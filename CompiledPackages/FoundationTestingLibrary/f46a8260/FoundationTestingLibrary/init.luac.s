MAIN:
       ...
       16 GETTABLEKS                       R3 R4 K7 ["createRenderSpy"]
       18 CALL                             R2 1 1
       19 GETIMPORT                        R3 K5 [require]
       21 GETIMPORT                        R5 K1 [script]
       23 GETTABLEKS                       R4 R5 K8 ["imageQueries"]
       25 CALL                             R3 1 1
       26 GETIMPORT                        R4 K5 [require]
       28 GETIMPORT                        R6 K1 [script]
       30 GETTABLEKS                       R5 R6 K9 ["mockComponent"]
       32 CALL                             R4 1 1
       33 GETIMPORT                        R5 K5 [require]
       35 GETIMPORT                        R7 K1 [script]
       37 GETTABLEKS                       R6 R7 K10 ["renderWithMocks"]
       39 CALL                             R5 1 1
       40 GETIMPORT                        R6 K5 [require]
       42 GETIMPORT                        R8 K1 [script]
       44 GETTABLEKS                       R7 R8 K11 ["setup"]
       46 CALL                             R6 1 1
       47 GETIMPORT                        R7 K5 [require]
       49 GETIMPORT                        R9 K1 [script]
       51 GETTABLEKS                       R8 R9 K12 ["testCommonProps"]
       53 CALL                             R7 1 1
