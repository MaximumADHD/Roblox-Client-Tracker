PROTO_0:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R3 R0 K0 ["AnchorPoint"]
        3 CALL                             R2 1 1
        4 GETTABLEKS                       R2 R2 K1 ["toEqual"]
        6 GETTABLEKS                       R3 R1 K0 ["AnchorPoint"]
        8 CALL                             R2 1 0
        9 GETUPVAL                         R2 0
       10 GETTABLEKS                       R3 R0 K2 ["LayoutOrder"]
       12 CALL                             R2 1 1
       13 GETTABLEKS                       R2 R2 K3 ["toBe"]
       15 GETTABLEKS                       R3 R1 K2 ["LayoutOrder"]
       17 CALL                             R2 1 0
       18 GETUPVAL                         R2 0
       19 GETTABLEKS                       R3 R0 K4 ["Position"]
       21 CALL                             R2 1 1
       22 GETTABLEKS                       R2 R2 K3 ["toBe"]
       24 GETTABLEKS                       R3 R1 K4 ["Position"]
       26 CALL                             R2 1 0
       27 GETUPVAL                         R2 0
       28 GETTABLEKS                       R3 R0 K5 ["Visible"]
       30 CALL                             R2 1 1
       31 GETTABLEKS                       R2 R2 K3 ["toBe"]
       33 GETTABLEKS                       R3 R1 K5 ["Visible"]
       35 CALL                             R2 1 0
       36 GETUPVAL                         R2 0
       37 GETTABLEKS                       R3 R0 K6 ["ZIndex"]
       39 CALL                             R2 1 1
       40 GETTABLEKS                       R2 R2 K3 ["toBe"]
