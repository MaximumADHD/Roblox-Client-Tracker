...
PROTO_2:
        ...
        6 JUMPIF                           R3 ; [+7]
        7 GETUPVAL                         R3 1
        8 GETTABLEKS                       R3 R3 K0 ["FoundationMigrateIconNames"]
       10 JUMPIFNOT                        R3 ; [+27]
       11 GETUPVAL                         R4 2
       ...
       25 MOVE                             R2 R3
       26 GETUPVAL                         R3 4
       27 GETTABLEKS                       R3 R3 K2 ["List"]
       29 GETTABLEKS                       R3 R3 K3 ["filter"]
       31 MOVE                             R4 R2
       32 NEWCLOSURE                       R5 P0
       33 CAPTURE                          UPVAL U5
       34 CAPTURE                          UPVAL U2
       ...
       53 CALL                             R4 -1 1
       54 GETUPVAL                         R5 4
       55 GETTABLEKS                       R5 R5 K2 ["List"]
       57 GETTABLEKS                       R5 R5 K3 ["filter"]
       59 MOVE                             R6 R4
       60 NEWCLOSURE                       R7 P1
       61 CAPTURE                          VAL R3
       62 CALL                             R5 2 1
       63 MOVE                             R4 R5
       64 GETUPVAL                         R5 4
       65 GETTABLEKS                       R5 R5 K2 ["List"]
       67 GETTABLEKS                       R5 R5 K5 ["join"]
       69 MOVE                             R6 R4
       70 MOVE                             R7 R2
       71 CALL                             R5 2 -1
       72 RETURN                           R5 -1
       73 GETUPVAL                         R4 4
       74 GETTABLEKS                       R4 R4 K2 ["List"]
       76 GETTABLEKS                       R4 R4 K5 ["join"]
       78 GETUPVAL                         R5 8
...
MAIN:
       ...
       48 CALL                             R10 1 1
       49 GETTABLEKS                       R11 R2 K8 ["Utility"]
       51 GETTABLEKS                       R11 R11 K18 ["isBuilderIcon"]
