...
PROTO_2:
        ...
        6 LOADK                            R6 K2 ["creator-inventory-api/v1/%*/%*/creator-inventory-items:move"]
        7 MOVE                             R8 R1
        8 MOVE                             R9 R0
       ...
       12 CALL                             R4 2 1
       13 NEWTABLE                         R5 1 0
       15 LOADK                            R6 K4 ["application/json"]
       16 SETTABLEKS                       R6 R5 K5 ["Content-Type"]
       18 GETUPVAL                         R6 1
       19 CALL                             R6 0 1
       20 JUMPIFNOT                        R6 ; [+8]
       21 JUMPIFNOT                        R3 ; [+7]
       ...
       27 FORGLOOP                         R6 2 ; [-2]
       29 DUPTABLE                         R6 K8 [{"getUrl", "makeRequest"}]
       30 NEWCLOSURE                       R7 P0
       31 CAPTURE                          VAL R4
       32 SETTABLEKS                       R7 R6 K6 ["getUrl"]
       34 NEWCLOSURE                       R7 P1
       35 CAPTURE                          UPVAL U2
       36 CAPTURE                          VAL R4
       37 CAPTURE                          UPVAL U3
       38 CAPTURE                          VAL R2
       39 CAPTURE                          VAL R5
       40 SETTABLEKS                       R7 R6 K7 ["makeRequest"]
       42 RETURN                           R6 1
