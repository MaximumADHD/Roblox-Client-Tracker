...
PROTO_2:
  ...
  LOADK R3 K4 ["Log of yielded values is not empty. Call expectToHaveYielded(scheduler, ...) first."]
  LOADN R4 3
  CALL R2 2 0
  RETURN R0 0
...
PROTO_4:
  ...
  CALL R3 0 1
  LENGTH R4 R3
  JUMPIFEQKN R4 K1 [0] [+6]
  GETIMPORT R4 K3 [error]
  LOADK R5 K4 ["Log of yielded values is not empty. Call expectToHaveYielded(scheduler, ...) first."]
  LOADN R6 3
  CALL R4 2 0
  GETTABLEKS R3 R1 K5 ["unstable_flushAllWithoutAsserting"]
  CALL R3 0 0
  GETTABLEKS R3 R1 K0 ["unstable_clearYields"]
  CALL R3 0 1
  GETUPVAL R4 0
...
PROTO_6:
  ...
  LOADN R6 3
  CALL R4 2 0
  GETTABLEKS R3 R1 K5 ["unstable_flushNumberOfYields"]
  LENGTH R4 R2
  CALL R3 1 0
  GETTABLEKS R3 R1 K0 ["unstable_clearYields"]
  CALL R3 0 1
...
PROTO_8:
  ...
  LOADN R6 3
  CALL R4 2 0
  GETTABLEKS R3 R1 K5 ["unstable_flushUntilNextPaint"]
  CALL R3 0 0
  GETTABLEKS R3 R1 K0 ["unstable_clearYields"]
  CALL R3 0 1
  GETUPVAL R4 0
...
PROTO_9:
  ...
  LOADK R6 K4 ["Log of yielded values is not empty. Call expectToHaveYielded(scheduler, ...) first."]
  LOADN R7 3
  CALL R5 2 0
  GETTABLEKS R4 R1 K5 ["unstable_flushAllWithoutAsserting"]
  CALL R4 0 0
  GETTABLEKS R4 R1 K0 ["unstable_clearYields"]
  CALL R4 0 1
  GETUPVAL R5 0
...
PROTO_11:
  ...
  LOADN R6 3
  CALL R4 2 0
  GETTABLEKS R3 R1 K5 ["unstable_flushExpired"]
  CALL R3 0 0
  GETTABLEKS R3 R1 K0 ["unstable_clearYields"]
  CALL R3 0 1
  GETUPVAL R4 0
