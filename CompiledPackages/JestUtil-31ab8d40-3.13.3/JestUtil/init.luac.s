MAIN:
  ...
  MOVE R7 R4
  CALL R5 2 0
  SETTABLEKS R4 R2 K17 ["specialChars"]
  ...
  GETTABLEKS R7 R8 K22 ["testPathPatternToRegExp"]
  CALL R6 1 1
  GETTABLEKS R5 R6 K8 ["default"]
  SETTABLEKS R5 R2 K22 ["testPathPatternToRegExp"]
  GETIMPORT R6 K1 [require]
  GETIMPORT R8 K3 [script]
  GETTABLEKS R7 R8 K23 ["globsToMatcher"]
  CALL R6 1 1
  GETTABLEKS R5 R6 K8 ["default"]
  SETTABLEKS R5 R2 K23 ["globsToMatcher"]
  GETIMPORT R5 K1 [require]
  GETIMPORT R7 K3 [script]
  GETTABLEKS R6 R7 K24 ["preRunMessage"]
  CALL R5 1 1
  SETTABLEKS R5 R2 K24 ["preRunMessage"]
  GETTABLEKS R6 R5 K25 ["print"]
  SETTABLEKS R6 R2 K25 ["print"]
  GETTABLEKS R6 R5 K26 ["remove"]
  SETTABLEKS R6 R2 K26 ["remove"]
  GETIMPORT R7 K1 [require]
  GETIMPORT R9 K3 [script]
  GETTABLEKS R8 R9 K27 ["pluralize"]
  CALL R7 1 1
  GETTABLEKS R6 R7 K8 ["default"]
  SETTABLEKS R6 R2 K27 ["pluralize"]
  GETIMPORT R7 K1 [require]
  GETIMPORT R9 K3 [script]
  GETTABLEKS R8 R9 K28 ["formatTime"]
  CALL R7 1 1
  GETTABLEKS R6 R7 K8 ["default"]
  SETTABLEKS R6 R2 K28 ["formatTime"]
  RETURN R2 1
