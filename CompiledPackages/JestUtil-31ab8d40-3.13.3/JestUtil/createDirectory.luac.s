...
PROTO_1:
  ...
  LOADK R8 K7 ["Provided path is invalid: you likely need to provide a different argument to --fs.readwrite.
"]
  LOADK R9 K8 ["You may need to pass in `--fs.readwrite=$PWD`"]
  CONCAT R7 R8 R9
  CALL R6 1 -1
  CALL R5 -1 0
  GETTABLEKS R5 R3 K9 ["code"]
  JUMPIFEQKS R5 K10 ["EEXIST"] [+5]
  GETIMPORT R5 K5 [error]
  MOVE R6 R3
  CALL R5 1 0
  JUMPIFNOT R4 [+1]
