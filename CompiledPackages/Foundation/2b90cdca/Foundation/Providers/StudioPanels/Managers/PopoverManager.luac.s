...
PROTO_10:
        ...
        2 MOVE                             R5 R1
        3 DUPTABLE                         R6 K9 [{["Id"], ["InitialEnabled"] = True, ["Tooltip"] = True, ["Transparent"] = True, ["Resizable"] = True, ["Title"], ["ZIndex"]}]
        4 SETTABLEKS                       R1 R6 K1 ["Id"]
        6 SETTABLEKS                       R1 R6 K7 ["Title"]
        8 ADDK                             R7 R2 K10 [200]
        9 SETTABLEKS                       R7 R6 K8 ["ZIndex"]
       11 NAMECALL                         R3 R3 K11 ["CreateQWidgetPluginGui"]
       13 CALL                             R3 3 1
       14 GETIMPORT                        R4 K15 [Enum.ZIndexBehavior.Sibling]
       16 SETTABLEKS                       R4 R3 K13 ["ZIndexBehavior"]
       18 MOVE                             R4 R3
       19 GETUPVAL                         R5 0
       20 GETTABLEKS                       R5 R5 K16 ["join"]
       22 GETTABLEKS                       R6 R0 K17 ["_pluginUri"]
       24 DUPTABLE                         R7 K21 [{["Category"] = "Panels", ["ItemId"]}]
       25 SETTABLEKS                       R1 R7 K20 ["ItemId"]
       27 CALL                             R5 2 -1
       28 RETURN                           R4 -1
...
PROTO_14:
        ...
        4 CALL                             R3 3 2
        5 DUPTABLE                         R5 K12 [{["id"], ["uri"], ["panel"], ["open"] = False, ["depth"], ["generation"] = 0, ["parentPopoverId"] = , ["onClose"] = }]
        6 SETTABLEKS                       R1 R5 K1 ["id"]
        8 SETTABLEKS                       R4 R5 K2 ["uri"]
       10 SETTABLEKS                       R3 R5 K3 ["panel"]
       12 SETTABLEKS                       R2 R5 K6 ["depth"]
       14 NEWCLOSURE                       R6 P0
       15 CAPTURE                          UPVAL U0
       16 CAPTURE                          VAL R0
       17 CAPTURE                          VAL R5
       18 LOADK                            R9 K13 ["PluginGui"]
       19 NAMECALL                         R7 R3 K14 ["IsA"]
       21 CALL                             R7 2 1
       22 JUMPIFNOT                        R7 ; [+4]
       23 MOVE                             R9 R6
       24 NAMECALL                         R7 R3 K15 ["BindToClose"]
       26 CALL                             R7 2 0
       27 GETTABLEKS                       R6 R3 K16 ["InputBegan"]
       29 NEWCLOSURE                       R8 P1
       30 CAPTURE                          VAL R5
       31 CAPTURE                          VAL R0
       32 NAMECALL                         R6 R6 K17 ["Connect"]
       34 CALL                             R6 2 0
       35 RETURN                           R5 1
