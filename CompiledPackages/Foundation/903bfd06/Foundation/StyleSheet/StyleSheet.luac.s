...
PROTO_2:
        ...
        7 GETUPVAL                         R3 1
        8 GETTABLEKS                       R3 R3 K2 ["tokenOverrides"]
       10 CALL                             R0 3 -1
       11 RETURN                           R0 -1
...
PROTO_4:
       ...
       60 CALL                             R5 2 1
       61 GETUPVAL                         R6 0
       62 GETTABLEKS                       R6 R6 K6 ["useMemo"]
       64 NEWCLOSURE                       R7 P3
       65 CAPTURE                          VAL R1
       66 CAPTURE                          UPVAL U4
       67 CAPTURE                          VAL R4
       ...
       82 CALL                             R6 2 1
       83 GETUPVAL                         R7 0
       84 GETTABLEKS                       R7 R7 K10 ["createElement"]
       86 GETUPVAL                         R8 0
       87 GETTABLEKS                       R8 R8 K11 ["Fragment"]
       89 LOADNIL                          R9
       90 DUPTABLE                         R10 K14 [{"FoundationStyleSheet", "FoundationStyleLink"}]
       91 GETUPVAL                         R11 0
       92 GETTABLEKS                       R11 R11 K10 ["createElement"]
      ...
      102 GETUPVAL                         R11 0
      103 GETTABLEKS                       R11 R11 K10 ["createElement"]
...
MAIN:
       ...
       27 GETTABLEKS                       R6 R1 K10 ["Providers"]
       29 GETTABLEKS                       R6 R6 K11 ["Style"]
       31 GETTABLEKS                       R6 R6 K12 ["Tokens"]
       33 CALL                             R5 1 1
       34 GETIMPORT                        R6 K6 [require]
       36 GETTABLEKS                       R7 R0 K13 ["Rules"]
       ...
       53 GETTABLEKS                       R10 R1 K7 ["Utility"]
       55 GETTABLEKS                       R10 R10 K17 ["useGeneratedRules"]
       57 CALL                             R9 1 1
       58 GETIMPORT                        R10 K6 [require]
       60 GETTABLEKS                       R11 R1 K18 ["Enums"]
       62 GETTABLEKS                       R11 R11 K19 ["Device"]
       64 CALL                             R10 1 1
       65 GETIMPORT                        R11 K6 [require]
       67 GETTABLEKS                       R12 R1 K18 ["Enums"]
       69 GETTABLEKS                       R12 R12 K20 ["Theme"]
       71 CALL                             R11 1 1
