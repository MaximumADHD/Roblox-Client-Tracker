PROTO_0:
       ...
       20 GETUPVAL                         R2 3
       21 DUPTABLE                         R3 K6 [{["tag"] = "size-0-0 auto-xy col align-x-center gap-small"}]
       22 DUPTABLE                         R4 K9 [{"Label", "Indicator"}]
       23 GETUPVAL                         R5 2
       24 GETTABLEKS                       R5 R5 K2 ["createElement"]
       26 GETUPVAL                         R6 4
       27 DUPTABLE                         R7 K12 [{["tag"] = "auto-xy text-align-x-center text-caption-small", ["Text"]}]
...
PROTO_1:
        ...
        3 GETUPVAL                         R1 1
        4 DUPTABLE                         R2 K3 [{["tag"] = "size-full-0 auto-y row align-x-left align-y-center gap-xxlarge"}]
        5 GETUPVAL                         R3 2
...
PROTO_3:
        ...
        3 GETUPVAL                         R2 1
        4 DUPTABLE                         R3 K3 [{["tag"] = "size-full-0 auto-y row align-x-left align-y-center gap-xxlarge"}]
        5 GETUPVAL                         R4 2
