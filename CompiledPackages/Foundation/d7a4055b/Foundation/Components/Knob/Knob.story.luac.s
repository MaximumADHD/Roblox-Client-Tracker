...
PROTO_2:
       ...
       14 GETUPVAL                         R5 3
       15 DUPTABLE                         R6 K8 [{["tag"] = "gap-medium auto-xy align-y-center padding-medium radius-medium", ["backgroundStyle"]}]
       16 JUMPIFNOT                        R2 ; [+7]
       ...
       64 GETUPVAL                         R5 3
       65 DUPTABLE                         R6 K20 [{["tag"] = "gap-medium auto-xy align-y-center padding-medium radius-medium"}]
       66 GETUPVAL                         R7 2
...
PROTO_3:
       ...
       12 GETTABLEKS                       R4 R4 K4 ["createElement"]
       14 GETUPVAL                         R5 3
       15 DUPTABLE                         R6 K8 [{["backgroundStyle"], ["tag"] = "gap-medium auto-xy align-y-center padding-medium radius-medium"}]
       16 JUMPIFNOT                        R2 ; [+7]
       17 GETTABLEKS                       R7 R3 K9 ["Inverse"]
       19 GETTABLEKS                       R7 R7 K10 ["Surface"]
       21 GETTABLEKS                       R7 R7 K11 ["Surface_0"]
      ...
      114 GETUPVAL                         R5 3
      115 DUPTABLE                         R6 K31 [{["tag"] = "gap-medium auto-xy align-y-center padding-medium radius-medium"}]
      116 GETUPVAL                         R7 2
...
PROTO_4:
       ...
       10 GETUPVAL                         R5 2
       11 DUPTABLE                         R6 K7 [{["backgroundStyle"], ["tag"] = "gap-medium auto-xy align-y-center padding-medium radius-medium"}]
       12 JUMPIFNOT                        R2 ; [+2]
       13 LOADNIL                          R7
       14 JUMP                             ; [+6]
...
MAIN:
      ...
      110 GETTABLEKS                       R14 R9 K34 ["FoundationToggleVisualUpdate"]
      ...
      130 GETTABLEKS                       R16 R9 K34 ["FoundationToggleVisualUpdate"]
      132 JUMPIFNOT                        R16 ; [+2]
      ...
      138 GETTABLEKS                       R16 R9 K34 ["FoundationToggleVisualUpdate"]
      140 JUMPIFNOT                        R16 ; [+2]
