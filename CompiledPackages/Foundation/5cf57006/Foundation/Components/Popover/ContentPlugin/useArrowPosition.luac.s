PROTO_0:
        0 GETUPVAL                         R0 0
        1 GETUPVAL                         R1 1
        2 GETTABLEKS                       R1 R1 K0 ["XSmall"]
        4 JUMPIFNOTEQ                      R0 R1 ; [+7]
        6 GETUPVAL                         R0 2
        7 GETTABLEKS                       R0 R0 K1 ["Size"]
        9 GETTABLEKS                       R0 R0 K2 ["Size_50"]
       11 RETURN                           R0 1
       12 GETUPVAL                         R0 0
       13 GETUPVAL                         R1 1
       ...
       18 GETUPVAL                         R0 2
       19 GETTABLEKS                       R0 R0 K1 ["Size"]
       21 GETTABLEKS                       R0 R0 K4 ["Size_100"]
       23 RETURN                           R0 1
       24 GETUPVAL                         R0 0
       25 GETUPVAL                         R1 1
       26 GETTABLEKS                       R1 R1 K5 ["Medium"]
       28 JUMPIFNOTEQ                      R0 R1 ; [+7]
       30 GETUPVAL                         R0 2
       31 GETTABLEKS                       R0 R0 K1 ["Size"]
       33 GETTABLEKS                       R0 R0 K6 ["Size_200"]
       35 RETURN                           R0 1
       36 GETUPVAL                         R0 0
       37 GETUPVAL                         R1 1
       38 GETTABLEKS                       R1 R1 K7 ["Large"]
       40 JUMPIFNOTEQ                      R0 R1 ; [+7]
       42 GETUPVAL                         R0 2
       43 GETTABLEKS                       R0 R0 K1 ["Size"]
       45 GETTABLEKS                       R0 R0 K8 ["Size_300"]
       47 RETURN                           R0 1
       48 LOADN                            R0 0
       49 RETURN                           R0 1
...
PROTO_1:
        ...
        4 GETTABLEKS                       R2 R0 K2 ["Y"]
        6 GETTABLEKS                       R2 R2 K1 ["Offset"]
        8 GETUPVAL                         R3 0
        9 GETUPVAL                         R4 1
       10 GETUPVAL                         R5 2
       11 GETTABLEKS                       R5 R5 K3 ["Circle"]
       ...
       26 GETUPVAL                         R6 4
       27 GETUPVAL                         R7 5
       28 GETTABLEKS                       R7 R7 K8 ["Top"]
       30 JUMPIFEQ                         R6 R7 ; [+9]
       32 GETUPVAL                         R6 4
       33 GETUPVAL                         R7 5
       34 GETTABLEKS                       R7 R7 K9 ["Bottom"]
       36 JUMPIFEQ                         R6 R7 ; [+2]
       38 LOADB                            R5 0 +1
       39 LOADB                            R5 1
       40 JUMPIFNOT                        R5 ; [+2]
       ...
       54 GETUPVAL                         R8 6
       55 GETTABLEKS                       R8 R8 K13 ["AbsoluteSize"]
       57 JUMPIFNOT                        R5 ; [+3]
      ...
      139 GETUPVAL                         R13 4
      140 GETUPVAL                         R14 5
      141 GETTABLEKS                       R14 R14 K23 ["Left"]
...
MAIN:
       ...
       23 GETTABLEKS                       R5 R5 K10 ["PopoverSide"]
       25 CALL                             R4 1 1
       26 GETIMPORT                        R5 K6 [require]
       28 GETTABLEKS                       R6 R0 K9 ["Enums"]
       30 GETTABLEKS                       R6 R6 K11 ["Radius"]
       32 CALL                             R5 1 1
