PROTO_0:
        ...
        2 LOADN                            R1 0
        3 GETUPVAL                         R7 0
        4 GETTABLEKS                       R6 R7 K4 ["FoundationInputVariantsConsolidateContainer"]
        6 JUMPIFNOT                        R6 ; [+4]
        7 GETUPVAL                         R6 1
        8 GETTABLEKS                       R5 R6 K5 ["container"]
       10 JUMP                             ; [+3]
       11 GETUPVAL                         R6 1
       12 GETTABLEKS                       R5 R6 K6 ["outerContainer"]
       14 GETTABLEKS                       R4 R5 K7 ["minHeight"]
       16 GETUPVAL                         R7 2
       17 GETTABLEKS                       R6 R7 K8 ["Stroke"]
       19 GETTABLEKS                       R5 R6 K9 ["Standard"]
       21 SUB                              R3 R4 R5
       22 DIVK                             R2 R3 K3 [2]
       23 CALL                             R0 2 -1
       24 RETURN                           R0 -1
...
PROTO_1:
       ...
       17 CALL                             R5 1 1
       18 GETUPVAL                         R7 6
       19 GETTABLEKS                       R6 R7 K3 ["FoundationInternalTextInputClearButton"]
       21 JUMPIFNOT                        R6 ; [+7]
       ...
       36 NEWTABLE                         R8 0 2
       38 GETUPVAL                         R12 6
       39 GETTABLEKS                       R11 R12 K6 ["FoundationInputVariantsConsolidateContainer"]
       41 JUMPIFNOT                        R11 ; [+3]
       42 GETTABLEKS                       R10 R4 K7 ["container"]
       44 JUMP                             ; [+2]
       45 GETTABLEKS                       R10 R4 K8 ["outerContainer"]
       47 GETTABLEKS                       R9 R10 K9 ["minHeight"]
       49 GETTABLEKS                       R11 R3 K10 ["Stroke"]
       51 GETTABLEKS                       R10 R11 K11 ["Standard"]
       53 SETLIST                          R8 R9 2 [1]
       55 CALL                             R6 2 1
       56 GETUPVAL                         R8 7
       57 GETTABLEKS                       R7 R8 K12 ["createElement"]
       59 GETUPVAL                         R8 8
       60 GETUPVAL                         R9 9
       61 MOVE                             R10 R2
       ...
       97 GETUPVAL                         R12 7
       98 GETTABLEKS                       R11 R12 K12 ["createElement"]
      100 GETUPVAL                         R12 10
      ...
      112 GETUPVAL                         R16 6
      113 GETTABLEKS                       R15 R16 K3 ["FoundationInternalTextInputClearButton"]
      115 JUMPIFNOT                        R15 ; [+3]
      ...
      141 GETUPVAL                         R18 6
      142 GETTABLEKS                       R17 R18 K6 ["FoundationInputVariantsConsolidateContainer"]
      144 JUMPIFNOT                        R17 ; [+3]
      145 GETTABLEKS                       R16 R4 K7 ["container"]
      147 JUMP                             ; [+2]
      148 GETTABLEKS                       R16 R4 K42 ["innerContainer"]
      150 GETTABLEKS                       R15 R16 K30 ["horizontalPadding"]
      152 SETTABLEKS                       R15 R14 K39 ["left"]
      154 GETUPVAL                         R18 6
      155 GETTABLEKS                       R17 R18 K6 ["FoundationInputVariantsConsolidateContainer"]
      157 JUMPIFNOT                        R17 ; [+3]
      158 GETTABLEKS                       R16 R4 K7 ["container"]
      160 JUMP                             ; [+2]
      161 GETTABLEKS                       R16 R4 K42 ["innerContainer"]
      163 GETTABLEKS                       R15 R16 K30 ["horizontalPadding"]
      ...
      194 GETUPVAL                         R15 7
      195 GETTABLEKS                       R14 R15 K12 ["createElement"]
      197 GETUPVAL                         R15 8
      ...
      205 GETUPVAL                         R19 7
      206 GETTABLEKS                       R18 R19 K12 ["createElement"]
      208 GETUPVAL                         R19 13
      209 DUPTABLE                         R20 K52 [{"name", "size", "testId"}]
      210 GETUPVAL                         R23 14
      211 GETTABLEKS                       R22 R23 K49 ["Icon"]
      213 GETTABLEKS                       R21 R22 K53 ["MagnifyingGlass"]
...
MAIN:
       ...
       55 GETTABLEKS                       R14 R0 K15 ["Utility"]
       57 GETTABLEKS                       R13 R14 K17 ["Localization"]
       59 GETTABLEKS                       R12 R13 K18 ["Translator"]
       61 CALL                             R11 1 1
       62 GETIMPORT                        R12 K6 [require]
       64 GETTABLEKS                       R14 R0 K15 ["Utility"]
       66 GETTABLEKS                       R13 R14 K19 ["useScaledValue"]
       68 CALL                             R12 1 1
       69 GETIMPORT                        R13 K6 [require]
       71 GETTABLEKS                       R16 R0 K9 ["Components"]
       73 GETTABLEKS                       R15 R16 K20 ["TextInput"]
       75 GETTABLEKS                       R14 R15 K21 ["useTextInputVariants"]
       77 CALL                             R13 1 1
       78 GETIMPORT                        R14 K6 [require]
       80 GETTABLEKS                       R17 R0 K22 ["Providers"]
       82 GETTABLEKS                       R16 R17 K23 ["Style"]
       84 GETTABLEKS                       R15 R16 K24 ["useTokens"]
       86 CALL                             R14 1 1
       87 GETIMPORT                        R15 K6 [require]
       89 GETTABLEKS                       R17 R0 K15 ["Utility"]
       91 GETTABLEKS                       R16 R17 K25 ["withCommonProps"]
       93 CALL                             R15 1 1
       94 GETIMPORT                        R16 K6 [require]
       96 GETTABLEKS                       R18 R0 K15 ["Utility"]
       98 GETTABLEKS                       R17 R18 K26 ["withDefaults"]
      100 CALL                             R16 1 1
      101 GETIMPORT                        R17 K6 [require]
      103 GETTABLEKS                       R19 R0 K27 ["Enums"]
      105 GETTABLEKS                       R18 R19 K28 ["InputSize"]
      107 CALL                             R17 1 1
      108 GETIMPORT                        R18 K6 [require]
      110 GETTABLEKS                       R20 R0 K27 ["Enums"]
      112 GETTABLEKS                       R19 R20 K29 ["InputVariant"]
      114 CALL                             R18 1 1
      115 GETIMPORT                        R19 K6 [require]
      117 GETTABLEKS                       R21 R0 K27 ["Enums"]
      119 GETTABLEKS                       R20 R21 K30 ["Radius"]
      121 CALL                             R19 1 1
      122 GETIMPORT                        R20 K6 [require]
      124 GETTABLEKS                       R22 R0 K27 ["Enums"]
      126 GETTABLEKS                       R21 R22 K31 ["SearchInputShape"]
      128 CALL                             R20 1 1
