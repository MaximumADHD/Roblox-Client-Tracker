...
PROTO_3:
        0 LOADNIL                          R0
        1 GETUPVAL                         R2 0
        2 GETTABLEKS                       R1 R2 K0 ["FoundationPopoverPluginPrewarmDepthPool"]
        4 JUMPIFNOT                        R1 ; [+6]
...
PROTO_6:
       ...
       34 CALL                             R3 2 0
       35 GETUPVAL                         R4 1
       36 GETTABLEKS                       R3 R4 K6 ["useCallback"]
       38 NEWCLOSURE                       R4 P2
       39 CAPTURE                          VAL R2
       40 NEWTABLE                         R5 0 1
       42 MOVE                             R6 R2
       ...
       49 GETUPVAL                         R6 1
       50 GETTABLEKS                       R5 R6 K9 ["createElement"]
       52 GETUPVAL                         R7 4
       53 GETTABLEKS                       R6 R7 K10 ["Provider"]
...
MAIN:
       ...
       23 GETTABLEKS                       R7 R0 K8 ["Utility"]
       25 GETTABLEKS                       R6 R7 K10 ["Plugin"]
       27 GETTABLEKS                       R5 R6 K11 ["StudioUri"]
       29 CALL                             R4 1 1
       30 GETIMPORT                        R5 K6 [require]
       32 GETTABLEKS                       R8 R0 K12 ["Providers"]
       34 GETTABLEKS                       R7 R8 K10 ["Plugin"]
       36 GETTABLEKS                       R6 R7 K13 ["usePlugin"]
       38 CALL                             R5 1 1
       39 GETIMPORT                        R6 K6 [require]
       41 GETIMPORT                        R9 K1 [script]
       43 GETTABLEKS                       R8 R9 K4 ["Parent"]
       45 GETTABLEKS                       R7 R8 K14 ["PanelsContext"]
       47 CALL                             R6 1 1
       48 GETIMPORT                        R7 K6 [require]
       50 GETIMPORT                        R11 K1 [script]
       52 GETTABLEKS                       R10 R11 K4 ["Parent"]
       54 GETTABLEKS                       R9 R10 K15 ["Managers"]
       56 GETTABLEKS                       R8 R9 K16 ["PopoverManager"]
       58 CALL                             R7 1 1
       59 GETIMPORT                        R8 K6 [require]
       61 GETIMPORT                        R11 K1 [script]
       63 GETTABLEKS                       R10 R11 K4 ["Parent"]
       65 GETTABLEKS                       R9 R10 K17 ["Types"]
       67 CALL                             R8 1 1
