PROTO_0:
        0 GETTABLEKS                       R3 R0 K0 ["Stroke"]
        2 GETTABLEKS                       R2 R3 K1 ["Standard"]
       ...
       30 LOADNIL                          R3
       31 GETUPVAL                         R5 0
       32 GETTABLEKS                       R4 R5 K19 ["FoundationInternalInputSelectedStylesAndSpacing"]
       34 JUMPIFNOT                        R4 ; [+48]
       35 NEWTABLE                         R4 4 0
       37 GETUPVAL                         R6 1
       38 GETTABLEKS                       R5 R6 K20 ["XSmall"]
       ...
       59 GETUPVAL                         R6 1
       60 GETTABLEKS                       R5 R6 K25 ["Medium"]
       ...
       83 NEWTABLE                         R4 4 0
       85 GETUPVAL                         R6 1
       86 GETTABLEKS                       R5 R6 K20 ["XSmall"]
      ...
      107 GETUPVAL                         R6 1
      108 GETTABLEKS                       R5 R6 K25 ["Medium"]
      ...
      118 GETUPVAL                         R6 1
      119 GETTABLEKS                       R5 R6 K26 ["Large"]
      ...
      129 MOVE                             R3 R4
      130 DUPTABLE                         R4 K31 [{"common", "sizes"}]
      131 SETTABLEKS                       R2 R4 K29 ["common"]
      133 SETTABLEKS                       R3 R4 K30 ["sizes"]
      135 RETURN                           R4 1

PROTO_1:
        0 GETUPVAL                         R3 0
        1 GETTABLEKS                       R2 R3 K0 ["useVariants"]
        3 LOADK                            R3 K1 ["InternalInput"]
        4 GETUPVAL                         R4 1
        5 MOVE                             R5 R0
        6 CALL                             R2 3 1
        7 GETUPVAL                         R3 2
