...
PROTO_1:
        ...
        3 GETUPVAL                         R2 1
        4 DUPTABLE                         R3 K5 [{"defaultDates", "onSelectedDateChanged", "showStartDateTimeCalendarInput", "showEndDateTimeCalendarInput"}]
        5 NEWTABLE                         R4 0 1
        7 GETIMPORT                        R5 K8 [DateTime.now]
        9 CALL                             R5 0 -1
       10 SETLIST                          R4 R5 -1 [1]
       12 SETTABLEKS                       R4 R3 K1 ["defaultDates"]
       14 DUPCLOSURE                       R4 K9 [PROTO_0]
       15 SETTABLEKS                       R4 R3 K2 ["onSelectedDateChanged"]
       17 GETTABLEKS                       R5 R0 K10 ["controls"]
       19 GETTABLEKS                       R4 R5 K3 ["showStartDateTimeCalendarInput"]
       21 SETTABLEKS                       R4 R3 K3 ["showStartDateTimeCalendarInput"]
       23 GETTABLEKS                       R5 R0 K10 ["controls"]
...
MAIN:
       ...
       42 DUPTABLE                         R5 K19 [{"showStartDateTimeCalendarInput", "showEndDateTimeCalendarInput"}]
       43 LOADB                            R6 0
       44 SETTABLEKS                       R6 R5 K17 ["showStartDateTimeCalendarInput"]
       46 LOADB                            R6 0
       47 SETTABLEKS                       R6 R5 K18 ["showEndDateTimeCalendarInput"]
       49 SETTABLEKS                       R5 R4 K11 ["controls"]
       51 RETURN                           R4 1
