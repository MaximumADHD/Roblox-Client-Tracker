PROTO_0:
        ...
        7 GETUPVAL                         R4 1
        8 DUPTABLE                         R5 K6 [{["tag"] = "size-3000-0 auto-y col align-x-center align-y-center gap-small bg-surface-100 radius-medium padding-medium", ["Visible"]}]
       ...
       25 GETUPVAL                         R8 3
       26 DUPTABLE                         R9 K19 [{["tag"] = "auto-xy size-full-0 content-default text-caption-large text-wrap", ["Text"], ["LayoutOrder"] = 2}]
       27 LOADK                            R13 K20 ["([^/]+)$"]
       ...
       40 GETUPVAL                         R8 3
       41 DUPTABLE                         R9 K24 [{["tag"] = "auto-xy size-full-0 content-default text-caption-small text-wrap", ["Text"], ["LayoutOrder"] = 3}]
...
PROTO_4:
       ...
       47 GETUPVAL                         R5 3
       48 DUPTABLE                         R6 K14 [{["tag"] = "auto-y size-full-0 row wrap gap-xlarge"}]
       49 MOVE                             R7 R3
       50 CALL                             R4 3 -1
       51 RETURN                           R4 -1
...
MAIN:
       ...
       39 CALL                             R6 1 1
       40 GETTABLEKS                       R7 R3 K13 ["Images"]
