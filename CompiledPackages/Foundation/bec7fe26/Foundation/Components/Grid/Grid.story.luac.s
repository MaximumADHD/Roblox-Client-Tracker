PROTO_0:
       ...
       64 GETUPVAL                         R7 3
       65 DUPTABLE                         R8 K22 [{["tag"] = "size-full-2000 text-wrap text-label-small position-center-center anchor-center-center", ["Text"]}]
       66 LOADK                            R10 K23 ["%* %*"]
...
PROTO_1:
       ...
       36 GETUPVAL                         R6 3
       37 DUPTABLE                         R7 K17 [{["tag"] = "size-full-2000 text-wrap text-label-small position-center-center anchor-center-center", ["Text"]}]
       38 LOADK                            R9 K18 ["%* %*"]
...
PROTO_4:
       ...
       10 GETUPVAL                         R7 1
       11 DUPTABLE                         R8 K4 [{["tag"] = "xs-col-1 sm-col-2 md-col-3 lg-col-4 xl-col-6 size-full-full aspect-2-1  margin-bottom-large", ["LayoutOrder"]}]
       12 GETUPVAL                         R9 2
       ...
       27 GETUPVAL                         R15 3
       28 DUPTABLE                         R16 K13 [{["tag"] = "size-full-full text-wrap text-label-small position-center-center anchor-center-center", ["Text"]}]
       29 LOADK                            R18 K14 ["%*"]
       30 MOVE                             R20 R3
...
PROTO_10:
        ...
        1 GETTABLEKS                       R1 R1 K0 ["createElement"]
        3 GETUPVAL                         R2 1
        4 DUPTABLE                         R3 K3 [{["tag"] = "size-full-3000 row auto-y"}]
       ...
       11 GETIMPORT                        R8 K12 [UDim2.new]
       13 LOADK                            R9 K13 [0.666]
       14 LOADN                            R10 0
       15 LOADN                            R11 1
       16 LOADN                            R12 0
       17 CALL                             R8 4 1
       18 SETTABLEKS                       R8 R7 K8 ["Size"]
       20 DUPTABLE                         R8 K15 [{"ChildL1"}]
       21 NEWCLOSURE                       R9 P0
       22 CAPTURE                          UPVAL U0
       23 CAPTURE                          UPVAL U2
       24 CAPTURE                          VAL R0
       ...
       26 CAPTURE                          UPVAL U4
       27 CALL                             R9 0 1
       28 SETTABLEKS                       R9 R8 K14 ["ChildL1"]
       30 CALL                             R5 3 1
       31 SETTABLEKS                       R5 R4 K4 ["Left"]
       33 GETUPVAL                         R5 0
       34 GETTABLEKS                       R5 R5 K0 ["createElement"]
       36 GETUPVAL                         R6 1
       37 DUPTABLE                         R7 K17 [{["tag"] = "col flex-y-fill auto-y", ["Size"]}]
       38 GETIMPORT                        R8 K12 [UDim2.new]
       40 LOADK                            R9 K18 [0.333]
       41 LOADN                            R10 0
       42 LOADN                            R11 1
       43 LOADN                            R12 0
       44 CALL                             R8 4 1
       45 SETTABLEKS                       R8 R7 K8 ["Size"]
       47 DUPTABLE                         R8 K21 [{"ChildR1", "ChildR2"}]
       48 NEWCLOSURE                       R9 P1
       49 CAPTURE                          UPVAL U0
       50 CAPTURE                          UPVAL U2
       51 CAPTURE                          VAL R0
       ...
       53 CAPTURE                          UPVAL U4
       54 CALL                             R9 0 1
       55 SETTABLEKS                       R9 R8 K19 ["ChildR1"]
       57 NEWCLOSURE                       R9 P2
       58 CAPTURE                          UPVAL U0
       59 CAPTURE                          UPVAL U2
       60 CAPTURE                          VAL R0
       ...
       62 CAPTURE                          UPVAL U4
       63 CALL                             R9 0 1
       64 SETTABLEKS                       R9 R8 K20 ["ChildR2"]
       66 CALL                             R5 3 1
       67 SETTABLEKS                       R5 R4 K5 ["Right"]
       69 CALL                             R1 3 -1
       70 RETURN                           R1 -1
