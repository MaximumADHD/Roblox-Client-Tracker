...
PROTO_7:
        ...
        3 GETUPVAL                         R2 1
        4 DUPTABLE                         R3 K5 [{"key", "isChecked", "onActivated", "label"}]
        5 GETTABLEKS                       R4 R0 K1 ["key"]
        7 SETTABLEKS                       R4 R3 K1 ["key"]
        9 GETTABLEKS                       R4 R0 K6 ["value"]
       11 SETTABLEKS                       R4 R3 K2 ["isChecked"]
       13 GETTABLEKS                       R5 R0 K1 ["key"]
       15 NEWCLOSURE                       R4 P0
       16 CAPTURE                          UPVAL U2
       17 CAPTURE                          VAL R5
       18 CAPTURE                          UPVAL U3
       19 SETTABLEKS                       R4 R3 K3 ["onActivated"]
       21 GETTABLEKS                       R4 R0 K1 ["key"]
       23 SETTABLEKS                       R4 R3 K4 ["label"]
       25 CALL                             R1 2 -1
       26 RETURN                           R1 -1
...
PROTO_8:
       ...
       26 CAPTURE                          VAL R3
       27 GETUPVAL                         R6 0
       28 GETTABLEKS                       R6 R6 K4 ["createElement"]
       30 GETUPVAL                         R7 2
       31 DUPTABLE                         R8 K7 [{["tag"] = "col gap-medium auto-xy"}]
       32 DUPTABLE                         R9 K10 [{"Search", "List"}]
       33 GETUPVAL                         R10 0
       34 GETTABLEKS                       R10 R10 K4 ["createElement"]
       36 GETUPVAL                         R11 3
       37 DUPTABLE                         R12 K16 [{["text"], ["onChanged"], ["label"] = "Search", ["placeholder"] = "Search flags..."}]
       38 SETTABLEKS                       R0 R12 K11 ["text"]
       40 SETTABLEKS                       R1 R12 K12 ["onChanged"]
       42 CALL                             R10 2 1
       43 SETTABLEKS                       R10 R9 K8 ["Search"]
       45 GETUPVAL                         R10 0
       46 GETTABLEKS                       R10 R10 K4 ["createElement"]
       48 GETUPVAL                         R11 2
       49 DUPTABLE                         R12 K18 [{["tag"] = "col gap-small auto-xy"}]
       50 GETUPVAL                         R13 4
       51 GETTABLEKS                       R13 R13 K19 ["map"]
       53 MOVE                             R14 R4
       54 NEWCLOSURE                       R15 P3
       55 CAPTURE                          UPVAL U0
       56 CAPTURE                          UPVAL U5
       57 CAPTURE                          UPVAL U1
       58 CAPTURE                          VAL R3
