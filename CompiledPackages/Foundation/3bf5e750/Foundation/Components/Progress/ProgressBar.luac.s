...
PROTO_3:
       ...
       29 GETUPVAL                         R11 11
       30 MOVE                             R12 R1
       31 DUPTABLE                         R13 K8 [{["Size"], ["tag"] = "radius-small bg-shift-400", ["ref"]}]
       32 GETIMPORT                        R14 K11 [UDim2.new]
       34 GETTABLEKS                       R15 R1 K12 ["width"]
       36 GETIMPORT                        R16 K14 [UDim.new]
       38 LOADN                            R17 0
       39 GETTABLEKS                       R18 R4 K15 ["bar"]
       41 GETTABLEKS                       R18 R18 K16 ["height"]
       43 CALL                             R16 2 -1
       44 CALL                             R14 -1 1
       45 SETTABLEKS                       R14 R13 K4 ["Size"]
       47 GETTABLEKS                       R14 R1 K7 ["ref"]
       49 SETTABLEKS                       R14 R13 K7 ["ref"]
       51 CALL                             R11 2 1
       52 DUPTABLE                         R12 K18 [{"Fill"}]
       53 GETUPVAL                         R13 9
       54 GETTABLEKS                       R13 R13 K3 ["createElement"]
       56 GETUPVAL                         R14 10
       57 DUPTABLE                         R15 K22 [{["backgroundStyle"], ["tag"] = "size-full radius-small", ["ref"], ["testId"]}]
       58 GETTABLEKS                       R16 R2 K23 ["Color"]
       60 GETTABLEKS                       R16 R16 K24 ["Content"]
       62 GETTABLEKS                       R16 R16 K25 ["Emphasis"]
       64 SETTABLEKS                       R16 R15 K19 ["backgroundStyle"]
       66 GETTABLEKS                       R16 R1 K7 ["ref"]
       68 SETTABLEKS                       R16 R15 K7 ["ref"]
       70 LOADK                            R17 K26 ["%*--fill"]
       71 GETTABLEKS                       R19 R1 K21 ["testId"]
       73 NAMECALL                         R17 R17 K27 ["format"]
       75 CALL                             R17 2 1
       76 MOVE                             R16 R17
       77 SETTABLEKS                       R16 R15 K21 ["testId"]
       79 DUPTABLE                         R16 K29 [{"Gradient"}]
       80 GETUPVAL                         R17 9
       81 GETTABLEKS                       R17 R17 K3 ["createElement"]
       83 LOADK                            R18 K30 ["UIGradient"]
       84 DUPTABLE                         R19 K33 [{"Color", "Transparency", "Offset"}]
       85 GETIMPORT                        R20 K35 [ColorSequence.new]
       87 GETTABLEKS                       R21 R2 K23 ["Color"]
       89 GETTABLEKS                       R21 R21 K24 ["Content"]
       91 GETTABLEKS                       R21 R21 K25 ["Emphasis"]
       93 GETTABLEKS                       R21 R21 K36 ["Color3"]
       95 CALL                             R20 1 1
       96 SETTABLEKS                       R20 R19 K23 ["Color"]
       98 JUMPIFNOT                        R6 ; [+7]
       99 NEWCLOSURE                       R22 P0
      100 CAPTURE                          VAL R3
      101 CAPTURE                          VAL R2
      102 NAMECALL                         R20 R8 K37 ["map"]
      104 CALL                             R20 2 1
      105 JUMP                             ; [+4]
      106 DUPCLOSURE                       R22 K38 [PROTO_1]
      107 NAMECALL                         R20 R5 K37 ["map"]
      109 CALL                             R20 2 1
      110 SETTABLEKS                       R20 R19 K31 ["Transparency"]
      112 JUMPIFNOT                        R6 ; [+7]
      113 NEWCLOSURE                       R22 P2
      114 CAPTURE                          VAL R3
      115 CAPTURE                          UPVAL U8
      116 NAMECALL                         R20 R7 K37 ["map"]
      118 CALL                             R20 2 1
      119 JUMP                             ; [+1]
      120 LOADNIL                          R20
      121 SETTABLEKS                       R20 R19 K32 ["Offset"]
      123 CALL                             R17 2 1
      124 SETTABLEKS                       R17 R16 K28 ["Gradient"]
      126 CALL                             R13 3 1
      127 SETTABLEKS                       R13 R12 K17 ["Fill"]
      129 CALL                             R9 3 -1
      130 RETURN                           R9 -1
...
MAIN:
       ...
       39 GETTABLEKS                       R7 R0 K12 ["Providers"]
       41 GETTABLEKS                       R7 R7 K13 ["Preferences"]
       43 GETTABLEKS                       R7 R7 K14 ["usePreferences"]
       45 CALL                             R6 1 1
       46 GETIMPORT                        R7 K6 [require]
       48 GETIMPORT                        R8 K1 [script]
       50 GETTABLEKS                       R8 R8 K4 ["Parent"]
       52 GETTABLEKS                       R8 R8 K15 ["useProgressBinding"]
       54 CALL                             R7 1 1
       55 GETIMPORT                        R8 K6 [require]
       57 GETIMPORT                        R9 K1 [script]
       59 GETTABLEKS                       R9 R9 K4 ["Parent"]
       61 GETTABLEKS                       R9 R9 K16 ["useProgressVariants"]
       63 CALL                             R8 1 1
       64 GETIMPORT                        R9 K6 [require]
       66 GETTABLEKS                       R10 R0 K17 ["Utility"]
       68 GETTABLEKS                       R10 R10 K18 ["usePulseBinding"]
       70 CALL                             R9 1 1
       71 GETIMPORT                        R10 K6 [require]
       73 GETTABLEKS                       R11 R0 K17 ["Utility"]
       75 GETTABLEKS                       R11 R11 K19 ["useRotation"]
       77 CALL                             R10 1 1
       78 GETIMPORT                        R11 K6 [require]
       80 GETTABLEKS                       R12 R0 K12 ["Providers"]
       ...
       91 GETTABLEKS                       R13 R13 K22 ["withCommonProps"]
       93 CALL                             R12 1 1
       94 GETIMPORT                        R13 K6 [require]
       96 GETTABLEKS                       R14 R0 K17 ["Utility"]
       98 GETTABLEKS                       R14 R14 K23 ["withDefaults"]
      100 CALL                             R13 1 1
