PROTO_0:
       ...
       28 JUMPIFNOT                        R0 ; [+10]
       29 GETUPVAL                         R1 3
       30 GETTABLEKS                       R1 R1 K2 ["acquire"]
       32 GETUPVAL                         R2 1
       33 DUPTABLE                         R3 K4 [{"reserve"}]
       34 LOADB                            R4 1
       35 SETTABLEKS                       R4 R3 K3 ["reserve"]
       37 CALL                             R1 2 -1
       38 RETURN                           R1 -1
       39 GETUPVAL                         R2 0
       40 GETTABLEKS                       R2 R2 K6 ["zIndex"]
       42 ADDK                             R1 R2 K5 [1]
       43 DUPTABLE                         R2 K8 [{"layer", "index", "zIndex"}]
       44 GETUPVAL                         R3 1
       45 SETTABLEKS                       R3 R2 K0 ["layer"]
       47 LOADN                            R3 255
       48 SETTABLEKS                       R3 R2 K7 ["index"]
       50 SETTABLEKS                       R1 R2 K6 ["zIndex"]
       52 RETURN                           R2 1
       53 GETUPVAL                         R1 3
       54 GETTABLEKS                       R1 R1 K2 ["acquire"]
       56 GETUPVAL                         R2 1
       57 DUPTABLE                         R3 K4 [{"reserve"}]
       58 SETTABLEKS                       R0 R3 K3 ["reserve"]
       60 CALL                             R1 2 -1
       61 RETURN                           R1 -1
