PROTO_0:
        0 GETUPVAL                         R1 0
        1 GETUPVAL                         R3 1
        2 GETTABLEKS                       R3 R3 K0 ["LOCALIZATION_TABLE_NAME"]
       ...
       22 CALL                             R2 1 1
       23 GETUPVAL                         R3 1
       24 GETTABLEKS                       R3 R3 K0 ["LOCALIZATION_TABLE_NAME"]
...
PROTO_1:
        ...
        4 GETUPVAL                         R2 1
        5 GETUPVAL                         R4 2
        6 GETTABLEKS                       R4 R4 K0 ["LOCALIZATION_TABLE_NAME"]
...
PROTO_2:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["RobloxLocaleId"]
        3 GETUPVAL                         R3 1
        4 GETTABLE                         R2 R3 R1
        5 JUMPIFNOT                        R2 ; [+2]
        6 MOVE                             R0 R2
        ...
        8 GETUPVAL                         R3 2
        9 GETUPVAL                         R5 3
       10 GETTABLEKS                       R5 R5 K1 ["LOCALIZATION_TABLE_NAME"]
...
PROTO_5:
        ...
        2 MOVE                             R5 R2
        3 GETUPVAL                         R7 1
        4 GETTABLEKS                       R7 R7 K0 ["RobloxLocaleId"]
        6 GETUPVAL                         R9 2
        7 GETTABLE                         R8 R9 R7
        8 JUMPIFNOT                        R8 ; [+2]
        9 MOVE                             R6 R8
       ...
       11 GETUPVAL                         R9 3
       12 GETUPVAL                         R11 4
       13 GETTABLEKS                       R11 R11 K1 ["LOCALIZATION_TABLE_NAME"]
...
PROTO_6:
        ...
        8 GETUPVAL                         R9 2
        9 GETUPVAL                         R11 3
       10 GETTABLEKS                       R11 R11 K0 ["LOCALIZATION_TABLE_NAME"]
...
MAIN:
       ...
       33 GETTABLEKS                       R7 R1 K13 ["Generated"]
       35 GETTABLEKS                       R7 R7 K14 ["Translations"]
       37 GETTABLEKS                       R7 R7 K15 ["GeneratedTranslations"]
       39 CALL                             R6 1 1
