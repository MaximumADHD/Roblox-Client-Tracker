PROTO_0:
        ...
        1 CALL                             R1 0 1
        2 GETUPVAL                         R3 1
        3 GETTABLEKS                       R3 R3 K0 ["FoundationFixUseScaledValueWarning"]
        5 JUMPIFNOT                        R3 ; [+8]
        6 GETTABLEKS                       R3 R1 K1 ["Config"]
        8 GETTABLEKS                       R3 R3 K2 ["UI"]
       10 GETTABLEKS                       R3 R3 K3 ["Scale"]
       12 MUL                              R2 R0 R3
       13 JUMP                             ; [+1]
       14 MOVE                             R2 R0
       15 GETTABLEKS                       R3 R1 K4 ["Size"]
       17 GETTABLEKS                       R3 R3 K5 ["Size_3000"]
       ...
       25 CALL                             R3 2 0
       26 GETUPVAL                         R3 1
       27 GETTABLEKS                       R3 R3 K0 ["FoundationFixUseScaledValueWarning"]
       29 JUMPIFNOT                        R3 ; [+1]
       30 RETURN                           R2 1
       31 GETTABLEKS                       R4 R1 K1 ["Config"]
       33 GETTABLEKS                       R4 R4 K2 ["UI"]
       35 GETTABLEKS                       R4 R4 K3 ["Scale"]
       37 MUL                              R3 R0 R4
       38 RETURN                           R3 1
