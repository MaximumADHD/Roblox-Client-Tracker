PROTO_0:
       ...
       13 LOADK                            R9 K4 ["auto-xy size-full col align-y-center align-x-center gap-small"]
       ...
       25 GETTABLEKS                       R12 R2 K14 ["icon"]
       27 GETTABLEKS                       R11 R12 K9 ["name"]
       29 SETTABLEKS                       R11 R10 K9 ["name"]
       31 GETTABLEKS                       R12 R2 K14 ["icon"]
       33 GETTABLEKS                       R11 R12 K10 ["size"]
       35 SETTABLEKS                       R11 R10 K10 ["size"]
       37 GETTABLEKS                       R13 R3 K15 ["Color"]
       39 GETTABLEKS                       R12 R13 K16 ["Content"]
       41 GETTABLEKS                       R11 R12 K17 ["Default"]
       ...
       51 GETUPVAL                         R9 3
       52 GETTABLEKS                       R8 R9 K0 ["createElement"]
       54 GETUPVAL                         R9 7
       ...
       63 LOADK                            R11 K21 ["size-full-0 auto-y text-body-large content-default text-wrap text-align-x-center"]
       ...
       80 JUMPIFNOT                        R9 ; [+33]
       81 GETTABLEKS                       R10 R2 K24 ["button"]
       83 GETTABLEKS                       R9 R10 K25 ["onActivated"]
       85 JUMPIFNOT                        R9 ; [+28]
       86 GETUPVAL                         R9 3
       87 GETTABLEKS                       R8 R9 K0 ["createElement"]
       89 GETUPVAL                         R9 8
       90 DUPTABLE                         R10 K26 [{"text", "icon", "onActivated", "LayoutOrder"}]
       91 GETTABLEKS                       R12 R2 K24 ["button"]
       93 GETTABLEKS                       R11 R12 K20 ["text"]
       95 SETTABLEKS                       R11 R10 K20 ["text"]
       97 GETTABLEKS                       R12 R2 K24 ["button"]
       99 GETTABLEKS                       R11 R12 K14 ["icon"]
      101 SETTABLEKS                       R11 R10 K14 ["icon"]
      103 GETTABLEKS                       R12 R2 K24 ["button"]
      105 GETTABLEKS                       R11 R12 K25 ["onActivated"]
...
MAIN:
       ...
       51 GETTABLEKS                       R11 R0 K15 ["Utility"]
       53 GETTABLEKS                       R10 R11 K16 ["Localization"]
       55 GETTABLEKS                       R9 R10 K17 ["Translator"]
       57 CALL                             R8 1 1
       58 GETIMPORT                        R9 K6 [require]
       60 GETTABLEKS                       R11 R0 K8 ["Components"]
       62 GETTABLEKS                       R10 R11 K18 ["Types"]
       64 CALL                             R9 1 1
       65 GETIMPORT                        R10 K6 [require]
       67 GETTABLEKS                       R13 R0 K19 ["Providers"]
       69 GETTABLEKS                       R12 R13 K20 ["Style"]
       71 GETTABLEKS                       R11 R12 K21 ["useTokens"]
       73 CALL                             R10 1 1
       74 GETIMPORT                        R11 K6 [require]
       76 GETTABLEKS                       R13 R0 K15 ["Utility"]
       78 GETTABLEKS                       R12 R13 K22 ["withCommonProps"]
       80 CALL                             R11 1 1
       81 GETIMPORT                        R12 K6 [require]
       83 GETTABLEKS                       R14 R0 K15 ["Utility"]
       85 GETTABLEKS                       R13 R14 K23 ["withDefaults"]
       87 CALL                             R12 1 1
