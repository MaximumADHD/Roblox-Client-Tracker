...
PROTO_3:
        0 GETUPVAL                         R3 0
        1 GETTABLEKS                       R3 R3 K0 ["useLayoutEffect"]
        3 NEWCLOSURE                       R4 P0
        4 CAPTURE                          VAL R0
        5 CAPTURE                          VAL R1
        6 CAPTURE                          VAL R2
...
PROTO_6:
       ...
       13 GETUPVAL                         R1 1
       14 GETTABLEKS                       R1 R1 K4 ["position"]
       16 JUMP                             ; [+1]
       17 GETUPVAL                         R1 1
       18 GETUPVAL                         R4 1
       ...
       42 ORK                              R4 R5 K6 [0]
       43 GETUPVAL                         R5 4
       44 GETTABLEKS                       R5 R5 K7 ["calculatePopoverBounds"]
       46 MOVE                             R6 R1
       47 MOVE                             R7 R2
       48 MOVE                             R8 R3
       49 MOVE                             R9 R4
       ...
       77 CALL                             R7 -1 0
       78 GETUPVAL                         R7 0
       79 GETTABLEKS                       R7 R7 K17 ["AbsolutePosition"]
       81 GETUPVAL                         R8 8
       82 JUMPIFNOT                        R8 ; [+19]
       83 GETUPVAL                         R8 9
       84 GETTABLEKS                       R8 R8 K18 ["current"]
       86 JUMPIFNOT                        R8 ; [+6]
       87 GETIMPORT                        R8 K21 [task.cancel]
       89 GETUPVAL                         R9 9
       90 GETTABLEKS                       R9 R9 K18 ["current"]
       92 CALL                             R8 1 0
       93 GETUPVAL                         R8 9
...
PROTO_10:
        0 GETUPVAL                         R5 0
        1 GETTABLEKS                       R5 R5 K0 ["useBinding"]
        3 GETIMPORT                        R6 K3 [UDim2.new]
        5 CALL                             R6 0 -1
        6 CALL                             R5 -1 2
        7 GETUPVAL                         R7 0
        8 GETTABLEKS                       R7 R7 K0 ["useBinding"]
       10 GETIMPORT                        R8 K3 [UDim2.new]
       12 CALL                             R8 0 -1
       13 CALL                             R7 -1 2
       14 GETUPVAL                         R9 0
       15 GETTABLEKS                       R9 R9 K4 ["useRef"]
       17 LOADNIL                          R10
       18 CALL                             R9 1 1
       19 GETUPVAL                         R10 0
       20 GETTABLEKS                       R10 R10 K4 ["useRef"]
       22 DUPCLOSURE                       R11 K5 [PROTO_4]
       23 CALL                             R10 1 1
       24 GETUPVAL                         R11 0
       25 GETTABLEKS                       R11 R11 K6 ["useCallback"]
       ...
       55 GETUPVAL                         R13 0
       56 GETTABLEKS                       R13 R13 K9 ["useLayoutEffect"]
       ...
       68 CALL                             R13 2 0
       69 GETUPVAL                         R12 0
       70 GETTABLEKS                       R12 R12 K9 ["useLayoutEffect"]
       ...
       79 CALL                             R12 2 0
       80 GETUPVAL                         R12 0
       81 GETTABLEKS                       R12 R12 K10 ["useEffect"]
...
MAIN:
       ...
       18 GETTABLEKS                       R4 R4 K9 ["StudioPanels"]
       20 GETTABLEKS                       R4 R4 K10 ["Types"]
       22 CALL                             R3 1 1
       23 GETIMPORT                        R4 K6 [require]
       25 GETTABLEKS                       R5 R0 K11 ["Enums"]
       27 GETTABLEKS                       R5 R5 K12 ["PopoverAlign"]
       29 CALL                             R4 1 1
       30 GETIMPORT                        R5 K6 [require]
       32 GETTABLEKS                       R6 R0 K11 ["Enums"]
       34 GETTABLEKS                       R6 R6 K13 ["PopoverSide"]
       36 CALL                             R5 1 1
       ...
       50 GETTABLEKS                       R8 R8 K15 ["positioning"]
       52 CALL                             R7 1 1
