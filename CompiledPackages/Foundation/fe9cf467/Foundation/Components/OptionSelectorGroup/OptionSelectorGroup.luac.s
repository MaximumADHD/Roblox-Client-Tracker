...
PROTO_1:
        ...
        2 CALL                             R1 1 0
        3 GETUPVAL                         R2 1
        4 GETTABLEKS                       R1 R2 K0 ["onValueChanged"]
        6 MOVE                             R2 R0
        7 CALL                             R1 1 0
        8 RETURN                           R0 0
...
PROTO_2:
       ...
       22 CALL                             R5 2 0
       23 GETUPVAL                         R6 2
       24 GETTABLEKS                       R5 R6 K3 ["useCallback"]
       26 NEWCLOSURE                       R6 P1
       27 CAPTURE                          VAL R4
       28 CAPTURE                          VAL R2
       29 NEWTABLE                         R7 0 2
       ...
       36 CALL                             R5 2 1
       37 GETUPVAL                         R7 2
       38 GETTABLEKS                       R6 R7 K5 ["createElement"]
       40 GETUPVAL                         R7 3
       41 GETUPVAL                         R8 4
       42 MOVE                             R9 R2
       43 DUPTABLE                         R10 K8 [{"tag", "ref"}]
       44 GETUPVAL                         R13 5
       45 GETTABLEKS                       R12 R13 K9 ["FoundationFixOptionSelectorGroupItemSize"]
       47 JUMPIFNOT                        R12 ; [+28]
       48 NEWTABLE                         R11 4 0
       50 GETTABLEKS                       R13 R2 K10 ["orientation"]
       52 GETUPVAL                         R15 6
       53 GETTABLEKS                       R14 R15 K11 ["Vertical"]
       ...
       63 GETUPVAL                         R15 6
       64 GETTABLEKS                       R14 R15 K13 ["Horizontal"]
       ...
       80 GETUPVAL                         R15 6
       81 GETTABLEKS                       R14 R15 K11 ["Vertical"]
       ...
       91 GETUPVAL                         R15 6
       92 GETTABLEKS                       R14 R15 K13 ["Horizontal"]
      ...
      109 GETUPVAL                         R11 2
      110 GETTABLEKS                       R10 R11 K5 ["createElement"]
      112 GETUPVAL                         R12 7
      113 GETTABLEKS                       R11 R12 K19 ["Provider"]
...
MAIN:
       ...
       25 GETTABLEKS                       R5 R6 K11 ["Orientation"]
       27 CALL                             R4 1 1
       ...
       53 GETTABLEKS                       R9 R10 K16 ["withDefaults"]
       55 CALL                             R8 1 1
       56 GETIMPORT                        R9 K6 [require]
       58 GETIMPORT                        R12 K1 [script]
       60 GETTABLEKS                       R11 R12 K4 ["Parent"]
       62 GETTABLEKS                       R10 R11 K17 ["OptionSelectorGroupContext"]
       64 CALL                             R9 1 1
