...
PROTO_6:
       ...
       29 GETUPVAL                         R6 1
       30 DUPTABLE                         R7 K6 [{["tag"] = "col gap-medium size-full-0 auto-y"}]
       31 DUPTABLE                         R8 K11 [{"Title", "CircleProgress", "BarProgress", "Button"}]
       32 GETUPVAL                         R9 0
       33 GETTABLEKS                       R9 R9 K3 ["createElement"]
       35 GETUPVAL                         R10 2
       36 DUPTABLE                         R11 K16 [{["Text"], ["tag"] = "size-0-0 auto-xy text-title-small content-emphasis", ["LayoutOrder"] = 1}]
       37 DUPCLOSURE                       R14 K17 [PROTO_5]
       38 NAMECALL                         R12 R0 K18 ["map"]
       40 CALL                             R12 2 1
       41 SETTABLEKS                       R12 R11 K12 ["Text"]
       43 CALL                             R9 2 1
       44 SETTABLEKS                       R9 R8 K7 ["Title"]
       46 GETUPVAL                         R9 0
       47 GETTABLEKS                       R9 R9 K3 ["createElement"]
       49 GETUPVAL                         R10 3
       50 DUPTABLE                         R11 K23 [{["shape"], ["value"], ["size"], ["LayoutOrder"] = 2}]
       51 GETUPVAL                         R12 4
       52 GETTABLEKS                       R12 R12 K24 ["Circle"]
       54 SETTABLEKS                       R12 R11 K19 ["shape"]
       56 SETTABLEKS                       R0 R11 K20 ["value"]
       58 GETUPVAL                         R12 5
       59 GETTABLEKS                       R12 R12 K25 ["Large"]
       61 SETTABLEKS                       R12 R11 K21 ["size"]
       63 CALL                             R9 2 1
       64 SETTABLEKS                       R9 R8 K8 ["CircleProgress"]
       66 GETUPVAL                         R9 0
       67 GETTABLEKS                       R9 R9 K3 ["createElement"]
       69 GETUPVAL                         R10 3
       70 DUPTABLE                         R11 K27 [{["shape"], ["value"], ["size"], ["LayoutOrder"] = 3}]
       71 GETUPVAL                         R12 4
       72 GETTABLEKS                       R12 R12 K28 ["Bar"]
       74 SETTABLEKS                       R12 R11 K19 ["shape"]
       76 SETTABLEKS                       R0 R11 K20 ["value"]
       78 GETUPVAL                         R12 5
       79 GETTABLEKS                       R12 R12 K29 ["Medium"]
       81 SETTABLEKS                       R12 R11 K21 ["size"]
       83 CALL                             R9 2 1
       84 SETTABLEKS                       R9 R8 K9 ["BarProgress"]
       86 GETUPVAL                         R9 0
       87 GETTABLEKS                       R9 R9 K3 ["createElement"]
       89 GETUPVAL                         R10 6
       90 DUPTABLE                         R11 K34 [{["text"], ["onActivated"], ["isDisabled"], ["LayoutOrder"] = 4}]
       91 JUMPIFNOT                        R2 ; [+2]
       92 LOADK                            R12 K35 ["Animating..."]
       93 JUMP                             ; [+1]
       94 LOADK                            R12 K36 ["Start Animation"]
       95 SETTABLEKS                       R12 R11 K30 ["text"]
       97 SETTABLEKS                       R4 R11 K31 ["onActivated"]
       99 SETTABLEKS                       R2 R11 K32 ["isDisabled"]
      101 CALL                             R9 2 1
      102 SETTABLEKS                       R9 R8 K10 ["Button"]
      104 CALL                             R5 3 -1
      105 RETURN                           R5 -1
...
PROTO_7:
        ...
        9 GETUPVAL                         R6 2
       10 DUPTABLE                         R7 K12 [{["Text"], ["tag"] = "size-1500-0 auto-y text-body-small text-align-x-right content-default", ["LayoutOrder"] = 1}]
       11 LOADK                            R9 K13 ["%*:"]
       12 MOVE                             R11 R0
...
PROTO_9:
        ...
        3 GETUPVAL                         R1 1
        4 DUPTABLE                         R2 K3 [{["tag"] = "col gap-medium size-full-0 auto-y"}]
...
MAIN:
       ...
       30 GETTABLEKS                       R6 R6 K11 ["Progress"]
       32 CALL                             R5 1 1
       33 GETIMPORT                        R6 K6 [require]
       35 GETTABLEKS                       R7 R0 K12 ["Enums"]
       37 GETTABLEKS                       R7 R7 K13 ["ProgressShape"]
       39 CALL                             R6 1 1
       40 GETIMPORT                        R7 K6 [require]
       42 GETTABLEKS                       R8 R0 K12 ["Enums"]
       44 GETTABLEKS                       R8 R8 K14 ["ProgressSize"]
       46 CALL                             R7 1 1
      ...
      106 GETTABLEKS                       R16 R2 K43 ["values"]
      108 MOVE                             R17 R6
      109 CALL                             R16 1 1
      110 SETTABLEKS                       R16 R15 K36 ["shape"]
      112 GETTABLEKS                       R16 R2 K43 ["values"]
      114 MOVE                             R17 R7
      115 CALL                             R16 1 1
