...
PROTO_3:
       ...
       24 GETUPVAL                         R9 0
       25 GETTABLEKS                       R9 R9 K11 ["Standard"]
       27 JUMP                             ; [+3]
       28 GETUPVAL                         R9 0
       29 GETTABLEKS                       R9 R9 K12 ["Utility"]
       ...
       44 FORNLOOP                         R3
       45 GETUPVAL                         R3 2
       46 GETTABLEKS                       R3 R3 K16 ["createElement"]
       48 GETUPVAL                         R4 3
       49 DUPTABLE                         R5 K24 [{"title", "subtitle", "description", "severity", "link", "actions", "onClose"}]
       50 GETTABLEKS                       R6 R0 K0 ["controls"]
       52 GETTABLEKS                       R6 R6 K17 ["title"]
       54 SETTABLEKS                       R6 R5 K17 ["title"]
       56 GETTABLEKS                       R7 R0 K0 ["controls"]
       58 GETTABLEKS                       R7 R7 K18 ["subtitle"]
       60 JUMPIFEQKS                       R7 K25 [""] ; [+6]
       62 GETTABLEKS                       R6 R0 K0 ["controls"]
       64 GETTABLEKS                       R6 R6 K18 ["subtitle"]
       66 JUMP                             ; [+1]
       67 LOADNIL                          R6
       68 SETTABLEKS                       R6 R5 K18 ["subtitle"]
       70 GETTABLEKS                       R7 R0 K0 ["controls"]
       72 GETTABLEKS                       R7 R7 K19 ["description"]
       74 JUMPIFEQKS                       R7 K25 [""] ; [+6]
       76 GETTABLEKS                       R6 R0 K0 ["controls"]
       78 GETTABLEKS                       R6 R6 K19 ["description"]
       80 JUMP                             ; [+1]
       81 LOADNIL                          R6
       82 SETTABLEKS                       R6 R5 K19 ["description"]
       84 GETUPVAL                         R6 4
       85 SETTABLEKS                       R6 R5 K20 ["severity"]
       87 GETTABLEKS                       R7 R0 K0 ["controls"]
       89 GETTABLEKS                       R7 R7 K26 ["linkText"]
       91 JUMPIFEQKS                       R7 K25 [""] ; [+13]
       93 DUPTABLE                         R6 K27 [{"text", "onActivated"}]
       94 GETTABLEKS                       R7 R0 K0 ["controls"]
       96 GETTABLEKS                       R7 R7 K26 ["linkText"]
      ...
      117 GETTABLEKS                       R7 R0 K0 ["controls"]
      119 GETTABLEKS                       R7 R7 K28 ["hasCloseAffordance"]
      121 JUMPIFNOT                        R7 ; [+3]
...
MAIN:
       ...
       30 GETTABLEKS                       R6 R6 K11 ["ButtonVariant"]
       32 CALL                             R5 1 1
       33 GETIMPORT                        R6 K6 [require]
       35 GETTABLEKS                       R7 R0 K12 ["Components"]
       37 GETTABLEKS                       R7 R7 K13 ["FeedbackAlert"]
       39 CALL                             R6 1 1
       40 DUPTABLE                         R7 K17 [{["summary"] = "FeedbackAlert", ["stories"], ["controls"]}]
       41 GETTABLEKS                       R8 R2 K18 ["map"]
       43 MOVE                             R9 R4
       44 DUPCLOSURE                       R10 K19 [PROTO_4]
       45 CAPTURE                          VAL R5
       46 CAPTURE                          VAL R3
       47 CAPTURE                          VAL R6
       48 CALL                             R8 2 1
       49 SETTABLEKS                       R8 R7 K15 ["stories"]
       51 DUPTABLE                         R8 K31 [{["title"] = "Title", ["subtitle"] = "Description", ["description"] = "InlineAlerts are displayed in-line with page content. e.g., a form error. It is immediate feedback that's tied to page content.", ["linkText"] = "Link", ["actionCount"], ["hasCloseAffordance"] = True}]
       52 NEWTABLE                         R9 0 4
       54 LOADN                            R10 0
       55 LOADN                            R11 1
       56 LOADN                            R12 2
       ...
       60 SETTABLEKS                       R9 R8 K28 ["actionCount"]
       62 SETTABLEKS                       R8 R7 K16 ["controls"]
       64 RETURN                           R7 1
