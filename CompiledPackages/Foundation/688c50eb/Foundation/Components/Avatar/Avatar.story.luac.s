...
PROTO_1:
        ...
        1 GETTABLEKS                       R1 R1 K0 ["createElement"]
        3 GETUPVAL                         R2 1
        4 DUPTABLE                         R3 K3 [{["tag"] = "col gap-large auto-xy"}]
        5 DUPTABLE                         R4 K6 [{"Header", "Avatars"}]
        6 GETUPVAL                         R5 0
        7 GETTABLEKS                       R5 R5 K0 ["createElement"]
        9 GETUPVAL                         R6 2
       10 DUPTABLE                         R7 K9 [{["Text"], ["tag"] = "align-x-left size-0-0 auto-xy text-caption-medium content-default"}]
       ...
       24 GETUPVAL                         R6 1
       25 DUPTABLE                         R7 K13 [{["tag"] = "row gap-xxlarge auto-xy"}]
       26 GETUPVAL                         R8 3
...
PROTO_2:
        ...
        5 GETUPVAL                         R2 2
        6 DUPTABLE                         R3 K3 [{["tag"] = "col gap-medium auto-xy"}]
        7 GETUPVAL                         R4 3
