PROTO_0:
       ...
       39 GETUPVAL                         R3 5
       40 DUPTABLE                         R4 K12 [{["tag"] = "col align-y-center gap-xxlarge size-full-2000 padding-large bg-surface-0"}]
       41 MOVE                             R5 R0
       42 CALL                             R2 3 -1
       43 RETURN                           R2 -1
...
PROTO_1:
        ...
        3 GETUPVAL                         R1 1
        4 DUPTABLE                         R2 K3 [{["tag"] = "row align-x-center align-y-center gap-large size-full-2000 padding-large bg-surface-0"}]
