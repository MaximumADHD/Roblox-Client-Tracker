...
PROTO_7:
       ...
       23 GETUPVAL                         R7 2
       24 DUPTABLE                         R8 K9 [{["cursor"], ["onActivated"], ["tag"] = "col align-x-center align-y-center gap-medium auto-y padding-large stroke-muted radius-medium bg-surface-100", ["Size"]}]
       ...
       66 GETUPVAL                         R11 4
       67 DUPTABLE                         R12 K30 [{["Text"] = "Get notified when someone mentions you or sends you a message", ["tag"] = "size-full-0 auto-y text-body-small text-wrap content-muted", ["LayoutOrder"] = 2}]
       68 CALL                             R10 2 1
...
PROTO_12:
       ...
       34 GETUPVAL                         R12 1
       35 DUPTABLE                         R13 K6 [{["tag"] = "col gap-medium size-3000-0 auto-xy"}]
