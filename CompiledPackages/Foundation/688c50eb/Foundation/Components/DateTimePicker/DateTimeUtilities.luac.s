...
PROTO_3:
       ...
       11 CALL                             R2 3 1
       12 GETTABLEKS                       R2 R2 K7 ["UnixTimestamp"]
       14 RETURN                           R2 1
...
PROTO_5:
       ...
       13 CALL                             R5 3 1
       14 MOVE                             R2 R5
       15 GETTABLEKS                       R2 R2 K8 ["UnixTimestamp"]
       17 GETTABLEKS                       R4 R1 K9 ["endDate"]
       19 NAMECALL                         R5 R4 K1 ["ToLocalTime"]
       21 CALL                             R5 1 1
       22 GETIMPORT                        R6 K4 [DateTime.fromLocalTime]
       24 GETTABLEKS                       R7 R5 K5 ["Year"]
       26 GETTABLEKS                       R8 R5 K6 ["Month"]
       28 GETTABLEKS                       R9 R5 K7 ["Day"]
       30 CALL                             R6 3 1
       31 MOVE                             R3 R6
       32 GETTABLEKS                       R3 R3 K8 ["UnixTimestamp"]
       34 NAMECALL                         R5 R0 K1 ["ToLocalTime"]
       36 CALL                             R5 1 1
       37 GETIMPORT                        R6 K4 [DateTime.fromLocalTime]
       39 GETTABLEKS                       R7 R5 K5 ["Year"]
       41 GETTABLEKS                       R8 R5 K6 ["Month"]
       43 GETTABLEKS                       R9 R5 K7 ["Day"]
       45 CALL                             R6 3 1
       46 MOVE                             R4 R6
       47 GETTABLEKS                       R4 R4 K8 ["UnixTimestamp"]
       49 LOADB                            R5 0
       50 JUMPIFNOTLE                      R2 R4 ; [+5]
       52 JUMPIFLE                         R4 R3 ; [+2]
       54 LOADB                            R5 0 +1
       55 LOADB                            R5 1
       56 RETURN                           R5 1
...
PROTO_8:
       ...
       42 JUMPIFNOT                        R7 ; [+18]
       43 JUMPIFNOT                        R8 ; [+17]
       44 GETIMPORT                        R9 K15 [os.date]
       46 LOADK                            R10 K16 ["*t"]
       47 GETTABLEKS                       R11 R8 K17 ["UnixTimestamp"]
       49 CALL                             R9 2 1
       50 GETTABLEKS                       R9 R9 K18 ["isdst"]
       52 JUMPIFNOT                        R9 ; [+7]
       53 GETTABLEKS                       R10 R8 K17 ["UnixTimestamp"]
       55 GETIMPORT                        R11 K21 [DateTime.fromUnixTimestamp]
       57 SUBK                             R12 R10 K22 [3600]
       58 CALL                             R11 1 1
       59 MOVE                             R8 R11
       60 RETURN                           R8 1
       61 LOADNIL                          R6
...
PROTO_11:
        0 LOADK                            R4 K0 ["L"]
        1 GETUPVAL                         R5 0
        2 GETTABLEKS                       R5 R5 K1 ["RobloxLocaleId"]
       ...
       10 LOADK                            R7 K4 ["LT"]
       11 GETUPVAL                         R8 0
       12 GETTABLEKS                       R8 R8 K1 ["RobloxLocaleId"]
...
MAIN:
       ...
       16 GETTABLEKS                       R1 R1 K9 ["LocalizationService"]
       18 GETIMPORT                        R2 K5 [require]
       20 GETTABLEKS                       R3 R0 K6 ["Utility"]
       22 GETTABLEKS                       R3 R3 K10 ["Localization"]
       24 GETTABLEKS                       R3 R3 K11 ["Translator"]
       26 CALL                             R2 1 1
       27 NEWTABLE                         R3 0 12
      ...
      106 LOADK                            R7 K28 ["CommonUI.Controls.Label.WednesdayAbbreviated"]
      ...
      139 CAPTURE                          VAL R1
      140 DUPTABLE                         R16 K59 [{["DATE_COMPOSITE_TOKEN"] = "L", ["TIME_COMPOSITE_TOKEN"] = "LT", ["formatLocalTime"], ["getDaysInMonth"], ["getFirstDayOfWeek"], ["getLastDayOfWeek"], ["getNextMonthInfo"], ["getPrevMonthInfo"], ["isDateWithinRange"], ["getDateTimeFromText"], ["monthMap"], ["roundDownToNearestMinute"], ["roundToStartOfDay"], ["weekdays"]}]
      141 SETTABLEKS                       R15 R16 K47 ["formatLocalTime"]
      143 SETTABLEKS                       R5 R16 K48 ["getDaysInMonth"]
      145 SETTABLEKS                       R6 R16 K49 ["getFirstDayOfWeek"]
      147 SETTABLEKS                       R7 R16 K50 ["getLastDayOfWeek"]
      149 SETTABLEKS                       R14 R16 K51 ["getNextMonthInfo"]
      151 SETTABLEKS                       R13 R16 K52 ["getPrevMonthInfo"]
      153 SETTABLEKS                       R10 R16 K53 ["isDateWithinRange"]
      155 SETTABLEKS                       R12 R16 K54 ["getDateTimeFromText"]
      157 SETTABLEKS                       R3 R16 K55 ["monthMap"]
      159 SETTABLEKS                       R9 R16 K56 ["roundDownToNearestMinute"]
      161 SETTABLEKS                       R8 R16 K57 ["roundToStartOfDay"]
      163 SETTABLEKS                       R4 R16 K58 ["weekdays"]
      165 RETURN                           R16 1
