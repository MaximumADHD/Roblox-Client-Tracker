PROTO_0:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R0 R1 K0 ["OnScreenKeyboardVisible"]
        3 JUMPIF                           R0 ; [+8]
        4 GETUPVAL                         R0 1
       ...
       15 CALL                             R0 1 1
       16 GETUPVAL                         R4 0
       17 GETTABLEKS                       R3 R4 K5 ["OnScreenKeyboardPosition"]
       19 GETTABLEKS                       R2 R3 K6 ["Y"]
       21 GETTABLEKS                       R3 R0 K6 ["Y"]
       23 SUB                              R1 R2 R3
       24 GETUPVAL                         R3 3
       25 GETTABLEKS                       R2 R3 K7 ["AbsoluteSize"]
       27 GETUPVAL                         R4 3
       28 GETTABLEKS                       R3 R4 K8 ["AbsolutePosition"]
       30 GETTABLEKS                       R5 R3 K6 ["Y"]
       32 GETTABLEKS                       R6 R2 K6 ["Y"]
       34 ADD                              R4 R5 R6
       35 SUB                              R5 R4 R1
       36 GETUPVAL                         R7 4
       37 GETTABLEKS                       R6 R7 K9 ["FoundationOverlayKeyboardAwarenessHardened"]
       39 JUMPIFNOT                        R6 ; [+17]
...
PROTO_1:
        ...
        7 CALL                             R0 1 0
        8 GETUPVAL                         R1 2
        9 GETTABLEKS                       R0 R1 K1 ["FoundationOverlayKeyboardAwarenessHardened"]
       11 JUMPIFNOT                        R0 ; [+4]
       12 GETUPVAL                         R0 3
...
PROTO_2:
       ...
       30 LOADNIL                          R3
       31 GETUPVAL                         R5 4
       32 GETTABLEKS                       R4 R5 K4 ["FoundationOverlayKeyboardAwarenessHardened"]
       34 JUMPIFNOT                        R4 ; [+10]
       35 GETUPVAL                         R4 0
...
PROTO_3:
        ...
        8 CALL                             R1 -1 2
        9 GETUPVAL                         R4 0
       10 GETTABLEKS                       R3 R4 K4 ["useLayoutEffect"]
       12 NEWCLOSURE                       R4 P0
       13 CAPTURE                          VAL R0
       14 CAPTURE                          UPVAL U1
       15 CAPTURE                          VAL R2
...
MAIN:
       ...
       13 GETTABLEKS                       R3 R4 K8 ["Wrappers"]
       15 CALL                             R2 1 1
       16 GETTABLEKS                       R4 R2 K9 ["Services"]
       18 GETTABLEKS                       R3 R4 K10 ["GuiService"]
       20 GETTABLEKS                       R5 R2 K9 ["Services"]
       22 GETTABLEKS                       R4 R5 K11 ["UserInputService"]
       24 GETIMPORT                        R5 K6 [require]
       26 GETTABLEKS                       R7 R0 K7 ["Utility"]
