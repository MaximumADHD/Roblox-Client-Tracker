...
PROTO_2:
       ...
       34 LOADB                            R6 1
       35 GETUPVAL                         R8 4
       36 GETTABLEKS                       R7 R8 K7 ["useMemo"]
       38 NEWCLOSURE                       R8 P0
       39 CAPTURE                          VAL R2
       40 NEWTABLE                         R9 0 1
       ...
       82 GETUPVAL                         R13 4
       83 GETTABLEKS                       R12 R13 K12 ["Tag"]
       85 SETTABLE                         R5 R11 R12
       86 CALL                             R9 2 1
       87 GETUPVAL                         R11 7
       88 GETTABLEKS                       R10 R11 K13 ["FoundationBuildingBlocksRemoveDashUnion"]
       90 JUMPIFNOT                        R10 ; [+39]
       91 MOVE                             R10 R8
       92 JUMPIFNOT                        R6 ; [+27]
       93 GETUPVAL                         R10 8
      ...
      120 GETUPVAL                         R12 4
      121 GETTABLEKS                       R11 R12 K18 ["createElement"]
      123 MOVE                             R12 R10
      124 MOVE                             R13 R9
      125 GETUPVAL                         R14 9
      126 MOVE                             R15 R2
      ...
      161 JUMPIFNOT                        R6 ; [+7]
      162 GETUPVAL                         R13 10
      163 GETTABLEKS                       R12 R13 K20 ["union"]
      165 MOVE                             R13 R9
      166 MOVE                             R14 R11
      167 CALL                             R12 2 1
      168 JUMP                             ; [+1]
      169 MOVE                             R12 R9
      170 GETUPVAL                         R14 4
      171 GETTABLEKS                       R13 R14 K18 ["createElement"]
      173 MOVE                             R14 R10
      174 MOVE                             R15 R12
      175 GETUPVAL                         R16 9
      176 MOVE                             R17 R2
...
MAIN:
       ...
       42 GETTABLEKS                       R9 R0 K9 ["Utility"]
       44 GETTABLEKS                       R8 R9 K14 ["GuiObjectChildren"]
       46 CALL                             R7 1 1
       ...
       56 GETTABLEKS                       R11 R0 K9 ["Utility"]
       58 GETTABLEKS                       R10 R11 K16 ["useDefaultTags"]
       60 CALL                             R9 1 1
       61 GETIMPORT                        R10 K6 [require]
       63 GETTABLEKS                       R12 R0 K9 ["Utility"]
       65 GETTABLEKS                       R11 R12 K17 ["withDefaults"]
       67 CALL                             R10 1 1
       68 GETIMPORT                        R11 K6 [require]
       70 GETTABLEKS                       R13 R0 K9 ["Utility"]
       72 GETTABLEKS                       R12 R13 K18 ["withGuiObjectProps"]
       74 CALL                             R11 1 1
       ...
       88 GETTABLEKS                       R14 R15 K23 ["ControlState"]
       90 CALL                             R13 1 1
       91 DUPTABLE                         R14 K28 [{"layout", "AutoLocalize", "BorderSizePixel", "isDisabled"}]
       92 DUPTABLE                         R15 K30 [{"SortOrder"}]
       93 GETIMPORT                        R16 K33 [Enum.SortOrder.LayoutOrder]
       95 SETTABLEKS                       R16 R15 K29 ["SortOrder"]
       97 SETTABLEKS                       R15 R14 K24 ["layout"]
       99 LOADB                            R15 0
      100 SETTABLEKS                       R15 R14 K25 ["AutoLocalize"]
      102 LOADN                            R15 0
      103 SETTABLEKS                       R15 R14 K26 ["BorderSizePixel"]
      105 LOADB                            R15 0
      106 SETTABLEKS                       R15 R14 K27 ["isDisabled"]
      108 DUPCLOSURE                       R15 K34 [PROTO_2]
      109 CAPTURE                          VAL R10
      110 CAPTURE                          VAL R14
      111 CAPTURE                          VAL R9
      112 CAPTURE                          VAL R12
      ...
      118 CAPTURE                          VAL R7
      119 CAPTURE                          VAL R2
      120 GETTABLEKS                       R16 R3 K35 ["memo"]
      122 GETTABLEKS                       R17 R3 K36 ["forwardRef"]
      124 MOVE                             R18 R15
      125 CALL                             R17 1 -1
      126 CALL                             R16 -1 -1
      127 RETURN                           R16 -1
