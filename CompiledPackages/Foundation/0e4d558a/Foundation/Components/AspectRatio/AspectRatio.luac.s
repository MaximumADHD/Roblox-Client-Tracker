PROTO_0:
       ...
       10 CALL                             R1 1 1
       11 JUMPIFNOTEQKS                    R1 K3 ["number"] ; [+11]
       13 DUPTABLE                         R1 K7 [{"AspectRatio", "AspectType", "DominantAxis"}]
       14 SETTABLEKS                       R0 R1 K4 ["AspectRatio"]
       16 LOADNIL                          R2
       17 SETTABLEKS                       R2 R1 K5 ["AspectType"]
       19 LOADNIL                          R2
       20 SETTABLEKS                       R2 R1 K6 ["DominantAxis"]
       22 RETURN                           R1 1
       23 DUPTABLE                         R1 K7 [{"AspectRatio", "AspectType", "DominantAxis"}]
       24 GETTABLEKS                       R2 R0 K4 ["AspectRatio"]
       26 SETTABLEKS                       R2 R1 K4 ["AspectRatio"]
       28 GETTABLEKS                       R2 R0 K5 ["AspectType"]
       30 SETTABLEKS                       R2 R1 K5 ["AspectType"]
       32 GETTABLEKS                       R2 R0 K6 ["DominantAxis"]
       34 SETTABLEKS                       R2 R1 K6 ["DominantAxis"]
       36 RETURN                           R1 1
