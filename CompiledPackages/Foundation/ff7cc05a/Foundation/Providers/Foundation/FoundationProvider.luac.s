PROTO_0:
       ...
       32 CALL                             R7 2 1
       33 GETUPVAL                         R9 0
       34 GETTABLEKS                       R8 R9 K2 ["createElement"]
       36 GETUPVAL                         R9 3
       37 LOADNIL                          R10
       38 CALL                             R8 2 1
       39 GETUPVAL                         R10 0
       40 GETTABLEKS                       R9 R10 K2 ["createElement"]
       42 GETUPVAL                         R10 4
       43 MOVE                             R11 R1
       44 CALL                             R9 2 1
       45 GETUPVAL                         R11 0
       46 GETTABLEKS                       R10 R11 K2 ["createElement"]
       48 GETUPVAL                         R11 5
       ...
       66 CALL                             R10 2 1
       67 GETUPVAL                         R12 0
       68 GETTABLEKS                       R11 R12 K2 ["createElement"]
       70 GETUPVAL                         R12 6
       71 DUPTABLE                         R13 K13 [{"config"}]
       72 SETTABLEKS                       R2 R13 K12 ["config"]
       74 CALL                             R11 2 1
       75 GETUPVAL                         R13 0
       76 GETTABLEKS                       R12 R13 K2 ["createElement"]
       78 GETUPVAL                         R13 7
       79 GETUPVAL                         R16 8
       80 GETTABLEKS                       R15 R16 K14 ["FoundationOverlayDisplayOrder"]
       82 JUMPIFNOT                        R15 ; [+16]
       ...
       92 GETTABLEKS                       R16 R0 K15 ["overlayGui"]
       94 GETTABLEKS                       R15 R16 K19 ["DisplayOrder"]
      ...
      104 CALL                             R12 2 1
      105 GETUPVAL                         R14 0
      106 GETTABLEKS                       R13 R14 K2 ["createElement"]
      108 GETUPVAL                         R14 9
      109 CALL                             R13 1 -1
...
MAIN:
       ...
       35 GETTABLEKS                       R9 R0 K10 ["Plugin"]
       37 GETTABLEKS                       R8 R9 K11 ["PluginProvider"]
       39 CALL                             R7 1 1
       40 GETIMPORT                        R8 K4 [require]
       42 GETTABLEKS                       R10 R0 K12 ["Preferences"]
       44 GETTABLEKS                       R9 R10 K13 ["PreferencesProvider"]
       46 CALL                             R8 1 1
       ...
       63 GETTABLEKS                       R13 R0 K17 ["Style"]
       65 GETTABLEKS                       R12 R13 K18 ["StyleProvider"]
       67 CALL                             R11 1 1
       68 GETIMPORT                        R12 K4 [require]
       70 GETTABLEKS                       R14 R1 K19 ["Components"]
       72 GETTABLEKS                       R13 R14 K20 ["Types"]
       74 CALL                             R12 1 1
       75 GETIMPORT                        R14 K4 [require]
       77 GETTABLEKS                       R16 R0 K21 ["Elevation"]
       79 GETTABLEKS                       R15 R16 K22 ["ElevationProvider"]
       81 CALL                             R14 1 1
       82 GETTABLEKS                       R13 R14 K22 ["ElevationProvider"]
       84 GETIMPORT                        R14 K4 [require]
       86 GETTABLEKS                       R16 R1 K23 ["Utility"]
       88 GETTABLEKS                       R15 R16 K24 ["Flags"]
       90 CALL                             R14 1 1
