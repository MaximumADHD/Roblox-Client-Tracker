...
PROTO_4:
        ...
        2 GETTABLE                         R2 R3 R1
        3 JUMPIFNOT                        R2 ; [+6]
        4 GETTABLEKS                       R3 R0 K0 ["_signals"]
        6 GETTABLE                         R2 R3 R1
        7 GETTABLEKS                       R2 R2 K1 ["signal"]
        9 RETURN                           R2 1
...
PROTO_5:
        ...
        6 GETTABLEKS                       R2 R0 K1 ["_signals"]
        8 GETTABLEKS                       R2 R2 K0 ["AbsolutePosition"]
       10 GETTABLEKS                       R2 R2 K2 ["fire"]
       12 MOVE                             R3 R1
       13 CALL                             R2 1 0
       14 RETURN                           R0 0
...
PROTO_6:
        ...
        6 GETTABLEKS                       R2 R0 K1 ["_signals"]
        8 GETTABLEKS                       R2 R2 K0 ["AbsoluteSize"]
       10 GETTABLEKS                       R2 R2 K2 ["fire"]
       12 MOVE                             R3 R1
       13 CALL                             R2 1 0
       14 RETURN                           R0 0
...
PROTO_9:
       ...
       20 GETUPVAL                         R3 0
       21 GETTABLEKS                       R3 R3 K6 ["useEffect"]
       23 NEWCLOSURE                       R4 P0
       24 CAPTURE                          VAL R2
       25 CAPTURE                          VAL R0
       26 NEWTABLE                         R5 0 1
       ...
       31 CALL                             R3 2 0
       32 GETUPVAL                         R3 0
       33 GETTABLEKS                       R3 R3 K6 ["useEffect"]
       35 NEWCLOSURE                       R4 P1
       36 CAPTURE                          VAL R2
       37 CAPTURE                          VAL R1
       38 NEWTABLE                         R5 0 1
