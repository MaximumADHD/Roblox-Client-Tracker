...
local function usePluginAnchor(anchor: PopoverAnchor?, uriAnchor: StudioUri?)
	...
	return {
		uri = if uriAnchor ~= nil then uriAnchor else anchorWidget.uri,
		element = anchorElement,
		isVirtual = isVirtualAnchor,
		isReady = if uriAnchor ~= nil then true else anchorReady,
	}
end
