PROTO_0:
        ...
        2 GETUPVAL                         R0 1
        3 GETUPVAL                         R3 0
        4 GETTABLEKS                       R2 R3 K0 ["AbsoluteSize"]
        6 GETTABLEKS                       R1 R2 K1 ["X"]
        8 GETUPVAL                         R3 2
       ...
       13 RETURN                           R0 -1
       14 GETUPVAL                         R1 2
       15 GETTABLEKS                       R0 R1 K3 ["responsiveSize"]
       17 JUMPIF                           R0 ; [+3]
       18 GETUPVAL                         R1 2
       19 GETTABLEKS                       R0 R1 K2 ["size"]
       21 RETURN                           R0 1
...
PROTO_1:
       ...
       12 CALL                             R3 1 2
       13 GETUPVAL                         R6 2
       14 GETTABLEKS                       R5 R6 K0 ["useState"]
       16 GETTABLEKS                       R6 R0 K1 ["hasHeroMedia"]
       18 CALL                             R5 1 2
       19 GETUPVAL                         R8 2
       20 GETTABLEKS                       R7 R8 K2 ["useRef"]
       22 LOADNIL                          R8
       23 CALL                             R7 1 1
       24 GETUPVAL                         R9 2
       ...
       32 GETUPVAL                         R12 4
       33 GETTABLEKS                       R11 R12 K4 ["Provider"]
...
MAIN:
       ...
       27 GETTABLEKS                       R5 R6 K10 ["getResponsiveSize"]
       29 CALL                             R4 1 1
       30 GETIMPORT                        R5 K6 [require]
       32 GETTABLEKS                       R8 R0 K11 ["Providers"]
       34 GETTABLEKS                       R7 R8 K12 ["Overlay"]
       36 GETTABLEKS                       R6 R7 K13 ["useOverlay"]
       38 CALL                             R5 1 1
       39 GETIMPORT                        R6 K6 [require]
       41 GETTABLEKS                       R9 R0 K11 ["Providers"]
       43 GETTABLEKS                       R8 R9 K14 ["Style"]
       45 GETTABLEKS                       R7 R8 K15 ["useTokens"]
       47 CALL                             R6 1 1
       48 GETIMPORT                        R7 K6 [require]
       50 GETIMPORT                        R10 K1 [script]
       52 GETTABLEKS                       R9 R10 K4 ["Parent"]
       54 GETTABLEKS                       R8 R9 K16 ["DialogContext"]
       56 CALL                             R7 1 1
