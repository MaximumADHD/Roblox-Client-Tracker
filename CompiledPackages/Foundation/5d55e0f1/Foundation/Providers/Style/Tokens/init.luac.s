...
PROTO_1:
        0 GETUPVAL                         R3 0
        1 GETTABLEKS                       R2 R3 K0 ["FoundationTokenOverrides"]
        3 JUMPIF                           R2 ; [+1]
        4 RETURN                           R0 1
        5 MOVE                             R2 R1
        6 LOADNIL                          R3
        ...
        8 FORGPREP                         R2
        9 GETUPVAL                         R8 1
       10 GETTABLEKS                       R7 R8 K1 ["getTokenValue"]
       12 MOVE                             R8 R0
       13 MOVE                             R9 R6
       14 CALL                             R7 2 1
       15 JUMPIFEQKNIL                     R7 ; [+8]
       17 GETUPVAL                         R9 1
       18 GETTABLEKS                       R8 R9 K2 ["setTokenValue"]
       20 MOVE                             R9 R0
       21 MOVE                             R10 R5
       22 MOVE                             R11 R7
       23 CALL                             R8 3 0
...
PROTO_2:
        0 GETUPVAL                         R5 0
        1 GETTABLEKS                       R4 R5 K0 ["Tokens"]
        3 MOVE                             R5 R1
        4 JUMPIF                           R5 ; [+3]
        5 GETUPVAL                         R6 1
        6 GETTABLEKS                       R5 R6 K1 ["Desktop"]
        8 MOVE                             R7 R2
        9 GETUPVAL                         R9 2
       10 GETTABLEKS                       R8 R9 K2 ["FoundationDisableTokenScaling"]
       12 JUMPIFNOT                        R8 ; [+2]
       13 LOADN                            R6 1
       14 JUMP                             ; [+22]
       ...
       27 MOVE                             R7 R8
       28 GETUPVAL                         R10 1
       29 GETTABLEKS                       R9 R10 K7 ["Console"]
...
MAIN:
       ...
       39 GETTABLEKS                       R7 R8 K13 ["TokenProcessingUtilities"]
       41 CALL                             R6 1 1
