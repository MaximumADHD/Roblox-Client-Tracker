PROTO_0:
       ...
       43 GETUPVAL                         R8 4
       44 DUPTABLE                         R9 K10 [{"theme", "device", "derives", "scale", "tokenOverrides"}]
       ...
       61 GETTABLEKS                       R10 R0 K9 ["tokenOverrides"]
       63 SETTABLEKS                       R10 R9 K9 ["tokenOverrides"]
       65 CALL                             R7 2 1
       66 GETUPVAL                         R9 0
       67 GETTABLEKS                       R8 R9 K2 ["createElement"]
       69 GETUPVAL                         R9 5
       70 DUPTABLE                         R10 K12 [{"config"}]
       71 SETTABLEKS                       R2 R10 K11 ["config"]
       73 CALL                             R8 2 1
       74 GETUPVAL                         R10 0
       75 GETTABLEKS                       R9 R10 K2 ["createElement"]
       77 GETUPVAL                         R10 6
       78 GETUPVAL                         R13 7
       79 GETTABLEKS                       R12 R13 K13 ["FoundationOverlayDisplayOrder"]
       81 JUMPIFNOT                        R12 ; [+16]
       82 GETTABLEKS                       R13 R0 K14 ["overlayGui"]
       84 FASTCALL1                        TYPEOF R13 ; [+2]
       85 GETIMPORT                        R12 K16 [typeof]
       87 CALL                             R12 1 1
       88 JUMPIFNOTEQKS                    R12 K17 ["table"] ; [+9]
       90 DUPTABLE                         R11 K19 [{"DisplayOrder"}]
       91 GETTABLEKS                       R13 R0 K14 ["overlayGui"]
       93 GETTABLEKS                       R12 R13 K18 ["DisplayOrder"]
       95 SETTABLEKS                       R12 R11 K18 ["DisplayOrder"]
       97 JUMP                             ; [+5]
       98 DUPTABLE                         R11 K21 [{"gui"}]
       99 GETTABLEKS                       R12 R0 K14 ["overlayGui"]
      101 SETTABLEKS                       R12 R11 K20 ["gui"]
      103 CALL                             R9 2 1
      104 GETUPVAL                         R11 0
      105 GETTABLEKS                       R10 R11 K2 ["createElement"]
      107 GETUPVAL                         R11 8
      108 CALL                             R10 1 -1
      109 SETLIST                          R3 R4 -1 [1]
      111 GETUPVAL                         R5 7
      112 GETTABLEKS                       R4 R5 K22 ["FoundationFixUserLevelPlugins"]
      114 JUMPIFNOT                        R4 ; [+37]
      115 GETTABLEKS                       R4 R0 K3 ["plugin"]
      117 JUMPIFNOT                        R4 ; [+65]
      118 GETUPVAL                         R4 9
      119 GETTABLEKS                       R5 R0 K3 ["plugin"]
      121 CALL                             R4 1 1
      122 JUMPIFNOT                        R4 ; [+60]
      123 GETUPVAL                         R5 7
      124 GETTABLEKS                       R4 R5 K23 ["FoundationPopoverPluginSupport"]
      126 JUMPIFNOT                        R4 ; [+56]
      127 MOVE                             R5 R3
      128 GETUPVAL                         R7 0
      129 GETTABLEKS                       R6 R7 K2 ["createElement"]
      131 GETUPVAL                         R7 10
      132 NEWTABLE                         R8 0 0
      134 CALL                             R6 2 -1
      135 FASTCALL                         TABLE_INSERT ; [+2]
      136 GETIMPORT                        R4 K25 [table.insert]
      138 CALL                             R4 -1 0
      139 MOVE                             R5 R3
      140 GETUPVAL                         R7 0
      141 GETTABLEKS                       R6 R7 K2 ["createElement"]
      143 GETUPVAL                         R7 11
      144 NEWTABLE                         R8 0 0
      146 CALL                             R6 2 -1
      147 FASTCALL                         TABLE_INSERT ; [+2]
      148 GETIMPORT                        R4 K25 [table.insert]
      150 CALL                             R4 -1 0
      151 JUMP                             ; [+31]
      152 GETTABLEKS                       R4 R0 K3 ["plugin"]
      154 JUMPIFNOT                        R4 ; [+28]
      155 GETUPVAL                         R5 7
      156 GETTABLEKS                       R4 R5 K23 ["FoundationPopoverPluginSupport"]
      158 JUMPIFNOT                        R4 ; [+24]
      159 MOVE                             R5 R3
      160 GETUPVAL                         R7 0
      161 GETTABLEKS                       R6 R7 K2 ["createElement"]
      163 GETUPVAL                         R7 10
      164 NEWTABLE                         R8 0 0
      166 CALL                             R6 2 -1
      167 FASTCALL                         TABLE_INSERT ; [+2]
      168 GETIMPORT                        R4 K25 [table.insert]
      170 CALL                             R4 -1 0
      171 MOVE                             R5 R3
      172 GETUPVAL                         R7 0
      173 GETTABLEKS                       R6 R7 K2 ["createElement"]
      175 GETUPVAL                         R7 11
      176 NEWTABLE                         R8 0 0
      178 CALL                             R6 2 -1
      179 FASTCALL                         TABLE_INSERT ; [+2]
      180 GETIMPORT                        R4 K25 [table.insert]
      182 CALL                             R4 -1 0
      183 GETUPVAL                         R5 0
      184 GETTABLEKS                       R4 R5 K2 ["createElement"]
      186 GETUPVAL                         R5 12
      187 DUPTABLE                         R6 K27 [{"providers"}]
      188 SETTABLEKS                       R3 R6 K26 ["providers"]
      190 GETTABLEKS                       R7 R0 K28 ["children"]
      192 CALL                             R4 3 -1
      193 RETURN                           R4 -1
...
MAIN:
      ...
      107 GETTABLEKS                       R19 R0 K12 ["Plugin"]
      109 GETTABLEKS                       R18 R19 K29 ["isPluginElevated"]
      111 CALL                             R17 1 1
