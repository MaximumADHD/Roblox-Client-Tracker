PROTO_0:
       ...
       12 CALL                             R0 2 1
       13 GETUPVAL                         R2 2
       14 GETTABLEKS                       R2 R2 K2 ["FoundationBaseMenuSubmenuSupport"]
       16 JUMPIFNOT                        R2 ; [+14]
       17 GETUPVAL                         R1 0
       18 GETTABLEKS                       R1 R1 K0 ["get"]
       20 GETUPVAL                         R2 1
       21 GETTABLEKS                       R2 R2 K1 ["items"]
       23 NEWTABLE                         R3 0 2
       25 LOADN                            R4 1
       26 LOADK                            R5 K3 ["id"]
       ...
       33 JUMPIF                           R1 ; [+4]
       34 GETUPVAL                         R2 1
       35 GETTABLEKS                       R2 R2 K1 ["items"]
       37 RETURN                           R2 1
       38 NEWTABLE                         R2 0 1
       40 DUPTABLE                         R3 K4 [{"items"}]
       41 GETUPVAL                         R4 1
       42 GETTABLEKS                       R4 R4 K1 ["items"]
...
PROTO_1:
        ...
        3 GETUPVAL                         R3 1
        4 DUPTABLE                         R4 K10 [{"LayoutOrder", "key", "icon", "isChecked", "isDisabled", "text", "onActivated", "id", "testId"}]
       ...
       35 GETTABLEKS                       R6 R0 K11 ["items"]
       37 JUMPIFNOT                        R6 ; [+2]
       38 LOADK                            R5 K12 ["--foundation-menu-submenu-item"]
       39 JUMP                             ; [+1]
       40 LOADK                            R5 K13 ["--foundation-menu-item"]
       41 SETTABLEKS                       R5 R4 K9 ["testId"]
       43 GETUPVAL                         R6 2
       44 GETTABLEKS                       R6 R6 K14 ["FoundationBaseMenuSubmenuSupport"]
       46 JUMPIFNOT                        R6 ; [+14]
       47 GETTABLEKS                       R6 R0 K11 ["items"]
       49 JUMPIFNOT                        R6 ; [+11]
       50 GETUPVAL                         R5 0
       51 GETTABLEKS                       R5 R5 K0 ["createElement"]
       53 GETUPVAL                         R6 3
       54 DUPTABLE                         R7 K15 [{"items"}]
       55 GETTABLEKS                       R8 R0 K11 ["items"]
       57 SETTABLEKS                       R8 R7 K11 ["items"]
       59 CALL                             R5 2 1
       60 JUMP                             ; [+1]
       61 LOADNIL                          R5
       62 CALL                             R2 3 -1
...
PROTO_3:
       ...
       17 GETUPVAL                         R3 0
       18 GETTABLEKS                       R3 R3 K3 ["Fragment"]
       20 LOADNIL                          R4
       21 GETUPVAL                         R5 1
       22 GETTABLEKS                       R5 R5 K4 ["map"]
       24 MOVE                             R6 R1
