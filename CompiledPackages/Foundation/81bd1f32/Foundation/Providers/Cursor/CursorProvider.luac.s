...
PROTO_3:
       ...
       25 LOADNIL                          R8
       26 GETUPVAL                         R10 3
       27 GETTABLEKS                       R9 R10 K1 ["FoundationSupportPresentationContextInSelectionCursor"]
       29 JUMPIFNOT                        R9 ; [+12]
       ...
       50 LOADNIL                          R10
       51 GETUPVAL                         R12 3
       52 GETTABLEKS                       R11 R12 K1 ["FoundationSupportPresentationContextInSelectionCursor"]
       54 JUMPIFNOT                        R11 ; [+7]
       55 GETUPVAL                         R12 5
       56 GETTABLEKS                       R11 R12 K7 ["decodeCursorTypeKey"]
       58 MOVE                             R12 R8
       59 CALL                             R11 1 2
       60 MOVE                             R9 R11
       61 MOVE                             R10 R12
       62 GETUPVAL                         R12 6
       63 GETTABLEKS                       R11 R12 K8 ["createElement"]
       65 GETUPVAL                         R12 7
       ...
       75 GETUPVAL                         R16 3
       76 GETTABLEKS                       R15 R16 K1 ["FoundationSupportPresentationContextInSelectionCursor"]
       78 JUMPIFNOT                        R15 ; [+2]
       79 MOVE                             R14 R10
       80 JUMP                             ; [+1]
       81 LOADNIL                          R14
       ...
       86 JUMP                             ; [+39]
       87 GETUPVAL                         R10 5
       88 GETTABLEKS                       R9 R10 K14 ["decodeKey"]
       90 GETUPVAL                         R14 3
       91 GETTABLEKS                       R13 R14 K1 ["FoundationSupportPresentationContextInSelectionCursor"]
       93 JUMPIFNOT                        R13 ; [+2]
       94 MOVE                             R10 R8
       95 JUMP                             ; [+1]
       96 MOVE                             R10 R4
       97 CALL                             R9 1 4
       98 GETUPVAL                         R14 6
       99 GETTABLEKS                       R13 R14 K8 ["createElement"]
      101 GETUPVAL                         R14 8
      ...
      115 GETUPVAL                         R18 3
      116 GETTABLEKS                       R17 R18 K1 ["FoundationSupportPresentationContextInSelectionCursor"]
      118 JUMPIFNOT                        R17 ; [+2]
      119 MOVE                             R16 R12
      120 JUMP                             ; [+1]
      121 LOADNIL                          R16
...
PROTO_10:
       ...
       46 CAPTURE                          UPVAL U8
       47 GETUPVAL                         R11 0
       48 GETTABLEKS                       R10 R11 K3 ["useEffect"]
       ...
       58 CALL                             R10 2 0
       59 GETUPVAL                         R11 0
       60 GETTABLEKS                       R10 R11 K4 ["createElement"]
       62 GETUPVAL                         R12 12
       63 GETTABLEKS                       R11 R12 K5 ["Provider"]
       65 DUPTABLE                         R12 K7 [{"value"}]
       66 SETTABLEKS                       R8 R12 K6 ["value"]
       68 DUPTABLE                         R13 K10 [{"Children", "FoundationCursorContainer"}]
       69 GETUPVAL                         R15 0
       70 GETTABLEKS                       R14 R15 K4 ["createElement"]
       72 GETUPVAL                         R16 0
       73 GETTABLEKS                       R15 R16 K11 ["Fragment"]
       75 NEWTABLE                         R16 0 0
       77 GETTABLEKS                       R17 R0 K12 ["children"]
       79 CALL                             R14 3 1
       80 SETTABLEKS                       R14 R13 K8 ["Children"]
       82 GETUPVAL                         R15 0
       83 GETTABLEKS                       R14 R15 K4 ["createElement"]
       85 LOADK                            R15 K13 ["Frame"]
       86 DUPTABLE                         R16 K17 [{"Size", "Visible", "ref"}]
       87 GETIMPORT                        R17 K20 [UDim2.new]
       89 LOADN                            R18 0
       90 LOADN                            R19 0
       91 LOADN                            R20 0
       92 LOADN                            R21 0
       ...
       96 LOADB                            R17 0
       97 SETTABLEKS                       R17 R16 K15 ["Visible"]
       99 SETTABLEKS                       R3 R16 K16 ["ref"]
      101 MOVE                             R17 R9
      102 CALL                             R17 0 1
      103 CALL                             R14 3 1
      104 SETTABLEKS                       R14 R13 K9 ["FoundationCursorContainer"]
      106 CALL                             R10 3 -1
      107 RETURN                           R10 -1
...
MAIN:
       ...
       18 GETTABLEKS                       R7 R0 K7 ["Utility"]
       20 GETTABLEKS                       R6 R7 K9 ["Wrappers"]
       22 CALL                             R5 1 1
       23 GETTABLEKS                       R4 R5 K10 ["Services"]
       25 GETTABLEKS                       R3 R4 K11 ["CoreGui"]
       27 GETIMPORT                        R6 K6 [require]
       29 GETTABLEKS                       R8 R0 K7 ["Utility"]
       31 GETTABLEKS                       R7 R8 K9 ["Wrappers"]
       33 CALL                             R6 1 1
       34 GETTABLEKS                       R5 R6 K10 ["Services"]
       36 GETTABLEKS                       R4 R5 K12 ["GuiService"]
       ...
       57 GETTABLEKS                       R11 R0 K7 ["Utility"]
       59 GETTABLEKS                       R10 R11 K17 ["isPluginSecurity"]
       61 CALL                             R9 1 1
       62 GETIMPORT                        R10 K6 [require]
       64 GETIMPORT                        R14 K1 [script]
       66 GETTABLEKS                       R13 R14 K4 ["Parent"]
       68 GETTABLEKS                       R12 R13 K18 ["Cursors"]
       70 GETTABLEKS                       R11 R12 K19 ["Cursor"]
       72 CALL                             R10 1 1
       73 GETIMPORT                        R11 K6 [require]
       75 GETIMPORT                        R14 K1 [script]
       77 GETTABLEKS                       R13 R14 K4 ["Parent"]
       79 GETTABLEKS                       R12 R13 K20 ["CursorComponent"]
       81 CALL                             R11 1 1
       82 GETIMPORT                        R12 K6 [require]
       84 GETIMPORT                        R15 K1 [script]
       86 GETTABLEKS                       R14 R15 K4 ["Parent"]
       88 GETTABLEKS                       R13 R14 K21 ["CursorContext"]
       90 CALL                             R12 1 1
       91 GETIMPORT                        R13 K6 [require]
       93 GETTABLEKS                       R15 R0 K22 ["Enums"]
       95 GETTABLEKS                       R14 R15 K23 ["CursorType"]
       97 CALL                             R13 1 1
       98 GETIMPORT                        R14 K6 [require]
      100 GETIMPORT                        R17 K1 [script]
      102 GETTABLEKS                       R16 R17 K4 ["Parent"]
      104 GETTABLEKS                       R15 R16 K24 ["KeyUtilities"]
      106 CALL                             R14 1 1
      107 GETIMPORT                        R15 K6 [require]
      109 GETTABLEKS                       R17 R0 K22 ["Enums"]
      111 GETTABLEKS                       R16 R17 K25 ["ColorMode"]
      113 CALL                             R15 1 1
      114 GETIMPORT                        R16 K6 [require]
      116 GETTABLEKS                       R18 R0 K26 ["Components"]
      118 GETTABLEKS                       R17 R18 K27 ["Types"]
      120 CALL                             R16 1 1
      121 GETIMPORT                        R17 K6 [require]
      123 GETTABLEKS                       R20 R0 K28 ["Providers"]
      125 GETTABLEKS                       R19 R20 K29 ["Style"]
      127 GETTABLEKS                       R18 R19 K30 ["useTokens"]
      129 CALL                             R17 1 1
