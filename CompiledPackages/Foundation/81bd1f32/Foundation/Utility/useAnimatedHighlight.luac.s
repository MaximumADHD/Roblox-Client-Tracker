...
PROTO_5:
       ...
       23 JUMPIFNOT                        R3 ; [+43]
       24 GETUPVAL                         R4 5
       25 GETTABLEKS                       R3 R4 K1 ["Connect"]
       27 GETUPVAL                         R5 6
       28 GETTABLEKS                       R4 R5 K2 ["GetPropertyChangedSignal"]
       ...
       35 CALL                             R3 2 1
       36 GETUPVAL                         R5 5
       37 GETTABLEKS                       R4 R5 K1 ["Connect"]
       39 GETUPVAL                         R6 6
       40 GETTABLEKS                       R5 R6 K2 ["GetPropertyChangedSignal"]
       ...
       47 CALL                             R4 2 1
       48 GETUPVAL                         R6 5
       49 GETTABLEKS                       R5 R6 K1 ["Connect"]
       51 GETUPVAL                         R7 6
       52 GETTABLEKS                       R6 R7 K2 ["GetPropertyChangedSignal"]
       54 GETUPVAL                         R8 4
       55 GETTABLEKS                       R7 R8 K0 ["current"]
...
PROTO_6:
       ...
       14 GETUPVAL                         R4 0
       15 GETUPVAL                         R6 4
       16 GETTABLEKS                       R5 R6 K0 ["current"]
       18 JUMPIFEQ                         R4 R5 ; [+2]
       20 LOADB                            R3 0 +1
       21 LOADB                            R3 1
       22 CALL                             R1 2 0
...
PROTO_7:
       ...
       13 CALL                             R3 2 1
       14 GETUPVAL                         R5 1
       15 GETTABLEKS                       R4 R5 K1 ["useRef"]
       17 MOVE                             R5 R0
       18 CALL                             R4 1 1
       19 GETUPVAL                         R6 2
       20 GETTABLEKS                       R5 R6 K2 ["useAnimatedBinding"]
       22 LOADN                            R6 0
       23 CALL                             R5 1 2
       24 GETUPVAL                         R8 2
       25 GETTABLEKS                       R7 R8 K2 ["useAnimatedBinding"]
       27 LOADN                            R8 0
       28 CALL                             R7 1 2
       29 GETUPVAL                         R10 1
       ...
       35 CALL                             R11 0 1
       36 GETUPVAL                         R13 1
       37 GETTABLEKS                       R12 R13 K4 ["useCallback"]
       ...
       52 CALL                             R12 2 1
       53 GETUPVAL                         R14 1
       54 GETTABLEKS                       R13 R14 K5 ["useEffect"]
       ...
       70 CALL                             R13 2 0
       71 GETUPVAL                         R14 1
       72 GETTABLEKS                       R13 R14 K5 ["useEffect"]
...
MAIN:
       ...
       44 GETTABLEKS                       R9 R10 K16 ["Wrappers"]
       46 CALL                             R8 1 1
