...
local function InternalTextInput(textInputProps: TextInputProps, ref: React.Ref<InternalTextInputRef>?)
	...
	return React.createElement(
		...
		withCommonProps(props, {
			...
			cursor = cursor,
			stroke = if (variantProps.outerView.strokeStyle and variantProps.outerView.strokeThickness)
				then {
					Color = variantProps.outerView.strokeStyle.Color3,
					...
					Thickness = variantProps.outerView.strokeThickness,
			...
			backgroundStyle = if variantProps.outerView.bgStyle
