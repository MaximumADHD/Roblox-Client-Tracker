...
PROTO_2:
  ...
  GETUPVAL R2 0
  GETTABLEKS R3 R1 K1 ["updateIconButtonSizes"]
  SETTABLEKS R3 R2 K2 ["FoundationUpdateIconButtonSizes"]
  GETUPVAL R3 1
...
MAIN:
  ...
  CALL R9 1 1
  NEWTABLE R10 0 5
  GETTABLEKS R11 R8 K16 ["Utility"]
  GETTABLEKS R12 R8 K18 ["Standard"]
  GETTABLEKS R13 R8 K19 ["Emphasis"]
  GETTABLEKS R14 R8 K20 ["OverMedia"]
  GETTABLEKS R15 R8 K21 ["Alert"]
  SETLIST R10 R11 5 [1]
  DUPTABLE R11 K25 [{"summary", "stories", "controls"}]
  LOADK R12 K12 ["IconButton"]
  SETTABLEKS R12 R11 K22 ["summary"]
  GETTABLEKS R12 R3 K26 ["map"]
  MOVE R13 R10
  ...
  CAPTURE VAL R6
  CALL R12 2 1
  SETTABLEKS R12 R11 K23 ["stories"]
  DUPTABLE R12 K33 [{"name", "variant", "isDisabled", "isCircular", "updateIconButtonSizes"}]
  GETTABLEKS R13 R3 K34 ["values"]
  GETTABLEKS R14 R4 K35 ["Icon"]
  CALL R13 1 1
  SETTABLEKS R13 R12 K28 ["name"]
  GETTABLEKS R13 R3 K34 ["values"]
  GETTABLEKS R14 R4 K36 ["IconVariant"]
  CALL R13 1 1
  SETTABLEKS R13 R12 K29 ["variant"]
  LOADB R13 0
  SETTABLEKS R13 R12 K30 ["isDisabled"]
  LOADB R13 0
  SETTABLEKS R13 R12 K31 ["isCircular"]
  GETTABLEKS R13 R9 K37 ["FoundationUpdateIconButtonSizes"]
  SETTABLEKS R13 R12 K32 ["updateIconButtonSizes"]
  SETTABLEKS R12 R11 K24 ["controls"]
  RETURN R11 1
