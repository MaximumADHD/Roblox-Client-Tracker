...
PROTO_3:
  ...
  GETUPVAL R10 2
  DUPTABLE R11 K11 [{"ref", "backgroundStyle", "Size"}]
  SETTABLEKS R4 R11 K8 ["ref"]
  DUPTABLE R12 K14 [{"Color3", "Transparency"}]
  GETTABLEKS R16 R5 K15 ["Color"]
  GETTABLEKS R15 R16 K16 ["Shift"]
  GETTABLEKS R14 R15 K17 ["Shift_200"]
  GETTABLEKS R13 R14 K12 ["Color3"]
  SETTABLEKS R13 R12 K12 ["Color3"]
  GETTABLEKS R16 R5 K15 ["Color"]
  GETTABLEKS R15 R16 K16 ["Shift"]
  GETTABLEKS R14 R15 K17 ["Shift_200"]
  GETTABLEKS R13 R14 K13 ["Transparency"]
  ...
  LOADN R14 0
  LOADN R15 0
  GETTABLEKS R17 R2 K22 ["mockScreenYOffset"]
  ORK R16 R17 K21 [0]
  CALL R12 4 1
  SETTABLEKS R12 R11 K10 ["Size"]
  DUPTABLE R12 K24 [{"OverlayProvider"}]
  GETUPVAL R14 0
  GETTABLEKS R13 R14 K7 ["createElement"]
  GETUPVAL R14 3
  DUPTABLE R15 K26 [{"gui"}]
  SETTABLEKS R3 R15 K25 ["gui"]
  DUPTABLE R16 K29 [{"ToggleButton", "DialogRoot"}]
  GETUPVAL R18 0
  GETTABLEKS R17 R18 K7 ["createElement"]
  GETUPVAL R18 4
  DUPTABLE R19 K34 [{"text", "onActivated", "variant", "Position"}]
  JUMPIFNOT R6 [+2]
  LOADK R20 K35 ["Close Dialog"]
  JUMP [+1]
  LOADK R20 K36 ["Open Dialog"]
  SETTABLEKS R20 R19 K30 ["text"]
  SETTABLEKS R8 R19 K31 ["onActivated"]
  GETUPVAL R21 5
  GETTABLEKS R20 R21 K37 ["Emphasis"]
  SETTABLEKS R20 R19 K32 ["variant"]
  GETIMPORT R20 K39 [UDim2.fromOffset]
  LOADN R21 20
  LOADN R22 20
  CALL R20 2 1
  SETTABLEKS R20 R19 K33 ["Position"]
  CALL R17 2 1
  SETTABLEKS R17 R16 K27 ["ToggleButton"]
  JUMPIFNOT R6 [+98]
  GETUPVAL R18 0
  GETTABLEKS R17 R18 K7 ["createElement"]
  GETUPVAL R19 6
  GETTABLEKS R18 R19 K40 ["Root"]
  DUPTABLE R19 K45 [{"size", "onClose", "hasBackdrop", "disablePortal"}]
  GETTABLEKS R20 R2 K41 ["size"]
  SETTABLEKS R20 R19 K41 ["size"]
  SETTABLEKS R8 R19 K42 ["onClose"]
  GETTABLEKS R20 R2 K43 ["hasBackdrop"]
  SETTABLEKS R20 R19 K43 ["hasBackdrop"]
  GETTABLEKS R20 R2 K44 ["disablePortal"]
  SETTABLEKS R20 R19 K44 ["disablePortal"]
  DUPTABLE R20 K47 [{"DialogMedia", "DialogTitle", "DialogContent", "DialogActions"}]
  ...
  GETTABLEKS R22 R2 K48 ["hasActions"]
  JUMPIFNOT R22 [+56]
  GETUPVAL R22 0
  GETTABLEKS R21 R22 K7 ["createElement"]
  GETUPVAL R23 6
  GETTABLEKS R22 R23 K49 ["Actions"]
  DUPTABLE R23 K54 [{"LayoutOrder", "orientation", "actions", "label"}]
  LOADN R24 3
  SETTABLEKS R24 R23 K50 ["LayoutOrder"]
  GETTABLEKS R24 R2 K55 ["actionsOrientation"]
  SETTABLEKS R24 R23 K51 ["orientation"]
  NEWTABLE R24 0 2
  DUPTABLE R25 K58 [{"text", "variant", "icon", "onActivated", "inputDelay"}]
  LOADK R26 K59 ["Join"]
  SETTABLEKS R26 R25 K30 ["text"]
  GETUPVAL R27 5
  GETTABLEKS R26 R27 K37 ["Emphasis"]
  SETTABLEKS R26 R25 K32 ["variant"]
  LOADK R26 K60 ["icons/common/robux"]
  SETTABLEKS R26 R25 K56 ["icon"]
  DUPCLOSURE R26 K61 [PROTO_1]
  SETTABLEKS R26 R25 K31 ["onActivated"]
  LOADN R26 3
  SETTABLEKS R26 R25 K57 ["inputDelay"]
  DUPTABLE R26 K62 [{"text", "variant", "onActivated"}]
  LOADK R27 K63 ["Share"]
  SETTABLEKS R27 R26 K30 ["text"]
  GETUPVAL R28 5
  GETTABLEKS R27 R28 K64 ["Standard"]
  SETTABLEKS R27 R26 K32 ["variant"]
  DUPCLOSURE R27 K65 [PROTO_2]
  SETTABLEKS R27 R26 K31 ["onActivated"]
  SETLIST R24 R25 2 [1]
  SETTABLEKS R24 R23 K52 ["actions"]
  GETTABLEKS R24 R2 K66 ["actionsLabel"]
  SETTABLEKS R24 R23 K53 ["label"]
  CALL R21 2 1
  JUMP [+1]
  LOADNIL R21
  SETTABLEKS R21 R20 K46 ["DialogActions"]
  CALL R17 3 1
  JUMP [+1]
  LOADNIL R17
  SETTABLEKS R17 R16 K28 ["DialogRoot"]
  CALL R13 3 1
  SETTABLEKS R13 R12 K23 ["OverlayProvider"]
  CALL R9 3 -1
  RETURN R9 -1
...
PROTO_4:
  ...
  GETUPVAL R6 3
  DUPTABLE R7 K12 [{"aspectRatio", "Image", "Size"}]
...
PROTO_5:
  ...
  GETUPVAL R2 1
  MOVE R3 R0
  DUPTABLE R4 K4 [{"DialogTitle", "DialogMedia", "DialogContent"}]
  GETUPVAL R6 0
  GETTABLEKS R5 R6 K0 ["createElement"]
  GETUPVAL R7 2
  GETTABLEKS R6 R7 K5 ["Title"]
  DUPTABLE R7 K7 [{"text"}]
  GETTABLEKS R9 R0 K8 ["controls"]
  GETTABLEKS R8 R9 K9 ["title"]
  ...
  GETTABLEKS R5 R6 K0 ["createElement"]
  GETUPVAL R7 2
  GETTABLEKS R6 R7 K10 ["HeroMedia"]
  DUPTABLE R7 K14 [{"media", "height", "aspectRatio"}]
  GETTABLEKS R9 R0 K8 ["controls"]
  GETTABLEKS R8 R9 K11 ["media"]
  SETTABLEKS R8 R7 K11 ["media"]
  GETIMPORT R8 K17 [UDim.new]
  GETTABLEKS R11 R0 K8 ["controls"]
  GETTABLEKS R10 R11 K19 ["heroMediaHeightScale"]
  ORK R9 R10 K18 [0]
  GETTABLEKS R12 R0 K8 ["controls"]
  GETTABLEKS R11 R12 K20 ["heroMediaHeightOffset"]
  ORK R10 R11 K18 [0]
  CALL R8 2 1
  SETTABLEKS R8 R7 K12 ["height"]
  GETTABLEKS R10 R0 K8 ["controls"]
  GETTABLEKS R9 R10 K21 ["heroMediaAspectRatio"]
  LOADN R10 0
  JUMPIFNOTLT R10 R9 [+6]
  GETTABLEKS R9 R0 K8 ["controls"]
  GETTABLEKS R8 R9 K21 ["heroMediaAspectRatio"]
  JUMP [+1]
  LOADNIL R8
  SETTABLEKS R8 R7 K13 ["aspectRatio"]
  CALL R5 2 1
  SETTABLEKS R5 R4 K2 ["DialogMedia"]
  GETUPVAL R6 0
  GETTABLEKS R5 R6 K0 ["createElement"]
  GETUPVAL R7 2
  GETTABLEKS R6 R7 K22 ["Content"]
  DUPTABLE R7 K24 [{"LayoutOrder"}]
  LOADN R8 2
  SETTABLEKS R8 R7 K23 ["LayoutOrder"]
  DUPTABLE R8 K26 [{"DialogText"}]
  GETUPVAL R10 0
  GETTABLEKS R9 R10 K0 ["createElement"]
  GETUPVAL R11 2
  GETTABLEKS R10 R11 K27 ["Text"]
  DUPTABLE R11 K28 [{"Text"}]
  GETTABLEKS R13 R0 K8 ["controls"]
  GETTABLEKS R12 R13 K29 ["content"]
  SETTABLEKS R12 R11 K27 ["Text"]
  CALL R9 2 1
  SETTABLEKS R9 R8 K25 ["DialogText"]
  CALL R5 3 1
  SETTABLEKS R5 R4 K3 ["DialogContent"]
  CALL R1 3 -1
  RETURN R1 -1
...
PROTO_7:
  ...
  DUPTABLE R7 K8 [{"media", "height", "aspectRatio"}]
  GETTABLEKS R9 R0 K9 ["controls"]
  GETTABLEKS R8 R9 K5 ["media"]
  SETTABLEKS R8 R7 K5 ["media"]
  GETIMPORT R8 K12 [UDim.new]
  GETTABLEKS R11 R0 K9 ["controls"]
  GETTABLEKS R10 R11 K14 ["heroMediaHeightScale"]
  ORK R9 R10 K13 [0]
  GETTABLEKS R12 R0 K9 ["controls"]
  GETTABLEKS R11 R12 K15 ["heroMediaHeightOffset"]
  ORK R10 R11 K13 [0]
  CALL R8 2 1
  SETTABLEKS R8 R7 K6 ["height"]
  GETTABLEKS R10 R0 K9 ["controls"]
  GETTABLEKS R9 R10 K16 ["heroMediaAspectRatio"]
  LOADN R10 0
  JUMPIFNOTLT R10 R9 [+6]
  GETTABLEKS R9 R0 K9 ["controls"]
  GETTABLEKS R8 R9 K16 ["heroMediaAspectRatio"]
  JUMP [+1]
  LOADNIL R8
  SETTABLEKS R8 R7 K7 ["aspectRatio"]
  CALL R5 2 1
  SETTABLEKS R5 R4 K1 ["DialogMedia"]
  GETUPVAL R6 0
  GETTABLEKS R5 R6 K0 ["createElement"]
  GETUPVAL R7 2
  GETTABLEKS R6 R7 K17 ["Content"]
  DUPTABLE R7 K19 [{"LayoutOrder"}]
  LOADN R8 2
  SETTABLEKS R8 R7 K18 ["LayoutOrder"]
  DUPTABLE R8 K21 [{"DialogText"}]
  GETUPVAL R10 0
  GETTABLEKS R9 R10 K0 ["createElement"]
  GETUPVAL R11 2
  ...
  GETTABLEKS R12 R13 K24 ["content"]
  SETTABLEKS R12 R11 K22 ["Text"]
  CALL R9 2 1
  SETTABLEKS R9 R8 K20 ["DialogText"]
  CALL R5 3 1
  SETTABLEKS R5 R4 K2 ["DialogContent"]
  CALL R1 3 -1
  RETURN R1 -1
...
PROTO_8:
  ...
  GETUPVAL R2 1
  MOVE R3 R0
  DUPTABLE R4 K2 [{"DialogMedia"}]
  GETUPVAL R6 0
  GETTABLEKS R5 R6 K0 ["createElement"]
  GETUPVAL R7 2
  GETTABLEKS R6 R7 K3 ["HeroMedia"]
  DUPTABLE R7 K7 [{"media", "height", "aspectRatio"}]
  GETTABLEKS R9 R0 K8 ["controls"]
  GETTABLEKS R8 R9 K4 ["media"]
  SETTABLEKS R8 R7 K4 ["media"]
  GETIMPORT R8 K11 [UDim.new]
  GETTABLEKS R11 R0 K8 ["controls"]
  GETTABLEKS R10 R11 K13 ["heroMediaHeightScale"]
  ORK R9 R10 K12 [0]
  GETTABLEKS R12 R0 K8 ["controls"]
  GETTABLEKS R11 R12 K14 ["heroMediaHeightOffset"]
  ORK R10 R11 K12 [0]
  CALL R8 2 1
  SETTABLEKS R8 R7 K5 ["height"]
  GETTABLEKS R10 R0 K8 ["controls"]
  GETTABLEKS R9 R10 K15 ["heroMediaAspectRatio"]
  LOADN R10 0
  JUMPIFNOTLT R10 R9 [+6]
  GETTABLEKS R9 R0 K8 ["controls"]
  GETTABLEKS R8 R9 K15 ["heroMediaAspectRatio"]
  JUMP [+1]
  LOADNIL R8
  SETTABLEKS R8 R7 K6 ["aspectRatio"]
  CALL R5 2 1
  SETTABLEKS R5 R4 K1 ["DialogMedia"]
  CALL R1 3 -1
  RETURN R1 -1
...
MAIN:
  ...
  DUPTABLE R19 K68 [{"title", "content", "actionsLabel", "actionsOrientation", "hasActions", "disablePortal", "hasBackdrop", "media", "mediaSizeScaleX", "mediaSizeScaleY", "mediaSizeOffsetX", "mediaSizeOffsetY", "mediaAspectRatio", "heroMediaAspectRatio", "heroMediaHeightScale", "heroMediaHeightOffset", "size", "mockScreenYOffset"}]
  LOADK R20 K69 ["Welcome Dialog"]
  SETTABLEKS R20 R19 K50 ["title"]
  LOADK R20 K70 ["This is a dialog with a very, very long description that spans multiple lines. Now, I'm not joking when I say that it has a lot to say. Really, a lot of things have a lot to say if you're willing to listen. Do you hear that? That's the sound of the universe vibrating. It's beautiful, but you really have to listen. This may be the most important decision of your life. You need to decide: are you willing to listen?"]
  SETTABLEKS R20 R19 K51 ["content"]
  LOADK R20 K71 ["By selecting Primary, I consent to Roblox's collection, use, and storage of my data to enable services and for moderation, safety, and improvement of our services and tools."]
  SETTABLEKS R20 R19 K52 ["actionsLabel"]
  GETTABLEKS R20 R3 K72 ["values"]
  MOVE R21 R13
  CALL R20 1 1
  ...
  LOADK R20 K73 ["component_assets/avatarBG_dark"]
  ...
  LOADK R20 K74 [2.5]
  SETTABLEKS R20 R19 K63 ["heroMediaAspectRatio"]
  LOADN R20 1
  SETTABLEKS R20 R19 K64 ["heroMediaHeightScale"]
  LOADN R20 0
  SETTABLEKS R20 R19 K65 ["heroMediaHeightOffset"]
  GETTABLEKS R20 R3 K72 ["values"]
  MOVE R21 R12
  CALL R20 1 1
  SETTABLEKS R20 R19 K66 ["size"]
  LOADN R20 32
  SETTABLEKS R20 R19 K67 ["mockScreenYOffset"]
