...
PROTO_2:
  ...
  LOADK R12 K11 ["col auto-y size-full-0 %*"]
  GETUPVAL R16 11
  GETTABLEKS R15 R16 K12 ["FoundationDialogActionsUpdate"]
  JUMPIFNOT R15 [+2]
  LOADK R14 K13 [""]
  JUMP [+1]
  LOADK R14 K14 ["gap-large"]
  ...
  DUPTABLE R11 K18 [{"ActionsContainer", "ActionsLabel"}]
  GETUPVAL R13 4
  GETTABLEKS R12 R13 K7 ["createElement"]
  GETUPVAL R13 10
  DUPTABLE R14 K10 [{"tag", "LayoutOrder"}]
  NEWTABLE R15 4 0
  LOADK R17 K19 ["auto-y size-full-0 %*"]
  GETUPVAL R21 11
  GETTABLEKS R20 R21 K12 ["FoundationDialogActionsUpdate"]
  JUMPIFNOT R20 [+2]
  LOADK R19 K20 ["gap-small"]
  JUMP [+1]
  LOADK R19 K14 ["gap-large"]
  NAMECALL R17 R17 K15 ["format"]
  CALL R17 2 1
  MOVE R16 R17
  LOADB R17 1
  SETTABLE R17 R15 R16
  SETTABLEKS R6 R15 K21 ["row wrap"]
  SETTABLEKS R7 R15 K22 ["col flex-x-fill"]
  SETTABLEKS R15 R14 K8 ["tag"]
  LOADN R15 1
  SETTABLEKS R15 R14 K9 ["LayoutOrder"]
  DUPTABLE R15 K24 [{"Actions"}]
  SETTABLEKS R4 R15 K23 ["Actions"]
  CALL R12 3 1
  SETTABLEKS R12 R11 K16 ["ActionsContainer"]
  GETTABLEKS R13 R1 K25 ["label"]
  JUMPIFNOT R13 [+20]
  GETUPVAL R13 4
  GETTABLEKS R12 R13 K7 ["createElement"]
  GETUPVAL R13 12
  DUPTABLE R14 K27 [{"Text", "tag", "LayoutOrder"}]
  GETTABLEKS R15 R1 K25 ["label"]
  SETTABLEKS R15 R14 K26 ["Text"]
  GETTABLEKS R16 R2 K28 ["actionsLabel"]
  ...
  JUMP [+1]
  LOADNIL R12
  SETTABLEKS R12 R11 K17 ["ActionsLabel"]
  CALL R8 3 -1
  RETURN R8 -1
...
MAIN:
  ...
  GETTABLEKS R18 R19 K4 ["Parent"]
  GETTABLEKS R17 R18 K4 ["Parent"]
  GETTABLEKS R16 R17 K23 ["useDialogLayout"]
  CALL R15 1 1
