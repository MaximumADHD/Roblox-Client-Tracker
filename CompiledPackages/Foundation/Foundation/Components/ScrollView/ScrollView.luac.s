...
PROTO_1:
  ...
  GETUPVAL R17 11
  DUPTABLE R18 K38 [{"controlState", "scrollBarVisibility", "onCanvasPositionChanged", "onAbsoluteCanvasSizeChanged", "onAbsoluteWindowSizeChanged", "AutomaticSize", "AutomaticCanvasSize", "CanvasSize", "ClipsDescendants", "ScrollingDirection", "ScrollingEnabled", "VerticalScrollBarInset", "HorizontalScrollBarInset", "ref", "tag"}]
...
MAIN:
  ...
  CALL R14 1 1
  DUPTABLE R15 K31 [{"layout", "scroll", "AutoLocalize", "BorderSizePixel", "ClipsDescendants", "isDisabled"}]
  DUPTABLE R16 K33 [{"SortOrder"}]
  GETIMPORT R17 K36 [Enum.SortOrder.LayoutOrder]
  SETTABLEKS R17 R16 K32 ["SortOrder"]
  SETTABLEKS R16 R15 K25 ["layout"]
  DUPTABLE R16 K38 [{"scrollBarVisibility"}]
  GETTABLEKS R17 R13 K39 ["Auto"]
  SETTABLEKS R17 R16 K37 ["scrollBarVisibility"]
  SETTABLEKS R16 R15 K26 ["scroll"]
  LOADB R16 0
  SETTABLEKS R16 R15 K27 ["AutoLocalize"]
  LOADN R16 0
  SETTABLEKS R16 R15 K28 ["BorderSizePixel"]
  GETTABLEKS R17 R2 K40 ["FoundationScrollViewMoveClipOutside"]
  JUMPIFNOT R17 [+2]
  LOADB R16 1
  JUMP [+1]
  LOADNIL R16
  ...
  CAPTURE VAL R7
  CAPTURE VAL R5
  GETTABLEKS R17 R3 K42 ["memo"]
  GETTABLEKS R18 R3 K43 ["forwardRef"]
  MOVE R19 R16
  CALL R18 1 -1
  CALL R17 -1 -1
  RETURN R17 -1
