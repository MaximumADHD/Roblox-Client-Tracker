PROTO_0:
  ...
  GETUPVAL R8 4
  DUPTABLE R9 K14 [{"Size", "layout", "selection", "scroll"}]
  ...
  DUPTABLE R10 K19 [{"FillDirection"}]
  GETIMPORT R11 K21 [Enum.FillDirection.Vertical]
  SETTABLEKS R11 R10 K18 ["FillDirection"]
  SETTABLEKS R10 R9 K11 ["layout"]
  DUPTABLE R10 K23 [{"Selectable"}]
  GETTABLEKS R11 R1 K24 ["selectable"]
  SETTABLEKS R11 R10 K22 ["Selectable"]
  SETTABLEKS R10 R9 K12 ["selection"]
  DUPTABLE R10 K29 [{"AutomaticCanvasSize", "CanvasSize", "ScrollingDirection", "scrollBarVisibility"}]
  GETIMPORT R11 K32 [Enum.AutomaticSize.Y]
  SETTABLEKS R11 R10 K25 ["AutomaticCanvasSize"]
  GETIMPORT R11 K34 [UDim2.fromOffset]
  LOADN R12 0
  LOADN R13 0
  CALL R11 2 1
  SETTABLEKS R11 R10 K26 ["CanvasSize"]
  GETIMPORT R11 K35 [Enum.ScrollingDirection.Y]
  SETTABLEKS R11 R10 K27 ["ScrollingDirection"]
  GETTABLEKS R11 R1 K28 ["scrollBarVisibility"]
  SETTABLEKS R11 R10 K28 ["scrollBarVisibility"]
  SETTABLEKS R10 R9 K13 ["scroll"]
  NEWTABLE R10 0 2
  GETUPVAL R12 2
  GETTABLEKS R11 R12 K3 ["createElement"]
  GETUPVAL R12 3
  DUPTABLE R13 K37 [{"Size", "backgroundStyle"}]
  GETIMPORT R14 K34 [UDim2.fromOffset]
  LOADN R15 120
  LOADN R16 75
  CALL R14 2 1
  SETTABLEKS R14 R13 K10 ["Size"]
  GETTABLEKS R17 R2 K38 ["Color"]
  GETTABLEKS R16 R17 K39 ["Extended"]
  GETTABLEKS R15 R16 K40 ["Turquoise"]
  GETTABLEKS R14 R15 K41 ["Turquoise_500"]
  SETTABLEKS R14 R13 K36 ["backgroundStyle"]
  CALL R11 2 1
  GETUPVAL R13 2
  GETTABLEKS R12 R13 K3 ["createElement"]
  GETUPVAL R13 3
  DUPTABLE R14 K37 [{"Size", "backgroundStyle"}]
  GETIMPORT R15 K34 [UDim2.fromOffset]
  LOADN R16 120
  LOADN R17 75
  CALL R15 2 1
  SETTABLEKS R15 R14 K10 ["Size"]
  GETTABLEKS R18 R2 K38 ["Color"]
  GETTABLEKS R17 R18 K39 ["Extended"]
  GETTABLEKS R16 R17 K42 ["Magenta"]
  GETTABLEKS R15 R16 K43 ["Magenta_500"]
  SETTABLEKS R15 R14 K36 ["backgroundStyle"]
  CALL R12 2 -1
  SETLIST R10 R11 -1 [1]
  CALL R7 3 1
  ...
  SETTABLEKS R10 R9 K10 ["Size"]
  DUPTABLE R10 K19 [{"FillDirection"}]
  GETIMPORT R11 K44 [Enum.FillDirection.Horizontal]
  SETTABLEKS R11 R10 K18 ["FillDirection"]
  SETTABLEKS R10 R9 K11 ["layout"]
  DUPTABLE R10 K23 [{"Selectable"}]
  GETTABLEKS R11 R1 K24 ["selectable"]
  ...
  SETTABLEKS R10 R9 K12 ["selection"]
  DUPTABLE R10 K29 [{"AutomaticCanvasSize", "CanvasSize", "ScrollingDirection", "scrollBarVisibility"}]
  GETIMPORT R11 K46 [Enum.AutomaticSize.X]
  SETTABLEKS R11 R10 K25 ["AutomaticCanvasSize"]
  GETIMPORT R11 K34 [UDim2.fromOffset]
  LOADN R12 0
  LOADN R13 0
  CALL R11 2 1
  SETTABLEKS R11 R10 K26 ["CanvasSize"]
  GETIMPORT R11 K47 [Enum.ScrollingDirection.X]
  SETTABLEKS R11 R10 K27 ["ScrollingDirection"]
  GETTABLEKS R11 R1 K28 ["scrollBarVisibility"]
  SETTABLEKS R11 R10 K28 ["scrollBarVisibility"]
  SETTABLEKS R10 R9 K13 ["scroll"]
...
PROTO_1:
  ...
  DUPTABLE R6 K16 [{"ScrollView", "TagInfo"}]
  GETUPVAL R8 1
  GETTABLEKS R7 R8 K5 ["createElement"]
  GETUPVAL R8 4
  DUPTABLE R9 K19 [{"tag", "selection", "scroll", "LayoutOrder"}]
  LOADK R10 K20 ["row gap-medium bg-surface-100 padding-medium radius-medium size-full-3000"]
  SETTABLEKS R10 R9 K6 ["tag"]
  DUPTABLE R10 K22 [{"Selectable"}]
  GETTABLEKS R11 R1 K23 ["selectable"]
  SETTABLEKS R11 R10 K21 ["Selectable"]
  SETTABLEKS R10 R9 K17 ["selection"]
  DUPTABLE R10 K27 [{"AutomaticCanvasSize", "CanvasSize", "ScrollingDirection"}]
  GETIMPORT R11 K31 [Enum.AutomaticSize.X]
  ...
  GETIMPORT R11 K35 [Enum.ScrollingDirection.X]
  SETTABLEKS R11 R10 K26 ["ScrollingDirection"]
  SETTABLEKS R10 R9 K18 ["scroll"]
  LOADN R10 1
  SETTABLEKS R10 R9 K8 ["LayoutOrder"]
  MOVE R10 R2
  CALL R7 3 1
  SETTABLEKS R7 R6 K14 ["ScrollView"]
  GETUPVAL R8 1
  GETTABLEKS R7 R8 K5 ["createElement"]
  GETUPVAL R8 2
  DUPTABLE R9 K9 [{"tag", "Text", "LayoutOrder"}]
  LOADK R10 K36 ["text-label-small content-default size-full-200"]
  SETTABLEKS R10 R9 K6 ["tag"]
  LOADK R11 K37 ["tag = %*"]
  LOADK R13 K20 ["row gap-medium bg-surface-100 padding-medium radius-medium size-full-3000"]
  NAMECALL R11 R11 K4 ["format"]
  CALL R11 2 1
  MOVE R10 R11
  SETTABLEKS R10 R9 K7 ["Text"]
...
MAIN:
  ...
  DUPTABLE R12 K36 [{"scrollBarVisibility", "selectable", "fixScrollViewTags"}]
  NEWTABLE R13 0 3
  LOADK R14 K37 ["Auto"]
  LOADK R15 K38 ["Always"]
  LOADK R16 K39 ["None"]
  SETLIST R13 R14 3 [1]
  SETTABLEKS R13 R12 K33 ["scrollBarVisibility"]
  LOADB R13 1
  SETTABLEKS R13 R12 K34 ["selectable"]
  GETTABLEKS R13 R8 K40 ["FoundationFixScrollViewTags"]
  SETTABLEKS R13 R12 K35 ["fixScrollViewTags"]
