PROTO_0:
  ...
  GETUPVAL R2 1
  DUPTABLE R3 K7 [{"leading", "trailing", "text", "onActivated", "isChecked", "size"}]
  ...
  GETTABLEKS R6 R0 K1 ["leading"]
  FASTCALL1 TYPE R6 [+2]
  GETIMPORT R5 K9 [type]
  CALL R5 1 1
  JUMPIFNOTEQKS R5 K10 ["table"] [+4]
...
PROTO_2:
  ...
  GETUPVAL R1 1
  DUPTABLE R2 K10 [{"text", "onActivated", "leading", "trailing", "isChecked", "size", "chipDesignUpdate"}]
  ...
  GETTABLEKS R4 R0 K0 ["controls"]
  GETTABLEKS R3 R4 K9 ["chipDesignUpdate"]
  SETTABLEKS R3 R2 K9 ["chipDesignUpdate"]
  CALL R1 1 -1
  RETURN R1 -1
...
PROTO_4:
  ...
  GETUPVAL R3 1
  DUPTABLE R4 K9 [{"key", "text", "onActivated", "leading", "trailing", "isChecked", "size", "chipDesignUpdate"}]
  ...
  SETTABLEKS R0 R4 K7 ["size"]
  GETUPVAL R7 2
  GETTABLEKS R6 R7 K10 ["controls"]
  GETTABLEKS R5 R6 K8 ["chipDesignUpdate"]
  SETTABLEKS R5 R4 K8 ["chipDesignUpdate"]
  CALL R2 2 -1
  RETURN R2 -1
...
PROTO_7:
  ...
  GETTABLEKS R1 R2 K0 ["createElement"]
  GETUPVAL R2 1
  DUPTABLE R3 K7 [{"text", "onActivated", "leading", "isChecked", "size", "chipDesignUpdate"}]
  ...
  DUPTABLE R4 K12 [{"type", "props"}]
  LOADK R5 K13 ["AvatarGroup"]
  SETTABLEKS R5 R4 K10 ["type"]
  DUPTABLE R5 K16 [{"avatars", "type", "max"}]
  NEWTABLE R6 0 4
  LOADK R7 K17 [24813339]
  LOADK R8 K18 [24813338]
  LOADK R9 K19 [24813337]
  LOADK R10 K20 [24813336]
  SETLIST R6 R7 4 [1]
  SETTABLEKS R6 R5 K14 ["avatars"]
  GETUPVAL R7 2
  GETTABLEKS R6 R7 K21 ["Stacked"]
  SETTABLEKS R6 R5 K10 ["type"]
  LOADN R6 3
  SETTABLEKS R6 R5 K15 ["max"]
  SETTABLEKS R5 R4 K11 ["props"]
  ...
  GETTABLEKS R5 R0 K8 ["controls"]
  GETTABLEKS R4 R5 K6 ["chipDesignUpdate"]
  SETTABLEKS R4 R3 K6 ["chipDesignUpdate"]
  CALL R1 2 -1
  RETURN R1 -1
...
PROTO_9:
  ...
  GETUPVAL R9 4
  DUPTABLE R10 K16 [{"text", "onActivated", "leading", "isChecked", "size", "chipDesignUpdate"}]
  GETTABLEKS R12 R0 K17 ["controls"]
  GETTABLEKS R11 R12 K10 ["text"]
  SETTABLEKS R11 R10 K10 ["text"]
  DUPCLOSURE R11 K18 [PROTO_8]
  SETTABLEKS R11 R10 K11 ["onActivated"]
  DUPTABLE R11 K21 [{"type", "props"}]
  LOADK R12 K22 ["AvatarGroup"]
  SETTABLEKS R12 R11 K19 ["type"]
  DUPTABLE R12 K25 [{"avatars", "type", "max"}]
  NEWTABLE R13 0 4
  LOADK R14 K26 [24813339]
  LOADK R15 K27 [24813338]
  LOADK R16 K28 [24813337]
  LOADK R17 K29 [24813336]
  SETLIST R13 R14 4 [1]
  SETTABLEKS R13 R12 K23 ["avatars"]
  GETUPVAL R14 5
  GETTABLEKS R13 R14 K30 ["Stacked"]
  SETTABLEKS R13 R12 K19 ["type"]
  LOADN R13 3
  SETTABLEKS R13 R12 K24 ["max"]
  SETTABLEKS R12 R11 K20 ["props"]
  ...
  GETTABLEKS R12 R0 K17 ["controls"]
  GETTABLEKS R11 R12 K15 ["chipDesignUpdate"]
  SETTABLEKS R11 R10 K15 ["chipDesignUpdate"]
  CALL R8 2 -1
  CALL R5 -1 -1
  CALL R2 -1 -1
  RETURN R2 -1
...
PROTO_12:
  ...
  GETTABLEKS R5 R6 K0 ["createElement"]
  GETUPVAL R6 2
  DUPTABLE R7 K13 [{"icon", "text", "onActivated", "isChecked"}]
  DUPTABLE R8 K16 [{"name", "position"}]
  LOADK R9 K10 ["icons/common/robux"]
  SETTABLEKS R9 R8 K14 ["name"]
  GETUPVAL R10 3
  GETTABLEKS R9 R10 K17 ["Right"]
...
MAIN:
  ...
  DUPTABLE R14 K46 [{"leading", "trailing", "size", "text", "isChecked", "migrateIconNames"}]
  NEWTABLE R15 0 6
  LOADK R16 K47 ["robux"]
  LOADK R17 K48 ["icons/actions/filter"]
  LOADK R18 K49 ["icons/common/robux"]
  LOADK R19 K50 ["icons/common/play"]
  DUPTABLE R20 K54 [{"iconName", "onActivated", "isCircular"}]
  LOADK R21 K55 ["icons/actions/selectOn"]
  SETTABLEKS R21 R20 K51 ["iconName"]
  DUPCLOSURE R21 K56 [PROTO_13]
  SETTABLEKS R21 R20 K52 ["onActivated"]
  LOADB R21 1
  SETTABLEKS R21 R20 K53 ["isCircular"]
  LOADK R21 K57 [""]
  SETLIST R15 R16 6 [1]
  SETTABLEKS R15 R14 K40 ["leading"]
  NEWTABLE R15 0 8
  LOADK R16 K58 ["three-bars-horizontal-narrowing"]
  LOADK R17 K48 ["icons/actions/filter"]
  LOADK R18 K49 ["icons/common/robux"]
  LOADK R19 K50 ["icons/common/play"]
  LOADK R20 K59 ["icons/status/success_small"]
  LOADK R21 K60 ["icons/actions/truncationExpand_small"]
  DUPTABLE R22 K54 [{"iconName", "onActivated", "isCircular"}]
  LOADK R23 K55 ["icons/actions/selectOn"]
  SETTABLEKS R23 R22 K51 ["iconName"]
  DUPCLOSURE R23 K61 [PROTO_14]
  SETTABLEKS R23 R22 K52 ["onActivated"]
  LOADB R23 1
  SETTABLEKS R23 R22 K53 ["isCircular"]
  LOADK R23 K57 [""]
  SETLIST R15 R16 8 [1]
  SETTABLEKS R15 R14 K41 ["trailing"]
  GETTABLEKS R15 R3 K62 ["values"]
  MOVE R16 R5
  CALL R15 1 1
  SETTABLEKS R15 R14 K42 ["size"]
  LOADK R15 K63 ["Filter"]
  SETTABLEKS R15 R14 K43 ["text"]
  LOADB R15 0
  SETTABLEKS R15 R14 K44 ["isChecked"]
  GETTABLEKS R15 R4 K64 ["FoundationMigrateIconNames"]
  SETTABLEKS R15 R14 K45 ["migrateIconNames"]
