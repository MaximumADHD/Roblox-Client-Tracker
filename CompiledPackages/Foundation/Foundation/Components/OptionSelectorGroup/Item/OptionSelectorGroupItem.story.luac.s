PROTO_0:
  ...
  LOADK R7 K6 ["%* %*"]
  MOVE R9 R4
  LOADK R10 K7 [" that goes on and on and on to test how the component handles text overflow and wrapping in various scenarios with extremely long content"]
  ...
  DUPTABLE R10 K17 [{"value", "onValueChanged", "Selectable", "orientation"}]
  SETTABLEKS R2 R10 K12 ["value"]
  SETTABLEKS R3 R10 K14 ["onValueChanged"]
  LOADB R11 1
  SETTABLEKS R11 R10 K15 ["Selectable"]
  GETTABLEKS R11 R1 K16 ["orientation"]
  SETTABLEKS R11 R10 K16 ["orientation"]
  SETTABLEKS R10 R9 K12 ["value"]
  NEWTABLE R10 0 1
  GETUPVAL R12 0
  GETTABLEKS R11 R12 K10 ["createElement"]
  GETUPVAL R13 2
  GETTABLEKS R12 R13 K18 ["Item"]
  DUPTABLE R13 K22 [{"icon", "value", "label", "metadata", "description", "isDisabled", "size"}]
  GETTABLEKS R14 R1 K19 ["icon"]
  SETTABLEKS R14 R13 K19 ["icon"]
  GETTABLEKS R14 R1 K12 ["value"]
  ...
  GETTABLEKS R14 R1 K20 ["isDisabled"]
  SETTABLEKS R14 R13 K20 ["isDisabled"]
  GETTABLEKS R14 R1 K21 ["size"]
