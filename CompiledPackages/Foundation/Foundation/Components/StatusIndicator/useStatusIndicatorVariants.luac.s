PROTO_0:
  ...
  SETTABLE R4 R2 R3
  GETUPVAL R4 0
  GETTABLEKS R3 R4 K26 ["Contrast_Experiment"]
  DUPTABLE R4 K2 [{"container", "content"}]
  DUPTABLE R5 K4 [{"tag"}]
  LOADK R6 K27 ["bg-system-contrast"]
  SETTABLEKS R6 R5 K3 ["tag"]
  SETTABLEKS R5 R4 K0 ["container"]
  DUPTABLE R5 K10 [{"style"}]
  GETTABLEKS R8 R0 K22 ["Inverse"]
  ...
  NEWTABLE R3 2 0
  LOADB R4 0
  DUPTABLE R5 K28 [{"container"}]
  DUPTABLE R6 K4 [{"tag"}]
  LOADK R7 K29 ["size-200-200"]
  ...
  DUPTABLE R5 K28 [{"container"}]
  DUPTABLE R6 K4 [{"tag"}]
  LOADK R7 K30 ["size-400-400 auto-x row align-y-center align-x-center padding-xsmall"]
  SETTABLEKS R7 R6 K3 ["tag"]
  SETTABLEKS R6 R5 K0 ["container"]
  SETTABLE R5 R3 R4
  DUPTABLE R4 K34 [{"common", "variants", "hasValue"}]
  SETTABLEKS R1 R4 K31 ["common"]
  SETTABLEKS R2 R4 K32 ["variants"]
  SETTABLEKS R3 R4 K33 ["hasValue"]
  RETURN R4 1
