...
PROTO_2:
  ...
  GETUPVAL R8 1
  DUPTABLE R9 K17 [{"tag"}]
  LOADK R10 K18 ["auto-xy bg-surface-100 radius-medium"]
  SETTABLEKS R10 R9 K2 ["tag"]
  GETUPVAL R11 0
  GETTABLEKS R10 R11 K0 ["createElement"]
  GETUPVAL R11 4
  DUPTABLE R12 K21 [{"name", "size"}]
  LOADK R13 K22 ["icons/controls/voice/microphone_off_light"]
...
MAIN:
  ...
  DUPTABLE R15 K31 [{"name", "story"}]
  LOADK R16 K36 ["Short text"]
  ...
  DUPTABLE R12 K41 [{"title", "side", "align"}]
  LOADK R13 K42 ["Title"]
  SETTABLEKS R13 R12 K38 ["title"]
  GETTABLEKS R13 R3 K43 ["values"]
  MOVE R14 R8
  CALL R13 1 1
  SETTABLEKS R13 R12 K39 ["side"]
  GETTABLEKS R13 R3 K43 ["values"]
  MOVE R14 R9
  CALL R13 1 1
  SETTABLEKS R13 R12 K40 ["align"]
