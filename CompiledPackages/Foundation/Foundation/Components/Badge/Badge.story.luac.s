...
PROTO_3:
  ...
  SETTABLEKS R2 R1 K2 ["FoundationUpdateBadgeDesign"]
  GETUPVAL R1 1
  CALL R1 0 1
  GETTABLEKS R4 R0 K0 ["controls"]
  GETTABLEKS R3 R4 K1 ["updateBadgeDesign"]
  JUMPIFNOT R3 [+2]
  GETUPVAL R2 2
  JUMP [+1]
  GETUPVAL R2 3
  ...
  CAPTURE UPVAL U5
  NEWTABLE R7 0 1
  LOADK R8 K5 [21070012]
  SETLIST R7 R8 1 [1]
  CALL R5 2 0
  GETTABLEKS R6 R0 K0 ["controls"]
  GETTABLEKS R5 R6 K6 ["onTile"]
  JUMPIFNOT R5 [+214]
  GETUPVAL R6 4
  GETTABLEKS R5 R6 K7 ["createElement"]
  GETUPVAL R7 6
  GETTABLEKS R6 R7 K8 ["Root"]
  DUPTABLE R7 K12 [{"isContained", "FillDirection", "Size"}]
  LOADB R8 1
  SETTABLEKS R8 R7 K9 ["isContained"]
  GETIMPORT R8 K15 [Enum.FillDirection.Vertical]
  SETTABLEKS R8 R7 K10 ["FillDirection"]
  GETUPVAL R8 7
  SETTABLEKS R8 R7 K11 ["Size"]
  DUPTABLE R8 K18 [{"TileMedia", "TileContent"}]
  GETUPVAL R10 4
  GETTABLEKS R9 R10 K7 ["createElement"]
  GETUPVAL R11 6
  GETTABLEKS R10 R11 K19 ["Media"]
  DUPTABLE R11 K24 [{"id", "type", "aspectRatio", "background"}]
  LOADK R12 K5 [21070012]
  SETTABLEKS R12 R11 K20 ["id"]
  GETUPVAL R13 8
  GETTABLEKS R12 R13 K25 ["Asset"]
  SETTABLEKS R12 R11 K21 ["type"]
  LOADN R12 1
  SETTABLEKS R12 R11 K22 ["aspectRatio"]
  DUPTABLE R12 K27 [{"image"}]
  LOADK R14 K28 ["component_assets/itemBG_"]
  GETTABLEKS R18 R1 K29 ["Config"]
  GETTABLEKS R17 R18 K30 ["Theme"]
  GETTABLEKS R16 R17 K31 ["Name"]
  GETUPVAL R18 9
  GETTABLEKS R17 R18 K32 ["Dark"]
  ...
  SETTABLEKS R12 R11 K23 ["background"]
  DUPTABLE R12 K37 [{"UIListLayout", "Badge"}]
  GETUPVAL R14 4
  GETTABLEKS R13 R14 K7 ["createElement"]
  LOADK R14 K35 ["UIListLayout"]
  DUPTABLE R15 K41 [{"FillDirection", "HorizontalAlignment", "VerticalAlignment", "SortOrder"}]
  GETIMPORT R16 K15 [Enum.FillDirection.Vertical]
  ...
  GETIMPORT R16 K45 [Enum.VerticalAlignment.Bottom]
  SETTABLEKS R16 R15 K39 ["VerticalAlignment"]
  GETIMPORT R16 K47 [Enum.SortOrder.LayoutOrder]
  SETTABLEKS R16 R15 K40 ["SortOrder"]
  CALL R13 2 1
  SETTABLEKS R13 R12 K35 ["UIListLayout"]
  GETUPVAL R14 4
  GETTABLEKS R13 R14 K7 ["createElement"]
  MOVE R14 R2
  DUPTABLE R15 K53 [{"text", "icon", "size", "isDisabled", "variant"}]
  GETTABLEKS R17 R0 K0 ["controls"]
  GETTABLEKS R16 R17 K48 ["text"]
  SETTABLEKS R16 R15 K48 ["text"]
  GETTABLEKS R18 R0 K0 ["controls"]
  GETTABLEKS R17 R18 K49 ["icon"]
  JUMPIFEQKS R17 K54 [""] [+6]
  GETTABLEKS R17 R0 K0 ["controls"]
  GETTABLEKS R16 R17 K49 ["icon"]
  JUMP [+1]
  LOADNIL R16
  SETTABLEKS R16 R15 K49 ["icon"]
  GETTABLEKS R17 R0 K0 ["controls"]
  GETTABLEKS R16 R17 K50 ["size"]
  SETTABLEKS R16 R15 K50 ["size"]
  GETTABLEKS R17 R0 K0 ["controls"]
  GETTABLEKS R16 R17 K51 ["isDisabled"]
  SETTABLEKS R16 R15 K51 ["isDisabled"]
  GETTABLEKS R17 R0 K0 ["controls"]
  GETTABLEKS R16 R17 K52 ["variant"]
  SETTABLEKS R16 R15 K52 ["variant"]
  CALL R13 2 1
  SETTABLEKS R13 R12 K36 ["Badge"]
  CALL R9 3 1
  SETTABLEKS R9 R8 K16 ["TileMedia"]
  GETUPVAL R10 4
  GETTABLEKS R9 R10 K7 ["createElement"]
  GETUPVAL R11 6
  GETTABLEKS R10 R11 K55 ["Content"]
  NEWTABLE R11 0 0
  DUPTABLE R12 K57 [{"TileHeader"}]
  GETUPVAL R14 4
  GETTABLEKS R13 R14 K7 ["createElement"]
  GETUPVAL R15 6
  GETTABLEKS R14 R15 K58 ["Header"]
  DUPTABLE R15 K62 [{"title", "subtitle", "spacing"}]
  DUPTABLE R16 K66 [{"text", "isLoading", "fontStyle", "numLines"}]
  GETTABLEKS R17 R3 K31 ["Name"]
  SETTABLEKS R17 R16 K48 ["text"]
  GETTABLEKS R18 R3 K31 ["Name"]
  JUMPIFEQKNIL R18 [+2]
  LOADB R17 0 +1
  LOADB R17 1
  SETTABLEKS R17 R16 K63 ["isLoading"]
  GETTABLEKS R18 R1 K67 ["Typography"]
  GETTABLEKS R17 R18 K68 ["HeadingSmall"]
  SETTABLEKS R17 R16 K64 ["fontStyle"]
  LOADN R17 2
  SETTABLEKS R17 R16 K65 ["numLines"]
  SETTABLEKS R16 R15 K59 ["title"]
  DUPTABLE R16 K70 [{"text", "isLoading", "fontStyle", "colorStyle"}]
  GETTABLEKS R17 R3 K71 ["PriceText"]
  SETTABLEKS R17 R16 K48 ["text"]
  GETTABLEKS R18 R3 K71 ["PriceText"]
  JUMPIFEQKNIL R18 [+2]
  LOADB R17 0 +1
  LOADB R17 1
  SETTABLEKS R17 R16 K63 ["isLoading"]
  GETTABLEKS R18 R1 K67 ["Typography"]
  GETTABLEKS R17 R18 K72 ["BodyLarge"]
  SETTABLEKS R17 R16 K64 ["fontStyle"]
  GETTABLEKS R19 R1 K73 ["Color"]
  GETTABLEKS R18 R19 K55 ["Content"]
  GETTABLEKS R17 R18 K74 ["Muted"]
  SETTABLEKS R17 R16 K69 ["colorStyle"]
  SETTABLEKS R16 R15 K60 ["subtitle"]
  GETTABLEKS R17 R1 K75 ["Gap"]
  GETTABLEKS R16 R17 K76 ["Small"]
  SETTABLEKS R16 R15 K61 ["spacing"]
  CALL R13 2 1
  SETTABLEKS R13 R12 K56 ["TileHeader"]
  CALL R9 3 1
  SETTABLEKS R9 R8 K17 ["TileContent"]
  CALL R5 3 -1
  RETURN R5 -1
  GETUPVAL R6 4
  GETTABLEKS R5 R6 K7 ["createElement"]
  MOVE R6 R2
  DUPTABLE R7 K53 [{"text", "icon", "size", "isDisabled", "variant"}]
  GETTABLEKS R9 R0 K0 ["controls"]
  GETTABLEKS R8 R9 K48 ["text"]
  SETTABLEKS R8 R7 K48 ["text"]
  GETTABLEKS R10 R0 K0 ["controls"]
  GETTABLEKS R9 R10 K49 ["icon"]
  JUMPIFEQKS R9 K54 [""] [+6]
  GETTABLEKS R9 R0 K0 ["controls"]
  GETTABLEKS R8 R9 K49 ["icon"]
  JUMP [+1]
  LOADNIL R8
  SETTABLEKS R8 R7 K49 ["icon"]
  GETTABLEKS R9 R0 K0 ["controls"]
  GETTABLEKS R8 R9 K50 ["size"]
  SETTABLEKS R8 R7 K50 ["size"]
  GETTABLEKS R9 R0 K0 ["controls"]
  GETTABLEKS R8 R9 K51 ["isDisabled"]
  SETTABLEKS R8 R7 K51 ["isDisabled"]
  GETTABLEKS R9 R0 K0 ["controls"]
  GETTABLEKS R8 R9 K52 ["variant"]
  SETTABLEKS R8 R7 K52 ["variant"]
  CALL R5 2 -1
  RETURN R5 -1
...
MAIN:
  ...
  DUPTABLE R18 K52 [{"text", "icon", "variant", "onTile", "updateBadgeDesign"}]
  LOADK R19 K53 ["Label"]
  SETTABLEKS R19 R18 K47 ["text"]
  NEWTABLE R19 0 5
  LOADK R20 K54 ["diamond-simplified"]
  LOADK R21 K55 ["house"]
  LOADK R22 K56 ["icons/placeholder/placeholderOn_small"]
  LOADK R23 K57 ["icons/menu/clothing/limited_on"]
  LOADK R24 K58 [""]
  SETLIST R19 R20 5 [1]
  ...
  GETTABLEKS R19 R14 K59 ["FoundationUpdateBadgeDesign"]
  SETTABLEKS R19 R18 K51 ["updateBadgeDesign"]
