...
MAIN:
  ...
  CALL R10 1 1
  DUPTABLE R11 K24 [{"variant", "orientation", "testId"}]
  GETTABLEKS R12 R8 K25 ["Default"]
  SETTABLEKS R12 R11 K21 ["variant"]
  GETTABLEKS R12 R9 K26 ["Horizontal"]
  SETTABLEKS R12 R11 K22 ["orientation"]
  LOADK R12 K27 ["--foundation-divider"]
  ...
  CAPTURE VAL R4
  CAPTURE VAL R7
  GETTABLEKS R13 R2 K29 ["memo"]
  GETTABLEKS R14 R2 K30 ["forwardRef"]
  MOVE R15 R12
  CALL R14 1 -1
  CALL R13 -1 -1
  RETURN R13 -1
