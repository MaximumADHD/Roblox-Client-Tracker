...
MAIN:
  ...
  LOADK R12 K25 ["Narrow dropdown narrow items"]
  ...
  LOADK R13 K27 ["Narrow dropdown wider items"]
  ...
  LOADK R14 K29 ["Wide dropdown narrow items"]
  ...
  DUPTABLE R9 K37 [{"size", "isDisabled", "label", "hasError", "hasIcon", "hasPlaceholder"}]
  GETTABLEKS R10 R3 K38 ["values"]
  MOVE R11 R6
  CALL R10 1 1
  SETTABLEKS R10 R9 K31 ["size"]
  LOADB R10 0
  SETTABLEKS R10 R9 K32 ["isDisabled"]
  LOADK R10 K39 ["Dropdown Label"]
  SETTABLEKS R10 R9 K33 ["label"]
  LOADB R10 0
  SETTABLEKS R10 R9 K34 ["hasError"]
  LOADB R10 1
  SETTABLEKS R10 R9 K35 ["hasIcon"]
  LOADB R10 0
  SETTABLEKS R10 R9 K36 ["hasPlaceholder"]
