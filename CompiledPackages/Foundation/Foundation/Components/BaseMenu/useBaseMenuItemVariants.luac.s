PROTO_0:
  ...
  DUPTABLE R5 K7 [{"tag"}]
  LOADK R7 K21 ["size-full-600 radius-small %* gap-xsmall"]
  GETUPVAL R11 0
  GETTABLEKS R10 R11 K22 ["FoundationMenuItemStyles"]
  JUMPIFNOT R10 [+2]
  LOADK R9 K23 ["padding-x-medium"]
  JUMP [+1]
  LOADK R9 K24 ["padding-x-xsmall"]
  NAMECALL R7 R7 K25 ["format"]
  CALL R7 2 1
  MOVE R6 R7
  SETTABLEKS R6 R5 K6 ["tag"]
  SETTABLEKS R5 R4 K0 ["container"]
  DUPTABLE R5 K27 [{"tag", "size"}]
  LOADK R6 K28 ["size-400"]
  SETTABLEKS R6 R5 K6 ["tag"]
  GETUPVAL R7 2
  ...
  DUPTABLE R5 K7 [{"tag"}]
  GETUPVAL R8 0
  GETTABLEKS R7 R8 K22 ["FoundationMenuItemStyles"]
  JUMPIFNOT R7 [+2]
  LOADK R6 K29 ["text-body-small"]
  JUMP [+1]
  LOADK R6 K30 ["text-title-small"]
  SETTABLEKS R6 R5 K6 ["tag"]
  SETTABLEKS R5 R4 K2 ["text"]
  DUPTABLE R5 K7 [{"tag"}]
  LOADK R6 K31 ["text-caption-small"]
  SETTABLEKS R6 R5 K6 ["tag"]
  SETTABLEKS R5 R4 K3 ["title"]
  DUPTABLE R5 K27 [{"tag", "size"}]
  LOADK R6 K32 ["size-300"]
  SETTABLEKS R6 R5 K6 ["tag"]
  GETTABLEKS R7 R0 K33 ["Size"]
  GETTABLEKS R6 R7 K34 ["Size_600"]
  SETTABLEKS R6 R5 K26 ["size"]
  SETTABLEKS R5 R4 K4 ["check"]
  SETTABLE R4 R2 R3
  GETUPVAL R4 1
  GETTABLEKS R3 R4 K35 ["Small"]
  DUPTABLE R4 K5 [{"container", "icon", "text", "title", "check"}]
  DUPTABLE R5 K7 [{"tag"}]
  LOADK R7 K36 ["size-full-800 radius-medium %* gap-xsmall"]
  GETUPVAL R11 0
  GETTABLEKS R10 R11 K22 ["FoundationMenuItemStyles"]
  JUMPIFNOT R10 [+2]
  LOADK R9 K23 ["padding-x-medium"]
  JUMP [+1]
  LOADK R9 K37 ["padding-x-small"]
  NAMECALL R7 R7 K25 ["format"]
  CALL R7 2 1
  MOVE R6 R7
  SETTABLEKS R6 R5 K6 ["tag"]
  SETTABLEKS R5 R4 K0 ["container"]
  DUPTABLE R5 K27 [{"tag", "size"}]
  LOADK R6 K38 ["size-500"]
  SETTABLEKS R6 R5 K6 ["tag"]
  GETUPVAL R7 2
  GETTABLEKS R6 R7 K35 ["Small"]
  SETTABLEKS R6 R5 K26 ["size"]
  SETTABLEKS R5 R4 K1 ["icon"]
  DUPTABLE R5 K7 [{"tag"}]
  GETUPVAL R8 0
  ...
  SETTABLEKS R6 R5 K6 ["tag"]
  GETTABLEKS R7 R0 K33 ["Size"]
  GETTABLEKS R6 R7 K39 ["Size_700"]
  SETTABLEKS R6 R5 K26 ["size"]
  SETTABLEKS R5 R4 K4 ["check"]
  SETTABLE R4 R2 R3
  GETUPVAL R4 1
  GETTABLEKS R3 R4 K40 ["Medium"]
  DUPTABLE R4 K5 [{"container", "icon", "text", "title", "check"}]
  DUPTABLE R5 K7 [{"tag"}]
  LOADK R7 K41 ["size-full-1000 radius-medium %* gap-small"]
  GETUPVAL R11 0
  GETTABLEKS R10 R11 K22 ["FoundationMenuItemStyles"]
  JUMPIFNOT R10 [+2]
  LOADK R9 K23 ["padding-x-medium"]
  ...
  SETTABLEKS R5 R4 K0 ["container"]
  DUPTABLE R5 K27 [{"tag", "size"}]
  LOADK R6 K42 ["size-600"]
  SETTABLEKS R6 R5 K6 ["tag"]
  GETUPVAL R7 2
  GETTABLEKS R6 R7 K40 ["Medium"]
  SETTABLEKS R6 R5 K26 ["size"]
  SETTABLEKS R5 R4 K1 ["icon"]
  DUPTABLE R5 K7 [{"tag"}]
  GETUPVAL R8 0
  GETTABLEKS R7 R8 K22 ["FoundationMenuItemStyles"]
  JUMPIFNOT R7 [+2]
  LOADK R6 K43 ["text-body-medium"]
  JUMP [+1]
  LOADK R6 K44 ["text-title-medium"]
  SETTABLEKS R6 R5 K6 ["tag"]
  SETTABLEKS R5 R4 K2 ["text"]
  DUPTABLE R5 K7 [{"tag"}]
  GETUPVAL R8 0
  GETTABLEKS R7 R8 K22 ["FoundationMenuItemStyles"]
  JUMPIFNOT R7 [+2]
  LOADK R6 K45 ["text-caption-medium"]
  JUMP [+1]
  LOADK R6 K44 ["text-title-medium"]
  SETTABLEKS R6 R5 K6 ["tag"]
  SETTABLEKS R5 R4 K3 ["title"]
  ...
  SETTABLEKS R6 R5 K6 ["tag"]
  GETTABLEKS R7 R0 K33 ["Size"]
  GETTABLEKS R6 R7 K46 ["Size_800"]
  SETTABLEKS R6 R5 K26 ["size"]
  SETTABLEKS R5 R4 K4 ["check"]
  SETTABLE R4 R2 R3
  GETUPVAL R4 1
  GETTABLEKS R3 R4 K47 ["Large"]
  DUPTABLE R4 K5 [{"container", "icon", "text", "title", "check"}]
  DUPTABLE R5 K7 [{"tag"}]
  LOADK R7 K48 ["size-full-1200 radius-medium %* gap-small"]
  GETUPVAL R11 0
  GETTABLEKS R10 R11 K22 ["FoundationMenuItemStyles"]
  JUMPIFNOT R10 [+2]
  LOADK R9 K49 ["padding-x-large"]
  JUMP [+1]
  LOADK R9 K37 ["padding-x-small"]
  NAMECALL R7 R7 K25 ["format"]
  CALL R7 2 1
  ...
  SETTABLEKS R5 R4 K0 ["container"]
  DUPTABLE R5 K27 [{"tag", "size"}]
  LOADK R6 K50 ["size-700"]
  SETTABLEKS R6 R5 K6 ["tag"]
  GETUPVAL R7 2
  GETTABLEKS R6 R7 K47 ["Large"]
  SETTABLEKS R6 R5 K26 ["size"]
  SETTABLEKS R5 R4 K1 ["icon"]
  DUPTABLE R5 K7 [{"tag"}]
  GETUPVAL R8 0
  GETTABLEKS R7 R8 K22 ["FoundationMenuItemStyles"]
  JUMPIFNOT R7 [+2]
  LOADK R6 K51 ["text-body-large"]
  JUMP [+1]
  LOADK R6 K52 ["text-title-large"]
  SETTABLEKS R6 R5 K6 ["tag"]
  SETTABLEKS R5 R4 K2 ["text"]
  DUPTABLE R5 K7 [{"tag"}]
  LOADK R6 K53 ["text-caption-large"]
  SETTABLEKS R6 R5 K6 ["tag"]
  SETTABLEKS R5 R4 K3 ["title"]
  DUPTABLE R5 K27 [{"tag", "size"}]
  LOADK R6 K42 ["size-600"]
  SETTABLEKS R6 R5 K6 ["tag"]
  GETTABLEKS R7 R0 K33 ["Size"]
  GETTABLEKS R6 R7 K54 ["Size_900"]
  SETTABLEKS R6 R5 K26 ["size"]
  SETTABLEKS R5 R4 K4 ["check"]
  SETTABLE R4 R2 R3
  NEWTABLE R3 2 0
  LOADB R4 0
  DUPTABLE R5 K55 [{"container"}]
  DUPTABLE R6 K7 [{"tag"}]
  LOADK R7 K56 [""]
  ...
  DUPTABLE R5 K55 [{"container"}]
  DUPTABLE R6 K7 [{"tag"}]
  LOADK R7 K57 ["bg-surface-200"]
  SETTABLEKS R7 R6 K6 ["tag"]
  SETTABLEKS R6 R5 K0 ["container"]
  SETTABLE R5 R3 R4
  DUPTABLE R4 K61 [{"common", "sizes", "isChecked"}]
  SETTABLEKS R1 R4 K58 ["common"]
  SETTABLEKS R2 R4 K59 ["sizes"]
  SETTABLEKS R3 R4 K60 ["isChecked"]
  RETURN R4 1

PROTO_1:
  GETUPVAL R4 0
  GETTABLEKS R3 R4 K0 ["useVariants"]
  LOADK R4 K1 ["BaseMenuItem"]
  GETUPVAL R5 1
  MOVE R6 R0
  CALL R3 3 1
  GETUPVAL R4 2
