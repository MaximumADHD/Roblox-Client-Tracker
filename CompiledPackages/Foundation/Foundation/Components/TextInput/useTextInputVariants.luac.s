PROTO_0:
  ...
  DUPTABLE R2 K13 [{"tag", "horizontalPadding", "gap", "radius"}]
  GETTABLEKS R3 R0 K14 ["innerContainerTag"]
  SETTABLEKS R3 R2 K6 ["tag"]
  GETIMPORT R3 K17 [UDim.new]
  LOADN R4 0
  GETTABLEKS R5 R0 K10 ["horizontalPadding"]
  CALL R3 2 1
  SETTABLEKS R3 R2 K10 ["horizontalPadding"]
  ...
  DUPTABLE R2 K21 [{"tag", "Font", "FontSize", "LineHeight"}]
  GETTABLEKS R3 R0 K22 ["textBoxTag"]
  SETTABLEKS R3 R2 K6 ["tag"]
  GETTABLEKS R4 R0 K23 ["typography"]
  GETTABLEKS R3 R4 K18 ["Font"]
  SETTABLEKS R3 R2 K18 ["Font"]
  GETTABLEKS R4 R0 K23 ["typography"]
  GETTABLEKS R3 R4 K19 ["FontSize"]
  SETTABLEKS R3 R2 K19 ["FontSize"]
  GETTABLEKS R4 R0 K23 ["typography"]
  GETTABLEKS R3 R4 K20 ["LineHeight"]
  SETTABLEKS R3 R2 K20 ["LineHeight"]
  SETTABLEKS R2 R1 K3 ["textBox"]
  DUPTABLE R2 K25 [{"size"}]
  GETTABLEKS R3 R0 K26 ["iconSize"]
...
PROTO_1:
  ...
  SETTABLEKS R6 R5 K16 ["canvasTag"]
  LOADK R6 K37 ["radius-medium"]
  SETTABLEKS R6 R5 K17 ["outerContainerTag"]
  GETTABLEKS R7 R0 K28 ["Radius"]
  GETTABLEKS R6 R7 K29 ["Small"]
  SETTABLEKS R6 R5 K18 ["radius"]
  LOADK R6 K38 ["gap-medium"]
  SETTABLEKS R6 R5 K19 ["innerContainerTag"]
  GETTABLEKS R7 R0 K31 ["Padding"]
  GETTABLEKS R6 R7 K29 ["Small"]
  SETTABLEKS R6 R5 K20 ["horizontalPadding"]
  GETTABLEKS R7 R0 K32 ["Gap"]
  GETTABLEKS R6 R7 K39 ["Medium"]
  SETTABLEKS R6 R5 K21 ["gap"]
  LOADK R6 K40 ["text-body-medium"]
  SETTABLEKS R6 R5 K22 ["textBoxTag"]
  GETTABLEKS R7 R0 K34 ["Typography"]
  GETTABLEKS R6 R7 K41 ["BodyMedium"]
  SETTABLEKS R6 R5 K23 ["typography"]
  GETUPVAL R7 2
  GETTABLEKS R6 R7 K15 ["XSmall"]
  SETTABLEKS R6 R5 K24 ["iconSize"]
  ...
  SETTABLE R4 R2 R3
  GETUPVAL R4 0
  GETTABLEKS R3 R4 K39 ["Medium"]
  GETUPVAL R4 1
  DUPTABLE R5 K25 [{"canvasTag", "outerContainerTag", "radius", "innerContainerTag", "horizontalPadding", "gap", "textBoxTag", "typography", "iconSize"}]
  LOADK R6 K42 ["size-full-1000"]
  SETTABLEKS R6 R5 K16 ["canvasTag"]
  LOADK R6 K37 ["radius-medium"]
  SETTABLEKS R6 R5 K17 ["outerContainerTag"]
  GETTABLEKS R7 R0 K28 ["Radius"]
  GETTABLEKS R6 R7 K29 ["Small"]
  SETTABLEKS R6 R5 K18 ["radius"]
  LOADK R6 K43 ["gap-large"]
  SETTABLEKS R6 R5 K19 ["innerContainerTag"]
  GETTABLEKS R7 R0 K31 ["Padding"]
  GETTABLEKS R6 R7 K29 ["Small"]
  SETTABLEKS R6 R5 K20 ["horizontalPadding"]
  GETTABLEKS R7 R0 K32 ["Gap"]
  GETTABLEKS R6 R7 K44 ["Large"]
  SETTABLEKS R6 R5 K21 ["gap"]
  LOADK R6 K40 ["text-body-medium"]
  SETTABLEKS R6 R5 K22 ["textBoxTag"]
  GETTABLEKS R7 R0 K34 ["Typography"]
  ...
  SETTABLE R4 R2 R3
  GETUPVAL R4 0
  GETTABLEKS R3 R4 K44 ["Large"]
  GETUPVAL R4 1
  DUPTABLE R5 K25 [{"canvasTag", "outerContainerTag", "radius", "innerContainerTag", "horizontalPadding", "gap", "textBoxTag", "typography", "iconSize"}]
  LOADK R6 K45 ["size-full-1200"]
  SETTABLEKS R6 R5 K16 ["canvasTag"]
  LOADK R6 K37 ["radius-medium"]
  SETTABLEKS R6 R5 K17 ["outerContainerTag"]
  GETTABLEKS R7 R0 K28 ["Radius"]
