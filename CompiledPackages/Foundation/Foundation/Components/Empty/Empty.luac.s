PROTO_0:
  ...
  GETTABLEKS R8 R9 K0 ["createElement"]
  GETUPVAL R9 7
  DUPTABLE R10 K19 [{"Text", "LayoutOrder", "tag", "testId"}]
  GETTABLEKS R11 R2 K20 ["text"]
  SETTABLEKS R11 R10 K6 ["Text"]
  LOADN R11 2
  SETTABLEKS R11 R10 K12 ["LayoutOrder"]
  LOADK R11 K21 ["size-full-0 auto-y text-body-large content-default text-wrap text-align-x-center"]
  SETTABLEKS R11 R10 K1 ["tag"]
  LOADK R12 K22 ["%*--text"]
  GETTABLEKS R14 R2 K18 ["testId"]
  NAMECALL R12 R12 K23 ["format"]
  CALL R12 2 1
  MOVE R11 R12
  SETTABLEKS R11 R10 K18 ["testId"]
  CALL R8 2 1
  SETTABLEKS R8 R7 K6 ["Text"]
  GETTABLEKS R9 R2 K24 ["button"]
  JUMPIFNOT R9 [+33]
  GETTABLEKS R10 R2 K24 ["button"]
  GETTABLEKS R9 R10 K25 ["onActivated"]
  JUMPIFNOT R9 [+28]
  GETUPVAL R9 3
  GETTABLEKS R8 R9 K0 ["createElement"]
  GETUPVAL R9 8
  DUPTABLE R10 K26 [{"text", "icon", "onActivated", "LayoutOrder"}]
  GETTABLEKS R12 R2 K24 ["button"]
  GETTABLEKS R11 R12 K20 ["text"]
  SETTABLEKS R11 R10 K20 ["text"]
  GETTABLEKS R12 R2 K24 ["button"]
  GETTABLEKS R11 R12 K14 ["icon"]
  SETTABLEKS R11 R10 K14 ["icon"]
  GETTABLEKS R12 R2 K24 ["button"]
  GETTABLEKS R11 R12 K25 ["onActivated"]
  SETTABLEKS R11 R10 K25 ["onActivated"]
  LOADN R11 3
  SETTABLEKS R11 R10 K12 ["LayoutOrder"]
  CALL R8 2 1
  JUMP [+1]
...
MAIN:
  ...
  CALL R12 1 1
  DUPTABLE R13 K28 [{"icon", "text", "button", "testId"}]
  DUPTABLE R14 K31 [{"name", "size"}]
  LOADK R15 K32 ["icons/status/oof_xlarge"]
  SETTABLEKS R15 R14 K29 ["name"]
  GETTABLEKS R15 R7 K33 ["Large"]
  SETTABLEKS R15 R14 K30 ["size"]
  SETTABLEKS R14 R13 K24 ["icon"]
  LOADK R16 K34 ["CommonUI.Controls.NoResultsFound"]
  NAMECALL R14 R10 K35 ["FormatByKey"]
  CALL R14 2 1
  SETTABLEKS R14 R13 K25 ["text"]
  DUPTABLE R14 K37 [{"icon", "text", "onActivated"}]
  LOADK R15 K38 ["icons/common/refresh"]
  SETTABLEKS R15 R14 K24 ["icon"]
  LOADK R17 K39 ["CommonUI.Controls.Action.Refresh"]
  NAMECALL R15 R10 K35 ["FormatByKey"]
  CALL R15 2 1
  SETTABLEKS R15 R14 K25 ["text"]
  LOADNIL R15
  SETTABLEKS R15 R14 K36 ["onActivated"]
  SETTABLEKS R14 R13 K26 ["button"]
  LOADK R14 K40 ["--foundation-empty"]
  ...
  CAPTURE VAL R5
  CAPTURE VAL R3
  GETTABLEKS R15 R2 K42 ["memo"]
  GETTABLEKS R16 R2 K43 ["forwardRef"]
  MOVE R17 R14
  CALL R16 1 -1
  CALL R15 -1 -1
  RETURN R15 -1
