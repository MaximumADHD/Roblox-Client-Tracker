...
PROTO_4:
  ...
  FORGLOOP R7 2 [-24]
  GETUPVAL R9 0
  GETTABLEKS R8 R9 K88 ["FoundationMigrateCryoToDash"]
  JUMPIFNOT R8 [+10]
  GETUPVAL R8 1
  GETTABLEKS R7 R8 K89 ["joinArrays"]
  MOVE R8 R0
  MOVE R9 R1
  MOVE R10 R2
  MOVE R11 R3
  ...
  RETURN R7 1
  GETUPVAL R9 2
  GETTABLEKS R8 R9 K90 ["List"]
  GETTABLEKS R7 R8 K91 ["join"]
  MOVE R8 R0
  MOVE R9 R1
  MOVE R10 R2
  MOVE R11 R3
...
PROTO_5:
  ...
  FORGLOOP R4 2 [-27]
  GETUPVAL R6 0
  GETTABLEKS R5 R6 K15 ["FoundationMigrateCryoToDash"]
  JUMPIFNOT R5 [+7]
  GETUPVAL R5 1
  GETTABLEKS R4 R5 K16 ["joinArrays"]
  MOVE R5 R2
  MOVE R6 R3
  CALL R4 2 1
  RETURN R4 1
...
PROTO_6:
  ...
  FORGLOOP R6 2 [-24]
  GETUPVAL R8 0
  GETTABLEKS R7 R8 K48 ["FoundationMigrateCryoToDash"]
  JUMPIFNOT R7 [+9]
  GETUPVAL R7 1
  GETTABLEKS R6 R7 K49 ["joinArrays"]
  MOVE R7 R0
  MOVE R8 R2
  MOVE R9 R3
  MOVE R10 R5
  ...
  RETURN R6 1
  GETUPVAL R8 2
  GETTABLEKS R7 R8 K50 ["List"]
  GETTABLEKS R6 R7 K51 ["join"]
  MOVE R7 R0
  MOVE R8 R2
  MOVE R9 R3
  MOVE R10 R5
...
PROTO_24:
  ...
  GETUPVAL R14 0
  GETTABLEKS R13 R14 K10 ["FoundationMigrateCryoToDash"]
  JUMPIFNOT R13 [+24]
  GETUPVAL R13 1
  GETTABLEKS R12 R13 K11 ["joinArrays"]
  GETUPVAL R13 2
  MOVE R14 R0
  CALL R13 1 1
  GETUPVAL R14 3
  ...
  CALL R12 9 1
  GETUPVAL R15 0
  GETTABLEKS R14 R15 K10 ["FoundationMigrateCryoToDash"]
  JUMPIFNOT R14 [+36]
  GETUPVAL R14 1
  GETTABLEKS R13 R14 K11 ["joinArrays"]
  GETUPVAL R14 12
  MOVE R15 R0
  CALL R14 1 1
  GETUPVAL R15 13
  ...
  GETUPVAL R20 18
  MOVE R21 R9
  GETTABLEKS R24 R0 K14 ["Config"]
  GETTABLEKS R23 R24 K15 ["Text"]
  GETTABLEKS R22 R23 K16 ["NominalScale"]
  CALL R20 2 1
  GETUPVAL R21 19
  MOVE R22 R10
  MOVE R23 R11
  ...
  CALL R13 8 1
  GETUPVAL R16 0
  GETTABLEKS R15 R16 K10 ["FoundationMigrateCryoToDash"]
  JUMPIFNOT R15 [+23]
  GETUPVAL R15 1
  GETTABLEKS R14 R15 K11 ["joinArrays"]
  GETUPVAL R15 20
  MOVE R16 R0
  CALL R15 1 1
  GETUPVAL R16 21
  ...
  RETURN R12 3
  GETUPVAL R16 11
  GETTABLEKS R15 R16 K12 ["List"]
  GETTABLEKS R14 R15 K13 ["join"]
  GETUPVAL R15 20
  MOVE R16 R0
  CALL R15 1 1
  GETUPVAL R16 21
...
MAIN:
  ...
  CALL R6 1 1
  DUPTABLE R7 K26 [{"Content", "Stroke", "Shift", "Surface", "OverMedia", "System", "Extended", "Common", "Selection", "State", "None"}]
  NEWTABLE R8 0 1
  LOADK R9 K27 ["content"]
  SETLIST R8 R9 1 [1]
  SETTABLEKS R8 R7 K15 ["Content"]
  NEWTABLE R8 0 1
  LOADK R9 K28 ["stroke"]
  SETLIST R8 R9 1 [1]
  SETTABLEKS R8 R7 K16 ["Stroke"]
  NEWTABLE R8 0 1
  LOADK R9 K29 ["bg"]
  SETLIST R8 R9 1 [1]
  SETTABLEKS R8 R7 K17 ["Shift"]
  NEWTABLE R8 0 1
  LOADK R9 K29 ["bg"]
  SETLIST R8 R9 1 [1]
  SETTABLEKS R8 R7 K18 ["Surface"]
  NEWTABLE R8 0 1
  LOADK R9 K29 ["bg"]
  SETLIST R8 R9 1 [1]
  SETTABLEKS R8 R7 K19 ["OverMedia"]
  NEWTABLE R8 0 3
  LOADK R9 K29 ["bg"]
  LOADK R10 K27 ["content"]
  LOADK R11 K28 ["stroke"]
  SETLIST R8 R9 3 [1]
  SETTABLEKS R8 R7 K20 ["System"]
  NEWTABLE R8 0 0
  SETTABLEKS R8 R7 K21 ["Extended"]
  NEWTABLE R8 0 0
  SETTABLEKS R8 R7 K22 ["Common"]
  NEWTABLE R8 0 0
  SETTABLEKS R8 R7 K23 ["Selection"]
  NEWTABLE R8 0 0
  SETTABLEKS R8 R7 K24 ["State"]
  NEWTABLE R8 0 0
  SETTABLEKS R8 R7 K25 ["None"]
  DUPCLOSURE R8 K30 [PROTO_0]
  DUPCLOSURE R9 K31 [PROTO_1]
  DUPCLOSURE R10 K32 [PROTO_2]
  ...
  DUPCLOSURE R22 K44 [PROTO_14]
  DUPCLOSURE R23 K45 [PROTO_15]
  DUPCLOSURE R24 K46 [PROTO_16]
  DUPCLOSURE R25 K47 [PROTO_17]
  DUPCLOSURE R26 K48 [PROTO_18]
  DUPCLOSURE R27 K49 [PROTO_19]
  DUPCLOSURE R28 K50 [PROTO_20]
  DUPCLOSURE R29 K51 [PROTO_21]
  DUPCLOSURE R30 K52 [PROTO_22]
  DUPCLOSURE R31 K53 [PROTO_23]
  DUPCLOSURE R32 K54 [PROTO_24]
  CAPTURE VAL R6
  CAPTURE VAL R3
  CAPTURE VAL R8
  CAPTURE VAL R11
  ...
  CAPTURE VAL R19
  CAPTURE VAL R20
  DUPTABLE R33 K57 [{"rulesGenerator", "rules"}]
  SETTABLEKS R32 R33 K55 ["rulesGenerator"]
  DUPTABLE R34 K80 [{"DefaultRules", "EngineDefaultBypassRules", "FlexItemRules", "TextRules", "AutomaticSizeRules", "PositionRules", "AnchorPointRules", "ClipsDescendantRules", "AspectRatioRules", "DefaultSizeRules", "ListLayoutRules", "ListLayoutSpacingRules", "CornerRules", "SizeRules", "StrokeSizeRules", "TypographyRules", "PaddingRules", "DefaultColorRules", "DeprecatedColorRules", "BackgroundRules", "StrokeRules", "ContentRules"}]
  SETTABLEKS R8 R34 K58 ["DefaultRules"]
  SETTABLEKS R11 R34 K59 ["EngineDefaultBypassRules"]
  SETTABLEKS R14 R34 K60 ["FlexItemRules"]
  SETTABLEKS R22 R34 K61 ["TextRules"]
  SETTABLEKS R24 R34 K62 ["AutomaticSizeRules"]
  SETTABLEKS R25 R34 K63 ["PositionRules"]
  SETTABLEKS R26 R34 K64 ["AnchorPointRules"]
  SETTABLEKS R27 R34 K65 ["ClipsDescendantRules"]
  SETTABLEKS R29 R34 K66 ["AspectRatioRules"]
  SETTABLEKS R9 R34 K67 ["DefaultSizeRules"]
  SETTABLEKS R12 R34 K68 ["ListLayoutRules"]
  SETTABLEKS R13 R34 K69 ["ListLayoutSpacingRules"]
  SETTABLEKS R15 R34 K70 ["CornerRules"]
  SETTABLEKS R16 R34 K71 ["SizeRules"]
  SETTABLEKS R18 R34 K72 ["StrokeSizeRules"]
  SETTABLEKS R21 R34 K73 ["TypographyRules"]
  SETTABLEKS R23 R34 K74 ["PaddingRules"]
  SETTABLEKS R10 R34 K75 ["DefaultColorRules"]
  SETTABLEKS R30 R34 K76 ["DeprecatedColorRules"]
  SETTABLEKS R17 R34 K77 ["BackgroundRules"]
  SETTABLEKS R19 R34 K78 ["StrokeRules"]
  SETTABLEKS R20 R34 K79 ["ContentRules"]
  SETTABLEKS R34 R33 K56 ["rules"]
  RETURN R33 1
