...
PROTO_10:
  ...
  GETTABLEKS R6 R7 K1 ["createElement"]
  GETUPVAL R7 5
  DUPTABLE R8 K37 [{"LayoutOrder", "items", "onActivated"}]
  LOADN R9 8
  SETTABLEKS R9 R8 K21 ["LayoutOrder"]
  NEWTABLE R9 0 2
  DUPTABLE R10 K39 [{"id", "text"}]
  LOADK R11 K40 ["item1"]
  SETTABLEKS R11 R10 K38 ["id"]
  LOADK R11 K41 ["Menu Item 1"]
  SETTABLEKS R11 R10 K22 ["text"]
  DUPTABLE R11 K39 [{"id", "text"}]
  LOADK R12 K42 ["item2"]
  SETTABLEKS R12 R11 K38 ["id"]
  LOADK R12 K43 ["Menu Item 2"]
  SETTABLEKS R12 R11 K22 ["text"]
  SETLIST R9 R10 2 [1]
  SETTABLEKS R9 R8 K36 ["items"]
  DUPCLOSURE R9 K44 [PROTO_6]
  SETTABLEKS R9 R8 K23 ["onActivated"]
  CALL R6 2 1
  ...
  LOADN R9 10
  SETTABLEKS R9 R8 K21 ["LayoutOrder"]
  LOADK R9 K45 ["Static Chip Component 1"]
  SETTABLEKS R9 R8 K22 ["text"]
  DUPCLOSURE R9 K46 [PROTO_7]
  SETTABLEKS R9 R8 K23 ["onActivated"]
  CALL R6 2 1
  ...
  LOADN R9 11
  SETTABLEKS R9 R8 K21 ["LayoutOrder"]
  LOADK R9 K47 ["Static Chip Component 2"]
  SETTABLEKS R9 R8 K22 ["text"]
  ...
  GETTABLEKS R6 R7 K1 ["createElement"]
  GETUPVAL R7 7
  DUPTABLE R8 K51 [{"LayoutOrder", "cursor", "Size"}]
  LOADN R9 13
  SETTABLEKS R9 R8 K21 ["LayoutOrder"]
  NEWTABLE R9 0 0
  SETTABLEKS R9 R8 K49 ["cursor"]
  GETIMPORT R9 K54 [UDim2.new]
  LOADN R10 0
  LOADN R11 50
  LOADN R12 0
  LOADN R13 50
  CALL R9 4 1
  SETTABLEKS R9 R8 K50 ["Size"]
  CALL R6 2 1
  ...
  SETTABLEKS R9 R8 K21 ["LayoutOrder"]
  JUMPIFNOT R0 [+2]
  LOADK R9 K55 ["Hide Dynamic Component"]
  JUMP [+1]
  LOADK R9 K56 ["Show Dynamic Component"]
  SETTABLEKS R9 R8 K22 ["text"]
  NEWCLOSURE R9 P7
  CAPTURE VAL R1
  CAPTURE VAL R0
