...
PROTO_4:
  ...
  GETUPVAL R3 1
  MOVE R4 R0
  NAMECALL R1 R1 K2 ["SetFastFlagForTesting"]
  CALL R1 3 0
  GETUPVAL R1 2
  NEWCLOSURE R2 P0
  CAPTURE UPVAL U1
...
PROTO_6:
  ...
  GETUPVAL R2 1
  DUPTABLE R3 K3 [{"key", "tag"}]
  GETTABLEKS R4 R0 K1 ["key"]
  SETTABLEKS R4 R3 K1 ["key"]
  LOADK R4 K4 ["col auto-xy"]
  SETTABLEKS R4 R3 K2 ["tag"]
  DUPTABLE R4 K6 [{"Checkbox"}]
  GETUPVAL R6 0
  GETTABLEKS R5 R6 K0 ["createElement"]
  GETUPVAL R6 2
  DUPTABLE R7 K10 [{"isChecked", "onActivated", "label"}]
  GETTABLEKS R8 R0 K11 ["value"]
...
PROTO_7:
  ...
  GETUPVAL R11 2
  DUPTABLE R12 K6 [{"tag"}]
  LOADK R13 K17 ["col gap-small size-full"]
