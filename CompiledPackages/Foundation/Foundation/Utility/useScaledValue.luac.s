PROTO_0:
  ...
  JUMPIFNOTLE R2 R3 [+6]
  GETUPVAL R3 2
  LOADK R5 K6 ["useScaledValue should be used for values larger than Size tokens. For smaller values, please align to a Size or derivative token."]
  NAMECALL R3 R3 K7 ["warning"]
  CALL R3 2 0
  GETUPVAL R4 1
  GETTABLEKS R3 R4 K0 ["FoundationFixUseScaledValueWarning"]
  JUMPIFNOT R3 [+1]
