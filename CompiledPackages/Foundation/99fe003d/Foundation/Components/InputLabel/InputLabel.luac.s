...
PROTO_3:
       ...
       60 GETTABLEKS                       R10 R2 K23 ["isDisabled"]
       62 JUMPIF                           R10 ; [+3]
       63 GETTABLEKS                       R9 R2 K6 ["onActivated"]
       65 JUMP                             ; [+1]
       66 LOADNIL                          R9
       67 SETTABLEKS                       R9 R8 K6 ["onActivated"]
       69 GETTABLEKS                       R10 R2 K23 ["isDisabled"]
       71 JUMPIF                           R10 ; [+2]
       72 MOVE                             R9 R3
       73 JUMP                             ; [+1]
       74 LOADNIL                          R9
       75 SETTABLEKS                       R9 R8 K7 ["onStateChanged"]
       77 DUPTABLE                         R9 K25 [{"affordance"}]
       78 GETUPVAL                         R10 7
       79 GETTABLEKS                       R10 R10 K14 ["None"]
       81 SETTABLEKS                       R10 R9 K24 ["affordance"]
       83 SETTABLEKS                       R9 R8 K8 ["stateLayer"]
       85 GETTABLEKS                       R9 R2 K9 ["textStyle"]
       87 SETTABLEKS                       R9 R8 K9 ["textStyle"]
       89 NEWTABLE                         R9 8 0
       91 LOADB                            R10 1
       92 SETTABLEKS                       R10 R9 K26 ["size-0 auto-xy text-wrap text-align-x-left text-align-y-top"]
       94 GETTABLEKS                       R10 R2 K23 ["isDisabled"]
       96 SETTABLEKS                       R10 R9 K27 ["content-muted"]
       98 GETTABLEKS                       R11 R2 K23 ["isDisabled"]
      100 NOT                              R10 R11
      101 SETTABLEKS                       R10 R9 K28 ["content-default"]
      103 GETTABLEKS                       R11 R2 K29 ["size"]
      105 GETUPVAL                         R12 8
      106 GETTABLEKS                       R12 R12 K30 ["Small"]
      108 JUMPIFEQ                         R11 R12 ; [+2]
      110 LOADB                            R10 0 +1
      111 LOADB                            R10 1
      112 SETTABLEKS                       R10 R9 K31 ["text-title-small"]
      114 GETTABLEKS                       R11 R2 K29 ["size"]
      116 GETUPVAL                         R12 8
      117 GETTABLEKS                       R12 R12 K32 ["Medium"]
      119 JUMPIFEQ                         R11 R12 ; [+2]
      121 LOADB                            R10 0 +1
      122 LOADB                            R10 1
      123 SETTABLEKS                       R10 R9 K33 ["text-title-medium"]
      125 GETTABLEKS                       R11 R2 K29 ["size"]
      127 GETUPVAL                         R12 8
      128 GETTABLEKS                       R12 R12 K34 ["Large"]
      130 JUMPIFEQ                         R11 R12 ; [+2]
      132 LOADB                            R10 0 +1
      133 LOADB                            R10 1
      134 SETTABLEKS                       R10 R9 K35 ["text-title-large"]
      136 SETTABLEKS                       R9 R8 K10 ["tag"]
      138 SETTABLEKS                       R1 R8 K11 ["ref"]
      140 CALL                             R6 2 -1
      141 CALL                             R4 -1 -1
      142 RETURN                           R4 -1
...
MAIN:
       ...
       73 CAPTURE                          VAL R3
       74 CAPTURE                          VAL R4
       75 DUPTABLE                         R12 K24 [{["size"], ["testId"] = "--foundation-input-label"}]
       76 GETTABLEKS                       R13 R10 K25 ["Medium"]
       ...
       88 CAPTURE                          VAL R5
       89 CAPTURE                          VAL R10
       90 GETTABLEKS                       R14 R3 K27 ["memo"]
       92 GETTABLEKS                       R15 R3 K28 ["forwardRef"]
       94 MOVE                             R16 R13
       95 CALL                             R15 1 -1
       96 CALL                             R14 -1 -1
       97 RETURN                           R14 -1
