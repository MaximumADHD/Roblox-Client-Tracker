...
PROTO_5:
       ...
       28 GETIMPORT                        R7 K26 [UDim2.fromOffset]
       30 LOADN                            R8 400
       31 LOADN                            R9 0
       32 CALL                             R7 2 1
       33 SETTABLEKS                       R7 R6 K22 ["Size"]
       35 DUPTABLE                         R7 K28 [{"RadioGroup"}]
       36 GETUPVAL                         R8 1
       37 GETTABLEKS                       R8 R8 K19 ["createElement"]
       39 GETUPVAL                         R9 2
       40 GETTABLEKS                       R9 R9 K29 ["Root"]
       42 DUPTABLE                         R10 K31 [{"onValueChanged"}]
       43 DUPCLOSURE                       R11 K32 [PROTO_4]
       44 SETTABLEKS                       R11 R10 K30 ["onValueChanged"]
       46 MOVE                             R11 R3
       47 CALL                             R8 3 1
       48 SETTABLEKS                       R8 R7 K27 ["RadioGroup"]
       50 CALL                             R4 3 -1
       51 RETURN                           R4 -1
...
PROTO_8:
        ...
        3 GETUPVAL                         R4 1
        4 DUPTABLE                         R5 K3 [{["tag"] = "col align-x-center gap-small auto-xy padding-medium"}]
        5 DUPTABLE                         R6 K6 [{"ImageContainer", "RadioButton"}]
        6 GETUPVAL                         R7 0
        7 GETTABLEKS                       R7 R7 K0 ["createElement"]
        9 GETUPVAL                         R8 1
       10 DUPTABLE                         R9 K10 [{["cursor"], ["onActivated"], ["tag"] = "size-2000-2000 radius-medium bg-surface-100"}]
       11 GETUPVAL                         R10 2
...
PROTO_9:
       ...
       43 GETUPVAL                         R12 2
       44 DUPTABLE                         R13 K14 [{["tag"] = "row wrap gap-large auto-xy"}]
...
MAIN:
       ...
       30 GETTABLEKS                       R6 R6 K11 ["RadioGroup"]
       32 CALL                             R5 1 1
