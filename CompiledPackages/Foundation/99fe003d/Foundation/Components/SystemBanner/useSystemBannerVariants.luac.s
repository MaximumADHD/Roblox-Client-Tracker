...
PROTO_2:
        ...
        1 DUPTABLE                         R2 K6 [{["tag"] = "row gap-medium size-full-0 auto-y padding-x-medium padding-y-large"}]
        2 SETTABLEKS                       R2 R1 K0 ["container"]
        4 DUPTABLE                         R2 K8 [{["tag"] = "auto-xy padding-y-xxsmall text-title-medium text-wrap text-align-x-left"}]
        5 SETTABLEKS                       R2 R1 K1 ["title"]
        7 DUPTABLE                         R2 K10 [{["tag"] = "auto-xy text-body-medium text-wrap text-align-x-left"}]
