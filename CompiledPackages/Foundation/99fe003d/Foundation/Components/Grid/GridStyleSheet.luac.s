...
PROTO_1:
        ...
        3 GETUPVAL                         R1 1
        4 GETTABLEKS                       R1 R1 K1 ["baseRules"]
        6 GETUPVAL                         R3 1
        7 GETTABLEKS                       R3 R3 K2 ["rulesByBreakpoint"]
        9 GETUPVAL                         R4 2
...
PROTO_2:
       ...
       50 CALL                             R8 3 0
       51 GETUPVAL                         R8 0
       52 GETTABLEKS                       R8 R8 K0 ["current"]
       ...
       60 CALL                             R8 3 0
       61 GETUPVAL                         R8 0
       62 GETTABLEKS                       R8 R8 K0 ["current"]
...
PROTO_4:
       ...
       11 GETUPVAL                         R4 4
       12 CALL                             R4 0 1
       13 GETTABLEKS                       R5 R3 K1 ["config"]
       15 GETTABLEKS                       R5 R5 K2 ["breakpoint"]
       17 GETTABLEKS                       R6 R3 K1 ["config"]
       19 GETTABLEKS                       R6 R6 K3 ["grid"]
       ...
       40 CALL                             R10 2 1
       41 GETUPVAL                         R11 2
       42 GETTABLEKS                       R11 R11 K10 ["useMemo"]
       ...
       53 CALL                             R11 2 1
       54 GETUPVAL                         R12 2
       55 GETTABLEKS                       R12 R12 K10 ["useMemo"]
       ...
       67 CALL                             R12 2 1
       68 GETUPVAL                         R13 2
       69 GETTABLEKS                       R13 R13 K11 ["useLayoutEffect"]
       ...
       87 CALL                             R13 2 0
       88 GETUPVAL                         R13 2
       89 GETTABLEKS                       R13 R13 K11 ["useLayoutEffect"]
       ...
       99 CALL                             R13 2 0
      100 GETUPVAL                         R13 2
      101 GETTABLEKS                       R13 R13 K12 ["createElement"]
      103 GETUPVAL                         R14 2
      104 GETTABLEKS                       R14 R14 K13 ["Fragment"]
      106 LOADNIL                          R15
      107 DUPTABLE                         R16 K16 [{"GridStyleSheet", "GridStyleLink"}]
      108 GETUPVAL                         R17 2
      109 GETTABLEKS                       R17 R17 K12 ["createElement"]
...
MAIN:
       ...
       25 GETTABLEKS                       R5 R5 K11 ["StyleSheetContext"]
       27 CALL                             R4 1 1
       28 GETTABLEKS                       R4 R4 K12 ["useStyleSheet"]
       30 GETIMPORT                        R5 K6 [require]
       32 GETTABLEKS                       R6 R0 K13 ["Enums"]
       34 GETTABLEKS                       R6 R6 K14 ["Breakpoint"]
       36 CALL                             R5 1 1
       37 GETIMPORT                        R6 K6 [require]
       39 GETIMPORT                        R7 K1 [script]
       41 GETTABLEKS                       R7 R7 K4 ["Parent"]
       43 GETTABLEKS                       R7 R7 K15 ["createGridStyleRules"]
       45 CALL                             R6 1 1
       46 GETIMPORT                        R7 K6 [require]
       48 GETTABLEKS                       R8 R0 K16 ["Utility"]
       50 GETTABLEKS                       R8 R8 K17 ["getGridMetrics"]
       52 CALL                             R7 1 1
       53 GETIMPORT                        R8 K6 [require]
       55 GETTABLEKS                       R9 R0 K9 ["Providers"]
       57 GETTABLEKS                       R9 R9 K18 ["Responsive"]
       59 GETTABLEKS                       R9 R9 K19 ["useResponsive"]
       61 CALL                             R8 1 1
       62 GETIMPORT                        R9 K6 [require]
       64 GETTABLEKS                       R10 R0 K16 ["Utility"]
       66 GETTABLEKS                       R10 R10 K20 ["withDefaults"]
       68 CALL                             R9 1 1
       69 DUPTABLE                         R10 K23 [{["containerWidth"] = 0}]
       70 DUPCLOSURE                       R11 K24 [PROTO_4]
       71 CAPTURE                          VAL R9
       72 CAPTURE                          VAL R10
       73 CAPTURE                          VAL R3
       74 CAPTURE                          VAL R8
