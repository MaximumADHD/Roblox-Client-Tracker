PROTO_0:
       ...
       68 GETUPVAL                         R12 6
       69 GETUPVAL                         R14 7
       70 GETTABLEKS                       R14 R14 K12 ["FoundationOverlayDisplayOrder"]
       72 JUMPIFNOT                        R14 ; [+16]
       ...
       82 GETTABLEKS                       R14 R0 K13 ["overlayGui"]
       84 GETTABLEKS                       R14 R14 K17 ["DisplayOrder"]
       ...
       94 CALL                             R11 2 1
       95 GETUPVAL                         R12 0
       96 GETTABLEKS                       R12 R12 K2 ["createElement"]
       98 GETUPVAL                         R13 8
       99 CALL                             R12 1 -1
...
MAIN:
       ...
       35 GETTABLEKS                       R8 R0 K10 ["Preferences"]
       37 GETTABLEKS                       R8 R8 K11 ["PreferencesProvider"]
       39 CALL                             R7 1 1
       40 GETIMPORT                        R8 K4 [require]
       42 GETTABLEKS                       R9 R0 K12 ["Responsive"]
       44 GETTABLEKS                       R9 R9 K13 ["ResponsiveContext"]
       46 CALL                             R8 1 1
       47 GETIMPORT                        R9 K4 [require]
       49 GETTABLEKS                       R10 R0 K12 ["Responsive"]
       51 GETTABLEKS                       R10 R10 K14 ["ResponsiveProvider"]
       53 CALL                             R9 1 1
       54 GETIMPORT                        R10 K4 [require]
       56 GETTABLEKS                       R11 R0 K15 ["Style"]
       58 GETTABLEKS                       R11 R11 K16 ["StyleProvider"]
       60 CALL                             R10 1 1
       61 GETIMPORT                        R11 K4 [require]
       63 GETTABLEKS                       R12 R1 K17 ["Components"]
       65 GETTABLEKS                       R12 R12 K18 ["Types"]
       67 CALL                             R11 1 1
       68 GETIMPORT                        R12 K4 [require]
       70 GETTABLEKS                       R13 R0 K19 ["Elevation"]
       72 GETTABLEKS                       R13 R13 K20 ["ElevationProvider"]
       74 CALL                             R12 1 1
       75 GETTABLEKS                       R12 R12 K20 ["ElevationProvider"]
       77 GETIMPORT                        R13 K4 [require]
       79 GETTABLEKS                       R14 R1 K21 ["Utility"]
       81 GETTABLEKS                       R14 R14 K22 ["Flags"]
       83 CALL                             R13 1 1
