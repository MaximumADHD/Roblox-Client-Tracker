...
PROTO_19:
        ...
        8 GETUPVAL                         R4 1
        9 DUPTABLE                         R5 K4 [{"tag"}]
       10 LOADK                            R6 K5 ["col gap-large"]
       11 SETTABLEKS                       R6 R5 K3 ["tag"]
       13 DUPTABLE                         R6 K8 [{"Input", "Menu"}]
       14 GETUPVAL                         R7 0
       15 GETTABLEKS                       R7 R7 K2 ["createElement"]
       17 GETUPVAL                         R8 2
       18 DUPTABLE                         R9 K13 [{"onChanged", "label", "text", "LayoutOrder"}]
       19 NEWCLOSURE                       R10 P0
       20 CAPTURE                          VAL R2
       21 SETTABLEKS                       R10 R9 K9 ["onChanged"]
       23 LOADK                            R10 K14 ["Search"]
       24 SETTABLEKS                       R10 R9 K10 ["label"]
       26 SETTABLEKS                       R1 R9 K11 ["text"]
       28 LOADN                            R10 1
       29 SETTABLEKS                       R10 R9 K12 ["LayoutOrder"]
       31 CALL                             R7 2 1
       32 SETTABLEKS                       R7 R6 K6 ["Input"]
       34 GETUPVAL                         R7 0
       35 GETTABLEKS                       R7 R7 K2 ["createElement"]
       37 GETUPVAL                         R8 3
       38 GETTABLEKS                       R8 R8 K15 ["Root"]
       40 DUPTABLE                         R9 K18 [{"label", "items", "maxHeight", "LayoutOrder"}]
       41 LOADK                            R10 K19 ["Icons"]
       42 SETTABLEKS                       R10 R9 K10 ["label"]
       44 GETUPVAL                         R10 4
       45 GETTABLEKS                       R10 R10 K20 ["map"]
       47 GETUPVAL                         R11 4
       48 GETTABLEKS                       R11 R11 K21 ["filter"]
       50 GETUPVAL                         R12 5
       51 GETTABLEKS                       R12 R12 K22 ["Icon"]
       53 NEWCLOSURE                       R13 P1
       54 CAPTURE                          VAL R1
       55 CALL                             R11 2 1
       56 DUPCLOSURE                       R12 K23 [PROTO_18]
       57 CALL                             R10 2 1
       58 SETTABLEKS                       R10 R9 K16 ["items"]
       60 LOADN                            R10 88
       61 SETTABLEKS                       R10 R9 K17 ["maxHeight"]
       63 LOADN                            R10 2
       64 SETTABLEKS                       R10 R9 K12 ["LayoutOrder"]
       66 CALL                             R7 2 1
       67 SETTABLEKS                       R7 R6 K7 ["Menu"]
       69 CALL                             R3 3 -1
       70 RETURN                           R3 -1
...
MAIN:
      ...
      171 LOADK                            R17 K16 ["BaseMenu"]
      172 SETTABLEKS                       R17 R16 K55 ["summary"]
      174 NEWTABLE                         R17 0 11
      ...
      269 LOADK                            R28 K79 ["Dynamically Sizing"]
      270 SETTABLEKS                       R28 R27 K42 ["name"]
      272 DUPCLOSURE                       R28 K80 [PROTO_19]
      273 CAPTURE                          VAL R4
      274 CAPTURE                          VAL R11
      275 CAPTURE                          VAL R10
      276 CAPTURE                          VAL R8
      ...
      281 DUPTABLE                         R28 K60 [{"name", "story"}]
      282 LOADK                            R29 K81 ["Experience Icons"]
      283 SETTABLEKS                       R29 R28 K42 ["name"]
      285 DUPCLOSURE                       R29 K82 [PROTO_21]
      286 CAPTURE                          VAL R4
      287 CAPTURE                          VAL R15
      288 CAPTURE                          VAL R7
      289 CAPTURE                          VAL R5
      290 CAPTURE                          VAL R8
      291 SETTABLEKS                       R29 R28 K59 ["story"]
      293 SETLIST                          R17 R18 11 [1]
      295 SETTABLEKS                       R17 R16 K56 ["stories"]
      297 DUPTABLE                         R17 K85 [{"size", "icon", "hasIcon"}]
      298 GETTABLEKS                       R18 R3 K86 ["values"]
      300 MOVE                             R19 R9
      301 CALL                             R18 1 1
      302 SETTABLEKS                       R18 R17 K83 ["size"]
      304 GETTABLEKS                       R18 R3 K86 ["values"]
      306 MOVE                             R19 R12
      307 CALL                             R18 1 1
      308 SETTABLEKS                       R18 R17 K29 ["icon"]
      310 LOADB                            R18 1
      311 SETTABLEKS                       R18 R17 K84 ["hasIcon"]
      313 SETTABLEKS                       R17 R16 K57 ["controls"]
      315 RETURN                           R16 1
