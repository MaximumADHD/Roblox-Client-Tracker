PROTO_0:
        0 GETUPVAL                         R4 0
        1 GETTABLEKS                       R3 R4 K0 ["LOCALIZATION_TABLE_NAME"]
       ...
       16 CALL                             R2 2 0
       17 GETUPVAL                         R3 2
       18 GETTABLEKS                       R2 R3 K5 ["FoundationTranslatorLocalizationRecovery"]
       20 JUMPIFNOT                        R2 ; [+1]
       21 RETURN                           R1 1
       22 LOADNIL                          R2
       23 RETURN                           R2 1
       ...
       27 CALL                             R2 1 1
       28 GETUPVAL                         R4 0
       29 GETTABLEKS                       R3 R4 K0 ["LOCALIZATION_TABLE_NAME"]
       ...
       45 GETUPVAL                         R4 2
       46 GETTABLEKS                       R3 R4 K5 ["FoundationTranslatorLocalizationRecovery"]
       48 JUMPIFNOT                        R3 ; [+1]
       49 RETURN                           R2 1
       50 LOADNIL                          R3
       51 RETURN                           R3 1
...
PROTO_1:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R1 R2 K0 ["FoundationTranslatorLocalizationRecovery"]
        3 JUMPIFNOT                        R1 ; [+15]
        4 GETUPVAL                         R1 1
        5 JUMPIFEQKNIL                     R1 ; [+6]
        7 GETUPVAL                         R2 1
        8 GETTABLEKS                       R1 R2 K1 ["Parent"]
       ...
       23 GETUPVAL                         R2 3
       24 GETUPVAL                         R5 5
       25 GETTABLEKS                       R4 R5 K2 ["LOCALIZATION_TABLE_NAME"]
...
PROTO_2:
        0 GETUPVAL                         R0 0
        1 GETUPVAL                         R2 1
        2 GETTABLEKS                       R1 R2 K0 ["RobloxLocaleId"]
        4 CALL                             R0 1 1
        5 RETURN                           R0 1
...
PROTO_4:
       ...
       14 RETURN                           R5 1
       15 GETUPVAL                         R6 0
       16 GETTABLEKS                       R5 R6 K5 ["FoundationTranslatorLocalizationRecovery"]
       18 JUMPIFNOT                        R5 ; [+9]
       19 GETUPVAL                         R5 1
...
PROTO_5:
        ...
        3 GETUPVAL                         R6 1
        4 GETUPVAL                         R8 2
        5 GETTABLEKS                       R7 R8 K0 ["RobloxLocaleId"]
        7 CALL                             R6 1 1
        8 CALL                             R3 3 -1
        9 RETURN                           R3 -1
...
MAIN:
       ...
       33 GETTABLEKS                       R8 R1 K7 ["Utility"]
       35 GETTABLEKS                       R7 R8 K13 ["Flags"]
       37 CALL                             R6 1 1
       38 GETIMPORT                        R7 K6 [require]
       40 GETTABLEKS                       R10 R1 K14 ["Generated"]
       42 GETTABLEKS                       R9 R10 K15 ["Translations"]
       44 GETTABLEKS                       R8 R9 K16 ["GeneratedTranslations"]
       46 CALL                             R7 1 1
