PROTO_0:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["getStyleSheet"]
        3 GETUPVAL                         R1 1
        4 GETUPVAL                         R2 2
        5 GETUPVAL                         R3 3
        6 GETUPVAL                         R4 4
...
PROTO_1:
        ...
        3 FORGPREP                         R1
        4 GETUPVAL                         R6 0
        5 GETTABLEKS                       R6 R6 K0 ["current"]
        7 LOADB                            R7 1
        8 SETTABLE                         R7 R6 R5
        9 FORGLOOP                         R1 2 ; [-6]
       11 GETUPVAL                         R1 1
       12 GETTABLEKS                       R1 R1 K1 ["addStyleTags"]
       14 GETUPVAL                         R2 2
...
PROTO_2:
       ...
       15 FORGLOOP                         R1 1 ; [-8]
       17 GETUPVAL                         R1 1
       18 GETTABLEKS                       R1 R1 K4 ["addStyleTags"]
       20 GETUPVAL                         R2 2
       21 MOVE                             R3 R0
       22 CALL                             R1 2 0
       23 RETURN                           R0 0
...
PROTO_3:
       ...
       40 CALL                             R7 2 1
       41 GETUPVAL                         R8 0
       42 GETTABLEKS                       R8 R8 K4 ["useLayoutEffect"]
       44 NEWCLOSURE                       R9 P2
       45 CAPTURE                          VAL R4
       46 CAPTURE                          UPVAL U1
       47 CAPTURE                          VAL R5
