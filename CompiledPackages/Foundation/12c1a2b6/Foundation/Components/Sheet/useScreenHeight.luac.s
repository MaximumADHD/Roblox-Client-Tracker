...
PROTO_3:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["FoundationOverlayKeyboardAwarenessHardened"]
        3 JUMPIFNOT                        R1 ; [+3]
        4 GETUPVAL                         R0 1
        5 CALL                             R0 0 1
        6 JUMP                             ; [+2]
        ...
        8 CALL                             R0 0 1
        9 GETUPVAL                         R1 3
       10 GETTABLEKS                       R1 R1 K1 ["useState"]
       12 JUMPIFNOT                        R0 ; [+5]
       13 GETTABLEKS                       R2 R0 K2 ["AbsoluteSize"]
       15 GETTABLEKS                       R2 R2 K3 ["Y"]
       17 JUMPIF                           R2 ; [+1]
       18 LOADN                            R2 0
       19 CALL                             R1 1 2
       20 GETUPVAL                         R3 3
       21 GETTABLEKS                       R3 R3 K4 ["useLayoutEffect"]
       23 NEWCLOSURE                       R4 P0
       24 CAPTURE                          VAL R0
       25 CAPTURE                          VAL R2
       26 NEWTABLE                         R5 0 1
...
MAIN:
       ...
       34 GETTABLEKS                       R6 R6 K11 ["Overlay"]
       36 GETTABLEKS                       R6 R6 K13 ["useScreen"]
       38 CALL                             R5 1 1
