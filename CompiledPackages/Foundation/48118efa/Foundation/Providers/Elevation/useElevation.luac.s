PROTO_0:
        ...
        2 JUMPIFEQKNIL                     R1 ; [+9]
        4 GETUPVAL                         R1 0
        5 GETTABLEKS                       R1 R1 K0 ["layer"]
        7 GETUPVAL                         R2 1
        8 JUMPIFEQ                         R1 R2 ; [+2]
       10 LOADB                            R0 0 +1
       11 LOADB                            R0 1
       12 GETUPVAL                         R1 2
       13 GETTABLEKS                       R1 R1 K1 ["stackAboveOwner"]
       15 JUMPIFNOT                        R1 ; [+31]
       16 GETUPVAL                         R1 0
       17 JUMPIF                           R1 ; [+7]
       18 GETUPVAL                         R1 3
       19 GETTABLEKS                       R1 R1 K2 ["acquire"]
       21 GETUPVAL                         R2 1
       22 DUPTABLE                         R3 K5 [{["reserve"] = False}]
       23 CALL                             R1 2 -1
       24 RETURN                           R1 -1
       25 JUMPIFNOT                        R0 ; [+10]
       26 GETUPVAL                         R1 3
       27 GETTABLEKS                       R1 R1 K2 ["acquire"]
       29 GETUPVAL                         R2 1
       30 DUPTABLE                         R3 K8 [{["reserve"] = True, ["owner"]}]
       31 GETUPVAL                         R4 0
       32 SETTABLEKS                       R4 R3 K7 ["owner"]
       34 CALL                             R1 2 -1
       35 RETURN                           R1 -1
       36 GETUPVAL                         R2 0
       37 GETTABLEKS                       R2 R2 K10 ["zIndex"]
       39 ADDK                             R1 R2 K9 [1]
       40 DUPTABLE                         R2 K13 [{[1], ["index"] = -1, ["zIndex"]}]
       41 GETUPVAL                         R3 1
       42 SETTABLEKS                       R3 R2 K0 ["layer"]
       44 SETTABLEKS                       R1 R2 K10 ["zIndex"]
       46 RETURN                           R2 1
       47 GETUPVAL                         R1 3
       48 GETTABLEKS                       R1 R1 K2 ["acquire"]
       50 GETUPVAL                         R2 1
       51 DUPTABLE                         R3 K14 [{"reserve"}]
       52 SETTABLEKS                       R0 R3 K3 ["reserve"]
       54 CALL                             R1 2 -1
       55 RETURN                           R1 -1
