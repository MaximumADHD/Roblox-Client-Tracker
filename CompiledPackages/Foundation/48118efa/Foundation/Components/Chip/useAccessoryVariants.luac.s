...
PROTO_1:
       ...
       11 GETUPVAL                         R8 2
       12 GETTABLEKS                       R8 R8 K4 ["FoundationChipBeta"]
       14 JUMPIFNOT                        R8 ; [+2]
       15 MOVE                             R7 R2
       16 JUMP                             ; [+1]
       17 MOVE                             R7 R3
       18 JUMPIFNOT                        R7 ; [+2]
       19 LOADK                            R6 K5 ["Leading"]
       20 JUMP                             ; [+1]
       21 LOADK                            R6 K6 ["Trailing"]
       22 GETUPVAL                         R7 3
       23 DUPTABLE                         R8 K8 [{"accessory"}]
       24 DUPTABLE                         R9 K11 [{"Size", "padding"}]
       25 GETTABLEKS                       R12 R4 K12 ["accessorySize"]
       27 GETTABLE                         R11 R12 R5
       28 GETTABLE                         R10 R11 R1
       29 SETTABLEKS                       R10 R9 K9 ["Size"]
       31 JUMPIFNOT                        R2 ; [+14]
       32 DUPTABLE                         R10 K15 [{"left", "right"}]
       33 GETTABLEKS                       R13 R4 K16 ["accessorySpacing"]
       35 GETTABLE                         R12 R13 R5
       36 GETTABLE                         R11 R12 R1
       37 SETTABLEKS                       R11 R10 K13 ["left"]
       39 GETTABLEKS                       R13 R4 K17 ["textSpacing"]
       41 GETTABLE                         R12 R13 R6
       42 GETTABLE                         R11 R12 R1
       43 SETTABLEKS                       R11 R10 K14 ["right"]
       45 JUMP                             ; [+13]
       46 DUPTABLE                         R10 K15 [{"left", "right"}]
       47 GETTABLEKS                       R13 R4 K17 ["textSpacing"]
       49 GETTABLE                         R12 R13 R6
       50 GETTABLE                         R11 R12 R1
       51 SETTABLEKS                       R11 R10 K13 ["left"]
       53 GETTABLEKS                       R13 R4 K16 ["accessorySpacing"]
       55 GETTABLE                         R12 R13 R5
       56 GETTABLE                         R11 R12 R1
       57 SETTABLEKS                       R11 R10 K14 ["right"]
       59 SETTABLEKS                       R10 R9 K10 ["padding"]
       61 SETTABLEKS                       R9 R8 K7 ["accessory"]
       63 CALL                             R7 1 -1
       64 RETURN                           R7 -1
