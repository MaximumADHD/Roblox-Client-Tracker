PROTO_0:
        ...
        6 GETTABLEKS                       R1 R2 K1 ["LayoutOrder"]
        8 JUMPIFNOT                        R1 ; [+11]
        9 GETUPVAL                         R2 0
       10 GETTABLEKS                       R4 R0 K0 ["props"]
       12 GETTABLEKS                       R3 R4 K1 ["LayoutOrder"]
...
PROTO_1:
        ...
        4 LOADN                            R3 0
        5 GETUPVAL                         R6 2
        6 GETTABLEKS                       R5 R6 K0 ["Children"]
        8 GETTABLEKS                       R4 R5 K1 ["forEach"]
       ...
       25 JUMP                             ; [+4]
       26 GETTABLEKS                       R5 R2 K3 ["isContained"]
       28 GETTABLEKS                       R4 R5 K3 ["isContained"]
       30 JUMPIFNOT                        R4 ; [+2]
       31 LOADB                            R5 1
       32 JUMP                             ; [+14]
       ...
       41 GETTABLEKS                       R6 R2 K3 ["isContained"]
       43 GETTABLEKS                       R5 R6 K8 ["hasMargin"]
       45 JUMP                             ; [+1]
       46 LOADB                            R5 1
       ...
       57 JUMP                             ; [+4]
       58 GETTABLEKS                       R7 R2 K9 ["hasDivider"]
       60 GETTABLEKS                       R6 R7 K10 ["isInset"]
       62 GETUPVAL                         R8 2
       63 GETTABLEKS                       R7 R8 K11 ["createElement"]
       65 GETUPVAL                         R8 3
       66 GETUPVAL                         R9 4
       67 MOVE                             R10 R2
       ...
       82 GETUPVAL                         R12 2
       83 GETTABLEKS                       R11 R12 K11 ["createElement"]
       85 GETUPVAL                         R13 5
       86 GETTABLEKS                       R12 R13 K19 ["Provider"]
