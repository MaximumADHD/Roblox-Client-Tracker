PROTO_0:
        ...
        4 ORK                              R2 R3 K0 [0]
        5 GETUPVAL                         R4 1
        6 GETTABLEKS                       R4 R4 K2 ["ELEVATION_LAYERS"]
        8 GETTABLE                         R3 R4 R0
        9 GETTABLEKS                       R4 R1 K3 ["reserve"]
       11 JUMPIF                           R4 ; [+8]
       12 DUPTABLE                         R4 K8 [{["layer"], ["index"] = -1, ["zIndex"]}]
       13 SETTABLEKS                       R0 R4 K4 ["layer"]
       15 GETTABLEKS                       R5 R3 K9 ["start"]
       17 SETTABLEKS                       R5 R4 K7 ["zIndex"]
       19 RETURN                           R4 1
       20 GETTABLEKS                       R5 R3 K9 ["start"]
       22 ADDK                             R7 R2 K10 [1]
       23 GETTABLEKS                       R8 R3 K11 ["step"]
       25 MUL                              R6 R7 R8
       26 ADD                              R4 R5 R6
       27 GETTABLEKS                       R5 R3 K12 ["finish"]
       29 JUMPIFNOTLT                      R5 R4 ; [+18]
       31 GETIMPORT                        R5 K14 [warn]
       33 GETIMPORT                        R6 K17 [string.format]
       35 LOADK                            R7 K18 ["Layer '%s' capacity exceeded (%d/%d). Capping zIndex at %d."]
       36 FASTCALL1                        TOSTRING R0 ; [+3]
       37 MOVE                             R9 R0
       38 GETIMPORT                        R8 K20 [tostring]
       40 CALL                             R8 1 1
       41 MOVE                             R9 R4
       42 GETTABLEKS                       R10 R3 K12 ["finish"]
       44 GETTABLEKS                       R11 R3 K12 ["finish"]
       46 CALL                             R6 5 -1
       47 CALL                             R5 -1 0
       48 GETUPVAL                         R5 0
       49 GETTABLEKS                       R5 R5 K1 ["current"]
       51 ADDK                             R6 R2 K10 [1]
       52 SETTABLE                         R6 R5 R0
       53 MOVE                             R5 R4
       54 GETTABLEKS                       R6 R3 K12 ["finish"]
       56 JUMPIFNOTLT                      R6 R5 ; [+3]
       58 GETTABLEKS                       R5 R3 K12 ["finish"]
       60 DUPTABLE                         R6 K21 [{"layer", "index", "zIndex"}]
       61 SETTABLEKS                       R0 R6 K4 ["layer"]
       63 SETTABLEKS                       R2 R6 K5 ["index"]
       65 SETTABLEKS                       R5 R6 K7 ["zIndex"]
       67 RETURN                           R6 1
