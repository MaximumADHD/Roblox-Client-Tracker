PROTO_0:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["scrollBarVisibility"]
        3 GETUPVAL                         R1 1
        ...
        9 RETURN                           R0 1
       10 GETUPVAL                         R0 2
       11 GETTABLEKS                       R0 R0 K2 ["Size"]
       13 GETTABLEKS                       R0 R0 K3 ["Size_150"]
       15 RETURN                           R0 1

PROTO_1:
        0 GETUPVAL                         R0 0
        1 GETUPVAL                         R1 1
        2 GETTABLEKS                       R1 R1 K0 ["spring"]
        4 LOADN                            R2 1
        5 GETUPVAL                         R3 2
        6 CALL                             R1 2 -1
        7 CALL                             R0 -1 0
...
PROTO_2:
       ...
       11 GETUPVAL                         R2 1
       12 GETUPVAL                         R3 2
       13 GETTABLEKS                       R3 R3 K4 ["spring"]
       15 GETUPVAL                         R4 3
       16 GETTABLEKS                       R4 R4 K5 ["Transparency"]
       18 GETUPVAL                         R5 4
       19 CALL                             R3 2 -1
       20 CALL                             R2 -1 0
...
PROTO_3:
        ...
        9 RETURN                           R0 0
       10 GETUPVAL                         R0 0
       11 GETTABLEKS                       R0 R0 K0 ["scrollBarVisibility"]
       ...
       20 LOADB                            R1 1
       21 GETUPVAL                         R2 0
       22 GETTABLEKS                       R2 R2 K3 ["controlState"]
       24 GETUPVAL                         R3 2
       25 GETTABLEKS                       R3 R3 K4 ["Hover"]
       27 JUMPIFEQ                         R2 R3 ; [+20]
       29 LOADB                            R1 1
       30 GETUPVAL                         R2 0
       31 GETTABLEKS                       R2 R2 K3 ["controlState"]
       33 GETUPVAL                         R3 2
       34 GETTABLEKS                       R3 R3 K5 ["Selected"]
       36 JUMPIFEQ                         R2 R3 ; [+11]
       38 GETUPVAL                         R2 0
       39 GETTABLEKS                       R2 R2 K3 ["controlState"]
       41 GETUPVAL                         R3 2
       42 GETTABLEKS                       R3 R3 K6 ["Pressed"]
       44 JUMPIFEQ                         R2 R3 ; [+2]
       46 LOADB                            R1 0 +1
       47 LOADB                            R1 1
       48 GETUPVAL                         R3 0
       49 GETTABLEKS                       R3 R3 K3 ["controlState"]
       51 GETUPVAL                         R4 2
       52 GETTABLEKS                       R4 R4 K7 ["Default"]
...
PROTO_4:
        ...
        3 CALL                             R1 2 0
        4 GETUPVAL                         R1 1
        5 GETTABLEKS                       R1 R1 K0 ["onCanvasPositionChanged"]
        7 JUMPIFNOT                        R1 ; [+5]
        8 GETUPVAL                         R1 1
        9 GETTABLEKS                       R1 R1 K0 ["onCanvasPositionChanged"]
       11 MOVE                             R2 R0
       12 CALL                             R1 1 0
       13 RETURN                           R0 0
...
PROTO_5:
       ...
       18 CALL                             R5 1 1
       19 GETTABLEKS                       R6 R4 K3 ["Color"]
       21 GETTABLEKS                       R6 R6 K4 ["Shift"]
       23 GETTABLEKS                       R6 R6 K5 ["Shift_400"]
       25 GETUPVAL                         R7 5
       ...
       45 CALL                             R9 1 1
       46 GETUPVAL                         R10 8
       47 GETTABLEKS                       R10 R10 K9 ["useAnimatedBinding"]
       49 LOADN                            R11 1
       50 CALL                             R10 1 2
       51 GETUPVAL                         R12 5
       52 GETTABLEKS                       R12 R12 K10 ["useCallback"]
       ...
       65 CALL                             R12 2 1
       66 GETUPVAL                         R13 5
       67 GETTABLEKS                       R13 R13 K11 ["useEffect"]
       ...
       81 CALL                             R13 2 0
       82 GETUPVAL                         R13 5
       83 GETTABLEKS                       R13 R13 K13 ["createElement"]
      ...
      170 GETUPVAL                         R16 5
      171 GETTABLEKS                       R16 R16 K40 ["Change"]
      173 GETTABLEKS                       R16 R16 K41 ["CanvasPosition"]
      ...
      186 GETUPVAL                         R16 5
      187 GETTABLEKS                       R16 R16 K40 ["Change"]
      189 GETTABLEKS                       R16 R16 K44 ["AbsoluteCanvasSize"]
      191 GETTABLEKS                       R17 R2 K45 ["onAbsoluteCanvasSizeChanged"]
      193 SETTABLE                         R17 R15 R16
      194 GETUPVAL                         R16 5
      195 GETTABLEKS                       R16 R16 K40 ["Change"]
      197 GETTABLEKS                       R16 R16 K46 ["AbsoluteWindowSize"]
      199 GETTABLEKS                       R17 R2 K47 ["onAbsoluteWindowSizeChanged"]
      201 SETTABLE                         R17 R15 R16
      202 SETTABLEKS                       R1 R15 K48 ["ref"]
      204 GETUPVAL                         R16 5
      205 GETTABLEKS                       R16 R16 K49 ["Tag"]
...
MAIN:
       ...
       30 GETTABLEKS                       R6 R6 K12 ["withDefaults"]
       32 CALL                             R5 1 1
       33 GETIMPORT                        R6 K6 [require]
       35 GETTABLEKS                       R7 R0 K11 ["Utility"]
       37 GETTABLEKS                       R7 R7 K13 ["withGuiObjectProps"]
       39 CALL                             R6 1 1
       40 GETIMPORT                        R7 K6 [require]
       42 GETTABLEKS                       R8 R0 K14 ["Providers"]
       44 GETTABLEKS                       R8 R8 K15 ["Cursor"]
       46 GETTABLEKS                       R8 R8 K16 ["useCursor"]
       48 CALL                             R7 1 1
       49 GETIMPORT                        R8 K6 [require]
       51 GETTABLEKS                       R9 R0 K14 ["Providers"]
       53 GETTABLEKS                       R9 R9 K17 ["Style"]
       55 GETTABLEKS                       R9 R9 K18 ["useStyleTags"]
       57 CALL                             R8 1 1
       58 GETIMPORT                        R9 K6 [require]
       60 GETTABLEKS                       R10 R0 K14 ["Providers"]
       62 GETTABLEKS                       R10 R10 K17 ["Style"]
       64 GETTABLEKS                       R10 R10 K19 ["useTokens"]
       66 CALL                             R9 1 1
       67 GETIMPORT                        R10 K6 [require]
       69 GETTABLEKS                       R11 R0 K20 ["Enums"]
       71 GETTABLEKS                       R11 R11 K21 ["Visibility"]
       73 CALL                             R10 1 1
       74 GETIMPORT                        R11 K6 [require]
       76 GETTABLEKS                       R12 R0 K20 ["Enums"]
       78 GETTABLEKS                       R12 R12 K22 ["ControlState"]
       80 CALL                             R11 1 1
       81 DUPTABLE                         R12 K25 [{["frequency"] = 2}]
       82 DUPTABLE                         R13 K28 [{["scrollBarVisibility"] = "Auto"}]
       83 DUPCLOSURE                       R14 K29 [PROTO_5]
       84 CAPTURE                          VAL R5
       85 CAPTURE                          VAL R13
       86 CAPTURE                          VAL R6
       87 CAPTURE                          VAL R9
       ...
       93 CAPTURE                          VAL R12
       94 CAPTURE                          VAL R11
       95 GETTABLEKS                       R15 R2 K30 ["memo"]
       97 GETTABLEKS                       R16 R2 K31 ["forwardRef"]
       99 MOVE                             R17 R14
      100 CALL                             R16 1 -1
      101 CALL                             R15 -1 -1
      102 RETURN                           R15 -1
