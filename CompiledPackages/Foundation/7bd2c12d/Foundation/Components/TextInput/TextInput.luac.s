PROTO_0:
      ...
      128 CALL                             R8 1 1
      129 JUMPIFNOTEQKS                    R8 K33 ["table"] ; [+50]
      131 GETUPVAL                         R8 2
      ...
      140 GETUPVAL                         R8 6
      141 DUPTABLE                         R9 K35 [{"onActivated", "isDisabled", "size", "icon", "testId"}]
      142 GETUPVAL                         R10 2
      ...
      168 LOADK                            R11 K36 ["%*--trailing-icon-button"]
      169 GETUPVAL                         R13 2
      170 GETTABLEKS                       R13 R13 K15 ["testId"]
      172 NAMECALL                         R11 R11 K37 ["format"]
      174 CALL                             R11 2 1
      175 MOVE                             R10 R11
      176 SETTABLEKS                       R10 R9 K15 ["testId"]
      178 CALL                             R7 2 1
      179 JUMP                             ; [+40]
      180 GETUPVAL                         R7 0
      181 GETTABLEKS                       R7 R7 K0 ["createElement"]
      183 GETUPVAL                         R8 5
      184 DUPTABLE                         R9 K28 [{"name", "style", "size"}]
      185 GETUPVAL                         R12 2
      186 GETTABLEKS                       R12 R12 K30 ["iconTrailing"]
      188 FASTCALL1                        TYPE R12 ; [+2]
      189 GETIMPORT                        R11 K32 [type]
      191 CALL                             R11 1 1
      192 JUMPIFNOTEQKS                    R11 K33 ["table"] ; [+7]
      194 GETUPVAL                         R10 2
      195 GETTABLEKS                       R10 R10 K30 ["iconTrailing"]
      197 GETTABLEKS                       R10 R10 K26 ["name"]
      199 JUMP                             ; [+3]
      200 GETUPVAL                         R10 2
      201 GETTABLEKS                       R10 R10 K30 ["iconTrailing"]
      203 SETTABLEKS                       R10 R9 K26 ["name"]
      205 GETUPVAL                         R10 3
      206 GETTABLEKS                       R10 R10 K29 ["icon"]
      208 GETTABLEKS                       R10 R10 K27 ["style"]
      210 SETTABLEKS                       R10 R9 K27 ["style"]
      212 GETUPVAL                         R10 3
      213 GETTABLEKS                       R10 R10 K29 ["icon"]
      215 GETTABLEKS                       R10 R10 K6 ["size"]
      217 SETTABLEKS                       R10 R9 K6 ["size"]
      219 CALL                             R7 2 1
      220 CALL                             R4 3 1
      221 JUMP                             ; [+1]
      222 LOADNIL                          R4
      223 SETTABLEKS                       R4 R3 K14 ["trailingElement"]
      225 LOADK                            R5 K38 ["%*--internal-text-input"]
      226 GETUPVAL                         R7 2
      227 GETTABLEKS                       R7 R7 K15 ["testId"]
      229 NAMECALL                         R5 R5 K37 ["format"]
      231 CALL                             R5 2 1
      232 MOVE                             R4 R5
      233 SETTABLEKS                       R4 R3 K15 ["testId"]
      235 CALL                             R1 2 -1
      236 RETURN                           R1 -1
...
MAIN:
      ...
      107 CALL                             R17 1 1
      108 DUPTABLE                         R18 K32 [{["size"], ["width"], ["testId"] = "--foundation-text-input"}]
      109 GETTABLEKS                       R19 R14 K33 ["Large"]
      111 SETTABLEKS                       R19 R18 K28 ["size"]
      113 GETTABLEKS                       R20 R15 K34 ["FoundationTextInputTokenBasedWidth"]
      115 JUMPIFNOT                        R20 ; [+2]
      116 LOADNIL                          R19
      117 JUMP                             ; [+5]
      118 GETIMPORT                        R19 K37 [UDim.new]
      120 LOADN                            R20 0
      121 LOADN                            R21 400
      122 CALL                             R19 2 1
      123 SETTABLEKS                       R19 R18 K29 ["width"]
      125 DUPCLOSURE                       R19 K38 [PROTO_1]
      126 CAPTURE                          VAL R15
      127 CAPTURE                          VAL R18
      128 CAPTURE                          VAL R13
      129 CAPTURE                          VAL R11
      ...
      137 CAPTURE                          VAL R4
      138 CAPTURE                          VAL R5
      139 GETTABLEKS                       R20 R2 K39 ["memo"]
      141 GETTABLEKS                       R21 R2 K40 ["forwardRef"]
      143 MOVE                             R22 R19
      144 CALL                             R21 1 -1
      145 CALL                             R20 -1 -1
      146 RETURN                           R20 -1
