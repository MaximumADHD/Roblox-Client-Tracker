PROTO_0:
       ...
       10 GETUPVAL                         R5 3
       11 GETTABLEKS                       R5 R5 K18 ["FoundationTextAreaVariant"]
       13 JUMPIFNOT                        R5 ; [+4]
       14 GETUPVAL                         R4 2
       ...
       21 GETUPVAL                         R4 2
       22 GETTABLEKS                       R4 R4 K3 ["numLines"]
       24 SETTABLEKS                       R4 R3 K3 ["numLines"]
       26 GETUPVAL                         R5 3
       27 GETTABLEKS                       R5 R5 K19 ["FoundationTextInputFocusBehavior"]
       29 JUMPIFNOT                        R5 ; [+4]
       30 GETUPVAL                         R4 2
       31 GETTABLEKS                       R4 R4 K4 ["focusBehavior"]
       33 JUMP                             ; [+1]
       34 LOADNIL                          R4
       35 SETTABLEKS                       R4 R3 K4 ["focusBehavior"]
       37 GETUPVAL                         R4 2
       38 GETTABLEKS                       R4 R4 K20 ["onFocusGained"]
       40 SETTABLEKS                       R4 R3 K5 ["onFocus"]
       42 GETUPVAL                         R4 2
       43 GETTABLEKS                       R4 R4 K6 ["onFocusLost"]
       45 SETTABLEKS                       R4 R3 K6 ["onFocusLost"]
       47 GETUPVAL                         R4 2
       48 GETTABLEKS                       R4 R4 K7 ["onChanged"]
       50 SETTABLEKS                       R4 R3 K7 ["onChanged"]
       52 GETUPVAL                         R4 2
       53 GETTABLEKS                       R4 R4 K8 ["text"]
       55 SETTABLEKS                       R4 R3 K8 ["text"]
       57 GETUPVAL                         R4 2
       58 GETTABLEKS                       R4 R4 K9 ["hasError"]
       60 SETTABLEKS                       R4 R3 K9 ["hasError"]
       62 GETUPVAL                         R4 2
       63 GETTABLEKS                       R4 R4 K10 ["isDisabled"]
       65 SETTABLEKS                       R4 R3 K10 ["isDisabled"]
       67 GETUPVAL                         R5 3
       68 GETTABLEKS                       R5 R5 K21 ["FoundationInternalTextInputClearButton"]
       70 JUMPIFNOT                        R5 ; [+4]
       71 GETUPVAL                         R4 2
       72 GETTABLEKS                       R4 R4 K11 ["hasClearButton"]
       74 JUMP                             ; [+1]
       75 LOADNIL                          R4
       76 SETTABLEKS                       R4 R3 K11 ["hasClearButton"]
       78 GETUPVAL                         R4 2
       79 GETTABLEKS                       R4 R4 K12 ["placeholder"]
       81 SETTABLEKS                       R4 R3 K12 ["placeholder"]
       83 DUPTABLE                         R4 K24 [{"left", "right"}]
       84 GETUPVAL                         R6 3
       85 GETTABLEKS                       R6 R6 K25 ["FoundationInputVariantsConsolidateContainer"]
       87 JUMPIFNOT                        R6 ; [+4]
       88 GETUPVAL                         R5 4
       89 GETTABLEKS                       R5 R5 K26 ["container"]
       91 JUMP                             ; [+3]
       92 GETUPVAL                         R5 4
       93 GETTABLEKS                       R5 R5 K27 ["innerContainer"]
       95 GETTABLEKS                       R5 R5 K13 ["horizontalPadding"]
       97 SETTABLEKS                       R5 R4 K22 ["left"]
       99 GETUPVAL                         R7 3
      100 GETTABLEKS                       R7 R7 K25 ["FoundationInputVariantsConsolidateContainer"]
      102 JUMPIFNOT                        R7 ; [+4]
      103 GETUPVAL                         R6 4
      104 GETTABLEKS                       R6 R6 K26 ["container"]
      106 JUMP                             ; [+3]
      107 GETUPVAL                         R6 4
      108 GETTABLEKS                       R6 R6 K27 ["innerContainer"]
      110 GETTABLEKS                       R6 R6 K13 ["horizontalPadding"]
      112 GETIMPORT                        R7 K30 [UDim.new]
      114 LOADN                            R8 0
      115 GETUPVAL                         R9 5
      116 GETTABLEKS                       R9 R9 K31 ["Size"]
      118 GETTABLEKS                       R9 R9 K32 ["Size_150"]
      120 CALL                             R7 2 1
      121 SUB                              R5 R6 R7
      ...
      132 GETUPVAL                         R7 2
      133 GETTABLEKS                       R7 R7 K16 ["testId"]
...
PROTO_1:
       ...
       10 GETUPVAL                         R8 4
       11 GETTABLEKS                       R8 R8 K1 ["FoundationTextAreaVariant"]
       13 JUMPIFNOT                        R8 ; [+3]
...
MAIN:
       ...
       81 GETTABLEKS                       R14 R14 K23 ["InputVariant"]
       83 CALL                             R13 1 1
       84 GETIMPORT                        R14 K6 [require]
       86 GETTABLEKS                       R15 R0 K21 ["Enums"]
       88 GETTABLEKS                       R15 R15 K24 ["ControlState"]
       90 CALL                             R14 1 1
