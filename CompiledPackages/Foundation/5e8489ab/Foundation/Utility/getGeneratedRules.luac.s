...
PROTO_10:
        ...
        5 LOADNIL                          R5
        6 GETUPVAL                         R6 1
        7 GETTABLEKS                       R6 R6 K1 ["FoundationUseAttributeTokens"]
        9 JUMPIFNOT                        R6 ; [+10]
       10 GETUPVAL                         R8 2
       11 GETUPVAL                         R9 0
       12 GETTABLEKS                       R9 R9 K0 ["Attribute"]
       ...
       20 GETUPVAL                         R8 2
       21 GETUPVAL                         R9 0
       22 GETTABLEKS                       R9 R9 K3 ["Static"]
       24 GETTABLE                         R7 R8 R9
       25 GETTABLEKS                       R6 R7 K2 ["Common"]
       27 CALL                             R6 0 1
       28 MOVE                             R5 R6
       29 GETUPVAL                         R6 3
       30 GETTABLEKS                       R6 R6 K4 ["Dark"]
       32 JUMPIFNOTEQ                      R0 R6 ; [+25]
       34 GETUPVAL                         R6 1
       35 GETTABLEKS                       R6 R6 K1 ["FoundationUseAttributeTokens"]
       37 JUMPIFNOT                        R6 ; [+10]
       38 GETUPVAL                         R8 2
       39 GETUPVAL                         R9 0
       40 GETTABLEKS                       R9 R9 K0 ["Attribute"]
       ...
       57 JUMP                             ; [+28]
       58 GETUPVAL                         R6 3
       59 GETTABLEKS                       R6 R6 K5 ["Light"]
       61 JUMPIFNOTEQ                      R0 R6 ; [+24]
       63 GETUPVAL                         R6 1
       64 GETTABLEKS                       R6 R6 K1 ["FoundationUseAttributeTokens"]
       66 JUMPIFNOT                        R6 ; [+10]
       67 GETUPVAL                         R8 2
       68 GETUPVAL                         R9 0
       69 GETTABLEKS                       R9 R9 K0 ["Attribute"]
       ...
       77 GETUPVAL                         R8 2
       78 GETUPVAL                         R9 0
       79 GETTABLEKS                       R9 R9 K3 ["Static"]
       81 GETTABLE                         R7 R8 R9
       82 GETTABLEKS                       R6 R7 K5 ["Light"]
       84 CALL                             R6 0 1
       85 MOVE                             R3 R6
       86 GETUPVAL                         R6 4
       87 GETTABLEKS                       R6 R6 K6 ["Console"]
       89 JUMPIFNOTEQ                      R1 R6 ; [+12]
       91 GETUPVAL                         R6 1
       92 GETTABLEKS                       R6 R6 K7 ["FoundationDisableTokenScaling"]
       94 JUMPIF                           R6 ; [+7]
       95 GETUPVAL                         R8 2
