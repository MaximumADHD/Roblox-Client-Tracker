PROTO_0:
       ...
       22 LOADK                            R4 K6 ["size-0-0 auto-xy col align-x-center gap-small"]
       ...
       31 LOADK                            R8 K12 ["auto-xy text-align-x-center text-caption-small"]
       32 SETTABLEKS                       R8 R7 K4 ["tag"]
       34 SETTABLEKS                       R0 R7 K10 ["Text"]
       36 CALL                             R5 2 1
       37 SETTABLEKS                       R5 R4 K7 ["Label"]
       39 GETUPVAL                         R5 2
       40 GETTABLEKS                       R5 R5 K2 ["createElement"]
       42 GETUPVAL                         R6 5
...
PROTO_1:
        ...
        5 LOADK                            R3 K3 ["size-full-0 auto-y row align-x-left align-y-center gap-xxlarge"]
...
PROTO_2:
       ...
       37 SETTABLEKS                       R5 R4 K7 ["Label"]
       39 GETUPVAL                         R5 2
       40 GETTABLEKS                       R5 R5 K3 ["createElement"]
       42 GETUPVAL                         R6 5
       43 DUPTABLE                         R7 K16 [{"value", "variant", "max"}]
       44 GETUPVAL                         R8 6
       45 GETTABLEKS                       R8 R8 K17 ["controls"]
       47 GETTABLEKS                       R8 R8 K13 ["value"]
       49 SETTABLEKS                       R8 R7 K13 ["value"]
       51 SETTABLEKS                       R0 R7 K14 ["variant"]
       53 GETUPVAL                         R8 6
       54 GETTABLEKS                       R8 R8 K17 ["controls"]
       56 GETTABLEKS                       R8 R8 K15 ["max"]
...
PROTO_3:
        ...
        5 LOADK                            R4 K3 ["size-full-0 auto-y row align-x-left align-y-center gap-xxlarge"]
        6 SETTABLEKS                       R4 R3 K1 ["tag"]
        8 GETUPVAL                         R4 2
        9 GETTABLEKS                       R4 R4 K4 ["map"]
       11 NEWTABLE                         R5 0 4
       13 GETUPVAL                         R6 3
       14 GETTABLEKS                       R6 R6 K5 ["Standard"]
       16 GETUPVAL                         R7 3
       17 GETTABLEKS                       R7 R7 K6 ["Emphasis"]
       19 GETUPVAL                         R8 3
       20 GETTABLEKS                       R8 R8 K7 ["Alert"]
       22 GETUPVAL                         R9 3
       23 GETTABLEKS                       R9 R9 K8 ["Contrast_Experiment"]
...
MAIN:
       ...
       44 GETTABLEKS                       R8 R8 K14 ["StatusIndicator"]
       46 CALL                             R7 1 1
       47 GETIMPORT                        R8 K6 [require]
       49 GETTABLEKS                       R9 R0 K15 ["Enums"]
       51 GETTABLEKS                       R9 R9 K16 ["StatusIndicatorVariant"]
       53 CALL                             R8 1 1
       54 DUPTABLE                         R9 K20 [{"summary", "stories", "controls"}]
       55 LOADK                            R10 K14 ["StatusIndicator"]
