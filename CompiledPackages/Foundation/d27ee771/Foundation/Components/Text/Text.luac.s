...
PROTO_2:
      ...
      232 JUMPIFNOT                        R4 ; [+20]
      233 GETUPVAL                         R15 0
      234 GETTABLEKS                       R15 R15 K42 ["FoundationMigrateCryoToDash"]
      236 JUMPIFNOT                        R15 ; [+7]
      237 GETUPVAL                         R14 12
      238 GETTABLEKS                       R14 R14 K43 ["union"]
      240 MOVE                             R15 R11
      241 MOVE                             R16 R13
      242 CALL                             R14 2 1
      243 JUMP                             ; [+10]
      244 GETUPVAL                         R14 13
      245 GETTABLEKS                       R14 R14 K44 ["Dictionary"]
      247 GETTABLEKS                       R14 R14 K43 ["union"]
      249 MOVE                             R15 R11
      250 MOVE                             R16 R13
      251 CALL                             R14 2 1
      252 JUMP                             ; [+1]
      253 MOVE                             R14 R11
      254 GETUPVAL                         R15 6
      255 GETTABLEKS                       R15 R15 K45 ["createElement"]
      257 MOVE                             R16 R12
      258 MOVE                             R17 R14
      259 GETUPVAL                         R18 14
      260 MOVE                             R19 R3
...
MAIN:
       ...
       33 GETTABLEKS                       R7 R1 K12 ["Dash"]
       35 CALL                             R6 1 1
       36 GETIMPORT                        R7 K6 [require]
       38 GETTABLEKS                       R8 R0 K13 ["Components"]
       40 GETTABLEKS                       R8 R8 K14 ["Interactable"]
       42 CALL                             R7 1 1
       43 GETIMPORT                        R8 K6 [require]
       45 GETTABLEKS                       R9 R0 K13 ["Components"]
       47 GETTABLEKS                       R9 R9 K15 ["Types"]
       49 CALL                             R8 1 1
       50 GETIMPORT                        R9 K6 [require]
       52 GETTABLEKS                       R10 R0 K7 ["Utility"]
       54 GETTABLEKS                       R10 R10 K16 ["withDefaults"]
       56 CALL                             R9 1 1
       57 GETIMPORT                        R10 K6 [require]
       59 GETTABLEKS                       R11 R0 K7 ["Utility"]
       61 GETTABLEKS                       R11 R11 K17 ["useDefaultTags"]
       63 CALL                             R10 1 1
       64 GETIMPORT                        R11 K6 [require]
       66 GETTABLEKS                       R12 R0 K7 ["Utility"]
       68 GETTABLEKS                       R12 R12 K18 ["withGuiObjectProps"]
       70 CALL                             R11 1 1
       71 GETIMPORT                        R12 K6 [require]
       73 GETTABLEKS                       R13 R0 K7 ["Utility"]
       75 GETTABLEKS                       R13 R13 K19 ["useStyledDefaults"]
       77 CALL                             R12 1 1
       78 GETIMPORT                        R13 K6 [require]
       80 GETTABLEKS                       R14 R0 K7 ["Utility"]
       82 GETTABLEKS                       R14 R14 K20 ["indexBindable"]
       84 CALL                             R13 1 1
       85 GETIMPORT                        R14 K6 [require]
       87 GETTABLEKS                       R15 R0 K7 ["Utility"]
       89 GETTABLEKS                       R15 R15 K21 ["GuiObjectChildren"]
       91 CALL                             R14 1 1
       92 GETIMPORT                        R15 K6 [require]
       94 GETTABLEKS                       R16 R0 K22 ["Providers"]
       96 GETTABLEKS                       R16 R16 K23 ["Style"]
       98 GETTABLEKS                       R16 R16 K24 ["useStyleTags"]
      100 CALL                             R15 1 1
      101 GETIMPORT                        R16 K6 [require]
      103 GETIMPORT                        R17 K1 [script]
      105 GETTABLEKS                       R17 R17 K4 ["Parent"]
      107 GETTABLEKS                       R17 R17 K25 ["FontScales"]
      109 CALL                             R16 1 1
      110 DUPTABLE                         R17 K30 [{"AutoLocalize", "AutoButtonColor", "BorderSizePixel", "isDisabled"}]
      111 LOADB                            R18 0
      112 SETTABLEKS                       R18 R17 K26 ["AutoLocalize"]
      114 LOADB                            R18 0
      115 SETTABLEKS                       R18 R17 K27 ["AutoButtonColor"]
      117 LOADN                            R18 0
      118 SETTABLEKS                       R18 R17 K28 ["BorderSizePixel"]
      120 LOADB                            R18 0
      121 SETTABLEKS                       R18 R17 K29 ["isDisabled"]
      123 DUPCLOSURE                       R18 K31 [PROTO_2]
      124 CAPTURE                          VAL R2
      125 CAPTURE                          VAL R12
      126 CAPTURE                          VAL R17
      127 CAPTURE                          VAL R9
      ...
      137 CAPTURE                          VAL R5
      138 CAPTURE                          VAL R14
      139 GETTABLEKS                       R19 R3 K32 ["memo"]
      141 GETTABLEKS                       R20 R3 K33 ["forwardRef"]
      143 MOVE                             R21 R18
      144 CALL                             R20 1 -1
      145 CALL                             R19 -1 -1
      146 RETURN                           R19 -1
