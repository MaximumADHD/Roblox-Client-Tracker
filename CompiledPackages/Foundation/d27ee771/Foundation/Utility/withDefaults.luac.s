PROTO_0:
        ...
        8 GETUPVAL                         R2 0
        9 GETTABLEKS                       R2 R2 K3 ["isBinding"]
       11 MOVE                             R3 R0
       12 CALL                             R2 1 1
       13 NOT                              R1 R2
       14 RETURN                           R1 1
...
PROTO_1:
       ...
       16 GETUPVAL                         R9 0
       17 GETTABLEKS                       R9 R9 K5 ["isBinding"]
       19 MOVE                             R10 R7
       20 CALL                             R9 1 1
       21 NOT                              R8 R9
       22 JUMPIFNOT                        R8 ; [+22]
       ...
       32 GETUPVAL                         R10 0
       33 GETTABLEKS                       R10 R10 K5 ["isBinding"]
       35 MOVE                             R11 R9
       36 CALL                             R10 1 1
       37 NOT                              R8 R10
       38 JUMPIFNOT                        R8 ; [+6]
...
PROTO_2:
       ...
       27 CALL                             R3 2 1
       28 GETUPVAL                         R5 1
       29 GETTABLEKS                       R5 R5 K3 ["FoundationMigrateCryoToDash"]
       31 JUMPIFNOT                        R5 ; [+7]
       32 GETUPVAL                         R4 2
       33 GETTABLEKS                       R4 R4 K4 ["union"]
       35 MOVE                             R5 R0
       36 MOVE                             R6 R3
       37 CALL                             R4 2 1
       38 RETURN                           R4 1
       39 GETUPVAL                         R4 3
       40 GETTABLEKS                       R4 R4 K5 ["Dictionary"]
       42 GETTABLEKS                       R4 R4 K4 ["union"]
       44 MOVE                             R5 R0
       45 MOVE                             R6 R3
       46 CALL                             R4 2 1
       47 RETURN                           R4 1
