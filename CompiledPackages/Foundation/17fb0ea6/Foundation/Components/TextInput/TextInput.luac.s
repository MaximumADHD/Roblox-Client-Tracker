PROTO_0:
       ...
       33 GETUPVAL                         R7 3
       34 GETTABLEKS                       R6 R7 K20 ["innerContainer"]
       36 GETTABLEKS                       R5 R6 K7 ["horizontalPadding"]
       38 SETTABLEKS                       R5 R4 K17 ["left"]
       40 GETUPVAL                         R7 3
       41 GETTABLEKS                       R6 R7 K20 ["innerContainer"]
       43 GETTABLEKS                       R5 R6 K7 ["horizontalPadding"]
       45 SETTABLEKS                       R5 R4 K18 ["right"]
       47 SETTABLEKS                       R4 R3 K7 ["horizontalPadding"]
       49 GETUPVAL                         R5 2
       50 GETTABLEKS                       R4 R5 K8 ["onChanged"]
       52 SETTABLEKS                       R4 R3 K8 ["onChanged"]
       54 GETUPVAL                         R5 2
       55 GETTABLEKS                       R4 R5 K21 ["onFocusGained"]
       57 SETTABLEKS                       R4 R3 K9 ["onFocus"]
       59 GETUPVAL                         R5 2
       60 GETTABLEKS                       R4 R5 K10 ["onFocusLost"]
       62 SETTABLEKS                       R4 R3 K10 ["onFocusLost"]
       64 GETUPVAL                         R5 2
       65 GETTABLEKS                       R4 R5 K11 ["onReturnPressed"]
       67 SETTABLEKS                       R4 R3 K11 ["onReturnPressed"]
       69 GETUPVAL                         R5 2
       70 GETTABLEKS                       R4 R5 K12 ["placeholder"]
       72 SETTABLEKS                       R4 R3 K12 ["placeholder"]
       74 GETUPVAL                         R6 2
       75 GETTABLEKS                       R5 R6 K22 ["leadingIcon"]
       77 JUMPIFNOT                        R5 ; [+35]
       78 GETUPVAL                         R5 0
       79 GETTABLEKS                       R4 R5 K0 ["createElement"]
       81 GETUPVAL                         R5 4
       82 DUPTABLE                         R6 K24 [{"tag"}]
       83 LOADK                            R7 K25 ["row align-y-center size-0-full auto-x"]
       ...
       91 GETUPVAL                         R11 2
       92 GETTABLEKS                       R10 R11 K22 ["leadingIcon"]
       94 SETTABLEKS                       R10 R9 K26 ["name"]
       96 GETUPVAL                         R12 3
       97 GETTABLEKS                       R11 R12 K29 ["icon"]
       99 GETTABLEKS                       R10 R11 K27 ["style"]
      101 SETTABLEKS                       R10 R9 K27 ["style"]
      103 GETUPVAL                         R12 3
      104 GETTABLEKS                       R11 R12 K29 ["icon"]
      106 GETTABLEKS                       R10 R11 K6 ["size"]
      ...
      116 GETUPVAL                         R6 2
      117 GETTABLEKS                       R5 R6 K30 ["iconTrailing"]
      119 JUMPIFNOT                        R5 ; [+108]
      120 GETUPVAL                         R5 0
      121 GETTABLEKS                       R4 R5 K0 ["createElement"]
      123 GETUPVAL                         R5 4
      124 DUPTABLE                         R6 K24 [{"tag"}]
      125 LOADK                            R7 K25 ["row align-y-center size-0-full auto-x"]
      126 SETTABLEKS                       R7 R6 K23 ["tag"]
      128 GETUPVAL                         R10 2
      129 GETTABLEKS                       R9 R10 K30 ["iconTrailing"]
      131 FASTCALL1                        TYPE R9 ; [+2]
      132 GETIMPORT                        R8 K32 [type]
      134 CALL                             R8 1 1
      135 JUMPIFNOTEQKS                    R8 K33 ["table"] ; [+50]
      137 GETUPVAL                         R10 2
      138 GETTABLEKS                       R9 R10 K30 ["iconTrailing"]
      140 GETTABLEKS                       R8 R9 K34 ["onActivated"]
      142 JUMPIFNOT                        R8 ; [+43]
      143 GETUPVAL                         R8 0
      144 GETTABLEKS                       R7 R8 K0 ["createElement"]
      146 GETUPVAL                         R8 6
      147 DUPTABLE                         R9 K35 [{"onActivated", "isDisabled", "size", "icon", "testId"}]
      148 GETUPVAL                         R12 2
      149 GETTABLEKS                       R11 R12 K30 ["iconTrailing"]
      151 GETTABLEKS                       R10 R11 K34 ["onActivated"]
      153 SETTABLEKS                       R10 R9 K34 ["onActivated"]
      155 GETUPVAL                         R11 2
      156 GETTABLEKS                       R10 R11 K3 ["isDisabled"]
      158 SETTABLEKS                       R10 R9 K3 ["isDisabled"]
      160 GETUPVAL                         R12 3
      161 GETTABLEKS                       R11 R12 K29 ["icon"]
      163 GETTABLEKS                       R10 R11 K6 ["size"]
      165 SETTABLEKS                       R10 R9 K6 ["size"]
      167 GETUPVAL                         R12 2
      168 GETTABLEKS                       R11 R12 K30 ["iconTrailing"]
      170 GETTABLEKS                       R10 R11 K26 ["name"]
      172 SETTABLEKS                       R10 R9 K29 ["icon"]
      174 LOADK                            R11 K36 ["%*--trailing-icon-button"]
      175 GETUPVAL                         R14 2
      176 GETTABLEKS                       R13 R14 K15 ["testId"]
      ...
      185 JUMP                             ; [+40]
      186 GETUPVAL                         R8 0
      187 GETTABLEKS                       R7 R8 K0 ["createElement"]
      189 GETUPVAL                         R8 5
      190 DUPTABLE                         R9 K28 [{"name", "style", "size"}]
      191 GETUPVAL                         R13 2
      192 GETTABLEKS                       R12 R13 K30 ["iconTrailing"]
      194 FASTCALL1                        TYPE R12 ; [+2]
      195 GETIMPORT                        R11 K32 [type]
      197 CALL                             R11 1 1
      198 JUMPIFNOTEQKS                    R11 K33 ["table"] ; [+7]
      200 GETUPVAL                         R12 2
      201 GETTABLEKS                       R11 R12 K30 ["iconTrailing"]
      203 GETTABLEKS                       R10 R11 K26 ["name"]
      205 JUMP                             ; [+3]
      206 GETUPVAL                         R11 2
      207 GETTABLEKS                       R10 R11 K30 ["iconTrailing"]
      209 SETTABLEKS                       R10 R9 K26 ["name"]
      211 GETUPVAL                         R12 3
      212 GETTABLEKS                       R11 R12 K29 ["icon"]
      214 GETTABLEKS                       R10 R11 K27 ["style"]
      216 SETTABLEKS                       R10 R9 K27 ["style"]
      218 GETUPVAL                         R12 3
      219 GETTABLEKS                       R11 R12 K29 ["icon"]
      221 GETTABLEKS                       R10 R11 K6 ["size"]
      ...
      232 GETUPVAL                         R8 2
      233 GETTABLEKS                       R7 R8 K15 ["testId"]
...
MAIN:
       ...
       50 GETTABLEKS                       R13 R0 K8 ["Components"]
       52 GETTABLEKS                       R12 R13 K15 ["TextInput"]
       54 GETTABLEKS                       R11 R12 K16 ["useTextInputVariants"]
       56 CALL                             R10 1 1
       57 GETIMPORT                        R11 K6 [require]
       59 GETTABLEKS                       R14 R0 K17 ["Providers"]
       61 GETTABLEKS                       R13 R14 K18 ["Style"]
       63 GETTABLEKS                       R12 R13 K19 ["useTokens"]
       65 CALL                             R11 1 1
       66 GETIMPORT                        R12 K6 [require]
       68 GETTABLEKS                       R14 R0 K20 ["Utility"]
       70 GETTABLEKS                       R13 R14 K21 ["withCommonProps"]
       72 CALL                             R12 1 1
       73 GETIMPORT                        R13 K6 [require]
       75 GETTABLEKS                       R15 R0 K20 ["Utility"]
       77 GETTABLEKS                       R14 R15 K22 ["withDefaults"]
       79 CALL                             R13 1 1
       80 GETIMPORT                        R14 K6 [require]
       82 GETTABLEKS                       R16 R0 K23 ["Enums"]
       84 GETTABLEKS                       R15 R16 K24 ["InputSize"]
       86 CALL                             R14 1 1
       87 GETIMPORT                        R15 K6 [require]
       89 GETTABLEKS                       R17 R0 K20 ["Utility"]
       91 GETTABLEKS                       R16 R17 K25 ["getInputTextSize"]
       93 CALL                             R15 1 1
       94 GETIMPORT                        R16 K6 [require]
       96 GETTABLEKS                       R18 R0 K23 ["Enums"]
       98 GETTABLEKS                       R17 R18 K26 ["ControlState"]
      100 CALL                             R16 1 1
      101 DUPTABLE                         R17 K29 [{"size", "testId"}]
      102 GETTABLEKS                       R18 R14 K30 ["Large"]
      104 SETTABLEKS                       R18 R17 K27 ["size"]
      106 LOADK                            R18 K31 ["--foundation-text-input"]
      107 SETTABLEKS                       R18 R17 K28 ["testId"]
      109 DUPCLOSURE                       R18 K32 [PROTO_1]
      110 CAPTURE                          VAL R13
      111 CAPTURE                          VAL R17
      112 CAPTURE                          VAL R11
      113 CAPTURE                          VAL R10
      ...
      120 CAPTURE                          VAL R4
      121 CAPTURE                          VAL R5
      122 GETTABLEKS                       R19 R2 K33 ["memo"]
      124 GETTABLEKS                       R20 R2 K34 ["forwardRef"]
      126 MOVE                             R21 R18
      127 CALL                             R20 1 -1
      128 CALL                             R19 -1 -1
      129 RETURN                           R19 -1
