...
PROTO_1:
       ...
       11 NEWTABLE                         R0 0 0
       13 GETUPVAL                         R4 0
       14 GETTABLEKS                       R1 R4 K0 ["actions"]
       16 LOADNIL                          R2
       17 LOADNIL                          R3
       18 FORGPREP                         R1
       19 GETUPVAL                         R6 1
       ...
       48 CONCAT                           R7 R8 R9
       49 GETUPVAL                         R9 4
       50 GETTABLEKS                       R8 R9 K10 ["createElement"]
       52 GETUPVAL                         R9 5
       53 MOVE                             R10 R6
       54 CALL                             R8 2 1
...
PROTO_2:
        ...
        3 CALL                             R1 2 1
        4 GETUPVAL                         R3 2
        5 GETTABLEKS                       R2 R3 K0 ["useEffect"]
        7 NEWCLOSURE                       R3 P0
        8 CAPTURE                          VAL R1
        9 CAPTURE                          UPVAL U3
       10 CAPTURE                          UPVAL U4
       ...
       17 CALL                             R2 2 0
       18 GETUPVAL                         R3 2
       19 GETTABLEKS                       R2 R3 K2 ["useMemo"]
       21 NEWCLOSURE                       R3 P1
       22 CAPTURE                          VAL R1
       23 CAPTURE                          UPVAL U3
       24 CAPTURE                          UPVAL U5
...
MAIN:
       ...
       37 GETTABLEKS                       R7 R8 K14 ["Logger"]
       39 CALL                             R6 1 1
       40 GETIMPORT                        R7 K6 [require]
       42 GETTABLEKS                       R9 R0 K9 ["Components"]
       44 GETTABLEKS                       R8 R9 K15 ["Types"]
       46 CALL                             R7 1 1
       ...
       58 GETTABLEKS                       R10 R11 K17 ["withCommonProps"]
       60 CALL                             R9 1 1
       61 GETIMPORT                        R10 K6 [require]
       63 GETTABLEKS                       R12 R0 K13 ["Utility"]
       65 GETTABLEKS                       R11 R12 K18 ["withDefaults"]
       67 CALL                             R10 1 1
       68 GETIMPORT                        R11 K6 [require]
       70 GETIMPORT                        R14 K1 [script]
       72 GETTABLEKS                       R13 R14 K4 ["Parent"]
       74 GETTABLEKS                       R12 R13 K19 ["AlertConstants"]
       76 CALL                             R11 1 1
       77 GETTABLEKS                       R12 R11 K20 ["MAX_ACTION_COUNT"]
       79 DUPTABLE                         R13 K22 [{"testId"}]
       80 LOADK                            R14 K23 ["--foundation-alert-actions"]
       81 SETTABLEKS                       R14 R13 K21 ["testId"]
       83 DUPCLOSURE                       R14 K24 [PROTO_2]
       84 CAPTURE                          VAL R10
       85 CAPTURE                          VAL R13
       86 CAPTURE                          VAL R3
       87 CAPTURE                          VAL R12
