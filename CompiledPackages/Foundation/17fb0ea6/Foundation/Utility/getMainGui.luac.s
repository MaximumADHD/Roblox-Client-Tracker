PROTO_0:
        ...
        4 JUMPIFNOT                        R0 ; [+9]
        5 GETUPVAL                         R1 1
        6 GETTABLEKS                       R0 R1 K1 ["LocalPlayer"]
        8 JUMPIFNOT                        R0 ; [+5]
        9 GETUPVAL                         R0 0
       ...
       15 RETURN                           R0 1
       16 GETUPVAL                         R1 1
       17 GETTABLEKS                       R0 R1 K1 ["LocalPlayer"]
...
PROTO_1:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R0 R1 K0 ["FoundationUseMainGuiUtility"]
        3 JUMPIF                           R0 ; [+4]
       ...
       19 JUMPIFNOT                        R1 ; [+9]
       20 GETUPVAL                         R2 6
       21 GETTABLEKS                       R1 R2 K5 ["LocalPlayer"]
       23 JUMPIFNOT                        R1 ; [+5]
       24 GETUPVAL                         R1 5
       ...
       30 JUMP                             ; [+8]
       31 GETUPVAL                         R1 6
       32 GETTABLEKS                       R0 R1 K5 ["LocalPlayer"]
...
MAIN:
       ...
       11 GETTABLEKS                       R2 R3 K7 ["Wrappers"]
       13 CALL                             R1 1 1
       14 GETTABLEKS                       R3 R1 K8 ["Services"]
       16 GETTABLEKS                       R2 R3 K9 ["CoreGui"]
       18 GETTABLEKS                       R4 R1 K8 ["Services"]
       20 GETTABLEKS                       R3 R4 K10 ["RunService"]
       22 GETTABLEKS                       R5 R1 K8 ["Services"]
       24 GETTABLEKS                       R4 R5 K11 ["Players"]
       26 GETIMPORT                        R5 K5 [require]
       28 GETTABLEKS                       R7 R0 K6 ["Utility"]
       30 GETTABLEKS                       R6 R7 K12 ["Flags"]
       32 CALL                             R5 1 1
       33 GETIMPORT                        R6 K5 [require]
       35 GETTABLEKS                       R8 R0 K6 ["Utility"]
       37 GETTABLEKS                       R7 R8 K13 ["isPluginSecurity"]
       39 CALL                             R6 1 1
       40 LOADB                            R7 0
       41 LOADNIL                          R8
