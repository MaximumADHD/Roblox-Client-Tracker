PROTO_0:
       ...
       31 LOADNIL                          R9
       32 JUMP                             ; [+4]
       33 GETTABLEKS                       R10 R6 K6 ["Y"]
       35 GETTABLEKS                       R9 R10 K7 ["Offset"]
       37 GETUPVAL                         R10 6
       38 MOVE                             R11 R8
       39 CALL                             R10 1 1
       40 JUMPIF                           R10 ; [+22]
       ...
       65 JUMPIF                           R10 ; [+6]
       66 GETTABLEKS                       R12 R3 K12 ["Color"]
       68 GETTABLEKS                       R11 R12 K13 ["Content"]
       70 GETTABLEKS                       R10 R11 K14 ["Default"]
       72 GETUPVAL                         R11 6
       73 MOVE                             R12 R8
       74 CALL                             R11 1 1
       75 JUMPIF                           R11 ; [+34]
       ...
       85 CALL                             R11 2 0
       86 GETUPVAL                         R12 9
       87 GETTABLEKS                       R11 R12 K17 ["createElement"]
       89 GETUPVAL                         R12 10
       90 GETUPVAL                         R13 11
       91 MOVE                             R14 R2
      ...
      109 RETURN                           R11 1
      110 GETUPVAL                         R12 9
      111 GETTABLEKS                       R11 R12 K17 ["createElement"]
      113 GETUPVAL                         R12 12
      114 GETUPVAL                         R13 11
      115 MOVE                             R14 R2
      ...
      154 JUMPIFNOT                        R9 ; [+9]
      155 GETUPVAL                         R16 9
      156 GETTABLEKS                       R15 R16 K17 ["createElement"]
      ...
      167 GETUPVAL                         R16 9
      168 GETTABLEKS                       R15 R16 K17 ["createElement"]
      170 GETUPVAL                         R17 9
      171 GETTABLEKS                       R16 R17 K38 ["Fragment"]
      173 LOADNIL                          R17
...
MAIN:
       ...
       25 GETTABLEKS                       R8 R0 K11 ["Components"]
       27 GETTABLEKS                       R7 R8 K12 ["Text"]
       29 CALL                             R6 1 1
       30 GETIMPORT                        R7 K6 [require]
       32 GETTABLEKS                       R9 R0 K11 ["Components"]
       34 GETTABLEKS                       R8 R9 K13 ["Image"]
       36 CALL                             R7 1 1
       37 GETIMPORT                        R8 K6 [require]
       39 GETTABLEKS                       R10 R0 K14 ["Enums"]
       41 GETTABLEKS                       R9 R10 K15 ["IconSize"]
       43 CALL                             R8 1 1
       44 GETIMPORT                        R9 K6 [require]
       46 GETTABLEKS                       R12 R0 K16 ["Providers"]
       48 GETTABLEKS                       R11 R12 K17 ["Style"]
       50 GETTABLEKS                       R10 R11 K18 ["useTextSizeOffset"]
       52 CALL                             R9 1 1
       53 GETIMPORT                        R10 K6 [require]
       55 GETTABLEKS                       R13 R0 K16 ["Providers"]
       57 GETTABLEKS                       R12 R13 K17 ["Style"]
       59 GETTABLEKS                       R11 R12 K19 ["useTokens"]
       61 CALL                             R10 1 1
       62 GETIMPORT                        R11 K6 [require]
       64 GETTABLEKS                       R13 R0 K20 ["Utility"]
       66 GETTABLEKS                       R12 R13 K21 ["withCommonProps"]
       68 CALL                             R11 1 1
       69 GETIMPORT                        R12 K6 [require]
       71 GETTABLEKS                       R14 R0 K20 ["Utility"]
       73 GETTABLEKS                       R13 R14 K22 ["withDefaults"]
       75 CALL                             R12 1 1
       76 GETIMPORT                        R13 K6 [require]
       78 GETTABLEKS                       R15 R0 K20 ["Utility"]
       80 GETTABLEKS                       R14 R15 K23 ["useIconSize"]
       82 CALL                             R13 1 1
       83 GETIMPORT                        R14 K6 [require]
       85 GETTABLEKS                       R16 R0 K20 ["Utility"]
       87 GETTABLEKS                       R15 R16 K24 ["Logger"]
       89 CALL                             R14 1 1
       90 GETIMPORT                        R15 K6 [require]
       92 GETTABLEKS                       R17 R0 K20 ["Utility"]
       94 GETTABLEKS                       R16 R17 K25 ["isBuilderIcon"]
       96 CALL                             R15 1 1
       97 GETIMPORT                        R16 K6 [require]
       99 GETIMPORT                        R19 K1 [script]
      101 GETTABLEKS                       R18 R19 K4 ["Parent"]
      103 GETTABLEKS                       R17 R18 K26 ["migrateIconName"]
      105 CALL                             R16 1 1
      106 GETIMPORT                        R17 K6 [require]
      108 GETIMPORT                        R20 K1 [script]
      110 GETTABLEKS                       R19 R20 K4 ["Parent"]
      112 GETTABLEKS                       R18 R19 K27 ["migrateFontSize"]
      114 CALL                             R17 1 1
      115 GETIMPORT                        R18 K6 [require]
      117 GETTABLEKS                       R20 R0 K11 ["Components"]
      119 GETTABLEKS                       R19 R20 K28 ["Types"]
      121 CALL                             R18 1 1
      122 DUPTABLE                         R19 K32 [{"size", "variant", "testId"}]
      123 GETTABLEKS                       R20 R8 K33 ["Medium"]
