...
PROTO_1:
        ...
        4 MOVE                             R1 R5
        5 GETUPVAL                         R5 0
        6 GETTABLEKS                       R5 R5 K0 ["FoundationDisableTokenScaling"]
        8 JUMPIFNOT                        R5 ; [+2]
        9 LOADN                            R3 1
       10 JUMP                             ; [+1]
       11 ORK                              R3 R3 K1 [1]
       ...
       15 FORGPREP                         R5
       16 JUMPIFNOT                        R4 ; [+4]
       17 GETTABLEKS                       R11 R9 K2 ["name"]
       19 GETTABLE                         R10 R4 R11
       20 JUMP                             ; [+1]
       21 LOADNIL                          R10
       22 JUMPIFEQKNIL                     R10 ; [+3]
       24 MOVE                             R11 R10
       25 JUMP                             ; [+2]
       26 GETTABLEKS                       R11 R9 K3 ["value"]
       28 GETUPVAL                         R12 1
       29 MOVE                             R13 R11
       30 MOVE                             R14 R3
       31 CALL                             R12 2 1
       32 GETTABLEKS                       R14 R9 K2 ["name"]
       34 GETTABLE                         R13 R2 R14
       35 JUMPIFEQ                         R13 R12 ; [+10]
       37 GETTABLEKS                       R15 R9 K2 ["name"]
       39 MOVE                             R16 R12
       40 NAMECALL                         R13 R0 K4 ["SetAttribute"]
       42 CALL                             R13 3 0
       43 GETTABLEKS                       R13 R9 K2 ["name"]
       45 SETTABLE                         R12 R2 R13
       46 FORGLOOP                         R5 2 ; [-31]
       48 RETURN                           R0 0
...
MAIN:
       ...
       58 GETTABLEKS                       R11 R1 K13 ["Utility"]
       60 GETTABLEKS                       R11 R11 K17 ["scaleValue"]
       62 CALL                             R10 1 1
