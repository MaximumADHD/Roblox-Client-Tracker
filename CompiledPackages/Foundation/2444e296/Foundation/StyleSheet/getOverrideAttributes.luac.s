...
PROTO_2:
        0 NEWTABLE                         R3 0 0
        2 GETUPVAL                         R4 0
        3 GETTABLEKS                       R4 R4 K0 ["FoundationTokenOverrides"]
        5 JUMPIF                           R4 ; [+1]
        6 RETURN                           R3 1
        7 JUMPIFNOT                        R2 ; [+5]
       ...
       13 RETURN                           R3 1
       14 GETUPVAL                         R4 1
       15 GETTABLEKS                       R4 R4 K3 ["getTokens"]
       17 MOVE                             R5 R0
       18 MOVE                             R6 R1
       19 LOADN                            R7 1
       20 CALL                             R4 3 1
       ...
       24 FORGPREP                         R5
       25 GETUPVAL                         R10 2
       26 GETTABLEKS                       R10 R10 K4 ["resolveTokenOverride"]
       28 MOVE                             R11 R4
       29 MOVE                             R12 R8
       30 MOVE                             R13 R9
       31 CALL                             R10 3 1
       32 JUMPIFEQKNIL                     R10 ; [+15]
       34 GETUPVAL                         R11 3
       35 MOVE                             R12 R3
       36 LOADK                            R15 K5 ["%."]
       37 LOADK                            R16 K6 [""]
       38 NAMECALL                         R13 R8 K7 ["gsub"]
       40 CALL                             R13 3 1
       41 LOADK                            R15 K8 ["_"]
       42 LOADK                            R16 K6 [""]
       43 NAMECALL                         R13 R13 K7 ["gsub"]
       45 CALL                             R13 3 1
       46 MOVE                             R14 R10
       47 CALL                             R11 3 0
       48 FORGLOOP                         R5 2 ; [-24]
...
MAIN:
       ...
       36 GETTABLEKS                       R5 R5 K14 ["TokenProcessingUtilities"]
       38 CALL                             R4 1 1
       39 GETIMPORT                        R5 K5 [require]
       41 GETTABLEKS                       R6 R0 K11 ["Providers"]
       43 GETTABLEKS                       R6 R6 K12 ["Style"]
       45 GETTABLEKS                       R6 R6 K13 ["Tokens"]
       47 CALL                             R5 1 1
