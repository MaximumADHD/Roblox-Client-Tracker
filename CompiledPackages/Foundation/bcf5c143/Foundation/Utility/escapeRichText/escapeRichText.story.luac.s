PROTO_0:
        ...
        2 GETTABLEKS                       R1 R2 K1 ["inputText"]
        4 GETUPVAL                         R3 0
        5 GETTABLEKS                       R2 R3 K2 ["createElement"]
        7 GETUPVAL                         R3 1
        8 DUPTABLE                         R4 K4 [{"tag"}]
        9 LOADK                            R5 K5 ["col gap-small size-full-0"]
       ...
       19 LOADK                            R9 K9 ["size-full-0 auto-y text-wrap text-align-x-left"]
       ...
       33 CALL                             R6 2 1
       34 GETUPVAL                         R8 0
       35 GETTABLEKS                       R7 R8 K2 ["createElement"]
       37 GETUPVAL                         R8 2
       38 DUPTABLE                         R9 K8 [{"tag", "Text", "RichText"}]
       39 LOADK                            R10 K9 ["size-full-0 auto-y text-wrap text-align-x-left"]
...
PROTO_1:
        ...
        5 LOADK                            R4 K4 ["size-full-0 auto-y text-wrap text-align-x-left"]
        6 SETTABLEKS                       R4 R3 K1 ["tag"]
        8 LOADK                            R5 K5 ["Raw input: %*"]
        9 GETTABLEKS                       R8 R0 K6 ["controls"]
       11 GETTABLEKS                       R7 R8 K7 ["inputText"]
...
MAIN:
       ...
       32 GETTABLEKS                       R6 R7 K12 ["escapeRichText"]
       34 CALL                             R5 1 1
