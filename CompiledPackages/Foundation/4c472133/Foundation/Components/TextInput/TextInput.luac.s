PROTO_0:
      ...
      151 GETUPVAL                         R5 5
      152 DUPTABLE                         R6 K34 [{["tag"] = "row align-y-center size-0-full auto-x"}]
      153 GETUPVAL                         R7 0
      154 GETTABLEKS                       R7 R7 K0 ["createElement"]
      156 GETUPVAL                         R8 6
      157 DUPTABLE                         R9 K37 [{"name", "style", "size"}]
      158 GETUPVAL                         R10 2
      159 GETTABLEKS                       R10 R10 K31 ["leadingIcon"]
      161 SETTABLEKS                       R10 R9 K35 ["name"]
      163 GETUPVAL                         R10 4
      164 GETTABLEKS                       R10 R10 K38 ["icon"]
      166 GETTABLEKS                       R10 R10 K36 ["style"]
      168 SETTABLEKS                       R10 R9 K36 ["style"]
      170 GETUPVAL                         R10 4
      171 GETTABLEKS                       R10 R10 K38 ["icon"]
      173 GETTABLEKS                       R10 R10 K8 ["size"]
      175 SETTABLEKS                       R10 R9 K8 ["size"]
      177 CALL                             R7 2 -1
      178 CALL                             R4 -1 1
      179 JUMP                             ; [+1]
      180 LOADNIL                          R4
      181 SETTABLEKS                       R4 R3 K21 ["leadingElement"]
      183 GETUPVAL                         R5 2
      184 GETTABLEKS                       R5 R5 K39 ["iconTrailing"]
      186 JUMPIFNOT                        R5 ; [+105]
      187 GETUPVAL                         R4 0
      188 GETTABLEKS                       R4 R4 K0 ["createElement"]
      190 GETUPVAL                         R5 5
      191 DUPTABLE                         R6 K34 [{["tag"] = "row align-y-center size-0-full auto-x"}]
      192 GETUPVAL                         R9 2
      193 GETTABLEKS                       R9 R9 K39 ["iconTrailing"]
      195 FASTCALL1                        TYPE R9 ; [+2]
      196 GETIMPORT                        R8 K41 [type]
      198 CALL                             R8 1 1
      199 JUMPIFNOTEQKS                    R8 K42 ["table"] ; [+50]
      201 GETUPVAL                         R8 2
      202 GETTABLEKS                       R8 R8 K39 ["iconTrailing"]
      204 GETTABLEKS                       R8 R8 K43 ["onActivated"]
      206 JUMPIFNOT                        R8 ; [+43]
      207 GETUPVAL                         R7 0
      208 GETTABLEKS                       R7 R7 K0 ["createElement"]
      210 GETUPVAL                         R8 7
      211 DUPTABLE                         R9 K44 [{"onActivated", "isDisabled", "size", "icon", "testId"}]
      212 GETUPVAL                         R10 2
      213 GETTABLEKS                       R10 R10 K39 ["iconTrailing"]
      215 GETTABLEKS                       R10 R10 K43 ["onActivated"]
      217 SETTABLEKS                       R10 R9 K43 ["onActivated"]
      219 GETUPVAL                         R10 2
      220 GETTABLEKS                       R10 R10 K3 ["isDisabled"]
      222 SETTABLEKS                       R10 R9 K3 ["isDisabled"]
      224 GETUPVAL                         R10 4
      225 GETTABLEKS                       R10 R10 K38 ["icon"]
      227 GETTABLEKS                       R10 R10 K8 ["size"]
      229 SETTABLEKS                       R10 R9 K8 ["size"]
      231 GETUPVAL                         R10 2
      232 GETTABLEKS                       R10 R10 K39 ["iconTrailing"]
      234 GETTABLEKS                       R10 R10 K35 ["name"]
      236 SETTABLEKS                       R10 R9 K38 ["icon"]
      238 LOADK                            R11 K45 ["%*--trailing-icon-button"]
      239 GETUPVAL                         R13 2
      240 GETTABLEKS                       R13 R13 K23 ["testId"]
      242 NAMECALL                         R11 R11 K46 ["format"]
      244 CALL                             R11 2 1
      245 MOVE                             R10 R11
      246 SETTABLEKS                       R10 R9 K23 ["testId"]
      248 CALL                             R7 2 1
      249 JUMP                             ; [+40]
      250 GETUPVAL                         R7 0
      251 GETTABLEKS                       R7 R7 K0 ["createElement"]
      253 GETUPVAL                         R8 6
      254 DUPTABLE                         R9 K37 [{"name", "style", "size"}]
      255 GETUPVAL                         R12 2
      256 GETTABLEKS                       R12 R12 K39 ["iconTrailing"]
      258 FASTCALL1                        TYPE R12 ; [+2]
      259 GETIMPORT                        R11 K41 [type]
      261 CALL                             R11 1 1
      262 JUMPIFNOTEQKS                    R11 K42 ["table"] ; [+7]
      264 GETUPVAL                         R10 2
      265 GETTABLEKS                       R10 R10 K39 ["iconTrailing"]
      267 GETTABLEKS                       R10 R10 K35 ["name"]
      269 JUMP                             ; [+3]
      270 GETUPVAL                         R10 2
      271 GETTABLEKS                       R10 R10 K39 ["iconTrailing"]
      273 SETTABLEKS                       R10 R9 K35 ["name"]
      275 GETUPVAL                         R10 4
      276 GETTABLEKS                       R10 R10 K38 ["icon"]
      278 GETTABLEKS                       R10 R10 K36 ["style"]
      280 SETTABLEKS                       R10 R9 K36 ["style"]
      282 GETUPVAL                         R10 4
      283 GETTABLEKS                       R10 R10 K38 ["icon"]
      285 GETTABLEKS                       R10 R10 K8 ["size"]
      287 SETTABLEKS                       R10 R9 K8 ["size"]
      289 CALL                             R7 2 1
      290 CALL                             R4 3 1
      291 JUMP                             ; [+1]
      292 LOADNIL                          R4
      293 SETTABLEKS                       R4 R3 K22 ["trailingElement"]
      295 LOADK                            R5 K47 ["%*--internal-text-input"]
      296 GETUPVAL                         R7 2
      297 GETTABLEKS                       R7 R7 K23 ["testId"]
      299 NAMECALL                         R5 R5 K46 ["format"]
      301 CALL                             R5 2 1
      302 MOVE                             R4 R5
      303 SETTABLEKS                       R4 R3 K23 ["testId"]
      305 CALL                             R1 2 -1
      306 RETURN                           R1 -1
