PROTO_0:
       ...
       34 CALL                             R6 2 1
       35 CALL                             R3 3 1
       36 SETTABLEKS                       R3 R0 K8 ["code"]
       38 GETTABLEKS                       R3 R0 K10 ["message"]
       40 JUMPIFEQKNIL                     R3 ; [+26]
       42 GETTABLEKS                       R4 R0 K10 ["message"]
       44 FASTCALL1                        TYPEOF R4 ; [+2]
       45 GETIMPORT                        R3 K1 [typeof]
       47 CALL                             R3 1 1
       48 JUMPIFEQKS                       R3 K11 ["string"] ; [+18]
       50 LOADK                            R5 K12 ["%*\"message\" > Expected string, got %*"]
       51 MOVE                             R7 R2
       52 GETTABLEKS                       R9 R0 K10 ["message"]
       ...
       66 CALL                             R3 2 0
       67 GETTABLEKS                       R3 R0 K13 ["field"]
       69 JUMPIFEQKNIL                     R3 ; [+26]
       71 GETTABLEKS                       R4 R0 K13 ["field"]
       73 FASTCALL1                        TYPEOF R4 ; [+2]
       74 GETIMPORT                        R3 K1 [typeof]
       76 CALL                             R3 1 1
       77 JUMPIFEQKS                       R3 K11 ["string"] ; [+18]
       79 LOADK                            R5 K14 ["%*\"field\" > Expected string, got %*"]
       80 MOVE                             R7 R2
       81 GETTABLEKS                       R9 R0 K13 ["field"]
       83 FASTCALL1                        TYPEOF R9 ; [+2]
       84 GETIMPORT                        R8 K1 [typeof]
       86 CALL                             R8 1 1
       87 NAMECALL                         R5 R5 K4 ["format"]
       89 CALL                             R5 3 1
