PROTO_0:
       ...
       22 CALL                             R3 2 0
       23 RETURN                           R0 1
       24 GETTABLEKS                       R4 R0 K7 ["userId"]
       26 FASTCALL1                        TYPEOF R4 ; [+2]
       27 GETIMPORT                        R3 K1 [typeof]
       29 CALL                             R3 1 1
       30 JUMPIFEQKS                       R3 K8 ["number"] ; [+18]
       32 LOADK                            R5 K9 ["%*\"userId\" > Expected number, got %*"]
       33 MOVE                             R7 R2
       34 GETTABLEKS                       R9 R0 K7 ["userId"]
       ...
       48 CALL                             R3 2 0
       49 GETTABLEKS                       R3 R0 K10 ["groupId"]
       51 JUMPIFEQKNIL                     R3 ; [+26]
       53 GETTABLEKS                       R4 R0 K10 ["groupId"]
       55 FASTCALL1                        TYPEOF R4 ; [+2]
       56 GETIMPORT                        R3 K1 [typeof]
       58 CALL                             R3 1 1
       59 JUMPIFEQKS                       R3 K8 ["number"] ; [+18]
       61 LOADK                            R5 K11 ["%*\"groupId\" > Expected number, got %*"]
       62 MOVE                             R7 R2
       63 GETTABLEKS                       R9 R0 K10 ["groupId"]
       ...
       77 CALL                             R3 2 0
       78 GETTABLEKS                       R3 R0 K12 ["bannerId"]
       80 JUMPIFEQKNIL                     R3 ; [+26]
       82 GETTABLEKS                       R4 R0 K12 ["bannerId"]
       84 FASTCALL1                        TYPEOF R4 ; [+2]
       85 GETIMPORT                        R3 K1 [typeof]
       87 CALL                             R3 1 1
       88 JUMPIFEQKS                       R3 K13 ["string"] ; [+18]
       90 LOADK                            R5 K14 ["%*\"bannerId\" > Expected string, got %*"]
       91 MOVE                             R7 R2
       92 GETTABLEKS                       R9 R0 K12 ["bannerId"]
