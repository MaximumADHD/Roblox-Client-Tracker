PROTO_0:
       ...
       23 CALL                             R3 2 0
       24 RETURN                           R0 1
       25 GETTABLEKS                       R3 R0 K7 ["hasValidEntry"]
       27 JUMPIFEQKNIL                     R3 ; [+27]
       29 GETTABLEKS                       R4 R0 K7 ["hasValidEntry"]
       31 FASTCALL1                        TYPEOF R4 ; [+2]
       32 GETIMPORT                        R3 K1 [typeof]
       34 CALL                             R3 1 1
       35 JUMPIFEQKS                       R3 K8 ["boolean"] ; [+19]
       37 LOADK                            R6 K9 ["%*\"hasValidEntry\" > Expected boolean, got %*"]
       38 MOVE                             R8 R2
       39 GETTABLEKS                       R10 R0 K7 ["hasValidEntry"]
       ...
       54 CALL                             R3 2 0
       55 GETTABLEKS                       R3 R0 K10 ["universeId"]
       57 JUMPIFEQKNIL                     R3 ; [+27]
       59 GETTABLEKS                       R4 R0 K10 ["universeId"]
       61 FASTCALL1                        TYPEOF R4 ; [+2]
       62 GETIMPORT                        R3 K1 [typeof]
       64 CALL                             R3 1 1
       65 JUMPIFEQKS                       R3 K11 ["number"] ; [+19]
       67 LOADK                            R6 K12 ["%*\"universeId\" > Expected number, got %*"]
       68 MOVE                             R8 R2
       69 GETTABLEKS                       R10 R0 K10 ["universeId"]
       ...
       84 CALL                             R3 2 0
       85 GETTABLEKS                       R3 R0 K13 ["rootPlaceId"]
       87 JUMPIFEQKNIL                     R3 ; [+27]
       89 GETTABLEKS                       R4 R0 K13 ["rootPlaceId"]
       91 FASTCALL1                        TYPEOF R4 ; [+2]
       92 GETIMPORT                        R3 K1 [typeof]
       94 CALL                             R3 1 1
       95 JUMPIFEQKS                       R3 K11 ["number"] ; [+19]
       97 LOADK                            R6 K14 ["%*\"rootPlaceId\" > Expected number, got %*"]
       98 MOVE                             R8 R2
       99 GETTABLEKS                       R10 R0 K13 ["rootPlaceId"]
