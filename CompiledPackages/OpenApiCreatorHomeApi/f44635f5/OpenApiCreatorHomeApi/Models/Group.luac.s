PROTO_0:
       ...
       23 CALL                             R3 2 0
       24 RETURN                           R0 1
       25 GETTABLEKS                       R4 R0 K7 ["id"]
       27 FASTCALL1                        TYPEOF R4 ; [+2]
       28 GETIMPORT                        R3 K1 [typeof]
       30 CALL                             R3 1 1
       31 JUMPIFEQKS                       R3 K8 ["number"] ; [+19]
       33 LOADK                            R6 K9 ["%*\"id\" > Expected number, got %*"]
       34 MOVE                             R8 R2
       35 GETTABLEKS                       R10 R0 K7 ["id"]
       ...
       50 CALL                             R3 2 0
       51 GETTABLEKS                       R4 R0 K10 ["name"]
       53 FASTCALL1                        TYPEOF R4 ; [+2]
       54 GETIMPORT                        R3 K1 [typeof]
       56 CALL                             R3 1 1
       57 JUMPIFEQKS                       R3 K11 ["string"] ; [+19]
       59 LOADK                            R6 K12 ["%*\"name\" > Expected string, got %*"]
       60 MOVE                             R8 R2
       61 GETTABLEKS                       R10 R0 K10 ["name"]
       ...
       76 CALL                             R3 2 0
       77 GETTABLEKS                       R4 R0 K13 ["roleSetName"]
       79 FASTCALL1                        TYPEOF R4 ; [+2]
       80 GETIMPORT                        R3 K1 [typeof]
       82 CALL                             R3 1 1
       83 JUMPIFEQKS                       R3 K11 ["string"] ; [+19]
       85 LOADK                            R6 K14 ["%*\"roleSetName\" > Expected string, got %*"]
       86 MOVE                             R8 R2
       87 GETTABLEKS                       R10 R0 K13 ["roleSetName"]
      ...
      102 CALL                             R3 2 0
      103 GETTABLEKS                       R4 R0 K15 ["createdAt"]
      105 FASTCALL1                        TYPEOF R4 ; [+2]
      106 GETIMPORT                        R3 K1 [typeof]
      108 CALL                             R3 1 1
      109 JUMPIFEQKS                       R3 K11 ["string"] ; [+19]
      111 LOADK                            R6 K16 ["%*\"createdAt\" > Expected string, got %*"]
      112 MOVE                             R8 R2
      113 GETTABLEKS                       R10 R0 K15 ["createdAt"]
