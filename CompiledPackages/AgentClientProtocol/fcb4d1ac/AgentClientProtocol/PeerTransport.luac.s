...
PROTO_8:
        ...
        6 LOADK                            R4 K2 ["%*: Not connected"]
        7 GETTABLEKS                       R6 R0 K3 ["name"]
        9 NAMECALL                         R4 R4 K4 ["format"]
       11 CALL                             R4 2 1
       12 CALL                             R3 1 -1
       13 RETURN                           R3 -1
       14 GETTABLEKS                       R3 R0 K5 ["_peer"]
       16 JUMPIFNOT                        R3 ; [+3]
       17 GETTABLEKS                       R4 R3 K0 ["_isConnected"]
       19 JUMPIF                           R4 ; [+5]
       20 GETUPVAL                         R4 0
       21 GETTABLEKS                       R4 R4 K6 ["resolve"]
       23 CALL                             R4 0 -1
       24 RETURN                           R4 -1
       25 GETUPVAL                         R4 0
       26 GETTABLEKS                       R4 R4 K7 ["new"]
       28 NEWCLOSURE                       R5 P0
       29 CAPTURE                          VAL R3
       30 CAPTURE                          VAL R1
       31 CALL                             R4 1 -1
