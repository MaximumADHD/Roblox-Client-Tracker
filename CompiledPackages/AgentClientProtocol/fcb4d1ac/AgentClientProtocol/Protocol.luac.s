...
PROTO_19:
       ...
       17 LOADK                            R8 K6 ["Method not found: %*"]
       18 GETTABLEKS                       R10 R1 K2 ["method"]
       20 NAMECALL                         R8 R8 K7 ["format"]
       22 CALL                             R8 2 1
       23 DUPTABLE                         R5 K11 [{["jsonrpc"] = "2.0", ["id"], ["error"]}]
       24 SETTABLEKS                       R6 R5 K4 ["id"]
       26 DUPTABLE                         R9 K14 [{"code", "message"}]
       27 SETTABLEKS                       R7 R9 K12 ["code"]
       29 SETTABLEKS                       R8 R9 K13 ["message"]
       31 SETTABLEKS                       R9 R5 K10 ["error"]
       33 CALL                             R4 1 0
       34 RETURN                           R0 0
       35 GETUPVAL                         R4 1
       36 GETTABLEKS                       R4 R4 K15 ["new"]
       38 NEWCLOSURE                       R5 P0
       39 CAPTURE                          VAL R3
       40 CAPTURE                          VAL R1
       41 CAPTURE                          UPVAL U1
       ...
       48 CAPTURE                          VAL R2
       49 CAPTURE                          VAL R1
       50 NAMECALL                         R4 R4 K16 ["andThen"]
       52 CALL                             R4 3 1
       53 DUPCLOSURE                       R6 K17 [PROTO_18]
       54 NAMECALL                         R4 R4 K18 ["catch"]
       56 CALL                             R4 2 0
       57 RETURN                           R0 0
