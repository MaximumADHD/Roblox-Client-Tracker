PROTO_0:
        ...
        7 LOADK                            R4 K3 ["/api/v1/generate-map"]
        8 GETUPVAL                         R5 1
       ...
       50 CALL                             R1 3 1
       51 LOADK                            R3 K19 ["PrdPrompt"]
       52 GETTABLEKS                       R4 R0 K20 ["prdPrompt"]
...
PROTO_1:
        ...
        4 GETUPVAL                         R3 1
        5 GETTABLEKS                       R3 R3 K2 ["host"]
        7 LOADK                            R4 K3 ["/api/v1/generate-map/{jobId}"]
        8 GETUPVAL                         R5 1
        9 GETTABLEKS                       R5 R5 K4 ["pathPrefix"]
       11 GETUPVAL                         R6 1
       12 GETTABLEKS                       R6 R6 K5 ["baseUrl"]
...
MAIN:
       ...
       23 GETTABLEKS                       R5 R5 K10 ["GenerateMapResponse"]
       25 CALL                             R4 1 1
       26 GETIMPORT                        R5 K6 [require]
       28 GETTABLEKS                       R6 R0 K9 ["Models"]
       30 GETTABLEKS                       R6 R6 K11 ["GetMapGenerationStatusResponse"]
       32 CALL                             R5 1 1
       33 NEWTABLE                         R6 2 0
       ...
       37 CAPTURE                          VAL R3
       38 CAPTURE                          VAL R4
       39 SETTABLEKS                       R7 R6 K13 ["postGenerateMapAsync"]
       41 DUPCLOSURE                       R7 K14 [PROTO_1]
       42 CAPTURE                          VAL R2
       43 CAPTURE                          VAL R3
       44 CAPTURE                          VAL R5
       45 SETTABLEKS                       R7 R6 K15 ["getMapGenerationStatusAsync"]
