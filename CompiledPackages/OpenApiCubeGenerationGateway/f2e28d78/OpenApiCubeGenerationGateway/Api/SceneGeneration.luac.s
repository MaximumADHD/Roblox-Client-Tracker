PROTO_0:
        ...
        7 LOADK                            R4 K3 ["/api/v1/generate-scene"]
        8 GETUPVAL                         R5 1
       ...
       44 CALL                             R1 3 1
       45 LOADK                            R3 K17 ["terrain_height_map"]
       46 GETTABLEKS                       R4 R0 K18 ["terrainHeightMap"]
       48 NAMECALL                         R1 R1 K19 ["addFormParameter"]
       50 CALL                             R1 3 1
       51 LOADK                            R3 K20 ["semantic_classes"]
       52 GETTABLEKS                       R4 R0 K21 ["semanticClasses"]
       54 NAMECALL                         R1 R1 K19 ["addFormParameter"]
       56 CALL                             R1 3 1
       57 LOADK                            R3 K22 ["object_instance_segmentation"]
       58 GETTABLEKS                       R4 R0 K23 ["objectInstanceSegmentation"]
       60 NAMECALL                         R1 R1 K19 ["addFormParameter"]
       62 CALL                             R1 3 1
       63 LOADK                            R3 K24 ["roads_mask"]
       64 GETTABLEKS                       R4 R0 K25 ["roadsMask"]
       66 NAMECALL                         R1 R1 K19 ["addFormParameter"]
       68 CALL                             R1 3 1
       69 LOADK                            R3 K26 ["object_height_map"]
       70 GETTABLEKS                       R4 R0 K27 ["objectHeightMap"]
       72 NAMECALL                         R1 R1 K19 ["addFormParameter"]
       74 CALL                             R1 3 1
       75 LOADK                            R3 K28 ["admin_options"]
       76 GETTABLEKS                       R4 R0 K29 ["adminOptions"]
       78 NAMECALL                         R1 R1 K19 ["addFormParameter"]
       80 CALL                             R1 3 1
       81 LOADK                            R3 K30 ["options"]
       82 GETTABLEKS                       R4 R0 K30 ["options"]
       84 NAMECALL                         R1 R1 K19 ["addFormParameter"]
       86 CALL                             R1 3 1
       87 GETUPVAL                         R3 2
       88 NAMECALL                         R1 R1 K31 ["sendAsync"]
       90 CALL                             R1 2 -1
       91 RETURN                           R1 -1
...
PROTO_1:
        ...
        4 GETUPVAL                         R3 1
        5 GETTABLEKS                       R3 R3 K2 ["host"]
        7 LOADK                            R4 K3 ["/api/v1/generate-scene/{jobId}"]
        8 GETUPVAL                         R5 1
        9 GETTABLEKS                       R5 R5 K4 ["pathPrefix"]
       11 GETUPVAL                         R6 1
       12 GETTABLEKS                       R6 R6 K5 ["baseUrl"]
       14 CALL                             R1 5 1
       15 LOADK                            R3 K6 ["{jobId}"]
       16 GETTABLEKS                       R4 R0 K7 ["jobId"]
...
MAIN:
       ...
       23 GETTABLEKS                       R5 R5 K10 ["GenerateSceneResponse"]
       25 CALL                             R4 1 1
       26 GETIMPORT                        R5 K6 [require]
       28 GETTABLEKS                       R6 R0 K9 ["Models"]
       30 GETTABLEKS                       R6 R6 K11 ["GetSceneGenerationStatusResponse"]
       32 CALL                             R5 1 1
       33 NEWTABLE                         R6 2 0
       ...
       37 CAPTURE                          VAL R3
       38 CAPTURE                          VAL R4
       39 SETTABLEKS                       R7 R6 K13 ["postGenerateSceneAsync"]
       41 DUPCLOSURE                       R7 K14 [PROTO_1]
       42 CAPTURE                          VAL R2
       43 CAPTURE                          VAL R3
       44 CAPTURE                          VAL R5
       45 SETTABLEKS                       R7 R6 K15 ["getSceneGenerationStatusAsync"]
