PROTO_0:
       ...
       23 CALL                             R3 2 0
       24 RETURN                           R0 1
       25 GETTABLEKS                       R3 R0 K7 ["jobId"]
       27 JUMPIFEQKNIL                     R3 ; [+27]
       29 GETTABLEKS                       R4 R0 K7 ["jobId"]
       31 FASTCALL1                        TYPEOF R4 ; [+2]
       32 GETIMPORT                        R3 K1 [typeof]
       34 CALL                             R3 1 1
       35 JUMPIFEQKS                       R3 K8 ["string"] ; [+19]
       37 LOADK                            R6 K9 ["%*\"jobId\" > Expected string, got %*"]
       38 MOVE                             R8 R2
       39 GETTABLEKS                       R10 R0 K7 ["jobId"]
      ...
      144 CALL                             R3 2 0
      145 GETTABLEKS                       R3 R0 K16 ["terrainHeightMap"]
      147 JUMPIFEQKNIL                     R3 ; [+27]
      149 GETTABLEKS                       R4 R0 K16 ["terrainHeightMap"]
      151 FASTCALL1                        TYPEOF R4 ; [+2]
      152 GETIMPORT                        R3 K1 [typeof]
      154 CALL                             R3 1 1
      155 JUMPIFEQKS                       R3 K8 ["string"] ; [+19]
      157 LOADK                            R6 K17 ["%*\"terrainHeightMap\" > Expected string, got %*"]
      158 MOVE                             R8 R2
      159 GETTABLEKS                       R10 R0 K16 ["terrainHeightMap"]
      ...
      174 CALL                             R3 2 0
      175 GETTABLEKS                       R3 R0 K18 ["semanticClasses"]
      177 JUMPIFEQKNIL                     R3 ; [+27]
      179 GETTABLEKS                       R4 R0 K18 ["semanticClasses"]
      181 FASTCALL1                        TYPEOF R4 ; [+2]
      182 GETIMPORT                        R3 K1 [typeof]
      184 CALL                             R3 1 1
      185 JUMPIFEQKS                       R3 K8 ["string"] ; [+19]
      187 LOADK                            R6 K19 ["%*\"semanticClasses\" > Expected string, got %*"]
      188 MOVE                             R8 R2
      189 GETTABLEKS                       R10 R0 K18 ["semanticClasses"]
      ...
      204 CALL                             R3 2 0
      205 GETTABLEKS                       R3 R0 K20 ["objectInstanceSegmentation"]
      207 JUMPIFEQKNIL                     R3 ; [+27]
      209 GETTABLEKS                       R4 R0 K20 ["objectInstanceSegmentation"]
      211 FASTCALL1                        TYPEOF R4 ; [+2]
      212 GETIMPORT                        R3 K1 [typeof]
      214 CALL                             R3 1 1
      215 JUMPIFEQKS                       R3 K8 ["string"] ; [+19]
      217 LOADK                            R6 K21 ["%*\"objectInstanceSegmentation\" > Expected string, got %*"]
      218 MOVE                             R8 R2
      219 GETTABLEKS                       R10 R0 K20 ["objectInstanceSegmentation"]
      ...
      234 CALL                             R3 2 0
      235 GETTABLEKS                       R3 R0 K22 ["roadsMask"]
      237 JUMPIFEQKNIL                     R3 ; [+27]
      239 GETTABLEKS                       R4 R0 K22 ["roadsMask"]
      241 FASTCALL1                        TYPEOF R4 ; [+2]
      242 GETIMPORT                        R3 K1 [typeof]
      244 CALL                             R3 1 1
      245 JUMPIFEQKS                       R3 K8 ["string"] ; [+19]
      247 LOADK                            R6 K23 ["%*\"roadsMask\" > Expected string, got %*"]
      248 MOVE                             R8 R2
      249 GETTABLEKS                       R10 R0 K22 ["roadsMask"]
      ...
      264 CALL                             R3 2 0
      265 GETTABLEKS                       R3 R0 K24 ["objectHeightMap"]
      267 JUMPIFEQKNIL                     R3 ; [+27]
      269 GETTABLEKS                       R4 R0 K24 ["objectHeightMap"]
      271 FASTCALL1                        TYPEOF R4 ; [+2]
      272 GETIMPORT                        R3 K1 [typeof]
      274 CALL                             R3 1 1
      275 JUMPIFEQKS                       R3 K8 ["string"] ; [+19]
      277 LOADK                            R6 K25 ["%*\"objectHeightMap\" > Expected string, got %*"]
      278 MOVE                             R8 R2
      279 GETTABLEKS                       R10 R0 K24 ["objectHeightMap"]
