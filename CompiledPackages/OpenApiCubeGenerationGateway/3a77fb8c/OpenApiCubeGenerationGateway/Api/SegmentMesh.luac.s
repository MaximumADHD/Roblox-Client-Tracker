PROTO_0:
        ...
        7 LOADK                            R4 K3 ["/api/v1/segment-mesh"]
        8 GETUPVAL                         R5 1
       ...
       50 CALL                             R1 3 1
       51 LOADK                            R3 K19 ["Mesh"]
       52 GETTABLEKS                       R4 R0 K20 ["mesh"]
       54 NAMECALL                         R1 R1 K21 ["addFormParameter"]
       56 CALL                             R1 3 1
       57 LOADK                            R3 K22 ["Parts"]
       58 GETTABLEKS                       R4 R0 K23 ["parts"]
       60 NAMECALL                         R1 R1 K21 ["addFormParameter"]
       62 CALL                             R1 3 1
       63 LOADK                            R3 K24 ["PredefinedSchema"]
       64 GETTABLEKS                       R4 R0 K25 ["predefinedSchema"]
       ...
       74 CALL                             R1 3 1
       75 LOADK                            R3 K28 ["GenerateTexture"]
       76 GETTABLEKS                       R4 R0 K29 ["generateTexture"]
...
PROTO_1:
        ...
        4 GETUPVAL                         R3 1
        5 GETTABLEKS                       R3 R3 K2 ["host"]
        7 LOADK                            R4 K3 ["/api/v1/segment-mesh/{jobId}"]
        8 GETUPVAL                         R5 1
        9 GETTABLEKS                       R5 R5 K4 ["pathPrefix"]
       11 GETUPVAL                         R6 1
       12 GETTABLEKS                       R6 R6 K5 ["baseUrl"]
...
PROTO_2:
        ...
        4 GETUPVAL                         R3 1
        5 GETTABLEKS                       R3 R3 K2 ["host"]
        7 LOADK                            R4 K3 ["/api/v1/segment-mesh/{generationId}/upload-asset"]
        8 GETUPVAL                         R5 1
        9 GETTABLEKS                       R5 R5 K4 ["pathPrefix"]
       11 GETUPVAL                         R6 1
       12 GETTABLEKS                       R6 R6 K5 ["baseUrl"]
       ...
       24 NAMECALL                         R1 R1 K11 ["addHeaderParameter"]
       26 CALL                             R1 3 1
       27 LOADK                            R3 K12 ["Roblox-Api-Key"]
       28 GETTABLEKS                       R4 R0 K13 ["robloxApiKey"]
       30 NAMECALL                         R1 R1 K11 ["addHeaderParameter"]
       32 CALL                             R1 3 1
       33 GETUPVAL                         R3 2
       34 GETTABLEKS                       R4 R0 K14 ["body"]
       36 NAMECALL                         R1 R1 K15 ["setBody"]
       38 CALL                             R1 3 1
       39 GETUPVAL                         R3 3
       40 NAMECALL                         R1 R1 K16 ["sendAsync"]
       42 CALL                             R1 2 -1
       43 RETURN                           R1 -1
...
MAIN:
       ...
       23 GETTABLEKS                       R5 R5 K10 ["GenerateSegmentMeshResponse"]
       25 CALL                             R4 1 1
       26 GETIMPORT                        R5 K6 [require]
       28 GETTABLEKS                       R6 R0 K9 ["Models"]
       30 GETTABLEKS                       R6 R6 K11 ["GetSegmentMeshStatusResponse"]
       32 CALL                             R5 1 1
       ...
       51 CAPTURE                          VAL R3
       52 CAPTURE                          VAL R4
       53 SETTABLEKS                       R9 R8 K15 ["postGenerateSegmentMeshAsync"]
       55 DUPCLOSURE                       R9 K16 [PROTO_1]
       56 CAPTURE                          VAL R2
       57 CAPTURE                          VAL R3
       58 CAPTURE                          VAL R5
       59 SETTABLEKS                       R9 R8 K17 ["getSegmentMeshStatusAsync"]
       61 DUPCLOSURE                       R9 K18 [PROTO_2]
       62 CAPTURE                          VAL R2
       63 CAPTURE                          VAL R3
       64 CAPTURE                          VAL R6
       65 CAPTURE                          VAL R7
       66 SETTABLEKS                       R9 R8 K19 ["postUploadAssetAsync"]
