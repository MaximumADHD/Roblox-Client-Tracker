PROTO_0:
       ...
       84 CALL                             R3 2 0
       85 GETTABLEKS                       R3 R0 K13 ["resolution"]
       87 JUMPIFEQKNIL                     R3 ; [+27]
       89 GETTABLEKS                       R4 R0 K13 ["resolution"]
       91 FASTCALL1                        TYPEOF R4 ; [+2]
       92 GETIMPORT                        R3 K1 [typeof]
       94 CALL                             R3 1 1
       95 JUMPIFEQKS                       R3 K8 ["string"] ; [+19]
       97 LOADK                            R6 K14 ["%*\"resolution\" > Expected string, got %*"]
       98 MOVE                             R8 R2
       99 GETTABLEKS                       R10 R0 K13 ["resolution"]
      ...
      114 CALL                             R3 2 0
      115 GETTABLEKS                       R3 R0 K15 ["image"]
      117 JUMPIFEQKNIL                     R3 ; [+16]
      119 GETUPVAL                         R3 0
      120 GETTABLEKS                       R3 R3 K16 ["fromResponse"]
      122 GETTABLEKS                       R4 R0 K15 ["image"]
      124 MOVE                             R5 R1
      125 LOADK                            R7 K17 ["%*\"image\" > "]
      126 MOVE                             R9 R2
      127 NAMECALL                         R7 R7 K4 ["format"]
      129 CALL                             R7 2 1
      130 MOVE                             R6 R7
      131 CALL                             R3 3 1
      132 SETTABLEKS                       R3 R0 K15 ["image"]
      134 RETURN                           R0 1
