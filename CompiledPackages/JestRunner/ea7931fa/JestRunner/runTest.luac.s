...
PROTO_4:
        0 GETUPVAL                         R0 0
        1 DUPTABLE                         R1 K2 [{"leakDetector", "result"}]
        2 LOADNIL                          R2
        3 SETTABLEKS                       R2 R1 K0 ["leakDetector"]
        5 GETUPVAL                         R2 1
        6 SETTABLEKS                       R2 R1 K1 ["result"]
        8 CALL                             R0 1 -1
        9 RETURN                           R0 -1
...
PROTO_6:
       ...
       46 ADD                              R3 R4 R5
       47 GETIMPORT                        R5 K15 [DateTime.now]
       49 CALL                             R5 0 1
       50 GETTABLEKS                       R4 R5 K16 ["UnixTimestampMillis"]
       52 GETUPVAL                         R6 10
       53 SUB                              R5 R4 R6
       54 NEWTABLE                         R6 4 0
       ...
       61 GETUPVAL                         R10 3
       62 GETTABLEKS                       R9 R10 K20 ["slowTestThreshold"]
       64 JUMPIFLT                         R9 R8 ; [+2]
       66 LOADB                            R7 0 +1
       67 LOADB                            R7 1
       ...
       86 GETUPVAL                         R7 5
       87 GETUPVAL                         R9 3
       88 GETTABLEKS                       R8 R9 K26 ["rootDir"]
       90 CALL                             R6 2 1
      ...
      107 GETUPVAL                         R7 3
      108 GETTABLEKS                       R6 R7 K30 ["displayName"]
      110 SETTABLEKS                       R6 R0 K30 ["displayName"]
      112 GETUPVAL                         R7 13
      113 GETTABLEKS                       R6 R7 K31 ["new"]
...
PROTO_7:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R0 R1 K0 ["testEnvironment"]
        3 GETIMPORT                        R1 K2 [require]
        5 MOVE                             R2 R0
        6 CALL                             R1 1 1
        7 GETIMPORT                        R3 K2 [require]
        9 GETUPVAL                         R5 1
       10 GETTABLEKS                       R4 R5 K3 ["JestCircus"]
       12 CALL                             R3 1 1
       13 GETTABLEKS                       R2 R3 K4 ["runner"]
       15 GETIMPORT                        R3 K2 [require]
       17 GETUPVAL                         R5 1
       18 GETTABLEKS                       R4 R5 K5 ["JestRuntime"]
       20 CALL                             R3 1 1
       21 GETUPVAL                         R5 2
       ...
       30 LOADNIL                          R6
       31 GETUPVAL                         R8 5
       32 GETTABLEKS                       R7 R8 K7 ["silent"]
       34 JUMPIFNOT                        R7 ; [+9]
       35 GETUPVAL                         R8 6
       36 GETTABLEKS                       R7 R8 K6 ["new"]
       38 MOVE                             R8 R4
       39 MOVE                             R9 R4
       40 MOVE                             R10 R5
       41 CALL                             R7 3 1
       ...
       43 JUMP                             ; [+18]
       44 GETUPVAL                         R8 5
       45 GETTABLEKS                       R7 R8 K8 ["verbose"]
       47 JUMPIFNOT                        R7 ; [+9]
       48 GETUPVAL                         R8 7
       49 GETTABLEKS                       R7 R8 K6 ["new"]
       51 MOVE                             R8 R4
       52 MOVE                             R9 R4
       53 MOVE                             R10 R5
       54 CALL                             R7 3 1
      ...
      105 GETUPVAL                         R9 11
      106 CALL                             R8 1 1
      107 GETIMPORT                        R10 K25 [DateTime.now]
      109 CALL                             R10 0 1
      110 GETTABLEKS                       R9 R10 K26 ["UnixTimestampMillis"]
      112 GETUPVAL                         R13 0
      113 GETTABLEKS                       R10 R13 K27 ["setupFiles"]
      115 LOADNIL                          R11
      116 LOADNIL                          R12
      117 FORGPREP                         R10
      118 MOVE                             R17 R14
      119 NAMECALL                         R15 R8 K28 ["requireModule"]
      121 CALL                             R15 2 0
      122 FORGLOOP                         R10 2 ; [-5]
      124 GETIMPORT                        R10 K30 [pcall]
      ...
      142 CALL                             R10 1 2
      143 NAMECALL                         R12 R8 K31 ["teardown"]
      145 CALL                             R12 1 0
      146 NAMECALL                         R12 R7 K31 ["teardown"]
      148 CALL                             R12 1 1
      149 NAMECALL                         R12 R12 K32 ["expect"]
      151 CALL                             R12 1 0
      152 JUMPIF                           R10 ; [+4]
      153 GETIMPORT                        R12 K21 [error]
      155 MOVE                             R13 R11
      156 CALL                             R12 1 0
      157 CLOSEUPVALS                      R6
      158 RETURN                           R11 1
...
MAIN:
       ...
       23 GETTABLEKS                       R7 R0 K9 ["RobloxShared"]
       25 CALL                             R6 1 1
       26 GETTABLEKS                       R5 R6 K10 ["getRelativePath"]
       28 GETIMPORT                        R7 K4 [require]
       30 GETTABLEKS                       R8 R0 K9 ["RobloxShared"]
       32 CALL                             R7 1 1
       33 GETTABLEKS                       R6 R7 K11 ["getDataModelService"]
       35 MOVE                             R7 R6
       ...
       84 GETIMPORT                        R24 K1 [script]
       86 GETTABLEKS                       R23 R24 K2 ["Parent"]
       88 GETTABLEKS                       R22 R23 K25 ["types"]
       90 CALL                             R21 1 1
       91 GETIMPORT                        R23 K4 [require]
       93 GETTABLEKS                       R24 R0 K9 ["RobloxShared"]
       95 CALL                             R23 1 1
       96 GETTABLEKS                       R22 R23 K26 ["Writeable"]
