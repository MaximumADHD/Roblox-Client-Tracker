local TERRAIN = {
	...
	CPC_EVENTS = {
		...
		TERRAIN_EDITOR_READY = "TerrainEditorReady",
		TERRAIN_EDITOR_SOURCE_MATERIAL_CHANGED = "TerrainEditorSourceMaterialChanged",
		TERRAIN_PALETTE_SELECTION_CHANGED = "TerrainPaletteSelectionChanged",
