...
PROTO_7:
      ...
      476 JUMPIF                           R9 ; [+3]
      477 GETUPVAL                         R9 1
      478 GETTABLEKS                       R9 R9 K5 ["new"]
      480 CALL                             R7 2 0
      481 LOADK                            R7 K76 ["AssertionError"]
      482 SETTABLEKS                       R7 R1 K72 ["name"]
      484 RETURN                           R1 1
...
MAIN:
       ...
       46 DUPTABLE                         R12 K21 [{["isTTY"] = False, ["columns"] = 0, ["hasColors"]}]
       47 DUPCLOSURE                       R13 K22 [PROTO_0]
       48 SETTABLEKS                       R13 R12 K20 ["hasColors"]
       50 SETTABLEKS                       R12 R11 K14 ["stderr"]
       52 DUPCLOSURE                       R12 K23 [PROTO_1]
       53 CAPTURE                          VAL R9
       54 SETGLOBAL                        R12 K24 ["ErrorCaptureStackTrace"]
       56 DUPCLOSURE                       R12 K25 [PROTO_2]
       57 LOADK                            R13 K26 [""]
       58 LOADK                            R14 K26 [""]
       59 LOADK                            R15 K26 [""]
       60 LOADK                            R16 K26 [""]
       61 DUPTABLE                         R17 K47 [{["deepStrictEqual"] = "Expected values to be strictly deep-equal:", ["strictEqual"] = "Expected values to be strictly equal:", ["strictEqualObject"] = "Expected \"actual\" to be reference-equal to \"expected\":", ["deepEqual"] = "Expected values to be loosely deep-equal:", ["notDeepStrictEqual"] = "Expected \"actual\" not to be strictly deep-equal to:", ["notStrictEqual"] = "Expected \"actual\" to be strictly unequal to:", ["notStrictEqualObject"] = "Expected \"actual\" not to be reference-equal to \"expected\":", ["notDeepEqual"] = "Expected \"actual\" not to be loosely deep-equal to:", ["notIdentical"] = "Values have same structure but are not reference-equal:", ["notDeepEqualUnequal"] = "Expected values not to be loosely deep-equal:"}]
       62 DUPCLOSURE                       R18 K48 [PROTO_3]
       63 CAPTURE                          VAL R4
       64 DUPCLOSURE                       R19 K49 [PROTO_4]
       65 CAPTURE                          VAL R8
       66 NEWCLOSURE                       R20 P5
       67 CAPTURE                          VAL R8
       68 CAPTURE                          VAL R6
       69 CAPTURE                          VAL R5
       70 CAPTURE                          VAL R17
       ...
       76 CAPTURE                          REF R15
       77 NEWTABLE                         R22 0 0
       79 DUPTABLE                         R23 K51 [{"__index"}]
       80 SETTABLEKS                       R9 R23 K50 ["__index"]
       82 FASTCALL2                        SETMETATABLE R22 R23 ; [+3]
       84 GETIMPORT                        R21 K53 [setmetatable]
       86 CALL                             R21 2 1
       87 SETTABLEKS                       R21 R21 K50 ["__index"]
       89 DUPCLOSURE                       R22 K54 [PROTO_6]
       90 SETTABLEKS                       R22 R21 K55 ["__tostring"]
       92 NEWCLOSURE                       R22 P7
       93 CAPTURE                          VAL R9
       94 CAPTURE                          VAL R21
       95 CAPTURE                          VAL R11
       96 CAPTURE                          REF R13
      ...
      106 CAPTURE                          VAL R8
      107 CAPTURE                          VAL R5
      108 SETTABLEKS                       R22 R21 K56 ["new"]
      110 DUPCLOSURE                       R22 K57 [PROTO_8]
      111 SETTABLEKS                       R22 R21 K58 ["toString"]
      113 LOADK                            R22 K59 ["AssertionError"]
      114 SETTABLEKS                       R22 R21 K60 ["name"]
      116 DUPTABLE                         R22 K61 [{"AssertionError"}]
      117 SETTABLEKS                       R21 R22 K59 ["AssertionError"]
      119 CLOSEUPVALS                      R13
      120 RETURN                           R22 1
