PROTO_0:
        0 MOVE                             R2 R1
        1 JUMPIF                           R2 ; [+1]
        2 DUPTABLE                         R2 K2 [{[1] = 2}]
        3 GETTABLEKS                       R4 R2 K0 ["depth"]
        5 ORK                              R3 R4 K1 [2]
        6 LOADN                            R5 0
        7 JUMPIFNOTLE                      R5 R3 ; [+3]
        9 MOVE                             R4 R3
       10 JUMP                             ; [+1]
       11 LOADN                            R4 2
       12 SETTABLEKS                       R4 R2 K0 ["depth"]
       14 GETUPVAL                         R4 0
       15 MOVE                             R5 R0
       16 NEWTABLE                         R6 0 0
       18 MOVE                             R7 R2
...
MAIN:
       ...
       14 LOADK                            R4 K8 ["HttpService"]
       15 NAMECALL                         R2 R2 K9 ["GetService"]
       17 CALL                             R2 2 1
       18 GETIMPORT                        R3 K4 [require]
       20 GETTABLEKS                       R4 R0 K10 ["Array"]
       22 GETTABLEKS                       R4 R4 K11 ["isArray"]
       24 CALL                             R3 1 1
       25 LOADNIL                          R4
       26 LOADNIL                          R5
       27 LOADNIL                          R6
       ...
       30 NEWCLOSURE                       R9 P0
       31 CAPTURE                          REF R4
       32 DUPCLOSURE                       R10 K12 [PROTO_1]
       33 DUPCLOSURE                       R11 K13 [PROTO_2]
       34 DUPCLOSURE                       R12 K14 [PROTO_3]
       35 DUPCLOSURE                       R13 K15 [PROTO_4]
       36 DUPCLOSURE                       R14 K16 [PROTO_5]
       37 CAPTURE                          VAL R12
       38 NEWCLOSURE                       R4 P6
       39 CAPTURE                          VAL R2
       40 CAPTURE                          REF R5
