...
PROTO_1:
        0 DUPTABLE                         R2 K3 [{[1] = "Error", ["message"]}]
        1 ORK                              R3 R0 K4 [""]
        2 SETTABLEKS                       R3 R2 K2 ["message"]
        4 GETUPVAL                         R3 0
        5 FASTCALL2                        SETMETATABLE R2 R3 ; [+3]
        7 GETIMPORT                        R1 K6 [setmetatable]
        9 CALL                             R1 2 1
       10 GETUPVAL                         R2 0
       11 GETTABLEKS                       R2 R2 K7 ["__captureStackTrace"]
       13 MOVE                             R3 R1
       14 LOADN                            R4 4
       15 CALL                             R2 2 0
       16 RETURN                           R1 1
...
PROTO_2:
        0 DUPTABLE                         R3 K3 [{[1] = "Error", ["message"]}]
        1 ORK                              R4 R0 K4 [""]
        2 SETTABLEKS                       R4 R3 K2 ["message"]
        4 GETUPVAL                         R4 0
        5 FASTCALL2                        SETMETATABLE R3 R4 ; [+3]
        7 GETIMPORT                        R2 K6 [setmetatable]
        9 CALL                             R2 2 1
       10 GETUPVAL                         R3 0
       11 GETTABLEKS                       R3 R3 K7 ["__captureStackTrace"]
       13 MOVE                             R4 R2
       14 LOADN                            R5 4
       15 CALL                             R3 2 0
       16 MOVE                             R1 R2
...
PROTO_6:
        0 PREPVARARGS                      1
        1 GETVARARGS                       R2 1
        2 DUPTABLE                         R4 K3 [{[1] = "Error", ["message"]}]
        3 ORK                              R5 R2 K4 [""]
        4 SETTABLEKS                       R5 R4 K2 ["message"]
        6 GETUPVAL                         R5 0
        7 FASTCALL2                        SETMETATABLE R4 R5 ; [+3]
        9 GETIMPORT                        R3 K6 [setmetatable]
       11 CALL                             R3 2 1
       12 GETUPVAL                         R4 0
       13 GETTABLEKS                       R4 R4 K7 ["__captureStackTrace"]
       15 MOVE                             R5 R3
       16 LOADN                            R6 4
       17 CALL                             R4 2 0
       18 MOVE                             R1 R3
