...
PROTO_4:
       ...
       11 CALL                             R5 3 1
       12 MOVE                             R3 R5
       13 DUPTABLE                         R5 K9 [{["type"] = "Ref", ["templateAst"], ["templateId"], ["params"], ["children"], ["host"]}]
       14 SETTABLEKS                       R0 R5 K4 ["templateAst"]
       16 LOADK                            R7 K10 ["/custom/%*"]
       17 GETTABLEKS                       R9 R0 K11 ["name"]
       19 NAMECALL                         R7 R7 K12 ["format"]
       21 CALL                             R7 2 1
       22 MOVE                             R6 R7
       23 SETTABLEKS                       R6 R5 K5 ["templateId"]
       25 MOVE                             R6 R1
       26 JUMPIF                           R6 ; [+2]
       27 NEWTABLE                         R6 0 0
       29 SETTABLEKS                       R6 R5 K6 ["params"]
       31 NEWTABLE                         R6 0 0
       33 SETTABLEKS                       R6 R5 K7 ["children"]
       35 SETTABLEKS                       R2 R5 K8 ["host"]
       37 GETUPVAL                         R6 2
       38 MOVE                             R7 R4
       39 MOVE                             R8 R5
       40 MOVE                             R9 R2
       41 CALL                             R6 3 1
       42 GETTABLEKS                       R7 R6 K13 ["scheduled"]
       44 JUMPIF                           R7 ; [+9]
       45 LOADB                            R7 1
       46 SETTABLEKS                       R7 R6 K13 ["scheduled"]
       48 GETTABLEKS                       R9 R6 K14 ["depth"]
       50 MOVE                             R10 R6
       51 NAMECALL                         R7 R3 K15 ["enqueue"]
       53 CALL                             R7 3 0
       54 NAMECALL                         R7 R3 K16 ["start"]
       56 CALL                             R7 1 0
       57 GETUPVAL                         R7 3
       58 GETTABLEKS                       R7 R7 K17 ["Debug"]
       60 GETTABLEKS                       R7 R7 K18 ["PRE_RENDER_FLUSH"]
       62 JUMPIFNOT                        R7 ; [+3]
       63 NAMECALL                         R7 R3 K19 ["enablePreRenderFlush"]
       65 CALL                             R7 1 0
       66 NEWCLOSURE                       R7 P2
       67 CAPTURE                          REF R3
       68 MOVE                             R8 R7
