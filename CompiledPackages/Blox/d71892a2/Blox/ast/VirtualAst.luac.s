PROTO_0:
       ...
       23 CALL                             R8 2 0
       24 FORGLOOP                         R3 2 ; [-17]
       26 DUPTABLE                         R3 K10 [{[1] = "Instance", ["className"], ["params"], ["children"]}]
       27 GETUPVAL                         R4 0
       28 SETTABLEKS                       R4 R3 K7 ["className"]
       30 SETTABLEKS                       R1 R3 K8 ["params"]
       32 SETTABLEKS                       R2 R3 K9 ["children"]
       34 RETURN                           R3 1
...
PROTO_2:
       ...
       23 CALL                             R9 2 0
       24 FORGLOOP                         R4 2 ; [-17]
       26 DUPTABLE                         R4 K11 [{[1] = "Ref", ["templateId"], ["templateAst"], ["params"], ["children"]}]
       27 LOADK                            R6 K12 ["/custom/%*"]
       28 GETTABLEKS                       R8 R0 K13 ["name"]
       30 NAMECALL                         R6 R6 K14 ["format"]
       32 CALL                             R6 2 1
       33 MOVE                             R5 R6
       34 SETTABLEKS                       R5 R4 K7 ["templateId"]
       36 SETTABLEKS                       R0 R4 K8 ["templateAst"]
       38 SETTABLEKS                       R2 R4 K9 ["params"]
       40 SETTABLEKS                       R3 R4 K10 ["children"]
       42 RETURN                           R4 1
...
PROTO_3:
       ...
       23 CALL                             R8 2 0
       24 FORGLOOP                         R3 2 ; [-17]
       26 DUPTABLE                         R3 K10 [{[1] = "Ref", ["templateId"], ["params"], ["children"]}]
       27 LOADK                            R5 K11 ["/std/%*"]
       28 GETUPVAL                         R7 0
       29 NAMECALL                         R5 R5 K12 ["format"]
       31 CALL                             R5 2 1
       32 MOVE                             R4 R5
       33 SETTABLEKS                       R4 R3 K7 ["templateId"]
       35 SETTABLEKS                       R1 R3 K8 ["params"]
       37 SETTABLEKS                       R2 R3 K9 ["children"]
       39 RETURN                           R3 1
...
PROTO_5:
       ...
       33 DUPTABLE                         R8 K12 [{[1] = "Template", ["name"], ["defaultParams"], ["controller"], ["children"]}]
       34 SETTABLEKS                       R4 R8 K8 ["name"]
       36 SETTABLEKS                       R5 R8 K9 ["defaultParams"]
       38 MOVE                             R9 R3
       39 JUMPIF                           R9 ; [+2]
       40 NEWTABLE                         R9 0 0
       42 SETTABLEKS                       R9 R8 K10 ["controller"]
       44 MOVE                             R9 R6
       45 JUMPIF                           R9 ; [+2]
       46 NEWTABLE                         R9 0 0
       48 SETTABLEKS                       R9 R8 K11 ["children"]
       50 GETUPVAL                         R9 0
       51 FASTCALL2                        SETMETATABLE R8 R9 ; [+3]
       53 GETIMPORT                        R7 K14 [setmetatable]
       55 CALL                             R7 2 1
       56 RETURN                           R7 1
