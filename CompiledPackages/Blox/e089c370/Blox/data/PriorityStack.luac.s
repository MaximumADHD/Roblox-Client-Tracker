PROTO_0:
        0 DUPTABLE                         R1 K4 [{"_buffers", "_min", "_max", "size"}]
        1 NEWTABLE                         R2 0 0
        3 SETTABLEKS                       R2 R1 K0 ["_buffers"]
        5 LOADK                            R2 K5 [∞]
        6 SETTABLEKS                       R2 R1 K1 ["_min"]
        8 LOADN                            R2 0
        9 SETTABLEKS                       R2 R1 K2 ["_max"]
       11 LOADN                            R2 0
       12 SETTABLEKS                       R2 R1 K3 ["size"]
       14 GETUPVAL                         R2 0
       15 FASTCALL2                        SETMETATABLE R1 R2 ; [+3]
       17 GETIMPORT                        R0 K7 [setmetatable]
       19 CALL                             R0 2 1
       20 RETURN                           R0 1
