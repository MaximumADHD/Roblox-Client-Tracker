PROTO_0:
        0 ORK                              R1 R0 K0 [4]
        1 DUPTABLE                         R3 K5 [{"capacity", "size", "_startIndex", "_data"}]
        2 SETTABLEKS                       R1 R3 K1 ["capacity"]
        4 LOADN                            R4 0
        5 SETTABLEKS                       R4 R3 K2 ["size"]
        7 LOADN                            R4 1
        8 SETTABLEKS                       R4 R3 K3 ["_startIndex"]
       10 GETIMPORT                        R4 K8 [table.create]
       12 MOVE                             R5 R1
       13 CALL                             R4 1 1
       14 SETTABLEKS                       R4 R3 K4 ["_data"]
       16 GETUPVAL                         R4 0
       17 FASTCALL2                        SETMETATABLE R3 R4 ; [+3]
       19 GETIMPORT                        R2 K10 [setmetatable]
       21 CALL                             R2 2 1
       22 RETURN                           R2 1
