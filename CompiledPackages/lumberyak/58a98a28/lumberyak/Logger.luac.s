...
PROTO_1:
        0 DUPTABLE                         R2 K9 [{[1], ["sinks"], ["children"], ["parent"], ["context"], ["dirty"] = True, ["active"], ["cache"]}]
       ...
       17 NEWTABLE                         R3 0 0
       19 SETTABLEKS                       R3 R2 K7 ["active"]
       21 DUPTABLE                         R3 K10 [{"sinks", "context"}]
       22 NEWTABLE                         R4 0 0
       24 SETTABLEKS                       R4 R3 K1 ["sinks"]
       26 NEWTABLE                         R4 0 0
       28 SETTABLEKS                       R4 R3 K4 ["context"]
       30 SETTABLEKS                       R3 R2 K8 ["cache"]
       32 GETIMPORT                        R3 K12 [pairs]
       34 GETUPVAL                         R4 0
       35 GETTABLEKS                       R4 R4 K13 ["Levels"]
       37 CALL                             R3 1 3
       38 FORGPREP_NEXT                    R3
       39 JUMPIFNOT                        R0 ; [+7]
       40 GETTABLEKS                       R8 R2 K7 ["active"]
       42 GETTABLEKS                       R10 R0 K7 ["active"]
       44 GETTABLE                         R9 R10 R6
       45 SETTABLE                         R9 R8 R6
       46 JUMP                             ; [+4]
       47 GETTABLEKS                       R8 R2 K7 ["active"]
       49 LOADB                            R9 0
       50 SETTABLE                         R9 R8 R6
       51 FORGLOOP                         R3 2 ; [-13]
       53 JUMPIFNOT                        R0 ; [+4]
       54 GETTABLEKS                       R3 R0 K2 ["children"]
       56 LOADB                            R4 1
       57 SETTABLE                         R4 R3 R2
       58 GETUPVAL                         R5 0
       59 FASTCALL2                        SETMETATABLE R2 R5 ; [+4]
       61 MOVE                             R4 R2
       62 GETIMPORT                        R3 K15 [setmetatable]
       64 CALL                             R3 2 0
       65 RETURN                           R2 1
...
PROTO_4:
       ...
       29 GETUPVAL                         R2 1
       30 GETTABLEKS                       R2 R2 K5 ["Dictionary"]
       32 GETTABLEKS                       R2 R2 K6 ["join"]
       34 GETTABLEKS                       R3 R0 K1 ["parent"]
       36 GETTABLEKS                       R3 R3 K2 ["cache"]
       38 GETTABLEKS                       R3 R3 K3 ["context"]
       40 GETTABLEKS                       R4 R0 K3 ["context"]
       42 CALL                             R2 2 1
       43 SETTABLEKS                       R2 R1 K3 ["context"]
       45 GETTABLEKS                       R1 R0 K1 ["parent"]
       47 GETTABLEKS                       R1 R1 K2 ["cache"]
       49 GETTABLEKS                       R1 R1 K3 ["context"]
       51 GETTABLEKS                       R1 R1 K7 ["prefix"]
       53 JUMPIFNOT                        R1 ; [+24]
       54 GETTABLEKS                       R1 R0 K3 ["context"]
       56 GETTABLEKS                       R1 R1 K7 ["prefix"]
       58 JUMPIFNOT                        R1 ; [+19]
       59 GETTABLEKS                       R1 R0 K2 ["cache"]
       61 GETTABLEKS                       R1 R1 K3 ["context"]
       63 GETTABLEKS                       R3 R0 K1 ["parent"]
       65 GETTABLEKS                       R3 R3 K2 ["cache"]
       67 GETTABLEKS                       R3 R3 K3 ["context"]
       69 GETTABLEKS                       R3 R3 K7 ["prefix"]
       71 GETTABLEKS                       R4 R0 K3 ["context"]
       73 GETTABLEKS                       R4 R4 K7 ["prefix"]
       75 CONCAT                           R2 R3 R4
       76 SETTABLEKS                       R2 R1 K7 ["prefix"]
       78 GETTABLEKS                       R1 R0 K2 ["cache"]
       80 GETUPVAL                         R2 1
       81 GETTABLEKS                       R2 R2 K8 ["List"]
       83 GETTABLEKS                       R2 R2 K6 ["join"]
       85 GETTABLEKS                       R3 R0 K1 ["parent"]
       87 GETTABLEKS                       R3 R3 K2 ["cache"]
       89 GETTABLEKS                       R3 R3 K4 ["sinks"]
...
PROTO_5:
       ...
       14 GETTABLEKS                       R2 R0 K0 ["parent"]
       16 GETTABLEKS                       R2 R2 K1 ["children"]
       18 LOADB                            R3 1
       19 SETTABLE                         R3 R2 R0
       20 LOADN                            R2 -1
       21 GETIMPORT                        R3 K3 [pairs]
       23 GETTABLEKS                       R4 R1 K4 ["cache"]
       25 GETTABLEKS                       R4 R4 K5 ["sinks"]
       27 CALL                             R3 1 3
       28 FORGPREP_NEXT                    R3
       29 GETUPVAL                         R9 1
...
PROTO_9:
       ...
       96 GETTABLEKS                       R7 R1 K8 ["cache"]
       98 GETTABLEKS                       R7 R7 K23 ["sinks"]
      100 CALL                             R6 1 3
...
PROTO_11:
       ...
       12 GETUPVAL                         R2 0
       13 GETTABLEKS                       R2 R2 K1 ["Levels"]
       15 GETTABLEKS                       R2 R2 K2 ["Warning"]
       17 MOVE                             R3 R0
       18 GETIMPORT                        R4 K5 [table.pack]
       20 GETVARARGS                       R5 -1
       21 CALL                             R4 -1 -1
...
MAIN:
       ...
       16 DUPTABLE                         R3 K12 [{["Error"] = "Error", ["Warning"] = "Warning", ["Info"] = "Info", ["Debug"] = "Debug", ["Trace"] = "Trace"}]
       17 SETTABLEKS                       R3 R2 K13 ["Levels"]
       19 NEWTABLE                         R3 0 5
       21 GETTABLEKS                       R4 R2 K13 ["Levels"]
       23 GETTABLEKS                       R4 R4 K7 ["Error"]
       25 GETTABLEKS                       R5 R2 K13 ["Levels"]
       27 GETTABLEKS                       R5 R5 K8 ["Warning"]
       29 GETTABLEKS                       R6 R2 K13 ["Levels"]
       31 GETTABLEKS                       R6 R6 K9 ["Info"]
       33 GETTABLEKS                       R7 R2 K13 ["Levels"]
       35 GETTABLEKS                       R7 R7 K10 ["Debug"]
       37 GETTABLEKS                       R8 R2 K13 ["Levels"]
       39 GETTABLEKS                       R8 R8 K11 ["Trace"]
       41 SETLIST                          R3 R4 5 [1]
       43 NEWTABLE                         R4 0 0
       45 GETIMPORT                        R5 K15 [pairs]
       47 MOVE                             R6 R3
       48 CALL                             R5 1 3
       49 FORGPREP_NEXT                    R5
       50 SETTABLE                         R8 R4 R9
       51 FORGLOOP                         R5 2 ; [-2]
       53 DUPCLOSURE                       R5 K16 [PROTO_0]
       54 CAPTURE                          VAL R3
       55 GETTABLEKS                       R6 R2 K13 ["Levels"]
       57 SETTABLEKS                       R5 R6 K17 ["fromString"]
       59 DUPCLOSURE                       R5 K18 [PROTO_1]
       60 CAPTURE                          VAL R2
       61 SETTABLEKS                       R5 R2 K19 ["new"]
       63 DUPCLOSURE                       R5 K20 [PROTO_2]
       64 CAPTURE                          VAL R4
       65 CAPTURE                          VAL R3
       66 CAPTURE                          VAL R5
       67 DUPCLOSURE                       R6 K21 [PROTO_3]
       68 CAPTURE                          VAL R6
       69 DUPCLOSURE                       R7 K22 [PROTO_4]
       70 CAPTURE                          VAL R7
       71 CAPTURE                          VAL R1
       ...
       76 CAPTURE                          VAL R3
       77 CAPTURE                          VAL R6
       78 SETTABLEKS                       R8 R2 K24 ["setParent"]
       80 DUPCLOSURE                       R8 K25 [PROTO_6]
       81 CAPTURE                          VAL R5
       82 CAPTURE                          VAL R6
       83 SETTABLEKS                       R8 R2 K26 ["addSink"]
       85 DUPCLOSURE                       R8 K27 [PROTO_7]
       86 CAPTURE                          VAL R6
       87 SETTABLEKS                       R8 R2 K28 ["setContext"]
       89 DUPCLOSURE                       R8 K29 [PROTO_9]
       90 CAPTURE                          VAL R7
       91 CAPTURE                          VAL R4
       92 DUPCLOSURE                       R9 K30 [PROTO_10]
       93 CAPTURE                          VAL R2
       94 CAPTURE                          VAL R8
       95 SETTABLEKS                       R9 R2 K31 ["error"]
       97 DUPCLOSURE                       R9 K32 [PROTO_11]
       98 CAPTURE                          VAL R2
       99 CAPTURE                          VAL R8
      100 SETTABLEKS                       R9 R2 K33 ["warning"]
      102 DUPCLOSURE                       R9 K34 [PROTO_12]
      103 CAPTURE                          VAL R2
      104 CAPTURE                          VAL R8
      105 SETTABLEKS                       R9 R2 K35 ["info"]
      107 DUPCLOSURE                       R9 K36 [PROTO_13]
      108 CAPTURE                          VAL R2
      109 CAPTURE                          VAL R8
      110 SETTABLEKS                       R9 R2 K37 ["debug"]
      112 DUPCLOSURE                       R9 K38 [PROTO_14]
      113 CAPTURE                          VAL R2
      114 CAPTURE                          VAL R8
      115 SETTABLEKS                       R9 R2 K39 ["trace"]
      117 RETURN                           R2 1
