...
MAIN:
       ...
       20 CALL                             R3 1 1
       21 GETTABLEKS                       R4 R3 K9 ["Hooks"]
       23 GETTABLEKS                       R4 R4 K10 ["useTokens"]
       25 GETTABLEKS                       R5 R3 K11 ["Image"]
       27 GETTABLEKS                       R6 R3 K12 ["Text"]
       29 GETIMPORT                        R7 K6 [require]
       31 GETTABLEKS                       R8 R0 K2 ["Components"]
       33 GETTABLEKS                       R8 R8 K13 ["BulletList"]
       35 CALL                             R7 1 1
       36 DUPTABLE                         R8 K17 [{["summary"] = "An array of strings and/or elements displayed as a bulleted list.", ["stories"]}]
       37 NEWTABLE                         R9 0 3
       39 DUPTABLE                         R10 K22 [{["name"] = "Basic", ["summary"] = "A basic bullet list with string items.", ["story"]}]
       40 DUPCLOSURE                       R11 K23 [PROTO_0]
       41 CAPTURE                          VAL R2
       42 CAPTURE                          VAL R7
       43 SETTABLEKS                       R11 R10 K21 ["story"]
       45 DUPTABLE                         R11 K26 [{["name"] = "With Indentation", ["summary"] = "A bullet list with indented sub-items.", ["story"]}]
       46 DUPCLOSURE                       R12 K27 [PROTO_1]
       47 CAPTURE                          VAL R2
       48 CAPTURE                          VAL R7
       49 SETTABLEKS                       R12 R11 K21 ["story"]
       51 DUPTABLE                         R12 K30 [{["name"] = "With Rendered Components", ["summary"] = "BulletList can render custom components as items.", ["story"]}]
       52 DUPCLOSURE                       R13 K31 [PROTO_3]
       53 CAPTURE                          VAL R4
       54 CAPTURE                          VAL R2
       55 CAPTURE                          VAL R7
       56 CAPTURE                          VAL R5
       57 CAPTURE                          VAL R6
       58 SETTABLEKS                       R13 R12 K21 ["story"]
       60 SETLIST                          R9 R10 3 [1]
       62 SETTABLEKS                       R9 R8 K16 ["stories"]
       64 RETURN                           R8 1
