...
PROTO_4:
        ...
        1 LOADK                            R4 K0 [""]
        2 GETUPVAL                         R5 0
        3 GETTABLEKS                       R5 R5 K1 ["spyOn"]
        5 GETUPVAL                         R6 0
        6 GETTABLEKS                       R6 R6 K2 ["globalEnv"]
        8 LOADK                            R7 K3 ["warn"]
        9 CALL                             R5 2 1
       10 GETTABLEKS                       R5 R5 K4 ["mockImplementation"]
       12 NEWCLOSURE                       R6 P0
       13 CAPTURE                          UPVAL U1
       14 CAPTURE                          VAL R2
       15 CAPTURE                          REF R3
...
PROTO_8:
        0 LOADN                            R2 0
        1 GETUPVAL                         R3 0
        2 GETTABLEKS                       R3 R3 K0 ["spyOn"]
        4 GETUPVAL                         R4 0
        5 GETTABLEKS                       R4 R4 K1 ["globalEnv"]
        7 LOADK                            R5 K2 ["warn"]
        8 CALL                             R3 2 1
        9 GETTABLEKS                       R3 R3 K3 ["mockImplementation"]
       11 NEWCLOSURE                       R4 P0
       12 CAPTURE                          REF R2
       13 CALL                             R3 1 1
