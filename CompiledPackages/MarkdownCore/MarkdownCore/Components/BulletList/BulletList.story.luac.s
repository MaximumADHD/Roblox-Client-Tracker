...
MAIN:
  ...
  CALL R3 1 1
  GETTABLEKS R5 R3 K9 ["Hooks"]
  GETTABLEKS R4 R5 K10 ["useTokens"]
  GETTABLEKS R5 R3 K11 ["Image"]
  GETTABLEKS R6 R3 K12 ["Text"]
  GETIMPORT R7 K6 [require]
  GETTABLEKS R9 R0 K2 ["Components"]
  GETTABLEKS R8 R9 K13 ["BulletList"]
  CALL R7 1 1
  DUPTABLE R8 K16 [{"summary", "stories"}]
  LOADK R9 K17 ["An array of strings and/or elements displayed as a bulleted list."]
  SETTABLEKS R9 R8 K14 ["summary"]
  NEWTABLE R9 0 3
  DUPTABLE R10 K20 [{"name", "summary", "story"}]
  LOADK R11 K21 ["Basic"]
  SETTABLEKS R11 R10 K18 ["name"]
  LOADK R11 K22 ["A basic bullet list with string items."]
  SETTABLEKS R11 R10 K14 ["summary"]
  DUPCLOSURE R11 K23 [PROTO_0]
  CAPTURE VAL R2
  CAPTURE VAL R7
  SETTABLEKS R11 R10 K19 ["story"]
  DUPTABLE R11 K20 [{"name", "summary", "story"}]
  LOADK R12 K24 ["With Indentation"]
  SETTABLEKS R12 R11 K18 ["name"]
  LOADK R12 K25 ["A bullet list with indented sub-items."]
  SETTABLEKS R12 R11 K14 ["summary"]
  DUPCLOSURE R12 K26 [PROTO_1]
  CAPTURE VAL R2
  CAPTURE VAL R7
  SETTABLEKS R12 R11 K19 ["story"]
  DUPTABLE R12 K20 [{"name", "summary", "story"}]
  LOADK R13 K27 ["With Rendered Components"]
  SETTABLEKS R13 R12 K18 ["name"]
  LOADK R13 K28 ["BulletList can render custom components as items."]
  SETTABLEKS R13 R12 K14 ["summary"]
