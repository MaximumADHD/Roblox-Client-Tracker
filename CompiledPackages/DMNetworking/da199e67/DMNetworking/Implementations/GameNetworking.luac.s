...
PROTO_9:
        ...
        2 CAPTURE                          VAL R1
        3 GETUPVAL                         R7 0
        4 GETTABLEKS                       R6 R7 K0 ["TAG_GUEST_EVENT"]
        6 MOVE                             R7 R1
...
PROTO_13:
        ...
        2 CAPTURE                          VAL R1
        3 GETUPVAL                         R7 0
        4 GETTABLEKS                       R6 R7 K0 ["TAG_HOST_EVENT"]
        6 MOVE                             R7 R1
        7 NAMECALL                         R4 R0 K1 ["_getRemoteEvent"]
        9 CALL                             R4 3 1
...
PROTO_24:
        ...
        2 CAPTURE                          VAL R1
        3 GETUPVAL                         R7 0
        4 GETTABLEKS                       R6 R7 K0 ["TAG_GUEST_INVOKE"]
        6 MOVE                             R7 R1
...
PROTO_29:
        ...
        2 CAPTURE                          VAL R1
        3 GETUPVAL                         R7 0
        4 GETTABLEKS                       R6 R7 K0 ["TAG_HOST_INVOKE"]
        6 MOVE                             R7 R1
        7 NAMECALL                         R4 R0 K1 ["_getRemoteFunction"]
        9 CALL                             R4 3 1
       10 NAMECALL                         R5 R0 K2 ["IsGuest"]
...
PROTO_31:
       ...
       38 CALL                             R7 2 0
       39 GETIMPORT                        R7 K7 [table.remove]
       41 MOVE                             R8 R6
       42 LOADN                            R9 1
       43 CALL                             R7 2 1
       44 JUMPIF                           R7 ; [+5]
       45 GETIMPORT                        R8 K9 [error]
       47 GETTABLEN                        R9 R6 1
       48 LOADN                            R10 0
       49 CALL                             R8 2 0
       50 FASTCALL1                        TABLE_UNPACK R6 ; [+3]
       51 MOVE                             R9 R6
       52 GETIMPORT                        R8 K11 [table.unpack]
       54 CALL                             R8 1 -1
       55 RETURN                           R8 -1
