...
PROTO_4:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R0 R1 K0 ["_eventCallbacks"]
        3 GETUPVAL                         R1 1
        4 LOADNIL                          R2
        5 SETTABLE                         R2 R0 R1
        6 RETURN                           R0 0
...
PROTO_7:
        ...
        3 MOVE                             R4 R3
        4 GETUPVAL                         R8 0
        5 GETTABLEKS                       R7 R8 K0 ["TAG_GUEST_EVENT"]
        7 MOVE                             R8 R1
        8 MOVE                             R9 R2
...
PROTO_9:
        ...
        3 MOVE                             R4 R3
        4 GETUPVAL                         R8 0
        5 GETTABLEKS                       R7 R8 K0 ["TAG_HOST_EVENT"]
        7 MOVE                             R8 R1
        8 MOVE                             R9 R2
        9 NAMECALL                         R5 R0 K1 ["_connectEvent"]
       11 CALL                             R5 4 -1
...
PROTO_11:
       ...
       28 GETTABLEKS                       R7 R0 K6 ["_logger"]
       30 NEWCLOSURE                       R9 P0
       31 CAPTURE                          VAL R2
       32 CAPTURE                          UPVAL U0
       33 CAPTURE                          VAL R6
       34 NAMECALL                         R7 R7 K7 ["log"]
       36 CALL                             R7 2 0
       37 GETIMPORT                        R7 K10 [task.spawn]
       39 MOVE                             R8 R5
       40 MOVE                             R9 R3
       41 GETVARARGS                       R10 -1
       42 CALL                             R7 -1 0
...
PROTO_12:
        0 PREPVARARGS                      3
        1 GETUPVAL                         R6 0
        2 GETTABLEKS                       R5 R6 K0 ["TAG_GUEST_EVENT"]
        4 MOVE                             R6 R1
        5 MOVE                             R7 R2
        6 GETVARARGS                       R8 -1
...
PROTO_13:
        0 PREPVARARGS                      3
        1 GETUPVAL                         R6 0
        2 GETTABLEKS                       R5 R6 K0 ["TAG_HOST_EVENT"]
        4 MOVE                             R6 R1
        5 MOVE                             R7 R2
        6 GETVARARGS                       R8 -1
        7 NAMECALL                         R3 R0 K1 ["_doFire"]
...
PROTO_16:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R0 R1 K0 ["_invokeCallbacks"]
        3 GETUPVAL                         R1 1
        4 LOADNIL                          R2
        5 SETTABLE                         R2 R0 R1
        6 RETURN                           R0 0
...
PROTO_19:
        ...
        3 MOVE                             R4 R3
        4 GETUPVAL                         R8 0
        5 GETTABLEKS                       R7 R8 K0 ["TAG_GUEST_INVOKE"]
        7 MOVE                             R8 R1
        8 MOVE                             R9 R2
...
PROTO_21:
        ...
        3 MOVE                             R4 R3
        4 GETUPVAL                         R8 0
        5 GETTABLEKS                       R7 R8 K0 ["TAG_HOST_INVOKE"]
        7 MOVE                             R8 R1
        8 MOVE                             R9 R2
        9 NAMECALL                         R5 R0 K1 ["_connectOnInvoke"]
       11 CALL                             R5 4 -1
...
PROTO_23:
       ...
       45 GETTABLEKS                       R8 R0 K6 ["_logger"]
       47 LOADK                            R11 K8 ["received invoke Requester %*"]
       48 MOVE                             R13 R2
       49 NAMECALL                         R11 R11 K1 ["format"]
       51 CALL                             R11 2 1
       52 MOVE                             R10 R11
       53 NAMECALL                         R8 R8 K7 ["log"]
       55 CALL                             R8 2 0
       56 GETIMPORT                        R8 K11 [table.remove]
       58 MOVE                             R9 R7
       59 LOADN                            R10 1
       60 CALL                             R8 2 1
       61 JUMPIF                           R8 ; [+5]
       62 GETIMPORT                        R9 K13 [error]
       64 GETTABLEN                        R10 R7 1
       65 LOADN                            R11 0
       66 CALL                             R9 2 0
       67 FASTCALL1                        TABLE_UNPACK R7 ; [+3]
       68 MOVE                             R10 R7
       69 GETIMPORT                        R9 K15 [table.unpack]
       71 CALL                             R9 1 -1
       72 RETURN                           R9 -1
...
PROTO_24:
        0 PREPVARARGS                      3
        1 GETUPVAL                         R6 0
        2 GETTABLEKS                       R5 R6 K0 ["TAG_GUEST_INVOKE"]
        4 MOVE                             R6 R1
        5 MOVE                             R7 R2
        6 GETVARARGS                       R8 -1
...
PROTO_25:
        0 PREPVARARGS                      3
        1 GETUPVAL                         R6 0
        2 GETTABLEKS                       R5 R6 K0 ["TAG_HOST_INVOKE"]
        4 MOVE                             R6 R1
        5 MOVE                             R7 R2
        6 GETVARARGS                       R8 -1
        7 NAMECALL                         R3 R0 K1 ["_doInvoke"]
