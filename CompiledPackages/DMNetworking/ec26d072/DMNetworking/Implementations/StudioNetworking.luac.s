...
PROTO_1:
       ...
       28 CALL                             R2 0 1
       29 JUMPIFNOT                        R2 ; [+11]
       30 GETTABLEKS                       R2 R1 K10 ["_identity"]
       32 JUMPIFNOTEQKNIL                  R2 ; [+8]
       34 GETUPVAL                         R2 2
       35 LOADB                            R4 0
       36 NAMECALL                         R2 R2 K11 ["GenerateGUID"]
       38 CALL                             R2 2 1
       39 SETTABLEKS                       R2 R1 K10 ["_identity"]
       41 GETTABLEKS                       R2 R0 K12 ["isGuest"]
       43 SETTABLEKS                       R2 R1 K13 ["_isGuest"]
       45 GETTABLEKS                       R2 R0 K14 ["isHost"]
       47 SETTABLEKS                       R2 R1 K15 ["_isHost"]
       49 GETTABLEKS                       R3 R0 K17 ["unreachableTimeout"]
       51 ORK                              R2 R3 K16 [2]
       52 SETTABLEKS                       R2 R1 K18 ["_unreachableTimeout"]
       54 GETTABLEKS                       R3 R0 K19 ["useSuspendOverride"]
       56 JUMPIFEQKB                       R3 TRUE ; [+2]
       58 LOADB                            R2 0 +1
       59 LOADB                            R2 1
       60 SETTABLEKS                       R2 R1 K20 ["_useSuspendOverride"]
       62 NEWTABLE                         R2 0 0
       64 SETTABLEKS                       R2 R1 K21 ["_connections"]
       66 NEWTABLE                         R2 0 0
       68 SETTABLEKS                       R2 R1 K22 ["_invokeThreads"]
       70 NEWTABLE                         R2 0 0
       72 SETTABLEKS                       R2 R1 K23 ["_infiniteYieldThreads"]
       74 NEWTABLE                         R2 0 0
       76 SETTABLEKS                       R2 R1 K24 ["_pendingResponses"]
       78 LOADN                            R2 0
       79 SETTABLEKS                       R2 R1 K25 ["_invokeCounter"]
       81 GETUPVAL                         R4 3
       82 FASTCALL2                        SETMETATABLE R1 R4 ; [+4]
       84 MOVE                             R3 R1
       85 GETIMPORT                        R2 K27 [setmetatable]
       87 CALL                             R2 2 0
       88 RETURN                           R1 1
...
PROTO_38:
       ...
       42 LOADK                            R4 K12 ["Sender: %*."]
       43 GETUPVAL                         R7 4
       44 GETTABLEKS                       R7 R7 K14 ["_identity"]
       46 ORK                              R6 R7 K13 ["unknown"]
       47 NAMECALL                         R4 R4 K10 ["format"]
       49 CALL                             R4 2 1
       50 CONCAT                           R0 R2 R4
       51 JUMP                             ; [+30]
       52 LOADK                            R1 K15 ["Target is not reachable (%*)"]
       53 GETUPVAL                         R4 3
       54 GETUPVAL                         R5 2
       55 NEWTABLE                         R6 0 1
       57 MOVE                             R7 R4
       ...
       62 MOVE                             R10 R5
       63 GETIMPORT                        R9 K3 [tostring]
       65 CALL                             R9 1 1
       66 FASTCALL2                        TABLE_INSERT R6 R9 ; [+4]
       68 MOVE                             R8 R6
       69 GETIMPORT                        R7 K6 [table.insert]
       71 CALL                             R7 2 0
       72 GETIMPORT                        R7 K8 [table.concat]
       74 MOVE                             R8 R6
       75 LOADK                            R9 K9 [", "]
       76 CALL                             R7 2 1
       77 MOVE                             R3 R7
       78 NAMECALL                         R1 R1 K10 ["format"]
       80 CALL                             R1 2 1
       81 MOVE                             R0 R1
       82 NEWTABLE                         R1 0 2
       84 LOADB                            R2 0
       85 MOVE                             R3 R0
       86 SETLIST                          R1 R2 2 [1]
       88 SETUPVAL                         R1 0
       89 GETUPVAL                         R1 4
       90 GETTABLEKS                       R1 R1 K16 ["_invokeThreads"]
       92 GETUPVAL                         R2 5
       93 LOADNIL                          R3
       94 SETTABLE                         R3 R1 R2
       95 GETUPVAL                         R1 4
       96 GETTABLEKS                       R1 R1 K17 ["_infiniteYieldThreads"]
       98 GETUPVAL                         R2 5
       99 LOADNIL                          R3
      100 SETTABLE                         R3 R1 R2
      101 GETIMPORT                        R1 K20 [coroutine.status]
      103 GETUPVAL                         R2 6
      104 CALL                             R1 1 1
      105 JUMPIFNOTEQKS                    R1 K21 ["suspended"] ; [+5]
      107 GETIMPORT                        R1 K24 [task.spawn]
      109 GETUPVAL                         R2 6
      110 CALL                             R1 1 0
      111 RETURN                           R0 0
...
PROTO_41:
       ...
       70 LOADK                            R10 K24 ["received invoke Requester %*"]
       71 MOVE                             R12 R2
       72 NAMECALL                         R10 R10 K25 ["format"]
       74 CALL                             R10 2 1
