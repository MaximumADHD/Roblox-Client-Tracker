...
PROTO_27:
       ...
       87 DUPTABLE                         R8 K17 [{"kind", "requestId", "toIdentifier", "fromIdentifier"}]
       88 LOADK                            R9 K18 ["SUCCESS"]
       89 SETTABLEKS                       R9 R8 K16 ["kind"]
       91 SETTABLEKS                       R1 R8 K0 ["requestId"]
       93 SETTABLEKS                       R3 R8 K1 ["toIdentifier"]
       95 GETUPVAL                         R9 0
       96 GETTABLEKS                       R9 R9 K5 ["_identity"]
       98 SETTABLEKS                       R9 R8 K2 ["fromIdentifier"]
      100 GETUPVAL                         R9 0
      101 GETTABLEKS                       R9 R9 K19 ["_plugin"]
      103 MOVE                             R11 R5
      104 MOVE                             R12 R8
      105 NAMECALL                         R9 R9 K20 ["Invoke"]
      107 CALL                             R9 3 0
      108 NEWTABLE                         R9 0 1
      110 GETIMPORT                        R10 K22 [pcall]
      112 GETUPVAL                         R11 4
      113 MOVE                             R12 R3
      114 GETTABLEKS                       R14 R0 K23 ["args"]
      116 FASTCALL1                        TABLE_UNPACK R14 ; [+2]
      117 GETIMPORT                        R13 K26 [table.unpack]
      119 CALL                             R13 1 -1
      120 CALL                             R10 -1 -1
      121 SETLIST                          R9 R10 -1 [1]
      123 GETUPVAL                         R10 0
      124 GETTABLEKS                       R10 R10 K13 ["_pendingResponses"]
      126 LOADNIL                          R11
      127 SETTABLE                         R11 R10 R7
      128 GETUPVAL                         R10 0
      129 GETTABLEKS                       R10 R10 K6 ["_logger"]
      131 NEWCLOSURE                       R12 P1
      132 CAPTURE                          UPVAL U2
      133 CAPTURE                          UPVAL U5
      134 CAPTURE                          VAL R9
      135 CAPTURE                          VAL R3
      136 NAMECALL                         R10 R10 K7 ["log"]
      138 CALL                             R10 2 0
      139 DUPTABLE                         R10 K27 [{"kind", "requestId", "toIdentifier", "fromIdentifier", "args"}]
      140 LOADK                            R11 K28 ["RESULT"]
      141 SETTABLEKS                       R11 R10 K16 ["kind"]
      143 SETTABLEKS                       R1 R10 K0 ["requestId"]
      145 SETTABLEKS                       R3 R10 K1 ["toIdentifier"]
      147 GETUPVAL                         R11 0
      148 GETTABLEKS                       R11 R11 K5 ["_identity"]
      150 SETTABLEKS                       R11 R10 K2 ["fromIdentifier"]
      152 SETTABLEKS                       R9 R10 K23 ["args"]
      154 GETUPVAL                         R11 0
      155 GETTABLEKS                       R11 R11 K19 ["_plugin"]
      157 MOVE                             R13 R5
      158 MOVE                             R14 R10
      159 NAMECALL                         R11 R11 K20 ["Invoke"]
      161 CALL                             R11 3 0
      162 RETURN                           R0 0
