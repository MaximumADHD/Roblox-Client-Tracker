PROTO_0:
       ...
       33 GETTABLEKS                       R2 R0 K0 ["isGuest"]
       35 SETTABLEKS                       R2 R1 K12 ["_isGuest"]
       37 GETTABLEKS                       R2 R0 K1 ["isHost"]
       39 SETTABLEKS                       R2 R1 K13 ["_isHost"]
       41 LOADNIL                          R2
...
PROTO_23:
       ...
       27 CAPTURE                          UPVAL U3
       28 CAPTURE                          VAL R0
       29 NAMECALL                         R1 R1 K3 ["log"]
       31 CALL                             R1 2 0
       32 FASTCALL1                        TABLE_UNPACK R0 ; [+3]
       33 MOVE                             R2 R0
       34 GETIMPORT                        R1 K8 [table.unpack]
       36 CALL                             R1 1 -1
       37 RETURN                           R1 -1
...
PROTO_31:
       ...
       30 LOADK                            R9 K3 ["received invoke Requester %*"]
       31 MOVE                             R11 R2
       32 NAMECALL                         R9 R9 K4 ["format"]
       34 CALL                             R9 2 1
       35 NAMECALL                         R7 R7 K2 ["log"]
       37 CALL                             R7 2 0
       38 GETTABLEN                        R7 R6 1
       39 JUMPIF                           R7 ; [+5]
       40 GETIMPORT                        R7 K6 [error]
       42 GETTABLEN                        R8 R6 2
       43 LOADN                            R9 0
       44 CALL                             R7 2 0
       45 FASTCALL2K                       TABLE_UNPACK R6 K7 ; [+5]
       47 MOVE                             R8 R6
       48 LOADK                            R9 K7 [2]
       49 GETIMPORT                        R7 K10 [table.unpack]
       51 CALL                             R7 2 -1
       52 RETURN                           R7 -1
