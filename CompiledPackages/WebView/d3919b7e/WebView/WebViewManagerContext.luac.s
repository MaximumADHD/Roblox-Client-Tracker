...
PROTO_4:
       ...
       12 LOADK                            R5 K5 ["Failed to register browser context: %*"]
       13 MOVE                             R7 R3
...
PROTO_26:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["shouldMockUnsupported"]
        3 CALL                             R1 0 1
        4 JUMPIFNOT                        R1 ; [+2]
        5 LOADB                            R1 0
        6 RETURN                           R1 1
        7 NAMECALL                         R1 R0 K1 ["getWebViewManager"]
        9 CALL                             R1 1 1
       10 JUMPIF                           R1 ; [+2]
       11 LOADB                            R2 0
       12 RETURN                           R2 1
       13 NAMECALL                         R2 R1 K2 ["IsAvailableAsync"]
       15 CALL                             R2 1 1
       16 RETURN                           R2 1
...
MAIN:
       ...
       46 GETTABLEKS                       R9 R9 K18 ["DebugFlags"]
       48 CALL                             R8 1 1
       49 DUPCLOSURE                       R9 K19 [PROTO_0]
       50 LOADK                            R12 K20 ["WebViewManagerContext"]
       51 NAMECALL                         R10 R4 K21 ["extend"]
       53 CALL                             R10 2 1
       54 DUPCLOSURE                       R11 K22 [PROTO_1]
       55 CAPTURE                          VAL R6
       56 CAPTURE                          VAL R10
       57 SETTABLEKS                       R11 R10 K23 ["new"]
       59 DUPCLOSURE                       R11 K24 [PROTO_2]
       60 SETTABLEKS                       R11 R10 K25 ["getWebViewManager"]
       62 DUPCLOSURE                       R11 K26 [PROTO_4]
       63 SETTABLEKS                       R11 R10 K27 ["registerWebViewBrowserContext"]
       65 DUPCLOSURE                       R11 K28 [PROTO_5]
       66 SETTABLEKS                       R11 R10 K29 ["getBrowserUri"]
       68 DUPCLOSURE                       R11 K30 [PROTO_6]
       69 SETTABLEKS                       R11 R10 K31 ["get"]
       71 DUPCLOSURE                       R11 K32 [PROTO_7]
       72 SETTABLEKS                       R11 R10 K33 ["destroy"]
       74 DUPCLOSURE                       R11 K34 [PROTO_8]
       75 SETTABLEKS                       R11 R10 K35 ["resetListeners"]
       77 DUPCLOSURE                       R11 K36 [PROTO_10]
       78 CAPTURE                          VAL R7
       79 CAPTURE                          VAL R1
       80 SETTABLEKS                       R11 R10 K37 ["connectListeners"]
       82 DUPCLOSURE                       R11 K38 [PROTO_11]
       83 CAPTURE                          VAL R7
       84 CAPTURE                          VAL R1
       85 SETTABLEKS                       R11 R10 K39 ["postMessage"]
       87 DUPCLOSURE                       R11 K40 [PROTO_13]
       88 CAPTURE                          VAL R6
       89 SETTABLEKS                       R11 R10 K41 ["setListenerInternal"]
       91 DUPCLOSURE                       R11 K42 [PROTO_15]
       92 CAPTURE                          VAL R7
       93 CAPTURE                          VAL R6
       94 SETTABLEKS                       R11 R10 K43 ["setListener"]
       96 DUPCLOSURE                       R11 K44 [PROTO_16]
       97 SETTABLEKS                       R11 R10 K45 ["removeListener"]
       99 DUPCLOSURE                       R11 K46 [PROTO_20]
      100 CAPTURE                          VAL R6
      101 CAPTURE                          VAL R7
      102 CAPTURE                          VAL R5
      103 CAPTURE                          VAL R1
      104 SETTABLEKS                       R11 R10 K47 ["call"]
      106 DUPCLOSURE                       R11 K48 [PROTO_21]
      107 CAPTURE                          VAL R1
      108 CAPTURE                          VAL R7
      109 SETTABLEKS                       R11 R10 K49 ["fire"]
      111 DUPCLOSURE                       R11 K50 [PROTO_22]
      112 CAPTURE                          VAL R7
      113 SETTABLEKS                       R11 R10 K51 ["reloadBrowser"]
      115 DUPCLOSURE                       R11 K52 [PROTO_23]
      116 CAPTURE                          VAL R7
      117 SETTABLEKS                       R11 R10 K53 ["showBrowser"]
      119 DUPCLOSURE                       R11 K54 [PROTO_24]
      120 CAPTURE                          VAL R7
      121 SETTABLEKS                       R11 R10 K55 ["hideBrowser"]
      123 DUPCLOSURE                       R11 K56 [PROTO_25]
      124 CAPTURE                          VAL R7
      125 SETTABLEKS                       R11 R10 K57 ["clearBrowserFocus"]
      127 DUPCLOSURE                       R11 K58 [PROTO_26]
      128 CAPTURE                          VAL R8
      129 SETTABLEKS                       R11 R10 K59 ["isAvailable"]
      131 RETURN                           R10 1
