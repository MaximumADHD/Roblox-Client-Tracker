...
PROTO_17:
       ...
       16 NEWTABLE                         R3 4 0
       18 GETUPVAL                         R4 0
       19 GETTABLEKS                       R4 R4 K6 ["INTERNAL_INIT_NAME"]
       21 NEWCLOSURE                       R5 P0
       22 CAPTURE                          VAL R0
       23 SETTABLE                         R5 R3 R4
       24 GETUPVAL                         R4 0
       25 GETTABLEKS                       R4 R4 K7 ["SEND_ANALYTICS_COUNTER_EVENT_NAME"]
       27 DUPCLOSURE                       R5 K8 [PROTO_13]
       28 CAPTURE                          UPVAL U1
       29 SETTABLE                         R5 R3 R4
       30 GETUPVAL                         R4 0
       31 GETTABLEKS                       R4 R4 K9 ["SEND_ANALYTICS_EVENT_NAME"]
       33 NEWCLOSURE                       R5 P2
       34 CAPTURE                          UPVAL U2
       35 CAPTURE                          VAL R0
       36 CAPTURE                          UPVAL U1
       ...
       45 MOVE                             R12 R7
       46 MOVE                             R13 R8
       47 NAMECALL                         R9 R0 K12 ["_setUpListener"]
       49 CALL                             R9 4 0
       50 FORGLOOP                         R4 2 ; [-7]
       52 GETTABLEKS                       R4 R0 K13 ["_themeChangedConnection"]
       54 JUMPIFNOTEQKNIL                  R4 ; [+14]
       56 GETUPVAL                         R4 4
       57 GETTABLEKS                       R4 R4 K14 ["getStudioThemeChangedSignal"]
       59 CALL                             R4 0 1
       60 NEWCLOSURE                       R6 P3
       61 CAPTURE                          VAL R0
       62 CAPTURE                          UPVAL U4
       63 CAPTURE                          VAL R2
       64 NAMECALL                         R4 R4 K15 ["Connect"]
       66 CALL                             R4 2 1
       67 SETTABLEKS                       R4 R0 K13 ["_themeChangedConnection"]
       69 GETTABLEKS                       R4 R0 K16 ["_volumeChangedConnection"]
       71 JUMPIFNOTEQKNIL                  R4 ; [+14]
       73 GETUPVAL                         R4 4
       74 GETTABLEKS                       R4 R4 K17 ["getStudioVolumeChangedSignal"]
       76 CALL                             R4 0 1
       77 NEWCLOSURE                       R6 P4
       78 CAPTURE                          VAL R0
       79 CAPTURE                          UPVAL U4
       80 CAPTURE                          VAL R2
       81 NAMECALL                         R4 R4 K15 ["Connect"]
       83 CALL                             R4 2 1
       84 SETTABLEKS                       R4 R0 K16 ["_volumeChangedConnection"]
       86 GETTABLEKS                       R4 R0 K0 ["props"]
       88 GETTABLEKS                       R4 R4 K18 ["eventHandlers"]
       90 JUMPIFNOT                        R4 ; [+16]
       91 GETIMPORT                        R4 K11 [pairs]
       93 GETTABLEKS                       R5 R0 K0 ["props"]
       95 GETTABLEKS                       R5 R5 K18 ["eventHandlers"]
       97 CALL                             R4 1 3
       98 FORGPREP_NEXT                    R4
       99 MOVE                             R11 R2
      100 MOVE                             R12 R7
      101 MOVE                             R13 R8
      102 NAMECALL                         R9 R0 K12 ["_setUpListener"]
      104 CALL                             R9 4 0
      105 FORGLOOP                         R4 2 ; [-7]
      107 GETTABLEKS                       R4 R0 K19 ["_managerComponent"]
      109 JUMPIFNOTEQKNIL                  R4 ; [+4]
      111 NAMECALL                         R4 R0 K20 ["setUpManagerComponent"]
      113 CALL                             R4 1 0
      114 GETUPVAL                         R4 2
      115 GETTABLEKS                       R4 R4 K21 ["onWebViewMounted"]
      117 GETTABLEKS                       R5 R0 K0 ["props"]
      119 GETTABLEKS                       R5 R5 K22 ["analyticsContext"]
      121 CALL                             R4 1 0
      122 RETURN                           R0 0
...
MAIN:
       ...
       74 GETTABLEKS                       R13 R13 K13 ["Parent"]
       76 GETTABLEKS                       R13 R13 K23 ["EventNames"]
       78 CALL                             R12 1 1
       79 GETIMPORT                        R13 K6 [require]
       81 GETIMPORT                        R14 K1 [script]
       83 GETTABLEKS                       R14 R14 K13 ["Parent"]
       85 GETTABLEKS                       R14 R14 K9 ["Util"]
       87 GETTABLEKS                       R14 R14 K24 ["Constants"]
       89 CALL                             R13 1 1
