...
PROTO_1:
       ...
       49 JUMPIF                           R2 ; [+21]
       50 GETUPVAL                         R4 0
       51 GETTABLEKS                       R3 R4 K19 ["Dictionary"]
       53 GETTABLEKS                       R2 R3 K20 ["join"]
       55 GETTABLEKS                       R3 R0 K4 ["plugin"]
       57 NAMECALL                         R3 R3 K21 ["GetUri"]
       59 CALL                             R3 1 1
       60 DUPTABLE                         R4 K24 [{"Category", "ItemId"}]
       61 LOADK                            R5 K25 ["Widgets"]
       62 SETTABLEKS                       R5 R4 K22 ["Category"]
       64 GETTABLEKS                       R6 R0 K0 ["namespace"]
       66 LOADK                            R7 K26 [":WebView"]
       67 CONCAT                           R5 R6 R7
       68 SETTABLEKS                       R5 R4 K23 ["ItemId"]
       70 CALL                             R2 2 1
       71 SETTABLEKS                       R2 R1 K12 ["_browserUri"]
       73 GETUPVAL                         R4 1
       74 FASTCALL2                        SETMETATABLE R1 R4 ; [+4]
       76 MOVE                             R3 R1
       77 GETIMPORT                        R2 K28 [setmetatable]
       79 CALL                             R2 2 0
       80 RETURN                           R1 1
...
PROTO_9:
        ...
        9 CALL                             R4 2 1
       10 GETUPVAL                         R7 1
       11 GETTABLEKS                       R6 R7 K1 ["_listeners"]
...
PROTO_10:
        ...
        3 JUMPIF                           R1 ; [+6]
        4 GETUPVAL                         R4 0
        5 GETTABLEKS                       R3 R4 K1 ["MessageBusErrorCode"]
        7 GETTABLEKS                       R2 R3 K2 ["WEBVIEW_NOT_INITIALIZED"]
        9 RETURN                           R2 1
...
PROTO_11:
        ...
        3 JUMPIF                           R4 ; [+6]
        4 GETUPVAL                         R7 0
        5 GETTABLEKS                       R6 R7 K1 ["MessageBusErrorCode"]
        7 GETTABLEKS                       R5 R6 K2 ["WEBVIEW_NOT_FOUND"]
        9 RETURN                           R5 1
       10 GETUPVAL                         R5 1
       11 MOVE                             R7 R2
...
PROTO_13:
       ...
       31 CALL                             R6 2 0
       32 GETUPVAL                         R8 0
       33 GETTABLEKS                       R7 R8 K12 ["Dictionary"]
       35 GETTABLEKS                       R6 R7 K13 ["join"]
...
PROTO_14:
        ...
        8 GETUPVAL                         R6 1
        9 GETTABLEKS                       R5 R6 K1 ["MessageBusEventType"]
       11 GETTABLEKS                       R4 R5 K2 ["Request"]
       13 JUMPIFNOTEQ                      R3 R4 ; [+19]
       15 GETUPVAL                         R3 2
       16 GETUPVAL                         R5 3
       17 DUPTABLE                         R6 K4 [{"type", "uuid"}]
       18 GETUPVAL                         R9 1
       19 GETTABLEKS                       R8 R9 K1 ["MessageBusEventType"]
       21 GETTABLEKS                       R7 R8 K5 ["Response"]
...
PROTO_15:
       ...
       34 CALL                             R6 2 0
       35 GETUPVAL                         R8 1
       36 GETTABLEKS                       R7 R8 K12 ["Dictionary"]
       38 GETTABLEKS                       R6 R7 K13 ["join"]
...
PROTO_17:
        ...
        5 RETURN                           R0 0
        6 GETUPVAL                         R4 1
        7 GETTABLEKS                       R3 R4 K1 ["_callUuidToCallbackMap"]
        9 GETUPVAL                         R4 0
       ...
       17 CALL                             R3 3 0
       18 GETUPVAL                         R4 1
       19 GETTABLEKS                       R3 R4 K1 ["_callUuidToCallbackMap"]
       21 GETUPVAL                         R4 0
       22 GETUPVAL                         R6 3
       23 GETTABLEKS                       R5 R6 K3 ["None"]
...
PROTO_18:
       ...
       12 CALL                             R5 3 1
       13 GETUPVAL                         R7 0
       14 GETTABLEKS                       R6 R7 K1 ["_callUuidToCallbackMap"]
       16 SETTABLE                         R5 R6 R2
       17 GETUPVAL                         R6 0
       18 GETUPVAL                         R9 1
       19 GETUPVAL                         R11 0
       20 GETTABLEKS                       R10 R11 K2 ["_namespace"]
       ...
       38 GETUPVAL                         R12 3
       39 GETTABLEKS                       R11 R12 K13 ["MessageBusEventType"]
       41 GETTABLEKS                       R10 R11 K14 ["Request"]
       ...
       51 LOADN                            R6 0
       52 GETUPVAL                         R8 0
       53 GETTABLEKS                       R7 R8 K16 ["_timeout"]
       55 JUMPIFNOTLE                      R6 R7 ; [+22]
       57 GETUPVAL                         R9 0
       58 GETTABLEKS                       R8 R9 K1 ["_callUuidToCallbackMap"]
       60 GETTABLE                         R7 R8 R2
       61 JUMPIFEQKNIL                     R7 ; [+16]
       63 GETUPVAL                         R9 0
       64 GETTABLEKS                       R8 R9 K1 ["_callUuidToCallbackMap"]
       66 GETTABLE                         R7 R8 R2
       67 GETUPVAL                         R9 2
       68 GETTABLEKS                       R8 R9 K17 ["None"]
       70 JUMPIFEQ                         R7 R8 ; [+7]
       ...
       77 JUMPBACK                         ; [-26]
       78 GETUPVAL                         R8 0
       79 GETTABLEKS                       R7 R8 K16 ["_timeout"]
       ...
       88 CALL                             R7 3 0
       89 GETUPVAL                         R8 0
       90 GETTABLEKS                       R7 R8 K1 ["_callUuidToCallbackMap"]
       92 GETUPVAL                         R9 2
       93 GETTABLEKS                       R8 R9 K17 ["None"]
       95 SETTABLE                         R8 R7 R2
       96 MOVE                             R7 R1
       97 GETUPVAL                         R10 3
       98 GETTABLEKS                       R9 R10 K22 ["MessageBusErrorCode"]
      100 GETTABLEKS                       R8 R9 K23 ["TIMED_OUT"]
      102 CALL                             R7 1 -1
      103 CLOSEUPVALS                      R3
      104 RETURN                           R7 -1
      105 MOVE                             R7 R0
...
PROTO_21:
       ...
       23 GETUPVAL                         R10 1
       24 GETTABLEKS                       R9 R10 K12 ["MessageBusEventType"]
       26 GETTABLEKS                       R8 R9 K13 ["Fire"]
...
PROTO_22:
        ...
        4 GETUPVAL                         R4 0
        5 GETTABLEKS                       R3 R4 K1 ["MessageBusErrorCode"]
        7 GETTABLEKS                       R2 R3 K2 ["WEBVIEW_NOT_FOUND"]
        9 RETURN                           R2 1
...
MAIN:
       ...
       23 CALL                             R3 1 1
       24 GETTABLEKS                       R5 R3 K12 ["ContextServices"]
       26 GETTABLEKS                       R4 R5 K13 ["ContextItem"]
       28 GETTABLEKS                       R6 R3 K14 ["Util"]
       30 GETTABLEKS                       R5 R6 K15 ["Promise"]
