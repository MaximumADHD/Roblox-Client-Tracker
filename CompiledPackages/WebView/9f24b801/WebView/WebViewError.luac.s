...
PROTO_2:
       ...
       48 GETUPVAL                         R7 2
       49 GETTABLEKS                       R7 R7 K18 ["Change"]
       51 GETTABLEKS                       R7 R7 K19 ["AbsoluteSize"]
       53 SETTABLE                         R3 R6 R7
       54 DUPTABLE                         R7 K22 [{"Text", "Button"}]
       55 GETUPVAL                         R8 2
       56 GETTABLEKS                       R8 R8 K2 ["createElement"]
       58 GETUPVAL                         R9 4
       59 DUPTABLE                         R10 K29 [{["AutomaticSize"], ["Font"], ["LayoutOrder"], ["Size"], ["Text"], ["TextWrapped"] = True, ["TextXAlignment"]}]
       60 GETIMPORT                        R11 K31 [Enum.AutomaticSize.Y]
       62 SETTABLEKS                       R11 R10 K23 ["AutomaticSize"]
       64 GETIMPORT                        R11 K33 [Enum.Font.SourceSansSemibold]
       66 SETTABLEKS                       R11 R10 K24 ["Font"]
       68 NAMECALL                         R11 R1 K34 ["getNextOrder"]
       70 CALL                             R11 1 1
       ...
       82 GETTABLEKS                       R11 R2 K35 ["title"]
       84 SETTABLEKS                       R11 R10 K20 ["Text"]
       86 GETIMPORT                        R11 K36 [Enum.TextXAlignment.Center]
       88 SETTABLEKS                       R11 R10 K28 ["TextXAlignment"]
       90 CALL                             R8 2 1
       91 SETTABLEKS                       R8 R7 K20 ["Text"]
       93 GETUPVAL                         R8 2
       94 GETTABLEKS                       R8 R8 K2 ["createElement"]
       96 GETUPVAL                         R9 5
       97 DUPTABLE                         R10 K40 [{["LayoutOrder"], ["Size"], ["Style"] = "RoundPrimary", ["Text"], ["OnClick"]}]
       98 NAMECALL                         R11 R1 K34 ["getNextOrder"]
      100 CALL                             R11 1 1
      101 SETTABLEKS                       R11 R10 K25 ["LayoutOrder"]
      103 GETIMPORT                        R11 K42 [UDim2.fromOffset]
      105 LOADN                            R12 120
      106 LOADN                            R13 32
      107 CALL                             R11 2 1
      108 SETTABLEKS                       R11 R10 K6 ["Size"]
      110 GETTABLEKS                       R11 R2 K43 ["buttonText"]
      112 SETTABLEKS                       R11 R10 K20 ["Text"]
      114 NEWCLOSURE                       R11 P1
      115 CAPTURE                          VAL R2
      116 SETTABLEKS                       R11 R10 K39 ["OnClick"]
      118 CALL                             R8 2 1
      119 SETTABLEKS                       R8 R7 K21 ["Button"]
      121 CALL                             R4 3 -1
      122 RETURN                           R4 -1
