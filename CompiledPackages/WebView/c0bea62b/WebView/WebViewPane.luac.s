PROTO_0:
       ...
       30 CALL                             R2 2 0
       31 GETUPVAL                         R3 0
       32 GETTABLEKS                       R3 R3 K3 ["prevSize"]
       34 JUMPIFNOT                        R3 ; [+6]
       35 GETUPVAL                         R2 0
       36 GETTABLEKS                       R2 R2 K3 ["prevSize"]
       38 GETTABLEKS                       R2 R2 K4 ["X"]
       40 JUMP                             ; [+1]
       41 LOADN                            R2 0
       42 GETUPVAL                         R4 0
       43 GETTABLEKS                       R4 R4 K3 ["prevSize"]
       45 JUMPIFNOT                        R4 ; [+6]
       46 GETUPVAL                         R3 0
       47 GETTABLEKS                       R3 R3 K3 ["prevSize"]
       49 GETTABLEKS                       R3 R3 K5 ["Y"]
       51 JUMP                             ; [+1]
       52 LOADN                            R3 0
       53 GETUPVAL                         R4 1
       54 GETTABLEKS                       R4 R4 K8 ["onWebViewInitialSizing"]
       56 GETUPVAL                         R5 0
       57 GETTABLEKS                       R5 R5 K9 ["props"]
       59 GETTABLEKS                       R5 R5 K10 ["analyticsContext"]
       61 MOVE                             R6 R2
       62 MOVE                             R7 R3
...
PROTO_1:
       ...
       34 CALL                             R0 2 0
       35 GETUPVAL                         R0 0
       36 GETTABLEKS                       R0 R0 K10 ["props"]
       38 GETTABLEKS                       R0 R0 K11 ["WebViewManagerContext"]
       40 NAMECALL                         R0 R0 K12 ["showBrowser"]
       42 CALL                             R0 1 0
       43 RETURN                           R0 0
       44 GETUPVAL                         R0 0
       45 GETTABLEKS                       R0 R0 K0 ["state"]
       47 GETTABLEKS                       R0 R0 K13 ["hasWebViewEverLoaded"]
       49 JUMPIF                           R0 ; [+43]
       50 GETUPVAL                         R0 0
       51 DUPTABLE                         R2 K14 [{"webViewLoadingStatus", "webViewError", "webViewRetryAttempt", "hasWebViewEverLoaded", "webViewReloading"}]
       52 GETUPVAL                         R3 1
       53 GETTABLEKS                       R3 R3 K2 ["WebViewLoadingStatus"]
       55 GETTABLEKS                       R3 R3 K15 ["PASSED"]
       57 SETTABLEKS                       R3 R2 K1 ["webViewLoadingStatus"]
       59 GETUPVAL                         R3 2
       60 GETTABLEKS                       R3 R3 K8 ["None"]
       ...
       75 CALL                             R0 2 0
       76 GETUPVAL                         R0 3
       77 GETTABLEKS                       R0 R0 K16 ["onWebViewInit"]
       79 GETUPVAL                         R1 0
       80 GETTABLEKS                       R1 R1 K10 ["props"]
       82 GETTABLEKS                       R1 R1 K17 ["analyticsContext"]
       84 CALL                             R0 1 0
       85 GETUPVAL                         R0 0
       86 GETTABLEKS                       R0 R0 K10 ["props"]
       88 GETTABLEKS                       R0 R0 K11 ["WebViewManagerContext"]
...
PROTO_3:
        ...
        7 GETUPVAL                         R2 0
        8 GETTABLEKS                       R2 R2 K7 ["WebViewLoadingStatus"]
       10 GETTABLEKS                       R2 R2 K8 ["WAITING"]
