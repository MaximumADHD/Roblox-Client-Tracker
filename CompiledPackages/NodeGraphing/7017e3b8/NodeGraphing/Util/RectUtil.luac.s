PROTO_0:
        ...
        4 GETTABLEKS                       R4 R1 K0 ["Min"]
        6 GETTABLEKS                       R4 R4 K1 ["X"]
        8 FASTCALL2                        MATH_MIN R3 R4 ; [+3]
       10 GETIMPORT                        R2 K4 [math.min]
       12 CALL                             R2 2 1
       13 GETTABLEKS                       R4 R0 K0 ["Min"]
       15 GETTABLEKS                       R4 R4 K5 ["Y"]
       17 GETTABLEKS                       R5 R1 K0 ["Min"]
       19 GETTABLEKS                       R5 R5 K5 ["Y"]
       21 FASTCALL2                        MATH_MIN R4 R5 ; [+3]
       23 GETIMPORT                        R3 K4 [math.min]
       25 CALL                             R3 2 1
       26 GETTABLEKS                       R5 R0 K6 ["Max"]
       28 GETTABLEKS                       R5 R5 K1 ["X"]
       30 GETTABLEKS                       R6 R1 K6 ["Max"]
       32 GETTABLEKS                       R6 R6 K1 ["X"]
       34 FASTCALL2                        MATH_MAX R5 R6 ; [+3]
       36 GETIMPORT                        R4 K8 [math.max]
       38 CALL                             R4 2 1
       39 GETTABLEKS                       R6 R0 K6 ["Max"]
       41 GETTABLEKS                       R6 R6 K5 ["Y"]
       43 GETTABLEKS                       R7 R1 K6 ["Max"]
       45 GETTABLEKS                       R7 R7 K5 ["Y"]
...
PROTO_1:
        ...
        6 SUB                              R3 R4 R1
        7 GETTABLEKS                       R5 R0 K3 ["Min"]
        9 GETTABLEKS                       R5 R5 K5 ["Y"]
       11 SUB                              R4 R5 R1
       12 GETTABLEKS                       R6 R0 K6 ["Max"]
       14 GETTABLEKS                       R6 R6 K4 ["X"]
       16 ADD                              R5 R6 R1
       17 GETTABLEKS                       R7 R0 K6 ["Max"]
       19 GETTABLEKS                       R7 R7 K5 ["Y"]
       21 ADD                              R6 R7 R1
       22 CALL                             R2 4 -1
       23 RETURN                           R2 -1

PROTO_2:
        0 GETTABLEKS                       R4 R0 K1 ["Min"]
        2 GETTABLEKS                       R4 R4 K2 ["X"]
        4 GETTABLEKS                       R5 R0 K3 ["Max"]
        6 GETTABLEKS                       R5 R5 K2 ["X"]
        8 ADD                              R3 R4 R5
        9 DIVK                             R2 R3 K0 [2]
       10 GETTABLEKS                       R5 R0 K1 ["Min"]
       12 GETTABLEKS                       R5 R5 K4 ["Y"]
       14 GETTABLEKS                       R6 R0 K3 ["Max"]
...
PROTO_3:
        0 LOADB                            R1 1
        1 GETTABLEKS                       R2 R0 K0 ["Width"]
        3 JUMPIFEQKN                       R2 K1 [0] ; [+7]
        5 GETTABLEKS                       R2 R0 K2 ["Height"]
...
MAIN:
       ...
       13 SETTABLEKS                       R1 R0 K7 ["isZeroSized"]
       15 RETURN                           R0 1
