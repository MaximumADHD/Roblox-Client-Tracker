...
PROTO_14:
      ...
      366 CALL                             R26 2 -1
      367 CALL                             R25 -1 1
      368 DUPTABLE                         R26 K44 [{"text", "editName", "GraphPayload", "Position", "Size", "Selected", "Collapsed", "ZIndex", "OnDragStart", "OnDragMoved", "OnDragEnded", "OnPropertyChanged", "PropertyLookup", "StateLookup"}]
      369 GETTABLEKS                       R27 R15 K45 ["displayName"]
      371 SETTABLEKS                       R27 R26 K30 ["text"]
      373 GETTABLEKS                       R27 R15 K31 ["editName"]
      375 SETTABLEKS                       R27 R26 K31 ["editName"]
      377 GETTABLEKS                       R27 R0 K5 ["node"]
      379 SETTABLEKS                       R27 R26 K32 ["GraphPayload"]
      381 MOVE                             R27 R8
      382 JUMPIF                           R27 ; [+2]
      383 GETIMPORT                        R27 K48 [Vector2.zero]
      385 SETTABLEKS                       R27 R26 K33 ["Position"]
      387 JUMPIFNOT                        R10 ; [+6]
      388 GETTABLEKS                       R27 R10 K49 ["size"]
      390 JUMPIF                           R27 ; [+5]
      391 GETIMPORT                        R27 K48 [Vector2.zero]
      393 JUMP                             ; [+2]
      394 GETIMPORT                        R27 K48 [Vector2.zero]
      396 SETTABLEKS                       R27 R26 K34 ["Size"]
      398 JUMPIFNOT                        R10 ; [+3]
      399 GETTABLEKS                       R27 R10 K12 ["isSelected"]
      401 JUMP                             ; [+1]
      402 LOADB                            R27 0
      403 SETTABLEKS                       R27 R26 K35 ["Selected"]
      405 JUMPIFNOT                        R10 ; [+3]
      406 GETTABLEKS                       R27 R10 K50 ["isCollapsed"]
      408 JUMP                             ; [+1]
      409 LOADB                            R27 0
      410 SETTABLEKS                       R27 R26 K36 ["Collapsed"]
      412 SETTABLEKS                       R11 R26 K37 ["ZIndex"]
      414 SETTABLEKS                       R12 R26 K38 ["OnDragStart"]
      416 SETTABLEKS                       R13 R26 K39 ["OnDragMoved"]
      418 SETTABLEKS                       R14 R26 K40 ["OnDragEnded"]
      420 SETTABLEKS                       R19 R26 K41 ["OnPropertyChanged"]
      422 SETTABLEKS                       R24 R26 K42 ["PropertyLookup"]
      424 MOVE                             R27 R25
      425 JUMPIF                           R27 ; [+1]
      426 GETUPVAL                         R27 18
      427 SETTABLEKS                       R27 R26 K43 ["StateLookup"]
      429 LOADNIL                          R27
      430 JUMPIFNOT                        R20 ; [+2]
      431 GETUPVAL                         R27 19
      432 JUMP                             ; [+32]
      433 GETTABLEKS                       R28 R0 K5 ["node"]
      435 GETTABLEKS                       R28 R28 K23 ["nodeType"]
      437 JUMPIFNOT                        R28 ; [+5]
      438 GETTABLEKS                       R29 R0 K5 ["node"]
      440 GETTABLEKS                       R29 R29 K23 ["nodeType"]
      442 GETTABLE                         R28 R2 R29
      443 GETUPVAL                         R29 20
      444 JUMPIFNOT                        R29 ; [+4]
      445 JUMPIFEQKNIL                     R28 ; [+2]
      447 LOADB                            R29 0 +1
      448 LOADB                            R29 1
      449 SETTABLEKS                       R29 R26 K51 ["IsGeneric"]
      451 JUMPIFNOT                        R28 ; [+3]
      452 GETTABLEKS                       R27 R28 K52 ["render"]
      454 JUMP                             ; [+1]
      455 GETUPVAL                         R27 21
      456 GETIMPORT                        R29 K54 [game]
      458 LOADK                            R31 K55 ["DebugDisableCustomNodes"]
      459 LOADB                            R32 0
      460 NAMECALL                         R29 R29 K56 ["DefineFastFlag"]
      462 CALL                             R29 3 1
      463 JUMPIFNOT                        R29 ; [+1]
      464 GETUPVAL                         R27 21
      465 GETUPVAL                         R28 0
      466 GETTABLEKS                       R28 R28 K57 ["createElement"]
      468 GETUPVAL                         R29 0
      469 GETTABLEKS                       R29 R29 K58 ["Fragment"]
      471 NEWTABLE                         R30 0 0
      473 GETUPVAL                         R31 0
      474 GETTABLEKS                       R31 R31 K57 ["createElement"]
      476 MOVE                             R32 R27
      477 MOVE                             R33 R26
      478 CALL                             R31 2 1
      479 MOVE                             R32 R18
...
MAIN:
      ...
      152 CALL                             R20 1 1
      153 GETIMPORT                        R21 K32 [game]
      155 LOADK                            R23 K33 ["DebugAGEHighlightGenericNodes"]
      156 LOADB                            R24 0
      157 NAMECALL                         R21 R21 K34 ["DefineFastFlag"]
      159 CALL                             R21 3 1
      160 GETIMPORT                        R22 K5 [require]
      162 GETTABLEKS                       R23 R0 K29 ["Flags"]
      164 GETTABLEKS                       R23 R23 K35 ["getFFlagAnimGraphUILetAllParametersOverridable"]
      166 CALL                             R22 1 1
      167 GETIMPORT                        R23 K5 [require]
      169 GETTABLEKS                       R24 R0 K29 ["Flags"]
      171 GETTABLEKS                       R24 R24 K36 ["getFFlagAnimGraphUI_FixInputPanelParameters"]
      173 CALL                             R23 1 1
      174 NEWTABLE                         R24 0 0
      176 DUPCLOSURE                       R25 K37 [PROTO_14]
      177 CAPTURE                          VAL R12
      178 CAPTURE                          VAL R7
      179 CAPTURE                          VAL R9
      180 CAPTURE                          VAL R11
      ...
      197 CAPTURE                          VAL R21
      198 CAPTURE                          VAL R2
      199 GETTABLEKS                       R26 R12 K38 ["memo"]
      201 MOVE                             R27 R25
      202 CALL                             R26 1 -1
      203 RETURN                           R26 -1
