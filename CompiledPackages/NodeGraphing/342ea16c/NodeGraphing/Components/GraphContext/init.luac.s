...
MAIN:
       ...
       72 DUPTABLE                         R7 K52 [{"nodePayloadDispatcher", "nodeRenderInfoDispatcher", "reorderPins", "createNode", "createParameter", "createConnectedParameterAsync", "createExistingParameterAsync", "selectAllParameterNodesWithName", "selectNodes", "setNodePositions", "setNodeSize", "deleteNodeInput", "removeNodeInputConnectionAsync", "removeNodeOutputConnectionAsync", "removeParameter", "renameNode", "renameParameter", "deleteNodeInstance", "removeNodes", "setNodeConnection", "setCollapsed", "setZIndex", "setNodeProperty", "setInputPinNodeProperty", "setParameterNodeType", "observeNodePropsById", "observeNodeStateById"}]
      ...
      193 LOADK                            R9 K46 ["setZIndex"]
      194 CALL                             R8 1 1
      195 SETTABLEKS                       R8 R7 K46 ["setZIndex"]
      197 GETTABLEKS                       R8 R3 K21 ["createUnimplemented"]
      199 LOADK                            R9 K47 ["setNodeProperty"]
      200 CALL                             R8 1 1
      201 SETTABLEKS                       R8 R7 K47 ["setNodeProperty"]
      203 GETTABLEKS                       R8 R3 K21 ["createUnimplemented"]
      205 LOADK                            R9 K48 ["setInputPinNodeProperty"]
      206 CALL                             R8 1 1
      207 SETTABLEKS                       R8 R7 K48 ["setInputPinNodeProperty"]
      209 GETTABLEKS                       R8 R3 K21 ["createUnimplemented"]
      211 LOADK                            R9 K49 ["setParameterNodeType"]
      212 CALL                             R8 1 1
      213 SETTABLEKS                       R8 R7 K49 ["setParameterNodeType"]
      215 DUPCLOSURE                       R8 K53 [PROTO_3]
      216 CAPTURE                          VAL R4
      217 SETTABLEKS                       R8 R7 K50 ["observeNodePropsById"]
      219 DUPCLOSURE                       R8 K54 [PROTO_4]
      220 CAPTURE                          VAL R4
      221 SETTABLEKS                       R8 R7 K51 ["observeNodeStateById"]
      223 GETTABLEKS                       R8 R2 K55 ["createContext"]
      225 MOVE                             R9 R7
      226 CALL                             R8 1 1
      227 DUPCLOSURE                       R9 K56 [PROTO_5]
      228 CAPTURE                          VAL R2
      229 CAPTURE                          VAL R8
      230 DUPTABLE                         R10 K59 [{"Context", "Provider"}]
      231 SETTABLEKS                       R8 R10 K57 ["Context"]
      233 SETTABLEKS                       R9 R10 K58 ["Provider"]
      235 RETURN                           R10 1
