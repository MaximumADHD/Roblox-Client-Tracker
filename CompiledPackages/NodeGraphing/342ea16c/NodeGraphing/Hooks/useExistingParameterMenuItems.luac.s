...
PROTO_6:
       ...
       30 NEWTABLE                         R1 0 0
       32 MOVE                             R3 R1
       33 GETIMPORT                        R4 K2 [table.freeze]
       35 DUPTABLE                         R5 K13 [{"items"}]
       36 GETIMPORT                        R6 K2 [table.freeze]
       38 NEWTABLE                         R7 0 1
       40 GETIMPORT                        R8 K2 [table.freeze]
       42 DUPTABLE                         R9 K15 [{["id"], ["text"] = "New Parameter", ["isDisabled"] = False}]
       43 GETUPVAL                         R10 2
       44 GETTABLEKS                       R10 R10 K16 ["PARAMETER_NODE_CLASSNAME"]
       46 SETTABLEKS                       R10 R9 K3 ["id"]
       48 CALL                             R8 1 -1
       49 SETLIST                          R7 R8 -1 [1]
       51 CALL                             R6 1 1
       52 SETTABLEKS                       R6 R5 K12 ["items"]
       54 CALL                             R4 1 -1
       55 FASTCALL                         TABLE_INSERT ; [+2]
       56 GETIMPORT                        R2 K11 [table.insert]
       58 CALL                             R2 -1 0
       59 GETIMPORT                        R2 K18 [next]
       61 MOVE                             R3 R0
       62 CALL                             R2 1 1
       63 JUMPIFNOT                        R2 ; [+15]
       64 MOVE                             R3 R1
       65 GETIMPORT                        R4 K2 [table.freeze]
       67 DUPTABLE                         R5 K13 [{"items"}]
       68 GETIMPORT                        R6 K2 [table.freeze]
       70 MOVE                             R7 R0
       71 CALL                             R6 1 1
       72 SETTABLEKS                       R6 R5 K12 ["items"]
       74 CALL                             R4 1 -1
       75 FASTCALL                         TABLE_INSERT ; [+2]
       76 GETIMPORT                        R2 K11 [table.insert]
       78 CALL                             R2 -1 0
       79 GETIMPORT                        R2 K2 [table.freeze]
       81 MOVE                             R3 R1
       82 CALL                             R2 1 -1
       83 RETURN                           R2 -1
...
MAIN:
       ...
       67 CALL                             R9 1 1
       68 DUPCLOSURE                       R10 K19 [PROTO_0]
       69 DUPCLOSURE                       R11 K20 [PROTO_1]
       70 DUPCLOSURE                       R12 K21 [PROTO_7]
       71 CAPTURE                          VAL R6
       72 CAPTURE                          VAL R4
       73 CAPTURE                          VAL R3
       74 CAPTURE                          VAL R9
