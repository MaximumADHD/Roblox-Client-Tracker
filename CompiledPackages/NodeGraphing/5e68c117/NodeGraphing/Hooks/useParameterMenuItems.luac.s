PROTO_0:
       ...
       23 MOVE                             R3 R1
       24 CALL                             R2 1 1
       25 LOADK                            R3 K8 ["%*Parameter"]
       26 MOVE                             R5 R0
       27 NAMECALL                         R3 R3 K9 ["format"]
       29 CALL                             R3 2 1
       30 MOVE                             R4 R3
       31 GETUPVAL                         R5 2
       32 GETTABLEKS                       R5 R5 K10 ["observeParameters"]
       34 LOADB                            R6 0
       35 CALL                             R5 1 1
       36 JUMPIF                           R5 ; [+2]
       37 NEWTABLE                         R5 0 0
       39 LOADN                            R6 0
       40 GETTABLE                         R7 R5 R4
       41 JUMPIFEQKNIL                     R7 ; [+10]
       43 ADDK                             R6 R6 K11 [1]
       44 LOADK                            R7 K12 ["%*%*"]
       45 MOVE                             R9 R3
       46 MOVE                             R10 R6
       ...
       51 JUMPBACK                         ; [-12]
       52 GETUPVAL                         R7 3
       53 GETTABLEKS                       R7 R7 K13 ["createParameter"]
       55 DUPTABLE                         R8 K18 [{"parameterType", "parameterName", "pinPosition", "initializeWithValue"}]
       56 SETTABLEKS                       R0 R8 K14 ["parameterType"]
       58 SETTABLEKS                       R4 R8 K15 ["parameterName"]
       60 SETTABLEKS                       R2 R8 K16 ["pinPosition"]
       62 GETUPVAL                         R9 2
       63 GETTABLEKS                       R9 R9 K19 ["getDefaultValue"]
       65 JUMPIFNOT                        R9 ; [+5]
       66 GETUPVAL                         R9 2
       67 GETTABLEKS                       R9 R9 K19 ["getDefaultValue"]
       69 MOVE                             R10 R0
       70 CALL                             R9 1 1
       71 SETTABLEKS                       R9 R8 K17 ["initializeWithValue"]
       73 CALL                             R7 1 0
       74 GETUPVAL                         R7 4
       75 JUMPIFEQKNIL                     R7 ; [+3]
       77 GETUPVAL                         R7 4
       78 CALL                             R7 0 0
       79 RETURN                           R0 0
...
PROTO_3:
       ...
       29 RETURN                           R0 1
       30 NEWTABLE                         R2 0 1
       32 DUPTABLE                         R3 K9 [{["title"] = "New Parameter", ["items"]}]
       33 SETTABLEKS                       R0 R3 K8 ["items"]
       35 SETLIST                          R2 R3 1 [1]
       37 GETUPVAL                         R4 5
       38 LENGTH                           R3 R4
       39 LOADN                            R4 0
       40 JUMPIFNOTLT                      R4 R3 ; [+32]
       42 NEWTABLE                         R3 0 0
       44 GETUPVAL                         R4 5
       45 LOADNIL                          R5
       46 LOADNIL                          R6
       47 FORGPREP                         R4
       48 DUPTABLE                         R11 K12 [{"id", "text", "onActivated"}]
       49 SETTABLEKS                       R8 R11 K10 ["id"]
       51 SETTABLEKS                       R8 R11 K11 ["text"]
       53 GETUPVAL                         R12 6
       54 SETTABLEKS                       R12 R11 K5 ["onActivated"]
       56 FASTCALL2                        TABLE_INSERT R3 R11 ; [+4]
       58 MOVE                             R10 R3
       59 GETIMPORT                        R9 K14 [table.insert]
       61 CALL                             R9 2 0
       62 FORGLOOP                         R4 2 ; [-15]
       64 DUPTABLE                         R6 K16 [{["title"] = "Existing Parameters", ["items"]}]
       65 SETTABLEKS                       R3 R6 K8 ["items"]
       67 FASTCALL2                        TABLE_INSERT R2 R6 ; [+4]
       69 MOVE                             R5 R2
       70 GETIMPORT                        R4 K14 [table.insert]
       72 CALL                             R4 2 0
       73 RETURN                           R2 1
