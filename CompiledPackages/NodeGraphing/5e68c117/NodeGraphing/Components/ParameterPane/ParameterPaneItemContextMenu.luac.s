...
PROTO_5:
        ...
        3 NEWTABLE                         R2 0 4
        5 DUPTABLE                         R3 K6 [{["id"] = "Insert", ["text"] = "Insert", ["onActivated"]}]
        6 GETUPVAL                         R4 0
        7 SETTABLEKS                       R4 R3 K5 ["onActivated"]
        9 DUPTABLE                         R4 K8 [{["id"] = "Rename", ["text"] = "Rename", ["onActivated"]}]
       10 GETUPVAL                         R5 1
       11 SETTABLEKS                       R5 R4 K5 ["onActivated"]
       13 DUPTABLE                         R5 K10 [{["id"] = "Delete", ["text"] = "Delete", ["onActivated"]}]
       14 GETUPVAL                         R6 2
       15 SETTABLEKS                       R6 R5 K5 ["onActivated"]
       17 DUPTABLE                         R6 K13 [{["id"] = "ChangeType", ["text"] = "Change Type", [3], ["onActivated"]}]
       18 GETUPVAL                         R7 3
       19 GETTABLEKS                       R7 R7 K14 ["parameterMenuItems"]
       21 JUMPIF                           R7 ; [+3]
       22 GETUPVAL                         R7 4
       23 GETTABLEKS                       R7 R7 K15 ["PARAMETER_MENUITEM_TABLE"]
       25 SETTABLEKS                       R7 R6 K0 ["items"]
       27 DUPCLOSURE                       R7 K16 [PROTO_4]
       28 SETTABLEKS                       R7 R6 K5 ["onActivated"]
       30 SETLIST                          R2 R3 4 [1]
       32 SETTABLEKS                       R2 R1 K0 ["items"]
