...
PROTO_1:
       ...
       96 JUMPIFNOT                        R2 ; [+1]
       97 RETURN                           R0 0
       98 DUPTABLE                         R0 K31 [{["threadId"], ["messages"], ["tools"], ["system"], ["messageGuid"], ["isFirstMessage"] = False, ["isAgenticMode"], ["apiKeys"], ["selectedModel"], ["selectedProvider"], ["conversationUrl"], ["isSubagent"], ["assistantMode"]}]
       99 GETUPVAL                         R1 1
      ...
      139 GETUPVAL                         R1 1
      140 GETTABLEKS                       R1 R1 K12 ["selectedProvider"]
      142 SETTABLEKS                       R1 R0 K12 ["selectedProvider"]
      144 GETUPVAL                         R1 1
      145 GETTABLEKS                       R1 R1 K28 ["conversationUrl"]
      147 SETTABLEKS                       R1 R0 K28 ["conversationUrl"]
      149 GETUPVAL                         R1 1
      150 GETTABLEKS                       R1 R1 K29 ["isSubagent"]
      152 SETTABLEKS                       R1 R0 K29 ["isSubagent"]
      154 GETUPVAL                         R1 1
      155 GETTABLEKS                       R1 R1 K30 ["assistantMode"]
      157 SETTABLEKS                       R1 R0 K30 ["assistantMode"]
      159 GETUPVAL                         R1 6
      160 GETUPVAL                         R2 4
      161 GETUPVAL                         R3 0
      162 GETTABLEKS                       R3 R3 K33 ["resumedToolCallCount"]
      164 GETUPVAL                         R4 0
      165 GETTABLEKS                       R4 R4 K34 ["inputTokenLimitRetryCount"]
      167 CALL                             R1 3 1
      168 FASTCALL2K                       ASSERT R1 K35 ; [+5]
      170 MOVE                             R3 R1
      171 LOADK                            R4 K35 ["Failed to create new session"]
      172 GETIMPORT                        R2 K37 [assert]
      174 CALL                             R2 2 0
      175 SETUPVAL                         R1 7
      176 GETUPVAL                         R2 1
      177 GETTABLEKS                       R2 R2 K8 ["requestLLM"]
      179 MOVE                             R3 R0
      180 GETTABLEKS                       R4 R1 K38 ["processEvent"]
      182 CALL                             R2 2 0
      183 RETURN                           R0 0
