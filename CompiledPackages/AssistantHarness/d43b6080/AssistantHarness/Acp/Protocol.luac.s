...
PROTO_7:
       ...
       20 DUPTABLE                         R5 K12 [{"jsonrpc", "id", "method", "params"}]
       21 LOADK                            R6 K13 ["2.0"]
       22 SETTABLEKS                       R6 R5 K8 ["jsonrpc"]
       24 SETTABLEKS                       R4 R5 K9 ["id"]
       26 SETTABLEKS                       R1 R5 K10 ["method"]
       28 SETTABLEKS                       R2 R5 K11 ["params"]
       30 GETUPVAL                         R6 0
       31 GETTABLEKS                       R6 R6 K14 ["new"]
       33 NEWCLOSURE                       R7 P0
       34 CAPTURE                          VAL R0
       35 CAPTURE                          VAL R4
       36 CAPTURE                          VAL R3
...
PROTO_8:
        ...
        6 GETIMPORT                        R4 K3 [assert]
        8 CALL                             R4 2 0
        9 DUPTABLE                         R4 K7 [{"jsonrpc", "method", "params"}]
       10 LOADK                            R5 K8 ["2.0"]
       11 SETTABLEKS                       R5 R4 K4 ["jsonrpc"]
       13 SETTABLEKS                       R1 R4 K5 ["method"]
       15 SETTABLEKS                       R2 R4 K6 ["params"]
       17 GETTABLEKS                       R5 R3 K9 ["sendNotification"]
       19 MOVE                             R6 R4
       20 CALL                             R5 1 -1
       21 RETURN                           R5 -1
...
PROTO_12:
        0 DUPTABLE                         R3 K3 [{"jsonrpc", "id", "error"}]
        1 LOADK                            R4 K4 ["2.0"]
        2 SETTABLEKS                       R4 R3 K0 ["jsonrpc"]
        4 SETTABLEKS                       R0 R3 K1 ["id"]
        6 DUPTABLE                         R4 K7 [{"code", "message"}]
        7 SETTABLEKS                       R1 R4 K5 ["code"]
        9 SETTABLEKS                       R2 R4 K6 ["message"]
       11 SETTABLEKS                       R4 R3 K2 ["error"]
       13 RETURN                           R3 1
...
PROTO_14:
        ...
        3 DUPTABLE                         R2 K4 [{"jsonrpc", "id", "result"}]
        4 LOADK                            R3 K5 ["2.0"]
        5 SETTABLEKS                       R3 R2 K1 ["jsonrpc"]
        7 GETUPVAL                         R3 1
        8 GETTABLEKS                       R3 R3 K2 ["id"]
       10 SETTABLEKS                       R3 R2 K2 ["id"]
       12 MOVE                             R3 R0
       13 JUMPIF                           R3 ; [+2]
       14 NEWTABLE                         R3 0 0
       16 SETTABLEKS                       R3 R2 K3 ["result"]
       18 CALL                             R1 1 0
       19 RETURN                           R0 0
...
PROTO_15:
       ...
       25 MOVE                             R6 R1
       26 MOVE                             R7 R2
       27 DUPTABLE                         R4 K11 [{"jsonrpc", "id", "error"}]
       28 LOADK                            R8 K12 ["2.0"]
       29 SETTABLEKS                       R8 R4 K9 ["jsonrpc"]
       31 SETTABLEKS                       R5 R4 K8 ["id"]
       33 DUPTABLE                         R8 K13 [{"code", "message"}]
       34 SETTABLEKS                       R6 R8 K5 ["code"]
       36 SETTABLEKS                       R7 R8 K6 ["message"]
       38 SETTABLEKS                       R8 R4 K10 ["error"]
       40 CALL                             R3 1 0
       41 RETURN                           R0 0
...
PROTO_17:
       ...
       19 CALL                             R8 2 1
       20 MOVE                             R7 R8
       21 DUPTABLE                         R5 K9 [{"jsonrpc", "id", "error"}]
       22 LOADK                            R8 K10 ["2.0"]
       23 SETTABLEKS                       R8 R5 K7 ["jsonrpc"]
       25 SETTABLEKS                       R6 R5 K4 ["id"]
       27 DUPTABLE                         R8 K13 [{"code", "message"}]
       28 LOADN                            R9 167
       29 SETTABLEKS                       R9 R8 K11 ["code"]
       31 SETTABLEKS                       R7 R8 K12 ["message"]
       33 SETTABLEKS                       R8 R5 K8 ["error"]
       35 CALL                             R4 1 0
       36 RETURN                           R0 0
       37 GETUPVAL                         R4 0
       38 GETTABLEKS                       R4 R4 K14 ["new"]
       40 NEWCLOSURE                       R5 P0
       41 CAPTURE                          VAL R3
       42 CAPTURE                          VAL R1
       43 CAPTURE                          UPVAL U0
       ...
       49 CAPTURE                          VAL R2
       50 CAPTURE                          VAL R1
       51 NAMECALL                         R4 R4 K15 ["andThen"]
       53 CALL                             R4 3 1
       54 DUPCLOSURE                       R6 K16 [PROTO_16]
       55 NAMECALL                         R4 R4 K17 ["catch"]
       57 CALL                             R4 2 0
       58 RETURN                           R0 0
