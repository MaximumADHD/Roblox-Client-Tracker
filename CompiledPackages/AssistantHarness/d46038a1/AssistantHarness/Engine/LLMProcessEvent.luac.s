...
PROTO_7:
      ...
      444 DUPTABLE                         R7 K70 [{[1] = "tool_result", ["id"], ["name"], ["content"], ["isError"] = False, ["structuredContent"], ["startTime"], ["startTimeAfterConfirmation"]}]
      445 GETUPVAL                         R8 0
      446 GETTABLEKS                       R8 R8 K2 ["id"]
      448 SETTABLEKS                       R8 R7 K2 ["id"]
      450 GETUPVAL                         R8 0
      451 GETTABLEKS                       R8 R8 K3 ["name"]
      453 SETTABLEKS                       R8 R7 K3 ["name"]
      455 NEWTABLE                         R8 0 1
      457 MOVE                             R9 R6
      458 SETLIST                          R8 R9 1 [1]
      460 SETTABLEKS                       R8 R7 K26 ["content"]
      462 DUPTABLE                         R8 K72 [{["rejected"] = True}]
      463 SETTABLEKS                       R8 R7 K65 ["structuredContent"]
      465 SETTABLEKS                       R2 R7 K29 ["startTime"]
      467 SETTABLEKS                       R5 R7 K30 ["startTimeAfterConfirmation"]
      469 GETUPVAL                         R8 4
      470 JUMPIFNOT                        R8 ; [+8]
      471 GETUPVAL                         R8 3
      472 GETTABLEKS                       R8 R8 K22 ["observer"]
      474 GETTABLEKS                       R8 R8 K36 ["onToolResult"]
      476 GETUPVAL                         R9 4
      477 MOVE                             R10 R7
      478 CALL                             R8 2 0
      479 DUPTABLE                         R8 K40 [{"toolUse", "toolResult", "invocationIndex"}]
      480 SETTABLEKS                       R0 R8 K37 ["toolUse"]
      482 SETTABLEKS                       R7 R8 K38 ["toolResult"]
      484 GETUPVAL                         R9 7
      485 SETTABLEKS                       R9 R8 K39 ["invocationIndex"]
      487 RETURN                           R8 1
...
PROTO_24:
       ...
       89 CAPTURE                          UPVAL U7
       90 CAPTURE                          VAL R0
       91 NEWCLOSURE                       R11 P5
       92 CAPTURE                          VAL R5
       93 CAPTURE                          VAL R0
       94 NEWCLOSURE                       R12 P6
       95 CAPTURE                          VAL R5
       96 CAPTURE                          VAL R0
       97 NEWCLOSURE                       R13 P7
       98 CAPTURE                          VAL R5
       99 CAPTURE                          VAL R0
      100 NEWCLOSURE                       R14 P8
      101 CAPTURE                          VAL R5
      102 CAPTURE                          VAL R8
      103 CAPTURE                          VAL R9
      104 CAPTURE                          VAL R10
      ...
      142 GETTABLEKS                       R18 R4 K29 ["onTimeout"]
      144 NEWCLOSURE                       R20 P12
      145 CAPTURE                          VAL R17
      146 NAMECALL                         R18 R18 K30 ["Connect"]
      148 CALL                             R18 2 1
      149 LOADB                            R19 0
      150 LOADB                            R20 0
      151 DUPTABLE                         R21 K37 [{"state", "processEvent", "close", "cancel", "isClosed", "isCanceled"}]
      152 SETTABLEKS                       R5 R21 K31 ["state"]
      154 SETTABLEKS                       R17 R21 K32 ["processEvent"]
      156 NEWCLOSURE                       R22 P13
      157 CAPTURE                          REF R19
      158 CAPTURE                          VAL R18
      159 CAPTURE                          VAL R4
      160 CAPTURE                          VAL R5
      161 CAPTURE                          VAL R0
      162 SETTABLEKS                       R22 R21 K33 ["close"]
      164 NEWCLOSURE                       R22 P14
      165 CAPTURE                          REF R3
      166 CAPTURE                          REF R20
      167 CAPTURE                          VAL R0
      168 CAPTURE                          VAL R5
      169 SETTABLEKS                       R22 R21 K34 ["cancel"]
      171 NEWCLOSURE                       R22 P15
      172 CAPTURE                          REF R19
      173 SETTABLEKS                       R22 R21 K35 ["isClosed"]
      175 NEWCLOSURE                       R22 P16
      176 CAPTURE                          REF R20
      177 SETTABLEKS                       R22 R21 K36 ["isCanceled"]
      179 MOVE                             R3 R21
      180 SETUPVAL                         R3 5
      181 CLOSEUPVALS                      R3
      182 RETURN                           R3 1
