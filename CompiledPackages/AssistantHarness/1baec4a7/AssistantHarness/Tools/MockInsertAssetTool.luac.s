PROTO_0:
        0 GETUPVAL                         R3 0
        1 CALL                             R3 0 1
        2 LOADK                            R5 K0 ["Inserted asset %* as \"%*\""]
        3 GETTABLEKS                       R7 R0 K1 ["assetId"]
        5 GETTABLEKS                       R9 R0 K3 ["assetName"]
        7 ORK                              R8 R9 K2 ["MockAsset"]
        8 NAMECALL                         R5 R5 K4 ["format"]
       10 CALL                             R5 3 1
       11 NAMECALL                         R3 R3 K5 ["addText"]
       13 CALL                             R3 2 1
       14 NEWTABLE                         R5 8 0
       16 LOADK                            R6 K6 ["roblox://widget/AssetInsertResult/v1"]
       17 SETTABLEKS                       R6 R5 K7 ["$schema"]
       19 LOADK                            R6 K8 ["ok"]
       20 SETTABLEKS                       R6 R5 K9 ["status"]
       22 LOADK                            R6 K10 ["mock_insert_tag"]
       23 SETTABLEKS                       R6 R5 K11 ["tag"]
       25 GETTABLEKS                       R7 R0 K3 ["assetName"]
       27 ORK                              R6 R7 K2 ["MockAsset"]
       28 SETTABLEKS                       R6 R5 K3 ["assetName"]
       30 LOADK                            R6 K12 ["Model"]
       31 SETTABLEKS                       R6 R5 K13 ["className"]
       33 NAMECALL                         R3 R3 K14 ["setStructuredContent"]
       35 CALL                             R3 2 1
       36 NAMECALL                         R3 R3 K15 ["build"]
       38 CALL                             R3 1 -1
       39 RETURN                           R3 -1
