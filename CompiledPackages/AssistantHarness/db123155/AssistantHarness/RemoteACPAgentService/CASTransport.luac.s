...
PROTO_5:
      ...
      106 CALL                             R12 2 0
      107 JUMP                             ; [+7]
      108 FASTCALL2                        TABLE_INSERT R5 R11 ; [+5]
      110 MOVE                             R13 R5
      111 MOVE                             R14 R11
      112 GETIMPORT                        R12 K13 [table.insert]
      114 CALL                             R12 2 0
      115 FORGLOOP                         R6 2 ; [-45]
      117 GETUPVAL                         R6 0
      118 GETTABLEKS                       R6 R6 K24 ["FFlagDebugLogAssistantUI"]
      120 JUMPIFNOT                        R6 ; [+4]
      121 GETIMPORT                        R6 K26 [print]
      123 LOADK                            R7 K27 ["[Remote ACP] normalized and sorted session/load history"]
      124 CALL                             R6 1 0
      125 GETIMPORT                        R6 K29 [table.clone]
      127 MOVE                             R7 R1
      128 CALL                             R6 1 1
      129 SETTABLEKS                       R5 R6 K4 ["history"]
      131 SETTABLEKS                       R6 R0 K0 ["result"]
      133 RETURN                           R0 0
...
PROTO_6:
      ...
      240 RETURN                           R0 0
      241 GETUPVAL                         R1 3
      242 GETTABLEKS                       R1 R1 K25 ["onTransportMessage"]
      244 MOVE                             R3 R0
      245 NAMECALL                         R1 R1 K26 ["Fire"]
      247 CALL                             R1 2 0
      248 RETURN                           R0 0
...
PROTO_10:
      ...
      106 GETIMPORT                        R4 K20 [task.spawn]
      ...
      113 CALL                             R4 1 0
      114 GETUPVAL                         R3 5
      115 GETTABLEKS                       R3 R3 K21 ["resolve"]
      117 CALL                             R3 0 -1
      118 RETURN                           R3 -1
...
PROTO_14:
        ...
        8 CAPTURE                          VAL R0
        9 CAPTURE                          UPVAL U0
       10 DUPCLOSURE                       R7 K0 [PROTO_3]
       11 DUPCLOSURE                       R8 K1 [PROTO_5]
       12 CAPTURE                          UPVAL U0
       13 NEWCLOSURE                       R9 P4
       14 CAPTURE                          REF R3
       15 CAPTURE                          UPVAL U0
       ...
       18 CAPTURE                          VAL R1
       19 GETUPVAL                         R10 2
       20 GETTABLEKS                       R10 R10 K2 ["makeTransport"]
       22 DUPTABLE                         R11 K8 [{"start", "sendRequest", "sendNotification", "sendResponse", "close"}]
       ...
       27 CAPTURE                          VAL R9
       28 CAPTURE                          UPVAL U3
       29 SETTABLEKS                       R12 R11 K3 ["start"]
       31 NEWCLOSURE                       R12 P6
       32 CAPTURE                          UPVAL U0
       33 CAPTURE                          UPVAL U1
       34 CAPTURE                          VAL R1
       35 CAPTURE                          REF R4
       ...
       37 CAPTURE                          UPVAL U3
       38 CAPTURE                          VAL R8
       39 SETTABLEKS                       R12 R11 K4 ["sendRequest"]
       41 NEWCLOSURE                       R12 P7
       42 CAPTURE                          UPVAL U0
       43 CAPTURE                          VAL R0
       44 CAPTURE                          UPVAL U3
       45 SETTABLEKS                       R12 R11 K5 ["sendNotification"]
       47 NEWCLOSURE                       R12 P8
       48 CAPTURE                          UPVAL U0
       49 CAPTURE                          VAL R0
       50 CAPTURE                          UPVAL U3
       51 SETTABLEKS                       R12 R11 K6 ["sendResponse"]
       53 NEWCLOSURE                       R12 P9
       54 CAPTURE                          UPVAL U0
       55 CAPTURE                          REF R3
       56 CAPTURE                          REF R2
       57 CAPTURE                          UPVAL U3
       58 SETTABLEKS                       R12 R11 K7 ["close"]
       60 CALL                             R10 1 1
       61 MOVE                             R4 R10
       62 CLOSEUPVALS                      R2
       63 RETURN                           R4 1
...
MAIN:
       ...
       16 GETTABLEKS                       R3 R0 K8 ["Engine"]
       18 GETTABLEKS                       R3 R3 K9 ["EngineFlags"]
       20 CALL                             R2 1 1
       21 GETIMPORT                        R3 K5 [require]
       23 GETTABLEKS                       R4 R0 K6 ["Parent"]
       25 GETTABLEKS                       R4 R4 K10 ["Promise"]
       27 CALL                             R3 1 1
       28 GETTABLEKS                       R4 R1 K11 ["Method"]
       30 DUPCLOSURE                       R5 K12 [PROTO_14]
       31 CAPTURE                          VAL R2
       32 CAPTURE                          VAL R4
       33 CAPTURE                          VAL R1
       34 CAPTURE                          VAL R3
       35 DUPTABLE                         R6 K14 [{"makeCASTransport"}]
       36 SETTABLEKS                       R5 R6 K13 ["makeCASTransport"]
       38 RETURN                           R6 1
