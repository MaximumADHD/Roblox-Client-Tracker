...
MAIN:
       ...
       18 GETTABLEKS                       R3 R3 K8 ["EngineToolNames"]
       20 CALL                             R2 1 1
       21 GETIMPORT                        R3 K5 [require]
       23 GETTABLEKS                       R4 R0 K6 ["Engine"]
       25 GETTABLEKS                       R4 R4 K9 ["StreamTypes"]
       27 CALL                             R3 1 1
       28 NEWTABLE                         R4 0 0
       30 NEWTABLE                         R5 16 0
       32 DUPCLOSURE                       R6 K10 [PROTO_0]
       33 SETTABLEKS                       R6 R5 K11 ["new"]
       35 DUPCLOSURE                       R6 K12 [PROTO_1]
       36 CAPTURE                          VAL R4
       37 SETTABLEKS                       R6 R5 K13 ["get"]
       39 DUPCLOSURE                       R6 K14 [PROTO_2]
       40 CAPTURE                          VAL R4
       41 SETTABLEKS                       R6 R5 K15 ["set"]
       43 DUPCLOSURE                       R6 K16 [PROTO_3]
       44 CAPTURE                          VAL R4
       45 SETTABLEKS                       R6 R5 K17 ["removeThread"]
       47 DUPCLOSURE                       R6 K18 [PROTO_4]
       48 CAPTURE                          VAL R4
       49 SETTABLEKS                       R6 R5 K19 ["clearAll"]
       51 DUPCLOSURE                       R6 K20 [PROTO_5]
       52 DUPCLOSURE                       R7 K21 [PROTO_6]
       53 CAPTURE                          VAL R5
       54 SETTABLEKS                       R7 R5 K22 ["buildIndex"]
       56 DUPCLOSURE                       R7 K23 [PROTO_7]
       57 CAPTURE                          VAL R6
       58 CAPTURE                          VAL R2
       59 CAPTURE                          VAL R1
       60 SETTABLEKS                       R7 R5 K24 ["_indexToolResult"]
       62 DUPCLOSURE                       R7 K25 [PROTO_8]
       63 SETTABLEKS                       R7 R5 K26 ["mergeIndex"]
       65 DUPCLOSURE                       R7 K27 [PROTO_9]
       66 SETTABLEKS                       R7 R5 K28 ["getScript"]
       68 DUPCLOSURE                       R7 K29 [PROTO_10]
       69 SETTABLEKS                       R7 R5 K30 ["getGameTree"]
       71 DUPCLOSURE                       R7 K31 [PROTO_11]
       72 SETTABLEKS                       R7 R5 K32 ["getGrep"]
       74 DUPCLOSURE                       R7 K33 [PROTO_12]
       75 SETTABLEKS                       R7 R5 K34 ["getPlan"]
       77 DUPCLOSURE                       R7 K35 [PROTO_13]
       78 SETTABLEKS                       R7 R5 K36 ["getInspect"]
       80 DUPCLOSURE                       R7 K37 [PROTO_14]
       81 CAPTURE                          VAL R2
       82 CAPTURE                          VAL R1
       83 SETTABLEKS                       R7 R5 K38 ["buildManifest"]
       85 RETURN                           R5 1
