...
MAIN:
  ...
  LOADK R6 K10 ["Roact"]
  LOADK R7 K11 ["HostChangeEvent"]
  CONCAT R5 R6 R7
  CALL R4 1 1
  SETTABLEKS R4 R2 K11 ["HostChangeEvent"]
  GETTABLEKS R4 R0 K9 ["named"]
  LOADK R6 K10 ["Roact"]
  LOADK R7 K12 ["HostEvent"]
  CONCAT R5 R6 R7
  CALL R4 1 1
  SETTABLEKS R4 R2 K12 ["HostEvent"]
  DUPCLOSURE R4 K13 [PROTO_1]
  CAPTURE VAL R1
  SETTABLEKS R4 R2 K14 ["of"]
  FASTCALL1 GETMETATABLE R1 [+3]
  MOVE R5 R1
  GETIMPORT R4 K16 [getmetatable]
  CALL R4 1 1
  SETTABLEKS R2 R4 K17 ["__index"]
  FASTCALL1 GETMETATABLE R1 [+3]
  MOVE R5 R1
  GETIMPORT R4 K16 [getmetatable]
  CALL R4 1 1
  DUPCLOSURE R5 K18 [PROTO_2]
  SETTABLEKS R5 R4 K19 ["__tostring"]
  RETURN R1 1
