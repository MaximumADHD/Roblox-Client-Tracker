...
MAIN:
  ...
  CALL R3 1 1
  LOADK R5 K7 ["Array.concat(...) only works with array-like tables but "]
  LOADK R6 K8 ["it received an object-like table.
You can avoid this error by wrapping the "]
  LOADK R7 K9 ["object-like table into an array. Example: `concat({1, 2}, {a = true})` should "]
  LOADK R8 K10 ["be `concat({1, 2}, { {a = true} }`"]
  CONCAT R4 R5 R8
