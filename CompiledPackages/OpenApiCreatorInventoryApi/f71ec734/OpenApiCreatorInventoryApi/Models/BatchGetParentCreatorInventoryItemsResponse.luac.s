PROTO_0:
       ...
       23 CALL                             R3 2 0
       24 RETURN                           R0 1
       25 GETTABLEKS                       R3 R0 K7 ["results"]
       27 JUMPIFEQKNIL                     R3 ; [+77]
       29 GETTABLEKS                       R4 R0 K7 ["results"]
       31 FASTCALL1                        TYPEOF R4 ; [+2]
       32 GETIMPORT                        R3 K1 [typeof]
       34 CALL                             R3 1 1
       35 JUMPIFEQKS                       R3 K2 ["table"] ; [+20]
       37 LOADK                            R6 K8 ["%*\"results\" > Expected table, got %*"]
       38 MOVE                             R8 R2
       39 GETTABLEKS                       R10 R0 K7 ["results"]
       ...
       54 CALL                             R3 2 0
       55 RETURN                           R0 1
       56 GETTABLEKS                       R3 R0 K7 ["results"]
       58 LOADNIL                          R4
       59 LOADNIL                          R5
       60 FORGPREP                         R3
       ...
       68 LOADK                            R11 K10 ["%*\"results\" > Expected index of type number, got %* as %*"]
       69 MOVE                             R13 R2
       70 MOVE                             R14 R6
       ...
       85 CALL                             R8 2 0
       86 JUMP                             ; [+16]
       87 GETTABLEKS                       R8 R0 K7 ["results"]
       89 GETUPVAL                         R9 0
       90 GETTABLEKS                       R9 R9 K11 ["fromResponse"]
       92 MOVE                             R10 R7
       93 MOVE                             R11 R1
       94 LOADK                            R13 K12 ["%*\"results\" > [%*] > "]
       95 MOVE                             R15 R2
       96 MOVE                             R16 R6
...
PROTO_1:
        ...
        2 MOVE                             R2 R0
        3 CALL                             R1 1 1
        4 GETTABLEKS                       R2 R1 K3 ["results"]
        6 JUMPIFEQKNIL                     R2 ; [+23]
        8 GETIMPORT                        R2 K2 [table.clone]
       10 GETTABLEKS                       R3 R1 K3 ["results"]
       12 CALL                             R2 1 1
       13 SETTABLEKS                       R2 R1 K3 ["results"]
       15 GETTABLEKS                       R2 R1 K3 ["results"]
       17 LOADNIL                          R3
       18 LOADNIL                          R4
       19 FORGPREP                         R2
       20 GETTABLEKS                       R7 R1 K3 ["results"]
       22 GETUPVAL                         R8 0
...
MAIN:
       ...
       18 GETTABLEKS                       R4 R4 K9 ["BatchGetParentCreatorInventoryItemsResult"]
       20 CALL                             R3 1 1
