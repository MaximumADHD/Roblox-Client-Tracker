PROTO_0:
       ...
       23 CALL                             R3 2 0
       24 RETURN                           R0 1
       25 GETTABLEKS                       R3 R0 K7 ["path"]
       27 JUMPIFEQKNIL                     R3 ; [+27]
       29 GETTABLEKS                       R4 R0 K7 ["path"]
       31 FASTCALL1                        TYPEOF R4 ; [+2]
       32 GETIMPORT                        R3 K1 [typeof]
       34 CALL                             R3 1 1
       35 JUMPIFEQKS                       R3 K8 ["string"] ; [+19]
       37 LOADK                            R6 K9 ["%*\"path\" > Expected string, got %*"]
       38 MOVE                             R8 R2
       39 GETTABLEKS                       R10 R0 K7 ["path"]
       ...
       54 CALL                             R3 2 0
       55 GETTABLEKS                       R3 R0 K10 ["assetItem"]
       57 JUMPIFEQKNIL                     R3 ; [+16]
       59 GETUPVAL                         R3 0
       60 GETTABLEKS                       R3 R3 K11 ["fromResponse"]
       62 GETTABLEKS                       R4 R0 K10 ["assetItem"]
       64 MOVE                             R5 R1
       65 LOADK                            R7 K12 ["%*\"assetItem\" > "]
       66 MOVE                             R9 R2
       67 NAMECALL                         R7 R7 K4 ["format"]
       69 CALL                             R7 2 1
       70 MOVE                             R6 R7
       71 CALL                             R3 3 1
       72 SETTABLEKS                       R3 R0 K10 ["assetItem"]
       74 GETTABLEKS                       R3 R0 K13 ["folderItem"]
       76 JUMPIFEQKNIL                     R3 ; [+16]
       78 GETUPVAL                         R3 1
       79 GETTABLEKS                       R3 R3 K11 ["fromResponse"]
       81 GETTABLEKS                       R4 R0 K13 ["folderItem"]
       83 MOVE                             R5 R1
       84 LOADK                            R7 K14 ["%*\"folderItem\" > "]
       85 MOVE                             R9 R2
       86 NAMECALL                         R7 R7 K4 ["format"]
       88 CALL                             R7 2 1
       89 MOVE                             R6 R7
       90 CALL                             R3 3 1
       91 SETTABLEKS                       R3 R0 K13 ["folderItem"]
       93 RETURN                           R0 1
