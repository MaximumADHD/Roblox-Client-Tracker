PROTO_0:
       ...
       23 CALL                             R3 2 0
       24 RETURN                           R0 1
       25 GETTABLEKS                       R4 R0 K7 ["items"]
       27 FASTCALL1                        TYPEOF R4 ; [+2]
       28 GETIMPORT                        R3 K1 [typeof]
       30 CALL                             R3 1 1
       31 JUMPIFEQKS                       R3 K2 ["table"] ; [+20]
       33 LOADK                            R6 K8 ["%*\"items\" > Expected table, got %*"]
       34 MOVE                             R8 R2
       35 GETTABLEKS                       R10 R0 K7 ["items"]
       ...
       64 LOADK                            R11 K10 ["%*\"items\" > Expected index of type number, got %* as %*"]
       65 MOVE                             R13 R2
       66 MOVE                             R14 R6
       ...
       81 CALL                             R8 2 0
       82 JUMP                             ; [+16]
       83 GETTABLEKS                       R8 R0 K7 ["items"]
       85 GETUPVAL                         R9 0
       86 GETTABLEKS                       R9 R9 K11 ["fromResponse"]
       88 MOVE                             R10 R7
       89 MOVE                             R11 R1
       90 LOADK                            R13 K12 ["%*\"items\" > [%*] > "]
       91 MOVE                             R15 R2
       92 MOVE                             R16 R6
