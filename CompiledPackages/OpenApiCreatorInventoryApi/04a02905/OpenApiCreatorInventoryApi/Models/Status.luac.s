PROTO_0:
       ...
       29 GETTABLEKS                       R4 R0 K7 ["code"]
       31 FASTCALL1                        TYPEOF R4 ; [+2]
       32 GETIMPORT                        R3 K1 [typeof]
       34 CALL                             R3 1 1
       35 JUMPIFEQKS                       R3 K8 ["number"] ; [+19]
       37 LOADK                            R6 K9 ["%*\"code\" > Expected number, got %*"]
       38 MOVE                             R8 R2
       39 GETTABLEKS                       R10 R0 K7 ["code"]
       ...
       67 LOADK                            R6 K12 ["%*\"message\" > Expected string, got %*"]
       68 MOVE                             R8 R2
       ...
       84 CALL                             R3 2 0
       85 GETTABLEKS                       R3 R0 K13 ["details"]
       87 JUMPIFEQKNIL                     R3 ; [+77]
       89 GETTABLEKS                       R4 R0 K13 ["details"]
       91 FASTCALL1                        TYPEOF R4 ; [+2]
       92 GETIMPORT                        R3 K1 [typeof]
       94 CALL                             R3 1 1
       95 JUMPIFEQKS                       R3 K2 ["table"] ; [+20]
       97 LOADK                            R6 K14 ["%*\"details\" > Expected table, got %*"]
       98 MOVE                             R8 R2
       99 GETTABLEKS                       R10 R0 K13 ["details"]
      ...
      114 CALL                             R3 2 0
      115 RETURN                           R0 1
      116 GETTABLEKS                       R3 R0 K13 ["details"]
      118 LOADNIL                          R4
      119 LOADNIL                          R5
      120 FORGPREP                         R3
      ...
      128 LOADK                            R11 K15 ["%*\"details\" > Expected index of type number, got %* as %*"]
      129 MOVE                             R13 R2
      130 MOVE                             R14 R6
      ...
      145 CALL                             R8 2 0
      146 JUMP                             ; [+16]
      147 GETTABLEKS                       R8 R0 K13 ["details"]
      149 GETUPVAL                         R9 0
      150 GETTABLEKS                       R9 R9 K16 ["fromResponse"]
      152 MOVE                             R10 R7
      153 MOVE                             R11 R1
      154 LOADK                            R13 K17 ["%*\"details\" > [%*] > "]
      155 MOVE                             R15 R2
      156 MOVE                             R16 R6
