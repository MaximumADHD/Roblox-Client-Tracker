PROTO_0:
       ...
       23 CALL                             R3 2 0
       24 RETURN                           R0 1
       25 GETTABLEKS                       R3 R0 K7 ["userId"]
       27 JUMPIFEQKNIL                     R3 ; [+27]
       29 GETTABLEKS                       R4 R0 K7 ["userId"]
       31 FASTCALL1                        TYPEOF R4 ; [+2]
       32 GETIMPORT                        R3 K1 [typeof]
       34 CALL                             R3 1 1
       35 JUMPIFEQKS                       R3 K8 ["string"] ; [+19]
       37 LOADK                            R6 K9 ["%*\"userId\" > Expected string, got %*"]
       38 MOVE                             R8 R2
       39 GETTABLEKS                       R10 R0 K7 ["userId"]
       ...
       54 CALL                             R3 2 0
       55 GETTABLEKS                       R3 R0 K10 ["groupId"]
       57 JUMPIFEQKNIL                     R3 ; [+27]
       59 GETTABLEKS                       R4 R0 K10 ["groupId"]
       61 FASTCALL1                        TYPEOF R4 ; [+2]
       62 GETIMPORT                        R3 K1 [typeof]
       64 CALL                             R3 1 1
       65 JUMPIFEQKS                       R3 K8 ["string"] ; [+19]
       67 LOADK                            R6 K11 ["%*\"groupId\" > Expected string, got %*"]
       68 MOVE                             R8 R2
       69 GETTABLEKS                       R10 R0 K10 ["groupId"]
       ...
       84 CALL                             R3 2 0
       85 GETTABLEKS                       R3 R0 K12 ["universeId"]
       87 JUMPIFEQKNIL                     R3 ; [+27]
       89 GETTABLEKS                       R4 R0 K12 ["universeId"]
       91 FASTCALL1                        TYPEOF R4 ; [+2]
       92 GETIMPORT                        R3 K1 [typeof]
       94 CALL                             R3 1 1
       95 JUMPIFEQKS                       R3 K8 ["string"] ; [+19]
       97 LOADK                            R6 K13 ["%*\"universeId\" > Expected string, got %*"]
       98 MOVE                             R8 R2
       99 GETTABLEKS                       R10 R0 K12 ["universeId"]
      ...
      114 CALL                             R3 2 0
      115 GETTABLEKS                       R3 R0 K14 ["originFolderId"]
      117 JUMPIFEQKNIL                     R3 ; [+27]
      119 GETTABLEKS                       R4 R0 K14 ["originFolderId"]
      121 FASTCALL1                        TYPEOF R4 ; [+2]
      122 GETIMPORT                        R3 K1 [typeof]
      124 CALL                             R3 1 1
      125 JUMPIFEQKS                       R3 K15 ["number"] ; [+19]
      127 LOADK                            R6 K16 ["%*\"originFolderId\" > Expected number, got %*"]
      128 MOVE                             R8 R2
      129 GETTABLEKS                       R10 R0 K14 ["originFolderId"]
      ...
      144 CALL                             R3 2 0
      145 GETTABLEKS                       R3 R0 K17 ["destinationFolderId"]
      147 JUMPIFEQKNIL                     R3 ; [+27]
      149 GETTABLEKS                       R4 R0 K17 ["destinationFolderId"]
      151 FASTCALL1                        TYPEOF R4 ; [+2]
      152 GETIMPORT                        R3 K1 [typeof]
      154 CALL                             R3 1 1
      155 JUMPIFEQKS                       R3 K15 ["number"] ; [+19]
      157 LOADK                            R6 K18 ["%*\"destinationFolderId\" > Expected number, got %*"]
      158 MOVE                             R8 R2
      159 GETTABLEKS                       R10 R0 K17 ["destinationFolderId"]
      ...
      174 CALL                             R3 2 0
      175 GETTABLEKS                       R3 R0 K19 ["items"]
      177 JUMPIFEQKNIL                     R3 ; [+77]
      179 GETTABLEKS                       R4 R0 K19 ["items"]
      181 FASTCALL1                        TYPEOF R4 ; [+2]
      182 GETIMPORT                        R3 K1 [typeof]
      184 CALL                             R3 1 1
      185 JUMPIFEQKS                       R3 K2 ["table"] ; [+20]
      187 LOADK                            R6 K20 ["%*\"items\" > Expected table, got %*"]
      188 MOVE                             R8 R2
      189 GETTABLEKS                       R10 R0 K19 ["items"]
      ...
      204 CALL                             R3 2 0
      205 JUMP                             ; [+49]
      206 GETTABLEKS                       R3 R0 K19 ["items"]
      208 LOADNIL                          R4
      209 LOADNIL                          R5
      210 FORGPREP                         R3
      ...
      215 CALL                             R8 1 1
      216 JUMPIFEQKS                       R8 K15 ["number"] ; [+20]
      218 LOADK                            R11 K21 ["%*\"items\" > Expected index of type number, got %* as %*"]
      219 MOVE                             R13 R2
      220 MOVE                             R14 R6
      ...
      235 CALL                             R8 2 0
      236 JUMP                             ; [+16]
      237 GETTABLEKS                       R8 R0 K19 ["items"]
      239 GETUPVAL                         R9 0
      240 GETTABLEKS                       R9 R9 K22 ["fromResponse"]
      242 MOVE                             R10 R7
      243 MOVE                             R11 R1
      244 LOADK                            R13 K23 ["%*\"items\" > [%*] > "]
      245 MOVE                             R15 R2
      246 MOVE                             R16 R6
      ...
      255 GETTABLEKS                       R3 R0 K24 ["originFolderItem"]
      257 JUMPIFEQKNIL                     R3 ; [+16]
      259 GETUPVAL                         R3 0
      260 GETTABLEKS                       R3 R3 K22 ["fromResponse"]
      262 GETTABLEKS                       R4 R0 K24 ["originFolderItem"]
      264 MOVE                             R5 R1
      265 LOADK                            R7 K25 ["%*\"originFolderItem\" > "]
      266 MOVE                             R9 R2
      267 NAMECALL                         R7 R7 K4 ["format"]
      269 CALL                             R7 2 1
      270 MOVE                             R6 R7
      271 CALL                             R3 3 1
      272 SETTABLEKS                       R3 R0 K24 ["originFolderItem"]
      274 GETTABLEKS                       R3 R0 K26 ["destinationFolderItem"]
      276 JUMPIFEQKNIL                     R3 ; [+16]
      278 GETUPVAL                         R3 0
      279 GETTABLEKS                       R3 R3 K22 ["fromResponse"]
      281 GETTABLEKS                       R4 R0 K26 ["destinationFolderItem"]
      283 MOVE                             R5 R1
      284 LOADK                            R7 K27 ["%*\"destinationFolderItem\" > "]
      285 MOVE                             R9 R2
      286 NAMECALL                         R7 R7 K4 ["format"]
      288 CALL                             R7 2 1
      289 MOVE                             R6 R7
      290 CALL                             R3 3 1
      291 SETTABLEKS                       R3 R0 K26 ["destinationFolderItem"]
      293 RETURN                           R0 1
