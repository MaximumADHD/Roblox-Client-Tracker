...
PROTO_8:
       ...
       20 GETTABLEKS                       R5 R5 K2 ["__YOLO__"]
       22 JUMPIF                           R5 ; [+33]
       23 GETUPVAL                         R5 0
       24 JUMPIFNOT                        R5 ; [+24]
...
PROTO_9:
       ...
       13 JUMPIF                           R3 ; [+118]
       14 GETUPVAL                         R3 1
       15 GETTABLEKS                       R3 R3 K0 ["expirationTime"]
       ...
       22 JUMPIF                           R3 ; [+109]
       23 GETUPVAL                         R3 1
       24 GETTABLEKS                       R3 R3 K1 ["callback"]
       ...
       37 GETUPVAL                         R4 1
       38 GETTABLEKS                       R4 R4 K5 ["priorityLevel"]
       40 SETUPVAL                         R4 6
       41 GETUPVAL                         R5 1
       42 GETTABLEKS                       R5 R5 K0 ["expirationTime"]
       44 JUMPIFLE                         R5 R2 ; [+2]
       46 LOADB                            R4 0 +1
       47 LOADB                            R4 1
       48 GETUPVAL                         R5 7
...
PROTO_10:
       ...
       19 LOADNIL                          R3
       20 LOADNIL                          R4
       21 GETIMPORT                        R5 K1 [_G]
       23 GETTABLEKS                       R5 R5 K2 ["__YOLO__"]
       25 JUMPIF                           R5 ; [+8]
...
PROTO_11:
       ...
       18 LOADNIL                          R3
       19 LOADNIL                          R4
       20 GETIMPORT                        R5 K1 [_G]
       22 GETTABLEKS                       R5 R5 K2 ["__YOLO__"]
       24 JUMPIF                           R5 ; [+8]
       25 GETIMPORT                        R5 K4 [xpcall]
       27 MOVE                             R6 R0
       28 GETUPVAL                         R7 4
...
PROTO_12:
        ...
        8 GETTABLEKS                       R3 R3 K2 ["__YOLO__"]
       10 JUMPIF                           R3 ; [+9]
...
PROTO_21:
        ...
        8 GETTABLEKS                       R3 R1 K5 ["Shared"]
       10 CALL                             R2 1 1
       11 GETTABLEKS                       R2 R2 K6 ["describeError"]
       13 GETIMPORT                        R3 K4 [require]
       15 GETIMPORT                        R4 K1 [script]
       17 GETTABLEKS                       R4 R4 K2 ["Parent"]
       19 GETTABLEKS                       R4 R4 K7 ["SchedulerFeatureFlags"]
       21 CALL                             R3 1 1
       ...
       34 GETTABLEKS                       R7 R7 K10 ["SchedulerHostConfig"]
       36 CALL                             R6 1 1
       ...
       70 GETIMPORT                        R23 K1 [script]
       72 GETTABLEKS                       R23 R23 K2 ["Parent"]
       74 GETTABLEKS                       R23 R23 K22 ["SchedulerPriorities"]
       76 CALL                             R22 1 1
       ...
       89 GETIMPORT                        R29 K1 [script]
       91 GETTABLEKS                       R29 R29 K2 ["Parent"]
       93 GETTABLEKS                       R29 R29 K28 ["SchedulerProfiling"]
       95 CALL                             R28 1 1
