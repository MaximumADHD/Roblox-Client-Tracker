...
PROTO_4:
        ...
        1 JUMPIFEQKNIL                     R0 ; [+6]
        3 GETUPVAL                         R0 0
        4 GETTABLEKS                       R0 R0 K0 ["onInteractionTraced"]
        6 GETUPVAL                         R1 1
        7 CALL                             R0 1 0
        8 RETURN                           R0 0
...
PROTO_5:
        ...
        1 JUMPIFEQKNIL                     R0 ; [+7]
        3 GETUPVAL                         R0 0
        4 GETTABLEKS                       R0 R0 K0 ["onWorkStarted"]
        6 GETUPVAL                         R1 1
        7 GETUPVAL                         R2 2
        8 CALL                             R0 2 0
        9 RETURN                           R0 0
...
PROTO_7:
        ...
        1 JUMPIFEQKNIL                     R0 ; [+7]
        3 GETUPVAL                         R0 0
        4 GETTABLEKS                       R0 R0 K0 ["onWorkStopped"]
        6 GETUPVAL                         R1 1
        7 GETUPVAL                         R2 2
        8 CALL                             R0 2 0
        9 RETURN                           R0 0
...
PROTO_8:
        ...
        7 CLOSEUPVALS                      R3
        8 RETURN                           R4 -1
        9 DUPTABLE                         R4 K5 [{[1] = 1, ["id"], ["name"], ["timestamp"]}]
       10 GETUPVAL                         R5 1
       11 SETTABLEKS                       R5 R4 K2 ["id"]
       13 SETTABLEKS                       R0 R4 K3 ["name"]
       15 SETTABLEKS                       R1 R4 K4 ["timestamp"]
       17 GETUPVAL                         R5 1
       18 ADDK                             R5 R5 K1 [1]
       19 SETUPVAL                         R5 1
       20 GETUPVAL                         R5 2
       21 GETTABLEKS                       R5 R5 K6 ["current"]
       23 GETUPVAL                         R6 3
       24 MOVE                             R7 R5
       25 CALL                             R6 1 1
       26 MOVE                             R9 R4
       27 NAMECALL                         R7 R6 K7 ["add"]
       29 CALL                             R7 2 0
       30 GETUPVAL                         R7 2
       31 SETTABLEKS                       R6 R7 K6 ["current"]
       33 GETUPVAL                         R7 4
       34 GETTABLEKS                       R7 R7 K6 ["current"]
       36 LOADNIL                          R8
       37 GETIMPORT                        R9 K9 [pcall]
       39 NEWCLOSURE                       R10 P0
       40 CAPTURE                          VAL R7
       41 CAPTURE                          VAL R4
       42 CALL                             R9 1 2
       43 GETIMPORT                        R11 K9 [pcall]
       45 NEWCLOSURE                       R12 P1
       46 CAPTURE                          VAL R7
       47 CAPTURE                          VAL R6
       48 CAPTURE                          REF R3
       49 CALL                             R11 1 2
       50 GETIMPORT                        R13 K9 [pcall]
       52 NEWCLOSURE                       R14 P2
       53 CAPTURE                          REF R8
       54 CAPTURE                          VAL R2
       55 CALL                             R13 1 2
       56 GETUPVAL                         R15 2
       57 SETTABLEKS                       R5 R15 K6 ["current"]
       59 GETIMPORT                        R15 K9 [pcall]
       61 NEWCLOSURE                       R16 P3
       62 CAPTURE                          VAL R7
       63 CAPTURE                          VAL R6
       64 CAPTURE                          REF R3
       65 CALL                             R15 1 2
       66 GETTABLEKS                       R17 R4 K0 ["__count"]
       68 SUBK                             R17 R17 K1 [1]
       69 SETTABLEKS                       R17 R4 K0 ["__count"]
       71 JUMPIFEQKNIL                     R7 ; [+9]
       73 GETTABLEKS                       R17 R4 K0 ["__count"]
       75 JUMPIFNOTEQKN                    R17 K10 [0] ; [+5]
       77 GETTABLEKS                       R17 R7 K11 ["onInteractionScheduledWorkCompleted"]
       79 MOVE                             R18 R4
       80 CALL                             R17 1 0
       81 JUMPIF                           R15 ; [+4]
       82 GETIMPORT                        R17 K13 [error]
       84 MOVE                             R18 R16
       85 CALL                             R17 1 0
       86 JUMPIF                           R13 ; [+4]
       87 GETIMPORT                        R17 K13 [error]
       89 MOVE                             R18 R14
       90 CALL                             R17 1 0
       91 JUMPIF                           R11 ; [+4]
       92 GETIMPORT                        R17 K13 [error]
       94 MOVE                             R18 R12
       95 CALL                             R17 1 0
       96 JUMPIF                           R9 ; [+4]
       97 GETIMPORT                        R17 K13 [error]
       99 MOVE                             R18 R10
      100 CALL                             R17 1 0
      101 CLOSEUPVALS                      R3
      102 RETURN                           R8 1
...
PROTO_11:
       ...
       23 GETUPVAL                         R5 0
       24 GETTABLEKS                       R5 R5 K3 ["onWorkStopped"]
       26 GETUPVAL                         R6 1
       27 GETUPVAL                         R7 2
       28 CALL                             R5 2 0
       29 JUMPIF                           R3 ; [+4]
...
PROTO_12:
       ...
       44 GETUPVAL                         R9 2
       45 GETTABLEKS                       R9 R9 K7 ["onInteractionScheduledWorkCompleted"]
       47 MOVE                             R10 R8
       48 CALL                             R9 1 0
       49 FORGLOOP                         R4 2 ; [-18]
       51 JUMPIF                           R2 ; [+4]
...
PROTO_13:
        ...
        1 JUMPIFEQKNIL                     R0 ; [+7]
        3 GETUPVAL                         R0 0
        4 GETTABLEKS                       R0 R0 K0 ["onWorkCanceled"]
        6 GETUPVAL                         R1 1
        7 GETUPVAL                         R2 2
        8 CALL                             R0 2 0
        9 RETURN                           R0 0
...
PROTO_14:
       ...
       27 GETUPVAL                         R7 0
       28 GETTABLEKS                       R7 R7 K7 ["onInteractionScheduledWorkCompleted"]
       30 MOVE                             R8 R6
       31 CALL                             R7 1 0
       32 FORGLOOP                         R2 2 ; [-17]
       34 JUMPIF                           R0 ; [+4]
...
MAIN:
       ...
       18 GETTABLEKS                       R5 R0 K7 ["Shared"]
       20 CALL                             R4 1 1
       21 GETTABLEKS                       R4 R4 K8 ["ReactFeatureFlags"]
       ...
       36 MOVE                             R8 R10
       37 DUPTABLE                         R10 K14 [{["current"] = }]
       38 MOVE                             R9 R10
       39 SETTABLEKS                       R8 R3 K15 ["__interactionsRef"]
       41 SETTABLEKS                       R9 R3 K16 ["__subscriberRef"]
       43 NEWCLOSURE                       R10 P0
       44 CAPTURE                          VAL R5
       45 CAPTURE                          REF R8
       46 CAPTURE                          VAL R2
       47 SETTABLEKS                       R10 R3 K17 ["unstable_clear"]
       49 NEWCLOSURE                       R10 P1
       50 CAPTURE                          VAL R5
       51 CAPTURE                          REF R8
       52 SETTABLEKS                       R10 R3 K18 ["unstable_getCurrent"]
       54 NEWCLOSURE                       R10 P2
       55 CAPTURE                          REF R7
       56 SETTABLEKS                       R10 R3 K19 ["unstable_getThreadID"]
       58 DUPCLOSURE                       R10 K20 [PROTO_3]
       59 CAPTURE                          VAL R2
       ...
       64 CAPTURE                          VAL R10
       65 CAPTURE                          REF R9
       66 SETTABLEKS                       R11 R3 K21 ["unstable_trace"]
       68 NEWCLOSURE                       R11 P5
       69 CAPTURE                          VAL R5
       70 CAPTURE                          REF R8
       71 CAPTURE                          REF R9
       72 SETTABLEKS                       R11 R3 K22 ["unstable_wrap"]
       74 CLOSEUPVALS                      R6
       75 RETURN                           R3 1
