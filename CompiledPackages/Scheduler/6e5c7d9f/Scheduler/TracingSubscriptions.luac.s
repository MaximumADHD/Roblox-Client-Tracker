...
PROTO_2:
        ...
        4 LOADNIL                          R5
        5 FORGPREP                         R3
        6 GETIMPORT                        R8 K1 [pcall]
        8 GETTABLEKS                       R9 R6 K2 ["onInteractionTraced"]
       10 MOVE                             R10 R0
       11 CALL                             R8 2 2
       12 JUMPIF                           R8 ; [+3]
       13 JUMPIF                           R1 ; [+2]
...
PROTO_3:
        ...
        5 FORGPREP                         R3
        6 GETIMPORT                        R8 K1 [pcall]
        8 GETTABLEKS                       R9 R6 K2 ["onInteractionScheduledWorkCompleted"]
       10 MOVE                             R10 R0
       11 CALL                             R8 2 2
       12 JUMPIF                           R8 ; [+3]
       13 JUMPIF                           R1 ; [+2]
...
PROTO_4:
        ...
        4 LOADNIL                          R6
        5 FORGPREP                         R4
        6 GETIMPORT                        R9 K1 [pcall]
        8 GETTABLEKS                       R10 R7 K2 ["onWorkScheduled"]
       10 MOVE                             R11 R0
       11 MOVE                             R12 R1
       12 CALL                             R9 3 2
       13 JUMPIF                           R9 ; [+3]
...
PROTO_5:
        ...
        5 FORGPREP                         R4
        6 GETIMPORT                        R9 K1 [pcall]
        8 GETTABLEKS                       R10 R7 K2 ["onWorkStarted"]
       10 MOVE                             R11 R0
       11 MOVE                             R12 R1
       12 CALL                             R9 3 2
       13 JUMPIF                           R9 ; [+3]
...
PROTO_6:
        ...
        5 FORGPREP                         R4
        6 GETIMPORT                        R9 K1 [pcall]
        8 GETTABLEKS                       R10 R7 K2 ["onWorkStopped"]
       10 MOVE                             R11 R0
       11 MOVE                             R12 R1
       12 CALL                             R9 3 2
       13 JUMPIF                           R9 ; [+3]
...
PROTO_7:
        ...
        5 FORGPREP                         R4
        6 GETIMPORT                        R9 K1 [pcall]
        8 GETTABLEKS                       R10 R7 K2 ["onWorkCanceled"]
       10 MOVE                             R11 R0
       11 MOVE                             R12 R1
       12 CALL                             R9 3 2
       13 JUMPIF                           R9 ; [+3]
...
MAIN:
       ...
       13 CALL                             R2 1 1
       14 GETTABLEKS                       R2 R2 K6 ["Object"]
       16 GETIMPORT                        R3 K4 [require]
       18 GETIMPORT                        R4 K1 [script]
       20 GETTABLEKS                       R4 R4 K2 ["Parent"]
       22 GETTABLEKS                       R4 R4 K7 ["Tracing"]
       24 CALL                             R3 1 1
       25 GETIMPORT                        R4 K4 [require]
       27 GETTABLEKS                       R5 R1 K8 ["Shared"]
       29 CALL                             R4 1 1
       30 GETTABLEKS                       R4 R4 K9 ["ReactFeatureFlags"]
