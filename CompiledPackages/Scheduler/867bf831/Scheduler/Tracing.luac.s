...
PROTO_7:
        ...
        8 CALL                             R5 0 -1
        9 RETURN                           R5 -1
       10 DUPTABLE                         R5 K5 [{[1] = 1, ["id"], ["name"], ["timestamp"]}]
       11 GETUPVAL                         R6 1
       12 SETTABLEKS                       R6 R5 K2 ["id"]
       14 SETTABLEKS                       R0 R5 K3 ["name"]
       16 SETTABLEKS                       R1 R5 K4 ["timestamp"]
       18 GETUPVAL                         R6 1
       19 ADDK                             R6 R6 K1 [1]
       20 SETUPVAL                         R6 1
       21 GETUPVAL                         R6 2
       22 GETTABLEKS                       R6 R6 K6 ["current"]
       24 GETUPVAL                         R7 3
       25 GETTABLEKS                       R7 R7 K7 ["new"]
       27 MOVE                             R8 R6
       28 CALL                             R7 1 1
       29 MOVE                             R10 R5
       30 NAMECALL                         R8 R7 K8 ["add"]
       32 CALL                             R8 2 0
       33 GETUPVAL                         R8 2
       34 SETTABLEKS                       R7 R8 K6 ["current"]
       36 GETUPVAL                         R8 4
       37 GETTABLEKS                       R8 R8 K6 ["current"]
       39 LOADNIL                          R9
       40 GETIMPORT                        R10 K10 [pcall]
       42 NEWCLOSURE                       R11 P0
       43 CAPTURE                          VAL R8
       44 CAPTURE                          VAL R5
       45 CALL                             R10 1 2
       46 GETIMPORT                        R12 K10 [pcall]
       ...
       55 NEWCLOSURE                       R15 P2
       56 CAPTURE                          REF R9
       57 CAPTURE                          VAL R2
       58 CALL                             R14 1 2
       59 GETUPVAL                         R16 2
       60 SETTABLEKS                       R6 R16 K6 ["current"]
       62 GETIMPORT                        R16 K10 [pcall]
       64 NEWCLOSURE                       R17 P3
       65 CAPTURE                          VAL R8
       66 CAPTURE                          VAL R7
       67 CAPTURE                          VAL R4
       68 CALL                             R16 1 2
       69 GETTABLEKS                       R18 R5 K0 ["__count"]
       71 SUBK                             R18 R18 K1 [1]
       72 SETTABLEKS                       R18 R5 K0 ["__count"]
       74 JUMPIFEQKNIL                     R8 ; [+9]
       76 GETTABLEKS                       R18 R5 K0 ["__count"]
       78 JUMPIFNOTEQKN                    R18 K11 [0] ; [+5]
       80 GETTABLEKS                       R18 R8 K12 ["onInteractionScheduledWorkCompleted"]
       82 MOVE                             R19 R5
       83 CALL                             R18 1 0
       84 JUMPIF                           R16 ; [+4]
       85 GETIMPORT                        R18 K14 [error]
       87 MOVE                             R19 R17
       88 CALL                             R18 1 0
       89 JUMPIF                           R14 ; [+4]
       90 GETIMPORT                        R18 K14 [error]
       92 MOVE                             R19 R15
       93 CALL                             R18 1 0
       94 JUMPIF                           R12 ; [+4]
       95 GETIMPORT                        R18 K14 [error]
       97 MOVE                             R19 R13
       98 CALL                             R18 1 0
       99 JUMPIF                           R10 ; [+4]
      100 GETIMPORT                        R18 K14 [error]
      102 MOVE                             R19 R11
      103 CALL                             R18 1 0
      104 CLOSEUPVALS                      R9
      105 RETURN                           R9 1
...
PROTO_11:
       ...
       43 GETUPVAL                         R9 2
       44 GETTABLEKS                       R9 R9 K6 ["onInteractionScheduledWorkCompleted"]
       46 MOVE                             R10 R8
       47 CALL                             R9 1 0
       48 FORGLOOP                         R4 2 ; [-18]
       50 JUMPIF                           R2 ; [+4]
...
PROTO_13:
       ...
       27 GETUPVAL                         R7 0
       28 GETTABLEKS                       R7 R7 K6 ["onInteractionScheduledWorkCompleted"]
       30 MOVE                             R8 R6
       31 CALL                             R7 1 0
       32 FORGLOOP                         R2 2 ; [-18]
       34 JUMPIF                           R0 ; [+4]
...
MAIN:
       ...
       62 CAPTURE                          VAL R2
       63 CAPTURE                          REF R9
       64 SETTABLEKS                       R10 R3 K20 ["unstable_trace"]
       66 NEWCLOSURE                       R10 P4
       67 CAPTURE                          VAL R5
       68 CAPTURE                          REF R8
       69 CAPTURE                          REF R9
       70 SETTABLEKS                       R10 R3 K21 ["unstable_wrap"]
       72 CLOSEUPVALS                      R6
       73 RETURN                           R3 1
