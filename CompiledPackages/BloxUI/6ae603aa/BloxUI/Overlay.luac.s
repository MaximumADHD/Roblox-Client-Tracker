...
MAIN:
       ...
       16 GETTABLEKS                       R4 R1 K9 ["Portal"]
       18 GETTABLEKS                       R5 R1 K10 ["If"]
       20 DUPCLOSURE                       R6 K11 [PROTO_0]
       21 MOVE                             R7 R3
       22 LOADK                            R8 K12 ["Overlay"]
       23 DUPTABLE                         R9 K18 [{"visible", "anchor", "dismissOnBackdropClick", "onDismiss", "children"}]
       24 LOADB                            R10 0
       25 SETTABLEKS                       R10 R9 K13 ["visible"]
       27 LOADNIL                          R10
       28 SETTABLEKS                       R10 R9 K14 ["anchor"]
       30 LOADB                            R10 1
       31 SETTABLEKS                       R10 R9 K15 ["dismissOnBackdropClick"]
       33 LOADNIL                          R10
       34 SETTABLEKS                       R10 R9 K16 ["onDismiss"]
       36 NEWTABLE                         R10 0 0
       38 SETTABLEKS                       R10 R9 K17 ["children"]
       40 NEWTABLE                         R10 0 1
       42 MOVE                             R11 R5
       43 DUPTABLE                         R12 K21 [{"when", "Then"}]
       44 MOVE                             R13 R2
       45 LOADK                            R14 K13 ["visible"]
       46 CALL                             R13 1 1
       47 SETTABLEKS                       R13 R12 K19 ["when"]
       49 MOVE                             R13 R3
       50 NEWTABLE                         R14 0 1
       52 MOVE                             R15 R4
       53 DUPTABLE                         R16 K23 [{"target", "children"}]
       54 MOVE                             R17 R2
       55 LOADK                            R18 K24 ["container"]
       56 CALL                             R17 1 1
       57 SETTABLEKS                       R17 R16 K22 ["target"]
       59 MOVE                             R17 R2
       60 LOADK                            R18 K17 ["children"]
       61 CALL                             R17 1 1
       62 SETTABLEKS                       R17 R16 K17 ["children"]
       64 CALL                             R15 1 -1
       65 SETLIST                          R14 R15 -1 [1]
       67 CALL                             R13 1 1
       68 SETTABLEKS                       R13 R12 K20 ["Then"]
       70 CALL                             R11 1 -1
