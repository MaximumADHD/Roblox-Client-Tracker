...
MAIN:
       ...
       25 DUPTABLE                         R10 K19 [{"visible", "anchor", "dismissOnBackdropClick", "onDismiss", "children"}]
       26 LOADB                            R11 0
       27 SETTABLEKS                       R11 R10 K14 ["visible"]
       29 LOADNIL                          R11
       30 SETTABLEKS                       R11 R10 K15 ["anchor"]
       32 LOADB                            R11 1
       33 SETTABLEKS                       R11 R10 K16 ["dismissOnBackdropClick"]
       35 LOADNIL                          R11
       36 SETTABLEKS                       R11 R10 K17 ["onDismiss"]
       38 NEWTABLE                         R11 0 0
       40 SETTABLEKS                       R11 R10 K18 ["children"]
       42 NEWTABLE                         R11 0 1
       44 MOVE                             R12 R6
       45 DUPTABLE                         R13 K22 [{"when", "Then"}]
       46 MOVE                             R14 R3
       47 LOADK                            R15 K14 ["visible"]
       48 CALL                             R14 1 1
       49 SETTABLEKS                       R14 R13 K20 ["when"]
       51 MOVE                             R14 R4
       52 NEWTABLE                         R15 0 1
       54 MOVE                             R16 R5
       55 DUPTABLE                         R17 K24 [{"target", "children"}]
       56 MOVE                             R18 R3
       57 LOADK                            R19 K25 ["container"]
       58 CALL                             R18 1 1
       59 SETTABLEKS                       R18 R17 K23 ["target"]
       61 MOVE                             R18 R3
       62 LOADK                            R19 K18 ["children"]
       63 CALL                             R18 1 1
       64 SETTABLEKS                       R18 R17 K18 ["children"]
       66 CALL                             R16 1 -1
       67 SETLIST                          R15 R16 -1 [1]
       69 CALL                             R14 1 1
       70 SETTABLEKS                       R14 R13 K21 ["Then"]
       72 CALL                             R12 1 -1
       73 SETLIST                          R11 R12 -1 [1]
       75 DUPCLOSURE                       R12 K26 [PROTO_4]
       76 CAPTURE                          VAL R7
       77 CALL                             R8 4 1
       78 RETURN                           R8 1
