...
PROTO_12:
       ...
       47 MOVE                             R9 R4
       48 MOVE                             R10 R5
       49 GETTABLEKS                       R11 R2 K0 ["contentType"]
       51 MOVE                             R12 R3
       52 NAMECALL                         R6 R6 K20 ["format"]
       54 CALL                             R6 6 1
       55 RETURN                           R6 1
...
PROTO_14:
      ...
      116 LOADK                            R3 K16 ["%*--%*--"]
      117 GETIMPORT                        R5 K18 [table.concat]
      119 MOVE                             R6 R2
      120 CALL                             R5 1 1
      121 MOVE                             R6 R1
      122 NAMECALL                         R3 R3 K15 ["format"]
      124 CALL                             R3 3 1
      125 RETURN                           R3 1

PROTO_15:
        0 LOADK                            R0 K0 ["----HttpWrapperBoundary-%*"]
        1 GETUPVAL                         R2 0
        2 LOADB                            R4 0
...
PROTO_16:
        ...
        6 LOADK                            R9 K0 ["%*=%*"]
        7 GETUPVAL                         R11 0
        8 GETTABLEKS                       R13 R6 K1 ["key"]
       10 NAMECALL                         R11 R11 K2 ["UrlEncode"]
       12 CALL                             R11 2 1
       13 GETUPVAL                         R12 0
       14 GETTABLEKS                       R14 R6 K3 ["value"]
       16 NAMECALL                         R12 R12 K2 ["UrlEncode"]
       18 CALL                             R12 2 1
       ...
       27 CALL                             R7 2 0
       28 FORGLOOP                         R2 2 ; [-23]
       30 GETIMPORT                        R2 K9 [table.concat]
       32 MOVE                             R3 R1
       33 LOADK                            R4 K10 ["&"]
       34 CALL                             R2 2 -1
       35 RETURN                           R2 -1
...
PROTO_19:
        ...
        1 DUPCLOSURE                       R1 K3 [PROTO_17]
        2 SETTABLEKS                       R1 R0 K0 ["fromResponse"]
        4 DUPCLOSURE                       R1 K4 [PROTO_18]
...
PROTO_24:
       ...
       18 CALL                             R5 2 1
       19 CONCAT                           R3 R4 R5
       20 SETTABLEKS                       R3 R0 K2 ["url"]
       22 GETTABLEKS                       R2 R0 K5 ["formFields"]
       24 JUMPIFEQKNIL                     R2 ; [+36]
       26 GETTABLEKS                       R3 R0 K5 ["formFields"]
       28 LENGTH                           R2 R3
       29 LOADN                            R3 0
       30 JUMPIFNOTLT                      R3 R2 ; [+30]
       32 GETTABLEKS                       R2 R0 K6 ["body"]
       34 JUMPIFNOTEQKNIL                  R2 ; [+26]
       36 GETTABLEKS                       R2 R0 K7 ["formBoundary"]
       38 JUMPIF                           R2 ; [+4]
       39 GETUPVAL                         R2 0
       40 GETTABLEKS                       R2 R2 K8 ["buildBoundary"]
       42 CALL                             R2 0 1
       43 GETUPVAL                         R3 0
       44 GETTABLEKS                       R3 R3 K9 ["buildMultipartBody"]
       46 GETTABLEKS                       R4 R0 K5 ["formFields"]
       48 MOVE                             R5 R2
       49 CALL                             R3 2 1
       50 SETTABLEKS                       R3 R0 K6 ["body"]
       52 GETTABLEKS                       R3 R0 K10 ["headers"]
       54 LOADK                            R4 K11 ["multipart/form-data; boundary=\"%*\""]
       55 MOVE                             R6 R2
       56 NAMECALL                         R4 R4 K4 ["format"]
       58 CALL                             R4 2 1
       59 SETTABLEKS                       R4 R3 K12 ["Content-Type"]
       61 GETIMPORT                        R2 K15 [coroutine.running]
       63 CALL                             R2 0 1
       64 GETIMPORT                        R3 K18 [task.defer]
       66 NEWCLOSURE                       R4 P0
       67 CAPTURE                          UPVAL U1
       68 CAPTURE                          VAL R0
       69 CAPTURE                          VAL R2
       70 CALL                             R3 1 0
       71 GETIMPORT                        R3 K20 [coroutine.yield]
       73 CALL                             R3 0 2
       74 JUMPIF                           R3 ; [+9]
       75 DUPTABLE                         R5 K26 [{["success"] = False, ["errorDetails"], ["httpDetails"] = }]
       76 DUPTABLE                         R6 K30 [{["kind"] = "Network", ["networkError"]}]
       77 GETTABLEKS                       R7 R4 K31 ["ErrorMessage"]
       79 SETTABLEKS                       R7 R6 K29 ["networkError"]
       81 SETTABLEKS                       R6 R5 K23 ["errorDetails"]
       83 RETURN                           R5 1
       84 DUPTABLE                         R5 K34 [{"statusCode", "statusMessage", "headers"}]
       85 GETTABLEKS                       R6 R4 K35 ["StatusCode"]
       87 SETTABLEKS                       R6 R5 K32 ["statusCode"]
       89 GETTABLEKS                       R6 R4 K36 ["StatusMessage"]
       91 SETTABLEKS                       R6 R5 K33 ["statusMessage"]
       93 GETTABLEKS                       R6 R4 K37 ["Headers"]
       95 SETTABLEKS                       R6 R5 K10 ["headers"]
       97 LOADB                            R6 0
       98 GETTABLEKS                       R7 R4 K35 ["StatusCode"]
      100 LOADN                            R8 200
      101 JUMPIFNOTLE                      R8 R7 ; [+8]
      103 GETTABLEKS                       R7 R4 K35 ["StatusCode"]
      105 LOADN                            R8 300
      106 JUMPIFLT                         R7 R8 ; [+2]
      108 LOADB                            R6 0 +1
      109 LOADB                            R6 1
      110 JUMPIF                           R6 ; [+19]
      111 DUPTABLE                         R7 K38 [{["success"] = False, ["errorDetails"], ["httpDetails"]}]
      112 DUPTABLE                         R8 K40 [{["kind"] = "HttpStatusCode", ["statusCode"], ["statusMessage"], ["body"]}]
      113 GETTABLEKS                       R9 R4 K35 ["StatusCode"]
      115 SETTABLEKS                       R9 R8 K32 ["statusCode"]
      117 GETTABLEKS                       R9 R4 K36 ["StatusMessage"]
      119 SETTABLEKS                       R9 R8 K33 ["statusMessage"]
      121 GETTABLEKS                       R9 R4 K41 ["Body"]
      123 SETTABLEKS                       R9 R8 K6 ["body"]
      125 SETTABLEKS                       R8 R7 K23 ["errorDetails"]
      127 SETTABLEKS                       R5 R7 K24 ["httpDetails"]
      129 RETURN                           R7 1
      130 LOADNIL                          R7
      131 JUMPIFNOT                        R1 ; [+39]
      132 NEWTABLE                         R8 0 0
      134 GETTABLEKS                       R9 R1 K42 ["fromResponse"]
      136 GETTABLEKS                       R11 R4 K41 ["Body"]
      138 GETIMPORT                        R12 K44 [pcall]
      ...
      153 LENGTH                           R9 R8
      154 LOADN                            R10 0
      155 JUMPIFNOTLT                      R10 R9 ; [+17]
      157 DUPTABLE                         R9 K38 [{["success"] = False, ["errorDetails"], ["httpDetails"]}]
      158 DUPTABLE                         R10 K48 [{["kind"] = "Validation", ["validationErrors"], ["body"]}]
      159 SETTABLEKS                       R8 R10 K47 ["validationErrors"]
      161 GETTABLEKS                       R11 R4 K41 ["Body"]
      163 SETTABLEKS                       R11 R10 K6 ["body"]
      165 SETTABLEKS                       R10 R9 K23 ["errorDetails"]
      167 SETTABLEKS                       R5 R9 K24 ["httpDetails"]
      169 RETURN                           R9 1
      170 JUMP                             ; [+2]
      171 GETTABLEKS                       R7 R4 K41 ["Body"]
      173 DUPTABLE                         R8 K51 [{["success"] = True, ["data"], ["httpDetails"]}]
      174 SETTABLEKS                       R7 R8 K50 ["data"]
      176 SETTABLEKS                       R5 R8 K24 ["httpDetails"]
      178 RETURN                           R8 1
...
MAIN:
       ...
       82 DUPCLOSURE                       R10 K38 [PROTO_19]
       83 SETTABLEKS                       R10 R3 K39 ["makeIdentity"]
       85 DUPCLOSURE                       R10 K40 [PROTO_21]
       86 CAPTURE                          VAL R1
       87 DUPCLOSURE                       R11 K41 [PROTO_24]
       88 CAPTURE                          VAL R3
       89 CAPTURE                          VAL R1
       90 SETTABLEKS                       R11 R3 K42 ["sendAsync"]
       92 RETURN                           R3 1
