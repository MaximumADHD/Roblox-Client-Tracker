...
PROTO_3:
       ...
       26 GETTABLEKS                       R3 R0 K6 ["methods"]
       28 GETTABLEKS                       R2 R3 K7 ["get"]
       30 MOVE                             R3 R1
       31 CALL                             R2 1 -1
       32 RETURN                           R2 -1
       33 GETUPVAL                         R2 0
...
PROTO_4:
       ...
       21 GETTABLEKS                       R3 R0 K8 ["methods"]
       23 GETTABLEKS                       R2 R3 K9 ["getByRange"]
       25 JUMPIFNOTEQKNIL                  R2 ; [+34]
       27 NEWTABLE                         R2 0 0
       29 GETTABLEKS                       R4 R0 K8 ["methods"]
       31 GETTABLEKS                       R3 R4 K10 ["get"]
       ...
       58 FORNLOOP                         R4
       59 RETURN                           R2 1
       60 GETTABLEKS                       R3 R0 K8 ["methods"]
       62 GETTABLEKS                       R2 R3 K9 ["getByRange"]
...
PROTO_5:
       ...
       15 GETTABLEKS                       R2 R0 K3 ["methods"]
       17 GETTABLEKS                       R1 R2 K4 ["back"]
       19 JUMPIFNOTEQKNIL                  R1 ; [+16]
       21 GETTABLEKS                       R2 R0 K3 ["methods"]
       23 GETTABLEKS                       R1 R2 K5 ["get"]
       25 GETTABLEKS                       R3 R0 K3 ["methods"]
       27 GETTABLEKS                       R2 R3 K6 ["length"]
       29 CALL                             R2 0 -1
       30 CALL                             R1 -1 1
       31 MOVE                             R2 R1
       32 JUMPIFNOT                        R2 ; [+2]
       ...
       35 RETURN                           R2 1
       36 GETTABLEKS                       R2 R0 K3 ["methods"]
       38 GETTABLEKS                       R1 R2 K4 ["back"]
       40 CALL                             R1 0 -1
       41 RETURN                           R1 -1
       42 GETUPVAL                         R1 0
...
PROTO_6:
       ...
       12 GETTABLEKS                       R2 R0 K3 ["methods"]
       14 GETTABLEKS                       R1 R2 K4 ["length"]
       16 CALL                             R1 0 -1
       17 RETURN                           R1 -1
       18 GETUPVAL                         R1 0
...
MAIN:
       ...
       18 GETTABLEKS                       R3 R4 K8 ["exhaustiveMatch"]
       20 CALL                             R2 1 1
       21 NEWTABLE                         R3 8 0
