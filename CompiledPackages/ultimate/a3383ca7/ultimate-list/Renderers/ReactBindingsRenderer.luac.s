...
PROTO_1:
        0 NEWTABLE                         R0 0 0
        2 GETUPVAL                         R2 0
        3 GETTABLEKS                       R1 R2 K0 ["elementsDisplayedHint"]
        5 GETUPVAL                         R3 1
        6 GETTABLEKS                       R2 R3 K1 ["dimensions"]
        8 GETUPVAL                         R5 1
        9 GETTABLEKS                       R4 R5 K2 ["virtualizedListController"]
       11 GETTABLEKS                       R3 R4 K3 ["getWindowSize"]
       13 CALL                             R3 0 1
       14 GETUPVAL                         R5 1
       15 GETTABLEKS                       R4 R5 K4 ["direction"]
       17 CALL                             R1 3 1
       ...
       24 FORNPREP                         R2
       25 GETUPVAL                         R6 2
       26 GETTABLEKS                       R5 R6 K5 ["createBinding"]
...
PROTO_3:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R1 R2 K0 ["virtualizedListController"]
        3 GETTABLEKS                       R0 R1 K1 ["get"]
        5 CALL                             R0 0 1
        6 GETUPVAL                         R3 0
        7 GETTABLEKS                       R2 R3 K0 ["virtualizedListController"]
        9 GETTABLEKS                       R1 R2 K2 ["getRange"]
       11 CALL                             R1 0 1
       12 NEWTABLE                         R2 0 0
       14 MOVE                             R3 R0
       15 LOADNIL                          R4
       ...
       42 CALL                             R11 1 1
       43 GETTABLEKS                       R13 R11 K7 ["contents"]
       45 GETTABLEKS                       R12 R13 K8 ["type"]
       ...
       56 CALL                             R12 2 0
       57 JUMP                             ; [+53]
       58 GETTABLEKS                       R13 R11 K7 ["contents"]
       60 GETTABLEKS                       R12 R13 K14 ["key"]
       ...
       81 GETTABLEKS                       R16 R11 K7 ["contents"]
       83 GETTABLEKS                       R15 R16 K16 ["value"]
      ...
      179 JUMP                             ; [+16]
      180 GETUPVAL                         R16 4
      181 GETTABLEKS                       R15 R16 K30 ["createBinding"]
      183 MOVE                             R16 R12
      184 CALL                             R15 1 2
...
PROTO_4:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R1 R2 K0 ["virtualizedListController"]
        3 GETTABLEKS                       R0 R1 K1 ["bindToUpdate"]
        5 NEWCLOSURE                       R1 P0
        6 CAPTURE                          UPVAL U0
        7 CAPTURE                          UPVAL U1
        8 CAPTURE                          UPVAL U2
...
PROTO_5:
       ...
       17 RETURN                           R1 1
       18 GETUPVAL                         R2 0
       19 GETTABLEKS                       R1 R2 K9 ["getUDimRect"]
       21 GETUPVAL                         R3 1
       22 GETTABLEKS                       R2 R3 K10 ["dimensions"]
       24 GETTABLEKS                       R4 R0 K0 ["contents"]
       26 GETTABLEKS                       R3 R4 K11 ["value"]
       28 GETTABLEKS                       R5 R0 K0 ["contents"]
       30 GETTABLEKS                       R4 R5 K12 ["index"]
       32 GETUPVAL                         R7 1
       33 GETTABLEKS                       R6 R7 K13 ["virtualizedListController"]
       35 GETTABLEKS                       R5 R6 K14 ["getWindowSize"]
       37 CALL                             R5 0 1
       38 GETUPVAL                         R7 1
       39 GETTABLEKS                       R6 R7 K15 ["direction"]
       41 CALL                             R1 5 -1
       42 RETURN                           R1 -1
...
PROTO_6:
        ...
        3 MOVE                             R4 R1
        4 GETUPVAL                         R6 1
        5 GETTABLEKS                       R5 R6 K1 ["direction"]
        7 CALL                             R2 3 -1
        8 RETURN                           R2 -1
...
PROTO_8:
        0 GETTABLEKS                       R3 R0 K0 ["contents"]
...
PROTO_9:
        ...
        6 GETTABLEKS                       R2 R0 K0 ["contents"]
...
PROTO_10:
       ...
       93 GETUPVAL                         R5 4
       94 GETUPVAL                         R7 0
       95 GETTABLEKS                       R6 R7 K21 ["Fragment"]
       97 NEWTABLE                         R7 0 0
       99 MOVE                             R8 R4
      100 CALL                             R5 3 -1
      101 RETURN                           R5 -1
...
MAIN:
       ...
       14 GETTABLEKS                       R4 R0 K6 ["Dimensions"]
       16 GETTABLEKS                       R3 R4 K7 ["DimensionsMethods"]
       18 CALL                             R2 1 1
       19 GETIMPORT                        R3 K5 [require]
       21 GETTABLEKS                       R5 R0 K8 ["Parent"]
       23 GETTABLEKS                       R4 R5 K9 ["React"]
       25 CALL                             R3 1 1
       26 GETIMPORT                        R4 K5 [require]
       28 GETTABLEKS                       R6 R0 K6 ["Dimensions"]
       30 GETTABLEKS                       R5 R6 K10 ["adjustPositionToScrollAxis"]
       32 CALL                             R4 1 1
       ...
       49 GETTABLEKS                       R8 R9 K14 ["joinAndMapBindings"]
       51 CALL                             R7 1 1
