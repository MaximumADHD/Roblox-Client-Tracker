...
PROTO_1:
        ...
        5 GETUPVAL                         R3 2
        6 GETTABLEKS                       R2 R3 K3 ["scrollAxisBinding"]
        8 NAMECALL                         R2 R2 K4 ["getValue"]
       10 CALL                             R2 1 1
       11 SETTABLEKS                       R2 R1 K1 ["scrollAxis"]
       13 CALL                             R0 1 0
       14 GETUPVAL                         R2 2
       15 GETTABLEKS                       R1 R2 K5 ["virtualizedListController"]
       17 GETTABLEKS                       R0 R1 K6 ["get"]
       19 CALL                             R0 0 1
       20 SETUPVAL                         R0 1
       21 GETUPVAL                         R0 3
       22 GETUPVAL                         R1 1
...
PROTO_2:
        0 GETUPVAL                         R0 0
        1 GETUPVAL                         R3 1
        2 GETTABLEKS                       R2 R3 K0 ["virtualizedListController"]
        4 GETTABLEKS                       R1 R2 K1 ["bindToUpdate"]
        6 NEWCLOSURE                       R2 P0
        7 CAPTURE                          UPVAL U2
        8 CAPTURE                          REF R0
        9 CAPTURE                          UPVAL U1
...
PROTO_3:
        0 GETUPVAL                         R4 0
        1 GETTABLEKS                       R3 R4 K0 ["config"]
        3 GETTABLEKS                       R2 R3 K1 ["freezeViewWhileScrolling"]
       ...
       14 GETUPVAL                         R2 2
       15 GETUPVAL                         R4 3
       16 GETTABLEKS                       R3 R4 K3 ["position"]
       18 GETTABLEKS                       R4 R1 K4 ["scrollAxis"]
       20 GETUPVAL                         R6 0
       21 GETTABLEKS                       R5 R6 K5 ["direction"]
       23 CALL                             R2 3 -1
       24 RETURN                           R2 -1
       25 GETUPVAL                         R2 2
       26 GETUPVAL                         R4 3
       27 GETTABLEKS                       R3 R4 K3 ["position"]
       29 MOVE                             R4 R0
       30 GETUPVAL                         R6 0
       31 GETTABLEKS                       R5 R6 K5 ["direction"]
       33 CALL                             R2 3 -1
       34 RETURN                           R2 -1
...
PROTO_4:
        ...
        3 GETTABLEKS                       R3 R0 K1 ["virtualizedListController"]
        5 GETTABLEKS                       R2 R3 K2 ["get"]
        7 CALL                             R1 1 2
        8 GETUPVAL                         R4 0
        9 GETTABLEKS                       R3 R4 K3 ["useBinding"]
       11 LOADNIL                          R4
       12 CALL                             R3 1 2
       13 GETUPVAL                         R6 0
       14 GETTABLEKS                       R5 R6 K4 ["useEffect"]
       16 NEWCLOSURE                       R6 P0
       17 CAPTURE                          VAL R1
       18 CAPTURE                          VAL R0
       19 CAPTURE                          VAL R4
       ...
       34 JUMPIF                           R6 ; [+1]
       35 GETUPVAL                         R6 1
       36 GETTABLEKS                       R8 R0 K1 ["virtualizedListController"]
       38 GETTABLEKS                       R7 R8 K7 ["getRange"]
       40 CALL                             R7 0 1
       41 MOVE                             R8 R1
       42 LOADNIL                          R9
       43 LOADNIL                          R10
       ...
       48 ADD                              R13 R14 R15
       49 GETUPVAL                         R15 2
       50 GETTABLEKS                       R14 R15 K10 ["getUDimRect"]
       52 GETTABLEKS                       R15 R0 K11 ["dimensions"]
       54 MOVE                             R16 R12
       55 MOVE                             R17 R13
       56 GETTABLEKS                       R19 R0 K1 ["virtualizedListController"]
       58 GETTABLEKS                       R18 R19 K12 ["getWindowSize"]
       60 CALL                             R18 0 1
       ...
       98 GETUPVAL                         R8 3
       99 GETUPVAL                         R10 0
      100 GETTABLEKS                       R9 R10 K21 ["Fragment"]
      102 LOADNIL                          R10
      103 MOVE                             R11 R5
      104 CALL                             R8 3 -1
      105 RETURN                           R8 -1
...
MAIN:
       ...
       33 GETTABLEKS                       R7 R0 K6 ["Dimensions"]
       35 GETTABLEKS                       R6 R7 K11 ["adjustPositionToScrollAxis"]
       37 CALL                             R5 1 1
       ...
       47 GETTABLEKS                       R8 R9 K14 ["joinAndMapBindings"]
       49 CALL                             R7 1 1
