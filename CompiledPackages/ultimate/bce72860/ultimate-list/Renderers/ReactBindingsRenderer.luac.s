...
PROTO_1:
       ...
       29 DUPTABLE                         R7 K10 [{["type"] = "vacant"}]
       30 SETTABLEKS                       R7 R6 K6 ["contents"]
       32 CALL                             R5 1 2
       33 DUPTABLE                         R9 K13 [{"binding", "set"}]
       34 SETTABLEKS                       R5 R9 K11 ["binding"]
       36 SETTABLEKS                       R6 R9 K12 ["set"]
       38 FASTCALL2                        TABLE_INSERT R0 R9 ; [+4]
       40 MOVE                             R8 R0
       41 GETIMPORT                        R7 K16 [table.insert]
       43 CALL                             R7 2 0
       44 FORNLOOP                         R2
       45 RETURN                           R0 1
...
PROTO_3:
       ...
       94 DUPTABLE                         R17 K21 [{["type"] = "full", ["index"], ["key"], ["value"]}]
       95 GETTABLEKS                       R20 R1 K4 ["X"]
       97 SUBK                             R19 R20 K3 [1]
       98 ADD                              R18 R13 R19
       99 SETTABLEKS                       R18 R17 K20 ["index"]
      101 SETTABLEKS                       R12 R17 K14 ["key"]
      103 SETTABLEKS                       R14 R17 K16 ["value"]
      105 SETTABLEKS                       R17 R16 K7 ["contents"]
      107 CALL                             R15 1 0
      108 FORGLOOP                         R6 2 ; [-71]
      110 GETUPVAL                         R6 3
      111 LOADK                            R7 K22 ["%d total setters, %d dead setters, %d vacant setters"]
      112 GETUPVAL                         R9 2
      113 LENGTH                           R8 R9
      114 LENGTH                           R9 R3
      115 LENGTH                           R10 R4
      ...
      119 LOADNIL                          R8
      120 FORGPREP                         R6
      121 JUMPIFNOTEQKNIL                  R10 ; [+2]
      123 LOADB                            R12 0 +1
      124 LOADB                            R12 1
      125 FASTCALL2K                       ASSERT R12 K23 ; [+4]
      127 LOADK                            R13 K23 ["Luau"]
      128 GETIMPORT                        R11 K25 [assert]
      130 CALL                             R11 2 0
      131 GETTABLE                         R11 R0 R10
      132 DUPTABLE                         R12 K18 [{"contents"}]
      133 DUPTABLE                         R13 K21 [{["type"] = "full", ["index"], ["key"], ["value"]}]
      134 GETTABLEKS                       R16 R1 K4 ["X"]
      136 SUBK                             R15 R16 K3 [1]
      137 ADD                              R14 R10 R15
      138 SETTABLEKS                       R14 R13 K20 ["index"]
      140 SETTABLEKS                       R9 R13 K14 ["key"]
      142 SETTABLEKS                       R11 R13 K16 ["value"]
      144 SETTABLEKS                       R13 R12 K7 ["contents"]
      146 GETIMPORT                        R13 K27 [table.remove]
      148 MOVE                             R14 R3
      149 CALL                             R13 1 1
      150 JUMPIFEQKNIL                     R13 ; [+9]
      152 GETUPVAL                         R14 3
      153 LOADK                            R15 K28 ["%s is filling dead spot"]
      154 MOVE                             R16 R9
      155 CALL                             R14 2 0
      156 MOVE                             R14 R13
      157 MOVE                             R15 R12
      158 CALL                             R14 1 0
      159 JUMP                             ; [+30]
      160 GETIMPORT                        R14 K27 [table.remove]
      162 MOVE                             R15 R4
      163 CALL                             R14 1 1
      164 JUMPIFEQKNIL                     R14 ; [+9]
      166 GETUPVAL                         R15 3
      167 LOADK                            R16 K29 ["%s is filling vacant spot"]
      168 MOVE                             R17 R9
      169 CALL                             R15 2 0
      170 MOVE                             R15 R14
      171 MOVE                             R16 R12
      ...
      173 JUMP                             ; [+16]
      174 GETUPVAL                         R15 4
      175 GETTABLEKS                       R15 R15 K30 ["createBinding"]
      177 MOVE                             R16 R12
      178 CALL                             R15 1 2
      179 DUPTABLE                         R19 K31 [{"binding", "set"}]
      180 SETTABLEKS                       R15 R19 K5 ["binding"]
      182 SETTABLEKS                       R16 R19 K10 ["set"]
      184 FASTCALL2                        TABLE_INSERT R5 R19 ; [+4]
      186 MOVE                             R18 R5
      187 GETIMPORT                        R17 K13 [table.insert]
      189 CALL                             R17 2 0
      190 FORGLOOP                         R6 2 ; [-70]
      192 LENGTH                           R6 R5
      193 LOADN                            R7 0
      194 JUMPIFNOTLT                      R7 R6 ; [+13]
      196 GETUPVAL                         R6 3
      197 LOADK                            R7 K32 ["Needed to create %d more bindings to fit, there will be %d setters"]
      198 LENGTH                           R8 R5
      199 LENGTH                           R10 R5
      200 GETUPVAL                         R12 2
      201 LENGTH                           R11 R12
      ...
      211 FORGPREP                         R6
      212 MOVE                             R11 R10
      213 DUPTABLE                         R12 K18 [{"contents"}]
      214 DUPTABLE                         R13 K33 [{["type"] = "vacant"}]
      215 SETTABLEKS                       R13 R12 K7 ["contents"]
      217 CALL                             R11 1 0
      218 FORGLOOP                         R6 2 ; [-7]
      220 RETURN                           R0 0
...
PROTO_10:
       ...
       44 CALL                             R11 2 1
       45 LOADK                            R12 K6 ["Item%*"]
       46 MOVE                             R14 R8
       47 NAMECALL                         R12 R12 K7 ["format"]
       49 CALL                             R12 2 1
       50 GETUPVAL                         R13 4
       51 LOADK                            R14 K8 ["Frame"]
       52 DUPTABLE                         R15 K14 [{["BackgroundTransparency"] = 1, ["Position"], ["Size"], ["Visible"]}]
       53 GETUPVAL                         R16 5
       54 NEWCLOSURE                       R17 P3
       55 CAPTURE                          UPVAL U6
       56 CAPTURE                          VAL R0
       57 MOVE                             R18 R11
       58 GETTABLEKS                       R19 R0 K15 ["scrollAxisBinding"]
       60 CALL                             R16 3 1
       61 SETTABLEKS                       R16 R15 K11 ["Position"]
       63 DUPCLOSURE                       R18 K16 [PROTO_7]
       64 NAMECALL                         R16 R11 K5 ["map"]
       66 CALL                             R16 2 1
       67 SETTABLEKS                       R16 R15 K12 ["Size"]
       69 DUPCLOSURE                       R18 K17 [PROTO_8]
       70 NAMECALL                         R16 R10 K5 ["map"]
       72 CALL                             R16 2 1
       73 SETTABLEKS                       R16 R15 K13 ["Visible"]
       75 DUPTABLE                         R16 K19 [{"Content"}]
       76 GETTABLEKS                       R17 R0 K20 ["callback"]
       78 DUPCLOSURE                       R20 K21 [PROTO_9]
       79 NAMECALL                         R18 R10 K5 ["map"]
       81 CALL                             R18 2 -1
       82 CALL                             R17 -1 1
       83 SETTABLEKS                       R17 R16 K18 ["Content"]
       85 CALL                             R13 3 1
       86 SETTABLE                         R13 R4 R12
       87 FORGLOOP                         R5 2 ; [-51]
       89 GETUPVAL                         R5 4
       90 GETUPVAL                         R6 0
       91 GETTABLEKS                       R6 R6 K22 ["Fragment"]
       93 NEWTABLE                         R7 0 0
       95 MOVE                             R8 R4
       96 CALL                             R5 3 -1
       97 RETURN                           R5 -1
