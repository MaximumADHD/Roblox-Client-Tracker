PROTO_0:
        ...
        3 GETTABLEKS                       R1 R0 K1 ["position"]
        5 GETTABLEKS                       R1 R1 K2 ["X"]
        7 GETTABLEKS                       R1 R1 K3 ["Offset"]
        9 JUMP                             ; [+13]
       10 GETUPVAL                         R2 0
       11 JUMPIFNOTEQKS                    R2 K4 ["y"] ; [+8]
       13 GETTABLEKS                       R1 R0 K1 ["position"]
       15 GETTABLEKS                       R1 R1 K5 ["Y"]
       17 GETTABLEKS                       R1 R1 K3 ["Offset"]
       19 JUMP                             ; [+3]
       20 GETUPVAL                         R1 1
       21 GETUPVAL                         R2 0
       22 CALL                             R1 1 1
       ...
       26 GETTABLEKS                       R2 R0 K6 ["size"]
       28 GETTABLEKS                       R2 R2 K2 ["X"]
       30 GETTABLEKS                       R2 R2 K3 ["Offset"]
       32 JUMP                             ; [+13]
       33 GETUPVAL                         R3 0
       34 JUMPIFNOTEQKS                    R3 K4 ["y"] ; [+8]
       36 GETTABLEKS                       R2 R0 K6 ["size"]
       38 GETTABLEKS                       R2 R2 K5 ["Y"]
       40 GETTABLEKS                       R2 R2 K3 ["Offset"]
       42 JUMP                             ; [+3]
       43 GETUPVAL                         R2 1
       44 GETUPVAL                         R3 0
       45 CALL                             R2 1 1
...
MAIN:
       ...
       28 GETTABLEKS                       R5 R5 K10 ["exhaustiveMatch"]
       30 CALL                             R4 1 1
