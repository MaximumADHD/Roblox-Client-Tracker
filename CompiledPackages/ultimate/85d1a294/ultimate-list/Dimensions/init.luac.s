PROTO_0:
        0 DUPTABLE                         R1 K3 [{[1] = "getter", ["callback"]}]
        1 SETTABLEKS                       R0 R1 K2 ["callback"]
        3 RETURN                           R1 1

PROTO_1:
        0 DUPTABLE                         R1 K3 [{[1] = "consistentSize", ["size"]}]
        1 SETTABLEKS                       R0 R1 K2 ["size"]
        3 RETURN                           R1 1

PROTO_2:
        0 DUPTABLE                         R1 K3 [{[1] = "consistentUDim2", ["udim2"]}]
        1 SETTABLEKS                       R0 R1 K2 ["udim2"]
        3 RETURN                           R1 1
...
PROTO_3:
       ...
       16 GETUPVAL                         R2 0
       17 GETTABLEKS                       R2 R2 K6 ["withSpacing"]
       19 GETTABLEKS                       R3 R0 K7 ["inner"]
       21 MOVE                             R4 R1
       22 CALL                             R2 2 -1
       23 RETURN                           R2 -1
       24 DUPTABLE                         R2 K9 [{[1] = "spaced", ["spacing"], ["inner"]}]
       25 SETTABLEKS                       R1 R2 K8 ["spacing"]
       27 SETTABLEKS                       R0 R2 K7 ["inner"]
       29 RETURN                           R2 1
