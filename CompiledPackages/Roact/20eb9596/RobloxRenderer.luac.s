...
PROTO_1:
       ...
       13 RETURN                           R0 0
       14 GETUPVAL                         R2 0
       15 GETTABLEKS                       R2 R2 K3 ["of"]
       17 MOVE                             R3 R0
       18 CALL                             R2 1 1
       19 GETUPVAL                         R3 0
       20 GETTABLEKS                       R3 R3 K4 ["Binding"]
       22 JUMPIFNOTEQ                      R2 R3 ; [+8]
       24 GETUPVAL                         R2 1
       25 GETTABLEKS                       R2 R2 K5 ["update"]
       27 MOVE                             R3 R0
       28 MOVE                             R4 R1
       29 CALL                             R2 2 0
       30 RETURN                           R0 0
...
PROTO_4:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["hostObject"]
        3 GETUPVAL                         R1 1
        4 GETUPVAL                         R2 2
...
PROTO_5:
        ...
        9 JUMPIF                           R1 ; [+19]
       10 GETUPVAL                         R3 0
       11 GETTABLEKS                       R3 R3 K2 ["currentElement"]
       13 GETTABLEKS                       R3 R3 K3 ["source"]
...
PROTO_6:
       ...
       15 GETUPVAL                         R5 2
       16 GETTABLEKS                       R5 R5 K1 ["subscribe"]
       18 MOVE                             R6 R2
       19 MOVE                             R7 R3
       20 CALL                             R5 2 1
...
PROTO_8:
       ...
       59 RETURN                           R0 0
       60 GETUPVAL                         R6 2
       61 GETTABLEKS                       R6 R6 K0 ["of"]
       63 MOVE                             R7 R2
       64 CALL                             R6 1 1
       65 GETUPVAL                         R7 2
       66 GETTABLEKS                       R7 R7 K9 ["Binding"]
       68 JUMPIFEQ                         R6 R7 ; [+2]
       70 LOADB                            R5 0 +1
       71 LOADB                            R5 1
       72 GETUPVAL                         R7 2
       73 GETTABLEKS                       R7 R7 K0 ["of"]
       75 MOVE                             R8 R3
       76 CALL                             R7 1 1
       77 GETUPVAL                         R8 2
       78 GETTABLEKS                       R8 R8 K9 ["Binding"]
       80 JUMPIFEQ                         R7 R8 ; [+2]
       82 LOADB                            R6 0 +1
       83 LOADB                            R6 1
       84 JUMPIFNOT                        R6 ; [+9]
...
PROTO_13:
        ...
        6 GETUPVAL                         R5 0
        7 GETTABLEKS                       R5 R5 K3 ["internalTypeChecks"]
        9 JUMPIFNOT                        R5 ; [+15]
       10 GETUPVAL                         R5 1
       11 GETUPVAL                         R7 2
       12 GETTABLEKS                       R7 R7 K4 ["of"]
       14 MOVE                             R8 R2
       15 CALL                             R7 1 1
       16 GETUPVAL                         R8 2
       17 GETTABLEKS                       R8 R8 K5 ["Host"]
       19 JUMPIFEQ                         R7 R8 ; [+2]
       21 LOADB                            R6 0 +1
       22 LOADB                            R6 1
       ...
       24 CALL                             R5 2 0
       25 GETUPVAL                         R5 0
       26 GETTABLEKS                       R5 R5 K7 ["typeChecks"]
       28 JUMPIFNOT                        R5 ; [+28]
       29 GETTABLEKS                       R7 R2 K8 ["props"]
       31 GETTABLEKS                       R7 R7 K9 ["Name"]
...
PROTO_14:
       ...
       32 CALL                             R8 0 0
       33 FORGLOOP                         R3 2 ; [-3]
       35 GETTABLEKS                       R3 R1 K7 ["hostObject"]
       37 NAMECALL                         R3 R3 K8 ["Destroy"]
       39 CALL                             R3 1 0
       40 RETURN                           R0 0
...
PROTO_16:
        0 GETTABLEKS                       R3 R1 K0 ["currentElement"]
        2 GETTABLEKS                       R3 R3 K1 ["props"]
