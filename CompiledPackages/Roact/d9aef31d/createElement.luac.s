PROTO_0:
       ...
       60 GETUPVAL                         R3 2
       61 GETTABLEKS                       R3 R3 K9 ["warnOnce"]
       63 LOADK                            R4 K10 ["The prop `Roact.Children` was defined but was overridden by the third parameter to createElement!\nThis can happen when a component passes props through to a child element but also uses the `children` argument:\n\n\tRoact.createElement(\"Frame\", passedProps, {\n\t\tchild = ...\n\t})\n\nInstead, consider using a utility function to merge tables of children together:\n\n\tlocal children = mergeTables(passedProps[Roact.Children], {\n\t\tchild = ...\n\t})\n\n\tlocal fullProps = mergeTables(passedProps, {\n\t\t[Roact.Children] = children\n\t})\n\n\tRoact.createElement(\"Frame\", fullProps)"]
       64 CALL                             R3 1 0
       65 GETUPVAL                         R3 1
       66 SETTABLE                         R2 R1 R3
       67 GETUPVAL                         R3 3
       68 GETTABLEKS                       R3 R3 K11 ["fromComponent"]
       70 MOVE                             R4 R0
       71 CALL                             R3 1 1
       72 NEWTABLE                         R4 4 0
       74 GETUPVAL                         R5 4
       75 GETUPVAL                         R6 4
       76 GETTABLEKS                       R6 R6 K12 ["Element"]
       ...
       85 GETUPVAL                         R5 0
       86 GETTABLEKS                       R5 R5 K15 ["elementTracing"]
       88 JUMPIFNOT                        R5 ; [+11]
