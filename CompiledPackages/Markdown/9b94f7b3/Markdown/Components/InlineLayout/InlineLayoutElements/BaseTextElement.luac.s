...
PROTO_7:
        ...
        6 JUMPIFNOT                        R3 ; [+9]
        7 GETUPVAL                         R3 1
        8 GETTABLEKS                       R4 R0 K4 ["props"]
       10 GETTABLEKS                       R4 R4 K5 ["fontStyle"]
       12 CALL                             R3 1 1
       13 SETTABLEKS                       R3 R2 K6 ["Font"]
       15 JUMP                             ; [+11]
       16 GETIMPORT                        R3 K8 [Font.fromEnum]
       18 GETTABLEKS                       R4 R0 K4 ["props"]
       20 GETTABLEKS                       R4 R4 K5 ["fontStyle"]
       22 GETTABLEKS                       R4 R4 K6 ["Font"]
       24 CALL                             R3 1 1
       25 SETTABLEKS                       R3 R2 K6 ["Font"]
       27 GETTABLEKS                       R3 R0 K4 ["props"]
       29 GETTABLEKS                       R3 R3 K5 ["fontStyle"]
       31 GETTABLEKS                       R3 R3 K9 ["FontSize"]
       ...
       40 GETUPVAL                         R3 2
       41 MOVE                             R4 R1
       42 GETTABLEKS                       R5 R0 K4 ["props"]
       44 GETTABLEKS                       R5 R5 K13 ["TextVariant"]
       46 CALL                             R3 2 1
       ...
       83 GETUPVAL                         R5 3
       84 MOVE                             R7 R2
       85 NAMECALL                         R5 R5 K21 ["GetTextBoundsAsync"]
       87 CALL                             R5 2 1
       88 GETTABLEKS                       R5 R5 K22 ["X"]
       90 RETURN                           R5 1
...
PROTO_10:
       ...
       14 GETTABLEKS                       R4 R4 K3 ["TextVariant"]
       16 JUMPIFNOT                        R4 ; [+11]
       17 GETUPVAL                         R4 0
       18 GETTABLEKS                       R5 R0 K0 ["props"]
       20 GETTABLEKS                       R5 R5 K1 ["Text"]
       22 GETTABLEKS                       R6 R0 K0 ["props"]
       24 GETTABLEKS                       R6 R6 K3 ["TextVariant"]
       26 CALL                             R4 2 1
       27 MOVE                             R3 R4
       28 GETUPVAL                         R4 1
       ...
       60 GETUPVAL                         R10 3
       61 GETTABLEKS                       R10 R10 K18 ["None"]
...
MAIN:
       ...
       19 LOADK                            R5 K8 ["Components"]
       20 NAMECALL                         R3 R3 K3 ["FindFirstAncestor"]
       22 CALL                             R3 2 1
       23 GETTABLEKS                       R3 R3 K9 ["Parent"]
       25 GETIMPORT                        R4 K5 [require]
       27 GETTABLEKS                       R5 R3 K10 ["Utils"]
       29 GETTABLEKS                       R5 R5 K11 ["IsCli"]
       31 CALL                             R4 1 1
       32 GETIMPORT                        R5 K5 [require]
       34 GETTABLEKS                       R6 R3 K10 ["Utils"]
       36 GETTABLEKS                       R6 R6 K12 ["TextSplitByEnum"]
       38 CALL                             R5 1 1
       39 GETIMPORT                        R6 K5 [require]
       41 GETTABLEKS                       R7 R3 K10 ["Utils"]
       43 GETTABLEKS                       R7 R7 K13 ["SplitText"]
       45 CALL                             R6 1 1
       46 GETIMPORT                        R7 K5 [require]
       48 GETTABLEKS                       R8 R3 K10 ["Utils"]
       50 GETTABLEKS                       R8 R8 K14 ["InlineElementType"]
       52 CALL                             R7 1 1
       53 GETIMPORT                        R8 K5 [require]
       55 GETTABLEKS                       R9 R3 K10 ["Utils"]
       57 GETTABLEKS                       R9 R9 K15 ["GetFontFace"]
       59 CALL                             R8 1 1
       60 GETIMPORT                        R9 K5 [require]
       62 GETTABLEKS                       R10 R3 K16 ["Flags"]
       64 GETTABLEKS                       R10 R10 K17 ["FFlagMarkdownStudioThemeColors"]
       66 CALL                             R9 1 1
