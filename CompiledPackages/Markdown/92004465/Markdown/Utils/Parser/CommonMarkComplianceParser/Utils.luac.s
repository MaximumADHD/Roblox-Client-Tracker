...
MAIN:
       ...
       24 DUPTABLE                         R4 K21 [{["char"] = "*", ["length"] = 1}]
       25 SETTABLEKS                       R4 R3 K10 ["BOLD"]
       27 DUPTABLE                         R4 K23 [{["char"] = "*", ["length"] = 2}]
       28 SETTABLEKS                       R4 R3 K11 ["BOLD_2"]
       30 DUPTABLE                         R4 K25 [{["char"] = "_", ["length"] = 1}]
       31 SETTABLEKS                       R4 R3 K12 ["ITALIC"]
       33 DUPTABLE                         R4 K26 [{["char"] = "_", ["length"] = 2}]
       34 SETTABLEKS                       R4 R3 K13 ["ITALIC_2"]
       36 DUPTABLE                         R4 K28 [{["char"] = "~", ["length"] = 1}]
       37 SETTABLEKS                       R4 R3 K14 ["STRIKE"]
       39 DUPTABLE                         R4 K30 [{["char"] = "`", ["length"] = 1}]
       40 SETTABLEKS                       R4 R3 K15 ["INLINE_CODE"]
       42 NEWTABLE                         R4 16 0
       44 DUPCLOSURE                       R5 K31 [PROTO_0]
       45 CAPTURE                          VAL R3
       46 SETTABLEKS                       R5 R4 K32 ["getDelimiterInfo"]
       48 DUPCLOSURE                       R5 K33 [PROTO_1]
       49 SETTABLEKS                       R5 R4 K34 ["causesLineBreak"]
       51 DUPCLOSURE                       R5 K35 [PROTO_2]
       52 SETTABLEKS                       R5 R4 K36 ["getTokenNameFromCharAndLength"]
       54 DUPCLOSURE                       R5 K37 [PROTO_3]
       55 SETTABLEKS                       R5 R4 K38 ["canDelimitersMatch"]
       57 DUPCLOSURE                       R5 K39 [PROTO_4]
       58 SETTABLEKS                       R5 R4 K40 ["addDelimiterMatch"]
       60 DUPCLOSURE                       R5 K41 [PROTO_5]
       61 CAPTURE                          VAL R1
       62 SETTABLEKS                       R5 R4 K42 ["isWhitespace"]
       64 DUPCLOSURE                       R5 K43 [PROTO_6]
       65 CAPTURE                          VAL R1
       66 SETTABLEKS                       R5 R4 K44 ["isPunctuation"]
       68 DUPCLOSURE                       R5 K45 [PROTO_7]
       69 CAPTURE                          VAL R4
       70 SETTABLEKS                       R5 R4 K46 ["isLeftFlanking"]
       72 DUPCLOSURE                       R5 K47 [PROTO_8]
       73 CAPTURE                          VAL R4
       74 SETTABLEKS                       R5 R4 K48 ["isRightFlanking"]
       76 DUPCLOSURE                       R5 K49 [PROTO_9]
       77 CAPTURE                          VAL R4
       78 SETTABLEKS                       R5 R4 K50 ["canOpenEmphasis"]
       80 DUPCLOSURE                       R5 K51 [PROTO_10]
       81 CAPTURE                          VAL R4
       82 SETTABLEKS                       R5 R4 K52 ["canCloseEmphasis"]
       84 DUPCLOSURE                       R5 K53 [PROTO_11]
       85 SETTABLEKS                       R5 R4 K54 ["getCharacterContext"]
       87 DUPCLOSURE                       R5 K55 [PROTO_12]
       88 SETTABLEKS                       R5 R4 K56 ["isInsideInlineCode"]
       90 RETURN                           R4 1
