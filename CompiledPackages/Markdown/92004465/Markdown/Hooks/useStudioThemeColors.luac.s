...
PROTO_6:
        ...
        4 LOADK                            R2 K0 ["useStudioThemeColors is disabled"]
        5 GETIMPORT                        R0 K2 [assert]
        7 CALL                             R0 2 0
        8 GETUPVAL                         R0 1
        9 GETTABLEKS                       R0 R0 K3 ["useState"]
       11 GETUPVAL                         R1 2
       12 GETTABLEKS                       R1 R1 K4 ["defaultColors"]
       14 CALL                             R0 1 2
       15 GETUPVAL                         R2 1
...
MAIN:
       ...
       18 GETTABLEKS                       R3 R0 K8 ["Utils"]
       20 GETTABLEKS                       R3 R3 K9 ["Highlighter"]
       22 GETTABLEKS                       R3 R3 K10 ["Theme"]
       24 CALL                             R2 1 1
       25 GETIMPORT                        R3 K6 [require]
       27 GETTABLEKS                       R4 R0 K11 ["Types"]
       29 CALL                             R3 1 1
       30 GETIMPORT                        R4 K6 [require]
       32 GETTABLEKS                       R5 R0 K8 ["Utils"]
       34 GETTABLEKS                       R5 R5 K12 ["IsCli"]
       36 CALL                             R4 1 1
       37 GETIMPORT                        R5 K6 [require]
       39 GETTABLEKS                       R6 R0 K13 ["Flags"]
       41 GETTABLEKS                       R6 R6 K14 ["FFlagMarkdownStudioThemeColors"]
       43 CALL                             R5 1 1
       44 DUPCLOSURE                       R6 K15 [PROTO_6]
       45 CAPTURE                          VAL R5
       46 CAPTURE                          VAL R1
       47 CAPTURE                          VAL R2
       48 CAPTURE                          VAL R4
