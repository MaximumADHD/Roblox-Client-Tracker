...
MAIN:
       ...
       27 DUPTABLE                         R6 K14 [{["__mode"] = "k"}]
       28 CALL                             R5 1 1
       29 DUPCLOSURE                       R6 K15 [PROTO_0]
       30 CAPTURE                          VAL R5
       31 DUPCLOSURE                       R7 K16 [PROTO_1]
       32 DUPCLOSURE                       R8 K17 [PROTO_2]
       33 DUPCLOSURE                       R9 K18 [PROTO_3]
       34 CAPTURE                          VAL R8
       35 DUPCLOSURE                       R10 K19 [PROTO_6]
       36 CAPTURE                          VAL R9
       37 CAPTURE                          VAL R4
       38 GETIMPORT                        R11 K21 [_G]
       40 GETTABLEKS                       R11 R11 K22 ["__SIGNALS_VALIDATION_ENABLED__"]
       42 JUMPIF                           R11 ; [+4]
       43 GETIMPORT                        R11 K21 [_G]
       45 GETTABLEKS                       R11 R11 K23 ["__DEV__"]
       47 JUMPIFNOT                        R11 ; [+2]
       48 MOVE                             R12 R10
       49 JUMP                             ; [+1]
       50 MOVE                             R12 R4
       51 DUPCLOSURE                       R13 K24 [PROTO_13]
       52 CAPTURE                          VAL R7
       53 CAPTURE                          VAL R4
       54 CAPTURE                          VAL R5
       55 CAPTURE                          VAL R2
       56 DUPCLOSURE                       R14 K25 [PROTO_23]
       57 CAPTURE                          VAL R7
       58 CAPTURE                          VAL R5
       59 CAPTURE                          VAL R12
       60 CAPTURE                          VAL R4
       61 DUPCLOSURE                       R15 K26 [PROTO_29]
       62 CAPTURE                          VAL R12
       63 CAPTURE                          VAL R3
       64 DUPTABLE                         R16 K30 [{"createSignal", "createComputed", "createEffect"}]
       65 SETTABLEKS                       R13 R16 K27 ["createSignal"]
       67 SETTABLEKS                       R14 R16 K28 ["createComputed"]
       69 SETTABLEKS                       R15 R16 K29 ["createEffect"]
       71 RETURN                           R16 1
