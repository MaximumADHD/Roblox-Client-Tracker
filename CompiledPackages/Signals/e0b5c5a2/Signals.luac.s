...
PROTO_17:
       ...
       20 MOVE                             R3 R1
       21 GETIMPORT                        R2 K1 [setmetatable]
       23 CALL                             R2 2 1
       24 MOVE                             R0 R2
       25 SETUPVAL                         R0 3
       26 GETUPVAL                         R0 5
...
PROTO_29:
        ...
        3 NEWTABLE                         R5 0 0
        5 GETUPVAL                         R8 0
        6 FASTCALL2                        SETMETATABLE R5 R8 ; [+4]
        8 MOVE                             R7 R5
        9 GETIMPORT                        R6 K1 [setmetatable]
       11 CALL                             R6 2 1
       12 MOVE                             R4 R6
       13 LOADNIL                          R5
       14 NEWCLOSURE                       R6 P0
...
MAIN:
       ...
       16 GETTABLEKS                       R2 R2 K6 ["Scheduler"]
       18 CALL                             R1 1 1
       19 GETTABLEKS                       R2 R1 K7 ["scheduleWork"]
       21 GETTABLEKS                       R3 R1 K8 ["runContinuations"]
       23 DUPCLOSURE                       R4 K9 [PROTO_0]
       24 DUPTABLE                         R5 K12 [{["__mode"] = "k"}]
       25 DUPCLOSURE                       R6 K13 [PROTO_1]
       26 CAPTURE                          VAL R5
       27 DUPCLOSURE                       R7 K14 [PROTO_2]
       28 DUPCLOSURE                       R8 K15 [PROTO_3]
       29 CAPTURE                          VAL R7
       30 DUPCLOSURE                       R9 K16 [PROTO_6]
       31 CAPTURE                          VAL R8
       32 CAPTURE                          VAL R0
       33 GETIMPORT                        R10 K18 [_G]
       35 GETTABLEKS                       R10 R10 K19 ["__SIGNALS_VALIDATION_ENABLED__"]
       37 JUMPIF                           R10 ; [+4]
       38 GETIMPORT                        R10 K18 [_G]
       40 GETTABLEKS                       R10 R10 K20 ["__DEV__"]
       42 JUMPIFNOT                        R10 ; [+2]
       43 MOVE                             R11 R9
       44 JUMP                             ; [+1]
       45 MOVE                             R11 R0
       46 DUPCLOSURE                       R12 K21 [PROTO_13]
       47 CAPTURE                          VAL R4
       48 CAPTURE                          VAL R0
       49 CAPTURE                          VAL R5
       50 CAPTURE                          VAL R3
       51 DUPCLOSURE                       R13 K22 [PROTO_23]
       52 CAPTURE                          VAL R4
       53 CAPTURE                          VAL R5
       54 CAPTURE                          VAL R11
       55 CAPTURE                          VAL R0
       56 DUPCLOSURE                       R14 K23 [PROTO_29]
       57 CAPTURE                          VAL R5
       58 CAPTURE                          VAL R11
       59 CAPTURE                          VAL R2
       60 DUPTABLE                         R15 K27 [{"createSignal", "createComputed", "createEffect"}]
       61 SETTABLEKS                       R12 R15 K24 ["createSignal"]
       63 SETTABLEKS                       R13 R15 K25 ["createComputed"]
       65 SETTABLEKS                       R14 R15 K26 ["createEffect"]
       67 RETURN                           R15 1
