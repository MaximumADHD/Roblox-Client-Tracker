PROTO_0:
       ...
       13 GETUPVAL                         R7 2
       14 MOVE                             R8 R0
       15 DUPTABLE                         R9 K10 [{["maxDepth"] = 1, ["min"] = True}]
       16 CALL                             R7 2 -1
       17 NAMECALL                         R5 R5 K11 ["format"]
       19 CALL                             R5 -1 1
       20 CONCAT                           R3 R4 R5
       21 CALL                             R2 1 -1
       22 CALL                             R1 -1 0
       ...
       26 JUMPIFNOT                        R1 ; [+20]
       27 GETUPVAL                         R1 4
       28 GETTABLEN                        R2 R0 1
       29 CALL                             R1 1 1
       30 JUMPIFNOT                        R1 ; [+8]
       31 GETIMPORT                        R1 K2 [error]
       33 GETUPVAL                         R2 1
       34 GETTABLEKS                       R2 R2 K3 ["new"]
       36 LOADK                            R3 K12 ["Error: `.each` called with an empty Tagged Template Literal of table data.\n"]
       37 CALL                             R2 1 -1
       38 CALL                             R1 -1 0
       39 GETIMPORT                        R1 K2 [error]
       41 GETUPVAL                         R2 1
       42 GETTABLEKS                       R2 R2 K3 ["new"]
       44 LOADK                            R3 K13 ["Error: `.each` called with a Tagged Template Literal with no data, remember to interpolate with ${expression} syntax.\n"]
       45 CALL                             R2 1 -1
       46 CALL                             R1 -1 0
       47 GETUPVAL                         R1 5
       48 MOVE                             R2 R0
       49 CALL                             R1 1 1
       50 JUMPIFNOT                        R1 ; [+8]
       51 GETIMPORT                        R1 K2 [error]
       53 GETUPVAL                         R2 1
       54 GETTABLEKS                       R2 R2 K3 ["new"]
       56 LOADK                            R3 K14 ["Error: `.each` called with an empty Array of table data.\n"]
       57 CALL                             R2 1 -1
       58 CALL                             R1 -1 0
       59 RETURN                           R0 0
