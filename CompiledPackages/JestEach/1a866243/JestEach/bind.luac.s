...
PROTO_2:
       ...
       13 CALL                             R0 3 1
       14 GETUPVAL                         R1 6
       15 GETTABLEKS                       R1 R1 K0 ["forEach"]
       17 MOVE                             R2 R0
       18 NEWCLOSURE                       R3 P0
       19 CAPTURE                          UPVAL U7
       20 CAPTURE                          UPVAL U8
...
PROTO_13:
        ...
        4 RETURN                           R1 1
        5 GETUPVAL                         R1 1
        6 GETTABLEKS                       R1 R1 K0 ["isArray"]
        8 MOVE                             R2 R0
        9 CALL                             R1 1 1
       10 JUMPIFNOT                        R1 ; [+8]
       11 GETUPVAL                         R1 1
       12 GETTABLEKS                       R1 R1 K1 ["map"]
       14 MOVE                             R2 R0
       15 NEWCLOSURE                       R3 P0
       16 CAPTURE                          UPVAL U2
       17 CALL                             R1 2 -1
       ...
       26 GETUPVAL                         R1 1
       27 GETTABLEKS                       R1 R1 K5 ["forEach"]
       29 GETUPVAL                         R2 3
       30 GETTABLEKS                       R2 R2 K6 ["keys"]
       32 MOVE                             R3 R0
       33 CALL                             R2 1 1
       34 NEWCLOSURE                       R3 P1
       35 CAPTURE                          VAL R0
...
MAIN:
       ...
       24 GETTABLEKS                       R6 R6 K9 ["nilPlaceholder"]
       26 CALL                             R5 1 1
       27 NEWTABLE                         R6 1 0
       ...
       49 GETTABLEKS                       R12 R12 K14 ["table"]
       51 GETTABLEKS                       R12 R12 K15 ["array"]
       53 CALL                             R11 1 1
       54 GETTABLEKS                       R11 R11 K16 ["default"]
       56 GETIMPORT                        R12 K4 [require]
       58 GETIMPORT                        R13 K1 [script]
       60 GETTABLEKS                       R13 R13 K2 ["Parent"]
       62 GETTABLEKS                       R13 R13 K14 ["table"]
       64 GETTABLEKS                       R13 R13 K17 ["template"]
       66 CALL                             R12 1 1
       67 GETTABLEKS                       R12 R12 K16 ["default"]
       69 GETIMPORT                        R13 K4 [require]
       71 GETIMPORT                        R14 K1 [script]
       73 GETTABLEKS                       R14 R14 K2 ["Parent"]
       75 GETTABLEKS                       R14 R14 K18 ["validation"]
       77 CALL                             R13 1 1
