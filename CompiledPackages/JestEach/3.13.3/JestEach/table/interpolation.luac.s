PROTO_0:
        ...
        3 GETUPVAL                         R4 0
        4 GETTABLEKS                       R4 R4 K0 ["reduce"]
        6 GETUPVAL                         R5 1
        7 GETTABLEKS                       R5 R5 K1 ["keys"]
        9 MOVE                             R6 R1
       10 CALL                             R5 1 1
       11 GETUPVAL                         R6 2
       12 MOVE                             R7 R0
       ...
       34 MOVE                             R7 R2
       35 GETIMPORT                        R6 K4 [tostring]
       37 CALL                             R6 1 1
       38 LOADN                            R7 1
       39 NAMECALL                         R3 R3 K5 ["gsub"]
       41 CALL                             R3 4 -1
       42 RETURN                           R3 -1
...
PROTO_4:
       ...
       32 GETUPVAL                         R8 4
       33 MOVE                             R9 R4
       34 DUPTABLE                         R10 K11 [{["maxDepth"] = 1, ["min"] = True}]
       35 CALL                             R8 2 1
       36 LOADN                            R9 1
       37 NAMECALL                         R5 R0 K2 ["gsub"]
       39 CALL                             R5 4 -1
       40 RETURN                           R5 -1
...
PROTO_6:
       ...
       24 NEWTABLE                         R3 0 0
       26 GETUPVAL                         R4 0
       27 GETTABLEKS                       R4 R4 K4 ["toJSBoolean"]
       29 MOVE                             R5 R2
       30 CALL                             R4 1 1
       31 JUMPIFNOT                        R4 ; [+3]
...
MAIN:
       ...
       26 GETTABLEKS                       R8 R0 K10 ["JestGetType"]
       28 CALL                             R7 1 1
       29 GETTABLEKS                       R7 R7 K11 ["isPrimitive"]
       31 GETIMPORT                        R8 K4 [require]
       33 GETTABLEKS                       R9 R0 K12 ["PrettyFormat"]
       35 CALL                             R8 1 1
       36 GETTABLEKS                       R8 R8 K13 ["format"]
       38 LOADNIL                          R9
       39 LOADNIL                          R10
       40 LOADNIL                          R11
