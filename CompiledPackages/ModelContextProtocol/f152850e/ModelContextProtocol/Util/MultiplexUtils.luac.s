...
PROTO_6:
        0 DUPTABLE                         R2 K3 [{"name", "description", "inputSchema"}]
        1 LOADK                            R4 K4 ["%*-%*"]
        2 MOVE                             R6 R0
        3 GETTABLEKS                       R7 R1 K0 ["name"]
        5 NAMECALL                         R4 R4 K5 ["format"]
        7 CALL                             R4 3 1
        8 MOVE                             R3 R4
        9 SETTABLEKS                       R3 R2 K0 ["name"]
       11 GETTABLEKS                       R3 R1 K1 ["description"]
       13 SETTABLEKS                       R3 R2 K1 ["description"]
       15 GETTABLEKS                       R3 R1 K2 ["inputSchema"]
       17 SETTABLEKS                       R3 R2 K2 ["inputSchema"]
       19 RETURN                           R2 1
...
MAIN:
       ...
       39 SETTABLEKS                       R8 R4 K21 ["DEPRECATED_unpackToolIdentifier"]
       41 DUPCLOSURE                       R8 K22 [PROTO_6]
       42 SETTABLEKS                       R8 R4 K23 ["DEPRECATED_updateToolDefinitionForServer"]
       44 DUPCLOSURE                       R8 K24 [PROTO_7]
       45 CAPTURE                          VAL R3
       46 SETTABLEKS                       R8 R4 K25 ["updateToolNameAlias"]
       48 DUPCLOSURE                       R8 K26 [PROTO_8]
       49 CAPTURE                          VAL R7
       50 CAPTURE                          VAL R4
       51 SETTABLEKS                       R8 R4 K27 ["getServerNameFromToolNameAlias"]
       53 RETURN                           R4 1
