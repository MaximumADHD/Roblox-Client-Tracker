...
PROTO_4:
       ...
       42 DUPTABLE                         R3 K12 [{["responseType"], ["accumulatedResponse"] = ""}]
       43 GETUPVAL                         R4 5
       ...
       51 JUMP                             ; [+44]
       52 GETUPVAL                         R3 5
       53 GETTABLEKS                       R3 R3 K7 ["ResponseType"]
       55 GETTABLEKS                       R3 R3 K13 ["EventStream"]
       57 JUMPIFNOTEQ                      R2 R3 ; [+28]
       59 NEWCLOSURE                       R3 P0
       60 CAPTURE                          UPVAL U7
       61 CAPTURE                          UPVAL U8
       62 DUPTABLE                         R4 K15 [{"responseType", "eventStreamParser"}]
       63 GETUPVAL                         R5 5
       64 GETTABLEKS                       R5 R5 K7 ["ResponseType"]
       66 GETTABLEKS                       R5 R5 K13 ["EventStream"]
       68 SETTABLEKS                       R5 R4 K9 ["responseType"]
       70 GETUPVAL                         R5 9
       71 GETTABLEKS                       R5 R5 K16 ["createParser"]
       73 DUPTABLE                         R6 K18 [{"onEvent"}]
       74 GETUPVAL                         R7 5
       75 GETTABLEKS                       R7 R7 K19 ["wrapSSECallback"]
       77 MOVE                             R8 R3
       78 CALL                             R7 1 1
       79 SETTABLEKS                       R7 R6 K17 ["onEvent"]
       81 CALL                             R5 1 1
       82 SETTABLEKS                       R5 R4 K14 ["eventStreamParser"]
       84 SETUPVAL                         R4 6
       85 JUMP                             ; [+10]
       86 GETUPVAL                         R3 1
       87 GETTABLEKS                       R3 R3 K4 ["disconnect"]
       89 CALL                             R3 0 0
       90 GETUPVAL                         R3 2
       91 GETUPVAL                         R4 3
       92 GETTABLEKS                       R4 R4 K20 ["UnexpectedServerResponse"]
       94 CALL                             R3 1 -1
       95 RETURN                           R3 -1
       96 GETUPVAL                         R3 10
       97 GETTABLEKS                       R3 R3 K21 ["method"]
       99 JUMPIFNOTEQKS                    R3 K22 ["initialize"] ; [+17]
      101 GETUPVAL                         R4 5
      102 GETTABLEKS                       R4 R4 K23 ["Headers"]
      104 GETTABLEKS                       R4 R4 K24 ["MCP_SESSION_ID_HEADER"]
      106 GETTABLE                         R3 R1 R4
      107 JUMPIFNOT                        R3 ; [+9]
      108 GETUPVAL                         R3 7
      109 GETUPVAL                         R5 5
      110 GETTABLEKS                       R5 R5 K23 ["Headers"]
      112 GETTABLEKS                       R5 R5 K24 ["MCP_SESSION_ID_HEADER"]
      114 GETTABLE                         R4 R1 R5
      115 SETTABLEKS                       R4 R3 K25 ["sessionId"]
      117 RETURN                           R0 0
