...
PROTO_1:
       ...
       60 JUMPIFNOT                        R1 ; [+6]
       61 GETUPVAL                         R2 0
       62 GETTABLEKS                       R2 R2 K0 ["Headers"]
       64 GETTABLEKS                       R2 R2 K12 ["AUTHORIZATION"]
...
PROTO_14:
       ...
       15 CALL                             R1 2 0
       16 GETUPVAL                         R1 1
       17 GETTABLEKS                       R1 R1 K6 ["disconnect"]
       19 CALL                             R1 0 0
       20 GETUPVAL                         R1 2
       21 GETTABLEKS                       R1 R1 K7 ["new"]
       23 GETUPVAL                         R2 3
       24 GETUPVAL                         R3 4
       25 CALL                             R1 2 1
       26 DUPTABLE                         R2 K11 [{["transport"], ["type"] = "sse"}]
       27 GETTABLEKS                       R3 R1 K8 ["transport"]
       29 SETTABLEKS                       R3 R2 K8 ["transport"]
       31 SETUPVAL                         R2 5
       32 GETUPVAL                         R3 5
       33 FASTCALL2K                       ASSERT R3 K12 ; [+4]
       35 LOADK                            R4 K12 ["variant is nil"]
       36 GETIMPORT                        R2 K14 [assert]
       38 CALL                             R2 2 0
       39 GETUPVAL                         R2 6
       40 GETUPVAL                         R3 5
       41 GETTABLEKS                       R3 R3 K8 ["transport"]
       43 CALL                             R2 1 0
       44 GETUPVAL                         R2 5
       45 GETTABLEKS                       R2 R2 K8 ["transport"]
       47 GETTABLEKS                       R2 R2 K15 ["start"]
       49 CALL                             R2 0 1
       50 NEWCLOSURE                       R4 P0
       51 CAPTURE                          UPVAL U5
       52 CAPTURE                          UPVAL U7
       53 NAMECALL                         R2 R2 K16 ["andThen"]
       55 CALL                             R2 2 1
       56 NEWCLOSURE                       R4 P1
       57 CAPTURE                          UPVAL U8
       58 NAMECALL                         R2 R2 K16 ["andThen"]
       60 CALL                             R2 2 1
       61 NEWCLOSURE                       R4 P2
       62 CAPTURE                          UPVAL U9
       63 NAMECALL                         R2 R2 K17 ["catch"]
       65 CALL                             R2 2 0
       66 RETURN                           R0 0
