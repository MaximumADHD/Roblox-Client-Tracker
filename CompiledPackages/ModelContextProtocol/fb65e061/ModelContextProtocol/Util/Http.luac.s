...
PROTO_3:
       ...
       14 MOVE                             R6 R2
       15 MOVE                             R7 R3
       16 NAMECALL                         R4 R4 K4 ["format"]
       18 CALL                             R4 3 1
       19 LOADN                            R7 1
       20 LOADN                            R8 1
       21 NAMECALL                         R5 R0 K5 ["sub"]
       23 CALL                             R5 3 1
       24 JUMPIFNOTEQKS                    R5 K6 ["/"] ; [+8]
       26 LOADK                            R5 K7 ["%*%*"]
       27 MOVE                             R7 R4
       28 MOVE                             R8 R0
       ...
       31 CALL                             R5 3 1
       32 RETURN                           R5 1
       33 LOADK                            R8 K8 ["^https?://[^/]+(.*)"]
       34 NAMECALL                         R6 R1 K1 ["match"]
       36 CALL                             R6 2 1
       37 ORK                              R5 R6 K6 ["/"]
       38 LOADK                            R9 K9 ["^(.*/)"]
       39 NAMECALL                         R7 R5 K1 ["match"]
       41 CALL                             R7 2 1
       42 ORK                              R6 R7 K6 ["/"]
       43 LOADK                            R7 K10 ["%*%*%*"]
       44 MOVE                             R9 R4
