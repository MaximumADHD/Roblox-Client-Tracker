...
PROTO_8:
        ...
        2 DUPTABLE                         R4 K4 [{["schema"], ["required"] = False}]
...
PROTO_9:
        0 GETTABLEKS                       R3 R0 K0 ["args"]
        2 DUPTABLE                         R4 K4 [{["schema"], ["required"] = True}]
        3 SETTABLEKS                       R2 R4 K1 ["schema"]
        5 SETTABLE                         R4 R3 R1
        6 RETURN                           R0 1
...
PROTO_12:
        ...
        9 LOADK                            R9 K2 ["Missing required argument: %*"]
       10 MOVE                             R11 R7
       ...
       20 GETUPVAL                         R4 1
       21 GETTABLEKS                       R4 R4 K6 ["handler"]
       23 MOVE                             R5 R0
       24 MOVE                             R6 R1
       25 MOVE                             R7 R2
       26 CALL                             R3 4 2
...
PROTO_13:
       ...
       41 GETUPVAL                         R3 0
       42 GETTABLEKS                       R3 R3 K14 ["emptyObject"]
       44 CALL                             R3 0 1
       45 MOVE                             R1 R3
       46 NEWCLOSURE                       R3 P0
       47 CAPTURE                          VAL R2
       48 CAPTURE                          VAL R0
       49 CAPTURE                          UPVAL U1
       50 DUPTABLE                         R4 K18 [{["type"] = "object", ["properties"], ["required"]}]
       51 SETTABLEKS                       R1 R4 K17 ["properties"]
       53 SETTABLEKS                       R2 R4 K5 ["required"]
       55 DUPTABLE                         R5 K26 [{"name", "description", "inputSchema", "outputSchema", "annotations", "execution", "icons"}]
       56 GETTABLEKS                       R6 R0 K19 ["name"]
       58 SETTABLEKS                       R6 R5 K19 ["name"]
       60 GETTABLEKS                       R6 R0 K20 ["description"]
       62 SETTABLEKS                       R6 R5 K20 ["description"]
       64 SETTABLEKS                       R4 R5 K21 ["inputSchema"]
       66 GETTABLEKS                       R6 R0 K22 ["outputSchema"]
       68 SETTABLEKS                       R6 R5 K22 ["outputSchema"]
       70 GETTABLEKS                       R6 R0 K23 ["annotations"]
       72 SETTABLEKS                       R6 R5 K23 ["annotations"]
       74 GETTABLEKS                       R6 R0 K24 ["execution"]
       76 SETTABLEKS                       R6 R5 K24 ["execution"]
       78 GETTABLEKS                       R6 R0 K25 ["icons"]
       80 SETTABLEKS                       R6 R5 K25 ["icons"]
       82 DUPTABLE                         R6 K29 [{"definition", "handler", "mcpDisabled"}]
       83 SETTABLEKS                       R5 R6 K27 ["definition"]
       85 SETTABLEKS                       R3 R6 K0 ["handler"]
       87 GETTABLEKS                       R7 R0 K28 ["mcpDisabled"]
       89 SETTABLEKS                       R7 R6 K28 ["mcpDisabled"]
       91 RETURN                           R6 1
...
MAIN:
       ...
       11 GETTABLEKS                       R2 R2 K7 ["ToolResult"]
       13 CALL                             R1 1 1
