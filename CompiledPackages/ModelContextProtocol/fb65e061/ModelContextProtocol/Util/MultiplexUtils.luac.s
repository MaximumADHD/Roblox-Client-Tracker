...
PROTO_2:
        ...
        9 LOADK                            R3 K4 ["Invalid identifier: %*"]
       10 MOVE                             R5 R0
       ...
       16 ADDK                             R5 R1 K6 [1]
       17 LOADB                            R6 1
       18 NAMECALL                         R2 R0 K1 ["find"]
       20 CALL                             R2 4 1
       21 JUMPIF                           R2 ; [+8]
       22 GETIMPORT                        R3 K3 [error]
       24 LOADK                            R4 K4 ["Invalid identifier: %*"]
       25 MOVE                             R6 R0
       26 NAMECALL                         R4 R4 K5 ["format"]
       28 CALL                             R4 2 1
       29 CALL                             R3 1 0
       30 LOADN                            R5 1
       31 SUBK                             R6 R2 K6 [1]
       32 NAMECALL                         R3 R0 K7 ["sub"]
       34 CALL                             R3 3 1
       35 ADDK                             R6 R2 K6 [1]
       36 NAMECALL                         R4 R0 K7 ["sub"]
       38 CALL                             R4 2 1
       39 RETURN                           R3 2
...
PROTO_3:
        ...
        7 LOADN                            R8 1
        8 LOADN                            R9 5
        9 NAMECALL                         R6 R4 K3 ["sub"]
       11 CALL                             R6 3 1
       12 CONCAT                           R3 R5 R6
       13 LOADK                            R6 K4 ["%s"]
       14 LOADK                            R7 K5 ["_"]
       15 NAMECALL                         R4 R0 K6 ["gsub"]
       17 CALL                             R4 3 1
       18 LOADK                            R6 K7 ["-"]
       19 LOADK                            R7 K5 ["_"]
       20 NAMECALL                         R4 R4 K6 ["gsub"]
       22 CALL                             R4 3 1
       23 NAMECALL                         R1 R1 K8 ["format"]
       25 CALL                             R1 3 1
       26 RETURN                           R1 1
...
PROTO_5:
        ...
        6 CALL                             R2 3 1
        7 LOADK                            R5 K3 ["[^a-zA-Z0-9_-]"]
        8 LOADK                            R6 K4 ["_"]
        9 NAMECALL                         R3 R2 K5 ["gsub"]
       11 CALL                             R3 3 1
       12 MOVE                             R2 R3
       13 GETUPVAL                         R3 0
       14 GETTABLEKS                       R3 R3 K6 ["join"]
       16 MOVE                             R4 R1
       17 DUPTABLE                         R5 K7 [{"name"}]
       18 SETTABLEKS                       R2 R5 K1 ["name"]
       20 CALL                             R3 2 -1
       21 RETURN                           R3 -1
...
PROTO_6:
        ...
        2 CALL                             R1 1 2
        3 GETUPVAL                         R3 1
        4 GETTABLEKS                       R3 R3 K0 ["unpackServerIdentifier"]
        6 MOVE                             R4 R1
        7 CALL                             R3 1 2
        8 RETURN                           R4 1
