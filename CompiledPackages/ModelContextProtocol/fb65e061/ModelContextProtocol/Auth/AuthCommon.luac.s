...
PROTO_17:
       ...
       29 GETUPVAL                         R8 1
       30 CALL                             R8 0 1
       31 DUPTABLE                         R7 K15 [{["ok"] = False, ["status"] = 0, ["headers"], ["text"] = "", ["getJson"]}]
       32 SETTABLEKS                       R8 R7 K2 ["headers"]
       34 LOADK                            R10 K13 [""]
       35 NEWCLOSURE                       R9 P1
       36 CAPTURE                          UPVAL U2
       37 CAPTURE                          VAL R10
       38 SETTABLEKS                       R9 R7 K14 ["getJson"]
       40 RETURN                           R7 1
       41 GETUPVAL                         R7 1
       42 CALL                             R7 0 1
       43 GETTABLEKS                       R8 R6 K16 ["Headers"]
       45 JUMPIF                           R8 ; [+2]
       46 NEWTABLE                         R8 0 0
       48 LOADNIL                          R9
       49 LOADNIL                          R10
       ...
       51 MOVE                             R15 R11
       52 MOVE                             R16 R12
       53 NAMECALL                         R13 R7 K17 ["set"]
       55 CALL                             R13 3 0
       56 FORGLOOP                         R8 2 ; [-6]
       58 GETTABLEKS                       R9 R6 K18 ["Success"]
       60 GETTABLEKS                       R10 R6 K19 ["StatusCode"]
       62 GETTABLEKS                       R12 R6 K20 ["Body"]
       64 ORK                              R11 R12 K13 [""]
       65 DUPTABLE                         R8 K21 [{"ok", "status", "headers", "text", "getJson"}]
       66 SETTABLEKS                       R9 R8 K8 ["ok"]
       68 SETTABLEKS                       R10 R8 K10 ["status"]
       70 SETTABLEKS                       R7 R8 K2 ["headers"]
       72 SETTABLEKS                       R11 R8 K12 ["text"]
       74 NEWCLOSURE                       R12 P1
       75 CAPTURE                          UPVAL U2
       76 CAPTURE                          VAL R11
       77 SETTABLEKS                       R12 R8 K14 ["getJson"]
       79 RETURN                           R8 1
