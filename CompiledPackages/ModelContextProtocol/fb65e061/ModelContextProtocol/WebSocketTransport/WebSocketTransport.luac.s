...
PROTO_5:
       ...
       45 GETUPVAL                         R4 3
       46 LOADB                            R6 0
       47 NAMECALL                         R4 R4 K14 ["GenerateGUID"]
       49 CALL                             R4 2 1
       50 NAMECALL                         R2 R2 K15 ["format"]
       52 CALL                             R2 2 1
       53 GETUPVAL                         R3 4
       54 GETTABLEKS                       R3 R3 K16 ["makeTransport"]
       56 MOVE                             R4 R2
       57 DUPTABLE                         R5 K22 [{"start", "sendResponse", "sendNotification", "sendRequest", "close"}]
       58 NEWCLOSURE                       R6 P0
       59 CAPTURE                          VAL R1
       60 SETTABLEKS                       R6 R5 K17 ["start"]
       62 NEWCLOSURE                       R6 P1
       63 CAPTURE                          VAL R1
       64 SETTABLEKS                       R6 R5 K18 ["sendResponse"]
       66 NEWCLOSURE                       R6 P2
       67 CAPTURE                          VAL R1
       68 SETTABLEKS                       R6 R5 K19 ["sendNotification"]
       70 NEWCLOSURE                       R6 P3
       71 CAPTURE                          VAL R1
       72 SETTABLEKS                       R6 R5 K20 ["sendRequest"]
       74 NEWCLOSURE                       R6 P4
       75 CAPTURE                          VAL R1
       76 SETTABLEKS                       R6 R5 K21 ["close"]
       78 CALL                             R3 2 1
       79 SETTABLEKS                       R3 R1 K23 ["transport"]
       81 RETURN                           R1 1

PROTO_6:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["_isClosing"]
        3 JUMPIFNOT                        R0 ; [+1]
        4 RETURN                           R0 0
        5 GETUPVAL                         R0 0
        6 LOADNIL                          R1
...
PROTO_7:
        ...
        4 SETUPVAL                         R1 0
        5 GETUPVAL                         R1 1
        6 GETTABLEKS                       R1 R1 K0 ["isActive"]
        8 LOADB                            R3 0
        9 NAMECALL                         R1 R1 K1 ["set"]
       11 CALL                             R1 2 0
       12 JUMPIFNOT                        R0 ; [+9]
       13 GETUPVAL                         R1 1
       14 GETTABLEKS                       R1 R1 K2 ["transport"]
       16 GETTABLEKS                       R1 R1 K3 ["onTransportError"]
       18 MOVE                             R3 R0
       19 NAMECALL                         R1 R1 K4 ["Fire"]
       21 CALL                             R1 2 0
       22 GETUPVAL                         R1 1
       23 GETTABLEKS                       R1 R1 K5 ["_messageReceivedConnection"]
       25 JUMPIFNOT                        R1 ; [+10]
       26 GETUPVAL                         R1 1
       27 GETTABLEKS                       R1 R1 K5 ["_messageReceivedConnection"]
       ...
       38 GETUPVAL                         R2 1
       39 GETTABLEKS                       R2 R2 K10 ["_retryDelay"]
       41 NEWCLOSURE                       R3 P0
       42 CAPTURE                          UPVAL U1
       43 CALL                             R1 2 0
       44 RETURN                           R0 0
...
PROTO_8:
        ...
        4 SETUPVAL                         R0 0
        5 GETUPVAL                         R0 1
        6 GETTABLEKS                       R0 R0 K0 ["isActive"]
        8 LOADB                            R2 0
        9 NAMECALL                         R0 R0 K1 ["set"]
       11 CALL                             R0 2 0
       12 GETUPVAL                         R0 1
       13 GETTABLEKS                       R0 R0 K2 ["_messageReceivedConnection"]
       15 JUMPIFNOT                        R0 ; [+10]
       16 GETUPVAL                         R0 1
       17 GETTABLEKS                       R0 R0 K2 ["_messageReceivedConnection"]
       ...
       28 GETUPVAL                         R1 1
       29 GETTABLEKS                       R1 R1 K7 ["_retryDelay"]
       31 NEWCLOSURE                       R2 P0
       32 CAPTURE                          UPVAL U1
       33 CALL                             R0 2 0
       34 RETURN                           R0 0
...
PROTO_9:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["isActive"]
        3 LOADB                            R3 1
        4 NAMECALL                         R1 R1 K1 ["set"]
        6 CALL                             R1 2 0
        7 GETUPVAL                         R2 0
        8 GETTABLEKS                       R2 R2 K2 ["_messageQueue"]
...
PROTO_10:
        ...
        6 LOADK                            R2 K2 ["%*: Cannot start, transport is closing."]
        7 GETTABLEKS                       R4 R0 K3 ["name"]
        9 NAMECALL                         R2 R2 K4 ["format"]
       11 CALL                             R2 2 1
       12 CALL                             R1 1 -1
       13 RETURN                           R1 -1
       14 GETTABLEKS                       R1 R0 K5 ["_wsClient"]
       16 JUMPIFNOT                        R1 ; [+11]
       17 GETUPVAL                         R1 0
       18 GETTABLEKS                       R1 R1 K1 ["reject"]
       20 LOADK                            R2 K6 ["%*: Already started."]
       21 GETTABLEKS                       R4 R0 K3 ["name"]
       23 NAMECALL                         R2 R2 K4 ["format"]
       25 CALL                             R2 2 1
       26 CALL                             R1 1 -1
       27 RETURN                           R1 -1
       28 GETUPVAL                         R1 1
       29 GETTABLEKS                       R1 R1 K7 ["createWebSocketClient"]
       31 DUPTABLE                         R2 K9 [{"Url"}]
       32 GETTABLEKS                       R3 R0 K10 ["url"]
       34 SETTABLEKS                       R3 R2 K8 ["Url"]
       36 CALL                             R1 1 1
       37 SETTABLEKS                       R1 R0 K5 ["_wsClient"]
       39 GETTABLEKS                       R2 R0 K5 ["_wsClient"]
       41 LOADK                            R3 K11 ["%*: Failed to create WebStreamClient."]
       42 GETTABLEKS                       R5 R0 K3 ["name"]
       44 NAMECALL                         R3 R3 K4 ["format"]
       46 CALL                             R3 2 1
       47 FASTCALL2                        ASSERT R2 R3 ; [+3]
       49 GETIMPORT                        R1 K13 [assert]
       51 CALL                             R1 2 0
       52 LOADB                            R1 0
       53 NEWCLOSURE                       R2 P0
       54 CAPTURE                          REF R1
       55 CAPTURE                          VAL R0
       56 GETTABLEKS                       R3 R0 K5 ["_wsClient"]
       58 GETTABLEKS                       R3 R3 K14 ["Error"]
       60 MOVE                             R5 R2
       61 NAMECALL                         R3 R3 K15 ["Once"]
       63 CALL                             R3 2 0
       64 GETTABLEKS                       R3 R0 K5 ["_wsClient"]
       66 GETTABLEKS                       R3 R3 K16 ["Closed"]
       68 NEWCLOSURE                       R5 P1
       69 CAPTURE                          REF R1
       70 CAPTURE                          VAL R0
       71 NAMECALL                         R3 R3 K15 ["Once"]
       73 CALL                             R3 2 0
       74 GETTABLEKS                       R3 R0 K5 ["_wsClient"]
       76 GETTABLEKS                       R3 R3 K17 ["MessageReceived"]
       78 NEWCLOSURE                       R5 P2
       79 CAPTURE                          VAL R0
       80 NAMECALL                         R3 R3 K18 ["Connect"]
       82 CALL                             R3 2 1
       83 SETTABLEKS                       R3 R0 K19 ["_messageReceivedConnection"]
       85 GETUPVAL                         R3 0
       86 GETTABLEKS                       R3 R3 K20 ["resolve"]
       88 CALL                             R3 0 -1
       89 CLOSEUPVALS                      R1
       90 RETURN                           R3 -1
...
PROTO_11:
       ...
       36 CALL                             R3 3 0
       37 GETTABLEKS                       R3 R0 K11 ["transport"]
       39 GETTABLEKS                       R3 R3 K12 ["onTransportMessage"]
       41 MOVE                             R5 R2
...
PROTO_12:
        ...
        5 JUMPIF                           R3 ; [+11]
        6 GETUPVAL                         R3 0
        7 GETTABLEKS                       R3 R3 K2 ["reject"]
        9 LOADK                            R4 K3 ["%*: Not connected."]
       10 GETTABLEKS                       R6 R0 K4 ["name"]
       12 NAMECALL                         R4 R4 K5 ["format"]
       14 CALL                             R4 2 1
       15 CALL                             R3 1 -1
       16 RETURN                           R3 -1
       17 GETUPVAL                         R3 1
       18 GETTABLEKS                       R3 R3 K6 ["encode"]
       20 MOVE                             R4 R1
       21 CALL                             R3 1 1
       22 GETUPVAL                         R4 2
       23 LOADK                            R6 K7 ["Sending data:"]
       24 MOVE                             R7 R3
       25 NAMECALL                         R4 R4 K8 ["log"]
       27 CALL                             R4 3 0
       28 GETTABLEKS                       R4 R0 K1 ["_wsClient"]
       30 MOVE                             R7 R3
       31 NAMECALL                         R5 R4 K9 ["Send"]
       33 CALL                             R5 2 0
       34 GETUPVAL                         R5 0
       35 GETTABLEKS                       R5 R5 K10 ["resolve"]
       37 CALL                             R5 0 -1
       38 RETURN                           R5 -1
...
PROTO_13:
       ...
       43 CALL                             R1 1 0
       44 GETTABLEKS                       R1 R0 K12 ["transport"]
       46 GETTABLEKS                       R1 R1 K13 ["onTransportClose"]
       48 NAMECALL                         R1 R1 K14 ["Fire"]
       50 CALL                             R1 1 0
       51 GETUPVAL                         R1 0
       52 GETTABLEKS                       R1 R1 K1 ["resolve"]
       54 CALL                             R1 0 -1
       55 RETURN                           R1 -1
...
MAIN:
       ...
       32 GETTABLEKS                       R5 R5 K11 ["Promise"]
       34 CALL                             R4 1 1
       ...
       49 GETTABLEKS                       R8 R8 K10 ["Parent"]
       51 GETTABLEKS                       R8 R8 K14 ["WebSocketClientFactory"]
       53 CALL                             R7 1 1
       54 GETIMPORT                        R8 K5 [require]
       56 GETTABLEKS                       R9 R0 K15 ["Flags"]
       58 GETTABLEKS                       R9 R9 K16 ["FIntMCPWebSocketBackoff"]
       60 CALL                             R8 1 1
       ...
       71 GETTABLEKS                       R11 R2 K22 ["Logger"]
       73 GETTABLEKS                       R11 R11 K23 ["new"]
       75 GETIMPORT                        R12 K1 [script]
       77 GETTABLEKS                       R12 R12 K24 ["Name"]
       79 CALL                             R11 1 1
