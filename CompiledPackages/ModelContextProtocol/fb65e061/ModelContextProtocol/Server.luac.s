...
PROTO_2:
       ...
       62 DUPTABLE                         R5 K20 [{["method"] = "initialize"}]
       63 NEWCLOSURE                       R6 P0
       64 CAPTURE                          VAL R2
       65 NAMECALL                         R3 R3 K21 ["setRequestHandler"]
       67 CALL                             R3 3 0
       68 GETTABLEKS                       R3 R2 K10 ["_protocol"]
       70 DUPTABLE                         R5 K23 [{["method"] = "notifications/initialized"}]
       71 NEWCLOSURE                       R6 P1
       72 CAPTURE                          VAL R2
       73 NAMECALL                         R3 R3 K24 ["setNotificationHandler"]
       75 CALL                             R3 3 0
       76 RETURN                           R2 1
...
PROTO_7:
        ...
        6 GETTABLEKS                       R2 R0 K0 ["_clientCapabilities"]
        8 GETTABLEKS                       R2 R2 K2 ["sampling"]
       10 JUMPIF                           R2 ; [+8]
       ...
       21 GETTABLEKS                       R2 R0 K0 ["_clientCapabilities"]
       23 GETTABLEKS                       R2 R2 K8 ["roots"]
       25 JUMPIF                           R2 ; [+7]
...
PROTO_8:
        ...
        2 GETTABLEKS                       R2 R0 K1 ["_serverCapabilities"]
        4 GETTABLEKS                       R2 R2 K2 ["logging"]
        6 JUMPIF                           R2 ; [+8]
       ...
       19 GETTABLEKS                       R2 R0 K1 ["_serverCapabilities"]
       21 GETTABLEKS                       R2 R2 K9 ["resources"]
       23 JUMPIF                           R2 ; [+8]
       ...
       34 GETTABLEKS                       R2 R0 K1 ["_serverCapabilities"]
       36 GETTABLEKS                       R2 R2 K12 ["tools"]
       38 JUMPIF                           R2 ; [+8]
       ...
       49 GETTABLEKS                       R2 R0 K1 ["_serverCapabilities"]
       51 GETTABLEKS                       R2 R2 K15 ["prompts"]
       53 JUMPIF                           R2 ; [+7]
...
PROTO_9:
       ...
       19 GETTABLEKS                       R2 R0 K1 ["_serverCapabilities"]
       21 GETTABLEKS                       R2 R2 K9 ["prompts"]
       23 JUMPIF                           R2 ; [+8]
       24 GETIMPORT                        R2 K4 [error]
       ...
       38 GETTABLEKS                       R2 R0 K1 ["_serverCapabilities"]
       40 GETTABLEKS                       R2 R2 K14 ["resources"]
       42 JUMPIF                           R2 ; [+8]
       ...
       55 GETTABLEKS                       R2 R0 K1 ["_serverCapabilities"]
       57 GETTABLEKS                       R2 R2 K18 ["tools"]
       59 JUMPIF                           R2 ; [+7]
...
PROTO_11:
        ...
        7 CALL                             R3 2 0
        8 GETTABLEKS                       R3 R1 K0 ["params"]
       10 GETTABLEKS                       R3 R3 K4 ["protocolVersion"]
       ...
       26 CALL                             R4 2 0
       27 GETTABLEKS                       R4 R1 K0 ["params"]
       29 GETTABLEKS                       R4 R4 K9 ["capabilities"]
       31 GETTABLEKS                       R5 R1 K0 ["params"]
       33 GETTABLEKS                       R5 R5 K10 ["clientInfo"]
       35 LOADNIL                          R6
       36 GETIMPORT                        R7 K12 [ipairs]
       38 GETUPVAL                         R8 0
       39 GETTABLEKS                       R8 R8 K13 ["SUPPORTED_PROTOCOL_VERSIONS"]
       41 CALL                             R7 1 3
       ...
       58 GETUPVAL                         R12 0
       59 GETTABLEKS                       R12 R12 K13 ["SUPPORTED_PROTOCOL_VERSIONS"]
       61 LOADK                            R13 K23 [", "]
       62 CALL                             R11 2 -1
       63 CALL                             R8 -1 -1
       64 CALL                             R7 -1 0
...
PROTO_16:
        0 GETTABLEKS                       R2 R0 K0 ["_protocol"]
        2 DUPTABLE                         R4 K3 [{["method"] = "ping"}]
        3 MOVE                             R5 R1
        4 NAMECALL                         R2 R2 K4 ["request"]
        6 CALL                             R2 3 -1
        7 RETURN                           R2 -1

PROTO_17:
        0 GETTABLEKS                       R3 R0 K0 ["_protocol"]
        2 DUPTABLE                         R5 K4 [{["method"] = "sampling/createMessage", ["params"]}]
        3 SETTABLEKS                       R1 R5 K3 ["params"]
        5 MOVE                             R6 R2
        6 NAMECALL                         R3 R3 K5 ["request"]
        8 CALL                             R3 3 -1
        9 RETURN                           R3 -1

PROTO_18:
        0 GETTABLEKS                       R3 R0 K0 ["_protocol"]
        2 DUPTABLE                         R5 K4 [{["method"] = "roots/list", ["params"]}]
        3 SETTABLEKS                       R1 R5 K3 ["params"]
        5 MOVE                             R6 R2
        6 NAMECALL                         R3 R3 K5 ["request"]
        8 CALL                             R3 3 -1
...
PROTO_19:
        0 GETTABLEKS                       R2 R0 K0 ["_protocol"]
        2 DUPTABLE                         R4 K4 [{["method"] = "notifications/message", ["params"]}]
        3 SETTABLEKS                       R1 R4 K3 ["params"]
        5 NAMECALL                         R2 R2 K5 ["notification"]
        7 CALL                             R2 2 -1
        8 RETURN                           R2 -1

PROTO_20:
        0 GETTABLEKS                       R2 R0 K0 ["_protocol"]
        2 DUPTABLE                         R4 K4 [{["method"] = "notifications/resources/updated", ["params"]}]
        3 SETTABLEKS                       R1 R4 K3 ["params"]
        5 NAMECALL                         R2 R2 K5 ["notification"]
        7 CALL                             R2 2 -1
        8 RETURN                           R2 -1
...
PROTO_21:
        0 GETTABLEKS                       R1 R0 K0 ["_protocol"]
        2 DUPTABLE                         R3 K3 [{["method"] = "notifications/resources/list_changed"}]
        3 NAMECALL                         R1 R1 K4 ["notification"]
        5 CALL                             R1 2 -1
        6 RETURN                           R1 -1

PROTO_22:
        0 GETTABLEKS                       R1 R0 K0 ["_protocol"]
        2 DUPTABLE                         R3 K3 [{["method"] = "notifications/tools/list_changed"}]
        3 NAMECALL                         R1 R1 K4 ["notification"]
        5 CALL                             R1 2 -1
        6 RETURN                           R1 -1
...
PROTO_23:
        0 GETTABLEKS                       R1 R0 K0 ["_protocol"]
        2 DUPTABLE                         R3 K3 [{["method"] = "notifications/prompts/list_changed"}]
        3 NAMECALL                         R1 R1 K4 ["notification"]
        5 CALL                             R1 2 -1
        6 RETURN                           R1 -1
...
MAIN:
       ...
       31 GETTABLEKS                       R6 R0 K11 ["Util"]
       33 GETTABLEKS                       R6 R6 K12 ["mergeCapabilities"]
       35 CALL                             R5 1 1
       36 NEWTABLE                         R6 32 0
