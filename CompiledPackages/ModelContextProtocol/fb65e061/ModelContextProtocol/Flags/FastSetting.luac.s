...
PROTO_3:
        ...
        4 GETTABLEKS                       R1 R1 K4 ["GetFastFlag"]
...
PROTO_4:
        ...
        4 GETTABLEKS                       R2 R2 K4 ["SetFastFlagForTesting"]
...
PROTO_7:
        0 GETIMPORT                        R0 K1 [pcall]
        2 GETIMPORT                        R1 K3 [game]
        4 GETTABLEKS                       R1 R1 K4 ["GetFastInt"]
        6 GETIMPORT                        R2 K3 [game]
        8 GETUPVAL                         R3 0
        9 CALL                             R0 3 2
       10 JUMPIF                           R0 ; [+2]
...
PROTO_8:
        0 GETIMPORT                        R1 K1 [pcall]
        2 GETIMPORT                        R2 K3 [game]
        4 GETTABLEKS                       R2 R2 K4 ["SetFastIntForTesting"]
        6 GETIMPORT                        R3 K3 [game]
        8 GETUPVAL                         R4 0
        9 MOVE                             R5 R0
       10 CALL                             R1 4 0
...
PROTO_11:
        0 GETIMPORT                        R0 K1 [pcall]
        2 GETIMPORT                        R1 K3 [game]
        4 GETTABLEKS                       R1 R1 K4 ["GetFastString"]
        6 GETIMPORT                        R2 K3 [game]
        8 GETUPVAL                         R3 0
        9 CALL                             R0 3 2
       10 JUMPIF                           R0 ; [+2]
...
PROTO_12:
        0 GETIMPORT                        R1 K1 [pcall]
        2 GETIMPORT                        R2 K3 [game]
        4 GETTABLEKS                       R2 R2 K4 ["SetFastStringForTesting"]
        6 GETIMPORT                        R3 K3 [game]
        8 GETUPVAL                         R4 0
        9 MOVE                             R5 R0
       10 CALL                             R1 4 0
