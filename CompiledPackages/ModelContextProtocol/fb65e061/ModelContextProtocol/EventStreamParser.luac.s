...
PROTO_4:
       ...
       13 SETUPVAL                         R3 1
       14 RETURN                           R0 0
       15 JUMPIFNOTEQKS                    R0 K4 ["id"] ; [+8]
       17 LOADK                            R5 K5 ["\0"]
       18 NAMECALL                         R3 R1 K6 ["find"]
       20 CALL                             R3 2 1
       21 JUMPIF                           R3 ; [+62]
       22 SETUPVAL                         R1 2
       23 RETURN                           R0 0
       24 JUMPIFNOTEQKS                    R0 K7 ["retry"] ; [+26]
       ...
       35 RETURN                           R0 0
       36 GETUPVAL                         R4 4
       37 DUPTABLE                         R5 K15 [{["message"], ["type"] = "invalid-retry", ["value"], ["line"]}]
       38 LOADK                            R6 K16 ["Invalid \"retry\" value: \"%*\""]
       39 MOVE                             R8 R1
       40 NAMECALL                         R6 R6 K3 ["format"]
       42 CALL                             R6 2 1
       43 SETTABLEKS                       R6 R5 K10 ["message"]
       45 SETTABLEKS                       R1 R5 K13 ["value"]
       47 SETTABLEKS                       R2 R5 K14 ["line"]
       49 CALL                             R4 1 0
       50 RETURN                           R0 0
       51 MOVE                             R3 R0
       52 NAMECALL                         R4 R0 K17 ["len"]
       54 CALL                             R4 1 1
       55 LOADN                            R5 20
       ...
       59 LOADN                            R8 1
       60 LOADN                            R9 20
       61 NAMECALL                         R6 R0 K19 ["sub"]
       63 CALL                             R6 3 1
       64 NAMECALL                         R4 R4 K3 ["format"]
       66 CALL                             R4 2 1
       67 MOVE                             R3 R4
       68 GETUPVAL                         R4 4
       69 DUPTABLE                         R5 K22 [{["message"], ["type"] = "unknown-field", ["field"], ["value"], ["line"]}]
       70 LOADK                            R6 K23 ["Unknown field \"%*\""]
       71 MOVE                             R8 R3
       72 NAMECALL                         R6 R6 K3 ["format"]
       74 CALL                             R6 2 1
       75 SETTABLEKS                       R6 R5 K10 ["message"]
       77 SETTABLEKS                       R0 R5 K21 ["field"]
       79 SETTABLEKS                       R1 R5 K13 ["value"]
       81 SETTABLEKS                       R2 R5 K14 ["line"]
       83 CALL                             R4 1 0
       84 RETURN                           R0 0
