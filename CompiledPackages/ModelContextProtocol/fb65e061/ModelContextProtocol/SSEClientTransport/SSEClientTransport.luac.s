...
PROTO_14:
       ...
       44 LOADK                            R4 K10 ["SSE connection error: %*"]
       45 MOVE                             R6 R1
       46 NAMECALL                         R4 R4 K11 ["format"]
       48 CALL                             R4 2 1
       49 NAMECALL                         R2 R2 K12 ["Fire"]
       51 CALL                             R2 2 0
       52 RETURN                           R0 0
...
PROTO_17:
       ...
       40 CALL                             R8 1 1
       41 MOVE                             R2 R8
       42 DUPTABLE                         R8 K7 [{["Url"], ["Method"] = "GET", ["Headers"]}]
       43 GETUPVAL                         R9 8
       44 SETTABLEKS                       R9 R8 K3 ["Url"]
       46 NEWTABLE                         R10 1 0
       48 GETUPVAL                         R11 3
       49 GETTABLEKS                       R11 R11 K6 ["Headers"]
       51 GETTABLEKS                       R11 R11 K8 ["ACCEPT"]
       53 GETUPVAL                         R12 3
       54 GETTABLEKS                       R12 R12 K9 ["ResponseType"]
       56 GETTABLEKS                       R12 R12 K10 ["EventStream"]
       58 SETTABLE                         R12 R10 R11
       59 GETUPVAL                         R12 11
       60 JUMPIFNOT                        R12 ; [+4]
       61 GETUPVAL                         R12 11
       62 NAMECALL                         R12 R12 K11 ["getProvider"]
       64 CALL                             R12 1 1
       65 JUMPIFNOT                        R12 ; [+18]
       66 GETTABLEKS                       R13 R12 K12 ["getTokens"]
       68 JUMPIFNOT                        R13 ; [+15]
       69 GETTABLEKS                       R13 R12 K12 ["getTokens"]
       71 CALL                             R13 0 1
       72 JUMPIFNOT                        R13 ; [+11]
       73 GETTABLEKS                       R14 R13 K13 ["access_token"]
       75 JUMPIFNOT                        R14 ; [+8]
       76 LOADK                            R14 K14 ["Bearer %*"]
       77 GETTABLEKS                       R16 R13 K13 ["access_token"]
       79 NAMECALL                         R14 R14 K15 ["format"]
       81 CALL                             R14 2 1
       82 MOVE                             R11 R14
       83 JUMP                             ; [+1]
       84 LOADNIL                          R11
       85 JUMPIFNOT                        R11 ; [+6]
       86 GETUPVAL                         R12 3
       87 GETTABLEKS                       R12 R12 K6 ["Headers"]
       89 GETTABLEKS                       R12 R12 K16 ["AUTHORIZATION"]
       91 SETTABLE                         R11 R10 R12
       92 MOVE                             R9 R10
       93 SETTABLEKS                       R9 R8 K6 ["Headers"]
       95 GETUPVAL                         R9 12
       96 GETTABLEKS                       R9 R9 K17 ["createClient"]
       98 MOVE                             R10 R8
       99 DUPTABLE                         R11 K22 [{"onOpen", "onMessage", "onError", "onClose"}]
      100 SETTABLEKS                       R3 R11 K18 ["onOpen"]
      102 SETTABLEKS                       R4 R11 K19 ["onMessage"]
      104 SETTABLEKS                       R5 R11 K20 ["onError"]
      106 SETTABLEKS                       R6 R11 K21 ["onClose"]
      108 CALL                             R9 2 1
      109 SETUPVAL                         R9 0
      110 CLOSEUPVALS                      R2
      111 RETURN                           R0 0
...
PROTO_23:
       ...
       82 CAPTURE                          UPVAL U4
       83 CAPTURE                          VAL R0
       84 DUPTABLE                         R9 K19 [{["Url"], ["Method"] = "POST", ["Headers"], ["Body"]}]
       85 GETUPVAL                         R10 0
       86 SETTABLEKS                       R10 R9 K15 ["Url"]
       88 SETTABLEKS                       R2 R9 K3 ["Headers"]
       90 GETUPVAL                         R10 5
       91 SETTABLEKS                       R10 R9 K18 ["Body"]
       93 GETUPVAL                         R10 6
       94 GETTABLEKS                       R10 R10 K20 ["createClient"]
       96 MOVE                             R11 R9
       97 DUPTABLE                         R12 K25 [{"onOpen", "onMessage", "onError", "onClose"}]
       98 SETTABLEKS                       R5 R12 K21 ["onOpen"]
      100 SETTABLEKS                       R6 R12 K22 ["onMessage"]
      102 SETTABLEKS                       R7 R12 K23 ["onError"]
      104 SETTABLEKS                       R8 R12 K24 ["onClose"]
      106 CALL                             R10 2 0
      107 CLOSEUPVALS                      R3
      108 RETURN                           R0 0
