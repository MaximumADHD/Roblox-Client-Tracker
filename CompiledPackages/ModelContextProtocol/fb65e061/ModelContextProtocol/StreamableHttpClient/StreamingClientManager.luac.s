...
PROTO_1:
        ...
        2 JUMPIF                           R1 ; [+1]
        3 RETURN                           R0 0
        4 GETTABLEKS                       R2 R1 K0 ["client"]
        6 GETTABLEKS                       R2 R2 K1 ["ConnectionState"]
...
PROTO_3:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R2 R2 K0 ["onOpen"]
        3 MOVE                             R3 R0
        4 GETUPVAL                         R4 1
        5 GETTABLEKS                       R4 R4 K1 ["headerStringToTable"]
        7 MOVE                             R5 R1
        8 CALL                             R4 1 -1
        9 CALL                             R2 -1 0
       10 RETURN                           R0 0
...
PROTO_4:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R2 R2 K0 ["onError"]
        3 JUMPIFNOT                        R2 ; [+6]
        4 GETUPVAL                         R2 0
        5 GETTABLEKS                       R2 R2 K0 ["onError"]
        7 MOVE                             R3 R0
        8 MOVE                             R4 R1
        9 CALL                             R2 2 0
       10 GETUPVAL                         R2 1
...
PROTO_6:
        ...
        3 GETUPVAL                         R2 0
        4 GETUPVAL                         R3 1
        5 GETTABLEKS                       R3 R3 K1 ["connectStreamingClient"]
        7 MOVE                             R4 R0
        8 CALL                             R3 1 1
        9 NEWCLOSURE                       R4 P0
       10 CAPTURE                          UPVAL U2
...
MAIN:
       ...
       16 GETTABLEKS                       R3 R0 K8 ["StreamableHttpClient"]
       18 GETTABLEKS                       R3 R3 K9 ["StreamingClientFactory"]
       20 CALL                             R2 1 1
       21 NEWTABLE                         R3 1 0
