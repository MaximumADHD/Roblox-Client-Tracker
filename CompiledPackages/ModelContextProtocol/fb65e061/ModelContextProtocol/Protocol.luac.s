...
PROTO_21:
        0 GETUPVAL                         R1 0
        1 DUPTABLE                         R3 K3 [{[1] = "notifications/progress", ["params"]}]
        2 GETUPVAL                         R4 1
        3 GETTABLEKS                       R4 R4 K4 ["join"]
        5 MOVE                             R5 R0
        6 DUPTABLE                         R6 K6 [{"progressToken"}]
        7 GETUPVAL                         R7 2
        8 SETTABLEKS                       R7 R6 K5 ["progressToken"]
       10 CALL                             R4 2 1
       11 SETTABLEKS                       R4 R3 K2 ["params"]
       13 DUPTABLE                         R4 K8 [{"relatedRequestId"}]
       14 GETUPVAL                         R5 2
       15 SETTABLEKS                       R5 R4 K7 ["relatedRequestId"]
       17 NAMECALL                         R1 R1 K9 ["notification"]
       19 CALL                             R1 3 -1
       20 RETURN                           R1 -1
...
PROTO_26:
       ...
       90 CLOSEUPVALS                      R4
       91 RETURN                           R0 0
       92 DUPTABLE                         R7 K29 [{["aborted"] = False, ["reason"] = , ["abortSignal"]}]
       93 GETUPVAL                         R8 1
       94 GETTABLEKS                       R8 R8 K30 ["new"]
       96 CALL                             R8 0 1
       97 SETTABLEKS                       R8 R7 K28 ["abortSignal"]
       99 DUPCLOSURE                       R8 K31 [PROTO_18]
      100 SETTABLEKS                       R8 R7 K32 ["abort"]
      102 GETTABLEKS                       R8 R0 K33 ["_requestHandlerAbortControllers"]
      104 SETTABLE                         R7 R8 R3
      105 DUPTABLE                         R8 K39 [{"signal", "sessionId", "sendNotification", "sendRequest", "sendProgress"}]
      106 SETTABLEKS                       R7 R8 K34 ["signal"]
      108 GETTABLEKS                       R9 R0 K40 ["_transport"]
      110 JUMPIFNOT                        R9 ; [+4]
      111 GETTABLEKS                       R9 R0 K40 ["_transport"]
      113 GETTABLEKS                       R9 R9 K35 ["sessionId"]
      115 SETTABLEKS                       R9 R8 K35 ["sessionId"]
      117 NEWCLOSURE                       R9 P3
      118 CAPTURE                          VAL R0
      119 CAPTURE                          VAL R3
      120 SETTABLEKS                       R9 R8 K36 ["sendNotification"]
      122 NEWCLOSURE                       R9 P4
      123 CAPTURE                          VAL R3
      124 CAPTURE                          VAL R0
      125 SETTABLEKS                       R9 R8 K37 ["sendRequest"]
      127 NEWCLOSURE                       R9 P5
      128 CAPTURE                          VAL R0
      129 CAPTURE                          UPVAL U2
      130 CAPTURE                          VAL R3
      131 SETTABLEKS                       R9 R8 K38 ["sendProgress"]
      133 GETUPVAL                         R9 3
      134 GETTABLEKS                       R9 R9 K30 ["new"]
      ...
      141 CALL                             R9 1 1
      142 NEWCLOSURE                       R11 P7
      143 CAPTURE                          VAL R0
      144 CAPTURE                          VAL R3
      145 CAPTURE                          UPVAL U0
      146 NEWCLOSURE                       R12 P8
      147 CAPTURE                          VAL R0
      148 CAPTURE                          VAL R3
      149 CAPTURE                          UPVAL U0
      150 NAMECALL                         R9 R9 K41 ["andThen"]
      152 CALL                             R9 3 1
      153 NEWCLOSURE                       R11 P9
      154 CAPTURE                          VAL R0
      155 NAMECALL                         R9 R9 K42 ["catch"]
      157 CALL                             R9 2 0
      158 CLOSEUPVALS                      R4
      159 RETURN                           R0 0
...
PROTO_37:
       ...
       33 GETUPVAL                         R2 1
       34 DUPTABLE                         R4 K10 [{["method"] = "notifications/cancelled", ["params"]}]
       35 DUPTABLE                         R5 K13 [{"requestId", "reason"}]
       36 GETUPVAL                         R6 2
       37 SETTABLEKS                       R6 R5 K11 ["requestId"]
       39 SETTABLEKS                       R1 R5 K12 ["reason"]
       41 SETTABLEKS                       R5 R4 K9 ["params"]
       43 NAMECALL                         R2 R2 K14 ["notification"]
       45 CALL                             R2 2 0
       46 GETUPVAL                         R2 3
       47 MOVE                             R3 R0
       48 CALL                             R2 1 0
