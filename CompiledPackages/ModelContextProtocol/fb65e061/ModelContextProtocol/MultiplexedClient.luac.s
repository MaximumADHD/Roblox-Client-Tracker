PROTO_0:
       ...
       14 DUPTABLE                         R2 K6 [{["onlyUseStaticServers"] = False}]
       15 SETTABLEKS                       R2 R1 K7 ["_requestFilters"]
       17 NEWTABLE                         R2 0 0
       19 SETTABLEKS                       R2 R1 K8 ["_connectedServerNameToClient"]
       21 NEWTABLE                         R2 0 0
       23 SETTABLEKS                       R2 R1 K9 ["_toolNameAliases"]
       25 NEWTABLE                         R2 0 0
       27 SETTABLEKS                       R2 R1 K10 ["_staticToolsToClient"]
       29 GETUPVAL                         R2 1
       30 GETTABLEKS                       R2 R2 K11 ["new"]
       32 CALL                             R2 0 1
       33 SETTABLEKS                       R2 R1 K12 ["onClientAdded"]
       35 GETUPVAL                         R2 1
       36 GETTABLEKS                       R2 R2 K11 ["new"]
       38 CALL                             R2 0 1
       39 SETTABLEKS                       R2 R1 K13 ["onClientConnected"]
       41 GETUPVAL                         R2 1
       42 GETTABLEKS                       R2 R2 K11 ["new"]
       44 CALL                             R2 0 1
       45 SETTABLEKS                       R2 R1 K14 ["onClientClosed"]
       47 RETURN                           R1 1
...
PROTO_2:
        ...
        7 LOADK                            R3 K3 ["Client %* is not allowed for request due to request filters"]
        8 GETTABLEKS                       R5 R1 K4 ["clientConfig"]
       10 GETTABLEKS                       R5 R5 K5 ["identifier"]
...
PROTO_5:
        ...
        8 LOADK                            R3 K4 ["Client with identifier %* already exists"]
        9 GETTABLEKS                       R5 R1 K1 ["identifier"]
       11 NAMECALL                         R3 R3 K5 ["format"]
       13 CALL                             R3 2 1
       14 CALL                             R2 1 0
       15 GETUPVAL                         R2 0
       16 GETTABLEKS                       R2 R2 K6 ["new"]
       18 GETTABLEKS                       R3 R0 K7 ["_clientInfo"]
       20 GETTABLEKS                       R4 R1 K8 ["clientOptions"]
       22 CALL                             R2 2 1
       23 DUPTABLE                         R3 K11 [{"client", "clientConfig"}]
       24 SETTABLEKS                       R2 R3 K9 ["client"]
       26 SETTABLEKS                       R1 R3 K10 ["clientConfig"]
       28 GETTABLEKS                       R4 R0 K0 ["_clients"]
       30 GETTABLEKS                       R5 R1 K1 ["identifier"]
       32 SETTABLE                         R3 R4 R5
       33 GETTABLEKS                       R4 R0 K12 ["onClientAdded"]
       35 MOVE                             R6 R3
       36 NAMECALL                         R4 R4 K13 ["Fire"]
       38 CALL                             R4 2 0
       39 RETURN                           R0 0
...
PROTO_6:
       ...
       24 LOADK                            R5 K10 ["Server with name %* already connected"]
       25 MOVE                             R7 R3
       26 NAMECALL                         R5 R5 K11 ["format"]
       28 CALL                             R5 2 1
       29 CALL                             R4 1 0
       30 SETTABLEKS                       R3 R1 K12 ["connectedServerIdentifier"]
       32 GETTABLEKS                       R4 R0 K7 ["_connectedServerNameToClient"]
       34 SETTABLE                         R1 R4 R3
       35 GETTABLEKS                       R4 R1 K0 ["client"]
       37 NAMECALL                         R4 R4 K13 ["getServerCapabilities"]
       39 CALL                             R4 1 1
       40 GETTABLEKS                       R5 R0 K14 ["onClientConnected"]
       42 DUPTABLE                         R7 K18 [{"identifier", "connectedServerIdentifier", "serverInfo", "serverCapabilities"}]
       43 GETTABLEKS                       R8 R1 K19 ["clientConfig"]
       45 GETTABLEKS                       R8 R8 K15 ["identifier"]
       47 SETTABLEKS                       R8 R7 K15 ["identifier"]
       49 SETTABLEKS                       R3 R7 K12 ["connectedServerIdentifier"]
       51 SETTABLEKS                       R2 R7 K16 ["serverInfo"]
       53 SETTABLEKS                       R4 R7 K17 ["serverCapabilities"]
       55 NAMECALL                         R5 R5 K20 ["Fire"]
       57 CALL                             R5 2 0
       58 RETURN                           R0 0
...
PROTO_11:
       ...
       13 LOADK                            R9 K4 ["Tool name alias not found: %*"]
       14 MOVE                             R11 R1
       15 NAMECALL                         R9 R9 K5 ["format"]
       17 CALL                             R9 2 1
       18 CALL                             R8 1 0
       19 GETTABLEKS                       R8 R7 K6 ["serverIdentifier"]
       21 GETTABLEKS                       R6 R7 K7 ["actualToolName"]
       23 GETTABLEKS                       R9 R0 K8 ["_connectedServerNameToClient"]
       25 GETTABLE                         R5 R9 R8
       26 JUMPIF                           R5 ; [+8]
       27 GETIMPORT                        R9 K3 [error]
       29 LOADK                            R10 K9 ["No client found for server: %*"]
       30 MOVE                             R12 R8
       31 NAMECALL                         R10 R10 K5 ["format"]
       33 CALL                             R10 2 1
       34 CALL                             R9 1 0
       35 MOVE                             R9 R5
       36 NAMECALL                         R7 R0 K10 ["_assertClientCanBeUsedForRequest"]
       38 CALL                             R7 2 0
       39 DUPTABLE                         R7 K14 [{"name", "arguments", "_meta"}]
       40 SETTABLEKS                       R6 R7 K11 ["name"]
       42 SETTABLEKS                       R2 R7 K12 ["arguments"]
       44 SETTABLEKS                       R4 R7 K13 ["_meta"]
       46 GETTABLEKS                       R8 R5 K15 ["client"]
       48 MOVE                             R10 R7
       49 MOVE                             R11 R3
       50 NAMECALL                         R8 R8 K16 ["callTool"]
       52 CALL                             R8 3 -1
       53 RETURN                           R8 -1
...
PROTO_15:
        ...
        6 LOADK                            R4 K3 ["Client %* not found"]
        7 MOVE                             R6 R1
...
PROTO_20:
        ...
        9 LOADK                            R4 K4 ["Client %* is not connected"]
       10 MOVE                             R6 R1
       11 NAMECALL                         R4 R4 K5 ["format"]
       13 CALL                             R4 2 1
       14 CALL                             R3 1 0
       15 GETTABLEKS                       R3 R2 K1 ["connectedServerIdentifier"]
       17 RETURN                           R3 1
