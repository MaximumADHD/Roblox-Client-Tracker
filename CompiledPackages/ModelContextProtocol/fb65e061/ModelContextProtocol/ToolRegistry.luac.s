PROTO_0:
       ...
       13 GETUPVAL                         R4 1
       14 GETTABLEKS                       R4 R4 K0 ["toolsChanged"]
       16 CALL                             R4 0 0
       17 RETURN                           R0 0
...
PROTO_3:
        ...
        5 CONCAT                           R2 R3 R4
        6 CALL                             R1 1 0
        7 DUPTABLE                         R1 K6 [{["tool"], ["disabled"] = False}]
        8 GETUPVAL                         R2 1
...
PROTO_4:
       ...
       12 LOADK                            R7 K4 ["Tool already exists: "]
       13 MOVE                             R8 R1
       14 CONCAT                           R6 R7 R8
       15 CALL                             R5 1 0
       16 DUPTABLE                         R4 K8 [{["tool"], ["disabled"] = False}]
       17 SETTABLEKS                       R0 R4 K5 ["tool"]
       19 JUMPIFNOTEQKNIL                  R4 ; [+5]
       21 GETUPVAL                         R5 0
       22 LOADNIL                          R6
       23 SETTABLE                         R6 R5 R1
       24 JUMP                             ; [+2]
       25 GETUPVAL                         R5 0
       26 SETTABLE                         R4 R5 R1
       27 GETUPVAL                         R5 1
       28 GETTABLEKS                       R5 R5 K9 ["toolsChanged"]
       30 CALL                             R5 0 0
       31 RETURN                           R0 0
...
PROTO_6:
        ...
        4 GETTABLE                         R3 R4 R0
        5 JUMPIFNOT                        R3 ; [+4]
        6 SETTABLEKS                       R1 R3 K0 ["disabled"]
        8 MOVE                             R4 R3
        9 JUMP                             ; [+7]
       10 GETIMPORT                        R5 K2 [error]
       12 LOADK                            R7 K3 ["Tool not found: "]
       13 MOVE                             R8 R0
       14 CONCAT                           R6 R7 R8
       15 CALL                             R5 1 0
       16 LOADNIL                          R4
       17 JUMPIFNOTEQKNIL                  R4 ; [+5]
       19 GETUPVAL                         R5 0
       20 LOADNIL                          R6
       21 SETTABLE                         R6 R5 R0
       22 JUMP                             ; [+2]
       23 GETUPVAL                         R5 0
       24 SETTABLE                         R4 R5 R0
       25 GETUPVAL                         R5 1
       26 GETTABLEKS                       R5 R5 K4 ["toolsChanged"]
       28 CALL                             R5 0 0
       29 RETURN                           R0 0
...
PROTO_8:
        ...
        5 LOADNIL                          R3
        6 JUMP                             ; [+7]
        7 GETIMPORT                        R4 K1 [error]
        9 LOADK                            R6 K2 ["Tool not found: "]
       10 MOVE                             R7 R0
       11 CONCAT                           R5 R6 R7
       12 CALL                             R4 1 0
       13 LOADNIL                          R3
       14 JUMPIFNOTEQKNIL                  R3 ; [+5]
       16 GETUPVAL                         R4 0
       17 LOADNIL                          R5
       18 SETTABLE                         R5 R4 R0
       19 JUMP                             ; [+2]
       20 GETUPVAL                         R4 0
       21 SETTABLE                         R3 R4 R0
       22 GETUPVAL                         R4 1
       23 GETTABLEKS                       R4 R4 K3 ["toolsChanged"]
       25 CALL                             R4 0 0
       26 RETURN                           R0 0
...
PROTO_10:
        ...
        5 JUMPIF                           R2 ; [+5]
        6 GETTABLEKS                       R2 R1 K1 ["tool"]
        8 GETTABLEKS                       R2 R2 K2 ["handler"]
       10 RETURN                           R2 1
