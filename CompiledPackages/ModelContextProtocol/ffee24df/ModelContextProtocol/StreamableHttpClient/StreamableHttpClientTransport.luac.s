...
PROTO_1:
       ...
       34 GETUPVAL                         R2 1
       35 GETTABLEKS                       R1 R2 K8 ["sessionId"]
       37 JUMPIFNOT                        R1 ; [+9]
       38 GETUPVAL                         R3 0
       39 GETTABLEKS                       R2 R3 K0 ["Headers"]
       41 GETTABLEKS                       R1 R2 K9 ["MCP_SESSION_ID_HEADER"]
       43 GETUPVAL                         R3 1
       44 GETTABLEKS                       R2 R3 K8 ["sessionId"]
       ...
       63 JUMPIFNOT                        R3 ; [+13]
       64 GETUPVAL                         R5 0
       65 GETTABLEKS                       R4 R5 K0 ["Headers"]
       67 GETTABLEKS                       R3 R4 K13 ["AUTHORIZATION"]
...
PROTO_4:
       ...
       13 GETUPVAL                         R3 1
       14 GETTABLEKS                       R2 R3 K4 ["disconnect"]
       16 CALL                             R2 0 0
       17 GETUPVAL                         R2 2
       18 GETUPVAL                         R4 3
       19 GETTABLEKS                       R3 R4 K5 ["AuthorizationPending"]
       21 CALL                             R2 1 -1
       22 RETURN                           R2 -1
       23 LOADN                            R2 200
       24 JUMPIFLT                         R0 R2 ; [+4]
       ...
       29 SETUPVAL                         R0 4
       30 GETUPVAL                         R3 5
       31 GETTABLEKS                       R2 R3 K6 ["getContentType"]
       33 MOVE                             R3 R1
       34 CALL                             R2 1 1
       35 GETUPVAL                         R5 5
       36 GETTABLEKS                       R4 R5 K7 ["ResponseType"]
       38 GETTABLEKS                       R3 R4 K8 ["Json"]
       40 JUMPIFNOTEQ                      R2 R3 ; [+14]
       42 DUPTABLE                         R3 K11 [{"responseType", "accumulatedResponse"}]
       43 GETUPVAL                         R6 5
       44 GETTABLEKS                       R5 R6 K7 ["ResponseType"]
       46 GETTABLEKS                       R4 R5 K8 ["Json"]
       ...
       54 JUMP                             ; [+44]
       55 GETUPVAL                         R5 5
       56 GETTABLEKS                       R4 R5 K7 ["ResponseType"]
       58 GETTABLEKS                       R3 R4 K13 ["EventStream"]
       ...
       66 GETUPVAL                         R7 5
       67 GETTABLEKS                       R6 R7 K7 ["ResponseType"]
       69 GETTABLEKS                       R5 R6 K13 ["EventStream"]
       71 SETTABLEKS                       R5 R4 K9 ["responseType"]
       73 GETUPVAL                         R6 9
       74 GETTABLEKS                       R5 R6 K16 ["createParser"]
       76 DUPTABLE                         R6 K18 [{"onEvent"}]
       77 GETUPVAL                         R8 5
       78 GETTABLEKS                       R7 R8 K19 ["wrapSSECallback"]
       80 MOVE                             R8 R3
       81 CALL                             R7 1 1
       ...
       88 JUMP                             ; [+10]
       89 GETUPVAL                         R4 1
       90 GETTABLEKS                       R3 R4 K4 ["disconnect"]
       92 CALL                             R3 0 0
       93 GETUPVAL                         R3 2
       94 GETUPVAL                         R5 3
       95 GETTABLEKS                       R4 R5 K20 ["UnexpectedServerResponse"]
       97 CALL                             R3 1 -1
       98 RETURN                           R3 -1
       99 GETUPVAL                         R4 10
      100 GETTABLEKS                       R3 R4 K21 ["method"]
      102 JUMPIFNOTEQKS                    R3 K22 ["initialize"] ; [+17]
      104 GETUPVAL                         R6 5
      105 GETTABLEKS                       R5 R6 K23 ["Headers"]
      107 GETTABLEKS                       R4 R5 K24 ["MCP_SESSION_ID_HEADER"]
      109 GETTABLE                         R3 R1 R4
      110 JUMPIFNOT                        R3 ; [+9]
      111 GETUPVAL                         R3 7
      112 GETUPVAL                         R7 5
      113 GETTABLEKS                       R6 R7 K23 ["Headers"]
      115 GETTABLEKS                       R5 R6 K24 ["MCP_SESSION_ID_HEADER"]
...
PROTO_5:
       ...
       27 SETUPVAL                         R1 2
       28 GETUPVAL                         R2 1
       29 GETTABLEKS                       R1 R2 K8 ["responseType"]
       31 GETUPVAL                         R4 3
       32 GETTABLEKS                       R3 R4 K9 ["ResponseType"]
       34 GETTABLEKS                       R2 R3 K10 ["Json"]
       ...
       45 RETURN                           R0 0
       46 GETUPVAL                         R2 1
       47 GETTABLEKS                       R1 R2 K8 ["responseType"]
       49 GETUPVAL                         R4 3
       50 GETTABLEKS                       R3 R4 K9 ["ResponseType"]
       52 GETTABLEKS                       R2 R3 K12 ["EventStream"]
       54 JUMPIFNOTEQ                      R1 R2 ; [+9]
       56 GETUPVAL                         R1 1
       57 GETTABLEKS                       R3 R1 K13 ["eventStreamParser"]
       59 GETTABLEKS                       R2 R3 K14 ["parseNextChunk"]
       61 MOVE                             R3 R0
       62 CALL                             R2 1 0
       63 RETURN                           R0 0
       64 GETUPVAL                         R2 4
       65 GETTABLEKS                       R1 R2 K15 ["assertNever"]
       67 GETUPVAL                         R3 1
       68 GETTABLEKS                       R2 R3 K8 ["responseType"]
       70 CALL                             R1 1 0
       71 RETURN                           R0 0
...
PROTO_7:
        ...
        8 GETUPVAL                         R1 1
        9 GETTABLEKS                       R0 R1 K2 ["responseType"]
       11 GETUPVAL                         R3 2
       12 GETTABLEKS                       R2 R3 K3 ["ResponseType"]
       14 GETTABLEKS                       R1 R2 K4 ["Json"]
       16 JUMPIFNOTEQ                      R0 R1 ; [+15]
       18 GETUPVAL                         R0 1
       19 GETUPVAL                         R1 3
       20 GETUPVAL                         R3 4
       21 GETTABLEKS                       R2 R3 K5 ["decode"]
       ...
       36 GETUPVAL                         R0 7
       37 GETUPVAL                         R2 8
       38 GETTABLEKS                       R1 R2 K9 ["UnexpectedServerResponse"]
       40 CALL                             R0 1 0
       41 RETURN                           R0 0
       42 GETUPVAL                         R0 9
       43 CALL                             R0 0 0
...
PROTO_8:
       ...
       58 GETUPVAL                         R14 4
       59 GETTABLEKS                       R13 R14 K10 ["encode"]
       61 MOVE                             R14 R12
       62 CALL                             R13 1 1
       63 SETTABLEKS                       R13 R11 K7 ["Body"]
       65 GETUPVAL                         R13 10
       66 GETTABLEKS                       R12 R13 K11 ["createClient"]
       68 MOVE                             R13 R11
       69 MOVE                             R14 R10
       70 CALL                             R12 2 1
       71 MOVE                             R4 R12
...
PROTO_11:
        ...
        1 JUMPIFNOT                        R1 ; [+15]
        2 GETUPVAL                         R2 1
        3 GETTABLEKS                       R1 R2 K0 ["AuthorizationPending"]
...
PROTO_13:
       ...
       10 CALL                             R2 3 0
       11 GETUPVAL                         R3 1
       12 GETTABLEKS                       R2 R3 K3 ["getContentType"]
       14 MOVE                             R3 R1
       15 CALL                             R2 1 1
       16 GETUPVAL                         R5 1
       17 GETTABLEKS                       R4 R5 K4 ["ResponseType"]
       19 GETTABLEKS                       R3 R4 K5 ["Json"]
       21 JUMPIFEQ                         R2 R3 ; [+11]
       23 GETUPVAL                         R4 2
       24 GETTABLEKS                       R3 R4 K6 ["disconnect"]
       26 CALL                             R3 0 0
       27 GETUPVAL                         R3 3
       28 GETUPVAL                         R5 4
       29 GETTABLEKS                       R4 R5 K7 ["UnexpectedServerResponse"]
       31 CALL                             R3 1 -1
       32 RETURN                           R3 -1
...
PROTO_16:
        ...
        7 GETUPVAL                         R0 2
        8 GETUPVAL                         R2 3
        9 GETTABLEKS                       R1 R2 K2 ["UnexpectedServerResponse"]
       11 CALL                             R0 1 0
       12 RETURN                           R0 0
       13 GETUPVAL                         R0 4
       14 CALL                             R0 0 0
...
PROTO_17:
       ...
       33 GETUPVAL                         R10 5
       34 GETTABLEKS                       R9 R10 K4 ["createClient"]
       36 GETUPVAL                         R11 6
       ...
       48 GETUPVAL                         R13 4
       49 GETTABLEKS                       R12 R13 K11 ["encode"]
       51 MOVE                             R13 R11
       52 CALL                             R12 1 1
...
PROTO_23:
        ...
        3 CALL                             R0 0 0
        4 GETUPVAL                         R1 1
        5 GETTABLEKS                       R0 R1 K1 ["onTransportClose"]
        7 NAMECALL                         R0 R0 K2 ["Fire"]
        9 CALL                             R0 1 0
       10 GETUPVAL                         R1 2
       11 GETTABLEKS                       R0 R1 K3 ["resolve"]
       13 CALL                             R0 0 -1
       14 RETURN                           R0 -1
...
PROTO_24:
       ...
       48 CAPTURE                          VAL R4
       49 GETUPVAL                         R10 8
       50 GETTABLEKS                       R9 R10 K1 ["makeTransport"]
       52 LOADNIL                          R10
...
MAIN:
       ...
       75 CALL                             R11 1 1
       76 GETTABLEKS                       R13 R6 K21 ["Logger"]
       78 GETTABLEKS                       R12 R13 K22 ["new"]
       80 GETIMPORT                        R14 K1 [script]
       82 GETTABLEKS                       R13 R14 K23 ["Name"]
       84 CALL                             R12 1 1
       85 NEWTABLE                         R13 1 0
