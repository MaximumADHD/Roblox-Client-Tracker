MAIN:
  ...
  CALL R18 1 1
  DUPTABLE R19 K24 [{"Client", "ClientConnectionStatus", "EventStreamParser", "HttpVariantClientTransport", "MultiplexedClient", "PeerTransport", "Promise", "Protocol", "Server", "ServerRegistry", "SSEClientTransport", "StreamableHttpClient", "ToolRegistry", "Types", "Util", "AuthCommon", "Authorizer", "Json"}]
  SETTABLEKS R4 R19 K7 ["Client"]
  SETTABLEKS R5 R19 K8 ["ClientConnectionStatus"]
  SETTABLEKS R6 R19 K9 ["EventStreamParser"]
  SETTABLEKS R7 R19 K10 ["HttpVariantClientTransport"]
  SETTABLEKS R8 R19 K11 ["MultiplexedClient"]
  SETTABLEKS R9 R19 K12 ["PeerTransport"]
  SETTABLEKS R10 R19 K14 ["Promise"]
  SETTABLEKS R11 R19 K15 ["Protocol"]
  SETTABLEKS R13 R19 K17 ["Server"]
  SETTABLEKS R14 R19 K18 ["ServerRegistry"]
  SETTABLEKS R12 R19 K16 ["SSEClientTransport"]
  SETTABLEKS R15 R19 K19 ["StreamableHttpClient"]
  SETTABLEKS R16 R19 K20 ["ToolRegistry"]
  SETTABLEKS R17 R19 K21 ["Types"]
  SETTABLEKS R18 R19 K22 ["Util"]
  SETTABLEKS R2 R19 K5 ["AuthCommon"]
  SETTABLEKS R3 R19 K6 ["Authorizer"]
  GETTABLEKS R20 R18 K23 ["Json"]
  SETTABLEKS R20 R19 K23 ["Json"]
  RETURN R19 1
