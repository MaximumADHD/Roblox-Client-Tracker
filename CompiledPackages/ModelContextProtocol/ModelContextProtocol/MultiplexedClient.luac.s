PROTO_0:
  ...
  NEWTABLE R2 0 0
  SETTABLEKS R2 R1 K5 ["_toolNameAliases"]
  NEWTABLE R2 0 0
  SETTABLEKS R2 R1 K6 ["_staticToolsToClient"]
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K7 ["new"]
  CALL R2 0 1
  SETTABLEKS R2 R1 K8 ["onClientAdded"]
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K7 ["new"]
  CALL R2 0 1
  SETTABLEKS R2 R1 K9 ["onClientClosed"]
  RETURN R1 1
...
PROTO_7:
  ...
  MOVE R9 R10
  CALL R8 1 0
  DUPTABLE R7 K14 [{"name", "arguments", "_meta"}]
  SETTABLEKS R6 R7 K11 ["name"]
  SETTABLEKS R2 R7 K12 ["arguments"]
  SETTABLEKS R4 R7 K13 ["_meta"]
  GETTABLEKS R8 R5 K15 ["client"]
  MOVE R10 R7
  MOVE R11 R3
  NAMECALL R8 R8 K16 ["callTool"]
  CALL R8 3 -1
  RETURN R8 -1
...
MAIN:
  ...
  CAPTURE VAL R1
  SETTABLEKS R10 R9 K21 ["addClient"]
  DUPCLOSURE R10 K22 [PROTO_2]
  CAPTURE VAL R3
  SETTABLEKS R10 R9 K23 ["_onNewClientConnected"]
  DUPCLOSURE R10 K24 [PROTO_4]
  CAPTURE VAL R4
  SETTABLEKS R10 R9 K25 ["connectAll"]
  DUPCLOSURE R10 K26 [PROTO_6]
  SETTABLEKS R10 R9 K27 ["connectClient"]
  DUPCLOSURE R10 K28 [PROTO_7]
  CAPTURE VAL R8
  CAPTURE VAL R3
  SETTABLEKS R10 R9 K29 ["callTool"]
  DUPCLOSURE R10 K30 [PROTO_8]
  SETTABLEKS R10 R9 K31 ["callToolForClient"]
  DUPCLOSURE R10 K32 [PROTO_10]
  CAPTURE VAL R4
  CAPTURE VAL R8
  CAPTURE VAL R3
  SETTABLEKS R10 R9 K33 ["listTools"]
  DUPCLOSURE R10 K34 [PROTO_11]
  SETTABLEKS R10 R9 K35 ["_getStoredClient"]
  DUPCLOSURE R10 K36 [PROTO_12]
  SETTABLEKS R10 R9 K37 ["getClient"]
  DUPCLOSURE R10 K38 [PROTO_13]
  SETTABLEKS R10 R9 K39 ["getClientForStaticTool"]
  DUPCLOSURE R10 K40 [PROTO_15]
  CAPTURE VAL R2
  SETTABLEKS R10 R9 K41 ["listClients"]
  DUPCLOSURE R10 K42 [PROTO_16]
  SETTABLEKS R10 R9 K43 ["getServerIdentifier"]
  DUPCLOSURE R10 K44 [PROTO_18]
  CAPTURE VAL R4
  SETTABLEKS R10 R9 K45 ["close"]
  DUPCLOSURE R10 K46 [PROTO_19]
  SETTABLEKS R10 R9 K47 ["_clearToolNameAliases"]
  DUPCLOSURE R10 K48 [PROTO_20]
  SETTABLEKS R10 R9 K49 ["getToolInfoByAlias"]
  DUPCLOSURE R10 K50 [PROTO_21]
  CAPTURE VAL R8
  SETTABLEKS R10 R9 K51 ["closeClient"]
  RETURN R9 1
