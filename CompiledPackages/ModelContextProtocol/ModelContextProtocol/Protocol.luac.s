...
PROTO_26:
  ...
  SETTABLE R7 R8 R3
  DUPTABLE R8 K35 [{"signal", "sessionId", "sendNotification", "sendRequest", "sendProgress"}]
  SETTABLEKS R7 R8 K30 ["signal"]
  GETTABLEKS R9 R0 K36 ["_transport"]
  JUMPIFNOT R9 [+4]
  GETTABLEKS R10 R0 K36 ["_transport"]
  ...
  JUMP [+1]
  LOADNIL R9
  SETTABLEKS R9 R8 K34 ["sendProgress"]
  GETUPVAL R10 3
  ...
  CAPTURE VAL R3
  CAPTURE UPVAL U0
  NAMECALL R9 R9 K38 ["andThen"]
  CALL R9 3 1
  NEWCLOSURE R11 P9
  CAPTURE VAL R0
  NAMECALL R9 R9 K39 ["catch"]
  CALL R9 2 0
  CLOSEUPVALS R4
  RETURN R0 0
