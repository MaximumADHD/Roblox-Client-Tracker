...
PROTO_6:
  ...
  CALL R3 3 1
  MOVE R2 R3
  DUPTABLE R3 K8 [{"name", "description", "inputSchema"}]
  SETTABLEKS R2 R3 K1 ["name"]
  GETTABLEKS R4 R1 K6 ["description"]
  SETTABLEKS R4 R3 K6 ["description"]
  GETTABLEKS R4 R1 K7 ["inputSchema"]
  SETTABLEKS R4 R3 K7 ["inputSchema"]
  RETURN R3 1
...
MAIN:
  ...
  CAPTURE VAL R2
  SETTABLEKS R6 R3 K14 ["getNewServerName"]
