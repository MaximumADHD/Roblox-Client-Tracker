...
PROTO_9:
  ...
  LOADK R10 K14 ["Incompatible auth server: does not support response type %*"]
  LOADK R12 K11 ["code"]
  NAMECALL R10 R10 K15 ["format"]
  CALL R10 2 1
  MOVE R9 R10
  CALL R8 1 0
  GETTABLEKS R8 R1 K16 ["code_challenge_methods_supported"]
  JUMPIFNOT R8 [+7]
  GETIMPORT R8 K9 [table.find]
  GETTABLEKS R9 R1 K16 ["code_challenge_methods_supported"]
  LOADK R10 K17 ["S256"]
  CALL R8 2 1
  JUMPIF R8 [+17]
  GETIMPORT R8 K13 [error]
  LOADK R10 K18 ["Incompatible auth server: does not support code challenge method %*"]
  LOADK R12 K17 ["S256"]
  NAMECALL R10 R10 K15 ["format"]
  CALL R10 2 1
  MOVE R9 R10
  CALL R8 1 0
  JUMP [+7]
  LOADK R8 K19 ["%*/authorize"]
  GETTABLEKS R10 R0 K20 ["_authorizationServerUrl"]
