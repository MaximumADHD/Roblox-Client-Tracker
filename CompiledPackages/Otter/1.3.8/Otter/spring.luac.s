...
PROTO_2:
        0 DUPTABLE                         R2 K7 [{[1] = 1, ["frequency"] = 1, ["restingVelocityLimit"] = 0.001, ["restingPositionLimit"] = 0.01}]
        1 JUMPIFEQKNIL                     R1 ; [+5]
        3 GETUPVAL                         R3 0
        4 MOVE                             R4 R2
        5 MOVE                             R5 R1
        ...
        7 LOADNIL                          R3
        8 LOADNIL                          R4
        9 GETTABLEKS                       R5 R2 K3 ["restingVelocityLimit"]
       11 GETTABLEKS                       R6 R2 K5 ["restingPositionLimit"]
       13 GETTABLEKS                       R7 R2 K8 ["damping"]
       15 GETTABLEKS                       R8 R2 K9 ["stiffness"]
       17 GETTABLEKS                       R9 R2 K10 ["mass"]
       19 FASTCALL1                        TYPEOF R7 ; [+3]
       20 MOVE                             R11 R7
       21 GETIMPORT                        R10 K12 [typeof]
       23 CALL                             R10 1 1
       24 JUMPIFNOTEQKS                    R10 K13 ["number"] ; [+32]
       26 FASTCALL1                        TYPEOF R8 ; [+3]
       27 MOVE                             R11 R8
       28 GETIMPORT                        R10 K12 [typeof]
       30 CALL                             R10 1 1
       31 JUMPIFNOTEQKS                    R10 K13 ["number"] ; [+25]
       33 FASTCALL1                        TYPEOF R9 ; [+3]
       34 MOVE                             R11 R9
       35 GETIMPORT                        R10 K12 [typeof]
       37 CALL                             R10 1 1
       38 JUMPIFNOTEQKS                    R10 K13 ["number"] ; [+18]
       40 MUL                              R15 R9 R8
       41 FASTCALL1                        MATH_SQRT R15 ; [+1]
       42 GETUPVAL                         R14 1
       43 CALL                             R14 1 1
       44 MULK                             R13 R14 K14 [2]
       45 DIV                              R12 R7 R13
       46 DIV                              R16 R8 R9
       47 FASTCALL1                        MATH_SQRT R16 ; [+1]
       48 GETUPVAL                         R15 1
       49 CALL                             R15 1 1
       50 DIVK                             R14 R15 K14 [2]
       51 DIVK                             R13 R14 K15 [3.14159265358979]
       52 MOVE                             R10 R12
       53 MOVE                             R11 R13
       54 MOVE                             R3 R10
       55 MOVE                             R4 R11
       56 JUMP                             ; [+4]
       57 GETTABLEKS                       R3 R2 K0 ["dampingRatio"]
       59 GETTABLEKS                       R4 R2 K2 ["frequency"]
       61 MOVE                             R10 R3
       62 MULK                             R12 R4 K14 [2]
       63 MULK                             R11 R12 K15 [3.14159265358979]
       64 LOADN                            R14 0
       65 JUMPIFLE                         R14 R5 ; [+2]
       67 LOADB                            R13 0 +1
       68 LOADB                            R13 1
       69 FASTCALL2K                       ASSERT R13 K16 ; [+4]
       71 LOADK                            R14 K16 ["Expected restingVelocityLimit >= 0"]
       72 GETIMPORT                        R12 K18 [assert]
       74 CALL                             R12 2 0
       75 LOADN                            R14 0
       76 JUMPIFLE                         R14 R6 ; [+2]
       78 LOADB                            R13 0 +1
       79 LOADB                            R13 1
       80 FASTCALL2K                       ASSERT R13 K19 ; [+4]
       82 LOADK                            R14 K19 ["Expected restingPositionLimit >= 0"]
       83 GETIMPORT                        R12 K18 [assert]
       85 CALL                             R12 2 0
       ...
       96 CAPTURE                          VAL R5
       97 CAPTURE                          VAL R6
       98 DUPTABLE                         R13 K22 [{"step", "startingValue"}]
       99 SETTABLEKS                       R12 R13 K20 ["step"]
      101 JUMPIFNOT                        R1 ; [+3]
      102 GETTABLEKS                       R14 R1 K21 ["startingValue"]
      104 JUMP                             ; [+1]
      105 LOADNIL                          R14
      106 SETTABLEKS                       R14 R13 K21 ["startingValue"]
      108 RETURN                           R13 1
