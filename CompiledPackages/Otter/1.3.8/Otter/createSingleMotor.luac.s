PROTO_0:
        ...
        2 GETUPVAL                         R3 0
        3 CALL                             R3 0 2
        4 DUPTABLE                         R5 K9 [{[1] = , ["__state"], ["__onComplete"], ["__fireOnComplete"], ["__onStep"], ["__fireOnStep"], ["__running"] = False}]
        5 DUPTABLE                         R6 K13 [{["value"], ["complete"] = True}]
        6 SETTABLEKS                       R0 R6 K10 ["value"]
        8 SETTABLEKS                       R6 R5 K2 ["__state"]
       10 SETTABLEKS                       R1 R5 K3 ["__onComplete"]
       12 SETTABLEKS                       R2 R5 K4 ["__fireOnComplete"]
       14 SETTABLEKS                       R3 R5 K5 ["__onStep"]
       16 SETTABLEKS                       R4 R5 K6 ["__fireOnStep"]
       18 GETUPVAL                         R8 1
       19 FASTCALL2                        SETMETATABLE R5 R8 ; [+4]
       21 MOVE                             R7 R5
       22 GETIMPORT                        R6 K15 [setmetatable]
       24 CALL                             R6 2 0
       25 RETURN                           R5 1
...
PROTO_2:
       ...
       15 GETTABLEKS                       R1 R0 K3 ["__goal"]
       17 JUMPIFNOT                        R1 ; [+30]
       18 GETTABLEKS                       R1 R0 K3 ["__goal"]
       20 GETTABLEKS                       R1 R1 K4 ["startingValue"]
       22 JUMPIFNOT                        R1 ; [+25]
       23 GETTABLEKS                       R1 R0 K5 ["__state"]
       25 GETTABLEKS                       R2 R0 K3 ["__goal"]
       27 GETTABLEKS                       R2 R2 K4 ["startingValue"]
       29 SETTABLEKS                       R2 R1 K6 ["value"]
       31 GETTABLEKS                       R1 R0 K5 ["__state"]
       33 GETTABLEKS                       R1 R1 K7 ["initialValue"]
       35 JUMPIFNOT                        R1 ; [+8]
       36 GETTABLEKS                       R1 R0 K5 ["__state"]
       38 GETTABLEKS                       R2 R0 K3 ["__goal"]
       40 GETTABLEKS                       R2 R2 K4 ["startingValue"]
       42 SETTABLEKS                       R2 R1 K7 ["initialValue"]
       44 LOADN                            R3 0
       45 NAMECALL                         R1 R0 K8 ["step"]
       47 CALL                             R1 2 0
       48 RETURN                           R0 0
