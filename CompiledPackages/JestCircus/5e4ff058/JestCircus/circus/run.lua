...
local circusTypesModule = require(script.Parent.types)
local RETRY_TIMES = circusTypesModule.RETRY_TIMES
local WAIT_BEFORE_RETRY = circusTypesModule.WAIT_BEFORE_RETRY
local RETRY_IMMEDIATELY = circusTypesModule.RETRY_IMMEDIATELY
