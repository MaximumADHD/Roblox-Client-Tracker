PROTO_0:
        ...
        4 LOADK                            R2 K1 [""]
        5 GETUPVAL                         R3 0
        6 LOADK                            R4 K4 ["^(\\s*LoadedCode.*:\\d+)?(: )?(.*)$"]
        7 CALL                             R3 1 1
        8 MOVE                             R6 R0
        9 NAMECALL                         R4 R3 K5 ["exec"]
       11 CALL                             R4 2 1
       12 JUMPIFNOT                        R4 ; [+2]
       13 GETTABLEN                        R1 R4 4
       14 GETTABLEN                        R2 R4 2
       15 DUPTABLE                         R5 K6 [{"message", "stack"}]
       16 SETTABLEKS                       R1 R5 K0 ["message"]
       18 SETTABLEKS                       R2 R5 K2 ["stack"]
       20 RETURN                           R5 1
...
PROTO_3:
       ...
       11 DUPTABLE                         R4 K9 [{["type"] = "describeBlock", ["children"], ["hooks"], ["mode"], ["name"], ["parent"], ["tests"]}]
       12 NEWTABLE                         R5 0 0
       14 SETTABLEKS                       R5 R4 K4 ["children"]
       16 NEWTABLE                         R5 0 0
       18 SETTABLEKS                       R5 R4 K5 ["hooks"]
       20 SETTABLEKS                       R3 R4 K1 ["mode"]
       22 GETUPVAL                         R5 1
       23 MOVE                             R6 R0
       24 CALL                             R5 1 1
       25 SETTABLEKS                       R5 R4 K6 ["name"]
       27 SETTABLEKS                       R1 R4 K7 ["parent"]
       29 NEWTABLE                         R5 0 0
       31 SETTABLEKS                       R5 R4 K8 ["tests"]
       33 RETURN                           R4 1

PROTO_4:
        0 DUPTABLE                         R7 K19 [{[1] = "test", ["asyncError"], ["duration"] = , ["errors"], ["failing"], ["fn"], ["invocations"] = 0, ["mode"], ["name"], ["parent"], ["retryReasons"], ["seenDone"] = False, ["startedAt"] = , ["status"] = , ["timeout"]}]
        1 SETTABLEKS                       R5 R7 K2 ["asyncError"]
        3 NEWTABLE                         R8 0 0
        5 SETTABLEKS                       R8 R7 K5 ["errors"]
        7 SETTABLEKS                       R6 R7 K6 ["failing"]
        9 SETTABLEKS                       R0 R7 K7 ["fn"]
       11 SETTABLEKS                       R1 R7 K10 ["mode"]
       13 GETUPVAL                         R8 0
       14 MOVE                             R9 R2
       15 CALL                             R8 1 1
       16 SETTABLEKS                       R8 R7 K11 ["name"]
       18 SETTABLEKS                       R3 R7 K12 ["parent"]
       20 NEWTABLE                         R8 0 0
       22 SETTABLEKS                       R8 R7 K13 ["retryReasons"]
       24 SETTABLEKS                       R4 R7 K18 ["timeout"]
       26 RETURN                           R7 1
...
PROTO_14:
        ...
        6 GETUPVAL                         R4 3
        7 GETUPVAL                         R5 0
        8 DUPTABLE                         R6 K3 [{["maxDepth"] = 3}]
        9 CALL                             R4 2 -1
       10 NAMECALL                         R2 R2 K4 ["format"]
       12 CALL                             R2 -1 -1
       13 CALL                             R1 -1 1
       14 SETTABLEKS                       R1 R0 K5 ["message"]
       16 GETUPVAL                         R0 4
       17 GETUPVAL                         R1 1
       18 CALL                             R0 1 -1
       19 RETURN                           R0 -1
       ...
       21 GETUPVAL                         R2 5
       22 GETUPVAL                         R3 6
       23 GETTABLEKS                       R3 R3 K6 ["toJSBoolean"]
       25 MOVE                             R4 R2
       26 CALL                             R3 1 1
       27 MOVE                             R1 R3
       28 JUMPIFNOT                        R1 ; [+15]
       29 GETUPVAL                         R3 6
       30 GETTABLEKS                       R3 R3 K6 ["toJSBoolean"]
       32 GETTABLEKS                       R4 R2 K5 ["message"]
       34 CALL                             R3 1 1
       35 MOVE                             R1 R3
       36 JUMPIFNOT                        R1 ; [+7]
       37 GETUPVAL                         R3 6
       38 GETTABLEKS                       R3 R3 K6 ["toJSBoolean"]
       40 GETTABLEKS                       R4 R2 K7 ["stack"]
       42 CALL                             R3 1 1
       43 MOVE                             R1 R3
       44 JUMPIFNOT                        R1 ; [+2]
       45 GETUPVAL                         R0 5
       ...
       47 GETUPVAL                         R0 7
       48 GETUPVAL                         R1 7
       49 LOADK                            R2 K8 ["Failed: %s"]
       50 GETUPVAL                         R4 3
       51 GETUPVAL                         R5 5
       52 DUPTABLE                         R6 K3 [{["maxDepth"] = 3}]
       53 CALL                             R4 2 -1
       54 NAMECALL                         R2 R2 K4 ["format"]
       56 CALL                             R2 -1 1
       57 SETTABLEKS                       R2 R1 K5 ["message"]
       59 GETUPVAL                         R1 8
       60 JUMPIFNOT                        R1 ; [+16]
       61 GETUPVAL                         R1 6
       62 GETTABLEKS                       R1 R1 K6 ["toJSBoolean"]
       64 GETUPVAL                         R2 5
       65 CALL                             R1 1 1
       66 JUMPIFNOT                        R1 ; [+10]
       67 LOADK                            R2 K9 ["Caught error after test environment was torn down\n\n"]
       68 GETTABLEKS                       R3 R0 K5 ["message"]
       70 CONCAT                           R1 R2 R3
       71 SETTABLEKS                       R1 R0 K5 ["message"]
       73 GETIMPORT                        R1 K11 [error]
       75 MOVE                             R2 R0
       76 CALL                             R1 1 0
       77 GETUPVAL                         R2 6
       78 GETTABLEKS                       R2 R2 K6 ["toJSBoolean"]
       80 GETUPVAL                         R3 5
       81 CALL                             R2 1 1
       82 JUMPIFNOT                        R2 ; [+4]
       83 GETUPVAL                         R1 4
...
PROTO_15:
       ...
       24 GETUPVAL                         R5 5
       25 MOVE                             R6 R0
       26 DUPTABLE                         R7 K8 [{["maxDepth"] = 3}]
       27 CALL                             R5 2 1
       28 CONCAT                           R2 R3 R5
       29 SETTABLEKS                       R2 R1 K3 ["message"]
       31 GETUPVAL                         R2 6
       32 MOVE                             R3 R1
       33 CALL                             R2 1 0
       34 GETIMPORT                        R2 K10 [error]
       36 MOVE                             R3 R1
       37 CALL                             R2 1 0
       38 JUMP                             ; [+4]
       39 GETUPVAL                         R2 3
       40 LOADB                            R3 1
       41 SETTABLEKS                       R3 R2 K1 ["seenDone"]
       43 GETUPVAL                         R2 7
       44 GETTABLEKS                       R2 R2 K11 ["delay"]
       46 LOADN                            R3 0
       47 CALL                             R2 1 1
       48 NEWCLOSURE                       R4 P0
       49 CAPTURE                          UPVAL U8
...
PROTO_17:
       ...
       87 GETUPVAL                         R3 4
       88 JUMPIF                           R3 ; [+15]
       89 JUMPIFEQKNIL                     R2 ; [+14]
       91 MOVE                             R3 R1
       92 GETUPVAL                         R4 13
       93 LOADK                            R5 K14 ["\ntest functions can only return Promise or undefined.\n      Returned value: %s\n      "]
       94 GETUPVAL                         R7 10
       95 MOVE                             R8 R2
       96 DUPTABLE                         R9 K17 [{["maxDepth"] = 3}]
       97 CALL                             R7 2 -1
       98 NAMECALL                         R5 R5 K18 ["format"]
      100 CALL                             R5 -1 -1
      101 CALL                             R4 -1 1
      102 CALL                             R3 1 0
      103 RETURN                           R0 0
...
PROTO_23:
       ...
       32 GETUPVAL                         R7 3
       33 CALL                             R5 2 1
       34 DUPTABLE                         R6 K17 [{["duration"], ["errors"], ["errorsDetailed"], ["invocations"], ["location"] = , ["retryReasons"], ["status"], ["testPath"]}]
       ...
       53 GETUPVAL                         R7 2
       54 GETTABLEKS                       R7 R7 K8 ["map"]
       56 GETUPVAL                         R8 2
       57 GETTABLEKS                       R8 R8 K8 ["map"]
       59 GETTABLEKS                       R9 R0 K15 ["retryReasons"]
       61 GETUPVAL                         R10 3
       62 CALL                             R8 2 1
       63 GETUPVAL                         R9 4
       64 CALL                             R7 2 1
       65 SETTABLEKS                       R7 R6 K15 ["retryReasons"]
       67 SETTABLEKS                       R4 R6 K1 ["status"]
       69 GETUPVAL                         R7 2
       70 GETTABLEKS                       R7 R7 K18 ["from"]
       72 MOVE                             R8 R2
       73 CALL                             R7 1 1
       74 SETTABLEKS                       R7 R6 K16 ["testPath"]
       76 RETURN                           R6 1
...
PROTO_26:
       ...
       36 GETUPVAL                         R5 3
       37 MOVE                             R6 R1
       38 DUPTABLE                         R7 K11 [{["maxDepth"] = 3}]
       39 CALL                             R5 2 -1
       40 NAMECALL                         R3 R3 K12 ["format"]
       42 CALL                             R3 -1 1
       43 SETTABLEKS                       R3 R2 K7 ["message"]
       45 RETURN                           R2 1
...
PROTO_31:
       ...
       32 MOVE                             R4 R2
       33 CALL                             R3 1 1
       34 DUPTABLE                         R4 K24 [{["ancestorTitles"], ["duration"], ["failureDetails"], ["failureMessages"], ["fullName"], ["invocations"], ["location"], ["numPassingAsserts"] = 0, ["retryReasons"], [10], ["title"]}]
       35 SETTABLEKS                       R2 R4 K13 ["ancestorTitles"]
       37 GETTABLEKS                       R5 R0 K14 ["duration"]
       39 SETTABLEKS                       R5 R4 K14 ["duration"]
       41 GETTABLEKS                       R5 R0 K25 ["errorsDetailed"]
       43 SETTABLEKS                       R5 R4 K15 ["failureDetails"]
       45 GETUPVAL                         R5 0
       46 GETTABLEKS                       R5 R5 K26 ["from"]
       48 GETTABLEKS                       R6 R0 K4 ["errors"]
       50 CALL                             R5 1 1
       51 SETTABLEKS                       R5 R4 K16 ["failureMessages"]
       53 GETUPVAL                         R6 2
       54 GETTABLEKS                       R6 R6 K27 ["toJSBoolean"]
       56 MOVE                             R7 R3
       57 CALL                             R6 1 1
       58 JUMPIFNOT                        R6 ; [+12]
       59 GETUPVAL                         R5 0
       60 GETTABLEKS                       R5 R5 K28 ["join"]
       62 GETUPVAL                         R6 0
       63 GETTABLEKS                       R6 R6 K29 ["concat"]
       65 MOVE                             R7 R2
       66 MOVE                             R8 R3
       67 CALL                             R6 2 1
       68 LOADK                            R7 K30 [" "]
       ...
       87 GETUPVAL                         R5 0
       88 GETTABLEKS                       R5 R5 K26 ["from"]
       90 GETTABLEKS                       R6 R0 K22 ["retryReasons"]
       92 CALL                             R5 1 1
       93 SETTABLEKS                       R5 R4 K22 ["retryReasons"]
       95 SETTABLEKS                       R1 R4 K0 ["status"]
       97 GETTABLEKS                       R6 R0 K8 ["testPath"]
       99 GETTABLEKS                       R8 R0 K8 ["testPath"]
      101 LENGTH                           R7 R8
      102 GETTABLE                         R5 R6 R7
      103 SETTABLEKS                       R5 R4 K23 ["title"]
      105 RETURN                           R4 1
