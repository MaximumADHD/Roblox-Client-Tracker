...
PROTO_22:
       ...
       50 CAPTURE                          REF R1
       51 CAPTURE                          REF R0
       52 SETTABLEKS                       R5 R1 K4 ["todo"]
       54 DUPCLOSURE                       R0 K5 [PROTO_21]
       55 CAPTURE                          UPVAL U0
       56 CAPTURE                          UPVAL U1
       57 CAPTURE                          UPVAL U2
       58 GETUPVAL                         R5 3
       59 MOVE                             R6 R1
       60 CALL                             R5 1 1
       61 SETTABLEKS                       R5 R1 K6 ["each"]
       63 GETUPVAL                         R5 3
       64 MOVE                             R6 R3
       65 CALL                             R5 1 1
       66 SETTABLEKS                       R5 R3 K6 ["each"]
       68 GETUPVAL                         R5 3
       69 MOVE                             R6 R2
       70 CALL                             R5 1 1
       71 SETTABLEKS                       R5 R2 K6 ["each"]
       73 LOADK                            R7 K7 ["only"]
       74 NEWCLOSURE                       R6 P6
       75 CAPTURE                          REF R0
       76 CAPTURE                          VAL R7
       77 CAPTURE                          VAL R6
       78 MOVE                             R5 R6
       79 SETTABLEKS                       R5 R3 K8 ["failing"]
       81 LOADK                            R7 K9 ["skip"]
       82 NEWCLOSURE                       R6 P6
       83 CAPTURE                          REF R0
       84 CAPTURE                          VAL R7
       85 CAPTURE                          VAL R6
       86 MOVE                             R5 R6
       87 SETTABLEKS                       R5 R2 K8 ["failing"]
       89 LOADNIL                          R7
       90 NEWCLOSURE                       R6 P6
       91 CAPTURE                          REF R0
       92 CAPTURE                          VAL R7
       93 CAPTURE                          VAL R6
       94 MOVE                             R5 R6
       95 SETTABLEKS                       R5 R1 K8 ["failing"]
       97 SETTABLEKS                       R3 R1 K7 ["only"]
       99 SETTABLEKS                       R2 R1 K9 ["skip"]
      101 CLOSEUPVALS                      R0
      102 RETURN                           R1 1
