...
PROTO_2:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R0 R1 K0 ["resetModules"]
        3 JUMPIFNOT                        R0 ; [+4]
        4 GETUPVAL                         R0 1
        5 NAMECALL                         R0 R0 K0 ["resetModules"]
        7 CALL                             R0 1 0
        8 GETUPVAL                         R1 0
        9 GETTABLEKS                       R0 R1 K1 ["clearMocks"]
       11 JUMPIFNOT                        R0 ; [+4]
       12 GETUPVAL                         R0 1
       13 NAMECALL                         R0 R0 K2 ["clearAllMocks"]
       15 CALL                             R0 1 0
       16 GETUPVAL                         R1 0
       17 GETTABLEKS                       R0 R1 K3 ["resetMocks"]
       19 JUMPIFNOT                        R0 ; [+36]
       20 GETUPVAL                         R0 1
       21 NAMECALL                         R0 R0 K4 ["resetAllMocks"]
       23 CALL                             R0 1 0
       24 GETUPVAL                         R1 2
       25 GETTABLEKS                       R0 R1 K5 ["toJSBoolean"]
       27 GETUPVAL                         R3 2
       28 GETTABLEKS                       R2 R3 K5 ["toJSBoolean"]
       30 GETUPVAL                         R5 0
       31 GETTABLEKS                       R4 R5 K6 ["fakeTimers"]
       33 GETTABLEKS                       R3 R4 K7 ["enableGlobally"]
       35 CALL                             R2 1 1
       36 JUMPIFNOT                        R2 ; [+6]
       37 GETUPVAL                         R3 0
       38 GETTABLEKS                       R2 R3 K6 ["fakeTimers"]
       40 GETTABLEKS                       R1 R2 K8 ["legacyFakeTimers"]
       42 JUMP                             ; [+5]
       43 GETUPVAL                         R3 0
       44 GETTABLEKS                       R2 R3 K6 ["fakeTimers"]
       46 GETTABLEKS                       R1 R2 K7 ["enableGlobally"]
       48 CALL                             R0 1 1
       49 JUMPIFNOT                        R0 ; [+6]
       50 GETUPVAL                         R1 3
       51 GETTABLEKS                       R0 R1 K6 ["fakeTimers"]
       53 NAMECALL                         R0 R0 K9 ["useFakeTimers"]
       55 CALL                             R0 1 0
       56 GETUPVAL                         R1 0
       57 GETTABLEKS                       R0 R1 K10 ["restoreMocks"]
       59 JUMPIFNOT                        R0 ; [+4]
       60 GETUPVAL                         R0 1
...
PROTO_3:
       ...
       42 GETUPVAL                         R7 3
       43 GETTABLEKS                       R6 R7 K14 ["fakeTimers"]
       ...
       55 CALL                             R6 1 0
       56 GETUPVAL                         R9 2
       57 GETTABLEKS                       R6 R9 K17 ["setupFilesAfterEnv"]
       59 LOADNIL                          R7
       60 LOADNIL                          R8
       61 FORGPREP                         R6
       62 GETUPVAL                         R11 0
...
PROTO_6:
       ...
       13 CALL                             R3 1 1
       14 GETUPVAL                         R5 1
       15 GETTABLEKS                       R4 R5 K4 ["toJSBoolean"]
       17 MOVE                             R5 R2
       18 CALL                             R4 1 1
       19 JUMPIFNOT                        R4 ; [+3]
...
MAIN:
       ...
       47 GETTABLEKS                       R11 R0 K13 ["JestUtil"]
       49 CALL                             R10 1 1
       50 GETTABLEKS                       R9 R10 K14 ["deepCyclicCopy"]
       52 GETIMPORT                        R12 K1 [script]
       54 GETTABLEKS                       R11 R12 K2 ["Parent"]
       56 GETTABLEKS                       R10 R11 K15 ["jestAdapterInit"]
       58 LOADNIL                          R11
