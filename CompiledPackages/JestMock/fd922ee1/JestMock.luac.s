...
PROTO_35:
       ...
       82 LOADK                            R9 K18 ["Can't spy on %*:%*() because it is not mockable."]
       83 GETTABLEKS                       R11 R1 K19 ["Name"]
       85 MOVE                             R12 R2
       86 NAMECALL                         R9 R9 K20 ["format"]
       88 CALL                             R9 3 1
       89 CALL                             R8 1 -1
       90 CALL                             R7 -1 0
       91 GETTABLE                         R7 R5 R2
       92 JUMPIFNOTEQKNIL                  R7 ; [+24]
       94 LOADNIL                          R7
       95 DUPTABLE                         R10 K23 [{["type"] = "function"}]
       96 NEWCLOSURE                       R11 P0
       97 CAPTURE                          REF R7
       98 NAMECALL                         R8 R0 K24 ["_makeComponent"]
      100 CALL                             R8 3 2
      101 GETTABLEKS                       R10 R6 K25 ["controls"]
      103 MOVE                             R12 R2
      104 MOVE                             R13 R9
      105 NAMECALL                         R10 R10 K26 ["mockMethod"]
      107 CALL                             R10 3 1
      108 MOVE                             R7 R10
      109 SETTABLE                         R8 R5 R2
      110 GETTABLEKS                       R10 R8 K27 ["mockImplementation"]
      112 NEWCLOSURE                       R11 P1
      113 CAPTURE                          VAL R6
      114 CAPTURE                          VAL R2
      115 CALL                             R10 1 0
      116 CLOSEUPVALS                      R7
      117 GETTABLE                         R7 R5 R2
      118 RETURN                           R7 1
      119 GETUPVAL                         R7 2
      120 MOVE                             R9 R1
      121 NAMECALL                         R7 R7 K28 ["isMockGlobalLibrary"]
      123 CALL                             R7 2 1
      124 JUMPIFNOT                        R7 ; [+50]
      125 GETTABLEKS                       R7 R1 K29 ["_automocksRef"]
      127 GETTABLE                         R8 R7 R2
      128 FASTCALL1                        TYPEOF R8 ; [+3]
      129 MOVE                             R10 R8
      130 GETIMPORT                        R9 K7 [typeof]
      132 CALL                             R9 1 1
      133 JUMPIFNOTEQKS                    R9 K30 ["table"] ; [+4]
      135 GETTABLEKS                       R9 R8 K31 ["_isGlobalAutomockFn"]
      137 JUMPIF                           R9 ; [+22]
      138 GETIMPORT                        R9 K11 [error]
      140 GETUPVAL                         R10 1
      141 GETTABLEKS                       R10 R10 K12 ["new"]
      143 LOADK                            R11 K32 ["Cannot spy the %s property because it is not a function; %s given instead"]
      144 FASTCALL1                        TOSTRING R2 ; [+3]
      145 MOVE                             R14 R2
      146 GETIMPORT                        R13 K34 [tostring]
      148 CALL                             R13 1 1
      149 FASTCALL1                        TYPEOF R8 ; [+3]
      150 MOVE                             R15 R8
      151 GETIMPORT                        R14 K7 [typeof]
      153 CALL                             R14 1 1
      154 NAMECALL                         R11 R11 K20 ["format"]
      156 CALL                             R11 3 -1
      157 CALL                             R10 -1 -1
      158 CALL                             R9 -1 0
      159 JUMP                             ; [+12]
      160 GETTABLEKS                       R9 R8 K35 ["_maybeMock"]
      162 JUMPIFNOTEQKNIL                  R9 ; [+9]
      164 GETIMPORT                        R9 K11 [error]
      166 GETUPVAL                         R10 1
      167 GETTABLEKS                       R10 R10 K12 ["new"]
      169 LOADK                            R11 K36 ["globalEnv has not been initialised by Jest here"]
      170 CALL                             R10 1 -1
      171 CALL                             R9 -1 0
      172 GETTABLEKS                       R9 R8 K35 ["_maybeMock"]
      174 RETURN                           R9 1
      175 FASTCALL1                        TYPEOF R1 ; [+3]
      176 MOVE                             R8 R1
      177 GETIMPORT                        R7 K7 [typeof]
      179 CALL                             R7 1 1
      180 JUMPIFNOTEQKS                    R7 K30 ["table"] ; [+146]
      182 GETTABLE                         R7 R5 R2
      183 JUMPIFNOTEQKNIL                  R7 ; [+141]
      185 GETTABLE                         R7 R1 R2
      186 FASTCALL2                        RAWGET R1 R2 ; [+5]
      188 MOVE                             R10 R1
      189 MOVE                             R11 R2
      190 GETIMPORT                        R9 K38 [rawget]
      192 CALL                             R9 2 1
      193 JUMPIFNOTEQKNIL                  R9 ; [+2]
      195 LOADB                            R8 0 +1
      196 LOADB                            R8 1
      197 LOADNIL                          R9
      198 FASTCALL1                        TYPEOF R7 ; [+3]
      199 MOVE                             R11 R7
      200 GETIMPORT                        R10 K7 [typeof]
      202 CALL                             R10 1 1
      203 JUMPIFNOTEQKS                    R10 K30 ["table"] ; [+18]
      205 FASTCALL1                        GETMETATABLE R7 ; [+3]
      206 MOVE                             R11 R7
      207 GETIMPORT                        R10 K40 [getmetatable]
      209 CALL                             R10 1 1
      210 FASTCALL1                        TYPEOF R10 ; [+3]
      211 MOVE                             R12 R10
      212 GETIMPORT                        R11 K7 [typeof]
      214 CALL                             R11 1 1
      215 JUMPIFNOTEQKS                    R11 K30 ["table"] ; [+6]
      217 GETTABLEKS                       R11 R10 K41 ["__call"]
      219 JUMPIFEQKNIL                     R11 ; [+2]
      221 MOVE                             R9 R10
      222 DUPTABLE                         R12 K23 [{["type"] = "function"}]
      223 NEWCLOSURE                       R13 P2
      224 CAPTURE                          VAL R1
      225 CAPTURE                          VAL R2
      226 CAPTURE                          VAL R8
      227 CAPTURE                          VAL R7
      228 NAMECALL                         R10 R0 K24 ["_makeComponent"]
      230 CALL                             R10 3 2
      231 FASTCALL1                        TYPEOF R7 ; [+3]
      232 MOVE                             R13 R7
      233 GETIMPORT                        R12 K7 [typeof]
      235 CALL                             R12 1 1
      236 JUMPIFNOTEQKS                    R12 K22 ["function"] ; [+15]
      238 GETTABLEKS                       R13 R4 K42 ["oldFunctionSpying"]
      240 JUMPIFNOT                        R13 ; [+2]
      241 MOVE                             R12 R10
      242 JUMP                             ; [+1]
      243 MOVE                             R12 R11
      244 SETTABLE                         R12 R1 R2
      245 SETTABLE                         R10 R5 R2
      246 GETTABLEKS                       R12 R10 K27 ["mockImplementation"]
      248 NEWCLOSURE                       R13 P3
      249 CAPTURE                          VAL R7
      250 CALL                             R12 1 0
      251 JUMP                             ; [+72]
      252 JUMPIFEQKNIL                     R9 ; [+50]
      254 GETIMPORT                        R12 K44 [pcall]
      256 GETIMPORT                        R13 K46 [table.clone]
      258 MOVE                             R14 R7
      259 CALL                             R12 2 2
      260 JUMPIF                           R12 ; [+21]
      261 GETIMPORT                        R14 K11 [error]
      263 GETUPVAL                         R15 1
      264 GETTABLEKS                       R15 R15 K12 ["new"]
      266 LOADK                            R16 K47 ["Cannot spy the %s property because it cannot be cloned. (%s)"]
      267 FASTCALL1                        TOSTRING R2 ; [+3]
      268 MOVE                             R19 R2
      269 GETIMPORT                        R18 K34 [tostring]
      271 CALL                             R18 1 1
      272 LOADK                            R22 K48 ["protected metatable"]
      273 NAMECALL                         R20 R13 K49 ["match"]
      275 CALL                             R20 2 1
      276 OR                               R19 R20 R13
      277 NAMECALL                         R16 R16 K20 ["format"]
      279 CALL                             R16 3 -1
      280 CALL                             R15 -1 -1
      281 CALL                             R14 -1 0
      282 GETIMPORT                        R14 K46 [table.clone]
      284 MOVE                             R15 R9
      285 CALL                             R14 1 1
      286 SETTABLEKS                       R11 R14 K41 ["__call"]
      288 FASTCALL2                        SETMETATABLE R13 R14 ; [+5]
      290 MOVE                             R16 R13
      291 MOVE                             R17 R14
      292 GETIMPORT                        R15 K51 [setmetatable]
      294 CALL                             R15 2 1
      295 SETTABLE                         R15 R1 R2
      296 SETTABLE                         R10 R5 R2
      297 GETTABLEKS                       R15 R10 K27 ["mockImplementation"]
      299 NEWCLOSURE                       R16 P4
      300 CAPTURE                          REF R9
      301 CALL                             R15 1 0
      302 JUMP                             ; [+21]
      303 GETIMPORT                        R12 K11 [error]
      305 GETUPVAL                         R13 1
      306 GETTABLEKS                       R13 R13 K12 ["new"]
      308 LOADK                            R14 K52 ["Cannot spy the %s property because it is not a function or callable table; %s given instead"]
      309 FASTCALL1                        TOSTRING R2 ; [+3]
      310 MOVE                             R17 R2
      311 GETIMPORT                        R16 K34 [tostring]
      313 CALL                             R16 1 1
      314 FASTCALL1                        TYPEOF R7 ; [+3]
      315 MOVE                             R18 R7
      316 GETIMPORT                        R17 K7 [typeof]
      318 CALL                             R17 1 1
      319 NAMECALL                         R14 R14 K20 ["format"]
      321 CALL                             R14 3 -1
      322 CALL                             R13 -1 -1
      323 CALL                             R12 -1 0
      324 CLOSEUPVALS                      R9
      325 GETTABLE                         R7 R5 R2
      326 RETURN                           R7 1
      327 GETIMPORT                        R7 K11 [error]
      329 GETUPVAL                         R8 1
      330 GETTABLEKS                       R8 R8 K12 ["new"]
      332 LOADK                            R9 K53 ["Cannot spyOn on a primitive value; %s given"]
      333 FASTCALL1                        TYPEOF R1 ; [+3]
      334 MOVE                             R12 R1
      335 GETIMPORT                        R11 K7 [typeof]
      337 CALL                             R11 1 1
      338 NAMECALL                         R9 R9 K20 ["format"]
      340 CALL                             R9 2 -1
      341 CALL                             R8 -1 -1
      342 CALL                             R7 -1 0
      343 RETURN                           R0 0
