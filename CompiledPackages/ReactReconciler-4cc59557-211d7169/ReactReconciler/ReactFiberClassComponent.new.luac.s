...
PROTO_8:
  ...
  CALL R8 1 1
  JUMPIFNOTEQKS R8 K4 ["function"] [+61]
  GETIMPORT R9 K6 [_G]
  ...
  LOADK R11 K17 ["%s.shouldComponentUpdate(): Returned nil instead of a "]
  LOADK R12 K18 ["boolean value. Make sure to return true or false."]
  CONCAT R10 R11 R12
  GETUPVAL R12 5
  MOVE R13 R1
  CALL R12 1 1
  ORK R11 R12 K19 ["Component"]
  CALL R9 2 0
  RETURN R8 1
  ...
  GETIMPORT R8 K3 [typeof]
  CALL R8 1 1
  JUMPIFNOTEQKS R8 K20 ["table"] [+16]
  GETTABLEKS R8 R1 K21 ["isPureReactComponent"]
  JUMPIFNOT R8 [+12]
  GETUPVAL R9 6
  MOVE R10 R2
  MOVE R11 R3
...
PROTO_9:
  ...
  CALL R6 1 1
  JUMPIFNOTEQKS R6 K8 ["function"] [+10]
  GETUPVAL R7 1
  GETTABLEKS R6 R7 K9 ["error"]
  LOADK R8 K10 ["%s(...): No `render` method found on the returned component "]
  LOADK R9 K11 ["instance: did you accidentally return an object from the constructor?"]
  CONCAT R7 R8 R9
  MOVE R8 R4
  CALL R6 2 0
  JUMP [+8]
  ...
  GETTABLEKS R6 R7 K9 ["error"]
  LOADK R8 K10 ["%s(...): No `render` method found on the returned component "]
  LOADK R9 K12 ["instance: you may have forgotten to define `render`."]
  CONCAT R7 R8 R9
  MOVE R8 R4
  CALL R6 2 0
  GETTABLEKS R6 R3 K13 ["getInitialState"]
  JUMPIFNOT R6 [+17]
  GETTABLEKS R7 R3 K13 ["getInitialState"]
  GETTABLEKS R6 R7 K14 ["isReactClassApproved"]
  JUMPIF R6 [+12]
  GETTABLEKS R6 R3 K15 ["state"]
  JUMPIF R6 [+9]
  GETUPVAL R7 1
  GETTABLEKS R6 R7 K9 ["error"]
  LOADK R8 K16 ["getInitialState was defined on %s, a plain JavaScript class. "]
  LOADK R9 K17 ["This is only supported for classes created using React.createClass. "]
  LOADK R10 K18 ["Did you mean to define a state property instead?"]
  CONCAT R7 R8 R10
  MOVE R8 R4
  CALL R6 2 0
  GETTABLEKS R6 R3 K19 ["getDefaultProps"]
  JUMPIFNOT R6 [+14]
  GETTABLEKS R7 R3 K19 ["getDefaultProps"]
  GETTABLEKS R6 R7 K14 ["isReactClassApproved"]
  JUMPIF R6 [+9]
  GETUPVAL R7 1
  GETTABLEKS R6 R7 K9 ["error"]
  LOADK R8 K20 ["getDefaultProps was defined on %s, a plain JavaScript class. "]
  LOADK R9 K17 ["This is only supported for classes created using React.createClass. "]
  LOADK R10 K21 ["Use a static property to define defaultProps instead."]
  CONCAT R7 R8 R10
  MOVE R8 R4
  CALL R6 2 0
  GETTABLEKS R6 R3 K22 ["propTypes"]
  JUMPIFNOT R6 [+11]
  GETTABLEKS R6 R1 K22 ["propTypes"]
  JUMPIF R6 [+8]
  GETUPVAL R7 1
  GETTABLEKS R6 R7 K9 ["error"]
  LOADK R8 K23 ["propTypes was defined as an instance property on %s. Use a static "]
  LOADK R9 K24 ["property to define propTypes instead."]
  CONCAT R7 R8 R9
  MOVE R8 R4
  CALL R6 2 0
  GETTABLEKS R6 R3 K25 ["contextType"]
  JUMPIFNOT R6 [+11]
  GETTABLEKS R6 R1 K25 ["contextType"]
  JUMPIF R6 [+8]
  GETUPVAL R7 1
  GETTABLEKS R6 R7 K9 ["error"]
  LOADK R8 K26 ["contextType was defined as an instance property on %s. Use a static "]
  LOADK R9 K27 ["property to define contextType instead."]
  CONCAT R7 R8 R9
  MOVE R8 R4
  CALL R6 2 0
  GETUPVAL R6 2
  JUMPIFNOT R6 [+23]
  GETTABLEKS R6 R1 K28 ["childContextTypes"]
  JUMPIFNOT R6 [+8]
  GETUPVAL R7 1
  GETTABLEKS R6 R7 K9 ["error"]
  LOADK R8 K29 ["%s uses the legacy childContextTypes API which is no longer supported. "]
  LOADK R9 K30 ["Use React.createContext() instead."]
  CONCAT R7 R8 R9
  MOVE R8 R4
  CALL R6 2 0
  GETTABLEKS R6 R1 K31 ["contextTypes"]
  JUMPIFNOT R6 [+50]
  GETUPVAL R7 1
  GETTABLEKS R6 R7 K9 ["error"]
  LOADK R8 K32 ["%s uses the legacy contextTypes API which is no longer supported. "]
  LOADK R9 K33 ["Use React.createContext() with static contextType instead."]
  CONCAT R7 R8 R9
  MOVE R8 R4
  CALL R6 2 0
  JUMP [+41]
  GETTABLEKS R6 R3 K31 ["contextTypes"]
  JUMPIFNOT R6 [+11]
  GETTABLEKS R6 R1 K31 ["contextTypes"]
  JUMPIF R6 [+8]
  GETUPVAL R7 1
  GETTABLEKS R6 R7 K9 ["error"]
  LOADK R8 K34 ["contextTypes was defined as an instance property on %s. Use a static "]
  LOADK R9 K35 ["property to define contextTypes instead."]
  CONCAT R7 R8 R9
  MOVE R8 R4
  CALL R6 2 0
  FASTCALL1 TYPEOF R1 [+3]
  ...
  GETUPVAL R7 1
  GETTABLEKS R6 R7 K9 ["error"]
  LOADK R8 K37 ["%s declares both contextTypes and contextType static properties. "]
  LOADK R9 K38 ["The legacy contextTypes property will be ignored."]
  CONCAT R7 R8 R9
  MOVE R8 R4
  CALL R6 2 0
  GETTABLEKS R7 R3 K39 ["componentShouldUpdate"]
  FASTCALL1 TYPEOF R7 [+2]
  GETIMPORT R6 K7 [typeof]
  CALL R6 1 1
  JUMPIFNOTEQKS R6 K8 ["function"] [+11]
  GETUPVAL R7 1
  GETTABLEKS R6 R7 K9 ["error"]
  LOADK R8 K40 ["%s has a method called "]
  LOADK R9 K41 ["componentShouldUpdate(). Did you mean shouldComponentUpdate()? "]
  LOADK R10 K42 ["The name is phrased as a question because the function is "]
  LOADK R11 K43 ["expected to return a value."]
  CONCAT R7 R8 R11
  MOVE R8 R4
  CALL R6 2 0
  FASTCALL1 TYPEOF R1 [+3]
  ...
  GETIMPORT R6 K7 [typeof]
  CALL R6 1 1
  JUMPIFNOTEQKS R6 K36 ["table"] [+20]
  GETTABLEKS R6 R1 K44 ["isPureReactComponent"]
  JUMPIFNOT R6 [+16]
  GETTABLEKS R6 R3 K45 ["shouldComponentUpdate"]
  JUMPIFEQKNIL R6 [+13]
  GETUPVAL R7 1
  GETTABLEKS R6 R7 K9 ["error"]
  LOADK R8 K46 ["%s has a method called shouldComponentUpdate(). "]
  LOADK R9 K47 ["shouldComponentUpdate should not be used when extending React.PureComponent. "]
  LOADK R10 K48 ["Please extend React.Component if shouldComponentUpdate is used."]
  CONCAT R7 R8 R10
  GETUPVAL R9 0
  MOVE R10 R1
  CALL R9 1 1
  ORK R8 R9 K49 ["A pure component"]
  CALL R6 2 0
  GETTABLEKS R7 R3 K50 ["componentDidUnmount"]
  FASTCALL1 TYPEOF R7 [+2]
  GETIMPORT R6 K7 [typeof]
  CALL R6 1 1
  JUMPIFNOTEQKS R6 K8 ["function"] [+10]
  ...
  GETTABLEKS R6 R7 K9 ["error"]
  LOADK R8 K40 ["%s has a method called "]
  LOADK R9 K51 ["componentDidUnmount(). But there is no such lifecycle method. "]
  LOADK R10 K52 ["Did you mean componentWillUnmount()?"]
  CONCAT R7 R8 R10
  MOVE R8 R4
  CALL R6 2 0
  GETTABLEKS R7 R3 K53 ["componentDidReceiveProps"]
  FASTCALL1 TYPEOF R7 [+2]
  GETIMPORT R6 K7 [typeof]
  CALL R6 1 1
  JUMPIFNOTEQKS R6 K8 ["function"] [+12]
  GETUPVAL R7 1
  GETTABLEKS R6 R7 K9 ["error"]
  LOADK R8 K40 ["%s has a method called "]
  LOADK R9 K54 ["componentDidReceiveProps(). But there is no such lifecycle method. "]
  LOADK R10 K55 ["If you meant to update the state in response to changing props, "]
  LOADK R11 K56 ["use componentWillReceiveProps(). If you meant to fetch data or "]
  LOADK R12 K57 ["run side-effects or mutations after React has updated the UI, use componentDidUpdate()."]
  CONCAT R7 R8 R12
  MOVE R8 R4
  CALL R6 2 0
  GETTABLEKS R7 R3 K58 ["componentWillRecieveProps"]
  FASTCALL1 TYPEOF R7 [+2]
  GETIMPORT R6 K7 [typeof]
  CALL R6 1 1
  JUMPIFNOTEQKS R6 K8 ["function"] [+9]
  GETUPVAL R7 1
  GETTABLEKS R6 R7 K9 ["error"]
  LOADK R8 K40 ["%s has a method called "]
  LOADK R9 K59 ["componentWillRecieveProps(). Did you mean componentWillReceiveProps()?"]
  CONCAT R7 R8 R9
  MOVE R8 R4
  CALL R6 2 0
  GETTABLEKS R7 R3 K60 ["UNSAFE_componentWillRecieveProps"]
  FASTCALL1 TYPEOF R7 [+2]
  GETIMPORT R6 K7 [typeof]
  CALL R6 1 1
  JUMPIFNOTEQKS R6 K8 ["function"] [+9]
  ...
  GETTABLEKS R6 R7 K9 ["error"]
  LOADK R8 K40 ["%s has a method called "]
  LOADK R9 K61 ["UNSAFE_componentWillRecieveProps(). Did you mean UNSAFE_componentWillReceiveProps()?"]
  CONCAT R7 R8 R9
  MOVE R8 R4
  CALL R6 2 0
  GETTABLEKS R7 R3 K62 ["props"]
  JUMPIFNOTEQ R7 R2 [+2]
  LOADB R6 0 +1
  LOADB R6 1
  GETTABLEKS R7 R3 K62 ["props"]
  ...
  LOADK R9 K63 ["%s(...): When calling super() in `%s`, make sure to pass "]
  LOADK R10 K64 ["up the same props that your component's constructor was passed."]
  CONCAT R8 R9 R10
  MOVE R9 R4
  MOVE R10 R4
  CALL R7 3 0
  FASTCALL2K RAWGET R3 K65 [+5]
  MOVE R8 R3
  LOADK R9 K65 ["defaultProps"]
  GETIMPORT R7 K67 [rawget]
  CALL R7 2 1
  JUMPIFNOT R7 [+9]
  GETUPVAL R8 1
  GETTABLEKS R7 R8 K9 ["error"]
  LOADK R9 K68 ["Setting defaultProps as an instance property on %s is not supported and will be ignored."]
  LOADK R10 K69 [" Instead, define defaultProps as a static property on %s."]
  CONCAT R8 R9 R10
  MOVE R9 R4
  MOVE R10 R4
  CALL R7 3 0
  GETTABLEKS R8 R3 K70 ["getSnapshotBeforeUpdate"]
  FASTCALL1 TYPEOF R8 [+2]
  GETIMPORT R7 K7 [typeof]
  CALL R7 1 1
  JUMPIFNOTEQKS R7 K8 ["function"] [+25]
  GETTABLEKS R8 R3 K71 ["componentDidUpdate"]
  FASTCALL1 TYPEOF R8 [+2]
  GETIMPORT R7 K7 [typeof]
  CALL R7 1 1
  JUMPIFEQKS R7 K8 ["function"] [+17]
  GETUPVAL R8 4
  GETTABLE R7 R8 R1
  JUMPIF R7 [+13]
  GETUPVAL R7 4
  ...
  GETUPVAL R8 1
  GETTABLEKS R7 R8 K9 ["error"]
  LOADK R9 K72 ["%s: getSnapshotBeforeUpdate() should be used with componentDidUpdate(). "]
  LOADK R10 K73 ["This component defines getSnapshotBeforeUpdate() only."]
  CONCAT R8 R9 R10
  GETUPVAL R9 0
  MOVE R10 R1
  CALL R9 1 -1
  CALL R7 -1 0
  GETTABLEKS R7 R3 K15 ["state"]
  JUMPIFEQKNIL R7 [+14]
  FASTCALL1 TYPEOF R7 [+3]
  MOVE R9 R7
  GETIMPORT R8 K7 [typeof]
  CALL R8 1 1
  JUMPIFEQKS R8 K36 ["table"] [+7]
  GETUPVAL R9 1
  GETTABLEKS R8 R9 K9 ["error"]
  LOADK R9 K74 ["%s.state: must be set to an object or nil"]
  MOVE R10 R4
  CALL R8 2 0
  FASTCALL1 TYPEOF R1 [+3]
  MOVE R9 R1
  GETIMPORT R8 K7 [typeof]
  CALL R8 1 1
  JUMPIFNOTEQKS R8 K36 ["table"] [+25]
  GETTABLEKS R9 R3 K75 ["getChildContext"]
  FASTCALL1 TYPEOF R9 [+2]
  GETIMPORT R8 K7 [typeof]
  CALL R8 1 1
  JUMPIFNOTEQKS R8 K8 ["function"] [+17]
  GETTABLEKS R9 R1 K28 ["childContextTypes"]
  FASTCALL1 TYPEOF R9 [+2]
  GETIMPORT R8 K7 [typeof]
  CALL R8 1 1
  JUMPIFEQKS R8 K36 ["table"] [+9]
  GETUPVAL R9 1
  GETTABLEKS R8 R9 K9 ["error"]
  LOADK R10 K76 ["%s.getChildContext(): childContextTypes must be defined in order to "]
  LOADK R11 K77 ["use getChildContext()."]
  CONCAT R9 R10 R11
  MOVE R10 R4
  CALL R8 2 0
  RETURN R0 0
...
PROTO_11:
  ...
  LOADK R9 K7 [" However, it is set to nil. "]
  LOADK R10 K8 ["This can be caused by a typo or by mixing up named and default imports. "]
  LOADK R11 K9 ["This can also happen due to a circular dependency, so "]
  LOADK R12 K10 ["try moving the createContext() call to a separate file."]
  CONCAT R8 R9 R12
  JUMP [+47]
  ...
  CALL R9 1 1
  JUMPIFEQKS R9 K13 ["table"] [+11]
  LOADK R9 K14 [" However, it is set to a "]
  FASTCALL1 TYPEOF R6 [+3]
  MOVE R13 R6
  ...
  LOADK R8 K16 [" Did you accidentally pass the Context.Provider instead?"]
  JUMP [+23]
  GETTABLEKS R9 R6 K5 ["_context"]
  JUMPIFEQKNIL R9 [+3]
  LOADK R8 K17 [" Did you accidentally pass the Context.Consumer instead?"]
  JUMP [+17]
  MOVE R9 R8
  LOADK R10 K18 [" However, it is set to an object with keys {"]
  CONCAT R8 R9 R10
  GETIMPORT R9 K20 [pairs]
  MOVE R10 R6
  CALL R9 1 3
  FORGPREP_NEXT R9
  MOVE R14 R8
  ...
  CONCAT R8 R9 R10
  GETUPVAL R10 4
  GETTABLEKS R9 R10 K23 ["error"]
  LOADK R11 K24 ["%s defines an invalid contextType. "]
  LOADK R12 K25 ["contextType should point to the Context object returned by React.createContext().%s"]
  CONCAT R10 R11 R12
  GETUPVAL R12 5
  MOVE R13 R1
  CALL R12 1 1
  ORK R11 R12 K26 ["Component"]
  MOVE R12 R8
  CALL R9 3 0
  JUMPIFEQKNIL R6 [+13]
  FASTCALL1 TYPEOF R6 [+3]
  ...
  CALL R7 3 1
  MOVE R4 R7
  GETTABLEKS R7 R1 K27 ["contextTypes"]
  ...
  GETUPVAL R7 10
  JUMPIFNOT R7 [+26]
  GETTABLEKS R8 R0 K28 ["mode"]
  GETUPVAL R9 11
  FASTCALL2 BIT32_BAND R8 R9 [+3]
  GETIMPORT R7 K31 [bit32.band]
  CALL R7 2 1
  JUMPIFEQKN R7 K32 [0] [+17]
  GETUPVAL R7 12
  CALL R7 0 0
  GETIMPORT R7 K34 [pcall]
  GETTABLEKS R8 R1 K35 ["__ctor"]
  MOVE R9 R2
  MOVE R10 R5
  CALL R7 3 2
  GETUPVAL R9 13
  CALL R9 0 0
  JUMPIF R7 [+4]
  GETIMPORT R9 K36 [error]
  MOVE R10 R8
  CALL R9 1 0
  GETTABLEKS R7 R1 K35 ["__ctor"]
  MOVE R8 R2
  MOVE R9 R5
  CALL R7 2 1
  GETTABLEKS R8 R7 K37 ["state"]
  SETTABLEKS R8 R0 K38 ["memoizedState"]
  GETTABLEKS R8 R0 K38 ["memoizedState"]
  GETUPVAL R10 14
  JUMPIFNOTEQKNIL R10 [+3]
  GETUPVAL R10 15
  CALL R10 0 0
  GETUPVAL R9 14
  SETTABLEKS R9 R7 K39 ["__updater"]
  SETTABLEKS R7 R0 K40 ["stateNode"]
  GETUPVAL R9 16
  MOVE R10 R7
  MOVE R11 R0
  CALL R9 2 0
  ...
  JUMPIFNOT R9 [+3]
  GETUPVAL R9 17
  SETTABLEKS R9 R7 K41 ["_reactInternalInstance"]
  GETIMPORT R10 K2 [_G]
  GETTABLEKS R9 R10 K3 ["__DEV__"]
  JUMPIFNOT R9 [+186]
  GETTABLEKS R10 R1 K42 ["getDerivedStateFromProps"]
  FASTCALL1 TYPEOF R10 [+2]
  GETIMPORT R9 K12 [typeof]
  CALL R9 1 1
  JUMPIFNOTEQKS R9 K43 ["function"] [+25]
  GETUPVAL R9 18
  JUMPIFNOTEQ R8 R9 [+22]
  GETUPVAL R10 5
  MOVE R11 R1
  CALL R10 1 1
  ORK R9 R10 K26 ["Component"]
  GETUPVAL R11 19
  GETTABLE R10 R11 R9
  JUMPIF R10 [+14]
  GETUPVAL R10 19
  ...
  LOADK R12 K44 ["`%s` uses `getDerivedStateFromProps` but its initial state has not been initialized. "]
  LOADK R13 K45 ["This is not recommended. Instead, define the initial state by "]
  LOADK R14 K46 ["passing an object to `self:setState` in the `init` method of `%s`. "]
  LOADK R15 K47 ["This ensures that `getDerivedStateFromProps` arguments have a consistent shape."]
  CONCAT R11 R12 R15
  MOVE R12 R9
  MOVE R13 R9
  CALL R10 3 0
  ...
  GETIMPORT R9 K12 [typeof]
  CALL R9 1 1
  JUMPIFEQKS R9 K43 ["function"] [+9]
  GETTABLEKS R10 R7 K48 ["getSnapshotBeforeUpdate"]
  FASTCALL1 TYPEOF R10 [+2]
  GETIMPORT R9 K12 [typeof]
  CALL R9 1 1
  JUMPIFNOTEQKS R9 K43 ["function"] [+139]
  LOADNIL R9
  LOADNIL R10
  LOADNIL R11
  GETTABLEKS R13 R7 K49 ["componentWillMount"]
  FASTCALL1 TYPEOF R13 [+2]
  GETIMPORT R12 K12 [typeof]
  CALL R12 1 1
  JUMPIFNOTEQKS R12 K43 ["function"] [+3]
  LOADK R9 K49 ["componentWillMount"]
  JUMP [+9]
  GETTABLEKS R13 R7 K50 ["UNSAFE_componentWillMount"]
  FASTCALL1 TYPEOF R13 [+2]
  GETIMPORT R12 K12 [typeof]
  CALL R12 1 1
  JUMPIFNOTEQKS R12 K43 ["function"] [+2]
  LOADK R9 K50 ["UNSAFE_componentWillMount"]
  GETTABLEKS R13 R7 K51 ["componentWillReceiveProps"]
  FASTCALL1 TYPEOF R13 [+2]
  GETIMPORT R12 K12 [typeof]
  CALL R12 1 1
  JUMPIFNOTEQKS R12 K43 ["function"] [+3]
  LOADK R10 K51 ["componentWillReceiveProps"]
  JUMP [+9]
  GETTABLEKS R13 R7 K52 ["UNSAFE_componentWillReceiveProps"]
  FASTCALL1 TYPEOF R13 [+2]
  GETIMPORT R12 K12 [typeof]
  CALL R12 1 1
  JUMPIFNOTEQKS R12 K43 ["function"] [+2]
  LOADK R10 K52 ["UNSAFE_componentWillReceiveProps"]
  GETTABLEKS R13 R7 K53 ["componentWillUpdate"]
  FASTCALL1 TYPEOF R13 [+2]
  GETIMPORT R12 K12 [typeof]
  CALL R12 1 1
  JUMPIFNOTEQKS R12 K43 ["function"] [+3]
  LOADK R11 K53 ["componentWillUpdate"]
  JUMP [+9]
  GETTABLEKS R13 R7 K54 ["UNSAFE_componentWillUpdate"]
  FASTCALL1 TYPEOF R13 [+2]
  GETIMPORT R12 K12 [typeof]
  CALL R12 1 1
  JUMPIFNOTEQKS R12 K43 ["function"] [+2]
  LOADK R11 K54 ["UNSAFE_componentWillUpdate"]
  ...
  MOVE R14 R1
  CALL R13 1 1
  ORK R12 R13 K26 ["Component"]
  LOADNIL R13
  GETTABLEKS R15 R1 K42 ["getDerivedStateFromProps"]
  FASTCALL1 TYPEOF R15 [+2]
  GETIMPORT R14 K12 [typeof]
  CALL R14 1 1
  JUMPIFNOTEQKS R14 K43 ["function"] [+3]
  LOADK R13 K55 ["getDerivedStateFromProps()"]
  JUMP [+1]
  LOADK R13 K56 ["getSnapshotBeforeUpdate()"]
  LOADNIL R14
  JUMPIFEQKNIL R9 [+9]
  LOADK R15 K57 ["
  "]
  ...
  GETUPVAL R18 4
  GETTABLEKS R17 R18 K23 ["error"]
  LOADK R19 K60 ["Unsafe legacy lifecycles will not be called for components using new component APIs.

"]
  LOADK R20 K61 ["%s uses %s but also contains the following legacy lifecycles:%s%s%s

"]
  LOADK R21 K62 ["The above lifecycles should be removed. Learn more about this warning here:
"]
  LOADK R22 K63 ["https://reactjs.org/link/unsafe-component-lifecycles"]
  CONCAT R18 R19 R22
  MOVE R19 R12
  MOVE R20 R13
  MOVE R21 R14
...
PROTO_12:
  ...
  LOADK R5 K10 ["%s.componentWillMount(): Assigning directly to this.state is "]
  LOADK R6 K11 ["deprecated (except inside a component's "]
  LOADK R7 K12 ["constructor). Use setState instead."]
  CONCAT R4 R5 R7
  GETUPVAL R6 1
  GETTABLEKS R7 R0 K14 ["type"]
  CALL R6 1 1
  ORK R5 R6 K13 ["Component"]
  CALL R3 2 0
  GETUPVAL R5 2
  JUMPIFNOTEQKNIL R5 [+3]
  GETUPVAL R5 3
  CALL R5 0 0
  GETUPVAL R4 2
  GETTABLEKS R3 R4 K15 ["enqueueReplaceState"]
  MOVE R4 R1
...
PROTO_13:
  ...
  LOADK R8 K12 ["%s.componentWillReceiveProps(): Assigning directly to "]
  LOADK R9 K13 ["this.state is deprecated (except inside a component's "]
  LOADK R10 K14 ["constructor). Use setState instead."]
  CONCAT R7 R8 R10
  MOVE R8 R5
  CALL R6 2 0
  GETUPVAL R7 3
  ...
  CALL R7 0 0
  GETUPVAL R6 3
  GETTABLEKS R5 R6 K15 ["enqueueReplaceState"]
  MOVE R6 R1
...
PROTO_14:
  ...
  LOADK R9 K15 ["%s: It is not recommended to assign props directly to state "]
  LOADK R10 K16 ["because updates to props won't be reflected in state. "]
  LOADK R11 K17 ["In most cases, it is better to use props directly."]
  CONCAT R8 R9 R11
  MOVE R9 R6
  CALL R7 2 0
  GETTABLEKS R7 R0 K18 ["mode"]
  GETUPVAL R8 11
  FASTCALL2 BIT32_BAND R7 R8 [+3]
  GETIMPORT R6 K21 [bit32.band]
  CALL R6 2 1
  JUMPIFEQKN R6 K22 [0] [+7]
  GETUPVAL R7 12
  GETTABLEKS R6 R7 K23 ["recordLegacyContextWarning"]
  MOVE R7 R0
  MOVE R8 R4
  CALL R6 2 0
  GETUPVAL R6 13
  JUMPIFNOT R6 [+6]
  GETUPVAL R7 12
  GETTABLEKS R6 R7 K24 ["recordUnsafeLifecycleWarnings"]
  MOVE R7 R0
  MOVE R8 R4
  CALL R6 2 0
  GETUPVAL R6 14
  ...
  GETTABLEKS R6 R1 K25 ["getDerivedStateFromProps"]
  FASTCALL1 TYPEOF R6 [+3]
  MOVE R8 R6
  GETIMPORT R7 K9 [typeof]
  CALL R7 1 1
  JUMPIFNOTEQKS R7 K26 ["function"] [+11]
  GETUPVAL R7 15
  MOVE R8 R0
  MOVE R9 R1
  MOVE R10 R6
  ...
  GETTABLEKS R8 R1 K25 ["getDerivedStateFromProps"]
  FASTCALL1 TYPEOF R8 [+2]
  GETIMPORT R7 K9 [typeof]
  CALL R7 1 1
  JUMPIFEQKS R7 K26 ["function"] [+39]
  GETTABLEKS R8 R4 K27 ["getSnapshotBeforeUpdate"]
  FASTCALL1 TYPEOF R8 [+2]
  GETIMPORT R7 K9 [typeof]
  CALL R7 1 1
  JUMPIFEQKS R7 K26 ["function"] [+31]
  GETTABLEKS R8 R4 K28 ["UNSAFE_componentWillMount"]
  FASTCALL1 TYPEOF R8 [+2]
  GETIMPORT R7 K9 [typeof]
  CALL R7 1 1
  JUMPIFEQKS R7 K26 ["function"] [+9]
  GETTABLEKS R8 R4 K29 ["componentWillMount"]
  FASTCALL1 TYPEOF R8 [+2]
  GETIMPORT R7 K9 [typeof]
  CALL R7 1 1
  JUMPIFNOTEQKS R7 K26 ["function"] [+15]
  GETUPVAL R7 16
  MOVE R8 R0
  MOVE R9 R4
  CALL R7 2 0
  ...
  GETTABLEKS R7 R0 K5 ["memoizedState"]
  SETTABLEKS R7 R4 K6 ["state"]
  GETTABLEKS R8 R4 K30 ["componentDidMount"]
  FASTCALL1 TYPEOF R8 [+2]
  GETIMPORT R7 K9 [typeof]
  CALL R7 1 1
  JUMPIFNOTEQKS R7 K26 ["function"] [+35]
  GETIMPORT R8 K1 [_G]
  GETTABLEKS R7 R8 K2 ["__DEV__"]
  JUMPIFNOT R7 [+19]
  GETUPVAL R7 17
  JUMPIFNOT R7 [+17]
  GETTABLEKS R8 R0 K31 ["flags"]
  GETUPVAL R10 18
  GETUPVAL R11 19
  FASTCALL2 BIT32_BOR R10 R11 [+3]
  GETIMPORT R9 K33 [bit32.bor]
  CALL R9 2 1
  FASTCALL2 BIT32_BOR R8 R9 [+3]
  GETIMPORT R7 K33 [bit32.bor]
  CALL R7 2 1
  SETTABLEKS R7 R0 K31 ["flags"]
  RETURN R0 0
  GETTABLEKS R8 R0 K31 ["flags"]
  GETUPVAL R9 19
  FASTCALL2 BIT32_BOR R8 R9 [+3]
