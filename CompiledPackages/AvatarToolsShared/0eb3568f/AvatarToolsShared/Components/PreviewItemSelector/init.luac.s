...
PROTO_6:
        0 GETUPVAL                         R0 0
        1 DUPTABLE                         R2 K3 [{[1], ["hovered"] = False}]
        2 GETUPVAL                         R3 1
...
PROTO_8:
        0 DUPTABLE                         R1 K5 [{[1] = , ["isEquipped"] = False, ["hovered"] = False}]
        1 SETTABLEKS                       R1 R0 K6 ["state"]
        3 LOADNIL                          R1
        4 SETTABLEKS                       R1 R0 K7 ["selectedItem"]
        6 DUPCLOSURE                       R1 K8 [PROTO_3]
        7 CAPTURE                          UPVAL U0
        8 SETTABLEKS                       R1 R0 K9 ["selectInstance"]
       10 DUPCLOSURE                       R1 K10 [PROTO_4]
       11 CAPTURE                          UPVAL U0
       12 SETTABLEKS                       R1 R0 K11 ["deselect"]
       14 NEWCLOSURE                       R1 P2
       15 CAPTURE                          VAL R0
       16 SETTABLEKS                       R1 R0 K12 ["highlightInstance"]
       18 NEWCLOSURE                       R1 P3
       19 CAPTURE                          VAL R0
       20 CAPTURE                          UPVAL U1
       21 SETTABLEKS                       R1 R0 K13 ["removeHighlight"]
       23 GETIMPORT                        R1 K15 [game]
       25 GETTABLEKS                       R1 R1 K16 ["Workspace"]
       27 GETTABLEKS                       R1 R1 K17 ["CurrentCamera"]
       29 LOADK                            R3 K18 ["CFrame"]
       30 NAMECALL                         R1 R1 K19 ["GetPropertyChangedSignal"]
       32 CALL                             R1 2 1
       33 NEWCLOSURE                       R3 P4
       34 CAPTURE                          VAL R0
       35 NAMECALL                         R1 R1 K20 ["Connect"]
       37 CALL                             R1 2 1
       38 SETTABLEKS                       R1 R0 K21 ["cameraMoved"]
       40 GETIMPORT                        R1 K24 [Instance.new]
       42 LOADK                            R2 K25 ["ScreenGui"]
       43 CALL                             R1 1 1
       44 SETTABLEKS                       R1 R0 K25 ["ScreenGui"]
       46 GETTABLEKS                       R1 R0 K25 ["ScreenGui"]
       48 GETUPVAL                         R2 2
       49 SETTABLEKS                       R2 R1 K26 ["Parent"]
       51 GETTABLEKS                       R1 R0 K25 ["ScreenGui"]
       53 LOADK                            R2 K27 ["PreviewSelectorGUI"]
       54 SETTABLEKS                       R2 R1 K28 ["Name"]
       56 GETUPVAL                         R1 3
       57 GETTABLEKS                       R1 R1 K23 ["new"]
       59 GETTABLEKS                       R2 R0 K25 ["ScreenGui"]
       61 CALL                             R1 1 1
       62 SETTABLEKS                       R1 R0 K29 ["focus"]
       64 RETURN                           R0 0
...
MAIN:
       ...
       62 CALL                             R14 2 0
       63 DUPTABLE                         R14 K26 [{["SelectionDistance"] = 20}]
       64 SETTABLEKS                       R14 R10 K27 ["defaultProps"]
       66 DUPCLOSURE                       R14 K28 [PROTO_0]
       67 SETTABLEKS                       R14 R10 K29 ["getMouseTarget"]
       69 DUPCLOSURE                       R14 K30 [PROTO_1]
       70 DUPCLOSURE                       R15 K31 [PROTO_2]
       71 SETTABLEKS                       R15 R10 K32 ["selectValidInstance"]
       73 DUPCLOSURE                       R15 K33 [PROTO_8]
       74 CAPTURE                          VAL R9
       75 CAPTURE                          VAL R2
       76 CAPTURE                          VAL R8
       77 CAPTURE                          VAL R6
       78 SETTABLEKS                       R15 R10 K34 ["init"]
       80 DUPCLOSURE                       R15 K35 [PROTO_11]
       81 CAPTURE                          VAL R9
       82 CAPTURE                          VAL R7
       83 SETTABLEKS                       R15 R10 K36 ["didMount"]
       85 DUPCLOSURE                       R15 K37 [PROTO_12]
       86 SETTABLEKS                       R15 R10 K38 ["getIconPosition"]
       88 DUPCLOSURE                       R15 K39 [PROTO_13]
       89 SETTABLEKS                       R15 R10 K40 ["getIconRadius"]
       91 DUPCLOSURE                       R15 K41 [PROTO_17]
       92 CAPTURE                          VAL R2
       93 CAPTURE                          VAL R11
       94 SETTABLEKS                       R15 R10 K42 ["renderButton"]
       96 DUPCLOSURE                       R15 K43 [PROTO_18]
       97 CAPTURE                          VAL R4
       98 CAPTURE                          VAL R2
       99 SETTABLEKS                       R15 R10 K44 ["render"]
      101 DUPCLOSURE                       R15 K45 [PROTO_19]
      102 SETTABLEKS                       R15 R10 K46 ["willUnmount"]
      104 MOVE                             R15 R5
      105 DUPTABLE                         R16 K51 [{"Stylizer", "Localization", "Mouse", "Plugin"}]
      106 GETTABLEKS                       R17 R4 K47 ["Stylizer"]
      108 SETTABLEKS                       R17 R16 K47 ["Stylizer"]
      110 GETTABLEKS                       R17 R4 K48 ["Localization"]
      112 SETTABLEKS                       R17 R16 K48 ["Localization"]
      114 GETTABLEKS                       R17 R4 K49 ["Mouse"]
      116 SETTABLEKS                       R17 R16 K49 ["Mouse"]
      118 GETTABLEKS                       R17 R4 K50 ["Plugin"]
      120 SETTABLEKS                       R17 R16 K50 ["Plugin"]
      122 CALL                             R15 1 1
      123 MOVE                             R16 R10
      124 CALL                             R15 1 1
      125 MOVE                             R10 R15
