PROTO_0:
        ...
        4 GETUPVAL                         R2 0
        5 GETTABLEKS                       R2 R2 K2 ["previewClothing"]
        7 CALL                             R1 1 3
        8 FORGPREP_INEXT                   R1
       ...
       26 GETUPVAL                         R1 0
       27 GETTABLEKS                       R1 R1 K9 ["flattenLayerOrders"]
       29 MOVE                             R2 R0
       30 CALL                             R1 1 0
       31 GETUPVAL                         R1 0
       32 GETTABLEKS                       R1 R1 K10 ["updateIdMap"]
       34 CALL                             R1 0 0
       35 RETURN                           R0 0

PROTO_1:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["wrapLayerChanged"]
        3 JUMPIFNOT                        R0 ; [+7]
        4 GETUPVAL                         R0 0
        5 GETTABLEKS                       R0 R0 K0 ["wrapLayerChanged"]
        7 GETUPVAL                         R1 0
        8 GETTABLEKS                       R1 R1 K1 ["wrapLayerOrderBeforeChange"]
       10 RETURN                           R0 2
       11 LOADNIL                          R0
       12 LOADN                            R1 0
       13 GETIMPORT                        R2 K3 [ipairs]
       15 GETUPVAL                         R3 0
       16 GETTABLEKS                       R3 R3 K4 ["orderedLayers"]
       18 CALL                             R2 1 3
       ...
       25 LOADN                            R9 1
       26 GETUPVAL                         R11 0
       27 GETTABLEKS                       R11 R11 K4 ["orderedLayers"]
       29 LENGTH                           R10 R11
...
PROTO_2:
        ...
        8 GETUPVAL                         R6 0
        9 GETTABLEKS                       R6 R6 K2 ["orderedLayers"]
       11 CALL                             R5 1 3
...
PROTO_3:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["ignoreSignals"]
        3 JUMPIFNOT                        R0 ; [+1]
        4 RETURN                           R0 0
        5 LOADNIL                          R0
        6 LOADNIL                          R1
        7 GETUPVAL                         R2 0
        8 GETTABLEKS                       R2 R2 K1 ["findWrapLayerChanged"]
       10 CALL                             R2 0 2
       11 MOVE                             R0 R2
       12 MOVE                             R1 R3
       13 JUMPIFNOT                        R0 ; [+41]
       ...
       16 LOADN                            R4 1
       17 GETUPVAL                         R6 0
       18 GETTABLEKS                       R6 R6 K3 ["orderedLayers"]
       20 LENGTH                           R5 R6
       ...
       29 RETURN                           R0 0
       30 GETUPVAL                         R3 0
       31 GETTABLEKS                       R3 R3 K7 ["getNewOrderList"]
       33 MOVE                             R4 R0
       34 MOVE                             R5 R1
       35 MOVE                             R6 R2
       36 CALL                             R3 3 1
       37 GETUPVAL                         R4 0
       38 GETTABLEKS                       R4 R4 K8 ["flattenLayerOrders"]
       40 MOVE                             R5 R3
       41 CALL                             R4 1 0
       42 GETUPVAL                         R4 0
       43 GETTABLEKS                       R4 R4 K9 ["updateIdMap"]
       45 CALL                             R4 0 0
       46 GETUPVAL                         R4 0
...
PROTO_4:
       ...
       14 FORGPREP_NEXT                    R1
       15 GETUPVAL                         R8 0
       16 GETTABLEKS                       R8 R8 K1 ["orderedLayers"]
       18 LENGTH                           R7 R8
       19 ADDK                             R6 R7 K4 [1]
       20 SETTABLEKS                       R6 R5 K5 ["Order"]
       22 GETUPVAL                         R7 0
       23 GETTABLEKS                       R7 R7 K1 ["orderedLayers"]
...
PROTO_5:
        0 GETUPVAL                         R3 0
        1 GETTABLEKS                       R3 R3 K0 ["orderedLayers"]
        3 LENGTH                           R2 R3
        4 LOADN                            R3 1
        5 JUMPIFLT                         R0 R3 ; [+4]
        7 ADDK                             R3 R2 K1 [1]
       ...
       17 RETURN                           R0 0
       18 GETUPVAL                         R4 0
       19 GETTABLEKS                       R4 R4 K0 ["orderedLayers"]
       21 ADDK                             R6 R2 K1 [1]
       22 SUB                              R5 R6 R1
       23 GETTABLE                         R3 R4 R5
       24 GETTABLEKS                       R3 R3 K2 ["Order"]
       26 GETUPVAL                         R4 0
       27 GETUPVAL                         R6 0
       28 GETTABLEKS                       R6 R6 K0 ["orderedLayers"]
       30 ADDK                             R8 R2 K1 [1]
       31 SUB                              R7 R8 R0
       ...
       35 GETUPVAL                         R4 0
       36 GETUPVAL                         R5 0
       37 GETTABLEKS                       R5 R5 K3 ["wrapLayerChanged"]
       39 GETTABLEKS                       R5 R5 K2 ["Order"]
       41 SETTABLEKS                       R5 R4 K4 ["wrapLayerOrderBeforeChange"]
       43 GETUPVAL                         R4 0
       44 GETTABLEKS                       R4 R4 K3 ["wrapLayerChanged"]
...
PROTO_6:
       ...
       12 GETUPVAL                         R4 0
       13 GETTABLEKS                       R4 R4 K5 ["previewClothing"]
       15 CALL                             R3 1 3
       ...
       50 GETUPVAL                         R15 0
       51 GETTABLEKS                       R15 R15 K21 ["orderedLayers"]
       53 LENGTH                           R14 R15
...
PROTO_7:
        ...
        7 GETUPVAL                         R1 0
        8 GETTABLEKS                       R1 R1 K3 ["previewClothing"]
       10 CALL                             R0 1 3
       ...
       24 GETUPVAL                         R9 0
       25 GETTABLEKS                       R9 R9 K0 ["mapClothingIdToLayerOrder"]
...
PROTO_8:
        ...
        4 GETUPVAL                         R2 0
        5 GETTABLEKS                       R2 R2 K2 ["mapClothingIdToLayerOrder"]
        7 CALL                             R1 1 3
        8 FORGPREP_NEXT                    R1
...
PROTO_10:
        ...
        5 GETUPVAL                         R3 0
        6 GETTABLEKS                       R3 R3 K2 ["mapClothingIdToLayerOrder"]
        8 CALL                             R2 1 3
        9 FORGPREP_NEXT                    R2
       ...
       22 GETUPVAL                         R3 0
       23 GETTABLEKS                       R3 R3 K8 ["previewClothing"]
       25 CALL                             R2 1 3
       ...
       37 JUMPIFNOT                        R7 ; [+21]
       38 GETUPVAL                         R11 0
       39 GETTABLEKS                       R11 R11 K2 ["mapClothingIdToLayerOrder"]
       41 GETTABLE                         R10 R11 R7
       42 JUMPIFNOT                        R10 ; [+16]
       43 DUPTABLE                         R12 K15 [{"wrap", "order"}]
       44 SETTABLEKS                       R9 R12 K13 ["wrap"]
       46 GETUPVAL                         R14 0
       47 GETTABLEKS                       R14 R14 K2 ["mapClothingIdToLayerOrder"]
       ...
       95 GETUPVAL                         R3 0
       96 GETTABLEKS                       R3 R3 K23 ["flattenLayerOrders"]
       98 MOVE                             R4 R2
       99 CALL                             R3 1 0
      100 GETUPVAL                         R3 0
      101 GETTABLEKS                       R3 R3 K24 ["updateIdMap"]
      103 CALL                             R3 0 0
      104 RETURN                           R0 0
...
PROTO_11:
       ...
       25 GETTABLEKS                       R1 R0 K7 ["props"]
       27 GETTABLEKS                       R1 R1 K8 ["PreviewClothing"]
       29 JUMPIFNOT                        R1 ; [+6]
       30 GETTABLEKS                       R1 R0 K7 ["props"]
       32 GETTABLEKS                       R1 R1 K8 ["PreviewClothing"]
...
PROTO_13:
       ...
       11 GETTABLEKS                       R5 R5 K3 ["Capacity"]
       13 JUMPIFNOTLE                      R4 R5 ; [+2]
       15 RETURN                           R0 0
       16 GETTABLEKS                       R4 R0 K4 ["getOrderedIdList"]
       18 CALL                             R4 0 1
       19 GETTABLEKS                       R5 R0 K2 ["props"]
       21 GETTABLEKS                       R5 R5 K5 ["EditingItemContext"]
       ...
       39 GETTABLEKS                       R7 R7 K9 ["OnCapacityReached"]
...
PROTO_18:
       ...
       16 CALL                             R8 0 1
       17 GETUPVAL                         R9 0
       18 GETTABLEKS                       R9 R9 K8 ["createElement"]
       20 GETUPVAL                         R10 1
...
MAIN:
       ...
       21 GETTABLEKS                       R5 R0 K7 ["Contexts"]
       23 GETTABLEKS                       R5 R5 K8 ["EditingItemContext"]
       25 CALL                             R4 1 1
       26 GETIMPORT                        R5 K4 [require]
       28 GETTABLEKS                       R6 R0 K9 ["Util"]
       30 GETTABLEKS                       R6 R6 K10 ["AccessoryAndBodyToolShared"]
       32 GETTABLEKS                       R6 R6 K11 ["Constants"]
       34 CALL                             R5 1 1
       ...
       44 GETTABLEKS                       R9 R6 K15 ["UI"]
       46 GETTABLEKS                       R9 R9 K16 ["DraggableTileList"]
