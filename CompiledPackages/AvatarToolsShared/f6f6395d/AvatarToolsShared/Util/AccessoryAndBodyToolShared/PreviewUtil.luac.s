...
PROTO_4:
       ...
       36 MOVE                             R12 R4
       37 GETUPVAL                         R13 2
       38 GETTABLEKS                       R13 R13 K8 ["new"]
       40 MOVE                             R14 R10
       41 MOVE                             R15 R2
       42 MOVE                             R16 R9
       43 CALL                             R13 3 -1
       44 FASTCALL                         TABLE_INSERT ; [+2]
       45 GETIMPORT                        R11 K11 [table.insert]
       47 CALL                             R11 -1 0
       48 FORGLOOP                         R5 2 [inext] ; [-42]
       50 RETURN                           R4 1
...
PROTO_5:
       ...
       38 CALL                             R14 3 1
       39 GETUPVAL                         R17 2
       40 GETTABLEKS                       R17 R17 K8 ["new"]
       42 MOVE                             R18 R14
       43 LOADB                            R19 1
       44 MOVE                             R20 R13
       45 CALL                             R17 3 -1
       46 NAMECALL                         R15 R8 K9 ["addLayer"]
       48 CALL                             R15 -1 0
       49 FORGLOOP                         R9 2 [inext] ; [-40]
       51 FORGLOOP                         R4 2 [inext] ; [-47]
       53 RETURN                           R0 0
...
PROTO_7:
        ...
        9 FORGPREP_INEXT                   R8
       10 GETUPVAL                         R13 0
       11 GETTABLEKS                       R13 R13 K2 ["addPreviewClothingFromInstance"]
       13 MOVE                             R14 R7
