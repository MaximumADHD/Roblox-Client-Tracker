...
PROTO_36:
  ...
  DIV R8 R6 R7
  LOADN R9 244
  JUMPIFNOTLT R9 R7 [+40]
  GETUPVAL R11 0
  GETTABLEKS R10 R11 K22 ["_scrollMetrics"]
  GETTABLEKS R9 R10 K36 ["dt"]
  LOADN R10 244
  JUMPIFNOTLT R10 R9 [+32]
  LOADN R10 5
  MUL R9 R10 R3
  JUMPIFNOTLT R9 R4 [+28]
  GETUPVAL R11 0
  GETTABLEKS R10 R11 K37 ["_hasWarned"]
  GETTABLEKS R9 R10 K38 ["perf"]
  JUMPIF R9 [+21]
  GETUPVAL R9 2
  LOADK R10 K39 ["VirtualizedList: You have a large list that is slow to update - make sure your renderItem function renders components that follow React performance best practices like PureComponent, shouldComponentUpdate, etc."]
  DUPTABLE R11 K41 [{"dt", "prevDt", "contentLength"}]
  SETTABLEKS R7 R11 K36 ["dt"]
  GETUPVAL R14 0
  GETTABLEKS R13 R14 K22 ["_scrollMetrics"]
  GETTABLEKS R12 R13 K36 ["dt"]
  SETTABLEKS R12 R11 K40 ["prevDt"]
  ...
  GETUPVAL R9 0
  DUPTABLE R10 K43 [{"contentLength", "dt", "dOffset", "offset", "timestamp", "velocity", "visibleLength"}]
  ...
  SETTABLEKS R8 R10 K42 ["velocity"]
  SETTABLEKS R3 R10 K28 ["visibleLength"]
  SETTABLEKS R10 R9 K22 ["_scrollMetrics"]
  GETUPVAL R11 0
  GETTABLEKS R10 R11 K44 ["state"]
  GETTABLEKS R9 R10 K45 ["scrollPositionDelta"]
  LOADN R10 0
  JUMPIFNOTLT R10 R9 [+7]
  GETUPVAL R10 0
  NEWCLOSURE R12 P1
  CAPTURE VAL R9
  NAMECALL R10 R10 K46 ["setState"]
  CALL R10 2 0
  GETUPVAL R10 0
  GETUPVAL R14 0
  GETTABLEKS R13 R14 K2 ["props"]
  GETTABLEKS R12 R13 K47 ["data"]
  NAMECALL R10 R10 K48 ["_updateViewableItems"]
  CALL R10 2 0
  GETUPVAL R11 0
  ...
  RETURN R0 0
  GETUPVAL R10 0
  NAMECALL R10 R10 K49 ["_maybeCallOnEndReached"]
  CALL R10 1 0
  JUMPIFEQKN R8 K26 [0] [+7]
  GETUPVAL R11 0
  GETTABLEKS R10 R11 K50 ["_fillRateHelper"]
  NAMECALL R10 R10 K51 ["activate"]
  CALL R10 1 0
  GETUPVAL R10 0
  NAMECALL R10 R10 K52 ["_computeBlankness"]
  CALL R10 1 0
  GETUPVAL R10 0
  NAMECALL R10 R10 K53 ["_scheduleCellsToRenderUpdate"]
  CALL R10 1 0
  RETURN R0 0
...
PROTO_49:
  ...
  LOADK R7 K17 ["No scrollTo method provided. This may be because you have two nested VirtualizedLists with the same orientation, or because you are using a custom component that does not implement scrollTo."]
  CALL R6 1 0
  RETURN R0 0
  GETTABLEKS R7 R0 K14 ["_scrollRef"]
  GETTABLEKS R6 R7 K15 ["scrollTo"]
  GETTABLEKS R10 R0 K1 ["props"]
  GETTABLEKS R9 R10 K18 ["horizontal"]
  JUMPIFNOTEQKNIL R9 [+3]
  LOADB R8 0
  JUMP [+1]
  MOVE R8 R9
  JUMPIFNOT R8 [+6]
  DUPTABLE R7 K20 [{"x", "animated"}]
  SETTABLEKS R5 R7 K19 ["x"]
  SETTABLEKS R2 R7 K0 ["animated"]
  JUMP [+5]
  DUPTABLE R7 K22 [{"y", "animated"}]
  SETTABLEKS R5 R7 K21 ["y"]
  SETTABLEKS R2 R7 K0 ["animated"]
  CALL R6 1 0
  RETURN R0 0
...
PROTO_50:
  ...
  JUMPIFNOTLT R11 R8 [+23]
  GETUPVAL R11 0
  GETUPVAL R13 1
  GETTABLEKS R12 R13 K15 ["toJSBoolean"]
  MOVE R13 R6
  CALL R12 1 1
  LOADK R13 K16 ["scrollToIndex should be used in conjunction with getItemLayout or onScrollToIndexFailed, otherwise there is no way to know the location of offscreen indices or handle failures."]
  CALL R11 2 0
  MOVE R11 R6
  DUPTABLE R12 K19 [{"averageItemLength", "highestMeasuredFrameIndex", "index"}]
  GETTABLEKS R13 R0 K20 ["_averageCellLength"]
  SETTABLEKS R13 R12 K17 ["averageItemLength"]
  GETTABLEKS R13 R0 K14 ["_highestMeasuredFrameIndex"]
  SETTABLEKS R13 R12 K18 ["highestMeasuredFrameIndex"]
  SETTABLEKS R8 R12 K7 ["index"]
  CALL R11 1 0
  RETURN R0 0
  NAMECALL R12 R0 K21 ["getScrollRef"]
  CALL R12 1 1
  JUMPIFNOT R12 [+8]
  NAMECALL R13 R0 K21 ["getScrollRef"]
  CALL R13 1 1
  GETTABLEKS R12 R13 K22 ["_nativeRef"]
  GETTABLEKS R11 R12 K23 ["current"]
  JUMP [+1]
  LOADNIL R11
  JUMPIFNOTEQKNIL R11 [+2]
  RETURN R0 0
  GETTABLEKS R12 R11 K24 ["AbsoluteCanvasSize"]
  GETTABLEKS R13 R11 K25 ["AbsoluteSize"]
  GETTABLEKS R14 R0 K26 ["_getFrameMetricsApprox"]
  MOVE R15 R8
  CALL R14 1 1
  LOADN R17 0
  GETTABLEKS R20 R0 K0 ["props"]
  GETTABLEKS R19 R20 K27 ["inverted"]
  JUMPIFNOT R19 [+35]
  JUMPIFNOT R3 [+3]
  GETTABLEKS R21 R12 K28 ["X"]
  JUMP [+2]
  GETTABLEKS R21 R12 K29 ["Y"]
  JUMPIFNOT R3 [+3]
  GETTABLEKS R22 R13 K28 ["X"]
  JUMP [+2]
  GETTABLEKS R22 R13 K29 ["Y"]
  SUB R20 R21 R22
  GETTABLEKS R21 R14 K30 ["offset"]
  SUB R19 R20 R21
  GETUPVAL R23 1
  ...
  JUMPIF R21 [+1]
  LOADN R21 0
  GETTABLEKS R24 R0 K31 ["_scrollMetrics"]
  GETTABLEKS R23 R24 K32 ["visibleLength"]
  GETTABLEKS R24 R14 K33 ["length"]
  SUB R22 R23 R24
  MUL R20 R21 R22
  SUB R18 R19 R20
  JUMP [+20]
  GETTABLEKS R19 R14 K30 ["offset"]
  GETUPVAL R23 1
  GETTABLEKS R22 R23 K15 ["toJSBoolean"]
  MOVE R23 R10
  CALL R22 1 1
  ...
  LOADN R17 0
  SUB R15 R16 R17
  GETTABLEKS R16 R0 K37 ["_scrollRef"]
  JUMPIFNOTEQKNIL R16 [+2]
  RETURN R0 0
  GETTABLEKS R17 R0 K37 ["_scrollRef"]
  GETTABLEKS R16 R17 K38 ["scrollTo"]
  JUMPIFNOTEQKNIL R16 [+7]
  GETUPVAL R17 2
  GETTABLEKS R16 R17 K39 ["warn"]
  LOADK R17 K40 ["No scrollTo method provided. This may be because you have two nested VirtualizedLists with the same orientation, or because you are using a custom component that does not implement scrollTo."]
  CALL R16 1 0
  RETURN R0 0
  GETTABLEKS R17 R0 K37 ["_scrollRef"]
  GETTABLEKS R16 R17 K38 ["scrollTo"]
  JUMPIFNOT R3 [+6]
  DUPTABLE R17 K42 [{"x", "animated"}]
  SETTABLEKS R15 R17 K41 ["x"]
  SETTABLEKS R7 R17 K6 ["animated"]
  JUMP [+5]
  DUPTABLE R17 K44 [{"y", "animated"}]
  SETTABLEKS R15 R17 K43 ["y"]
  SETTABLEKS R7 R17 K6 ["animated"]
  CALL R16 1 0
  RETURN R0 0
...
PROTO_52:
  ...
  LOADK R6 K15 ["No scrollTo method provided. This may be because you have two nested VirtualizedLists with the same orientation, or because you are using a custom component that does not implement scrollTo."]
  CALL R5 1 0
  RETURN R0 0
  GETTABLEKS R6 R0 K5 ["_scrollRef"]
  GETTABLEKS R5 R6 K13 ["scrollTo"]
  ...
  MOVE R7 R8
  JUMPIFNOT R7 [+6]
  DUPTABLE R6 K17 [{"x", "animated"}]
  SETTABLEKS R4 R6 K16 ["x"]
  SETTABLEKS R3 R6 K3 ["animated"]
  JUMP [+5]
  DUPTABLE R6 K19 [{"y", "animated"}]
  SETTABLEKS R4 R6 K18 ["y"]
  SETTABLEKS R3 R6 K3 ["animated"]
  CALL R5 1 0
  RETURN R0 0
...
PROTO_69:
  ...
  CALL R16 2 1
  LOADB R17 1
  SETTABLEKS R17 R16 K19 ["shouldResizeOnMount"]
  FORNLOOP R13
  DUPTABLE R13 K21 [{"first", "last", "firstItemTracked", "scrollPositionDelta"}]
  SETTABLEKS R12 R13 K11 ["first"]
  LOADN R15 1
  GETTABLEKS R17 R1 K20 ["last"]
  ...
  CALL R14 2 1
  SETTABLEKS R14 R13 K20 ["last"]
  MOVE R14 R8
  JUMPIF R14 [+3]
  GETUPVAL R15 1
  GETTABLEKS R14 R15 K22 ["None"]
...
PROTO_77:
  ...
  LOADK R2 K6 ["VirtualizedLists should never be nested inside plain ScrollViews with the same orientation because it can break windowing and other functionality - use another VirtualizedList-backed container instead."]
  CALL R1 1 0
  GETUPVAL R2 0
...
PROTO_78:
  ...
  JUMPIFNOTEQKS R2 K6 ["wrap"] [+6]
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K7 ["warn"]
  LOADK R3 K8 ["`flexWrap: `wrap`` is not supported with the `VirtualizedList` components.Consider using `numColumns` with `FlatList` instead."]
  CALL R2 1 0
  GETTABLEKS R4 R0 K3 ["props"]
  GETTABLEKS R1 R4 K9 ["ListEmptyComponent"]
  GETTABLEKS R4 R0 K3 ["props"]
  GETTABLEKS R2 R4 K10 ["ListFooterComponent"]
  GETTABLEKS R4 R0 K3 ["props"]
  GETTABLEKS R3 R4 K11 ["ListHeaderComponent"]
  GETTABLEKS R6 R0 K3 ["props"]
  GETTABLEKS R4 R6 K12 ["data"]
  GETTABLEKS R6 R0 K3 ["props"]
  GETTABLEKS R5 R6 K13 ["horizontal"]
  NAMECALL R6 R0 K14 ["_isVirtualizationDisabled"]
  CALL R6 1 1
  GETTABLEKS R9 R0 K3 ["props"]
  GETTABLEKS R8 R9 K15 ["inverted"]
  JUMPIFNOT R8 [+18]
  GETTABLEKS R10 R0 K3 ["props"]
  GETTABLEKS R9 R10 K13 ["horizontal"]
  JUMPIFNOTEQKNIL R9 [+3]
  LOADB R8 0
  JUMP [+1]
  MOVE R8 R9
  JUMPIFNOT R8 [+4]
  GETUPVAL R8 2
  GETTABLEKS R7 R8 K16 ["horizontallyInverted"]
  JUMP [+5]
  GETUPVAL R8 2
  GETTABLEKS R7 R8 K17 ["verticallyInverted"]
  JUMP [+1]
  LOADNIL R7
  NEWTABLE R8 0 0
  GETUPVAL R10 3
  ...
  GETTABLEKS R10 R11 K19 ["stickyHeaderIndices"]
  CALL R9 1 1
  NEWTABLE R10 0 0
  JUMPIFNOT R3 [+112]
  LOADN R13 0
  NAMECALL R11 R9 K20 ["has"]
  CALL R11 2 1
  JUMPIFNOT R11 [+7]
  FASTCALL2K TABLE_INSERT R10 K21 [+5]
  MOVE R12 R10
  LOADK R13 K21 [0]
  GETIMPORT R11 K24 [table.insert]
  CALL R11 2 0
  GETUPVAL R13 4
  GETTABLEKS R12 R13 K25 ["isValidElement"]
  MOVE R13 R3
  CALL R12 1 1
  JUMPIFNOT R12 [+2]
  MOVE R11 R3
  ...
  GETUPVAL R15 5
  DUPTABLE R16 K30 [{"cellKey", "key", "Name"}]
  NAMECALL R20 R0 K31 ["_getCellKey"]
  CALL R20 1 1
  MOVE R18 R20
  LOADK R19 K32 ["-header"]
  CONCAT R17 R18 R19
  SETTABLEKS R17 R16 K27 ["cellKey"]
  LOADK R17 K33 ["$header"]
  SETTABLEKS R17 R16 K28 ["key"]
  LOADK R17 K33 ["$header"]
  SETTABLEKS R17 R16 K29 ["Name"]
  GETUPVAL R18 4
  GETTABLEKS R17 R18 K26 ["createElement"]
  GETUPVAL R18 6
  DUPTABLE R19 K39 [{"Name", "onLayout", "style", "LayoutOrder", "AutomaticSize", "Size"}]
  LOADK R20 K11 ["ListHeaderComponent"]
  SETTABLEKS R20 R19 K29 ["Name"]
  GETTABLEKS R20 R0 K40 ["_onLayoutHeader"]
  SETTABLEKS R20 R19 K34 ["onLayout"]
  GETUPVAL R21 7
  GETTABLEKS R20 R21 K41 ["compose"]
  MOVE R21 R7
  GETTABLEKS R23 R0 K3 ["props"]
  GETTABLEKS R22 R23 K42 ["ListHeaderComponentStyle"]
  CALL R20 2 1
  SETTABLEKS R20 R19 K35 ["style"]
  GETTABLEKS R22 R0 K3 ["props"]
  GETTABLEKS R21 R22 K15 ["inverted"]
  JUMPIFNOT R21 [+2]
  LOADK R20 K43 [999999998]
  JUMP [+1]
  LOADK R20 K44 [-999999998]
  SETTABLEKS R20 R19 K36 ["LayoutOrder"]
  JUMPIFNOT R5 [+3]
  GETIMPORT R20 K47 [Enum.AutomaticSize.X]
  JUMP [+2]
  GETIMPORT R20 K49 [Enum.AutomaticSize.Y]
  ...
  GETTABLEKS R11 R12 K52 ["getItemCount"]
  MOVE R12 R4
  CALL R11 1 1
  LOADN R12 0
  JUMPIFNOTLT R12 R11 [+402]
  LOADB R12 0
  SETUPVAL R12 8
  LOADK R12 K53 [""]
  SETUPVAL R12 9
  GETTABLEKS R12 R0 K54 ["_getSpacerKey"]
  NOT R13 R5
  CALL R12 1 1
  GETTABLEKS R17 R0 K3 ["props"]
  GETTABLEKS R16 R17 K56 ["initialScrollIndex"]
  LOADB R15 0
  JUMPIFEQKNIL R16 [+5]
  JUMPIFNOTEQKN R16 K55 [1] [+2]
  LOADB R15 0 +1
  LOADB R15 1
  JUMPIFNOT R15 [+2]
  LOADN R14 255
  JUMP [+10]
  GETTABLEKS R17 R0 K3 ["props"]
  GETTABLEKS R16 R17 K57 ["initialNumToRender"]
  ...
  SUBK R14 R15 K55 [1]
  ADDK R13 R14 K55 [1]
  GETTABLEKS R17 R0 K58 ["state"]
  GETTABLEKS R14 R17 K59 ["first"]
  GETTABLEKS R17 R0 K58 ["state"]
  GETTABLEKS R15 R17 K60 ["last"]
  GETTABLEKS R17 R0 K58 ["state"]
  GETTABLEKS R16 R17 K61 ["scrollPositionDelta"]
  LOADN R17 0
  ...
  MOVE R23 R13
  MOVE R24 R7
  NAMECALL R17 R0 K62 ["_pushCells"]
  CALL R17 7 0
  ADDK R18 R13 K55 [1]
  FASTCALL2 MATH_MAX R18 R14 [+4]
  MOVE R19 R14
  GETIMPORT R17 K65 [math.max]
  CALL R17 2 1
  JUMPIF R6 [+220]
  ADDK R18 R13 K55 [1]
  JUMPIFNOTLT R18 R14 [+218]
  LOADB R18 0
  GETTABLEKS R19 R9 K66 ["size"]
  LOADN R20 0
  ...
  ADD R23 R20 R19
  NAMECALL R21 R9 K20 ["has"]
  CALL R21 2 1
  JUMPIFNOT R21 [+131]
  GETTABLEKS R21 R0 K67 ["_getFrameMetricsApprox"]
  MOVE R22 R13
  CALL R21 1 1
  GETTABLEKS R22 R0 K67 ["_getFrameMetricsApprox"]
  MOVE R23 R20
  CALL R22 1 1
  GETTABLEKS R25 R22 K68 ["offset"]
  GETTABLEKS R26 R21 K68 ["offset"]
  SUB R24 R25 R26
  GETTABLEKS R28 R0 K3 ["props"]
  GETTABLEKS R27 R28 K56 ["initialScrollIndex"]
  LOADB R26 0
  JUMPIFEQKNIL R27 [+5]
  JUMPIFNOTEQKN R27 K55 [1] [+2]
  LOADB R26 0 +1
  LOADB R26 1
  JUMPIFNOT R26 [+2]
  LOADN R25 0
  JUMP [+2]
  GETTABLEKS R25 R21 K69 ["length"]
  SUB R23 R24 R25
  MOVE R25 R8
  GETUPVAL R27 4
  GETTABLEKS R26 R27 K26 ["createElement"]
  GETUPVAL R27 6
  DUPTABLE R28 K70 [{"key", "Name", "style"}]
  LOADK R29 K71 ["$sticky_lead"]
  SETTABLEKS R29 R28 K28 ["key"]
  LOADK R29 K71 ["$sticky_lead"]
  SETTABLEKS R29 R28 K29 ["Name"]
  DUPTABLE R29 K72 [{"Size"}]
  JUMPIFNOTEQKS R12 K73 ["height"] [+9]
  GETIMPORT R30 K51 [UDim2.new]
  LOADN R31 1
  LOADN R32 0
  LOADN R33 0
  MOVE R34 R23
  ...
  SETTABLEKS R29 R28 K35 ["style"]
  CALL R26 2 -1
  FASTCALL TABLE_INSERT [+2]
  GETIMPORT R24 K24 [table.insert]
  CALL R24 -1 0
  MOVE R26 R8
  MOVE R27 R10
  MOVE R28 R9
  ...
  MOVE R30 R20
  MOVE R31 R7
  NAMECALL R24 R0 K62 ["_pushCells"]
  CALL R24 7 0
  GETTABLEKS R27 R0 K67 ["_getFrameMetricsApprox"]
  MOVE R28 R14
  CALL R27 1 1
  GETTABLEKS R26 R27 K68 ["offset"]
  GETTABLEKS R27 R22 K68 ["offset"]
  SUB R25 R26 R27
  GETTABLEKS R26 R22 K69 ["length"]
  ADD R24 R25 R26
  MOVE R26 R8
  GETUPVAL R28 4
  GETTABLEKS R27 R28 K26 ["createElement"]
  GETUPVAL R28 6
  DUPTABLE R29 K70 [{"key", "Name", "style"}]
  LOADK R30 K74 ["$sticky_trail"]
  SETTABLEKS R30 R29 K28 ["key"]
  LOADK R30 K74 ["$sticky_trail"]
  SETTABLEKS R30 R29 K29 ["Name"]
  DUPTABLE R30 K72 [{"Size"}]
  JUMPIFNOTEQKS R12 K73 ["height"] [+9]
  ...
  JUMPBACK [-140]
  JUMPIF R18 [+65]
  GETTABLEKS R19 R0 K67 ["_getFrameMetricsApprox"]
  MOVE R20 R13
  CALL R19 1 1
  GETTABLEKS R22 R0 K67 ["_getFrameMetricsApprox"]
  MOVE R23 R14
  ...
  GETTABLEKS R23 R19 K68 ["offset"]
  GETTABLEKS R24 R19 K69 ["length"]
  ADD R22 R23 R24
  SUB R20 R21 R22
  MOVE R22 R8
  GETUPVAL R24 4
  ...
  GETUPVAL R24 6
  DUPTABLE R25 K75 [{"key", "Name", "style", "LayoutOrder"}]
  LOADK R26 K76 ["$lead_spacer"]
  SETTABLEKS R26 R25 K28 ["key"]
  LOADK R26 K76 ["$lead_spacer"]
  SETTABLEKS R26 R25 K29 ["Name"]
  DUPTABLE R26 K72 [{"Size"}]
  JUMPIFNOTEQKS R12 K73 ["height"] [+9]
  ...
  GETTABLEKS R28 R0 K3 ["props"]
  GETTABLEKS R27 R28 K15 ["inverted"]
  JUMPIFNOT R27 [+2]
  LOADK R26 K77 [999999999]
  JUMP [+1]
  LOADK R26 K78 [-999999999]
  SETTABLEKS R26 R25 K36 ["LayoutOrder"]
  CALL R23 2 -1
  FASTCALL TABLE_INSERT [+2]
  GETIMPORT R21 K24 [table.insert]
  CALL R21 -1 0
  MOVE R20 R8
  MOVE R21 R10
  MOVE R22 R9
  ...
  MOVE R24 R15
  MOVE R25 R7
  NAMECALL R18 R0 K62 ["_pushCells"]
  CALL R18 7 0
  GETTABLEKS R19 R0 K79 ["_hasWarned"]
  GETTABLEKS R18 R19 K80 ["keys"]
  JUMPIF R18 [+13]
  GETUPVAL R18 8
  JUMPIFNOT R18 [+11]
  GETUPVAL R19 1
  GETTABLEKS R18 R19 K7 ["warn"]
  LOADK R19 K81 ["VirtualizedList: missing keys for items, make sure to specify a key or id property on each item or provide a custom keyExtractor."]
  GETUPVAL R20 9
  CALL R18 2 0
  GETTABLEKS R18 R0 K79 ["_hasWarned"]
  LOADB R19 1
  SETTABLEKS R19 R18 K80 ["keys"]
  JUMPIF R6 [+134]
  JUMPIFNOTLT R15 R11 [+133]
  GETTABLEKS R18 R0 K67 ["_getFrameMetricsApprox"]
  MOVE R19 R15
  CALL R18 1 1
  GETTABLEKS R21 R0 K3 ["props"]
  GETTABLEKS R20 R21 K82 ["getItemLayout"]
  JUMPIFNOT R20 [+2]
  MOVE R19 R11
  JUMP [+8]
  GETTABLEKS R21 R0 K83 ["_highestMeasuredFrameIndex"]
  FASTCALL2 MATH_MIN R11 R21 [+4]
  MOVE R20 R11
  GETIMPORT R19 K85 [math.min]
  CALL R19 2 1
  GETTABLEKS R20 R0 K67 ["_getFrameMetricsApprox"]
  MOVE R21 R19
  CALL R20 1 1
  GETTABLEKS R23 R20 K68 ["offset"]
  GETTABLEKS R24 R20 K69 ["length"]
  ADD R22 R23 R24
  GETTABLEKS R24 R18 K68 ["offset"]
  GETTABLEKS R25 R18 K69 ["length"]
  ADD R23 R24 R25
  SUB R21 R22 R23
  MOVE R23 R8
  GETUPVAL R25 4
  ...
  GETUPVAL R25 6
  DUPTABLE R26 K75 [{"key", "Name", "style", "LayoutOrder"}]
  LOADK R27 K86 ["$tail_spacer"]
  SETTABLEKS R27 R26 K28 ["key"]
  LOADK R27 K86 ["$tail_spacer"]
  SETTABLEKS R27 R26 K29 ["Name"]
  DUPTABLE R27 K72 [{"Size"}]
  JUMPIFNOTEQKS R12 K73 ["height"] [+9]
  GETIMPORT R28 K51 [UDim2.new]
  LOADN R29 1
  LOADN R30 0
  LOADN R31 0
  MOVE R32 R21
  ...
  LOADN R32 0
  CALL R28 4 1
  SETTABLEKS R28 R27 K38 ["Size"]
  SETTABLEKS R27 R26 K35 ["style"]
  GETTABLEKS R29 R0 K3 ["props"]
  GETTABLEKS R28 R29 K15 ["inverted"]
  JUMPIFNOT R28 [+2]
  LOADK R27 K78 [-999999999]
  JUMP [+1]
  LOADK R27 K77 [999999999]
  ...
  JUMPIFNOT R1 [+47]
  GETUPVAL R14 4
  GETTABLEKS R13 R14 K25 ["isValidElement"]
  MOVE R14 R1
  CALL R13 1 1
  JUMPIFNOT R13 [+2]
  MOVE R12 R1
  ...
  MOVE R14 R8
  GETUPVAL R16 4
  GETTABLEKS R15 R16 K87 ["cloneElement"]
  MOVE R16 R12
  DUPTABLE R17 K88 [{"key", "Name", "onLayout", "style"}]
  LOADK R18 K89 ["$empty"]
  ...
  CAPTURE VAL R0
  CAPTURE VAL R12
  SETTABLEKS R18 R17 K34 ["onLayout"]
  GETUPVAL R19 7
  GETTABLEKS R18 R19 K41 ["compose"]
  MOVE R19 R7
  GETTABLEKS R21 R12 K3 ["props"]
  GETTABLEKS R20 R21 K35 ["style"]
  CALL R18 2 1
  ...
  GETUPVAL R16 5
  DUPTABLE R17 K30 [{"cellKey", "key", "Name"}]
  NAMECALL R18 R0 K90 ["_getFooterCellKey"]
  CALL R18 1 1
  SETTABLEKS R18 R17 K27 ["cellKey"]
  LOADK R18 K91 ["$footer"]
  SETTABLEKS R18 R17 K28 ["key"]
  LOADK R18 K91 ["$footer"]
  SETTABLEKS R18 R17 K29 ["Name"]
  GETUPVAL R19 4
  ...
  GETUPVAL R19 6
  DUPTABLE R20 K39 [{"Name", "onLayout", "style", "LayoutOrder", "AutomaticSize", "Size"}]
  LOADK R21 K10 ["ListFooterComponent"]
  SETTABLEKS R21 R20 K29 ["Name"]
  GETTABLEKS R21 R0 K92 ["_onLayoutFooter"]
  SETTABLEKS R21 R20 K34 ["onLayout"]
  GETUPVAL R22 7
  GETTABLEKS R21 R22 K41 ["compose"]
  MOVE R22 R7
  GETTABLEKS R24 R0 K3 ["props"]
  GETTABLEKS R23 R24 K93 ["ListFooterComponentStyle"]
  CALL R21 2 1
  SETTABLEKS R21 R20 K35 ["style"]
  GETTABLEKS R23 R0 K3 ["props"]
  GETTABLEKS R22 R23 K15 ["inverted"]
  JUMPIFNOT R22 [+2]
  LOADK R21 K44 [-999999998]
  JUMP [+1]
  LOADK R21 K43 [999999998]
  SETTABLEKS R21 R20 K36 ["LayoutOrder"]
  JUMPIFNOT R5 [+3]
  GETIMPORT R21 K47 [Enum.AutomaticSize.X]
  JUMP [+2]
  ...
  GETTABLEKS R12 R13 K15 ["inverted"]
  JUMPIFNOT R12 [+276]
  GETTABLEKS R13 R0 K3 ["props"]
  GETTABLEKS R12 R13 K82 ["getItemLayout"]
  JUMPIF R12 [+271]
  NAMECALL R12 R0 K94 ["getScrollRef"]
  CALL R12 1 1
  JUMPIFEQKNIL R12 [+222]
  NAMECALL R14 R0 K94 ["getScrollRef"]
  CALL R14 1 1
  GETTABLEKS R13 R14 K95 ["_nativeRef"]
  GETTABLEKS R12 R13 K96 ["current"]
  JUMPIFEQKNIL R12 [+213]
  NAMECALL R14 R0 K94 ["getScrollRef"]
  CALL R14 1 1
  GETTABLEKS R13 R14 K95 ["_nativeRef"]
  GETTABLEKS R12 R13 K96 ["current"]
  GETTABLEKS R13 R12 K97 ["CanvasPosition"]
  GETTABLEKS R14 R0 K67 ["_getFrameMetricsApprox"]
  GETTABLEKS R16 R0 K83 ["_highestMeasuredFrameIndex"]
  FASTCALL2 MATH_MIN R16 R11 [+4]
  MOVE R17 R11
  GETIMPORT R15 K85 [math.min]
  CALL R15 2 1
  CALL R14 1 1
  GETTABLEKS R16 R14 K68 ["offset"]
  GETTABLEKS R17 R14 K69 ["length"]
  ADD R15 R16 R17
  GETTABLEKS R18 R0 K3 ["props"]
  GETTABLEKS R17 R18 K98 ["optimizeInvertedCanvasResize"]
  JUMPIFNOT R17 [+10]
  GETTABLEKS R18 R0 K99 ["_invertedCanvasLength"]
  GETTABLEKS R19 R0 K100 ["_footerLength"]
  SUB R17 R18 R19
  JUMPIFLT R17 R15 [+2]
  LOADB R16 0 +1
  LOADB R16 1
  ...
  LOADB R16 0 +1
  LOADB R16 1
  GETTABLEKS R17 R0 K83 ["_highestMeasuredFrameIndex"]
  ...
  GETTABLEKS R19 R0 K100 ["_footerLength"]
  ADD R18 R15 R19
  GETTABLEKS R19 R0 K99 ["_invertedCanvasLength"]
  SUB R17 R18 R19
  GETTABLEKS R19 R0 K100 ["_footerLength"]
  ADD R18 R15 R19
  SETTABLEKS R18 R0 K99 ["_invertedCanvasLength"]
  GETTABLEKS R20 R0 K3 ["props"]
  GETTABLEKS R19 R20 K13 ["horizontal"]
  JUMPIFNOT R19 [+9]
  GETIMPORT R18 K51 [UDim2.new]
  LOADN R19 0
  GETTABLEKS R20 R0 K99 ["_invertedCanvasLength"]
  LOADN R21 1
  LOADN R22 0
  CALL R18 4 1
  JUMP [+8]
  ...
  LOADN R20 0
  LOADN R21 0
  GETTABLEKS R22 R0 K99 ["_invertedCanvasLength"]
  CALL R18 4 1
  SETTABLEKS R18 R12 K101 ["CanvasSize"]
  GETTABLEKS R21 R0 K3 ["props"]
  GETTABLEKS R20 R21 K13 ["horizontal"]
  JUMPIFNOT R20 [+9]
  GETIMPORT R19 K103 [Vector2.new]
  GETTABLEKS R21 R13 K46 ["X"]
  ADD R20 R21 R17
  GETTABLEKS R21 R13 K48 ["Y"]
  CALL R19 2 1
  JUMP [+8]
  GETIMPORT R19 K103 [Vector2.new]
  GETTABLEKS R20 R13 K46 ["X"]
  GETTABLEKS R22 R13 K48 ["Y"]
  ADD R21 R22 R17
  CALL R19 2 1
  SETTABLEKS R19 R0 K104 ["_canvasPosition"]
  SETTABLEKS R18 R0 K105 ["_canvasSize"]
  JUMP [+216]
  JUMPIFNOT R16 [+215]
  GETTABLEKS R18 R0 K58 ["state"]
  GETTABLEKS R17 R18 K61 ["scrollPositionDelta"]
  JUMPIFNOTEQKN R17 K21 [0] [+210]
  GETTABLEKS R17 R0 K99 ["_invertedCanvasLength"]
  GETTABLEKS R21 R0 K107 ["_scrollMetrics"]
  GETTABLEKS R20 R21 K108 ["visibleLength"]
  GETTABLEKS R23 R0 K3 ["props"]
  GETTABLEKS R22 R23 K109 ["windowSize"]
  JUMPIFNOTEQKNIL R22 [+3]
  LOADN R21 21
  JUMP [+1]
  MOVE R21 R22
  MUL R19 R20 R21
  MULK R18 R19 K106 [0.5]
  GETTABLEKS R21 R14 K68 ["offset"]
  GETTABLEKS R23 R0 K107 ["_scrollMetrics"]
  GETTABLEKS R22 R23 K108 ["visibleLength"]
  ADD R20 R21 R22
  ADD R19 R20 R18
  SUB R20 R19 R17
  SETTABLEKS R19 R0 K99 ["_invertedCanvasLength"]
  GETTABLEKS R23 R0 K3 ["props"]
  GETTABLEKS R22 R23 K13 ["horizontal"]
  JUMPIFNOT R22 [+9]
  GETIMPORT R21 K51 [UDim2.new]
  LOADN R22 0
  GETTABLEKS R23 R0 K99 ["_invertedCanvasLength"]
  LOADN R24 1
  LOADN R25 0
  CALL R21 4 1
  JUMP [+8]
  ...
  LOADN R23 0
  LOADN R24 0
  GETTABLEKS R25 R0 K99 ["_invertedCanvasLength"]
  CALL R21 4 1
  SETTABLEKS R21 R12 K101 ["CanvasSize"]
  GETTABLEKS R24 R0 K3 ["props"]
  GETTABLEKS R23 R24 K13 ["horizontal"]
  JUMPIFNOT R23 [+9]
  GETIMPORT R22 K103 [Vector2.new]
  GETTABLEKS R24 R13 K46 ["X"]
  ADD R23 R24 R20
  GETTABLEKS R24 R13 K48 ["Y"]
  CALL R22 2 1
  JUMP [+8]
  GETIMPORT R22 K103 [Vector2.new]
  GETTABLEKS R23 R13 K46 ["X"]
  GETTABLEKS R25 R13 K48 ["Y"]
  ADD R24 R25 R20
  CALL R22 2 1
  SETTABLEKS R22 R12 K97 ["CanvasPosition"]
  GETTABLEKS R22 R12 K97 ["CanvasPosition"]
  SETTABLEKS R22 R0 K104 ["_canvasPosition"]
  SETTABLEKS R21 R0 K105 ["_canvasSize"]
  JUMP [+126]
  GETTABLEKS R14 R0 K3 ["props"]
  GETTABLEKS R13 R14 K13 ["horizontal"]
  JUMPIFNOT R13 [+7]
  GETIMPORT R12 K103 [Vector2.new]
  GETTABLEKS R13 R0 K99 ["_invertedCanvasLength"]
  LOADN R14 0
  CALL R12 2 1
  JUMP [+6]
  GETIMPORT R12 K103 [Vector2.new]
  LOADN R13 0
  GETTABLEKS R14 R0 K99 ["_invertedCanvasLength"]
  CALL R12 2 1
  SETTABLEKS R12 R0 K104 ["_canvasPosition"]
  GETTABLEKS R14 R0 K3 ["props"]
  GETTABLEKS R13 R14 K13 ["horizontal"]
  JUMPIFNOT R13 [+9]
  GETIMPORT R12 K51 [UDim2.new]
  LOADN R13 0
  GETTABLEKS R14 R0 K99 ["_invertedCanvasLength"]
  LOADN R15 1
  LOADN R16 0
  ...
  LOADN R14 0
  LOADN R15 0
  GETTABLEKS R16 R0 K99 ["_invertedCanvasLength"]
  CALL R12 4 1
  SETTABLEKS R12 R0 K105 ["_canvasSize"]
  JUMP [+81]
  GETTABLEKS R13 R0 K3 ["props"]
  GETTABLEKS R12 R13 K15 ["inverted"]
  JUMPIFNOT R12 [+76]
  ...
  GETTABLEKS R12 R13 K82 ["getItemLayout"]
  JUMPIFNOT R12 [+71]
  GETTABLEKS R12 R0 K67 ["_getFrameMetricsApprox"]
  MOVE R13 R11
  CALL R12 1 1
  NAMECALL R13 R0 K94 ["getScrollRef"]
  CALL R13 1 1
  JUMPIFEQKNIL R13 [+56]
  NAMECALL R15 R0 K94 ["getScrollRef"]
  CALL R15 1 1
  GETTABLEKS R14 R15 K95 ["_nativeRef"]
  GETTABLEKS R13 R14 K96 ["current"]
  JUMPIFEQKNIL R13 [+47]
  NAMECALL R15 R0 K94 ["getScrollRef"]
  CALL R15 1 1
  GETTABLEKS R14 R15 K95 ["_nativeRef"]
  GETTABLEKS R13 R14 K96 ["current"]
  GETTABLEKS R14 R13 K97 ["CanvasPosition"]
  GETTABLEKS R15 R0 K99 ["_invertedCanvasLength"]
  GETTABLEKS R17 R12 K68 ["offset"]
  GETTABLEKS R18 R12 K69 ["length"]
  ADD R16 R17 R18
  SETTABLEKS R16 R0 K99 ["_invertedCanvasLength"]
  GETTABLEKS R16 R0 K99 ["_invertedCanvasLength"]
  JUMPIFEQ R15 R16 [+32]
  GETTABLEKS R17 R0 K99 ["_invertedCanvasLength"]
  SUB R16 R17 R15
  GETTABLEKS R19 R0 K3 ["props"]
  GETTABLEKS R18 R19 K13 ["horizontal"]
  JUMPIFNOT R18 [+7]
  GETIMPORT R18 K103 [Vector2.new]
  MOVE R19 R16
  LOADN R20 0
  CALL R18 2 1
  ADD R17 R14 R18
  ...
  CALL R18 2 1
  ADD R17 R14 R18
  SETTABLEKS R17 R13 K97 ["CanvasPosition"]
  JUMP [+7]
  GETTABLEKS R14 R12 K68 ["offset"]
  GETTABLEKS R15 R12 K69 ["length"]
  ADD R13 R14 R15
  SETTABLEKS R13 R0 K99 ["_invertedCanvasLength"]
  GETUPVAL R13 10
  GETTABLEKS R12 R13 K110 ["assign"]
  GETIMPORT R13 K112 [table.clone]
  GETTABLEKS R14 R0 K3 ["props"]
  CALL R13 1 1
  DUPTABLE R14 K123 [{"onContentSizeChange", "onLayout", "onScroll", "onScrollBeginDrag", "onScrollEndDrag", "onMomentumScrollBegin", "onMomentumScrollEnd", "scrollEventThrottle", "invertStickyHeaders", "stickyHeaderIndices", "style", "layoutStyle", "AutomaticCanvasSize", "CanvasSize", "CanvasPosition"}]
  GETTABLEKS R15 R0 K124 ["_onContentSizeChange"]
  SETTABLEKS R15 R14 K113 ["onContentSizeChange"]
  GETTABLEKS R15 R0 K125 ["_onLayout"]
  SETTABLEKS R15 R14 K34 ["onLayout"]
  GETTABLEKS R15 R0 K126 ["_onScroll"]
  SETTABLEKS R15 R14 K114 ["onScroll"]
  GETTABLEKS R15 R0 K127 ["_onScrollBeginDrag"]
  SETTABLEKS R15 R14 K115 ["onScrollBeginDrag"]
  GETTABLEKS R15 R0 K128 ["_onScrollEndDrag"]
  SETTABLEKS R15 R14 K116 ["onScrollEndDrag"]
  GETTABLEKS R15 R0 K129 ["_onMomentumScrollBegin"]
  SETTABLEKS R15 R14 K117 ["onMomentumScrollBegin"]
  GETTABLEKS R15 R0 K130 ["_onMomentumScrollEnd"]
  SETTABLEKS R15 R14 K118 ["onMomentumScrollEnd"]
  GETTABLEKS R17 R0 K3 ["props"]
  GETTABLEKS R16 R17 K119 ["scrollEventThrottle"]
  JUMPIFNOTEQKNIL R16 [+3]
  LOADN R15 50
  JUMP [+1]
  MOVE R15 R16
  SETTABLEKS R15 R14 K119 ["scrollEventThrottle"]
  GETTABLEKS R17 R0 K3 ["props"]
  GETTABLEKS R16 R17 K120 ["invertStickyHeaders"]
  JUMPIFEQKNIL R16 [+6]
  GETTABLEKS R16 R0 K3 ["props"]
  GETTABLEKS R15 R16 K120 ["invertStickyHeaders"]
  JUMP [+4]
  GETTABLEKS R16 R0 K3 ["props"]
  GETTABLEKS R15 R16 K15 ["inverted"]
  SETTABLEKS R15 R14 K120 ["invertStickyHeaders"]
  SETTABLEKS R10 R14 K19 ["stickyHeaderIndices"]
  GETTABLEKS R16 R0 K3 ["props"]
  GETTABLEKS R15 R16 K35 ["style"]
  SETTABLEKS R15 R14 K35 ["style"]
  ORK R15 R7 K131 []
  SETTABLEKS R15 R14 K121 ["layoutStyle"]
  GETTABLEKS R17 R0 K3 ["props"]
  GETTABLEKS R16 R17 K15 ["inverted"]
  JUMPIFNOT R16 [+8]
  GETTABLEKS R17 R0 K3 ["props"]
  GETTABLEKS R16 R17 K82 ["getItemLayout"]
  JUMPIF R16 [+3]
  GETIMPORT R15 K133 [Enum.AutomaticSize.None]
  JUMP [+1]
  LOADNIL R15
  SETTABLEKS R15 R14 K122 ["AutomaticCanvasSize"]
  GETTABLEKS R17 R0 K3 ["props"]
  GETTABLEKS R16 R17 K15 ["inverted"]
  JUMPIFNOT R16 [+3]
  GETTABLEKS R15 R0 K105 ["_canvasSize"]
  JUMP [+1]
  LOADNIL R15
  SETTABLEKS R15 R14 K101 ["CanvasSize"]
  GETTABLEKS R17 R0 K3 ["props"]
  GETTABLEKS R16 R17 K15 ["inverted"]
  JUMPIFNOT R16 [+3]
  GETTABLEKS R15 R0 K104 ["_canvasPosition"]
  JUMP [+1]
  LOADNIL R15
  SETTABLEKS R15 R14 K97 ["CanvasPosition"]
  CALL R12 2 1
  GETTABLEKS R15 R0 K58 ["state"]
  GETTABLEKS R14 R15 K60 ["last"]
  GETTABLEKS R16 R0 K3 ["props"]
  GETTABLEKS R15 R16 K52 ["getItemCount"]
  GETTABLEKS R17 R0 K3 ["props"]
  GETTABLEKS R16 R17 K12 ["data"]
  CALL R15 1 1
  JUMPIFLT R14 R15 [+2]
  LOADB R13 0 +1
  LOADB R13 1
  SETTABLEKS R13 R0 K134 ["_hasMore"]
  GETUPVAL R14 4
  GETTABLEKS R13 R14 K26 ["createElement"]
  GETUPVAL R14 11
  DUPTABLE R15 K136 [{"value"}]
  DUPTABLE R16 K143 [{"cellKey", "getScrollMetrics", "horizontal", "getOutermostParentListRef", "getNestedChildState", "registerAsNestedChild", "unregisterAsNestedChild", "debugInfo"}]
  LOADNIL R17
  SETTABLEKS R17 R16 K27 ["cellKey"]
  GETTABLEKS R17 R0 K144 ["_getScrollMetrics"]
  SETTABLEKS R17 R16 K137 ["getScrollMetrics"]
  GETTABLEKS R19 R0 K3 ["props"]
  GETTABLEKS R18 R19 K13 ["horizontal"]
  ...
  JUMP [+1]
  MOVE R17 R18
  SETTABLEKS R17 R16 K13 ["horizontal"]
  GETTABLEKS R17 R0 K145 ["_getOutermostParentListRef"]
  SETTABLEKS R17 R16 K138 ["getOutermostParentListRef"]
  GETTABLEKS R17 R0 K146 ["_getNestedChildState"]
  SETTABLEKS R17 R16 K139 ["getNestedChildState"]
  GETTABLEKS R17 R0 K147 ["_registerAsNestedChild"]
  SETTABLEKS R17 R16 K140 ["registerAsNestedChild"]
  GETTABLEKS R17 R0 K148 ["_unregisterAsNestedChild"]
  SETTABLEKS R17 R16 K141 ["unregisterAsNestedChild"]
  NAMECALL R17 R0 K149 ["_getDebugInfo"]
  CALL R17 1 1
  SETTABLEKS R17 R16 K142 ["debugInfo"]
  SETTABLEKS R16 R15 K135 ["value"]
  GETUPVAL R17 4
  GETTABLEKS R16 R17 K87 ["cloneElement"]
  GETTABLEKS R19 R0 K3 ["props"]
  GETTABLEKS R18 R19 K150 ["renderScrollComponent"]
  JUMPIFNOT R18 [+5]
  GETTABLEKS R18 R0 K3 ["props"]
  GETTABLEKS R17 R18 K150 ["renderScrollComponent"]
  JUMP [+2]
  GETTABLEKS R17 R0 K151 ["_defaultRenderScrollComponent"]
  MOVE R18 R12
  CALL R17 1 1
  DUPTABLE R18 K153 [{"ref"}]
  GETTABLEKS R19 R0 K154 ["_captureScrollRef"]
  SETTABLEKS R19 R18 K152 ["ref"]
  MOVE R19 R8
  CALL R16 3 -1
  CALL R13 -1 1
  MOVE R14 R13
  ...
  GETTABLEKS R15 R16 K26 ["createElement"]
  GETUPVAL R18 12
  GETTABLEKS R17 R18 K155 ["Context"]
  GETTABLEKS R16 R17 K156 ["Consumer"]
  LOADNIL R17
  NEWCLOSURE R18 P1
  CAPTURE VAL R0
  CAPTURE UPVAL U1
  ...
  MOVE R14 R15
  GETTABLEKS R16 R0 K3 ["props"]
  GETTABLEKS R15 R16 K157 ["debug"]
  JUMPIFNOT R15 [+19]
  GETUPVAL R16 4
  GETTABLEKS R15 R16 K26 ["createElement"]
  GETUPVAL R16 6
  DUPTABLE R17 K158 [{"style", "Name"}]
  GETUPVAL R19 2
  GETTABLEKS R18 R19 K157 ["debug"]
  SETTABLEKS R18 R17 K35 ["style"]
  LOADK R18 K157 ["debug"]
  SETTABLEKS R18 R17 K29 ["Name"]
  MOVE R18 R14
  NAMECALL R19 R0 K159 ["_renderDebugOverlay"]
  CALL R19 1 -1
  CALL R15 -1 -1
  RETURN R15 -1
  RETURN R14 1
...
PROTO_92:
  ...
  LOADK R2 K1 ["VirtualizedList: Encountered an error while measuring a list's offset from its containing VirtualizedList."]
  CALL R1 1 0
  RETURN R0 0
...
PROTO_112:
  ...
  LOADK R6 K2 ["VirtualizedList: Both ListItemComponent and renderItem props are present. ListItemComponent will take precedence over renderItem."]
  CALL R5 1 0
  GETUPVAL R6 0
  GETTABLEKS R5 R6 K0 ["toJSBoolean"]
  MOVE R6 R2
  ...
  MOVE R6 R2
  DUPTABLE R7 K7 [{"item", "index", "separators"}]
  SETTABLEKS R3 R7 K4 ["item"]
  SETTABLEKS R4 R7 K5 ["index"]
  GETTABLEKS R8 R0 K8 ["_separators"]
  SETTABLEKS R8 R7 K6 ["separators"]
  CALL R5 2 -1
  RETURN R5 -1
  GETUPVAL R6 0
  GETTABLEKS R5 R6 K0 ["toJSBoolean"]
  ...
  JUMPIFNOT R5 [+12]
  MOVE R5 R1
  DUPTABLE R6 K7 [{"item", "index", "separators"}]
  SETTABLEKS R3 R6 K4 ["item"]
  SETTABLEKS R4 R6 K5 ["index"]
  GETTABLEKS R7 R0 K8 ["_separators"]
  SETTABLEKS R7 R6 K6 ["separators"]
  CALL R5 1 -1
  RETURN R5 -1
  GETUPVAL R5 3
  LOADB R6 0
  LOADK R7 K9 ["VirtualizedList: Either ListItemComponent or renderItem props are required but none were found."]
  CALL R5 2 0
  LOADNIL R5
  RETURN R5 1
