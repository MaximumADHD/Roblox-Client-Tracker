...
PROTO_1:
        0 GETUPVAL                         R0 0
        1 GETUPVAL                         R1 1
        2 GETTABLEKS                       R1 R1 K0 ["virtualizedItems"]
        4 GETUPVAL                         R2 2
        5 LOADN                            R3 0
        6 CALL                             R0 3 1
        7 RETURN                           R0 1
...
PROTO_2:
       ...
       10 GETUPVAL                         R2 2
       11 GETUPVAL                         R3 3
       12 GETTABLEKS                       R3 R3 K1 ["virtualizedItems"]
       14 GETUPVAL                         R4 4
       15 MOVE                             R5 R0
       16 CALL                             R2 3 1
       17 CALL                             R1 1 0
...
PROTO_4:
        0 GETUPVAL                         R0 0
        1 GETUPVAL                         R1 1
        2 GETTABLEKS                       R1 R1 K0 ["CanvasPosition"]
        4 GETTABLEKS                       R1 R1 K1 ["Y"]
        6 CALL                             R0 1 0
        7 RETURN                           R0 0
...
PROTO_9:
        ...
        1 GETUPVAL                         R1 1
        2 GETUPVAL                         R2 2
        3 GETTABLEKS                       R2 R2 K0 ["virtualizedItems"]
        5 GETUPVAL                         R3 3
        6 GETUPVAL                         R4 4
...
PROTO_10:
       ...
       15 LOADN                            R2 0
       16 GETUPVAL                         R3 0
       17 GETTABLEKS                       R3 R3 K5 ["virtualizedItems"]
       19 LOADNIL                          R4
       20 LOADNIL                          R5
       21 FORGPREP                         R3
...
PROTO_11:
       ...
       34 CALL                             R6 2 1
       35 GETUPVAL                         R7 0
       36 GETTABLEKS                       R7 R7 K4 ["useEffect"]
       38 NEWCLOSURE                       R8 P2
       39 CAPTURE                          VAL R0
       40 CAPTURE                          VAL R2
       41 CAPTURE                          VAL R6
       ...
       47 CALL                             R7 2 0
       48 GETUPVAL                         R7 0
       49 GETTABLEKS                       R7 R7 K5 ["useMemo"]
       51 NEWCLOSURE                       R8 P3
       52 CAPTURE                          VAL R0
       53 NEWTABLE                         R9 0 1
       ...
       59 CALL                             R7 2 1
       60 GETUPVAL                         R8 0
       61 GETTABLEKS                       R8 R8 K4 ["useEffect"]
       63 NEWCLOSURE                       R9 P4
       64 CAPTURE                          VAL R0
       65 CAPTURE                          VAL R7
       66 NEWTABLE                         R10 0 1
       ...
       71 CALL                             R8 2 0
       72 GETUPVAL                         R8 0
       73 GETTABLEKS                       R8 R8 K6 ["useLayoutEffect"]
       75 NEWCLOSURE                       R9 P5
       76 CAPTURE                          VAL R4
       77 CAPTURE                          UPVAL U1
       78 CAPTURE                          VAL R0
       ...
       88 CALL                             R8 2 0
       89 GETUPVAL                         R8 0
       90 GETTABLEKS                       R8 R8 K2 ["useCallback"]
       92 NEWCLOSURE                       R9 P6
       93 CAPTURE                          VAL R0
       94 NEWTABLE                         R10 0 1
      ...
      128 JUMPIFEQKNIL                     R14 ; [+35]
      130 GETTABLEKS                       R15 R14 K11 ["key"]
      132 GETUPVAL                         R16 0
      133 GETTABLEKS                       R16 R16 K12 ["createElement"]
      135 LOADK                            R17 K13 ["Frame"]
      136 DUPTABLE                         R18 K19 [{["BackgroundTransparency"] = 1, ["BorderSizePixel"] = 0, ["Position"], ["Size"]}]
      137 GETIMPORT                        R19 K22 [UDim2.fromOffset]
      139 LOADN                            R20 0
      140 MOVE                             R21 R10
      141 CALL                             R19 2 1
      142 SETTABLEKS                       R19 R18 K17 ["Position"]
      144 GETIMPORT                        R19 K24 [UDim2.new]
      146 LOADN                            R20 1
      147 LOADN                            R21 0
      148 LOADN                            R22 0
      149 GETTABLEKS                       R23 R14 K9 ["height"]
      151 CALL                             R19 4 1
      152 SETTABLEKS                       R19 R18 K18 ["Size"]
      154 GETTABLEKS                       R19 R0 K25 ["renderItem"]
      156 MOVE                             R20 R14
      157 CALL                             R19 1 -1
      158 CALL                             R16 -1 1
      159 SETTABLE                         R16 R9 R15
      160 GETTABLEKS                       R15 R14 K9 ["height"]
      162 ADD                              R10 R10 R15
      163 FORNLOOP                         R11
      164 MOVE                             R11 R9
      165 MOVE                             R12 R8
