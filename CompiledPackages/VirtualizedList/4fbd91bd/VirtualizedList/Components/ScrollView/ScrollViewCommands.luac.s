...
PROTO_1:
        0 JUMPIFNOT                        R3 ; [+8]
        1 GETTABLEKS                       R4 R0 K0 ["_nativeRef"]
        3 GETTABLEKS                       R4 R4 K1 ["animateScrollTo"]
        5 MOVE                             R5 R1
        6 MOVE                             R6 R2
        7 CALL                             R4 2 0
        8 RETURN                           R0 0
        9 GETTABLEKS                       R4 R0 K0 ["_nativeRef"]
       11 GETTABLEKS                       R4 R4 K2 ["current"]
...
PROTO_2:
        ...
        4 GETTABLEKS                       R3 R3 K2 ["ScrollingDirection"]
        6 GETIMPORT                        R4 K5 [Enum.ScrollingDirection.Y]
        8 JUMPIFNOTEQ                      R3 R4 ; [+3]
       10 LOADN                            R2 0
       11 JUMP                             ; [+8]
       12 GETTABLEKS                       R2 R0 K0 ["_nativeRef"]
       14 GETTABLEKS                       R2 R2 K1 ["current"]
       16 GETTABLEKS                       R2 R2 K6 ["AbsoluteCanvasSize"]
       18 GETTABLEKS                       R2 R2 K7 ["X"]
       20 GETTABLEKS                       R4 R0 K0 ["_nativeRef"]
       22 GETTABLEKS                       R4 R4 K1 ["current"]
       24 GETTABLEKS                       R4 R4 K2 ["ScrollingDirection"]
       26 GETIMPORT                        R5 K5 [Enum.ScrollingDirection.Y]
       28 JUMPIFNOTEQ                      R4 R5 ; [+10]
       30 GETTABLEKS                       R3 R0 K0 ["_nativeRef"]
       32 GETTABLEKS                       R3 R3 K1 ["current"]
       34 GETTABLEKS                       R3 R3 K6 ["AbsoluteCanvasSize"]
       36 GETTABLEKS                       R3 R3 K4 ["Y"]
       38 JUMP                             ; [+1]
       39 LOADN                            R3 0
       40 JUMPIFNOT                        R1 ; [+8]
       41 GETTABLEKS                       R4 R0 K0 ["_nativeRef"]
       43 GETTABLEKS                       R4 R4 K8 ["animateScrollTo"]
       45 MOVE                             R5 R2
       46 MOVE                             R6 R3
       47 CALL                             R4 2 0
       48 RETURN                           R0 0
       49 GETTABLEKS                       R4 R0 K0 ["_nativeRef"]
       51 GETTABLEKS                       R4 R4 K1 ["current"]
