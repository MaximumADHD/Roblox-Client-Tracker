...
PROTO_6:
       ...
       14 GETUPVAL                         R4 1
       15 JUMPIF                           R4 ; [+12]
       16 GETIMPORT                        R4 K6 [Instance.new]
       18 LOADK                            R5 K7 ["GetTextBoundsParams"]
       19 CALL                             R4 1 1
       20 FASTCALL2K                       ASSERT R4 K8 ; [+5]
       22 MOVE                             R6 R4
       23 LOADK                            R7 K8 ["GetTextBoundsParams constructor failed"]
       24 GETIMPORT                        R5 K10 [assert]
       26 CALL                             R5 2 0
       27 SETUPVAL                         R4 1
       28 GETUPVAL                         R4 1
       29 SETTABLEKS                       R0 R4 K11 ["Font"]
       31 SETTABLEKS                       R1 R4 K12 ["Size"]
       33 LOADK                            R5 K13 ["Mg"]
       34 SETTABLEKS                       R5 R4 K14 ["Text"]
       36 LOADB                            R5 0
       37 SETTABLEKS                       R5 R4 K15 ["RichText"]
       39 GETIMPORT                        R5 K17 [pcall]
       41 NEWCLOSURE                       R6 P0
       42 CAPTURE                          UPVAL U2
       43 CAPTURE                          VAL R4
       44 CALL                             R5 1 2
       45 JUMPIFNOT                        R5 ; [+3]
       46 GETTABLEKS                       R7 R6 K18 ["Y"]
       48 JUMP                             ; [+1]
       49 MULK                             R7 R1 K19 [1.2]
       50 GETUPVAL                         R8 0
       51 SETTABLE                         R7 R8 R2
       52 RETURN                           R7 1
...
PROTO_7:
       ...
       13 RETURN                           R3 1
       14 GETUPVAL                         R4 1
       15 GETTABLEKS                       R4 R4 K4 ["rawMeasure"]
       17 LOADK                            R5 K5 ["|"]
       18 MOVE                             R6 R0
       19 MOVE                             R7 R1
       20 LOADB                            R8 0
...
PROTO_8:
       ...
       24 RETURN                           R6 1
       25 GETUPVAL                         R8 1
       26 GETTABLEKS                       R8 R8 K6 ["rawMeasure"]
       28 MOVE                             R10 R0
       29 LOADK                            R11 K7 ["|"]
       ...
       34 CALL                             R8 4 1
       35 GETUPVAL                         R9 1
       36 GETTABLEKS                       R9 R9 K8 ["getSentinelWidth"]
       38 MOVE                             R10 R1
       39 MOVE                             R11 R2
       40 CALL                             R9 2 1
       41 SUB                              R7 R8 R9
       42 GETUPVAL                         R8 0
       43 SETTABLE                         R7 R8 R5
       44 RETURN                           R7 1
