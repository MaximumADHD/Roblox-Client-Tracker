...
PROTO_1:
       ...
       46 JUMPIFNOT                        R11 ; [+13]
       47 LOADK                            R14 K13 ["<font color=\"%*\">%*</font>"]
       48 MOVE                             R16 R11
       49 MOVE                             R17 R10
       50 NAMECALL                         R14 R14 K14 ["format"]
       52 CALL                             R14 3 1
       53 FASTCALL2                        TABLE_INSERT R4 R14 ; [+4]
       55 MOVE                             R13 R4
       ...
       62 MOVE                             R13 R4
       63 MOVE                             R14 R10
       64 GETIMPORT                        R12 K17 [table.insert]
       66 CALL                             R12 2 0
       67 FORGLOOP                         R5 2 ; [-52]
       69 GETIMPORT                        R5 K19 [table.concat]
       71 MOVE                             R6 R4
       72 CALL                             R5 1 -1
       73 RETURN                           R5 -1
...
PROTO_2:
       ...
       78 JUMPIFNOT                        R13 ; [+13]
       79 LOADK                            R16 K14 ["<font color=\"%*\">%*</font>"]
       80 MOVE                             R18 R13
       81 MOVE                             R19 R12
       82 NAMECALL                         R16 R16 K15 ["format"]
       84 CALL                             R16 3 1
       85 FASTCALL2                        TABLE_INSERT R6 R16 ; [+4]
       87 MOVE                             R15 R6
       88 GETIMPORT                        R14 K18 [table.insert]
       90 CALL                             R14 2 0
       91 JUMP                             ; [+7]
       92 FASTCALL2                        TABLE_INSERT R6 R12 ; [+5]
       94 MOVE                             R15 R6
       95 MOVE                             R16 R12
       96 GETIMPORT                        R14 K18 [table.insert]
       98 CALL                             R14 2 0
       99 FORGLOOP                         R7 2 ; [-52]
...
PROTO_4:
      ...
      106 MOVE                             R22 R23
      107 MOVE                             R21 R22
      108 JUMPIFNOT                        R14 ; [+13]
      109 GETTABLE                         R23 R6 R7
      110 LOADK                            R24 K20 ["<font color=\"%*\">%*</font>"]
      111 MOVE                             R26 R14
      112 MOVE                             R27 R21
      113 NAMECALL                         R24 R24 K21 ["format"]
      115 CALL                             R24 3 1
      116 FASTCALL2                        TABLE_INSERT R23 R24 ; [+3]
      118 GETIMPORT                        R22 K24 [table.insert]
      120 CALL                             R22 2 0
      121 JUMP                             ; [+7]
      122 GETTABLE                         R23 R6 R7
      123 FASTCALL2                        TABLE_INSERT R23 R21 ; [+4]
      125 MOVE                             R24 R21
      126 GETIMPORT                        R22 K24 [table.insert]
      128 CALL                             R22 2 0
      129 FORGLOOP                         R16 2 ; [-59]
      131 FORGLOOP                         R8 2 ; [-75]
      133 GETIMPORT                        R8 K26 [table.create]
      135 LENGTH                           R9 R6
      136 CALL                             R8 1 1
      137 MOVE                             R9 R6
      138 LOADNIL                          R10
      139 LOADNIL                          R11
      140 FORGPREP                         R9
      141 GETIMPORT                        R14 K28 [table.concat]
      143 MOVE                             R15 R13
      144 CALL                             R14 1 1
      145 SETTABLE                         R14 R8 R12
      146 FORGLOOP                         R9 2 ; [-6]
      148 RETURN                           R8 1
