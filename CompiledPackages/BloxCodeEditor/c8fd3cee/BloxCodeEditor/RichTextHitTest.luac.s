...
PROTO_2:
       ...
       82 JUMPIFNOT                        R5 ; [+12]
       83 LOADK                            R7 K25 ["color=\"%*\""]
       84 GETTABLEKS                       R9 R1 K23 ["color"]
       86 NAMECALL                         R7 R7 K14 ["format"]
       88 CALL                             R7 2 1
       89 FASTCALL2                        TABLE_INSERT R4 R7 ; [+4]
       91 MOVE                             R6 R4
       92 GETIMPORT                        R5 K28 [table.insert]
       94 CALL                             R5 2 0
       95 GETTABLEKS                       R5 R1 K24 ["fontFamily"]
       97 JUMPIFNOT                        R5 ; [+12]
       98 LOADK                            R7 K29 ["family=\"%*\""]
       99 GETTABLEKS                       R9 R1 K24 ["fontFamily"]
      101 NAMECALL                         R7 R7 K14 ["format"]
      103 CALL                             R7 2 1
      104 FASTCALL2                        TABLE_INSERT R4 R7 ; [+4]
      106 MOVE                             R6 R4
      107 GETIMPORT                        R5 K28 [table.insert]
      109 CALL                             R5 2 0
      110 LOADK                            R5 K30 ["<font %*>%*</font>"]
      111 GETIMPORT                        R7 K32 [table.concat]
      113 MOVE                             R8 R4
      114 LOADK                            R9 K33 [" "]
      115 CALL                             R7 2 1
      116 MOVE                             R8 R3
      117 NAMECALL                         R5 R5 K14 ["format"]
      119 CALL                             R5 3 1
      120 MOVE                             R3 R5
      121 RETURN                           R3 1
