PROTO_0:
        ...
        8 JUMPIFNOT                        R1 ; [+9]
        9 GETUPVAL                         R1 3
       10 GETTABLEKS                       R1 R1 K1 ["onAnimationComplete"]
       12 JUMPIFNOT                        R1 ; [+5]
       13 GETUPVAL                         R1 3
       14 GETTABLEKS                       R1 R1 K1 ["onAnimationComplete"]
       16 MOVE                             R2 R0
       17 CALL                             R1 1 0
       18 GETUPVAL                         R1 2
       19 GETUPVAL                         R2 4
       ...
       23 JUMPIFNOT                        R1 ; [+9]
       24 GETUPVAL                         R1 3
       25 GETTABLEKS                       R1 R1 K1 ["onAnimationComplete"]
       27 JUMPIFNOT                        R1 ; [+5]
       28 GETUPVAL                         R1 3
       29 GETTABLEKS                       R1 R1 K1 ["onAnimationComplete"]
       31 LOADB                            R2 1
       32 CALL                             R1 1 0
       33 RETURN                           R0 0
...
PROTO_1:
        ...
        9 JUMPIFNOT                        R1 ; [+9]
       10 GETUPVAL                         R1 4
       11 GETTABLEKS                       R1 R1 K1 ["onAnimationComplete"]
       13 JUMPIFNOT                        R1 ; [+5]
       14 GETUPVAL                         R1 4
       15 GETTABLEKS                       R1 R1 K1 ["onAnimationComplete"]
       17 MOVE                             R2 R0
       18 CALL                             R1 1 0
       19 GETUPVAL                         R1 3
       20 GETUPVAL                         R2 5
       ...
       24 JUMPIFNOT                        R1 ; [+9]
       25 GETUPVAL                         R1 4
       26 GETTABLEKS                       R1 R1 K1 ["onAnimationComplete"]
       28 JUMPIFNOT                        R1 ; [+5]
       29 GETUPVAL                         R1 4
       30 GETTABLEKS                       R1 R1 K1 ["onAnimationComplete"]
       32 LOADB                            R2 1
       33 CALL                             R1 1 0
       34 RETURN                           R0 0
...
PROTO_3:
       ...
       33 GETUPVAL                         R12 1
       34 GETTABLEKS                       R12 R12 K2 ["current"]
       36 GETTABLE                         R11 R12 R9
       37 JUMPIFNOT                        R11 ; [+14]
       38 GETUPVAL                         R12 1
       39 GETTABLEKS                       R12 R12 K2 ["current"]
       ...
       46 CALL                             R12 1 0
       47 GETUPVAL                         R12 1
       48 GETTABLEKS                       R12 R12 K2 ["current"]
       50 LOADNIL                          R13
       ...
       55 NEWTABLE                         R11 1 0
       57 GETUPVAL                         R12 2
       58 GETTABLEKS                       R12 R12 K6 ["Default"]
       60 GETUPVAL                         R13 3
       61 GETTABLEKS                       R13 R13 K7 ["getDefaultTransition"]
       63 CALL                             R13 0 1
       64 SETTABLE                         R13 R11 R12
       65 GETTABLE                         R12 R11 R9
       66 JUMPIF                           R12 ; [+9]
       67 GETUPVAL                         R13 2
       68 GETTABLEKS                       R13 R13 K6 ["Default"]
       70 GETTABLE                         R12 R11 R13
       71 JUMPIF                           R12 ; [+4]
       72 GETUPVAL                         R12 3
       73 GETTABLEKS                       R12 R12 K7 ["getDefaultTransition"]
       75 CALL                             R12 0 1
      ...
      104 CALL                             R15 2 1
      105 GETUPVAL                         R16 1
      106 GETTABLEKS                       R16 R16 K2 ["current"]
...
MAIN:
       ...
       31 GETTABLEKS                       R8 R1 K9 ["Enums"]
       33 GETTABLEKS                       R8 R8 K10 ["TransitionPreset"]
       35 CALL                             R7 1 1
