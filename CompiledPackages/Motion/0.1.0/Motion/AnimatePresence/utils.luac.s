PROTO_0:
       ...
       22 JUMPIFNOT                        R1 ; [+11]
       23 GETTABLEKS                       R1 R0 K4 ["props"]
       25 GETTABLEKS                       R1 R1 K3 ["key"]
       27 JUMPIFEQKNIL                     R1 ; [+6]
       29 GETTABLEKS                       R1 R0 K4 ["props"]
       31 GETTABLEKS                       R1 R1 K3 ["key"]
       33 RETURN                           R1 1
       34 LOADNIL                          R1
       35 RETURN                           R1 1
...
PROTO_2:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["isValidElement"]
        3 MOVE                             R2 R0
        4 CALL                             R1 1 1
        5 JUMPIFNOT                        R1 ; [+7]
        6 GETUPVAL                         R2 1
...
PROTO_3:
        0 NEWTABLE                         R1 0 0
        2 GETUPVAL                         R2 0
        3 GETTABLEKS                       R2 R2 K0 ["Children"]
        5 GETTABLEKS                       R2 R2 K1 ["forEach"]
        7 MOVE                             R3 R0
        8 NEWCLOSURE                       R4 P0
        9 CAPTURE                          UPVAL U0
       10 CAPTURE                          VAL R1
