MAIN:
        ...
        5 GETTABLEKS                       R1 R1 K4 ["Motion"]
        7 CALL                             R0 1 1
        8 GETIMPORT                        R1 K1 [require]
       10 GETIMPORT                        R2 K3 [script]
       12 GETTABLEKS                       R2 R2 K5 ["Utility"]
       14 GETTABLEKS                       R2 R2 K6 ["useMotion"]
       16 CALL                             R1 1 1
       17 GETIMPORT                        R2 K1 [require]
       19 GETIMPORT                        R3 K3 [script]
       21 GETTABLEKS                       R3 R3 K7 ["AnimatePresence"]
       23 GETTABLEKS                       R3 R3 K7 ["AnimatePresence"]
       25 CALL                             R2 1 1
       26 GETIMPORT                        R3 K1 [require]
       28 GETIMPORT                        R4 K3 [script]
       30 GETTABLEKS                       R4 R4 K7 ["AnimatePresence"]
       32 GETTABLEKS                       R4 R4 K8 ["usePresence"]
       34 CALL                             R3 1 1
       35 GETIMPORT                        R4 K1 [require]
       37 GETIMPORT                        R5 K3 [script]
       39 GETTABLEKS                       R5 R5 K9 ["Types"]
       41 CALL                             R4 1 1
       ...
       65 GETTABLEKS                       R7 R7 K15 ["Enums"]
       67 GETTABLEKS                       R7 R7 K13 ["TransitionPreset"]
       69 CALL                             R6 1 1
