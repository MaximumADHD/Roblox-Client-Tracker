...
PROTO_2:
       ...
       12 CALL                             R4 2 0
       13 RETURN                           R0 0
       14 GETIMPORT                        R4 K2 [table.clone]
       16 GETTABLEKS                       R5 R3 K7 ["incomingWires"]
       18 JUMPIF                           R5 ; [+2]
       19 NEWTABLE                         R5 0 0
       21 CALL                             R4 1 1
       22 GETTABLEKS                       R5 R1 K8 ["wireId"]
       24 SETTABLE                         R1 R4 R5
       25 DUPTABLE                         R5 K12 [{"connection", "nodeId", "nodeOutputInfo", "incomingWires"}]
       26 GETTABLEKS                       R6 R3 K9 ["connection"]
       28 SETTABLEKS                       R6 R5 K9 ["connection"]
       30 SETTABLEKS                       R0 R5 K10 ["nodeId"]
       32 GETTABLEKS                       R6 R3 K11 ["nodeOutputInfo"]
       34 SETTABLEKS                       R6 R5 K11 ["nodeOutputInfo"]
       36 SETTABLEKS                       R4 R5 K7 ["incomingWires"]
       38 SETTABLE                         R5 R2 R0
       39 GETUPVAL                         R5 1
       40 MOVE                             R6 R2
       41 CALL                             R5 1 0
       42 RETURN                           R0 0
...
PROTO_3:
        0 DUPTABLE                         R0 K5 [{"nodeDestroyConnectionMapRef", "setNodeDestroyConnectionMap", "observeNodeInfoLookupListRef", "setNodeOutputInfoInDestroyMapRef", "registerIncomingWireInDestroyMapRef"}]
        1 GETUPVAL                         R1 0
       ...
       13 GETUPVAL                         R1 4
       14 SETTABLEKS                       R1 R0 K4 ["registerIncomingWireInDestroyMapRef"]
       16 RETURN                           R0 1
...
PROTO_4:
       ...
       47 CALL                             R8 1 1
       48 GETUPVAL                         R9 0
       49 GETTABLEKS                       R9 R9 K3 ["useCallback"]
       51 NEWCLOSURE                       R10 P2
       52 CAPTURE                          VAL R4
       53 CAPTURE                          VAL R3
       54 NEWTABLE                         R11 0 1
       56 GETTABLEKS                       R12 R4 K4 ["current"]
       58 SETLIST                          R11 R12 1 [1]
       60 CALL                             R9 2 1
       61 GETUPVAL                         R10 1
       62 GETTABLEKS                       R10 R10 K1 ["useRefToState"]
       64 MOVE                             R11 R9
       65 CALL                             R10 1 1
       66 GETUPVAL                         R11 0
       67 GETTABLEKS                       R11 R11 K2 ["useMemo"]
