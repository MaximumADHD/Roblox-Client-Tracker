PROTO_0:
      ...
      127 LOADNIL                          R9
      128 GETUPVAL                         R10 6
      129 GETTABLEKS                       R10 R10 K14 ["observeGraphNodeMap"]
      131 LOADB                            R11 0
      132 CALL                             R10 1 1
      133 JUMPIFNOT                        R9 ; [+3]
      134 JUMPIFNOT                        R10 ; [+2]
      135 GETTABLE                         R11 R10 R9
      136 JUMP                             ; [+1]
      137 LOADNIL                          R11
      138 DUPTABLE                         R12 K19 [{"Name", "ConnectedNodeId", "ConnectedNodeName", "Value"}]
      139 SETTABLEKS                       R5 R12 K15 ["Name"]
      141 SETTABLEKS                       R9 R12 K16 ["ConnectedNodeId"]
      143 JUMPIFNOT                        R11 ; [+10]
      144 GETUPVAL                         R13 7
      145 GETTABLEKS                       R13 R13 K20 ["getDisplayName"]
      147 GETTABLEKS                       R14 R11 K21 ["name"]
      149 JUMPIF                           R14 ; [+2]
      150 GETTABLEKS                       R14 R11 K22 ["className"]
      152 CALL                             R13 1 1
      153 JUMP                             ; [+3]
      154 GETUPVAL                         R13 8
      155 GETTABLEKS                       R13 R13 K23 ["DISCONNECTED_INPUT"]
      157 SETTABLEKS                       R13 R12 K17 ["ConnectedNodeName"]
      159 SETTABLEKS                       R7 R12 K18 ["Value"]
      161 MOVE                             R8 R12
      162 JUMP                             ; [+13]
      163 DUPTABLE                         R9 K24 [{"Name", "ConnectedNodeId", "Value"}]
      164 SETTABLEKS                       R5 R9 K15 ["Name"]
      166 JUMPIFNOT                        R6 ; [+3]
      167 GETTABLEKS                       R10 R6 K13 ["outputNodeId"]
      169 JUMPIF                           R10 ; [+1]
      170 LOADNIL                          R10
      171 SETTABLEKS                       R10 R9 K16 ["ConnectedNodeId"]
      173 SETTABLEKS                       R7 R9 K18 ["Value"]
      175 MOVE                             R8 R9
      176 FASTCALL2                        TABLE_INSERT R0 R8 ; [+5]
      178 MOVE                             R10 R0
      179 MOVE                             R11 R8
      180 GETIMPORT                        R9 K27 [table.insert]
      182 CALL                             R9 2 0
      183 FORGLOOP                         R1 2 ; [-166]
      185 RETURN                           R0 1
...
PROTO_5:
       ...
       35 CAPTURE                          UPVAL U9
       36 NEWTABLE                         R6 0 4
       38 GETTABLEKS                       R7 R0 K4 ["GraphPayload"]
       40 GETTABLEKS                       R8 R0 K5 ["Default"]
       42 GETTABLEKS                       R9 R0 K6 ["TransitionFields"]
       44 GETTABLEKS                       R10 R2 K7 ["animationParameters"]
       46 SETLIST                          R6 R7 4 [1]
       48 CALL                             R4 2 1
       49 GETUPVAL                         R5 0
       50 GETTABLEKS                       R5 R5 K8 ["useCallback"]
       52 NEWCLOSURE                       R6 P1
       53 CAPTURE                          VAL R0
       54 CAPTURE                          VAL R1
       55 CAPTURE                          UPVAL U6
       56 NEWTABLE                         R7 0 2
       58 GETTABLEKS                       R8 R0 K4 ["GraphPayload"]
       60 GETTABLEKS                       R9 R0 K6 ["TransitionFields"]
       62 SETLIST                          R7 R8 2 [1]
       64 CALL                             R5 2 1
       65 GETUPVAL                         R6 10
       66 GETTABLEKS                       R6 R6 K9 ["useEventCallback"]
       68 NEWCLOSURE                       R7 P2
       ...
       72 CALL                             R6 1 1
       73 GETUPVAL                         R7 0
       74 GETTABLEKS                       R7 R7 K8 ["useCallback"]
       76 NEWCLOSURE                       R8 P3
       77 CAPTURE                          VAL R0
       78 CAPTURE                          VAL R1
       79 NEWTABLE                         R9 0 3
       81 GETTABLEKS                       R10 R0 K4 ["GraphPayload"]
       83 MOVE                             R11 R4
       84 GETTABLEKS                       R12 R1 K10 ["reorderPins"]
       ...
       95 CAPTURE                          VAL R6
       96 CAPTURE                          VAL R7
       97 DUPTABLE                         R9 K17 [{"inputs", "onInputChanged", "onInputDeleted", "onInputReordered", "newInputDefaultValue", "makePropertyChild"}]
       98 SETTABLEKS                       R4 R9 K11 ["inputs"]
      100 SETTABLEKS                       R5 R9 K12 ["onInputChanged"]
      102 SETTABLEKS                       R6 R9 K13 ["onInputDeleted"]
      104 SETTABLEKS                       R7 R9 K14 ["onInputReordered"]
      106 GETTABLEKS                       R10 R0 K5 ["Default"]
      108 SETTABLEKS                       R10 R9 K15 ["newInputDefaultValue"]
      110 SETTABLEKS                       R8 R9 K16 ["makePropertyChild"]
      112 RETURN                           R9 1
...
MAIN:
       ...
       91 GETTABLEKS                       R12 R0 K23 ["Flags"]
       93 GETTABLEKS                       R12 R12 K24 ["getFFlagAnimGraphUI_FixInputPanelParameters"]
       95 CALL                             R11 1 1
       96 GETTABLEKS                       R12 R7 K25 ["getFFlagAnimGraphUIDefaultAndDisconnectedInputs"]
       98 GETIMPORT                        R13 K5 [require]
      100 GETTABLEKS                       R14 R0 K23 ["Flags"]
      102 GETTABLEKS                       R14 R14 K26 ["getFFlagAnimGraphUIDuplicateNodeNames"]
      104 CALL                             R13 1 1
      105 DUPCLOSURE                       R14 K27 [PROTO_5]
      106 CAPTURE                          VAL R9
      107 CAPTURE                          VAL R7
      108 CAPTURE                          VAL R1
      109 CAPTURE                          VAL R5
