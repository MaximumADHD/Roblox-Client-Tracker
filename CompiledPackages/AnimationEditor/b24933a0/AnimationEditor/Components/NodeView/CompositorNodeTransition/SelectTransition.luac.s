PROTO_0:
       ...
       23 CALL                             R9 0 1
       24 JUMPIFNOT                        R9 ; [+2]
       25 DUPTABLE                         R8 K23 [{["Minimum"] = 0}]
       26 JUMP                             ; [+1]
       27 LOADNIL                          R8
       28 SETTABLEKS                       R8 R7 K18 ["ExtraProps"]
       30 GETTABLEKS                       R8 R0 K24 ["Transition"]
       32 JUMPIFNOT                        R8 ; [+4]
       33 GETTABLEKS                       R8 R0 K24 ["Transition"]
       35 GETTABLEKS                       R8 R8 K13 ["Duration"]
       37 SETTABLEKS                       R8 R7 K19 ["Value"]
       39 CALL                             R6 1 1
       40 SETTABLEKS                       R6 R5 K8 ["Transition_Duration"]
       42 GETTABLEKS                       R6 R1 K11 ["nextTransitionProperty"]
       44 DUPTABLE                         R7 K28 [{["Name"] = "Curve", ["Label"] = "Curve", ["Type"] = "Enum.PoseEasingStyle", ["Choices"], ["Value"]}]
       45 NEWTABLE                         R8 2 0
       47 GETIMPORT                        R9 K32 [Enum.PoseEasingStyle.Linear]
       49 LOADK                            R10 K31 ["Linear"]
       50 SETTABLE                         R10 R8 R9
       51 GETIMPORT                        R9 K34 [Enum.PoseEasingStyle.CubicV2]
       53 LOADK                            R10 K35 ["In/Out"]
       54 SETTABLE                         R10 R8 R9
       55 SETTABLEKS                       R8 R7 K27 ["Choices"]
       57 GETTABLEKS                       R8 R0 K24 ["Transition"]
       59 JUMPIFNOT                        R8 ; [+4]
       60 GETTABLEKS                       R8 R0 K24 ["Transition"]
       62 GETTABLEKS                       R8 R8 K25 ["Curve"]
       64 SETTABLEKS                       R8 R7 K19 ["Value"]
       66 CALL                             R6 1 1
       67 SETTABLEKS                       R6 R5 K9 ["Transition_Curve"]
       69 CALL                             R2 3 -1
       70 RETURN                           R2 -1
