PROTO_0:
       ...
       23 CALL                             R9 0 1
       24 JUMPIFNOT                        R9 ; [+2]
       25 DUPTABLE                         R8 K24 [{["Minimum"] = 0}]
       26 JUMP                             ; [+1]
       27 LOADNIL                          R8
       28 SETTABLEKS                       R8 R7 K19 ["ExtraProps"]
       30 GETTABLEKS                       R8 R0 K25 ["Transition"]
       32 JUMPIFNOT                        R8 ; [+4]
       33 GETTABLEKS                       R8 R0 K25 ["Transition"]
       35 GETTABLEKS                       R8 R8 K14 ["WaitFor"]
       37 SETTABLEKS                       R8 R7 K20 ["Value"]
       39 CALL                             R6 1 1
       40 SETTABLEKS                       R6 R5 K8 ["Transition_WaitFor"]
       42 GETTABLEKS                       R6 R1 K12 ["nextTransitionProperty"]
       44 DUPTABLE                         R7 K29 [{["Name"] = "Duration", ["Label"] = "Length", ["Type"] = "Timestamp", ["Value"]}]
       45 GETTABLEKS                       R8 R0 K25 ["Transition"]
       47 JUMPIFNOT                        R8 ; [+4]
       48 GETTABLEKS                       R8 R0 K25 ["Transition"]
       50 GETTABLEKS                       R8 R8 K26 ["Duration"]
       52 SETTABLEKS                       R8 R7 K20 ["Value"]
       54 CALL                             R6 1 1
       55 SETTABLEKS                       R6 R5 K9 ["Transition_Duration"]
       57 GETTABLEKS                       R6 R1 K12 ["nextTransitionProperty"]
       59 DUPTABLE                         R7 K33 [{["Name"] = "Curve", ["Label"] = "Curve", ["Type"] = "Enum.PoseEasingStyle", ["Choices"], ["Value"]}]
       60 NEWTABLE                         R8 2 0
       62 GETIMPORT                        R9 K37 [Enum.PoseEasingStyle.Linear]
       64 LOADK                            R10 K36 ["Linear"]
       65 SETTABLE                         R10 R8 R9
       66 GETIMPORT                        R9 K39 [Enum.PoseEasingStyle.CubicV2]
       68 LOADK                            R10 K40 ["In/Out"]
       69 SETTABLE                         R10 R8 R9
       70 SETTABLEKS                       R8 R7 K32 ["Choices"]
       72 GETTABLEKS                       R8 R0 K25 ["Transition"]
       74 JUMPIFNOT                        R8 ; [+4]
       75 GETTABLEKS                       R8 R0 K25 ["Transition"]
       77 GETTABLEKS                       R8 R8 K30 ["Curve"]
