PROTO_0:
        ...
        2 LOADK                            R2 K2 ["Opening popup %* with no popup context"]
        3 GETTABLEKS                       R4 R0 K3 ["title"]
...
PROTO_1:
        0 DUPTABLE                         R0 K1 [{"popupComponent"}]
        1 GETUPVAL                         R1 0
        2 GETTABLEKS                       R1 R1 K0 ["popupComponent"]
        4 SETTABLEKS                       R1 R0 K0 ["popupComponent"]
        6 RETURN                           R0 1
...
PROTO_2:
        ...
        4 CAPTURE                          VAL R0
        5 NEWTABLE                         R3 0 1
        7 GETTABLEKS                       R4 R0 K1 ["popupComponent"]
        9 SETLIST                          R3 R4 1 [1]
       11 CALL                             R1 2 1
       12 GETUPVAL                         R2 0
...
PROTO_3:
        ...
        8 DUPTABLE                         R3 K10 [{["Id"], ["Enabled"] = True, ["Size"], ["Title"], ["InitialDockState"], ["OnClose"]}]
        9 GETTABLEKS                       R4 R0 K11 ["id"]
       11 SETTABLEKS                       R4 R3 K3 ["Id"]
       13 GETTABLEKS                       R4 R0 K12 ["size"]
       15 SETTABLEKS                       R4 R3 K6 ["Size"]
       17 GETTABLEKS                       R4 R0 K13 ["title"]
       19 SETTABLEKS                       R4 R3 K7 ["Title"]
       21 GETIMPORT                        R4 K16 [Enum.InitialDockState.Float]
       23 SETTABLEKS                       R4 R3 K8 ["InitialDockState"]
       25 GETTABLEKS                       R4 R0 K17 ["onClose"]
       27 SETTABLEKS                       R4 R3 K9 ["OnClose"]
       29 GETTABLEKS                       R4 R0 K18 ["children"]
       31 CALL                             R1 3 -1
       32 RETURN                           R1 -1
...
PROTO_4:
        0 DUPTABLE                         R0 K1 [{"popupComponent"}]
        1 GETUPVAL                         R1 0
        2 SETTABLEKS                       R1 R0 K0 ["popupComponent"]
        4 RETURN                           R0 1
...
PROTO_5:
       ...
       21 GETUPVAL                         R3 3
       22 GETTABLEKS                       R3 R3 K7 ["Provider"]
       24 DUPTABLE                         R4 K9 [{"value"}]
       25 SETTABLEKS                       R1 R4 K8 ["value"]
...
MAIN:
       ...
       33 MOVE                             R7 R5
       34 CALL                             R6 1 1
       35 DUPCLOSURE                       R7 K17 [PROTO_2]
       36 CAPTURE                          VAL R3
       37 CAPTURE                          VAL R6
       38 DUPCLOSURE                       R8 K18 [PROTO_3]
       39 CAPTURE                          VAL R3
       40 CAPTURE                          VAL R2
