...
PROTO_4:
        ...
        5 GETUPVAL                         R4 0
        6 LENGTH                           R3 R4
        7 JUMPIFNOTEQKN                    R3 K1 [0] ; [+7]
        9 GETTABLEKS                       R3 R2 K2 ["allowAddInput"]
       11 JUMPIFNOTEQKB                    R3 FALSE ; [+3]
       13 LOADNIL                          R3
       14 RETURN                           R3 1
       15 GETUPVAL                         R3 1
       16 GETTABLEKS                       R3 R3 K3 ["createElement"]
       18 GETUPVAL                         R4 2
       19 DUPTABLE                         R5 K21 [{"LayoutOrder", "InputBuilder", "InputBuilderProps", "NodeId", "Inputs", "NewInputDefaultValue", "OnInputChanged", "OnInputDeleted", "OnInputReordered", "AllowAddInput", "Position", "PropertyLookup", "Size", "StateLookup", "text", "editName", "GraphPayload"}]
       20 GETTABLEKS                       R6 R1 K22 ["nextOrder"]
       22 CALL                             R6 0 1
       23 SETTABLEKS                       R6 R5 K4 ["LayoutOrder"]
       25 GETTABLEKS                       R6 R2 K23 ["inputBuilder"]
       27 SETTABLEKS                       R6 R5 K5 ["InputBuilder"]
       29 GETTABLEKS                       R6 R2 K24 ["inputBuilderProps"]
       31 SETTABLEKS                       R6 R5 K6 ["InputBuilderProps"]
       33 GETTABLEKS                       R6 R0 K20 ["GraphPayload"]
       35 GETTABLEKS                       R6 R6 K25 ["id"]
       37 SETTABLEKS                       R6 R5 K7 ["NodeId"]
       39 GETUPVAL                         R6 0
       40 SETTABLEKS                       R6 R5 K8 ["Inputs"]
       42 GETUPVAL                         R6 3
       43 GETTABLEKS                       R6 R6 K26 ["Default"]
       45 SETTABLEKS                       R6 R5 K9 ["NewInputDefaultValue"]
       47 GETUPVAL                         R6 4
       48 SETTABLEKS                       R6 R5 K10 ["OnInputChanged"]
       50 GETUPVAL                         R6 5
       51 SETTABLEKS                       R6 R5 K11 ["OnInputDeleted"]
       53 GETUPVAL                         R6 6
       54 SETTABLEKS                       R6 R5 K12 ["OnInputReordered"]
       56 GETTABLEKS                       R6 R2 K2 ["allowAddInput"]
       58 SETTABLEKS                       R6 R5 K13 ["AllowAddInput"]
       60 GETTABLEKS                       R6 R0 K14 ["Position"]
       62 SETTABLEKS                       R6 R5 K14 ["Position"]
       64 GETTABLEKS                       R6 R0 K15 ["PropertyLookup"]
       66 SETTABLEKS                       R6 R5 K15 ["PropertyLookup"]
       68 GETTABLEKS                       R6 R0 K16 ["Size"]
       70 SETTABLEKS                       R6 R5 K16 ["Size"]
       72 GETTABLEKS                       R6 R0 K17 ["StateLookup"]
       74 SETTABLEKS                       R6 R5 K17 ["StateLookup"]
       76 GETTABLEKS                       R6 R0 K18 ["text"]
       78 SETTABLEKS                       R6 R5 K18 ["text"]
       80 GETTABLEKS                       R6 R0 K19 ["editName"]
       82 SETTABLEKS                       R6 R5 K19 ["editName"]
       84 GETTABLEKS                       R6 R0 K20 ["GraphPayload"]
       86 SETTABLEKS                       R6 R5 K20 ["GraphPayload"]
       88 CALL                             R3 2 -1
       89 RETURN                           R3 -1
...
PROTO_5:
       ...
       98 CALL                             R8 2 1
       99 GETUPVAL                         R9 0
      100 GETTABLEKS                       R9 R9 K10 ["useCallback"]
      ...
      112 MOVE                             R12 R5
      113 GETTABLEKS                       R13 R0 K7 ["Default"]
      115 MOVE                             R14 R6
      116 MOVE                             R15 R7
      117 MOVE                             R16 R8
      118 SETLIST                          R11 R12 5 [1]
      120 CALL                             R9 2 1
      121 DUPTABLE                         R10 K19 [{"inputs", "onInputChanged", "onInputDeleted", "onInputReordered", "newInputDefaultValue", "makePropertyChild"}]
      122 SETTABLEKS                       R5 R10 K13 ["inputs"]
      124 SETTABLEKS                       R6 R10 K14 ["onInputChanged"]
      126 SETTABLEKS                       R7 R10 K15 ["onInputDeleted"]
      128 SETTABLEKS                       R8 R10 K16 ["onInputReordered"]
      130 GETTABLEKS                       R11 R0 K7 ["Default"]
      132 SETTABLEKS                       R11 R10 K17 ["newInputDefaultValue"]
      134 SETTABLEKS                       R9 R10 K18 ["makePropertyChild"]
      136 RETURN                           R10 1
