...
PROTO_24:
       ...
       51 LOADK                            R7 K16 ["Network action %* send to %* failed - %*"]
       52 GETUPVAL                         R9 4
       53 ORK                              R10 R0 K1 ["ALL"]
       54 MOVE                             R11 R4
       55 NAMECALL                         R7 R7 K17 ["format"]
       57 CALL                             R7 4 1
       58 CALL                             R6 1 0
       59 DUPTABLE                         R6 K20 [{["n"] = 0}]
       60 MOVE                             R2 R6
       61 LOADN                            R7 1
       62 GETTABLEKS                       R8 R2 K18 ["n"]
       64 FASTCALL3                        TABLE_UNPACK R2 R7 R8
       66 MOVE                             R6 R2
       67 GETIMPORT                        R5 K22 [table.unpack]
       69 CALL                             R5 3 -1
       70 CLOSEUPVALS                      R0
       71 RETURN                           R5 -1
       72 CLOSEUPVALS                      R2
       ...
       75 MOVE                             R4 R0
       76 GETVARARGS                       R5 -1
       77 NAMECALL                         R1 R1 K23 ["InvokeHostAsync"]
       79 CALL                             R1 -1 -1
       80 CLOSEUPVALS                      R0
       81 RETURN                           R1 -1
       82 GETUPVAL                         R1 3
       83 NAMECALL                         R1 R1 K24 ["IsHost"]
       85 CALL                             R1 1 1
       86 JUMPIFNOT                        R1 ; [+63]
       87 GETUPVAL                         R1 0
       88 CALL                             R1 0 1
       89 JUMPIFNOT                        R1 ; [+51]
       90 GETIMPORT                        R1 K5 [table.pack]
       92 GETVARARGS                       R2 -1
       93 CALL                             R1 -1 1
       94 LOADNIL                          R2
       95 GETIMPORT                        R3 K7 [pcall]
       97 NEWCLOSURE                       R4 P1
       98 CAPTURE                          REF R2
       99 CAPTURE                          UPVAL U3
      ...
      107 MOVE                             R6 R4
      108 GETIMPORT                        R5 K9 [tostring]
      110 CALL                             R5 1 1
      111 GETIMPORT                        R6 K12 [string.find]
      113 MOVE                             R7 R5
      114 LOADK                            R8 K13 ["Self is closed"]
      115 CALL                             R6 2 1
      116 JUMPIF                           R6 ; [+10]
      117 GETIMPORT                        R6 K15 [warn]
      119 LOADK                            R7 K16 ["Network action %* send to %* failed - %*"]
      120 GETUPVAL                         R9 4
      121 ORK                              R10 R0 K25 ["UI"]
      122 MOVE                             R11 R4
      123 NAMECALL                         R7 R7 K17 ["format"]
      125 CALL                             R7 4 1
      126 CALL                             R6 1 0
      127 DUPTABLE                         R6 K20 [{["n"] = 0}]
      128 MOVE                             R2 R6
      129 LOADN                            R7 1
      130 GETTABLEKS                       R8 R2 K18 ["n"]
      132 FASTCALL3                        TABLE_UNPACK R2 R7 R8
      134 MOVE                             R6 R2
      135 GETIMPORT                        R5 K22 [table.unpack]
      137 CALL                             R5 3 -1
      138 CLOSEUPVALS                      R0
      139 RETURN                           R5 -1
      140 CLOSEUPVALS                      R2
      ...
      143 MOVE                             R4 R0
      144 GETVARARGS                       R5 -1
      145 NAMECALL                         R1 R1 K26 ["InvokeGuestAsync"]
      147 CALL                             R1 -1 -1
      148 CLOSEUPVALS                      R0
      149 RETURN                           R1 -1
      150 GETIMPORT                        R1 K28 [error]
      152 LOADK                            R2 K29 ["Networking is neither UIDM nor EditableDM"]
      153 CALL                             R1 1 0
      154 CLOSEUPVALS                      R0
      155 RETURN                           R0 0
