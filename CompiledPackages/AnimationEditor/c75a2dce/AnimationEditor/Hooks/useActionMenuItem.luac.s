...
PROTO_2:
       ...
       20 MOVE                             R4 R0
       21 CALL                             R3 1 1
       22 LOADK                            R4 K5 ["action_%*"]
       23 GETUPVAL                         R6 3
       24 GETTABLEKS                       R6 R6 K6 ["Util"]
       26 GETTABLEKS                       R6 R6 K7 ["StudioUri"]
       28 GETTABLEKS                       R6 R6 K8 ["toString"]
       30 MOVE                             R7 R0
       31 CALL                             R6 1 1
       32 NAMECALL                         R4 R4 K9 ["format"]
       34 CALL                             R4 2 1
       35 GETUPVAL                         R5 4
       36 GETTABLEKS                       R5 R5 K10 ["useEventCallback"]
       38 NEWCLOSURE                       R6 P0
       39 CAPTURE                          VAL R4
       40 CAPTURE                          VAL R1
       41 CAPTURE                          VAL R0
       42 CALL                             R5 1 1
       43 GETUPVAL                         R6 0
       44 GETTABLEKS                       R6 R6 K11 ["useMemo"]
       46 NEWCLOSURE                       R7 P1
       47 CAPTURE                          VAL R4
       48 CAPTURE                          VAL R2
       49 CAPTURE                          VAL R3
       ...
       54 MOVE                             R11 R3
       55 JUMPIFNOT                        R11 ; [+2]
       56 GETTABLEKS                       R11 R3 K12 ["enabled"]
       58 MOVE                             R12 R3
       59 JUMPIFNOT                        R12 ; [+2]
       60 GETTABLEKS                       R12 R3 K13 ["text"]
       62 SETLIST                          R8 R9 4 [1]
       64 CALL                             R6 2 1
       65 DUPTABLE                         R7 K16 [{"tryActivate", "menuItem"}]
       66 SETTABLEKS                       R5 R7 K14 ["tryActivate"]
       68 SETTABLEKS                       R6 R7 K15 ["menuItem"]
       70 RETURN                           R7 1
