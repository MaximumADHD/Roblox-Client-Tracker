...
PROTO_5:
        ...
        1 JUMPIF                           R0 ; [+13]
        2 GETUPVAL                         R0 1
        3 LOADK                            R2 K0 ["Humanoid"]
        4 NAMECALL                         R0 R0 K1 ["IsA"]
        6 CALL                             R0 2 1
        7 JUMPIFNOT                        R0 ; [+7]
        8 GETUPVAL                         R0 3
        9 GETUPVAL                         R2 1
       10 NAMECALL                         R0 R0 K2 ["LoadFromHumanoid"]
       12 CALL                             R0 2 1
       13 SETUPVAL                         R0 2
       14 RETURN                           R0 0
       15 GETUPVAL                         R0 3
       16 GETUPVAL                         R2 1
       17 GETTABLEKS                       R2 R2 K3 ["Parent"]
       19 NAMECALL                         R0 R0 K4 ["LoadFromModel"]
       21 CALL                             R0 2 1
       22 SETUPVAL                         R0 2
       23 RETURN                           R0 0
...
MAIN:
        ...
        9 LOADK                            R3 K4 ["AnimRigLoadFromModel2"]
       10 LOADB                            R4 0
       11 NAMECALL                         R1 R1 K5 ["DefineFastFlag"]
       13 CALL                             R1 3 1
       14 NEWTABLE                         R2 16 0
       16 DUPCLOSURE                       R3 K6 [PROTO_0]
       17 SETTABLEKS                       R3 R2 K7 ["canAnimateSelection"]
       19 DUPCLOSURE                       R3 K8 [PROTO_1]
       20 CAPTURE                          VAL R2
       21 SETTABLEKS                       R3 R2 K9 ["findAnimatorParent"]
       23 DUPCLOSURE                       R3 K10 [PROTO_2]
       24 CAPTURE                          VAL R2
       25 SETTABLEKS                       R3 R2 K11 ["findRigFromSelection"]
       27 DUPCLOSURE                       R3 K12 [PROTO_3]
       28 SETTABLEKS                       R3 R2 K13 ["_findAnimatorParentFromAnimSaves"]
       30 DUPCLOSURE                       R3 K14 [PROTO_4]
       31 SETTABLEKS                       R3 R2 K15 ["findAnimatorParentInParent"]
       33 DUPCLOSURE                       R3 K16 [PROTO_6]
       34 CAPTURE                          VAL R1
       35 SETTABLEKS                       R3 R2 K17 ["loadAnimationRig"]
       37 DUPCLOSURE                       R3 K18 [PROTO_7]
       38 CAPTURE                          VAL R2
       39 SETTABLEKS                       R3 R2 K19 ["getOrCreateAnimSavesFolderWithNoRig"]
       41 DUPCLOSURE                       R3 K20 [PROTO_8]
       42 CAPTURE                          VAL R2
       43 SETTABLEKS                       R3 R2 K21 ["getOrCreateAnimSavesFolder"]
       45 DUPCLOSURE                       R3 K22 [PROTO_9]
       46 CAPTURE                          VAL R0
       47 SETTABLEKS                       R3 R2 K23 ["getServerStorageContainer"]
       49 DUPCLOSURE                       R3 K24 [PROTO_10]
       50 CAPTURE                          VAL R0
       51 SETTABLEKS                       R3 R2 K25 ["getOrCreateServerStorageContainer"]
       53 DUPCLOSURE                       R3 K26 [PROTO_11]
       54 SETTABLEKS                       R3 R2 K27 ["getOrCreateAnimSavesObjectValue"]
       56 DUPCLOSURE                       R3 K28 [PROTO_12]
       57 CAPTURE                          VAL R2
       58 SETTABLEKS                       R3 R2 K29 ["ensureAnimationRigDataInAnimationClip"]
       60 DUPCLOSURE                       R3 K30 [PROTO_13]
       61 CAPTURE                          VAL R2
       62 SETTABLEKS                       R3 R2 K31 ["ensureAnimationRigDataInHumanoid"]
       64 RETURN                           R2 1
