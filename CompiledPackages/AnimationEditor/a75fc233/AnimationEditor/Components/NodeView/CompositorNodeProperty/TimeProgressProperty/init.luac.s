...
PROTO_2:
       ...
       92 GETUPVAL                         R9 5
       93 DUPTABLE                         R10 K29 [{["tag"] = "no-flex auto-y text-body-small text-align-x-left", ["Size"], ["Text"], ["LayoutOrder"] = 1, ["isDisabled"]}]
       94 GETIMPORT                        R11 K32 [UDim2.new]
       96 LOADN                            R12 0
       97 LOADN                            R13 40
       98 LOADN                            R14 0
       99 LOADN                            R15 0
      100 CALL                             R11 4 1
      101 SETTABLEKS                       R11 R10 K25 ["Size"]
      103 SETTABLEKS                       R2 R10 K26 ["Text"]
      105 GETTABLEKS                       R12 R0 K34 ["IsDisabled"]
      107 ORK                              R11 R12 K33 [False]
      108 SETTABLEKS                       R11 R10 K28 ["isDisabled"]
      110 CALL                             R8 2 1
      111 SETTABLEKS                       R8 R7 K21 ["CompositorNodeInputLabel"]
      113 GETUPVAL                         R8 1
      114 GETTABLEKS                       R8 R8 K7 ["createElement"]
      116 GETUPVAL                         R9 6
      117 DUPTABLE                         R10 K39 [{["tag"] = "size-full-700", ["gradient"], ["value"], ["LayoutOrder"] = 2}]
      118 SETTABLEKS                       R3 R10 K36 ["gradient"]
      120 GETTABLEKS                       R12 R0 K1 ["Value"]
      122 JUMPIFNOT                        R12 ; [+5]
      123 GETTABLEKS                       R11 R0 K1 ["Value"]
      125 GETTABLEKS                       R11 R11 K6 ["Time"]
      127 JUMPIF                           R11 ; [+1]
      128 LOADN                            R11 0
      129 SETTABLEKS                       R11 R10 K37 ["value"]
      131 CALL                             R8 2 1
      132 SETTABLEKS                       R8 R7 K22 ["Input"]
      134 CALL                             R4 3 -1
      135 RETURN                           R4 -1
...
MAIN:
       ...
       54 GETTABLEKS                       R7 R7 K15 ["TimeProgressBar"]
       56 CALL                             R6 1 1
       ...
       68 GETTABLEKS                       R9 R9 K17 ["getGradientNumberSequence"]
       70 CALL                             R8 1 1
       71 GETTABLEKS                       R9 R1 K18 ["Hooks"]
       73 GETTABLEKS                       R9 R9 K19 ["useTokens"]
       75 DUPCLOSURE                       R10 K20 [PROTO_2]
       76 CAPTURE                          VAL R9
       77 CAPTURE                          VAL R5
       78 CAPTURE                          VAL R4
       79 CAPTURE                          VAL R8
