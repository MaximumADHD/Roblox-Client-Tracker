PROTO_0:
        0 DUPTABLE                         R0 K3 [{"assetId", "instance", "state"}]
        1 GETUPVAL                         R1 0
        2 SETTABLEKS                       R1 R0 K0 ["assetId"]
        4 LOADNIL                          R1
        5 SETTABLEKS                       R1 R0 K1 ["instance"]
        7 LOADK                            R1 K4 ["pending"]
...
PROTO_2:
       ...
       16 JUMPIF                           R3 ; [+16]
       17 GETUPVAL                         R3 3
       18 DUPTABLE                         R4 K8 [{"assetId", "instance", "state", "message"}]
       19 GETUPVAL                         R5 1
       20 SETTABLEKS                       R5 R4 K4 ["assetId"]
       22 LOADNIL                          R5
       23 SETTABLEKS                       R5 R4 K5 ["instance"]
       25 LOADK                            R5 K9 ["error"]
       26 SETTABLEKS                       R5 R4 K6 ["state"]
       28 SETTABLEKS                       R2 R4 K7 ["message"]
       30 CALL                             R3 1 0
       31 CLOSEUPVALS                      R0
       32 RETURN                           R0 0
       33 GETUPVAL                         R3 3
       34 DUPTABLE                         R4 K10 [{"assetId", "instance", "state"}]
       35 GETUPVAL                         R5 1
       36 SETTABLEKS                       R5 R4 K4 ["assetId"]
       38 SETTABLEKS                       R0 R4 K5 ["instance"]
       40 LOADK                            R5 K11 ["loaded"]
       41 SETTABLEKS                       R5 R4 K6 ["state"]
       43 CALL                             R3 1 0
       44 CLOSEUPVALS                      R0
       45 RETURN                           R0 0
