...
PROTO_15:
      ...
      127 GETUPVAL                         R11 12
      128 GETTABLEKS                       R11 R11 K13 ["SELECT_GRAPH_BY_ID_ASYNC"]
      130 MOVE                             R12 R7
      131 CALL                             R10 2 0
      132 GETUPVAL                         R10 11
      133 GETTABLEKS                       R10 R10 K12 ["useBoundAction"]
      135 GETUPVAL                         R11 12
      136 GETTABLEKS                       R11 R11 K14 ["RENAME_GRAPH_BY_ID_ASYNC"]
      138 MOVE                             R12 R8
      139 CALL                             R10 2 0
      140 GETUPVAL                         R10 11
      141 GETTABLEKS                       R10 R10 K15 ["useReplicatedState"]
      143 GETUPVAL                         R11 13
      144 GETTABLEKS                       R11 R11 K16 ["GRAPH_ITEMS"]
      146 MOVE                             R12 R6
      147 CALL                             R10 2 0
      148 GETUPVAL                         R10 0
      149 CALL                             R10 0 1
      150 JUMPIF                           R10 ; [+8]
      151 GETUPVAL                         R10 11
      152 GETTABLEKS                       R10 R10 K15 ["useReplicatedState"]
      154 GETUPVAL                         R11 13
      155 GETTABLEKS                       R11 R11 K17 ["SELECTED_GRAPH_ID_DEPRECATED"]
      157 MOVE                             R12 R9
      158 CALL                             R10 2 0
      159 GETUPVAL                         R10 1
      160 GETTABLEKS                       R10 R10 K3 ["useMemo"]
      162 NEWCLOSURE                       R11 P3
      163 CAPTURE                          VAL R6
      164 CAPTURE                          UPVAL U0
      165 CAPTURE                          VAL R9
      166 CAPTURE                          VAL R7
      167 CAPTURE                          VAL R8
      168 NEWTABLE                         R12 0 4
      170 MOVE                             R13 R6
      171 MOVE                             R14 R9
      172 MOVE                             R15 R7
      173 MOVE                             R16 R8
      ...
      176 CALL                             R10 2 1
      177 GETUPVAL                         R11 1
      178 GETTABLEKS                       R11 R11 K18 ["createElement"]
      180 GETUPVAL                         R12 14
      181 GETTABLEKS                       R12 R12 K19 ["Provider"]
      183 DUPTABLE                         R13 K21 [{"value"}]
      184 SETTABLEKS                       R10 R13 K20 ["value"]
      186 GETTABLEKS                       R14 R0 K22 ["children"]
      188 CALL                             R11 3 -1
      189 RETURN                           R11 -1
...
MAIN:
      ...
      137 CALL                             R17 1 1
      138 DUPTABLE                         R18 K33 [{"graphItems", "selectedGraphId_DEPRECATED", "selectGraphByIdAsync", "renameGraphByIdAsync"}]
      139 GETIMPORT                        R19 K36 [table.freeze]
      141 NEWTABLE                         R20 0 0
      143 CALL                             R19 1 1
      144 SETTABLEKS                       R19 R18 K29 ["graphItems"]
      146 LOADNIL                          R19
      147 SETTABLEKS                       R19 R18 K30 ["selectedGraphId_DEPRECATED"]
      149 GETTABLEKS                       R19 R7 K37 ["createUnimplemented"]
      151 LOADK                            R20 K31 ["selectGraphByIdAsync"]
      152 CALL                             R19 1 1
      153 SETTABLEKS                       R19 R18 K31 ["selectGraphByIdAsync"]
      155 GETTABLEKS                       R19 R7 K37 ["createUnimplemented"]
      157 LOADK                            R20 K32 ["renameGraphByIdAsync"]
      158 CALL                             R19 1 1
      159 SETTABLEKS                       R19 R18 K32 ["renameGraphByIdAsync"]
      161 GETTABLEKS                       R19 R6 K38 ["createContext"]
      163 MOVE                             R20 R18
      164 CALL                             R19 1 1
      165 DUPTABLE                         R20 K41 [{"GRAPH_ITEMS", "SELECTED_GRAPH_ID_DEPRECATED"}]
      166 LOADK                            R21 K42 ["GraphDropdownContext_GraphItems"]
      167 SETTABLEKS                       R21 R20 K39 ["GRAPH_ITEMS"]
      169 LOADK                            R21 K43 ["GraphDropdownContext_SelectedGraphId"]
      170 SETTABLEKS                       R21 R20 K40 ["SELECTED_GRAPH_ID_DEPRECATED"]
      172 DUPTABLE                         R21 K46 [{"SELECT_GRAPH_BY_ID_ASYNC", "RENAME_GRAPH_BY_ID_ASYNC"}]
      173 LOADK                            R22 K47 ["GraphDropdownContext_SelectGraphByIdAsync"]
      174 SETTABLEKS                       R22 R21 K44 ["SELECT_GRAPH_BY_ID_ASYNC"]
      176 LOADK                            R22 K48 ["GraphDropdownContext_RenameGraphByIdAsync"]
      177 SETTABLEKS                       R22 R21 K45 ["RENAME_GRAPH_BY_ID_ASYNC"]
      179 DUPCLOSURE                       R22 K49 [PROTO_9]
      180 CAPTURE                          VAL R6
      181 CAPTURE                          VAL R10
      182 CAPTURE                          VAL R8
      183 CAPTURE                          VAL R3
      ...
      188 CAPTURE                          VAL R2
      189 CAPTURE                          VAL R17
      190 DUPCLOSURE                       R23 K50 [PROTO_15]
      191 CAPTURE                          VAL R17
      192 CAPTURE                          VAL R6
      193 CAPTURE                          VAL R9
      194 CAPTURE                          VAL R4
      ...
      204 CAPTURE                          VAL R20
      205 CAPTURE                          VAL R19
      206 DUPCLOSURE                       R24 K51 [PROTO_17]
      207 CAPTURE                          VAL R5
      208 CAPTURE                          VAL R20
      209 CAPTURE                          VAL R17
      210 CAPTURE                          VAL R21
      211 CAPTURE                          VAL R6
      212 CAPTURE                          VAL R19
      213 DUPTABLE                         R25 K55 [{"Context", "EditableDataModelProvider", "UIDataModelProvider"}]
      214 SETTABLEKS                       R19 R25 K52 ["Context"]
      216 SETTABLEKS                       R23 R25 K53 ["EditableDataModelProvider"]
      218 SETTABLEKS                       R24 R25 K54 ["UIDataModelProvider"]
      220 RETURN                           R25 1
