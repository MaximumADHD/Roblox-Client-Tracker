PROTO_0:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["_result"]
        3 GETIMPORT                        R1 K3 [table.pack]
        5 GETUPVAL                         R2 1
        6 GETTABLEKS                       R2 R2 K4 ["Hook"]
        8 GETUPVAL                         R3 1
        9 GETTABLEKS                       R3 R3 K5 ["HookProps"]
       11 CALL                             R2 1 -1
       12 CALL                             R1 -1 1
...
PROTO_1:
        ...
        7 CALL                             R1 2 1
        8 GETUPVAL                         R2 1
        9 GETTABLEKS                       R2 R2 K2 ["createRef"]
       11 CALL                             R2 0 1
       12 SETTABLEKS                       R2 R1 K3 ["_result"]
       14 GETUPVAL                         R2 2
       15 GETTABLEKS                       R2 R2 K4 ["new"]
...
MAIN:
       ...
       18 GETTABLEKS                       R3 R3 K9 ["Tests"]
       20 GETTABLEKS                       R3 R3 K10 ["TestController"]
       22 CALL                             R2 1 1
       23 NEWTABLE                         R3 8 0
