...
PROTO_5:
        0 LOADK                            R4 K0 ["%*_to_%*"]
        1 JUMPIFNOT                        R2 ; [+3]
        2 GETTABLEKS                       R6 R2 K1 ["Name"]
        4 JUMP                             ; [+1]
        5 LOADK                            R6 K2 ["Any"]
        6 GETTABLEKS                       R7 R3 K1 ["Name"]
        8 NAMECALL                         R4 R4 K3 ["format"]
       10 CALL                             R4 3 1
       11 SETTABLEKS                       R4 R0 K1 ["Name"]
       13 GETTABLEKS                       R4 R1 K4 ["id"]
       15 SETTABLEKS                       R4 R0 K5 ["TransitionId"]
       17 SETTABLEKS                       R2 R0 K6 ["From"]
       19 SETTABLEKS                       R3 R0 K7 ["To"]
       21 GETTABLEKS                       R4 R1 K8 ["Priority"]
       23 SETTABLEKS                       R4 R0 K8 ["Priority"]
       25 LOADK                            R6 K9 ["Expression"]
       26 GETTABLEKS                       R7 R1 K10 ["TriggerExpression"]
       28 NAMECALL                         R4 R0 K11 ["SetAttribute"]
       30 CALL                             R4 3 0
       31 LOADK                            R6 K12 ["Duration"]
       32 GETTABLEKS                       R7 R1 K13 ["Length"]
       34 NAMECALL                         R4 R0 K11 ["SetAttribute"]
       36 CALL                             R4 3 0
       37 LOADK                            R6 K14 ["Curve"]
       38 GETTABLEKS                       R7 R1 K14 ["Curve"]
       40 NAMECALL                         R4 R0 K11 ["SetAttribute"]
       42 CALL                             R4 3 0
       43 RETURN                           R0 0
...
PROTO_6:
      ...
      153 JUMPIFNOTEQKNIL                  R17 ; [+14]
      155 LOADK                            R20 K24 ["transition %* references a missing state; skipped"]
      156 GETTABLEKS                       R22 R15 K3 ["id"]
      158 NAMECALL                         R20 R20 K25 ["format"]
      160 CALL                             R20 2 1
      161 FASTCALL2                        TABLE_INSERT R9 R20 ; [+4]
      163 MOVE                             R19 R9
      164 GETIMPORT                        R18 K28 [table.insert]
      166 CALL                             R18 2 0
      167 JUMP                             ; [+58]
      168 GETTABLEKS                       R18 R16 K29 ["isStart"]
      170 JUMPIF                           R18 ; [+55]
      171 GETTABLEKS                       R18 R17 K29 ["isStart"]
      173 JUMPIF                           R18 ; [+3]
      174 GETTABLEKS                       R18 R17 K30 ["isAny"]
      176 JUMPIFNOT                        R18 ; [+13]
      177 LOADK                            R20 K31 ["transition %* targets a synthetic state; skipped"]
      178 GETTABLEKS                       R22 R15 K3 ["id"]
      180 NAMECALL                         R20 R20 K25 ["format"]
      182 CALL                             R20 2 1
      183 FASTCALL2                        TABLE_INSERT R9 R20 ; [+4]
      185 MOVE                             R19 R9
      186 GETIMPORT                        R18 K28 [table.insert]
      188 CALL                             R18 2 0
      189 JUMP                             ; [+36]
      190 GETTABLEKS                       R18 R15 K3 ["id"]
      192 LOADB                            R19 1
      193 SETTABLE                         R19 R10 R18
      194 GETTABLEKS                       R19 R15 K3 ["id"]
      196 GETTABLE                         R18 R8 R19
      197 JUMPIFEQKNIL                     R18 ; [+2]
      199 LOADB                            R19 0 +1
      200 LOADB                            R19 1
      201 JUMPIFNOT                        R19 ; [+5]
      202 GETIMPORT                        R20 K14 [Instance.new]
      204 LOADK                            R21 K19 ["StateMachineTransitionDefinition"]
      205 CALL                             R20 1 1
      206 MOVE                             R18 R20
      207 GETTABLEKS                       R21 R16 K30 ["isAny"]
      209 JUMPIFNOT                        R21 ; [+2]
      210 LOADNIL                          R20
      211 JUMP                             ; [+3]
      212 GETTABLEKS                       R21 R15 K22 ["fromStateId"]
      214 GETTABLE                         R20 R5 R21
      215 GETUPVAL                         R21 3
      216 MOVE                             R22 R18
      217 MOVE                             R23 R15
      218 MOVE                             R24 R20
      219 GETTABLEKS                       R26 R15 K23 ["toStateId"]
      221 GETTABLE                         R25 R5 R26
      222 CALL                             R21 4 0
      223 JUMPIFNOT                        R19 ; [+2]
      224 SETTABLEKS                       R0 R18 K15 ["Parent"]
      226 FORGLOOP                         R11 2 ; [-82]
      228 MOVE                             R11 R8
      229 LOADNIL                          R12
      230 LOADNIL                          R13
      231 FORGPREP                         R11
      232 GETTABLE                         R16 R10 R14
      233 JUMPIF                           R16 ; [+3]
      234 NAMECALL                         R16 R15 K16 ["Destroy"]
      236 CALL                             R16 1 0
      237 FORGLOOP                         R11 2 ; [-6]
      239 RETURN                           R9 1
