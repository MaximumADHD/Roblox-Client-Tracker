...
PROTO_1:
        ...
        7 CALL                             R0 2 1
        8 LOADB                            R1 0
        9 SETTABLEKS                       R1 R0 K2 ["isUnimplemented"]
       11 NEWTABLE                         R2 0 0
       13 DUPTABLE                         R3 K5 [{["__mode"] = "kv"}]
       14 FASTCALL2                        SETMETATABLE R2 R3 ; [+3]
       16 GETIMPORT                        R1 K1 [setmetatable]
       18 CALL                             R1 2 1
       19 SETTABLEKS                       R1 R0 K6 ["_idToInstance"]
       21 NEWTABLE                         R2 0 0
       23 DUPTABLE                         R3 K5 [{["__mode"] = "kv"}]
       24 FASTCALL2                        SETMETATABLE R2 R3 ; [+3]
       26 GETIMPORT                        R1 K1 [setmetatable]
       28 CALL                             R1 2 1
       29 SETTABLEKS                       R1 R0 K7 ["_instanceToId"]
       31 DUPCLOSURE                       R1 K8 [PROTO_0]
       32 CAPTURE                          UPVAL U1
       33 SETTABLEKS                       R1 R0 K9 ["_generateGUID"]
       35 LOADB                            R1 0
       36 SETTABLEKS                       R1 R0 K10 ["_dead"]
       38 RETURN                           R0 1

PROTO_2:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["_dead"]
        3 JUMPIFNOT                        R1 ; [+8]
        4 GETIMPORT                        R1 K2 [error]
        6 LOADK                            R2 K3 ["InstanceRegistry %* is destroyed. This is a sign that signals or resources have leaked."]
        7 GETUPVAL                         R4 1
        8 NAMECALL                         R2 R2 K4 ["format"]
       10 CALL                             R2 2 1
       11 CALL                             R1 1 0
       12 LOADK                            R3 K5 ["AnimationNodeDefinition"]
       13 NAMECALL                         R1 R0 K6 ["IsA"]
       15 CALL                             R1 2 1
       16 JUMPIFNOT                        R1 ; [+7]
       17 GETUPVAL                         R1 2
       18 GETTABLEKS                       R2 R0 K7 ["NodeType"]
       20 GETTABLEKS                       R2 R2 K8 ["Name"]
       22 CALL                             R1 1 -1
       23 RETURN                           R1 -1
       24 GETUPVAL                         R1 2
       25 GETTABLEKS                       R2 R0 K9 ["ClassName"]
       27 CALL                             R1 1 -1
       28 RETURN                           R1 -1
...
PROTO_5:
        ...
        3 CALL                             R0 0 1
        4 LOADB                            R1 1
        5 SETTABLEKS                       R1 R0 K1 ["isUnimplemented"]
        7 DUPCLOSURE                       R1 K2 [PROTO_4]
        8 SETTABLEKS                       R1 R0 K3 ["_generateGUID"]
       10 RETURN                           R0 1
...
PROTO_8:
        0 GETTABLE                         R3 R1 R2
        1 JUMPIFNOTEQKS                    R3 K0 [""] ; [+7]
        3 GETTABLEKS                       R3 R0 K1 ["_generateGUID"]
        5 MOVE                             R4 R1
        6 CALL                             R3 1 1
        7 SETTABLE                         R3 R1 R2
        8 JUMP                             ; [+12]
        9 GETTABLEKS                       R4 R0 K2 ["_idToInstance"]
       11 GETTABLE                         R5 R1 R2
       12 GETTABLE                         R3 R4 R5
       13 JUMPIFNOT                        R3 ; [+7]
       14 JUMPIFEQ                         R3 R1 ; [+6]
       16 GETTABLEKS                       R4 R0 K1 ["_generateGUID"]
       18 MOVE                             R5 R1
       19 CALL                             R4 1 1
       20 SETTABLE                         R4 R1 R2
       21 GETTABLE                         R3 R1 R2
       22 RETURN                           R3 1
...
PROTO_9:
        ...
        4 JUMPIFNOT                        R2 ; [+6]
        5 MOVE                             R4 R1
        6 LOADK                            R5 K2 ["NodeId"]
        7 NAMECALL                         R2 R0 K3 ["_ensureIdProperty"]
        9 CALL                             R2 3 -1
       10 RETURN                           R2 -1
       11 LOADK                            R4 K4 ["StateMachineStateDefinition"]
       12 NAMECALL                         R2 R1 K1 ["IsA"]
       14 CALL                             R2 2 1
       15 JUMPIFNOT                        R2 ; [+6]
       16 MOVE                             R4 R1
       17 LOADK                            R5 K5 ["StateId"]
       18 NAMECALL                         R2 R0 K3 ["_ensureIdProperty"]
       20 CALL                             R2 3 -1
       21 RETURN                           R2 -1
       22 LOADK                            R4 K6 ["StateMachineTransitionDefinition"]
       23 NAMECALL                         R2 R1 K1 ["IsA"]
       25 CALL                             R2 2 1
       26 JUMPIFNOT                        R2 ; [+6]
       27 MOVE                             R4 R1
       28 LOADK                            R5 K7 ["TransitionId"]
       29 NAMECALL                         R2 R0 K3 ["_ensureIdProperty"]
       31 CALL                             R2 3 -1
       32 RETURN                           R2 -1
       33 GETTABLEKS                       R2 R0 K8 ["_generateGUID"]
       35 MOVE                             R3 R1
       36 CALL                             R2 1 -1
       37 RETURN                           R2 -1
...
MAIN:
       ...
       17 GETTABLEKS                       R3 R3 K11 ["ReactUtils"]
       19 CALL                             R2 1 1
       20 NEWTABLE                         R3 16 0
       ...
       45 SETTABLEKS                       R4 R3 K24 ["_ensureIdProperty"]
       47 DUPCLOSURE                       R4 K25 [PROTO_9]
       48 SETTABLEKS                       R4 R3 K26 ["_ensureUniqueId"]
       50 DUPCLOSURE                       R4 K27 [PROTO_10]
       51 SETTABLEKS                       R4 R3 K28 ["destroy"]
       53 RETURN                           R3 1
