...
PROTO_24:
      ...
      134 CALL                             R7 1 0
      135 JUMP                             ; [+28]
      136 GETTABLEKS                       R6 R4 K2 ["animationTrack"]
      138 GETUPVAL                         R7 3
      139 GETTABLEKS                       R7 R7 K9 ["currentTime"]
      141 SETTABLEKS                       R7 R6 K28 ["TimePosition"]
      143 GETUPVAL                         R6 6
      144 NAMECALL                         R6 R6 K17 ["IsRunning"]
      146 CALL                             R6 1 1
      147 JUMPIF                           R6 ; [+16]
      148 GETIMPORT                        R6 K19 [pcall]
      150 NEWCLOSURE                       R7 P2
      151 CAPTURE                          VAL R4
      152 CALL                             R6 1 2
      153 JUMPIF                           R6 ; [+10]
      154 GETIMPORT                        R8 K21 [warn]
      156 LOADK                            R10 K22 ["Failed to step animations for preview: "]
      157 FASTCALL1                        TOSTRING R7 ; [+3]
      158 MOVE                             R12 R7
      159 GETIMPORT                        R11 K24 [tostring]
      161 CALL                             R11 1 1
      162 CONCAT                           R9 R10 R11
      163 CALL                             R8 1 0
      164 FORGLOOP                         R0 2 ; [-161]
      166 RETURN                           R0 0
...
PROTO_25:
      ...
      156 GETTABLEKS                       R15 R0 K15 ["isPlaying"]
      158 GETTABLEKS                       R16 R0 K14 ["currentTime"]
      160 MOVE                             R17 R10
      161 GETTABLEKS                       R18 R2 K16 ["animationParameters"]
      163 GETUPVAL                         R20 14
      164 CALL                             R20 0 1
      165 JUMPIFNOT                        R20 ; [+3]
      166 GETTABLEKS                       R19 R3 K17 ["setDebugDataAsync"]
      168 JUMP                             ; [+2]
      169 GETTABLEKS                       R19 R3 K18 ["setDebugDataAsync_DEPRECATED"]
      171 GETUPVAL                         R21 14
      172 CALL                             R21 0 1
      173 JUMPIFNOT                        R21 ; [+3]
      174 GETTABLEKS                       R20 R5 K5 ["instanceRegistry"]
      176 JUMP                             ; [+1]
      177 LOADNIL                          R20
      178 SETLIST                          R14 R15 6 [1]
      180 CALL                             R12 2 0
      181 RETURN                           R0 0
...
MAIN:
      ...
      156 GETTABLEKS                       R22 R0 K19 ["Flags"]
      158 GETTABLEKS                       R22 R22 K35 ["getFFlagAnimGraphUI_SpotlightNodes"]
      160 CALL                             R21 1 1
      161 GETIMPORT                        R22 K11 [require]
      163 GETTABLEKS                       R23 R0 K14 ["Contexts"]
      165 GETTABLEKS                       R23 R23 K36 ["MaskEditorContext"]
      167 GETTABLEKS                       R23 R23 K37 ["observeMaskDatum"]
      169 CALL                             R22 1 1
      170 DUPCLOSURE                       R23 K38 [PROTO_0]
      171 CAPTURE                          VAL R8
      172 DUPCLOSURE                       R24 K39 [PROTO_1]
      173 CAPTURE                          VAL R18
      174 CAPTURE                          VAL R3
      175 DUPCLOSURE                       R25 K40 [PROTO_2]
      176 DUPCLOSURE                       R26 K41 [PROTO_3]
      177 DUPCLOSURE                       R27 K42 [PROTO_25]
      178 CAPTURE                          VAL R14
      179 CAPTURE                          VAL R6
      180 CAPTURE                          VAL R5
      181 CAPTURE                          VAL R9
