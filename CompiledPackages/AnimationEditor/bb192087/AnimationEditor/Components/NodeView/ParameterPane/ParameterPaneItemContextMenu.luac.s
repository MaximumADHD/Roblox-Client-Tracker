...
PROTO_2:
        ...
        8 RETURN                           R0 0
        9 GETUPVAL                         R0 1
       10 GETTABLEKS                       R0 R0 K2 ["removeParameterAsync"]
       12 GETUPVAL                         R1 0
...
PROTO_3:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["setParameterNodeTypeAsync"]
        3 GETUPVAL                         R1 1
...
PROTO_6:
       ...
       59 GETUPVAL                         R11 3
       60 GETTABLEKS                       R11 R11 K15 ["PARAMETER_MENUITEM_TABLE"]
...
PROTO_7:
       ...
       34 CALL                             R3 2 1
       35 GETUPVAL                         R4 0
       36 GETTABLEKS                       R4 R4 K2 ["useCallback"]
       38 NEWCLOSURE                       R5 P1
       39 CAPTURE                          VAL R0
       40 NEWTABLE                         R6 0 2
       ...
       48 CALL                             R4 2 1
       49 GETUPVAL                         R5 0
       50 GETTABLEKS                       R5 R5 K2 ["useCallback"]
       52 NEWCLOSURE                       R6 P2
       53 CAPTURE                          VAL R0
       54 CAPTURE                          VAL R1
       55 NEWTABLE                         R7 0 3
       ...
       65 CALL                             R5 2 1
       66 GETUPVAL                         R6 0
       67 GETTABLEKS                       R6 R6 K2 ["useCallback"]
       69 NEWCLOSURE                       R7 P3
       70 CAPTURE                          VAL R0
       71 CAPTURE                          VAL R1
       72 NEWTABLE                         R8 0 2
       ...
       80 CALL                             R6 2 1
       81 GETUPVAL                         R7 0
       82 GETTABLEKS                       R7 R7 K10 ["useMemo"]
       84 NEWCLOSURE                       R8 P4
       85 CAPTURE                          VAL R3
       86 CAPTURE                          VAL R4
       87 CAPTURE                          VAL R5
       ...
       96 CALL                             R7 2 1
       97 GETUPVAL                         R8 0
       98 GETTABLEKS                       R8 R8 K11 ["createElement"]
      100 GETUPVAL                         R9 5
      101 GETTABLEKS                       R9 R9 K12 ["Menu"]
      ...
      116 GETUPVAL                         R11 5
      117 GETTABLEKS                       R11 R11 K22 ["Enums"]
      119 GETTABLEKS                       R11 R11 K23 ["PopoverSide"]
      121 GETTABLEKS                       R11 R11 K24 ["Right"]
      123 SETTABLEKS                       R11 R10 K17 ["side"]
      125 GETUPVAL                         R11 5
      126 GETTABLEKS                       R11 R11 K22 ["Enums"]
      128 GETTABLEKS                       R11 R11 K25 ["InputSize"]
      130 GETTABLEKS                       R11 R11 K26 ["XSmall"]
