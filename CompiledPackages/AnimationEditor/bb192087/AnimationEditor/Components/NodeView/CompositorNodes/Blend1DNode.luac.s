...
PROTO_6:
       ...
       26 CALL                             R3 1 1
       27 GETUPVAL                         R4 0
       28 GETTABLEKS                       R4 R4 K7 ["useMemo"]
       30 NEWCLOSURE                       R5 P0
       31 CAPTURE                          VAL R2
       32 CAPTURE                          VAL R0
       33 NEWTABLE                         R6 0 2
       35 GETTABLEKS                       R7 R2 K8 ["observeNodePropsById"]
       37 GETTABLEKS                       R8 R0 K2 ["GraphPayload"]
       39 GETTABLEKS                       R8 R8 K9 ["id"]
       41 SETLIST                          R6 R7 2 [1]
       43 CALL                             R4 2 1
       44 GETUPVAL                         R5 4
       45 GETTABLEKS                       R5 R5 K10 ["useSignalState"]
       47 MOVE                             R6 R4
       48 CALL                             R5 1 1
       49 GETUPVAL                         R6 0
       50 GETTABLEKS                       R6 R6 K7 ["useMemo"]
       52 NEWCLOSURE                       R7 P1
       53 CAPTURE                          UPVAL U5
       54 CAPTURE                          VAL R3
       55 NEWTABLE                         R8 0 1
       ...
       61 CALL                             R6 2 1
       62 GETUPVAL                         R7 6
       63 GETTABLEKS                       R7 R7 K12 ["createPropertyHelpers"]
       65 MOVE                             R8 R0
       66 CALL                             R7 1 1
       67 GETUPVAL                         R8 0
       68 GETTABLEKS                       R8 R8 K13 ["useCallback"]
       70 NEWCLOSURE                       R9 P2
       71 CAPTURE                          UPVAL U7
       72 CAPTURE                          VAL R5
       73 CAPTURE                          VAL R1
       ...
       87 CALL                             R8 2 1
       88 GETUPVAL                         R9 0
       89 GETTABLEKS                       R9 R9 K7 ["useMemo"]
      ...
      167 JUMP                             ; [+5]
      168 GETUPVAL                         R13 9
      169 GETTABLEKS                       R13 R13 K42 ["NUMBER_PRECISION"]
      171 GETTABLEKS                       R13 R13 K43 ["Float"]
      173 SETTABLEKS                       R13 R12 K38 ["Precision"]
      175 CALL                             R11 1 1
      176 SETTABLEKS                       R11 R10 K19 ["Property_Position"]
      178 GETUPVAL                         R11 0
      179 GETTABLEKS                       R11 R11 K44 ["createElement"]
      181 GETUPVAL                         R12 10
      ...
      207 GETTABLEKS                       R13 R0 K2 ["GraphPayload"]
      209 GETTABLEKS                       R13 R13 K9 ["id"]
      ...
      232 GETUPVAL                         R11 0
      233 GETTABLEKS                       R11 R11 K44 ["createElement"]
      235 GETUPVAL                         R12 12
...
MAIN:
       ...
       34 GETTABLEKS                       R5 R5 K12 ["CompositorNodeInput"]
       36 GETTABLEKS                       R5 R5 K13 ["Blend1DInput"]
       38 CALL                             R4 1 1
       39 GETIMPORT                        R5 K5 [require]
       41 GETTABLEKS                       R6 R0 K10 ["Components"]
       43 GETTABLEKS                       R6 R6 K11 ["NodeView"]
       45 GETTABLEKS                       R6 R6 K14 ["CompositorNodeProperty"]
       47 GETTABLEKS                       R6 R6 K15 ["Blend1DMap"]
       49 CALL                             R5 1 1
       50 GETIMPORT                        R6 K5 [require]
       52 GETTABLEKS                       R7 R0 K10 ["Components"]
       54 GETTABLEKS                       R7 R7 K11 ["NodeView"]
       56 GETTABLEKS                       R7 R7 K16 ["CompositorNodes"]
       58 GETTABLEKS                       R7 R7 K17 ["CompositorNode"]
       60 CALL                             R6 1 1
       61 GETIMPORT                        R7 K5 [require]
       63 GETTABLEKS                       R8 R0 K18 ["Util"]
       65 GETTABLEKS                       R8 R8 K19 ["Nodes"]
       67 GETTABLEKS                       R8 R8 K20 ["CompositorNodeUtils"]
       69 CALL                             R7 1 1
       70 GETIMPORT                        R8 K5 [require]
       72 GETTABLEKS                       R9 R0 K18 ["Util"]
       74 GETTABLEKS                       R9 R9 K21 ["Constants"]
       76 CALL                             R8 1 1
       77 GETIMPORT                        R9 K5 [require]
       79 GETTABLEKS                       R10 R0 K10 ["Components"]
       81 GETTABLEKS                       R10 R10 K11 ["NodeView"]
       83 GETTABLEKS                       R10 R10 K12 ["CompositorNodeInput"]
       85 GETTABLEKS                       R10 R10 K22 ["InputPanelTypes"]
       87 CALL                             R9 1 1
       88 GETIMPORT                        R10 K5 [require]
       90 GETTABLEKS                       R11 R0 K23 ["Contexts"]
       92 GETTABLEKS                       R11 R11 K24 ["NativeGraphContext"]
       94 CALL                             R10 1 1
       95 GETIMPORT                        R11 K5 [require]
       97 GETTABLEKS                       R12 R0 K23 ["Contexts"]
       99 GETTABLEKS                       R12 R12 K25 ["ParameterOverrideContext"]
      101 CALL                             R11 1 1
      102 GETIMPORT                        R12 K5 [require]
      104 GETTABLEKS                       R13 R0 K10 ["Components"]
      106 GETTABLEKS                       R13 R13 K11 ["NodeView"]
      108 GETTABLEKS                       R13 R13 K14 ["CompositorNodeProperty"]
      110 GETTABLEKS                       R13 R13 K26 ["PropertyUtils"]
      112 CALL                             R12 1 1
      113 GETIMPORT                        R13 K5 [require]
      115 GETTABLEKS                       R14 R0 K10 ["Components"]
      117 GETTABLEKS                       R14 R14 K11 ["NodeView"]
      119 GETTABLEKS                       R14 R14 K16 ["CompositorNodes"]
