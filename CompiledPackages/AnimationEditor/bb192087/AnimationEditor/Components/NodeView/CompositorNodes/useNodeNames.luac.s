...
PROTO_1:
        ...
        1 JUMPIFNOT                        R0 ; [+8]
        2 GETUPVAL                         R0 1
        3 GETTABLEKS                       R0 R0 K0 ["observeNodePropsById"]
        5 GETUPVAL                         R1 0
        6 GETTABLEKS                       R1 R1 K1 ["id"]
        8 CALL                             R0 1 -1
        9 RETURN                           R0 -1
       10 GETUPVAL                         R0 2
       11 GETTABLEKS                       R0 R0 K2 ["of"]
       13 LOADNIL                          R1
       14 CALL                             R0 1 -1
       15 RETURN                           R0 -1
...
PROTO_2:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["className"]
        3 JUMPIFNOT                        R1 ; [+14]
        4 GETUPVAL                         R0 0
        5 GETTABLEKS                       R0 R0 K0 ["className"]
        7 LOADK                            R2 K1 ["Node$"]
        8 LOADK                            R3 K2 [""]
...
PROTO_3:
        ...
        8 JUMPIFNOT                        R0 ; [+3]
        9 GETUPVAL                         R0 1
       10 GETTABLEKS                       R0 R0 K2 ["AnimationId"]
       ...
       20 RETURN                           R1 1
       21 GETUPVAL                         R1 2
       22 GETTABLEKS                       R1 R1 K6 ["getAssetNameAsync"]
       24 MOVE                             R2 R0
       25 CALL                             R1 1 -1
       26 RETURN                           R1 -1
...
PROTO_4:
       ...
       43 CALL                             R4 2 1
       44 GETUPVAL                         R5 5
       45 GETTABLEKS                       R5 R5 K6 ["useAsync"]
       47 NEWCLOSURE                       R6 P2
       48 CAPTURE                          VAL R0
       49 CAPTURE                          VAL R3
       50 CAPTURE                          VAL R1
      ...
      104 GETUPVAL                         R8 6
      105 GETTABLEKS                       R8 R8 K25 ["PARAMETER_NODE_CLASSNAME"]
...
MAIN:
       ...
       42 GETTABLEKS                       R7 R0 K12 ["Parent"]
       44 GETTABLEKS                       R7 R7 K14 ["ReactUtils"]
       46 CALL                             R6 1 1
       47 GETIMPORT                        R7 K5 [require]
       49 GETTABLEKS                       R8 R0 K8 ["Util"]
       51 GETTABLEKS                       R8 R8 K15 ["Signals"]
       53 GETTABLEKS                       R8 R8 K16 ["SignalsInstanceUtils"]
       55 CALL                             R7 1 1
       56 GETIMPORT                        R8 K5 [require]
       58 GETTABLEKS                       R9 R0 K12 ["Parent"]
       60 GETTABLEKS                       R9 R9 K17 ["SignalsReact"]
       62 CALL                             R8 1 1
