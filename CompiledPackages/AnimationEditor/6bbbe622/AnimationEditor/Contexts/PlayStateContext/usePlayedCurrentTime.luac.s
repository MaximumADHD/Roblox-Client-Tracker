PROTO_0:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R1 R2 K0 ["timeRange"]
        3 GETTABLEKS                       R0 R1 K1 ["Min"]
        5 RETURN                           R0 1

PROTO_1:
        0 GETUPVAL                         R1 0
        1 GETUPVAL                         R6 1
        2 GETTABLEKS                       R5 R6 K0 ["current"]
        4 GETTABLEKS                       R4 R5 K1 ["Min"]
        6 GETUPVAL                         R7 1
        7 GETTABLEKS                       R6 R7 K0 ["current"]
        9 GETTABLEKS                       R5 R6 K2 ["Max"]
...
PROTO_2:
       ...
       10 SUB                              R7 R8 R9
       11 GETUPVAL                         R9 3
       12 GETTABLEKS                       R8 R9 K0 ["current"]
       14 MUL                              R6 R7 R8
       15 ADD                              R4 R5 R6
...
PROTO_3:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R1 R2 K0 ["isAutomaticallyPlayingRef"]
...
PROTO_5:
       ...
       18 CAPTURE                          UPVAL U4
       19 GETUPVAL                         R4 5
       20 GETTABLEKS                       R3 R4 K5 ["RenderStepped"]
       22 MOVE                             R5 R2
       23 NAMECALL                         R3 R3 K6 ["Connect"]
       25 CALL                             R3 2 1
       26 GETUPVAL                         R6 0
       27 GETTABLEKS                       R5 R6 K0 ["isAutomaticallyPlayingRef"]
       29 GETTABLEKS                       R4 R5 K1 ["current"]
       31 JUMPIF                           R4 ; [+1]
       32 JUMP                             ; [+7]
       33 GETUPVAL                         R4 2
       34 NEWCLOSURE                       R5 P1
...
PROTO_6:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R1 R2 K0 ["useRefToState"]
        3 GETTABLEKS                       R2 R0 K1 ["timeRange"]
        5 CALL                             R1 1 1
        6 GETUPVAL                         R3 0
        7 GETTABLEKS                       R2 R3 K0 ["useRefToState"]
        9 GETTABLEKS                       R3 R0 K2 ["playbackSpeed"]
       11 CALL                             R2 1 1
       12 GETUPVAL                         R4 1
       13 GETTABLEKS                       R3 R4 K3 ["useCallback"]
       15 NEWCLOSURE                       R4 P0
       16 CAPTURE                          VAL R0
       17 NEWTABLE                         R5 0 1
       ...
       40 CALL                             R6 2 1
       41 GETUPVAL                         R8 1
       42 GETTABLEKS                       R7 R8 K5 ["useEffect"]
       44 NEWCLOSURE                       R8 P2
       45 CAPTURE                          VAL R0
       46 CAPTURE                          VAL R4
       47 CAPTURE                          VAL R5
       ...
       50 CAPTURE                          UPVAL U2
       51 NEWTABLE                         R9 0 2
       53 GETTABLEKS                       R11 R0 K6 ["isAutomaticallyPlayingRef"]
       55 GETTABLEKS                       R10 R11 K7 ["current"]
       57 MOVE                             R11 R1
