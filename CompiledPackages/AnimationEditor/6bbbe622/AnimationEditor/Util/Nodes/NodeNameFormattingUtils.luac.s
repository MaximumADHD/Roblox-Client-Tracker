...
PROTO_1:
        0 JUMPIFNOT                        R0 ; [+6]
        1 GETUPVAL                         R3 0
        2 GETTABLEKS                       R2 R3 K0 ["PARAMETER_NODE_CLASSNAME"]
        4 JUMPIFNOTEQ                      R1 R2 ; [+2]
        6 RETURN                           R0 1
        7 JUMPIFNOT                        R0 ; [+40]
        8 JUMPIFNOT                        R1 ; [+39]
        9 GETUPVAL                         R3 1
       10 GETTABLEKS                       R2 R3 K1 ["formatName"]
       12 MOVE                             R3 R1
       13 CALL                             R2 1 1
       14 GETUPVAL                         R4 1
       15 GETTABLEKS                       R3 R4 K1 ["formatName"]
       17 MOVE                             R4 R0
       18 CALL                             R3 1 1
       ...
       33 MOVE                             R3 R4
       34 GETUPVAL                         R5 1
       35 GETTABLEKS                       R4 R5 K1 ["formatName"]
       37 MOVE                             R5 R3
       38 CALL                             R4 1 1
       39 MOVE                             R3 R4
       40 LOADK                            R5 K8 ["%* (%*)"]
       ...
       48 JUMPIFNOT                        R0 ; [+6]
       49 GETUPVAL                         R3 1
       50 GETTABLEKS                       R2 R3 K1 ["formatName"]
       52 MOVE                             R3 R0
       53 CALL                             R2 1 -1
       54 RETURN                           R2 -1
       55 JUMPIFNOT                        R1 ; [+6]
       56 GETUPVAL                         R3 1
       57 GETTABLEKS                       R2 R3 K1 ["formatName"]
       59 MOVE                             R3 R1
       60 CALL                             R2 1 -1
       61 RETURN                           R2 -1
