...
PROTO_2:
        ...
        6 GETIMPORT                        R1 K3 [assert]
        8 CALL                             R1 2 0
        9 DUPTABLE                         R1 K11 [{"GraphPayload", "Position", "PropertyLookup", "StateLookup", "IsGeneric", "Size", "text"}]
       10 GETUPVAL                         R4 0
       11 GETTABLEKS                       R3 R4 K12 ["lookup"]
       13 GETUPVAL                         R5 0
       14 GETTABLEKS                       R4 R5 K0 ["output"]
       16 GETTABLE                         R2 R3 R4
       17 SETTABLEKS                       R2 R1 K4 ["GraphPayload"]
       19 GETIMPORT                        R2 K15 [Vector2.zero]
       ...
       34 GETIMPORT                        R2 K17 [Vector2.new]
       36 LOADN                            R3 100
       37 LOADN                            R4 100
       38 CALL                             R2 2 1
       39 SETTABLEKS                       R2 R1 K9 ["Size"]
       41 LOADK                            R2 K18 ["Test Node"]
       42 SETTABLEKS                       R2 R1 K10 ["text"]
       44 JUMPIFNOT                        R0 ; [+8]
       45 GETIMPORT                        R2 K20 [pairs]
       47 MOVE                             R3 R0
       48 CALL                             R2 1 3
       49 FORGPREP_NEXT                    R2
       50 SETTABLE                         R6 R1 R5
       51 FORGLOOP                         R2 2 ; [-2]
       53 RETURN                           R1 1
