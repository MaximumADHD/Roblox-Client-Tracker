PROTO_0:
       ...
       14 RETURN                           R0 0
       15 GETUPVAL                         R4 0
       16 GETTABLEKS                       R3 R4 K0 ["OnPropertyChanged"]
       ...
       24 JUMPIFNOT                        R2 ; [+43]
       25 GETUPVAL                         R4 0
       26 GETTABLEKS                       R3 R4 K0 ["OnPropertyChanged"]
       28 LOADK                            R4 K3 ["Trim"]
       29 LOADB                            R5 0
       30 CALL                             R3 2 0
       31 GETUPVAL                         R4 0
       32 GETTABLEKS                       R3 R4 K0 ["OnPropertyChanged"]
       34 LOADK                            R4 K4 ["TrimStart"]
       35 LOADN                            R5 0
       36 CALL                             R3 2 0
       37 GETUPVAL                         R4 0
       38 GETTABLEKS                       R3 R4 K0 ["OnPropertyChanged"]
       ...
       46 JUMPIFNOT                        R3 ; [+7]
       47 GETUPVAL                         R4 0
       48 GETTABLEKS                       R3 R4 K0 ["OnPropertyChanged"]
       ...
       60 JUMPIFNOT                        R3 ; [+7]
       61 GETUPVAL                         R4 0
       62 GETTABLEKS                       R3 R4 K0 ["OnPropertyChanged"]
...
PROTO_5:
       ...
       20 CALL                             R3 2 1
       21 GETUPVAL                         R5 0
       22 GETTABLEKS                       R4 R5 K1 ["useCallback"]
       24 NEWCLOSURE                       R5 P1
       25 CAPTURE                          VAL R0
       26 NEWTABLE                         R6 0 1
       ...
       52 CALL                             R5 2 0
       53 GETUPVAL                         R6 3
       54 GETTABLEKS                       R5 R6 K6 ["createPropertyHelpers"]
       56 MOVE                             R6 R0
       57 CALL                             R5 1 1
       58 GETUPVAL                         R7 2
       59 CALL                             R7 0 1
       60 JUMPIFNOT                        R7 ; [+30]
       61 GETUPVAL                         R7 0
       62 GETTABLEKS                       R6 R7 K7 ["useMemo"]
       64 NEWCLOSURE                       R7 P3
       65 CAPTURE                          UPVAL U4
       66 CAPTURE                          VAL R1
       67 CAPTURE                          VAL R0
      ...
      246 JUMP                             ; [+5]
      247 GETUPVAL                         R12 6
      248 GETTABLEKS                       R11 R12 K54 ["NUMBER_PRECISION"]
      250 GETTABLEKS                       R10 R11 K55 ["Float"]
      ...
      412 GETUPVAL                         R9 0
      413 GETTABLEKS                       R8 R9 K71 ["createElement"]
      415 GETUPVAL                         R9 7
