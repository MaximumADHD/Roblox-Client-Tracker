...
PROTO_1:
       ...
       14 CALL                             R1 2 0
       15 GETUPVAL                         R2 0
       16 GETTABLEKS                       R1 R2 K6 ["observeViewportRect"]
       18 LOADB                            R2 0
       19 CALL                             R1 1 1
       20 GETUPVAL                         R3 1
       21 GETTABLEKS                       R2 R3 K7 ["getNodeInsertPosition"]
       23 MOVE                             R3 R1
       24 CALL                             R2 1 1
...
PROTO_2:
        0 NEWTABLE                         R0 0 0
        2 GETUPVAL                         R4 0
        3 GETTABLEKS                       R1 R4 K0 ["PARAMETER_MENUITEM_TABLE"]
        5 LOADNIL                          R2
        6 LOADNIL                          R3
        7 FORGPREP                         R1
...
PROTO_3:
       ...
       14 CALL                             R1 1 1
       15 GETUPVAL                         R3 1
       16 GETTABLEKS                       R2 R3 K3 ["useContext"]
       18 GETUPVAL                         R4 3
       19 GETTABLEKS                       R3 R4 K4 ["Context"]
       21 CALL                             R2 1 1
       22 GETUPVAL                         R4 4
       23 GETTABLEKS                       R3 R4 K5 ["useEventCallback"]
       25 NEWCLOSURE                       R4 P0
       26 CAPTURE                          VAL R2
       27 CAPTURE                          UPVAL U5
       28 CAPTURE                          VAL R1
       ...
       30 CALL                             R3 1 1
       31 GETUPVAL                         R5 1
       32 GETTABLEKS                       R4 R5 K6 ["useMemo"]
       34 NEWCLOSURE                       R5 P1
       35 CAPTURE                          UPVAL U6
       36 CAPTURE                          VAL R3
       37 NEWTABLE                         R6 0 0
...
MAIN:
       ...
       13 GETTABLEKS                       R3 R4 K8 ["ParameterPane"]
       ...
       36 GETTABLEKS                       R7 R8 K7 ["NodeView"]
       38 GETTABLEKS                       R6 R7 K8 ["ParameterPane"]
       40 GETTABLEKS                       R5 R6 K14 ["ParameterPaneUtils"]
       42 CALL                             R4 1 1
       43 GETIMPORT                        R5 K5 [require]
       45 GETTABLEKS                       R7 R0 K10 ["Parent"]
       ...
       59 GETTABLEKS                       R9 R0 K12 ["Contexts"]
       61 GETTABLEKS                       R8 R9 K17 ["ViewportRectContext"]
       63 CALL                             R7 1 1
       64 GETIMPORT                        R8 K5 [require]
       66 GETTABLEKS                       R10 R0 K18 ["Flags"]
       68 GETTABLEKS                       R9 R10 K19 ["getFFlagAnimGraphInsertParameterContextMenu"]
       70 CALL                             R8 1 1
