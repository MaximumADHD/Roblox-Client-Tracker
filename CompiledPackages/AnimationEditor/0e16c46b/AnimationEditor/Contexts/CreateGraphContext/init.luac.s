...
MAIN:
       ...
       55 GETTABLEKS                       R8 R8 K20 ["NodeGraphing"]
       57 CALL                             R7 1 1
       ...
       74 GETTABLEKS                       R11 R0 K13 ["Contexts"]
       76 GETTABLEKS                       R11 R11 K23 ["RigListContext"]
       78 CALL                             R10 1 1
       79 GETIMPORT                        R11 K10 [require]
       81 GETTABLEKS                       R12 R0 K13 ["Contexts"]
       83 GETTABLEKS                       R12 R12 K24 ["SelectionServiceContext"]
       85 CALL                             R11 1 1
       86 GETIMPORT                        R12 K10 [require]
       88 GETTABLEKS                       R13 R0 K11 ["Parent"]
       90 GETTABLEKS                       R13 R13 K25 ["Signals"]
       92 CALL                             R12 1 1
       93 GETIMPORT                        R13 K10 [require]
       95 GETTABLEKS                       R14 R0 K17 ["Util"]
       97 GETTABLEKS                       R14 R14 K25 ["Signals"]
       99 GETTABLEKS                       R14 R14 K26 ["SignalsInstanceUtils"]
      101 CALL                             R13 1 1
      102 GETIMPORT                        R14 K10 [require]
      104 GETTABLEKS                       R15 R0 K11 ["Parent"]
      106 GETTABLEKS                       R15 R15 K27 ["SignalsReact"]
      108 CALL                             R14 1 1
      109 GETIMPORT                        R15 K10 [require]
      111 GETTABLEKS                       R16 R0 K17 ["Util"]
      113 GETTABLEKS                       R16 R16 K25 ["Signals"]
      115 GETTABLEKS                       R16 R16 K28 ["TypedInstanceSignals"]
      117 CALL                             R15 1 1
      118 GETIMPORT                        R16 K10 [require]
      120 GETTABLEKS                       R17 R0 K13 ["Contexts"]
      122 GETTABLEKS                       R17 R17 K29 ["CreateGraphContext"]
      124 GETTABLEKS                       R17 R17 K30 ["insertAnimationClip"]
      126 CALL                             R16 1 1
      127 GETIMPORT                        R17 K10 [require]
      129 GETTABLEKS                       R18 R0 K31 ["Flags"]
      131 GETTABLEKS                       R18 R18 K32 ["getFFlagAnimGraphUISortGraphElements"]
      133 CALL                             R17 1 1
      134 DUPTABLE                         R18 K37 [{"canCreateGraph", "selectedTargetName", "createGraphFromIdAsync", "createNewGraphAsync"}]
      135 LOADB                            R19 0
      136 SETTABLEKS                       R19 R18 K33 ["canCreateGraph"]
      138 LOADNIL                          R19
      139 SETTABLEKS                       R19 R18 K34 ["selectedTargetName"]
      141 GETTABLEKS                       R19 R9 K38 ["createUnimplemented"]
      143 LOADK                            R20 K35 ["createGraphFromIdAsync"]
      144 CALL                             R19 1 1
      145 SETTABLEKS                       R19 R18 K35 ["createGraphFromIdAsync"]
      147 GETTABLEKS                       R19 R9 K38 ["createUnimplemented"]
      149 LOADK                            R20 K36 ["createNewGraphAsync"]
      150 CALL                             R19 1 1
      151 SETTABLEKS                       R19 R18 K36 ["createNewGraphAsync"]
      153 GETTABLEKS                       R19 R8 K39 ["createContext"]
      155 MOVE                             R20 R18
      156 CALL                             R19 1 1
      157 DUPTABLE                         R20 K42 [{"CAN_CREATE_GRAPH", "SELECTED_TARGET_NAME"}]
      158 LOADK                            R21 K43 ["CreateGraphContext_CanCreateGraph"]
      159 SETTABLEKS                       R21 R20 K40 ["CAN_CREATE_GRAPH"]
      161 LOADK                            R21 K44 ["CreateGraphContext_SelectedTargetName"]
      162 SETTABLEKS                       R21 R20 K41 ["SELECTED_TARGET_NAME"]
      164 DUPTABLE                         R21 K47 [{"CREATE_NEW_GRAPH", "CREATE_GRAPH_FROM_ID"}]
      165 LOADK                            R22 K48 ["CreateGraphContext_CreateNewGraphAsync"]
      166 SETTABLEKS                       R22 R21 K45 ["CREATE_NEW_GRAPH"]
      168 LOADK                            R22 K49 ["CreateGraphContext_CreateGraphFromIdAsync"]
      169 SETTABLEKS                       R22 R21 K46 ["CREATE_GRAPH_FROM_ID"]
      171 DUPCLOSURE                       R22 K50 [PROTO_5]
      172 CAPTURE                          VAL R3
      173 CAPTURE                          VAL R8
      174 CAPTURE                          VAL R11
      175 CAPTURE                          VAL R10
      ...
      187 CAPTURE                          VAL R21
      188 CAPTURE                          VAL R19
      189 DUPCLOSURE                       R23 K51 [PROTO_6]
      190 CAPTURE                          VAL R6
      191 CAPTURE                          VAL R20
      192 CAPTURE                          VAL R21
      193 CAPTURE                          VAL R8
      194 CAPTURE                          VAL R19
      195 DUPTABLE                         R24 K55 [{"Context", "EditableDataModelProvider", "UIDataModelProvider"}]
      196 SETTABLEKS                       R19 R24 K52 ["Context"]
      198 SETTABLEKS                       R22 R24 K53 ["EditableDataModelProvider"]
      200 SETTABLEKS                       R23 R24 K54 ["UIDataModelProvider"]
      202 RETURN                           R24 1
