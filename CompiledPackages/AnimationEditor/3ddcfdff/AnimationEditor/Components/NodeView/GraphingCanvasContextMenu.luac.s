...
PROTO_13:
       ...
       61 CALL                             R6 0 1
       62 JUMPIFNOT                        R6 ; [+23]
       63 DUPTABLE                         R5 K19 [{["id"] = "insertStateMachine", ["text"], ["onActivated"], ["isDisabled"]}]
       64 GETUPVAL                         R6 1
       65 LOADK                            R8 K7 ["Common"]
       66 LOADK                            R9 K8 ["AnimationEditor"]
       67 LOADK                            R10 K9 ["Menu"]
       68 LOADK                            R11 K20 ["InsertStateMachine"]
       69 NAMECALL                         R6 R6 K11 ["getExternalText"]
       71 CALL                             R6 5 1
       72 SETTABLEKS                       R6 R5 K4 ["text"]
       74 GETUPVAL                         R6 6
       75 SETTABLEKS                       R6 R5 K18 ["onActivated"]
       77 GETUPVAL                         R7 0
       78 CALL                             R7 0 1
       79 JUMPIFNOT                        R7 ; [+2]
       80 GETUPVAL                         R6 3
       81 JUMP                             ; [+1]
       82 LOADNIL                          R6
       83 SETTABLEKS                       R6 R5 K5 ["isDisabled"]
       85 JUMP                             ; [+1]
       86 LOADNIL                          R5
       87 SETLIST                          R2 R3 3 [1]
       89 SETTABLEKS                       R2 R1 K0 ["items"]
       91 DUPTABLE                         R2 K1 [{"items"}]
       92 GETUPVAL                         R3 7
       93 SETTABLEKS                       R3 R2 K0 ["items"]
       95 DUPTABLE                         R3 K1 [{"items"}]
       96 NEWTABLE                         R4 0 1
       98 DUPTABLE                         R5 K22 [{["id"] = "frameSelection", ["text"], ["onActivated"]}]
       99 GETUPVAL                         R7 0
      100 CALL                             R7 0 1
      101 JUMPIFNOT                        R7 ; [+20]
      102 GETUPVAL                         R7 8
      103 JUMPIFNOT                        R7 ; [+9]
      104 GETUPVAL                         R6 1
      105 LOADK                            R8 K7 ["Common"]
      106 LOADK                            R9 K8 ["AnimationEditor"]
      107 LOADK                            R10 K9 ["Menu"]
      108 LOADK                            R11 K23 ["FrameSelection"]
      109 NAMECALL                         R6 R6 K11 ["getExternalText"]
      111 CALL                             R6 5 1
      112 JUMP                             ; [+10]
      113 GETUPVAL                         R6 1
      114 LOADK                            R8 K7 ["Common"]
      115 LOADK                            R9 K8 ["AnimationEditor"]
      116 LOADK                            R10 K9 ["Menu"]
      117 LOADK                            R11 K24 ["FrameAll"]
      118 NAMECALL                         R6 R6 K11 ["getExternalText"]
      120 CALL                             R6 5 1
      121 JUMP                             ; [+1]
      122 LOADK                            R6 K25 ["Frame Selection"]
      123 SETTABLEKS                       R6 R5 K4 ["text"]
      125 GETUPVAL                         R7 0
      126 CALL                             R7 0 1
      127 JUMPIFNOT                        R7 ; [+2]
      128 GETUPVAL                         R6 9
      129 JUMP                             ; [+3]
      130 GETUPVAL                         R6 10
      131 GETTABLEKS                       R6 R6 K21 ["frameSelection"]
      133 SETTABLEKS                       R6 R5 K18 ["onActivated"]
      135 SETLIST                          R4 R5 1 [1]
      137 SETTABLEKS                       R4 R3 K0 ["items"]
      139 SETLIST                          R0 R1 3 [1]
      141 RETURN                           R0 1
...
PROTO_14:
      ...
      219 MOVE                             R26 R18
      220 JUMP                             ; [+2]
      221 GETTABLEKS                       R26 R1 K26 ["frameSelection"]
      223 GETUPVAL                         R28 6
      224 CALL                             R28 0 1
      225 JUMPIFNOT                        R28 ; [+2]
      226 MOVE                             R27 R19
      ...
      235 MOVE                             R29 R2
      236 MOVE                             R30 R16
      237 GETTABLEKS                       R31 R14 K17 ["duplicate"]
      239 GETTABLEKS                       R31 R31 K27 ["menuItem"]
      241 GETTABLEKS                       R32 R14 K18 ["delete"]
      243 GETTABLEKS                       R32 R32 K27 ["menuItem"]
      245 MOVE                             R33 R13
      246 SETLIST                          R23 R24 10 [1]
      248 CALL                             R21 2 1
      249 GETTABLEKS                       R22 R0 K28 ["isOpen"]
      251 JUMPIF                           R22 ; [+2]
      252 LOADNIL                          R22
      253 RETURN                           R22 1
      254 GETUPVAL                         R22 0
      255 GETTABLEKS                       R22 R22 K29 ["createElement"]
      257 GETUPVAL                         R23 14
      258 GETTABLEKS                       R23 R23 K30 ["Menu"]
      260 DUPTABLE                         R24 K35 [{"isOpen", "items", "onActivated", "onPressedOutside", "size"}]
      261 GETTABLEKS                       R25 R0 K28 ["isOpen"]
      263 SETTABLEKS                       R25 R24 K28 ["isOpen"]
      265 GETTABLEKS                       R26 R9 K36 ["isParameterOnlyInsertMenu"]
      267 JUMPIFNOT                        R26 ; [+2]
      268 MOVE                             R25 R10
      269 JUMP                             ; [+6]
      270 GETTABLEKS                       R26 R9 K37 ["isDataOnlyInsertMenu"]
      272 JUMPIFNOT                        R26 ; [+2]
      273 MOVE                             R25 R6
      274 JUMP                             ; [+1]
      275 MOVE                             R25 R21
      276 SETTABLEKS                       R25 R24 K31 ["items"]
      278 SETTABLEKS                       R17 R24 K32 ["onActivated"]
      280 GETTABLEKS                       R25 R0 K11 ["close"]
      282 SETTABLEKS                       R25 R24 K33 ["onPressedOutside"]
      284 GETUPVAL                         R25 14
      285 GETTABLEKS                       R25 R25 K38 ["Enums"]
      287 GETTABLEKS                       R25 R25 K39 ["InputSize"]
      289 GETTABLEKS                       R25 R25 K40 ["XSmall"]
      291 SETTABLEKS                       R25 R24 K34 ["size"]
      293 CALL                             R22 2 -1
      294 RETURN                           R22 -1
