...
PROTO_4:
       ...
       70 CLOSEUPVALS                      R2
       71 RETURN                           R0 0
       72 LOADK                            R4 K23 ["rbxassetid://%*"]
       73 MOVE                             R6 R3
       74 NAMECALL                         R4 R4 K24 ["format"]
       76 CALL                             R4 2 1
       77 GETIMPORT                        R5 K12 [Instance.new]
       79 LOADK                            R6 K25 ["Animation"]
       80 CALL                             R5 1 1
       81 SETTABLEKS                       R4 R5 K26 ["AnimationId"]
       83 LOADK                            R8 K27 ["AnimationEditor_GraphAnimation"]
       84 NAMECALL                         R6 R5 K28 ["AddTag"]
       86 CALL                             R6 2 0
       87 GETIMPORT                        R6 K1 [script]
       89 SETTABLEKS                       R6 R5 K2 ["Parent"]
       91 NEWCLOSURE                       R6 P0
       92 CAPTURE                          REF R2
       93 CAPTURE                          VAL R4
       94 LOADNIL                          R7
       ...
       99 GETUPVAL                         R9 0
      100 MOVE                             R11 R8
      101 GETIMPORT                        R12 K32 [Enum.StepFrequency.Hz60]
      103 LOADN                            R13 1999
      104 NAMECALL                         R9 R9 K33 ["BindToSimulation"]
      106 CALL                             R9 4 1
      107 MOVE                             R7 R9
      108 GETTABLEKS                       R9 R1 K34 ["Died"]
      110 NEWCLOSURE                       R11 P2
      111 CAPTURE                          REF R7
      112 NAMECALL                         R9 R9 K35 ["Once"]
      114 CALL                             R9 2 0
      115 CLOSEUPVALS                      R2
      116 RETURN                           R0 0
...
PROTO_6:
       ...
       31 LOADK                            R8 K9 ["Graph \"%*\" not found in ServerStorage.RBX_ANIMSAVES/%*"]
       32 MOVE                             R10 R0
       33 MOVE                             R11 R1
       34 NAMECALL                         R8 R8 K10 ["format"]
       36 CALL                             R8 3 1
       37 CALL                             R7 1 0
       38 LOADNIL                          R7
       39 RETURN                           R7 1
       40 MOVE                             R9 R6
       41 NAMECALL                         R7 R3 K11 ["RegisterAnimationClip"]
       43 CALL                             R7 2 -1
       44 RETURN                           R7 -1
...
PROTO_7:
       ...
       36 LOADK                            R8 K11 ["Graph clone \"%*\" not found in ReplicatedStorage.AnimationGraphEditor"]
       37 MOVE                             R10 R5
       ...
       43 RETURN                           R7 1
       44 MOVE                             R9 R6
       45 NAMECALL                         R7 R3 K13 ["RegisterAnimationClip"]
       47 CALL                             R7 2 -1
       48 RETURN                           R7 -1
