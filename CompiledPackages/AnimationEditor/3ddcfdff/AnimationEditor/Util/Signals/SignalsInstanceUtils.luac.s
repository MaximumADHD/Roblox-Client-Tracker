...
PROTO_30:
        ...
        9 CAPTURE                          VAL R0
       10 GETUPVAL                         R4 2
       11 GETTABLEKS                       R4 R4 K0 ["ChildAdded"]
       13 MOVE                             R6 R3
       14 NAMECALL                         R4 R4 K1 ["Connect"]
       16 CALL                             R4 2 1
       17 GETUPVAL                         R5 2
       18 GETTABLEKS                       R5 R5 K2 ["ChildRemoved"]
       20 NEWCLOSURE                       R7 P1
       21 CAPTURE                          REF R2
       22 CAPTURE                          REF R1
       23 CAPTURE                          VAL R0
...
PROTO_33:
        0 GETUPVAL                         R3 0
        1 GETTABLEKS                       R3 R3 K0 ["observeFirstNamedChild"]
        3 MOVE                             R4 R0
        4 NEWCLOSURE                       R5 P0
        5 CAPTURE                          VAL R1
        6 MOVE                             R6 R2
...
PROTO_37:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["InputPinsChanged"]
        3 NEWCLOSURE                       R3 P0
        4 CAPTURE                          VAL R0
        5 CAPTURE                          UPVAL U0
...
PROTO_42:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["AttributeChanged"]
        3 NEWCLOSURE                       R3 P0
        4 CAPTURE                          VAL R0
        5 CAPTURE                          UPVAL U0
        6 NAMECALL                         R1 R1 K1 ["Connect"]
...
PROTO_47:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["AncestryChanged"]
        3 NEWCLOSURE                       R3 P0
        4 CAPTURE                          VAL R0
        5 CAPTURE                          UPVAL U1
        6 NAMECALL                         R1 R1 K1 ["Connect"]
...
PROTO_53:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["ChildAdded"]
        3 NEWCLOSURE                       R3 P0
        4 CAPTURE                          VAL R0
        5 CAPTURE                          UPVAL U0
        6 NAMECALL                         R1 R1 K1 ["Connect"]
...
PROTO_59:
       ...
       23 CAPTURE                          VAL R0
       24 GETUPVAL                         R3 0
       25 GETTABLEKS                       R3 R3 K4 ["ChildAdded"]
       27 MOVE                             R5 R2
       28 NAMECALL                         R3 R3 K5 ["Connect"]
       30 CALL                             R3 2 1
       31 GETUPVAL                         R4 0
       32 GETTABLEKS                       R4 R4 K6 ["ChildRemoved"]
       34 NEWCLOSURE                       R6 P1
       35 CAPTURE                          VAL R1
       36 CAPTURE                          VAL R0
...
PROTO_62:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R2 R2 K0 ["observeChildrenWithPredicate"]
        3 MOVE                             R3 R0
        4 NEWCLOSURE                       R4 P0
        5 CAPTURE                          VAL R1
        6 CALL                             R2 2 -1
...
PROTO_69:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["DescendantAdded"]
        3 NEWCLOSURE                       R3 P0
        4 CAPTURE                          UPVAL U1
        5 CAPTURE                          VAL R0
        6 NAMECALL                         R1 R1 K1 ["Connect"]
        8 CALL                             R1 2 1
        9 GETUPVAL                         R2 0
       10 GETTABLEKS                       R2 R2 K2 ["DescendantRemoving"]
       12 NEWCLOSURE                       R4 P1
       13 CAPTURE                          UPVAL U1
       14 CAPTURE                          VAL R0
       15 CAPTURE                          UPVAL U0
...
PROTO_75:
       ...
       23 CAPTURE                          VAL R0
       24 GETUPVAL                         R3 0
       25 GETTABLEKS                       R3 R3 K4 ["DescendantAdded"]
       27 MOVE                             R5 R2
       28 NAMECALL                         R3 R3 K5 ["Connect"]
       30 CALL                             R3 2 1
       31 GETUPVAL                         R4 0
       32 GETTABLEKS                       R4 R4 K6 ["DescendantRemoving"]
       34 NEWCLOSURE                       R6 P1
       35 CAPTURE                          VAL R1
       36 CAPTURE                          VAL R0
       37 NAMECALL                         R4 R4 K5 ["Connect"]
...
PROTO_77:
       ...
       13 LOADNIL                          R11
       14 FORGPREP                         R9
       15 GETTABLE                         R14 R3 R13
       16 JUMPIF                           R14 ; [+9]
       17 FASTCALL2                        TABLE_INSERT R2 R13 ; [+5]
       19 MOVE                             R15 R2
       20 MOVE                             R16 R13
       21 GETIMPORT                        R14 K2 [table.insert]
       23 CALL                             R14 2 0
       24 LOADB                            R14 1
       25 SETTABLE                         R14 R3 R13
       26 FORGLOOP                         R9 2 ; [-12]
       28 FORGLOOP                         R4 2 ; [-18]
       30 RETURN                           R2 1
...
MAIN:
       ...
       43 GETTABLEKS                       R6 R6 K13 ["cleanHoles"]
       45 CALL                             R5 1 1
       46 NEWTABLE                         R6 16 0
      ...
      125 DUPCLOSURE                       R9 K48 [PROTO_78]
      126 CAPTURE                          VAL R1
      127 SETTABLEKS                       R9 R6 K49 ["observeFlattenListToUniqueItems"]
      129 RETURN                           R6 1
