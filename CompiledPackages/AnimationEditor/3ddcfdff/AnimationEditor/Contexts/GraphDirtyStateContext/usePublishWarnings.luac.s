PROTO_0:
        ...
        6 RETURN                           R0 0
        7 LOADK                            R3 K1 ["AnimationGraphDefinition[$%* = true]"]
        8 GETUPVAL                         R5 1
        9 NAMECALL                         R3 R3 K2 ["format"]
       11 CALL                             R3 2 1
       12 NAMECALL                         R1 R0 K3 ["QueryDescendants"]
       14 CALL                             R1 2 3
       15 FORGPREP                         R1
       16 GETUPVAL                         R6 2
       17 GETTABLEKS                       R6 R6 K4 ["sendUnsavedWarning"]
       19 MOVE                             R7 R5
       20 CALL                             R6 1 0
       21 FORGLOOP                         R1 2 ; [-6]
       23 RETURN                           R0 0
...
PROTO_2:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["publishGameSignal"]
        3 NEWCLOSURE                       R2 P0
        4 CAPTURE                          UPVAL U1
        5 CAPTURE                          UPVAL U2
        6 CAPTURE                          UPVAL U0
...
PROTO_7:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["unsavedGraphWarningClickedSignal"]
        3 NEWCLOSURE                       R2 P0
        4 CAPTURE                          UPVAL U1
        5 CAPTURE                          UPVAL U2
...
PROTO_8:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R2 R2 K0 ["ContextServices"]
        3 GETTABLEKS                       R2 R2 K1 ["Localization"]
        5 NAMECALL                         R2 R2 K2 ["use"]
        7 CALL                             R2 1 1
        8 GETUPVAL                         R3 1
        9 GETTABLEKS                       R3 R3 K3 ["useContext"]
       11 GETUPVAL                         R4 2
       12 GETTABLEKS                       R4 R4 K4 ["Context"]
       14 CALL                             R3 1 1
       15 GETUPVAL                         R4 1
       16 GETTABLEKS                       R4 R4 K5 ["useEffect"]
       18 NEWCLOSURE                       R5 P0
       19 CAPTURE                          VAL R3
       20 CAPTURE                          UPVAL U3
       21 CAPTURE                          VAL R1
       ...
       31 CALL                             R4 2 0
       32 GETUPVAL                         R4 1
       33 GETTABLEKS                       R4 R4 K5 ["useEffect"]
       35 NEWCLOSURE                       R5 P1
       36 CAPTURE                          VAL R3
       37 CAPTURE                          VAL R0
       38 CAPTURE                          VAL R2
...
MAIN:
       ...
       27 GETTABLEKS                       R4 R4 K12 ["PublishWarningContext"]
       29 CALL                             R3 1 1
