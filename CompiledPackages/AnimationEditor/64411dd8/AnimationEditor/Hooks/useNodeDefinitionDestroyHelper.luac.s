PROTO_0:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R0 R1 K0 ["observeNodeInfoLookupList"]
        3 GETUPVAL                         R1 1
        4 GETUPVAL                         R2 2
        5 CALL                             R0 2 -1
        6 RETURN                           R0 -1
...
PROTO_3:
        ...
        5 CALL                             R2 1 2
        6 GETUPVAL                         R5 1
        7 GETTABLEKS                       R4 R5 K1 ["useRefToState"]
        9 MOVE                             R5 R2
       10 CALL                             R4 1 1
       11 GETUPVAL                         R6 0
       12 GETTABLEKS                       R5 R6 K2 ["useMemo"]
       14 NEWCLOSURE                       R6 P0
       15 CAPTURE                          UPVAL U2
       16 CAPTURE                          VAL R0
       17 CAPTURE                          VAL R1
       ...
       24 CALL                             R5 2 1
       25 GETUPVAL                         R7 1
       26 GETTABLEKS                       R6 R7 K1 ["useRefToState"]
       28 MOVE                             R7 R5
       29 CALL                             R6 1 1
       30 GETUPVAL                         R8 0
       31 GETTABLEKS                       R7 R8 K3 ["useCallback"]
       33 NEWCLOSURE                       R8 P1
       34 CAPTURE                          VAL R4
       35 CAPTURE                          VAL R3
       36 NEWTABLE                         R9 0 1
       ...
       42 CALL                             R7 2 1
       43 GETUPVAL                         R9 1
       44 GETTABLEKS                       R8 R9 K1 ["useRefToState"]
       46 MOVE                             R9 R7
       47 CALL                             R8 1 1
       48 GETUPVAL                         R10 0
       49 GETTABLEKS                       R9 R10 K2 ["useMemo"]
...
MAIN:
       ...
       20 GETTABLEKS                       R4 R5 K10 ["NativeGraphContext"]
       22 GETTABLEKS                       R3 R4 K11 ["NativeGraphUtils"]
       24 CALL                             R2 1 1
       ...
       41 GETTABLEKS                       R6 R7 K15 ["ReactUtils"]
       43 CALL                             R5 1 1
       44 GETIMPORT                        R6 K5 [require]
       46 GETTABLEKS                       R8 R0 K13 ["Parent"]
       48 GETTABLEKS                       R7 R8 K16 ["Signals"]
       50 CALL                             R6 1 1
