PROTO_0:
        ...
        3 GETUPVAL                         R2 1
        4 GETTABLEKS                       R1 R2 K1 ["createSignal"]
        6 NEWTABLE                         R2 0 0
        8 CALL                             R1 1 1
        9 CALL                             R0 1 -1
       10 RETURN                           R0 -1
...
PROTO_1:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R0 R1 K0 ["isUnimplemented"]
        3 JUMPIFNOT                        R0 ; [+1]
        4 RETURN                           R0 0
        5 GETUPVAL                         R1 1
        6 GETTABLEKS                       R0 R1 K1 ["getServerStorageContainer"]
        8 CALL                             R0 0 1
       ...
       19 CALL                             R2 1 1
       20 GETUPVAL                         R4 3
       21 GETTABLEKS                       R3 R4 K5 ["logStat"]
       ...
       80 CALL                             R9 2 0
       81 GETUPVAL                         R10 5
       82 GETTABLEKS                       R9 R10 K28 ["observeGraphState"]
       84 GETUPVAL                         R10 0
       85 GETUPVAL                         R11 6
       86 GETUPVAL                         R13 7
       87 GETTABLEKS                       R12 R13 K29 ["createSignal"]
       89 MOVE                             R13 R8
       90 CALL                             R12 1 1
       91 CALL                             R9 3 1
       92 LOADB                            R10 0
      ...
      102 GETTABLEKS                       R14 R9 K33 ["graphPayloadMap"]
      104 GETTABLEKS                       R11 R14 K34 ["lookup"]
      106 LOADNIL                          R12
      107 LOADNIL                          R13
      108 FORGPREP                         R11
      ...
      123 GETUPVAL                         R12 3
      124 GETTABLEKS                       R11 R12 K38 ["logEvent"]
...
PROTO_5:
       ...
       13 CALL                             R2 1 1
       14 GETTABLEKS                       R1 R2 K3 ["instanceRegistry"]
       16 GETUPVAL                         R3 0
       17 GETTABLEKS                       R2 R3 K0 ["useContext"]
       19 GETUPVAL                         R4 3
       20 GETTABLEKS                       R3 R4 K2 ["Context"]
       22 CALL                             R2 1 1
       23 GETUPVAL                         R4 0
       ...
       29 CALL                             R3 1 1
       30 GETUPVAL                         R5 0
       31 GETTABLEKS                       R4 R5 K6 ["useCallback"]
       33 NEWCLOSURE                       R5 P1
       34 CAPTURE                          VAL R1
       35 CAPTURE                          UPVAL U6
       36 CAPTURE                          UPVAL U7
       ...
       52 CALL                             R4 2 1
       53 GETUPVAL                         R6 0
       54 GETTABLEKS                       R5 R6 K9 ["useEffect"]
       56 NEWCLOSURE                       R6 P2
       57 CAPTURE                          VAL R2
       58 CAPTURE                          VAL R4
       59 NEWTABLE                         R7 0 2
...
MAIN:
       ...
       28 GETTABLEKS                       R7 R2 K13 ["Util"]
       30 GETTABLEKS                       R6 R7 K14 ["Rig"]
       32 GETTABLEKS                       R5 R6 K15 ["AnimationRigDataUtils"]
       34 CALL                             R4 1 1
       35 GETIMPORT                        R5 K10 [require]
       37 GETTABLEKS                       R7 R2 K16 ["Contexts"]
       39 GETTABLEKS                       R6 R7 K17 ["InstanceRegistryContext"]
       41 CALL                             R5 1 1
       42 GETIMPORT                        R6 K10 [require]
       44 GETTABLEKS                       R9 R2 K13 ["Util"]
       46 GETTABLEKS                       R8 R9 K18 ["Instances"]
       48 GETTABLEKS                       R7 R8 K19 ["InstanceSelectionRegistry"]
       50 CALL                             R6 1 1
       51 GETIMPORT                        R7 K10 [require]
       53 GETIMPORT                        R10 K6 [script]
       55 GETTABLEKS                       R9 R10 K11 ["Parent"]
       57 GETTABLEKS                       R8 R9 K20 ["NativeGraphUtils"]
       59 CALL                             R7 1 1
       60 GETIMPORT                        R8 K10 [require]
       62 GETTABLEKS                       R10 R2 K11 ["Parent"]
       64 GETTABLEKS                       R9 R10 K21 ["React"]
       66 CALL                             R8 1 1
       67 GETIMPORT                        R9 K10 [require]
       69 GETTABLEKS                       R11 R2 K11 ["Parent"]
       71 GETTABLEKS                       R10 R11 K22 ["Signals"]
       73 CALL                             R9 1 1
       74 GETIMPORT                        R10 K10 [require]
       76 GETTABLEKS                       R12 R2 K16 ["Contexts"]
       78 GETTABLEKS                       R11 R12 K23 ["VisibleContext"]
       80 CALL                             R10 1 1
