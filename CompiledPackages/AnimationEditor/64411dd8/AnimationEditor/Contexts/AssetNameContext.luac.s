...
PROTO_2:
        ...
        7 GETUPVAL                         R2 2
        8 GETTABLEKS                       R1 R2 K2 ["current"]
       10 GETUPVAL                         R2 1
       11 DUPTABLE                         R3 K5 [{"state", "name"}]
       12 LOADK                            R4 K6 ["ok"]
       13 SETTABLEKS                       R4 R3 K3 ["state"]
       15 SETTABLEKS                       R0 R3 K4 ["name"]
       17 SETTABLE                         R3 R1 R2
       18 GETUPVAL                         R1 3
       19 LOADNIL                          R2
       20 LOADNIL                          R3
       21 FORGPREP                         R1
       22 GETIMPORT                        R6 K9 [task.spawn]
       24 MOVE                             R7 R5
       25 MOVE                             R8 R0
       26 CALL                             R6 2 0
       27 FORGLOOP                         R1 2 ; [-6]
...
PROTO_3:
       ...
       31 RETURN                           R2 1
       32 GETUPVAL                         R4 0
       33 GETTABLEKS                       R3 R4 K10 ["current"]
       ...
       51 GETUPVAL                         R6 0
       52 GETTABLEKS                       R5 R6 K10 ["current"]
...
PROTO_5:
       ...
       12 CALL                             R2 1 1
       13 GETUPVAL                         R4 0
       14 GETTABLEKS                       R3 R4 K2 ["useMemo"]
       16 NEWCLOSURE                       R4 P1
       17 CAPTURE                          VAL R2
       18 NEWTABLE                         R5 0 1
       20 MOVE                             R6 R2
       ...
       23 CALL                             R3 2 1
       24 GETUPVAL                         R5 0
       25 GETTABLEKS                       R4 R5 K3 ["createElement"]
       27 GETUPVAL                         R6 3
       28 GETTABLEKS                       R5 R6 K4 ["Provider"]
...
PROTO_6:
        ...
        2 MOVE                             R6 R0
        3 GETIMPORT                        R5 K2 [typeof]
        5 CALL                             R5 1 1
        6 JUMPIFNOTEQKS                    R5 K3 ["number"] ; [+3]
        8 MOVE                             R4 R0
        9 JUMP                             ; [+19]
       10 GETIMPORT                        R5 K6 [string.match]
       12 MOVE                             R6 R0
       13 LOADK                            R7 K7 ["^rbxassetid://([0-9]+)$"]
       14 CALL                             R5 2 1
       15 JUMPIF                           R5 ; [+5]
       16 GETIMPORT                        R5 K6 [string.match]
       18 MOVE                             R6 R0
       19 LOADK                            R7 K8 ["^([0-9]+)$"]
       20 CALL                             R5 2 1
       21 MOVE                             R4 R5
       22 JUMPIFNOT                        R4 ; [+6]
       23 FASTCALL1                        TONUMBER R5 ; [+3]
       24 MOVE                             R7 R5
       25 GETIMPORT                        R6 K10 [tonumber]
       27 CALL                             R6 1 1
       28 MOVE                             R4 R6
...
PROTO_8:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R1 R2 K0 ["useEventCallback"]
       ...
       19 GETUPVAL                         R5 2
       20 GETTABLEKS                       R4 R5 K4 ["Provider"]
...
MAIN:
       ...
       24 GETTABLEKS                       R4 R5 K12 ["ReactUtils"]
       26 CALL                             R3 1 1
       ...
       43 CAPTURE                          VAL R2
       44 CAPTURE                          VAL R5
       45 DUPTABLE                         R9 K23 [{"Context", "Provider", "MockProvider"}]
       46 SETTABLEKS                       R5 R9 K20 ["Context"]
       48 SETTABLEKS                       R7 R9 K21 ["Provider"]
       50 SETTABLEKS                       R8 R9 K22 ["MockProvider"]
       52 RETURN                           R9 1
