...
PROTO_2:
        ...
        6 GETTABLEKS                       R6 R0 K0 ["instance"]
        8 GETTABLEKS                       R5 R6 K1 ["Name"]
       10 GETTABLEKS                       R7 R1 K0 ["instance"]
       12 GETTABLEKS                       R6 R7 K1 ["Name"]
       14 JUMPIFLT                         R5 R6 ; [+2]
       16 LOADB                            R4 0 +1
       17 LOADB                            R4 1
       18 RETURN                           R4 1
...
PROTO_3:
        ...
        5 FORGPREP                         R2
        6 GETUPVAL                         R9 0
        7 GETTABLEKS                       R8 R9 K0 ["attributes"]
        9 GETTABLEKS                       R7 R8 K1 ["observeNumber"]
       11 GETTABLEKS                       R8 R6 K2 ["instance"]
       13 GETUPVAL                         R10 1
       14 GETTABLEKS                       R9 R10 K3 ["orderAttribute"]
       16 CALL                             R7 2 1
       17 GETUPVAL                         R8 2
       18 CALL                             R7 1 1
       19 ORK                              R8 R7 K4 [∞]
...
PROTO_5:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R1 R2 K0 ["observeDescendantsWithPredicate"]
        3 MOVE                             R2 R0
        4 NEWCLOSURE                       R3 P0
        5 CAPTURE                          VAL R0
        6 CALL                             R1 2 1
        7 GETUPVAL                         R3 1
        8 GETTABLEKS                       R2 R3 K1 ["createComputed"]
       10 NEWCLOSURE                       R3 P1
       11 CAPTURE                          VAL R1
       12 CAPTURE                          VAL R0
       13 CAPTURE                          UPVAL U2
...
MAIN:
       ...
       11 GETTABLEKS                       R3 R4 K7 ["MaskEditorContext"]
       13 GETTABLEKS                       R2 R3 K8 ["MasksConstants"]
       15 CALL                             R1 1 1
       16 GETIMPORT                        R2 K5 [require]
       18 GETTABLEKS                       R6 R0 K9 ["Util"]
       20 GETTABLEKS                       R5 R6 K10 ["Signals"]
       22 GETTABLEKS                       R4 R5 K11 ["Experimental"]
       24 GETTABLEKS                       R3 R4 K12 ["SignalExperimentalUtils"]
       26 CALL                             R2 1 1
       27 GETIMPORT                        R3 K5 [require]
       29 GETTABLEKS                       R5 R0 K13 ["Parent"]
       31 GETTABLEKS                       R4 R5 K10 ["Signals"]
       33 CALL                             R3 1 1
       34 GETIMPORT                        R4 K5 [require]
       36 GETTABLEKS                       R7 R0 K9 ["Util"]
       38 GETTABLEKS                       R6 R7 K10 ["Signals"]
       40 GETTABLEKS                       R5 R6 K14 ["SignalsInstanceUtils"]
       42 CALL                             R4 1 1
       43 GETIMPORT                        R5 K5 [require]
       45 GETTABLEKS                       R8 R0 K9 ["Util"]
       47 GETTABLEKS                       R7 R8 K10 ["Signals"]
       49 GETTABLEKS                       R6 R7 K15 ["TypedInstanceSignals"]
       51 CALL                             R5 1 1
