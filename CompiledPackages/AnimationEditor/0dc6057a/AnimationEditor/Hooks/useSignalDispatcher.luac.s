...
PROTO_11:
       ...
       11 CALL                             R1 1 1
       12 GETUPVAL                         R3 0
       13 GETTABLEKS                       R2 R3 K1 ["useMemo"]
       15 DUPCLOSURE                       R3 K2 [PROTO_1]
       16 CAPTURE                          UPVAL U1
       17 NEWTABLE                         R4 0 0
       19 CALL                             R2 2 2
       20 GETUPVAL                         R5 0
       21 GETTABLEKS                       R4 R5 K1 ["useMemo"]
       23 NEWCLOSURE                       R5 P1
       24 CAPTURE                          UPVAL U2
       25 CAPTURE                          VAL R2
       26 CAPTURE                          VAL R0
       ...
       33 CALL                             R4 2 1
       34 GETUPVAL                         R6 0
       35 GETTABLEKS                       R5 R6 K3 ["useCallback"]
       37 NEWCLOSURE                       R6 P2
       38 CAPTURE                          VAL R1
       39 CAPTURE                          UPVAL U1
       40 CAPTURE                          VAL R0
       ...
       47 CALL                             R5 2 1
       48 GETUPVAL                         R7 0
       49 GETTABLEKS                       R6 R7 K3 ["useCallback"]
       51 NEWCLOSURE                       R7 P3
       52 CAPTURE                          VAL R0
       53 CAPTURE                          VAL R3
       54 CAPTURE                          VAL R2
       ...
       63 CALL                             R6 2 1
       64 GETUPVAL                         R8 0
       65 GETTABLEKS                       R7 R8 K3 ["useCallback"]
       67 NEWCLOSURE                       R8 P4
       68 CAPTURE                          VAL R0
       69 CAPTURE                          VAL R3
       70 CAPTURE                          VAL R2
       ...
       75 CALL                             R7 2 1
       76 GETUPVAL                         R9 0
       77 GETTABLEKS                       R8 R9 K3 ["useCallback"]
       79 NEWCLOSURE                       R9 P5
       80 CAPTURE                          VAL R0
       81 NEWTABLE                         R10 0 1
       83 MOVE                             R11 R0
       ...
       86 CALL                             R8 2 1
       87 GETUPVAL                         R10 0
       88 GETTABLEKS                       R9 R10 K3 ["useCallback"]
       ...
       97 CALL                             R9 2 1
       98 GETUPVAL                         R11 0
       99 GETTABLEKS                       R10 R11 K1 ["useMemo"]
...
MAIN:
       ...
       16 GETTABLEKS                       R6 R0 K8 ["Util"]
       18 GETTABLEKS                       R5 R6 K9 ["Signals"]
       20 GETTABLEKS                       R4 R5 K10 ["Experimental"]
       22 GETTABLEKS                       R3 R4 K11 ["SignalExperimentalUtils"]
       24 CALL                             R2 1 1
       25 GETIMPORT                        R3 K5 [require]
       27 GETTABLEKS                       R5 R0 K6 ["Parent"]
       29 GETTABLEKS                       R4 R5 K9 ["Signals"]
       31 CALL                             R3 1 1
       32 DUPCLOSURE                       R4 K12 [PROTO_0]
       33 CAPTURE                          VAL R4
       34 DUPCLOSURE                       R5 K13 [PROTO_11]
       35 CAPTURE                          VAL R1
       36 CAPTURE                          VAL R3
       37 CAPTURE                          VAL R2
       38 CAPTURE                          VAL R4
