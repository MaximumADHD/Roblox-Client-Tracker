...
PROTO_17:
      ...
      167 CALL                             R15 1 0
      168 DUPTABLE                         R15 K44 [{"animationClip", "animationTrack", "animationId", "animator", "destroy"}]
      169 SETTABLEKS                       R6 R15 K40 ["animationClip"]
      171 SETTABLEKS                       R11 R15 K41 ["animationTrack"]
      173 SETTABLEKS                       R9 R15 K42 ["animationId"]
      175 SETTABLEKS                       R7 R15 K6 ["animator"]
      ...
      182 CAPTURE                          REF R7
      183 SETTABLEKS                       R16 R15 K43 ["destroy"]
      185 FASTCALL2                        TABLE_INSERT R0 R15 ; [+4]
      187 MOVE                             R14 R0
      188 GETIMPORT                        R13 K47 [table.insert]
      190 CALL                             R13 2 0
      191 CLOSEUPVALS                      R7
      192 FORGLOOP                         R1 2 ; [-185]
      194 GETIMPORT                        R1 K49 [table.freeze]
      196 MOVE                             R2 R0
      197 CALL                             R1 1 -1
      198 RETURN                           R1 -1
...
PROTO_21:
        ...
        1 CALL                             R0 0 1
        2 JUMPIFNOT                        R0 ; [+52]
        3 DUPTABLE                         R0 K4 [{"type", "graphId", "rigId", "retrievalData"}]
        4 LOADK                            R1 K5 ["edit"]
        5 SETTABLEKS                       R1 R0 K0 ["type"]
        7 GETUPVAL                         R1 1
        8 GETTABLEKS                       R1 R1 K6 ["instanceRegistry"]
       10 GETUPVAL                         R3 2
       11 GETTABLEKS                       R3 R3 K7 ["animationTrack"]
       13 NAMECALL                         R1 R1 K8 ["instanceToId"]
       15 CALL                             R1 2 1
       16 SETTABLEKS                       R1 R0 K1 ["graphId"]
       18 LOADK                            R1 K9 [""]
       19 SETTABLEKS                       R1 R0 K2 ["rigId"]
       21 DUPTABLE                         R1 K13 [{"animationId", "graphInstanceId", "loadAsEphemeral"}]
       22 GETUPVAL                         R2 2
       23 GETTABLEKS                       R2 R2 K10 ["animationId"]
       25 SETTABLEKS                       R2 R1 K10 ["animationId"]
       27 GETUPVAL                         R2 1
       28 GETTABLEKS                       R2 R2 K6 ["instanceRegistry"]
       30 GETUPVAL                         R4 2
       31 GETTABLEKS                       R4 R4 K14 ["animationClip"]
       33 NAMECALL                         R2 R2 K8 ["instanceToId"]
       35 CALL                             R2 2 1
       36 SETTABLEKS                       R2 R1 K11 ["graphInstanceId"]
       38 LOADB                            R2 0
       39 SETTABLEKS                       R2 R1 K12 ["loadAsEphemeral"]
       41 SETTABLEKS                       R1 R0 K3 ["retrievalData"]
       43 GETUPVAL                         R1 3
       44 GETTABLEKS                       R1 R1 K15 ["setDebugDataAsync"]
       46 MOVE                             R2 R0
       47 GETUPVAL                         R3 2
       48 GETTABLEKS                       R3 R3 K7 ["animationTrack"]
       50 NAMECALL                         R3 R3 K16 ["GetDebugData"]
       52 CALL                             R3 1 -1
       53 CALL                             R1 -1 0
       54 RETURN                           R0 0
       55 GETUPVAL                         R0 3
       56 GETTABLEKS                       R0 R0 K17 ["setDebugDataAsync_DEPRECATED"]
       58 GETUPVAL                         R1 2
       59 GETTABLEKS                       R1 R1 K7 ["animationTrack"]
       61 NAMECALL                         R1 R1 K16 ["GetDebugData"]
       63 CALL                             R1 1 -1
       64 CALL                             R0 -1 0
       65 RETURN                           R0 0
...
PROTO_23:
      ...
      102 CALL                             R7 1 0
      103 JUMP                             ; [+28]
      104 GETTABLEKS                       R6 R4 K2 ["animationTrack"]
      106 GETUPVAL                         R7 2
      107 GETTABLEKS                       R7 R7 K4 ["currentTime"]
      109 SETTABLEKS                       R7 R6 K23 ["TimePosition"]
      111 GETUPVAL                         R6 5
      112 NAMECALL                         R6 R6 K12 ["IsRunning"]
      114 CALL                             R6 1 1
      115 JUMPIF                           R6 ; [+16]
      116 GETIMPORT                        R6 K14 [pcall]
      118 NEWCLOSURE                       R7 P2
      119 CAPTURE                          VAL R4
      120 CALL                             R6 1 2
      121 JUMPIF                           R6 ; [+10]
      122 GETIMPORT                        R8 K16 [warn]
      124 LOADK                            R10 K17 ["Failed to step animations for preview: "]
      125 FASTCALL1                        TOSTRING R7 ; [+3]
      126 MOVE                             R12 R7
      127 GETIMPORT                        R11 K19 [tostring]
      129 CALL                             R11 1 1
      130 CONCAT                           R9 R10 R11
      131 CALL                             R8 1 0
      132 FORGLOOP                         R0 2 ; [-129]
      134 RETURN                           R0 0
...
PROTO_24:
      ...
      113 CAPTURE                          UPVAL U18
      114 CAPTURE                          VAL R5
      115 CAPTURE                          VAL R3
      116 NEWTABLE                         R13 0 6
      118 GETTABLEKS                       R14 R0 K12 ["isPlaying"]
      120 GETTABLEKS                       R15 R0 K11 ["currentTime"]
      122 MOVE                             R16 R9
      123 GETTABLEKS                       R17 R2 K13 ["animationParameters"]
      125 GETUPVAL                         R19 18
      126 CALL                             R19 0 1
      127 JUMPIFNOT                        R19 ; [+3]
      128 GETTABLEKS                       R18 R3 K14 ["setDebugDataAsync"]
      130 JUMP                             ; [+2]
      131 GETTABLEKS                       R18 R3 K15 ["setDebugDataAsync_DEPRECATED"]
      133 GETUPVAL                         R20 18
      134 CALL                             R20 0 1
      135 JUMPIFNOT                        R20 ; [+3]
      136 GETTABLEKS                       R19 R5 K4 ["instanceRegistry"]
      138 JUMP                             ; [+1]
      139 LOADNIL                          R19
      140 SETLIST                          R13 R14 6 [1]
      142 CALL                             R11 2 0
      143 RETURN                           R0 0
...
MAIN:
       ...
       89 GETTABLEKS                       R13 R13 K24 ["React"]
       91 CALL                             R12 1 1
       92 GETIMPORT                        R13 K11 [require]
       94 GETTABLEKS                       R14 R0 K12 ["Util"]
       96 GETTABLEKS                       R14 R14 K25 ["Signals"]
       98 GETTABLEKS                       R14 R14 K26 ["Experimental"]
      100 GETTABLEKS                       R14 R14 K27 ["SignalExperimentalUtils"]
      102 CALL                             R13 1 1
      103 GETIMPORT                        R14 K11 [require]
      105 GETTABLEKS                       R15 R0 K23 ["Parent"]
      107 GETTABLEKS                       R15 R15 K25 ["Signals"]
      109 CALL                             R14 1 1
      110 GETIMPORT                        R15 K11 [require]
      112 GETTABLEKS                       R16 R0 K12 ["Util"]
      114 GETTABLEKS                       R16 R16 K25 ["Signals"]
      116 GETTABLEKS                       R16 R16 K28 ["SignalsInstanceUtils"]
      118 CALL                             R15 1 1
      119 GETIMPORT                        R16 K11 [require]
      121 GETTABLEKS                       R17 R0 K29 ["Flags"]
      123 GETTABLEKS                       R17 R17 K30 ["getFFlagAnimEditorResetAnimationConstraints"]
      125 CALL                             R16 1 1
      126 GETIMPORT                        R17 K11 [require]
      128 GETTABLEKS                       R18 R0 K29 ["Flags"]
      130 GETTABLEKS                       R18 R18 K31 ["getFFlagAnimGraphUI_RunTimeDebug"]
      132 CALL                             R17 1 1
      133 GETIMPORT                        R18 K11 [require]
      135 GETTABLEKS                       R19 R0 K14 ["Contexts"]
      137 GETTABLEKS                       R19 R19 K32 ["MaskEditorContext"]
      139 GETTABLEKS                       R19 R19 K33 ["observeMaskDatum"]
      141 CALL                             R18 1 1
      142 DUPCLOSURE                       R19 K34 [PROTO_0]
      143 DUPCLOSURE                       R20 K35 [PROTO_1]
      144 CAPTURE                          VAL R16
      145 CAPTURE                          VAL R3
      146 DUPCLOSURE                       R21 K36 [PROTO_2]
      147 DUPCLOSURE                       R22 K37 [PROTO_24]
      148 CAPTURE                          VAL R12
      149 CAPTURE                          VAL R6
      150 CAPTURE                          VAL R5
      151 CAPTURE                          VAL R8
