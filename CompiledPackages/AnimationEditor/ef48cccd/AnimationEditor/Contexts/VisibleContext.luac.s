...
PROTO_2:
        0 DUPTABLE                         R0 K1 [{"isOpen"}]
        1 GETUPVAL                         R2 0
        2 GETTABLEKS                       R1 R2 K0 ["isOpen"]
        4 SETTABLEKS                       R1 R0 K0 ["isOpen"]
        6 RETURN                           R0 1

PROTO_3:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R1 R2 K0 ["useProducer"]
       ...
       21 GETUPVAL                         R4 2
       22 GETTABLEKS                       R3 R4 K4 ["Provider"]
...
MAIN:
       ...
       25 DUPTABLE                         R4 K13 [{"isOpen"}]
       26 LOADB                            R5 1
       27 SETTABLEKS                       R5 R4 K12 ["isOpen"]
       29 CALL                             R3 1 1
       30 GETTABLEKS                       R4 R1 K14 ["createReplicatedState"]
       32 LOADK                            R5 K15 ["AnimationEditor_isOpen"]
       33 CALL                             R4 1 1
       34 DUPCLOSURE                       R5 K16 [PROTO_1]
       35 CAPTURE                          VAL R4
       36 CAPTURE                          VAL R2
       37 CAPTURE                          VAL R3
       38 DUPCLOSURE                       R6 K17 [PROTO_3]
       39 CAPTURE                          VAL R4
       40 CAPTURE                          VAL R2
       41 CAPTURE                          VAL R3
       42 DUPTABLE                         R7 K21 [{"Context", "EditableDataModelProvider", "UIDataModelProvider"}]
       43 SETTABLEKS                       R3 R7 K18 ["Context"]
       45 SETTABLEKS                       R5 R7 K19 ["EditableDataModelProvider"]
       47 SETTABLEKS                       R6 R7 K20 ["UIDataModelProvider"]
       49 RETURN                           R7 1
