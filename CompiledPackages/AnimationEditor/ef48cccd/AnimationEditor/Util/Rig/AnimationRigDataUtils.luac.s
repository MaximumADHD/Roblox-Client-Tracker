...
PROTO_1:
       ...
       10 RETURN                           R0 1
       11 GETUPVAL                         R2 0
       12 GETTABLEKS                       R1 R2 K3 ["_findAnimatorParentFromAnimSaves"]
       14 MOVE                             R2 R0
       15 CALL                             R1 1 1
       16 JUMPIFNOT                        R1 ; [+1]
       17 RETURN                           R1 1
...
PROTO_2:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R1 R2 K0 ["findAnimatorParent"]
        3 MOVE                             R2 R0
        4 CALL                             R1 1 1
        5 JUMPIF                           R1 ; [+2]
        6 LOADNIL                          R2
...
PROTO_7:
       ...
       24 RETURN                           R2 1
       25 GETUPVAL                         R4 0
       26 GETTABLEKS                       R3 R4 K10 ["getOrCreateServerStorageContainer"]
       28 CALL                             R3 0 1
...
PROTO_12:
       ...
       31 GETUPVAL                         R6 0
       32 GETTABLEKS                       R5 R6 K10 ["loadAnimationRig"]
       34 MOVE                             R6 R4
       35 MOVE                             R7 R0
       36 CALL                             R5 2 1
       37 JUMPIF                           R5 ; [+5]
...
MAIN:
       ...
       30 CAPTURE                          VAL R1
       31 SETTABLEKS                       R2 R1 K17 ["getOrCreateAnimSavesFolder"]
       33 DUPCLOSURE                       R2 K18 [PROTO_8]
       34 CAPTURE                          VAL R0
       35 SETTABLEKS                       R2 R1 K19 ["getServerStorageContainer"]
       37 DUPCLOSURE                       R2 K20 [PROTO_9]
       38 CAPTURE                          VAL R0
       39 SETTABLEKS                       R2 R1 K21 ["getOrCreateServerStorageContainer"]
       41 DUPCLOSURE                       R2 K22 [PROTO_10]
       42 SETTABLEKS                       R2 R1 K23 ["getOrCreateAnimSavesObjectValue"]
       44 DUPCLOSURE                       R2 K24 [PROTO_11]
       45 CAPTURE                          VAL R1
       46 SETTABLEKS                       R2 R1 K25 ["ensureAnimationRigDataInAnimationClip"]
       48 DUPCLOSURE                       R2 K26 [PROTO_12]
       49 CAPTURE                          VAL R1
       50 SETTABLEKS                       R2 R1 K27 ["ensureAnimationRigDataInHumanoid"]
       52 RETURN                           R1 1
