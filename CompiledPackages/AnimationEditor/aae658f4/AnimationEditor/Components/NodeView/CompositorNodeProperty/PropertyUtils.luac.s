PROTO_0:
        0 LOADK                            R3 K0 ["%."]
        1 GETUPVAL                         R4 0
        2 GETTABLEKS                       R4 R4 K1 ["NUMBER_PRECISION"]
        4 GETTABLEKS                       R4 R4 K2 ["Timestamp"]
        6 LOADK                            R5 K3 ["f"]
        7 CONCAT                           R2 R3 R5
        8 JUMPIFEQKB                       R1 FALSE ; [+4]
       10 MOVE                             R3 R2
       11 LOADK                            R4 K4 [" sec"]
       12 CONCAT                           R2 R3 R4
       13 GETIMPORT                        R3 K7 [string.format]
       15 MOVE                             R4 R2
       16 MOVE                             R5 R0
       17 CALL                             R3 2 -1
       18 RETURN                           R3 -1
...
PROTO_1:
        0 LOADK                            R2 K0 ["%."]
        1 GETUPVAL                         R3 0
        2 GETTABLEKS                       R3 R3 K1 ["NUMBER_PRECISION"]
        4 GETTABLEKS                       R3 R3 K2 ["Angle"]
        6 LOADK                            R4 K3 ["f°"]
        7 CONCAT                           R1 R2 R4
...
MAIN:
       ...
       27 GETTABLEKS                       R4 R4 K12 ["NodeGraphing"]
       29 CALL                             R3 1 1
       30 NEWTABLE                         R4 8 0
       32 DUPCLOSURE                       R5 K13 [PROTO_0]
       33 CAPTURE                          VAL R1
       34 SETTABLEKS                       R5 R4 K14 ["formatTimestamp"]
       36 DUPCLOSURE                       R5 K15 [PROTO_1]
       37 CAPTURE                          VAL R1
       38 SETTABLEKS                       R5 R4 K16 ["formatDegrees"]
       40 DUPCLOSURE                       R5 K17 [PROTO_2]
       41 SETTABLEKS                       R5 R4 K18 ["getStepFromSpread"]
       43 DUPCLOSURE                       R5 K19 [PROTO_3]
       44 CAPTURE                          VAL R4
       45 SETTABLEKS                       R5 R4 K20 ["roundStep"]
       47 DUPCLOSURE                       R5 K21 [PROTO_4]
       48 CAPTURE                          VAL R2
       49 SETTABLEKS                       R5 R4 K22 ["isPropertyParameterized"]
       51 DUPCLOSURE                       R5 K23 [PROTO_5]
       52 SETTABLEKS                       R5 R4 K24 ["toCartesian"]
       54 RETURN                           R4 1
