PROTO_0:
       ...
       14 GETUPVAL                         R2 2
       15 GETUPVAL                         R4 3
       16 GETTABLEKS                       R3 R4 K2 ["EDIT_TIME_DATA_MODEL"]
       18 GETUPVAL                         R5 4
       19 GETTABLEKS                       R4 R5 K0 ["current"]
       21 NAMECALL                         R0 R0 K3 ["FireHost"]
       23 CALL                             R0 4 0
       24 GETUPVAL                         R0 1
       25 NAMECALL                         R0 R0 K4 ["IsHost"]
       27 CALL                             R0 1 1
       28 JUMPIFNOT                        R0 ; [+11]
       29 GETUPVAL                         R0 1
       30 GETUPVAL                         R2 2
       31 GETUPVAL                         R4 3
       32 GETTABLEKS                       R3 R4 K2 ["EDIT_TIME_DATA_MODEL"]
       34 GETUPVAL                         R5 4
       35 GETTABLEKS                       R4 R5 K0 ["current"]
       37 NAMECALL                         R0 R0 K5 ["FireGuest"]
       39 CALL                             R0 4 0
       40 RETURN                           R0 0
...
PROTO_5:
        ...
        6 CALL                             R4 1 1
        7 GETTABLEKS                       R3 R4 K2 ["getNetworking"]
        9 CALL                             R3 0 1
       10 GETUPVAL                         R5 0
       ...
       17 GETUPVAL                         R6 0
       18 GETTABLEKS                       R5 R6 K5 ["useEffect"]
       20 NEWCLOSURE                       R6 P0
       21 CAPTURE                          VAL R2
       22 CAPTURE                          VAL R3
       23 CAPTURE                          VAL R0
       ...
       34 CALL                             R5 2 0
       35 GETUPVAL                         R6 0
       36 GETTABLEKS                       R5 R6 K5 ["useEffect"]
       38 NEWCLOSURE                       R6 P1
       39 CAPTURE                          VAL R3
       40 CAPTURE                          VAL R0
       41 CAPTURE                          VAL R4
...
PROTO_8:
       ...
       24 GETUPVAL                         R6 2
       25 GETUPVAL                         R8 3
       26 GETTABLEKS                       R7 R8 K5 ["EDIT_TIME_DATA_MODEL"]
       28 NAMECALL                         R4 R4 K6 ["FireHost"]
       30 CALL                             R4 3 0
       31 GETUPVAL                         R2 1
       32 NAMECALL                         R2 R2 K7 ["IsHost"]
       34 CALL                             R2 1 1
       35 JUMPIFNOT                        R2 ; [+22]
       36 GETUPVAL                         R2 1
       37 GETUPVAL                         R4 2
       38 MOVE                             R5 R0
       39 NAMECALL                         R2 R2 K8 ["OnHostEvent"]
       41 CALL                             R2 3 2
       42 JUMPIFNOT                        R3 ; [+7]
       ...
       51 GETUPVAL                         R6 2
       52 GETUPVAL                         R8 3
       53 GETTABLEKS                       R7 R8 K5 ["EDIT_TIME_DATA_MODEL"]
       55 NAMECALL                         R4 R4 K9 ["FireGuest"]
       57 CALL                             R4 3 0
       58 NEWCLOSURE                       R2 P1
       59 CAPTURE                          VAL R1
       60 RETURN                           R2 1
...
PROTO_9:
        ...
        6 CALL                             R3 1 1
        7 GETTABLEKS                       R2 R3 K2 ["getNetworking"]
        9 CALL                             R2 0 1
       10 GETUPVAL                         R4 0
...
PROTO_10:
        ...
        4 CALL                             R2 1 2
        5 GETUPVAL                         R5 1
        6 GETTABLEKS                       R4 R5 K1 ["useReplicatedStateListenerCallback"]
        8 MOVE                             R5 R0
        9 MOVE                             R6 R3
       10 CALL                             R4 2 0
       11 RETURN                           R2 1
...
PROTO_12:
        ...
        7 GETUPVAL                         R2 1
        8 GETUPVAL                         R4 2
        9 GETTABLEKS                       R3 R4 K1 ["EDIT_TIME_DATA_MODEL"]
       11 GETVARARGS                       R4 -1
       12 NAMECALL                         R0 R0 K2 ["InvokeHostAsync"]
       14 CALL                             R0 -1 -1
       15 RETURN                           R0 -1
       16 GETUPVAL                         R0 0
       17 NAMECALL                         R0 R0 K3 ["IsHost"]
       19 CALL                             R0 1 1
       20 JUMPIFNOT                        R0 ; [+10]
       21 GETUPVAL                         R0 0
       22 GETUPVAL                         R2 1
       23 GETUPVAL                         R4 2
       24 GETTABLEKS                       R3 R4 K1 ["EDIT_TIME_DATA_MODEL"]
       26 GETVARARGS                       R4 -1
       27 NAMECALL                         R0 R0 K4 ["InvokeGuestAsync"]
       29 CALL                             R0 -1 -1
       30 RETURN                           R0 -1
...
PROTO_16:
        ...
        9 CALL                             R2 0 1
       10 GETUPVAL                         R4 0
       11 GETTABLEKS                       R3 R4 K3 ["useRef"]
       13 LOADNIL                          R4
       14 CALL                             R3 1 1
       15 GETUPVAL                         R5 0
       16 GETTABLEKS                       R4 R5 K3 ["useRef"]
       18 LOADNIL                          R5
       19 CALL                             R4 1 1
       ...
       38 CALL                             R5 2 0
       39 GETUPVAL                         R6 0
       40 GETTABLEKS                       R5 R6 K6 ["useCallback"]
       42 NEWCLOSURE                       R6 P1
       43 CAPTURE                          VAL R3
       44 NEWTABLE                         R7 0 1
       46 MOVE                             R8 R3
...
PROTO_18:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R0 R1 K0 ["useBoundAction"]
        3 GETUPVAL                         R1 1
        4 CALL                             R0 1 -1
        5 RETURN                           R0 -1
...
PROTO_20:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R1 R2 K0 ["useReplicatedState"]
        3 GETUPVAL                         R2 1
        4 MOVE                             R3 R0
        5 CALL                             R1 2 0
        6 RETURN                           R0 0
...
MAIN:
       ...
       13 GETTABLEKS                       R2 R3 K8 ["NetworkIdentifiers"]
       15 CALL                             R1 1 1
       16 GETIMPORT                        R2 K5 [require]
       18 GETTABLEKS                       R4 R0 K9 ["Contexts"]
       20 GETTABLEKS                       R3 R4 K10 ["NetworkingContext"]
       22 CALL                             R2 1 1
       ...
       29 CALL                             R3 1 1
       30 NEWTABLE                         R4 8 0
       32 DUPCLOSURE                       R5 K13 [PROTO_5]
       33 CAPTURE                          VAL R3
       34 CAPTURE                          VAL R2
       35 CAPTURE                          VAL R1
       36 SETTABLEKS                       R5 R4 K14 ["useReplicatedState"]
       38 DUPCLOSURE                       R5 K15 [PROTO_9]
       39 CAPTURE                          VAL R3
       40 CAPTURE                          VAL R2
       41 CAPTURE                          VAL R1
       42 SETTABLEKS                       R5 R4 K16 ["useReplicatedStateListenerCallback"]
       44 DUPCLOSURE                       R5 K17 [PROTO_10]
       45 CAPTURE                          VAL R3
       46 CAPTURE                          VAL R4
       47 SETTABLEKS                       R5 R4 K18 ["useReplicatedStateListener"]
       49 DUPCLOSURE                       R5 K19 [PROTO_16]
       50 CAPTURE                          VAL R3
       51 CAPTURE                          VAL R2
       52 CAPTURE                          VAL R1
       53 SETTABLEKS                       R5 R4 K20 ["useBoundAction"]
       55 DUPCLOSURE                       R5 K21 [PROTO_19]
       56 CAPTURE                          VAL R4
       57 SETTABLEKS                       R5 R4 K22 ["createBoundAction"]
       59 DUPCLOSURE                       R5 K23 [PROTO_22]
       60 CAPTURE                          VAL R4
       61 SETTABLEKS                       R5 R4 K24 ["createReplicatedState"]
       63 RETURN                           R4 1
