...
PROTO_1:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R0 R1 K0 ["Height"]
        3 JUMPIFEQKN                       R0 K1 [0] ; [+6]
        5 GETUPVAL                         R1 0
        6 GETTABLEKS                       R0 R1 K2 ["Width"]
       ...
       17 RETURN                           R0 -1
       18 GETUPVAL                         R2 1
       19 GETTABLEKS                       R1 R2 K2 ["Width"]
       21 GETUPVAL                         R3 0
       22 GETTABLEKS                       R2 R3 K2 ["Width"]
       24 DIV                              R0 R1 R2
       25 GETUPVAL                         R3 1
       26 GETTABLEKS                       R2 R3 K0 ["Height"]
       28 GETUPVAL                         R4 0
       29 GETTABLEKS                       R3 R4 K0 ["Height"]
       31 DIV                              R1 R2 R3
...
PROTO_2:
        ...
        3 RETURN                           R0 0
        4 GETUPVAL                         R3 1
        5 GETTABLEKS                       R2 R3 K0 ["Min"]
        7 GETTABLEKS                       R1 R2 K1 ["X"]
        9 GETUPVAL                         R4 2
       10 GETTABLEKS                       R3 R4 K0 ["Min"]
       12 GETTABLEKS                       R2 R3 K1 ["X"]
       14 SUB                              R0 R1 R2
       15 GETUPVAL                         R4 2
       16 GETTABLEKS                       R3 R4 K0 ["Min"]
       18 GETTABLEKS                       R2 R3 K2 ["Y"]
       20 GETUPVAL                         R5 1
       21 GETTABLEKS                       R4 R5 K0 ["Min"]
       23 GETTABLEKS                       R3 R4 K2 ["Y"]
       25 SUB                              R1 R2 R3
...
PROTO_3:
       ...
       23 CALL                             R5 1 1
       24 GETUPVAL                         R7 0
       25 GETTABLEKS                       R6 R7 K6 ["useMemo"]
       27 NEWCLOSURE                       R7 P0
       28 CAPTURE                          VAL R4
       29 CAPTURE                          VAL R5
       30 CAPTURE                          UPVAL U3
       ...
       37 CALL                             R6 2 1
       38 GETUPVAL                         R8 0
       39 GETTABLEKS                       R7 R8 K7 ["useRef"]
       41 LOADNIL                          R8
       42 CALL                             R7 1 1
       43 GETUPVAL                         R9 0
       44 GETTABLEKS                       R8 R9 K8 ["useEffect"]
       46 NEWCLOSURE                       R9 P1
       47 CAPTURE                          VAL R2
       48 CAPTURE                          VAL R4
       49 CAPTURE                          VAL R5
       ...
       58 CALL                             R8 2 0
       59 GETUPVAL                         R9 0
       60 GETTABLEKS                       R8 R9 K9 ["createElement"]
       62 GETUPVAL                         R10 4
       63 GETTABLEKS                       R9 R10 K10 ["ScrollView"]
       ...
       72 GETUPVAL                         R15 4
       73 GETTABLEKS                       R14 R15 K21 ["Enums"]
       75 GETTABLEKS                       R13 R14 K22 ["Visibility"]
       77 GETTABLEKS                       R12 R13 K23 ["Always"]
