...
MAIN:
       ...
       41 CALL                             R5 1 1
       42 DUPTABLE                         R6 K19 [{"selectionNodeId", "selectionInputIndices", "clearSelection", "isInputSelected", "inputDown", "inputUp", "getSelectedIndices"}]
       43 LOADNIL                          R7
       44 SETTABLEKS                       R7 R6 K12 ["selectionNodeId"]
       46 NEWTABLE                         R7 0 0
       48 SETTABLEKS                       R7 R6 K13 ["selectionInputIndices"]
       50 GETTABLEKS                       R7 R4 K20 ["createUnimplemented"]
       52 LOADK                            R8 K14 ["clearSelection"]
       53 CALL                             R7 1 1
       54 SETTABLEKS                       R7 R6 K14 ["clearSelection"]
       56 GETTABLEKS                       R7 R4 K20 ["createUnimplemented"]
       58 LOADK                            R8 K15 ["isInputSelected"]
       59 CALL                             R7 1 1
       60 SETTABLEKS                       R7 R6 K15 ["isInputSelected"]
       62 GETTABLEKS                       R7 R4 K20 ["createUnimplemented"]
       64 LOADK                            R8 K16 ["inputDown"]
       65 CALL                             R7 1 1
       66 SETTABLEKS                       R7 R6 K16 ["inputDown"]
       68 GETTABLEKS                       R7 R4 K20 ["createUnimplemented"]
       70 LOADK                            R8 K17 ["inputUp"]
       71 CALL                             R7 1 1
       72 SETTABLEKS                       R7 R6 K17 ["inputUp"]
       74 GETTABLEKS                       R7 R4 K20 ["createUnimplemented"]
       76 LOADK                            R8 K18 ["getSelectedIndices"]
       77 CALL                             R7 1 1
       78 SETTABLEKS                       R7 R6 K18 ["getSelectedIndices"]
       80 GETTABLEKS                       R7 R3 K21 ["createContext"]
       82 MOVE                             R8 R6
       83 CALL                             R7 1 1
       84 DUPCLOSURE                       R8 K22 [PROTO_8]
       85 CAPTURE                          VAL R3
       86 CAPTURE                          VAL R2
       87 CAPTURE                          VAL R1
       88 CAPTURE                          VAL R5
       89 CAPTURE                          VAL R7
       90 DUPTABLE                         R9 K25 [{"Context", "Provider"}]
       91 SETTABLEKS                       R7 R9 K23 ["Context"]
       93 SETTABLEKS                       R8 R9 K24 ["Provider"]
       95 RETURN                           R9 1
