...
MAIN:
       ...
       84 DUPTABLE                         R14 K29 [{["id"] = "String", ["text"] = "string"}]
       85 CALL                             R13 1 1
       86 GETIMPORT                        R14 K24 [table.freeze]
       88 DUPTABLE                         R15 K32 [{["id"] = "Boolean", ["text"] = "boolean"}]
       89 CALL                             R14 1 1
       90 GETIMPORT                        R15 K24 [table.freeze]
       92 DUPTABLE                         R16 K35 [{["id"] = "Number", ["text"] = "number"}]
       93 CALL                             R15 1 1
       94 GETIMPORT                        R16 K24 [table.freeze]
       96 DUPTABLE                         R17 K37 [{["id"] = "Mask", ["text"] = "Mask"}]
       97 CALL                             R16 1 -1
       98 SETLIST                          R12 R13 -1 [1]
      100 CALL                             R11 1 1
      101 JUMP                             ; [+35]
      102 GETIMPORT                        R11 K24 [table.freeze]
      104 NEWTABLE                         R12 0 7
      106 GETIMPORT                        R13 K24 [table.freeze]
      108 DUPTABLE                         R14 K29 [{["id"] = "String", ["text"] = "string"}]
      109 CALL                             R13 1 1
      110 GETIMPORT                        R14 K24 [table.freeze]
      112 DUPTABLE                         R15 K32 [{["id"] = "Boolean", ["text"] = "boolean"}]
      113 CALL                             R14 1 1
      114 GETIMPORT                        R15 K24 [table.freeze]
      116 DUPTABLE                         R16 K35 [{["id"] = "Number", ["text"] = "number"}]
      117 CALL                             R15 1 1
      118 GETIMPORT                        R16 K24 [table.freeze]
      120 DUPTABLE                         R17 K37 [{["id"] = "Mask", ["text"] = "Mask"}]
      121 CALL                             R16 1 1
      122 GETIMPORT                        R17 K24 [table.freeze]
      124 DUPTABLE                         R18 K39 [{["id"] = "PlayMode", ["text"] = "PlayMode"}]
      125 CALL                             R17 1 1
      126 GETIMPORT                        R18 K24 [table.freeze]
      128 DUPTABLE                         R19 K41 [{["id"] = "InputMode", ["text"] = "InputMode"}]
      129 CALL                             R18 1 1
      130 GETIMPORT                        R19 K24 [table.freeze]
      132 DUPTABLE                         R20 K43 [{["id"] = "PhaseSync", ["text"] = "PhaseSync"}]
      133 CALL                             R19 1 -1
      134 SETLIST                          R12 R13 -1 [1]
      136 CALL                             R11 1 1
      137 DUPTABLE                         R12 K44 [{"PlayMode", "InputMode", "PhaseSync"}]
      138 GETIMPORT                        R13 K48 [Enum.AnimationNodePlayMode.Loop]
      140 SETTABLEKS                       R13 R12 K38 ["PlayMode"]
      142 GETIMPORT                        R13 K51 [Enum.AnimationNodeBlend2DInputMode.Cartesian]
      144 SETTABLEKS                       R13 R12 K40 ["InputMode"]
      146 GETIMPORT                        R13 K54 [Enum.AnimationNodePhaseSync.Synced]
      148 SETTABLEKS                       R13 R12 K42 ["PhaseSync"]
      150 DUPTABLE                         R13 K58 [{["String"] = "", ["Boolean"] = False, ["Number"] = 0, ["PlayMode"], ["InputMode"], ["PhaseSync"]}]
      151 GETIMPORT                        R14 K48 [Enum.AnimationNodePlayMode.Loop]
      153 SETTABLEKS                       R14 R13 K38 ["PlayMode"]
      155 GETIMPORT                        R14 K51 [Enum.AnimationNodeBlend2DInputMode.Cartesian]
      157 SETTABLEKS                       R14 R13 K40 ["InputMode"]
      159 GETIMPORT                        R14 K54 [Enum.AnimationNodePhaseSync.Synced]
      161 SETTABLEKS                       R14 R13 K42 ["PhaseSync"]
      163 DUPCLOSURE                       R14 K59 [PROTO_0]
      164 CAPTURE                          VAL R8
      165 CAPTURE                          VAL R13
      166 CAPTURE                          VAL R12
      167 DUPCLOSURE                       R15 K60 [PROTO_2]
      168 CAPTURE                          VAL R6
      169 CAPTURE                          VAL R1
      170 CAPTURE                          VAL R11
      171 CAPTURE                          VAL R14
