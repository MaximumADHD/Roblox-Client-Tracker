PROTO_0:
       ...
       21 DUPTABLE                         R7 K20 [{["Name"] = "WaitFor", ["Label"] = "Wait For", ["Type"] = "Enum.AnimationNodeWaitFor", ["Value"]}]
       22 GETTABLEKS                       R8 R0 K21 ["Transition"]
       24 JUMPIFNOT                        R8 ; [+4]
       25 GETTABLEKS                       R8 R0 K21 ["Transition"]
       27 GETTABLEKS                       R8 R8 K14 ["WaitFor"]
       29 SETTABLEKS                       R8 R7 K19 ["Value"]
       31 CALL                             R6 1 1
       32 SETTABLEKS                       R6 R5 K8 ["Transition_WaitFor"]
       34 GETTABLEKS                       R6 R1 K12 ["nextTransitionProperty"]
       36 DUPTABLE                         R7 K27 [{["Name"] = "Duration", ["Label"] = "Length", ["Type"] = "Timestamp", ["Value"], ["Step"], ["Precision"]}]
       37 GETTABLEKS                       R8 R0 K21 ["Transition"]
       39 JUMPIFNOT                        R8 ; [+4]
       40 GETTABLEKS                       R8 R0 K21 ["Transition"]
       42 GETTABLEKS                       R8 R8 K22 ["Duration"]
       44 SETTABLEKS                       R8 R7 K19 ["Value"]
       46 GETUPVAL                         R9 3
       47 CALL                             R9 0 1
       48 JUMPIFNOT                        R9 ; [+2]
       49 LOADNIL                          R8
       ...
       58 JUMP                             ; [+5]
       59 GETUPVAL                         R8 4
       60 GETTABLEKS                       R8 R8 K29 ["NUMBER_PRECISION"]
       62 GETTABLEKS                       R8 R8 K30 ["Float"]
       64 SETTABLEKS                       R8 R7 K26 ["Precision"]
       66 CALL                             R6 1 1
       67 SETTABLEKS                       R6 R5 K9 ["Transition_Duration"]
       69 GETTABLEKS                       R6 R1 K12 ["nextTransitionProperty"]
       71 DUPTABLE                         R7 K34 [{["Name"] = "Curve", ["Label"] = "Curve", ["Type"] = "Enum.PoseEasingStyle", ["Choices"], ["Value"]}]
       72 NEWTABLE                         R8 2 0
       74 GETIMPORT                        R9 K38 [Enum.PoseEasingStyle.Linear]
       76 LOADK                            R10 K37 ["Linear"]
       77 SETTABLE                         R10 R8 R9
       78 GETIMPORT                        R9 K40 [Enum.PoseEasingStyle.CubicV2]
       80 LOADK                            R10 K41 ["In/Out"]
       81 SETTABLE                         R10 R8 R9
       82 SETTABLEKS                       R8 R7 K33 ["Choices"]
       84 GETTABLEKS                       R8 R0 K21 ["Transition"]
       86 JUMPIFNOT                        R8 ; [+4]
       87 GETTABLEKS                       R8 R0 K21 ["Transition"]
       89 GETTABLEKS                       R8 R8 K31 ["Curve"]
       91 SETTABLEKS                       R8 R7 K19 ["Value"]
       93 CALL                             R6 1 1
