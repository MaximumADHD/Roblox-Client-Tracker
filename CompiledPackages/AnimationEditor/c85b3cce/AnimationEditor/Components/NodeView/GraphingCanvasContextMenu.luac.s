...
PROTO_5:
       ...
       66 NEWTABLE                         R3 0 2
       68 GETUPVAL                         R4 6
       69 GETTABLEKS                       R4 R4 K17 ["duplicate"]
       71 GETTABLEKS                       R4 R4 K18 ["menuItem"]
       73 GETUPVAL                         R5 6
       74 GETTABLEKS                       R5 R5 K19 ["delete"]
       76 GETTABLEKS                       R5 R5 K18 ["menuItem"]
       78 SETLIST                          R3 R4 2 [1]
       80 SETTABLEKS                       R3 R2 K0 ["items"]
       82 DUPTABLE                         R3 K1 [{"items"}]
       83 NEWTABLE                         R4 0 1
       85 DUPTABLE                         R5 K22 [{["id"] = "frameSelection", ["text"], ["onActivated"]}]
       86 GETUPVAL                         R7 1
       87 CALL                             R7 0 1
       88 JUMPIFNOT                        R7 ; [+20]
       89 GETUPVAL                         R7 7
       90 JUMPIFNOT                        R7 ; [+9]
       91 GETUPVAL                         R6 2
       92 LOADK                            R8 K7 ["Common"]
       93 LOADK                            R9 K8 ["AnimationEditor"]
       94 LOADK                            R10 K9 ["Menu"]
       95 LOADK                            R11 K23 ["FrameSelection"]
       96 NAMECALL                         R6 R6 K11 ["getExternalText"]
       98 CALL                             R6 5 1
       99 JUMP                             ; [+10]
      100 GETUPVAL                         R6 2
      ...
      104 LOADK                            R11 K24 ["FrameAll"]
      105 NAMECALL                         R6 R6 K11 ["getExternalText"]
      107 CALL                             R6 5 1
      108 JUMP                             ; [+1]
      109 LOADK                            R6 K25 ["Frame Selection"]
      110 SETTABLEKS                       R6 R5 K4 ["text"]
      112 GETUPVAL                         R7 1
      113 CALL                             R7 0 1
      114 JUMPIFNOT                        R7 ; [+2]
      115 GETUPVAL                         R6 8
      116 JUMP                             ; [+3]
      117 GETUPVAL                         R6 9
      118 GETTABLEKS                       R6 R6 K20 ["frameSelection"]
      120 SETTABLEKS                       R6 R5 K21 ["onActivated"]
      122 SETLIST                          R4 R5 1 [1]
      124 SETTABLEKS                       R4 R3 K0 ["items"]
      126 SETLIST                          R0 R1 3 [1]
      128 RETURN                           R0 1
