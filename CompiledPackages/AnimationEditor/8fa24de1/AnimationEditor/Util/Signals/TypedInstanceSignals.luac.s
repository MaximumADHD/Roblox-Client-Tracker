...
PROTO_25:
        ...
        4 CALL                             R1 1 1
        5 JUMPIFNOTEQKS                    R1 K2 ["Instance"] ; [+2]
        7 RETURN                           R0 1
        8 JUMPIFEQKS                       R1 K3 ["InstanceHandle"] ; [+3]
       10 LOADNIL                          R2
       11 RETURN                           R2 1
       12 NAMECALL                         R2 R0 K4 ["Get"]
       14 CALL                             R2 1 1
       15 FASTCALL1                        TYPEOF R2 ; [+3]
       16 MOVE                             R5 R2
       17 GETIMPORT                        R4 K1 [typeof]
       19 CALL                             R4 1 1
       20 JUMPIFNOTEQKS                    R4 K2 ["Instance"] ; [+3]
       22 MOVE                             R3 R2
       23 RETURN                           R3 1
       24 LOADNIL                          R3
       25 RETURN                           R3 1
...
PROTO_26:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["resolveInstanceAttribute"]
        3 MOVE                             R2 R0
        4 CALL                             R1 1 -1
        5 RETURN                           R1 -1
...
MAIN:
       ...
       79 DUPCLOSURE                       R6 K28 [PROTO_25]
       80 SETTABLEKS                       R6 R3 K29 ["resolveInstanceAttribute"]
       82 DUPCLOSURE                       R6 K30 [PROTO_27]
       83 CAPTURE                          VAL R5
       84 CAPTURE                          VAL R3
       85 GETTABLEKS                       R7 R3 K24 ["attributes"]
       87 SETTABLEKS                       R6 R7 K17 ["observeInstance"]
       89 DUPCLOSURE                       R6 K31 [PROTO_29]
       90 CAPTURE                          VAL R5
       91 GETTABLEKS                       R7 R3 K24 ["attributes"]
       93 SETTABLEKS                       R6 R7 K19 ["observeNumber"]
       95 DUPCLOSURE                       R6 K32 [PROTO_31]
       96 CAPTURE                          VAL R5
       97 GETTABLEKS                       R7 R3 K24 ["attributes"]
       99 SETTABLEKS                       R6 R7 K21 ["observeString"]
      101 DUPCLOSURE                       R6 K33 [PROTO_33]
      102 CAPTURE                          VAL R5
      103 GETTABLEKS                       R7 R3 K24 ["attributes"]
      105 SETTABLEKS                       R6 R7 K23 ["observeVector2"]
      107 RETURN                           R3 1
