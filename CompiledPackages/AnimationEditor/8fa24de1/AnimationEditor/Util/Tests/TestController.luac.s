...
PROTO_1:
        ...
        7 DUPTABLE                         R4 K5 [{"PreProviders", "Providers", "Plugin"}]
        8 GETUPVAL                         R5 3
        9 SETTABLEKS                       R5 R4 K2 ["PreProviders"]
       11 GETUPVAL                         R5 4
       12 SETTABLEKS                       R5 R4 K3 ["Providers"]
       14 GETUPVAL                         R5 0
       15 GETTABLEKS                       R5 R5 K6 ["_testPlugin"]
       17 SETTABLEKS                       R5 R4 K4 ["Plugin"]
       19 CALL                             R2 2 -1
       20 NAMECALL                         R0 R0 K7 ["render"]
       22 CALL                             R0 -1 0
       23 RETURN                           R0 0
...
PROTO_2:
        ...
        7 CALL                             R1 2 1
        8 GETTABLEKS                       R2 R0 K2 ["Plugin"]
       10 JUMPIF                           R2 ; [+5]
       11 GETUPVAL                         R2 1
       12 GETTABLEKS                       R2 R2 K3 ["new"]
       14 DUPTABLE                         R3 K6 [{["MockMDI"] = True}]
       15 CALL                             R2 1 1
       16 SETTABLEKS                       R2 R1 K7 ["_testPlugin"]
       18 GETUPVAL                         R2 2
       19 GETTABLEKS                       R2 R2 K3 ["new"]
       21 CALL                             R2 0 1
       22 SETTABLEKS                       R2 R1 K8 ["_testSelection"]
       24 GETIMPORT                        R2 K10 [Instance.new]
       26 LOADK                            R3 K11 ["ScreenGui"]
       27 CALL                             R2 1 1
       28 SETTABLEKS                       R2 R1 K12 ["_layerCollector"]
       30 GETUPVAL                         R2 3
       31 GETTABLEKS                       R2 R2 K13 ["createRoot"]
       33 GETTABLEKS                       R3 R1 K12 ["_layerCollector"]
       35 CALL                             R2 1 1
       36 SETTABLEKS                       R2 R1 K14 ["_root"]
       38 GETUPVAL                         R2 4
       39 GETTABLEKS                       R2 R2 K15 ["createUnimplemented"]
       41 LOADK                            R3 K16 ["setContextList"]
       42 CALL                             R2 1 1
       43 SETTABLEKS                       R2 R1 K17 ["_setContextList"]
       45 NEWTABLE                         R2 0 0
       47 SETTABLEKS                       R2 R1 K18 ["_lastContextMap"]
       49 NEWTABLE                         R2 0 1
       51 GETUPVAL                         R3 5
       52 GETTABLEKS                       R3 R3 K19 ["createElement"]
       54 GETUPVAL                         R4 6
       55 GETTABLEKS                       R4 R4 K20 ["Provider"]
       57 DUPTABLE                         R5 K22 [{"selectionService"}]
       58 GETTABLEKS                       R6 R1 K8 ["_testSelection"]
       60 SETTABLEKS                       R6 R5 K21 ["selectionService"]
       62 CALL                             R3 2 -1
       63 SETLIST                          R2 R3 -1 [1]
       65 NEWTABLE                         R3 0 0
       67 GETTABLEKS                       R4 R0 K23 ["Providers"]
       69 JUMPIFNOT                        R4 ; [+14]
       70 GETTABLEKS                       R4 R0 K23 ["Providers"]
       72 LOADNIL                          R5
       73 LOADNIL                          R6
       74 FORGPREP                         R4
       ...
       77 MOVE                             R10 R3
       78 MOVE                             R11 R8
       79 GETIMPORT                        R9 K26 [table.insert]
       81 CALL                             R9 2 0
       82 FORGLOOP                         R4 2 ; [-8]
       84 NEWCLOSURE                       R4 P0
       85 CAPTURE                          UPVAL U5
       ...
       88 MOVE                             R6 R3
       89 GETUPVAL                         R7 5
       90 GETTABLEKS                       R7 R7 K19 ["createElement"]
       92 MOVE                             R8 R4
       93 CALL                             R7 1 -1
       94 FASTCALL                         TABLE_INSERT ; [+2]
       95 GETIMPORT                        R5 K26 [table.insert]
       97 CALL                             R5 -1 0
       98 GETUPVAL                         R5 3
       99 GETTABLEKS                       R5 R5 K27 ["act"]
