...
PROTO_3:
       ...
       19 CALL                             R8 1 1
       20 JUMPIFNOTEQKS                    R8 K7 ["string"] ; [+45]
       ...
       37 CALL                             R9 2 1
       38 JUMPIFNOTEQKNIL                  R9 ; [+14]
       40 JUMPIFEQKS                       R8 K14 ["Boolean"] ; [+3]
       42 JUMPIFNOTEQKS                    R8 K15 ["Trigger"] ; [+3]
       44 LOADB                            R9 0
       45 JUMP                             ; [+7]
       46 JUMPIFEQKS                       R8 K16 ["String"] ; [+3]
       48 JUMPIFNOTEQKS                    R8 K17 ["Enum"] ; [+3]
       50 LOADK                            R9 K18 [""]
       51 JUMP                             ; [+1]
       52 LOADN                            R9 0
       53 DUPTABLE                         R12 K21 [{"name", "type", "defaultValue"}]
       54 SETTABLEKS                       R7 R12 K19 ["name"]
       56 SETTABLEKS                       R8 R12 K5 ["type"]
       58 SETTABLEKS                       R9 R12 K20 ["defaultValue"]
       60 FASTCALL2                        TABLE_INSERT R1 R12 ; [+4]
       62 MOVE                             R11 R1
       63 GETIMPORT                        R10 K24 [table.insert]
       65 CALL                             R10 2 0
       66 FORGLOOP                         R2 2 ; [-61]
       68 GETIMPORT                        R2 K26 [table.sort]
       70 MOVE                             R3 R1
       71 DUPCLOSURE                       R4 K27 [PROTO_2]
       72 CALL                             R2 2 0
       73 RETURN                           R1 1
