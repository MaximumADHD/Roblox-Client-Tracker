...
MAIN:
       ...
       78 CALL                             R10 1 1
       79 GETIMPORT                        R11 K22 [game]
       81 LOADK                            R13 K23 ["AnimGraphTriggerParameters"]
       82 NAMECALL                         R11 R11 K24 ["GetEngineFeature"]
       84 CALL                             R11 2 1
       85 DUPTABLE                         R12 K26 [{"contextMenuComponent"}]
       86 SETTABLEKS                       R4 R12 K25 ["contextMenuComponent"]
       88 NEWTABLE                         R13 0 3
       90 GETIMPORT                        R14 K29 [table.freeze]
       92 DUPTABLE                         R15 K34 [{["id"] = "String", ["text"] = "string"}]
       93 CALL                             R14 1 1
       94 GETIMPORT                        R15 K29 [table.freeze]
       96 DUPTABLE                         R16 K37 [{["id"] = "Boolean", ["text"] = "boolean"}]
       97 CALL                             R15 1 1
       98 GETIMPORT                        R16 K29 [table.freeze]
      100 DUPTABLE                         R17 K40 [{["id"] = "Number", ["text"] = "number"}]
      101 CALL                             R16 1 -1
      102 SETLIST                          R13 R14 -1 [1]
      104 JUMPIF                           R2 ; [+9]
      105 MOVE                             R15 R13
      106 GETIMPORT                        R16 K29 [table.freeze]
      108 DUPTABLE                         R17 K42 [{["id"] = "Mask", ["text"] = "Mask"}]
      109 CALL                             R16 1 -1
      110 FASTCALL                         TABLE_INSERT ; [+2]
      111 GETIMPORT                        R14 K44 [table.insert]
      113 CALL                             R14 -1 0
      114 JUMPIFNOT                        R11 ; [+9]
      115 MOVE                             R15 R13
      116 GETIMPORT                        R16 K29 [table.freeze]
      118 DUPTABLE                         R17 K46 [{["id"] = "Trigger", ["text"] = "Trigger"}]
      119 CALL                             R16 1 -1
      120 FASTCALL                         TABLE_INSERT ; [+2]
      121 GETIMPORT                        R14 K44 [table.insert]
      123 CALL                             R14 -1 0
      124 GETIMPORT                        R14 K29 [table.freeze]
      126 MOVE                             R15 R13
      127 CALL                             R14 1 1
      128 DUPTABLE                         R15 K50 [{"PlayMode", "InputMode", "PhaseSync"}]
      129 GETIMPORT                        R16 K54 [Enum.AnimationNodePlayMode.Loop]
      131 SETTABLEKS                       R16 R15 K47 ["PlayMode"]
      133 GETIMPORT                        R16 K57 [Enum.AnimationNodeBlend2DInputMode.Cartesian]
      135 SETTABLEKS                       R16 R15 K48 ["InputMode"]
      137 GETIMPORT                        R16 K60 [Enum.AnimationNodePhaseSync.Synced]
      139 SETTABLEKS                       R16 R15 K49 ["PhaseSync"]
      141 DUPTABLE                         R16 K64 [{["String"] = "", ["Boolean"] = False, ["Trigger"] = False, ["Number"] = 0, ["PlayMode"], ["InputMode"], ["PhaseSync"]}]
      142 GETIMPORT                        R17 K54 [Enum.AnimationNodePlayMode.Loop]
      144 SETTABLEKS                       R17 R16 K47 ["PlayMode"]
      146 GETIMPORT                        R17 K57 [Enum.AnimationNodeBlend2DInputMode.Cartesian]
      148 SETTABLEKS                       R17 R16 K48 ["InputMode"]
      150 GETIMPORT                        R17 K60 [Enum.AnimationNodePhaseSync.Synced]
      152 SETTABLEKS                       R17 R16 K49 ["PhaseSync"]
      154 DUPCLOSURE                       R17 K65 [PROTO_0]
      155 CAPTURE                          VAL R10
      156 CAPTURE                          VAL R16
      157 CAPTURE                          VAL R15
      158 DUPCLOSURE                       R18 K66 [PROTO_3]
      159 CAPTURE                          VAL R8
      160 CAPTURE                          VAL R1
      161 CAPTURE                          VAL R5
      162 CAPTURE                          VAL R14
