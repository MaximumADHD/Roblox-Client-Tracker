...
PROTO_2:
        ...
        3 JUMPIFEQKS                       R1 K1 ["ok"] ; [+12]
        5 GETIMPORT                        R1 K3 [warn]
        7 LOADK                            R2 K4 ["OutputLink not ready yet when warning about unsaved graph (%*)"]
        8 NAMECALL                         R4 R0 K5 ["GetFullName"]
       10 CALL                             R4 1 1
       ...
       15 RETURN                           R0 0
       16 GETUPVAL                         R1 0
       17 GETTABLEKS                       R1 R1 K7 ["value"]
       19 JUMPIFNOTEQKNIL                  R1 ; [+2]
       21 RETURN                           R0 0
       22 GETUPVAL                         R1 0
       23 GETTABLEKS                       R1 R1 K7 ["value"]
       25 GETIMPORT                        R3 K11 [Enum.MessageType.MessageError]
       27 GETUPVAL                         R4 1
       28 LOADK                            R6 K12 ["Common"]
       29 LOADK                            R7 K13 ["AnimationEditor"]
       30 LOADK                            R8 K14 ["PublishWarning"]
       31 LOADK                            R9 K15 ["Warning"]
       32 DUPTABLE                         R10 K17 [{"name"}]
       33 GETTABLEKS                       R11 R0 K18 ["Name"]
       35 SETTABLEKS                       R11 R10 K16 ["name"]
       37 NAMECALL                         R4 R4 K19 ["getExternalText"]
       39 CALL                             R4 6 1
       40 GETUPVAL                         R5 2
       41 MOVE                             R7 R0
       42 NAMECALL                         R5 R5 K20 ["GetOrCreateUniqueId"]
       44 CALL                             R5 2 -1
       45 NAMECALL                         R1 R1 K21 ["Print"]
       47 CALL                             R1 -1 0
       48 RETURN                           R0 0
