...
PROTO_2:
        ...
        8 GETUPVAL                         R2 1
        9 DUPTABLE                         R3 K5 [{["state"] = "ok", ["name"]}]
       10 SETTABLEKS                       R0 R3 K4 ["name"]
       12 SETTABLE                         R3 R1 R2
       13 GETUPVAL                         R1 3
       14 LOADNIL                          R2
       15 LOADNIL                          R3
       16 FORGPREP                         R1
       17 GETIMPORT                        R6 K8 [coroutine.status]
       19 MOVE                             R7 R5
       20 CALL                             R6 1 1
       21 JUMPIFNOTEQKS                    R6 K9 ["suspended"] ; [+6]
       23 GETIMPORT                        R6 K12 [task.spawn]
       25 MOVE                             R7 R5
       26 MOVE                             R8 R0
       27 CALL                             R6 2 0
       28 FORGLOOP                         R1 2 ; [-12]
...
PROTO_3:
       ...
       36 JUMPIFNOTEQKNIL                  R2 ; [+27]
       38 NEWTABLE                         R3 0 1
       40 GETIMPORT                        R4 K13 [coroutine.running]
       42 CALL                             R4 0 -1
       43 SETLIST                          R3 R4 -1 [1]
       45 DUPTABLE                         R4 K17 [{["state"] = "loading", ["threads"]}]
       46 SETTABLEKS                       R3 R4 K16 ["threads"]
       48 GETUPVAL                         R5 0
       49 GETTABLEKS                       R5 R5 K10 ["current"]
       51 SETTABLE                         R4 R5 R1
       52 GETIMPORT                        R5 K20 [task.defer]
       54 NEWCLOSURE                       R6 P0
       55 CAPTURE                          UPVAL U1
       56 CAPTURE                          VAL R1
       57 CAPTURE                          UPVAL U0
       58 CAPTURE                          VAL R3
       59 CALL                             R5 1 0
       60 GETIMPORT                        R5 K22 [coroutine.yield]
       62 CALL                             R5 0 -1
       63 RETURN                           R5 -1
       64 GETTABLEKS                       R3 R2 K14 ["state"]
       66 JUMPIFNOTEQKS                    R3 K15 ["loading"] ; [+14]
       68 GETTABLEKS                       R4 R2 K16 ["threads"]
       70 GETIMPORT                        R5 K13 [coroutine.running]
       72 CALL                             R5 0 -1
       73 FASTCALL                         TABLE_INSERT ; [+2]
       74 GETIMPORT                        R3 K25 [table.insert]
       76 CALL                             R3 -1 0
       77 GETIMPORT                        R3 K22 [coroutine.yield]
       79 CALL                             R3 0 -1
       80 RETURN                           R3 -1
       81 GETTABLEKS                       R3 R2 K14 ["state"]
       83 JUMPIFNOTEQKS                    R3 K26 ["ok"] ; [+4]
       85 GETTABLEKS                       R3 R2 K27 ["name"]
       87 RETURN                           R3 1
       88 GETTABLEKS                       R3 R2 K14 ["state"]
       90 GETIMPORT                        R4 K29 [error]
       92 LOADK                            R5 K30 ["Unreachable"]
       93 CALL                             R4 1 0
       94 RETURN                           R0 0
