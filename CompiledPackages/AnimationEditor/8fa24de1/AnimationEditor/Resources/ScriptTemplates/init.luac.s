...
PROTO_2:
       ...
       43 CALL                             R9 1 1
       44 MOVE                             R7 R9
       45 LOADK                            R10 K17 ["-- \t\ttrack:SetParameter(\"%*\", %*) -- %*"]
       46 GETTABLEKS                       R12 R6 K18 ["name"]
       48 MOVE                             R13 R7
       49 GETTABLEKS                       R14 R6 K10 ["type"]
       51 NAMECALL                         R10 R10 K14 ["format"]
       53 CALL                             R10 4 1
       54 FASTCALL2                        TABLE_INSERT R1 R10 ; [+4]
       56 MOVE                             R9 R1
       57 GETIMPORT                        R8 K8 [table.insert]
       59 CALL                             R8 2 0
       60 FORGLOOP                         R2 2 ; [-38]
       62 FASTCALL2K                       TABLE_INSERT R1 K19 ; [+5]
       64 MOVE                             R3 R1
       65 LOADK                            R4 K19 ["-- \tend"]
       66 GETIMPORT                        R2 K8 [table.insert]
       68 CALL                             R2 2 0
       69 FASTCALL2K                       TABLE_INSERT R1 K20 ; [+5]
       71 MOVE                             R3 R1
       72 LOADK                            R4 K20 ["-- end)"]
       73 GETIMPORT                        R2 K8 [table.insert]
       75 CALL                             R2 2 0
       76 FASTCALL2K                       TABLE_INSERT R1 K0 ; [+5]
       78 MOVE                             R3 R1
       79 LOADK                            R4 K0 [""]
       80 GETIMPORT                        R2 K8 [table.insert]
       82 CALL                             R2 2 0
       83 GETIMPORT                        R2 K22 [table.concat]
       85 MOVE                             R3 R1
       86 LOADK                            R4 K23 ["\n"]
       87 CALL                             R2 2 -1
       88 RETURN                           R2 -1
