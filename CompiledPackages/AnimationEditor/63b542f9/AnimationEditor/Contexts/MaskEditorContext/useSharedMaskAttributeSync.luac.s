...
PROTO_1:
        ...
        3 CALL                             R1 2 1
        4 GETUPVAL                         R2 2
        5 GETTABLEKS                       R2 R2 K0 ["createComputed"]
        7 NEWCLOSURE                       R3 P0
        8 CAPTURE                          VAL R1
        9 CAPTURE                          VAL R0
       10 CALL                             R2 1 -1
...
PROTO_3:
        ...
        9 NEWTABLE                         R1 0 0
       11 GETUPVAL                         R2 5
       12 GETTABLEKS                       R2 R2 K1 ["createEffect"]
       14 NEWCLOSURE                       R3 P1
       15 CAPTURE                          VAL R0
       16 CAPTURE                          VAL R1
       17 CALL                             R2 1 -1
...
MAIN:
       ...
       29 GETTABLEKS                       R4 R4 K12 ["Experimental"]
       31 GETTABLEKS                       R4 R4 K13 ["SignalExperimentalUtils"]
       33 CALL                             R3 1 1
       34 GETIMPORT                        R4 K5 [require]
       36 GETTABLEKS                       R5 R0 K9 ["Parent"]
       38 GETTABLEKS                       R5 R5 K11 ["Signals"]
       40 CALL                             R4 1 1
       41 GETIMPORT                        R5 K5 [require]
       43 GETTABLEKS                       R6 R0 K6 ["Util"]
       45 GETTABLEKS                       R6 R6 K11 ["Signals"]
       47 GETTABLEKS                       R6 R6 K14 ["SignalsInstanceUtils"]
       49 CALL                             R5 1 1
       50 GETIMPORT                        R6 K5 [require]
       52 GETIMPORT                        R7 K1 [script]
       54 GETTABLEKS                       R7 R7 K9 ["Parent"]
       56 GETTABLEKS                       R7 R7 K15 ["observeFlattenedJoints"]
       58 CALL                             R6 1 1
