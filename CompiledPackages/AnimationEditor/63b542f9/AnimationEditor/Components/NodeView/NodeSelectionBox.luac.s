...
PROTO_1:
        ...
        2 JUMPIFNOT                        R0 ; [+4]
        3 GETUPVAL                         R0 1
        4 GETTABLEKS                       R0 R0 K0 ["clearSelection"]
        6 CALL                             R0 0 0
        7 GETUPVAL                         R0 2
        8 GETTABLEKS                       R0 R0 K1 ["selectNodesFromRectAsync"]
       10 GETIMPORT                        R1 K4 [Rect.new]
       12 GETUPVAL                         R2 3
       13 GETUPVAL                         R3 3
       14 CALL                             R1 2 1
       15 GETUPVAL                         R2 4
       16 GETTABLEKS                       R2 R2 K5 ["current"]
       18 CALL                             R0 2 0
       19 RETURN                           R0 0
...
PROTO_5:
       ...
       10 CALL                             R1 2 1
       11 GETUPVAL                         R2 2
       12 GETTABLEKS                       R2 R2 K3 ["selectNodesFromRectAsync"]
       14 MOVE                             R3 R1
       15 GETUPVAL                         R4 3
       16 GETTABLEKS                       R4 R4 K4 ["current"]
       18 CALL                             R2 2 0
       19 GETUPVAL                         R2 4
       20 MOVE                             R3 R0
       21 CALL                             R2 1 0
...
PROTO_7:
       ...
       39 CALL                             R8 2 1
       40 GETUPVAL                         R9 0
       41 GETTABLEKS                       R9 R9 K4 ["useCallback"]
       ...
       60 CALL                             R9 2 1
       61 GETUPVAL                         R10 0
       62 GETTABLEKS                       R10 R10 K4 ["useCallback"]
       ...
       73 CALL                             R10 2 1
       74 GETUPVAL                         R11 0
       75 GETTABLEKS                       R11 R11 K4 ["useCallback"]
       ...
       92 CALL                             R11 2 1
       93 GETUPVAL                         R12 0
       94 GETTABLEKS                       R12 R12 K4 ["useCallback"]
      ...
      112 GETUPVAL                         R15 0
      113 GETTABLEKS                       R15 R15 K10 ["Fragment"]
      115 NEWTABLE                         R16 0 0
      117 DUPTABLE                         R17 K13 [{"Box", "BoxInputDetector"}]
      118 JUMPIFNOT                        R1 ; [+76]
      119 JUMPIFNOT                        R3 ; [+75]
      120 GETUPVAL                         R18 0
      121 GETTABLEKS                       R18 R18 K9 ["createElement"]
      123 GETUPVAL                         R19 4
      124 GETTABLEKS                       R19 R19 K14 ["Panel"]
      ...
      198 GETUPVAL                         R18 0
      199 GETTABLEKS                       R18 R18 K9 ["createElement"]
      201 GETUPVAL                         R19 4
      202 GETTABLEKS                       R19 R19 K35 ["InputDetector"]
...
MAIN:
       ...
       18 GETTABLEKS                       R3 R3 K9 ["InputSelectionContext"]
       20 CALL                             R2 1 1
       ...
       39 GETTABLEKS                       R6 R6 K13 ["getFFlagAnimGraphUIInputSelection"]
       41 CALL                             R5 1 1
