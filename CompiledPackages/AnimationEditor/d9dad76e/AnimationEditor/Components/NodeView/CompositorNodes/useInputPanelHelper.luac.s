PROTO_0:
      ...
      119 JUMPIFNOT                        R6 ; [+3]
      120 GETTABLEKS                       R8 R6 K13 ["outputNodeId"]
      122 JUMPIF                           R8 ; [+1]
      123 LOADNIL                          R8
      124 GETUPVAL                         R10 5
      125 JUMPIFNOT                        R10 ; [+2]
      ...
      127 JUMP                             ; [+5]
      128 GETUPVAL                         R9 7
      129 GETTABLEKS                       R9 R9 K14 ["observeGraphNodeMap"]
      131 LOADB                            R10 0
      132 CALL                             R9 1 1
      133 JUMPIFNOT                        R8 ; [+3]
      134 JUMPIFNOT                        R9 ; [+2]
      135 GETTABLE                         R10 R9 R8
      136 JUMP                             ; [+1]
      137 LOADNIL                          R10
      138 DUPTABLE                         R11 K19 [{"Name", "ConnectedNodeId", "ConnectedNodeName", "Value"}]
      139 SETTABLEKS                       R5 R11 K15 ["Name"]
      141 SETTABLEKS                       R8 R11 K16 ["ConnectedNodeId"]
      143 JUMPIFNOT                        R10 ; [+10]
      144 GETUPVAL                         R12 8
      145 GETTABLEKS                       R12 R12 K20 ["getDisplayName"]
      147 GETTABLEKS                       R13 R10 K21 ["name"]
      149 JUMPIF                           R13 ; [+2]
      150 GETTABLEKS                       R13 R10 K22 ["className"]
      152 CALL                             R12 1 1
      153 JUMP                             ; [+3]
      154 GETUPVAL                         R12 9
      155 GETTABLEKS                       R12 R12 K23 ["DISCONNECTED_INPUT"]
      157 SETTABLEKS                       R12 R11 K17 ["ConnectedNodeName"]
      159 SETTABLEKS                       R7 R11 K18 ["Value"]
      161 FASTCALL2                        TABLE_INSERT R0 R11 ; [+5]
      163 MOVE                             R13 R0
      164 MOVE                             R14 R11
      165 GETIMPORT                        R12 K26 [table.insert]
      167 CALL                             R12 2 0
      168 FORGLOOP                         R1 2 ; [-151]
      170 RETURN                           R0 1
...
PROTO_5:
       ...
       47 NEWTABLE                         R7 0 5
       49 GETTABLEKS                       R8 R0 K6 ["GraphPayload"]
       51 GETTABLEKS                       R9 R0 K7 ["Default"]
       53 GETTABLEKS                       R10 R0 K8 ["TransitionFields"]
       55 GETTABLEKS                       R11 R2 K9 ["animationParameters"]
       57 MOVE                             R12 R4
       58 SETLIST                          R7 R8 5 [1]
       60 CALL                             R5 2 1
       61 GETUPVAL                         R6 0
       62 GETTABLEKS                       R6 R6 K10 ["useCallback"]
       64 NEWCLOSURE                       R7 P1
       65 CAPTURE                          VAL R0
       66 CAPTURE                          VAL R1
       67 CAPTURE                          UPVAL U8
       68 NEWTABLE                         R8 0 2
       70 GETTABLEKS                       R9 R0 K6 ["GraphPayload"]
       72 GETTABLEKS                       R10 R0 K8 ["TransitionFields"]
       74 SETLIST                          R8 R9 2 [1]
       76 CALL                             R6 2 1
       77 GETUPVAL                         R7 11
       78 GETTABLEKS                       R7 R7 K11 ["useEventCallback"]
       80 NEWCLOSURE                       R8 P2
       81 CAPTURE                          VAL R0
       82 CAPTURE                          VAL R1
       83 CALL                             R7 1 1
       84 GETUPVAL                         R8 0
       85 GETTABLEKS                       R8 R8 K10 ["useCallback"]
       87 NEWCLOSURE                       R9 P3
       88 CAPTURE                          VAL R0
       89 CAPTURE                          VAL R1
       90 NEWTABLE                         R10 0 3
       92 GETTABLEKS                       R11 R0 K6 ["GraphPayload"]
       94 MOVE                             R12 R5
       95 GETTABLEKS                       R13 R1 K12 ["reorderPins"]
       97 SETLIST                          R10 R11 3 [1]
       99 CALL                             R8 2 1
      100 NEWCLOSURE                       R9 P4
      ...
      106 CAPTURE                          VAL R7
      107 CAPTURE                          VAL R8
      108 DUPTABLE                         R10 K19 [{"inputs", "onInputChanged", "onInputDeleted", "onInputReordered", "newInputDefaultValue", "makePropertyChild"}]
      109 SETTABLEKS                       R5 R10 K13 ["inputs"]
      111 SETTABLEKS                       R6 R10 K14 ["onInputChanged"]
      113 SETTABLEKS                       R7 R10 K15 ["onInputDeleted"]
      115 SETTABLEKS                       R8 R10 K16 ["onInputReordered"]
      117 GETTABLEKS                       R11 R0 K7 ["Default"]
      119 SETTABLEKS                       R11 R10 K17 ["newInputDefaultValue"]
      121 SETTABLEKS                       R9 R10 K18 ["makePropertyChild"]
      123 RETURN                           R10 1
...
MAIN:
      ...
      105 GETTABLEKS                       R14 R0 K24 ["Flags"]
      107 GETTABLEKS                       R14 R14 K26 ["getFFlagAnimGraphUI_FixInputPanelParameters"]
      109 CALL                             R13 1 1
      110 DUPCLOSURE                       R14 K27 [PROTO_5]
      111 CAPTURE                          VAL R9
      112 CAPTURE                          VAL R7
      113 CAPTURE                          VAL R1
      114 CAPTURE                          VAL R5
