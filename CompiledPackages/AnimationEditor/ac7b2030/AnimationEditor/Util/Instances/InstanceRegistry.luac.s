...
PROTO_1:
       ...
       11 NEWTABLE                         R2 0 0
       13 DUPTABLE                         R3 K4 [{"__mode"}]
       14 LOADK                            R4 K5 ["kv"]
       15 SETTABLEKS                       R4 R3 K3 ["__mode"]
       17 FASTCALL2                        SETMETATABLE R2 R3 ; [+3]
       19 GETIMPORT                        R1 K1 [setmetatable]
       21 CALL                             R1 2 1
       22 SETTABLEKS                       R1 R0 K6 ["_idToInstance"]
       24 NEWTABLE                         R2 0 0
       26 DUPTABLE                         R3 K4 [{"__mode"}]
       27 LOADK                            R4 K5 ["kv"]
       28 SETTABLEKS                       R4 R3 K3 ["__mode"]
       30 FASTCALL2                        SETMETATABLE R2 R3 ; [+3]
       32 GETIMPORT                        R1 K1 [setmetatable]
       34 CALL                             R1 2 1
       35 SETTABLEKS                       R1 R0 K7 ["_instanceToId"]
       37 DUPCLOSURE                       R1 K8 [PROTO_0]
       38 CAPTURE                          UPVAL U1
       39 SETTABLEKS                       R1 R0 K9 ["_generateGUID"]
       41 LOADB                            R1 0
       42 SETTABLEKS                       R1 R0 K10 ["_dead"]
       44 RETURN                           R0 1
