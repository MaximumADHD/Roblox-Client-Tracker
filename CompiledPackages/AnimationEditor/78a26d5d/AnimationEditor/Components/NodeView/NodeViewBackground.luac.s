...
PROTO_3:
       ...
       13 CALL                             R2 1 1
       14 GETUPVAL                         R4 3
       15 GETTABLEKS                       R3 R4 K3 ["useSignalState"]
       17 GETTABLEKS                       R4 R2 K4 ["observeZoomRatio"]
       19 CALL                             R3 1 1
       20 GETUPVAL                         R6 4
       21 GETTABLEKS                       R5 R6 K5 ["ORIGINAL_TILE_SIZE"]
       23 MUL                              R4 R3 R5
       24 GETUPVAL                         R6 0
       25 GETTABLEKS                       R5 R6 K6 ["useMemo"]
       27 NEWCLOSURE                       R6 P0
       28 CAPTURE                          VAL R1
       29 CAPTURE                          UPVAL U4
       30 CAPTURE                          VAL R3
       ...
       41 CALL                             R5 2 1
       42 GETUPVAL                         R7 0
       43 GETTABLEKS                       R6 R7 K6 ["useMemo"]
       45 NEWCLOSURE                       R7 P1
       46 CAPTURE                          VAL R4
       47 NEWTABLE                         R8 0 2
       49 MOVE                             R9 R3
       ...
       53 CALL                             R6 2 1
       54 GETUPVAL                         R8 0
       55 GETTABLEKS                       R7 R8 K6 ["useMemo"]
       57 NEWCLOSURE                       R8 P2
       58 CAPTURE                          VAL R4
       59 NEWTABLE                         R9 0 1
       61 MOVE                             R10 R4
       ...
       64 CALL                             R7 2 1
       65 GETUPVAL                         R9 0
       66 GETTABLEKS                       R8 R9 K9 ["createElement"]
...
MAIN:
       ...
       32 GETTABLEKS                       R5 R6 K11 ["SignalsReact"]
       34 CALL                             R4 1 1
