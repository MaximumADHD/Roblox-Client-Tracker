...
PROTO_2:
       ...
       10 LOADK                            R1 K0 ["%* / %*"]
       11 GETUPVAL                         R5 0
       12 GETTABLEKS                       R4 R5 K3 ["timePosition"]
       14 JUMPIFNOTEQKN                    R4 K4 [0] ; [+3]
       16 LOADK                            R3 K1 ["0.00"]
       17 JUMP                             ; [+17]
       18 FASTCALL1                        MATH_FLOOR R4 ; [+3]
       19 MOVE                             R6 R4
       20 GETIMPORT                        R5 K7 [math.floor]
       22 CALL                             R5 1 1
       23 MULK                             R7 R4 K8 [100]
       24 FASTCALL1                        MATH_ROUND R7 ; [+2]
       25 GETIMPORT                        R6 K10 [math.round]
       27 CALL                             R6 1 1
       28 GETIMPORT                        R7 K12 [string.format]
       30 LOADK                            R8 K13 ["%d:%02d"]
       31 MOVE                             R9 R5
       32 MOVE                             R10 R6
       33 CALL                             R7 3 1
       34 MOVE                             R3 R7
       35 GETUPVAL                         R6 0
       36 GETTABLEKS                       R5 R6 K14 ["length"]
       38 JUMPIFNOTEQKN                    R5 K4 [0] ; [+3]
       40 LOADK                            R4 K1 ["0.00"]
       41 JUMP                             ; [+17]
       42 FASTCALL1                        MATH_FLOOR R5 ; [+3]
       43 MOVE                             R7 R5
       44 GETIMPORT                        R6 K7 [math.floor]
       46 CALL                             R6 1 1
       47 MULK                             R8 R5 K8 [100]
       48 FASTCALL1                        MATH_ROUND R8 ; [+2]
       49 GETIMPORT                        R7 K10 [math.round]
       51 CALL                             R7 1 1
       52 GETIMPORT                        R8 K12 [string.format]
       54 LOADK                            R9 K13 ["%d:%02d"]
       55 MOVE                             R10 R6
       56 MOVE                             R11 R7
       57 CALL                             R8 3 1
       58 MOVE                             R4 R8
       59 NAMECALL                         R1 R1 K2 ["format"]
       61 CALL                             R1 3 1
       62 MOVE                             R0 R1
       63 RETURN                           R0 1
