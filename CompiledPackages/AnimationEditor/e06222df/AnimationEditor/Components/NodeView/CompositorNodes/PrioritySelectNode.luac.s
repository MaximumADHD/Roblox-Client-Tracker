PROTO_0:
        ...
        3 GETUPVAL                         R3 1
        4 GETTABLEKS                       R2 R3 K4 ["PropertyLookup"]
        6 GETTABLEKS                       R1 R2 K5 ["DefaultInterruptible"]
        8 JUMPIF                           R1 ; [+2]
        9 GETIMPORT                        R1 K9 [Enum.AnimationNodeInterruptible.Always]
       11 SETTABLEKS                       R1 R0 K0 ["Interruptible"]
       13 GETUPVAL                         R3 1
       14 GETTABLEKS                       R2 R3 K4 ["PropertyLookup"]
       16 GETTABLEKS                       R1 R2 K10 ["DefaultTransitionDuration"]
       18 JUMPIF                           R1 ; [+5]
       19 GETUPVAL                         R3 2
       20 GETTABLEKS                       R2 R3 K11 ["DEFAULT_TRANSITION"]
       22 GETTABLEKS                       R1 R2 K1 ["Duration"]
       24 SETTABLEKS                       R1 R0 K1 ["Duration"]
       26 GETUPVAL                         R3 1
       27 GETTABLEKS                       R2 R3 K4 ["PropertyLookup"]
       29 GETTABLEKS                       R1 R2 K12 ["DefaultTransitionCurve"]
       31 JUMPIF                           R1 ; [+5]
       32 GETUPVAL                         R3 2
       33 GETTABLEKS                       R2 R3 K11 ["DEFAULT_TRANSITION"]
       35 GETTABLEKS                       R1 R2 K2 ["Curve"]
       37 SETTABLEKS                       R1 R0 K2 ["Curve"]
       39 RETURN                           R0 1
       40 DUPTABLE                         R0 K14 [{"Interruptible", "InterruptibleTrigger", "Duration", "Curve"}]
       41 GETUPVAL                         R3 1
       42 GETTABLEKS                       R2 R3 K4 ["PropertyLookup"]
       44 GETTABLEKS                       R1 R2 K5 ["DefaultInterruptible"]
       46 JUMPIF                           R1 ; [+2]
       47 GETIMPORT                        R1 K9 [Enum.AnimationNodeInterruptible.Always]
       49 SETTABLEKS                       R1 R0 K0 ["Interruptible"]
       51 GETUPVAL                         R4 1
       52 GETTABLEKS                       R3 R4 K4 ["PropertyLookup"]
       54 GETTABLEKS                       R2 R3 K16 ["DefaultInterruptibleTrigger"]
       56 ORK                              R1 R2 K15 [False]
       57 SETTABLEKS                       R1 R0 K13 ["InterruptibleTrigger"]
       59 GETUPVAL                         R3 1
       60 GETTABLEKS                       R2 R3 K4 ["PropertyLookup"]
       62 GETTABLEKS                       R1 R2 K10 ["DefaultTransitionDuration"]
       64 JUMPIF                           R1 ; [+5]
       65 GETUPVAL                         R3 2
       66 GETTABLEKS                       R2 R3 K11 ["DEFAULT_TRANSITION"]
       68 GETTABLEKS                       R1 R2 K1 ["Duration"]
       70 SETTABLEKS                       R1 R0 K1 ["Duration"]
       72 GETUPVAL                         R3 1
       73 GETTABLEKS                       R2 R3 K4 ["PropertyLookup"]
       75 GETTABLEKS                       R1 R2 K12 ["DefaultTransitionCurve"]
       77 JUMPIF                           R1 ; [+5]
       78 GETUPVAL                         R3 2
       79 GETTABLEKS                       R2 R3 K11 ["DEFAULT_TRANSITION"]
       81 GETTABLEKS                       R1 R2 K2 ["Curve"]
...
PROTO_2:
       ...
       31 CAPTURE                          UPVAL U3
       32 NEWTABLE                         R4 0 4
       34 GETTABLEKS                       R6 R0 K11 ["PropertyLookup"]
       36 GETTABLEKS                       R5 R6 K12 ["DefaultInterruptibleTrigger"]
       38 GETTABLEKS                       R7 R0 K11 ["PropertyLookup"]
       40 GETTABLEKS                       R6 R7 K13 ["DefaultInterruptible"]
       42 GETTABLEKS                       R8 R0 K11 ["PropertyLookup"]
       44 GETTABLEKS                       R7 R8 K14 ["DefaultTransitionDuration"]
       46 GETTABLEKS                       R9 R0 K11 ["PropertyLookup"]
       48 GETTABLEKS                       R8 R9 K15 ["DefaultTransitionCurve"]
       50 SETLIST                          R4 R5 4 [1]
       52 CALL                             R2 2 1
       53 GETUPVAL                         R4 1
       54 GETTABLEKS                       R3 R4 K16 ["useCallback"]
       56 NEWCLOSURE                       R4 P1
       57 CAPTURE                          VAL R0
       58 NEWTABLE                         R5 0 1
       ...
       64 CALL                             R3 2 1
       65 GETUPVAL                         R5 4
       66 GETTABLEKS                       R4 R5 K18 ["createPropertyHelpers"]
       68 MOVE                             R5 R0
       69 CALL                             R4 1 1
      ...
      148 GETTABLEKS                       R9 R0 K0 ["GraphPayload"]
      150 GETTABLEKS                       R8 R9 K57 ["id"]
      ...
      173 GETUPVAL                         R7 1
      174 GETTABLEKS                       R6 R7 K62 ["createElement"]
      176 GETUPVAL                         R7 7
