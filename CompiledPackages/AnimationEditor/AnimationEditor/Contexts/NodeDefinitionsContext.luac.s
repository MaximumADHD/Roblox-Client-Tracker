...
MAIN:
  ...
  CAPTURE VAL R5
  CAPTURE VAL R2
  DUPTABLE R7 K39 [{"nodeGroups"}]
  MOVE R8 R6
  CALL R8 0 1
  SETTABLEKS R8 R7 K38 ["nodeGroups"]
  GETTABLEKS R8 R4 K40 ["createContext"]
  MOVE R9 R7
  CALL R8 1 1
  ...
  CAPTURE VAL R4
  CAPTURE VAL R8
  DUPTABLE R10 K44 [{"Context", "Provider"}]
  SETTABLEKS R8 R10 K42 ["Context"]
  SETTABLEKS R9 R10 K43 ["Provider"]
  RETURN R10 1
