...
MAIN:
  ...
  LOADB R7 1
  SETTABLE R7 R5 R6
  GETIMPORT R6 K20 [Enum.AnimationNodeType.ClipNode]
  LOADB R7 1
  SETTABLE R7 R5 R6
  GETIMPORT R6 K22 [Enum.AnimationNodeType.SelectNode]
  LOADB R7 1
  SETTABLE R7 R5 R6
  GETIMPORT R6 K24 [Enum.AnimationNodeType.SubtractNode]
  LOADB R7 1
  SETTABLE R7 R5 R6
  ...
  CAPTURE VAL R5
  CAPTURE VAL R2
  DUPTABLE R7 K27 [{"nodeGroups"}]
  MOVE R8 R6
  CALL R8 0 1
  SETTABLEKS R8 R7 K26 ["nodeGroups"]
  GETTABLEKS R8 R4 K28 ["createContext"]
  MOVE R9 R7
  CALL R8 1 1
  ...
  CAPTURE VAL R4
  CAPTURE VAL R8
  DUPTABLE R10 K32 [{"Context", "Provider"}]
  SETTABLEKS R8 R10 K30 ["Context"]
  SETTABLEKS R9 R10 K31 ["Provider"]
  RETURN R10 1
