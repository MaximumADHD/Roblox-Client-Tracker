...
PROTO_1:
  ...
  LOADK R8 K26 ["Folder"]
  NEWTABLE R9 0 0
  DUPTABLE R10 K28 [{"RenderedPinInput"}]
  GETUPVAL R12 1
  GETTABLEKS R11 R12 K4 ["createElement"]
  GETUPVAL R12 5
  DUPTABLE R13 K34 [{"Position", "pinSide", "pinDataType", "pinNodeId", "pinName"}]
  ...
  LOADK R14 K3 ["Input"]
  SETTABLEKS R14 R13 K30 ["pinSide"]
  LOADK R14 K39 ["Animation"]
  SETTABLEKS R14 R13 K31 ["pinDataType"]
  GETTABLEKS R14 R0 K40 ["NodeId"]
  SETTABLEKS R14 R13 K32 ["pinNodeId"]
  GETTABLEKS R15 R0 K3 ["Input"]
  GETTABLEKS R14 R15 K14 ["Name"]
  SETTABLEKS R14 R13 K33 ["pinName"]
  CALL R11 2 1
  SETTABLEKS R11 R10 K27 ["RenderedPinInput"]
  CALL R7 3 1
