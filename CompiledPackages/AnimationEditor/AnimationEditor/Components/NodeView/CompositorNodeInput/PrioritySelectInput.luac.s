...
PROTO_1:
  ...
  DUPTABLE R6 K13 [{"Transition", "Condition", "PinChildren"}]
  GETTABLEKS R7 R1 K14 ["nextProperty"]
  DUPTABLE R8 K22 [{"Name", "Label", "Weight", "Type", "Value", "DefaultValue", "OnChanged", "ExtraProps"}]
  ...
  GETTABLEKS R10 R0 K24 ["InputBuilderProps"]
  GETTABLEKS R9 R10 K25 ["DefaultTransition"]
  SETTABLEKS R9 R8 K20 ["DefaultValue"]
  SETTABLEKS R2 R8 K2 ["OnChanged"]
  DUPTABLE R9 K27 [{"TransitionBuilder"}]
  GETUPVAL R10 4
  SETTABLEKS R10 R9 K26 ["TransitionBuilder"]
  SETTABLEKS R9 R8 K21 ["ExtraProps"]
  CALL R7 1 1
  SETTABLEKS R7 R6 K10 ["Transition"]
  GETTABLEKS R7 R1 K14 ["nextProperty"]
  DUPTABLE R8 K28 [{"Name", "Label", "Type", "Value"}]
  LOADK R9 K11 ["Condition"]
  SETTABLEKS R9 R8 K15 ["Name"]
  LOADK R9 K11 ["Condition"]
  SETTABLEKS R9 R8 K16 ["Label"]
  LOADK R9 K29 ["Boolean"]
  SETTABLEKS R9 R8 K18 ["Type"]
  GETTABLEKS R12 R0 K3 ["Input"]
  GETTABLEKS R11 R12 K19 ["Value"]
  GETTABLEKS R10 R11 K11 ["Condition"]
  ORK R9 R10 K23 []
  SETTABLEKS R9 R8 K19 ["Value"]
  CALL R7 1 1
  SETTABLEKS R7 R6 K11 ["Condition"]
  GETUPVAL R8 1
  ...
  LOADK R14 K43 ["Animation"]
  SETTABLEKS R14 R13 K35 ["pinDataType"]
  GETTABLEKS R14 R0 K44 ["NodeId"]
...
MAIN:
  ...
  GETTABLEKS R6 R7 K17 ["PrioritySelectTransition"]
  CALL R5 1 1
