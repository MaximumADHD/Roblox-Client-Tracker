...
PROTO_2:
  GETUPVAL R2 0
  GETTABLEKS R1 R2 K0 ["attributes"]
  GETTABLEKS R0 R1 K1 ["observeString"]
  GETUPVAL R2 1
  GETTABLEKS R1 R2 K2 ["selectedMaskInstance"]
  LOADK R2 K3 ["RBX_MaskRigType"]
  CALL R0 2 -1
  RETURN R0 -1
...
PROTO_7:
  ...
  CALL R1 2 0
  GETUPVAL R2 0
  GETTABLEKS R1 R2 K6 ["selectedMaskInstance"]
  LOADK R3 K7 ["RBX_MaskRigType"]
  MOVE R4 R0
  NAMECALL R1 R1 K8 ["SetAttribute"]
  CALL R1 3 0
  JUMPIFNOTEQKS R0 K9 ["HRD"] [+28]
  GETUPVAL R2 0
  GETTABLEKS R1 R2 K6 ["selectedMaskInstance"]
  ...
  GETUPVAL R1 1
  GETUPVAL R3 0
  GETTABLEKS R2 R3 K6 ["selectedMaskInstance"]
  GETIMPORT R3 K15 [Enum.RigLabel.Root]
  CALL R1 2 0
  GETUPVAL R2 0
  GETTABLEKS R1 R2 K6 ["selectedMaskInstance"]
  LOADK R3 K16 ["RBX_MaskRigName"]
  LOADK R4 K17 [""]
  NAMECALL R1 R1 K8 ["SetAttribute"]
  CALL R1 3 0
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R10 R11 K18 ["SignalsReact"]
  CALL R9 1 1
