...
PROTO_4:
  ...
  GETTABLEKS R9 R10 K7 ["createElement"]
  GETUPVAL R10 2
  DUPTABLE R11 K42 [{"Label", "Type", "Value", "IsParameterized", "OnChanged", "LayoutOrder"}]
  LOADK R12 K43 ["Transition Type"]
  SETTABLEKS R12 R11 K25 ["Label"]
  LOADK R12 K44 ["Enum.AnimationNodeTransitionType"]
  SETTABLEKS R12 R11 K40 ["Type"]
  GETTABLEKS R13 R0 K2 ["Value"]
  GETTABLEKS R12 R13 K4 ["TransitionType"]
  SETTABLEKS R12 R11 K2 ["Value"]
  GETTABLEKS R12 R0 K41 ["IsParameterized"]
  SETTABLEKS R12 R11 K41 ["IsParameterized"]
  ...
  GETUPVAL R10 3
  DUPTABLE R11 K42 [{"Label", "Type", "Value", "IsParameterized", "OnChanged", "LayoutOrder"}]
  LOADK R12 K45 ["Length"]
  SETTABLEKS R12 R11 K25 ["Label"]
  LOADK R12 K46 ["Timestamp"]
  SETTABLEKS R12 R11 K40 ["Type"]
  GETTABLEKS R13 R0 K2 ["Value"]
  ...
  GETIMPORT R11 K50 [Enum.AnimationNodeTransitionType.CrossFade]
  ...
  LOADK R12 K51 ["Curve"]
  SETTABLEKS R12 R11 K25 ["Label"]
  LOADK R12 K52 ["Enum.PoseEasingDirection"]
  SETTABLEKS R12 R11 K40 ["Type"]
  GETTABLEKS R13 R0 K2 ["Value"]
  GETTABLEKS R12 R13 K53 ["CurveType"]
  SETTABLEKS R12 R11 K2 ["Value"]
  GETTABLEKS R12 R0 K41 ["IsParameterized"]
  SETTABLEKS R12 R11 K41 ["IsParameterized"]
