PROTO_0:
  ...
  DUPTABLE R7 K11 [{"tag", "Text", "LayoutOrder"}]
  LOADK R8 K12 ["text-body-small text-align-x-left auto-xy fill text-truncate-split"]
  SETTABLEKS R8 R7 K2 ["tag"]
  GETTABLEKS R8 R0 K13 ["Label"]
  ...
  GETTABLEKS R5 R6 K0 ["createElement"]
  GETUPVAL R6 2
  DUPTABLE R7 K16 [{"info", "updateValue", "LayoutOrder"}]
  DUPTABLE R8 K20 [{"type", "value", "readonly"}]
  LOADK R9 K21 ["boolean"]
  SETTABLEKS R9 R8 K17 ["type"]
  GETTABLEKS R10 R0 K23 ["Value"]
  ORK R9 R10 K22 [False]
  SETTABLEKS R9 R8 K18 ["value"]
  GETTABLEKS R9 R0 K24 ["IsParameterized"]
  SETTABLEKS R9 R8 K19 ["readonly"]
  SETTABLEKS R8 R7 K14 ["info"]
  GETTABLEKS R8 R0 K25 ["OnChanged"]
  SETTABLEKS R8 R7 K15 ["updateValue"]
  LOADN R8 2
  SETTABLEKS R8 R7 K3 ["LayoutOrder"]
  CALL R5 2 1
