...
PROTO_1:
  ...
  DUPTABLE R8 K24 [{"size", "width", "label", "value", "isDisabled", "LayoutOrder", "precision", "controlsVariant", "onChanged"}]
  GETUPVAL R12 1
  ...
  GETTABLEKS R9 R0 K32 ["IsParameterized"]
  SETTABLEKS R9 R8 K20 ["isDisabled"]
  LOADN R9 2
  SETTABLEKS R9 R8 K5 ["LayoutOrder"]
  LOADN R9 2
  SETTABLEKS R9 R8 K21 ["precision"]
  GETUPVAL R12 1
  GETTABLEKS R11 R12 K25 ["Enums"]
  GETTABLEKS R10 R11 K33 ["NumberInputControlsVariant"]
  GETTABLEKS R9 R10 K34 ["None"]
  SETTABLEKS R9 R8 K22 ["controlsVariant"]
  GETTABLEKS R9 R0 K35 ["OnChanged"]
  SETTABLEKS R9 R8 K23 ["onChanged"]
  CALL R6 2 1
