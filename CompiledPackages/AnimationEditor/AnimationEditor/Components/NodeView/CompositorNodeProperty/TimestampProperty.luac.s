PROTO_0:
  ...
  DUPTABLE R8 K24 [{"size", "width", "label", "value", "isDisabled", "LayoutOrder", "precision", "formatAsString", "onChanged"}]
  GETUPVAL R12 2
  ...
  GETTABLEKS R9 R0 K32 ["Value"]
  SETTABLEKS R9 R8 K19 ["value"]
  GETTABLEKS R9 R0 K33 ["IsParameterized"]
  SETTABLEKS R9 R8 K20 ["isDisabled"]
  LOADN R9 2
  SETTABLEKS R9 R8 K5 ["LayoutOrder"]
  LOADN R9 2
  SETTABLEKS R9 R8 K21 ["precision"]
  SETTABLEKS R1 R8 K22 ["formatAsString"]
  GETTABLEKS R9 R0 K34 ["OnChanged"]
