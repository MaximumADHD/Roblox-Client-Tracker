...
PROTO_2:
  ...
  DUPTABLE R10 K32 [{"size", "width", "label", "value", "isDisabled", "minimum", "maximum", "step", "formatAsString", "LayoutOrder", "precision", "controlsVariant", "onChanged", "isScrubbable"}]
  GETUPVAL R14 2
  GETTABLEKS R13 R14 K33 ["Enums"]
  GETTABLEKS R12 R13 K34 ["InputSize"]
  GETTABLEKS R11 R12 K35 ["XSmall"]
  SETTABLEKS R11 R10 K19 ["size"]
  GETIMPORT R11 K38 [UDim.new]
  LOADN R12 0
  LOADN R13 90
  CALL R11 2 1
  ...
  MOVE R15 R2
  GETIMPORT R14 K43 [math.deg]
  CALL R14 1 1
  MULK R13 R14 K40 [100]
  FASTCALL1 MATH_ROUND R13 [+2]
  GETIMPORT R12 K45 [math.round]
  CALL R12 1 1
  DIVK R11 R12 K40 [100]
  SETTABLEKS R11 R10 K22 ["value"]
  GETTABLEKS R11 R0 K46 ["IsParameterized"]
  SETTABLEKS R11 R10 K23 ["isDisabled"]
  LOADN R11 76
  SETTABLEKS R11 R10 K24 ["minimum"]
  LOADN R11 180
  SETTABLEKS R11 R10 K25 ["maximum"]
  LOADN R11 5
  SETTABLEKS R11 R10 K26 ["step"]
  SETTABLEKS R1 R10 K27 ["formatAsString"]
  LOADN R11 2
  SETTABLEKS R11 R10 K8 ["LayoutOrder"]
  LOADN R11 2
  SETTABLEKS R11 R10 K28 ["precision"]
  GETUPVAL R14 2
  GETTABLEKS R13 R14 K33 ["Enums"]
  GETTABLEKS R12 R13 K47 ["NumberInputControlsVariant"]
  GETTABLEKS R11 R12 K48 ["None"]
  SETTABLEKS R11 R10 K29 ["controlsVariant"]
  SETTABLEKS R3 R10 K30 ["onChanged"]
  LOADB R11 1
  SETTABLEKS R11 R10 K31 ["isScrubbable"]
  CALL R8 2 1
