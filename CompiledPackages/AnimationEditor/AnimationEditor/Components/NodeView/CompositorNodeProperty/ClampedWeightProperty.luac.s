...
PROTO_2:
  ...
  DUPTABLE R6 K14 [{"CompositorNodeInputLabel", "Input", "Clamped", "PinChildren"}]
  GETUPVAL R8 0
  GETTABLEKS R7 R8 K5 ["createElement"]
  GETUPVAL R8 2
  DUPTABLE R9 K17 [{"tag", "Text", "LayoutOrder", "isDisabled"}]
  LOADK R10 K18 ["text-body-small text-align-x-left auto-xy fill text-truncate-split"]
  SETTABLEKS R10 R9 K7 ["tag"]
  GETTABLEKS R10 R0 K19 ["Label"]
  SETTABLEKS R10 R9 K15 ["Text"]
  LOADN R10 1
  SETTABLEKS R10 R9 K8 ["LayoutOrder"]
  GETTABLEKS R10 R0 K20 ["IsReadOnly"]
  ...
  GETTABLEKS R7 R8 K5 ["createElement"]
  GETUPVAL R9 1
  GETTABLEKS R8 R9 K21 ["NumberInput"]
  DUPTABLE R9 K33 [{"size", "width", "label", "value", "LayoutOrder", "precision", "onChanged", "isDisabled", "isScrubbable", "controlsVariant", "minimum", "maximum", "step"}]
  GETUPVAL R13 1
  GETTABLEKS R12 R13 K34 ["Enums"]
  GETTABLEKS R11 R12 K35 ["InputSize"]
  GETTABLEKS R10 R11 K36 ["XSmall"]
  SETTABLEKS R10 R9 K22 ["size"]
  GETIMPORT R10 K39 [UDim.new]
  LOADN R11 0
  LOADN R12 90
  CALL R10 2 1
  SETTABLEKS R10 R9 K23 ["width"]
  LOADK R10 K40 [""]
  SETTABLEKS R10 R9 K24 ["label"]
  ...
  SETTABLEKS R10 R9 K8 ["LayoutOrder"]
  LOADN R10 2
  SETTABLEKS R10 R9 K26 ["precision"]
  SETTABLEKS R1 R9 K27 ["onChanged"]
  GETTABLEKS R10 R0 K20 ["IsReadOnly"]
  SETTABLEKS R10 R9 K16 ["isDisabled"]
  GETTABLEKS R11 R0 K2 ["Value"]
  GETTABLEKS R10 R11 K3 ["Clamped"]
  SETTABLEKS R10 R9 K28 ["isScrubbable"]
  GETUPVAL R13 1
  GETTABLEKS R12 R13 K34 ["Enums"]
  GETTABLEKS R11 R12 K41 ["NumberInputControlsVariant"]
  GETTABLEKS R10 R11 K42 ["None"]
  SETTABLEKS R10 R9 K29 ["controlsVariant"]
  ...
  JUMP [+1]
  LOADNIL R10
  SETTABLEKS R10 R9 K32 ["step"]
  CALL R7 2 1
  SETTABLEKS R7 R6 K12 ["Input"]
  GETUPVAL R8 0
  GETTABLEKS R7 R8 K5 ["createElement"]
  GETUPVAL R8 3
  DUPTABLE R9 K46 [{"info", "updateValue", "LayoutOrder"}]
  DUPTABLE R10 K48 [{"type", "value"}]
  LOADK R11 K49 ["boolean"]
  SETTABLEKS R11 R10 K47 ["type"]
  GETTABLEKS R13 R0 K2 ["Value"]
  GETTABLEKS R12 R13 K3 ["Clamped"]
  ORK R11 R12 K50 [False]
  SETTABLEKS R11 R10 K25 ["value"]
  SETTABLEKS R10 R9 K44 ["info"]
  SETTABLEKS R2 R9 K45 ["updateValue"]
  LOADN R10 3
  SETTABLEKS R10 R9 K8 ["LayoutOrder"]
  CALL R7 2 1
  ...
  LOADK R8 K51 ["Folder"]
  NEWTABLE R9 0 0
  GETTABLEKS R10 R0 K52 ["children"]
  CALL R7 3 1
  SETTABLEKS R7 R6 K13 ["PinChildren"]
  CALL R3 3 -1
  RETURN R3 -1
