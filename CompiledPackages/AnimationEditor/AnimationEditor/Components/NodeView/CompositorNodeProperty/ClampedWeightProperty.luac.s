...
PROTO_2:
  ...
  GETTABLEKS R7 R8 K5 ["createElement"]
  GETUPVAL R9 1
  GETTABLEKS R8 R9 K19 ["NumberInput"]
  DUPTABLE R9 K31 [{"size", "width", "label", "value", "LayoutOrder", "precision", "onChanged", "isScrubbable", "controlsVariant", "minimum", "maximum", "step"}]
  GETUPVAL R13 1
  GETTABLEKS R12 R13 K32 ["Enums"]
  GETTABLEKS R11 R12 K33 ["InputSize"]
  ...
  SETTABLEKS R10 R9 K8 ["LayoutOrder"]
  LOADN R10 2
  SETTABLEKS R10 R9 K24 ["precision"]
  SETTABLEKS R1 R9 K25 ["onChanged"]
  GETTABLEKS R11 R0 K2 ["Value"]
  GETTABLEKS R10 R11 K3 ["Clamped"]
  SETTABLEKS R10 R9 K26 ["isScrubbable"]
  GETUPVAL R13 1
  GETTABLEKS R12 R13 K32 ["Enums"]
  GETTABLEKS R11 R12 K39 ["NumberInputControlsVariant"]
  GETTABLEKS R10 R11 K40 ["None"]
  SETTABLEKS R10 R9 K27 ["controlsVariant"]
  ...
  JUMP [+1]
  LOADNIL R10
  SETTABLEKS R10 R9 K30 ["step"]
  CALL R7 2 1
  SETTABLEKS R7 R6 K12 ["Input"]
  GETUPVAL R8 0
  GETTABLEKS R7 R8 K5 ["createElement"]
  GETUPVAL R8 2
  DUPTABLE R9 K44 [{"info", "updateValue", "LayoutOrder"}]
  DUPTABLE R10 K46 [{"type", "value"}]
  LOADK R11 K47 ["boolean"]
  SETTABLEKS R11 R10 K45 ["type"]
  GETTABLEKS R13 R0 K2 ["Value"]
  GETTABLEKS R12 R13 K3 ["Clamped"]
  ORK R11 R12 K48 [False]
  SETTABLEKS R11 R10 K23 ["value"]
  SETTABLEKS R10 R9 K42 ["info"]
  SETTABLEKS R2 R9 K43 ["updateValue"]
  LOADN R10 3
  SETTABLEKS R10 R9 K8 ["LayoutOrder"]
  CALL R7 2 1
  ...
  LOADK R8 K49 ["Folder"]
  NEWTABLE R9 0 0
  GETTABLEKS R10 R0 K50 ["children"]
  CALL R7 3 1
