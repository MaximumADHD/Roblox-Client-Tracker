PROTO_0:
  ...
  DUPTABLE R4 K7 [{"Input", "Builder"}]
  DUPTABLE R5 K9 [{"Name"}]
  LOADK R6 K10 ["Pose"]
  SETTABLEKS R6 R5 K8 ["Name"]
  SETTABLEKS R5 R4 K5 ["Input"]
  GETUPVAL R5 1
  ...
  GETUPVAL R4 3
  GETTABLEKS R5 R1 K20 ["nodeProps"]
  DUPTABLE R6 K22 [{"OutputPin"}]
  GETTABLEKS R7 R1 K23 ["outputPin"]
  CALL R7 0 1
  SETTABLEKS R7 R6 K21 ["OutputPin"]
  CALL R5 1 1
  MOVE R6 R2
  CALL R3 3 -1
  RETURN R3 -1
