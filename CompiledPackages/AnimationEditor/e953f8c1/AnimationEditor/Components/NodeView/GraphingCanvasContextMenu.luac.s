...
PROTO_13:
       ...
       62 CALL                             R6 0 1
       63 JUMPIFNOT                        R6 ; [+13]
       64 DUPTABLE                         R5 K20 [{["id"] = "insertStateMachine", ["text"] = "Insert State Machine", ["onActivated"], ["isDisabled"]}]
       65 GETUPVAL                         R6 7
       66 SETTABLEKS                       R6 R5 K19 ["onActivated"]
       68 GETUPVAL                         R7 1
       69 CALL                             R7 0 1
       70 JUMPIFNOT                        R7 ; [+2]
       71 GETUPVAL                         R6 4
       72 JUMP                             ; [+1]
       73 LOADNIL                          R6
       74 SETTABLEKS                       R6 R5 K5 ["isDisabled"]
       76 JUMP                             ; [+1]
       77 LOADNIL                          R5
       78 SETLIST                          R2 R3 3 [1]
       80 SETTABLEKS                       R2 R1 K0 ["items"]
       82 DUPTABLE                         R2 K1 [{"items"}]
       83 GETUPVAL                         R3 8
       84 SETTABLEKS                       R3 R2 K0 ["items"]
       86 DUPTABLE                         R3 K1 [{"items"}]
       87 NEWTABLE                         R4 0 1
       89 DUPTABLE                         R5 K22 [{["id"] = "frameSelection", ["text"], ["onActivated"]}]
       90 GETUPVAL                         R7 1
       91 CALL                             R7 0 1
       92 JUMPIFNOT                        R7 ; [+20]
       93 GETUPVAL                         R7 9
       94 JUMPIFNOT                        R7 ; [+9]
       95 GETUPVAL                         R6 2
       96 LOADK                            R8 K7 ["Common"]
       97 LOADK                            R9 K8 ["AnimationEditor"]
       98 LOADK                            R10 K9 ["Menu"]
       99 LOADK                            R11 K23 ["FrameSelection"]
      100 NAMECALL                         R6 R6 K11 ["getExternalText"]
      102 CALL                             R6 5 1
      103 JUMP                             ; [+10]
      104 GETUPVAL                         R6 2
      ...
      108 LOADK                            R11 K24 ["FrameAll"]
      109 NAMECALL                         R6 R6 K11 ["getExternalText"]
      111 CALL                             R6 5 1
      112 JUMP                             ; [+1]
      113 LOADK                            R6 K25 ["Frame Selection"]
      114 SETTABLEKS                       R6 R5 K4 ["text"]
      116 GETUPVAL                         R7 1
      117 CALL                             R7 0 1
      118 JUMPIFNOT                        R7 ; [+2]
      119 GETUPVAL                         R6 10
      120 JUMP                             ; [+3]
      121 GETUPVAL                         R6 11
      122 GETTABLEKS                       R6 R6 K21 ["frameSelection"]
      124 SETTABLEKS                       R6 R5 K19 ["onActivated"]
      126 SETLIST                          R4 R5 1 [1]
      128 SETTABLEKS                       R4 R3 K0 ["items"]
      130 SETLIST                          R0 R1 3 [1]
      132 RETURN                           R0 1
