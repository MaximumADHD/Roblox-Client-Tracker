...
PROTO_1:
       ...
       19 GETUPVAL                         R2 5
       20 GETTABLEKS                       R2 R2 K5 ["encode"]
       22 GETUPVAL                         R3 6
       23 GETTABLEKS                       R3 R3 K6 ["readFromDefinition"]
       25 GETUPVAL                         R4 3
       26 CALL                             R3 1 -1
       27 CALL                             R2 -1 1
       28 SETTABLEKS                       R2 R1 K2 ["data"]
       30 RETURN                           R1 1
...
PROTO_2:
       ...
       19 MOVE                             R6 R0
       20 CALL                             R5 1 1
       21 DUPCLOSURE                       R6 K6 [PROTO_0]
       22 CAPTURE                          UPVAL U1
       23 CALL                             R4 2 1
       24 GETUPVAL                         R5 2
       25 GETTABLEKS                       R5 R5 K7 ["createComputed"]
       27 NEWCLOSURE                       R6 P1
       28 CAPTURE                          VAL R3
       29 CAPTURE                          VAL R4
       30 CAPTURE                          VAL R1
...
PROTO_13:
       ...
       17 MOVE                             R5 R2
       18 GETUPVAL                         R6 3
       19 GETTABLEKS                       R6 R6 K5 ["decode"]
       21 MOVE                             R7 R1
       22 CALL                             R6 1 1
       23 GETTABLEKS                       R7 R2 K6 ["Name"]
       25 CALL                             R4 3 1
       26 MOVE                             R5 R4
       27 LOADNIL                          R6
       28 LOADNIL                          R7
       ...
       32 LOADK                            R12 K9 ["StateMachine \"%*\": %*"]
       33 GETTABLEKS                       R14 R2 K6 ["Name"]
       35 MOVE                             R15 R9
       36 NAMECALL                         R12 R12 K10 ["format"]
       38 CALL                             R12 3 1
       39 MOVE                             R11 R12
       40 CALL                             R10 1 0
       41 FORGLOOP                         R5 2 ; [-12]
       ...
       44 GETUPVAL                         R5 1
       45 MOVE                             R7 R3
       46 GETIMPORT                        R8 K14 [Enum.FinishRecordingOperation.Commit]
       48 NAMECALL                         R5 R5 K15 ["FinishRecording"]
       50 CALL                             R5 3 0
       51 RETURN                           R0 0
...
MAIN:
      ...
      187 DUPCLOSURE                       R24 K59 [PROTO_2]
      188 CAPTURE                          VAL R16
      189 CAPTURE                          VAL R12
      190 CAPTURE                          VAL R10
      191 CAPTURE                          VAL R19
      192 CAPTURE                          VAL R15
      193 DUPCLOSURE                       R25 K60 [PROTO_15]
      194 CAPTURE                          VAL R7
      195 CAPTURE                          VAL R4
      196 CAPTURE                          VAL R18
      197 CAPTURE                          VAL R9
      ...
      209 CAPTURE                          VAL R6
      210 CAPTURE                          VAL R23
      211 DUPCLOSURE                       R26 K61 [PROTO_17]
      212 CAPTURE                          VAL R6
      213 CAPTURE                          VAL R7
      214 CAPTURE                          VAL R23
      215 DUPTABLE                         R27 K65 [{"Context", "EditableDataModelProvider", "UIDataModelProvider"}]
      216 SETTABLEKS                       R23 R27 K62 ["Context"]
      218 SETTABLEKS                       R25 R27 K63 ["EditableDataModelProvider"]
      220 SETTABLEKS                       R26 R27 K64 ["UIDataModelProvider"]
      222 RETURN                           R27 1
