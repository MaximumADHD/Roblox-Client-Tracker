...
PROTO_2:
      ...
      208 DUPTABLE                         R8 K55 [{"Name", "Type", "Value", "DefaultValue", "Step", "Precision", "IsReadOnly"}]
      209 LOADK                            R9 K14 ["TrimStart"]
      210 SETTABLEKS                       R9 R8 K28 ["Name"]
      212 LOADK                            R9 K52 ["Number"]
      ...
      224 LOADK                            R9 K53 [0.1]
      225 SETTABLEKS                       R9 R8 K48 ["Step"]
      227 LOADN                            R9 2
      228 SETTABLEKS                       R9 R8 K49 ["Precision"]
      230 GETTABLEKS                       R11 R0 K12 ["PropertyLookup"]
      232 GETTABLEKS                       R10 R11 K11 ["Trim"]
      234 NOT                              R9 R10
      235 SETTABLEKS                       R9 R8 K54 ["IsReadOnly"]
      237 CALL                             R7 1 1
      238 SETTABLEKS                       R7 R6 K23 ["Property_TrimStart"]
      240 GETTABLEKS                       R7 R3 K27 ["nextProperty"]
      242 DUPTABLE                         R8 K55 [{"Name", "Type", "Value", "DefaultValue", "Step", "Precision", "IsReadOnly"}]
      243 LOADK                            R9 K13 ["TrimEnd"]
      244 SETTABLEKS                       R9 R8 K28 ["Name"]
      246 LOADK                            R9 K52 ["Number"]
      247 SETTABLEKS                       R9 R8 K29 ["Type"]
      249 GETTABLEKS                       R10 R0 K12 ["PropertyLookup"]
      251 GETTABLEKS                       R9 R10 K13 ["TrimEnd"]
      253 SETTABLEKS                       R9 R8 K30 ["Value"]
      255 LOADN                            R9 0
      256 SETTABLEKS                       R9 R8 K33 ["DefaultValue"]
      258 LOADK                            R9 K53 [0.1]
      259 SETTABLEKS                       R9 R8 K48 ["Step"]
      261 LOADN                            R9 2
      262 SETTABLEKS                       R9 R8 K49 ["Precision"]
      264 GETTABLEKS                       R11 R0 K12 ["PropertyLookup"]
      266 GETTABLEKS                       R10 R11 K11 ["Trim"]
      268 NOT                              R9 R10
      269 SETTABLEKS                       R9 R8 K54 ["IsReadOnly"]
      271 CALL                             R7 1 1
      272 SETTABLEKS                       R7 R6 K24 ["Property_TrimEnd"]
      274 GETUPVAL                         R9 6
      275 GETTABLEKS                       R8 R9 K56 ["PLAYING_PREVIEW_ENABLED"]
      277 JUMPIFNOT                        R8 ; [+18]
      278 GETUPVAL                         R8 0
      279 GETTABLEKS                       R7 R8 K57 ["createElement"]
      281 GETUPVAL                         R8 7
      282 DUPTABLE                         R9 K60 [{"GraphPayload", "LayoutOrder", "disabled"}]
      283 GETTABLEKS                       R10 R0 K4 ["GraphPayload"]
      285 SETTABLEKS                       R10 R9 K4 ["GraphPayload"]
      287 GETTABLEKS                       R10 R3 K61 ["nextOrder"]
      289 CALL                             R10 0 1
      290 SETTABLEKS                       R10 R9 K58 ["LayoutOrder"]
      292 SETTABLEKS                       R4 R9 K59 ["disabled"]
      294 CALL                             R7 2 1
      295 JUMP                             ; [+1]
      296 LOADNIL                          R7
      297 SETTABLEKS                       R7 R6 K25 ["PlayingPreview"]
      299 GETUPVAL                         R8 0
      300 GETTABLEKS                       R7 R8 K57 ["createElement"]
      302 GETUPVAL                         R8 8
      303 GETTABLEKS                       R9 R3 K62 ["nodeProps"]
      305 DUPTABLE                         R10 K64 [{"OutputPin"}]
      306 GETTABLEKS                       R11 R3 K65 ["outputPin"]
      308 CALL                             R11 0 1
      309 SETTABLEKS                       R11 R10 K63 ["OutputPin"]
      311 CALL                             R9 1 1
      312 MOVE                             R10 R6
      313 CALL                             R7 3 -1
      314 RETURN                           R7 -1
