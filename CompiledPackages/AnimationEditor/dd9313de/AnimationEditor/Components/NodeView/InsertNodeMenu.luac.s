PROTO_0:
       ...
       42 CALL                             R0 2 0
       43 GETUPVAL                         R1 4
       44 GETTABLEKS                       R0 R1 K14 ["createConnectedParameterAsync"]
       46 GETUPVAL                         R3 2
       47 GETTABLEKS                       R2 R3 K5 ["visibleMenuState"]
       49 GETTABLEKS                       R1 R2 K10 ["sourcePinInfo"]
       51 GETUPVAL                         R4 2
       52 GETTABLEKS                       R3 R4 K5 ["visibleMenuState"]
       54 GETTABLEKS                       R2 R3 K15 ["targetPinPosition"]
       56 CALL                             R0 2 0
       57 JUMP                             ; [+52]
       58 GETUPVAL                         R1 1
       59 FASTCALL1                        TYPE R1 ; [+2]
       60 GETIMPORT                        R0 K17 [type]
       62 CALL                             R0 1 1
       63 JUMPIFNOTEQKS                    R0 K18 ["number"] ; [+36]
       65 GETIMPORT                        R0 K21 [Enum.AnimationNodeType]
       67 GETUPVAL                         R2 1
       68 NAMECALL                         R0 R0 K22 ["FromValue"]
       70 CALL                             R0 2 1
       71 JUMPIFEQKNIL                     R0 ; [+17]
       73 GETUPVAL                         R2 4
       74 GETTABLEKS                       R1 R2 K23 ["createNodeAsync"]
       76 MOVE                             R2 R0
       77 GETUPVAL                         R5 2
       78 GETTABLEKS                       R4 R5 K5 ["visibleMenuState"]
       80 GETTABLEKS                       R3 R4 K15 ["targetPinPosition"]
       82 GETUPVAL                         R6 2
       83 GETTABLEKS                       R5 R6 K5 ["visibleMenuState"]
       85 GETTABLEKS                       R4 R5 K10 ["sourcePinInfo"]
       87 CALL                             R1 3 0
       88 JUMP                             ; [+21]
       89 GETIMPORT                        R1 K7 [warn]
       91 LOADK                            R3 K24 ["Could not convert id to Enum.AnimationNodeType: "]
       92 GETUPVAL                         R5 1
       93 FASTCALL1                        TOSTRING R5 ; [+2]
       94 GETIMPORT                        R4 K3 [tostring]
       96 CALL                             R4 1 1
       97 CONCAT                           R2 R3 R4
       98 CALL                             R1 1 0
       99 JUMP                             ; [+10]
      100 GETIMPORT                        R0 K7 [warn]
      102 LOADK                            R2 K25 ["Unexpected node id type: "]
      103 GETUPVAL                         R4 1
      104 FASTCALL1                        TYPEOF R4 ; [+2]
      105 GETIMPORT                        R3 K27 [typeof]
      107 CALL                             R3 1 1
      108 CONCAT                           R1 R2 R3
      109 CALL                             R0 1 0
      110 GETUPVAL                         R1 0
      111 GETTABLEKS                       R0 R1 K28 ["close"]
      113 CALL                             R0 0 0
      114 RETURN                           R0 0
...
PROTO_5:
       ...
       45 GETTABLEKS                       R11 R3 K9 ["createConnectedParameterAsync"]
