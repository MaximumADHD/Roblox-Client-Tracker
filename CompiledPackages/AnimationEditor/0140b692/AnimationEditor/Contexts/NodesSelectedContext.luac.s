...
PROTO_3:
       ...
       18 CALL                             R2 -1 1
       19 GETUPVAL                         R3 5
       20 GETTABLEKS                       R3 R3 K2 ["useProducer"]
       22 MOVE                             R4 R2
       23 CALL                             R3 1 0
       24 GETUPVAL                         R3 2
       25 GETTABLEKS                       R3 R3 K1 ["useMemo"]
       27 NEWCLOSURE                       R4 P1
       28 CAPTURE                          VAL R2
       29 NEWTABLE                         R5 0 1
       31 MOVE                             R6 R2
       ...
       34 CALL                             R3 2 1
       35 GETUPVAL                         R4 2
       36 GETTABLEKS                       R4 R4 K3 ["createElement"]
       38 GETUPVAL                         R5 6
       39 GETTABLEKS                       R5 R5 K4 ["Provider"]
       41 DUPTABLE                         R6 K6 [{"value"}]
       42 SETTABLEKS                       R3 R6 K5 ["value"]
       44 GETTABLEKS                       R7 R0 K7 ["children"]
       46 CALL                             R4 3 -1
       47 RETURN                           R4 -1
...
MAIN:
       ...
       50 CALL                             R6 1 1
       51 GETTABLEKS                       R7 R2 K17 ["createContext"]
       53 DUPTABLE                         R8 K20 [{["onlySelectingNodes"] = False}]
       54 CALL                             R7 1 1
       55 GETTABLEKS                       R8 R1 K21 ["createReplicatedState"]
       57 LOADK                            R9 K22 ["NodesSelectedContext_onlySelectingNodes"]
       58 CALL                             R8 1 1
       ...
       65 CAPTURE                          VAL R8
       66 CAPTURE                          VAL R7
       67 DUPCLOSURE                       R10 K24 [PROTO_5]
       68 CAPTURE                          VAL R8
       69 CAPTURE                          VAL R2
       70 CAPTURE                          VAL R7
       71 DUPTABLE                         R11 K28 [{"Context", "EditableDataModelProvider", "UIDataModelProvider"}]
       72 SETTABLEKS                       R7 R11 K25 ["Context"]
       74 SETTABLEKS                       R9 R11 K26 ["EditableDataModelProvider"]
       76 SETTABLEKS                       R10 R11 K27 ["UIDataModelProvider"]
       78 RETURN                           R11 1
