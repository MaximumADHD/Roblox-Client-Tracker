...
PROTO_5:
       ...
       20 CALL                             R7 1 2
       21 GETUPVAL                         R10 0
       22 GETTABLEKS                       R9 R10 K1 ["useCallback"]
       ...
       35 CALL                             R9 2 1
       36 GETUPVAL                         R11 0
       37 GETTABLEKS                       R10 R11 K1 ["useCallback"]
       ...
       56 CALL                             R10 2 1
       57 GETUPVAL                         R12 0
       58 GETTABLEKS                       R11 R12 K1 ["useCallback"]
       ...
       73 CALL                             R11 2 1
       74 GETUPVAL                         R13 0
       75 GETTABLEKS                       R12 R13 K1 ["useCallback"]
       ...
       86 CALL                             R12 2 1
       87 GETUPVAL                         R14 0
       88 GETTABLEKS                       R13 R14 K1 ["useCallback"]
      ...
      112 GETUPVAL                         R16 0
      113 GETTABLEKS                       R15 R16 K9 ["createElement"]
      115 GETUPVAL                         R17 2
      116 GETTABLEKS                       R16 R17 K10 ["Provider"]
...
MAIN:
       ...
       32 CALL                             R4 1 1
       33 DUPTABLE                         R5 K18 [{"selectionNodeId", "selectionInputIndices", "clearSelection", "isInputSelected", "inputDown", "inputUp", "getSelectedIndices"}]
       34 LOADNIL                          R6
       35 SETTABLEKS                       R6 R5 K11 ["selectionNodeId"]
       37 NEWTABLE                         R6 0 0
       39 SETTABLEKS                       R6 R5 K12 ["selectionInputIndices"]
       41 GETTABLEKS                       R6 R4 K19 ["createUnimplemented"]
       43 LOADK                            R7 K13 ["clearSelection"]
       44 CALL                             R6 1 1
       45 SETTABLEKS                       R6 R5 K13 ["clearSelection"]
       47 GETTABLEKS                       R6 R4 K19 ["createUnimplemented"]
       49 LOADK                            R7 K14 ["isInputSelected"]
       50 CALL                             R6 1 1
       51 SETTABLEKS                       R6 R5 K14 ["isInputSelected"]
       53 GETTABLEKS                       R6 R4 K19 ["createUnimplemented"]
       55 LOADK                            R7 K15 ["inputDown"]
       56 CALL                             R6 1 1
       57 SETTABLEKS                       R6 R5 K15 ["inputDown"]
       59 GETTABLEKS                       R6 R4 K19 ["createUnimplemented"]
       61 LOADK                            R7 K16 ["inputUp"]
       62 CALL                             R6 1 1
       63 SETTABLEKS                       R6 R5 K16 ["inputUp"]
       65 GETTABLEKS                       R6 R4 K19 ["createUnimplemented"]
       67 LOADK                            R7 K17 ["getSelectedIndices"]
       68 CALL                             R6 1 1
       69 SETTABLEKS                       R6 R5 K17 ["getSelectedIndices"]
       71 GETTABLEKS                       R6 R3 K20 ["createContext"]
       73 MOVE                             R7 R5
       74 CALL                             R6 1 1
       75 DUPCLOSURE                       R7 K21 [PROTO_5]
       76 CAPTURE                          VAL R3
       77 CAPTURE                          VAL R1
       78 CAPTURE                          VAL R6
       79 DUPTABLE                         R8 K24 [{"Context", "Provider"}]
       80 SETTABLEKS                       R6 R8 K22 ["Context"]
       82 SETTABLEKS                       R7 R8 K23 ["Provider"]
       84 RETURN                           R8 1
