PROTO_0:
        0 DUPTABLE                         R1 K2 [{"attributes", "name"}]
        1 GETUPVAL                         R2 0
        2 MOVE                             R3 R0
        3 CALL                             R2 1 1
        4 SETTABLEKS                       R2 R1 K0 ["attributes"]
        6 GETUPVAL                         R2 1
        7 MOVE                             R3 R0
        8 CALL                             R2 1 1
        9 SETTABLEKS                       R2 R1 K1 ["name"]
       11 RETURN                           R1 1

PROTO_1:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["observeAttributes"]
        3 MOVE                             R2 R0
        4 CALL                             R1 1 1
        5 GETUPVAL                         R2 1
       ...
       12 CALL                             R2 2 1
       13 GETUPVAL                         R3 2
       14 GETTABLEKS                       R3 R3 K4 ["createComputed"]
       16 NEWCLOSURE                       R4 P0
       17 CAPTURE                          VAL R1
       18 CAPTURE                          VAL R2
       19 CALL                             R3 1 -1
...
PROTO_2:
        ...
        4 MOVE                             R2 R0
        5 CALL                             R1 1 0
        6 DUPTABLE                         R1 K3 [{"id", "name", "data"}]
        7 GETUPVAL                         R2 2
        8 GETUPVAL                         R4 3
        9 NAMECALL                         R2 R2 K4 ["instanceToId"]
       11 CALL                             R2 2 1
       12 SETTABLEKS                       R2 R1 K0 ["id"]
       14 GETUPVAL                         R2 4
       15 MOVE                             R3 R0
       16 CALL                             R2 1 1
       17 SETTABLEKS                       R2 R1 K1 ["name"]
       19 GETUPVAL                         R2 5
       20 GETTABLEKS                       R2 R2 K5 ["readFromDefinition"]
       22 GETUPVAL                         R3 3
       23 CALL                             R2 1 1
       24 SETTABLEKS                       R2 R1 K2 ["data"]
       26 RETURN                           R1 1
...
PROTO_3:
        ...
        7 CALL                             R2 2 1
        8 GETUPVAL                         R3 1
        9 GETTABLEKS                       R3 R3 K3 ["observeAttributes"]
       11 MOVE                             R4 R0
       12 CALL                             R3 1 1
       13 GETUPVAL                         R4 1
       14 GETTABLEKS                       R4 R4 K4 ["forEach"]
       16 GETUPVAL                         R5 1
       17 GETTABLEKS                       R5 R5 K5 ["observeChildren"]
       19 MOVE                             R6 R0
       20 CALL                             R5 1 1
       21 DUPCLOSURE                       R6 K6 [PROTO_1]
       22 CAPTURE                          UPVAL U1
       23 CAPTURE                          UPVAL U0
       24 CAPTURE                          UPVAL U2
       25 CALL                             R4 2 1
       26 GETUPVAL                         R5 2
       27 GETTABLEKS                       R5 R5 K7 ["createComputed"]
       29 NEWCLOSURE                       R6 P1
       30 CAPTURE                          VAL R3
       31 CAPTURE                          VAL R4
       32 CAPTURE                          VAL R1
...
PROTO_16:
      ...
      109 CALL                             R9 2 1
      110 GETUPVAL                         R10 0
      111 GETTABLEKS                       R10 R10 K7 ["useCallback"]
      ...
      122 CALL                             R10 2 1
      123 GETUPVAL                         R11 0
      124 GETTABLEKS                       R11 R11 K5 ["useMemo"]
      ...
      130 CAPTURE                          VAL R10
      131 CAPTURE                          VAL R6
      132 NEWTABLE                         R13 0 5
      134 MOVE                             R14 R7
      135 MOVE                             R15 R8
      136 MOVE                             R16 R9
      137 MOVE                             R17 R10
      138 MOVE                             R18 R6
      139 SETLIST                          R13 R14 5 [1]
      141 CALL                             R11 2 1
      142 GETUPVAL                         R12 15
      143 GETTABLEKS                       R12 R12 K8 ["useReplicatedState"]
      145 LOADK                            R13 K9 ["StateMachineEditorContext_StateMachines"]
      146 MOVE                             R14 R6
      147 CALL                             R12 2 0
      148 GETUPVAL                         R12 15
      149 GETTABLEKS                       R12 R12 K10 ["useBoundAction"]
      151 LOADK                            R13 K11 ["StateMachineEditorContext_CreateAsync"]
      152 MOVE                             R14 R7
      153 CALL                             R12 2 0
      154 GETUPVAL                         R12 15
      155 GETTABLEKS                       R12 R12 K10 ["useBoundAction"]
      157 LOADK                            R13 K12 ["StateMachineEditorContext_DeleteAsync"]
      158 MOVE                             R14 R8
      159 CALL                             R12 2 0
      160 GETUPVAL                         R12 15
      161 GETTABLEKS                       R12 R12 K10 ["useBoundAction"]
      163 LOADK                            R13 K13 ["StateMachineEditorContext_RenameAsync"]
      164 MOVE                             R14 R9
      165 CALL                             R12 2 0
      166 GETUPVAL                         R12 15
      167 GETTABLEKS                       R12 R12 K10 ["useBoundAction"]
      169 LOADK                            R13 K14 ["StateMachineEditorContext_SetDataAsync"]
      170 MOVE                             R14 R10
      171 CALL                             R12 2 0
      172 GETUPVAL                         R12 0
      173 GETTABLEKS                       R12 R12 K15 ["createElement"]
      175 GETUPVAL                         R13 16
      176 GETTABLEKS                       R13 R13 K16 ["Provider"]
      178 DUPTABLE                         R14 K18 [{"value"}]
      179 SETTABLEKS                       R11 R14 K17 ["value"]
      181 GETTABLEKS                       R15 R0 K19 ["children"]
      183 CALL                             R12 3 -1
      184 RETURN                           R12 -1
...
MAIN:
      ...
      187 DUPCLOSURE                       R24 K59 [PROTO_3]
      188 CAPTURE                          VAL R16
      189 CAPTURE                          VAL R12
      190 CAPTURE                          VAL R10
      191 CAPTURE                          VAL R15
      192 DUPCLOSURE                       R25 K60 [PROTO_16]
      193 CAPTURE                          VAL R7
      194 CAPTURE                          VAL R4
      195 CAPTURE                          VAL R18
      196 CAPTURE                          VAL R9
      ...
      208 CAPTURE                          VAL R6
      209 CAPTURE                          VAL R23
      210 DUPCLOSURE                       R26 K61 [PROTO_18]
      211 CAPTURE                          VAL R6
      212 CAPTURE                          VAL R7
      213 CAPTURE                          VAL R23
      214 DUPTABLE                         R27 K65 [{"Context", "EditableDataModelProvider", "UIDataModelProvider"}]
      215 SETTABLEKS                       R23 R27 K62 ["Context"]
      217 SETTABLEKS                       R25 R27 K63 ["EditableDataModelProvider"]
      219 SETTABLEKS                       R26 R27 K64 ["UIDataModelProvider"]
      221 RETURN                           R27 1
