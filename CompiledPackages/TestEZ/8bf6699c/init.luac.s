PROTO_0:
        ...
        4 CALL                             R2 2 1
        5 GETUPVAL                         R3 1
        6 GETTABLEKS                       R3 R3 K1 ["createPlan"]
        8 MOVE                             R4 R2
        9 CALL                             R3 1 1
       10 GETUPVAL                         R4 2
       11 GETTABLEKS                       R4 R4 K2 ["runPlan"]
       13 MOVE                             R5 R3
       14 CALL                             R4 1 1
       15 MOVE                             R5 R1
       16 MOVE                             R6 R4
...
MAIN:
        ...
        5 GETTABLEKS                       R1 R1 K4 ["Expectation"]
        7 CALL                             R0 1 1
        8 GETIMPORT                        R1 K1 [require]
       10 GETIMPORT                        R2 K3 [script]
       12 GETTABLEKS                       R2 R2 K5 ["TestBootstrap"]
       14 CALL                             R1 1 1
       15 GETIMPORT                        R2 K1 [require]
       17 GETIMPORT                        R3 K3 [script]
       19 GETTABLEKS                       R3 R3 K6 ["TestEnum"]
       21 CALL                             R2 1 1
       22 GETIMPORT                        R3 K1 [require]
       24 GETIMPORT                        R4 K3 [script]
       26 GETTABLEKS                       R4 R4 K7 ["TestPlan"]
       28 CALL                             R3 1 1
       29 GETIMPORT                        R4 K1 [require]
       31 GETIMPORT                        R5 K3 [script]
       33 GETTABLEKS                       R5 R5 K8 ["TestPlanner"]
       35 CALL                             R4 1 1
       36 GETIMPORT                        R5 K1 [require]
       38 GETIMPORT                        R6 K3 [script]
       40 GETTABLEKS                       R6 R6 K9 ["TestResults"]
       42 CALL                             R5 1 1
       43 GETIMPORT                        R6 K1 [require]
       45 GETIMPORT                        R7 K3 [script]
       47 GETTABLEKS                       R7 R7 K10 ["TestRunner"]
       49 CALL                             R6 1 1
       50 GETIMPORT                        R7 K1 [require]
       52 GETIMPORT                        R8 K3 [script]
       54 GETTABLEKS                       R8 R8 K11 ["TestSession"]
       56 CALL                             R7 1 1
       57 GETIMPORT                        R8 K1 [require]
       59 GETIMPORT                        R9 K3 [script]
       61 GETTABLEKS                       R9 R9 K12 ["Reporters"]
       63 GETTABLEKS                       R9 R9 K13 ["TextReporter"]
       65 CALL                             R8 1 1
       66 GETIMPORT                        R9 K1 [require]
       68 GETIMPORT                        R10 K3 [script]
       70 GETTABLEKS                       R10 R10 K12 ["Reporters"]
       72 GETTABLEKS                       R10 R10 K14 ["TextReporterQuiet"]
       74 CALL                             R9 1 1
       75 GETIMPORT                        R10 K1 [require]
       77 GETIMPORT                        R11 K3 [script]
       79 GETTABLEKS                       R11 R11 K12 ["Reporters"]
       81 GETTABLEKS                       R11 R11 K15 ["TeamCityReporter"]
       83 CALL                             R10 1 1
