...
PROTO_1:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["NodeType"]
        3 GETTABLEKS                       R1 R1 K1 ["BeforeEach"]
        5 NEWTABLE                         R2 0 0
...
PROTO_2:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["NodeType"]
        3 GETTABLEKS                       R1 R1 K1 ["AfterEach"]
        5 NEWTABLE                         R2 0 0
        7 GETIMPORT                        R3 K3 [ipairs]
        9 GETTABLEKS                       R4 R0 K4 ["_stack"]
       11 CALL                             R3 1 3
...
PROTO_4:
       ...
       10 NEWTABLE                         R4 4 0
       12 GETUPVAL                         R5 0
       13 GETTABLEKS                       R5 R5 K3 ["NodeType"]
       15 GETTABLEKS                       R5 R5 K4 ["BeforeAll"]
       17 GETTABLEKS                       R8 R1 K5 ["children"]
       19 GETUPVAL                         R9 0
       20 GETTABLEKS                       R9 R9 K3 ["NodeType"]
       22 GETTABLEKS                       R9 R9 K4 ["BeforeAll"]
       24 NAMECALL                         R6 R0 K6 ["_getHooksOfType"]
       26 CALL                             R6 3 1
       27 SETTABLE                         R6 R4 R5
       28 GETUPVAL                         R5 0
       29 GETTABLEKS                       R5 R5 K3 ["NodeType"]
       31 GETTABLEKS                       R5 R5 K7 ["AfterAll"]
       33 GETTABLEKS                       R8 R1 K5 ["children"]
       35 GETUPVAL                         R9 0
       36 GETTABLEKS                       R9 R9 K3 ["NodeType"]
       38 GETTABLEKS                       R9 R9 K7 ["AfterAll"]
       40 NAMECALL                         R6 R0 K6 ["_getHooksOfType"]
       42 CALL                             R6 3 1
       43 SETTABLE                         R6 R4 R5
       44 GETUPVAL                         R5 0
       45 GETTABLEKS                       R5 R5 K3 ["NodeType"]
       47 GETTABLEKS                       R5 R5 K8 ["BeforeEach"]
       49 GETTABLEKS                       R8 R1 K5 ["children"]
       51 GETUPVAL                         R9 0
       52 GETTABLEKS                       R9 R9 K3 ["NodeType"]
       54 GETTABLEKS                       R9 R9 K8 ["BeforeEach"]
       56 NAMECALL                         R6 R0 K6 ["_getHooksOfType"]
       58 CALL                             R6 3 1
       59 SETTABLE                         R6 R4 R5
       60 GETUPVAL                         R5 0
       61 GETTABLEKS                       R5 R5 K3 ["NodeType"]
       63 GETTABLEKS                       R5 R5 K9 ["AfterEach"]
       65 GETTABLEKS                       R8 R1 K5 ["children"]
       67 GETUPVAL                         R9 0
       68 GETTABLEKS                       R9 R9 K3 ["NodeType"]
       70 GETTABLEKS                       R9 R9 K9 ["AfterEach"]
...
PROTO_5:
        ...
        5 GETTABLE                         R2 R3 R4
        6 GETUPVAL                         R3 0
        7 GETTABLEKS                       R3 R3 K1 ["NodeType"]
        9 GETTABLEKS                       R3 R3 K2 ["BeforeAll"]
...
PROTO_6:
        ...
        6 GETUPVAL                         R3 0
        7 GETTABLEKS                       R3 R3 K1 ["NodeType"]
        9 GETTABLEKS                       R3 R3 K2 ["AfterAll"]
       11 GETTABLE                         R1 R2 R3
       12 RETURN                           R1 1
