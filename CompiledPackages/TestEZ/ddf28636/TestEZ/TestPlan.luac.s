...
PROTO_4:
       ...
       10 GETUPVAL                         R7 2
       11 GETTABLEKS                       R6 R7 K2 ["NodeType"]
       13 GETTABLEKS                       R5 R6 K3 ["Describe"]
...
PROTO_5:
        ...
        2 MOVE                             R4 R1
        3 GETUPVAL                         R7 1
        4 GETTABLEKS                       R6 R7 K0 ["NodeType"]
        6 GETTABLEKS                       R5 R6 K1 ["Describe"]
        8 GETUPVAL                         R8 1
        9 GETTABLEKS                       R7 R8 K2 ["NodeModifier"]
       11 GETTABLEKS                       R6 R7 K3 ["Focus"]
       13 CALL                             R2 4 0
       14 RETURN                           R0 0
...
PROTO_7:
        ...
        2 MOVE                             R5 R1
        3 GETUPVAL                         R8 1
        4 GETTABLEKS                       R7 R8 K0 ["NodeType"]
        6 GETTABLEKS                       R6 R7 K1 ["Describe"]
        8 GETUPVAL                         R9 1
        9 GETTABLEKS                       R8 R9 K2 ["NodeModifier"]
       11 GETTABLEKS                       R7 R8 K3 ["None"]
       13 CALL                             R3 4 0
       14 RETURN                           R0 0
...
PROTO_12:
       ...
       10 GETUPVAL                         R4 3
       11 GETUPVAL                         R7 4
       12 GETTABLEKS                       R6 R7 K3 ["NodeModifier"]
...
PROTO_13:
        ...
        9 GETUPVAL                         R1 0
       10 GETUPVAL                         R4 1
       11 GETTABLEKS                       R3 R4 K5 ["NodeModifier"]
       13 GETTABLEKS                       R2 R3 K6 ["Skip"]
...
PROTO_14:
        0 GETUPVAL                         R0 0
        1 GETUPVAL                         R3 1
        2 GETTABLEKS                       R2 R3 K0 ["NodeModifier"]
        4 GETTABLEKS                       R1 R2 K1 ["Focus"]
...
PROTO_19:
       ...
       71 NEWTABLE                         R6 4 0
       73 GETUPVAL                         R9 0
       74 GETTABLEKS                       R8 R9 K18 ["NodeType"]
       76 GETTABLEKS                       R7 R8 K19 ["BeforeAll"]
       78 LOADK                            R8 K20 ["beforeAll"]
       79 SETTABLE                         R8 R6 R7
       80 GETUPVAL                         R9 0
       81 GETTABLEKS                       R8 R9 K18 ["NodeType"]
       83 GETTABLEKS                       R7 R8 K21 ["AfterAll"]
       85 LOADK                            R8 K22 ["afterAll"]
       86 SETTABLE                         R8 R6 R7
       87 GETUPVAL                         R9 0
       88 GETTABLEKS                       R8 R9 K18 ["NodeType"]
       90 GETTABLEKS                       R7 R8 K23 ["BeforeEach"]
       92 LOADK                            R8 K24 ["beforeEach"]
       93 SETTABLE                         R8 R6 R7
       94 GETUPVAL                         R9 0
       95 GETTABLEKS                       R8 R9 K18 ["NodeType"]
       97 GETTABLEKS                       R7 R8 K25 ["AfterEach"]
...
PROTO_20:
        ...
        1 JUMPIF                           R5 ; [+5]
        2 GETUPVAL                         R7 0
        3 GETTABLEKS                       R6 R7 K0 ["NodeModifier"]
        5 GETTABLEKS                       R5 R6 K1 ["None"]
        7 MOVE                             R3 R5
...
PROTO_21:
        ...
        1 JUMPIFEQKNIL                     R2 ; [+8]
        3 GETUPVAL                         R5 0
        4 GETTABLEKS                       R4 R5 K0 ["NodeModifier"]
        6 GETTABLEKS                       R3 R4 K1 ["None"]
       ...
       14 JUMPIFNOT                        R3 ; [+6]
       15 GETUPVAL                         R5 0
       16 GETTABLEKS                       R4 R5 K0 ["NodeModifier"]
       18 GETTABLEKS                       R3 R4 K3 ["Focus"]
       20 RETURN                           R3 1
       21 GETUPVAL                         R5 0
       22 GETTABLEKS                       R4 R5 K0 ["NodeModifier"]
       24 GETTABLEKS                       R3 R4 K4 ["Skip"]
       26 RETURN                           R3 1
       27 RETURN                           R2 1
...
PROTO_22:
       ...
       15 GETUPVAL                         R5 0
       16 GETTABLEKS                       R4 R5 K0 ["NodeModifier"]
       18 GETTABLEKS                       R3 R4 K3 ["Skip"]
       20 RETURN                           R3 1
       21 RETURN                           R2 1

PROTO_23:
        0 GETUPVAL                         R7 0
        1 GETTABLEKS                       R6 R7 K0 ["NodeType"]
        3 GETTABLEKS                       R5 R6 K1 ["It"]
       ...
       33 CONCAT                           R5 R6 R8
       34 NEWTABLE                         R6 0 0
       36 GETTABLEKS                       R8 R0 K11 ["plan"]
       38 GETTABLEKS                       R7 R8 K12 ["testNamePattern"]
       40 JUMPIFNOT                        R7 ; [+10]
       41 GETUPVAL                         R7 1
       42 MOVE                             R8 R5
       43 GETTABLEKS                       R10 R0 K11 ["plan"]
       45 GETTABLEKS                       R9 R10 K12 ["testNamePattern"]
       47 MOVE                             R10 R3
       48 CALL                             R7 3 1
       49 SETTABLEKS                       R7 R6 K13 ["nameNodeModifier"]
       51 GETTABLEKS                       R8 R0 K11 ["plan"]
       53 GETTABLEKS                       R7 R8 K14 ["testPathPattern"]
       55 JUMPIFNOT                        R7 ; [+11]
       56 JUMPIFNOT                        R4 ; [+10]
       57 GETUPVAL                         R7 1
       58 MOVE                             R8 R4
       59 GETTABLEKS                       R10 R0 K11 ["plan"]
       61 GETTABLEKS                       R9 R10 K14 ["testPathPattern"]
       63 MOVE                             R10 R3
       64 CALL                             R7 3 1
       65 SETTABLEKS                       R7 R6 K15 ["pathNodeModifier"]
       67 GETTABLEKS                       R8 R0 K11 ["plan"]
       69 GETTABLEKS                       R7 R8 K16 ["testPathIgnorePatterns"]
       71 JUMPIFNOT                        R7 ; [+11]
       72 JUMPIFNOT                        R4 ; [+10]
       73 GETUPVAL                         R7 2
       74 MOVE                             R8 R4
       75 GETTABLEKS                       R10 R0 K11 ["plan"]
       77 GETTABLEKS                       R9 R10 K16 ["testPathIgnorePatterns"]
       79 MOVE                             R10 R3
       80 CALL                             R7 3 1
       ...
       87 FORGPREP_NEXT                    R7
       88 GETUPVAL                         R14 0
       89 GETTABLEKS                       R13 R14 K18 ["NodeModifier"]
       91 GETTABLEKS                       R12 R13 K19 ["Focus"]
       93 JUMPIFEQ                         R11 R12 ; [+3]
       95 MOVE                             R3 R11
       96 JUMP                             ; [+3]
       97 MOVE                             R3 R11
       98 FORGLOOP                         R7 2 ; [-11]
      100 GETTABLEKS                       R8 R0 K11 ["plan"]
      102 GETTABLEKS                       R7 R8 K20 ["runTestsByPath"]
      104 JUMPIFNOT                        R7 ; [+23]
      105 GETTABLEKS                       R9 R0 K11 ["plan"]
      107 GETTABLEKS                       R8 R9 K20 ["runTestsByPath"]
      109 LENGTH                           R7 R8
      110 LOADN                            R8 0
      111 JUMPIFNOTLT                      R8 R7 ; [+16]
      113 JUMPIFNOT                        R4 ; [+14]
      114 GETIMPORT                        R7 K23 [table.find]
      116 GETTABLEKS                       R9 R0 K11 ["plan"]
      118 GETTABLEKS                       R8 R9 K20 ["runTestsByPath"]
      120 MOVE                             R9 R4
      121 CALL                             R7 2 1
      122 JUMPIF                           R7 ; [+5]
      123 GETUPVAL                         R8 0
      124 GETTABLEKS                       R7 R8 K18 ["NodeModifier"]
      126 GETTABLEKS                       R3 R7 K24 ["Skip"]
      128 GETUPVAL                         R8 3
      129 GETTABLEKS                       R7 R8 K25 ["new"]
...
PROTO_29:
       ...
       27 GETUPVAL                         R15 1
       28 GETTABLEKS                       R14 R15 K4 ["NodeType"]
       30 GETTABLEKS                       R13 R14 K5 ["Describe"]
       32 LOADNIL                          R14
       33 MOVE                             R15 R9
...
MAIN:
       ...
       16 GETTABLEKS                       R2 R3 K6 ["Expectation"]
       18 CALL                             R1 1 1
       19 NEWCLOSURE                       R2 P0
       20 LOADNIL                          R3
       21 NEWCLOSURE                       R4 P1
