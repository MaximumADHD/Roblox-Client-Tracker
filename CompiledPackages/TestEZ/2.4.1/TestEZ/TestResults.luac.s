PROTO_0:
        0 DUPTABLE                         R1 K7 [{[1] = 0, ["failureCount"] = 0, ["skippedCount"] = 0, ["planNode"], ["children"], ["errors"]}]
        1 SETTABLEKS                       R0 R1 K4 ["planNode"]
        3 NEWTABLE                         R2 0 0
        5 SETTABLEKS                       R2 R1 K5 ["children"]
        7 NEWTABLE                         R2 0 0
        9 SETTABLEKS                       R2 R1 K6 ["errors"]
       11 GETUPVAL                         R4 0
...
PROTO_1:
        0 DUPTABLE                         R1 K5 [{[1], ["children"], ["errors"], ["status"] = }]
...
PROTO_3:
        ...
        8 CALL                             R4 1 3
        9 FORGPREP_INEXT                   R4
       10 GETTABLEKS                       R9 R8 K4 ["planNode"]
       12 GETTABLEKS                       R9 R9 K5 ["type"]
       14 GETUPVAL                         R10 0
       15 GETTABLEKS                       R10 R10 K6 ["NodeType"]
       17 GETTABLEKS                       R10 R10 K7 ["It"]
       ...
       32 CALL                             R12 2 1
       33 MOVE                             R13 R9
       34 GETTABLEKS                       R14 R8 K4 ["planNode"]
       36 GETTABLEKS                       R14 R14 K13 ["phrase"]
       ...
       87 CALL                             R11 2 1
       88 GETTABLEKS                       R13 R8 K4 ["planNode"]
       90 GETTABLEKS                       R13 R13 K13 ["phrase"]
       92 ORK                              R12 R13 K23 [""]
...
MAIN:
        ...
        9 CALL                             R0 1 1
       10 NEWTABLE                         R1 4 0
       12 GETTABLEKS                       R2 R0 K6 ["TestStatus"]
       14 GETTABLEKS                       R2 R2 K7 ["Success"]
       16 LOADK                            R3 K8 ["+"]
       17 SETTABLE                         R3 R1 R2
       18 GETTABLEKS                       R2 R0 K6 ["TestStatus"]
       20 GETTABLEKS                       R2 R2 K9 ["Failure"]
       22 LOADK                            R3 K10 ["-"]
       23 SETTABLE                         R3 R1 R2
       24 GETTABLEKS                       R2 R0 K6 ["TestStatus"]
       26 GETTABLEKS                       R2 R2 K11 ["Skipped"]
       28 LOADK                            R3 K12 ["~"]
