...
PROTO_2:
       ...
       79 MOVE                             R10 R4
       80 CALL                             R8 2 2
       81 GETIMPORT                        R10 K20 [string.match]
       83 MOVE                             R11 R3
       84 MOVE                             R12 R5
       85 CALL                             R10 2 1
       86 GETTABLEKS                       R11 R1 K3 ["Typechecking"]
       88 JUMPIFNOT                        R11 ; [+1]
       89 JUMPIF                           R8 ; [+8]
       90 GETIMPORT                        R11 K26 [print]
       92 LOADK                            R13 K28 ["💔 Couldn't find props for "]
       93 GETTABLEKS                       R14 R2 K12 ["Name"]
       95 CONCAT                           R12 R13 R14
       96 CALL                             R11 1 0
       97 JUMP                             ; [+10]
       98 GETUPVAL                         R11 2
       99 GETTABLEKS                       R11 R11 K29 ["parseProps"]
      101 GETTABLEKS                       R12 R1 K3 ["Typechecking"]
      103 MOVE                             R13 R8
      104 MOVE                             R14 R10
      105 CALL                             R11 3 1
      106 SETTABLEKS                       R11 R1 K0 ["Props"]
      108 JUMPIFNOT                        R9 ; [+7]
      109 GETIMPORT                        R11 K31 [string.split]
      111 MOVE                             R12 R9
      112 LOADK                            R13 K32 [" & "]
      113 CALL                             R11 2 1
      114 SETTABLEKS                       R11 R1 K2 ["Inherits"]
      116 NEWTABLE                         R11 0 0
      118 GETIMPORT                        R12 K34 [string.gmatch]
      120 MOVE                             R13 R3
      121 LOADK                            R14 K35 ["R[oe]act%.createElement%(%s*([%w%.]+)%s*,"]
      122 CALL                             R12 2 3
      123 FORGPREP                         R12
      124 LOADB                            R17 1
      125 SETTABLE                         R17 R11 R15
      126 FORGLOOP                         R12 1 ; [-3]
      128 GETUPVAL                         R12 3
      129 GETTABLEKS                       R12 R12 K36 ["Dictionary"]
      131 GETTABLEKS                       R12 R12 K37 ["keys"]
      133 MOVE                             R13 R11
      134 CALL                             R12 1 1
      135 SETTABLEKS                       R12 R1 K38 ["Components"]
      137 RETURN                           R1 1
