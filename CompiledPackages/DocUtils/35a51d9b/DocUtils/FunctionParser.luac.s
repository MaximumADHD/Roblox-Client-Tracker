...
PROTO_2:
       ...
       37 LOADB                            R6 0 +1
       38 LOADB                            R6 1
       39 DUPTABLE                         R7 K15 [{["Name"], ["Type"], ["IsOptional"], ["Default"] = , ["Comment"] = }]
...
PROTO_3:
        0 DUPTABLE                         R1 K4 [{[1] = , ["Returns"] = , ["Comment"] = }]
        1 GETUPVAL                         R2 0
        2 GETTABLEKS                       R2 R2 K5 ["_extractSignature"]
        4 MOVE                             R3 R0
        5 CALL                             R2 1 3
        6 JUMPIFNOT                        R4 ; [+2]
        7 SETTABLEKS                       R4 R1 K3 ["Comment"]
        9 JUMPIF                           R2 ; [+1]
       10 RETURN                           R1 1
       11 JUMPIFNOT                        R2 ; [+35]
       12 JUMPIFEQKS                       R2 K6 [""] ; [+34]
       14 GETUPVAL                         R5 0
       15 GETTABLEKS                       R5 R5 K7 ["_splitOnComma"]
       17 MOVE                             R6 R2
       18 CALL                             R5 1 1
       19 NEWTABLE                         R6 0 0
       21 GETIMPORT                        R7 K9 [ipairs]
       23 MOVE                             R8 R5
       24 CALL                             R7 1 3
       25 FORGPREP_INEXT                   R7
       26 GETUPVAL                         R12 0
       27 GETTABLEKS                       R12 R12 K10 ["_parseParameter"]
       29 MOVE                             R13 R11
       30 CALL                             R12 1 1
       31 JUMPIFNOT                        R12 ; [+7]
       32 FASTCALL2                        TABLE_INSERT R6 R12 ; [+5]
       34 MOVE                             R14 R6
       35 MOVE                             R15 R12
       36 GETIMPORT                        R13 K13 [table.insert]
       38 CALL                             R13 2 0
       39 FORGLOOP                         R7 2 [inext] ; [-14]
       41 LENGTH                           R7 R6
       42 LOADN                            R8 0
       43 JUMPIFNOTLT                      R8 R7 ; [+3]
       45 SETTABLEKS                       R6 R1 K0 ["Parameters"]
       47 JUMPIFNOT                        R3 ; [+18]
       48 JUMPIFEQKS                       R3 K6 [""] ; [+17]
       50 LOADK                            R7 K14 ["^%s*(.-)%s*$"]
       51 NAMECALL                         R5 R3 K15 ["match"]
       53 CALL                             R5 2 1
       54 MOVE                             R3 R5
       55 GETUPVAL                         R5 0
       56 GETTABLEKS                       R5 R5 K7 ["_splitOnComma"]
       58 MOVE                             R6 R3
       59 CALL                             R5 1 1
       60 LENGTH                           R6 R5
       61 LOADN                            R7 0
       62 JUMPIFNOTLT                      R7 R6 ; [+3]
       64 SETTABLEKS                       R5 R1 K2 ["Returns"]
       66 RETURN                           R1 1
