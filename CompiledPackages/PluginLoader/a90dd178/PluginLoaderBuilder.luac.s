...
PROTO_6:
       ...
       21 JUMPIFNOT                        R0 ; [+16]
       22 GETUPVAL                         R0 1
       23 GETTABLEKS                       R0 R0 K3 ["actionTriggeredSignals"]
       25 JUMPIFNOT                        R0 ; [+12]
       26 GETIMPORT                        R0 K5 [pairs]
       28 GETUPVAL                         R1 1
       29 GETTABLEKS                       R1 R1 K3 ["actionTriggeredSignals"]
       31 CALL                             R0 1 3
       32 FORGPREP_NEXT                    R0
       ...
       40 GETUPVAL                         R1 1
       41 GETTABLEKS                       R1 R1 K6 ["signals"]
       43 CALL                             R0 1 3
       44 FORGPREP_NEXT                    R0
...
PROTO_7:
      ...
      266 CALL                             R15 2 0
      267 GETUPVAL                         R15 3
      268 JUMPIFNOT                        R15 ; [+11]
      269 GETTABLEKS                       R15 R13 K46 ["uri"]
      271 JUMPIFEQKNIL                     R15 ; [+8]
      273 GETIMPORT                        R15 K49 [task.spawn]
      275 NEWCLOSURE                       R16 P4
      276 CAPTURE                          VAL R0
      277 CAPTURE                          VAL R13
      278 CAPTURE                          REF R12
      279 CALL                             R15 1 0
      280 NEWTABLE                         R14 0 0
      282 GETTABLEKS                       R15 R0 K50 ["extraTriggers"]
      284 JUMPIFNOT                        R15 ; [+15]
      285 GETIMPORT                        R15 K52 [pairs]
      287 GETTABLEKS                       R16 R0 K50 ["extraTriggers"]
      289 CALL                             R15 1 3
      290 FORGPREP_NEXT                    R15
      291 MOVE                             R20 R19
      292 CALL                             R20 0 1
      293 MOVE                             R23 R20
      294 NAMECALL                         R21 R3 K28 ["registerSignal"]
      296 CALL                             R21 2 1
      297 SETTABLE                         R21 R14 R18
      298 FORGLOOP                         R15 2 ; [-8]
      300 DUPTABLE                         R15 K62 [{"pluginLoader", "plugin", "toolbar", "mainButton", "mainDockWidget", "mainButtonClickedSignal", "additionalButtons", "additionalButtonClickedSignals", "actionTriggeredSignals", "signals"}]
      301 SETTABLEKS                       R3 R15 K53 ["pluginLoader"]
      303 GETTABLEKS                       R16 R0 K0 ["plugin"]
      305 SETTABLEKS                       R16 R15 K0 ["plugin"]
      307 SETTABLEKS                       R6 R15 K54 ["toolbar"]
      309 SETTABLEKS                       R7 R15 K55 ["mainButton"]
      311 SETTABLEKS                       R12 R15 K56 ["mainDockWidget"]
      313 SETTABLEKS                       R8 R15 K57 ["mainButtonClickedSignal"]
      315 GETUPVAL                         R17 2
      316 JUMPIFNOT                        R17 ; [+2]
      317 MOVE                             R16 R10
      318 JUMP                             ; [+1]
      319 LOADNIL                          R16
      320 SETTABLEKS                       R16 R15 K58 ["additionalButtons"]
      322 GETUPVAL                         R17 2
      323 JUMPIFNOT                        R17 ; [+2]
      324 MOVE                             R16 R11
      325 JUMP                             ; [+1]
      326 LOADNIL                          R16
      327 SETTABLEKS                       R16 R15 K59 ["additionalButtonClickedSignals"]
      329 GETUPVAL                         R17 0
      330 JUMPIFNOT                        R17 ; [+2]
      331 MOVE                             R16 R9
      332 JUMP                             ; [+1]
      333 LOADNIL                          R16
      334 SETTABLEKS                       R16 R15 K60 ["actionTriggeredSignals"]
      336 SETTABLEKS                       R14 R15 K61 ["signals"]
      338 GETTABLEKS                       R16 R0 K0 ["plugin"]
      340 GETTABLEKS                       R16 R16 K63 ["Unloading"]
      342 NEWCLOSURE                       R18 P5
      343 CAPTURE                          REF R3
      344 CAPTURE                          VAL R15
      345 CAPTURE                          UPVAL U0
      346 NAMECALL                         R16 R16 K64 ["Connect"]
      348 CALL                             R16 2 0
      349 CLOSEUPVALS                      R3
      350 RETURN                           R15 1
...
MAIN:
       ...
       14 CALL                             R2 1 1
       15 GETTABLEKS                       R2 R2 K7 ["getFFlagRegisterActionsPluginLoader"]
       17 CALL                             R2 0 1
       18 GETIMPORT                        R3 K4 [require]
       20 GETTABLEKS                       R4 R0 K6 ["defineLuaFlags"]
       22 CALL                             R3 1 1
       23 GETTABLEKS                       R3 R3 K8 ["getFFlagPluginLoaderAddMultipleButtonInfos"]
       25 CALL                             R3 0 1
       26 GETIMPORT                        R4 K10 [game]
       28 LOADK                            R6 K11 ["PluginLoaderRegisterUri"]
       29 LOADB                            R7 0
