...
PROTO_3:
       ...
       23 GETTABLEKS                       R2 R0 K8 ["_signal"]
       25 GETTABLEKS                       R2 R2 K9 ["Event"]
       27 MOVE                             R4 R1
...
PROTO_6:
        0 DUPTABLE                         R1 K12 [{[1], ["_buttonConnections"], ["_widgetConnections"], ["_userHasInteracted"] = False, ["_destroyed"] = False, ["_userInteractionSignal"], ["_locale"] = , ["_mainTranslator"] = , ["_fallbackTranslator"] = , ["_initArgs"]}]
        1 NEWTABLE                         R2 0 0
       ...
       13 GETIMPORT                        R2 K15 [Instance.new]
       15 LOADK                            R3 K16 ["BindableEvent"]
       16 CALL                             R2 1 1
       17 SETTABLEKS                       R2 R1 K6 ["_userInteractionSignal"]
       19 SETTABLEKS                       R0 R1 K11 ["_initArgs"]
       21 GETUPVAL                         R4 0
       22 FASTCALL2                        SETMETATABLE R1 R4 ; [+4]
       24 MOVE                             R3 R1
       25 GETIMPORT                        R2 K18 [setmetatable]
       27 CALL                             R2 2 0
       28 GETTABLEKS                       R2 R1 K11 ["_initArgs"]
       30 GETTABLEKS                       R2 R2 K19 ["localizationNamespace"]
       32 JUMPIFNOTEQKNIL                  R2 ; [+6]
       34 GETTABLEKS                       R2 R1 K11 ["_initArgs"]
       36 LOADK                            R3 K20 ["Studio"]
       37 SETTABLEKS                       R3 R2 K19 ["localizationNamespace"]
       39 GETTABLEKS                       R3 R0 K21 ["overrideLocaleId"]
       41 JUMPIFEQKNIL                     R3 ; [+3]
       43 MOVE                             R2 R3
       44 JUMP                             ; [+3]
       45 GETUPVAL                         R4 1
       46 GETTABLEKS                       R2 R4 K22 ["StudioLocaleId"]
       48 SETTABLEKS                       R2 R1 K7 ["_locale"]
       50 GETTABLEKS                       R2 R0 K23 ["translationResourceTable"]
       52 GETTABLEKS                       R4 R1 K7 ["_locale"]
       54 NAMECALL                         R2 R2 K24 ["GetTranslator"]
       56 CALL                             R2 2 1
       57 SETTABLEKS                       R2 R1 K9 ["_mainTranslator"]
       59 GETTABLEKS                       R2 R0 K25 ["fallbackResourceTable"]
       61 LOADK                            R4 K26 ["en-us"]
       62 NAMECALL                         R2 R2 K24 ["GetTranslator"]
       64 CALL                             R2 2 1
       65 SETTABLEKS                       R2 R1 K10 ["_fallbackTranslator"]
       67 GETTABLEKS                       R2 R0 K27 ["shouldImmediatelyOpen"]
       69 JUMPIFNOT                        R2 ; [+7]
       70 GETTABLEKS                       R2 R0 K27 ["shouldImmediatelyOpen"]
       72 CALL                             R2 0 1
       73 JUMPIFNOT                        R2 ; [+3]
       74 NAMECALL                         R2 R1 K28 ["_onUserInteracted"]
       76 CALL                             R2 1 0
       77 RETURN                           R1 1
...
PROTO_8:
        0 GETTABLEKS                       R1 R0 K0 ["_initArgs"]
        2 GETTABLEKS                       R1 R1 K1 ["localizationNamespace"]
        4 RETURN                           R1 1

PROTO_9:
        0 GETTABLEKS                       R1 R0 K0 ["_initArgs"]
        2 GETTABLEKS                       R1 R1 K1 ["pluginName"]
        4 RETURN                           R1 1
