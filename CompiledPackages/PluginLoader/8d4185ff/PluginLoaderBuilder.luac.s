...
PROTO_7:
      ...
      235 MOVE                             R12 R18
      236 JUMP                             ; [+20]
      237 GETTABLEKS                       R15 R0 K0 ["plugin"]
      239 GETTABLEKS                       R16 R13 K35 ["id"]
      241 MOVE                             R19 R16
      242 GETTABLEKS                       R20 R13 K36 ["dockWidgetPluginGuiInfo"]
      244 NAMECALL                         R17 R15 K37 ["CreateDockWidgetPluginGui"]
      246 CALL                             R17 3 1
      247 SETTABLEKS                       R14 R17 K38 ["Title"]
      249 GETTABLEKS                       R18 R13 K40 ["zIndexBehavior"]
      251 JUMPIF                           R18 ; [+2]
      252 GETIMPORT                        R18 K44 [Enum.ZIndexBehavior.Sibling]
      254 SETTABLEKS                       R18 R17 K42 ["ZIndexBehavior"]
      256 MOVE                             R12 R17
      257 MOVE                             R17 R12
      258 NAMECALL                         R15 R3 K45 ["registerWidget"]
      260 CALL                             R15 2 0
      261 GETUPVAL                         R15 2
      262 JUMPIFNOT                        R15 ; [+11]
      263 GETTABLEKS                       R15 R13 K46 ["uri"]
      265 JUMPIFEQKNIL                     R15 ; [+8]
      267 GETIMPORT                        R15 K49 [task.spawn]
      269 NEWCLOSURE                       R16 P4
      270 CAPTURE                          VAL R0
      271 CAPTURE                          VAL R13
      272 CAPTURE                          REF R12
      273 CALL                             R15 1 0
      274 NEWTABLE                         R14 0 0
      276 GETTABLEKS                       R15 R0 K50 ["extraTriggers"]
      278 JUMPIFNOT                        R15 ; [+15]
      279 GETIMPORT                        R15 K52 [pairs]
      281 GETTABLEKS                       R16 R0 K50 ["extraTriggers"]
      283 CALL                             R15 1 3
      284 FORGPREP_NEXT                    R15
      285 MOVE                             R20 R19
      286 CALL                             R20 0 1
      287 MOVE                             R23 R20
      288 NAMECALL                         R21 R3 K28 ["registerSignal"]
      290 CALL                             R21 2 1
      291 SETTABLE                         R21 R14 R18
      292 FORGLOOP                         R15 2 ; [-8]
      294 DUPTABLE                         R15 K62 [{"pluginLoader", "plugin", "toolbar", "mainButton", "mainDockWidget", "mainButtonClickedSignal", "additionalButtons", "additionalButtonClickedSignals", "actionTriggeredSignals", "signals"}]
      295 SETTABLEKS                       R3 R15 K53 ["pluginLoader"]
      297 GETTABLEKS                       R16 R0 K0 ["plugin"]
      299 SETTABLEKS                       R16 R15 K0 ["plugin"]
      301 SETTABLEKS                       R6 R15 K54 ["toolbar"]
      303 SETTABLEKS                       R7 R15 K55 ["mainButton"]
      305 SETTABLEKS                       R12 R15 K56 ["mainDockWidget"]
      307 SETTABLEKS                       R8 R15 K57 ["mainButtonClickedSignal"]
      309 GETUPVAL                         R17 1
      310 JUMPIFNOT                        R17 ; [+2]
      311 MOVE                             R16 R10
      312 JUMP                             ; [+1]
      313 LOADNIL                          R16
      314 SETTABLEKS                       R16 R15 K58 ["additionalButtons"]
      316 GETUPVAL                         R17 1
      317 JUMPIFNOT                        R17 ; [+2]
      318 MOVE                             R16 R11
      319 JUMP                             ; [+1]
      320 LOADNIL                          R16
      321 SETTABLEKS                       R16 R15 K59 ["additionalButtonClickedSignals"]
      323 SETTABLEKS                       R9 R15 K60 ["actionTriggeredSignals"]
      325 SETTABLEKS                       R14 R15 K61 ["signals"]
      327 GETTABLEKS                       R16 R0 K0 ["plugin"]
      329 GETTABLEKS                       R16 R16 K63 ["Unloading"]
      331 NEWCLOSURE                       R18 P5
      332 CAPTURE                          REF R3
      333 CAPTURE                          VAL R15
      334 NAMECALL                         R16 R16 K64 ["Connect"]
      336 CALL                             R16 2 0
      337 CLOSEUPVALS                      R3
      338 RETURN                           R15 1
