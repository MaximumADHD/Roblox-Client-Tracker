...
PROTO_6:
        0 GETUPVAL                         R3 0
        1 GETTABLEKS                       R3 R3 K0 ["branchData"]
        3 GETTABLE                         R2 R3 R0
       ...
       22 GETUPVAL                         R4 0
       23 GETTABLEKS                       R4 R4 K0 ["branchData"]
...
PROTO_7:
       ...
       10 GETUPVAL                         R3 2
       11 GETUPVAL                         R4 3
       12 GETTABLEKS                       R4 R4 K0 ["children"]
       14 MOVE                             R5 R1
       15 CALL                             R3 2 1
       16 JUMPIFNOT                        R3 ; [+9]
       17 GETUPVAL                         R4 4
...
PROTO_11:
        ...
        2 RETURN                           R2 1
        3 GETUPVAL                         R2 0
        4 GETTABLEKS                       R2 R2 K0 ["childNodes"]
        6 GETUPVAL                         R4 0
        7 GETTABLEKS                       R4 R4 K0 ["childNodes"]
        9 GETTABLE                         R3 R4 R1
       10 JUMPIF                           R3 ; [+5]
       ...
       17 GETUPVAL                         R3 0
       18 GETTABLEKS                       R3 R3 K0 ["childNodes"]
...
PROTO_15:
       ...
       10 GETUPVAL                         R3 2
       11 MOVE                             R5 R0
       12 NAMECALL                         R3 R3 K0 ["getHostNode"]
       14 CALL                             R3 2 1
       15 GETTABLEKS                       R3 R3 K1 ["hostObject"]
       17 JUMPIFNOT                        R3 ; [+3]
...
PROTO_19:
        ...
        5 GETTABLEKS                       R2 R2 K1 ["elements"]
        7 RETURN                           R2 1

PROTO_20:
        0 GETTABLEKS                       R2 R1 K0 ["currentElement"]
        2 JUMPIFNOT                        R2 ; [+12]
        3 GETTABLEKS                       R4 R1 K0 ["currentElement"]
        5 GETTABLEKS                       R4 R4 K1 ["component"]
...
PROTO_25:
       ...
       17 CALL                             R2 2 1
       18 JUMPIFNOT                        R2 ; [+9]
       19 GETTABLEKS                       R3 R1 K5 ["currentElement"]
       21 GETTABLEKS                       R3 R3 K6 ["component"]
       ...
       31 CALL                             R2 2 1
       32 JUMPIFNOT                        R2 ; [+5]
       33 GETTABLEKS                       R2 R1 K5 ["currentElement"]
       35 GETTABLEKS                       R2 R2 K6 ["component"]
       37 RETURN                           R2 1
       38 GETTABLEKS                       R2 R1 K5 ["currentElement"]
       40 GETTABLEKS                       R2 R2 K6 ["component"]
       42 GETTABLEKS                       R2 R2 K10 ["__componentName"]
       44 RETURN                           R2 1
...
PROTO_26:
       ...
       24 CALL                             R2 2 1
       25 JUMPIFNOT                        R2 ; [+5]
       26 GETTABLEKS                       R2 R1 K7 ["hostObject"]
       28 GETTABLEKS                       R2 R2 K8 ["ClassName"]
       30 RETURN                           R2 1
       31 GETTABLEKS                       R2 R1 K9 ["currentElement"]
       33 GETTABLEKS                       R2 R2 K10 ["component"]
       35 GETTABLEKS                       R2 R2 K11 ["__componentName"]
       ...
       55 RETURN                           R3 1
       56 GETTABLEKS                       R3 R1 K9 ["currentElement"]
       58 GETTABLEKS                       R3 R3 K10 ["component"]
       60 GETTABLEKS                       R3 R3 K16 ["shouldUpdate"]
       62 JUMPIFNOT                        R3 ; [+2]
...
PROTO_28:
        0 NEWTABLE                         R2 0 0
        2 JUMPIFNOT                        R1 ; [+24]
        3 GETTABLEKS                       R3 R0 K0 ["debugInterface"]
        5 GETTABLEKS                       R3 R3 K1 ["rootInstance"]
        7 JUMPIFEQ                         R1 R3 ; [+19]
       ...
       27 GETUPVAL                         R3 1
       28 NEWTABLE                         R4 0 0
       30 GETTABLEKS                       R5 R0 K0 ["debugInterface"]
       32 GETTABLEKS                       R5 R5 K6 ["rootPath"]
       34 JUMPIF                           R5 ; [+3]
       ...
       40 CALL                             R6 1 -1
       41 CALL                             R3 -1 1
       42 GETTABLEKS                       R4 R0 K0 ["debugInterface"]
       44 GETTABLEKS                       R4 R4 K8 ["rootPrefix"]
       46 JUMPIFNOT                        R4 ; [+10]
       47 GETUPVAL                         R4 3
       48 MOVE                             R5 R3
       49 GETTABLEKS                       R8 R0 K0 ["debugInterface"]
       51 GETTABLEKS                       R8 R8 K8 ["rootPrefix"]
       53 LENGTH                           R7 R8
       54 ADDK                             R6 R7 K9 [1]
       55 CALL                             R4 2 1
       56 RETURN                           R4 1
...
MAIN:
       ...
       22 GETTABLEKS                       R4 R0 K5 ["RoactInspector"]
       24 GETTABLEKS                       R4 R4 K6 ["Utils"]
       26 GETTABLEKS                       R4 R4 K8 ["getChildAtKey"]
       28 CALL                             R3 1 1
