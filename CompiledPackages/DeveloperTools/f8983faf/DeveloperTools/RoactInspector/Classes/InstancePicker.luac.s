...
PROTO_3:
        0 DUPTABLE                         R2 K14 [{[1], ["onSelect"], ["active"] = False, ["connection"] = , ["selectedObject"] = , ["pickerArea"], ["highlightArea"], ["selectedTime"], ["nextPosition"], ["nextSize"], ["prevPosition"], ["prevSize"]}]
        1 SETTABLEKS                       R0 R2 K0 ["debugInterface"]
        3 SETTABLEKS                       R1 R2 K1 ["onSelect"]
        5 GETUPVAL                         R3 0
        6 CALL                             R3 0 1
        7 SETTABLEKS                       R3 R2 K7 ["pickerArea"]
        9 GETUPVAL                         R3 1
       10 CALL                             R3 0 1
       11 SETTABLEKS                       R3 R2 K8 ["highlightArea"]
       13 GETIMPORT                        R3 K17 [os.clock]
       15 CALL                             R3 0 1
       16 SETTABLEKS                       R3 R2 K9 ["selectedTime"]
       18 GETUPVAL                         R3 2
       19 SETTABLEKS                       R3 R2 K10 ["nextPosition"]
       21 GETUPVAL                         R3 2
       22 SETTABLEKS                       R3 R2 K11 ["nextSize"]
       24 GETUPVAL                         R3 2
       25 SETTABLEKS                       R3 R2 K12 ["prevPosition"]
       27 GETUPVAL                         R3 2
       28 SETTABLEKS                       R3 R2 K13 ["prevSize"]
       30 RETURN                           R2 1
...
PROTO_14:
        ...
        6 CAPTURE                          VAL R0
        7 CAPTURE                          VAL R2
        8 DUPTABLE                         R7 K3 [{["minArea"] = ∞}]
        9 CALL                             R4 3 1
       10 GETTABLEKS                       R5 R4 K4 ["instance"]
       12 RETURN                           R5 1
