...
PROTO_2:
  ...
  JUMPIFNOTEQKS R5 K4 ["RobloxTelemetry"] [+9]
  MOVE R11 R7
  MOVE R12 R8
  GETTABLEKS R13 R6 K5 ["standardizedFields"]
  NAMECALL R9 R0 K6 ["logRobloxTelemetryEvent"]
  CALL R9 4 0
  JUMP [+17]
...
MAIN:
  ...
  NEWTABLE R2 0 4
  LOADK R3 K5 ["addPlaceId"]
  LOADK R4 K6 ["addUniverseId"]
  LOADK R5 K7 ["addPlaceInstanceId"]
  LOADK R6 K8 ["addSessionId"]
  SETLIST R2 R3 4 [1]
  DUPCLOSURE R3 K9 [PROTO_0]
  SETTABLEKS R3 R1 K10 ["logRobloxTelemetryEvent"]
  DUPCLOSURE R3 K11 [PROTO_1]
  SETTABLEKS R3 R1 K12 ["logTelemetryCounterEvent"]
  DUPCLOSURE R3 K13 [PROTO_2]
  SETTABLEKS R3 R1 K14 ["logEvent"]
  DUPCLOSURE R3 K15 [PROTO_3]
  CAPTURE VAL R0
  CAPTURE VAL R1
  SETTABLEKS R3 R1 K16 ["new"]
  NEWTABLE R3 0 4
  LOADK R4 K5 ["addPlaceId"]
  LOADK R5 K6 ["addUniverseId"]
  LOADK R6 K7 ["addPlaceInstanceId"]
  LOADK R7 K8 ["addSessionId"]
  SETLIST R3 R4 4 [1]
  SETTABLEKS R3 R1 K17 ["StandardizedFields"]
  GETTABLEKS R3 R1 K16 ["new"]
  CALL R3 0 1
  SETTABLEKS R3 R1 K18 ["default"]
  RETURN R1 1
