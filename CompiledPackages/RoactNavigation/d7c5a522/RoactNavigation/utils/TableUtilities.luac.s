...
PROTO_5:
       ...
       52 GETUPVAL                         R10 1
       53 GETTABLEKS                       R9 R10 K6 ["DeepEqual"]
       55 MOVE                             R10 R8
       ...
       99 JUMPIF                           R9 ; [+40]
      100 GETUPVAL                         R10 1
      101 GETTABLEKS                       R9 R10 K6 ["DeepEqual"]
...
PROTO_12:
       ...
       41 LOADK                            R12 K11 [" = "]
       42 GETUPVAL                         R16 0
       43 GETTABLEKS                       R15 R16 K12 ["RecursiveToString"]
       45 MOVE                             R16 R7
       46 LOADK                            R18 K8 ["  "]
       47 MOVE                             R19 R1
       ...
       62 MOVE                             R10 R1
       63 GETUPVAL                         R14 0
       64 GETTABLEKS                       R13 R14 K12 ["RecursiveToString"]
       66 MOVE                             R14 R7
       67 LOADK                            R16 K8 ["  "]
       68 MOVE                             R17 R1
...
PROTO_13:
       ...
       68 CALL                             R10 1 1
       69 JUMPIFNOTEQKS                    R10 K16 ["table"] ; [+17]
       71 GETUPVAL                         R11 0
       ...
       76 MOVE                             R12 R9
       77 MOVE                             R13 R4
       78 LOADK                            R14 K17 ["Possible cycle"]
       79 CALL                             R10 4 0
       80 JUMP                             ; [+11]
       81 GETUPVAL                         R10 4
       82 MOVE                             R11 R9
       ...
       91 CALL                             R10 3 0
       92 FORGLOOP                         R5 2 ; [-29]
       94 GETIMPORT                        R5 K5 [print]
       96 GETIMPORT                        R6 K7 [string.format]
       98 LOADK                            R7 K18 ["%s}%s"]
       99 MOVE                             R8 R3
      100 LOADN                            R10 0
      101 JUMPIFNOTLT                      R10 R2 ; [+3]
      103 LOADK                            R9 K19 [","]
      104 JUMP                             ; [+1]
      105 LOADK                            R9 K20 [""]
      106 CALL                             R6 3 -1
