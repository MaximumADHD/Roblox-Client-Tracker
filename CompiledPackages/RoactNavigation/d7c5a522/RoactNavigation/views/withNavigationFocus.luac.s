...
PROTO_1:
        ...
        3 GETTABLEKS                       R3 R4 K3 ["navigation"]
        5 GETTABLEKS                       R2 R3 K0 ["isFocused"]
        7 CALL                             R2 0 1
...
PROTO_4:
        ...
        8 GETUPVAL                         R5 0
        9 GETTABLEKS                       R4 R5 K3 ["WillFocus"]
       11 NEWCLOSURE                       R5 P0
       12 CAPTURE                          VAL R0
       13 CALL                             R3 2 1
       14 GETTABLEKS                       R4 R1 K2 ["addListener"]
       16 GETUPVAL                         R6 0
       17 GETTABLEKS                       R5 R6 K4 ["WillBlur"]
       19 NEWCLOSURE                       R6 P1
       20 CAPTURE                          VAL R0
       21 CALL                             R4 2 -1
...
PROTO_6:
        ...
        3 GETUPVAL                         R2 1
        4 GETUPVAL                         R4 2
        5 GETTABLEKS                       R3 R4 K1 ["assign"]
        7 GETIMPORT                        R4 K4 [table.clone]
        9 GETTABLEKS                       R5 R0 K5 ["props"]
       11 CALL                             R4 1 1
       12 DUPTABLE                         R5 K7 [{"isFocused"}]
       13 GETTABLEKS                       R7 R0 K8 ["state"]
       15 GETTABLEKS                       R6 R7 K6 ["isFocused"]
...
PROTO_7:
       ...
       17 CALL                             R1 2 0
       18 GETUPVAL                         R2 0
       19 GETTABLEKS                       R1 R2 K7 ["Component"]
       ...
       41 GETUPVAL                         R2 3
       42 MOVE                             R3 R1
       43 DUPTABLE                         R4 K18 [{"forwardRef"}]
       44 LOADB                            R5 0
       45 SETTABLEKS                       R5 R4 K17 ["forwardRef"]
       47 CALL                             R2 2 -1
       48 RETURN                           R2 -1
