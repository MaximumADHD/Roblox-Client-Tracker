...
PROTO_6:
       ...
       16 GETUPVAL                         R4 0
       17 GETTABLEKS                       R3 R4 K5 ["WillFocus"]
       19 NEWCLOSURE                       R4 P1
       20 CAPTURE                          VAL R0
       21 CALL                             R2 2 1
       ...
       26 GETUPVAL                         R4 0
       27 GETTABLEKS                       R3 R4 K7 ["WillBlur"]
       29 NEWCLOSURE                       R4 P2
       30 CAPTURE                          VAL R0
       31 CALL                             R2 2 1
       ...
       36 GETUPVAL                         R4 0
       37 GETTABLEKS                       R3 R4 K9 ["DidFocus"]
       39 NEWCLOSURE                       R4 P3
       40 CAPTURE                          VAL R0
       41 CALL                             R2 2 1
       ...
       46 GETUPVAL                         R4 0
       47 GETTABLEKS                       R3 R4 K11 ["DidBlur"]
       49 NEWCLOSURE                       R4 P4
       50 CAPTURE                          VAL R0
       51 CALL                             R2 2 1
       ...
       56 GETUPVAL                         R4 0
       57 GETTABLEKS                       R3 R4 K13 ["Refocus"]
       59 NEWCLOSURE                       R4 P5
       60 CAPTURE                          VAL R0
       61 CALL                             R2 2 1
...
PROTO_7:
        ...
        2 JUMPIFNOT                        R1 ; [+5]
        3 GETTABLEKS                       R2 R0 K0 ["_actionSubscription"]
        5 GETTABLEKS                       R1 R2 K1 ["remove"]
        7 CALL                             R1 0 0
        8 GETTABLEKS                       R1 R0 K2 ["_willFocusSubscription"]
       10 JUMPIFNOT                        R1 ; [+5]
       11 GETTABLEKS                       R2 R0 K2 ["_willFocusSubscription"]
       13 GETTABLEKS                       R1 R2 K1 ["remove"]
       15 CALL                             R1 0 0
       16 GETTABLEKS                       R1 R0 K3 ["_willBlurSubscription"]
       18 JUMPIFNOT                        R1 ; [+5]
       19 GETTABLEKS                       R2 R0 K3 ["_willBlurSubscription"]
       21 GETTABLEKS                       R1 R2 K1 ["remove"]
       23 CALL                             R1 0 0
       24 GETTABLEKS                       R1 R0 K4 ["_didFocusSubscription"]
       26 JUMPIFNOT                        R1 ; [+5]
       27 GETTABLEKS                       R2 R0 K4 ["_didFocusSubscription"]
       29 GETTABLEKS                       R1 R2 K1 ["remove"]
       31 CALL                             R1 0 0
       32 GETTABLEKS                       R1 R0 K5 ["_didBlurSubscription"]
       34 JUMPIFNOT                        R1 ; [+5]
       35 GETTABLEKS                       R2 R0 K5 ["_didBlurSubscription"]
       37 GETTABLEKS                       R1 R2 K1 ["remove"]
       39 CALL                             R1 0 0
       40 GETTABLEKS                       R1 R0 K6 ["_refocusSubscription"]
       42 JUMPIFNOT                        R1 ; [+5]
       43 GETTABLEKS                       R2 R0 K6 ["_refocusSubscription"]
       45 GETTABLEKS                       R1 R2 K1 ["remove"]
       47 CALL                             R1 0 0
       48 RETURN                           R0 0
...
PROTO_8:
       ...
       10 GETTABLEKS                       R8 R0 K5 ["props"]
       12 GETTABLEKS                       R7 R8 K6 ["navigation"]
       14 GETTABLEKS                       R9 R0 K5 ["props"]
       16 GETTABLEKS                       R8 R9 K7 ["onEvent"]
      ...
      118 GETUPVAL                         R15 0
      119 GETTABLEKS                       R14 R15 K25 ["Action"]
      121 MOVE                             R15 R11
      122 CALL                             R12 3 0
      123 RETURN                           R0 0
...
PROTO_10:
        ...
        6 GETTABLEKS                       R5 R1 K3 ["type"]
        8 GETTABLEKS                       R7 R0 K4 ["props"]
       10 GETTABLEKS                       R6 R7 K5 ["navigation"]
       12 GETTABLEKS                       R9 R6 K6 ["state"]
       14 GETTABLEKS                       R8 R9 K7 ["routes"]
       16 GETTABLEKS                       R10 R6 K6 ["state"]
       18 GETTABLEKS                       R9 R10 K8 ["index"]
       ...
       26 JUMPIFNOT                        R2 ; [+9]
       27 GETUPVAL                         R10 0
       28 GETTABLEKS                       R9 R10 K9 ["findIndex"]
...
PROTO_13:
        0 GETTABLEKS                       R2 R0 K0 ["key"]
        2 GETUPVAL                         R4 0
        3 GETTABLEKS                       R3 R4 K1 ["_lastWillFocusKey"]
        5 JUMPIFEQ                         R2 R3 ; [+2]
        7 LOADB                            R1 0 +1
        8 LOADB                            R1 1
        9 RETURN                           R1 1
...
PROTO_15:
       ...
       14 JUMPIFNOT                        R7 ; [+68]
       15 GETUPVAL                         R8 0
       16 GETTABLEKS                       R7 R8 K7 ["findIndex"]
       18 GETTABLEKS                       R9 R6 K8 ["state"]
       20 GETTABLEKS                       R8 R9 K9 ["routes"]
       22 NEWCLOSURE                       R9 P0
       23 CAPTURE                          VAL R0
       24 CALL                             R7 2 1
       25 JUMPIFNOT                        R7 ; [+57]
       26 GETTABLEKS                       R10 R6 K8 ["state"]
       28 GETTABLEKS                       R9 R10 K9 ["routes"]
       ...
       36 JUMPIFNOT                        R2 ; [+9]
       37 GETUPVAL                         R11 0
       38 GETTABLEKS                       R10 R11 K7 ["findIndex"]
...
PROTO_16:
        0 GETTABLEKS                       R2 R0 K0 ["key"]
        2 GETUPVAL                         R4 0
        3 GETTABLEKS                       R3 R4 K1 ["_lastWillBlurKey"]
        5 JUMPIFEQ                         R2 R3 ; [+2]
        7 LOADB                            R1 0 +1
        8 LOADB                            R1 1
        9 RETURN                           R1 1
...
PROTO_18:
       ...
       28 GETTABLEKS                       R10 R6 K8 ["state"]
       30 GETTABLEKS                       R9 R10 K9 ["routes"]
       ...
       38 JUMPIFNOT                        R2 ; [+9]
       39 GETUPVAL                         R11 0
       40 GETTABLEKS                       R10 R11 K7 ["findIndex"]
...
PROTO_19:
        0 GETTABLEKS                       R2 R0 K0 ["props"]
        2 GETTABLEKS                       R1 R2 K1 ["onEvent"]
        4 GETTABLEKS                       R3 R0 K0 ["props"]
        6 GETTABLEKS                       R2 R3 K2 ["navigation"]
        8 GETTABLEKS                       R5 R2 K3 ["state"]
       10 GETTABLEKS                       R4 R5 K4 ["routes"]
       12 GETTABLEKS                       R6 R2 K3 ["state"]
       14 GETTABLEKS                       R5 R6 K5 ["index"]
       16 GETTABLE                         R3 R4 R5
       17 MOVE                             R4 R1
       18 GETTABLEKS                       R5 R3 K6 ["key"]
       20 GETUPVAL                         R7 0
       21 GETTABLEKS                       R6 R7 K7 ["Refocus"]
       23 CALL                             R4 2 0
       24 RETURN                           R0 0
...
PROTO_20:
       ...
       17 GETTABLEKS                       R4 R0 K3 ["props"]
       19 GETTABLEKS                       R3 R4 K4 ["navigation"]
       21 GETTABLEKS                       R5 R0 K3 ["props"]
       23 GETTABLEKS                       R4 R5 K5 ["onEvent"]
       25 MOVE                             R5 R4
       26 MOVE                             R6 R1
       27 GETUPVAL                         R8 0
       28 GETTABLEKS                       R7 R8 K6 ["WillFocus"]
       30 MOVE                             R8 R2
       31 CALL                             R5 3 0
       32 GETTABLEKS                       R7 R3 K7 ["state"]
       34 GETTABLEKS                       R6 R7 K8 ["isTransitioning"]
       36 FASTCALL1                        TYPE R6 ; [+2]
       37 GETIMPORT                        R5 K10 [type]
       39 CALL                             R5 1 1
       40 JUMPIFNOTEQKS                    R5 K11 ["boolean"] ; [+11]
       42 GETTABLEKS                       R6 R3 K7 ["state"]
       44 GETTABLEKS                       R5 R6 K8 ["isTransitioning"]
...
PROTO_21:
       ...
       26 MOVE                             R6 R1
       27 GETUPVAL                         R8 0
       28 GETTABLEKS                       R7 R8 K6 ["WillBlur"]
       30 MOVE                             R8 R2
       31 CALL                             R5 3 0
       32 GETTABLEKS                       R7 R3 K7 ["state"]
       34 GETTABLEKS                       R6 R7 K8 ["isTransitioning"]
...
PROTO_22:
       ...
       11 GETTABLEKS                       R4 R0 K2 ["props"]
       13 GETTABLEKS                       R3 R4 K3 ["onEvent"]
       15 MOVE                             R4 R3
       16 MOVE                             R5 R1
       17 GETUPVAL                         R7 0
       18 GETTABLEKS                       R6 R7 K4 ["DidFocus"]
       20 MOVE                             R7 R2
       21 CALL                             R4 3 0
       22 RETURN                           R0 0
...
PROTO_23:
       ...
       16 MOVE                             R5 R1
       17 GETUPVAL                         R7 0
       18 GETTABLEKS                       R6 R7 K4 ["DidBlur"]
       20 MOVE                             R7 R2
       21 CALL                             R4 3 0
       22 RETURN                           R0 0
