...
PROTO_3:
  ...
  LOADB R3 0 +1
  LOADB R3 1
  LOADK R5 K2 ["withNavigationFocus can only be used within the view hierarchy of a navigator. "]
  LOADK R6 K3 ["The wrapped component cannot access 'navigation' from props or context."]
  CONCAT R4 R5 R6
  CALL R2 2 0
  GETTABLEKS R2 R1 K4 ["addListener"]
  GETUPVAL R4 1
  GETTABLEKS R3 R4 K5 ["DidFocus"]
  NEWCLOSURE R4 P0
  CAPTURE VAL R0
  CALL R2 2 1
  SETTABLEKS R2 R0 K6 ["_didFocusListener"]
  GETTABLEKS R2 R1 K4 ["addListener"]
  GETUPVAL R4 1
  GETTABLEKS R3 R4 K7 ["WillBlur"]
  NEWCLOSURE R4 P1
  CAPTURE VAL R0
  CALL R2 2 1
  SETTABLEKS R2 R0 K8 ["_willBlurListener"]
  RETURN R0 0
