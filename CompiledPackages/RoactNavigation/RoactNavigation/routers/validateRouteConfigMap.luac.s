PROTO_0:
  ...
  CALL R12 0 -1
  CALL R11 -1 1
  LOADK R13 K9 ["The component for route '%s' must be a Roact Function/Stateful component or table with 'getScreen'."]
  LOADK R14 K10 ["getScreen function must return Roact Function/Stateful component."]
  CONCAT R12 R13 R14
  MOVE R13 R5
  CALL R10 3 0
  GETUPVAL R10 0
  ...
  LOADB R11 0 +1
  LOADB R11 1
  LOADK R12 K11 ["Route '%s' should provide 'screen' or 'getScreen', but not both."]
  MOVE R13 R5
  CALL R10 3 0
  LOADB R1 1
  FORGLOOP R2 2 [-60]
  GETUPVAL R2 0
  MOVE R3 R1
  LOADK R4 K12 ["Please specify at least one route when configuring a navigator."]
  CALL R2 2 0
  RETURN R0 1
