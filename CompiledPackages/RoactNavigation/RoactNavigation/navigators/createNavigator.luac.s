...
PROTO_2:
  ...
  LOADB R7 0 +1
  LOADB R7 1
  LOADK R9 K9 ["No 'routes' found in navigation state. "]
  LOADK R10 K10 ["Don't try to pass the navigation prop from a Roact component to a Navigator child."]
  CONCAT R8 R9 R10
  CALL R6 2 0
  NEWTABLE R6 0 0
  ...
  CAPTURE UPVAL U1
  CAPTURE VAL R11
  GETTABLEKS R13 R3 K14 ["getChildNavigation"]
  GETTABLEKS R14 R11 K13 ["key"]
  CALL R13 1 1
  GETUPVAL R15 1
  GETTABLEKS R14 R15 K15 ["getScreenOptions"]
  MOVE R15 R13
  MOVE R16 R4
  CALL R14 2 1
  GETTABLEKS R15 R11 K13 ["key"]
  DUPTABLE R16 K18 [{"key", "getComponent", "options", "state", "navigation"}]
  GETTABLEKS R17 R11 K13 ["key"]
  SETTABLEKS R17 R16 K13 ["key"]
  SETTABLEKS R12 R16 K16 ["getComponent"]
  SETTABLEKS R14 R16 K17 ["options"]
  SETTABLEKS R11 R16 K4 ["state"]
  SETTABLEKS R13 R16 K1 ["navigation"]
  SETTABLE R16 R6 R15
  FORGLOOP R7 2 [inext] [-54]
  DUPTABLE R7 K19 [{"descriptors", "screenProps"}]
