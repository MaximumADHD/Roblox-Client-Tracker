...
PROTO_2:
        ...
        6 JUMPIFNOT                        R2 ; [+22]
        7 GETUPVAL                         R3 0
        8 GETTABLEKS                       R4 R1 K0 ["key"]
       10 GETTABLE                         R2 R3 R4
       11 GETTABLEKS                       R2 R2 K1 ["state"]
       13 JUMPIFNOTEQ                      R1 R2 ; [+15]
       15 GETUPVAL                         R2 1
       16 GETUPVAL                         R3 2
       17 GETTABLEKS                       R3 R3 K2 ["screenProps"]
       ...
       31 CAPTURE                          VAL R1
       32 GETUPVAL                         R3 4
       33 GETTABLEKS                       R3 R3 K3 ["getChildNavigation"]
       35 GETTABLEKS                       R4 R1 K0 ["key"]
       37 CALL                             R3 1 1
       38 GETUPVAL                         R4 3
       39 GETTABLEKS                       R4 R4 K4 ["getScreenOptions"]
       41 MOVE                             R5 R3
       42 GETUPVAL                         R6 1
       43 CALL                             R4 2 1
...
PROTO_4:
       ...
       14 CALL                             R6 2 0
       15 GETTABLEKS                       R6 R4 K5 ["state"]
       17 GETTABLEKS                       R6 R6 K6 ["routes"]
       19 GETUPVAL                         R7 0
       ...
       30 CALL                             R7 2 0
       31 GETUPVAL                         R7 1
       32 GETTABLEKS                       R7 R7 K11 ["reduce"]
       34 MOVE                             R8 R6
       35 NEWCLOSURE                       R9 P0
       36 CAPTURE                          VAL R2
       37 CAPTURE                          VAL R5
       ...
       43 CALL                             R7 3 1
       44 NEWTABLE                         R8 0 0
       46 GETTABLEKS                       R9 R4 K5 ["state"]
       48 GETTABLEKS                       R9 R9 K12 ["isTransitioning"]
       50 JUMPIFNOT                        R9 ; [+18]
       51 GETUPVAL                         R9 3
       52 GETTABLEKS                       R9 R9 K13 ["assign"]
       54 NEWTABLE                         R10 0 0
       56 MOVE                             R11 R3
       57 MOVE                             R12 R2
       58 GETUPVAL                         R13 1
       59 GETTABLEKS                       R13 R13 K11 ["reduce"]
       61 MOVE                             R14 R6
...
PROTO_5:
        ...
        3 GETUPVAL                         R4 0
        4 GETTABLE                         R3 R4 R0
        5 GETTABLEKS                       R3 R3 K0 ["navigation"]
        7 GETTABLEKS                       R3 R3 K1 ["emit"]
        9 MOVE                             R4 R1
       10 MOVE                             R5 R2
       11 CALL                             R3 2 0
       12 RETURN                           R0 0
       ...
       18 GETTABLEKS                       R3 R3 K0 ["navigation"]
       20 GETTABLEKS                       R3 R3 K1 ["emit"]
       22 MOVE                             R4 R1
       23 MOVE                             R5 R2
       24 CALL                             R3 2 0
       25 RETURN                           R0 0
...
PROTO_6:
       ...
       14 GETTABLEKS                       R4 R4 K5 ["transitioningDescriptors"]
       16 GETUPVAL                         R5 0
       17 GETTABLEKS                       R5 R5 K6 ["createFragment"]
       19 DUPTABLE                         R6 K9 [{"Events", "View"}]
       20 GETUPVAL                         R7 0
       21 GETTABLEKS                       R7 R7 K10 ["createElement"]
       23 GETUPVAL                         R8 1
       ...
       38 GETUPVAL                         R8 2
       39 GETUPVAL                         R9 3
       40 GETTABLEKS                       R9 R9 K13 ["assign"]
...
MAIN:
       ...
       25 GETTABLEKS                       R7 R0 K9 ["utils"]
       27 GETTABLEKS                       R7 R7 K10 ["invariant"]
       29 CALL                             R6 1 1
       30 GETIMPORT                        R7 K4 [require]
       32 GETTABLEKS                       R8 R0 K11 ["views"]
       34 GETTABLEKS                       R8 R8 K12 ["NavigationFocusEvents"]
       36 CALL                             R7 1 1
