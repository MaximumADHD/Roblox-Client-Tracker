PROTO_0:
       ...
       17 CALL                             R4 1 1
       18 JUMPIFEQKS                       R4 K6 ["userdata"] ; [+2]
       20 LOADB                            R3 0 +1
       21 LOADB                            R3 1
       22 LOADK                            R4 K7 ["event should be RoactNavigation.Event"]
       23 CALL                             R2 2 0
       24 DUPTABLE                         R2 K10 [{"event", "pageName"}]
       25 SETTABLEKS                       R1 R2 K8 ["event"]
       27 SETTABLEKS                       R0 R2 K9 ["pageName"]
       29 GETUPVAL                         R5 1
...
PROTO_3:
        0 GETUPVAL                         R2 0
        1 GETUPVAL                         R3 1
        2 GETTABLEKS                       R3 R3 K0 ["isPageNavigationEvent"]
        4 MOVE                             R4 R1
        5 CALL                             R3 1 1
...
MAIN:
        ...
        7 GETTABLEKS                       R1 R1 K5 ["invariant"]
        9 CALL                             R0 1 1
       10 NEWTABLE                         R1 8 0
