...
PROTO_11:
       ...
       57 CALL                             R6 -1 -1
       58 CALL                             R5 -1 0
       59 GETIMPORT                        R5 K17 [pairs]
       61 MOVE                             R6 R0
       62 CALL                             R5 1 3
       63 FORGPREP_NEXT                    R5
       64 FASTCALL1                        TYPE R9 ; [+3]
       65 MOVE                             R11 R9
       66 GETIMPORT                        R10 K10 [type]
       68 CALL                             R10 1 1
       69 JUMPIFNOTEQKS                    R10 K18 ["table"] ; [+17]
       71 GETUPVAL                         R11 0
       ...
       76 MOVE                             R12 R9
       77 MOVE                             R13 R4
       78 LOADK                            R14 K19 ["Possible cycle"]
       79 CALL                             R10 4 0
       80 JUMP                             ; [+42]
       81 GETUPVAL                         R10 4
       82 MOVE                             R11 R9
       ...
       85 CALL                             R10 3 0
       86 JUMP                             ; [+36]
       87 FASTCALL1                        TYPE R8 ; [+3]
       88 MOVE                             R12 R8
       89 GETIMPORT                        R11 K10 [type]
       91 CALL                             R11 1 1
       92 JUMPIFNOTEQKS                    R11 K0 ["string"] ; [+7]
       94 GETIMPORT                        R10 K7 [string.format]
       96 LOADK                            R11 K11 ["%s"]
       97 MOVE                             R12 R8
       98 CALL                             R10 2 1
       99 JUMP                             ; [+9]
      100 GETIMPORT                        R10 K7 [string.format]
      102 LOADK                            R11 K12 ["[%s]"]
      103 FASTCALL1                        TOSTRING R8 ; [+3]
      104 MOVE                             R13 R8
      105 GETIMPORT                        R12 K14 [tostring]
      107 CALL                             R12 1 1
      108 CALL                             R10 2 1
      109 GETUPVAL                         R11 2
      110 MOVE                             R12 R9
      111 CALL                             R11 1 1
      112 GETIMPORT                        R12 K5 [print]
      114 GETIMPORT                        R13 K7 [string.format]
      116 LOADK                            R14 K20 ["%s%s = %s,%s"]
      117 MOVE                             R15 R4
      118 MOVE                             R16 R10
      119 MOVE                             R17 R11
      120 LOADK                            R18 K21 [""]
      121 CALL                             R13 5 -1
      122 CALL                             R12 -1 0
      123 FORGLOOP                         R5 2 ; [-60]
      125 GETIMPORT                        R5 K5 [print]
      127 GETIMPORT                        R6 K7 [string.format]
      129 LOADK                            R7 K22 ["%s}%s"]
      130 MOVE                             R8 R3
      131 LOADN                            R10 0
      132 JUMPIFNOTLT                      R10 R2 ; [+3]
      134 LOADK                            R9 K23 [","]
      135 JUMP                             ; [+1]
      136 LOADK                            R9 K21 [""]
      137 CALL                             R6 3 -1
