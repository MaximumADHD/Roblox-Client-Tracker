...
PROTO_8:
       ...
       11 DUPTABLE                         R4 K13 [{["initWidth"] = 0, ["initHeight"] = 0, ["isMeasured"] = False}]
       12 SETTABLEKS                       R4 R3 K4 ["layout"]
       14 GETUPVAL                         R4 0
       15 GETTABLEKS                       R4 R4 K14 ["createSingleMotor"]
       17 GETTABLEKS                       R5 R1 K15 ["index"]
       19 CALL                             R4 1 1
       20 SETTABLEKS                       R4 R3 K5 ["position"]
       22 GETUPVAL                         R4 1
       23 NEWTABLE                         R5 0 0
       25 MOVE                             R6 R1
       26 LOADNIL                          R7
       27 MOVE                             R8 R2
       28 CALL                             R4 4 1
       29 SETTABLEKS                       R4 R3 K6 ["scenes"]
       31 SETTABLEKS                       R3 R0 K2 ["state"]
       33 NEWCLOSURE                       R3 P0
       34 CAPTURE                          VAL R0
       35 SETTABLEKS                       R3 R0 K16 ["_doOnAbsoluteSizeChanged"]
       37 GETTABLEKS                       R3 R1 K15 ["index"]
       39 SETTABLEKS                       R3 R0 K17 ["_positionLastValue"]
       41 LOADNIL                          R3
       42 SETTABLEKS                       R3 R0 K18 ["_prevTransitionProps"]
       44 GETUPVAL                         R3 2
       45 GETTABLEKS                       R4 R0 K0 ["props"]
       47 GETTABLEKS                       R5 R0 K2 ["state"]
       49 CALL                             R3 2 1
       50 SETTABLEKS                       R3 R0 K19 ["_transitionProps"]
       52 LOADB                            R3 0
       53 SETTABLEKS                       R3 R0 K20 ["_isMounted"]
       55 LOADB                            R3 0
       56 SETTABLEKS                       R3 R0 K21 ["_isTransitionRunning"]
       58 NEWTABLE                         R3 0 0
       60 SETTABLEKS                       R3 R0 K22 ["_transitionQueue"]
       62 GETTABLEKS                       R3 R0 K2 ["state"]
       64 GETTABLEKS                       R3 R3 K5 ["position"]
       66 NEWCLOSURE                       R5 P1
       67 CAPTURE                          VAL R0
       68 NAMECALL                         R3 R3 K23 ["onComplete"]
       70 CALL                             R3 2 1
       71 SETTABLEKS                       R3 R0 K24 ["_completeSignalDisconnector"]
       73 GETTABLEKS                       R3 R0 K2 ["state"]
       75 GETTABLEKS                       R3 R3 K5 ["position"]
       77 NEWCLOSURE                       R5 P2
       78 CAPTURE                          VAL R0
       79 NAMECALL                         R3 R3 K25 ["onStep"]
       81 CALL                             R3 2 1
       82 SETTABLEKS                       R3 R0 K26 ["_stepSignalDisconnector"]
       84 RETURN                           R0 0
...
PROTO_13:
       ...
       34 DUPTABLE                         R6 K11 [{["initWidth"], ["initHeight"], ["isMeasured"] = True}]
       35 SETTABLEKS                       R2 R6 K5 ["initWidth"]
       37 SETTABLEKS                       R3 R6 K6 ["initHeight"]
       39 CALL                             R4 2 1
       40 GETUPVAL                         R5 0
       41 GETTABLEKS                       R5 R5 K7 ["Dictionary"]
       43 GETTABLEKS                       R5 R5 K8 ["join"]
       45 GETTABLEKS                       R6 R0 K3 ["state"]
       47 DUPTABLE                         R7 K12 [{"layout"}]
       48 SETTABLEKS                       R4 R7 K4 ["layout"]
       50 CALL                             R5 2 1
       51 GETUPVAL                         R6 1
       52 GETTABLEKS                       R7 R0 K13 ["props"]
       54 MOVE                             R8 R5
       55 CALL                             R6 2 1
       56 SETTABLEKS                       R6 R0 K14 ["_transitionProps"]
       58 DUPTABLE                         R8 K12 [{"layout"}]
       59 SETTABLEKS                       R4 R8 K4 ["layout"]
       61 NAMECALL                         R6 R0 K15 ["setState"]
       63 CALL                             R6 2 0
       64 RETURN                           R0 0
...
MAIN:
       ...
       61 CALL                             R4 1 1
       62 DUPTABLE                         R5 K13 [{["frequency"] = 4}]
       63 DUPCLOSURE                       R6 K14 [PROTO_0]
       64 CAPTURE                          VAL R4
       65 DUPCLOSURE                       R7 K15 [PROTO_2]
       66 CAPTURE                          VAL R0
       67 GETTABLEKS                       R8 R1 K16 ["Component"]
       69 LOADK                            R10 K17 ["Transitioner"]
       70 NAMECALL                         R8 R8 K18 ["extend"]
       72 CALL                             R8 2 1
       73 DUPCLOSURE                       R9 K19 [PROTO_8]
       74 CAPTURE                          VAL R2
       75 CAPTURE                          VAL R3
       76 CAPTURE                          VAL R6
       77 SETTABLEKS                       R9 R8 K20 ["init"]
       79 DUPCLOSURE                       R9 K21 [PROTO_9]
       80 SETTABLEKS                       R9 R8 K22 ["didMount"]
       82 DUPCLOSURE                       R9 K23 [PROTO_10]
       83 SETTABLEKS                       R9 R8 K24 ["willUnmount"]
       85 DUPCLOSURE                       R9 K25 [PROTO_11]
       86 SETTABLEKS                       R9 R8 K26 ["didUpdate"]
       88 DUPCLOSURE                       R9 K27 [PROTO_12]
       89 CAPTURE                          VAL R1
       90 SETTABLEKS                       R9 R8 K28 ["render"]
       92 DUPCLOSURE                       R9 K29 [PROTO_13]
       93 CAPTURE                          VAL R0
       94 CAPTURE                          VAL R6
       95 SETTABLEKS                       R9 R8 K30 ["_onAbsoluteSizeChanged"]
       97 DUPCLOSURE                       R9 K31 [PROTO_14]
       98 CAPTURE                          VAL R3
       99 CAPTURE                          VAL R0
      100 SETTABLEKS                       R9 R8 K32 ["_computeScenes"]
      102 DUPCLOSURE                       R9 K33 [PROTO_17]
      103 CAPTURE                          VAL R2
      104 CAPTURE                          VAL R0
      105 CAPTURE                          VAL R6
      106 CAPTURE                          VAL R5
      107 SETTABLEKS                       R9 R8 K34 ["_startTransition"]
      109 DUPCLOSURE                       R9 K35 [PROTO_19]
      110 CAPTURE                          VAL R0
      111 CAPTURE                          VAL R6
      112 SETTABLEKS                       R9 R8 K36 ["_onTransitionEnd"]
      114 DUPCLOSURE                       R9 K37 [PROTO_20]
      115 SETTABLEKS                       R9 R8 K38 ["_onPositionStep"]
      117 RETURN                           R8 1
