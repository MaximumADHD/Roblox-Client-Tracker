...
MAIN:
       ...
       18 GETTABLEKS                       R7 R2 K6 ["utils"]
       20 GETTABLEKS                       R6 R7 K7 ["invariant"]
       22 CALL                             R5 1 1
       23 GETTABLEKS                       R6 R4 K8 ["Component"]
       25 LOADK                            R8 K9 ["StackViewCard"]
       26 NAMECALL                         R6 R6 K10 ["extend"]
       28 CALL                             R6 2 1
       29 DUPTABLE                         R7 K13 [{"transparent", "cardColor3"}]
       30 LOADB                            R8 0
       31 SETTABLEKS                       R8 R7 K11 ["transparent"]
       33 GETIMPORT                        R8 K16 [Color3.new]
       35 LOADN                            R9 1
       36 LOADN                            R10 1
       37 LOADN                            R11 1
       38 CALL                             R8 3 1
       39 SETTABLEKS                       R8 R7 K12 ["cardColor3"]
       41 SETTABLEKS                       R7 R6 K17 ["defaultProps"]
       43 DUPCLOSURE                       R7 K18 [PROTO_1]
       44 CAPTURE                          VAL R4
       45 SETTABLEKS                       R7 R6 K19 ["init"]
       47 DUPCLOSURE                       R7 K20 [PROTO_2]
       48 CAPTURE                          VAL R5
       49 CAPTURE                          VAL R4
       50 SETTABLEKS                       R7 R6 K21 ["render"]
       52 DUPCLOSURE                       R7 K22 [PROTO_4]
       53 SETTABLEKS                       R7 R6 K23 ["didMount"]
       55 DUPCLOSURE                       R7 K24 [PROTO_5]
       56 SETTABLEKS                       R7 R6 K25 ["willUnmount"]
       58 DUPCLOSURE                       R7 K26 [PROTO_7]
       59 SETTABLEKS                       R7 R6 K27 ["didUpdate"]
       61 DUPCLOSURE                       R7 K28 [PROTO_8]
       62 SETTABLEKS                       R7 R6 K29 ["_onPositionStep"]
       64 RETURN                           R6 1
