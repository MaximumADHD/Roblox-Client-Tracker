...
PROTO_2:
        ...
        2 GETTABLEKS                       R1 R2 K1 ["navigationOptions"]
        4 GETTABLEKS                       R3 R0 K0 ["props"]
        6 GETTABLEKS                       R2 R3 K2 ["initialTransitionValue"]
        8 GETUPVAL                         R3 0
        9 LOADN                            R4 1
       ...
       13 CALL                             R3 3 1
       14 GETUPVAL                         R5 1
       15 GETTABLEKS                       R4 R5 K4 ["createElement"]
...
PROTO_4:
        ...
        2 GETTABLEKS                       R2 R3 K1 ["transitionChangedSignal"]
...
PROTO_6:
        ...
        5 GETTABLEKS                       R1 R2 K2 ["transitionChangedSignal"]
        7 NEWCLOSURE                       R2 P0
        8 CAPTURE                          VAL R0
        9 CALL                             R1 1 1
...
PROTO_7:
        ...
        8 CALL                             R1 0 0
        9 LOADNIL                          R1
       10 SETTABLEKS                       R1 R0 K1 ["_signalDisconnect"]
       12 RETURN                           R0 0
...
PROTO_8:
       ...
       12 GETTABLEKS                       R3 R4 K4 ["navigationOptions"]
       14 GETUPVAL                         R4 0
       15 LOADN                            R5 1
...
MAIN:
       ...
       13 GETTABLEKS                       R4 R2 K5 ["Roact"]
       15 CALL                             R3 1 1
       16 GETIMPORT                        R4 K4 [require]
       18 GETTABLEKS                       R6 R1 K6 ["utils"]
       20 GETTABLEKS                       R5 R6 K7 ["lerp"]
       22 CALL                             R4 1 1
       23 GETTABLEKS                       R5 R3 K8 ["Component"]
       25 LOADK                            R7 K9 ["StackViewOverlayFrame"]
       26 NAMECALL                         R5 R5 K10 ["extend"]
       28 CALL                             R5 2 1
       29 DUPCLOSURE                       R6 K11 [PROTO_1]
       30 CAPTURE                          VAL R3
       31 SETTABLEKS                       R6 R5 K12 ["init"]
       33 DUPCLOSURE                       R6 K13 [PROTO_2]
       34 CAPTURE                          VAL R4
       35 CAPTURE                          VAL R3
       36 SETTABLEKS                       R6 R5 K14 ["render"]
       38 DUPCLOSURE                       R6 K15 [PROTO_4]
       39 SETTABLEKS                       R6 R5 K16 ["didUpdate"]
       41 DUPCLOSURE                       R6 K17 [PROTO_6]
       42 SETTABLEKS                       R6 R5 K18 ["didMount"]
       44 DUPCLOSURE                       R6 K19 [PROTO_7]
       45 SETTABLEKS                       R6 R5 K20 ["willUnmount"]
       47 DUPCLOSURE                       R6 K21 [PROTO_8]
       48 CAPTURE                          VAL R4
       49 SETTABLEKS                       R6 R5 K22 ["_transitionChanged"]
       51 RETURN                           R5 1
