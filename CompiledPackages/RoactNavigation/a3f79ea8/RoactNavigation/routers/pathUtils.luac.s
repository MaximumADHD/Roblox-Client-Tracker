...
PROTO_3:
        0 GETUPVAL                         R5 0
        1 GETTABLEKS                       R4 R5 K1 ["findIndex"]
        3 MOVE                             R5 R1
...
PROTO_4:
       ...
       14 FORGPREP                         R2
       15 GETUPVAL                         R8 1
       16 GETTABLEKS                       R7 R8 K2 ["startsWith"]
       18 MOVE                             R8 R0
       19 MOVE                             R9 R6
       20 CALL                             R7 2 1
       21 JUMPIFNOT                        R7 ; [+1]
...
PROTO_7:
       ...
       42 JUMPIFNOT                        R13 ; [+15]
       43 GETUPVAL                         R21 2
       44 GETTABLEKS                       R20 R21 K9 ["findIndex"]
       46 MOVE                             R21 R12
       ...
       57 MOVE                             R16 R18
       58 GETUPVAL                         R18 3
       59 GETTABLEKS                       R17 R18 K12 ["navigate"]
       61 DUPTABLE                         R18 K16 [{"routeName", "params", "action"}]
       62 SETTABLEKS                       R7 R18 K13 ["routeName"]
       64 GETUPVAL                         R20 4
       65 GETTABLEKS                       R19 R20 K17 ["getParamsFromPath"]
       67 MOVE                             R20 R1
       68 MOVE                             R21 R14
       69 MOVE                             R22 R10
       70 CALL                             R19 3 1
      ...
      102 GETUPVAL                         R17 2
      103 GETTABLEKS                       R16 R17 K9 ["findIndex"]
      105 MOVE                             R17 R10
      ...
      120 GETUPVAL                         R16 3
      121 GETTABLEKS                       R15 R16 K12 ["navigate"]
      123 DUPTABLE                         R16 K16 [{"routeName", "params", "action"}]
      124 SETTABLEKS                       R7 R16 K13 ["routeName"]
      126 GETUPVAL                         R18 4
      127 GETTABLEKS                       R17 R18 K17 ["getParamsFromPath"]
      129 MOVE                             R18 R1
      130 MOVE                             R19 R12
      131 MOVE                             R20 R10
      132 CALL                             R17 3 1
...
PROTO_10:
       ...
       17 JUMPIFNOT                        R2 ; [+20]
       18 GETUPVAL                         R10 2
       19 GETTABLEKS                       R9 R10 K4 ["filter"]
       21 GETUPVAL                         R11 3
       22 GETTABLEKS                       R10 R11 K5 ["keys"]
       24 MOVE                             R11 R2
       25 CALL                             R10 1 1
       ...
       64 JUMPIFNOT                        R12 ; [+8]
       65 GETUPVAL                         R12 3
       66 GETTABLEKS                       R11 R12 K12 ["assign"]
       68 MOVE                             R12 R8
...
PROTO_11:
      ...
      109 GETUPVAL                         R8 4
      110 GETTABLEKS                       R7 R8 K20 ["entries"]
      112 MOVE                             R8 R5
      113 CALL                             R7 1 1
      114 MOVE                             R6 R7
...
MAIN:
       ...
       27 GETTABLEKS                       R10 R1 K10 ["utils"]
       29 GETTABLEKS                       R9 R10 K11 ["invariant"]
       31 CALL                             R8 1 1
