...
PROTO_3:
        ...
        3 CALL                             R0 -1 1
        4 GETUPVAL                         R2 1
        5 GETTABLEKS                       R1 R2 K0 ["dispatch"]
        7 MOVE                             R2 R0
        8 CALL                             R1 1 -1
        9 RETURN                           R1 -1
...
PROTO_8:
        ...
        2 CALL                             R3 1 1
        3 GETUPVAL                         R5 1
        4 GETTABLEKS                       R4 R5 K0 ["findIndex"]
        6 GETTABLEKS                       R6 R0 K1 ["state"]
        8 GETTABLEKS                       R5 R6 K2 ["routes"]
       10 NEWCLOSURE                       R6 P0
       11 CAPTURE                          VAL R1
       12 CALL                             R4 2 1
       13 LOADN                            R5 1
       ...
       16 LOADNIL                          R5
       17 RETURN                           R5 1
       18 GETTABLEKS                       R7 R0 K1 ["state"]
       20 GETTABLEKS                       R6 R7 K2 ["routes"]
       ...
       61 NEWTABLE                         R9 0 0
       63 GETUPVAL                         R11 3
       64 GETTABLEKS                       R10 R11 K11 ["assign"]
       ...
       74 JUMP                             ; [+2]
       75 NEWTABLE                         R11 0 0
       77 GETTABLEKS                       R13 R0 K3 ["router"]
       79 GETTABLEKS                       R12 R13 K9 ["getActionCreators"]
       81 MOVE                             R13 R5
       82 GETTABLEKS                       R15 R0 K1 ["state"]
       84 GETTABLEKS                       R14 R15 K10 ["key"]
       86 CALL                             R12 2 1
       87 JUMPIF                           R12 ; [+2]
       88 NEWTABLE                         R12 0 0
       90 MOVE                             R13 R9
      ...
      117 GETUPVAL                         R15 1
      118 GETTABLEKS                       R14 R15 K16 ["indexOf"]
      120 GETTABLEKS                       R16 R13 K1 ["state"]
      122 GETTABLEKS                       R15 R16 K2 ["routes"]
      124 MOVE                             R16 R5
      125 CALL                             R14 2 1
      ...
      136 GETUPVAL                         R15 3
      137 GETTABLEKS                       R14 R15 K11 ["assign"]
      ...
      162 CALL                             R14 1 1
      163 GETUPVAL                         R16 3
      164 GETTABLEKS                       R15 R16 K11 ["assign"]
...
MAIN:
       ...
       22 GETTABLEKS                       R5 R6 K8 ["getEventManager"]
       24 CALL                             R4 1 1
       25 GETIMPORT                        R5 K4 [require]
       27 GETIMPORT                        R8 K1 [script]
       29 GETTABLEKS                       R7 R8 K2 ["Parent"]
       31 GETTABLEKS                       R6 R7 K9 ["getChildRouter"]
       33 CALL                             R5 1 1
       34 GETIMPORT                        R6 K4 [require]
       36 GETIMPORT                        R10 K1 [script]
       38 GETTABLEKS                       R9 R10 K2 ["Parent"]
       40 GETTABLEKS                       R8 R9 K10 ["routers"]
       42 GETTABLEKS                       R7 R8 K11 ["getNavigationActionCreators"]
       44 CALL                             R6 1 1
       45 GETIMPORT                        R7 K4 [require]
       47 GETIMPORT                        R10 K1 [script]
       49 GETTABLEKS                       R9 R10 K2 ["Parent"]
       51 GETTABLEKS                       R8 R9 K12 ["getChildrenNavigationCache"]
       53 CALL                             R7 1 1
