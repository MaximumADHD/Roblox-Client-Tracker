...
PROTO_1:
       ...
       58 GETUPVAL                         R12 0
       59 GETTABLEKS                       R11 R12 K23 ["keys"]
       61 MOVE                             R12 R1
       62 CALL                             R11 1 1
       63 LOADK                            R12 K24 [", "]
       64 CALL                             R10 2 -1
...
PROTO_4:
       ...
       21 GETTABLEKS                       R3 R4 K5 ["loadNavigationState"]
       23 JUMPIF                           R3 ; [+9]
       24 GETUPVAL                         R5 2
       25 GETTABLEKS                       R4 R5 K6 ["router"]
       27 GETTABLEKS                       R3 R4 K7 ["getStateForAction"]
...
PROTO_5:
        0 PREPVARARGS                      0
        1 GETUPVAL                         R1 0
        2 GETTABLEKS                       R0 R1 K0 ["_isMounted"]
        4 JUMPIFNOT                        R0 ; [+6]
        5 GETUPVAL                         R0 0
        6 GETVARARGS                       R2 -1
...
PROTO_6:
       ...
       11 GETTABLEKS                       R1 R2 K2 ["externalDispatchConnector"]
...
PROTO_7:
        ...
        2 GETTABLEKS                       R1 R2 K1 ["renderLoading"]
        4 JUMPIFNOT                        R1 ; [+5]
        5 GETTABLEKS                       R2 R0 K0 ["props"]
        7 GETTABLEKS                       R1 R2 K1 ["renderLoading"]
        9 CALL                             R1 0 1
       10 RETURN                           R1 1
...
PROTO_9:
        ...
        4 GETTABLEKS                       R3 R4 K2 ["enableURLHandling"]
        6 GETTABLEKS                       R5 R0 K1 ["props"]
        8 GETTABLEKS                       R4 R5 K3 ["uriPrefix"]
       ...
       22 GETUPVAL                         R10 1
       23 GETTABLEKS                       R9 R10 K6 ["router"]
       25 GETTABLEKS                       R8 R9 K7 ["getActionForPathAndParams"]
       27 MOVE                             R9 R6
       28 MOVE                             R10 R7
       29 CALL                             R8 2 1
       30 JUMPIFNOT                        R8 ; [+4]
...
PROTO_10:
        ...
        2 GETTABLEKS                       R4 R5 K1 ["onNavigationStateChange"]
        4 JUMPIFNOTEQKNIL                  R4 ; [+38]
        6 NAMECALL                         R5 R0 K2 ["_isStateful"]
        8 CALL                             R5 1 1
        9 JUMPIFNOT                        R5 ; [+33]
       10 GETIMPORT                        R6 K4 [_G]
       12 GETTABLEKS                       R5 R6 K5 ["REACT_NAV_LOGGING"]
       14 JUMPIFNOT                        R5 ; [+28]
       15 GETUPVAL                         R6 0
       16 GETTABLEKS                       R5 R6 K6 ["group"]
       18 LOADK                            R6 K7 ["Navigation Dispatch: "]
       19 CALL                             R5 1 0
       20 GETUPVAL                         R6 0
       21 GETTABLEKS                       R5 R6 K8 ["log"]
       23 LOADK                            R6 K9 ["Action: "]
       24 MOVE                             R7 R3
       25 CALL                             R5 2 0
       26 GETUPVAL                         R6 0
       27 GETTABLEKS                       R5 R6 K8 ["log"]
       29 LOADK                            R6 K10 ["New State: "]
       30 MOVE                             R7 R2
       31 CALL                             R5 2 0
       32 GETUPVAL                         R6 0
       33 GETTABLEKS                       R5 R6 K8 ["log"]
       35 LOADK                            R6 K11 ["Last State: "]
       36 MOVE                             R7 R1
       37 CALL                             R5 2 0
       38 GETUPVAL                         R6 0
       39 GETTABLEKS                       R5 R6 K12 ["groupEnd"]
       41 CALL                             R5 0 0
       42 RETURN                           R0 0
...
PROTO_13:
        0 GETUPVAL                         R3 0
        1 GETTABLEKS                       R0 R3 K0 ["_actionEventSubscribers"]
        3 LOADNIL                          R1
        4 LOADNIL                          R2
        5 FORGPREP                         R0
        6 MOVE                             R5 R3
        ...
        8 GETUPVAL                         R8 1
        9 GETTABLEKS                       R7 R8 K6 ["Action"]
       11 SETTABLEKS                       R7 R6 K1 ["type"]
       13 GETUPVAL                         R7 2
       14 SETTABLEKS                       R7 R6 K2 ["action"]
       16 GETUPVAL                         R9 0
       17 GETTABLEKS                       R8 R9 K3 ["state"]
       19 GETTABLEKS                       R7 R8 K7 ["nav"]
...
PROTO_14:
        ...
        9 JUMPIF                           R1 ; [+1]
       10 RETURN                           R0 0
       11 GETIMPORT                        R2 K4 [_G]
       13 GETTABLEKS                       R1 R2 K5 ["__DEV__"]
       15 JUMPIFNOT                        R1 ; [+14]
       16 GETTABLEKS                       R2 R0 K6 ["props"]
       18 GETTABLEKS                       R1 R2 K7 ["detached"]
       20 JUMPIF                           R1 ; [+9]
       21 GETUPVAL                         R1 0
       22 LOADN                            R2 0
       23 JUMPIFNOTLT                      R2 R1 ; [+6]
       25 GETUPVAL                         R2 1
       26 GETTABLEKS                       R1 R2 K8 ["warn"]
       ...
       42 LOADNIL                          R1
       43 LOADNIL                          R2
       44 GETTABLEKS                       R4 R0 K6 ["props"]
       46 GETTABLEKS                       R3 R4 K12 ["enableURLHandling"]
       ...
       61 GETTABLEKS                       R4 R5 K18 ["nav"]
       63 JUMPIF                           R4 ; [+8]
       64 GETUPVAL                         R7 3
       65 GETTABLEKS                       R6 R7 K19 ["router"]
       67 GETTABLEKS                       R5 R6 K20 ["getStateForAction"]
       69 MOVE                             R6 R3
       70 CALL                             R5 1 1
       71 MOVE                             R4 R5
       72 JUMPIFNOT                        R2 ; [+1]
       ...
       79 GETUPVAL                         R9 3
       80 GETTABLEKS                       R8 R9 K19 ["router"]
       82 GETTABLEKS                       R7 R8 K23 ["getActionForPathAndParams"]
       84 MOVE                             R8 R5
       85 MOVE                             R9 R6
       86 CALL                             R7 2 1
       87 JUMPIFNOT                        R7 ; [+10]
       88 MOVE                             R3 R7
       89 GETUPVAL                         R10 3
       90 GETTABLEKS                       R9 R10 K19 ["router"]
       92 GETTABLEKS                       R8 R9 K20 ["getStateForAction"]
       94 MOVE                             R9 R7
       95 MOVE                             R10 R4
       96 CALL                             R8 2 1
       97 MOVE                             R4 R8
      ...
      101 CAPTURE                          REF R3
      102 GETTABLEKS                       R7 R0 K17 ["state"]
      104 GETTABLEKS                       R6 R7 K18 ["nav"]
...
PROTO_18:
        ...
        2 GETTABLEKS                       R2 R3 K1 ["persistNavigationState"]
        4 JUMPIFNOT                        R2 ; [+14]
...
PROTO_22:
        ...
        7 GETTABLEKS                       R3 R4 K1 ["navigation"]
        9 GETTABLEKS                       R2 R3 K2 ["dispatch"]
       11 MOVE                             R3 R1
       12 CALL                             R2 1 -1
       13 RETURN                           R2 -1
       14 GETTABLEKS                       R2 R0 K3 ["_navState"]
       16 JUMPIF                           R2 ; [+4]
       17 GETTABLEKS                       R3 R0 K4 ["state"]
       19 GETTABLEKS                       R2 R3 K5 ["nav"]
       ...
       33 CALL                             R3 2 0
       34 GETUPVAL                         R5 1
       35 GETTABLEKS                       R4 R5 K7 ["router"]
       37 GETTABLEKS                       R3 R4 K8 ["getStateForAction"]
       39 MOVE                             R4 R1
       40 MOVE                             R5 R2
       41 CALL                             R3 2 1
       42 MOVE                             R4 R3
...
PROTO_23:
        ...
        4 GETTABLEKS                       R3 R4 K1 ["screenProps"]
        6 RETURN                           R3 1
        7 GETTABLEKS                       R4 R0 K0 ["props"]
        9 GETTABLEKS                       R3 R4 K1 ["screenProps"]
...
PROTO_26:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R0 R1 K0 ["_navigation"]
        3 RETURN                           R0 1
...
PROTO_27:
       ...
       19 JUMPIFNOT                        R3 ; [+6]
       20 GETTABLEKS                       R4 R0 K6 ["_navigation"]
       22 GETTABLEKS                       R3 R4 K3 ["state"]
       24 JUMPIFEQ                         R3 R2 ; [+17]
       26 GETUPVAL                         R3 0
       27 GETUPVAL                         R5 1
       28 GETTABLEKS                       R4 R5 K7 ["router"]
       30 MOVE                             R5 R2
       31 NEWCLOSURE                       R6 P0
       32 CAPTURE                          VAL R0
       ...
       52 CALL                             R2 2 0
       53 GETUPVAL                         R3 3
       54 GETTABLEKS                       R2 R3 K10 ["createElement"]
       56 GETUPVAL                         R4 4
       57 GETTABLEKS                       R3 R4 K11 ["Provider"]
       59 DUPTABLE                         R4 K13 [{"value"}]
       60 SETTABLEKS                       R1 R4 K12 ["value"]
       62 DUPTABLE                         R5 K15 [{"AppComponent"}]
       63 GETUPVAL                         R7 3
       64 GETTABLEKS                       R6 R7 K10 ["createElement"]
       66 GETUPVAL                         R7 1
       67 GETUPVAL                         R9 5
       68 GETTABLEKS                       R8 R9 K16 ["assign"]
...
PROTO_28:
       ...
       27 CALL                             R2 2 1
       28 GETUPVAL                         R4 1
       29 GETTABLEKS                       R3 R4 K11 ["Component"]
       31 MOVE                             R5 R2
...
MAIN:
       ...
       33 GETTABLEKS                       R10 R0 K11 ["views"]
       35 GETTABLEKS                       R9 R10 K12 ["NavigationContext"]
       37 CALL                             R8 1 1
       ...
       47 GETTABLEKS                       R13 R0 K16 ["routers"]
       49 GETTABLEKS                       R12 R13 K17 ["pathUtils"]
       51 CALL                             R11 1 1
