...
MAIN:
  ...
  NEWTABLE R1 2 0
  NEWTABLE R2 8 0
  DUPTABLE R3 K10 [{"print", "warn", "math"}]
  GETIMPORT R4 K11 [print]
  SETTABLEKS R4 R3 K7 ["print"]
  GETIMPORT R4 K12 [warn]
  SETTABLEKS R4 R3 K8 ["warn"]
  DUPTABLE R4 K14 [{"random"}]
  GETIMPORT R5 K15 [math.random]
  SETTABLEKS R5 R4 K13 ["random"]
  SETTABLEKS R4 R3 K9 ["math"]
  SETTABLEKS R2 R2 K16 ["__index"]
  DUPCLOSURE R4 K17 [PROTO_0]
  CAPTURE VAL R2
  SETTABLEKS R4 R2 K18 ["new"]
  DUPCLOSURE R4 K19 [PROTO_1]
  SETTABLEKS R4 R2 K20 ["isMockGlobalLibrary"]
  DUPCLOSURE R4 K21 [PROTO_3]
  CAPTURE VAL R3
  SETTABLEKS R4 R2 K22 ["_createGlobalAutomocks"]
  DUPCLOSURE R4 K23 [PROTO_6]
  SETTABLEKS R4 R2 K24 ["_createGlobalEnv"]
  SETTABLEKS R2 R1 K25 ["GlobalMocker"]
  SETTABLEKS R3 R1 K26 ["MOCKABLE_GLOBALS"]
  RETURN R1 1
