...
PROTO_3:
        ...
        7 MOVE                             R2 R0
        8 CALL                             R1 1 1
        9 JUMPIFNOTEQKNIL                  R1 ; [+55]
       11 JUMPIFEQKNIL                     R0 ; [+52]
       13 GETTABLEKS                       R3 R0 K0 ["render"]
       15 FASTCALL1                        TYPEOF R3 ; [+2]
       16 GETIMPORT                        R2 K2 [typeof]
       18 CALL                             R2 1 1
       19 JUMPIFNOTEQKS                    R2 K3 ["function"] ; [+44]
       ...
       39 JUMP                             ; [+1]
       40 MOVE                             R2 R3
       41 GETTABLEKS                       R3 R0 K0 ["render"]
       43 JUMPIFEQ                         R3 R2 ; [+20]
       45 NEWTABLE                         R3 4 0
       47 GETUPVAL                         R4 2
       48 SETTABLEKS                       R4 R3 K5 ["$$typeof"]
       50 SETTABLEKS                       R2 R3 K0 ["render"]
       52 LOADNIL                          R4
       53 SETTABLEKS                       R4 R3 K6 ["displayName"]
       55 GETTABLEKS                       R4 R0 K6 ["displayName"]
       57 JUMPIFEQKNIL                     R4 ; [+5]
       59 GETTABLEKS                       R4 R0 K6 ["displayName"]
       61 SETTABLEKS                       R4 R3 K6 ["displayName"]
       63 RETURN                           R3 1
       64 RETURN                           R0 1
       65 GETTABLEKS                       R2 R1 K4 ["current"]
       67 RETURN                           R2 1
       68 RETURN                           R0 1
...
PROTO_7:
       ...
       12 GETIMPORT                        R6 K6 [script]
       14 GETTABLEKS                       R6 R6 K7 ["Parent"]
...
PROTO_8:
        ...
        6 GETTABLEKS                       R1 R2 K2 ["ReactFiberReconciler.new"]
        8 CALL                             R0 1 1
        9 GETTABLEKS                       R0 R0 K6 ["updateContainer"]
       11 MOVE                             R1 R0
       12 GETUPVAL                         R2 0
       13 GETUPVAL                         R3 1
       14 LOADNIL                          R4
...
PROTO_9:
        ...
        8 GETTABLEKS                       R3 R4 K2 ["ReactFiberContext.new"]
       10 CALL                             R2 1 1
       11 GETTABLEKS                       R2 R2 K6 ["emptyContextObject"]
       13 GETTABLEKS                       R3 R0 K7 ["context"]
       15 JUMPIFEQ                         R3 R2 ; [+2]
       17 RETURN                           R0 0
       18 GETIMPORT                        R3 K1 [require]
       20 GETIMPORT                        R5 K4 [script]
       22 GETTABLEKS                       R5 R5 K5 ["Parent"]
...
PROTO_10:
       ...
       93 GETIMPORT                        R13 K16 [script]
       95 GETTABLEKS                       R13 R13 K17 ["Parent"]
...
PROTO_14:
       ...
       23 GETTABLEKS                       R7 R3 K1 ["stateNode"]
       25 GETTABLEKS                       R7 R7 K3 ["containerInfo"]
       27 NAMECALL                         R5 R1 K2 ["add"]
       29 CALL                             R5 2 0
       30 RETURN                           R0 0
       31 GETUPVAL                         R5 4
       32 JUMPIFNOTEQ                      R4 R5 ; [+9]
       34 GETTABLEKS                       R7 R3 K1 ["stateNode"]
       36 GETTABLEKS                       R7 R7 K3 ["containerInfo"]
...
MAIN:
       ...
       63 GETTABLEKS                       R13 R13 K2 ["Parent"]
       65 GETTABLEKS                       R13 R13 K16 ["ReactWorkTags"]
       67 CALL                             R12 1 1
       ...
       84 GETIMPORT                        R21 K4 [require]
       86 GETTABLEKS                       R22 R0 K10 ["Shared"]
       88 CALL                             R21 1 1
       89 GETTABLEKS                       R21 R21 K25 ["ReactSymbols"]
