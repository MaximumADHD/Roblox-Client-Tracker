...
PROTO_8:
  ...
  LOADK R9 K8 ["Using UNSAFE_componentWillMount in strict mode is not recommended and may indicate bugs in your code. "]
  LOADK R10 K9 ["See https://reactjs.org/link/unsafe-component-lifecycles for details.

"]
  LOADK R11 K10 ["* Move code with side effects to componentDidMount, and set initial state in the constructor.
"]
  LOADK R12 K11 ["
Please update the following components: %s"]
  ...
  GETUPVAL R8 9
  GETTABLEKS R7 R8 K7 ["error"]
  LOADK R9 K12 ["Using UNSAFE_componentWillReceiveProps in strict mode is not recommended "]
  LOADK R10 K13 ["and may indicate bugs in your code. "]
  LOADK R11 K9 ["See https://reactjs.org/link/unsafe-component-lifecycles for details.

"]
  LOADK R12 K14 ["* Move data fetching code or side effects to componentDidUpdate.
"]
  LOADK R13 K15 ["* If you're updating state whenever props change, "]
  LOADK R14 K16 ["refactor your code to use memoization techniques or move it to "]
  LOADK R15 K17 ["static getDerivedStateFromProps. Learn more at: https://reactjs.org/link/derived-state
"]
  LOADK R16 K11 ["
Please update the following components: %s"]
  CONCAT R8 R9 R16
  ...
  GETUPVAL R8 9
  GETTABLEKS R7 R8 K7 ["error"]
  LOADK R9 K18 ["Using UNSAFE_componentWillUpdate in strict mode is not recommended "]
  LOADK R10 K13 ["and may indicate bugs in your code. "]
  LOADK R11 K9 ["See https://reactjs.org/link/unsafe-component-lifecycles for details.
...
Please update the following components: %s"]
  ...
  CALL R6 1 1
  GETUPVAL R8 9
  GETTABLEKS R7 R8 K19 ["warn"]
  LOADK R9 K20 ["componentWillMount has been renamed, and is not recommended for use. "]
  LOADK R10 K9 ["See https://reactjs.org/link/unsafe-component-lifecycles for details.

"]
  LOADK R11 K10 ["* Move code with side effects to componentDidMount, and set initial state in the constructor.
"]
  LOADK R12 K21 ["* Rename componentWillMount to UNSAFE_componentWillMount to suppress "]
  LOADK R13 K22 ["this warning in non-strict mode. In React 18.x, only the UNSAFE_ name will work.
"]
  LOADK R14 K11 ["
Please update the following components: %s"]
  CONCAT R8 R9 R14
  ...
  GETUPVAL R8 9
  GETTABLEKS R7 R8 K19 ["warn"]
  LOADK R9 K23 ["componentWillReceiveProps has been renamed, and is not recommended for use. "]
  LOADK R10 K9 ["See https://reactjs.org/link/unsafe-component-lifecycles for details.

"]
  LOADK R11 K14 ["* Move data fetching code or side effects to componentDidUpdate.
"]
  LOADK R12 K24 ["* If you're updating state whenever props change, refactor your "]
  LOADK R13 K25 ["code to use memoization techniques or move it to "]
  LOADK R14 K17 ["static getDerivedStateFromProps. Learn more at: https://reactjs.org/link/derived-state
"]
  LOADK R15 K26 ["* Rename componentWillReceiveProps to UNSAFE_componentWillReceiveProps to suppress "]
  LOADK R16 K22 ["this warning in non-strict mode. In React 18.x, only the UNSAFE_ name will work.
"]
  LOADK R17 K11 ["
Please update the following components: %s"]
  CONCAT R8 R9 R17
  ...
  GETUPVAL R8 9
  GETTABLEKS R7 R8 K19 ["warn"]
  LOADK R9 K27 ["componentWillUpdate has been renamed, and is not recommended for use. "]
  LOADK R10 K9 ["See https://reactjs.org/link/unsafe-component-lifecycles for details.

"]
  LOADK R11 K14 ["* Move data fetching code or side effects to componentDidUpdate.
"]
  LOADK R12 K28 ["* Rename componentWillUpdate to UNSAFE_componentWillUpdate to suppress "]
  LOADK R13 K22 ["this warning in non-strict mode. In React 18.x, only the UNSAFE_ name will work.
"]
  LOADK R14 K11 ["
Please update the following components: %s"]
