...
PROTO_8:
  ...
  GETUPVAL R3 1
  LOADB R4 0
  LOADK R6 K0 ["Expected prepareToHydrateHostInstance() to never be called. "]
  LOADK R7 K1 ["This error is likely caused by a bug in React. Please file an issue."]
  CONCAT R5 R6 R7
  CALL R3 2 0
  GETTABLEKS R3 R0 K2 ["stateNode"]
  GETUPVAL R4 2
  MOVE R5 R3
  GETTABLEKS R6 R0 K3 ["type"]
  GETTABLEKS R7 R0 K4 ["memoizedProps"]
  MOVE R8 R1
  MOVE R9 R2
  MOVE R10 R0
  CALL R4 6 1
  SETTABLEKS R4 R0 K5 ["updateQueue"]
  JUMPIFEQKNIL R4 [+3]
  LOADB R5 1
  RETURN R5 1
  LOADB R5 0
...
PROTO_9:
  ...
  GETUPVAL R1 1
  LOADB R2 0
  LOADK R4 K0 ["Expected prepareToHydrateHostTextInstance() to never be called. "]
  LOADK R5 K1 ["This error is likely caused by a bug in React. Please file an issue."]
  CONCAT R3 R4 R5
  CALL R1 2 0
  GETTABLEKS R1 R0 K2 ["stateNode"]
  GETTABLEKS R2 R0 K3 ["memoizedProps"]
  GETUPVAL R3 2
  MOVE R4 R1
  MOVE R5 R2
  MOVE R6 R0
...
PROTO_10:
  ...
  GETUPVAL R1 1
  LOADB R2 0
  LOADK R4 K0 ["Expected prepareToHydrateHostSuspenseInstance() to never be called. "]
  LOADK R5 K1 ["This error is likely caused by a bug in React. Please file an issue."]
  CONCAT R3 R4 R5
  CALL R1 2 0
  ...
  GETUPVAL R3 1
  MOVE R4 R2
  LOADK R6 K4 ["Expected to have a hydrated suspense instance. "]
  LOADK R7 K1 ["This error is likely caused by a bug in React. Please file an issue."]
  CONCAT R5 R6 R7
  CALL R3 2 0
  GETUPVAL R3 2
...
PROTO_11:
  ...
  GETUPVAL R1 1
  LOADB R2 0
  LOADK R4 K0 ["Expected skipPastDehydratedSuspenseInstance() to never be called. "]
  LOADK R5 K1 ["This error is likely caused by a bug in React. Please file an issue."]
  CONCAT R3 R4 R5
  CALL R1 2 0
  GETTABLEKS R1 R0 K2 ["memoizedState"]
