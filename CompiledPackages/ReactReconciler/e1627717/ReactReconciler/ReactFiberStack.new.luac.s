...
PROTO_2:
        ...
        6 GETTABLEKS                       R2 R2 K2 ["__DEV__"]
        8 JUMPIFNOT                        R2 ; [+5]
        9 GETUPVAL                         R2 1
       10 GETTABLEKS                       R2 R2 K3 ["error"]
       12 LOADK                            R3 K4 ["Unexpected pop."]
       13 CALL                             R2 1 0
       14 RETURN                           R0 0
       15 GETIMPORT                        R2 K1 [_G]
       17 GETTABLEKS                       R2 R2 K2 ["__DEV__"]
       19 JUMPIFNOT                        R2 ; [+10]
       20 GETUPVAL                         R3 2
       21 GETUPVAL                         R4 0
       ...
       46 GETIMPORT                        R3 K1 [_G]
       48 GETTABLEKS                       R3 R3 K2 ["__DEV__"]
       50 JUMPIFNOT                        R3 ; [+4]
       51 GETUPVAL                         R3 2
       52 GETUPVAL                         R4 0
       53 LOADNIL                          R5
...
PROTO_3:
       ...
       15 GETIMPORT                        R4 K3 [_G]
       17 GETTABLEKS                       R4 R4 K4 ["__DEV__"]
       19 JUMPIFNOT                        R4 ; [+3]
       20 GETUPVAL                         R4 3
       21 GETUPVAL                         R5 0
...
MAIN:
       ...
       25 NEWTABLE                         R4 0 0
       27 LOADNIL                          R5
       28 GETIMPORT                        R6 K9 [_G]
       30 GETTABLEKS                       R6 R6 K10 ["__DEV__"]
       32 JUMPIFNOT                        R6 ; [+2]
       33 NEWTABLE                         R5 0 0
       35 LOADN                            R6 0
