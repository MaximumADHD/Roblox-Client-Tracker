...
PROTO_1:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R1 R2 K0 ["__REACT_DEVTOOLS_GLOBAL_HOOK__"]
...
PROTO_3:
        ...
        6 RETURN                           R1 1
        7 GETUPVAL                         R2 0
        8 GETTABLEKS                       R1 R2 K0 ["__REACT_DEVTOOLS_GLOBAL_HOOK__"]
       ...
       17 JUMPIF                           R2 ; [+11]
       18 GETUPVAL                         R3 0
       19 GETTABLEKS                       R2 R3 K3 ["__DEV__"]
       21 JUMPIFNOT                        R2 ; [+5]
       22 GETUPVAL                         R3 1
       ...
       37 JUMPIF                           R2 ; [+10]
       38 GETUPVAL                         R5 0
       39 GETTABLEKS                       R4 R5 K3 ["__DEV__"]
       41 JUMPIFNOT                        R4 ; [+6]
       42 GETUPVAL                         R5 1
       43 GETTABLEKS                       R4 R5 K4 ["error"]
...
PROTO_4:
        ...
        5 JUMPIFNOT                        R2 ; [+66]
        6 GETUPVAL                         R4 1
        7 GETTABLEKS                       R3 R4 K1 ["onScheduleFiberRoot"]
       ...
       50 GETUPVAL                         R4 1
       51 GETTABLEKS                       R3 R4 K1 ["onScheduleFiberRoot"]
       53 GETUPVAL                         R4 2
       54 MOVE                             R5 R0
       55 MOVE                             R6 R1
       56 CALL                             R2 4 2
       57 JUMPIF                           R2 ; [+14]
       58 GETUPVAL                         R5 0
       59 GETTABLEKS                       R4 R5 K0 ["__DEV__"]
       61 JUMPIFNOT                        R4 ; [+10]
       62 GETUPVAL                         R4 3
       63 JUMPIF                           R4 ; [+8]
       64 LOADB                            R4 1
...
PROTO_6:
       ...
       54 JUMPIF                           R2 ; [+14]
       55 GETUPVAL                         R5 4
       56 GETTABLEKS                       R4 R5 K13 ["__DEV__"]
       58 JUMPIFNOT                        R4 ; [+10]
       59 GETUPVAL                         R4 5
       60 JUMPIF                           R4 ; [+8]
       61 LOADB                            R4 1
...
PROTO_7:
       ...
       52 JUMPIF                           R1 ; [+14]
       53 GETUPVAL                         R4 2
       54 GETTABLEKS                       R3 R4 K13 ["__DEV__"]
       56 JUMPIFNOT                        R3 ; [+10]
       57 GETUPVAL                         R3 3
       58 JUMPIF                           R3 ; [+8]
       59 LOADB                            R3 1
...
MAIN:
       ...
       29 GETTABLEKS                       R9 R0 K6 ["Shared"]
       31 CALL                             R8 1 1
       32 GETTABLEKS                       R7 R8 K10 ["ReactFeatureFlags"]
       34 GETTABLEKS                       R6 R7 K11 ["enableProfilerTimer"]
       36 GETIMPORT                        R7 K4 [require]
       38 GETIMPORT                        R10 K1 [script]
       40 GETTABLEKS                       R9 R10 K2 ["Parent"]
       42 GETTABLEKS                       R8 R9 K12 ["ReactInternalTypes"]
       44 CALL                             R7 1 1
       ...
       56 GETTABLEKS                       R11 R12 K13 ["ReactFiberFlags"]
       58 CALL                             R10 1 1
       59 GETTABLEKS                       R9 R10 K14 ["DidCapture"]
       61 LOADNIL                          R10
       62 LOADNIL                          R11
       63 LOADB                            R12 0
