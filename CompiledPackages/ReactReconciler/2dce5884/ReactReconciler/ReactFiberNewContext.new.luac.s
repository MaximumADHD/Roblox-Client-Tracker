...
PROTO_3:
       ...
       14 GETUPVAL                         R3 3
       15 GETTABLEKS                       R3 R3 K3 ["__DEV__"]
       17 JUMPIFNOT                        R3 ; [+47]
       ...
       44 GETUPVAL                         R3 3
       45 GETTABLEKS                       R3 R3 K3 ["__DEV__"]
       47 JUMPIFNOT                        R3 ; [+17]
...
PROTO_9:
       ...
       28 GETUPVAL                         R3 4
       29 GETTABLEKS                       R3 R3 K7 ["MAX_SAFE_INTEGER"]
       ...
       37 JUMP                             ; [+1]
       38 MOVE                             R2 R1
       39 DUPTABLE                         R3 K12 [{["context"], ["observedBits"], ["next"] = }]
       40 SETTABLEKS                       R0 R3 K8 ["context"]
       42 SETTABLEKS                       R2 R3 K9 ["observedBits"]
       44 GETUPVAL                         R4 5
       45 JUMPIFNOTEQKNIL                  R4 ; [+23]
       47 GETUPVAL                         R4 6
       48 JUMPIFNOTEQKNIL                  R4 ; [+9]
       50 GETIMPORT                        R4 K13 [error]
       52 GETUPVAL                         R5 7
       53 GETTABLEKS                       R5 R5 K14 ["new"]
       55 LOADK                            R6 K2 ["Context can only be read while React is rendering. In classes, you can read it in the render method or getDerivedStateFromProps. In function components, you can read it directly in the function body, but not inside Hooks like useReducer() or useMemo()."]
       56 CALL                             R5 1 -1
       57 CALL                             R4 -1 0
       58 SETUPVAL                         R3 5
       59 GETUPVAL                         R4 6
       60 DUPTABLE                         R5 K18 [{["lanes"], ["firstContext"], ["responders"] = }]
       61 GETUPVAL                         R6 8
       62 SETTABLEKS                       R6 R5 K15 ["lanes"]
       64 SETTABLEKS                       R3 R5 K16 ["firstContext"]
       66 SETTABLEKS                       R5 R4 K19 ["dependencies"]
       68 JUMP                             ; [+4]
       69 GETUPVAL                         R4 5
       70 SETTABLEKS                       R3 R4 K10 ["next"]
       72 SETUPVAL                         R3 5
       73 GETUPVAL                         R3 9
       74 JUMPIFNOT                        R3 ; [+3]
       75 GETTABLEKS                       R2 R0 K20 ["_currentValue"]
       77 RETURN                           R2 1
       78 GETTABLEKS                       R2 R0 K21 ["_currentValue2"]
       80 RETURN                           R2 1
...
MAIN:
       ...
       57 GETTABLEKS                       R10 R10 K13 ["ReactFiberLane"]
       59 CALL                             R9 1 1
       60 GETIMPORT                        R10 K4 [require]
       62 GETIMPORT                        R12 K1 [script]
       64 GETTABLEKS                       R12 R12 K2 ["Parent"]
       ...
       75 GETTABLEKS                       R12 R12 K15 ["ReactFiberHostConfig"]
       77 CALL                             R11 1 1
       ...
       86 GETIMPORT                        R16 K4 [require]
       88 GETIMPORT                        R17 K1 [script]
       90 GETTABLEKS                       R17 R17 K2 ["Parent"]
       92 GETTABLEKS                       R17 R17 K20 ["MaxInts"]
       94 CALL                             R16 1 1
       95 GETTABLEKS                       R16 R16 K21 ["MAX_SIGNED_31_BIT_INT"]
       97 GETIMPORT                        R17 K4 [require]
       99 GETIMPORT                        R18 K1 [script]
      101 GETTABLEKS                       R18 R18 K2 ["Parent"]
      103 GETTABLEKS                       R18 R18 K22 ["ReactWorkTags"]
      105 CALL                             R17 1 1
      ...
      122 GETIMPORT                        R26 K4 [require]
      124 GETTABLEKS                       R27 R0 K9 ["Shared"]
      126 CALL                             R26 1 1
      127 GETTABLEKS                       R26 R26 K31 ["objectIs"]
