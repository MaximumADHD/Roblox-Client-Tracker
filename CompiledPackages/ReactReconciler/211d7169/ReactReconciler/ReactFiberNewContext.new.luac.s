...
PROTO_9:
       ...
       38 JUMP                             ; [+1]
       39 MOVE                             R2 R1
       40 DUPTABLE                         R3 K14 [{["context"], ["observedBits"], ["next"] = }]
       41 SETTABLEKS                       R0 R3 K10 ["context"]
       43 SETTABLEKS                       R2 R3 K11 ["observedBits"]
       45 GETUPVAL                         R4 4
       46 JUMPIFNOTEQKNIL                  R4 ; [+23]
       48 GETUPVAL                         R4 5
       49 JUMPIFNOTEQKNIL                  R4 ; [+9]
       51 GETIMPORT                        R4 K15 [error]
       53 GETUPVAL                         R5 6
       54 GETTABLEKS                       R5 R5 K16 ["new"]
       56 LOADK                            R6 K4 ["Context can only be read while React is rendering. In classes, you can read it in the render method or getDerivedStateFromProps. In function components, you can read it directly in the function body, but not inside Hooks like useReducer() or useMemo()."]
       57 CALL                             R5 1 -1
       58 CALL                             R4 -1 0
       59 SETUPVAL                         R3 4
       60 GETUPVAL                         R4 5
       61 DUPTABLE                         R5 K20 [{["lanes"], ["firstContext"], ["responders"] = }]
       62 GETUPVAL                         R6 7
       63 SETTABLEKS                       R6 R5 K17 ["lanes"]
       65 SETTABLEKS                       R3 R5 K18 ["firstContext"]
       67 SETTABLEKS                       R5 R4 K21 ["dependencies"]
       69 JUMP                             ; [+4]
       70 GETUPVAL                         R4 4
       71 SETTABLEKS                       R3 R4 K12 ["next"]
       73 SETUPVAL                         R3 4
       74 GETUPVAL                         R3 8
       75 JUMPIFNOT                        R3 ; [+3]
       76 GETTABLEKS                       R2 R0 K22 ["_currentValue"]
       78 JUMPIF                           R2 ; [+2]
       79 GETTABLEKS                       R2 R0 K23 ["_currentValue2"]
       81 RETURN                           R2 1
