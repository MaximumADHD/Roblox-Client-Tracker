...
PROTO_2:
       ...
       34 FORGLOOP                         R6 2 ; [-3]
       36 GETIMPORT                        R6 K11 [_G]
       38 GETTABLEKS                       R6 R6 K12 ["__DEV__"]
       40 JUMPIF                           R6 ; [+5]
       41 GETIMPORT                        R6 K11 [_G]
       43 GETTABLEKS                       R6 R6 K13 ["__DISABLE_ALL_WARNINGS_EXCEPT_PROP_VALIDATION__"]
       45 JUMPIFNOT                        R6 ; [+11]
       46 GETUPVAL                         R7 1
       47 MOVE                             R8 R2
       48 CALL                             R7 1 1
...
PROTO_8:
       ...
       12 GETIMPORT                        R5 K7 [_G]
       14 GETTABLEKS                       R5 R5 K8 ["__DEV__"]
       16 JUMPIFNOT                        R5 ; [+17]
       17 GETUPVAL                         R6 0
       18 MOVE                             R7 R1
       19 CALL                             R6 1 1
       ...
       62 CALL                             R12 -1 0
       63 FORGLOOP                         R6 2 ; [-21]
       65 GETIMPORT                        R6 K7 [_G]
       67 GETTABLEKS                       R6 R6 K8 ["__DEV__"]
       69 JUMPIF                           R6 ; [+5]
       70 GETIMPORT                        R6 K7 [_G]
       72 GETTABLEKS                       R6 R6 K20 ["__DISABLE_ALL_WARNINGS_EXCEPT_PROP_VALIDATION__"]
       74 JUMPIFNOT                        R6 ; [+11]
       75 GETUPVAL                         R7 0
       76 MOVE                             R8 R1
       77 CALL                             R7 1 1
       ...
       85 CALL                             R7 5 0
       86 GETUPVAL                         R6 5
       87 GETTABLEKS                       R6 R6 K22 ["Dictionary"]
       89 GETTABLEKS                       R6 R6 K23 ["join"]
       91 MOVE                             R7 R2
       92 MOVE                             R8 R5
       93 CALL                             R6 2 -1
       94 RETURN                           R6 -1
...
PROTO_9:
       ...
       17 GETUPVAL                         R4 4
       18 GETUPVAL                         R5 4
       19 GETTABLEKS                       R5 R5 K2 ["current"]
       21 MOVE                             R6 R0
       22 CALL                             R3 3 0
       23 LOADB                            R3 1
       24 RETURN                           R3 1
...
PROTO_11:
       ...
       23 GETTABLEKS                       R2 R1 K5 ["stateNode"]
       25 GETTABLEKS                       R2 R2 K6 ["context"]
       27 RETURN                           R2 1
       ...
       39 GETTABLEKS                       R3 R1 K5 ["stateNode"]
       41 GETTABLEKS                       R3 R3 K9 ["__reactInternalMemoizedMergedChildContext"]
       43 RETURN                           R3 1
...
MAIN:
       ...
       52 GETTABLEKS                       R9 R9 K13 ["ReactFiberTreeReflection"]
       54 CALL                             R8 1 1
       55 GETTABLEKS                       R8 R8 K14 ["isFiberMounted"]
       57 GETIMPORT                        R9 K4 [require]
       59 GETTABLEKS                       R10 R0 K9 ["Shared"]
       61 CALL                             R9 1 1
       62 GETTABLEKS                       R9 R9 K15 ["ReactFeatureFlags"]
       64 GETTABLEKS                       R9 R9 K16 ["disableLegacyContext"]
       66 GETIMPORT                        R10 K4 [require]
       68 GETIMPORT                        R11 K1 [script]
       70 GETTABLEKS                       R11 R11 K2 ["Parent"]
       72 GETTABLEKS                       R11 R11 K17 ["ReactWorkTags"]
       74 CALL                             R10 1 1
       75 GETTABLEKS                       R11 R10 K18 ["ClassComponent"]
       77 GETTABLEKS                       R12 R10 K19 ["HostRoot"]
       79 GETIMPORT                        R13 K4 [require]
       81 GETTABLEKS                       R14 R0 K9 ["Shared"]
       83 CALL                             R13 1 1
       84 GETTABLEKS                       R13 R13 K20 ["getComponentName"]
       86 GETIMPORT                        R14 K4 [require]
       88 GETTABLEKS                       R15 R0 K9 ["Shared"]
       90 CALL                             R14 1 1
       91 GETTABLEKS                       R14 R14 K21 ["checkPropTypes"]
       93 GETTABLEKS                       R15 R7 K22 ["createCursor"]
       95 GETTABLEKS                       R16 R7 K23 ["push"]
       97 GETTABLEKS                       R17 R7 K24 ["pop"]
       99 LOADNIL                          R18
      100 GETIMPORT                        R19 K26 [_G]
      102 GETTABLEKS                       R19 R19 K27 ["__DEV__"]
      104 JUMPIFNOT                        R19 ; [+2]
      105 NEWTABLE                         R18 0 0
      107 NEWTABLE                         R19 0 0
      109 GETIMPORT                        R20 K26 [_G]
      111 GETTABLEKS                       R20 R20 K27 ["__DEV__"]
      113 JUMPIFNOT                        R20 ; [+4]
