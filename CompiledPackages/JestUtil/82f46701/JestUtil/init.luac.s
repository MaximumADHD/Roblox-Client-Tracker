MAIN:
      ...
      144 GETTABLEKS                       R6 R6 K22 ["testPathPatternToRegExp"]
      146 CALL                             R5 1 1
      147 GETTABLEKS                       R5 R5 K8 ["default"]
      149 SETTABLEKS                       R5 R2 K22 ["testPathPatternToRegExp"]
      151 GETIMPORT                        R5 K1 [require]
      153 GETIMPORT                        R6 K3 [script]
      155 GETTABLEKS                       R6 R6 K23 ["globsToMatcher"]
      157 CALL                             R5 1 1
      158 GETTABLEKS                       R5 R5 K8 ["default"]
      160 SETTABLEKS                       R5 R2 K23 ["globsToMatcher"]
      162 GETIMPORT                        R5 K1 [require]
      164 GETIMPORT                        R6 K3 [script]
      166 GETTABLEKS                       R6 R6 K24 ["preRunMessage"]
      168 CALL                             R5 1 1
      ...
      179 GETIMPORT                        R6 K1 [require]
      181 GETIMPORT                        R7 K3 [script]
      183 GETTABLEKS                       R7 R7 K27 ["pluralize"]
      185 CALL                             R6 1 1
      186 GETTABLEKS                       R6 R6 K8 ["default"]
      188 SETTABLEKS                       R6 R2 K27 ["pluralize"]
      190 GETIMPORT                        R6 K1 [require]
      192 GETIMPORT                        R7 K3 [script]
      194 GETTABLEKS                       R7 R7 K28 ["formatTime"]
      196 CALL                             R6 1 1
      197 GETTABLEKS                       R6 R6 K8 ["default"]
