PROTO_0:
        0 MOVE                             R3 R1
        1 JUMPIF                           R3 ; [+4]
        2 DUPTABLE                         R3 K3 [{[1], ["keepPrototype"] = False}]
        3 GETUPVAL                         R4 0
       ...
       14 MOVE                             R6 R0
       15 GETIMPORT                        R5 K6 [typeof]
       17 CALL                             R5 1 1
       18 JUMPIFEQKS                       R5 K7 ["table"] ; [+2]
       20 RETURN                           R0 1
       21 MOVE                             R7 R0
       22 NAMECALL                         R5 R4 K8 ["has"]
       24 CALL                             R5 2 1
       25 JUMPIFNOT                        R5 ; [+5]
       26 MOVE                             R7 R0
       27 NAMECALL                         R5 R4 K9 ["get"]
       29 CALL                             R5 2 -1
       30 RETURN                           R5 -1
       31 GETUPVAL                         R5 2
       32 GETTABLEKS                       R5 R5 K10 ["isArray"]
       34 MOVE                             R6 R0
       35 CALL                             R5 1 1
       36 JUMPIFNOT                        R5 ; [+6]
       37 GETUPVAL                         R5 3
