...
local getFFlagEnableSkyForMetalBalls = require(main.Flags.getFFlagEnableSkyForMetalBalls)
...
local function MaterialPreview(props: _Props)
	...
	return React.createElement(Pane, componentProps, {
		AssetRenderModel = React.createElement(AssetRenderModel, {
			...
			DisablePan = true,
			EnableSky = if getFFlagEnableSkyForMetalBalls() then shouldEnableSky else nil,
