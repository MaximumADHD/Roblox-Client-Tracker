...
PROTO_7:
       ...
       32 JUMPIFNOT                        R3 ; [+18]
       33 GETUPVAL                         R12 1
       34 GETTABLEKS                       R12 R12 K7 ["readStyledProp"]
       36 MOVE                             R13 R0
       37 MOVE                             R14 R8
       38 CALL                             R12 2 2
       39 MOVE                             R10 R12
       ...
       41 JUMPIF                           R10 ; [+17]
       42 GETUPVAL                         R12 1
       43 GETTABLEKS                       R12 R12 K8 ["readProp"]
       45 MOVE                             R13 R0
       46 MOVE                             R14 R8
       47 CALL                             R12 2 2
       48 MOVE                             R10 R12
       ...
       50 JUMP                             ; [+8]
       51 GETUPVAL                         R12 1
       52 GETTABLEKS                       R12 R12 K8 ["readProp"]
       54 MOVE                             R13 R0
       55 MOVE                             R14 R8
       56 CALL                             R12 2 2
       57 MOVE                             R10 R12
...
PROTO_10:
       ...
       18 CALL                             R6 1 0
       19 GETUPVAL                         R6 2
       20 GETTABLEKS                       R6 R6 K8 ["listProps"]
       22 MOVE                             R7 R5
...
MAIN:
       ...
       37 GETTABLEKS                       R10 R7 K14 ["isAsymmetric"]
       39 NEWTABLE                         R11 16 0
       41 DUPCLOSURE                       R12 K15 [PROTO_0]
       42 DUPCLOSURE                       R13 K16 [PROTO_1]
       43 DUPCLOSURE                       R14 K17 [PROTO_2]
       44 DUPCLOSURE                       R15 K18 [PROTO_3]
       45 CAPTURE                          VAL R12
       46 SETTABLEKS                       R15 R11 K19 ["readProp"]
       48 DUPCLOSURE                       R15 K20 [PROTO_4]
       49 CAPTURE                          VAL R13
       50 SETTABLEKS                       R15 R11 K21 ["readStyledProp"]
       52 DUPCLOSURE                       R15 K22 [PROTO_5]
       53 CAPTURE                          VAL R14
       54 SETTABLEKS                       R15 R11 K23 ["writeProp"]
       56 DUPCLOSURE                       R15 K24 [PROTO_6]
       57 CAPTURE                          VAL R2
       58 DUPCLOSURE                       R16 K25 [PROTO_7]
       59 CAPTURE                          VAL R15
       60 CAPTURE                          VAL R11
       61 CAPTURE                          VAL R6
       62 CAPTURE                          VAL R13
       63 SETTABLEKS                       R16 R11 K26 ["listProps"]
       65 DUPCLOSURE                       R16 K27 [PROTO_9]
       66 SETTABLEKS                       R16 R11 K28 ["getTags"]
       68 NEWTABLE                         R16 0 0
       70 NEWTABLE                         R17 0 0
       72 DUPCLOSURE                       R18 K29 [PROTO_10]
       73 CAPTURE                          VAL R17
       74 CAPTURE                          VAL R16
       75 CAPTURE                          VAL R11
       76 SETTABLEKS                       R18 R11 K30 ["listDefaultProps"]
       78 DUPCLOSURE                       R16 K31 [PROTO_14]
       79 CAPTURE                          VAL R3
       80 CAPTURE                          VAL R9
       81 CAPTURE                          VAL R5
       82 CAPTURE                          VAL R6
       83 CAPTURE                          VAL R11
       84 CAPTURE                          VAL R8
       85 SETTABLEKS                       R16 R11 K32 ["instanceSubsetEquality"]
       87 NEWTABLE                         R16 2 0
       89 SETTABLEKS                       R16 R11 K33 ["InstanceSubset"]
       91 SETTABLEKS                       R16 R16 K34 ["__index"]
       93 DUPCLOSURE                       R17 K35 [PROTO_15]
       94 CAPTURE                          VAL R16
       95 SETTABLEKS                       R17 R16 K36 ["new"]
       97 DUPCLOSURE                       R17 K37 [PROTO_16]
       98 CAPTURE                          VAL R8
       99 CAPTURE                          VAL R10
      100 CAPTURE                          VAL R11
      101 CAPTURE                          VAL R16
      102 SETTABLEKS                       R17 R11 K38 ["getInstanceSubset"]
      104 RETURN                           R11 1
