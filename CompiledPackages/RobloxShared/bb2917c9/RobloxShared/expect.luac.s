...
PROTO_4:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["asymmetricMatch"]
        3 RETURN                           R0 1
...
PROTO_7:
       ...
       61 RETURN                           R9 1
       62 GETUPVAL                         R9 3
       63 GETTABLEKS                       R9 R9 K4 ["isArray"]
       65 MOVE                             R10 R0
       66 CALL                             R9 1 1
       67 GETUPVAL                         R10 3
       68 GETTABLEKS                       R10 R10 K4 ["isArray"]
       70 MOVE                             R11 R1
       71 CALL                             R10 1 1
      ...
      164 CALL                             R10 2 0
      165 GETUPVAL                         R10 3
      166 GETTABLEKS                       R10 R10 K4 ["isArray"]
      168 MOVE                             R11 R0
      169 CALL                             R10 1 1
      170 JUMPIFNOT                        R10 ; [+6]
      171 LENGTH                           R10 R0
...
PROTO_11:
       ...
       20 GETUPVAL                         R2 0
       21 GETTABLEKS                       R2 R2 K5 ["isArray"]
       23 MOVE                             R3 R0
       24 CALL                             R2 1 1
       25 NOT                              R1 R2
       26 RETURN                           R1 1
...
PROTO_14:
       ...
       22 GETUPVAL                         R3 1
       23 GETTABLEKS                       R3 R3 K5 ["isArray"]
       25 MOVE                             R4 R2
       26 CALL                             R3 1 1
       27 NOT                              R1 R3
       28 JUMPIFNOT                        R1 ; [+22]
...
PROTO_15:
       ...
       20 GETUPVAL                         R3 0
       21 GETTABLEKS                       R3 R3 K5 ["isArray"]
       23 MOVE                             R4 R1
       24 CALL                             R3 1 1
       25 NOT                              R2 R3
       26 JUMPIF                           R2 ; [+2]
       ...
       28 RETURN                           R2 1
       29 GETUPVAL                         R2 0
       30 GETTABLEKS                       R2 R2 K6 ["every"]
       32 GETUPVAL                         R3 1
       33 GETTABLEKS                       R3 R3 K7 ["keys"]
       35 MOVE                             R4 R1
       36 CALL                             R3 1 1
       37 NEWCLOSURE                       R4 P0
       38 CAPTURE                          VAL R1
...
PROTO_19:
        ...
        3 NEWTABLE                         R3 0 0
        5 GETUPVAL                         R4 0
        6 GETTABLEKS                       R4 R4 K0 ["isArray"]
        8 MOVE                             R5 R0
        9 CALL                             R4 1 1
       10 JUMPIFNOT                        R4 ; [+30]
       11 GETUPVAL                         R4 0
       12 GETTABLEKS                       R4 R4 K0 ["isArray"]
       14 MOVE                             R5 R1
       15 CALL                             R4 1 1
       16 JUMPIFNOT                        R4 ; [+113]
       17 LENGTH                           R4 R1
       ...
       90 GETUPVAL                         R6 0
       91 GETTABLEKS                       R6 R6 K9 ["filter"]
       93 GETUPVAL                         R7 6
       94 GETTABLEKS                       R7 R7 K10 ["keys"]
       96 MOVE                             R8 R0
       97 CALL                             R7 1 1
       98 NEWCLOSURE                       R8 P0
       99 CAPTURE                          VAL R1
...
MAIN:
       ...
       18 CALL                             R3 1 1
       19 GETTABLEKS                       R4 R3 K8 ["Boolean"]
       21 GETTABLEKS                       R4 R4 K9 ["toJSBoolean"]
