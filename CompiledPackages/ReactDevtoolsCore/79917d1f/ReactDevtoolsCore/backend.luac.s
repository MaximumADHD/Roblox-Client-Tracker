...
PROTO_5:
       ...
       19 LOADK                            R1 K7 ["Bad data received from socket: %* (of type %*)"]
       20 GETUPVAL                         R3 0
       21 GETUPVAL                         R5 0
       22 FASTCALL1                        TYPEOF R5 ; [+2]
       23 GETIMPORT                        R4 K9 [typeof]
       25 CALL                             R4 1 1
       26 NAMECALL                         R1 R1 K10 ["format"]
       28 CALL                             R1 3 1
       29 CALL                             R0 1 0
       30 RETURN                           R0 0
...
PROTO_6:
       ...
       10 LOADK                            R4 K4 ["[React DevTools] Failed to parse JSON: %* (got error: %*)"]
       11 GETTABLEKS                       R6 R0 K5 ["data"]
       13 MOVE                             R7 R2
       ...
       20 LOADNIL                          R5
       21 FORGPREP                         R3
       22 GETIMPORT                        R8 K1 [pcall]
       24 MOVE                             R9 R7
       25 MOVE                             R10 R2
       26 CALL                             R8 2 2
       27 JUMPIF                           R8 ; [+9]
       28 GETIMPORT                        R10 K3 [error]
       30 LOADK                            R11 K7 ["[React DevTools] Error calling listener with data: %*\n%*"]
       31 MOVE                             R13 R2
       32 MOVE                             R14 R9
...
PROTO_15:
       ...
       56 MOVE                             R15 R2
       57 MOVE                             R16 R4
       58 NAMECALL                         R12 R12 K13 ["format"]
       60 CALL                             R12 4 1
       61 NEWCLOSURE                       R13 P3
       62 CAPTURE                          UPVAL U2
       63 CAPTURE                          REF R9
       64 CAPTURE                          UPVAL U3
       65 CAPTURE                          REF R7
       ...
       70 CAPTURE                          UPVAL U2
       71 CAPTURE                          VAL R11
       72 GETIMPORT                        R15 K15 [pcall]
       74 NEWCLOSURE                       R16 P5
       75 CAPTURE                          UPVAL U5
       76 CAPTURE                          UPVAL U4
       77 CAPTURE                          VAL R12
       78 CALL                             R15 1 2
       79 JUMPIFNOTEQKB                    R15 FALSE ; [+27]
       81 GETIMPORT                        R17 K17 [warn]
       83 LOADK                            R18 K18 ["[React DevTools] Could not connect to DevTools. Attempted to connect to \"%*\" (%*)"]
       84 MOVE                             R20 R12
       85 MOVE                             R21 R16
       ...
       89 CALL                             R17 1 0
       90 GETUPVAL                         R17 3
       91 GETTABLEKS                       R17 R17 K19 ["reportFailedDevtoolsConnection"]
       93 LOADK                            R18 K20 ["create_client_failed"]
       94 CALL                             R17 1 0
       95 JUMPIFNOTEQKNIL                  R7 ; [+9]
       97 GETIMPORT                        R17 K11 [task.delay]
       99 LOADN                            R18 2
      ...
      105 CLOSEUPVALS                      R7
      106 RETURN                           R0 0
      107 GETTABLEKS                       R17 R16 K21 ["Closed"]
      109 MOVE                             R19 R13
      110 NAMECALL                         R17 R17 K22 ["Connect"]
      112 CALL                             R17 2 0
      113 GETTABLEKS                       R17 R16 K23 ["MessageReceived"]
      115 MOVE                             R19 R14
      116 NAMECALL                         R17 R17 K22 ["Connect"]
      118 CALL                             R17 2 0
      119 GETTABLEKS                       R17 R16 K24 ["Opened"]
      121 NEWCLOSURE                       R19 P6
      122 CAPTURE                          REF R9
      ...
      141 NAMECALL                         R17 R17 K22 ["Connect"]
      143 CALL                             R17 2 0
      144 CLOSEUPVALS                      R7
      145 RETURN                           R0 0
