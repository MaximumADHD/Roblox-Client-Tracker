...
PROTO_2:
        0 JUMPIFEQKNIL                     R2 ; [+9]
        2 GETUPVAL                         R3 0
        3 GETTABLEKS                       R3 R3 K0 ["onFocusLost"]
        5 MOVE                             R4 R0
        6 MOVE                             R5 R1
        7 MOVE                             R6 R2
        8 GETUPVAL                         R7 1
...
PROTO_3:
       ...
       15 CALL                             R2 2 1
       16 GETUPVAL                         R3 0
       17 GETTABLEKS                       R3 R3 K1 ["useCallback"]
       19 NEWCLOSURE                       R4 P1
       20 CAPTURE                          VAL R2
       21 NEWTABLE                         R5 0 1
       23 MOVE                             R6 R2
       ...
       26 CALL                             R3 2 1
       27 GETUPVAL                         R4 0
       28 GETTABLEKS                       R4 R4 K1 ["useCallback"]
       30 NEWCLOSURE                       R5 P2
       31 CAPTURE                          VAL R0
       32 CAPTURE                          VAL R2
       33 NEWTABLE                         R6 0 2
       ...
       55 GETUPVAL                         R8 0
       56 GETTABLEKS                       R8 R8 K9 ["Event"]
       58 GETTABLEKS                       R8 R8 K10 ["InputBegan"]
       ...
       64 NEWTABLE                         R11 4 0
       66 LOADB                            R12 1
       67 SETTABLEKS                       R12 R11 K14 ["ShouldEmitUpAndDownArrowEvents"]
       69 LOADB                            R12 0
       70 SETTABLEKS                       R12 R11 K15 ["Visible"]
       72 SETTABLEKS                       R1 R11 K16 ["ref"]
       74 GETUPVAL                         R12 0
       75 GETTABLEKS                       R12 R12 K9 ["Event"]
       77 GETTABLEKS                       R12 R12 K17 ["FocusLost"]
       79 SETTABLE                         R4 R11 R12
       80 CALL                             R9 2 1
       81 SETTABLEKS                       R9 R8 K11 ["Dummy"]
       83 CALL                             R5 3 -1
       84 RETURN                           R5 -1
