PROTO_0:
       ...
       11 DUPTABLE                         R4 K8 [{["ServiceType"] = 1, ["RunningTCS"]}]
       12 GETIMPORT                        R6 K12 [Enum.ChatVersion.TextChatService]
       14 JUMPIFEQ                         R2 R6 ; [+2]
       16 LOADB                            R5 0 +1
       17 LOADB                            R5 1
       18 SETTABLEKS                       R5 R4 K7 ["RunningTCS"]
       20 CALL                             R3 1 -1
       21 RETURN                           R3 -1
       22 LOADK                            R5 K11 ["TextChatService"]
       23 NAMECALL                         R3 R0 K1 ["IsA"]
       25 CALL                             R3 2 1
       26 JUMPIFNOT                        R3 ; [+10]
       27 JUMPIFNOT                        R1 ; [+9]
       28 GETIMPORT                        R3 K12 [Enum.ChatVersion.TextChatService]
       30 JUMPIFEQ                         R2 R3 ; [+6]
       32 GETIMPORT                        R3 K4 [table.freeze]
       34 DUPTABLE                         R4 K14 [{["ServiceType"] = 0}]
       35 CALL                             R3 1 -1
       36 RETURN                           R3 -1
       37 LOADNIL                          R3
       38 RETURN                           R3 1
...
PROTO_1:
        ...
        2 GETUPVAL                         R2 2
        3 GETUPVAL                         R3 2
        4 GETTABLEKS                       R3 R3 K0 ["IsAutoMigrated"]
        6 GETUPVAL                         R4 3
        7 GETTABLEKS                       R4 R4 K1 ["ChatVersion"]
        9 CALL                             R1 3 -1
       10 CALL                             R0 -1 0
       11 RETURN                           R0 0
...
PROTO_6:
        ...
        3 RETURN                           R2 1
        4 GETUPVAL                         R2 0
        5 GETTABLEKS                       R2 R2 K1 ["alertIcons"]
        7 MOVE                             R3 R1
        8 CALL                             R2 1 -1
        9 RETURN                           R2 -1
...
PROTO_7:
       ...
       36 RETURN                           R0 0
       37 GETUPVAL                         R4 2
       38 GETTABLEKS                       R4 R4 K9 ["mouseEnter"]
       40 MOVE                             R5 R0
       41 MOVE                             R6 R1
       42 MOVE                             R7 R2
       43 MOVE                             R8 R3
...
PROTO_9:
       ...
       50 GETUPVAL                         R8 1
       51 GETTABLEKS                       R8 R8 K15 ["Event"]
       53 GETTABLEKS                       R8 R8 K16 ["MouseEnter"]
       55 SETTABLE                         R4 R7 R8
       56 GETUPVAL                         R8 1
       57 GETTABLEKS                       R8 R8 K15 ["Event"]
       59 GETTABLEKS                       R8 R8 K17 ["MouseLeave"]
       61 GETTABLEKS                       R9 R3 K18 ["mouseLeave"]
       63 SETTABLE                         R9 R7 R8
       64 GETUPVAL                         R8 1
       65 GETTABLEKS                       R8 R8 K19 ["Tag"]
...
PROTO_10:
        ...
        3 GETUPVAL                         R2 1
        4 DUPTABLE                         R3 K5 [{["valueBinding"], ["getTooltipText"], ["tag"] = "data-testid=ChatMigration"}]
...
MAIN:
       ...
       48 GETTABLEKS                       R7 R7 K16 ["WarningView"]
       50 CALL                             R6 1 1
       51 GETIMPORT                        R7 K5 [require]
       53 GETTABLEKS                       R8 R0 K17 ["Flags"]
       55 GETTABLEKS                       R8 R8 K18 ["getFFlagBehaviorVisualState"]
       57 CALL                             R7 1 1
       ...
       80 CAPTURE                          VAL R6
       81 CAPTURE                          VAL R11
       82 DUPTABLE                         R15 K36 [{["key"] = "ChatMigration", ["icon"] = "", ["watch"], ["validateArgs"], ["render"], ["permanent"] = True}]
       83 SETTABLEKS                       R10 R15 K31 ["watch"]
       85 DUPCLOSURE                       R16 K37 [PROTO_11]
       86 SETTABLEKS                       R16 R15 K32 ["validateArgs"]
       88 DUPCLOSURE                       R16 K38 [PROTO_12]
       89 CAPTURE                          VAL R7
       90 CAPTURE                          VAL R4
       91 CAPTURE                          VAL R14
       92 CAPTURE                          VAL R13
       93 SETTABLEKS                       R16 R15 K33 ["render"]
       95 RETURN                           R15 1
