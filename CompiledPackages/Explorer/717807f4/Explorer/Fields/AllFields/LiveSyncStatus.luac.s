...
PROTO_3:
        ...
        3 JUMPIF                           R2 ; [+7]
        4 GETUPVAL                         R2 0
        5 GETTABLEKS                       R2 R2 K1 ["liveSyncStatus"]
       ...
       15 GETUPVAL                         R2 0
       16 GETTABLEKS                       R2 R2 K1 ["liveSyncStatus"]
       18 LOADK                            R3 K4 ["Errored"]
       19 MOVE                             R4 R1
       20 CALL                             R2 2 -1
       21 RETURN                           R2 -1
       22 GETUPVAL                         R2 0
       23 GETTABLEKS                       R2 R2 K1 ["liveSyncStatus"]
...
PROTO_5:
       ...
       26 RETURN                           R0 0
       27 GETUPVAL                         R4 2
       28 GETTABLEKS                       R4 R4 K6 ["mouseEnter"]
       30 MOVE                             R5 R0
       31 MOVE                             R6 R1
       32 MOVE                             R7 R2
       33 MOVE                             R8 R3
...
MAIN:
       ...
       67 CAPTURE                          VAL R13
       68 DUPTABLE                         R15 K36 [{["key"] = "liveSyncStatus", ["icon"] = "", ["init"], ["watch"], ["validateArgs"], ["render"], ["permanent"] = True}]
       69 SETTABLEKS                       R14 R15 K30 ["init"]
       71 SETTABLEKS                       R9 R15 K31 ["watch"]
       73 DUPCLOSURE                       R16 K37 [PROTO_15]
       74 SETTABLEKS                       R16 R15 K32 ["validateArgs"]
       76 DUPCLOSURE                       R16 K38 [PROTO_16]
       77 CAPTURE                          VAL R7
       78 CAPTURE                          VAL R12
       79 SETTABLEKS                       R16 R15 K33 ["render"]
       81 RETURN                           R15 1
