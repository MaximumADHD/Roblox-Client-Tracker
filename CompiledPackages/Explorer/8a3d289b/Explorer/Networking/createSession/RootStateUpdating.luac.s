PROTO_0:
        ...
        6 LOADK                            R4 K3 ["%* (%*) is being parented to nil"]
        7 GETTABLEKS                       R6 R1 K4 ["name"]
        9 GETTABLEKS                       R7 R1 K5 ["id"]
       11 NAMECALL                         R4 R4 K6 ["format"]
       13 CALL                             R4 3 1
       14 CALL                             R3 1 0
       15 GETTABLEKS                       R6 R0 K7 ["instanceIdsToNodes"]
       17 GETTABLEKS                       R7 R1 K5 ["id"]
       19 GETTABLE                         R5 R6 R7
       20 JUMPIFEQKNIL                     R5 ; [+2]
       22 LOADB                            R4 0 +1
       23 LOADB                            R4 1
       24 FASTCALL2K                       ASSERT R4 K8 ; [+4]
       26 LOADK                            R5 K8 ["Receiving instance added about instance we already know about"]
       27 GETIMPORT                        R3 K10 [assert]
       29 CALL                             R3 2 0
       30 GETTABLEKS                       R4 R0 K7 ["instanceIdsToNodes"]
       32 GETTABLEKS                       R5 R1 K0 ["parentId"]
       34 GETTABLE                         R3 R4 R5
       35 JUMPIFNOTEQKNIL                  R3 ; [+15]
       37 GETIMPORT                        R4 K2 [error]
       39 LOADK                            R5 K11 ["Instance added to parent we don't know about: %* (datum.id = %*) (datum.name = %*) (search = %*)"]
       40 GETTABLEKS                       R7 R1 K0 ["parentId"]
       42 GETTABLEKS                       R8 R1 K5 ["id"]
       44 GETTABLEKS                       R9 R1 K4 ["name"]
       46 MOVE                             R10 R2
       47 NAMECALL                         R5 R5 K6 ["format"]
       49 CALL                             R5 5 1
       50 CALL                             R4 1 0
       51 GETUPVAL                         R4 0
       52 GETTABLEKS                       R4 R4 K12 ["createFromDatum"]
       54 MOVE                             R5 R1
       55 CALL                             R4 1 1
       56 GETUPVAL                         R5 1
       57 GETTABLEKS                       R5 R5 K13 ["insertInto"]
       59 MOVE                             R6 R0
       60 MOVE                             R7 R3
       61 MOVE                             R8 R4
       62 CALL                             R5 3 0
