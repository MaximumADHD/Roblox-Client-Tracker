...
PROTO_15:
        ...
        2 MOVE                             R2 R0
        3 LOADB                            R3 1
        4 JUMPIFEQKNIL                     R2 ; [+45]
        6 GETUPVAL                         R5 0
        7 GETTABLEKS                       R5 R5 K0 ["instanceIdsToNodes"]
        9 GETTABLE                         R4 R5 R2
       10 JUMPIFNOTEQKNIL                  R4 ; [+39]
       12 GETUPVAL                         R5 1
       13 GETTABLEKS                       R5 R5 K1 ["rootState"]
       15 GETTABLEKS                       R5 R5 K0 ["instanceIdsToNodes"]
       17 GETTABLE                         R4 R5 R2
       18 JUMPIFNOTEQKNIL                  R4 ; [+9]
       20 GETIMPORT                        R5 K3 [error]
       22 LOADK                            R6 K4 ["Found node we don't know about, this should've been pre-populated from newDatums: %*"]
       23 MOVE                             R8 R2
       24 NAMECALL                         R6 R6 K5 ["format"]
       26 CALL                             R6 2 1
       27 CALL                             R5 1 0
       28 FASTCALL2                        TABLE_INSERT R1 R4 ; [+5]
       30 MOVE                             R6 R1
       31 MOVE                             R7 R4
       32 GETIMPORT                        R5 K8 [table.insert]
       34 CALL                             R5 2 0
       35 GETTABLEKS                       R5 R4 K9 ["parent"]
       37 JUMPIFNOT                        R5 ; [+6]
       38 GETTABLEKS                       R5 R4 K9 ["parent"]
       40 GETTABLEKS                       R5 R5 K10 ["datum"]
       42 GETTABLEKS                       R5 R5 K11 ["id"]
       44 MOVE                             R2 R5
       45 JUMPIFNOTEQKNIL                  R2 ; [+3]
       47 LOADB                            R3 0
       48 JUMP                             ; [+1]
       49 JUMPBACK                         ; [-46]
       50 JUMPIF                           R3 ; [+1]
       ...
       54 LOADN                            R5 -1
       55 FORNPREP                         R4
       56 GETTABLE                         R7 R1 R6
       57 GETTABLEKS                       R8 R7 K10 ["datum"]
       59 GETTABLEKS                       R9 R8 K12 ["hasChildren"]
       61 JUMPIFNOT                        R9 ; [+12]
       62 GETIMPORT                        R9 K14 [table.clone]
       64 MOVE                             R10 R8
       65 CALL                             R9 1 1
       66 MOVE                             R8 R9
       67 LOADB                            R9 0
       68 SETTABLEKS                       R9 R8 K12 ["hasChildren"]
       70 GETIMPORT                        R9 K16 [table.freeze]
       72 MOVE                             R10 R8
       73 CALL                             R9 1 0
       74 GETUPVAL                         R9 2
       75 GETTABLEKS                       R9 R9 K17 ["instanceAdded"]
       77 GETUPVAL                         R10 0
       78 MOVE                             R11 R8
       79 GETUPVAL                         R12 3
       80 CALL                             R9 3 1
