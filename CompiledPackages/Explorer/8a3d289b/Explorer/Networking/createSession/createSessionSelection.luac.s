...
PROTO_2:
      ...
      133 LOADK                            R13 K25 ["Selecting unknown instance %*, with selection count %*"]
      134 MOVE                             R15 R2
      135 LENGTH                           R16 R0
      136 NAMECALL                         R13 R13 K26 ["format"]
      138 CALL                             R13 3 1
      139 CALL                             R12 1 0
      140 GETTABLEKS                       R14 R11 K11 ["datum"]
      142 GETTABLEKS                       R14 R14 K0 ["parentId"]
      144 JUMPIFNOTEQKNIL                  R14 ; [+2]
      146 LOADB                            R13 0 +1
      147 LOADB                            R13 1
      148 FASTCALL2K                       ASSERT R13 K27 ; [+4]
      150 LOADK                            R14 K27 ["Selecting instance not in data model."]
      151 GETIMPORT                        R12 K3 [assert]
      153 CALL                             R12 2 0
      154 GETUPVAL                         R12 2
      155 CALL                             R12 0 1
      156 JUMPIFNOT                        R12 ; [+11]
      157 GETUPVAL                         R12 3
      158 GETTABLEKS                       R12 R12 K9 ["expandKnownInstance"]
      160 GETUPVAL                         R13 0
      161 GETTABLEKS                       R13 R13 K4 ["rootState"]
      163 GETTABLEKS                       R14 R11 K11 ["datum"]
      165 GETTABLEKS                       R14 R14 K0 ["parentId"]
      167 CALL                             R12 2 0
      168 GETTABLEKS                       R12 R11 K12 ["parent"]
      170 JUMPIFEQKNIL                     R12 ; [+10]
      172 GETTABLEKS                       R13 R12 K11 ["datum"]
      174 GETTABLEKS                       R13 R13 K7 ["id"]
      176 LOADB                            R14 1
      177 SETTABLE                         R14 R5 R13
      178 GETTABLEKS                       R12 R12 K12 ["parent"]
      180 JUMPBACK                         ; [-11]
      181 FORGLOOP                         R6 2 ; [-84]
      183 GETUPVAL                         R6 0
      184 GETTABLEKS                       R6 R6 K4 ["rootState"]
      186 GETTABLEKS                       R6 R6 K28 ["queueRootChanged"]
      188 CALL                             R6 0 0
      189 GETUPVAL                         R6 6
      190 GETIMPORT                        R7 K31 [table.freeze]
      192 MOVE                             R8 R0
      193 CALL                             R7 1 -1
      194 CALL                             R6 -1 0
      195 GETUPVAL                         R6 7
...
MAIN:
       ...
       89 CALL                             R11 1 1
       90 DUPTABLE                         R12 K30 [{["eventName"] = "LuaExplorerUnknownSelection", ["backends"], ["throttlingPercentage"], ["description"] = "Fires when Explorer errors with an unknown selection.", ["lastUpdated"] = "2025-05-12"}]
       91 NEWTABLE                         R13 0 1
       93 LOADK                            R14 K31 ["Points"]
       94 SETLIST                          R13 R14 1 [1]
       96 SETTABLEKS                       R13 R12 K24 ["backends"]
       98 GETIMPORT                        R13 K33 [game]
      100 LOADK                            R15 K34 ["LuaExplorerUnknownSelectionThrottlingHundredthsPercent"]
      101 LOADN                            R16 10000
      102 NAMECALL                         R13 R13 K35 ["DefineFastInt"]
      104 CALL                             R13 3 1
      105 SETTABLEKS                       R13 R12 K25 ["throttlingPercentage"]
      107 DUPCLOSURE                       R13 K36 [PROTO_3]
      108 CAPTURE                          VAL R4
      109 CAPTURE                          VAL R10
      110 CAPTURE                          VAL R8
      111 CAPTURE                          VAL R9
