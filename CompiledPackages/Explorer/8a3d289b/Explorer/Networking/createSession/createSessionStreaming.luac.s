PROTO_0:
       ...
       15 CALL                             R2 2 0
       16 GETTABLEKS                       R2 R1 K5 ["datum"]
       18 GETTABLEKS                       R2 R2 K6 ["isGhost"]
       20 JUMPIFNOT                        R2 ; [+1]
       21 RETURN                           R0 0
       ...
       41 JUMPIFNOT                        R2 ; [+30]
       42 GETUPVAL                         R2 0
       43 GETTABLEKS                       R2 R2 K12 ["searchRootState"]
       45 JUMPIFEQKNIL                     R2 ; [+26]
       47 GETUPVAL                         R3 0
       48 GETTABLEKS                       R3 R3 K12 ["searchRootState"]
       50 GETTABLEKS                       R3 R3 K1 ["instanceIdsToNodes"]
       ...
       71 CALL                             R3 1 0
       72 GETUPVAL                         R2 0
       73 GETTABLEKS                       R2 R2 K0 ["rootState"]
       75 GETTABLEKS                       R2 R2 K13 ["queueRootChanged"]
       77 CALL                             R2 0 0
       78 RETURN                           R0 0
...
PROTO_1:
        ...
        6 JUMPIFNOTEQKNIL                  R1 ; [+2]
        8 RETURN                           R0 0
        9 GETTABLEKS                       R2 R1 K2 ["datum"]
       11 GETTABLEKS                       R2 R2 K3 ["isGhost"]
       13 JUMPIF                           R2 ; [+1]
       14 RETURN                           R0 0
...
PROTO_4:
       ...
       20 GETUPVAL                         R5 1
       21 GETTABLEKS                       R6 R2 K5 ["datum"]
       23 GETTABLEKS                       R6 R6 K6 ["id"]
...
PROTO_5:
       ...
       31 GETTABLEKS                       R10 R0 K9 ["guestRpcInterface"]
       33 GETTABLEKS                       R10 R10 K5 ["requestStreamIn"]
...
MAIN:
       ...
       28 GETTABLEKS                       R5 R0 K11 ["Networking"]
       30 GETTABLEKS                       R5 R5 K12 ["createSession"]
       32 GETTABLEKS                       R5 R5 K13 ["createSessionTypes"]
       34 CALL                             R4 1 1
       35 GETIMPORT                        R5 K5 [require]
       37 GETTABLEKS                       R6 R0 K14 ["Flags"]
       39 GETTABLEKS                       R6 R6 K15 ["getFFlagExplorerMakeGhostsWhenSearching"]
       41 CALL                             R5 1 1
       42 MOVE                             R6 R3
