...
PROTO_2:
       ...
       47 LOADK                            R9 K13 ["connection.identifier = %*"]
       48 GETUPVAL                         R11 1
       49 GETTABLEKS                       R11 R11 K3 ["identifier"]
       51 NAMECALL                         R9 R9 K14 ["format"]
       53 CALL                             R9 2 1
       54 LOADK                            R10 K15 ["key = %*"]
       55 MOVE                             R12 R0
       56 NAMECALL                         R10 R10 K14 ["format"]
       58 CALL                             R10 2 1
       59 LOADK                            R11 K16 ["nonce = %*"]
       60 MOVE                             R13 R2
       61 NAMECALL                         R11 R11 K14 ["format"]
       63 CALL                             R11 2 1
       64 LOADK                            R12 K17 ["yieldingThreadNonces = %*"]
       65 GETUPVAL                         R14 4
       66 MOVE                             R16 R4
       67 NAMECALL                         R14 R14 K18 ["JSONEncode"]
       69 CALL                             R14 2 1
       70 NAMECALL                         R12 R12 K14 ["format"]
       72 CALL                             R12 2 1
       73 SETLIST                          R7 R8 5 [1]
       75 LOADK                            R8 K19 ["\n"]
       76 CALL                             R6 2 -1
       77 CALL                             R5 -1 0
       78 GETUPVAL                         R5 3
       79 LENGTH                           R4 R5
       80 JUMPIFNOTEQKN                    R4 K20 [1] ; [+15]
       82 NEWTABLE                         R4 0 0
       84 SETUPVAL                         R4 3
       85 GETIMPORT                        R4 K23 [task.spawn]
       87 GETTABLEKS                       R5 R3 K24 ["thread"]
       89 GETIMPORT                        R6 K26 [select]
       91 LOADN                            R7 2
       92 GETVARARGS                       R8 -1
       93 CALL                             R6 -1 -1
       94 CALL                             R4 -1 0
       95 RETURN                           R0 0
       96 GETIMPORT                        R4 K28 [table.pack]
       98 GETIMPORT                        R5 K26 [select]
      100 LOADN                            R6 2
      101 GETVARARGS                       R7 -1
      102 CALL                             R5 -1 -1
      103 CALL                             R4 -1 1
      ...
      105 CAPTURE                          VAL R4
      106 SETTABLEKS                       R5 R3 K29 ["resumeWith"]
      108 GETUPVAL                         R6 3
      109 LENGTH                           R5 R6
      110 LOADN                            R6 0
      111 JUMPIFNOTLT                      R6 R5 ; [+43]
      113 GETUPVAL                         R6 3
      114 GETTABLEN                        R5 R6 1
      115 GETTABLEKS                       R5 R5 K29 ["resumeWith"]
      117 JUMPIFEQKNIL                     R5 ; [+37]
      119 GETIMPORT                        R5 K31 [table.remove]
      121 GETUPVAL                         R6 3
      122 LOADN                            R7 1
      123 CALL                             R5 2 1
      124 JUMPIFNOTEQKNIL                  R5 ; [+2]
      126 LOADB                            R7 0 +1
      127 LOADB                            R7 1
      128 FASTCALL2K                       ASSERT R7 K32 ; [+4]
      130 LOADK                            R8 K32 ["Couldn't pop yielding thread"]
      131 GETIMPORT                        R6 K34 [assert]
      133 CALL                             R6 2 0
      134 GETTABLEKS                       R8 R5 K29 ["resumeWith"]
      136 JUMPIFNOTEQKNIL                  R8 ; [+2]
      138 LOADB                            R7 0 +1
      139 LOADB                            R7 1
      140 FASTCALL2K                       ASSERT R7 K35 ; [+4]
      142 LOADK                            R8 K35 ["Yielding thread didn't set resumeWith"]
      143 GETIMPORT                        R6 K34 [assert]
      145 CALL                             R6 2 0
      146 GETIMPORT                        R6 K23 [task.spawn]
      148 GETTABLEKS                       R7 R5 K24 ["thread"]
      150 GETTABLEKS                       R8 R5 K29 ["resumeWith"]
      152 CALL                             R8 0 -1
      153 CALL                             R6 -1 0
      154 JUMPBACK                         ; [-47]
      155 RETURN                           R0 0
...
PROTO_6:
       ...
       39 CALL                             R6 2 0
       40 FORGLOOP                         R1 2 ; [-30]
       42 LOADK                            R1 K8 ["fire to %*: %*"]
       43 GETUPVAL                         R3 1
       44 GETTABLEKS                       R3 R3 K9 ["identifier"]
       46 GETUPVAL                         R4 2
       47 NAMECALL                         R1 R1 K10 ["format"]
       49 CALL                             R1 3 1
       50 FASTCALL1                        TABLE_UNPACK R0 ; [+3]
       51 MOVE                             R3 R0
       52 GETIMPORT                        R2 K12 [unpack]
       54 CALL                             R2 1 -1
       55 RETURN                           R1 -1
...
PROTO_7:
        ...
        7 CALL                             R0 -1 0
        8 GETUPVAL                         R0 2
        9 GETTABLEKS                       R0 R0 K0 ["sendMessage"]
       11 GETUPVAL                         R1 3
       12 GETVARARGS                       R2 -1
       13 CALL                             R0 -1 0
       14 RETURN                           R0 0
...
MAIN:
       ...
       27 GETTABLEKS                       R5 R1 K13 ["Util"]
       29 GETTABLEKS                       R5 R5 K14 ["createDebugLogger"]
       31 CALL                             R4 1 1
       32 GETIMPORT                        R5 K9 [require]
       34 GETTABLEKS                       R6 R1 K13 ["Util"]
       36 GETTABLEKS                       R6 R6 K15 ["createNextNonce"]
       38 CALL                             R5 1 1
       39 GETIMPORT                        R6 K9 [require]
       41 GETTABLEKS                       R7 R1 K13 ["Util"]
       43 GETTABLEKS                       R7 R7 K16 ["find"]
       45 CALL                             R6 1 1
       46 NEWTABLE                         R7 4 0
       48 MOVE                             R8 R4
