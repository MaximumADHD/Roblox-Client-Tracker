...
PROTO_25:
       ...
       12 LOADK                            R4 K6 ["Removing explorer node %* from parent (presumably %*), but it's not inside of its children array"]
       13 GETTABLEKS                       R6 R1 K7 ["datum"]
       15 GETTABLEKS                       R6 R6 K8 ["id"]
       17 GETTABLEKS                       R7 R1 K7 ["datum"]
       19 GETTABLEKS                       R7 R7 K9 ["parentId"]
       21 NAMECALL                         R4 R4 K10 ["format"]
       23 CALL                             R4 3 1
       24 CALL                             R3 1 0
       25 GETIMPORT                        R3 K12 [table.remove]
       27 GETTABLEKS                       R4 R0 K0 ["array"]
       29 MOVE                             R5 R2
       30 CALL                             R3 2 0
       31 RETURN                           R0 0
       32 GETTABLEKS                       R4 R0 K13 ["tree"]
       34 JUMPIFNOTEQKNIL                  R4 ; [+2]
       36 LOADB                            R3 0 +1
       37 LOADB                            R3 1
       38 FASTCALL2K                       ASSERT R3 K14 ; [+4]
       40 LOADK                            R4 K14 ["Removing explorer node from parent, but it has neither an array nor a tree"]
       41 GETIMPORT                        R2 K16 [assert]
       43 CALL                             R2 2 0
       44 GETTABLEKS                       R3 R0 K13 ["tree"]
       46 GETTABLEKS                       R4 R1 K17 ["childNodeLeft"]
       48 JUMPIFNOT                        R4 ; [+19]
       49 GETTABLEKS                       R4 R1 K18 ["childNodeRight"]
       51 JUMPIFNOT                        R4 ; [+16]
       52 GETTABLEKS                       R5 R1 K18 ["childNodeRight"]
       54 GETTABLEKS                       R6 R5 K17 ["childNodeLeft"]
       56 JUMPIFNOT                        R6 ; [+3]
       57 GETTABLEKS                       R5 R5 K17 ["childNodeLeft"]
       59 JUMPBACK                         ; [-6]
       60 MOVE                             R4 R5
       61 GETUPVAL                         R5 0
       62 MOVE                             R6 R1
       ...
       71 CALL                             R4 2 1
       72 MOVE                             R2 R4
       73 SETTABLEKS                       R2 R0 K13 ["tree"]
       75 LOADNIL                          R2
       76 SETTABLEKS                       R2 R1 K19 ["childNodeColor"]
       78 LOADNIL                          R2
       79 SETTABLEKS                       R2 R1 K20 ["childNodeTreeCount"]
       81 LOADNIL                          R2
       82 SETTABLEKS                       R2 R1 K17 ["childNodeLeft"]
       84 LOADNIL                          R2
       85 SETTABLEKS                       R2 R1 K18 ["childNodeRight"]
       87 LOADNIL                          R2
       88 SETTABLEKS                       R2 R1 K21 ["childNodeParent"]
       90 GETTABLEKS                       R2 R0 K13 ["tree"]
       92 JUMPIF                           R2 ; [+4]
       93 NEWTABLE                         R2 0 0
       95 SETTABLEKS                       R2 R0 K0 ["array"]
       97 RETURN                           R0 0
...
PROTO_32:
       ...
       18 LOADK                            R3 K4 ["Invalid direction %*"]
       19 MOVE                             R5 R1
...
PROTO_43:
       ...
       16 JUMPIFEQ                         R3 R6 ; [+17]
       18 LOADK                            R5 K4 [" (Bad parent %*)"]
       19 GETTABLEKS                       R8 R0 K3 ["childNodeParent"]
       21 JUMPIFNOT                        R8 ; [+7]
       22 GETTABLEKS                       R7 R0 K3 ["childNodeParent"]
       24 GETTABLEKS                       R7 R7 K0 ["datum"]
       26 GETTABLEKS                       R7 R7 K1 ["name"]
       28 JUMP                             ; [+1]
       29 LOADK                            R7 K5 ["nil"]
       ...
       33 JUMP                             ; [+1]
       34 LOADK                            R5 K7 [""]
       35 GETTABLEKS                       R7 R0 K8 ["childNodeColor"]
       37 JUMPIFNOTEQKB                    R7 FALSE ; [+3]
       39 LOADK                            R6 K9 ["b"]
       40 JUMP                             ; [+1]
       41 LOADK                            R6 K10 ["r"]
       42 MOVE                             R7 R4
       43 LOADK                            R8 K11 ["%*%* [%* %* (%*)]%* %*"]
       44 MOVE                             R10 R1
       45 GETTABLEKS                       R11 R0 K0 ["datum"]
       47 GETTABLEKS                       R11 R11 K1 ["name"]
       49 MOVE                             R12 R6
       50 GETTABLEKS                       R13 R0 K12 ["childNodeTreeCount"]
       52 GETUPVAL                         R14 0
       53 MOVE                             R15 R0
       54 CALL                             R14 1 1
       55 MOVE                             R15 R5
       56 GETTABLEKS                       R16 R0 K0 ["datum"]
       58 GETTABLEKS                       R16 R16 K13 ["id"]
       60 NAMECALL                         R8 R8 K6 ["format"]
       62 CALL                             R8 8 1
       63 CALL                             R7 1 0
       64 GETTABLEKS                       R7 R0 K14 ["childNodeLeft"]
       66 JUMPIF                           R7 ; [+3]
       67 GETTABLEKS                       R7 R0 K15 ["childNodeRight"]
       69 JUMPIFNOT                        R7 ; [+38]
       70 GETTABLEKS                       R7 R0 K14 ["childNodeLeft"]
       72 JUMPIFNOT                        R7 ; [+11]
       73 GETUPVAL                         R7 1
       74 GETTABLEKS                       R8 R0 K14 ["childNodeLeft"]
       76 MOVE                             R10 R1
       77 LOADK                            R11 K16 ["| "]
       ...
       84 MOVE                             R7 R4
       85 MOVE                             R9 R1
       86 LOADK                            R10 K17 ["| nil"]
       87 CONCAT                           R8 R9 R10
       88 CALL                             R7 1 0
       89 GETTABLEKS                       R7 R0 K15 ["childNodeRight"]
       91 JUMPIFNOT                        R7 ; [+11]
       92 GETUPVAL                         R7 1
       93 GETTABLEKS                       R8 R0 K15 ["childNodeRight"]
       95 MOVE                             R10 R1
       96 LOADK                            R11 K16 ["| "]
...
PROTO_45:
       ...
       28 JUMPIFNOT                        R3 ; [+30]
       29 MOVE                             R3 R2
       30 LOADK                            R4 K8 ["[Backed by array] [%*]"]
       31 GETTABLEKS                       R6 R0 K9 ["treeDescendantCount"]
       33 NAMECALL                         R4 R4 K10 ["format"]
       35 CALL                             R4 2 1
       36 CALL                             R3 1 0
       37 GETTABLEKS                       R3 R0 K3 ["array"]
       39 LOADNIL                          R4
       40 LOADNIL                          R5
       41 FORGPREP                         R3
       42 MOVE                             R8 R2
       43 LOADK                            R9 K11 ["| %*: %* [%*]"]
       44 MOVE                             R11 R6
       45 GETTABLEKS                       R12 R7 K12 ["datum"]
       47 GETTABLEKS                       R12 R12 K13 ["name"]
       49 GETUPVAL                         R13 0
       50 MOVE                             R14 R7
       51 CALL                             R13 1 1
       52 NAMECALL                         R9 R9 K10 ["format"]
       54 CALL                             R9 4 1
       55 CALL                             R8 1 0
       56 FORGLOOP                         R3 2 ; [-15]
       58 RETURN                           R0 0
       59 GETTABLEKS                       R3 R0 K4 ["tree"]
       61 JUMPIFNOT                        R3 ; [+18]
       62 MOVE                             R3 R2
       63 LOADK                            R4 K14 ["[Backed by tree] [%*]"]
       64 GETTABLEKS                       R6 R0 K9 ["treeDescendantCount"]
       66 NAMECALL                         R4 R4 K10 ["format"]
       68 CALL                             R4 2 1
       69 CALL                             R3 1 0
       70 GETUPVAL                         R3 1
       71 GETTABLEKS                       R4 R0 K4 ["tree"]
       73 LOADK                            R5 K15 [""]
       74 NEWTABLE                         R6 0 0
       76 LOADNIL                          R7
       77 MOVE                             R8 R2
       78 CALL                             R3 5 0
       79 RETURN                           R0 0
       80 GETTABLEKS                       R5 R0 K9 ["treeDescendantCount"]
       82 JUMPIFEQKN                       R5 K16 [1] ; [+2]
       84 LOADB                            R4 0 +1
       85 LOADB                            R4 1
       86 FASTCALL2K                       ASSERT R4 K17 ; [+4]
       88 LOADK                            R5 K17 ["Not backed by anything, but has descendant count"]
       89 GETIMPORT                        R3 K7 [assert]
       91 CALL                             R3 2 0
       92 MOVE                             R3 R2
       93 LOADK                            R4 K18 ["[Not backed by anything] [1]"]
       94 CALL                             R3 1 0
       95 RETURN                           R0 0
