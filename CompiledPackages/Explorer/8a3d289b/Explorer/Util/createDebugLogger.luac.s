PROTO_0:
        ...
        9 CALL                             R1 1 1
       10 JUMPIFNOTEQKS                    R1 K2 ["string"] ; [+15]
       12 GETIMPORT                        R1 K4 [print]
       14 LOADK                            R2 K5 ["[%*] %*"]
       15 GETUPVAL                         R4 1
       16 GETIMPORT                        R5 K7 [string.format]
       18 MOVE                             R6 R0
       19 GETVARARGS                       R7 -1
       20 CALL                             R5 -1 1
       ...
       24 CALL                             R1 1 0
       25 RETURN                           R0 0
       26 GETIMPORT                        R1 K4 [print]
       28 LOADK                            R2 K8 ["[%*]"]
       29 GETUPVAL                         R4 1
       30 NAMECALL                         R2 R2 K6 ["format"]
       32 CALL                             R2 2 1
       33 MOVE                             R3 R0
       34 GETVARARGS                       R4 -1
       35 CALL                             R3 -1 -1
...
MAIN:
       ...
       11 GETTABLEKS                       R2 R2 K7 ["getFFlagDebugNewExplorerLogging"]
       13 CALL                             R1 1 1
