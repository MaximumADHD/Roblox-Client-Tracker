...
PROTO_4:
        ...
        6 LOADK                            R4 K2 ["Invalid field requested: %*"]
        7 MOVE                             R6 R2
        8 NAMECALL                         R4 R4 K3 ["format"]
       10 CALL                             R4 2 1
       11 CALL                             R3 1 0
       12 GETTABLEKS                       R3 R2 K4 ["validateArgs"]
       14 MOVE                             R4 R1
       15 CALL                             R3 1 2
       16 JUMPIF                           R3 ; [+9]
       17 GETIMPORT                        R5 K1 [error]
       19 LOADK                            R6 K5 ["Invalid arguments sent to %*: %*"]
       20 MOVE                             R8 R2
       21 MOVE                             R9 R4
       ...
       26 LOADNIL                          R5
       27 LOADNIL                          R6
       28 GETTABLEKS                       R7 R2 K6 ["init"]
       30 JUMPIFNOT                        R7 ; [+7]
       31 GETTABLEKS                       R7 R2 K6 ["init"]
       33 GETUPVAL                         R8 1
       34 MOVE                             R9 R1
       35 CALL                             R7 2 2
       36 MOVE                             R5 R7
       37 MOVE                             R6 R8
       38 GETUPVAL                         R7 2
       39 GETTABLEKS                       R8 R2 K7 ["key"]
       41 CALL                             R7 1 1
       42 DUPTABLE                         R8 K12 [{"field", "state", "destructor", "instances"}]
       43 SETTABLEKS                       R2 R8 K8 ["field"]
       45 SETTABLEKS                       R5 R8 K9 ["state"]
       47 SETTABLEKS                       R6 R8 K10 ["destructor"]
       49 NEWTABLE                         R9 0 0
       51 SETTABLEKS                       R9 R8 K11 ["instances"]
       53 NEWTABLE                         R9 0 0
       55 GETUPVAL                         R10 3
       56 GETTABLEKS                       R10 R10 K13 ["instancesInView"]
       58 LOADNIL                          R11
       59 LOADNIL                          R12
       60 FORGPREP                         R10
       61 GETUPVAL                         R15 3
       62 GETTABLEKS                       R15 R15 K14 ["getInstanceId"]
       64 MOVE                             R16 R13
       65 CALL                             R15 1 1
       66 GETUPVAL                         R16 4
       67 MOVE                             R17 R13
       ...
       69 MOVE                             R19 R8
       70 CALL                             R16 3 1
       71 SETTABLE                         R16 R9 R15
       72 FORGLOOP                         R10 1 ; [-12]
       74 GETUPVAL                         R10 3
       75 GETTABLEKS                       R10 R10 K15 ["trackingFields"]
       77 SETTABLE                         R8 R10 R7
       78 MOVE                             R10 R7
       79 MOVE                             R11 R9
       80 RETURN                           R10 2
...
PROTO_7:
       ...
       40 JUMPIFNOTEQKNIL                  R5 ; [+13]
       42 GETIMPORT                        R6 K9 [error]
       44 LOADK                            R7 K10 ["Host performed action \"%*\" on %*, which doesn't exist"]
       45 MOVE                             R9 R2
       46 GETTABLEKS                       R10 R3 K6 ["field"]
       48 GETTABLEKS                       R10 R10 K11 ["key"]
       50 NAMECALL                         R7 R7 K12 ["format"]
       52 CALL                             R7 3 1
       53 CALL                             R6 1 0
       54 MOVE                             R6 R5
       55 MOVE                             R7 R4
       56 GETTABLEKS                       R8 R3 K13 ["state"]
       58 GETVARARGS                       R9 -1
       59 CALL                             R6 -1 0
       60 RETURN                           R0 0
