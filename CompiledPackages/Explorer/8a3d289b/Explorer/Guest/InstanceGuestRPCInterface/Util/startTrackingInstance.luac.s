PROTO_0:
       ...
       14 JUMPIFNOT                        R2 ; [+9]
       15 GETUPVAL                         R3 2
       16 GETTABLEKS                       R3 R3 K3 ["isServiceVisible"]
       18 JUMPIFNOT                        R3 ; [+5]
       19 MOVE                             R4 R3
       20 MOVE                             R5 R0
       21 CALL                             R4 1 1
       ...
       24 JUMPIF                           R1 ; [+10]
       25 GETUPVAL                         R3 2
       26 GETTABLEKS                       R3 R3 K4 ["hostRpcInterface"]
       28 GETTABLEKS                       R3 R3 K5 ["instanceReplaced"]
       30 GETUPVAL                         R4 3
       31 GETUPVAL                         R5 2
       32 GETUPVAL                         R6 0
       33 CALL                             R4 2 -1
       34 CALL                             R3 -1 0
       35 GETUPVAL                         R4 2
       36 GETTABLEKS                       R4 R4 K6 ["expandedInstances"]
       38 GETUPVAL                         R5 0
       39 GETTABLE                         R3 R4 R5
       40 JUMPIFNOT                        R3 ; [+5]
       41 GETUPVAL                         R4 2
       42 GETTABLEKS                       R4 R4 K7 ["watchingInstanceConnections"]
       ...
       59 CALL                             R3 2 1
       60 GETUPVAL                         R4 2
       61 GETTABLEKS                       R4 R4 K4 ["hostRpcInterface"]
       63 GETTABLEKS                       R4 R4 K9 ["instanceAdded"]
       65 MOVE                             R5 R3
       66 CALL                             R4 1 0
       67 RETURN                           R0 0
...
PROTO_1:
        ...
        2 JUMPIFNOT                        R1 ; [+14]
        3 GETUPVAL                         R1 1
        4 GETTABLEKS                       R1 R1 K0 ["streamingInterface"]
        6 JUMPIFEQKNIL                     R1 ; [+10]
        8 GETUPVAL                         R1 1
        9 GETTABLEKS                       R1 R1 K0 ["streamingInterface"]
       11 GETTABLEKS                       R1 R1 K1 ["isInstanceStreamedOut"]
       13 MOVE                             R2 R0
       14 CALL                             R1 1 1
       15 JUMPIFNOT                        R1 ; [+1]
       16 RETURN                           R0 0
       ...
       27 SETUPVAL                         R1 2
       28 GETUPVAL                         R2 1
       29 GETTABLEKS                       R2 R2 K3 ["expandedInstances"]
       31 GETUPVAL                         R3 4
       ...
       38 GETUPVAL                         R2 1
       39 GETTABLEKS                       R2 R2 K5 ["watchingInstanceConnections"]
       ...
       48 JUMPIF                           R1 ; [+10]
       49 GETUPVAL                         R1 1
       50 GETTABLEKS                       R1 R1 K6 ["hostRpcInterface"]
       52 GETTABLEKS                       R1 R1 K7 ["instanceReplaced"]
       54 GETUPVAL                         R2 5
       55 GETUPVAL                         R3 1
       56 GETUPVAL                         R4 4
       57 CALL                             R2 2 -1
...
PROTO_2:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["hostRpcInterface"]
        3 GETTABLEKS                       R0 R0 K1 ["instanceReplaced"]
        5 GETUPVAL                         R1 1
        6 GETUPVAL                         R2 0
        7 GETUPVAL                         R3 2
        8 CALL                             R1 2 -1
...
PROTO_3:
        0 LOADK                            R0 K0 ["Parent of %* changed to be at %*"]
        1 GETUPVAL                         R2 0
        2 GETTABLEKS                       R2 R2 K1 ["getInstanceId"]
        4 GETUPVAL                         R3 1
        5 CALL                             R2 1 1
        6 GETUPVAL                         R3 1
        7 NAMECALL                         R3 R3 K2 ["GetFullName"]
        9 CALL                             R3 1 1
...
PROTO_4:
        0 LOADK                            R0 K0 ["Parent changed to be at %*"]
        1 GETUPVAL                         R2 0
        2 NAMECALL                         R2 R2 K1 ["GetFullName"]
        4 CALL                             R2 1 1
...
PROTO_5:
       ...
       24 CALL                             R1 1 0
       25 GETUPVAL                         R1 1
       26 GETTABLEKS                       R1 R1 K2 ["Parent"]
       28 SETUPVAL                         R1 3
       29 SETUPVAL                         R0 4
       30 GETUPVAL                         R1 2
       31 GETTABLEKS                       R1 R1 K3 ["streamingInterface"]
       33 JUMPIFEQKNIL                     R1 ; [+21]
       35 GETUPVAL                         R1 2
       36 GETTABLEKS                       R1 R1 K3 ["streamingInterface"]
       38 GETTABLEKS                       R1 R1 K4 ["isInstanceStreamedOut"]
       40 GETUPVAL                         R2 1
       41 CALL                             R1 1 1
       42 JUMPIFNOT                        R1 ; [+12]
       43 GETUPVAL                         R1 2
       44 GETTABLEKS                       R1 R1 K5 ["hostRpcInterface"]
       46 GETTABLEKS                       R1 R1 K6 ["instanceStreamedOut"]
       48 GETUPVAL                         R2 2
       49 GETTABLEKS                       R2 R2 K7 ["getInstanceId"]
       51 GETUPVAL                         R3 1
       52 CALL                             R2 1 -1
       53 CALL                             R1 -1 0
       54 RETURN                           R0 0
       55 GETUPVAL                         R1 2
       56 GETTABLEKS                       R1 R1 K5 ["hostRpcInterface"]
       58 GETTABLEKS                       R1 R1 K8 ["instanceReplaced"]
       60 GETUPVAL                         R2 6
       61 GETUPVAL                         R3 2
       62 GETUPVAL                         R4 1
       63 CALL                             R2 2 -1
       ...
       69 CALL                             R0 1 0
       70 GETUPVAL                         R0 1
       71 GETTABLEKS                       R0 R0 K2 ["Parent"]
       73 SETUPVAL                         R0 3
       74 GETUPVAL                         R0 2
       75 GETTABLEKS                       R0 R0 K5 ["hostRpcInterface"]
       77 GETTABLEKS                       R0 R0 K8 ["instanceReplaced"]
       79 GETUPVAL                         R1 6
       80 GETUPVAL                         R2 2
       81 GETUPVAL                         R3 1
       82 CALL                             R1 2 -1
...
MAIN:
       ...
       26 GETTABLEKS                       R4 R4 K11 ["InstanceGuestRPCInterface"]
       28 GETTABLEKS                       R4 R4 K13 ["Util"]
       30 GETTABLEKS                       R4 R4 K14 ["createDatumFromInstance"]
       32 CALL                             R3 1 1
       33 GETIMPORT                        R4 K9 [require]
       35 GETTABLEKS                       R5 R1 K13 ["Util"]
       37 GETTABLEKS                       R5 R5 K15 ["createDebugLogger"]
       39 CALL                             R4 1 1
       40 GETIMPORT                        R5 K9 [require]
       42 GETTABLEKS                       R6 R1 K16 ["Flags"]
       44 GETTABLEKS                       R6 R6 K17 ["getFFlagExplorerStreaming"]
       46 CALL                             R5 1 1
       47 MOVE                             R6 R4
