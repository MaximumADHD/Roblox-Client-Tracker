...
PROTO_6:
       ...
       11 JUMPIFNOTEQKNIL                  R8 ; [+13]
       13 LOADK                            R11 K0 ["%* = NIL"]
       14 MOVE                             R13 R7
       15 NAMECALL                         R11 R11 K1 ["format"]
       17 CALL                             R11 2 1
       ...
       25 LOADK                            R11 K5 ["%* = %*"]
       26 MOVE                             R13 R7
       27 NAMECALL                         R14 R8 K6 ["GetFullName"]
       29 CALL                             R14 1 1
       30 NAMECALL                         R11 R11 K1 ["format"]
       32 CALL                             R11 3 1
       ...
       38 CALL                             R9 2 0
       39 FORNLOOP                         R4
       40 GETIMPORT                        R4 K8 [table.concat]
       42 MOVE                             R5 R3
       43 LOADK                            R6 K9 ["   "]
       44 CALL                             R4 2 -1
       45 RETURN                           R4 -1
...
PROTO_8:
      ...
      133 LOADK                            R5 K49 ["Could not find an instance by ID (%*). If you see this, please file a bug report, we are having a hard time tracking this one down! =)"]
      134 MOVE                             R7 R2
      135 NAMECALL                         R5 R5 K50 ["format"]
      137 CALL                             R5 2 1
      138 CALL                             R4 1 0
      139 RETURN                           R0 0
