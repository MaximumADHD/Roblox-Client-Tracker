PROTO_0:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R2 R2 K0 ["getIndexOfInstanceId"]
        3 MOVE                             R3 R1
        4 CALL                             R2 1 1
...
PROTO_1:
        ...
        3 GETUPVAL                         R2 1
        4 GETTABLEKS                       R2 R2 K1 ["children"]
        6 MOVE                             R3 R0
        7 CALL                             R1 2 1
       ...
       17 CALL                             R2 2 0
       18 GETTABLEKS                       R2 R1 K5 ["datum"]
       20 GETTABLEKS                       R2 R2 K6 ["id"]
       22 GETUPVAL                         R4 2
       23 GETTABLEKS                       R4 R4 K7 ["selectedVisibleIds"]
       ...
       38 CALL                             R3 0 1
       39 JUMPIFNOT                        R3 ; [+7]
       40 GETTABLEKS                       R3 R1 K5 ["datum"]
       42 GETTABLEKS                       R3 R3 K8 ["isGhost"]
       44 JUMPIFNOT                        R3 ; [+2]
       45 LOADB                            R3 0
       46 RETURN                           R3 1
       47 GETUPVAL                         R3 6
       48 JUMPIFNOT                        R3 ; [+20]
       49 GETUPVAL                         R4 2
       50 GETTABLEKS                       R4 R4 K9 ["selectedVisibleIdsArray"]
       52 FASTCALL2                        TABLE_INSERT R4 R2 ; [+4]
       54 MOVE                             R5 R2
       55 GETIMPORT                        R3 K12 [table.insert]
       57 CALL                             R3 2 0
       58 GETUPVAL                         R3 7
       59 GETTABLEKS                       R3 R3 K13 ["selectIds"]
       61 GETIMPORT                        R4 K15 [table.freeze]
       63 GETUPVAL                         R5 2
       64 GETTABLEKS                       R5 R5 K9 ["selectedVisibleIdsArray"]
       66 CALL                             R4 1 -1
       67 CALL                             R3 -1 0
       68 JUMP                             ; [+12]
       69 GETUPVAL                         R3 7
       70 GETTABLEKS                       R3 R3 K13 ["selectIds"]
...
PROTO_2:
        ...
        2 RETURN                           R0 0
        3 GETUPVAL                         R3 0
        4 GETTABLEKS                       R3 R3 K1 ["focusedRootObservable"]
        6 GETTABLEKS                       R3 R3 K2 ["get"]
        8 CALL                             R3 0 1
       ...
       43 GETUPVAL                         R7 0
       44 GETTABLEKS                       R7 R7 K14 ["selectedIdsArrayObservable"]
       46 GETTABLEKS                       R7 R7 K2 ["get"]
       48 CALL                             R7 0 1
       49 GETUPVAL                         R8 2
       50 MOVE                             R9 R7
...
MAIN:
       ...
       30 GETTABLEKS                       R5 R5 K12 ["getFFlagExplorerSkipGhosts"]
       32 CALL                             R4 1 1
       33 GETIMPORT                        R5 K5 [require]
       35 GETTABLEKS                       R6 R0 K11 ["Flags"]
       37 GETTABLEKS                       R6 R6 K13 ["getFFlagExplorerStreaming"]
       39 CALL                             R5 1 1
       40 GETIMPORT                        R6 K5 [require]
       42 GETTABLEKS                       R7 R0 K6 ["Util"]
       44 GETTABLEKS                       R7 R7 K14 ["getItemCount"]
       46 CALL                             R6 1 1
       47 GETIMPORT                        R7 K5 [require]
       49 GETTABLEKS                       R8 R0 K6 ["Util"]
       51 GETTABLEKS                       R8 R8 K15 ["reduceList"]
       53 CALL                             R7 1 1
