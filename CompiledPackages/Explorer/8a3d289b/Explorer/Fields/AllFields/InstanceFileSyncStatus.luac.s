...
PROTO_8:
       ...
       11 LOADB                            R3 0 +1
       12 LOADB                            R3 1
       13 GETTABLEKS                       R4 R0 K3 ["status"]
       15 GETIMPORT                        R5 K7 [Enum.InstanceFileSyncStatus.SyncedAsRoot]
       17 JUMPIFNOTEQ                      R4 R5 ; [+8]
       19 GETUPVAL                         R4 0
       20 GETTABLEKS                       R4 R4 K8 ["instanceFileSyncStatus"]
       22 LOADK                            R5 K9 ["Syncing"]
       23 MOVE                             R6 R1
       24 CALL                             R4 2 -1
       25 RETURN                           R4 -1
       26 GETTABLEKS                       R4 R0 K3 ["status"]
       28 GETIMPORT                        R5 K11 [Enum.InstanceFileSyncStatus.SyncedAsDescendant]
       30 JUMPIFNOTEQ                      R4 R5 ; [+8]
       32 GETUPVAL                         R4 0
       33 GETTABLEKS                       R4 R4 K8 ["instanceFileSyncStatus"]
       35 LOADK                            R5 K12 ["Descendant"]
       36 MOVE                             R6 R1
       37 CALL                             R4 2 -1
       38 RETURN                           R4 -1
       39 GETTABLEKS                       R4 R0 K3 ["status"]
       41 GETIMPORT                        R5 K14 [Enum.InstanceFileSyncStatus.Errored]
       43 JUMPIFNOTEQ                      R4 R5 ; [+11]
       45 GETUPVAL                         R4 0
       46 GETTABLEKS                       R4 R4 K8 ["instanceFileSyncStatus"]
       48 JUMPIFNOT                        R3 ; [+2]
       49 LOADK                            R5 K15 ["Errored_Highlighted"]
       50 JUMP                             ; [+1]
       51 LOADK                            R5 K13 ["Errored"]
       52 MOVE                             R6 R1
       53 CALL                             R4 2 -1
       54 RETURN                           R4 -1
       55 GETUPVAL                         R4 1
       56 CALL                             R4 0 1
       57 JUMPIFNOT                        R4 ; [+13]
       58 GETTABLEKS                       R4 R0 K3 ["status"]
       60 GETIMPORT                        R5 K17 [Enum.InstanceFileSyncStatus.AncestorErrored]
       62 JUMPIFNOTEQ                      R4 R5 ; [+8]
       64 GETUPVAL                         R4 0
       65 GETTABLEKS                       R4 R4 K8 ["instanceFileSyncStatus"]
       67 LOADK                            R5 K16 ["AncestorErrored"]
       68 MOVE                             R6 R1
       69 CALL                             R4 2 -1
       70 RETURN                           R4 -1
       71 LOADK                            R4 K0 [""]
...
PROTO_9:
       ...
       68 MOVE                             R6 R2
       69 MOVE                             R7 R3
       70 NAMECALL                         R4 R4 K22 ["format"]
       72 CALL                             R4 3 1
       73 RETURN                           R4 1
       74 LOADK                            R4 K9 ["LiveSync"]
       75 LOADK                            R5 K23 ["ScriptSyncing"]
       76 NAMECALL                         R2 R0 K10 ["getText"]
       78 CALL                             R2 3 -1
       79 RETURN                           R2 -1
...
PROTO_13:
       ...
       91 GETTABLEKS                       R8 R0 K6 ["valueBinding"]
       93 DUPCLOSURE                       R10 K28 [PROTO_12]
       94 NAMECALL                         R8 R8 K26 ["map"]
       96 CALL                             R8 2 1
       97 SETTABLEKS                       R8 R7 K29 ["ImageTransparency"]
       99 CALL                             R5 2 -1
      100 RETURN                           R5 -1
...
PROTO_22:
        ...
        7 SETTABLEKS                       R2 R5 K2 ["selectionStateBinding"]
        9 CALL                             R3 2 -1
       10 RETURN                           R3 -1
...
MAIN:
      ...
      131 CAPTURE                          VAL R19
      132 DUPTABLE                         R21 K53 [{["key"] = "instanceFileSyncStatus", ["icon"] = "", ["init"], ["watch"], ["validateArgs"], ["render"], ["permanent"] = True}]
      133 SETTABLEKS                       R20 R21 K47 ["init"]
      135 SETTABLEKS                       R15 R21 K48 ["watch"]
      137 DUPCLOSURE                       R22 K54 [PROTO_21]
      138 SETTABLEKS                       R22 R21 K49 ["validateArgs"]
      140 DUPCLOSURE                       R22 K55 [PROTO_22]
      141 CAPTURE                          VAL R9
      142 CAPTURE                          VAL R18
      143 SETTABLEKS                       R22 R21 K50 ["render"]
      145 RETURN                           R21 1
