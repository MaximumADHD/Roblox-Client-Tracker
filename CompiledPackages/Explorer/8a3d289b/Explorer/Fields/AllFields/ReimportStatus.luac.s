...
PROTO_3:
       ...
       67 LOADK                            R14 K29 [0.3]
       68 SETTABLEKS                       R14 R13 K30 ["ImageTransparency"]
       70 GETIMPORT                        R14 K14 [UDim2.fromScale]
       72 LOADN                            R15 1
       73 LOADN                            R16 1
       74 CALL                             R14 2 1
       75 SETTABLEKS                       R14 R13 K5 ["Size"]
       77 GETIMPORT                        R14 K14 [UDim2.fromScale]
       79 LOADN                            R15 0
       80 LOADN                            R16 0
       81 CALL                             R14 2 1
       82 SETTABLEKS                       R14 R13 K31 ["Position"]
       84 GETUPVAL                         R14 1
       85 GETTABLEKS                       R14 R14 K19 ["Tag"]
       87 LOADK                            R15 K32 ["Explorer-Content-Muted"]
       88 SETTABLE                         R15 R13 R14
       89 CALL                             R11 2 1
       90 SETTABLEKS                       R11 R10 K21 ["Shadow"]
       92 GETUPVAL                         R11 3
       93 GETUPVAL                         R12 5
       94 DUPTABLE                         R13 K36 [{["ZIndex"], ["Size"], ["imageTags"] = "Explorer-Content-Standard", ["progress"]}]
       95 MOVE                             R14 R1
       96 CALL                             R14 0 1
       97 SETTABLEKS                       R14 R13 K25 ["ZIndex"]
       99 GETIMPORT                        R14 K14 [UDim2.fromScale]
      101 LOADN                            R15 1
      102 LOADN                            R16 1
      103 CALL                             R14 2 1
      104 SETTABLEKS                       R14 R13 K5 ["Size"]
      106 GETTABLEKS                       R14 R0 K15 ["valueBinding"]
      108 DUPCLOSURE                       R16 K37 [PROTO_1]
      109 NAMECALL                         R14 R14 K17 ["map"]
      111 CALL                             R14 2 1
      112 SETTABLEKS                       R14 R13 K35 ["progress"]
      114 CALL                             R11 2 1
      115 SETTABLEKS                       R11 R10 K22 ["Spinner"]
      117 CALL                             R7 3 1
      118 SETTABLEKS                       R7 R6 K10 ["Progress"]
      120 GETUPVAL                         R7 3
      121 LOADK                            R8 K24 ["ImageLabel"]
      122 NEWTABLE                         R9 8 0
      124 GETIMPORT                        R10 K9 [UDim2.fromOffset]
      126 LOADN                            R11 16
      127 LOADN                            R12 16
      128 CALL                             R10 2 1
      129 SETTABLEKS                       R10 R9 K5 ["Size"]
      131 LOADN                            R10 1
      132 SETTABLEKS                       R10 R9 K3 ["BackgroundTransparency"]
      134 GETUPVAL                         R10 4
      135 GETTABLEKS                       R10 R10 K38 ["reimportFileWatch"]
      137 GETTABLEKS                       R11 R2 K27 ["theme"]
      139 CALL                             R10 1 1
      140 SETTABLEKS                       R10 R9 K28 ["Image"]
      142 GETTABLEKS                       R10 R0 K15 ["valueBinding"]
      144 DUPCLOSURE                       R12 K39 [PROTO_2]
      145 NAMECALL                         R10 R10 K17 ["map"]
      147 CALL                             R10 2 1
      148 SETTABLEKS                       R10 R9 K18 ["Visible"]
      150 GETUPVAL                         R10 1
      151 GETTABLEKS                       R10 R10 K19 ["Tag"]
      153 LOADK                            R11 K40 ["data-testid=ReimportFileWatch"]
      154 SETTABLE                         R11 R9 R10
      155 CALL                             R7 2 1
      156 SETTABLEKS                       R7 R6 K11 ["Watch"]
      158 CALL                             R3 3 -1
      159 RETURN                           R3 -1
...
MAIN:
       ...
       73 GETTABLEKS                       R11 R1 K23 ["Flags"]
       75 GETTABLEKS                       R11 R11 K24 ["getFFlagReimportFileWatcher"]
       77 CALL                             R10 1 1
       78 GETTABLEKS                       R11 R4 K16 ["Util"]
       80 GETTABLEKS                       R11 R11 K25 ["CrossPluginCommunication"]
       82 GETTABLEKS                       R12 R11 K26 ["new"]
       84 GETTABLEKS                       R13 R7 K27 ["REIMPORT"]
       86 GETTABLEKS                       R13 R13 K28 ["CPC_ID"]
       88 CALL                             R12 1 1
       89 GETTABLEKS                       R13 R6 K29 ["createElement"]
       91 DUPCLOSURE                       R14 K30 [PROTO_3]
       92 CAPTURE                          VAL R9
       93 CAPTURE                          VAL R6
       94 CAPTURE                          VAL R8
       95 CAPTURE                          VAL R13
       96 CAPTURE                          VAL R5
       97 CAPTURE                          VAL R2
       98 DUPTABLE                         R15 K40 [{["key"] = "reimportStatus", ["icon"] = "", ["watch"], ["render"], ["validateArgs"], ["permanent"] = True}]
       99 DUPCLOSURE                       R16 K41 [PROTO_9]
      100 CAPTURE                          VAL R10
      101 CAPTURE                          VAL R0
      102 CAPTURE                          VAL R12
      103 CAPTURE                          VAL R7
      104 SETTABLEKS                       R16 R15 K35 ["watch"]
      106 DUPCLOSURE                       R16 K42 [PROTO_10]
      107 CAPTURE                          VAL R13
      108 CAPTURE                          VAL R14
      109 SETTABLEKS                       R16 R15 K36 ["render"]
      111 DUPCLOSURE                       R16 K43 [PROTO_11]
      112 SETTABLEKS                       R16 R15 K37 ["validateArgs"]
      114 RETURN                           R15 1
