...
PROTO_3:
  ...
  LOADK R6 K10 ["%*.%* - ID of node with no parent didn't match: %* ~= %*"]
  MOVE R8 R3
  ...
  CALL R4 1 0
  LOADN R1 1
  GETTABLEKS R2 R0 K13 ["children"]
  JUMPIFNOT R2 [+13]
  GETUPVAL R3 2
  GETTABLEKS R2 R3 K14 ["iterate"]
  GETTABLEKS R3 R0 K13 ["children"]
  CALL R2 1 3
  FORGPREP R2
  GETUPVAL R7 3
  MOVE R8 R5
  ...
  LOADK R7 K15 ["%*.%* - tree descendant count didn't match: %* ~= %*"]
  MOVE R9 R4
  ...
  CALL R3 2 0
  GETUPVAL R3 5
  GETTABLEKS R4 R0 K17 ["uiState"]
  LOADK R6 K18 ["<%*>.uiState"]
  MOVE R8 R2
  NAMECALL R6 R6 K12 ["format"]
  CALL R6 2 1
  MOVE R5 R6
