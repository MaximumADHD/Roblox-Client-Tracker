...
PROTO_1:
  ...
  MOVE R4 R0
  GETUPVAL R7 4
  GETTABLEKS R6 R7 K7 ["field"]
  LOADB R5 0
  JUMPIFEQKNIL R0 [+7]
  GETTABLEKS R7 R6 K8 ["render"]
...
PROTO_6:
  ...
  GETUPVAL R9 1
  MOVE R10 R7
  LOADK R11 K0 ["viewing"]
  CALL R8 3 1
  JUMPIFNOTEQKNIL R8 [+2]
  LOADB R10 0 +1
  LOADB R10 1
  FASTCALL2K ASSERT R10 K1 [+4]
  LOADK R11 K1 ["Guest is viewing an instance we don't know about"]
  GETIMPORT R9 K3 [assert]
  CALL R9 2 0
  GETUPVAL R11 1
  GETTABLEKS R10 R11 K4 ["instancesInView"]
  GETTABLE R9 R10 R8
  JUMPIFNOT R9 [+5]
  GETUPVAL R9 2
  LOADK R10 K5 ["%* is being viewed twice"]
  MOVE R11 R8
  CALL R9 2 0
  JUMP [+57]
  GETUPVAL R10 1
  ...
  LOADB R10 1
  SETTABLE R10 R9 R8
  GETIMPORT R9 K7 [next]
  GETUPVAL R11 1
  GETTABLEKS R10 R11 K8 ["trackingFields"]
  CALL R9 1 1
  JUMPIFEQKNIL R9 [+45]
  NEWTABLE R9 0 0
  GETUPVAL R13 1
  GETTABLEKS R10 R13 K8 ["trackingFields"]
  LOADNIL R11
  LOADNIL R12
  FORGPREP R10
  ...
  CALL R16 0 1
  JUMPIFNOT R16 [+14]
  GETTABLEKS R17 R14 K10 ["field"]
  LOADB R16 0
  JUMPIFEQKNIL R15 [+7]
  GETTABLEKS R18 R17 K11 ["render"]
...
MAIN:
  ...
  GETTABLEKS R9 R10 K19 ["getFFlagExplorerFieldColumns"]
  CALL R8 1 1
  GETIMPORT R9 K5 [require]
  GETTABLEKS R13 R0 K9 ["Guest"]
  GETTABLEKS R12 R13 K10 ["InstanceGuestRPCInterface"]
  GETTABLEKS R11 R12 K15 ["Util"]
  GETTABLEKS R10 R11 K20 ["getInstanceById"]
  CALL R9 1 1
  GETIMPORT R10 K5 [require]
  GETTABLEKS R12 R0 K15 ["Util"]
  GETTABLEKS R11 R12 K21 ["onlyOnce"]
  CALL R10 1 1
  MOVE R11 R6
  LOADK R12 K22 ["createGuestFields"]
  CALL R11 1 1
