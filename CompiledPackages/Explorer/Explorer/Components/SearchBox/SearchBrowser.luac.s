...
PROTO_3:
  ...
  CALL R20 0 1
  JUMPIFNOT R20 [+2]
  LOADK R19 K35 [" Explorer-Content-Muted"]
  JUMP [+6]
  GETUPVAL R20 9
  CALL R20 0 1
  JUMPIFNOT R20 [+2]
  LOADK R19 K36 [" DEPRECATED_Explorer-Text-Size-14 Explorer-Content-Muted"]
  JUMP [+1]
  LOADK R19 K24 [""]
  CONCAT R17 R18 R19
  ...
  GETUPVAL R13 5
  GETUPVAL R14 10
  DUPTABLE R15 K40 [{"image", "layoutOrder", "tooltipText", "onActivated"}]
  GETUPVAL R17 11
  GETTABLEKS R16 R17 K41 ["standard"]
  LOADK R17 K42 ["findPrevious"]
  CALL R16 1 1
  ...
  SETTABLEKS R16 R15 K11 ["layoutOrder"]
  LOADK R18 K26 ["SearchBrowser"]
  LOADK R19 K43 ["SelectPreviousMatch"]
  NAMECALL R16 R1 K28 ["getText"]
  CALL R16 3 1
  SETTABLEKS R16 R15 K38 ["tooltipText"]
  SETTABLEKS R4 R15 K39 ["onActivated"]
  CALL R13 2 1
  ...
  SETTABLEKS R16 R15 K11 ["layoutOrder"]
  LOADK R18 K26 ["SearchBrowser"]
  LOADK R19 K45 ["SelectNextMatch"]
  NAMECALL R16 R1 K28 ["getText"]
  CALL R16 3 1
  SETTABLEKS R16 R15 K38 ["tooltipText"]
  SETTABLEKS R5 R15 K39 ["onActivated"]
  CALL R13 2 1
  ...
  SETTABLEKS R16 R15 K11 ["layoutOrder"]
  LOADK R18 K26 ["SearchBrowser"]
  LOADK R19 K47 ["SelectAllMatches"]
  NAMECALL R16 R1 K28 ["getText"]
  CALL R16 3 1
  SETTABLEKS R16 R15 K38 ["tooltipText"]
  GETTABLEKS R17 R0 K3 ["session"]
  GETTABLEKS R16 R17 K48 ["selectAllSearchedIds"]
  SETTABLEKS R16 R15 K39 ["onActivated"]
  CALL R13 2 1
...
MAIN:
  ...
  GETTABLEKS R12 R13 K21 ["localizeInt"]
  CALL R11 1 1
  GETIMPORT R12 K5 [require]
  GETTABLEKS R14 R0 K22 ["Hooks"]
  GETTABLEKS R13 R14 K23 ["useSelectionStepper"]
  CALL R12 1 1
