PROTO_0:
        ...
        3 FORGPREP                         R0
        4 GETUPVAL                         R5 1
        5 GETTABLEKS                       R5 R5 K0 ["getExplorerNodeById"]
        7 MOVE                             R6 R3
        8 CALL                             R5 1 1
        9 JUMPIFNOT                        R5 ; [+13]
       ...
       12 JUMPIFNOT                        R6 ; [+10]
       13 GETUPVAL                         R6 1
       14 GETTABLEKS                       R6 R6 K2 ["expandAsync"]
       16 GETTABLEKS                       R7 R5 K1 ["parent"]
       18 GETTABLEKS                       R7 R7 K3 ["datum"]
       20 GETTABLEKS                       R7 R7 K4 ["id"]
       22 CALL                             R6 1 0
       23 FORGLOOP                         R0 1 ; [-20]
       25 GETUPVAL                         R0 0
       26 LOADNIL                          R1
...
PROTO_2:
        ...
        3 DUPTABLE                         R1 K5 [{["uri"], ["shouldFocusExplorer"] = False, ["onActionActivated"]}]
        4 GETUPVAL                         R2 1
        5 GETTABLEKS                       R2 R2 K6 ["fromAction"]
        7 LOADK                            R3 K7 ["BuilderTools"]
        8 LOADK                            R4 K8 ["ZoomExtents"]
        9 CALL                             R2 2 1
       10 SETTABLEKS                       R2 R1 K1 ["uri"]
       12 NEWCLOSURE                       R2 P0
       13 CAPTURE                          UPVAL U2
       14 CAPTURE                          UPVAL U3
       15 SETTABLEKS                       R2 R1 K4 ["onActionActivated"]
       17 CALL                             R0 1 -1
       18 RETURN                           R0 -1
