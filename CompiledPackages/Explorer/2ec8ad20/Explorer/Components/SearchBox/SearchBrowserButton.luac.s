PROTO_0:
        0 GETUPVAL                         R3 0
        1 GETTABLEKS                       R3 R3 K0 ["onMouseEnter"]
        3 JUMPIFEQKNIL                     R3 ; [+8]
        5 GETUPVAL                         R3 0
        6 GETTABLEKS                       R3 R3 K0 ["onMouseEnter"]
        8 MOVE                             R4 R0
        9 MOVE                             R5 R1
       10 MOVE                             R6 R2
       11 CALL                             R3 3 0
       12 GETUPVAL                         R3 1
       13 GETTABLEKS                       R3 R3 K1 ["enable"]
       15 CALL                             R3 0 0
       16 RETURN                           R0 0

PROTO_1:
        0 GETUPVAL                         R3 0
        1 GETTABLEKS                       R3 R3 K0 ["onMouseLeave"]
        3 JUMPIFEQKNIL                     R3 ; [+8]
        5 GETUPVAL                         R3 0
        6 GETTABLEKS                       R3 R3 K0 ["onMouseLeave"]
        8 MOVE                             R4 R0
        9 MOVE                             R5 R1
       10 MOVE                             R6 R2
       11 CALL                             R3 3 0
       12 GETUPVAL                         R3 1
       13 GETTABLEKS                       R3 R3 K1 ["disable"]
       15 CALL                             R3 0 0
       16 RETURN                           R0 0
...
PROTO_2:
       ...
       16 CALL                             R2 2 1
       17 GETUPVAL                         R3 1
       18 GETTABLEKS                       R3 R3 K1 ["useCallback"]
       20 NEWCLOSURE                       R4 P1
       21 CAPTURE                          VAL R0
       22 CAPTURE                          VAL R1
       23 NEWTABLE                         R5 0 1
       ...
       71 GETUPVAL                         R8 1
       72 GETTABLEKS                       R8 R8 K19 ["Event"]
       74 GETTABLEKS                       R8 R8 K20 ["Activated"]
       76 GETTABLEKS                       R9 R4 K21 ["activated"]
       78 SETTABLE                         R9 R7 R8
       79 GETUPVAL                         R8 1
       80 GETTABLEKS                       R8 R8 K19 ["Event"]
       82 GETTABLEKS                       R8 R8 K22 ["MouseEnter"]
       84 GETTABLEKS                       R9 R4 K23 ["mouseEnter"]
       86 SETTABLE                         R9 R7 R8
       87 GETUPVAL                         R8 1
       88 GETTABLEKS                       R8 R8 K19 ["Event"]
       90 GETTABLEKS                       R8 R8 K24 ["MouseLeave"]
       92 GETTABLEKS                       R9 R4 K25 ["mouseLeave"]
       94 SETTABLE                         R9 R7 R8
       95 GETUPVAL                         R8 1
       96 GETTABLEKS                       R8 R8 K26 ["Tag"]
      ...
      109 GETUPVAL                         R12 1
      110 GETTABLEKS                       R12 R12 K26 ["Tag"]
...
MAIN:
       ...
       25 GETTABLEKS                       R4 R4 K10 ["useTooltipActions"]
       27 CALL                             R3 1 1
