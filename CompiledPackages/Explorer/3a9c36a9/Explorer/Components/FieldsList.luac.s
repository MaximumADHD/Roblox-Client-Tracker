...
PROTO_4:
       ...
       20 GETUPVAL                         R8 1
       21 GETTABLEKS                       R7 R8 K9 ["session"]
       23 GETTABLEKS                       R6 R7 K10 ["seenFieldsObservable"]
       25 GETTABLEKS                       R5 R6 K11 ["getBinding"]
       27 CALL                             R5 0 1
       28 NEWCLOSURE                       R7 P0
       29 CAPTURE                          VAL R0
       ...
       38 GETUPVAL                         R6 2
       39 GETTABLEKS                       R8 R0 K0 ["field"]
       41 GETTABLEKS                       R7 R8 K4 ["key"]
       43 GETTABLE                         R5 R6 R7
       44 SETTABLEKS                       R5 R4 K15 ["LayoutOrder"]
       46 GETIMPORT                        R5 K18 [UDim2.fromOffset]
       48 GETUPVAL                         R7 3
       49 GETTABLEKS                       R6 R7 K19 ["fieldSize"]
       51 GETUPVAL                         R8 3
       52 GETTABLEKS                       R7 R8 K19 ["fieldSize"]
       54 CALL                             R5 2 1
       55 SETTABLEKS                       R5 R4 K20 ["Size"]
       57 GETUPVAL                         R6 4
       58 GETTABLEKS                       R5 R6 K21 ["Tag"]
       60 LOADK                            R7 K22 ["data-testid=Field-%*"]
       61 GETTABLEKS                       R10 R0 K0 ["field"]
       63 GETTABLEKS                       R9 R10 K4 ["key"]
       65 NAMECALL                         R7 R7 K23 ["format"]
       67 CALL                             R7 2 1
       68 MOVE                             R6 R7
       69 SETTABLE                         R6 R4 R5
       70 GETTABLEKS                       R6 R0 K0 ["field"]
       72 GETTABLEKS                       R5 R6 K1 ["render"]
       74 GETUPVAL                         R8 1
       75 GETTABLEKS                       R7 R8 K24 ["visibleNodeObservable"]
       77 GETTABLEKS                       R6 R7 K11 ["getBinding"]
       79 CALL                             R6 0 1
       80 NEWCLOSURE                       R8 P1
       81 CAPTURE                          VAL R0
       ...
       86 CAPTURE                          VAL R0
       87 CAPTURE                          UPVAL U1
       88 GETTABLEKS                       R8 R0 K25 ["parameters"]
       90 CALL                             R5 3 -1
       91 CALL                             R2 -1 1
       92 RETURN                           R2 1
...
PROTO_5:
       ...
       24 GETTABLEKS                       R6 R0 K9 ["visibleNodeObservable"]
       26 GETTABLEKS                       R5 R6 K10 ["getBinding"]
       28 CALL                             R5 0 1
...
MAIN:
       ...
       44 GETTABLEKS                       R7 R8 K14 ["mapValues"]
       46 CALL                             R6 1 1
       47 GETIMPORT                        R7 K5 [require]
       49 GETTABLEKS                       R9 R0 K15 ["Hooks"]
       51 GETTABLEKS                       R8 R9 K16 ["useVisibleExplorerNodeRange"]
       53 CALL                             R7 1 1
