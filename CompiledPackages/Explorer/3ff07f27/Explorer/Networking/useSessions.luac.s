...
PROTO_1:
       ...
       16 GETUPVAL                         R10 3
       17 GETTABLEKS                       R10 R10 K0 ["current"]
       ...
       59 GETUPVAL                         R12 5
       60 GETTABLEKS                       R12 R12 K5 ["waitForNextSearchAsync"]
       62 SETTABLEKS                       R12 R11 K5 ["waitForNextSearchAsync"]
       64 GETUPVAL                         R12 6
       65 GETTABLEKS                       R12 R12 K9 ["getExpandHierarchy"]
...
PROTO_4:
       ...
       12 CALL                             R2 1 2
       13 GETUPVAL                         R4 2
       14 GETTABLEKS                       R4 R4 K3 ["useRefToState"]
       16 MOVE                             R5 R2
       17 CALL                             R4 1 1
       18 GETUPVAL                         R5 0
       ...
       27 GETUPVAL                         R7 3
       28 GETTABLEKS                       R7 R7 K5 ["Context"]
       30 CALL                             R6 1 1
       31 GETUPVAL                         R7 0
       32 GETTABLEKS                       R7 R7 K0 ["useContext"]
       34 GETUPVAL                         R8 4
       35 GETTABLEKS                       R8 R8 K5 ["Context"]
       37 CALL                             R7 1 1
       38 GETUPVAL                         R8 0
       39 GETTABLEKS                       R8 R8 K6 ["useEffect"]
       41 NEWCLOSURE                       R9 P0
       42 CAPTURE                          UPVAL U5
       43 CAPTURE                          UPVAL U6
       44 CAPTURE                          VAL R0
       ...
       56 CALL                             R8 2 0
       57 GETUPVAL                         R8 0
       58 GETTABLEKS                       R8 R8 K6 ["useEffect"]
       60 NEWCLOSURE                       R9 P1
       61 CAPTURE                          VAL R4
       62 NEWTABLE                         R10 0 0
       64 CALL                             R8 2 0
...
MAIN:
       ...
       39 GETTABLEKS                       R6 R6 K13 ["SearchThrottlingContext"]
       41 CALL                             R5 1 1
       42 GETIMPORT                        R6 K5 [require]
       44 GETTABLEKS                       R7 R0 K11 ["Components"]
       46 GETTABLEKS                       R7 R7 K12 ["Contexts"]
       48 GETTABLEKS                       R7 R7 K14 ["SettingsContext"]
       50 CALL                             R6 1 1
       51 GETIMPORT                        R7 K5 [require]
       53 GETTABLEKS                       R8 R0 K15 ["Networking"]
       55 GETTABLEKS                       R8 R8 K16 ["createSession"]
       57 CALL                             R7 1 1
       58 GETIMPORT                        R8 K5 [require]
       60 GETTABLEKS                       R9 R0 K17 ["Util"]
       62 GETTABLEKS                       R9 R9 K18 ["diffArray"]
       64 CALL                             R8 1 1
       65 GETIMPORT                        R9 K5 [require]
       67 GETTABLEKS                       R10 R0 K17 ["Util"]
       69 GETTABLEKS                       R10 R10 K19 ["keys"]
       71 CALL                             R9 1 1
       72 GETIMPORT                        R10 K5 [require]
       74 GETTABLEKS                       R11 R0 K15 ["Networking"]
       76 GETTABLEKS                       R11 R11 K20 ["useServe"]
       78 CALL                             R10 1 1
