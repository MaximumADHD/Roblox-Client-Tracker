...
PROTO_8:
        ...
        6 DUPTABLE                         R4 K10 [{["BackgroundTransparency"] = 1, ["Image"], ["ScaleType"], ["TileSize"], ["Size"], ["Visible"]}]
        7 GETUPVAL                         R5 1
        8 GETTABLEKS                       R5 R5 K11 ["standard"]
       10 LOADK                            R6 K12 ["collaboratorSelection"]
       11 CALL                             R5 1 1
       12 SETTABLEKS                       R5 R4 K5 ["Image"]
       14 GETIMPORT                        R5 K15 [Enum.ScaleType.Tile]
       16 SETTABLEKS                       R5 R4 K6 ["ScaleType"]
       18 GETIMPORT                        R5 K18 [UDim2.new]
       20 LOADN                            R6 0
       21 LOADN                            R7 16
       22 LOADN                            R8 1
       23 LOADN                            R9 0
       24 CALL                             R5 4 1
       25 SETTABLEKS                       R5 R4 K7 ["TileSize"]
       27 DUPCLOSURE                       R7 K19 [PROTO_4]
       28 NAMECALL                         R5 R1 K1 ["map"]
       30 CALL                             R5 2 1
       31 SETTABLEKS                       R5 R4 K8 ["Size"]
       33 DUPCLOSURE                       R7 K20 [PROTO_5]
       34 NAMECALL                         R5 R1 K1 ["map"]
       36 CALL                             R5 2 1
       37 SETTABLEKS                       R5 R4 K9 ["Visible"]
       39 DUPTABLE                         R5 K22 [{"UIGradient"}]
       40 GETUPVAL                         R6 0
       41 LOADK                            R7 K21 ["UIGradient"]
       42 DUPTABLE                         R8 K25 [{"Color", "Transparency"}]
       43 DUPCLOSURE                       R11 K26 [PROTO_6]
       44 NAMECALL                         R9 R1 K1 ["map"]
       46 CALL                             R9 2 1
       47 SETTABLEKS                       R9 R8 K23 ["Color"]
       49 DUPCLOSURE                       R11 K27 [PROTO_7]
       50 NAMECALL                         R9 R1 K1 ["map"]
       52 CALL                             R9 2 1
       53 SETTABLEKS                       R9 R8 K24 ["Transparency"]
       55 CALL                             R6 2 1
       56 SETTABLEKS                       R6 R5 K21 ["UIGradient"]
       58 CALL                             R2 3 -1
       59 RETURN                           R2 -1
...
PROTO_10:
        0 NEWTABLE                         R0 0 0
        2 GETUPVAL                         R1 0
        3 GETTABLEKS                       R1 R1 K0 ["collaboratorsSelectionsObservable"]
       ...
       19 FORGLOOP                         R1 2 ; [-11]
       21 LENGTH                           R1 R0
       22 JUMPIFNOTEQKN                    R1 K5 [0] ; [+3]
       24 LOADNIL                          R1
       25 RETURN                           R1 1
       26 GETIMPORT                        R1 K7 [table.sort]
       28 MOVE                             R2 R0
       29 DUPCLOSURE                       R3 K8 [PROTO_9]
       30 CALL                             R1 2 0
       31 RETURN                           R0 1
...
PROTO_13:
        ...
        1 CAPTURE                          VAL R2
        2 CAPTURE                          VAL R0
        3 GETTABLEKS                       R4 R2 K0 ["collaboratorsSelectionsObservable"]
        5 GETTABLEKS                       R4 R4 K1 ["changedSignal"]
        7 NEWCLOSURE                       R6 P1
        8 CAPTURE                          VAL R1
        9 CAPTURE                          VAL R3
...
MAIN:
       ...
       34 CALL                             R4 1 1
       35 GETTABLEKS                       R5 R4 K13 ["createElement"]
       37 NEWTABLE                         R6 0 0
       39 DUPCLOSURE                       R7 K14 [PROTO_0]
       40 CAPTURE                          VAL R6
       41 DUPCLOSURE                       R8 K15 [PROTO_2]
       42 CAPTURE                          VAL R3
       43 CAPTURE                          VAL R6
       44 DUPCLOSURE                       R9 K16 [PROTO_8]
       45 CAPTURE                          VAL R5
       46 CAPTURE                          VAL R2
       47 DUPCLOSURE                       R10 K17 [PROTO_13]
       48 DUPTABLE                         R11 K28 [{["key"] = "collaboratorSelection", ["icon"] = "", ["init"], ["render"], ["watch"], ["validateArgs"], ["permanent"] = True}]
       49 SETTABLEKS                       R8 R11 K22 ["init"]
       51 SETTABLEKS                       R9 R11 K23 ["render"]
       53 SETTABLEKS                       R10 R11 K24 ["watch"]
       55 DUPCLOSURE                       R12 K29 [PROTO_14]
       56 SETTABLEKS                       R12 R11 K25 ["validateArgs"]
       58 RETURN                           R11 1
