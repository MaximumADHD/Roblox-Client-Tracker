PROTO_0:
        ...
        3 GETTABLEKS                       R0 R0 K1 ["instancePickerActivated"]
        5 CALL                             R0 0 0
        6 RETURN                           R0 0
...
PROTO_1:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["hostRpcInterface"]
        3 GETTABLEKS                       R0 R0 K1 ["instancePickerDeactivated"]
        5 CALL                             R0 0 0
        6 RETURN                           R0 0

PROTO_2:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["submitPickedInstance"]
        3 MOVE                             R2 R0
        4 JUMPIFNOT                        R2 ; [+4]
        5 GETUPVAL                         R3 1
        6 GETTABLEKS                       R3 R3 K1 ["instanceIdsToInstance"]
        8 GETTABLE                         R2 R3 R0
        9 CALL                             R1 1 0
       10 RETURN                           R0 0
