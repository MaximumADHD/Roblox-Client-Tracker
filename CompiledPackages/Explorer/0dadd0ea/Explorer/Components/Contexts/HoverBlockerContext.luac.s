...
PROTO_4:
       ...
       26 GETUPVAL                         R6 3
       27 GETUPVAL                         R7 4
       28 GETTABLEKS                       R7 R7 K6 ["Provider"]
...
PROTO_5:
        ...
        6 GETUPVAL                         R0 0
        7 GETUPVAL                         R1 1
        8 GETTABLEKS                       R1 R1 K1 ["blockHover"]
       10 CALL                             R1 0 1
...
PROTO_9:
        ...
        4 CALL                             R0 1 1
        5 GETUPVAL                         R1 0
        6 GETTABLEKS                       R1 R1 K1 ["useRef"]
        8 LOADNIL                          R2
        9 CALL                             R1 1 1
       10 GETUPVAL                         R2 0
       11 GETTABLEKS                       R2 R2 K2 ["useCallback"]
       13 NEWCLOSURE                       R3 P0
       14 CAPTURE                          VAL R1
       15 CAPTURE                          VAL R0
       16 NEWTABLE                         R4 0 0
       18 CALL                             R2 2 1
       19 GETUPVAL                         R3 0
       20 GETTABLEKS                       R3 R3 K2 ["useCallback"]
       22 NEWCLOSURE                       R4 P1
       23 CAPTURE                          VAL R1
       24 NEWTABLE                         R5 0 0
       26 CALL                             R3 2 1
       27 GETUPVAL                         R4 0
       28 GETTABLEKS                       R4 R4 K3 ["useEffect"]
       30 NEWCLOSURE                       R5 P2
       31 CAPTURE                          VAL R1
       32 NEWTABLE                         R6 0 0
       34 CALL                             R4 2 0
...
MAIN:
       ...
       25 GETTABLEKS                       R4 R4 K10 ["onlyOnce"]
       27 CALL                             R3 1 1
