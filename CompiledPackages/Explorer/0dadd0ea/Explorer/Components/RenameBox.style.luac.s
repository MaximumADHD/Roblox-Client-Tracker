MAIN:
      ...
      101 DUPTABLE                         R17 K39 [{["Color"] = "$RDLSemanticColorActionPrimaryBrandFill", ["Thickness"] = 2}]
      102 CALL                             R15 2 -1
      103 SETLIST                          R13 R14 -1 [1]
      105 CALL                             R10 3 1
      106 MOVE                             R11 R4
      107 LOADK                            R12 K40 [">> TextBox"]
      108 DUPTABLE                         R13 K51 [{["BackgroundTransparency"] = 1, ["BorderSizePixel"] = 0, ["ClipsDescendants"] = True, ["Font"], ["Size"], ["TextColor3"], ["TextSize"], ["TextXAlignment"]}]
      109 MOVE                             R15 R3
      110 CALL                             R15 0 1
      111 JUMPIFNOT                        R15 ; [+2]
      112 LOADNIL                          R14
      113 JUMP                             ; [+2]
      114 GETIMPORT                        R14 K54 [Enum.Font.SourceSans]
      116 SETTABLEKS                       R14 R13 K47 ["Font"]
      118 GETIMPORT                        R14 K28 [UDim2.fromScale]
      120 LOADN                            R15 1
      121 LOADN                            R16 1
      122 CALL                             R14 2 1
      123 SETTABLEKS                       R14 R13 K16 ["Size"]
      125 MOVE                             R15 R2
      126 CALL                             R15 0 1
      127 JUMPIFNOT                        R15 ; [+2]
      128 LOADNIL                          R14
      129 JUMP                             ; [+1]
      130 LOADK                            R14 K55 ["$RDLSemanticColorContentMuted"]
      131 SETTABLEKS                       R14 R13 K48 ["TextColor3"]
      133 MOVE                             R15 R2
      134 CALL                             R15 0 1
      135 JUMPIFNOT                        R15 ; [+2]
      136 LOADNIL                          R14
      137 JUMP                             ; [+1]
      138 LOADK                            R14 K56 [17.598]
      139 SETTABLEKS                       R14 R13 K49 ["TextSize"]
      141 GETIMPORT                        R14 K58 [Enum.TextXAlignment.Left]
      143 SETTABLEKS                       R14 R13 K50 ["TextXAlignment"]
      145 CALL                             R11 2 -1
