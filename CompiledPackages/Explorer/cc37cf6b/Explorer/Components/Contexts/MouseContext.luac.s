...
PROTO_3:
       ...
       25 GETUPVAL                         R2 0
       26 GETUPVAL                         R3 1
       27 GETTABLEKS                       R3 R3 K7 ["Provider"]
...
PROTO_5:
       ...
       12 GETTABLEKS                       R4 R0 K8 ["Position"]
       14 GETTABLEKS                       R4 R4 K9 ["X"]
       16 GETTABLEKS                       R5 R0 K8 ["Position"]
       18 GETTABLEKS                       R5 R5 K10 ["Y"]
       20 CALL                             R3 2 -1
...
PROTO_6:
       ...
       12 RETURN                           R0 0
       13 GETUPVAL                         R1 0
       14 GETTABLEKS                       R1 R1 K6 ["current"]
       16 LOADB                            R3 1
...
PROTO_10:
       ...
       24 GETUPVAL                         R4 3
       25 GETUPVAL                         R5 2
       26 GETTABLEKS                       R5 R5 K4 ["InputChanged"]
       28 NEWCLOSURE                       R6 P1
       29 CAPTURE                          VAL R1
       30 NEWTABLE                         R7 0 0
       32 CALL                             R4 3 0
       33 GETUPVAL                         R4 3
       34 GETUPVAL                         R5 2
       35 GETTABLEKS                       R5 R5 K5 ["InputBegan"]
       37 NEWCLOSURE                       R6 P2
       38 CAPTURE                          VAL R2
       39 NEWTABLE                         R7 0 0
       41 CALL                             R4 3 0
       42 GETUPVAL                         R4 3
       43 GETUPVAL                         R5 2
       44 GETTABLEKS                       R5 R5 K6 ["InputEnded"]
       46 NEWCLOSURE                       R6 P3
       47 CAPTURE                          VAL R2
       48 NEWTABLE                         R7 0 0
       50 CALL                             R4 3 0
       51 GETUPVAL                         R4 0
       52 GETTABLEKS                       R4 R4 K2 ["useCallback"]
       54 DUPCLOSURE                       R5 K7 [PROTO_8]
       55 CAPTURE                          UPVAL U2
       56 NEWTABLE                         R6 0 0
       58 CALL                             R4 2 1
       59 GETUPVAL                         R5 0
       60 GETTABLEKS                       R5 R5 K2 ["useCallback"]
       ...
       81 GETUPVAL                         R9 6
       82 GETTABLEKS                       R9 R9 K17 ["create"]
       84 LOADB                            R10 1
       85 CALL                             R9 1 1
...
MAIN:
       ...
       17 GETTABLEKS                       R3 R3 K11 ["Observable"]
       19 CALL                             R2 1 1
       ...
       31 GETTABLEKS                       R5 R5 K14 ["Signal"]
       33 CALL                             R4 1 1
       34 GETIMPORT                        R5 K9 [require]
       36 GETTABLEKS                       R6 R1 K15 ["Hooks"]
       38 GETTABLEKS                       R6 R6 K16 ["useEventConnection"]
       40 CALL                             R5 1 1
