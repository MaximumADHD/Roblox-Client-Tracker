...
PROTO_2:
       ...
       60 GETUPVAL                         R2 1
       61 GETUPVAL                         R3 6
       62 DUPTABLE                         R4 K17 [{["scrollingFrameRef"], ["position"], ["shouldIgnoreUnclickableArea"] = True}]
       63 GETUPVAL                         R5 3
       64 SETTABLEKS                       R5 R4 K13 ["scrollingFrameRef"]
       66 GETUPVAL                         R5 4
       67 GETTABLEKS                       R5 R5 K18 ["getMousePosition"]
       69 CALL                             R5 0 1
...
PROTO_3:
        0 GETUPVAL                         R0 0
        1 DUPTABLE                         R1 K4 [{[1], ["position"], ["shouldIgnoreUnclickableArea"] = True}]
        2 GETUPVAL                         R2 1
        3 SETTABLEKS                       R2 R1 K0 ["scrollingFrameRef"]
        5 GETUPVAL                         R2 2
        6 GETTABLEKS                       R2 R2 K5 ["getMousePosition"]
        8 CALL                             R2 0 1
       ...
       15 RETURN                           R1 1
       16 GETUPVAL                         R1 1
       17 GETTABLEKS                       R1 R1 K6 ["current"]
       19 JUMPIFNOTEQKNIL                  R1 ; [+2]
       21 LOADB                            R3 0 +1
       22 LOADB                            R3 1
       23 FASTCALL2K                       ASSERT R3 K7 ; [+4]
       25 LOADK                            R4 K7 ["scrollingFrameRef should not be nil"]
       26 GETIMPORT                        R2 K9 [assert]
       28 CALL                             R2 2 0
       29 JUMPIFNOTEQKS                    R0 K10 ["Vertical"] ; [+4]
       31 GETTABLEKS                       R2 R1 K11 ["VerticalBarRect"]
       33 JUMP                             ; [+2]
       34 GETTABLEKS                       R2 R1 K12 ["HorizontalBarRect"]
       36 GETTABLEKS                       R3 R2 K13 ["Min"]
       38 GETTABLEKS                       R4 R2 K14 ["Max"]
       40 GETUPVAL                         R5 2
       41 GETTABLEKS                       R5 R5 K5 ["getMousePosition"]
       43 CALL                             R5 0 1
       44 JUMPIFNOTEQKS                    R0 K10 ["Vertical"] ; [+18]
       46 GETTABLEKS                       R6 R5 K15 ["Y"]
       48 GETTABLEKS                       R7 R3 K15 ["Y"]
       50 JUMPIFNOTLE                      R6 R7 ; [+3]
       52 LOADK                            R6 K16 ["Up"]
       53 RETURN                           R6 1
       54 GETTABLEKS                       R6 R5 K15 ["Y"]
       56 GETTABLEKS                       R7 R4 K15 ["Y"]
       58 JUMPIFNOTLT                      R7 R6 ; [+20]
       60 LOADK                            R6 K17 ["Down"]
       61 RETURN                           R6 1
       62 JUMP                             ; [+16]
       63 GETTABLEKS                       R6 R5 K18 ["X"]
       65 GETTABLEKS                       R7 R3 K18 ["X"]
       67 JUMPIFNOTLE                      R6 R7 ; [+3]
       69 LOADK                            R6 K19 ["Left"]
       70 RETURN                           R6 1
       71 GETTABLEKS                       R6 R5 K18 ["X"]
       73 GETTABLEKS                       R7 R4 K18 ["X"]
       75 JUMPIFNOTLT                      R7 R6 ; [+3]
       77 LOADK                            R6 K20 ["Right"]
       78 RETURN                           R6 1
       79 LOADNIL                          R6
       80 RETURN                           R6 1
