...
PROTO_2:
        ...
        4 RETURN                           R0 1
        5 GETUPVAL                         R1 1
        6 GETTABLEKS                       R0 R1 K0 ["createBinding"]
        8 GETUPVAL                         R1 2
        9 CALL                             R0 1 2
       10 GETUPVAL                         R2 3
       11 MOVE                             R4 R1
...
PROTO_8:
        ...
        1 GETUPVAL                         R3 0
        2 GETTABLEKS                       R2 R3 K1 ["useState"]
        4 NEWCLOSURE                       R3 P1
        5 CAPTURE                          VAL R0
        6 CALL                             R2 1 2
        7 GETUPVAL                         R5 0
       ...
       18 CALL                             R4 2 1
       19 GETUPVAL                         R6 0
       20 GETTABLEKS                       R5 R6 K3 ["useEffect"]
       22 MOVE                             R6 R4
       23 NEWTABLE                         R7 0 1
       25 MOVE                             R8 R4
...
PROTO_12:
       ...
       17 CAPTURE                          VAL R3
       18 GETUPVAL                         R7 0
       19 GETTABLEKS                       R6 R7 K6 ["useEffect"]
       21 NEWCLOSURE                       R7 P1
       22 CAPTURE                          VAL R3
       23 CAPTURE                          VAL R1
       24 CAPTURE                          VAL R0
...
MAIN:
       ...
       31 CAPTURE                          VAL R2
       32 CAPTURE                          VAL R1
       33 SETTABLEKS                       R5 R4 K12 ["create"]
       35 DUPCLOSURE                       R5 K13 [PROTO_8]
       36 CAPTURE                          VAL R1
       37 CAPTURE                          VAL R3
       38 SETTABLEKS                       R5 R4 K14 ["use"]
       40 DUPCLOSURE                       R5 K15 [PROTO_12]
       41 CAPTURE                          VAL R1
       42 CAPTURE                          VAL R3
       43 SETTABLEKS                       R5 R4 K16 ["useEffect"]
       45 DUPCLOSURE                       R5 K17 [PROTO_14]
       46 CAPTURE                          VAL R1
       47 CAPTURE                          VAL R4
       48 SETTABLEKS                       R5 R4 K18 ["useState"]
       50 RETURN                           R4 1
