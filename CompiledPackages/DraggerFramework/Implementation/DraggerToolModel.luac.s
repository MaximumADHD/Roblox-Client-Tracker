...
PROTO_34:
  NAMECALL R1 R0 K0 ["doesAllowFreeformDrag"]
  CALL R1 1 1
  JUMPIF R1 [+1]
  RETURN R0 0
  GETTABLEKS R1 R0 K1 ["_isMouseDown"]
  ...
  RETURN R0 0
  LOADB R1 1
  SETTABLEKS R1 R0 K1 ["_isMouseDown"]
  GETUPVAL R1 0
  CALL R1 0 1
  JUMPIFNOT R1 [+40]
  GETUPVAL R4 1
  GETTABLEKS R3 R4 K2 ["DraggingParts"]
  DUPTABLE R4 K8 [{"draggedPoint", "clickedPoint", "clickedMetadata", "clickedFaceInstance", "attachmentBeingDragged"}]
  LOADK R5 K9 [{0, 0, 0}]
  SETTABLEKS R5 R4 K3 ["draggedPoint"]
  LOADK R5 K9 [{0, 0, 0}]
  SETTABLEKS R5 R4 K4 ["clickedPoint"]
  GETIMPORT R5 K12 [table.freeze]
  DUPTABLE R6 K17 [{"RaycastResult", "TargetMatrix", "TargetSize", "IsPivot"}]
  LOADNIL R7
  SETTABLEKS R7 R6 K13 ["RaycastResult"]
  GETIMPORT R7 K20 [CFrame.new]
  CALL R7 0 1
  SETTABLEKS R7 R6 K14 ["TargetMatrix"]
  LOADK R7 K9 [{0, 0, 0}]
  SETTABLEKS R7 R6 K15 ["TargetSize"]
  LOADB R7 0
  SETTABLEKS R7 R6 K16 ["IsPivot"]
  CALL R5 1 1
  SETTABLEKS R5 R4 K5 ["clickedMetadata"]
  LOADNIL R5
  SETTABLEKS R5 R4 K6 ["clickedFaceInstance"]
  LOADNIL R5
  SETTABLEKS R5 R4 K7 ["attachmentBeingDragged"]
  NAMECALL R1 R0 K21 ["transitionToState"]
  CALL R1 3 0
  RETURN R0 0
  GETUPVAL R4 1
  GETTABLEKS R3 R4 K2 ["DraggingParts"]
  DUPTABLE R4 K25 [{"mouseLocation", "basisPoint", "clickPoint"}]
  GETTABLEKS R5 R0 K26 ["_draggerContext"]
  NAMECALL R5 R5 K27 ["getMouseLocation"]
  CALL R5 1 1
  SETTABLEKS R5 R4 K22 ["mouseLocation"]
  LOADK R5 K9 [{0, 0, 0}]
  SETTABLEKS R5 R4 K23 ["basisPoint"]
  LOADK R5 K9 [{0, 0, 0}]
  SETTABLEKS R5 R4 K24 ["clickPoint"]
  NAMECALL R1 R0 K21 ["transitionToState"]
  CALL R1 3 0
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R15 R1 K11 ["Implementation"]
  GETTABLEKS R14 R15 K32 ["DraggerStateType"]
  CALL R13 1 1
  GETTABLEKS R15 R1 K11 ["Implementation"]
  GETTABLEKS R14 R15 K33 ["DraggerStates"]
  GETIMPORT R15 K36 [table.freeze]
  NEWTABLE R16 8 0
  GETTABLEKS R17 R13 K37 ["Ready"]
  GETIMPORT R18 K8 [require]
  GETTABLEKS R19 R14 K37 ["Ready"]
  CALL R18 1 1
  SETTABLE R18 R16 R17
  GETTABLEKS R17 R13 K38 ["DraggingFaceInstance"]
  GETIMPORT R18 K8 [require]
  GETTABLEKS R19 R14 K38 ["DraggingFaceInstance"]
  CALL R18 1 1
  SETTABLE R18 R16 R17
  GETTABLEKS R17 R13 K39 ["PendingDraggingParts"]
  GETIMPORT R18 K8 [require]
  GETTABLEKS R19 R14 K39 ["PendingDraggingParts"]
  CALL R18 1 1
  SETTABLE R18 R16 R17
  GETTABLEKS R17 R13 K40 ["PendingSelectNext"]
  GETIMPORT R18 K8 [require]
  GETTABLEKS R19 R14 K40 ["PendingSelectNext"]
  CALL R18 1 1
  SETTABLE R18 R16 R17
  GETTABLEKS R17 R13 K41 ["DraggingHandle"]
  GETIMPORT R18 K8 [require]
  GETTABLEKS R19 R14 K41 ["DraggingHandle"]
  CALL R18 1 1
  SETTABLE R18 R16 R17
  GETTABLEKS R17 R13 K42 ["DraggingParts"]
  GETIMPORT R18 K8 [require]
  GETTABLEKS R19 R14 K42 ["DraggingParts"]
  CALL R18 1 1
  SETTABLE R18 R16 R17
  GETTABLEKS R17 R13 K43 ["DragSelecting"]
  GETIMPORT R18 K8 [require]
  GETTABLEKS R19 R14 K43 ["DragSelecting"]
  CALL R18 1 1
  SETTABLE R18 R16 R17
  CALL R15 1 1
  DUPTABLE R16 K51 [{"AllowDragSelect", "AllowFreeformDrag", "ShowLocalSpaceIndicator", "WasAutoSelected", "HandlesList", "ShowPivotIndicator", "ShowDragSelect"}]
  LOADB R17 1
  SETTABLEKS R17 R16 K44 ["AllowDragSelect"]
  LOADB R17 1
  SETTABLEKS R17 R16 K45 ["AllowFreeformDrag"]
  LOADB R17 0
  SETTABLEKS R17 R16 K46 ["ShowLocalSpaceIndicator"]
  LOADB R17 0
  SETTABLEKS R17 R16 K47 ["WasAutoSelected"]
  NEWTABLE R17 0 0
  SETTABLEKS R17 R16 K48 ["HandlesList"]
  LOADB R17 0
  SETTABLEKS R17 R16 K49 ["ShowPivotIndicator"]
  LOADB R17 1
  SETTABLEKS R17 R16 K50 ["ShowDragSelect"]
  DUPTABLE R17 K53 [{"AnalyticsName"}]
  LOADB R18 1
  SETTABLEKS R18 R17 K52 ["AnalyticsName"]
  ...
  CAPTURE VAL R4
  CAPTURE VAL R12
  SETTABLEKS R18 R12 K55 ["new"]
  DUPCLOSURE R18 K56 [PROTO_1]
  SETTABLEKS R18 R12 K57 ["setMouseCursor"]
  DUPCLOSURE R18 K58 [PROTO_2]
  CAPTURE VAL R15
  SETTABLEKS R18 R12 K59 ["transitionToState"]
  DUPCLOSURE R18 K60 [PROTO_3]
  CAPTURE VAL R3
  SETTABLEKS R18 R12 K61 ["render"]
  DUPCLOSURE R18 K62 [PROTO_4]
  CAPTURE VAL R13
  SETTABLEKS R18 R12 K63 ["update"]
  DUPCLOSURE R18 K64 [PROTO_5]
  SETTABLEKS R18 R12 K65 ["getSelectionWrapper"]
  DUPCLOSURE R18 K66 [PROTO_6]
  SETTABLEKS R18 R12 K67 ["getAnalyticsName"]
  DUPCLOSURE R18 K68 [PROTO_7]
  SETTABLEKS R18 R12 K69 ["wasAutoSelected"]
  DUPCLOSURE R18 K70 [PROTO_8]
  SETTABLEKS R18 R12 K71 ["getSchema"]
  DUPCLOSURE R18 K72 [PROTO_9]
  CAPTURE VAL R10
  SETTABLEKS R18 R12 K73 ["getHandlesList"]
  DUPCLOSURE R18 K74 [PROTO_10]
  SETTABLEKS R18 R12 K75 ["doesAllowDragSelect"]
  DUPCLOSURE R18 K76 [PROTO_11]
  SETTABLEKS R18 R12 K77 ["doesAllowFreeformDrag"]
  DUPCLOSURE R18 K78 [PROTO_12]
  SETTABLEKS R18 R12 K79 ["shouldShowDragSelect"]
  DUPCLOSURE R18 K80 [PROTO_13]
  SETTABLEKS R18 R12 K81 ["shouldShowLocalSpaceIndicator"]
  DUPCLOSURE R18 K82 [PROTO_14]
  SETTABLEKS R18 R12 K83 ["shouldShowSelectionDot"]
  DUPCLOSURE R18 K84 [PROTO_15]
  SETTABLEKS R18 R12 K85 ["shouldUseCollisionTransparency"]
  DUPCLOSURE R18 K86 [PROTO_16]
  SETTABLEKS R18 R12 K87 ["shouldAlignDraggedObjects"]
  DUPCLOSURE R18 K88 [PROTO_17]
  CAPTURE VAL R6
  SETTABLEKS R18 R12 K89 ["selectNextSelectables"]
  DUPCLOSURE R18 K90 [PROTO_18]
  CAPTURE VAL R7
  SETTABLEKS R18 R12 K91 ["classifySelectionPivot"]
  DUPCLOSURE R18 K92 [PROTO_21]
  CAPTURE VAL R13
  CAPTURE VAL R15
  CAPTURE VAL R5
  CAPTURE VAL R10
  SETTABLEKS R18 R12 K93 ["_processSelected"]
  DUPCLOSURE R18 K94 [PROTO_22]
  CAPTURE VAL R11
  SETTABLEKS R18 R12 K95 ["_processDeselected"]
  DUPCLOSURE R18 K96 [PROTO_23]
  SETTABLEKS R18 R12 K97 ["isSelected"]
  MOVE R18 R10
  CALL R18 0 1
  JUMPIFNOT R18 [+3]
  DUPCLOSURE R18 K98 [PROTO_24]
  SETTABLEKS R18 R12 K99 ["_updateEnabledHandlesList"]
  DUPCLOSURE R18 K100 [PROTO_25]
  CAPTURE VAL R10
  CAPTURE VAL R11
  SETTABLEKS R18 R12 K101 ["_processSelectionChanged"]
  DUPCLOSURE R18 K102 [PROTO_26]
  SETTABLEKS R18 R12 K103 ["_processKeyDown"]
  DUPCLOSURE R18 K104 [PROTO_27]
  SETTABLEKS R18 R12 K105 ["_processKeyUp"]
  DUPCLOSURE R18 K106 [PROTO_28]
  SETTABLEKS R18 R12 K107 ["_processMouseDown"]
  DUPCLOSURE R18 K108 [PROTO_29]
  SETTABLEKS R18 R12 K109 ["_processMouseUp"]
  DUPCLOSURE R18 K110 [PROTO_30]
  SETTABLEKS R18 R12 K111 ["_processViewChanged"]
  DUPCLOSURE R18 K112 [PROTO_31]
  CAPTURE VAL R10
  SETTABLEKS R18 R12 K113 ["_updateHandles"]
  DUPCLOSURE R18 K114 [PROTO_32]
  SETTABLEKS R18 R12 K115 ["_updateSelectionInfo"]
  DUPCLOSURE R18 K116 [PROTO_33]
  CAPTURE VAL R13
  SETTABLEKS R18 R12 K117 ["_updatePivotIndicatorVisibility"]
  DUPCLOSURE R18 K118 [PROTO_34]
  CAPTURE VAL R11
  CAPTURE VAL R13
  SETTABLEKS R18 R12 K119 ["_processToolboxInitiatedFreeformSelectionDrag"]
  DUPCLOSURE R18 K120 [PROTO_36]
  CAPTURE VAL R0
  CAPTURE VAL R13
  SETTABLEKS R18 R12 K121 ["_processToolboxInitiatedFaceDrag"]
  DUPCLOSURE R18 K122 [PROTO_37]
  SETTABLEKS R18 R12 K123 ["_processMouseEnter"]
  DUPCLOSURE R18 K124 [PROTO_38]
  SETTABLEKS R18 R12 K125 ["_processMouseLeave"]
  DUPCLOSURE R18 K126 [PROTO_39]
  SETTABLEKS R18 R12 K127 ["_scheduleRender"]
  DUPCLOSURE R18 K128 [PROTO_40]
  SETTABLEKS R18 R12 K129 ["_isSummoned"]
  DUPCLOSURE R18 K130 [PROTO_41]
  SETTABLEKS R18 R12 K131 ["_beginSummon"]
  DUPCLOSURE R18 K132 [PROTO_42]
  SETTABLEKS R18 R12 K133 ["_endSummon"]
  DUPCLOSURE R18 K134 [PROTO_43]
  SETTABLEKS R18 R12 K135 ["shouldShowPivotIndicator"]
  DUPCLOSURE R18 K136 [PROTO_44]
  SETTABLEKS R18 R12 K137 ["_analyticsSessionBegin"]
  DUPCLOSURE R18 K138 [PROTO_45]
  SETTABLEKS R18 R12 K139 ["_analyticsSendSession"]
  DUPCLOSURE R18 K140 [PROTO_46]
  SETTABLEKS R18 R12 K141 ["_analyticsSendClick"]
  DUPCLOSURE R18 K142 [PROTO_47]
  SETTABLEKS R18 R12 K143 ["_analyticsSendSelectionCycle"]
  DUPCLOSURE R18 K144 [PROTO_48]
  SETTABLEKS R18 R12 K145 ["_analyticsRecordFreeformDragBegin"]
  DUPCLOSURE R18 K146 [PROTO_49]
  CAPTURE VAL R9
  SETTABLEKS R18 R12 K147 ["_analyticsSendHandleDragged"]
  DUPCLOSURE R18 K148 [PROTO_50]
  SETTABLEKS R18 R12 K149 ["_analyticsSendBoxSelect"]
  DUPCLOSURE R18 K150 [PROTO_51]
  SETTABLEKS R18 R12 K151 ["_analyticsSendFaceInstanceSelected"]
  RETURN R12 1
