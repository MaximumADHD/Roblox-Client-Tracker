PROTO_0:
       ...
       42 GETTABLEKS                       R4 R0 K10 ["name"]
       44 FASTCALL1                        TYPEOF R4 ; [+2]
       45 GETIMPORT                        R3 K1 [typeof]
       47 CALL                             R3 1 1
       48 JUMPIFEQKS                       R3 K11 ["string"] ; [+18]
       50 LOADK                            R5 K12 ["%*\"name\" > Expected string, got %*"]
       51 MOVE                             R7 R2
       52 GETTABLEKS                       R9 R0 K10 ["name"]
       ...
       66 CALL                             R3 2 0
       67 GETTABLEKS                       R4 R0 K13 ["id"]
       69 FASTCALL1                        TYPEOF R4 ; [+2]
       70 GETIMPORT                        R3 K1 [typeof]
       72 CALL                             R3 1 1
       73 JUMPIFEQKS                       R3 K11 ["string"] ; [+18]
       75 LOADK                            R5 K14 ["%*\"id\" > Expected string, got %*"]
       76 MOVE                             R7 R2
       77 GETTABLEKS                       R9 R0 K13 ["id"]
       ...
       91 CALL                             R3 2 0
       92 GETTABLEKS                       R4 R0 K15 ["content"]
       94 FASTCALL1                        TYPEOF R4 ; [+2]
       95 GETIMPORT                        R3 K1 [typeof]
       97 CALL                             R3 1 1
       98 JUMPIFEQKS                       R3 K2 ["table"] ; [+19]
      100 LOADK                            R5 K16 ["%*\"content\" > Expected table, got %*"]
      101 MOVE                             R7 R2
      102 GETTABLEKS                       R9 R0 K15 ["content"]
      ...
      116 CALL                             R3 2 0
      117 JUMP                             ; [+32]
      118 GETTABLEKS                       R3 R0 K15 ["content"]
      120 LOADNIL                          R4
      121 LOADNIL                          R5
      122 FORGPREP                         R3
      ...
      127 CALL                             R8 1 1
      128 JUMPIFEQKS                       R8 K17 ["number"] ; [+19]
      130 LOADK                            R10 K18 ["%*\"content\" > Expected index of type number, got %* as %*"]
      131 MOVE                             R12 R2
      132 MOVE                             R13 R6
      ...
      150 GETTABLEKS                       R3 R0 K19 ["isError"]
      152 JUMPIFEQKNIL                     R3 ; [+26]
      154 GETTABLEKS                       R4 R0 K19 ["isError"]
      156 FASTCALL1                        TYPEOF R4 ; [+2]
      157 GETIMPORT                        R3 K1 [typeof]
      159 CALL                             R3 1 1
      160 JUMPIFEQKS                       R3 K20 ["boolean"] ; [+18]
      162 LOADK                            R5 K21 ["%*\"isError\" > Expected boolean, got %*"]
      163 MOVE                             R7 R2
      164 GETTABLEKS                       R9 R0 K19 ["isError"]
