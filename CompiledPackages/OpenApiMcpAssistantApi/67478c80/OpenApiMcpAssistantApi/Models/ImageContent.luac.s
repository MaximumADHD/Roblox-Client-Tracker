PROTO_0:
       ...
       45 GETTABLEKS                       R4 R0 K10 ["mimeType"]
       47 MOVE                             R5 R1
       48 LOADK                            R6 K11 ["%*\"mimeType\" > "]
       49 MOVE                             R8 R2
       50 NAMECALL                         R6 R6 K4 ["format"]
       52 CALL                             R6 2 1
       53 CALL                             R3 3 1
       54 SETTABLEKS                       R3 R0 K10 ["mimeType"]
       56 GETTABLEKS                       R4 R0 K12 ["data"]
       58 FASTCALL1                        TYPEOF R4 ; [+2]
       59 GETIMPORT                        R3 K1 [typeof]
       61 CALL                             R3 1 1
       62 JUMPIFEQKS                       R3 K13 ["string"] ; [+18]
       64 LOADK                            R5 K14 ["%*\"data\" > Expected string, got %*"]
       65 MOVE                             R7 R2
       66 GETTABLEKS                       R9 R0 K12 ["data"]
       68 FASTCALL1                        TYPEOF R9 ; [+2]
       69 GETIMPORT                        R8 K1 [typeof]
       71 CALL                             R8 1 1
       72 NAMECALL                         R5 R5 K4 ["format"]
       74 CALL                             R5 3 1
