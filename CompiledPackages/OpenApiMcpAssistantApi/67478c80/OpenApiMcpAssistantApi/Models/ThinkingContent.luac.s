PROTO_0:
       ...
       42 GETTABLEKS                       R4 R0 K10 ["thinking"]
       44 FASTCALL1                        TYPEOF R4 ; [+2]
       45 GETIMPORT                        R3 K1 [typeof]
       47 CALL                             R3 1 1
       48 JUMPIFEQKS                       R3 K11 ["string"] ; [+18]
       50 LOADK                            R5 K12 ["%*\"thinking\" > Expected string, got %*"]
       51 MOVE                             R7 R2
       52 GETTABLEKS                       R9 R0 K10 ["thinking"]
       ...
       66 CALL                             R3 2 0
       67 GETTABLEKS                       R4 R0 K13 ["signature"]
       69 FASTCALL1                        TYPEOF R4 ; [+2]
       70 GETIMPORT                        R3 K1 [typeof]
       72 CALL                             R3 1 1
       73 JUMPIFEQKS                       R3 K11 ["string"] ; [+18]
       75 LOADK                            R5 K14 ["%*\"signature\" > Expected string, got %*"]
       76 MOVE                             R7 R2
       77 GETTABLEKS                       R9 R0 K13 ["signature"]
