PROTO_0:
       ...
       22 CALL                             R3 2 0
       23 RETURN                           R0 1
       24 GETTABLEKS                       R3 R0 K7 ["summary"]
       26 JUMPIFEQKNIL                     R3 ; [+15]
       28 GETUPVAL                         R3 0
       29 GETTABLEKS                       R3 R3 K8 ["fromResponse"]
       31 GETTABLEKS                       R4 R0 K7 ["summary"]
       33 MOVE                             R5 R1
       34 LOADK                            R6 K9 ["%*\"summary\" > "]
       35 MOVE                             R8 R2
       36 NAMECALL                         R6 R6 K4 ["format"]
       38 CALL                             R6 2 1
       39 CALL                             R3 3 1
       40 SETTABLEKS                       R3 R0 K7 ["summary"]
       42 RETURN                           R0 1
...
PROTO_1:
        ...
        2 MOVE                             R2 R0
        3 CALL                             R1 1 1
        4 GETTABLEKS                       R2 R1 K3 ["summary"]
        6 JUMPIFEQKNIL                     R2 ; [+9]
        8 GETUPVAL                         R2 0
        9 GETTABLEKS                       R2 R2 K4 ["toRequest"]
       11 GETTABLEKS                       R3 R1 K3 ["summary"]
       13 CALL                             R2 1 1
       14 SETTABLEKS                       R2 R1 K3 ["summary"]
       16 RETURN                           R1 1
...
MAIN:
       ...
       18 GETTABLEKS                       R4 R4 K9 ["QuotaSummary"]
       20 CALL                             R3 1 1
