...
PROTO_1:
        ...
        8 JUMPIFNOT                        R4 ; [+5]
        9 GETTABLEKS                       R4 R2 K3 ["Button"]
       11 GETTABLEKS                       R3 R4 K4 ["Filled"]
       13 JUMPIF                           R3 ; [+4]
       14 GETTABLEKS                       R4 R2 K3 ["Button"]
       16 GETTABLEKS                       R3 R4 K5 ["Unfilled"]
       18 GETUPVAL                         R4 0
       19 GETTABLEKS                       R5 R1 K6 ["Size"]
       21 GETTABLEKS                       R6 R2 K6 ["Size"]
       23 CALL                             R4 2 1
       24 GETUPVAL                         R6 1
       25 GETTABLEKS                       R5 R6 K7 ["createElement"]
       27 GETUPVAL                         R6 2
      ...
      118 GETUPVAL                         R10 1
      119 GETTABLEKS                       R9 R10 K7 ["createElement"]
      121 GETUPVAL                         R10 6
...
MAIN:
       ...
       48 GETTABLEKS                       R12 R0 K2 ["UI"]
       50 GETTABLEKS                       R11 R12 K15 ["Components"]
       52 GETTABLEKS                       R10 R11 K16 ["DEPRECATED_Button"]
       54 CALL                             R9 1 1
       55 GETIMPORT                        R10 K6 [require]
       57 GETTABLEKS                       R13 R0 K2 ["UI"]
       59 GETTABLEKS                       R12 R13 K15 ["Components"]
       61 GETTABLEKS                       R11 R12 K17 ["HoverArea"]
       63 CALL                             R10 1 1
       64 GETIMPORT                        R11 K6 [require]
       66 GETTABLEKS                       R14 R0 K2 ["UI"]
       68 GETTABLEKS                       R13 R14 K15 ["Components"]
       70 GETTABLEKS                       R12 R13 K18 ["Pane"]
       72 CALL                             R11 1 1
       73 GETIMPORT                        R12 K6 [require]
       75 GETTABLEKS                       R15 R0 K2 ["UI"]
       77 GETTABLEKS                       R14 R15 K15 ["Components"]
       79 GETTABLEKS                       R13 R14 K19 ["TextLabel"]
       81 CALL                             R12 1 1
       82 GETIMPORT                        R13 K6 [require]
       84 GETTABLEKS                       R15 R0 K20 ["SharedFlags"]
       86 GETTABLEKS                       R14 R15 K21 ["getFFlagDevFrameworkFixMissingKeyErrors"]
       88 CALL                             R13 1 1
       89 CALL                             R13 0 1
