...
PROTO_3:
        0 GETTABLEKS                       R3 R0 K0 ["Src"]
        2 GETTABLEKS                       R2 R3 K1 ["Resources"]
        4 MOVE                             R4 R1
...
PROTO_8:
        ...
        4 CALL                             R4 2 1
        5 MOVE                             R1 R4
        6 GETTABLEKS                       R5 R1 K2 ["Src"]
        8 GETTABLEKS                       R4 R5 K3 ["Resources"]
       ...
       47 LOADNIL                          R8
       48 GETTABLEKS                       R10 R1 K2 ["Src"]
       50 GETTABLEKS                       R9 R10 K3 ["Resources"]
       52 LOADK                            R11 K14 ["PluginStyles"]
       53 NAMECALL                         R9 R9 K5 ["FindFirstChild"]
       55 CALL                             R9 2 1
       56 JUMPIFNOT                        R9 ; [+11]
       57 GETIMPORT                        R9 K16 [require]
       59 GETTABLEKS                       R12 R1 K2 ["Src"]
       61 GETTABLEKS                       R11 R12 K3 ["Resources"]
       63 GETTABLEKS                       R10 R11 K14 ["PluginStyles"]
       65 CALL                             R9 1 1
       66 MOVE                             R8 R9
       67 JUMP                             ; [+5]
       ...
       78 GETTABLEKS                       R10 R1 K2 ["Src"]
       80 GETTABLEKS                       R9 R10 K19 ["Components"]
...
MAIN:
       ...
       28 GETTABLEKS                       R7 R8 K2 ["Parent"]
       30 GETTABLEKS                       R6 R7 K12 ["createStudioDesign"]
       32 CALL                             R5 1 1
       33 GETIMPORT                        R6 K8 [require]
       35 GETTABLEKS                       R8 R0 K13 ["Util"]
       37 GETTABLEKS                       R7 R8 K14 ["getStudioSettings"]
       39 CALL                             R6 1 1
       40 GETIMPORT                        R7 K8 [require]
       42 GETTABLEKS                       R9 R0 K15 ["Style"]
       44 GETTABLEKS                       R8 R9 K16 ["StudioThemeFallback"]
       46 CALL                             R7 1 1
