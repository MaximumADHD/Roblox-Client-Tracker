...
PROTO_3:
        ...
        2 JUMPIF                           R0 ; [+1]
        3 RETURN                           R0 0
        4 GETTABLEKS                       R2 R0 K0 ["Theme"]
        6 GETTABLEKS                       R1 R2 K1 ["Name"]
        8 GETUPVAL                         R3 1
        9 GETTABLEKS                       R2 R3 K2 ["Design"]
       11 NEWTABLE                         R4 0 1
       13 GETUPVAL                         R6 2
...
PROTO_4:
       ...
       71 CALL                             R0 0 1
       72 JUMPIFNOT                        R0 ; [+5]
       73 GETTABLEKS                       R2 R0 K24 ["Theme"]
       75 GETTABLEKS                       R1 R2 K3 ["Name"]
       77 JUMP                             ; [+1]
       78 GETUPVAL                         R1 3
       79 GETUPVAL                         R2 4
...
MAIN:
       ...
       15 GETTABLEKS                       R4 R0 K2 ["Parent"]
       17 GETTABLEKS                       R3 R4 K9 ["Dash"]
       19 CALL                             R2 1 1
       20 GETTABLEKS                       R3 R2 K10 ["append"]
       22 GETTABLEKS                       R4 R2 K11 ["filter"]
       24 GETTABLEKS                       R5 R2 K12 ["includes"]
       26 GETIMPORT                        R6 K8 [require]
       28 GETTABLEKS                       R8 R0 K13 ["Style"]
       30 GETTABLEKS                       R7 R8 K14 ["StudioThemeFallback"]
       32 CALL                             R6 1 1
       33 GETIMPORT                        R7 K8 [require]
       35 GETTABLEKS                       R9 R0 K15 ["Styling"]
       37 GETTABLEKS                       R8 R9 K16 ["createDesign"]
       39 CALL                             R7 1 1
       40 GETIMPORT                        R8 K8 [require]
       42 GETTABLEKS                       R10 R0 K15 ["Styling"]
       44 GETTABLEKS                       R9 R10 K17 ["createStyleSheet"]
       46 CALL                             R8 1 1
       47 GETTABLEKS                       R10 R0 K18 ["UI"]
       49 GETTABLEKS                       R9 R10 K19 ["Components"]
       51 GETTABLEKS                       R11 R0 K18 ["UI"]
       53 GETTABLEKS                       R10 R11 K20 ["Hooks"]
       55 GETIMPORT                        R11 K8 [require]
       57 GETTABLEKS                       R13 R0 K15 ["Styling"]
       59 GETTABLEKS                       R12 R13 K21 ["StudioPalette"]
       61 CALL                             R11 1 1
       62 GETIMPORT                        R12 K8 [require]
       64 GETTABLEKS                       R14 R0 K15 ["Styling"]
       66 GETTABLEKS                       R13 R14 K22 ["StudioMixins"]
       68 CALL                             R12 1 1
       69 GETIMPORT                        R13 K8 [require]
       71 GETTABLEKS                       R15 R0 K15 ["Styling"]
       73 GETTABLEKS                       R14 R15 K23 ["LightThemeTokens"]
       75 CALL                             R13 1 1
       76 GETIMPORT                        R14 K8 [require]
       78 GETTABLEKS                       R16 R0 K15 ["Styling"]
       80 GETTABLEKS                       R15 R16 K24 ["DarkThemeTokens"]
       82 CALL                             R14 1 1
       83 GETIMPORT                        R15 K8 [require]
       85 GETTABLEKS                       R17 R0 K25 ["SharedFlags"]
       87 GETTABLEKS                       R16 R17 K26 ["getFFlagDevFrameworkDesignVersionRename"]
       89 CALL                             R15 1 1
       90 CALL                             R15 0 1
       91 GETIMPORT                        R16 K8 [require]
       93 GETTABLEKS                       R18 R0 K27 ["Util"]
       95 GETTABLEKS                       R17 R18 K28 ["getStudioSettings"]
       97 CALL                             R16 1 1
       98 NEWTABLE                         R17 0 3
