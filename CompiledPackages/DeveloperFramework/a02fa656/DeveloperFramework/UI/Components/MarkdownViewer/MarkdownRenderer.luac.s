...
PROTO_1:
        ...
        2 LOADK                            R2 K2 ["[Defaullt link callback]: URL [%*] is clicked"]
        3 MOVE                             R4 R0
...
PROTO_5:
       ...
       12 LOADK                            R4 K4 ["No renderer found for node: $%*"]
       13 GETTABLEKS                       R6 R0 K1 ["name"]
...
PROTO_6:
       ...
       22 LOADK                            R11 K4 ["No renderer found for node: $%*"]
       23 GETTABLEKS                       R13 R7 K1 ["name"]
       ...
       37 LENGTH                           R9 R8
       38 LOADN                            R10 0
       39 JUMPIFNOTLT                      R10 R9 ; [+15]
       41 MOVE                             R9 R8
       42 LOADNIL                          R10
       43 LOADNIL                          R11
       44 FORGPREP                         R9
       45 FASTCALL2                        TABLE_INSERT R2 R13 ; [+5]
       47 MOVE                             R15 R2
       48 MOVE                             R16 R13
       49 GETIMPORT                        R14 K8 [table.insert]
       51 CALL                             R14 2 0
       52 FORGLOOP                         R9 2 ; [-8]
       54 JUMP                             ; [+7]
       55 FASTCALL2                        TABLE_INSERT R2 R8 ; [+5]
       57 MOVE                             R10 R2
       58 MOVE                             R11 R8
       59 GETIMPORT                        R9 K8 [table.insert]
       61 CALL                             R9 2 0
       62 FORGLOOP                         R3 2 ; [-53]
       64 RETURN                           R2 1
...
PROTO_13:
       ...
       51 LOADK                            R19 K17 ["No renderer found for node: $%*"]
       52 GETTABLEKS                       R21 R16 K1 ["name"]
       54 NAMECALL                         R19 R19 K18 ["format"]
       56 CALL                             R19 2 1
       57 CALL                             R18 1 0
       58 LOADNIL                          R15
       59 JUMP                             ; [+5]
       ...
       63 CALL                             R18 2 1
       64 MOVE                             R15 R18
       65 SETTABLEKS                       R15 R14 K7 ["Item"]
       67 GETUPVAL                         R16 1
       68 GETTABLEKS                       R16 R16 K10 ["join"]
       70 MOVE                             R17 R3
       71 DUPTABLE                         R18 K20 [{["index"] = 2}]
       72 CALL                             R16 2 1
       73 JUMPIF                           R16 ; [+2]
       74 LOADNIL                          R15
       75 JUMP                             ; [+23]
       76 GETUPVAL                         R18 2
       77 GETTABLEKS                       R18 R18 K14 ["renderers"]
       79 GETTABLEKS                       R19 R16 K1 ["name"]
       81 GETTABLE                         R17 R18 R19
       82 JUMPIF                           R17 ; [+11]
       83 GETIMPORT                        R18 K16 [warn]
       85 LOADK                            R19 K17 ["No renderer found for node: $%*"]
       86 GETTABLEKS                       R21 R16 K1 ["name"]
       88 NAMECALL                         R19 R19 K18 ["format"]
       90 CALL                             R19 2 1
       91 CALL                             R18 1 0
       92 LOADNIL                          R15
       93 JUMP                             ; [+5]
       ...
       97 CALL                             R18 2 1
       98 MOVE                             R15 R18
       99 SETTABLEKS                       R15 R14 K8 ["List"]
      101 CALL                             R11 3 -1
      102 FASTCALL                         TABLE_INSERT ; [+2]
      103 GETIMPORT                        R8 K23 [table.insert]
      105 CALL                             R8 -1 0
      106 LOADNIL                          R3
      107 JUMP                             ; [+10]
      108 MOVE                             R9 R2
      ...
      115 GETIMPORT                        R8 K23 [table.insert]
      117 CALL                             R8 -1 0
      118 FORNLOOP                         R4
      119 GETUPVAL                         R4 0
      120 GETTABLEKS                       R4 R4 K3 ["createElement"]
      122 GETUPVAL                         R5 4
      123 NEWTABLE                         R6 8 0
      125 GETTABLEKS                       R8 R0 K11 ["index"]
      127 FASTCALL1                        TOSTRING R8 ; [+2]
      128 GETIMPORT                        R7 K25 [tostring]
      130 CALL                             R7 1 1
      131 SETTABLEKS                       R7 R6 K26 ["key"]
      133 GETTABLEKS                       R7 R0 K11 ["index"]
      135 SETTABLEKS                       R7 R6 K27 ["LayoutOrder"]
      137 SETTABLEKS                       R2 R6 K28 ["Items"]
      139 LOADB                            R7 1
      140 SETTABLEKS                       R7 R6 K29 ["TextWrapped"]
      142 GETUPVAL                         R7 0
      143 GETTABLEKS                       R7 R7 K5 ["Tag"]
      145 LOADK                            R8 K30 ["X-FitY"]
