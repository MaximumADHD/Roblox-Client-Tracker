...
PROTO_2:
       ...
       25 LOADK                            R4 K6 ["WARN: %* has no mapping"]
       26 GETTABLEKS                       R6 R0 K3 ["Style"]
       28 NAMECALL                         R4 R4 K7 ["format"]
       30 CALL                             R4 2 1
       31 CALL                             R3 1 0
       32 GETTABLEKS                       R4 R0 K3 ["Style"]
       34 JUMPIFNOTEQKS                    R4 K8 ["Close"] ; [+3]
       36 LOADK                            R3 K9 ["rbxasset://textures/StudioSharedUI/clear.png"]
       37 JUMP                             ; [+2]
       38 GETTABLEKS                       R3 R0 K10 ["Icon"]
       40 GETUPVAL                         R4 4
       41 MOVE                             R5 R0
       42 DUPTABLE                         R6 K14 [{"LeftIcon", "TooltipText", "Disabled", "TextXAlignment"}]
       43 SETTABLEKS                       R3 R6 K11 ["LeftIcon"]
       45 GETTABLEKS                       R7 R0 K15 ["Tooltip"]
       47 SETTABLEKS                       R7 R6 K12 ["TooltipText"]
       49 SETTABLEKS                       R1 R6 K1 ["Disabled"]
       51 GETTABLEKS                       R7 R0 K13 ["TextXAlignment"]
       53 JUMPIF                           R7 ; [+2]
       54 GETIMPORT                        R7 K18 [Enum.TextXAlignment.Center]
       56 SETTABLEKS                       R7 R6 K13 ["TextXAlignment"]
       58 MOVE                             R7 R2
       59 CALL                             R4 3 -1
       60 RETURN                           R4 -1
