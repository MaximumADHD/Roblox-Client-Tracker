PROTO_0:
        ...
        3 GETTABLEKS                       R1 R1 K1 ["GetItemId"]
        5 JUMPIFNOT                        R1 ; [+8]
        6 GETUPVAL                         R1 0
        7 GETTABLEKS                       R1 R1 K0 ["props"]
        9 GETTABLEKS                       R1 R1 K1 ["GetItemId"]
       11 MOVE                             R2 R0
       12 CALL                             R1 1 -1
       13 RETURN                           R1 -1
       14 RETURN                           R0 1
...
PROTO_1:
        ...
        1 JUMPIFNOT                        R2 ; [+7]
        2 GETUPVAL                         R1 1
        3 GETTABLEKS                       R1 R1 K0 ["getItemId"]
       ...
       11 NEWTABLE                         R2 1 0
       13 GETUPVAL                         R5 1
       14 GETTABLEKS                       R5 R5 K2 ["props"]
       16 GETTABLEKS                       R5 R5 K3 ["Expansion"]
       18 GETTABLE                         R4 R5 R1
       19 NOT                              R3 R4
       20 SETTABLE                         R3 R2 R1
       21 GETUPVAL                         R3 1
       22 GETTABLEKS                       R3 R3 K2 ["props"]
       24 GETTABLEKS                       R3 R3 K4 ["OnExpansionChange"]
       26 MOVE                             R4 R2
       27 CALL                             R3 1 0
       28 RETURN                           R0 0
...
PROTO_2:
       ...
       18 GETTABLEKS                       R3 R3 K3 ["OnSelectionChange"]
       20 MOVE                             R4 R2
       21 CALL                             R3 1 0
       22 RETURN                           R0 0
...
PROTO_3:
        ...
        3 JUMPIFNOT                        R6 ; [+7]
        4 GETUPVAL                         R5 1
        5 GETTABLEKS                       R5 R5 K1 ["getItemId"]
        7 GETTABLEKS                       R6 R0 K0 ["item"]
        9 CALL                             R5 1 1
       10 JUMP                             ; [+2]
       11 GETTABLEKS                       R5 R0 K0 ["item"]
       13 GETUPVAL                         R6 1
       14 GETTABLEKS                       R6 R6 K2 ["props"]
       ...
       44 GETUPVAL                         R11 1
       45 GETTABLEKS                       R11 R11 K20 ["toggleRow"]
       47 SETTABLEKS                       R11 R10 K11 ["onToggled"]
       49 GETUPVAL                         R11 1
       50 GETTABLEKS                       R11 R11 K21 ["selectRow"]
...
MAIN:
       ...
       13 CALL                             R1 2 1
       14 GETTABLEKS                       R1 R1 K8 ["Parent"]
       16 GETIMPORT                        R2 K10 [require]
       18 GETTABLEKS                       R3 R1 K8 ["Parent"]
       20 GETTABLEKS                       R3 R3 K11 ["Roact"]
       22 CALL                             R2 1 1
       23 GETIMPORT                        R3 K10 [require]
       25 GETTABLEKS                       R4 R1 K6 ["UI"]
       27 GETTABLEKS                       R4 R4 K12 ["ContextServices"]
       29 CALL                             R3 1 1
       30 GETTABLEKS                       R4 R3 K13 ["withContext"]
       32 GETIMPORT                        R5 K10 [require]
       34 GETTABLEKS                       R6 R1 K14 ["Util"]
       36 GETTABLEKS                       R6 R6 K15 ["Typecheck"]
       38 CALL                             R5 1 1
       39 GETTABLEKS                       R6 R1 K6 ["UI"]
       41 GETIMPORT                        R7 K10 [require]
       43 GETTABLEKS                       R8 R6 K16 ["Components"]
       45 GETTABLEKS                       R8 R8 K17 ["TreeView"]
       47 CALL                             R7 1 1
       48 GETIMPORT                        R8 K10 [require]
       50 GETIMPORT                        R9 K5 [script]
       52 GETTABLEKS                       R9 R9 K18 ["InstanceTreeRow"]
       54 CALL                             R8 1 1
