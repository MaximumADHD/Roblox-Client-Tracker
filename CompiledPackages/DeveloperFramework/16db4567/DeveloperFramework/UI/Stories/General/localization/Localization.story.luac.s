...
MAIN:
       ...
       20 GETTABLEKS                       R3 R4 K9 ["ContextServices"]
       22 CALL                             R2 1 1
       23 GETTABLEKS                       R3 R2 K10 ["Plugin"]
       25 GETTABLEKS                       R4 R2 K11 ["Localization"]
       27 GETIMPORT                        R7 K1 [script]
       29 GETTABLEKS                       R6 R7 K4 ["Parent"]
       31 GETTABLEKS                       R5 R6 K12 ["SourceStrings"]
       33 GETIMPORT                        R8 K1 [script]
       35 GETTABLEKS                       R7 R8 K4 ["Parent"]
       37 GETTABLEKS                       R6 R7 K13 ["LocalizedStrings"]
       39 GETTABLEKS                       R7 R3 K14 ["new"]
       41 GETIMPORT                        R8 K16 [plugin]
       43 CALL                             R7 1 1
       44 GETTABLEKS                       R8 R4 K14 ["new"]
       46 DUPTABLE                         R9 K20 [{"stringResourceTable", "translationResourceTable", "pluginName"}]
       47 SETTABLEKS                       R5 R9 K17 ["stringResourceTable"]
       49 SETTABLEKS                       R6 R9 K18 ["translationResourceTable"]
       51 LOADK                            R10 K21 ["TestFramework"]
       52 SETTABLEKS                       R10 R9 K19 ["pluginName"]
       54 CALL                             R8 1 1
       55 DUPCLOSURE                       R9 K22 [PROTO_0]
       56 CAPTURE                          VAL R4
       57 CAPTURE                          VAL R1
       58 SETGLOBAL                        R9 K23 ["Label"]
       60 GETTABLEKS                       R9 R2 K24 ["provide"]
       62 NEWTABLE                         R10 0 2
       64 MOVE                             R11 R7
       65 MOVE                             R12 R8
       66 SETLIST                          R10 R11 2 [1]
       68 DUPTABLE                         R11 K25 [{"Label"}]
       69 GETTABLEKS                       R12 R1 K26 ["createElement"]
       71 GETGLOBAL                        R13 K23 ["Label"]
       73 DUPTABLE                         R14 K28 [{"name"}]
       74 LOADK                            R15 K29 ["ZeroIndex"]
       75 SETTABLEKS                       R15 R14 K27 ["name"]
       77 CALL                             R12 2 1
       78 SETTABLEKS                       R12 R11 K23 ["Label"]
       80 CALL                             R9 2 -1
       81 RETURN                           R9 -1
