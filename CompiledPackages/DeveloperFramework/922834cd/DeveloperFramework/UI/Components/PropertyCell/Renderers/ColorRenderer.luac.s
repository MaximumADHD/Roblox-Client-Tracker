...
PROTO_2:
        ...
        3 GETTABLEKS                       R0 R1 K1 ["OnChanged"]
        5 GETUPVAL                         R3 0
        6 GETTABLEKS                       R2 R3 K2 ["state"]
        8 GETTABLEKS                       R1 R2 K3 ["ColorValue"]
       10 CALL                             R0 1 0
       11 GETUPVAL                         R1 0
       12 GETTABLEKS                       R0 R1 K4 ["onClose"]
       14 CALL                             R0 0 0
       15 RETURN                           R0 0
...
PROTO_5:
        ...
        9 GETTABLEKS                       R3 R4 K3 ["OnChanged"]
       11 MOVE                             R4 R2
       12 CALL                             R3 1 0
       13 RETURN                           R0 0
...
PROTO_6:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R1 R2 K0 ["cellRef"]
        3 JUMPIFNOT                        R1 ; [+6]
        4 GETUPVAL                         R3 0
        5 GETTABLEKS                       R2 R3 K0 ["cellRef"]
        7 GETTABLEKS                       R1 R2 K1 ["current"]
        9 JUMPIF                           R1 ; [+2]
       10 LOADNIL                          R1
       11 RETURN                           R1 1
       12 GETUPVAL                         R4 0
       13 GETTABLEKS                       R3 R4 K0 ["cellRef"]
       15 GETTABLEKS                       R2 R3 K1 ["current"]
       17 GETTABLEKS                       R1 R2 K2 ["AbsolutePosition"]
       19 GETUPVAL                         R5 0
       20 GETTABLEKS                       R4 R5 K0 ["cellRef"]
       22 GETTABLEKS                       R3 R4 K1 ["current"]
       24 GETTABLEKS                       R2 R3 K3 ["AbsoluteSize"]
...
PROTO_7:
       ...
       10 GETTABLEKS                       R3 R0 K5 ["props"]
       12 GETTABLEKS                       R2 R3 K6 ["Value"]
...
PROTO_8:
       ...
       27 GETUPVAL                         R10 0
       28 GETTABLEKS                       R9 R10 K5 ["createElement"]
       30 GETUPVAL                         R10 3
       ...
       70 GETUPVAL                         R14 0
       71 GETTABLEKS                       R13 R14 K5 ["createElement"]
       73 GETUPVAL                         R14 4
       ...
       88 GETUPVAL                         R14 0
       89 GETTABLEKS                       R13 R14 K5 ["createElement"]
       91 GETUPVAL                         R14 4
...
MAIN:
       ...
       41 GETTABLEKS                       R5 R6 K12 ["Components"]
