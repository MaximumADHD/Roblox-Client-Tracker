PROTO_0:
        ...
        5 JUMPIFNOT                        R1 ; [+7]
        6 GETUPVAL                         R2 0
        7 GETTABLEKS                       R1 R2 K1 ["callback"]
...
PROTO_1:
        ...
        6 JUMPIF                           R1 ; [+7]
        7 GETUPVAL                         R3 0
        8 GETTABLEKS                       R2 R3 K1 ["callback"]
...
PROTO_8:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R1 R2 K0 ["userdata"]
        3 MOVE                             R2 R0
        4 CALL                             R1 1 -1
        5 RETURN                           R1 -1
...
PROTO_10:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R1 R2 K0 ["isEnumValue"]
        3 MOVE                             R2 R0
        4 CALL                             R1 1 1
        5 JUMPIFNOT                        R1 ; [+2]
        6 LOADB                            R1 1
...
PROTO_13:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R0 R1 K0 ["strictInterface"]
        3 DUPTABLE                         R1 K7 [{"UpVotes", "DownVotes", "VoteCount", "UpVotePercent", "CanVote", "UserVote"}]
        4 GETUPVAL                         R3 0
        5 GETTABLEKS                       R2 R3 K8 ["integer"]
        7 SETTABLEKS                       R2 R1 K1 ["UpVotes"]
        9 GETUPVAL                         R3 0
       10 GETTABLEKS                       R2 R3 K8 ["integer"]
       12 SETTABLEKS                       R2 R1 K2 ["DownVotes"]
       14 GETUPVAL                         R3 0
       15 GETTABLEKS                       R2 R3 K8 ["integer"]
       17 SETTABLEKS                       R2 R1 K3 ["VoteCount"]
       19 GETUPVAL                         R3 0
       20 GETTABLEKS                       R2 R3 K8 ["integer"]
       22 SETTABLEKS                       R2 R1 K4 ["UpVotePercent"]
       24 GETUPVAL                         R3 0
       25 GETTABLEKS                       R2 R3 K9 ["optional"]
       27 GETUPVAL                         R4 0
       28 GETTABLEKS                       R3 R4 K10 ["boolean"]
       30 CALL                             R2 1 1
       31 SETTABLEKS                       R2 R1 K5 ["CanVote"]
       33 GETUPVAL                         R3 0
       34 GETTABLEKS                       R2 R3 K9 ["optional"]
       36 GETUPVAL                         R4 0
       37 GETTABLEKS                       R3 R4 K10 ["boolean"]
       39 CALL                             R2 1 1
...
MAIN:
       ...
       11 GETTABLEKS                       R3 R0 K2 ["Util"]
       13 GETTABLEKS                       R2 R3 K7 ["StyleModifier"]
       15 CALL                             R1 1 1
       16 GETIMPORT                        R2 K6 [require]
       18 GETIMPORT                        R5 K1 [script]
       20 GETTABLEKS                       R4 R5 K4 ["Parent"]
       22 GETTABLEKS                       R3 R4 K8 ["t"]
       24 CALL                             R2 1 1
       25 NEWTABLE                         R3 16 0
