...
MAIN:
       ...
       27 GETTABLEKS                       R4 R4 K10 ["getFFlagDevFrameworkDragBarStylesheets"]
       29 CALL                             R3 1 1
       ...
       51 GETTABLEKS                       R6 R0 K13 ["Styling"]
       53 GETTABLEKS                       R6 R6 K14 ["supportsStyleSheets"]
       55 CALL                             R5 1 1
       56 GETIMPORT                        R6 K6 [require]
       58 GETTABLEKS                       R7 R0 K13 ["Styling"]
       60 GETTABLEKS                       R7 R7 K15 ["joinTags"]
       62 CALL                             R6 1 1
       63 GETIMPORT                        R7 K6 [require]
       65 GETTABLEKS                       R8 R0 K2 ["UI"]
       67 GETTABLEKS                       R8 R8 K7 ["ContextServices"]
       69 GETTABLEKS                       R8 R8 K16 ["Mouse"]
       71 CALL                             R7 1 1
       72 GETTABLEKS                       R8 R1 K17 ["withContext"]
       74 GETIMPORT                        R9 K6 [require]
       76 GETTABLEKS                       R10 R0 K18 ["Util"]
       78 GETTABLEKS                       R10 R10 K19 ["Typecheck"]
       80 GETTABLEKS                       R10 R10 K20 ["t"]
       82 CALL                             R9 1 1
       83 GETIMPORT                        R10 K6 [require]
       85 GETIMPORT                        R11 K1 [script]
       87 GETTABLEKS                       R11 R11 K21 ["style"]
       89 CALL                             R10 1 1
       90 GETTABLEKS                       R11 R0 K2 ["UI"]
       92 GETIMPORT                        R12 K6 [require]
       94 GETTABLEKS                       R13 R11 K22 ["Components"]
       96 GETTABLEKS                       R13 R13 K23 ["Pane"]
       98 CALL                             R12 1 1
       99 GETIMPORT                        R13 K6 [require]
      101 GETTABLEKS                       R14 R0 K4 ["Parent"]
      103 GETTABLEKS                       R14 R14 K24 ["Dash"]
      105 CALL                             R13 1 1
      106 GETTABLEKS                       R14 R13 K25 ["join"]
      108 GETIMPORT                        R15 K6 [require]
      110 GETIMPORT                        R16 K1 [script]
      112 GETTABLEKS                       R16 R16 K26 ["styles"]
      114 CALL                             R15 1 1
      115 GETIMPORT                        R16 K6 [require]
      117 GETTABLEKS                       R17 R0 K27 ["Wrappers"]
      119 GETTABLEKS                       R17 R17 K28 ["withControl"]
      121 CALL                             R16 1 1
