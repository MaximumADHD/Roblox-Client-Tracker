PROTO_0:
        ...
        6 GETUPVAL                         R6 0
        7 GETTABLEKS                       R5 R6 K8 ["string"]
        9 SETTABLEKS                       R5 R4 K2 ["Text"]
       11 GETUPVAL                         R6 0
       12 GETTABLEKS                       R5 R6 K9 ["callback"]
       14 SETTABLEKS                       R5 R4 K3 ["OnLinkClicked"]
       16 GETUPVAL                         R6 0
       17 GETTABLEKS                       R5 R6 K8 ["string"]
       19 SETTABLEKS                       R5 R4 K4 ["LinkText"]
       21 GETUPVAL                         R6 0
       22 GETTABLEKS                       R5 R6 K8 ["string"]
       24 SETTABLEKS                       R5 R4 K5 ["LinkPlaceholder"]
       26 GETUPVAL                         R6 0
       27 GETTABLEKS                       R5 R6 K1 ["interface"]
       29 DUPTABLE                         R6 K12 [{"TextSize", "Font"}]
       30 GETUPVAL                         R8 0
       31 GETTABLEKS                       R7 R8 K13 ["integer"]
       33 SETTABLEKS                       R7 R6 K10 ["TextSize"]
       35 GETUPVAL                         R8 0
       36 GETTABLEKS                       R7 R8 K14 ["enum"]
...
PROTO_1:
        ...
        1 MOVE                             R3 R0
        2 GETUPVAL                         R5 1
        3 GETTABLEKS                       R4 R5 K0 ["TextSize"]
        5 GETUPVAL                         R6 1
        6 GETTABLEKS                       R5 R6 K1 ["Font"]
...
PROTO_3:
       ...
       14 GETUPVAL                         R4 3
       15 GETUPVAL                         R7 4
       16 GETTABLEKS                       R6 R7 K3 ["Dictionary"]
       18 GETTABLEKS                       R5 R6 K4 ["join"]
...
PROTO_4:
        ...
        6 CALL                             R1 1 1
        7 GETUPVAL                         R3 3
        8 GETTABLEKS                       R2 R3 K1 ["createElement"]
       10 GETUPVAL                         R3 4
...
PROTO_5:
      ...
      106 GETUPVAL                         R27 2
      107 GETTABLEKS                       R26 R27 K19 ["createElement"]
      109 GETUPVAL                         R27 8
      ...
      127 GETUPVAL                         R21 2
      128 GETTABLEKS                       R20 R21 K19 ["createElement"]
      130 GETUPVAL                         R21 8
...
MAIN:
       ...
       24 GETTABLEKS                       R5 R1 K8 ["Parent"]
       26 GETTABLEKS                       R4 R5 K12 ["Cryo"]
       28 CALL                             R3 1 1
       29 GETIMPORT                        R4 K10 [require]
       31 GETTABLEKS                       R6 R1 K6 ["UI"]
       33 GETTABLEKS                       R5 R6 K13 ["ContextServices"]
       35 CALL                             R4 1 1
       36 GETTABLEKS                       R5 R4 K14 ["withContext"]
       38 GETIMPORT                        R6 K10 [require]
       40 GETTABLEKS                       R9 R1 K6 ["UI"]
       42 GETTABLEKS                       R8 R9 K15 ["Components"]
       44 GETTABLEKS                       R7 R8 K16 ["LinkText"]
       46 CALL                             R6 1 1
       47 GETIMPORT                        R7 K10 [require]
       49 GETTABLEKS                       R10 R1 K6 ["UI"]
       51 GETTABLEKS                       R9 R10 K15 ["Components"]
       53 GETTABLEKS                       R8 R9 K17 ["Pane"]
       55 CALL                             R7 1 1
       56 GETIMPORT                        R8 K10 [require]
       58 GETTABLEKS                       R11 R1 K6 ["UI"]
       60 GETTABLEKS                       R10 R11 K15 ["Components"]
       62 GETTABLEKS                       R9 R10 K18 ["TextLabel"]
       64 CALL                             R8 1 1
       65 GETIMPORT                        R9 K10 [require]
       67 GETTABLEKS                       R12 R1 K19 ["Util"]
       69 GETTABLEKS                       R11 R12 K20 ["Typecheck"]
       71 GETTABLEKS                       R10 R11 K21 ["t"]
       73 CALL                             R9 1 1
       74 GETIMPORT                        R10 K10 [require]
       76 GETTABLEKS                       R12 R1 K19 ["Util"]
       78 GETTABLEKS                       R11 R12 K22 ["LayoutOrderIterator"]
       80 CALL                             R10 1 1
       81 GETIMPORT                        R11 K10 [require]
       83 GETTABLEKS                       R13 R1 K23 ["SharedFlags"]
       85 GETTABLEKS                       R12 R13 K24 ["getFFlagDevFrameworkFixMissingKeyErrors"]
       87 CALL                             R11 1 1
       88 CALL                             R11 0 1
       89 GETIMPORT                        R12 K10 [require]
       91 GETTABLEKS                       R14 R1 K19 ["Util"]
       93 GETTABLEKS                       R13 R14 K25 ["isRoact17"]
       95 CALL                             R12 1 1
       96 MOVE                             R13 R2
       97 CALL                             R12 1 1
