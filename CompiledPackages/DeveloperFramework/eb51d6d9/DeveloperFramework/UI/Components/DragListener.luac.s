PROTO_0:
        ...
        9 GETTABLEKS                       R2 R3 K5 ["OnDragMoved"]
       11 JUMPIFNOT                        R2 ; [+7]
       12 GETUPVAL                         R4 0
       13 GETTABLEKS                       R3 R4 K4 ["props"]
       15 GETTABLEKS                       R2 R3 K5 ["OnDragMoved"]
       17 MOVE                             R3 R1
       18 CALL                             R2 1 0
       19 RETURN                           R0 0
...
PROTO_1:
        ...
        3 GETTABLEKS                       R0 R1 K1 ["OnDragEnded"]
        5 JUMPIFNOT                        R0 ; [+6]
        6 GETUPVAL                         R2 0
        7 GETTABLEKS                       R1 R2 K0 ["props"]
        9 GETTABLEKS                       R0 R1 K1 ["OnDragEnded"]
       11 CALL                             R0 0 0
       12 RETURN                           R0 0
...
PROTO_3:
       ...
       28 GETUPVAL                         R10 0
       29 GETTABLEKS                       R9 R10 K12 ["Event"]
       31 GETTABLEKS                       R8 R9 K13 ["InputChanged"]
       33 GETTABLEKS                       R9 R0 K14 ["inputChanged"]
       35 SETTABLE                         R9 R7 R8
       36 GETUPVAL                         R10 0
       37 GETTABLEKS                       R9 R10 K12 ["Event"]
       39 GETTABLEKS                       R8 R9 K15 ["InputEnded"]
       41 GETTABLEKS                       R9 R0 K3 ["inputEnded"]
       43 SETTABLE                         R9 R7 R8
       44 GETUPVAL                         R10 0
       45 GETTABLEKS                       R9 R10 K12 ["Event"]
       47 GETTABLEKS                       R8 R9 K16 ["MouseButton1Up"]
       49 GETTABLEKS                       R9 R0 K3 ["inputEnded"]
       51 SETTABLE                         R9 R7 R8
       52 GETUPVAL                         R10 0
       53 GETTABLEKS                       R9 R10 K12 ["Event"]
       55 GETTABLEKS                       R8 R9 K17 ["MouseButton2Up"]
       57 GETTABLEKS                       R9 R0 K3 ["inputEnded"]
       59 SETTABLE                         R9 R7 R8
       60 GETTABLEKS                       R9 R0 K18 ["props"]
       62 GETUPVAL                         R11 0
       63 GETTABLEKS                       R10 R11 K19 ["Children"]
...
MAIN:
       ...
       29 GETTABLEKS                       R4 R5 K11 ["CaptureFocus"]
       31 CALL                             R3 1 1
