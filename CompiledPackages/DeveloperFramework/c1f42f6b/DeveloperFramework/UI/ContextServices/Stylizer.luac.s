...
PROTO_2:
       ...
       24 GETUPVAL                         R9 0
       25 GETTABLEKS                       R8 R9 K6 ["Dictionary"]
       27 GETTABLEKS                       R7 R8 K7 ["join"]
       29 MOVE                             R8 R6
       30 NEWTABLE                         R9 1 0
       32 GETUPVAL                         R11 0
       33 GETTABLEKS                       R10 R11 K8 ["None"]
       35 SETTABLE                         R10 R9 R5
       36 CALL                             R7 2 1
       37 GETUPVAL                         R10 0
       38 GETTABLEKS                       R9 R10 K6 ["Dictionary"]
       40 GETTABLEKS                       R8 R9 K7 ["join"]
       42 MOVE                             R9 R7
       43 MOVE                             R10 R4
       44 CALL                             R8 2 1
       45 MOVE                             R4 R8
...
PROTO_6:
       ...
       12 CALL                             R6 1 1
       13 GETUPVAL                         R9 1
       14 GETTABLEKS                       R8 R9 K2 ["Dictionary"]
       16 GETTABLEKS                       R7 R8 K3 ["join"]
...
PROTO_14:
        ...
        2 CALL                             R0 1 0
        3 GETUPVAL                         R1 2
        4 GETTABLEKS                       R0 R1 K0 ["valuesChanged"]
        6 NEWCLOSURE                       R2 P0
        7 CAPTURE                          UPVAL U0
        8 CAPTURE                          UPVAL U1
...
PROTO_15:
       ...
       10 CAPTURE                          VAL R3
       11 GETUPVAL                         R7 0
       12 GETTABLEKS                       R6 R7 K2 ["useState"]
       14 MOVE                             R7 R5
       15 CALL                             R6 1 2
       16 GETUPVAL                         R9 0
       17 GETTABLEKS                       R8 R9 K3 ["useEffect"]
       19 NEWCLOSURE                       R9 P1
       20 CAPTURE                          VAL R7
       21 CAPTURE                          VAL R5
       22 CAPTURE                          VAL R4
...
PROTO_17:
       ...
       80 LOADB                            R7 0 +1
       81 LOADB                            R7 1
       82 GETTABLEKS                       R9 R1 K0 ["props"]
       84 GETTABLEKS                       R8 R9 K22 ["StyleModifier"]
       86 JUMPIF                           R8 ; [+7]
       87 JUMPIFNOT                        R7 ; [+2]
       88 LOADNIL                          R8
       89 JUMP                             ; [+4]
       90 GETTABLEKS                       R9 R1 K16 ["state"]
       92 GETTABLEKS                       R8 R9 K22 ["StyleModifier"]
...
MAIN:
       ...
       20 GETTABLEKS                       R3 R4 K9 ["ComponentSymbols"]
       22 CALL                             R2 1 1
       23 GETIMPORT                        R3 K6 [require]
       25 GETTABLEKS                       R5 R0 K8 ["Style"]
       27 GETTABLEKS                       R4 R5 K10 ["StyleKey"]
       29 CALL                             R3 1 1
       30 GETIMPORT                        R4 K6 [require]
       32 GETTABLEKS                       R7 R0 K2 ["UI"]
       34 GETTABLEKS                       R6 R7 K11 ["ContextServices"]
       36 GETTABLEKS                       R5 R6 K12 ["ContextItem"]
       38 CALL                             R4 1 1
