PROTO_0:
       ...
       29 GETUPVAL                         R13 2
       30 GETTABLEKS                       R12 R13 K13 ["numberMin"]
       32 LOADN                            R13 0
       33 CALL                             R12 1 1
       34 MOVE                             R13 R10
       35 CALL                             R12 1 1
       ...
       41 CALL                             R11 2 0
       42 GETUPVAL                         R13 2
       43 GETTABLEKS                       R12 R13 K13 ["numberMin"]
       45 LOADN                            R13 0
       46 CALL                             R12 1 1
       47 MOVE                             R13 R9
       48 CALL                             R12 1 1
       ...
       82 GETUPVAL                         R14 3
       83 GETTABLEKS                       R13 R14 K24 ["createElement"]
       85 GETUPVAL                         R14 4
       86 GETUPVAL                         R16 5
       87 GETTABLEKS                       R15 R16 K25 ["join"]
      ...
      122 GETUPVAL                         R18 3
      123 GETTABLEKS                       R17 R18 K24 ["createElement"]
...
MAIN:
       ...
       34 GETTABLEKS                       R8 R0 K11 ["Util"]
       36 GETTABLEKS                       R7 R8 K12 ["Typecheck"]
       38 GETTABLEKS                       R6 R7 K13 ["t"]
       40 CALL                             R5 1 1
       41 GETIMPORT                        R6 K6 [require]
       43 GETTABLEKS                       R8 R0 K14 ["Styling"]
       45 GETTABLEKS                       R7 R8 K15 ["joinTags"]
       47 CALL                             R6 1 1
       48 GETIMPORT                        R7 K6 [require]
       50 GETTABLEKS                       R9 R0 K11 ["Util"]
       52 GETTABLEKS                       R8 R9 K16 ["React"]
       54 CALL                             R7 1 1
       55 GETIMPORT                        R8 K6 [require]
       57 GETTABLEKS                       R10 R0 K14 ["Styling"]
       59 GETTABLEKS                       R9 R10 K17 ["supportsStyleSheets"]
       61 CALL                             R8 1 1
       62 GETIMPORT                        R9 K6 [require]
       64 GETTABLEKS                       R11 R0 K11 ["Util"]
       66 GETTABLEKS                       R10 R11 K12 ["Typecheck"]
       68 CALL                             R9 1 1
       69 GETIMPORT                        R10 K6 [require]
       71 GETTABLEKS                       R13 R0 K2 ["UI"]
       73 GETTABLEKS                       R12 R13 K18 ["Components"]
       75 GETTABLEKS                       R11 R12 K19 ["Pane"]
       77 CALL                             R10 1 1
