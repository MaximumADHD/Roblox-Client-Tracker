...
local getFFlagDevFrameworkAddPopupPassesThroughMouseEventsProp =
	require(Framework.SharedFlags.getFFlagDevFrameworkAddPopupPassesThroughMouseEventsProp)
...
local Popup = createPluginWidget("Popup", function(props)
	...
	local options = {
		...
		Popup = {
			...
			PassesThroughMouseEvents = if getFFlagDevFrameworkAddPopupPassesThroughMouseEventsProp()
				then props.PassesThroughMouseEvents
				else nil,
