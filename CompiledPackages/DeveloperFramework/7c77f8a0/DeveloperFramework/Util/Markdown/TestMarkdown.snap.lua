...
local markdown = if FFlagDevFrameworkMarkdownCommonMarkCompliance
	then [==[
	...
	children = {
		...
		},
		{
			children = {
				...
				if FFlagDevFrameworkMarkdownCommonMarkCompliance
					then {
  ...
  def fact
    (1..self).reduce(:*) || 1
		...
		},
		{
			...
			children = {
				...
				},
				{
					...
					offset = 730,
					text = "link",
					url = if not FFlagDevFrameworkMarkdownCommonMarkCompliance then "http://example.com" else nil,
					attributes = if FFlagDevFrameworkMarkdownCommonMarkCompliance
						then {
					...
					children = {
						{
							...
							children = {
								...
								},
								{
									...
									offset = 802,
									text = "link",
									url = if not FFlagDevFrameworkMarkdownCommonMarkCompliance
		...
		},
		{
			...
			isBlock = true,
			name = if FFlagDevFrameworkMarkdownCommonMarkCompliance then "DIVIDER" else "DIVIDER_2",
			offset = 889,
		},
		{
			attributes = {
		...
		},
		{
			...
			children = {
				...
				},
				{
					...
					offset = 1163,
					text = "Image",
					url = if not FFlagDevFrameworkMarkdownCommonMarkCompliance then "rbxassetid://123456" else nil,
					attributes = if FFlagDevFrameworkMarkdownCommonMarkCompliance
						then {
