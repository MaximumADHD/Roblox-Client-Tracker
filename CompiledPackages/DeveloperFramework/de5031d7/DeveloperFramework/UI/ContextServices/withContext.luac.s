PROTO_0:
       ...
       15 GETUPVAL                         R12 2
       16 GETTABLEKS                       R11 R12 K7 ["__componentName"]
       18 MOVE                             R12 R5
...
PROTO_3:
        ...
        2 GETUPVAL                         R6 0
        3 GETTABLEKS                       R5 R6 K1 ["Component"]
        5 GETTABLEKS                       R4 R5 K0 ["render"]
...
PROTO_5:
       ...
       29 FORGLOOP                         R2 2 ; [-24]
       31 GETUPVAL                         R4 2
       32 GETTABLEKS                       R3 R4 K6 ["Dictionary"]
       34 GETTABLEKS                       R2 R3 K7 ["join"]
       36 GETUPVAL                         R4 3
       37 GETTABLEKS                       R3 R4 K8 ["props"]
       39 MOVE                             R4 R1
       40 CALL                             R2 2 1
       41 GETUPVAL                         R4 4
       42 GETTABLEKS                       R3 R4 K9 ["createElement"]
       44 GETUPVAL                         R4 5
       45 MOVE                             R5 R2
       46 CALL                             R3 2 -1
       47 RETURN                           R3 -1
...
PROTO_7:
        ...
        4 CALL                             R1 1 1
        5 GETUPVAL                         R3 0
        6 GETTABLEKS                       R2 R3 K2 ["PureComponent"]
...
PROTO_10:
       ...
       26 MOVE                             R0 R1
       27 GETUPVAL                         R2 4
       28 GETTABLEKS                       R1 R2 K6 ["isEmpty"]
       30 GETUPVAL                         R2 5
       31 CALL                             R1 1 1
       32 JUMPIF                           R1 ; [+10]
       33 GETUPVAL                         R2 5
...
PROTO_11:
       ...
       17 JUMPIFNOT                        R1 ; [+24]
       18 GETUPVAL                         R4 1
       19 GETTABLEKS                       R3 R4 K1 ["Dictionary"]
       21 GETTABLEKS                       R2 R3 K2 ["join"]
       23 MOVE                             R3 R0
       24 NEWTABLE                         R4 1 0
       26 GETUPVAL                         R6 1
       27 GETTABLEKS                       R5 R6 K3 ["None"]
...
MAIN:
       ...
       29 GETTABLEKS                       R4 R5 K10 ["Context"]
       31 CALL                             R3 1 1
       32 GETIMPORT                        R4 K6 [require]
       34 GETTABLEKS                       R7 R0 K2 ["UI"]
       36 GETTABLEKS                       R6 R7 K9 ["ContextServices"]
       38 GETTABLEKS                       R5 R6 K11 ["Stylizer"]
       40 CALL                             R4 1 1
