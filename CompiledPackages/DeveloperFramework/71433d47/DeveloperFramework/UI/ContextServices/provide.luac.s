...
PROTO_3:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R1 R2 K0 ["Roact17"]
        3 JUMPIF                           R1 ; [+7]
        4 GETUPVAL                         R2 0
        5 GETTABLEKS                       R1 R2 K0 ["Roact17"]
        7 JUMPIF                           R1 ; [+22]
...
PROTO_4:
        ...
        3 GETUPVAL                         R4 1
        4 GETTABLEKS                       R3 R4 K1 ["Children"]
        6 GETTABLE                         R2 R1 R3
        7 GETUPVAL                         R3 2
        8 MOVE                             R4 R0
        9 GETUPVAL                         R6 0
       10 GETTABLEKS                       R5 R6 K2 ["state"]
       12 CALL                             R3 2 1
       13 GETUPVAL                         R5 1
       14 GETTABLEKS                       R4 R5 K3 ["createElement"]
       16 GETUPVAL                         R6 3
       17 GETTABLEKS                       R5 R6 K4 ["Provider"]
       ...
       27 GETUPVAL                         R5 4
       28 GETUPVAL                         R7 0
       29 GETTABLEKS                       R6 R7 K8 ["filteredItems"]
       31 NEWCLOSURE                       R7 P0
       32 CAPTURE                          VAL R1
       33 CAPTURE                          REF R4
       34 CALL                             R5 2 0
...
PROTO_8:
        ...
        2 GETUPVAL                         R7 0
        3 GETTABLEKS                       R6 R7 K3 ["state"]
        5 GETTABLEKS                       R5 R6 K0 ["count"]
        7 ADDK                             R4 R5 K2 [1]
...
MAIN:
       ...
       22 GETTABLEKS                       R3 R4 K9 ["Context"]
       24 CALL                             R2 1 1
