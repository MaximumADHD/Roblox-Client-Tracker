...
PROTO_1:
        ...
        3 GETTABLEKS                       R2 R3 K1 ["GetItemId"]
...
PROTO_2:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R1 R2 K0 ["getItemId"]
        3 GETTABLEKS                       R2 R0 K1 ["item"]
        5 CALL                             R1 1 1
        6 NEWTABLE                         R2 1 0
        8 GETUPVAL                         R7 0
        9 GETTABLEKS                       R6 R7 K2 ["props"]
       11 GETTABLEKS                       R5 R6 K3 ["Expansion"]
       13 GETTABLE                         R4 R5 R1
       14 NOT                              R3 R4
       15 SETTABLE                         R3 R2 R1
       16 GETUPVAL                         R5 0
       17 GETTABLEKS                       R4 R5 K2 ["props"]
       19 GETTABLEKS                       R3 R4 K4 ["OnExpansionChange"]
       21 MOVE                             R4 R2
       22 CALL                             R3 1 0
       23 RETURN                           R0 0
...
PROTO_3:
        ...
        6 RETURN                           R0 0
        7 GETUPVAL                         R2 0
        8 GETTABLEKS                       R1 R2 K2 ["getItemId"]
       ...
       20 GETTABLEKS                       R3 R4 K1 ["OnSelectionChange"]
       22 MOVE                             R4 R2
       23 CALL                             R3 1 0
       24 RETURN                           R0 0
...
PROTO_4:
        0 GETUPVAL                         R4 0
        1 GETTABLEKS                       R3 R4 K0 ["props"]
        3 GETTABLEKS                       R2 R3 K1 ["RightClick"]
        5 JUMPIF                           R2 ; [+1]
        6 RETURN                           R0 0
        7 GETUPVAL                         R4 0
        8 GETTABLEKS                       R3 R4 K0 ["props"]
       10 GETTABLEKS                       R2 R3 K1 ["RightClick"]
       12 MOVE                             R3 R0
       13 MOVE                             R4 R1
       14 CALL                             R2 2 0
       15 RETURN                           R0 0
...
PROTO_5:
        ...
        3 GETTABLEKS                       R2 R0 K2 ["props"]
        5 GETTABLEKS                       R1 R2 K3 ["GetItemId"]
        7 JUMPIF                           R1 ; [+2]
...
PROTO_8:
        ...
        4 GETTABLEKS                       R3 R4 K0 ["GetItemId"]
        6 JUMPIFEQ                         R2 R3 ; [+8]
...
PROTO_11:
        0 GETUPVAL                         R3 0
        1 GETTABLEKS                       R2 R3 K0 ["getItemId"]
...
PROTO_12:
        ...
        8 GETUPVAL                         R6 1
        9 GETTABLEKS                       R4 R6 K2 ["RootItems"]
       11 CALL                             R3 1 3
       ...
       35 GETUPVAL                         R5 1
       36 GETTABLEKS                       R4 R5 K7 ["Selection"]
       38 JUMPIFNOT                        R4 ; [+7]
       39 GETUPVAL                         R3 3
       40 GETUPVAL                         R5 1
       41 GETTABLEKS                       R4 R5 K7 ["Selection"]
       ...
       58 JUMPIF                           R4 ; [+11]
       59 GETUPVAL                         R5 5
       60 GETTABLEKS                       R4 R5 K10 ["None"]
       62 SETTABLEKS                       R4 R1 K9 ["selectedRow"]
       64 RETURN                           R1 1
       65 GETUPVAL                         R5 5
       66 GETTABLEKS                       R4 R5 K10 ["None"]
...
PROTO_15:
      ...
      186 JUMPIFNOT                        R5 ; [+21]
      187 GETUPVAL                         R6 5
      188 GETTABLEKS                       R5 R6 K51 ["Tag"]
      190 GETUPVAL                         R6 6
      191 LOADK                            R7 K52 ["Component-TreeTable"]
      192 GETUPVAL                         R10 5
      193 GETTABLEKS                       R9 R10 K51 ["Tag"]
      ...
      208 GETUPVAL                         R6 2
      209 GETTABLEKS                       R5 R6 K55 ["createElement"]
      211 GETUPVAL                         R6 7
      212 MOVE                             R7 R4
      213 CALL                             R5 2 -1
      214 RETURN                           R5 -1
...
MAIN:
       ...
       34 GETTABLEKS                       R7 R0 K12 ["Wrappers"]
       36 GETTABLEKS                       R6 R7 K13 ["withForwardRef"]
       38 CALL                             R5 1 1
       ...
       50 GETTABLEKS                       R7 R8 K14 ["React"]
       52 CALL                             R6 1 1
       53 JUMP                             ; [+1]
       54 LOADNIL                          R6
       55 GETIMPORT                        R7 K6 [require]
       57 GETTABLEKS                       R9 R0 K16 ["Styling"]
       59 GETTABLEKS                       R8 R9 K17 ["supportsStyleSheets"]
       61 CALL                             R7 1 1
       62 GETIMPORT                        R8 K6 [require]
       64 GETTABLEKS                       R10 R0 K16 ["Styling"]
       66 GETTABLEKS                       R9 R10 K18 ["joinTags"]
       68 CALL                             R8 1 1
       69 GETIMPORT                        R9 K6 [require]
       71 GETTABLEKS                       R11 R0 K19 ["SharedFlags"]
       73 GETTABLEKS                       R10 R11 K20 ["getFFlagLuaStartPageTableContextMenu"]
       75 CALL                             R9 1 1
       76 CALL                             R9 0 1
       77 GETIMPORT                        R10 K6 [require]
       79 GETTABLEKS                       R12 R0 K19 ["SharedFlags"]
       81 GETTABLEKS                       R11 R12 K21 ["getFFlagDevFrameworkFixTableMissingKeyErrors"]
       83 CALL                             R10 1 1
       84 CALL                             R10 0 1
       85 GETIMPORT                        R11 K6 [require]
       87 GETTABLEKS                       R13 R0 K4 ["Parent"]
       89 GETTABLEKS                       R12 R13 K22 ["Dash"]
       91 CALL                             R11 1 1
      ...
      102 GETTABLEKS                       R19 R0 K2 ["UI"]
      104 GETTABLEKS                       R18 R19 K29 ["Components"]
      106 GETTABLEKS                       R17 R18 K30 ["Table"]
      108 CALL                             R16 1 1
      109 GETIMPORT                        R17 K6 [require]
      111 GETIMPORT                        R19 K1 [script]
      113 GETTABLEKS                       R18 R19 K31 ["TreeTableCell"]
      115 CALL                             R17 1 1
