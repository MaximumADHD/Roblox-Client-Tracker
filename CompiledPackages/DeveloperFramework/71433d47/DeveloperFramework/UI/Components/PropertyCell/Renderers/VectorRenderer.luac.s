PROTO_0:
        ...
        6 JUMPIFNOT                        R2 ; [+5]
        7 GETUPVAL                         R3 1
        8 GETTABLEKS                       R2 R3 K2 ["GetChildren"]
       10 JUMPIFNOT                        R2 ; [+1]
       11 MOVE                             R1 R0
       12 GETUPVAL                         R3 2
       13 GETUPVAL                         R4 3
       ...
       22 GETUPVAL                         R4 5
       23 GETTABLEKS                       R3 R4 K3 ["OnChanged"]
       25 GETUPVAL                         R5 1
       26 GETTABLEKS                       R4 R5 K4 ["GetValue"]
       28 MOVE                             R5 R2
       29 CALL                             R4 1 -1
       30 CALL                             R3 -1 0
       31 RETURN                           R0 0
...
PROTO_1:
      ...
      107 GETUPVAL                         R17 3
      108 GETTABLEKS                       R16 R17 K34 ["createElement"]
      110 GETUPVAL                         R17 4
      ...
      172 MOVE                             R16 R17
      173 GETUPVAL                         R18 3
      174 GETTABLEKS                       R17 R18 K34 ["createElement"]
      176 GETUPVAL                         R18 6
      177 GETUPVAL                         R19 7
      ...
      205 GETUPVAL                         R23 10
      206 GETTABLEKS                       R22 R23 K56 ["Tag"]
      208 JUMPIFNOT                        R6 ; [+3]
      ...
      218 JUMPIFNOT                        R23 ; [+4]
      219 GETUPVAL                         R23 11
      220 GETTABLEKS                       R22 R23 K60 ["Error"]
      222 JUMP                             ; [+1]
      223 LOADNIL                          R22
      ...
      235 GETUPVAL                         R20 3
      236 GETTABLEKS                       R19 R20 K34 ["createElement"]
      238 GETUPVAL                         R20 12
      ...
      283 GETUPVAL                         R11 3
      284 GETTABLEKS                       R10 R11 K34 ["createElement"]
      286 GETUPVAL                         R11 12
...
MAIN:
       ...
       36 GETTABLEKS                       R8 R1 K8 ["Parent"]
       38 GETTABLEKS                       R7 R8 K15 ["Dash"]
       40 CALL                             R6 1 1
       ...
       54 GETTABLEKS                       R11 R1 K8 ["Parent"]
       56 GETTABLEKS                       R10 R11 K18 ["React"]
       58 CALL                             R9 1 1
       59 JUMP                             ; [+1]
       60 LOADNIL                          R9
       61 GETIMPORT                        R10 K10 [require]
       63 GETTABLEKS                       R12 R1 K20 ["Styling"]
       65 GETTABLEKS                       R11 R12 K21 ["supportsStyleSheets"]
       67 CALL                             R10 1 1
       68 GETTABLEKS                       R12 R1 K6 ["UI"]
       70 GETTABLEKS                       R11 R12 K22 ["Components"]
       72 GETIMPORT                        R12 K10 [require]
       74 GETTABLEKS                       R13 R11 K23 ["Pane"]
       76 CALL                             R12 1 1
       77 GETIMPORT                        R13 K10 [require]
       79 GETTABLEKS                       R16 R1 K6 ["UI"]
       81 GETTABLEKS                       R15 R16 K22 ["Components"]
       83 GETTABLEKS                       R14 R15 K24 ["TextInput"]
       85 CALL                             R13 1 1
       86 GETIMPORT                        R14 K10 [require]
       88 GETTABLEKS                       R15 R11 K25 ["TextLabel"]
       90 CALL                             R14 1 1
       91 GETIMPORT                        R15 K10 [require]
       93 GETTABLEKS                       R17 R1 K12 ["Util"]
       95 GETTABLEKS                       R16 R17 K26 ["StyleModifier"]
       97 CALL                             R15 1 1
       98 GETIMPORT                        R16 K10 [require]
      100 GETIMPORT                        R20 K5 [script]
      102 GETTABLEKS                       R19 R20 K8 ["Parent"]
      104 GETTABLEKS                       R18 R19 K8 ["Parent"]
      106 GETTABLEKS                       R17 R18 K27 ["Types"]
      108 CALL                             R16 1 1
      109 GETIMPORT                        R17 K10 [require]
      111 GETTABLEKS                       R19 R1 K28 ["SharedFlags"]
      113 GETTABLEKS                       R18 R19 K29 ["getFFlagDevFrameworkVectorRendererSize"]
      115 CALL                             R17 1 1
