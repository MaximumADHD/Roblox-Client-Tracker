PROTO_0:
       ...
       23 GETUPVAL                         R3 2
       24 GETTABLEKS                       R3 R3 K6 ["stubScript"]
       26 GETTABLEKS                       R4 R2 K7 ["Util"]
       28 GETTABLEKS                       R4 R4 K8 ["Typecheck"]
       30 GETTABLEKS                       R4 R4 K9 ["DocParser"]
       32 CALL                             R3 1 0
       33 GETUPVAL                         R3 2
       34 GETTABLEKS                       R3 R3 K6 ["stubScript"]
       36 GETTABLEKS                       R4 R2 K7 ["Util"]
       38 GETTABLEKS                       R4 R4 K10 ["Flags"]
       40 CALL                             R3 1 0
       41 GETUPVAL                         R3 2
       42 GETTABLEKS                       R3 R3 K6 ["stubScript"]
       44 GETTABLEKS                       R4 R2 K11 ["UI"]
       46 GETTABLEKS                       R4 R4 K12 ["ContextServices"]
       48 GETTABLEKS                       R4 R4 K13 ["Localization"]
       50 CALL                             R3 1 0
       51 GETUPVAL                         R3 2
       52 GETTABLEKS                       R3 R3 K6 ["stubScript"]
       54 GETTABLEKS                       R4 R2 K14 ["Style"]
       56 GETTABLEKS                       R4 R4 K15 ["Themes"]
       58 GETTABLEKS                       R4 R4 K16 ["StudioTheme"]
       60 CALL                             R3 1 0
       61 GETUPVAL                         R3 2
       62 GETTABLEKS                       R3 R3 K17 ["rewriteStaticFlagsWithCurrentValues"]
       64 MOVE                             R4 R2
       65 CALL                             R3 1 0
       66 RETURN                           R0 0
...
PROTO_2:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R2 R2 K0 ["installPeerDependency"]
        3 MOVE                             R3 R0
        4 MOVE                             R4 R1
        5 LOADK                            R5 K1 ["Cryo"]
        6 CALL                             R2 3 0
       ...
       80 CALL                             R8 2 0
       81 GETUPVAL                         R8 0
       82 GETTABLEKS                       R8 R8 K0 ["installPeerDependency"]
       84 MOVE                             R9 R0
       85 MOVE                             R10 R1
       86 LOADK                            R11 K27 ["React"]
       87 CALL                             R8 3 0
       88 GETUPVAL                         R8 0
       89 GETTABLEKS                       R8 R8 K0 ["installPeerDependency"]
       91 MOVE                             R9 R0
       92 MOVE                             R10 R1
       93 LOADK                            R11 K33 ["ReactIs"]
       94 CALL                             R8 3 0
       95 GETUPVAL                         R8 0
       96 GETTABLEKS                       R8 R8 K0 ["installPeerDependency"]
       98 MOVE                             R9 R0
       99 MOVE                             R10 R1
      100 LOADK                            R11 K29 ["ReactRoblox"]
      101 CALL                             R8 3 0
      102 GETUPVAL                         R8 0
      103 GETTABLEKS                       R8 R8 K0 ["installPeerDependency"]
      105 MOVE                             R9 R0
      106 MOVE                             R10 R1
      107 LOADK                            R11 K9 ["Roact"]
      108 CALL                             R8 3 0
      109 GETUPVAL                         R8 0
      110 GETTABLEKS                       R8 R8 K0 ["installPeerDependency"]
      112 MOVE                             R9 R0
      113 MOVE                             R10 R1
      114 LOADK                            R11 K34 ["enumerate"]
      115 CALL                             R8 3 0
      116 GETUPVAL                         R8 0
      117 GETTABLEKS                       R8 R8 K0 ["installPeerDependency"]
      119 MOVE                             R9 R0
      120 MOVE                             R10 R1
      121 LOADK                            R11 K35 ["Dash"]
      122 CALL                             R8 3 0
      123 GETUPVAL                         R8 0
      124 GETTABLEKS                       R8 R8 K0 ["installPeerDependency"]
      126 MOVE                             R9 R0
      127 MOVE                             R10 R1
      128 LOADK                            R11 K36 ["RoactRodux"]
      129 CALL                             R8 3 0
      130 GETUPVAL                         R8 0
      131 GETTABLEKS                       R8 R8 K0 ["installPeerDependency"]
      133 MOVE                             R9 R0
      134 MOVE                             R10 R1
      135 LOADK                            R11 K37 ["Rodux"]
      136 CALL                             R8 3 0
      137 GETUPVAL                         R8 0
      138 GETTABLEKS                       R8 R8 K0 ["installPeerDependency"]
      140 MOVE                             R9 R0
      141 MOVE                             R10 R1
      142 LOADK                            R11 K38 ["TestLoader"]
      143 CALL                             R8 3 0
      144 GETUPVAL                         R8 0
      145 GETTABLEKS                       R8 R8 K0 ["installPeerDependency"]
      147 MOVE                             R9 R0
      148 MOVE                             R10 R1
      149 LOADK                            R11 K39 ["MaterialFramework"]
      150 CALL                             R8 3 0
      151 GETUPVAL                         R8 0
      152 GETTABLEKS                       R8 R8 K0 ["installPeerDependency"]
      154 MOVE                             R9 R0
      155 MOVE                             R10 R1
...
PROTO_5:
        ...
        4 JUMPIFNOT                        R1 ; [+5]
        5 GETUPVAL                         R1 0
        6 GETTABLEKS                       R1 R1 K2 ["rewriteFlagsForScript"]
        8 MOVE                             R2 R0
        9 CALL                             R1 1 0
       10 RETURN                           R0 0
...
PROTO_7:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["rewriteFlagsForScript"]
        3 MOVE                             R2 R0
        4 CALL                             R1 1 0
        5 GETUPVAL                         R1 0
        6 GETTABLEKS                       R1 R1 K0 ["rewriteFlagsForScript"]
        8 LOADK                            R4 K1 ["Util"]
        9 NAMECALL                         R2 R0 K2 ["FindFirstChild"]
       11 CALL                             R2 2 1
       12 CALL                             R1 1 0
       13 GETUPVAL                         R1 0
       14 GETTABLEKS                       R1 R1 K0 ["rewriteFlagsForScript"]
       16 LOADK                            R4 K3 ["UI"]
...
MAIN:
       ...
       29 GETTABLEKS                       R6 R6 K14 ["getDeepFolder"]
       31 CALL                             R5 1 1
       32 NEWTABLE                         R6 8 0
