...
PROTO_1:
        0 DUPTABLE                         R1 K2 [{[1] = "Important"}]
        1 SETTABLEKS                       R1 R0 K3 ["state"]
        3 NEWCLOSURE                       R1 P0
        4 CAPTURE                          VAL R0
        5 SETTABLEKS                       R1 R0 K4 ["changeStyle"]
        7 RETURN                           R0 0
...
PROTO_2:
       ...
       47 GETUPVAL                         R6 1
       48 DUPTABLE                         R7 K31 [{["LayoutOrder"] = 1, ["Size"], ["Style"]}]
       49 GETIMPORT                        R8 K6 [UDim2.fromOffset]
       51 LOADN                            R9 300
       52 LOADN                            R10 150
       53 CALL                             R8 2 1
       54 SETTABLEKS                       R8 R7 K2 ["Size"]
       56 GETTABLEKS                       R8 R0 K32 ["state"]
       58 GETTABLEKS                       R8 R8 K33 ["className"]
       60 SETTABLEKS                       R8 R7 K30 ["Style"]
       62 CALL                             R5 2 1
       63 SETTABLEKS                       R5 R4 K8 ["Dialog1"]
       65 GETUPVAL                         R5 0
       66 GETTABLEKS                       R5 R5 K0 ["createElement"]
       68 GETUPVAL                         R6 1
       69 DUPTABLE                         R7 K35 [{["LayoutOrder"] = 2, ["Size"]}]
       70 GETIMPORT                        R8 K6 [UDim2.fromOffset]
       72 LOADN                            R9 300
       73 LOADN                            R10 150
       74 CALL                             R8 2 1
       75 SETTABLEKS                       R8 R7 K2 ["Size"]
       77 CALL                             R5 2 1
       78 SETTABLEKS                       R5 R4 K9 ["Dialog2"]
       80 GETUPVAL                         R5 0
       81 GETTABLEKS                       R5 R5 K0 ["createElement"]
       83 GETUPVAL                         R6 2
       84 DUPTABLE                         R7 K40 [{["LayoutOrder"] = 3, ["Size"], ["Text"] = "Click to change Style prop for Dialog 2", ["OnClick"]}]
       85 GETIMPORT                        R8 K6 [UDim2.fromOffset]
       87 LOADN                            R9 300
       88 LOADN                            R10 60
       89 CALL                             R8 2 1
       90 SETTABLEKS                       R8 R7 K2 ["Size"]
       92 GETTABLEKS                       R8 R0 K41 ["changeStyle"]
       94 SETTABLEKS                       R8 R7 K39 ["OnClick"]
       96 CALL                             R5 2 1
       97 SETTABLEKS                       R5 R4 K10 ["Button"]
       99 CALL                             R1 3 -1
      100 RETURN                           R1 -1
