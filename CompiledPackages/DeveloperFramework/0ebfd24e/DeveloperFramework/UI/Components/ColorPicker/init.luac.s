...
PROTO_7:
        0 DUPTABLE                         R1 K4 [{[1] = 1, ["s"] = 1, ["v"] = 1}]
        1 SETTABLEKS                       R1 R0 K5 ["state"]
        3 NEWCLOSURE                       R1 P0
        4 CAPTURE                          VAL R0
        5 SETTABLEKS                       R1 R0 K6 ["SetNewHSV"]
        7 NEWCLOSURE                       R1 P1
        8 CAPTURE                          UPVAL U0
        9 CAPTURE                          VAL R0
       10 SETTABLEKS                       R1 R0 K7 ["onTextChangedHex"]
       12 NEWCLOSURE                       R1 P2
       13 CAPTURE                          UPVAL U0
       14 CAPTURE                          VAL R0
       15 SETTABLEKS                       R1 R0 K8 ["onTextChangedRGB"]
       17 NEWCLOSURE                       R1 P3
       18 CAPTURE                          UPVAL U0
       19 CAPTURE                          VAL R0
       20 SETTABLEKS                       R1 R0 K9 ["onTextChangedHSV"]
       22 NEWCLOSURE                       R1 P4
       23 CAPTURE                          VAL R0
       24 SETTABLEKS                       R1 R0 K10 ["onHueSaturationChanged"]
       26 NEWCLOSURE                       R1 P5
       27 CAPTURE                          VAL R0
       28 SETTABLEKS                       R1 R0 K11 ["onColorValueChanged"]
       30 RETURN                           R0 0

PROTO_8:
        0 GETTABLEKS                       R2 R0 K0 ["Color"]
        2 JUMPIFNOTEQKNIL                  R2 ; [+3]
        4 DUPTABLE                         R2 K5 [{["h"] = 1, ["s"] = 1, ["v"] = 1}]
        5 RETURN                           R2 1
        6 GETTABLEKS                       R2 R1 K0 ["Color"]
        8 GETTABLEKS                       R3 R0 K0 ["Color"]
       10 JUMPIFEQ                         R2 R3 ; [+22]
       12 GETTABLEKS                       R2 R0 K0 ["Color"]
       14 SETTABLEKS                       R2 R1 K0 ["Color"]
       16 GETTABLEKS                       R2 R0 K0 ["Color"]
       18 NAMECALL                         R2 R2 K6 ["ToHSV"]
       20 CALL                             R2 1 3
       21 DUPTABLE                         R5 K7 [{"h", "s", "v", "Color"}]
       22 SETTABLEKS                       R2 R5 K1 ["h"]
       24 SETTABLEKS                       R3 R5 K3 ["s"]
       26 SETTABLEKS                       R4 R5 K4 ["v"]
       28 GETTABLEKS                       R6 R0 K0 ["Color"]
       30 SETTABLEKS                       R6 R5 K0 ["Color"]
       32 RETURN                           R5 1
       33 LOADNIL                          R2
       34 RETURN                           R2 1
