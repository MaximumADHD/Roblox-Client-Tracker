...
PROTO_1:
       ...
       67 GETUPVAL                         R10 3
       68 DUPTABLE                         R11 K32 [{["AutomaticSize"], ["LayoutOrder"] = 1, ["Style"], ["OnClick"], ["SizeConstraint"], ["Size"]}]
       69 GETTABLEKS                       R12 R1 K9 ["AutomaticSize"]
       71 SETTABLEKS                       R12 R11 K9 ["AutomaticSize"]
       73 SETTABLEKS                       R3 R11 K29 ["Style"]
       75 GETTABLEKS                       R12 R1 K30 ["OnClick"]
       77 SETTABLEKS                       R12 R11 K30 ["OnClick"]
       79 GETIMPORT                        R12 K34 [Enum.SizeConstraint.RelativeYY]
       81 SETTABLEKS                       R12 R11 K31 ["SizeConstraint"]
       83 GETTABLEKS                       R12 R2 K35 ["IconSize"]
       85 SETTABLEKS                       R12 R11 K6 ["Size"]
       87 GETUPVAL                         R13 4
       88 JUMPIFNOT                        R13 ; [+7]
       89 GETUPVAL                         R12 1
       90 GETTABLEKS                       R12 R12 K7 ["createElement"]
       92 GETUPVAL                         R13 5
       93 DUPTABLE                         R14 K38 [{["Cursor"] = "PointingHand"}]
       94 CALL                             R12 2 1
       95 JUMP                             ; [+10]
       96 NEWTABLE                         R12 0 1
       98 GETUPVAL                         R13 1
      ...
      101 GETUPVAL                         R14 5
      102 DUPTABLE                         R15 K38 [{["Cursor"] = "PointingHand"}]
      103 CALL                             R13 2 -1
      104 SETLIST                          R12 R13 -1 [1]
      106 CALL                             R9 3 1
      107 SETTABLEKS                       R9 R8 K25 ["Icon"]
      109 GETUPVAL                         R9 1
      110 GETTABLEKS                       R9 R9 K7 ["createElement"]
      112 GETUPVAL                         R10 6
      113 DUPTABLE                         R11 K40 [{["LayoutOrder"] = 2, ["AutomaticSize"], ["Style"], ["Text"]}]
      114 GETIMPORT                        R12 K42 [Enum.AutomaticSize.XY]
      116 SETTABLEKS                       R12 R11 K9 ["AutomaticSize"]
      118 GETTABLEKS                       R12 R2 K26 ["Text"]
      120 SETTABLEKS                       R12 R11 K29 ["Style"]
      122 GETTABLEKS                       R14 R1 K43 ["Count"]
      124 NAMECALL                         R12 R0 K44 ["formatCount"]
      126 CALL                             R12 2 1
      127 SETTABLEKS                       R12 R11 K26 ["Text"]
      129 CALL                             R9 2 1
      130 SETTABLEKS                       R9 R8 K26 ["Text"]
      132 CALL                             R5 3 -1
      133 RETURN                           R5 -1
