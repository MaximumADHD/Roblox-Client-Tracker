PROTO_0:
        ...
        8 GETUPVAL                         R2 1
        9 MOVE                             R4 R0
       10 LOADK                            R7 K2 ["TextSize"]
       11 NAMECALL                         R5 R1 K3 ["GetStyled"]
       13 CALL                             R5 2 1
       14 LOADK                            R8 K4 ["Font"]
       15 NAMECALL                         R6 R1 K3 ["GetStyled"]
       17 CALL                             R6 2 1
       18 GETIMPORT                        R7 K7 [Vector2.new]
       20 LOADK                            R8 K8 [∞]
       21 LOADK                            R9 K8 [∞]
       22 CALL                             R7 2 -1
       23 NAMECALL                         R2 R2 K9 ["GetTextSize"]
       25 CALL                             R2 -1 1
       26 GETTABLEKS                       R2 R2 K10 ["x"]
       28 RETURN                           R2 1
...
PROTO_1:
       ...
       21 MOVE                             R2 R3
       22 GETUPVAL                         R3 0
       23 GETTABLEKS                       R3 R3 K8 ["textRef"]
       25 GETTABLEKS                       R3 R3 K9 ["current"]
       27 JUMPIF                           R3 ; [+1]
       28 RETURN                           R0 0
       29 GETTABLEKS                       R4 R3 K10 ["AbsoluteSize"]
       31 GETTABLEKS                       R4 R4 K11 ["X"]
       33 GETUPVAL                         R5 0
       34 GETTABLEKS                       R5 R5 K12 ["lastText"]
       36 JUMPIFNOTEQ                      R1 R5 ; [+6]
       38 GETUPVAL                         R5 0
       39 GETTABLEKS                       R5 R5 K13 ["lastTextWidth"]
       41 JUMPIFEQ                         R4 R5 ; [+17]
       43 GETUPVAL                         R5 1
       44 MOVE                             R6 R1
       45 MOVE                             R7 R4
       46 GETUPVAL                         R8 0
       47 GETTABLEKS                       R8 R8 K14 ["getTextWidth"]
       49 MOVE                             R9 R2
       50 CALL                             R5 4 1
...
PROTO_2:
        ...
        6 GETTABLEKS                       R2 R2 K2 ["AbsoluteSize"]
        8 GETTABLE                         R0 R1 R2
        9 JUMPIFNOT                        R0 ; [+10]
       10 GETUPVAL                         R1 0
       11 GETTABLEKS                       R1 R1 K0 ["props"]
       13 GETUPVAL                         R2 1
       14 GETTABLEKS                       R2 R2 K1 ["Change"]
       16 GETTABLEKS                       R2 R2 K2 ["AbsoluteSize"]
       18 GETTABLE                         R0 R1 R2
       19 CALL                             R0 0 0
       20 GETUPVAL                         R0 0
       21 GETTABLEKS                       R0 R0 K3 ["updateText"]
       23 CALL                             R0 0 0
       24 RETURN                           R0 0
...
PROTO_6:
        ...
        9 NEWTABLE                         R2 2 0
       11 GETUPVAL                         R3 1
       12 GETTABLEKS                       R3 R3 K2 ["Ref"]
       14 GETTABLEKS                       R4 R0 K3 ["textRef"]
       16 SETTABLE                         R4 R2 R3
       17 GETUPVAL                         R3 1
       18 GETTABLEKS                       R3 R3 K4 ["Change"]
       20 GETTABLEKS                       R3 R3 K5 ["AbsoluteSize"]
       22 GETTABLEKS                       R4 R0 K6 ["onAbsoluteSizeChange"]
       24 SETTABLE                         R4 R2 R3
       25 GETUPVAL                         R3 1
       26 GETTABLEKS                       R3 R3 K7 ["createElement"]
       28 GETUPVAL                         R4 2
       29 GETUPVAL                         R5 3
       30 MOVE                             R6 R1
       31 MOVE                             R7 R2
...
MAIN:
       ...
       19 GETTABLEKS                       R3 R3 K11 ["Components"]
       21 GETTABLEKS                       R3 R3 K12 ["TextLabel"]
       23 CALL                             R2 1 1
       24 GETIMPORT                        R3 K10 [require]
       26 GETTABLEKS                       R4 R1 K8 ["Parent"]
       28 GETTABLEKS                       R4 R4 K13 ["Dash"]
       30 CALL                             R3 1 1
       31 GETIMPORT                        R4 K10 [require]
       33 GETTABLEKS                       R5 R1 K8 ["Parent"]
       35 GETTABLEKS                       R5 R5 K14 ["Roact"]
       37 CALL                             R4 1 1
       ...
       47 GETTABLEKS                       R8 R1 K15 ["Util"]
       49 GETTABLEKS                       R8 R8 K17 ["Typecheck"]
       51 CALL                             R7 1 1
