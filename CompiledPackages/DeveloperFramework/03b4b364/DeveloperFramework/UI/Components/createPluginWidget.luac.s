...
PROTO_2:
        ...
        3 GETTABLEKS                       R0 R1 K1 ["OnWidgetFocused"]
        5 GETUPVAL                         R2 0
        6 GETTABLEKS                       R1 R2 K2 ["widget"]
        8 CALL                             R0 1 0
        9 RETURN                           R0 0
...
PROTO_3:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R1 R2 K0 ["props"]
        3 GETTABLEKS                       R0 R1 K1 ["OnWidgetFocusReleased"]
        5 GETUPVAL                         R2 0
        6 GETTABLEKS                       R1 R2 K2 ["widget"]
        8 CALL                             R0 1 0
        9 RETURN                           R0 0
...
PROTO_4:
        ...
        9 JUMPIFNOT                        R0 ; [+21]
       10 GETUPVAL                         R2 0
       11 GETTABLEKS                       R1 R2 K3 ["widget"]
       13 JUMPIFNOT                        R1 ; [+17]
       14 GETUPVAL                         R3 0
       15 GETTABLEKS                       R2 R3 K3 ["widget"]
       17 GETTABLEKS                       R1 R2 K2 ["Enabled"]
       19 GETUPVAL                         R4 0
       20 GETTABLEKS                       R3 R4 K0 ["props"]
       22 GETTABLEKS                       R2 R3 K2 ["Enabled"]
       24 JUMPIFEQ                         R1 R2 ; [+6]
       26 MOVE                             R1 R0
       27 GETUPVAL                         R3 0
       28 GETTABLEKS                       R2 R3 K3 ["widget"]
       30 CALL                             R1 1 0
       31 RETURN                           R0 0
...
PROTO_5:
       ...
       48 CALL                             R5 2 0
       49 GETTABLEKS                       R6 R0 K2 ["props"]
       51 GETTABLEKS                       R5 R6 K18 ["OnWidgetFocused"]
       53 JUMPIFNOT                        R5 ; [+9]
       ...
       63 GETTABLEKS                       R6 R0 K2 ["props"]
       65 GETTABLEKS                       R5 R6 K22 ["OnWidgetFocusReleased"]
       67 JUMPIFNOT                        R5 ; [+9]
      ...
      120 GETUPVAL                         R6 2
      121 GETTABLEKS                       R5 R6 K32 ["new"]
      123 MOVE                             R6 R4
      124 CALL                             R5 1 1
      125 SETTABLEKS                       R5 R0 K33 ["focus"]
      127 SETTABLEKS                       R4 R0 K0 ["widget"]
      129 DUPTABLE                         R7 K35 [{"_widgetReady"}]
      130 LOADB                            R8 1
      131 SETTABLEKS                       R8 R7 K34 ["_widgetReady"]
      133 NAMECALL                         R5 R0 K36 ["setState"]
      135 CALL                             R5 2 0
      136 RETURN                           R0 0
...
PROTO_6:
       ...
       64 CALL                             R7 2 1
       65 GETTABLEKS                       R10 R2 K11 ["Size"]
       67 GETTABLEKS                       R9 R10 K13 ["X"]
       69 GETTABLEKS                       R11 R2 K11 ["Size"]
       71 GETTABLEKS                       R10 R11 K14 ["Y"]
...
PROTO_8:
        ...
        5 GETTABLEKS                       R1 R2 K2 ["CreateWidgetImmediately"]
        7 JUMPIFNOT                        R1 ; [+4]
...
PROTO_10:
       ...
       21 GETUPVAL                         R6 1
       22 GETTABLEKS                       R5 R6 K6 ["Portal"]
       24 DUPTABLE                         R6 K8 [{"target"}]
       25 GETTABLEKS                       R7 R0 K0 ["widget"]
       27 SETTABLEKS                       R7 R6 K7 ["target"]
       29 GETUPVAL                         R8 2
       30 JUMPIFNOT                        R8 ; [+45]
       31 GETTABLEKS                       R9 R0 K9 ["props"]
       33 GETTABLEKS                       R8 R9 K10 ["PluginDesign"]
       35 JUMPIFNOT                        R8 ; [+40]
       36 DUPTABLE                         R7 K13 [{"Wrapper", "StyleLink"}]
       37 GETUPVAL                         R9 1
       38 GETTABLEKS                       R8 R9 K5 ["createElement"]
       40 LOADK                            R9 K14 ["Frame"]
       41 DUPTABLE                         R10 K17 [{"Size", "BackgroundTransparency"}]
       42 GETIMPORT                        R11 K20 [UDim2.fromScale]
       44 LOADN                            R12 1
       45 LOADN                            R13 1
       46 CALL                             R11 2 1
       47 SETTABLEKS                       R11 R10 K15 ["Size"]
       49 LOADN                            R11 1
       50 SETTABLEKS                       R11 R10 K16 ["BackgroundTransparency"]
       52 GETTABLEKS                       R12 R0 K9 ["props"]
       54 GETUPVAL                         R14 1
       55 GETTABLEKS                       R13 R14 K21 ["Children"]
       57 GETTABLE                         R11 R12 R13
       58 CALL                             R8 3 1
       59 SETTABLEKS                       R8 R7 K11 ["Wrapper"]
       61 GETUPVAL                         R9 1
       62 GETTABLEKS                       R8 R9 K5 ["createElement"]
       64 LOADK                            R9 K12 ["StyleLink"]
       65 DUPTABLE                         R10 K23 [{"StyleSheet"}]
       66 GETTABLEKS                       R12 R0 K9 ["props"]
       68 GETTABLEKS                       R11 R12 K10 ["PluginDesign"]
       70 SETTABLEKS                       R11 R10 K22 ["StyleSheet"]
       72 CALL                             R8 2 1
       73 SETTABLEKS                       R8 R7 K12 ["StyleLink"]
       75 JUMP                             ; [+6]
       76 GETTABLEKS                       R8 R0 K9 ["props"]
       78 GETUPVAL                         R10 1
       79 GETTABLEKS                       R9 R10 K21 ["Children"]
       81 GETTABLE                         R7 R8 R9
       82 CALL                             R4 3 1
       83 SETTABLEKS                       R4 R3 K3 ["Child"]
       85 CALL                             R1 2 -1
       86 RETURN                           R1 -1
...
PROTO_12:
       ...
       38 GETUPVAL                         R6 4
       39 GETTABLEKS                       R5 R6 K14 ["Plugin"]
...
MAIN:
        ...
        5 CAPTURE                          REF R0
        6 CALL                             R1 1 0
        7 GETIMPORT                        R2 K3 [script]
        9 LOADK                            R4 K4 ["UI"]
       10 NAMECALL                         R2 R2 K5 ["FindFirstAncestor"]
       12 CALL                             R2 2 1
       13 GETTABLEKS                       R1 R2 K6 ["Parent"]
       15 GETIMPORT                        R2 K8 [require]
       17 GETTABLEKS                       R4 R1 K6 ["Parent"]
       19 GETTABLEKS                       R3 R4 K9 ["Roact"]
       21 CALL                             R2 1 1
       22 GETIMPORT                        R3 K8 [require]
       24 GETTABLEKS                       R5 R1 K4 ["UI"]
       26 GETTABLEKS                       R4 R5 K10 ["ContextServices"]
       28 CALL                             R3 1 1
       ...
       42 GETTABLEKS                       R9 R1 K17 ["SharedFlags"]
       44 GETTABLEKS                       R8 R9 K18 ["getFFlagDevFrameworkPortalDesignInPlugins"]
       46 CALL                             R7 1 1
       47 CALL                             R7 0 1
       48 NEWCLOSURE                       R8 P1
       49 CAPTURE                          VAL R2
