PROTO_0:
        ...
        9 GETTABLEKS                       R3 R4 K1 ["Stylizer"]
       11 GETUPVAL                         R4 1
       12 MOVE                             R5 R3
       13 CALL                             R4 1 2
       14 MOVE                             R1 R4
...
PROTO_2:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R0 R1 K0 ["__renderAfterValidation"]
        3 JUMPIFNOT                        R0 ; [+2]
        4 LOADB                            R0 1
        5 RETURN                           R0 1
        6 GETUPVAL                         R1 0
        7 GETTABLEKS                       R0 R1 K1 ["__renderWithContext"]
        9 JUMPIFNOT                        R0 ; [+14]
       10 GETUPVAL                         R0 0
       11 GETUPVAL                         R2 0
       12 GETTABLEKS                       R1 R2 K1 ["__renderWithContext"]
...
PROTO_5:
       ...
       16 CALL                             R4 1 1
       17 GETUPVAL                         R6 0
       18 GETTABLEKS                       R5 R6 K4 ["toInterface"]
       20 MOVE                             R6 R4
       21 CALL                             R5 1 2
       22 NEWCLOSURE                       R7 P1
       23 CAPTURE                          VAL R0
...
MAIN:
        ...
        7 GETTABLEKS                       R1 R2 K5 ["DocParser"]
        9 CALL                             R0 1 1
