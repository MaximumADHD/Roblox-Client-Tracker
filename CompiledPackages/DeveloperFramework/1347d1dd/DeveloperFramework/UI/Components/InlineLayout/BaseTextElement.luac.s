...
PROTO_7:
        ...
        4 GETUPVAL                         R3 0
        5 JUMPIFNOT                        R3 ; [+20]
        6 GETTABLEKS                       R5 R0 K4 ["props"]
        8 GETTABLEKS                       R4 R5 K5 ["FontFace"]
       10 JUMPIFNOT                        R4 ; [+5]
       11 GETTABLEKS                       R4 R0 K4 ["props"]
       13 GETTABLEKS                       R3 R4 K5 ["FontFace"]
       15 JUMP                             ; [+7]
       16 GETIMPORT                        R3 K8 [Font.fromEnum]
       18 GETTABLEKS                       R5 R0 K4 ["props"]
       20 GETTABLEKS                       R4 R5 K6 ["Font"]
       22 CALL                             R3 1 1
       23 SETTABLEKS                       R3 R2 K6 ["Font"]
       25 JUMP                             ; [+9]
       26 GETIMPORT                        R3 K8 [Font.fromEnum]
       28 GETTABLEKS                       R5 R0 K4 ["props"]
       30 GETTABLEKS                       R4 R5 K6 ["Font"]
       32 CALL                             R3 1 1
       33 SETTABLEKS                       R3 R2 K6 ["Font"]
       35 GETTABLEKS                       R4 R0 K4 ["props"]
       37 GETTABLEKS                       R3 R4 K9 ["TextSize"]
       39 SETTABLEKS                       R3 R2 K10 ["Size"]
       41 SETTABLEKS                       R1 R2 K11 ["Text"]
       43 GETTABLEKS                       R3 R0 K12 ["hasRichText"]
       45 JUMPIFNOT                        R3 ; [+69]
       46 GETTABLEKS                       R5 R0 K4 ["props"]
       48 GETTABLEKS                       R4 R5 K13 ["TextStyle"]
       50 LOADK                            R7 K14 ["[&<>\"']"]
       51 NEWTABLE                         R8 8 0
       53 LOADK                            R9 K15 ["&amp;"]
      ...
      146 GETUPVAL                         R6 1
      147 MOVE                             R8 R2
      148 NAMECALL                         R6 R6 K41 ["GetTextBoundsAsync"]
      150 CALL                             R6 2 1
      151 GETTABLEKS                       R5 R6 K42 ["X"]
      153 RETURN                           R5 1
...
PROTO_10:
       ...
       13 GETTABLEKS                       R5 R6 K3 ["TextStyle"]
       15 LOADK                            R8 K4 ["[&<>\"']"]
       16 NEWTABLE                         R9 8 0
       18 LOADK                            R10 K5 ["&amp;"]
       ...
       74 MOVE                             R3 R6
       75 GETUPVAL                         R5 0
       76 GETTABLEKS                       R4 R5 K25 ["createElement"]
      ...
      107 GETUPVAL                         R11 2
      108 GETTABLEKS                       R10 R11 K39 ["None"]
...
MAIN:
       ...
       20 GETTABLEKS                       R3 R4 K9 ["isCli"]
       22 CALL                             R2 1 1
       23 GETIMPORT                        R3 K6 [require]
       25 GETIMPORT                        R6 K1 [script]
       27 GETTABLEKS                       R5 R6 K4 ["Parent"]
       29 GETTABLEKS                       R4 R5 K10 ["TextSplitByEnum"]
       31 CALL                             R3 1 1
       32 GETIMPORT                        R4 K6 [require]
       34 GETIMPORT                        R7 K1 [script]
       36 GETTABLEKS                       R6 R7 K4 ["Parent"]
       38 GETTABLEKS                       R5 R6 K11 ["splitText"]
       40 CALL                             R4 1 1
       41 GETIMPORT                        R5 K6 [require]
       43 GETIMPORT                        R8 K1 [script]
       45 GETTABLEKS                       R7 R8 K4 ["Parent"]
       47 GETTABLEKS                       R6 R7 K12 ["InlineElementType"]
       49 CALL                             R5 1 1
       50 GETIMPORT                        R6 K6 [require]
       52 GETTABLEKS                       R8 R0 K13 ["SharedFlags"]
       54 GETTABLEKS                       R7 R8 K14 ["getFFlagDevFrameworkMarkdownControlCodeFont"]
       56 CALL                             R6 1 1
       57 CALL                             R6 0 1
       58 GETIMPORT                        R7 K6 [require]
       60 GETTABLEKS                       R9 R0 K4 ["Parent"]
       62 GETTABLEKS                       R8 R9 K15 ["Dash"]
       64 CALL                             R7 1 1
