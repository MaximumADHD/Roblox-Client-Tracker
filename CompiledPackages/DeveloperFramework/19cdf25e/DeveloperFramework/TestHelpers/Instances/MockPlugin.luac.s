...
PROTO_2:
        0 DUPTABLE                         R5 K16 [{"_id", "Name", "_plugin", "Deactivation", "Unloading", "_activated", "_activatedWithExclusiveMouse", "_mouse", "_toolbars", "_mockedSettings", "_mockItems", "_mockItemsCallbacks", "_mockInvokeCallbacks", "_uri", "mockComponents", "subWindows"}]
        1 ORK                              R6 R0 K17 [""]
        2 SETTABLEKS                       R6 R5 K0 ["_id"]
        4 ORK                              R6 R0 K18 ["MockPlugin"]
        5 SETTABLEKS                       R6 R5 K1 ["Name"]
        7 SETTABLEKS                       R2 R5 K2 ["_plugin"]
        9 GETUPVAL                         R7 0
       10 GETTABLEKS                       R6 R7 K19 ["new"]
       12 CALL                             R6 0 1
       13 SETTABLEKS                       R6 R5 K3 ["Deactivation"]
       15 GETUPVAL                         R7 0
       16 GETTABLEKS                       R6 R7 K19 ["new"]
       18 CALL                             R6 0 1
       19 SETTABLEKS                       R6 R5 K4 ["Unloading"]
       21 LOADB                            R6 0
       22 SETTABLEKS                       R6 R5 K5 ["_activated"]
       24 LOADB                            R6 0
       25 SETTABLEKS                       R6 R5 K6 ["_activatedWithExclusiveMouse"]
       27 GETUPVAL                         R7 1
       28 GETTABLEKS                       R6 R7 K19 ["new"]
       30 CALL                             R6 0 1
       31 SETTABLEKS                       R6 R5 K7 ["_mouse"]
       33 NEWTABLE                         R6 0 0
       35 SETTABLEKS                       R6 R5 K8 ["_toolbars"]
       37 NEWTABLE                         R6 0 0
       39 SETTABLEKS                       R6 R5 K9 ["_mockedSettings"]
       41 NEWTABLE                         R6 0 0
       43 SETTABLEKS                       R6 R5 K10 ["_mockItems"]
       45 NEWTABLE                         R6 0 0
       47 SETTABLEKS                       R6 R5 K11 ["_mockItemsCallbacks"]
       49 NEWTABLE                         R6 0 0
       51 SETTABLEKS                       R6 R5 K12 ["_mockInvokeCallbacks"]
       53 SETTABLEKS                       R3 R5 K13 ["_uri"]
       55 GETUPVAL                         R6 2
       56 CALL                             R6 0 1
       57 SETTABLEKS                       R6 R5 K14 ["mockComponents"]
       59 NEWTABLE                         R6 0 0
       61 SETTABLEKS                       R6 R5 K15 ["subWindows"]
       63 GETUPVAL                         R6 3
       64 FASTCALL2                        SETMETATABLE R5 R6 ; [+3]
       66 GETIMPORT                        R4 K21 [setmetatable]
       68 CALL                             R4 2 1
       69 JUMPIFNOT                        R1 ; [+6]
       70 SETTABLEKS                       R1 R4 K22 ["_mockedPlugins"]
       72 GETTABLEKS                       R5 R4 K22 ["_mockedPlugins"]
       74 LOADB                            R6 1
...
PROTO_12:
        ...
        2 GETUPVAL                         R3 0
        3 GETTABLEKS                       R2 R3 K3 ["subWindows"]
        5 GETUPVAL                         R3 1
        6 CALL                             R1 2 1
       ...
       15 GETUPVAL                         R3 0
       16 GETTABLEKS                       R2 R3 K3 ["subWindows"]
       18 MOVE                             R3 R0
       19 CALL                             R1 2 0
       20 RETURN                           R0 0
...
PROTO_20:
        0 GETUPVAL                         R4 0
        1 GETTABLEKS                       R3 R4 K0 ["_mockItemsCallbacks"]
        3 GETUPVAL                         R4 1
        4 GETTABLE                         R0 R3 R4
        5 LOADNIL                          R1
        6 LOADNIL                          R2
       ...
       13 GETUPVAL                         R8 0
       14 GETTABLEKS                       R7 R8 K0 ["_mockItemsCallbacks"]
       16 GETUPVAL                         R8 1
...
PROTO_23:
        0 GETUPVAL                         R4 0
        1 GETTABLEKS                       R3 R4 K0 ["_mockInvokeCallbacks"]
        3 GETUPVAL                         R4 1
        4 GETTABLE                         R0 R3 R4
        5 LOADNIL                          R1
        6 LOADNIL                          R2
       ...
       11 GETIMPORT                        R5 K3 [table.remove]
       13 GETUPVAL                         R8 0
       14 GETTABLEKS                       R7 R8 K0 ["_mockInvokeCallbacks"]
       16 GETUPVAL                         R8 1
       17 GETTABLE                         R6 R7 R8
       18 MOVE                             R7 R3
       19 CALL                             R5 2 0
...
PROTO_25:
        ...
        2 JUMPIF                           R1 ; [+10]
        3 DUPTABLE                         R1 K4 [{"DataModel", "PluginType", "PluginId"}]
        4 LOADK                            R2 K5 ["Standalone"]
        5 SETTABLEKS                       R2 R1 K1 ["DataModel"]
        7 LOADK                            R2 K5 ["Standalone"]
        8 SETTABLEKS                       R2 R1 K2 ["PluginType"]
       10 LOADK                            R2 K6 ["MockPlugin"]
       11 SETTABLEKS                       R2 R1 K3 ["PluginId"]
       13 RETURN                           R1 1
