PROTO_0:
        ...
        6 CALL                             R2 2 0
        7 GETUPVAL                         R4 0
        8 GETTABLEKS                       R3 R4 K3 ["values"]
       10 GETUPVAL                         R5 0
       11 GETTABLEKS                       R4 R5 K4 ["strictInterface"]
       13 DUPTABLE                         R5 K11 [{"id", "text", "statusTip", "iconName", "allowBinding", "defaultShortcut"}]
       14 GETUPVAL                         R7 0
       15 GETTABLEKS                       R6 R7 K12 ["string"]
       17 SETTABLEKS                       R6 R5 K5 ["id"]
       19 GETUPVAL                         R7 0
       20 GETTABLEKS                       R6 R7 K12 ["string"]
       22 SETTABLEKS                       R6 R5 K6 ["text"]
       24 GETUPVAL                         R7 0
       25 GETTABLEKS                       R6 R7 K13 ["optional"]
       27 GETUPVAL                         R8 0
       28 GETTABLEKS                       R7 R8 K12 ["string"]
       30 CALL                             R6 1 1
       31 SETTABLEKS                       R6 R5 K7 ["statusTip"]
       33 GETUPVAL                         R7 0
       34 GETTABLEKS                       R6 R7 K13 ["optional"]
       36 GETUPVAL                         R8 0
       37 GETTABLEKS                       R7 R8 K12 ["string"]
       39 CALL                             R6 1 1
       40 SETTABLEKS                       R6 R5 K8 ["iconName"]
       42 GETUPVAL                         R7 0
       43 GETTABLEKS                       R6 R7 K13 ["optional"]
       45 GETUPVAL                         R8 0
       46 GETTABLEKS                       R7 R8 K14 ["boolean"]
       48 CALL                             R6 1 1
       49 SETTABLEKS                       R6 R5 K9 ["allowBinding"]
       51 GETUPVAL                         R7 0
       52 GETTABLEKS                       R6 R7 K13 ["optional"]
       54 GETUPVAL                         R8 0
       55 GETTABLEKS                       R7 R8 K12 ["string"]
       57 CALL                             R6 1 1
...
PROTO_1:
        0 GETTABLEKS                       R3 R0 K0 ["plugin"]
        2 GETTABLEKS                       R2 R3 K1 ["Name"]
        4 GETUPVAL                         R5 0
        5 GETTABLEKS                       R4 R5 K2 ["string"]
        7 MOVE                             R5 R2
        8 CALL                             R4 1 1
...
MAIN:
       ...
       22 GETTABLEKS                       R4 R5 K10 ["Typecheck"]
       24 GETTABLEKS                       R3 R4 K11 ["t"]
       26 CALL                             R2 1 1
