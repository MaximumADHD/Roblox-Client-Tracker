...
PROTO_3:
        0 DUPTABLE                         R1 K2 [{"Default", "DropFromSide"}]
        1 LOADB                            R2 0
        2 SETTABLEKS                       R2 R1 K0 ["Default"]
        4 LOADB                            R2 0
        5 SETTABLEKS                       R2 R1 K1 ["DropFromSide"]
       ...
       13 NEWCLOSURE                       R1 P1
       14 CAPTURE                          VAL R0
       15 SETTABLEKS                       R1 R0 K5 ["openMenu"]
       17 NEWCLOSURE                       R1 P2
       18 CAPTURE                          VAL R0
       19 SETTABLEKS                       R1 R0 K6 ["closeMenu"]
       21 RETURN                           R0 0

PROTO_4:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R0 R1 K0 ["selectItem"]
...
PROTO_5:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R0 R1 K0 ["closeMenu"]
        3 LOADK                            R1 K1 ["Default"]
        4 CALL                             R0 1 0
        5 RETURN                           R0 0
...
PROTO_6:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R0 R1 K0 ["openMenu"]
        3 LOADK                            R1 K1 ["Default"]
        4 CALL                             R0 1 0
        5 RETURN                           R0 0
...
PROTO_10:
       ...
       40 GETUPVAL                         R6 0
       41 GETTABLEKS                       R5 R6 K0 ["createElement"]
       ...
       55 GETUPVAL                         R10 0
       56 GETTABLEKS                       R9 R10 K0 ["createElement"]
       58 GETUPVAL                         R10 2
       59 DUPTABLE                         R11 K36 [{"Hide", "Items", "OnItemActivated", "OnFocusLost"}]
       60 GETTABLEKS                       R14 R0 K37 ["state"]
       62 GETTABLEKS                       R13 R14 K11 ["Default"]
       64 NOT                              R12 R13
       ...
       90 GETUPVAL                         R10 0
       91 GETTABLEKS                       R9 R10 K0 ["createElement"]
      ...
      117 GETUPVAL                         R14 0
      118 GETTABLEKS                       R13 R14 K48 ["Event"]
      120 GETTABLEKS                       R12 R13 K49 ["Activated"]
      ...
      131 GETUPVAL                         R6 0
      132 GETTABLEKS                       R5 R6 K0 ["createElement"]
      ...
      146 GETUPVAL                         R10 0
      147 GETTABLEKS                       R9 R10 K0 ["createElement"]
      149 GETUPVAL                         R10 2
      150 DUPTABLE                         R11 K50 [{"Hide", "Items", "OnItemActivated", "OnFocusLost", "DropFromSide"}]
      151 GETTABLEKS                       R14 R0 K37 ["state"]
      153 GETTABLEKS                       R13 R14 K12 ["DropFromSide"]
      155 NOT                              R12 R13
      ...
      178 LOADB                            R12 1
      179 SETTABLEKS                       R12 R11 K12 ["DropFromSide"]
      181 CALL                             R9 2 1
      182 SETTABLEKS                       R9 R8 K29 ["Menu"]
      184 GETUPVAL                         R10 0
      185 GETTABLEKS                       R9 R10 K0 ["createElement"]
      187 LOADK                            R10 K44 ["TextButton"]
      188 NEWTABLE                         R11 4 0
      190 LOADK                            R12 K51 ["Open to the side"]
      191 SETTABLEKS                       R12 R11 K46 ["Text"]
      193 GETIMPORT                        R12 K28 [UDim2.new]
      195 LOADN                            R13 0
      196 LOADN                            R14 250
      197 LOADN                            R15 0
      198 LOADN                            R16 0
      199 CALL                             R12 4 1
      200 SETTABLEKS                       R12 R11 K47 ["Position"]
      202 GETIMPORT                        R12 K28 [UDim2.new]
      204 LOADN                            R13 0
      205 LOADN                            R14 90
      206 LOADN                            R15 1
      207 LOADN                            R16 0
      208 CALL                             R12 4 1
      209 SETTABLEKS                       R12 R11 K2 ["Size"]
      211 GETUPVAL                         R14 0
      212 GETTABLEKS                       R13 R14 K48 ["Event"]
      214 GETTABLEKS                       R12 R13 K49 ["Activated"]
      216 NEWCLOSURE                       R13 P5
      217 CAPTURE                          VAL R0
      218 SETTABLE                         R13 R11 R12
      219 CALL                             R9 2 1
      220 SETTABLEKS                       R9 R8 K30 ["Button"]
      222 CALL                             R5 3 1
      223 SETTABLEKS                       R5 R4 K12 ["DropFromSide"]
      225 CALL                             R1 3 -1
      226 RETURN                           R1 -1
...
MAIN:
       ...
       31 GETTABLEKS                       R4 R5 K10 ["DropdownMenu"]
       33 CALL                             R3 1 1
       34 GETTABLEKS                       R4 R1 K11 ["PureComponent"]
       36 GETIMPORT                        R10 K1 [script]
       38 GETTABLEKS                       R9 R10 K4 ["Parent"]
       40 GETTABLEKS                       R7 R9 K12 ["Name"]
