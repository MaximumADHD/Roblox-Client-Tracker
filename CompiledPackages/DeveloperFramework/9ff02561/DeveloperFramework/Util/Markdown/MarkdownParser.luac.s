...
MAIN:
       ...
       24 GETTABLEKS                       R4 R5 K9 ["CommonMarkComplianceParser"]
       26 GETTABLEKS                       R3 R4 K10 ["BuildTree"]
       28 CALL                             R2 1 1
       29 JUMP                             ; [+9]
       30 GETIMPORT                        R2 K6 [require]
       32 GETIMPORT                        R5 K1 [script]
       34 GETTABLEKS                       R4 R5 K4 ["Parent"]
       36 GETTABLEKS                       R3 R4 K10 ["BuildTree"]
       38 CALL                             R2 1 1
       39 JUMPIFNOT                        R1 ; [+12]
       40 GETIMPORT                        R3 K6 [require]
       42 GETIMPORT                        R7 K1 [script]
       44 GETTABLEKS                       R6 R7 K4 ["Parent"]
       46 GETTABLEKS                       R5 R6 K9 ["CommonMarkComplianceParser"]
       48 GETTABLEKS                       R4 R5 K11 ["PostProcessTree"]
       50 CALL                             R3 1 1
       51 JUMP                             ; [+9]
       52 GETIMPORT                        R3 K6 [require]
       54 GETIMPORT                        R6 K1 [script]
       56 GETTABLEKS                       R5 R6 K4 ["Parent"]
       58 GETTABLEKS                       R4 R5 K11 ["PostProcessTree"]
       60 CALL                             R3 1 1
       61 JUMPIFNOT                        R1 ; [+12]
       62 GETIMPORT                        R4 K6 [require]
       64 GETIMPORT                        R8 K1 [script]
       66 GETTABLEKS                       R7 R8 K4 ["Parent"]
       68 GETTABLEKS                       R6 R7 K9 ["CommonMarkComplianceParser"]
       70 GETTABLEKS                       R5 R6 K12 ["Tokenize"]
       72 CALL                             R4 1 1
       73 JUMP                             ; [+9]
       74 GETIMPORT                        R4 K6 [require]
       76 GETIMPORT                        R7 K1 [script]
       78 GETTABLEKS                       R6 R7 K4 ["Parent"]
       80 GETTABLEKS                       R5 R6 K12 ["Tokenize"]
       82 CALL                             R4 1 1
       83 GETIMPORT                        R5 K6 [require]
       85 GETIMPORT                        R8 K1 [script]
       87 GETTABLEKS                       R7 R8 K4 ["Parent"]
       89 GETTABLEKS                       R6 R7 K13 ["unindentTags"]
       91 CALL                             R5 1 1
       92 GETIMPORT                        R6 K6 [require]
       94 GETIMPORT                        R9 K1 [script]
       96 GETTABLEKS                       R8 R9 K4 ["Parent"]
       98 GETTABLEKS                       R7 R8 K14 ["indexTree"]
      100 CALL                             R6 1 1
      101 GETIMPORT                        R7 K6 [require]
      103 GETIMPORT                        R10 K1 [script]
      105 GETTABLEKS                       R9 R10 K4 ["Parent"]
      107 GETTABLEKS                       R8 R9 K15 ["Types"]
      109 CALL                             R7 1 1
