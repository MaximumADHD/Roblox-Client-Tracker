PROTO_0:
       ...
       10 GETUPVAL                         R2 0
       11 GETTABLEKS                       R2 R2 K4 ["lastProgress"]
...
PROTO_1:
        ...
        5 CALL                             R2 0 1
        6 GETUPVAL                         R3 0
        7 GETTABLEKS                       R3 R3 K3 ["startTime"]
        9 SUB                              R1 R2 R3
       10 LOADNIL                          R2
       11 GETUPVAL                         R3 1
       ...
       24 MUL                              R2 R3 R4
       25 GETUPVAL                         R3 0
       26 GETTABLEKS                       R3 R3 K5 ["updateProgress"]
       28 MOVE                             R4 R2
       29 CALL                             R3 1 0
       30 RETURN                           R0 0
...
PROTO_2:
        ...
        8 DUPTABLE                         R2 K6 [{["progress"] = 0}]
        9 SETTABLEKS                       R2 R0 K7 ["state"]
       11 NEWCLOSURE                       R2 P0
       12 CAPTURE                          VAL R0
       13 SETTABLEKS                       R2 R0 K8 ["updateProgress"]
       15 GETTABLEKS                       R2 R1 K9 ["LoadingTime"]
       17 FASTCALL1                        TYPE R2 ; [+3]
       18 MOVE                             R6 R2
       19 GETIMPORT                        R5 K11 [type]
       21 CALL                             R5 1 1
       22 JUMPIFEQKS                       R5 K12 ["number"] ; [+2]
       24 LOADB                            R4 0 +1
       25 LOADB                            R4 1
       26 FASTCALL2K                       ASSERT R4 K13 ; [+4]
       28 LOADK                            R5 K13 ["FakeLoadingBar expects a 'LoadingTime' prop."]
       29 GETIMPORT                        R3 K15 [assert]
       31 CALL                             R3 2 0
       32 LOADN                            R5 0
       33 JUMPIFLT                         R5 R2 ; [+2]
       35 LOADB                            R4 0 +1
       36 LOADB                            R4 1
       37 FASTCALL2K                       ASSERT R4 K16 ; [+4]
       39 LOADK                            R5 K16 ["FakeLoadingBar expects 'LoadingTime' to be > 0."]
       40 GETIMPORT                        R3 K15 [assert]
       42 CALL                             R3 2 0
       43 GETTABLEKS                       R4 R1 K18 ["HoldValue"]
       45 ORK                              R3 R4 K17 [1]
       46 LOADN                            R6 0
       47 JUMPIFLT                         R6 R3 ; [+2]
       49 LOADB                            R5 0 +1
       50 LOADB                            R5 1
       51 FASTCALL2K                       ASSERT R5 K19 ; [+4]
       53 LOADK                            R6 K19 ["FakeLoadingBar expects 'HoldValue' to be > 0."]
       54 GETIMPORT                        R4 K15 [assert]
       56 CALL                             R4 2 0
       57 LOADN                            R6 1
       58 JUMPIFLE                         R3 R6 ; [+2]
       60 LOADB                            R5 0 +1
       61 LOADB                            R5 1
       62 FASTCALL2K                       ASSERT R5 K20 ; [+4]
       64 LOADK                            R6 K20 ["FakeLoadingBar expects 'HoldValue' to be <= 1."]
       65 GETIMPORT                        R4 K15 [assert]
       67 CALL                             R4 2 0
       68 GETUPVAL                         R4 0
       69 GETTABLEKS                       R4 R4 K21 ["RenderStepped"]
       71 NEWCLOSURE                       R6 P1
       72 CAPTURE                          VAL R0
       73 CAPTURE                          VAL R2
       74 CAPTURE                          VAL R3
       75 NAMECALL                         R4 R4 K22 ["Connect"]
       77 CALL                             R4 2 1
       78 SETTABLEKS                       R4 R0 K23 ["updateConnection"]
       80 RETURN                           R0 0
...
PROTO_4:
       ...
       24 GETUPVAL                         R10 0
       25 GETTABLEKS                       R10 R10 K12 ["createElement"]
       27 GETUPVAL                         R11 1
...
MAIN:
       ...
       26 GETTABLEKS                       R4 R4 K12 ["Components"]
       28 GETTABLEKS                       R4 R4 K13 ["LoadingBar"]
       30 CALL                             R3 1 1
       31 GETIMPORT                        R4 K10 [require]
       33 GETTABLEKS                       R5 R1 K14 ["Util"]
       35 CALL                             R4 1 1
       36 GETTABLEKS                       R4 R4 K15 ["Typecheck"]
