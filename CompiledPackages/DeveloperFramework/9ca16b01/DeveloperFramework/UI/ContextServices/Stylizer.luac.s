...
PROTO_16:
        ...
        9 LOADK                            R8 K4 ["Style:getConsumerItem() is unable to find the Style in context of %*"]
       10 MOVE                             R10 R1
       11 NAMECALL                         R8 R8 K5 ["format"]
       13 CALL                             R8 2 1
       14 CALL                             R7 1 0
       15 RETURN                           R0 1
       16 LOADNIL                          R7
       17 JUMPIFNOT                        R4 ; [+33]
       18 FASTCALL1                        TYPEOF R4 ; [+3]
       19 MOVE                             R9 R4
       20 GETIMPORT                        R8 K7 [typeof]
       22 CALL                             R8 1 1
       23 JUMPIFNOTEQKS                    R8 K8 ["table"] ; [+13]
       25 DUPTABLE                         R10 K10 [{"__index"}]
       26 GETUPVAL                         R11 1
       27 SETTABLEKS                       R11 R10 K9 ["__index"]
       29 FASTCALL2                        SETMETATABLE R4 R10 ; [+4]
       31 MOVE                             R9 R4
       ...
       38 MOVE                             R9 R4
       39 GETIMPORT                        R8 K7 [typeof]
       41 CALL                             R8 1 1
       42 JUMPIFNOTEQKS                    R8 K13 ["string"] ; [+8]
       44 MOVE                             R10 R4
       45 MOVE                             R11 R5
       46 MOVE                             R12 R6
       47 NAMECALL                         R8 R0 K14 ["__getClassStyle"]
       49 CALL                             R8 4 1
       50 MOVE                             R7 R8
       51 MOVE                             R8 R7
       52 JUMPIF                           R8 ; [+5]
       53 GETTABLE                         R8 R5 R6
       54 JUMPIF                           R8 ; [+3]
       55 MOVE                             R8 R5
       56 JUMPIF                           R8 ; [+1]
       57 MOVE                             R8 R0
       ...
       63 JUMPIFNOT                        R3 ; [+37]
       64 JUMPIFNOT                        R8 ; [+36]
       65 DUPTABLE                         R11 K10 [{"__index"}]
       66 SETTABLEKS                       R7 R11 K9 ["__index"]
       68 FASTCALL2                        SETMETATABLE R8 R11 ; [+4]
       70 MOVE                             R10 R8
       71 GETIMPORT                        R9 K12 [setmetatable]
       73 CALL                             R9 2 0
       74 GETIMPORT                        R9 K16 [pairs]
       76 MOVE                             R10 R8
       77 CALL                             R9 1 3
       78 FORGPREP_NEXT                    R9
       79 FASTCALL1                        TYPEOF R13 ; [+3]
       80 MOVE                             R15 R13
       81 GETIMPORT                        R14 K7 [typeof]
       83 CALL                             R14 1 1
       84 JUMPIFNOTEQKS                    R14 K8 ["table"] ; [+13]
       86 GETTABLE                         R14 R7 R12
       87 JUMPIFNOT                        R14 ; [+10]
       88 DUPTABLE                         R16 K10 [{"__index"}]
       89 GETTABLE                         R17 R7 R12
       90 SETTABLEKS                       R17 R16 K9 ["__index"]
       92 FASTCALL2                        SETMETATABLE R13 R16 ; [+4]
       94 MOVE                             R15 R13
       95 GETIMPORT                        R14 K12 [setmetatable]
       97 CALL                             R14 2 0
       98 FORGLOOP                         R9 2 ; [-20]
      100 MOVE                             R7 R8
      101 RETURN                           R7 1
