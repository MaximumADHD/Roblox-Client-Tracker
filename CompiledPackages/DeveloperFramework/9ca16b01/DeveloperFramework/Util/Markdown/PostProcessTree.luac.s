...
PROTO_2:
       ...
       24 LOADB                            R5 0 +1
       25 LOADB                            R5 1
       26 LOADK                            R6 K4 ["Found non-inline content inside inline element at %*"]
       27 GETTABLEKS                       R8 R0 K5 ["offset"]
       29 NAMECALL                         R6 R6 K6 ["format"]
       31 CALL                             R6 2 1
       32 FASTCALL2                        ASSERT R5 R6 ; [+3]
       34 GETIMPORT                        R4 K8 [assert]
       36 CALL                             R4 2 0
       37 LOADK                            R4 K9 ["<%*>%*</%*>"]
       38 MOVE                             R6 R1
       39 GETTABLEKS                       R7 R3 K10 ["text"]
       41 MOVE                             R8 R1
       42 NAMECALL                         R4 R4 K6 ["format"]
       44 CALL                             R4 4 1
       45 RETURN                           R4 1
       46 GETTABLEKS                       R2 R0 K10 ["text"]
       48 JUMPIFNOT                        R2 ; [+3]
       49 GETTABLEKS                       R2 R0 K10 ["text"]
       51 RETURN                           R2 1
       52 LOADB                            R3 0
       53 LOADK                            R4 K11 ["No text for node at %*"]
       54 GETTABLEKS                       R6 R0 K5 ["offset"]
       56 NAMECALL                         R4 R4 K6 ["format"]
       58 CALL                             R4 2 1
       59 FASTCALL2                        ASSERT R3 R4 ; [+3]
       61 GETIMPORT                        R2 K8 [assert]
       63 CALL                             R2 2 0
       64 RETURN                           R0 0
...
MAIN:
       ...
       70 DUPCLOSURE                       R8 K28 [PROTO_7]
       71 SETTABLEKS                       R8 R7 K29 ["applyCodeSpanRules"]
       73 GETTABLEKS                       R8 R7 K15 ["postProcessTree"]
       75 RETURN                           R8 1
