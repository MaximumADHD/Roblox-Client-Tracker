...
PROTO_1:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R0 R1 K0 ["updateThumbnailChangeInfo"]
        3 CALL                             R0 0 0
        4 RETURN                           R0 0
...
PROTO_2:
       ...
       61 CALL                             R4 2 0
       62 GETUPVAL                         R5 0
       63 GETTABLEKS                       R4 R5 K15 ["updateThumbnailChangeInfo"]
       65 CALL                             R4 0 0
       66 RETURN                           R0 0
...
PROTO_4:
       ...
       22 CALL                             R2 2 0
       23 GETUPVAL                         R3 1
       24 GETTABLEKS                       R2 R3 K4 ["updateThumbnailChangeInfo"]
       26 CALL                             R2 0 0
       27 RETURN                           R0 0
...
PROTO_6:
       ...
       18 CALL                             R1 2 0
       19 GETUPVAL                         R2 1
       20 GETTABLEKS                       R1 R2 K3 ["updateThumbnailChangeInfo"]
       22 CALL                             R1 0 0
       23 RETURN                           R0 0
...
PROTO_8:
       ...
       24 CALL                             R1 2 0
       25 GETUPVAL                         R2 1
       26 GETTABLEKS                       R1 R2 K4 ["updateThumbnailChangeInfo"]
       28 CALL                             R1 0 0
       29 RETURN                           R0 0
...
PROTO_9:
       ...
       64 GETTABLEKS                       R12 R13 K12 ["altText"]
...
PROTO_15:
       ...
       14 GETUPVAL                         R8 0
       15 GETTABLEKS                       R7 R8 K2 ["createElement"]
       17 GETUPVAL                         R8 2
...
MAIN:
       ...
       59 GETTABLEKS                       R14 R0 K14 ["Util"]
       61 GETTABLEKS                       R13 R14 K18 ["getFileMaxSizeBytesOrDefault"]
       63 CALL                             R12 1 1
       64 GETIMPORT                        R13 K6 [require]
       66 GETIMPORT                        R15 K1 [script]
       68 GETTABLEKS                       R14 R15 K19 ["RejectedThumbnailDialog"]
       70 CALL                             R13 1 1
       71 GETIMPORT                        R14 K6 [require]
       73 GETTABLEKS                       R16 R0 K20 ["SharedFlags"]
       75 GETTABLEKS                       R15 R16 K21 ["getFFlagDevFrameworkSettingsCliFix"]
       77 CALL                             R14 1 1
       78 CALL                             R14 0 1
