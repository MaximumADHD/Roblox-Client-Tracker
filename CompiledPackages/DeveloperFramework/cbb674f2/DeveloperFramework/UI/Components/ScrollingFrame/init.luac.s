...
PROTO_2:
       ...
       33 CALL                             R6 2 1
       34 GETUPVAL                         R9 0
       35 GETTABLEKS                       R8 R9 K12 ["Dictionary"]
       37 GETTABLEKS                       R7 R8 K13 ["join"]
       39 GETUPVAL                         R9 1
       40 JUMPIFNOT                        R9 ; [+13]
       41 NEWTABLE                         R8 1 0
       43 GETUPVAL                         R10 2
       44 GETTABLEKS                       R9 R10 K14 ["Tag"]
       46 GETUPVAL                         R11 3
       ...
       55 MOVE                             R9 R0
       56 GETUPVAL                         R12 4
       57 GETTABLEKS                       R11 R12 K16 ["propFilters"]
       59 GETTABLEKS                       R10 R11 K17 ["parentContainerProps"]
       61 NEWTABLE                         R11 8 0
       63 GETUPVAL                         R13 1
       64 JUMPIFNOT                        R13 ; [+6]
       ...
       77 GETUPVAL                         R13 0
       78 GETTABLEKS                       R12 R13 K21 ["None"]
       80 SETTABLEKS                       R12 R11 K22 ["ForwardRef"]
       82 GETUPVAL                         R13 5
       83 GETTABLEKS                       R12 R13 K23 ["Children"]
       85 GETUPVAL                         R14 0
       86 GETTABLEKS                       R13 R14 K21 ["None"]
       88 SETTABLE                         R13 R11 R12
       89 GETUPVAL                         R14 5
       90 GETTABLEKS                       R13 R14 K24 ["Change"]
       92 GETTABLEKS                       R12 R13 K25 ["CanvasPosition"]
       94 GETUPVAL                         R14 4
       95 GETTABLEKS                       R13 R14 K26 ["onScroll"]
       97 SETTABLE                         R13 R11 R12
       98 GETUPVAL                         R14 5
       99 GETTABLEKS                       R13 R14 K24 ["Change"]
      101 GETTABLEKS                       R12 R13 K27 ["AbsoluteSize"]
      103 GETUPVAL                         R14 1
      104 JUMPIFNOT                        R14 ; [+2]
      105 LOADNIL                          R13
      106 JUMP                             ; [+3]
      107 GETUPVAL                         R14 4
      108 GETTABLEKS                       R13 R14 K28 ["updateCanvasSize"]
      110 SETTABLE                         R13 R11 R12
      111 GETUPVAL                         R13 5
      112 GETTABLEKS                       R12 R13 K29 ["Ref"]
      114 GETUPVAL                         R14 4
      115 GETTABLEKS                       R13 R14 K30 ["scrollingRef"]
      117 SETTABLE                         R13 R11 R12
      118 GETUPVAL                         R13 0
      119 GETTABLEKS                       R12 R13 K21 ["None"]
...
MAIN:
       ...
       32 GETTABLEKS                       R4 R5 K9 ["React"]
       34 CALL                             R3 1 1
       35 JUMP                             ; [+1]
       36 LOADNIL                          R3
       37 GETIMPORT                        R4 K6 [require]
       39 GETTABLEKS                       R6 R0 K11 ["Styling"]
       41 GETTABLEKS                       R5 R6 K12 ["supportsStyleSheets"]
       43 CALL                             R4 1 1
       44 GETIMPORT                        R5 K6 [require]
       46 GETTABLEKS                       R7 R0 K11 ["Styling"]
       48 GETTABLEKS                       R6 R7 K13 ["joinTags"]
       50 CALL                             R5 1 1
       51 GETIMPORT                        R6 K6 [require]
       53 GETTABLEKS                       R8 R0 K4 ["Parent"]
       55 GETTABLEKS                       R7 R8 K14 ["Cryo"]
       57 CALL                             R6 1 1
       58 GETIMPORT                        R7 K6 [require]
       60 GETTABLEKS                       R9 R0 K2 ["UI"]
       62 GETTABLEKS                       R8 R9 K15 ["ContextServices"]
       64 CALL                             R7 1 1
       65 GETTABLEKS                       R8 R7 K16 ["withContext"]
       67 GETIMPORT                        R9 K6 [require]
       69 GETIMPORT                        R12 K1 [script]
       71 GETTABLEKS                       R11 R12 K4 ["Parent"]
       73 GETTABLEKS                       R10 R11 K17 ["Pane"]
       75 CALL                             R9 1 1
       76 GETTABLEKS                       R10 R2 K18 ["prioritize"]
       78 GETIMPORT                        R11 K6 [require]
       80 GETTABLEKS                       R13 R0 K8 ["Util"]
       82 GETTABLEKS                       R12 R13 K19 ["Typecheck"]
       84 CALL                             R11 1 1
       85 GETIMPORT                        R12 K6 [require]
       87 GETTABLEKS                       R14 R0 K20 ["Wrappers"]
       89 GETTABLEKS                       R13 R14 K21 ["withForwardRef"]
       91 CALL                             R12 1 1
       92 JUMPIF                           R4 ; [+8]
       93 GETIMPORT                        R13 K6 [require]
       95 GETIMPORT                        R15 K1 [script]
       97 GETTABLEKS                       R14 R15 K22 ["style"]
       99 CALL                             R13 1 1
      100 JUMP                             ; [+1]
      101 LOADNIL                          R13
