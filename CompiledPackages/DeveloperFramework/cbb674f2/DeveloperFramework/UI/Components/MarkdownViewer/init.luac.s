PROTO_0:
        ...
        3 GETUPVAL                         R2 1
        4 GETTABLEKS                       R1 R2 K1 ["defaultRenderers"]
        6 GETUPVAL                         R3 2
        7 GETTABLEKS                       R2 R3 K2 ["Renderers"]
        9 JUMPIF                           R2 ; [+2]
       10 NEWTABLE                         R2 0 0
       12 CALL                             R0 2 -1
       13 RETURN                           R0 -1
...
PROTO_1:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R0 R1 K0 ["Ast"]
        3 JUMPIFNOT                        R0 ; [+5]
        4 LOADB                            R0 1
        5 GETUPVAL                         R2 0
        6 GETTABLEKS                       R1 R2 K0 ["Ast"]
        8 RETURN                           R0 2
        9 GETUPVAL                         R1 0
       10 GETTABLEKS                       R0 R1 K1 ["Markdown"]
       12 JUMPIFNOT                        R0 ; [+24]
       13 GETUPVAL                         R1 1
       14 GETTABLEKS                       R0 R1 K2 ["safeParse"]
       16 GETUPVAL                         R2 0
       17 GETTABLEKS                       R1 R2 K1 ["Markdown"]
       19 CALL                             R0 1 2
       20 JUMPIF                           R0 ; [+15]
       21 GETUPVAL                         R3 0
       22 GETTABLEKS                       R2 R3 K3 ["OnError"]
       24 JUMPIFNOT                        R2 ; [+6]
       25 GETUPVAL                         R3 0
       26 GETTABLEKS                       R2 R3 K3 ["OnError"]
       28 MOVE                             R3 R1
       29 CALL                             R2 1 0
       30 RETURN                           R0 2
...
PROTO_3:
       ...
       11 RETURN                           R1 1
       12 GETUPVAL                         R2 0
       13 GETTABLEKS                       R1 R2 K5 ["useMemo"]
       15 NEWCLOSURE                       R2 P0
       16 CAPTURE                          UPVAL U1
       17 CAPTURE                          UPVAL U2
       18 CAPTURE                          VAL R0
       ...
       25 CALL                             R1 2 1
       26 GETUPVAL                         R3 0
       27 GETTABLEKS                       R2 R3 K5 ["useMemo"]
       29 NEWCLOSURE                       R3 P1
       30 CAPTURE                          VAL R0
       31 CAPTURE                          UPVAL U3
       32 NEWTABLE                         R4 0 2
       ...
       40 CALL                             R2 2 2
       41 GETUPVAL                         R5 0
       42 GETTABLEKS                       R4 R5 K5 ["useMemo"]
       44 NEWCLOSURE                       R5 P2
       45 CAPTURE                          VAL R2
       46 CAPTURE                          UPVAL U2
       47 CAPTURE                          VAL R3
       ...
       67 JUMPIF                           R5 ; [+30]
       68 GETUPVAL                         R6 0
       69 GETTABLEKS                       R5 R6 K11 ["createElement"]
       71 LOADK                            R6 K12 ["Frame"]
       72 GETUPVAL                         R8 1
       73 GETTABLEKS                       R7 R8 K13 ["join"]
       75 NEWTABLE                         R8 1 0
       77 GETUPVAL                         R10 0
       78 GETTABLEKS                       R9 R10 K14 ["Tag"]
       ...
       87 CALL                             R7 2 1
       88 GETUPVAL                         R9 0
       89 GETTABLEKS                       R8 R9 K11 ["createElement"]
       91 GETUPVAL                         R9 4
       ...
       98 RETURN                           R5 1
       99 GETUPVAL                         R6 0
      100 GETTABLEKS                       R5 R6 K11 ["createElement"]
      102 LOADK                            R6 K12 ["Frame"]
      103 GETUPVAL                         R8 1
      104 GETTABLEKS                       R7 R8 K13 ["join"]
      106 NEWTABLE                         R8 1 0
      108 GETUPVAL                         R10 0
      109 GETTABLEKS                       R9 R10 K14 ["Tag"]
...
MAIN:
       ...
       27 GETTABLEKS                       R5 R6 K10 ["Markdown"]
       29 GETTABLEKS                       R4 R5 K11 ["MarkdownParser"]
       31 CALL                             R3 1 1
       32 GETIMPORT                        R4 K6 [require]
       34 GETTABLEKS                       R7 R0 K7 ["Util"]
       36 GETTABLEKS                       R6 R7 K12 ["Highlighter"]
       38 GETTABLEKS                       R5 R6 K13 ["Types"]
       40 CALL                             R4 1 1
       41 GETIMPORT                        R5 K6 [require]
       43 GETTABLEKS                       R8 R0 K7 ["Util"]
       45 GETTABLEKS                       R7 R8 K10 ["Markdown"]
       47 GETTABLEKS                       R6 R7 K13 ["Types"]
       49 CALL                             R5 1 1
       50 GETIMPORT                        R6 K6 [require]
       52 GETIMPORT                        R8 K1 [script]
       54 GETTABLEKS                       R7 R8 K14 ["MarkdownRenderer"]
       56 CALL                             R6 1 1
       57 GETIMPORT                        R7 K6 [require]
       59 GETTABLEKS                       R10 R0 K2 ["UI"]
       61 GETTABLEKS                       R9 R10 K15 ["Components"]
       63 GETTABLEKS                       R8 R9 K16 ["TextLabel"]
       65 CALL                             R7 1 1
