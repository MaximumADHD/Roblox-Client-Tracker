...
PROTO_2:
       ...
       35 LOADK                            R6 K17 [{2, 0.1, 0.1}]
       36 GETTABLEKS                       R5 R6 K25 ["X"]
       38 DIVK                             R4 R5 K24 [2]
       39 LOADN                            R5 0
       40 LOADN                            R6 0
       41 CALL                             R3 3 1
       42 SETTABLEKS                       R3 R2 K22 ["CFrame"]
       44 GETUPVAL                         R4 1
       45 GETIMPORT                        R5 K3 [Instance.new]
       47 LOADK                            R6 K5 ["Part"]
       48 CALL                             R5 1 1
       49 GETIMPORT                        R6 K9 [Enum.PartType.Cylinder]
       51 SETTABLEKS                       R6 R5 K10 ["Shape"]
       53 GETIMPORT                        R6 K13 [Enum.SurfaceType.Smooth]
       55 SETTABLEKS                       R6 R5 K14 ["TopSurface"]
       57 GETIMPORT                        R6 K13 [Enum.SurfaceType.Smooth]
       59 SETTABLEKS                       R6 R5 K15 ["BottomSurface"]
       61 SETTABLEKS                       R1 R5 K16 ["Parent"]
       63 LOADK                            R6 K17 [{2, 0.1, 0.1}]
       64 SETTABLEKS                       R6 R5 K18 ["Size"]
       66 SETTABLEKS                       R4 R5 K19 ["Color"]
       68 LOADK                            R6 K26 ["YAxis"]
       69 SETTABLEKS                       R6 R5 K21 ["Name"]
       71 MOVE                             R3 R5
       72 GETIMPORT                        R5 K23 [CFrame.new]
       74 LOADN                            R6 0
       75 LOADK                            R9 K17 [{2, 0.1, 0.1}]
       76 GETTABLEKS                       R8 R9 K25 ["X"]
       78 DIVK                             R7 R8 K24 [2]
       79 LOADN                            R8 0
       80 CALL                             R5 3 1
       81 GETIMPORT                        R6 K28 [CFrame.Angles]
       83 LOADN                            R7 0
       84 LOADN                            R8 0
       85 LOADK                            R9 K29 [1.5707963267949]
       86 CALL                             R6 3 1
       87 MUL                              R4 R5 R6
       88 SETTABLEKS                       R4 R3 K22 ["CFrame"]
       90 GETUPVAL                         R5 2
       91 GETIMPORT                        R6 K3 [Instance.new]
       93 LOADK                            R7 K5 ["Part"]
       94 CALL                             R6 1 1
       95 GETIMPORT                        R7 K9 [Enum.PartType.Cylinder]
       97 SETTABLEKS                       R7 R6 K10 ["Shape"]
       99 GETIMPORT                        R7 K13 [Enum.SurfaceType.Smooth]
      101 SETTABLEKS                       R7 R6 K14 ["TopSurface"]
      103 GETIMPORT                        R7 K13 [Enum.SurfaceType.Smooth]
      105 SETTABLEKS                       R7 R6 K15 ["BottomSurface"]
      107 SETTABLEKS                       R1 R6 K16 ["Parent"]
      109 LOADK                            R7 K17 [{2, 0.1, 0.1}]
      110 SETTABLEKS                       R7 R6 K18 ["Size"]
      112 SETTABLEKS                       R5 R6 K19 ["Color"]
      114 LOADK                            R7 K30 ["ZAxis"]
      115 SETTABLEKS                       R7 R6 K21 ["Name"]
      117 MOVE                             R4 R6
      118 GETIMPORT                        R6 K23 [CFrame.new]
      120 LOADN                            R7 0
      121 LOADN                            R8 0
      122 LOADK                            R11 K17 [{2, 0.1, 0.1}]
      123 GETTABLEKS                       R10 R11 K25 ["X"]
      125 DIVK                             R9 R10 K24 [2]
      126 CALL                             R6 3 1
      127 GETIMPORT                        R7 K28 [CFrame.Angles]
      129 LOADN                            R8 0
      130 LOADK                            R9 K29 [1.5707963267949]
      131 LOADN                            R10 0
      132 CALL                             R7 3 1
      133 MUL                              R5 R6 R7
      134 SETTABLEKS                       R5 R4 K22 ["CFrame"]
      136 RETURN                           R1 1
