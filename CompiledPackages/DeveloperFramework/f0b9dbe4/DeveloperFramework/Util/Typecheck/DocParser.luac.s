...
PROTO_1:
        ...
        2 GETUPVAL                         R4 0
        3 GETTABLEKS                       R3 R4 K1 ["instanceIsA"]
...
PROTO_2:
       ...
       22 JUMPIFNOT                        R5 ; [+16]
       23 GETUPVAL                         R7 0
       24 GETTABLEKS                       R6 R7 K9 ["PropParser"]
       26 GETTABLEKS                       R5 R6 K10 ["parseProps"]
       28 GETUPVAL                         R9 0
       29 GETTABLEKS                       R8 R9 K11 ["DocTypes"]
       31 GETTABLEKS                       R7 R8 K12 ["Typecheckers"]
       33 GETTABLEKS                       R6 R7 K13 ["Luau"]
       35 MOVE                             R7 R4
       36 MOVE                             R8 R3
       37 CALL                             R5 3 -1
       38 RETURN                           R5 -1
...
PROTO_3:
       ...
       11 JUMPIFNOT                        R4 ; [+15]
       12 GETUPVAL                         R6 0
       13 GETTABLEKS                       R5 R6 K6 ["PropParser"]
       15 GETTABLEKS                       R4 R5 K7 ["parseProps"]
       17 GETUPVAL                         R8 0
       18 GETTABLEKS                       R7 R8 K8 ["DocTypes"]
       20 GETTABLEKS                       R6 R7 K9 ["Typecheckers"]
       22 GETTABLEKS                       R5 R6 K10 ["Luau"]
       24 MOVE                             R6 R3
       25 CALL                             R4 2 -1
       26 RETURN                           R4 -1
       27 LOADNIL                          R4
...
PROTO_5:
       ...
       21 GETUPVAL                         R5 1
       22 GETTABLEKS                       R4 R5 K5 ["Summary"]
       24 LOADK                            R7 K7 ["\r"]
       25 LOADK                            R8 K8 [""]
       ...
       85 JUMP                             ; [+88]
       86 GETUPVAL                         R14 1
       87 GETTABLEKS                       R13 R14 K5 ["Summary"]
      ...
      129 JUMP                             ; [+44]
      130 GETUPVAL                         R14 1
      131 GETTABLEKS                       R13 R14 K21 ["Required"]
      ...
      144 JUMP                             ; [+29]
      145 GETUPVAL                         R14 1
      146 GETTABLEKS                       R13 R14 K23 ["Optional"]
      ...
      159 JUMP                             ; [+14]
      160 GETUPVAL                         R14 1
      161 GETTABLEKS                       R13 R14 K4 ["Style"]
...
PROTO_6:
        0 GETUPVAL                         R3 0
        1 GETTABLEKS                       R2 R3 K0 ["strictInterface"]
        3 DUPTABLE                         R3 K4 [{"Summary", "Props", "Style"}]
        4 GETUPVAL                         R5 0
        5 GETTABLEKS                       R4 R5 K5 ["optional"]
        7 GETUPVAL                         R6 0
        8 GETTABLEKS                       R5 R6 K6 ["string"]
       10 CALL                             R4 1 1
       11 SETTABLEKS                       R4 R3 K1 ["Summary"]
       13 GETUPVAL                         R5 0
       14 GETTABLEKS                       R4 R5 K7 ["table"]
       16 SETTABLEKS                       R4 R3 K2 ["Props"]
       18 GETUPVAL                         R5 0
       19 GETTABLEKS                       R4 R5 K7 ["table"]
       ...
       30 NEWTABLE                         R1 4 0
       32 GETUPVAL                         R3 1
       33 GETTABLEKS                       R2 R3 K10 ["Children"]
       35 GETUPVAL                         R4 0
       36 GETTABLEKS                       R3 R4 K5 ["optional"]
       38 GETUPVAL                         R5 0
       39 GETTABLEKS                       R4 R5 K7 ["table"]
       41 CALL                             R3 1 1
       42 SETTABLE                         R3 R1 R2
       43 GETUPVAL                         R3 1
       44 GETTABLEKS                       R2 R3 K11 ["Ref"]
       46 GETUPVAL                         R4 0
       47 GETTABLEKS                       R3 R4 K5 ["optional"]
       49 GETUPVAL                         R5 2
       50 GETTABLEKS                       R4 R5 K12 ["RoactRef"]
       52 CALL                             R3 1 1
       53 SETTABLE                         R3 R1 R2
       54 GETUPVAL                         R4 1
       55 GETTABLEKS                       R3 R4 K13 ["Change"]
       57 GETTABLEKS                       R2 R3 K14 ["AbsoluteSize"]
       59 GETUPVAL                         R4 0
       60 GETTABLEKS                       R3 R4 K5 ["optional"]
       62 GETUPVAL                         R5 0
       63 GETTABLEKS                       R4 R5 K15 ["callback"]
       65 CALL                             R3 1 1
       66 SETTABLE                         R3 R1 R2
       67 GETUPVAL                         R2 3
       68 JUMPIFNOT                        R2 ; [+11]
       69 GETUPVAL                         R3 4
       70 GETTABLEKS                       R2 R3 K16 ["Tag"]
       72 GETUPVAL                         R4 0
       73 GETTABLEKS                       R3 R4 K5 ["optional"]
       75 GETUPVAL                         R5 0
       76 GETTABLEKS                       R4 R5 K6 ["string"]
       78 CALL                             R3 1 1
       ...
       87 FORGPREP_NEXT                    R3
       88 GETUPVAL                         R9 5
       89 GETTABLEKS                       R8 R9 K19 ["__addCheckForProp"]
       91 MOVE                             R9 R1
       92 MOVE                             R10 R7
       93 CALL                             R8 2 0
       94 FORGLOOP                         R3 2 ; [-7]
      ...
      102 GETUPVAL                         R9 5
      103 GETTABLEKS                       R8 R9 K19 ["__addCheckForProp"]
      105 MOVE                             R9 R2
      106 MOVE                             R10 R7
      107 CALL                             R8 2 0
      108 FORGLOOP                         R3 2 ; [-7]
      110 GETUPVAL                         R4 0
      111 GETTABLEKS                       R3 R4 K0 ["strictInterface"]
      113 MOVE                             R4 R1
      114 CALL                             R3 1 1
      ...
      119 JUMPIFNOT                        R5 ; [+6]
      120 GETUPVAL                         R5 0
      121 GETTABLEKS                       R4 R5 K22 ["interface"]
      123 MOVE                             R5 R2
      124 CALL                             R4 1 1
      125 JUMPIF                           R4 ; [+1]
      126 LOADNIL                          R4
...
PROTO_8:
       ...
       73 GETTABLEKS                       R6 R7 K17 ["Comment"]
       75 LENGTH                           R8 R1
...
PROTO_9:
       ...
       45 JUMPIFNOT                        R9 ; [+13]
       46 GETUPVAL                         R11 0
       47 GETTABLEKS                       R10 R11 K15 ["array"]
       49 MOVE                             R11 R9
       50 CALL                             R10 1 1
       51 MOVE                             R6 R10
       52 JUMP                             ; [+6]
       ...
       69 JUMPIFNOT                        R4 ; [+6]
       70 GETUPVAL                         R10 0
       71 GETTABLEKS                       R9 R10 K21 ["optional"]
       73 MOVE                             R10 R6
       74 CALL                             R9 1 1
       75 MOVE                             R6 R9
       76 LOADN                            R11 1
       ...
       90 GETUPVAL                         R10 2
       91 GETTABLEKS                       R9 R10 K24 ["Change"]
       93 LOADN                            R12 14
      ...
      106 GETUPVAL                         R10 2
      107 GETTABLEKS                       R9 R10 K26 ["Event"]
      109 LOADN                            R12 13
      ...
      122 GETUPVAL                         R10 0
      123 GETTABLEKS                       R9 R10 K29 ["union"]
      125 MOVE                             R10 R5
      126 MOVE                             R11 R6
      127 CALL                             R9 2 1
...
MAIN:
       ...
       18 GETTABLEKS                       R4 R0 K2 ["Util"]
       20 GETTABLEKS                       R3 R4 K8 ["Symbol"]
       22 CALL                             R2 1 1
       ...
       41 GETTABLEKS                       R5 R6 K10 ["DocUtils"]
       43 CALL                             R4 1 1
       44 JUMP                             ; [+1]
       45 LOADNIL                          R4
       ...
       52 GETTABLEKS                       R6 R7 K12 ["FrameworkTypes"]
       54 CALL                             R5 1 1
       ...
       64 GETTABLEKS                       R8 R0 K4 ["Parent"]
       66 GETTABLEKS                       R7 R8 K13 ["React"]
       68 CALL                             R6 1 1
       69 JUMP                             ; [+1]
       70 LOADNIL                          R6
       71 JUMPIFNOT                        R6 ; [+7]
       ...
       84 GETTABLEKS                       R10 R11 K4 ["Parent"]
       86 GETTABLEKS                       R9 R10 K15 ["t"]
       88 CALL                             R8 1 1
