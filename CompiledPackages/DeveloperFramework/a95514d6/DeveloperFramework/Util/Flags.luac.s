PROTO_0:
       ...
       17 GETIMPORT                        R4 K9 [game]
       19 GETTABLEKS                       R3 R4 K10 ["GetFastFlag"]
       ...
       31 GETIMPORT                        R6 K9 [game]
       33 GETTABLEKS                       R5 R6 K11 ["DefineFastFlag"]
...
PROTO_3:
        ...
        3 LOADNIL                          R2
        4 DUPTABLE                         R3 K4 [{"shouldAssertOnMissingFlag", "shouldFetchLiveValues", "defaultValueIfMissing"}]
        5 LOADB                            R4 0
        6 SETTABLEKS                       R4 R3 K1 ["shouldAssertOnMissingFlag"]
        8 LOADB                            R4 0
        9 SETTABLEKS                       R4 R3 K2 ["shouldFetchLiveValues"]
       11 JUMPIFEQKNIL                     R0 ; [+3]
       13 MOVE                             R4 R0
       14 JUMPIF                           R4 ; [+1]
       15 LOADB                            R4 0
       16 SETTABLEKS                       R4 R3 K3 ["defaultValueIfMissing"]
       18 CALL                             R1 2 1
       19 RETURN                           R1 1
...
PROTO_5:
        ...
        3 CALL                             R3 2 0
        4 GETUPVAL                         R4 1
        5 GETTABLEKS                       R3 R4 K0 ["JoinDictionaries"]
...
PROTO_7:
       ...
       15 CALL                             R2 -1 0
       16 GETUPVAL                         R3 0
       17 GETTABLEKS                       R2 R3 K7 ["RemoveFromDictionary"]
