...
PROTO_1:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R2 R2 K0 ["hasEnoughRatings"]
        3 MOVE                             R3 R0
        4 CALL                             R2 1 1
        5 JUMPIF                           R2 ; [+2]
        6 LOADK                            R2 K1 [""]
       ...
       19 MOVE                             R5 R0
       20 GETUPVAL                         R6 1
       21 GETTABLEKS                       R6 R6 K4 ["Truncate"]
       23 LOADN                            R7 1
...
PROTO_2:
        0 GETUPVAL                         R4 0
        1 GETTABLEKS                       R4 R4 K0 ["hasEnoughRatings"]
        3 MOVE                             R5 R0
        4 CALL                             R4 1 1
        5 JUMPIF                           R4 ; [+7]
        6 GETUPVAL                         R6 1
       ...
       12 RETURN                           R4 -1
       13 GETUPVAL                         R4 0
       14 GETTABLEKS                       R4 R4 K4 ["getFormattedVoteNumber"]
       16 MOVE                             R5 R0
       17 MOVE                             R6 R1
       18 CALL                             R4 2 1
       19 JUMPIFNOT                        R2 ; [+10]
...
MAIN:
       ...
       11 GETTABLEKS                       R2 R2 K6 ["RoundingBehaviour"]
       13 CALL                             R1 1 1
