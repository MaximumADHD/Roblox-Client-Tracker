...
PROTO_3:
       ...
       24 CALL                             R8 0 1
       25 JUMPIFNOT                        R8 ; [+2]
       26 DUPTABLE                         R7 K17 [{["PassesThroughMouseEvents"] = True}]
       27 JUMP                             ; [+1]
       28 DUPTABLE                         R7 K19 [{["GrabsMouse"] = False}]
       29 SETTABLEKS                       R7 R6 K7 ["Popup"]
       31 GETIMPORT                        R7 K15 [Vector2.new]
       33 LOADN                            R8 100
       34 LOADN                            R9 100
       35 CALL                             R7 2 1
       36 SETTABLEKS                       R7 R6 K10 ["Size"]
       38 SETTABLEKS                       R2 R6 K11 ["Title"]
       40 NAMECALL                         R3 R0 K20 ["CreateQWidgetPluginGui"]
       42 CALL                             R3 3 1
       43 GETIMPORT                        R4 K24 [Enum.ZIndexBehavior.Sibling]
       45 SETTABLEKS                       R4 R3 K22 ["ZIndexBehavior"]
       47 GETUPVAL                         R4 2
       48 GETTABLEKS                       R4 R4 K25 ["createRoot"]
       50 MOVE                             R5 R3
       51 CALL                             R4 1 1
       52 DUPTABLE                         R5 K32 [{["depth"], ["uri"], ["panel"], ["root"], ["open"] = False, ["Panels"]}]
       53 GETUPVAL                         R8 0
       54 LENGTH                           R7 R8
       55 ADDK                             R6 R7 K33 [1]
       56 SETTABLEKS                       R6 R5 K26 ["depth"]
       58 GETUPVAL                         R6 3
       59 NAMECALL                         R7 R0 K34 ["GetUri"]
       61 CALL                             R7 1 1
       62 DUPTABLE                         R8 K37 [{["Category"] = "Panels", ["ItemId"]}]
       63 SETTABLEKS                       R2 R8 K36 ["ItemId"]
       65 CALL                             R6 2 1
       66 SETTABLEKS                       R6 R5 K27 ["uri"]
       68 SETTABLEKS                       R3 R5 K28 ["panel"]
       70 SETTABLEKS                       R4 R5 K29 ["root"]
       72 LOADK                            R8 K31 ["Panels"]
       73 NAMECALL                         R6 R0 K38 ["GetPluginComponent"]
       75 CALL                             R6 2 1
       76 SETTABLEKS                       R6 R5 K31 ["Panels"]
       78 GETUPVAL                         R6 0
       79 SETTABLE                         R5 R6 R1
       80 LOADK                            R8 K39 ["PluginGui"]
       81 NAMECALL                         R6 R3 K40 ["IsA"]
       83 CALL                             R6 2 1
       84 JUMPIFNOT                        R6 ; [+7]
       85 NEWCLOSURE                       R8 P0
       86 CAPTURE                          UPVAL U0
       87 CAPTURE                          VAL R5
       88 CAPTURE                          UPVAL U4
       89 NAMECALL                         R6 R3 K41 ["BindToClose"]
       91 CALL                             R6 2 0
       92 RETURN                           R5 1
