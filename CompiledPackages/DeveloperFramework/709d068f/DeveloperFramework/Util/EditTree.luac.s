...
PROTO_8:
       ...
       17 GETUPVAL                         R5 1
       18 GETTABLEKS                       R4 R5 K6 ["_interface"]
       20 GETTABLEKS                       R3 R4 K7 ["getChildren"]
       22 MOVE                             R4 R2
       23 CALL                             R3 1 1
...
PROTO_10:
       ...
       15 CALL                             R5 2 0
       16 GETTABLEKS                       R6 R0 K5 ["_interface"]
       18 GETTABLEKS                       R5 R6 K6 ["getId"]
       20 MOVE                             R6 R4
       21 CALL                             R5 1 1
       22 GETUPVAL                         R6 0
...
PROTO_12:
        ...
        4 MOVE                             R7 R5
        5 CALL                             R6 1 1
        6 GETTABLEKS                       R9 R1 K0 ["Columns"]
        8 GETTABLE                         R8 R9 R4
        9 GETTABLEKS                       R7 R8 K1 ["Key"]
       11 MOVE                             R10 R1
       12 MOVE                             R11 R5
...
PROTO_13:
        0 GETTABLEKS                       R5 R0 K0 ["_interface"]
        2 GETTABLEKS                       R4 R5 K1 ["getId"]
        4 MOVE                             R5 R2
        5 CALL                             R4 1 1
        6 GETTABLEKS                       R6 R0 K0 ["_interface"]
        8 GETTABLEKS                       R5 R6 K1 ["getId"]
       10 MOVE                             R6 R3
       11 CALL                             R5 1 1
...
PROTO_14:
        ...
        1 JUMPIFEQKNIL                     R1 ; [+6]
        3 GETUPVAL                         R2 0
        4 GETTABLEKS                       R1 R2 K0 ["Children"]
       ...
       13 GETUPVAL                         R4 0
       14 GETTABLEKS                       R3 R4 K0 ["Children"]
       ...
       25 CALL                             R1 2 0
       26 GETUPVAL                         R3 0
       27 GETTABLEKS                       R2 R3 K0 ["Children"]
       ...
       40 CALL                             R3 4 0
       41 GETUPVAL                         R4 0
       42 GETTABLEKS                       R3 R4 K0 ["Children"]
...
PROTO_28:
        ...
        2 LOADNIL                          R5
        3 FORGPREP                         R3
        4 GETTABLEKS                       R9 R0 K0 ["_interface"]
        6 GETTABLEKS                       R8 R9 K1 ["getId"]
        8 MOVE                             R9 R7
        9 CALL                             R8 1 1
       10 JUMPIFNOTEQ                      R8 R2 ; [+2]
       12 RETURN                           R7 1
       13 GETTABLEKS                       R9 R0 K0 ["_interface"]
       15 GETTABLEKS                       R8 R9 K2 ["getChildren"]
       17 MOVE                             R9 R7
       18 CALL                             R8 1 1
       19 JUMPIFNOT                        R8 ; [+7]
       20 MOVE                             R11 R8
...
PROTO_29:
        ...
        3 LOADNIL                          R5
        4 FORGPREP                         R3
        5 GETTABLEKS                       R9 R0 K0 ["_interface"]
        7 GETTABLEKS                       R8 R9 K1 ["getId"]
        9 MOVE                             R9 R7
       10 CALL                             R8 1 1
       11 LOADB                            R9 1
...
PROTO_30:
       ...
       16 LOADNIL                          R8
       17 FORGPREP                         R6
       18 GETTABLEKS                       R12 R0 K2 ["_interface"]
       20 GETTABLEKS                       R11 R12 K3 ["getId"]
       22 MOVE                             R12 R5
       23 CALL                             R11 1 1
       24 JUMPIFEQ                         R5 R4 ; [+3]
       26 LOADB                            R12 1
