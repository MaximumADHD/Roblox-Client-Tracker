PROTO_0:
        0 GETUPVAL                         R5 0
        1 GETTABLE                         R4 R5 R0
        2 GETTABLEKS                       R3 R4 K0 ["MinWidth"]
        4 GETUPVAL                         R6 0
        5 GETTABLE                         R5 R6 R1
        6 GETTABLEKS                       R4 R5 K0 ["MinWidth"]
        8 JUMPIFLT                         R3 R4 ; [+2]
       10 LOADB                            R2 0 +1
       11 LOADB                            R2 1
       12 RETURN                           R2 1
...
PROTO_1:
        0 LOADN                            R0 1
        1 GETUPVAL                         R2 0
        2 GETTABLEKS                       R1 R2 K0 ["ref"]
        4 JUMPIFNOT                        R1 ; [+5]
        5 GETUPVAL                         R3 0
        6 GETTABLEKS                       R2 R3 K0 ["ref"]
        8 GETTABLEKS                       R1 R2 K1 ["current"]
       10 GETTABLEKS                       R3 R1 K2 ["AbsoluteSize"]
       12 GETTABLEKS                       R2 R3 K3 ["X"]
       14 GETIMPORT                        R3 K5 [pairs]
       16 GETUPVAL                         R6 0
       17 GETTABLEKS                       R4 R6 K6 ["sortedCutOffList"]
       19 CALL                             R3 1 3
       20 FORGPREP_NEXT                    R3
       21 GETUPVAL                         R10 0
       22 GETTABLEKS                       R9 R10 K6 ["sortedCutOffList"]
       24 GETTABLE                         R8 R9 R6
       25 GETTABLEKS                       R10 R8 K7 ["MinWidth"]
       27 GETUPVAL                         R14 0
       28 GETTABLEKS                       R13 R14 K6 ["sortedCutOffList"]
       30 GETTABLEN                        R12 R13 1
       31 GETTABLEKS                       R11 R12 K7 ["MinWidth"]
       33 JUMPIFLT                         R11 R10 ; [+2]
       35 LOADB                            R9 0 +1
       36 LOADB                            R9 1
       37 GETUPVAL                         R14 0
       38 GETTABLEKS                       R13 R14 K6 ["sortedCutOffList"]
       40 GETTABLEN                        R12 R13 1
       41 GETTABLEKS                       R11 R12 K7 ["MinWidth"]
...
PROTO_2:
       ...
       38 GETUPVAL                         R10 0
       39 GETTABLEKS                       R9 R10 K2 ["sortedCutOffList"]
...
PROTO_3:
        ...
        2 GETUPVAL                         R4 0
        3 GETTABLEKS                       R3 R4 K1 ["ref"]
        5 GETTABLEKS                       R2 R3 K2 ["current"]
        7 JUMPIFNOT                        R1 ; [+1]
        8 JUMPIF                           R2 ; [+1]
        9 RETURN                           R0 0
       10 GETUPVAL                         R5 0
       11 GETTABLEKS                       R4 R5 K3 ["sortedCutOffList"]
       13 GETTABLE                         R3 R4 R1
       14 LOADNIL                          R4
       15 ADDK                             R5 R1 K4 [1]
       16 GETUPVAL                         R8 0
       17 GETTABLEKS                       R7 R8 K3 ["sortedCutOffList"]
       19 LENGTH                           R6 R7
       20 JUMPIFNOTLE                      R5 R6 ; [+6]
       22 GETUPVAL                         R6 0
       23 GETTABLEKS                       R5 R6 K3 ["sortedCutOffList"]
       25 ADDK                             R6 R1 K4 [1]
       ...
       31 GETUPVAL                         R7 0
       32 GETTABLEKS                       R6 R7 K3 ["sortedCutOffList"]
       34 SUBK                             R7 R1 K4 [1]
       35 GETTABLE                         R5 R6 R7
       36 GETTABLEKS                       R7 R2 K5 ["AbsoluteSize"]
       38 GETTABLEKS                       R6 R7 K6 ["X"]
       40 MOVE                             R7 R5
       41 JUMPIFNOT                        R7 ; [+11]
       42 LOADB                            R7 0
...
PROTO_8:
       ...
       66 GETUPVAL                         R17 1
       67 GETTABLEKS                       R16 R17 K26 ["createElement"]
       ...
       91 GETUPVAL                         R19 1
       92 GETTABLEKS                       R18 R19 K30 ["Children"]
       94 GETTABLE                         R16 R17 R18
       95 CALL                             R14 2 1
       96 GETUPVAL                         R16 1
       97 GETTABLEKS                       R15 R16 K26 ["createElement"]
      ...
      113 GETUPVAL                         R20 1
      114 GETTABLEKS                       R19 R20 K33 ["Change"]
      116 GETTABLEKS                       R18 R19 K34 ["AbsoluteSize"]
      118 GETTABLEKS                       R19 R0 K35 ["updateCurrentCutOff"]
      120 SETTABLE                         R19 R17 R18
      121 GETUPVAL                         R19 1
      122 GETTABLEKS                       R18 R19 K36 ["Ref"]
