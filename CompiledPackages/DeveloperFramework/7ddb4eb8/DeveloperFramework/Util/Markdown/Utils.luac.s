...
MAIN:
       ...
       18 CALL                             R1 1 1
       19 DUPTABLE                         R2 K13 [{"BOLD", "BOLD_2", "ITALIC", "ITALIC_2", "STRIKE", "INLINE_CODE"}]
       20 DUPTABLE                         R3 K18 [{["char"] = "*", ["length"] = 1}]
       21 SETTABLEKS                       R3 R2 K7 ["BOLD"]
       23 DUPTABLE                         R3 K20 [{["char"] = "*", ["length"] = 2}]
       24 SETTABLEKS                       R3 R2 K8 ["BOLD_2"]
       26 DUPTABLE                         R3 K22 [{["char"] = "_", ["length"] = 1}]
       27 SETTABLEKS                       R3 R2 K9 ["ITALIC"]
       29 DUPTABLE                         R3 K23 [{["char"] = "_", ["length"] = 2}]
       30 SETTABLEKS                       R3 R2 K10 ["ITALIC_2"]
       32 DUPTABLE                         R3 K25 [{["char"] = "~", ["length"] = 1}]
       33 SETTABLEKS                       R3 R2 K11 ["STRIKE"]
       35 DUPTABLE                         R3 K27 [{["char"] = "`", ["length"] = 1}]
       36 SETTABLEKS                       R3 R2 K12 ["INLINE_CODE"]
       38 NEWTABLE                         R3 16 0
       40 DUPCLOSURE                       R4 K28 [PROTO_0]
       41 CAPTURE                          VAL R2
       42 SETTABLEKS                       R4 R3 K29 ["getDelimiterInfo"]
       44 DUPCLOSURE                       R4 K30 [PROTO_1]
       45 SETTABLEKS                       R4 R3 K31 ["causesLineBreak"]
       47 DUPCLOSURE                       R4 K32 [PROTO_2]
       48 SETTABLEKS                       R4 R3 K33 ["getTokenNameFromCharAndLength"]
       50 DUPCLOSURE                       R4 K34 [PROTO_3]
       51 SETTABLEKS                       R4 R3 K35 ["canDelimitersMatch"]
       53 DUPCLOSURE                       R4 K36 [PROTO_4]
       54 SETTABLEKS                       R4 R3 K37 ["addDelimiterMatch"]
       56 DUPCLOSURE                       R4 K38 [PROTO_5]
       57 CAPTURE                          VAL R0
       58 SETTABLEKS                       R4 R3 K39 ["isWhitespace"]
       60 DUPCLOSURE                       R4 K40 [PROTO_6]
       61 CAPTURE                          VAL R0
       62 SETTABLEKS                       R4 R3 K41 ["isPunctuation"]
       64 DUPCLOSURE                       R4 K42 [PROTO_7]
       65 CAPTURE                          VAL R3
       66 SETTABLEKS                       R4 R3 K43 ["isLeftFlanking"]
       68 DUPCLOSURE                       R4 K44 [PROTO_8]
       69 CAPTURE                          VAL R3
       70 SETTABLEKS                       R4 R3 K45 ["isRightFlanking"]
       72 DUPCLOSURE                       R4 K46 [PROTO_9]
       73 CAPTURE                          VAL R3
       74 SETTABLEKS                       R4 R3 K47 ["canOpenEmphasis"]
       76 DUPCLOSURE                       R4 K48 [PROTO_10]
       77 CAPTURE                          VAL R3
       78 SETTABLEKS                       R4 R3 K49 ["canCloseEmphasis"]
       80 DUPCLOSURE                       R4 K50 [PROTO_11]
       81 SETTABLEKS                       R4 R3 K51 ["getCharacterContext"]
       83 DUPCLOSURE                       R4 K52 [PROTO_12]
       84 SETTABLEKS                       R4 R3 K53 ["isInsideInlineCode"]
       86 RETURN                           R3 1
