...
PROTO_6:
       ...
       43 CALL                             R7 2 0
       44 LOADK                            R9 K5 ["PluginGui"]
       45 NAMECALL                         R7 R6 K6 ["IsA"]
       47 CALL                             R7 2 1
       48 JUMPIFNOT                        R7 ; [+25]
       49 GETUPVAL                         R7 0
       50 JUMPIFEQKNIL                     R7 ; [+23]
       52 GETTABLEKS                       R7 R2 K11 ["Size"]
       54 GETTABLEKS                       R8 R1 K11 ["Size"]
       56 JUMPIFEQ                         R7 R8 ; [+17]
       58 GETUPVAL                         R7 0
       59 MOVE                             R9 R6
       60 NAMECALL                         R7 R7 K12 ["GetWidgetFromPluginGui"]
       62 CALL                             R7 2 1
       63 GETTABLEKS                       R9 R2 K11 ["Size"]
       65 GETTABLEKS                       R9 R9 K13 ["X"]
       67 GETTABLEKS                       R10 R2 K11 ["Size"]
       69 GETTABLEKS                       R10 R10 K14 ["Y"]
       71 NAMECALL                         R7 R7 K15 ["SetFixedSize"]
       73 CALL                             R7 3 0
       74 RETURN                           R0 0
...
PROTO_10:
       ...
       29 GETTABLEKS                       R8 R0 K9 ["props"]
       31 GETTABLEKS                       R8 R8 K10 ["PluginDesign"]
       33 JUMPIFNOT                        R8 ; [+37]
       34 DUPTABLE                         R7 K13 [{"Wrapper", "StyleLink"}]
       35 GETUPVAL                         R8 1
       36 GETTABLEKS                       R8 R8 K5 ["createElement"]
       38 LOADK                            R9 K14 ["Frame"]
       39 DUPTABLE                         R10 K18 [{["Size"], ["BackgroundTransparency"] = 1}]
       40 GETIMPORT                        R11 K21 [UDim2.fromScale]
       42 LOADN                            R12 1
       43 LOADN                            R13 1
       44 CALL                             R11 2 1
       45 SETTABLEKS                       R11 R10 K15 ["Size"]
       47 GETTABLEKS                       R12 R0 K9 ["props"]
       49 GETUPVAL                         R13 1
       50 GETTABLEKS                       R13 R13 K22 ["Children"]
       52 GETTABLE                         R11 R12 R13
       53 CALL                             R8 3 1
       54 SETTABLEKS                       R8 R7 K11 ["Wrapper"]
       56 GETUPVAL                         R8 1
       57 GETTABLEKS                       R8 R8 K5 ["createElement"]
       59 LOADK                            R9 K12 ["StyleLink"]
       60 DUPTABLE                         R10 K24 [{"StyleSheet"}]
       61 GETTABLEKS                       R11 R0 K9 ["props"]
       63 GETTABLEKS                       R11 R11 K10 ["PluginDesign"]
       65 SETTABLEKS                       R11 R10 K23 ["StyleSheet"]
       67 CALL                             R8 2 1
       68 SETTABLEKS                       R8 R7 K12 ["StyleLink"]
       70 JUMP                             ; [+6]
       71 GETTABLEKS                       R8 R0 K9 ["props"]
       73 GETUPVAL                         R9 1
       74 GETTABLEKS                       R9 R9 K22 ["Children"]
       76 GETTABLE                         R7 R8 R9
       77 CALL                             R4 3 1
       78 SETTABLEKS                       R4 R3 K3 ["Child"]
       80 CALL                             R1 2 -1
       81 RETURN                           R1 -1
...
PROTO_12:
       ...
       16 NEWCLOSURE                       R3 P2
       17 CAPTURE                          UPVAL U2
       18 SETTABLEKS                       R3 R2 K5 ["updateWidget"]
       20 DUPCLOSURE                       R3 K6 [PROTO_8]
       21 SETTABLEKS                       R3 R2 K7 ["didMount"]
       23 DUPCLOSURE                       R3 K8 [PROTO_9]
       24 SETTABLEKS                       R3 R2 K9 ["didUpdate"]
       26 DUPCLOSURE                       R3 K10 [PROTO_10]
       27 CAPTURE                          UPVAL U3
       28 CAPTURE                          UPVAL U0
       29 SETTABLEKS                       R3 R2 K11 ["render"]
       31 DUPCLOSURE                       R3 K12 [PROTO_11]
       32 SETTABLEKS                       R3 R2 K13 ["willUnmount"]
       34 GETUPVAL                         R3 4
       35 DUPTABLE                         R4 K15 [{"Plugin"}]
       36 GETUPVAL                         R5 3
       37 GETTABLEKS                       R5 R5 K14 ["Plugin"]
       39 SETTABLEKS                       R5 R4 K14 ["Plugin"]
       41 CALL                             R3 1 1
       42 MOVE                             R4 R2
       43 CALL                             R3 1 1
       44 MOVE                             R2 R3
