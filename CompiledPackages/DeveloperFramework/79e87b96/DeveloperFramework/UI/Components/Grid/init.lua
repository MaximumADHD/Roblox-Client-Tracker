...
local FFlagDevFrameworkGridDefaultMinMaxIndex = game:DefineFastFlag("DevFrameworkGridDefaultMinMaxIndex", false)
...
function Grid:_getRange(): (number, number, { _CellGroup }?)
	...
	if FFlagDevFrameworkGridDefaultMinMaxIndex then
		minIndex, maxIndex, groups = 1, 1, nil
	end
