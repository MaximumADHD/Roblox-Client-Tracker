--[[
	...
	Example
	https://apis.roblox.com/content-aliases-api/v1/universes/get-aliases?universeId=1552514118&page=1 
...
return function(networkingImpl, baseUrl)
	...
	return function(universeId, pageNumber)
		...
		assert(type(pageNumber) == "number", string.format("universeId must be number, received %s", type(pageNumber)))
		local url = baseUrl.composeUrl(baseUrl.APIS_URL, "content-aliases-api/v1/universes/get-aliases", {
