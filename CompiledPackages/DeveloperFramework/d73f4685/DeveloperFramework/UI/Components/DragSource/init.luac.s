PROTO_0:
        0 GETUPVAL                         R3 0
        1 GETTABLEKS                       R3 R3 K0 ["_dragging"]
        3 JUMPIF                           R3 ; [+14]
        4 GETUPVAL                         R3 0
        5 GETTABLEKS                       R3 R3 K1 ["props"]
        7 GETTABLEKS                       R3 R3 K2 ["OnClick"]
        9 JUMPIFNOT                        R3 ; [+8]
       10 GETUPVAL                         R3 0
       11 GETTABLEKS                       R3 R3 K1 ["props"]
       13 GETTABLEKS                       R3 R3 K2 ["OnClick"]
       15 MOVE                             R4 R1
       16 MOVE                             R5 R2
       17 CALL                             R3 2 0
       18 RETURN                           R0 0
...
PROTO_2:
        ...
        3 JUMPIF                           R3 ; [+4]
        4 GETUPVAL                         R3 0
        5 GETTABLEKS                       R3 R3 K1 ["_mouseDownPosition"]
        7 JUMPIF                           R3 ; [+1]
        8 RETURN                           R0 0
       ...
       13 CALL                             R3 2 1
       14 GETUPVAL                         R5 0
       15 GETTABLEKS                       R5 R5 K1 ["_mouseDownPosition"]
       17 SUB                              R4 R3 R5
       18 GETTABLEKS                       R4 R4 K5 ["Magnitude"]
       20 LOADN                            R5 4
       ...
       31 GETUPVAL                         R4 0
       32 GETTABLEKS                       R4 R4 K6 ["props"]
       34 GETTABLEKS                       R4 R4 K7 ["OnDragBegan"]
       36 JUMPIFNOT                        R4 ; [+6]
       37 GETUPVAL                         R4 0
       38 GETTABLEKS                       R4 R4 K6 ["props"]
       40 GETTABLEKS                       R4 R4 K7 ["OnDragBegan"]
       42 CALL                             R4 0 0
       43 RETURN                           R0 0
...
PROTO_4:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["_dragging"]
        3 JUMPIF                           R0 ; [+12]
        4 GETUPVAL                         R0 0
        5 GETTABLEKS                       R0 R0 K1 ["props"]
        7 GETTABLEKS                       R0 R0 K2 ["OnRightClick"]
        9 JUMPIFNOT                        R0 ; [+6]
       10 GETUPVAL                         R0 0
       11 GETTABLEKS                       R0 R0 K1 ["props"]
       13 GETTABLEKS                       R0 R0 K2 ["OnRightClick"]
       15 CALL                             R0 0 0
       16 RETURN                           R0 0
...
PROTO_6:
       ...
       27 GETUPVAL                         R5 0
       28 GETTABLEKS                       R5 R5 K8 ["Event"]
       30 GETTABLEKS                       R5 R5 K9 ["Activated"]
       ...
       40 GETUPVAL                         R5 0
       41 GETTABLEKS                       R5 R5 K8 ["Event"]
       43 GETTABLEKS                       R5 R5 K12 ["MouseButton1Down"]
       45 GETTABLEKS                       R6 R0 K13 ["mouseButton1Down"]
       47 SETTABLE                         R6 R4 R5
       48 GETUPVAL                         R5 0
       49 GETTABLEKS                       R5 R5 K8 ["Event"]
       51 GETTABLEKS                       R5 R5 K14 ["MouseButton1Up"]
       53 GETTABLEKS                       R6 R0 K15 ["mouseButton1Up"]
       55 SETTABLE                         R6 R4 R5
       56 GETUPVAL                         R5 0
       57 GETTABLEKS                       R5 R5 K8 ["Event"]
       59 GETTABLEKS                       R5 R5 K16 ["MouseButton2Click"]
       ...
       69 GETUPVAL                         R5 0
       70 GETTABLEKS                       R5 R5 K8 ["Event"]
       72 GETTABLEKS                       R5 R5 K19 ["MouseMoved"]
       74 GETTABLEKS                       R6 R0 K20 ["mouseMoved"]
       76 SETTABLE                         R6 R4 R5
       77 GETUPVAL                         R6 0
       78 GETTABLEKS                       R6 R6 K21 ["Children"]
