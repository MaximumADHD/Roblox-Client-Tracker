...
PROTO_6:
        0 DUPTABLE                         R1 K10 [{[1], ["_type"] = "Promise", ["_status"], ["_value"] = , ["_queuedResolve"], ["_queuedReject"], ["_unhandledRejection"] = False}]
        1 GETIMPORT                        R2 K13 [debug.traceback]
        3 CALL                             R2 0 1
        4 SETTABLEKS                       R2 R1 K0 ["_source"]
        6 GETUPVAL                         R2 0
        7 GETTABLEKS                       R2 R2 K14 ["Status"]
        9 GETTABLEKS                       R2 R2 K15 ["Started"]
       ...
       24 MOVE                             R3 R1
       25 GETIMPORT                        R2 K17 [setmetatable]
       27 CALL                             R2 2 0
       28 NEWCLOSURE                       R2 P0
       29 CAPTURE                          VAL R1
       30 NEWCLOSURE                       R3 P1
       ...
       40 GETUPVAL                         R7 0
       41 GETTABLEKS                       R7 R7 K14 ["Status"]
       43 GETTABLEKS                       R7 R7 K15 ["Started"]
...
MAIN:
       ...
       14 LOADNIL                          R4
       15 SETTABLEKS                       R4 R3 K9 ["onUnhandledRejection"]
       17 NEWCLOSURE                       R4 P2
       18 CAPTURE                          VAL R3
       19 CAPTURE                          REF R0
       20 SETTABLEKS                       R4 R3 K10 ["new"]
       22 DUPCLOSURE                       R4 K11 [PROTO_8]
       23 CAPTURE                          VAL R3
       24 SETTABLEKS                       R4 R3 K12 ["resolve"]
       26 DUPCLOSURE                       R4 K13 [PROTO_10]
       27 CAPTURE                          VAL R3
       28 SETTABLEKS                       R4 R3 K14 ["reject"]
       30 DUPCLOSURE                       R4 K15 [PROTO_15]
       31 CAPTURE                          VAL R3
       32 SETTABLEKS                       R4 R3 K16 ["all"]
       34 DUPCLOSURE                       R4 K17 [PROTO_16]
       35 SETTABLEKS                       R4 R3 K18 ["is"]
       37 NEWCLOSURE                       R4 P7
       38 CAPTURE                          VAL R3
       39 CAPTURE                          REF R0
       40 SETTABLEKS                       R4 R3 K19 ["andThen"]
       42 DUPCLOSURE                       R4 K20 [PROTO_19]
       43 SETTABLEKS                       R4 R3 K21 ["catch"]
       45 DUPCLOSURE                       R4 K22 [PROTO_22]
       46 CAPTURE                          VAL R3
       47 SETTABLEKS                       R4 R3 K23 ["await"]
       49 DUPCLOSURE                       R4 K24 [PROTO_25]
       50 CAPTURE                          VAL R3
       51 SETTABLEKS                       R4 R3 K25 ["_resolve"]
       53 DUPCLOSURE                       R4 K26 [PROTO_28]
       54 CAPTURE                          VAL R3
       55 SETTABLEKS                       R4 R3 K27 ["_reject"]
       57 CLOSEUPVALS                      R0
       58 RETURN                           R3 1
