--[[
	...
	We try to organize RobloxAPI as follows:
	- HostName (apis, api, develop, etc.)
		- if BEDEV2, Service (toolboxService, etc.)
			- Version (V1, V2, etc.)
				- Endpoint (plugins, assets, etc.)
					- There can be multiple levels of endpoints after this
	Please adhere to this organizational structure when adding new endpoints!
...
function RobloxAPI.new(props)
	...
	local robloxApi = {
		...
		GameInternationalization = initDirectoryWithArgs(script.GameInternationalization, networkingImpl, baseUrl),
		Inventory = initDirectoryWithArgs(script.Inventory, networkingImpl, baseUrl),
