...
PROTO_9:
        ...
        2 JUMPIFNOT                        R1 ; [+3]
        3 LOADB                            R1 0
        4 SETTABLEKS                       R1 R0 K0 ["firstUpdateDone"]
        6 RETURN                           R0 0
...
PROTO_10:
       ...
       24 GETTABLEKS                       R3 R0 K3 ["firstUpdateDone"]
       26 JUMPIFNOT                        R3 ; [+1]
       27 RETURN                           R0 0
       28 GETTABLEKS                       R4 R0 K2 ["ref"]
       30 GETTABLEKS                       R3 R4 K4 ["current"]
       32 JUMPIFNOT                        R3 ; [+34]
       33 GETTABLEKS                       R4 R2 K5 ["InitialCanvasPosition"]
       35 JUMPIFNOT                        R4 ; [+31]
       36 GETTABLEKS                       R4 R2 K5 ["InitialCanvasPosition"]
       38 SETTABLEKS                       R4 R3 K6 ["CanvasPosition"]
       40 GETTABLEKS                       R4 R2 K7 ["OnScrollUpdate"]
       42 JUMPIFNOT                        R4 ; [+21]
       43 GETIMPORT                        R4 K10 [Vector2.new]
       45 GETTABLEKS                       R7 R3 K11 ["CanvasSize"]
       47 GETTABLEKS                       R6 R7 K12 ["X"]
       49 GETTABLEKS                       R5 R6 K13 ["Offset"]
       51 GETTABLEKS                       R8 R3 K11 ["CanvasSize"]
       53 GETTABLEKS                       R7 R8 K14 ["Y"]
       55 GETTABLEKS                       R6 R7 K13 ["Offset"]
       57 CALL                             R4 2 1
       58 GETTABLEKS                       R5 R2 K7 ["OnScrollUpdate"]
       60 GETTABLEKS                       R6 R3 K6 ["CanvasPosition"]
       62 MOVE                             R7 R4
       63 CALL                             R5 2 0
       64 LOADB                            R4 1
       65 SETTABLEKS                       R4 R0 K3 ["firstUpdateDone"]
       67 GETTABLEKS                       R2 R0 K0 ["props"]
       69 GETTABLEKS                       R3 R1 K7 ["OnScrollUpdate"]
       71 GETTABLEKS                       R4 R2 K7 ["OnScrollUpdate"]
       73 JUMPIFNOTEQ                      R3 R4 ; [+21]
       75 GETTABLEKS                       R3 R1 K15 ["OnLoadRange"]
       77 GETTABLEKS                       R4 R2 K15 ["OnLoadRange"]
       79 JUMPIFEQ                         R3 R4 ; [+3]
       81 GETUPVAL                         R3 1
       82 JUMPIF                           R3 ; [+12]
       83 GETTABLEKS                       R3 R1 K16 ["SpecialCells"]
       85 GETTABLEKS                       R4 R2 K16 ["SpecialCells"]
       87 JUMPIFNOTEQ                      R3 R4 ; [+7]
       89 GETTABLEKS                       R3 R1 K17 ["CellGroups"]
       91 GETTABLEKS                       R4 R2 K17 ["CellGroups"]
       93 JUMPIFEQ                         R3 R4 ; [+4]
       95 NAMECALL                         R3 R0 K18 ["_update"]
       97 CALL                             R3 1 0
       98 RETURN                           R0 0
...
PROTO_12:
       ...
       42 CALL                             R7 0 1
       43 JUMPIFNOT                        R7 ; [+15]
       44 GETTABLEKS                       R7 R6 K12 ["X"]
       46 JUMPIFNOTEQKN                    R7 K2 [0] ; [+5]
       48 GETTABLEKS                       R7 R6 K14 ["Y"]
       50 JUMPIFEQKN                       R7 K2 [0] ; [+14]
       52 GETTABLEKS                       R7 R1 K7 ["OnScrollUpdate"]
       54 GETTABLEKS                       R8 R0 K6 ["canvasPosition"]
       56 MOVE                             R9 R6
       57 CALL                             R7 2 0
       58 JUMP                             ; [+6]
       59 GETTABLEKS                       R7 R1 K7 ["OnScrollUpdate"]
       61 GETTABLEKS                       R8 R0 K6 ["canvasPosition"]
       63 MOVE                             R9 R6
       64 CALL                             R7 2 0
       65 GETTABLEKS                       R6 R0 K15 ["minIndex"]
       67 JUMPIFNOTEQ                      R6 R2 ; [+6]
       69 GETTABLEKS                       R6 R0 K16 ["maxIndex"]
       71 JUMPIFNOTEQ                      R6 R3 ; [+2]
       73 RETURN                           R0 0
       74 GETUPVAL                         R6 1
       75 JUMPIFNOT                        R6 ; [+13]
       76 GETTABLEKS                       R6 R1 K17 ["OnLoadRange"]
       78 JUMPIFNOT                        R6 ; [+10]
       79 GETTABLEKS                       R7 R1 K18 ["Cells"]
       81 LENGTH                           R6 R7
       82 JUMPIFNOTLE                      R6 R3 ; [+6]
       84 GETTABLEKS                       R6 R1 K17 ["OnLoadRange"]
       86 MOVE                             R7 R2
       87 MOVE                             R8 R3
       88 CALL                             R6 2 0
       89 SETTABLEKS                       R2 R0 K15 ["minIndex"]
       91 SETTABLEKS                       R3 R0 K16 ["maxIndex"]
       93 SETTABLEKS                       R4 R0 K19 ["cellGroups"]
       95 GETUPVAL                         R6 2
       96 CALL                             R6 0 1
       97 JUMPIFNOT                        R6 ; [+6]
       98 GETIMPORT                        R6 K22 [task.defer]
      100 NEWCLOSURE                       R7 P0
      101 CAPTURE                          VAL R0
      102 CALL                             R6 1 0
      103 RETURN                           R0 0
      104 NAMECALL                         R6 R0 K23 ["_incrementRender"]
      106 CALL                             R6 1 0
      107 RETURN                           R0 0
...
MAIN:
       ...
       85 GETTABLEKS                       R20 R0 K26 ["SharedFlags"]
       87 CALL                             R19 1 1
       88 GETTABLEKS                       R18 R19 K27 ["getFFlagDevFrameworkMaterialPickerImprovedScroll"]
       90 GETIMPORT                        R19 K29 [game]
       92 LOADK                            R21 K30 ["DevFrameworkGridOnLoadRange"]
       93 LOADB                            R22 0
       94 NAMECALL                         R19 R19 K31 ["DefineFastFlag"]
       96 CALL                             R19 3 1
       97 GETIMPORT                        R20 K6 [require]
       99 GETTABLEKS                       R22 R0 K26 ["SharedFlags"]
      101 GETTABLEKS                       R21 R22 K32 ["getFFlagDevFrameworkFixMissingKeyErrors"]
      103 CALL                             R20 1 1
      104 CALL                             R20 0 1
      105 GETIMPORT                        R21 K6 [require]
      107 GETTABLEKS                       R23 R0 K26 ["SharedFlags"]
      ...
      176 CAPTURE                          VAL R18
      177 SETTABLEKS                       R26 R25 K69 ["didMount"]
      179 DUPCLOSURE                       R26 K70 [PROTO_10]
      180 CAPTURE                          VAL R18
      181 CAPTURE                          VAL R19
      182 SETTABLEKS                       R26 R25 K71 ["didUpdate"]
      184 DUPCLOSURE                       R26 K72 [PROTO_12]
      185 CAPTURE                          VAL R18
      186 CAPTURE                          VAL R19
      187 CAPTURE                          VAL R21
      188 SETTABLEKS                       R26 R25 K73 ["_update"]
      190 DUPCLOSURE                       R26 K74 [PROTO_14]
      191 SETTABLEKS                       R26 R25 K75 ["_incrementRender"]
      193 DUPCLOSURE                       R26 K76 [PROTO_15]
      194 SETTABLEKS                       R26 R25 K77 ["_getRange"]
      196 DUPCLOSURE                       R26 K78 [PROTO_17]
      197 CAPTURE                          VAL R8
      198 CAPTURE                          VAL R6
      199 SETTABLEKS                       R26 R25 K79 ["_getGroups"]
      201 DUPCLOSURE                       R26 K80 [PROTO_18]
      202 CAPTURE                          VAL R9
      203 SETTABLEKS                       R26 R25 K81 ["_calculateCellPosition"]
      205 DUPCLOSURE                       R26 K82 [PROTO_19]
      206 CAPTURE                          VAL R17
      207 SETTABLEKS                       R26 R25 K83 ["getDefaultCellProps"]
      209 DUPCLOSURE                       R26 K84 [PROTO_22]
      210 CAPTURE                          VAL R12
      211 CAPTURE                          VAL R9
      212 CAPTURE                          VAL R20
      213 CAPTURE                          VAL R14
      ...
      219 CAPTURE                          VAL R11
      220 CAPTURE                          VAL R6
      221 SETTABLEKS                       R26 R25 K85 ["render"]
      223 DUPCLOSURE                       R26 K86 [PROTO_25]
      224 CAPTURE                          VAL R5
      225 CAPTURE                          VAL R6
      226 CAPTURE                          VAL R14
      227 SETTABLEKS                       R26 R25 K87 ["renderGroupHeaders"]
      229 MOVE                             R26 R2
      230 DUPTABLE                         R27 K88 [{"Stylizer"}]
      231 GETTABLEKS                       R28 R1 K45 ["Stylizer"]
      233 SETTABLEKS                       R28 R27 K45 ["Stylizer"]
      235 CALL                             R26 1 1
      236 MOVE                             R27 R25
      237 CALL                             R26 1 1
      238 MOVE                             R25 R26
