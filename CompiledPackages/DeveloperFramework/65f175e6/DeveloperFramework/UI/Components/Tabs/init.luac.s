PROTO_0:
        ...
        2 GETTABLEKS                       R1 R1 K1 ["TabsListRef"]
        4 JUMPIFEQKNIL                     R1 ; [+24]
        6 GETTABLEKS                       R1 R0 K0 ["props"]
        8 GETTABLEKS                       R1 R1 K2 ["Tabs"]
       10 LOADNIL                          R2
       11 LOADNIL                          R3
       12 FORGPREP                         R1
       13 GETTABLEKS                       R6 R0 K0 ["props"]
       15 GETTABLEKS                       R6 R6 K1 ["TabsListRef"]
       17 GETTABLEKS                       R6 R6 K3 ["current"]
       19 GETTABLEKS                       R8 R5 K4 ["Key"]
       21 OR                               R7 R8 R4
       22 GETUPVAL                         R8 0
       23 GETTABLEKS                       R8 R8 K5 ["createRef"]
       25 CALL                             R8 0 1
...
PROTO_1:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R2 R2 K0 ["SelectedTab"]
        3 JUMPIFEQ                         R0 R2 ; [+2]
        5 LOADB                            R1 0 +1
        6 LOADB                            R1 1
        7 RETURN                           R1 1
...
PROTO_2:
        ...
        2 GETUPVAL                         R3 0
        3 GETTABLEKS                       R3 R3 K1 ["SelectedTab"]
        5 JUMPIFEQ                         R2 R3 ; [+2]
        7 LOADB                            R1 0 +1
        8 LOADB                            R1 1
        9 RETURN                           R1 1
...
PROTO_3:
       ...
       37 GETUPVAL                         R5 5
       38 GETTABLEKS                       R5 R5 K9 ["OnTabSelected"]
       40 SETTABLEKS                       R5 R4 K9 ["OnTabSelected"]
       42 GETUPVAL                         R5 0
       43 GETTABLEKS                       R5 R5 K10 ["Ref"]
       45 GETUPVAL                         R7 5
       46 GETTABLEKS                       R7 R7 K11 ["TabsListRef"]
       48 JUMPIFEQKNIL                     R7 ; [+11]
       50 GETUPVAL                         R7 5
       51 GETTABLEKS                       R7 R7 K11 ["TabsListRef"]
       53 GETTABLEKS                       R7 R7 K12 ["current"]
...
PROTO_4:
       ...
       58 GETUPVAL                         R6 3
       59 GETTABLEKS                       R6 R6 K12 ["createElement"]
       61 GETUPVAL                         R7 6
       62 GETUPVAL                         R9 7
       63 JUMPIFNOT                        R9 ; [+40]
       64 NEWTABLE                         R8 4 0
       ...
       70 GETUPVAL                         R9 8
       71 GETTABLEKS                       R9 R9 K14 ["Tag"]
       73 GETUPVAL                         R10 9
       74 LOADK                            R11 K15 ["Component-Tabs"]
       75 GETUPVAL                         R14 8
       76 GETTABLEKS                       R14 R14 K14 ["Tag"]
       ...
       89 GETUPVAL                         R9 3
       90 GETTABLEKS                       R9 R9 K21 ["Ref"]
       92 GETTABLEKS                       R10 R1 K22 ["ForwardRef"]
       94 SETTABLE                         R10 R8 R9
       95 GETUPVAL                         R9 8
       96 GETTABLEKS                       R9 R9 K23 ["Change"]
       98 GETTABLEKS                       R9 R9 K24 ["AbsoluteSize"]
      ...
      124 GETUPVAL                         R9 3
      125 GETTABLEKS                       R9 R9 K21 ["Ref"]
      127 GETTABLEKS                       R10 R1 K22 ["ForwardRef"]
      129 SETTABLE                         R10 R8 R9
      130 GETUPVAL                         R9 3
      131 GETTABLEKS                       R9 R9 K23 ["Change"]
      133 GETTABLEKS                       R9 R9 K24 ["AbsoluteSize"]
...
MAIN:
       ...
       55 GETTABLEKS                       R8 R0 K4 ["Parent"]
       57 GETTABLEKS                       R8 R8 K15 ["React"]
       59 CALL                             R7 1 1
       60 JUMP                             ; [+1]
       61 LOADNIL                          R7
       62 GETIMPORT                        R8 K6 [require]
       64 GETTABLEKS                       R9 R0 K17 ["Styling"]
       66 GETTABLEKS                       R9 R9 K18 ["supportsStyleSheets"]
       68 CALL                             R8 1 1
       69 GETIMPORT                        R9 K6 [require]
       71 GETTABLEKS                       R10 R0 K17 ["Styling"]
       73 GETTABLEKS                       R10 R10 K19 ["joinTags"]
       75 CALL                             R9 1 1
       76 GETIMPORT                        R10 K6 [require]
       78 GETTABLEKS                       R11 R0 K4 ["Parent"]
       80 GETTABLEKS                       R11 R11 K20 ["Dash"]
       82 CALL                             R10 1 1
       83 GETTABLEKS                       R11 R10 K21 ["map"]
       85 GETTABLEKS                       R12 R10 K22 ["findIndex"]
       87 GETIMPORT                        R13 K6 [require]
       89 GETTABLEKS                       R14 R0 K2 ["UI"]
       91 GETTABLEKS                       R14 R14 K23 ["Components"]
       93 GETTABLEKS                       R14 R14 K24 ["Pane"]
       95 CALL                             R13 1 1
       96 GETIMPORT                        R14 K6 [require]
       98 GETTABLEKS                       R15 R0 K2 ["UI"]
      100 GETTABLEKS                       R15 R15 K23 ["Components"]
      102 GETTABLEKS                       R15 R15 K25 ["SimpleTab"]
      104 CALL                             R14 1 1
      ...
      119 GETTABLEKS                       R17 R0 K30 ["SharedFlags"]
      121 GETTABLEKS                       R17 R17 K31 ["getFFlagDevFrameworkFixMissingKeyErrors"]
      123 CALL                             R16 1 1
      124 CALL                             R16 0 1
      125 GETIMPORT                        R17 K6 [require]
      127 GETTABLEKS                       R18 R0 K11 ["Util"]
      129 GETTABLEKS                       R18 R18 K32 ["isRoact17"]
      131 CALL                             R17 1 1
      132 MOVE                             R18 R4
      133 CALL                             R17 1 1
