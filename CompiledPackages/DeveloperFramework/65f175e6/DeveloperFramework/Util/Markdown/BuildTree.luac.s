...
PROTO_5:
        ...
        2 JUMPIFNOTEQKS                    R1 K1 ["TAG"] ; [+27]
        4 GETTABLEKS                       R3 R0 K2 ["text"]
        6 GETUPVAL                         R4 0
        7 JUMPIFEQ                         R3 R4 ; [+2]
        9 LOADB                            R2 0 +1
       10 LOADB                            R2 1
       11 LOADK                            R3 K3 ["Found <%*> at %* when trying to close </%*> at %*"]
       12 GETTABLEKS                       R5 R0 K2 ["text"]
       14 GETTABLEKS                       R6 R0 K4 ["offset"]
       16 GETUPVAL                         R7 0
       17 GETUPVAL                         R8 1
       18 GETTABLEKS                       R8 R8 K4 ["offset"]
       20 NAMECALL                         R3 R3 K5 ["format"]
       22 CALL                             R3 5 1
       23 FASTCALL2                        ASSERT R2 R3 ; [+3]
       25 GETIMPORT                        R1 K7 [assert]
       27 CALL                             R1 2 0
       28 LOADB                            R1 1
       29 RETURN                           R1 1
       30 LOADB                            R1 0
...
PROTO_9:
      ...
      457 JUMPIFNOTEQKS                    R6 K56 ["CLOSE"] ; [+29]
      ...
      471 CAPTURE                          VAL R4
      472 CALL                             R7 2 1
      473 LOADK                            R10 K57 ["No open tag exists trying to close </%*> at %*"]
      474 MOVE                             R12 R6
      475 GETTABLEKS                       R13 R4 K3 ["offset"]
      477 NAMECALL                         R10 R10 K58 ["format"]
      479 CALL                             R10 3 1
      480 FASTCALL2                        ASSERT R7 R10 ; [+4]
      482 MOVE                             R9 R7
      483 GETIMPORT                        R8 K60 [assert]
      485 CALL                             R8 2 0
      486 JUMP                             ; [+166]
      487 GETTABLEKS                       R6 R5 K0 ["name"]
      489 JUMPIFNOTEQKS                    R6 K36 ["HEADING"] ; [+140]
      491 GETIMPORT                        R6 K62 [string.find]
      493 GETTABLEKS                       R7 R4 K13 ["text"]
      495 LOADK                            R8 K63 ["\n"]
      496 LOADN                            R9 1
      497 LOADB                            R10 1
      498 CALL                             R6 4 1
      499 JUMPIF                           R6 ; [+25]
      500 GETTABLEKS                       R8 R5 K2 ["children"]
      502 DUPTABLE                         R9 K64 [{"name", "text", "children", "offset"}]
      503 GETTABLEKS                       R10 R4 K0 ["name"]
      505 SETTABLEKS                       R10 R9 K0 ["name"]
      507 GETTABLEKS                       R10 R4 K13 ["text"]
      509 SETTABLEKS                       R10 R9 K13 ["text"]
      511 NEWTABLE                         R10 0 0
      513 SETTABLEKS                       R10 R9 K2 ["children"]
      515 GETTABLEKS                       R10 R4 K3 ["offset"]
      517 SETTABLEKS                       R10 R9 K3 ["offset"]
      519 FASTCALL2                        TABLE_INSERT R8 R9 ; [+2]
      521 GETUPVAL                         R7 0
      522 CALL                             R7 2 0
      523 ADDK                             R3 R3 K4 [1]
      524 JUMP                             ; [+129]
      525 GETTABLEKS                       R8 R4 K13 ["text"]
      527 LOADN                            R9 1
      528 SUBK                             R10 R6 K4 [1]
      529 FASTCALL                         STRING_SUB ; [+2]
      530 GETIMPORT                        R7 K66 [string.sub]
      532 CALL                             R7 3 1
      533 GETTABLEKS                       R9 R4 K13 ["text"]
      535 ADDK                             R10 R6 K4 [1]
      536 FASTCALL2                        STRING_SUB R9 R10 ; [+3]
      538 GETIMPORT                        R8 K66 [string.sub]
      540 CALL                             R8 2 1
      541 GETIMPORT                        R9 K62 [string.find]
      543 MOVE                             R10 R8
      544 LOADK                            R11 K67 ["%S"]
      545 CALL                             R9 2 1
      546 JUMPIFNOTEQKNIL                  R9 ; [+26]
      548 GETTABLEKS                       R10 R5 K2 ["children"]
      550 DUPTABLE                         R11 K64 [{"name", "text", "children", "offset"}]
      551 GETTABLEKS                       R12 R4 K0 ["name"]
      553 SETTABLEKS                       R12 R11 K0 ["name"]
      555 GETTABLEKS                       R12 R4 K13 ["text"]
      557 SETTABLEKS                       R12 R11 K13 ["text"]
      559 NEWTABLE                         R12 0 0
      561 SETTABLEKS                       R12 R11 K2 ["children"]
      563 GETTABLEKS                       R12 R4 K3 ["offset"]
      565 SETTABLEKS                       R12 R11 K3 ["offset"]
      567 FASTCALL2                        TABLE_INSERT R10 R11 ; [+2]
      569 GETUPVAL                         R9 0
      570 CALL                             R9 2 0
      571 ADDK                             R3 R3 K4 [1]
      572 JUMP                             ; [+81]
      573 GETTABLEKS                       R10 R5 K2 ["children"]
      575 DUPTABLE                         R11 K64 [{"name", "text", "children", "offset"}]
      576 GETTABLEKS                       R12 R4 K0 ["name"]
      578 SETTABLEKS                       R12 R11 K0 ["name"]
      580 SETTABLEKS                       R7 R11 K13 ["text"]
      582 NEWTABLE                         R12 0 0
      584 SETTABLEKS                       R12 R11 K2 ["children"]
      586 GETTABLEKS                       R12 R4 K3 ["offset"]
      588 SETTABLEKS                       R12 R11 K3 ["offset"]
      590 FASTCALL2                        TABLE_INSERT R10 R11 ; [+2]
      592 GETUPVAL                         R9 0
      593 CALL                             R9 2 0
      594 GETUPVAL                         R9 1
      595 GETTABLEKS                       R9 R9 K24 ["closeNode"]
      597 MOVE                             R10 R2
      598 DUPCLOSURE                       R11 K68 [PROTO_6]
      599 CALL                             R9 2 0
      600 DUPTABLE                         R11 K70 [{[1] = "PARAGRAPH", ["children"], ["offset"]}]
      601 NEWTABLE                         R12 0 1
      603 DUPTABLE                         R13 K27 [{[1] = "TEXT", ["text"], ["children"], ["offset"]}]
      604 SETTABLEKS                       R8 R13 K13 ["text"]
      606 NEWTABLE                         R14 0 0
      608 SETTABLEKS                       R14 R13 K2 ["children"]
      610 GETTABLEKS                       R16 R4 K3 ["offset"]
      612 ADD                              R15 R16 R6
      613 ADDK                             R14 R15 K4 [1]
      614 SETTABLEKS                       R14 R13 K3 ["offset"]
      616 SETLIST                          R12 R13 1 [1]
      618 SETTABLEKS                       R12 R11 K2 ["children"]
      620 GETTABLEKS                       R12 R4 K3 ["offset"]
      622 SETTABLEKS                       R12 R11 K3 ["offset"]
      624 FASTCALL2                        TABLE_INSERT R2 R11 ; [+3]
      626 MOVE                             R10 R2
      627 GETUPVAL                         R9 0
      628 CALL                             R9 2 0
      629 JUMP                             ; [+23]
      630 GETTABLEKS                       R7 R5 K2 ["children"]
      632 DUPTABLE                         R8 K64 [{"name", "text", "children", "offset"}]
      633 GETTABLEKS                       R9 R4 K0 ["name"]
      635 SETTABLEKS                       R9 R8 K0 ["name"]
      637 GETTABLEKS                       R9 R4 K13 ["text"]
      639 SETTABLEKS                       R9 R8 K13 ["text"]
      641 NEWTABLE                         R9 0 0
      643 SETTABLEKS                       R9 R8 K2 ["children"]
      645 GETTABLEKS                       R9 R4 K3 ["offset"]
      647 SETTABLEKS                       R9 R8 K3 ["offset"]
      649 FASTCALL2                        TABLE_INSERT R7 R8 ; [+2]
      651 GETUPVAL                         R6 0
      652 CALL                             R6 2 0
      653 ADDK                             R3 R3 K4 [1]
      654 JUMPBACK                         ; [-644]
      655 GETUPVAL                         R4 1
      656 GETTABLEKS                       R4 R4 K24 ["closeNode"]
      658 MOVE                             R5 R2
      659 DUPCLOSURE                       R6 K71 [PROTO_7]
      660 CALL                             R4 2 0
      661 GETUPVAL                         R4 1
      662 GETTABLEKS                       R4 R4 K24 ["closeNode"]
      664 MOVE                             R5 R2
      665 DUPCLOSURE                       R6 K72 [PROTO_8]
      666 CALL                             R4 2 0
      667 RETURN                           R1 1
...
MAIN:
       ...
       30 DUPCLOSURE                       R8 K14 [PROTO_9]
       31 CAPTURE                          VAL R5
       32 CAPTURE                          VAL R6
       33 CAPTURE                          VAL R3
       34 CAPTURE                          VAL R2
       35 CAPTURE                          VAL R4
       36 SETTABLEKS                       R8 R6 K15 ["buildTree"]
       38 DUPCLOSURE                       R8 K16 [PROTO_10]
       39 CAPTURE                          VAL R6
       40 CAPTURE                          VAL R5
       41 SETTABLEKS                       R8 R6 K17 ["closeNode"]
       43 DUPCLOSURE                       R8 K18 [PROTO_11]
       44 SETTABLEKS                       R8 R6 K19 ["findLastNodeIndex"]
       46 DUPCLOSURE                       R8 K20 [PROTO_12]
       47 SETTABLEKS                       R8 R6 K21 ["parseXmlAttributes"]
       49 GETTABLEKS                       R8 R6 K15 ["buildTree"]
       51 RETURN                           R8 1
