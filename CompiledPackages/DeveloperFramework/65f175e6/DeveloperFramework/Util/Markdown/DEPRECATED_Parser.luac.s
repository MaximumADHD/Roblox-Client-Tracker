...
PROTO_1:
        ...
        7 JUMPIFNOT                        R1 ; [+5]
        8 SETUPVAL                         R1 1
        9 DUPTABLE                         R2 K5 [{["flag"] = False, ["text"]}]
       10 SETTABLEKS                       R0 R2 K4 ["text"]
       12 RETURN                           R2 1
       13 GETUPVAL                         R2 1
       14 GETUPVAL                         R3 0
       15 NAMECALL                         R3 R3 K6 ["len"]
       17 CALL                             R3 1 1
       18 JUMPIFNOTLE                      R2 R3 ; [+21]
       20 GETUPVAL                         R2 0
       21 LOADK                            R5 K7 ["^(%"]
       22 GETUPVAL                         R8 0
       23 GETUPVAL                         R10 1
       24 GETUPVAL                         R11 1
       25 NAMECALL                         R8 R8 K8 ["sub"]
       27 CALL                             R8 3 1
       28 MOVE                             R6 R8
       29 LOADK                            R7 K9 ["+)()"]
       30 CONCAT                           R4 R5 R7
       31 GETUPVAL                         R5 1
       32 NAMECALL                         R2 R2 K1 ["match"]
       34 CALL                             R2 3 2
       35 SETUPVAL                         R3 1
       36 DUPTABLE                         R4 K11 [{["flag"] = True, ["text"]}]
       37 SETTABLEKS                       R2 R4 K4 ["text"]
       39 RETURN                           R4 1
       40 LOADNIL                          R2
       41 RETURN                           R2 1
...
PROTO_5:
       ...
       22 LOADK                            R10 K6 ["[%*]"]
       23 MOVE                             R12 R6
       24 NAMECALL                         R10 R10 K7 ["format"]
       26 CALL                             R10 2 1
       27 CONCAT                           R2 R8 R10
       28 DUPTABLE                         R10 K10 [{"Text", "Url"}]
       29 SETTABLEKS                       R6 R10 K8 ["Text"]
       31 SETTABLEKS                       R7 R10 K9 ["Url"]
       33 FASTCALL2                        TABLE_INSERT R1 R10 ; [+4]
       35 MOVE                             R9 R1
       36 GETIMPORT                        R8 K13 [table.insert]
       38 CALL                             R8 2 0
       39 ADDK                             R3 R5 K4 [1]
       40 JUMP                             ; [+7]
       41 MOVE                             R8 R2
       42 MOVE                             R11 R3
       43 NAMECALL                         R9 R0 K5 ["sub"]
       45 CALL                             R9 2 1
       46 CONCAT                           R2 R8 R9
       47 JUMP                             ; [+1]
       48 JUMPBACK                         ; [-45]
...
MAIN:
        0 PREPVARARGS                      0
        1 NEWTABLE                         R0 8 0
        3 DUPTABLE                         R1 K4 [{[1] = 0, ["Ref"] = 1}]
        4 DUPTABLE                         R2 K11 [{["Bold"] = 0, ["Italic"] = 1, ["Strike"] = 2, ["Code"] = 3}]
        5 DUPCLOSURE                       R3 K12 [PROTO_0]
        6 DUPCLOSURE                       R4 K13 [PROTO_2]
        7 NEWTABLE                         R5 4 0
        9 GETTABLEKS                       R6 R2 K5 ["Bold"]
       11 SETTABLEKS                       R6 R5 K14 ["*"]
       13 GETTABLEKS                       R6 R2 K6 ["Italic"]
       15 SETTABLEKS                       R6 R5 K15 ["_"]
       17 GETTABLEKS                       R6 R2 K7 ["Strike"]
       19 SETTABLEKS                       R6 R5 K16 ["~"]
       21 GETTABLEKS                       R6 R2 K9 ["Code"]
       23 SETTABLEKS                       R6 R5 K17 ["`"]
       25 DUPCLOSURE                       R6 K18 [PROTO_3]
       26 CAPTURE                          VAL R5
       27 DUPCLOSURE                       R7 K19 [PROTO_4]
       28 CAPTURE                          VAL R3
       29 CAPTURE                          VAL R2
       30 CAPTURE                          VAL R5
       31 DUPCLOSURE                       R8 K20 [PROTO_5]
       32 DUPTABLE                         R9 K30 [{["None"] = 0, ["Paragraph"] = 1, ["Heading"] = 2, ["Code"] = 3, ["List"] = 4, ["Ruler"] = 5, ["Quote"] = 6}]
       33 NEWTABLE                         R10 8 0
       35 GETTABLEKS                       R11 R9 K21 ["None"]
       37 LOADB                            R12 1
       38 SETTABLE                         R12 R10 R11
       39 GETTABLEKS                       R11 R9 K22 ["Paragraph"]
       41 LOADB                            R12 1
       42 SETTABLE                         R12 R10 R11
       43 GETTABLEKS                       R11 R9 K9 ["Code"]
       45 LOADB                            R12 1
       46 SETTABLE                         R12 R10 R11
       47 GETTABLEKS                       R11 R9 K24 ["List"]
       49 LOADB                            R12 1
       50 SETTABLE                         R12 R10 R11
       51 GETTABLEKS                       R11 R9 K28 ["Quote"]
       53 LOADB                            R12 1
       54 SETTABLE                         R12 R10 R11
       55 DUPCLOSURE                       R11 K31 [PROTO_6]
       56 DUPCLOSURE                       R12 K32 [PROTO_7]
       57 DUPCLOSURE                       R13 K33 [PROTO_8]
       58 DUPCLOSURE                       R14 K34 [PROTO_10]
       59 CAPTURE                          VAL R9
       60 DUPCLOSURE                       R15 K35 [PROTO_12]
       61 CAPTURE                          VAL R9
       62 CAPTURE                          VAL R10
       63 DUPCLOSURE                       R16 K36 [PROTO_14]
       64 CAPTURE                          VAL R9
       65 CAPTURE                          VAL R10
       66 CAPTURE                          VAL R8
       67 CAPTURE                          VAL R3
       68 CAPTURE                          VAL R16
       69 DUPCLOSURE                       R17 K37 [PROTO_15]
       70 CAPTURE                          VAL R7
       71 CAPTURE                          VAL R9
       72 CAPTURE                          VAL R10
       73 CAPTURE                          VAL R8
       74 CAPTURE                          VAL R3
       75 CAPTURE                          VAL R16
       76 SETTABLEKS                       R3 R0 K38 ["sanitize"]
       78 SETTABLEKS                       R17 R0 K39 ["parse"]
       80 SETTABLEKS                       R4 R0 K40 ["parseTokens"]
       82 SETTABLEKS                       R9 R0 K41 ["BlockType"]
       84 SETTABLEKS                       R1 R0 K42 ["InlineType"]
       86 SETTABLEKS                       R2 R0 K43 ["ModifierType"]
       88 RETURN                           R0 1
