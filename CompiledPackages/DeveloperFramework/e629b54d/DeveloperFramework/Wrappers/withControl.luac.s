...
PROTO_1:
       ...
       11 GETTABLEKS                       R0 R0 K4 ["ComponentProps"]
       13 GETTABLEKS                       R0 R0 K5 ["OnHoverEnd"]
       15 JUMPIFNOT                        R0 ; [+13]
       16 GETUPVAL                         R0 0
       17 GETTABLEKS                       R0 R0 K3 ["props"]
       19 GETTABLEKS                       R0 R0 K4 ["ComponentProps"]
       21 GETTABLEKS                       R0 R0 K5 ["OnHoverEnd"]
       23 GETUPVAL                         R1 0
       24 GETTABLEKS                       R1 R1 K3 ["props"]
       26 GETTABLEKS                       R1 R1 K4 ["ComponentProps"]
       28 CALL                             R0 1 0
       29 RETURN                           R0 0
...
PROTO_2:
       ...
       15 GETTABLEKS                       R2 R2 K4 ["ComponentProps"]
       17 GETTABLEKS                       R2 R2 K5 ["OnPress"]
       19 JUMPIFNOT                        R2 ; [+15]
       20 GETUPVAL                         R2 1
       21 GETTABLEKS                       R2 R2 K3 ["props"]
       23 GETTABLEKS                       R2 R2 K4 ["ComponentProps"]
       25 GETTABLEKS                       R2 R2 K5 ["OnPress"]
       27 GETUPVAL                         R3 1
       28 GETTABLEKS                       R3 R3 K3 ["props"]
       30 GETTABLEKS                       R3 R3 K4 ["ComponentProps"]
       32 MOVE                             R4 R0
       33 MOVE                             R5 R1
       34 CALL                             R2 3 0
       35 GETUPVAL                         R2 1
       36 GETTABLEKS                       R2 R2 K3 ["props"]
       38 GETTABLEKS                       R2 R2 K4 ["ComponentProps"]
       40 GETTABLEKS                       R2 R2 K6 ["OnDoubleClick"]
       42 JUMPIFNOT                        R2 ; [+52]
       43 GETUPVAL                         R2 1
       44 GETTABLEKS                       R2 R2 K7 ["DoubleClickDetector"]
       46 NAMECALL                         R2 R2 K8 ["isDoubleClick"]
       48 CALL                             R2 1 1
       49 JUMPIFNOT                        R2 ; [+45]
       50 GETUPVAL                         R2 1
       51 GETTABLEKS                       R2 R2 K3 ["props"]
       53 GETTABLEKS                       R2 R2 K4 ["ComponentProps"]
       55 GETTABLEKS                       R2 R2 K6 ["OnDoubleClick"]
       57 GETUPVAL                         R3 1
       58 GETTABLEKS                       R3 R3 K3 ["props"]
       60 GETTABLEKS                       R3 R3 K4 ["ComponentProps"]
       62 MOVE                             R4 R0
       63 MOVE                             R5 R1
       64 CALL                             R2 3 0
       65 RETURN                           R0 0
       ...
       72 GETUPVAL                         R2 1
       73 GETTABLEKS                       R2 R2 K3 ["props"]
       75 GETTABLEKS                       R2 R2 K4 ["ComponentProps"]
       77 GETTABLEKS                       R2 R2 K13 ["OnSecondaryPress"]
       79 JUMPIFNOT                        R2 ; [+15]
       80 GETUPVAL                         R2 1
       81 GETTABLEKS                       R2 R2 K3 ["props"]
       83 GETTABLEKS                       R2 R2 K4 ["ComponentProps"]
       85 GETTABLEKS                       R2 R2 K13 ["OnSecondaryPress"]
       87 GETUPVAL                         R3 1
       88 GETTABLEKS                       R3 R3 K3 ["props"]
       90 GETTABLEKS                       R3 R3 K4 ["ComponentProps"]
       92 MOVE                             R4 R0
       93 MOVE                             R5 R1
       94 CALL                             R2 3 0
       95 RETURN                           R0 0
...
PROTO_3:
       ...
       13 GETTABLEKS                       R2 R2 K3 ["props"]
       15 GETTABLEKS                       R2 R2 K4 ["ComponentProps"]
       17 GETTABLEKS                       R2 R2 K5 ["OnPressEnd"]
       19 JUMPIFNOT                        R2 ; [+15]
       20 GETUPVAL                         R2 1
       21 GETTABLEKS                       R2 R2 K3 ["props"]
       23 GETTABLEKS                       R2 R2 K4 ["ComponentProps"]
       25 GETTABLEKS                       R2 R2 K5 ["OnPressEnd"]
       27 GETUPVAL                         R3 1
       28 GETTABLEKS                       R3 R3 K3 ["props"]
       30 GETTABLEKS                       R3 R3 K4 ["ComponentProps"]
       32 MOVE                             R4 R0
