...
local getFFlagDevFrameworkDragBarStylesheets = require(Framework.SharedFlags.getFFlagDevFrameworkDragBarStylesheets)
local React = if Framework.Parent:FindFirstChild("React") then require(Framework.Parent.React) else nil
local supportsStyleSheets = getFFlagDevFrameworkDragBarStylesheets() and require(Framework.Styling.supportsStyleSheets)
