PROTO_0:
        ...
        3 GETTABLEKS                       R1 R1 K1 ["OnSizeChange"]
        5 JUMPIFNOT                        R1 ; [+7]
        6 GETUPVAL                         R1 0
        7 GETTABLEKS                       R1 R1 K0 ["props"]
        9 GETTABLEKS                       R1 R1 K1 ["OnSizeChange"]
       11 MOVE                             R2 R0
       12 CALL                             R1 1 0
       13 GETUPVAL                         R1 0
       14 GETTABLEKS                       R1 R1 K0 ["props"]
       16 GETTABLEKS                       R1 R1 K2 ["Stylizer"]
       ...
       28 GETTABLEKS                       R3 R3 K7 ["OnPageSizeChange"]
       30 JUMPIFNOT                        R3 ; [+13]
       31 GETUPVAL                         R3 0
       32 GETTABLEKS                       R3 R3 K0 ["props"]
       34 GETTABLEKS                       R3 R3 K7 ["OnPageSizeChange"]
       36 LOADN                            R5 1
...
PROTO_2:
       ...
       45 GETUPVAL                         R9 0
       46 GETTABLEKS                       R9 R9 K5 ["createElement"]
       48 GETUPVAL                         R10 2
       ...
       71 GETUPVAL                         R7 0
       72 GETTABLEKS                       R7 R7 K5 ["createElement"]
       74 GETUPVAL                         R8 3
      ...
      104 JUMPIFNOT                        R4 ; [+6]
      105 GETUPVAL                         R10 0
      106 GETTABLEKS                       R10 R10 K44 ["createFragment"]
      108 MOVE                             R11 R6
      109 CALL                             R10 1 1
      110 JUMPIF                           R10 ; [+1]
      111 LOADNIL                          R10
