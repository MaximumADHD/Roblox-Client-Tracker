...
return {
	...
	INLINE_TEXT = {
		STYLED_TEXT = true,
		INLINE_CODE = if FFlagDevFrameworkMarkdownCommonMarkCompliance then nil else true,
		LINK = true,
		IMAGE = true,
		ACTION = true,
		TABLE_DIVIDER = true,
	...
	DIVIDERS = {
		LINE_BREAK = true,
		DIVIDER = true,
		DIVIDER_2 = if FFlagDevFrameworkMarkdownCommonMarkCompliance then nil else true,
	},
	ASCII = {
