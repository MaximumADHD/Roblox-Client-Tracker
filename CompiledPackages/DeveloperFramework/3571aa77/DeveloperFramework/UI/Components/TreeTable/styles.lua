...
return rule(".Component-TreeTable", {}, {
	...
	rule(".modern", {}, {
		...
		if FFlagLuaStartPageTableContextMenu
			then rule(".enable-hover >> .Component-TableRow:hover >> .Component-TreeTableCell", {
				BackgroundColor3 = "$TableRowHoverBackground",
				BackgroundTransparency = "$TableRowHoverBackgroundTransparency",
			})
			else rule(">> .Component-TableRow:hover >> .Component-TreeTableCell", {
				BackgroundColor3 = "$TableRowHoverBackground",
				BackgroundTransparency = "$TableRowHoverBackgroundTransparency",
			}),
	}),
