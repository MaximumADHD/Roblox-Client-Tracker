...
local getFFlagDevFrameworkSliderFixLayoutOrder = require(Framework.SharedFlags.getFFlagDevFrameworkSliderFixLayoutOrder)
...
function Slider:render()
	...
	if props.ShowInput then
		...
		return Roact.createElement(Pane, {
			...
			LayoutOrder = if getFFlagDevFrameworkSliderFixLayoutOrder() then props.LayoutOrder else nil,
			Spacing = 10,
			Size = props.Size,
		}, {
