...
local getFFlagUseDialogWidgetDeferUnmount = require(Framework.SharedFlags.getFFlagUseDialogWidgetDeferUnmount)
...
local function useDialogWidget(props: Props)
	...
	React.useEffect(function()
		...
		return function()
			...
			if getFFlagUseDialogWidgetDeferUnmount() then
				task.defer(function()
					root:unmount()
					widget:Destroy()
				end)
