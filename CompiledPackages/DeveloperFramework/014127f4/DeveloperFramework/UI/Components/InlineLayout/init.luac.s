...
PROTO_2:
      ...
      122 ADDK                             R7 R7 K1 [1]
      123 JUMPBACK                         ; [-104]
      124 JUMPIFNOTEQKN                    R7 K9 [100] ; [+15]
      126 GETUPVAL                         R10 1
      127 JUMPIFNOT                        R10 ; [+12]
      ...
      131 LOADK                            R12 K13 ["Desired width: %*"]
      132 MOVE                             R14 R1
      133 NAMECALL                         R12 R12 K14 ["format"]
      135 CALL                             R12 2 1
      136 GETIMPORT                        R13 K17 [debug.traceback]
      138 CALL                             R13 0 -1
      139 CALL                             R10 -1 0
      140 LENGTH                           R10 R3
      141 LOADN                            R11 0
      142 JUMPIFNOTLT                      R11 R10 ; [+8]
      144 FASTCALL2                        TABLE_INSERT R2 R3 ; [+5]
      146 MOVE                             R11 R2
      147 MOVE                             R12 R3
      148 GETIMPORT                        R10 K4 [table.insert]
      150 CALL                             R10 2 0
      151 GETUPVAL                         R10 2
      152 MOVE                             R11 R2
      153 DUPCLOSURE                       R12 K18 [PROTO_1]
...
PROTO_4:
       ...
       34 CALL                             R5 2 0
       35 GETUPVAL                         R5 6
       36 GETTABLEKS                       R5 R5 K4 ["createElement"]
       38 GETUPVAL                         R6 7
       39 GETTABLEKS                       R6 R6 K5 ["Provider"]
       41 LOADNIL                          R7
       42 GETUPVAL                         R8 6
       ...
       46 NEWTABLE                         R10 4 0
       48 GETUPVAL                         R11 6
       49 GETTABLEKS                       R11 R11 K6 ["Change"]
       51 GETTABLEKS                       R11 R11 K7 ["AbsoluteSize"]
       53 SETTABLE                         R4 R10 R11
       54 SETTABLEKS                       R1 R10 K8 ["ref"]
       56 GETUPVAL                         R11 6
       57 GETTABLEKS                       R11 R11 K9 ["Tag"]
...
MAIN:
       ...
       29 GETTABLEKS                       R5 R0 K4 ["Parent"]
       31 GETTABLEKS                       R5 R5 K11 ["Dash"]
       33 CALL                             R4 1 1
       ...
       46 GETTABLEKS                       R11 R0 K2 ["UI"]
       48 GETTABLEKS                       R11 R11 K17 ["Components"]
       50 GETTABLEKS                       R11 R11 K18 ["Pane"]
       52 CALL                             R10 1 1
       53 GETIMPORT                        R11 K6 [require]
       55 GETIMPORT                        R12 K1 [script]
       57 GETTABLEKS                       R12 R12 K19 ["RenderableInlineElement"]
       59 CALL                             R11 1 1
       60 GETIMPORT                        R12 K6 [require]
       62 GETIMPORT                        R13 K1 [script]
       64 GETTABLEKS                       R13 R13 K20 ["HardBreakElement"]
       66 CALL                             R12 1 1
       67 GETIMPORT                        R13 K6 [require]
       69 GETIMPORT                        R14 K1 [script]
       71 GETTABLEKS                       R14 R14 K21 ["HoverContext"]
       73 CALL                             R13 1 1
