...
PROTO_19:
        ...
        5 JUMPIFNOT                        R3 ; [+5]
        6 GETUPVAL                         R3 0
        7 GETTABLEKS                       R3 R3 K0 ["number"]
        9 MOVE                             R4 R1
       10 CALL                             R3 1 1
       11 FASTCALL2K                       ASSERT R3 K1 ; [+4]
       13 LOADK                            R4 K1 ["TypeError"]
       14 GETIMPORT                        R2 K3 [assert]
       16 CALL                             R2 2 0
       17 GETUPVAL                         R2 0
       18 GETTABLEKS                       R2 R2 K4 ["numberMin"]
       20 MOVE                             R3 R0
       21 CALL                             R2 1 1
       22 GETUPVAL                         R3 0
       23 GETTABLEKS                       R3 R3 K5 ["numberMax"]
       25 MOVE                             R4 R1
       26 CALL                             R3 1 1
       27 NEWCLOSURE                       R4 P0
       28 CAPTURE                          VAL R2
...
PROTO_21:
       ...
       16 CALL                             R2 2 0
       17 GETUPVAL                         R2 0
       18 GETTABLEKS                       R2 R2 K4 ["numberMinExclusive"]
       20 MOVE                             R3 R0
       21 CALL                             R2 1 1
       22 GETUPVAL                         R3 0
       23 GETTABLEKS                       R3 R3 K5 ["numberMaxExclusive"]
       25 MOVE                             R4 R1
       26 CALL                             R3 1 1
       27 NEWCLOSURE                       R4 P0
       28 CAPTURE                          VAL R2
...
PROTO_33:
        ...
        4 CALL                             R3 1 1
        5 GETUPVAL                         R4 0
        6 GETTABLEKS                       R4 R4 K0 ["callback"]
        8 MOVE                             R5 R1
        9 CALL                             R4 1 -1
       ...
       13 CALL                             R2 -1 0
       14 GETUPVAL                         R2 0
       15 GETTABLEKS                       R2 R2 K3 ["keys"]
       17 MOVE                             R3 R0
       18 CALL                             R2 1 1
       19 GETUPVAL                         R3 0
       20 GETTABLEKS                       R3 R3 K4 ["values"]
       22 MOVE                             R4 R1
       23 CALL                             R3 1 1
       24 NEWCLOSURE                       R4 P0
       25 CAPTURE                          VAL R2
...
PROTO_45:
        ...
        7 LOADK                            R4 K1 ["TypeError"]
        8 GETIMPORT                        R2 K3 [assert]
       10 CALL                             R2 2 0
       11 LOADNIL                          R2
       12 JUMPIFEQKNIL                     R1 ; [+7]
       14 GETUPVAL                         R3 0
       15 GETTABLEKS                       R3 R3 K4 ["children"]
       17 MOVE                             R4 R1
       18 CALL                             R3 1 1
       19 MOVE                             R2 R3
       20 NEWCLOSURE                       R3 P0
...
PROTO_50:
        ...
        2 GETVARARGS                       R2 -1
        3 CALL                             R1 -1 1
        4 FASTCALL2K                       ASSERT R1 K0 ; [+4]
        6 LOADK                            R2 K0 ["TypeError"]
        7 GETIMPORT                        R0 K2 [assert]
        9 CALL                             R0 2 0
       10 GETUPVAL                         R0 1
       11 GETVARARGS                       R1 -1
       12 CALL                             R0 -1 -1
