...
PROTO_5:
      ...
      517 GETUPVAL                         R24 10
      518 JUMPIFNOT                        R24 ; [+7]
      519 GETTABLEKS                       R24 R17 K65 ["Size"]
      521 GETUPVAL                         R25 11
      522 JUMPIFNOTEQ                      R24 R25 ; [+3]
      524 LOADK                            R23 K108 ["X-DefaultSize"]
      525 JUMP                             ; [+1]
      526 LOADNIL                          R23
      527 GETUPVAL                         R25 10
      528 JUMPIFNOT                        R25 ; [+6]
      529 GETTABLEKS                       R25 R17 K70 ["BackgroundTransparency"]
      531 JUMPIFNOTEQKN                    R25 K77 [0] ; [+3]
      533 LOADK                            R24 K109 ["X-DefaultTransparency"]
      534 JUMP                             ; [+1]
      535 LOADNIL                          R24
      536 CALL                             R19 5 1
      537 SETTABLE                         R19 R17 R18
      538 GETUPVAL                         R19 2
      539 GETTABLEKS                       R18 R19 K25 ["createElement"]
      541 MOVE                             R19 R10
      542 MOVE                             R20 R17
      543 MOVE                             R21 R4
      544 CALL                             R18 3 -1
...
MAIN:
      ...
      116 GETTABLEKS                       R18 R0 K44 ["SharedFlags"]
      118 CALL                             R17 1 1
      119 GETTABLEKS                       R18 R17 K45 ["getFFlagDeveloperFrameworkMigrateStylingV2"]
      121 CALL                             R18 0 1
      122 GETTABLEKS                       R19 R3 K46 ["PureComponent"]
      124 LOADK                            R21 K47 ["Pane"]
      125 NAMECALL                         R19 R19 K48 ["extend"]
      127 CALL                             R19 2 1
      128 DUPCLOSURE                       R20 K49 [PROTO_0]
      129 CAPTURE                          VAL R8
      130 DUPTABLE                         R21 K52 [{"HorizontalAlignment", "VerticalAlignment"}]
      131 GETIMPORT                        R22 K55 [Enum.HorizontalAlignment.Center]
      133 SETTABLEKS                       R22 R21 K50 ["HorizontalAlignment"]
      135 GETIMPORT                        R22 K56 [Enum.VerticalAlignment.Center]
      137 SETTABLEKS                       R22 R21 K51 ["VerticalAlignment"]
      139 SETTABLEKS                       R21 R19 K57 ["defaultProps"]
      141 DUPCLOSURE                       R21 K58 [PROTO_4]
      142 CAPTURE                          VAL R7
      143 CAPTURE                          VAL R3
      144 SETTABLEKS                       R21 R19 K59 ["init"]
      146 DUPCLOSURE                       R21 K60 [PROTO_5]
      147 CAPTURE                          VAL R5
      148 CAPTURE                          VAL R4
      149 CAPTURE                          VAL R3
      150 CAPTURE                          VAL R16
      ...
      157 CAPTURE                          VAL R18
      158 CAPTURE                          VAL R15
      159 SETTABLEKS                       R21 R19 K61 ["render"]
      161 MOVE                             R21 R2
      162 DUPTABLE                         R22 K63 [{"Stylizer"}]
      163 JUMPIFNOT                        R5 ; [+2]
      164 LOADNIL                          R23
      165 JUMP                             ; [+2]
      166 GETTABLEKS                       R23 R1 K62 ["Stylizer"]
      168 SETTABLEKS                       R23 R22 K62 ["Stylizer"]
      170 CALL                             R21 1 1
      171 MOVE                             R22 R19
      172 CALL                             R21 1 1
      173 MOVE                             R19 R21
