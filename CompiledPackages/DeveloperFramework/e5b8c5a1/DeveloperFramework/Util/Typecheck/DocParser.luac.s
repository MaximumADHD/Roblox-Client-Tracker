PROTO_0:
        0 DUPTABLE                         R2 K4 [{[1], ["script"], ["line"] = 1}]
        1 FASTCALL1                        TOSTRING R0 ; [+3]
        2 MOVE                             R4 R0
        3 GETIMPORT                        R3 K6 [tostring]
        5 CALL                             R3 1 1
       ...
       13 MOVE                             R4 R2
       14 GETIMPORT                        R3 K8 [setmetatable]
       16 CALL                             R3 2 0
       17 RETURN                           R2 1
...
PROTO_1:
       ...
       40 CALL                             R5 3 1
       41 LOADK                            R6 K14 ["%*%%.defaultProps%%s*=%%s*%%{\n(.-)\n%%}"]
       42 GETTABLEKS                       R8 R1 K15 ["Name"]
       44 NAMECALL                         R6 R6 K16 ["format"]
       46 CALL                             R6 2 1
       47 GETIMPORT                        R7 K19 [string.match]
       49 MOVE                             R8 R2
       50 MOVE                             R9 R6
       51 CALL                             R7 2 1
       52 JUMPIFNOT                        R7 ; [+3]
       ...
       56 MOVE                             R10 R5
       57 MOVE                             R11 R7
       58 NAMECALL                         R8 R0 K21 ["parseComments"]
       60 CALL                             R8 3 -1
       61 RETURN                           R8 -1
...
PROTO_2:
        ...
        6 MOVE                             R4 R2
        7 LOADK                            R5 K5 ["%*%%.defaultProps%%s*=%%s*%%{\n(.-)\n%%}"]
        8 GETTABLEKS                       R7 R1 K6 ["Name"]
       10 NAMECALL                         R5 R5 K7 ["format"]
       12 CALL                             R5 2 1
       13 CALL                             R3 2 1
       14 GETIMPORT                        R4 K4 [string.match]
       16 MOVE                             R5 R2
       17 LOADK                            R6 K8 ["export%stype%sProps[%b<>]?%s*=%s*%{\n(.-)\n%}"]
       18 CALL                             R4 2 1
       19 JUMPIFNOT                        R4 ; [+18]
       20 GETUPVAL                         R5 0
       21 JUMPIFNOT                        R5 ; [+16]
       22 GETUPVAL                         R5 0
       23 GETTABLEKS                       R5 R5 K9 ["PropParser"]
       25 GETTABLEKS                       R5 R5 K10 ["parseProps"]
       27 GETUPVAL                         R6 0
       28 GETTABLEKS                       R6 R6 K11 ["DocTypes"]
       30 GETTABLEKS                       R6 R6 K12 ["Typecheckers"]
       32 GETTABLEKS                       R6 R6 K13 ["Luau"]
       34 MOVE                             R7 R4
       35 MOVE                             R8 R3
       36 CALL                             R5 3 -1
       37 RETURN                           R5 -1
...
PROTO_5:
        ...
        8 CALL                             R3 -1 0
        9 DUPTABLE                         R3 K7 [{["Props"], ["Style"], ["Summary"] = }]
       10 NEWTABLE                         R4 0 0
       12 SETTABLEKS                       R4 R3 K3 ["Props"]
       14 NEWTABLE                         R4 0 0
       16 SETTABLEKS                       R4 R3 K4 ["Style"]
       18 GETUPVAL                         R4 1
       19 GETTABLEKS                       R4 R4 K5 ["Summary"]
       21 LOADK                            R7 K8 ["\r"]
       22 LOADK                            R8 K9 [""]
       23 NAMECALL                         R5 R1 K10 ["gsub"]
       25 CALL                             R5 3 1
       26 LOADK                            R7 K11 ["\n"]
       27 NAMECALL                         R5 R5 K12 ["split"]
       29 CALL                             R5 2 1
       30 GETIMPORT                        R6 K14 [ipairs]
       32 MOVE                             R7 R5
       33 CALL                             R6 1 3
       34 FORGPREP_INEXT                   R6
       35 ADDK                             R11 R9 K15 [1]
       36 SETTABLEKS                       R11 R0 K16 ["line"]
       38 LOADN                            R11 0
       39 GETIMPORT                        R12 K18 [string.gmatch]
       41 MOVE                             R13 R10
       42 LOADK                            R14 K19 ["\t"]
       43 CALL                             R12 2 3
       44 FORGPREP                         R12
       45 ADDK                             R11 R11 K15 [1]
       46 FORGLOOP                         R12 1 ; [-2]
       48 ADDK                             R14 R11 K15 [1]
       49 NAMECALL                         R12 R10 K20 ["sub"]
       51 CALL                             R12 2 1
       52 JUMPIFNOTEQKS                    R12 K21 ["Required Props:"] ; [+5]
       54 GETUPVAL                         R13 1
       55 GETTABLEKS                       R4 R13 K22 ["Required"]
       57 JUMP                             ; [+113]
       58 JUMPIFNOTEQKS                    R12 K23 ["Optional Props:"] ; [+5]
       60 GETUPVAL                         R13 1
       61 GETTABLEKS                       R4 R13 K24 ["Optional"]
       63 JUMP                             ; [+107]
       64 JUMPIFNOTEQKS                    R12 K25 ["Style Values:"] ; [+5]
       66 GETUPVAL                         R13 1
       67 GETTABLEKS                       R4 R13 K4 ["Style"]
       69 JUMP                             ; [+101]
       70 JUMPIFNOTEQKN                    R11 K15 [1] ; [+12]
       72 LOADK                            R15 K26 [":"]
       73 NAMECALL                         R13 R12 K27 ["find"]
       75 CALL                             R13 2 1
       76 JUMPIFNOT                        R13 ; [+6]
       77 LOADB                            R15 0
       78 GETUPVAL                         R16 2
       79 NAMECALL                         R13 R0 K28 ["__assert"]
       81 CALL                             R13 3 0
       82 JUMP                             ; [+88]
       83 GETUPVAL                         R13 1
       84 GETTABLEKS                       R13 R13 K5 ["Summary"]
       86 JUMPIFNOTEQ                      R4 R13 ; [+40]
       88 LENGTH                           R13 R12
       89 LOADN                            R14 0
       90 JUMPIFNOTLT                      R14 R13 ; [+36]
       92 LOADB                            R16 0
       93 JUMPIFNOTEQKN                    R11 K29 [2] ; [+5]
       95 LOADK                            R18 K26 [":"]
       96 NAMECALL                         R16 R12 K27 ["find"]
       98 CALL                             R16 2 1
       99 NOT                              R15 R16
      100 LOADK                            R16 K30 ["DocParser:parse expects a header before prop definitions."]
      101 NAMECALL                         R13 R0 K28 ["__assert"]
      103 CALL                             R13 3 0
      104 JUMPIFEQKN                       R11 K15 [1] ; [+2]
      106 LOADB                            R15 0 +1
      107 LOADB                            R15 1
      108 LOADK                            R16 K31 ["DocParser:parse expects 1 tab for headers, 2 tabs for prop definitions, and 3 tabs for multilined prop comments."]
      109 NAMECALL                         R13 R0 K28 ["__assert"]
      111 CALL                             R13 3 0
      112 GETTABLEKS                       R14 R3 K5 ["Summary"]
      114 JUMPIFNOT                        R14 ; [+8]
      115 GETIMPORT                        R13 K33 [string.format]
      117 LOADK                            R14 K34 ["%s\n%s"]
      118 GETTABLEKS                       R15 R3 K5 ["Summary"]
      120 MOVE                             R16 R12
      121 CALL                             R13 3 1
      122 JUMPIF                           R13 ; [+1]
      123 MOVE                             R13 R12
      124 SETTABLEKS                       R13 R3 K5 ["Summary"]
      126 JUMP                             ; [+44]
      127 GETUPVAL                         R13 1
      128 GETTABLEKS                       R13 R13 K22 ["Required"]
      130 JUMPIFNOTEQ                      R4 R13 ; [+11]
      132 GETTABLEKS                       R15 R3 K3 ["Props"]
      134 MOVE                             R16 R2
      135 MOVE                             R17 R11
      136 MOVE                             R18 R12
      137 LOADB                            R19 0
      138 NAMECALL                         R13 R0 K35 ["__parseProp"]
      140 CALL                             R13 6 0
      141 JUMP                             ; [+29]
      142 GETUPVAL                         R13 1
      143 GETTABLEKS                       R13 R13 K24 ["Optional"]
      145 JUMPIFNOTEQ                      R4 R13 ; [+11]
      147 GETTABLEKS                       R15 R3 K3 ["Props"]
      149 MOVE                             R16 R2
      150 MOVE                             R17 R11
      151 MOVE                             R18 R12
      152 LOADB                            R19 1
      153 NAMECALL                         R13 R0 K35 ["__parseProp"]
      155 CALL                             R13 6 0
      156 JUMP                             ; [+14]
      157 GETUPVAL                         R13 1
      158 GETTABLEKS                       R13 R13 K4 ["Style"]
      160 JUMPIFNOTEQ                      R4 R13 ; [+10]
      162 GETTABLEKS                       R15 R3 K4 ["Style"]
      164 MOVE                             R16 R2
      165 MOVE                             R17 R11
      166 MOVE                             R18 R12
      167 LOADB                            R19 1
      168 NAMECALL                         R13 R0 K35 ["__parseProp"]
      170 CALL                             R13 6 0
      171 FORGLOOP                         R6 2 [inext] ; [-137]
      173 RETURN                           R3 1
