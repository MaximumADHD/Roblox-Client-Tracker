...
PROTO_2:
        ...
        5 GETTABLEKS                       R2 R2 K2 ["OnExpansionChange"]
        7 JUMPIFNOT                        R2 ; [+21]
        8 GETUPVAL                         R2 0
        9 GETTABLEKS                       R2 R2 K3 ["getItemId"]
       11 MOVE                             R3 R1
       12 CALL                             R2 1 1
       13 GETUPVAL                         R3 0
       14 GETTABLEKS                       R3 R3 K1 ["props"]
       16 GETTABLEKS                       R3 R3 K2 ["OnExpansionChange"]
       18 NEWTABLE                         R4 1 0
       20 GETUPVAL                         R7 0
       21 GETTABLEKS                       R7 R7 K1 ["props"]
       23 GETTABLEKS                       R7 R7 K4 ["Expansion"]
...
PROTO_3:
        ...
        2 GETUPVAL                         R2 0
        3 GETTABLEKS                       R2 R2 K1 ["props"]
        5 GETTABLEKS                       R2 R2 K2 ["OnSelectionChange"]
        7 JUMPIFNOT                        R2 ; [+15]
        8 GETUPVAL                         R2 0
        9 GETTABLEKS                       R2 R2 K3 ["getItemId"]
       11 MOVE                             R3 R1
       ...
       13 GETUPVAL                         R3 0
       14 GETTABLEKS                       R3 R3 K1 ["props"]
       16 GETTABLEKS                       R3 R3 K2 ["OnSelectionChange"]
       18 NEWTABLE                         R4 1 0
       20 LOADB                            R5 1
...
PROTO_4:
        ...
        3 GETUPVAL                         R5 0
        4 GETTABLEKS                       R5 R5 K1 ["getChildren"]
        6 GETTABLEKS                       R6 R0 K2 ["item"]
        8 CALL                             R5 1 1
        9 GETUPVAL                         R6 0
       10 GETTABLEKS                       R6 R6 K3 ["getItemId"]
       ...
       58 GETUPVAL                         R9 0
       59 GETTABLEKS                       R9 R9 K19 ["onToggle"]
       61 SETTABLEKS                       R9 R8 K12 ["OnToggle"]
       63 GETUPVAL                         R9 0
       64 GETTABLEKS                       R9 R9 K20 ["onSelect"]
...
PROTO_5:
       ...
       10 GETTABLEKS                       R1 R0 K5 ["props"]
       12 GETTABLEKS                       R1 R1 K6 ["GetChildren"]
       14 JUMPIF                           R1 ; [+2]
       ...
       22 GETTABLEKS                       R1 R0 K5 ["props"]
       24 GETTABLEKS                       R1 R1 K10 ["GetItemId"]
       26 JUMPIF                           R1 ; [+2]
...
PROTO_7:
        ...
        4 GETTABLEKS                       R3 R3 K0 ["GetChildren"]
        6 JUMPIFEQ                         R2 R3 ; [+8]
       ...
       19 GETTABLEKS                       R3 R3 K4 ["GetItemId"]
       21 JUMPIFEQ                         R2 R3 ; [+8]
...
PROTO_11:
       ...
       17 GETTABLEKS                       R6 R0 K9 ["state"]
       19 GETTABLEKS                       R6 R6 K10 ["rows"]
...
PROTO_12:
       ...
       32 GETUPVAL                         R6 3
       33 GETTABLEKS                       R6 R6 K7 ["Tag"]
       35 GETUPVAL                         R7 4
       36 LOADK                            R8 K8 ["Component-TreeView"]
       37 GETUPVAL                         R11 3
       38 GETTABLEKS                       R11 R11 K7 ["Tag"]
...
MAIN:
       ...
       41 GETTABLEKS                       R6 R0 K4 ["Parent"]
       43 GETTABLEKS                       R6 R6 K12 ["React"]
       45 CALL                             R5 1 1
       46 JUMP                             ; [+1]
       47 LOADNIL                          R5
       48 GETIMPORT                        R6 K6 [require]
       50 GETTABLEKS                       R7 R0 K14 ["Styling"]
       52 GETTABLEKS                       R7 R7 K15 ["supportsStyleSheets"]
       54 CALL                             R6 1 1
       55 GETIMPORT                        R7 K6 [require]
       57 GETTABLEKS                       R8 R0 K14 ["Styling"]
       59 GETTABLEKS                       R8 R8 K16 ["joinTags"]
       61 CALL                             R7 1 1
       62 GETIMPORT                        R8 K6 [require]
       64 GETTABLEKS                       R9 R0 K4 ["Parent"]
       66 GETTABLEKS                       R9 R9 K17 ["Dash"]
       68 CALL                             R8 1 1
       69 GETTABLEKS                       R9 R8 K18 ["join"]
       71 GETTABLEKS                       R10 R0 K2 ["UI"]
       73 GETIMPORT                        R11 K6 [require]
       75 GETTABLEKS                       R12 R10 K19 ["Components"]
       77 GETTABLEKS                       R12 R12 K20 ["Pane"]
       79 CALL                             R11 1 1
       80 GETIMPORT                        R12 K6 [require]
       82 GETTABLEKS                       R13 R10 K19 ["Components"]
       84 GETTABLEKS                       R13 R13 K21 ["List"]
       86 CALL                             R12 1 1
       87 GETIMPORT                        R13 K6 [require]
       89 GETTABLEKS                       R14 R10 K19 ["Components"]
       91 GETTABLEKS                       R14 R14 K22 ["TreeViewRow"]
       93 CALL                             R13 1 1
