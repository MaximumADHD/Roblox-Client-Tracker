...
PROTO_9:
      ...
      100 GETUPVAL                         R6 1
      101 GETTABLEKS                       R6 R6 K23 ["closeNode"]
      103 MOVE                             R7 R2
      ...
      142 JUMPIFNOT                        R6 ; [+41]
      143 GETUPVAL                         R6 1
      144 GETTABLEKS                       R6 R6 K23 ["closeNode"]
      146 MOVE                             R7 R2
      ...
      190 JUMPIF                           R6 ; [+30]
      191 GETUPVAL                         R6 1
      192 GETTABLEKS                       R6 R6 K23 ["closeNode"]
      194 MOVE                             R7 R2
      ...
      223 JUMPIFNOT                        R6 ; [+56]
      224 GETUPVAL                         R6 1
      225 GETTABLEKS                       R6 R6 K23 ["closeNode"]
      227 MOVE                             R7 R2
      ...
      234 JUMPIFNOT                        R7 ; [+5]
      235 LENGTH                           R7 R2
      236 GETTABLE                         R6 R2 R7
      237 GETTABLEKS                       R6 R6 K1 ["children"]
      239 JUMP                             ; [+1]
      240 MOVE                             R6 R2
      241 NEWTABLE                         R7 1 0
      243 NEWTABLE                         R8 0 0
      ...
      405 JUMPIFNOT                        R7 ; [+6]
      406 GETUPVAL                         R11 1
      407 GETTABLEKS                       R11 R11 K51 ["parseXmlAttributes"]
      409 MOVE                             R12 R7
      410 CALL                             R11 1 1
      411 JUMP                             ; [+2]
      ...
      472 JUMPIFNOT                        R7 ; [+6]
      473 GETUPVAL                         R11 1
      474 GETTABLEKS                       R11 R11 K51 ["parseXmlAttributes"]
      476 MOVE                             R12 R7
      477 CALL                             R11 1 1
      478 JUMP                             ; [+2]
      ...
      507 GETUPVAL                         R7 1
      508 GETTABLEKS                       R7 R7 K23 ["closeNode"]
      510 MOVE                             R8 R2
      ...
      636 CALL                             R9 2 0
      637 GETUPVAL                         R9 1
      638 GETTABLEKS                       R9 R9 K23 ["closeNode"]
      640 MOVE                             R10 R2
      ...
      703 JUMPBACK                         ; [-687]
      704 GETUPVAL                         R4 1
      705 GETTABLEKS                       R4 R4 K23 ["closeNode"]
      707 MOVE                             R5 R2
      708 DUPCLOSURE                       R6 K67 [PROTO_7]
      709 CALL                             R4 2 0
      710 GETUPVAL                         R4 1
      711 GETTABLEKS                       R4 R4 K23 ["closeNode"]
      713 MOVE                             R5 R2
...
MAIN:
       ...
       22 CALL                             R1 1 1
       23 GETTABLEKS                       R2 R1 K7 ["LISTS"]
       25 GETTABLEKS                       R3 R1 K8 ["STYLED_TEXT"]
       27 GETTABLEKS                       R4 R1 K9 ["DIVIDERS"]
       29 GETIMPORT                        R5 K12 [table.insert]
       31 NEWTABLE                         R6 4 0
       33 DUPCLOSURE                       R7 K13 [PROTO_0]
       34 DUPCLOSURE                       R8 K14 [PROTO_9]
       35 CAPTURE                          VAL R5
       36 CAPTURE                          VAL R6
       37 CAPTURE                          VAL R3
       38 CAPTURE                          VAL R2
       39 CAPTURE                          VAL R4
       40 SETTABLEKS                       R8 R6 K15 ["buildTree"]
       42 DUPCLOSURE                       R8 K16 [PROTO_10]
       43 CAPTURE                          VAL R6
       44 CAPTURE                          VAL R5
       45 SETTABLEKS                       R8 R6 K17 ["closeNode"]
       47 DUPCLOSURE                       R8 K18 [PROTO_11]
       48 SETTABLEKS                       R8 R6 K19 ["findLastNodeIndex"]
       50 DUPCLOSURE                       R8 K20 [PROTO_12]
       51 SETTABLEKS                       R8 R6 K21 ["parseXmlAttributes"]
       53 GETTABLEKS                       R8 R6 K15 ["buildTree"]
       55 RETURN                           R8 1
