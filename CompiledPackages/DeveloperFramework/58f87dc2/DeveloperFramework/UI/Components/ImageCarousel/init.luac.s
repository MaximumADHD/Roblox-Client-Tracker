...
PROTO_1:
       ...
       35 GETTABLEKS                       R6 R6 K12 ["AutoAdvance"]
       37 JUMPIFNOT                        R6 ; [+2]
       38 LOADB                            R5 1
       39 JUMP                             ; [+1]
       40 LOADB                            R5 0
       ...
       52 CALL                             R2 2 0
       53 GETUPVAL                         R2 0
       54 GETTABLEKS                       R2 R2 K0 ["props"]
       56 GETTABLEKS                       R2 R2 K1 ["ResetWhenHoveredOff"]
       58 JUMPIFNOT                        R2 ; [+9]
       59 GETUPVAL                         R2 0
       60 GETTABLEKS                       R2 R2 K14 ["_useAnimations"]
       62 JUMPIFNOT                        R2 ; [+5]
       63 GETUPVAL                         R2 0
       64 MOVE                             R4 R1
...
PROTO_4:
        ...
        1 GETTABLEKS                       R2 R0 K8 ["props"]
        3 GETTABLEKS                       R2 R2 K9 ["AutoAdvance"]
       ...
       33 GETTABLEKS                       R3 R3 K9 ["AutoAdvance"]
       ...
       60 GETUPVAL                         R2 0
       61 JUMPIFNOT                        R2 ; [+5]
       62 GETTABLEKS                       R3 R0 K8 ["props"]
       64 GETTABLEKS                       R3 R3 K14 ["DisableAnimations"]
       66 NOT                              R2 R3
       ...
       78 GETTABLEKS                       R2 R0 K8 ["props"]
       80 GETTABLEKS                       R2 R2 K9 ["AutoAdvance"]
       82 JUMPIFNOT                        R2 ; [+3]
...
PROTO_8:
       ...
       30 GETUPVAL                         R6 0
       31 GETTABLEKS                       R6 R6 K11 ["instant"]
       33 LOADN                            R7 0
       34 CALL                             R6 1 -1
...
PROTO_13:
        ...
        7 CALL                             R0 2 0
        8 GETUPVAL                         R0 0
        9 GETTABLEKS                       R0 R0 K3 ["_moveRight"]
       11 CALL                             R0 0 0
       12 RETURN                           R0 0
...
PROTO_14:
        ...
        7 CALL                             R0 2 0
        8 GETUPVAL                         R0 0
        9 GETTABLEKS                       R0 R0 K3 ["_moveLeft"]
       11 CALL                             R0 0 0
       12 RETURN                           R0 0
...
PROTO_17:
       ...
       41 GETUPVAL                         R6 0
       42 GETTABLEKS                       R6 R6 K10 ["spring"]
       44 LOADN                            R7 1
       ...
       59 CALL                             R4 2 0
       60 GETTABLEKS                       R4 R0 K16 ["props"]
       62 GETTABLEKS                       R4 R4 K17 ["OnImageChange"]
       64 JUMPIFNOT                        R4 ; [+13]
       65 GETTABLEKS                       R4 R0 K0 ["_useAnimations"]
       67 JUMPIF                           R4 ; [+10]
       68 GETTABLEKS                       R4 R0 K16 ["props"]
       70 GETTABLEKS                       R4 R4 K17 ["OnImageChange"]
       72 MOVE                             R5 R3
       73 GETTABLEKS                       R6 R0 K1 ["state"]
       75 GETTABLEKS                       R6 R6 K18 ["fromAutoRotation"]
       77 CALL                             R4 2 0
       78 RETURN                           R0 0
