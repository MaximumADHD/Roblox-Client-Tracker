--[[
	NOTE: Use of this is discouraged. Please use https://github.com/Roblox/roblox-lua-promise-internal instead by adding it to your project's dependencies.
