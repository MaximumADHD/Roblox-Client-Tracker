...
PROTO_3:
       ...
       11 CALL                             R3 2 1
       12 GETUPVAL                         R5 1
       13 GETTABLEKS                       R4 R5 K3 ["new"]
       15 CALL                             R4 0 1
       16 GETTABLEKS                       R7 R1 K4 ["Voting"]
       18 GETTABLEKS                       R6 R7 K5 ["VoteCount"]
       20 JUMPIFEQKNIL                     R6 ; [+6]
       22 GETTABLEKS                       R6 R1 K4 ["Voting"]
       24 GETTABLEKS                       R5 R6 K5 ["VoteCount"]
       26 JUMP                             ; [+1]
       27 LOADN                            R5 0
       28 GETUPVAL                         R7 2
       29 GETTABLEKS                       R6 R7 K6 ["hasEnoughRatings"]
       31 MOVE                             R7 R5
       32 CALL                             R6 1 1
       33 DUPTABLE                         R7 K10 [{"Layout", "VoteUp", "VoteDown"}]
       34 GETUPVAL                         R9 3
       35 GETTABLEKS                       R8 R9 K11 ["createElement"]
       ...
       65 GETUPVAL                         R9 3
       66 GETTABLEKS                       R8 R9 K11 ["createElement"]
       68 GETUPVAL                         R9 4
       69 DUPTABLE                         R10 K34 [{"CanVote", "LayoutOrder", "OnClick", "UserVote", "VoteType"}]
       70 GETTABLEKS                       R12 R1 K4 ["Voting"]
       72 GETTABLEKS                       R11 R12 K30 ["CanVote"]
       ...
       85 GETTABLEKS                       R12 R1 K4 ["Voting"]
       87 GETTABLEKS                       R11 R12 K32 ["UserVote"]
       89 SETTABLEKS                       R11 R10 K32 ["UserVote"]
       91 GETUPVAL                         R13 4
       92 GETTABLEKS                       R12 R13 K33 ["VoteType"]
       94 GETTABLEKS                       R11 R12 K37 ["UpVote"]
       96 SETTABLEKS                       R11 R10 K33 ["VoteType"]
       98 CALL                             R8 2 1
       99 SETTABLEKS                       R8 R7 K8 ["VoteUp"]
      101 GETUPVAL                         R9 3
      102 GETTABLEKS                       R8 R9 K11 ["createElement"]
      104 GETUPVAL                         R9 4
      105 DUPTABLE                         R10 K34 [{"CanVote", "LayoutOrder", "OnClick", "UserVote", "VoteType"}]
      106 GETTABLEKS                       R12 R1 K4 ["Voting"]
      108 GETTABLEKS                       R11 R12 K30 ["CanVote"]
      ...
      121 GETTABLEKS                       R12 R1 K4 ["Voting"]
      123 GETTABLEKS                       R11 R12 K32 ["UserVote"]
      125 SETTABLEKS                       R11 R10 K32 ["UserVote"]
      127 GETUPVAL                         R13 4
      128 GETTABLEKS                       R12 R13 K33 ["VoteType"]
      130 GETTABLEKS                       R11 R12 K39 ["DownVote"]
      132 SETTABLEKS                       R11 R10 K33 ["VoteType"]
      134 CALL                             R8 2 1
      135 SETTABLEKS                       R8 R7 K9 ["VoteDown"]
      137 GETUPVAL                         R9 3
      138 GETTABLEKS                       R8 R9 K11 ["createElement"]
      140 GETUPVAL                         R9 5
      ...
      165 GETUPVAL                         R13 3
      166 GETTABLEKS                       R12 R13 K11 ["createElement"]
      168 GETUPVAL                         R13 5
      ...
      180 GETUPVAL                         R17 3
      181 GETTABLEKS                       R16 R17 K11 ["createElement"]
      ...
      213 JUMP                             ; [+28]
      214 GETUPVAL                         R17 3
      215 GETTABLEKS                       R16 R17 K11 ["createElement"]
      217 GETUPVAL                         R17 6
      ...
      244 GETUPVAL                         R17 3
      245 GETTABLEKS                       R16 R17 K11 ["createElement"]
      247 GETUPVAL                         R17 7
      ...
      276 GETUPVAL                         R20 2
      277 GETTABLEKS                       R19 R20 K59 ["getFormattedVoteNumberAndText"]
      279 MOVE                             R20 R5
      280 GETTABLEKS                       R22 R0 K0 ["props"]
      282 GETTABLEKS                       R21 R22 K60 ["Localization"]
      284 LOADB                            R22 0
      285 LOADB                            R23 1
      286 CALL                             R19 4 1
      ...
      303 GETUPVAL                         R13 3
      304 GETTABLEKS                       R12 R13 K11 ["createElement"]
      306 GETUPVAL                         R13 5
...
MAIN:
       ...
       45 GETTABLEKS                       R12 R0 K2 ["UI"]
       47 GETTABLEKS                       R11 R12 K15 ["Components"]
       49 GETTABLEKS                       R10 R11 K16 ["Container"]
       51 CALL                             R9 1 1
       52 GETIMPORT                        R10 K6 [require]
       54 GETTABLEKS                       R13 R0 K2 ["UI"]
       56 GETTABLEKS                       R12 R13 K15 ["Components"]
       58 GETTABLEKS                       R11 R12 K17 ["TextLabel"]
       60 CALL                             R10 1 1
       61 GETIMPORT                        R11 K6 [require]
       63 GETIMPORT                        R14 K1 [script]
       65 GETTABLEKS                       R13 R14 K4 ["Parent"]
       67 GETTABLEKS                       R12 R13 K18 ["VoteButton"]
       69 CALL                             R11 1 1
       70 GETIMPORT                        R12 K6 [require]
       72 GETIMPORT                        R15 K1 [script]
       74 GETTABLEKS                       R14 R15 K4 ["Parent"]
       76 GETTABLEKS                       R13 R14 K19 ["Votes"]
       78 CALL                             R12 1 1
