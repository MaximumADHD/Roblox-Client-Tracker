PROTO_0:
       ...
       10 GETTABLEKS                       R2 R3 K3 ["OnEnd"]
       12 CALL                             R2 0 0
       13 JUMPIFNOTEQKS                    R1 K4 ["TimeLength"] ; [+18]
       15 GETUPVAL                         R4 0
       16 GETTABLEKS                       R3 R4 K2 ["props"]
       18 GETTABLEKS                       R2 R3 K5 ["SetTimeLength"]
       20 GETTABLEKS                       R3 R0 K4 ["TimeLength"]
       22 CALL                             R2 1 0
       23 GETUPVAL                         R4 0
       24 GETTABLEKS                       R3 R4 K2 ["props"]
       26 GETTABLEKS                       R2 R3 K6 ["SetIsLoaded"]
       ...
       37 GETTABLEKS                       R3 R4 K7 ["IsLoaded"]
       39 JUMPIFEQ                         R2 R3 ; [+9]
       41 GETUPVAL                         R4 0
       42 GETTABLEKS                       R3 R4 K2 ["props"]
       44 GETTABLEKS                       R2 R3 K6 ["SetIsLoaded"]
...
PROTO_1:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R1 R2 K0 ["soundRef"]
       ...
       20 GETTABLEKS                       R3 R4 K5 ["SoundId"]
       22 SETTABLEKS                       R3 R1 K5 ["SoundId"]
       24 LOADB                            R3 1
       25 SETTABLEKS                       R3 R1 K6 ["Playing"]
       27 RETURN                           R0 0
       28 GETUPVAL                         R4 1
       29 GETTABLEKS                       R3 R4 K7 ["PAUSE"]
       31 JUMPIFNOTEQ                      R0 R3 ; [+5]
       33 LOADB                            R3 0
       34 SETTABLEKS                       R3 R1 K6 ["Playing"]
       36 RETURN                           R0 0
       37 GETUPVAL                         R4 1
       38 GETTABLEKS                       R3 R4 K8 ["SET_TIME"]
       40 JUMPIFNOTEQ                      R0 R3 ; [+14]
       42 GETUPVAL                         R5 0
       43 GETTABLEKS                       R4 R5 K4 ["props"]
       45 GETTABLEKS                       R3 R4 K9 ["IsPlaying"]
       47 JUMPIFNOT                        R3 ; [+7]
       48 GETUPVAL                         R5 0
       49 GETTABLEKS                       R4 R5 K4 ["props"]
       51 GETTABLEKS                       R3 R4 K10 ["CurrentTime"]
...
PROTO_3:
        ...
        2 GETTABLEKS                       R1 R2 K1 ["MediaPlayerSignal"]
...
PROTO_5:
       ...
       12 GETUPVAL                         R7 0
       13 GETTABLEKS                       R6 R7 K5 ["calculateSize"]
       ...
       30 GETUPVAL                         R12 1
       31 GETTABLEKS                       R11 R12 K7 ["createElement"]
       ...
       61 GETUPVAL                         R12 1
       62 GETTABLEKS                       R11 R12 K7 ["createElement"]
       64 GETUPVAL                         R12 2
       ...
       88 GETUPVAL                         R16 1
       89 GETTABLEKS                       R15 R16 K7 ["createElement"]
       91 GETUPVAL                         R16 3
      ...
      103 GETUPVAL                         R12 1
      104 GETTABLEKS                       R11 R12 K7 ["createElement"]
      106 GETUPVAL                         R12 0
      ...
      146 GETUPVAL                         R12 1
      147 GETTABLEKS                       R11 R12 K7 ["createElement"]
      ...
      163 GETUPVAL                         R15 1
      164 GETTABLEKS                       R14 R15 K52 ["Ref"]
      166 GETTABLEKS                       R15 R0 K53 ["soundRef"]
      168 SETTABLE                         R15 R13 R14
      169 GETUPVAL                         R16 1
      170 GETTABLEKS                       R15 R16 K54 ["Event"]
      172 GETTABLEKS                       R14 R15 K55 ["Changed"]
      174 GETTABLEKS                       R15 R0 K56 ["onSoundChange"]
      176 SETTABLE                         R15 R13 R14
      177 GETUPVAL                         R16 1
      178 GETTABLEKS                       R15 R16 K54 ["Event"]
      180 GETTABLEKS                       R14 R15 K57 ["Ended"]
