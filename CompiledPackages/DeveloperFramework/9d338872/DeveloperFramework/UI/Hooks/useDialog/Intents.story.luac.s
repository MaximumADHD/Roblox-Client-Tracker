PROTO_0:
        ...
        2 CALL                             R1 1 2
        3 GETUPVAL                         R3 1
        4 DUPTABLE                         R4 K9 [{"Intent", "Heading", "Body", "Contents", "ActionPrimary", "ActionSecondary", "ActionTertiary", "Title"}]
        5 GETTABLEKS                       R5 R0 K1 ["Intent"]
        7 SETTABLEKS                       R5 R4 K1 ["Intent"]
        9 LOADK                            R5 K10 ["Are you sure you want to quit Roblox Studio?"]
       10 SETTABLEKS                       R5 R4 K2 ["Heading"]
       12 LOADK                            R5 K11 ["The details will be shown here. The details will be shown here."]
       13 SETTABLEKS                       R5 R4 K3 ["Body"]
       15 MOVE                             R5 R2
       16 CALL                             R5 0 1
       17 SETTABLEKS                       R5 R4 K4 ["Contents"]
       19 GETUPVAL                         R6 2
       20 GETTABLEKS                       R5 R6 K12 ["OK"]
       22 SETTABLEKS                       R5 R4 K5 ["ActionPrimary"]
       24 GETUPVAL                         R6 2
       25 GETTABLEKS                       R5 R6 K13 ["CANCEL"]
       27 SETTABLEKS                       R5 R4 K6 ["ActionSecondary"]
       29 SETTABLEKS                       R1 R4 K7 ["ActionTertiary"]
       31 GETTABLEKS                       R5 R0 K1 ["Intent"]
       33 SETTABLEKS                       R5 R4 K8 ["Title"]
       35 CALL                             R3 1 1
       36 GETUPVAL                         R5 3
       37 GETTABLEKS                       R4 R5 K14 ["createElement"]
       39 GETUPVAL                         R5 4
       40 DUPTABLE                         R6 K17 [{"OnClick", "Text"}]
       41 SETTABLEKS                       R3 R6 K15 ["OnClick"]
       43 LOADK                            R7 K18 ["Show Dialog"]
       44 SETTABLEKS                       R7 R6 K16 ["Text"]
       46 CALL                             R4 2 -1
       47 RETURN                           R4 -1
...
MAIN:
       ...
       18 GETTABLEKS                       R2 R3 K9 ["Components"]
       20 GETIMPORT                        R3 K6 [require]
       22 GETTABLEKS                       R4 R2 K10 ["IconButton"]
       24 CALL                             R3 1 1
       25 GETIMPORT                        R4 K6 [require]
       27 GETTABLEKS                       R7 R0 K2 ["UI"]
       29 GETTABLEKS                       R6 R7 K11 ["Hooks"]
       31 GETTABLEKS                       R5 R6 K12 ["useDialogDetailsAction"]
       33 CALL                             R4 1 1
       34 GETIMPORT                        R5 K6 [require]
       36 GETTABLEKS                       R7 R0 K7 ["Util"]
       38 GETTABLEKS                       R6 R7 K13 ["DialogAction"]
       40 CALL                             R5 1 1
