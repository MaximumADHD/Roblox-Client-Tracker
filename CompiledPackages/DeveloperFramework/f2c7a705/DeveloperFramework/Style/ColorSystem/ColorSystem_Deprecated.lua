-- This color system is deprecated!
-- If you are looking for a color in here, please consider using a foundation tag for your React component instead!
return {
	Black = {
		[0] = Color3.fromHex("#121212"),
	},
	White = {
