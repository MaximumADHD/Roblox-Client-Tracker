...
PROTO_1:
        ...
        3 GETUPVAL                         R2 1
        4 DUPTABLE                         R3 K7 [{["LayoutOrder"], ["Style"] = "Round", ["Text"], ["Size"], ["OnClick"]}]
        5 GETUPVAL                         R4 2
        6 NAMECALL                         R4 R4 K8 ["getNextOrder"]
        8 CALL                             R4 1 1
        9 SETTABLEKS                       R4 R3 K1 ["LayoutOrder"]
       11 SETTABLEKS                       R0 R3 K4 ["Text"]
       13 GETIMPORT                        R4 K11 [UDim2.new]
       15 LOADN                            R5 1
       16 LOADN                            R6 -8
       17 LOADN                            R7 0
       18 LOADN                            R8 32
       19 CALL                             R4 4 1
       20 SETTABLEKS                       R4 R3 K5 ["Size"]
       22 NEWCLOSURE                       R4 P0
       23 CAPTURE                          VAL R0
       24 SETTABLEKS                       R4 R3 K6 ["OnClick"]
       26 CALL                             R1 2 -1
       27 RETURN                           R1 -1
...
MAIN:
       ...
       31 GETTABLEKS                       R4 R4 K10 ["ScrollingFrame"]
       33 CALL                             R3 1 1
