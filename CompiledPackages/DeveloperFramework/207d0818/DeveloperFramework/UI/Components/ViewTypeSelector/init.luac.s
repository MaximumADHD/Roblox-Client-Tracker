PROTO_0:
       ...
       12 GETUPVAL                         R2 0
       13 GETTABLEKS                       R2 R2 K2 ["Unsupported"]
...
PROTO_1:
        ...
        6 NEWTABLE                         R7 4 0
        8 GETUPVAL                         R8 2
        9 GETTABLEKS                       R8 R8 K4 ["List"]
       11 LOADK                            R9 K4 ["List"]
       12 SETTABLE                         R9 R7 R8
       13 GETUPVAL                         R8 2
       14 GETTABLEKS                       R8 R8 K5 ["Grid"]
       16 LOADK                            R9 K5 ["Grid"]
       17 SETTABLE                         R9 R7 R8
       18 GETUPVAL                         R8 2
       19 GETTABLEKS                       R8 R8 K6 ["Unsupported"]
...
PROTO_2:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["allValues"]
        3 CALL                             R1 0 1
        4 GETIMPORT                        R2 K3 [table.remove]
        6 MOVE                             R3 R1
        7 GETUPVAL                         R4 0
        8 GETTABLEKS                       R4 R4 K4 ["Unsupported"]
       10 GETTABLEKS                       R4 R4 K5 ["rawValue"]
       12 CALL                             R4 0 -1
       13 CALL                             R2 -1 0
       14 GETUPVAL                         R2 1
       15 GETTABLEKS                       R2 R2 K6 ["map"]
       17 MOVE                             R3 R1
       18 NEWCLOSURE                       R4 P0
       19 CAPTURE                          VAL R0
       20 CAPTURE                          UPVAL U2
...
PROTO_3:
       ...
       12 LOADK                            R4 K2 [""]
       13 GETUPVAL                         R6 1
       14 GETTABLEKS                       R6 R6 K3 ["HideLabels"]
       16 JUMPIFNOT                        R6 ; [+6]
       17 GETUPVAL                         R6 1
       18 GETTABLEKS                       R6 R6 K4 ["HideSlider"]
       20 JUMPIFNOT                        R6 ; [+2]
       21 LOADK                            R5 K5 ["Icon"]
       22 JUMP                             ; [+1]
       23 LOADK                            R5 K2 [""]
       ...
       34 GETUPVAL                         R10 1
       35 GETTABLEKS                       R10 R10 K3 ["HideLabels"]
       37 JUMPIF                           R10 ; [+3]
       ...
       44 GETUPVAL                         R9 1
       45 GETTABLEKS                       R9 R9 K10 ["DefaultGridTileSize"]
       47 SETTABLEKS                       R9 R8 K11 ["GridTileSize"]
       49 JUMPIFNOT                        R3 ; [+4]
       50 GETUPVAL                         R9 1
       51 GETTABLEKS                       R9 R9 K12 ["OnGridTileSizeChanged"]
       53 JUMP                             ; [+1]
       54 LOADNIL                          R9
       ...
       61 GETUPVAL                         R9 1
       62 GETTABLEKS                       R9 R9 K15 ["MinGridTileSize"]
       64 SETTABLEKS                       R9 R8 K15 ["MinGridTileSize"]
       66 GETUPVAL                         R9 1
       67 GETTABLEKS                       R9 R9 K16 ["MaxGridTileSize"]
       69 SETTABLEKS                       R9 R8 K16 ["MaxGridTileSize"]
       71 GETUPVAL                         R10 1
       72 GETTABLEKS                       R10 R10 K4 ["HideSlider"]
       74 NOT                              R9 R10
       75 JUMPIFNOT                        R9 ; [+9]
       76 GETTABLEKS                       R10 R0 K0 ["Id"]
       78 GETUPVAL                         R11 0
       79 GETTABLEKS                       R11 R11 K1 ["Grid"]
       81 JUMPIFEQ                         R10 R11 ; [+2]
       83 LOADB                            R9 0 +1
       84 LOADB                            R9 1
       85 SETTABLEKS                       R9 R8 K17 ["HasSlider"]
       87 GETUPVAL                         R9 2
       88 GETTABLEKS                       R9 R9 K18 ["Tag"]
       90 LOADK                            R10 K19 ["%* %*"]
       91 MOVE                             R12 R4
       92 MOVE                             R13 R5
       93 NAMECALL                         R10 R10 K20 ["format"]
       95 CALL                             R10 3 1
...
PROTO_4:
        ...
        3 CALL                             R1 1 0
        4 GETUPVAL                         R1 1
        5 GETTABLEKS                       R1 R1 K1 ["OnViewTypeSelected"]
...
PROTO_5:
       ...
       31 GETUPVAL                         R4 3
       32 GETTABLEKS                       R4 R4 K10 ["fromRawValue"]
       ...
       52 GETUPVAL                         R8 6
       53 GETUPVAL                         R10 0
       54 GETTABLEKS                       R10 R10 K5 ["Tag"]
       56 GETTABLE                         R9 R0 R10
       57 LOADK                            R10 K12 ["IconOnly"]
       58 CALL                             R8 2 1
       59 LOADNIL                          R9
       60 GETUPVAL                         R10 3
       61 GETTABLEKS                       R10 R10 K13 ["Grid"]
       ...
       88 GETUPVAL                         R14 0
       89 GETTABLEKS                       R14 R14 K14 ["createElement"]
       91 GETUPVAL                         R15 9
      ...
      136 GETUPVAL                         R17 0
      137 GETTABLEKS                       R17 R17 K5 ["Tag"]
      139 LOADK                            R18 K31 ["%* HasIcon"]
      140 MOVE                             R20 R9
      141 NAMECALL                         R18 R18 K32 ["format"]
      143 CALL                             R18 2 1
      144 SETTABLE                         R18 R16 R17
      145 CALL                             R14 2 1
      146 SETTABLEKS                       R14 R13 K17 ["Input"]
      148 CALL                             R10 3 -1
      149 RETURN                           R10 -1
...
MAIN:
       ...
       34 GETTABLEKS                       R5 R0 K12 ["Styling"]
       36 GETTABLEKS                       R5 R5 K13 ["hasTag"]
       38 CALL                             R4 1 1
       39 GETIMPORT                        R5 K6 [require]
       41 GETTABLEKS                       R6 R0 K12 ["Styling"]
       43 GETTABLEKS                       R6 R6 K14 ["joinTags"]
       45 CALL                             R5 1 1
       ...
       57 GETTABLEKS                       R9 R9 K17 ["Dash"]
       59 CALL                             R8 1 1
       60 GETIMPORT                        R9 K6 [require]
       62 GETTABLEKS                       R10 R0 K2 ["UI"]
       64 GETTABLEKS                       R10 R10 K18 ["Components"]
       66 GETTABLEKS                       R10 R10 K19 ["Pane"]
       68 CALL                             R9 1 1
       69 GETIMPORT                        R10 K6 [require]
       71 GETTABLEKS                       R11 R0 K2 ["UI"]
       73 GETTABLEKS                       R11 R11 K18 ["Components"]
       75 GETTABLEKS                       R11 R11 K20 ["SelectInput"]
       77 CALL                             R10 1 1
       78 GETIMPORT                        R11 K6 [require]
       80 GETTABLEKS                       R12 R0 K2 ["UI"]
       82 GETTABLEKS                       R12 R12 K18 ["Components"]
       84 GETTABLEKS                       R12 R12 K21 ["ViewTypeButton"]
       86 CALL                             R11 1 1
       87 GETIMPORT                        R12 K6 [require]
       89 GETTABLEKS                       R13 R0 K2 ["UI"]
       91 GETTABLEKS                       R13 R13 K18 ["Components"]
       93 GETTABLEKS                       R13 R13 K21 ["ViewTypeButton"]
       95 GETTABLEKS                       R13 R13 K22 ["ViewType"]
       97 CALL                             R12 1 1
       98 GETTABLEKS                       R13 R3 K23 ["useState"]
      100 GETIMPORT                        R14 K6 [require]
      102 GETIMPORT                        R15 K1 [script]
      104 GETTABLEKS                       R15 R15 K24 ["styles"]
      106 CALL                             R14 1 1
