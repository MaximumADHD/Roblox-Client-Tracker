...
PROTO_1:
        ...
        5 GETTABLEKS                       R1 R1 K1 ["ErrorMessage"]
        7 JUMPIFNOT                        R1 ; [+11]
        8 GETTABLEKS                       R1 R0 K0 ["responseBody"]
       10 GETTABLEKS                       R1 R1 K1 ["ErrorMessage"]
       ...
       21 JUMPIFNOT                        R1 ; [+48]
       22 GETTABLEKS                       R1 R0 K2 ["requestOptions"]
       24 GETTABLEKS                       R1 R1 K3 ["Url"]
       26 JUMPIFNOT                        R1 ; [+11]
       27 GETTABLEKS                       R1 R0 K2 ["requestOptions"]
       29 GETTABLEKS                       R1 R1 K3 ["Url"]
       31 SETTABLEKS                       R1 R0 K4 ["url"]
       33 GETTABLEKS                       R1 R0 K2 ["requestOptions"]
       35 LOADNIL                          R2
       36 SETTABLEKS                       R2 R1 K4 ["url"]
       38 GETTABLEKS                       R1 R0 K2 ["requestOptions"]
       40 GETTABLEKS                       R1 R1 K4 ["url"]
       42 JUMPIFNOT                        R1 ; [+11]
       43 GETTABLEKS                       R1 R0 K2 ["requestOptions"]
       45 GETTABLEKS                       R1 R1 K4 ["url"]
       47 SETTABLEKS                       R1 R0 K4 ["url"]
       49 GETTABLEKS                       R1 R0 K2 ["requestOptions"]
       51 LOADNIL                          R2
       52 SETTABLEKS                       R2 R1 K4 ["url"]
       54 GETTABLEKS                       R1 R0 K2 ["requestOptions"]
       56 GETTABLEKS                       R1 R1 K5 ["Method"]
       58 JUMPIFNOT                        R1 ; [+11]
       59 GETTABLEKS                       R1 R0 K2 ["requestOptions"]
       61 GETTABLEKS                       R1 R1 K5 ["Method"]
       63 SETTABLEKS                       R1 R0 K6 ["requestType"]
       65 GETTABLEKS                       R1 R0 K2 ["requestOptions"]
       67 LOADNIL                          R2
       68 SETTABLEKS                       R2 R1 K5 ["Method"]
       70 GETTABLEKS                       R1 R0 K4 ["url"]
       72 GETTABLEKS                       R1 R1 K3 ["Url"]
       74 JUMPIFNOT                        R1 ; [+6]
       75 GETTABLEKS                       R1 R0 K4 ["url"]
       77 GETTABLEKS                       R1 R1 K3 ["Url"]
