...
PROTO_2:
       ...
       33 GETUPVAL                         R4 1
       34 GETTABLEKS                       R3 R4 K14 ["createContext"]
       36 NEWTABLE                         R4 0 0
       38 CALL                             R3 1 1
...
PROTO_3:
        ...
        3 GETTABLEKS                       R4 R0 K1 ["Context"]
        5 GETTABLEKS                       R3 R4 K2 ["Provider"]
...
PROTO_7:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R0 R1 K0 ["_updateSignal"]
        3 GETUPVAL                         R2 0
...
PROTO_8:
        ...
        1 JUMPIFNOT                        R1 ; [+9]
        2 GETUPVAL                         R2 0
        3 GETTABLEKS                       R1 R2 K0 ["verifyNewItem"]
        5 JUMPIFNOT                        R1 ; [+5]
        6 GETUPVAL                         R2 0
        7 GETTABLEKS                       R1 R2 K0 ["verifyNewItem"]
        9 MOVE                             R2 R0
       10 CALL                             R1 1 0
       ...
       21 JUMPIFNOT                        R2 ; [+9]
       22 GETUPVAL                         R3 0
       23 GETTABLEKS                       R2 R3 K5 ["getChangedSignal"]
       25 JUMPIFNOT                        R2 ; [+5]
       26 GETUPVAL                         R3 0
       27 GETTABLEKS                       R2 R3 K5 ["getChangedSignal"]
       29 MOVE                             R3 R0
       30 CALL                             R2 1 1
       31 JUMPIFNOT                        R2 ; [+13]
       32 GETUPVAL                         R4 2
       33 GETTABLEKS                       R3 R4 K6 ["new"]
       35 CALL                             R3 0 1
...
PROTO_9:
       ...
       12 JUMPIFNOT                        R1 ; [+10]
       13 GETUPVAL                         R2 0
       14 GETTABLEKS                       R1 R2 K2 ["destroy"]
       16 JUMPIFNOT                        R1 ; [+6]
       17 GETUPVAL                         R2 0
       18 GETTABLEKS                       R1 R2 K2 ["destroy"]
...
PROTO_12:
        ...
        1 JUMPIFNOT                        R2 ; [+11]
        2 GETUPVAL                         R3 0
        3 GETTABLEKS                       R2 R3 K0 ["getValues"]
        5 JUMPIFNOT                        R2 ; [+7]
        6 GETUPVAL                         R2 0
        7 GETTABLEKS                       R1 R2 K0 ["getValues"]
