PROTO_0:
      ...
      142 CALL                             R16 3 1
      143 GETUPVAL                         R17 12
      144 GETTABLEKS                       R17 R17 K24 ["scan"]
      146 MOVE                             R18 R16
      147 CALL                             R17 1 3
      148 FORGPREP                         R17
...
PROTO_4:
       ...
       14 GETUPVAL                         R5 1
       15 GETTABLEKS                       R5 R5 K4 ["TokenCache"]
       17 GETUPVAL                         R6 1
       18 GETTABLEKS                       R6 R6 K2 ["_RealIndex"]
       20 NEWTABLE                         R7 0 2
       22 MOVE                             R8 R3
       23 MOVE                             R9 R4
...
PROTO_6:
        ...
        6 GETUPVAL                         R0 0
        7 GETTABLEKS                       R0 R0 K2 ["_RealIndex"]
        9 GETUPVAL                         R1 0
       10 GETTABLEKS                       R1 R1 K0 ["_UserIndex"]
       12 JUMPIFNOTLE                      R1 R0 ; [+13]
       14 GETUPVAL                         R2 0
       15 GETTABLEKS                       R2 R2 K3 ["TokenCache"]
       17 GETUPVAL                         R3 0
       18 GETTABLEKS                       R3 R3 K0 ["_UserIndex"]
       ...
       28 GETUPVAL                         R1 0
       29 GETTABLEKS                       R1 R1 K10 ["_ScanThread"]
       31 CALL                             R0 1 1
       32 JUMPIFNOTEQKS                    R0 K11 ["dead"] ; [+2]
       34 RETURN                           R0 0
       35 GETIMPORT                        R0 K13 [coroutine.resume]
       37 GETUPVAL                         R1 0
       38 GETTABLEKS                       R1 R1 K10 ["_ScanThread"]
       40 CALL                             R0 1 3
       41 JUMPIFNOT                        R0 ; [+2]
       42 JUMPIFNOT                        R1 ; [+1]
       43 RETURN                           R1 2
...
PROTO_7:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R2 R2 K0 ["_UserIndex"]
        3 ADD                              R1 R2 R0
        4 GETUPVAL                         R2 0
        5 GETTABLEKS                       R2 R2 K1 ["_RealIndex"]
        7 JUMPIFNOTLE                      R1 R2 ; [+14]
        9 LOADN                            R2 0
       10 JUMPIFNOTLT                      R2 R1 ; [+10]
       12 GETUPVAL                         R4 0
       13 GETTABLEKS                       R4 R4 K2 ["TokenCache"]
       ...
       24 GETUPVAL                         R3 0
       25 GETTABLEKS                       R3 R3 K9 ["_ScanThread"]
       27 CALL                             R2 1 1
       28 JUMPIFNOTEQKS                    R2 K10 ["dead"] ; [+2]
       30 RETURN                           R0 0
       31 GETUPVAL                         R3 0
       32 GETTABLEKS                       R3 R3 K1 ["_RealIndex"]
       34 SUB                              R2 R1 R3
       35 LOADNIL                          R3
       36 LOADNIL                          R4
       37 LOADNIL                          R5
       ...
       44 GETUPVAL                         R10 0
       45 GETTABLEKS                       R10 R10 K9 ["_ScanThread"]
       47 CALL                             R9 1 3
       48 MOVE                             R3 R9
       49 MOVE                             R4 R10
       50 MOVE                             R5 R11
...
PROTO_8:
        0 DUPTABLE                         R0 K8 [{[1] = "", ["TokenCache"], ["_RealIndex"] = 0, ["_UserIndex"] = 0, ["_ScanThread"] = }]
        1 GETIMPORT                        R1 K11 [table.create]
        3 LOADN                            R2 50
        4 CALL                             R1 1 1
        5 SETTABLEKS                       R1 R0 K2 ["TokenCache"]
        7 DUPCLOSURE                       R1 K12 [PROTO_3]
        8 SETTABLEKS                       R1 R0 K13 ["Destroy"]
       10 DUPCLOSURE                       R1 K14 [PROTO_5]
       11 CAPTURE                          UPVAL U0
       12 SETTABLEKS                       R1 R0 K15 ["SetSource"]
       14 NEWCLOSURE                       R1 P2
       15 CAPTURE                          VAL R0
       16 SETTABLEKS                       R1 R0 K16 ["Next"]
       18 NEWCLOSURE                       R1 P3
       19 CAPTURE                          VAL R0
       20 SETTABLEKS                       R1 R0 K17 ["Peek"]
       22 RETURN                           R0 1
...
MAIN:
        ...
        7 GETTABLEKS                       R2 R2 K4 ["Language"]
        9 CALL                             R1 1 1
