...
local FFlagAudioAssetInsertUsesNewApiLua = require(Framework.SharedFlags.getFFlagAudioAssetInsertUsesNewApiLua)()
...
local CLASS_TO_TYPE = {
	...
	AudioPlayer = if FFlagAudioAssetInsertUsesNewApiLua then AssetRenderUtil.AssetRenderType.Sound else nil,
