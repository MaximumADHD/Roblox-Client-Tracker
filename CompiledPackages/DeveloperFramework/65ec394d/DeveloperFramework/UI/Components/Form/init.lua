...
local FFlagDevFrameworkFormHideHeader = require(Framework.SharedFlags.getFFlagDevFrameworkFormHideHeader)()
...
function Form:render()
	...
	for sectionOrder, section in props.Items do
		...
		local headerSize
		if FFlagDevFrameworkFormHideHeader then
			headerSize = if not section.Label then UDim2.new(1, 0, 0, 0) else nil
		end
