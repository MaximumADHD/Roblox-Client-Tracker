...
return function()
	...
	return {
		Basic = Roact.createElement(Pane, {
			Size = UDim2.new(0, 368, 0, 700),
		}, {
			AssetPreview = Roact.createElement(
				AssetPreview,
		...
		BasicNoDescription = Roact.createElement(Pane, {
			Size = UDim2.new(0, 368, 0, 700),
		}, {
			AssetPreview = Roact.createElement(
				AssetPreview,
		...
		BasicVideo = Roact.createElement(Pane, {
			Size = UDim2.new(0, 368, 0, 700),
		}, {
			AssetPreview = Roact.createElement(
				AssetPreview,
		...
		BasicWithISODates = Roact.createElement(Pane, {
			Size = UDim2.new(0, 368, 0, 700),
		}, {
			AssetPreview = Roact.createElement(
				AssetPreview,
		...
		BasicWithRawDates = Roact.createElement(Pane, {
			Size = UDim2.new(0, 368, 0, 700),
		}, {
			AssetPreview = Roact.createElement(
				AssetPreview,
		...
		BasicWithDescriptionLinks = Roact.createElement(Pane, {
			Size = UDim2.new(0, 368, 0, 700),
		}, {
			AssetPreview = Roact.createElement(
				AssetPreview,
				Cryo.Dictionary.join(props, {
					...
					AssetData = Cryo.Dictionary.join(props.AssetData, {
						Asset = Cryo.Dictionary.join(props.AssetData.Asset, {
							Description = "See the web marketplace at https://create.roblox.com/marketplace",
						}),
					}),
				})
			),
		...
		NoVoting = Roact.createElement(Pane, {
			Size = UDim2.new(0, 368, 0, 700),
		}, {
			AssetPreview = Roact.createElement(
				AssetPreview,
		...
		Scrolling = Roact.createElement(Pane, {
		...
		FontFamily = Roact.createElement(Pane, {
			Size = UDim2.new(0, 368, 0, 700),
		}, {
			AssetPreview = Roact.createElement(
				AssetPreview,
				Cryo.Dictionary.join(props, {
					...
					AssetData = Cryo.Dictionary.join(props.AssetData, {
						Asset = Cryo.Dictionary.join(props.AssetData.Asset, {
							Id = 8836875837,
							TypeId = Enum.AssetType.FontFamily.Value,
						}),
					}),
				})
			),
		...
		Narrow = Roact.createElement(Pane, {
