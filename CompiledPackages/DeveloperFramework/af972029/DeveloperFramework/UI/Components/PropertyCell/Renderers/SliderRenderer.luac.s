PROTO_0:
        ...
        5 GETUPVAL                         R3 1
        6 GETUPVAL                         R4 2
        7 DUPTABLE                         R5 K14 [{["Disabled"], ["Max"], ["Min"], ["OnValueChanged"], ["Size"], ["CustomValidation"], ["ShowInput"], ["SnapIncrement"], ["StyleModifier"], ["VerticalDragTolerance"] = 0, ["Value"]}]
       ...
       20 GETTABLEKS                       R6 R0 K15 ["OnChanged"]
       22 SETTABLEKS                       R6 R5 K5 ["OnValueChanged"]
       24 GETTABLEKS                       R7 R0 K16 ["AutomaticSize"]
       26 JUMPIFNOT                        R7 ; [+10]
       27 GETIMPORT                        R6 K19 [UDim2.new]
       29 LOADN                            R7 1
       30 LOADN                            R8 0
       31 LOADN                            R9 0
       32 GETTABLEKS                       R11 R0 K21 ["MinimumHeight"]
       34 ORK                              R10 R11 K20 [24]
       35 CALL                             R6 4 1
       36 JUMP                             ; [+5]
       37 GETIMPORT                        R6 K23 [UDim2.fromScale]
       39 LOADN                            R7 1
       40 LOADN                            R8 1
       41 CALL                             R6 2 1
       ...
       56 GETUPVAL                         R7 3
       57 JUMPIF                           R7 ; [+7]
       58 GETTABLEKS                       R7 R0 K24 ["HasError"]
       60 JUMPIFNOT                        R7 ; [+4]
       61 GETUPVAL                         R6 4
       62 GETTABLEKS                       R6 R6 K25 ["Error"]
       64 JUMP                             ; [+1]
       65 LOADNIL                          R6
       66 SETTABLEKS                       R6 R5 K10 ["StyleModifier"]
       68 GETTABLEKS                       R6 R0 K13 ["Value"]
       70 SETTABLEKS                       R6 R5 K13 ["Value"]
       72 GETUPVAL                         R7 3
       73 JUMPIFNOT                        R7 ; [+14]
       74 NEWTABLE                         R6 1 0
       76 GETUPVAL                         R7 5
       77 GETTABLEKS                       R7 R7 K26 ["Tag"]
       79 GETTABLEKS                       R9 R0 K24 ["HasError"]
       81 JUMPIFNOT                        R9 ; [+3]
       82 GETTABLEKS                       R8 R1 K27 ["ErrorStyle"]
       84 JUMP                             ; [+1]
       85 LOADNIL                          R8
