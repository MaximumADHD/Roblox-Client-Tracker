...
PROTO_2:
       ...
       70 GETUPVAL                         R17 4
       71 DUPTABLE                         R18 K21 [{["Cursor"] = "PointingHand"}]
       72 CALL                             R16 2 1
       73 JUMPIF                           R16 ; [+1]
       74 LOADNIL                          R16
       75 SETTABLEKS                       R16 R15 K17 ["PointingHand"]
       77 GETUPVAL                         R18 2
       78 GETTABLEKS                       R18 R18 K22 ["Children"]
       80 GETTABLE                         R17 R1 R18
       81 JUMPIFNOT                        R17 ; [+7]
       82 GETUPVAL                         R17 2
       83 GETTABLEKS                       R17 R17 K22 ["Children"]
       85 GETTABLE                         R16 R1 R17
       86 GETTABLEKS                       R16 R16 K18 ["TeachingCallout"]
       88 JUMP                             ; [+1]
       89 LOADNIL                          R16
       90 SETTABLEKS                       R16 R15 K18 ["TeachingCallout"]
       92 CALL                             R12 3 -1
       93 RETURN                           R12 -1
...
MAIN:
       ...
       75 CALL                             R10 2 0
       76 DUPTABLE                         R10 K26 [{["Disabled"] = False, ["Selected"] = False, ["Text"] = ""}]
       77 SETTABLEKS                       R10 R9 K27 ["defaultProps"]
       79 DUPCLOSURE                       R10 K28 [PROTO_1]
       80 SETTABLEKS                       R10 R9 K29 ["init"]
       82 DUPCLOSURE                       R10 K30 [PROTO_2]
       83 CAPTURE                          VAL R4
       84 CAPTURE                          VAL R5
       85 CAPTURE                          VAL R1
       86 CAPTURE                          VAL R7
       87 CAPTURE                          VAL R8
       88 SETTABLEKS                       R10 R9 K31 ["render"]
       90 MOVE                             R10 R3
       91 DUPTABLE                         R11 K33 [{"Stylizer"}]
       92 GETTABLEKS                       R12 R2 K32 ["Stylizer"]
       94 SETTABLEKS                       R12 R11 K32 ["Stylizer"]
       96 CALL                             R10 1 1
       97 MOVE                             R11 R9
       98 CALL                             R10 1 1
       99 MOVE                             R9 R10
