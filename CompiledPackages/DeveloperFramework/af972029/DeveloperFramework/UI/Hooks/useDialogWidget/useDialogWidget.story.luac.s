...
PROTO_3:
       ...
       58 LOADK                            R12 K28 ["%* Dialog Widget"]
       59 JUMPIFNOT                        R4 ; [+2]
       60 LOADK                            R14 K29 ["Hide"]
       61 JUMP                             ; [+1]
       62 LOADK                            R14 K30 ["Show"]
       63 NAMECALL                         R12 R12 K31 ["format"]
       65 CALL                             R12 2 1
       66 SETTABLEKS                       R12 R11 K9 ["Text"]
       68 CALL                             R9 2 1
       69 SETTABLEKS                       R9 R8 K23 ["ShowToggle"]
       71 GETUPVAL                         R9 0
       72 GETTABLEKS                       R9 R9 K5 ["createElement"]
       74 GETUPVAL                         R10 2
       75 DUPTABLE                         R11 K27 [{"OnClick", "Text"}]
       76 NEWCLOSURE                       R12 P1
       77 CAPTURE                          VAL R1
       78 SETTABLEKS                       R12 R11 K26 ["OnClick"]
       80 LOADK                            R12 K32 ["Modal: %*"]
       81 JUMPIFNOT                        R0 ; [+2]
       82 LOADK                            R14 K33 ["ON"]
       83 JUMP                             ; [+1]
       84 LOADK                            R14 K34 ["OFF"]
       85 NAMECALL                         R12 R12 K31 ["format"]
       87 CALL                             R12 2 1
       88 SETTABLEKS                       R12 R11 K9 ["Text"]
       90 CALL                             R9 2 1
       91 SETTABLEKS                       R9 R8 K24 ["ModalToggle"]
       93 CALL                             R5 3 -1
       94 RETURN                           R5 -1
