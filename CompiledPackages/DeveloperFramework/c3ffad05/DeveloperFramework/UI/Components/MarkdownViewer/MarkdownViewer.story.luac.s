...
PROTO_1:
       ...
       19 GETUPVAL                         R6 1
       20 DUPTABLE                         R7 K13 [{["MultiLine"] = True, ["OnTextChanged"], ["Text"], ["Size"], ["LayoutOrder"] = 1}]
       21 SETTABLEKS                       R1 R7 K8 ["OnTextChanged"]
       23 SETTABLEKS                       R0 R7 K9 ["Text"]
       25 GETIMPORT                        R8 K16 [UDim2.new]
       27 LOADN                            R9 1
       28 LOADN                            R10 0
       29 LOADN                            R11 0
       30 LOADN                            R12 200
       ...
       35 GETUPVAL                         R6 2
       36 MOVE                             R7 R0
       37 DUPTABLE                         R8 K18 [{["LayoutOrder"] = 2}]
       38 CALL                             R6 2 -1
       39 CALL                             R2 -1 -1
       40 RETURN                           R2 -1
...
PROTO_5:
        ...
        5 GETUPVAL                         R2 2
        6 DUPTABLE                         R3 K4 [{["Markdown"] = "Lua code block:\n\n```lua\n-- factorial function\nfunction fact(n)\n  if n == 0 then\n    return 1\n  else\n    return n * fact(n-1)\n  end\nend\n\nprint(\"enter a number:\")\na = io.read(\"*number\")\nprint(fact(a))\n```\n\nNon-lua code block:\n\n```ruby\nclass Integer\n  def fact\n    (1..self).reduce(:*) || 1\n  end\nend\n```\n", ["ColorScheme"]}]
        7 SETTABLEKS                       R0 R3 K3 ["ColorScheme"]
        9 CALL                             R1 2 -1
       10 RETURN                           R1 -1
...
PROTO_7:
        0 DUPTABLE                         R0 K3 [{[1], ["BackgroundTransparency"] = 0}]
        1 GETIMPORT                        R1 K6 [Color3.fromRGB]
        3 LOADN                            R2 34
        4 LOADN                            R3 87
        5 LOADN                            R4 122
        6 CALL                             R1 3 1
        ...
        9 GETUPVAL                         R1 0
       10 GETTABLEKS                       R1 R1 K7 ["createElement"]
       12 GETUPVAL                         R2 1
       13 DUPTABLE                         R3 K11 [{["Markdown"] = "You can customize or position the MarkdownViewer's container by passing a `WrapperProps` prop. For example, this story uses the following properties:\n```lua\n{\n\tBackgroundColor3 = Color3.fromRGB(34, 87, 122),\n\tBackgroundTransparency = 0\n}\n```\nYou can pass any properties that Frame supports.\n", ["WrapperProps"]}]
       14 SETTABLEKS                       R0 R3 K10 ["WrapperProps"]
       16 CALL                             R1 2 -1
       17 RETURN                           R1 -1
...
PROTO_9:
        0 DUPTABLE                         R0 K3 [{[1] = 20, ["font"]}]
        1 GETIMPORT                        R1 K7 [Enum.Font.Fondamento]
        3 SETTABLEKS                       R1 R0 K2 ["font"]
        5 GETUPVAL                         R1 0
        6 GETTABLEKS                       R1 R1 K8 ["createElement"]
        8 GETUPVAL                         R2 1
        9 DUPTABLE                         R3 K12 [{["Markdown"] = "You can customize the text style by passing a `MarkdownRendererProps` prop. For example, this story uses the following properties:\n```lua\n{\n\ttextSize = 20,\n\tfont = Enum.Font.Fondamento,\n}\n```\n", ["MarkdownRendererProps"]}]
       10 SETTABLEKS                       R0 R3 K11 ["MarkdownRendererProps"]
       12 CALL                             R1 2 -1
       13 RETURN                           R1 -1
...
PROTO_12:
       ...
       13 GETUPVAL                         R2 1
       14 DUPTABLE                         R3 K9 [{["Markdown"] = "You can include inline images using the normal markdown syntax: ![Image](rbxasset://textures/ui/common/robux_color@2x.png)\n\nImage can be added via `img` tag with the `src` attribute. Optionally, you can specify `width` and `height` attributes:\n\n<img src=\"rbxasset://textures/ui/common/robux_color@2x.png\" width=\"100\" height=\"100\">\n", ["MarkdownRendererProps"]}]
       15 SETTABLEKS                       R0 R3 K8 ["MarkdownRendererProps"]
       17 CALL                             R1 2 -1
       18 RETURN                           R1 -1
...
MAIN:
      ...
      108 DUPTABLE                         R16 K42 [{["name"] = "Custom text", ["story"]}]
      109 SETTABLEKS                       R7 R16 K41 ["story"]
      111 DUPTABLE                         R17 K44 [{["name"] = "Rich text", ["story"]}]
      112 SETTABLEKS                       R8 R17 K41 ["story"]
      114 DUPTABLE                         R18 K46 [{["name"] = "Headings", ["story"]}]
      115 SETTABLEKS                       R9 R18 K41 ["story"]
      117 DUPTABLE                         R19 K48 [{["name"] = "Paragraphs", ["story"]}]
      118 SETTABLEKS                       R10 R19 K41 ["story"]
      120 DUPTABLE                         R20 K50 [{["name"] = "Code", ["story"]}]
      121 SETTABLEKS                       R11 R20 K41 ["story"]
      123 DUPTABLE                         R21 K52 [{["name"] = "List", ["story"]}]
      124 SETTABLEKS                       R12 R21 K41 ["story"]
      126 DUPTABLE                         R22 K54 [{["name"] = "Customization", ["story"]}]
      127 SETTABLEKS                       R13 R22 K41 ["story"]
      129 DUPTABLE                         R23 K56 [{["name"] = "Ruler", ["story"]}]
      130 GETGLOBAL                        R24 K24 ["rulerStory"]
      132 SETTABLEKS                       R24 R23 K41 ["story"]
      134 DUPTABLE                         R24 K58 [{["name"] = "With MarkdownRendererProps", ["story"]}]
      135 GETGLOBAL                        R25 K26 ["withMarkdownRendererPropsStory"]
      137 SETTABLEKS                       R25 R24 K41 ["story"]
      139 DUPTABLE                         R25 K60 [{["name"] = "With a custom codeblock color scheme", ["story"]}]
      140 GETGLOBAL                        R26 K28 ["customCodeColorsStory"]
      142 SETTABLEKS                       R26 R25 K41 ["story"]
      144 DUPTABLE                         R26 K62 [{["name"] = "Quote", ["story"]}]
      145 GETGLOBAL                        R27 K30 ["quoteStory"]
      147 SETTABLEKS                       R27 R26 K41 ["story"]
      149 DUPTABLE                         R27 K64 [{["name"] = "Image", ["story"]}]
      150 GETGLOBAL                        R28 K32 ["imageStory"]
      152 SETTABLEKS                       R28 R27 K41 ["story"]
      154 DUPTABLE                         R28 K66 [{["name"] = "Line Breaks", ["story"]}]
      155 GETGLOBAL                        R29 K34 ["lineBreaksStory"]
      157 SETTABLEKS                       R29 R28 K41 ["story"]
      159 DUPTABLE                         R29 K68 [{["name"] = "Action button", ["story"]}]
      160 GETGLOBAL                        R30 K36 ["actionButtonStory"]
      162 SETTABLEKS                       R30 R29 K41 ["story"]
      164 SETLIST                          R15 R16 14 [1]
      166 SETTABLEKS                       R15 R14 K37 ["stories"]
      168 RETURN                           R14 1
