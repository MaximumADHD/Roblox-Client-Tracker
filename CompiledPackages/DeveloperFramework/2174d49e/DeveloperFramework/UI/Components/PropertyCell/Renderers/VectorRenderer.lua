...
local getFFlagDevFrameworkVectorRendererSize = require(Framework.SharedFlags.getFFlagDevFrameworkVectorRendererSize)
...
local function VectorRenderer(props: Props)
	...
	elseif layout == Enum.FillDirection.Vertical then
		...
		size = if getFFlagDevFrameworkVectorRendererSize() then UDim2.fromOffset(54, 24) else UDim2.fromOffset(40, 24)
	end
