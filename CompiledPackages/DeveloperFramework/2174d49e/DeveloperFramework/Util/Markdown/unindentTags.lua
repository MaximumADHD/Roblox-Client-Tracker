...
local function unindentTags(source: string, configuredIndentSize: number?): string
	local indentSize = configuredIndentSize or 2
	...
	for _, line in lines do
		local _, indentEnd = string.find(line, "^[ \t]*")
		local indent = indentEnd or 0
