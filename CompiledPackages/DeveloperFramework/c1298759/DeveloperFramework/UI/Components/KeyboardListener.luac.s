PROTO_0:
        ...
        6 GETUPVAL                         R3 0
        7 GETTABLEKS                       R2 R3 K4 ["keysHeld"]
        9 GETTABLEKS                       R3 R1 K5 ["KeyCode"]
       11 LOADB                            R4 1
       12 SETTABLE                         R4 R2 R3
       13 GETUPVAL                         R4 0
       14 GETTABLEKS                       R3 R4 K6 ["props"]
       16 GETTABLEKS                       R2 R3 K7 ["OnKeyPressed"]
       18 JUMPIFNOT                        R2 ; [+10]
       19 GETUPVAL                         R4 0
       20 GETTABLEKS                       R3 R4 K6 ["props"]
       22 GETTABLEKS                       R2 R3 K7 ["OnKeyPressed"]
       24 MOVE                             R3 R1
       25 GETUPVAL                         R5 0
       26 GETTABLEKS                       R4 R5 K4 ["keysHeld"]
       28 CALL                             R2 2 0
       29 RETURN                           R0 0
...
PROTO_1:
       ...
       13 GETUPVAL                         R4 0
       14 GETTABLEKS                       R3 R4 K6 ["props"]
       16 GETTABLEKS                       R2 R3 K7 ["OnKeyReleased"]
       18 JUMPIFNOT                        R2 ; [+7]
       19 GETUPVAL                         R4 0
       20 GETTABLEKS                       R3 R4 K6 ["props"]
       22 GETTABLEKS                       R2 R3 K7 ["OnKeyReleased"]
       24 MOVE                             R3 R1
       25 CALL                             R2 1 0
       26 RETURN                           R0 0
...
PROTO_3:
        ...
        3 GETTABLEKS                       R0 R1 K1 ["OnKeyReleased"]
        5 JUMPIFNOT                        R0 ; [+20]
        6 GETIMPORT                        R0 K3 [pairs]
        8 GETUPVAL                         R3 0
        9 GETTABLEKS                       R1 R3 K4 ["keysHeld"]
       11 CALL                             R0 1 3
       12 FORGPREP_NEXT                    R0
       13 GETUPVAL                         R6 1
       14 GETTABLEKS                       R5 R6 K1 ["OnKeyReleased"]
...
PROTO_4:
       ...
       18 CALL                             R2 2 1
       19 JUMPIFNOT                        R2 ; [+12]
       20 GETTABLEKS                       R3 R0 K4 ["target"]
       22 GETTABLEKS                       R2 R3 K7 ["WindowFocusReleased"]
       24 NEWCLOSURE                       R4 P0
       25 CAPTURE                          VAL R0
       26 CAPTURE                          VAL R1
...
PROTO_5:
       ...
       25 GETUPVAL                         R10 0
       26 GETTABLEKS                       R9 R10 K9 ["Event"]
       28 GETTABLEKS                       R8 R9 K10 ["InputBegan"]
       30 GETTABLEKS                       R9 R0 K11 ["onInputBegan"]
       32 SETTABLE                         R9 R7 R8
       33 GETUPVAL                         R10 0
       34 GETTABLEKS                       R9 R10 K9 ["Event"]
       36 GETTABLEKS                       R8 R9 K12 ["InputEnded"]
...
MAIN:
       ...
       38 GETTABLEKS                       R6 R7 K13 ["ShowOnTop"]
       40 CALL                             R5 1 1
