...
PROTO_4:
        ...
        3 JUMPIFNOTEQKS                    R0 K1 ["Default"] ; [+16]
        5 GETUPVAL                         R1 1
        6 JUMPIFNOT                        R1 ; [+3]
        7 GETUPVAL                         R0 2
        8 CALL                             R0 0 1
...
PROTO_5:
       ...
       35 GETUPVAL                         R13 0
       36 GETTABLEKS                       R12 R13 K14 ["getThemeName"]
       38 CALL                             R12 0 -1
...
PROTO_6:
       ...
       12 JUMPIFNOT                        R1 ; [+9]
       13 GETUPVAL                         R6 1
       14 GETTABLEKS                       R5 R6 K0 ["Dictionary"]
       16 GETTABLEKS                       R4 R5 K1 ["join"]
       18 GETUPVAL                         R5 2
       19 MOVE                             R6 R1
       20 CALL                             R4 2 1
       21 MOVE                             R3 R4
       22 GETUPVAL                         R6 1
       23 GETTABLEKS                       R5 R6 K0 ["Dictionary"]
       25 GETTABLEKS                       R4 R5 K1 ["join"]
       ...
       43 CALL                             R5 1 1
       44 GETUPVAL                         R7 4
       45 GETTABLEKS                       R6 R7 K7 ["setTheme"]
       47 GETUPVAL                         R8 4
...
MAIN:
       ...
       18 GETTABLEKS                       R3 R4 K7 ["Signal"]
       20 CALL                             R2 1 1
       21 GETTABLEKS                       R3 R0 K8 ["Style"]
       23 GETIMPORT                        R4 K4 [require]
       25 GETTABLEKS                       R6 R3 K9 ["Themes"]
       27 GETTABLEKS                       R5 R6 K10 ["DarkTheme"]
       29 CALL                             R4 1 1
       30 GETIMPORT                        R5 K4 [require]
       32 GETTABLEKS                       R7 R3 K9 ["Themes"]
       34 GETTABLEKS                       R6 R7 K11 ["LightTheme"]
       36 CALL                             R5 1 1
       ...
       49 GETTABLEKS                       R10 R0 K14 ["SharedFlags"]
       51 GETTABLEKS                       R9 R10 K15 ["getFFlagDevFrameworkSettingsCliFix"]
       53 CALL                             R8 1 1
       54 CALL                             R8 0 1
