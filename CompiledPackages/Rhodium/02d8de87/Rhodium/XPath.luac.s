...
PROTO_4:
       ...
       60 CALL                             R3 1 1
       61 JUMPIFNOTEQKS                    R3 K20 ["table"] ; [+12]
       63 GETTABLEKS                       R3 R0 K24 ["__type"]
       65 GETUPVAL                         R4 0
       66 GETTABLEKS                       R4 R4 K24 ["__type"]
       68 JUMPIFNOTEQ                      R3 R4 ; [+5]
       70 NAMECALL                         R3 R0 K25 ["copy"]
       72 CALL                             R3 1 -1
       73 RETURN                           R3 -1
       74 GETIMPORT                        R3 K27 [error]
       76 GETIMPORT                        R4 K29 [string.format]
       78 LOADK                            R5 K30 ["unknown parameter %s"]
       79 FASTCALL1                        TOSTRING R0 ; [+3]
       80 MOVE                             R7 R0
       81 GETIMPORT                        R6 K32 [tostring]
       83 CALL                             R6 1 1
       84 CALL                             R4 2 -1
       85 CALL                             R3 -1 0
       86 RETURN                           R2 1
...
MAIN:
        0 PREPVARARGS                      0
        1 DUPTABLE                         R0 K2 [{[1] = "XPath"}]
        2 SETTABLEKS                       R0 R0 K3 ["__index"]
        4 NEWTABLE                         R1 0 0
        6 LOADN                            R4 1
        7 LOADN                            R2 6
        8 LOADN                            R3 1
       ...
       11 MOVE                             R7 R4
       12 MOVE                             R8 R4
       13 NAMECALL                         R5 R5 K5 ["sub"]
       15 CALL                             R5 3 1
       16 LOADB                            R6 1
       17 SETTABLE                         R6 R1 R5
       18 FORNLOOP                         R2
       19 DUPCLOSURE                       R2 K6 [PROTO_0]
       20 CAPTURE                          VAL R1
       21 SETTABLEKS                       R2 R0 K7 ["addSlash"]
       23 DUPCLOSURE                       R2 K8 [PROTO_1]
       24 SETTABLEKS                       R2 R0 K9 ["removeSlash"]
       26 DUPCLOSURE                       R2 K10 [PROTO_2]
       27 DUPCLOSURE                       R3 K11 [PROTO_3]
       28 CAPTURE                          VAL R3
       29 DUPCLOSURE                       R4 K12 [PROTO_4]
       30 CAPTURE                          VAL R0
       31 SETTABLEKS                       R4 R0 K13 ["new"]
       33 DUPCLOSURE                       R4 K14 [PROTO_5]
       34 SETTABLEKS                       R4 R0 K15 ["size"]
       36 DUPCLOSURE                       R4 K16 [PROTO_6]
       37 SETTABLEKS                       R4 R0 K17 ["mergeFilter"]
       39 DUPCLOSURE                       R4 K18 [PROTO_7]
       40 CAPTURE                          VAL R0
       41 CAPTURE                          VAL R2
       42 SETTABLEKS                       R4 R0 K19 ["fromString"]
       44 DUPCLOSURE                       R4 K20 [PROTO_8]
       45 CAPTURE                          VAL R3
       46 CAPTURE                          VAL R0
       47 SETTABLEKS                       R4 R0 K21 ["copy"]
       49 DUPCLOSURE                       R4 K22 [PROTO_9]
       50 SETTABLEKS                       R4 R0 K23 ["parent"]
       52 DUPCLOSURE                       R4 K24 [PROTO_10]
       53 CAPTURE                          VAL R0
       54 SETTABLEKS                       R4 R0 K25 ["_itemToString"]
       56 DUPCLOSURE                       R4 K26 [PROTO_11]
       57 SETTABLEKS                       R4 R0 K27 ["toString"]
       59 DUPCLOSURE                       R4 K28 [PROTO_12]
       60 SETTABLEKS                       R4 R0 K29 ["hasChild"]
       62 DUPCLOSURE                       R4 K30 [PROTO_13]
       63 SETTABLEKS                       R4 R0 K31 ["relative"]
       65 DUPCLOSURE                       R4 K32 [PROTO_14]
       66 CAPTURE                          VAL R0
       67 SETTABLEKS                       R4 R0 K33 ["cat"]
       69 DUPCLOSURE                       R4 K34 [PROTO_15]
       70 SETTABLEKS                       R4 R0 K35 ["clearFilter"]
       72 DUPCLOSURE                       R4 K36 [PROTO_17]
       73 DUPCLOSURE                       R5 K37 [PROTO_18]
       74 DUPCLOSURE                       R6 K38 [PROTO_19]
       75 DUPCLOSURE                       R7 K39 [PROTO_20]
       76 CAPTURE                          VAL R6
       77 DUPCLOSURE                       R8 K40 [PROTO_21]
       78 CAPTURE                          VAL R7
       79 DUPCLOSURE                       R9 K41 [PROTO_22]
       80 CAPTURE                          VAL R2
       81 CAPTURE                          VAL R0
       82 CAPTURE                          VAL R7
       83 DUPCLOSURE                       R10 K42 [PROTO_23]
       84 CAPTURE                          VAL R9
       85 DUPCLOSURE                       R11 K43 [PROTO_24]
       86 CAPTURE                          VAL R10
       87 DUPCLOSURE                       R12 K44 [PROTO_25]
       88 SETTABLEKS                       R12 R0 K45 ["getFirstInstance"]
       90 DUPCLOSURE                       R12 K46 [PROTO_26]
       91 CAPTURE                          VAL R7
       92 CAPTURE                          VAL R11
       93 SETTABLEKS                       R12 R0 K47 ["getInstances"]
       95 DUPCLOSURE                       R12 K48 [PROTO_27]
       96 SETTABLEKS                       R12 R0 K49 ["setWait"]
       98 DUPCLOSURE                       R12 K50 [PROTO_28]
       99 SETTABLEKS                       R12 R0 K51 ["waitFor"]
      101 DUPCLOSURE                       R12 K52 [PROTO_29]
      102 SETTABLEKS                       R12 R0 K53 ["waitForFirstInstance"]
      104 DUPCLOSURE                       R12 K54 [PROTO_31]
      105 SETTABLEKS                       R12 R0 K55 ["waitForInstances"]
      107 DUPCLOSURE                       R12 K56 [PROTO_33]
      108 SETTABLEKS                       R12 R0 K57 ["waitForDisappear"]
      110 DUPCLOSURE                       R12 K58 [PROTO_35]
      111 SETTABLEKS                       R12 R0 K59 ["waitForNInstances"]
      113 RETURN                           R0 1
