PROTO_0:
        ...
        5 CALL                             R5 2 2
        6 GETUPVAL                         R7 0
        7 GETTABLEKS                       R7 R7 K1 ["getCurrentWindow"]
        9 CALL                             R7 0 1
       10 GETUPVAL                         R8 1
       11 MOVE                             R10 R5
       12 MOVE                             R11 R6
...
PROTO_1:
        ...
        5 CALL                             R2 2 2
        6 GETUPVAL                         R4 0
        7 GETTABLEKS                       R4 R4 K1 ["getCurrentWindow"]
        9 CALL                             R4 0 1
       10 GETUPVAL                         R5 1
       11 MOVE                             R7 R2
       12 MOVE                             R8 R3
...
PROTO_2:
        ...
        5 CALL                             R3 2 2
        6 GETUPVAL                         R5 0
        7 GETTABLEKS                       R5 R5 K1 ["getCurrentWindow"]
        9 CALL                             R5 0 1
       10 GETUPVAL                         R6 1
       11 MOVE                             R8 R3
       12 MOVE                             R9 R4
...
PROTO_4:
       ...
       19 CALL                             R3 5 0
       20 GETUPVAL                         R3 1
       21 GETTABLEKS                       R3 R3 K5 ["waitForInputEventsProcessed"]
       23 CALL                             R3 0 0
       24 GETUPVAL                         R3 2
       25 GETTABLEKS                       R3 R3 K2 ["sendMouseButtonEvent"]
       ...
       34 CALL                             R3 5 0
       35 GETUPVAL                         R3 1
       36 GETTABLEKS                       R3 R3 K5 ["waitForInputEventsProcessed"]
       38 CALL                             R3 0 0
       39 RETURN                           R0 0
