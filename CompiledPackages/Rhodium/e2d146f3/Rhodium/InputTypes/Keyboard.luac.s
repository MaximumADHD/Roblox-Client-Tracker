PROTO_0:
        0 GETUPVAL                         R3 0
        1 GETTABLEKS                       R3 R3 K0 ["getCurrentWindow"]
        3 CALL                             R3 0 1
        4 GETUPVAL                         R4 1
        5 MOVE                             R6 R0
        6 MOVE                             R7 R1
...
PROTO_1:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["SendKeyEvent"]
        3 LOADB                            R2 1
        4 MOVE                             R3 R0
        5 LOADB                            R4 0
        6 CALL                             R1 3 0
...
PROTO_3:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["pressKey"]
        3 MOVE                             R2 R0
        4 CALL                             R1 1 0
        5 GETUPVAL                         R1 1
        6 GETTABLEKS                       R1 R1 K1 ["waitForInputEventsProcessed"]
        8 CALL                             R1 0 0
        9 GETUPVAL                         R1 0
       10 GETTABLEKS                       R1 R1 K2 ["releaseKey"]
       12 MOVE                             R2 R0
       13 CALL                             R1 1 0
       14 GETUPVAL                         R1 1
       15 GETTABLEKS                       R1 R1 K1 ["waitForInputEventsProcessed"]
       17 CALL                             R1 0 0
       18 RETURN                           R0 0
