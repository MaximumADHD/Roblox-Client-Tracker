...
PROTO_7:
       ...
       54 CALL                             R4 2 -1
       55 CALL                             R3 -1 0
       56 DUPTABLE                         R4 K19 [{"path", "rbxInstance", "isInScrollingFrame", "anchor"}]
       57 SETTABLEKS                       R1 R4 K15 ["path"]
       59 SETTABLEKS                       R2 R4 K16 ["rbxInstance"]
       61 MOVE                             R7 R2
       62 JUMPIFNOT                        R7 ; [+16]
       63 GETIMPORT                        R8 K21 [game]
       65 JUMPIFEQ                         R7 R8 ; [+13]
       67 GETUPVAL                         R8 1
       68 GETTABLEKS                       R9 R7 K22 ["Parent"]
       70 CALL                             R8 1 1
       71 LOADK                            R11 K23 ["ScrollingFrame"]
       72 NAMECALL                         R9 R7 K24 ["IsA"]
       74 CALL                             R9 2 1
       75 JUMPIFNOT                        R9 ; [+1]
       76 ADDK                             R8 R8 K25 [1]
       77 MOVE                             R6 R8
       ...
       79 LOADN                            R6 0
       80 JUMP                             ; [0]
       81 JUMPIFNOTEQKN                    R6 K26 [0] ; [+2]
       83 LOADB                            R5 0 +1
       84 LOADB                            R5 1
       85 SETTABLEKS                       R5 R4 K17 ["isInScrollingFrame"]
       87 LOADNIL                          R5
       88 SETTABLEKS                       R5 R4 K18 ["anchor"]
       90 GETUPVAL                         R5 2
       91 FASTCALL2                        SETMETATABLE R4 R5 ; [+3]
...
PROTO_11:
       ...
       21 CALL                             R4 -1 0
       22 GETUPVAL                         R6 1
       23 GETTABLEKS                       R5 R6 K11 ["Mouse"]
       25 GETTABLEKS                       R4 R5 K12 ["SendMouseMoveEvent"]
       27 GETTABLEKS                       R5 R2 K13 ["X"]
       29 GETTABLEKS                       R6 R2 K14 ["Y"]
       31 CALL                             R4 2 0
       32 GETUPVAL                         R5 2
       33 GETTABLEKS                       R4 R5 K15 ["waitForInputEventsProcessed"]
       35 CALL                             R4 0 0
...
PROTO_35:
        ...
        6 CALL                             R1 2 1
        7 GETUPVAL                         R3 0
        8 GETTABLEKS                       R2 R3 K3 ["setCurrentWindow"]
       10 MOVE                             R3 R1
       11 CALL                             R2 1 0
       12 RETURN                           R0 0
...
PROTO_36:
        ...
        5 CALL                             R2 1 1
        6 GETUPVAL                         R4 0
        7 GETTABLEKS                       R3 R4 K2 ["waitForInputEventsProcessed"]
        9 CALL                             R3 0 0
       10 GETUPVAL                         R3 1
       11 MOVE                             R4 R2
       12 MOVE                             R5 R1
