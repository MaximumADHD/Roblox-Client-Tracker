PROTO_0:
        ...
        3 GETUPVAL                         R2 1
        4 GETTABLEKS                       R1 R2 K1 ["__DEV__"]
        6 JUMPIFNOT                        R1 ; [+7]
        7 JUMPIFNOTEQKNIL                  R0 ; [+6]
        9 GETUPVAL                         R2 2
       10 GETTABLEKS                       R1 R2 K2 ["error"]
...
PROTO_1:
        ...
        4 GETUPVAL                         R5 1
        5 GETTABLEKS                       R4 R5 K1 ["__DEV__"]
        7 JUMPIFNOT                        R4 ; [+7]
        8 JUMPIFNOTEQKNIL                  R3 ; [+6]
       10 GETUPVAL                         R5 2
       11 GETTABLEKS                       R4 R5 K2 ["error"]
       ...
       15 MOVE                             R2 R3
       16 GETUPVAL                         R4 1
       17 GETTABLEKS                       R3 R4 K1 ["__DEV__"]
       19 JUMPIFNOT                        R3 ; [+53]
       20 JUMPIFEQKNIL                     R1 ; [+27]
       22 GETUPVAL                         R4 2
       23 GETTABLEKS                       R3 R4 K2 ["error"]
       ...
       34 GETUPVAL                         R8 3
       35 GETTABLEKS                       R7 R8 K8 ["isArray"]
       37 NEWTABLE                         R8 0 0
       39 GETVARARGS                       R9 -1
...
PROTO_2:
        ...
        4 GETUPVAL                         R4 1
        5 GETTABLEKS                       R3 R4 K1 ["__DEV__"]
        7 JUMPIFNOT                        R3 ; [+7]
        8 JUMPIFNOTEQKNIL                  R2 ; [+6]
       10 GETUPVAL                         R4 2
       11 GETTABLEKS                       R3 R4 K2 ["error"]
...
PROTO_3:
        ...
        3 GETUPVAL                         R6 1
        4 GETTABLEKS                       R5 R6 K1 ["__DEV__"]
        6 JUMPIFNOT                        R5 ; [+7]
        7 JUMPIFNOTEQKNIL                  R4 ; [+6]
        9 GETUPVAL                         R6 2
       10 GETTABLEKS                       R5 R6 K2 ["error"]
...
PROTO_4:
        ...
        3 GETUPVAL                         R4 1
        4 GETTABLEKS                       R3 R4 K1 ["__DEV__"]
        6 JUMPIFNOT                        R3 ; [+7]
        7 JUMPIFNOTEQKNIL                  R2 ; [+6]
        9 GETUPVAL                         R4 2
       10 GETTABLEKS                       R3 R4 K2 ["error"]
...
PROTO_6:
        ...
        3 GETUPVAL                         R5 1
        4 GETTABLEKS                       R4 R5 K1 ["__DEV__"]
        6 JUMPIFNOT                        R4 ; [+7]
        7 JUMPIFNOTEQKNIL                  R3 ; [+6]
        9 GETUPVAL                         R5 2
       10 GETTABLEKS                       R4 R5 K2 ["error"]
...
PROTO_11:
        ...
        3 JUMPIFNOT                        R2 ; [+21]
        4 GETUPVAL                         R4 1
        5 GETTABLEKS                       R3 R4 K1 ["current"]
        7 GETUPVAL                         R5 0
        8 GETTABLEKS                       R4 R5 K0 ["__DEV__"]
       10 JUMPIFNOT                        R4 ; [+7]
       11 JUMPIFNOTEQKNIL                  R3 ; [+6]
       13 GETUPVAL                         R5 2
       14 GETTABLEKS                       R4 R5 K2 ["error"]
...
PROTO_12:
        ...
        3 GETUPVAL                         R3 1
        4 GETTABLEKS                       R2 R3 K1 ["__DEV__"]
        6 JUMPIFNOT                        R2 ; [+7]
        7 JUMPIFNOTEQKNIL                  R1 ; [+6]
        9 GETUPVAL                         R3 2
       10 GETTABLEKS                       R2 R3 K2 ["error"]
...
MAIN:
       ...
       38 GETTABLEKS                       R10 R0 K8 ["Shared"]
       40 CALL                             R9 1 1
       41 GETTABLEKS                       R8 R9 K10 ["ReactSharedInternals"]
       43 GETTABLEKS                       R7 R8 K11 ["ReactCurrentDispatcher"]
