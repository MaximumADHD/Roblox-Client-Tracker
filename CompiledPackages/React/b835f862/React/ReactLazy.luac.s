PROTO_0:
        ...
        7 GETUPVAL                         R2 1
        8 GETTABLEKS                       R2 R2 K3 ["__DEV__"]
       10 JUMPIFNOT                        R2 ; [+10]
       11 JUMPIFNOTEQKNIL                  R1 ; [+9]
       13 GETUPVAL                         R2 2
       14 GETTABLEKS                       R2 R2 K4 ["error"]
...
PROTO_9:
        0 DUPTABLE                         R1 K3 [{[1] = -1, ["_result"]}]
        1 SETTABLEKS                       R0 R1 K2 ["_result"]
        3 NEWTABLE                         R2 4 0
        5 GETUPVAL                         R3 0
        6 SETTABLEKS                       R3 R2 K4 ["$$typeof"]
        8 SETTABLEKS                       R1 R2 K5 ["_payload"]
       10 GETGLOBAL                        R3 K6 ["lazyInitializer"]
       12 SETTABLEKS                       R3 R2 K7 ["_init"]
       14 GETUPVAL                         R3 1
       15 GETTABLEKS                       R3 R3 K8 ["__DEV__"]
       17 JUMPIFNOT                        R3 ; [+21]
       18 LOADNIL                          R3
       19 LOADNIL                          R4
       20 DUPTABLE                         R7 K11 [{"__index", "__newindex"}]
       21 NEWCLOSURE                       R8 P0
       22 CAPTURE                          REF R3
       23 CAPTURE                          REF R4
       24 SETTABLEKS                       R8 R7 K9 ["__index"]
       26 NEWCLOSURE                       R8 P1
       27 CAPTURE                          UPVAL U2
       28 CAPTURE                          REF R3
       29 CAPTURE                          REF R4
       30 SETTABLEKS                       R8 R7 K10 ["__newindex"]
       32 FASTCALL2                        SETMETATABLE R2 R7 ; [+4]
       34 MOVE                             R6 R2
       35 GETIMPORT                        R5 K13 [setmetatable]
       37 CALL                             R5 2 0
       38 CLOSEUPVALS                      R3
       39 RETURN                           R2 1
...
MAIN:
       ...
       23 CALL                             R4 1 1
       24 GETTABLEKS                       R5 R4 K9 ["util"]
       26 GETTABLEKS                       R5 R5 K10 ["inspect"]
       28 GETIMPORT                        R6 K4 [require]
       30 GETTABLEKS                       R7 R0 K6 ["Shared"]
       32 CALL                             R6 1 1
       33 GETIMPORT                        R7 K4 [require]
       35 GETTABLEKS                       R8 R0 K6 ["Shared"]
       37 CALL                             R7 1 1
       38 GETTABLEKS                       R7 R7 K11 ["ReactSymbols"]
