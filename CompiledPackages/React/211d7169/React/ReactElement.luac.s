PROTO_0:
       ...
       17 GETTABLEKS                       R1 R0 K3 ["ref"]
       19 GETTABLEKS                       R1 R1 K7 ["get"]
       21 JUMPIFNOT                        R1 ; [+5]
...
PROTO_1:
       ...
       16 GETTABLEKS                       R1 R0 K3 ["key"]
       18 GETTABLEKS                       R1 R1 K7 ["get"]
       20 JUMPIFNOT                        R1 ; [+5]
...
PROTO_8:
       ...
       13 GETUPVAL                         R1 0
       14 GETTABLEKS                       R1 R1 K7 ["current"]
       16 JUMPIFNOT                        R1 ; [+20]
       17 GETUPVAL                         R1 1
       18 GETUPVAL                         R2 0
       19 GETTABLEKS                       R2 R2 K7 ["current"]
       21 GETTABLEKS                       R2 R2 K8 ["type"]
       23 CALL                             R1 1 1
       24 GETUPVAL                         R3 2
...
PROTO_9:
       ...
       14 GETIMPORT                        R8 K8 [_G]
       16 GETTABLEKS                       R8 R8 K9 ["__DEV__"]
       18 JUMPIFNOT                        R8 ; [+17]
       19 NEWTABLE                         R9 0 0
       21 DUPTABLE                         R10 K11 [{"__index"}]
       22 DUPTABLE                         R11 K14 [{["validated"] = False}]
       23 SETTABLEKS                       R11 R10 K10 ["__index"]
       25 FASTCALL2                        SETMETATABLE R9 R10 ; [+3]
       27 GETIMPORT                        R8 K16 [setmetatable]
       29 CALL                             R8 2 1
       30 SETTABLEKS                       R8 R7 K17 ["_store"]
       32 SETTABLEKS                       R3 R7 K18 ["_self"]
       34 SETTABLEKS                       R4 R7 K19 ["_source"]
       36 RETURN                           R7 1
...
PROTO_12:
        ...
        9 GETIMPORT                        R8 K1 [_G]
       11 GETTABLEKS                       R8 R8 K2 ["__DEV__"]
       13 JUMPIFNOT                        R8 ; [+22]
       14 JUMPIFNOT                        R1 ; [+21]
       ...
       26 GETTABLEKS                       R8 R1 K3 ["ref"]
       28 GETTABLEKS                       R8 R8 K7 ["get"]
       30 JUMPIFNOT                        R8 ; [+5]
       ...
       45 GETIMPORT                        R7 K1 [_G]
       47 GETTABLEKS                       R7 R7 K2 ["__DEV__"]
       49 JUMPIFNOT                        R7 ; [+3]
       50 GETUPVAL                         R7 0
       51 MOVE                             R8 R1
       52 CALL                             R7 1 0
       53 GETIMPORT                        R8 K1 [_G]
       55 GETTABLEKS                       R8 R8 K2 ["__DEV__"]
       57 JUMPIFNOT                        R8 ; [+21]
       ...
       69 GETTABLEKS                       R8 R1 K9 ["key"]
       71 GETTABLEKS                       R8 R8 K7 ["get"]
       73 JUMPIFNOT                        R8 ; [+5]
      ...
      175 CALL                             R13 2 0
      176 FORNLOOP                         R9
      177 GETIMPORT                        R9 K1 [_G]
      179 GETTABLEKS                       R9 R9 K2 ["__DEV__"]
      181 JUMPIFNOT                        R9 ; [+9]
      182 GETUPVAL                         R9 2
      183 GETTABLEKS                       R9 R9 K26 ["freeze"]
      185 JUMPIFNOT                        R9 ; [+5]
      186 GETUPVAL                         R9 2
      187 GETTABLEKS                       R9 R9 K26 ["freeze"]
      189 MOVE                             R10 R8
      190 CALL                             R9 1 0
      ...
      215 FORGLOOP                         R9 2 ; [-6]
      217 GETIMPORT                        R8 K1 [_G]
      219 GETTABLEKS                       R8 R8 K2 ["__DEV__"]
      221 JUMPIFNOT                        R8 ; [+44]
      222 JUMPIF                           R3 ; [+1]
      223 JUMPIFNOT                        R4 ; [+42]
      224 LOADNIL                          R8
      ...
      271 MOVE                             R13 R6
      272 GETUPVAL                         R14 6
      273 GETTABLEKS                       R14 R14 K37 ["current"]
      275 MOVE                             R15 R2
      276 CALL                             R8 7 1
      277 RETURN                           R8 1
...
PROTO_13:
       ...
       35 GETIMPORT                        R9 K11 [_G]
       37 GETTABLEKS                       R9 R9 K12 ["__DEV__"]
       39 JUMPIFNOT                        R9 ; [+22]
       40 JUMPIFNOT                        R1 ; [+21]
       ...
       52 GETTABLEKS                       R9 R1 K6 ["ref"]
       54 GETTABLEKS                       R9 R9 K16 ["get"]
       56 JUMPIFNOT                        R9 ; [+5]
       ...
       74 GETIMPORT                        R9 K11 [_G]
       76 GETTABLEKS                       R9 R9 K12 ["__DEV__"]
       78 JUMPIFNOT                        R9 ; [+21]
       ...
       90 GETTABLEKS                       R9 R1 K5 ["key"]
       92 GETTABLEKS                       R9 R9 K16 ["get"]
       94 JUMPIFNOT                        R9 ; [+5]
      ...
      120 GETTABLEKS                       R9 R0 K20 ["type"]
      122 GETTABLEKS                       R9 R9 K21 ["defaultProps"]
      124 JUMPIFNOT                        R9 ; [+4]
...
MAIN:
       ...
       25 CALL                             R4 1 1
       26 GETTABLEKS                       R4 R4 K9 ["getComponentName"]
       28 GETIMPORT                        R5 K4 [require]
       30 GETTABLEKS                       R6 R0 K7 ["Shared"]
       32 CALL                             R5 1 1
       33 GETTABLEKS                       R5 R5 K10 ["invariant"]
       35 GETIMPORT                        R6 K4 [require]
       37 GETTABLEKS                       R7 R0 K7 ["Shared"]
       39 CALL                             R6 1 1
       40 GETTABLEKS                       R6 R6 K11 ["ReactSymbols"]
       42 GETTABLEKS                       R6 R6 K12 ["REACT_ELEMENT_TYPE"]
       44 GETIMPORT                        R7 K4 [require]
       46 GETTABLEKS                       R8 R0 K7 ["Shared"]
       48 CALL                             R7 1 1
       49 GETTABLEKS                       R7 R7 K13 ["ReactSharedInternals"]
       51 GETTABLEKS                       R7 R7 K14 ["ReactCurrentOwner"]
       53 DUPTABLE                         R8 K20 [{["key"] = True, ["ref"] = True, ["__self"] = True, ["__source"] = True}]
       54 LOADNIL                          R9
       55 LOADNIL                          R10
       56 LOADNIL                          R11
       57 GETIMPORT                        R12 K22 [_G]
       59 GETTABLEKS                       R12 R12 K23 ["__DEV__"]
       61 JUMPIFNOT                        R12 ; [+2]
       62 NEWTABLE                         R11 0 0
       64 NEWTABLE                         R12 8 0
       66 DUPCLOSURE                       R13 K24 [PROTO_0]
       67 DUPCLOSURE                       R14 K25 [PROTO_1]
       68 DUPTABLE                         R15 K27 [{["isReactWarning"] = True}]
       ...
       79 CAPTURE                          VAL R4
       80 CAPTURE                          REF R11
       81 DUPCLOSURE                       R19 K28 [PROTO_9]
       82 CAPTURE                          VAL R6
       83 DUPCLOSURE                       R20 K29 [PROTO_10]
       84 SETTABLEKS                       R20 R12 K30 ["jsx"]
       86 DUPCLOSURE                       R20 K31 [PROTO_11]
       87 SETTABLEKS                       R20 R12 K32 ["jsxDEV"]
       89 DUPCLOSURE                       R20 K33 [PROTO_12]
       90 CAPTURE                          VAL R18
       91 CAPTURE                          VAL R8
       92 CAPTURE                          VAL R2
       93 CAPTURE                          VAL R16
       ...
       95 CAPTURE                          VAL R19
       96 CAPTURE                          VAL R7
       97 SETTABLEKS                       R20 R12 K34 ["createElement"]
       99 DUPCLOSURE                       R21 K35 [PROTO_13]
      100 CAPTURE                          VAL R5
      101 CAPTURE                          VAL R2
      102 CAPTURE                          VAL R7
      103 CAPTURE                          VAL R8
      104 CAPTURE                          VAL R19
      105 SETTABLEKS                       R21 R12 K36 ["cloneElement"]
      107 DUPCLOSURE                       R21 K37 [PROTO_14]
      108 CAPTURE                          VAL R6
      109 SETTABLEKS                       R21 R12 K38 ["isValidElement"]
      111 CLOSEUPVALS                      R9
      112 RETURN                           R12 1
