...
MAIN:
       ...
       57 DUPTABLE                         R10 K18 [{["isReactComponent"] = True}]
       58 DUPCLOSURE                       R11 K19 [PROTO_0]
       59 DUPCLOSURE                       R12 K20 [PROTO_1]
       60 CAPTURE                          VAL R5
       61 DUPCLOSURE                       R13 K21 [PROTO_2]
       62 CAPTURE                          VAL R0
       63 CAPTURE                          VAL R1
       64 CAPTURE                          VAL R5
       65 DUPTABLE                         R14 K32 [{["didMount"] = "componentDidMount", ["shouldUpdate"] = "shouldComponentUpdate", ["willUpdate"] = "UNSAFE_componentWillUpdate", ["didUpdate"] = "componentDidUpdate", ["willUnmount"] = "componentWillUnmount"}]
       66 DUPCLOSURE                       R15 K33 [PROTO_3]
       67 CAPTURE                          VAL R14
       68 CAPTURE                          VAL R5
       69 CAPTURE                          VAL R0
       70 CAPTURE                          VAL R1
       71 DUPTABLE                         R16 K37 [{"__newindex", "__index", "__tostring"}]
       72 SETTABLEKS                       R15 R16 K34 ["__newindex"]
       74 SETTABLEKS                       R10 R16 K35 ["__index"]
       76 DUPCLOSURE                       R17 K38 [PROTO_4]
       77 SETTABLEKS                       R17 R16 K36 ["__tostring"]
       79 DUPTABLE                         R18 K41 [{["__componentName"] = "Component"}]
       80 FASTCALL2                        SETMETATABLE R18 R16 ; [+4]
       82 MOVE                             R19 R16
       83 GETIMPORT                        R17 K43 [setmetatable]
       85 CALL                             R17 2 1
       86 GETIMPORT                        R19 K1 [_G]
       88 GETTABLEKS                       R19 R19 K44 ["__TESTEZ_RUNNING_TEST__"]
       90 JUMPIF                           R19 ; [+2]
       91 LOADN                            R18 900
       92 JUMP                             ; [+1]
       93 LOADN                            R18 0
       94 LOADN                            R19 1
       95 GETIMPORT                        R20 K47 [table.create]
       97 MOVE                             R21 R18
       98 CALL                             R20 1 1
       99 LOADN                            R23 1
      100 MOVE                             R21 R18
      101 LOADN                            R22 1
      102 FORNPREP                         R21
      103 DUPTABLE                         R26 K54 [{["props"] = , ["context"] = , ["state"], ["__refs"], ["__updater"]}]
      104 SETTABLEKS                       R9 R26 K51 ["state"]
      106 SETTABLEKS                       R8 R26 K52 ["__refs"]
      108 SETTABLEKS                       R7 R26 K53 ["__updater"]
      110 FASTCALL2                        TABLE_INSERT R20 R26 ; [+4]
      112 MOVE                             R25 R20
      113 GETIMPORT                        R24 K56 [table.insert]
      115 CALL                             R24 2 0
      116 FORNLOOP                         R21
      117 DUPCLOSURE                       R21 K57 [PROTO_5]
      118 CAPTURE                          VAL R0
      119 CAPTURE                          VAL R5
      120 CAPTURE                          VAL R4
      121 NEWCLOSURE                       R22 P6
      122 CAPTURE                          VAL R1
      123 CAPTURE                          VAL R5
      124 CAPTURE                          REF R19
      125 CAPTURE                          VAL R18
      ...
      129 CAPTURE                          VAL R7
      130 CAPTURE                          VAL R21
      131 SETTABLEKS                       R22 R17 K58 ["extend"]
      133 DUPCLOSURE                       R22 K59 [PROTO_8]
      134 SETTABLEKS                       R22 R17 K60 ["setState"]
      136 DUPCLOSURE                       R22 K61 [PROTO_9]
      137 SETTABLEKS                       R22 R17 K62 ["forceUpdate"]
      139 JUMPIFNOT                        R0 ; [+34]
      140 DUPTABLE                         R22 K65 [{"isMounted", "replaceState"}]
      141 NEWTABLE                         R23 0 2
      143 LOADK                            R24 K63 ["isMounted"]
      144 LOADK                            R25 K66 ["Instead, make sure to clean up subscriptions and pending requests in componentWillUnmount to prevent memory leaks."]
      145 SETLIST                          R23 R24 2 [1]
      147 SETTABLEKS                       R23 R22 K63 ["isMounted"]
      149 NEWTABLE                         R23 0 2
      151 LOADK                            R24 K64 ["replaceState"]
      152 LOADK                            R25 K67 ["Refactor your code to use setState instead (see https://github.com/facebook/react/issues/3236)."]
      153 SETLIST                          R23 R24 2 [1]
      155 SETTABLEKS                       R23 R22 K64 ["replaceState"]
      157 DUPCLOSURE                       R23 K68 [PROTO_11]
      158 CAPTURE                          VAL R17
      159 CAPTURE                          VAL R5
      160 MOVE                             R24 R22
      161 LOADNIL                          R25
      162 LOADNIL                          R26
      163 FORGPREP                         R24
      164 GETTABLE                         R29 R22 R27
      165 JUMPIFEQKNIL                     R29 ; [+6]
      167 GETTABLE                         R29 R22 R27
      168 NEWCLOSURE                       R30 P10
      169 CAPTURE                          VAL R5
      170 CAPTURE                          VAL R29
      171 SETTABLE                         R30 R17 R27
      172 FORGLOOP                         R24 2 ; [-9]
      174 LOADK                            R24 K69 ["PureComponent"]
      175 NAMECALL                         R22 R17 K58 ["extend"]
      177 CALL                             R22 2 1
      178 GETTABLEKS                       R23 R17 K58 ["extend"]
      180 SETTABLEKS                       R23 R22 K58 ["extend"]
      182 DUPTABLE                         R23 K71 [{["isReactComponent"] = True, ["isPureReactComponent"] = True}]
      183 DUPTABLE                         R26 K37 [{"__newindex", "__index", "__tostring"}]
      184 SETTABLEKS                       R15 R26 K34 ["__newindex"]
      186 SETTABLEKS                       R23 R26 K35 ["__index"]
      188 DUPCLOSURE                       R27 K72 [PROTO_12]
      189 SETTABLEKS                       R27 R26 K36 ["__tostring"]
      191 FASTCALL2                        SETMETATABLE R22 R26 ; [+4]
      193 MOVE                             R25 R22
      194 GETIMPORT                        R24 K43 [setmetatable]
      196 CALL                             R24 2 0
      197 DUPTABLE                         R24 K73 [{"Component", "PureComponent"}]
      198 SETTABLEKS                       R17 R24 K40 ["Component"]
      200 SETTABLEKS                       R22 R24 K69 ["PureComponent"]
      202 CLOSEUPVALS                      R19
      203 RETURN                           R24 1
