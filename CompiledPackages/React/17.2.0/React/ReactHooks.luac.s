PROTO_0:
        ...
        5 GETTABLEKS                       R1 R2 K3 ["__DEV__"]
        7 JUMPIFNOT                        R1 ; [+7]
        8 JUMPIFNOTEQKNIL                  R0 ; [+6]
       10 GETUPVAL                         R2 1
       11 GETTABLEKS                       R1 R2 K4 ["error"]
...
PROTO_1:
        ...
        6 GETTABLEKS                       R4 R5 K3 ["__DEV__"]
        8 JUMPIFNOT                        R4 ; [+7]
        9 JUMPIFNOTEQKNIL                  R3 ; [+6]
       11 GETUPVAL                         R5 1
       12 GETTABLEKS                       R4 R5 K4 ["error"]
       ...
       15 CALL                             R4 1 0
       16 MOVE                             R2 R3
       17 GETIMPORT                        R4 K2 [_G]
       19 GETTABLEKS                       R3 R4 K3 ["__DEV__"]
       21 JUMPIFNOT                        R3 ; [+53]
       22 JUMPIFEQKNIL                     R1 ; [+27]
       24 GETUPVAL                         R4 1
       25 GETTABLEKS                       R3 R4 K4 ["error"]
       ...
       36 GETUPVAL                         R8 2
       37 GETTABLEKS                       R7 R8 K10 ["isArray"]
       39 NEWTABLE                         R8 0 0
       41 GETVARARGS                       R9 -1
...
PROTO_2:
       ...
       11 GETUPVAL                         R4 1
       12 GETTABLEKS                       R3 R4 K4 ["error"]
       14 LOADK                            R4 K5 ["Invalid hook call. Hooks can only be called inside of the body of a function component. This could happen for one of the following reasons:\n1. You might have mismatching versions of React and the renderer (such as React DOM)\n2. You might be breaking the Rules of Hooks\n3. You might have more than one copy of React in the same app\nSee https://reactjs.org/link/invalid-hook-call for tips about how to debug and fix this problem."]
       15 CALL                             R3 1 0
       16 MOVE                             R1 R2
       17 GETTABLEKS                       R2 R1 K6 ["useState"]
       19 MOVE                             R3 R0
       20 GETVARARGS                       R4 -1
       21 CALL                             R2 -1 -1
       22 RETURN                           R2 -1
...
PROTO_3:
        ...
        3 GETIMPORT                        R6 K2 [_G]
        5 GETTABLEKS                       R5 R6 K3 ["__DEV__"]
        7 JUMPIFNOT                        R5 ; [+7]
        8 JUMPIFNOTEQKNIL                  R4 ; [+6]
       10 GETUPVAL                         R6 1
       11 GETTABLEKS                       R5 R6 K4 ["error"]
...
PROTO_4:
        ...
        5 GETTABLEKS                       R3 R4 K3 ["__DEV__"]
        7 JUMPIFNOT                        R3 ; [+7]
        8 JUMPIFNOTEQKNIL                  R2 ; [+6]
       10 GETUPVAL                         R4 1
       11 GETTABLEKS                       R3 R4 K4 ["error"]
...
PROTO_5:
       ...
       14 CALL                             R3 1 0
       15 MOVE                             R1 R2
       16 GETTABLEKS                       R2 R1 K6 ["useBinding"]
       18 MOVE                             R3 R0
       19 CALL                             R2 1 -1
       20 RETURN                           R2 -1
...
PROTO_11:
        ...
        8 GETIMPORT                        R5 K1 [_G]
       10 GETTABLEKS                       R4 R5 K2 ["__DEV__"]
       12 JUMPIFNOT                        R4 ; [+7]
       13 JUMPIFNOTEQKNIL                  R3 ; [+6]
       15 GETUPVAL                         R5 1
       16 GETTABLEKS                       R4 R5 K4 ["error"]
...
PROTO_12:
        ...
        5 GETTABLEKS                       R2 R3 K3 ["__DEV__"]
        7 JUMPIFNOT                        R2 ; [+7]
        8 JUMPIFNOTEQKNIL                  R1 ; [+6]
       10 GETUPVAL                         R3 1
       11 GETTABLEKS                       R2 R3 K4 ["error"]
...
MAIN:
       ...
       33 GETTABLEKS                       R9 R0 K7 ["Shared"]
       35 CALL                             R8 1 1
       36 GETTABLEKS                       R7 R8 K9 ["ReactSharedInternals"]
       38 GETTABLEKS                       R6 R7 K10 ["ReactCurrentDispatcher"]
       ...
       51 DUPCLOSURE                       R10 K14 [PROTO_2]
       52 CAPTURE                          VAL R6
       53 CAPTURE                          VAL R3
       54 SETTABLEKS                       R10 R8 K15 ["useState"]
       56 DUPCLOSURE                       R11 K16 [PROTO_3]
       57 CAPTURE                          VAL R6
       58 CAPTURE                          VAL R3
       59 SETTABLEKS                       R11 R8 K17 ["useReducer"]
       61 DUPCLOSURE                       R12 K18 [PROTO_4]
       62 CAPTURE                          VAL R6
       63 CAPTURE                          VAL R3
       64 SETTABLEKS                       R12 R8 K19 ["useRef"]
       66 DUPCLOSURE                       R13 K20 [PROTO_5]
       67 CAPTURE                          VAL R6
       68 CAPTURE                          VAL R3
       69 SETTABLEKS                       R13 R8 K21 ["useBinding"]
       71 DUPCLOSURE                       R14 K22 [PROTO_6]
       72 CAPTURE                          VAL R6
       73 CAPTURE                          VAL R3
       74 SETTABLEKS                       R14 R8 K23 ["useEffect"]
       76 DUPCLOSURE                       R15 K24 [PROTO_7]
       77 CAPTURE                          VAL R6
       78 CAPTURE                          VAL R3
       79 SETTABLEKS                       R15 R8 K25 ["useLayoutEffect"]
       81 DUPCLOSURE                       R16 K26 [PROTO_8]
       82 CAPTURE                          VAL R6
       83 CAPTURE                          VAL R3
       84 SETTABLEKS                       R16 R8 K27 ["useCallback"]
       86 DUPCLOSURE                       R17 K28 [PROTO_9]
       87 CAPTURE                          VAL R6
       88 CAPTURE                          VAL R3
       89 SETTABLEKS                       R17 R8 K29 ["useMemo"]
       91 DUPCLOSURE                       R18 K30 [PROTO_10]
       92 CAPTURE                          VAL R6
       93 CAPTURE                          VAL R3
       94 SETTABLEKS                       R18 R8 K31 ["useImperativeHandle"]
       96 DUPCLOSURE                       R19 K32 [PROTO_11]
       97 CAPTURE                          VAL R6
       98 CAPTURE                          VAL R3
       99 SETTABLEKS                       R19 R8 K33 ["useDebugValue"]
      101 NEWTABLE                         R20 0 0
      103 SETTABLEKS                       R20 R8 K34 ["emptyObject"]
      105 DUPCLOSURE                       R20 K35 [PROTO_12]
      106 CAPTURE                          VAL R6
      107 CAPTURE                          VAL R3
      108 SETTABLEKS                       R20 R8 K36 ["useOpaqueIdentifier"]
      110 DUPCLOSURE                       R20 K37 [PROTO_13]
      111 CAPTURE                          VAL R6
      112 CAPTURE                          VAL R3
      113 SETTABLEKS                       R20 R8 K38 ["useMutableSource"]
      115 RETURN                           R8 1
