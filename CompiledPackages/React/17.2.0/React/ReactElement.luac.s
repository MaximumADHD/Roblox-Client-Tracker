PROTO_0:
       ...
       14 GETTABLEKS                       R2 R0 K0 ["ref"]
       16 GETTABLEKS                       R1 R2 K4 ["isReactWarning"]
       18 JUMPIFNOT                        R1 ; [+2]
       19 LOADB                            R1 0
       20 RETURN                           R1 1
...
PROTO_10:
       ...
       14 GETUPVAL                         R8 1
       15 JUMPIFNOT                        R8 ; [+34]
       16 DUPTABLE                         R8 K8 [{"validated"}]
       17 LOADB                            R9 0
       18 SETTABLEKS                       R9 R8 K7 ["validated"]
       20 NEWTABLE                         R10 0 0
       22 DUPTABLE                         R11 K11 [{"__index", "__newindex"}]
       23 SETTABLEKS                       R8 R11 K9 ["__index"]
       25 NEWCLOSURE                       R12 P0
       26 CAPTURE                          VAL R8
       27 SETTABLEKS                       R12 R11 K10 ["__newindex"]
       29 FASTCALL2                        SETMETATABLE R10 R11 ; [+3]
       31 GETIMPORT                        R9 K13 [setmetatable]
       33 CALL                             R9 2 1
       34 SETTABLEKS                       R9 R7 K14 ["_store"]
       36 DUPTABLE                         R11 K15 [{"__index"}]
       37 DUPTABLE                         R12 K18 [{"_self", "_source"}]
       38 SETTABLEKS                       R3 R12 K16 ["_self"]
       40 SETTABLEKS                       R4 R12 K17 ["_source"]
       42 SETTABLEKS                       R12 R11 K9 ["__index"]
       44 FASTCALL2                        SETMETATABLE R7 R11 ; [+4]
       46 MOVE                             R10 R7
       47 GETIMPORT                        R9 K13 [setmetatable]
       49 CALL                             R9 2 0
       50 RETURN                           R7 1
...
PROTO_13:
       ...
       29 GETTABLEKS                       R8 R1 K3 ["ref"]
       31 GETTABLEKS                       R7 R8 K6 ["isReactWarning"]
       33 JUMPIFNOT                        R7 ; [+2]
       34 LOADB                            R6 0
       35 JUMP                             ; [+6]
       ...
       64 GETTABLEKS                       R8 R1 K7 ["key"]
       66 GETTABLEKS                       R7 R8 K6 ["isReactWarning"]
       68 JUMPIFNOT                        R7 ; [+2]
       69 LOADB                            R6 0
       70 JUMP                             ; [+6]
      ...
      273 MOVE                             R12 R5
      274 GETUPVAL                         R14 5
      275 GETTABLEKS                       R13 R14 K39 ["current"]
      277 MOVE                             R14 R2
      278 CALL                             R7 7 1
      279 RETURN                           R7 1
...
PROTO_15:
       ...
       61 GETTABLEKS                       R10 R1 K11 ["ref"]
       63 GETTABLEKS                       R9 R10 K17 ["isReactWarning"]
       65 JUMPIFNOT                        R9 ; [+1]
       66 JUMP                             ; [+6]
      ...
      102 GETTABLEKS                       R11 R1 K10 ["key"]
      104 GETTABLEKS                       R10 R11 K17 ["isReactWarning"]
      106 JUMPIFNOT                        R10 ; [+1]
      107 JUMP                             ; [+6]
...
MAIN:
       ...
       32 GETIMPORT                        R9 K4 [script]
       34 GETTABLEKS                       R8 R9 K5 ["Parent"]
       36 GETTABLEKS                       R7 R8 K12 ["ReactLazy"]
       38 CALL                             R6 1 1
       39 GETIMPORT                        R8 K7 [require]
       41 GETTABLEKS                       R9 R1 K10 ["Shared"]
       43 CALL                             R8 1 1
       44 GETTABLEKS                       R7 R8 K13 ["getComponentName"]
       46 GETIMPORT                        R10 K7 [require]
       48 GETTABLEKS                       R11 R1 K10 ["Shared"]
       50 CALL                             R10 1 1
       51 GETTABLEKS                       R9 R10 K14 ["ReactSymbols"]
       53 GETTABLEKS                       R8 R9 K15 ["REACT_ELEMENT_TYPE"]
       55 GETIMPORT                        R11 K7 [require]
       57 GETTABLEKS                       R12 R1 K10 ["Shared"]
       59 CALL                             R11 1 1
       60 GETTABLEKS                       R10 R11 K16 ["ReactSharedInternals"]
       62 GETTABLEKS                       R9 R10 K17 ["ReactCurrentOwner"]
       64 DUPTABLE                         R10 K22 [{"key", "ref", "__self", "__source"}]
       65 LOADB                            R11 1
       66 SETTABLEKS                       R11 R10 K18 ["key"]
       68 LOADB                            R11 1
       69 SETTABLEKS                       R11 R10 K19 ["ref"]
       71 LOADB                            R11 1
       72 SETTABLEKS                       R11 R10 K20 ["__self"]
       74 LOADB                            R11 1
       75 SETTABLEKS                       R11 R10 K21 ["__source"]
       77 LOADNIL                          R11
       78 LOADNIL                          R12
       79 LOADNIL                          R13
       80 JUMPIFNOT                        R0 ; [+2]
       81 NEWTABLE                         R13 0 0
       83 NEWTABLE                         R14 8 0
       85 DUPCLOSURE                       R15 K23 [PROTO_0]
       86 CAPTURE                          VAL R0
       87 DUPCLOSURE                       R16 K24 [PROTO_1]
       88 CAPTURE                          VAL R0
       89 DUPTABLE                         R17 K26 [{"isReactWarning"}]
       90 LOADB                            R18 1
       91 SETTABLEKS                       R18 R17 K25 ["isReactWarning"]
       93 NEWCLOSURE                       R18 P2
       94 CAPTURE                          VAL R0
       95 CAPTURE                          REF R11
       96 CAPTURE                          VAL R4
       97 CAPTURE                          VAL R17
      ...
      101 CAPTURE                          VAL R4
      102 CAPTURE                          VAL R17
      103 NEWCLOSURE                       R20 P4
      104 CAPTURE                          VAL R0
      105 CAPTURE                          VAL R9
      106 CAPTURE                          VAL R7
      107 CAPTURE                          REF R13
      108 DUPCLOSURE                       R21 K27 [PROTO_10]
      109 CAPTURE                          VAL R8
      110 CAPTURE                          VAL R0
      111 DUPCLOSURE                       R22 K28 [PROTO_11]
      112 SETTABLEKS                       R22 R14 K29 ["jsx"]
      114 DUPCLOSURE                       R22 K30 [PROTO_12]
      115 SETTABLEKS                       R22 R14 K31 ["jsxDEV"]
      117 DUPCLOSURE                       R22 K32 [PROTO_13]
      118 CAPTURE                          VAL R0
      119 CAPTURE                          VAL R20
      120 CAPTURE                          VAL R18
      121 CAPTURE                          VAL R19
      122 CAPTURE                          VAL R21
      123 CAPTURE                          VAL R9
      124 SETTABLEKS                       R22 R14 K33 ["createElement"]
      126 DUPCLOSURE                       R23 K34 [PROTO_14]
      127 CAPTURE                          VAL R21
      128 SETTABLEKS                       R23 R14 K35 ["cloneAndReplaceKey"]
      130 DUPCLOSURE                       R23 K36 [PROTO_15]
      131 CAPTURE                          VAL R3
      132 CAPTURE                          VAL R9
      133 CAPTURE                          VAL R0
      134 CAPTURE                          VAL R10
      135 CAPTURE                          VAL R21
      136 SETTABLEKS                       R23 R14 K37 ["cloneElement"]
      138 DUPCLOSURE                       R23 K38 [PROTO_16]
      139 CAPTURE                          VAL R8
      140 SETTABLEKS                       R23 R14 K39 ["isValidElement"]
      142 CLOSEUPVALS                      R11
      143 RETURN                           R14 1
