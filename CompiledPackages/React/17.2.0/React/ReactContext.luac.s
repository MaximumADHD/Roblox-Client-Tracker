PROTO_0:
        ...
        2 GETUPVAL                         R2 0
        3 GETTABLEKS                       R2 R2 K0 ["_currentValue"]
        5 RETURN                           R2 1
        6 JUMPIFNOTEQKS                    R1 K1 ["_currentValue2"] ; [+5]
        8 GETUPVAL                         R2 0
        9 GETTABLEKS                       R2 R2 K1 ["_currentValue2"]
       11 RETURN                           R2 1
       12 JUMPIFNOTEQKS                    R1 K2 ["_threadCount"] ; [+5]
       14 GETUPVAL                         R2 0
       15 GETTABLEKS                       R2 R2 K2 ["_threadCount"]
       17 RETURN                           R2 1
       18 JUMPIFNOTEQKS                    R1 K3 ["displayName"] ; [+5]
       20 GETUPVAL                         R2 0
       21 GETTABLEKS                       R2 R2 K3 ["displayName"]
       23 RETURN                           R2 1
       24 LOADNIL                          R2
       25 RETURN                           R2 1
...
PROTO_2:
       ...
       38 LOADB                            R3 0
       39 GETIMPORT                        R4 K12 [_G]
       41 GETTABLEKS                       R4 R4 K13 ["__DEV__"]
       43 JUMPIFNOT                        R4 ; [+31]
       44 NEWTABLE                         R4 4 0
       46 GETUPVAL                         R5 0
       ...
       77 GETIMPORT                        R4 K12 [_G]
       79 GETTABLEKS                       R4 R4 K13 ["__DEV__"]
       81 JUMPIFNOT                        R4 ; [+6]
       82 LOADNIL                          R4
...
MAIN:
       ...
       18 CALL                             R3 1 1
       19 GETTABLEKS                       R3 R3 K7 ["ReactSymbols"]
