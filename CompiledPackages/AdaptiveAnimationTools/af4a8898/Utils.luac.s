...
MAIN:
      ...
      266 GETIMPORT                        R9 K100 [table.clone]
      268 GETTABLEKS                       R10 R0 K64 ["bodyRigLabels"]
      270 CALL                             R9 1 1
      271 SETTABLEKS                       R9 R0 K101 ["bodyAndHandRigLabels"]
      273 GETIMPORT                        R9 K103 [table.move]
      275 GETTABLEKS                       R10 R0 K96 ["handRigLabels"]
      277 LOADN                            R11 1
      278 GETTABLEKS                       R13 R0 K96 ["handRigLabels"]
      280 LENGTH                           R12 R13
      281 GETTABLEKS                       R15 R0 K101 ["bodyAndHandRigLabels"]
      283 LENGTH                           R14 R15
      284 ADDK                             R13 R14 K104 [1]
      285 GETTABLEKS                       R14 R0 K101 ["bodyAndHandRigLabels"]
      287 CALL                             R9 5 0
      288 DUPCLOSURE                       R9 K105 [PROTO_2]
      289 CAPTURE                          VAL R1
      290 SETTABLEKS                       R9 R0 K106 ["isValidTJoint"]
      292 DUPCLOSURE                       R9 K107 [PROTO_3]
      293 SETTABLEKS                       R9 R0 K108 ["startsWith"]
      295 DUPCLOSURE                       R9 K109 [PROTO_4]
      296 SETTABLEKS                       R9 R0 K110 ["endsWith"]
      298 DUPCLOSURE                       R9 K111 [PROTO_5]
      299 CAPTURE                          VAL R0
      300 SETTABLEKS                       R9 R0 K112 ["trimStart"]
      302 DUPCLOSURE                       R9 K113 [PROTO_6]
      303 CAPTURE                          VAL R0
      304 SETTABLEKS                       R9 R0 K114 ["trimEnd"]
      306 DUPCLOSURE                       R9 K115 [PROTO_7]
      307 SETTABLEKS                       R9 R0 K116 ["commonPrefix"]
      309 DUPCLOSURE                       R9 K117 [PROTO_8]
      310 CAPTURE                          VAL R0
      311 SETTABLEKS                       R9 R0 K118 ["commonSuffix"]
      313 DUPCLOSURE                       R9 K119 [PROTO_9]
      314 SETTABLEKS                       R9 R0 K120 ["remap"]
      316 DUPCLOSURE                       R9 K121 [PROTO_10]
      317 CAPTURE                          VAL R0
      318 SETTABLEKS                       R9 R0 K122 ["normalizePoints"]
      320 DUPCLOSURE                       R9 K123 [PROTO_11]
      321 SETTABLEKS                       R9 R0 K124 ["getDepth"]
      323 DUPCLOSURE                       R9 K125 [PROTO_13]
      324 CAPTURE                          VAL R1
      325 SETTABLEKS                       R9 R0 K126 ["getJointParent"]
      327 DUPCLOSURE                       R9 K127 [PROTO_14]
      328 CAPTURE                          VAL R0
      329 CAPTURE                          VAL R1
      330 SETTABLEKS                       R9 R0 K128 ["getJointPosition"]
      332 DUPCLOSURE                       R9 K129 [PROTO_15]
      333 CAPTURE                          VAL R0
      334 CAPTURE                          VAL R1
      335 SETTABLEKS                       R9 R0 K130 ["getJointRotation"]
      337 DUPCLOSURE                       R9 K131 [PROTO_16]
      338 CAPTURE                          VAL R1
      339 SETTABLEKS                       R9 R0 K132 ["setJointRotation"]
      341 DUPCLOSURE                       R9 K133 [PROTO_17]
      342 CAPTURE                          VAL R0
      343 DUPCLOSURE                       R10 K134 [PROTO_18]
      344 CAPTURE                          VAL R0
      345 DUPCLOSURE                       R11 K135 [PROTO_19]
      346 CAPTURE                          VAL R0
      347 CAPTURE                          VAL R9
      348 CAPTURE                          VAL R1
      349 SETTABLEKS                       R11 R0 K136 ["getGlobalCoordinateFrame"]
      351 DUPCLOSURE                       R11 K137 [PROTO_20]
      352 CAPTURE                          VAL R0
      353 CAPTURE                          VAL R10
      354 CAPTURE                          VAL R1
      355 SETTABLEKS                       R11 R0 K138 ["setGlobalCoordinateFrame"]
      357 DUPCLOSURE                       R11 K139 [PROTO_21]
      358 CAPTURE                          VAL R1
      359 SETTABLEKS                       R11 R0 K140 ["getJointTransform"]
      361 DUPCLOSURE                       R11 K141 [PROTO_22]
      362 CAPTURE                          VAL R1
      363 SETTABLEKS                       R11 R0 K142 ["setJointTransform"]
      365 DUPCLOSURE                       R11 K143 [PROTO_23]
      366 CAPTURE                          VAL R0
      367 SETTABLEKS                       R11 R0 K144 ["getRigLabelForJoint"]
      369 RETURN                           R0 1
