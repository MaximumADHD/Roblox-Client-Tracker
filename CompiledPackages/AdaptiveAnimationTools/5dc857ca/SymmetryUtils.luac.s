...
PROTO_1:
        ...
        1 CALL                             R1 0 1
        2 JUMPIFNOT                        R1 ; [+10]
        3 GETIMPORT                        R1 K2 [CFrame.fromMatrix]
        5 LOADK                            R2 K3 [{0, 0, 0}]
        6 LOADK                            R3 K4 [{-1, 0, 0}]
        7 LOADK                            R4 K5 [{0, 1, 0}]
        8 LOADK                            R5 K6 [{0, 0, 1}]
       ...
       12 RETURN                           R2 1
       13 GETUPVAL                         R1 1
       14 GETTABLEKS                       R1 R1 K7 ["mirrorTransformMotor6D"]
       16 MOVE                             R2 R0
       17 CALL                             R1 1 -1
       18 RETURN                           R1 -1
...
PROTO_3:
        0 JUMPIFNOT                        R1 ; [+6]
        1 GETUPVAL                         R2 0
        2 GETTABLEKS                       R2 R2 K0 ["mirrorTransformMotor6D"]
        4 MOVE                             R3 R0
        5 CALL                             R2 1 -1
        6 RETURN                           R2 -1
        7 GETUPVAL                         R2 0
...
MAIN:
       ...
       11 GETTABLEKS                       R2 R2 K7 ["getFFlagAdaptiveAnimationNaNFix"]
       13 CALL                             R1 1 1
       14 NEWTABLE                         R2 8 0
       16 DUPCLOSURE                       R3 K8 [PROTO_0]
       17 SETTABLEKS                       R3 R2 K9 ["mirrorTransformMotor6D"]
       19 DUPCLOSURE                       R3 K10 [PROTO_1]
       20 CAPTURE                          VAL R1
       21 CAPTURE                          VAL R2
       22 SETTABLEKS                       R3 R2 K11 ["mirrorTransformMotor6DDelta"]
       24 DUPCLOSURE                       R3 K12 [PROTO_2]
       25 SETTABLEKS                       R3 R2 K13 ["mirrorTransformAnimationConstraint"]
       27 DUPCLOSURE                       R3 K14 [PROTO_3]
       28 CAPTURE                          VAL R2
       29 SETTABLEKS                       R3 R2 K15 ["getMirroredTransform"]
       31 DUPCLOSURE                       R3 K16 [PROTO_5]
       32 SETTABLEKS                       R3 R2 K17 ["isIdentityTransform"]
       34 RETURN                           R2 1
