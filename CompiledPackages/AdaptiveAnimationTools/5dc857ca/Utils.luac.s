...
PROTO_14:
       ...
       80 JUMPIFNOT                        R1 ; [+14]
       81 GETTABLEKS                       R1 R0 K7 ["Attachment0"]
       83 GETTABLEKS                       R1 R1 K3 ["Parent"]
       85 JUMPIFNOT                        R1 ; [+8]
       86 GETTABLEKS                       R1 R0 K7 ["Attachment0"]
       88 GETTABLEKS                       R1 R1 K3 ["Parent"]
...
PROTO_15:
       ...
       43 JUMPIFNOT                        R1 ; [+7]
       44 GETTABLEKS                       R1 R0 K9 ["Attachment1"]
       46 GETTABLEKS                       R1 R1 K7 ["WorldCFrame"]
       48 GETTABLEKS                       R1 R1 K3 ["Position"]
       50 RETURN                           R1 1
...
PROTO_16:
       ...
       44 GETTABLEKS                       R1 R0 K9 ["Attachment1"]
       46 GETTABLEKS                       R1 R1 K7 ["WorldCFrame"]
       48 GETTABLEKS                       R1 R1 K3 ["Rotation"]
       50 RETURN                           R1 1
       51 GETIMPORT                        R1 K11 [warn]
       53 LOADK                            R2 K12 ["Invalid joint type"]
       54 CALL                             R1 1 0
...
PROTO_20:
       ...
       96 JUMPIFNOT                        R1 ; [+20]
       97 GETTABLEKS                       R2 R0 K19 ["Attachment0"]
       99 GETTABLEKS                       R2 R2 K17 ["WorldCFrame"]
      ...
      108 JUMPIFNOT                        R1 ; [+8]
      109 GETTABLEKS                       R2 R0 K20 ["Attachment1"]
      111 GETTABLEKS                       R2 R2 K17 ["WorldCFrame"]
...
PROTO_21:
      ...
      100 JUMPIFNOT                        R2 ; [+29]
      101 GETTABLEKS                       R3 R0 K17 ["Attachment0"]
      103 GETTABLEKS                       R3 R3 K18 ["WorldCFrame"]
      ...
      114 JUMPIFNOT                        R2 ; [+15]
      115 GETTABLEKS                       R2 R0 K19 ["Attachment1"]
      117 GETTABLEKS                       R2 R2 K18 ["WorldCFrame"]
...
MAIN:
       ...
       11 GETTABLEKS                       R2 R2 K6 ["getFFlagAdaptiveAnimationConstraints"]
       13 CALL                             R1 1 1
       ...
       31 GETTABLEKS                       R4 R4 K5 ["Flags"]
       33 GETTABLEKS                       R4 R4 K8 ["getFFlagAdaptiveAnimationNaNFix"]
       35 CALL                             R3 1 1
       36 GETIMPORT                        R4 K1 [require]
       38 GETIMPORT                        R5 K3 [script]
       40 GETTABLEKS                       R5 R5 K4 ["Parent"]
       42 GETTABLEKS                       R5 R5 K5 ["Flags"]
       44 GETTABLEKS                       R5 R5 K9 ["getFFlagAdaptiveAnimationSpineRename"]
       46 CALL                             R4 1 1
