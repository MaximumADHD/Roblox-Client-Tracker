PROTO_0:
       ...
       11 CALL                             R3 2 0
       12 GETUPVAL                         R3 1
       13 GETTABLEKS                       R3 R3 K2 ["sampleTposeAdjustment"]
       15 MOVE                             R4 R0
       16 CALL                             R3 1 0
       17 GETUPVAL                         R3 1
       18 GETTABLEKS                       R3 R3 K3 ["clearTransforms"]
       20 MOVE                             R4 R1
       21 CALL                             R3 1 0
       22 GETUPVAL                         R3 1
       23 GETTABLEKS                       R3 R3 K4 ["automaticSize"]
       25 MOVE                             R4 R0
       26 CALL                             R3 1 0
       27 JUMPIFNOT                        R2 ; [+101]
       28 GETUPVAL                         R3 2
       ...
       99 MOVE                             R10 R12
      100 GETUPVAL                         R12 4
      101 GETTABLEKS                       R12 R12 K28 ["autoMapHand"]
      103 MOVE                             R13 R10
      104 MOVE                             R14 R0
      105 CALL                             R12 2 0
      ...
      107 LOADB                            R12 0
      108 GETUPVAL                         R13 5
      109 GETTABLEKS                       R13 R13 K29 ["handRigLabels"]
      111 LOADNIL                          R14
      112 LOADNIL                          R15
      113 FORGPREP                         R13
      114 MOVE                             R20 R17
...
PROTO_1:
        ...
        9 CALL                             R2 1 0
       10 GETUPVAL                         R2 0
       11 GETTABLEKS                       R2 R2 K2 ["clearTransforms"]
       13 MOVE                             R3 R1
       14 CALL                             R2 1 0
       15 GETUPVAL                         R2 0
       16 GETTABLEKS                       R2 R2 K3 ["clearSize"]
       18 MOVE                             R3 R0
       19 CALL                             R2 1 0
       20 GETUPVAL                         R2 0
       21 GETTABLEKS                       R2 R2 K4 ["clearRange"]
       23 MOVE                             R3 R0
       24 CALL                             R2 1 0
       25 RETURN                           R0 0
...
MAIN:
       ...
       56 GETTABLEKS                       R8 R8 K12 ["getFFlagAdaptiveAnimationBetaImprovements"]
       58 CALL                             R7 1 1
