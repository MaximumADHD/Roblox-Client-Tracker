...
MAIN:
       ...
       13 CALL                             R1 1 1
       14 NEWTABLE                         R2 0 0
       16 GETIMPORT                        R3 K9 [Enum.RigLabel]
       18 NAMECALL                         R3 R3 K10 ["GetEnumItems"]
       20 CALL                             R3 1 3
       21 FORGPREP                         R3
       22 GETIMPORT                        R8 K12 [Enum.RigLabel.Invalid]
       24 JUMPIFEQ                         R7 R8 ; [+8]
       26 FASTCALL2                        TABLE_INSERT R2 R7 ; [+5]
       28 MOVE                             R9 R2
       29 MOVE                             R10 R7
       30 GETIMPORT                        R8 K15 [table.insert]
       32 CALL                             R8 2 0
       33 FORGLOOP                         R3 2 ; [-12]
       35 SETTABLEKS                       R2 R0 K16 ["allRigLabels"]
       37 DUPCLOSURE                       R3 K17 [PROTO_0]
       38 CAPTURE                          VAL R1
       39 SETTABLEKS                       R3 R0 K18 ["isValidTJoint"]
       41 DUPCLOSURE                       R3 K19 [PROTO_1]
       42 SETTABLEKS                       R3 R0 K20 ["startsWith"]
       44 DUPCLOSURE                       R3 K21 [PROTO_2]
       45 SETTABLEKS                       R3 R0 K22 ["endsWith"]
       47 DUPCLOSURE                       R3 K23 [PROTO_3]
       48 CAPTURE                          VAL R0
       49 SETTABLEKS                       R3 R0 K24 ["trimStart"]
       51 DUPCLOSURE                       R3 K25 [PROTO_4]
       52 CAPTURE                          VAL R0
       53 SETTABLEKS                       R3 R0 K26 ["trimEnd"]
       55 DUPCLOSURE                       R3 K27 [PROTO_5]
       56 SETTABLEKS                       R3 R0 K28 ["commonPrefix"]
       58 DUPCLOSURE                       R3 K29 [PROTO_6]
       59 CAPTURE                          VAL R0
       60 SETTABLEKS                       R3 R0 K30 ["commonSuffix"]
       62 DUPCLOSURE                       R3 K31 [PROTO_7]
       63 SETTABLEKS                       R3 R0 K32 ["remap"]
       65 DUPCLOSURE                       R3 K33 [PROTO_8]
       66 CAPTURE                          VAL R0
       67 SETTABLEKS                       R3 R0 K34 ["normalizePoints"]
       69 DUPCLOSURE                       R3 K35 [PROTO_9]
       70 SETTABLEKS                       R3 R0 K36 ["getDepth"]
       72 DUPCLOSURE                       R3 K37 [PROTO_11]
       73 CAPTURE                          VAL R1
       74 SETTABLEKS                       R3 R0 K38 ["getJointParent"]
       76 DUPCLOSURE                       R3 K39 [PROTO_12]
       77 CAPTURE                          VAL R0
       78 CAPTURE                          VAL R1
       79 SETTABLEKS                       R3 R0 K40 ["getJointPosition"]
       81 DUPCLOSURE                       R3 K41 [PROTO_13]
       82 CAPTURE                          VAL R0
       83 CAPTURE                          VAL R1
       84 SETTABLEKS                       R3 R0 K42 ["getJointRotation"]
       86 DUPCLOSURE                       R3 K43 [PROTO_14]
       87 CAPTURE                          VAL R1
       88 SETTABLEKS                       R3 R0 K44 ["setJointRotation"]
       90 DUPCLOSURE                       R3 K45 [PROTO_15]
       91 CAPTURE                          VAL R0
       92 DUPCLOSURE                       R4 K46 [PROTO_16]
       93 CAPTURE                          VAL R0
       94 DUPCLOSURE                       R5 K47 [PROTO_17]
       95 CAPTURE                          VAL R0
       96 CAPTURE                          VAL R3
       97 CAPTURE                          VAL R1
       98 SETTABLEKS                       R5 R0 K48 ["getGlobalCoordinateFrame"]
      100 DUPCLOSURE                       R5 K49 [PROTO_18]
      101 CAPTURE                          VAL R0
      102 CAPTURE                          VAL R4
      103 CAPTURE                          VAL R1
      104 SETTABLEKS                       R5 R0 K50 ["setGlobalCoordinateFrame"]
      106 DUPCLOSURE                       R5 K51 [PROTO_19]
      107 CAPTURE                          VAL R1
      108 SETTABLEKS                       R5 R0 K52 ["getJointTransform"]
      110 DUPCLOSURE                       R5 K53 [PROTO_20]
      111 CAPTURE                          VAL R1
      112 SETTABLEKS                       R5 R0 K54 ["setJointTransform"]
      114 DUPCLOSURE                       R5 K55 [PROTO_21]
      115 CAPTURE                          VAL R0
      116 SETTABLEKS                       R5 R0 K56 ["getRigLabelForJoint"]
      118 RETURN                           R0 1
