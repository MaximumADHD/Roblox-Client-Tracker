...
MAIN:
       ...
       66 GETIMPORT                        R2 K55 [pcall]
       68 DUPCLOSURE                       R3 K56 [PROTO_0]
       69 CALL                             R2 1 2
       70 JUMPIFNOT                        R2 ; [+36]
       71 JUMPIFNOT                        R3 ; [+35]
       72 NEWTABLE                         R4 0 15
       74 GETIMPORT                        R5 K58 [Enum.RigLabel.Thumb1]
       76 GETIMPORT                        R6 K60 [Enum.RigLabel.Thumb2]
       78 GETIMPORT                        R7 K62 [Enum.RigLabel.Thumb3]
       80 GETIMPORT                        R8 K64 [Enum.RigLabel.Index1]
       82 GETIMPORT                        R9 K66 [Enum.RigLabel.Index2]
       84 GETIMPORT                        R10 K68 [Enum.RigLabel.Index3]
       86 GETIMPORT                        R11 K70 [Enum.RigLabel.Middle1]
       88 GETIMPORT                        R12 K72 [Enum.RigLabel.Middle2]
       90 GETIMPORT                        R13 K74 [Enum.RigLabel.Middle3]
       92 GETIMPORT                        R14 K76 [Enum.RigLabel.Ring1]
       94 GETIMPORT                        R15 K78 [Enum.RigLabel.Ring2]
       96 GETIMPORT                        R16 K80 [Enum.RigLabel.Ring3]
       98 GETIMPORT                        R17 K82 [Enum.RigLabel.Pinky1]
      100 GETIMPORT                        R18 K84 [Enum.RigLabel.Pinky2]
      102 GETIMPORT                        R19 K86 [Enum.RigLabel.Pinky3]
      104 SETLIST                          R4 R5 15 [1]
      106 JUMP                             ; [+2]
      107 NEWTABLE                         R4 0 0
      109 SETTABLEKS                       R4 R0 K87 ["handRigLabels"]
      111 GETTABLEKS                       R4 R0 K53 ["bodyRigLabels"]
      113 SETTABLEKS                       R4 R0 K88 ["allRigLabels"]
      115 DUPCLOSURE                       R4 K89 [PROTO_1]
      116 CAPTURE                          VAL R1
      117 SETTABLEKS                       R4 R0 K90 ["isValidTJoint"]
      119 DUPCLOSURE                       R4 K91 [PROTO_2]
      120 SETTABLEKS                       R4 R0 K92 ["startsWith"]
      122 DUPCLOSURE                       R4 K93 [PROTO_3]
      123 SETTABLEKS                       R4 R0 K94 ["endsWith"]
      125 DUPCLOSURE                       R4 K95 [PROTO_4]
      126 CAPTURE                          VAL R0
      127 SETTABLEKS                       R4 R0 K96 ["trimStart"]
      129 DUPCLOSURE                       R4 K97 [PROTO_5]
      130 CAPTURE                          VAL R0
      131 SETTABLEKS                       R4 R0 K98 ["trimEnd"]
      133 DUPCLOSURE                       R4 K99 [PROTO_6]
      134 SETTABLEKS                       R4 R0 K100 ["commonPrefix"]
      136 DUPCLOSURE                       R4 K101 [PROTO_7]
      137 CAPTURE                          VAL R0
      138 SETTABLEKS                       R4 R0 K102 ["commonSuffix"]
      140 DUPCLOSURE                       R4 K103 [PROTO_8]
      141 SETTABLEKS                       R4 R0 K104 ["remap"]
      143 DUPCLOSURE                       R4 K105 [PROTO_9]
      144 CAPTURE                          VAL R0
      145 SETTABLEKS                       R4 R0 K106 ["normalizePoints"]
      147 DUPCLOSURE                       R4 K107 [PROTO_10]
      148 SETTABLEKS                       R4 R0 K108 ["getDepth"]
      150 DUPCLOSURE                       R4 K109 [PROTO_12]
      151 CAPTURE                          VAL R1
      152 SETTABLEKS                       R4 R0 K110 ["getJointParent"]
      154 DUPCLOSURE                       R4 K111 [PROTO_13]
      155 CAPTURE                          VAL R0
      156 CAPTURE                          VAL R1
      157 SETTABLEKS                       R4 R0 K112 ["getJointPosition"]
      159 DUPCLOSURE                       R4 K113 [PROTO_14]
      160 CAPTURE                          VAL R0
      161 CAPTURE                          VAL R1
      162 SETTABLEKS                       R4 R0 K114 ["getJointRotation"]
      164 DUPCLOSURE                       R4 K115 [PROTO_15]
      165 CAPTURE                          VAL R1
      166 SETTABLEKS                       R4 R0 K116 ["setJointRotation"]
      168 DUPCLOSURE                       R4 K117 [PROTO_16]
      169 CAPTURE                          VAL R0
      170 DUPCLOSURE                       R5 K118 [PROTO_17]
      171 CAPTURE                          VAL R0
      172 DUPCLOSURE                       R6 K119 [PROTO_18]
      173 CAPTURE                          VAL R0
      174 CAPTURE                          VAL R4
      175 CAPTURE                          VAL R1
      176 SETTABLEKS                       R6 R0 K120 ["getGlobalCoordinateFrame"]
      178 DUPCLOSURE                       R6 K121 [PROTO_19]
      179 CAPTURE                          VAL R0
      180 CAPTURE                          VAL R5
      181 CAPTURE                          VAL R1
      182 SETTABLEKS                       R6 R0 K122 ["setGlobalCoordinateFrame"]
      184 DUPCLOSURE                       R6 K123 [PROTO_20]
      185 CAPTURE                          VAL R1
      186 SETTABLEKS                       R6 R0 K124 ["getJointTransform"]
      188 DUPCLOSURE                       R6 K125 [PROTO_21]
      189 CAPTURE                          VAL R1
      190 SETTABLEKS                       R6 R0 K126 ["setJointTransform"]
      192 DUPCLOSURE                       R6 K127 [PROTO_22]
      193 CAPTURE                          VAL R0
      194 SETTABLEKS                       R6 R0 K128 ["getRigLabelForJoint"]
      196 RETURN                           R0 1
