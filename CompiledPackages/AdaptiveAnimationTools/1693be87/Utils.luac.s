...
PROTO_11:
       ...
       73 JUMPIFNOT                        R1 ; [+18]
       74 JUMPIFNOT                        R0 ; [+17]
       75 GETTABLEKS                       R1 R0 K7 ["Attachment0"]
       77 JUMPIFNOT                        R1 ; [+14]
       78 GETTABLEKS                       R1 R0 K7 ["Attachment0"]
       80 GETTABLEKS                       R1 R1 K3 ["Parent"]
       82 JUMPIFNOT                        R1 ; [+8]
       83 GETTABLEKS                       R1 R0 K7 ["Attachment0"]
       85 GETTABLEKS                       R1 R1 K3 ["Parent"]
       87 LOADK                            R3 K6 ["AnimationConstraint"]
       88 NAMECALL                         R1 R1 K8 ["FindFirstChildWhichIsA"]
       90 CALL                             R1 2 1
       91 RETURN                           R1 1
       92 LOADNIL                          R1
       93 RETURN                           R1 1
...
MAIN:
       ...
       11 GETTABLEKS                       R2 R2 K6 ["getFFlagAdaptiveAnimationConstraintsFix"]
       13 CALL                             R1 1 1
       14 NEWTABLE                         R2 0 22
      ...
      208 SETTABLEKS                       R2 R0 K117 ["getJointParent"]
      210 DUPCLOSURE                       R2 K118 [PROTO_12]
      211 CAPTURE                          VAL R0
      212 SETTABLEKS                       R2 R0 K119 ["getJointPosition"]
      214 DUPCLOSURE                       R2 K120 [PROTO_13]
      215 CAPTURE                          VAL R0
      216 SETTABLEKS                       R2 R0 K121 ["getJointRotation"]
      218 DUPCLOSURE                       R2 K122 [PROTO_14]
      219 SETTABLEKS                       R2 R0 K123 ["setJointRotation"]
      221 DUPCLOSURE                       R2 K124 [PROTO_15]
      222 CAPTURE                          VAL R0
      223 DUPCLOSURE                       R3 K125 [PROTO_16]
      224 CAPTURE                          VAL R0
      225 DUPCLOSURE                       R4 K126 [PROTO_17]
      226 CAPTURE                          VAL R0
      227 CAPTURE                          VAL R2
      228 CAPTURE                          VAL R1
      ...
      233 CAPTURE                          VAL R3
      234 CAPTURE                          VAL R1
      235 SETTABLEKS                       R4 R0 K129 ["setGlobalCoordinateFrame"]
      237 DUPCLOSURE                       R4 K130 [PROTO_19]
      238 SETTABLEKS                       R4 R0 K131 ["getJointTransform"]
      240 DUPCLOSURE                       R4 K132 [PROTO_20]
      241 SETTABLEKS                       R4 R0 K133 ["setJointTransform"]
      243 DUPCLOSURE                       R4 K134 [PROTO_21]
      244 CAPTURE                          VAL R0
      245 SETTABLEKS                       R4 R0 K135 ["getRigLabelForJoint"]
      247 RETURN                           R0 1
