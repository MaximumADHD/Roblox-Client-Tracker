PROTO_0:
        ...
        2 CALL                             R1 1 1
        3 GETUPVAL                         R2 0
        4 GETTABLEKS                       R2 R2 K1 ["guessJointSide"]
        6 MOVE                             R3 R0
        7 CALL                             R2 1 1
        8 LOADNIL                          R3
       ...
       18 DUPTABLE                         R4 K14 [{["finger"] = , ["digit"] = , ["side"]}]
       19 SETTABLEKS                       R3 R4 K13 ["side"]
       21 GETUPVAL                         R5 1
       22 LOADNIL                          R6
       23 LOADNIL                          R7
       24 FORGPREP                         R5
       25 GETTABLEKS                       R12 R9 K15 ["pattern"]
       27 NAMECALL                         R10 R1 K16 ["find"]
       29 CALL                             R10 2 1
       30 JUMPIFNOT                        R10 ; [+5]
       31 GETTABLEKS                       R10 R9 K10 ["finger"]
       33 SETTABLEKS                       R10 R4 K10 ["finger"]
       35 JUMP                             ; [+2]
       36 FORGLOOP                         R5 2 ; [-12]
       38 LOADK                            R7 K17 ["finger%d(%d)"]
       39 NAMECALL                         R5 R1 K18 ["match"]
       41 CALL                             R5 2 1
       42 JUMPIFNOT                        R5 ; [+10]
       43 FASTCALL1                        TONUMBER R5 ; [+3]
       44 MOVE                             R9 R5
       45 GETIMPORT                        R8 K22 [tonumber]
       47 CALL                             R8 1 1
       48 ORK                              R7 R8 K20 [0]
       49 ADDK                             R6 R7 K19 [1]
       50 SETTABLEKS                       R6 R4 K12 ["digit"]
       52 RETURN                           R4 1
       53 LOADNIL                          R6
       54 LOADK                            R9 K23 ["%d+"]
       55 NAMECALL                         R7 R1 K24 ["gmatch"]
       57 CALL                             R7 2 3
       58 FORGPREP                         R7
       59 FASTCALL1                        TONUMBER R10 ; [+3]
       60 MOVE                             R13 R10
       61 GETIMPORT                        R12 K22 [tonumber]
       63 CALL                             R12 1 1
       64 JUMPIFNOT                        R12 ; [+4]
       65 LOADN                            R13 1
       66 JUMPIFNOTLE                      R13 R12 ; [+2]
       68 MOVE                             R6 R12
       69 FORGLOOP                         R7 1 ; [-11]
       71 SETTABLEKS                       R6 R4 K12 ["digit"]
       73 RETURN                           R4 1
...
PROTO_1:
       ...
       20 FORGPREP                         R4
       21 GETUPVAL                         R9 1
       22 GETTABLEKS                       R9 R9 K4 ["isValidTJoint"]
       24 MOVE                             R10 R8
       25 CALL                             R9 1 1
       26 JUMPIFNOT                        R9 ; [+7]
       ...
       50 FORGPREP                         R3
       51 GETUPVAL                         R8 1
       52 GETTABLEKS                       R8 R8 K4 ["isValidTJoint"]
       54 MOVE                             R9 R7
       55 CALL                             R8 1 1
       56 JUMPIFNOT                        R8 ; [+7]
       ...
       81 GETUPVAL                         R9 1
       82 GETTABLEKS                       R9 R9 K4 ["isValidTJoint"]
       84 MOVE                             R10 R8
       85 CALL                             R9 1 1
       86 JUMPIFNOT                        R9 ; [+7]
...
PROTO_7:
       ...
       41 LOADNIL                          R16
       42 FORGPREP                         R14
       43 GETTABLEKS                       R19 R18 K3 ["parse"]
       45 GETTABLEKS                       R19 R19 K4 ["finger"]
       47 JUMPIFNOTEQ                      R19 R12 ; [+20]
       49 GETTABLEKS                       R19 R18 K3 ["parse"]
       51 GETTABLEKS                       R19 R19 K5 ["side"]
       53 JUMPIFEQKNIL                     R19 ; [+7]
       55 GETTABLEKS                       R19 R18 K3 ["parse"]
       57 GETTABLEKS                       R19 R19 K5 ["side"]
...
MAIN:
       ...
       19 CALL                             R3 1 1
       20 NEWTABLE                         R4 0 8
       22 DUPTABLE                         R5 K12 [{["pattern"] = "thumb", ["finger"] = "Thumb"}]
       23 DUPTABLE                         R6 K15 [{["pattern"] = "index", ["finger"] = "Index"}]
       24 DUPTABLE                         R7 K18 [{["pattern"] = "middle", ["finger"] = "Middle"}]
       25 DUPTABLE                         R8 K21 [{["pattern"] = "ring", ["finger"] = "Ring"}]
       26 DUPTABLE                         R9 K24 [{["pattern"] = "pinky", ["finger"] = "Pinky"}]
       27 DUPTABLE                         R10 K26 [{["pattern"] = "little", ["finger"] = "Pinky"}]
       28 DUPTABLE                         R11 K28 [{["pattern"] = "pinkie", ["finger"] = "Pinky"}]
       29 DUPTABLE                         R12 K29 [{["pattern"] = "finger", ["finger"] = "Middle"}]
       30 SETLIST                          R4 R5 8 [1]
       32 DUPCLOSURE                       R5 K30 [PROTO_0]
       33 CAPTURE                          VAL R1
       34 CAPTURE                          VAL R4
       35 DUPCLOSURE                       R6 K31 [PROTO_2]
       36 CAPTURE                          VAL R3
       37 CAPTURE                          VAL R5
       38 DUPCLOSURE                       R7 K32 [PROTO_3]
       39 DUPCLOSURE                       R8 K33 [PROTO_4]
       40 NEWTABLE                         R9 0 5
       42 LOADK                            R10 K11 ["Thumb"]
       43 LOADK                            R11 K14 ["Index"]
       44 LOADK                            R12 K17 ["Middle"]
       45 LOADK                            R13 K20 ["Ring"]
       46 LOADK                            R14 K23 ["Pinky"]
       47 SETLIST                          R9 R10 5 [1]
       49 NEWTABLE                         R10 0 3
       51 LOADN                            R11 1
       52 LOADN                            R12 2
       53 LOADN                            R13 3
       54 SETLIST                          R10 R11 3 [1]
       56 DUPCLOSURE                       R11 K34 [PROTO_7]
       57 CAPTURE                          VAL R6
       58 CAPTURE                          VAL R9
       59 CAPTURE                          VAL R10
       60 CAPTURE                          VAL R8
       61 NEWTABLE                         R12 8 0
       63 SETTABLEKS                       R11 R12 K35 ["setupHand"]
       65 SETTABLEKS                       R5 R12 K36 ["parseFingerName"]
       67 SETTABLEKS                       R8 R12 K37 ["scoreCandidate"]
       69 SETTABLEKS                       R6 R12 K38 ["collectDescendants"]
       71 SETTABLEKS                       R9 R12 K39 ["FINGERS"]
       73 SETTABLEKS                       R10 R12 K40 ["DIGITS"]
       75 RETURN                           R12 1
