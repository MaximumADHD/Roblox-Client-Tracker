...
PROTO_18:
       ...
       32 FORNLOOP                         R4
       33 SETTABLEKS                       R3 R0 K2 ["_s2"]
       35 GETTABLEKS                       R1 R0 K2 ["_s2"]
       37 GETIMPORT                        R2 K8 [table.remove]
       39 MOVE                             R3 R1
       40 CALL                             R2 1 1
       41 SETTABLEKS                       R2 R0 K9 ["_shiftBlock"]
       43 GETTABLEKS                       R1 R0 K10 ["_pushBlock"]
       45 GETTABLEKS                       R2 R0 K9 ["_shiftBlock"]
       47 JUMPIFNOTEQ                      R1 R2 ; [+9]
       49 GETTABLEKS                       R1 R0 K11 ["_pushIndex"]
       51 GETTABLEKS                       R2 R0 K0 ["_shiftIndex"]
       53 JUMPIFNOTEQ                      R1 R2 ; [+3]
       55 LOADNIL                          R1
       56 RETURN                           R1 1
       57 GETTABLEKS                       R2 R0 K9 ["_shiftBlock"]
       59 GETTABLEKS                       R4 R0 K0 ["_shiftIndex"]
       61 ADDK                             R3 R4 K5 [1]
       62 GETTABLE                         R1 R2 R3
       63 GETTABLEKS                       R2 R0 K9 ["_shiftBlock"]
       65 GETTABLEKS                       R4 R0 K0 ["_shiftIndex"]
       67 ADDK                             R3 R4 K5 [1]
       68 LOADNIL                          R4
       69 SETTABLE                         R4 R2 R3
       70 GETTABLEKS                       R2 R0 K0 ["_shiftIndex"]
       72 ADDK                             R2 R2 K5 [1]
       73 SETTABLEKS                       R2 R0 K0 ["_shiftIndex"]
       75 RETURN                           R1 1
...
MAIN:
       ...
       12 GETTABLEKS                       R3 R0 K6 ["JestTypes"]
       14 CALL                             R2 1 1
       15 GETTABLEKS                       R3 R2 K7 ["Error"]
       17 NEWTABLE                         R4 0 0
       19 LOADNIL                          R5
       20 DUPCLOSURE                       R6 K8 [PROTO_0]
       21 NEWCLOSURE                       R7 P1
       22 CAPTURE                          REF R5
       23 CAPTURE                          VAL R1
       24 CAPTURE                          VAL R4
       25 DUPCLOSURE                       R8 K9 [PROTO_11]
       26 CAPTURE                          VAL R7
       27 DUPCLOSURE                       R9 K10 [PROTO_13]
       28 CAPTURE                          VAL R7
       29 CAPTURE                          VAL R3
       30 DUPCLOSURE                       R10 K11 [PROTO_14]
       31 CAPTURE                          VAL R3
       32 CAPTURE                          VAL R7
       33 SETTABLEKS                       R4 R4 K12 ["__index"]
       35 DUPCLOSURE                       R11 K13 [PROTO_15]
       36 CAPTURE                          VAL R4
       37 SETTABLEKS                       R11 R4 K14 ["new"]
       39 NEWTABLE                         R11 0 0
       41 SETTABLEKS                       R11 R11 K12 ["__index"]
       43 DUPCLOSURE                       R12 K15 [PROTO_16]
       44 CAPTURE                          VAL R11
       45 SETTABLEKS                       R12 R11 K14 ["new"]
       47 DUPCLOSURE                       R12 K16 [PROTO_17]
       48 SETTABLEKS                       R12 R11 K17 ["push"]
       50 DUPCLOSURE                       R12 K18 [PROTO_18]
       51 SETTABLEKS                       R12 R11 K19 ["shift"]
       53 MOVE                             R5 R11
       54 CLOSEUPVALS                      R5
       55 RETURN                           R10 1
