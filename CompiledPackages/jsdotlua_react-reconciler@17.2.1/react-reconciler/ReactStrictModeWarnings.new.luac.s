...
MAIN:
  ...
  GETIMPORT R4 K3 [script]
  GETTABLEKS R3 R4 K4 ["Parent"]
  LOADK R5 K9 ["ReactCurrentFiber"]
  NAMECALL R3 R3 K6 ["WaitForChild"]
  CALL R3 2 -1
  CALL R2 -1 1
  GETTABLEKS R3 R2 K10 ["resetCurrentFiber"]
  GETTABLEKS R4 R2 K11 ["setCurrentFiber"]
  ...
  CALL R7 2 -1
  CALL R6 -1 1
  GETTABLEKS R5 R6 K12 ["getComponentName"]
  GETIMPORT R7 K1 [require]
  GETIMPORT R9 K3 [script]
  GETTABLEKS R8 R9 K4 ["Parent"]
  LOADK R10 K13 ["ReactTypeOfMode"]
  NAMECALL R8 R8 K6 ["WaitForChild"]
  CALL R8 2 -1
  CALL R7 -1 1
  GETTABLEKS R6 R7 K14 ["StrictMode"]
  DUPTABLE R7 K20 [{"recordUnsafeLifecycleWarnings", "flushPendingUnsafeLifecycleWarnings", "recordLegacyContextWarning", "flushLegacyContextWarning", "discardPendingWarnings"}]
  DUPCLOSURE R8 K21 [PROTO_0]
  SETTABLEKS R8 R7 K15 ["recordUnsafeLifecycleWarnings"]
  DUPCLOSURE R8 K22 [PROTO_1]
  SETTABLEKS R8 R7 K16 ["flushPendingUnsafeLifecycleWarnings"]
  DUPCLOSURE R8 K23 [PROTO_2]
  SETTABLEKS R8 R7 K17 ["recordLegacyContextWarning"]
  DUPCLOSURE R8 K24 [PROTO_3]
  SETTABLEKS R8 R7 K18 ["flushLegacyContextWarning"]
  DUPCLOSURE R8 K25 [PROTO_4]
  SETTABLEKS R8 R7 K19 ["discardPendingWarnings"]
  GETIMPORT R9 K27 [_G]
  GETTABLEKS R8 R9 K28 ["__DEV__"]
  JUMPIFNOT R8 [+72]
  ...
  CAPTURE VAL R14
  CAPTURE VAL R15
  SETTABLEKS R17 R7 K15 ["recordUnsafeLifecycleWarnings"]
  ...
  CAPTURE VAL R9
  CAPTURE VAL R0
  SETTABLEKS R17 R7 K16 ["flushPendingUnsafeLifecycleWarnings"]
  NEWTABLE R17 0 0
  NEWTABLE R18 0 0
  ...
  CAPTURE VAL R18
  CAPTURE VAL R17
  SETTABLEKS R19 R7 K17 ["recordLegacyContextWarning"]
  ...
  CAPTURE VAL R0
  CAPTURE VAL R3
  SETTABLEKS R19 R7 K18 ["flushLegacyContextWarning"]
  DUPCLOSURE R19 K35 [PROTO_12]
  CAPTURE VAL R10
  CAPTURE VAL R11
  CAPTURE VAL R12
  CAPTURE VAL R13
  ...
  CAPTURE VAL R15
  CAPTURE VAL R17
  SETTABLEKS R19 R7 K19 ["discardPendingWarnings"]
  RETURN R7 1
