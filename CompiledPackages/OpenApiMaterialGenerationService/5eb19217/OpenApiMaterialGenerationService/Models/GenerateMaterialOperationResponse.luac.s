PROTO_0:
       ...
       52 CALL                             R3 2 0
       53 GETTABLEKS                       R3 R0 K10 ["error"]
       55 JUMPIFEQKNIL                     R3 ; [+15]
       57 GETUPVAL                         R3 0
       58 GETTABLEKS                       R3 R3 K11 ["fromResponse"]
       60 GETTABLEKS                       R4 R0 K10 ["error"]
       62 MOVE                             R5 R1
       63 LOADK                            R6 K12 ["%*\"error\" > "]
       64 MOVE                             R8 R2
       65 NAMECALL                         R6 R6 K4 ["format"]
       67 CALL                             R6 2 1
       68 CALL                             R3 3 1
       69 SETTABLEKS                       R3 R0 K10 ["error"]
       71 GETTABLEKS                       R3 R0 K13 ["filteredText"]
       73 JUMPIFEQKNIL                     R3 ; [+26]
       75 GETTABLEKS                       R4 R0 K13 ["filteredText"]
       77 FASTCALL1                        TYPEOF R4 ; [+2]
       78 GETIMPORT                        R3 K1 [typeof]
       80 CALL                             R3 1 1
       81 JUMPIFEQKS                       R3 K8 ["string"] ; [+18]
       83 LOADK                            R5 K14 ["%*\"filteredText\" > Expected string, got %*"]
       84 MOVE                             R7 R2
       85 GETTABLEKS                       R9 R0 K13 ["filteredText"]
...
MAIN:
       ...
       18 GETTABLEKS                       R4 R4 K9 ["TextToImagePublicError"]
       20 CALL                             R3 1 1
