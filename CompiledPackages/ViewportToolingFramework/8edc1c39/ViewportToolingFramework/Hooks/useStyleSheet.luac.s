PROTO_0:
        ...
        7 GETUPVAL                         R1 1
        8 GETTABLEKS                       R1 R1 K2 ["Styling"]
       10 GETTABLEKS                       R1 R1 K3 ["createStudioDesign"]
       12 CALL                             R1 0 1
       13 MOVE                             R0 R1
       14 GETUPVAL                         R1 2
       15 CALL                             R1 0 1
       ...
       38 CALL                             R2 2 0
       39 GETUPVAL                         R2 1
       40 GETTABLEKS                       R2 R2 K2 ["Styling"]
       42 GETTABLEKS                       R2 R2 K10 ["createStyleSheet"]
...
PROTO_3:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["Hooks"]
        3 GETTABLEKS                       R0 R0 K1 ["useStyleSheet"]
        5 CALL                             R0 0 1
        6 GETUPVAL                         R1 1
       ...
       20 CALL                             R1 2 1
       21 GETUPVAL                         R2 1
       22 GETTABLEKS                       R2 R2 K3 ["useEffect"]
       24 NEWCLOSURE                       R3 P1
       25 CAPTURE                          VAL R1
       26 CAPTURE                          UPVAL U2
       27 NEWTABLE                         R4 0 0
...
PROTO_4:
       ...
       21 SETTABLEKS                       R1 R0 K5 ["Parent"]
       23 GETUPVAL                         R1 1
       24 GETTABLEKS                       R1 R1 K2 ["Styling"]
       26 GETTABLEKS                       R1 R1 K6 ["createStyleSheet"]
...
PROTO_7:
        ...
        8 CALL                             R0 1 1
        9 GETUPVAL                         R1 0
       10 GETTABLEKS                       R1 R1 K2 ["useEffect"]
       12 NEWCLOSURE                       R2 P1
       13 CAPTURE                          VAL R0
       14 CAPTURE                          UPVAL U1
       15 NEWTABLE                         R3 0 0
...
MAIN:
       ...
       41 GETTABLEKS                       R7 R1 K15 ["Flags"]
       43 GETTABLEKS                       R7 R7 K16 ["getFFlagViewportToolingFrameworkMoreComponents"]
       45 CALL                             R6 1 1
       46 GETIMPORT                        R7 K9 [require]
       48 GETTABLEKS                       R8 R1 K15 ["Flags"]
       50 GETTABLEKS                       R8 R8 K17 ["getFFlagViewportToolingFrameworkRenameCreatedStudioDesign"]
       52 CALL                             R7 1 1
