...
-- They look like buttons, but they have an arrow to select more options.
export type Dropdown = {
	...
	-- An optional method for when you click on the icon itself.
	-- If unspecified, will just open the dropdown normally.
	OnClickIcon: () -> ()?,
...
export type ToolbarVerticalItem = Button | Dropdown | SplitButton | Radio | Separator
