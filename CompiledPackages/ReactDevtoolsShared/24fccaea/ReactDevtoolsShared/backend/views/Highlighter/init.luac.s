...
PROTO_10:
       ...
       16 JUMPIFNOTEQKNIL                  R7 ; [+11]
       18 GETUPVAL                         R8 1
       19 GETTABLEKS                       R8 R8 K7 ["warn"]
       21 LOADK                            R9 K8 ["Invalid renderer id \"%*\" for element \"%*\""]
       22 MOVE                             R11 R5
       23 MOVE                             R12 R3
       24 NAMECALL                         R9 R9 K9 ["format"]
       26 CALL                             R9 3 1
       27 CALL                             R8 1 0
       28 LOADNIL                          R8
       29 JUMPIFEQKNIL                     R7 ; [+6]
       31 GETTABLEKS                       R9 R7 K10 ["findNativeNodesForFiberID"]
       33 MOVE                             R10 R3
       34 CALL                             R9 1 1
       35 MOVE                             R8 R9
       36 JUMPIFEQKNIL                     R8 ; [+31]
       38 GETTABLEN                        R9 R8 1
       39 JUMPIFEQKNIL                     R9 ; [+28]
       41 GETUPVAL                         R9 2
       42 MOVE                             R10 R8
       43 CALL                             R9 1 1
       44 LENGTH                           R10 R9
       45 JUMPIFNOTEQKN                    R10 K11 [0] ; [+4]
       47 GETUPVAL                         R10 3
       48 CALL                             R10 0 0
       49 RETURN                           R0 0
       50 GETUPVAL                         R10 4
       ...
       55 JUMPIFNOT                        R4 ; [+14]
       56 GETUPVAL                         R10 5
       57 GETTABLEKS                       R10 R10 K12 ["__REACT_DEVTOOLS_GLOBAL_HOOK__"]
       59 GETTABLEN                        R11 R9 1
       60 SETTABLEKS                       R11 R10 K13 ["$0"]
       62 GETUPVAL                         R10 6
       63 LOADK                            R12 K14 ["syncSelectionToNativeElementsPanel"]
       64 NAMECALL                         R10 R10 K15 ["send"]
       66 CALL                             R10 2 0
       67 RETURN                           R0 0
       68 GETUPVAL                         R9 3
       69 CALL                             R9 0 0
