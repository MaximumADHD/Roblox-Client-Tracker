...
MAIN:
  ...
  GETTABLEKS R18 R19 K24 ["views"]
  GETTABLEKS R17 R18 K25 ["Highlighter"]
  CALL R16 1 1
  GETTABLEKS R17 R16 K26 ["setupHighlighter"]
  DUPCLOSURE R18 K27 [PROTO_1]
  DUPCLOSURE R19 K28 [PROTO_2]
  ...
  CALL R24 1 1
  DUPCLOSURE R25 K33 [PROTO_5]
  CAPTURE VAL R11
  NEWTABLE R27 0 0
  DUPTABLE R28 K35 [{"__index"}]
  SETTABLEKS R5 R28 K34 ["__index"]
  FASTCALL2 SETMETATABLE R27 R28 [+3]
  GETIMPORT R26 K37 [setmetatable]
  CALL R26 2 1
  DUPTABLE R27 K35 [{"__index"}]
  SETTABLEKS R26 R27 K34 ["__index"]
  ...
  CAPTURE VAL R3
  CAPTURE VAL R17
  SETTABLEKS R28 R26 K39 ["new"]
  DUPCLOSURE R28 K40 [PROTO_9]
  SETTABLEKS R28 R26 K41 ["getRendererInterfaces"]
  DUPCLOSURE R28 K42 [PROTO_10]
  CAPTURE VAL R2
  SETTABLEKS R28 R26 K43 ["copyElementPath"]
  DUPCLOSURE R28 K44 [PROTO_11]
  CAPTURE VAL R2
  SETTABLEKS R28 R26 K45 ["deletePath"]
  DUPCLOSURE R28 K46 [PROTO_12]
  CAPTURE VAL R2
  SETTABLEKS R28 R26 K47 ["getInstanceAndStyle"]
  DUPCLOSURE R28 K48 [PROTO_13]
  SETTABLEKS R28 R26 K49 ["getIDForNode"]
  DUPCLOSURE R28 K50 [PROTO_14]
  CAPTURE VAL R2
  SETTABLEKS R28 R26 K51 ["getProfilingData"]
  DUPCLOSURE R28 K52 [PROTO_15]
  SETTABLEKS R28 R26 K53 ["getProfilingStatus"]
  DUPCLOSURE R28 K54 [PROTO_16]
  CAPTURE VAL R2
  SETTABLEKS R28 R26 K55 ["getOwnersList"]
  DUPCLOSURE R28 K56 [PROTO_17]
  CAPTURE VAL R2
  SETTABLEKS R28 R26 K57 ["inspectElement"]
  DUPCLOSURE R28 K58 [PROTO_18]
  CAPTURE VAL R2
  SETTABLEKS R28 R26 K59 ["logElementToConsole"]
  DUPCLOSURE R28 K60 [PROTO_19]
  CAPTURE VAL R2
  SETTABLEKS R28 R26 K61 ["overrideSuspense"]
  DUPCLOSURE R28 K62 [PROTO_20]
  CAPTURE VAL R2
  SETTABLEKS R28 R26 K63 ["overrideValueAtPath"]
  DUPCLOSURE R28 K64 [PROTO_21]
  SETTABLEKS R28 R26 K65 ["overrideContext"]
  DUPCLOSURE R28 K66 [PROTO_22]
  SETTABLEKS R28 R26 K67 ["overrideHookState"]
  DUPCLOSURE R28 K68 [PROTO_23]
  SETTABLEKS R28 R26 K69 ["overrideProps"]
  DUPCLOSURE R28 K70 [PROTO_24]
  SETTABLEKS R28 R26 K71 ["overrideState"]
  DUPCLOSURE R28 K72 [PROTO_26]
  CAPTURE VAL R15
  CAPTURE VAL R9
  CAPTURE VAL R10
  SETTABLEKS R28 R26 K73 ["reloadAndProfile"]
  DUPCLOSURE R28 K74 [PROTO_27]
  CAPTURE VAL R2
  SETTABLEKS R28 R26 K75 ["renamePath"]
  DUPCLOSURE R28 K76 [PROTO_28]
  SETTABLEKS R28 R26 K77 ["selectNode"]
  DUPCLOSURE R28 K78 [PROTO_29]
  SETTABLEKS R28 R26 K79 ["setRendererInterface"]
  DUPCLOSURE R28 K80 [PROTO_30]
  SETTABLEKS R28 R26 K81 ["setTraceUpdatesEnabled"]
  DUPCLOSURE R28 K82 [PROTO_31]
  CAPTURE VAL R4
  SETTABLEKS R28 R26 K83 ["syncSelectionFromNativeElementsPanel"]
  DUPCLOSURE R28 K84 [PROTO_32]
  SETTABLEKS R28 R26 K85 ["shutdown"]
  DUPCLOSURE R28 K86 [PROTO_33]
  SETTABLEKS R28 R26 K87 ["startProfiling"]
  DUPCLOSURE R28 K88 [PROTO_34]
  SETTABLEKS R28 R26 K89 ["stopProfiling"]
  DUPCLOSURE R28 K90 [PROTO_35]
  CAPTURE VAL R2
  SETTABLEKS R28 R26 K91 ["storeAsGlobal"]
  DUPCLOSURE R28 K92 [PROTO_36]
  SETTABLEKS R28 R26 K93 ["updateConsolePatchSettings"]
  DUPCLOSURE R28 K94 [PROTO_37]
  SETTABLEKS R28 R26 K95 ["updateComponentFilters"]
  DUPCLOSURE R28 K96 [PROTO_38]
  CAPTURE VAL R2
  SETTABLEKS R28 R26 K97 ["viewAttributeSource"]
  DUPCLOSURE R28 K98 [PROTO_39]
  CAPTURE VAL R2
  SETTABLEKS R28 R26 K99 ["viewElementSource"]
  DUPCLOSURE R28 K100 [PROTO_40]
  SETTABLEKS R28 R26 K101 ["onTraceUpdates"]
  DUPCLOSURE R28 K102 [PROTO_41]
  CAPTURE VAL R4
  CAPTURE VAL R25
  CAPTURE VAL R2
  SETTABLEKS R28 R26 K103 ["onHookOperations"]
  DUPCLOSURE R28 K104 [PROTO_42]
  SETTABLEKS R28 R26 K105 ["onUnsupportedRenderer"]
  DUPCLOSURE R29 K106 [PROTO_44]
  CAPTURE VAL R15
  CAPTURE VAL R8
  CAPTURE VAL R3
  CAPTURE VAL R14
  MOVE R28 R29
  SETTABLEKS R28 R26 K107 ["_throttledPersistSelection"]
  RETURN R26 1
