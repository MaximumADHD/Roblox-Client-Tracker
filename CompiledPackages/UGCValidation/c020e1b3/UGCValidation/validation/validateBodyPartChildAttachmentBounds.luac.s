PROTO_0:
       ...
       57 GETUPVAL                         R18 2
       58 GETTABLEKS                       R18 R18 K13 ["reportFailure"]
       60 GETUPVAL                         R19 2
       61 GETTABLEKS                       R19 R19 K14 ["ErrorType"]
       63 GETTABLEKS                       R19 R19 K15 ["validateBodyPartChildAttachmentBounds_InvalidAttachmentPosition"]
       65 LOADNIL                          R20
       66 MOVE                             R21 R3
       67 CALL                             R18 3 0
       68 GETUPVAL                         R18 3
       69 GETTABLEKS                       R18 R18 K16 ["clampAttachmentToBounds"]
       71 MOVE                             R19 R0
       72 MOVE                             R20 R4
       73 MOVE                             R21 R2
       ...
       82 CALL                             R19 2 0
       83 GETUPVAL                         R19 3
       84 GETTABLEKS                       R19 R19 K21 ["calculateAcceptableBoundsLocalSpace"]
       86 MOVE                             R20 R2
       87 MOVE                             R21 R4
       88 MOVE                             R22 R7
       89 MOVE                             R23 R6
      ...
      127 GETUPVAL                         R32 4
      128 GETTABLEKS                       R33 R0 K34 ["CFrame"]
      130 GETTABLEKS                       R33 R33 K6 ["Position"]
      132 LOADN                            R34 3
      133 CALL                             R32 2 1
      134 GETUPVAL                         R33 4
...
PROTO_1:
        ...
        3 CALL                             R5 0 1
        4 GETTABLEKS                       R8 R2 K1 ["rigAttachmentToParent"]
        6 GETTABLEKS                       R8 R8 K2 ["name"]
        8 GETUPVAL                         R9 1
        9 GETTABLEKS                       R9 R9 K3 ["checkFlagEnabledForAllowHrd"]
       11 CALL                             R9 0 -1
       ...
       21 MOVE                             R10 R6
       22 MOVE                             R11 R0
       23 GETTABLEKS                       R12 R2 K1 ["rigAttachmentToParent"]
       25 GETTABLEKS                       R12 R12 K7 ["bounds"]
       27 MOVE                             R13 R3
       28 MOVE                             R14 R4
       29 CALL                             R9 5 -1
       ...
       39 MOVE                             R14 R10
       40 GETUPVAL                         R15 1
       41 GETTABLEKS                       R15 R15 K3 ["checkFlagEnabledForAllowHrd"]
       43 CALL                             R15 0 -1
...
PROTO_2:
       ...
       11 CALL                             R5 1 0
       12 GETUPVAL                         R6 0
       13 GETTABLEKS                       R6 R6 K6 ["ASSET_TYPE_INFO"]
       ...
       24 CALL                             R6 0 1
       25 GETUPVAL                         R7 2
       26 GETTABLEKS                       R7 R7 K8 ["calculateIndividualAssetPartsData"]
       28 MOVE                             R8 R0
       29 MOVE                             R9 R1
       30 CALL                             R7 2 3
       31 JUMPIF                           R7 ; [+1]
       ...
       41 MOVE                             R14 R0
       42 MOVE                             R15 R4
       43 GETTABLEKS                       R16 R5 K14 ["subParts"]
       45 GETTABLEKS                       R16 R16 K15 ["Head"]
       47 MOVE                             R17 R1
       48 MOVE                             R18 R10
       49 CALL                             R13 5 -1
       ...
       82 GETUPVAL                         R10 4
       83 GETTABLEKS                       R10 R10 K20 ["recordScriptTime"]
       85 GETIMPORT                        R11 K22 [script]
       87 GETTABLEKS                       R11 R11 K13 ["Name"]
       89 MOVE                             R12 R2
       90 MOVE                             R13 R1
       91 CALL                             R10 3 0
...
MAIN:
       ...
       35 GETTABLEKS                       R6 R6 K10 ["prettyPrintVector3"]
       37 CALL                             R5 1 1
       ...
       49 GETTABLEKS                       R8 R8 K12 ["BoundsDataUtils"]
       51 CALL                             R7 1 1
       52 GETIMPORT                        R8 K4 [require]
       54 GETTABLEKS                       R9 R0 K5 ["util"]
       56 GETTABLEKS                       R9 R9 K13 ["MeshSpaceUtils"]
       58 CALL                             R8 1 1
       59 GETIMPORT                        R9 K4 [require]
       61 GETTABLEKS                       R10 R0 K14 ["flags"]
       63 GETTABLEKS                       R10 R10 K15 ["getFStringUGCValidationAttachmentErrorLink"]
       65 CALL                             R9 1 1
       66 GETIMPORT                        R10 K4 [require]
       68 GETTABLEKS                       R11 R0 K5 ["util"]
       70 GETTABLEKS                       R11 R11 K16 ["R15plusUtils"]
       72 CALL                             R10 1 1
       73 GETIMPORT                        R11 K4 [require]
       75 GETTABLEKS                       R12 R0 K5 ["util"]
       77 GETTABLEKS                       R12 R12 K17 ["getAttachmentCFrameInPartSpace"]
       79 CALL                             R11 1 1
