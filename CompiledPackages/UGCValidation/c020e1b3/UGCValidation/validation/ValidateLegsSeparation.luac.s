PROTO_0:
        ...
        4 GETTABLEKS                       R3 R0 K4 ["RightUpperLeg"]
        6 GETTABLEKS                       R3 R3 K5 ["Size"]
        8 GETTABLEKS                       R3 R3 K6 ["X"]
       10 GETUPVAL                         R4 0
       11 GETTABLEKS                       R4 R4 K7 ["asNumber"]
       13 CALL                             R4 0 1
       14 MUL                              R2 R3 R4
       15 GETTABLEKS                       R3 R0 K4 ["RightUpperLeg"]
       17 GETTABLEKS                       R3 R3 K8 ["RightHipRigAttachment"]
       19 GETTABLEKS                       R3 R3 K9 ["CFrame"]
       21 GETTABLEKS                       R3 R3 K10 ["Position"]
       23 GETTABLEKS                       R3 R3 K6 ["X"]
       ...
       33 GETTABLEKS                       R7 R0 K4 ["RightUpperLeg"]
       35 GETTABLEKS                       R7 R7 K8 ["RightHipRigAttachment"]
       37 GETTABLEKS                       R7 R7 K9 ["CFrame"]
       39 GETTABLEKS                       R7 R7 K10 ["Position"]
       ...
       53 GETTABLEKS                       R4 R0 K17 ["LeftUpperLeg"]
       55 GETTABLEKS                       R4 R4 K5 ["Size"]
       57 GETTABLEKS                       R4 R4 K6 ["X"]
       59 MINUS                            R3 R4
       60 GETUPVAL                         R4 0
       61 GETTABLEKS                       R4 R4 K7 ["asNumber"]
       63 CALL                             R4 0 1
       64 MUL                              R2 R3 R4
       65 GETTABLEKS                       R3 R0 K17 ["LeftUpperLeg"]
       67 GETTABLEKS                       R3 R3 K18 ["LeftHipRigAttachment"]
       69 GETTABLEKS                       R3 R3 K9 ["CFrame"]
       71 GETTABLEKS                       R3 R3 K10 ["Position"]
       73 GETTABLEKS                       R3 R3 K6 ["X"]
       ...
       83 GETTABLEKS                       R7 R0 K17 ["LeftUpperLeg"]
       85 GETTABLEKS                       R7 R7 K18 ["LeftHipRigAttachment"]
       87 GETTABLEKS                       R7 R7 K9 ["CFrame"]
       89 GETTABLEKS                       R7 R7 K10 ["Position"]
       91 GETTABLEKS                       R7 R7 K6 ["X"]
       93 MOVE                             R8 R2
       94 CALL                             R5 3 -1
...
PROTO_1:
       ...
       34 JUMPIF                           R5 ; [+11]
       35 GETUPVAL                         R5 2
       36 GETTABLEKS                       R5 R5 K14 ["reportFailure"]
       38 GETUPVAL                         R6 2
       39 GETTABLEKS                       R6 R6 K15 ["ErrorType"]
       41 GETTABLEKS                       R6 R6 K16 ["validateLegsSeparation_InvalidAttachmentPosition"]
       43 LOADNIL                          R7
       44 MOVE                             R8 R1
       45 CALL                             R5 3 0
       46 GETUPVAL                         R5 2
       47 GETTABLEKS                       R5 R5 K17 ["recordScriptTime"]
       49 GETIMPORT                        R6 K19 [script]
       51 GETTABLEKS                       R6 R6 K20 ["Name"]
       53 MOVE                             R7 R2
       54 MOVE                             R8 R1
       55 CALL                             R5 3 0
...
PROTO_3:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R2 R2 K0 ["calculateIndividualFullBodyPartsData"]
        3 MOVE                             R3 R0
        4 MOVE                             R4 R1
        5 LOADNIL                          R5
        6 LOADB                            R6 0
       ...
       14 NEWTABLE                         R7 0 3
       16 GETUPVAL                         R8 2
       17 GETTABLEKS                       R8 R8 K1 ["NAMED_R15_BODY_PARTS"]
       19 GETTABLEKS                       R8 R8 K2 ["LeftUpperLeg"]
       21 GETUPVAL                         R9 2
       22 GETTABLEKS                       R9 R9 K1 ["NAMED_R15_BODY_PARTS"]
       24 GETTABLEKS                       R9 R9 K3 ["LeftLowerLeg"]
       26 GETUPVAL                         R10 2
       27 GETTABLEKS                       R10 R10 K1 ["NAMED_R15_BODY_PARTS"]
       29 GETTABLEKS                       R10 R10 K4 ["LeftFoot"]
       31 SETLIST                          R7 R8 3 [1]
       33 CALL                             R5 2 1
       34 GETUPVAL                         R6 3
       35 GETTABLEKS                       R6 R6 K5 ["calculateBoundsCenters"]
       37 MOVE                             R7 R5
       38 CALL                             R6 1 1
       39 GETUPVAL                         R7 3
       40 GETTABLEKS                       R7 R7 K6 ["calculateBoundsDimensions"]
       42 MOVE                             R8 R5
       43 CALL                             R7 1 1
       44 GETUPVAL                         R8 1
       45 MOVE                             R9 R4
       46 NEWTABLE                         R10 0 3
       48 GETUPVAL                         R11 2
       49 GETTABLEKS                       R11 R11 K1 ["NAMED_R15_BODY_PARTS"]
       51 GETTABLEKS                       R11 R11 K7 ["RightUpperLeg"]
       53 GETUPVAL                         R12 2
       54 GETTABLEKS                       R12 R12 K1 ["NAMED_R15_BODY_PARTS"]
       56 GETTABLEKS                       R12 R12 K8 ["RightLowerLeg"]
       58 GETUPVAL                         R13 2
       59 GETTABLEKS                       R13 R13 K1 ["NAMED_R15_BODY_PARTS"]
       61 GETTABLEKS                       R13 R13 K9 ["RightFoot"]
       63 SETLIST                          R10 R11 3 [1]
       65 CALL                             R8 2 1
       66 GETUPVAL                         R9 3
       67 GETTABLEKS                       R9 R9 K5 ["calculateBoundsCenters"]
       69 MOVE                             R10 R8
       70 CALL                             R9 1 1
       71 GETUPVAL                         R10 3
       72 GETTABLEKS                       R10 R10 K6 ["calculateBoundsDimensions"]
       74 MOVE                             R11 R8
       75 CALL                             R10 1 1
       76 JUMPIFNOT                        R6 ; [+3]
       77 JUMPIFNOT                        R7 ; [+2]
      ...
      101 GETUPVAL                         R16 4
      102 GETTABLEKS                       R16 R16 K12 ["asNumber"]
      104 CALL                             R16 0 1
      105 MUL                              R14 R15 R16
      106 GETTABLEKS                       R16 R10 K10 ["X"]
      108 GETUPVAL                         R17 4
      109 GETTABLEKS                       R17 R17 K12 ["asNumber"]
      111 CALL                             R17 0 1
      112 MUL                              R15 R16 R17
...
PROTO_4:
       ...
       22 JUMPIF                           R4 ; [+11]
       23 GETUPVAL                         R4 3
       24 GETTABLEKS                       R4 R4 K5 ["reportFailure"]
       26 GETUPVAL                         R5 3
       27 GETTABLEKS                       R5 R5 K6 ["ErrorType"]
       29 GETTABLEKS                       R5 R5 K7 ["validateLegsSeparation_LegsOverlap"]
       31 LOADNIL                          R6
       32 MOVE                             R7 R1
       33 CALL                             R4 3 0
       34 GETUPVAL                         R4 3
       35 GETTABLEKS                       R4 R4 K8 ["recordScriptTime"]
       37 GETIMPORT                        R5 K10 [script]
       39 GETTABLEKS                       R5 R5 K11 ["Name"]
       41 MOVE                             R6 R2
       42 MOVE                             R7 R1
       43 CALL                             R4 3 0
