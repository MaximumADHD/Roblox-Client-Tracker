PROTO_0:
        ...
        3 CALL                             R3 0 1
        4 GETUPVAL                         R4 1
        5 GETTABLEKS                       R4 R4 K1 ["findSurfaceAppearancesMissingTexturePacks"]
        7 MOVE                             R5 R0
        8 MOVE                             R6 R1
        9 CALL                             R4 2 1
       10 MOVE                             R5 R4
       ...
       36 GETUPVAL                         R5 2
       37 GETTABLEKS                       R5 R5 K6 ["reportFailure"]
       39 GETUPVAL                         R6 2
       40 GETTABLEKS                       R6 R6 K7 ["ErrorType"]
       42 GETTABLEKS                       R6 R6 K8 ["validateTexturePack_InvalidTexturePackURL"]
       44 LOADNIL                          R7
       45 MOVE                             R8 R2
       46 CALL                             R5 3 0
...
PROTO_2:
        ...
        5 LOADB                            R4 0
        6 GETUPVAL                         R5 1
        7 GETTABLEKS                       R5 R5 K1 ["findSurfaceAppearancesWithTexturePacks"]
        9 MOVE                             R6 R0
       10 CALL                             R5 1 3
       11 FORGPREP                         R5
       ...
       66 JUMPIFNOT                        R4 ; [+11]
       67 GETUPVAL                         R5 3
       68 GETTABLEKS                       R5 R5 K12 ["reportFailure"]
       70 GETUPVAL                         R6 3
       71 GETTABLEKS                       R6 R6 K13 ["ErrorType"]
       73 GETTABLEKS                       R6 R6 K14 ["validateTexturePack_FailedToDownloadTexturePack"]
       75 LOADNIL                          R7
       76 MOVE                             R8 R1
       77 CALL                             R5 3 0
       78 JUMPIFNOT                        R3 ; [+11]
       79 GETUPVAL                         R5 3
       80 GETTABLEKS                       R5 R5 K12 ["reportFailure"]
       82 GETUPVAL                         R6 3
       83 GETTABLEKS                       R6 R6 K13 ["ErrorType"]
       85 GETTABLEKS                       R6 R6 K15 ["validateTexturePack_TexturePackMismatch"]
       87 LOADNIL                          R7
       88 MOVE                             R8 R1
       89 CALL                             R5 3 0
...
PROTO_3:
       ...
       54 CALL                             R7 -1 0
       55 GETUPVAL                         R7 5
       56 GETTABLEKS                       R7 R7 K6 ["recordScriptTime"]
       58 GETIMPORT                        R8 K8 [script]
       60 GETTABLEKS                       R8 R8 K9 ["Name"]
       62 MOVE                             R9 R5
       63 MOVE                             R10 R2
       64 CALL                             R7 3 0
...
MAIN:
       ...
       37 GETTABLEKS                       R8 R1 K14 ["flags"]
       39 GETTABLEKS                       R8 R8 K15 ["getFFlagUGCValidateTexturePack"]
       41 CALL                             R7 1 1
       42 GETIMPORT                        R8 K8 [require]
       44 GETTABLEKS                       R9 R1 K14 ["flags"]
       46 GETTABLEKS                       R9 R9 K16 ["getFFlagUGCValidateTexturePackOnRCCOnly"]
       48 CALL                             R8 1 1
       49 NEWTABLE                         R9 1 0
