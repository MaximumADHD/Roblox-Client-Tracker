...
PROTO_1:
       ...
       34 GETUPVAL                         R4 0
       35 GETTABLEKS                       R4 R4 K11 ["validate"]
       37 MOVE                             R5 R0
       38 CALL                             R4 1 -1
       39 RETURN                           R4 -1
       40 GETUPVAL                         R4 1
       ...
       42 JUMPIFNOT                        R4 ; [+10]
       43 GETUPVAL                         R4 2
       44 GETTABLEKS                       R4 R4 K12 ["isMakeupAsset"]
       46 MOVE                             R5 R2
       47 CALL                             R4 1 1
       48 JUMPIFNOT                        R4 ; [+4]
       49 GETUPVAL                         R4 3
       ...
       52 RETURN                           R4 -1
       53 GETUPVAL                         R4 2
       54 GETTABLEKS                       R4 R4 K13 ["isBodyPart"]
       56 MOVE                             R5 R2
       57 CALL                             R4 1 1
       58 JUMPIFNOT                        R4 ; [+4]
       59 GETUPVAL                         R4 4
...
MAIN:
       ...
       18 GETTABLEKS                       R3 R3 K8 ["getFFlagUGCValidationMakeupSupport"]
       20 CALL                             R2 1 1
       ...
       30 GETTABLEKS                       R5 R5 K10 ["isMeshPartAccessory"]
       32 CALL                             R4 1 1
       33 GETIMPORT                        R5 K4 [require]
       35 GETTABLEKS                       R6 R0 K5 ["util"]
       37 GETTABLEKS                       R6 R6 K11 ["isLayeredClothing"]
       39 CALL                             R5 1 1
       40 GETIMPORT                        R6 K4 [require]
       42 GETTABLEKS                       R7 R0 K12 ["validation"]
       44 GETTABLEKS                       R7 R7 K13 ["validateLayeredClothingAccessory"]
       46 CALL                             R6 1 1
       47 GETIMPORT                        R7 K4 [require]
       49 GETTABLEKS                       R8 R0 K12 ["validation"]
       51 GETTABLEKS                       R8 R8 K14 ["validateLegacyAccessory"]
       53 CALL                             R7 1 1
       54 GETIMPORT                        R8 K4 [require]
       56 GETTABLEKS                       R9 R0 K12 ["validation"]
       58 GETTABLEKS                       R9 R9 K15 ["validateMeshPartAccessory"]
       60 CALL                             R8 1 1
       61 GETIMPORT                        R9 K4 [require]
       63 GETTABLEKS                       R10 R0 K12 ["validation"]
       65 GETTABLEKS                       R10 R10 K16 ["validateMakeupAsset"]
       67 CALL                             R9 1 1
       68 GETIMPORT                        R10 K4 [require]
       70 GETTABLEKS                       R11 R0 K12 ["validation"]
       72 GETTABLEKS                       R11 R11 K17 ["validateLimbsAndTorso"]
       74 CALL                             R10 1 1
       75 GETIMPORT                        R11 K4 [require]
       77 GETTABLEKS                       R12 R0 K12 ["validation"]
       79 GETTABLEKS                       R12 R12 K18 ["validateDynamicHeadMeshPartFormat"]
       81 CALL                             R11 1 1
       82 GETIMPORT                        R12 K4 [require]
       84 GETTABLEKS                       R13 R0 K12 ["validation"]
       86 GETTABLEKS                       R13 R13 K19 ["validatePackage"]
       88 CALL                             R12 1 1
       89 GETIMPORT                        R13 K4 [require]
       91 GETTABLEKS                       R14 R0 K12 ["validation"]
       93 GETTABLEKS                       R14 R14 K20 ["ValidateEmoteAnimation"]
       95 CALL                             R13 1 1
