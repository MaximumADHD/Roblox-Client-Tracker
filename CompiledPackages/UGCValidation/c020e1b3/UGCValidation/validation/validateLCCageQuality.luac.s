PROTO_0:
       ...
       76 MOVE                             R17 R12
       77 MOVE                             R18 R1
       78 GETTABLEKS                       R19 R6 K14 ["ReferenceOrigin"]
       80 GETTABLEKS                       R19 R19 K15 ["Position"]
       82 GETTABLEKS                       R20 R6 K16 ["CageOrigin"]
       84 GETTABLEKS                       R20 R20 K15 ["Position"]
       86 MOVE                             R21 R2
       87 CALL                             R15 6 2
       88 MOVE                             R13 R15
       89 MOVE                             R14 R16
      ...
      208 LOADB                            R3 0
      209 GETUPVAL                         R15 7
      210 GETTABLEKS                       R15 R15 K27 ["validate"]
      212 MOVE                             R16 R11
...
MAIN:
       ...
       30 GETTABLEKS                       R5 R0 K5 ["validation"]
       32 GETTABLEKS                       R5 R5 K10 ["validateVerticesSimilarity"]
       34 CALL                             R4 1 1
       35 GETIMPORT                        R5 K4 [require]
       37 GETTABLEKS                       R6 R0 K5 ["validation"]
       39 GETTABLEKS                       R6 R6 K11 ["validateLCCagingRelevancy"]
       41 CALL                             R5 1 1
       42 GETIMPORT                        R6 K4 [require]
       44 GETTABLEKS                       R7 R0 K5 ["validation"]
       46 GETTABLEKS                       R7 R7 K12 ["validateRenderMeshInsideOuterCageMesh"]
       48 CALL                             R6 1 1
       49 GETIMPORT                        R7 K4 [require]
       51 GETTABLEKS                       R8 R0 K5 ["validation"]
       53 GETTABLEKS                       R8 R8 K13 ["validateCageMeshDistance"]
       55 CALL                             R7 1 1
       56 GETIMPORT                        R8 K4 [require]
       58 GETTABLEKS                       R9 R0 K5 ["validation"]
       60 GETTABLEKS                       R9 R9 K14 ["validateCageUVDuplicates"]
       62 CALL                             R8 1 1
       63 GETIMPORT                        R9 K4 [require]
       65 GETTABLEKS                       R10 R0 K5 ["validation"]
       67 GETTABLEKS                       R10 R10 K15 ["ValidateModifiedCageArea"]
       69 CALL                             R9 1 1
       70 GETIMPORT                        R10 K4 [require]
       72 GETTABLEKS                       R11 R0 K16 ["util"]
       74 GETTABLEKS                       R11 R11 K17 ["Types"]
       76 CALL                             R10 1 1
