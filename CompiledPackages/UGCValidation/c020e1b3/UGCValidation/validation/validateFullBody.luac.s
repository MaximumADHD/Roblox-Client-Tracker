...
PROTO_7:
      ...
      100 CALL                             R13 1 0
      101 GETUPVAL                         R13 7
      102 GETTABLEKS                       R13 R13 K14 ["validateAll"]
      104 MOVE                             R14 R12
      105 MOVE                             R15 R0
      106 CALL                             R13 2 1
      107 JUMPIF                           R13 ; [+26]
      108 GETUPVAL                         R13 8
      109 GETTABLEKS                       R13 R13 K15 ["reportFailure"]
      111 GETUPVAL                         R14 8
      112 GETTABLEKS                       R14 R14 K16 ["ErrorType"]
      114 GETTABLEKS                       R14 R14 K17 ["validateFullBody_ZeroMeshSize"]
      116 LOADNIL                          R15
      117 MOVE                             R16 R0
      118 CALL                             R13 3 0
      119 GETUPVAL                         R13 0
      ...
      121 JUMPIFNOT                        R13 ; [+5]
      122 GETUPVAL                         R13 1
      123 GETTABLEKS                       R13 R13 K5 ["setIsBackendBundleUpload"]
      125 LOADB                            R14 0
      126 CALL                             R13 1 0
      127 LOADB                            R13 0
      ...
      133 RETURN                           R13 2
      134 GETUPVAL                         R15 9
      135 GETTABLEKS                       R15 R15 K19 ["validateFullBody"]
      137 MOVE                             R16 R12
      138 MOVE                             R17 R0
      139 CALL                             R15 2 -1
      ...
      153 JUMPIFNOT                        R13 ; [+9]
      154 GETUPVAL                         R15 12
      155 GETTABLEKS                       R15 R15 K19 ["validateFullBody"]
      157 MOVE                             R16 R12
      158 MOVE                             R17 R0
      159 CALL                             R15 2 -1
      ...
      167 JUMPIFNOT                        R7 ; [+5]
      168 GETUPVAL                         R7 1
      169 GETTABLEKS                       R7 R7 K5 ["setIsBackendBundleUpload"]
      171 LOADB                            R8 0
      172 CALL                             R7 1 0
...
MAIN:
       ...
       31 GETTABLEKS                       R6 R0 K10 ["util"]
       33 GETTABLEKS                       R6 R6 K11 ["Types"]
       35 CALL                             R5 1 1
       36 GETIMPORT                        R6 K4 [require]
       38 GETTABLEKS                       R7 R0 K10 ["util"]
       40 GETTABLEKS                       R7 R7 K12 ["FailureReasonsAccumulator"]
       42 CALL                             R6 1 1
       43 GETIMPORT                        R7 K4 [require]
       45 GETTABLEKS                       R8 R0 K10 ["util"]
       47 GETTABLEKS                       R8 R8 K13 ["validateWithSchema"]
       49 CALL                             R7 1 1
       50 GETIMPORT                        R8 K4 [require]
       52 GETTABLEKS                       R9 R0 K14 ["validation"]
       54 GETTABLEKS                       R9 R9 K15 ["validateAssetBounds"]
       56 CALL                             R8 1 1
       57 GETIMPORT                        R9 K4 [require]
       59 GETTABLEKS                       R10 R0 K14 ["validation"]
       61 GETTABLEKS                       R10 R10 K16 ["validateSingleInstance"]
       63 CALL                             R9 1 1
       64 GETIMPORT                        R10 K4 [require]
       66 GETTABLEKS                       R11 R0 K10 ["util"]
       68 GETTABLEKS                       R11 R11 K17 ["ValidateBodyBlockingTests"]
       70 CALL                             R10 1 1
       71 GETIMPORT                        R11 K4 [require]
       73 GETTABLEKS                       R12 R0 K14 ["validation"]
       75 GETTABLEKS                       R12 R12 K18 ["ValidateAssetBodyPartCages"]
       77 CALL                             R11 1 1
       78 GETIMPORT                        R12 K4 [require]
       80 GETTABLEKS                       R13 R0 K14 ["validation"]
       82 GETTABLEKS                       R13 R13 K19 ["ValidateLegsSeparation"]
       84 CALL                             R12 1 1
       85 GETIMPORT                        R13 K4 [require]
       87 GETTABLEKS                       R14 R0 K10 ["util"]
       89 GETTABLEKS                       R14 R14 K20 ["createDynamicHeadMeshPartSchema"]
       91 CALL                             R13 1 1
       92 GETIMPORT                        R14 K4 [require]
       94 GETTABLEKS                       R15 R0 K10 ["util"]
       96 GETTABLEKS                       R15 R15 K21 ["createLimbsAndTorsoSchema"]
       98 CALL                             R14 1 1
       99 GETIMPORT                        R15 K4 [require]
      101 GETTABLEKS                       R16 R0 K10 ["util"]
      103 GETTABLEKS                       R16 R16 K22 ["resetPhysicsData"]
      105 CALL                             R15 1 1
      106 GETIMPORT                        R16 K4 [require]
      108 GETTABLEKS                       R17 R0 K10 ["util"]
      110 GETTABLEKS                       R17 R17 K23 ["ParseContentIds"]
      112 CALL                             R16 1 1
      113 GETIMPORT                        R17 K4 [require]
      115 GETTABLEKS                       R18 R0 K10 ["util"]
      117 GETTABLEKS                       R18 R18 K24 ["R15plusUtils"]
      119 CALL                             R17 1 1
      120 GETIMPORT                        R18 K4 [require]
      122 GETTABLEKS                       R19 R0 K8 ["flags"]
      124 GETTABLEKS                       R19 R19 K25 ["getFFlagDebugAllowHRDUploadOnBundleBackend"]
      126 CALL                             R18 1 1
