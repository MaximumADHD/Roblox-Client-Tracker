PROTO_0:
        0 GETUPVAL                         R0 0
        1 GETUPVAL                         R2 1
        2 GETTABLEKS                       R2 R2 K0 ["editableImage"]
...
PROTO_1:
       ...
       22 RETURN                           R6 1
       23 GETUPVAL                         R6 1
       24 GETTABLEKS                       R6 R6 K8 ["reportFailure"]
       26 GETUPVAL                         R7 1
       27 GETTABLEKS                       R7 R7 K9 ["ErrorType"]
       29 GETTABLEKS                       R7 R7 K10 ["validateTextureSize_InvalidTextureId"]
       31 LOADNIL                          R8
       32 MOVE                             R9 R2
       33 CALL                             R6 3 0
       34 LOADB                            R6 0
       ...
       64 CALL                             R8 -1 0
       65 GETUPVAL                         R8 1
       66 GETTABLEKS                       R8 R8 K8 ["reportFailure"]
       68 GETUPVAL                         R9 1
       69 GETTABLEKS                       R9 R9 K9 ["ErrorType"]
       71 GETTABLEKS                       R9 R9 K19 ["validateTextureSize_FailedToLoadTexture"]
       73 LOADNIL                          R10
       74 MOVE                             R11 R2
       75 CALL                             R8 3 0
       76 LOADB                            R8 0
       ...
       96 GETUPVAL                         R8 1
       97 GETTABLEKS                       R8 R8 K8 ["reportFailure"]
       99 GETUPVAL                         R9 1
      100 GETTABLEKS                       R9 R9 K9 ["ErrorType"]
      102 GETTABLEKS                       R9 R9 K22 ["validateTextureSize_TextureTooBig"]
      104 LOADNIL                          R10
      105 MOVE                             R11 R2
      106 CALL                             R8 3 0
      107 GETUPVAL                         R9 0
      108 GETTABLEKS                       R9 R9 K3 ["MAX_TEXTURE_SIZE"]
      ...
      155 RETURN                           R9 2
      156 GETUPVAL                         R8 1
      157 GETTABLEKS                       R8 R8 K26 ["recordScriptTime"]
      159 GETIMPORT                        R9 K28 [script]
      161 GETTABLEKS                       R9 R9 K29 ["Name"]
      163 MOVE                             R10 R4
      164 MOVE                             R11 R2
      165 CALL                             R8 3 0
      166 LOADB                            R8 1
