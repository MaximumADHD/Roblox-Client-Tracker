PROTO_0:
       ...
       11 RETURN                           R3 1
       12 GETUPVAL                         R3 0
       13 GETTABLEKS                       R3 R3 K4 ["UploadCategory"]
       15 GETTABLEKS                       R3 R3 K6 ["BOTH_SHOES"]
       17 RETURN                           R3 1
       ...
       28 GETUPVAL                         R4 0
       29 GETTABLEKS                       R4 R4 K4 ["UploadCategory"]
       31 GETTABLEKS                       R3 R4 K12 ["EMOTE_ANIMATION"]
       33 JUMP                             ; [+78]
       34 GETUPVAL                         R5 1
       35 GETTABLEKS                       R5 R5 K13 ["ASSET_TYPE_INFO"]
       37 GETTABLE                         R4 R5 R1
       38 JUMPIFNOT                        R4 ; [+24]
       39 GETUPVAL                         R5 1
       40 GETTABLEKS                       R5 R5 K13 ["ASSET_TYPE_INFO"]
       42 GETTABLE                         R4 R5 R1
       43 GETTABLEKS                       R4 R4 K14 ["isBodyPart"]
       45 JUMPIFNOT                        R4 ; [+17]
       46 GETIMPORT                        R5 K16 [Enum.AssetType.DynamicHead]
       48 JUMPIFNOTEQ                      R1 R5 ; [+7]
       50 GETUPVAL                         R4 0
       51 GETTABLEKS                       R4 R4 K4 ["UploadCategory"]
       53 GETTABLEKS                       R4 R4 K17 ["DYNAMIC_HEAD"]
       55 JUMPIF                           R4 ; [+5]
       56 GETUPVAL                         R4 0
       57 GETTABLEKS                       R4 R4 K4 ["UploadCategory"]
       59 GETTABLEKS                       R4 R4 K18 ["TORSO_AND_LIMBS"]
       61 MOVE                             R3 R4
       62 JUMP                             ; [+49]
       ...
       73 JUMPIFNOT                        R4 ; [+6]
       74 GETUPVAL                         R4 0
       75 GETTABLEKS                       R4 R4 K4 ["UploadCategory"]
       77 GETTABLEKS                       R3 R4 K25 ["LAYERED_CLOTHING"]
       79 JUMP                             ; [+32]
       80 GETUPVAL                         R5 1
       81 GETTABLEKS                       R5 R5 K13 ["ASSET_TYPE_INFO"]
       83 GETTABLE                         R4 R5 R1
       84 JUMPIFNOT                        R4 ; [+13]
       85 GETUPVAL                         R5 1
       86 GETTABLEKS                       R5 R5 K13 ["ASSET_TYPE_INFO"]
       88 GETTABLE                         R4 R5 R1
       89 GETTABLEKS                       R4 R4 K26 ["rigidAllowed"]
       91 JUMPIFNOT                        R4 ; [+6]
       92 GETUPVAL                         R4 0
       93 GETTABLEKS                       R4 R4 K4 ["UploadCategory"]
      ...
      100 JUMPIFNOT                        R4 ; [+11]
      101 GETUPVAL                         R4 4
      102 GETTABLEKS                       R4 R4 K28 ["isMakeupAsset"]
      104 MOVE                             R5 R1
      105 CALL                             R4 1 1
      106 JUMPIFNOT                        R4 ; [+5]
      107 GETUPVAL                         R4 0
      108 GETTABLEKS                       R4 R4 K4 ["UploadCategory"]
...
MAIN:
       ...
       35 GETTABLEKS                       R6 R6 K11 ["getFFlagUGCValidateMakeupAssetTypeNewPipeline"]
       37 CALL                             R5 1 1
