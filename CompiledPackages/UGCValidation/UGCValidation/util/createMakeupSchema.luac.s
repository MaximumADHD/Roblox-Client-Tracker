PROTO_0:
  ...
  NEWTABLE R1 0 2
  DUPTABLE R2 K6 [{"Name", "ClassName", "_optional", "_children"}]
  LOADK R3 K7 ["ThumbnailConfiguration"]
  SETTABLEKS R3 R2 K4 ["Name"]
  LOADK R3 K8 ["Configuration"]
  SETTABLEKS R3 R2 K0 ["ClassName"]
  LOADB R3 1
  SETTABLEKS R3 R2 K5 ["_optional"]
  NEWTABLE R3 0 1
  DUPTABLE R4 K9 [{"Name", "ClassName"}]
  LOADK R5 K10 ["SkinColorValue"]
  SETTABLEKS R5 R4 K4 ["Name"]
  LOADK R5 K11 ["Color3Value"]
  SETTABLEKS R5 R4 K0 ["ClassName"]
  SETLIST R3 R4 1 [1]
  SETTABLEKS R3 R2 K1 ["_children"]
  DUPTABLE R3 K9 [{"Name", "ClassName"}]
  LOADK R4 K12 ["WrapTextureTransfer"]
