...
PROTO_2:
  NAMECALL R2 R0 K0 ["getRules"]
  CALL R2 1 1
  GETTABLEKS R1 R2 K1 ["MakeupRules"]
  RETURN R1 1
...
MAIN:
  ...
  SETTABLEKS R2 R1 K41 ["getMakeupRules"]
  DUPCLOSURE R2 K42 [PROTO_3]
  SETTABLEKS R2 R1 K43 ["getAccessoryRules"]
  DUPCLOSURE R2 K44 [PROTO_4]
  CAPTURE VAL R1
  SETTABLEKS R2 R1 K45 ["getBodyPartRules"]
  DUPCLOSURE R2 K46 [PROTO_5]
  SETTABLEKS R2 R1 K47 ["getFullBodyRulesBounds"]
  RETURN R1 1
