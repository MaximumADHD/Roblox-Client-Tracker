...
PROTO_2:
  ...
  LOADNIL R5
  FORGPREP R3
  JUMPIFEQKS R6 K2 ["ExcludeUVBounds"] [+4]
  JUMPIFEQKS R6 K3 ["IncludeUVBounds"] [+2]
  SETTABLE R7 R2 R6
  FORGLOOP R3 2 [-6]
  NEWTABLE R3 0 0
  GETTABLEKS R4 R1 K2 ["ExcludeUVBounds"]
  LOADNIL R5
  LOADNIL R6
  FORGPREP R4
  GETTABLE R9 R3 R7
  ...
  FORGPREP R9
  GETTABLE R15 R3 R7
  DUPTABLE R16 K7 [{"isIncludeBound", "MinBound", "MaxBound"}]
  LOADB R17 0
  SETTABLEKS R17 R16 K4 ["isIncludeBound"]
  GETTABLEKS R17 R13 K5 ["MinBound"]
  SETTABLEKS R17 R16 K5 ["MinBound"]
  GETTABLEKS R17 R13 K6 ["MaxBound"]
  SETTABLEKS R17 R16 K6 ["MaxBound"]
  FASTCALL2 TABLE_INSERT R15 R16 [+3]
  GETIMPORT R14 K10 [table.insert]
  CALL R14 2 0
  FORGLOOP R9 2 [-19]
  FORGLOOP R4 2 [-30]
  GETTABLEKS R4 R1 K3 ["IncludeUVBounds"]
  LOADNIL R5
  LOADNIL R6
  FORGPREP R4
  GETTABLE R9 R3 R7
  ...
  SETTABLE R9 R3 R7
  GETTABLE R10 R3 R7
  DUPTABLE R11 K7 [{"isIncludeBound", "MinBound", "MaxBound"}]
  LOADB R12 1
  SETTABLEKS R12 R11 K4 ["isIncludeBound"]
  GETTABLEKS R12 R8 K5 ["MinBound"]
  SETTABLEKS R12 R11 K5 ["MinBound"]
  GETTABLEKS R12 R8 K6 ["MaxBound"]
  SETTABLEKS R12 R11 K6 ["MaxBound"]
  FASTCALL2 TABLE_INSERT R10 R11 [+3]
  GETIMPORT R9 K10 [table.insert]
  CALL R9 2 0
  FORGLOOP R4 2 [-24]
  SETTABLEKS R3 R2 K11 ["AssetUVBounds"]
  RETURN R2 1
