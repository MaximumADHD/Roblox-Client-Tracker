PROTO_0:
  ...
  SETTABLEKS R7 R6 K3 ["ClassName"]
  DUPTABLE R7 K21 [{"ClassName"}]
  LOADK R8 K22 ["WrapLayer"]
  SETTABLEKS R8 R7 K3 ["ClassName"]
  DUPTABLE R8 K23 [{"ClassName", "_optional"}]
  LOADK R9 K24 ["SurfaceAppearance"]
  SETTABLEKS R9 R8 K3 ["ClassName"]
  LOADB R9 1
  SETTABLEKS R9 R8 K8 ["_optional"]
  DUPTABLE R9 K25 [{"ClassName", "Name", "_optional"}]
  LOADK R10 K26 ["StringValue"]
  SETTABLEKS R10 R9 K3 ["ClassName"]
  LOADK R10 K27 ["AvatarPartScaleType"]
  SETTABLEKS R10 R9 K7 ["Name"]
  LOADB R10 1
  SETTABLEKS R10 R9 K8 ["_optional"]
  DUPTABLE R10 K23 [{"ClassName", "_optional"}]
  LOADK R11 K28 ["TouchTransmitter"]
  SETTABLEKS R11 R10 K3 ["ClassName"]
  LOADB R11 1
  SETTABLEKS R11 R10 K8 ["_optional"]
  SETLIST R5 R6 5 [1]
