...
MAIN:
  ...
  GETTABLEKS R19 R12 K25 ["getFFlagUGCValidateLimitMaxTotalInstances"]
  CALL R18 1 1
  GETIMPORT R19 K8 [require]
  GETTABLEKS R20 R12 K26 ["getFFlagUGCValidateMaxTotalInstances"]
  CALL R19 1 1
  GETIMPORT R20 K8 [require]
  GETTABLEKS R21 R12 K27 ["getFFlagUGCValidateNoTagsInCurveAnimations"]
  CALL R20 1 1
  GETIMPORT R21 K8 [require]
  GETTABLEKS R22 R12 K28 ["getFFlagUGCValidateIncorrectNumericalData"]
  CALL R21 1 1
  GETIMPORT R22 K8 [require]
  GETTABLEKS R23 R12 K29 ["getFIntUGCValidateMaxAnimationFPS"]
  CALL R22 1 1
  GETIMPORT R23 K8 [require]
  GETTABLEKS R24 R12 K30 ["getFFlagUGCValidateRestrictAnimationMovement"]
  CALL R23 1 1
  GETIMPORT R24 K8 [require]
  GETTABLEKS R25 R12 K31 ["GetFStringUGCValidateMaxAnimationMovement"]
  CALL R24 1 1
  GETIMPORT R25 K8 [require]
  GETTABLEKS R26 R12 K32 ["getFIntUGCValidateMaxMarkerCurveValueLength"]
  CALL R25 1 1
  GETIMPORT R26 K8 [require]
  GETTABLEKS R27 R12 K33 ["getFFlagUGCValidateRestrictAnimationMovementPerPart"]
  CALL R26 1 1
  GETIMPORT R27 K8 [require]
  GETTABLEKS R28 R12 K34 ["GetFStringUGCValidateMaxAnimationMovementPerPart"]
  CALL R27 1 1
  GETIMPORT R28 K8 [require]
  GETTABLEKS R29 R12 K35 ["getFFlagUGCValidateRestrictAnimationMovementCurvesFix"]
  CALL R28 1 1
  GETIMPORT R29 K8 [require]
  GETTABLEKS R30 R12 K36 ["getFFlagUGCValidateStopNaNsInfsInAnimationKeys"]
  CALL R29 1 1
  GETIMPORT R30 K8 [require]
  GETTABLEKS R31 R12 K37 ["getFFlagUGCValidateStopNaNsInfsInCalculatedData"]
  CALL R30 1 1
  GETIMPORT R31 K8 [require]
  GETTABLEKS R32 R12 K38 ["getFFlagUGCValidateSingleAnimationRigData"]
  CALL R31 1 1
  GETIMPORT R32 K8 [require]
  GETTABLEKS R33 R12 K39 ["getEngineFeatureEngineUGCIsValidR15AnimationRigCheck"]
  CALL R32 1 1
  GETIMPORT R33 K8 [require]
  GETTABLEKS R34 R12 K40 ["getFFlagUGCValidatePreciseStepThrough"]
  CALL R33 1 1
  GETIMPORT R34 K8 [require]
  GETTABLEKS R35 R12 K41 ["getFFlagUGCValidatePreciseCurveLimit"]
  CALL R34 1 1
  GETIMPORT R35 K8 [require]
  GETTABLEKS R36 R12 K42 ["GetFStringUGCValidateFrameDeltaKeyTimeTol"]
  CALL R35 1 1
  GETIMPORT R36 K8 [require]
  GETTABLEKS R38 R1 K19 ["flags"]
  GETTABLEKS R37 R38 K43 ["getEngineFeatureEngineUGCValidatePropertiesSensible"]
  CALL R36 1 1
  GETIMPORT R37 K8 [require]
  GETTABLEKS R38 R12 K44 ["getFFlagUGCValidateRestrictEmoteHeight"]
  CALL R37 1 1
  GETIMPORT R38 K8 [require]
  GETTABLEKS R39 R12 K45 ["GetFStringUGCValidateAnimationHeightTol"]
  CALL R38 1 1
  NEWTABLE R39 32 0
  DUPCLOSURE R40 K46 [PROTO_0]
  CAPTURE VAL R2
  LOADNIL R41
  NEWCLOSURE R42 P1
  CAPTURE REF R41
  ...
  CAPTURE REF R41
  CAPTURE VAL R7
  DUPCLOSURE R44 K47 [PROTO_4]
  NEWCLOSURE R45 P4
  CAPTURE REF R41
  CAPTURE VAL R7
  DUPCLOSURE R46 K48 [PROTO_6]
  CAPTURE VAL R45
  DUPCLOSURE R47 K49 [PROTO_7]
  DUPCLOSURE R48 K50 [PROTO_8]
  DUPCLOSURE R49 K51 [PROTO_9]
  CAPTURE VAL R46
  CAPTURE VAL R44
  CAPTURE VAL R47
  CAPTURE VAL R23
  ...
  CAPTURE VAL R2
  CAPTURE VAL R17
  DUPCLOSURE R52 K52 [PROTO_13]
  CAPTURE VAL R40
  CAPTURE VAL R2
  SETTABLEKS R52 R39 K53 ["validateSingleAnimationRigData"]
  DUPCLOSURE R52 K54 [PROTO_14]
  CAPTURE VAL R40
  CAPTURE VAL R2
  SETTABLEKS R52 R39 K55 ["validateAnimationRigDataInternals"]
  DUPCLOSURE R52 K56 [PROTO_15]
  CAPTURE VAL R31
  CAPTURE VAL R39
  CAPTURE VAL R32
  DUPCLOSURE R53 K57 [PROTO_16]
  CAPTURE VAL R40
  CAPTURE VAL R2
  NEWTABLE R54 0 7
  LOADK R55 K58 ["MarkerCurve"]
  LOADK R56 K59 ["AnimationRigData"]
  LOADK R57 K60 ["Folder"]
  LOADK R58 K61 ["Vector3Curve"]
  LOADK R59 K62 ["EulerRotationCurve"]
  LOADK R60 K63 ["FloatCurve"]
  LOADK R61 K64 ["RotationCurve"]
  SETLIST R54 R55 7 [1]
  MOVE R55 R28
  CALL R55 0 1
  JUMPIFNOT R55 [+14]
  ...
  LOADNIL R57
  FORGPREP R55
  JUMPIFNOTEQKS R59 K64 ["RotationCurve"] [+7]
  GETIMPORT R60 K67 [table.remove]
  MOVE R61 R54
  MOVE R62 R58
  CALL R60 2 0
  JUMP [+2]
  ...
  CALL R55 0 1
  JUMPIFNOT R55 [+7]
  FASTCALL2K TABLE_INSERT R54 K68 [+5]
  MOVE R56 R54
  LOADK R57 K68 ["ObjectValue"]
  GETIMPORT R55 K70 [table.insert]
  CALL R55 2 0
  DUPCLOSURE R55 K71 [PROTO_17]
  CAPTURE VAL R54
  CAPTURE VAL R40
  CAPTURE VAL R2
  DUPCLOSURE R56 K72 [PROTO_18]
  CAPTURE VAL R55
  SETTABLEKS R56 R39 K73 ["validateExtraInstancesUnitTest"]
  DUPCLOSURE R56 K74 [PROTO_19]
  CAPTURE VAL R53
  SETTABLEKS R56 R39 K75 ["validateScriptsUnitTest"]
  NEWCLOSURE R56 P18
  CAPTURE VAL R2
  CAPTURE VAL R18
  CAPTURE VAL R19
  ...
  CAPTURE VAL R53
  CAPTURE VAL R55
  DUPCLOSURE R57 K76 [PROTO_21]
  MOVE R59 R33
  CALL R59 0 1
  JUMPIFNOT R59 [+4]
  MOVE R59 R22
  CALL R59 0 1
  DIVRK R58 R77 K59 ["AnimationRigData"]
  JUMP [+1]
  LOADK R58 K78 [0.0333333333333333]
  NEWCLOSURE R59 P20
  CAPTURE REF R41
  CAPTURE VAL R7
  DUPCLOSURE R60 K79 [PROTO_23]
  DUPCLOSURE R61 K80 [PROTO_24]
  CAPTURE VAL R60
  DUPCLOSURE R62 K81 [PROTO_25]
  CAPTURE VAL R60
  NEWCLOSURE R63 P24
  CAPTURE VAL R17
  CAPTURE VAL R59
  ...
  CAPTURE VAL R57
  CAPTURE VAL R58
  DUPCLOSURE R64 K82 [PROTO_32]
  CAPTURE VAL R13
  CAPTURE VAL R40
  CAPTURE VAL R2
  SETTABLEKS R64 R39 K83 ["validateAnimationLength"]
  DUPCLOSURE R64 K84 [PROTO_33]
  CAPTURE VAL R37
  CAPTURE VAL R6
  CAPTURE VAL R38
  CAPTURE VAL R14
  CAPTURE VAL R2
  CAPTURE VAL R40
  SETTABLEKS R64 R39 K85 ["validateBounds"]
  DUPCLOSURE R64 K86 [PROTO_34]
  CAPTURE VAL R33
  CAPTURE VAL R58
  CAPTURE VAL R15
  CAPTURE VAL R40
  CAPTURE VAL R2
  SETTABLEKS R64 R39 K87 ["validateFrameDeltas"]
  DUPCLOSURE R64 K88 [PROTO_35]
  CAPTURE VAL R40
  CAPTURE VAL R2
  SETTABLEKS R64 R39 K89 ["validateMinimumTransformations"]
  NEWCLOSURE R64 P29
  CAPTURE VAL R17
  CAPTURE VAL R59
  CAPTURE REF R41
  ...
  CAPTURE VAL R40
  CAPTURE VAL R2
  SETTABLEKS R64 R39 K90 ["validateContainsJointManipulation"]
  DUPCLOSURE R64 K91 [PROTO_37]
  DUPCLOSURE R65 K92 [PROTO_38]
  CAPTURE VAL R10
  CAPTURE VAL R0
  CAPTURE VAL R40
  CAPTURE VAL R2
  SETTABLEKS R65 R39 K93 ["validateAllowedTags"]
  DUPCLOSURE R65 K94 [PROTO_39]
  CAPTURE VAL R56
  SETTABLEKS R65 R39 K95 ["validateStructure"]
  DUPCLOSURE R65 K96 [PROTO_42]
  DUPCLOSURE R66 K97 [PROTO_44]
  CAPTURE VAL R22
  CAPTURE VAL R13
  CAPTURE VAL R34
  CAPTURE VAL R58
  ...
  CAPTURE VAL R65
  CAPTURE VAL R25
  SETTABLEKS R66 R39 K98 ["validateData"]
  DUPCLOSURE R66 K99 [PROTO_45]
  CAPTURE VAL R65
  CAPTURE VAL R40
  CAPTURE VAL R2
  SETTABLEKS R66 R39 K100 ["validateCalculatedData"]
  DUPCLOSURE R66 K101 [PROTO_46]
  CAPTURE VAL R63
  SETTABLEKS R66 R39 K102 ["calculateAnimFramesAtOrigin"]
  DUPCLOSURE R66 K103 [PROTO_47]
  CAPTURE VAL R3
  CAPTURE VAL R27
  CAPTURE VAL R40
  CAPTURE VAL R2
  SETTABLEKS R66 R39 K104 ["validatePositionMagnitudes"]
  DUPCLOSURE R66 K105 [PROTO_48]
  CAPTURE VAL R26
  CAPTURE VAL R27
  CAPTURE VAL R40
  CAPTURE VAL R2
  CAPTURE VAL R24
  SETTABLEKS R66 R39 K106 ["validateMovement"]
  DUPCLOSURE R66 K107 [PROTO_49]
  CAPTURE VAL R39
  CAPTURE VAL R30
  CAPTURE VAL R6
  CAPTURE VAL R28
  CAPTURE VAL R23
  SETTABLEKS R66 R39 K108 ["validateFrames"]
  DUPCLOSURE R66 K109 [PROTO_50]
  CAPTURE VAL R39
  CAPTURE VAL R36
  CAPTURE VAL R11
  CAPTURE VAL R21
  ...
  CAPTURE VAL R20
  CAPTURE VAL R28
  SETTABLEKS R66 R39 K110 ["validate"]
  CLOSEUPVALS R41
  RETURN R39 1
