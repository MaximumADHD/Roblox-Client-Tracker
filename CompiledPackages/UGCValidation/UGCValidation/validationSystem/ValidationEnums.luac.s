...
MAIN:
  ...
  CALL R3 1 0
  DUPTABLE R3 K30 [{"categories", "fflag", "shadowFlag", "requiredData", "prereqTests", "expectedFailures", "requiredAqsReturnSchema", "run"}]
  ...
  LOADK R4 K25 ["requiredData"]
  SETTABLEKS R4 R3 K25 ["requiredData"]
  LOADK R4 K26 ["prereqTests"]
  SETTABLEKS R4 R3 K26 ["prereqTests"]
  LOADK R4 K27 ["expectedFailures"]
  SETTABLEKS R4 R3 K27 ["expectedFailures"]
  LOADK R4 K28 ["requiredAqsReturnSchema"]
  SETTABLEKS R4 R3 K28 ["requiredAqsReturnSchema"]
  LOADK R4 K29 ["run"]
  SETTABLEKS R4 R3 K29 ["run"]
  SETTABLEKS R3 R0 K31 ["ValidationConfig"]
  MOVE R3 R2
  LOADK R4 K31 ["ValidationConfig"]
  CALL R3 1 0
  DUPTABLE R3 K37 [{"CANNOT_START", "TIMEOUT", "ERROR", "FAIL", "PASS"}]
  LOADK R4 K32 ["CANNOT_START"]
  SETTABLEKS R4 R3 K32 ["CANNOT_START"]
  LOADK R4 K33 ["TIMEOUT"]
  SETTABLEKS R4 R3 K33 ["TIMEOUT"]
  LOADK R4 K34 ["ERROR"]
  SETTABLEKS R4 R3 K34 ["ERROR"]
  LOADK R4 K35 ["FAIL"]
  SETTABLEKS R4 R3 K35 ["FAIL"]
  LOADK R4 K36 ["PASS"]
  SETTABLEKS R4 R3 K36 ["PASS"]
  SETTABLEKS R3 R0 K38 ["Status"]
  MOVE R3 R2
  LOADK R4 K38 ["Status"]
  CALL R3 1 0
  DUPTABLE R3 K47 [{"TORSO_AND_LIMBS", "DYNAMIC_HEAD", "LAYERED_CLOTHING", "RIGID_ACCESSORY", "EMOTE_ANIMATION", "MAKEUP", "FULL_BODY", "BOTH_SHOES"}]
  LOADK R4 K39 ["TORSO_AND_LIMBS"]
  SETTABLEKS R4 R3 K39 ["TORSO_AND_LIMBS"]
  LOADK R4 K40 ["DYNAMIC_HEAD"]
  SETTABLEKS R4 R3 K40 ["DYNAMIC_HEAD"]
  LOADK R4 K41 ["LAYERED_CLOTHING"]
  SETTABLEKS R4 R3 K41 ["LAYERED_CLOTHING"]
  LOADK R4 K42 ["RIGID_ACCESSORY"]
  SETTABLEKS R4 R3 K42 ["RIGID_ACCESSORY"]
  LOADK R4 K43 ["EMOTE_ANIMATION"]
  SETTABLEKS R4 R3 K43 ["EMOTE_ANIMATION"]
  LOADK R4 K44 ["MAKEUP"]
  SETTABLEKS R4 R3 K44 ["MAKEUP"]
  LOADK R4 K45 ["FULL_BODY"]
  SETTABLEKS R4 R3 K45 ["FULL_BODY"]
  LOADK R4 K46 ["BOTH_SHOES"]
  SETTABLEKS R4 R3 K46 ["BOTH_SHOES"]
  SETTABLEKS R3 R0 K48 ["UploadCategory"]
  MOVE R3 R2
  LOADK R4 K48 ["UploadCategory"]
  CALL R3 1 0
  RETURN R0 1
