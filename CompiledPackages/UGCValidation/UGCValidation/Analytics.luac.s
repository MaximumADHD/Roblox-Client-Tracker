...
MAIN:
  ...
  LOADK R31 K131 ["validateUVSpace_FailedToExecute"]
  SETTABLEKS R31 R30 K131 ["validateUVSpace_FailedToExecute"]
  LOADK R31 K132 ["validateUVSpace_InvalidUVSpace"]
  SETTABLEKS R31 R30 K132 ["validateUVSpace_InvalidUVSpace"]
  LOADK R31 K133 ["validateVertexDensity_FailedToExecute"]
  SETTABLEKS R31 R30 K133 ["validateVertexDensity_FailedToExecute"]
  LOADK R31 K134 ["validateVertexDensity_MaxDensityExceeded"]
  SETTABLEKS R31 R30 K134 ["validateVertexDensity_MaxDensityExceeded"]
  LOADK R31 K135 ["validateDynamicHeadMeshPartFormat_ValidateDynamicHeadMeshControls"]
  SETTABLEKS R31 R30 K135 ["validateDynamicHeadMeshPartFormat_ValidateDynamicHeadMeshControls"]
  LOADK R31 K136 ["validateRenderMeshInsideOuterCageMesh_FailedToExecute"]
  SETTABLEKS R31 R30 K136 ["validateRenderMeshInsideOuterCageMesh_FailedToExecute"]
  LOADK R31 K137 ["validateRenderMeshInsideOuterCageMesh_MaxOutsideCageMeshExceeded"]
  SETTABLEKS R31 R30 K137 ["validateRenderMeshInsideOuterCageMesh_MaxOutsideCageMeshExceeded"]
  LOADK R31 K138 ["validateLayeredClothingAccessory_CageOriginOutOfBounds"]
  SETTABLEKS R31 R30 K138 ["validateLayeredClothingAccessory_CageOriginOutOfBounds"]
  LOADK R31 K139 ["validateBodyPart_CageOriginOutOfBounds"]
  SETTABLEKS R31 R30 K139 ["validateBodyPart_CageOriginOutOfBounds"]
  LOADK R31 K140 ["validateTotalSurfaceArea_FailedToExecute"]
  SETTABLEKS R31 R30 K140 ["validateTotalSurfaceArea_FailedToExecute"]
  LOADK R31 K141 ["validateTotalSurfaceArea_maxTotalSurfaceAreaExceeded"]
  SETTABLEKS R31 R30 K141 ["validateTotalSurfaceArea_maxTotalSurfaceAreaExceeded"]
  LOADK R31 K142 ["validateCoplanarIntersection_FailedToExecute"]
  SETTABLEKS R31 R30 K142 ["validateCoplanarIntersection_FailedToExecute"]
  LOADK R31 K143 ["validateCoplanarIntersection_CoplanarIntersection"]
  SETTABLEKS R31 R30 K143 ["validateCoplanarIntersection_CoplanarIntersection"]
  LOADK R31 K144 ["validateExcludedModifiedCageUVs_FailedToExecute"]
  SETTABLEKS R31 R30 K144 ["validateExcludedModifiedCageUVs_FailedToExecute"]
  LOADK R31 K145 ["validateExcludedModifiedCageUVs_UnexpectedUVValue"]
  SETTABLEKS R31 R30 K145 ["validateExcludedModifiedCageUVs_UnexpectedUVValue"]
  LOADK R31 K146 ["validateMainModifiedCageUVs_FailedToExecute"]
  SETTABLEKS R31 R30 K146 ["validateMainModifiedCageUVs_FailedToExecute"]
  LOADK R31 K147 ["validateMainModifiedCageUVs_TooFewModifiedUVsFound"]
  SETTABLEKS R31 R30 K147 ["validateMainModifiedCageUVs_TooFewModifiedUVsFound"]
  LOADK R31 K148 ["validateRenderMeshInsideModifiedOuterCageArea_FailedToExecute"]
  SETTABLEKS R31 R30 K148 ["validateRenderMeshInsideModifiedOuterCageArea_FailedToExecute"]
  LOADK R31 K149 ["validateRenderMeshInsideModifiedOuterCageArea_RenderMeshNotPositionedCorrectly"]
  SETTABLEKS R31 R30 K149 ["validateRenderMeshInsideModifiedOuterCageArea_RenderMeshNotPositionedCorrectly"]
  LOADK R31 K150 ["validateBodyPartCage_FailedToExecute"]
  SETTABLEKS R31 R30 K150 ["validateBodyPartCage_FailedToExecute"]
  LOADK R31 K151 ["validateBodyPartCage_VertsAreTooFarInFrontOfRenderMesh"]
  SETTABLEKS R31 R30 K151 ["validateBodyPartCage_VertsAreTooFarInFrontOfRenderMesh"]
  LOADK R31 K152 ["validateCurveAnimation_IncorrectNumericalData"]
  SETTABLEKS R31 R30 K152 ["validateCurveAnimation_IncorrectNumericalData"]
  SETTABLEKS R30 R29 K153 ["ErrorType"]
  MOVE R30 R14
  CALL R30 0 1
  JUMPIFNOT R30 [+5]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K154 ["validateMeshBounds_Shifted"]
  SETTABLEKS R31 R30 K154 ["validateMeshBounds_Shifted"]
  MOVE R30 R21
  CALL R30 0 1
  JUMPIFNOT R30 [+10]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K155 ["validateEachBodyPartFacsBounds_FailedToExecute"]
  SETTABLEKS R31 R30 K155 ["validateEachBodyPartFacsBounds_FailedToExecute"]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K156 ["validateEachBodyPartFacsBounds_ExtendedBounds"]
  SETTABLEKS R31 R30 K156 ["validateEachBodyPartFacsBounds_ExtendedBounds"]
  MOVE R30 R10
  CALL R30 0 1
  JUMPIFNOT R30 [+10]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K157 ["validateVerticesSimilarity_FailedToExecute"]
  SETTABLEKS R31 R30 K157 ["validateVerticesSimilarity_FailedToExecute"]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K158 ["validateVerticesSimilarity_MaxSimilarityExceeded"]
  SETTABLEKS R31 R30 K158 ["validateVerticesSimilarity_MaxSimilarityExceeded"]
  MOVE R30 R11
  CALL R30 0 1
  JUMPIFNOT R30 [+10]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K159 ["validateCagingRelevancy_FailedToExecute"]
  SETTABLEKS R31 R30 K159 ["validateCagingRelevancy_FailedToExecute"]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K160 ["validateCagingRelevancy_IrrelevantCaging"]
  SETTABLEKS R31 R30 K160 ["validateCagingRelevancy_IrrelevantCaging"]
  MOVE R30 R7
  CALL R30 0 1
  JUMPIFNOT R30 [+10]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K161 ["validateCageMeshDistance_FailedToExecute"]
  SETTABLEKS R31 R30 K161 ["validateCageMeshDistance_FailedToExecute"]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K162 ["validateCageMeshDistance_OuterCageToMeshDistance"]
  SETTABLEKS R31 R30 K162 ["validateCageMeshDistance_OuterCageToMeshDistance"]
  MOVE R30 R9
  CALL R30 0 1
  JUMPIFNOT R30 [+10]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K163 ["validateCageUVDuplicate_FailedToExecute"]
  SETTABLEKS R31 R30 K163 ["validateCageUVDuplicate_FailedToExecute"]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K164 ["validateCageUVDuplicate_UnexpectedUVValue"]
  SETTABLEKS R31 R30 K164 ["validateCageUVDuplicate_UnexpectedUVValue"]
  MOVE R30 R13
  CALL R30 0 1
  JUMPIFNOT R30 [+5]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K165 ["validatePartSizeWithinRenderSizeLimits_SizeExceeded"]
  SETTABLEKS R31 R30 K165 ["validatePartSizeWithinRenderSizeLimits_SizeExceeded"]
  MOVE R30 R15
  CALL R30 0 1
  JUMPIFNOT R30 [+5]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K166 ["validateLayeredClothingAccessory_HandleIsScaled"]
  SETTABLEKS R31 R30 K166 ["validateLayeredClothingAccessory_HandleIsScaled"]
  MOVE R30 R16
  CALL R30 0 1
  JUMPIFNOT R30 [+5]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K167 ["resetPhysicsData_LargeMass"]
  SETTABLEKS R31 R30 K167 ["resetPhysicsData_LargeMass"]
  MOVE R30 R12
  CALL R30 0 1
  JUMPIFNOT R30 [+10]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K168 ["validateRigidMeshSkinning_FailedToDownload"]
  SETTABLEKS R31 R30 K168 ["validateRigidMeshSkinning_FailedToDownload"]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K169 ["validateRigidMeshSkinning_BonesFoundInMesh"]
  SETTABLEKS R31 R30 K169 ["validateRigidMeshSkinning_BonesFoundInMesh"]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K170 ["validateBodyBlockingTests_ZeroMeshSize"]
  SETTABLEKS R31 R30 K170 ["validateBodyBlockingTests_ZeroMeshSize"]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K171 ["validateFullBody_ZeroMeshSize"]
  SETTABLEKS R31 R30 K171 ["validateFullBody_ZeroMeshSize"]
  MOVE R30 R17
  CALL R30 0 1
  JUMPIFNOT R30 [+10]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K172 ["validateBodyAttPosRelativeToParent_PartAboveParent"]
  SETTABLEKS R31 R30 K172 ["validateBodyAttPosRelativeToParent_PartAboveParent"]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K173 ["validateBodyAttPosRelativeToParent_ParentBelowPart"]
  SETTABLEKS R31 R30 K173 ["validateBodyAttPosRelativeToParent_ParentBelowPart"]
  MOVE R30 R18
  CALL R30 0 1
  JUMPIFNOT R30 [+15]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K174 ["validateBodyPartChildAttachmentOrientations_RotatedRig"]
  SETTABLEKS R31 R30 K174 ["validateBodyPartChildAttachmentOrientations_RotatedRig"]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K175 ["validateBodyPartChildAttachmentOrientations_RotatedGrip"]
  SETTABLEKS R31 R30 K175 ["validateBodyPartChildAttachmentOrientations_RotatedGrip"]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K176 ["validateBodyPartChildAttachmentOrientations_RotatedBasic"]
  SETTABLEKS R31 R30 K176 ["validateBodyPartChildAttachmentOrientations_RotatedBasic"]
  MOVE R30 R19
  CALL R30 0 1
  JUMPIFNOT R30 [+10]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K177 ["validateDeformedLayeredClothingInRenderBounds_FailedToExecute"]
  SETTABLEKS R31 R30 K177 ["validateDeformedLayeredClothingInRenderBounds_FailedToExecute"]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K178 ["validateDeformedLayeredClothingInRenderBounds_ClothingOutOfBounds"]
  SETTABLEKS R31 R30 K178 ["validateDeformedLayeredClothingInRenderBounds_ClothingOutOfBounds"]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K179 ["validateEmoteAnimation_FailedToDownloadCurveAnimation"]
  SETTABLEKS R31 R30 K179 ["validateEmoteAnimation_FailedToDownloadCurveAnimation"]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K180 ["validateCurveAnimation_AnimationHierarchyIsIncorrect"]
  SETTABLEKS R31 R30 K180 ["validateCurveAnimation_AnimationHierarchyIsIncorrect"]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K181 ["validateCurveAnimation_AnimationContainsNoJointManipulation"]
  SETTABLEKS R31 R30 K181 ["validateCurveAnimation_AnimationContainsNoJointManipulation"]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K182 ["validateCurveAnimation_UnacceptableLength"]
  SETTABLEKS R31 R30 K182 ["validateCurveAnimation_UnacceptableLength"]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K183 ["validateCurveAnimation_UnacceptableSizeBounds"]
  SETTABLEKS R31 R30 K183 ["validateCurveAnimation_UnacceptableSizeBounds"]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K184 ["validateCurveAnimation_UnacceptableFrameDelta"]
  SETTABLEKS R31 R30 K184 ["validateCurveAnimation_UnacceptableFrameDelta"]
  MOVE R30 R23
  CALL R30 0 1
  JUMPIFNOT R30 [+5]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K185 ["validateCurveAnimation_PositionalMovement"]
  SETTABLEKS R31 R30 K185 ["validateCurveAnimation_PositionalMovement"]
  MOVE R30 R25
  CALL R30 0 1
  JUMPIFNOT R30 [+5]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K186 ["validateCurveAnimation_IncorrectAnimationRigData"]
  SETTABLEKS R31 R30 K186 ["validateCurveAnimation_IncorrectAnimationRigData"]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K187 ["validateMeshSizeProperty_FailedToLoadMesh"]
  SETTABLEKS R31 R30 K187 ["validateMeshSizeProperty_FailedToLoadMesh"]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K188 ["validateMeshSizeProperty_Mismatch"]
  SETTABLEKS R31 R30 K188 ["validateMeshSizeProperty_Mismatch"]
  MOVE R30 R22
  CALL R30 0 1
  JUMPIFNOT R30 [+10]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K189 ["validateBodyPartVertsSkinnedToR15_FailedToFetchSkinning"]
  SETTABLEKS R31 R30 K189 ["validateBodyPartVertsSkinnedToR15_FailedToFetchSkinning"]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K190 ["validateBodyPartVertsSkinnedToR15_BodyIsSkinnedToFakeJoints"]
  SETTABLEKS R31 R30 K190 ["validateBodyPartVertsSkinnedToR15_BodyIsSkinnedToFakeJoints"]
  MOVE R30 R24
  CALL R30 0 1
  JUMPIFNOT R30 [+20]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K191 ["validateSkinningTransfer_FailedToExecute"]
  SETTABLEKS R31 R30 K191 ["validateSkinningTransfer_FailedToExecute"]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K192 ["validateSkinningTransfer_BodyPartsWithSpecialJoints"]
  SETTABLEKS R31 R30 K192 ["validateSkinningTransfer_BodyPartsWithSpecialJoints"]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K193 ["validateSkinningTransfer_SkinningTransferOverride"]
  SETTABLEKS R31 R30 K193 ["validateSkinningTransfer_SkinningTransferOverride"]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K194 ["validateSkinningTransfer_Weights"]
  SETTABLEKS R31 R30 K194 ["validateSkinningTransfer_Weights"]
  MOVE R30 R26
  CALL R30 0 1
  JUMPIFNOT R30 [+5]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K195 ["validatePropertiesSensible_IncorrectPropertiesFound"]
  SETTABLEKS R31 R30 K195 ["validatePropertiesSensible_IncorrectPropertiesFound"]
  MOVE R30 R27
  CALL R30 0 1
  JUMPIFNOT R30 [+5]
  GETTABLEKS R30 R29 K153 ["ErrorType"]
  LOADK R31 K196 ["validateHSR_FileDataInvalid"]
  SETTABLEKS R31 R30 K196 ["validateHSR_FileDataInvalid"]
  GETTABLEKS R31 R29 K153 ["ErrorType"]
  DUPTABLE R32 K198 [{"__index"}]
  DUPCLOSURE R33 K199 [PROTO_1]
  SETTABLEKS R33 R32 K197 ["__index"]
  FASTCALL2 SETMETATABLE R31 R32 [+3]
  GETIMPORT R30 K201 [setmetatable]
  CALL R30 2 0
  NEWTABLE R30 0 0
  SETTABLEKS R30 R29 K202 ["metadata"]
  DUPCLOSURE R30 K203 [PROTO_2]
  CAPTURE VAL R29
  SETTABLEKS R30 R29 K204 ["setMetadata"]
  DUPCLOSURE R30 K205 [PROTO_3]
  CAPTURE VAL R8
  CAPTURE VAL R2
  SETTABLEKS R30 R29 K206 ["shouldReportIECTelemetry"]
  DUPCLOSURE R30 K207 [PROTO_4]
  CAPTURE VAL R29
  CAPTURE VAL R3
  SETTABLEKS R30 R29 K208 ["reportCounter"]
  DUPCLOSURE R30 K209 [PROTO_5]
  CAPTURE VAL R2
  CAPTURE VAL R28
  CAPTURE VAL R29
  CAPTURE VAL R5
  CAPTURE VAL R4
  CAPTURE VAL R3
  SETTABLEKS R30 R29 K210 ["reportFailure"]
  DUPCLOSURE R30 K211 [PROTO_6]
  CAPTURE VAL R2
  CAPTURE VAL R28
  CAPTURE VAL R29
  CAPTURE VAL R5
  CAPTURE VAL R4
  SETTABLEKS R30 R29 K212 ["reportThumbnailing"]
  DUPCLOSURE R30 K213 [PROTO_7]
  CAPTURE VAL R6
  SETTABLEKS R30 R29 K214 ["recordScriptTime"]
  DUPCLOSURE R30 K215 [PROTO_8]
  CAPTURE VAL R6
  CAPTURE VAL R2
  CAPTURE VAL R29
  CAPTURE VAL R3
  SETTABLEKS R30 R29 K216 ["reportScriptTimes"]
  RETURN R29 1
