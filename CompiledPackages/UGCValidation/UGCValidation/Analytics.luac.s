...
MAIN:
  ...
  GETTABLEKS R29 R30 K38 ["getFFlagUGCValidateCurveAnimRotationSpeed"]
  CALL R28 1 1
  ...
  LOADK R32 K132 ["validateVertexDensity_FailedToExecute"]
  SETTABLEKS R32 R31 K132 ["validateVertexDensity_FailedToExecute"]
  LOADK R32 K133 ["validateVertexDensity_MaxDensityExceeded"]
  SETTABLEKS R32 R31 K133 ["validateVertexDensity_MaxDensityExceeded"]
  LOADK R32 K134 ["validateDynamicHeadMeshPartFormat_ValidateDynamicHeadMeshControls"]
  SETTABLEKS R32 R31 K134 ["validateDynamicHeadMeshPartFormat_ValidateDynamicHeadMeshControls"]
  LOADK R32 K135 ["validateRenderMeshInsideOuterCageMesh_FailedToExecute"]
  SETTABLEKS R32 R31 K135 ["validateRenderMeshInsideOuterCageMesh_FailedToExecute"]
  LOADK R32 K136 ["validateRenderMeshInsideOuterCageMesh_MaxOutsideCageMeshExceeded"]
  SETTABLEKS R32 R31 K136 ["validateRenderMeshInsideOuterCageMesh_MaxOutsideCageMeshExceeded"]
  LOADK R32 K137 ["validateLayeredClothingAccessory_CageOriginOutOfBounds"]
  SETTABLEKS R32 R31 K137 ["validateLayeredClothingAccessory_CageOriginOutOfBounds"]
  LOADK R32 K138 ["validateBodyPart_CageOriginOutOfBounds"]
  SETTABLEKS R32 R31 K138 ["validateBodyPart_CageOriginOutOfBounds"]
  LOADK R32 K139 ["validateTotalSurfaceArea_FailedToExecute"]
  SETTABLEKS R32 R31 K139 ["validateTotalSurfaceArea_FailedToExecute"]
  LOADK R32 K140 ["validateTotalSurfaceArea_maxTotalSurfaceAreaExceeded"]
  SETTABLEKS R32 R31 K140 ["validateTotalSurfaceArea_maxTotalSurfaceAreaExceeded"]
  LOADK R32 K141 ["validateCoplanarIntersection_FailedToExecute"]
  SETTABLEKS R32 R31 K141 ["validateCoplanarIntersection_FailedToExecute"]
  LOADK R32 K142 ["validateCoplanarIntersection_CoplanarIntersection"]
  SETTABLEKS R32 R31 K142 ["validateCoplanarIntersection_CoplanarIntersection"]
  LOADK R32 K143 ["validateExcludedModifiedCageUVs_FailedToExecute"]
  SETTABLEKS R32 R31 K143 ["validateExcludedModifiedCageUVs_FailedToExecute"]
  LOADK R32 K144 ["validateExcludedModifiedCageUVs_UnexpectedUVValue"]
  SETTABLEKS R32 R31 K144 ["validateExcludedModifiedCageUVs_UnexpectedUVValue"]
  LOADK R32 K145 ["validateMainModifiedCageUVs_FailedToExecute"]
  SETTABLEKS R32 R31 K145 ["validateMainModifiedCageUVs_FailedToExecute"]
  LOADK R32 K146 ["validateMainModifiedCageUVs_TooFewModifiedUVsFound"]
  SETTABLEKS R32 R31 K146 ["validateMainModifiedCageUVs_TooFewModifiedUVsFound"]
  LOADK R32 K147 ["validateRenderMeshInsideModifiedOuterCageArea_FailedToExecute"]
  SETTABLEKS R32 R31 K147 ["validateRenderMeshInsideModifiedOuterCageArea_FailedToExecute"]
  LOADK R32 K148 ["validateRenderMeshInsideModifiedOuterCageArea_RenderMeshNotPositionedCorrectly"]
  SETTABLEKS R32 R31 K148 ["validateRenderMeshInsideModifiedOuterCageArea_RenderMeshNotPositionedCorrectly"]
  LOADK R32 K149 ["validateBodyPartCage_FailedToExecute"]
  SETTABLEKS R32 R31 K149 ["validateBodyPartCage_FailedToExecute"]
  LOADK R32 K150 ["validateBodyPartCage_VertsAreTooFarInFrontOfRenderMesh"]
  SETTABLEKS R32 R31 K150 ["validateBodyPartCage_VertsAreTooFarInFrontOfRenderMesh"]
  LOADK R32 K151 ["validateCurveAnimation_IncorrectNumericalData"]
  SETTABLEKS R32 R31 K151 ["validateCurveAnimation_IncorrectNumericalData"]
  LOADK R32 K152 ["validateCurveAnimation_PositionalMovement"]
  SETTABLEKS R32 R31 K152 ["validateCurveAnimation_PositionalMovement"]
  SETTABLEKS R31 R30 K153 ["ErrorType"]
  MOVE R31 R14
  CALL R31 0 1
  JUMPIFNOT R31 [+5]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K154 ["validateMeshBounds_Shifted"]
  SETTABLEKS R32 R31 K154 ["validateMeshBounds_Shifted"]
  MOVE R31 R21
  CALL R31 0 1
  JUMPIFNOT R31 [+10]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K155 ["validateEachBodyPartFacsBounds_FailedToExecute"]
  SETTABLEKS R32 R31 K155 ["validateEachBodyPartFacsBounds_FailedToExecute"]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K156 ["validateEachBodyPartFacsBounds_ExtendedBounds"]
  SETTABLEKS R32 R31 K156 ["validateEachBodyPartFacsBounds_ExtendedBounds"]
  MOVE R31 R10
  CALL R31 0 1
  JUMPIFNOT R31 [+10]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K157 ["validateVerticesSimilarity_FailedToExecute"]
  SETTABLEKS R32 R31 K157 ["validateVerticesSimilarity_FailedToExecute"]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K158 ["validateVerticesSimilarity_MaxSimilarityExceeded"]
  SETTABLEKS R32 R31 K158 ["validateVerticesSimilarity_MaxSimilarityExceeded"]
  MOVE R31 R11
  CALL R31 0 1
  JUMPIFNOT R31 [+10]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K159 ["validateCagingRelevancy_FailedToExecute"]
  SETTABLEKS R32 R31 K159 ["validateCagingRelevancy_FailedToExecute"]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K160 ["validateCagingRelevancy_IrrelevantCaging"]
  SETTABLEKS R32 R31 K160 ["validateCagingRelevancy_IrrelevantCaging"]
  MOVE R31 R7
  CALL R31 0 1
  JUMPIFNOT R31 [+10]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K161 ["validateCageMeshDistance_FailedToExecute"]
  SETTABLEKS R32 R31 K161 ["validateCageMeshDistance_FailedToExecute"]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K162 ["validateCageMeshDistance_OuterCageToMeshDistance"]
  SETTABLEKS R32 R31 K162 ["validateCageMeshDistance_OuterCageToMeshDistance"]
  MOVE R31 R9
  CALL R31 0 1
  JUMPIFNOT R31 [+10]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K163 ["validateCageUVDuplicate_FailedToExecute"]
  SETTABLEKS R32 R31 K163 ["validateCageUVDuplicate_FailedToExecute"]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K164 ["validateCageUVDuplicate_UnexpectedUVValue"]
  SETTABLEKS R32 R31 K164 ["validateCageUVDuplicate_UnexpectedUVValue"]
  MOVE R31 R13
  CALL R31 0 1
  JUMPIFNOT R31 [+5]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K165 ["validatePartSizeWithinRenderSizeLimits_SizeExceeded"]
  SETTABLEKS R32 R31 K165 ["validatePartSizeWithinRenderSizeLimits_SizeExceeded"]
  MOVE R31 R15
  CALL R31 0 1
  JUMPIFNOT R31 [+5]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K166 ["validateLayeredClothingAccessory_HandleIsScaled"]
  SETTABLEKS R32 R31 K166 ["validateLayeredClothingAccessory_HandleIsScaled"]
  MOVE R31 R16
  CALL R31 0 1
  JUMPIFNOT R31 [+5]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K167 ["resetPhysicsData_LargeMass"]
  SETTABLEKS R32 R31 K167 ["resetPhysicsData_LargeMass"]
  MOVE R31 R12
  CALL R31 0 1
  JUMPIFNOT R31 [+10]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K168 ["validateRigidMeshSkinning_FailedToDownload"]
  SETTABLEKS R32 R31 K168 ["validateRigidMeshSkinning_FailedToDownload"]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K169 ["validateRigidMeshSkinning_BonesFoundInMesh"]
  SETTABLEKS R32 R31 K169 ["validateRigidMeshSkinning_BonesFoundInMesh"]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K170 ["validateBodyBlockingTests_ZeroMeshSize"]
  SETTABLEKS R32 R31 K170 ["validateBodyBlockingTests_ZeroMeshSize"]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K171 ["validateFullBody_ZeroMeshSize"]
  SETTABLEKS R32 R31 K171 ["validateFullBody_ZeroMeshSize"]
  MOVE R31 R17
  CALL R31 0 1
  JUMPIFNOT R31 [+10]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K172 ["validateBodyAttPosRelativeToParent_PartAboveParent"]
  SETTABLEKS R32 R31 K172 ["validateBodyAttPosRelativeToParent_PartAboveParent"]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K173 ["validateBodyAttPosRelativeToParent_ParentBelowPart"]
  SETTABLEKS R32 R31 K173 ["validateBodyAttPosRelativeToParent_ParentBelowPart"]
  MOVE R31 R18
  CALL R31 0 1
  JUMPIFNOT R31 [+15]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K174 ["validateBodyPartChildAttachmentOrientations_RotatedRig"]
  SETTABLEKS R32 R31 K174 ["validateBodyPartChildAttachmentOrientations_RotatedRig"]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K175 ["validateBodyPartChildAttachmentOrientations_RotatedGrip"]
  SETTABLEKS R32 R31 K175 ["validateBodyPartChildAttachmentOrientations_RotatedGrip"]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K176 ["validateBodyPartChildAttachmentOrientations_RotatedBasic"]
  SETTABLEKS R32 R31 K176 ["validateBodyPartChildAttachmentOrientations_RotatedBasic"]
  MOVE R31 R19
  CALL R31 0 1
  JUMPIFNOT R31 [+10]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K177 ["validateDeformedLayeredClothingInRenderBounds_FailedToExecute"]
  SETTABLEKS R32 R31 K177 ["validateDeformedLayeredClothingInRenderBounds_FailedToExecute"]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K178 ["validateDeformedLayeredClothingInRenderBounds_ClothingOutOfBounds"]
  SETTABLEKS R32 R31 K178 ["validateDeformedLayeredClothingInRenderBounds_ClothingOutOfBounds"]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K179 ["validateEmoteAnimation_FailedToDownloadCurveAnimation"]
  SETTABLEKS R32 R31 K179 ["validateEmoteAnimation_FailedToDownloadCurveAnimation"]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K180 ["validateCurveAnimation_AnimationHierarchyIsIncorrect"]
  SETTABLEKS R32 R31 K180 ["validateCurveAnimation_AnimationHierarchyIsIncorrect"]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K181 ["validateCurveAnimation_AnimationContainsNoJointManipulation"]
  SETTABLEKS R32 R31 K181 ["validateCurveAnimation_AnimationContainsNoJointManipulation"]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K182 ["validateCurveAnimation_UnacceptableLength"]
  SETTABLEKS R32 R31 K182 ["validateCurveAnimation_UnacceptableLength"]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K183 ["validateCurveAnimation_UnacceptableSizeBounds"]
  SETTABLEKS R32 R31 K183 ["validateCurveAnimation_UnacceptableSizeBounds"]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K184 ["validateCurveAnimation_UnacceptableFrameDelta"]
  SETTABLEKS R32 R31 K184 ["validateCurveAnimation_UnacceptableFrameDelta"]
  MOVE R31 R28
  CALL R31 0 1
  JUMPIFNOT R31 [+5]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K185 ["validateCurveAnimation_UnacceptableFrameRotationDelta"]
  SETTABLEKS R32 R31 K185 ["validateCurveAnimation_UnacceptableFrameRotationDelta"]
  MOVE R31 R24
  CALL R31 0 1
  JUMPIFNOT R31 [+5]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K186 ["validateCurveAnimation_IncorrectAnimationRigData"]
  SETTABLEKS R32 R31 K186 ["validateCurveAnimation_IncorrectAnimationRigData"]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K187 ["validateMeshSizeProperty_FailedToLoadMesh"]
  SETTABLEKS R32 R31 K187 ["validateMeshSizeProperty_FailedToLoadMesh"]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K188 ["validateMeshSizeProperty_Mismatch"]
  SETTABLEKS R32 R31 K188 ["validateMeshSizeProperty_Mismatch"]
  MOVE R31 R22
  CALL R31 0 1
  JUMPIFNOT R31 [+10]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K189 ["validateBodyPartVertsSkinnedToR15_FailedToFetchSkinning"]
  SETTABLEKS R32 R31 K189 ["validateBodyPartVertsSkinnedToR15_FailedToFetchSkinning"]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K190 ["validateBodyPartVertsSkinnedToR15_BodyIsSkinnedToFakeJoints"]
  SETTABLEKS R32 R31 K190 ["validateBodyPartVertsSkinnedToR15_BodyIsSkinnedToFakeJoints"]
  MOVE R31 R23
  CALL R31 0 1
  JUMPIFNOT R31 [+20]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K191 ["validateSkinningTransfer_FailedToExecute"]
  SETTABLEKS R32 R31 K191 ["validateSkinningTransfer_FailedToExecute"]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K192 ["validateSkinningTransfer_BodyPartsWithSpecialJoints"]
  SETTABLEKS R32 R31 K192 ["validateSkinningTransfer_BodyPartsWithSpecialJoints"]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K193 ["validateSkinningTransfer_SkinningTransferOverride"]
  SETTABLEKS R32 R31 K193 ["validateSkinningTransfer_SkinningTransferOverride"]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K194 ["validateSkinningTransfer_Weights"]
  SETTABLEKS R32 R31 K194 ["validateSkinningTransfer_Weights"]
  MOVE R31 R27
  CALL R31 0 1
  JUMPIFNOT R31 [+5]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K195 ["validateSkinningTransfer_RequiredAssetTypes"]
  SETTABLEKS R32 R31 K195 ["validateSkinningTransfer_RequiredAssetTypes"]
  MOVE R31 R25
  CALL R31 0 1
  JUMPIFNOT R31 [+5]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K196 ["validatePropertiesSensible_IncorrectPropertiesFound"]
  SETTABLEKS R32 R31 K196 ["validatePropertiesSensible_IncorrectPropertiesFound"]
  MOVE R31 R26
  CALL R31 0 1
  JUMPIFNOT R31 [+5]
  GETTABLEKS R31 R30 K153 ["ErrorType"]
  LOADK R32 K197 ["validateHSR_FileDataInvalid"]
  SETTABLEKS R32 R31 K197 ["validateHSR_FileDataInvalid"]
  GETTABLEKS R32 R30 K153 ["ErrorType"]
  DUPTABLE R33 K199 [{"__index"}]
  DUPCLOSURE R34 K200 [PROTO_1]
  SETTABLEKS R34 R33 K198 ["__index"]
  FASTCALL2 SETMETATABLE R32 R33 [+3]
  GETIMPORT R31 K202 [setmetatable]
  CALL R31 2 0
  NEWTABLE R31 0 0
  SETTABLEKS R31 R30 K203 ["metadata"]
  DUPCLOSURE R31 K204 [PROTO_2]
  CAPTURE VAL R30
  SETTABLEKS R31 R30 K205 ["setMetadata"]
  DUPCLOSURE R31 K206 [PROTO_3]
  CAPTURE VAL R8
  CAPTURE VAL R2
  SETTABLEKS R31 R30 K207 ["shouldReportIECTelemetry"]
  DUPCLOSURE R31 K208 [PROTO_4]
  CAPTURE VAL R30
  CAPTURE VAL R3
  SETTABLEKS R31 R30 K209 ["reportCounter"]
  DUPCLOSURE R31 K210 [PROTO_5]
  CAPTURE VAL R2
  CAPTURE VAL R29
  CAPTURE VAL R30
  CAPTURE VAL R5
  CAPTURE VAL R4
  CAPTURE VAL R3
  SETTABLEKS R31 R30 K211 ["reportFailure"]
  DUPCLOSURE R31 K212 [PROTO_6]
  CAPTURE VAL R2
  CAPTURE VAL R29
  CAPTURE VAL R30
  CAPTURE VAL R5
  CAPTURE VAL R4
  SETTABLEKS R31 R30 K213 ["reportThumbnailing"]
  DUPCLOSURE R31 K214 [PROTO_7]
  CAPTURE VAL R6
  SETTABLEKS R31 R30 K215 ["recordScriptTime"]
  DUPCLOSURE R31 K216 [PROTO_8]
  CAPTURE VAL R6
  CAPTURE VAL R2
  CAPTURE VAL R30
  CAPTURE VAL R3
  SETTABLEKS R31 R30 K217 ["reportScriptTimes"]
  RETURN R30 1
