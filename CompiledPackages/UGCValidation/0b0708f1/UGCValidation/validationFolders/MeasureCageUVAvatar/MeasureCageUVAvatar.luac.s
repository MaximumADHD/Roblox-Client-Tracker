PROTO_0:
        0 GETTABLEKS                       R3 R1 K0 ["aqsSummaryData"]
        2 GETTABLEKS                       R2 R3 K1 ["Measure_Cage_UV_Avatar"]
        4 GETUPVAL                         R6 0
        5 GETTABLEKS                       R3 R6 K2 ["R15_CAGE_PARTS"]
        7 LOADNIL                          R4
        8 LOADNIL                          R5
        9 FORGPREP                         R3
       10 GETTABLE                         R8 R2 R7
       11 JUMPIFEQKNIL                     R8 ; [+6]
       13 GETTABLE                         R9 R2 R7
       14 GETTABLEKS                       R8 R9 K3 ["incorrect_uv_count"]
       16 JUMPIFNOTEQKNIL                  R8 ; [+10]
       18 GETUPVAL                         R12 1
       19 GETTABLEKS                       R11 R12 K4 ["Keys"]
       21 GETTABLEKS                       R10 R11 K5 ["AQSInputDataError"]
       23 NAMECALL                         R8 R0 K6 ["fail"]
       25 CALL                             R8 2 0
       26 JUMP                             ; [+30]
       27 GETTABLE                         R10 R2 R7
       28 GETTABLEKS                       R9 R10 K3 ["incorrect_uv_count"]
       ...
       37 GETUPVAL                         R12 1
       38 GETTABLEKS                       R11 R12 K4 ["Keys"]
       40 GETTABLEKS                       R10 R11 K9 ["MeasureCageUV"]
       42 DUPTABLE                         R11 K11 [{"cage_name", "incorrect_uv_count"}]
       43 SETTABLEKS                       R7 R11 K10 ["cage_name"]
       45 GETTABLE                         R14 R2 R7
       46 GETTABLEKS                       R13 R14 K3 ["incorrect_uv_count"]
...
MAIN:
       ...
       42 NEWTABLE                         R6 4 0
       44 NEWTABLE                         R7 0 1
       46 GETTABLEKS                       R9 R2 K15 ["UploadCategory"]
       48 GETTABLEKS                       R8 R9 K16 ["FULL_BODY"]
       50 SETLIST                          R7 R8 1 [1]
       52 SETTABLEKS                       R7 R6 K17 ["categories"]
       54 GETIMPORT                        R7 K4 [require]
       56 GETTABLEKS                       R9 R0 K18 ["flags"]
       58 GETTABLEKS                       R8 R9 K19 ["getFFlagUGCValidateAQCageQualityAvatar"]
       60 CALL                             R7 1 1
