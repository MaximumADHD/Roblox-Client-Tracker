...
PROTO_2:
       ...
       53 GETUPVAL                         R7 2
       54 GETTABLEKS                       R6 R7 K17 ["processAll"]
       56 MOVE                             R7 R4
       57 GETUPVAL                         R8 0
       58 CALL                             R6 2 2
       59 JUMPIF                           R6 ; [+3]
       ...
       78 JUMPIFNOT                        R8 ; [+10]
       79 GETUPVAL                         R9 5
       80 GETTABLEKS                       R8 R9 K20 ["studioRFUAssetValidation"]
       82 MOVE                             R9 R5
       83 GETUPVAL                         R10 6
       84 MOVE                             R11 R2
       85 MOVE                             R12 R3
      ...
      103 GETUPVAL                         R11 8
      104 GETTABLEKS                       R10 R11 K24 ["errors"]
      106 CALL                             R9 1 1
      ...
      123 FORGPREP                         R8
      124 GETUPVAL                         R15 8
      125 GETTABLEKS                       R14 R15 K24 ["errors"]
      ...
      150 GETUPVAL                         R11 8
      151 GETTABLEKS                       R10 R11 K33 ["pieces"]
      153 CALL                             R9 1 1
      154 SETTABLEKS                       R9 R8 K33 ["pieces"]
      156 GETUPVAL                         R10 8
      157 GETTABLEKS                       R9 R10 K33 ["pieces"]
...
MAIN:
       ...
       37 GETTABLEKS                       R6 R7 K10 ["createEditableInstancesForContext"]
       39 CALL                             R5 1 1
       40 GETIMPORT                        R6 K4 [require]
       42 GETTABLEKS                       R8 R0 K7 ["util"]
       44 GETTABLEKS                       R7 R8 K11 ["destroyEditableInstances"]
       46 CALL                             R6 1 1
       47 GETIMPORT                        R7 K4 [require]
       49 GETTABLEKS                       R9 R0 K7 ["util"]
       51 GETTABLEKS                       R8 R9 K12 ["createUGCBodyPartFolders"]
       53 CALL                             R7 1 1
       54 GETIMPORT                        R8 K4 [require]
       56 GETTABLEKS                       R10 R0 K7 ["util"]
       58 GETTABLEKS                       R9 R10 K13 ["fixUpPreValidation"]
       60 CALL                             R8 1 1
       61 GETIMPORT                        R9 K4 [require]
       63 GETTABLEKS                       R11 R0 K14 ["validation"]
       65 GETTABLEKS                       R10 R11 K15 ["validateInternal"]
       67 CALL                             R9 1 1
       68 GETIMPORT                        R10 K4 [require]
       70 GETTABLEKS                       R12 R0 K14 ["validation"]
       72 GETTABLEKS                       R11 R12 K16 ["validateFullBody"]
       74 CALL                             R10 1 1
       75 GETIMPORT                        R11 K4 [require]
       77 GETTABLEKS                       R13 R0 K17 ["flags"]
       79 GETTABLEKS                       R12 R13 K18 ["getFFlagUGCValidationEnableFolderStructure"]
       81 CALL                             R11 1 1
       82 GETIMPORT                        R12 K4 [require]
       84 GETTABLEKS                       R14 R0 K7 ["util"]
       86 GETTABLEKS                       R13 R14 K19 ["LegacyValidationAdapter"]
       88 CALL                             R12 1 1
