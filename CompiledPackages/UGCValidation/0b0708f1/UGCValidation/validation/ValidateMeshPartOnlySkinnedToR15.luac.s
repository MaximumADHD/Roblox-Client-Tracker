...
PROTO_1:
       ...
       15 JUMPIF                           R2 ; [+23]
       16 GETUPVAL                         R5 3
       17 GETTABLEKS                       R4 R5 K4 ["reportFailure"]
       19 GETUPVAL                         R7 3
       20 GETTABLEKS                       R6 R7 K5 ["ErrorType"]
       22 GETTABLEKS                       R5 R6 K6 ["validateBodyPartVertsSkinnedToR15_FailedToFetchSkinning"]
       24 LOADNIL                          R6
       25 MOVE                             R7 R1
       26 CALL                             R4 3 0
       27 LOADB                            R4 0
       ...
       45 JUMPIF                           R4 ; [+23]
       46 GETUPVAL                         R7 3
       47 GETTABLEKS                       R6 R7 K4 ["reportFailure"]
       49 GETUPVAL                         R9 3
       50 GETTABLEKS                       R8 R9 K5 ["ErrorType"]
       52 GETTABLEKS                       R7 R8 K6 ["validateBodyPartVertsSkinnedToR15_FailedToFetchSkinning"]
       54 LOADNIL                          R8
       55 MOVE                             R9 R1
       56 CALL                             R6 3 0
       57 LOADB                            R6 0
       ...
       72 FORGPREP                         R6
       73 GETUPVAL                         R13 6
       74 GETTABLEKS                       R12 R13 K10 ["R15_STANDARD_JOINT_NAMES"]
       76 GETTABLE                         R11 R12 R10
       77 JUMPIFNOTEQKNIL                  R11 ; [+25]
       79 GETUPVAL                         R12 3
       80 GETTABLEKS                       R11 R12 K4 ["reportFailure"]
       82 GETUPVAL                         R14 3
       83 GETTABLEKS                       R13 R14 K5 ["ErrorType"]
       85 GETTABLEKS                       R12 R13 K11 ["validateBodyPartVertsSkinnedToR15_BodyIsSkinnedToFakeJoints"]
       87 LOADNIL                          R13
       88 MOVE                             R14 R1
       89 CALL                             R11 3 0
       90 LOADB                            R11 0
...
PROTO_2:
        ...
        9 CALL                             R2 1 0
       10 GETUPVAL                         R5 2
       11 GETTABLEKS                       R2 R5 K3 ["R15_BODY_PARTS"]
       13 LOADNIL                          R3
       14 LOADNIL                          R4
       15 FORGPREP                         R2
       16 MOVE                             R9 R6
       ...
       20 JUMPIFNOT                        R7 ; [+8]
       21 GETUPVAL                         R9 3
       22 GETTABLEKS                       R8 R9 K5 ["validateMeshPart"]
       24 MOVE                             R9 R7
       25 MOVE                             R10 R1
       26 CALL                             R8 2 2
       27 JUMPIF                           R8 ; [+1]
...
MAIN:
       ...
       44 GETTABLEKS                       R10 R0 K15 ["flags"]
       46 GETTABLEKS                       R9 R10 K16 ["getEngineFeatureEngineUGCValidationConsolidateAccessorySkinning"]
       48 CALL                             R8 1 1
       49 GETIMPORT                        R9 K8 [require]
       51 GETTABLEKS                       R11 R0 K15 ["flags"]
       53 GETTABLEKS                       R10 R11 K17 ["getFFlagUGCValidationEnableR15plusSkinning"]
       55 CALL                             R9 1 1
       56 NEWTABLE                         R10 2 0
