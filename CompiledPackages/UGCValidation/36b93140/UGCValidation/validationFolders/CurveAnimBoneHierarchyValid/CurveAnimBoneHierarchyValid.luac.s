...
PROTO_1:
       ...
       17 LOADNIL                          R6
       18 FORGPREP                         R4
       19 DUPTABLE                         R11 K5 [{["ClassName"] = "Folder", ["Name"]}]
       20 SETTABLEKS                       R8 R11 K1 ["Name"]
       22 FASTCALL2                        TABLE_INSERT R2 R11 ; [+4]
       24 MOVE                             R10 R2
       25 GETIMPORT                        R9 K8 [table.insert]
       27 CALL                             R9 2 0
       28 FORGLOOP                         R4 2 ; [-10]
       30 LOADB                            R4 0
       31 LENGTH                           R5 R3
       32 JUMPIFNOTEQKN                    R5 K9 [1] ; [+19]
       34 GETTABLEN                        R5 R3 1
       35 NAMECALL                         R6 R0 K10 ["GetChildren"]
       37 CALL                             R6 1 3
       38 FORGPREP                         R6
       39 LOADK                            R13 K4 ["Folder"]
       40 NAMECALL                         R11 R10 K11 ["IsA"]
       42 CALL                             R11 2 1
       43 JUMPIFNOT                        R11 ; [+6]
       44 GETTABLEKS                       R11 R10 K1 ["Name"]
       46 JUMPIFNOTEQ                      R11 R5 ; [+3]
       48 LOADB                            R4 1
       49 JUMP                             ; [+2]
       50 FORGLOOP                         R6 2 ; [-12]
       52 JUMPIF                           R4 ; [+15]
       53 GETUPVAL                         R5 1
       54 GETTABLEKS                       R5 R5 K12 ["calculateAcceptableChildBodyPartFolders"]
       56 MOVE                             R6 R1
       57 CALL                             R5 1 3
       58 FORGPREP                         R5
       ...
       61 MOVE                             R11 R2
       62 MOVE                             R12 R9
       63 GETIMPORT                        R10 K8 [table.insert]
       65 CALL                             R10 2 0
       66 FORGLOOP                         R5 2 ; [-8]
       68 DUPTABLE                         R7 K15 [{["ClassName"] = "Vector3Curve", ["Name"] = "Position"}]
       69 FASTCALL2                        TABLE_INSERT R2 R7 ; [+4]
       71 MOVE                             R6 R2
       72 GETIMPORT                        R5 K8 [table.insert]
       74 CALL                             R5 2 0
       75 DUPTABLE                         R7 K18 [{["ClassName"] = "EulerRotationCurve", ["Name"] = "Rotation"}]
       76 FASTCALL2                        TABLE_INSERT R2 R7 ; [+4]
       78 MOVE                             R6 R2
       79 GETIMPORT                        R5 K8 [table.insert]
       81 CALL                             R5 2 0
       82 RETURN                           R2 1
       83 GETUPVAL                         R2 1
       84 GETTABLEKS                       R2 R2 K12 ["calculateAcceptableChildBodyPartFolders"]
       86 GETTABLEKS                       R3 R0 K1 ["Name"]
       88 CALL                             R2 1 1
       89 GETUPVAL                         R3 0
       90 GETTABLEKS                       R3 R3 K19 ["getRootBoneNamesForBodyPart"]
       92 GETTABLEKS                       R4 R0 K1 ["Name"]
       94 CALL                             R3 1 3
       95 FORGPREP                         R3
       96 DUPTABLE                         R10 K5 [{["ClassName"] = "Folder", ["Name"]}]
       97 SETTABLEKS                       R7 R10 K1 ["Name"]
       99 FASTCALL2                        TABLE_INSERT R2 R10 ; [+4]
      101 MOVE                             R9 R2
      102 GETIMPORT                        R8 K8 [table.insert]
      104 CALL                             R8 2 0
      105 FORGLOOP                         R3 2 ; [-10]
      107 GETTABLEKS                       R3 R0 K1 ["Name"]
      109 GETUPVAL                         R4 1
      110 GETTABLEKS                       R4 R4 K20 ["humanoidRootPartName"]
      112 JUMPIFNOTEQ                      R3 R4 ; [+2]
      114 RETURN                           R2 1
      115 DUPTABLE                         R5 K15 [{["ClassName"] = "Vector3Curve", ["Name"] = "Position"}]
      116 FASTCALL2                        TABLE_INSERT R2 R5 ; [+4]
      118 MOVE                             R4 R2
      119 GETIMPORT                        R3 K8 [table.insert]
      121 CALL                             R3 2 0
      122 DUPTABLE                         R5 K18 [{["ClassName"] = "EulerRotationCurve", ["Name"] = "Rotation"}]
      123 FASTCALL2                        TABLE_INSERT R2 R5 ; [+4]
      125 MOVE                             R4 R2
      126 GETIMPORT                        R3 K8 [table.insert]
      128 CALL                             R3 2 0
      129 GETTABLEKS                       R3 R0 K1 ["Name"]
      131 JUMPIFNOTEQKS                    R3 K21 ["Head"] ; [+13]
      133 DUPTABLE                         R5 K5 [{["ClassName"] = "Folder", ["Name"]}]
      134 GETUPVAL                         R6 1
      135 GETTABLEKS                       R6 R6 K22 ["FaceControlsName"]
      137 SETTABLEKS                       R6 R5 K1 ["Name"]
      139 FASTCALL2                        TABLE_INSERT R2 R5 ; [+4]
      141 MOVE                             R4 R2
      142 GETIMPORT                        R3 K8 [table.insert]
      144 CALL                             R3 2 0
      145 RETURN                           R2 1
...
MAIN:
       ...
       74 GETTABLEKS                       R11 R0 K12 ["flags"]
       76 GETTABLEKS                       R11 R11 K17 ["getFFlagUGCValidateAnimBonesSupport"]
       78 CALL                             R10 1 1
       79 GETIMPORT                        R11 K4 [require]
       81 GETTABLEKS                       R12 R0 K12 ["flags"]
       ...
       98 MOVE                             R13 R10
       99 CALL                             R13 0 1
      100 JUMPIFNOT                        R13 ; [+14]
      101 MOVE                             R13 R11
      102 CALL                             R13 0 1
      103 JUMPIFNOT                        R13 ; [+11]
      104 GETTABLEKS                       R14 R12 K21 ["categories"]
      106 GETTABLEKS                       R15 R2 K19 ["UploadCategory"]
      108 GETTABLEKS                       R15 R15 K22 ["ANIMATION"]
      110 FASTCALL2                        TABLE_INSERT R14 R15 ; [+3]
      112 GETIMPORT                        R13 K25 [table.insert]
      114 CALL                             R13 2 0
      115 NEWTABLE                         R13 0 1
      117 GETTABLEKS                       R14 R2 K26 ["SharedDataMember"]
      119 GETTABLEKS                       R14 R14 K27 ["curveAnimations"]
      121 SETLIST                          R13 R14 1 [1]
      123 SETTABLEKS                       R13 R12 K28 ["requiredData"]
      125 NEWTABLE                         R13 0 1
      127 GETTABLEKS                       R14 R2 K26 ["SharedDataMember"]
      129 GETTABLEKS                       R14 R14 K29 ["curveAnimBoneData"]
      131 SETLIST                          R13 R14 1 [1]
      133 SETTABLEKS                       R13 R12 K30 ["conditionalData"]
      135 DUPCLOSURE                       R13 K31 [PROTO_0]
      136 CAPTURE                          VAL R6
      137 CAPTURE                          VAL R10
      138 SETTABLEKS                       R13 R12 K32 ["fflag"]
      140 NEWTABLE                         R13 0 0
      142 SETTABLEKS                       R13 R12 K33 ["expectedFailures"]
      144 NEWTABLE                         R13 0 1
      146 GETTABLEKS                       R14 R2 K34 ["ValidationModule"]
      148 GETTABLEKS                       R14 R14 K35 ["CurveAnimDataAvailable"]
      150 SETLIST                          R13 R14 1 [1]
      152 SETTABLEKS                       R13 R12 K36 ["prereqTests"]
      154 DUPCLOSURE                       R13 K37 [PROTO_1]
      155 CAPTURE                          VAL R5
      156 CAPTURE                          VAL R4
      157 DUPCLOSURE                       R14 K38 [PROTO_2]
      158 DUPCLOSURE                       R15 K39 [PROTO_3]
      159 CAPTURE                          VAL R13
      160 CAPTURE                          VAL R14
      161 CAPTURE                          VAL R4
      162 CAPTURE                          VAL R8
      163 CAPTURE                          VAL R9
      164 DUPCLOSURE                       R16 K40 [PROTO_4]
      165 CAPTURE                          VAL R15
      166 CAPTURE                          VAL R3
      167 CAPTURE                          VAL R4
      168 CAPTURE                          VAL R5
      169 CAPTURE                          VAL R16
      170 DUPCLOSURE                       R17 K41 [PROTO_5]
      171 CAPTURE                          VAL R7
      172 CAPTURE                          VAL R4
      173 CAPTURE                          VAL R16
      174 SETTABLEKS                       R17 R12 K42 ["run"]
      176 RETURN                           R12 1
