...
PROTO_2:
       ...
       41 DUPTABLE                         R14 K16 [{["instance"], ["created"] = False}]
       42 GETTABLEKS                       R15 R12 K10 ["editable"]
       44 SETTABLEKS                       R15 R14 K13 ["instance"]
       46 SETTABLEKS                       R14 R13 K11 ["MeshId"]
       48 SETTABLE                         R13 R5 R11
       49 FORGLOOP                         R7 2 ; [-19]
       51 DUPTABLE                         R6 K20 [{"assetTypeEnum", "isServer", "editableMeshes"}]
       52 SETTABLEKS                       R3 R6 K17 ["assetTypeEnum"]
       54 GETTABLEKS                       R8 R1 K21 ["consumerConfig"]
       56 GETTABLEKS                       R8 R8 K22 ["consumerEnv"]
       58 GETUPVAL                         R9 1
       59 GETTABLEKS                       R9 R9 K23 ["ConsumerEnv"]
       61 GETTABLEKS                       R9 R9 K24 ["Backend"]
       63 JUMPIFEQ                         R8 R9 ; [+2]
       65 LOADB                            R7 0 +1
       66 LOADB                            R7 1
       67 SETTABLEKS                       R7 R6 K18 ["isServer"]
       69 SETTABLEKS                       R5 R6 K19 ["editableMeshes"]
       71 GETUPVAL                         R7 2
       72 GETTABLEKS                       R7 R7 K25 ["calculateIndividualAssetPartsData"]
       74 MOVE                             R8 R2
       75 MOVE                             R9 R6
       76 CALL                             R7 2 3
       77 JUMPIF                           R7 ; [+15]
       78 GETUPVAL                         R12 3
       79 GETTABLEKS                       R12 R12 K26 ["Keys"]
       81 GETTABLEKS                       R12 R12 K27 ["AttachmentBoundsAssetCalculationFailed"]
       83 DUPTABLE                         R13 K29 [{"InstancePath"}]
       84 NAMECALL                         R14 R2 K30 ["GetFullName"]
       86 CALL                             R14 1 1
       87 SETTABLEKS                       R14 R13 K28 ["InstancePath"]
       89 NAMECALL                         R10 R0 K31 ["fail"]
       91 CALL                             R10 3 0
       92 RETURN                           R0 0
       93 GETIMPORT                        R10 K35 [Enum.AssetType.DynamicHead]
       95 JUMPIFNOTEQ                      R10 R3 ; [+15]
       97 GETTABLEKS                       R11 R2 K9 ["Name"]
       99 GETTABLE                         R10 R9 R11
      100 JUMPIFNOT                        R10 ; [+31]
      101 GETUPVAL                         R11 4
      102 MOVE                             R12 R2
      103 GETTABLEKS                       R13 R4 K36 ["subParts"]
      105 GETTABLEKS                       R13 R13 K37 ["Head"]
      107 MOVE                             R14 R10
      108 MOVE                             R15 R0
      109 CALL                             R11 4 0
      110 RETURN                           R0 0
      111 GETIMPORT                        R10 K39 [pairs]
      113 GETTABLEKS                       R11 R4 K36 ["subParts"]
      115 CALL                             R10 1 3
      116 FORGPREP_NEXT                    R10
      117 MOVE                             R17 R13
      118 NAMECALL                         R15 R2 K40 ["FindFirstChild"]
      120 CALL                             R15 2 1
      121 JUMPIFNOT                        R15 ; [+8]
