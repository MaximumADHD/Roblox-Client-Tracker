PROTO_0:
       ...
       11 CALL                             R4 1 0
       12 GETUPVAL                         R4 0
       13 GETTABLEKS                       R4 R4 K3 ["reportFailure"]
       15 MOVE                             R5 R1
       16 LOADNIL                          R6
       17 MOVE                             R7 R2
       18 CALL                             R4 3 0
...
PROTO_3:
       ...
       19 JUMPIF                           R3 ; [+16]
       20 GETUPVAL                         R5 1
       21 GETIMPORT                        R6 K10 [string.format]
       23 LOADK                            R7 K11 ["Mesh for '%s' failed to load. Make sure the mesh exists and try again."]
       24 GETTABLEKS                       R8 R0 K7 ["Name"]
       26 CALL                             R6 2 1
       27 GETUPVAL                         R7 2
       28 GETTABLEKS                       R7 R7 K12 ["ErrorType"]
       30 GETTABLEKS                       R7 R7 K13 ["validateMeshSizeProperty_FailedToLoadMesh"]
       32 MOVE                             R8 R1
       33 LOADB                            R9 0
       34 CALL                             R5 4 -1
       35 RETURN                           R5 -1
       36 SETTABLEKS                       R4 R2 K14 ["editableMesh"]
       38 GETUPVAL                         R5 3
       39 NEWCLOSURE                       R6 P0
       40 CAPTURE                          UPVAL U4
       41 CAPTURE                          VAL R2
       ...
       44 JUMPIF                           R5 ; [+16]
       45 GETUPVAL                         R7 1
       46 GETIMPORT                        R8 K10 [string.format]
       48 LOADK                            R9 K11 ["Mesh for '%s' failed to load. Make sure the mesh exists and try again."]
       49 GETTABLEKS                       R10 R0 K7 ["Name"]
       51 CALL                             R8 2 1
       52 GETUPVAL                         R9 2
       53 GETTABLEKS                       R9 R9 K12 ["ErrorType"]
       55 GETTABLEKS                       R9 R9 K13 ["validateMeshSizeProperty_FailedToLoadMesh"]
       57 MOVE                             R10 R1
       58 LOADB                            R11 1
       59 CALL                             R7 4 -1
       60 RETURN                           R7 -1
...
PROTO_4:
       ...
       45 CALL                             R7 2 1
       46 GETUPVAL                         R8 3
       47 GETTABLEKS                       R8 R8 K12 ["ErrorType"]
       49 GETTABLEKS                       R8 R8 K13 ["validateMeshSizeProperty_Mismatch"]
       51 MOVE                             R9 R1
       52 LOADB                            R10 0
       53 CALL                             R6 4 -1
       54 RETURN                           R6 -1
       55 GETUPVAL                         R6 3
       56 GETTABLEKS                       R6 R6 K14 ["recordScriptTime"]
       58 GETIMPORT                        R7 K16 [script]
       60 GETTABLEKS                       R7 R7 K11 ["Name"]
       62 MOVE                             R8 R2
       63 MOVE                             R9 R1
       64 CALL                             R6 3 0
       65 LOADB                            R6 1
...
PROTO_6:
       ...
       17 CALL                             R4 2 2
       18 GETUPVAL                         R6 1
       19 GETTABLEKS                       R6 R6 K8 ["recordScriptTime"]
       21 GETIMPORT                        R7 K10 [script]
       23 GETTABLEKS                       R7 R7 K11 ["Name"]
       25 MOVE                             R8 R2
       26 MOVE                             R9 R1
       27 CALL                             R6 3 0
       28 RETURN                           R4 2
       ...
       32 CALL                             R4 0 1
       33 GETUPVAL                         R6 3
       34 GETTABLEKS                       R6 R6 K13 ["ASSET_TYPE_INFO"]
       ...
       58 FORGLOOP                         R6 1 ; [-17]
       60 GETUPVAL                         R6 1
       61 GETTABLEKS                       R6 R6 K8 ["recordScriptTime"]
       63 GETIMPORT                        R7 K10 [script]
       65 GETTABLEKS                       R7 R7 K11 ["Name"]
       67 MOVE                             R8 R2
       68 MOVE                             R9 R1
       69 CALL                             R6 3 0
...
MAIN:
       ...
       23 GETTABLEKS                       R5 R5 K8 ["floatEquals"]
       25 CALL                             R4 1 1
