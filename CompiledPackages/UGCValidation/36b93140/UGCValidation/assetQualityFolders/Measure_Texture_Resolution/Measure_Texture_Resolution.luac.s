PROTO_0:
        ...
        2 GETTABLEKS                       R2 R2 K1 ["Measure_Texture_Resolution"]
        4 JUMPIFNOTEQKNIL                  R2 ; [+11]
        6 GETUPVAL                         R5 0
        7 GETTABLEKS                       R5 R5 K2 ["Keys"]
        9 GETTABLEKS                       R5 R5 K3 ["AQSWarn_MissingData"]
       11 DUPTABLE                         R6 K5 [{["measureName"] = "Measure_Texture_Resolution"}]
       ...
       18 LOADNIL                          R5
       19 FORGPREP                         R3
       20 JUMPIFEQKS                       R6 K7 ["measurement_score"] ; [+63]
       ...
       33 DUPTABLE                         R11 K5 [{["measureName"] = "Measure_Texture_Resolution"}]
       ...
       43 CALL                             R8 1 1
       44 JUMPIFEQKN                       R8 K11 [100] ; [+39]
       46 GETUPVAL                         R10 0
       47 GETTABLEKS                       R10 R10 K2 ["Keys"]
       49 GETTABLEKS                       R10 R10 K12 ["AQSWarn_TextureResolution"]
       51 DUPTABLE                         R11 K16 [{"textureName", "texture_width", "texture_height", "score"}]
       52 SETTABLEKS                       R6 R11 K13 ["textureName"]
       54 GETTABLEKS                       R13 R7 K14 ["texture_width"]
       56 ORK                              R12 R13 K17 ["unknown"]
       57 SETTABLEKS                       R12 R11 K14 ["texture_width"]
       59 GETTABLEKS                       R13 R7 K15 ["texture_height"]
       61 ORK                              R12 R13 K17 ["unknown"]
       62 SETTABLEKS                       R12 R11 K15 ["texture_height"]
       64 GETTABLEKS                       R16 R7 K8 ["score"]
       66 FASTCALL1                        TONUMBER R16 ; [+2]
       67 GETIMPORT                        R15 K10 [tonumber]
       69 CALL                             R15 1 1
       70 ORK                              R14 R15 K18 [0]
       71 FASTCALL1                        MATH_FLOOR R14 ; [+2]
       72 GETIMPORT                        R13 K21 [math.floor]
       74 CALL                             R13 1 1
       75 FASTCALL1                        TOSTRING R13 ; [+2]
       76 GETIMPORT                        R12 K23 [tostring]
       78 CALL                             R12 1 1
       79 SETTABLEKS                       R12 R11 K8 ["score"]
       81 NAMECALL                         R8 R0 K6 ["warn"]
       83 CALL                             R8 3 0
       84 FORGLOOP                         R3 2 ; [-65]
       86 RETURN                           R0 0
