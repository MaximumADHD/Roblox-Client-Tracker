PROTO_0:
        ...
        9 CALL                             R7 2 1
       10 GETUPVAL                         R8 0
       11 GETTABLEKS                       R8 R8 K1 ["getRigAttachmentToParent"]
       13 GETUPVAL                         R9 1
       14 MOVE                             R10 R3
       15 CALL                             R8 2 1
       16 MOVE                             R11 R8
       17 GETUPVAL                         R12 2
       18 GETTABLEKS                       R12 R12 K2 ["checkFlagEnabledForAllowHrd"]
       20 CALL                             R12 0 -1
       21 NAMECALL                         R9 R7 K0 ["FindFirstChild"]
       23 CALL                             R9 -1 1
       24 MOVE                             R12 R8
       25 GETUPVAL                         R13 2
       26 GETTABLEKS                       R13 R13 K2 ["checkFlagEnabledForAllowHrd"]
       28 CALL                             R13 0 -1
...
PROTO_1:
        ...
        6 GETUPVAL                         R6 0
        7 GETTABLEKS                       R6 R6 K4 ["calculateBounds"]
        9 MOVE                             R7 R3
       10 MOVE                             R8 R2
       ...
       31 JUMP                             ; [+146]
       32 GETUPVAL                         R7 0
       33 GETTABLEKS                       R7 R7 K9 ["assetHierarchy"]
       35 GETTABLE                         R6 R7 R3
       36 GETUPVAL                         R7 0
       37 GETTABLEKS                       R7 R7 K10 ["traverseHierarchy"]
       39 LOADNIL                          R8
       40 MOVE                             R9 R2
       41 MOVE                             R10 R3
       42 LOADNIL                          R11
      ...
      150 GETTABLEKS                       R14 R0 K8 ["Size"]
      152 GETTABLEKS                       R14 R14 K18 ["X"]
      154 DIVK                             R13 R14 K21 [2]
      155 ADD                              R11 R12 R13
      156 GETTABLEKS                       R13 R9 K19 ["Y"]
      158 GETTABLEKS                       R15 R0 K8 ["Size"]
      160 GETTABLEKS                       R15 R15 K19 ["Y"]
      162 DIVK                             R14 R15 K21 [2]
      163 ADD                              R12 R13 R14
      164 GETTABLEKS                       R14 R9 K20 ["Z"]
      166 GETTABLEKS                       R16 R0 K8 ["Size"]
      168 GETTABLEKS                       R16 R16 K20 ["Z"]
...
MAIN:
       ...
       18 GETTABLEKS                       R3 R3 K7 ["AssetTraversalUtils"]
       20 CALL                             R2 1 1
       ...
       30 GETTABLEKS                       R5 R5 K9 ["R15plusUtils"]
       32 CALL                             R4 1 1
       33 GETIMPORT                        R5 K4 [require]
       35 GETTABLEKS                       R6 R0 K5 ["util"]
       37 GETTABLEKS                       R6 R6 K10 ["getAttachmentCFrameInPartSpace"]
       39 CALL                             R5 1 1
