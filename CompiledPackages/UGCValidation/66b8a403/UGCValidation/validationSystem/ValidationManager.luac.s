PROTO_0:
        ...
        4 NEWTABLE                         R4 0 0
        6 GETUPVAL                         R8 0
        7 GETTABLEKS                       R5 R8 K0 ["ValidationModule"]
        9 LOADNIL                          R6
       10 LOADNIL                          R7
       11 FORGPREP                         R5
       12 JUMPIFEQ                         R8 R9 ; [+2]
       ...
       17 GETIMPORT                        R10 K2 [assert]
       19 CALL                             R10 1 0
       20 GETUPVAL                         R11 1
       21 GETTABLEKS                       R10 R11 K3 ["getValidationModule"]
       23 MOVE                             R11 R9
       24 CALL                             R10 1 1
       25 GETTABLEKS                       R11 R10 K4 ["categories"]
       27 GETIMPORT                        R12 K7 [table.find]
       29 MOVE                             R13 R11
       30 MOVE                             R14 R0
       31 CALL                             R12 2 1
       32 JUMPIFNOT                        R12 ; [+76]
       33 GETTABLEKS                       R12 R10 K8 ["fflag"]
       35 CALL                             R12 0 1
       36 JUMPIF                           R12 ; [+4]
       37 GETTABLEKS                       R12 R10 K9 ["shadowFlag"]
       39 CALL                             R12 0 1
       40 JUMPIFNOT                        R12 ; [+68]
       41 GETTABLEKS                       R12 R10 K9 ["shadowFlag"]
       43 CALL                             R12 0 1
       44 JUMPIFNOT                        R12 ; [+4]
       45 GETTABLEKS                       R13 R10 K8 ["fflag"]
       47 CALL                             R13 0 1
       48 NOT                              R12 R13
       49 GETTABLEKS                       R13 R10 K10 ["requiredData"]
       51 LOADNIL                          R14
       52 LOADNIL                          R15
       53 FORGPREP                         R13
       54 LOADB                            R18 1
       55 SETTABLE                         R18 R4 R17
       56 FORGLOOP                         R13 2 ; [-3]
       58 GETTABLEKS                       R13 R10 K11 ["conditionalData"]
       60 LOADNIL                          R14
       61 LOADNIL                          R15
       62 FORGPREP                         R13
       63 LOADB                            R18 1
       ...
       65 FORGLOOP                         R13 2 ; [-3]
       67 GETIMPORT                        R14 K13 [next]
       69 GETTABLEKS                       R15 R10 K14 ["expectedAqsData"]
       71 CALL                             R14 1 1
       72 JUMPIFNOTEQKNIL                  R14 ; [+2]
       74 LOADB                            R13 0 +1
       75 LOADB                            R13 1
       76 JUMPIFNOT                        R13 ; [+7]
       ...
       79 MOVE                             R15 R2
       80 MOVE                             R16 R9
       81 GETIMPORT                        R14 K16 [table.insert]
       83 CALL                             R14 2 0
       84 NEWTABLE                         R14 0 0
       86 GETTABLEKS                       R15 R10 K17 ["prereqTests"]
       88 LOADNIL                          R16
       89 LOADNIL                          R17
       90 FORGPREP                         R15
       91 LOADB                            R20 1
       92 SETTABLE                         R20 R14 R19
       93 FORGLOOP                         R15 2 ; [-3]
       95 DUPTABLE                         R15 K23 [{"name", "prereqs", "postreqs", "isQuality", "isShadow"}]
       96 SETTABLEKS                       R9 R15 K18 ["name"]
       98 SETTABLEKS                       R14 R15 K19 ["prereqs"]
      100 NEWTABLE                         R16 0 0
      102 SETTABLEKS                       R16 R15 K20 ["postreqs"]
      104 SETTABLEKS                       R13 R15 K21 ["isQuality"]
      106 SETTABLEKS                       R12 R15 K22 ["isShadow"]
      108 SETTABLE                         R15 R3 R9
      109 FORGLOOP                         R5 2 ; [-98]
      111 MOVE                             R5 R3
      112 LOADNIL                          R6
      113 LOADNIL                          R7
      114 FORGPREP                         R5
      115 GETTABLEKS                       R10 R9 K19 ["prereqs"]
      117 LOADNIL                          R11
      118 LOADNIL                          R12
      119 FORGPREP                         R10
      120 GETTABLE                         R15 R3 R13
      121 JUMPIFNOTEQKNIL                  R15 ; [+10]
      123 GETIMPORT                        R15 K25 [error]
      125 GETIMPORT                        R16 K28 [string.format]
      127 LOADK                            R17 K29 ["%s is needed for %s to run, but is not an included test"]
      128 MOVE                             R18 R13
      129 MOVE                             R19 R8
      130 CALL                             R16 3 -1
      131 CALL                             R15 -1 0
      132 GETTABLE                         R17 R3 R13
      133 GETTABLEKS                       R16 R17 K20 ["postreqs"]
      135 FASTCALL2                        TABLE_INSERT R16 R8 ; [+4]
      137 MOVE                             R17 R8
      138 GETIMPORT                        R15 K16 [table.insert]
      140 CALL                             R15 2 0
      141 FORGLOOP                         R10 2 ; [-22]
      143 FORGLOOP                         R5 2 ; [-29]
      145 RETURN                           R2 3
