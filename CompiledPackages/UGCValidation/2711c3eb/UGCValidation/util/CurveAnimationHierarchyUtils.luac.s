...
PROTO_6:
        ...
        5 CALL                             R2 0 3
        6 FORGPREP                         R2
        7 JUMPIFNOTEQ                      R6 R0 ; [+13]
        9 DUPTABLE                         R9 K3 [{"ClassName", "Name"}]
       10 LOADK                            R10 K4 ["Folder"]
       11 SETTABLEKS                       R10 R9 K1 ["ClassName"]
       13 SETTABLEKS                       R5 R9 K2 ["Name"]
...
PROTO_7:
       ...
       13 RETURN                           R2 1
       14 DUPTABLE                         R5 K4 [{"ClassName", "Name"}]
       15 LOADK                            R6 K5 ["Vector3Curve"]
       16 SETTABLEKS                       R6 R5 K3 ["ClassName"]
       18 LOADK                            R6 K6 ["Position"]
       19 SETTABLEKS                       R6 R5 K1 ["Name"]
       21 FASTCALL2                        TABLE_INSERT R2 R5 ; [+4]
       23 MOVE                             R4 R2
       24 GETIMPORT                        R3 K9 [table.insert]
       26 CALL                             R3 2 0
       27 DUPTABLE                         R5 K4 [{"ClassName", "Name"}]
       28 JUMPIFNOT                        R1 ; [+2]
       29 LOADK                            R6 K10 ["EulerRotationCurve"]
       30 JUMP                             ; [+1]
       31 LOADK                            R6 K11 ["RotationCurve"]
       32 SETTABLEKS                       R6 R5 K3 ["ClassName"]
       34 LOADK                            R6 K12 ["Rotation"]
       35 SETTABLEKS                       R6 R5 K1 ["Name"]
       37 FASTCALL2                        TABLE_INSERT R2 R5 ; [+4]
       39 MOVE                             R4 R2
       40 GETIMPORT                        R3 K9 [table.insert]
       42 CALL                             R3 2 0
       43 GETTABLEKS                       R3 R0 K1 ["Name"]
       45 JUMPIFEQKS                       R3 K13 ["Head"] ; [+2]
       47 RETURN                           R2 1
       48 DUPTABLE                         R5 K4 [{"ClassName", "Name"}]
       49 LOADK                            R6 K14 ["Folder"]
       50 SETTABLEKS                       R6 R5 K3 ["ClassName"]
       52 GETUPVAL                         R6 0
       53 GETTABLEKS                       R6 R6 K15 ["FaceControlsName"]
       55 SETTABLEKS                       R6 R5 K1 ["Name"]
       57 FASTCALL2                        TABLE_INSERT R2 R5 ; [+4]
       59 MOVE                             R4 R2
       60 GETIMPORT                        R3 K9 [table.insert]
       62 CALL                             R3 2 0
       63 RETURN                           R2 1
