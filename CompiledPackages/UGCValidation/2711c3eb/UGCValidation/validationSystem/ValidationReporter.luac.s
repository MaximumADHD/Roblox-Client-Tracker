...
PROTO_6:
        ...
        2 DUPTABLE                         R3 K4 [{"__forceError", "message"}]
        3 LOADB                            R4 1
        4 SETTABLEKS                       R4 R3 K2 ["__forceError"]
        6 SETTABLEKS                       R1 R3 K3 ["message"]
        8 CALL                             R2 1 0
        9 RETURN                           R0 0

PROTO_7:
        0 GETIMPORT                        R2 K1 [error]
        2 DUPTABLE                         R3 K4 [{"__fetchError", "message"}]
        3 LOADB                            R4 1
        4 SETTABLEKS                       R4 R3 K2 ["__fetchError"]
        6 SETTABLEKS                       R1 R3 K3 ["message"]
        8 CALL                             R2 1 0
        9 RETURN                           R0 0
