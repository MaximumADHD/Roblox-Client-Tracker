PROTO_0:
        ...
        2 GETTABLEKS                       R2 R2 K1 ["Measure_Triangle_Intersection"]
        4 JUMPIFNOTEQKNIL                  R2 ; [+11]
        6 GETUPVAL                         R5 0
        7 GETTABLEKS                       R5 R5 K2 ["Keys"]
        9 GETTABLEKS                       R5 R5 K3 ["AQSWarn_MissingData"]
       11 DUPTABLE                         R6 K5 [{["measureName"] = "Measure_Triangle_Intersection"}]
       ...
       33 DUPTABLE                         R11 K5 [{["measureName"] = "Measure_Triangle_Intersection"}]
       ...
       49 GETTABLEKS                       R10 R10 K12 ["AQSWarn_TriangleIntersection"]
       51 DUPTABLE                         R11 K15 [{"partName", "intersecting_tri_face_percent", "score"}]
       52 SETTABLEKS                       R6 R11 K13 ["partName"]
       54 GETIMPORT                        R12 K18 [string.format]
       56 LOADK                            R13 K19 ["%.2f"]
       57 GETTABLEKS                       R17 R7 K14 ["intersecting_tri_face_percent"]
       ...
       65 CALL                             R12 2 1
       66 SETTABLEKS                       R12 R11 K14 ["intersecting_tri_face_percent"]
