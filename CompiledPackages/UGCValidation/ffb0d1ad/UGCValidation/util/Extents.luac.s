...
PROTO_3:
       ...
       10 LOADNIL                          R6
       11 FORGPREP                         R4
       12 GETTABLEKS                       R10 R0 K7 ["max"]
       14 GETTABLE                         R9 R10 R8
       15 GETTABLEKS                       R11 R0 K8 ["min"]
       17 GETTABLE                         R10 R11 R8
       18 JUMPIFLT                         R9 R10 ; [+35]
       20 GETTABLEKS                       R10 R1 K7 ["max"]
       22 GETTABLE                         R9 R10 R8
       23 GETTABLEKS                       R11 R1 K8 ["min"]
       25 GETTABLE                         R10 R11 R8
       26 JUMPIFLT                         R9 R10 ; [+27]
       28 GETTABLEKS                       R11 R0 K8 ["min"]
       30 GETTABLE                         R10 R11 R8
       31 GETTABLEKS                       R12 R1 K8 ["min"]
       33 GETTABLE                         R11 R12 R8
       34 FASTCALL2                        MATH_MAX R10 R11 ; [+3]
       36 GETIMPORT                        R9 K10 [math.max]
       38 CALL                             R9 2 1
       39 GETTABLEKS                       R12 R0 K7 ["max"]
       41 GETTABLE                         R11 R12 R8
       42 GETTABLEKS                       R13 R1 K7 ["max"]
       44 GETTABLE                         R12 R13 R8
       45 FASTCALL2                        MATH_MIN R11 R12 ; [+3]
       47 GETIMPORT                        R10 K11 [math.min]
       49 CALL                             R10 2 1
       50 JUMPIFNOTLE                      R9 R10 ; [+3]
       52 SETTABLE                         R9 R2 R8
       53 SETTABLE                         R10 R3 R8
       54 FORGLOOP                         R4 2 ; [-43]
       56 GETUPVAL                         R4 0
       57 GETTABLEKS                       R4 R4 K12 ["new"]
       59 CALL                             R4 0 1
       60 GETTABLEKS                       R6 R2 K0 ["X"]
       62 GETTABLEKS                       R7 R2 K2 ["Y"]
       64 GETTABLEKS                       R8 R2 K3 ["Z"]
       66 FASTCALL                         VECTOR ; [+2]
       67 GETIMPORT                        R5 K14 [Vector3.new]
       69 CALL                             R5 3 1
       70 SETTABLEKS                       R5 R4 K8 ["min"]
       72 GETTABLEKS                       R6 R3 K0 ["X"]
       74 GETTABLEKS                       R7 R3 K2 ["Y"]
       76 GETTABLEKS                       R8 R3 K3 ["Z"]
       78 FASTCALL                         VECTOR ; [+2]
       79 GETIMPORT                        R5 K14 [Vector3.new]
       81 CALL                             R5 3 1
       82 SETTABLEKS                       R5 R4 K7 ["max"]
       84 RETURN                           R4 1
