...
PROTO_3:
       ...
       26 JUMP                             ; [+19]
       27 LOADNIL                          R5
       28 LOADK                            R8 K13 ["MeshPart"]
       29 NAMECALL                         R6 R0 K14 ["IsA"]
       31 CALL                             R6 2 1
       32 JUMPIFNOT                        R6 ; [+3]
       33 GETTABLEKS                       R5 R0 K15 ["TextureContent"]
       35 JUMP                             ; [+6]
       36 GETIMPORT                        R6 K18 [Content.fromUri]
       38 GETTABLEKS                       R7 R0 K19 ["TextureId"]
       40 CALL                             R6 1 1
       41 MOVE                             R5 R6
       42 DUPTABLE                         R6 K22 [{["isPBR"] = False, ["Texture"]}]
       43 SETTABLEKS                       R5 R6 K21 ["Texture"]
       45 MOVE                             R4 R6
       46 DUPTABLE                         R5 K23 [{"isPBR"}]
       47 GETTABLEKS                       R6 R4 K2 ["isPBR"]
       49 SETTABLEKS                       R6 R5 K2 ["isPBR"]
       51 MOVE                             R6 R4
       52 LOADNIL                          R7
       53 LOADNIL                          R8
       54 FORGPREP                         R6
       55 JUMPIFEQKS                       R9 K2 ["isPBR"] ; [+33]
       57 GETTABLEKS                       R11 R10 K24 ["SourceType"]
       59 GETIMPORT                        R12 K28 [Enum.ContentSourceType.None]
       61 JUMPIFEQ                         R11 R12 ; [+27]
       63 GETUPVAL                         R11 0
       64 GETTABLEKS                       R11 R11 K29 ["getEditableInstanceInfo"]
       66 MOVE                             R12 R10
       67 MOVE                             R13 R2
       68 LOADK                            R14 K30 ["EditableImage"]
       69 MOVE                             R15 R1
       70 CALL                             R11 4 2
       71 JUMPIF                           R11 ; [+7]
       72 GETUPVAL                         R13 1
       73 GETTABLEKS                       R13 R13 K31 ["cleanup"]
       75 MOVE                             R14 R5
       76 CALL                             R13 1 0
       77 LOADB                            R13 0
       78 RETURN                           R13 1
       79 DUPTABLE                         R13 K34 [{"editable", "createdInValidation"}]
       80 GETTABLEKS                       R14 R12 K35 ["instance"]
       82 SETTABLEKS                       R14 R13 K32 ["editable"]
       84 GETTABLEKS                       R14 R12 K36 ["created"]
       86 SETTABLEKS                       R14 R13 K33 ["createdInValidation"]
       88 SETTABLE                         R13 R5 R9
       89 FORGLOOP                         R6 2 ; [-35]
       91 LOADB                            R6 1
       92 MOVE                             R7 R5
       93 RETURN                           R6 2
