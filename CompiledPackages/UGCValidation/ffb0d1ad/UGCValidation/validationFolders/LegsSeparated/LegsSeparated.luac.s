PROTO_0:
       ...
       25 JUMPIFNOTLT                      R3 R4 ; [+94]
       27 GETUPVAL                         R6 1
       28 GETTABLEKS                       R6 R6 K11 ["Keys"]
       30 GETTABLEKS                       R6 R6 K12 ["LegsSeparated_HipAttachmentOutOfRange"]
       32 DUPTABLE                         R7 K19 [{["attachmentPath"] = "RightUpperLeg.RightHipRigAttachment.CFrame.Position.X", ["currentValue"], ["comparison"] = "greater than", ["cutoff"]}]
       33 GETIMPORT                        R8 K22 [string.format]
       35 LOADK                            R9 K23 ["%.2f"]
       36 GETTABLEKS                       R10 R1 K4 ["RightUpperLeg"]
       38 GETTABLEKS                       R10 R10 K8 ["RightHipRigAttachment"]
       40 GETTABLEKS                       R10 R10 K9 ["CFrame"]
       42 GETTABLEKS                       R10 R10 K10 ["Position"]
       44 GETTABLEKS                       R10 R10 K6 ["X"]
       46 CALL                             R8 2 1
       47 SETTABLEKS                       R8 R7 K15 ["currentValue"]
       49 GETIMPORT                        R8 K22 [string.format]
       51 LOADK                            R9 K23 ["%.2f"]
       52 MOVE                             R10 R3
       53 CALL                             R8 2 1
       54 SETTABLEKS                       R8 R7 K18 ["cutoff"]
       56 NAMECALL                         R4 R0 K24 ["fail"]
       58 CALL                             R4 3 0
       59 RETURN                           R0 0
       60 GETIMPORT                        R3 K26 [Enum.AssetType.LeftLeg]
       62 JUMPIFNOTEQ                      R2 R3 ; [+57]
       64 GETTABLEKS                       R5 R1 K27 ["LeftUpperLeg"]
       66 GETTABLEKS                       R5 R5 K5 ["Size"]
       68 GETTABLEKS                       R5 R5 K6 ["X"]
       70 MINUS                            R4 R5
       71 GETUPVAL                         R5 0
       72 GETTABLEKS                       R5 R5 K7 ["asNumber"]
       74 CALL                             R5 0 1
       75 MUL                              R3 R4 R5
       76 GETTABLEKS                       R4 R1 K27 ["LeftUpperLeg"]
       78 GETTABLEKS                       R4 R4 K28 ["LeftHipRigAttachment"]
       80 GETTABLEKS                       R4 R4 K9 ["CFrame"]
       82 GETTABLEKS                       R4 R4 K10 ["Position"]
       84 GETTABLEKS                       R4 R4 K6 ["X"]
       86 JUMPIFNOTLT                      R4 R3 ; [+33]
       88 GETUPVAL                         R6 1
       89 GETTABLEKS                       R6 R6 K11 ["Keys"]
       91 GETTABLEKS                       R6 R6 K12 ["LegsSeparated_HipAttachmentOutOfRange"]
       93 DUPTABLE                         R7 K31 [{["attachmentPath"] = "LeftUpperLeg.LeftHipRigAttachment.CFrame.Position.X", ["currentValue"], ["comparison"] = "less than", ["cutoff"]}]
       94 GETIMPORT                        R8 K22 [string.format]
       96 LOADK                            R9 K23 ["%.2f"]
       97 GETTABLEKS                       R10 R1 K27 ["LeftUpperLeg"]
       99 GETTABLEKS                       R10 R10 K28 ["LeftHipRigAttachment"]
      101 GETTABLEKS                       R10 R10 K9 ["CFrame"]
      103 GETTABLEKS                       R10 R10 K10 ["Position"]
      105 GETTABLEKS                       R10 R10 K6 ["X"]
      107 CALL                             R8 2 1
      108 SETTABLEKS                       R8 R7 K15 ["currentValue"]
      110 GETIMPORT                        R8 K22 [string.format]
      112 LOADK                            R9 K23 ["%.2f"]
      113 MOVE                             R10 R3
      114 CALL                             R8 2 1
      115 SETTABLEKS                       R8 R7 K18 ["cutoff"]
      117 NAMECALL                         R4 R0 K24 ["fail"]
      119 CALL                             R4 3 0
      120 RETURN                           R0 0
...
PROTO_2:
       ...
       19 DUPTABLE                         R9 K9 [{["instance"], ["created"] = False}]
       20 GETTABLEKS                       R10 R6 K3 ["editable"]
       22 SETTABLEKS                       R10 R9 K6 ["instance"]
       24 SETTABLEKS                       R9 R8 K4 ["MeshId"]
