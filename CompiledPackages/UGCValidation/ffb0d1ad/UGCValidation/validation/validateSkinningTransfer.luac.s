...
PROTO_1:
      ...
      140 JUMPIF                           R5 ; [+31]
      141 GETUPVAL                         R7 6
      142 GETTABLEKS                       R7 R7 K32 ["SkinningTransferRequiredTypes"]
      144 GETTABLE                         R6 R7 R2
      145 JUMPIFNOT                        R6 ; [+26]
      146 GETUPVAL                         R6 3
      147 GETTABLEKS                       R6 R6 K1 ["reportFailure"]
      149 GETUPVAL                         R7 3
      150 GETTABLEKS                       R7 R7 K2 ["ErrorType"]
      152 GETTABLEKS                       R7 R7 K33 ["validateSkinningTransfer_RequiredAssetTypes"]
      154 LOADNIL                          R8
      155 MOVE                             R9 R1
      156 CALL                             R6 3 0
      157 LOADB                            R6 0
      158 NEWTABLE                         R7 0 1
      160 GETIMPORT                        R8 K6 [string.format]
      162 LOADK                            R9 K34 ["No Skinning Transfer joints found in '%s'. Accessories of type %s are required to use Skinning Transfer with RBX_Leader and RBX_Follower joints."]
      163 NAMECALL                         R10 R0 K8 ["GetFullName"]
      165 CALL                             R10 1 1
      166 GETTABLEKS                       R11 R2 K35 ["Name"]
      168 CALL                             R8 3 -1
      ...
      176 JUMPIF                           R10 ; [+25]
      177 GETUPVAL                         R11 3
      178 GETTABLEKS                       R11 R11 K1 ["reportFailure"]
      180 GETUPVAL                         R12 3
      181 GETTABLEKS                       R12 R12 K2 ["ErrorType"]
      183 GETTABLEKS                       R12 R12 K36 ["validateSkinningTransfer_Weights"]
      185 LOADNIL                          R13
      186 MOVE                             R14 R1
      187 CALL                             R11 3 0
      188 LOADB                            R11 0
      189 NEWTABLE                         R12 0 1
      191 GETIMPORT                        R13 K6 [string.format]
      193 LOADK                            R14 K37 ["Vert(s) in mesh '%s' are only partially weighted to joint %s. Vert(s) must be fully weighted to this joint."]
      194 NAMECALL                         R15 R0 K8 ["GetFullName"]
      196 CALL                             R15 1 1
      197 MOVE                             R16 R9
      198 CALL                             R13 3 -1
