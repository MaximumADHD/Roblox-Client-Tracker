...
PROTO_5:
       ...
       11 LOADNIL                          R4
       12 FORGPREP                         R2
       13 JUMPIFNOTEQ                      R6 R0 ; [+10]
       15 DUPTABLE                         R9 K4 [{["ClassName"] = "Folder", ["Name"]}]
       16 SETTABLEKS                       R5 R9 K3 ["Name"]
...
PROTO_6:
        ...
        8 RETURN                           R2 1
        9 DUPTABLE                         R5 K5 [{["ClassName"] = "Vector3Curve", [2] = "Position"}]
       10 FASTCALL2                        TABLE_INSERT R2 R5 ; [+4]
       12 MOVE                             R4 R2
       13 GETIMPORT                        R3 K8 [table.insert]
       15 CALL                             R3 2 0
       16 DUPTABLE                         R5 K10 [{["ClassName"], [2] = "Rotation"}]
       17 JUMPIFNOT                        R1 ; [+2]
       18 LOADK                            R6 K11 ["EulerRotationCurve"]
       19 JUMP                             ; [+1]
       20 LOADK                            R6 K12 ["RotationCurve"]
       21 SETTABLEKS                       R6 R5 K2 ["ClassName"]
       23 FASTCALL2                        TABLE_INSERT R2 R5 ; [+4]
       25 MOVE                             R4 R2
       26 GETIMPORT                        R3 K8 [table.insert]
       28 CALL                             R3 2 0
       29 GETTABLEKS                       R3 R0 K0 ["Name"]
       31 JUMPIFEQKS                       R3 K13 ["Head"] ; [+2]
       33 RETURN                           R2 1
       34 DUPTABLE                         R5 K16 [{["ClassName"] = "Folder", [2] = "FaceControls"}]
       35 FASTCALL2                        TABLE_INSERT R2 R5 ; [+4]
       37 MOVE                             R4 R2
       38 GETIMPORT                        R3 K8 [table.insert]
       40 CALL                             R3 2 0
       41 RETURN                           R2 1
...
PROTO_51:
       ...
       41 MOVE                             R9 R1
       42 CALL                             R7 2 -1
       43 NAMECALL                         R5 R4 K4 ["updateReasons"]
       45 CALL                             R5 -1 0
       46 GETUPVAL                         R7 0
       47 GETTABLEKS                       R7 R7 K5 ["validateAllowedTags"]
       49 MOVE                             R8 R0
       50 MOVE                             R9 R1
       51 CALL                             R7 2 -1
       52 NAMECALL                         R5 R4 K4 ["updateReasons"]
       54 CALL                             R5 -1 0
       55 GETUPVAL                         R7 0
       56 GETTABLEKS                       R7 R7 K6 ["validateFrames"]
       58 MOVE                             R8 R0
       59 MOVE                             R9 R1
       60 CALL                             R7 2 -1
       61 NAMECALL                         R5 R4 K4 ["updateReasons"]
       63 CALL                             R5 -1 0
       64 NAMECALL                         R5 R4 K7 ["getFinalResults"]
       66 CALL                             R5 1 -1
       67 RETURN                           R5 -1
...
MAIN:
      ...
      194 GETTABLEKS                       R40 R13 K46 ["getFFlagUGCValidateMigrateSchemaProperties"]
      196 CALL                             R39 1 1
      197 GETIMPORT                        R40 K9 [require]
      199 GETTABLEKS                       R41 R13 K47 ["getFFlagUGCValidationCombineEntrypointResults"]
      201 CALL                             R40 1 1
      ...
      392 DUPCLOSURE                       R68 K99 [PROTO_46]
      393 CAPTURE                          VAL R60
      394 CAPTURE                          VAL R23
      395 CAPTURE                          VAL R14
      396 CAPTURE                          VAL R37
      ...
      401 CAPTURE                          VAL R21
      402 CAPTURE                          VAL R20
      403 SETTABLEKS                       R68 R41 K100 ["validateData"]
      405 DUPCLOSURE                       R68 K101 [PROTO_47]
      406 CAPTURE                          VAL R67
      407 CAPTURE                          VAL R42
      408 CAPTURE                          VAL R3
      409 SETTABLEKS                       R68 R41 K102 ["validateCalculatedData"]
      411 DUPCLOSURE                       R68 K103 [PROTO_48]
      412 CAPTURE                          VAL R65
      413 SETTABLEKS                       R68 R41 K104 ["calculateAnimFramesAtOrigin"]
      415 DUPCLOSURE                       R68 K105 [PROTO_49]
      416 CAPTURE                          VAL R4
      417 CAPTURE                          VAL R22
      418 CAPTURE                          VAL R42
      419 CAPTURE                          VAL R3
      420 SETTABLEKS                       R68 R41 K106 ["validatePositionMagnitudes"]
      422 DUPCLOSURE                       R68 K107 [PROTO_50]
      423 CAPTURE                          VAL R41
      424 CAPTURE                          VAL R7
      425 CAPTURE                          VAL R27
      426 SETTABLEKS                       R68 R41 K108 ["validateFrames"]
      428 DUPCLOSURE                       R68 K109 [PROTO_51]
      429 CAPTURE                          VAL R41
      430 CAPTURE                          VAL R24
      431 CAPTURE                          VAL R12
      432 CAPTURE                          VAL R7
