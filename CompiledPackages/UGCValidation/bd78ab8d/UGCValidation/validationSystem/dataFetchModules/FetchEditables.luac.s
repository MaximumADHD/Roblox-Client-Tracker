...
PROTO_3:
       ...
       69 GETUPVAL                         R12 0
       70 GETTABLEKS                       R11 R12 K27 ["getEditableInstanceInfo"]
       72 MOVE                             R12 R10
       73 MOVE                             R13 R2
       ...
       77 JUMPIF                           R11 ; [+7]
       78 GETUPVAL                         R14 1
       79 GETTABLEKS                       R13 R14 K29 ["cleanup"]
       81 MOVE                             R14 R5
       82 CALL                             R13 1 0
       83 LOADB                            R13 0
       84 RETURN                           R13 1
...
PROTO_6:
       ...
       15 CALL                             R3 2 1
       16 GETUPVAL                         R5 0
       17 GETTABLEKS                       R4 R5 K6 ["renderMeshesData"]
       19 JUMPIFNOTEQ                      R1 R4 ; [+4]
       21 LOADB                            R4 1
       22 MOVE                             R5 R2
       23 RETURN                           R4 2
       24 GETUPVAL                         R5 0
       25 GETTABLEKS                       R4 R5 K7 ["meshTextures"]
       ...
       53 GETTABLEKS                       R8 R2 K12 ["TextureContent"]
       55 GETTABLEKS                       R7 R8 K13 ["SourceType"]
       ...
       75 JUMPIFNOT                        R3 ; [+13]
       76 GETTABLEKS                       R6 R3 K19 ["CageMeshContent"]
       78 GETTABLEKS                       R5 R6 K13 ["SourceType"]
       ...
       88 RETURN                           R5 2
       89 GETUPVAL                         R5 0
       90 GETTABLEKS                       R4 R5 K20 ["innerCagesData"]
       92 JUMPIFNOTEQ                      R1 R4 ; [+19]
       94 JUMPIFNOT                        R3 ; [+17]
       95 GETTABLEKS                       R4 R3 K9 ["ClassName"]
       97 JUMPIFNOTEQKS                    R4 K21 ["WrapLayer"] ; [+14]
       99 GETTABLEKS                       R6 R3 K22 ["ReferenceMeshContent"]
      101 GETTABLEKS                       R5 R6 K13 ["SourceType"]
...
PROTO_7:
       ...
       36 LOADNIL                          R15
       37 GETUPVAL                         R17 3
       38 GETTABLEKS                       R16 R17 K4 ["renderMeshesData"]
       ...
       49 JUMP                             ; [+49]
       50 GETUPVAL                         R17 3
       51 GETTABLEKS                       R16 R17 K5 ["innerCagesData"]
       53 JUMPIFEQ                         R1 R16 ; [+6]
       55 GETUPVAL                         R17 3
       56 GETTABLEKS                       R16 R17 K6 ["outerCagesData"]
       58 JUMPIFNOTEQ                      R1 R16 ; [+17]
       60 GETUPVAL                         R18 3
       61 GETTABLEKS                       R17 R18 K6 ["outerCagesData"]
       ...
       75 JUMP                             ; [+23]
       76 GETUPVAL                         R17 3
       77 GETTABLEKS                       R16 R17 K7 ["meshTextures"]
      ...
      102 GETUPVAL                         R17 8
      103 GETTABLEKS                       R16 R17 K8 ["cleanup"]
      105 MOVE                             R17 R5
      106 CALL                             R16 1 0
      107 RETURN                           R0 0
...
MAIN:
       ...
       41 GETTABLEKS                       R8 R0 K12 ["flags"]
       43 GETTABLEKS                       R7 R8 K13 ["getFFlagUGCValidationAddPBRToSharedData"]
       45 CALL                             R6 1 1
       46 NEWTABLE                         R7 2 0
