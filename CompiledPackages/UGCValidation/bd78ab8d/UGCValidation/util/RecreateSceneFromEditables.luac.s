...
PROTO_1:
       ...
       21 GETTABLEKS                       R6 R2 K6 ["Texture"]
       23 GETTABLEKS                       R5 R6 K3 ["editable"]
       25 CALL                             R4 1 1
       ...
       42 GETTABLEKS                       R7 R2 K12 ["ColorMap"]
       44 GETTABLEKS                       R6 R7 K3 ["editable"]
       46 CALL                             R5 1 1
       47 SETTABLEKS                       R5 R4 K13 ["ColorMapContent"]
       49 GETTABLEKS                       R5 R2 K14 ["MetalnessMap"]
       51 JUMPIFNOT                        R5 ; [+9]
       52 GETIMPORT                        R5 K2 [Content.fromObject]
       54 GETTABLEKS                       R7 R2 K14 ["MetalnessMap"]
       56 GETTABLEKS                       R6 R7 K3 ["editable"]
       58 CALL                             R5 1 1
       59 SETTABLEKS                       R5 R4 K15 ["MetalnessMapContent"]
       61 GETTABLEKS                       R5 R2 K16 ["NormalMap"]
       63 JUMPIFNOT                        R5 ; [+9]
       64 GETIMPORT                        R5 K2 [Content.fromObject]
       66 GETTABLEKS                       R7 R2 K16 ["NormalMap"]
       68 GETTABLEKS                       R6 R7 K3 ["editable"]
       70 CALL                             R5 1 1
       71 SETTABLEKS                       R5 R4 K17 ["NormalMapContent"]
       73 GETTABLEKS                       R5 R2 K18 ["RoughnessMap"]
       75 JUMPIFNOT                        R5 ; [+9]
       76 GETIMPORT                        R5 K2 [Content.fromObject]
       78 GETTABLEKS                       R7 R2 K18 ["RoughnessMap"]
       80 GETTABLEKS                       R6 R7 K3 ["editable"]
       82 CALL                             R5 1 1
       83 SETTABLEKS                       R5 R4 K19 ["RoughnessMapContent"]
       85 SETTABLEKS                       R3 R4 K20 ["Parent"]
       87 JUMP                             ; [+8]
       88 JUMPIFNOT                        R2 ; [+7]
       89 GETIMPORT                        R4 K2 [Content.fromObject]
       91 GETTABLEKS                       R5 R2 K3 ["editable"]
       93 CALL                             R4 1 1
       94 SETTABLEKS                       R4 R3 K7 ["TextureContent"]
       96 GETTABLEKS                       R4 R0 K21 ["Name"]
       98 SETTABLEKS                       R4 R3 K21 ["Name"]
      100 GETTABLEKS                       R4 R0 K22 ["Size"]
      102 SETTABLEKS                       R4 R3 K22 ["Size"]
      104 GETTABLEKS                       R4 R0 K23 ["CFrame"]
      106 SETTABLEKS                       R4 R3 K23 ["CFrame"]
      108 NAMECALL                         R4 R0 K24 ["GetChildren"]
      110 CALL                             R4 1 3
      111 FORGPREP                         R4
      112 LOADK                            R11 K25 ["Attachment"]
      113 NAMECALL                         R9 R8 K26 ["IsA"]
      115 CALL                             R9 2 1
      116 JUMPIF                           R9 ; [+5]
      117 LOADK                            R11 K27 ["FaceControls"]
      118 NAMECALL                         R9 R8 K26 ["IsA"]
      120 CALL                             R9 2 1
      121 JUMPIFNOT                        R9 ; [+15]
      122 GETUPVAL                         R10 2
      123 GETTABLEKS                       R9 R10 K28 ["checkFlagEnabledForAllowHrd"]
      125 CALL                             R9 0 1
      126 JUMPIFNOT                        R9 ; [+5]
      127 LOADK                            R11 K29 ["Bone"]
      128 NAMECALL                         R9 R8 K26 ["IsA"]
      130 CALL                             R9 2 1
      131 JUMPIF                           R9 ; [+5]
      132 NAMECALL                         R9 R8 K30 ["Clone"]
      134 CALL                             R9 1 1
      135 SETTABLEKS                       R3 R9 K20 ["Parent"]
      137 FORGLOOP                         R4 2 ; [-26]
      139 GETUPVAL                         R5 2
      140 GETTABLEKS                       R4 R5 K28 ["checkFlagEnabledForAllowHrd"]
      142 CALL                             R4 0 1
      143 JUMPIFNOT                        R4 ; [+48]
      144 GETUPVAL                         R5 2
      145 GETTABLEKS                       R4 R5 K31 ["getAvatarBoneSchema"]
      147 GETTABLEKS                       R5 R0 K21 ["Name"]
      149 CALL                             R4 1 1
      150 GETUPVAL                         R6 2
      151 GETTABLEKS                       R5 R6 K32 ["getNameWhitelistOfClassInSchema"]
      153 MOVE                             R6 R4
      154 LOADK                            R7 K25 ["Attachment"]
      155 CALL                             R5 2 1
      156 MOVE                             R6 R5
      157 LOADNIL                          R7
      158 LOADNIL                          R8
      159 FORGPREP                         R6
      160 JUMPIFNOT                        R10 ; [+29]
      161 MOVE                             R13 R9
      162 NAMECALL                         R11 R3 K33 ["FindFirstChild"]
      164 CALL                             R11 2 1
      165 JUMPIFNOTEQKNIL                  R11 ; [+24]
      167 MOVE                             R13 R9
      168 LOADB                            R14 1
      169 NAMECALL                         R11 R0 K33 ["FindFirstChild"]
      171 CALL                             R11 3 1
      172 LOADNIL                          R12
      173 JUMPIFEQKNIL                     R11 ; [+4]
      175 GETTABLEKS                       R12 R11 K34 ["WorldCFrame"]
      177 JUMP                             ; [+2]
      178 GETTABLEKS                       R12 R3 K23 ["CFrame"]
      180 GETIMPORT                        R13 K10 [Instance.new]
      182 LOADK                            R14 K25 ["Attachment"]
      183 CALL                             R13 1 1
      184 SETTABLEKS                       R9 R13 K21 ["Name"]
      186 SETTABLEKS                       R3 R13 K20 ["Parent"]
      188 SETTABLEKS                       R12 R13 K34 ["WorldCFrame"]
      190 FORGLOOP                         R6 2 ; [-31]
      192 RETURN                           R3 1
...
PROTO_2:
       ...
       75 GETUPVAL                         R17 3
       76 GETTABLEKS                       R16 R17 K23 ["UploadCategory"]
       78 GETTABLEKS                       R15 R16 K24 ["FULL_BODY"]
...
MAIN:
       ...
       22 GETTABLEKS                       R5 R0 K11 ["flags"]
       24 GETTABLEKS                       R4 R5 K12 ["getFFlagUGCValidationAddPBRToSharedData"]
       26 CALL                             R3 1 1
       27 GETIMPORT                        R4 K4 [require]
       29 GETTABLEKS                       R6 R0 K13 ["validationSystem"]
       31 GETTABLEKS                       R5 R6 K14 ["ValidationEnums"]
       33 CALL                             R4 1 1
       34 GETIMPORT                        R5 K4 [require]
       36 GETTABLEKS                       R7 R0 K5 ["util"]
       38 GETTABLEKS                       R6 R7 K15 ["R15plusUtils"]
       40 CALL                             R5 1 1
       41 GETIMPORT                        R6 K4 [require]
       43 GETTABLEKS                       R8 R0 K11 ["flags"]
       45 GETTABLEKS                       R7 R8 K16 ["getFFlagUGCValidationAddGeometryToExports"]
       47 CALL                             R6 1 1
       48 NEWTABLE                         R7 1 0
       ...
       54 CAPTURE                          VAL R3
       55 CAPTURE                          VAL R5
       56 DUPCLOSURE                       R10 K19 [PROTO_2]
       57 CAPTURE                          VAL R9
       58 CAPTURE                          VAL R8
       59 CAPTURE                          VAL R6
       60 CAPTURE                          VAL R4
       61 SETTABLEKS                       R10 R7 K20 ["createModelForGltfExport"]
       63 RETURN                           R7 1
