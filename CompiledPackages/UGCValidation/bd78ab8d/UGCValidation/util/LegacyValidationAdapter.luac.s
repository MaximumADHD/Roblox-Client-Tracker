...
PROTO_1:
        ...
        9 GETTABLE                         R1 R2 R3
       10 GETUPVAL                         R3 4
       11 GETTABLEKS                       R2 R3 K1 ["instance"]
...
PROTO_5:
       ...
       47 GETUPVAL                         R13 1
       48 GETTABLEKS                       R12 R13 K9 ["Keys"]
       50 GETTABLEKS                       R11 R12 K10 ["FailureWithoutReason"]
...
PROTO_6:
        ...
        3 JUMPIFNOT                        R6 ; [+5]
        4 GETTABLEKS                       R6 R0 K1 ["bypassFlags"]
        6 GETTABLEKS                       R5 R6 K2 ["enforceShadowValidations"]
        8 JUMPIF                           R5 ; [+1]
        9 LOADB                            R5 0
       10 GETTABLEKS                       R6 R0 K1 ["bypassFlags"]
       12 JUMPIFNOT                        R6 ; [+9]
       13 GETTABLEKS                       R7 R0 K1 ["bypassFlags"]
       15 GETTABLEKS                       R6 R7 K3 ["studioPluginName"]
       17 JUMPIFNOT                        R6 ; [+4]
       18 GETTABLEKS                       R6 R0 K1 ["bypassFlags"]
       20 GETTABLEKS                       R4 R6 K3 ["studioPluginName"]
       22 GETUPVAL                         R7 0
       23 GETTABLEKS                       R6 R7 K4 ["getPrecomputedEditables"]
       ...
       35 CALL                             R6 2 2
       36 GETUPVAL                         R9 1
       37 GETTABLEKS                       R8 R9 K7 ["ValidateAsset"]
       ...
       62 JUMPIFNOT                        R9 ; [+18]
       63 GETUPVAL                         R10 0
       64 GETTABLEKS                       R9 R10 K18 ["combineResultsIntoLegacy"]
       66 MOVE                             R10 R2
       67 MOVE                             R11 R3
       68 MOVE                             R12 R8
       69 GETTABLEKS                       R14 R0 K1 ["bypassFlags"]
       71 JUMPIFEQKNIL                     R14 ; [+6]
       73 GETTABLEKS                       R14 R0 K1 ["bypassFlags"]
       75 GETTABLEKS                       R13 R14 K19 ["localizationCallback"]
       77 JUMP                             ; [+1]
       78 LOADNIL                          R13
       79 CALL                             R9 4 -1
       80 RETURN                           R9 -1
...
PROTO_7:
        ...
        3 JUMPIFNOT                        R7 ; [+9]
        4 GETTABLEKS                       R8 R2 K1 ["bypassFlags"]
        6 GETTABLEKS                       R7 R8 K2 ["studioPluginName"]
        8 JUMPIFNOT                        R7 ; [+4]
        9 GETTABLEKS                       R7 R2 K1 ["bypassFlags"]
       11 GETTABLEKS                       R6 R7 K2 ["studioPluginName"]
       13 GETTABLEKS                       R8 R2 K1 ["bypassFlags"]
       15 JUMPIFNOT                        R8 ; [+5]
       16 GETTABLEKS                       R8 R2 K1 ["bypassFlags"]
       18 GETTABLEKS                       R7 R8 K3 ["enforceShadowValidations"]
       20 JUMPIF                           R7 ; [+1]
       21 LOADB                            R7 0
       22 GETUPVAL                         R9 0
       23 GETTABLEKS                       R8 R9 K4 ["getPrecomputedEditables"]
       ...
       35 CALL                             R8 2 2
       36 GETUPVAL                         R11 1
       37 GETTABLEKS                       R10 R11 K7 ["ValidateFinalizedBundle"]
       39 MOVE                             R11 R0
       40 MOVE                             R12 R1
       ...
       66 CALL                             R11 1 0
       67 GETTABLEKS                       R13 R2 K1 ["bypassFlags"]
       69 GETTABLEKS                       R12 R13 K18 ["localizationCallback"]
       71 FASTCALL1                        ASSERT R12 ; [+2]
       72 GETIMPORT                        R11 K17 [assert]
       74 CALL                             R11 1 0
       75 GETUPVAL                         R12 0
       76 GETTABLEKS                       R11 R12 K19 ["combineResultsIntoLegacy"]
       78 MOVE                             R12 R4
       79 MOVE                             R13 R5
       80 MOVE                             R14 R10
       81 GETTABLEKS                       R16 R2 K1 ["bypassFlags"]
       83 JUMPIFEQKNIL                     R16 ; [+6]
       85 GETTABLEKS                       R16 R2 K1 ["bypassFlags"]
       87 GETTABLEKS                       R15 R16 K18 ["localizationCallback"]
       89 JUMP                             ; [+1]
       90 LOADNIL                          R15
       91 CALL                             R11 4 -1
       92 RETURN                           R11 -1
...
MAIN:
       ...
       18 GETTABLEKS                       R3 R4 K8 ["ValidationManager"]
       20 CALL                             R2 1 1
       21 GETIMPORT                        R3 K4 [require]
       23 GETTABLEKS                       R5 R0 K9 ["flags"]
       25 GETTABLEKS                       R4 R5 K10 ["getFFlagUGCValidationCombineEntrypointResults"]
       27 CALL                             R3 1 1
       28 GETIMPORT                        R4 K4 [require]
       30 GETTABLEKS                       R6 R0 K7 ["validationSystem"]
       32 GETTABLEKS                       R5 R6 K11 ["ErrorSourceStrings"]
       34 CALL                             R4 1 1
       35 NEWTABLE                         R5 4 0
