...
PROTO_6:
      ...
      106 JUMPIFNOTEQKS                    R16 K28 ["MeshPart"] ; [+153]
      ...
      243 JUMPIFNOT                        R20 ; [+8]
      244 GETUPVAL                         R22 17
      245 GETTABLEKS                       R23 R12 K19 ["instance"]
      247 MOVE                             R24 R1
      248 CALL                             R22 2 -1
      249 NAMECALL                         R20 R5 K11 ["updateReasons"]
      251 CALL                             R20 -1 0
      252 GETUPVAL                         R22 18
      253 MOVE                             R23 R13
      254 MOVE                             R24 R1
      255 CALL                             R22 2 -1
      256 NAMECALL                         R20 R5 K11 ["updateReasons"]
      258 CALL                             R20 -1 0
      259 JUMP                             ; [+54]
      260 GETTABLEKS                       R17 R12 K19 ["instance"]
      262 GETTABLEKS                       R16 R17 K27 ["ClassName"]
      264 JUMPIFNOTEQKS                    R16 K37 ["WrapTarget"] ; [+49]
      266 GETTABLEKS                       R18 R12 K15 ["fieldName"]
      268 JUMPIFEQKS                       R18 K38 ["CageMeshId"] ; [+2]
      270 LOADB                            R17 0 +1
      271 LOADB                            R17 1
      272 FASTCALL1                        ASSERT R17 ; [+2]
      273 GETIMPORT                        R16 K4 [assert]
      275 CALL                             R16 1 0
      276 GETTABLEKS                       R17 R13 K14 ["fullName"]
      278 LOADK                            R18 K39 ["OuterCage"]
      279 CONCAT                           R16 R17 R18
      280 SETTABLEKS                       R16 R13 K14 ["fullName"]
      282 GETUPVAL                         R18 19
      283 MOVE                             R19 R13
      284 GETTABLEKS                       R20 R12 K19 ["instance"]
      286 MOVE                             R21 R1
      287 CALL                             R18 3 -1
      288 NAMECALL                         R16 R5 K11 ["updateReasons"]
      290 CALL                             R16 -1 0
      291 GETUPVAL                         R18 20
      292 MOVE                             R19 R13
      293 MOVE                             R20 R1
      294 CALL                             R18 2 -1
      295 NAMECALL                         R16 R5 K11 ["updateReasons"]
      297 CALL                             R16 -1 0
      298 GETUPVAL                         R18 21
      299 MOVE                             R19 R13
      300 GETTABLEKS                       R20 R12 K19 ["instance"]
      302 MOVE                             R21 R1
      303 CALL                             R18 3 -1
      304 NAMECALL                         R16 R5 K11 ["updateReasons"]
      306 CALL                             R16 -1 0
      307 GETUPVAL                         R18 18
      308 MOVE                             R19 R13
      309 MOVE                             R20 R1
      310 CALL                             R18 2 -1
      311 NAMECALL                         R16 R5 K11 ["updateReasons"]
      313 CALL                             R16 -1 0
      314 FORGLOOP                         R8 2 ; [-262]
      316 NAMECALL                         R8 R5 K40 ["getFinalResults"]
      318 CALL                             R8 1 -1
      319 RETURN                           R8 -1
...
MAIN:
      ...
      158 GETTABLEKS                       R25 R1 K29 ["flags"]
      160 GETTABLEKS                       R24 R25 K33 ["getEngineFeatureEngineUGCValidationConsolidateAccessorySkinning"]
      162 CALL                             R23 1 1
      163 DUPCLOSURE                       R24 K34 [PROTO_1]
      164 CAPTURE                          VAL R3
      165 CAPTURE                          VAL R2
      166 CAPTURE                          VAL R17
      167 CAPTURE                          VAL R0
      168 DUPCLOSURE                       R25 K35 [PROTO_4]
      169 CAPTURE                          VAL R3
      170 CAPTURE                          VAL R17
      171 CAPTURE                          VAL R2
      172 CAPTURE                          VAL R5
      173 CAPTURE                          VAL R0
      174 CAPTURE                          VAL R21
      175 DUPCLOSURE                       R26 K36 [PROTO_5]
      176 CAPTURE                          VAL R2
      177 DUPCLOSURE                       R27 K37 [PROTO_6]
      178 CAPTURE                          VAL R14
      179 CAPTURE                          VAL R15
      180 CAPTURE                          VAL R3
      181 CAPTURE                          VAL R25
