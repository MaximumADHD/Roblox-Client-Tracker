PROTO_0:
       ...
       60 MOVE                             R12 R0
       61 CALL                             R9 3 -1
       62 NAMECALL                         R7 R6 K3 ["updateReasons"]
       64 CALL                             R7 -1 0
       65 GETUPVAL                         R9 8
       66 MOVE                             R10 R4
       67 MOVE                             R11 R0
       68 CALL                             R9 2 -1
       69 NAMECALL                         R7 R6 K3 ["updateReasons"]
       71 CALL                             R7 -1 0
       72 GETUPVAL                         R9 9
       73 MOVE                             R10 R4
       74 MOVE                             R11 R0
       75 CALL                             R9 2 -1
       76 NAMECALL                         R7 R6 K3 ["updateReasons"]
       78 CALL                             R7 -1 0
       79 GETUPVAL                         R9 10
       80 MOVE                             R10 R4
       81 NEWTABLE                         R11 0 0
       83 MOVE                             R12 R0
       84 CALL                             R9 3 -1
       85 NAMECALL                         R7 R6 K3 ["updateReasons"]
       87 CALL                             R7 -1 0
       88 GETUPVAL                         R9 11
       89 MOVE                             R10 R4
       90 MOVE                             R11 R0
       91 CALL                             R9 2 -1
       92 NAMECALL                         R7 R6 K3 ["updateReasons"]
       94 CALL                             R7 -1 0
       95 GETUPVAL                         R9 12
       96 MOVE                             R10 R4
       97 MOVE                             R11 R0
       98 CALL                             R9 2 -1
       99 NAMECALL                         R7 R6 K3 ["updateReasons"]
      101 CALL                             R7 -1 0
      102 NAMECALL                         R7 R6 K4 ["getFinalResults"]
      104 CALL                             R7 1 -1
      105 RETURN                           R7 -1
...
MAIN:
      ...
      102 GETTABLEKS                       R15 R16 K21 ["getEngineFeatureEngineUGCValidatePropertiesSensible"]
      104 CALL                             R14 1 1
