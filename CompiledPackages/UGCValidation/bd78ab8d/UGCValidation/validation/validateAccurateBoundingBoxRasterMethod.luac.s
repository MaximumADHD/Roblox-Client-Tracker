...
PROTO_2:
       ...
       20 DIVRK                            R9 R3 K10 [0.01]
       21 GETUPVAL                         R11 0
       22 GETTABLEKS                       R10 R11 K6 ["new"]
       24 MOVE                             R11 R0
       25 CALL                             R10 1 1
       26 MOVE                             R11 R1
       27 MOVE                             R12 R0
...
PROTO_9:
       ...
       20 LOADK                            R5 K6 [{1, 0, 0}]
       21 GETTABLEKS                       R7 R1 K7 ["XVector"]
       23 NAMECALL                         R7 R7 K8 ["Abs"]
       25 CALL                             R7 1 -1
       26 NAMECALL                         R5 R5 K9 ["FuzzyEq"]
       28 CALL                             R5 -1 1
       29 JUMPIFNOT                        R5 ; [+2]
       30 LOADB                            R4 1
       31 JUMP                             ; [+13]
       32 LOADK                            R5 K6 [{1, 0, 0}]
       33 GETTABLEKS                       R7 R1 K10 ["YVector"]
       35 NAMECALL                         R7 R7 K8 ["Abs"]
       37 CALL                             R7 1 -1
       38 NAMECALL                         R5 R5 K9 ["FuzzyEq"]
       40 CALL                             R5 -1 1
       41 JUMPIFNOT                        R5 ; [+2]
       42 LOADB                            R4 1
       43 JUMP                             ; [+1]
       44 LOADB                            R4 0
       45 JUMPIFNOT                        R4 ; [+22]
       46 GETTABLEKS                       R5 R2 K0 ["X"]
       48 GETTABLEKS                       R6 R0 K0 ["X"]
       50 FASTCALL2                        MATH_MAX R5 R6 ; [+3]
       52 GETIMPORT                        R4 K13 [math.max]
       54 CALL                             R4 2 1
       55 SETTABLEKS                       R4 R2 K0 ["X"]
       57 GETTABLEKS                       R5 R3 K0 ["X"]
       59 GETTABLEKS                       R6 R0 K0 ["X"]
       61 FASTCALL2                        MATH_MIN R5 R6 ; [+3]
       63 GETIMPORT                        R4 K15 [math.min]
       65 CALL                             R4 2 1
       66 SETTABLEKS                       R4 R3 K0 ["X"]
       68 LOADK                            R5 K16 [{0, 1, 0}]
       69 GETTABLEKS                       R7 R1 K7 ["XVector"]
       71 NAMECALL                         R7 R7 K8 ["Abs"]
       73 CALL                             R7 1 -1
       74 NAMECALL                         R5 R5 K9 ["FuzzyEq"]
       76 CALL                             R5 -1 1
       77 JUMPIFNOT                        R5 ; [+2]
       78 LOADB                            R4 1
       79 JUMP                             ; [+13]
       80 LOADK                            R5 K16 [{0, 1, 0}]
       81 GETTABLEKS                       R7 R1 K10 ["YVector"]
       83 NAMECALL                         R7 R7 K8 ["Abs"]
       85 CALL                             R7 1 -1
       86 NAMECALL                         R5 R5 K9 ["FuzzyEq"]
       88 CALL                             R5 -1 1
       89 JUMPIFNOT                        R5 ; [+2]
       90 LOADB                            R4 1
       91 JUMP                             ; [+1]
       92 LOADB                            R4 0
       93 JUMPIFNOT                        R4 ; [+22]
       94 GETTABLEKS                       R5 R2 K1 ["Y"]
       96 GETTABLEKS                       R6 R0 K1 ["Y"]
       98 FASTCALL2                        MATH_MAX R5 R6 ; [+3]
      100 GETIMPORT                        R4 K13 [math.max]
      102 CALL                             R4 2 1
      103 SETTABLEKS                       R4 R2 K1 ["Y"]
      105 GETTABLEKS                       R5 R3 K1 ["Y"]
      107 GETTABLEKS                       R6 R0 K1 ["Y"]
      109 FASTCALL2                        MATH_MIN R5 R6 ; [+3]
      111 GETIMPORT                        R4 K15 [math.min]
      113 CALL                             R4 2 1
      114 SETTABLEKS                       R4 R3 K1 ["Y"]
      116 LOADK                            R5 K17 [{0, 0, 1}]
      117 GETTABLEKS                       R7 R1 K7 ["XVector"]
      119 NAMECALL                         R7 R7 K8 ["Abs"]
      121 CALL                             R7 1 -1
      122 NAMECALL                         R5 R5 K9 ["FuzzyEq"]
      124 CALL                             R5 -1 1
      125 JUMPIFNOT                        R5 ; [+2]
      126 LOADB                            R4 1
      127 JUMP                             ; [+13]
      128 LOADK                            R5 K17 [{0, 0, 1}]
      129 GETTABLEKS                       R7 R1 K10 ["YVector"]
      131 NAMECALL                         R7 R7 K8 ["Abs"]
      133 CALL                             R7 1 -1
      134 NAMECALL                         R5 R5 K9 ["FuzzyEq"]
      136 CALL                             R5 -1 1
      137 JUMPIFNOT                        R5 ; [+2]
      138 LOADB                            R4 1
      139 JUMP                             ; [+1]
      140 LOADB                            R4 0
      141 JUMPIFNOT                        R4 ; [+22]
      142 GETTABLEKS                       R5 R2 K2 ["Z"]
      144 GETTABLEKS                       R6 R0 K2 ["Z"]
      146 FASTCALL2                        MATH_MAX R5 R6 ; [+3]
      148 GETIMPORT                        R4 K13 [math.max]
      150 CALL                             R4 2 1
      151 SETTABLEKS                       R4 R2 K2 ["Z"]
      153 GETTABLEKS                       R5 R3 K2 ["Z"]
      155 GETTABLEKS                       R6 R0 K2 ["Z"]
      157 FASTCALL2                        MATH_MIN R5 R6 ; [+3]
      159 GETIMPORT                        R4 K15 [math.min]
      161 CALL                             R4 2 1
      162 SETTABLEKS                       R4 R3 K2 ["Z"]
      164 GETUPVAL                         R5 0
      165 GETTABLEKS                       R4 R5 K18 ["fromMinMax"]
      167 GETTABLEKS                       R6 R3 K0 ["X"]
      169 GETTABLEKS                       R7 R3 K1 ["Y"]
      171 GETTABLEKS                       R8 R3 K2 ["Z"]
      173 FASTCALL                         VECTOR ; [+2]
      174 GETIMPORT                        R5 K21 [Vector3.new]
      176 CALL                             R5 3 1
      177 GETTABLEKS                       R7 R2 K0 ["X"]
      179 GETTABLEKS                       R8 R2 K1 ["Y"]
      181 GETTABLEKS                       R9 R2 K2 ["Z"]
      183 FASTCALL                         VECTOR ; [+2]
      184 GETIMPORT                        R6 K21 [Vector3.new]
      186 CALL                             R6 3 1
      187 CALL                             R4 2 -1
      188 RETURN                           R4 -1
...
MAIN:
      ...
      100 GETTABLEKS                       R15 R16 K20 ["getFFlagUGCValidateTinyTrianglesIntersectFix"]
      102 CALL                             R14 1 1
      103 DUPCLOSURE                       R15 K21 [PROTO_0]
      104 DUPCLOSURE                       R16 K22 [PROTO_2]
      105 CAPTURE                          VAL R10
      106 DUPCLOSURE                       R17 K23 [PROTO_3]
      107 CAPTURE                          VAL R10
      108 DUPCLOSURE                       R18 K24 [PROTO_7]
      109 CAPTURE                          VAL R10
      110 CAPTURE                          VAL R17
      111 CAPTURE                          VAL R4
      112 CAPTURE                          VAL R13
      ...
      114 CAPTURE                          VAL R12
      115 CAPTURE                          VAL R16
      116 DUPCLOSURE                       R19 K25 [PROTO_8]
      117 DUPCLOSURE                       R20 K26 [PROTO_9]
      118 CAPTURE                          VAL R11
      119 DUPCLOSURE                       R21 K27 [PROTO_10]
      120 CAPTURE                          VAL R11
      121 CAPTURE                          VAL R14
      122 CAPTURE                          VAL R18
      123 CAPTURE                          VAL R2
      124 CAPTURE                          VAL R20
      125 DUPCLOSURE                       R22 K28 [PROTO_11]
      126 DUPCLOSURE                       R23 K29 [PROTO_12]
      127 CAPTURE                          VAL R8
      128 DUPCLOSURE                       R24 K30 [PROTO_13]
      129 CAPTURE                          VAL R7
      130 DUPCLOSURE                       R25 K31 [PROTO_14]
      131 CAPTURE                          VAL R5
      132 CAPTURE                          VAL R13
      133 NEWTABLE                         R26 2 0
      135 LOADNIL                          R27
      136 NEWCLOSURE                       R28 P11
      137 CAPTURE                          REF R27
      138 CAPTURE                          VAL R2
      139 SETTABLEKS                       R28 R26 K32 ["getBoundsViewsForAssetType"]
      141 DUPCLOSURE                       R28 K33 [PROTO_18]
      142 CAPTURE                          VAL R26
      143 CAPTURE                          VAL R21
      144 CAPTURE                          VAL R6
      145 CAPTURE                          VAL R24
      ...
      147 CAPTURE                          VAL R25
      148 CAPTURE                          VAL R1
      149 SETTABLEKS                       R28 R26 K34 ["validate"]
      151 CLOSEUPVALS                      R27
      152 RETURN                           R26 1
