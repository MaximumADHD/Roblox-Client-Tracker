...
PROTO_4:
       ...
       39 LENGTH                           R10 R9
       40 JUMPIFNOTLT                      R6 R10 ; [+6]
       42 DUPTABLE                         R10 K11 [{"status"}]
       43 LOADK                            R11 K12 ["tooManyAssets"]
       44 SETTABLEKS                       R11 R10 K10 ["status"]
       46 RETURN                           R10 1
       47 NEWTABLE                         R10 0 0
       49 NEWTABLE                         R11 0 0
       51 MOVE                             R12 R9
       ...
       53 LOADNIL                          R14
       54 FORGPREP                         R12
       55 FASTCALL2                        TABLE_INSERT R11 R16 ; [+5]
       57 MOVE                             R18 R11
       58 MOVE                             R19 R16
       59 GETIMPORT                        R17 K9 [table.insert]
       61 CALL                             R17 2 0
       62 LENGTH                           R17 R11
       63 JUMPIFNOTLE                      R5 R17 ; [+15]
       65 MOVE                             R18 R10
       66 GETUPVAL                         R19 1
       67 MOVE                             R20 R7
       68 MOVE                             R21 R11
       ...
       74 GETIMPORT                        R17 K9 [table.insert]
       76 CALL                             R17 -1 0
       77 NEWTABLE                         R11 0 0
       79 FORGLOOP                         R12 2 ; [-25]
       81 LENGTH                           R12 R11
       82 LOADN                            R13 0
       83 JUMPIFNOTLT                      R13 R12 ; [+13]
       85 MOVE                             R13 R10
       86 GETUPVAL                         R14 1
       87 MOVE                             R15 R7
       88 MOVE                             R16 R11
       ...
       94 GETIMPORT                        R12 K9 [table.insert]
       96 CALL                             R12 -1 0
       97 GETUPVAL                         R12 2
       98 GETTABLEKS                       R12 R12 K13 ["all"]
      100 MOVE                             R13 R10
      101 CALL                             R12 1 1
      102 NAMECALL                         R12 R12 K14 ["await"]
      104 CALL                             R12 1 2
      105 JUMPIF                           R12 ; [+5]
      106 DUPTABLE                         R14 K11 [{"status"}]
      107 LOADK                            R15 K15 ["loadFailed"]
      108 SETTABLEKS                       R15 R14 K10 ["status"]
      110 RETURN                           R14 1
      111 GETUPVAL                         R15 3
      112 CALL                             R15 0 1
      113 JUMPIFNOTEQKS                    R15 K16 [""] ; [+2]
      115 LOADB                            R14 0 +1
      116 LOADB                            R14 1
      117 JUMPIFNOT                        R14 ; [+3]
      118 GETUPVAL                         R15 4
      ...
      127 LOADNIL                          R19
      128 FORGPREP                         R17
      129 GETTABLEKS                       R22 R21 K17 ["result"]
      131 LOADNIL                          R23
      132 LOADNIL                          R24
      133 FORGPREP                         R22
      134 GETTABLE                         R27 R0 R25
      135 JUMPIFNOT                        R27 ; [+20]
      136 MOVE                             R28 R26
      137 JUMPIFNOT                        R14 ; [+4]
      138 JUMPIF                           R26 ; [+3]
      139 GETTABLE                         R29 R15 R25
      140 JUMPIFNOT                        R29 ; [+1]
      141 LOADB                            R28 1
      142 DUPTABLE                         R31 K21 [{"assetId", "allowed", "entry"}]
      143 SETTABLEKS                       R25 R31 K18 ["assetId"]
      145 SETTABLEKS                       R28 R31 K19 ["allowed"]
      147 GETTABLEN                        R32 R27 1
      148 SETTABLEKS                       R32 R31 K20 ["entry"]
      150 FASTCALL2                        TABLE_INSERT R16 R31 ; [+4]
      152 MOVE                             R30 R16
      153 GETIMPORT                        R29 K9 [table.insert]
      155 CALL                             R29 2 0
      156 FORGLOOP                         R22 2 ; [-23]
      158 FORGLOOP                         R17 2 ; [-30]
      160 DUPTABLE                         R17 K23 [{"status", "verdicts"}]
      161 LOADK                            R18 K24 ["ok"]
      162 SETTABLEKS                       R18 R17 K10 ["status"]
      164 SETTABLEKS                       R16 R17 K22 ["verdicts"]
      166 RETURN                           R17 1
