...
PROTO_2:
        ...
        5 JUMPIF                           R6 ; [+29]
        6 GETUPVAL                         R6 1
        7 GETTABLEKS                       R6 R6 K0 ["reportFailure"]
        9 GETUPVAL                         R7 1
       10 GETTABLEKS                       R7 R7 K1 ["ErrorType"]
       12 GETTABLEKS                       R7 R7 K2 ["validateProperties_PropertyMismatch"]
       14 LOADNIL                          R8
       15 MOVE                             R9 R0
       16 CALL                             R6 3 0
       17 LOADB                            R6 0
...
PROTO_6:
       ...
       21 FORGPREP                         R5
       22 GETUPVAL                         R10 1
       23 GETTABLEKS                       R10 R10 K6 ["PROPERTIES"]
       25 LOADNIL                          R11
       26 LOADNIL                          R12
       27 FORGPREP                         R10
       28 MOVE                             R17 R13
       ...
       43 JUMPIF                           R20 ; [+28]
       44 GETUPVAL                         R22 2
       45 GETTABLEKS                       R22 R22 K10 ["reportFailure"]
       47 GETUPVAL                         R23 2
       48 GETTABLEKS                       R23 R23 K11 ["ErrorType"]
       50 GETTABLEKS                       R23 R23 K12 ["validateProperties_PropertyDoesNotExist"]
       52 LOADNIL                          R24
       53 MOVE                             R25 R2
       54 CALL                             R22 3 0
       55 LOADB                            R24 0
...
MAIN:
       ...
       26 GETTABLEKS                       R5 R0 K8 ["util"]
       28 GETTABLEKS                       R5 R5 K9 ["Types"]
       30 CALL                             R4 1 1
       31 GETIMPORT                        R5 K4 [require]
       33 GETTABLEKS                       R6 R0 K8 ["util"]
       35 GETTABLEKS                       R6 R6 K10 ["valueToString"]
       37 CALL                             R5 1 1
       38 GETIMPORT                        R6 K4 [require]
       40 GETTABLEKS                       R7 R0 K8 ["util"]
       42 GETTABLEKS                       R7 R7 K11 ["FailureReasonsAccumulator"]
       44 CALL                             R6 1 1
       45 GETIMPORT                        R7 K4 [require]
       47 GETTABLEKS                       R8 R0 K12 ["flags"]
       49 GETTABLEKS                       R8 R8 K13 ["getFFlagUGCValidationEyebrowEyelashSupport"]
       51 CALL                             R7 1 1
       52 DUPCLOSURE                       R8 K14 [PROTO_0]
       53 CAPTURE                          VAL R3
       54 DUPCLOSURE                       R9 K15 [PROTO_1]
       55 CAPTURE                          VAL R1
       56 CAPTURE                          VAL R7
       57 CAPTURE                          VAL R3
       58 CAPTURE                          VAL R9
       59 CAPTURE                          VAL R8
       60 DUPCLOSURE                       R10 K16 [PROTO_2]
       61 CAPTURE                          VAL R9
       62 CAPTURE                          VAL R2
       63 CAPTURE                          VAL R5
       64 DUPCLOSURE                       R11 K17 [PROTO_3]
       65 DUPCLOSURE                       R12 K18 [PROTO_4]
       66 CAPTURE                          VAL R3
       67 CAPTURE                          VAL R12
       68 DUPCLOSURE                       R13 K19 [PROTO_6]
       69 CAPTURE                          VAL R6
       70 CAPTURE                          VAL R3
       71 CAPTURE                          VAL R2
       72 CAPTURE                          VAL R12
