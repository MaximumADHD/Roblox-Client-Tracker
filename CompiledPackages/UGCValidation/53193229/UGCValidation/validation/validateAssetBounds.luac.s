PROTO_0:
       ...
       30 JUMP                             ; [+40]
       31 GETUPVAL                         R6 0
       32 GETTABLEKS                       R6 R6 K2 ["ASSET_TYPE_INFO"]
...
PROTO_2:
       ...
       25 JUMPIF                           R6 ; [+20]
       26 GETUPVAL                         R7 1
       27 GETTABLEKS                       R7 R7 K2 ["reportFailure"]
       29 GETUPVAL                         R8 1
       30 GETTABLEKS                       R8 R8 K3 ["ErrorType"]
       32 GETTABLEKS                       R8 R8 K4 ["validateAssetBounds_InconsistentAvatarPartScaleType"]
       34 LOADNIL                          R9
       35 MOVE                             R10 R3
       36 CALL                             R7 3 0
       37 LOADB                            R7 0
...
PROTO_3:
       ...
       27 JUMPIF                           R5 ; [+12]
       28 GETUPVAL                         R15 1
       29 GETTABLEKS                       R15 R15 K6 ["reportFailure"]
       31 GETUPVAL                         R16 1
       32 GETTABLEKS                       R16 R16 K7 ["ErrorType"]
       34 GETTABLEKS                       R16 R16 K8 ["validateAssetBounds_AssetSizeTooSmall"]
       36 LOADNIL                          R17
       37 MOVE                             R18 R3
       38 CALL                             R15 3 0
       39 LOADB                            R5 1
...
PROTO_4:
       ...
       31 GETUPVAL                         R16 1
       32 GETTABLEKS                       R16 R16 K7 ["ErrorType"]
       34 GETTABLEKS                       R16 R16 K8 ["validateAssetBounds_AssetSizeTooBig"]
       36 LOADNIL                          R17
       37 MOVE                             R18 R3
       38 CALL                             R15 3 0
       39 LOADB                            R5 1
...
PROTO_5:
       ...
       25 JUMPIFNOT                        R0 ; [+10]
       26 GETUPVAL                         R9 0
       27 GETTABLEKS                       R9 R9 K5 ["calculateFullBodyBounds"]
       29 MOVE                             R10 R0
       30 MOVE                             R11 R2
       31 CALL                             R9 2 3
       32 MOVE                             R6 R9
       ...
       35 JUMP                             ; [+9]
       36 GETUPVAL                         R9 0
       37 GETTABLEKS                       R9 R9 K6 ["calculateAssetBounds"]
       39 MOVE                             R10 R1
       40 MOVE                             R11 R2
       41 CALL                             R9 2 3
       42 MOVE                             R6 R9
       ...
       59 RETURN                           R6 2
       60 GETUPVAL                         R11 2
       61 GETTABLEKS                       R11 R11 K7 ["new"]
       63 CALL                             R11 0 1
       64 LOADNIL                          R12
       65 LOADNIL                          R13
       66 JUMPIFNOT                        R0 ; [+13]
       67 GETUPVAL                         R15 3
       68 GETTABLEKS                       R15 R15 K8 ["FULL_BODY_BOUNDS"]
       70 GETTABLE                         R14 R15 R10
       71 GETTABLEKS                       R12 R14 K9 ["minSize"]
       73 GETUPVAL                         R15 3
       74 GETTABLEKS                       R15 R15 K8 ["FULL_BODY_BOUNDS"]
       76 GETTABLE                         R14 R15 R10
       77 GETTABLEKS                       R13 R14 K10 ["maxSize"]
       79 JUMP                             ; [+18]
       80 GETUPVAL                         R16 3
       81 GETTABLEKS                       R16 R16 K11 ["ASSET_TYPE_INFO"]
       83 GETTABLE                         R15 R16 R4
       84 GETTABLEKS                       R15 R15 K12 ["bounds"]
       86 GETTABLE                         R14 R15 R10
       87 GETTABLEKS                       R12 R14 K9 ["minSize"]
       89 GETUPVAL                         R16 3
       90 GETTABLEKS                       R16 R16 K11 ["ASSET_TYPE_INFO"]
       92 GETTABLE                         R15 R16 R4
       93 GETTABLEKS                       R15 R15 K12 ["bounds"]
      ...
      115 CALL                             R14 -1 0
      116 GETUPVAL                         R14 6
      117 GETTABLEKS                       R14 R14 K14 ["recordScriptTime"]
      119 GETIMPORT                        R15 K16 [script]
      121 GETTABLEKS                       R15 R15 K17 ["Name"]
      123 MOVE                             R16 R3
      124 MOVE                             R17 R2
      125 CALL                             R14 3 0
...
MAIN:
       ...
       28 GETTABLEKS                       R5 R5 K9 ["BoundsCalculator"]
       30 CALL                             R4 1 1
       31 GETIMPORT                        R5 K4 [require]
       33 GETTABLEKS                       R6 R0 K7 ["util"]
       35 GETTABLEKS                       R6 R6 K10 ["FailureReasonsAccumulator"]
       37 CALL                             R5 1 1
       38 GETIMPORT                        R6 K4 [require]
       40 GETTABLEKS                       R7 R0 K11 ["validation"]
       42 GETTABLEKS                       R7 R7 K12 ["validateScaleType"]
       44 CALL                             R6 1 1
