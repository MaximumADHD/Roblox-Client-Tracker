PROTO_0:
        ...
        3 GETUPVAL                         R2 0
        4 GETTABLEKS                       R2 R2 K1 ["reportFailure"]
        6 GETUPVAL                         R3 0
        7 GETTABLEKS                       R3 R3 K2 ["ErrorType"]
        9 GETTABLEKS                       R3 R3 K3 ["validateHSR_FileDataInvalid"]
       11 LOADNIL                          R4
       12 MOVE                             R5 R1
       13 CALL                             R2 3 0
       14 LOADB                            R2 0
       ...
       26 JUMPIF                           R3 ; [+18]
       27 GETUPVAL                         R3 0
       28 GETTABLEKS                       R3 R3 K1 ["reportFailure"]
       30 GETUPVAL                         R4 0
       31 GETTABLEKS                       R4 R4 K2 ["ErrorType"]
       33 GETTABLEKS                       R4 R4 K3 ["validateHSR_FileDataInvalid"]
       35 LOADNIL                          R5
       36 MOVE                             R6 R1
       37 CALL                             R3 3 0
       38 LOADB                            R3 0
       ...
       78 CALL                             R4 -1 0
       79 GETUPVAL                         R6 4
       80 GETTABLEKS                       R6 R6 K13 ["validate"]
       82 MOVE                             R7 R2
       83 MOVE                             R8 R1
       84 CALL                             R6 2 -1
       ...
       91 JUMPIF                           R4 ; [+11]
       92 GETUPVAL                         R4 0
       93 GETTABLEKS                       R4 R4 K1 ["reportFailure"]
       95 GETUPVAL                         R5 0
       96 GETTABLEKS                       R5 R5 K2 ["ErrorType"]
       98 GETTABLEKS                       R5 R5 K3 ["validateHSR_FileDataInvalid"]
      100 LOADNIL                          R6
      101 MOVE                             R7 R1
      102 CALL                             R4 3 0
...
PROTO_2:
       ...
       43 JUMPIF                           R5 ; [+18]
       44 GETUPVAL                         R6 3
       45 GETTABLEKS                       R6 R6 K6 ["reportFailure"]
       47 GETUPVAL                         R7 3
       48 GETTABLEKS                       R7 R7 K7 ["ErrorType"]
       50 GETTABLEKS                       R7 R7 K8 ["validataHSR_HSRMeshIdsMismatch"]
       52 LOADNIL                          R8
       53 MOVE                             R9 R2
       54 CALL                             R6 3 0
       55 LOADB                            R6 0
...
PROTO_4:
       ...
       18 JUMPIFNOT                        R2 ; [+18]
       19 GETUPVAL                         R4 0
       20 GETTABLEKS                       R4 R4 K5 ["reportFailure"]
       22 GETUPVAL                         R5 0
       23 GETTABLEKS                       R5 R5 K6 ["ErrorType"]
       25 GETTABLEKS                       R5 R5 K7 ["validateHSR_FileDataInvalid"]
       27 LOADNIL                          R6
       28 MOVE                             R7 R1
       29 CALL                             R4 3 0
       30 LOADB                            R4 0
       ...
       38 RETURN                           R4 1
       39 GETUPVAL                         R4 1
       40 GETTABLEKS                       R4 R4 K9 ["tryGetAssetIdFromContentId"]
       42 MOVE                             R5 R3
       43 CALL                             R4 1 1
       44 JUMPIF                           R4 ; [+18]
       45 GETUPVAL                         R4 0
       46 GETTABLEKS                       R4 R4 K5 ["reportFailure"]
       48 GETUPVAL                         R5 0
       49 GETTABLEKS                       R5 R5 K6 ["ErrorType"]
       51 GETTABLEKS                       R5 R5 K7 ["validateHSR_FileDataInvalid"]
       53 LOADNIL                          R6
       54 MOVE                             R7 R1
       55 CALL                             R4 3 0
       56 LOADB                            R4 0
       ...
       73 CALL                             R6 1 0
       74 GETUPVAL                         R6 0
       75 GETTABLEKS                       R6 R6 K5 ["reportFailure"]
       77 GETUPVAL                         R7 0
       78 GETTABLEKS                       R7 R7 K6 ["ErrorType"]
       80 GETTABLEKS                       R7 R7 K7 ["validateHSR_FileDataInvalid"]
       82 LOADNIL                          R8
       83 MOVE                             R9 R1
       84 CALL                             R6 3 0
       85 LOADB                            R6 0
       ...
       94 JUMPIF                           R6 ; [+7]
       95 GETUPVAL                         R6 3
       96 GETTABLEKS                       R6 R6 K16 ["validateHiddenSurfaceRemovalAsset"]
       98 MOVE                             R7 R5
       99 MOVE                             R8 R1
      100 CALL                             R6 2 -1
      101 RETURN                           R6 -1
      102 GETUPVAL                         R6 4
      103 GETTABLEKS                       R6 R6 K17 ["new"]
      105 CALL                             R6 0 1
      106 GETUPVAL                         R9 3
      107 GETTABLEKS                       R9 R9 K16 ["validateHiddenSurfaceRemovalAsset"]
      109 MOVE                             R10 R5
      110 MOVE                             R11 R1
      111 CALL                             R9 2 -1
      ...
      118 JUMPIFNOT                        R7 ; [+10]
      119 GETUPVAL                         R9 3
      120 GETTABLEKS                       R9 R9 K20 ["validateHSRMeshIdData"]
      122 MOVE                             R10 R0
      123 MOVE                             R11 R5
      124 MOVE                             R12 R1
      125 CALL                             R9 3 -1
      ...
      132 JUMPIF                           R7 ; [+11]
      133 GETUPVAL                         R7 0
      134 GETTABLEKS                       R7 R7 K5 ["reportFailure"]
      136 GETUPVAL                         R8 0
      137 GETTABLEKS                       R8 R8 K6 ["ErrorType"]
      139 GETTABLEKS                       R8 R8 K7 ["validateHSR_FileDataInvalid"]
      141 LOADNIL                          R9
      142 MOVE                             R10 R1
      143 CALL                             R7 3 0
...
PROTO_5:
        ...
        2 CALL                             R2 0 1
        3 GETUPVAL                         R3 0
        4 GETTABLEKS                       R3 R3 K2 ["new"]
        6 CALL                             R3 0 1
        7 GETUPVAL                         R6 1
        8 GETTABLEKS                       R6 R6 K3 ["validateInstance"]
       10 MOVE                             R7 R0
       11 MOVE                             R8 R1
       12 CALL                             R6 2 -1
       ...
       15 CALL                             R4 -1 0
       16 GETUPVAL                         R4 2
       17 GETTABLEKS                       R4 R4 K5 ["recordScriptTime"]
...
MAIN:
       ...
       54 GETTABLEKS                       R12 R1 K14 ["util"]
       56 GETTABLEKS                       R12 R12 K18 ["pcallDeferred"]
       58 CALL                             R11 1 1
       59 NEWTABLE                         R12 4 0
       61 GETIMPORT                        R13 K8 [require]
       63 GETTABLEKS                       R14 R1 K19 ["flags"]
       65 GETTABLEKS                       R14 R14 K20 ["getFFlagUGCValidateHSRMeshIds"]
       67 CALL                             R13 1 1
