...
PROTO_2:
       ...
       24 NEWTABLE                         R6 2 0
       26 GETUPVAL                         R7 5
       27 GETTABLEKS                       R7 R7 K11 ["ExperienceAuthHeaderKey"]
       29 GETUPVAL                         R8 6
       30 SETTABLE                         R8 R6 R7
       31 GETUPVAL                         R7 5
       32 GETTABLEKS                       R7 R7 K12 ["ContentType"]
       34 GETUPVAL                         R8 5
       35 GETTABLEKS                       R8 R8 K13 ["ApplicationJson"]
...
PROTO_4:
       ...
       70 GETUPVAL                         R12 3
       71 GETTABLEKS                       R12 R12 K17 ["reportFailure"]
       73 GETUPVAL                         R13 3
       74 GETTABLEKS                       R13 R13 K18 ["ErrorType"]
       76 GETTABLEKS                       R13 R13 K19 ["validateAssetCreator_TooManyDependencies"]
       78 LOADNIL                          R14
       79 MOVE                             R15 R1
       80 CALL                             R12 3 0
       81 LOADB                            R12 0
      ...
      101 LENGTH                           R18 R12
      102 GETUPVAL                         R19 4
      103 JUMPIFNOTLE                      R19 R18 ; [+33]
      105 MOVE                             R19 R12
      106 LENGTH                           R20 R19
      107 JUMPIFNOTEQKN                    R20 K24 [0] ; [+7]
      109 GETUPVAL                         R20 5
      110 GETTABLEKS                       R20 R20 K25 ["resolve"]
      112 CALL                             R20 0 1
      113 MOVE                             R18 R20
      114 JUMP                             ; [+13]
      115 GETUPVAL                         R20 5
      116 GETTABLEKS                       R20 R20 K9 ["new"]
      ...
      126 CALL                             R20 1 1
      127 MOVE                             R18 R20
      128 FASTCALL2                        TABLE_INSERT R10 R18 ; [+5]
      130 MOVE                             R20 R10
      131 MOVE                             R21 R18
      132 GETIMPORT                        R19 K23 [table.insert]
      134 CALL                             R19 2 0
      135 NEWTABLE                         R12 0 0
      137 FORGLOOP                         R13 2 ; [-44]
      139 LENGTH                           R13 R12
      140 LOADN                            R14 0
      141 JUMPIFNOTLT                      R14 R13 ; [+31]
      143 MOVE                             R14 R12
      144 LENGTH                           R15 R14
      145 JUMPIFNOTEQKN                    R15 K24 [0] ; [+7]
      147 GETUPVAL                         R15 5
      148 GETTABLEKS                       R15 R15 K25 ["resolve"]
      150 CALL                             R15 0 1
      151 MOVE                             R13 R15
      152 JUMP                             ; [+13]
      153 GETUPVAL                         R15 5
      154 GETTABLEKS                       R15 R15 K9 ["new"]
      ...
      164 CALL                             R15 1 1
      165 MOVE                             R13 R15
      166 FASTCALL2                        TABLE_INSERT R10 R13 ; [+5]
      168 MOVE                             R15 R10
      169 MOVE                             R16 R13
      170 GETIMPORT                        R14 K23 [table.insert]
      172 CALL                             R14 2 0
      173 GETUPVAL                         R13 5
      174 GETTABLEKS                       R13 R13 K26 ["all"]
      176 MOVE                             R14 R10
      177 CALL                             R13 1 1
      178 NAMECALL                         R13 R13 K27 ["await"]
      180 CALL                             R13 1 2
      181 JUMPIF                           R13 ; [+18]
      182 GETUPVAL                         R15 3
      183 GETTABLEKS                       R15 R15 K17 ["reportFailure"]
      185 GETUPVAL                         R16 3
      186 GETTABLEKS                       R16 R16 K18 ["ErrorType"]
      188 GETTABLEKS                       R16 R16 K28 ["validateAssetCreator_FailedToLoad"]
      190 LOADNIL                          R17
      191 MOVE                             R18 R1
      192 CALL                             R15 3 0
      193 LOADB                            R15 0
      194 NEWTABLE                         R16 0 1
      196 LOADK                            R17 K29 ["Failed to load detailed information for model assets. Make sure all model assets exist and try again."]
      197 SETLIST                          R16 R17 1 [1]
      199 RETURN                           R15 2
      200 GETUPVAL                         R16 8
      201 CALL                             R16 0 1
      202 JUMPIFNOTEQKS                    R16 K30 [""] ; [+2]
      204 LOADB                            R15 0 +1
      205 LOADB                            R15 1
      206 JUMPIFNOT                        R15 ; [+3]
      207 GETUPVAL                         R16 9
      208 CALL                             R16 0 1
      209 JUMP                             ; [+2]
      210 NEWTABLE                         R16 0 0
      212 MOVE                             R17 R14
      213 LOADNIL                          R18
      214 LOADNIL                          R19
      215 FORGPREP                         R17
      216 GETTABLEKS                       R22 R21 K31 ["result"]
      218 GETIMPORT                        R23 K33 [pairs]
      220 MOVE                             R24 R22
      221 CALL                             R23 1 3
      222 FORGPREP_NEXT                    R23
      223 MOVE                             R28 R27
      224 JUMPIFNOT                        R15 ; [+4]
      225 MOVE                             R29 R27
      226 JUMPIF                           R29 ; [+1]
      227 GETTABLE                         R29 R16 R26
      228 MOVE                             R28 R29
      229 JUMPIF                           R28 ; [+11]
      230 GETUPVAL                         R29 3
      231 GETTABLEKS                       R29 R29 K17 ["reportFailure"]
      233 GETUPVAL                         R30 3
      234 GETTABLEKS                       R30 R30 K18 ["ErrorType"]
      236 GETTABLEKS                       R30 R30 K34 ["validateAssetCreator_DependencyNotOwnedByCreator"]
      238 LOADNIL                          R31
      239 MOVE                             R32 R1
      240 CALL                             R29 3 0
      241 GETTABLE                         R29 R0 R26
      242 GETIMPORT                        R30 K37 [string.format]
      244 LOADK                            R31 K38 ["%s.%s ( %s ) being used is not owned by the experience creator or player. You can only publish assets that you own."]
      245 GETTABLEKS                       R32 R29 K39 ["instance"]
      247 NAMECALL                         R32 R32 K40 ["GetFullName"]
      249 CALL                             R32 1 1
      250 GETTABLEKS                       R33 R29 K41 ["fieldName"]
      252 MOVE                             R34 R26
      253 CALL                             R30 4 1
      254 MOVE                             R33 R28
      255 NEWTABLE                         R34 0 1
      257 MOVE                             R35 R30
      258 SETLIST                          R34 R35 1 [1]
      260 NAMECALL                         R31 R8 K42 ["updateReasons"]
      262 CALL                             R31 3 0
      263 FORGLOOP                         R23 2 ; [-41]
      265 FORGLOOP                         R17 2 ; [-50]
      267 NAMECALL                         R17 R8 K43 ["getFinalResults"]
      269 CALL                             R17 1 -1
      270 RETURN                           R17 -1
...
MAIN:
       ...
       37 GETTABLEKS                       R4 R4 K13 ["APIUtil"]
       39 CALL                             R3 1 1
       40 GETIMPORT                        R4 K4 [require]
       42 GETTABLEKS                       R5 R0 K12 ["util"]
       44 GETTABLEKS                       R5 R5 K14 ["Types"]
       46 CALL                             R4 1 1
       ...
       80 GETTABLEKS                       R12 R0 K12 ["util"]
       82 GETTABLEKS                       R12 R12 K24 ["FailureReasonsAccumulator"]
       84 CALL                             R11 1 1
       85 GETIMPORT                        R12 K4 [require]
       87 GETTABLEKS                       R13 R0 K25 ["flags"]
       89 GETTABLEKS                       R13 R13 K26 ["getFStringUGCValidationReferenceMeshIdWhitelistForIEC"]
       91 CALL                             R12 1 1
