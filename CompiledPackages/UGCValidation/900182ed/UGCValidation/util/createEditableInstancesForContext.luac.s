...
PROTO_1:
        ...
        9 GETUPVAL                         R0 1
       10 GETUPVAL                         R2 2
       11 NAMECALL                         R0 R0 K2 ["CreateEditableImageAsync"]
       13 CALL                             R0 2 1
       14 RETURN                           R0 1
...
PROTO_2:
       ...
       11 SETTABLE                         R4 R1 R5
       12 LOADB                            R5 1
       13 DUPTABLE                         R6 K5 [{"created", "instance"}]
       14 LOADB                            R7 1
       15 SETTABLEKS                       R7 R6 K3 ["created"]
       17 SETTABLEKS                       R4 R6 K4 ["instance"]
       19 RETURN                           R5 2
...
MAIN:
       ...
       24 GETTABLEKS                       R6 R0 K11 ["util"]
       26 GETTABLEKS                       R5 R6 K12 ["Types"]
       28 CALL                             R4 1 1
       29 GETIMPORT                        R5 K4 [require]
       31 GETTABLEKS                       R7 R0 K11 ["util"]
       33 GETTABLEKS                       R6 R7 K13 ["destroyEditableInstances"]
       35 CALL                             R5 1 1
       36 DUPCLOSURE                       R6 K14 [PROTO_0]
       37 DUPCLOSURE                       R7 K15 [PROTO_2]
       38 CAPTURE                          VAL R3
       39 DUPCLOSURE                       R8 K16 [PROTO_3]
       40 CAPTURE                          VAL R7
       41 SETTABLEKS                       R8 R1 K17 ["getEditableInstanceInfo"]
       43 DUPCLOSURE                       R8 K18 [PROTO_4]
       44 DUPCLOSURE                       R9 K19 [PROTO_5]
       45 CAPTURE                          VAL R2
       46 DUPCLOSURE                       R10 K20 [PROTO_6]
       47 DUPCLOSURE                       R11 K21 [PROTO_7]
       48 CAPTURE                          VAL R2
       49 DUPCLOSURE                       R12 K22 [PROTO_8]
       50 CAPTURE                          VAL R11
       51 CAPTURE                          VAL R9
       52 CAPTURE                          VAL R1
       53 SETTABLEKS                       R12 R1 K23 ["getOrCreateEditableInstances"]
       55 DUPCLOSURE                       R12 K24 [PROTO_9]
       56 CAPTURE                          VAL R1
       57 CAPTURE                          VAL R5
       58 SETTABLEKS                       R12 R1 K25 ["processAll"]
       60 RETURN                           R1 1
