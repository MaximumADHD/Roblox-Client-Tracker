...
PROTO_6:
       ...
       11 GETUPVAL                         R2 1
       12 GETUPVAL                         R6 2
       13 GETTABLEKS                       R5 R6 K6 ["ASSET_TYPE_INFO"]
       15 GETTABLE                         R4 R5 R0
       16 GETTABLEKS                       R3 R4 K7 ["attachmentNames"]
       18 CALL                             R2 1 -1
       19 RETURN                           R2 -1
       20 GETUPVAL                         R2 3
       21 GETUPVAL                         R6 2
       22 GETTABLEKS                       R5 R6 K6 ["ASSET_TYPE_INFO"]
       24 GETTABLE                         R4 R5 R0
       25 GETTABLEKS                       R3 R4 K7 ["attachmentNames"]
       27 CALL                             R2 1 -1
       28 RETURN                           R2 -1
       29 GETUPVAL                         R2 3
       30 GETUPVAL                         R6 2
       31 GETTABLEKS                       R5 R6 K6 ["ASSET_TYPE_INFO"]
       33 GETTABLE                         R4 R5 R0
       34 GETTABLEKS                       R3 R4 K7 ["attachmentNames"]
       36 CALL                             R2 1 -1
       37 RETURN                           R2 -1
...
MAIN:
       ...
       37 GETTABLEKS                       R6 R7 K10 ["createEyebrowEyelashSchema"]
       39 CALL                             R5 1 1
       40 GETIMPORT                        R6 K4 [require]
       42 GETTABLEKS                       R8 R0 K5 ["util"]
       44 GETTABLEKS                       R7 R8 K11 ["createMeshPartAccessorySchema"]
       46 CALL                             R6 1 1
       47 GETIMPORT                        R7 K4 [require]
       49 GETTABLEKS                       R9 R0 K5 ["util"]
       51 GETTABLEKS                       R8 R9 K12 ["createMakeupSchema"]
       53 CALL                             R7 1 1
       54 GETIMPORT                        R8 K4 [require]
       56 GETTABLEKS                       R10 R0 K5 ["util"]
       58 GETTABLEKS                       R9 R10 K13 ["createDynamicHeadMeshPartSchema"]
       60 CALL                             R8 1 1
       61 GETIMPORT                        R9 K4 [require]
       63 GETTABLEKS                       R11 R0 K5 ["util"]
       65 GETTABLEKS                       R10 R11 K14 ["createAccessorySchema"]
       67 CALL                             R9 1 1
       68 GETIMPORT                        R10 K4 [require]
       70 GETTABLEKS                       R12 R0 K5 ["util"]
       72 GETTABLEKS                       R11 R12 K15 ["createEmoteSchema"]
       74 CALL                             R10 1 1
       75 GETIMPORT                        R11 K4 [require]
       77 GETTABLEKS                       R13 R0 K5 ["util"]
       79 GETTABLEKS                       R12 R13 K16 ["getUploadCategory"]
       81 CALL                             R11 1 1
       82 GETIMPORT                        R12 K4 [require]
       84 GETTABLEKS                       R14 R0 K17 ["flags"]
       86 GETTABLEKS                       R13 R14 K18 ["getFFlagUGCValidateMakeupAssetTypeNewPipeline"]
       88 CALL                             R12 1 1
       89 GETIMPORT                        R13 K4 [require]
       91 GETTABLEKS                       R15 R0 K17 ["flags"]
       93 GETTABLEKS                       R14 R15 K19 ["getFFlagUGCValidateEyebrowEyelashThumbnailSchema"]
       95 CALL                             R13 1 1
       96 NEWTABLE                         R14 2 0
