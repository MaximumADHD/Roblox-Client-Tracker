...
PROTO_1:
       ...
       51 JUMPIF                           R5 ; [+23]
       52 JUMPIFNOT                        R1 ; [+4]
       53 GETIMPORT                        R7 K13 [error]
       55 LOADK                            R8 K14 ["Failed to retrieve mesh data to validate skinned mesh"]
       56 CALL                             R7 1 0
       57 GETUPVAL                         R8 1
       58 GETTABLEKS                       R7 R8 K4 ["reportFailure"]
       60 GETUPVAL                         R10 1
       61 GETTABLEKS                       R9 R10 K5 ["ErrorType"]
       63 GETTABLEKS                       R8 R9 K15 ["validateDescendantMeshMetrics_FailedToLoadMesh"]
       65 LOADNIL                          R9
       66 MOVE                             R10 R3
       67 CALL                             R7 3 0
       68 LOADB                            R7 0
       69 NEWTABLE                         R8 0 1
       71 LOADK                            R9 K14 ["Failed to retrieve mesh data to validate skinned mesh"]
       72 SETLIST                          R8 R9 1 [1]
       74 RETURN                           R7 2
       75 JUMPIF                           R6 ; [+30]
       76 LOADK                            R8 K16 ["Detected mismatch between model and skinned data for %*. You need to re-skin your model to fix this issue."]
       77 GETTABLEKS                       R10 R0 K8 ["Name"]
       79 NAMECALL                         R8 R8 K9 ["format"]
       81 CALL                             R8 2 1
       82 MOVE                             R7 R8
       83 JUMPIFNOT                        R1 ; [+4]
       84 GETIMPORT                        R8 K13 [error]
       86 MOVE                             R9 R7
       87 CALL                             R8 1 0
       88 GETUPVAL                         R9 1
       89 GETTABLEKS                       R8 R9 K4 ["reportFailure"]
       91 GETUPVAL                         R11 1
       92 GETTABLEKS                       R10 R11 K5 ["ErrorType"]
       94 GETTABLEKS                       R9 R10 K17 ["validateDescendantMeshMetrics_HasSkinnedMeshMismatch"]
       96 LOADNIL                          R10
       97 MOVE                             R11 R3
       98 CALL                             R8 3 0
       99 LOADB                            R8 0
...
MAIN:
      ...
      146 GETTABLEKS                       R22 R23 K31 ["getEngineFeatureEngineUGCValidateBodyParts"]
      148 CALL                             R21 1 1
      149 GETIMPORT                        R22 K8 [require]
      151 GETTABLEKS                       R24 R1 K29 ["flags"]
      153 GETTABLEKS                       R23 R24 K32 ["getFIntUGCValidateTriangleLimitTolerance"]
      155 CALL                             R22 1 1
      156 GETIMPORT                        R23 K8 [require]
      158 GETTABLEKS                       R25 R1 K29 ["flags"]
      160 GETTABLEKS                       R24 R25 K33 ["getEngineUGCValidateRelativeSkinningTransfer"]
      162 CALL                             R23 1 1
      ...
      167 CAPTURE                          VAL R17
      168 CAPTURE                          VAL R0
      169 DUPCLOSURE                       R25 K35 [PROTO_4]
      170 CAPTURE                          VAL R3
      171 CAPTURE                          VAL R17
      172 CAPTURE                          VAL R2
      173 CAPTURE                          VAL R5
      ...
      177 CAPTURE                          VAL R2
      178 DUPCLOSURE                       R27 K37 [PROTO_6]
      179 CAPTURE                          VAL R14
      180 CAPTURE                          VAL R15
      181 CAPTURE                          VAL R3
      182 CAPTURE                          VAL R25
