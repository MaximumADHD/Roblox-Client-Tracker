...
PROTO_3:
       ...
       11 MOVE                             R3 R1
       12 GETIMPORT                        R2 K3 [tostring]
       14 CALL                             R2 1 1
       15 RETURN                           R2 1
       16 RETURN                           R1 1
       17 GETIMPORT                        R2 K6 [string.match]
       19 MOVE                             R3 R0
       20 LOADK                            R4 K7 ["^rbxassetid://(%d+)$"]
       21 CALL                             R2 2 1
       22 MOVE                             R1 R2
       ...
       28 CALL                             R2 1 1
       29 MOVE                             R1 R2
       30 JUMPIFEQKNIL                     R1 ; [+2]
       32 RETURN                           R1 1
       33 GETUPVAL                         R2 2
       34 MOVE                             R3 R0
       35 CALL                             R2 1 1
       36 MOVE                             R1 R2
       37 JUMPIFEQKNIL                     R1 ; [+2]
       39 RETURN                           R1 1
       40 LOADNIL                          R2
       41 RETURN                           R2 1
...
MAIN:
       ...
       21 GETTABLEKS                       R5 R0 K8 ["flags"]
       23 GETTABLEKS                       R4 R5 K9 ["getFFlagFixPackageIDFieldName"]
       25 CALL                             R3 1 1
       26 NEWTABLE                         R4 4 0
       ...
       36 DUPCLOSURE                       R10 K15 [PROTO_5]
       37 CAPTURE                          VAL R8
       38 DUPCLOSURE                       R11 K16 [PROTO_6]
       39 CAPTURE                          VAL R1
       40 CAPTURE                          VAL R2
       41 CAPTURE                          VAL R10
       42 DUPCLOSURE                       R12 K17 [PROTO_7]
       43 CAPTURE                          VAL R8
       44 SETTABLEKS                       R12 R4 K18 ["tryGetAssetIdFromContentId"]
       46 DUPCLOSURE                       R12 K19 [PROTO_8]
       47 CAPTURE                          VAL R11
       48 SETTABLEKS                       R12 R4 K20 ["parseWithErrorCheck"]
       50 DUPCLOSURE                       R12 K21 [PROTO_9]
       51 CAPTURE                          VAL R11
       52 SETTABLEKS                       R12 R4 K22 ["parse"]
       54 RETURN                           R4 1
