PROTO_0:
      ...
      236 GETUPVAL                         R15 8
      237 CALL                             R15 0 1
      238 JUMPIFEQKS                       R15 K28 [""] ; [+27]
      240 LOADNIL                          R15
      241 GETUPVAL                         R16 9
      242 CALL                             R16 0 1
      243 JUMPIFNOT                        R16 ; [+8]
      244 GETIMPORT                        R16 K31 [string.format]
      246 LOADK                            R17 K32 ["[Caging best practices](%s)"]
      247 GETUPVAL                         R18 8
      248 CALL                             R18 0 -1
      249 CALL                             R16 -1 1
      250 MOVE                             R15 R16
      251 JUMP                             ; [+7]
      252 GETIMPORT                        R16 K31 [string.format]
      254 LOADK                            R17 K33 ["To better understand caging requirements, please visit %s"]
      255 GETUPVAL                         R18 8
      256 CALL                             R18 0 -1
      257 CALL                             R16 -1 1
      258 MOVE                             R15 R16
      259 FASTCALL2                        TABLE_INSERT R4 R15 ; [+5]
      261 MOVE                             R17 R4
      262 MOVE                             R18 R15
      263 GETIMPORT                        R16 K13 [table.insert]
      265 CALL                             R16 2 0
      266 LOADB                            R15 0
      267 MOVE                             R16 R4
      268 RETURN                           R15 2
...
MAIN:
       ...
       25 GETTABLEKS                       R4 R5 K9 ["getFFlagUGCValidationHyperlinksInCageQuality"]
       27 CALL                             R3 1 1
       28 GETIMPORT                        R4 K4 [require]
       30 GETTABLEKS                       R6 R0 K7 ["flags"]
       32 GETTABLEKS                       R5 R6 K10 ["getFFlagUGCValidationEyebrowEyelashSupport"]
       34 CALL                             R4 1 1
       35 GETIMPORT                        R5 K4 [require]
       37 GETTABLEKS                       R7 R0 K5 ["validation"]
       39 GETTABLEKS                       R6 R7 K11 ["validateVerticesSimilarity"]
       41 CALL                             R5 1 1
       42 GETIMPORT                        R6 K4 [require]
       44 GETTABLEKS                       R8 R0 K5 ["validation"]
       46 GETTABLEKS                       R7 R8 K12 ["validateLCCagingRelevancy"]
       48 CALL                             R6 1 1
       49 GETIMPORT                        R7 K4 [require]
       51 GETTABLEKS                       R9 R0 K5 ["validation"]
       53 GETTABLEKS                       R8 R9 K13 ["validateRenderMeshInsideOuterCageMesh"]
       55 CALL                             R7 1 1
       56 GETIMPORT                        R8 K4 [require]
       58 GETTABLEKS                       R10 R0 K5 ["validation"]
       60 GETTABLEKS                       R9 R10 K14 ["validateCageMeshDistance"]
       62 CALL                             R8 1 1
       63 GETIMPORT                        R9 K4 [require]
       65 GETTABLEKS                       R11 R0 K5 ["validation"]
       67 GETTABLEKS                       R10 R11 K15 ["validateCageUVDuplicates"]
       69 CALL                             R9 1 1
       70 GETIMPORT                        R10 K4 [require]
       72 GETTABLEKS                       R12 R0 K5 ["validation"]
       74 GETTABLEKS                       R11 R12 K16 ["ValidateModifiedCageArea"]
       76 CALL                             R10 1 1
       77 GETIMPORT                        R11 K4 [require]
       79 GETTABLEKS                       R13 R0 K17 ["util"]
       81 GETTABLEKS                       R12 R13 K18 ["Types"]
       83 CALL                             R11 1 1
