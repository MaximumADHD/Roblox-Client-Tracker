...
PROTO_1:
  ...
  LOADK R4 K3 ["Received a non-table as the second argument for instanceof"]
  ...
  DUPTABLE R4 K9 [{"tbl"}]
  LOADB R5 1
  SETTABLEKS R5 R4 K8 ["tbl"]
  JUMPIFNOT R0 [+42]
  FASTCALL1 TYPEOF R0 [+3]
  MOVE R6 R0
  GETIMPORT R5 K1 [typeof]
  CALL R5 1 1
  JUMPIFNOTEQKS R5 K2 ["table"] [+36]
  FASTCALL1 GETMETATABLE R0 [+3]
  MOVE R6 R0
  GETIMPORT R5 K11 [getmetatable]
  CALL R5 1 1
  MOVE R0 R5
  FASTCALL1 TYPEOF R0 [+3]
  MOVE R6 R0
