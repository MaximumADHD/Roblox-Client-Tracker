...
PROTO_1:
       ...
       50 FORGLOOP                         R11 2 ; [-8]
       52 DUPTABLE                         R11 K11 [{["Sanitized"] = 0}]
       53 NEWTABLE                         R12 0 0
       55 MOVE                             R13 R0
       56 LOADNIL                          R14
       57 LOADNIL                          R15
       58 FORGPREP                         R13
       59 GETTABLEKS                       R18 R5 K12 ["OnProgress"]
       61 MOVE                             R19 R17
       62 CALL                             R18 1 0
       63 GETTABLE                         R18 R9 R17
       64 JUMPIF                           R18 ; [+29]
       65 GETTABLE                         R18 R1 R16
       66 GETTABLE                         R19 R2 R16
       67 GETTABLE                         R20 R3 R16
       68 GETUPVAL                         R21 3
       69 MOVE                             R22 R17
       70 MOVE                             R23 R18
       71 MOVE                             R24 R19
       72 MOVE                             R25 R20
       73 GETTABLEKS                       R26 R5 K13 ["UseAnimationInstance"]
       75 CALL                             R21 5 1
       76 JUMPIF                           R21 ; [+4]
       77 LOADB                            R7 0
       78 LOADK                            R22 K14 ["Failed to get asset instances"]
       79 SETTABLE                         R22 R8 R17
       80 JUMP                             ; [+13]
       81 GETUPVAL                         R22 4
       82 MOVE                             R23 R21
       83 MOVE                             R24 R17
       ...
       87 CALL                             R22 5 0
       88 GETUPVAL                         R22 2
       89 GETTABLEKS                       R22 R22 K15 ["append"]
       91 MOVE                             R23 R12
       92 MOVE                             R24 R21
       93 CALL                             R22 2 0
       94 FORGLOOP                         R13 2 ; [-36]
       96 GETUPVAL                         R13 5
       97 CALL                             R13 0 1
       98 JUMPIFNOT                        R13 ; [+11]
       99 MOVE                             R13 R12
      ...
      103 GETUPVAL                         R18 6
      104 MOVE                             R19 R17
      105 GETTABLEKS                       R20 R5 K16 ["Parent"]
      107 CALL                             R18 2 0
      108 FORGLOOP                         R13 2 ; [-6]
      110 GETTABLEKS                       R13 R5 K17 ["SkipCameraMove"]
      112 JUMPIF                           R13 ; [+24]
      113 LENGTH                           R13 R12
      114 JUMPIFEQKN                       R13 K6 [0] ; [+22]
      116 GETUPVAL                         R13 7
      117 MOVE                             R15 R12
      118 NAMECALL                         R13 R13 K18 ["Set"]
      120 CALL                             R13 2 0
      121 GETUPVAL                         R13 8
      122 LOADK                            R15 K19 ["Insert assets"]
      123 NAMECALL                         R13 R13 K20 ["SetWaypoint"]
      125 CALL                             R13 2 0
      126 GETIMPORT                        R13 K22 [game]
      128 GETTABLEKS                       R13 R13 K23 ["Workspace"]
      130 GETTABLEKS                       R13 R13 K24 ["CurrentCamera"]
      132 JUMPIFNOT                        R13 ; [+4]
      133 GETUPVAL                         R14 9
      134 MOVE                             R15 R13
      135 MOVE                             R16 R12
      136 CALL                             R14 2 0
      137 DUPTABLE                         R13 K29 [{"Success", "Instances", "Errors", "Analytics"}]
      138 SETTABLEKS                       R7 R13 K25 ["Success"]
      140 SETTABLEKS                       R12 R13 K26 ["Instances"]
      142 SETTABLEKS                       R8 R13 K27 ["Errors"]
      144 SETTABLEKS                       R11 R13 K28 ["Analytics"]
      146 RETURN                           R13 1
