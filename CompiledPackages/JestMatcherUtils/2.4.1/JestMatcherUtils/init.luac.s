PROTO_0:
        0 GETUPVAL                         R0 1
        1 GETUPVAL                         R1 2
        2 DUPTABLE                         R2 K3 [{"maxDepth", "min", "plugins"}]
        3 GETUPVAL                         R3 3
        4 SETTABLEKS                       R3 R2 K0 ["maxDepth"]
        6 LOADB                            R3 1
        7 SETTABLEKS                       R3 R2 K1 ["min"]
        9 GETUPVAL                         R3 4
       10 SETTABLEKS                       R3 R2 K2 ["plugins"]
       12 CALL                             R0 2 1
       13 SETUPVAL                         R0 0
       14 RETURN                           R0 0
...
PROTO_1:
       ...
       20 GETUPVAL                         R4 1
       21 MOVE                             R5 R0
       22 DUPTABLE                         R6 K9 [{"callToJSON", "maxDepth", "min", "plugins"}]
       23 LOADB                            R7 0
       24 SETTABLEKS                       R7 R6 K5 ["callToJSON"]
       26 SETTABLEKS                       R1 R6 K6 ["maxDepth"]
       28 LOADB                            R7 1
       29 SETTABLEKS                       R7 R6 K7 ["min"]
       31 GETUPVAL                         R7 2
       32 SETTABLEKS                       R7 R6 K8 ["plugins"]
       34 CALL                             R4 2 1
       35 MOVE                             R2 R4
       36 LENGTH                           R4 R2
       37 LOADN                            R5 16
       38 JUMPIFNOTLE                      R5 R4 ; [+15]
       40 LOADN                            R4 1
       41 JUMPIFNOTLT                      R4 R1 ; [+12]
       43 JUMPIFNOT                        R1 ; [+10]
       44 GETUPVAL                         R4 3
       45 MOVE                             R5 R0
       46 DIVK                             R7 R1 K10 [2]
       47 FASTCALL1                        MATH_FLOOR R7 ; [+2]
       48 GETIMPORT                        R6 K13 [math.floor]
       50 CALL                             R6 1 1
       51 CALL                             R4 2 -1
       52 CLOSEUPVALS                      R0
       53 RETURN                           R4 -1
...
PROTO_18:
       ...
       50 GETUPVAL                         R9 1
       51 GETTABLEKS                       R9 R9 K15 ["bgYellow"]
       53 SETTABLEKS                       R9 R8 K9 ["changeLineTrailingSpaceColor"]
       55 GETUPVAL                         R9 1
       56 GETTABLEKS                       R9 R9 K15 ["bgYellow"]
