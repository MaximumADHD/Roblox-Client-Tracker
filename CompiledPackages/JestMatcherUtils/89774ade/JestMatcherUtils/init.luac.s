PROTO_0:
        0 GETUPVAL                         R0 1
        1 GETUPVAL                         R1 2
        2 DUPTABLE                         R2 K4 [{[1], ["min"] = True, ["plugins"]}]
        3 GETUPVAL                         R3 3
        4 SETTABLEKS                       R3 R2 K0 ["maxDepth"]
        6 GETUPVAL                         R3 4
        7 SETTABLEKS                       R3 R2 K3 ["plugins"]
        9 CALL                             R0 2 1
       10 SETUPVAL                         R0 0
       11 RETURN                           R0 0
...
PROTO_1:
       ...
       20 GETUPVAL                         R4 1
       21 MOVE                             R5 R0
       22 DUPTABLE                         R6 K11 [{["callToJSON"] = False, ["maxDepth"], ["min"] = True, ["plugins"]}]
       23 SETTABLEKS                       R1 R6 K7 ["maxDepth"]
       25 GETUPVAL                         R7 2
       26 SETTABLEKS                       R7 R6 K10 ["plugins"]
       28 CALL                             R4 2 1
       29 MOVE                             R2 R4
       30 LENGTH                           R4 R2
       31 LOADN                            R5 10000
       32 JUMPIFNOTLE                      R5 R4 ; [+15]
       34 LOADN                            R4 1
       35 JUMPIFNOTLT                      R4 R1 ; [+12]
       37 JUMPIFNOT                        R1 ; [+10]
       38 GETUPVAL                         R4 3
       39 MOVE                             R5 R0
       40 DIVK                             R7 R1 K12 [2]
       41 FASTCALL1                        MATH_FLOOR R7 ; [+2]
       42 GETIMPORT                        R6 K15 [math.floor]
       44 CALL                             R6 1 1
       45 CALL                             R4 2 -1
       46 CLOSEUPVALS                      R0
       47 RETURN                           R4 -1
