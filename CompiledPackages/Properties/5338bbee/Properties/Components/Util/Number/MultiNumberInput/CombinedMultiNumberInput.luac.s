...
MAIN:
       ...
       22 GETTABLEKS                       R4 R4 K10 ["Number"]
       24 GETTABLEKS                       R4 R4 K11 ["MultiNumberInput"]
       26 GETTABLEKS                       R4 R4 K12 ["NumberPartInput"]
       28 CALL                             R3 1 1
       29 GETIMPORT                        R4 K6 [require]
       31 GETTABLEKS                       R5 R0 K13 ["PropertyEditorTypes"]
       33 CALL                             R4 1 1
       34 GETIMPORT                        R5 K6 [require]
       36 GETTABLEKS                       R6 R1 K14 ["React"]
       38 CALL                             R5 1 1
       39 GETIMPORT                        R6 K6 [require]
       41 GETTABLEKS                       R7 R1 K15 ["SignalsReact"]
       43 CALL                             R6 1 1
       44 GETIMPORT                        R7 K6 [require]
       46 GETTABLEKS                       R8 R0 K9 ["Util"]
       48 GETTABLEKS                       R8 R8 K16 ["NumberDisplay"]
       50 GETTABLEKS                       R8 R8 K17 ["Parsing"]
       52 GETTABLEKS                       R8 R8 K18 ["MultiInput"]
       54 GETTABLEKS                       R8 R8 K19 ["anyValidNumbers"]
       56 CALL                             R7 1 1
       57 GETIMPORT                        R8 K6 [require]
       59 GETTABLEKS                       R9 R0 K9 ["Util"]
       61 GETTABLEKS                       R9 R9 K16 ["NumberDisplay"]
       63 GETTABLEKS                       R9 R9 K20 ["Formatting"]
       65 GETTABLEKS                       R9 R9 K21 ["formatForMultiInput"]
       67 CALL                             R8 1 1
       68 GETIMPORT                        R9 K6 [require]
       70 GETTABLEKS                       R10 R0 K9 ["Util"]
       72 GETTABLEKS                       R10 R10 K16 ["NumberDisplay"]
       74 GETTABLEKS                       R10 R10 K17 ["Parsing"]
       76 GETTABLEKS                       R10 R10 K18 ["MultiInput"]
       78 GETTABLEKS                       R10 R10 K22 ["stringsFromMultiInputString"]
       80 CALL                             R9 1 1
       81 GETTABLEKS                       R10 R5 K23 ["createElement"]
       83 DUPCLOSURE                       R11 K24 [PROTO_0]
       84 CAPTURE                          VAL R8
       85 DUPCLOSURE                       R12 K25 [PROTO_5]
       86 CAPTURE                          VAL R6
       87 CAPTURE                          VAL R5
       88 CAPTURE                          VAL R9
       89 CAPTURE                          VAL R7
