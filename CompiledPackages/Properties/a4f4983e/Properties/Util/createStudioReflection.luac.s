...
PROTO_4:
       ...
       68 JUMPIF                           R1 ; [+4]
       69 GETTABLEKS                       R4 R0 K15 ["Owner"]
       71 MOVE                             R5 R3
       72 MOVE                             R1 R3
       73 DUPTABLE                         R4 K29 [{"name", "owner", "assetType", "enumName", "instanceRefType", "readonly", "type", "category"}]
       74 GETTABLEKS                       R5 R0 K12 ["Name"]
       76 SETTABLEKS                       R5 R4 K21 ["name"]
       78 GETTABLEKS                       R5 R0 K15 ["Owner"]
       80 SETTABLEKS                       R5 R4 K22 ["owner"]
       82 GETTABLEKS                       R5 R0 K30 ["ContentType"]
       84 SETTABLEKS                       R5 R4 K23 ["assetType"]
       86 GETTABLEKS                       R6 R0 K4 ["Type"]
       88 GETTABLEKS                       R5 R6 K31 ["EnumType"]
       90 SETTABLEKS                       R5 R4 K24 ["enumName"]
       92 GETTABLEKS                       R6 R0 K4 ["Type"]
       94 GETTABLEKS                       R5 R6 K32 ["InstanceType"]
       96 SETTABLEKS                       R5 R4 K25 ["instanceRefType"]
       98 GETTABLEKS                       R7 R0 K2 ["Permits"]
      100 GETTABLEKS                       R6 R7 K33 ["Write"]
      102 NOT                              R5 R6
      103 SETTABLEKS                       R5 R4 K26 ["readonly"]
      105 SETTABLEKS                       R1 R4 K27 ["type"]
      107 GETTABLEKS                       R6 R0 K0 ["Display"]
      109 GETTABLEKS                       R5 R6 K34 ["Category"]
      111 SETTABLEKS                       R5 R4 K28 ["category"]
      113 GETUPVAL                         R5 2
      114 MOVE                             R6 R4
      115 CALL                             R5 1 1
      116 JUMPIF                           R5 ; [+2]
...
MAIN:
       ...
       68 DUPCLOSURE                       R14 K29 [PROTO_4]
       69 CAPTURE                          VAL R11
       70 CAPTURE                          VAL R10
       71 CAPTURE                          VAL R3
       72 DUPCLOSURE                       R15 K30 [PROTO_5]
       73 CAPTURE                          VAL R5
       74 CAPTURE                          VAL R7
       75 DUPCLOSURE                       R16 K31 [PROTO_6]
       76 CAPTURE                          VAL R5
       77 CAPTURE                          VAL R7
       78 NEWTABLE                         R17 0 0
       80 DUPCLOSURE                       R18 K32 [PROTO_7]
       81 CAPTURE                          VAL R17
       82 CAPTURE                          VAL R5
       83 CAPTURE                          VAL R7
       84 DUPCLOSURE                       R19 K33 [PROTO_8]
       85 CAPTURE                          VAL R8
       86 CAPTURE                          VAL R5
       87 CAPTURE                          VAL R7
       88 CAPTURE                          VAL R4
       89 CAPTURE                          VAL R14
       90 DUPCLOSURE                       R20 K34 [PROTO_9]
       91 CAPTURE                          VAL R18
       92 CAPTURE                          VAL R19
       93 RETURN                           R20 1
