PROTO_0:
        ...
        3 GETUPVAL                         R2 1
        4 GETTABLEKS                       R1 R2 K1 ["shareAccessToAssetsAsync"]
        6 NEWTABLE                         R2 0 1
        8 MOVE                             R3 R0
        9 SETLIST                          R2 R3 1 [1]
       11 CALL                             R1 1 2
       12 JUMPIFNOT                        R1 ; [+6]
       13 GETUPVAL                         R4 1
       14 GETTABLEKS                       R3 R4 K2 ["onAssetSelected"]
       16 GETUPVAL                         R4 0
       17 CALL                             R3 1 0
       18 RETURN                           R0 0
       ...
       25 GETUPVAL                         R10 0
       26 GETTABLEKS                       R9 R10 K7 ["assetType"]
...
PROTO_1:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R1 R2 K0 ["gameId"]
        3 JUMPIFNOTEQKN                    R1 K1 [0] ; [+7]
        5 GETUPVAL                         R2 0
        6 GETTABLEKS                       R1 R2 K2 ["onAssetSelected"]
        8 MOVE                             R2 R0
        9 CALL                             R1 1 0
       10 RETURN                           R0 0
...
MAIN:
       ...
       22 GETTABLEKS                       R7 R1 K9 ["Resources"]
       24 GETTABLEKS                       R6 R7 K10 ["Localization"]
       26 GETTABLEKS                       R5 R6 K11 ["Translator"]
       28 CALL                             R4 1 1
