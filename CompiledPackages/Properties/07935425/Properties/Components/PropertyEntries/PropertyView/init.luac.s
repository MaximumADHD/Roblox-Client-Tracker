...
PROTO_6:
        ...
        4 GETUPVAL                         R3 1
        5 GETTABLEKS                       R3 R3 K1 ["useCallback"]
        7 NEWCLOSURE                       R4 P0
        8 CAPTURE                          VAL R2
        9 CAPTURE                          VAL R0
       10 NEWTABLE                         R5 0 2
       ...
       45 CALL                             R5 2 1
       46 GETTABLEKS                       R6 R0 K2 ["getProperty"]
       48 CALL                             R6 0 1
       49 GETTABLEKS                       R6 R6 K3 ["aggregatePropertyInfo"]
       51 GETTABLEKS                       R6 R6 K4 ["type"]
       53 GETUPVAL                         R7 1
       54 GETTABLEKS                       R7 R7 K5 ["useMemo"]
       56 NEWCLOSURE                       R8 P3
       57 CAPTURE                          UPVAL U2
       58 CAPTURE                          VAL R6
       59 NEWTABLE                         R9 0 1
       ...
       64 CALL                             R7 2 1
       65 GETUPVAL                         R8 3
       66 GETTABLEKS                       R8 R8 K6 ["createComputed"]
       68 NEWCLOSURE                       R9 P4
       69 CAPTURE                          VAL R0
       70 CALL                             R8 1 1
       71 GETUPVAL                         R9 1
       ...
       96 GETUPVAL                         R13 1
       97 GETTABLEKS                       R13 R13 K7 ["createElement"]
       99 MOVE                             R14 R7
      ...
      128 GETUPVAL                         R13 1
      129 GETTABLEKS                       R13 R13 K7 ["createElement"]
      131 LOADK                            R14 K29 ["UISizeConstraint"]
      132 DUPTABLE                         R15 K31 [{"MinSize"}]
      133 GETIMPORT                        R16 K34 [Vector2.new]
      135 LOADN                            R17 0
      136 GETTABLEKS                       R18 R1 K11 ["Size"]
      138 GETTABLEKS                       R18 R18 K35 ["Size_600"]
      140 CALL                             R16 2 1
...
MAIN:
       ...
       43 GETTABLEKS                       R9 R9 K13 ["getPropertyView"]
       45 CALL                             R8 1 1
       46 GETTABLEKS                       R9 R2 K14 ["View"]
       48 GETTABLEKS                       R10 R2 K15 ["Hooks"]
       50 GETTABLEKS                       R10 R10 K16 ["useTokens"]
