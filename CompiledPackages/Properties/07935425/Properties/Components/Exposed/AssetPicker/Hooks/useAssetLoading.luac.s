...
PROTO_5:
        ...
        3 GETTABLEKS                       R0 R0 K1 ["fetchAssetsByScopeAsync"]
        5 DUPTABLE                         R1 K7 [{"assetType", "scopeId", "scopeType", "search", "pageToken"}]
        6 GETUPVAL                         R2 1
        7 GETTABLEKS                       R2 R2 K2 ["assetType"]
        9 SETTABLEKS                       R2 R1 K2 ["assetType"]
       11 GETUPVAL                         R2 1
       12 GETTABLEKS                       R2 R2 K8 ["scope"]
       14 GETTABLEKS                       R2 R2 K9 ["id"]
       16 SETTABLEKS                       R2 R1 K3 ["scopeId"]
       18 GETUPVAL                         R2 1
       19 GETTABLEKS                       R2 R2 K8 ["scope"]
       21 GETTABLEKS                       R2 R2 K10 ["type"]
       23 SETTABLEKS                       R2 R1 K4 ["scopeType"]
       25 GETUPVAL                         R2 1
       26 GETTABLEKS                       R2 R2 K5 ["search"]
       ...
       34 GETUPVAL                         R2 3
       35 GETUPVAL                         R3 4
       36 GETTABLEKS                       R3 R3 K11 ["current"]
       38 JUMPIFEQ                         R2 R3 ; [+2]
       40 RETURN                           R0 0
       41 GETUPVAL                         R3 1
       42 GETUPVAL                         R4 2
       ...
       52 JUMPIFNOT                        R2 ; [+13]
       53 GETUPVAL                         R2 5
       54 GETTABLEKS                       R2 R2 K13 ["setAssets"]
       56 GETUPVAL                         R3 1
       57 GETTABLEKS                       R3 R3 K8 ["scope"]
       59 GETTABLEKS                       R3 R3 K14 ["uniqueId"]
       61 GETUPVAL                         R4 1
       62 GETTABLEKS                       R4 R4 K2 ["assetType"]
       64 MOVE                             R5 R0
       65 CALL                             R2 3 0
       66 GETUPVAL                         R2 6
...
PROTO_13:
       ...
       76 CALL                             R8 2 1
       77 GETUPVAL                         R9 0
       78 GETTABLEKS                       R9 R9 K10 ["useCallback"]
       ...
       89 CALL                             R9 2 1
       90 GETUPVAL                         R10 0
       91 GETTABLEKS                       R10 R10 K12 ["useEffect"]
      ...
      103 CALL                             R10 2 0
      104 GETUPVAL                         R10 0
      105 GETTABLEKS                       R10 R10 K12 ["useEffect"]
...
MAIN:
       ...
       50 GETTABLEKS                       R9 R9 K15 ["sortAssets"]
       52 CALL                             R8 1 1
