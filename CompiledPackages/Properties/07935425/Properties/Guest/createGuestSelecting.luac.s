...
PROTO_2:
       ...
       54 CALL                             R3 2 0
       55 GETUPVAL                         R3 0
       56 GETTABLEKS                       R3 R3 K7 ["stopAggregating"]
       58 CALL                             R3 0 0
       59 RETURN                           R0 0
...
PROTO_3:
       ...
       17 FORGPREP                         R6
       18 GETUPVAL                         R11 0
       19 GETTABLEKS                       R11 R11 K3 ["catalogProperty"]
       21 MOVE                             R12 R5
       22 MOVE                             R13 R9
       23 CALL                             R11 2 0
       24 GETUPVAL                         R11 4
       ...
       32 GETUPVAL                         R13 5
       33 GETUPVAL                         R14 0
       34 GETTABLEKS                       R14 R14 K4 ["listenToParts"]
       36 MOVE                             R15 R5
       37 MOVE                             R16 R9
       ...
       48 FORGPREP                         R6
       49 GETUPVAL                         R11 0
       50 GETTABLEKS                       R11 R11 K3 ["catalogProperty"]
       52 MOVE                             R12 R5
       53 GETUPVAL                         R13 7
       54 GETTABLEKS                       R13 R13 K6 ["fromAttribute"]
       56 MOVE                             R14 R9
       57 CALL                             R13 1 -1
       58 CALL                             R11 -1 0
       59 FORGLOOP                         R6 2 ; [-11]
       ...
       64 FORGPREP                         R6
       65 GETUPVAL                         R11 0
       66 GETTABLEKS                       R11 R11 K3 ["catalogProperty"]
       68 MOVE                             R12 R5
       69 GETUPVAL                         R13 7
       70 GETTABLEKS                       R13 R13 K8 ["fromTag"]
       72 MOVE                             R14 R10
       73 CALL                             R13 1 -1
       74 CALL                             R11 -1 0
       75 FORGLOOP                         R6 2 ; [-11]
       77 FORGLOOP                         R1 2 ; [-66]
       79 GETUPVAL                         R1 0
       80 GETTABLEKS                       R1 R1 K9 ["getCataloggedProperties"]
       82 CALL                             R1 0 1
       83 GETUPVAL                         R2 0
       84 GETTABLEKS                       R2 R2 K10 ["getCataloggedInfos"]
       86 CALL                             R2 0 1
       ...
       94 GETUPVAL                         R4 8
       95 GETTABLEKS                       R4 R4 K14 ["showProperties"]
       97 MOVE                             R5 R1
       98 MOVE                             R6 R2
       99 MOVE                             R7 R3
      100 CALL                             R4 3 0
      ...
      105 SETUPVAL                         R4 9
      106 GETUPVAL                         R4 0
      107 GETTABLEKS                       R4 R4 K18 ["stopAggregating"]
      109 CALL                             R4 0 0
      110 RETURN                           R0 0
...
PROTO_14:
       ...
       36 CALL                             R0 1 0
       37 GETUPVAL                         R0 6
       38 GETTABLEKS                       R0 R0 K2 ["isAggregating"]
       40 CALL                             R0 0 1
       41 JUMPIFNOT                        R0 ; [+4]
       42 GETUPVAL                         R0 6
       43 GETTABLEKS                       R0 R0 K3 ["stopAggregating"]
       45 CALL                             R0 0 0
       46 GETUPVAL                         R0 7
       47 CALL                             R0 0 0
       48 RETURN                           R0 0
...
PROTO_15:
        ...
        7 CALL                             R0 1 0
        8 GETUPVAL                         R0 2
        9 GETTABLEKS                       R0 R0 K1 ["isAggregating"]
       11 CALL                             R0 0 1
       12 JUMPIFNOT                        R0 ; [+4]
       13 GETUPVAL                         R0 2
       14 GETTABLEKS                       R0 R0 K2 ["stopAggregating"]
       16 CALL                             R0 0 0
       17 GETUPVAL                         R0 3
...
MAIN:
       ...
       11 GETTABLEKS                       R2 R2 K7 ["PropertyId"]
       13 CALL                             R1 1 1
       ...
       33 GETTABLEKS                       R6 R0 K6 ["PropertyInteraction"]
       35 GETTABLEKS                       R6 R6 K11 ["hasProperty"]
       37 CALL                             R5 1 1
       38 GETIMPORT                        R6 K5 [require]
       40 GETTABLEKS                       R7 R0 K6 ["PropertyInteraction"]
       42 GETTABLEKS                       R7 R7 K12 ["propertyIdToString"]
       44 CALL                             R6 1 1
       45 DUPCLOSURE                       R7 K13 [PROTO_16]
       46 CAPTURE                          VAL R6
       47 CAPTURE                          VAL R5
       48 CAPTURE                          VAL R4
       49 CAPTURE                          VAL R1
