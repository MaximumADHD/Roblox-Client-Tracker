...
MAIN:
       ...
       20 GETTABLEKS                       R4 R4 K9 ["CombinedMultiNumberInput"]
       22 CALL                             R3 1 1
       23 GETIMPORT                        R4 K6 [require]
       25 GETTABLEKS                       R5 R1 K10 ["Cryo"]
       27 CALL                             R4 1 1
       28 GETIMPORT                        R5 K6 [require]
       30 GETTABLEKS                       R6 R1 K11 ["Foundation"]
       32 CALL                             R5 1 1
       33 GETIMPORT                        R6 K6 [require]
       35 GETIMPORT                        R7 K1 [script]
       37 GETTABLEKS                       R7 R7 K12 ["NumberPartInput"]
       39 CALL                             R6 1 1
       40 GETIMPORT                        R7 K6 [require]
       42 GETTABLEKS                       R8 R0 K13 ["PropertyEditorTypes"]
       44 CALL                             R7 1 1
       45 GETIMPORT                        R8 K6 [require]
       47 GETTABLEKS                       R9 R1 K14 ["React"]
       49 CALL                             R8 1 1
       50 GETIMPORT                        R9 K6 [require]
       52 GETTABLEKS                       R10 R1 K15 ["ReactUtils"]
       54 CALL                             R9 1 1
       55 GETIMPORT                        R10 K6 [require]
       57 GETIMPORT                        R11 K1 [script]
       59 GETTABLEKS                       R11 R11 K16 ["SeparateMultiNumberInput"]
       61 CALL                             R10 1 1
       62 GETIMPORT                        R11 K6 [require]
       64 GETTABLEKS                       R12 R0 K17 ["Hooks"]
       66 GETTABLEKS                       R12 R12 K18 ["useEventConnection"]
       68 CALL                             R11 1 1
       69 GETTABLEKS                       R12 R8 K19 ["createElement"]
       71 DUPCLOSURE                       R13 K20 [PROTO_2]
       72 CAPTURE                          VAL R9
       73 CAPTURE                          VAL R11
       74 CAPTURE                          VAL R8
       75 CAPTURE                          VAL R5
