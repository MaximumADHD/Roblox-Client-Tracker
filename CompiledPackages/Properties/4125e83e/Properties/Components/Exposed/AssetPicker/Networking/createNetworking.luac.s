...
PROTO_1:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R1 R2 K0 ["requestGroupsAsync"]
       ...
       27 JUMP                             ; [+1]
       28 LOADNIL                          R3
       29 GETTABLEKS                       R5 R2 K10 ["responseBody"]
       31 GETTABLEKS                       R4 R5 K11 ["groups"]
       33 NEWTABLE                         R5 0 0
      ...
      112 RETURN                           R5 1
      113 NEWTABLE                         R3 0 0
      115 GETTABLEKS                       R7 R2 K10 ["responseBody"]
      117 GETTABLEKS                       R4 R7 K11 ["groups"]
      119 LOADNIL                          R5
      120 LOADNIL                          R6
      121 FORGPREP                         R4
      122 GETUPVAL                         R9 3
...
PROTO_3:
       ...
       14 GETUPVAL                         R5 1
       15 GETTABLEKS                       R4 R5 K4 ["requestUniverseInfoAsync"]
...
PROTO_7:
       ...
       30 DUPTABLE                         R7 K3 [{"fetchScopesAsync", "fetchAssetsByScopeAsync", "fetchAssetByIdAsync"}]
       31 SETTABLEKS                       R3 R7 K0 ["fetchScopesAsync"]
       33 SETTABLEKS                       R5 R7 K1 ["fetchAssetsByScopeAsync"]
       35 SETTABLEKS                       R6 R7 K2 ["fetchAssetByIdAsync"]
       37 RETURN                           R7 1
...
MAIN:
       ...
       55 GETTABLEKS                       R8 R9 K17 ["getFFlagAssetPickerSmarterGroups"]
       57 CALL                             R7 1 1
       58 GETIMPORT                        R8 K5 [require]
       60 GETTABLEKS                       R10 R0 K14 ["Flags"]
       62 GETTABLEKS                       R9 R10 K18 ["getFIntAssetPickerMaxGroupCount"]
       64 CALL                             R8 1 1
       65 GETIMPORT                        R9 K5 [require]
       67 GETTABLEKS                       R11 R0 K11 ["Util"]
       69 GETTABLEKS                       R10 R11 K19 ["isAnimationAssetType"]
       71 CALL                             R9 1 1
       72 GETIMPORT                        R10 K5 [require]
       74 GETTABLEKS                       R12 R0 K11 ["Util"]
       76 GETTABLEKS                       R11 R12 K20 ["toInternalAssetType"]
       78 CALL                             R10 1 1
       79 GETIMPORT                        R11 K22 [game]
       81 LOADK                            R13 K23 ["AssetPickerMaxPageSize"]
       82 LOADN                            R14 238
       83 NAMECALL                         R11 R11 K24 ["DefineFastInt"]
       85 CALL                             R11 3 1
       86 GETIMPORT                        R12 K22 [game]
       88 LOADK                            R14 K25 ["AssetPickerMinAnimationPageSize"]
       89 LOADN                            R15 20
       90 NAMECALL                         R12 R12 K24 ["DefineFastInt"]
       92 CALL                             R12 3 1
       93 MOVE                             R13 R8
       94 CALL                             R13 0 1
       95 DUPCLOSURE                       R14 K26 [PROTO_0]
       96 CAPTURE                          VAL R4
       97 DUPCLOSURE                       R15 K27 [PROTO_7]
       98 CAPTURE                          VAL R7
       99 CAPTURE                          VAL R4
      100 CAPTURE                          VAL R13
      101 CAPTURE                          VAL R1
