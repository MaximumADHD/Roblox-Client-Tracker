...
PROTO_1:
        0 DUPTABLE                         R0 K3 [{"id", "text", "categorizeProperties"}]
        1 LOADK                            R1 K4 ["General"]
        2 SETTABLEKS                       R1 R0 K0 ["id"]
        4 GETUPVAL                         R1 0
        5 LOADK                            R3 K5 ["Tabs"]
        6 LOADK                            R4 K4 ["General"]
        7 NAMECALL                         R1 R1 K6 ["getText"]
        9 CALL                             R1 3 1
       10 SETTABLEKS                       R1 R0 K1 ["text"]
       12 GETUPVAL                         R2 1
       13 GETTABLEKS                       R1 R2 K4 ["General"]
       15 SETTABLEKS                       R1 R0 K2 ["categorizeProperties"]
       17 DUPTABLE                         R1 K3 [{"id", "text", "categorizeProperties"}]
       18 LOADK                            R2 K7 ["AttributesAndTags"]
       19 SETTABLEKS                       R2 R1 K0 ["id"]
       21 GETUPVAL                         R2 0
       22 LOADK                            R4 K5 ["Tabs"]
       23 LOADK                            R5 K7 ["AttributesAndTags"]
       24 NAMECALL                         R2 R2 K6 ["getText"]
       26 CALL                             R2 3 1
       27 SETTABLEKS                       R2 R1 K1 ["text"]
       29 GETUPVAL                         R3 1
       30 GETTABLEKS                       R2 R3 K7 ["AttributesAndTags"]
       32 SETTABLEKS                       R2 R1 K2 ["categorizeProperties"]
       34 DUPTABLE                         R2 K3 [{"id", "text", "categorizeProperties"}]
       35 LOADK                            R3 K8 ["All"]
       ...
       46 GETUPVAL                         R4 1
       47 GETTABLEKS                       R3 R4 K8 ["All"]
       49 SETTABLEKS                       R3 R2 K2 ["categorizeProperties"]
       51 NEWTABLE                         R3 0 3
       53 MOVE                             R4 R0
       54 MOVE                             R5 R1
       55 MOVE                             R6 R2
       56 SETLIST                          R3 R4 3 [1]
       58 RETURN                           R3 1
