...
PROTO_7:
       ...
       26 LOADK                            R1 K7 ["%*, %*, %*"]
       27 GETUPVAL                         R3 2
       28 NAMECALL                         R3 R3 K8 ["getValue"]
       30 CALL                             R3 1 1
       31 GETUPVAL                         R4 3
       32 NAMECALL                         R4 R4 K8 ["getValue"]
       34 CALL                             R4 1 1
       35 GETUPVAL                         R5 4
       36 NAMECALL                         R5 R5 K8 ["getValue"]
       38 CALL                             R5 1 1
       39 NAMECALL                         R1 R1 K9 ["format"]
       41 CALL                             R1 4 1
       42 SETTABLEKS                       R1 R0 K6 ["Text"]
       44 GETTABLEKS                       R3 R0 K6 ["Text"]
       46 LENGTH                           R2 R3
       47 ADDK                             R1 R2 K10 [1]
       48 SETTABLEKS                       R1 R0 K11 ["CursorPosition"]
       50 LOADN                            R1 1
       51 SETTABLEKS                       R1 R0 K12 ["SelectionStart"]
       53 GETUPVAL                         R1 1
       54 GETTABLEKS                       R1 R1 K13 ["onFocused"]
       56 JUMPIFEQKNIL                     R1 ; [+6]
       58 GETUPVAL                         R1 1
       59 GETTABLEKS                       R1 R1 K13 ["onFocused"]
       61 MOVE                             R2 R0
       62 CALL                             R1 1 0
       63 RETURN                           R0 0
