...
PROTO_4:
       ...
       16 CALL                             R6 2 3
       17 FORGPREP                         R6
       18 GETTABLEKS                       R11 R10 K3 ["patch"]
       20 JUMPIFEQKNIL                     R11 ; [+14]
       22 GETTABLEKS                       R11 R10 K3 ["patch"]
       24 GETTABLEKS                       R11 R11 K4 ["isVisible"]
       26 JUMPIFEQKNIL                     R11 ; [+8]
       28 GETTABLEKS                       R11 R10 K3 ["patch"]
       30 GETTABLEKS                       R11 R11 K4 ["isVisible"]
       32 MOVE                             R12 R5
       33 CALL                             R11 1 1
       34 JUMPIFNOT                        R11 ; [+25]
       35 GETUPVAL                         R11 0
       36 GETTABLEKS                       R11 R11 K5 ["catalogProperty"]
       38 MOVE                             R12 R5
       39 MOVE                             R13 R9
       40 CALL                             R11 2 0
       41 GETUPVAL                         R11 4
       ...
       43 CALL                             R11 1 1
       44 GETUPVAL                         R13 5
       45 GETTABLE                         R12 R13 R11
       46 JUMPIFNOT                        R12 ; [+2]
       47 MOVE                             R13 R12
       48 CALL                             R13 0 0
       49 GETUPVAL                         R13 5
       50 GETUPVAL                         R14 0
       51 GETTABLEKS                       R14 R14 K6 ["listenToParts"]
       53 MOVE                             R15 R5
       54 MOVE                             R16 R9
       55 NEWCLOSURE                       R17 P0
       56 CAPTURE                          UPVAL U6
       57 CAPTURE                          VAL R9
       58 CALL                             R14 3 1
       59 SETTABLE                         R14 R13 R11
       60 FORGLOOP                         R6 2 ; [-43]
       62 NAMECALL                         R6 R5 K7 ["GetAttributes"]
       64 CALL                             R6 1 3
       65 FORGPREP                         R6
       66 GETUPVAL                         R11 0
       67 GETTABLEKS                       R11 R11 K5 ["catalogProperty"]
       69 MOVE                             R12 R5
       70 GETUPVAL                         R13 7
       71 GETTABLEKS                       R13 R13 K8 ["fromAttribute"]
       73 MOVE                             R14 R9
       74 CALL                             R13 1 -1
       75 CALL                             R11 -1 0
       76 FORGLOOP                         R6 2 ; [-11]
       78 NAMECALL                         R6 R5 K9 ["GetTags"]
       80 CALL                             R6 1 3
       81 FORGPREP                         R6
       82 GETUPVAL                         R11 0
       83 GETTABLEKS                       R11 R11 K5 ["catalogProperty"]
       85 MOVE                             R12 R5
       86 GETUPVAL                         R13 7
       87 GETTABLEKS                       R13 R13 K10 ["fromTag"]
       89 MOVE                             R14 R10
       90 CALL                             R13 1 -1
       91 CALL                             R11 -1 0
       92 FORGLOOP                         R6 2 ; [-11]
       94 FORGLOOP                         R1 2 ; [-83]
       96 GETUPVAL                         R1 0
       97 GETTABLEKS                       R1 R1 K11 ["getCataloggedProperties"]
       99 CALL                             R1 0 1
      100 GETUPVAL                         R2 0
      101 GETTABLEKS                       R2 R2 K12 ["getCataloggedInfos"]
      103 CALL                             R2 0 1
      104 DUPTABLE                         R3 K15 [{"processedInstances", "totalInstances"}]
      105 LENGTH                           R4 R0
      106 SETTABLEKS                       R4 R3 K13 ["processedInstances"]
      108 LENGTH                           R4 R0
      109 SETTABLEKS                       R4 R3 K14 ["totalInstances"]
      111 GETUPVAL                         R4 8
      112 GETTABLEKS                       R4 R4 K16 ["showProperties"]
      114 MOVE                             R5 R1
      115 MOVE                             R6 R2
      116 MOVE                             R7 R3
      117 CALL                             R4 3 0
      ...
      138 MOVE                             R13 R10
      139 CALL                             R12 1 1
      140 GETTABLE                         R11 R4 R12
      141 JUMPIF                           R11 ; [+7]
      142 FASTCALL2                        TABLE_INSERT R5 R10 ; [+5]
      144 MOVE                             R12 R5
      145 MOVE                             R13 R10
      146 GETIMPORT                        R11 K19 [table.insert]
      148 CALL                             R11 2 0
      149 FORGLOOP                         R6 2 ; [-13]
      151 LENGTH                           R6 R5
      152 LOADN                            R7 0
      153 JUMPIFNOTLT                      R7 R6 ; [+6]
      155 GETUPVAL                         R6 8
      156 GETTABLEKS                       R6 R6 K20 ["hideProperties"]
      158 MOVE                             R7 R5
      159 CALL                             R6 1 0
      160 GETIMPORT                        R6 K22 [table.clone]
      162 MOVE                             R7 R1
      163 CALL                             R6 1 1
      164 SETUPVAL                         R6 9
      165 GETUPVAL                         R6 0
      166 GETTABLEKS                       R6 R6 K23 ["stopAggregating"]
      168 CALL                             R6 0 0
      169 RETURN                           R0 0
...
PROTO_20:
       ...
       58 CAPTURE                          VAL R3
       59 CAPTURE                          VAL R10
       60 GETTABLEKS                       R16 R1 K0 ["SelectionChanged"]
       62 MOVE                             R18 R15
       63 NAMECALL                         R16 R16 K1 ["Connect"]
       65 CALL                             R16 2 1
       66 GETIMPORT                        R17 K4 [task.defer]
       68 MOVE                             R18 R15
       69 CALL                             R17 1 0
       70 NEWCLOSURE                       R17 P8
       71 CAPTURE                          VAL R0
       72 CAPTURE                          REF R4
       73 CAPTURE                          VAL R3
       74 CAPTURE                          VAL R16
       75 DUPTABLE                         R18 K6 [{"destroy"}]
       76 SETTABLEKS                       R17 R18 K5 ["destroy"]
       78 CLOSEUPVALS                      R4
       79 RETURN                           R18 1
