...
PROTO_1:
        ...
        3 LENGTH                           R2 R3
        4 JUMPIFNOTLT                      R2 R0 ; [+13]
        6 GETIMPORT                        R2 K2 [error]
        8 LOADK                            R3 K3 ["called with out of bounds index %* on unorderedKeypoints of length %*"]
        9 MOVE                             R5 R0
       10 GETUPVAL                         R7 0
       11 GETTABLEKS                       R7 R7 K0 ["unorderedKeypoints"]
       13 LENGTH                           R6 R7
       14 NAMECALL                         R3 R3 K4 ["format"]
       16 CALL                             R3 3 1
       17 CALL                             R2 1 0
       18 GETUPVAL                         R3 0
       19 GETTABLEKS                       R3 R3 K0 ["unorderedKeypoints"]
       21 GETTABLE                         R2 R3 R0
       22 GETUPVAL                         R3 1
       23 GETTABLEKS                       R3 R3 K5 ["updateKeypoint"]
       25 MOVE                             R4 R0
       26 MOVE                             R5 R1
       27 MOVE                             R6 R2
       28 CALL                             R5 1 -1
...
PROTO_21:
       ...
       15 GETUPVAL                         R8 4
       16 NEWTABLE                         R9 0 1
       18 GETTABLEKS                       R10 R0 K3 ["unorderedKeypoints"]
       20 SETLIST                          R9 R10 1 [1]
       22 CALL                             R6 3 1
       23 GETUPVAL                         R7 5
       24 GETTABLEKS                       R7 R7 K4 ["useEventCallback"]
       26 NEWCLOSURE                       R8 P1
       27 CAPTURE                          VAL R0
       28 CAPTURE                          VAL R1
       29 CALL                             R7 1 1
       30 GETUPVAL                         R8 5
       31 GETTABLEKS                       R8 R8 K4 ["useEventCallback"]
       33 NEWCLOSURE                       R9 P2
       34 CAPTURE                          VAL R7
       35 CAPTURE                          VAL R6
       36 CAPTURE                          VAL R0
       37 CALL                             R8 1 1
       38 GETUPVAL                         R9 5
       39 GETTABLEKS                       R9 R9 K4 ["useEventCallback"]
       ...
       47 CALL                             R9 1 1
       48 GETUPVAL                         R10 5
       49 GETTABLEKS                       R10 R10 K4 ["useEventCallback"]
       51 NEWCLOSURE                       R11 P4
       52 CAPTURE                          VAL R7
       53 CAPTURE                          UPVAL U3
       54 CAPTURE                          VAL R0
       55 CALL                             R10 1 1
       56 GETUPVAL                         R11 0
       57 GETTABLEKS                       R11 R11 K5 ["useCallback"]
       59 NEWCLOSURE                       R12 P5
       60 CAPTURE                          UPVAL U5
       61 CAPTURE                          VAL R0
       62 CAPTURE                          UPVAL U6
       63 NEWTABLE                         R13 0 1
       65 GETTABLEKS                       R14 R0 K6 ["unorderedKeypointsBinding"]
       67 SETLIST                          R13 R14 1 [1]
       69 CALL                             R11 2 1
       70 GETUPVAL                         R12 0
       71 GETTABLEKS                       R12 R12 K7 ["useMemo"]
       ...
       83 MOVE                             R17 R9
       84 MOVE                             R18 R10
       85 SETLIST                          R14 R15 4 [1]
       87 CALL                             R12 2 1
       88 GETUPVAL                         R13 5
       89 GETTABLEKS                       R13 R13 K4 ["useEventCallback"]
       91 NEWCLOSURE                       R14 P7
       92 CAPTURE                          VAL R1
       93 CAPTURE                          VAL R3
       94 CALL                             R13 1 1
       95 GETUPVAL                         R14 5
       96 GETTABLEKS                       R14 R14 K4 ["useEventCallback"]
       98 NEWCLOSURE                       R15 P8
       99 CAPTURE                          VAL R1
      100 CAPTURE                          VAL R0
      101 CALL                             R14 1 1
      102 GETUPVAL                         R15 5
      103 GETTABLEKS                       R15 R15 K4 ["useEventCallback"]
      105 NEWCLOSURE                       R16 P9
      ...
      110 GETUPVAL                         R16 8
      111 GETUPVAL                         R17 9
      112 DUPTABLE                         R18 K19 [{"rowSlots", "rowsCount", "layoutOrders", "maxRowsBeforeScroll", "autoScrollToSelected", "selectedRow", "setSelectedRow", "onEditStart", "onEditFinish", "onDelete", "onAdd"}]
      113 SETTABLEKS                       R12 R18 K8 ["rowSlots"]
      115 GETTABLEKS                       R20 R0 K3 ["unorderedKeypoints"]
      117 LENGTH                           R19 R20
      118 SETTABLEKS                       R19 R18 K9 ["rowsCount"]
      120 SETTABLEKS                       R6 R18 K10 ["layoutOrders"]
      122 GETTABLEKS                       R19 R5 K20 ["MaxRows"]
      124 SETTABLEKS                       R19 R18 K11 ["maxRowsBeforeScroll"]
      126 GETTABLEKS                       R19 R0 K12 ["autoScrollToSelected"]
      128 SETTABLEKS                       R19 R18 K12 ["autoScrollToSelected"]
      130 GETTABLEKS                       R19 R0 K21 ["selectedUnorderedKeypoint"]
      132 SETTABLEKS                       R19 R18 K13 ["selectedRow"]
      134 GETTABLEKS                       R19 R0 K22 ["SetSelectedUnorderedKeypoint"]
      136 SETTABLEKS                       R19 R18 K14 ["setSelectedRow"]
      138 SETTABLEKS                       R13 R18 K15 ["onEditStart"]
      140 GETTABLEKS                       R19 R1 K23 ["finishEditing"]
      142 SETTABLEKS                       R19 R18 K16 ["onEditFinish"]
      144 SETTABLEKS                       R14 R18 K17 ["onDelete"]
      146 SETTABLEKS                       R15 R18 K18 ["onAdd"]
      148 CALL                             R16 2 -1
      149 RETURN                           R16 -1
...
MAIN:
       ...
       62 GETTABLEKS                       R10 R10 K17 ["shallowEqual"]
       64 CALL                             R9 1 1
       65 GETIMPORT                        R10 K6 [require]
       67 GETTABLEKS                       R11 R0 K18 ["Hooks"]
       69 GETTABLEKS                       R11 R11 K19 ["useMemoConditional"]
       71 CALL                             R10 1 1
       72 GETIMPORT                        R11 K6 [require]
       74 GETIMPORT                        R12 K1 [script]
       76 GETTABLEKS                       R12 R12 K4 ["Parent"]
       78 GETTABLEKS                       R12 R12 K20 ["useNumberSequence"]
       80 CALL                             R11 1 1
       81 GETIMPORT                        R12 K6 [require]
       83 GETTABLEKS                       R13 R0 K18 ["Hooks"]
       85 GETTABLEKS                       R13 R13 K21 ["useVisualValues"]
       87 CALL                             R12 1 1
       88 GETTABLEKS                       R13 R5 K22 ["createElement"]
       90 GETTABLEKS                       R14 R2 K23 ["MAX_POINTS"]
       92 DUPCLOSURE                       R15 K24 [PROTO_21]
       93 CAPTURE                          VAL R5
       94 CAPTURE                          VAL R12
       95 CAPTURE                          VAL R10
       96 CAPTURE                          VAL R3
      ...
      101 CAPTURE                          VAL R13
      102 CAPTURE                          VAL R7
      103 GETTABLEKS                       R16 R5 K25 ["memo"]
      105 MOVE                             R17 R15
      106 CALL                             R16 1 1
      107 MOVE                             R15 R16
      108 RETURN                           R15 1
