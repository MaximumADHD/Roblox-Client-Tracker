PROTO_0:
        0 JUMPIFNOTEQKS                    R0 K0 ["studs"] ; [+12]
        2 LOADK                            R1 K1 [" %*"]
        3 GETUPVAL                         R3 0
        4 LOADK                            R5 K2 ["Unit"]
        5 LOADK                            R6 K3 ["Studs"]
        6 NAMECALL                         R3 R3 K4 ["getText"]
        8 CALL                             R3 3 1
        9 NAMECALL                         R1 R1 K5 ["format"]
       11 CALL                             R1 2 1
       12 RETURN                           R1 1
       13 JUMPIFNOTEQKS                    R0 K6 ["degrees"] ; [+3]
       15 LOADK                            R1 K7 ["°"]
       16 RETURN                           R1 1
       17 JUMPIFNOTEQKS                    R0 K8 ["pixels"] ; [+3]
       19 LOADK                            R1 K9 ["px"]
       20 RETURN                           R1 1
       21 JUMPIFNOTEQKS                    R0 K10 ["seconds"] ; [+12]
       23 LOADK                            R1 K1 [" %*"]
       24 GETUPVAL                         R3 0
       25 LOADK                            R5 K2 ["Unit"]
       26 LOADK                            R6 K11 ["Seconds"]
       27 NAMECALL                         R3 R3 K4 ["getText"]
       29 CALL                             R3 3 1
       30 NAMECALL                         R1 R1 K5 ["format"]
       32 CALL                             R1 2 1
       33 RETURN                           R1 1
       34 JUMPIFNOTEQKS                    R0 K12 ["percent_0-1"] ; [+3]
       36 LOADK                            R1 K13 ["%"]
       37 RETURN                           R1 1
       38 GETUPVAL                         R1 1
       39 MOVE                             R2 R0
