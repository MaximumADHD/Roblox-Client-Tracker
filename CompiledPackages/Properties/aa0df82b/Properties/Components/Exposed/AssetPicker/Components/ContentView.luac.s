...
PROTO_1:
       ...
       84 LENGTH                           R5 R6
       85 JUMPIFNOTEQKN                    R5 K26 [0] ; [+6]
       87 GETUPVAL                         R4 3
       88 GETUPVAL                         R5 5
       89 DUPTABLE                         R6 K31 [{["tag"] = "size-full-full text-body-small text-align-x-center text-align-y-center", ["Text"] = "No results found"}]
       90 CALL                             R4 2 1
       91 RETURN                           R4 1
       92 GETUPVAL                         R4 3
       93 GETUPVAL                         R5 6
       94 DUPTABLE                         R6 K35 [{"assetItems", "onAssetSelected", "onCanvasPositionChanged"}]
       95 GETTABLEKS                       R7 R1 K7 ["loadedAssets"]
       97 SETTABLEKS                       R7 R6 K32 ["assetItems"]
       99 GETTABLEKS                       R7 R0 K33 ["onAssetSelected"]
      101 SETTABLEKS                       R7 R6 K33 ["onAssetSelected"]
      103 SETTABLEKS                       R2 R6 K34 ["onCanvasPositionChanged"]
      105 CALL                             R4 2 1
      106 RETURN                           R4 1
