...
PROTO_2:
        ...
        3 GETUPVAL                         R2 1
        4 GETTABLEKS                       R1 R2 K1 ["getGameIdAsync"]
        6 CALL                             R1 0 1
        7 GETUPVAL                         R4 1
        8 GETTABLEKS                       R3 R4 K2 ["networking"]
       10 GETTABLEKS                       R2 R3 K3 ["fetchScopesAsync"]
       12 MOVE                             R3 R0
       13 MOVE                             R4 R1
       14 CALL                             R2 2 1
       15 GETUPVAL                         R3 2
       16 GETUPVAL                         R5 3
       17 GETTABLEKS                       R4 R5 K4 ["current"]
       19 JUMPIFEQ                         R3 R4 ; [+2]
       21 RETURN                           R0 0
       22 GETUPVAL                         R5 4
       23 GETTABLEKS                       R4 R5 K5 ["scopeIdRef"]
       25 GETTABLEKS                       R3 R4 K4 ["current"]
       27 JUMPIFEQKNIL                     R3 ; [+4]
       29 GETTABLE                         R4 R2 R3
       30 JUMPIFNOTEQKNIL                  R4 ; [+6]
       32 JUMPIFNOTEQKN                    R1 K6 [0] ; [+3]
       34 MOVE                             R3 R0
       35 JUMP                             ; [+1]
       36 MOVE                             R3 R1
       ...
       39 LOADB                            R5 0 +1
       40 LOADB                            R5 1
       41 FASTCALL2K                       ASSERT R5 K7 ; [+4]
       43 LOADK                            R6 K7 ["Luau"]
       44 GETIMPORT                        R4 K9 [assert]
       46 CALL                             R4 2 0
       47 GETUPVAL                         R4 5
       48 DUPTABLE                         R5 K12 [{"loadedScope", "loadedScopeMap"}]
       49 GETTABLE                         R6 R2 R3
       50 SETTABLEKS                       R6 R5 K10 ["loadedScope"]
       52 SETTABLEKS                       R2 R5 K11 ["loadedScopeMap"]
       54 CALL                             R4 1 0
       55 RETURN                           R0 0
