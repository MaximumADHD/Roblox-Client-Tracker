...
PROTO_2:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R3 R0 K0 ["updateTime"]
        3 GETUPVAL                         R5 1
        4 GETTABLEKS                       R4 R5 K1 ["locale"]
        6 CALL                             R2 2 1
        7 GETUPVAL                         R3 2
        8 JUMPIFNOTEQ                      R2 R3 ; [+5]
       10 GETUPVAL                         R3 3
       11 GETTABLEKS                       R2 R3 K2 ["Today"]
       13 JUMP                             ; [+6]
       14 GETUPVAL                         R3 4
       15 JUMPIFNOTEQ                      R2 R3 ; [+4]
       17 GETUPVAL                         R3 3
       18 GETTABLEKS                       R2 R3 K3 ["Yesterday"]
       20 GETUPVAL                         R3 5
       21 GETUPVAL                         R4 6
       22 DUPTABLE                         R5 K8 [{"layoutOrder", "asset", "lastUpdated", "onAssetSelected"}]
       23 GETUPVAL                         R6 7
       24 CALL                             R6 0 1
       25 SETTABLEKS                       R6 R5 K4 ["layoutOrder"]
       27 SETTABLEKS                       R0 R5 K5 ["asset"]
       ...
       36 CALL                             R3 2 1
       37 GETUPVAL                         R4 9
       38 GETTABLEKS                       R5 R0 K9 ["displayName"]
       40 CALL                             R4 1 -1
       41 RETURN                           R3 -1
...
PROTO_3:
       ...
       78 GETTABLEKS                       R14 R0 K26 ["assets"]
