...
PROTO_1:
        ...
        1 RETURN                           R0 0
        2 GETUPVAL                         R2 0
        3 GETTABLEKS                       R1 R2 K0 ["beginEditingAsync"]
        5 CALL                             R1 0 0
        6 GETUPVAL                         R2 0
        7 GETTABLEKS                       R1 R2 K1 ["setPart"]
        9 LOADK                            R2 K2 ["value"]
       10 MOVE                             R3 R0
       11 CALL                             R1 2 0
       12 GETUPVAL                         R2 0
       13 GETTABLEKS                       R1 R2 K3 ["finishEditing"]
...
PROTO_3:
        ...
        5 CALL                             R1 1 1
        6 GETUPVAL                         R3 0
        7 GETTABLEKS                       R2 R3 K2 ["useSignalState"]
       ...
       36 CALL                             R5 2 1
       37 GETUPVAL                         R7 1
       38 GETTABLEKS                       R6 R7 K9 ["createElement"]
       40 GETUPVAL                         R7 2
...
MAIN:
       ...
       13 GETTABLEKS                       R3 R4 K8 ["EditorTextbox"]
       15 CALL                             R2 1 1
       16 GETIMPORT                        R3 K6 [require]
       18 GETIMPORT                        R6 K1 [script]
       20 GETTABLEKS                       R5 R6 K4 ["Parent"]
       22 GETTABLEKS                       R4 R5 K9 ["PropertyViewTypes"]
       24 CALL                             R3 1 1
       25 GETIMPORT                        R4 K6 [require]
       27 GETTABLEKS                       R6 R0 K4 ["Parent"]
       29 GETTABLEKS                       R5 R6 K10 ["React"]
       31 CALL                             R4 1 1
       32 GETIMPORT                        R5 K6 [require]
       34 GETTABLEKS                       R6 R1 K11 ["SignalsReact"]
       36 CALL                             R5 1 1
       37 DUPCLOSURE                       R6 K12 [PROTO_3]
       38 CAPTURE                          VAL R5
       39 CAPTURE                          VAL R4
       40 CAPTURE                          VAL R2
       41 GETTABLEKS                       R7 R4 K13 ["memo"]
       43 MOVE                             R8 R6
       44 CALL                             R7 1 -1
       45 RETURN                           R7 -1
