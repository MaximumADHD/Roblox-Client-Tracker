...
PROTO_2:
       ...
       33 CALL                             R2 2 1
       34 GETUPVAL                         R5 3
       35 GETTABLEKS                       R4 R5 K7 ["Hooks"]
       37 GETTABLEKS                       R3 R4 K8 ["useTokens"]
       39 CALL                             R3 0 1
       40 GETUPVAL                         R4 4
       41 GETUPVAL                         R6 2
       42 GETTABLEKS                       R5 R6 K9 ["Fragment"]
       44 NEWTABLE                         R6 0 0
       ...
       52 LOADN                            R12 0
       53 GETTABLEKS                       R14 R3 K23 ["Gap"]
       55 GETTABLEKS                       R13 R14 K24 ["XSmall"]
       57 CALL                             R11 2 1
       ...
       76 GETUPVAL                         R9 5
       77 GETUPVAL                         R12 6
       78 GETTABLEKS                       R11 R12 K33 ["Dictionary"]
       80 GETTABLEKS                       R10 R11 K34 ["join"]
       82 MOVE                             R11 R0
       ...
       95 GETUPVAL                         R9 7
       96 GETUPVAL                         R12 6
       97 GETTABLEKS                       R11 R12 K33 ["Dictionary"]
       99 GETTABLEKS                       R10 R11 K34 ["join"]
      101 MOVE                             R11 R0
...
MAIN:
       ...
       30 GETTABLEKS                       R6 R7 K10 ["NumberPartInput"]
       32 CALL                             R5 1 1
       33 GETIMPORT                        R6 K6 [require]
       35 GETTABLEKS                       R10 R0 K11 ["Components"]
       37 GETTABLEKS                       R9 R10 K12 ["PropertyEntries"]
       39 GETTABLEKS                       R8 R9 K13 ["PropertyView"]
       41 GETTABLEKS                       R7 R8 K14 ["PropertyViewTypes"]
       43 CALL                             R6 1 1
       44 GETIMPORT                        R7 K6 [require]
       46 GETTABLEKS                       R8 R1 K15 ["React"]
       48 CALL                             R7 1 1
       49 GETIMPORT                        R8 K6 [require]
       51 GETTABLEKS                       R9 R1 K16 ["ReactUtils"]
       53 CALL                             R8 1 1
       54 GETIMPORT                        R9 K6 [require]
       56 GETIMPORT                        R11 K1 [script]
       58 GETTABLEKS                       R10 R11 K17 ["SeparateMultiNumberInput"]
       60 CALL                             R9 1 1
       61 GETIMPORT                        R10 K6 [require]
       63 GETTABLEKS                       R12 R0 K18 ["Hooks"]
       65 GETTABLEKS                       R11 R12 K19 ["useEventConnection"]
       67 CALL                             R10 1 1
       68 GETTABLEKS                       R11 R7 K20 ["createElement"]
       70 DUPCLOSURE                       R12 K21 [PROTO_2]
       71 CAPTURE                          VAL R8
       72 CAPTURE                          VAL R10
       73 CAPTURE                          VAL R7
       74 CAPTURE                          VAL R4
