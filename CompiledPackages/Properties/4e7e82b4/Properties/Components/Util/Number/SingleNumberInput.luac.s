...
PROTO_1:
        ...
        4 RETURN                           R0 0
        5 GETUPVAL                         R0 1
        6 GETTABLEKS                       R0 R0 K1 ["onEditStart"]
        8 CALL                             R0 0 0
        9 GETUPVAL                         R0 2
       10 LOADNIL                          R1
       11 CALL                             R0 1 0
       ...
       15 GETTABLEKS                       R0 R0 K2 ["setSelectionStart"]
       17 LOADN                            R1 0
       18 CALL                             R0 1 0
       19 GETUPVAL                         R0 0
       20 GETTABLEKS                       R0 R0 K0 ["current"]
       22 GETTABLEKS                       R0 R0 K3 ["setCursorPosition"]
       24 GETUPVAL                         R4 3
...
PROTO_2:
        ...
        1 JUMPIFNOT                        R0 ; [+8]
        2 GETUPVAL                         R0 1
        3 GETTABLEKS                       R0 R0 K0 ["onChange"]
        5 GETUPVAL                         R1 0
        6 CALL                             R0 1 0
        7 GETUPVAL                         R0 2
        8 LOADNIL                          R1
        9 CALL                             R0 1 0
       10 GETUPVAL                         R0 1
       11 GETTABLEKS                       R0 R0 K1 ["onEditFinish"]
       13 CALL                             R0 0 0
       14 RETURN                           R0 0

PROTO_3:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["propertyPart"]
        3 GETTABLEKS                       R1 R1 K1 ["multiple"]
        5 JUMPIFNOT                        R1 ; [+2]
        6 LOADK                            R1 K2 ["-"]
        7 RETURN                           R1 1
        8 GETUPVAL                         R1 1
...
PROTO_4:
       ...
       10 MOVE                             R4 R1
       11 JUMPIF                           R4 ; [+4]
       12 GETTABLEKS                       R4 R0 K2 ["propertyPart"]
       ...
       39 CALL                             R6 2 1
       40 GETUPVAL                         R7 0
       41 GETTABLEKS                       R7 R7 K4 ["useCallback"]
       43 NEWCLOSURE                       R8 P2
       44 CAPTURE                          VAL R1
       45 CAPTURE                          VAL R0
       46 CAPTURE                          VAL R2
       ...
       62 CAPTURE                          UPVAL U1
       63 NEWTABLE                         R10 0 1
       65 GETTABLEKS                       R11 R0 K2 ["propertyPart"]
       67 GETTABLEKS                       R11 R11 K7 ["multiple"]
       69 SETLIST                          R10 R11 1 [1]
       71 CALL                             R8 2 1
       72 GETTABLEKS                       R9 R0 K2 ["propertyPart"]
       74 GETTABLEKS                       R9 R9 K7 ["multiple"]
       76 GETTABLEKS                       R10 R0 K8 ["slider"]
       78 JUMPIFNOT                        R10 ; [+4]
       79 GETTABLEKS                       R10 R0 K8 ["slider"]
       81 GETTABLEKS                       R10 R10 K9 ["step"]
       83 ORK                              R11 R10 K10 [1]
       84 GETTABLEKS                       R12 R0 K8 ["slider"]
       86 JUMPIFNOT                        R12 ; [+4]
       87 GETTABLEKS                       R12 R0 K8 ["slider"]
       89 GETTABLEKS                       R12 R12 K11 ["bounds"]
      ...
      162 GETUPVAL                         R21 5
      163 GETTABLEKS                       R21 R21 K42 ["None"]
      165 SETTABLEKS                       R21 R20 K34 ["controlsVariant"]
      167 GETUPVAL                         R21 6
      168 GETTABLEKS                       R21 R21 K43 ["XSmall"]
      ...
      191 GETTABLEKS                       R21 R0 K48 ["chip"]
      193 GETTABLEKS                       R21 R21 K55 ["color"]
