...
PROTO_41:
       ...
       62 CAPTURE                          VAL R6
       63 GETUPVAL                         R9 6
       64 GETTABLEKS                       R9 R9 K12 ["renderWithMocks"]
       66 GETUPVAL                         R10 2
       67 LOADK                            R11 K13 ["ScreenGui"]
       68 DUPTABLE                         R12 K15 [{"ZIndexBehavior"}]
       69 GETIMPORT                        R13 K18 [Enum.ZIndexBehavior.Sibling]
       71 SETTABLEKS                       R13 R12 K14 ["ZIndexBehavior"]
       73 GETUPVAL                         R13 2
       74 GETUPVAL                         R14 7
       75 GETTABLEKS                       R14 R14 K19 ["Provider"]
       77 DUPTABLE                         R15 K24 [{"theme", "userId", "browseAssetsAsync", "openAssetManager"}]
       78 LOADK                            R16 K25 ["Dark"]
       79 SETTABLEKS                       R16 R15 K20 ["theme"]
       81 GETUPVAL                         R16 0
       82 GETTABLEKS                       R16 R16 K10 ["user"]
       84 GETTABLEKS                       R16 R16 K5 ["id"]
       86 SETTABLEKS                       R16 R15 K21 ["userId"]
       88 JUMPIFNOT                        R0 ; [+3]
       89 GETTABLEKS                       R16 R0 K22 ["browseAssetsAsync"]
       91 JUMPIF                           R16 ; [+1]
       92 DUPCLOSURE                       R16 K26 [PROTO_3]
       93 SETTABLEKS                       R16 R15 K22 ["browseAssetsAsync"]
       95 JUMPIFNOT                        R0 ; [+3]
       96 GETTABLEKS                       R16 R0 K23 ["openAssetManager"]
       98 JUMPIF                           R16 ; [+1]
       99 DUPCLOSURE                       R16 K27 [PROTO_4]
      100 SETTABLEKS                       R16 R15 K23 ["openAssetManager"]
      102 GETUPVAL                         R16 2
      103 MOVE                             R17 R8
      104 CALL                             R16 1 -1
      105 CALL                             R13 -1 -1
      106 CALL                             R10 -1 -1
      107 CALL                             R9 -1 1
      108 GETTABLEKS                       R9 R9 K28 ["container"]
