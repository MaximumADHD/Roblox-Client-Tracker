...
PROTO_4:
        ...
        8 JUMPIFEQKN                       R1 K2 [-1] ; [+13]
       10 GETUPVAL                         R1 1
       11 GETTABLEKS                       R1 R1 K1 ["selectedRow"]
       13 GETUPVAL                         R3 1
       14 GETTABLEKS                       R3 R3 K3 ["layoutOrders"]
       16 LENGTH                           R2 R3
       17 JUMPIFLT                         R2 R1 ; [+4]
       19 GETUPVAL                         R1 2
       ...
       22 RETURN                           R0 0
       23 GETUPVAL                         R1 1
       24 GETTABLEKS                       R1 R1 K1 ["selectedRow"]
       26 GETUPVAL                         R3 1
       27 GETTABLEKS                       R3 R3 K3 ["layoutOrders"]
       29 LENGTH                           R2 R3
       30 JUMPIFNOTLT                      R2 R1 ; [+2]
       32 RETURN                           R0 0
       33 GETUPVAL                         R2 1
       34 GETTABLEKS                       R2 R2 K3 ["layoutOrders"]
       36 GETUPVAL                         R3 1
       37 GETTABLEKS                       R3 R3 K1 ["selectedRow"]
       ...
       45 GETUPVAL                         R4 2
       46 ADD                              R3 R2 R4
       47 GETTABLEKS                       R4 R0 K6 ["CanvasPosition"]
       49 GETTABLEKS                       R4 R4 K7 ["Y"]
       51 GETTABLEKS                       R6 R0 K8 ["AbsoluteSize"]
       53 GETTABLEKS                       R6 R6 K7 ["Y"]
       55 ADD                              R5 R4 R6
       56 MOVE                             R6 R4
       57 GETUPVAL                         R7 1
       58 GETTABLEKS                       R7 R7 K9 ["maxRowsBeforeScroll"]
       60 JUMPIFNOTLE                      R1 R7 ; [+3]
       62 LOADN                            R6 0
       63 JUMP                             ; [+25]
       64 GETUPVAL                         R8 1
       65 GETTABLEKS                       R8 R8 K10 ["rowsCount"]
       67 GETUPVAL                         R9 1
       68 GETTABLEKS                       R9 R9 K9 ["maxRowsBeforeScroll"]
       70 SUB                              R7 R8 R9
       71 JUMPIFNOTLT                      R7 R1 ; [+6]
       73 GETTABLEKS                       R7 R0 K11 ["AbsoluteCanvasSize"]
       75 GETTABLEKS                       R6 R7 K7 ["Y"]
       77 JUMP                             ; [+11]
       78 JUMPIFNOTLT                      R2 R4 ; [+3]
       80 MOVE                             R6 R2
       81 JUMP                             ; [+7]
       82 JUMPIFNOTLT                      R5 R3 ; [+6]
       84 GETTABLEKS                       R7 R0 K8 ["AbsoluteSize"]
       86 GETTABLEKS                       R7 R7 K7 ["Y"]
       88 SUB                              R6 R3 R7
       89 LOADN                            R8 0
       90 GETTABLEKS                       R10 R0 K11 ["AbsoluteCanvasSize"]
       92 GETTABLEKS                       R10 R10 K7 ["Y"]
       94 GETTABLEKS                       R11 R0 K8 ["AbsoluteSize"]
       96 GETTABLEKS                       R11 R11 K7 ["Y"]
       98 SUB                              R9 R10 R11
       99 FASTCALL2                        MATH_MAX R8 R9 ; [+3]
      101 GETIMPORT                        R7 K14 [math.max]
      103 CALL                             R7 2 1
      104 LOADN                            R10 0
      105 FASTCALL3                        MATH_CLAMP R6 R10 R7
      107 MOVE                             R9 R6
      108 MOVE                             R11 R7
      109 GETIMPORT                        R8 K16 [math.clamp]
      111 CALL                             R8 3 1
      112 MOVE                             R6 R8
      113 JUMPIFEQ                         R6 R4 ; [+8]
      115 GETIMPORT                        R8 K19 [Vector2.new]
      117 LOADN                            R9 0
      118 MOVE                             R10 R6
      119 CALL                             R8 2 1
      120 SETTABLEKS                       R8 R0 K6 ["CanvasPosition"]
      122 RETURN                           R0 0
