...
PROTO_7:
  ...
  CAPTURE VAL R15
  CAPTURE VAL R9
  DUPTABLE R20 K22 [{"beginEditingPropertyAsync", "finishEditingProperty", "setPropertyPart", "propertiesObservable", "summaryObservable", "instancePicker", "reflection", "getGameIdAsync", "destroy"}]
  ...
  DUPTABLE R21 K26 [{"isActive", "pickInstanceAsync", "deactivateInstancePickerAsync"}]
  GETTABLEKS R22 R13 K27 ["instancePickerActiveObservable"]
  SETTABLEKS R22 R21 K23 ["isActive"]
  GETTABLEKS R22 R8 K28 ["instancePickerPickInstanceAsync"]
  SETTABLEKS R22 R21 K24 ["pickInstanceAsync"]
  GETTABLEKS R22 R8 K25 ["deactivateInstancePickerAsync"]
  SETTABLEKS R22 R21 K25 ["deactivateInstancePickerAsync"]
  SETTABLEKS R21 R20 K18 ["instancePicker"]
  GETUPVAL R21 5
  CALL R21 0 1
  SETTABLEKS R21 R20 K19 ["reflection"]
  GETTABLEKS R21 R8 K20 ["getGameIdAsync"]
  SETTABLEKS R21 R20 K20 ["getGameIdAsync"]
  SETTABLEKS R19 R20 K21 ["destroy"]
  CLOSEUPVALS R6
  RETURN R20 1
...
MAIN:
  ...
  GETTABLEKS R8 R9 K14 ["createStudioReflection"]
  CALL R7 1 1
