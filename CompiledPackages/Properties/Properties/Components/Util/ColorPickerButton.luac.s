PROTO_0:
  ...
  DUPTABLE R9 K12 [{"Color3", "Transparency"}]
  GETTABLEKS R10 R0 K13 ["swatchColor"]
  SETTABLEKS R10 R9 K10 ["Color3"]
  LOADN R10 0
  SETTABLEKS R10 R9 K11 ["Transparency"]
  SETTABLEKS R9 R8 K7 ["backgroundStyle"]
  DUPTABLE R9 K15 [{"Border"}]
  GETUPVAL R10 1
  LOADK R11 K16 ["UIStroke"]
  DUPTABLE R12 K21 [{"Color", "Transparency", "Thickness", "LineJoinMode", "BorderStrokePosition"}]
  GETTABLEKS R16 R1 K17 ["Color"]
  GETTABLEKS R15 R16 K22 ["Stroke"]
  ...
  GETTABLEKS R15 R16 K22 ["Stroke"]
  GETTABLEKS R14 R15 K23 ["Default"]
  GETTABLEKS R13 R14 K11 ["Transparency"]
  SETTABLEKS R13 R12 K11 ["Transparency"]
  LOADN R13 1
  SETTABLEKS R13 R12 K18 ["Thickness"]
  GETIMPORT R13 K26 [Enum.LineJoinMode.Round]
  SETTABLEKS R13 R12 K19 ["LineJoinMode"]
  GETIMPORT R13 K28 [Enum.BorderStrokePosition.Inner]
  SETTABLEKS R13 R12 K20 ["BorderStrokePosition"]
  CALL R10 2 1
