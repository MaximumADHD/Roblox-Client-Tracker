PROTO_0:
  ...
  DUPTABLE R3 K9 [{"label", "size", "width", "items", "value", "onItemChanged", "testId"}]
  LOADK R4 K10 [""]
  ...
  SETTABLEKS R4 R3 K5 ["items"]
  GETTABLEKS R4 R0 K6 ["value"]
  SETTABLEKS R4 R3 K6 ["value"]
  GETTABLEKS R4 R0 K7 ["onItemChanged"]
  SETTABLEKS R4 R3 K7 ["onItemChanged"]
  GETTABLEKS R4 R0 K8 ["testId"]
  SETTABLEKS R4 R3 K8 ["testId"]
  CALL R1 2 -1
  RETURN R1 -1
