PROTO_0:
  DUPTABLE R1 K1 [{"openAssetManager"}]
  GETTABLEKS R2 R0 K0 ["openAssetManager"]
  SETTABLEKS R2 R1 K0 ["openAssetManager"]
  GETUPVAL R2 0
  GETUPVAL R4 1
...
MAIN:
  ...
  DUPTABLE R4 K12 [{"openAssetManager"}]
  MOVE R5 R2
  LOADK R6 K11 ["openAssetManager"]
  CALL R5 1 1
  SETTABLEKS R5 R4 K11 ["openAssetManager"]
