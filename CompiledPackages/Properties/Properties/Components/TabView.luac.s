...
PROTO_3:
  ...
  GETTABLEKS R4 R5 K3 ["reflection"]
  CALL R2 2 1
  NEWTABLE R3 0 0
  MOVE R4 R2
  LOADNIL R5
  LOADNIL R6
  FORGPREP R4
  GETTABLEKS R9 R8 K4 ["categoryName"]
  GETUPVAL R10 2
  GETUPVAL R11 3
  DUPTABLE R12 K8 [{"session", "category", "layoutOrder", "labelWidthBinding"}]
  GETTABLEKS R13 R0 K1 ["session"]
  SETTABLEKS R13 R12 K1 ["session"]
  SETTABLEKS R8 R12 K5 ["category"]
  SETTABLEKS R7 R12 K6 ["layoutOrder"]
  GETTABLEKS R13 R0 K7 ["labelWidthBinding"]
  SETTABLEKS R13 R12 K7 ["labelWidthBinding"]
  CALL R10 2 1
  SETTABLE R10 R3 R9
  FORGLOOP R4 2 [-20]
  GETUPVAL R4 2
  GETUPVAL R6 4
  GETTABLEKS R5 R6 K9 ["Fragment"]
  NEWTABLE R6 0 0
  MOVE R7 R3
  CALL R4 3 -1
  RETURN R4 -1
