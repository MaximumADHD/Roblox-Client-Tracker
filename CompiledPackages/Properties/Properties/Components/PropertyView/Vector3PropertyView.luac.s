PROTO_0:
  ...
  GETUPVAL R11 1
  DUPTABLE R12 K23 [{"part", "position", "size", "color", "editable", "value", "beginEditingAsync", "setPart", "finishEditing"}]
  LOADK R13 K2 ["x"]
  ...
  LOADK R14 K31 ["#DF281F"]
  CALL R13 1 1
  SETTABLEKS R13 R12 K18 ["color"]
  SETTABLEKS R5 R12 K19 ["editable"]
  SETTABLEKS R2 R12 K5 ["value"]
  GETTABLEKS R13 R0 K20 ["beginEditingAsync"]
  SETTABLEKS R13 R12 K20 ["beginEditingAsync"]
  GETTABLEKS R13 R0 K21 ["setPart"]
  SETTABLEKS R13 R12 K21 ["setPart"]
  GETTABLEKS R13 R0 K22 ["finishEditing"]
  SETTABLEKS R13 R12 K22 ["finishEditing"]
  CALL R10 2 1
...
MAIN:
  ...
  GETTABLEKS R2 R3 K8 ["NumberPartView"]
  CALL R1 1 1
