...
PROTO_2:
  ...
  GETTABLEKS R3 R4 K2 ["parts"]
  GETTABLEKS R2 R3 K3 ["value"]
  GETIMPORT R4 K5 [Enum]
  GETTABLEKS R5 R1 K6 ["enumName"]
  GETTABLE R3 R4 R5
  GETTABLEKS R5 R2 K7 ["multiple"]
  JUMPIFNOT R5 [+2]
  LOADNIL R4
  JUMP [+2]
  ...
  NEWTABLE R8 0 4
  MOVE R9 R3
  GETTABLEKS R10 R0 K10 ["beginEditingAsync"]
  GETTABLEKS R11 R0 K11 ["setPart"]
  GETTABLEKS R12 R0 K12 ["finishEditing"]
  SETLIST R8 R9 4 [1]
  CALL R6 2 1
  GETUPVAL R7 1
  GETUPVAL R8 2
  DUPTABLE R9 K16 [{"items", "value", "onItemChanged", "testId"}]
  SETTABLEKS R5 R9 K13 ["items"]
  JUMPIFNOT R4 [+3]
  GETTABLEKS R10 R4 K17 ["Name"]
  JUMP [+1]
  LOADNIL R10
  SETTABLEKS R10 R9 K3 ["value"]
  SETTABLEKS R6 R9 K14 ["onItemChanged"]
