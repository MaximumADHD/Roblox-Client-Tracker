...
MAIN:
  ...
  CALL R13 1 1
  DUPTABLE R14 K34 [{"int", "int64", "float", "double", "number", "string", "Vector3", "boolean", "bool", "InstanceRef", "Enum", "CombinedColor"}]
  ...
  SETTABLEKS R5 R14 K33 ["CombinedColor"]
  DUPTABLE R15 K36 [{"CollisionGroup"}]
  SETTABLEKS R4 R15 K35 ["CollisionGroup"]
