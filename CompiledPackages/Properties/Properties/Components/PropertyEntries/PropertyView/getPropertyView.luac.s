...
MAIN:
  ...
  GETTABLEKS R6 R7 K13 ["CombinedColorPropertyView"]
  CALL R5 1 1
  ...
  CALL R13 1 1
  DUPTABLE R14 K32 [{"int", "int64", "float", "string", "Vector3", "boolean", "bool", "InstanceRef", "Enum", "CombinedColor"}]
  SETTABLEKS R8 R14 K22 ["int"]
  SETTABLEKS R8 R14 K23 ["int64"]
  SETTABLEKS R8 R14 K24 ["float"]
  SETTABLEKS R12 R14 K25 ["string"]
  SETTABLEKS R13 R14 K26 ["Vector3"]
  SETTABLEKS R3 R14 K27 ["boolean"]
  SETTABLEKS R3 R14 K28 ["bool"]
  SETTABLEKS R7 R14 K29 ["InstanceRef"]
  SETTABLEKS R6 R14 K30 ["Enum"]
  SETTABLEKS R5 R14 K31 ["CombinedColor"]
  DUPTABLE R15 K34 [{"CollisionGroup"}]
  SETTABLEKS R4 R15 K33 ["CollisionGroup"]
