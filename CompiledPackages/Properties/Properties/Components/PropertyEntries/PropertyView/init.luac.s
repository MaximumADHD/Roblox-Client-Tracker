...
PROTO_5:
  ...
  MOVE R14 R8
  DUPTABLE R15 K29 [{"info", "beginEditingAsync", "setPart", "finishEditing", "labelPressedSignal", "instancePicker", "getGameIdAsync"}]
  ...
  GETTABLEKS R16 R4 K28 ["getGameIdAsync"]
  SETTABLEKS R16 R15 K28 ["getGameIdAsync"]
  CALL R13 2 1
  SETTABLEKS R13 R12 K19 ["SpecificView"]
  GETUPVAL R14 1
  GETTABLEKS R13 R14 K7 ["createElement"]
  LOADK R14 K30 ["UISizeConstraint"]
  DUPTABLE R15 K32 [{"MinSize"}]
  GETIMPORT R16 K35 [Vector2.new]
  LOADN R17 0
  GETTABLEKS R19 R2 K11 ["Size"]
  GETTABLEKS R18 R19 K36 ["Size_600"]
  CALL R16 2 1
  SETTABLEKS R16 R15 K31 ["MinSize"]
  CALL R13 2 1
