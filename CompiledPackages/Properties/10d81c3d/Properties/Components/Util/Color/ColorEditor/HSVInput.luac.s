PROTO_0:
       ...
       27 GETTABLEKS                       R11 R0 K18 ["hPart"]
       29 GETTABLEKS                       R10 R11 K19 ["multiple"]
       31 JUMPIFNOT                        R10 ; [+2]
       32 LOADK                            R9 K19 ["multiple"]
       33 JUMP                             ; [+8]
       34 GETIMPORT                        R9 K22 [string.format]
       36 LOADK                            R10 K23 ["%.2f"]
       37 GETTABLEKS                       R12 R0 K18 ["hPart"]
       39 GETTABLEKS                       R11 R12 K24 ["value"]
       41 CALL                             R9 2 1
       ...
       69 GETTABLEKS                       R11 R0 K25 ["sPart"]
       71 GETTABLEKS                       R10 R11 K19 ["multiple"]
       73 JUMPIFNOT                        R10 ; [+2]
       74 LOADK                            R9 K19 ["multiple"]
       75 JUMP                             ; [+8]
       76 GETIMPORT                        R9 K22 [string.format]
       78 LOADK                            R10 K23 ["%.2f"]
       79 GETTABLEKS                       R12 R0 K25 ["sPart"]
       81 GETTABLEKS                       R11 R12 K24 ["value"]
       83 CALL                             R9 2 1
      ...
      111 GETTABLEKS                       R11 R0 K26 ["vPart"]
      113 GETTABLEKS                       R10 R11 K19 ["multiple"]
      115 JUMPIFNOT                        R10 ; [+2]
      116 LOADK                            R9 K19 ["multiple"]
      117 JUMP                             ; [+8]
      118 GETIMPORT                        R9 K22 [string.format]
      120 LOADK                            R10 K23 ["%.2f"]
      121 GETTABLEKS                       R12 R0 K26 ["vPart"]
      123 GETTABLEKS                       R11 R12 K24 ["value"]
      125 CALL                             R9 2 1
...
MAIN:
        ...
        9 GETTABLEKS                       R6 R0 K6 ["Components"]
       11 GETTABLEKS                       R5 R6 K7 ["Util"]
       13 GETTABLEKS                       R4 R5 K8 ["Color"]
       15 GETTABLEKS                       R3 R4 K9 ["ColorEditor"]
       17 GETTABLEKS                       R2 R3 K10 ["ChannelInput"]
       19 CALL                             R1 1 1
       20 GETIMPORT                        R2 K5 [require]
       22 GETTABLEKS                       R4 R0 K11 ["Parent"]
       24 GETTABLEKS                       R3 R4 K12 ["Foundation"]
       26 CALL                             R2 1 1
       ...
       41 GETTABLEKS                       R7 R0 K11 ["Parent"]
