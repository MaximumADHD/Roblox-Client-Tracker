...
PROTO_1:
       ...
       23 JUMP                             ; [+15]
       24 GETTABLEKS                       R10 R7 K5 ["propertyToRow"]
       26 JUMPIFNOT                        R10 ; [+6]
       27 GETTABLEKS                       R9 R7 K5 ["propertyToRow"]
       29 GETTABLEKS                       R10 R8 K6 ["value"]
       31 CALL                             R9 1 1
       32 JUMP                             ; [+2]
       33 GETTABLEKS                       R9 R8 K6 ["value"]
       35 DUPTABLE                         R10 K8 [{["multiple"] = False, ["value"]}]
       36 SETTABLEKS                       R9 R10 K6 ["value"]
       38 SETTABLE                         R10 R2 R6
       39 FORGLOOP                         R3 2 ; [-27]
       41 GETUPVAL                         R3 3
       42 GETTABLEKS                       R3 R3 K9 ["fromInfoAndParts"]
       44 GETUPVAL                         R4 4
       45 GETTABLEKS                       R4 R4 K10 ["fromType"]
       47 GETUPVAL                         R5 1
       48 GETTABLEKS                       R5 R5 K11 ["type"]
       50 GETTABLEKS                       R6 R1 K12 ["readonly"]
       52 CALL                             R4 2 1
       53 MOVE                             R5 R2
       54 CALL                             R3 2 -1
       55 RETURN                           R3 -1
...
PROTO_2:
        0 GETUPVAL                         R3 0
        1 GETTABLEKS                       R3 R3 K0 ["partNameMap"]
        3 GETTABLE                         R2 R3 R0
        4 GETTABLEKS                       R4 R2 K1 ["rowToProperty"]
        6 JUMPIFNOT                        R4 ; [+5]
        7 GETTABLEKS                       R3 R2 K1 ["rowToProperty"]
        9 MOVE                             R4 R1
       10 CALL                             R3 1 1
       11 JUMP                             ; [+1]
       12 MOVE                             R3 R1
       13 GETUPVAL                         R4 1
       14 GETTABLEKS                       R4 R4 K2 ["setPart"]
       16 GETTABLEKS                       R5 R2 K3 ["propertyPartName"]
       18 MOVE                             R6 R3
       19 CALL                             R4 2 0
       20 RETURN                           R0 0
