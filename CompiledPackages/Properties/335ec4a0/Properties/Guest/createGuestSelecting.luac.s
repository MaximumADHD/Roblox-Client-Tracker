...
PROTO_18:
        ...
        4 JUMPIFNOT                        R0 ; [+5]
        5 GETUPVAL                         R0 1
        6 GETTABLEKS                       R0 R0 K1 ["selectionUpdatedWhilePinned"]
        8 CALL                             R0 0 0
        9 RETURN                           R0 0
       10 GETUPVAL                         R0 2
       11 LOADNIL                          R1
       ...
       26 GETUPVAL                         R0 4
       27 GETUPVAL                         R1 5
       28 GETTABLEKS                       R1 R1 K2 ["Get"]
       30 CALL                             R1 0 -1
       31 CALL                             R0 -1 0
       32 GETUPVAL                         R0 6
       33 GETTABLEKS                       R0 R0 K0 ["get"]
       35 CALL                             R0 0 3
       36 FORGPREP                         R0
       37 GETUPVAL                         R5 7
       38 MOVE                             R6 R4
       ...
       40 FORGLOOP                         R0 2 ; [-4]
       42 GETUPVAL                         R0 1
       43 GETTABLEKS                       R0 R0 K3 ["hideProperties"]
       45 GETUPVAL                         R1 8
       46 CALL                             R0 1 0
       47 GETUPVAL                         R0 9
       48 GETTABLEKS                       R0 R0 K4 ["isAggregating"]
       50 CALL                             R0 0 1
       51 JUMPIFNOT                        R0 ; [+4]
       52 GETUPVAL                         R0 9
       53 GETTABLEKS                       R0 R0 K5 ["stopAggregating"]
       55 CALL                             R0 0 0
       56 GETUPVAL                         R0 10
       57 CALL                             R0 0 0
       58 RETURN                           R0 0
...
PROTO_22:
       ...
       57 CAPTURE                          VAL R15
       58 GETUPVAL                         R17 0
       59 GETTABLEKS                       R17 R17 K0 ["create"]
       61 LOADB                            R18 0
       62 CALL                             R17 1 2
       63 NEWCLOSURE                       R19 P7
       64 CAPTURE                          VAL R17
       65 CAPTURE                          VAL R0
       66 CAPTURE                          VAL R7
       67 CAPTURE                          VAL R8
       ...
       76 CAPTURE                          VAL R17
       77 CAPTURE                          VAL R18
       78 NEWCLOSURE                       R21 P9
       79 CAPTURE                          VAL R17
       80 CAPTURE                          VAL R18
       81 CAPTURE                          VAL R19
       82 GETTABLEKS                       R22 R1 K1 ["SelectionChanged"]
       84 MOVE                             R24 R19
       85 NAMECALL                         R22 R22 K2 ["Connect"]
       87 CALL                             R22 2 1
       88 GETIMPORT                        R23 K5 [task.defer]
       90 MOVE                             R24 R19
       91 CALL                             R23 1 0
       92 NEWCLOSURE                       R23 P10
       93 CAPTURE                          VAL R0
       94 CAPTURE                          REF R6
       95 CAPTURE                          VAL R3
       96 CAPTURE                          VAL R22
       97 DUPTABLE                         R24 K9 [{"getSelection", "pinning", "destroy"}]
       98 GETTABLEKS                       R25 R4 K10 ["get"]
      100 SETTABLEKS                       R25 R24 K6 ["getSelection"]
      102 DUPTABLE                         R25 K13 [{"pinSelection", "unpinSelection"}]
      103 SETTABLEKS                       R20 R25 K11 ["pinSelection"]
      105 SETTABLEKS                       R21 R25 K12 ["unpinSelection"]
      107 SETTABLEKS                       R25 R24 K7 ["pinning"]
      109 SETTABLEKS                       R23 R24 K8 ["destroy"]
      111 CLOSEUPVALS                      R6
      112 RETURN                           R24 1
...
MAIN:
       ...
       24 GETTABLEKS                       R4 R4 K13 ["Observable"]
       26 CALL                             R3 1 1
       27 GETIMPORT                        R4 K9 [require]
       29 GETTABLEKS                       R5 R1 K14 ["PropertyInteraction"]
       31 GETTABLEKS                       R5 R5 K15 ["PropertyId"]
       33 CALL                             R4 1 1
       34 GETIMPORT                        R5 K9 [require]
       36 GETTABLEKS                       R6 R1 K16 ["PropertyTypes"]
       38 CALL                             R5 1 1
       39 GETIMPORT                        R6 K9 [require]
       41 GETTABLEKS                       R7 R1 K17 ["RpcTypes"]
       43 CALL                             R6 1 1
       44 GETIMPORT                        R7 K9 [require]
       46 GETTABLEKS                       R8 R1 K14 ["PropertyInteraction"]
       48 GETTABLEKS                       R8 R8 K18 ["SpecialProperties"]
       50 CALL                             R7 1 1
       51 GETIMPORT                        R8 K9 [require]
       53 GETTABLEKS                       R9 R1 K14 ["PropertyInteraction"]
       55 GETTABLEKS                       R9 R9 K19 ["getReadablePropertiesForClass"]
       57 CALL                             R8 1 1
       58 GETIMPORT                        R9 K9 [require]
       60 GETTABLEKS                       R10 R1 K14 ["PropertyInteraction"]
       62 GETTABLEKS                       R10 R10 K20 ["hasProperty"]
       64 CALL                             R9 1 1
       65 GETIMPORT                        R10 K9 [require]
       67 GETTABLEKS                       R11 R1 K14 ["PropertyInteraction"]
       69 GETTABLEKS                       R11 R11 K21 ["propertyIdToString"]
       71 CALL                             R10 1 1
       72 DUPCLOSURE                       R11 K22 [PROTO_0]
       73 CAPTURE                          VAL R10
       74 DUPCLOSURE                       R12 K23 [PROTO_22]
       75 CAPTURE                          VAL R3
       76 CAPTURE                          VAL R10
       77 CAPTURE                          VAL R9
       78 CAPTURE                          VAL R8
