...
PROTO_1:
      ...
      116 GETUPVAL                         R16 7
      117 GETUPVAL                         R17 11
      118 DUPTABLE                         R18 K34 [{"scroll", "LayoutOrder", "Size", "selection"}]
      119 DUPTABLE                         R19 K37 [{"AutomaticCanvasSize", "CanvasSize"}]
      120 GETIMPORT                        R20 K41 [Enum.AutomaticSize.Y]
      122 SETTABLEKS                       R20 R19 K35 ["AutomaticCanvasSize"]
      124 GETIMPORT                        R20 K24 [UDim2.new]
      126 CALL                             R20 0 1
      127 SETTABLEKS                       R20 R19 K36 ["CanvasSize"]
      ...
      153 DUPTABLE                         R19 K44 [{["Selectable"] = False}]
      154 SETTABLEKS                       R19 R18 K33 ["selection"]
      156 DUPTABLE                         R19 K46 [{"TabView"}]
      157 GETUPVAL                         R20 7
      158 GETUPVAL                         R21 12
      159 DUPTABLE                         R22 K51 [{"session", "filter", "setCategoryExpanded", "size", "labelWidthBinding", "initialCaches"}]
      160 GETTABLEKS                       R23 R0 K0 ["session"]
      162 SETTABLEKS                       R23 R22 K0 ["session"]
      164 DUPTABLE                         R23 K55 [{"getTab", "getSearch", "getCollapsedCategories"}]
      165 SETTABLEKS                       R3 R23 K52 ["getTab"]
      167 SETTABLEKS                       R5 R23 K53 ["getSearch"]
      169 SETTABLEKS                       R7 R23 K54 ["getCollapsedCategories"]
      171 SETTABLEKS                       R23 R22 K47 ["filter"]
      173 SETTABLEKS                       R9 R22 K48 ["setCategoryExpanded"]
      175 GETIMPORT                        R23 K24 [UDim2.new]
      177 LOADN                            R24 1
      178 GETTABLEKS                       R26 R11 K56 ["ScrollBar"]
      180 GETTABLEKS                       R26 R26 K57 ["Width"]
      182 MINUS                            R25 R26
      183 LOADN                            R26 0
      184 LOADN                            R27 0
      185 CALL                             R23 4 1
      186 SETTABLEKS                       R23 R22 K20 ["size"]
      188 GETTABLEKS                       R23 R1 K49 ["labelWidthBinding"]
      190 SETTABLEKS                       R23 R22 K49 ["labelWidthBinding"]
      192 DUPTABLE                         R23 K60 [{"categories", "properties"}]
      193 DUPTABLE                         R24 K65 [{["Properties"] = 1, ["Tags"] = 1, ["Attributes"] = 1}]
      194 SETTABLEKS                       R24 R23 K58 ["categories"]
      196 DUPTABLE                         R24 K82 [{["string"] = 1, ["int"] = 1, ["float"] = 1, ["number"] = 1, ["Vector2"] = 1, ["Vector3"] = 1, ["boolean"] = 1, ["InstanceRef"] = 1, ["Enum"] = 1, ["DynamicEnum"] = 1, ["CombinedColor"] = 1, ["Content"] = 1, ["CFrame"] = 1, ["SecurityCapabilities"] = 1, ["Faces"] = 1, ["Color3"] = 1, ["BrickColor"] = 1}]
      197 SETTABLEKS                       R24 R23 K59 ["properties"]
      199 SETTABLEKS                       R23 R22 K50 ["initialCaches"]
      201 CALL                             R20 2 1
      202 SETTABLEKS                       R20 R19 K45 ["TabView"]
      204 CALL                             R16 3 1
      205 SETTABLEKS                       R16 R15 K16 ["ScrollingContent"]
      207 GETUPVAL                         R16 7
      208 GETUPVAL                         R17 13
      209 DUPTABLE                         R18 K83 [{"session"}]
      210 GETTABLEKS                       R19 R0 K0 ["session"]
      212 SETTABLEKS                       R19 R18 K0 ["session"]
      214 CALL                             R16 2 1
      215 SETTABLEKS                       R16 R15 K17 ["Windows"]
      217 CALL                             R12 3 -1
      218 RETURN                           R12 -1
