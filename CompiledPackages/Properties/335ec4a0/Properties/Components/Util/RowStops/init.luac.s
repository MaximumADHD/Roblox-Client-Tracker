...
PROTO_3:
       ...
       12 JUMPIFNOTEQKNIL                  R4 ; [+9]
       14 GETIMPORT                        R5 K3 [error]
       16 LOADK                            R6 K4 ["Missing RowStops slot for row %*"]
       17 MOVE                             R8 R3
       ...
       25 GETUPVAL                         R6 1
       26 GETUPVAL                         R7 2
       27 DUPTABLE                         R8 K16 [{"LayoutOrder", "rowSlot", "isSelected", "canDelete", "onEditStart", "onEditFinish", "onSelected", "onDelete", "onAbsoluteSizeChanged"}]
       28 GETUPVAL                         R10 0
       29 GETTABLEKS                       R10 R10 K17 ["layoutOrders"]
       31 GETTABLE                         R9 R10 R3
       32 SETTABLEKS                       R9 R8 K7 ["LayoutOrder"]
       34 SETTABLEKS                       R4 R8 K8 ["rowSlot"]
       36 GETUPVAL                         R10 0
       37 GETTABLEKS                       R10 R10 K18 ["selectedRow"]
       39 JUMPIFEQ                         R3 R10 ; [+2]
       41 LOADB                            R9 0 +1
       42 LOADB                            R9 1
       43 SETTABLEKS                       R9 R8 K9 ["isSelected"]
       45 GETUPVAL                         R10 0
       46 GETTABLEKS                       R10 R10 K0 ["rowsCount"]
       48 LOADN                            R11 2
       49 JUMPIFLT                         R11 R10 ; [+2]
       51 LOADB                            R9 0 +1
       52 LOADB                            R9 1
       53 SETTABLEKS                       R9 R8 K10 ["canDelete"]
       55 GETUPVAL                         R9 0
       56 GETTABLEKS                       R9 R9 K11 ["onEditStart"]
       58 SETTABLEKS                       R9 R8 K11 ["onEditStart"]
       60 GETUPVAL                         R9 0
       61 GETTABLEKS                       R9 R9 K12 ["onEditFinish"]
       63 SETTABLEKS                       R9 R8 K12 ["onEditFinish"]
       65 NEWCLOSURE                       R9 P0
       66 CAPTURE                          UPVAL U0
       67 CAPTURE                          VAL R3
       68 SETTABLEKS                       R9 R8 K13 ["onSelected"]
       70 NEWCLOSURE                       R9 P1
       71 CAPTURE                          UPVAL U0
       72 CAPTURE                          VAL R3
       73 SETTABLEKS                       R9 R8 K14 ["onDelete"]
       75 JUMPIFNOTEQKN                    R3 K19 [1] ; [+3]
       77 GETUPVAL                         R9 3
       78 JUMP                             ; [+1]
       79 LOADNIL                          R9
       80 SETTABLEKS                       R9 R8 K15 ["onAbsoluteSizeChanged"]
       82 CALL                             R6 2 1
       83 SETTABLE                         R6 R0 R5
       84 FORNLOOP                         R1
       85 RETURN                           R0 1
...
PROTO_5:
      ...
      140 LENGTH                           R24 R25
      141 JUMPIFNOTLE                      R24 R23 ; [+9]
      143 LOADK                            R22 K44 ["Maximum stops reached. A sequence can contain up to %* stops."]
      144 GETTABLEKS                       R25 R0 K8 ["rowSlots"]
      146 LENGTH                           R24 R25
      147 NAMECALL                         R22 R22 K45 ["format"]
      149 CALL                             R22 2 1
      150 JUMP                             ; [+1]
      151 LOADK                            R22 K46 ["Add stop"]
      152 SETTABLEKS                       R22 R21 K40 ["text"]
      154 GETUPVAL                         R22 9
      155 GETTABLEKS                       R22 R22 K47 ["End"]
      157 SETTABLEKS                       R22 R21 K41 ["align"]
      159 GETUPVAL                         R22 10
      160 GETTABLEKS                       R22 R22 K48 ["Top"]
      162 SETTABLEKS                       R22 R21 K42 ["side"]
      164 MOVE                             R22 R10
      165 CALL                             R22 0 1
      166 SETTABLEKS                       R22 R21 K24 ["LayoutOrder"]
      168 DUPTABLE                         R22 K50 [{"Anchor"}]
      169 GETUPVAL                         R23 2
      170 GETUPVAL                         R24 11
      171 DUPTABLE                         R25 K58 [{["size"], ["icon"], ["variant"], ["isDisabled"], ["onActivated"], ["testId"] = "RowStops-Add"}]
      172 GETUPVAL                         R26 12
      173 GETTABLEKS                       R26 R26 K59 ["XSmall"]
      175 SETTABLEKS                       R26 R25 K51 ["size"]
      177 GETUPVAL                         R26 13
      178 GETTABLEKS                       R26 R26 K60 ["PlusLarge"]
      180 SETTABLEKS                       R26 R25 K52 ["icon"]
      182 GETUPVAL                         R26 14
      183 GETTABLEKS                       R26 R26 K61 ["Utility"]
      185 SETTABLEKS                       R26 R25 K53 ["variant"]
      187 GETTABLEKS                       R27 R0 K5 ["rowsCount"]
      189 GETTABLEKS                       R29 R0 K8 ["rowSlots"]
      191 LENGTH                           R28 R29
      192 JUMPIFLE                         R28 R27 ; [+2]
      194 LOADB                            R26 0 +1
      195 LOADB                            R26 1
      196 SETTABLEKS                       R26 R25 K54 ["isDisabled"]
      198 SETTABLEKS                       R4 R25 K55 ["onActivated"]
      200 CALL                             R23 2 1
      201 SETTABLEKS                       R23 R22 K49 ["Anchor"]
      203 CALL                             R19 3 1
      204 SETTABLEKS                       R19 R18 K32 ["Add"]
      206 CALL                             R15 3 1
      207 SETTABLEKS                       R15 R14 K26 ["Header"]
      209 GETUPVAL                         R15 2
      210 GETUPVAL                         R16 15
      211 DUPTABLE                         R17 K67 [{["scroll"], ["scrollingFrameRef"], ["tag"] = "flex-none", ["Size"], ["LayoutOrder"], ["testId"] = "RowStops-ScrollView"}]
      212 DUPTABLE                         R18 K72 [{"CanvasSize", "AutomaticCanvasSize", "ScrollingEnabled", "ScrollingDirection"}]
      213 GETIMPORT                        R19 K75 [UDim2.fromScale]
      215 LOADN                            R20 1
      216 LOADN                            R21 0
      217 CALL                             R19 2 1
      218 SETTABLEKS                       R19 R18 K68 ["CanvasSize"]
      220 GETIMPORT                        R19 K79 [Enum.AutomaticSize.Y]
      222 SETTABLEKS                       R19 R18 K69 ["AutomaticCanvasSize"]
      224 GETTABLEKS                       R20 R0 K5 ["rowsCount"]
      226 GETTABLEKS                       R21 R0 K16 ["maxRowsBeforeScroll"]
      228 JUMPIFLT                         R21 R20 ; [+2]
      230 LOADB                            R19 0 +1
      231 LOADB                            R19 1
      232 SETTABLEKS                       R19 R18 K70 ["ScrollingEnabled"]
      234 GETIMPORT                        R19 K80 [Enum.ScrollingDirection.Y]
      236 SETTABLEKS                       R19 R18 K71 ["ScrollingDirection"]
      238 SETTABLEKS                       R18 R17 K62 ["scroll"]
      240 SETTABLEKS                       R1 R17 K63 ["scrollingFrameRef"]
      242 GETIMPORT                        R18 K82 [UDim2.new]
      244 LOADN                            R19 1
      245 LOADN                            R20 0
      246 LOADN                            R21 0
      247 MOVE                             R22 R9
      248 CALL                             R18 4 1
      249 SETTABLEKS                       R18 R17 K65 ["Size"]
      251 MOVE                             R18 R10
      252 CALL                             R18 0 1
      253 SETTABLEKS                       R18 R17 K24 ["LayoutOrder"]
      255 DUPTABLE                         R18 K84 [{"Content"}]
      256 GETUPVAL                         R19 2
      257 GETUPVAL                         R20 6
      258 DUPTABLE                         R21 K87 [{["tag"] = "flex-none align-x-center items-center size-full-0 auto-y", ["layout"]}]
      259 DUPTABLE                         R22 K90 [{"FillDirection", "Padding"}]
      260 GETIMPORT                        R23 K92 [Enum.FillDirection.Vertical]
      262 SETTABLEKS                       R23 R22 K88 ["FillDirection"]
      264 GETIMPORT                        R23 K94 [UDim.new]
      266 LOADN                            R24 0
      267 MOVE                             R25 R7
      268 CALL                             R23 2 1
      269 SETTABLEKS                       R23 R22 K89 ["Padding"]
      271 SETTABLEKS                       R22 R21 K86 ["layout"]
      273 MOVE                             R22 R5
      274 CALL                             R19 3 1
      275 SETTABLEKS                       R19 R18 K83 ["Content"]
      277 CALL                             R15 3 1
      278 SETTABLEKS                       R15 R14 K27 ["Rows"]
      280 CALL                             R11 3 -1
      281 RETURN                           R11 -1
