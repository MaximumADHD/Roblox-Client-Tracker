PROTO_0:
       ...
       50 LOADK                            R15 K11 [""]
       51 MOVE                             R16 R12
       52 NAMECALL                         R13 R13 K12 ["format"]
       54 CALL                             R13 3 1
       55 GETTABLEKS                       R14 R9 K13 ["handle"]
       57 GETTABLEKS                       R14 R14 K14 ["setTitle"]
       59 MOVE                             R15 R13
       60 CALL                             R14 1 0
       61 JUMPIFNOTEQKNIL                  R10 ; [+11]
       63 GETTABLEKS                       R11 R9 K15 ["isOpen"]
       65 CALL                             R11 0 1
       66 JUMPIF                           R11 ; [+6]
       67 GETUPVAL                         R11 0
       68 GETTABLEKS                       R11 R11 K16 ["cleanupWindow"]
       70 MOVE                             R12 R3
       71 MOVE                             R13 R8
       72 CALL                             R11 2 0
       73 FORGLOOP                         R5 2 ; [-64]
...
PROTO_4:
       ...
       31 JUMPIFNOT                        R14 ; [+19]
       32 LOADK                            R14 K5 ["%*%*"]
       33 GETTABLEKS                       R20 R12 K7 ["propertyInfo"]
       35 CALL                             R20 0 1
       36 MOVE                             R18 R20
       37 GETTABLEKS                       R18 R18 K8 ["type"]
       39 LOADK                            R19 K9 [" "]
       40 CONCAT                           R17 R18 R19
       41 ORK                              R16 R17 K6 [""]
       42 GETTABLEKS                       R17 R12 K10 ["propertyId"]
       44 CALL                             R17 0 1
       45 GETTABLEKS                       R17 R17 K11 ["name"]
       47 NAMECALL                         R14 R14 K12 ["format"]
       49 CALL                             R14 3 1
       50 SETTABLE                         R12 R2 R14
       51 FORGLOOP                         R8 2 ; [-33]
       53 FORGLOOP                         R3 2 ; [-39]
       55 RETURN                           R2 1
