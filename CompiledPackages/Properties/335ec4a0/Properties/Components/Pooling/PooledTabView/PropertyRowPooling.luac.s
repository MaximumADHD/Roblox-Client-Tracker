...
PROTO_2:
       ...
       14 JUMPIFNOTEQKS                    R5 K4 ["Tag"] ; [+15]
       16 GETUPVAL                         R5 1
       17 GETUPVAL                         R6 2
       18 DUPTABLE                         R7 K9 [{"getTag", "session", "LayoutOrder", "Visible"}]
       19 SETTABLEKS                       R4 R7 K5 ["getTag"]
       21 GETUPVAL                         R8 3
       22 SETTABLEKS                       R8 R7 K6 ["session"]
       24 SETTABLEKS                       R2 R7 K7 ["LayoutOrder"]
       26 SETTABLEKS                       R3 R7 K8 ["Visible"]
       28 CALL                             R5 2 -1
       29 RETURN                           R5 -1
       30 GETUPVAL                         R5 1
       31 GETUPVAL                         R6 4
       32 DUPTABLE                         R7 K12 [{"session", "getProperty", "labelWidthBinding", "LayoutOrder", "Visible"}]
       33 GETUPVAL                         R8 3
       34 SETTABLEKS                       R8 R7 K6 ["session"]
       36 SETTABLEKS                       R4 R7 K10 ["getProperty"]
       38 GETUPVAL                         R8 5
       39 SETTABLEKS                       R8 R7 K11 ["labelWidthBinding"]
       41 SETTABLEKS                       R2 R7 K7 ["LayoutOrder"]
       43 SETTABLEKS                       R3 R7 K8 ["Visible"]
       45 CALL                             R5 2 -1
       46 RETURN                           R5 -1
...
PROTO_4:
       ...
       36 MOVE                             R11 R8
       37 CALL                             R10 1 1
       38 GETIMPORT                        R11 K11 [string.lower]
       40 MOVE                             R12 R4
       41 CALL                             R11 1 -1
       42 CALL                             R9 -1 1
       43 JUMPIFNOTEQKNIL                  R9 ; [+2]
       45 LOADB                            R7 0 +1
       46 LOADB                            R7 1
       47 JUMPIF                           R5 ; [+2]
       48 NOT                              R8 R6
...
MAIN:
       ...
       77 GETTABLEKS                       R13 R13 K21 ["getAggregateParts"]
       79 CALL                             R12 1 1
