PROTO_0:
        ...
        4 JUMPIFNOTEQ                      R3 R4 ; [+10]
        6 GETIMPORT                        R3 K2 [error]
        8 LOADK                            R4 K3 ["pointA (%*) and pointB (%*) have the same X value"]
        9 MOVE                             R6 R0
       10 MOVE                             R7 R1
       11 NAMECALL                         R4 R4 K4 ["format"]
       13 CALL                             R4 3 1
       14 CALL                             R3 1 0
       15 GETTABLEKS                       R5 R1 K5 ["Y"]
       17 GETTABLEKS                       R6 R0 K5 ["Y"]
       19 SUB                              R4 R5 R6
       20 GETTABLEKS                       R6 R1 K0 ["X"]
       22 GETTABLEKS                       R7 R0 K0 ["X"]
       24 SUB                              R5 R6 R7
       25 DIV                              R3 R4 R5
       26 GETTABLEKS                       R5 R0 K5 ["Y"]
       28 GETTABLEKS                       R7 R0 K0 ["X"]
       30 MUL                              R6 R7 R3
       31 SUB                              R4 R5 R6
       32 GETIMPORT                        R5 K8 [Vector2.new]
       34 MOVE                             R6 R2
       35 MUL                              R8 R3 R2
       36 ADD                              R7 R8 R4
       37 CALL                             R5 2 -1
...
PROTO_2:
        ...
        8 LOADK                            R3 K4 ["ghost keypoint index (%*) is out of bounds"]
        9 MOVE                             R5 R1
       ...
       16 GETTABLE                         R3 R0 R1
       17 GETIMPORT                        R4 K8 [Vector2.new]
       19 GETTABLEKS                       R5 R2 K9 ["Time"]
       21 GETTABLEKS                       R6 R2 K10 ["Value"]
       23 CALL                             R4 2 1
       24 GETIMPORT                        R5 K8 [Vector2.new]
       26 GETTABLEKS                       R6 R3 K9 ["Time"]
       28 GETTABLEKS                       R7 R3 K10 ["Value"]
       30 CALL                             R5 2 1
       31 LOADNIL                          R6
       32 GETTABLEKS                       R7 R4 K11 ["X"]
       34 GETTABLEKS                       R8 R5 K11 ["X"]
       36 JUMPIFNOTEQ                      R7 R8 ; [+18]
       38 GETTABLEKS                       R8 R4 K12 ["Y"]
       40 GETTABLEKS                       R11 R5 K12 ["Y"]
       42 GETTABLEKS                       R12 R4 K12 ["Y"]
       44 SUB                              R10 R11 R12
       45 DIVK                             R9 R10 K13 [2]
       46 ADD                              R7 R8 R9
       47 GETIMPORT                        R8 K8 [Vector2.new]
       49 GETTABLEKS                       R9 R4 K11 ["X"]
       51 MOVE                             R10 R7
       52 CALL                             R8 2 1
       53 MOVE                             R6 R8
       54 JUMP                             ; [+13]
       55 GETUPVAL                         R7 0
       56 GETTABLEKS                       R7 R7 K14 ["calculatePointOnLine"]
       58 MOVE                             R8 R4
       59 MOVE                             R9 R5
       60 GETTABLEKS                       R12 R2 K9 ["Time"]
       62 GETTABLEKS                       R13 R3 K9 ["Time"]
       64 ADD                              R11 R12 R13
       65 DIVK                             R10 R11 K13 [2]
       66 CALL                             R7 3 1
       67 MOVE                             R6 R7
       68 GETIMPORT                        R7 K16 [NumberSequenceKeypoint.new]
       70 GETTABLEKS                       R8 R6 K11 ["X"]
       72 GETTABLEKS                       R9 R6 K12 ["Y"]
       74 CALL                             R7 2 -1
       75 RETURN                           R7 -1
...
PROTO_8:
        ...
        8 FORGPREP                         R6
        9 LOADNIL                          R11
       10 GETTABLEKS                       R12 R10 K3 ["Envelope"]
       12 JUMPIFNOT                        R3 ; [+20]
       13 LENGTH                           R13 R3
       14 JUMPIFNOTLE                      R9 R13 ; [+18]
       16 GETTABLE                         R13 R3 R9
       17 GETTABLEKS                       R14 R10 K4 ["Value"]
       19 GETTABLEKS                       R15 R13 K4 ["Value"]
       21 JUMPIFLT                         R14 R15 ; [+7]
       23 GETTABLEKS                       R14 R10 K4 ["Value"]
       25 GETTABLEKS                       R15 R13 K4 ["Value"]
       27 JUMPIFNOTLT                      R15 R14 ; [+3]
       29 GETTABLEKS                       R11 R13 K4 ["Value"]
       31 GETTABLEKS                       R12 R13 K3 ["Envelope"]
       33 MOVE                             R14 R11
       34 JUMPIF                           R14 ; [+2]
       35 GETTABLEKS                       R14 R10 K4 ["Value"]
       37 FASTCALL3                        MATH_CLAMP R14 R1 R2
       39 MOVE                             R15 R1
       40 MOVE                             R16 R2
       41 GETIMPORT                        R13 K7 [math.clamp]
       43 CALL                             R13 3 1
       44 GETUPVAL                         R14 0
       45 GETTABLEKS                       R14 R14 K8 ["calculateBoundedEnvelope"]
       47 GETIMPORT                        R15 K11 [Vector2.new]
       49 GETTABLEKS                       R16 R10 K12 ["Time"]
       51 MOVE                             R17 R13
       52 CALL                             R15 2 1
       53 MOVE                             R16 R12
       54 MOVE                             R17 R1
       55 MOVE                             R18 R2
       56 CALL                             R14 4 1
       57 GETIMPORT                        R15 K14 [NumberSequenceKeypoint.new]
       59 GETTABLEKS                       R16 R10 K12 ["Time"]
       61 MOVE                             R17 R13
       62 MOVE                             R18 R14
       63 CALL                             R15 3 1
       64 GETUPVAL                         R16 0
       65 GETTABLEKS                       R16 R16 K15 ["isKeypointEqual"]
       67 MOVE                             R17 R10
       68 MOVE                             R18 R15
       69 CALL                             R16 2 1
       70 JUMPIF                           R16 ; [+2]
       71 SETTABLE                         R15 R4 R9
       72 LOADB                            R5 1
       73 FORGLOOP                         R6 2 ; [-65]
       75 RETURN                           R4 2
