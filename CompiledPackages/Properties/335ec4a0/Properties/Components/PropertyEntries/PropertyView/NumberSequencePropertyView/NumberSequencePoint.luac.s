PROTO_0:
       ...
       12 MOVE                             R0 R1
       13 GETUPVAL                         R1 0
       14 GETTABLEKS                       R1 R1 K6 ["OnKeypointChanged"]
       16 JUMPIFNOT                        R1 ; [+47]
       17 GETUPVAL                         R1 2
...
PROTO_3:
        ...
        4 GETUPVAL                         R2 1
        5 GETTABLEKS                       R2 R2 K1 ["SetDragged"]
        7 JUMPIFNOT                        R2 ; [+8]
        8 GETUPVAL                         R2 1
        9 GETTABLEKS                       R2 R2 K1 ["SetDragged"]
       11 GETUPVAL                         R3 1
       12 GETTABLEKS                       R3 R3 K2 ["KeypointIndex"]
       14 LOADK                            R4 K3 ["Start"]
       15 CALL                             R2 2 0
       16 RETURN                           R0 0

PROTO_4:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R2 R2 K0 ["SetDragged"]
        3 JUMPIFNOT                        R2 ; [+9]
        4 GETUPVAL                         R2 0
        5 GETTABLEKS                       R2 R2 K0 ["SetDragged"]
        7 GETUPVAL                         R3 0
        8 GETTABLEKS                       R3 R3 K1 ["KeypointIndex"]
       10 LOADK                            R4 K2 ["Stop"]
       11 MOVE                             R5 R1
       12 CALL                             R2 3 0
       13 RETURN                           R0 0
