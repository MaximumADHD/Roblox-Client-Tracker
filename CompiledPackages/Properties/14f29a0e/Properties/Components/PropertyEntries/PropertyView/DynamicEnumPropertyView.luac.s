...
PROTO_1:
        ...
        3 GETUPVAL                         R1 1
        4 GETTABLEKS                       R1 R1 K1 ["extraGuestDataKey"]
        6 CALL                             R0 1 1
        7 GETUPVAL                         R1 0
        8 GETTABLEKS                       R1 R1 K2 ["finishEditing"]
       10 GETIMPORT                        R2 K6 [Enum.FinishRecordingOperation.Commit]
       12 CALL                             R1 1 0
       13 LOADB                            R1 0
       14 GETUPVAL                         R2 2
       15 GETTABLEKS                       R2 R2 K7 ["Dictionary"]
       17 GETTABLEKS                       R2 R2 K8 ["map"]
       19 MOVE                             R3 R0
       20 NEWCLOSURE                       R4 P0
       21 CAPTURE                          UPVAL U3
       22 CAPTURE                          REF R1
...
PROTO_4:
       ...
       36 CALL                             R5 1 2
       37 GETUPVAL                         R7 1
       38 GETTABLEKS                       R7 R7 K10 ["useEffect"]
       40 NEWCLOSURE                       R8 P0
       41 CAPTURE                          VAL R0
       42 CAPTURE                          VAL R3
       43 CAPTURE                          UPVAL U2
       ...
       48 CALL                             R7 2 0
       49 GETUPVAL                         R7 1
       50 GETTABLEKS                       R7 R7 K11 ["useCallback"]
       52 NEWCLOSURE                       R8 P1
       53 CAPTURE                          VAL R0
       54 NEWTABLE                         R9 0 3
...
MAIN:
       ...
       34 GETTABLEKS                       R6 R6 K12 ["PropertyViewTypes"]
       36 CALL                             R5 1 1
       37 GETIMPORT                        R6 K6 [require]
       39 GETTABLEKS                       R7 R0 K4 ["Parent"]
       41 GETTABLEKS                       R7 R7 K13 ["React"]
       43 CALL                             R6 1 1
