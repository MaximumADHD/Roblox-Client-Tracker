PROTO_0:
        ...
        5 GETUPVAL                         R2 0
        6 GETUPVAL                         R4 2
        7 GETTABLEKS                       R3 R4 K0 ["Provider"]
       ...
       15 GETUPVAL                         R3 0
       16 GETUPVAL                         R5 3
       17 GETTABLEKS                       R4 R5 K0 ["Provider"]
       ...
       30 GETUPVAL                         R5 0
       31 GETUPVAL                         R7 5
       32 GETTABLEKS                       R6 R7 K0 ["Provider"]
       34 CALL                             R5 1 1
       35 GETUPVAL                         R6 0
       36 GETUPVAL                         R8 6
       37 GETTABLEKS                       R7 R8 K0 ["Provider"]
       39 CALL                             R6 1 1
       40 GETUPVAL                         R7 0
       41 GETUPVAL                         R9 7
       42 GETTABLEKS                       R8 R9 K0 ["Provider"]
       44 CALL                             R7 1 1
       45 GETUPVAL                         R8 0
       46 GETUPVAL                         R10 8
       47 GETTABLEKS                       R9 R10 K0 ["Provider"]
       ...
       55 GETUPVAL                         R9 0
       56 GETUPVAL                         R11 9
       57 GETTABLEKS                       R10 R11 K0 ["Provider"]
       ...
       65 GETUPVAL                         R10 0
       66 GETUPVAL                         R12 10
       67 GETTABLEKS                       R11 R12 K9 ["ContextStack"]
...
MAIN:
       ...
       25 GETTABLEKS                       R5 R6 K13 ["AssetCacheContext"]
       27 CALL                             R4 1 1
       28 GETIMPORT                        R5 K11 [require]
       30 GETTABLEKS                       R7 R2 K12 ["Contexts"]
       32 GETTABLEKS                       R6 R7 K14 ["AssetManagerContext"]
       34 CALL                             R5 1 1
       35 GETIMPORT                        R6 K11 [require]
       37 GETTABLEKS                       R8 R2 K12 ["Contexts"]
       39 GETTABLEKS                       R7 R8 K15 ["BrowserContext"]
       41 CALL                             R6 1 1
       42 GETIMPORT                        R7 K11 [require]
       44 GETTABLEKS                       R9 R2 K12 ["Contexts"]
       46 GETTABLEKS                       R8 R9 K16 ["LayoutContext"]
       48 CALL                             R7 1 1
       ...
       61 GETTABLEKS                       R12 R2 K12 ["Contexts"]
       63 GETTABLEKS                       R11 R12 K19 ["ScopeCacheContext"]
       65 CALL                             R10 1 1
       66 GETIMPORT                        R11 K11 [require]
       68 GETTABLEKS                       R13 R2 K12 ["Contexts"]
       70 GETTABLEKS                       R12 R13 K20 ["ScopeUniqueIdContext"]
       72 CALL                             R11 1 1
       73 GETIMPORT                        R12 K11 [require]
       75 GETTABLEKS                       R14 R2 K12 ["Contexts"]
       77 GETTABLEKS                       R13 R14 K21 ["SortContext"]
       79 CALL                             R12 1 1
       80 GETIMPORT                        R13 K11 [require]
       82 GETTABLEKS                       R14 R3 K22 ["StudioFoundation"]
       84 CALL                             R13 1 1
       85 GETIMPORT                        R14 K11 [require]
       87 GETTABLEKS                       R16 R2 K12 ["Contexts"]
       89 GETTABLEKS                       R15 R16 K23 ["ThemeContext"]
       91 CALL                             R14 1 1
       92 GETIMPORT                        R15 K11 [require]
       94 GETTABLEKS                       R17 R2 K12 ["Contexts"]
       96 GETTABLEKS                       R16 R17 K24 ["UserContext"]
       98 CALL                             R15 1 1
       99 GETTABLEKS                       R17 R13 K25 ["Util"]
      101 GETTABLEKS                       R16 R17 K26 ["StudioUri"]
      103 GETTABLEKS                       R17 R8 K27 ["createElement"]
      ...
      115 CAPTURE                          VAL R15
      116 CAPTURE                          VAL R9
      117 DUPCLOSURE                       R19 K29 [PROTO_6]
      118 CAPTURE                          VAL R0
      119 CAPTURE                          VAL R8
      120 CAPTURE                          VAL R16
      121 CAPTURE                          VAL R17
      122 CAPTURE                          VAL R18
      123 DUPTABLE                         R20 K32 [{"Provider", "StudioProvider"}]
      124 SETTABLEKS                       R18 R20 K30 ["Provider"]
      126 SETTABLEKS                       R19 R20 K31 ["StudioProvider"]
      128 RETURN                           R20 1
