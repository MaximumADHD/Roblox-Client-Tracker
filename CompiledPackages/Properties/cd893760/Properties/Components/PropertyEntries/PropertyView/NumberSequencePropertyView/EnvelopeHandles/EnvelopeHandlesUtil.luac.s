...
MAIN:
       ...
       13 GETTABLEKS                       R2 R2 K8 ["PropertyView"]
       15 GETTABLEKS                       R2 R2 K9 ["NumberSequencePropertyView"]
       17 GETTABLEKS                       R2 R2 K10 ["Types"]
       19 CALL                             R1 1 1
       20 GETIMPORT                        R2 K5 [require]
       22 GETTABLEKS                       R3 R0 K6 ["Components"]
       24 GETTABLEKS                       R3 R3 K7 ["PropertyEntries"]
       26 GETTABLEKS                       R3 R3 K8 ["PropertyView"]
       28 GETTABLEKS                       R3 R3 K9 ["NumberSequencePropertyView"]
       30 GETTABLEKS                       R3 R3 K11 ["NumberSequenceUtil"]
       32 CALL                             R2 1 1
       33 DUPCLOSURE                       R3 K12 [PROTO_0]
       34 DUPCLOSURE                       R4 K13 [PROTO_1]
       35 DUPCLOSURE                       R5 K14 [PROTO_2]
       36 DUPCLOSURE                       R6 K15 [PROTO_3]
       37 DUPCLOSURE                       R7 K16 [PROTO_4]
       38 DUPCLOSURE                       R8 K17 [PROTO_5]
       39 DUPCLOSURE                       R9 K18 [PROTO_6]
       40 DUPCLOSURE                       R10 K19 [PROTO_8]
       41 CAPTURE                          VAL R9
       42 CAPTURE                          VAL R2
       43 DUPTABLE                         R11 K27 [{"toUDim2", "clampEnvelope", "calculateCatmullRomTangents", "calculateCurvePositions", "pixelsPerPlotUnitY", "pixelsPerPlotUnitX", "scalePixelOffsetY"}]
       44 SETTABLEKS                       R3 R11 K20 ["toUDim2"]
       46 SETTABLEKS                       R4 R11 K21 ["clampEnvelope"]
       48 SETTABLEKS                       R5 R11 K22 ["calculateCatmullRomTangents"]
       50 SETTABLEKS                       R10 R11 K23 ["calculateCurvePositions"]
       52 SETTABLEKS                       R6 R11 K24 ["pixelsPerPlotUnitY"]
       54 SETTABLEKS                       R7 R11 K25 ["pixelsPerPlotUnitX"]
       56 SETTABLEKS                       R8 R11 K26 ["scalePixelOffsetY"]
       58 RETURN                           R11 1
