...
PROTO_8:
       ...
       10 JUMPIFNOT                        R3 ; [+18]
       11 LENGTH                           R12 R3
       12 JUMPIFNOTLE                      R9 R12 ; [+16]
       14 GETTABLE                         R12 R3 R9
       15 GETTABLEKS                       R13 R10 K3 ["Value"]
       17 GETTABLEKS                       R14 R12 K3 ["Value"]
       19 JUMPIFLT                         R13 R14 ; [+7]
       21 GETTABLEKS                       R13 R10 K3 ["Value"]
       23 GETTABLEKS                       R14 R12 K3 ["Value"]
       25 JUMPIFNOTLT                      R14 R13 ; [+3]
       27 GETTABLEKS                       R11 R12 K3 ["Value"]
       29 MOVE                             R13 R11
       30 JUMPIF                           R13 ; [+2]
       31 GETTABLEKS                       R13 R10 K3 ["Value"]
       33 FASTCALL3                        MATH_CLAMP R13 R1 R2
       35 MOVE                             R14 R1
       36 MOVE                             R15 R2
       37 GETIMPORT                        R12 K6 [math.clamp]
       39 CALL                             R12 3 1
       40 GETUPVAL                         R13 0
       41 GETTABLEKS                       R13 R13 K7 ["calculateBoundedEnvelope"]
       43 GETIMPORT                        R14 K10 [Vector2.new]
       45 GETTABLEKS                       R15 R10 K11 ["Time"]
       47 MOVE                             R16 R12
       48 CALL                             R14 2 1
       49 GETTABLEKS                       R15 R10 K12 ["Envelope"]
       51 MOVE                             R16 R1
       52 MOVE                             R17 R2
       53 CALL                             R13 4 1
       54 GETIMPORT                        R14 K14 [NumberSequenceKeypoint.new]
       56 GETTABLEKS                       R15 R10 K11 ["Time"]
       58 MOVE                             R16 R12
       59 MOVE                             R17 R13
       60 CALL                             R14 3 1
       61 GETUPVAL                         R15 0
       62 GETTABLEKS                       R15 R15 K15 ["isKeypointEqual"]
       64 MOVE                             R16 R10
       65 MOVE                             R17 R14
       66 CALL                             R15 2 1
       67 JUMPIF                           R15 ; [+2]
       68 SETTABLE                         R14 R4 R9
       69 LOADB                            R5 1
       70 FORGLOOP                         R6 2 ; [-62]
       72 RETURN                           R4 2
