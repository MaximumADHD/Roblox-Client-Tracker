...
PROTO_16:
        ...
        5 FORNPREP                         R1
        6 NEWTABLE                         R4 0 3
        8 DUPTABLE                         R5 K8 [{[1] = "Number", ["name"] = "Time", ["part"], ["onChange"], ["step"] = 0.001}]
        9 GETUPVAL                         R6 1
       10 MOVE                             R7 R3
...
PROTO_18:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["deleteKeypointAsync"]
        3 MOVE                             R2 R0
        4 CALL                             R1 1 0
        5 GETUPVAL                         R1 1
...
PROTO_19:
        ...
        6 CALL                             R1 1 1
        7 GETUPVAL                         R2 2
        8 GETTABLEKS                       R2 R2 K2 ["addKeypointAsync"]
       10 MOVE                             R3 R0
       11 GETUPVAL                         R4 0
...
PROTO_20:
       ...
       89 GETUPVAL                         R13 6
       90 GETUPVAL                         R14 7
       91 DUPTABLE                         R15 K18 [{"rowSlots", "rowsCount", "layoutOrders", "maxRowsBeforeScroll", "selectedRow", "setSelectedRow", "onEditStart", "onEditFinish", "onDelete", "onAdd"}]
      ...
      101 GETTABLEKS                       R16 R5 K19 ["MaxRows"]
      103 SETTABLEKS                       R16 R15 K11 ["maxRowsBeforeScroll"]
      105 GETTABLEKS                       R16 R0 K20 ["selectedUnorderedKeypoint"]
      107 SETTABLEKS                       R16 R15 K12 ["selectedRow"]
      109 GETTABLEKS                       R16 R0 K21 ["SetSelectedUnorderedKeypoint"]
      111 SETTABLEKS                       R16 R15 K13 ["setSelectedRow"]
      113 NEWCLOSURE                       R16 P7
      114 CAPTURE                          VAL R1
      115 CAPTURE                          VAL R3
      116 SETTABLEKS                       R16 R15 K14 ["onEditStart"]
      118 GETTABLEKS                       R16 R1 K22 ["finishEditing"]
      120 SETTABLEKS                       R16 R15 K15 ["onEditFinish"]
      122 NEWCLOSURE                       R16 P8
      123 CAPTURE                          VAL R1
      124 CAPTURE                          VAL R0
      125 SETTABLEKS                       R16 R15 K16 ["onDelete"]
      127 NEWCLOSURE                       R16 P9
      128 CAPTURE                          UPVAL U2
      129 CAPTURE                          VAL R0
      130 CAPTURE                          VAL R1
      131 SETTABLEKS                       R16 R15 K17 ["onAdd"]
      133 CALL                             R13 2 -1
      134 RETURN                           R13 -1
...
MAIN:
       ...
       78 DUPCLOSURE                       R13 K22 [PROTO_20]
       79 CAPTURE                          VAL R5
       80 CAPTURE                          VAL R10
       81 CAPTURE                          VAL R3
       82 CAPTURE                          VAL R6
