...
PROTO_2:
        ...
        2 GETTABLEKS                       R1 R2 K1 ["DeprecationMessage"]
        4 JUMPIFNOT                        R1 ; [+2]
        5 LOADB                            R1 0
        6 RETURN                           R1 1
        7 GETTABLEKS                       R2 R0 K2 ["Permits"]
        9 GETTABLEKS                       R1 R2 K3 ["Read"]
       11 JUMPIF                           R1 ; [+2]
       12 LOADB                            R1 0
       13 RETURN                           R1 1
       14 LOADB                            R1 1
...
PROTO_3:
        0 RETURN                           R0 0
        1 GETIMPORT                        R3 K2 [table.concat]
        3 NEWTABLE                         R4 0 3
        5 MOVE                             R5 R0
        6 MOVE                             R6 R1
        7 MOVE                             R7 R2
       ...
       17 LOADK                            R6 K6 ["Unmapped property %*"]
       18 MOVE                             R8 R3
...
PROTO_4:
        0 GETTABLEKS                       R3 R0 K0 ["Display"]
        2 GETTABLEKS                       R2 R3 K1 ["DeprecationMessage"]
        4 JUMPIFNOT                        R2 ; [+2]
        5 LOADB                            R1 0
        6 JUMP                             ; [+8]
        7 GETTABLEKS                       R3 R0 K2 ["Permits"]
        9 GETTABLEKS                       R2 R3 K3 ["Read"]
       11 JUMPIF                           R2 ; [+2]
       12 LOADB                            R1 0
       13 JUMP                             ; [+1]
       14 LOADB                            R1 1
       ...
       17 RETURN                           R1 1
       18 LOADNIL                          R1
       19 GETTABLEKS                       R3 R0 K4 ["Type"]
       21 GETTABLEKS                       R2 R3 K5 ["EngineType"]
       23 GETTABLEKS                       R4 R0 K4 ["Type"]
       25 GETTABLEKS                       R3 R4 K6 ["ScriptType"]
       27 JUMPIF                           R3 ; [+3]
       28 JUMPIFNOTEQKS                    R2 K7 ["UniqueId"] ; [+2]
       30 LOADK                            R3 K8 ["string"]
       31 JUMPIF                           R3 ; [+13]
       32 GETIMPORT                        R4 K10 [warn]
       34 LOADK                            R5 K11 ["No ScriptType for property:"]
       35 GETTABLEKS                       R6 R0 K12 ["Name"]
       37 LOADK                            R7 K13 ["EngineType:"]
       38 MOVE                             R8 R2
       39 LOADK                            R9 K14 ["Owner:"]
       40 GETTABLEKS                       R10 R0 K15 ["Owner"]
       42 CALL                             R4 6 0
       43 LOADNIL                          R4
       44 RETURN                           R4 1
       45 GETUPVAL                         R5 0
       ...
       52 MOVE                             R1 R4
       53 JUMPIFNOTEQKS                    R1 K16 ["number"] ; [+14]
       55 JUMPIFEQKS                       R2 K17 ["float"] ; [+3]
       57 JUMPIFNOTEQKS                    R2 K18 ["double"] ; [+3]
       59 LOADK                            R1 K17 ["float"]
       60 JUMP                             ; [+7]
       61 JUMPIFEQKS                       R2 K19 ["int"] ; [+3]
       63 JUMPIFNOTEQKS                    R2 K20 ["int64"] ; [+3]
       65 LOADK                            R1 K19 ["int"]
       66 JUMP                             ; [+1]
       67 LOADK                            R1 K16 ["number"]
       68 JUMPIF                           R1 ; [+7]
       69 GETUPVAL                         R4 2
       70 GETTABLEKS                       R5 R0 K15 ["Owner"]
       72 MOVE                             R6 R2
       73 MOVE                             R7 R3
       74 CALL                             R4 3 0
       75 MOVE                             R1 R3
       76 DUPTABLE                         R4 K29 [{"name", "owner", "assetType", "enumName", "instanceRefType", "readonly", "type", "category"}]
       77 GETTABLEKS                       R5 R0 K12 ["Name"]
       79 SETTABLEKS                       R5 R4 K21 ["name"]
       81 GETTABLEKS                       R5 R0 K15 ["Owner"]
       83 SETTABLEKS                       R5 R4 K22 ["owner"]
       85 GETTABLEKS                       R5 R0 K30 ["ContentType"]
       87 SETTABLEKS                       R5 R4 K23 ["assetType"]
       89 GETTABLEKS                       R6 R0 K4 ["Type"]
       91 GETTABLEKS                       R5 R6 K31 ["EnumType"]
       93 SETTABLEKS                       R5 R4 K24 ["enumName"]
       95 GETTABLEKS                       R6 R0 K4 ["Type"]
       97 GETTABLEKS                       R5 R6 K32 ["InstanceType"]
       99 SETTABLEKS                       R5 R4 K25 ["instanceRefType"]
      101 GETTABLEKS                       R7 R0 K2 ["Permits"]
      103 GETTABLEKS                       R6 R7 K33 ["Write"]
      105 NOT                              R5 R6
      106 SETTABLEKS                       R5 R4 K26 ["readonly"]
      108 SETTABLEKS                       R1 R4 K27 ["type"]
      110 GETTABLEKS                       R6 R0 K0 ["Display"]
      112 GETTABLEKS                       R5 R6 K34 ["Category"]
      114 SETTABLEKS                       R5 R4 K28 ["category"]
      116 GETUPVAL                         R5 3
      117 MOVE                             R6 R4
      118 CALL                             R5 1 1
      119 JUMPIF                           R5 ; [+2]
...
MAIN:
       ...
       21 GETTABLEKS                       R4 R5 K9 ["filterOutProperties"]
       23 CALL                             R3 1 1
       ...
       60 NEWTABLE                         R11 0 0
       62 LOADK                            R12 K26 ["DynamicEnum"]
       63 SETTABLEKS                       R12 R11 K27 ["CollisionGroup"]
       65 NEWTABLE                         R12 0 0
       67 DUPCLOSURE                       R13 K28 [PROTO_3]
       68 CAPTURE                          VAL R12
       69 DUPCLOSURE                       R14 K29 [PROTO_4]
       70 CAPTURE                          VAL R11
       71 CAPTURE                          VAL R10
       72 CAPTURE                          VAL R13
       73 CAPTURE                          VAL R3
       74 DUPCLOSURE                       R15 K30 [PROTO_5]
       75 CAPTURE                          VAL R5
       76 CAPTURE                          VAL R7
       77 DUPCLOSURE                       R16 K31 [PROTO_6]
       78 CAPTURE                          VAL R5
       79 CAPTURE                          VAL R7
       80 NEWTABLE                         R17 0 0
       82 DUPCLOSURE                       R18 K32 [PROTO_7]
       83 CAPTURE                          VAL R17
       84 CAPTURE                          VAL R5
       85 CAPTURE                          VAL R7
