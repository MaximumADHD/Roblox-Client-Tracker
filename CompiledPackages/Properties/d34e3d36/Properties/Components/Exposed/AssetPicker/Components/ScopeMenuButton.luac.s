...
PROTO_1:
       ...
       23 GETTABLEKS                       R10 R6 K6 ["uniqueId"]
       25 SETTABLEKS                       R10 R9 K3 ["id"]
       27 GETUPVAL                         R10 1
       28 LOADK                            R12 K7 ["ScopeMenuItem"]
       29 LOADK                            R13 K2 ["Universe"]
       30 NAMECALL                         R10 R10 K8 ["getText"]
       32 CALL                             R10 3 1
       33 SETTABLEKS                       R10 R9 K4 ["text"]
       35 FASTCALL2                        TABLE_INSERT R1 R9 ; [+4]
       37 MOVE                             R8 R1
       38 GETIMPORT                        R7 K11 [table.insert]
       40 CALL                             R7 2 0
       41 JUMP                             ; [+60]
       42 GETTABLEKS                       R7 R6 K1 ["type"]
       44 JUMPIFNOTEQKS                    R7 K12 ["User"] ; [+27]
       46 LOADN                            R9 1
       47 DUPTABLE                         R10 K5 [{"id", "text"}]
       48 GETTABLEKS                       R11 R6 K6 ["uniqueId"]
       50 SETTABLEKS                       R11 R10 K3 ["id"]
       52 GETUPVAL                         R11 1
       53 LOADK                            R13 K7 ["ScopeMenuItem"]
       54 LOADK                            R14 K12 ["User"]
       55 DUPTABLE                         R15 K14 [{"user"}]
       56 GETTABLEKS                       R16 R6 K15 ["name"]
       58 SETTABLEKS                       R16 R15 K13 ["user"]
       60 NAMECALL                         R11 R11 K8 ["getText"]
       62 CALL                             R11 4 1
       63 SETTABLEKS                       R11 R10 K4 ["text"]
       65 FASTCALL3                        TABLE_INSERT R0 R9 R10
       67 MOVE                             R8 R0
       68 GETIMPORT                        R7 K11 [table.insert]
       70 CALL                             R7 3 0
       71 JUMP                             ; [+30]
       72 GETTABLEKS                       R7 R6 K1 ["type"]
       74 JUMPIFNOTEQKS                    R7 K16 ["Group"] ; [+17]
       76 DUPTABLE                         R9 K5 [{"id", "text"}]
       77 GETTABLEKS                       R10 R6 K6 ["uniqueId"]
       79 SETTABLEKS                       R10 R9 K3 ["id"]
       81 GETTABLEKS                       R10 R6 K15 ["name"]
       83 SETTABLEKS                       R10 R9 K4 ["text"]
       85 FASTCALL2                        TABLE_INSERT R0 R9 ; [+4]
       87 MOVE                             R8 R0
       88 GETIMPORT                        R7 K11 [table.insert]
       90 CALL                             R7 2 0
       91 JUMP                             ; [+10]
       92 GETIMPORT                        R7 K18 [error]
       94 LOADK                            R9 K19 ["Unsupported scope type: %*"]
       95 GETTABLEKS                       R11 R6 K1 ["type"]
       97 NAMECALL                         R9 R9 K20 ["format"]
       99 CALL                             R9 2 1
      100 MOVE                             R8 R9
      101 CALL                             R7 1 0
      102 FORGLOOP                         R2 2 ; [-85]
      104 NEWTABLE                         R2 0 2
      106 DUPTABLE                         R3 K22 [{"id", "text", "items"}]
      107 LOADK                            R4 K23 ["UserAndGroup"]
      108 SETTABLEKS                       R4 R3 K3 ["id"]
      110 LOADNIL                          R4
      111 SETTABLEKS                       R4 R3 K4 ["text"]
      113 SETTABLEKS                       R0 R3 K21 ["items"]
      115 DUPTABLE                         R4 K22 [{"id", "text", "items"}]
      116 LOADK                            R5 K24 ["OpenAssetManager"]
      117 SETTABLEKS                       R5 R4 K3 ["id"]
      119 LOADNIL                          R5
      120 SETTABLEKS                       R5 R4 K4 ["text"]
      122 NEWTABLE                         R5 0 1
      124 DUPTABLE                         R6 K5 [{"id", "text"}]
      125 LOADK                            R7 K24 ["OpenAssetManager"]
      126 SETTABLEKS                       R7 R6 K3 ["id"]
      128 GETUPVAL                         R7 1
      129 LOADK                            R9 K7 ["ScopeMenuItem"]
      130 LOADK                            R10 K24 ["OpenAssetManager"]
      131 NAMECALL                         R7 R7 K8 ["getText"]
      133 CALL                             R7 3 1
      134 SETTABLEKS                       R7 R6 K4 ["text"]
      136 SETLIST                          R5 R6 1 [1]
      138 SETTABLEKS                       R5 R4 K21 ["items"]
      140 SETLIST                          R2 R3 2 [1]
      142 LENGTH                           R3 R1
      143 LOADN                            R4 0
      144 JUMPIFNOTLT                      R4 R3 ; [+17]
      146 LOADN                            R5 1
      147 DUPTABLE                         R6 K22 [{"id", "text", "items"}]
      148 LOADK                            R7 K2 ["Universe"]
      149 SETTABLEKS                       R7 R6 K3 ["id"]
      151 LOADNIL                          R7
      152 SETTABLEKS                       R7 R6 K4 ["text"]
      154 SETTABLEKS                       R1 R6 K21 ["items"]
      156 FASTCALL3                        TABLE_INSERT R2 R5 R6
      158 MOVE                             R4 R2
      159 GETIMPORT                        R3 K11 [table.insert]
      161 CALL                             R3 3 0
      162 RETURN                           R2 1
...
PROTO_3:
       ...
       77 LOADK                            R19 K25 ["padding-x-small radius-small row align-y-center gap-xsmall"]
      ...
      221 GETTABLEKS                       R23 R24 K67 ["ChevronSmallDown"]
