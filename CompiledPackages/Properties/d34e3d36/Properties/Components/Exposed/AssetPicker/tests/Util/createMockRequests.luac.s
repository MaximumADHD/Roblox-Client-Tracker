...
PROTO_2:
       ...
       12 RETURN                           R1 2
       13 GETUPVAL                         R2 0
       14 GETTABLEKS                       R1 R2 K6 ["requestToYield"]
       16 JUMPIFEQKS                       R1 K7 ["All"] ; [+6]
       18 GETUPVAL                         R2 0
       19 GETTABLEKS                       R1 R2 K6 ["requestToYield"]
       ...
       32 JUMPIFNOTEQKS                    R6 K13 ["Universe"] ; [+17]
       34 GETTABLEKS                       R6 R5 K14 ["id"]
       36 GETTABLEKS                       R7 R0 K15 ["gameId"]
       38 JUMPIFNOTEQ                      R6 R7 ; [+11]
       40 LOADB                            R6 1
       41 DUPTABLE                         R7 K2 [{"responseBody"}]
       42 DUPTABLE                         R8 K4 [{"name"}]
       43 GETTABLEKS                       R9 R5 K3 ["name"]
       45 SETTABLEKS                       R9 R8 K3 ["name"]
       47 SETTABLEKS                       R8 R7 K1 ["responseBody"]
       49 RETURN                           R6 2
       50 FORGLOOP                         R1 2 ; [-21]
       52 LOADB                            R1 1
       53 DUPTABLE                         R2 K2 [{"responseBody"}]
       54 DUPTABLE                         R3 K4 [{"name"}]
       55 LOADK                            R4 K5 [""]
       56 SETTABLEKS                       R4 R3 K3 ["name"]
...
PROTO_3:
       ...
       13 RETURN                           R1 2
       14 GETUPVAL                         R2 0
       15 GETTABLEKS                       R1 R2 K5 ["requestToYield"]
       17 JUMPIFEQKS                       R1 K6 ["All"] ; [+6]
       19 GETUPVAL                         R2 0
       20 GETTABLEKS                       R1 R2 K5 ["requestToYield"]
...
PROTO_5:
       ...
       16 RETURN                           R1 2
       17 GETUPVAL                         R2 0
       18 GETTABLEKS                       R1 R2 K6 ["requestToYield"]
       20 JUMPIFEQKS                       R1 K7 ["All"] ; [+6]
       22 GETUPVAL                         R2 0
       23 GETTABLEKS                       R1 R2 K6 ["requestToYield"]
       25 JUMPIFNOTEQKS                    R1 K8 ["Asset"] ; [+4]
       27 GETIMPORT                        R1 K11 [coroutine.yield]
       29 CALL                             R1 0 0
       30 GETUPVAL                         R1 1
       31 GETTABLEKS                       R3 R0 K12 ["scopeParams"]
       33 GETTABLEKS                       R2 R3 K13 ["Type"]
       35 GETTABLEKS                       R4 R0 K12 ["scopeParams"]
       37 GETTABLEKS                       R3 R4 K14 ["Id"]
       39 CALL                             R1 2 1
       40 GETUPVAL                         R3 2
       ...
       47 JUMPIFEQKS                       R3 K16 [""] ; [+37]
       49 NEWTABLE                         R3 0 0
       51 MOVE                             R4 R2
       52 LOADNIL                          R5
       53 LOADNIL                          R6
       54 FORGPREP                         R4
       55 GETTABLEKS                       R10 R8 K17 ["assetItem"]
       57 GETTABLEKS                       R9 R10 K18 ["asset"]
       59 GETIMPORT                        R10 K21 [string.find]
       61 GETTABLEKS                       R11 R9 K22 ["displayName"]
       63 NAMECALL                         R11 R11 K23 ["lower"]
       65 CALL                             R11 1 1
       66 GETTABLEKS                       R12 R0 K15 ["query"]
       68 NAMECALL                         R12 R12 K23 ["lower"]
       70 CALL                             R12 1 1
       71 LOADN                            R13 1
       72 LOADB                            R14 1
       73 CALL                             R10 4 1
       ...
       77 MOVE                             R11 R3
       78 MOVE                             R12 R8
       79 GETIMPORT                        R10 K26 [table.insert]
       81 CALL                             R10 2 0
       82 FORGLOOP                         R4 2 ; [-28]
       84 MOVE                             R2 R3
       85 GETUPVAL                         R4 0
       86 GETTABLEKS                       R3 R4 K27 ["pageSize"]
       88 JUMPIFEQKNIL                     R3 ; [+19]
       90 GETUPVAL                         R3 3
       91 MOVE                             R4 R2
       92 GETTABLEKS                       R5 R0 K28 ["pageToken"]
       94 GETUPVAL                         R7 0
       95 GETTABLEKS                       R6 R7 K27 ["pageSize"]
       97 CALL                             R3 3 2
       98 LOADB                            R5 1
       99 DUPTABLE                         R6 K2 [{"responseBody"}]
      100 DUPTABLE                         R7 K5 [{"items", "nextPageToken"}]
      101 SETTABLEKS                       R3 R7 K3 ["items"]
      103 SETTABLEKS                       R4 R7 K4 ["nextPageToken"]
      105 SETTABLEKS                       R7 R6 K1 ["responseBody"]
      107 RETURN                           R5 2
      108 LOADB                            R3 1
      109 DUPTABLE                         R4 K2 [{"responseBody"}]
      110 DUPTABLE                         R5 K5 [{"items", "nextPageToken"}]
      111 SETTABLEKS                       R2 R5 K3 ["items"]
      113 LOADNIL                          R6
      114 SETTABLEKS                       R6 R5 K4 ["nextPageToken"]
      116 SETTABLEKS                       R5 R4 K1 ["responseBody"]
      118 RETURN                           R3 2
...
PROTO_6:
        ...
        6 LOADNIL                          R8
        7 FORGPREP                         R6
        8 GETTABLEKS                       R12 R10 K0 ["assetItem"]
       10 GETTABLEKS                       R11 R12 K1 ["asset"]
       12 GETTABLEKS                       R12 R11 K2 ["assetId"]
       14 GETTABLEKS                       R13 R0 K2 ["assetId"]
       16 JUMPIFNOTEQ                      R12 R13 ; [+44]
       18 GETTABLEKS                       R13 R11 K3 ["creationContext"]
       20 GETTABLEKS                       R12 R13 K4 ["creator"]
       ...
       27 GETIMPORT                        R15 K16 [Enum.AssetType.Image]
       29 GETTABLEKS                       R14 R15 K17 ["Value"]
...
PROTO_7:
       ...
       16 CALL                             R8 2 0
       17 GETUPVAL                         R8 0
       18 GETTABLEKS                       R10 R7 K1 ["scope"]
       20 GETTABLEKS                       R9 R10 K5 ["type"]
       22 GETTABLEKS                       R11 R7 K1 ["scope"]
       24 GETTABLEKS                       R10 R11 K6 ["id"]
       26 CALL                             R8 2 1
       ...
       71 NEWCLOSURE                       R7 P4
       72 CAPTURE                          VAL R1
       73 DUPTABLE                         R8 K17 [{"requestUniverseNameAsync", "requestGroupsAsync", "requestUserDisplayNameAsync", "requestAssetItemsAsync", "getAssetProductInfoAsync"}]
       74 SETTABLEKS                       R3 R8 K12 ["requestUniverseNameAsync"]
...
MAIN:
       ...
       23 GETTABLEKS                       R4 R5 K9 ["createScopeUniqueId"]
       25 CALL                             R3 1 1
       26 LOADN                            R4 0
       27 NEWCLOSURE                       R5 P0
       28 CAPTURE                          REF R4
