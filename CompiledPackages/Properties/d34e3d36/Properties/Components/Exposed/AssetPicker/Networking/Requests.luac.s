...
PROTO_4:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R1 R2 K0 ["search"]
        3 GETTABLEKS                       R2 R0 K1 ["query"]
        5 GETTABLEKS                       R4 R0 K2 ["assetType"]
        7 GETTABLEKS                       R3 R4 K3 ["Name"]
        9 GETTABLEKS                       R4 R0 K4 ["scopeParams"]
       11 GETTABLEKS                       R5 R0 K5 ["maxPageSize"]
       13 GETTABLEKS                       R6 R0 K6 ["pageToken"]
       15 CALL                             R1 5 1
       16 NAMECALL                         R2 R1 K7 ["makeRequest"]
       18 CALL                             R2 1 1
       19 NAMECALL                         R2 R2 K8 ["await"]
       21 CALL                             R2 1 -1
       22 RETURN                           R2 -1
...
MAIN:
       ...
       62 CAPTURE                          VAL R0
       63 DUPTABLE                         R14 K30 [{"requestUniverseNameAsync", "requestGroupsAsync", "requestUserDisplayNameAsync", "requestAssetItemsAsync", "getAssetProductInfoAsync"}]
       64 SETTABLEKS                       R9 R14 K25 ["requestUniverseNameAsync"]
