...
PROTO_1:
      ...
      107 LOADK                            R4 K2 ["Universe"]
      108 SETTABLEKS                       R4 R3 K3 ["id"]
      110 LOADNIL                          R4
      111 SETTABLEKS                       R4 R3 K4 ["text"]
      113 SETTABLEKS                       R1 R3 K20 ["items"]
      115 DUPTABLE                         R4 K21 [{"id", "text", "items"}]
      116 LOADK                            R5 K22 ["UserAndGroup"]
      117 SETTABLEKS                       R5 R4 K3 ["id"]
      119 LOADNIL                          R5
      120 SETTABLEKS                       R5 R4 K4 ["text"]
      122 SETTABLEKS                       R0 R4 K20 ["items"]
      124 DUPTABLE                         R5 K21 [{"id", "text", "items"}]
      125 LOADK                            R6 K23 ["OpenAssetManager"]
      126 SETTABLEKS                       R6 R5 K3 ["id"]
      128 LOADNIL                          R6
      129 SETTABLEKS                       R6 R5 K4 ["text"]
      131 NEWTABLE                         R6 0 1
      133 DUPTABLE                         R7 K5 [{"id", "text"}]
      134 LOADK                            R8 K23 ["OpenAssetManager"]
      135 SETTABLEKS                       R8 R7 K3 ["id"]
      137 LOADK                            R8 K24 ["Open Asset Manager..."]
      138 SETTABLEKS                       R8 R7 K4 ["text"]
      140 SETLIST                          R6 R7 1 [1]
      142 SETTABLEKS                       R6 R5 K20 ["items"]
      144 SETLIST                          R2 R3 3 [1]
      146 RETURN                           R2 1
