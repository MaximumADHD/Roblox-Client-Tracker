...
PROTO_5:
        ...
        3 MOVE                             R3 R0
        4 GETTABLEKS                       R4 R1 K1 ["fromStateId"]
        6 CALL                             R2 2 1
        7 LOADB                            R3 0
        8 JUMPIFEQKNIL                     R2 ; [+7]
       10 GETTABLEKS                       R4 R2 K2 ["isStart"]
...
PROTO_11:
        ...
        2 JUMPIFNOT                        R4 ; [+8]
        3 GETUPVAL                         R3 1
        4 GETTABLEKS                       R3 R3 K0 ["getUniqueStateName"]
        6 MOVE                             R4 R0
        7 MOVE                             R5 R1
        8 MOVE                             R6 R2
        9 CALL                             R3 3 1
...
MAIN:
       ...
       17 GETTABLEKS                       R3 R3 K11 ["StateMachineUtils"]
       19 CALL                             R2 1 1
       20 GETIMPORT                        R3 K9 [require]
       22 GETTABLEKS                       R4 R0 K12 ["Data"]
       24 GETTABLEKS                       R4 R4 K13 ["StateMachineTypes"]
       26 CALL                             R3 1 1
       27 GETIMPORT                        R4 K9 [require]
       29 GETTABLEKS                       R5 R0 K14 ["Flags"]
       31 GETTABLEKS                       R5 R5 K15 ["getFFlagAnimGraphUI_FixDuplicateStateNames"]
       33 CALL                             R4 1 1
       34 NEWTABLE                         R5 32 0
       36 LOADN                            R6 1
       37 SETTABLEKS                       R6 R5 K16 ["CURRENT_VERSION"]
       39 LOADK                            R6 K17 ["(Entry)"]
       40 SETTABLEKS                       R6 R5 K18 ["ENTRY_STATE_NAME"]
       42 LOADK                            R6 K19 ["(Any)"]
       43 SETTABLEKS                       R6 R5 K20 ["ANY_STATE_NAME"]
       45 DUPTABLE                         R6 K28 [{["Length"] = 0.2, ["Curve"], ["Priority"] = 1, ["TriggerExpression"] = ""}]
       46 GETIMPORT                        R7 K32 [Enum.PoseEasingStyle.Linear]
       48 SETTABLEKS                       R7 R6 K23 ["Curve"]
       50 DUPCLOSURE                       R7 K33 [PROTO_0]
       51 CAPTURE                          VAL R1
       52 DUPCLOSURE                       R8 K34 [PROTO_1]
       53 CAPTURE                          VAL R1
       54 CAPTURE                          VAL R5
       55 SETTABLEKS                       R8 R5 K35 ["getDefault"]
       57 DUPCLOSURE                       R9 K36 [PROTO_2]
       58 DUPCLOSURE                       R10 K37 [PROTO_3]
       59 SETTABLEKS                       R10 R5 K38 ["getState"]
       61 DUPCLOSURE                       R10 K39 [PROTO_4]
       62 SETTABLEKS                       R10 R5 K40 ["getTransition"]
       64 DUPCLOSURE                       R10 K41 [PROTO_5]
       65 CAPTURE                          VAL R5
       66 SETTABLEKS                       R10 R5 K42 ["isEntryTransition"]
       68 DUPCLOSURE                       R10 K43 [PROTO_6]
       69 CAPTURE                          VAL R9
       70 CAPTURE                          VAL R1
       71 SETTABLEKS                       R10 R5 K44 ["addState"]
       73 DUPCLOSURE                       R10 K45 [PROTO_7]
       74 SETTABLEKS                       R10 R5 K46 ["findFreePosition"]
       76 DUPCLOSURE                       R10 K47 [PROTO_8]
       77 SETTABLEKS                       R10 R5 K48 ["isSynthetic"]
       79 DUPCLOSURE                       R10 K49 [PROTO_9]
       80 CAPTURE                          VAL R9
       81 DUPCLOSURE                       R11 K50 [PROTO_10]
       82 CAPTURE                          VAL R10
       83 SETTABLEKS                       R11 R5 K51 ["moveState"]
       85 DUPCLOSURE                       R11 K52 [PROTO_11]
       86 CAPTURE                          VAL R4
       87 CAPTURE                          VAL R2
       88 CAPTURE                          VAL R10
       89 SETTABLEKS                       R11 R5 K53 ["renameState"]
       91 DUPCLOSURE                       R11 K54 [PROTO_12]
       92 CAPTURE                          VAL R9
       93 SETTABLEKS                       R11 R5 K55 ["deleteState"]
       95 DUPCLOSURE                       R11 K56 [PROTO_13]
       96 SETTABLEKS                       R11 R5 K57 ["hasTransition"]
       98 DUPCLOSURE                       R11 K58 [PROTO_14]
       99 SETTABLEKS                       R11 R5 K59 ["hasOutgoingTransition"]
      101 DUPCLOSURE                       R11 K60 [PROTO_15]
      102 CAPTURE                          VAL R9
      103 CAPTURE                          VAL R1
      104 CAPTURE                          VAL R6
      105 SETTABLEKS                       R11 R5 K61 ["addTransition"]
      107 DUPCLOSURE                       R11 K62 [PROTO_16]
      108 CAPTURE                          VAL R9
      109 SETTABLEKS                       R11 R5 K63 ["deleteTransition"]
      111 DUPCLOSURE                       R11 K64 [PROTO_17]
      112 CAPTURE                          VAL R9
      113 SETTABLEKS                       R11 R5 K65 ["setTransitionField"]
      115 RETURN                           R5 1
