...
PROTO_3:
       ...
       57 NEWTABLE                         R8 0 1
       59 DUPTABLE                         R10 K17 [{["id"] = "delete", ["text"] = "Delete", ["isDisabled"], ["onActivated"]}]
       60 NOT                              R11 R3
       61 SETTABLEKS                       R11 R10 K15 ["isDisabled"]
       63 SETTABLEKS                       R4 R10 K16 ["onActivated"]
       65 MOVE                             R9 R10
       66 SETLIST                          R8 R9 1 [1]
       68 SETTABLEKS                       R8 R7 K9 ["items"]
       70 DUPTABLE                         R8 K10 [{"items"}]
       71 NEWTABLE                         R9 0 1
       73 DUPTABLE                         R11 K19 [{["id"] = "frameSelection", ["text"] = "Frame Selection", ["onActivated"]}]
       74 SETTABLEKS                       R5 R11 K16 ["onActivated"]
       76 MOVE                             R10 R11
       77 SETLIST                          R9 R10 1 [1]
       79 SETTABLEKS                       R9 R8 K9 ["items"]
       81 SETLIST                          R6 R7 2 [1]
       83 GETUPVAL                         R7 0
       84 GETTABLEKS                       R7 R7 K20 ["createElement"]
       86 GETUPVAL                         R8 3
       87 GETTABLEKS                       R8 R8 K21 ["Menu"]
       89 DUPTABLE                         R9 K24 [{"isOpen", "items", "onPressedOutside", "size"}]
       90 GETTABLEKS                       R10 R0 K8 ["isOpen"]
       92 SETTABLEKS                       R10 R9 K8 ["isOpen"]
       94 SETTABLEKS                       R6 R9 K9 ["items"]
       96 GETTABLEKS                       R10 R0 K6 ["close"]
       98 SETTABLEKS                       R10 R9 K22 ["onPressedOutside"]
      100 GETUPVAL                         R10 3
      101 GETTABLEKS                       R10 R10 K25 ["Enums"]
      103 GETTABLEKS                       R10 R10 K26 ["InputSize"]
      105 GETTABLEKS                       R10 R10 K27 ["XSmall"]
      107 SETTABLEKS                       R10 R9 K23 ["size"]
      109 CALL                             R7 2 -1
      110 RETURN                           R7 -1
