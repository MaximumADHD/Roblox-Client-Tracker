PROTO_0:
        ...
        5 CALL                             R3 1 1
        6 LOADK                            R4 K2 ["table"]
        7 LOADK                            R5 K3 ["Attempted to call Dash.pick with argument #1 of type {left:?} not {right:?}"]
        8 CALL                             R2 3 0
        9 GETUPVAL                         R2 0
       ...
       16 LOADK                            R5 K5 ["Attempted to call Dash.pick with argument #2 of type {left:?} not {right:?}"]
       17 CALL                             R2 3 0
       18 NEWTABLE                         R2 0 0
       20 GETUPVAL                         R3 1
       21 MOVE                             R4 R0
