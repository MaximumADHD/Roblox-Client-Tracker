...
PROTO_9:
        0 DUPTABLE                         R2 K3 [{[1] = "__lt", ["className"]}]
        1 GETUPVAL                         R3 0
        2 SETTABLEKS                       R3 R2 K2 ["className"]
        4 GETIMPORT                        R3 K5 [require]
        6 GETUPVAL                         R4 1
        7 GETTABLEKS                       R4 R4 K6 ["Error"]
        9 CALL                             R3 1 1
       10 GETTABLEKS                       R4 R3 K7 ["new"]
       12 LOADK                            R5 K8 ["NotImplemented"]
       13 LOADK                            R6 K9 ["The method \"{methodName}\" is not implemented on the class \"{className}\""]
       14 CALL                             R4 2 1
       15 MOVE                             R7 R2
       16 NAMECALL                         R5 R4 K10 ["throw"]
       18 CALL                             R5 2 0
       19 RETURN                           R0 0

PROTO_10:
        0 DUPTABLE                         R2 K3 [{[1] = "__le", ["className"]}]
        1 GETUPVAL                         R3 0
        2 SETTABLEKS                       R3 R2 K2 ["className"]
        4 GETIMPORT                        R3 K5 [require]
        6 GETUPVAL                         R4 1
...
PROTO_11:
        0 DUPTABLE                         R1 K3 [{[1] = "__add", ["className"]}]
        1 GETUPVAL                         R2 0
        2 SETTABLEKS                       R2 R1 K2 ["className"]
        4 GETIMPORT                        R2 K5 [require]
        6 GETUPVAL                         R3 1
        7 GETTABLEKS                       R3 R3 K6 ["Error"]
        9 CALL                             R2 1 1
       10 GETTABLEKS                       R3 R2 K7 ["new"]
       12 LOADK                            R4 K8 ["NotImplemented"]
       13 LOADK                            R5 K9 ["The method \"{methodName}\" is not implemented on the class \"{className}\""]
       14 CALL                             R3 2 1
       15 MOVE                             R6 R1
       16 NAMECALL                         R4 R3 K10 ["throw"]
       18 CALL                             R4 2 0
       19 RETURN                           R0 0

PROTO_12:
        0 DUPTABLE                         R1 K3 [{[1] = "__sub", ["className"]}]
        1 GETUPVAL                         R2 0
        2 SETTABLEKS                       R2 R1 K2 ["className"]
        4 GETIMPORT                        R2 K5 [require]
        6 GETUPVAL                         R3 1
...
PROTO_13:
        0 DUPTABLE                         R1 K3 [{[1] = "__mul", ["className"]}]
        1 GETUPVAL                         R2 0
        2 SETTABLEKS                       R2 R1 K2 ["className"]
        4 GETIMPORT                        R2 K5 [require]
        6 GETUPVAL                         R3 1
...
PROTO_14:
        0 DUPTABLE                         R1 K3 [{[1] = "__div", ["className"]}]
        1 GETUPVAL                         R2 0
        2 SETTABLEKS                       R2 R1 K2 ["className"]
        4 GETIMPORT                        R2 K5 [require]
        6 GETUPVAL                         R3 1
...
PROTO_15:
        0 DUPTABLE                         R1 K3 [{[1] = "__mod", ["className"]}]
        1 GETUPVAL                         R2 0
        2 SETTABLEKS                       R2 R1 K2 ["className"]
        4 GETIMPORT                        R2 K5 [require]
        6 GETUPVAL                         R3 1
