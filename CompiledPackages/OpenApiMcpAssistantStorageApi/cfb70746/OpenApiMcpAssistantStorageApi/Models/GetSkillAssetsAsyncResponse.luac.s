PROTO_0:
       ...
       22 CALL                             R3 2 0
       23 RETURN                           R0 1
       24 GETTABLEKS                       R3 R0 K7 ["assets"]
       26 JUMPIFEQKNIL                     R3 ; [+74]
       28 GETTABLEKS                       R4 R0 K7 ["assets"]
       30 FASTCALL1                        TYPEOF R4 ; [+2]
       31 GETIMPORT                        R3 K1 [typeof]
       33 CALL                             R3 1 1
       34 JUMPIFEQKS                       R3 K2 ["table"] ; [+19]
       36 LOADK                            R5 K8 ["%*\"assets\" > Expected table, got %*"]
       37 MOVE                             R7 R2
       38 GETTABLEKS                       R9 R0 K7 ["assets"]
       ...
       66 LOADK                            R10 K10 ["%*\"assets\" > Expected index of type number, got %* as %*"]
       67 MOVE                             R12 R2
       68 MOVE                             R13 R6
       ...
       82 CALL                             R8 2 0
       83 JUMP                             ; [+15]
       84 GETTABLEKS                       R8 R0 K7 ["assets"]
       86 GETUPVAL                         R9 0
       87 GETTABLEKS                       R9 R9 K11 ["fromResponse"]
       89 MOVE                             R10 R7
       90 MOVE                             R11 R1
       91 LOADK                            R12 K12 ["%*\"assets\" > [%*] > "]
       92 MOVE                             R14 R2
       93 MOVE                             R15 R6
