PROTO_0:
       ...
       22 CALL                             R3 2 0
       23 RETURN                           R0 1
       24 GETTABLEKS                       R3 R0 K7 ["assetId"]
       26 JUMPIFEQKNIL                     R3 ; [+26]
       28 GETTABLEKS                       R4 R0 K7 ["assetId"]
       30 FASTCALL1                        TYPEOF R4 ; [+2]
       31 GETIMPORT                        R3 K1 [typeof]
       33 CALL                             R3 1 1
       34 JUMPIFEQKS                       R3 K8 ["number"] ; [+18]
       36 LOADK                            R5 K9 ["%*\"assetId\" > Expected number, got %*"]
       37 MOVE                             R7 R2
       38 GETTABLEKS                       R9 R0 K7 ["assetId"]
       ...
       52 CALL                             R3 2 0
       53 GETTABLEKS                       R3 R0 K10 ["name"]
       55 JUMPIFEQKNIL                     R3 ; [+26]
       57 GETTABLEKS                       R4 R0 K10 ["name"]
       59 FASTCALL1                        TYPEOF R4 ; [+2]
       60 GETIMPORT                        R3 K1 [typeof]
       62 CALL                             R3 1 1
       63 JUMPIFEQKS                       R3 K11 ["string"] ; [+18]
       65 LOADK                            R5 K12 ["%*\"name\" > Expected string, got %*"]
       66 MOVE                             R7 R2
       67 GETTABLEKS                       R9 R0 K10 ["name"]
       ...
       81 CALL                             R3 2 0
       82 GETTABLEKS                       R3 R0 K13 ["description"]
       84 JUMPIFEQKNIL                     R3 ; [+26]
       86 GETTABLEKS                       R4 R0 K13 ["description"]
       88 FASTCALL1                        TYPEOF R4 ; [+2]
       89 GETIMPORT                        R3 K1 [typeof]
       91 CALL                             R3 1 1
       92 JUMPIFEQKS                       R3 K11 ["string"] ; [+18]
       94 LOADK                            R5 K14 ["%*\"description\" > Expected string, got %*"]
       95 MOVE                             R7 R2
       96 GETTABLEKS                       R9 R0 K13 ["description"]
      ...
      110 CALL                             R3 2 0
      111 GETTABLEKS                       R3 R0 K15 ["isDisabled"]
      113 JUMPIFEQKNIL                     R3 ; [+26]
      115 GETTABLEKS                       R4 R0 K15 ["isDisabled"]
      117 FASTCALL1                        TYPEOF R4 ; [+2]
      118 GETIMPORT                        R3 K1 [typeof]
      120 CALL                             R3 1 1
      121 JUMPIFEQKS                       R3 K16 ["boolean"] ; [+18]
      123 LOADK                            R5 K17 ["%*\"isDisabled\" > Expected boolean, got %*"]
      124 MOVE                             R7 R2
      125 GETTABLEKS                       R9 R0 K15 ["isDisabled"]
      ...
      139 CALL                             R3 2 0
      140 GETTABLEKS                       R3 R0 K18 ["createdUtc"]
      142 JUMPIFEQKNIL                     R3 ; [+26]
      144 GETTABLEKS                       R4 R0 K18 ["createdUtc"]
      146 FASTCALL1                        TYPEOF R4 ; [+2]
      147 GETIMPORT                        R3 K1 [typeof]
      149 CALL                             R3 1 1
      150 JUMPIFEQKS                       R3 K8 ["number"] ; [+18]
      152 LOADK                            R5 K19 ["%*\"createdUtc\" > Expected number, got %*"]
      153 MOVE                             R7 R2
      154 GETTABLEKS                       R9 R0 K18 ["createdUtc"]
      ...
      168 CALL                             R3 2 0
      169 GETTABLEKS                       R3 R0 K20 ["updatedUtc"]
      171 JUMPIFEQKNIL                     R3 ; [+26]
      173 GETTABLEKS                       R4 R0 K20 ["updatedUtc"]
      175 FASTCALL1                        TYPEOF R4 ; [+2]
      176 GETIMPORT                        R3 K1 [typeof]
      178 CALL                             R3 1 1
      179 JUMPIFEQKS                       R3 K8 ["number"] ; [+18]
      181 LOADK                            R5 K21 ["%*\"updatedUtc\" > Expected number, got %*"]
      182 MOVE                             R7 R2
      183 GETTABLEKS                       R9 R0 K20 ["updatedUtc"]
