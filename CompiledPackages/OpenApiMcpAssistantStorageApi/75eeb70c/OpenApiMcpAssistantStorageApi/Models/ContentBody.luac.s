PROTO_0:
       ...
       23 CALL                             R3 2 0
       24 RETURN                           R0 1
       25 GETTABLEKS                       R3 R0 K7 ["sequenceNumber"]
       27 JUMPIFEQKNIL                     R3 ; [+27]
       29 GETTABLEKS                       R4 R0 K7 ["sequenceNumber"]
       31 FASTCALL1                        TYPEOF R4 ; [+2]
       32 GETIMPORT                        R3 K1 [typeof]
       34 CALL                             R3 1 1
       35 JUMPIFEQKS                       R3 K8 ["number"] ; [+19]
       37 LOADK                            R6 K9 ["%*\"sequenceNumber\" > Expected number, got %*"]
       38 MOVE                             R8 R2
       39 GETTABLEKS                       R10 R0 K7 ["sequenceNumber"]
       ...
       54 CALL                             R3 2 0
       55 GETTABLEKS                       R3 R0 K10 ["contentId"]
       57 JUMPIFEQKNIL                     R3 ; [+27]
       59 GETTABLEKS                       R4 R0 K10 ["contentId"]
       61 FASTCALL1                        TYPEOF R4 ; [+2]
       62 GETIMPORT                        R3 K1 [typeof]
       64 CALL                             R3 1 1
       65 JUMPIFEQKS                       R3 K11 ["string"] ; [+19]
       67 LOADK                            R6 K12 ["%*\"contentId\" > Expected string, got %*"]
       68 MOVE                             R8 R2
       69 GETTABLEKS                       R10 R0 K10 ["contentId"]
       ...
       84 CALL                             R3 2 0
       85 GETTABLEKS                       R3 R0 K13 ["createdUtc"]
       87 JUMPIFEQKNIL                     R3 ; [+27]
       89 GETTABLEKS                       R4 R0 K13 ["createdUtc"]
       ...
       98 MOVE                             R8 R2
       99 GETTABLEKS                       R10 R0 K13 ["createdUtc"]
      ...
      174 CALL                             R3 2 0
      175 GETTABLEKS                       R3 R0 K20 ["mcpVersion"]
      177 JUMPIFEQKNIL                     R3 ; [+27]
      179 GETTABLEKS                       R4 R0 K20 ["mcpVersion"]
      181 FASTCALL1                        TYPEOF R4 ; [+2]
      182 GETIMPORT                        R3 K1 [typeof]
      184 CALL                             R3 1 1
      185 JUMPIFEQKS                       R3 K11 ["string"] ; [+19]
      187 LOADK                            R6 K21 ["%*\"mcpVersion\" > Expected string, got %*"]
      188 MOVE                             R8 R2
      189 GETTABLEKS                       R10 R0 K20 ["mcpVersion"]
      ...
      204 CALL                             R3 2 0
      205 GETTABLEKS                       R3 R0 K22 ["mcpContent"]
      207 JUMPIFEQKNIL                     R3 ; [+27]
      209 GETTABLEKS                       R4 R0 K22 ["mcpContent"]
      211 FASTCALL1                        TYPEOF R4 ; [+2]
      212 GETIMPORT                        R3 K1 [typeof]
      214 CALL                             R3 1 1
      215 JUMPIFEQKS                       R3 K11 ["string"] ; [+19]
      217 LOADK                            R6 K23 ["%*\"mcpContent\" > Expected string, got %*"]
      218 MOVE                             R8 R2
      219 GETTABLEKS                       R10 R0 K22 ["mcpContent"]
