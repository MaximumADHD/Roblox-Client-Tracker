...
PROTO_3:
       ...
       21 CALL                             R6 2 1
       22 SETTABLEKS                       R6 R3 K5 ["bridge"]
       24 GETTABLEKS                       R4 R2 K8 ["animatorRemoved"]
       26 MOVE                             R5 R3
       27 CALL                             R4 1 -1
       28 RETURN                           R4 -1
...
PROTO_4:
       ...
       21 CALL                             R6 2 1
       22 SETTABLEKS                       R6 R3 K5 ["bridge"]
       24 GETTABLEKS                       R4 R2 K8 ["rigSelected"]
       26 MOVE                             R5 R3
       27 CALL                             R4 1 -1
       28 RETURN                           R4 -1
...
PROTO_8:
        0 DUPTABLE                         R2 K3 [{"animatorRemoved", "rigSelected", "toTarget"}]
        1 NEWCLOSURE                       R3 P0
        2 CAPTURE                          UPVAL U0
        3 CAPTURE                          VAL R0
        4 CAPTURE                          VAL R1
...
PROTO_9:
        ...
        5 CAPTURE                          VAL R1
        6 GETUPVAL                         R8 0
        7 GETTABLEKS                       R8 R8 K1 ["animatorRemoved"]
        9 GETUPVAL                         R11 0
       ...
       31 CALL                             R5 3 1
       32 GETUPVAL                         R9 0
       33 GETTABLEKS                       R9 R9 K8 ["rigSelected"]
       35 GETUPVAL                         R12 0
...
PROTO_17:
       ...
       21 CALL                             R6 2 1
       22 SETTABLEKS                       R6 R3 K5 ["bridge"]
       24 GETTABLEKS                       R4 R2 K8 ["publishAnimationAsync"]
       26 MOVE                             R5 R3
       27 CALL                             R4 1 -1
       28 RETURN                           R4 -1
...
PROTO_25:
        0 DUPTABLE                         R2 K7 [{"generateAndSaveAnimationAsync", "getSelectedRigRef", "setIsPlaying", "setCurrentTime", "setPlaybackSpeed", "publishAnimationAsync", "toTarget"}]
        1 NEWCLOSURE                       R3 P0
        2 CAPTURE                          UPVAL U0
        3 CAPTURE                          VAL R0
        4 CAPTURE                          VAL R1
...
PROTO_26:
        ...
        5 CAPTURE                          VAL R1
        6 GETUPVAL                         R8 0
        7 GETTABLEKS                       R8 R8 K1 ["generateAndSaveAnimationAsync"]
        9 GETUPVAL                         R11 0
       10 GETTABLE                         R10 R11 R8
       11 LOADK                            R12 K2 ["Invalid network key: "]
       12 MOVE                             R13 R8
       ...
       57 CALL                             R6 3 1
       58 GETUPVAL                         R10 0
       59 GETTABLEKS                       R10 R10 K9 ["setIsPlaying"]
       61 GETUPVAL                         R13 0
       ...
       83 CALL                             R7 3 1
       84 GETUPVAL                         R11 0
       85 GETTABLEKS                       R11 R11 K11 ["setCurrentTime"]
       87 GETUPVAL                         R14 0
      ...
      109 CALL                             R8 3 1
      110 GETUPVAL                         R12 0
      111 GETTABLEKS                       R12 R12 K12 ["setPlaybackSpeed"]
      113 GETUPVAL                         R15 0
      ...
      131 CAPTURE                          VAL R0
      132 CAPTURE                          VAL R1
      133 NAMECALL                         R9 R3 K10 ["OnHostEvent"]
      135 CALL                             R9 3 1
      136 GETUPVAL                         R13 0
      137 GETTABLEKS                       R13 R13 K13 ["publishAnimationAsync"]
      139 GETUPVAL                         R16 0
...
PROTO_29:
        ...
        1 DUPCLOSURE                       R4 K3 [PROTO_27]
        2 SETTABLEKS                       R4 R3 K0 ["toGuest"]
        4 DUPCLOSURE                       R4 K4 [PROTO_28]
...
MAIN:
        ...
        7 GETTABLEKS                       R1 R1 K5 ["AnimationGenBridgeTypes"]
        9 CALL                             R0 1 1
       10 DUPTABLE                         R1 K14 [{"animatorRemoved", "rigSelected", "generateAndSaveAnimationAsync", "getSelectedRigRef", "setIsPlaying", "setCurrentTime", "setPlaybackSpeed", "publishAnimationAsync"}]
       11 LOADK                            R2 K6 ["animatorRemoved"]
       12 SETTABLEKS                       R2 R1 K6 ["animatorRemoved"]
       14 LOADK                            R2 K7 ["rigSelected"]
       15 SETTABLEKS                       R2 R1 K7 ["rigSelected"]
       17 LOADK                            R2 K8 ["generateAndSaveAnimationAsync"]
       18 SETTABLEKS                       R2 R1 K8 ["generateAndSaveAnimationAsync"]
       20 LOADK                            R2 K9 ["getSelectedRigRef"]
       21 SETTABLEKS                       R2 R1 K9 ["getSelectedRigRef"]
       23 LOADK                            R2 K10 ["setIsPlaying"]
       24 SETTABLEKS                       R2 R1 K10 ["setIsPlaying"]
       26 LOADK                            R2 K11 ["setCurrentTime"]
       27 SETTABLEKS                       R2 R1 K11 ["setCurrentTime"]
       29 LOADK                            R2 K12 ["setPlaybackSpeed"]
       30 SETTABLEKS                       R2 R1 K12 ["setPlaybackSpeed"]
       32 LOADK                            R2 K13 ["publishAnimationAsync"]
       33 SETTABLEKS                       R2 R1 K13 ["publishAnimationAsync"]
       35 DUPCLOSURE                       R2 K15 [PROTO_0]
       36 CAPTURE                          VAL R1
       37 DUPCLOSURE                       R3 K16 [PROTO_1]
       38 DUPCLOSURE                       R4 K17 [PROTO_9]
       39 CAPTURE                          VAL R1
       40 DUPCLOSURE                       R5 K18 [PROTO_10]
       41 DUPCLOSURE                       R6 K19 [PROTO_26]
       42 CAPTURE                          VAL R1
       43 DUPCLOSURE                       R7 K20 [PROTO_29]
       44 CAPTURE                          VAL R6
       45 CAPTURE                          VAL R4
       46 DUPTABLE                         R8 K23 [{"prepareBridges", "createGuestContext"}]
       47 SETTABLEKS                       R7 R8 K21 ["prepareBridges"]
       49 SETTABLEKS                       R3 R8 K22 ["createGuestContext"]
       51 RETURN                           R8 1
