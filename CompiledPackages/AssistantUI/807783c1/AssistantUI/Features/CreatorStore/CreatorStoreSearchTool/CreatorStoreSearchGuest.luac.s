...
PROTO_10:
       ...
       32 CALL                             R2 3 1
       33 DUPTABLE                         R4 K18 [{"title", "readOnlyHint", "destructiveHint", "idempotentHint", "openWorldHint"}]
       34 LOADK                            R5 K19 ["Creator Store Search"]
       35 SETTABLEKS                       R5 R4 K13 ["title"]
       37 LOADB                            R5 1
       38 SETTABLEKS                       R5 R4 K14 ["readOnlyHint"]
       40 LOADB                            R5 0
       41 SETTABLEKS                       R5 R4 K15 ["destructiveHint"]
       43 LOADB                            R5 0
       44 SETTABLEKS                       R5 R4 K16 ["idempotentHint"]
       46 LOADB                            R5 0
       47 SETTABLEKS                       R5 R4 K17 ["openWorldHint"]
       49 NAMECALL                         R2 R2 K20 ["setAnnotations"]
       51 CALL                             R2 2 1
       52 MOVE                             R4 R1
       53 NAMECALL                         R2 R2 K21 ["setHandler"]
       55 CALL                             R2 2 1
       56 NAMECALL                         R2 R2 K22 ["build"]
       58 CALL                             R2 1 1
       59 DUPTABLE                         R3 K26 [{"command", "getDescription", "mapToToolCall"}]
       60 LOADK                            R4 K27 ["insert"]
       61 SETTABLEKS                       R4 R3 K23 ["command"]
       63 DUPCLOSURE                       R4 K28 [PROTO_7]
       64 CAPTURE                          UPVAL U4
       65 SETTABLEKS                       R4 R3 K24 ["getDescription"]
       67 DUPCLOSURE                       R4 K29 [PROTO_9]
       68 CAPTURE                          UPVAL U3
       69 CAPTURE                          UPVAL U5
       70 SETTABLEKS                       R4 R3 K25 ["mapToToolCall"]
       72 DUPTABLE                         R4 K32 [{"definition", "slashCommands"}]
       73 SETTABLEKS                       R2 R4 K30 ["definition"]
       75 NEWTABLE                         R5 0 1
       77 MOVE                             R6 R3
       78 SETLIST                          R5 R6 1 [1]
       80 SETTABLEKS                       R5 R4 K31 ["slashCommands"]
       82 RETURN                           R4 1
