...
PROTO_7:
       ...
       18 CALL                             R9 2 0
       19 LOADK                            R9 K5 ["CreatorStoreInsertTool_%*"]
       20 MOVE                             R11 R8
...
PROTO_12:
       ...
       21 CALL                             R7 2 1
       22 SETTABLEKS                       R7 R4 K5 ["bridge"]
       24 GETTABLEKS                       R5 R3 K8 ["swapAssetAsync"]
       26 MOVE                             R6 R2
       27 MOVE                             R7 R4
       28 CALL                             R5 2 -1
       29 RETURN                           R5 -1
...
PROTO_13:
       ...
       21 CALL                             R7 2 1
       22 SETTABLEKS                       R7 R4 K5 ["bridge"]
       24 GETTABLEKS                       R5 R3 K8 ["insertFromMarketplaceAsync"]
       26 MOVE                             R6 R2
       27 MOVE                             R7 R4
       28 CALL                             R5 2 -1
       29 RETURN                           R5 -1
...
PROTO_20:
       ...
       44 CALL                             R10 2 0
       45 LOADK                            R10 K5 ["CreatorStoreInsertTool_%*"]
       46 MOVE                             R12 R9
       ...
       57 CALL                             R6 3 1
       58 GETUPVAL                         R10 0
       59 GETTABLEKS                       R10 R10 K9 ["swapAssetAsync"]
       61 GETUPVAL                         R13 0
       ...
       70 CALL                             R11 2 0
       71 LOADK                            R11 K5 ["CreatorStoreInsertTool_%*"]
       72 MOVE                             R13 R10
       ...
       83 CALL                             R7 3 1
       84 GETUPVAL                         R11 0
       85 GETTABLEKS                       R11 R11 K11 ["insertFromMarketplaceAsync"]
       87 GETUPVAL                         R14 0
       ...
       96 CALL                             R12 2 0
       97 LOADK                            R12 K5 ["CreatorStoreInsertTool_%*"]
       98 MOVE                             R14 R11
      ...
      105 CAPTURE                          VAL R0
      106 CAPTURE                          VAL R1
      107 NAMECALL                         R8 R3 K10 ["OnHostInvokeAsync"]
      109 CALL                             R8 3 1
...
MAIN:
        ...
        9 CALL                             R0 1 1
       10 DUPTABLE                         R1 K11 [{"updateContentHeader", "selectInsertedAssets", "listenToLinkChanges", "swapAssetAsync", "insertFromMarketplaceAsync"}]
       11 LOADK                            R2 K6 ["updateContentHeader"]
       12 SETTABLEKS                       R2 R1 K6 ["updateContentHeader"]
       14 LOADK                            R2 K7 ["selectInsertedAssets"]
       15 SETTABLEKS                       R2 R1 K7 ["selectInsertedAssets"]
       17 LOADK                            R2 K8 ["listenToLinkChanges"]
       18 SETTABLEKS                       R2 R1 K8 ["listenToLinkChanges"]
       20 LOADK                            R2 K9 ["swapAssetAsync"]
       21 SETTABLEKS                       R2 R1 K9 ["swapAssetAsync"]
       23 LOADK                            R2 K10 ["insertFromMarketplaceAsync"]
       24 SETTABLEKS                       R2 R1 K10 ["insertFromMarketplaceAsync"]
       26 DUPCLOSURE                       R2 K12 [PROTO_0]
       27 CAPTURE                          VAL R1
       28 DUPCLOSURE                       R3 K13 [PROTO_1]
       29 DUPCLOSURE                       R4 K14 [PROTO_7]
       30 CAPTURE                          VAL R1
       31 DUPCLOSURE                       R5 K15 [PROTO_8]
       32 DUPCLOSURE                       R6 K16 [PROTO_20]
       33 CAPTURE                          VAL R1
       34 DUPCLOSURE                       R7 K17 [PROTO_23]
       35 CAPTURE                          VAL R6
       36 CAPTURE                          VAL R4
       37 DUPTABLE                         R8 K20 [{"prepareBridges", "createGuestContext"}]
       38 SETTABLEKS                       R7 R8 K18 ["prepareBridges"]
       40 SETTABLEKS                       R3 R8 K19 ["createGuestContext"]
       42 RETURN                           R8 1
