...
MAIN:
       ...
       27 CALL                             R3 1 1
       28 DUPTABLE                         R4 K19 [{"Submitted", "Polling", "Downloading", "Inserting", "Completed", "Failed", "Cancelled"}]
       29 LOADK                            R5 K12 ["Submitted"]
       30 SETTABLEKS                       R5 R4 K12 ["Submitted"]
       32 LOADK                            R5 K13 ["Polling"]
       33 SETTABLEKS                       R5 R4 K13 ["Polling"]
       35 LOADK                            R5 K14 ["Downloading"]
       36 SETTABLEKS                       R5 R4 K14 ["Downloading"]
       38 LOADK                            R5 K15 ["Inserting"]
       39 SETTABLEKS                       R5 R4 K15 ["Inserting"]
       41 LOADK                            R5 K16 ["Completed"]
       42 SETTABLEKS                       R5 R4 K16 ["Completed"]
       44 LOADK                            R5 K17 ["Failed"]
       45 SETTABLEKS                       R5 R4 K17 ["Failed"]
       47 LOADK                            R5 K18 ["Cancelled"]
       48 SETTABLEKS                       R5 R4 K18 ["Cancelled"]
       50 NEWTABLE                         R5 0 0
       ...
       57 CAPTURE                          VAL R1
       58 CAPTURE                          VAL R3
       59 DUPCLOSURE                       R8 K22 [PROTO_3]
       60 CAPTURE                          VAL R5
       61 DUPCLOSURE                       R9 K23 [PROTO_4]
       62 CAPTURE                          VAL R1
       63 CAPTURE                          VAL R3
       64 CAPTURE                          VAL R5
       65 DUPCLOSURE                       R10 K24 [PROTO_5]
       66 CAPTURE                          VAL R2
       67 CAPTURE                          VAL R1
       68 CAPTURE                          VAL R3
       69 CAPTURE                          VAL R5
       ...
       74 CAPTURE                          VAL R5
       75 NEWTABLE                         R12 4 0
       77 GETTABLEKS                       R13 R4 K16 ["Completed"]
       79 LOADB                            R14 1
       80 SETTABLE                         R14 R12 R13
       81 GETTABLEKS                       R13 R4 K17 ["Failed"]
       83 LOADB                            R14 1
       84 SETTABLE                         R14 R12 R13
       85 GETTABLEKS                       R13 R4 K18 ["Cancelled"]
       87 LOADB                            R14 1
       88 SETTABLE                         R14 R12 R13
       89 GETTABLEKS                       R13 R4 K15 ["Inserting"]
       91 LOADB                            R14 1
       92 SETTABLE                         R14 R12 R13
       93 DUPCLOSURE                       R13 K26 [PROTO_7]
       94 CAPTURE                          VAL R5
       95 CAPTURE                          VAL R12
       96 DUPCLOSURE                       R14 K27 [PROTO_8]
       97 CAPTURE                          VAL R5
       98 DUPTABLE                         R15 K36 [{"JobStatus", "setJob", "getJob", "updateJobStatus", "appendLog", "removeJob", "getActiveJobCount", "clear"}]
       99 SETTABLEKS                       R4 R15 K28 ["JobStatus"]
      101 SETTABLEKS                       R7 R15 K29 ["setJob"]
      103 SETTABLEKS                       R8 R15 K30 ["getJob"]
      105 SETTABLEKS                       R10 R15 K31 ["updateJobStatus"]
      107 SETTABLEKS                       R9 R15 K32 ["appendLog"]
      109 SETTABLEKS                       R11 R15 K33 ["removeJob"]
      111 SETTABLEKS                       R13 R15 K34 ["getActiveJobCount"]
      113 SETTABLEKS                       R14 R15 K35 ["clear"]
      115 RETURN                           R15 1
