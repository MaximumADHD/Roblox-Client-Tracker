...
PROTO_13:
       ...
       83 CALL                             R7 3 1
       84 GETUPVAL                         R11 0
       85 GETTABLEKS                       R11 R11 K11 ["reportGeneratedInstanceDeleted"]
       87 GETUPVAL                         R14 0
      ...
      105 CAPTURE                          VAL R0
      106 CAPTURE                          VAL R1
      107 NAMECALL                         R8 R3 K7 ["OnGuestEvent"]
      109 CALL                             R8 3 1
...
PROTO_24:
       ...
       21 CALL                             R6 2 1
       22 SETTABLEKS                       R6 R3 K5 ["bridge"]
       24 GETTABLEKS                       R4 R2 K8 ["createViewportBoundingBoxAsync"]
       26 MOVE                             R5 R3
       27 CALL                             R4 1 -1
       28 RETURN                           R4 -1
...
PROTO_25:
       ...
       21 CALL                             R7 2 1
       22 SETTABLEKS                       R7 R4 K5 ["bridge"]
       24 GETTABLEKS                       R5 R3 K8 ["destroyViewportBoundingBoxAsync"]
       26 MOVE                             R6 R2
       27 MOVE                             R7 R4
       28 CALL                             R5 2 -1
       29 RETURN                           R5 -1
...
PROTO_38:
      ...
      213 CALL                             R12 3 1
      214 GETUPVAL                         R16 0
      215 GETTABLEKS                       R16 R16 K16 ["createViewportBoundingBoxAsync"]
      217 GETUPVAL                         R19 0
      218 GETTABLE                         R18 R19 R16
      219 LOADK                            R20 K2 ["Invalid network key: "]
      220 MOVE                             R21 R16
      221 CONCAT                           R19 R20 R21
      222 FASTCALL2                        ASSERT R18 R19 ; [+3]
      224 GETIMPORT                        R17 K4 [assert]
      226 CALL                             R17 2 0
      227 LOADK                            R17 K5 ["MeshGenTool_%*"]
      228 MOVE                             R19 R16
      229 NAMECALL                         R17 R17 K6 ["format"]
      231 CALL                             R17 2 1
      232 MOVE                             R15 R17
      233 NEWCLOSURE                       R16 P9
      234 CAPTURE                          VAL R2
      235 CAPTURE                          VAL R0
      236 CAPTURE                          VAL R1
      237 NAMECALL                         R13 R3 K7 ["OnHostInvokeAsync"]
      239 CALL                             R13 3 1
      240 GETUPVAL                         R17 0
      241 GETTABLEKS                       R17 R17 K17 ["destroyViewportBoundingBoxAsync"]
      243 GETUPVAL                         R20 0
      244 GETTABLE                         R19 R20 R17
      245 LOADK                            R21 K2 ["Invalid network key: "]
      246 MOVE                             R22 R17
      247 CONCAT                           R20 R21 R22
      248 FASTCALL2                        ASSERT R19 R20 ; [+3]
      250 GETIMPORT                        R18 K4 [assert]
      252 CALL                             R18 2 0
      253 LOADK                            R18 K5 ["MeshGenTool_%*"]
      254 MOVE                             R20 R17
      255 NAMECALL                         R18 R18 K6 ["format"]
      257 CALL                             R18 2 1
      258 MOVE                             R16 R18
      259 NEWCLOSURE                       R17 P10
      260 CAPTURE                          VAL R2
      261 CAPTURE                          VAL R0
      262 CAPTURE                          VAL R1
      263 NAMECALL                         R14 R3 K7 ["OnHostInvokeAsync"]
      265 CALL                             R14 3 1
      266 NEWCLOSURE                       R15 P11
      267 CAPTURE                          VAL R5
      268 CAPTURE                          VAL R6
      269 CAPTURE                          VAL R7
      270 CAPTURE                          VAL R8
...
MAIN:
        ...
        9 CALL                             R0 1 1
       10 DUPTABLE                         R1 K20 [{"updateContentHeader", "setPreviewStateAsync", "setPreviewImage", "reportGeneratedInstanceDeleted", "generateAssetsAsync", "cancelGenerationAsync", "publishAssetsAsync", "removeSelectedBoundsAsync", "insertAssetsAsync", "selectLinkedAssets", "listenToLinkChanges", "getSelectedBoundingBox", "createViewportBoundingBoxAsync", "destroyViewportBoundingBoxAsync"}]
       11 LOADK                            R2 K6 ["updateContentHeader"]
       12 SETTABLEKS                       R2 R1 K6 ["updateContentHeader"]
       14 LOADK                            R2 K7 ["setPreviewStateAsync"]
       15 SETTABLEKS                       R2 R1 K7 ["setPreviewStateAsync"]
       17 LOADK                            R2 K8 ["setPreviewImage"]
       18 SETTABLEKS                       R2 R1 K8 ["setPreviewImage"]
       20 LOADK                            R2 K9 ["reportGeneratedInstanceDeleted"]
       21 SETTABLEKS                       R2 R1 K9 ["reportGeneratedInstanceDeleted"]
       23 LOADK                            R2 K10 ["generateAssetsAsync"]
       24 SETTABLEKS                       R2 R1 K10 ["generateAssetsAsync"]
       26 LOADK                            R2 K11 ["cancelGenerationAsync"]
       27 SETTABLEKS                       R2 R1 K11 ["cancelGenerationAsync"]
       29 LOADK                            R2 K12 ["publishAssetsAsync"]
       30 SETTABLEKS                       R2 R1 K12 ["publishAssetsAsync"]
       32 LOADK                            R2 K13 ["removeSelectedBoundsAsync"]
       33 SETTABLEKS                       R2 R1 K13 ["removeSelectedBoundsAsync"]
       35 LOADK                            R2 K14 ["insertAssetsAsync"]
       36 SETTABLEKS                       R2 R1 K14 ["insertAssetsAsync"]
       38 LOADK                            R2 K15 ["selectLinkedAssets"]
       39 SETTABLEKS                       R2 R1 K15 ["selectLinkedAssets"]
       41 LOADK                            R2 K16 ["listenToLinkChanges"]
       42 SETTABLEKS                       R2 R1 K16 ["listenToLinkChanges"]
       44 LOADK                            R2 K17 ["getSelectedBoundingBox"]
       45 SETTABLEKS                       R2 R1 K17 ["getSelectedBoundingBox"]
       47 LOADK                            R2 K18 ["createViewportBoundingBoxAsync"]
       48 SETTABLEKS                       R2 R1 K18 ["createViewportBoundingBoxAsync"]
       50 LOADK                            R2 K19 ["destroyViewportBoundingBoxAsync"]
       51 SETTABLEKS                       R2 R1 K19 ["destroyViewportBoundingBoxAsync"]
       53 DUPCLOSURE                       R2 K21 [PROTO_0]
       54 CAPTURE                          VAL R1
       55 DUPCLOSURE                       R3 K22 [PROTO_1]
       56 DUPCLOSURE                       R4 K23 [PROTO_13]
       57 CAPTURE                          VAL R1
       58 DUPCLOSURE                       R5 K24 [PROTO_14]
       59 DUPCLOSURE                       R6 K25 [PROTO_38]
       60 CAPTURE                          VAL R1
       61 DUPCLOSURE                       R7 K26 [PROTO_41]
       62 CAPTURE                          VAL R6
       63 CAPTURE                          VAL R4
       64 DUPTABLE                         R8 K29 [{"prepareBridges", "createGuestContext"}]
       65 SETTABLEKS                       R7 R8 K27 ["prepareBridges"]
       67 SETTABLEKS                       R3 R8 K28 ["createGuestContext"]
       69 RETURN                           R8 1
