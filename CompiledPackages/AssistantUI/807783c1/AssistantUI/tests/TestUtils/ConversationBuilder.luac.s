...
PROTO_2:
        0 DUPTABLE                         R1 K14 [{"threadId", "ephemeral", "isDirty", "createdAt", "updatedAt", "lastActivityAt", "lastViewedAt", "title", "isPinned", "messages", "messageLoadState", "messagePageState", "messageCountAdded", "messageCountLoaded"}]
        ...
        9 LOADN                            R2 0
       10 SETTABLEKS                       R2 R1 K3 ["createdAt"]
       12 LOADN                            R2 0
       13 SETTABLEKS                       R2 R1 K4 ["updatedAt"]
       15 LOADN                            R2 0
       16 SETTABLEKS                       R2 R1 K5 ["lastActivityAt"]
       18 LOADN                            R2 255
       19 SETTABLEKS                       R2 R1 K6 ["lastViewedAt"]
       21 SETTABLEKS                       R0 R1 K7 ["title"]
       23 LOADB                            R2 0
       24 SETTABLEKS                       R2 R1 K8 ["isPinned"]
       26 NEWTABLE                         R2 0 0
       28 SETTABLEKS                       R2 R1 K9 ["messages"]
       30 GETUPVAL                         R2 0
       31 GETTABLEKS                       R2 R2 K15 ["PersistenceLoadStates"]
       33 GETTABLEKS                       R2 R2 K16 ["Disabled"]
       35 SETTABLEKS                       R2 R1 K10 ["messageLoadState"]
       37 LOADNIL                          R2
       38 SETTABLEKS                       R2 R1 K11 ["messagePageState"]
       40 LOADN                            R2 0
       41 SETTABLEKS                       R2 R1 K12 ["messageCountAdded"]
       43 LOADN                            R2 0
       44 SETTABLEKS                       R2 R1 K13 ["messageCountLoaded"]
       46 RETURN                           R1 1
