...
PROTO_10:
       ...
       29 JUMPIFNOT                        R0 ; [+22]
       30 GETUPVAL                         R3 4
       31 DUPTABLE                         R4 K9 [{"fromPlayerId", "targetPlayerId", "content"}]
       32 LOADN                            R5 0
       33 SETTABLEKS                       R5 R4 K6 ["fromPlayerId"]
       35 LOADN                            R5 0
       36 SETTABLEKS                       R5 R4 K7 ["targetPlayerId"]
       38 LOADK                            R5 K10 ["Finished with message: All Multi-player agents are ended, User manually stopped the multi-player agents."]
       39 SETTABLEKS                       R5 R4 K8 ["content"]
       41 FASTCALL2                        TABLE_INSERT R3 R4 ; [+3]
       43 GETIMPORT                        R2 K13 [table.insert]
       45 CALL                             R2 2 0
       46 GETUPVAL                         R2 5
       47 GETUPVAL                         R4 4
       48 NAMECALL                         R2 R2 K14 ["Fire"]
       50 CALL                             R2 2 0
       51 RETURN                           R0 0
       52 GETUPVAL                         R3 4
       53 DUPTABLE                         R4 K9 [{"fromPlayerId", "targetPlayerId", "content"}]
       54 LOADN                            R5 0
       55 SETTABLEKS                       R5 R4 K6 ["fromPlayerId"]
       57 LOADN                            R5 0
       58 SETTABLEKS                       R5 R4 K7 ["targetPlayerId"]
       60 LOADK                            R5 K15 ["Finished with message: All Multi-player agents finished the tasks."]
       61 SETTABLEKS                       R5 R4 K8 ["content"]
       63 FASTCALL2                        TABLE_INSERT R3 R4 ; [+3]
       65 GETIMPORT                        R2 K13 [table.insert]
       67 CALL                             R2 2 0
       68 GETUPVAL                         R2 5
       69 GETUPVAL                         R4 4
       70 NAMECALL                         R2 R2 K14 ["Fire"]
       72 CALL                             R2 2 0
       73 RETURN                           R0 0
...
PROTO_13:
       ...
       32 MOVE                             R4 R5
       33 GETUPVAL                         R6 4
       34 DUPTABLE                         R7 K13 [{"fromPlayerId", "targetPlayerId", "content"}]
       35 SETTABLEKS                       R0 R7 K10 ["fromPlayerId"]
       37 LOADN                            R8 0
       38 SETTABLEKS                       R8 R7 K11 ["targetPlayerId"]
       40 SETTABLEKS                       R4 R7 K12 ["content"]
       42 FASTCALL2                        TABLE_INSERT R6 R7 ; [+3]
       44 GETIMPORT                        R5 K7 [table.insert]
       46 CALL                             R5 2 0
       47 GETUPVAL                         R5 5
       48 GETUPVAL                         R7 4
       49 NAMECALL                         R5 R5 K14 ["Fire"]
       51 CALL                             R5 2 0
       52 GETUPVAL                         R5 2
       53 LENGTH                           R4 R5
       54 GETUPVAL                         R5 0
       55 GETTABLEKS                       R5 R5 K15 ["player_count"]
       57 JUMPIFNOTLE                      R5 R4 ; [+3]
       59 GETUPVAL                         R4 6
       60 CALL                             R4 0 0
       61 RETURN                           R0 0
...
PROTO_15:
       ...
       21 JUMPIFNOTEQ                      R2 R3 ; [+23]
       23 GETUPVAL                         R3 3
       24 DUPTABLE                         R4 K7 [{"fromPlayerId", "targetPlayerId", "content"}]
       25 LOADN                            R5 0
       26 SETTABLEKS                       R5 R4 K4 ["fromPlayerId"]
       28 LOADN                            R5 0
       29 SETTABLEKS                       R5 R4 K5 ["targetPlayerId"]
       31 LOADK                            R5 K8 ["All players are waiting for team communications, please send team communications or finish the multiplayer agents test."]
       32 SETTABLEKS                       R5 R4 K6 ["content"]
       34 FASTCALL2                        TABLE_INSERT R3 R4 ; [+3]
       36 GETIMPORT                        R2 K2 [table.insert]
       38 CALL                             R2 2 0
       39 GETUPVAL                         R2 4
       40 GETUPVAL                         R4 3
       41 NAMECALL                         R2 R2 K9 ["Fire"]
       43 CALL                             R2 2 0
       44 RETURN                           R0 0
       45 LOADK                            R3 K10 ["Player%* is now paused and waiting for team communications."]
       46 MOVE                             R5 R0
       47 NAMECALL                         R3 R3 K11 ["format"]
       49 CALL                             R3 2 1
       50 MOVE                             R2 R3
       51 GETUPVAL                         R4 3
       52 DUPTABLE                         R5 K7 [{"fromPlayerId", "targetPlayerId", "content"}]
       53 SETTABLEKS                       R0 R5 K4 ["fromPlayerId"]
       55 LOADN                            R6 0
       56 SETTABLEKS                       R6 R5 K5 ["targetPlayerId"]
       58 SETTABLEKS                       R2 R5 K6 ["content"]
       60 FASTCALL2                        TABLE_INSERT R4 R5 ; [+3]
       62 GETIMPORT                        R3 K2 [table.insert]
       64 CALL                             R3 2 0
       65 GETUPVAL                         R3 4
       66 GETUPVAL                         R5 3
       67 NAMECALL                         R3 R3 K9 ["Fire"]
       69 CALL                             R3 2 0
       70 RETURN                           R0 0
...
PROTO_22:
       ...
       81 JUMPIFNOTEQ                      R1 R3 ; [+50]
       83 GETTABLEN                        R3 R2 1
       84 GETTABLEN                        R4 R2 2
       85 GETTABLEN                        R5 R2 3
       86 JUMPIFNOTEQKN                    R4 K13 [0] ; [+21]
       88 GETUPVAL                         R7 7
       89 DUPTABLE                         R8 K17 [{"fromPlayerId", "targetPlayerId", "content"}]
       90 SETTABLEKS                       R3 R8 K14 ["fromPlayerId"]
       92 LOADN                            R9 0
       93 SETTABLEKS                       R9 R8 K15 ["targetPlayerId"]
       95 SETTABLEKS                       R5 R8 K16 ["content"]
       97 FASTCALL2                        TABLE_INSERT R7 R8 ; [+3]
       99 GETIMPORT                        R6 K8 [table.insert]
      101 CALL                             R6 2 0
      102 GETUPVAL                         R6 8
      103 GETUPVAL                         R8 7
      104 NAMECALL                         R6 R6 K9 ["Fire"]
      106 CALL                             R6 2 0
      107 RETURN                           R0 0
      108 GETUPVAL                         R6 9
      109 MOVE                             R7 R3
      ...
      112 CALL                             R6 3 0
      113 GETUPVAL                         R7 7
      114 DUPTABLE                         R8 K17 [{"fromPlayerId", "targetPlayerId", "content"}]
      115 SETTABLEKS                       R3 R8 K14 ["fromPlayerId"]
      117 SETTABLEKS                       R4 R8 K15 ["targetPlayerId"]
      119 SETTABLEKS                       R5 R8 K16 ["content"]
      121 FASTCALL2                        TABLE_INSERT R7 R8 ; [+3]
      123 GETIMPORT                        R6 K8 [table.insert]
      125 CALL                             R6 2 0
      126 GETUPVAL                         R6 8
      127 GETUPVAL                         R8 7
      128 NAMECALL                         R6 R6 K9 ["Fire"]
      130 CALL                             R6 2 0
      131 RETURN                           R0 0
      132 GETUPVAL                         R3 0
      133 GETTABLEKS                       R3 R3 K18 ["NotifyLogging"]
      135 JUMPIFNOTEQ                      R1 R3 ; [+13]
      137 GETVARARGS                       R3 2
      138 GETUPVAL                         R5 10
      139 GETTABLEKS                       R5 R5 K19 ["log"]
      141 LOADK                            R7 K20 ["[Player%*]: %*"]
      142 MOVE                             R9 R3
      143 MOVE                             R10 R4
      144 NAMECALL                         R7 R7 K21 ["format"]
      146 CALL                             R7 3 1
      147 MOVE                             R6 R7
      148 CALL                             R5 1 0
      149 RETURN                           R0 0
