...
PROTO_6:
       ...
       34 DUPTABLE                         R8 K14 [{"type", "description"}]
       35 LOADK                            R9 K15 ["number"]
       36 SETTABLEKS                       R9 R8 K12 ["type"]
       38 LOADK                            R9 K16 ["The number of players to start, minimum is 1, maximum is 8."]
       39 SETTABLEKS                       R9 R8 K13 ["description"]
       41 NAMECALL                         R5 R5 K17 ["addArgument"]
       43 CALL                             R5 3 1
       44 LOADK                            R7 K18 ["player_prompts"]
       45 DUPTABLE                         R8 K20 [{"type", "description", "items"}]
       46 LOADK                            R9 K21 ["array"]
       47 SETTABLEKS                       R9 R8 K12 ["type"]
       49 LOADK                            R9 K22 ["The prompt for the player agents. Size should be the same as player_count. The first player's name is 'Player1', the second player's name is 'Player2', etc."]
       50 SETTABLEKS                       R9 R8 K13 ["description"]
       52 DUPTABLE                         R9 K14 [{"type", "description"}]
       53 LOADK                            R10 K23 ["string"]
       54 SETTABLEKS                       R10 R9 K12 ["type"]
       56 LOADK                            R10 K24 ["The prompt for the player agent."]
       57 SETTABLEKS                       R10 R9 K13 ["description"]
       59 SETTABLEKS                       R9 R8 K19 ["items"]
       61 NAMECALL                         R5 R5 K17 ["addArgument"]
       63 CALL                             R5 3 1
       64 DUPTABLE                         R7 K30 [{"title", "readOnlyHint", "destructiveHint", "idempotentHint", "openWorldHint"}]
       65 LOADK                            R8 K31 ["Start Multi-Player Agents"]
       66 SETTABLEKS                       R8 R7 K25 ["title"]
       68 LOADB                            R8 0
       69 SETTABLEKS                       R8 R7 K26 ["readOnlyHint"]
       71 LOADB                            R8 0
       72 SETTABLEKS                       R8 R7 K27 ["destructiveHint"]
       74 LOADB                            R8 0
       75 SETTABLEKS                       R8 R7 K28 ["idempotentHint"]
       77 LOADB                            R8 0
       78 SETTABLEKS                       R8 R7 K29 ["openWorldHint"]
       80 NAMECALL                         R5 R5 K32 ["setAnnotations"]
       82 CALL                             R5 2 1
       83 MOVE                             R7 R4
       84 NAMECALL                         R5 R5 K33 ["setHandler"]
       86 CALL                             R5 2 1
       87 NAMECALL                         R5 R5 K34 ["build"]
       89 CALL                             R5 1 1
       90 DUPTABLE                         R6 K38 [{"definition", "getPreExecuteWarning", "displayNameFunction"}]
       91 SETTABLEKS                       R5 R6 K35 ["definition"]
       93 DUPCLOSURE                       R7 K39 [PROTO_4]
       94 CAPTURE                          UPVAL U5
       95 SETTABLEKS                       R7 R6 K36 ["getPreExecuteWarning"]
       97 GETUPVAL                         R8 6
       98 CALL                             R8 0 1
       99 JUMPIFNOT                        R8 ; [+2]
      100 LOADNIL                          R7
      101 JUMP                             ; [+2]
      102 DUPCLOSURE                       R7 K40 [PROTO_5]
      103 CAPTURE                          UPVAL U7
      104 SETTABLEKS                       R7 R6 K37 ["displayNameFunction"]
      106 RETURN                           R6 1
