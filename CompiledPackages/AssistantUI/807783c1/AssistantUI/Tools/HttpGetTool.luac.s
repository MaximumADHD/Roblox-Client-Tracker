...
PROTO_13:
      ...
      139 SETTABLEKS                       R8 R7 K47 ["contentWidgets"]
      141 GETUPVAL                         R9 9
      142 CALL                             R9 0 1
      143 JUMPIFNOT                        R9 ; [+2]
      144 LOADNIL                          R8
      145 JUMP                             ; [+1]
      146 MOVE                             R8 R6
      147 SETTABLEKS                       R8 R7 K48 ["streamTransform"]
      149 RETURN                           R7 1
...
MAIN:
       ...
       50 CALL                             R6 1 1
       51 GETTABLEKS                       R7 R2 K19 ["Util"]
       53 GETTABLEKS                       R7 R7 K20 ["ToolBuilder"]
       55 GETTABLEKS                       R8 R2 K19 ["Util"]
       57 GETTABLEKS                       R8 R8 K21 ["ToolResult"]
       59 GETTABLEKS                       R9 R4 K22 ["ToolNames"]
       61 GETTABLEKS                       R10 R1 K23 ["ROBLOX_ENGINE_DOCS_BASE_URL"]
       63 DUPCLOSURE                       R11 K24 [PROTO_0]
       64 NEWTABLE                         R12 0 4
       66 DUPTABLE                         R13 K28 [{"base", "description", "validate"}]
       67 SETTABLEKS                       R10 R13 K25 ["base"]
       69 LOADK                            R14 K29 ["Roblox Engine API docs — URLs must end with .md or be llms.txt"]
       70 SETTABLEKS                       R14 R13 K26 ["description"]
       72 SETTABLEKS                       R11 R13 K27 ["validate"]
       74 DUPTABLE                         R14 K28 [{"base", "description", "validate"}]
       75 LOADK                            R15 K30 ["https://create.roblox.com/docs/cloud"]
       76 SETTABLEKS                       R15 R14 K25 ["base"]
       78 LOADK                            R15 K31 ["Roblox Cloud API docs — URLs must end with .md or be llms.txt"]
       79 SETTABLEKS                       R15 R14 K26 ["description"]
       81 SETTABLEKS                       R11 R14 K27 ["validate"]
       83 DUPTABLE                         R15 K28 [{"base", "description", "validate"}]
       84 LOADK                            R16 K32 ["https://create.roblox.com/docs/performance-optimization"]
       85 SETTABLEKS                       R16 R15 K25 ["base"]
       87 LOADK                            R16 K33 ["Roblox Performance Optimization docs — URLs must end with .md or be llms.txt"]
       88 SETTABLEKS                       R16 R15 K26 ["description"]
       90 SETTABLEKS                       R11 R15 K27 ["validate"]
       92 DUPTABLE                         R16 K28 [{"base", "description", "validate"}]
       93 LOADK                            R17 K34 ["https://github.com/Roblox/libmp"]
       94 SETTABLEKS                       R17 R16 K25 ["base"]
       96 LOADK                            R17 K35 ["Roblox LibMP repository — URLs must end with .md or be llms.txt"]
       97 SETTABLEKS                       R17 R16 K26 ["description"]
       99 SETTABLEKS                       R11 R16 K27 ["validate"]
      101 SETLIST                          R12 R13 4 [1]
      103 DUPCLOSURE                       R13 K36 [PROTO_1]
      104 CAPTURE                          VAL R12
      105 DUPCLOSURE                       R14 K37 [PROTO_2]
      106 CAPTURE                          VAL R12
      107 DUPCLOSURE                       R15 K38 [PROTO_3]
      108 DUPCLOSURE                       R16 K39 [PROTO_4]
      109 CAPTURE                          VAL R15
      110 DUPCLOSURE                       R17 K40 [PROTO_13]
      111 CAPTURE                          VAL R13
      112 CAPTURE                          VAL R14
      113 CAPTURE                          VAL R8
      114 CAPTURE                          VAL R16
