...
PROTO_2:
        0 GETUPVAL                         R0 0
        1 LOADK                            R2 K0 ["Tools"]
        2 LOADK                            R3 K1 ["MultiPlayerAgentsCommunication"]
...
PROTO_3:
       ...
       35 DUPTABLE                         R7 K13 [{"type", "description"}]
       36 LOADK                            R8 K14 ["number"]
       37 SETTABLEKS                       R8 R7 K11 ["type"]
       39 LOADK                            R8 K15 ["The player id to send the multi-player agents communication to, 0 is the leader agent, 1 is the first player agent, 2 is the second player agent, etc."]
       40 SETTABLEKS                       R8 R7 K12 ["description"]
       42 NAMECALL                         R4 R4 K16 ["addArgument"]
       44 CALL                             R4 3 1
       45 LOADK                            R6 K17 ["content"]
       46 DUPTABLE                         R7 K13 [{"type", "description"}]
       47 LOADK                            R8 K18 ["string"]
       48 SETTABLEKS                       R8 R7 K11 ["type"]
       50 LOADK                            R8 K19 ["The content to send to the multi-player agents."]
       51 SETTABLEKS                       R8 R7 K12 ["description"]
       53 NAMECALL                         R4 R4 K16 ["addArgument"]
       55 CALL                             R4 3 1
       56 DUPTABLE                         R6 K25 [{"title", "readOnlyHint", "destructiveHint", "idempotentHint", "openWorldHint"}]
       57 LOADK                            R7 K26 ["Multi-Player Agents Communication"]
       58 SETTABLEKS                       R7 R6 K20 ["title"]
       60 LOADB                            R7 0
       61 SETTABLEKS                       R7 R6 K21 ["readOnlyHint"]
       63 LOADB                            R7 0
       64 SETTABLEKS                       R7 R6 K22 ["destructiveHint"]
       66 LOADB                            R7 0
       67 SETTABLEKS                       R7 R6 K23 ["idempotentHint"]
       69 LOADB                            R7 0
       70 SETTABLEKS                       R7 R6 K24 ["openWorldHint"]
       72 NAMECALL                         R4 R4 K27 ["setAnnotations"]
       74 CALL                             R4 2 1
       75 MOVE                             R6 R3
       76 NAMECALL                         R4 R4 K28 ["setHandler"]
       78 CALL                             R4 2 1
       79 NAMECALL                         R4 R4 K29 ["build"]
       81 CALL                             R4 1 1
       82 DUPTABLE                         R5 K32 [{"definition", "displayNameFunction"}]
       83 SETTABLEKS                       R4 R5 K30 ["definition"]
       85 GETUPVAL                         R7 7
       86 CALL                             R7 0 1
       87 JUMPIFNOT                        R7 ; [+2]
       88 LOADNIL                          R6
       89 JUMP                             ; [+2]
       90 DUPCLOSURE                       R6 K33 [PROTO_2]
       91 CAPTURE                          UPVAL U8
       92 SETTABLEKS                       R6 R5 K31 ["displayNameFunction"]
       94 RETURN                           R5 1
...
MAIN:
       ...
       63 GETTABLEKS                       R8 R0 K16 ["Resources"]
       65 GETTABLEKS                       R8 R8 K17 ["Localization"]
       67 GETTABLEKS                       R8 R8 K18 ["Translator"]
       69 CALL                             R7 1 1
       70 GETIMPORT                        R8 K5 [require]
       72 GETTABLEKS                       R9 R0 K19 ["Flags"]
       74 GETTABLEKS                       R9 R9 K20 ["FFlagAssistantSplitToolsAndWidgets"]
       76 CALL                             R8 1 1
       77 GETTABLEKS                       R9 R2 K7 ["Util"]
       79 GETTABLEKS                       R9 R9 K21 ["ToolBuilder"]
       81 GETTABLEKS                       R10 R2 K7 ["Util"]
       83 GETTABLEKS                       R10 R10 K22 ["ToolResult"]
       85 GETTABLEKS                       R11 R6 K23 ["ToolNames"]
       87 DUPCLOSURE                       R12 K24 [PROTO_3]
       88 CAPTURE                          VAL R5
       89 CAPTURE                          VAL R1
       90 CAPTURE                          VAL R4
       91 CAPTURE                          VAL R3
