...
MAIN:
       ...
       16 DUPTABLE                         R3 K11 [{"QuestionAnswer", "InputRequested"}]
       17 LOADN                            R4 0
       18 SETTABLEKS                       R4 R3 K9 ["QuestionAnswer"]
       20 LOADN                            R4 1
       21 SETTABLEKS                       R4 R3 K10 ["InputRequested"]
       23 DUPTABLE                         R4 K14 [{"activeRender", "registerOverride"}]
       24 LOADNIL                          R5
       25 SETTABLEKS                       R5 R4 K12 ["activeRender"]
       27 DUPCLOSURE                       R5 K15 [PROTO_1]
       28 SETTABLEKS                       R5 R4 K13 ["registerOverride"]
       30 GETTABLEKS                       R5 R1 K16 ["createContext"]
       32 MOVE                             R6 R4
       33 CALL                             R5 1 1
       34 DUPCLOSURE                       R6 K17 [PROTO_2]
       35 DUPCLOSURE                       R7 K18 [PROTO_8]
       36 CAPTURE                          VAL R1
       37 CAPTURE                          VAL R2
       38 CAPTURE                          VAL R5
       39 DUPTABLE                         R8 K22 [{"Context", "Provider", "OverridePriorities"}]
       40 SETTABLEKS                       R5 R8 K19 ["Context"]
       42 SETTABLEKS                       R7 R8 K20 ["Provider"]
       44 SETTABLEKS                       R3 R8 K21 ["OverridePriorities"]
       46 RETURN                           R8 1
