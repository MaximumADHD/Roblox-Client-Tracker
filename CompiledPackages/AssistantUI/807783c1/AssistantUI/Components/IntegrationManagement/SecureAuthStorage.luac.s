...
PROTO_12:
       ...
       22 JUMPIFNOT                        R5 ; [+7]
       23 GETIMPORT                        R5 K6 [warn]
       25 LOADK                            R6 K7 ["Failed to write secure settings for key:"]
       26 MOVE                             R7 R2
       27 MOVE                             R8 R4
       28 CALL                             R5 3 0
       29 RETURN                           R0 0
...
MAIN:
       ...
       49 CALL                             R6 1 1
       50 NEWTABLE                         R7 4 0
       52 GETTABLEKS                       R8 R5 K21 ["wrapFunction"]
       54 GETTABLEKS                       R9 R5 K22 ["collectTasks"]
       56 DUPCLOSURE                       R10 K23 [PROTO_0]
       57 CAPTURE                          VAL R1
       58 DUPCLOSURE                       R11 K24 [PROTO_2]
       59 CAPTURE                          VAL R6
       60 DUPCLOSURE                       R12 K25 [PROTO_4]
       61 CAPTURE                          VAL R6
       62 DUPCLOSURE                       R13 K26 [PROTO_5]
       63 DUPCLOSURE                       R14 K27 [PROTO_8]
       64 CAPTURE                          VAL R3
       65 CAPTURE                          VAL R8
       66 CAPTURE                          VAL R1
       67 CAPTURE                          VAL R6
       68 CAPTURE                          VAL R9
       69 SETTABLEKS                       R14 R7 K28 ["attachSecretsAsync"]
       71 DUPCLOSURE                       R14 K29 [PROTO_11]
       72 CAPTURE                          VAL R3
       73 CAPTURE                          VAL R8
       74 CAPTURE                          VAL R1
       75 CAPTURE                          VAL R6
       76 CAPTURE                          VAL R9
       77 SETTABLEKS                       R14 R7 K30 ["extractAndSaveSecretsAsync"]
       79 DUPCLOSURE                       R14 K31 [PROTO_12]
       80 CAPTURE                          VAL R1
       81 CAPTURE                          VAL R6
       82 SETTABLEKS                       R14 R7 K32 ["removeSecretsAsync"]
       84 RETURN                           R7 1
