...
PROTO_4:
      ...
      183 CALL                             R15 1 1
      184 JUMPIFNOT                        R15 ; [+7]
      185 FASTCALL1                        TYPEOF R15 ; [+3]
      186 MOVE                             R17 R15
      187 GETIMPORT                        R16 K75 [typeof]
      189 CALL                             R16 1 1
      190 JUMPIFNOTEQKS                    R16 K76 ["string"] ; [+6]
      192 GETIMPORT                        R16 K78 [error]
      194 MOVE                             R17 R15
      195 LOADN                            R18 0
      196 CALL                             R16 2 0
      197 GETTABLEKS                       R16 R15 K79 ["model"]
      199 GETUPVAL                         R17 0
      200 GETTABLEKS                       R17 R17 K80 ["FFlagPrimGenSchemaSelector"]
      202 JUMPIFNOT                        R17 ; [+12]
      203 LENGTH                           R17 R3
      204 JUMPIFNOTEQKN                    R17 K81 [0] ; [+10]
      206 GETUPVAL                         R17 6
      207 ADDK                             R17 R17 K82 [1]
      208 SETUPVAL                         R17 6
      209 LOADK                            R18 K83 ["MeshGen"]
      210 GETUPVAL                         R19 6
      211 CONCAT                           R17 R18 R19
      212 SETTABLEKS                       R17 R16 K84 ["Name"]
      214 JUMP                             ; [+2]
      215 SETTABLEKS                       R3 R16 K84 ["Name"]
      217 SETTABLEKS                       R16 R10 K85 ["previewAssets"]
      219 GETTABLEKS                       R17 R1 K86 ["callArgs"]
      221 GETTABLEKS                       R17 R17 K87 ["isThirdPartyRequest"]
      223 JUMPIF                           R17 ; [+14]
      224 GETUPVAL                         R17 7
      225 GETTABLEKS                       R17 R17 K88 ["capturePreviewImages"]
      227 MOVE                             R18 R16
      228 NEWCLOSURE                       R19 P1
      229 CAPTURE                          VAL R1
      230 GETUPVAL                         R21 0
      231 GETTABLEKS                       R21 R21 K89 ["FFlagAssistantMeshGenCarouselPreview"]
      233 JUMPIFNOT                        R21 ; [+2]
      234 GETUPVAL                         R20 8
      235 JUMP                             ; [+1]
      236 LOADNIL                          R20
      237 CALL                             R17 3 0
      238 DUPTABLE                         R17 K91 [{"generationId"}]
      239 GETTABLEKS                       R18 R15 K92 ["metadata"]
      241 GETTABLEKS                       R18 R18 K93 ["UUID"]
      243 SETTABLEKS                       R18 R17 K90 ["generationId"]
      245 CLOSEUPVALS                      R4
      246 RETURN                           R17 1
...
MAIN:
       ...
       73 GETTABLEKS                       R12 R9 K23 ["MeshGenTool"]
       75 GETTABLEKS                       R12 R12 K24 ["MeshGenHost"]
       77 GETTABLEKS                       R12 R12 K25 ["MeshGenAssetManager"]
       79 CALL                             R11 1 1
       80 GETIMPORT                        R12 K11 [require]
       82 GETTABLEKS                       R13 R9 K23 ["MeshGenTool"]
       84 GETTABLEKS                       R13 R13 K26 ["MeshGenBridgeTypes"]
       86 CALL                             R12 1 1
       87 GETIMPORT                        R13 K11 [require]
       89 GETTABLEKS                       R14 R9 K27 ["MeshGenConstants"]
       91 CALL                             R13 1 1
       92 GETIMPORT                        R14 K11 [require]
       94 GETTABLEKS                       R15 R9 K28 ["MeshGenTypes"]
       96 CALL                             R14 1 1
       97 GETIMPORT                        R15 K11 [require]
       99 GETTABLEKS                       R16 R0 K29 ["Features"]
      101 GETTABLEKS                       R16 R16 K30 ["Gen3dUtils"]
      103 GETTABLEKS                       R16 R16 K31 ["ViewportPreviewUtils"]
      105 CALL                             R15 1 1
      106 GETTABLEKS                       R16 R13 K32 ["Enums"]
      108 LOADN                            R17 0
      109 LOADN                            R18 0
      110 GETTABLEKS                       R19 R13 K33 ["PREVIEW_IMAGE_COUNT_CAROUSEL"]
      112 NEWTABLE                         R20 0 0
      114 LOADN                            R23 0
      115 SUBK                             R21 R19 K34 [1]
      116 LOADN                            R22 1
      117 FORNPREP                         R21
      118 DUPTABLE                         R26 K38 [{["azimuth"], ["elevation"] = 30}]
      119 DIVRK                            R29 K40 [360] R19
      120 MUL                              R28 R29 R23
      121 ADDK                             R27 R28 K39 [45]
      122 SETTABLEKS                       R27 R26 K35 ["azimuth"]
      124 FASTCALL2                        TABLE_INSERT R20 R26 ; [+4]
      126 MOVE                             R25 R20
      127 GETIMPORT                        R24 K43 [table.insert]
      129 CALL                             R24 2 0
      130 FORNLOOP                         R21
      131 DUPCLOSURE                       R21 K44 [PROTO_0]
      132 CAPTURE                          VAL R13
      133 CAPTURE                          VAL R11
      134 NEWCLOSURE                       R22 P1
      135 CAPTURE                          VAL R10
      136 CAPTURE                          VAL R11
      137 CAPTURE                          VAL R21
      138 CAPTURE                          VAL R16
      ...
      142 CAPTURE                          VAL R15
      143 CAPTURE                          VAL R20
      144 DUPCLOSURE                       R23 K45 [PROTO_5]
      145 CAPTURE                          VAL R11
      146 DUPCLOSURE                       R24 K46 [PROTO_6]
      147 CAPTURE                          VAL R11
      148 DUPCLOSURE                       R25 K47 [PROTO_7]
      149 CAPTURE                          VAL R13
      150 CAPTURE                          VAL R1
      151 DUPCLOSURE                       R26 K48 [PROTO_8]
      152 CAPTURE                          VAL R11
      153 CAPTURE                          VAL R13
      154 CAPTURE                          VAL R1
      155 NEWCLOSURE                       R27 P6
      156 CAPTURE                          REF R17
      157 CAPTURE                          VAL R11
      158 CAPTURE                          VAL R14
      159 CAPTURE                          VAL R10
      ...
      161 CAPTURE                          VAL R26
      162 CAPTURE                          VAL R6
      163 DUPCLOSURE                       R28 K49 [PROTO_12]
      164 CAPTURE                          VAL R14
      165 CAPTURE                          VAL R1
      166 DUPCLOSURE                       R29 K50 [PROTO_14]
      167 CAPTURE                          VAL R14
      168 CAPTURE                          VAL R5
      169 CAPTURE                          VAL R1
      170 CAPTURE                          VAL R10
      171 CAPTURE                          VAL R7
      172 DUPCLOSURE                       R30 K51 [PROTO_15]
      173 CAPTURE                          VAL R10
      174 CAPTURE                          VAL R13
      175 DUPCLOSURE                       R31 K52 [PROTO_16]
      176 CAPTURE                          VAL R10
      177 CAPTURE                          VAL R13
      178 DUPCLOSURE                       R32 K53 [PROTO_17]
      179 CAPTURE                          VAL R10
      180 DUPTABLE                         R33 K64 [{"generateAssetsAsync", "cancelGenerationAsync", "publishAssetsAsync", "removeSelectedBoundsAsync", "insertAssetsAsync", "selectLinkedAssets", "listenToLinkChanges", "getSelectedBoundingBox", "createViewportBoundingBoxAsync", "destroyViewportBoundingBoxAsync"}]
      181 SETTABLEKS                       R22 R33 K54 ["generateAssetsAsync"]
      183 SETTABLEKS                       R23 R33 K55 ["cancelGenerationAsync"]
      185 SETTABLEKS                       R24 R33 K56 ["publishAssetsAsync"]
      187 SETTABLEKS                       R26 R33 K57 ["removeSelectedBoundsAsync"]
      189 SETTABLEKS                       R27 R33 K58 ["insertAssetsAsync"]
      191 SETTABLEKS                       R28 R33 K59 ["selectLinkedAssets"]
      193 SETTABLEKS                       R29 R33 K60 ["listenToLinkChanges"]
      195 SETTABLEKS                       R30 R33 K61 ["getSelectedBoundingBox"]
      197 SETTABLEKS                       R31 R33 K62 ["createViewportBoundingBoxAsync"]
      199 SETTABLEKS                       R32 R33 K63 ["destroyViewportBoundingBoxAsync"]
      201 DUPTABLE                         R34 K66 [{"bridge"}]
      202 SETTABLEKS                       R33 R34 K65 ["bridge"]
      204 CLOSEUPVALS                      R17
      205 RETURN                           R34 1
