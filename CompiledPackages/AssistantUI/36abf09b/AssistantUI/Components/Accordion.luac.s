...
PROTO_1:
        ...
        6 DUPTABLE                         R1 K3 [{["rawTransformValues"] = True}]
        7 RETURN                           R1 1
...
PROTO_4:
       ...
       21 CAPTURE                          VAL R1
       22 NEWTABLE                         R4 0 2
       24 GETTABLEKS                       R5 R0 K3 ["expanded"]
       26 MOVE                             R6 R1
       27 SETLIST                          R4 R5 2 [1]
       29 CALL                             R2 2 1
       30 GETUPVAL                         R3 1
       31 GETUPVAL                         R4 2
       32 DUPTABLE                         R5 K7 [{"tag", "LayoutOrder"}]
       33 GETTABLEKS                       R7 R0 K5 ["tag"]
       35 ORK                              R6 R7 K8 ["col size-full-0 auto-xy gap-small"]
       36 SETTABLEKS                       R6 R5 K5 ["tag"]
       38 GETTABLEKS                       R6 R0 K6 ["LayoutOrder"]
       40 SETTABLEKS                       R6 R5 K6 ["LayoutOrder"]
       42 DUPTABLE                         R6 K10 [{"Context"}]
       43 GETUPVAL                         R7 1
       44 GETUPVAL                         R8 3
       45 GETTABLEKS                       R8 R8 K11 ["Provider"]
       47 DUPTABLE                         R9 K13 [{"value"}]
       48 SETTABLEKS                       R2 R9 K12 ["value"]
       50 GETTABLEKS                       R10 R0 K14 ["children"]
       52 CALL                             R7 3 1
       53 SETTABLEKS                       R7 R6 K9 ["Context"]
       55 CALL                             R3 3 -1
       56 RETURN                           R3 -1
