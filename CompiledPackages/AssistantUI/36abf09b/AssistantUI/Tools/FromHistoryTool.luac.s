...
PROTO_6:
       ...
       80 RETURN                           R9 -1
       81 GETUPVAL                         R9 4
       82 GETTABLEKS                       R9 R9 K13 ["FIntFromHistoryMaxResultChars"]
       84 LENGTH                           R10 R8
       85 JUMPIFNOTLT                      R9 R10 ; [+28]
       87 GETUPVAL                         R10 1
       88 CALL                             R10 0 1
       89 GETIMPORT                        R12 K15 [string.format]
       ...
       97 MOVE                             R16 R4
       98 CALL                             R12 4 -1
       99 NAMECALL                         R10 R10 K3 ["addText"]
      101 CALL                             R10 -1 1
      102 DUPTABLE                         R12 K19 [{["type"], ["key"], ["truncated"] = True}]
      103 SETTABLEKS                       R4 R12 K6 ["type"]
      105 SETTABLEKS                       R5 R12 K7 ["key"]
      107 NAMECALL                         R10 R10 K20 ["setStructuredContent"]
      109 CALL                             R10 2 1
      110 NAMECALL                         R10 R10 K5 ["build"]
      112 CALL                             R10 1 -1
      113 RETURN                           R10 -1
      114 GETUPVAL                         R10 1
      115 CALL                             R10 0 1
      116 MOVE                             R12 R8
      117 NAMECALL                         R10 R10 K3 ["addText"]
      119 CALL                             R10 2 1
      120 DUPTABLE                         R12 K21 [{"type", "key"}]
      121 SETTABLEKS                       R4 R12 K6 ["type"]
      123 SETTABLEKS                       R5 R12 K7 ["key"]
      125 NAMECALL                         R10 R10 K20 ["setStructuredContent"]
      127 CALL                             R10 2 1
      128 NAMECALL                         R10 R10 K5 ["build"]
      130 CALL                             R10 1 -1
      131 RETURN                           R10 -1
...
MAIN:
       ...
       34 GETTABLEKS                       R5 R5 K14 ["SummarizedContentWidget"]
       36 CALL                             R4 1 1
       ...
       59 CALL                             R7 1 1
       60 GETTABLEKS                       R8 R3 K6 ["Util"]
       62 GETTABLEKS                       R8 R8 K21 ["ToolBuilder"]
       64 GETTABLEKS                       R9 R3 K6 ["Util"]
       66 GETTABLEKS                       R9 R9 K22 ["ToolResult"]
       68 GETTABLEKS                       R10 R5 K23 ["ToolNames"]
       70 NEWTABLE                         R11 4 0
       72 GETTABLEKS                       R12 R10 K24 ["ReadFile"]
       74 DUPCLOSURE                       R13 K25 [PROTO_0]
       75 CAPTURE                          VAL R1
       76 SETTABLE                         R13 R11 R12
       77 GETTABLEKS                       R12 R10 K26 ["GrepSearch"]
       79 DUPCLOSURE                       R13 K27 [PROTO_1]
       80 CAPTURE                          VAL R1
       81 SETTABLE                         R13 R11 R12
       82 GETTABLEKS                       R12 R10 K28 ["InspectInstance"]
       84 DUPCLOSURE                       R13 K29 [PROTO_2]
       85 CAPTURE                          VAL R1
       86 SETTABLE                         R13 R11 R12
       87 GETTABLEKS                       R12 R10 K30 ["GameTree"]
       89 DUPCLOSURE                       R13 K31 [PROTO_3]
       90 CAPTURE                          VAL R1
       91 SETTABLE                         R13 R11 R12
       92 GETTABLEKS                       R12 R2 K32 ["FFlagAssistantMarkdownPlanMode"]
       94 JUMPIFNOT                        R12 ; [+4]
       95 DUPCLOSURE                       R12 K33 [PROTO_4]
       96 CAPTURE                          VAL R1
       97 SETTABLEKS                       R12 R11 K34 ["plan_mode"]
       99 DUPCLOSURE                       R12 K35 [PROTO_5]
      100 CAPTURE                          VAL R11
      101 DUPCLOSURE                       R13 K36 [PROTO_10]
      102 CAPTURE                          VAL R1
      103 CAPTURE                          VAL R9
      104 CAPTURE                          VAL R12
      105 CAPTURE                          VAL R11
