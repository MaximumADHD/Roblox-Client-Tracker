...
PROTO_7:
       ...
       58 CALL                             R5 1 1
       59 GETUPVAL                         R6 4
       60 GETTABLEKS                       R6 R6 K40 ["FFlagAssistantSplitToolsAndWidgets"]
       62 JUMPIF                           R6 ; [+7]
       63 LOADK                            R8 K41 ["ReadFileTool_openScript"]
       64 NEWCLOSURE                       R9 P2
       65 CAPTURE                          UPVAL U5
       66 CAPTURE                          VAL R2
       67 NAMECALL                         R6 R1 K3 ["OnHostInvokeAsync"]
       69 CALL                             R6 3 0
       70 DUPTABLE                         R6 K44 [{"transformInitialContent", "getTransformPreExecuteFn"}]
       71 DUPCLOSURE                       R7 K45 [PROTO_4]
       72 CAPTURE                          UPVAL U6
       73 SETTABLEKS                       R7 R6 K42 ["transformInitialContent"]
       75 DUPCLOSURE                       R7 K46 [PROTO_6]
       76 SETTABLEKS                       R7 R6 K43 ["getTransformPreExecuteFn"]
       78 DUPTABLE                         R7 K50 [{"definition", "contentWidgets", "streamTransform"}]
       79 SETTABLEKS                       R5 R7 K47 ["definition"]
       81 GETUPVAL                         R9 4
       82 GETTABLEKS                       R9 R9 K40 ["FFlagAssistantSplitToolsAndWidgets"]
       84 JUMPIFNOT                        R9 ; [+2]
       85 LOADNIL                          R8
       86 JUMP                             ; [+5]
       87 NEWTABLE                         R8 0 1
       ...
       92 SETTABLEKS                       R8 R7 K48 ["contentWidgets"]
       94 GETUPVAL                         R9 4
       95 GETTABLEKS                       R9 R9 K40 ["FFlagAssistantSplitToolsAndWidgets"]
       97 JUMPIFNOT                        R9 ; [+2]
       98 LOADNIL                          R8
       99 JUMP                             ; [+1]
      100 MOVE                             R8 R6
      101 SETTABLEKS                       R8 R7 K49 ["streamTransform"]
      103 RETURN                           R7 1
...
MAIN:
       ...
       32 GETTABLEKS                       R5 R5 K13 ["ReadFileContentWidget"]
       34 CALL                             R4 1 1
       ...
       44 GETTABLEKS                       R7 R0 K16 ["Util"]
       46 GETTABLEKS                       R7 R7 K17 ["ToolUtils"]
       48 CALL                             R6 1 1
       49 GETTABLEKS                       R7 R3 K16 ["Util"]
       51 GETTABLEKS                       R7 R7 K18 ["ToolBuilder"]
       53 GETTABLEKS                       R8 R3 K16 ["Util"]
       55 GETTABLEKS                       R8 R8 K19 ["ToolResult"]
       57 GETTABLEKS                       R9 R5 K20 ["ToolNames"]
       59 DUPCLOSURE                       R10 K21 [PROTO_0]
       60 CAPTURE                          VAL R6
       61 DUPCLOSURE                       R11 K22 [PROTO_7]
       62 CAPTURE                          VAL R10
       63 CAPTURE                          VAL R8
       64 CAPTURE                          VAL R7
       65 CAPTURE                          VAL R9
