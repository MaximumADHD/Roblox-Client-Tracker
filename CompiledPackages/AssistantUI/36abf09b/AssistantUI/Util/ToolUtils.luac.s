...
MAIN:
       ...
       31 GETTABLEKS                       R6 R1 K14 ["Flags"]
       33 CALL                             R5 1 1
       34 GETIMPORT                        R6 K9 [require]
       36 GETTABLEKS                       R7 R1 K15 ["Util"]
       38 GETTABLEKS                       R7 R7 K16 ["truncateUtf8Safe"]
       40 CALL                             R6 1 1
       41 NEWTABLE                         R7 0 0
       43 GETTABLEKS                       R8 R5 K17 ["FStringAssistantToolsExcludedDirectories"]
       45 LOADK                            R11 K18 ["[^,]+"]
       46 NAMECALL                         R9 R8 K19 ["gmatch"]
       48 CALL                             R9 2 3
       49 FORGPREP                         R9
       50 LOADK                            R16 K20 ["^%s*(.-)%s*$"]
       51 NAMECALL                         R14 R12 K21 ["match"]
       53 CALL                             R14 2 1
       54 JUMPIFNOT                        R14 ; [+9]
       55 JUMPIFEQKS                       R14 K22 [""] ; [+8]
       57 FASTCALL2                        TABLE_INSERT R7 R14 ; [+5]
       59 MOVE                             R16 R7
       60 MOVE                             R17 R14
       61 GETIMPORT                        R15 K25 [table.insert]
       63 CALL                             R15 2 0
       64 FORGLOOP                         R9 1 ; [-15]
       66 NEWTABLE                         R8 0 0
       68 DUPCLOSURE                       R9 K26 [PROTO_0]
       69 DUPCLOSURE                       R10 K27 [PROTO_1]
       70 DUPCLOSURE                       R11 K28 [PROTO_3]
       71 CAPTURE                          VAL R8
       72 CAPTURE                          VAL R3
       73 CAPTURE                          VAL R9
       74 CAPTURE                          VAL R10
       75 SETTABLEKS                       R11 R0 K29 ["loadCachedAssetAsync"]
       77 DUPCLOSURE                       R11 K30 [PROTO_4]
       78 CAPTURE                          VAL R10
       79 DUPCLOSURE                       R12 K31 [PROTO_5]
       80 DUPCLOSURE                       R13 K32 [PROTO_6]
       81 CAPTURE                          VAL R12
       82 DUPCLOSURE                       R14 K33 [PROTO_7]
       83 DUPCLOSURE                       R15 K34 [PROTO_9]
       84 CAPTURE                          VAL R11
       85 CAPTURE                          VAL R13
       86 CAPTURE                          VAL R14
       87 SETTABLEKS                       R15 R0 K35 ["setPositionOnGround"]
       89 DUPCLOSURE                       R15 K36 [PROTO_10]
       90 SETTABLEKS                       R15 R0 K37 ["useEnumExcept"]
       92 DUPCLOSURE                       R15 K38 [PROTO_11]
       93 CAPTURE                          VAL R0
       94 SETTABLEKS                       R15 R0 K39 ["useEnum"]
       96 DUPCLOSURE                       R15 K40 [PROTO_12]
       97 CAPTURE                          VAL R2
       98 SETTABLEKS                       R15 R0 K41 ["toString"]
      100 DUPCLOSURE                       R15 K42 [PROTO_15]
      101 CAPTURE                          VAL R6
      102 CAPTURE                          VAL R0
      103 CAPTURE                          VAL R2
      104 SETTABLEKS                       R15 R0 K43 ["getValueRepresentation"]
      106 DUPCLOSURE                       R15 K44 [PROTO_16]
      107 CAPTURE                          VAL R0
      108 SETTABLEKS                       R15 R0 K45 ["serializeToString"]
      110 DUPCLOSURE                       R15 K46 [PROTO_19]
      111 SETTABLEKS                       R15 R0 K47 ["runWithProgressLoop"]
      113 DUPCLOSURE                       R15 K48 [PROTO_21]
      114 SETTABLEKS                       R15 R0 K49 ["findOrCreateInstance"]
      116 DUPCLOSURE                       R15 K50 [PROTO_23]
      117 SETTABLEKS                       R15 R0 K51 ["findInstance"]
      119 DUPCLOSURE                       R15 K52 [PROTO_24]
      120 CAPTURE                          VAL R2
      121 SETTABLEKS                       R15 R0 K53 ["generateToolId"]
      123 DUPCLOSURE                       R15 K54 [PROTO_26]
      124 SETTABLEKS                       R15 R0 K55 ["preloadMaterialVariant"]
      126 DUPCLOSURE                       R15 K56 [PROTO_28]
      127 SETTABLEKS                       R15 R0 K57 ["captureSnapshotAsync"]
      129 DUPCLOSURE                       R15 K58 [PROTO_29]
      130 CAPTURE                          VAL R7
      131 SETTABLEKS                       R15 R0 K59 ["isPathExcluded"]
      133 DUPCLOSURE                       R15 K60 [PROTO_31]
      134 CAPTURE                          VAL R5
      135 SETTABLEKS                       R15 R0 K61 ["getScreenCaptureSize"]
      137 RETURN                           R0 1
