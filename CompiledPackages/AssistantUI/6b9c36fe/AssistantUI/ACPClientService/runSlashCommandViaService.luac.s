...
PROTO_12:
      ...
      230 DUPTABLE                         R3 K20 [{"errorType", "messageGuid", "acpSessionId", "threadId"}]
      231 ORK                              R4 R1 K21 ["client_error"]
      232 SETTABLEKS                       R4 R3 K16 ["errorType"]
      234 GETUPVAL                         R4 2
      235 GETTABLEKS                       R4 R4 K22 ["assistantMessageId"]
      237 SETTABLEKS                       R4 R3 K17 ["messageGuid"]
      239 GETUPVAL                         R4 3
      240 SETTABLEKS                       R4 R3 K18 ["acpSessionId"]
      242 GETUPVAL                         R4 2
      243 GETTABLEKS                       R4 R4 K19 ["threadId"]
      245 SETTABLEKS                       R4 R3 K19 ["threadId"]
      247 CALL                             R2 1 0
      248 GETUPVAL                         R2 10
      249 CALL                             R2 0 0
      250 CLOSEUPVALS                      R1
...
PROTO_14:
       ...
       97 CAPTURE                          UPVAL U0
       98 SETTABLEKS                       R10 R9 K25 ["addContent"]
      100 NEWCLOSURE                       R10 P1
      101 CAPTURE                          UPVAL U0
      102 SETTABLEKS                       R10 R9 K26 ["editContent"]
      104 NEWCLOSURE                       R10 P2
      105 CAPTURE                          VAL R2
      106 SETTABLEKS                       R10 R9 K27 ["getMessageId"]
      108 CALL                             R8 1 -1
      109 NAMECALL                         R5 R5 K29 ["setClientToolConfirmationHandler"]
      111 CALL                             R5 -1 0
      112 DUPTABLE                         R5 K32 [{"cancelSessionPrompt", "getStateOfSessionPrompt"}]
      113 GETUPVAL                         R6 3
      114 SETTABLEKS                       R6 R5 K30 ["cancelSessionPrompt"]
      116 NEWCLOSURE                       R6 P3
      117 CAPTURE                          VAL R4
      118 CAPTURE                          UPVAL U4
      119 SETTABLEKS                       R6 R5 K31 ["getStateOfSessionPrompt"]
      121 GETUPVAL                         R6 0
      122 GETTABLEKS                       R6 R6 K33 ["registerPromptController"]
      124 JUMPIFNOT                        R6 ; [+6]
      125 GETUPVAL                         R6 0
      126 GETTABLEKS                       R6 R6 K33 ["registerPromptController"]
      128 MOVE                             R7 R4
      129 MOVE                             R8 R5
      130 CALL                             R6 2 0
      131 LOADNIL                          R6
      132 LOADB                            R7 0
      133 LOADNIL                          R8
      134 NEWCLOSURE                       R9 P4
      135 CAPTURE                          UPVAL U0
      136 CAPTURE                          VAL R4
      137 CAPTURE                          VAL R2
      138 CAPTURE                          REF R8
      139 NEWCLOSURE                       R10 P5
      140 CAPTURE                          REF R7
      ...
      179 NAMECALL                         R14 R2 K34 ["observeUpdates"]
      181 CALL                             R14 2 1
      182 MOVE                             R8 R14
      183 DUPTABLE                         R14 K38 [{"sessionId", "name", "arguments", "userPromptText"}]
      184 SETTABLEKS                       R4 R14 K17 ["sessionId"]
      186 GETUPVAL                         R15 8
      187 GETTABLEKS                       R15 R15 K39 ["agentToolName"]
      189 SETTABLEKS                       R15 R14 K35 ["name"]
      191 GETUPVAL                         R15 8
      192 GETTABLEKS                       R15 R15 K36 ["arguments"]
      194 SETTABLEKS                       R15 R14 K36 ["arguments"]
      196 GETUPVAL                         R15 8
      197 GETTABLEKS                       R15 R15 K37 ["userPromptText"]
      199 SETTABLEKS                       R15 R14 K37 ["userPromptText"]
      201 GETUPVAL                         R15 5
      202 GETTABLEKS                       R15 R15 K40 ["FFlagAssistantOmitSlashToolCallDroppedFields"]
      204 JUMPIF                           R15 ; [+13]
      205 GETUPVAL                         R15 9
      206 GETUPVAL                         R16 8
      207 GETTABLEKS                       R16 R16 K41 ["images"]
      209 CALL                             R15 1 1
      210 SETTABLEKS                       R15 R14 K41 ["images"]
      212 DUPTABLE                         R15 K43 [{"_roblox"}]
      213 DUPTABLE                         R16 K45 [{["isSlashCommand"] = True}]
      214 SETTABLEKS                       R16 R15 K42 ["_roblox"]
      216 SETTABLEKS                       R15 R14 K46 ["_meta"]
      218 GETUPVAL                         R15 0
      219 GETTABLEKS                       R15 R15 K7 ["service"]
      221 MOVE                             R17 R14
      222 NAMECALL                         R15 R15 K47 ["requestToolCall"]
      224 CALL                             R15 2 1
      225 NAMECALL                         R15 R15 K11 ["await"]
      227 CALL                             R15 1 2
      228 JUMPIFNOT                        R15 ; [+18]
      229 FASTCALL1                        TYPE R16 ; [+3]
      230 MOVE                             R18 R16
      231 GETIMPORT                        R17 K49 [type]
      233 CALL                             R17 1 1
      234 JUMPIFNOTEQKS                    R17 K50 ["table"] ; [+12]
      236 GETTABLEKS                       R18 R16 K51 ["toolCallId"]
      238 FASTCALL1                        TYPEOF R18 ; [+2]
      239 GETIMPORT                        R17 K53 [typeof]
      241 CALL                             R17 1 1
      242 JUMPIFNOTEQKS                    R17 K54 ["string"] ; [+4]
      244 GETTABLEKS                       R17 R16 K51 ["toolCallId"]
      246 SETUPVAL                         R17 4
      247 JUMPIF                           R15 ; [+40]
      248 JUMPIF                           R7 ; [+39]
      249 LOADB                            R7 1
      250 GETUPVAL                         R17 0
      251 GETTABLEKS                       R17 R17 K7 ["service"]
      253 MOVE                             R19 R4
      254 LOADNIL                          R20
      255 NAMECALL                         R17 R17 K29 ["setClientToolConfirmationHandler"]
      257 CALL                             R17 3 0
      258 GETUPVAL                         R17 0
      259 GETTABLEKS                       R17 R17 K55 ["unregisterPromptController"]
      261 JUMPIFNOT                        R17 ; [+5]
      262 GETUPVAL                         R17 0
      263 GETTABLEKS                       R17 R17 K55 ["unregisterPromptController"]
      265 MOVE                             R18 R4
      266 CALL                             R17 1 0
      267 NAMECALL                         R17 R2 K12 ["endTurn"]
      269 CALL                             R17 1 0
      270 JUMPIFNOT                        R8 ; [+3]
      271 MOVE                             R17 R8
      272 CALL                             R17 0 0
      273 LOADNIL                          R8
      274 MOVE                             R17 R1
      275 LOADK                            R19 K56 ["_roblox/session/tool_call failed: %*"]
      276 FASTCALL1                        TOSTRING R16 ; [+3]
      277 MOVE                             R22 R16
      278 GETIMPORT                        R21 K15 [tostring]
      280 CALL                             R21 1 1
      281 NAMECALL                         R19 R19 K16 ["format"]
      283 CALL                             R19 2 1
      284 MOVE                             R18 R19
      285 CALL                             R17 1 0
      286 CLOSEUPVALS                      R6
      ...
      289 JUMPIFNOT                        R17 ; [+9]
      290 GETUPVAL                         R17 0
      291 GETTABLEKS                       R17 R17 K7 ["service"]
      293 DUPTABLE                         R19 K57 [{"sessionId"}]
      294 SETTABLEKS                       R4 R19 K17 ["sessionId"]
      296 NAMECALL                         R17 R17 K58 ["cancel"]
      298 CALL                             R17 2 0
      299 CLOSEUPVALS                      R6
      300 RETURN                           R0 0
