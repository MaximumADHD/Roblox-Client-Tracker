...
PROTO_3:
       ...
       22 DUPTABLE                         R6 K14 [{"requestId", "textPrompt", "selectedUniqueId", "hintImage", "hintImageContentType", "model"}]
       ...
       39 GETTABLEKS                       R7 R0 K13 ["model"]
       41 SETTABLEKS                       R7 R6 K13 ["model"]
       43 GETUPVAL                         R7 2
       44 GETTABLEKS                       R7 R7 K15 ["buildServices"]
       46 DUPTABLE                         R8 K17 [{"environment"}]
       47 GETTABLEKS                       R9 R1 K18 ["initArgs"]
       49 GETTABLEKS                       R9 R9 K16 ["environment"]
       51 SETTABLEKS                       R9 R8 K16 ["environment"]
       53 CALL                             R7 1 1
       54 GETUPVAL                         R8 3
       55 DUPTABLE                         R9 K20 [{"setPreviewImage"}]
       56 GETUPVAL                         R10 4
       57 GETTABLEKS                       R11 R0 K9 ["requestId"]
       59 CALL                             R10 1 1
       60 SETTABLEKS                       R10 R9 K19 ["setPreviewImage"]
       62 CALL                             R5 4 -1
       63 RETURN                           R5 -1
...
PROTO_5:
       ...
       27 CALL                             R2 3 0
       28 GETUPVAL                         R2 0
       29 GETTABLEKS                       R2 R2 K12 ["getFFlagGen3dTextureGenReapplyMeshInPlace"]
       31 CALL                             R2 0 1
       32 JUMPIFNOT                        R2 ; [+12]
       33 GETUPVAL                         R2 0
       34 GETTABLEKS                       R2 R2 K0 ["TextureGenOps"]
       36 GETTABLEKS                       R2 R2 K13 ["releaseRevertSnapshot"]
       38 DUPTABLE                         R3 K14 [{"requestId"}]
       39 GETTABLEKS                       R4 R0 K2 ["requestId"]
       41 SETTABLEKS                       R4 R3 K2 ["requestId"]
       43 GETUPVAL                         R4 3
       44 CALL                             R2 2 0
       45 RETURN                           R0 0
...
MAIN:
       ...
       44 GETTABLEKS                       R7 R7 K17 ["InstanceChannel"]
       46 GETTABLEKS                       R7 R7 K17 ["InstanceChannel"]
       48 CALL                             R6 1 1
       49 GETIMPORT                        R7 K10 [require]
       51 GETTABLEKS                       R8 R0 K18 ["Bridges"]
       53 GETTABLEKS                       R8 R8 K19 ["createTextureGenBridge"]
       55 GETTABLEKS                       R8 R8 K20 ["TextureGenBridgeTypes"]
       57 CALL                             R7 1 1
       58 GETIMPORT                        R8 K10 [require]
       60 GETTABLEKS                       R9 R0 K14 ["Util"]
       62 GETTABLEKS                       R9 R9 K21 ["TextureGen"]
       64 GETTABLEKS                       R9 R9 K22 ["TextureGenChannel"]
       66 CALL                             R8 1 1
       67 GETIMPORT                        R9 K10 [require]
       69 GETTABLEKS                       R10 R0 K14 ["Util"]
       71 GETTABLEKS                       R10 R10 K21 ["TextureGen"]
       73 GETTABLEKS                       R10 R10 K23 ["TextureGenTypes"]
       75 CALL                             R9 1 1
       76 GETTABLEKS                       R10 R4 K24 ["createGenerationSessions"]
       78 CALL                             R10 0 1
       79 DUPCLOSURE                       R11 K25 [PROTO_0]
       80 CAPTURE                          VAL R5
       81 DUPCLOSURE                       R12 K26 [PROTO_2]
       82 CAPTURE                          VAL R6
       83 CAPTURE                          VAL R8
       84 CAPTURE                          VAL R4
       85 CAPTURE                          VAL R2
       86 DUPCLOSURE                       R13 K27 [PROTO_3]
       87 CAPTURE                          VAL R1
       88 CAPTURE                          VAL R4
       89 CAPTURE                          VAL R5
       90 CAPTURE                          VAL R10
       91 CAPTURE                          VAL R12
       92 DUPCLOSURE                       R14 K28 [PROTO_4]
       93 CAPTURE                          VAL R4
       94 CAPTURE                          VAL R10
       95 DUPCLOSURE                       R15 K29 [PROTO_5]
       96 CAPTURE                          VAL R4
       97 CAPTURE                          VAL R3
       98 CAPTURE                          VAL R5
       99 CAPTURE                          VAL R10
      100 DUPCLOSURE                       R16 K30 [PROTO_6]
      101 CAPTURE                          VAL R4
      102 CAPTURE                          VAL R11
      103 DUPCLOSURE                       R17 K31 [PROTO_7]
      104 CAPTURE                          VAL R5
      105 CAPTURE                          VAL R4
      106 DUPCLOSURE                       R18 K32 [PROTO_8]
      107 CAPTURE                          VAL R4
      108 CAPTURE                          VAL R11
      109 DUPTABLE                         R19 K39 [{"generateTextureAsync", "cancelGenerationAsync", "insertTexturedModelAsync", "getSelectedMeshRef", "isTextureableInstance", "captureSourceInstanceImageAsync"}]
      110 SETTABLEKS                       R13 R19 K33 ["generateTextureAsync"]
      112 SETTABLEKS                       R14 R19 K34 ["cancelGenerationAsync"]
      114 SETTABLEKS                       R15 R19 K35 ["insertTexturedModelAsync"]
      116 SETTABLEKS                       R16 R19 K36 ["getSelectedMeshRef"]
      118 SETTABLEKS                       R17 R19 K37 ["isTextureableInstance"]
      120 SETTABLEKS                       R18 R19 K38 ["captureSourceInstanceImageAsync"]
      122 DUPTABLE                         R20 K41 [{"bridge"}]
      123 SETTABLEKS                       R19 R20 K40 ["bridge"]
      125 RETURN                           R20 1
