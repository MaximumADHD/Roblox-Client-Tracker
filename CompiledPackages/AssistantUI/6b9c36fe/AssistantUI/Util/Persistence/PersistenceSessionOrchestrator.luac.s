...
PROTO_14:
       ...
       21 LOADK                            R2 K11 ["[Persistence] [Session] Session ended for placeId %*. Attempting to save conversations before destroying cached metadata."]
       22 GETUPVAL                         R4 1
       23 GETTABLEKS                       R4 R4 K12 ["placeId"]
       25 NAMECALL                         R2 R2 K13 ["format"]
       27 CALL                             R2 2 1
       28 MOVE                             R1 R2
       29 CALL                             R0 1 0
       30 GETUPVAL                         R0 3
       31 GETTABLEKS                       R0 R0 K14 ["requestSave"]
       33 DUPTABLE                         R1 K16 [{"metadata"}]
       34 DUPTABLE                         R2 K20 [{["gameId"], ["placeId"], ["isPlaceClosed"] = True}]
       35 GETUPVAL                         R3 1
       36 GETTABLEKS                       R3 R3 K17 ["gameId"]
       38 SETTABLEKS                       R3 R2 K17 ["gameId"]
       40 GETUPVAL                         R3 1
       41 GETTABLEKS                       R3 R3 K12 ["placeId"]
       43 SETTABLEKS                       R3 R2 K12 ["placeId"]
       45 SETTABLEKS                       R2 R1 K15 ["metadata"]
       47 CALL                             R0 1 0
       48 RETURN                           R0 0
...
PROTO_17:
       ...
       44 CALL                             R3 1 0
       45 JUMPIF                           R2 ; [+6]
       46 DUPTABLE                         R3 K15 [{["sessions"], ["nextPageToken"] = }]
       47 NEWTABLE                         R4 0 0
       49 SETTABLEKS                       R4 R3 K12 ["sessions"]
       51 RETURN                           R3 1
       52 GETUPVAL                         R3 3
       53 GETTABLEKS                       R3 R3 K16 ["io"]
       55 GETTABLEKS                       R3 R3 K17 ["getThreadsAsync"]
       57 DUPTABLE                         R4 K20 [{"placeId", "cursor", "limit"}]
       58 GETTABLEKS                       R5 R1 K6 ["placeId"]
       60 SETTABLEKS                       R5 R4 K6 ["placeId"]
       62 SETTABLEKS                       R0 R4 K18 ["cursor"]
       64 GETUPVAL                         R5 2
       65 GETTABLEKS                       R5 R5 K21 ["FIntAssistantPersistenceThreadLoadLimit"]
       67 SETTABLEKS                       R5 R4 K19 ["limit"]
       69 CALL                             R3 1 2
       70 JUMPIFNOT                        R3 ; [+1]
       71 JUMPIF                           R4 ; [+5]
       72 GETIMPORT                        R5 K3 [error]
       74 LOADK                            R6 K22 ["Failed to load ACP thread list"]
       75 LOADN                            R7 0
       76 CALL                             R5 2 0
       77 NEWTABLE                         R5 0 0
       79 GETTABLEKS                       R6 R4 K23 ["threads"]
       81 JUMPIFNOT                        R6 ; [+34]
       82 MOVE                             R7 R6
       83 LOADNIL                          R8
       84 LOADNIL                          R9
       85 FORGPREP                         R7
       86 DUPTABLE                         R14 K26 [{"sessionId", "title", "updatedAt"}]
       87 GETTABLEKS                       R15 R11 K27 ["threadId"]
       89 SETTABLEKS                       R15 R14 K1 ["sessionId"]
       91 GETTABLEKS                       R15 R11 K24 ["title"]
       93 SETTABLEKS                       R15 R14 K24 ["title"]
       95 GETIMPORT                        R15 K30 [os.date]
       97 LOADK                            R16 K31 ["!%Y-%m-%dT%H:%M:%SZ"]
       98 GETTABLEKS                       R19 R11 K25 ["updatedAt"]
      100 DIVK                             R18 R19 K32 [1000]
      101 FASTCALL1                        MATH_FLOOR R18 ; [+2]
      102 GETIMPORT                        R17 K35 [math.floor]
      104 CALL                             R17 1 1
      105 CALL                             R15 2 1
      106 SETTABLEKS                       R15 R14 K25 ["updatedAt"]
      108 FASTCALL2                        TABLE_INSERT R5 R14 ; [+4]
      110 MOVE                             R13 R5
      111 GETIMPORT                        R12 K38 [table.insert]
      113 CALL                             R12 2 0
      114 FORGLOOP                         R7 2 ; [-29]
      116 DUPTABLE                         R7 K39 [{"sessions", "nextPageToken"}]
      117 SETTABLEKS                       R5 R7 K12 ["sessions"]
      119 GETTABLEKS                       R8 R4 K18 ["cursor"]
      121 SETTABLEKS                       R8 R7 K13 ["nextPageToken"]
      123 RETURN                           R7 1
...
PROTO_20:
       ...
       54 LOADK                            R7 K15 ["[Persistence][ACP] session/load request: sessionId=%*, historyPageToken=%*, limit=%*"]
       55 MOVE                             R9 R0
       56 FASTCALL1                        TOSTRING R1 ; [+3]
       57 MOVE                             R11 R1
       58 GETIMPORT                        R10 K17 [tostring]
       60 CALL                             R10 1 1
       61 MOVE                             R11 R4
       62 NAMECALL                         R7 R7 K18 ["format"]
       64 CALL                             R7 4 1
       65 MOVE                             R6 R7
       66 CALL                             R5 1 0
       67 MOVE                             R5 R2
       68 MOVE                             R6 R0
       69 DUPTABLE                         R7 K21 [{"cursor", "limit"}]
       70 SETTABLEKS                       R1 R7 K19 ["cursor"]
       72 SETTABLEKS                       R4 R7 K20 ["limit"]
       74 CALL                             R5 2 2
       75 JUMPIFNOT                        R5 ; [+1]
       76 JUMPIF                           R6 ; [+28]
       77 GETUPVAL                         R7 3
       78 GETTABLEKS                       R7 R7 K12 ["FFlagDebugLogAssistantUI"]
       80 JUMPIFNOT                        R7 ; [+14]
       81 GETIMPORT                        R7 K23 [warn]
       83 LOADK                            R9 K24 ["[Persistence][ACP] session/load failed: sessionId=%*, historyPageToken=%*"]
       84 MOVE                             R11 R0
       85 FASTCALL1                        TOSTRING R1 ; [+3]
       86 MOVE                             R13 R1
       87 GETIMPORT                        R12 K17 [tostring]
       89 CALL                             R12 1 1
       90 NAMECALL                         R9 R9 K18 ["format"]
       92 CALL                             R9 3 1
       93 MOVE                             R8 R9
       94 CALL                             R7 1 0
       95 GETIMPORT                        R7 K3 [error]
       97 LOADK                            R9 K25 ["Failed to load ACP session %*"]
       98 MOVE                             R11 R0
       99 NAMECALL                         R9 R9 K18 ["format"]
      101 CALL                             R9 2 1
      102 MOVE                             R8 R9
      103 LOADN                            R9 0
      104 CALL                             R7 2 0
      105 GETTABLEKS                       R7 R6 K26 ["messages"]
      107 JUMPIF                           R7 ; [+2]
      108 NEWTABLE                         R7 0 0
      110 GETUPVAL                         R8 3
      111 GETTABLEKS                       R8 R8 K12 ["FFlagDebugLogAssistantUI"]
      113 JUMPIFNOT                        R8 ; [+16]
      114 GETIMPORT                        R8 K14 [print]
      116 LOADK                            R10 K27 ["[Persistence][ACP] session/load response: sessionId=%*, messageCount=%*, nextHistoryPageToken=%*"]
      117 MOVE                             R12 R0
      118 LENGTH                           R13 R7
      119 GETTABLEKS                       R15 R6 K19 ["cursor"]
      121 FASTCALL1                        TOSTRING R15 ; [+2]
      122 GETIMPORT                        R14 K17 [tostring]
      124 CALL                             R14 1 1
      125 NAMECALL                         R10 R10 K18 ["format"]
      127 CALL                             R10 4 1
      128 MOVE                             R9 R10
      129 CALL                             R8 1 0
      130 DUPCLOSURE                       R8 K28 [PROTO_18]
      131 GETIMPORT                        R9 K31 [table.sort]
      133 MOVE                             R10 R7
      134 DUPCLOSURE                       R11 K32 [PROTO_19]
      135 CAPTURE                          UPVAL U3
      136 CALL                             R9 2 0
      137 DUPTABLE                         R9 K36 [{["messages"], ["modes"] = , ["nextHistoryPageToken"]}]
      138 SETTABLEKS                       R7 R9 K26 ["messages"]
      140 GETTABLEKS                       R10 R6 K19 ["cursor"]
      142 SETTABLEKS                       R10 R9 K35 ["nextHistoryPageToken"]
      144 RETURN                           R9 1
...
PROTO_22:
       ...
       33 LOADK                            R5 K7 ["[Persistence] [Session] Session %* already has cached metadata for placeId %*"]
       34 GETTABLEKS                       R7 R1 K3 ["sessionId"]
       36 GETTABLEKS                       R8 R1 K1 ["placeId"]
       38 NAMECALL                         R5 R5 K8 ["format"]
       40 CALL                             R5 3 1
       41 MOVE                             R4 R5
       42 CALL                             R3 1 0
       43 RETURN                           R0 0
       44 GETUPVAL                         R4 0
       45 GETTABLEKS                       R5 R1 K3 ["sessionId"]
       47 GETTABLE                         R3 R4 R5
       48 JUMPIFNOT                        R3 ; [+12]
       49 GETUPVAL                         R4 2
       50 GETTABLEKS                       R4 R4 K9 ["FFlagAssistantACPServiceClearSessions"]
       52 JUMPIFNOT                        R4 ; [+3]
       53 LOADB                            R4 1
       54 SETTABLEKS                       R4 R3 K10 ["replaced"]
       56 GETTABLEKS                       R4 R3 K11 ["Destroying"]
       58 NAMECALL                         R4 R4 K12 ["Fire"]
       60 CALL                             R4 1 0
       61 DUPTABLE                         R4 K15 [{[1], ["placeId"], ["loadState"], ["replaced"] = False, ["Destroying"]}]
       62 GETTABLEKS                       R5 R1 K0 ["gameId"]
       64 SETTABLEKS                       R5 R4 K0 ["gameId"]
       66 GETTABLEKS                       R5 R1 K1 ["placeId"]
       68 SETTABLEKS                       R5 R4 K1 ["placeId"]
       70 GETUPVAL                         R5 3
       71 GETTABLEKS                       R5 R5 K16 ["Idle"]
       73 SETTABLEKS                       R5 R4 K13 ["loadState"]
       75 GETUPVAL                         R5 4
       76 GETTABLEKS                       R5 R5 K17 ["new"]
       78 CALL                             R5 0 1
       79 SETTABLEKS                       R5 R4 K11 ["Destroying"]
       81 GETUPVAL                         R5 0
       82 GETTABLEKS                       R6 R1 K3 ["sessionId"]
       84 SETTABLE                         R4 R5 R6
       85 GETUPVAL                         R5 5
       86 GETTABLEKS                       R7 R1 K3 ["sessionId"]
       88 NAMECALL                         R5 R5 K12 ["Fire"]
       90 CALL                             R5 2 0
       91 JUMPIFNOT                        R2 ; [+5]
       92 GETUPVAL                         R5 1
       93 GETTABLEKS                       R6 R1 K1 ["placeId"]
       95 LOADB                            R7 1
       96 SETTABLE                         R7 R5 R6
       97 JUMPIF                           R2 ; [+4]
       98 GETUPVAL                         R5 2
       99 GETTABLEKS                       R5 R5 K9 ["FFlagAssistantACPServiceClearSessions"]
      101 JUMPIFNOT                        R5 ; [+4]
      102 GETUPVAL                         R5 6
      103 GETUPVAL                         R6 7
      104 MOVE                             R7 R4
