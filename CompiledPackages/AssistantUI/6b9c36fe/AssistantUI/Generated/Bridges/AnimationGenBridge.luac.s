...
PROTO_25:
        0 DUPTABLE                         R2 K7 [{"generateAndSaveAnimationAsync", "getSelectedRigRef", "setIsPlaying", "setCurrentTime", "setPlaybackSpeed", "openInAnimationClipEditor", "toTarget"}]
        1 NEWCLOSURE                       R3 P0
        2 CAPTURE                          UPVAL U0
        3 CAPTURE                          VAL R0
        4 CAPTURE                          VAL R1
...
MAIN:
       ...
       15 CALL                             R1 1 1
       16 DUPTABLE                         R2 K17 [{["animatorRemoved"] = "animatorRemoved", ["restartPlayback"] = "restartPlayback", ["generateAndSaveAnimationAsync"] = "generateAndSaveAnimationAsync", ["getSelectedRigRef"] = "getSelectedRigRef", ["setIsPlaying"] = "setIsPlaying", ["setCurrentTime"] = "setCurrentTime", ["setPlaybackSpeed"] = "setPlaybackSpeed", ["openInAnimationClipEditor"] = "openInAnimationClipEditor"}]
       17 DUPCLOSURE                       R3 K18 [PROTO_0]
       18 CAPTURE                          VAL R2
       19 DUPCLOSURE                       R4 K19 [PROTO_1]
       20 DUPCLOSURE                       R5 K20 [PROTO_9]
       21 CAPTURE                          VAL R2
       22 DUPCLOSURE                       R6 K21 [PROTO_10]
       23 DUPCLOSURE                       R7 K22 [PROTO_26]
       24 CAPTURE                          VAL R2
       25 DUPCLOSURE                       R8 K23 [PROTO_31]
       26 CAPTURE                          VAL R5
       27 CAPTURE                          VAL R7
       28 DUPTABLE                         R9 K25 [{"prepareBridges"}]
       29 SETTABLEKS                       R8 R9 K24 ["prepareBridges"]
       31 RETURN                           R9 1
