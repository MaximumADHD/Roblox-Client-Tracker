...
PROTO_5:
       ...
       78 CALL                             R5 3 1
       79 LOADK                            R7 K37 ["skipReview"]
       80 DUPTABLE                         R8 K40 [{["type"] = "boolean", ["description"] = "Client-managed flag skipping the review/confirm screen and submitting as soon as every question is answered. Set by slash-command flows; leave unset when authoring a question directly."}]
       81 NAMECALL                         R5 R5 K41 ["addOptionalArgument"]
       83 CALL                             R5 3 1
       84 DUPTABLE                         R7 K50 [{["title"] = "Question Answer", ["readOnlyHint"] = True, ["destructiveHint"] = False, ["idempotentHint"] = False, ["openWorldHint"] = False}]
       85 NAMECALL                         R5 R5 K51 ["setAnnotations"]
       87 CALL                             R5 2 1
       88 MOVE                             R7 R3
       89 NAMECALL                         R5 R5 K52 ["setHandler"]
       91 CALL                             R5 2 1
       92 NAMECALL                         R5 R5 K53 ["build"]
       94 CALL                             R5 1 1
       95 DUPTABLE                         R6 K55 [{"definition"}]
       96 SETTABLEKS                       R5 R6 K54 ["definition"]
       98 RETURN                           R6 1
