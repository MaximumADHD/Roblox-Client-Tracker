...
PROTO_1:
       ...
       35 LOADK                            R7 K12 [""]
       36 GETUPVAL                         R9 5
       37 GETTABLEKS                       R9 R9 K13 ["FFlagAssistantReplaceJobRunWithAsyncArg"]
       39 JUMPIFNOT                        R9 ; [+9]
       40 LOADK                            R9 K14 ["Pass the jobId returned when a tool was called with its '%*' argument set to true."]
       41 GETUPVAL                         R11 8
       42 GETTABLEKS                       R11 R11 K15 ["ASYNC_ARG"]
       44 NAMECALL                         R9 R9 K11 ["format"]
       46 CALL                             R9 2 1
       47 MOVE                             R8 R9
       48 JUMP                             ; [+8]
       49 LOADK                            R9 K16 ["Pass the jobId returned by %*."]
       50 GETUPVAL                         R11 7
       51 GETTABLEKS                       R11 R11 K17 ["JobRun"]
       53 NAMECALL                         R9 R9 K11 ["format"]
       55 CALL                             R9 2 1
       56 MOVE                             R8 R9
       57 LOADK                            R9 K12 [""]
       58 LOADK                            R10 K18 ["Only call this tool when:"]
       59 LOADK                            R11 K19 ["- The user EXPLICITLY asks to wait for a backgrounded job to finish (e.g. \"wait for it to complete\", \"let me know when it's done\")"]
       60 LOADK                            R12 K20 ["- You need to confirm a job's result before performing a follow-up action that depends on it"]
       61 SETLIST                          R5 R6 7 [1]
       63 LOADK                            R6 K21 ["\n"]
       64 CALL                             R4 2 -1
       65 NAMECALL                         R2 R2 K22 ["setDescription"]
       67 CALL                             R2 -1 1
       68 LOADK                            R4 K23 ["jobId"]
       69 DUPTABLE                         R5 K27 [{["type"] = "string", ["description"]}]
       70 GETUPVAL                         R7 5
       71 GETTABLEKS                       R7 R7 K13 ["FFlagAssistantReplaceJobRunWithAsyncArg"]
       73 JUMPIFNOT                        R7 ; [+9]
       74 LOADK                            R7 K28 ["The jobId returned when a tool was called with its '%*' argument set to true."]
       75 GETUPVAL                         R9 8
       76 GETTABLEKS                       R9 R9 K15 ["ASYNC_ARG"]
       78 NAMECALL                         R7 R7 K11 ["format"]
       80 CALL                             R7 2 1
       81 MOVE                             R6 R7
       82 JUMP                             ; [+8]
       83 LOADK                            R7 K29 ["The jobId returned by the %* tool."]
       84 GETUPVAL                         R9 7
       85 GETTABLEKS                       R9 R9 K17 ["JobRun"]
       87 NAMECALL                         R7 R7 K11 ["format"]
       89 CALL                             R7 2 1
       90 MOVE                             R6 R7
       91 SETTABLEKS                       R6 R5 K26 ["description"]
       93 NAMECALL                         R2 R2 K30 ["addArgument"]
       95 CALL                             R2 3 1
       96 LOADK                            R4 K31 ["timeout"]
       97 DUPTABLE                         R5 K33 [{["type"] = "number", ["description"]}]
       98 LOADK                            R7 K34 ["Maximum time in seconds to wait for the job to finish. Defaults to %* seconds."]
       99 GETUPVAL                         R9 2
      100 NAMECALL                         R7 R7 K11 ["format"]
      102 CALL                             R7 2 1
      103 MOVE                             R6 R7
      104 SETTABLEKS                       R6 R5 K26 ["description"]
      106 NAMECALL                         R2 R2 K35 ["addOptionalArgument"]
      108 CALL                             R2 3 1
      109 MOVE                             R4 R1
      110 NAMECALL                         R2 R2 K36 ["setHandler"]
      112 CALL                             R2 2 1
      113 DUPTABLE                         R4 K45 [{["title"] = "Wait Job Finished", ["readOnlyHint"] = True, ["destructiveHint"] = False, ["idempotentHint"] = False, ["openWorldHint"] = False}]
      114 NAMECALL                         R2 R2 K46 ["setAnnotations"]
      116 CALL                             R2 2 1
      117 NAMECALL                         R2 R2 K47 ["build"]
      119 CALL                             R2 1 1
      120 DUPTABLE                         R3 K49 [{"definition"}]
      121 SETTABLEKS                       R2 R3 K48 ["definition"]
      123 RETURN                           R3 1
