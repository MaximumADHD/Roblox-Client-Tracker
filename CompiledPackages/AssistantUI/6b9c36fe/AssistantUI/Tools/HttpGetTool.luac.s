...
PROTO_7:
       ...
       72 CALL                             R5 1 1
       73 DUPTABLE                         R6 K45 [{"definition"}]
       74 SETTABLEKS                       R5 R6 K44 ["definition"]
       76 RETURN                           R6 1
...
MAIN:
       ...
       25 CALL                             R3 1 1
       26 GETTABLEKS                       R4 R2 K11 ["Util"]
       28 GETTABLEKS                       R4 R4 K12 ["ToolBuilder"]
       30 GETTABLEKS                       R5 R2 K11 ["Util"]
       32 GETTABLEKS                       R5 R5 K13 ["ToolResult"]
       34 GETTABLEKS                       R6 R3 K14 ["ToolNames"]
       36 GETTABLEKS                       R7 R1 K15 ["ROBLOX_ENGINE_DOCS_BASE_URL"]
       38 GETTABLEKS                       R8 R1 K16 ["ROBLOX_CREATOR_DOCS_BASE_URL"]
       40 DUPCLOSURE                       R9 K17 [PROTO_0]
       41 NEWTABLE                         R10 0 5
       43 DUPTABLE                         R11 K22 [{["base"], ["description"] = "Roblox Engine API docs — URLs must end with .md or be llms.txt", ["validate"]}]
       44 SETTABLEKS                       R7 R11 K18 ["base"]
       46 SETTABLEKS                       R9 R11 K21 ["validate"]
       48 DUPTABLE                         R12 K25 [{["base"] = "https://create.roblox.com/docs/cloud", ["description"] = "Roblox Cloud API docs — URLs must end with .md or be llms.txt", ["validate"]}]
       49 SETTABLEKS                       R9 R12 K21 ["validate"]
       51 DUPTABLE                         R13 K28 [{["base"] = "https://create.roblox.com/docs/performance-optimization", ["description"] = "Roblox Performance Optimization docs — URLs must end with .md or be llms.txt", ["validate"]}]
       52 SETTABLEKS                       R9 R13 K21 ["validate"]
       54 DUPTABLE                         R14 K31 [{["base"] = "https://github.com/Roblox/libmp", ["description"] = "Roblox LibMP repository — URLs must end with .md or be llms.txt", ["validate"]}]
       55 SETTABLEKS                       R9 R14 K21 ["validate"]
       57 DUPTABLE                         R15 K33 [{["base"], ["description"] = "Roblox Creator docs (guides, tutorials, etc.) — URLs must end with .md or be llms.txt", ["validate"]}]
       58 SETTABLEKS                       R8 R15 K18 ["base"]
       60 SETTABLEKS                       R9 R15 K21 ["validate"]
       62 SETLIST                          R10 R11 5 [1]
       64 DUPCLOSURE                       R11 K34 [PROTO_1]
       65 CAPTURE                          VAL R10
       66 DUPCLOSURE                       R12 K35 [PROTO_2]
       67 CAPTURE                          VAL R10
       68 DUPCLOSURE                       R13 K36 [PROTO_3]
       69 DUPCLOSURE                       R14 K37 [PROTO_4]
       70 CAPTURE                          VAL R13
       71 DUPCLOSURE                       R15 K38 [PROTO_7]
       72 CAPTURE                          VAL R11
       73 CAPTURE                          VAL R12
       74 CAPTURE                          VAL R5
       75 CAPTURE                          VAL R14
