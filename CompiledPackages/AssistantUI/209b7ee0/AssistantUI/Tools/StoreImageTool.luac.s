PROTO_0:
       ...
       23 GETUPVAL                         R3 1
       24 GETTABLEKS                       R2 R3 K8 ["loadImageFromPathAsync"]
       ...
       52 RETURN                           R3 -1
       53 GETUPVAL                         R4 2
       54 GETTABLEKS                       R3 R4 K13 ["storeImage"]
       56 MOVE                             R4 R2
       57 CALL                             R3 1 1
       58 GETUPVAL                         R4 0
       59 CALL                             R4 0 1
...
PROTO_1:
        ...
        3 CAPTURE                          UPVAL U2
        4 GETUPVAL                         R3 3
        5 GETTABLEKS                       R2 R3 K1 ["define"]
        7 CALL                             R2 0 1
        8 GETUPVAL                         R5 4
        9 GETTABLEKS                       R4 R5 K2 ["StoreImage"]
       11 NAMECALL                         R2 R2 K3 ["setName"]
       13 CALL                             R2 2 1
       14 GETUPVAL                         R5 4
       15 GETTABLEKS                       R4 R5 K4 ["replaceTokens"]
       ...
       32 CALL                             R2 3 1
       33 MOVE                             R4 R1
       34 NAMECALL                         R2 R2 K14 ["setHandler"]
       36 CALL                             R2 2 1
       37 NAMECALL                         R2 R2 K15 ["build"]
       39 CALL                             R2 1 1
       40 DUPTABLE                         R3 K17 [{"definition"}]
       41 SETTABLEKS                       R2 R3 K16 ["definition"]
       43 RETURN                           R3 1
...
MAIN:
       ...
       11 GETTABLEKS                       R2 R3 K7 ["ImageAttachmentUtils"]
       13 CALL                             R1 1 1
       14 GETIMPORT                        R2 K5 [require]
       16 GETTABLEKS                       R4 R0 K6 ["Util"]
       18 GETTABLEKS                       R3 R4 K8 ["ImageContentStore"]
       20 CALL                             R2 1 1
       ...
       30 GETTABLEKS                       R6 R0 K11 ["Tools"]
       32 GETTABLEKS                       R5 R6 K12 ["ToolTypes"]
       34 CALL                             R4 1 1
       35 GETTABLEKS                       R6 R3 K6 ["Util"]
       37 GETTABLEKS                       R5 R6 K13 ["ToolBuilder"]
       39 GETTABLEKS                       R7 R3 K6 ["Util"]
       41 GETTABLEKS                       R6 R7 K14 ["ToolResult"]
