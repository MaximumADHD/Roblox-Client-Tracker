...
PROTO_10:
       ...
       31 CALL                             R5 3 1
       32 GETUPVAL                         R10 0
       33 GETTABLEKS                       R9 R10 K8 ["setPreviewStateAsync"]
       35 GETUPVAL                         R12 0
...
PROTO_30:
        ...
        5 CAPTURE                          VAL R1
        6 GETUPVAL                         R9 0
        7 GETTABLEKS                       R8 R9 K1 ["generateAssetsAsync"]
        9 GETUPVAL                         R11 0
       10 GETTABLE                         R10 R11 R8
       11 LOADK                            R12 K2 ["Invalid network key: "]
       12 MOVE                             R13 R8
       ...
       31 CALL                             R5 3 1
       32 GETUPVAL                         R10 0
       33 GETTABLEKS                       R9 R10 K8 ["cancelGenerationAsync"]
       35 GETUPVAL                         R12 0
       36 GETTABLE                         R11 R12 R9
       37 LOADK                            R13 K2 ["Invalid network key: "]
       38 MOVE                             R14 R9
       ...
       57 CALL                             R6 3 1
       58 GETUPVAL                         R11 0
       59 GETTABLEKS                       R10 R11 K9 ["publishAssetsAsync"]
       61 GETUPVAL                         R13 0
       62 GETTABLE                         R12 R13 R10
       63 LOADK                            R14 K2 ["Invalid network key: "]
       64 MOVE                             R15 R10
       ...
       83 CALL                             R7 3 1
       84 GETUPVAL                         R12 0
       85 GETTABLEKS                       R11 R12 K10 ["removeSelectedBoundsAsync"]
       87 GETUPVAL                         R14 0
      ...
      109 CALL                             R8 3 1
      110 GETUPVAL                         R13 0
      111 GETTABLEKS                       R12 R13 K11 ["insertAssetsAsync"]
      113 GETUPVAL                         R15 0
      ...
      135 CALL                             R9 3 1
      136 GETUPVAL                         R14 0
      137 GETTABLEKS                       R13 R14 K12 ["selectLinkedAssets"]
      139 GETUPVAL                         R16 0
...
MAIN:
       ...
       20 GETTABLEKS                       R3 R4 K9 ["MeshGenBridgeTypes"]
       22 CALL                             R2 1 1
