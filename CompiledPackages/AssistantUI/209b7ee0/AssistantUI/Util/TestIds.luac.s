...
MAIN:
      ...
      399 DUPTABLE                         R1 K238 [{"Section", "Toggle", "CommandLabel", "CommandCopy"}]
      400 LOADK                            R2 K239 ["Assistant-QuickConnect-Section"]
      401 SETTABLEKS                       R2 R1 K235 ["Section"]
      403 DUPCLOSURE                       R2 K240 [PROTO_1]
      404 SETTABLEKS                       R2 R1 K216 ["Toggle"]
      406 DUPCLOSURE                       R2 K241 [PROTO_2]
      407 SETTABLEKS                       R2 R1 K236 ["CommandLabel"]
      409 DUPCLOSURE                       R2 K242 [PROTO_3]
      410 SETTABLEKS                       R2 R1 K237 ["CommandCopy"]
      412 SETTABLEKS                       R1 R0 K243 ["QuickConnect"]
      414 DUPCLOSURE                       R1 K244 [PROTO_4]
      415 SETTABLEKS                       R1 R0 K245 ["ProviderCheckbox"]
      417 DUPTABLE                         R1 K250 [{"Display", "EditButton", "Input", "SaveButton", "CancelButton"}]
      418 DUPCLOSURE                       R2 K251 [PROTO_5]
      419 SETTABLEKS                       R2 R1 K246 ["Display"]
      421 DUPCLOSURE                       R2 K252 [PROTO_6]
      422 SETTABLEKS                       R2 R1 K247 ["EditButton"]
      424 DUPCLOSURE                       R2 K253 [PROTO_7]
      425 SETTABLEKS                       R2 R1 K23 ["Input"]
      427 DUPCLOSURE                       R2 K254 [PROTO_8]
      428 SETTABLEKS                       R2 R1 K248 ["SaveButton"]
      430 DUPCLOSURE                       R2 K255 [PROTO_9]
      431 SETTABLEKS                       R2 R1 K249 ["CancelButton"]
      433 SETTABLEKS                       R1 R0 K256 ["APIKey"]
      435 DUPTABLE                         R1 K258 [{"Remove"}]
      436 LOADK                            R2 K3 [{"ToggleThreadsMenu", "SettingsButton", "SettingsContent"}]
      437 SETTABLEKS                       R2 R1 K257 ["Remove"]
      439 SETTABLEKS                       R1 R0 K260 ["AttachedImagePreview"]
      441 GETIMPORT                        R1 K262 [pcall]
      443 DUPCLOSURE                       R2 K263 [PROTO_10]
      444 CALL                             R1 1 2
      445 JUMPIFNOT                        R1 ; [+8]
      446 NEWTABLE                         R3 0 0
      448 DUPCLOSURE                       R4 K264 [PROTO_11]
      449 CAPTURE                          VAL R4
      450 CAPTURE                          VAL R3
      451 MOVE                             R5 R4
      452 MOVE                             R6 R0
