...
PROTO_30:
      ...
      513 GETUPVAL                         R4 3
      514 LOADK                            R5 K183 ["getStudioPlayState"]
      515 CALL                             R4 1 1
      516 SETTABLEKS                       R4 R3 K183 ["getStudioPlayState"]
      518 GETUPVAL                         R4 3
      519 LOADK                            R5 K184 ["fetchSystemPromptAsync"]
      520 CALL                             R4 1 1
      521 SETTABLEKS                       R4 R3 K184 ["fetchSystemPromptAsync"]
      523 DUPTABLE                         R4 K187 [{"startAsync", "getStatusAsync"}]
      524 GETUPVAL                         R5 3
      525 LOADK                            R6 K188 ["imageGeneration.startAsync"]
      526 CALL                             R5 1 1
      527 SETTABLEKS                       R5 R4 K185 ["startAsync"]
      529 GETUPVAL                         R5 3
      530 LOADK                            R6 K189 ["imageGeneration.getStatusAsync"]
      531 CALL                             R5 1 1
      532 SETTABLEKS                       R5 R4 K186 ["getStatusAsync"]
      534 SETTABLEKS                       R4 R3 K190 ["imageGeneration"]
      536 DUPCLOSURE                       R4 K191 [PROTO_28]
      537 SETTABLEKS                       R4 R3 K192 ["hasInternalPermission"]
      539 DUPCLOSURE                       R4 K193 [PROTO_29]
      540 CAPTURE                          UPVAL U12
      541 SETTABLEKS                       R4 R3 K194 ["getMockPrimGenBackendData"]
      543 GETUPVAL                         R4 3
      544 LOADK                            R5 K195 ["startMultiPlayerTest"]
      545 CALL                             R4 1 1
      546 SETTABLEKS                       R4 R3 K195 ["startMultiPlayerTest"]
      548 GETUPVAL                         R4 3
      549 LOADK                            R5 K196 ["stopMultiPlayerTest"]
      550 CALL                             R4 1 1
      551 SETTABLEKS                       R4 R3 K196 ["stopMultiPlayerTest"]
      553 GETUPVAL                         R4 3
      554 LOADK                            R5 K197 ["isInMultiPlayerTest"]
      555 CALL                             R4 1 1
      556 SETTABLEKS                       R4 R3 K197 ["isInMultiPlayerTest"]
      558 GETUPVAL                         R4 3
      559 LOADK                            R5 K198 ["getStopMultiPlayerTestResults"]
      560 CALL                             R4 1 1
      561 SETTABLEKS                       R4 R3 K199 ["subscribeStopMultiPlayerTestStateChanged"]
      563 GETUPVAL                         R4 3
      564 LOADK                            R5 K200 ["createMultiPlayersServer"]
      565 CALL                             R4 1 1
      566 SETTABLEKS                       R4 R3 K200 ["createMultiPlayersServer"]
      568 GETUPVAL                         R4 3
      569 LOADK                            R5 K201 ["createMultiPlayersClient"]
      570 CALL                             R4 1 1
      571 SETTABLEKS                       R4 R3 K201 ["createMultiPlayersClient"]
      573 GETUPVAL                         R4 3
      574 LOADK                            R5 K202 ["getExperimentFeatureEnabled"]
      575 CALL                             R4 1 1
      576 SETTABLEKS                       R4 R3 K202 ["getExperimentFeatureEnabled"]
      578 GETUPVAL                         R4 3
      579 LOADK                            R5 K203 ["getOnExperimentChangedSignal"]
      580 CALL                             R4 1 1
      581 SETTABLEKS                       R4 R3 K204 ["onceExperimentFeatureEnabled"]
      583 GETUPVAL                         R4 3
      584 LOADK                            R5 K205 ["getStudioState"]
      585 CALL                             R4 1 1
      586 SETTABLEKS                       R4 R3 K205 ["getStudioState"]
      588 MOVE                             R2 R3
      589 CLOSEUPVALS                      R2
      590 RETURN                           R2 1
...
PROTO_31:
        ...
        3 GETTABLEKS                       R1 R1 K1 ["logErrorEvent"]
        5 MOVE                             R2 R0
        6 CALL                             R1 1 0
        7 RETURN                           R0 0
