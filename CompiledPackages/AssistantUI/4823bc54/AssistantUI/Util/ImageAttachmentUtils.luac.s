...
PROTO_11:
       ...
       70 GETUPVAL                         R8 2
       71 GETTABLEKS                       R8 R8 K21 ["FFlagPrimGenDetectMineTypeFromContent"]
       73 JUMPIFNOT                        R8 ; [+20]
       74 GETUPVAL                         R8 3
       75 MOVE                             R9 R4
       76 CALL                             R8 1 1
       77 JUMPIFNOT                        R8 ; [+16]
       78 JUMPIFEQ                         R8 R7 ; [+15]
       80 GETIMPORT                        R9 K9 [error]
       82 LOADK                            R13 K22 ["File extension \".%*\" indicates %*, but the file contents are actually %*. "]
       83 MOVE                             R15 R6
       84 MOVE                             R16 R7
       85 MOVE                             R17 R8
       86 NAMECALL                         R13 R13 K20 ["format"]
       88 CALL                             R13 4 1
       89 MOVE                             R11 R13
       90 LOADK                            R12 K23 ["Please rename the file to match its real format or convert it to a supported one (jpg, jpeg, png)."]
       91 CONCAT                           R10 R11 R12
       92 LOADN                            R11 0
       93 CALL                             R9 2 0
       94 GETIMPORT                        R8 K25 [pcall]
       96 NEWCLOSURE                       R9 P0
       97 CAPTURE                          VAL R1
       98 CAPTURE                          VAL R4
       99 CALL                             R8 1 2
      100 JUMPIF                           R8 ; [+10]
      101 GETIMPORT                        R10 K9 [error]
      103 LOADK                            R12 K26 ["Failed to encode image to base64, reason: "]
      104 FASTCALL1                        TOSTRING R9 ; [+3]
      105 MOVE                             R14 R9
      106 GETIMPORT                        R13 K28 [tostring]
      108 CALL                             R13 1 1
      109 CONCAT                           R11 R12 R13
      110 CALL                             R10 1 0
      111 JUMPIF                           R9 ; [+4]
      112 GETIMPORT                        R10 K9 [error]
      114 LOADK                            R11 K29 ["Failed to encode image to base64."]
      115 CALL                             R10 1 0
      116 DUPTABLE                         R10 K34 [{["type"] = "image", ["data"], ["mimeType"]}]
      117 SETTABLEKS                       R9 R10 K32 ["data"]
      119 SETTABLEKS                       R7 R10 K33 ["mimeType"]
      121 RETURN                           R10 1
...
MAIN:
       ...
       32 NEWTABLE                         R6 0 3
       34 LOADK                            R7 K14 ["jpg"]
       35 LOADK                            R8 K15 ["jpeg"]
       36 LOADK                            R9 K16 ["png"]
       37 SETLIST                          R6 R7 3 [1]
       39 DUPTABLE                         R7 K19 [{["jpg"] = "image/jpeg", ["jpeg"] = "image/jpeg", ["png"] = "image/png"}]
       40 DUPCLOSURE                       R8 K20 [PROTO_0]
       41 DUPCLOSURE                       R9 K21 [PROTO_1]
       42 DUPCLOSURE                       R10 K22 [PROTO_2]
       43 DUPCLOSURE                       R11 K23 [PROTO_3]
       44 DUPCLOSURE                       R12 K24 [PROTO_4]
       45 DUPCLOSURE                       R13 K25 [PROTO_5]
       46 DUPCLOSURE                       R14 K26 [PROTO_6]
       47 DUPCLOSURE                       R15 K27 [PROTO_8]
       48 CAPTURE                          VAL R1
       49 CAPTURE                          VAL R8
       50 CAPTURE                          VAL R12
       51 CAPTURE                          VAL R14
       52 SETTABLEKS                       R15 R5 K28 ["getPngOrJpegDimensionsFromBase64"]
       54 DUPCLOSURE                       R15 K29 [PROTO_9]
       55 DUPCLOSURE                       R16 K30 [PROTO_11]
       56 CAPTURE                          VAL R2
       57 CAPTURE                          VAL R7
       58 CAPTURE                          VAL R3
       59 CAPTURE                          VAL R8
       60 SETTABLEKS                       R16 R5 K31 ["loadImageFromPathAsync"]
       62 DUPCLOSURE                       R16 K32 [PROTO_12]
       63 CAPTURE                          VAL R2
       64 CAPTURE                          VAL R6
       65 CAPTURE                          VAL R5
       66 SETTABLEKS                       R16 R5 K33 ["promptAndLoadImageAsync"]
       68 DUPCLOSURE                       R16 K34 [PROTO_13]
       69 SETTABLEKS                       R16 R5 K35 ["addImage"]
       71 DUPCLOSURE                       R16 K36 [PROTO_14]
       72 SETTABLEKS                       R16 R5 K37 ["removeImage"]
       74 RETURN                           R5 1
