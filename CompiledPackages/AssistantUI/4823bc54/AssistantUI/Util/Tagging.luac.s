...
PROTO_4:
       ...
       15 SETUPVAL                         R0 1
       16 GETUPVAL                         R0 2
       17 GETTABLEKS                       R0 R0 K1 ["FFlagAssistantSplitToolsAndWidgets"]
       19 JUMPIFNOT                        R0 ; [+8]
       20 GETUPVAL                         R0 3
       21 JUMPIFNOT                        R0 ; [+6]
       22 GETUPVAL                         R0 3
       23 NAMECALL                         R0 R0 K0 ["Disconnect"]
       25 CALL                             R0 1 0
       26 LOADNIL                          R0
       27 SETUPVAL                         R0 3
       28 GETUPVAL                         R0 4
...
PROTO_5:
       ...
       67 CAPTURE                          UPVAL U4
       68 CAPTURE                          REF R9
       69 GETTABLEKS                       R10 R3 K14 ["Destroying"]
       71 MOVE                             R12 R9
       72 NAMECALL                         R10 R10 K15 ["Once"]
       74 CALL                             R10 2 1
       75 MOVE                             R8 R10
       76 GETUPVAL                         R10 4
       77 LOADB                            R11 1
...
MAIN:
       ...
       30 GETTABLEKS                       R6 R1 K13 ["Flags"]
       32 CALL                             R5 1 1
       33 GETIMPORT                        R6 K10 [require]
       35 GETTABLEKS                       R7 R1 K14 ["Parent"]
       37 GETTABLEKS                       R7 R7 K15 ["Signal"]
       39 CALL                             R6 1 1
       40 NEWTABLE                         R7 0 0
       42 DUPCLOSURE                       R8 K16 [PROTO_0]
       43 CAPTURE                          VAL R3
       44 SETTABLEKS                       R8 R0 K17 ["getUniqueTag"]
       46 DUPCLOSURE                       R8 K18 [PROTO_1]
       47 SETTABLEKS                       R8 R0 K19 ["_batchTagUpdates"]
       49 DUPCLOSURE                       R8 K20 [PROTO_5]
       50 CAPTURE                          VAL R4
       51 CAPTURE                          VAL R0
       52 CAPTURE                          VAL R2
       53 CAPTURE                          VAL R5
       54 CAPTURE                          VAL R7
       55 SETTABLEKS                       R8 R0 K21 ["observeTagChanges"]
       57 DUPCLOSURE                       R8 K22 [PROTO_6]
       58 CAPTURE                          VAL R7
       59 SETTABLEKS                       R8 R0 K23 ["_DEBUG_clearTagObservers"]
       61 RETURN                           R0 1
