...
PROTO_17:
       ...
       14 MOVE                             R1 R2
       15 GETUPVAL                         R2 2
       16 GETTABLEKS                       R2 R2 K5 ["io"]
       18 GETTABLEKS                       R2 R2 K6 ["getThreadsAsync"]
       20 DUPTABLE                         R3 K10 [{"placeId", "cursor", "limit"}]
       21 GETTABLEKS                       R4 R1 K7 ["placeId"]
       23 SETTABLEKS                       R4 R3 K7 ["placeId"]
       25 SETTABLEKS                       R0 R3 K8 ["cursor"]
       27 GETUPVAL                         R4 3
       28 GETTABLEKS                       R4 R4 K11 ["FIntAssistantPersistenceThreadLoadLimit"]
       30 SETTABLEKS                       R4 R3 K9 ["limit"]
       32 CALL                             R2 1 2
       33 JUMPIFNOT                        R2 ; [+1]
       34 JUMPIF                           R3 ; [+5]
       35 GETIMPORT                        R4 K3 [error]
       37 LOADK                            R5 K12 ["Failed to load ACP thread list"]
       38 LOADN                            R6 0
       39 CALL                             R4 2 0
       40 NEWTABLE                         R4 0 0
       42 GETTABLEKS                       R5 R3 K13 ["threads"]
       44 JUMPIFNOT                        R5 ; [+34]
       45 MOVE                             R6 R5
       46 LOADNIL                          R7
       47 LOADNIL                          R8
       48 FORGPREP                         R6
       49 DUPTABLE                         R13 K16 [{"sessionId", "title", "updatedAt"}]
       50 GETTABLEKS                       R14 R10 K17 ["threadId"]
       52 SETTABLEKS                       R14 R13 K1 ["sessionId"]
       54 GETTABLEKS                       R14 R10 K14 ["title"]
       56 SETTABLEKS                       R14 R13 K14 ["title"]
       58 GETIMPORT                        R14 K20 [os.date]
       60 LOADK                            R15 K21 ["!%Y-%m-%dT%H:%M:%SZ"]
       61 GETTABLEKS                       R18 R10 K15 ["updatedAt"]
       63 DIVK                             R17 R18 K22 [1000]
       64 FASTCALL1                        MATH_FLOOR R17 ; [+2]
       65 GETIMPORT                        R16 K25 [math.floor]
       67 CALL                             R16 1 1
       68 CALL                             R14 2 1
       69 SETTABLEKS                       R14 R13 K15 ["updatedAt"]
       71 FASTCALL2                        TABLE_INSERT R4 R13 ; [+4]
       73 MOVE                             R12 R4
       74 GETIMPORT                        R11 K28 [table.insert]
       76 CALL                             R11 2 0
       77 FORGLOOP                         R6 2 ; [-29]
       79 DUPTABLE                         R6 K31 [{"sessions", "nextPageToken"}]
       80 SETTABLEKS                       R4 R6 K29 ["sessions"]
       82 GETTABLEKS                       R7 R3 K8 ["cursor"]
       84 SETTABLEKS                       R7 R6 K30 ["nextPageToken"]
       86 RETURN                           R6 1
...
PROTO_20:
       ...
       12 GETUPVAL                         R4 2
       13 GETUPVAL                         R5 2
       14 GETTABLEKS                       R5 R5 K5 ["sessionIdRef"]
       16 GETTABLEKS                       R5 R5 K6 ["sessionId"]
       18 CALL                             R3 2 1
       19 JUMPIF                           R3 ; [+5]
       20 GETIMPORT                        R4 K3 [error]
       22 LOADK                            R5 K7 ["Studio session metadata is unavailable"]
       23 LOADN                            R6 0
       24 CALL                             R4 2 0
       25 MOVE                             R3 R2
       26 MOVE                             R4 R0
       27 DUPTABLE                         R5 K10 [{"cursor", "limit"}]
       28 SETTABLEKS                       R1 R5 K8 ["cursor"]
       30 GETUPVAL                         R6 3
       31 GETTABLEKS                       R6 R6 K11 ["FIntAssistantPersistenceMessageLoadLimit"]
       33 SETTABLEKS                       R6 R5 K9 ["limit"]
       35 CALL                             R3 2 2
       36 JUMPIFNOT                        R3 ; [+1]
       37 JUMPIF                           R4 ; [+10]
       38 GETIMPORT                        R5 K3 [error]
       40 LOADK                            R7 K12 ["Failed to load ACP session %*"]
       41 MOVE                             R9 R0
       ...
       46 LOADN                            R7 0
       47 CALL                             R5 2 0
       48 GETTABLEKS                       R5 R4 K14 ["messages"]
       50 JUMPIF                           R5 ; [+2]
       51 NEWTABLE                         R5 0 0
       53 DUPCLOSURE                       R6 K15 [PROTO_18]
       54 GETIMPORT                        R7 K18 [table.sort]
       56 MOVE                             R8 R5
       57 DUPCLOSURE                       R9 K19 [PROTO_19]
       58 CAPTURE                          UPVAL U3
       59 CALL                             R7 2 0
       60 DUPTABLE                         R7 K23 [{["messages"], ["modes"] = , ["nextHistoryPageToken"]}]
       61 SETTABLEKS                       R5 R7 K14 ["messages"]
       63 GETTABLEKS                       R8 R4 K8 ["cursor"]
       65 SETTABLEKS                       R8 R7 K22 ["nextHistoryPageToken"]
       67 RETURN                           R7 1
...
PROTO_33:
        ...
        2 GETUPVAL                         R2 0
        3 GETTABLEKS                       R3 R0 K1 ["sessions"]
        5 DUPTABLE                         R4 K3 [{"placeId"}]
        6 GETTABLEKS                       R5 R1 K2 ["placeId"]
        8 SETTABLEKS                       R5 R4 K2 ["placeId"]
       10 CALL                             R2 2 1
       11 JUMPIF                           R2 ; [+5]
       12 GETIMPORT                        R3 K5 [error]
       14 LOADK                            R4 K6 ["IO error while uploading ACP agent sessions"]
       15 LOADN                            R5 0
       16 CALL                             R3 2 0
       17 RETURN                           R0 0
...
PROTO_34:
        ...
        2 GETTABLEKS                       R1 R1 K1 ["uploadAgentSessionsAsync"]
        4 JUMPIF                           R1 ; [+2]
        5 LOADNIL                          R2
        6 RETURN                           R2 1
        7 GETTABLEKS                       R2 R0 K2 ["coordinator"]
        9 GETTABLEKS                       R2 R2 K3 ["onAgentSaveReady"]
       11 NEWCLOSURE                       R3 P0
       12 CAPTURE                          VAL R1
       13 CALL                             R2 1 -1
       14 RETURN                           R2 -1
...
PROTO_39:
       ...
       36 CALL                             R1 0 0
       37 GETUPVAL                         R1 5
       38 GETTABLEKS                       R1 R1 K4 ["FFlagAssistantRemoveWaitForPendingSavesOnDestroy"]
       40 JUMPIF                           R1 ; [+12]
       41 GETUPVAL                         R1 6
       42 NAMECALL                         R1 R1 K5 ["IsGuest"]
       44 CALL                             R1 1 1
       45 JUMPIFNOT                        R1 ; [+5]
       46 GETUPVAL                         R1 7
       47 GETTABLEKS                       R1 R1 K6 ["waitForPendingSaves"]
       49 CALL                             R1 0 0
       50 JUMP                             ; [+2]
       51 GETUPVAL                         R1 8
       52 CALL                             R1 0 0
...
PROTO_40:
       ...
       71 GETTABLEKS                       R10 R10 K15 ["uploadAgentSessionsAsync"]
       73 JUMPIF                           R10 ; [+2]
       74 LOADNIL                          R8
       75 JUMP                             ; [+8]
       76 GETTABLEKS                       R11 R0 K1 ["coordinator"]
       78 GETTABLEKS                       R11 R11 K16 ["onAgentSaveReady"]
       80 NEWCLOSURE                       R12 P2
       81 CAPTURE                          VAL R10
       82 CALL                             R11 1 1
       83 MOVE                             R8 R11
       84 GETTABLEKS                       R10 R0 K1 ["coordinator"]
       86 GETTABLEKS                       R11 R0 K12 ["io"]
       88 GETTABLEKS                       R12 R10 K17 ["onDeleteRequested"]
       ...
       94 CALL                             R12 1 1
       95 MOVE                             R9 R12
       96 LOADK                            R12 K18 ["StudioSessionOrchestration_waitForPendingSavesAsync"]
       97 NEWCLOSURE                       R13 P4
       98 CAPTURE                          VAL R2
       99 NAMECALL                         R10 R1 K19 ["OnGuestInvokeAsync"]
      101 CALL                             R10 3 2
      102 GETTABLEKS                       R12 R1 K20 ["Destroying"]
...
MAIN:
       ...
       81 DUPCLOSURE                       R22 K35 [PROTO_37]
       82 CAPTURE                          VAL R9
       83 CAPTURE                          VAL R3
       84 DUPCLOSURE                       R23 K36 [PROTO_40]
       85 CAPTURE                          VAL R4
       86 CAPTURE                          VAL R17
       87 CAPTURE                          VAL R18
       88 CAPTURE                          VAL R9
       ...
       90 CAPTURE                          VAL R3
       91 CAPTURE                          VAL R8
       92 DUPTABLE                         R24 K38 [{"trackSessions"}]
       93 SETTABLEKS                       R23 R24 K37 ["trackSessions"]
       95 RETURN                           R24 1
