...
PROTO_6:
        ...
        3 DUPTABLE                         R2 K4 [{["inputEnabled"] = False, [2]}]
        4 SETTABLEKS                       R1 R2 K0 ["reasonDisabled"]
        6 GETUPVAL                         R3 0
        7 GETTABLEKS                       R3 R3 K5 ["current"]
        9 GETUPVAL                         R4 1
       10 SETTABLE                         R2 R3 R4
       11 GETUPVAL                         R3 2
       12 GETIMPORT                        R4 K8 [table.clone]
       14 GETUPVAL                         R5 0
       15 GETTABLEKS                       R5 R5 K5 ["current"]
       17 CALL                             R4 1 -1
       18 CALL                             R3 -1 0
       19 GETUPVAL                         R3 1
       20 GETUPVAL                         R4 3
       21 GETTABLEKS                       R4 R4 K5 ["current"]
       23 JUMPIFNOTEQ                      R3 R4 ; [+4]
       25 GETUPVAL                         R3 4
       26 MOVE                             R4 R2
       27 CALL                             R3 1 0
       28 RETURN                           R0 0
...
PROTO_7:
       ...
       18 JUMPIFNOTEQ                      R0 R1 ; [+4]
       20 GETUPVAL                         R0 4
       21 DUPTABLE                         R1 K8 [{["inputEnabled"] = True, ["reasonDisabled"] = }]
       22 CALL                             R0 1 0
       23 RETURN                           R0 0
