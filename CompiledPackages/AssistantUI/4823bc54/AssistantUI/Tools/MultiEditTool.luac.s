...
PROTO_10:
       ...
       16 LOADB                            R5 1
       17 GETUPVAL                         R6 1
       18 GETTABLEKS                       R6 R6 K3 ["FFlagSubagentScriptEditAutoConfirmation"]
       20 JUMPIFNOT                        R6 ; [+1]
       21 JUMPIF                           R4 ; [+9]
       22 GETUPVAL                         R6 1
       23 GETTABLEKS                       R6 R6 K4 ["FFlagAssistantEval"]
       25 JUMPIFNOT                        R6 ; [+7]
       26 GETUPVAL                         R6 2
       27 GETTABLEKS                       R6 R6 K5 ["getIsEvaluationRunning"]
       29 CALL                             R6 0 1
       30 JUMPIFNOT                        R6 ; [+2]
       31 LOADB                            R5 0
       32 JUMP                             ; [+12]
       33 GETUPVAL                         R6 1
       34 GETTABLEKS                       R6 R6 K6 ["FFlagAssistantMultiEditExternalClient"]
       36 JUMPIFNOT                        R6 ; [+3]
       37 JUMPIFNOT                        R2 ; [+2]
       38 LOADB                            R5 0
       39 JUMP                             ; [+5]
       40 GETUPVAL                         R6 3
       41 GETTABLEKS                       R6 R6 K7 ["shouldUseDiffView"]
       43 CALL                             R6 0 1
       44 MOVE                             R5 R6
       45 GETUPVAL                         R6 4
       46 MOVE                             R7 R3
       47 MOVE                             R8 R0
       48 ORK                              R9 R1 K8 ["none"]
       49 MOVE                             R10 R5
       50 CALL                             R6 4 1
       51 GETUPVAL                         R7 5
       52 CALL                             R7 0 1
       53 MOVE                             R9 R6
       54 NAMECALL                         R7 R7 K9 ["addText"]
       56 CALL                             R7 2 1
       57 NAMECALL                         R7 R7 K10 ["build"]
       59 CALL                             R7 1 -1
       60 RETURN                           R7 -1
...
PROTO_13:
       ...
       23 CAPTURE                          UPVAL U7
       24 GETUPVAL                         R6 8
       25 GETTABLEKS                       R6 R6 K4 ["define"]
       27 CALL                             R6 0 1
       28 GETUPVAL                         R8 9
       29 GETTABLEKS                       R8 R8 K5 ["MultiEdit"]
       ...
       39 DUPTABLE                         R9 K14 [{["type"] = "string", ["description"] = "The dot-notation path of the script (e.g., 'game.ServerScriptService.MyScript'). Will be created if it doesn't exist."}]
       40 NAMECALL                         R6 R6 K15 ["addArgument"]
       42 CALL                             R6 3 1
       43 LOADK                            R8 K16 ["edits"]
       44 DUPTABLE                         R9 K20 [{["type"] = "array", ["description"] = "An array of edit operations. For new scripts, first edit can have empty old_string to set initial content.", ["items"]}]
       45 DUPTABLE                         R10 K24 [{["type"] = "object", ["properties"], ["required"]}]
       46 DUPTABLE                         R11 K28 [{"old_string", "new_string", "replace_all"}]
       47 DUPTABLE                         R12 K30 [{["type"] = "string", ["description"] = "The text to replace (must match exactly). Use empty string for new script initial content."}]
       48 SETTABLEKS                       R12 R11 K25 ["old_string"]
       50 DUPTABLE                         R12 K32 [{["type"] = "string", ["description"] = "The text to replace it with (must be different from old_string)"}]
       51 SETTABLEKS                       R12 R11 K26 ["new_string"]
       53 DUPTABLE                         R12 K35 [{["type"] = "boolean", ["description"] = "Replace all occurrences of old_string (optional, defaults to false)"}]
       54 SETTABLEKS                       R12 R11 K27 ["replace_all"]
       56 SETTABLEKS                       R11 R10 K22 ["properties"]
       58 NEWTABLE                         R11 0 2
       60 LOADK                            R12 K25 ["old_string"]
       61 LOADK                            R13 K26 ["new_string"]
       62 SETLIST                          R11 R12 2 [1]
       64 SETTABLEKS                       R11 R10 K23 ["required"]
       66 SETTABLEKS                       R10 R9 K19 ["items"]
       68 NAMECALL                         R6 R6 K15 ["addArgument"]
       70 CALL                             R6 3 1
       71 LOADK                            R8 K36 ["className"]
       72 DUPTABLE                         R9 K38 [{["type"] = "string", ["description"] = "The class name of the script to create (e.g., 'Script', 'LocalScript', 'ModuleScript'). Required only when creating new scripts, leave empty if script already exists."}]
       73 NAMECALL                         R6 R6 K39 ["addOptionalArgument"]
       75 CALL                             R6 3 1
       76 DUPTABLE                         R8 K47 [{["title"] = "Multi-Edit", ["readOnlyHint"] = False, ["destructiveHint"] = False, ["idempotentHint"] = False, ["openWorldHint"] = False}]
       77 NAMECALL                         R6 R6 K48 ["setAnnotations"]
       79 CALL                             R6 2 1
       80 MOVE                             R8 R5
       81 NAMECALL                         R6 R6 K49 ["setHandler"]
       83 CALL                             R6 2 1
       84 NAMECALL                         R6 R6 K50 ["build"]
       86 CALL                             R6 1 1
       87 DUPTABLE                         R7 K55 [{"availableDataModelTypes", "definition", "getPreExecuteWarning", "displayNameFunction"}]
       88 GETUPVAL                         R9 2
       89 GETTABLEKS                       R9 R9 K56 ["FFlagAssistantBackgroundDataModelToolCall"]
       91 JUMPIFNOT                        R9 ; [+10]
       92 NEWTABLE                         R8 0 1
       94 GETUPVAL                         R9 4
       95 GETTABLEKS                       R9 R9 K57 ["Types"]
       97 GETTABLEKS                       R9 R9 K58 ["Edit"]
       99 SETLIST                          R8 R9 1 [1]
      101 JUMPIF                           R8 ; [+1]
      102 LOADNIL                          R8
      103 SETTABLEKS                       R8 R7 K51 ["availableDataModelTypes"]
      105 SETTABLEKS                       R6 R7 K52 ["definition"]
      107 DUPCLOSURE                       R8 K59 [PROTO_11]
      108 CAPTURE                          UPVAL U6
      109 CAPTURE                          UPVAL U10
      110 SETTABLEKS                       R8 R7 K53 ["getPreExecuteWarning"]
      112 GETUPVAL                         R9 2
      113 GETTABLEKS                       R9 R9 K60 ["FFlagAssistantSplitToolsAndWidgets"]
      115 JUMPIFNOT                        R9 ; [+2]
      116 LOADNIL                          R8
      117 JUMP                             ; [+2]
      118 DUPCLOSURE                       R8 K61 [PROTO_12]
...
MAIN:
       ...
       31 GETTABLEKS                       R5 R0 K14 ["FlagUtils"]
       33 CALL                             R4 1 1
       34 GETIMPORT                        R5 K9 [require]
       36 GETTABLEKS                       R6 R0 K15 ["Flags"]
       38 CALL                             R5 1 1
       39 GETIMPORT                        R6 K9 [require]
       41 GETTABLEKS                       R7 R0 K16 ["Parent"]
       43 GETTABLEKS                       R7 R7 K17 ["ModelContextProtocol"]
       45 CALL                             R6 1 1
       46 GETIMPORT                        R7 K9 [require]
       48 GETTABLEKS                       R8 R0 K10 ["Util"]
       50 GETTABLEKS                       R8 R8 K18 ["MultiEditAcceptanceState"]
       52 CALL                             R7 1 1
       53 GETIMPORT                        R8 K9 [require]
       55 GETTABLEKS                       R9 R0 K19 ["Tools"]
       57 GETTABLEKS                       R9 R9 K20 ["ToolTypes"]
       59 CALL                             R8 1 1
       60 GETIMPORT                        R9 K9 [require]
       62 GETTABLEKS                       R10 R0 K10 ["Util"]
       64 GETTABLEKS                       R10 R10 K21 ["ToolUtils"]
       66 CALL                             R9 1 1
       67 GETIMPORT                        R10 K9 [require]
       69 GETTABLEKS                       R11 R0 K22 ["Resources"]
       71 GETTABLEKS                       R11 R11 K23 ["Localization"]
       73 GETTABLEKS                       R11 R11 K24 ["Translator"]
       75 CALL                             R10 1 1
       76 GETIMPORT                        R11 K9 [require]
       78 GETTABLEKS                       R12 R0 K25 ["Types"]
       80 CALL                             R11 1 1
       81 GETTABLEKS                       R12 R4 K26 ["getIsAssistantBackgroundDataModelToolCall"]
       83 GETTABLEKS                       R13 R6 K10 ["Util"]
       85 GETTABLEKS                       R13 R13 K27 ["ToolBuilder"]
       87 GETTABLEKS                       R14 R6 K10 ["Util"]
       89 GETTABLEKS                       R14 R14 K28 ["ToolResult"]
       91 GETTABLEKS                       R15 R8 K29 ["ToolNames"]
       93 DUPCLOSURE                       R16 K30 [PROTO_0]
       94 DUPCLOSURE                       R17 K31 [PROTO_1]
       95 DUPCLOSURE                       R18 K32 [PROTO_2]
       96 DUPCLOSURE                       R19 K33 [PROTO_3]
       97 DUPCLOSURE                       R20 K34 [PROTO_4]
       98 DUPCLOSURE                       R21 K35 [PROTO_5]
       99 DUPCLOSURE                       R22 K36 [PROTO_6]
      100 CAPTURE                          VAL R20
      101 CAPTURE                          VAL R21
      102 DUPCLOSURE                       R23 K37 [PROTO_13]
      103 CAPTURE                          VAL R9
      104 CAPTURE                          VAL R1
      105 CAPTURE                          VAL R5
      106 CAPTURE                          VAL R12
