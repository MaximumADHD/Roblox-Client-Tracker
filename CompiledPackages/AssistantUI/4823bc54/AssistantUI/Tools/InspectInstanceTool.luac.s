...
PROTO_17:
        0 DUPTABLE                         R0 K4 [{[1], ["summary"], ["noExpand"] = True}]
        1 GETUPVAL                         R1 0
        2 GETTABLEKS                       R1 R1 K5 ["Type"]
        4 SETTABLEKS                       R1 R0 K0 ["type"]
        6 GETUPVAL                         R1 1
        7 LOADK                            R3 K6 ["InspectInstance"]
        8 LOADK                            R4 K7 ["Pending"]
        9 NAMECALL                         R1 R1 K8 ["getText"]
       11 CALL                             R1 3 1
...
PROTO_22:
       ...
       40 DUPTABLE                         R8 K20 [{["type"] = "string", ["description"]}]
       41 LOADK                            R10 K21 ["Path to the instance(s) to inspect using dot notation (case-insensitive). Returns detailed properties, attributes, and children summary. If multiple instances match, up to %* will be returned with a warning if more exist. Example: 'Workspace.Model.Part' or 'workspace.model.part'"]
       42 GETUPVAL                         R12 4
       43 NAMECALL                         R10 R10 K22 ["format"]
       45 CALL                             R10 2 1
       46 MOVE                             R9 R10
       47 SETTABLEKS                       R9 R8 K19 ["description"]
       49 NAMECALL                         R5 R5 K23 ["addArgument"]
       51 CALL                             R5 3 1
       52 DUPTABLE                         R7 K32 [{["title"] = "Inspect Instance", ["readOnlyHint"] = True, ["destructiveHint"] = False, ["idempotentHint"] = True, ["openWorldHint"] = False}]
       53 NAMECALL                         R5 R5 K33 ["setAnnotations"]
       55 CALL                             R5 2 1
       56 MOVE                             R7 R4
       57 NAMECALL                         R5 R5 K34 ["setHandler"]
       59 CALL                             R5 2 1
       60 NAMECALL                         R5 R5 K35 ["build"]
       62 CALL                             R5 1 1
       63 DUPTABLE                         R6 K39 [{"transformInitialContent", "getTransformPreExecuteFn", "getTransformResultFn"}]
       64 DUPCLOSURE                       R7 K40 [PROTO_17]
       65 CAPTURE                          UPVAL U5
       66 CAPTURE                          UPVAL U6
       67 SETTABLEKS                       R7 R6 K36 ["transformInitialContent"]
       69 DUPCLOSURE                       R7 K41 [PROTO_19]
       70 CAPTURE                          UPVAL U6
       71 SETTABLEKS                       R7 R6 K37 ["getTransformPreExecuteFn"]
       73 DUPCLOSURE                       R7 K42 [PROTO_21]
       74 CAPTURE                          UPVAL U6
       75 SETTABLEKS                       R7 R6 K38 ["getTransformResultFn"]
       77 DUPTABLE                         R7 K46 [{"definition", "contentWidgets", "streamTransform"}]
       78 SETTABLEKS                       R5 R7 K43 ["definition"]
       80 GETUPVAL                         R9 7
       81 GETTABLEKS                       R9 R9 K47 ["FFlagAssistantSplitToolsAndWidgets"]
       83 JUMPIFNOT                        R9 ; [+2]
       84 LOADNIL                          R8
       85 JUMP                             ; [+5]
       86 NEWTABLE                         R8 0 1
       ...
       91 SETTABLEKS                       R8 R7 K44 ["contentWidgets"]
       93 GETUPVAL                         R9 7
       94 GETTABLEKS                       R9 R9 K47 ["FFlagAssistantSplitToolsAndWidgets"]
       96 JUMPIFNOT                        R9 ; [+2]
       97 LOADNIL                          R8
       98 JUMP                             ; [+1]
       99 MOVE                             R8 R6
      100 SETTABLEKS                       R8 R7 K45 ["streamTransform"]
      102 RETURN                           R7 1
...
MAIN:
       ...
       33 GETTABLEKS                       R6 R0 K14 ["Components"]
       35 GETTABLEKS                       R6 R6 K15 ["ContentWidgets"]
       37 GETTABLEKS                       R6 R6 K16 ["SummarizedContentWidget"]
       39 CALL                             R5 1 1
       40 GETIMPORT                        R6 K10 [require]
       42 GETTABLEKS                       R7 R0 K17 ["Tools"]
       44 GETTABLEKS                       R7 R7 K18 ["ToolTypes"]
       46 CALL                             R6 1 1
       47 GETIMPORT                        R7 K10 [require]
       49 GETTABLEKS                       R8 R0 K19 ["Util"]
       51 GETTABLEKS                       R8 R8 K20 ["ToolUtils"]
       53 CALL                             R7 1 1
       54 GETIMPORT                        R8 K10 [require]
       56 GETTABLEKS                       R9 R0 K21 ["Resources"]
       58 GETTABLEKS                       R9 R9 K22 ["Localization"]
       60 GETTABLEKS                       R9 R9 K23 ["Translator"]
       62 CALL                             R8 1 1
       63 GETTABLEKS                       R9 R4 K19 ["Util"]
       65 GETTABLEKS                       R9 R9 K24 ["ToolBuilder"]
       67 GETTABLEKS                       R10 R4 K19 ["Util"]
       69 GETTABLEKS                       R10 R10 K25 ["ToolResult"]
       71 GETTABLEKS                       R11 R6 K26 ["ToolNames"]
       73 GETTABLEKS                       R12 R3 K27 ["FIntInspectInstanceMaxJsonLength"]
       75 GETTABLEKS                       R13 R3 K28 ["FIntInspectInstanceMaxMatches"]
       77 GETTABLEKS                       R14 R3 K29 ["FIntInspectInstanceMaxStringLength"]
       79 DUPCLOSURE                       R15 K30 [PROTO_0]
       80 DUPCLOSURE                       R16 K31 [PROTO_1]
       81 CAPTURE                          VAL R7
       82 CAPTURE                          VAL R14
       83 CAPTURE                          VAL R12
       84 DUPCLOSURE                       R17 K32 [PROTO_2]
       85 CAPTURE                          VAL R7
       86 CAPTURE                          VAL R14
       87 CAPTURE                          VAL R12
       88 DUPTABLE                         R18 K37 [{["Parent"] = True, ["ClassName"] = True, ["Name"] = True, ["DataModel"] = True}]
       89 DUPCLOSURE                       R19 K38 [PROTO_3]
       90 CAPTURE                          VAL R7
       91 CAPTURE                          VAL R14
       92 CAPTURE                          VAL R12
       93 DUPCLOSURE                       R20 K39 [PROTO_6]
       94 CAPTURE                          VAL R2
       95 CAPTURE                          VAL R18
       96 CAPTURE                          VAL R7
       97 CAPTURE                          VAL R14
       98 CAPTURE                          VAL R12
       99 DUPCLOSURE                       R21 K40 [PROTO_8]
      100 CAPTURE                          VAL R20
      101 CAPTURE                          VAL R15
      102 CAPTURE                          VAL R17
      103 DUPCLOSURE                       R22 K41 [PROTO_10]
      104 CAPTURE                          VAL R1
      105 DUPCLOSURE                       R23 K42 [PROTO_12]
      106 DUPCLOSURE                       R24 K43 [PROTO_13]
      107 CAPTURE                          VAL R23
      108 CAPTURE                          VAL R21
      109 CAPTURE                          VAL R1
      110 CAPTURE                          VAL R13
      111 DUPCLOSURE                       R25 K44 [PROTO_22]
      112 CAPTURE                          VAL R24
      113 CAPTURE                          VAL R10
      114 CAPTURE                          VAL R9
      115 CAPTURE                          VAL R11
