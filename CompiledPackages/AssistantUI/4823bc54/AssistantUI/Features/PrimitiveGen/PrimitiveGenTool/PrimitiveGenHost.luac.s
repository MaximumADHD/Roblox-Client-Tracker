...
PROTO_18:
       ...
       55 CALL                             R4 2 0
       56 GETUPVAL                         R4 5
       57 GETTABLEKS                       R4 R4 K10 ["FFlagAssistantGen3DTelemetryV2"]
       59 JUMPIFNOT                        R4 ; [+23]
       60 GETUPVAL                         R4 1
       61 GETTABLEKS                       R4 R4 K2 ["generationId"]
       63 JUMPIFNOT                        R4 ; [+19]
       64 GETUPVAL                         R4 1
       65 GETTABLEKS                       R4 R4 K2 ["generationId"]
       67 GETIMPORT                        R5 K13 [os.clock]
       69 CALL                             R5 0 1
       70 LOADNIL                          R6
       71 GETTABLEKS                       R7 R2 K14 ["Destroying"]
       73 NEWCLOSURE                       R9 P0
       74 CAPTURE                          REF R6
       75 CAPTURE                          UPVAL U7
       76 CAPTURE                          VAL R4
       77 CAPTURE                          VAL R5
       78 NAMECALL                         R7 R7 K15 ["Connect"]
       80 CALL                             R7 2 1
       81 MOVE                             R6 R7
       82 CLOSEUPVALS                      R6
       83 GETUPVAL                         R4 8
...
PROTO_19:
       ...
       31 CALL                             R6 1 0
       32 JUMPIF                           R4 ; [+4]
       33 DUPTABLE                         R6 K11 [{["success"] = False, ["error"]}]
       34 SETTABLEKS                       R5 R6 K10 ["error"]
       36 RETURN                           R6 1
       37 DUPTABLE                         R6 K14 [{["success"] = True, ["resultName"]}]
       38 SETTABLEKS                       R5 R6 K13 ["resultName"]
       40 RETURN                           R6 1
...
MAIN:
       ...
       42 GETTABLEKS                       R7 R7 K11 ["Parent"]
       44 GETTABLEKS                       R7 R7 K16 ["PrimitiveGenBridgeTypes"]
       46 CALL                             R6 1 1
       47 GETIMPORT                        R7 K10 [require]
       49 GETTABLEKS                       R8 R0 K17 ["Util"]
       51 GETTABLEKS                       R8 R8 K18 ["Tagging"]
       53 CALL                             R7 1 1
       54 GETTABLEKS                       R8 R3 K19 ["Engine"]
       56 GETTABLEKS                       R8 R8 K20 ["TaskCollector"]
       58 GETIMPORT                        R9 K10 [require]
       60 GETTABLEKS                       R10 R0 K17 ["Util"]
       62 GETTABLEKS                       R10 R10 K21 ["ToolUtils"]
       64 CALL                             R9 1 1
       65 GETIMPORT                        R10 K10 [require]
       67 GETTABLEKS                       R11 R0 K22 ["Resources"]
       69 GETTABLEKS                       R11 R11 K23 ["Localization"]
       71 GETTABLEKS                       R11 R11 K24 ["Translator"]
       73 CALL                             R10 1 1
       74 GETIMPORT                        R11 K10 [require]
       76 GETTABLEKS                       R12 R0 K25 ["Features"]
       78 GETTABLEKS                       R12 R12 K26 ["Gen3dUtils"]
       80 GETTABLEKS                       R12 R12 K27 ["ViewportPreviewUtils"]
       82 CALL                             R11 1 1
       83 NEWTABLE                         R12 0 0
       85 LOADN                            R15 0
       86 LOADN                            R13 47
       87 LOADN                            R14 1
       88 FORNPREP                         R13
       89 DUPTABLE                         R18 K31 [{["azimuth"], ["elevation"] = 30}]
       90 MULK                             R20 R15 K33 [7.5]
       91 ADDK                             R19 R20 K32 [45]
       92 SETTABLEKS                       R19 R18 K28 ["azimuth"]
       94 FASTCALL2                        TABLE_INSERT R12 R18 ; [+4]
       96 MOVE                             R17 R12
       97 GETIMPORT                        R16 K36 [table.insert]
       99 CALL                             R16 2 0
      100 FORNLOOP                         R13
      101 DUPTABLE                         R13 K43 [{["smartWidth"] = "parameters.Size.X", ["smartHeight"] = "parameters.Size.Y", ["smartDepth"] = "parameters.Size.Z"}]
      102 DUPTABLE                         R14 K47 [{["SmartWidth"] = "parameters.Size.X", ["SmartHeight"] = "parameters.Size.Y", ["SmartDepth"] = "parameters.Size.Z"}]
      103 DUPCLOSURE                       R15 K48 [PROTO_0]
      104 DUPCLOSURE                       R16 K49 [PROTO_1]
      105 CAPTURE                          VAL R5
      106 CAPTURE                          VAL R7
      107 DUPCLOSURE                       R17 K50 [PROTO_2]
      108 DUPCLOSURE                       R18 K51 [PROTO_3]
      109 DUPCLOSURE                       R19 K52 [PROTO_5]
      110 CAPTURE                          VAL R8
      111 CAPTURE                          VAL R18
      112 DUPCLOSURE                       R20 K53 [PROTO_7]
      113 CAPTURE                          VAL R13
      114 CAPTURE                          VAL R5
      115 CAPTURE                          VAL R14
      116 DUPCLOSURE                       R21 K54 [PROTO_8]
      117 DUPCLOSURE                       R22 K55 [PROTO_9]
      118 CAPTURE                          VAL R5
      119 DUPCLOSURE                       R23 K56 [PROTO_10]
      120 CAPTURE                          VAL R5
      121 CAPTURE                          VAL R17
      122 CAPTURE                          VAL R19
      123 CAPTURE                          VAL R22
      124 DUPCLOSURE                       R24 K57 [PROTO_15]
      125 CAPTURE                          VAL R9
      126 CAPTURE                          VAL R5
      127 CAPTURE                          VAL R11
      128 CAPTURE                          VAL R12
      129 DUPCLOSURE                       R25 K58 [PROTO_19]
      130 CAPTURE                          VAL R2
      131 CAPTURE                          VAL R21
      132 CAPTURE                          VAL R20
      133 CAPTURE                          VAL R23
      ...
      135 CAPTURE                          VAL R7
      136 CAPTURE                          VAL R24
      137 DUPCLOSURE                       R26 K59 [PROTO_20]
      138 DUPCLOSURE                       R27 K60 [PROTO_21]
      139 CAPTURE                          VAL R1
      140 DUPCLOSURE                       R28 K61 [PROTO_23]
      141 CAPTURE                          VAL R5
      142 CAPTURE                          VAL R7
      143 CAPTURE                          VAL R1
      144 CAPTURE                          VAL R10
      145 DUPTABLE                         R29 K66 [{"addWorkspaceModelAsync", "pingAssetDmAsync", "selectModel", "listenToLinkChanges"}]
      146 SETTABLEKS                       R25 R29 K62 ["addWorkspaceModelAsync"]
      148 SETTABLEKS                       R26 R29 K63 ["pingAssetDmAsync"]
      150 SETTABLEKS                       R27 R29 K64 ["selectModel"]
      152 SETTABLEKS                       R28 R29 K65 ["listenToLinkChanges"]
      154 DUPTABLE                         R30 K68 [{"bridge"}]
      155 SETTABLEKS                       R29 R30 K67 ["bridge"]
      157 RETURN                           R30 1
