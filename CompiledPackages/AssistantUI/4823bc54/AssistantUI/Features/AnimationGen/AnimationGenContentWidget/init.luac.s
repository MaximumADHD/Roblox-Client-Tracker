...
MAIN:
       ...
       17 GETTABLEKS                       R4 R0 K8 ["Components"]
       19 GETTABLEKS                       R4 R4 K9 ["Accordion"]
       21 CALL                             R3 1 1
       22 GETIMPORT                        R4 K7 [require]
       24 GETTABLEKS                       R5 R1 K10 ["AnimationGenTypes"]
       26 CALL                             R4 1 1
       27 GETIMPORT                        R5 K7 [require]
       29 GETTABLEKS                       R6 R2 K11 ["Foundation"]
       31 CALL                             R5 1 1
       32 GETTABLEKS                       R5 R5 K12 ["Chip"]
       34 GETIMPORT                        R6 K7 [require]
       36 GETTABLEKS                       R7 R2 K13 ["Dash"]
       38 CALL                             R6 1 1
       39 GETIMPORT                        R7 K7 [require]
       41 GETTABLEKS                       R8 R2 K11 ["Foundation"]
       43 CALL                             R7 1 1
       44 GETIMPORT                        R8 K7 [require]
       46 GETIMPORT                        R9 K1 [script]
       48 GETTABLEKS                       R9 R9 K14 ["PlaybackWidget"]
       50 CALL                             R8 1 1
       51 GETIMPORT                        R9 K7 [require]
       53 GETTABLEKS                       R10 R2 K15 ["React"]
       55 CALL                             R9 1 1
       56 GETIMPORT                        R10 K7 [require]
       58 GETTABLEKS                       R11 R2 K16 ["ReactUtils"]
       60 CALL                             R10 1 1
       61 GETIMPORT                        R11 K7 [require]
       63 GETTABLEKS                       R12 R0 K17 ["Util"]
       65 GETTABLEKS                       R12 R12 K18 ["Serializer"]
       67 GETTABLEKS                       R12 R12 K19 ["SerializerTypes"]
       69 CALL                             R11 1 1
       70 GETIMPORT                        R12 K7 [require]
       72 GETTABLEKS                       R13 R0 K8 ["Components"]
       74 GETTABLEKS                       R13 R13 K20 ["ShimmerGradient"]
       76 CALL                             R12 1 1
       77 GETIMPORT                        R13 K7 [require]
       79 GETTABLEKS                       R14 R2 K21 ["Signal"]
       81 CALL                             R13 1 1
       82 GETIMPORT                        R14 K7 [require]
       84 GETTABLEKS                       R15 R0 K22 ["Resources"]
       86 GETTABLEKS                       R15 R15 K23 ["Localization"]
       88 GETTABLEKS                       R15 R15 K24 ["Translator"]
       90 CALL                             R14 1 1
       91 GETIMPORT                        R15 K7 [require]
       93 GETTABLEKS                       R16 R0 K25 ["Types"]
       95 CALL                             R15 1 1
       96 GETIMPORT                        R16 K7 [require]
       98 GETTABLEKS                       R17 R0 K26 ["Hooks"]
      100 GETTABLEKS                       R17 R17 K27 ["useClassIcon"]
      102 CALL                             R16 1 1
      103 GETTABLEKS                       R17 R7 K28 ["Button"]
      105 GETTABLEKS                       R18 R7 K29 ["Text"]
      107 GETTABLEKS                       R19 R7 K30 ["View"]
      109 GETTABLEKS                       R20 R10 K31 ["createNextOrder"]
      111 GETTABLEKS                       R21 R9 K32 ["createElement"]
      113 DUPCLOSURE                       R22 K33 [PROTO_0]
      114 CAPTURE                          VAL R20
      115 CAPTURE                          VAL R21
      116 CAPTURE                          VAL R3
      117 DUPCLOSURE                       R23 K34 [PROTO_4]
      118 CAPTURE                          VAL R4
      119 CAPTURE                          VAL R16
      120 CAPTURE                          VAL R9
      121 CAPTURE                          VAL R14
      ...
      131 CAPTURE                          VAL R8
      132 CAPTURE                          VAL R17
      133 DUPTABLE                         R24 K37 [{"toMeta", "fromMeta"}]
      134 DUPCLOSURE                       R25 K38 [PROTO_5]
      135 SETTABLEKS                       R25 R24 K35 ["toMeta"]
      137 DUPCLOSURE                       R25 K39 [PROTO_6]
      138 SETTABLEKS                       R25 R24 K36 ["fromMeta"]
      140 DUPTABLE                         R25 K43 [{["Type"] = "AnimationGen", ["ContentWidget"], ["Serialization"]}]
      141 GETTABLEKS                       R26 R9 K44 ["memo"]
      143 MOVE                             R27 R23
      144 CALL                             R26 1 1
      145 SETTABLEKS                       R26 R25 K41 ["ContentWidget"]
      147 SETTABLEKS                       R24 R25 K42 ["Serialization"]
      149 RETURN                           R25 1
