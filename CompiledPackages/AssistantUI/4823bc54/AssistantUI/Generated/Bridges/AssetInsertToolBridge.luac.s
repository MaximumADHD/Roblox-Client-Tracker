...
PROTO_7:
       ...
       14 CALL                             R8 2 0
       15 LOADK                            R7 K5 ["AssetInsertTool_updateContentHeader"]
       16 NEWCLOSURE                       R8 P1
       17 CAPTURE                          VAL R2
       18 CAPTURE                          VAL R0
       19 CAPTURE                          VAL R1
...
PROTO_12:
       ...
       19 CALL                             R7 2 1
       20 SETTABLEKS                       R7 R4 K5 ["bridge"]
       22 GETTABLEKS                       R5 R3 K8 ["insertAssetAsync"]
       24 MOVE                             R6 R2
       25 MOVE                             R7 R4
       26 CALL                             R5 2 -1
       27 RETURN                           R5 -1
...
PROTO_17:
        0 DUPTABLE                         R2 K4 [{"selectInsertedAssets", "listenToLinkChanges", "insertAssetAsync", "toTarget"}]
        1 NEWCLOSURE                       R3 P0
        2 CAPTURE                          UPVAL U0
        3 CAPTURE                          VAL R0
        4 CAPTURE                          VAL R1
...
PROTO_18:
       ...
       12 GETIMPORT                        R8 K4 [assert]
       14 CALL                             R8 2 0
       15 LOADK                            R7 K5 ["AssetInsertTool_selectInsertedAssets"]
       16 NEWCLOSURE                       R8 P1
       17 CAPTURE                          VAL R2
       18 CAPTURE                          VAL R0
       19 CAPTURE                          VAL R1
       ...
       31 CALL                             R9 2 0
       32 LOADK                            R8 K9 ["AssetInsertTool_listenToLinkChanges"]
       33 NEWCLOSURE                       R9 P2
       34 CAPTURE                          VAL R2
       35 CAPTURE                          VAL R0
       36 CAPTURE                          VAL R1
       ...
       39 CALL                             R6 3 1
       40 GETUPVAL                         R12 0
       41 GETTABLEKS                       R11 R12 K10 ["insertAssetAsync"]
       43 FASTCALL2K                       ASSERT R11 K11 ; [+4]
       45 LOADK                            R12 K11 ["Invalid network key: insertAssetAsync"]
       46 GETIMPORT                        R10 K4 [assert]
       48 CALL                             R10 2 0
       49 LOADK                            R9 K12 ["AssetInsertTool_insertAssetAsync"]
...
MAIN:
       ...
       13 GETTABLEKS                       R2 R2 K8 ["AssetInsertTool"]
       15 GETTABLEKS                       R2 R2 K9 ["AssetInsertToolBridgeTypes"]
       17 CALL                             R1 1 1
       18 DUPTABLE                         R2 K14 [{["updateContentHeader"] = "updateContentHeader", ["selectInsertedAssets"] = "selectInsertedAssets", ["listenToLinkChanges"] = "listenToLinkChanges", ["insertAssetAsync"] = "insertAssetAsync"}]
       19 DUPCLOSURE                       R3 K15 [PROTO_0]
       20 CAPTURE                          VAL R2
       21 DUPCLOSURE                       R4 K16 [PROTO_1]
       22 DUPCLOSURE                       R5 K17 [PROTO_7]
       23 CAPTURE                          VAL R2
       24 DUPCLOSURE                       R6 K18 [PROTO_8]
       25 DUPCLOSURE                       R7 K19 [PROTO_18]
       26 CAPTURE                          VAL R2
       27 DUPCLOSURE                       R8 K20 [PROTO_23]
       28 CAPTURE                          VAL R5
       29 CAPTURE                          VAL R7
       30 DUPTABLE                         R9 K22 [{"prepareBridges"}]
       31 SETTABLEKS                       R8 R9 K21 ["prepareBridges"]
       33 RETURN                           R9 1
