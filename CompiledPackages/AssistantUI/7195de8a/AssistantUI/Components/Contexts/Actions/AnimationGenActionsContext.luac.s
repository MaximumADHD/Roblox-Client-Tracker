...
MAIN:
       ...
       27 LOADNIL                          R5
       28 CALL                             R4 1 1
       29 DUPTABLE                         R5 K17 [{["AnimatorRemoved"] = "animatorRemoved", ["PlaybackRestarted"] = "playbackRestarted"}]
       30 DUPTABLE                         R6 K18 [{"animatorRemoved", "playbackRestarted"}]
       31 NEWTABLE                         R7 0 0
       ...
       44 CAPTURE                          VAL R2
       45 CAPTURE                          VAL R7
       46 DUPTABLE                         R10 K23 [{"animatorRemoved", "restartPlayback"}]
       47 DUPCLOSURE                       R11 K24 [PROTO_5]
       48 CAPTURE                          VAL R8
       49 SETTABLEKS                       R11 R10 K14 ["animatorRemoved"]
       51 DUPCLOSURE                       R11 K25 [PROTO_6]
       52 CAPTURE                          VAL R8
       53 SETTABLEKS                       R11 R10 K22 ["restartPlayback"]
       55 DUPCLOSURE                       R11 K26 [PROTO_7]
       56 CAPTURE                          VAL R2
       57 CAPTURE                          VAL R7
       58 DUPCLOSURE                       R12 K27 [PROTO_8]
       59 CAPTURE                          VAL R2
       60 CAPTURE                          VAL R7
       61 DUPCLOSURE                       R13 K28 [PROTO_10]
       62 CAPTURE                          VAL R2
       63 CAPTURE                          VAL R3
       64 CAPTURE                          VAL R4
       65 DUPTABLE                         R14 K34 [{"Context", "Provider", "guestBridgeImplementation", "useAnimatorRemoved", "usePlaybackRestarted"}]
       66 SETTABLEKS                       R4 R14 K29 ["Context"]
       68 SETTABLEKS                       R13 R14 K30 ["Provider"]
       70 SETTABLEKS                       R10 R14 K31 ["guestBridgeImplementation"]
       72 SETTABLEKS                       R11 R14 K32 ["useAnimatorRemoved"]
       74 SETTABLEKS                       R12 R14 K33 ["usePlaybackRestarted"]
       76 RETURN                           R14 1
