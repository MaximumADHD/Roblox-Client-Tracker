...
PROTO_7:
      ...
      113 JUMPIFNOTEQKS                    R13 K21 ["text"] ; [+27]
      115 GETUPVAL                         R13 0
      116 GETTABLEKS                       R13 R13 K22 ["FFlagAssistantAcpHistoryCompatibility"]
      118 JUMPIFNOT                        R13 ; [+13]
      119 GETTABLEKS                       R14 R7 K1 ["content"]
      121 DUPTABLE                         R15 K23 [{["type"] = "text", ["text"]}]
      122 GETTABLEKS                       R16 R12 K21 ["text"]
      124 SETTABLEKS                       R16 R15 K21 ["text"]
      126 FASTCALL2                        TABLE_INSERT R14 R15 ; [+3]
      128 GETIMPORT                        R13 K15 [table.insert]
      130 CALL                             R13 2 0
      131 JUMP                             ; [+34]
      132 GETTABLEKS                       R14 R7 K1 ["content"]
      134 FASTCALL2                        TABLE_INSERT R14 R12 ; [+4]
      136 MOVE                             R15 R12
      137 GETIMPORT                        R13 K15 [table.insert]
      139 CALL                             R13 2 0
      140 JUMP                             ; [+25]
      141 GETTABLEKS                       R13 R12 K3 ["type"]
      143 JUMPIFNOTEQKS                    R13 K24 ["tool_use"] ; [+22]
      145 DUPTABLE                         R13 K27 [{["type"] = "tool_use", ["id"], ["name"], ["input"]}]
      146 GETTABLEKS                       R14 R12 K18 ["id"]
      148 SETTABLEKS                       R14 R13 K18 ["id"]
      150 GETTABLEKS                       R14 R12 K25 ["name"]
      152 SETTABLEKS                       R14 R13 K25 ["name"]
      154 GETTABLEKS                       R14 R12 K26 ["input"]
      156 SETTABLEKS                       R14 R13 K26 ["input"]
      158 GETTABLEKS                       R15 R7 K1 ["content"]
      160 FASTCALL2                        TABLE_INSERT R15 R13 ; [+4]
      162 MOVE                             R16 R13
      163 GETIMPORT                        R14 K15 [table.insert]
      165 CALL                             R14 2 0
      166 FORGLOOP                         R8 2 ; [-147]
      168 FASTCALL2                        TABLE_INSERT R1 R7 ; [+5]
      170 MOVE                             R9 R1
      171 MOVE                             R10 R7
      172 GETIMPORT                        R8 K15 [table.insert]
      174 CALL                             R8 2 0
      175 FORGLOOP                         R2 2 ; [-170]
      177 RETURN                           R1 1
...
MAIN:
       ...
       30 CALL                             R4 1 1
       31 GETTABLEKS                       R5 R3 K12 ["createTracker"]
       33 GETTABLEKS                       R6 R4 K13 ["LLMProviderTypes"]
       35 GETTABLEKS                       R6 R6 K14 ["Claude"]
       37 CALL                             R5 1 1
       ...
       43 CAPTURE                          VAL R5
       44 DUPCLOSURE                       R9 K18 [PROTO_3]
       45 CAPTURE                          VAL R4
       46 DUPCLOSURE                       R10 K19 [PROTO_6]
       47 CAPTURE                          VAL R2
       48 CAPTURE                          VAL R5
       49 CAPTURE                          VAL R4
       50 DUPCLOSURE                       R11 K20 [PROTO_7]
       51 CAPTURE                          VAL R1
       52 DUPTABLE                         R12 K25 [{"getTokenUsageTracker", "resetTokenUsageTracker", "createAdapter", "convertLLMtoClaudeMessage"}]
       53 SETTABLEKS                       R7 R12 K21 ["getTokenUsageTracker"]
       55 SETTABLEKS                       R8 R12 K22 ["resetTokenUsageTracker"]
       57 SETTABLEKS                       R10 R12 K23 ["createAdapter"]
       59 SETTABLEKS                       R11 R12 K24 ["convertLLMtoClaudeMessage"]
       61 RETURN                           R12 1
