...
PROTO_6:
       ...
       28 FORGLOOP                         R3 2 ; [-5]
       30 GETUPVAL                         R3 2
       31 GETTABLEKS                       R3 R3 K3 ["FFlagAssistantUseRemoteService"]
       33 JUMPIFNOT                        R3 ; [+12]
       34 JUMPIFNOT                        R2 ; [+1]
       35 RETURN                           R0 0
       36 JUMPIFNOT                        R0 ; [+9]
       ...
       38 JUMPIFNOT                        R3 ; [+7]
       39 GETUPVAL                         R3 3
       40 DUPTABLE                         R5 K5 [{"sessionId"}]
       41 SETTABLEKS                       R0 R5 K4 ["sessionId"]
       43 NAMECALL                         R3 R3 K6 ["cancel"]
       45 CALL                             R3 2 0
       46 RETURN                           R0 0
...
MAIN:
       ...
       30 GETTABLEKS                       R5 R0 K12 ["ACPClientService"]
       32 GETTABLEKS                       R5 R5 K13 ["sendMessage"]
       34 CALL                             R4 1 1
       35 GETIMPORT                        R5 K5 [require]
       37 GETTABLEKS                       R6 R0 K14 ["Hooks"]
       39 GETTABLEKS                       R6 R6 K15 ["useCurrentThread"]
       41 CALL                             R5 1 1
       42 GETTABLEKS                       R6 R3 K16 ["createElement"]
       44 DUPTABLE                         R7 K23 [{["default"] = True, ["registerPromptController"], ["unregisterPromptController"], ["cancelCurrentAcpSession"], ["getCurrentPromptState"]}]
       45 DUPCLOSURE                       R8 K24 [PROTO_0]
       46 SETTABLEKS                       R8 R7 K19 ["registerPromptController"]
       48 DUPCLOSURE                       R8 K25 [PROTO_1]
       49 SETTABLEKS                       R8 R7 K20 ["unregisterPromptController"]
       51 DUPCLOSURE                       R8 K26 [PROTO_2]
       52 SETTABLEKS                       R8 R7 K21 ["cancelCurrentAcpSession"]
       54 DUPCLOSURE                       R8 K27 [PROTO_3]
       55 SETTABLEKS                       R8 R7 K22 ["getCurrentPromptState"]
       57 GETTABLEKS                       R8 R3 K28 ["createContext"]
       59 MOVE                             R9 R7
       60 CALL                             R8 1 1
       61 DUPCLOSURE                       R9 K29 [PROTO_9]
       62 CAPTURE                          VAL R5
       63 CAPTURE                          VAL R3
       64 CAPTURE                          VAL R1
       65 CAPTURE                          VAL R2
       66 CAPTURE                          VAL R6
       67 CAPTURE                          VAL R8
       68 DUPTABLE                         R10 K32 [{"Context", "Provider"}]
       69 SETTABLEKS                       R8 R10 K30 ["Context"]
       71 SETTABLEKS                       R9 R10 K31 ["Provider"]
       73 RETURN                           R10 1
