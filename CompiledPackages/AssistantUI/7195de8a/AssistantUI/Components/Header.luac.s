...
PROTO_29:
        ...
        8 GETUPVAL                         R6 2
        9 GETTABLEKS                       R6 R6 K2 ["FFlagAssistantUseRemoteService"]
       11 JUMPIFNOT                        R6 ; [+9]
       12 GETUPVAL                         R6 2
       13 GETTABLEKS                       R6 R6 K3 ["FFlagAssistantCreditMetering"]
       15 JUMPIFNOT                        R6 ; [+3]
       16 GETTABLEKS                       R5 R2 K4 ["showUsage"]
       18 JUMP                             ; [+4]
       19 LOADNIL                          R5
       20 JUMP                             ; [+2]
       21 GETTABLEKS                       R5 R2 K5 ["showApiKeys"]
       23 GETTABLEKS                       R6 R2 K4 ["showUsage"]
       25 GETUPVAL                         R7 3
       26 GETTABLEKS                       R7 R7 K6 ["useMemo"]
       28 NEWCLOSURE                       R8 P0
       29 CAPTURE                          UPVAL U2
       30 CAPTURE                          UPVAL U4
       31 CAPTURE                          VAL R2
       ...
       35 GETUPVAL                         R8 5
       36 GETUPVAL                         R9 6
       37 DUPTABLE                         R10 K10 [{["tag"] = "row align-y-center gap-xsmall size-full-0 auto-y padding-small", ["LayoutOrder"]}]
       38 GETTABLEKS                       R11 R0 K9 ["LayoutOrder"]
       40 SETTABLEKS                       R11 R10 K9 ["LayoutOrder"]
       42 DUPTABLE                         R11 K17 [{"FillArea", "Version", "HarnessSplitTag", "Expand", "Settings", "DialogWidget"}]
       43 GETUPVAL                         R12 5
       44 GETUPVAL                         R13 6
       45 DUPTABLE                         R14 K19 [{["tag"] = "row align-x-left align-y-center fill gap-xsmall auto-y", ["LayoutOrder"]}]
       46 MOVE                             R15 R1
       47 CALL                             R15 0 1
       48 SETTABLEKS                       R15 R14 K9 ["LayoutOrder"]
       50 DUPTABLE                         R15 K22 [{"ToggleThreadsMenuButton", "AcpSessionIdTag"}]
       51 GETUPVAL                         R16 5
       52 GETUPVAL                         R17 7
       53 DUPTABLE                         R18 K23 [{"LayoutOrder"}]
       54 MOVE                             R19 R1
       55 CALL                             R19 0 1
       56 SETTABLEKS                       R19 R18 K9 ["LayoutOrder"]
       58 CALL                             R16 2 1
       59 SETTABLEKS                       R16 R15 K20 ["ToggleThreadsMenuButton"]
       61 GETUPVAL                         R17 2
       62 GETTABLEKS                       R17 R17 K24 ["FFlagDebugLogAssistantUI"]
       64 JUMPIFNOT                        R17 ; [+9]
       65 GETUPVAL                         R16 5
       66 GETUPVAL                         R17 8
       67 DUPTABLE                         R18 K23 [{"LayoutOrder"}]
       68 MOVE                             R19 R1
       69 CALL                             R19 0 1
       70 SETTABLEKS                       R19 R18 K9 ["LayoutOrder"]
       72 CALL                             R16 2 1
       73 JUMP                             ; [+1]
       74 LOADNIL                          R16
       75 SETTABLEKS                       R16 R15 K21 ["AcpSessionIdTag"]
       77 CALL                             R12 3 1
       78 SETTABLEKS                       R12 R11 K11 ["FillArea"]
       80 GETUPVAL                         R13 2
       81 GETTABLEKS                       R13 R13 K25 ["FFlagAssistantVersionMismatchWarning"]
       83 JUMPIFNOT                        R13 ; [+9]
       84 GETUPVAL                         R12 5
       85 GETUPVAL                         R13 9
       86 DUPTABLE                         R14 K23 [{"LayoutOrder"}]
       87 MOVE                             R15 R1
       88 CALL                             R15 0 1
       89 SETTABLEKS                       R15 R14 K9 ["LayoutOrder"]
       91 CALL                             R12 2 1
       92 JUMP                             ; [+14]
       93 GETUPVAL                         R12 5
       94 GETUPVAL                         R13 10
       95 DUPTABLE                         R14 K28 [{["tag"] = "auto-xy text-caption-small content-muted", ["Text"], ["LayoutOrder"]}]
       96 GETUPVAL                         R15 11
       97 GETTABLEKS                       R15 R15 K29 ["getVersion"]
       99 CALL                             R15 0 1
      100 SETTABLEKS                       R15 R14 K27 ["Text"]
      102 MOVE                             R15 R1
      103 CALL                             R15 0 1
      104 SETTABLEKS                       R15 R14 K9 ["LayoutOrder"]
      106 CALL                             R12 2 1
      107 SETTABLEKS                       R12 R11 K12 ["Version"]
      109 GETUPVAL                         R13 12
      110 CALL                             R13 0 1
      111 JUMPIFNOT                        R13 ; [+25]
      112 GETUPVAL                         R12 5
      113 GETUPVAL                         R13 10
      114 DUPTABLE                         R14 K31 [{["tag"] = "auto-xy text-caption-small content-muted", ["Text"], ["LayoutOrder"], ["testId"]}]
      115 GETUPVAL                         R16 2
      116 GETTABLEKS                       R16 R16 K2 ["FFlagAssistantUseRemoteService"]
      118 JUMPIFNOT                        R16 ; [+2]
      119 LOADK                            R15 K32 ["R"]
      120 JUMP                             ; [+1]
      121 LOADK                            R15 K33 ["ACP"]
      122 SETTABLEKS                       R15 R14 K27 ["Text"]
      124 MOVE                             R15 R1
      125 CALL                             R15 0 1
      126 SETTABLEKS                       R15 R14 K9 ["LayoutOrder"]
      128 GETUPVAL                         R15 13
      129 GETTABLEKS                       R15 R15 K34 ["Header"]
      131 GETTABLEKS                       R15 R15 K13 ["HarnessSplitTag"]
      133 SETTABLEKS                       R15 R14 K30 ["testId"]
      135 CALL                             R12 2 1
      136 JUMP                             ; [+1]
      137 LOADNIL                          R12
      138 SETTABLEKS                       R12 R11 K13 ["HarnessSplitTag"]
      140 GETUPVAL                         R12 5
      141 GETUPVAL                         R13 14
      142 DUPTABLE                         R14 K23 [{"LayoutOrder"}]
      143 MOVE                             R15 R1
      144 CALL                             R15 0 1
      145 SETTABLEKS                       R15 R14 K9 ["LayoutOrder"]
      147 CALL                             R12 2 1
      148 SETTABLEKS                       R12 R11 K14 ["Expand"]
      150 GETUPVAL                         R12 5
      151 GETUPVAL                         R13 15
      152 DUPTABLE                         R14 K37 [{"LayoutOrder", "showIntegrations", "showSettings", "showInternalSettings", "showSkills", "showUsage"}]
      153 MOVE                             R15 R1
      154 CALL                             R15 0 1
      155 SETTABLEKS                       R15 R14 K9 ["LayoutOrder"]
      157 SETTABLEKS                       R3 R14 K0 ["showIntegrations"]
      159 SETTABLEKS                       R5 R14 K35 ["showSettings"]
      161 SETTABLEKS                       R7 R14 K36 ["showInternalSettings"]
      163 SETTABLEKS                       R4 R14 K1 ["showSkills"]
      165 SETTABLEKS                       R6 R14 K4 ["showUsage"]
      167 CALL                             R12 2 1
      168 SETTABLEKS                       R12 R11 K15 ["Settings"]
      170 GETTABLEKS                       R12 R2 K38 ["root"]
      172 SETTABLEKS                       R12 R11 K16 ["DialogWidget"]
      174 CALL                             R8 3 -1
      175 RETURN                           R8 -1
