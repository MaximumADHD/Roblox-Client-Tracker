...
PROTO_3:
       ...
       62 LOADB                            R4 0 +1
       63 LOADB                            R4 1
       64 LOADK                            R6 K11 ["parts must contain at least %* entries"]
       65 LOADN                            R8 2
       66 NAMECALL                         R6 R6 K12 ["format"]
       68 CALL                             R6 2 1
       69 MOVE                             R5 R6
       70 FASTCALL2                        ASSERT R4 R5 ; [+3]
       72 GETIMPORT                        R3 K5 [assert]
       74 CALL                             R3 2 0
       75 GETUPVAL                         R3 0
       76 GETTABLEKS                       R3 R3 K13 ["FIntAssistantSegmentMeshMaxUserParts"]
       78 LENGTH                           R6 R1
       79 JUMPIFLE                         R6 R3 ; [+2]
       81 LOADB                            R5 0 +1
       82 LOADB                            R5 1
       83 LOADK                            R7 K14 ["parts must contain at most %* entries"]
       84 MOVE                             R9 R3
       85 NAMECALL                         R7 R7 K12 ["format"]
       87 CALL                             R7 2 1
       88 MOVE                             R6 R7
       89 FASTCALL2                        ASSERT R5 R6 ; [+3]
       91 GETIMPORT                        R4 K5 [assert]
       93 CALL                             R4 2 0
       94 GETTABLEKS                       R4 R0 K15 ["isManualRun"]
       96 JUMPIFEQKNIL                     R4 ; [+16]
       98 FASTCALL1                        TYPEOF R4 ; [+3]
       99 MOVE                             R8 R4
      100 GETIMPORT                        R7 K1 [typeof]
      102 CALL                             R7 1 1
      103 JUMPIFEQKS                       R7 K16 ["boolean"] ; [+2]
      105 LOADB                            R6 0 +1
      106 LOADB                            R6 1
      107 FASTCALL2K                       ASSERT R6 K17 ; [+4]
      109 LOADK                            R7 K17 ["isManualRun must be a boolean"]
      110 GETIMPORT                        R5 K5 [assert]
      112 CALL                             R5 2 0
      113 GETTABLEKS                       R5 R0 K18 ["selectedInstanceRef"]
      115 LOADNIL                          R6
      116 JUMPIFEQKNIL                     R5 ; [+34]
      118 FASTCALL1                        TYPEOF R5 ; [+3]
      119 MOVE                             R10 R5
      120 GETIMPORT                        R9 K1 [typeof]
      122 CALL                             R9 1 1
      123 JUMPIFEQKS                       R9 K2 ["table"] ; [+2]
      125 LOADB                            R8 0 +1
      126 LOADB                            R8 1
      127 FASTCALL2K                       ASSERT R8 K19 ; [+4]
      129 LOADK                            R9 K19 ["selectedInstanceRef must be a table"]
      130 GETIMPORT                        R7 K5 [assert]
      132 CALL                             R7 2 0
      133 GETTABLEKS                       R10 R5 K20 ["uniqueId"]
      135 FASTCALL1                        TYPEOF R10 ; [+2]
      136 GETIMPORT                        R9 K1 [typeof]
      138 CALL                             R9 1 1
      139 JUMPIFEQKS                       R9 K9 ["string"] ; [+2]
      141 LOADB                            R8 0 +1
      142 LOADB                            R8 1
      143 FASTCALL2K                       ASSERT R8 K21 ; [+4]
      145 LOADK                            R9 K21 ["selectedInstanceRef.uniqueId must be a string"]
      146 GETIMPORT                        R7 K5 [assert]
      148 CALL                             R7 2 0
      149 GETTABLEKS                       R6 R5 K20 ["uniqueId"]
      151 JUMPIFNOTEQKNIL                  R6 ; [+2]
      153 LOADB                            R8 0 +1
      154 LOADB                            R8 1
      155 FASTCALL2K                       ASSERT R8 K22 ; [+4]
      157 LOADK                            R9 K22 ["selectedInstanceRef must be provided — mesh segmentation requires a source MeshPart or Model"]
      158 GETIMPORT                        R7 K5 [assert]
      160 CALL                             R7 2 0
      161 DUPTABLE                         R7 K25 [{"partNames", "isManualRun", "selectedUniqueId"}]
      162 SETTABLEKS                       R1 R7 K23 ["partNames"]
      164 SETTABLEKS                       R4 R7 K15 ["isManualRun"]
      166 SETTABLEKS                       R6 R7 K24 ["selectedUniqueId"]
      168 RETURN                           R7 1
...
PROTO_20:
       ...
       89 GETUPVAL                         R9 5
       90 GETTABLEKS                       R9 R9 K44 ["FFlagAssistantAskInputTool"]
       92 JUMPIFNOT                        R9 ; [+2]
       93 MOVE                             R8 R5
       94 JUMP                             ; [+1]
       95 LOADNIL                          R8
       96 SETTABLEKS                       R8 R7 K39 ["runToolChain"]
       98 GETUPVAL                         R9 5
       99 GETTABLEKS                       R9 R9 K44 ["FFlagAssistantAskInputTool"]
      101 JUMPIFNOT                        R9 ; [+2]
      102 LOADNIL                          R8
      103 JUMP                             ; [+3]
      ...
      107 SETTABLEKS                       R8 R7 K40 ["mapToToolCall"]
      109 NEWCLOSURE                       R8 P5
      110 CAPTURE                          VAL R0
      ...
      116 SETTABLEKS                       R8 R7 K41 ["getInputRequestArguments"]
      118 DUPTABLE                         R8 K49 [{"definition", "slashCommands", "getPreExecuteWarning", "toolCallOptions"}]
      119 SETTABLEKS                       R4 R8 K45 ["definition"]
      121 GETUPVAL                         R10 5
      122 GETTABLEKS                       R10 R10 K50 ["FFlagAssistantSegmentMeshTool"]
      124 JUMPIFNOT                        R10 ; [+6]
      125 NEWTABLE                         R9 0 1
      127 MOVE                             R10 R7
      ...
      130 JUMP                             ; [+1]
      131 LOADNIL                          R9
      132 SETTABLEKS                       R9 R8 K46 ["slashCommands"]
      134 DUPCLOSURE                       R9 K51 [PROTO_19]
      135 SETTABLEKS                       R9 R8 K47 ["getPreExecuteWarning"]
      137 DUPTABLE                         R9 K54 [{["resetTimeoutOnProgress"] = True}]
      138 SETTABLEKS                       R9 R8 K48 ["toolCallOptions"]
      140 CLOSEUPVALS                      R6
      141 RETURN                           R8 1
