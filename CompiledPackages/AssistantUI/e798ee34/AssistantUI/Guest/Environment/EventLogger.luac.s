...
MAIN:
       ...
       22 GETTABLEKS                       R4 R5 K12 ["FFlagAssistantMultipleChatPersistence"]
       24 CALL                             R3 1 1
       25 DUPTABLE                         R4 K45 [{"logUserMessageSent", "logAssistantMessageSent", "logApiKeyAdded", "logErrorEvent", "logExternalAPIError", "logThumbsUp", "logThumbsDown", "logInitialResponseLatency", "logMarkdownError", "logRetry", "logStopGeneration", "logToolStarted", "logToolEnded", "logToolConfirmationShown", "logToolConfirmationResult", "logRequestJourney", "logMeshGenActivated", "logMeshGenCompleted", "logMeshGenPublishedAssets", "logMeshGenMeshInserted", "logPrimitiveGen", "logIntegrationEvent", "logExternalServerConnected", "logThreadCreated", "logThreadRenamed", "logThreadPinnedChanged", "logThreadDeleted", "logThreadDuplicated", "logThreadSwitched", "logPersistenceOperation", "getMessageGuid", "createMessageGuid"}]
       26 DUPCLOSURE                       R5 K46 [PROTO_0]
       27 SETTABLEKS                       R5 R4 K13 ["logUserMessageSent"]
       29 DUPCLOSURE                       R5 K47 [PROTO_1]
       30 SETTABLEKS                       R5 R4 K14 ["logAssistantMessageSent"]
       32 DUPCLOSURE                       R5 K48 [PROTO_2]
       33 SETTABLEKS                       R5 R4 K15 ["logApiKeyAdded"]
       35 DUPCLOSURE                       R5 K49 [PROTO_3]
       36 SETTABLEKS                       R5 R4 K16 ["logErrorEvent"]
       38 DUPCLOSURE                       R5 K50 [PROTO_4]
       39 SETTABLEKS                       R5 R4 K17 ["logExternalAPIError"]
       41 DUPCLOSURE                       R5 K51 [PROTO_5]
       42 SETTABLEKS                       R5 R4 K18 ["logThumbsUp"]
       44 DUPCLOSURE                       R5 K52 [PROTO_6]
       45 SETTABLEKS                       R5 R4 K19 ["logThumbsDown"]
       47 DUPCLOSURE                       R5 K53 [PROTO_7]
       48 SETTABLEKS                       R5 R4 K20 ["logInitialResponseLatency"]
       50 DUPCLOSURE                       R5 K54 [PROTO_8]
       51 SETTABLEKS                       R5 R4 K21 ["logMarkdownError"]
       53 DUPCLOSURE                       R5 K55 [PROTO_9]
       54 SETTABLEKS                       R5 R4 K22 ["logRetry"]
       56 DUPCLOSURE                       R5 K56 [PROTO_10]
       57 SETTABLEKS                       R5 R4 K23 ["logStopGeneration"]
       59 DUPCLOSURE                       R5 K57 [PROTO_11]
       60 SETTABLEKS                       R5 R4 K24 ["logToolStarted"]
       62 DUPCLOSURE                       R5 K58 [PROTO_12]
       63 SETTABLEKS                       R5 R4 K25 ["logToolEnded"]
       65 DUPCLOSURE                       R5 K59 [PROTO_13]
       66 SETTABLEKS                       R5 R4 K26 ["logToolConfirmationShown"]
       68 DUPCLOSURE                       R5 K60 [PROTO_14]
       69 SETTABLEKS                       R5 R4 K27 ["logToolConfirmationResult"]
       71 DUPCLOSURE                       R5 K61 [PROTO_15]
       72 SETTABLEKS                       R5 R4 K28 ["logRequestJourney"]
       74 DUPCLOSURE                       R5 K62 [PROTO_16]
       75 SETTABLEKS                       R5 R4 K29 ["logMeshGenActivated"]
       77 DUPCLOSURE                       R5 K63 [PROTO_17]
       78 SETTABLEKS                       R5 R4 K30 ["logMeshGenCompleted"]
       80 DUPCLOSURE                       R5 K64 [PROTO_18]
       81 SETTABLEKS                       R5 R4 K31 ["logMeshGenPublishedAssets"]
       83 DUPCLOSURE                       R5 K65 [PROTO_19]
       84 SETTABLEKS                       R5 R4 K32 ["logMeshGenMeshInserted"]
       86 DUPCLOSURE                       R5 K66 [PROTO_20]
       87 SETTABLEKS                       R5 R4 K33 ["logPrimitiveGen"]
       89 DUPCLOSURE                       R5 K67 [PROTO_21]
       90 SETTABLEKS                       R5 R4 K34 ["logIntegrationEvent"]
       92 DUPCLOSURE                       R5 K68 [PROTO_22]
       93 SETTABLEKS                       R5 R4 K35 ["logExternalServerConnected"]
       95 DUPCLOSURE                       R5 K69 [PROTO_23]
       96 SETTABLEKS                       R5 R4 K36 ["logThreadCreated"]
       98 DUPCLOSURE                       R5 K70 [PROTO_24]
       99 SETTABLEKS                       R5 R4 K37 ["logThreadRenamed"]
      101 DUPCLOSURE                       R5 K71 [PROTO_25]
      102 SETTABLEKS                       R5 R4 K38 ["logThreadPinnedChanged"]
      104 DUPCLOSURE                       R5 K72 [PROTO_26]
      105 SETTABLEKS                       R5 R4 K39 ["logThreadDeleted"]
      107 DUPCLOSURE                       R5 K73 [PROTO_27]
      108 SETTABLEKS                       R5 R4 K40 ["logThreadDuplicated"]
      110 DUPCLOSURE                       R5 K74 [PROTO_28]
      111 SETTABLEKS                       R5 R4 K41 ["logThreadSwitched"]
      113 DUPCLOSURE                       R5 K75 [PROTO_29]
      114 SETTABLEKS                       R5 R4 K42 ["logPersistenceOperation"]
      116 DUPCLOSURE                       R5 K76 [PROTO_30]
      117 CAPTURE                          VAL R3
      118 CAPTURE                          VAL R1
      119 SETTABLEKS                       R5 R4 K43 ["getMessageGuid"]
      121 DUPCLOSURE                       R5 K77 [PROTO_31]
      122 CAPTURE                          VAL R3
      123 CAPTURE                          VAL R1
      124 SETTABLEKS                       R5 R4 K44 ["createMessageGuid"]
      126 RETURN                           R4 1
