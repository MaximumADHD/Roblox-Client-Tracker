...
PROTO_7:
        ...
        9 LOADNIL                          R4
       10 RETURN                           R4 1
       11 JUMPIFNOTEQKS                    R3 K1 ["inactive"] ; [+12]
       13 GETTABLEKS                       R5 R0 K2 ["_state"]
       15 GETTABLEKS                       R4 R5 K3 ["planModeStateByThread"]
       17 LOADK                            R5 K4 ["active"]
       18 SETTABLE                         R5 R4 R2
       19 GETUPVAL                         R5 0
       20 GETTABLEKS                       R4 R5 K5 ["getEnterPlanSystemReminder"]
       22 CALL                             R4 0 -1
       23 RETURN                           R4 -1
       24 GETUPVAL                         R5 1
       25 GETTABLEKS                       R4 R5 K6 ["assertNever"]
       27 MOVE                             R5 R3
       28 CALL                             R4 1 -1
       29 RETURN                           R4 -1
...
PROTO_8:
        ...
        9 LOADNIL                          R4
       10 RETURN                           R4 1
       11 JUMPIFNOTEQKS                    R3 K4 ["active"] ; [+12]
       13 GETTABLEKS                       R5 R0 K2 ["_state"]
       15 GETTABLEKS                       R4 R5 K3 ["planModeStateByThread"]
       17 LOADK                            R5 K1 ["inactive"]
       18 SETTABLE                         R5 R4 R2
       19 GETUPVAL                         R5 0
       20 GETTABLEKS                       R4 R5 K5 ["getExitPlanSystemReminder"]
       22 CALL                             R4 0 -1
       23 RETURN                           R4 -1
       24 GETUPVAL                         R5 1
       25 GETTABLEKS                       R4 R5 K6 ["assertNever"]
...
MAIN:
       ...
       47 CAPTURE                          VAL R1
       48 SETTABLEKS                       R6 R4 K23 ["getPersistentPlanSystemReminder"]
       50 DUPCLOSURE                       R6 K24 [PROTO_7]
       51 CAPTURE                          VAL R1
       52 CAPTURE                          VAL R3
       53 SETTABLEKS                       R6 R4 K25 ["onStartNewPlan"]
       55 DUPCLOSURE                       R6 K26 [PROTO_8]
       56 CAPTURE                          VAL R1
       57 CAPTURE                          VAL R3
       58 SETTABLEKS                       R6 R4 K27 ["onEndPlan"]
       60 DUPCLOSURE                       R6 K28 [PROTO_9]
       61 CAPTURE                          VAL R3
       62 SETTABLEKS                       R6 R4 K29 ["getPlanModeSystemReminder"]
       64 DUPCLOSURE                       R6 K30 [PROTO_11]
       65 SETTABLEKS                       R6 R4 K31 ["subscribe"]
       67 NEWTABLE                         R6 0 0
       69 DUPCLOSURE                       R7 K32 [PROTO_12]
       70 DUPCLOSURE                       R8 K33 [PROTO_13]
       71 CAPTURE                          VAL R2
       72 CAPTURE                          VAL R4
       73 DUPCLOSURE                       R9 K34 [PROTO_14]
       74 CAPTURE                          VAL R6
       75 CAPTURE                          VAL R8
       76 DUPCLOSURE                       R10 K35 [PROTO_15]
       77 CAPTURE                          VAL R6
       78 CAPTURE                          VAL R8
       79 DUPTABLE                         R11 K39 [{"create", "getRuntime", "getRuntimeForMeta"}]
       80 SETTABLEKS                       R8 R11 K36 ["create"]
       82 SETTABLEKS                       R9 R11 K37 ["getRuntime"]
       84 SETTABLEKS                       R10 R11 K38 ["getRuntimeForMeta"]
       86 RETURN                           R11 1
