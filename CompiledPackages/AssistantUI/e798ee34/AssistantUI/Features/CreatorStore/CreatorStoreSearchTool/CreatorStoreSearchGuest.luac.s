...
PROTO_1:
        0 GETTABLEKS                       R5 R0 K0 ["environment"]
        2 GETTABLEKS                       R4 R5 K1 ["tools"]
        4 GETTABLEKS                       R3 R4 K2 ["marketplaceInsertion"]
        6 GETTABLEKS                       R2 R3 K3 ["getFreeModelsAsync"]
        8 MOVE                             R3 R1
        9 LOADN                            R4 0
       10 CALL                             R2 2 1
       11 NEWTABLE                         R3 0 0
       13 GETTABLEN                        R7 R2 1
       14 GETTABLEKS                       R4 R7 K4 ["Results"]
       16 LOADNIL                          R5
       17 LOADNIL                          R6
       18 FORGPREP                         R4
...
PROTO_4:
       ...
       23 CALL                             R4 2 0
       24 GETUPVAL                         R5 2
       25 GETTABLEKS                       R4 R5 K7 ["setFromAssets"]
       27 MOVE                             R5 R2
       28 MOVE                             R6 R3
       29 CALL                             R4 2 0
       ...
       44 GETUPVAL                         R7 4
       45 GETTABLEKS                       R6 R7 K11 ["toString"]
       47 MOVE                             R7 R4
       48 CALL                             R6 1 -1
       49 RETURN                           R6 -1
...
PROTO_8:
       ...
       43 GETUPVAL                         R6 1
       44 GETTABLEKS                       R5 R6 K14 ["CreatorStoreInsert"]
...
PROTO_9:
        ...
        1 GETUPVAL                         R3 0
        2 GETTABLEKS                       R2 R3 K3 ["CreatorStoreSearch"]
...
PROTO_10:
        ...
        3 CAPTURE                          UPVAL U1
        4 GETUPVAL                         R3 2
        5 GETTABLEKS                       R2 R3 K0 ["define"]
        7 CALL                             R2 0 1
        8 GETUPVAL                         R5 3
        9 GETTABLEKS                       R4 R5 K1 ["CreatorStoreSearch"]
       11 NAMECALL                         R2 R2 K2 ["setName"]
       13 CALL                             R2 2 1
       14 LOADK                            R5 K3 ["Searches the Roblox Creator Store for assets matching the query.\nReturns a unique searchId and a set of objectTypes for use with the "]
       15 GETUPVAL                         R12 3
       16 GETTABLEKS                       R6 R12 K4 ["CreatorStoreInsert"]
       18 LOADK                            R7 K5 [" tool.\n\nIf no objectTypes are found, returns searchId only.\n\nFor example: call "]
       19 GETUPVAL                         R12 3
       20 GETTABLEKS                       R8 R12 K1 ["CreatorStoreSearch"]
       22 LOADK                            R9 K6 [" with query \"lion\". Then choose one or more objectTypes that are semantically\nclose to the user request and pass searchId and optional objectType(s) to the "]
       23 GETUPVAL                         R12 3
       24 GETTABLEKS                       R10 R12 K4 ["CreatorStoreInsert"]
       26 LOADK                            R11 K7 [" tool to insert assets.\n"]
       27 CONCAT                           R4 R5 R11
       28 NAMECALL                         R2 R2 K8 ["setDescription"]
       30 CALL                             R2 2 1
       31 LOADK                            R4 K9 ["query"]
       32 DUPTABLE                         R5 K12 [{"type", "description"}]
       33 LOADK                            R6 K13 ["string"]
       34 SETTABLEKS                       R6 R5 K10 ["type"]
       36 LOADK                            R6 K14 ["The query to search for assets for."]
       37 SETTABLEKS                       R6 R5 K11 ["description"]
       39 NAMECALL                         R2 R2 K15 ["addArgument"]
       41 CALL                             R2 3 1
       42 MOVE                             R4 R1
       43 NAMECALL                         R2 R2 K16 ["setHandler"]
       45 CALL                             R2 2 1
       46 NAMECALL                         R2 R2 K17 ["build"]
       48 CALL                             R2 1 1
       49 DUPTABLE                         R3 K21 [{"command", "getDescription", "mapToToolCall"}]
       50 LOADK                            R4 K22 ["insert"]
       51 SETTABLEKS                       R4 R3 K18 ["command"]
       53 DUPCLOSURE                       R4 K23 [PROTO_7]
       54 CAPTURE                          UPVAL U4
       55 SETTABLEKS                       R4 R3 K19 ["getDescription"]
       57 DUPCLOSURE                       R4 K24 [PROTO_9]
       58 CAPTURE                          UPVAL U3
       59 CAPTURE                          UPVAL U5
       60 SETTABLEKS                       R4 R3 K20 ["mapToToolCall"]
       62 DUPTABLE                         R4 K27 [{"definition", "slashCommands"}]
       63 SETTABLEKS                       R2 R4 K25 ["definition"]
       65 NEWTABLE                         R5 0 1
       67 MOVE                             R6 R3
       68 SETLIST                          R5 R6 1 [1]
       70 SETTABLEKS                       R5 R4 K26 ["slashCommands"]
       72 RETURN                           R4 1
...
MAIN:
       ...
       36 GETTABLEKS                       R8 R0 K16 ["Resources"]
       38 GETTABLEKS                       R7 R8 K17 ["Localization"]
       40 GETTABLEKS                       R6 R7 K18 ["Translator"]
       42 CALL                             R5 1 1
       ...
       58 CALL                             R8 1 1
       59 GETTABLEKS                       R10 R2 K14 ["Util"]
       61 GETTABLEKS                       R9 R10 K22 ["ToolBuilder"]
       63 GETTABLEKS                       R11 R2 K14 ["Util"]
       65 GETTABLEKS                       R10 R11 K23 ["ToolResult"]
