...
PROTO_7:
        0 DUPTABLE                         R2 K2 [{"updateContentHeader", "setPreviewImage"}]
        1 NEWCLOSURE                       R3 P0
        2 CAPTURE                          UPVAL U0
        3 CAPTURE                          VAL R0
        4 CAPTURE                          VAL R1
...
PROTO_8:
       ...
       31 CALL                             R5 3 1
       32 GETUPVAL                         R10 0
       33 GETTABLEKS                       R9 R10 K8 ["setPreviewImage"]
       35 GETUPVAL                         R12 0
...
PROTO_17:
        0 DUPTABLE                         R2 K3 [{"addWorkspaceModelAsync", "selectModel", "listenToLinkChanges"}]
        1 NEWCLOSURE                       R3 P0
        2 CAPTURE                          UPVAL U0
        3 CAPTURE                          VAL R0
        4 CAPTURE                          VAL R1
        ...
        9 CAPTURE                          VAL R0
       10 CAPTURE                          VAL R1
       11 SETTABLEKS                       R3 R2 K1 ["selectModel"]
       13 NEWCLOSURE                       R3 P2
       14 CAPTURE                          UPVAL U2
       15 CAPTURE                          VAL R0
       16 CAPTURE                          VAL R1
       17 SETTABLEKS                       R3 R2 K2 ["listenToLinkChanges"]
       19 RETURN                           R2 1
...
PROTO_18:
        ...
        5 CAPTURE                          VAL R1
        6 GETUPVAL                         R9 0
        7 GETTABLEKS                       R8 R9 K1 ["addWorkspaceModelAsync"]
        9 GETUPVAL                         R11 0
       10 GETTABLE                         R10 R11 R8
       11 LOADK                            R12 K2 ["Invalid network key: "]
       12 MOVE                             R13 R8
       ...
       31 CALL                             R5 3 1
       32 GETUPVAL                         R10 0
       33 GETTABLEKS                       R9 R10 K8 ["selectModel"]
       35 GETUPVAL                         R12 0
       36 GETTABLE                         R11 R12 R9
       37 LOADK                            R13 K2 ["Invalid network key: "]
       38 MOVE                             R14 R9
       ...
       53 CAPTURE                          VAL R0
       54 CAPTURE                          VAL R1
       55 NAMECALL                         R6 R3 K9 ["OnHostEvent"]
       57 CALL                             R6 3 1
       58 GETUPVAL                         R11 0
       59 GETTABLEKS                       R10 R11 K10 ["listenToLinkChanges"]
       61 GETUPVAL                         R13 0
       ...
       79 CAPTURE                          VAL R0
       80 CAPTURE                          VAL R1
       81 NAMECALL                         R7 R3 K9 ["OnHostEvent"]
       83 CALL                             R7 3 1
       84 NEWCLOSURE                       R8 P4
       85 CAPTURE                          VAL R5
       86 CAPTURE                          VAL R6
...
MAIN:
       ...
       20 GETTABLEKS                       R3 R4 K9 ["PrimitiveGenBridgeTypes"]
       22 CALL                             R2 1 1
       23 DUPTABLE                         R3 K15 [{"updateContentHeader", "setPreviewImage", "addWorkspaceModelAsync", "selectModel", "listenToLinkChanges"}]
       24 LOADK                            R4 K10 ["updateContentHeader"]
       25 SETTABLEKS                       R4 R3 K10 ["updateContentHeader"]
       27 LOADK                            R4 K11 ["setPreviewImage"]
       28 SETTABLEKS                       R4 R3 K11 ["setPreviewImage"]
       30 LOADK                            R4 K12 ["addWorkspaceModelAsync"]
       31 SETTABLEKS                       R4 R3 K12 ["addWorkspaceModelAsync"]
       33 LOADK                            R4 K13 ["selectModel"]
       34 SETTABLEKS                       R4 R3 K13 ["selectModel"]
       36 LOADK                            R4 K14 ["listenToLinkChanges"]
       37 SETTABLEKS                       R4 R3 K14 ["listenToLinkChanges"]
       39 DUPCLOSURE                       R4 K16 [PROTO_0]
       40 CAPTURE                          VAL R3
       41 DUPCLOSURE                       R5 K17 [PROTO_1]
       42 DUPCLOSURE                       R6 K18 [PROTO_8]
       43 CAPTURE                          VAL R3
       44 DUPCLOSURE                       R7 K19 [PROTO_9]
