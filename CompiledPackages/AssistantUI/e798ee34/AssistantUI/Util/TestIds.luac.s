...
MAIN:
      ...
      327 DUPTABLE                         R1 K191 [{"StepperPrev", "StepperNext"}]
      328 LOADK                            R2 K192 ["Assistant-QuestionAnswer-StepperPrev"]
      329 SETTABLEKS                       R2 R1 K189 ["StepperPrev"]
      331 LOADK                            R2 K193 ["Assistant-QuestionAnswer-StepperNext"]
      332 SETTABLEKS                       R2 R1 K190 ["StepperNext"]
      334 SETTABLEKS                       R1 R0 K194 ["QuestionAnswer"]
      336 DUPTABLE                         R1 K198 [{"AddIntegrationDialog", "TabContent", "EmptyState"}]
      337 LOADK                            R2 K199 ["Assistant-IntegrationMenu-AddIntegrationDialog"]
      338 SETTABLEKS                       R2 R1 K195 ["AddIntegrationDialog"]
      340 LOADK                            R2 K200 ["Assistant-IntegrationMenu-TabContent"]
      341 SETTABLEKS                       R2 R1 K196 ["TabContent"]
      343 LOADK                            R2 K201 ["Assistant-IntegrationMenu-EmptyState"]
      344 SETTABLEKS                       R2 R1 K197 ["EmptyState"]
      346 SETTABLEKS                       R1 R0 K202 ["IntegrationMenu"]
      348 DUPTABLE                         R1 K207 [{"Dialog", "Header", "ToolsContainer", "ToolPill", "Actions"}]
      349 LOADK                            R2 K208 ["Assistant-IntegrationItem-Dialog"]
      350 SETTABLEKS                       R2 R1 K203 ["Dialog"]
      352 LOADK                            R2 K209 ["Assistant-IntegrationItem-Header"]
      353 SETTABLEKS                       R2 R1 K7 ["Header"]
      355 LOADK                            R2 K210 ["Assistant-IntegrationItem-ToolsContainer"]
      356 SETTABLEKS                       R2 R1 K204 ["ToolsContainer"]
      358 DUPCLOSURE                       R2 K211 [PROTO_0]
      359 SETTABLEKS                       R2 R1 K205 ["ToolPill"]
      361 DUPTABLE                         R2 K215 [{"Toggle", "OverflowButton", "OverflowContent"}]
      362 LOADK                            R3 K216 ["Assistant-IntegrationItem-Actions-Toggle"]
      363 SETTABLEKS                       R3 R2 K212 ["Toggle"]
      365 LOADK                            R3 K217 ["Assistant-IntegrationItem-Actions-OverflowButton"]
      366 SETTABLEKS                       R3 R2 K213 ["OverflowButton"]
      368 LOADK                            R3 K218 ["Assistant-IntegrationItem-Actions-OverflowContent"]
      369 SETTABLEKS                       R3 R2 K214 ["OverflowContent"]
      371 SETTABLEKS                       R2 R1 K206 ["Actions"]
      373 SETTABLEKS                       R1 R0 K219 ["IntegrationItem"]
      375 DUPTABLE                         R1 K224 [{"Toggle", "StartupCommandLabel", "JsonConfigLabel", "StartupCommandCopy", "JsonConfigCopy"}]
      376 LOADK                            R2 K225 ["Assistant-McpSetup-Toggle"]
      377 SETTABLEKS                       R2 R1 K212 ["Toggle"]
      379 LOADK                            R2 K226 ["Assistant-McpSetup-StartupCommandLabel"]
      380 SETTABLEKS                       R2 R1 K220 ["StartupCommandLabel"]
      382 LOADK                            R2 K227 ["Assistant-McpSetup-JsonConfigLabel"]
      383 SETTABLEKS                       R2 R1 K221 ["JsonConfigLabel"]
      385 LOADK                            R2 K228 ["Assistant-McpSetup-StartupCommandCopy"]
      386 SETTABLEKS                       R2 R1 K222 ["StartupCommandCopy"]
      388 LOADK                            R2 K229 ["Assistant-McpSetup-JsonConfigCopy"]
      389 SETTABLEKS                       R2 R1 K223 ["JsonConfigCopy"]
      391 SETTABLEKS                       R1 R0 K230 ["McpSetup"]
      393 DUPCLOSURE                       R1 K231 [PROTO_1]
      394 SETTABLEKS                       R1 R0 K232 ["ProviderCheckbox"]
      396 DUPTABLE                         R1 K237 [{"Display", "EditButton", "Input", "SaveButton", "CancelButton"}]
      397 DUPCLOSURE                       R2 K238 [PROTO_2]
      398 SETTABLEKS                       R2 R1 K233 ["Display"]
      400 DUPCLOSURE                       R2 K239 [PROTO_3]
      401 SETTABLEKS                       R2 R1 K234 ["EditButton"]
      403 DUPCLOSURE                       R2 K240 [PROTO_4]
      404 SETTABLEKS                       R2 R1 K23 ["Input"]
      406 DUPCLOSURE                       R2 K241 [PROTO_5]
      407 SETTABLEKS                       R2 R1 K235 ["SaveButton"]
      409 DUPCLOSURE                       R2 K242 [PROTO_6]
      410 SETTABLEKS                       R2 R1 K236 ["CancelButton"]
      412 SETTABLEKS                       R1 R0 K243 ["APIKey"]
      414 DUPTABLE                         R1 K245 [{"Remove"}]
      415 LOADK                            R2 K246 ["Assistant-AttachedImagePreview-Remove"]
      416 SETTABLEKS                       R2 R1 K244 ["Remove"]
      418 SETTABLEKS                       R1 R0 K247 ["AttachedImagePreview"]
      420 GETIMPORT                        R1 K249 [pcall]
      422 DUPCLOSURE                       R2 K250 [PROTO_7]
      423 CALL                             R1 1 2
      424 JUMPIFNOT                        R1 ; [+8]
      425 NEWTABLE                         R3 0 0
      427 DUPCLOSURE                       R4 K251 [PROTO_8]
      428 CAPTURE                          VAL R4
      429 CAPTURE                          VAL R3
      430 MOVE                             R5 R4
      431 MOVE                             R6 R0
