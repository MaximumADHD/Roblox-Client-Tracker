...
PROTO_3:
        ...
        9 CALL                             R3 1 2
       10 JUMPIF                           R3 ; [+15]
       11 DUPTABLE                         R5 K5 [{"uid", "success", "data"}]
       12 SETTABLEKS                       R1 R5 K2 ["uid"]
       14 LOADB                            R6 0
       15 SETTABLEKS                       R6 R5 K3 ["success"]
       17 FASTCALL1                        TOSTRING R4 ; [+3]
       18 MOVE                             R7 R4
       19 GETIMPORT                        R6 K7 [tostring]
       21 CALL                             R6 1 1
       22 SETTABLEKS                       R6 R5 K4 ["data"]
       24 CLOSEUPVALS                      R2
       25 RETURN                           R5 1
       26 CLOSEUPVALS                      R2
       27 RETURN                           R0 0
...
PROTO_5:
       ...
       25 GETUPVAL                         R4 6
       26 GETTABLEKS                       R3 R4 K7 ["Json"]
       28 GETTABLEKS                       R2 R3 K8 ["encode"]
       30 GETUPVAL                         R3 5
       31 CALL                             R2 1 1
       32 SETUPVAL                         R2 5
       33 GETUPVAL                         R2 7
       ...
       42 CALL                             R2 3 1
       43 JUMPIFNOT                        R2 ; [+24]
       44 GETTABLEKS                       R3 R2 K10 ["success"]
       46 JUMPIF                           R3 ; [+7]
       47 GETIMPORT                        R3 K12 [warn]
       49 LOADK                            R4 K13 ["Error in LLM request:"]
       50 GETTABLEKS                       R5 R2 K14 ["data"]
       52 CALL                             R3 2 0
       53 RETURN                           R0 0
       54 GETTABLEKS                       R3 R2 K14 ["data"]
       56 GETUPVAL                         R4 2
       57 MOVE                             R5 R3
       58 CALL                             R4 1 0
       59 GETUPVAL                         R5 3
       60 GETTABLEKS                       R4 R5 K15 ["isTerminalEventType"]
       62 MOVE                             R5 R3
       63 CALL                             R4 1 1
       64 JUMPIFNOT                        R4 ; [+3]
       65 GETUPVAL                         R4 4
       66 LOADNIL                          R5
       67 SETTABLE                         R5 R4 R0
       68 RETURN                           R0 0
...
MAIN:
       ...
       48 GETTABLEKS                       R7 R8 K17 ["FFlagAssistantDMNetworkIdentity"]
       50 CALL                             R6 1 1
       51 DUPCLOSURE                       R7 K18 [PROTO_8]
       52 CAPTURE                          VAL R3
       53 CAPTURE                          VAL R4
       54 CAPTURE                          VAL R6
       55 RETURN                           R7 1
