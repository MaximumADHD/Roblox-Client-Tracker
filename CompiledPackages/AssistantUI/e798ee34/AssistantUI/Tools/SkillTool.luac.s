...
PROTO_4:
        ...
        2 GETTABLEKS                       R2 R3 K2 ["skill_name"]
        4 ORK                              R1 R2 K0 [""]
        5 NEWCLOSURE                       R2 P0
        6 CAPTURE                          UPVAL U0
        7 CAPTURE                          VAL R1
...
PROTO_5:
        ...
        3 DUPTABLE                         R5 K3 [{"name"}]
        4 GETUPVAL                         R8 1
        5 GETTABLEKS                       R7 R8 K5 ["skillName"]
        7 ORK                              R6 R7 K4 [""]
...
PROTO_7:
        ...
        2 CAPTURE                          UPVAL U1
        3 GETUPVAL                         R3 0
        4 GETTABLEKS                       R2 R3 K1 ["getNames"]
        6 CALL                             R2 0 1
        7 GETIMPORT                        R3 K4 [table.sort]
        9 MOVE                             R4 R2
       10 CALL                             R3 1 0
       11 GETUPVAL                         R4 2
       12 GETTABLEKS                       R3 R4 K5 ["define"]
       14 CALL                             R3 0 1
       ...
       40 CALL                             R3 3 1
       41 MOVE                             R5 R1
       42 NAMECALL                         R3 R3 K19 ["setHandler"]
       44 CALL                             R3 2 1
       45 NAMECALL                         R3 R3 K20 ["build"]
       47 CALL                             R3 1 1
       48 DUPTABLE                         R4 K24 [{"transformInitialContent", "getTransformPreExecuteFn", "getTransformResultFn"}]
       49 DUPCLOSURE                       R5 K25 [PROTO_2]
       50 CAPTURE                          UPVAL U4
       51 CAPTURE                          UPVAL U5
       52 SETTABLEKS                       R5 R4 K21 ["transformInitialContent"]
       54 DUPCLOSURE                       R5 K26 [PROTO_4]
       55 CAPTURE                          UPVAL U5
       56 SETTABLEKS                       R5 R4 K22 ["getTransformPreExecuteFn"]
       58 DUPCLOSURE                       R5 K27 [PROTO_6]
       59 CAPTURE                          UPVAL U5
       60 SETTABLEKS                       R5 R4 K23 ["getTransformResultFn"]
       62 DUPTABLE                         R5 K31 [{"definition", "contentWidgets", "streamTransform"}]
       63 SETTABLEKS                       R3 R5 K28 ["definition"]
       65 NEWTABLE                         R6 0 1
       67 GETUPVAL                         R7 4
       68 SETLIST                          R6 R7 1 [1]
       70 SETTABLEKS                       R6 R5 K29 ["contentWidgets"]
       72 SETTABLEKS                       R4 R5 K30 ["streamTransform"]
       74 RETURN                           R5 1
...
MAIN:
       ...
       16 GETTABLEKS                       R4 R0 K8 ["Skills"]
       18 GETTABLEKS                       R3 R4 K9 ["SkillRegistry"]
       20 CALL                             R2 1 1
       ...
       45 CALL                             R5 1 1
       46 GETTABLEKS                       R7 R1 K18 ["Util"]
       48 GETTABLEKS                       R6 R7 K19 ["ToolBuilder"]
       50 GETTABLEKS                       R8 R1 K18 ["Util"]
       52 GETTABLEKS                       R7 R8 K20 ["ToolResult"]
