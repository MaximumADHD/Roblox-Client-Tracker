...
PROTO_6:
        ...
        5 MOVE                             R2 R1
        6 GETUPVAL                         R3 1
        7 GETTABLEKS                       R3 R3 K0 ["ASSISTANT_PROVIDER_KEYS"]
        9 CALL                             R2 1 0
       10 MOVE                             R2 R1
       11 GETUPVAL                         R3 1
       12 GETTABLEKS                       R3 R3 K1 ["ASSISTANT_PROVIDER_SETTINGS"]
       14 CALL                             R2 1 0
       15 GETUPVAL                         R2 2
       16 GETTABLEKS                       R2 R2 K2 ["current"]
       18 MOVE                             R4 R0
...
PROTO_9:
        ...
        5 FORGPREP                         R1
        6 GETUPVAL                         R6 1
        7 GETTABLEKS                       R6 R6 K0 ["CLAUDE_API_KEY"]
        9 JUMPIFEQ                         R4 R6 ; [+11]
       11 GETUPVAL                         R6 1
       12 GETTABLEKS                       R6 R6 K1 ["GEMINI_API_KEY"]
       14 JUMPIFEQ                         R4 R6 ; [+6]
       16 GETUPVAL                         R6 1
       17 GETTABLEKS                       R6 R6 K2 ["OPENAI_API_KEY"]
       19 JUMPIFNOTEQ                      R4 R6 ; [+2]
       21 SETTABLE                         R5 R0 R4
       22 FORGLOOP                         R1 2 ; [-17]
       24 GETUPVAL                         R1 2
       25 GETTABLEKS                       R1 R1 K3 ["setSecureSettingsAsync"]
       27 GETUPVAL                         R2 1
       28 GETTABLEKS                       R2 R2 K4 ["ASSISTANT_PROVIDER_KEYS"]
       30 MOVE                             R3 R0
       31 CALL                             R1 2 0
       32 RETURN                           R0 0
...
PROTO_12:
        ...
        5 FORGPREP                         R1
        6 GETUPVAL                         R6 1
        7 GETTABLEKS                       R6 R6 K0 ["ANTHROPIC_PROVIDER_ENABLED"]
        9 JUMPIFEQ                         R4 R6 ; [+16]
       11 GETUPVAL                         R6 1
       12 GETTABLEKS                       R6 R6 K1 ["OPENAI_PROVIDER_ENABLED"]
       14 JUMPIFEQ                         R4 R6 ; [+11]
       16 GETUPVAL                         R6 1
       17 GETTABLEKS                       R6 R6 K2 ["GEMINI_PROVIDER_ENABLED"]
       19 JUMPIFEQ                         R4 R6 ; [+6]
       21 GETUPVAL                         R6 1
       22 GETTABLEKS                       R6 R6 K3 ["CURRENT_MODEL"]
       24 JUMPIFNOTEQ                      R4 R6 ; [+2]
       26 SETTABLE                         R5 R0 R4
       27 FORGLOOP                         R1 2 ; [-22]
       29 GETUPVAL                         R1 2
       30 GETTABLEKS                       R1 R1 K4 ["setSecureSettingsAsync"]
       32 GETUPVAL                         R2 1
       33 GETTABLEKS                       R2 R2 K5 ["ASSISTANT_PROVIDER_SETTINGS"]
       35 MOVE                             R3 R0
       36 CALL                             R1 2 0
       37 RETURN                           R0 0
...
PROTO_17:
       ...
       31 CALL                             R3 2 1
       32 GETUPVAL                         R4 0
       33 GETTABLEKS                       R4 R4 K4 ["useCallback"]
       35 NEWCLOSURE                       R5 P2
       36 CAPTURE                          VAL R1
       37 CAPTURE                          UPVAL U3
       38 CAPTURE                          VAL R2
       ...
       41 CALL                             R4 2 1
       42 GETUPVAL                         R5 0
       43 GETTABLEKS                       R5 R5 K4 ["useCallback"]
       45 NEWCLOSURE                       R6 P3
       46 CAPTURE                          VAL R1
       47 CAPTURE                          UPVAL U3
       48 CAPTURE                          VAL R2
       ...
       51 CALL                             R5 2 1
       52 GETUPVAL                         R6 0
       53 GETTABLEKS                       R6 R6 K4 ["useCallback"]
       55 NEWCLOSURE                       R7 P4
       56 CAPTURE                          VAL R1
       57 NEWTABLE                         R8 0 0
       59 CALL                             R6 2 1
       60 GETUPVAL                         R7 0
       61 GETTABLEKS                       R7 R7 K5 ["useMemo"]
       63 NEWCLOSURE                       R8 P5
       64 CAPTURE                          VAL R3
       65 CAPTURE                          VAL R4
       66 CAPTURE                          VAL R5
       ...
       77 GETUPVAL                         R8 4
       78 GETUPVAL                         R9 5
       79 GETTABLEKS                       R9 R9 K6 ["Provider"]
...
MAIN:
       ...
       32 CALL                             R4 1 1
       33 GETTABLEKS                       R5 R2 K12 ["Util"]
       35 GETTABLEKS                       R5 R5 K13 ["Observable"]
