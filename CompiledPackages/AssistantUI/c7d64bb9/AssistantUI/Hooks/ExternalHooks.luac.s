...
PROTO_3:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R2 R2 K0 ["editContent"]
        3 DUPTABLE                         R3 K6 [{"threadId", "messageId", "contentId", "transformFn", "skipIfNoMessage"}]
        4 GETUPVAL                         R4 1
        5 SETTABLEKS                       R4 R3 K1 ["threadId"]
        7 GETUPVAL                         R4 2
        8 SETTABLEKS                       R4 R3 K2 ["messageId"]
       10 GETUPVAL                         R4 3
       11 SETTABLEKS                       R4 R3 K3 ["contentId"]
       13 SETTABLEKS                       R0 R3 K4 ["transformFn"]
       15 JUMPIFNOT                        R1 ; [+3]
       16 GETTABLEKS                       R4 R1 K5 ["skipIfNoMessage"]
       18 JUMP                             ; [+1]
       19 LOADNIL                          R4
       20 SETTABLEKS                       R4 R3 K5 ["skipIfNoMessage"]
       22 CALL                             R2 1 -1
       23 RETURN                           R2 -1
...
PROTO_4:
        ...
        7 CALL                             R2 2 0
        8 GETUPVAL                         R2 1
        9 GETTABLEKS                       R2 R2 K3 ["getContentMetadata"]
       11 MOVE                             R3 R1
       12 CALL                             R2 1 1
       13 GETTABLEKS                       R5 R2 K4 ["type"]
       15 GETUPVAL                         R6 2
       16 GETTABLEKS                       R6 R6 K5 ["Content"]
       18 JUMPIFEQ                         R5 R6 ; [+2]
       20 LOADB                            R4 0 +1
       21 LOADB                            R4 1
       22 LOADK                            R6 K6 ["Content metadata type mismatch (expected %*, got %*)"]
       23 GETUPVAL                         R8 2
       24 GETTABLEKS                       R8 R8 K5 ["Content"]
