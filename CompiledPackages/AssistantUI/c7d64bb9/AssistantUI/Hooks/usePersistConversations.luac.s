...
PROTO_2:
       ...
       30 DUPTABLE                         R3 K7 [{"scope", "threadId"}]
       31 GETUPVAL                         R4 4
       32 GETTABLEKS                       R4 R4 K8 ["Messages"]
...
PROTO_7:
       ...
       99 MOVE                             R4 R0
      100 DUPTABLE                         R5 K20 [{"rawTransformValues"}]
      101 LOADB                            R6 1
      102 SETTABLEKS                       R6 R5 K19 ["rawTransformValues"]
      104 RETURN                           R4 2
...
PROTO_10:
        ...
        3 MOVE                             R1 R0
        4 DUPTABLE                         R2 K2 [{"rawTransformValues"}]
        5 LOADB                            R3 1
        6 SETTABLEKS                       R3 R2 K1 ["rawTransformValues"]
        8 RETURN                           R1 2
...
PROTO_13:
       ...
       84 MOVE                             R3 R0
       85 DUPTABLE                         R4 K10 [{"rawTransformValues"}]
       86 LOADB                            R5 1
       87 SETTABLEKS                       R5 R4 K9 ["rawTransformValues"]
       89 RETURN                           R3 2
...
PROTO_17:
        ...
        6 MOVE                             R3 R1
        7 CALL                             R2 1 1
        8 GETIMPORT                        R3 K2 [next]
       10 GETTABLEKS                       R4 R2 K3 ["threads"]
       12 CALL                             R3 1 1
       13 JUMPIFNOT                        R3 ; [+18]
       14 GETUPVAL                         R3 2
       15 GETTABLEKS                       R3 R3 K4 ["provideSaveData"]
       17 DUPTABLE                         R4 K7 [{"scope", "threads", "metadata"}]
       18 GETUPVAL                         R5 3
       19 GETTABLEKS                       R5 R5 K8 ["Threads"]
       21 SETTABLEKS                       R5 R4 K5 ["scope"]
       23 GETTABLEKS                       R5 R2 K3 ["threads"]
       25 SETTABLEKS                       R5 R4 K3 ["threads"]
       27 GETTABLEKS                       R5 R0 K6 ["metadata"]
       29 SETTABLEKS                       R5 R4 K6 ["metadata"]
       31 CALL                             R3 1 0
       32 GETTABLEKS                       R3 R2 K9 ["messages"]
       34 LOADNIL                          R4
       35 LOADNIL                          R5
       36 FORGPREP                         R3
       37 NEWTABLE                         R8 0 0
       39 GETTABLEKS                       R10 R2 K10 ["contents"]
       ...
       45 LOADNIL                          R12
       46 FORGPREP                         R10
       47 GETIMPORT                        R15 K13 [table.clone]
       49 MOVE                             R16 R14
       50 CALL                             R15 1 1
       51 GETTABLE                         R16 R9 R13
       52 SETTABLEKS                       R16 R15 K10 ["contents"]
       54 SETTABLE                         R15 R8 R13
       55 FORGLOOP                         R10 2 ; [-9]
       57 GETUPVAL                         R10 2
       58 GETTABLEKS                       R10 R10 K4 ["provideSaveData"]
       60 DUPTABLE                         R11 K15 [{"scope", "threadId", "messages", "metadata"}]
       61 GETUPVAL                         R12 3
       62 GETTABLEKS                       R12 R12 K16 ["Messages"]
       64 SETTABLEKS                       R12 R11 K5 ["scope"]
       66 SETTABLEKS                       R6 R11 K14 ["threadId"]
       68 SETTABLEKS                       R8 R11 K9 ["messages"]
       70 GETTABLEKS                       R12 R0 K6 ["metadata"]
       72 SETTABLEKS                       R12 R11 K6 ["metadata"]
       74 CALL                             R10 1 0
       75 FORGLOOP                         R3 2 ; [-39]
       77 RETURN                           R0 0
...
PROTO_20:
        ...
        4 LOADK                            R2 K0 ["FFlagAssistantMultipleChatPersistence must be enabled"]
       ...
       20 CALL                             R3 0 1
       21 GETUPVAL                         R4 1
       22 GETTABLEKS                       R4 R4 K6 ["useEffect"]
       24 NEWCLOSURE                       R5 P0
       25 CAPTURE                          UPVAL U5
       26 CAPTURE                          UPVAL U6
       27 CAPTURE                          VAL R1
       ...
       38 CALL                             R4 2 0
       39 GETUPVAL                         R4 1
       40 GETTABLEKS                       R4 R4 K6 ["useEffect"]
       42 NEWCLOSURE                       R5 P1
       43 CAPTURE                          UPVAL U5
       44 CAPTURE                          VAL R2
...
MAIN:
       ...
       64 GETTABLEKS                       R9 R9 K17 ["clonePath"]
       66 CALL                             R8 1 1
       67 GETIMPORT                        R9 K5 [require]
       69 GETTABLEKS                       R10 R0 K9 ["Util"]
       71 GETTABLEKS                       R10 R10 K10 ["Persistence"]
       73 GETTABLEKS                       R10 R10 K18 ["getDirtyConversationState"]
       75 CALL                             R9 1 1
       76 GETIMPORT                        R10 K5 [require]
       78 GETTABLEKS                       R11 R0 K19 ["Hooks"]
       80 GETTABLEKS                       R11 R11 K20 ["useEditThread"]
       82 CALL                             R10 1 1
       83 GETIMPORT                        R11 K5 [require]
       85 GETTABLEKS                       R12 R0 K21 ["Flags"]
       87 GETTABLEKS                       R12 R12 K22 ["FFlagAssistantMultipleChatPersistence"]
       89 CALL                             R11 1 1
       90 GETTABLEKS                       R12 R7 K23 ["PersistenceLoadStates"]
       92 GETTABLEKS                       R13 R7 K24 ["ScopeTypes"]
       94 DUPCLOSURE                       R14 K25 [PROTO_3]
       95 CAPTURE                          VAL R3
       96 CAPTURE                          VAL R1
       97 CAPTURE                          VAL R6
       98 CAPTURE                          VAL R5
       99 CAPTURE                          VAL R2
      100 CAPTURE                          VAL R13
      101 DUPCLOSURE                       R15 K26 [PROTO_20]
      102 CAPTURE                          VAL R11
      103 CAPTURE                          VAL R3
      104 CAPTURE                          VAL R1
      105 CAPTURE                          VAL R14
