...
PROTO_8:
       ...
       21 CALL                             R7 2 1
       22 SETTABLEKS                       R7 R4 K5 ["bridge"]
       24 GETTABLEKS                       R5 R3 K8 ["generateAnimationAsync"]
       26 MOVE                             R6 R2
       27 MOVE                             R7 R4
       28 CALL                             R5 2 -1
       29 RETURN                           R5 -1
...
PROTO_18:
        0 DUPTABLE                         R2 K6 [{"generateAnimationAndSetupAnimatorAsync", "getSelectedRigRef", "generateAnimationAsync", "setIsPlaying", "setCurrentTime", "setPlaybackSpeed"}]
        1 NEWCLOSURE                       R3 P0
        2 CAPTURE                          UPVAL U0
        3 CAPTURE                          VAL R0
        4 CAPTURE                          VAL R1
       ...
       15 CAPTURE                          VAL R0
       16 CAPTURE                          VAL R1
       17 SETTABLEKS                       R3 R2 K2 ["generateAnimationAsync"]
       19 NEWCLOSURE                       R3 P3
       20 CAPTURE                          UPVAL U3
       21 CAPTURE                          VAL R0
       22 CAPTURE                          VAL R1
...
PROTO_19:
       ...
       57 CALL                             R6 3 1
       58 GETUPVAL                         R10 0
       59 GETTABLEKS                       R10 R10 K9 ["generateAnimationAsync"]
       61 GETUPVAL                         R13 0
...
MAIN:
       ...
       22 CALL                             R2 1 1
       23 DUPTABLE                         R3 K16 [{"generateAnimationAndSetupAnimatorAsync", "getSelectedRigRef", "generateAnimationAsync", "setIsPlaying", "setCurrentTime", "setPlaybackSpeed"}]
       ...
       30 LOADK                            R4 K12 ["generateAnimationAsync"]
       31 SETTABLEKS                       R4 R3 K12 ["generateAnimationAsync"]
