...
PROTO_3:
       ...
       46 CALL                             R11 1 1
       47 GETUPVAL                         R12 0
       48 GETTABLEKS                       R12 R12 K13 ["setPositionOnGround"]
       50 MOVE                             R13 R10
       51 LOADB                            R14 0
...
PROTO_6:
        ...
        9 CALL                             R2 1 0
       10 GETTABLEKS                       R2 R0 K5 ["assetName"]
       12 GETTABLEKS                       R3 R0 K6 ["assetIds"]
       14 LENGTH                           R6 R3
       15 LOADN                            R7 0
       16 JUMPIFLT                         R7 R6 ; [+2]
       18 LOADB                            R5 0 +1
       ...
       22 LOADK                            R6 K7 ["At least one assetId must be provided"]
       23 GETIMPORT                        R4 K9 [assert]
       25 CALL                             R4 2 0
       26 GETUPVAL                         R4 1
       27 LOADB                            R6 0
       28 NAMECALL                         R4 R4 K10 ["GenerateGUID"]
       30 CALL                             R4 2 1
       31 GETTABLEKS                       R5 R1 K11 ["toolArgs"]
       33 GETTABLEKS                       R5 R5 K12 ["environment"]
       35 GETIMPORT                        R6 K15 [table.clone]
       37 MOVE                             R7 R3
       38 CALL                             R6 1 1
       39 GETIMPORT                        R7 K15 [table.clone]
       41 MOVE                             R8 R3
       42 CALL                             R7 1 1
       43 GETIMPORT                        R8 K17 [table.remove]
       45 MOVE                             R9 R7
       46 LOADN                            R10 1
       47 CALL                             R8 2 1
       48 JUMPIF                           R8 ; [+4]
       49 GETIMPORT                        R9 K3 [error]
       51 LOADK                            R10 K18 ["No assetId was provided"]
       52 CALL                             R9 1 0
       53 NEWCLOSURE                       R9 P0
       54 CAPTURE                          UPVAL U2
       55 CAPTURE                          VAL R5
       ...
       64 LOADNIL                          R15
       65 FORGPREP                         R13
       66 GETIMPORT                        R18 K21 [task.spawn]
       68 NEWCLOSURE                       R19 P1
       69 CAPTURE                          UPVAL U2
       70 CAPTURE                          VAL R17
       71 CALL                             R18 1 0
       72 FORGLOOP                         R13 2 ; [-7]
       74 DUPTABLE                         R13 K24 [{"result", "responseInfo"}]
       75 DUPTABLE                         R14 K27 [{"primaryResult", "secondaryResults"}]
       76 DUPTABLE                         R15 K30 [{"assetId", "insertGuid"}]
       77 SETTABLEKS                       R8 R15 K28 ["assetId"]
       79 SETTABLEKS                       R11 R15 K29 ["insertGuid"]
       81 SETTABLEKS                       R15 R14 K25 ["primaryResult"]
       83 SETTABLEKS                       R7 R14 K26 ["secondaryResults"]
       85 SETTABLEKS                       R14 R13 K22 ["result"]
       87 DUPTABLE                         R14 K34 [{"assets", "tag", "assetName", "insertGuid", "className"}]
       88 SETTABLEKS                       R6 R14 K31 ["assets"]
       90 SETTABLEKS                       R10 R14 K32 ["tag"]
       92 SETTABLEKS                       R2 R14 K5 ["assetName"]
       94 SETTABLEKS                       R11 R14 K29 ["insertGuid"]
       96 SETTABLEKS                       R12 R14 K33 ["className"]
       98 SETTABLEKS                       R14 R13 K23 ["responseInfo"]
      100 RETURN                           R13 1
...
MAIN:
       ...
       30 GETTABLEKS                       R5 R5 K13 ["ToolUtils"]
       32 CALL                             R4 1 1
       33 GETIMPORT                        R5 K10 [require]
       35 GETTABLEKS                       R6 R0 K14 ["Resources"]
       37 GETTABLEKS                       R6 R6 K15 ["Localization"]
       39 GETTABLEKS                       R6 R6 K16 ["Translator"]
       41 CALL                             R5 1 1
       ...
       50 GETTABLEKS                       R8 R6 K18 ["CreatorStoreInsertTool"]
       52 GETTABLEKS                       R8 R8 K19 ["CreatorStoreInsertBridgeTypes"]
       54 CALL                             R7 1 1
       55 DUPCLOSURE                       R8 K20 [PROTO_0]
       56 CAPTURE                          VAL R1
       57 DUPCLOSURE                       R9 K21 [PROTO_2]
       58 CAPTURE                          VAL R4
       59 CAPTURE                          VAL R1
       60 CAPTURE                          VAL R5
       61 DUPCLOSURE                       R10 K22 [PROTO_3]
       62 CAPTURE                          VAL R4
       63 CAPTURE                          VAL R1
       64 DUPCLOSURE                       R11 K23 [PROTO_6]
       65 CAPTURE                          VAL R3
       66 CAPTURE                          VAL R2
       67 CAPTURE                          VAL R4
       68 DUPTABLE                         R12 K28 [{"selectInsertedAssets", "listenToLinkChanges", "swapAssetAsync", "insertFromMarketplaceAsync"}]
       69 SETTABLEKS                       R8 R12 K24 ["selectInsertedAssets"]
       71 SETTABLEKS                       R9 R12 K25 ["listenToLinkChanges"]
       73 SETTABLEKS                       R10 R12 K26 ["swapAssetAsync"]
       75 SETTABLEKS                       R11 R12 K27 ["insertFromMarketplaceAsync"]
       77 DUPTABLE                         R13 K30 [{"bridge"}]
       78 SETTABLEKS                       R12 R13 K29 ["bridge"]
       80 RETURN                           R13 1
