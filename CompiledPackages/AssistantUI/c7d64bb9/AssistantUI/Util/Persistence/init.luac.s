...
MAIN:
       ...
       16 GETTABLEKS                       R4 R2 K7 ["PersistenceCoordinator"]
       18 CALL                             R3 1 1
       19 GETIMPORT                        R4 K5 [require]
       21 GETTABLEKS                       R5 R2 K8 ["PersistenceSessionOrchestrator"]
       23 CALL                             R4 1 1
       24 GETTABLEKS                       R5 R1 K9 ["ScopeTypes"]
       26 DUPCLOSURE                       R6 K10 [PROTO_0]
       27 CAPTURE                          VAL R3
       28 DUPCLOSURE                       R7 K11 [PROTO_1]
       29 CAPTURE                          VAL R3
       30 CAPTURE                          VAL R5
       31 DUPCLOSURE                       R8 K12 [PROTO_2]
       32 CAPTURE                          VAL R3
       33 CAPTURE                          VAL R5
       34 DUPTABLE                         R9 K18 [{"create", "getCoordinator", "trackSessions", "loadMoreThreads", "loadOlderMessages"}]
       35 SETTABLEKS                       R6 R9 K13 ["create"]
       37 GETTABLEKS                       R10 R3 K19 ["get"]
       39 SETTABLEKS                       R10 R9 K14 ["getCoordinator"]
       41 GETTABLEKS                       R10 R4 K15 ["trackSessions"]
       43 SETTABLEKS                       R10 R9 K15 ["trackSessions"]
       45 SETTABLEKS                       R7 R9 K16 ["loadMoreThreads"]
       47 SETTABLEKS                       R8 R9 K17 ["loadOlderMessages"]
       49 RETURN                           R9 1
