...
PROTO_24:
      ...
      256 GETUPVAL                         R3 2
      257 LOADK                            R4 K99 ["setupMCPServerAsync"]
      258 CALL                             R3 1 1
      259 SETTABLEKS                       R3 R2 K99 ["setupMCPServerAsync"]
      261 GETUPVAL                         R3 2
      262 LOADK                            R4 K100 ["startStopPlayAsync"]
      263 CALL                             R3 1 1
      264 SETTABLEKS                       R3 R2 K100 ["startStopPlayAsync"]
      266 GETUPVAL                         R3 2
      267 LOADK                            R4 K101 ["subscribeOutput"]
      268 CALL                             R3 1 1
      269 SETTABLEKS                       R3 R2 K101 ["subscribeOutput"]
      271 GETUPVAL                         R3 2
      272 LOADK                            R4 K102 ["subscribeGameLoaded"]
      273 CALL                             R3 1 1
      274 SETTABLEKS                       R3 R2 K102 ["subscribeGameLoaded"]
      276 GETUPVAL                         R3 2
      277 LOADK                            R4 K103 ["subscribeGameStopped"]
      278 CALL                             R3 1 1
      279 SETTABLEKS                       R3 R2 K103 ["subscribeGameStopped"]
      281 GETUPVAL                         R3 2
      282 LOADK                            R4 K104 ["openFileDialogAsync"]
      283 CALL                             R3 1 1
      284 SETTABLEKS                       R3 R2 K104 ["openFileDialogAsync"]
      286 GETUPVAL                         R3 2
      287 LOADK                            R4 K105 ["importFileBinaryAsync"]
      288 CALL                             R3 1 1
      289 SETTABLEKS                       R3 R2 K105 ["importFileBinaryAsync"]
      291 GETUPVAL                         R4 10
      292 CALL                             R4 0 1
      293 JUMPIFNOT                        R4 ; [+5]
      294 GETUPVAL                         R4 11
      295 GETTABLEKS                       R3 R4 K106 ["new"]
      297 CALL                             R3 0 1
      298 JUMP                             ; [+1]
      299 LOADNIL                          R3
      300 SETTABLEKS                       R3 R2 K107 ["conversationPersistence"]
      302 MOVE                             R1 R2
      303 CLOSEUPVALS                      R1
      304 RETURN                           R1 1
...
MAIN:
       ...
       94 DUPCLOSURE                       R15 K27 [PROTO_24]
       95 CAPTURE                          VAL R12
       96 CAPTURE                          VAL R9
       97 CAPTURE                          VAL R14
       98 CAPTURE                          VAL R6
