...
PROTO_33:
       ...
       73 DUPTABLE                         R8 K25 [{"enum", "description"}]
       74 NEWTABLE                         R9 0 3
       76 LOADK                            R10 K26 ["Script"]
       77 LOADK                            R11 K27 ["LocalScript"]
       78 LOADK                            R12 K28 ["ModuleScript"]
       79 SETLIST                          R9 R10 3 [1]
       81 SETTABLEKS                       R9 R8 K24 ["enum"]
       83 LOADK                            R9 K29 ["Filter by script class: \"Script\", \"LocalScript\", or \"ModuleScript\". Only applies to script objects. Case sensitive."]
       84 SETTABLEKS                       R9 R8 K11 ["description"]
       86 NAMECALL                         R5 R5 K18 ["addOptionalArgument"]
       88 CALL                             R5 3 1
       89 LOADK                            R7 K30 ["instance_type"]
       90 DUPTABLE                         R8 K12 [{"type", "description"}]
       91 LOADK                            R9 K13 ["string"]
       92 SETTABLEKS                       R9 R8 K10 ["type"]
       94 LOADK                            R9 K31 ["Filter by Roblox instance type (e.g., \"Part\", \"Frame\", \"Folder\"). Only searches scripts that are descendants of objects matching this type. Case sensitive."]
       95 SETTABLEKS                       R9 R8 K11 ["description"]
       97 NAMECALL                         R5 R5 K18 ["addOptionalArgument"]
       99 CALL                             R5 3 1
      100 LOADK                            R7 K32 ["-i"]
      101 DUPTABLE                         R8 K12 [{"type", "description"}]
      102 LOADK                            R9 K33 ["boolean"]
      103 SETTABLEKS                       R9 R8 K10 ["type"]
      105 LOADK                            R9 K34 ["Case insensitive search. Doesn't affect the behavior of script class or instance type filtering, only pattern matching within files."]
      106 SETTABLEKS                       R9 R8 K11 ["description"]
      108 NAMECALL                         R5 R5 K18 ["addOptionalArgument"]
      110 CALL                             R5 3 1
      111 LOADK                            R7 K35 ["-n"]
      112 DUPTABLE                         R8 K12 [{"type", "description"}]
      113 LOADK                            R9 K33 ["boolean"]
      114 SETTABLEKS                       R9 R8 K10 ["type"]
      116 LOADK                            R9 K36 ["Show line numbers in output. Requires output_mode: \"content\", ignored otherwise."]
      117 SETTABLEKS                       R9 R8 K11 ["description"]
      119 NAMECALL                         R5 R5 K18 ["addOptionalArgument"]
      121 CALL                             R5 3 1
      122 LOADK                            R7 K37 ["-A"]
      123 DUPTABLE                         R8 K12 [{"type", "description"}]
      124 LOADK                            R9 K38 ["number"]
      125 SETTABLEKS                       R9 R8 K10 ["type"]
      127 LOADK                            R9 K39 ["Number of lines to show after each match. Requires output_mode: \"content\", ignored otherwise."]
      128 SETTABLEKS                       R9 R8 K11 ["description"]
      130 NAMECALL                         R5 R5 K18 ["addOptionalArgument"]
      132 CALL                             R5 3 1
      133 LOADK                            R7 K40 ["-B"]
      134 DUPTABLE                         R8 K12 [{"type", "description"}]
      135 LOADK                            R9 K38 ["number"]
      136 SETTABLEKS                       R9 R8 K10 ["type"]
      138 LOADK                            R9 K41 ["Number of lines to show before each match. Requires output_mode: \"content\", ignored otherwise."]
      139 SETTABLEKS                       R9 R8 K11 ["description"]
      141 NAMECALL                         R5 R5 K18 ["addOptionalArgument"]
      143 CALL                             R5 3 1
      144 LOADK                            R7 K42 ["-C"]
      145 DUPTABLE                         R8 K12 [{"type", "description"}]
      146 LOADK                            R9 K38 ["number"]
      147 SETTABLEKS                       R9 R8 K10 ["type"]
      149 LOADK                            R9 K43 ["Number of lines to show before and after each match. Requires output_mode: \"content\", ignored otherwise."]
      150 SETTABLEKS                       R9 R8 K11 ["description"]
      152 NAMECALL                         R5 R5 K18 ["addOptionalArgument"]
      154 CALL                             R5 3 1
      155 LOADK                            R7 K44 ["multiline"]
      156 DUPTABLE                         R8 K12 [{"type", "description"}]
      157 LOADK                            R9 K33 ["boolean"]
      158 SETTABLEKS                       R9 R8 K10 ["type"]
      160 LOADK                            R9 K45 ["Enable multiline mode where . matches newlines and patterns can span lines. Default: false."]
      161 SETTABLEKS                       R9 R8 K11 ["description"]
      163 NAMECALL                         R5 R5 K18 ["addOptionalArgument"]
      165 CALL                             R5 3 1
      166 LOADK                            R7 K46 ["head_limit"]
      167 DUPTABLE                         R8 K12 [{"type", "description"}]
      168 LOADK                            R9 K38 ["number"]
      169 SETTABLEKS                       R9 R8 K10 ["type"]
      171 LOADK                            R9 K47 ["Limit output to first N lines/entries, equivalent to \"| head -N\". Works across all output modes: content (limits output lines), files_with_matches (limits file paths), count (limits count entries). Default: 50."]
      172 SETTABLEKS                       R9 R8 K11 ["description"]
      174 NAMECALL                         R5 R5 K18 ["addOptionalArgument"]
      176 CALL                             R5 3 1
      177 MOVE                             R7 R4
      178 NAMECALL                         R5 R5 K48 ["setHandler"]
      180 CALL                             R5 2 1
      181 NAMECALL                         R5 R5 K49 ["build"]
      183 CALL                             R5 1 1
      184 DUPTABLE                         R6 K51 [{"definition"}]
      185 SETTABLEKS                       R5 R6 K50 ["definition"]
      187 RETURN                           R6 1
