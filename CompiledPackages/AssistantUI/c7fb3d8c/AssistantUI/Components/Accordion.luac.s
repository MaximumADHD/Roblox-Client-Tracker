...
PROTO_6:
       ...
       47 CALL                             R14 0 1
       48 JUMPIFNOT                        R14 ; [+5]
       49 GETTABLEKS                       R14 R0 K14 ["IsDisabled"]
       51 JUMPIFNOT                        R14 ; [+2]
       52 LOADNIL                          R13
       53 JUMP                             ; [+1]
       54 MOVE                             R13 R3
       55 SETTABLEKS                       R13 R12 K10 ["onActivated"]
       57 GETTABLEKS                       R13 R0 K11 ["LayoutOrder"]
       59 SETTABLEKS                       R13 R12 K11 ["LayoutOrder"]
       61 GETTABLEKS                       R13 R0 K12 ["testId"]
       63 SETTABLEKS                       R13 R12 K12 ["testId"]
       65 GETUPVAL                         R15 5
       66 GETTABLEKS                       R14 R15 K15 ["Dictionary"]
       68 GETTABLEKS                       R13 R14 K16 ["join"]
       70 DUPTABLE                         R14 K18 [{"ExpandIcon"}]
       71 GETUPVAL                         R15 2
       72 GETUPVAL                         R16 6
       73 DUPTABLE                         R17 K21 [{"icon", "tag", "iconTag", "LayoutOrder"}]
       74 JUMPIFNOT                        R2 ; [+2]
       75 LOADK                            R18 K22 ["icons/actions/truncationExpand_small"]
       76 JUMP                             ; [+1]
       77 LOADK                            R18 K23 ["icons/actions/cycleRight_small"]
       78 SETTABLEKS                       R18 R17 K19 ["icon"]
       80 SETTABLEKS                       R8 R17 K9 ["tag"]
       82 SETTABLEKS                       R9 R17 K20 ["iconTag"]
       84 LOADN                            R18 255
       85 SETTABLEKS                       R18 R17 K11 ["LayoutOrder"]
       87 CALL                             R15 2 1
       88 SETTABLEKS                       R15 R14 K17 ["ExpandIcon"]
       90 GETTABLEKS                       R15 R0 K24 ["children"]
       92 CALL                             R13 2 -1
       93 CALL                             R10 -1 -1
       94 RETURN                           R10 -1
...
MAIN:
       ...
       56 GETTABLEKS                       R10 R0 K14 ["Flags"]
       58 GETTABLEKS                       R9 R10 K16 ["FFlagMCPAssistantLongRunningToolCalls"]
       60 CALL                             R8 1 1
       61 GETTABLEKS                       R9 R3 K17 ["View"]
       63 GETTABLEKS                       R10 R5 K18 ["createNextOrder"]
       65 GETTABLEKS                       R11 R4 K19 ["createElement"]
       67 GETTABLEKS                       R12 R4 K20 ["createContext"]
       69 DUPTABLE                         R13 K23 [{"isExpanded", "toggleIsExpanded"}]
       70 LOADB                            R14 0
       71 SETTABLEKS                       R14 R13 K21 ["isExpanded"]
       73 DUPCLOSURE                       R14 K24 [PROTO_0]
       74 SETTABLEKS                       R14 R13 K22 ["toggleIsExpanded"]
       76 CALL                             R12 1 1
       77 DUPCLOSURE                       R13 K25 [PROTO_3]
       78 CAPTURE                          VAL R4
       79 CAPTURE                          VAL R7
       80 CAPTURE                          VAL R11
       81 CAPTURE                          VAL R9
       82 CAPTURE                          VAL R12
       83 DUPCLOSURE                       R14 K26 [PROTO_6]
       84 CAPTURE                          VAL R4
       85 CAPTURE                          VAL R12
       86 CAPTURE                          VAL R11
       87 CAPTURE                          VAL R9
       ...
       89 CAPTURE                          VAL R1
       90 CAPTURE                          VAL R2
       91 DUPCLOSURE                       R15 K27 [PROTO_10]
       92 CAPTURE                          VAL R4
       93 CAPTURE                          VAL R12
       94 CAPTURE                          VAL R10
       95 CAPTURE                          VAL R11
       96 CAPTURE                          VAL R9
       97 DUPTABLE                         R16 K31 [{"Root", "Header", "Content"}]
       98 GETTABLEKS                       R17 R4 K32 ["memo"]
      100 MOVE                             R18 R13
      101 CALL                             R17 1 1
      102 SETTABLEKS                       R17 R16 K28 ["Root"]
      104 GETTABLEKS                       R17 R4 K32 ["memo"]
      106 MOVE                             R18 R14
      107 CALL                             R17 1 1
      108 SETTABLEKS                       R17 R16 K29 ["Header"]
      110 GETTABLEKS                       R17 R4 K32 ["memo"]
      112 MOVE                             R18 R15
      113 CALL                             R17 1 1
      114 SETTABLEKS                       R17 R16 K30 ["Content"]
      116 RETURN                           R16 1
