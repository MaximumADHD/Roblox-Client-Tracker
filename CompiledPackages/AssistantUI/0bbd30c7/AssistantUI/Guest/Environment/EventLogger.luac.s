...
MAIN:
       ...
       87 SETTABLEKS                       R3 R2 K56 ["logIntegrationEvent"]
       89 DUPCLOSURE                       R3 K57 [PROTO_25]
       90 SETTABLEKS                       R3 R2 K58 ["logExternalServerConnected"]
       92 DUPCLOSURE                       R3 K59 [PROTO_26]
       93 SETTABLEKS                       R3 R2 K60 ["logQuickSetupToggled"]
       95 DUPCLOSURE                       R3 K61 [PROTO_27]
       96 SETTABLEKS                       R3 R2 K62 ["logQuestionAnswerCompleted"]
       98 DUPCLOSURE                       R3 K63 [PROTO_28]
       99 SETTABLEKS                       R3 R2 K64 ["logPlanDecision"]
      101 DUPCLOSURE                       R3 K65 [PROTO_29]
      102 SETTABLEKS                       R3 R2 K66 ["logThreadCreated"]
      104 DUPCLOSURE                       R3 K67 [PROTO_30]
      105 SETTABLEKS                       R3 R2 K68 ["logThreadRenamed"]
      107 DUPCLOSURE                       R3 K69 [PROTO_31]
      108 SETTABLEKS                       R3 R2 K70 ["logThreadPinnedChanged"]
      110 DUPCLOSURE                       R3 K71 [PROTO_32]
      111 SETTABLEKS                       R3 R2 K72 ["logThreadDeleted"]
      113 DUPCLOSURE                       R3 K73 [PROTO_33]
      114 SETTABLEKS                       R3 R2 K74 ["logThreadDuplicated"]
      116 DUPCLOSURE                       R3 K75 [PROTO_34]
      117 SETTABLEKS                       R3 R2 K76 ["logThreadSwitched"]
      119 DUPCLOSURE                       R3 K77 [PROTO_35]
      120 SETTABLEKS                       R3 R2 K78 ["logPersistenceOperation"]
      122 DUPCLOSURE                       R3 K79 [PROTO_36]
      123 SETTABLEKS                       R3 R2 K80 ["logCompactionSuccess"]
      125 DUPCLOSURE                       R3 K81 [PROTO_37]
      126 SETTABLEKS                       R3 R2 K82 ["logCompactionFallback"]
      128 DUPCLOSURE                       R3 K83 [PROTO_38]
      129 SETTABLEKS                       R3 R2 K84 ["logUserSkillEvent"]
      131 DUPCLOSURE                       R3 K85 [PROTO_39]
      132 SETTABLEKS                       R3 R2 K86 ["logThinkingBlock"]
      134 RETURN                           R2 1
