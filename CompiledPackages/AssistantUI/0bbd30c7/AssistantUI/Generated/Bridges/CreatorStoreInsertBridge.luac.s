PROTO_0:
        ...
        9 CALL                             R1 2 0
       10 LOADK                            R2 K3 ["CreatorStoreInsertTool_%*"]
       11 MOVE                             R4 R0
...
PROTO_6:
        0 DUPTABLE                         R2 K2 [{"updateContentHeader", "toTarget"}]
        1 NEWCLOSURE                       R3 P0
        2 CAPTURE                          UPVAL U0
        3 CAPTURE                          VAL R0
        4 CAPTURE                          VAL R1
...
PROTO_7:
       ...
       14 CALL                             R8 2 0
       15 LOADK                            R7 K5 ["CreatorStoreInsertTool_updateContentHeader"]
       16 NEWCLOSURE                       R8 P1
       17 CAPTURE                          VAL R2
       18 CAPTURE                          VAL R0
       19 CAPTURE                          VAL R1
...
PROTO_10:
       ...
       19 CALL                             R7 2 1
       20 SETTABLEKS                       R7 R4 K5 ["bridge"]
       22 GETTABLEKS                       R5 R3 K8 ["selectInsertedAssets"]
       24 MOVE                             R6 R2
       25 MOVE                             R7 R4
       26 CALL                             R5 2 -1
       27 RETURN                           R5 -1
...
PROTO_12:
       ...
       19 CALL                             R7 2 1
       20 SETTABLEKS                       R7 R4 K5 ["bridge"]
       22 GETTABLEKS                       R5 R3 K8 ["swapAssetAsync"]
       24 MOVE                             R6 R2
       25 MOVE                             R7 R4
       26 CALL                             R5 2 -1
       27 RETURN                           R5 -1
...
PROTO_13:
       ...
       19 CALL                             R7 2 1
       20 SETTABLEKS                       R7 R4 K5 ["bridge"]
       22 GETTABLEKS                       R5 R3 K8 ["insertFromMarketplaceAsync"]
       24 MOVE                             R6 R2
       25 MOVE                             R7 R4
       26 CALL                             R5 2 -1
       27 RETURN                           R5 -1
...
PROTO_19:
        0 DUPTABLE                         R2 K5 [{"selectInsertedAssets", "listenToLinkChanges", "swapAssetAsync", "insertFromMarketplaceAsync", "toTarget"}]
        1 NEWCLOSURE                       R3 P0
        2 CAPTURE                          UPVAL U0
        3 CAPTURE                          VAL R0
        4 CAPTURE                          VAL R1
       ...
       15 CAPTURE                          VAL R0
       16 CAPTURE                          VAL R1
       17 SETTABLEKS                       R3 R2 K2 ["swapAssetAsync"]
       19 NEWCLOSURE                       R3 P3
       20 CAPTURE                          UPVAL U3
       21 CAPTURE                          VAL R0
       22 CAPTURE                          VAL R1
       23 SETTABLEKS                       R3 R2 K3 ["insertFromMarketplaceAsync"]
       25 NEWCLOSURE                       R3 P4
       26 CAPTURE                          UPVAL U4
       27 CAPTURE                          VAL R1
...
PROTO_20:
        ...
        5 CAPTURE                          VAL R1
        6 GETUPVAL                         R10 0
        7 GETTABLEKS                       R9 R10 K1 ["selectInsertedAssets"]
        9 FASTCALL2K                       ASSERT R9 K2 ; [+4]
       11 LOADK                            R10 K2 ["Invalid network key: selectInsertedAssets"]
       12 GETIMPORT                        R8 K4 [assert]
       14 CALL                             R8 2 0
       15 LOADK                            R7 K5 ["CreatorStoreInsertTool_selectInsertedAssets"]
       16 NEWCLOSURE                       R8 P1
       17 CAPTURE                          VAL R2
       18 CAPTURE                          VAL R0
       19 CAPTURE                          VAL R1
       ...
       22 CALL                             R5 3 1
       23 GETUPVAL                         R11 0
       24 GETTABLEKS                       R10 R11 K7 ["listenToLinkChanges"]
       26 FASTCALL2K                       ASSERT R10 K8 ; [+4]
       28 LOADK                            R11 K8 ["Invalid network key: listenToLinkChanges"]
       29 GETIMPORT                        R9 K4 [assert]
       31 CALL                             R9 2 0
       32 LOADK                            R8 K9 ["CreatorStoreInsertTool_listenToLinkChanges"]
       33 NEWCLOSURE                       R9 P2
       34 CAPTURE                          VAL R2
       35 CAPTURE                          VAL R0
       36 CAPTURE                          VAL R1
       ...
       39 CALL                             R6 3 1
       40 GETUPVAL                         R12 0
       41 GETTABLEKS                       R11 R12 K10 ["swapAssetAsync"]
       43 FASTCALL2K                       ASSERT R11 K11 ; [+4]
       45 LOADK                            R12 K11 ["Invalid network key: swapAssetAsync"]
       46 GETIMPORT                        R10 K4 [assert]
       48 CALL                             R10 2 0
       49 LOADK                            R9 K12 ["CreatorStoreInsertTool_swapAssetAsync"]
       50 NEWCLOSURE                       R10 P3
       51 CAPTURE                          VAL R2
       52 CAPTURE                          VAL R0
       53 CAPTURE                          VAL R1
       54 NAMECALL                         R7 R3 K13 ["OnHostInvokeAsync"]
       56 CALL                             R7 3 1
       57 GETUPVAL                         R13 0
       58 GETTABLEKS                       R12 R13 K14 ["insertFromMarketplaceAsync"]
       60 FASTCALL2K                       ASSERT R12 K15 ; [+4]
       62 LOADK                            R13 K15 ["Invalid network key: insertFromMarketplaceAsync"]
       63 GETIMPORT                        R11 K4 [assert]
       65 CALL                             R11 2 0
       66 LOADK                            R10 K16 ["CreatorStoreInsertTool_insertFromMarketplaceAsync"]
       67 NEWCLOSURE                       R11 P4
       68 CAPTURE                          VAL R2
       69 CAPTURE                          VAL R0
       70 CAPTURE                          VAL R1
       71 NAMECALL                         R8 R3 K13 ["OnHostInvokeAsync"]
       73 CALL                             R8 3 1
       74 NEWCLOSURE                       R9 P5
       75 CAPTURE                          VAL R5
       76 CAPTURE                          VAL R6
...
MAIN:
       ...
       11 GETTABLEKS                       R2 R2 K7 ["CreatorStore"]
       13 GETTABLEKS                       R2 R2 K8 ["CreatorStoreInsertTool"]
       15 GETTABLEKS                       R2 R2 K9 ["CreatorStoreInsertBridgeTypes"]
       17 CALL                             R1 1 1
       18 DUPTABLE                         R2 K15 [{["updateContentHeader"] = "updateContentHeader", ["selectInsertedAssets"] = "selectInsertedAssets", ["listenToLinkChanges"] = "listenToLinkChanges", ["swapAssetAsync"] = "swapAssetAsync", ["insertFromMarketplaceAsync"] = "insertFromMarketplaceAsync"}]
       19 DUPCLOSURE                       R3 K16 [PROTO_0]
       20 CAPTURE                          VAL R2
       21 DUPCLOSURE                       R4 K17 [PROTO_1]
       22 DUPCLOSURE                       R5 K18 [PROTO_7]
       23 CAPTURE                          VAL R2
       24 DUPCLOSURE                       R6 K19 [PROTO_8]
       25 DUPCLOSURE                       R7 K20 [PROTO_20]
       26 CAPTURE                          VAL R2
       27 DUPCLOSURE                       R8 K21 [PROTO_25]
       28 CAPTURE                          VAL R5
       29 CAPTURE                          VAL R7
       30 DUPTABLE                         R9 K23 [{"prepareBridges"}]
       31 SETTABLEKS                       R8 R9 K22 ["prepareBridges"]
       33 RETURN                           R9 1
