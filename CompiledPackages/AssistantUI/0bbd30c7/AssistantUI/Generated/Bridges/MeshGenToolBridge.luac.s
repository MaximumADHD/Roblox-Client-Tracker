...
PROTO_4:
       ...
       19 CALL                             R7 2 1
       20 SETTABLEKS                       R7 R4 K5 ["bridge"]
       22 GETTABLEKS                       R5 R3 K8 ["setPreviewStateAsync"]
       24 MOVE                             R6 R2
       25 MOVE                             R7 R4
       26 CALL                             R5 2 -1
       27 RETURN                           R5 -1
...
PROTO_12:
        0 DUPTABLE                         R2 K5 [{"updateContentHeader", "setPreviewStateAsync", "setPreviewImage", "reportGeneratedInstanceDeleted", "toTarget"}]
        1 NEWCLOSURE                       R3 P0
        2 CAPTURE                          UPVAL U0
        3 CAPTURE                          VAL R0
        4 CAPTURE                          VAL R1
       ...
       21 CAPTURE                          VAL R0
       22 CAPTURE                          VAL R1
       23 SETTABLEKS                       R3 R2 K3 ["reportGeneratedInstanceDeleted"]
       25 NEWCLOSURE                       R3 P4
       26 CAPTURE                          UPVAL U4
       27 CAPTURE                          VAL R1
...
PROTO_13:
       ...
       14 CALL                             R8 2 0
       15 LOADK                            R7 K5 ["MeshGenTool_updateContentHeader"]
       16 NEWCLOSURE                       R8 P1
       17 CAPTURE                          VAL R2
       18 CAPTURE                          VAL R0
       19 CAPTURE                          VAL R1
       ...
       22 CALL                             R5 3 1
       23 GETUPVAL                         R11 0
       24 GETTABLEKS                       R10 R11 K7 ["setPreviewStateAsync"]
       26 FASTCALL2K                       ASSERT R10 K8 ; [+4]
       28 LOADK                            R11 K8 ["Invalid network key: setPreviewStateAsync"]
       29 GETIMPORT                        R9 K4 [assert]
       31 CALL                             R9 2 0
       32 LOADK                            R8 K9 ["MeshGenTool_setPreviewStateAsync"]
       33 NEWCLOSURE                       R9 P2
       34 CAPTURE                          VAL R2
       35 CAPTURE                          VAL R0
       36 CAPTURE                          VAL R1
       37 NAMECALL                         R6 R3 K10 ["OnGuestInvokeAsync"]
       39 CALL                             R6 3 1
       40 GETUPVAL                         R12 0
       41 GETTABLEKS                       R11 R12 K11 ["setPreviewImage"]
       43 FASTCALL2K                       ASSERT R11 K12 ; [+4]
       45 LOADK                            R12 K12 ["Invalid network key: setPreviewImage"]
       46 GETIMPORT                        R10 K4 [assert]
       48 CALL                             R10 2 0
       49 LOADK                            R9 K13 ["MeshGenTool_setPreviewImage"]
       ...
       56 CALL                             R7 3 1
       57 GETUPVAL                         R13 0
       58 GETTABLEKS                       R12 R13 K14 ["reportGeneratedInstanceDeleted"]
       60 FASTCALL2K                       ASSERT R12 K15 ; [+4]
       62 LOADK                            R13 K15 ["Invalid network key: reportGeneratedInstanceDeleted"]
       63 GETIMPORT                        R11 K4 [assert]
       65 CALL                             R11 2 0
       66 LOADK                            R10 K16 ["MeshGenTool_reportGeneratedInstanceDeleted"]
       67 NEWCLOSURE                       R11 P4
       68 CAPTURE                          VAL R2
       69 CAPTURE                          VAL R0
       70 CAPTURE                          VAL R1
       71 NAMECALL                         R8 R3 K6 ["OnGuestEvent"]
       73 CALL                             R8 3 1
       74 NEWCLOSURE                       R9 P5
       75 CAPTURE                          VAL R5
       76 CAPTURE                          VAL R6
...
PROTO_21:
       ...
       19 CALL                             R7 2 1
       20 SETTABLEKS                       R7 R4 K5 ["bridge"]
       22 GETTABLEKS                       R5 R3 K8 ["selectLinkedAssets"]
       24 MOVE                             R6 R2
       25 MOVE                             R7 R4
       26 CALL                             R5 2 -1
       27 RETURN                           R5 -1
...
PROTO_37:
        0 DUPTABLE                         R2 K11 [{"generateAssetsAsync", "cancelGenerationAsync", "publishAssetsAsync", "removeSelectedBoundsAsync", "insertAssetsAsync", "selectLinkedAssets", "listenToLinkChanges", "getSelectedBoundingBox", "createViewportBoundingBoxAsync", "destroyViewportBoundingBoxAsync", "toTarget"}]
        1 NEWCLOSURE                       R3 P0
        2 CAPTURE                          UPVAL U0
        3 CAPTURE                          VAL R0
        4 CAPTURE                          VAL R1
       ...
       51 CAPTURE                          VAL R0
       52 CAPTURE                          VAL R1
       53 SETTABLEKS                       R3 R2 K8 ["createViewportBoundingBoxAsync"]
       55 NEWCLOSURE                       R3 P9
       56 CAPTURE                          UPVAL U9
       57 CAPTURE                          VAL R0
       58 CAPTURE                          VAL R1
       59 SETTABLEKS                       R3 R2 K9 ["destroyViewportBoundingBoxAsync"]
...
PROTO_38:
       ...
       12 GETIMPORT                        R8 K4 [assert]
       14 CALL                             R8 2 0
       15 LOADK                            R7 K5 ["MeshGenTool_generateAssetsAsync"]
       16 NEWCLOSURE                       R8 P1
       17 CAPTURE                          VAL R2
       18 CAPTURE                          VAL R0
       19 CAPTURE                          VAL R1
       ...
       29 GETIMPORT                        R9 K4 [assert]
       31 CALL                             R9 2 0
       32 LOADK                            R8 K9 ["MeshGenTool_cancelGenerationAsync"]
       33 NEWCLOSURE                       R9 P2
       34 CAPTURE                          VAL R2
       35 CAPTURE                          VAL R0
       36 CAPTURE                          VAL R1
       ...
       46 GETIMPORT                        R10 K4 [assert]
       48 CALL                             R10 2 0
       49 LOADK                            R9 K12 ["MeshGenTool_publishAssetsAsync"]
       50 NEWCLOSURE                       R10 P3
       51 CAPTURE                          VAL R2
       52 CAPTURE                          VAL R0
       53 CAPTURE                          VAL R1
       ...
       63 GETIMPORT                        R11 K4 [assert]
       65 CALL                             R11 2 0
       66 LOADK                            R10 K15 ["MeshGenTool_removeSelectedBoundsAsync"]
       67 NEWCLOSURE                       R11 P4
       68 CAPTURE                          VAL R2
       69 CAPTURE                          VAL R0
       70 CAPTURE                          VAL R1
       ...
       82 CALL                             R12 2 0
       83 LOADK                            R11 K18 ["MeshGenTool_insertAssetsAsync"]
       ...
       90 CALL                             R9 3 1
       91 GETUPVAL                         R15 0
       92 GETTABLEKS                       R14 R15 K19 ["selectLinkedAssets"]
       94 FASTCALL2K                       ASSERT R14 K20 ; [+4]
       96 LOADK                            R15 K20 ["Invalid network key: selectLinkedAssets"]
       97 GETIMPORT                        R13 K4 [assert]
       99 CALL                             R13 2 0
      100 LOADK                            R12 K21 ["MeshGenTool_selectLinkedAssets"]
      101 NEWCLOSURE                       R13 P6
      102 CAPTURE                          VAL R2
      103 CAPTURE                          VAL R0
      104 CAPTURE                          VAL R1
      105 NAMECALL                         R10 R3 K22 ["OnHostEvent"]
      107 CALL                             R10 3 1
      108 GETUPVAL                         R16 0
      109 GETTABLEKS                       R15 R16 K23 ["listenToLinkChanges"]
      111 FASTCALL2K                       ASSERT R15 K24 ; [+4]
      113 LOADK                            R16 K24 ["Invalid network key: listenToLinkChanges"]
      114 GETIMPORT                        R14 K4 [assert]
      116 CALL                             R14 2 0
      117 LOADK                            R13 K25 ["MeshGenTool_listenToLinkChanges"]
      118 NEWCLOSURE                       R14 P7
      119 CAPTURE                          VAL R2
      120 CAPTURE                          VAL R0
      121 CAPTURE                          VAL R1
      122 NAMECALL                         R11 R3 K22 ["OnHostEvent"]
      124 CALL                             R11 3 1
      125 GETUPVAL                         R17 0
      126 GETTABLEKS                       R16 R17 K26 ["getSelectedBoundingBox"]
      128 FASTCALL2K                       ASSERT R16 K27 ; [+4]
      130 LOADK                            R17 K27 ["Invalid network key: getSelectedBoundingBox"]
      131 GETIMPORT                        R15 K4 [assert]
      133 CALL                             R15 2 0
      134 LOADK                            R14 K28 ["MeshGenTool_getSelectedBoundingBox"]
      ...
      141 CALL                             R12 3 1
      142 GETUPVAL                         R18 0
      143 GETTABLEKS                       R17 R18 K29 ["createViewportBoundingBoxAsync"]
      145 FASTCALL2K                       ASSERT R17 K30 ; [+4]
      147 LOADK                            R18 K30 ["Invalid network key: createViewportBoundingBoxAsync"]
      148 GETIMPORT                        R16 K4 [assert]
      150 CALL                             R16 2 0
      151 LOADK                            R15 K31 ["MeshGenTool_createViewportBoundingBoxAsync"]
      ...
      158 CALL                             R13 3 1
      159 GETUPVAL                         R19 0
      160 GETTABLEKS                       R18 R19 K32 ["destroyViewportBoundingBoxAsync"]
      162 FASTCALL2K                       ASSERT R18 K33 ; [+4]
      164 LOADK                            R19 K33 ["Invalid network key: destroyViewportBoundingBoxAsync"]
      165 GETIMPORT                        R17 K4 [assert]
      167 CALL                             R17 2 0
      168 LOADK                            R16 K34 ["MeshGenTool_destroyViewportBoundingBoxAsync"]
...
PROTO_43:
        ...
        1 DUPCLOSURE                       R4 K3 [PROTO_39]
        2 SETTABLEKS                       R4 R3 K0 ["toGuest"]
        4 DUPCLOSURE                       R4 K4 [PROTO_40]
...
MAIN:
       ...
       11 GETTABLEKS                       R2 R2 K7 ["MeshGen"]
       13 GETTABLEKS                       R2 R2 K8 ["MeshGenTool"]
       15 GETTABLEKS                       R2 R2 K9 ["MeshGenToolBridgeTypes"]
       17 CALL                             R1 1 1
       18 DUPTABLE                         R2 K24 [{["updateContentHeader"] = "updateContentHeader", ["setPreviewStateAsync"] = "setPreviewStateAsync", ["setPreviewImage"] = "setPreviewImage", ["reportGeneratedInstanceDeleted"] = "reportGeneratedInstanceDeleted", ["generateAssetsAsync"] = "generateAssetsAsync", ["cancelGenerationAsync"] = "cancelGenerationAsync", ["publishAssetsAsync"] = "publishAssetsAsync", ["removeSelectedBoundsAsync"] = "removeSelectedBoundsAsync", ["insertAssetsAsync"] = "insertAssetsAsync", ["selectLinkedAssets"] = "selectLinkedAssets", ["listenToLinkChanges"] = "listenToLinkChanges", ["getSelectedBoundingBox"] = "getSelectedBoundingBox", ["createViewportBoundingBoxAsync"] = "createViewportBoundingBoxAsync", ["destroyViewportBoundingBoxAsync"] = "destroyViewportBoundingBoxAsync"}]
       19 DUPCLOSURE                       R3 K25 [PROTO_0]
       20 CAPTURE                          VAL R2
       21 DUPCLOSURE                       R4 K26 [PROTO_1]
       22 DUPCLOSURE                       R5 K27 [PROTO_13]
       23 CAPTURE                          VAL R2
       24 DUPCLOSURE                       R6 K28 [PROTO_14]
       25 DUPCLOSURE                       R7 K29 [PROTO_38]
       26 CAPTURE                          VAL R2
       27 DUPCLOSURE                       R8 K30 [PROTO_43]
       28 CAPTURE                          VAL R5
       29 CAPTURE                          VAL R7
       30 DUPTABLE                         R9 K32 [{"prepareBridges"}]
       31 SETTABLEKS                       R8 R9 K31 ["prepareBridges"]
       33 RETURN                           R9 1
