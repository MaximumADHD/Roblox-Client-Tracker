...
PROTO_2:
       ...
       15 LOADK                            R7 K4 ["[MeshGenSchemaSelector] LLM detected explicit no-segmentation intent for \"%*\""]
       16 MOVE                             R9 R0
       ...
       29 LOADNIL                          R7
       30 FORGPREP                         R5
       31 GETTABLEKS                       R10 R9 K6 ["id"]
       33 JUMPIFNOTEQ                      R10 R2 ; [+28]
       35 GETUPVAL                         R10 3
       36 GETTABLEKS                       R10 R10 K1 ["FFlagDebugLogAssistantUI"]
       38 JUMPIFNOT                        R10 ; [+18]
       39 GETIMPORT                        R10 K3 [print]
       41 LOADK                            R12 K7 ["[MeshGenSchemaSelector] matched schema \"%*\" (%*): %*"]
       42 GETTABLEKS                       R14 R9 K6 ["id"]
       44 GETTABLEKS                       R15 R9 K8 ["name"]
       46 GETIMPORT                        R16 K11 [table.concat]
       48 GETTABLEKS                       R17 R9 K12 ["parts"]
       50 LOADK                            R18 K13 [", "]
       51 CALL                             R16 2 1
       52 NAMECALL                         R12 R12 K5 ["format"]
       54 CALL                             R12 4 1
       55 MOVE                             R11 R12
       56 CALL                             R10 1 0
       57 GETTABLEKS                       R10 R9 K12 ["parts"]
       59 LOADB                            R11 1
       60 LOADB                            R12 0
       61 RETURN                           R10 3
       62 FORGLOOP                         R5 2 ; [-32]
       64 GETUPVAL                         R5 3
       65 GETTABLEKS                       R5 R5 K1 ["FFlagDebugLogAssistantUI"]
       67 JUMPIFNOT                        R5 ; [+9]
       68 GETIMPORT                        R5 K3 [print]
       70 LOADK                            R7 K14 ["[MeshGenSchemaSelector] schema ID \"%*\" not found in table, treating as no match"]
       71 MOVE                             R9 R2
       72 NAMECALL                         R7 R7 K5 ["format"]
       74 CALL                             R7 2 1
       75 MOVE                             R6 R7
       76 CALL                             R5 1 0
       77 GETUPVAL                         R5 3
       78 GETTABLEKS                       R5 R5 K1 ["FFlagDebugLogAssistantUI"]
       80 JUMPIFNOT                        R5 ; [+16]
       81 GETIMPORT                        R5 K3 [print]
       83 LOADK                            R7 K15 ["[MeshGenSchemaSelector] free-form parts: %*"]
       84 JUMPIFNOT                        R3 ; [+6]
       85 GETIMPORT                        R9 K11 [table.concat]
       87 MOVE                             R10 R3
       88 LOADK                            R11 K13 [", "]
       89 CALL                             R9 2 1
       90 JUMP                             ; [+1]
...
PROTO_8:
       ...
       93 CALL                             R6 2 3
       94 GETUPVAL                         R9 5
       95 GETTABLEKS                       R9 R9 K13 ["FFlagAssistantGen3dAutoSegmentation"]
       97 JUMPIFNOT                        R9 ; [+3]
       98 JUMPIFNOT                        R8 ; [+2]
       99 LOADNIL                          R9
      100 RETURN                           R9 1
      ...
      103 LENGTH                           R9 R6
      104 JUMPIFNOTEQKN                    R9 K14 [0] ; [+11]
      106 GETIMPORT                        R9 K8 [error]
      108 LOADK                            R11 K15 ["Auto-segmentation failed: could not derive part names for prompt \"%*\". Retry, or pass segmentation=\"none\", or pass segmentation=\"explicit\" with partNames."]
      109 MOVE                             R13 R2
      110 NAMECALL                         R11 R11 K12 ["format"]
      112 CALL                             R11 2 1
      113 MOVE                             R10 R11
      114 LOADN                            R11 0
      115 CALL                             R9 2 0
