...
PROTO_11:
       ...
       26 LOADK                            R4 K10 ["RBX_Assistant_Channel_%*_%*"]
       27 MOVE                             R6 R0
       28 MOVE                             R7 R1
       ...
       43 CALL                             R3 -1 0
       44 GETIMPORT                        R4 K15 [workspace]
       46 GETTABLEKS                       R4 R4 K16 ["CurrentCamera"]
       48 JUMPIF                           R4 ; [+9]
       49 GETIMPORT                        R4 K15 [workspace]
       51 LOADK                            R6 K16 ["CurrentCamera"]
       52 NAMECALL                         R4 R4 K17 ["GetPropertyChangedSignal"]
       54 CALL                             R4 2 1
       55 NAMECALL                         R4 R4 K18 ["Wait"]
       57 CALL                             R4 1 0
       58 GETIMPORT                        R4 K15 [workspace]
       60 GETTABLEKS                       R4 R4 K16 ["CurrentCamera"]
       62 FASTCALL2K                       ASSERT R4 K19 ; [+5]
       64 MOVE                             R6 R4
       65 LOADK                            R7 K19 ["InstanceChannel requires workspace.CurrentCamera"]
       66 GETIMPORT                        R5 K4 [assert]
       68 CALL                             R5 2 0
       69 MOVE                             R3 R4
       70 SETTABLEKS                       R3 R2 K20 ["Parent"]
       72 GETUPVAL                         R3 1
       73 GETTABLEKS                       R3 R3 K6 ["new"]
       75 MOVE                             R4 R0
       76 MOVE                             R5 R1
       77 MOVE                             R6 R2
       78 CALL                             R3 3 -1
...
MAIN:
       ...
       77 CAPTURE                          VAL R0
       78 CAPTURE                          VAL R6
       79 SETTABLEKS                       R8 R0 K18 ["new"]
       81 DUPCLOSURE                       R8 K37 [PROTO_12]
       82 CAPTURE                          VAL R0
       83 SETTABLEKS                       R8 R0 K38 ["getOrCreate"]
       85 RETURN                           R0 1
