...
PROTO_6:
       ...
       63 GETUPVAL                         R5 5
       64 GETTABLEKS                       R5 R5 K11 ["getThreadMetadata"]
       66 GETTABLEKS                       R6 R1 K12 ["threadId"]
       68 CALL                             R5 1 1
       69 GETTABLEKS                       R6 R5 K13 ["isNewThread"]
       71 JUMPIFNOT                        R6 ; [+25]
       72 LOADK                            R9 K14 ["\n"]
       73 LOADK                            R10 K15 [" "]
       74 NAMECALL                         R7 R3 K16 ["gsub"]
       76 CALL                             R7 3 1
       77 GETUPVAL                         R8 6
       78 MOVE                             R9 R7
       79 GETUPVAL                         R11 7
       80 GETTABLEKS                       R11 R11 K18 ["MAX_THREAD_NAME_LENGTH"]
       82 SUBK                             R10 R11 K17 [3]
       83 CALL                             R8 2 2
       84 JUMPIFNOT                        R9 ; [+3]
       85 MOVE                             R10 R8
       86 LOADK                            R11 K19 ["..."]
       87 CONCAT                           R8 R10 R11
       88 SETTABLEKS                       R8 R1 K20 ["title"]
       90 GETUPVAL                         R10 5
       91 GETTABLEKS                       R10 R10 K21 ["setThreadMetadata"]
       93 GETTABLEKS                       R11 R1 K12 ["threadId"]
       95 LOADNIL                          R12
       96 CALL                             R10 2 0
       97 GETTABLEKS                       R7 R4 K22 ["EventLogger"]
       99 GETTABLEKS                       R7 R7 K23 ["logThreadCreated"]
      101 DUPTABLE                         R8 K30 [{"conversationId", "threadId", "creationReason", "sourceThreadId", "rootThreadId", "titleAtCreate", "namingSource"}]
      102 GETTABLEKS                       R9 R0 K31 ["sessionId"]
      104 SETTABLEKS                       R9 R8 K24 ["conversationId"]
      106 GETTABLEKS                       R9 R1 K12 ["threadId"]
      108 SETTABLEKS                       R9 R8 K12 ["threadId"]
      110 JUMPIFNOT                        R6 ; [+6]
      111 GETUPVAL                         R9 8
      112 GETTABLEKS                       R9 R9 K32 ["ThreadCreationReason"]
      114 GETTABLEKS                       R9 R9 K33 ["New"]
      116 JUMP                             ; [+5]
      117 GETUPVAL                         R9 8
      118 GETTABLEKS                       R9 R9 K32 ["ThreadCreationReason"]
      120 GETTABLEKS                       R9 R9 K34 ["Duplicate"]
      122 SETTABLEKS                       R9 R8 K25 ["creationReason"]
      124 GETTABLEKS                       R9 R1 K35 ["sourceId"]
      126 SETTABLEKS                       R9 R8 K26 ["sourceThreadId"]
      128 GETTABLEKS                       R9 R1 K36 ["rootId"]
      130 SETTABLEKS                       R9 R8 K27 ["rootThreadId"]
      132 GETTABLEKS                       R9 R1 K20 ["title"]
      134 SETTABLEKS                       R9 R8 K28 ["titleAtCreate"]
      136 JUMPIFNOT                        R6 ; [+6]
      137 GETUPVAL                         R9 8
      138 GETTABLEKS                       R9 R9 K37 ["ThreadNamingSource"]
      140 GETTABLEKS                       R9 R9 K38 ["FirstUserMessage"]
      142 JUMP                             ; [+5]
      143 GETUPVAL                         R9 8
      144 GETTABLEKS                       R9 R9 K37 ["ThreadNamingSource"]
      146 GETTABLEKS                       R9 R9 K39 ["DuplicateOrigin"]
      148 SETTABLEKS                       R9 R8 K29 ["namingSource"]
      150 CALL                             R7 1 0
      151 GETUPVAL                         R7 9
      152 NEWTABLE                         R8 0 1
      154 MOVE                             R9 R1
