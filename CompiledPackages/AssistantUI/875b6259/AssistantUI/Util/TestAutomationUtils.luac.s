...
MAIN:
       ...
       14 LOADB                            R7 0
       15 LOADN                            R8 10
       16 GETIMPORT                        R9 K7 [require]
       18 GETTABLEKS                       R10 R0 K8 ["Flags"]
       20 GETTABLEKS                       R10 R10 K9 ["FFlagAssistantVirtualInputEnabled"]
       22 CALL                             R9 1 1
       23 NEWTABLE                         R10 8 0
       ...
       36 CAPTURE                          REF R1
       37 CAPTURE                          VAL R11
       38 SETTABLEKS                       R12 R10 K10 ["setDataModel"]
       40 LOADNIL                          R12
       41 LOADNIL                          R13
       42 NEWCLOSURE                       R14 P2
       43 CAPTURE                          REF R12
       44 CAPTURE                          REF R1
       45 CAPTURE                          REF R8
       46 CAPTURE                          REF R13
       ...
       48 CAPTURE                          REF R12
       49 CAPTURE                          REF R8
       50 NEWCLOSURE                       R16 P4
       51 CAPTURE                          REF R12
       52 CAPTURE                          REF R2
       53 NEWCLOSURE                       R17 P5
       54 CAPTURE                          REF R12
       55 CAPTURE                          REF R13
       56 CAPTURE                          REF R2
       57 DUPCLOSURE                       R18 K11 [PROTO_8]
       58 DUPCLOSURE                       R19 K12 [PROTO_9]
       59 NEWCLOSURE                       R20 P8
       60 CAPTURE                          REF R1
       61 SETTABLEKS                       R20 R10 K13 ["findInstanceByPath"]
       63 DUPCLOSURE                       R20 K14 [PROTO_11]
       64 NEWCLOSURE                       R21 P10
       65 CAPTURE                          REF R4
       66 NEWCLOSURE                       R22 P11
       67 CAPTURE                          REF R4
       68 NEWCLOSURE                       R23 P12
       69 CAPTURE                          REF R4
       70 NEWCLOSURE                       R24 P13
       71 CAPTURE                          REF R4
       72 NEWCLOSURE                       R25 P14
       73 CAPTURE                          REF R4
       74 NEWCLOSURE                       R26 P15
       75 CAPTURE                          VAL R14
       76 CAPTURE                          VAL R9
       77 CAPTURE                          REF R6
       78 CAPTURE                          VAL R10
       ...
       86 CAPTURE                          REF R13
       87 CAPTURE                          VAL R23
       88 SETTABLEKS                       R26 R10 K15 ["mouseInput"]
       90 NEWCLOSURE                       R26 P16
       91 CAPTURE                          VAL R9
       92 CAPTURE                          REF R6
       93 CAPTURE                          REF R4
       94 CAPTURE                          VAL R10
       95 SETTABLEKS                       R26 R10 K16 ["keyboardInput"]
       97 NEWCLOSURE                       R26 P17
       98 CAPTURE                          REF R1
       99 NEWCLOSURE                       R27 P18
      100 CAPTURE                          REF R5
      101 CAPTURE                          REF R1
      102 CAPTURE                          REF R7
      103 NEWCLOSURE                       R28 P19
      104 CAPTURE                          REF R1
      105 CAPTURE                          VAL R10
      106 CAPTURE                          VAL R27
      107 SETTABLEKS                       R28 R10 K17 ["characterNavigation"]
      109 NEWCLOSURE                       R28 P20
      110 CAPTURE                          REF R7
      111 SETTABLEKS                       R28 R10 K18 ["stopCharacterNavigation"]
      113 CLOSEUPVALS                      R1
      114 RETURN                           R10 1
