...
PROTO_3:
        ...
        6 GETUPVAL                         R5 2
        7 GETTABLEKS                       R5 R5 K5 ["targetFile"]
        9 SETTABLEKS                       R5 R4 K1 ["path"]
       11 GETUPVAL                         R5 2
       12 GETTABLEKS                       R5 R5 K2 ["startLine"]
       14 SETTABLEKS                       R5 R4 K2 ["startLine"]
       16 GETUPVAL                         R5 2
       17 GETTABLEKS                       R5 R5 K3 ["endLine"]
...
PROTO_4:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["targetFile"]
        3 JUMPIFNOT                        R0 ; [+5]
        4 GETUPVAL                         R0 0
        5 GETTABLEKS                       R0 R0 K0 ["targetFile"]
        7 JUMPIFNOTEQKS                    R0 K1 [""] ; [+2]
        9 RETURN                           R0 0
       10 GETUPVAL                         R0 1
       11 GETTABLEKS                       R0 R0 K2 ["getNetworking"]
       13 CALL                             R0 0 1
       14 JUMPIF                           R0 ; [+1]
       15 RETURN                           R0 0
...
PROTO_5:
       ...
       32 LOADB                            R5 1
       33 GETUPVAL                         R6 2
       34 GETTABLEKS                       R6 R6 K7 ["useMemo"]
       36 DUPCLOSURE                       R7 K8 [PROTO_2]
       37 CAPTURE                          UPVAL U3
       38 NEWTABLE                         R8 0 1
       40 GETUPVAL                         R9 3
       41 GETTABLEKS                       R9 R9 K9 ["locale"]
      ...
      103 MOVE                             R8 R11
      104 GETUPVAL                         R9 2
      105 GETTABLEKS                       R9 R9 K23 ["useCallback"]
      ...
      150 JUMPIFNOT                        R5 ; [+6]
      151 GETUPVAL                         R17 7
      152 GETTABLEKS                       R17 R17 K12 ["ReadFile"]
      154 GETTABLEKS                       R17 R17 K28 ["Title"]
      156 JUMP                             ; [+1]
      157 LOADNIL                          R17
...
MAIN:
       ...
       39 GETTABLEKS                       R6 R6 K13 ["Serializer"]
       41 GETTABLEKS                       R6 R6 K14 ["SerializerTypes"]
       43 CALL                             R5 1 1
       44 GETIMPORT                        R6 K5 [require]
       46 GETTABLEKS                       R7 R0 K15 ["Components"]
       48 GETTABLEKS                       R7 R7 K16 ["ShimmerGradient"]
       50 CALL                             R6 1 1
       51 GETIMPORT                        R7 K5 [require]
       53 GETTABLEKS                       R8 R0 K12 ["Util"]
       55 GETTABLEKS                       R8 R8 K17 ["TestIds"]
       57 CALL                             R7 1 1
       ...
       76 GETTABLEKS                       R11 R11 K23 ["FFlagAssistantMultipleChatPersistence"]
       78 CALL                             R10 1 1
       79 GETTABLEKS                       R11 R2 K24 ["Text"]
       81 GETTABLEKS                       R12 R2 K25 ["View"]
       83 GETTABLEKS                       R13 R4 K26 ["createNextOrder"]
       85 GETTABLEKS                       R14 R3 K27 ["createElement"]
       87 DUPTABLE                         R15 K29 [{"openScript"}]
       88 LOADK                            R16 K30 ["ReadFileTool_openScript"]
       89 SETTABLEKS                       R16 R15 K28 ["openScript"]
       91 DUPCLOSURE                       R16 K31 [PROTO_0]
       92 DUPCLOSURE                       R17 K32 [PROTO_1]
       93 DUPCLOSURE                       R18 K33 [PROTO_5]
       94 CAPTURE                          VAL R13
       95 CAPTURE                          VAL R1
       96 CAPTURE                          VAL R3
       97 CAPTURE                          VAL R8
      ...
      102 CAPTURE                          VAL R11
      103 CAPTURE                          VAL R6
      104 DUPTABLE                         R19 K36 [{"toMeta", "fromMeta"}]
      105 DUPCLOSURE                       R20 K37 [PROTO_6]
      106 CAPTURE                          VAL R10
      107 SETTABLEKS                       R20 R19 K34 ["toMeta"]
      109 DUPCLOSURE                       R20 K38 [PROTO_7]
      110 CAPTURE                          VAL R10
      111 SETTABLEKS                       R20 R19 K35 ["fromMeta"]
      113 DUPTABLE                         R20 K43 [{"Type", "ContentWidget", "Serialization", "NETWORK_KEYS"}]
      114 LOADK                            R21 K44 ["ReadFile"]
      115 SETTABLEKS                       R21 R20 K39 ["Type"]
      117 GETTABLEKS                       R21 R3 K45 ["memo"]
      119 MOVE                             R22 R18
      120 CALL                             R21 1 1
      121 SETTABLEKS                       R21 R20 K40 ["ContentWidget"]
      123 SETTABLEKS                       R19 R20 K41 ["Serialization"]
      125 SETTABLEKS                       R15 R20 K42 ["NETWORK_KEYS"]
      127 RETURN                           R20 1
