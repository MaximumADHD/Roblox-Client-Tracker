...
PROTO_33:
        0 DUPTABLE                         R2 K10 [{"generateAssetsAsync", "cancelGenerationAsync", "publishAssetsAsync", "removeSelectedBoundsAsync", "insertAssetsAsync", "selectLinkedAssets", "listenToLinkChanges", "getSelectedBoundingBox", "createViewportBoundingBoxAsync", "destroyViewportBoundingBoxAsync"}]
        1 NEWCLOSURE                       R3 P0
        2 CAPTURE                          UPVAL U0
        3 CAPTURE                          VAL R0
        4 CAPTURE                          VAL R1
...
MAIN:
       ...
       22 CALL                             R2 1 1
       23 DUPTABLE                         R3 K23 [{"updateContentHeader", "setPreviewStateAsync", "setPreviewImage", "generateAssetsAsync", "cancelGenerationAsync", "publishAssetsAsync", "removeSelectedBoundsAsync", "insertAssetsAsync", "selectLinkedAssets", "listenToLinkChanges", "getSelectedBoundingBox", "createViewportBoundingBoxAsync", "destroyViewportBoundingBoxAsync"}]
       ...
       57 LOADK                            R4 K21 ["createViewportBoundingBoxAsync"]
       58 SETTABLEKS                       R4 R3 K21 ["createViewportBoundingBoxAsync"]
       60 LOADK                            R4 K22 ["destroyViewportBoundingBoxAsync"]
       61 SETTABLEKS                       R4 R3 K22 ["destroyViewportBoundingBoxAsync"]
       63 DUPCLOSURE                       R4 K24 [PROTO_0]
       64 CAPTURE                          VAL R3
       65 DUPCLOSURE                       R5 K25 [PROTO_1]
       66 DUPCLOSURE                       R6 K26 [PROTO_10]
       67 CAPTURE                          VAL R3
       68 DUPCLOSURE                       R7 K27 [PROTO_11]
       69 DUPCLOSURE                       R8 K28 [PROTO_34]
       70 CAPTURE                          VAL R3
       71 DUPCLOSURE                       R9 K29 [PROTO_35]
       72 CAPTURE                          VAL R1
       73 CAPTURE                          VAL R8
       74 CAPTURE                          VAL R6
       75 DUPTABLE                         R10 K32 [{"prepareBridges", "createGuestContext"}]
       76 SETTABLEKS                       R9 R10 K30 ["prepareBridges"]
       78 SETTABLEKS                       R5 R10 K31 ["createGuestContext"]
       80 RETURN                           R10 1
