...
PROTO_7:
        0 DUPTABLE                         R2 K2 [{"animatorRemoved", "rigSelected"}]
        1 NEWCLOSURE                       R3 P0
        2 CAPTURE                          UPVAL U0
        3 CAPTURE                          VAL R0
        4 CAPTURE                          VAL R1
...
PROTO_23:
        0 DUPTABLE                         R2 K6 [{"generateAndSaveAnimationAsync", "getSelectedRigRef", "setIsPlaying", "setCurrentTime", "setPlaybackSpeed", "publishAnimationAsync"}]
        1 NEWCLOSURE                       R3 P0
        2 CAPTURE                          UPVAL U0
        3 CAPTURE                          VAL R0
        4 CAPTURE                          VAL R1
...
MAIN:
       ...
       22 CALL                             R2 1 1
       23 DUPTABLE                         R3 K18 [{"animatorRemoved", "rigSelected", "generateAndSaveAnimationAsync", "getSelectedRigRef", "setIsPlaying", "setCurrentTime", "setPlaybackSpeed", "publishAnimationAsync"}]
       24 LOADK                            R4 K10 ["animatorRemoved"]
       25 SETTABLEKS                       R4 R3 K10 ["animatorRemoved"]
       27 LOADK                            R4 K11 ["rigSelected"]
       28 SETTABLEKS                       R4 R3 K11 ["rigSelected"]
       30 LOADK                            R4 K12 ["generateAndSaveAnimationAsync"]
       31 SETTABLEKS                       R4 R3 K12 ["generateAndSaveAnimationAsync"]
       33 LOADK                            R4 K13 ["getSelectedRigRef"]
       34 SETTABLEKS                       R4 R3 K13 ["getSelectedRigRef"]
       36 LOADK                            R4 K14 ["setIsPlaying"]
       37 SETTABLEKS                       R4 R3 K14 ["setIsPlaying"]
       39 LOADK                            R4 K15 ["setCurrentTime"]
       40 SETTABLEKS                       R4 R3 K15 ["setCurrentTime"]
       42 LOADK                            R4 K16 ["setPlaybackSpeed"]
       43 SETTABLEKS                       R4 R3 K16 ["setPlaybackSpeed"]
       45 LOADK                            R4 K17 ["publishAnimationAsync"]
       46 SETTABLEKS                       R4 R3 K17 ["publishAnimationAsync"]
       48 DUPCLOSURE                       R4 K19 [PROTO_0]
       49 CAPTURE                          VAL R3
       50 DUPCLOSURE                       R5 K20 [PROTO_1]
       51 DUPCLOSURE                       R6 K21 [PROTO_8]
       52 CAPTURE                          VAL R3
       53 DUPCLOSURE                       R7 K22 [PROTO_9]
       54 DUPCLOSURE                       R8 K23 [PROTO_24]
       55 CAPTURE                          VAL R3
       56 DUPCLOSURE                       R9 K24 [PROTO_25]
       57 CAPTURE                          VAL R1
       58 CAPTURE                          VAL R8
       59 CAPTURE                          VAL R6
       60 DUPTABLE                         R10 K27 [{"prepareBridges", "createGuestContext"}]
       61 SETTABLEKS                       R9 R10 K25 ["prepareBridges"]
       63 SETTABLEKS                       R5 R10 K26 ["createGuestContext"]
       65 RETURN                           R10 1
