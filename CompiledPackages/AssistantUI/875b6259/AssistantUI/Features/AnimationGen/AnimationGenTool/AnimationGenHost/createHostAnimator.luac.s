...
PROTO_8:
       ...
       40 GETUPVAL                         R2 0
       41 DUPTABLE                         R3 K8 [{"isPlaying", "currentTime", "playbackSpeed", "loadedAnimation", "renderSteppedConnection"}]
       42 LOADB                            R4 0
       ...
       51 LOADNIL                          R4
       52 SETTABLEKS                       R4 R3 K0 ["loadedAnimation"]
       54 LOADNIL                          R4
       55 SETTABLEKS                       R4 R3 K4 ["renderSteppedConnection"]
       57 SETTABLE                         R3 R2 R0
       58 RETURN                           R0 0
...
PROTO_13:
        0 GETTABLEKS                       R1 R0 K0 ["handlerArgs"]
       ...
       44 GETUPVAL                         R3 0
       45 DUPTABLE                         R4 K10 [{"isPlaying", "currentTime", "playbackSpeed", "loadedAnimation", "renderSteppedConnection"}]
       46 LOADB                            R5 0
       47 SETTABLEKS                       R5 R4 K7 ["isPlaying"]
       49 LOADN                            R5 0
       50 SETTABLEKS                       R5 R4 K8 ["currentTime"]
       52 LOADN                            R5 1
       53 SETTABLEKS                       R5 R4 K9 ["playbackSpeed"]
       55 LOADNIL                          R5
       56 SETTABLEKS                       R5 R4 K2 ["loadedAnimation"]
       58 LOADNIL                          R5
       59 SETTABLEKS                       R5 R4 K6 ["renderSteppedConnection"]
       61 SETTABLE                         R4 R3 R1
       62 GETUPVAL                         R3 2
       63 GETTABLE                         R2 R3 R1
       64 GETUPVAL                         R3 3
       65 JUMPIFEQKNIL                     R3 ; [+5]
       67 GETUPVAL                         R3 3
       68 NAMECALL                         R3 R3 K4 ["Disconnect"]
       70 CALL                             R3 1 0
       71 GETUPVAL                         R3 4
       72 NEWCLOSURE                       R5 P0
       73 CAPTURE                          UPVAL U5
       ...
       77 CAPTURE                          UPVAL U1
       78 CAPTURE                          VAL R0
       79 NAMECALL                         R3 R3 K11 ["Connect"]
       81 CALL                             R3 2 1
       82 SETUPVAL                         R3 3
       83 RETURN                           R0 0

PROTO_14:
        0 GETTABLEKS                       R2 R1 K0 ["handlerArgs"]
