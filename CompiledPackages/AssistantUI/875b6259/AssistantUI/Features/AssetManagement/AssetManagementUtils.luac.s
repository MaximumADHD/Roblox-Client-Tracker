...
PROTO_5:
       ...
       10 JUMPIF                           R5 ; [+16]
       11 LOADB                            R7 0
       12 DUPTABLE                         R8 K5 [{"Success", "StatusCode", "Body"}]
       13 LOADB                            R9 0
       14 SETTABLEKS                       R9 R8 K2 ["Success"]
       16 LOADN                            R9 0
       17 SETTABLEKS                       R9 R8 K3 ["StatusCode"]
       19 FASTCALL1                        TOSTRING R6 ; [+3]
       20 MOVE                             R10 R6
       21 GETIMPORT                        R9 K7 [tostring]
       23 CALL                             R9 1 1
       24 SETTABLEKS                       R9 R8 K4 ["Body"]
       26 RETURN                           R7 2
       27 LOADB                            R7 1
       28 MOVE                             R8 R6
       29 RETURN                           R7 2
...
MAIN:
       ...
       24 GETTABLEKS                       R4 R4 K13 ["FFlagDebugLogAssistantUI"]
       26 CALL                             R3 1 1
       27 DUPCLOSURE                       R4 K14 [PROTO_0]
       28 CAPTURE                          VAL R3
       29 DUPCLOSURE                       R5 K15 [PROTO_1]
       30 CAPTURE                          VAL R0
       31 DUPCLOSURE                       R6 K16 [PROTO_5]
       32 CAPTURE                          VAL R2
       33 DUPCLOSURE                       R7 K17 [PROTO_6]
       34 DUPTABLE                         R8 K22 [{"getBaseDomain", "isPackageAsset", "requestInternal", "debugPrint"}]
       35 SETTABLEKS                       R5 R8 K18 ["getBaseDomain"]
       37 SETTABLEKS                       R7 R8 K19 ["isPackageAsset"]
       39 SETTABLEKS                       R6 R8 K20 ["requestInternal"]
       41 SETTABLEKS                       R4 R8 K21 ["debugPrint"]
       43 RETURN                           R8 1
