...
PROTO_19:
        0 DUPTABLE                         R2 K4 [{"addWorkspaceModelAsync", "pingAssetDmAsync", "selectModel", "listenToLinkChanges"}]
        1 NEWCLOSURE                       R3 P0
        2 CAPTURE                          UPVAL U0
        3 CAPTURE                          VAL R0
        4 CAPTURE                          VAL R1
...
MAIN:
       ...
       22 CALL                             R2 1 1
       23 DUPTABLE                         R3 K16 [{"updateContentHeader", "setPreviewImage", "addWorkspaceModelAsync", "pingAssetDmAsync", "selectModel", "listenToLinkChanges"}]
       ...
       33 LOADK                            R4 K13 ["pingAssetDmAsync"]
       34 SETTABLEKS                       R4 R3 K13 ["pingAssetDmAsync"]
       36 LOADK                            R4 K14 ["selectModel"]
       37 SETTABLEKS                       R4 R3 K14 ["selectModel"]
       39 LOADK                            R4 K15 ["listenToLinkChanges"]
       40 SETTABLEKS                       R4 R3 K15 ["listenToLinkChanges"]
       42 DUPCLOSURE                       R4 K17 [PROTO_0]
       43 CAPTURE                          VAL R3
       44 DUPCLOSURE                       R5 K18 [PROTO_1]
       45 DUPCLOSURE                       R6 K19 [PROTO_8]
       46 CAPTURE                          VAL R3
       47 DUPCLOSURE                       R7 K20 [PROTO_9]
       48 DUPCLOSURE                       R8 K21 [PROTO_20]
       49 CAPTURE                          VAL R3
       50 DUPCLOSURE                       R9 K22 [PROTO_21]
       51 CAPTURE                          VAL R1
       52 CAPTURE                          VAL R8
       53 CAPTURE                          VAL R6
       54 DUPTABLE                         R10 K25 [{"prepareBridges", "createGuestContext"}]
       55 SETTABLEKS                       R9 R10 K23 ["prepareBridges"]
       57 SETTABLEKS                       R5 R10 K24 ["createGuestContext"]
       59 RETURN                           R10 1
