...
MAIN:
       ...
       63 NEWTABLE                         R11 0 2
       65 DUPTABLE                         R12 K27 [{"base", "description", "validate"}]
       66 SETTABLEKS                       R10 R12 K24 ["base"]
       68 LOADK                            R13 K28 ["Roblox Engine API docs — URLs must end with .md or be llms.txt"]
       69 SETTABLEKS                       R13 R12 K25 ["description"]
       71 DUPCLOSURE                       R13 K29 [PROTO_0]
       72 SETTABLEKS                       R13 R12 K26 ["validate"]
       74 DUPTABLE                         R13 K27 [{"base", "description", "validate"}]
       75 LOADK                            R14 K30 ["https://create.roblox.com/docs/cloud"]
       76 SETTABLEKS                       R14 R13 K24 ["base"]
       78 LOADK                            R14 K31 ["Roblox Cloud API docs — URLs must end with .md or be llms.txt"]
       79 SETTABLEKS                       R14 R13 K25 ["description"]
       81 DUPCLOSURE                       R14 K32 [PROTO_1]
       82 SETTABLEKS                       R14 R13 K26 ["validate"]
       84 SETLIST                          R11 R12 2 [1]
       86 DUPCLOSURE                       R12 K33 [PROTO_2]
       87 CAPTURE                          VAL R11
       88 DUPCLOSURE                       R13 K34 [PROTO_3]
       89 CAPTURE                          VAL R11
       90 DUPCLOSURE                       R14 K35 [PROTO_4]
       91 DUPCLOSURE                       R15 K36 [PROTO_5]
       92 CAPTURE                          VAL R14
       93 DUPCLOSURE                       R16 K37 [PROTO_14]
       94 CAPTURE                          VAL R12
       95 CAPTURE                          VAL R13
       96 CAPTURE                          VAL R8
       97 CAPTURE                          VAL R15
