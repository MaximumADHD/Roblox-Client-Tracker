...
PROTO_3:
       ...
       36 CALL                             R4 2 1
       37 DUPTABLE                         R6 K15 [{"title", "readOnlyHint", "destructiveHint", "idempotentHint", "openWorldHint"}]
       38 LOADK                            R7 K16 ["Wait For Multi-Player Agents Communication"]
       39 SETTABLEKS                       R7 R6 K10 ["title"]
       41 LOADB                            R7 1
       42 SETTABLEKS                       R7 R6 K11 ["readOnlyHint"]
       44 LOADB                            R7 0
       45 SETTABLEKS                       R7 R6 K12 ["destructiveHint"]
       47 LOADB                            R7 0
       48 SETTABLEKS                       R7 R6 K13 ["idempotentHint"]
       50 LOADB                            R7 0
       51 SETTABLEKS                       R7 R6 K14 ["openWorldHint"]
       53 NAMECALL                         R4 R4 K17 ["setAnnotations"]
       55 CALL                             R4 2 1
       56 MOVE                             R6 R3
       57 NAMECALL                         R4 R4 K18 ["setHandler"]
       59 CALL                             R4 2 1
       60 NAMECALL                         R4 R4 K19 ["build"]
       62 CALL                             R4 1 1
       63 DUPTABLE                         R5 K22 [{"definition", "displayNameFunction"}]
       64 SETTABLEKS                       R4 R5 K20 ["definition"]
       66 GETUPVAL                         R7 8
       67 CALL                             R7 0 1
       68 JUMPIFNOT                        R7 ; [+2]
       69 LOADNIL                          R6
       70 JUMP                             ; [+2]
       71 DUPCLOSURE                       R6 K23 [PROTO_2]
       72 CAPTURE                          UPVAL U9
       73 SETTABLEKS                       R6 R5 K21 ["displayNameFunction"]
       75 RETURN                           R5 1
