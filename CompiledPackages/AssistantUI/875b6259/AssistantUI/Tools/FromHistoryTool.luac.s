...
PROTO_10:
       ...
       33 LOADK                            R7 K11 ["The type of data to retrieve: \"{ToolNames.ReadFile}\" (previously read script content), \"{ToolNames.GrepSearch}\" (previous grep/search results), \"{ToolNames.InspectInstance}\" (previous instance inspection), \"{ToolNames.GameTree}\" (previously explored game hierarchy), or \"plan_mode\" (previously created plan content)."]
       34 CALL                             R6 1 1
       ...
       48 LOADK                            R7 K14 ["The key to look up: script path (for {ToolNames.ReadFile}/{ToolNames.InspectInstance}), search query (for {ToolNames.GrepSearch}), root path like \"game\" or \"Workspace\" (for {ToolNames.GameTree}), or plan ID (for plan_mode)."]
       49 CALL                             R6 1 1
       ...
       82 DUPCLOSURE                       R4 K28 [PROTO_7]
       83 CAPTURE                          UPVAL U8
       84 CAPTURE                          UPVAL U9
       85 SETTABLEKS                       R4 R3 K25 ["transformInitialContent"]
       87 DUPCLOSURE                       R4 K29 [PROTO_9]
       88 CAPTURE                          UPVAL U9
      ...
      104 SETTABLEKS                       R5 R4 K31 ["contentWidgets"]
      106 GETUPVAL                         R6 10
      107 CALL                             R6 0 1
      108 JUMPIFNOT                        R6 ; [+2]
      109 LOADNIL                          R5
      110 JUMP                             ; [+1]
      111 MOVE                             R5 R3
      112 SETTABLEKS                       R5 R4 K32 ["streamTransform"]
      114 RETURN                           R4 1
...
MAIN:
       ...
       69 GETTABLEKS                       R11 R11 K24 ["FFlagAssistantMarkdownPlanMode"]
       71 CALL                             R10 1 1
       72 GETIMPORT                        R11 K5 [require]
       74 GETTABLEKS                       R12 R0 K23 ["Flags"]
       76 GETTABLEKS                       R12 R12 K25 ["FFlagAssistantSplitToolsAndWidgets"]
       78 CALL                             R11 1 1
       79 GETIMPORT                        R12 K5 [require]
       81 GETTABLEKS                       R13 R0 K23 ["Flags"]
       83 GETTABLEKS                       R13 R13 K26 ["FIntFromHistoryMaxResultChars"]
       85 CALL                             R12 1 1
       86 NEWTABLE                         R13 4 0
       88 GETTABLEKS                       R14 R9 K27 ["ReadFile"]
       90 DUPCLOSURE                       R15 K28 [PROTO_0]
       91 CAPTURE                          VAL R1
       92 SETTABLE                         R15 R13 R14
       93 GETTABLEKS                       R14 R9 K29 ["GrepSearch"]
       95 DUPCLOSURE                       R15 K30 [PROTO_1]
       96 CAPTURE                          VAL R1
       97 SETTABLE                         R15 R13 R14
       98 GETTABLEKS                       R14 R9 K31 ["InspectInstance"]
      100 DUPCLOSURE                       R15 K32 [PROTO_2]
      101 CAPTURE                          VAL R1
      102 SETTABLE                         R15 R13 R14
      103 GETTABLEKS                       R14 R9 K33 ["GameTree"]
      105 DUPCLOSURE                       R15 K34 [PROTO_3]
      106 CAPTURE                          VAL R1
      107 SETTABLE                         R15 R13 R14
      108 MOVE                             R14 R10
      109 CALL                             R14 0 1
      110 JUMPIFNOT                        R14 ; [+4]
      111 DUPCLOSURE                       R14 K35 [PROTO_4]
      112 CAPTURE                          VAL R1
      113 SETTABLEKS                       R14 R13 K36 ["plan_mode"]
      115 DUPCLOSURE                       R14 K37 [PROTO_5]
      116 CAPTURE                          VAL R13
      117 DUPCLOSURE                       R15 K38 [PROTO_10]
      118 CAPTURE                          VAL R1
      119 CAPTURE                          VAL R8
      120 CAPTURE                          VAL R14
      121 CAPTURE                          VAL R13
