...
PROTO_4:
      ...
      102 CALL                             R9 0 1
      103 GETUPVAL                         R11 3
      104 GETTABLEKS                       R11 R11 K23 ["encode"]
      106 MOVE                             R12 R8
      107 CALL                             R11 1 -1
      ...
      122 CALL                             R8 1 0
      123 GETUPVAL                         R8 0
      124 GETTABLEKS                       R8 R8 K3 ["getJob"]
      126 MOVE                             R9 R3
      127 CALL                             R8 1 1
      128 MOVE                             R5 R8
      129 JUMPIF                           R5 ; [+19]
...
PROTO_6:
       ...
       30 GETUPVAL                         R9 6
       31 GETTABLEKS                       R9 R9 K13 ["PrimitiveGen"]
       ...
       56 CALL                             R2 2 1
       57 DUPTABLE                         R4 K26 [{"title", "readOnlyHint", "destructiveHint", "idempotentHint", "openWorldHint"}]
       58 LOADK                            R5 K27 ["Wait Job Finished"]
       59 SETTABLEKS                       R5 R4 K21 ["title"]
       61 LOADB                            R5 1
       62 SETTABLEKS                       R5 R4 K22 ["readOnlyHint"]
       64 LOADB                            R5 0
       65 SETTABLEKS                       R5 R4 K23 ["destructiveHint"]
       67 LOADB                            R5 0
       68 SETTABLEKS                       R5 R4 K24 ["idempotentHint"]
       70 LOADB                            R5 0
       71 SETTABLEKS                       R5 R4 K25 ["openWorldHint"]
       73 NAMECALL                         R2 R2 K28 ["setAnnotations"]
       75 CALL                             R2 2 1
       76 NAMECALL                         R2 R2 K29 ["build"]
       78 CALL                             R2 1 1
       79 DUPTABLE                         R3 K32 [{"definition", "displayNameFunction"}]
       80 SETTABLEKS                       R2 R3 K30 ["definition"]
       82 GETUPVAL                         R5 7
       83 CALL                             R5 0 1
       84 JUMPIFNOT                        R5 ; [+2]
       85 LOADNIL                          R4
       86 JUMP                             ; [+2]
       87 DUPCLOSURE                       R4 K33 [PROTO_5]
       88 CAPTURE                          UPVAL U8
       89 SETTABLEKS                       R4 R3 K31 ["displayNameFunction"]
       91 RETURN                           R3 1
...
MAIN:
       ...
       22 GETTABLEKS                       R3 R3 K11 ["PrimitiveGenJobStore"]
       24 CALL                             R2 1 1
       25 GETIMPORT                        R3 K5 [require]
       27 GETTABLEKS                       R4 R0 K12 ["Tools"]
       29 GETTABLEKS                       R4 R4 K13 ["ToolTypes"]
       31 CALL                             R3 1 1
       32 GETIMPORT                        R4 K5 [require]
       34 GETTABLEKS                       R5 R0 K14 ["Resources"]
       36 GETTABLEKS                       R5 R5 K15 ["Localization"]
       38 GETTABLEKS                       R5 R5 K16 ["Translator"]
       40 CALL                             R4 1 1
       41 GETIMPORT                        R5 K5 [require]
       43 GETTABLEKS                       R6 R0 K17 ["Flags"]
       45 GETTABLEKS                       R6 R6 K18 ["FFlagAssistantSplitToolsAndWidgets"]
       47 CALL                             R5 1 1
       48 GETTABLEKS                       R6 R1 K19 ["Util"]
       50 GETTABLEKS                       R6 R6 K20 ["ToolBuilder"]
       52 GETTABLEKS                       R7 R1 K19 ["Util"]
       54 GETTABLEKS                       R7 R7 K21 ["ToolResult"]
       56 GETTABLEKS                       R8 R1 K22 ["Json"]
       58 GETTABLEKS                       R9 R3 K23 ["ToolNames"]
       60 GETTABLEKS                       R10 R2 K24 ["JobStatus"]
       62 DUPCLOSURE                       R11 K25 [PROTO_0]
       63 CAPTURE                          VAL R10
       64 DUPCLOSURE                       R12 K26 [PROTO_1]
       65 CAPTURE                          VAL R10
       66 CAPTURE                          VAL R7
       67 CAPTURE                          VAL R8
       68 DUPCLOSURE                       R13 K27 [PROTO_6]
       69 CAPTURE                          VAL R2
       70 CAPTURE                          VAL R7
       71 CAPTURE                          VAL R10
       72 CAPTURE                          VAL R8
