...
PROTO_1:
       ...
       23 LENGTH                           R4 R5
       24 LOADN                            R5 0
       25 JUMPIFNOTLT                      R5 R4 ; [+21]
       27 MOVE                             R4 R1
       28 DUPTABLE                         R5 K8 [{"messageId", "content"}]
       29 SETTABLEKS                       R3 R5 K6 ["messageId"]
       31 DUPTABLE                         R6 K12 [{"type", "imageContents", "expanded"}]
       32 GETUPVAL                         R7 1
       33 GETTABLEKS                       R7 R7 K13 ["Type"]
       35 SETTABLEKS                       R7 R6 K9 ["type"]
       37 GETTABLEKS                       R7 R2 K5 ["images"]
       39 SETTABLEKS                       R7 R6 K10 ["imageContents"]
       41 LOADB                            R7 0
       42 SETTABLEKS                       R7 R6 K11 ["expanded"]
       44 SETTABLEKS                       R6 R5 K7 ["content"]
       46 CALL                             R4 1 0
       47 GETTABLEKS                       R5 R2 K14 ["text"]
       49 LENGTH                           R4 R5
       50 LOADN                            R5 0
       51 JUMPIFNOTLT                      R5 R4 ; [+18]
       53 MOVE                             R4 R1
       54 DUPTABLE                         R5 K8 [{"messageId", "content"}]
       55 SETTABLEKS                       R3 R5 K6 ["messageId"]
       57 DUPTABLE                         R6 K15 [{"type", "text"}]
       58 GETUPVAL                         R7 2
       59 GETTABLEKS                       R7 R7 K13 ["Type"]
       61 SETTABLEKS                       R7 R6 K9 ["type"]
       63 GETTABLEKS                       R7 R2 K14 ["text"]
       65 SETTABLEKS                       R7 R6 K14 ["text"]
       67 SETTABLEKS                       R6 R5 K7 ["content"]
       69 CALL                             R4 1 0
       70 RETURN                           R0 0
...
PROTO_3:
       ...
       12 CALL                             R1 1 0
       13 GETUPVAL                         R1 0
       14 DUPTABLE                         R2 K7 [{"errorType"}]
       15 LOADK                            R3 K8 ["client_error"]
       16 SETTABLEKS                       R3 R2 K6 ["errorType"]
       18 CALL                             R1 1 0
       19 RETURN                           R0 0
...
PROTO_5:
       ...
       57 CALL                             R2 3 0
       58 GETUPVAL                         R2 6
       59 DUPTABLE                         R3 K16 [{"prompt", "images", "setInputEnabled"}]
       60 GETTABLEKS                       R4 R0 K17 ["text"]
       62 SETTABLEKS                       R4 R3 K14 ["prompt"]
       64 GETTABLEKS                       R4 R0 K15 ["images"]
       66 SETTABLEKS                       R4 R3 K15 ["images"]
       68 NEWCLOSURE                       R4 P0
       69 CAPTURE                          UPVAL U2
       70 SETTABLEKS                       R4 R3 K8 ["setInputEnabled"]
       72 CALL                             R2 1 1
       73 JUMPIFNOT                        R2 ; [+1]
       74 RETURN                           R0 0
       75 GETUPVAL                         R3 7
       76 DUPTABLE                         R4 K24 [{"service", "threadId", "addMessage", "addContent", "editContent", "apiKeys", "selectedModel"}]
       77 SETTABLEKS                       R1 R4 K6 ["service"]
       79 GETUPVAL                         R5 8
       80 SETTABLEKS                       R5 R4 K18 ["threadId"]
       82 GETUPVAL                         R5 4
       83 SETTABLEKS                       R5 R4 K19 ["addMessage"]
       85 GETUPVAL                         R5 5
       86 SETTABLEKS                       R5 R4 K20 ["addContent"]
       88 GETUPVAL                         R5 9
       89 SETTABLEKS                       R5 R4 K21 ["editContent"]
       91 GETUPVAL                         R5 10
       92 GETUPVAL                         R6 11
       93 GETTABLEKS                       R6 R6 K25 ["getSetting"]
       95 CALL                             R5 1 1
       96 SETTABLEKS                       R5 R4 K22 ["apiKeys"]
       98 GETUPVAL                         R5 12
       99 GETTABLEKS                       R5 R5 K23 ["selectedModel"]
      101 SETTABLEKS                       R5 R4 K23 ["selectedModel"]
      103 DUPTABLE                         R5 K26 [{"text", "retry", "previousMessageId", "images"}]
      104 GETTABLEKS                       R6 R0 K17 ["text"]
      106 SETTABLEKS                       R6 R5 K17 ["text"]
      108 GETTABLEKS                       R6 R0 K10 ["retry"]
      110 SETTABLEKS                       R6 R5 K10 ["retry"]
      112 GETTABLEKS                       R6 R0 K9 ["previousMessageId"]
      114 SETTABLEKS                       R6 R5 K9 ["previousMessageId"]
      116 GETTABLEKS                       R6 R0 K15 ["images"]
      118 SETTABLEKS                       R6 R5 K15 ["images"]
      120 CALL                             R3 2 1
      121 NEWCLOSURE                       R5 P1
      122 CAPTURE                          UPVAL U13
      123 NAMECALL                         R3 R3 K27 ["catch"]
      125 CALL                             R3 2 1
      126 NEWCLOSURE                       R5 P2
      127 CAPTURE                          UPVAL U2
      128 NAMECALL                         R3 R3 K28 ["finally"]
      130 CALL                             R3 2 0
      131 RETURN                           R0 0
...
MAIN:
      ...
      136 CAPTURE                          VAL R2
      137 CAPTURE                          VAL R6
      138 DUPCLOSURE                       R19 K31 [PROTO_6]
      139 CAPTURE                          VAL R10
      140 CAPTURE                          VAL R9
      141 CAPTURE                          VAL R11
      142 CAPTURE                          VAL R12
