...
PROTO_11:
       ...
       12 CALL                             R2 1 1
       13 GETUPVAL                         R4 2
       14 GETTABLEKS                       R3 R4 K5 ["getMessageGuid"]
       16 GETUPVAL                         R4 0
       17 CALL                             R3 1 1
       18 GETUPVAL                         R5 2
       19 GETTABLEKS                       R4 R5 K6 ["logToolEnded"]
       21 DUPTABLE                         R5 K14 [{"messageGuid", "toolId", "toolName", "startTime", "startTimeAfterConfirmation", "endTime", "isError"}]
       22 SETTABLEKS                       R3 R5 K7 ["messageGuid"]
       24 GETTABLEKS                       R6 R1 K15 ["id"]
       26 SETTABLEKS                       R6 R5 K8 ["toolId"]
       28 GETTABLEKS                       R6 R1 K4 ["name"]
       30 SETTABLEKS                       R6 R5 K9 ["toolName"]
       32 GETTABLEKS                       R6 R1 K10 ["startTime"]
       34 SETTABLEKS                       R6 R5 K10 ["startTime"]
       36 GETTABLEKS                       R6 R1 K11 ["startTimeAfterConfirmation"]
       38 SETTABLEKS                       R6 R5 K11 ["startTimeAfterConfirmation"]
       40 GETIMPORT                        R7 K18 [DateTime.now]
       42 CALL                             R7 0 1
       43 GETTABLEKS                       R6 R7 K19 ["UnixTimestampMillis"]
       45 SETTABLEKS                       R6 R5 K12 ["endTime"]
       47 GETTABLEKS                       R6 R1 K13 ["isError"]
       49 SETTABLEKS                       R6 R5 K13 ["isError"]
       51 CALL                             R4 1 0
       52 GETUPVAL                         R5 1
       53 GETTABLEKS                       R4 R5 K20 ["None"]
       55 JUMPIFNOTEQ                      R2 R4 ; [+2]
       57 RETURN                           R0 0
       58 JUMPIFEQKNIL                     R2 ; [+20]
       60 GETUPVAL                         R4 3
       61 GETTABLEKS                       R5 R2 K21 ["getTransformResultFn"]
       63 MOVE                             R6 R1
       64 CALL                             R4 2 1
       65 NEWCLOSURE                       R5 P0
       66 CAPTURE                          VAL R4
       67 CAPTURE                          VAL R1
       68 GETUPVAL                         R6 4
       69 DUPTABLE                         R7 K25 [{"messageId", "contentId", "transformFn"}]
       70 GETUPVAL                         R8 0
       71 SETTABLEKS                       R8 R7 K22 ["messageId"]
       73 SETTABLEKS                       R0 R7 K23 ["contentId"]
       75 SETTABLEKS                       R5 R7 K24 ["transformFn"]
       77 CALL                             R6 1 0
       78 RETURN                           R0 0
       79 GETUPVAL                         R4 4
       80 DUPTABLE                         R5 K25 [{"messageId", "contentId", "transformFn"}]
       81 GETUPVAL                         R6 0
       82 SETTABLEKS                       R6 R5 K22 ["messageId"]
       84 SETTABLEKS                       R0 R5 K23 ["contentId"]
       86 NEWCLOSURE                       R6 P1
       87 CAPTURE                          VAL R1
       88 SETTABLEKS                       R6 R5 K24 ["transformFn"]
       90 CALL                             R4 1 0
       91 RETURN                           R0 0
...
PROTO_19:
       ...
       25 GETUPVAL                         R7 1
       26 GETTABLEKS                       R6 R7 K9 ["getToolDisplayName"]
       28 MOVE                             R7 R0
       29 CALL                             R6 1 1
       30 GETUPVAL                         R8 2
       31 GETTABLEKS                       R7 R8 K10 ["getMessageGuid"]
       33 GETUPVAL                         R8 0
       34 CALL                             R7 1 1
       35 GETUPVAL                         R9 2
       36 GETTABLEKS                       R8 R9 K11 ["logToolConfirmationShown"]
       38 DUPTABLE                         R9 K14 [{"messageGuid", "toolName", "warningMessage"}]
       39 SETTABLEKS                       R7 R9 K12 ["messageGuid"]
       41 SETTABLEKS                       R0 R9 K13 ["toolName"]
       43 SETTABLEKS                       R5 R9 K8 ["warningMessage"]
       45 CALL                             R8 1 0
       46 DUPTABLE                         R8 K21 [{"type", "toolName", "toolInput", "toolDisplayName", "warningMessage", "onConfirm", "onReject", "onAlwaysAccept"}]
       47 GETUPVAL                         R10 3
       48 GETTABLEKS                       R9 R10 K22 ["Type"]
       50 SETTABLEKS                       R9 R8 K15 ["type"]
       52 SETTABLEKS                       R0 R8 K13 ["toolName"]
       54 SETTABLEKS                       R1 R8 K16 ["toolInput"]
       56 SETTABLEKS                       R6 R8 K17 ["toolDisplayName"]
       58 SETTABLEKS                       R5 R8 K8 ["warningMessage"]
       60 NEWCLOSURE                       R9 P0
       61 CAPTURE                          UPVAL U2
       62 CAPTURE                          VAL R7
       63 CAPTURE                          VAL R4
       64 SETTABLEKS                       R9 R8 K18 ["onConfirm"]
       66 NEWCLOSURE                       R9 P1
       67 CAPTURE                          UPVAL U2
       68 CAPTURE                          VAL R7
       69 CAPTURE                          VAL R4
       70 SETTABLEKS                       R9 R8 K19 ["onReject"]
       72 NEWCLOSURE                       R9 P2
       73 CAPTURE                          UPVAL U2
       74 CAPTURE                          VAL R7
       75 CAPTURE                          UPVAL U1
       76 CAPTURE                          VAL R0
       77 CAPTURE                          VAL R4
       78 SETTABLEKS                       R9 R8 K20 ["onAlwaysAccept"]
       80 GETUPVAL                         R9 4
       81 DUPTABLE                         R10 K25 [{"messageId", "content"}]
       82 GETUPVAL                         R11 0
       83 SETTABLEKS                       R11 R10 K23 ["messageId"]
       85 SETTABLEKS                       R8 R10 K24 ["content"]
       87 CALL                             R9 1 1
       88 MOVE                             R3 R9
       89 GETIMPORT                        R9 K27 [coroutine.yield]
       91 CALL                             R9 0 1
       92 GETUPVAL                         R10 5
       93 DUPTABLE                         R11 K30 [{"messageId", "contentId", "transformFn"}]
       94 GETUPVAL                         R12 0
       95 SETTABLEKS                       R12 R11 K23 ["messageId"]
       97 SETTABLEKS                       R3 R11 K28 ["contentId"]
       99 DUPCLOSURE                       R12 K31 [PROTO_18]
      100 SETTABLEKS                       R12 R11 K29 ["transformFn"]
      102 CALL                             R10 1 0
      103 RETURN                           R9 1
...
PROTO_21:
       ...
       42 CAPTURE                          VAL R2
       43 CAPTURE                          VAL R1
       44 DUPCLOSURE                       R12 K3 [PROTO_20]
       45 CAPTURE                          UPVAL U2
       46 DUPTABLE                         R13 K12 [{"onNewMessage", "onContentStart", "onContentDelta", "onContentFinished", "onToolResult", "onPreExecuteToolUse", "checkToolConfirmationRequestAsync", "getToolCallOptions"}]
       47 SETTABLEKS                       R5 R13 K4 ["onNewMessage"]
       49 SETTABLEKS                       R6 R13 K5 ["onContentStart"]
       51 SETTABLEKS                       R7 R13 K6 ["onContentDelta"]
       53 SETTABLEKS                       R8 R13 K7 ["onContentFinished"]
       55 SETTABLEKS                       R9 R13 K8 ["onToolResult"]
       57 SETTABLEKS                       R10 R13 K9 ["onPreExecuteToolUse"]
       59 SETTABLEKS                       R11 R13 K10 ["checkToolConfirmationRequestAsync"]
       61 SETTABLEKS                       R12 R13 K11 ["getToolCallOptions"]
       63 CLOSEUPVALS                      R4
       64 RETURN                           R13 1
...
MAIN:
       ...
       70 GETTABLEKS                       R11 R0 K11 ["Components"]
       72 GETTABLEKS                       R10 R11 K12 ["ContentWidgets"]
       74 GETTABLEKS                       R9 R10 K20 ["ToolConfirmationContentWidget"]
       76 CALL                             R8 1 1
       77 GETIMPORT                        R9 K5 [require]
       79 GETTABLEKS                       R10 R0 K21 ["Types"]
       81 CALL                             R9 1 1
       82 GETIMPORT                        R10 K5 [require]
       84 GETTABLEKS                       R12 R0 K11 ["Components"]
       86 GETTABLEKS                       R11 R12 K22 ["UIToolRegistry"]
       88 CALL                             R10 1 1
       89 GETIMPORT                        R11 K5 [require]
       91 GETTABLEKS                       R13 R0 K23 ["Hooks"]
       93 GETTABLEKS                       R12 R13 K24 ["useAddContent"]
       95 CALL                             R11 1 1
       96 GETIMPORT                        R12 K5 [require]
       98 GETTABLEKS                       R14 R0 K23 ["Hooks"]
      100 GETTABLEKS                       R13 R14 K25 ["useEditContent"]
      102 CALL                             R12 1 1
      103 NEWTABLE                         R13 1 0
      105 DUPCLOSURE                       R14 K26 [PROTO_0]
      106 DUPCLOSURE                       R15 K27 [PROTO_1]
      107 DUPCLOSURE                       R16 K28 [PROTO_21]
      108 CAPTURE                          VAL R6
      109 CAPTURE                          VAL R7
      110 CAPTURE                          VAL R10
      111 CAPTURE                          VAL R3
      ...
      114 CAPTURE                          VAL R9
      115 CAPTURE                          VAL R8
      116 SETTABLEKS                       R16 R13 K29 ["new"]
      118 RETURN                           R13 1
