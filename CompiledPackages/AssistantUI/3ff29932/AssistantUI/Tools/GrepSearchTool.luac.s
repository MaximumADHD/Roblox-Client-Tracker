PROTO_0:
       ...
       71 CALL                             R18 2 1
       72 JUMPIFNOT                        R18 ; [+17]
       73 LOADK                            R20 K20 ["Path: %* | Line: %* | %*"]
       74 MOVE                             R22 R9
       75 MOVE                             R23 R15
       76 MOVE                             R24 R16
       77 NAMECALL                         R20 R20 K21 ["format"]
       79 CALL                             R20 4 1
       80 FASTCALL2                        TABLE_INSERT R2 R20 ; [+4]
       82 MOVE                             R19 R2
       83 GETIMPORT                        R18 K17 [table.insert]
       85 CALL                             R18 2 0
       86 LENGTH                           R18 R2
       87 LOADN                            R19 50
       88 JUMPIFLE                         R19 R18 ; [+3]
       90 FORGLOOP                         R12 2 ; [-27]
       92 FORGLOOP                         R4 2 ; [-82]
       94 LENGTH                           R4 R2
       95 JUMPIFNOTEQKN                    R4 K22 [0] ; [+3]
       97 DUPTABLE                         R4 K28 [{["text"] = "No matches found for the given query.", ["count"] = 0, ["noMatch"] = True}]
       98 RETURN                           R4 1
       99 LENGTH                           R4 R2
      100 LENGTH                           R5 R2
      101 LOADN                            R6 50
      102 JUMPIFNOTLE                      R6 R5 ; [+11]
      104 MOVE                             R6 R2
      105 GETIMPORT                        R7 K29 [string.format]
      107 LOADK                            R8 K30 ["... Search stopped after reaching the limit of %d matches."]
      108 LOADN                            R9 50
      109 CALL                             R7 2 -1
      110 FASTCALL                         TABLE_INSERT ; [+2]
      111 GETIMPORT                        R5 K17 [table.insert]
      113 CALL                             R5 -1 0
      114 DUPTABLE                         R5 K32 [{["text"], ["count"], ["noMatch"] = False}]
      115 GETIMPORT                        R6 K34 [table.concat]
      117 MOVE                             R7 R2
      118 LOADK                            R8 K35 ["\n"]
      119 CALL                             R6 2 1
      120 SETTABLEKS                       R6 R5 K23 ["text"]
      122 SETTABLEKS                       R4 R5 K25 ["count"]
      124 RETURN                           R5 1
