...
PROTO_1:
       ...
       53 GETUPVAL                         R9 0
       54 CALL                             R9 0 1
       55 LOADK                            R11 K12 ["Error editing skill: %*"]
       56 FASTCALL1                        TOSTRING R8 ; [+3]
       57 MOVE                             R14 R8
       58 GETIMPORT                        R13 K14 [tostring]
       60 CALL                             R13 1 1
       61 NAMECALL                         R11 R11 K15 ["format"]
       63 CALL                             R11 2 1
       64 NAMECALL                         R9 R9 K3 ["addText"]
       66 CALL                             R9 2 1
       67 LOADB                            R11 1
       68 NAMECALL                         R9 R9 K4 ["setError"]
       70 CALL                             R9 2 1
       71 NAMECALL                         R9 R9 K5 ["build"]
       73 CALL                             R9 1 -1
       74 RETURN                           R9 -1
       75 OR                               R9 R4 R3
       76 GETUPVAL                         R10 0
       77 CALL                             R10 0 1
       78 LOADK                            R12 K16 ["Skill \"%*\" updated successfully."]
       79 MOVE                             R14 R9
       80 NAMECALL                         R12 R12 K15 ["format"]
       82 CALL                             R12 2 1
       83 NAMECALL                         R10 R10 K3 ["addText"]
       85 CALL                             R10 2 1
       86 DUPTABLE                         R12 K18 [{"skillName"}]
       87 SETTABLEKS                       R9 R12 K17 ["skillName"]
       89 NAMECALL                         R10 R10 K19 ["setStructuredContent"]
       91 CALL                             R10 2 1
       92 NAMECALL                         R10 R10 K5 ["build"]
       94 CALL                             R10 1 -1
       95 RETURN                           R10 -1
