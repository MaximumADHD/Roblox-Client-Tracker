...
PROTO_1:
       ...
       14 CALL                             R3 2 1
       15 LOADK                            R5 K4 ["Get the state of the studio, including current play state and available datamodel types. If the studio state is not expected, please call %* tool to start or stop the play."]
       16 GETUPVAL                         R7 2
       17 GETTABLEKS                       R7 R7 K5 ["StartStopPlay"]
       19 NAMECALL                         R5 R5 K6 ["format"]
       21 CALL                             R5 2 1
       22 NAMECALL                         R3 R3 K7 ["setDescription"]
       24 CALL                             R3 2 1
       25 DUPTABLE                         R5 K16 [{["title"] = "Get Studio State", ["readOnlyHint"] = True, ["destructiveHint"] = False, ["idempotentHint"] = False, ["openWorldHint"] = False}]
       26 NAMECALL                         R3 R3 K17 ["setAnnotations"]
       28 CALL                             R3 2 1
       29 MOVE                             R5 R2
       30 NAMECALL                         R3 R3 K18 ["setHandler"]
       32 CALL                             R3 2 1
       33 NAMECALL                         R3 R3 K19 ["build"]
       35 CALL                             R3 1 1
       36 DUPTABLE                         R4 K21 [{"definition"}]
       37 SETTABLEKS                       R3 R4 K20 ["definition"]
       39 RETURN                           R4 1
