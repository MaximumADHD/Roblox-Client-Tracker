...
PROTO_2:
        ...
        8 JUMPIFNOT                        R4 ; [+16]
        9 GETUPVAL                         R5 3
       10 GETTABLEKS                       R5 R5 K1 ["FFlagDebugLogAssistantUI"]
       12 JUMPIFNOT                        R5 ; [+8]
       13 GETIMPORT                        R5 K3 [print]
       15 LOADK                            R6 K4 ["[MeshGenSchemaSelector] LLM detected explicit no-segmentation intent for \"%*\""]
       16 MOVE                             R8 R0
       ...
       28 LOADNIL                          R7
       29 FORGPREP                         R5
       30 GETTABLEKS                       R10 R9 K6 ["id"]
       32 JUMPIFNOTEQ                      R10 R2 ; [+27]
       34 GETUPVAL                         R10 3
       35 GETTABLEKS                       R10 R10 K1 ["FFlagDebugLogAssistantUI"]
       37 JUMPIFNOT                        R10 ; [+17]
       38 GETIMPORT                        R10 K3 [print]
       40 LOADK                            R11 K7 ["[MeshGenSchemaSelector] matched schema \"%*\" (%*): %*"]
       41 GETTABLEKS                       R13 R9 K6 ["id"]
       43 GETTABLEKS                       R14 R9 K8 ["name"]
       45 GETIMPORT                        R15 K11 [table.concat]
       47 GETTABLEKS                       R16 R9 K12 ["parts"]
       49 LOADK                            R17 K13 [", "]
       50 CALL                             R15 2 1
       51 NAMECALL                         R11 R11 K5 ["format"]
       53 CALL                             R11 4 1
       54 CALL                             R10 1 0
       55 GETTABLEKS                       R10 R9 K12 ["parts"]
       57 LOADB                            R11 1
       58 LOADB                            R12 0
       59 RETURN                           R10 3
       60 FORGLOOP                         R5 2 ; [-31]
       62 GETUPVAL                         R5 3
       63 GETTABLEKS                       R5 R5 K1 ["FFlagDebugLogAssistantUI"]
       65 JUMPIFNOT                        R5 ; [+8]
       66 GETIMPORT                        R5 K3 [print]
       68 LOADK                            R6 K14 ["[MeshGenSchemaSelector] schema ID \"%*\" not found in table, treating as no match"]
       69 MOVE                             R8 R2
       70 NAMECALL                         R6 R6 K5 ["format"]
       72 CALL                             R6 2 1
       73 CALL                             R5 1 0
       74 GETUPVAL                         R5 3
       75 GETTABLEKS                       R5 R5 K1 ["FFlagDebugLogAssistantUI"]
       77 JUMPIFNOT                        R5 ; [+15]
       78 GETIMPORT                        R5 K3 [print]
       80 LOADK                            R6 K15 ["[MeshGenSchemaSelector] free-form parts: %*"]
       81 JUMPIFNOT                        R3 ; [+6]
       82 GETIMPORT                        R8 K11 [table.concat]
       84 MOVE                             R9 R3
       85 LOADK                            R10 K13 [", "]
       86 CALL                             R8 2 1
       87 JUMP                             ; [+1]
       88 LOADK                            R8 K16 ["(nil)"]
       89 NAMECALL                         R6 R6 K5 ["format"]
       91 CALL                             R6 2 1
       92 CALL                             R5 1 0
       93 MOVE                             R5 R3
       94 LOADB                            R6 0
...
PROTO_8:
       ...
       65 JUMPIFNOTEQ                      R4 R6 ; [+23]
       67 GETUPVAL                         R6 2
       68 MOVE                             R7 R1
       69 CALL                             R6 1 1
       70 JUMPIFNOTEQKNIL                  R6 ; [+14]
       72 GETIMPORT                        R7 K8 [error]
       74 LOADK                            R8 K9 ["segmentation=\"explicit\" requires a non-empty partNames argument (got: %*)"]
       75 FASTCALL1                        TOSTRING R1 ; [+3]
       76 MOVE                             R11 R1
       77 GETIMPORT                        R10 K11 [tostring]
       79 CALL                             R10 1 1
       80 NAMECALL                         R8 R8 K12 ["format"]
       82 CALL                             R8 2 1
       83 LOADN                            R9 0
       84 CALL                             R7 2 0
       85 GETUPVAL                         R7 3
       ...
       92 CALL                             R6 2 3
       93 GETUPVAL                         R9 5
       94 GETTABLEKS                       R9 R9 K13 ["FFlagAssistantGen3dAutoSegmentation"]
       96 JUMPIFNOT                        R9 ; [+3]
       97 JUMPIFNOT                        R8 ; [+2]
       98 LOADNIL                          R9
       99 RETURN                           R9 1
      ...
      102 LENGTH                           R9 R6
      103 JUMPIFNOTEQKN                    R9 K14 [0] ; [+10]
      105 GETIMPORT                        R9 K8 [error]
      107 LOADK                            R10 K15 ["Auto-segmentation failed: could not derive part names for prompt \"%*\". Retry, or pass segmentation=\"none\", or pass segmentation=\"explicit\" with partNames."]
      108 MOVE                             R12 R2
      109 NAMECALL                         R10 R10 K12 ["format"]
      111 CALL                             R10 2 1
      112 LOADN                            R11 0
      113 CALL                             R9 2 0
      114 RETURN                           R6 1
...
MAIN:
       ...
       18 GETTABLEKS                       R3 R3 K8 ["MeshGenSchemas"]
       20 CALL                             R2 1 1
       21 GETIMPORT                        R3 K5 [require]
       23 GETTABLEKS                       R4 R0 K9 ["Util"]
       25 GETTABLEKS                       R4 R4 K10 ["Gen3dUtils"]
       27 GETTABLEKS                       R4 R4 K11 ["SchemaSelector"]
       29 CALL                             R3 1 1
       30 GETIMPORT                        R4 K5 [require]
       32 GETTABLEKS                       R5 R0 K9 ["Util"]
       34 GETTABLEKS                       R5 R5 K10 ["Gen3dUtils"]
       36 GETTABLEKS                       R5 R5 K12 ["SegmentationEnums"]
       38 CALL                             R4 1 1
       39 GETTABLEKS                       R5 R2 K13 ["SCHEMAS"]
       ...
       50 LOADNIL                          R13
       51 FORGPREP                         R11
       52 GETTABLEKS                       R16 R15 K16 ["id"]
       54 LOADB                            R17 1
       55 SETTABLE                         R17 R10 R16
       56 FORGLOOP                         R11 2 ; [-5]
       58 MOVE                             R9 R10
       59 DUPCLOSURE                       R10 K17 [PROTO_2]
       60 CAPTURE                          VAL R3
       61 CAPTURE                          VAL R8
       62 CAPTURE                          VAL R9
       63 CAPTURE                          VAL R1
       64 CAPTURE                          VAL R5
       65 DUPCLOSURE                       R11 K18 [PROTO_4]
       66 DUPCLOSURE                       R12 K19 [PROTO_5]
       67 DUPCLOSURE                       R13 K20 [PROTO_6]
       68 CAPTURE                          VAL R12
       69 CAPTURE                          VAL R4
       70 DUPCLOSURE                       R14 K21 [PROTO_7]
       71 DUPCLOSURE                       R15 K22 [PROTO_8]
       72 CAPTURE                          VAL R12
       73 CAPTURE                          VAL R4
       74 CAPTURE                          VAL R11
       75 CAPTURE                          VAL R14
       76 CAPTURE                          VAL R10
       77 CAPTURE                          VAL R1
       78 DUPTABLE                         R16 K29 [{["suggestPartsAsync"], ["parsePartNames"], ["resolveSegmentationAsync"], ["inferUISegmentation"], ["MAX_HANDLER_PARTS"] = 8}]
       79 SETTABLEKS                       R10 R16 K23 ["suggestPartsAsync"]
       81 SETTABLEKS                       R11 R16 K24 ["parsePartNames"]
       83 SETTABLEKS                       R15 R16 K25 ["resolveSegmentationAsync"]
       85 SETTABLEKS                       R13 R16 K26 ["inferUISegmentation"]
       87 RETURN                           R16 1
