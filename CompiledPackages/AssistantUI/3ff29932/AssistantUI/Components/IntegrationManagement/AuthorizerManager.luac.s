...
PROTO_1:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["exchangeAuthCallback"]
        3 JUMPIFNOT                        R1 ; [+8]
        4 GETUPVAL                         R1 0
        5 GETTABLEKS                       R1 R1 K0 ["exchangeAuthCallback"]
...
PROTO_2:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["authorizerEnvironment"]
        3 GETTABLEKS                       R1 R1 K1 ["redirectToAuthorization"]
        5 MOVE                             R2 R0
        6 NEWCLOSURE                       R3 P0
        7 CAPTURE                          UPVAL U0
        8 CALL                             R1 2 0
...
PROTO_3:
       ...
       10 CAPTURE                          VAL R0
       11 GETUPVAL                         R5 0
       12 GETTABLEKS                       R5 R5 K1 ["createProvider"]
       14 MOVE                             R6 R3
       15 MOVE                             R7 R4
       16 CALL                             R5 2 1
       17 GETUPVAL                         R6 1
       18 GETTABLEKS                       R6 R6 K2 ["new"]
       20 MOVE                             R7 R5
...
PROTO_8:
       ...
       15 JUMPIFNOT                        R4 ; [+5]
       16 GETIMPORT                        R4 K5 [print]
       18 LOADK                            R5 K6 ["OAuth error:"]
       19 MOVE                             R6 R3
       20 CALL                             R4 2 0
       21 RETURN                           R0 0
...
PROTO_12:
        ...
        3 CALL                             R0 0 1
        4 GETUPVAL                         R1 1
        5 GETTABLEKS                       R1 R1 K1 ["removeSecretsAsync"]
        7 MOVE                             R2 R0
        8 GETUPVAL                         R3 2
        9 CALL                             R1 2 0
       10 RETURN                           R0 0
...
PROTO_13:
        ...
        6 LOADK                            R2 K3 ["Failed to invalidate credentials for label: "]
        7 GETUPVAL                         R3 1
        8 MOVE                             R4 R0
        9 CALL                             R1 3 0
       10 RETURN                           R0 0
...
MAIN:
       ...
       13 GETTABLEKS                       R2 R2 K7 ["SecureAuthStorage"]
       15 CALL                             R1 1 1
       ...
       34 GETTABLEKS                       R5 R5 K11 ["Promise"]
       36 CALL                             R4 1 1
       37 GETTABLEKS                       R5 R3 K12 ["Authorizer"]
       39 GETIMPORT                        R6 K5 [require]
       41 GETTABLEKS                       R7 R0 K13 ["Components"]
       43 GETTABLEKS                       R7 R7 K14 ["IntegrationManagement"]
       45 GETTABLEKS                       R7 R7 K15 ["AuthorizerProvider"]
       47 CALL                             R6 1 1
       48 GETIMPORT                        R7 K5 [require]
       50 GETTABLEKS                       R8 R0 K16 ["Flags"]
       52 CALL                             R7 1 1
       53 GETIMPORT                        R8 K5 [require]
       55 GETTABLEKS                       R9 R0 K13 ["Components"]
       57 GETTABLEKS                       R9 R9 K14 ["IntegrationManagement"]
       59 GETTABLEKS                       R9 R9 K17 ["createAuthorizerEnvironment"]
       61 CALL                             R8 1 1
       62 NEWTABLE                         R9 16 0
       64 SETTABLEKS                       R9 R9 K18 ["__index"]
       66 DUPCLOSURE                       R10 K19 [PROTO_0]
       67 CAPTURE                          VAL R9
       68 CAPTURE                          VAL R8
       69 SETTABLEKS                       R10 R9 K20 ["new"]
       71 DUPCLOSURE                       R10 K21 [PROTO_3]
       72 CAPTURE                          VAL R6
       73 CAPTURE                          VAL R5
       74 SETTABLEKS                       R10 R9 K22 ["createAuthorizer"]
       76 DUPCLOSURE                       R10 K23 [PROTO_4]
       77 SETTABLEKS                       R10 R9 K24 ["getAuthorizer"]
       79 DUPCLOSURE                       R10 K25 [PROTO_5]
       80 SETTABLEKS                       R10 R9 K26 ["getOrCreateAuthorizer"]
       82 DUPCLOSURE                       R10 K27 [PROTO_6]
       83 SETTABLEKS                       R10 R9 K28 ["removeAuthorizer"]
       85 DUPCLOSURE                       R10 K29 [PROTO_9]
       86 CAPTURE                          VAL R7
       87 SETTABLEKS                       R10 R9 K30 ["startAuthorization"]
       89 DUPCLOSURE                       R10 K31 [PROTO_10]
       90 SETTABLEKS                       R10 R9 K32 ["getAllAuthPersistInfo"]
       92 DUPCLOSURE                       R10 K33 [PROTO_11]
       93 SETTABLEKS                       R10 R9 K34 ["setAllAuthPersistInfo"]
       95 DUPCLOSURE                       R10 K35 [PROTO_14]
       96 CAPTURE                          VAL R4
       97 CAPTURE                          VAL R2
       98 CAPTURE                          VAL R1
       99 CAPTURE                          VAL R7
      100 SETTABLEKS                       R10 R9 K36 ["promiseInvalidateCredentials"]
      102 RETURN                           R9 1
