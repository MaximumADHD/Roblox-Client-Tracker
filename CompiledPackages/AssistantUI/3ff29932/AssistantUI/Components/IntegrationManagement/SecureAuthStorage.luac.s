...
MAIN:
       ...
       24 GETTABLEKS                       R4 R4 K13 ["IntegrationManagement"]
       26 GETTABLEKS                       R4 R4 K14 ["AuthorizerProvider"]
       28 CALL                             R3 1 1
       29 GETIMPORT                        R4 K9 [require]
       31 GETTABLEKS                       R5 R0 K10 ["Parent"]
       33 GETTABLEKS                       R5 R5 K15 ["Dash"]
       35 CALL                             R4 1 1
       36 GETIMPORT                        R5 K9 [require]
       38 GETTABLEKS                       R6 R0 K16 ["Guest"]
       40 GETTABLEKS                       R6 R6 K17 ["Environment"]
       42 CALL                             R5 1 1
       43 GETIMPORT                        R6 K9 [require]
       45 GETTABLEKS                       R7 R0 K18 ["Flags"]
       47 CALL                             R6 1 1
       48 GETTABLEKS                       R7 R2 K19 ["Engine"]
       50 GETTABLEKS                       R7 R7 K20 ["TaskCollector"]
       52 NEWTABLE                         R8 4 0
       54 GETTABLEKS                       R9 R7 K21 ["wrapFunction"]
       56 GETTABLEKS                       R10 R7 K22 ["collectTasks"]
       58 DUPCLOSURE                       R11 K23 [PROTO_0]
       59 CAPTURE                          VAL R1
       60 DUPCLOSURE                       R12 K24 [PROTO_2]
       61 CAPTURE                          VAL R6
       62 DUPCLOSURE                       R13 K25 [PROTO_4]
       63 CAPTURE                          VAL R6
       64 DUPCLOSURE                       R14 K26 [PROTO_5]
       65 DUPCLOSURE                       R15 K27 [PROTO_8]
       66 CAPTURE                          VAL R4
       67 CAPTURE                          VAL R9
       68 CAPTURE                          VAL R1
       69 CAPTURE                          VAL R6
       70 CAPTURE                          VAL R10
       71 SETTABLEKS                       R15 R8 K28 ["attachSecretsAsync"]
       73 DUPCLOSURE                       R15 K29 [PROTO_11]
       74 CAPTURE                          VAL R4
       75 CAPTURE                          VAL R9
       76 CAPTURE                          VAL R1
       77 CAPTURE                          VAL R6
       78 CAPTURE                          VAL R10
       79 SETTABLEKS                       R15 R8 K30 ["extractAndSaveSecretsAsync"]
       81 DUPCLOSURE                       R15 K31 [PROTO_12]
       82 CAPTURE                          VAL R1
       83 CAPTURE                          VAL R6
       84 SETTABLEKS                       R15 R8 K32 ["removeSecretsAsync"]
       86 RETURN                           R8 1
