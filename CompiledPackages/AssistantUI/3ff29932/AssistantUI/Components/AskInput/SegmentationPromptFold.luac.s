...
PROTO_1:
       ...
       81 LOADB                            R8 0 +1
       82 LOADB                            R8 1
       83 LOADK                            R9 K11 ["Unexpected segArg: %*"]
       84 MOVE                             R11 R5
       85 NAMECALL                         R9 R9 K12 ["format"]
       87 CALL                             R9 2 1
       88 FASTCALL2                        ASSERT R8 R9 ; [+3]
       90 GETIMPORT                        R7 K14 [assert]
       92 CALL                             R7 2 0
       93 MOVE                             R7 R5
       94 LOADB                            R9 1
       95 JUMPIFEQKNIL                     R6 ; [+18]
       97 LOADB                            R9 1
       98 GETUPVAL                         R10 2
       99 GETTABLEKS                       R10 R10 K15 ["SegmentationMode"]
      101 GETTABLEKS                       R10 R10 K16 ["Functional"]
      103 JUMPIFEQ                         R6 R10 ; [+10]
      105 GETUPVAL                         R10 2
      106 GETTABLEKS                       R10 R10 K15 ["SegmentationMode"]
      108 GETTABLEKS                       R10 R10 K17 ["Material"]
      110 JUMPIFEQ                         R6 R10 ; [+2]
      112 LOADB                            R9 0 +1
      113 LOADB                            R9 1
      114 LOADK                            R10 K18 ["Unexpected segMode: %*"]
      115 MOVE                             R12 R6
      116 NAMECALL                         R10 R10 K12 ["format"]
      118 CALL                             R10 2 1
      119 FASTCALL2                        ASSERT R9 R10 ; [+3]
      121 GETIMPORT                        R8 K14 [assert]
      123 CALL                             R8 2 0
      124 GETUPVAL                         R8 0
      125 GETTABLEKS                       R8 R8 K19 ["resolveSegmentationAsync"]
      127 MOVE                             R9 R7
      128 MOVE                             R10 R3
      129 MOVE                             R11 R2
      130 MOVE                             R12 R6
      ...
      133 MOVE                             R10 R8
      134 GETIMPORT                        R9 K4 [typeof]
      136 CALL                             R9 1 1
      137 JUMPIFNOTEQKS                    R9 K20 ["table"] ; [+8]
      139 GETUPVAL                         R9 3
      140 GETTABLEKS                       R9 R9 K21 ["combinePromptWithParts"]
      142 MOVE                             R10 R2
      143 MOVE                             R11 R8
      144 CALL                             R9 2 -1
      145 RETURN                           R9 -1
...
PROTO_3:
       ...
       11 LOADK                            R6 K4 ["[SegmentationPromptFold] fold errored: %*"]
       12 FASTCALL1                        TOSTRING R4 ; [+3]
       13 MOVE                             R9 R4
       14 GETIMPORT                        R8 K6 [tostring]
       16 CALL                             R8 1 1
...
MAIN:
       ...
       38 GETTABLEKS                       R5 R5 K14 ["Gen3dUtils"]
       40 GETTABLEKS                       R5 R5 K15 ["SegmentationEnums"]
       42 CALL                             R4 1 1
       43 GETTABLEKS                       R5 R1 K16 ["SEGMENTATION_FOLD_KIND"]
       45 GETTABLEKS                       R6 R4 K17 ["SegmentationArg"]
       47 DUPCLOSURE                       R7 K18 [PROTO_0]
       48 DUPCLOSURE                       R8 K19 [PROTO_1]
       49 CAPTURE                          VAL R3
       50 CAPTURE                          VAL R6
       51 CAPTURE                          VAL R4
       52 CAPTURE                          VAL R2
       53 NEWTABLE                         R9 1 0
       55 GETTABLEKS                       R10 R5 K20 ["Gen3D"]
       57 SETTABLE                         R8 R9 R10
       58 DUPCLOSURE                       R10 K21 [PROTO_3]
       59 CAPTURE                          VAL R9
       60 DUPTABLE                         R11 K23 [{"resolveAsync"}]
       61 SETTABLEKS                       R10 R11 K22 ["resolveAsync"]
       63 RETURN                           R11 1
