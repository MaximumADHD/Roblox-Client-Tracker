...
PROTO_1:
       ...
       67 CALL                             R1 1 -1
       68 RETURN                           R1 -1
       69 JUMPIFNOTEQKS                    R0 K23 ["prompt_moderated"] ; [+8]
       71 GETUPVAL                         R1 2
       72 LOADK                            R3 K24 ["Common"]
       73 LOADK                            R4 K25 ["ErrorModerated"]
       74 NAMECALL                         R1 R1 K26 ["getText"]
       76 CALL                             R1 3 -1
       77 RETURN                           R1 -1
       78 JUMPIFNOTEQKS                    R0 K27 ["token_limit"] ; [+5]
       80 GETUPVAL                         R1 1
       81 LOADK                            R2 K28 ["TokenLimit"]
       82 CALL                             R1 1 -1
       83 RETURN                           R1 -1
       84 JUMPIFNOTEQKS                    R0 K29 ["safety_filter"] ; [+5]
       86 GETUPVAL                         R1 1
       87 LOADK                            R2 K30 ["SafetyFilter"]
       88 CALL                             R1 1 -1
       89 RETURN                           R1 -1
       90 JUMPIFNOTEQKS                    R0 K31 ["max_tool_calls"] ; [+11]
       92 GETUPVAL                         R1 1
       93 LOADK                            R2 K32 ["MaxToolCalls"]
       94 DUPTABLE                         R3 K34 [{"count"}]
       95 GETUPVAL                         R4 3
       96 GETTABLEKS                       R4 R4 K35 ["FIntMCPAssistantMaxToolCalls"]
       98 SETTABLEKS                       R4 R3 K33 ["count"]
      100 CALL                             R1 2 -1
      101 RETURN                           R1 -1
      102 JUMPIFNOTEQKS                    R0 K36 ["input_disabled"] ; [+5]
      104 GETUPVAL                         R1 1
      105 LOADK                            R2 K37 ["ExternalError"]
      106 CALL                             R1 1 -1
      107 RETURN                           R1 -1
      108 JUMPIFNOTEQKS                    R0 K38 ["external_connection_unauthorized_error"] ; [+5]
      110 GETUPVAL                         R1 1
      111 LOADK                            R2 K39 ["ExternalAPIError"]
      112 CALL                             R1 1 -1
      113 RETURN                           R1 -1
      114 JUMPIFNOTEQKS                    R0 K40 ["free_trial_exhausted"] ; [+5]
      116 GETUPVAL                         R1 1
      117 LOADK                            R2 K41 ["FreeTrialExhausted"]
      118 CALL                             R1 1 -1
      119 RETURN                           R1 -1
      120 JUMPIFNOTEQKS                    R0 K42 ["daily_limit_reached"] ; [+5]
      122 GETUPVAL                         R1 1
      123 LOADK                            R2 K43 ["DailyLimitReached"]
      124 CALL                             R1 1 -1
      125 RETURN                           R1 -1
      126 JUMPIFNOTEQKS                    R0 K44 ["insufficient_robux_balance"] ; [+5]
      128 GETUPVAL                         R1 1
      129 LOADK                            R2 K45 ["InsufficientRobuxBalance"]
      130 CALL                             R1 1 -1
      131 RETURN                           R1 -1
      132 GETUPVAL                         R1 4
      133 GETTABLEKS                       R1 R1 K46 ["assertNever"]
      135 MOVE                             R2 R0
      136 CALL                             R1 1 -1
      137 RETURN                           R1 -1
...
MAIN:
      ...
      123 CAPTURE                          VAL R3
      124 CAPTURE                          VAL R10
      125 DUPCLOSURE                       R20 K35 [PROTO_2]
      126 CAPTURE                          VAL R10
      127 DUPCLOSURE                       R21 K36 [PROTO_3]
      128 CAPTURE                          VAL R11
      129 DUPCLOSURE                       R22 K37 [PROTO_4]
      130 CAPTURE                          VAL R3
      131 DUPCLOSURE                       R23 K38 [PROTO_5]
      132 CAPTURE                          VAL R3
      133 DUPCLOSURE                       R24 K39 [PROTO_19]
      134 CAPTURE                          VAL R6
      135 CAPTURE                          VAL R5
      136 CAPTURE                          VAL R2
      137 CAPTURE                          VAL R13
      ...
      147 CAPTURE                          VAL R15
      148 CAPTURE                          VAL R1
      149 DUPTABLE                         R25 K42 [{"toMeta", "fromMeta"}]
      150 DUPCLOSURE                       R26 K43 [PROTO_20]
      151 SETTABLEKS                       R26 R25 K40 ["toMeta"]
      153 DUPCLOSURE                       R26 K44 [PROTO_21]
      154 CAPTURE                          VAL R10
      155 SETTABLEKS                       R26 R25 K41 ["fromMeta"]
      157 DUPTABLE                         R26 K49 [{["Type"] = "Error", ["ContentWidget"], ["Serialization"]}]
      158 GETTABLEKS                       R27 R6 K50 ["memo"]
      160 MOVE                             R28 R24
      161 CALL                             R27 1 1
      162 SETTABLEKS                       R27 R26 K47 ["ContentWidget"]
      164 SETTABLEKS                       R25 R26 K48 ["Serialization"]
      166 RETURN                           R26 1
