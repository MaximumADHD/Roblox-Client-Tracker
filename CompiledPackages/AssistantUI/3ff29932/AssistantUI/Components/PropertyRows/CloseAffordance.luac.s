...
PROTO_1:
        ...
        5 DUPTABLE                         R5 K8 [{["tag"] = "size-600-600"}]
        6 SETTABLEKS                       R5 R4 K0 ["clickableViewProps"]
        8 DUPTABLE                         R5 K10 [{["tag"] = "position-center-center anchor-center-center size-400-400 radius-circle"}]
        9 SETTABLEKS                       R5 R4 K1 ["affordanceViewProps"]
       11 GETTABLEKS                       R5 R0 K11 ["onClose"]
       13 SETTABLEKS                       R5 R4 K2 ["onActivated"]
       15 GETTABLEKS                       R5 R0 K3 ["LayoutOrder"]
       17 SETTABLEKS                       R5 R4 K3 ["LayoutOrder"]
       19 GETTABLEKS                       R5 R0 K4 ["Visible"]
       21 SETTABLEKS                       R5 R4 K4 ["Visible"]
       23 DUPTABLE                         R5 K13 [{"CloseIcon"}]
       24 GETUPVAL                         R6 3
       25 GETTABLEKS                       R6 R6 K14 ["useMemo"]
       27 NEWCLOSURE                       R7 P0
       28 CAPTURE                          UPVAL U1
       29 CAPTURE                          UPVAL U4
       30 CAPTURE                          UPVAL U5
       ...
       34 CAPTURE                          VAL R1
       35 NEWTABLE                         R8 0 2
       37 GETTABLEKS                       R9 R0 K15 ["emphasis"]
       39 MOVE                             R10 R1
       40 SETLIST                          R8 R9 2 [1]
       42 CALL                             R6 2 1
       43 SETTABLEKS                       R6 R5 K12 ["CloseIcon"]
       45 CALL                             R2 3 -1
       46 RETURN                           R2 -1
