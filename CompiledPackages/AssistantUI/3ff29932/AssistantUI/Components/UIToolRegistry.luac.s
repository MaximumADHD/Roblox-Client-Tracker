...
PROTO_1:
       ...
       30 LOADK                            R10 K5 ["Slash command %* already registered"]
       31 MOVE                             R12 R7
       32 NAMECALL                         R10 R10 K6 ["format"]
       34 CALL                             R10 2 1
       35 CALL                             R9 1 0
       36 GETUPVAL                         R11 3
       37 GETTABLEKS                       R11 R11 K7 ["CommandDelimiter"]
       39 NAMECALL                         R9 R7 K8 ["find"]
       41 CALL                             R9 2 1
       42 JUMPIFNOT                        R9 ; [+11]
       43 GETIMPORT                        R9 K4 [error]
       45 LOADK                            R10 K9 ["Slash command %* cannot contain the delimiter \"%*\""]
       46 MOVE                             R12 R7
       47 GETUPVAL                         R13 3
       48 GETTABLEKS                       R13 R13 K7 ["CommandDelimiter"]
       50 NAMECALL                         R10 R10 K6 ["format"]
       52 CALL                             R10 3 1
       53 CALL                             R9 1 0
       54 GETUPVAL                         R9 2
       55 GETTABLEKS                       R10 R6 K10 ["mapToToolCall"]
       57 SETTABLE                         R10 R9 R7
       58 GETUPVAL                         R9 4
       59 GETTABLEKS                       R10 R6 K11 ["getDescription"]
       61 SETTABLE                         R10 R9 R7
       62 GETUPVAL                         R9 1
       63 SETTABLE                         R6 R9 R7
       64 GETUPVAL                         R10 5
       65 FASTCALL2                        TABLE_INSERT R10 R7 ; [+4]
       67 MOVE                             R11 R7
       68 GETIMPORT                        R9 K14 [table.insert]
       70 CALL                             R9 2 0
       71 FORGLOOP                         R2 2 ; [-65]
       73 GETIMPORT                        R2 K16 [table.sort]
       75 GETUPVAL                         R3 5
       76 CALL                             R2 1 0
       77 GETTABLEKS                       R2 R0 K17 ["getPreExecuteWarning"]
       79 JUMPIFNOT                        R2 ; [+10]
       80 GETUPVAL                         R2 6
       81 GETTABLEKS                       R3 R0 K18 ["definition"]
       83 GETTABLEKS                       R3 R3 K18 ["definition"]
       85 GETTABLEKS                       R3 R3 K19 ["name"]
       87 GETTABLEKS                       R4 R0 K17 ["getPreExecuteWarning"]
       89 SETTABLE                         R4 R2 R3
       90 GETTABLEKS                       R2 R0 K20 ["toolCallOptions"]
       92 JUMPIFNOT                        R2 ; [+10]
       93 GETUPVAL                         R2 7
       94 GETTABLEKS                       R3 R0 K18 ["definition"]
       96 GETTABLEKS                       R3 R3 K18 ["definition"]
       98 GETTABLEKS                       R3 R3 K19 ["name"]
      100 GETTABLEKS                       R4 R0 K20 ["toolCallOptions"]
      102 SETTABLE                         R4 R2 R3
      103 GETTABLEKS                       R2 R0 K21 ["availableDataModelTypes"]
      105 JUMPIFNOT                        R2 ; [+18]
      106 GETUPVAL                         R2 0
      107 GETTABLEKS                       R2 R2 K22 ["FFlagAssistantStandaloneDataModel"]
      109 JUMPIF                           R2 ; [+4]
      110 GETUPVAL                         R2 8
      111 GETTABLEKS                       R3 R0 K21 ["availableDataModelTypes"]
      113 CALL                             R2 1 0
      114 GETUPVAL                         R2 9
      115 GETTABLEKS                       R3 R0 K18 ["definition"]
      117 GETTABLEKS                       R3 R3 K18 ["definition"]
      119 GETTABLEKS                       R3 R3 K19 ["name"]
      121 GETTABLEKS                       R4 R0 K21 ["availableDataModelTypes"]
      123 SETTABLE                         R4 R2 R3
      124 GETTABLEKS                       R2 R0 K11 ["getDescription"]
      126 JUMPIFNOT                        R2 ; [+10]
      127 GETUPVAL                         R2 10
      128 GETTABLEKS                       R3 R0 K18 ["definition"]
      130 GETTABLEKS                       R3 R3 K18 ["definition"]
      132 GETTABLEKS                       R3 R3 K19 ["name"]
      134 GETTABLEKS                       R4 R0 K11 ["getDescription"]
      136 SETTABLE                         R4 R2 R3
      137 GETUPVAL                         R2 11
      138 GETTABLEKS                       R2 R2 K23 ["addTool"]
      140 GETTABLEKS                       R3 R0 K18 ["definition"]
      142 CALL                             R2 1 0
      143 RETURN                           R0 0
...
PROTO_5:
       ...
       29 LOADK                            R10 K6 ["Mode command %* collides with an existing tool slash command"]
       30 MOVE                             R12 R7
       31 NAMECALL                         R10 R10 K7 ["format"]
       33 CALL                             R10 2 1
       34 CALL                             R9 1 0
       35 GETUPVAL                         R10 3
       36 GETTABLE                         R9 R10 R7
       37 JUMPIFNOT                        R9 ; [+8]
       38 GETIMPORT                        R9 K5 [error]
       40 LOADK                            R10 K8 ["Mode command %* already registered"]
       41 MOVE                             R12 R7
       ...
       61 FORGLOOP                         R2 2 ; [-58]
       63 GETIMPORT                        R2 K13 [table.sort]
       65 GETUPVAL                         R3 4
       66 CALL                             R2 1 0
       67 RETURN                           R0 0
