...
PROTO_19:
      ...
      116 LOADNIL                          R8
      117 GETTABLEKS                       R9 R0 K30 ["_isHistoryReplay"]
      119 JUMPIFNOT                        R9 ; [+18]
      120 GETUPVAL                         R10 4
      121 GETTABLEKS                       R10 R10 K31 ["FFlagAssistantAskInputTool"]
      123 NOT                              R9 R10
      124 JUMPIFNOT                        R9 ; [+13]
      125 LOADB                            R9 1
      126 GETUPVAL                         R10 6
      127 GETTABLEKS                       R10 R10 K32 ["PrimitiveGen"]
      129 JUMPIFEQ                         R3 R10 ; [+8]
      131 GETUPVAL                         R10 6
      132 GETTABLEKS                       R10 R10 K33 ["MeshGen"]
      134 JUMPIFEQ                         R3 R10 ; [+2]
      136 LOADB                            R9 0 +1
      137 LOADB                            R9 1
      138 JUMPIF                           R9 ; [+5]
      139 GETUPVAL                         R10 3
      140 GETTABLEKS                       R10 R10 K6 ["Type"]
      142 JUMPIFNOTEQ                      R4 R10 ; [+9]
      144 DUPTABLE                         R10 K38 [{["type"], ["expanded"] = False, ["generating"] = True}]
      145 GETUPVAL                         R11 3
      146 GETTABLEKS                       R11 R11 K6 ["Type"]
      148 SETTABLEKS                       R11 R10 K19 ["type"]
      150 MOVE                             R8 R10
      151 JUMP                             ; [+4]
      152 DUPTABLE                         R10 K38 [{["type"], ["expanded"] = False, ["generating"] = True}]
      153 SETTABLEKS                       R4 R10 K19 ["type"]
      155 MOVE                             R8 R10
      156 JUMPIFNOT                        R6 ; [+3]
      157 SETTABLEKS                       R7 R8 K39 ["toolUse"]
      159 JUMP                             ; [+7]
      160 GETTABLEKS                       R10 R0 K30 ["_isHistoryReplay"]
      162 JUMPIF                           R10 ; [+4]
      163 NEWTABLE                         R10 0 0
      165 SETTABLEKS                       R10 R8 K40 ["streaming"]
      167 LOADB                            R10 1
      168 SETTABLEKS                       R10 R8 K36 ["generating"]
      170 FASTCALL1                        TYPEOF R4 ; [+3]
      171 MOVE                             R12 R4
      172 GETIMPORT                        R11 K42 [typeof]
      174 CALL                             R11 1 1
      175 JUMPIFNOTEQKS                    R11 K43 ["string"] ; [+7]
      177 GETUPVAL                         R10 7
      178 GETTABLEKS                       R10 R10 K44 ["getAutoExpand"]
      180 MOVE                             R11 R4
      181 CALL                             R10 1 1
      182 JUMP                             ; [+1]
      183 LOADNIL                          R10
      184 JUMPIFNOT                        R10 ; [+9]
      185 GETTABLEKS                       R12 R10 K45 ["expandWhileGenerating"]
      187 JUMPIFNOT                        R12 ; [+2]
      188 LOADB                            R11 1
      189 JUMP                             ; [+1]
      190 LOADB                            R11 0
      191 SETTABLEKS                       R11 R8 K34 ["expanded"]
      193 JUMP                             ; [+7]
      194 GETTABLEKS                       R11 R8 K34 ["expanded"]
      196 JUMPIFNOTEQKNIL                  R11 ; [+4]
      198 LOADB                            R11 0
      199 SETTABLEKS                       R11 R8 K34 ["expanded"]
      201 NAMECALL                         R11 R0 K46 ["getOrCreateAssistantMessage"]
      203 CALL                             R11 1 1
      204 GETTABLEKS                       R12 R0 K47 ["_callbacks"]
      206 GETTABLEKS                       R12 R12 K48 ["addContent"]
      208 DUPTABLE                         R13 K51 [{"messageId", "content"}]
      209 SETTABLEKS                       R11 R13 K49 ["messageId"]
      211 SETTABLEKS                       R8 R13 K50 ["content"]
      213 CALL                             R12 1 1
      214 GETUPVAL                         R13 4
      215 GETTABLEKS                       R13 R13 K8 ["FFlagDebugLogAssistantUI"]
      217 JUMPIFNOT                        R13 ; [+30]
      218 GETIMPORT                        R13 K10 [print]
      220 LOADK                            R17 K52 ["[Tool Call] UI update (create): toolCallId=%* messageId=%* "]
      221 GETTABLEKS                       R20 R1 K12 ["toolCallId"]
      223 FASTCALL1                        TOSTRING R20 ; [+2]
      224 GETIMPORT                        R19 K14 [tostring]
      226 CALL                             R19 1 1
      227 MOVE                             R20 R11
      228 NAMECALL                         R17 R17 K15 ["format"]
      230 CALL                             R17 3 1
      231 MOVE                             R15 R17
      232 LOADK                            R16 K53 ["contentId=%* widgetType=%* status=%*"]
      233 MOVE                             R18 R12
      234 GETTABLEKS                       R20 R8 K19 ["type"]
      236 OR                               R19 R20 R4
      237 GETTABLEKS                       R21 R1 K54 ["status"]
      239 FASTCALL1                        TOSTRING R21 ; [+2]
      240 GETIMPORT                        R20 K14 [tostring]
      242 CALL                             R20 1 1
      243 NAMECALL                         R16 R16 K15 ["format"]
      245 CALL                             R16 4 1
      246 CONCAT                           R14 R15 R16
      247 CALL                             R13 1 0
      248 GETTABLEKS                       R13 R1 K12 ["toolCallId"]
      250 JUMPIFNOT                        R13 ; [+30]
      251 GETTABLEKS                       R13 R0 K55 ["_contentIdByToolCallId"]
      253 GETTABLEKS                       R14 R1 K12 ["toolCallId"]
      255 SETTABLE                         R12 R13 R14
      256 GETTABLEKS                       R13 R0 K56 ["_toolNameByToolCallId"]
      258 GETTABLEKS                       R14 R1 K12 ["toolCallId"]
      260 SETTABLE                         R3 R13 R14
      261 GETTABLEKS                       R13 R0 K57 ["_openToolCallIds"]
      263 GETTABLEKS                       R14 R1 K12 ["toolCallId"]
      265 LOADB                            R15 1
      266 SETTABLE                         R15 R13 R14
      267 GETTABLEKS                       R13 R0 K47 ["_callbacks"]
      269 GETTABLEKS                       R13 R13 K58 ["onToolWidgetCreated"]
      271 JUMPIFNOT                        R13 ; [+9]
      272 GETTABLEKS                       R13 R0 K47 ["_callbacks"]
      274 GETTABLEKS                       R13 R13 K58 ["onToolWidgetCreated"]
      276 GETTABLEKS                       R14 R1 K12 ["toolCallId"]
      278 MOVE                             R15 R11
      279 MOVE                             R16 R12
      280 CALL                             R13 3 0
      281 RETURN                           R0 0
...
MAIN:
      ...
      163 CAPTURE                          VAL R3
      164 SETTABLEKS                       R21 R20 K45 ["beginHistoryReplay"]
      166 DUPCLOSURE                       R21 K46 [PROTO_4]
      167 CAPTURE                          VAL R3
      168 SETTABLEKS                       R21 R20 K47 ["endHistoryReplay"]
      170 DUPCLOSURE                       R21 K48 [PROTO_5]
      171 SETTABLEKS                       R21 R20 K49 ["_addMessage"]
      173 DUPCLOSURE                       R21 K50 [PROTO_6]
      174 SETTABLEKS                       R21 R20 K51 ["resetRenderedState"]
      176 DUPCLOSURE                       R21 K52 [PROTO_7]
      177 CAPTURE                          VAL R11
      178 CAPTURE                          VAL R4
      179 DUPCLOSURE                       R22 K53 [PROTO_8]
      180 CAPTURE                          VAL R14
      181 CAPTURE                          VAL R19
      182 DUPCLOSURE                       R23 K54 [PROTO_9]
      183 DUPCLOSURE                       R24 K55 [PROTO_11]
      184 SETTABLEKS                       R24 R20 K56 ["_resetActiveStream"]
      186 DUPCLOSURE                       R24 K57 [PROTO_12]
      187 CAPTURE                          VAL R13
      188 SETTABLEKS                       R24 R20 K58 ["getOrCreateAssistantMessage"]
      190 DUPCLOSURE                       R24 K59 [PROTO_14]
      191 CAPTURE                          VAL R8
      192 SETTABLEKS                       R24 R20 K60 ["_handleMessageChunk"]
      194 DUPCLOSURE                       R24 K61 [PROTO_15]
      195 CAPTURE                          VAL R13
      196 CAPTURE                          VAL R8
      197 SETTABLEKS                       R24 R20 K62 ["_handleUserMessageChunk"]
      199 DUPCLOSURE                       R24 K63 [PROTO_16]
      200 CAPTURE                          VAL R13
      201 CAPTURE                          VAL R8
      202 CAPTURE                          VAL R5
      203 SETTABLEKS                       R24 R20 K64 ["_handleUserMessage"]
      205 DUPCLOSURE                       R24 K65 [PROTO_18]
      206 CAPTURE                          VAL R9
      207 SETTABLEKS                       R24 R20 K66 ["_handleThoughtChunk"]
      209 DUPCLOSURE                       R24 K67 [PROTO_19]
      210 CAPTURE                          VAL R14
      211 CAPTURE                          VAL R19
      212 CAPTURE                          VAL R11
      213 CAPTURE                          VAL R4
      ...
      216 CAPTURE                          VAL R10
      217 CAPTURE                          VAL R2
      218 SETTABLEKS                       R24 R20 K68 ["_handleToolCall"]
      220 DUPCLOSURE                       R24 K69 [PROTO_22]
      221 CAPTURE                          VAL R3
      222 CAPTURE                          VAL R14
      223 CAPTURE                          VAL R19
      224 CAPTURE                          VAL R11
      ...
      227 CAPTURE                          VAL R1
      228 CAPTURE                          VAL R23
      229 SETTABLEKS                       R24 R20 K70 ["_handleToolCallUpdate"]
      231 DUPCLOSURE                       R24 K71 [PROTO_23]
      232 CAPTURE                          VAL R3
      233 CAPTURE                          VAL R18
      234 SETTABLEKS                       R24 R20 K72 ["_cancelOpenToolCalls"]
      236 DUPCLOSURE                       R24 K73 [PROTO_24]
      237 SETTABLEKS                       R24 R20 K74 ["_handlePlan"]
      239 DUPCLOSURE                       R24 K75 [PROTO_25]
      240 SETTABLEKS                       R24 R20 K76 ["_handleAvailableCommands"]
      242 DUPCLOSURE                       R24 K77 [PROTO_26]
      243 SETTABLEKS                       R24 R20 K78 ["_handleSessionInfo"]
      245 DUPCLOSURE                       R24 K79 [PROTO_28]
      246 CAPTURE                          VAL R7
      247 CAPTURE                          VAL R12
      248 SETTABLEKS                       R24 R20 K80 ["_handleCompactionStatus"]
      250 DUPCLOSURE                       R24 K81 [PROTO_29]
      251 CAPTURE                          VAL R18
      252 CAPTURE                          VAL R3
      253 SETTABLEKS                       R24 R20 K82 ["handleUpdate"]
      255 RETURN                           R20 1
