...
PROTO_11:
       ...
       16 RETURN                           R1 -1
       17 GETUPVAL                         R2 4
       18 GETTABLEKS                       R2 R2 K4 ["getPreExecuteWarningResult"]
       20 JUMPIFNOT                        R2 ; [+9]
       21 GETUPVAL                         R1 4
       22 GETTABLEKS                       R1 R1 K4 ["getPreExecuteWarningResult"]
       24 GETTABLEKS                       R2 R0 K5 ["toolName"]
       26 GETTABLEKS                       R3 R0 K6 ["toolInput"]
       28 CALL                             R1 2 1
       29 JUMP                             ; [+8]
       30 GETUPVAL                         R1 5
       31 GETTABLEKS                       R1 R1 K4 ["getPreExecuteWarningResult"]
       33 GETTABLEKS                       R2 R0 K5 ["toolName"]
       35 GETTABLEKS                       R3 R0 K6 ["toolInput"]
       37 CALL                             R1 2 1
       38 JUMPIFNOT                        R1 ; [+3]
       39 GETTABLEKS                       R2 R1 K7 ["shouldConfirm"]
       41 JUMPIF                           R2 ; [+8]
       42 GETUPVAL                         R2 2
       43 GETTABLEKS                       R2 R2 K2 ["resolve"]
       45 GETUPVAL                         R3 3
       46 GETTABLEKS                       R3 R3 K3 ["Execute"]
       48 CALL                             R2 1 -1
       49 RETURN                           R2 -1
       50 GETUPVAL                         R2 2
       51 GETTABLEKS                       R2 R2 K8 ["new"]
       53 NEWCLOSURE                       R3 P0
       54 CAPTURE                          VAL R0
       55 CAPTURE                          UPVAL U4
       56 CAPTURE                          UPVAL U6
...
PROTO_14:
       ...
       28 CAPTURE                          VAL R2
       29 CAPTURE                          UPVAL U8
       30 DUPTABLE                         R7 K3 [{"request", "interrupt", "dispose"}]
       31 SETTABLEKS                       R4 R7 K0 ["request"]
       33 SETTABLEKS                       R5 R7 K1 ["interrupt"]
       35 SETTABLEKS                       R6 R7 K2 ["dispose"]
       37 RETURN                           R7 1
...
MAIN:
       ...
       75 CALL                             R10 1 1
       76 DUPCLOSURE                       R11 K31 [PROTO_14]
       77 CAPTURE                          VAL R3
       78 CAPTURE                          VAL R2
       79 CAPTURE                          VAL R5
       80 CAPTURE                          VAL R10
