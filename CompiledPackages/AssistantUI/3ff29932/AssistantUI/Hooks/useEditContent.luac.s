PROTO_0:
       ...
       52 LOADK                            R7 K12 ["Failed at key: %*"]
       53 MOVE                             R9 R5
       54 NAMECALL                         R7 R7 K13 ["format"]
       56 CALL                             R7 2 1
       57 CALL                             R6 1 0
       58 RETURN                           R0 1
       59 GETUPVAL                         R6 0
       60 GETTABLEKS                       R6 R6 K14 ["transformFn"]
       62 MOVE                             R7 R4
       63 CALL                             R6 1 1
       64 JUMPIF                           R6 ; [+2]
       65 NEWTABLE                         R6 0 0
       67 GETTABLEKS                       R7 R6 K15 ["cancelTransform"]
       69 JUMPIFNOT                        R7 ; [+1]
       70 RETURN                           R0 1
       71 GETTABLEKS                       R7 R6 K16 ["rawTransformValues"]
       73 JUMPIF                           R7 ; [+28]
       74 GETTABLEKS                       R8 R3 K1 ["threads"]
       76 GETUPVAL                         R9 1
       77 GETTABLE                         R7 R8 R9
       78 GETTABLEKS                       R9 R7 K2 ["messages"]
       80 GETUPVAL                         R10 0
       81 GETTABLEKS                       R10 R10 K3 ["messageId"]
       83 GETTABLE                         R8 R9 R10
       84 GETUPVAL                         R9 3
       85 NEWTABLE                         R10 0 3
       87 MOVE                             R11 R7
       88 MOVE                             R12 R8
       89 MOVE                             R13 R4
       90 SETLIST                          R10 R11 3 [1]
       92 CALL                             R9 1 0
       93 GETUPVAL                         R9 4
       94 NEWTABLE                         R10 0 3
       96 MOVE                             R11 R7
