...
PROTO_3:
        ...
        9 LOADK                            R3 K4 ["useThreadWorkQueue: work %* errored: %*"]
       10 GETUPVAL                         R5 0
       11 GETTABLEKS                       R5 R5 K5 ["key"]
       13 FASTCALL1                        TOSTRING R1 ; [+3]
       14 MOVE                             R7 R1
       15 GETIMPORT                        R6 K7 [tostring]
       17 CALL                             R6 1 1
       18 NAMECALL                         R3 R3 K8 ["format"]
       20 CALL                             R3 3 1
       21 CALL                             R2 1 0
       22 GETUPVAL                         R2 1
       23 CALL                             R2 0 0
...
PROTO_5:
       ...
       59 LOADK                            R4 K12 ["useThreadWorkQueue: Expected work to be present for thread %*, but queue was empty."]
       60 MOVE                             R6 R0
       61 NAMECALL                         R4 R4 K13 ["format"]
       63 CALL                             R4 2 1
       64 CALL                             R3 1 0
       65 LOADB                            R3 0
       66 RETURN                           R3 1
