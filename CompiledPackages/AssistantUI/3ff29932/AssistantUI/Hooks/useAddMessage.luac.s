PROTO_0:
       ...
       32 LOADNIL                          R8
       33 FORGPREP                         R6
       34 GETTABLEKS                       R11 R10 K10 ["ephemeral"]
       36 JUMPIFNOT                        R11 ; [+2]
       37 LOADNIL                          R11
       38 SETTABLE                         R11 R4 R9
       39 FORGLOOP                         R6 2 ; [-6]
       41 LOADNIL                          R6
       42 GETTABLEKS                       R8 R3 K0 ["threads"]
       44 GETUPVAL                         R9 0
       45 GETTABLE                         R7 R8 R9
       46 GETTABLEKS                       R8 R7 K11 ["messageCountAdded"]
       48 ADDK                             R8 R8 K12 [1]
       49 SETTABLEKS                       R8 R7 K11 ["messageCountAdded"]
       51 GETTABLEKS                       R6 R7 K11 ["messageCountAdded"]
       53 GETUPVAL                         R8 2
       54 DUPTABLE                         R9 K28 [{["messageId"], ["createdAt"] = -1, ["updatedAt"] = -1, ["ephemeral"], ["isDirty"] = False, ["isDeleted"] = , ["role"], ["contents"], ["contentCountAdded"] = 0, ["contentCountLoaded"] = 0, ["LayoutOrder"], ["hidden"]}]
       55 GETUPVAL                         R10 2
       56 SETTABLEKS                       R10 R9 K13 ["messageId"]
       58 GETUPVAL                         R11 3
       59 GETTABLEKS                       R11 R11 K10 ["ephemeral"]
       61 ORK                              R10 R11 K18 [False]
       62 SETTABLEKS                       R10 R9 K10 ["ephemeral"]
       64 GETUPVAL                         R10 3
       65 GETTABLEKS                       R10 R10 K21 ["role"]
       67 SETTABLEKS                       R10 R9 K21 ["role"]
       69 NEWTABLE                         R10 0 0
       71 SETTABLEKS                       R10 R9 K22 ["contents"]
       73 SETTABLEKS                       R6 R9 K26 ["LayoutOrder"]
       75 GETUPVAL                         R10 3
       76 GETTABLEKS                       R10 R10 K27 ["hidden"]
       78 SETTABLEKS                       R10 R9 K27 ["hidden"]
       80 SETTABLE                         R9 R4 R8
       81 GETUPVAL                         R9 2
       82 GETTABLE                         R8 R4 R9
       83 GETUPVAL                         R9 4
       84 DUPTABLE                         R10 K31 [{"thread", "sessionId"}]
       85 SETTABLEKS                       R7 R10 K29 ["thread"]
       87 GETUPVAL                         R11 5
       88 SETTABLEKS                       R11 R10 K30 ["sessionId"]
       90 CALL                             R9 1 0
       91 GETUPVAL                         R9 6
       92 NEWTABLE                         R10 0 1
       94 MOVE                             R11 R8
      ...
      105 CALL                             R9 1 0
      106 GETUPVAL                         R9 8
      107 NEWTABLE                         R10 0 2
      109 MOVE                             R11 R7
      110 MOVE                             R12 R8
      111 SETLIST                          R10 R11 2 [1]
      113 CALL                             R9 1 0
      114 RETURN                           R3 1
