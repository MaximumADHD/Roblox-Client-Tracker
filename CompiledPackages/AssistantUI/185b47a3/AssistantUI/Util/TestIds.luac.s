...
MAIN:
      ...
      204 DUPTABLE                         R1 K383 [{["SuggestCheckbox"] = "Assistant-SegPropRow-SuggestCheckbox", ["RefreshButton"] = "Assistant-SegPropRow-RefreshButton", ["WarningToggle"] = "Assistant-PropRow-WarningToggle", ["CancelButton"] = "Assistant-PropRow-CancelButton", ["SuggestButton"] = "Assistant-PropRow-SuggestButton", ["UploadButton"] = "Assistant-PropRow-UploadButton", ["DeletePillButton"] = "Assistant-PropRow-DeletePillButton", ["BooleanCheckbox"] = "Assistant-PropRow-BooleanCheckbox"}]
      205 SETTABLEKS                       R1 R0 K384 ["SegmentationPropertyRow"]
      207 GETIMPORT                        R1 K386 [pcall]
      209 GETIMPORT                        R2 K388 [game]
      211 GETTABLEKS                       R2 R2 K389 ["GetService"]
      213 GETIMPORT                        R3 K388 [game]
      215 LOADK                            R4 K390 ["ProcessService"]
      216 CALL                             R1 3 1
      217 JUMPIFNOT                        R1 ; [+8]
      218 NEWTABLE                         R2 0 0
      220 DUPCLOSURE                       R3 K391 [PROTO_15]
      221 CAPTURE                          VAL R3
      222 CAPTURE                          VAL R2
      223 MOVE                             R4 R3
      224 MOVE                             R5 R0
