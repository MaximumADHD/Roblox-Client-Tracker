...
PROTO_45:
       ...
       63 CALL                             R14 0 1
       64 JUMPIFNOT                        R14 ; [+4]
       65 NEWCLOSURE                       R13 P10
       66 CAPTURE                          REF R6
       67 CAPTURE                          VAL R11
       68 JUMP                             ; [+1]
       69 DUPCLOSURE                       R13 K21 [PROTO_27]
       70 SETTABLEKS                       R13 R12 K11 ["provideAgentSaveData"]
       72 GETUPVAL                         R14 2
       73 CALL                             R14 0 1
       74 JUMPIFNOT                        R14 ; [+3]
       75 NEWCLOSURE                       R13 P12
       76 CAPTURE                          REF R6
       77 JUMP                             ; [+1]
       78 DUPCLOSURE                       R13 K22 [PROTO_31]
       79 SETTABLEKS                       R13 R12 K12 ["onAgentSaveReady"]
       81 GETUPVAL                         R14 2
       82 CALL                             R14 0 1
       83 JUMPIFNOT                        R14 ; [+4]
       84 NEWCLOSURE                       R13 P14
       85 CAPTURE                          REF R8
       86 CAPTURE                          VAL R7
       87 JUMP                             ; [+1]
       88 DUPCLOSURE                       R13 K23 [PROTO_33]
       89 SETTABLEKS                       R13 R12 K13 ["provideAgentRestoreData"]
       91 GETUPVAL                         R14 2
       92 CALL                             R14 0 1
       93 JUMPIFNOT                        R14 ; [+4]
       94 NEWCLOSURE                       R13 P16
       95 CAPTURE                          VAL R7
       96 CAPTURE                          REF R8
       97 JUMP                             ; [+1]
       98 DUPCLOSURE                       R13 K24 [PROTO_37]
       99 SETTABLEKS                       R13 R12 K14 ["onAgentRestoreReady"]
      101 NEWCLOSURE                       R13 P18
      102 CAPTURE                          VAL R11
      103 SETTABLEKS                       R13 R12 K15 ["waitForPendingSaves"]
      105 NEWCLOSURE                       R13 P19
      106 CAPTURE                          REF R9
      107 SETTABLEKS                       R13 R12 K16 ["clearDirty"]
      109 NEWCLOSURE                       R13 P20
      110 CAPTURE                          REF R9
      111 SETTABLEKS                       R13 R12 K17 ["onClearDirty"]
      113 NEWCLOSURE                       R13 P21
      114 CAPTURE                          REF R10
      115 SETTABLEKS                       R13 R12 K18 ["requestDelete"]
      117 NEWCLOSURE                       R13 P22
      118 CAPTURE                          REF R10
      119 SETTABLEKS                       R13 R12 K19 ["onDeleteRequested"]
      121 CLOSEUPVALS                      R1
      122 RETURN                           R12 1
...
MAIN:
       ...
       26 GETTABLEKS                       R5 R0 K6 ["Parent"]
       28 GETTABLEKS                       R5 R5 K10 ["Signal"]
       30 CALL                             R4 1 1
       31 GETIMPORT                        R5 K5 [require]
       33 GETTABLEKS                       R6 R0 K11 ["Types"]
       35 CALL                             R5 1 1
       36 GETTABLEKS                       R6 R2 K12 ["getIsAssistantHarnessSplit"]
       38 DUPCLOSURE                       R7 K13 [PROTO_7]
       39 CAPTURE                          VAL R4
       40 CAPTURE                          VAL R3
       41 DUPCLOSURE                       R8 K14 [PROTO_45]
       42 CAPTURE                          VAL R4
       43 CAPTURE                          VAL R7
       44 CAPTURE                          VAL R6
       45 LOADNIL                          R9
       46 DUPTABLE                         R10 K18 [{"new", "get", "set"}]
       47 SETTABLEKS                       R8 R10 K15 ["new"]
       49 NEWCLOSURE                       R11 P2
       50 CAPTURE                          REF R9
       51 SETTABLEKS                       R11 R10 K16 ["get"]
       53 NEWCLOSURE                       R11 P3
       54 CAPTURE                          REF R9
       55 SETTABLEKS                       R11 R10 K17 ["set"]
       57 CLOSEUPVALS                      R9
       58 RETURN                           R10 1
