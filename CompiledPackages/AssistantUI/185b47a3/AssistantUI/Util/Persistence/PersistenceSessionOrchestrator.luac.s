...
PROTO_22:
       ...
       54 JUMPIFNOT                        R3 ; [+12]
       55 GETUPVAL                         R4 0
       56 GETTABLEKS                       R4 R4 K10 ["FFlagAssistantACPServiceClearSessions"]
       58 JUMPIFNOT                        R4 ; [+3]
       59 LOADB                            R4 1
       60 SETTABLEKS                       R4 R3 K11 ["replaced"]
       62 GETTABLEKS                       R4 R3 K12 ["Destroying"]
       64 NAMECALL                         R4 R4 K13 ["Fire"]
       66 CALL                             R4 1 0
       67 DUPTABLE                         R4 K16 [{[1], ["placeId"], ["loadState"], ["replaced"] = False, ["Destroying"]}]
       68 GETTABLEKS                       R5 R1 K0 ["gameId"]
       70 SETTABLEKS                       R5 R4 K0 ["gameId"]
       72 GETTABLEKS                       R5 R1 K1 ["placeId"]
       74 SETTABLEKS                       R5 R4 K1 ["placeId"]
       76 GETUPVAL                         R5 3
       77 GETTABLEKS                       R5 R5 K17 ["Idle"]
       79 SETTABLEKS                       R5 R4 K14 ["loadState"]
       81 GETUPVAL                         R5 4
       82 GETTABLEKS                       R5 R5 K18 ["new"]
       84 CALL                             R5 0 1
       85 SETTABLEKS                       R5 R4 K12 ["Destroying"]
       87 GETUPVAL                         R5 1
       88 GETTABLEKS                       R6 R1 K4 ["sessionId"]
       90 SETTABLE                         R4 R5 R6
       91 GETUPVAL                         R5 5
       92 GETTABLEKS                       R7 R1 K4 ["sessionId"]
       94 NAMECALL                         R5 R5 K13 ["Fire"]
       96 CALL                             R5 2 0
       97 JUMPIFNOT                        R2 ; [+5]
       98 GETUPVAL                         R5 2
       99 GETTABLEKS                       R6 R1 K1 ["placeId"]
      101 LOADB                            R7 1
      102 SETTABLE                         R7 R5 R6
      103 JUMPIF                           R2 ; [+4]
      104 GETUPVAL                         R5 0
      105 GETTABLEKS                       R5 R5 K10 ["FFlagAssistantACPServiceClearSessions"]
      107 JUMPIFNOT                        R5 ; [+4]
      108 GETUPVAL                         R5 6
      109 GETUPVAL                         R6 7
      110 MOVE                             R7 R4
