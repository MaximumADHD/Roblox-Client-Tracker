...
PROTO_9:
        0 LENGTH                           R2 R0
        1 GETTABLE                         R1 R0 R2
        2 GETTABLEKS                       R3 R1 K0 ["toolResult"]
        4 FASTCALL2K                       ASSERT R3 K1 ; [+5]
        6 MOVE                             R5 R3
        7 LOADK                            R6 K1 ["Expected previous results to contain the search result from CreatorStoreSearch tool"]
        8 GETIMPORT                        R4 K3 [assert]
       10 CALL                             R4 2 0
       11 GETTABLEKS                       R5 R3 K4 ["content"]
       13 FASTCALL2K                       ASSERT R5 K5 ; [+4]
       15 LOADK                            R6 K5 ["Expected search tool result to contain content"]
       16 GETIMPORT                        R4 K3 [assert]
       18 CALL                             R4 2 0
       19 GETTABLEKS                       R4 R3 K4 ["content"]
       21 LOADNIL                          R5
       22 LOADNIL                          R6
       23 FORGPREP                         R4
       24 GETTABLEKS                       R9 R8 K6 ["type"]
       26 JUMPIFNOTEQKS                    R9 K7 ["text"] ; [+4]
       28 GETTABLEKS                       R2 R8 K7 ["text"]
       30 JUMP                             ; [+8]
       31 FORGLOOP                         R4 2 ; [-8]
       33 GETIMPORT                        R4 K9 [error]
       35 LOADK                            R5 K10 ["Expected search tool result content to include text"]
       36 LOADN                            R6 0
       37 CALL                             R4 2 0
       38 LOADNIL                          R2
       39 GETUPVAL                         R3 0
       40 MOVE                             R5 R2
       41 NAMECALL                         R3 R3 K11 ["JSONDecode"]
       43 CALL                             R3 2 1
       44 DUPTABLE                         R4 K14 [{"name", "arguments"}]
       45 GETUPVAL                         R5 1
       46 GETTABLEKS                       R5 R5 K15 ["CreatorStoreInsert"]
       48 SETTABLEKS                       R5 R4 K12 ["name"]
       50 DUPTABLE                         R5 K19 [{"searchId", "objectTypes", "assetName"}]
       51 GETTABLEKS                       R6 R3 K16 ["searchId"]
       53 SETTABLEKS                       R6 R5 K16 ["searchId"]
       55 GETTABLEKS                       R6 R3 K17 ["objectTypes"]
       57 SETTABLEKS                       R6 R5 K17 ["objectTypes"]
       59 GETUPVAL                         R6 2
       60 SETTABLEKS                       R6 R5 K18 ["assetName"]
       62 SETTABLEKS                       R5 R4 K13 ["arguments"]
       64 RETURN                           R4 1
...
PROTO_13:
       ...
       45 CALL                             R2 1 1
       46 DUPTABLE                         R3 K31 [{["command"] = "insert", ["getDescription"], ["runToolChain"], ["mapToToolCall"]}]
       47 DUPCLOSURE                       R4 K32 [PROTO_7]
       48 CAPTURE                          UPVAL U6
       49 SETTABLEKS                       R4 R3 K28 ["getDescription"]
       51 GETUPVAL                         R5 7
       52 GETTABLEKS                       R5 R5 K33 ["getIsAskInputToolEnabled"]
       54 CALL                             R5 0 1
       55 JUMPIFNOT                        R5 ; [+4]
       56 DUPCLOSURE                       R4 K34 [PROTO_10]
       57 CAPTURE                          UPVAL U5
       58 CAPTURE                          UPVAL U8
       59 JUMP                             ; [+1]
       60 LOADNIL                          R4
       61 SETTABLEKS                       R4 R3 K29 ["runToolChain"]
       63 GETUPVAL                         R5 7
       64 GETTABLEKS                       R5 R5 K33 ["getIsAskInputToolEnabled"]
       66 CALL                             R5 0 1
       67 JUMPIFNOT                        R5 ; [+2]
       68 LOADNIL                          R4
       69 JUMP                             ; [+3]
       70 DUPCLOSURE                       R4 K35 [PROTO_12]
       71 CAPTURE                          UPVAL U5
       72 CAPTURE                          UPVAL U8
       73 SETTABLEKS                       R4 R3 K30 ["mapToToolCall"]
       75 DUPTABLE                         R4 K38 [{"definition", "slashCommands"}]
       76 SETTABLEKS                       R2 R4 K36 ["definition"]
       78 NEWTABLE                         R5 0 1
       80 MOVE                             R6 R3
       81 SETLIST                          R5 R6 1 [1]
       83 SETTABLEKS                       R5 R4 K37 ["slashCommands"]
       85 RETURN                           R4 1
...
MAIN:
       ...
       22 GETTABLEKS                       R4 R0 K12 ["FlagUtils"]
       24 CALL                             R3 1 1
       25 GETIMPORT                        R4 K9 [require]
       27 GETTABLEKS                       R5 R0 K13 ["Flags"]
       29 CALL                             R4 1 1
       30 GETIMPORT                        R5 K9 [require]
       32 GETTABLEKS                       R6 R0 K14 ["Parent"]
       34 GETTABLEKS                       R6 R6 K15 ["ModelContextProtocol"]
       36 CALL                             R5 1 1
       37 GETIMPORT                        R6 K9 [require]
       39 GETTABLEKS                       R7 R0 K16 ["Tools"]
       41 GETTABLEKS                       R7 R7 K17 ["ToolTypes"]
       43 CALL                             R6 1 1
       44 GETIMPORT                        R7 K9 [require]
       46 GETTABLEKS                       R8 R0 K18 ["Util"]
       48 GETTABLEKS                       R8 R8 K19 ["ToolUtils"]
       50 CALL                             R7 1 1
       51 GETIMPORT                        R8 K9 [require]
       53 GETTABLEKS                       R9 R0 K20 ["Resources"]
       55 GETTABLEKS                       R9 R9 K21 ["Localization"]
       57 GETTABLEKS                       R9 R9 K22 ["Translator"]
       59 CALL                             R8 1 1
       60 GETTABLEKS                       R9 R0 K23 ["Features"]
       62 GETTABLEKS                       R9 R9 K24 ["CreatorStore"]
       64 GETIMPORT                        R10 K9 [require]
       66 GETTABLEKS                       R11 R9 K25 ["CreatorStoreSearchCache"]
       68 CALL                             R10 1 1
       69 GETIMPORT                        R11 K9 [require]
       71 GETTABLEKS                       R12 R9 K26 ["CreatorStoreTypes"]
       73 CALL                             R11 1 1
       74 GETIMPORT                        R12 K9 [require]
       76 GETTABLEKS                       R13 R9 K27 ["CreatorStoreSearchTool"]
       78 CALL                             R12 1 1
       79 GETTABLEKS                       R13 R5 K18 ["Util"]
       81 GETTABLEKS                       R13 R13 K28 ["ToolBuilder"]
       83 GETTABLEKS                       R14 R5 K18 ["Util"]
       85 GETTABLEKS                       R14 R14 K29 ["ToolResult"]
       87 GETTABLEKS                       R15 R6 K30 ["ToolNames"]
       89 DUPCLOSURE                       R16 K31 [PROTO_0]
       90 CAPTURE                          VAL R1
       91 DUPCLOSURE                       R17 K32 [PROTO_1]
       92 DUPCLOSURE                       R18 K33 [PROTO_3]
       93 DUPCLOSURE                       R19 K34 [PROTO_4]
       94 CAPTURE                          VAL R1
       95 CAPTURE                          VAL R17
       96 CAPTURE                          VAL R10
       97 CAPTURE                          VAL R18
       98 CAPTURE                          VAL R7
       99 DUPCLOSURE                       R20 K35 [PROTO_5]
      100 DUPCLOSURE                       R21 K36 [PROTO_13]
      101 CAPTURE                          VAL R4
      102 CAPTURE                          VAL R12
      103 CAPTURE                          VAL R19
      104 CAPTURE                          VAL R14
