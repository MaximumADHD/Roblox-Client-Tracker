...
PROTO_3:
       ...
       51 GETUPVAL                         R7 8
       52 GETTABLEKS                       R7 R7 K25 ["FFlagAssistantSplitToolsAndWidgets"]
       54 JUMPIFNOT                        R7 ; [+2]
       55 LOADNIL                          R6
       56 JUMP                             ; [+2]
       57 DUPCLOSURE                       R6 K26 [PROTO_2]
       58 CAPTURE                          UPVAL U9
       59 SETTABLEKS                       R6 R5 K23 ["displayNameFunction"]
       61 RETURN                           R5 1
...
MAIN:
       ...
       28 GETTABLEKS                       R4 R1 K13 ["Flags"]
       30 CALL                             R3 1 1
       31 GETIMPORT                        R4 K9 [require]
       33 GETTABLEKS                       R5 R1 K10 ["Parent"]
       35 GETTABLEKS                       R5 R5 K14 ["ModelContextProtocol"]
       37 CALL                             R4 1 1
       38 GETIMPORT                        R5 K9 [require]
       40 GETTABLEKS                       R6 R1 K11 ["Util"]
       42 GETTABLEKS                       R6 R6 K15 ["MultiPlayersConnection"]
       44 GETTABLEKS                       R6 R6 K16 ["MultiPlayersAgentClient"]
       46 CALL                             R5 1 1
       47 GETIMPORT                        R6 K9 [require]
       49 GETTABLEKS                       R7 R1 K11 ["Util"]
       51 GETTABLEKS                       R7 R7 K15 ["MultiPlayersConnection"]
       53 GETTABLEKS                       R7 R7 K17 ["MultiPlayersAgentServer"]
       55 CALL                             R6 1 1
       56 GETIMPORT                        R7 K9 [require]
       58 GETTABLEKS                       R8 R1 K11 ["Util"]
       60 GETTABLEKS                       R8 R8 K15 ["MultiPlayersConnection"]
       62 GETTABLEKS                       R8 R8 K18 ["MultiPlayersModeUtils"]
       64 CALL                             R7 1 1
       65 GETIMPORT                        R8 K9 [require]
       67 GETTABLEKS                       R9 R1 K19 ["Tools"]
       69 GETTABLEKS                       R9 R9 K20 ["ToolTypes"]
       71 CALL                             R8 1 1
       72 GETIMPORT                        R9 K9 [require]
       74 GETTABLEKS                       R10 R1 K21 ["Resources"]
       76 GETTABLEKS                       R10 R10 K22 ["Localization"]
       78 GETTABLEKS                       R10 R10 K23 ["Translator"]
       80 CALL                             R9 1 1
       81 GETTABLEKS                       R10 R4 K11 ["Util"]
       83 GETTABLEKS                       R10 R10 K24 ["ToolBuilder"]
       85 GETTABLEKS                       R11 R4 K11 ["Util"]
       87 GETTABLEKS                       R11 R11 K25 ["ToolResult"]
       89 GETTABLEKS                       R12 R8 K26 ["ToolNames"]
