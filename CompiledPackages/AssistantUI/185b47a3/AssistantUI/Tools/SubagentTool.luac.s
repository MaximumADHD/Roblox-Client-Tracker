...
PROTO_9:
      ...
      121 DUPTABLE                         R8 K39 [{"definition", "prompt", "context", "requestLLM", "callTool", "formattedTools", "contentId", "parentMessageGuid", "parentToolId", "onPacketReceived"}]
      122 SETTABLEKS                       R3 R8 K29 ["definition"]
      124 GETTABLEKS                       R9 R0 K40 ["task"]
      126 SETTABLEKS                       R9 R8 K30 ["prompt"]
      128 GETTABLEKS                       R9 R0 K31 ["context"]
      130 SETTABLEKS                       R9 R8 K31 ["context"]
      132 SETTABLEKS                       R4 R8 K32 ["requestLLM"]
      134 GETUPVAL                         R9 6
      135 MOVE                             R10 R2
      136 MOVE                             R11 R1
      137 MOVE                             R12 R3
      138 CALL                             R9 3 1
      139 SETTABLEKS                       R9 R8 K33 ["callTool"]
      141 SETTABLEKS                       R5 R8 K34 ["formattedTools"]
      143 JUMPIFNOT                        R1 ; [+3]
      144 GETTABLEKS                       R9 R1 K35 ["contentId"]
      146 JUMP                             ; [+1]
      147 LOADNIL                          R9
      148 SETTABLEKS                       R9 R8 K35 ["contentId"]
      150 JUMPIFNOT                        R1 ; [+3]
      151 GETTABLEKS                       R9 R1 K41 ["messageGuid"]
      153 JUMP                             ; [+1]
      154 LOADNIL                          R9
      155 SETTABLEKS                       R9 R8 K36 ["parentMessageGuid"]
      157 JUMPIFNOT                        R1 ; [+3]
      158 GETTABLEKS                       R9 R1 K42 ["toolId"]
      160 JUMP                             ; [+1]
      161 LOADNIL                          R9
      162 SETTABLEKS                       R9 R8 K37 ["parentToolId"]
      164 NEWCLOSURE                       R9 P2
      165 CAPTURE                          VAL R2
      166 SETTABLEKS                       R9 R8 K38 ["onPacketReceived"]
      168 MOVE                             R9 R6
      169 CALL                             R7 2 1
      170 GETTABLEKS                       R8 R7 K43 ["error"]
      172 JUMPIFNOT                        R8 ; [+22]
      173 GETUPVAL                         R8 1
      174 CALL                             R8 0 1
      175 LOADK                            R11 K44 ["Subagent encountered an error: %*\n\nPartial result:\n%*"]
      176 GETTABLEKS                       R13 R7 K43 ["error"]
      178 GETTABLEKS                       R14 R7 K45 ["finalAnswer"]
      180 NAMECALL                         R11 R11 K8 ["format"]
      182 CALL                             R11 3 1
      183 MOVE                             R10 R11
      184 NAMECALL                         R8 R8 K9 ["addText"]
      186 CALL                             R8 2 1
      187 LOADB                            R10 1
      188 NAMECALL                         R8 R8 K10 ["setError"]
      190 CALL                             R8 2 1
      191 NAMECALL                         R8 R8 K11 ["build"]
      193 CALL                             R8 1 -1
      194 RETURN                           R8 -1
      195 GETUPVAL                         R8 1
      196 CALL                             R8 0 1
      197 GETTABLEKS                       R10 R7 K45 ["finalAnswer"]
      199 NAMECALL                         R8 R8 K9 ["addText"]
      201 CALL                             R8 2 1
      202 NAMECALL                         R8 R8 K11 ["build"]
      204 CALL                             R8 1 -1
      205 RETURN                           R8 -1
...
PROTO_15:
       ...
       72 CALL                             R4 1 1
       73 DUPTABLE                         R5 K43 [{"transformInitialContent", "getTransformPreExecuteFn", "getTransformResultFn"}]
       74 DUPCLOSURE                       R6 K44 [PROTO_10]
       75 CAPTURE                          UPVAL U9
       76 SETTABLEKS                       R6 R5 K40 ["transformInitialContent"]
       78 DUPCLOSURE                       R6 K45 [PROTO_12]
       79 SETTABLEKS                       R6 R5 K41 ["getTransformPreExecuteFn"]
       81 DUPCLOSURE                       R6 K46 [PROTO_14]
       82 SETTABLEKS                       R6 R5 K42 ["getTransformResultFn"]
       84 DUPTABLE                         R6 K52 [{"definition", "toolCallOptions", "contentWidgets", "streamTransform", "getDescription"}]
       85 SETTABLEKS                       R4 R6 K47 ["definition"]
       87 DUPTABLE                         R7 K57 [{["timeout"] = 600000, ["resetTimeoutOnProgress"] = True}]
       88 SETTABLEKS                       R7 R6 K48 ["toolCallOptions"]
       90 GETUPVAL                         R8 3
       91 GETTABLEKS                       R8 R8 K58 ["FFlagAssistantSplitToolsAndWidgets"]
       93 JUMPIFNOT                        R8 ; [+2]
       94 LOADNIL                          R7
       95 JUMP                             ; [+5]
       96 NEWTABLE                         R7 0 1
      ...
      101 SETTABLEKS                       R7 R6 K49 ["contentWidgets"]
      103 GETUPVAL                         R8 3
      104 GETTABLEKS                       R8 R8 K58 ["FFlagAssistantSplitToolsAndWidgets"]
      106 JUMPIFNOT                        R8 ; [+2]
      107 LOADNIL                          R7
      108 JUMP                             ; [+1]
      109 MOVE                             R7 R5
      110 SETTABLEKS                       R7 R6 K50 ["streamTransform"]
      112 GETUPVAL                         R7 8
      113 SETTABLEKS                       R7 R6 K51 ["getDescription"]
      115 RETURN                           R6 1
...
MAIN:
       ...
       20 GETTABLEKS                       R3 R3 K10 ["SubagentContentWidget"]
       22 CALL                             R2 1 1
