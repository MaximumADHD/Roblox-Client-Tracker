PROTO_0:
        ...
        4 JUMPIFNOT                        R0 ; [+5]
        5 GETUPVAL                         R1 0
        6 GETTABLEKS                       R1 R1 K1 ["enable"]
        8 CALL                             R1 0 0
        9 JUMP                             ; [+4]
       10 GETUPVAL                         R1 0
       11 GETTABLEKS                       R1 R1 K2 ["disable"]
       13 CALL                             R1 0 0
       14 GETUPVAL                         R1 1
       15 GETTABLEKS                       R1 R1 K3 ["setHostIsPlaying"]
       17 JUMPIFNOT                        R1 ; [+5]
       18 GETUPVAL                         R1 1
       19 GETTABLEKS                       R1 R1 K3 ["setHostIsPlaying"]
       21 MOVE                             R2 R0
       22 CALL                             R1 1 0
       23 RETURN                           R0 0
...
MAIN:
       ...
       26 GETTABLEKS                       R6 R1 K10 ["Signal"]
       28 CALL                             R5 1 1
       29 GETIMPORT                        R6 K6 [require]
       31 GETTABLEKS                       R7 R0 K11 ["Hooks"]
       33 GETTABLEKS                       R7 R7 K12 ["useEventConnection"]
       35 CALL                             R6 1 1
       36 GETIMPORT                        R7 K6 [require]
       38 GETTABLEKS                       R8 R0 K13 ["Util"]
       40 GETTABLEKS                       R8 R8 K14 ["AnimationGen"]
       42 GETTABLEKS                       R8 R8 K15 ["usePlayedCurrentTime"]
       44 CALL                             R7 1 1
       45 GETTABLEKS                       R8 R2 K16 ["Dropdown"]
       47 GETTABLEKS                       R9 R2 K17 ["IconButton"]
       49 GETTABLEKS                       R10 R2 K18 ["Slider"]
       51 GETTABLEKS                       R11 R2 K19 ["Text"]
       53 GETTABLEKS                       R12 R2 K20 ["View"]
       55 GETTABLEKS                       R13 R4 K21 ["createNextOrder"]
       57 GETTABLEKS                       R14 R3 K22 ["createElement"]
       59 NEWTABLE                         R15 0 5
       61 DUPTABLE                         R16 K27 [{["id"] = 0.25, ["text"] = "0.25x"}]
       62 DUPTABLE                         R17 K30 [{["id"] = 0.5, ["text"] = "0.5x"}]
       63 DUPTABLE                         R18 K33 [{["id"] = 1, ["text"] = "1x"}]
       64 DUPTABLE                         R19 K36 [{["id"] = 2, ["text"] = "2x"}]
       65 DUPTABLE                         R20 K39 [{["id"] = 4, ["text"] = "4x"}]
       66 SETLIST                          R15 R16 5 [1]
       68 DUPCLOSURE                       R16 K40 [PROTO_10]
       69 CAPTURE                          VAL R4
       70 CAPTURE                          VAL R3
       71 CAPTURE                          VAL R7
       72 CAPTURE                          VAL R6
