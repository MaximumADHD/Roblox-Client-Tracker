...
MAIN:
       ...
       41 GETTABLEKS                       R6 R6 K16 ["SegmentMesh"]
       43 GETTABLEKS                       R6 R6 K17 ["SegmentMeshTypes"]
       45 CALL                             R5 1 1
       46 GETTABLEKS                       R6 R2 K18 ["createGenerationSessions"]
       48 CALL                             R6 0 1
       49 DUPCLOSURE                       R7 K19 [PROTO_0]
       50 CAPTURE                          VAL R3
       51 DUPCLOSURE                       R8 K20 [PROTO_1]
       52 CAPTURE                          VAL R2
       53 CAPTURE                          VAL R3
       54 CAPTURE                          VAL R6
       55 DUPCLOSURE                       R9 K21 [PROTO_2]
       56 CAPTURE                          VAL R2
       57 CAPTURE                          VAL R6
       ...
       61 CAPTURE                          VAL R3
       62 CAPTURE                          VAL R6
       63 DUPCLOSURE                       R11 K23 [PROTO_4]
       64 CAPTURE                          VAL R2
       65 CAPTURE                          VAL R7
       66 DUPCLOSURE                       R12 K24 [PROTO_5]
       67 CAPTURE                          VAL R3
       68 CAPTURE                          VAL R2
       69 DUPTABLE                         R13 K30 [{"generateSegmentMeshAsync", "cancelSegmentationAsync", "insertSegmentedModelAsync", "getSelectedMeshRef", "isSegmentableInstance"}]
       70 SETTABLEKS                       R8 R13 K25 ["generateSegmentMeshAsync"]
       72 SETTABLEKS                       R9 R13 K26 ["cancelSegmentationAsync"]
       74 SETTABLEKS                       R10 R13 K27 ["insertSegmentedModelAsync"]
       76 SETTABLEKS                       R11 R13 K28 ["getSelectedMeshRef"]
       78 SETTABLEKS                       R12 R13 K29 ["isSegmentableInstance"]
       80 DUPTABLE                         R14 K32 [{"bridge"}]
       81 SETTABLEKS                       R13 R14 K31 ["bridge"]
       83 RETURN                           R14 1
