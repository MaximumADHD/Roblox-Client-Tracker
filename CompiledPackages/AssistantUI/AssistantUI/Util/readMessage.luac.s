...
PROTO_2:
  ...
  CALL R2 2 0
  DUPTABLE R2 K8 [{"message", "startEditTimestamp", "lastEditTimestamp"}]
  DUPTABLE R3 K9 [{"content", "role"}]
  NEWTABLE R4 0 1
...
PROTO_3:
  ...
  JUMPIFNOTEQ R7 R8 [+38]
  GETTABLEKS R7 R6 K6 ["text"]
  JUMPIFEQKS R7 K7 [""] [+143]
  DUPTABLE R8 K8 [{"type", "text"}]
  LOADK R9 K6 ["text"]
  SETTABLEKS R9 R8 K4 ["type"]
  GETTABLEKS R9 R6 K6 ["text"]
  SETTABLEKS R9 R8 K6 ["text"]
  DUPTABLE R11 K14 [{"content", "layoutOrder", "priority", "startEditTimestamp", "lastEditTimestamp"}]
  SETTABLEKS R8 R11 K9 ["content"]
  GETTABLEKS R12 R6 K15 ["LayoutOrder"]
  ...
  GETTABLEKS R7 R6 K19 ["thinking"]
  JUMPIFNOTEQKS R7 K7 [""] [+5]
  GETTABLEKS R7 R6 K20 ["signature"]
  JUMPIFEQKS R7 K7 [""] [+95]
  DUPTABLE R7 K21 [{"type", "thinking", "signature"}]
  LOADK R8 K19 ["thinking"]
  SETTABLEKS R8 R7 K4 ["type"]
  GETTABLEKS R8 R6 K19 ["thinking"]
  SETTABLEKS R8 R7 K19 ["thinking"]
  GETTABLEKS R8 R6 K20 ["signature"]
  SETTABLEKS R8 R7 K20 ["signature"]
  DUPTABLE R10 K14 [{"content", "layoutOrder", "priority", "startEditTimestamp", "lastEditTimestamp"}]
  SETTABLEKS R7 R10 K9 ["content"]
  GETTABLEKS R11 R6 K15 ["LayoutOrder"]
  ...
  JUMPIFNOT R7 [+26]
  DUPTABLE R9 K14 [{"content", "layoutOrder", "priority", "startEditTimestamp", "lastEditTimestamp"}]
  GETTABLEKS R10 R6 K22 ["toolUse"]
  SETTABLEKS R10 R9 K9 ["content"]
  GETTABLEKS R10 R6 K15 ["LayoutOrder"]
  ...
  JUMPIFNOT R7 [+26]
  DUPTABLE R9 K14 [{"content", "layoutOrder", "priority", "startEditTimestamp", "lastEditTimestamp"}]
  GETTABLEKS R10 R6 K23 ["toolResult"]
  SETTABLEKS R10 R9 K9 ["content"]
  GETTABLEKS R10 R6 K15 ["LayoutOrder"]
  SETTABLEKS R10 R9 K10 ["layoutOrder"]
  LOADN R10 3
  ...
  CALL R7 2 0
  FORGLOOP R2 2 [-154]
  GETIMPORT R2 K25 [table.sort]
  MOVE R3 R1
  GETUPVAL R4 3
  CALL R2 2 0
  NEWTABLE R2 0 0
  DUPTABLE R3 K27 [{"message", "startEditTimestamp", "lastEditTimestamp"}]
  DUPTABLE R4 K29 [{"content", "role"}]
  NEWTABLE R5 0 0
  SETTABLEKS R5 R4 K9 ["content"]
  GETTABLEKS R5 R0 K28 ["role"]
  SETTABLEKS R5 R4 K28 ["role"]
  SETTABLEKS R4 R3 K26 ["message"]
  LOADN R4 0
  ...
  GETTABLEKS R12 R11 K4 ["type"]
  JUMPIFNOTEQKS R12 K30 ["image"] [+7]
  MOVE R12 R5
  GETTABLEKS R13 R0 K28 ["role"]
  MOVE R14 R10
  CALL R12 2 0
  JUMP [+33]
  GETTABLEKS R12 R11 K4 ["type"]
  JUMPIFNOTEQKS R12 K19 ["thinking"] [+6]
  MOVE R12 R5
  LOADK R13 K31 ["assistant"]
  MOVE R14 R10
  CALL R12 2 0
  JUMP [+24]
  GETTABLEKS R12 R11 K4 ["type"]
  JUMPIFNOTEQKS R12 K32 ["tool_use"] [+6]
  MOVE R12 R5
  LOADK R13 K31 ["assistant"]
  MOVE R14 R10
  CALL R12 2 0
  JUMP [+15]
  GETTABLEKS R12 R11 K4 ["type"]
  JUMPIFNOTEQKS R12 K33 ["tool_result"] [+6]
  MOVE R12 R5
  LOADK R13 K34 ["user"]
  MOVE R14 R10
  CALL R12 2 0
  JUMP [+6]
  GETUPVAL R13 4
  GETTABLEKS R12 R13 K35 ["assertNever"]
  GETTABLEKS R13 R11 K4 ["type"]
  CALL R12 1 0
  FORGLOOP R6 2 [-50]
  GETTABLEKS R8 R3 K26 ["message"]
...
PROTO_6:
  ...
  JUMPIFEQKS R7 K8 [""] [+143]
  DUPTABLE R8 K9 [{"type", "text"}]
  LOADK R9 K7 ["text"]
  SETTABLEKS R9 R8 K5 ["type"]
  GETTABLEKS R9 R6 K7 ["text"]
  SETTABLEKS R9 R8 K7 ["text"]
  DUPTABLE R11 K15 [{"content", "layoutOrder", "priority", "startEditTimestamp", "lastEditTimestamp"}]
  ...
  DUPTABLE R10 K15 [{"content", "layoutOrder", "priority", "startEditTimestamp", "lastEditTimestamp"}]
  ...
  GETIMPORT R8 K3 [table.insert]
  CALL R8 2 0
  GETTABLEKS R7 R6 K20 ["toolUse"]
  JUMPIFNOT R7 [+26]
  DUPTABLE R9 K15 [{"content", "layoutOrder", "priority", "startEditTimestamp", "lastEditTimestamp"}]
  GETTABLEKS R10 R6 K20 ["toolUse"]
  ...
  CALL R7 2 0
  GETTABLEKS R7 R6 K21 ["toolResult"]
  JUMPIFNOT R7 [+26]
  DUPTABLE R9 K15 [{"content", "layoutOrder", "priority", "startEditTimestamp", "lastEditTimestamp"}]
  GETTABLEKS R10 R6 K21 ["toolResult"]
  SETTABLEKS R10 R9 K10 ["content"]
  GETTABLEKS R10 R6 K16 ["LayoutOrder"]
  SETTABLEKS R10 R9 K11 ["layoutOrder"]
  LOADN R10 3
  ...
  CALL R7 2 0
  FORGLOOP R2 2 [-154]
  GETIMPORT R2 K23 [table.sort]
  MOVE R3 R1
  GETUPVAL R4 4
  CALL R2 2 0
  NEWTABLE R2 0 0
  DUPTABLE R3 K25 [{"content", "role"}]
  NEWTABLE R4 0 0
  SETTABLEKS R4 R3 K10 ["content"]
  GETTABLEKS R4 R0 K24 ["role"]
  SETTABLEKS R4 R3 K24 ["role"]
  NEWCLOSURE R4 P0
  CAPTURE REF R3
  CAPTURE VAL R2
  NEWCLOSURE R5 P1
  ...
  GETTABLEKS R12 R11 K5 ["type"]
  JUMPIFNOTEQKS R12 K26 ["image"] [+7]
  MOVE R12 R5
  GETTABLEKS R13 R0 K24 ["role"]
  MOVE R14 R11
  CALL R12 2 0
  JUMP [+33]
  GETTABLEKS R12 R11 K5 ["type"]
  ...
  MOVE R12 R5
  LOADK R13 K27 ["assistant"]
  MOVE R14 R11
  CALL R12 2 0
  JUMP [+24]
  GETTABLEKS R12 R11 K5 ["type"]
  JUMPIFNOTEQKS R12 K28 ["tool_use"] [+6]
  MOVE R12 R5
  LOADK R13 K27 ["assistant"]
  MOVE R14 R11
  CALL R12 2 0
  JUMP [+15]
  GETTABLEKS R12 R11 K5 ["type"]
  JUMPIFNOTEQKS R12 K29 ["tool_result"] [+6]
  MOVE R12 R5
  LOADK R13 K30 ["user"]
  MOVE R14 R11
  CALL R12 2 0
  JUMP [+6]
  GETUPVAL R13 5
  GETTABLEKS R12 R13 K31 ["assertNever"]
