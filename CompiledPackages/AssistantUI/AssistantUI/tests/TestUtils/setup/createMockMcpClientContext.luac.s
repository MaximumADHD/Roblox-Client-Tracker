...
MAIN:
  ...
  GETTABLEKS R9 R10 K19 ["UIToolRegistry"]
  CALL R8 1 1
  GETTABLEKS R9 R2 K20 ["MultiplexedClient"]
  GETTABLEKS R10 R2 K21 ["PeerTransport"]
  GETTABLEKS R11 R2 K22 ["Server"]
  GETTABLEKS R13 R2 K23 ["Util"]
  GETTABLEKS R12 R13 K24 ["ToolBuilder"]
  GETTABLEKS R13 R2 K25 ["ToolRegistry"]
  GETTABLEKS R15 R2 K23 ["Util"]
  GETTABLEKS R14 R15 K26 ["ToolResult"]
  GETTABLEKS R15 R3 K27 ["createElement"]
  DUPCLOSURE R16 K28 [PROTO_0]
  CAPTURE VAL R10
  DUPCLOSURE R17 K29 [PROTO_3]
  CAPTURE VAL R11
  CAPTURE VAL R13
  DUPCLOSURE R18 K30 [PROTO_23]
  CAPTURE VAL R12
  CAPTURE VAL R14
  CAPTURE VAL R4
  CAPTURE VAL R8
  CAPTURE VAL R5
  DUPCLOSURE R19 K31 [PROTO_30]
  CAPTURE VAL R8
  CAPTURE VAL R18
  CAPTURE VAL R6
  CAPTURE VAL R10
