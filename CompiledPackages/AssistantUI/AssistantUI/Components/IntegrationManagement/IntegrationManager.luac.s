...
PROTO_2:
  GETUPVAL R1 0
  GETTABLEKS R0 R1 K0 ["getSettingsAsync"]
  CALL R0 0 -1
  RETURN R0 -1
...
PROTO_4:
  GETUPVAL R1 0
  GETTABLEKS R0 R1 K0 ["setSettingsAsync"]
  NEWTABLE R1 1 0
  GETUPVAL R2 1
  SETTABLEKS R2 R1 K1 ["integrations"]
  CALL R0 1 0
  RETURN R0 0
...
MAIN:
  ...
  CAPTURE VAL R8
  CAPTURE VAL R7
  SETTABLEKS R9 R5 K26 ["getIntegrationsAsync"]
  DUPCLOSURE R9 K27 [PROTO_5]
  CAPTURE VAL R4
  SETTABLEKS R9 R5 K28 ["setIntegrationsAsync"]
  RETURN R5 1
