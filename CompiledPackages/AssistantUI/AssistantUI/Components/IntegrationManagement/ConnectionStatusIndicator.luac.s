PROTO_0:
  ...
  JUMP [+10]
  GETUPVAL R4 0
  GETTABLEKS R3 R4 K6 ["AuthorizationPending"]
  JUMPIFNOTEQ R0 R3 [+4]
  LOADK R1 K7 ["content-action-link"]
  LOADK R2 K8 ["icons/navigation/externallink"]
  JUMP [+2]
  LOADK R1 K9 ["content-system-alert"]
  LOADK R2 K3 ["component_assets/circle_16"]
  LOADB R4 0
  JUMPIFEQKS R1 K0 [""] [+5]
  ...
  LOADK R5 K10 ["Expected colorTag and icon to be set"]
...
PROTO_3:
  ...
  JUMP [+10]
  GETUPVAL R8 2
  GETTABLEKS R7 R8 K11 ["AuthorizationPending"]
  JUMPIFNOTEQ R4 R7 [+4]
  LOADK R5 K12 ["content-action-link"]
  LOADK R6 K13 ["icons/navigation/externallink"]
  JUMP [+2]
  LOADK R5 K14 ["content-system-alert"]
  LOADK R6 K8 ["component_assets/circle_16"]
  LOADB R8 0
  JUMPIFEQKS R5 K5 [""] [+5]
  ...
  LOADK R9 K15 ["Expected colorTag and icon to be set"]
  ...
  JUMP [+19]
  GETUPVAL R7 2
  GETTABLEKS R6 R7 K11 ["AuthorizationPending"]
  JUMPIFNOTEQ R5 R6 [+4]
  GETTABLEKS R4 R1 K11 ["AuthorizationPending"]
  JUMP [+11]
  GETUPVAL R7 2
  GETTABLEKS R6 R7 K18 ["UnsupportedProtocolVersion"]
  JUMPIFNOTEQ R5 R6 [+4]
  GETTABLEKS R4 R1 K19 ["Unsupported"]
  JUMP [+3]
  GETTABLEKS R4 R1 K20 ["ConnectionError"]
  JUMP [0]
  GETUPVAL R5 3
  CALL R5 0 1
  GETUPVAL R6 4
  GETUPVAL R7 5
  DUPTABLE R8 K23 [{"tag", "LayoutOrder"}]
  LOADK R9 K24 ["row auto-xy align-y-center"]
  SETTABLEKS R9 R8 K21 ["tag"]
  GETTABLEKS R9 R0 K22 ["LayoutOrder"]
  SETTABLEKS R9 R8 K22 ["LayoutOrder"]
  DUPTABLE R9 K27 [{"Icon", "Text"}]
  GETUPVAL R10 4
  GETUPVAL R11 6
  DUPTABLE R12 K30 [{"icon", "tag", "iconTag", "LayoutOrder"}]
  SETTABLEKS R3 R12 K28 ["icon"]
  LOADK R13 K31 ["size-400-400 align-x-center align-y-center"]
  SETTABLEKS R13 R12 K21 ["tag"]
  NEWTABLE R13 2 0
  LOADB R14 1
  SETTABLEKS R14 R13 K32 ["size-200-200"]
  LOADB R14 1
  SETTABLE R14 R13 R2
  SETTABLEKS R13 R12 K29 ["iconTag"]
  MOVE R13 R5
  CALL R13 0 1
  ...
  GETUPVAL R10 4
  GETUPVAL R11 7
  DUPTABLE R12 K34 [{"tag", "Text", "LayoutOrder", "onActivated"}]
  LOADK R13 K35 ["auto-xy text-body-small text-no-wrap text-align-x-left"]
  SETTABLEKS R13 R12 K21 ["tag"]
  SETTABLEKS R4 R12 K26 ["Text"]
  MOVE R13 R5
  CALL R13 0 1
  SETTABLEKS R13 R12 K22 ["LayoutOrder"]
  ...
  GETUPVAL R16 2
  GETTABLEKS R15 R16 K11 ["AuthorizationPending"]
  JUMPIFNOTEQ R14 R15 [+4]
  GETTABLEKS R13 R0 K36 ["onLogin"]
  JUMP [+1]
  LOADNIL R13
  SETTABLEKS R13 R12 K33 ["onActivated"]
  CALL R10 2 1
