...
PROTO_1:
  DUPTABLE R0 K3 [{"ManageIntegrations", "Add", "Disclaimer"}]
  GETUPVAL R1 0
  ...
  GETUPVAL R1 0
  LOADK R3 K4 ["IntegrationManagement"]
  LOADK R4 K2 ["Disclaimer"]
  NAMECALL R1 R1 K5 ["getText"]
  CALL R1 3 1
  SETTABLEKS R1 R0 K2 ["Disclaimer"]
  RETURN R0 1
...
PROTO_2:
  ...
  DUPTABLE R7 K11 [{"TitleAndButton", "Disclaimer", "IntegrationsDisabledNotice"}]
  GETUPVAL R8 3
  GETUPVAL R9 4
  ...
  LOADK R11 K12 ["row size-full-0 auto-y gap-small align-y-center"]
  SETTABLEKS R11 R10 K5 ["tag"]
  DUPTABLE R11 K16 [{"TitleText", "Spacer", "AddIntegrationButtonContainer"}]
  GETUPVAL R12 3
  GETUPVAL R13 5
  DUPTABLE R14 K18 [{"tag", "Text", "LayoutOrder"}]
  LOADK R15 K19 ["auto-xy text-title-medium bold text-align-x-left"]
  SETTABLEKS R15 R14 K5 ["tag"]
  GETTABLEKS R15 R2 K20 ["ManageIntegrations"]
  SETTABLEKS R15 R14 K17 ["Text"]
  MOVE R15 R1
  CALL R15 0 1
  SETTABLEKS R15 R14 K4 ["LayoutOrder"]
  CALL R12 2 1
  SETTABLEKS R12 R11 K13 ["TitleText"]
  GETUPVAL R12 3
  GETUPVAL R13 4
  ...
  SETTABLEKS R15 R14 K4 ["LayoutOrder"]
  CALL R12 2 1
  SETTABLEKS R12 R11 K14 ["Spacer"]
  GETUPVAL R12 3
  GETUPVAL R13 4
  DUPTABLE R14 K24 [{"LayoutOrder", "tag", "GroupTransparency"}]
  MOVE R15 R1
  CALL R15 0 1
  SETTABLEKS R15 R14 K4 ["LayoutOrder"]
  LOADK R15 K25 ["auto-xy"]
  SETTABLEKS R15 R14 K5 ["tag"]
  JUMPIFNOT R3 [+2]
  LOADN R15 0
  JUMP [+1]
  LOADN R15 1
  SETTABLEKS R15 R14 K23 ["GroupTransparency"]
  DUPTABLE R15 K27 [{"AddIntegrationButton"}]
  GETUPVAL R16 3
  GETUPVAL R17 6
  DUPTABLE R18 K31 [{"text", "size", "onActivated"}]
  GETTABLEKS R19 R2 K32 ["Add"]
  SETTABLEKS R19 R18 K28 ["text"]
  GETUPVAL R20 7
  GETTABLEKS R19 R20 K33 ["XSmall"]
  ...
  CALL R16 2 1
  SETTABLEKS R16 R15 K26 ["AddIntegrationButton"]
  CALL R12 3 1
  SETTABLEKS R12 R11 K15 ["AddIntegrationButtonContainer"]
  CALL R8 3 1
  SETTABLEKS R8 R7 K8 ["TitleAndButton"]
  GETUPVAL R8 3
  GETUPVAL R9 5
  DUPTABLE R10 K18 [{"tag", "Text", "LayoutOrder"}]
  LOADK R11 K34 ["auto-xy text-caption-small text-wrap text-align-x-left"]
  SETTABLEKS R11 R10 K5 ["tag"]
  GETTABLEKS R11 R2 K9 ["Disclaimer"]
  SETTABLEKS R11 R10 K17 ["Text"]
  MOVE R11 R1
  CALL R11 0 1
  SETTABLEKS R11 R10 K4 ["LayoutOrder"]
  CALL R8 2 1
  SETTABLEKS R8 R7 K9 ["Disclaimer"]
  GETUPVAL R8 3
  GETUPVAL R9 9
  DUPTABLE R10 K35 [{"LayoutOrder"}]
  MOVE R11 R1
  CALL R11 0 1
  SETTABLEKS R11 R10 K4 ["LayoutOrder"]
  CALL R8 2 1
  SETTABLEKS R8 R7 K10 ["IntegrationsDisabledNotice"]
  CALL R4 3 -1
  RETURN R4 -1
