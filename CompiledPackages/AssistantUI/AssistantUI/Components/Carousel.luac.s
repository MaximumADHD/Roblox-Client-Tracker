PROTO_0:
  ...
  LOADK R12 K26 ["Assistant-CarouselItem-Selected"]
  SETTABLEKS R12 R11 K22 ["testId"]
  DUPTABLE R12 K29 [{"UICorner", "UIStroke"}]
  GETUPVAL R13 1
  LOADK R14 K27 ["UICorner"]
  DUPTABLE R15 K31 [{"CornerRadius"}]
  GETIMPORT R16 K34 [UDim.new]
  LOADN R17 0
  SUBK R18 R4 K35 [2]
  CALL R16 2 1
  SETTABLEKS R16 R15 K30 ["CornerRadius"]
  CALL R13 2 1
  SETTABLEKS R13 R12 K27 ["UICorner"]
  GETUPVAL R13 1
  LOADK R14 K28 ["UIStroke"]
  DUPTABLE R15 K38 [{"Thickness", "Color"}]
  LOADN R16 2
  SETTABLEKS R16 R15 K36 ["Thickness"]
  GETIMPORT R16 K40 [Color3.new]
  LOADN R17 1
  LOADN R18 1
  LOADN R19 1
  CALL R16 3 1
  SETTABLEKS R16 R15 K37 ["Color"]
  CALL R13 2 1
  SETTABLEKS R13 R12 K28 ["UIStroke"]
  CALL R9 3 1
  SETTABLEKS R9 R8 K16 ["InnerBorder"]
  GETUPVAL R9 1
  GETUPVAL R10 3
  DUPTABLE R11 K41 [{"tag", "Image"}]
  LOADK R12 K42 ["size-full-full radius-small anchor-center-center position-center-center"]
  SETTABLEKS R12 R11 K7 ["tag"]
  GETTABLEKS R12 R0 K43 ["uri"]
  SETTABLEKS R12 R11 K17 ["Image"]
  CALL R9 2 1
  SETTABLEKS R9 R8 K17 ["Image"]
  GETUPVAL R9 1
  LOADK R10 K18 ["UIPadding"]
  DUPTABLE R11 K48 [{"PaddingLeft", "PaddingRight", "PaddingTop", "PaddingBottom"}]
  ...
  MOVE R14 R3
  CALL R12 2 1
  SETTABLEKS R12 R11 K46 ["PaddingTop"]
  GETIMPORT R12 K34 [UDim.new]
  LOADN R13 0
  MOVE R14 R3
  CALL R12 2 1
  SETTABLEKS R12 R11 K47 ["PaddingBottom"]
  CALL R9 2 1
...
PROTO_3:
  ...
  LOADK R13 K25 ["Assistant-Carousel-Container"]
