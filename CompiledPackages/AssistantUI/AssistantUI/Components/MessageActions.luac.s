...
PROTO_2:
  ...
  DUPTABLE R3 K8 [{"messageGuid", "sessionId"}]
  SETTABLEKS R1 R3 K6 ["messageGuid"]
  GETUPVAL R4 4
  SETTABLEKS R4 R3 K7 ["sessionId"]
  CALL R2 1 0
  RETURN R0 0
...
PROTO_4:
  ...
  DUPTABLE R3 K7 [{"messageGuid", "sessionId"}]
  SETTABLEKS R1 R3 K5 ["messageGuid"]
  GETUPVAL R4 2
  SETTABLEKS R4 R3 K6 ["sessionId"]
  CALL R2 1 0
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K8 ["retryMessage"]
  CALL R2 0 0
  RETURN R0 0
...
PROTO_5:
  ...
  GETUPVAL R23 14
  GETTABLEKS R22 R23 K30 ["MessageActions"]
  GETTABLEKS R21 R22 K31 ["ThumbsUp"]
  ...
  GETUPVAL R23 14
  GETTABLEKS R22 R23 K30 ["MessageActions"]
  GETTABLEKS R21 R22 K32 ["ThumbsDown"]
  SETTABLEKS R21 R20 K26 ["testId"]
  CALL R18 2 1
...
MAIN:
  ...
  GETTABLEKS R7 R8 K15 ["SessionIdContext"]
  CALL R6 1 1
  GETIMPORT R7 K5 [require]
  GETTABLEKS R9 R0 K16 ["Util"]
  GETTABLEKS R8 R9 K17 ["TestIds"]
  CALL R7 1 1
  GETIMPORT R8 K5 [require]
  GETTABLEKS R9 R0 K18 ["Types"]
  CALL R8 1 1
  GETIMPORT R9 K5 [require]
  GETTABLEKS R11 R0 K16 ["Util"]
  GETTABLEKS R10 R11 K19 ["callOnce"]
  CALL R9 1 1
  GETIMPORT R10 K5 [require]
  GETTABLEKS R12 R0 K20 ["Hooks"]
  GETTABLEKS R11 R12 K21 ["useLogAssistantMessageSent"]
  CALL R10 1 1
  GETTABLEKS R11 R3 K22 ["View"]
  GETTABLEKS R12 R5 K23 ["createNextOrder"]
  GETTABLEKS R13 R4 K24 ["createElement"]
  DUPTABLE R14 K27 [{"Dark", "Light"}]
  LOADK R15 K28 ["rbxasset://studio_svg_textures/Shared/GenerativeAI/Dark/Standard/ThumbsUpOutline.png"]
  SETTABLEKS R15 R14 K25 ["Dark"]
  LOADK R15 K29 ["rbxasset://studio_svg_textures/Shared/GenerativeAI/Light/Standard/ThumbsUpOutline.png"]
  SETTABLEKS R15 R14 K26 ["Light"]
  DUPTABLE R15 K27 [{"Dark", "Light"}]
  LOADK R16 K30 ["rbxasset://studio_svg_textures/Shared/GenerativeAI/Dark/Standard/ThumbsUp.png"]
  SETTABLEKS R16 R15 K25 ["Dark"]
  LOADK R16 K31 ["rbxasset://studio_svg_textures/Shared/GenerativeAI/Light/Standard/ThumbsUp.png"]
  SETTABLEKS R16 R15 K26 ["Light"]
  DUPTABLE R16 K27 [{"Dark", "Light"}]
  LOADK R17 K32 ["rbxasset://studio_svg_textures/Shared/GenerativeAI/Dark/Standard/ThumbsDownOutline.png"]
  SETTABLEKS R17 R16 K25 ["Dark"]
  LOADK R17 K33 ["rbxasset://studio_svg_textures/Shared/GenerativeAI/Light/Standard/ThumbsDownOutline.png"]
  SETTABLEKS R17 R16 K26 ["Light"]
  DUPTABLE R17 K27 [{"Dark", "Light"}]
  LOADK R18 K34 ["rbxasset://studio_svg_textures/Shared/GenerativeAI/Dark/Standard/ThumbsDown.png"]
  SETTABLEKS R18 R17 K25 ["Dark"]
  LOADK R18 K35 ["rbxasset://studio_svg_textures/Shared/GenerativeAI/Light/Standard/ThumbsDown.png"]
  SETTABLEKS R18 R17 K26 ["Light"]
  DUPTABLE R18 K27 [{"Dark", "Light"}]
  LOADK R19 K36 ["rbxasset://studio_svg_textures/Shared/GenerativeAI/Dark/Standard/Regenerate.png"]
  SETTABLEKS R19 R18 K25 ["Dark"]
  LOADK R19 K37 ["rbxasset://studio_svg_textures/Shared/GenerativeAI/Light/Standard/Regenerate.png"]
  SETTABLEKS R19 R18 K26 ["Light"]
