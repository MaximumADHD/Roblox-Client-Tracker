...
MAIN:
  ...
  GETTABLEKS R6 R0 K6 ["Components"]
  GETTABLEKS R5 R6 K7 ["Contexts"]
  GETTABLEKS R4 R5 K13 ["Claude"]
  GETIMPORT R5 K5 [require]
  GETTABLEKS R6 R4 K14 ["ClaudeLLMRequest"]
  CALL R5 1 1
  GETIMPORT R6 K5 [require]
  GETTABLEKS R7 R4 K15 ["ClaudeLLMSystemMessage"]
  CALL R6 1 1
  GETIMPORT R7 K5 [require]
  GETTABLEKS R8 R4 K16 ["ClaudeLLMToolFormat"]
  CALL R7 1 1
  ...
  CAPTURE VAL R8
  CAPTURE VAL R1
  DUPTABLE R10 K21 [{"Context", "Provider"}]
  GETTABLEKS R11 R1 K19 ["Context"]
  SETTABLEKS R11 R10 K19 ["Context"]
  SETTABLEKS R9 R10 K20 ["Provider"]
  RETURN R10 1
