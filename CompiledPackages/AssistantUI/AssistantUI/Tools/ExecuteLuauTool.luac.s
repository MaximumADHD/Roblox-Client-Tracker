...
PROTO_13:
  GETTABLEKS R1 R0 K0 ["input"]
  JUMPIFNOT R1 [+4]
  GETTABLEKS R2 R0 K0 ["input"]
...
PROTO_16:
  ...
  DUPTABLE R7 K36 [{"transformInitialContent", "getTransformDeltaFn", "getTransformPreExecuteFn"}]
  DUPCLOSURE R8 K37 [PROTO_9]
  CAPTURE UPVAL U10
  ...
  JUMP [+1]
  LOADNIL R8
  SETTABLEKS R8 R7 K35 ["getTransformPreExecuteFn"]
  DUPTABLE R8 K46 [{"definition", "slashCommands", "contentWidgets", "streamTransform", "getPreExecuteWarning", "displayNameFunction"}]
  SETTABLEKS R5 R8 K40 ["definition"]
  NEWTABLE R9 0 1
  MOVE R10 R6
  SETLIST R9 R10 1 [1]
  SETTABLEKS R9 R8 K41 ["slashCommands"]
  GETUPVAL R10 12
  CALL R10 0 1
  JUMPIFNOT R10 [+6]
  NEWTABLE R9 0 1
  ...
  JUMP [+1]
  LOADNIL R9
  SETTABLEKS R9 R8 K42 ["contentWidgets"]
  SETTABLEKS R7 R8 K43 ["streamTransform"]
  DUPCLOSURE R9 K47 [PROTO_14]
  CAPTURE UPVAL U13
  SETTABLEKS R9 R8 K44 ["getPreExecuteWarning"]
  DUPCLOSURE R9 K48 [PROTO_15]
  CAPTURE UPVAL U9
  SETTABLEKS R9 R8 K45 ["displayNameFunction"]
  RETURN R8 1
...
MAIN:
  ...
  GETTABLEKS R12 R13 K27 ["FFlagAssistantRegisterWidgetsThroughTools"]
  CALL R11 1 1
  GETIMPORT R12 K9 [require]
  GETTABLEKS R14 R0 K26 ["Flags"]
  GETTABLEKS R13 R14 K28 ["FFlagAssistantToolResultSerialization"]
  CALL R12 1 1
  GETIMPORT R13 K9 [require]
  GETTABLEKS R15 R0 K26 ["Flags"]
  GETTABLEKS R14 R15 K29 ["FFlagMCPAssistantSlashCommandMenu"]
  CALL R13 1 1
  GETTABLEKS R15 R4 K10 ["Util"]
  GETTABLEKS R14 R15 K30 ["ToolBuilder"]
  GETTABLEKS R16 R4 K10 ["Util"]
  GETTABLEKS R15 R16 K31 ["ToolResult"]
  GETTABLEKS R16 R7 K32 ["ToolNames"]
  GETTABLEKS R17 R6 K33 ["NETWORK_KEYS"]
