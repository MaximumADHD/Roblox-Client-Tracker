...
PROTO_4:
  ...
  LENGTH R7 R6
  LOADN R8 0
  JUMPIFNOTLT R8 R7 [+109]
  JUMPIFNOTLT R4 R5 [+107]
  ...
  CALL R12 2 1
  JUMPIFNOT R12 [+48]
  DUPTABLE R13 K14 [{"name", "className", "fullPath", "parentName"}]
  GETTABLEKS R14 R8 K15 ["Name"]
  SETTABLEKS R14 R13 K10 ["name"]
  GETTABLEKS R14 R8 K16 ["ClassName"]
  SETTABLEKS R14 R13 K11 ["className"]
  SETTABLEKS R10 R13 K12 ["fullPath"]
  GETTABLEKS R14 R8 K17 ["Parent"]
  JUMPIFNOT R14 [+4]
  GETTABLEKS R15 R8 K17 ["Parent"]
  GETTABLEKS R14 R15 K15 ["Name"]
  SETTABLEKS R14 R13 K13 ["parentName"]
  JUMPIFNOTLE R2 R9 [+19]
  LENGTH R14 R11
  LOADN R15 0
  ...
  MOVE R15 R8
  CALL R14 1 1
  SETTABLEKS R14 R13 K18 ["childSummary"]
  GETUPVAL R14 4
  MOVE R15 R8
  MOVE R16 R1
  CALL R14 2 1
  ...
  SETTABLEKS R14 R13 K19 ["unexploredChildCount"]
