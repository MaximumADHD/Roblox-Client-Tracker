PROTO_0:
  ...
  LOADNIL R5
  FORGPREP R3
  DUPTABLE R10 K3 [{"className", "path"}]
  GETTABLEKS R11 R7 K4 ["ClassName"]
  SETTABLEKS R11 R10 K1 ["className"]
  NAMECALL R11 R7 K5 ["GetFullName"]
  CALL R11 1 1
  SETTABLEKS R11 R10 K2 ["path"]
  FASTCALL2 TABLE_INSERT R2 R10 [+4]
  MOVE R9 R2
  GETIMPORT R8 K8 [table.insert]
  CALL R8 2 0
  FORGLOOP R3 2 [-17]
  DUPTABLE R3 K12 [{"immediateChildren", "totalDescendants", "childrenCount"}]
  SETTABLEKS R2 R3 K9 ["immediateChildren"]
  NAMECALL R5 R0 K13 ["GetDescendants"]
  CALL R5 1 1
  LENGTH R4 R5
  SETTABLEKS R4 R3 K10 ["totalDescendants"]
  LENGTH R4 R1
  SETTABLEKS R4 R3 K11 ["childrenCount"]
  RETURN R3 1
