...
PROTO_23:
  ...
  CALL R2 2 1
  JUMPIF R2 [+5]
  LOADK R4 K3 ["ModuleScript"]
  NAMECALL R2 R1 K1 ["IsA"]
  CALL R2 2 1
  JUMPIFNOT R2 [+8]
  GETTABLEKS R2 R0 K4 ["getScriptSource"]
  MOVE R3 R1
  CALL R2 1 1
  JUMPIFNOT R2 [+3]
  JUMPIFEQKS R2 K5 [""] [+2]
...
PROTO_25:
  ...
  CALL R2 1 1
  GETUPVAL R4 0
  GETTABLEKS R3 R4 K1 ["isPathExcluded"]
  MOVE R4 R2
  CALL R3 1 1
  JUMPIFNOT R3 [+2]
  LOADB R3 0
  ...
  LOADB R3 0
  RETURN R3 1
  GETTABLEKS R3 R1 K4 ["glob"]
  JUMPIFNOT R3 [+8]
  GETUPVAL R3 1
  MOVE R4 R2
  GETTABLEKS R5 R1 K4 ["glob"]
  CALL R3 2 1
  JUMPIF R3 [+2]
  LOADB R3 0
  RETURN R3 1
...
PROTO_29:
  ...
  CALL R6 2 1
  JUMPIFNOT R6 [+9]
  GETTABLEKS R6 R0 K4 ["getScriptSource"]
  MOVE R7 R1
  CALL R6 1 1
  JUMPIFNOT R6 [+4]
  JUMPIFEQKS R6 K5 [""] [+3]
  ...
  JUMPIF R5 [+1]
  RETURN R4 1
  NAMECALL R6 R1 K6 ["GetFullName"]
  CALL R6 1 1
  GETUPVAL R7 0
  MOVE R8 R5
  GETTABLEKS R9 R2 K7 ["patternMatcher"]
  GETTABLEKS R10 R2 K8 ["multiline"]
  CALL R7 3 1
  LENGTH R8 R7
  LOADN R9 0
  JUMPIFNOTLT R9 R8 [+51]
  GETTABLEKS R8 R2 K9 ["outputMode"]
  JUMPIFNOTEQKS R8 K10 ["files_with_matches"] [+10]
  ...
  RETURN R4 1
  GETTABLEKS R8 R2 K9 ["outputMode"]
  JUMPIFNOTEQKS R8 K20 ["content"] [+17]
  GETUPVAL R8 1
  MOVE R9 R3
  MOVE R10 R6
  MOVE R11 R5
  MOVE R12 R7
  GETTABLEKS R13 R2 K21 ["showLineNumbers"]
  GETTABLEKS R14 R2 K22 ["contextBefore"]
  GETTABLEKS R15 R2 K23 ["contextAfter"]
  GETTABLEKS R16 R2 K24 ["headLimit"]
  MOVE R17 R4
  CALL R8 9 1
  MOVE R4 R8
  RETURN R4 1
...
PROTO_30:
  ...
  JUMPIF R3 [+1]
  JUMPIF R2 [+2]
  ORK R4 R3 K0 ["Unknown error creating search context"]
  RETURN R4 1
  NEWTABLE R4 0 0
  LOADN R5 0
  GETIMPORT R6 K2 [game]
  NAMECALL R6 R6 K3 ["GetDescendants"]
  CALL R6 1 3
  FORGPREP R6
  GETTABLEKS R11 R2 K4 ["headLimit"]
  JUMPIFLE R11 R5 [+21]
  GETUPVAL R11 1
  MOVE R12 R10
  MOVE R13 R1
  ...
  LOADK R6 K6 ["No matches found for the given query."]
  RETURN R6 1
  GETTABLEKS R6 R2 K4 ["headLimit"]
  JUMPIFNOTLE R6 R5 [+8]
  FASTCALL2K TABLE_INSERT R4 K7 [+5]
  MOVE R7 R4
  LOADK R8 K7 ["... Search stopped after reaching the output limit."]
...
PROTO_33:
  ...
  CALL R5 0 1
  GETUPVAL R8 3
  GETTABLEKS R7 R8 K5 ["Grep"]
  NAMECALL R5 R5 K6 ["setName"]
  CALL R5 2 1
  LOADK R7 K7 ["A ripgrep style search tool for Roblox game hierarchy with regex support, glob pattern matching, and path based filtering. Output is limited to 50 results by default, override `headLimit` to change the output limit.
...
"]
  ...
  LOADK R9 K14 ["The regular expression pattern to search for in file contents"]
  ...
  LOADK R9 K13 ["string"]
  SETTABLEKS R9 R8 K10 ["type"]
  LOADK R9 K17 ["Substring filter for Roblox paths. Searches entire game hierarchy, only includes scripts whose full path contains this substring. Uses literal string matching (not patterns). Case sensitive."]
  SETTABLEKS R9 R8 K11 ["description"]
  NAMECALL R5 R5 K18 ["addOptionalArgument"]
  CALL R5 3 1
  LOADK R7 K19 ["output_mode"]
  DUPTABLE R8 K12 [{"type", "description"}]
  LOADK R9 K13 ["string"]
  SETTABLEKS R9 R8 K10 ["type"]
  LOADK R9 K20 ["Output mode: \"content\" shows matching lines (supports -A/-B/-C context, -n line numbers, head_limit), \"files_with_matches\" shows file paths (supports head_limit), \"count\" shows match counts (supports head_limit). Defaults to \"files_with_matches\"."]
  SETTABLEKS R9 R8 K11 ["description"]
  NAMECALL R5 R5 K18 ["addOptionalArgument"]
  CALL R5 3 1
  LOADK R7 K21 ["glob"]
  ...
  LOADK R9 K13 ["string"]
  SETTABLEKS R9 R8 K10 ["type"]
  LOADK R9 K22 ["Glob pattern to filter files using Unix-style paths. Use \"/\" as path separator (e.g., \"Workspace/Scripts/*\" to match direct children of Scripts folder). Dots in patterns are literal. Supports * (single level), ** (multi-level), ? (single char). Examples: \"ServerStorage/*\", \"Workspace/**/*\", \"*/Utils/*\"."]
  SETTABLEKS R9 R8 K11 ["description"]
  NAMECALL R5 R5 K18 ["addOptionalArgument"]
  CALL R5 3 1
  LOADK R7 K23 ["script_class"]
  DUPTABLE R8 K25 [{"enum", "description"}]
  NEWTABLE R9 0 3
  LOADK R10 K26 ["Script"]
  LOADK R11 K27 ["LocalScript"]
  LOADK R12 K28 ["ModuleScript"]
  SETLIST R9 R10 3 [1]
  SETTABLEKS R9 R8 K24 ["enum"]
  LOADK R9 K29 ["Filter by script class: \"Script\", \"LocalScript\", or \"ModuleScript\". Only applies to script objects. Case sensitive."]
  SETTABLEKS R9 R8 K11 ["description"]
  NAMECALL R5 R5 K18 ["addOptionalArgument"]
  CALL R5 3 1
  LOADK R7 K30 ["instance_type"]
  DUPTABLE R8 K12 [{"type", "description"}]
  LOADK R9 K13 ["string"]
  SETTABLEKS R9 R8 K10 ["type"]
  LOADK R9 K31 ["Filter by Roblox instance type (e.g., \"Part\", \"Frame\", \"Folder\"). Only searches scripts that are descendants of objects matching this type. Case sensitive."]
  SETTABLEKS R9 R8 K11 ["description"]
  NAMECALL R5 R5 K18 ["addOptionalArgument"]
  CALL R5 3 1
  LOADK R7 K32 ["-i"]
  DUPTABLE R8 K12 [{"type", "description"}]
  LOADK R9 K33 ["boolean"]
  SETTABLEKS R9 R8 K10 ["type"]
  LOADK R9 K34 ["Case insensitive search. Doesn't affect the behavior of script class or instance type filtering, only pattern matching within files."]
  SETTABLEKS R9 R8 K11 ["description"]
  NAMECALL R5 R5 K18 ["addOptionalArgument"]
  CALL R5 3 1
  LOADK R7 K35 ["-n"]
  ...
  LOADK R9 K33 ["boolean"]
  SETTABLEKS R9 R8 K10 ["type"]
  LOADK R9 K36 ["Show line numbers in output. Requires output_mode: \"content\", ignored otherwise."]
  SETTABLEKS R9 R8 K11 ["description"]
  NAMECALL R5 R5 K18 ["addOptionalArgument"]
  CALL R5 3 1
  LOADK R7 K37 ["-A"]
  ...
  LOADK R9 K38 ["number"]
  SETTABLEKS R9 R8 K10 ["type"]
  LOADK R9 K39 ["Number of lines to show after each match. Requires output_mode: \"content\", ignored otherwise."]
  SETTABLEKS R9 R8 K11 ["description"]
  NAMECALL R5 R5 K18 ["addOptionalArgument"]
  CALL R5 3 1
  LOADK R7 K40 ["-B"]
  ...
  LOADK R9 K38 ["number"]
  SETTABLEKS R9 R8 K10 ["type"]
  LOADK R9 K41 ["Number of lines to show before each match. Requires output_mode: \"content\", ignored otherwise."]
  SETTABLEKS R9 R8 K11 ["description"]
  NAMECALL R5 R5 K18 ["addOptionalArgument"]
  CALL R5 3 1
  LOADK R7 K42 ["-C"]
  ...
  LOADK R9 K38 ["number"]
  SETTABLEKS R9 R8 K10 ["type"]
  LOADK R9 K43 ["Number of lines to show before and after each match. Requires output_mode: \"content\", ignored otherwise."]
  SETTABLEKS R9 R8 K11 ["description"]
  NAMECALL R5 R5 K18 ["addOptionalArgument"]
  CALL R5 3 1
  LOADK R7 K44 ["multiline"]
  DUPTABLE R8 K12 [{"type", "description"}]
  LOADK R9 K33 ["boolean"]
  SETTABLEKS R9 R8 K10 ["type"]
  LOADK R9 K45 ["Enable multiline mode where . matches newlines and patterns can span lines. Default: false."]
  SETTABLEKS R9 R8 K11 ["description"]
  NAMECALL R5 R5 K18 ["addOptionalArgument"]
  CALL R5 3 1
  LOADK R7 K46 ["head_limit"]
  DUPTABLE R8 K12 [{"type", "description"}]
  LOADK R9 K38 ["number"]
  SETTABLEKS R9 R8 K10 ["type"]
  LOADK R9 K47 ["Limit output to first N lines/entries, equivalent to \"| head -N\". Works across all output modes: content (limits output lines), files_with_matches (limits file paths), count (limits count entries). Default: 50."]
  SETTABLEKS R9 R8 K11 ["description"]
  NAMECALL R5 R5 K18 ["addOptionalArgument"]
  CALL R5 3 1
  MOVE R7 R4
  NAMECALL R5 R5 K48 ["setHandler"]
  CALL R5 2 1
  NAMECALL R5 R5 K49 ["build"]
  CALL R5 1 1
  DUPTABLE R6 K51 [{"definition"}]
  SETTABLEKS R5 R6 K50 ["definition"]
  RETURN R6 1
...
MAIN:
  ...
  NEWCLOSURE R23 P14
  CAPTURE REF R21
  DUPCLOSURE R24 K27 [PROTO_18]
  DUPCLOSURE R21 K28 [PROTO_20]
  CAPTURE VAL R22
  CAPTURE VAL R23
  CAPTURE VAL R24
  DUPCLOSURE R25 K29 [PROTO_21]
  DUPCLOSURE R26 K30 [PROTO_22]
  DUPCLOSURE R27 K31 [PROTO_23]
  DUPCLOSURE R28 K32 [PROTO_24]
  NEWCLOSURE R29 P21
  CAPTURE VAL R4
  CAPTURE REF R21
  DUPCLOSURE R30 K33 [PROTO_26]
  DUPCLOSURE R31 K34 [PROTO_27]
  DUPCLOSURE R32 K35 [PROTO_28]
  CAPTURE VAL R20
  CAPTURE VAL R16
  DUPCLOSURE R33 K36 [PROTO_29]
  CAPTURE VAL R30
  CAPTURE VAL R31
  DUPCLOSURE R34 K37 [PROTO_30]
  CAPTURE VAL R32
  CAPTURE VAL R28
  CAPTURE VAL R29
  CAPTURE VAL R33
  DUPCLOSURE R35 K38 [PROTO_33]
  CAPTURE VAL R34
  CAPTURE VAL R6
  CAPTURE VAL R5
  CAPTURE VAL R7
