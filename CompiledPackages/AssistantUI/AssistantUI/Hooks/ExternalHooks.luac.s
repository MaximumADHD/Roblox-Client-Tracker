...
PROTO_2:
  ...
  GETUPVAL R2 6
  CALL R2 0 1
  SETTABLEKS R2 R1 K4 ["getOrAddMessage"]
  GETUPVAL R1 1
  GETUPVAL R2 7
  CALL R2 0 1
  SETTABLEKS R2 R1 K5 ["getThread"]
  GETUPVAL R2 8
  GETTABLEKS R1 R2 K6 ["useContext"]
  GETUPVAL R3 9
  GETTABLEKS R2 R3 K7 ["Context"]
  CALL R1 1 1
  GETUPVAL R2 1
  GETUPVAL R3 10
  DUPTABLE R4 K9 [{"setInputEnabled"}]
  GETUPVAL R5 11
  MOVE R6 R1
  CALL R5 1 1
  SETTABLEKS R5 R4 K8 ["setInputEnabled"]
  CALL R3 1 1
  SETTABLEKS R3 R2 K10 ["sendMessage"]
  RETURN R0 0
...
PROTO_10:
  DUPTABLE R0 K7 [{"addMessage", "addTextContent", "addToolContent", "editContent", "getOrAddMessage", "getThread", "sendMessage"}]
  ...
  CAPTURE UPVAL U0
  SETTABLEKS R1 R0 K4 ["getOrAddMessage"]
  DUPCLOSURE R1 K13 [PROTO_8]
  CAPTURE UPVAL U0
  SETTABLEKS R1 R0 K5 ["getThread"]
  DUPCLOSURE R1 K14 [PROTO_9]
  CAPTURE UPVAL U0
  SETTABLEKS R1 R0 K6 ["sendMessage"]
  RETURN R0 1
...
MAIN:
  ...
  GETTABLEKS R11 R12 K21 ["useGetOrAddMessage"]
  CALL R10 1 1
  GETIMPORT R11 K5 [require]
  GETTABLEKS R13 R0 K17 ["Hooks"]
  GETTABLEKS R12 R13 K22 ["useGetThread"]
  CALL R11 1 1
  GETIMPORT R12 K5 [require]
  GETTABLEKS R14 R0 K17 ["Hooks"]
  GETTABLEKS R13 R14 K23 ["useSendMessage"]
  CALL R12 1 1
  DUPTABLE R13 K31 [{"addMessage", "addTextContent", "addToolContent", "editContent", "getOrAddMessage", "getThread", "sendMessage"}]
  LOADNIL R14
  SETTABLEKS R14 R13 K24 ["addMessage"]
  LOADNIL R14
  SETTABLEKS R14 R13 K25 ["addTextContent"]
  LOADNIL R14
  SETTABLEKS R14 R13 K26 ["addToolContent"]
  LOADNIL R14
  SETTABLEKS R14 R13 K27 ["editContent"]
  LOADNIL R14
  SETTABLEKS R14 R13 K28 ["getOrAddMessage"]
  LOADNIL R14
  SETTABLEKS R14 R13 K29 ["getThread"]
  LOADNIL R14
  SETTABLEKS R14 R13 K30 ["sendMessage"]
  ...
  CAPTURE VAL R13
  DUPTABLE R16 K36 [{"use", "get"}]
  SETTABLEKS R14 R16 K34 ["use"]
  SETTABLEKS R15 R16 K35 ["get"]
  RETURN R16 1
