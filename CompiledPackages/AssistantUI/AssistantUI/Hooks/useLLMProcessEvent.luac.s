PROTO_0:
  ...
  MOVE R2 R0
  LOADK R3 K2 ["useLLMProcessEvent must be used within a LLMPackageContextProvider"]
  GETIMPORT R1 K4 [assert]
  CALL R1 2 0
  DUPTABLE R1 K7 [{"createLLMSession", "processEvent"}]
  GETTABLEKS R2 R0 K5 ["createLLMSession"]
  SETTABLEKS R2 R1 K5 ["createLLMSession"]
  GETTABLEKS R2 R0 K6 ["processEvent"]
  SETTABLEKS R2 R1 K6 ["processEvent"]
  RETURN R1 1
