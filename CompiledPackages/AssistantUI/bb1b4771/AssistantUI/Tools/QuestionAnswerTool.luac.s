...
PROTO_15:
       ...
       32 CALL                             R4 1 1
       33 GETUPVAL                         R5 8
       34 GETTABLEKS                       R5 R5 K8 ["define"]
       36 CALL                             R5 0 1
       37 GETUPVAL                         R7 7
       38 GETTABLEKS                       R7 R7 K9 ["QuestionAnswer"]
       40 NAMECALL                         R5 R5 K10 ["setName"]
       42 CALL                             R5 2 1
       43 MOVE                             R7 R4
       44 NAMECALL                         R5 R5 K11 ["setDescription"]
       46 CALL                             R5 2 1
       47 LOADK                            R7 K12 ["questions"]
       48 DUPTABLE                         R8 K18 [{["type"] = "array", ["description"] = "An array of questions to present to the user.", ["items"]}]
       49 DUPTABLE                         R9 K22 [{["type"] = "object", ["properties"], ["required"]}]
       50 DUPTABLE                         R10 K25 [{"question", "options"}]
       51 DUPTABLE                         R11 K28 [{["type"] = "string", ["description"] = "The question text to display."}]
       52 SETTABLEKS                       R11 R10 K23 ["question"]
       54 DUPTABLE                         R11 K30 [{["type"] = "array", ["description"] = "Optional predefined answer choices.", ["items"]}]
       55 DUPTABLE                         R12 K22 [{["type"] = "object", ["properties"], ["required"]}]
       56 DUPTABLE                         R13 K33 [{"optionText", "clarificationText"}]
       57 DUPTABLE                         R14 K35 [{["type"] = "string", ["description"] = "The display text for this option."}]
       58 SETTABLEKS                       R14 R13 K31 ["optionText"]
       60 DUPTABLE                         R14 K37 [{["type"] = "string", ["description"] = "Additional context or explanation for this option."}]
       61 SETTABLEKS                       R14 R13 K32 ["clarificationText"]
       63 SETTABLEKS                       R13 R12 K20 ["properties"]
       65 NEWTABLE                         R13 0 2
       67 LOADK                            R14 K31 ["optionText"]
       68 LOADK                            R15 K32 ["clarificationText"]
       69 SETLIST                          R13 R14 2 [1]
       71 SETTABLEKS                       R13 R12 K21 ["required"]
       73 SETTABLEKS                       R12 R11 K17 ["items"]
       75 SETTABLEKS                       R11 R10 K24 ["options"]
       77 SETTABLEKS                       R10 R9 K20 ["properties"]
       79 NEWTABLE                         R10 0 1
       81 LOADK                            R11 K23 ["question"]
       82 SETLIST                          R10 R11 1 [1]
       84 SETTABLEKS                       R10 R9 K21 ["required"]
       86 SETTABLEKS                       R9 R8 K17 ["items"]
       88 NAMECALL                         R5 R5 K38 ["addArgument"]
       90 CALL                             R5 3 1
       91 DUPTABLE                         R7 K47 [{["title"] = "Question Answer", ["readOnlyHint"] = True, ["destructiveHint"] = False, ["idempotentHint"] = False, ["openWorldHint"] = False}]
       92 NAMECALL                         R5 R5 K48 ["setAnnotations"]
       94 CALL                             R5 2 1
       95 MOVE                             R7 R3
       96 NAMECALL                         R5 R5 K49 ["setHandler"]
       98 CALL                             R5 2 1
       99 NAMECALL                         R5 R5 K50 ["build"]
      101 CALL                             R5 1 1
      102 DUPTABLE                         R6 K54 [{"transformInitialContent", "getTransformPreExecuteFn", "getTransformResultFn"}]
      103 DUPCLOSURE                       R7 K55 [PROTO_10]
      104 CAPTURE                          UPVAL U9
      105 CAPTURE                          UPVAL U10
      106 SETTABLEKS                       R7 R6 K51 ["transformInitialContent"]
      108 DUPCLOSURE                       R7 K56 [PROTO_12]
      109 CAPTURE                          UPVAL U10
      110 SETTABLEKS                       R7 R6 K52 ["getTransformPreExecuteFn"]
      112 DUPCLOSURE                       R7 K57 [PROTO_14]
      113 CAPTURE                          UPVAL U10
      114 SETTABLEKS                       R7 R6 K53 ["getTransformResultFn"]
      116 DUPTABLE                         R7 K61 [{"definition", "contentWidgets", "streamTransform"}]
      117 SETTABLEKS                       R5 R7 K58 ["definition"]
      119 GETUPVAL                         R9 0
      120 GETTABLEKS                       R9 R9 K2 ["FFlagAssistantSplitToolsAndWidgets"]
      122 JUMPIFNOT                        R9 ; [+2]
      123 LOADNIL                          R8
      124 JUMP                             ; [+5]
      125 NEWTABLE                         R8 0 1
      ...
      130 SETTABLEKS                       R8 R7 K59 ["contentWidgets"]
      132 GETUPVAL                         R9 0
      133 GETTABLEKS                       R9 R9 K2 ["FFlagAssistantSplitToolsAndWidgets"]
      135 JUMPIFNOT                        R9 ; [+2]
      136 LOADNIL                          R8
      137 JUMP                             ; [+1]
      138 MOVE                             R8 R6
      139 SETTABLEKS                       R8 R7 K60 ["streamTransform"]
      141 RETURN                           R7 1
