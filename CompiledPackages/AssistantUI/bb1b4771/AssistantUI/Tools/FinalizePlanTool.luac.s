...
PROTO_1:
      ...
      240 CALL                             R6 2 0
      241 DUPTABLE                         R6 K35 [{["status"] = "presented", ["planId"], ["name"]}]
      242 SETTABLEKS                       R5 R6 K34 ["planId"]
      244 SETTABLEKS                       R3 R6 K18 ["name"]
      246 GETUPVAL                         R7 4
      247 GETTABLEKS                       R7 R7 K36 ["toString"]
      249 MOVE                             R8 R6
      250 CALL                             R7 1 1
      251 GETUPVAL                         R8 5
      252 CALL                             R8 0 1
      253 MOVE                             R10 R7
      254 NAMECALL                         R8 R8 K37 ["addText"]
      256 CALL                             R8 2 1
      257 MOVE                             R10 R6
      258 NAMECALL                         R8 R8 K38 ["setStructuredContent"]
      260 CALL                             R8 2 1
      261 NAMECALL                         R8 R8 K39 ["build"]
      263 CALL                             R8 1 -1
      264 RETURN                           R8 -1
      265 DUPTABLE                         R3 K40 [{["status"] = "presented"}]
      266 GETUPVAL                         R4 4
      267 GETTABLEKS                       R4 R4 K36 ["toString"]
      269 MOVE                             R5 R3
      270 CALL                             R4 1 1
      271 GETUPVAL                         R5 5
      272 CALL                             R5 0 1
      273 MOVE                             R7 R4
      274 NAMECALL                         R5 R5 K37 ["addText"]
      276 CALL                             R5 2 1
      277 MOVE                             R7 R3
      278 NAMECALL                         R5 R5 K38 ["setStructuredContent"]
      280 CALL                             R5 2 1
      281 NAMECALL                         R5 R5 K39 ["build"]
      283 CALL                             R5 1 -1
      284 RETURN                           R5 -1
...
PROTO_7:
      ...
      110 GETUPVAL                         R10 0
      111 GETTABLEKS                       R10 R10 K58 ["FFlagAssistantSplitToolsAndWidgets"]
      113 JUMPIFNOT                        R10 ; [+2]
      114 LOADNIL                          R9
      115 JUMP                             ; [+1]
      116 MOVE                             R9 R7
      117 SETTABLEKS                       R9 R8 K56 ["streamTransform"]
      119 RETURN                           R8 1
