...
MAIN:
       ...
       43 GETTABLEKS                       R7 R0 K16 ["Features"]
       45 GETTABLEKS                       R7 R7 K17 ["Gen3dUtils"]
       47 GETTABLEKS                       R7 R7 K18 ["Gen3DAssetTracking"]
       49 CALL                             R6 1 1
       50 GETIMPORT                        R7 K9 [require]
       52 GETTABLEKS                       R8 R0 K19 ["Util"]
       54 GETTABLEKS                       R8 R8 K20 ["PrimitiveGen"]
       56 GETTABLEKS                       R8 R8 K21 ["PrimitiveGenTypes"]
       58 CALL                             R7 1 1
       59 GETIMPORT                        R8 K9 [require]
       61 GETTABLEKS                       R9 R0 K19 ["Util"]
       63 GETTABLEKS                       R9 R9 K22 ["ToolUtils"]
       65 CALL                             R8 1 1
       66 GETTABLEKS                       R9 R2 K23 ["Engine"]
       68 GETTABLEKS                       R9 R9 K24 ["TaskCollector"]
       70 GETTABLEKS                       R10 R3 K25 ["raiseError"]
       72 GETTABLEKS                       R11 R7 K26 ["getLinkTag"]
       74 DUPTABLE                         R12 K33 [{["smartWidth"] = "parameters.Size.X", ["smartHeight"] = "parameters.Size.Y", ["smartDepth"] = "parameters.Size.Z"}]
       75 DUPTABLE                         R13 K37 [{["SmartWidth"] = "parameters.Size.X", ["SmartHeight"] = "parameters.Size.Y", ["SmartDepth"] = "parameters.Size.Z"}]
       76 DUPCLOSURE                       R14 K38 [PROTO_0]
       77 DUPCLOSURE                       R15 K39 [PROTO_1]
       78 DUPCLOSURE                       R16 K40 [PROTO_3]
       79 CAPTURE                          VAL R9
       80 CAPTURE                          VAL R15
       81 CAPTURE                          VAL R10
       82 DUPCLOSURE                       R17 K41 [PROTO_5]
       83 CAPTURE                          VAL R12
       84 CAPTURE                          VAL R5
       85 CAPTURE                          VAL R13
       86 DUPCLOSURE                       R18 K42 [PROTO_6]
       87 DUPCLOSURE                       R19 K43 [PROTO_7]
       88 CAPTURE                          VAL R5
       89 DUPCLOSURE                       R20 K44 [PROTO_8]
       90 CAPTURE                          VAL R5
       91 CAPTURE                          VAL R14
       92 CAPTURE                          VAL R16
       93 CAPTURE                          VAL R19
       94 DUPCLOSURE                       R21 K45 [PROTO_12]
       95 CAPTURE                          VAL R8
       96 DUPCLOSURE                       R22 K46 [PROTO_15]
       97 CAPTURE                          VAL R4
       98 CAPTURE                          VAL R1
       99 CAPTURE                          VAL R18
      100 CAPTURE                          VAL R17
      ...
      104 CAPTURE                          VAL R5
      105 CAPTURE                          VAL R21
      106 DUPTABLE                         R23 K48 [{"addWorkspaceModel"}]
      107 SETTABLEKS                       R22 R23 K47 ["addWorkspaceModel"]
      109 RETURN                           R23 1
