...
PROTO_17:
      ...
      117 LOADNIL                          R13
      118 GETUPVAL                         R14 0
      119 GETTABLEKS                       R14 R14 K11 ["useMemo"]
      121 NEWCLOSURE                       R15 P7
      122 CAPTURE                          VAL R8
      123 CAPTURE                          VAL R10
      124 CAPTURE                          VAL R11
      125 CAPTURE                          VAL R5
      126 CAPTURE                          VAL R6
      127 CAPTURE                          VAL R13
      128 NEWTABLE                         R16 0 6
      130 MOVE                             R17 R8
      131 MOVE                             R18 R10
      132 MOVE                             R19 R11
      133 GETTABLEKS                       R20 R5 K12 ["isProcessing"]
      135 MOVE                             R21 R6
      136 MOVE                             R22 R13
      137 SETLIST                          R16 R17 6 [1]
      139 CALL                             R14 2 1
      140 GETUPVAL                         R15 5
      141 GETUPVAL                         R16 6
      142 GETTABLEKS                       R16 R16 K13 ["Provider"]
      144 DUPTABLE                         R17 K15 [{"value"}]
      145 SETTABLEKS                       R14 R17 K14 ["value"]
      147 GETTABLEKS                       R18 R0 K16 ["children"]
      149 CALL                             R15 3 -1
      150 RETURN                           R15 -1
...
MAIN:
       ...
       46 CALL                             R6 1 1
       47 GETTABLEKS                       R7 R2 K15 ["Util"]
       49 GETTABLEKS                       R7 R7 K16 ["Observable"]
       51 GETTABLEKS                       R8 R4 K17 ["useAsync"]
       53 GETTABLEKS                       R9 R3 K18 ["createElement"]
       55 DUPTABLE                         R10 K28 [{["state"] = "disconnected", ["isBusy"] = False, ["start"], ["stop"], ["setupInstructions"] = , ["connectionCountObservable"] = }]
       56 DUPCLOSURE                       R11 K29 [PROTO_0]
       57 SETTABLEKS                       R11 R10 K23 ["start"]
       59 DUPCLOSURE                       R11 K30 [PROTO_1]
       60 SETTABLEKS                       R11 R10 K24 ["stop"]
       62 GETTABLEKS                       R11 R3 K31 ["createContext"]
       64 MOVE                             R12 R10
       65 CALL                             R11 1 1
       66 DUPCLOSURE                       R12 K32 [PROTO_2]
       67 DUPCLOSURE                       R13 K33 [PROTO_17]
       68 CAPTURE                          VAL R3
       69 CAPTURE                          VAL R1
       70 CAPTURE                          VAL R6
       71 CAPTURE                          VAL R8
       ...
       73 CAPTURE                          VAL R9
       74 CAPTURE                          VAL R11
       75 DUPCLOSURE                       R14 K34 [PROTO_18]
       76 CAPTURE                          VAL R3
       77 CAPTURE                          VAL R11
       78 DUPTABLE                         R15 K38 [{"Context", "Provider", "useExternalServer"}]
       79 SETTABLEKS                       R11 R15 K35 ["Context"]
       81 SETTABLEKS                       R13 R15 K36 ["Provider"]
       83 SETTABLEKS                       R14 R15 K37 ["useExternalServer"]
       85 RETURN                           R15 1
