...
PROTO_1:
       ...
       52 SETUPVAL                         R1 5
       53 GETUPVAL                         R0 0
       54 GETTABLEKS                       R0 R0 K14 ["FFlagAssistantMarkdownColorFix"]
       56 JUMPIFNOT                        R0 ; [+5]
       57 GETUPVAL                         R0 4
       58 GETUPVAL                         R1 5
       59 JUMPIF                           R1 ; [+1]
...
PROTO_11:
       ...
       88 GETUPVAL                         R9 8
       89 MOVE                             R10 R3
       90 DUPTABLE                         R11 K21 [{"Markdown", "WrapperProps", "MarkdownRendererProps", "ColorScheme", "Fallback", "LinkCallback", "OnError"}]
      ...
      101 GETUPVAL                         R12 8
      102 GETUPVAL                         R13 9
      103 DUPTABLE                         R14 K23 [{"LayoutOrder", "onMount"}]
      104 GETTABLEKS                       R15 R0 K10 ["LayoutOrder"]
      106 SETTABLEKS                       R15 R14 K10 ["LayoutOrder"]
      108 SETTABLEKS                       R8 R14 K22 ["onMount"]
      110 CALL                             R12 2 1
      111 SETTABLEKS                       R12 R11 K18 ["Fallback"]
      113 GETTABLEKS                       R12 R0 K24 ["linkCallback"]
      115 SETTABLEKS                       R12 R11 K19 ["LinkCallback"]
      117 SETTABLEKS                       R8 R11 K20 ["OnError"]
      119 CALL                             R9 2 -1
      120 RETURN                           R9 -1
...
MAIN:
       ...
       95 CAPTURE                          VAL R0
       96 CAPTURE                          VAL R13
       97 DUPCLOSURE                       R19 K28 [PROTO_2]
       98 DUPCLOSURE                       R20 K29 [PROTO_5]
       99 CAPTURE                          VAL R7
      100 CAPTURE                          VAL R8
      101 CAPTURE                          VAL R14
      102 CAPTURE                          VAL R12
      103 CAPTURE                          VAL R11
      104 DUPCLOSURE                       R21 K30 [PROTO_11]
      105 CAPTURE                          VAL R4
      106 CAPTURE                          VAL R7
      107 CAPTURE                          VAL R9
      108 CAPTURE                          VAL R3
      ...
      113 CAPTURE                          VAL R14
      114 CAPTURE                          VAL R20
      115 GETTABLEKS                       R22 R7 K31 ["memo"]
      117 MOVE                             R23 R21
      118 CALL                             R22 1 -1
      119 CLOSEUPVALS                      R15
      120 RETURN                           R22 -1
