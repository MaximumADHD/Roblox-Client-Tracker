PROTO_0:
       ...
       34 CALL                             R0 0 0
       35 GETUPVAL                         R0 6
       36 GETTABLEKS                       R0 R0 K2 ["set"]
       38 GETUPVAL                         R1 6
       39 GETTABLEKS                       R1 R1 K3 ["new"]
       41 CALL                             R1 0 -1
       42 CALL                             R0 -1 0
       43 GETUPVAL                         R0 7
       44 GETTABLEKS                       R0 R0 K4 ["setMcpClientIdentifier"]
       46 GETUPVAL                         R1 8
       47 CALL                             R0 1 0
       48 RETURN                           R0 0
...
PROTO_1:
       ...
       86 JUMPIFNOT                        R4 ; [+5]
       87 GETUPVAL                         R4 6
       88 GETTABLEKS                       R4 R4 K13 ["registerDefaultWidgets"]
       90 CALL                             R4 0 1
       91 MOVE                             R3 R4
       92 GETTABLEKS                       R4 R0 K14 ["EnvironmentOverride"]
       94 JUMPIF                           R4 ; [+4]
       95 GETUPVAL                         R4 7
       96 GETTABLEKS                       R4 R4 K15 ["new"]
       98 CALL                             R4 0 1
       99 GETUPVAL                         R5 7
      100 GETTABLEKS                       R5 R5 K16 ["set"]
      102 MOVE                             R6 R4
      103 CALL                             R5 1 0
      104 GETUPVAL                         R5 8
      105 GETTABLEKS                       R5 R5 K17 ["setup"]
      107 MOVE                             R6 R4
      108 CALL                             R5 1 0
...
MAIN:
       ...
       22 GETTABLEKS                       R3 R3 K11 ["ContentWidgetRegistry"]
       24 CALL                             R2 1 1
       25 GETIMPORT                        R3 K5 [require]
       27 GETTABLEKS                       R4 R0 K12 ["Parent"]
       29 GETTABLEKS                       R4 R4 K13 ["DMNetworking"]
       31 CALL                             R3 1 1
       32 GETIMPORT                        R4 K5 [require]
       34 GETTABLEKS                       R5 R0 K6 ["Components"]
       36 GETTABLEKS                       R5 R5 K7 ["Contexts"]
       38 GETTABLEKS                       R5 R5 K14 ["DefaultLLMProvider"]
       40 GETTABLEKS                       R5 R5 K15 ["LLMRequest"]
       42 CALL                             R4 1 1
       43 GETIMPORT                        R5 K5 [require]
       45 GETTABLEKS                       R6 R0 K16 ["Guest"]
       47 GETTABLEKS                       R6 R6 K17 ["Environment"]
       49 CALL                             R5 1 1
       50 GETIMPORT                        R6 K5 [require]
       52 GETTABLEKS                       R7 R0 K6 ["Components"]
       54 GETTABLEKS                       R7 R7 K7 ["Contexts"]
       56 GETTABLEKS                       R7 R7 K18 ["Gemini"]
       58 GETTABLEKS                       R7 R7 K19 ["GeminiLLMRequest"]
       60 CALL                             R6 1 1
       61 GETIMPORT                        R7 K5 [require]
       63 GETTABLEKS                       R8 R0 K16 ["Guest"]
       65 GETTABLEKS                       R8 R8 K20 ["JsonEnvironment"]
       67 CALL                             R7 1 1
       68 GETIMPORT                        R8 K5 [require]
       70 GETTABLEKS                       R9 R0 K6 ["Components"]
       72 GETTABLEKS                       R9 R9 K7 ["Contexts"]
       74 GETTABLEKS                       R9 R9 K14 ["DefaultLLMProvider"]
       76 GETTABLEKS                       R9 R9 K15 ["LLMRequest"]
       78 CALL                             R8 1 1
       79 GETIMPORT                        R9 K5 [require]
       81 GETTABLEKS                       R10 R0 K6 ["Components"]
       83 GETTABLEKS                       R10 R10 K7 ["Contexts"]
       85 GETTABLEKS                       R10 R10 K21 ["OpenAI"]
       87 GETTABLEKS                       R10 R10 K22 ["OpenAILLMRequest"]
       89 CALL                             R9 1 1
       90 GETIMPORT                        R10 K5 [require]
       92 GETTABLEKS                       R11 R0 K23 ["Types"]
       94 CALL                             R10 1 1
       95 GETIMPORT                        R11 K5 [require]
       97 GETTABLEKS                       R12 R0 K10 ["Util"]
       99 GETTABLEKS                       R12 R12 K24 ["withLLMRequestNetworkWrapper"]
      101 CALL                             R11 1 1
