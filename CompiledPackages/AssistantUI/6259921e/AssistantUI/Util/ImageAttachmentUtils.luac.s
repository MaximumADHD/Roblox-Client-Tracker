...
MAIN:
       ...
       29 GETTABLEKS                       R5 R5 K14 ["FFlagEnableStoreImageTool"]
       31 CALL                             R4 1 1
       32 GETIMPORT                        R5 K9 [require]
       34 GETTABLEKS                       R6 R0 K13 ["Flags"]
       36 GETTABLEKS                       R6 R6 K15 ["FFlagPrimGenDetectMineTypeFromContent"]
       38 CALL                             R5 1 1
       39 NEWTABLE                         R6 8 0
       41 NEWTABLE                         R7 0 3
       43 LOADK                            R8 K16 ["jpg"]
       44 LOADK                            R9 K17 ["jpeg"]
       45 LOADK                            R10 K18 ["png"]
       46 SETLIST                          R7 R8 3 [1]
       48 DUPTABLE                         R8 K19 [{"jpg", "jpeg", "png"}]
       49 LOADK                            R9 K20 ["image/jpeg"]
       50 SETTABLEKS                       R9 R8 K16 ["jpg"]
       52 LOADK                            R9 K20 ["image/jpeg"]
       53 SETTABLEKS                       R9 R8 K17 ["jpeg"]
       55 LOADK                            R9 K21 ["image/png"]
       56 SETTABLEKS                       R9 R8 K18 ["png"]
       58 DUPCLOSURE                       R9 K22 [PROTO_0]
       59 DUPCLOSURE                       R10 K23 [PROTO_1]
       60 DUPCLOSURE                       R11 K24 [PROTO_2]
       61 DUPCLOSURE                       R12 K25 [PROTO_3]
       62 DUPCLOSURE                       R13 K26 [PROTO_4]
       63 DUPCLOSURE                       R14 K27 [PROTO_5]
       64 DUPCLOSURE                       R15 K28 [PROTO_6]
       65 DUPCLOSURE                       R16 K29 [PROTO_8]
       66 CAPTURE                          VAL R1
       67 CAPTURE                          VAL R9
       68 CAPTURE                          VAL R13
       69 CAPTURE                          VAL R15
       70 SETTABLEKS                       R16 R6 K30 ["getPngOrJpegDimensionsFromBase64"]
       72 DUPCLOSURE                       R16 K31 [PROTO_9]
       73 DUPCLOSURE                       R17 K32 [PROTO_11]
       74 CAPTURE                          VAL R2
       75 CAPTURE                          VAL R8
       76 CAPTURE                          VAL R5
       77 CAPTURE                          VAL R9
       78 SETTABLEKS                       R17 R6 K33 ["loadImageFromPathAsync"]
       80 DUPCLOSURE                       R17 K34 [PROTO_13]
       81 CAPTURE                          VAL R2
       82 CAPTURE                          VAL R7
       83 CAPTURE                          VAL R4
       84 CAPTURE                          VAL R6
       85 CAPTURE                          VAL R8
       86 SETTABLEKS                       R17 R6 K35 ["promptAndLoadImageAsync"]
       88 DUPCLOSURE                       R17 K36 [PROTO_14]
       89 SETTABLEKS                       R17 R6 K37 ["addImage"]
       91 DUPCLOSURE                       R17 K38 [PROTO_15]
       92 SETTABLEKS                       R17 R6 K39 ["removeImage"]
       94 RETURN                           R6 1
