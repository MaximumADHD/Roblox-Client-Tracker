...
PROTO_5:
       ...
       37 CALL                             R2 3 1
       38 JUMPIFNOT                        R2 ; [+24]
       39 GETTABLEKS                       R3 R2 K10 ["success"]
       41 JUMPIF                           R3 ; [+7]
       42 GETIMPORT                        R3 K12 [warn]
       44 LOADK                            R4 K13 ["Error in LLM request:"]
       45 GETTABLEKS                       R5 R2 K14 ["data"]
       47 CALL                             R3 2 0
       48 RETURN                           R0 0
       49 GETTABLEKS                       R3 R2 K14 ["data"]
       51 GETUPVAL                         R4 2
       52 MOVE                             R5 R3
       53 CALL                             R4 1 0
       54 GETUPVAL                         R4 3
       55 GETTABLEKS                       R4 R4 K15 ["isTerminalEventType"]
       57 MOVE                             R5 R3
       58 CALL                             R4 1 1
       59 JUMPIFNOT                        R4 ; [+3]
       60 GETUPVAL                         R4 4
       61 LOADNIL                          R5
       62 SETTABLE                         R5 R4 R0
       63 RETURN                           R0 0
...
PROTO_6:
       ...
       15 LOADK                            R5 K4 ["Error in LLM request:"]
       16 MOVE                             R6 R3
       17 CALL                             R4 2 0
       18 CLOSEUPVALS                      R0
       19 RETURN                           R3 1
...
MAIN:
       ...
       36 GETTABLEKS                       R5 R5 K14 ["StreamEventUtils"]
       38 CALL                             R4 1 1
       39 GETIMPORT                        R5 K5 [require]
       41 GETTABLEKS                       R6 R0 K15 ["Types"]
       43 CALL                             R5 1 1
       44 DUPCLOSURE                       R6 K16 [PROTO_8]
       45 CAPTURE                          VAL R3
       46 CAPTURE                          VAL R4
       47 RETURN                           R6 1
