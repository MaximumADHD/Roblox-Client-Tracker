...
PROTO_1:
       ...
       23 MOVE                             R7 R2
       24 JUMPIFNOT                        R7 ; [+1]
       25 GETTABLE                         R7 R0 R2
       26 MOVE                             R6 R7
       27 JUMPIF                           R6 ; [+1]
       28 RETURN                           R0 0
       29 GETTABLEKS                       R8 R6 K4 ["messages"]
       31 GETTABLE                         R7 R8 R3
       32 JUMPIFNOT                        R7 ; [+3]
       33 GETTABLEKS                       R8 R7 K5 ["contents"]
       35 JUMPIF                           R8 ; [+1]
       36 RETURN                           R0 0
       37 GETUPVAL                         R8 2
       38 GETTABLEKS                       R8 R8 K6 ["readMessage"]
       40 MOVE                             R9 R7
       41 CALL                             R8 1 1
       ...
       47 CALL                             R9 1 2
       48 JUMPIFNOT                        R9 ; [+20]
       49 JUMPIFEQKS                       R10 K9 [""] ; [+19]
       51 GETTABLEKS                       R11 R4 K10 ["logAssistantMessageSent"]
       53 DUPTABLE                         R12 K15 [{"messageGuid", "sessionId", "threadId", "message"}]
       54 SETTABLEKS                       R5 R12 K11 ["messageGuid"]
       56 SETTABLEKS                       R1 R12 K12 ["sessionId"]
       58 GETUPVAL                         R14 1
       59 CALL                             R14 0 1
       60 JUMPIFNOT                        R14 ; [+2]
       61 MOVE                             R13 R2
       62 JUMP                             ; [+1]
       63 LOADNIL                          R13
       64 SETTABLEKS                       R13 R12 K13 ["threadId"]
       66 SETTABLEKS                       R10 R12 K14 ["message"]
       68 CALL                             R11 1 0
       69 RETURN                           R0 0
