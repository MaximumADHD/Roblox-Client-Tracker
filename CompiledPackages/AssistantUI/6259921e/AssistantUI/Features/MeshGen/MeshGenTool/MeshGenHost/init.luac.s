...
PROTO_8:
       ...
       36 CALL                             R7 1 1
       37 GETUPVAL                         R8 2
       38 GETTABLEKS                       R8 R8 K13 ["addAssistantLink"]
       40 MOVE                             R9 R7
       41 GETUPVAL                         R10 3
       42 GETTABLEKS                       R10 R10 K14 ["getLinkTag"]
       44 MOVE                             R11 R2
       45 CALL                             R10 1 -1
       46 CALL                             R8 -1 0
      ...
      105 GETUPVAL                         R13 1
      106 GETTABLEKS                       R13 R13 K7 ["getGenerationSession"]
      108 MOVE                             R14 R12
      109 CALL                             R13 1 1
      ...
      131 JUMP                             ; [+6]
      132 GETUPVAL                         R9 2
      133 GETTABLEKS                       R9 R9 K30 ["setPositionOnGround"]
      135 MOVE                             R10 R7
      136 LOADB                            R11 1
      137 CALL                             R9 2 0
...
PROTO_9:
        ...
        6 CALL                             R3 1 1
        7 GETUPVAL                         R4 1
        8 GETTABLEKS                       R4 R4 K2 ["getLinkedInstances"]
       10 MOVE                             R5 R3
       11 CALL                             R4 1 1
       12 LENGTH                           R5 R4
...
PROTO_11:
        ...
        4 GETTABLEKS                       R4 R1 K2 ["toolArgs"]
        6 GETTABLEKS                       R4 R4 K3 ["networking"]
        8 GETUPVAL                         R5 0
        9 GETTABLEKS                       R5 R5 K4 ["getLinkTag"]
       11 MOVE                             R6 R3
       12 CALL                             R5 1 1
       13 GETUPVAL                         R6 1
       14 GETTABLEKS                       R6 R6 K5 ["observeLinkChanges"]
       16 MOVE                             R7 R4
       17 MOVE                             R8 R5
       18 NEWCLOSURE                       R9 P0
       19 CAPTURE                          UPVAL U2
...
MAIN:
       ...
       24 GETTABLEKS                       R4 R4 K13 ["ToolUtils"]
       26 CALL                             R3 1 1
       ...
       49 GETTABLEKS                       R8 R6 K19 ["MeshGenTool"]
       51 GETTABLEKS                       R8 R8 K20 ["MeshGenHost"]
       53 GETTABLEKS                       R8 R8 K21 ["MeshGenAssetManager"]
       55 CALL                             R7 1 1
       56 GETIMPORT                        R8 K9 [require]
       58 GETTABLEKS                       R9 R6 K19 ["MeshGenTool"]
       60 GETTABLEKS                       R9 R9 K20 ["MeshGenHost"]
       62 GETTABLEKS                       R9 R9 K22 ["MeshGenBoundingBoxVisualizer"]
       64 CALL                             R8 1 1
       65 GETIMPORT                        R9 K9 [require]
       67 GETTABLEKS                       R10 R6 K19 ["MeshGenTool"]
       69 GETTABLEKS                       R10 R10 K23 ["MeshGenBridgeTypes"]
       71 CALL                             R9 1 1
       ...
       84 GETTABLEKS                       R13 R0 K26 ["Features"]
       86 GETTABLEKS                       R13 R13 K27 ["Gen3dUtils"]
       88 GETTABLEKS                       R13 R13 K28 ["ViewportPreviewUtils"]
       90 CALL                             R12 1 1
