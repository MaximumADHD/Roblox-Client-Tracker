...
PROTO_12:
       ...
       46 JUMPIF                           R0 ; [+7]
       47 GETUPVAL                         R0 6
       48 GETTABLEKS                       R0 R0 K15 ["capturePreviewImages"]
       50 GETUPVAL                         R1 1
       51 NEWCLOSURE                       R2 P0
       52 CAPTURE                          UPVAL U7
       53 CALL                             R0 2 0
       54 GETUPVAL                         R0 7
       55 GETTABLEKS                       R0 R0 K16 ["bridge"]
       57 GETTABLEKS                       R0 R0 K17 ["updateContentHeader"]
       59 DUPTABLE                         R1 K21 [{"newDisplayName", "newClassName", "modelTag"}]
       60 GETUPVAL                         R2 1
       61 GETTABLEKS                       R2 R2 K1 ["Name"]
       63 SETTABLEKS                       R2 R1 K18 ["newDisplayName"]
       65 GETUPVAL                         R2 1
       66 GETTABLEKS                       R2 R2 K22 ["ClassName"]
       68 SETTABLEKS                       R2 R1 K19 ["newClassName"]
       70 GETUPVAL                         R2 8
       71 SETTABLEKS                       R2 R1 K20 ["modelTag"]
       73 CALL                             R0 1 0
       74 RETURN                           R0 0
...
PROTO_15:
       ...
       14 NEWCLOSURE                       R7 P1
       15 CAPTURE                          VAL R6
       16 LOADK                            R10 K4 ["GeneratedFolder"]
       17 NAMECALL                         R8 R0 K5 ["FindFirstChildWhichIsA"]
       19 CALL                             R8 2 1
       20 JUMPIFNOT                        R8 ; [+20]
       21 LOADK                            R11 K6 ["Model"]
       22 NAMECALL                         R9 R8 K7 ["FindFirstChildOfClass"]
       24 CALL                             R9 2 1
       25 JUMPIF                           R9 ; [+4]
       26 NAMECALL                         R10 R8 K8 ["GetChildren"]
       28 CALL                             R10 1 1
       ...
       32 CALL                             R10 0 0
       33 JUMP                             ; [+18]
       34 GETTABLEKS                       R10 R8 K9 ["ChildAdded"]
       36 MOVE                             R12 R6
       37 NAMECALL                         R10 R10 K10 ["Once"]
       39 CALL                             R10 2 0
       40 JUMP                             ; [+11]
       41 LOADNIL                          R9
       42 GETTABLEKS                       R10 R0 K9 ["ChildAdded"]
       44 NEWCLOSURE                       R12 P2
       45 CAPTURE                          REF R9
       46 CAPTURE                          VAL R6
       47 NAMECALL                         R10 R10 K11 ["Connect"]
       49 CALL                             R10 2 1
       50 MOVE                             R9 R10
       51 CLOSEUPVALS                      R9
       52 JUMPIFEQKS                       R4 K0 [""] ; [+3]
       54 CLOSEUPVALS                      R4
       55 RETURN                           R4 1
       56 GETIMPORT                        R9 K13 [coroutine.yield]
       58 CALL                             R9 0 1
       59 MOVE                             R4 R9
       60 CLOSEUPVALS                      R4
       61 RETURN                           R4 1
...
PROTO_20:
        ...
        8 CALL                             R5 2 1
        9 MOVE                             R3 R5
       10 GETTABLEKS                       R4 R1 K4 ["toolArgs"]
       12 GETTABLEKS                       R4 R4 K5 ["networking"]
       14 GETUPVAL                         R5 0
       15 GETTABLEKS                       R5 R5 K6 ["observeLinkChanges"]
       17 MOVE                             R6 R4
       18 MOVE                             R7 R3
       19 NEWCLOSURE                       R8 P0
       20 CAPTURE                          UPVAL U1
...
MAIN:
       ...
       23 GETTABLEKS                       R4 R4 K11 ["Parent"]
       25 GETTABLEKS                       R4 R4 K12 ["PrimitiveGenBridgeTypes"]
       27 CALL                             R3 1 1
       28 GETIMPORT                        R4 K10 [require]
       30 GETTABLEKS                       R5 R0 K13 ["Util"]
       32 GETTABLEKS                       R5 R5 K14 ["TaskCollector"]
       34 CALL                             R4 1 1
       ...
       62 GETTABLEKS                       R9 R0 K22 ["Guest"]
       64 GETTABLEKS                       R9 R9 K23 ["Environment"]
       66 CALL                             R8 1 1
       67 GETIMPORT                        R9 K10 [require]
       69 GETTABLEKS                       R10 R0 K24 ["Flags"]
       71 GETTABLEKS                       R10 R10 K25 ["FFlagControlProceduralScriptCapabilities"]
       73 CALL                             R9 1 1
       74 GETIMPORT                        R10 K10 [require]
       76 GETTABLEKS                       R11 R0 K24 ["Flags"]
       78 GETTABLEKS                       R11 R11 K26 ["FFlagDisableNewSmartSize"]
       80 CALL                             R10 1 1
       81 GETIMPORT                        R11 K10 [require]
       83 GETTABLEKS                       R12 R0 K24 ["Flags"]
       85 GETTABLEKS                       R12 R12 K27 ["FFlagDisableOldSmartSize"]
       87 CALL                             R11 1 1
       88 GETIMPORT                        R12 K10 [require]
       90 GETTABLEKS                       R13 R0 K24 ["Flags"]
       92 GETTABLEKS                       R13 R13 K28 ["FFlagPrimGenErrorInfo"]
       94 CALL                             R12 1 1
       95 GETIMPORT                        R13 K10 [require]
       97 GETTABLEKS                       R14 R0 K24 ["Flags"]
       99 GETTABLEKS                       R14 R14 K29 ["FFlagPrimGenFetchPreviewFromBackend"]
      101 CALL                             R13 1 1
      102 GETIMPORT                        R14 K10 [require]
      104 GETTABLEKS                       R15 R0 K24 ["Flags"]
      106 GETTABLEKS                       R15 R15 K30 ["FFlagSandboxProceduralScript"]
      108 CALL                             R14 1 1
