PROTO_0:
        0 DUPTABLE                         R0 K10 [{"AnimationGen", "AssetInsert", "Channel", "CreatorStore", "ExecuteLuau", "Instance", "MaterialGen", "MeshGen", "PrimitiveGen", "ReadFile"}]
        1 GETUPVAL                         R1 0
        2 GETTABLEKS                       R1 R1 K0 ["AnimationGen"]
        4 GETTABLEKS                       R1 R1 K11 ["createGuestContext"]
        6 LOADNIL                          R2
        7 LOADNIL                          R3
        8 CALL                             R1 2 1
        9 GETTABLEKS                       R1 R1 K12 ["bridge"]
       11 SETTABLEKS                       R1 R0 K0 ["AnimationGen"]
       13 GETUPVAL                         R1 0
       14 GETTABLEKS                       R1 R1 K1 ["AssetInsert"]
       16 GETTABLEKS                       R1 R1 K11 ["createGuestContext"]
       18 LOADNIL                          R2
       19 LOADNIL                          R3
       20 CALL                             R1 2 1
       21 GETTABLEKS                       R1 R1 K12 ["bridge"]
       23 SETTABLEKS                       R1 R0 K1 ["AssetInsert"]
       25 GETUPVAL                         R1 0
       26 GETTABLEKS                       R1 R1 K2 ["Channel"]
       28 GETTABLEKS                       R1 R1 K11 ["createGuestContext"]
       30 LOADNIL                          R2
       31 LOADNIL                          R3
       32 CALL                             R1 2 1
       33 GETTABLEKS                       R1 R1 K12 ["bridge"]
       35 SETTABLEKS                       R1 R0 K2 ["Channel"]
       37 GETUPVAL                         R1 0
       38 GETTABLEKS                       R1 R1 K3 ["CreatorStore"]
       40 GETTABLEKS                       R1 R1 K11 ["createGuestContext"]
       42 LOADNIL                          R2
       43 LOADNIL                          R3
       44 CALL                             R1 2 1
       45 GETTABLEKS                       R1 R1 K12 ["bridge"]
       47 SETTABLEKS                       R1 R0 K3 ["CreatorStore"]
       49 GETUPVAL                         R1 0
       50 GETTABLEKS                       R1 R1 K4 ["ExecuteLuau"]
       52 GETTABLEKS                       R1 R1 K11 ["createGuestContext"]
       54 LOADNIL                          R2
       55 LOADNIL                          R3
       56 CALL                             R1 2 1
       57 GETTABLEKS                       R1 R1 K12 ["bridge"]
       59 SETTABLEKS                       R1 R0 K4 ["ExecuteLuau"]
       61 GETUPVAL                         R1 0
       62 GETTABLEKS                       R1 R1 K5 ["Instance"]
       64 GETTABLEKS                       R1 R1 K11 ["createGuestContext"]
       66 LOADNIL                          R2
       67 LOADNIL                          R3
       68 CALL                             R1 2 1
       69 GETTABLEKS                       R1 R1 K12 ["bridge"]
       71 SETTABLEKS                       R1 R0 K5 ["Instance"]
       73 GETUPVAL                         R1 0
       74 GETTABLEKS                       R1 R1 K6 ["MaterialGen"]
       76 GETTABLEKS                       R1 R1 K11 ["createGuestContext"]
       78 LOADNIL                          R2
       79 LOADNIL                          R3
       80 CALL                             R1 2 1
       81 GETTABLEKS                       R1 R1 K12 ["bridge"]
       83 SETTABLEKS                       R1 R0 K6 ["MaterialGen"]
       85 GETUPVAL                         R1 0
       86 GETTABLEKS                       R1 R1 K7 ["MeshGen"]
       88 GETTABLEKS                       R1 R1 K11 ["createGuestContext"]
       90 LOADNIL                          R2
       91 LOADNIL                          R3
       92 CALL                             R1 2 1
       93 GETTABLEKS                       R1 R1 K12 ["bridge"]
       95 SETTABLEKS                       R1 R0 K7 ["MeshGen"]
       97 GETUPVAL                         R1 0
       98 GETTABLEKS                       R1 R1 K8 ["PrimitiveGen"]
      100 GETTABLEKS                       R1 R1 K11 ["createGuestContext"]
      102 LOADNIL                          R2
      103 LOADNIL                          R3
      104 CALL                             R1 2 1
      105 GETTABLEKS                       R1 R1 K12 ["bridge"]
      107 SETTABLEKS                       R1 R0 K8 ["PrimitiveGen"]
      109 GETUPVAL                         R1 0
      110 GETTABLEKS                       R1 R1 K9 ["ReadFile"]
      112 GETTABLEKS                       R1 R1 K11 ["createGuestContext"]
      114 LOADNIL                          R2
      115 LOADNIL                          R3
      116 CALL                             R1 2 1
      117 GETTABLEKS                       R1 R1 K12 ["bridge"]
...
MAIN:
      ...
      128 CALL                             R12 1 1
      129 GETTABLEKS                       R13 R11 K22 ["createElement"]
      131 DUPCLOSURE                       R14 K23 [PROTO_1]
      132 CAPTURE                          VAL R11
      133 CAPTURE                          VAL R13
      134 CAPTURE                          VAL R1
      135 CAPTURE                          VAL R2
