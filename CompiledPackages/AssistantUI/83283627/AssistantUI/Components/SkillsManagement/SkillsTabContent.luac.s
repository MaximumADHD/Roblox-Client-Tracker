...
PROTO_5:
       ...
       70 CALL                             R2 2 0
       71 GETUPVAL                         R2 7
       72 GETTABLEKS                       R2 R2 K12 ["FFlagAssistantSkillsCloudSync"]
       74 JUMPIFNOT                        R2 ; [+54]
       75 GETUPVAL                         R2 2
       76 GETTABLEKS                       R2 R2 K4 ["skill"]
       78 GETTABLEKS                       R2 R2 K5 ["source"]
       80 GETUPVAL                         R3 6
       81 GETTABLEKS                       R3 R3 K9 ["User"]
       83 JUMPIFNOTEQ                      R2 R3 ; [+45]
       85 GETUPVAL                         R2 2
       86 GETTABLEKS                       R2 R2 K4 ["skill"]
       88 GETTABLEKS                       R2 R2 K13 ["assetId"]
       90 JUMPIFNOT                        R2 ; [+38]
       91 GETIMPORT                        R2 K15 [pcall]
       93 GETTABLEKS                       R3 R0 K16 ["cloudSkillAssets"]
       95 GETTABLEKS                       R3 R3 K17 ["uploadAssetsAsync"]
       97 NEWTABLE                         R4 0 1
       99 DUPTABLE                         R5 K21 [{"assetId", "name", "description", "isDisabled"}]
      100 GETUPVAL                         R6 2
      101 GETTABLEKS                       R6 R6 K4 ["skill"]
      103 GETTABLEKS                       R6 R6 K13 ["assetId"]
      105 SETTABLEKS                       R6 R5 K13 ["assetId"]
      107 GETUPVAL                         R6 2
      108 GETTABLEKS                       R6 R6 K4 ["skill"]
      110 GETTABLEKS                       R6 R6 K18 ["name"]
      112 SETTABLEKS                       R6 R5 K18 ["name"]
      114 GETUPVAL                         R6 2
      115 GETTABLEKS                       R6 R6 K4 ["skill"]
      117 GETTABLEKS                       R6 R6 K19 ["description"]
      119 SETTABLEKS                       R6 R5 K19 ["description"]
      121 GETUPVAL                         R6 2
      122 GETTABLEKS                       R6 R6 K2 ["isEnabled"]
      124 SETTABLEKS                       R6 R5 K20 ["isDisabled"]
