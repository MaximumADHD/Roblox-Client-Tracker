...
PROTO_18:
       ...
       60 LOADNIL                          R1
       61 GETUPVAL                         R2 6
       62 DUPTABLE                         R3 K24 [{"textPrompt", "slotCount", "model", "modelFlow", "onSlotsUpdated", "onImageSelected"}]
       ...
       71 GETUPVAL                         R4 9
       72 SETTABLEKS                       R4 R3 K21 ["modelFlow"]
       74 NEWCLOSURE                       R4 P1
       75 CAPTURE                          UPVAL U5
       76 CAPTURE                          UPVAL U10
       77 SETTABLEKS                       R4 R3 K22 ["onSlotsUpdated"]
       79 GETUPVAL                         R5 1
       80 GETTABLEKS                       R5 R5 K0 ["FFlagAssistantImageGenImprovements"]
       82 JUMPIFNOT                        R5 ; [+3]
       83 NEWCLOSURE                       R4 P2
       84 CAPTURE                          UPVAL U5
       85 JUMP                             ; [+1]
       86 LOADNIL                          R4
       87 SETTABLEKS                       R4 R3 K23 ["onImageSelected"]
       89 CALL                             R2 1 1
       90 MOVE                             R1 R2
       91 GETUPVAL                         R2 5
       92 GETTABLEKS                       R2 R2 K16 ["editWidget"]
       94 NEWCLOSURE                       R3 P3
       95 CAPTURE                          REF R1
       96 CALL                             R2 1 0
       97 NAMECALL                         R2 R1 K25 ["runAsync"]
       99 CALL                             R2 1 1
      100 GETTABLEKS                       R3 R2 K26 ["cancelled"]
      102 JUMPIFNOT                        R3 ; [+7]
      103 GETUPVAL                         R3 5
      104 GETTABLEKS                       R3 R3 K16 ["editWidget"]
      106 DUPCLOSURE                       R4 K27 [PROTO_17]
      107 CALL                             R3 1 0
      108 CLOSEUPVALS                      R1
      109 RETURN                           R0 0
      110 GETTABLEKS                       R3 R2 K28 ["errorMessage"]
      112 JUMPIFNOT                        R3 ; [+6]
      113 GETUPVAL                         R3 5
      114 GETTABLEKS                       R3 R3 K29 ["cancelInputRequest"]
      116 CALL                             R3 0 0
      117 CLOSEUPVALS                      R1
      118 RETURN                           R0 0
      119 GETUPVAL                         R3 5
      120 GETTABLEKS                       R3 R3 K30 ["dispatchWithOverrides"]
      122 DUPTABLE                         R4 K32 [{"hintImage"}]
      123 GETTABLEKS                       R5 R2 K33 ["imageContent"]
      125 SETTABLEKS                       R5 R4 K31 ["hintImage"]
      127 CALL                             R3 1 0
      128 CLOSEUPVALS                      R1
      129 RETURN                           R0 0
...
PROTO_20:
       ...
       17 GETTABLEKS                       R7 R0 K8 ["modelFlow"]
       19 DUPTABLE                         R8 K10 [{"wizardMode", "onFormSubmitted"}]
       20 SETTABLEKS                       R2 R8 K1 ["wizardMode"]
       22 NEWCLOSURE                       R9 P0
       23 CAPTURE                          VAL R1
       24 CAPTURE                          UPVAL U1
       25 CAPTURE                          VAL R6
       ...
       29 CAPTURE                          VAL R7
       30 CAPTURE                          UPVAL U2
       31 SETTABLEKS                       R9 R8 K9 ["onFormSubmitted"]
       33 RETURN                           R8 1
...
MAIN:
       ...
       19 LOADK                            R5 K8 ["ImageSelection"]
       20 NAMECALL                         R3 R3 K3 ["FindFirstAncestor"]
       22 CALL                             R3 2 1
       23 GETIMPORT                        R4 K5 [require]
       25 GETTABLEKS                       R5 R3 K9 ["ImageSelectionController"]
       27 CALL                             R4 1 1
       28 GETIMPORT                        R5 K5 [require]
       30 GETTABLEKS                       R6 R3 K10 ["ImageSelectionPicker"]
       32 CALL                             R5 1 1
       33 GETIMPORT                        R6 K5 [require]
       35 GETTABLEKS                       R7 R0 K11 ["Components"]
       37 GETTABLEKS                       R7 R7 K12 ["UIToolRegistry"]
       39 CALL                             R6 1 1
       40 DUPCLOSURE                       R7 K13 [PROTO_0]
       41 DUPCLOSURE                       R8 K14 [PROTO_20]
       42 CAPTURE                          VAL R4
       43 CAPTURE                          VAL R1
       44 CAPTURE                          VAL R7
       45 DUPTABLE                         R9 K16 [{"build"}]
       46 SETTABLEKS                       R8 R9 K15 ["build"]
       48 RETURN                           R9 1
