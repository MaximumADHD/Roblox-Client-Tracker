...
PROTO_3:
       ...
       81 GETUPVAL                         R13 3
       82 GETTABLEKS                       R12 R13 K25 ["updatePreviewImages"]
       84 MOVE                             R13 R1
       85 MOVE                             R14 R11
       86 CALL                             R12 2 0
       87 DUPTABLE                         R12 K27 [{"generationId"}]
       88 GETTABLEKS                       R14 R10 K28 ["metadata"]
       90 GETTABLEKS                       R13 R14 K29 ["UUID"]
       92 SETTABLEKS                       R13 R12 K26 ["generationId"]
       94 CLOSEUPVALS                      R4
       95 RETURN                           R12 1
...
MAIN:
       ...
       84 GETTABLEKS                       R15 R6 K19 ["MeshGenTool"]
       86 GETTABLEKS                       R14 R15 K20 ["MeshGenHost"]
       88 GETTABLEKS                       R13 R14 K26 ["MeshGenViewportUtils"]
       90 CALL                             R12 1 1
       91 GETTABLEKS                       R13 R10 K27 ["Enums"]
       93 LOADN                            R14 0
       94 DUPCLOSURE                       R15 K28 [PROTO_0]
       95 CAPTURE                          VAL R10
       96 CAPTURE                          VAL R7
       97 CAPTURE                          VAL R8
       98 DUPCLOSURE                       R16 K29 [PROTO_3]
       99 CAPTURE                          VAL R7
      100 CAPTURE                          VAL R15
      101 CAPTURE                          VAL R13
      102 CAPTURE                          VAL R12
      103 DUPCLOSURE                       R17 K30 [PROTO_4]
      104 CAPTURE                          VAL R7
      105 DUPCLOSURE                       R18 K31 [PROTO_5]
      106 CAPTURE                          VAL R7
      107 DUPCLOSURE                       R19 K32 [PROTO_6]
      108 CAPTURE                          VAL R7
      ...
      112 CAPTURE                          VAL R3
      113 CAPTURE                          VAL R11
      114 DUPCLOSURE                       R21 K33 [PROTO_8]
      115 CAPTURE                          VAL R11
      116 CAPTURE                          VAL R3
      117 DUPCLOSURE                       R22 K34 [PROTO_10]
      118 CAPTURE                          VAL R11
      119 CAPTURE                          VAL R3
      120 CAPTURE                          VAL R1
      121 CAPTURE                          VAL R4
      122 DUPCLOSURE                       R23 K35 [PROTO_11]
      123 CAPTURE                          VAL R10
      124 DUPTABLE                         R24 K44 [{"generateAssetsAsync", "cancelGenerationAsync", "publishAssetsAsync", "removeSelectedBoundsAsync", "insertAssetsAsync", "selectLinkedAssets", "listenToLinkChanges", "getSelectedBoundingBox"}]
      125 SETTABLEKS                       R16 R24 K36 ["generateAssetsAsync"]
      127 SETTABLEKS                       R17 R24 K37 ["cancelGenerationAsync"]
      129 SETTABLEKS                       R18 R24 K38 ["publishAssetsAsync"]
      131 SETTABLEKS                       R19 R24 K39 ["removeSelectedBoundsAsync"]
      133 SETTABLEKS                       R20 R24 K40 ["insertAssetsAsync"]
      135 SETTABLEKS                       R21 R24 K41 ["selectLinkedAssets"]
      137 SETTABLEKS                       R22 R24 K42 ["listenToLinkChanges"]
      139 SETTABLEKS                       R23 R24 K43 ["getSelectedBoundingBox"]
      141 DUPTABLE                         R25 K46 [{"bridge"}]
      142 SETTABLEKS                       R24 R25 K45 ["bridge"]
      144 CLOSEUPVALS                      R14
      145 RETURN                           R25 1
