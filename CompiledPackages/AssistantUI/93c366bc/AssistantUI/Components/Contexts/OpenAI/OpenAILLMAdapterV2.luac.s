...
PROTO_5:
       ...
       40 JUMPIFNOT                        R5 ; [+17]
       41 GETTABLEKS                       R6 R2 K10 ["response"]
       43 GETTABLEKS                       R5 R6 K11 ["usage"]
       45 JUMPIFNOT                        R5 ; [+12]
       46 GETTABLEKS                       R7 R2 K10 ["response"]
       48 GETTABLEKS                       R6 R7 K13 ["model"]
       50 ORK                              R5 R6 K12 []
       51 GETUPVAL                         R6 1
       52 GETTABLEKS                       R8 R2 K10 ["response"]
       54 GETTABLEKS                       R7 R8 K11 ["usage"]
       56 MOVE                             R8 R5
       57 CALL                             R6 2 0
      ...
      267 JUMPIFNOT                        R6 ; [+5]
      268 GETTABLEKS                       R6 R2 K10 ["response"]
      270 GETTABLEKS                       R5 R6 K50 ["status"]
      272 JUMPIF                           R5 ; [+1]
...
PROTO_7:
       ...
       11 GETTABLEKS                       R1 R2 K2 ["type"]
       13 JUMPIFNOTEQKS                    R1 K3 ["input_text"] ; [+6]
       15 GETUPVAL                         R2 0
       16 GETTABLEN                        R1 R2 1
       17 GETTABLEKS                       R0 R1 K4 ["text"]
       19 JUMP                             ; [+1]
       20 GETUPVAL                         R0 0
       21 LOADB                            R2 1
       22 GETUPVAL                         R4 1
       23 GETTABLEKS                       R3 R4 K5 ["role"]
       25 JUMPIFEQKS                       R3 K6 ["assistant"] ; [+14]
       27 LOADB                            R2 1
       28 GETUPVAL                         R4 1
       29 GETTABLEKS                       R3 R4 K5 ["role"]
       31 JUMPIFEQKS                       R3 K7 ["user"] ; [+8]
       33 GETUPVAL                         R4 1
       34 GETTABLEKS                       R3 R4 K5 ["role"]
...
PROTO_8:
       ...
       81 GETTABLEN                        R17 R14 1
       82 GETTABLEKS                       R16 R17 K1 ["type"]
       84 JUMPIFNOTEQKS                    R16 K18 ["input_text"] ; [+5]
       86 GETTABLEN                        R16 R14 1
       87 GETTABLEKS                       R15 R16 K16 ["text"]
       89 JUMP                             ; [+1]
       90 MOVE                             R15 R14
      ...
      185 JUMPIFNOT                        R15 ; [+9]
      186 GETUPVAL                         R17 0
      187 GETTABLEKS                       R16 R17 K29 ["Json"]
      189 GETTABLEKS                       R15 R16 K30 ["encode"]
...
MAIN:
       ...
       30 GETTABLEKS                       R7 R8 K12 ["Contexts"]
       32 GETTABLEKS                       R6 R7 K13 ["OpenAI"]
       34 GETTABLEKS                       R5 R6 K14 ["OpenAIRequestTypes"]
       36 CALL                             R4 1 1
       37 GETIMPORT                        R5 K5 [require]
       39 GETTABLEKS                       R9 R0 K11 ["Components"]
       41 GETTABLEKS                       R8 R9 K12 ["Contexts"]
       43 GETTABLEKS                       R7 R8 K13 ["OpenAI"]
       45 GETTABLEKS                       R6 R7 K15 ["OpenAIResponseTypes"]
       47 CALL                             R5 1 1
       48 GETTABLEKS                       R6 R2 K16 ["createTracker"]
       50 LOADK                            R7 K13 ["OpenAI"]
       51 CALL                             R6 1 1
       ...
       59 DUPCLOSURE                       R11 K21 [PROTO_6]
       60 CAPTURE                          VAL R1
       61 CAPTURE                          VAL R7
       62 DUPCLOSURE                       R12 K22 [PROTO_8]
       63 CAPTURE                          VAL R1
       64 DUPTABLE                         R13 K27 [{"getTokenUsageTracker", "resetTokenUsageTracker", "createAdapter", "convertLLMtoOpenAIMessage"}]
       65 SETTABLEKS                       R8 R13 K23 ["getTokenUsageTracker"]
       67 SETTABLEKS                       R9 R13 K24 ["resetTokenUsageTracker"]
       69 SETTABLEKS                       R11 R13 K25 ["createAdapter"]
       71 SETTABLEKS                       R12 R13 K26 ["convertLLMtoOpenAIMessage"]
       73 RETURN                           R13 1
