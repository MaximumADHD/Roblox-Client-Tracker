...
PROTO_1:
        0 GETUPVAL                         R1 0
        1 GETUPVAL                         R2 1
        2 DUPTABLE                         R3 K3 [{"uid", "success", "data"}]
        3 GETUPVAL                         R4 2
        4 SETTABLEKS                       R4 R3 K0 ["uid"]
        6 LOADB                            R4 1
        7 SETTABLEKS                       R4 R3 K1 ["success"]
        9 SETTABLEKS                       R0 R3 K2 ["data"]
       11 CALL                             R1 2 0
       12 RETURN                           R0 0
...
PROTO_3:
       ...
       10 CALL                             R3 1 2
       11 JUMPIF                           R3 ; [+15]
       12 DUPTABLE                         R5 K5 [{"uid", "success", "data"}]
       13 SETTABLEKS                       R1 R5 K2 ["uid"]
       15 LOADB                            R6 0
       16 SETTABLEKS                       R6 R5 K3 ["success"]
       18 FASTCALL1                        TOSTRING R4 ; [+3]
       19 MOVE                             R7 R4
       20 GETIMPORT                        R6 K7 [tostring]
       22 CALL                             R6 1 1
       23 SETTABLEKS                       R6 R5 K4 ["data"]
       25 CLOSEUPVALS                      R2
       26 RETURN                           R5 1
       27 CLOSEUPVALS                      R2
       28 RETURN                           R0 0
...
PROTO_5:
       ...
       45 CALL                             R2 3 1
       46 JUMPIFNOT                        R2 ; [+24]
       47 GETTABLEKS                       R3 R2 K10 ["success"]
       49 JUMPIF                           R3 ; [+7]
       50 GETIMPORT                        R3 K12 [warn]
       52 LOADK                            R4 K13 ["Error in LLM request:"]
       53 GETTABLEKS                       R5 R2 K14 ["data"]
       55 CALL                             R3 2 0
       56 RETURN                           R0 0
       57 GETTABLEKS                       R3 R2 K14 ["data"]
       59 GETUPVAL                         R4 2
       60 MOVE                             R5 R3
       61 CALL                             R4 1 0
       62 GETUPVAL                         R5 3
       63 GETTABLEKS                       R4 R5 K15 ["isTerminalEventType"]
       65 MOVE                             R5 R3
       66 CALL                             R4 1 1
       67 JUMPIFNOT                        R4 ; [+3]
       68 GETUPVAL                         R4 4
       69 LOADNIL                          R5
       70 SETTABLE                         R5 R4 R0
       71 RETURN                           R0 0
...
PROTO_6:
       ...
       17 LOADK                            R5 K4 ["Error in LLM request:"]
       18 MOVE                             R6 R3
       19 CALL                             R4 2 0
       20 CLOSEUPVALS                      R0
       21 RETURN                           R3 1
...
PROTO_8:
       ...
       25 CAPTURE                          VAL R2
       26 CAPTURE                          VAL R7
       27 NAMECALL                         R8 R0 K4 ["OnHostInvokeAsync"]
       29 CALL                             R8 3 1
       30 NEWCLOSURE                       R9 P2
       31 CAPTURE                          VAL R0
       32 CAPTURE                          REF R5
...
MAIN:
       ...
       48 GETTABLEKS                       R7 R8 K17 ["FFlagAssistantBYOKNewJsonEncoder"]
       50 CALL                             R6 1 1
       51 GETIMPORT                        R7 K5 [require]
       53 GETTABLEKS                       R9 R0 K16 ["Flags"]
       55 GETTABLEKS                       R8 R9 K18 ["FFlagAssistantDMNetworkIdentity"]
       57 CALL                             R7 1 1
       58 DUPCLOSURE                       R8 K19 [PROTO_8]
       59 CAPTURE                          VAL R6
       60 CAPTURE                          VAL R3
       61 CAPTURE                          VAL R4
       62 CAPTURE                          VAL R7
