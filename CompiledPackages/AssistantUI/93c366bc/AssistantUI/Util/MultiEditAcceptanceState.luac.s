PROTO_0:
        0 GETUPVAL                         R0 0
        1 GETUPVAL                         R2 1
        2 GETTABLEKS                       R1 R2 K0 ["AcceptAllSession"]
...
PROTO_1:
        ...
        8 GETUPVAL                         R0 2
        9 GETUPVAL                         R2 1
       10 GETTABLEKS                       R1 R2 K1 ["AcceptAllPrompt"]
...
PROTO_2:
        0 GETUPVAL                         R1 1
        1 GETTABLEKS                       R0 R1 K0 ["ReviewEach"]
        3 SETUPVAL                         R0 0
        4 RETURN                           R0 0

PROTO_3:
        0 GETUPVAL                         R1 1
        1 GETTABLEKS                       R0 R1 K0 ["AcceptAllPrompt"]
        3 SETUPVAL                         R0 0
        4 RETURN                           R0 0

PROTO_4:
        0 GETUPVAL                         R1 1
        1 GETTABLEKS                       R0 R1 K0 ["AcceptAllSession"]
        3 SETUPVAL                         R0 0
        4 RETURN                           R0 0
