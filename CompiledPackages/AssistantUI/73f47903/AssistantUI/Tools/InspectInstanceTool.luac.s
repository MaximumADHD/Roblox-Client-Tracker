...
PROTO_22:
       ...
       90 SETTABLEKS                       R8 R7 K44 ["contentWidgets"]
       92 GETUPVAL                         R9 7
       93 CALL                             R9 0 1
       94 JUMPIFNOT                        R9 ; [+2]
       95 LOADNIL                          R8
       96 JUMP                             ; [+1]
       97 MOVE                             R8 R6
       98 SETTABLEKS                       R8 R7 K45 ["streamTransform"]
      100 RETURN                           R7 1
...
MAIN:
       ...
       62 GETTABLEKS                       R9 R9 K24 ["FFlagAssistantSplitToolsAndWidgets"]
       64 CALL                             R8 1 1
       65 GETTABLEKS                       R9 R3 K18 ["Util"]
       67 GETTABLEKS                       R9 R9 K25 ["ToolBuilder"]
       69 GETTABLEKS                       R10 R3 K18 ["Util"]
       71 GETTABLEKS                       R10 R10 K26 ["ToolResult"]
       73 GETTABLEKS                       R11 R5 K27 ["ToolNames"]
       75 GETIMPORT                        R12 K10 [require]
       77 GETTABLEKS                       R13 R0 K23 ["Flags"]
       79 GETTABLEKS                       R13 R13 K28 ["FIntInspectInstanceMaxJsonLength"]
       81 CALL                             R12 1 1
       82 CALL                             R12 0 1
       83 GETIMPORT                        R13 K10 [require]
       85 GETTABLEKS                       R14 R0 K23 ["Flags"]
       87 GETTABLEKS                       R14 R14 K29 ["FIntInspectInstanceMaxMatches"]
       89 CALL                             R13 1 1
       90 CALL                             R13 0 1
       91 GETIMPORT                        R14 K10 [require]
       93 GETTABLEKS                       R15 R0 K23 ["Flags"]
       95 GETTABLEKS                       R15 R15 K30 ["FIntInspectInstanceMaxStringLength"]
       97 CALL                             R14 1 1
       98 CALL                             R14 0 1
       99 DUPCLOSURE                       R15 K31 [PROTO_0]
      100 DUPCLOSURE                       R16 K32 [PROTO_1]
      101 CAPTURE                          VAL R6
      102 CAPTURE                          VAL R14
      103 CAPTURE                          VAL R12
      ...
      106 CAPTURE                          VAL R14
      107 CAPTURE                          VAL R12
      108 DUPTABLE                         R18 K38 [{["Parent"] = True, ["ClassName"] = True, ["Name"] = True, ["DataModel"] = True}]
      109 DUPCLOSURE                       R19 K39 [PROTO_3]
      110 CAPTURE                          VAL R6
      111 CAPTURE                          VAL R14
      112 CAPTURE                          VAL R12
      113 DUPCLOSURE                       R20 K40 [PROTO_6]
      114 CAPTURE                          VAL R2
      115 CAPTURE                          VAL R18
      116 CAPTURE                          VAL R6
      117 CAPTURE                          VAL R14
      118 CAPTURE                          VAL R12
      119 DUPCLOSURE                       R21 K41 [PROTO_8]
      120 CAPTURE                          VAL R20
      121 CAPTURE                          VAL R15
      122 CAPTURE                          VAL R17
      123 DUPCLOSURE                       R22 K42 [PROTO_10]
      124 CAPTURE                          VAL R1
      125 DUPCLOSURE                       R23 K43 [PROTO_12]
      126 DUPCLOSURE                       R24 K44 [PROTO_13]
      127 CAPTURE                          VAL R23
      128 CAPTURE                          VAL R21
      129 CAPTURE                          VAL R1
      130 CAPTURE                          VAL R13
      131 DUPCLOSURE                       R25 K45 [PROTO_22]
      132 CAPTURE                          VAL R24
      133 CAPTURE                          VAL R10
      134 CAPTURE                          VAL R9
      135 CAPTURE                          VAL R11
