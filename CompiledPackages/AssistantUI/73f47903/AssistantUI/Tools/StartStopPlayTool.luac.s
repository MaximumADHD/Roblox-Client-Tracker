...
PROTO_8:
       ...
       38 DUPTABLE                         R11 K12 [{["type"] = "boolean", ["description"] = "true to start the game, false to stop the game and return to edit mode."}]
       39 NAMECALL                         R8 R8 K13 ["addArgument"]
       41 CALL                             R8 3 1
       42 DUPTABLE                         R10 K21 [{["title"] = "Start/Stop Play", ["readOnlyHint"] = False, ["destructiveHint"] = False, ["idempotentHint"] = False, ["openWorldHint"] = False}]
       43 NAMECALL                         R8 R8 K22 ["setAnnotations"]
       45 CALL                             R8 2 1
       46 MOVE                             R10 R7
       47 NAMECALL                         R8 R8 K23 ["setHandler"]
       49 CALL                             R8 2 1
       50 NAMECALL                         R8 R8 K24 ["build"]
       52 CALL                             R8 1 1
       53 DUPTABLE                         R9 K28 [{"definition", "getPreExecuteWarning", "displayNameFunction"}]
       54 SETTABLEKS                       R8 R9 K25 ["definition"]
       56 DUPCLOSURE                       R10 K29 [PROTO_6]
       57 CAPTURE                          UPVAL U8
       58 SETTABLEKS                       R10 R9 K26 ["getPreExecuteWarning"]
       60 GETUPVAL                         R11 9
       61 CALL                             R11 0 1
       62 JUMPIFNOT                        R11 ; [+2]
       63 LOADNIL                          R10
       64 JUMP                             ; [+2]
       65 DUPCLOSURE                       R10 K30 [PROTO_7]
       66 CAPTURE                          UPVAL U10
       67 SETTABLEKS                       R10 R9 K27 ["displayNameFunction"]
       69 CLOSEUPVALS                      R4
       70 RETURN                           R9 1
