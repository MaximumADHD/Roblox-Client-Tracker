...
PROTO_13:
      ...
      100 SETTABLEKS                       R8 R7 K52 ["contentWidgets"]
      102 GETUPVAL                         R9 9
      103 CALL                             R9 0 1
      104 JUMPIFNOT                        R9 ; [+2]
      105 LOADNIL                          R8
      106 JUMP                             ; [+1]
      107 MOVE                             R8 R6
      108 SETTABLEKS                       R8 R7 K53 ["streamTransform"]
      110 RETURN                           R7 1
...
MAIN:
       ...
       63 GETTABLEKS                       R11 R1 K24 ["ROBLOX_CREATOR_DOCS_BASE_URL"]
       65 DUPCLOSURE                       R12 K25 [PROTO_0]
       66 NEWTABLE                         R13 0 5
       68 DUPTABLE                         R14 K30 [{["base"], ["description"] = "Roblox Engine API docs — URLs must end with .md or be llms.txt", ["validate"]}]
       69 SETTABLEKS                       R10 R14 K26 ["base"]
       71 SETTABLEKS                       R12 R14 K29 ["validate"]
       73 DUPTABLE                         R15 K33 [{["base"] = "https://create.roblox.com/docs/cloud", ["description"] = "Roblox Cloud API docs — URLs must end with .md or be llms.txt", ["validate"]}]
       74 SETTABLEKS                       R12 R15 K29 ["validate"]
       76 DUPTABLE                         R16 K36 [{["base"] = "https://create.roblox.com/docs/performance-optimization", ["description"] = "Roblox Performance Optimization docs — URLs must end with .md or be llms.txt", ["validate"]}]
       77 SETTABLEKS                       R12 R16 K29 ["validate"]
       79 DUPTABLE                         R17 K39 [{["base"] = "https://github.com/Roblox/libmp", ["description"] = "Roblox LibMP repository — URLs must end with .md or be llms.txt", ["validate"]}]
       80 SETTABLEKS                       R12 R17 K29 ["validate"]
       82 DUPTABLE                         R18 K41 [{["base"], ["description"] = "Roblox Creator docs (guides, tutorials, etc.) — URLs must end with .md or be llms.txt", ["validate"]}]
       83 SETTABLEKS                       R11 R18 K26 ["base"]
       85 SETTABLEKS                       R12 R18 K29 ["validate"]
       87 SETLIST                          R13 R14 5 [1]
       89 DUPCLOSURE                       R14 K42 [PROTO_1]
       90 CAPTURE                          VAL R13
       91 DUPCLOSURE                       R15 K43 [PROTO_2]
       92 CAPTURE                          VAL R13
       93 DUPCLOSURE                       R16 K44 [PROTO_3]
       94 DUPCLOSURE                       R17 K45 [PROTO_4]
       95 CAPTURE                          VAL R16
       96 DUPCLOSURE                       R18 K46 [PROTO_13]
       97 CAPTURE                          VAL R14
       98 CAPTURE                          VAL R15
       99 CAPTURE                          VAL R8
      100 CAPTURE                          VAL R17
