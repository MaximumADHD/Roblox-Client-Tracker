...
PROTO_7:
       ...
       60 CALL                             R6 0 1
       61 JUMPIF                           R6 ; [+7]
       62 LOADK                            R8 K40 ["ReadFileTool_openScript"]
       63 NEWCLOSURE                       R9 P2
       64 CAPTURE                          UPVAL U5
       65 CAPTURE                          VAL R2
       66 NAMECALL                         R6 R1 K3 ["OnHostInvokeAsync"]
       68 CALL                             R6 3 0
       69 DUPTABLE                         R6 K43 [{"transformInitialContent", "getTransformPreExecuteFn"}]
       70 DUPCLOSURE                       R7 K44 [PROTO_4]
       71 CAPTURE                          UPVAL U6
       72 SETTABLEKS                       R7 R6 K41 ["transformInitialContent"]
       74 DUPCLOSURE                       R7 K45 [PROTO_6]
       75 SETTABLEKS                       R7 R6 K42 ["getTransformPreExecuteFn"]
       77 DUPTABLE                         R7 K49 [{"definition", "contentWidgets", "streamTransform"}]
       78 SETTABLEKS                       R5 R7 K46 ["definition"]
       80 GETUPVAL                         R9 4
       81 CALL                             R9 0 1
       82 JUMPIFNOT                        R9 ; [+2]
       83 LOADNIL                          R8
       ...
       90 SETTABLEKS                       R8 R7 K47 ["contentWidgets"]
       92 GETUPVAL                         R9 4
       93 CALL                             R9 0 1
       94 JUMPIFNOT                        R9 ; [+2]
       95 LOADNIL                          R8
       96 JUMP                             ; [+1]
       97 MOVE                             R8 R6
       98 SETTABLEKS                       R8 R7 K48 ["streamTransform"]
      100 RETURN                           R7 1
