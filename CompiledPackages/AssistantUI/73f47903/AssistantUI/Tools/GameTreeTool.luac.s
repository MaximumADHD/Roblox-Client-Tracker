...
PROTO_15:
       ...
       15 NEWTABLE                         R1 0 0
       17 GETUPVAL                         R2 1
       18 GETTABLEKS                       R2 R2 K7 ["path"]
       20 JUMPIFNOT                        R2 ; [+14]
       21 GETUPVAL                         R2 1
       22 GETTABLEKS                       R2 R2 K7 ["path"]
       24 JUMPIFEQKS                       R2 K8 [""] ; [+10]
       26 GETUPVAL                         R4 1
       27 GETTABLEKS                       R4 R4 K7 ["path"]
       29 FASTCALL2                        TABLE_INSERT R1 R4 ; [+4]
       31 MOVE                             R3 R1
       32 GETIMPORT                        R2 K11 [table.insert]
       34 CALL                             R2 2 0
       35 GETUPVAL                         R2 1
       36 GETTABLEKS                       R2 R2 K12 ["keywords"]
       38 JUMPIFNOT                        R2 ; [+19]
       39 GETUPVAL                         R2 1
       40 GETTABLEKS                       R2 R2 K12 ["keywords"]
       42 JUMPIFEQKS                       R2 K8 [""] ; [+15]
       44 LOADK                            R5 K13 ["'%*'"]
       45 GETUPVAL                         R7 1
       46 GETTABLEKS                       R7 R7 K12 ["keywords"]
       ...
       57 CALL                             R2 2 0
       58 GETUPVAL                         R2 1
       59 GETTABLEKS                       R2 R2 K15 ["instanceType"]
       61 JUMPIFNOT                        R2 ; [+14]
       62 GETUPVAL                         R2 1
       63 GETTABLEKS                       R2 R2 K15 ["instanceType"]
       65 JUMPIFEQKS                       R2 K8 [""] ; [+10]
       67 GETUPVAL                         R4 1
       68 GETTABLEKS                       R4 R4 K15 ["instanceType"]
...
PROTO_17:
       ...
       14 CALL                             R4 0 1
       15 GETUPVAL                         R6 3
       16 GETTABLEKS                       R6 R6 K5 ["ToolNames"]
       18 GETTABLEKS                       R6 R6 K6 ["GameTree"]
       ...
       35 DUPTABLE                         R7 K18 [{["type"] = "string", ["description"] = "Start exploration from this path. Examples: 'Workspace', 'ServerScriptService', 'Workspace.Models'. Path is case-sensitive."}]
       36 NAMECALL                         R4 R4 K19 ["addOptionalArgument"]
       38 CALL                             R4 3 1
       39 LOADK                            R6 K20 ["instance_type"]
       40 DUPTABLE                         R7 K22 [{["type"] = "string", ["description"] = "Filter by ClassName using IsA() check. Examples: 'BasePart', 'BaseScript', 'GuiObject', 'Model', 'Folder'. Case sensitive."}]
       41 NAMECALL                         R4 R4 K19 ["addOptionalArgument"]
       43 CALL                             R4 3 1
       44 LOADK                            R6 K23 ["keywords"]
       45 DUPTABLE                         R7 K25 [{["type"] = "string", ["description"] = "Filter by instance name keywords (case-insensitive). Separate multiple keywords with commas or spaces. Instance name must contain at least one keyword. Examples: 'player', 'red, blue', 'button door'"}]
       46 NAMECALL                         R4 R4 K19 ["addOptionalArgument"]
       48 CALL                             R4 3 1
       49 LOADK                            R6 K26 ["max_depth"]
       50 DUPTABLE                         R7 K28 [{["type"] = "number", ["description"]}]
       51 LOADK                            R9 K29 ["Maximum absolute depth to traverse from start point. Default: %*, Absolute max: %*. Limits how deep we explore in the hierarchy regardless of filters. Beyond this depth, children are summarized instead of expanded."]
       52 GETUPVAL                         R11 4
       53 GETUPVAL                         R12 5
       54 NAMECALL                         R9 R9 K30 ["format"]
       56 CALL                             R9 3 1
       57 MOVE                             R8 R9
       58 SETTABLEKS                       R8 R7 K16 ["description"]
       60 NAMECALL                         R4 R4 K19 ["addOptionalArgument"]
       62 CALL                             R4 3 1
       63 LOADK                            R6 K31 ["head_limit"]
       64 DUPTABLE                         R7 K28 [{["type"] = "number", ["description"]}]
       65 LOADK                            R9 K32 ["Maximum number of results to return. Default: %*. Prevents overwhelming output for large trees."]
       66 GETUPVAL                         R11 6
       67 NAMECALL                         R9 R9 K30 ["format"]
       69 CALL                             R9 2 1
       70 MOVE                             R8 R9
       71 SETTABLEKS                       R8 R7 K16 ["description"]
       73 NAMECALL                         R4 R4 K19 ["addOptionalArgument"]
       75 CALL                             R4 3 1
       76 DUPTABLE                         R6 K41 [{["title"] = "Game Tree", ["readOnlyHint"] = True, ["destructiveHint"] = False, ["idempotentHint"] = True, ["openWorldHint"] = False}]
       77 NAMECALL                         R4 R4 K42 ["setAnnotations"]
       79 CALL                             R4 2 1
       80 MOVE                             R6 R3
       ...
       86 CALL                             R4 1 1
       87 DUPTABLE                         R5 K48 [{"transformInitialContent", "getTransformPreExecuteFn", "getTransformResultFn"}]
       88 DUPCLOSURE                       R6 K49 [PROTO_11]
       89 CAPTURE                          UPVAL U7
       90 CAPTURE                          UPVAL U8
       91 SETTABLEKS                       R6 R5 K45 ["transformInitialContent"]
       93 DUPCLOSURE                       R6 K50 [PROTO_14]
       94 CAPTURE                          UPVAL U8
       95 SETTABLEKS                       R6 R5 K46 ["getTransformPreExecuteFn"]
       97 DUPCLOSURE                       R6 K51 [PROTO_16]
       98 CAPTURE                          UPVAL U8
       99 SETTABLEKS                       R6 R5 K47 ["getTransformResultFn"]
      101 DUPTABLE                         R6 K55 [{"definition", "contentWidgets", "streamTransform"}]
      102 SETTABLEKS                       R4 R6 K52 ["definition"]
      104 GETUPVAL                         R8 9
      105 CALL                             R8 0 1
      106 JUMPIFNOT                        R8 ; [+2]
      107 LOADNIL                          R7
      ...
      114 SETTABLEKS                       R7 R6 K53 ["contentWidgets"]
      116 GETUPVAL                         R8 9
      117 CALL                             R8 0 1
      118 JUMPIFNOT                        R8 ; [+2]
      119 LOADNIL                          R7
      120 JUMP                             ; [+1]
      121 MOVE                             R7 R5
      122 SETTABLEKS                       R7 R6 K54 ["streamTransform"]
      124 RETURN                           R6 1
...
MAIN:
       ...
       26 GETTABLEKS                       R4 R4 K14 ["SummarizedContentWidget"]
       28 CALL                             R3 1 1
       29 GETIMPORT                        R4 K9 [require]
       31 GETTABLEKS                       R5 R0 K15 ["Tools"]
       33 GETTABLEKS                       R5 R5 K16 ["ToolTypes"]
       35 CALL                             R4 1 1
       36 GETIMPORT                        R5 K9 [require]
       38 GETTABLEKS                       R6 R0 K17 ["Util"]
       40 GETTABLEKS                       R6 R6 K18 ["ToolUtils"]
       42 CALL                             R5 1 1
       43 GETIMPORT                        R6 K9 [require]
       45 GETTABLEKS                       R7 R0 K19 ["Resources"]
       47 GETTABLEKS                       R7 R7 K20 ["Localization"]
       49 GETTABLEKS                       R7 R7 K21 ["Translator"]
       51 CALL                             R6 1 1
       52 GETIMPORT                        R7 K9 [require]
       54 GETTABLEKS                       R8 R0 K22 ["Flags"]
       56 GETTABLEKS                       R8 R8 K23 ["FFlagAssistantSplitToolsAndWidgets"]
       58 CALL                             R7 1 1
       59 GETTABLEKS                       R8 R2 K17 ["Util"]
       61 GETTABLEKS                       R8 R8 K24 ["ToolBuilder"]
       63 GETTABLEKS                       R9 R2 K17 ["Util"]
       65 GETTABLEKS                       R9 R9 K25 ["ToolResult"]
       67 GETIMPORT                        R10 K9 [require]
       69 GETTABLEKS                       R11 R0 K22 ["Flags"]
       71 GETTABLEKS                       R11 R11 K26 ["FIntGameTreeDefaultHeadLimit"]
       73 CALL                             R10 1 1
       74 CALL                             R10 0 1
       75 GETIMPORT                        R11 K9 [require]
       77 GETTABLEKS                       R12 R0 K22 ["Flags"]
       79 GETTABLEKS                       R12 R12 K27 ["FIntGameTreeDefaultMaxDepth"]
       81 CALL                             R11 1 1
       82 CALL                             R11 0 1
       83 GETIMPORT                        R12 K9 [require]
       85 GETTABLEKS                       R13 R0 K22 ["Flags"]
       87 GETTABLEKS                       R13 R13 K28 ["FIntGameTreeMaxAbsoluteDepth"]
       89 CALL                             R12 1 1
       90 CALL                             R12 0 1
       91 DUPCLOSURE                       R13 K29 [PROTO_0]
       92 DUPCLOSURE                       R14 K30 [PROTO_1]
       93 CAPTURE                          VAL R5
       94 DUPCLOSURE                       R15 K31 [PROTO_2]
       95 CAPTURE                          VAL R13
       96 DUPCLOSURE                       R16 K32 [PROTO_3]
       97 DUPCLOSURE                       R17 K33 [PROTO_4]
       98 CAPTURE                          VAL R10
       99 CAPTURE                          VAL R5
      100 CAPTURE                          VAL R13
      101 CAPTURE                          VAL R16
      102 CAPTURE                          VAL R15
      103 DUPCLOSURE                       R18 K34 [PROTO_5]
      104 DUPCLOSURE                       R19 K35 [PROTO_6]
      105 CAPTURE                          VAL R5
      106 DUPCLOSURE                       R20 K36 [PROTO_8]
      107 CAPTURE                          VAL R11
      108 CAPTURE                          VAL R12
      109 CAPTURE                          VAL R5
      110 CAPTURE                          VAL R17
      ...
      112 CAPTURE                          VAL R1
      113 CAPTURE                          VAL R10
      114 DUPCLOSURE                       R21 K37 [PROTO_17]
      115 CAPTURE                          VAL R20
      116 CAPTURE                          VAL R9
      117 CAPTURE                          VAL R8
      118 CAPTURE                          VAL R4
