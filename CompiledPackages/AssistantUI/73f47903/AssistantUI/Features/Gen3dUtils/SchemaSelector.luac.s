...
PROTO_4:
       ...
       57 DUPTABLE                         R9 K19 [{["name"] = "schema_selector", ["description"] = "Suggests part names for 3D generation", ["systemPrompt"], ["userPrompt"]}]
       58 SETTABLEKS                       R5 R9 K17 ["systemPrompt"]
       60 SETTABLEKS                       R6 R9 K18 ["userPrompt"]
       62 CALL                             R8 1 1
       63 GETUPVAL                         R9 3
       64 CALL                             R9 0 1
       65 JUMPIFNOT                        R9 ; [+28]
       66 GETIMPORT                        R9 K7 [print]
       68 LOADK                            R11 K20 ["[SchemaSelector] combined done in %*s — error: %*, response: \"%*\""]
       69 GETIMPORT                        R13 K22 [string.format]
       71 LOADK                            R14 K23 ["%.2f"]
       72 GETIMPORT                        R16 K11 [os.clock]
       74 CALL                             R16 0 1
       75 SUB                              R15 R16 R7
       76 CALL                             R13 2 1
       77 GETTABLEKS                       R15 R8 K24 ["error"]
       79 FASTCALL1                        TOSTRING R15 ; [+2]
       80 GETIMPORT                        R14 K26 [tostring]
       82 CALL                             R14 1 1
       83 GETTABLEKS                       R16 R8 K27 ["text"]
       85 FASTCALL1                        TOSTRING R16 ; [+2]
       86 GETIMPORT                        R15 K26 [tostring]
       88 CALL                             R15 1 1
       89 NAMECALL                         R11 R11 K3 ["format"]
       91 CALL                             R11 4 1
       92 MOVE                             R10 R11
       93 CALL                             R9 1 0
       94 GETTABLEKS                       R9 R8 K24 ["error"]
       96 JUMPIF                           R9 ; [+3]
       97 GETTABLEKS                       R9 R8 K27 ["text"]
       99 JUMPIF                           R9 ; [+4]
      100 LOADNIL                          R9
      101 LOADNIL                          R10
      102 LOADB                            R11 0
      103 RETURN                           R9 3
      104 GETUPVAL                         R9 5
      105 GETTABLEKS                       R10 R8 K27 ["text"]
      107 MOVE                             R11 R3
      108 CALL                             R9 2 -1
      109 RETURN                           R9 -1
