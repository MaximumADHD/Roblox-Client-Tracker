...
PROTO_21:
      ...
      125 CALL                             R10 5 0
      126 JUMP                             ; [+70]
      127 JUMPIFNOTEQKS                    R7 K19 ["textInput"] ; [+43]
      129 GETUPVAL                         R10 0
      130 CALL                             R10 0 1
      131 JUMPIFNOT                        R10 ; [+7]
      ...
      141 JUMPIFNOT                        R10 ; [+16]
      142 GETUPVAL                         R10 3
      143 GETTABLEKS                       R10 R10 K22 ["mouseInput"]
      145 DUPTABLE                         R11 K23 [{"actions"}]
      146 NEWTABLE                         R12 0 1
      148 DUPTABLE                         R13 K27 [{["action"] = "mouseButtonClick", ["instance_path"], ["mouse_button"] = "left"}]
      149 GETTABLEKS                       R14 R6 K21 ["instance_path"]
      151 SETTABLEKS                       R14 R13 K21 ["instance_path"]
      153 SETLIST                          R12 R13 1 [1]
      155 SETTABLEKS                       R12 R11 K1 ["actions"]
      157 CALL                             R10 1 0
      158 JUMPIFNOT                        R1 ; [+5]
      159 MOVE                             R12 R9
      160 NAMECALL                         R10 R1 K28 ["SendTextInput"]
      162 CALL                             R10 2 0
      163 JUMP                             ; [+33]
      164 GETUPVAL                         R10 2
      165 MOVE                             R12 R9
      166 LOADNIL                          R13
      167 NAMECALL                         R10 R10 K29 ["SendTextInputCharacterEvent"]
      169 CALL                             R10 3 0
      170 JUMP                             ; [+26]
      171 JUMPIFNOTEQKS                    R7 K16 ["wait"] ; [+25]
      173 GETTABLEKS                       R10 R6 K30 ["wait_time_ms"]
      175 JUMPIFNOTEQKNIL                  R10 ; [+6]
      177 GETIMPORT                        R11 K32 [error]
      179 LOADK                            R12 K33 ["wait_time_ms is required for wait action"]
      180 LOADN                            R13 0
      181 CALL                             R11 2 0
      182 LOADN                            R11 0
      183 JUMPIFLT                         R10 R11 ; [+4]
      185 LOADN                            R11 10000
      186 JUMPIFNOTLT                      R11 R10 ; [+6]
      188 GETIMPORT                        R11 K32 [error]
      190 LOADK                            R12 K34 ["wait_time_ms must be between 0 and 10000"]
      191 LOADN                            R13 0
      192 CALL                             R11 2 0
      193 GETIMPORT                        R11 K17 [task.wait]
      195 DIVK                             R12 R10 K35 [1000]
      196 CALL                             R11 1 0
      197 FORGLOOP                         R2 2 ; [-184]
      199 RETURN                           R0 0
