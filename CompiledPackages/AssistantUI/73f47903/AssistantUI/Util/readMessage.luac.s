PROTO_0:
       ...
       12 JUMPIFNOT                        R2 ; [+13]
       13 GETUPVAL                         R2 4
       14 GETTABLEKS                       R2 R2 K0 ["join"]
       16 MOVE                             R3 R1
       17 DUPTABLE                         R4 K2 [{"content"}]
       18 GETUPVAL                         R5 5
       19 GETTABLEKS                       R6 R1 K1 ["content"]
       21 CALL                             R5 1 1
       22 SETTABLEKS                       R5 R4 K1 ["content"]
       24 CALL                             R2 2 -1
       25 RETURN                           R2 -1
       26 RETURN                           R1 1
...
MAIN:
       ...
       64 GETTABLEKS                       R9 R9 K17 ["capToolResult"]
       66 CALL                             R8 1 1
       67 GETIMPORT                        R9 K5 [require]
       69 GETTABLEKS                       R10 R0 K18 ["Flags"]
       71 GETTABLEKS                       R10 R10 K19 ["FFlagAssistantCapToolResult"]
       73 CALL                             R9 1 1
       74 GETIMPORT                        R10 K5 [require]
       76 GETTABLEKS                       R11 R0 K18 ["Flags"]
       78 GETTABLEKS                       R11 R11 K20 ["FFlagMCPContentNormalization"]
       80 CALL                             R10 1 1
       81 GETIMPORT                        R11 K5 [require]
       83 GETTABLEKS                       R12 R0 K18 ["Flags"]
       85 GETTABLEKS                       R12 R12 K21 ["FIntAssistantMaxToolResultChars"]
       87 CALL                             R11 1 1
       88 GETTABLEKS                       R12 R4 K22 ["normalizeContentArray"]
       90 DUPCLOSURE                       R13 K23 [PROTO_0]
       91 CAPTURE                          VAL R9
       92 CAPTURE                          VAL R8
       93 CAPTURE                          VAL R11
       94 CAPTURE                          VAL R10
      ...
      104 CAPTURE                          VAL R13
      105 CAPTURE                          VAL R14
      106 DUPCLOSURE                       R16 K26 [PROTO_5]
      107 CAPTURE                          VAL R15
      108 DUPTABLE                         R17 K29 [{"readMessage", "readMessageWithTimestamp"}]
      109 SETTABLEKS                       R16 R17 K27 ["readMessage"]
      111 SETTABLEKS                       R15 R17 K28 ["readMessageWithTimestamp"]
      113 RETURN                           R17 1
