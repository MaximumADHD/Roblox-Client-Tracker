...
MAIN:
       ...
       17 GETTABLEKS                       R4 R1 K10 ["Guest"]
       19 GETTABLEKS                       R4 R4 K11 ["Environment"]
       21 CALL                             R3 1 1
       22 GETIMPORT                        R4 K9 [require]
       24 GETTABLEKS                       R5 R1 K12 ["Parent"]
       26 GETTABLEKS                       R5 R5 K13 ["ModelContextProtocol"]
       28 CALL                             R4 1 1
       29 GETIMPORT                        R5 K9 [require]
       31 GETTABLEKS                       R6 R1 K14 ["Util"]
       33 GETTABLEKS                       R6 R6 K15 ["truncateUtf8Safe"]
       35 CALL                             R5 1 1
       36 GETIMPORT                        R6 K9 [require]
       38 GETTABLEKS                       R7 R1 K16 ["Flags"]
       40 GETTABLEKS                       R7 R7 K17 ["FStringAssistantToolsExcludedDirectories"]
       42 CALL                             R6 1 1
       43 GETIMPORT                        R7 K9 [require]
       45 GETTABLEKS                       R8 R1 K16 ["Flags"]
       47 GETTABLEKS                       R8 R8 K18 ["FStringScreenCaptureSize"]
       49 CALL                             R7 1 1
       50 NEWTABLE                         R8 0 0
       52 GETTABLEKS                       R9 R6 K19 ["Get"]
       54 CALL                             R9 0 1
       55 LOADK                            R12 K20 ["[^,]+"]
       56 NAMECALL                         R10 R9 K21 ["gmatch"]
       58 CALL                             R10 2 3
       59 FORGPREP                         R10
       60 LOADK                            R17 K22 ["^%s*(.-)%s*$"]
       61 NAMECALL                         R15 R13 K23 ["match"]
       63 CALL                             R15 2 1
       64 JUMPIFNOT                        R15 ; [+9]
       65 JUMPIFEQKS                       R15 K24 [""] ; [+8]
       67 FASTCALL2                        TABLE_INSERT R8 R15 ; [+5]
       69 MOVE                             R17 R8
       70 MOVE                             R18 R15
       71 GETIMPORT                        R16 K27 [table.insert]
       73 CALL                             R16 2 0
       74 FORGLOOP                         R10 1 ; [-15]
       76 NEWTABLE                         R9 0 0
       78 DUPCLOSURE                       R10 K28 [PROTO_0]
       79 DUPCLOSURE                       R11 K29 [PROTO_1]
       80 DUPCLOSURE                       R12 K30 [PROTO_3]
       81 CAPTURE                          VAL R9
       82 CAPTURE                          VAL R3
       83 CAPTURE                          VAL R10
       84 CAPTURE                          VAL R11
       85 SETTABLEKS                       R12 R0 K31 ["loadCachedAssetAsync"]
       87 DUPCLOSURE                       R12 K32 [PROTO_4]
       88 CAPTURE                          VAL R11
       89 DUPCLOSURE                       R13 K33 [PROTO_5]
       90 DUPCLOSURE                       R14 K34 [PROTO_6]
       91 CAPTURE                          VAL R13
       92 DUPCLOSURE                       R15 K35 [PROTO_7]
       93 DUPCLOSURE                       R16 K36 [PROTO_9]
       94 CAPTURE                          VAL R12
       95 CAPTURE                          VAL R14
       96 CAPTURE                          VAL R15
       97 SETTABLEKS                       R16 R0 K37 ["setPositionOnGround"]
       99 DUPCLOSURE                       R16 K38 [PROTO_10]
      100 SETTABLEKS                       R16 R0 K39 ["useEnumExcept"]
      102 DUPCLOSURE                       R16 K40 [PROTO_11]
      103 CAPTURE                          VAL R0
      104 SETTABLEKS                       R16 R0 K41 ["useEnum"]
      106 DUPCLOSURE                       R16 K42 [PROTO_12]
      107 CAPTURE                          VAL R2
      108 SETTABLEKS                       R16 R0 K43 ["toString"]
      110 DUPCLOSURE                       R16 K44 [PROTO_15]
      111 CAPTURE                          VAL R5
      112 CAPTURE                          VAL R0
      113 CAPTURE                          VAL R2
      114 SETTABLEKS                       R16 R0 K45 ["getValueRepresentation"]
      116 DUPCLOSURE                       R16 K46 [PROTO_16]
      117 CAPTURE                          VAL R0
      118 SETTABLEKS                       R16 R0 K47 ["serializeToString"]
      120 DUPCLOSURE                       R16 K48 [PROTO_19]
      121 SETTABLEKS                       R16 R0 K49 ["runWithProgressLoop"]
      123 DUPCLOSURE                       R16 K50 [PROTO_21]
      124 SETTABLEKS                       R16 R0 K51 ["findOrCreateInstance"]
      126 DUPCLOSURE                       R16 K52 [PROTO_23]
      127 SETTABLEKS                       R16 R0 K53 ["findInstance"]
      129 DUPCLOSURE                       R16 K54 [PROTO_24]
      130 CAPTURE                          VAL R2
      131 SETTABLEKS                       R16 R0 K55 ["generateToolId"]
      133 DUPCLOSURE                       R16 K56 [PROTO_26]
      134 SETTABLEKS                       R16 R0 K57 ["preloadMaterialVariant"]
      136 DUPCLOSURE                       R16 K58 [PROTO_28]
      137 SETTABLEKS                       R16 R0 K59 ["captureSnapshotAsync"]
      139 DUPCLOSURE                       R16 K60 [PROTO_29]
      140 CAPTURE                          VAL R8
      141 SETTABLEKS                       R16 R0 K61 ["isPathExcluded"]
      143 DUPCLOSURE                       R16 K62 [PROTO_31]
      144 CAPTURE                          VAL R7
      145 SETTABLEKS                       R16 R0 K63 ["getScreenCaptureSize"]
      147 RETURN                           R0 1
