...
PROTO_11:
      ...
      114 CALL                             R10 1 0
      115 DUPTABLE                         R10 K33 [{["type"] = "image", ["data"], ["mimeType"]}]
      116 SETTABLEKS                       R9 R10 K31 ["data"]
      118 SETTABLEKS                       R7 R10 K32 ["mimeType"]
      120 RETURN                           R10 1
...
MAIN:
       ...
       41 DUPTABLE                         R7 K20 [{["jpg"] = "image/jpeg", ["jpeg"] = "image/jpeg", ["png"] = "image/png"}]
       42 DUPCLOSURE                       R8 K21 [PROTO_0]
       43 DUPCLOSURE                       R9 K22 [PROTO_1]
       44 DUPCLOSURE                       R10 K23 [PROTO_2]
       45 DUPCLOSURE                       R11 K24 [PROTO_3]
       46 DUPCLOSURE                       R12 K25 [PROTO_4]
       47 DUPCLOSURE                       R13 K26 [PROTO_5]
       48 DUPCLOSURE                       R14 K27 [PROTO_6]
       49 DUPCLOSURE                       R15 K28 [PROTO_8]
       50 CAPTURE                          VAL R1
       51 CAPTURE                          VAL R8
       52 CAPTURE                          VAL R12
       53 CAPTURE                          VAL R14
       54 SETTABLEKS                       R15 R5 K29 ["getPngOrJpegDimensionsFromBase64"]
       56 DUPCLOSURE                       R15 K30 [PROTO_9]
       57 DUPCLOSURE                       R16 K31 [PROTO_11]
       58 CAPTURE                          VAL R2
       59 CAPTURE                          VAL R7
       60 CAPTURE                          VAL R4
       61 CAPTURE                          VAL R8
       62 SETTABLEKS                       R16 R5 K32 ["loadImageFromPathAsync"]
       64 DUPCLOSURE                       R16 K33 [PROTO_12]
       65 CAPTURE                          VAL R2
       66 CAPTURE                          VAL R6
       67 CAPTURE                          VAL R5
       68 SETTABLEKS                       R16 R5 K34 ["promptAndLoadImageAsync"]
       70 DUPCLOSURE                       R16 K35 [PROTO_13]
       71 SETTABLEKS                       R16 R5 K36 ["addImage"]
       73 DUPCLOSURE                       R16 K37 [PROTO_14]
       74 SETTABLEKS                       R16 R5 K38 ["removeImage"]
       76 RETURN                           R5 1
