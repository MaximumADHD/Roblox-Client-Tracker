...
PROTO_6:
        ...
        2 GETUPVAL                         R2 0
        3 JUMPIFNOT                        R2 ; [+16]
        4 DUPTABLE                         R1 K4 [{[1] = "unpin", ["icon"], ["text"]}]
        5 GETUPVAL                         R2 1
        6 GETTABLEKS                       R2 R2 K5 ["Enums"]
        8 GETTABLEKS                       R2 R2 K6 ["IconName"]
       10 GETTABLEKS                       R2 R2 K7 ["PinSlash"]
       12 SETTABLEKS                       R2 R1 K2 ["icon"]
       14 GETUPVAL                         R2 2
       15 GETTABLEKS                       R2 R2 K8 ["Unpin"]
       17 SETTABLEKS                       R2 R1 K3 ["text"]
       19 JUMP                             ; [+15]
       20 DUPTABLE                         R1 K10 [{[1] = "pin", ["icon"], ["text"]}]
       21 GETUPVAL                         R2 1
       22 GETTABLEKS                       R2 R2 K5 ["Enums"]
       24 GETTABLEKS                       R2 R2 K6 ["IconName"]
       26 GETTABLEKS                       R2 R2 K11 ["Pin"]
       28 SETTABLEKS                       R2 R1 K2 ["icon"]
       30 GETUPVAL                         R2 2
       31 GETTABLEKS                       R2 R2 K11 ["Pin"]
       33 SETTABLEKS                       R2 R1 K3 ["text"]
       35 DUPTABLE                         R2 K13 [{[1] = "rename", ["icon"], ["text"]}]
       36 GETUPVAL                         R3 1
       37 GETTABLEKS                       R3 R3 K5 ["Enums"]
       39 GETTABLEKS                       R3 R3 K6 ["IconName"]
       41 GETTABLEKS                       R3 R3 K14 ["Pencil"]
       43 SETTABLEKS                       R3 R2 K2 ["icon"]
       45 GETUPVAL                         R3 2
       46 GETTABLEKS                       R3 R3 K15 ["EditName"]
       48 SETTABLEKS                       R3 R2 K3 ["text"]
       50 DUPTABLE                         R3 K18 [{[1] = "delete", ["icon"], ["text"], ["isDisabled"]}]
       51 GETUPVAL                         R4 1
       52 GETTABLEKS                       R4 R4 K5 ["Enums"]
       54 GETTABLEKS                       R4 R4 K6 ["IconName"]
       56 GETTABLEKS                       R4 R4 K19 ["TrashCan"]
       58 SETTABLEKS                       R4 R3 K2 ["icon"]
       60 GETUPVAL                         R4 2
       61 GETTABLEKS                       R4 R4 K20 ["DeleteThread"]
       63 SETTABLEKS                       R4 R3 K3 ["text"]
       65 GETUPVAL                         R4 3
       66 SETTABLEKS                       R4 R3 K17 ["isDisabled"]
       68 SETLIST                          R0 R1 3 [1]
       70 RETURN                           R0 1
...
PROTO_7:
       ...
       88 GETUPVAL                         R13 7
       89 GETUPVAL                         R14 8
       90 DUPTABLE                         R15 K23 [{"isOpen", "items", "size", "align", "onPressedOutside", "onActivated", "width", "LayoutOrder", "testId"}]
       91 GETTABLEKS                       R16 R0 K14 ["isOpen"]
       93 SETTABLEKS                       R16 R15 K14 ["isOpen"]
       95 SETTABLEKS                       R12 R15 K15 ["items"]
       97 GETUPVAL                         R16 6
       98 GETTABLEKS                       R16 R16 K24 ["Enums"]
      100 GETTABLEKS                       R16 R16 K25 ["InputSize"]
      102 GETTABLEKS                       R16 R16 K26 ["XSmall"]
      104 SETTABLEKS                       R16 R15 K16 ["size"]
      106 GETUPVAL                         R16 6
      107 GETTABLEKS                       R16 R16 K24 ["Enums"]
      109 GETTABLEKS                       R16 R16 K27 ["PopoverAlign"]
      111 GETTABLEKS                       R16 R16 K28 ["End"]
      113 SETTABLEKS                       R16 R15 K17 ["align"]
      115 SETTABLEKS                       R8 R15 K18 ["onPressedOutside"]
      117 SETTABLEKS                       R9 R15 K19 ["onActivated"]
      119 GETUPVAL                         R16 9
      120 SETTABLEKS                       R16 R15 K20 ["width"]
      122 GETTABLEKS                       R16 R0 K21 ["LayoutOrder"]
      124 SETTABLEKS                       R16 R15 K21 ["LayoutOrder"]
      126 GETUPVAL                         R16 10
      127 GETTABLEKS                       R16 R16 K29 ["ThreadOptionsMenu"]
      129 GETTABLEKS                       R16 R16 K30 ["Container"]
      131 SETTABLEKS                       R16 R15 K22 ["testId"]
      133 GETTABLEKS                       R16 R0 K31 ["children"]
      135 CALL                             R13 3 -1
      136 RETURN                           R13 -1
...
MAIN:
       ...
       79 LOADN                            R14 200
       80 CALL                             R12 2 1
       81 DUPTABLE                         R13 K36 [{["Pin"] = "pin", ["Unpin"] = "unpin", ["Rename"] = "rename", ["Delete"] = "delete"}]
       82 DUPCLOSURE                       R14 K37 [PROTO_7]
       83 CAPTURE                          VAL R3
       84 CAPTURE                          VAL R4
       85 CAPTURE                          VAL R8
       86 CAPTURE                          VAL R9
       ...
       92 CAPTURE                          VAL R12
       93 CAPTURE                          VAL R5
       94 DUPCLOSURE                       R15 K38 [PROTO_10]
       95 CAPTURE                          VAL R3
       96 CAPTURE                          VAL R11
       97 CAPTURE                          VAL R14
       98 RETURN                           R15 1
