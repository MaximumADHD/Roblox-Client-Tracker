...
PROTO_1:
       ...
       72 CALL                             R1 1 -1
       73 RETURN                           R1 -1
       74 JUMPIFNOTEQKS                    R0 K26 ["max_tool_calls"] ; [+10]
       76 GETUPVAL                         R1 0
       77 LOADK                            R2 K27 ["MaxToolCalls"]
       78 DUPTABLE                         R3 K29 [{"count"}]
       79 GETUPVAL                         R4 1
       80 CALL                             R4 0 1
       81 SETTABLEKS                       R4 R3 K28 ["count"]
       83 CALL                             R1 2 -1
       84 RETURN                           R1 -1
       85 JUMPIFNOTEQKS                    R0 K30 ["input_disabled"] ; [+5]
       87 GETUPVAL                         R1 0
       88 LOADK                            R2 K31 ["ExternalError"]
       89 CALL                             R1 1 -1
       90 RETURN                           R1 -1
       91 JUMPIFNOTEQKS                    R0 K32 ["external_connection_unauthorized_error"] ; [+5]
       93 GETUPVAL                         R1 0
       94 LOADK                            R2 K33 ["ExternalAPIError"]
       95 CALL                             R1 1 -1
       96 RETURN                           R1 -1
       97 GETUPVAL                         R1 2
       98 GETTABLEKS                       R1 R1 K34 ["assertNever"]
      100 MOVE                             R2 R0
      101 CALL                             R1 1 -1
      102 RETURN                           R1 -1
...
MAIN:
       ...
       85 GETTABLEKS                       R12 R12 K25 ["FIntMCPAssistantMaxToolCalls"]
       87 CALL                             R11 1 1
       88 GETTABLEKS                       R12 R2 K26 ["View"]
       90 GETTABLEKS                       R13 R5 K27 ["createNextOrder"]
       92 GETTABLEKS                       R14 R4 K28 ["createElement"]
       94 DUPCLOSURE                       R15 K29 [PROTO_0]
       95 CAPTURE                          VAL R7
       96 DUPCLOSURE                       R16 K30 [PROTO_1]
       97 CAPTURE                          VAL R15
       98 CAPTURE                          VAL R11
       99 CAPTURE                          VAL R8
      100 DUPCLOSURE                       R17 K31 [PROTO_2]
      101 CAPTURE                          VAL R8
      102 DUPCLOSURE                       R18 K32 [PROTO_3]
      103 DUPCLOSURE                       R19 K33 [PROTO_13]
      104 CAPTURE                          VAL R4
      105 CAPTURE                          VAL R3
      106 CAPTURE                          VAL R9
      107 CAPTURE                          VAL R10
      ...
      113 CAPTURE                          VAL R12
      114 CAPTURE                          VAL R1
      115 DUPTABLE                         R20 K36 [{"toMeta", "fromMeta"}]
      116 DUPCLOSURE                       R21 K37 [PROTO_14]
      117 SETTABLEKS                       R21 R20 K34 ["toMeta"]
      119 DUPCLOSURE                       R21 K38 [PROTO_15]
      120 CAPTURE                          VAL R8
      121 SETTABLEKS                       R21 R20 K35 ["fromMeta"]
      123 DUPTABLE                         R21 K43 [{["Type"] = "Error", ["ContentWidget"], ["Serialization"]}]
      124 GETTABLEKS                       R22 R4 K44 ["memo"]
      126 MOVE                             R23 R19
      127 CALL                             R22 1 1
      128 SETTABLEKS                       R22 R21 K41 ["ContentWidget"]
      130 SETTABLEKS                       R20 R21 K42 ["Serialization"]
      132 RETURN                           R21 1
