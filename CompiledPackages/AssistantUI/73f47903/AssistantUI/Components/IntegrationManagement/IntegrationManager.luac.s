...
MAIN:
       ...
       30 NEWTABLE                         R4 2 0
       32 NEWTABLE                         R5 0 4
       34 DUPTABLE                         R6 K16 [{["key"] = "label", ["type"] = "string"}]
       35 DUPTABLE                         R7 K18 [{["key"] = "url", ["type"] = "string"}]
       36 DUPTABLE                         R8 K23 [{["key"] = "disabled", ["type"] = "boolean", ["optional"] = True}]
       37 DUPTABLE                         R9 K26 [{["key"] = "authorization", ["type"] = "table", ["optional"] = True}]
       38 SETLIST                          R5 R6 4 [1]
       40 DUPCLOSURE                       R6 K27 [PROTO_0]
       41 CAPTURE                          VAL R5
       42 DUPCLOSURE                       R7 K28 [PROTO_1]
       43 CAPTURE                          VAL R3
       44 DUPCLOSURE                       R8 K29 [PROTO_3]
       45 CAPTURE                          VAL R7
       46 CAPTURE                          VAL R6
       47 SETTABLEKS                       R8 R4 K30 ["getIntegrationsAsync"]
       49 DUPCLOSURE                       R8 K31 [PROTO_5]
       50 CAPTURE                          VAL R3
       51 SETTABLEKS                       R8 R4 K32 ["setIntegrationsAsync"]
       53 RETURN                           R4 1
