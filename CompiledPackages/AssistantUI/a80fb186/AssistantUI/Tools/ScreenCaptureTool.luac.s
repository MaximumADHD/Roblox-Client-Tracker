...
PROTO_10:
       ...
       58 CALL                             R8 0 1
       59 JUMPIFNOT                        R8 ; [+9]
       60 DUPTABLE                         R7 K22 [{"transformInitialContent", "getTransformResultFn"}]
       61 DUPCLOSURE                       R8 K23 [PROTO_5]
       62 CAPTURE                          UPVAL U7
       63 SETTABLEKS                       R8 R7 K20 ["transformInitialContent"]
       65 DUPCLOSURE                       R8 K24 [PROTO_7]
       66 SETTABLEKS                       R8 R7 K21 ["getTransformResultFn"]
       68 JUMP                             ; [+1]
       69 LOADNIL                          R7
       70 DUPTABLE                         R8 K30 [{"definition", "getPreExecuteWarning", "displayNameFunction", "streamTransform", "contentWidgets"}]
       71 SETTABLEKS                       R6 R8 K25 ["definition"]
       73 DUPCLOSURE                       R9 K31 [PROTO_8]
       74 SETTABLEKS                       R9 R8 K26 ["getPreExecuteWarning"]
       76 DUPCLOSURE                       R9 K32 [PROTO_9]
       77 CAPTURE                          UPVAL U8
       78 SETTABLEKS                       R9 R8 K27 ["displayNameFunction"]
       80 SETTABLEKS                       R7 R8 K28 ["streamTransform"]
       82 GETUPVAL                         R10 6
       83 CALL                             R10 0 1
       84 JUMPIFNOT                        R10 ; [+6]
       85 NEWTABLE                         R9 0 1
       ...
       90 JUMP                             ; [+1]
       91 LOADNIL                          R9
       92 SETTABLEKS                       R9 R8 K29 ["contentWidgets"]
       94 CLOSEUPVALS                      R3
       95 RETURN                           R8 1
...
MAIN:
       ...
       57 GETTABLEKS                       R8 R9 K20 ["FFlagEnableSubagents"]
       59 CALL                             R7 1 1
       60 GETIMPORT                        R8 K5 [require]
       62 GETTABLEKS                       R10 R0 K19 ["Flags"]
       64 GETTABLEKS                       R9 R10 K21 ["FStringScreenCaptureFormat"]
       66 CALL                             R8 1 1
       67 GETTABLEKS                       R10 R2 K14 ["Util"]
       69 GETTABLEKS                       R9 R10 K22 ["ToolBuilder"]
       71 GETTABLEKS                       R11 R2 K14 ["Util"]
       73 GETTABLEKS                       R10 R11 K23 ["ToolResult"]
       75 GETIMPORT                        R11 K5 [require]
       77 GETTABLEKS                       R12 R0 K24 ["Types"]
       79 CALL                             R11 1 1
       80 GETTABLEKS                       R12 R4 K25 ["ToolNames"]
       82 DUPCLOSURE                       R13 K26 [PROTO_10]
       83 CAPTURE                          VAL R8
       84 CAPTURE                          VAL R3
       85 CAPTURE                          VAL R5
       86 CAPTURE                          VAL R10
