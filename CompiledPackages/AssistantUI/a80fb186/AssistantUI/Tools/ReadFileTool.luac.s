...
PROTO_3:
        0 GETUPVAL                         R3 0
        1 GETTABLEKS                       R2 R3 K0 ["findInstance"]
       ...
       15 GETUPVAL                         R5 1
       16 GETTABLEKS                       R4 R5 K7 ["openScriptAsync"]
       18 MOVE                             R5 R2
...
PROTO_6:
        ...
        2 GETTABLEKS                       R2 R3 K2 ["target_file"]
        4 ORK                              R1 R2 K0 [""]
        5 GETTABLEKS                       R3 R0 K1 ["input"]
        7 GETTABLEKS                       R2 R3 K3 ["start_line_one_indexed"]
        9 GETTABLEKS                       R4 R0 K1 ["input"]
       11 GETTABLEKS                       R3 R4 K4 ["end_line_one_indexed_inclusive"]
       13 NEWCLOSURE                       R4 P0
       14 CAPTURE                          VAL R1
       15 CAPTURE                          VAL R2
       16 CAPTURE                          VAL R3
...
PROTO_10:
       ...
       80 CALL                             R6 0 1
       81 JUMPIFNOT                        R6 ; [+7]
       82 LOADK                            R8 K27 ["ReadFileTool_openScript"]
       83 NEWCLOSURE                       R9 P2
       84 CAPTURE                          UPVAL U5
       85 CAPTURE                          VAL R2
       86 NAMECALL                         R6 R1 K3 ["OnHostInvokeAsync"]
       88 CALL                             R6 3 0
       89 LOADNIL                          R6
       90 GETUPVAL                         R7 4
       91 CALL                             R7 0 1
       92 JUMPIFNOT                        R7 ; [+10]
       93 DUPTABLE                         R7 K30 [{"transformInitialContent", "getTransformPreExecuteFn"}]
       94 DUPCLOSURE                       R8 K31 [PROTO_4]
       95 CAPTURE                          UPVAL U6
       96 SETTABLEKS                       R8 R7 K28 ["transformInitialContent"]
       98 DUPCLOSURE                       R8 K32 [PROTO_6]
       99 SETTABLEKS                       R8 R7 K29 ["getTransformPreExecuteFn"]
      101 MOVE                             R6 R7
      102 JUMP                             ; [+11]
      103 DUPTABLE                         R7 K34 [{"transformInitialContent", "getTransformResultFn"}]
      104 DUPCLOSURE                       R8 K35 [PROTO_7]
      105 CAPTURE                          UPVAL U7
      106 CAPTURE                          UPVAL U8
      107 SETTABLEKS                       R8 R7 K28 ["transformInitialContent"]
      109 DUPCLOSURE                       R8 K36 [PROTO_9]
      110 CAPTURE                          UPVAL U8
      111 SETTABLEKS                       R8 R7 K33 ["getTransformResultFn"]
      113 MOVE                             R6 R7
      114 DUPTABLE                         R7 K40 [{"definition", "contentWidgets", "streamTransform"}]
      115 SETTABLEKS                       R5 R7 K37 ["definition"]
      117 NEWTABLE                         R8 0 1
      119 GETUPVAL                         R10 4
      120 CALL                             R10 0 1
      121 JUMPIFNOT                        R10 ; [+2]
      ...
      127 SETTABLEKS                       R8 R7 K38 ["contentWidgets"]
      129 SETTABLEKS                       R6 R7 K39 ["streamTransform"]
      131 RETURN                           R7 1
...
MAIN:
       ...
       27 GETTABLEKS                       R4 R5 K12 ["ReadFileContentWidget"]
       29 CALL                             R3 1 1
       30 GETIMPORT                        R4 K5 [require]
       32 GETTABLEKS                       R7 R0 K10 ["Components"]
       34 GETTABLEKS                       R6 R7 K11 ["ContentWidgets"]
       36 GETTABLEKS                       R5 R6 K13 ["SummarizedContentWidget"]
       38 CALL                             R4 1 1
       39 GETIMPORT                        R5 K5 [require]
       41 GETTABLEKS                       R7 R0 K14 ["Tools"]
       43 GETTABLEKS                       R6 R7 K15 ["ToolTypes"]
       45 CALL                             R5 1 1
       46 GETIMPORT                        R6 K5 [require]
       48 GETTABLEKS                       R8 R0 K16 ["Util"]
       50 GETTABLEKS                       R7 R8 K17 ["ToolUtils"]
       52 CALL                             R6 1 1
       53 GETIMPORT                        R7 K5 [require]
       55 GETTABLEKS                       R10 R0 K18 ["Resources"]
       57 GETTABLEKS                       R9 R10 K19 ["Localization"]
       59 GETTABLEKS                       R8 R9 K20 ["Translator"]
       61 CALL                             R7 1 1
       62 GETIMPORT                        R8 K5 [require]
       64 GETTABLEKS                       R9 R0 K21 ["Flags"]
       66 CALL                             R8 1 1
       67 GETTABLEKS                       R10 R8 K22 ["Shared"]
       69 GETTABLEKS                       R9 R10 K23 ["FFlagEnableSubagents"]
       71 GETTABLEKS                       R11 R2 K16 ["Util"]
       73 GETTABLEKS                       R10 R11 K24 ["ToolBuilder"]
       75 GETTABLEKS                       R12 R2 K16 ["Util"]
       77 GETTABLEKS                       R11 R12 K25 ["ToolResult"]
       79 GETTABLEKS                       R12 R5 K26 ["ToolNames"]
       81 DUPCLOSURE                       R13 K27 [PROTO_0]
       82 CAPTURE                          VAL R6
       83 DUPCLOSURE                       R14 K28 [PROTO_10]
       84 CAPTURE                          VAL R13
       85 CAPTURE                          VAL R11
       86 CAPTURE                          VAL R10
       87 CAPTURE                          VAL R12
