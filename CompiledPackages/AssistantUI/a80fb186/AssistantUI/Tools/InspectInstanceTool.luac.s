...
PROTO_1:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R1 R2 K0 ["getValueRepresentation"]
        3 MOVE                             R2 R0
        4 GETUPVAL                         R3 1
        5 GETUPVAL                         R4 2
        6 CALL                             R1 3 -1
...
PROTO_2:
       ...
       21 FORGPREP_NEXT                    R4
       22 GETUPVAL                         R10 0
       23 GETTABLEKS                       R9 R10 K7 ["getValueRepresentation"]
       25 MOVE                             R10 R8
       26 GETUPVAL                         R11 1
       27 GETUPVAL                         R12 2
       28 CALL                             R9 3 1
...
PROTO_6:
       ...
       36 GETUPVAL                         R13 2
       37 GETTABLEKS                       R12 R13 K3 ["getValueRepresentation"]
       39 MOVE                             R13 R11
       40 GETUPVAL                         R14 3
       41 GETUPVAL                         R15 4
       42 CALL                             R12 3 1
...
MAIN:
       ...
       62 CALL                             R8 1 1
       63 GETTABLEKS                       R10 R8 K24 ["Shared"]
       65 GETTABLEKS                       R9 R10 K25 ["FFlagEnableSubagents"]
       67 GETTABLEKS                       R11 R3 K18 ["Util"]
       69 GETTABLEKS                       R10 R11 K26 ["ToolBuilder"]
       71 GETTABLEKS                       R12 R3 K18 ["Util"]
       73 GETTABLEKS                       R11 R12 K27 ["ToolResult"]
       75 GETTABLEKS                       R12 R5 K28 ["ToolNames"]
       77 GETIMPORT                        R13 K10 [require]
       79 GETTABLEKS                       R15 R0 K23 ["Flags"]
       81 GETTABLEKS                       R14 R15 K29 ["FIntInspectInstanceMaxJsonLength"]
       83 CALL                             R13 1 1
       84 CALL                             R13 0 1
       85 GETIMPORT                        R14 K10 [require]
       87 GETTABLEKS                       R16 R0 K23 ["Flags"]
       89 GETTABLEKS                       R15 R16 K30 ["FIntInspectInstanceMaxMatches"]
       91 CALL                             R14 1 1
       92 CALL                             R14 0 1
       93 GETIMPORT                        R15 K10 [require]
       95 GETTABLEKS                       R17 R0 K23 ["Flags"]
       97 GETTABLEKS                       R16 R17 K31 ["FIntInspectInstanceMaxStringLength"]
       99 CALL                             R15 1 1
      100 CALL                             R15 0 1
      101 DUPCLOSURE                       R16 K32 [PROTO_0]
      102 DUPCLOSURE                       R17 K33 [PROTO_1]
      103 CAPTURE                          VAL R6
      104 CAPTURE                          VAL R15
      105 CAPTURE                          VAL R13
      106 DUPCLOSURE                       R18 K34 [PROTO_2]
      107 CAPTURE                          VAL R6
      108 CAPTURE                          VAL R15
      109 CAPTURE                          VAL R13
      110 DUPTABLE                         R19 K38 [{"Parent", "ClassName", "Name", "DataModel"}]
      111 LOADB                            R20 1
      112 SETTABLEKS                       R20 R19 K11 ["Parent"]
      114 LOADB                            R20 1
      115 SETTABLEKS                       R20 R19 K35 ["ClassName"]
      117 LOADB                            R20 1
      118 SETTABLEKS                       R20 R19 K36 ["Name"]
      120 LOADB                            R20 1
      121 SETTABLEKS                       R20 R19 K37 ["DataModel"]
      123 DUPCLOSURE                       R20 K39 [PROTO_3]
      124 CAPTURE                          VAL R6
      125 CAPTURE                          VAL R15
      126 CAPTURE                          VAL R13
      127 DUPCLOSURE                       R21 K40 [PROTO_6]
      128 CAPTURE                          VAL R2
      129 CAPTURE                          VAL R19
      130 CAPTURE                          VAL R6
      131 CAPTURE                          VAL R15
      132 CAPTURE                          VAL R13
      133 DUPCLOSURE                       R22 K41 [PROTO_8]
      134 CAPTURE                          VAL R21
      135 CAPTURE                          VAL R16
      136 CAPTURE                          VAL R18
      137 DUPCLOSURE                       R23 K42 [PROTO_10]
      138 CAPTURE                          VAL R1
      139 DUPCLOSURE                       R24 K43 [PROTO_12]
      140 DUPCLOSURE                       R25 K44 [PROTO_13]
      141 CAPTURE                          VAL R24
      142 CAPTURE                          VAL R9
      143 CAPTURE                          VAL R22
      144 CAPTURE                          VAL R1
      145 CAPTURE                          VAL R14
      146 DUPCLOSURE                       R26 K45 [PROTO_22]
      147 CAPTURE                          VAL R25
      148 CAPTURE                          VAL R9
      149 CAPTURE                          VAL R11
      150 CAPTURE                          VAL R10
