...
PROTO_3:
        ...
        1 JUMPIFEQKNIL                     R0 ; [+8]
        3 GETUPVAL                         R1 1
        4 GETTABLEKS                       R0 R1 K0 ["onCustomTextFocused"]
        6 GETUPVAL                         R1 2
        7 CALL                             R0 1 0
        8 GETUPVAL                         R0 3
        9 CALL                             R0 0 0
...
PROTO_4:
       ...
       20 CALL                             R7 1 1
       21 GETUPVAL                         R9 1
       22 GETTABLEKS                       R8 R9 K4 ["useState"]
       24 LOADB                            R9 0
       25 CALL                             R8 1 2
       26 GETUPVAL                         R11 1
       27 GETTABLEKS                       R10 R11 K5 ["useCallback"]
       29 NEWCLOSURE                       R11 P0
       30 CAPTURE                          VAL R9
       31 NEWTABLE                         R12 0 0
       33 CALL                             R10 2 1
       34 GETUPVAL                         R12 1
       35 GETTABLEKS                       R11 R12 K6 ["useEffect"]
      ...
      105 LOADB                            R16 1
      106 GETUPVAL                         R18 1
      107 GETTABLEKS                       R17 R18 K5 ["useCallback"]
...
MAIN:
       ...
       34 GETTABLEKS                       R5 R6 K10 ["useAnswerState"]
       36 CALL                             R4 1 1
       37 GETIMPORT                        R5 K5 [require]
       39 GETIMPORT                        R8 K1 [script]
       41 GETTABLEKS                       R7 R8 K6 ["Parent"]
       43 GETTABLEKS                       R6 R7 K11 ["useQuestionKeyboardInput"]
       45 CALL                             R5 1 1
       46 GETIMPORT                        R6 K5 [require]
       48 GETIMPORT                        R9 K1 [script]
       50 GETTABLEKS                       R8 R9 K6 ["Parent"]
       52 GETTABLEKS                       R7 R8 K12 ["useQuestionPagination"]
       54 CALL                             R6 1 1
