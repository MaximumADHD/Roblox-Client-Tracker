PROTO_0:
        0 GETUPVAL                         R0 0
        1 GETUPVAL                         R2 1
        2 GETTABLEKS                       R1 R2 K0 ["initialText"]
...
PROTO_1:
        ...
        8 LOADN                            R4 1
        9 GETUPVAL                         R6 1
       10 GETTABLEKS                       R5 R6 K2 ["maxLength"]
       ...
       36 GETUPVAL                         R5 0
       37 GETTABLEKS                       R4 R5 K1 ["current"]
       39 SETTABLEKS                       R4 R0 K0 ["Text"]
       41 GETUPVAL                         R6 0
       42 GETTABLEKS                       R5 R6 K1 ["current"]
       ...
       51 GETUPVAL                         R7 1
       52 GETTABLEKS                       R6 R7 K9 ["min"]
       54 JUMPIFEQKNIL                     R6 ; [+7]
       56 LOADB                            R5 0
       57 GETUPVAL                         R7 1
       58 GETTABLEKS                       R6 R7 K9 ["min"]
       60 JUMPIFNOTLE                      R6 R4 ; [+14]
       62 LOADB                            R5 1
       63 GETUPVAL                         R7 1
       64 GETTABLEKS                       R6 R7 K10 ["max"]
       66 JUMPIFEQKNIL                     R6 ; [+8]
       68 GETUPVAL                         R7 1
       69 GETTABLEKS                       R6 R7 K10 ["max"]
       71 JUMPIFLE                         R4 R6 ; [+2]
       73 LOADB                            R5 0 +1
       74 LOADB                            R5 1
       75 GETUPVAL                         R6 2
       ...
       77 CALL                             R6 1 0
       78 GETUPVAL                         R7 1
       79 GETTABLEKS                       R6 R7 K11 ["onValueChange"]
       81 JUMPIFNOT                        R6 ; [+5]
       82 GETUPVAL                         R7 1
       83 GETTABLEKS                       R6 R7 K11 ["onValueChange"]
       85 MOVE                             R7 R4
       86 CALL                             R6 1 0
       87 RETURN                           R0 0
...
PROTO_2:
        ...
        5 CALL                             R1 0 1
        6 GETTABLEKS                       R4 R1 K2 ["Color"]
        8 GETTABLEKS                       R3 R4 K3 ["System"]
       10 GETTABLEKS                       R2 R3 K4 ["Alert"]
       12 GETUPVAL                         R4 1
       13 GETTABLEKS                       R3 R4 K5 ["useRef"]
       15 GETTABLEKS                       R4 R0 K6 ["initialText"]
       17 CALL                             R3 1 1
       18 GETUPVAL                         R5 1
       19 GETTABLEKS                       R4 R5 K7 ["useState"]
       21 LOADB                            R5 1
       22 CALL                             R4 1 2
       23 GETUPVAL                         R7 1
       24 GETTABLEKS                       R6 R7 K8 ["useEffect"]
       26 NEWCLOSURE                       R7 P0
       27 CAPTURE                          VAL R3
       28 CAPTURE                          VAL R0
       29 NEWTABLE                         R8 0 0
       31 CALL                             R6 2 0
       32 GETUPVAL                         R7 1
       33 GETTABLEKS                       R6 R7 K9 ["useCallback"]
       35 NEWCLOSURE                       R7 P1
       36 CAPTURE                          VAL R3
       37 CAPTURE                          VAL R0
       38 CAPTURE                          VAL R5
       ...
       50 GETUPVAL                         R10 3
       51 GETTABLEKS                       R9 R10 K13 ["assign"]
       ...
       69 GETUPVAL                         R14 1
       70 GETTABLEKS                       R13 R14 K19 ["Change"]
       72 GETTABLEKS                       R12 R13 K16 ["Text"]
...
PROTO_4:
        ...
        5 CALL                             R1 0 1
        6 GETTABLEKS                       R4 R1 K2 ["Color"]
        8 GETTABLEKS                       R3 R4 K3 ["Content"]
       10 GETTABLEKS                       R2 R3 K4 ["Emphasis"]
       12 GETUPVAL                         R4 1
       13 GETTABLEKS                       R3 R4 K5 ["useCallback"]
       15 NEWCLOSURE                       R4 P0
       16 CAPTURE                          VAL R0
       17 NEWTABLE                         R5 0 1
       ...
       23 CALL                             R3 2 1
       24 GETTABLEKS                       R5 R0 K7 ["definition"]
       26 GETTABLEKS                       R4 R5 K8 ["options"]
       28 JUMPIF                           R4 ; [+2]
       29 NEWTABLE                         R4 0 0
       31 GETUPVAL                         R5 2
       32 GETUPVAL                         R6 3
      ...
      108 GETTABLEKS                       R14 R1 K47 ["FontSize"]
      110 GETTABLEKS                       R13 R14 K48 ["FontSize_300"]
      112 SETTABLEKS                       R13 R12 K33 ["TextSize"]
      114 GETTABLEKS                       R14 R1 K34 ["LineHeight"]
      116 GETTABLEKS                       R13 R14 K49 ["LineHeight_140"]
      ...
      147 LOADN                            R13 0
      148 GETTABLEKS                       R15 R1 K27 ["Size"]
      150 GETTABLEKS                       R14 R15 K59 ["Size_150"]
      152 CALL                             R12 2 1
...
MAIN:
       ...
       34 GETTABLEKS                       R5 R6 K10 ["PropertyRowTypes"]
       36 CALL                             R4 1 1
