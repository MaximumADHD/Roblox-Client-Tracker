PROTO_0:
        0 GETUPVAL                         R3 0
        1 GETTABLEKS                       R2 R3 K0 ["LLMProviderTypes"]
        3 GETTABLEKS                       R1 R2 K1 ["Claude"]
        5 JUMPIFNOTEQ                      R0 R1 ; [+4]
        7 GETUPVAL                         R2 1
        8 GETTABLEN                        R1 R2 1
        9 RETURN                           R1 1
       10 GETUPVAL                         R3 0
       11 GETTABLEKS                       R2 R3 K0 ["LLMProviderTypes"]
       13 GETTABLEKS                       R1 R2 K2 ["Gemini"]
       15 JUMPIFNOTEQ                      R0 R1 ; [+4]
       17 GETUPVAL                         R2 2
       18 GETTABLEN                        R1 R2 1
       19 RETURN                           R1 1
       20 GETUPVAL                         R3 0
       21 GETTABLEKS                       R2 R3 K0 ["LLMProviderTypes"]
       23 GETTABLEKS                       R1 R2 K3 ["OpenAI"]
...
PROTO_1:
        ...
        3 GETUPVAL                         R3 1
        4 GETTABLEKS                       R2 R3 K0 ["LLMProviderTypes"]
        6 GETTABLEKS                       R1 R2 K1 ["Studio"]
        8 RETURN                           R1 1
       ...
       14 JUMPIFNOT                        R1 ; [+6]
       15 GETUPVAL                         R3 1
       16 GETTABLEKS                       R2 R3 K0 ["LLMProviderTypes"]
       18 GETTABLEKS                       R1 R2 K5 ["Claude"]
       20 RETURN                           R1 1
       ...
       26 JUMPIFNOT                        R1 ; [+6]
       27 GETUPVAL                         R3 1
       28 GETTABLEKS                       R2 R3 K0 ["LLMProviderTypes"]
       30 GETTABLEKS                       R1 R2 K6 ["Gemini"]
       32 RETURN                           R1 1
       ...
       38 JUMPIFNOT                        R1 ; [+6]
       39 GETUPVAL                         R3 1
       40 GETTABLEKS                       R2 R3 K0 ["LLMProviderTypes"]
       42 GETTABLEKS                       R1 R2 K7 ["OpenAI"]
       44 RETURN                           R1 1
       45 GETUPVAL                         R3 1
       46 GETTABLEKS                       R2 R3 K0 ["LLMProviderTypes"]
       48 GETTABLEKS                       R1 R2 K1 ["Studio"]
       50 RETURN                           R1 1
...
PROTO_2:
        ...
        5 GETUPVAL                         R3 0
        6 GETTABLEKS                       R2 R3 K1 ["LLMProviderTypes"]
        8 GETTABLEKS                       R1 R2 K2 ["Claude"]
       10 RETURN                           R1 1
       11 GETUPVAL                         R2 0
       12 GETTABLEKS                       R1 R2 K3 ["OPENAI_PROVIDER_ENABLED"]
       14 JUMPIFNOTEQ                      R0 R1 ; [+7]
       16 GETUPVAL                         R3 0
       17 GETTABLEKS                       R2 R3 K1 ["LLMProviderTypes"]
       19 GETTABLEKS                       R1 R2 K4 ["OpenAI"]
       21 RETURN                           R1 1
       22 GETUPVAL                         R2 0
       23 GETTABLEKS                       R1 R2 K5 ["GEMINI_PROVIDER_ENABLED"]
       25 JUMPIFNOTEQ                      R0 R1 ; [+7]
       27 GETUPVAL                         R3 0
       28 GETTABLEKS                       R2 R3 K1 ["LLMProviderTypes"]
       30 GETTABLEKS                       R1 R2 K6 ["Gemini"]
       32 RETURN                           R1 1
       33 LOADNIL                          R1
       34 RETURN                           R1 1
...
PROTO_3:
        ...
        7 GETUPVAL                         R2 0
        8 GETTABLEKS                       R1 R2 K2 ["ANTHROPIC_PROVIDER_ENABLED"]
       10 RETURN                           R1 1
       11 GETUPVAL                         R3 0
       12 GETTABLEKS                       R2 R3 K0 ["LLMProviderTypes"]
       14 GETTABLEKS                       R1 R2 K3 ["OpenAI"]
       16 JUMPIFNOTEQ                      R0 R1 ; [+5]
       18 GETUPVAL                         R2 0
       19 GETTABLEKS                       R1 R2 K4 ["OPENAI_PROVIDER_ENABLED"]
       21 RETURN                           R1 1
       22 GETUPVAL                         R3 0
       23 GETTABLEKS                       R2 R3 K0 ["LLMProviderTypes"]
       25 GETTABLEKS                       R1 R2 K5 ["Gemini"]
       27 JUMPIFNOTEQ                      R0 R1 ; [+5]
       29 GETUPVAL                         R2 0
       30 GETTABLEKS                       R1 R2 K6 ["GEMINI_PROVIDER_ENABLED"]
       32 RETURN                           R1 1
       33 LOADK                            R1 K7 [""]
       34 RETURN                           R1 1
