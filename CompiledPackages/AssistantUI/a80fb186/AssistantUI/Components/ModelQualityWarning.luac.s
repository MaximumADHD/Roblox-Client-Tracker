...
PROTO_1:
        ...
        3 GETUPVAL                         R4 1
        4 GETTABLEKS                       R3 R4 K1 ["ModelQuality"]
        6 GETTABLEKS                       R2 R3 K2 ["Low"]
        8 JUMPIFEQ                         R1 R2 ; [+2]
       10 LOADB                            R0 0 +1
       11 LOADB                            R0 1
       12 GETUPVAL                         R1 2
...
PROTO_3:
       ...
       17 NEWTABLE                         R6 0 1
       19 GETUPVAL                         R8 2
       20 GETTABLEKS                       R7 R8 K5 ["locale"]
       22 SETLIST                          R6 R7 1 [1]
       24 CALL                             R4 2 1
       25 GETUPVAL                         R6 0
       26 GETTABLEKS                       R5 R6 K6 ["useEffect"]
       28 NEWCLOSURE                       R6 P1
       29 CAPTURE                          VAL R1
       30 CAPTURE                          UPVAL U1
       31 CAPTURE                          VAL R3
       ...
       45 CALL                             R5 2 1
       46 GETUPVAL                         R8 3
       47 GETTABLEKS                       R7 R8 K8 ["Hooks"]
       49 GETTABLEKS                       R6 R7 K9 ["useTokens"]
       51 CALL                             R6 0 1
       52 JUMPIF                           R2 ; [+1]
       53 RETURN                           R0 0
       54 GETUPVAL                         R7 4
       ...
       75 LOADN                            R12 1
       76 LOADN                            R14 254
       77 GETTABLEKS                       R16 R6 K22 ["Padding"]
       79 GETTABLEKS                       R15 R16 K23 ["Medium"]
       81 MUL                              R13 R14 R15
       82 LOADN                            R14 0
       83 LOADN                            R15 0
       84 CALL                             R11 4 1
       ...
       95 GETUPVAL                         R12 7
       96 GETTABLEKS                       R11 R12 K24 ["ModelQualityWarning"]
...
MAIN:
       ...
       27 GETTABLEKS                       R4 R5 K11 ["ModelQualityContext"]
       29 CALL                             R3 1 1
