...
PROTO_17:
        0 DUPTABLE                         R2 K4 [{"selectInsertedAssets", "listenToLinkChanges", "swapAssetAsync", "insertFromMarketplaceAsync"}]
        1 NEWCLOSURE                       R3 P0
        2 CAPTURE                          UPVAL U0
        3 CAPTURE                          VAL R0
        4 CAPTURE                          VAL R1
...
PROTO_18:
        ...
        5 CAPTURE                          VAL R1
        6 GETUPVAL                         R9 0
        7 GETTABLEKS                       R8 R9 K1 ["selectInsertedAssets"]
        9 GETUPVAL                         R11 0
       10 GETTABLE                         R10 R11 R8
       11 LOADK                            R12 K2 ["Invalid network key: "]
       12 MOVE                             R13 R8
       ...
       31 CALL                             R5 3 1
       32 GETUPVAL                         R10 0
       33 GETTABLEKS                       R9 R10 K8 ["listenToLinkChanges"]
       35 GETUPVAL                         R12 0
       ...
       57 CALL                             R6 3 1
       58 GETUPVAL                         R11 0
       59 GETTABLEKS                       R10 R11 K9 ["swapAssetAsync"]
       61 GETUPVAL                         R13 0
       ...
       83 CALL                             R7 3 1
       84 GETUPVAL                         R12 0
       85 GETTABLEKS                       R11 R12 K11 ["insertFromMarketplaceAsync"]
       87 GETUPVAL                         R14 0
...
MAIN:
       ...
       20 GETTABLEKS                       R3 R4 K9 ["CreatorStoreInsertBridgeTypes"]
       22 CALL                             R2 1 1
       23 DUPTABLE                         R3 K15 [{"updateContentHeader", "selectInsertedAssets", "listenToLinkChanges", "swapAssetAsync", "insertFromMarketplaceAsync"}]
       ...
       33 LOADK                            R4 K13 ["swapAssetAsync"]
       34 SETTABLEKS                       R4 R3 K13 ["swapAssetAsync"]
       36 LOADK                            R4 K14 ["insertFromMarketplaceAsync"]
       37 SETTABLEKS                       R4 R3 K14 ["insertFromMarketplaceAsync"]
       39 DUPCLOSURE                       R4 K16 [PROTO_0]
       40 CAPTURE                          VAL R3
       41 DUPCLOSURE                       R5 K17 [PROTO_1]
       42 DUPCLOSURE                       R6 K18 [PROTO_6]
       43 CAPTURE                          VAL R3
       44 DUPCLOSURE                       R7 K19 [PROTO_7]
       45 DUPCLOSURE                       R8 K20 [PROTO_18]
       46 CAPTURE                          VAL R3
       47 DUPCLOSURE                       R9 K21 [PROTO_19]
       48 CAPTURE                          VAL R1
       49 CAPTURE                          VAL R8
       50 CAPTURE                          VAL R6
       51 DUPTABLE                         R10 K24 [{"prepareBridges", "createGuestContext"}]
       52 SETTABLEKS                       R9 R10 K22 ["prepareBridges"]
       54 SETTABLEKS                       R5 R10 K23 ["createGuestContext"]
       56 RETURN                           R10 1
