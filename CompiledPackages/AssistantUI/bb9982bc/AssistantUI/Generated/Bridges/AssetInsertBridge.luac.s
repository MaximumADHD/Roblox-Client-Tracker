PROTO_0:
        ...
        9 CALL                             R1 2 0
       10 LOADK                            R1 K3 ["createAssetInsertBridge_%*"]
       11 MOVE                             R3 R0
...
PROTO_10:
        0 DUPTABLE                         R2 K2 [{"insertAssetAsync", "toTarget"}]
        1 NEWCLOSURE                       R3 P0
        2 CAPTURE                          UPVAL U0
        3 CAPTURE                          VAL R0
        4 CAPTURE                          VAL R1
        5 SETTABLEKS                       R3 R2 K0 ["insertAssetAsync"]
        7 NEWCLOSURE                       R3 P1
        8 CAPTURE                          UPVAL U1
        9 CAPTURE                          VAL R1
...
PROTO_11:
        ...
        5 CAPTURE                          VAL R1
        6 GETUPVAL                         R10 0
        7 GETTABLEKS                       R9 R10 K1 ["insertAssetAsync"]
        9 FASTCALL2K                       ASSERT R9 K2 ; [+4]
       11 LOADK                            R10 K2 ["Invalid network key: insertAssetAsync"]
       12 GETIMPORT                        R8 K4 [assert]
       14 CALL                             R8 2 0
       15 LOADK                            R7 K5 ["createAssetInsertBridge_insertAssetAsync"]
       16 NEWCLOSURE                       R8 P1
       17 CAPTURE                          VAL R2
       18 CAPTURE                          VAL R0
       19 CAPTURE                          VAL R1
...
MAIN:
       ...
       11 GETTABLEKS                       R2 R2 K7 ["createAssetInsertBridge"]
       13 GETTABLEKS                       R2 R2 K8 ["AssetInsertBridgeTypes"]
       15 CALL                             R1 1 1
       16 DUPTABLE                         R2 K10 [{["insertAssetAsync"] = "insertAssetAsync"}]
