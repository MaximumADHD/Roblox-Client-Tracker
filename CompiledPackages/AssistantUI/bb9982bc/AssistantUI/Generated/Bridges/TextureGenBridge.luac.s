PROTO_0:
        ...
        9 CALL                             R1 2 0
       10 LOADK                            R1 K3 ["createTextureGenBridge_%*"]
       11 MOVE                             R3 R0
       12 NAMECALL                         R1 R1 K4 ["format"]
       14 CALL                             R1 2 1
       15 RETURN                           R1 1
...
PROTO_7:
       ...
       22 GETTABLEKS                       R5 R3 K8 ["generateTextureAsync"]
       24 MOVE                             R6 R2
       25 MOVE                             R7 R4
       26 CALL                             R5 2 -1
       27 RETURN                           R5 -1
...
PROTO_9:
       ...
       19 CALL                             R7 2 1
       20 SETTABLEKS                       R7 R4 K5 ["bridge"]
       22 GETTABLEKS                       R5 R3 K8 ["insertTexturedModelAsync"]
       24 MOVE                             R6 R2
       25 MOVE                             R7 R4
       26 CALL                             R5 2 -1
       27 RETURN                           R5 -1
...
PROTO_10:
       ...
       19 CALL                             R6 2 1
       20 SETTABLEKS                       R6 R3 K5 ["bridge"]
       22 GETTABLEKS                       R4 R2 K8 ["getSelectedMeshRef"]
       24 MOVE                             R5 R3
       25 CALL                             R4 1 -1
       26 RETURN                           R4 -1
...
PROTO_11:
       ...
       19 CALL                             R7 2 1
       20 SETTABLEKS                       R7 R4 K5 ["bridge"]
       22 GETTABLEKS                       R5 R3 K8 ["isTextureableInstance"]
       24 MOVE                             R6 R2
       25 MOVE                             R7 R4
       26 CALL                             R5 2 -1
       27 RETURN                           R5 -1
...
PROTO_12:
       ...
       19 CALL                             R7 2 1
       20 SETTABLEKS                       R7 R4 K5 ["bridge"]
       22 GETTABLEKS                       R5 R3 K8 ["captureSourceInstanceImageAsync"]
       24 MOVE                             R6 R2
       25 MOVE                             R7 R4
       26 CALL                             R5 2 -1
       27 RETURN                           R5 -1
...
PROTO_20:
        0 DUPTABLE                         R2 K7 [{"generateTextureAsync", "cancelGenerationAsync", "insertTexturedModelAsync", "getSelectedMeshRef", "isTextureableInstance", "captureSourceInstanceImageAsync", "toTarget"}]
        1 NEWCLOSURE                       R3 P0
        2 CAPTURE                          UPVAL U0
        3 CAPTURE                          VAL R0
        4 CAPTURE                          VAL R1
        5 SETTABLEKS                       R3 R2 K0 ["generateTextureAsync"]
        7 NEWCLOSURE                       R3 P1
        8 CAPTURE                          UPVAL U1
        9 CAPTURE                          VAL R0
       10 CAPTURE                          VAL R1
       ...
       15 CAPTURE                          VAL R0
       16 CAPTURE                          VAL R1
       17 SETTABLEKS                       R3 R2 K2 ["insertTexturedModelAsync"]
       19 NEWCLOSURE                       R3 P3
       20 CAPTURE                          UPVAL U3
       21 CAPTURE                          VAL R0
       22 CAPTURE                          VAL R1
       23 SETTABLEKS                       R3 R2 K3 ["getSelectedMeshRef"]
       25 NEWCLOSURE                       R3 P4
       26 CAPTURE                          UPVAL U4
       27 CAPTURE                          VAL R0
       28 CAPTURE                          VAL R1
       29 SETTABLEKS                       R3 R2 K4 ["isTextureableInstance"]
       31 NEWCLOSURE                       R3 P5
       32 CAPTURE                          UPVAL U5
       33 CAPTURE                          VAL R0
       34 CAPTURE                          VAL R1
       35 SETTABLEKS                       R3 R2 K5 ["captureSourceInstanceImageAsync"]
       37 NEWCLOSURE                       R3 P6
       38 CAPTURE                          UPVAL U6
       39 CAPTURE                          VAL R1
       40 SETTABLEKS                       R3 R2 K6 ["toTarget"]
       42 RETURN                           R2 1
...
PROTO_21:
        ...
        5 CAPTURE                          VAL R1
        6 GETUPVAL                         R10 0
        7 GETTABLEKS                       R9 R10 K1 ["generateTextureAsync"]
        9 FASTCALL2K                       ASSERT R9 K2 ; [+4]
       11 LOADK                            R10 K2 ["Invalid network key: generateTextureAsync"]
       12 GETIMPORT                        R8 K4 [assert]
       14 CALL                             R8 2 0
       15 LOADK                            R7 K5 ["createTextureGenBridge_generateTextureAsync"]
       16 NEWCLOSURE                       R8 P1
       17 CAPTURE                          VAL R2
       18 CAPTURE                          VAL R0
       19 CAPTURE                          VAL R1
       ...
       31 CALL                             R9 2 0
       32 LOADK                            R8 K9 ["createTextureGenBridge_cancelGenerationAsync"]
       33 NEWCLOSURE                       R9 P2
       34 CAPTURE                          VAL R2
       35 CAPTURE                          VAL R0
       36 CAPTURE                          VAL R1
       ...
       39 CALL                             R6 3 1
       40 GETUPVAL                         R12 0
       41 GETTABLEKS                       R11 R12 K10 ["insertTexturedModelAsync"]
       43 FASTCALL2K                       ASSERT R11 K11 ; [+4]
       45 LOADK                            R12 K11 ["Invalid network key: insertTexturedModelAsync"]
       46 GETIMPORT                        R10 K4 [assert]
       48 CALL                             R10 2 0
       49 LOADK                            R9 K12 ["createTextureGenBridge_insertTexturedModelAsync"]
       ...
       56 CALL                             R7 3 1
       57 GETUPVAL                         R13 0
       58 GETTABLEKS                       R12 R13 K13 ["getSelectedMeshRef"]
       60 FASTCALL2K                       ASSERT R12 K14 ; [+4]
       62 LOADK                            R13 K14 ["Invalid network key: getSelectedMeshRef"]
       63 GETIMPORT                        R11 K4 [assert]
       65 CALL                             R11 2 0
       66 LOADK                            R10 K15 ["createTextureGenBridge_getSelectedMeshRef"]
       ...
       73 CALL                             R8 3 1
       74 GETUPVAL                         R14 0
       75 GETTABLEKS                       R13 R14 K16 ["isTextureableInstance"]
       77 FASTCALL2K                       ASSERT R13 K17 ; [+4]
       79 LOADK                            R14 K17 ["Invalid network key: isTextureableInstance"]
       80 GETIMPORT                        R12 K4 [assert]
       82 CALL                             R12 2 0
       83 LOADK                            R11 K18 ["createTextureGenBridge_isTextureableInstance"]
       ...
       90 CALL                             R9 3 1
       91 GETUPVAL                         R15 0
       92 GETTABLEKS                       R14 R15 K19 ["captureSourceInstanceImageAsync"]
       94 FASTCALL2K                       ASSERT R14 K20 ; [+4]
       96 LOADK                            R15 K20 ["Invalid network key: captureSourceInstanceImageAsync"]
       97 GETIMPORT                        R13 K4 [assert]
       99 CALL                             R13 2 0
      100 LOADK                            R12 K21 ["createTextureGenBridge_captureSourceInstanceImageAsync"]
...
PROTO_26:
        ...
        1 DUPCLOSURE                       R4 K3 [PROTO_22]
        2 SETTABLEKS                       R4 R3 K0 ["toGuest"]
        4 DUPCLOSURE                       R4 K4 [PROTO_23]
...
MAIN:
       ...
       11 GETTABLEKS                       R2 R2 K7 ["createTextureGenBridge"]
       13 GETTABLEKS                       R2 R2 K8 ["TextureGenBridgeTypes"]
       15 CALL                             R1 1 1
       16 DUPTABLE                         R2 K15 [{["generateTextureAsync"] = "generateTextureAsync", ["cancelGenerationAsync"] = "cancelGenerationAsync", ["insertTexturedModelAsync"] = "insertTexturedModelAsync", ["getSelectedMeshRef"] = "getSelectedMeshRef", ["isTextureableInstance"] = "isTextureableInstance", ["captureSourceInstanceImageAsync"] = "captureSourceInstanceImageAsync"}]
       17 DUPCLOSURE                       R3 K16 [PROTO_0]
       18 CAPTURE                          VAL R2
       19 DUPCLOSURE                       R4 K17 [PROTO_1]
       20 DUPCLOSURE                       R5 K18 [PROTO_4]
       21 DUPCLOSURE                       R6 K19 [PROTO_5]
       22 DUPCLOSURE                       R7 K20 [PROTO_21]
       23 CAPTURE                          VAL R2
       24 DUPCLOSURE                       R8 K21 [PROTO_26]
       25 CAPTURE                          VAL R7
       26 DUPTABLE                         R9 K23 [{"prepareBridges"}]
       27 SETTABLEKS                       R8 R9 K22 ["prepareBridges"]
       29 RETURN                           R9 1
