PROTO_0:
        ...
        5 CALL                             R1 2 1
        6 GETUPVAL                         R2 1
        7 GETTABLEKS                       R3 R0 K2 ["definition"]
...
PROTO_1:
        ...
        3 LOADB                            R2 0
        4 RETURN                           R2 1
        5 GETTABLEKS                       R2 R1 K0 ["mock"]
        7 GETTABLEKS                       R2 R2 K1 ["calls"]
        9 JUMPIFNOT                        R2 ; [+10]
       10 GETTABLEKS                       R4 R1 K0 ["mock"]
       12 GETTABLEKS                       R4 R4 K1 ["calls"]
       14 LENGTH                           R3 R4
       15 LOADN                            R4 0
       16 JUMPIFLT                         R4 R3 ; [+2]
       18 LOADB                            R2 0 +1
...
PROTO_2:
        ...
        3 LOADB                            R3 0
        4 RETURN                           R3 1
        5 GETTABLEKS                       R3 R2 K0 ["mock"]
        7 GETTABLEKS                       R3 R3 K1 ["calls"]
        9 LOADNIL                          R4
       10 LOADNIL                          R5
       11 FORGPREP                         R3
       12 GETUPVAL                         R8 1
       13 GETTABLEKS                       R8 R8 K2 ["Dictionary"]
       15 GETTABLEKS                       R8 R8 K3 ["equals"]
...
MAIN:
       ...
       13 GETTABLEKS                       R3 R3 K7 ["Cryo"]
       15 CALL                             R2 1 1
       16 GETIMPORT                        R3 K5 [require]
       18 GETTABLEKS                       R4 R1 K6 ["Parent"]
       20 GETTABLEKS                       R4 R4 K8 ["ModelContextProtocol"]
       22 CALL                             R3 1 1
       23 LOADK                            R6 K9 ["Packages"]
       24 NAMECALL                         R4 R1 K3 ["FindFirstAncestor"]
       26 CALL                             R4 2 1
       27 GETTABLEKS                       R4 R4 K10 ["Dev"]
