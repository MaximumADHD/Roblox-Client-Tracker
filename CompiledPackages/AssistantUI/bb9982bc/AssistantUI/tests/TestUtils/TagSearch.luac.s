...
PROTO_2:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R2 R2 K0 ["queryAll"]
        3 MOVE                             R3 R0
        4 MOVE                             R4 R1
        5 CALL                             R2 2 1
        6 LENGTH                           R3 R2
        7 JUMPIFEQKN                       R3 K1 [1] ; [+10]
        9 GETIMPORT                        R3 K3 [error]
       11 LOADK                            R4 K4 ["%* instances found with tag \"%*\""]
       12 LENGTH                           R6 R2
       13 MOVE                             R7 R1
...
PROTO_3:
        ...
        6 LENGTH                           R3 R2
        7 LOADN                            R4 1
        8 JUMPIFNOTLT                      R4 R3 ; [+10]
       10 GETIMPORT                        R3 K2 [error]
       12 LOADK                            R4 K3 ["%* instances found with tag \"%*\""]
       13 LENGTH                           R6 R2
       14 MOVE                             R7 R1
...
MAIN:
       ...
       17 GETTABLEKS                       R3 R3 K11 ["filterList"]
       19 CALL                             R2 1 1
       20 NEWTABLE                         R3 4 0
