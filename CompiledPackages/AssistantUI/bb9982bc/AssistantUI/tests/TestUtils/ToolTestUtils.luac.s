...
PROTO_3:
      ...
      102 CALL                             R13 1 1
      103 LOADK                            R16 K29 ["Tool name %* is not a number string"]
      104 MOVE                             R18 R11
      105 NAMECALL                         R16 R16 K30 ["format"]
      107 CALL                             R16 2 1
      108 FASTCALL2                        ASSERT R13 R16 ; [+4]
      110 MOVE                             R15 R13
      111 GETIMPORT                        R14 K9 [assert]
      113 CALL                             R14 2 0
      114 SETTABLE                         R12 R7 R13
      115 FORGLOOP                         R8 2 ; [-18]
      117 MOVE                             R8 R7
      118 MOVE                             R9 R2
      119 RETURN                           R8 2
...
PROTO_8:
        ...
        2 GETTABLE                         R2 R3 R1
        3 LOADK                            R5 K1 ["No content found at index %*"]
        4 MOVE                             R7 R1
       ...
       13 CALL                             R3 2 0
       14 GETTABLEKS                       R5 R2 K5 ["type"]
       16 JUMPIFEQKS                       R5 K6 ["text"] ; [+2]
       18 LOADB                            R4 0 +1
       19 LOADB                            R4 1
       20 LOADK                            R5 K7 ["Expected content at index %* to be of type \"text\", got %*"]
       21 MOVE                             R7 R1
       22 GETTABLEKS                       R8 R2 K5 ["type"]
