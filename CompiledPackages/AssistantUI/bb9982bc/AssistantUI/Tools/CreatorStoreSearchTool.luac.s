...
PROTO_1:
       ...
       38 LOADB                            R5 0 +1
       39 LOADB                            R5 1
       40 LOADK                            R6 K12 ["Failed to find \"%*\" in the marketplace!"]
       41 MOVE                             R8 R1
       42 NAMECALL                         R6 R6 K13 ["format"]
       44 CALL                             R6 2 1
       45 FASTCALL2                        ASSERT R5 R6 ; [+3]
       47 GETIMPORT                        R4 K15 [assert]
       49 CALL                             R4 2 0
       50 RETURN                           R3 1
...
PROTO_4:
        ...
        9 CALL                             R3 2 1
       10 LENGTH                           R4 R3
       11 JUMPIFNOTEQKN                    R4 K2 [0] ; [+11]
       13 GETIMPORT                        R4 K4 [error]
       15 LOADK                            R5 K5 ["Failed to find \"%*\" in the marketplace!"]
       16 GETTABLEKS                       R7 R1 K1 ["query"]
       18 NAMECALL                         R5 R5 K6 ["format"]
       20 CALL                             R5 2 1
       21 LOADN                            R6 0
       22 CALL                             R4 2 0
       23 GETUPVAL                         R4 2
       24 GETTABLEKS                       R4 R4 K7 ["setFromAssets"]
       26 MOVE                             R5 R2
       27 MOVE                             R6 R3
       28 CALL                             R4 2 0
       29 DUPTABLE                         R4 K9 [{"searchId"}]
       30 SETTABLEKS                       R2 R4 K8 ["searchId"]
       32 GETUPVAL                         R5 3
       33 MOVE                             R6 R3
       34 GETTABLEKS                       R7 R1 K1 ["query"]
       36 CALL                             R5 2 1
       37 LENGTH                           R6 R5
       38 LOADN                            R7 0
       39 JUMPIFNOTLT                      R7 R6 ; [+3]
       41 SETTABLEKS                       R5 R4 K10 ["objectTypes"]
       43 GETUPVAL                         R6 4
       44 GETTABLEKS                       R6 R6 K11 ["toString"]
       46 MOVE                             R7 R4
       47 CALL                             R6 1 -1
       48 RETURN                           R6 -1
...
PROTO_13:
       ...
       37 CALL                             R2 1 1
       38 DUPTABLE                         R3 K30 [{["command"] = "insert", ["getDescription"], ["runToolChain"], ["mapToToolCall"]}]
       39 DUPCLOSURE                       R4 K31 [PROTO_7]
       40 CAPTURE                          UPVAL U4
       41 SETTABLEKS                       R4 R3 K27 ["getDescription"]
       43 GETUPVAL                         R5 5
       44 GETTABLEKS                       R5 R5 K32 ["FFlagAssistantAskInputTool"]
       46 JUMPIFNOT                        R5 ; [+4]
       47 DUPCLOSURE                       R4 K33 [PROTO_10]
       48 CAPTURE                          UPVAL U3
       49 CAPTURE                          UPVAL U6
       50 JUMP                             ; [+1]
       51 LOADNIL                          R4
       52 SETTABLEKS                       R4 R3 K28 ["runToolChain"]
       54 GETUPVAL                         R5 5
       55 GETTABLEKS                       R5 R5 K32 ["FFlagAssistantAskInputTool"]
       57 JUMPIFNOT                        R5 ; [+2]
       58 LOADNIL                          R4
       59 JUMP                             ; [+3]
       60 DUPCLOSURE                       R4 K34 [PROTO_12]
       61 CAPTURE                          UPVAL U3
       62 CAPTURE                          UPVAL U6
       63 SETTABLEKS                       R4 R3 K29 ["mapToToolCall"]
       65 DUPTABLE                         R4 K37 [{"definition", "slashCommands"}]
       66 SETTABLEKS                       R2 R4 K35 ["definition"]
       68 NEWTABLE                         R5 0 1
       70 MOVE                             R6 R3
       71 SETLIST                          R5 R6 1 [1]
       73 SETTABLEKS                       R5 R4 K36 ["slashCommands"]
       75 RETURN                           R4 1
...
MAIN:
       ...
       57 GETTABLEKS                       R8 R8 K22 ["CreatorStore"]
       59 GETIMPORT                        R9 K9 [require]
       61 GETTABLEKS                       R10 R8 K23 ["CreatorStoreSearchCache"]
       63 CALL                             R9 1 1
       64 GETIMPORT                        R10 K9 [require]
       66 GETTABLEKS                       R11 R8 K24 ["CreatorStoreTypes"]
       68 CALL                             R10 1 1
       69 GETTABLEKS                       R11 R4 K17 ["Util"]
       71 GETTABLEKS                       R11 R11 K25 ["ToolBuilder"]
       73 GETTABLEKS                       R12 R4 K17 ["Util"]
       75 GETTABLEKS                       R12 R12 K26 ["ToolResult"]
       77 GETTABLEKS                       R13 R5 K27 ["ToolNames"]
       79 DUPCLOSURE                       R14 K28 [PROTO_0]
       80 CAPTURE                          VAL R1
       81 DUPCLOSURE                       R15 K29 [PROTO_1]
       82 DUPCLOSURE                       R16 K30 [PROTO_3]
       ...
       87 CAPTURE                          VAL R16
       88 CAPTURE                          VAL R6
       89 DUPCLOSURE                       R18 K32 [PROTO_5]
       90 DUPCLOSURE                       R19 K33 [PROTO_13]
       91 CAPTURE                          VAL R17
       92 CAPTURE                          VAL R12
       93 CAPTURE                          VAL R11
       94 CAPTURE                          VAL R13
