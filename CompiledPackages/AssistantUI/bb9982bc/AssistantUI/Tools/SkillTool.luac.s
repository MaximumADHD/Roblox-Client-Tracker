...
PROTO_1:
        ...
        9 FORGPREP                         R2
       10 LOADK                            R7 K1 ["\n    <source>%*</source>"]
       11 GETTABLEKS                       R10 R6 K2 ["source"]
       13 GETUPVAL                         R11 1
       14 GETTABLEKS                       R11 R11 K3 ["User"]
       16 JUMPIFNOTEQ                      R10 R11 ; [+3]
       18 LOADK                            R9 K4 ["Local"]
       19 JUMP                             ; [+1]
       20 LOADK                            R9 K5 ["Roblox"]
       21 NAMECALL                         R7 R7 K6 ["format"]
       23 CALL                             R7 2 1
       24 LOADK                            R10 K7 ["  <skill>\n    <name>%*</name>%*\n    <description>%*</description>\n  </skill>"]
       25 GETTABLEKS                       R12 R6 K8 ["name"]
       27 MOVE                             R13 R7
       28 GETTABLEKS                       R14 R6 K9 ["description"]
       ...
       43 MOVE                             R3 R1
       44 CALL                             R2 1 0
       45 LOADK                            R3 K15 ["Retrieve detailed knowledge, best practices, or reference material for a specific skill.\nSkills provide domain-specific expertise that helps you produce better, more accurate results.\n\n<available_skills>\n"]
       46 GETIMPORT                        R6 K17 [table.concat]
       48 MOVE                             R7 R1
       49 LOADK                            R8 K18 ["\n"]
       50 CALL                             R6 2 1
       51 MOVE                             R4 R6
...
PROTO_2:
       ...
       15 GETUPVAL                         R5 1
       16 CALL                             R5 0 1
       17 LOADK                            R7 K6 ["Unknown skill: \"%*\". Available skills: %*"]
       18 GETTABLEKS                       R9 R0 K1 ["skill_name"]
       20 GETIMPORT                        R10 K8 [table.concat]
       22 MOVE                             R11 R4
       23 LOADK                            R12 K9 [", "]
       24 CALL                             R10 2 1
       25 NAMECALL                         R7 R7 K10 ["format"]
       27 CALL                             R7 3 1
       28 NAMECALL                         R5 R5 K11 ["addText"]
       30 CALL                             R5 2 1
       31 LOADB                            R7 1
       32 NAMECALL                         R5 R5 K12 ["setError"]
       34 CALL                             R5 2 1
       35 NAMECALL                         R5 R5 K13 ["build"]
       37 CALL                             R5 1 -1
       38 RETURN                           R5 -1
       39 GETTABLEKS                       R4 R3 K14 ["content"]
       41 GETUPVAL                         R5 2
       42 GETTABLEKS                       R5 R5 K15 ["FFlagAssistantSkillToolNameReplace"]
       44 JUMPIFNOT                        R5 ; [+6]
       45 GETUPVAL                         R5 3
       46 GETTABLEKS                       R5 R5 K16 ["replaceTokens"]
       48 MOVE                             R6 R4
       49 CALL                             R5 1 1
       50 MOVE                             R4 R5
       51 GETUPVAL                         R5 1
       ...
       56 CALL                             R5 2 1
       57 DUPTABLE                         R7 K18 [{"skillName"}]
       58 GETTABLEKS                       R8 R0 K1 ["skill_name"]
       60 SETTABLEKS                       R8 R7 K17 ["skillName"]
       62 NAMECALL                         R5 R5 K19 ["setStructuredContent"]
       64 CALL                             R5 2 1
