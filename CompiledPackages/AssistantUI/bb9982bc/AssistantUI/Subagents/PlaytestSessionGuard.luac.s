...
PROTO_7:
       ...
       32 JUMPIF                           R5 ; [+43]
       33 MOVE                             R6 R2
       34 LOADK                            R7 K5 ["Play did not reach a live state within %*s; the experience may be broken."]
       35 GETUPVAL                         R9 3
       36 NAMECALL                         R7 R7 K6 ["format"]
       38 CALL                             R7 2 1
       39 FASTCALL1                        TYPEOF R6 ; [+3]
       40 MOVE                             R9 R6
       41 GETIMPORT                        R8 K8 [typeof]
       43 CALL                             R8 1 1
       44 JUMPIFNOTEQKS                    R8 K9 ["table"] ; [+11]
       46 GETTABLEKS                       R9 R6 K10 ["content"]
       48 FASTCALL1                        TYPEOF R9 ; [+2]
       49 GETIMPORT                        R8 K8 [typeof]
       51 CALL                             R8 1 1
       52 JUMPIFNOTEQKS                    R8 K9 ["table"] ; [+3]
       54 JUMPIFNOTEQKS                    R7 K11 [""] ; [+3]
       56 MOVE                             R2 R6
       57 RETURN                           R2 1
       58 GETTABLEKS                       R9 R6 K10 ["content"]
       60 DUPTABLE                         R10 K14 [{["type"] = "text", ["text"]}]
       61 SETTABLEKS                       R7 R10 K13 ["text"]
       63 FASTCALL2                        TABLE_INSERT R9 R10 ; [+3]
       65 GETIMPORT                        R8 K16 [table.insert]
       67 CALL                             R8 2 0
       68 MOVE                             R2 R6
       69 RETURN                           R2 1
       70 GETUPVAL                         R5 2
       ...
       72 CALL                             R5 1 0
       73 LOADB                            R5 1
       74 SETTABLEKS                       R5 R3 K4 ["intentionalStop"]
       76 RETURN                           R2 1
