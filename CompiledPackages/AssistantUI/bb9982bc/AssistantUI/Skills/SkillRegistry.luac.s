PROTO_0:
        ...
        6 LOADB                            R3 0 +1
        7 LOADB                            R3 1
        8 LOADK                            R4 K1 ["Skill \"%*\" has unknown source \"%*\"."]
        9 GETTABLEKS                       R6 R0 K2 ["name"]
       11 GETTABLEKS                       R7 R0 K0 ["source"]
       13 NAMECALL                         R4 R4 K3 ["format"]
       15 CALL                             R4 3 1
       16 FASTCALL2                        ASSERT R3 R4 ; [+3]
       18 GETIMPORT                        R2 K5 [assert]
       20 CALL                             R2 2 0
       21 GETTABLEKS                       R2 R0 K2 ["name"]
       23 SETTABLE                         R0 R1 R2
       24 GETUPVAL                         R2 1
       25 GETTABLEKS                       R2 R2 K6 ["Changed"]
...
PROTO_2:
        ...
        4 LOADB                            R4 0 +1
        5 LOADB                            R4 1
        6 LOADK                            R5 K0 ["Skill \"%*\" has unknown source \"%*\"."]
        7 MOVE                             R7 R1
        8 MOVE                             R8 R0
        9 NAMECALL                         R5 R5 K1 ["format"]
       11 CALL                             R5 3 1
       12 FASTCALL2                        ASSERT R4 R5 ; [+3]
...
PROTO_9:
       ...
       18 GETIMPORT                        R2 K5 [assert]
       20 CALL                             R2 2 0
       21 GETTABLEKS                       R3 R0 K2 ["name"]
       23 GETTABLE                         R2 R1 R3
       24 JUMPIFNOT                        R2 ; [+8]
       25 GETTABLEKS                       R3 R2 K6 ["assetId"]
       27 GETTABLEKS                       R4 R0 K6 ["assetId"]
       29 JUMPIFEQ                         R3 R4 ; [+3]
       31 LOADB                            R3 0
       32 RETURN                           R3 1
       33 MOVE                             R3 R1
       ...
       35 LOADNIL                          R5
       36 FORGPREP                         R3
       37 GETTABLEKS                       R8 R7 K6 ["assetId"]
       39 GETTABLEKS                       R9 R0 K6 ["assetId"]
       41 JUMPIFNOTEQ                      R8 R9 ; [+4]
       43 LOADNIL                          R8
       44 SETTABLE                         R8 R1 R6
       45 JUMP                             ; [+2]
       46 FORGLOOP                         R3 2 ; [-10]
       48 GETTABLEKS                       R3 R0 K2 ["name"]
       50 SETTABLE                         R0 R1 R3
       51 GETUPVAL                         R3 1
       52 GETTABLEKS                       R3 R3 K7 ["Changed"]
       54 NAMECALL                         R3 R3 K8 ["Fire"]
       56 CALL                             R3 1 0
       57 LOADB                            R3 1
       58 RETURN                           R3 1
