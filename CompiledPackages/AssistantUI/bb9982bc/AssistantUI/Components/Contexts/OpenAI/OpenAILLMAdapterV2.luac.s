...
PROTO_9:
       ...
       60 JUMPIFNOTEQKS                    R16 K13 ["tool_result"] ; [+73]
       62 MOVE                             R16 R10
       63 CALL                             R16 0 0
       64 NEWTABLE                         R16 0 0
       ...
       73 JUMPIFNOTEQKS                    R22 K14 ["image"] ; [+19]
       75 DUPTABLE                         R24 K19 [{["type"] = "input_image", ["detail"] = "auto", ["image_url"]}]
       76 LOADK                            R25 K20 ["data:%*;base64,%*"]
       77 GETTABLEKS                       R27 R21 K21 ["mimeType"]
       79 GETTABLEKS                       R28 R21 K22 ["data"]
       81 NAMECALL                         R25 R25 K23 ["format"]
       83 CALL                             R25 3 1
       84 SETTABLEKS                       R25 R24 K18 ["image_url"]
       86 FASTCALL2                        TABLE_INSERT R16 R24 ; [+4]
       88 MOVE                             R23 R16
       89 GETIMPORT                        R22 K12 [table.insert]
       91 CALL                             R22 2 0
       92 JUMP                             ; [+11]
       93 DUPTABLE                         R24 K26 [{["type"] = "input_text", ["text"]}]
       94 GETTABLEKS                       R25 R21 K25 ["text"]
       96 SETTABLEKS                       R25 R24 K25 ["text"]
       98 FASTCALL2                        TABLE_INSERT R16 R24 ; [+4]
      100 MOVE                             R23 R16
      101 GETIMPORT                        R22 K12 [table.insert]
      103 CALL                             R22 2 0
      104 FORGLOOP                         R17 2 ; [-34]
      106 LENGTH                           R18 R16
      107 JUMPIFNOTEQKN                    R18 K27 [1] ; [+10]
      109 GETTABLEN                        R18 R16 1
      110 GETTABLEKS                       R18 R18 K2 ["type"]
      112 JUMPIFNOTEQKS                    R18 K24 ["input_text"] ; [+5]
      114 GETTABLEN                        R17 R16 1
      115 GETTABLEKS                       R17 R17 K25 ["text"]
      117 JUMP                             ; [+1]
      118 MOVE                             R17 R16
      119 DUPTABLE                         R18 K31 [{["type"] = "function_call_output", ["call_id"], ["output"]}]
      120 GETTABLEKS                       R19 R15 K32 ["id"]
      122 SETTABLEKS                       R19 R18 K29 ["call_id"]
      124 SETTABLEKS                       R17 R18 K30 ["output"]
      126 FASTCALL2                        TABLE_INSERT R3 R18 ; [+5]
      128 MOVE                             R20 R3
      129 MOVE                             R21 R18
      130 GETIMPORT                        R19 K12 [table.insert]
      132 CALL                             R19 2 0
      133 JUMP                             ; [+93]
      134 GETTABLEKS                       R16 R15 K2 ["type"]
      136 JUMPIFNOTEQKS                    R16 K25 ["text"] ; [+32]
      138 GETTABLEKS                       R16 R15 K25 ["text"]
      140 JUMPIFNOT                        R16 ; [+28]
      141 LENGTH                           R17 R9
      142 GETTABLE                         R16 R9 R17
      143 JUMPIFNOT                        R16 ; [+13]
      144 GETTABLEKS                       R17 R16 K2 ["type"]
      146 JUMPIFNOTEQKS                    R17 K24 ["input_text"] ; [+10]
      148 GETTABLEKS                       R18 R16 K25 ["text"]
      150 LOADK                            R19 K33 ["\n"]
      151 GETTABLEKS                       R20 R15 K25 ["text"]
      153 CONCAT                           R17 R18 R20
      154 SETTABLEKS                       R17 R16 K25 ["text"]
      156 JUMP                             ; [+70]
      157 DUPTABLE                         R19 K26 [{["type"] = "input_text", ["text"]}]
      158 GETTABLEKS                       R20 R15 K25 ["text"]
      160 SETTABLEKS                       R20 R19 K25 ["text"]
      162 FASTCALL2                        TABLE_INSERT R9 R19 ; [+4]
      164 MOVE                             R18 R9
      165 GETIMPORT                        R17 K12 [table.insert]
      167 CALL                             R17 2 0
      168 JUMP                             ; [+58]
      169 GETTABLEKS                       R16 R15 K2 ["type"]
      171 JUMPIFNOTEQKS                    R16 K14 ["image"] ; [+19]
      173 DUPTABLE                         R18 K19 [{["type"] = "input_image", ["detail"] = "auto", ["image_url"]}]
      174 LOADK                            R19 K20 ["data:%*;base64,%*"]
      175 GETTABLEKS                       R21 R15 K21 ["mimeType"]
      177 GETTABLEKS                       R22 R15 K22 ["data"]
      179 NAMECALL                         R19 R19 K23 ["format"]
      181 CALL                             R19 3 1
      182 SETTABLEKS                       R19 R18 K18 ["image_url"]
      184 FASTCALL2                        TABLE_INSERT R9 R18 ; [+4]
      186 MOVE                             R17 R9
      187 GETIMPORT                        R16 K12 [table.insert]
      189 CALL                             R16 2 0
      190 JUMP                             ; [+36]
      191 GETTABLEKS                       R16 R15 K2 ["type"]
      193 JUMPIFNOTEQKS                    R16 K34 ["tool_use"] ; [+33]
      195 MOVE                             R16 R10
      196 CALL                             R16 0 0
      197 LOADK                            R16 K5 [""]
      198 GETTABLEKS                       R17 R15 K35 ["input"]
      200 JUMPIFNOT                        R17 ; [+9]
      201 GETUPVAL                         R17 0
      202 GETTABLEKS                       R17 R17 K36 ["Json"]
      204 GETTABLEKS                       R17 R17 K37 ["encode"]
      206 GETTABLEKS                       R18 R15 K35 ["input"]
      208 CALL                             R17 1 1
      209 MOVE                             R16 R17
      210 DUPTABLE                         R19 K41 [{["type"] = "function_call", ["call_id"], ["name"], ["arguments"]}]
      211 GETTABLEKS                       R20 R15 K32 ["id"]
      213 SETTABLEKS                       R20 R19 K29 ["call_id"]
      215 GETTABLEKS                       R20 R15 K39 ["name"]
      217 SETTABLEKS                       R20 R19 K39 ["name"]
      219 SETTABLEKS                       R16 R19 K40 ["arguments"]
      221 FASTCALL2                        TABLE_INSERT R3 R19 ; [+4]
      223 MOVE                             R18 R3
      224 GETIMPORT                        R17 K12 [table.insert]
      226 CALL                             R17 2 0
      227 FORGLOOP                         R11 2 ; [-207]
      229 MOVE                             R11 R10
      230 CALL                             R11 0 0
      231 FORGLOOP                         R4 2 ; [-225]
      233 RETURN                           R3 1
