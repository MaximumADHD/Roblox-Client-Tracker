...
PROTO_3:
        ...
        6 LOADK                            R2 K3 ["--- TestLLMRequest event: %* %* %*"]
...
PROTO_4:
       ...
       18 LOADK                            R2 K5 ["--- TestLLMRequest error: %* (%*)"]
...
PROTO_5:
        ...
        3 JUMPIFNOT                        R1 ; [+8]
        4 GETIMPORT                        R1 K2 [print]
        6 LOADK                            R2 K3 ["--- TestLLMRequest comment: %*"]
        7 MOVE                             R4 R0
...
PROTO_6:
       ...
       20 JUMPIFNOT                        R2 ; [+24]
       21 GETUPVAL                         R3 0
       22 GETTABLEKS                       R3 R3 K10 ["FFlagDebugLogAssistantUI"]
       24 JUMPIFNOT                        R3 ; [+9]
       25 GETIMPORT                        R3 K2 [warn]
       27 LOADK                            R4 K11 ["TestLLMRequest failed: model=%*, statusCode=%*"]
       28 GETUPVAL                         R6 1
       29 MOVE                             R7 R0
       30 NAMECALL                         R4 R4 K4 ["format"]
       32 CALL                             R4 3 1
       33 CALL                             R3 1 0
       34 GETUPVAL                         R3 2
       35 DUPTABLE                         R4 K14 [{["type"] = "error", ["error"]}]
       36 SETTABLEKS                       R2 R4 K13 ["error"]
       38 CALL                             R3 1 0
       39 GETUPVAL                         R3 3
       40 JUMPIFNOT                        R3 ; [+4]
       41 GETUPVAL                         R3 3
       42 NAMECALL                         R3 R3 K15 ["Close"]
       44 CALL                             R3 1 0
       45 RETURN                           R0 0
...
PROTO_8:
      ...
      107 JUMPIFNOT                        R12 ; [+14]
      108 GETIMPORT                        R12 K44 [print]
      110 LOADK                            R13 K45 ["--- TestLLMRequest requestBody: %*"]
      111 GETUPVAL                         R15 4
      112 GETTABLEKS                       R15 R15 K46 ["Json"]
      114 GETTABLEKS                       R15 R15 K47 ["encode"]
      116 MOVE                             R16 R11
      117 CALL                             R15 1 1
      118 NAMECALL                         R13 R13 K48 ["format"]
      120 CALL                             R13 2 1
      121 CALL                             R12 1 0
      122 GETTABLEKS                       R13 R0 K49 ["apiKeys"]
      124 JUMPIFNOT                        R13 ; [+14]
      125 GETTABLEKS                       R14 R0 K49 ["apiKeys"]
      127 GETUPVAL                         R15 5
      128 GETTABLEKS                       R15 R15 K50 ["OPENAI_API_KEY"]
      130 GETTABLE                         R13 R14 R15
      131 JUMPIFNOT                        R13 ; [+7]
      132 GETTABLEKS                       R13 R0 K49 ["apiKeys"]
      134 GETUPVAL                         R14 5
      135 GETTABLEKS                       R14 R14 K50 ["OPENAI_API_KEY"]
      137 GETTABLE                         R12 R13 R14
      138 JUMP                             ; [+3]
      139 GETUPVAL                         R12 0
      140 GETTABLEKS                       R12 R12 K51 ["FStringMCPAssistantTestLLMAPIKey"]
      142 LOADNIL                          R13
      143 NEWTABLE                         R14 1 0
      145 LOADK                            R15 K52 ["application/json"]
      146 SETTABLEKS                       R15 R14 K53 ["content-type"]
      148 MOVE                             R13 R14
      149 JUMPIFEQKS                       R12 K16 [""] ; [+8]
      151 LOADK                            R14 K54 ["Bearer %*"]
      152 MOVE                             R16 R12
      153 NAMECALL                         R14 R14 K48 ["format"]
      155 CALL                             R14 2 1
      156 SETTABLEKS                       R14 R13 K55 ["authorization"]
      158 GETUPVAL                         R14 0
      159 GETTABLEKS                       R14 R14 K42 ["FFlagDebugLogAssistantUI"]
      161 JUMPIFNOT                        R14 ; [+8]
      162 GETIMPORT                        R14 K44 [print]
      164 LOADK                            R15 K56 ["--- TestLLMRequest sending request to: %*"]
      165 MOVE                             R17 R8
      166 NAMECALL                         R15 R15 K48 ["format"]
      168 CALL                             R15 2 1
      169 CALL                             R14 1 0
      170 GETUPVAL                         R14 4
      171 GETTABLEKS                       R14 R14 K46 ["Json"]
      173 GETTABLEKS                       R14 R14 K47 ["encode"]
      175 MOVE                             R15 R11
      176 CALL                             R14 1 1
      177 GETUPVAL                         R15 6
      178 GETTABLEKS                       R15 R15 K57 ["get"]
      180 CALL                             R15 0 1
      181 GETTABLEKS                       R16 R15 K58 ["http"]
      183 GETTABLEKS                       R16 R16 K59 ["createWebStreamClient"]
      185 GETIMPORT                        R17 K63 [Enum.WebStreamClientType.RawStream]
      187 DUPTABLE                         R18 K69 [{["Method"] = "POST", ["Url"], ["Headers"], ["Body"]}]
      188 SETTABLEKS                       R8 R18 K66 ["Url"]
      190 SETTABLEKS                       R13 R18 K67 ["Headers"]
      192 SETTABLEKS                       R14 R18 K68 ["Body"]
      194 CALL                             R16 2 1
      195 FASTCALL2K                       ASSERT R16 K70 ; [+5]
      197 MOVE                             R18 R16
      198 LOADK                            R19 K70 ["WebStreamClient should not be nil"]
      199 GETIMPORT                        R17 K72 [assert]
      201 CALL                             R17 2 0
      202 GETUPVAL                         R17 7
      203 GETTABLEKS                       R17 R17 K73 ["createParser"]
      205 DUPTABLE                         R18 K77 [{"onEvent", "onError", "onComment"}]
      206 NEWCLOSURE                       R19 P0
      207 CAPTURE                          UPVAL U0
      208 CAPTURE                          UPVAL U4
      209 CAPTURE                          UPVAL U8
      210 CAPTURE                          VAL R1
      211 SETTABLEKS                       R19 R18 K74 ["onEvent"]
      213 DUPCLOSURE                       R19 K78 [PROTO_4]
      214 CAPTURE                          UPVAL U0
      215 SETTABLEKS                       R19 R18 K75 ["onError"]
      217 DUPCLOSURE                       R19 K79 [PROTO_5]
      218 CAPTURE                          UPVAL U0
      219 SETTABLEKS                       R19 R18 K76 ["onComment"]
      221 CALL                             R17 1 1
      222 GETTABLEKS                       R18 R16 K80 ["MessageReceived"]
      224 GETTABLEKS                       R20 R17 K81 ["parseNextChunk"]
      226 NAMECALL                         R18 R18 K82 ["Connect"]
      228 CALL                             R18 2 1
      229 GETTABLEKS                       R19 R16 K83 ["Opened"]
      231 NEWCLOSURE                       R21 P3
      232 CAPTURE                          UPVAL U0
      233 CAPTURE                          REF R6
      234 CAPTURE                          VAL R1
      235 CAPTURE                          REF R16
      236 NAMECALL                         R19 R19 K82 ["Connect"]
      238 CALL                             R19 2 1
      239 GETTABLEKS                       R20 R16 K84 ["Closed"]
      241 NEWCLOSURE                       R22 P4
      242 CAPTURE                          UPVAL U0
      243 CAPTURE                          REF R18
      244 CAPTURE                          REF R19
      245 CAPTURE                          REF R16
      246 NAMECALL                         R20 R20 K85 ["Once"]
      248 CALL                             R20 2 0
      249 CLOSEUPVALS                      R6
      250 RETURN                           R0 0
