...
PROTO_12:
       ...
       16 RETURN                           R0 0
       17 GETUPVAL                         R2 3
       18 GETTABLEKS                       R2 R2 K5 ["FFlagDebugLogAssistantUI"]
       20 JUMPIFNOT                        R2 ; [+4]
       21 GETIMPORT                        R2 K7 [warn]
       23 LOADK                            R3 K8 ["Client not found, this should not happen, should always enabled the client before login"]
       24 CALL                             R2 1 0
       25 RETURN                           R0 0
...
PROTO_15:
        ...
        6 JUMPIF                           R1 ; [+9]
        7 GETUPVAL                         R1 1
        8 GETTABLEKS                       R1 R1 K2 ["FFlagDebugLogAssistantUI"]
       10 JUMPIFNOT                        R1 ; [+4]
       11 GETIMPORT                        R1 K4 [warn]
       13 LOADK                            R2 K5 ["should enable the client before login"]
       14 CALL                             R1 1 0
       15 RETURN                           R0 0
       16 GETUPVAL                         R1 2
       17 GETTABLEKS                       R1 R1 K6 ["authorizerManager"]
       19 GETUPVAL                         R3 0
       20 GETTABLEKS                       R3 R3 K0 ["label"]
       22 GETUPVAL                         R4 0
       23 GETTABLEKS                       R4 R4 K7 ["url"]
       25 NAMECALL                         R1 R1 K8 ["getOrCreateAuthorizer"]
       27 CALL                             R1 3 0
       28 GETUPVAL                         R1 2
       29 GETTABLEKS                       R1 R1 K6 ["authorizerManager"]
       31 GETUPVAL                         R3 0
       32 GETTABLEKS                       R3 R3 K0 ["label"]
       34 NAMECALL                         R1 R1 K9 ["startAuthorization"]
       36 CALL                             R1 2 1
       37 NEWCLOSURE                       R3 P0
       38 CAPTURE                          UPVAL U3
       39 CAPTURE                          UPVAL U4
       40 NAMECALL                         R1 R1 K10 ["andThen"]
       42 CALL                             R1 2 0
       43 RETURN                           R0 0
...
MAIN:
       ...
       79 GETTABLEKS                       R10 R0 K17 ["Flags"]
       81 CALL                             R9 1 1
       82 GETIMPORT                        R10 K5 [require]
       84 GETTABLEKS                       R11 R0 K6 ["Parent"]
       86 GETTABLEKS                       R11 R11 K18 ["Foundation"]
       88 CALL                             R10 1 1
       89 GETIMPORT                        R11 K5 [require]
       91 GETTABLEKS                       R12 R0 K6 ["Parent"]
       93 GETTABLEKS                       R12 R12 K19 ["ModelContextProtocol"]
       95 CALL                             R11 1 1
       96 GETIMPORT                        R12 K5 [require]
       98 GETTABLEKS                       R13 R0 K6 ["Parent"]
      100 GETTABLEKS                       R13 R13 K20 ["React"]
      102 CALL                             R12 1 1
      103 GETIMPORT                        R13 K5 [require]
      105 GETTABLEKS                       R14 R0 K6 ["Parent"]
      107 GETTABLEKS                       R14 R14 K21 ["ReactUtils"]
      109 CALL                             R13 1 1
      110 GETIMPORT                        R14 K5 [require]
      112 GETTABLEKS                       R15 R0 K11 ["Components"]
      114 GETTABLEKS                       R15 R15 K22 ["ShimmerGradient"]
      116 CALL                             R14 1 1
      117 GETIMPORT                        R15 K5 [require]
      119 GETTABLEKS                       R16 R0 K23 ["Util"]
      121 GETTABLEKS                       R16 R16 K24 ["TestIds"]
      123 CALL                             R15 1 1
      124 GETIMPORT                        R16 K5 [require]
      126 GETTABLEKS                       R17 R0 K25 ["Types"]
      128 CALL                             R16 1 1
      129 GETIMPORT                        R17 K5 [require]
      131 GETTABLEKS                       R18 R0 K26 ["Hooks"]
      133 GETTABLEKS                       R18 R18 K27 ["useEventConnection"]
      135 CALL                             R17 1 1
      136 GETIMPORT                        R18 K5 [require]
      138 GETTABLEKS                       R19 R0 K26 ["Hooks"]
      140 GETTABLEKS                       R19 R19 K28 ["useWithClient"]
      142 CALL                             R18 1 1
      143 GETTABLEKS                       R19 R10 K29 ["View"]
      145 GETTABLEKS                       R20 R10 K30 ["Text"]
      147 GETTABLEKS                       R21 R10 K31 ["Divider"]
      149 GETTABLEKS                       R22 R10 K32 ["Chip"]
      151 GETTABLEKS                       R23 R13 K33 ["createNextOrder"]
      153 GETTABLEKS                       R24 R12 K34 ["createElement"]
      155 GETTABLEKS                       R25 R11 K35 ["ClientConnectionStatus"]
      157 DUPCLOSURE                       R26 K36 [PROTO_0]
      158 DUPCLOSURE                       R27 K37 [PROTO_5]
      159 CAPTURE                          VAL R12
      160 CAPTURE                          VAL R17
      161 CAPTURE                          VAL R24
      162 CAPTURE                          VAL R19
      ...
      164 CAPTURE                          VAL R22
      165 CAPTURE                          VAL R10
      166 DUPCLOSURE                       R28 K38 [PROTO_23]
      167 CAPTURE                          VAL R23
      168 CAPTURE                          VAL R18
      169 CAPTURE                          VAL R6
      170 CAPTURE                          VAL R7
      ...
      183 CAPTURE                          VAL R14
      184 CAPTURE                          VAL R21
      185 GETTABLEKS                       R29 R12 K39 ["memo"]
      187 MOVE                             R30 R28
      188 CALL                             R29 1 -1
      189 RETURN                           R29 -1
