...
PROTO_1:
       ...
       39 LOADK                            R4 K13 ["Skill save rejected: %*"]
       40 MOVE                             R6 R2
       41 NAMECALL                         R4 R4 K14 ["format"]
       43 CALL                             R4 2 1
       44 CALL                             R3 1 0
       45 RETURN                           R0 0
       46 GETUPVAL                         R3 0
       47 GETUPVAL                         R4 4
       48 GETTABLEKS                       R4 R4 K8 ["frontmatter"]
       50 GETTABLEKS                       R4 R4 K1 ["name"]
       52 SETTABLEKS                       R4 R3 K0 ["current"]
       54 GETUPVAL                         R3 5
       55 GETTABLEKS                       R3 R3 K0 ["current"]
       57 JUMPIFNOT                        R3 ; [+4]
       58 LOADB                            R6 1
       59 NAMECALL                         R4 R3 K15 ["setIsActionDisabled"]
       61 CALL                             R4 2 0
       62 RETURN                           R0 0
...
PROTO_2:
       ...
       14 LOADK                            R4 K4 ["Skill save rejected: %*"]
       15 MOVE                             R6 R2
       16 NAMECALL                         R4 R4 K5 ["format"]
       18 CALL                             R4 2 1
       19 CALL                             R3 1 0
       20 RETURN                           R0 0
       21 GETIMPORT                        R3 K8 [task.spawn]
       23 NEWCLOSURE                       R4 P0
       24 CAPTURE                          UPVAL U2
       25 CAPTURE                          UPVAL U3
       26 CAPTURE                          UPVAL U4
