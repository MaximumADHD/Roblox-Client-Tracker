...
PROTO_12:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R2 R2 K0 ["FFlagAssistantRevertPerThreadInputState"]
        3 JUMPIFNOT                        R2 ; [+2]
        4 LOADNIL                          R1
        5 RETURN                           R1 1
        6 GETTABLEKS                       R1 R0 K1 ["_threadId"]
        8 RETURN                           R1 1

PROTO_13:
        0 GETTABLEKS                       R1 R0 K0 ["_clearInputDisabled"]
        2 JUMPIFNOT                        R1 ; [+8]
        3 LOADNIL                          R2
        4 SETTABLEKS                       R2 R0 K0 ["_clearInputDisabled"]
        6 MOVE                             R2 R1
        7 NAMECALL                         R3 R0 K1 ["_ownerInputThreadId"]
        9 CALL                             R3 1 -1
       10 CALL                             R2 -1 0
       11 RETURN                           R0 0
...
PROTO_14:
       ...
       18 LOADB                            R4 1
       19 JUMPIFNOT                        R4 ; [+4]
       20 NAMECALL                         R5 R0 K7 ["_flushPendingInputClear"]
       22 CALL                             R5 1 0
       23 RETURN                           R0 0
       24 LOADB                            R5 1
       25 JUMPIFEQKS                       R3 K8 ["user_message"] ; [+10]
       27 LOADB                            R5 0
       28 JUMPIFNOTEQKS                    R3 K4 ["state_update"] ; [+7]
       30 GETTABLEKS                       R6 R1 K5 ["state"]
       32 JUMPIFEQKS                       R6 K9 ["running"] ; [+2]
       34 LOADB                            R5 0 +1
       35 LOADB                            R5 1
       36 JUMPIF                           R5 ; [+1]
       37 RETURN                           R0 0
       38 GETUPVAL                         R6 0
       39 GETTABLEKS                       R6 R6 K10 ["FFlagAssistantRevertPerThreadInputState"]
       41 JUMPIF                           R6 ; [+4]
       42 GETTABLEKS                       R6 R0 K11 ["_historyReplayActive"]
       44 JUMPIFNOT                        R6 ; [+1]
       45 RETURN                           R0 0
       46 GETTABLEKS                       R6 R0 K12 ["_localTurnOwnsInput"]
       48 JUMPIF                           R6 ; [+3]
       49 GETTABLEKS                       R6 R0 K13 ["_clearInputDisabled"]
       51 JUMPIFNOT                        R6 ; [+1]
       52 RETURN                           R0 0
       53 GETTABLEKS                       R6 R0 K14 ["_threadId"]
       55 GETTABLEKS                       R7 R2 K15 ["threadId"]
       57 JUMPIFEQ                         R6 R7 ; [+2]
       59 RETURN                           R0 0
       60 GETTABLEKS                       R6 R2 K16 ["clearInputDisabled"]
       62 SETTABLEKS                       R6 R0 K13 ["_clearInputDisabled"]
       64 GETTABLEKS                       R6 R2 K17 ["markInputDisabled"]
       66 GETUPVAL                         R7 1
       67 GETTABLEKS                       R7 R7 K18 ["Generation"]
       69 NAMECALL                         R8 R0 K19 ["_ownerInputThreadId"]
       71 CALL                             R8 1 -1
       72 CALL                             R6 -1 0
       73 RETURN                           R0 0
...
PROTO_27:
        0 GETTABLEKS                       R3 R0 K0 ["_writeGate"]
        2 GETTABLEKS                       R3 R3 K1 ["destroyed"]
        4 JUMPIFNOT                        R3 ; [+1]
        5 RETURN                           R0 0
        6 MOVE                             R5 R2
        7 NAMECALL                         R3 R0 K2 ["beginHistoryReplay"]
        9 CALL                             R3 2 0
       10 MOVE                             R3 R1
       11 LOADNIL                          R4
       12 LOADNIL                          R5
       13 FORGPREP                         R3
       14 MOVE                             R10 R7
       15 NAMECALL                         R8 R0 K3 ["handleUpdate"]
       17 CALL                             R8 2 0
       18 FORGLOOP                         R3 2 ; [-5]
       20 NAMECALL                         R3 R0 K4 ["endHistoryReplay"]
       22 CALL                             R3 1 0
       23 RETURN                           R0 0
...
PROTO_30:
       ...
       46 CALL                             R1 1 0
       47 NAMECALL                         R1 R0 K11 ["_flushPendingInputClear"]
       49 CALL                             R1 1 0
       50 GETTABLEKS                       R1 R0 K5 ["_relay"]
       52 NAMECALL                         R1 R1 K12 ["resetRenderedState"]
       54 CALL                             R1 1 0
       55 RETURN                           R0 0
...
PROTO_33:
       ...
       19 CALL                             R2 1 0
       20 GETUPVAL                         R2 0
       21 GETTABLEKS                       R2 R2 K7 ["FFlagAssistantRevertPerThreadInputState"]
       23 JUMPIF                           R2 ; [+3]
       24 NAMECALL                         R2 R1 K8 ["_flushPendingInputClear"]
       26 CALL                             R2 1 0
       27 GETTABLEKS                       R2 R0 K9 ["_monitors"]
       29 GETTABLEKS                       R3 R1 K10 ["_threadId"]
       31 LOADNIL                          R4
...
MAIN:
       ...
       84 CAPTURE                          VAL R2
       85 SETTABLEKS                       R12 R10 K29 ["_ownerInputThreadId"]
       87 DUPCLOSURE                       R12 K30 [PROTO_13]
       88 SETTABLEKS                       R12 R10 K31 ["_flushPendingInputClear"]
       90 DUPCLOSURE                       R12 K32 [PROTO_14]
       91 CAPTURE                          VAL R2
       92 CAPTURE                          VAL R8
       93 SETTABLEKS                       R12 R10 K33 ["_trackInputStateForTurn"]
       95 DUPCLOSURE                       R12 K34 [PROTO_16]
       96 SETTABLEKS                       R12 R10 K35 ["attachSession"]
       98 DUPCLOSURE                       R12 K36 [PROTO_17]
       99 SETTABLEKS                       R12 R10 K37 ["beginTurn"]
      101 DUPCLOSURE                       R12 K38 [PROTO_18]
      102 SETTABLEKS                       R12 R10 K39 ["endTurn"]
      104 DUPCLOSURE                       R12 K40 [PROTO_19]
      105 SETTABLEKS                       R12 R10 K41 ["getOrCreateAssistantMessage"]
      107 DUPCLOSURE                       R12 K42 [PROTO_22]
      108 SETTABLEKS                       R12 R10 K43 ["observeUpdates"]
      110 DUPCLOSURE                       R12 K44 [PROTO_23]
      111 SETTABLEKS                       R12 R10 K45 ["resetRenderedState"]
      113 DUPCLOSURE                       R12 K46 [PROTO_24]
      114 SETTABLEKS                       R12 R10 K47 ["getRelay"]
      116 DUPCLOSURE                       R12 K48 [PROTO_25]
      117 SETTABLEKS                       R12 R10 K49 ["beginHistoryReplay"]
      119 DUPCLOSURE                       R12 K50 [PROTO_26]
      120 SETTABLEKS                       R12 R10 K51 ["endHistoryReplay"]
      122 DUPCLOSURE                       R12 K52 [PROTO_27]
      123 SETTABLEKS                       R12 R10 K53 ["replayHistoryPage"]
      125 DUPCLOSURE                       R12 K54 [PROTO_28]
      126 SETTABLEKS                       R12 R10 K55 ["handleUpdate"]
      128 DUPCLOSURE                       R12 K56 [PROTO_29]
      129 SETTABLEKS                       R12 R10 K57 ["setPinned"]
      131 DUPCLOSURE                       R12 K58 [PROTO_30]
      132 CAPTURE                          VAL R2
      133 SETTABLEKS                       R12 R10 K59 ["destroy"]
      135 DUPCLOSURE                       R12 K60 [PROTO_31]
      136 CAPTURE                          VAL R9
      137 SETTABLEKS                       R12 R9 K21 ["new"]
      139 DUPCLOSURE                       R12 K61 [PROTO_32]
      140 CAPTURE                          VAL R10
      141 SETTABLEKS                       R12 R9 K62 ["getSessionMonitor"]
      143 DUPCLOSURE                       R12 K63 [PROTO_33]
      144 CAPTURE                          VAL R2
      145 SETTABLEKS                       R12 R9 K64 ["_releaseMonitor"]
      147 DUPCLOSURE                       R12 K65 [PROTO_34]
      148 SETTABLEKS                       R12 R9 K66 ["syncPinnedThread"]
      150 DUPCLOSURE                       R12 K67 [PROTO_35]
      151 SETTABLEKS                       R12 R9 K59 ["destroy"]
      153 DUPTABLE                         R12 K70 [{"AcpSessionMonitor", "AcpSessionMonitorFactory"}]
      154 SETTABLEKS                       R10 R12 K68 ["AcpSessionMonitor"]
      156 SETTABLEKS                       R9 R12 K69 ["AcpSessionMonitorFactory"]
      158 RETURN                           R12 1
