...
PROTO_13:
       ...
       12 ADDK                             R5 R5 K4 [1]
       13 SETUPVAL                         R5 1
       14 LOADK                            R5 K5 ["Insert AI Generated MeshPart %*"]
       15 GETUPVAL                         R7 1
       16 NAMECALL                         R5 R5 K6 ["format"]
       18 CALL                             R5 2 1
       19 GETTABLEKS                       R6 R3 K7 ["startRecording"]
       21 MOVE                             R7 R2
       22 MOVE                             R8 R5
       23 CALL                             R6 2 0
       24 GETIMPORT                        R6 K9 [pcall]
       26 NEWCLOSURE                       R7 P0
       27 CAPTURE                          VAL R4
       28 CAPTURE                          UPVAL U2
       29 CAPTURE                          VAL R2
       ...
       34 CAPTURE                          UPVAL U6
       35 CALL                             R6 1 2
       36 GETTABLEKS                       R8 R3 K10 ["endRecording"]
       38 MOVE                             R9 R2
       39 CALL                             R8 1 0
       40 JUMPIFNOT                        R6 ; [+7]
       41 GETUPVAL                         R10 4
       42 GETTABLEKS                       R10 R10 K11 ["ATTRIBUTE_AI_GENERATION_ID"]
       44 NAMECALL                         R8 R7 K12 ["GetAttribute"]
       46 CALL                             R8 2 1
       47 JUMP                             ; [+1]
       48 LOADNIL                          R8
       49 FASTCALL1                        TYPEOF R8 ; [+3]
       50 MOVE                             R11 R8
       51 GETIMPORT                        R10 K14 [typeof]
       53 CALL                             R10 1 1
       54 JUMPIFNOTEQKS                    R10 K15 ["string"] ; [+3]
       56 MOVE                             R9 R8
       57 JUMP                             ; [+1]
       58 LOADK                            R9 K16 [""]
       59 GETTABLEKS                       R10 R3 K17 ["EventLogger"]
       61 GETTABLEKS                       R10 R10 K18 ["logMeshGenMeshInserted"]
       63 DUPTABLE                         R11 K25 [{"requestId", "generationId", "success", "errorMessage", "modelFlow", "inputFormat"}]
       64 SETTABLEKS                       R2 R11 K19 ["requestId"]
       66 SETTABLEKS                       R9 R11 K20 ["generationId"]
       68 SETTABLEKS                       R6 R11 K21 ["success"]
       70 JUMPIFNOT                        R6 ; [+2]
       71 LOADK                            R12 K16 [""]
       72 JUMP                             ; [+5]
       73 FASTCALL1                        TOSTRING R7 ; [+3]
       74 MOVE                             R13 R7
       75 GETIMPORT                        R12 K27 [tostring]
       77 CALL                             R12 1 1
       78 SETTABLEKS                       R12 R11 K22 ["errorMessage"]
       80 GETUPVAL                         R13 3
       81 GETTABLEKS                       R13 R13 K28 ["FFlagAssistantGen3DTelemetryV2"]
       83 JUMPIFNOT                        R13 ; [+2]
       84 LOADK                            R12 K29 ["mesh"]
       85 JUMP                             ; [+1]
       86 LOADNIL                          R12
       87 SETTABLEKS                       R12 R11 K23 ["modelFlow"]
       89 GETUPVAL                         R13 3
       90 GETTABLEKS                       R13 R13 K28 ["FFlagAssistantGen3DTelemetryV2"]
       92 JUMPIFNOT                        R13 ; [+3]
       93 GETTABLEKS                       R12 R4 K24 ["inputFormat"]
       95 JUMP                             ; [+1]
       96 LOADNIL                          R12
       97 SETTABLEKS                       R12 R11 K24 ["inputFormat"]
       99 CALL                             R10 1 0
      100 JUMPIF                           R6 ; [+5]
      101 GETIMPORT                        R10 K31 [error]
      103 MOVE                             R11 R7
      104 LOADN                            R12 0
      105 CALL                             R10 2 0
      106 GETUPVAL                         R10 3
      107 GETTABLEKS                       R10 R10 K28 ["FFlagAssistantGen3DTelemetryV2"]
      109 JUMPIFNOT                        R10 ; [+19]
      110 JUMPIFEQKS                       R9 K16 [""] ; [+18]
      112 GETIMPORT                        R10 K34 [os.clock]
      114 CALL                             R10 0 1
      115 LOADNIL                          R11
      116 GETTABLEKS                       R12 R7 K35 ["Destroying"]
      ...
      122 CAPTURE                          VAL R9
      123 CAPTURE                          VAL R10
      124 NAMECALL                         R12 R12 K36 ["Connect"]
      126 CALL                             R12 2 1
      127 MOVE                             R11 R12
      128 CLOSEUPVALS                      R11
      129 RETURN                           R0 0
