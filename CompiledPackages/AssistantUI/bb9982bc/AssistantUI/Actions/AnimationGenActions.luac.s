...
PROTO_9:
        0 GETUPVAL                         R3 0
        1 GETTABLEKS                       R4 R0 K0 ["sourceToolUseId"]
        3 GETTABLE                         R2 R3 R4
        4 JUMPIFNOTEQKNIL                  R2 ; [+2]
        6 RETURN                           R0 0
        7 GETUPVAL                         R3 0
        8 GETTABLEKS                       R4 R0 K1 ["editToolUseId"]
       10 DUPTABLE                         R5 K6 [{["rig"], ["keyframeSequence"], ["needsReload"] = True}]
       11 GETTABLEKS                       R6 R2 K2 ["rig"]
       13 SETTABLEKS                       R6 R5 K2 ["rig"]
       15 GETTABLEKS                       R6 R2 K3 ["keyframeSequence"]
       17 SETTABLEKS                       R6 R5 K3 ["keyframeSequence"]
       19 SETTABLE                         R5 R3 R4
       20 GETUPVAL                         R3 1
       21 GETTABLEKS                       R3 R3 K7 ["setAnimation"]
       23 GETUPVAL                         R4 2
       24 GETTABLEKS                       R5 R0 K1 ["editToolUseId"]
       26 MOVE                             R6 R1
       27 CALL                             R4 2 1
       28 CALL                             R3 1 0
       29 RETURN                           R0 0
...
MAIN:
      ...
      158 CAPTURE                          VAL R21
      159 CAPTURE                          VAL R22
      160 DUPCLOSURE                       R29 K37 [PROTO_10]
      161 CAPTURE                          VAL R0
      162 CAPTURE                          VAL R8
      163 DUPCLOSURE                       R30 K38 [PROTO_11]
      164 CAPTURE                          VAL R3
      165 CAPTURE                          VAL R15
      166 CAPTURE                          VAL R16
      167 DUPCLOSURE                       R31 K39 [PROTO_12]
      168 CAPTURE                          VAL R30
      169 CAPTURE                          VAL R0
      170 NEWCLOSURE                       R32 P10
      171 CAPTURE                          VAL R8
      172 CAPTURE                          VAL R17
      173 CAPTURE                          VAL R29
      174 CAPTURE                          VAL R31
      ...
      176 CAPTURE                          VAL R2
      177 CAPTURE                          REF R18
      178 NEWCLOSURE                       R33 P11
      179 CAPTURE                          REF R18
      180 CAPTURE                          VAL R21
      181 CAPTURE                          VAL R19
      182 DUPTABLE                         R34 K47 [{"generateAndSaveAnimationAsync", "getSelectedRigRef", "setIsPlaying", "setCurrentTime", "setPlaybackSpeed", "openInAnimationClipEditor", "beginEditPreview"}]
      183 SETTABLEKS                       R24 R34 K40 ["generateAndSaveAnimationAsync"]
      185 SETTABLEKS                       R23 R34 K41 ["getSelectedRigRef"]
      187 SETTABLEKS                       R25 R34 K42 ["setIsPlaying"]
      189 SETTABLEKS                       R26 R34 K43 ["setCurrentTime"]
      191 SETTABLEKS                       R27 R34 K44 ["setPlaybackSpeed"]
      193 SETTABLEKS                       R32 R34 K45 ["openInAnimationClipEditor"]
      195 SETTABLEKS                       R28 R34 K46 ["beginEditPreview"]
      197 DUPTABLE                         R35 K50 [{"bridge", "destroy"}]
      198 SETTABLEKS                       R34 R35 K48 ["bridge"]
      200 SETTABLEKS                       R33 R35 K49 ["destroy"]
      202 CLOSEUPVALS                      R18
      203 RETURN                           R35 1
