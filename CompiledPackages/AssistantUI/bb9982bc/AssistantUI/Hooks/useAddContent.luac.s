PROTO_0:
       ...
       25 LOADK                            R7 K9 ["Failed at key: %*"]
       26 MOVE                             R9 R5
       27 NAMECALL                         R7 R7 K10 ["format"]
       29 CALL                             R7 2 1
       30 CALL                             R6 1 0
       31 RETURN                           R0 1
       32 LOADNIL                          R6
       ...
       37 GETTABLEKS                       R8 R7 K1 ["messages"]
       39 JUMPIFNOT                        R8 ; [+9]
       40 GETUPVAL                         R10 1
       41 GETTABLE                         R9 R8 R10
       42 GETTABLEKS                       R10 R9 K11 ["contentCountAdded"]
       44 ADDK                             R10 R10 K12 [1]
       45 SETTABLEKS                       R10 R9 K11 ["contentCountAdded"]
       47 GETTABLEKS                       R6 R9 K11 ["contentCountAdded"]
       49 DUPTABLE                         R9 K24 [{["contentId"], ["type"] = , ["createdAt"] = -1, ["updatedAt"] = -1, ["ephemeral"] = , ["isDirty"] = , ["isDeleted"] = , ["lastServerStreamId"], ["LayoutOrder"]}]
       50 GETUPVAL                         R10 3
       51 SETTABLEKS                       R10 R9 K13 ["contentId"]
       53 GETUPVAL                         R10 4
       54 GETTABLEKS                       R10 R10 K25 ["get"]
       56 GETUPVAL                         R11 1
       57 CALL                             R10 1 1
       58 SETTABLEKS                       R10 R9 K22 ["lastServerStreamId"]
       60 SETTABLEKS                       R6 R9 K23 ["LayoutOrder"]
       62 GETUPVAL                         R10 5
       63 GETTABLEKS                       R10 R10 K26 ["assign"]
       65 MOVE                             R11 R9
       66 GETUPVAL                         R12 6
       67 GETTABLEKS                       R12 R12 K27 ["content"]
       69 CALL                             R10 2 1
       70 MOVE                             R9 R10
       71 GETUPVAL                         R10 3
       72 SETTABLE                         R9 R4 R10
       73 GETTABLEKS                       R11 R7 K1 ["messages"]
       75 GETUPVAL                         R12 1
       76 GETTABLE                         R10 R11 R12
       77 GETUPVAL                         R11 7
       78 DUPTABLE                         R12 K30 [{"thread", "sessionId"}]
       79 SETTABLEKS                       R7 R12 K28 ["thread"]
       81 GETUPVAL                         R13 8
       82 SETTABLEKS                       R13 R12 K29 ["sessionId"]
       84 CALL                             R11 1 0
       85 GETUPVAL                         R11 9
       86 NEWTABLE                         R12 0 1
       88 MOVE                             R13 R9
