...
PROTO_4:
        0 DUPTABLE                         R2 K1 [{"editContent"}]
        1 NEWCLOSURE                       R3 P0
        2 CAPTURE                          UPVAL U0
        3 CAPTURE                          VAL R1
        4 CAPTURE                          VAL R0
        5 SETTABLEKS                       R3 R2 K0 ["editContent"]
        7 RETURN                           R2 1
...
PROTO_13:
        0 GETUPVAL                         R2 0
        1 DUPTABLE                         R1 K1 [{"editContent"}]
        2 NEWCLOSURE                       R3 P0
        3 CAPTURE                          UPVAL U1
        4 CAPTURE                          VAL R0
        5 CAPTURE                          VAL R2
        6 SETTABLEKS                       R3 R1 K0 ["editContent"]
        8 RETURN                           R1 1
...
MAIN:
      ...
      106 CALL                             R14 1 1
      107 DUPTABLE                         R15 K36 [{["addMessage"] = , ["addTextContent"] = , ["addToolContent"] = , ["editContent"] = , ["getContentObserver"] = , ["getOrAddMessage"] = , ["getThread"] = , ["sendMessage"] = , ["getContentHooks"] = }]
      108 DUPCLOSURE                       R16 K37 [PROTO_2]
      109 CAPTURE                          VAL R8
      110 CAPTURE                          VAL R15
      111 CAPTURE                          VAL R9
      112 CAPTURE                          VAL R5
      ...
      120 CAPTURE                          VAL R14
      121 CAPTURE                          VAL R7
      122 DUPCLOSURE                       R17 K38 [PROTO_4]
      123 CAPTURE                          VAL R1
      124 DUPCLOSURE                       R18 K39 [PROTO_14]
      125 CAPTURE                          VAL R15
      126 CAPTURE                          VAL R1
      127 DUPTABLE                         R19 K42 [{"use", "get"}]
      128 SETTABLEKS                       R16 R19 K40 ["use"]
      130 SETTABLEKS                       R18 R19 K41 ["get"]
      132 RETURN                           R19 1
