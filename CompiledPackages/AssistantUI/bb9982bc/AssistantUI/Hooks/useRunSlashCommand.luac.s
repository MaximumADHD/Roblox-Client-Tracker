...
PROTO_9:
      ...
      136 LOADK                            R12 K31 ["This is a following tool call from %*"]
      137 MOVE                             R14 R10
      138 NAMECALL                         R12 R12 K32 ["format"]
      140 CALL                             R12 2 1
      141 CALL                             R11 1 1
      142 MOVE                             R9 R11
      143 SETTABLEKS                       R9 R8 K27 ["userPromptText"]
      145 JUMPIFNOT                        R5 ; [+4]
      146 GETUPVAL                         R9 21
      147 GETTABLEKS                       R9 R9 K28 ["images"]
      149 JUMP                             ; [+1]
      150 LOADNIL                          R9
      151 SETTABLEKS                       R9 R8 K28 ["images"]
      153 CALL                             R6 2 1
      154 GETTABLEKS                       R7 R6 K33 ["promise"]
      156 NEWCLOSURE                       R9 P1
      157 CAPTURE                          VAL R1
      158 CAPTURE                          UPVAL U22
      159 CAPTURE                          UPVAL U5
      160 CAPTURE                          UPVAL U1
      161 NAMECALL                         R7 R7 K34 ["andThen"]
      163 CALL                             R7 2 1
      164 NEWCLOSURE                       R9 P2
      165 CAPTURE                          UPVAL U22
      166 CAPTURE                          UPVAL U5
      167 CAPTURE                          UPVAL U1
      168 NAMECALL                         R7 R7 K35 ["catch"]
      170 CALL                             R7 2 0
      171 RETURN                           R0 0
...
PROTO_11:
       ...
       27 LOADK                            R9 K10 ["This is a following tool call from %*"]
       28 MOVE                             R11 R7
       29 NAMECALL                         R9 R9 K11 ["format"]
       31 CALL                             R9 2 1
       32 CALL                             R8 1 1
       33 MOVE                             R6 R8
       34 SETTABLEKS                       R6 R5 K4 ["userPromptText"]
       36 JUMPIFNOT                        R2 ; [+4]
       37 GETUPVAL                         R6 8
       38 GETTABLEKS                       R6 R6 K5 ["images"]
       40 JUMP                             ; [+1]
       41 LOADNIL                          R6
       42 SETTABLEKS                       R6 R5 K5 ["images"]
       44 GETUPVAL                         R7 0
       45 GETTABLEKS                       R7 R7 K12 ["FFlagAssistantSlashToolNameAndError"]
       47 JUMPIFNOT                        R7 ; [+2]
       48 GETUPVAL                         R6 9
       49 JUMP                             ; [+1]
       50 LOADNIL                          R6
       51 SETTABLEKS                       R6 R5 K6 ["showError"]
       53 NEWCLOSURE                       R6 P0
       54 CAPTURE                          VAL R1
       55 CAPTURE                          UPVAL U10
       56 CAPTURE                          UPVAL U0
       57 CAPTURE                          UPVAL U11
       58 SETTABLEKS                       R6 R5 K7 ["onComplete"]
       60 CALL                             R3 2 0
       61 RETURN                           R0 0
       62 GETUPVAL                         R2 12
       63 MOVE                             R3 R0
