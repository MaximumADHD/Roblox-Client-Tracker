...
PROTO_2:
       ...
       29 JUMPIFNOT                        R4 ; [+15]
       30 LOADK                            R7 K2 ["The following tools have been removed: %*"]
       31 GETIMPORT                        R9 K5 [table.concat]
       33 MOVE                             R10 R4
       34 LOADK                            R11 K6 [", "]
       35 CALL                             R9 2 1
       36 NAMECALL                         R7 R7 K7 ["format"]
       38 CALL                             R7 2 1
       39 FASTCALL2                        TABLE_INSERT R1 R7 ; [+4]
       41 MOVE                             R6 R1
       42 GETIMPORT                        R5 K9 [table.insert]
       44 CALL                             R5 2 0
       45 JUMPIFNOT                        R3 ; [+15]
       46 LOADK                            R7 K10 ["The following tools have been added: %*"]
       47 GETIMPORT                        R9 K5 [table.concat]
       49 MOVE                             R10 R3
       50 LOADK                            R11 K6 [", "]
       51 CALL                             R9 2 1
       52 NAMECALL                         R7 R7 K7 ["format"]
       54 CALL                             R7 2 1
       55 FASTCALL2                        TABLE_INSERT R1 R7 ; [+4]
       57 MOVE                             R6 R1
       58 GETIMPORT                        R5 K9 [table.insert]
       60 CALL                             R5 2 0
       61 RETURN                           R1 1
...
MAIN:
       ...
       27 GETTABLEKS                       R4 R4 K11 ["SessionIdContext"]
       29 CALL                             R3 1 1
