...
PROTO_15:
       ...
       77 RETURN                           R9 1
       78 JUMPIFNOTEQKS                    R5 K18 ["CFrame"] ; [+35]
       80 GETTABLEKS                       R6 R0 K19 ["Position"]
       82 NAMECALL                         R7 R0 K20 ["GetComponents"]
       84 CALL                             R7 1 12
       85 DUPTABLE                         R19 K22 [{"Position", "Rotation"}]
       86 LOADK                            R20 K23 ["%*, %*, %*"]
       87 GETTABLEKS                       R22 R6 K24 ["X"]
       89 GETTABLEKS                       R23 R6 K25 ["Y"]
       91 GETTABLEKS                       R24 R6 K26 ["Z"]
       93 NAMECALL                         R20 R20 K27 ["format"]
       95 CALL                             R20 4 1
       96 SETTABLEKS                       R20 R19 K19 ["Position"]
       98 LOADK                            R20 K28 ["%*, %*, %*, %*, %*, %*, %*, %*, %*"]
       99 MOVE                             R22 R10
      100 MOVE                             R23 R11
      101 MOVE                             R24 R12
      ...
      106 MOVE                             R29 R17
      107 MOVE                             R30 R18
      108 NAMECALL                         R20 R20 K27 ["format"]
      110 CALL                             R20 10 1
      111 SETTABLEKS                       R20 R19 K21 ["Rotation"]
      113 RETURN                           R19 1
      114 JUMPIFNOTEQKS                    R5 K29 ["Vector3"] ; [+12]
      116 LOADK                            R6 K23 ["%*, %*, %*"]
      117 GETTABLEKS                       R8 R0 K24 ["X"]
      119 GETTABLEKS                       R9 R0 K25 ["Y"]
      121 GETTABLEKS                       R10 R0 K26 ["Z"]
      123 NAMECALL                         R6 R6 K27 ["format"]
      125 CALL                             R6 4 1
      126 RETURN                           R6 1
      127 JUMPIFNOTEQKS                    R5 K30 ["Vector2"] ; [+10]
      129 LOADK                            R6 K31 ["%*, %*"]
      130 GETTABLEKS                       R8 R0 K24 ["X"]
      132 GETTABLEKS                       R9 R0 K25 ["Y"]
      134 NAMECALL                         R6 R6 K27 ["format"]
      136 CALL                             R6 3 1
      137 RETURN                           R6 1
      138 JUMPIFNOTEQKS                    R5 K32 ["Color3"] ; [+12]
      140 LOADK                            R6 K23 ["%*, %*, %*"]
      141 GETTABLEKS                       R8 R0 K33 ["R"]
      143 GETTABLEKS                       R9 R0 K34 ["G"]
      145 GETTABLEKS                       R10 R0 K35 ["B"]
      147 NAMECALL                         R6 R6 K27 ["format"]
      149 CALL                             R6 4 1
      150 RETURN                           R6 1
      151 FASTCALL1                        TOSTRING R0 ; [+3]
      152 MOVE                             R7 R0
      153 GETIMPORT                        R6 K15 [tostring]
      155 CALL                             R6 1 1
      156 RETURN                           R6 1
