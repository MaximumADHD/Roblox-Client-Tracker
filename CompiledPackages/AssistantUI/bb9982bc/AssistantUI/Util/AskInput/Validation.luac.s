...
PROTO_15:
       ...
       11 CALL                             R3 1 1
       12 JUMPIFEQKS                       R3 K4 ["string"] ; [+182]
       14 LOADK                            R3 K5 ["\"%*\" must be a string"]
       15 GETTABLEKS                       R5 R0 K6 ["name"]
       17 NAMECALL                         R3 R3 K7 ["format"]
       19 CALL                             R3 2 1
       20 RETURN                           R3 1
       21 JUMP                             ; [+173]
       22 GETUPVAL                         R3 0
       23 GETTABLEKS                       R3 R3 K8 ["Number"]
       25 JUMPIFNOTEQ                      R2 R3 ; [+16]
       27 FASTCALL1                        TYPEOF R1 ; [+3]
       28 MOVE                             R4 R1
       29 GETIMPORT                        R3 K3 [typeof]
       31 CALL                             R3 1 1
       32 JUMPIFEQKS                       R3 K9 ["number"] ; [+162]
       34 LOADK                            R3 K10 ["\"%*\" must be a number"]
       35 GETTABLEKS                       R5 R0 K6 ["name"]
       37 NAMECALL                         R3 R3 K7 ["format"]
       39 CALL                             R3 2 1
       40 RETURN                           R3 1
       41 JUMP                             ; [+153]
       42 GETUPVAL                         R3 0
       43 GETTABLEKS                       R3 R3 K11 ["Boolean"]
       45 JUMPIFNOTEQ                      R2 R3 ; [+16]
       47 FASTCALL1                        TYPEOF R1 ; [+3]
       48 MOVE                             R4 R1
       49 GETIMPORT                        R3 K3 [typeof]
       51 CALL                             R3 1 1
       52 JUMPIFEQKS                       R3 K12 ["boolean"] ; [+142]
       54 LOADK                            R3 K13 ["\"%*\" must be a boolean"]
       55 GETTABLEKS                       R5 R0 K6 ["name"]
       57 NAMECALL                         R3 R3 K7 ["format"]
       59 CALL                             R3 2 1
       60 RETURN                           R3 1
       61 JUMP                             ; [+133]
       62 GETUPVAL                         R3 0
       63 GETTABLEKS                       R3 R3 K14 ["Array"]
       65 JUMPIFNOTEQ                      R2 R3 ; [+13]
       67 GETUPVAL                         R3 1
       68 MOVE                             R4 R1
       69 CALL                             R3 1 1
       70 JUMPIF                           R3 ; [+124]
       71 LOADK                            R3 K15 ["\"%*\" must be an array of strings"]
       72 GETTABLEKS                       R5 R0 K6 ["name"]
       74 NAMECALL                         R3 R3 K7 ["format"]
       76 CALL                             R3 2 1
       77 RETURN                           R3 1
       78 JUMP                             ; [+116]
       79 GETTABLEKS                       R3 R0 K0 ["inputType"]
       81 GETUPVAL                         R4 0
       82 GETTABLEKS                       R4 R4 K16 ["Option"]
       84 JUMPIFNOTEQ                      R3 R4 ; [+40]
       86 FASTCALL1                        TYPEOF R1 ; [+3]
       87 MOVE                             R4 R1
       88 GETIMPORT                        R3 K3 [typeof]
       90 CALL                             R3 1 1
       91 JUMPIFEQKS                       R3 K4 ["string"] ; [+8]
       93 LOADK                            R3 K17 ["\"%*\" must be one of its options"]
       94 GETTABLEKS                       R5 R0 K6 ["name"]
       96 NAMECALL                         R3 R3 K7 ["format"]
       98 CALL                             R3 2 1
       99 RETURN                           R3 1
      100 GETTABLEKS                       R3 R0 K18 ["options"]
      102 FASTCALL1                        TYPEOF R3 ; [+3]
      103 MOVE                             R5 R3
      104 GETIMPORT                        R4 K3 [typeof]
      106 CALL                             R4 1 1
      107 JUMPIFNOTEQKS                    R4 K19 ["table"] ; [+10]
      109 GETIMPORT                        R4 K21 [table.find]
      111 MOVE                             R5 R3
      112 MOVE                             R6 R1
      113 CALL                             R4 2 1
      114 JUMPIFEQKNIL                     R4 ; [+3]
      116 LOADNIL                          R4
      117 RETURN                           R4 1
      118 LOADK                            R4 K17 ["\"%*\" must be one of its options"]
      119 GETTABLEKS                       R6 R0 K6 ["name"]
      121 NAMECALL                         R4 R4 K7 ["format"]
      123 CALL                             R4 2 1
      124 RETURN                           R4 1
      125 GETUPVAL                         R3 0
      126 GETTABLEKS                       R3 R3 K22 ["Instance"]
      128 JUMPIFNOTEQ                      R2 R3 ; [+24]
      130 FASTCALL1                        TYPEOF R1 ; [+3]
      131 MOVE                             R4 R1
      132 GETIMPORT                        R3 K3 [typeof]
      134 CALL                             R3 1 1
      135 JUMPIFNOTEQKS                    R3 K19 ["table"] ; [+9]
      137 GETTABLEKS                       R4 R1 K23 ["uniqueId"]
      139 FASTCALL1                        TYPEOF R4 ; [+2]
      140 GETIMPORT                        R3 K3 [typeof]
      142 CALL                             R3 1 1
      143 JUMPIFEQKS                       R3 K4 ["string"] ; [+51]
      145 LOADK                            R3 K24 ["\"%*\" must be a picked instance"]
      146 GETTABLEKS                       R5 R0 K6 ["name"]
      148 NAMECALL                         R3 R3 K7 ["format"]
      150 CALL                             R3 2 1
      151 RETURN                           R3 1
      152 JUMP                             ; [+42]
      153 GETUPVAL                         R3 0
      154 GETTABLEKS                       R3 R3 K25 ["Image"]
      156 JUMPIFNOTEQ                      R2 R3 ; [+38]
      158 FASTCALL1                        TYPEOF R1 ; [+3]
      159 MOVE                             R5 R1
      160 GETIMPORT                        R4 K3 [typeof]
      162 CALL                             R4 1 1
      163 JUMPIFEQKS                       R4 K4 ["string"] ; [+2]
      165 LOADB                            R3 0 +1
      166 LOADB                            R3 1
      167 LOADB                            R4 0
      168 FASTCALL1                        TYPEOF R1 ; [+3]
      169 MOVE                             R6 R1
      170 GETIMPORT                        R5 K3 [typeof]
      172 CALL                             R5 1 1
      173 JUMPIFNOTEQKS                    R5 K19 ["table"] ; [+12]
      175 LOADB                            R4 0
      176 GETTABLEKS                       R5 R1 K26 ["data"]
      178 JUMPIFEQKNIL                     R5 ; [+7]
      180 GETTABLEKS                       R5 R1 K27 ["mimeType"]
      182 JUMPIFNOTEQKNIL                  R5 ; [+2]
      184 LOADB                            R4 0 +1
      185 LOADB                            R4 1
      186 JUMPIF                           R3 ; [+8]
      187 JUMPIF                           R4 ; [+7]
      188 LOADK                            R5 K28 ["\"%*\" must be an image"]
      189 GETTABLEKS                       R7 R0 K6 ["name"]
      191 NAMECALL                         R5 R5 K7 ["format"]
      193 CALL                             R5 2 1
      194 RETURN                           R5 1
      195 LOADNIL                          R3
      196 RETURN                           R3 1
...
PROTO_20:
       ...
       14 LOADK                            R2 K3 ["\"%*\" is required"]
       15 GETTABLEKS                       R4 R0 K4 ["field"]
       17 NAMECALL                         R2 R2 K5 ["format"]
       19 CALL                             R2 2 1
       20 RETURN                           R2 1
       21 GETTABLEKS                       R2 R0 K0 ["kind"]
       23 GETUPVAL                         R3 0
       24 GETTABLEKS                       R3 R3 K6 ["Equals"]
       26 JUMPIFNOTEQ                      R2 R3 ; [+14]
       28 LOADK                            R2 K7 ["\"%*\" must equal %*"]
       29 GETTABLEKS                       R4 R0 K4 ["field"]
       31 GETTABLEKS                       R6 R0 K8 ["value"]
       33 FASTCALL1                        TOSTRING R6 ; [+2]
       34 GETIMPORT                        R5 K10 [tostring]
       36 CALL                             R5 1 1
       37 NAMECALL                         R2 R2 K5 ["format"]
       39 CALL                             R2 3 1
       40 RETURN                           R2 1
       41 GETTABLEKS                       R2 R0 K0 ["kind"]
       43 GETUPVAL                         R3 0
       44 GETTABLEKS                       R3 R3 K11 ["Range"]
       46 JUMPIFNOTEQ                      R2 R3 ; [+76]
       48 FASTCALL1                        TYPEOF R1 ; [+3]
       49 MOVE                             R4 R1
       50 GETIMPORT                        R3 K13 [typeof]
       52 CALL                             R3 1 1
       53 JUMPIFEQKS                       R3 K14 ["table"] ; [+2]
       55 LOADB                            R2 0 +1
       56 LOADB                            R2 1
       57 JUMPIFNOT                        R2 ; [+2]
       58 LOADK                            R3 K15 ["have"]
       59 JUMP                             ; [+1]
       60 LOADK                            R3 K16 ["be"]
       61 JUMPIFNOT                        R2 ; [+2]
       62 LOADK                            R4 K17 [" items"]
       63 JUMP                             ; [+1]
       64 LOADK                            R4 K18 [""]
       65 GETTABLEKS                       R5 R0 K19 ["min"]
       67 JUMPIFEQKNIL                     R5 ; [+18]
       69 GETTABLEKS                       R5 R0 K20 ["max"]
       71 JUMPIFEQKNIL                     R5 ; [+14]
       73 LOADK                            R5 K21 ["\"%*\" must %* between %* and %*%*"]
       74 GETTABLEKS                       R7 R0 K4 ["field"]
       76 MOVE                             R8 R3
       77 GETTABLEKS                       R9 R0 K19 ["min"]
       79 GETTABLEKS                       R10 R0 K20 ["max"]
       81 MOVE                             R11 R4
       82 NAMECALL                         R5 R5 K5 ["format"]
       84 CALL                             R5 6 1
       85 RETURN                           R5 1
       86 GETTABLEKS                       R5 R0 K19 ["min"]
       88 JUMPIFEQKNIL                     R5 ; [+12]
       90 LOADK                            R5 K22 ["\"%*\" must %* at least %*%*"]
       91 GETTABLEKS                       R7 R0 K4 ["field"]
       93 MOVE                             R8 R3
       94 GETTABLEKS                       R9 R0 K19 ["min"]
       96 MOVE                             R10 R4
       97 NAMECALL                         R5 R5 K5 ["format"]
       99 CALL                             R5 5 1
      100 RETURN                           R5 1
      101 GETTABLEKS                       R5 R0 K20 ["max"]
      103 JUMPIFEQKNIL                     R5 ; [+12]
      105 LOADK                            R5 K23 ["\"%*\" must %* at most %*%*"]
      106 GETTABLEKS                       R7 R0 K4 ["field"]
      108 MOVE                             R8 R3
      109 GETTABLEKS                       R9 R0 K20 ["max"]
      111 MOVE                             R10 R4
      112 NAMECALL                         R5 R5 K5 ["format"]
      114 CALL                             R5 5 1
      115 RETURN                           R5 1
      116 LOADK                            R5 K24 ["\"%*\" must be a number"]
      117 GETTABLEKS                       R7 R0 K4 ["field"]
      119 NAMECALL                         R5 R5 K5 ["format"]
      121 CALL                             R5 2 1
      122 RETURN                           R5 1
      123 GETTABLEKS                       R2 R0 K0 ["kind"]
      125 GETUPVAL                         R3 0
      126 GETTABLEKS                       R3 R3 K25 ["Any"]
      128 JUMPIFNOTEQ                      R2 R3 ; [+3]
      130 LOADK                            R2 K26 ["at least one of a set of conditions must be met"]
      131 RETURN                           R2 1
      132 GETTABLEKS                       R2 R0 K0 ["kind"]
      134 GETUPVAL                         R3 0
      135 GETTABLEKS                       R3 R3 K27 ["Not"]
      137 JUMPIFNOTEQ                      R2 R3 ; [+3]
      139 LOADK                            R2 K28 ["a condition that must not hold is currently true"]
      140 RETURN                           R2 1
      141 LOADK                            R2 K29 ["the \"%*\" rule was not satisfied"]
      142 GETTABLEKS                       R4 R0 K0 ["kind"]
      144 NAMECALL                         R2 R2 K5 ["format"]
      146 CALL                             R2 2 1
      147 RETURN                           R2 1
