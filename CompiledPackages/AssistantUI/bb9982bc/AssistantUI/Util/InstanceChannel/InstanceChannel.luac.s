...
PROTO_7:
       ...
       13 CALL                             R2 2 -1
       14 RETURN                           R2 -1
       15 LOADK                            R2 K4 ["Assistant-Channel-%*-%*"]
       16 MOVE                             R4 R0
       17 MOVE                             R5 R1
       18 NAMECALL                         R2 R2 K3 ["format"]
       20 CALL                             R2 3 1
       21 RETURN                           R2 1
...
PROTO_11:
        ...
        5 CALL                             R4 2 1
        6 NOT                              R3 R4
        7 LOADK                            R4 K1 ["An InstanceChannel with scope \"%*\" and id \"%*\" is already open; ids must be unique."]
        8 MOVE                             R6 R0
        9 MOVE                             R7 R1
       ...
       17 CALL                             R2 2 0
       18 GETIMPORT                        R2 K7 [Instance.new]
       20 LOADK                            R3 K8 ["Folder"]
       21 CALL                             R2 1 1
       22 LOADB                            R3 0
       23 SETTABLEKS                       R3 R2 K9 ["Archivable"]
       25 LOADK                            R3 K10 ["RBXAssistantChannel_%*_%*"]
       26 MOVE                             R5 R0
       27 MOVE                             R6 R1
       ...
       33 GETUPVAL                         R5 0
       34 GETTABLEKS                       R5 R5 K12 ["getTag"]
       36 MOVE                             R6 R0
       37 MOVE                             R7 R1
       38 CALL                             R5 2 -1
       39 NAMECALL                         R3 R2 K13 ["AddTag"]
       41 CALL                             R3 -1 0
       42 GETUPVAL                         R3 1
       43 CALL                             R3 0 1
       44 SETTABLEKS                       R3 R2 K14 ["Parent"]
       46 GETUPVAL                         R3 2
