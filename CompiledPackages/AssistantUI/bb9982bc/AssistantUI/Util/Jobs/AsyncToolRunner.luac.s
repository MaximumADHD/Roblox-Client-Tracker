...
PROTO_2:
       ...
       16 LOADK                            R9 K13 ["The tool runs in the background and updates its own UI. Poll the returned jobId with the %* tool only when you actually need the final result."]
       17 GETUPVAL                         R11 2
       18 GETTABLEKS                       R11 R11 K14 ["JobWait"]
       20 NAMECALL                         R9 R9 K15 ["format"]
       22 CALL                             R9 2 1
       23 LOADK                            R10 K16 ["If you DO need the result before proceeding, omit this argument (or set it false) and call the tool normally."]
       24 SETLIST                          R6 R7 4 [1]
       26 LOADK                            R7 K17 [" "]
       27 CALL                             R5 2 1
       28 SETTABLEKS                       R5 R4 K6 ["description"]
       30 SETTABLEKS                       R4 R3 K2 ["schema"]
       32 CALL                             R1 2 -1
       33 RETURN                           R1 -1
