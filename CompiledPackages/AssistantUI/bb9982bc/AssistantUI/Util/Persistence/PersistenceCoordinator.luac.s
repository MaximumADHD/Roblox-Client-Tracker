...
PROTO_39:
       ...
       63 CAPTURE                          REF R6
       64 CAPTURE                          VAL R11
       65 SETTABLEKS                       R13 R12 K11 ["provideAgentSaveData"]
       67 NEWCLOSURE                       R13 P11
       68 CAPTURE                          REF R6
       69 SETTABLEKS                       R13 R12 K12 ["onAgentSaveReady"]
       71 NEWCLOSURE                       R13 P12
       72 CAPTURE                          REF R8
       73 CAPTURE                          VAL R7
       74 SETTABLEKS                       R13 R12 K13 ["provideAgentRestoreData"]
       76 NEWCLOSURE                       R13 P13
       77 CAPTURE                          VAL R7
       78 CAPTURE                          REF R8
       79 SETTABLEKS                       R13 R12 K14 ["onAgentRestoreReady"]
       81 NEWCLOSURE                       R13 P14
       82 CAPTURE                          VAL R11
       83 SETTABLEKS                       R13 R12 K15 ["waitForPendingSaves"]
       85 NEWCLOSURE                       R13 P15
       86 CAPTURE                          REF R9
       87 SETTABLEKS                       R13 R12 K16 ["clearDirty"]
       89 NEWCLOSURE                       R13 P16
       90 CAPTURE                          REF R9
       91 SETTABLEKS                       R13 R12 K17 ["onClearDirty"]
       93 NEWCLOSURE                       R13 P17
       94 CAPTURE                          REF R10
       95 SETTABLEKS                       R13 R12 K18 ["requestDelete"]
       97 NEWCLOSURE                       R13 P18
       98 CAPTURE                          REF R10
       99 SETTABLEKS                       R13 R12 K19 ["onDeleteRequested"]
      101 CLOSEUPVALS                      R1
      102 RETURN                           R12 1
...
MAIN:
       ...
       32 CAPTURE                          VAL R3
       33 CAPTURE                          VAL R2
       34 DUPCLOSURE                       R6 K12 [PROTO_39]
       35 CAPTURE                          VAL R3
       36 CAPTURE                          VAL R5
       37 LOADNIL                          R7
       38 DUPTABLE                         R8 K16 [{"new", "get", "set"}]
       39 SETTABLEKS                       R6 R8 K13 ["new"]
       41 NEWCLOSURE                       R9 P2
       42 CAPTURE                          REF R7
       43 SETTABLEKS                       R9 R8 K14 ["get"]
       45 NEWCLOSURE                       R9 P3
       46 CAPTURE                          REF R7
       47 SETTABLEKS                       R9 R8 K15 ["set"]
       49 CLOSEUPVALS                      R7
       50 RETURN                           R8 1
