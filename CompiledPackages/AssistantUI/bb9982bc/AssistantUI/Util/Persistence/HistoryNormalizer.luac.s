...
PROTO_10:
      ...
      156 JUMPIFNOTEQKS                    R12 K19 ["model"] ; [+149]
      158 JUMPIF                           R3 ; [+8]
      ...
      217 JUMP                             ; [+1]
      218 LOADNIL                          R18
      219 JUMPIFEQKS                       R18 K10 ["tool_result"] ; [+83]
      221 GETUPVAL                         R19 2
      222 MOVE                             R20 R17
      223 CALL                             R19 1 1
      ...
      263 JUMP                             ; [+1]
      264 LOADNIL                          R20
      265 JUMPIFNOT                        R20 ; [+37]
      266 GETTABLE                         R21 R1 R20
      267 JUMPIFNOT                        R21 ; [+35]
      268 GETTABLE                         R21 R5 R20
      269 JUMPIFNOT                        R21 ; [+24]
      270 GETUPVAL                         R21 3
      271 GETTABLEKS                       R21 R21 K27 ["FFlagDebugLogAssistantUI"]
      273 JUMPIFNOT                        R21 ; [+20]
      274 GETIMPORT                        R21 K29 [warn]
      276 LOADK                            R22 K30 ["[HistoryNormalizer] Duplicate tool_use id %* while projecting message %*; inserting tool_result again into assistant group %*"]
      277 MOVE                             R24 R20
      278 GETTABLEKS                       R26 R11 K31 ["messageId"]
      280 FASTCALL1                        TOSTRING R26 ; [+2]
      281 GETIMPORT                        R25 K33 [tostring]
      283 CALL                             R25 1 1
      284 GETTABLEKS                       R27 R12 K31 ["messageId"]
      286 FASTCALL1                        TOSTRING R27 ; [+2]
      287 GETIMPORT                        R26 K33 [tostring]
      289 CALL                             R26 1 1
      290 NAMECALL                         R22 R22 K34 ["format"]
      292 CALL                             R22 4 1
      293 CALL                             R21 1 0
      294 LOADB                            R21 1
      295 SETTABLE                         R21 R5 R20
      296 GETTABLE                         R23 R1 R20
      297 FASTCALL2                        TABLE_INSERT R4 R23 ; [+4]
      299 MOVE                             R22 R4
      300 GETIMPORT                        R21 K15 [table.insert]
      302 CALL                             R21 2 0
      303 FORGLOOP                         R13 2 ; [-115]
      305 JUMP                             ; [+9]
      306 MOVE                             R12 R6
      307 CALL                             R12 0 0
      308 FASTCALL2                        TABLE_INSERT R2 R11 ; [+5]
      310 MOVE                             R13 R2
      311 MOVE                             R14 R11
      312 GETIMPORT                        R12 K15 [table.insert]
      314 CALL                             R12 2 0
      315 FORGLOOP                         R7 2 ; [-241]
      317 MOVE                             R7 R6
      318 CALL                             R7 0 0
      319 CLOSEUPVALS                      R3
      320 RETURN                           R2 1
