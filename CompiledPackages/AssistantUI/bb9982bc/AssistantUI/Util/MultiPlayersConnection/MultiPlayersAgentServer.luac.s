...
PROTO_2:
       ...
       10 JUMPIFNOTLT                      R3 R1 ; [+13]
       12 GETIMPORT                        R3 K1 [error]
       14 LOADK                            R4 K4 ["We only have %* players, player id %* is out of range."]
       15 GETUPVAL                         R6 0
       16 GETTABLEKS                       R6 R6 K3 ["player_count"]
       18 MOVE                             R7 R1
       ...
       26 LOADNIL                          R6
       27 FORGPREP                         R4
       28 GETTABLEKS                       R9 R8 K6 ["playerId"]
       30 JUMPIFNOTEQ                      R9 R1 ; [+3]
       32 MOVE                             R3 R8
       33 JUMP                             ; [+3]
       34 FORGLOOP                         R4 2 ; [-7]
       36 LOADNIL                          R3
       37 JUMPIFNOT                        R3 ; [+9]
       38 GETIMPORT                        R4 K1 [error]
       40 LOADK                            R5 K7 ["Player %* has already finished, cannot send team communication to it."]
       41 MOVE                             R7 R1
       ...
       46 CALL                             R4 2 0
       47 GETUPVAL                         R4 2
       48 GETTABLEKS                       R4 R4 K8 ["log"]
       50 LOADK                            R5 K9 ["Sending team communication to player %* from player %* with content: %*"]
       51 MOVE                             R7 R1
       52 MOVE                             R8 R0
       53 MOVE                             R9 R2
       54 NAMECALL                         R5 R5 K5 ["format"]
       56 CALL                             R5 4 1
       57 CALL                             R4 1 0
       58 GETUPVAL                         R4 3
       59 FASTCALL2K                       ASSERT R4 K10 ; [+5]
       61 MOVE                             R6 R4
       62 LOADK                            R7 K10 ["Multi-player server is not initialized."]
       63 GETIMPORT                        R5 K12 [assert]
       65 CALL                             R5 2 0
       66 MOVE                             R7 R1
       67 GETUPVAL                         R8 4
       68 GETTABLEKS                       R8 R8 K13 ["TeamCommunication"]
       70 MOVE                             R9 R0
       71 MOVE                             R10 R1
       72 MOVE                             R11 R2
       73 NAMECALL                         R5 R4 K14 ["sendCommand"]
       75 CALL                             R5 6 0
       76 RETURN                           R0 0
...
PROTO_13:
       ...
       25 MOVE                             R5 R0
       26 CALL                             R4 1 0
       27 LOADK                            R4 K8 ["Finished with message: %*"]
       28 MOVE                             R6 R2
       29 NAMECALL                         R4 R4 K9 ["format"]
       31 CALL                             R4 2 1
       32 GETUPVAL                         R6 4
       33 DUPTABLE                         R7 K14 [{["fromPlayerId"], ["targetPlayerId"] = 0, ["content"]}]
       34 SETTABLEKS                       R0 R7 K10 ["fromPlayerId"]
       36 SETTABLEKS                       R4 R7 K13 ["content"]
       38 FASTCALL2                        TABLE_INSERT R6 R7 ; [+3]
       40 GETIMPORT                        R5 K7 [table.insert]
       42 CALL                             R5 2 0
       43 GETUPVAL                         R5 5
       44 GETUPVAL                         R7 4
       45 NAMECALL                         R5 R5 K15 ["Fire"]
       47 CALL                             R5 2 0
       48 GETUPVAL                         R5 2
       49 LENGTH                           R4 R5
       50 GETUPVAL                         R5 0
       51 GETTABLEKS                       R5 R5 K16 ["player_count"]
       53 JUMPIFNOTLE                      R5 R4 ; [+3]
       55 GETUPVAL                         R4 6
       56 CALL                             R4 0 0
       57 RETURN                           R0 0
...
PROTO_14:
       ...
       16 MOVE                             R3 R0
       17 LOADNIL                          R4
       18 LOADK                            R5 K1 ["Player %* disconnected."]
       19 MOVE                             R7 R0
       20 NAMECALL                         R5 R5 K2 ["format"]
       22 CALL                             R5 2 1
       23 CALL                             R2 3 0
       24 RETURN                           R0 0
...
PROTO_15:
       ...
       34 CALL                             R2 2 0
       35 RETURN                           R0 0
       36 LOADK                            R2 K11 ["Player%* is now paused and waiting for team communications."]
       37 MOVE                             R4 R0
       38 NAMECALL                         R2 R2 K12 ["format"]
       40 CALL                             R2 2 1
       41 GETUPVAL                         R4 3
       42 DUPTABLE                         R5 K13 [{["fromPlayerId"], ["targetPlayerId"] = 0, ["content"]}]
       43 SETTABLEKS                       R0 R5 K4 ["fromPlayerId"]
       45 SETTABLEKS                       R2 R5 K7 ["content"]
       47 FASTCALL2                        TABLE_INSERT R4 R5 ; [+3]
       49 GETIMPORT                        R3 K2 [table.insert]
       51 CALL                             R3 2 0
       52 GETUPVAL                         R3 4
       53 GETUPVAL                         R5 3
       54 NAMECALL                         R3 R3 K10 ["Fire"]
       56 CALL                             R3 2 0
       57 RETURN                           R0 0
...
PROTO_22:
      ...
      132 JUMPIFNOTEQ                      R1 R3 ; [+12]
      134 GETVARARGS                       R3 2
      135 GETUPVAL                         R5 10
      136 GETTABLEKS                       R5 R5 K20 ["log"]
      138 LOADK                            R6 K21 ["[Player%*]: %*"]
      139 MOVE                             R8 R3
      140 MOVE                             R9 R4
      141 NAMECALL                         R6 R6 K22 ["format"]
      143 CALL                             R6 3 1
      144 CALL                             R5 1 0
      145 RETURN                           R0 0
