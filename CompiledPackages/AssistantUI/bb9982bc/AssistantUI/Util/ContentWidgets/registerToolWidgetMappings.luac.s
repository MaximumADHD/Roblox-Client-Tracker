...
PROTO_2:
      ...
      524 LENGTH                           R1 R0
      525 LOADN                            R2 0
      526 JUMPIFNOTLT                      R2 R1 ; [+13]
      528 GETUPVAL                         R1 4
      529 GETTABLEKS                       R1 R1 K55 ["FFlagDebugLogAssistantUI"]
      531 JUMPIFNOT                        R1 ; [+8]
      532 GETIMPORT                        R1 K57 [print]
      534 LOADK                            R2 K58 ["[registerToolWidgetMappings] Applying %* FString mapping(s)"]
      535 LENGTH                           R4 R0
      536 NAMECALL                         R2 R2 K59 ["format"]
      538 CALL                             R2 2 1
      539 CALL                             R1 1 0
      540 MOVE                             R1 R0
      541 LOADNIL                          R2
      ...
      543 FORGPREP                         R1
      544 GETUPVAL                         R6 0
      545 GETTABLEKS                       R6 R6 K0 ["add"]
      547 GETTABLEKS                       R7 R5 K60 ["toolName"]
      549 GETTABLEKS                       R8 R5 K61 ["widgetType"]
      551 GETUPVAL                         R9 34
      552 GETTABLEKS                       R9 R9 K62 ["FString"]
      554 CALL                             R6 3 0
      555 FORGLOOP                         R1 2 ; [-12]
      557 GETUPVAL                         R1 4
      558 GETTABLEKS                       R1 R1 K55 ["FFlagDebugLogAssistantUI"]
      560 JUMPIFNOT                        R1 ; [+55]
      561 GETUPVAL                         R1 1
      562 LOADNIL                          R2
      563 LOADNIL                          R3
      564 FORGPREP                         R1
      565 FASTCALL1                        TYPEOF R5 ; [+3]
      566 MOVE                             R7 R5
      567 GETIMPORT                        R6 K64 [typeof]
      569 CALL                             R6 1 1
      570 JUMPIFNOTEQKS                    R6 K65 ["string"] ; [+43]
      572 GETUPVAL                         R6 32
      573 CALL                             R6 0 1
      574 JUMPIF                           R6 ; [+6]
      575 GETUPVAL                         R6 35
      576 GETTABLEKS                       R6 R6 K66 ["isCloudTool"]
      578 MOVE                             R7 R5
      579 CALL                             R6 1 1
      580 JUMPIF                           R6 ; [+33]
      581 GETUPVAL                         R6 1
      582 GETTABLEKS                       R6 R6 K4 ["AskInput"]
      584 JUMPIFNOTEQ                      R5 R6 ; [+5]
      586 GETUPVAL                         R6 4
      587 GETTABLEKS                       R6 R6 K3 ["FFlagAssistantAskInputTool"]
      589 JUMPIFNOT                        R6 ; [+24]
      590 GETUPVAL                         R6 1
      591 GETTABLEKS                       R6 R6 K26 ["JobRun"]
      593 JUMPIFNOTEQ                      R5 R6 ; [+5]
      595 GETUPVAL                         R6 4
      596 GETTABLEKS                       R6 R6 K25 ["FFlagAssistantReplaceJobRunWithAsyncArg"]
      598 JUMPIF                           R6 ; [+15]
      599 GETUPVAL                         R6 0
      600 GETTABLEKS                       R6 R6 K67 ["get"]
      602 MOVE                             R7 R5
      603 CALL                             R6 1 1
      604 JUMPIF                           R6 ; [+9]
      605 GETIMPORT                        R6 K69 [error]
      607 LOADK                            R7 K70 ["[registerToolWidgetMappings] No widget mapping found for tool \"%*\""]
      608 MOVE                             R9 R5
      609 NAMECALL                         R7 R7 K59 ["format"]
      611 CALL                             R7 2 1
      612 LOADN                            R8 0
      613 CALL                             R6 2 0
      614 FORGLOOP                         R1 2 ; [-50]
      616 RETURN                           R0 0
