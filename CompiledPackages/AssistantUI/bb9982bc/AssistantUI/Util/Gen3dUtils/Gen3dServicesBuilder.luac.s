...
PROTO_4:
        0 GETTABLEKS                       R1 R0 K0 ["environment"]
        2 DUPTABLE                         R2 K6 [{"imageGeneration", "http", "base64EncodeAsync", "convertImageDataToTempIdAsync", "capabilities"}]
        3 DUPTABLE                         R3 K9 [{"startAsync", "getStatusAsync"}]
        4 GETUPVAL                         R4 0
        5 GETTABLEKS                       R4 R4 K10 ["startGenerationAsync"]
        7 SETTABLEKS                       R4 R3 K7 ["startAsync"]
        9 GETUPVAL                         R4 0
       10 GETTABLEKS                       R4 R4 K11 ["getGenerationStatusAsync"]
       12 SETTABLEKS                       R4 R3 K8 ["getStatusAsync"]
       14 SETTABLEKS                       R3 R2 K1 ["imageGeneration"]
       16 DUPTABLE                         R3 K13 [{"requestAsync"}]
       17 GETTABLEKS                       R4 R1 K2 ["http"]
       19 GETTABLEKS                       R4 R4 K12 ["requestAsync"]
       21 SETTABLEKS                       R4 R3 K12 ["requestAsync"]
       23 SETTABLEKS                       R3 R2 K2 ["http"]
       25 GETTABLEKS                       R3 R1 K3 ["base64EncodeAsync"]
       27 SETTABLEKS                       R3 R2 K3 ["base64EncodeAsync"]
       29 GETTABLEKS                       R3 R1 K4 ["convertImageDataToTempIdAsync"]
       31 SETTABLEKS                       R3 R2 K4 ["convertImageDataToTempIdAsync"]
       33 DUPTABLE                         R3 K17 [{"allocateSeed", "debugLog", "abortPollOn4xx"}]
       34 GETUPVAL                         R4 1
       35 GETTABLEKS                       R4 R4 K18 ["FFlagAssistantImageGenSeed"]
       37 SETTABLEKS                       R4 R3 K14 ["allocateSeed"]
       39 GETUPVAL                         R4 1
       40 GETTABLEKS                       R4 R4 K19 ["FFlagDebugLogAssistantUI"]
       42 SETTABLEKS                       R4 R3 K15 ["debugLog"]
       44 GETUPVAL                         R4 1
       45 GETTABLEKS                       R4 R4 K20 ["FFlagAssistantImageGenAbortPollOn4xx"]
       47 SETTABLEKS                       R4 R3 K16 ["abortPollOn4xx"]
       49 SETTABLEKS                       R3 R2 K5 ["capabilities"]
       51 RETURN                           R2 1
...
MAIN:
       ...
       30 GETTABLEKS                       R5 R5 K12 ["ImageSelection"]
       32 GETTABLEKS                       R5 R5 K13 ["ImageGenerationClient"]
       34 CALL                             R4 1 1
       ...
       46 GETTABLEKS                       R7 R0 K17 ["Util"]
       48 GETTABLEKS                       R7 R7 K18 ["Gen3dUtils"]
       50 GETTABLEKS                       R7 R7 K19 ["ViewportPreviewUtils"]
       52 CALL                             R6 1 1
       53 DUPCLOSURE                       R7 K20 [PROTO_3]
       54 CAPTURE                          VAL R6
       55 CAPTURE                          VAL R5
       56 DUPCLOSURE                       R8 K21 [PROTO_4]
       57 CAPTURE                          VAL R4
       58 CAPTURE                          VAL R2
       59 DUPTABLE                         R9 K24 [{"buildServices", "buildImageSelectionServices"}]
       60 SETTABLEKS                       R7 R9 K22 ["buildServices"]
       62 SETTABLEKS                       R8 R9 K23 ["buildImageSelectionServices"]
       64 RETURN                           R9 1
