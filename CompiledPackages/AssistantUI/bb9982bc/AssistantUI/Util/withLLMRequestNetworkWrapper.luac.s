...
PROTO_8:
        0 LOADK                            R3 K0 ["%*LLMRequest"]
        1 MOVE                             R5 R1
        2 NAMECALL                         R3 R3 K1 ["format"]
        4 CALL                             R3 2 1
        5 NEWTABLE                         R4 0 0
        7 LOADN                            R5 0
        8 LOADK                            R6 K2 ["%*StreamEvent"]
        9 MOVE                             R8 R3
       ...
       15 CAPTURE                          VAL R4
       16 NAMECALL                         R7 R0 K3 ["OnGuestInvokeAsync"]
       18 CALL                             R7 3 1
       19 MOVE                             R10 R3
       ...
       22 CAPTURE                          VAL R2
       23 CAPTURE                          VAL R7
       24 NAMECALL                         R8 R0 K4 ["OnHostInvokeAsync"]
       26 CALL                             R8 3 1
       27 NEWCLOSURE                       R9 P2
       28 CAPTURE                          VAL R0
       29 CAPTURE                          REF R5
...
MAIN:
       ...
       32 GETTABLEKS                       R5 R5 K11 ["ModelContextProtocol"]
       34 CALL                             R4 1 1
       35 GETTABLEKS                       R5 R1 K12 ["Engine"]
       37 GETTABLEKS                       R5 R5 K13 ["StreamEventUtils"]
       39 GETIMPORT                        R6 K5 [require]
       41 GETTABLEKS                       R7 R0 K14 ["Types"]
       43 CALL                             R6 1 1
       44 DUPCLOSURE                       R7 K15 [PROTO_8]
       45 CAPTURE                          VAL R4
       46 CAPTURE                          VAL R5
       47 CAPTURE                          VAL R3
       48 RETURN                           R7 1
