PROTO_0:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["fetchSystemPromptAsync"]
        3 DUPTABLE                         R1 K5 [{"tools", "model", "assistantMode", "isDebugMode"}]
        4 GETUPVAL                         R2 1
        5 GETTABLEKS                       R2 R2 K1 ["tools"]
        7 SETTABLEKS                       R2 R1 K1 ["tools"]
        9 GETUPVAL                         R2 1
       10 GETTABLEKS                       R2 R2 K2 ["model"]
       12 SETTABLEKS                       R2 R1 K2 ["model"]
       14 GETUPVAL                         R2 1
       15 GETTABLEKS                       R2 R2 K3 ["assistantMode"]
       17 SETTABLEKS                       R2 R1 K3 ["assistantMode"]
       19 GETUPVAL                         R2 1
       20 GETTABLEKS                       R2 R2 K4 ["isDebugMode"]
       22 SETTABLEKS                       R2 R1 K4 ["isDebugMode"]
       24 CALL                             R0 1 1
       25 GETUPVAL                         R1 2
       26 GETTABLEKS                       R1 R1 K6 ["injectSafetyBlocks"]
       28 MOVE                             R2 R0
       29 CALL                             R1 1 -1
       30 RETURN                           R1 -1
...
MAIN:
       ...
       11 GETTABLEKS                       R2 R2 K7 ["BYOKSafetyBlocks"]
       13 CALL                             R1 1 1
