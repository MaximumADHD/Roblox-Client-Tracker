...
PROTO_6:
       ...
       47 CALL                             R3 1 1
       48 MOVE                             R2 R3
       49 SETTABLEKS                       R1 R2 K13 ["Name"]
       51 GETUPVAL                         R5 6
       52 GETUPVAL                         R6 4
       53 CALL                             R5 1 -1
       54 NAMECALL                         R3 R2 K14 ["AddTag"]
       56 CALL                             R3 -1 0
       57 DUPTABLE                         R3 K18 [{"name", "generationId", "fbxFilePath", "keyframeSequence"}]
       58 SETTABLEKS                       R1 R3 K15 ["name"]
       60 GETUPVAL                         R4 4
       61 SETTABLEKS                       R4 R3 K16 ["generationId"]
       63 GETTABLEKS                       R4 R0 K8 ["fbxFilePath"]
       65 SETTABLEKS                       R4 R3 K8 ["fbxFilePath"]
       67 SETTABLEKS                       R2 R3 K17 ["keyframeSequence"]
       69 RETURN                           R3 1
...
PROTO_7:
       ...
       38 CALL                             R5 1 2
       39 JUMPIF                           R5 ; [+18]
       40 GETIMPORT                        R7 K15 [warn]
       42 LOADK                            R8 K16 ["[AnimationGenTool] Generation failed:"]
       43 FASTCALL1                        TOSTRING R6 ; [+3]
       44 MOVE                             R10 R6
       45 GETIMPORT                        R9 K18 [tostring]
       47 CALL                             R9 1 1
       48 CALL                             R7 2 0
       49 DUPTABLE                         R7 K22 [{["success"] = False, ["errorMessage"]}]
       50 FASTCALL1                        TOSTRING R6 ; [+3]
       51 MOVE                             R9 R6
       52 GETIMPORT                        R8 K18 [tostring]
       54 CALL                             R8 1 1
       55 SETTABLEKS                       R8 R7 K21 ["errorMessage"]
       57 RETURN                           R7 1
       58 DUPTABLE                         R7 K29 [{["success"] = True, ["name"], ["generationId"], ["fbxFilePath"], ["keyframeSequence"], ["id"]}]
       59 GETTABLEKS                       R8 R6 K24 ["name"]
       61 SETTABLEKS                       R8 R7 K24 ["name"]
       63 GETTABLEKS                       R8 R6 K25 ["generationId"]
       65 SETTABLEKS                       R8 R7 K25 ["generationId"]
       67 GETTABLEKS                       R8 R6 K26 ["fbxFilePath"]
       69 SETTABLEKS                       R8 R7 K26 ["fbxFilePath"]
       71 GETTABLEKS                       R8 R6 K27 ["keyframeSequence"]
       73 SETTABLEKS                       R8 R7 K27 ["keyframeSequence"]
       75 GETTABLEKS                       R8 R0 K28 ["id"]
       77 SETTABLEKS                       R8 R7 K28 ["id"]
       79 RETURN                           R7 1
...
PROTO_8:
       ...
       19 CAPTURE                          UPVAL U5
       20 CAPTURE                          UPVAL U6
       21 DUPTABLE                         R6 K5 [{"generateAnimationAsync", "saveKeyframeSequence"}]
       22 SETTABLEKS                       R5 R6 K3 ["generateAnimationAsync"]
       24 SETTABLEKS                       R4 R6 K4 ["saveKeyframeSequence"]
       26 RETURN                           R6 1
