PROTO_0:
        ...
        6 LOADK                            R3 K3 ["[JobStore] setJob %* %*"]
        7 MOVE                             R5 R0
        8 GETTABLEKS                       R6 R1 K4 ["status"]
...
PROTO_2:
       ...
       13 LOADK                            R4 K3 ["[JobStore] updateJob %* %*"]
       14 MOVE                             R6 R0
       15 GETTABLEKS                       R7 R2 K4 ["status"]
...
PROTO_3:
        ...
        6 LOADK                            R2 K3 ["[JobStore] removeJob %*"]
        7 MOVE                             R4 R0
...
PROTO_4:
       ...
       11 LOADK                            R3 K3 ["[JobStore] cancelJob %*"]
       12 MOVE                             R5 R0
       13 NAMECALL                         R3 R3 K4 ["format"]
       15 CALL                             R3 2 1
       16 CALL                             R2 1 0
       17 LOADK                            R4 K5 ["Cancelled by user"]
       18 NAMECALL                         R2 R1 K6 ["abort"]
       20 CALL                             R2 2 0
       21 LOADB                            R2 1
       22 RETURN                           R2 1
