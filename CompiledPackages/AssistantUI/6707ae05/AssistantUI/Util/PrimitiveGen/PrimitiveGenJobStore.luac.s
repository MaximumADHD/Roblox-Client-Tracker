...
PROTO_5:
       ...
       39 FORGLOOP                         R4 2 ; [-2]
       41 LOADK                            R4 K10 ["Status changed to %*"]
       42 MOVE                             R6 R1
       43 NAMECALL                         R4 R4 K11 ["format"]
       45 CALL                             R4 2 1
       46 JUMPIFNOT                        R2 ; [+11]
       47 GETTABLEKS                       R5 R2 K12 ["errorMessage"]
       49 JUMPIFNOT                        R5 ; [+8]
       50 LOADK                            R5 K13 ["%*: %*"]
       51 MOVE                             R7 R4
       52 GETTABLEKS                       R8 R2 K12 ["errorMessage"]
       54 NAMECALL                         R5 R5 K11 ["format"]
       56 CALL                             R5 3 1
       57 MOVE                             R4 R5
       58 JUMPIFNOT                        R2 ; [+11]
       59 GETTABLEKS                       R5 R2 K14 ["serverStage"]
       61 JUMPIFNOT                        R5 ; [+8]
       62 LOADK                            R5 K15 ["%* (stage: %*)"]
       63 MOVE                             R7 R4
       64 GETTABLEKS                       R8 R2 K14 ["serverStage"]
       66 NAMECALL                         R5 R5 K11 ["format"]
       68 CALL                             R5 3 1
       69 MOVE                             R4 R5
       70 GETUPVAL                         R5 4
       71 MOVE                             R6 R0
