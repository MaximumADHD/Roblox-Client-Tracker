PROTO_0:
       ...
       26 CALL                             R6 1 0
       27 RETURN                           R0 1
       28 GETIMPORT                        R6 K10 [table.clone]
       30 GETUPVAL                         R8 1
       31 GETTABLE                         R7 R4 R8
       32 CALL                             R6 1 1
       33 LOADB                            R7 1
       34 SETTABLEKS                       R7 R6 K11 ["isDeleted"]
       36 GETUPVAL                         R7 1
       37 SETTABLE                         R6 R4 R7
       38 GETUPVAL                         R7 2
       39 NEWTABLE                         R8 0 1
       41 MOVE                             R9 R6
       ...
       51 CALL                             R7 1 0
       52 GETTABLEKS                       R7 R6 K12 ["ephemeral"]
       54 JUMPIF                           R7 ; [+23]
       55 GETUPVAL                         R7 4
       56 DUPTABLE                         R8 K18 [{"deleteThreadId", "acpSessionId", "acpClientService", "sessionId", "deleteReason"}]
       57 GETUPVAL                         R9 1
       58 SETTABLEKS                       R9 R8 K13 ["deleteThreadId"]
       60 GETTABLEKS                       R9 R6 K14 ["acpSessionId"]
       62 SETTABLEKS                       R9 R8 K14 ["acpSessionId"]
       64 GETUPVAL                         R9 5
       65 SETTABLEKS                       R9 R8 K15 ["acpClientService"]
       67 GETUPVAL                         R9 6
       68 SETTABLEKS                       R9 R8 K16 ["sessionId"]
       70 GETUPVAL                         R9 7
       71 GETTABLEKS                       R9 R9 K19 ["DeletionReason"]
       73 GETTABLEKS                       R9 R9 K20 ["UserDelete"]
       75 SETTABLEKS                       R9 R8 K17 ["deleteReason"]
       77 CALL                             R7 1 0
       78 RETURN                           R3 1
...
MAIN:
       ...
       20 GETTABLEKS                       R3 R3 K10 ["AssistantHarness"]
       22 CALL                             R2 1 1
       23 GETTABLEKS                       R3 R2 K11 ["Engine"]
       25 GETTABLEKS                       R3 R3 K12 ["CompactedStore"]
       27 GETIMPORT                        R4 K5 [require]
       29 GETTABLEKS                       R5 R0 K6 ["Components"]
       31 GETTABLEKS                       R5 R5 K7 ["Contexts"]
       33 GETTABLEKS                       R5 R5 K13 ["ConversationContext"]
       35 CALL                             R4 1 1
       36 GETIMPORT                        R5 K5 [require]
       38 GETTABLEKS                       R6 R0 K9 ["Parent"]
       40 GETTABLEKS                       R6 R6 K14 ["React"]
       42 CALL                             R5 1 1
       43 GETIMPORT                        R6 K5 [require]
       45 GETTABLEKS                       R7 R0 K6 ["Components"]
       47 GETTABLEKS                       R7 R7 K7 ["Contexts"]
       49 GETTABLEKS                       R7 R7 K15 ["SessionIdContext"]
       51 CALL                             R6 1 1
       52 GETIMPORT                        R7 K5 [require]
       54 GETTABLEKS                       R8 R0 K6 ["Components"]
       56 GETTABLEKS                       R8 R8 K7 ["Contexts"]
