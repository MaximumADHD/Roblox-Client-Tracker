PROTO_0:
       ...
       30 GETUPVAL                         R3 0
       31 CALL                             R3 0 1
       32 LOADK                            R5 K9 ["Error loading image: %*"]
       ...
       40 CALL                             R5 2 1
       41 NAMECALL                         R3 R3 K3 ["addText"]
       43 CALL                             R3 2 1
       44 LOADB                            R5 1
       45 NAMECALL                         R3 R3 K4 ["setError"]
       47 CALL                             R3 2 1
       48 NAMECALL                         R3 R3 K5 ["build"]
       50 CALL                             R3 1 -1
       51 RETURN                           R3 -1
       52 GETUPVAL                         R3 2
       53 GETTABLEKS                       R3 R3 K13 ["storeImage"]
       55 MOVE                             R4 R2
       56 CALL                             R3 1 1
       57 GETUPVAL                         R4 0
       58 CALL                             R4 0 1
       59 MOVE                             R6 R3
       60 NAMECALL                         R4 R4 K3 ["addText"]
       62 CALL                             R4 2 1
       63 NAMECALL                         R4 R4 K5 ["build"]
       65 CALL                             R4 1 -1
       66 RETURN                           R4 -1
...
PROTO_1:
       ...
       23 DUPTABLE                         R5 K12 [{["type"] = "string", ["description"] = "Absolute path to a local image file (png, jpg, or jpeg)."}]
       24 NAMECALL                         R2 R2 K13 ["addArgument"]
       26 CALL                             R2 3 1
       27 DUPTABLE                         R4 K21 [{["title"] = "Store Image", ["readOnlyHint"] = False, ["destructiveHint"] = False, ["idempotentHint"] = False, ["openWorldHint"] = False}]
       ...
       37 CALL                             R2 1 1
       38 DUPTABLE                         R3 K26 [{"definition"}]
       39 SETTABLEKS                       R2 R3 K25 ["definition"]
       41 RETURN                           R3 1
