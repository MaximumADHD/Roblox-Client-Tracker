...
PROTO_3:
       ...
       18 GETUPVAL                         R3 0
       19 GETTABLEKS                       R3 R3 K7 ["FFlagAssistantAskInputTool"]
       21 JUMPIFNOT                        R3 ; [+17]
       22 FASTCALL1                        TYPEOF R2 ; [+3]
       23 MOVE                             R6 R2
       24 GETIMPORT                        R5 K1 [typeof]
       26 CALL                             R5 1 1
       27 JUMPIFEQKS                       R5 K2 ["table"] ; [+2]
       29 LOADB                            R4 0 +1
       30 LOADB                            R4 1
       31 FASTCALL2K                       ASSERT R4 K8 ; [+4]
       33 LOADK                            R5 K8 ["parts must be a table"]
       ...
       40 MOVE                             R6 R2
       41 GETIMPORT                        R5 K1 [typeof]
       43 CALL                             R5 1 1
       44 JUMPIFEQKS                       R5 K9 ["string"] ; [+2]
       46 LOADB                            R4 0 +1
       47 LOADB                            R4 1
       48 FASTCALL2K                       ASSERT R4 K10 ; [+4]
       50 LOADK                            R5 K10 ["parts must be a comma-separated string of part names"]
       51 GETIMPORT                        R3 K5 [assert]
       53 CALL                             R3 2 0
       54 GETUPVAL                         R3 1
       55 MOVE                             R4 R2
       56 CALL                             R3 1 1
       ...
       62 LOADB                            R4 0 +1
       63 LOADB                            R4 1
       64 LOADK                            R5 K11 ["parts must contain at least %* entries"]
       65 LOADN                            R7 2
       66 NAMECALL                         R5 R5 K12 ["format"]
       68 CALL                             R5 2 1
       69 FASTCALL2                        ASSERT R4 R5 ; [+3]
       71 GETIMPORT                        R3 K5 [assert]
       73 CALL                             R3 2 0
       74 GETUPVAL                         R3 0
       75 GETTABLEKS                       R3 R3 K13 ["FIntAssistantSegmentMeshMaxUserParts"]
       77 LENGTH                           R6 R1
       78 JUMPIFLE                         R6 R3 ; [+2]
       80 LOADB                            R5 0 +1
       81 LOADB                            R5 1
       82 LOADK                            R6 K14 ["parts must contain at most %* entries"]
       83 MOVE                             R8 R3
       84 NAMECALL                         R6 R6 K12 ["format"]
       86 CALL                             R6 2 1
       87 FASTCALL2                        ASSERT R5 R6 ; [+3]
       89 GETIMPORT                        R4 K5 [assert]
       91 CALL                             R4 2 0
       92 GETTABLEKS                       R4 R0 K15 ["isManualRun"]
       94 JUMPIFEQKNIL                     R4 ; [+16]
       96 FASTCALL1                        TYPEOF R4 ; [+3]
       97 MOVE                             R8 R4
       98 GETIMPORT                        R7 K1 [typeof]
      100 CALL                             R7 1 1
      101 JUMPIFEQKS                       R7 K16 ["boolean"] ; [+2]
      103 LOADB                            R6 0 +1
      104 LOADB                            R6 1
      105 FASTCALL2K                       ASSERT R6 K17 ; [+4]
      107 LOADK                            R7 K17 ["isManualRun must be a boolean"]
      108 GETIMPORT                        R5 K5 [assert]
      110 CALL                             R5 2 0
      111 GETTABLEKS                       R5 R0 K18 ["selectedInstanceRef"]
      113 LOADNIL                          R6
      114 JUMPIFEQKNIL                     R5 ; [+34]
      116 FASTCALL1                        TYPEOF R5 ; [+3]
      117 MOVE                             R10 R5
      118 GETIMPORT                        R9 K1 [typeof]
      120 CALL                             R9 1 1
      121 JUMPIFEQKS                       R9 K2 ["table"] ; [+2]
      123 LOADB                            R8 0 +1
      124 LOADB                            R8 1
      125 FASTCALL2K                       ASSERT R8 K19 ; [+4]
      127 LOADK                            R9 K19 ["selectedInstanceRef must be a table"]
      128 GETIMPORT                        R7 K5 [assert]
      130 CALL                             R7 2 0
      131 GETTABLEKS                       R10 R5 K20 ["uniqueId"]
      133 FASTCALL1                        TYPEOF R10 ; [+2]
      134 GETIMPORT                        R9 K1 [typeof]
      136 CALL                             R9 1 1
      137 JUMPIFEQKS                       R9 K9 ["string"] ; [+2]
      139 LOADB                            R8 0 +1
      140 LOADB                            R8 1
      141 FASTCALL2K                       ASSERT R8 K21 ; [+4]
      143 LOADK                            R9 K21 ["selectedInstanceRef.uniqueId must be a string"]
      144 GETIMPORT                        R7 K5 [assert]
      146 CALL                             R7 2 0
      147 GETTABLEKS                       R6 R5 K20 ["uniqueId"]
      149 JUMPIFNOTEQKNIL                  R6 ; [+2]
      151 LOADB                            R8 0 +1
      152 LOADB                            R8 1
      153 FASTCALL2K                       ASSERT R8 K22 ; [+4]
      155 LOADK                            R9 K22 ["selectedInstanceRef must be provided — mesh segmentation requires a source MeshPart or Model"]
      156 GETIMPORT                        R7 K5 [assert]
      158 CALL                             R7 2 0
      159 DUPTABLE                         R7 K25 [{"partNames", "isManualRun", "selectedUniqueId"}]
      160 SETTABLEKS                       R1 R7 K23 ["partNames"]
      162 SETTABLEKS                       R4 R7 K15 ["isManualRun"]
      164 SETTABLEKS                       R6 R7 K24 ["selectedUniqueId"]
      166 RETURN                           R7 1
...
PROTO_20:
       ...
       41 CALL                             R4 3 1
       42 LOADK                            R6 K14 ["selectedInstanceRef"]
       43 DUPTABLE                         R7 K19 [{["type"] = "object", ["description"] = "The source mesh: an InstanceRef pointing to a MeshPart or to a Model containing the mesh to segment.", ["properties"], ["required"]}]
       44 DUPTABLE                         R8 K21 [{"uniqueId"}]
       45 DUPTABLE                         R9 K23 [{["type"] = "string", ["description"] = "Unique instance id of the source MeshPart or Model."}]
       46 SETTABLEKS                       R9 R8 K20 ["uniqueId"]
       48 SETTABLEKS                       R8 R7 K17 ["properties"]
       50 NEWTABLE                         R8 0 1
       52 LOADK                            R9 K20 ["uniqueId"]
       53 SETLIST                          R8 R9 1 [1]
       55 SETTABLEKS                       R8 R7 K18 ["required"]
       57 NAMECALL                         R4 R4 K13 ["addArgument"]
       59 CALL                             R4 3 1
       60 DUPTABLE                         R6 K31 [{["title"] = "Mesh Segmentation", ["readOnlyHint"] = False, ["destructiveHint"] = False, ["idempotentHint"] = False, ["openWorldHint"] = False}]
       61 NAMECALL                         R4 R4 K32 ["setAnnotations"]
       63 CALL                             R4 2 1
       64 MOVE                             R6 R2
       65 NAMECALL                         R4 R4 K33 ["setHandler"]
       67 CALL                             R4 2 1
       68 NAMECALL                         R4 R4 K34 ["build"]
       70 CALL                             R4 1 1
       71 NEWCLOSURE                       R5 P2
       72 CAPTURE                          VAL R0
       73 CAPTURE                          UPVAL U8
       ...
       81 LOADK                            R6 K35 [""]
       82 DUPTABLE                         R7 K42 [{["command"] = "segment_mesh", ["getDescription"], ["runToolChain"], ["mapToToolCall"], ["getInputRequestArguments"]}]
       83 DUPCLOSURE                       R8 K43 [PROTO_12]
       84 CAPTURE                          UPVAL U14
       85 SETTABLEKS                       R8 R7 K38 ["getDescription"]
       87 GETUPVAL                         R9 5
       88 GETTABLEKS                       R9 R9 K44 ["FFlagAssistantAskInputTool"]
       90 JUMPIFNOT                        R9 ; [+2]
       91 MOVE                             R8 R5
       92 JUMP                             ; [+1]
       93 LOADNIL                          R8
       94 SETTABLEKS                       R8 R7 K39 ["runToolChain"]
       96 GETUPVAL                         R9 5
       97 GETTABLEKS                       R9 R9 K44 ["FFlagAssistantAskInputTool"]
       99 JUMPIFNOT                        R9 ; [+2]
      100 LOADNIL                          R8
      101 JUMP                             ; [+3]
      102 NEWCLOSURE                       R8 P4
      103 CAPTURE                          REF R6
      104 CAPTURE                          UPVAL U7
      105 SETTABLEKS                       R8 R7 K40 ["mapToToolCall"]
      107 NEWCLOSURE                       R8 P5
      108 CAPTURE                          VAL R0
      ...
      114 SETTABLEKS                       R8 R7 K41 ["getInputRequestArguments"]
      116 DUPTABLE                         R8 K49 [{"definition", "slashCommands", "getPreExecuteWarning", "toolCallOptions"}]
      117 SETTABLEKS                       R4 R8 K45 ["definition"]
      119 GETUPVAL                         R10 5
      120 GETTABLEKS                       R10 R10 K50 ["FFlagAssistantSegmentMeshTool"]
      122 JUMPIFNOT                        R10 ; [+6]
      123 NEWTABLE                         R9 0 1
      125 MOVE                             R10 R7
      ...
      128 JUMP                             ; [+1]
      129 LOADNIL                          R9
      130 SETTABLEKS                       R9 R8 K46 ["slashCommands"]
      132 DUPCLOSURE                       R9 K51 [PROTO_19]
      133 SETTABLEKS                       R9 R8 K47 ["getPreExecuteWarning"]
      135 DUPTABLE                         R9 K54 [{["resetTimeoutOnProgress"] = True}]
      136 SETTABLEKS                       R9 R8 K48 ["toolCallOptions"]
      138 CLOSEUPVALS                      R6
      139 RETURN                           R8 1
...
MAIN:
       ...
       78 GETTABLEKS                       R12 R0 K10 ["Util"]
       80 GETTABLEKS                       R12 R12 K26 ["SegmentMesh"]
       82 GETTABLEKS                       R12 R12 K27 ["SegmentMeshTypes"]
       84 CALL                             R11 1 1
       85 GETTABLEKS                       R12 R5 K10 ["Util"]
       87 GETTABLEKS                       R12 R12 K28 ["ToolBuilder"]
       89 GETTABLEKS                       R13 R5 K10 ["Util"]
       91 GETTABLEKS                       R13 R13 K29 ["ToolResult"]
       93 GETTABLEKS                       R14 R7 K30 ["ToolNames"]
       95 GETTABLEKS                       R15 R2 K31 ["INPUT_TYPE"]
       97 GETTABLEKS                       R16 R2 K32 ["RULE_KIND"]
       99 GETTABLEKS                       R17 R2 K33 ["asRule"]
      101 GETTABLEKS                       R18 R6 K34 ["Configs"]
      103 GETTABLEKS                       R18 R18 K26 ["SegmentMesh"]
      105 GETTABLEKS                       R19 R18 K35 ["row"]
      107 DUPCLOSURE                       R20 K36 [PROTO_0]
      108 CAPTURE                          VAL R1
      109 DUPCLOSURE                       R21 K37 [PROTO_1]
      110 DUPCLOSURE                       R22 K38 [PROTO_2]
      111 CAPTURE                          VAL R4
      112 DUPCLOSURE                       R23 K39 [PROTO_3]
      113 CAPTURE                          VAL R4
      114 CAPTURE                          VAL R21
      115 DUPCLOSURE                       R24 K40 [PROTO_20]
      116 CAPTURE                          VAL R23
      117 CAPTURE                          VAL R1
      118 CAPTURE                          VAL R11
      119 CAPTURE                          VAL R8
