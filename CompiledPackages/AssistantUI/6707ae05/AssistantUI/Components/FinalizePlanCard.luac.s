...
PROTO_14:
       ...
       19 JUMP                             ; [+1]
       20 LOADK                            R1 K3 [""]
       21 LOADK                            R7 K4 ["The user saved edits to the plan markdown. If the changes affect the task breakdown, call `%*` with the planId and a regenerated todo list. If the edits are cosmetic (typos, formatting), no action is needed."]
       22 GETUPVAL                         R9 6
       23 GETTABLEKS                       R9 R9 K5 ["UpdatePlan"]
       25 NAMECALL                         R7 R7 K2 ["format"]
       27 CALL                             R7 2 1
       28 MOVE                             R3 R7
       29 MOVE                             R4 R1
       ...
       32 CONCAT                           R2 R3 R6
       33 GETUPVAL                         R3 2
       34 DUPTABLE                         R4 K10 [{["text"], ["hidden"] = True}]
       35 GETUPVAL                         R5 7
       36 MOVE                             R6 R2
       37 CALL                             R5 1 1
       38 SETTABLEKS                       R5 R4 K7 ["text"]
       40 CALL                             R3 1 0
       41 GETUPVAL                         R0 8
       42 LOADB                            R1 0
       43 CALL                             R0 1 0
