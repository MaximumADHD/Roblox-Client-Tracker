...
PROTO_5:
       ...
       16 CALL                             R0 0 0
       17 GETUPVAL                         R0 6
       18 GETTABLEKS                       R0 R0 K2 ["useRef"]
       20 LOADNIL                          R1
       21 CALL                             R0 1 1
       22 GETUPVAL                         R1 6
       23 GETTABLEKS                       R1 R1 K3 ["useCallback"]
       25 NEWCLOSURE                       R2 P0
       26 CAPTURE                          VAL R0
       27 NEWTABLE                         R3 0 0
       29 CALL                             R1 2 1
       30 GETUPVAL                         R3 0
       31 GETTABLEKS                       R3 R3 K4 ["FFlagAssistantFeedbackView"]
       33 JUMPIFNOT                        R3 ; [+8]
       34 GETUPVAL                         R2 6
       35 GETTABLEKS                       R2 R2 K5 ["useContext"]
       37 GETUPVAL                         R3 7
       38 GETTABLEKS                       R3 R3 K6 ["Context"]
       40 CALL                             R2 1 1
       41 JUMP                             ; [+1]
       42 LOADNIL                          R2
       43 JUMPIFNOT                        R2 ; [+3]
       44 GETTABLEKS                       R3 R2 K7 ["feedbackRequest"]
       46 JUMP                             ; [+1]
       47 LOADNIL                          R3
       48 DUPTABLE                         R4 K10 [{"chatHistoryInterfaceRef", "onMessageSent", "feedbackRequest"}]
       49 SETTABLEKS                       R0 R4 K8 ["chatHistoryInterfaceRef"]
       51 SETTABLEKS                       R1 R4 K9 ["onMessageSent"]
       53 SETTABLEKS                       R3 R4 K7 ["feedbackRequest"]
       55 RETURN                           R4 1
...
PROTO_7:
        ...
        2 GETUPVAL                         R1 0
        3 GETUPVAL                         R2 1
        4 GETTABLEKS                       R2 R2 K0 ["Provider"]
        6 CALL                             R1 1 1
        7 GETUPVAL                         R2 0
        8 GETUPVAL                         R3 2
        9 GETTABLEKS                       R3 R3 K0 ["Provider"]
       11 CALL                             R2 1 1
       12 GETUPVAL                         R3 0
       13 GETUPVAL                         R4 3
       14 GETTABLEKS                       R4 R4 K0 ["Provider"]
       16 CALL                             R3 1 1
       17 GETUPVAL                         R4 0
       18 GETUPVAL                         R5 4
       19 GETTABLEKS                       R5 R5 K0 ["Provider"]
       21 CALL                             R4 1 1
       22 GETUPVAL                         R5 0
       23 GETUPVAL                         R6 5
       24 GETTABLEKS                       R6 R6 K0 ["Provider"]
       26 CALL                             R5 1 -1
       27 SETLIST                          R0 R1 -1 [1]
       29 GETUPVAL                         R1 6
       30 GETTABLEKS                       R1 R1 K1 ["FFlagAssistantExternalInterface"]
       32 JUMPIFNOT                        R1 ; [+10]
       33 MOVE                             R2 R0
       34 GETUPVAL                         R3 0
       35 GETUPVAL                         R4 7
       36 GETTABLEKS                       R4 R4 K0 ["Provider"]
       38 CALL                             R3 1 -1
...
MAIN:
      ...
      192 GETTABLEKS                       R25 R25 K34 ["useRefreshQuotaOnTurnEnd"]
      194 CALL                             R24 1 1
      195 GETIMPORT                        R25 K5 [require]
      197 GETTABLEKS                       R26 R0 K12 ["Hooks"]
      199 GETTABLEKS                       R26 R26 K35 ["useRemoveUnfocusedNewThread"]
      201 CALL                             R25 1 1
      202 GETIMPORT                        R26 K5 [require]
      204 GETTABLEKS                       R27 R0 K12 ["Hooks"]
      206 GETTABLEKS                       R27 R27 K36 ["useShowSessionConversation"]
      208 CALL                             R26 1 1
      209 GETIMPORT                        R27 K5 [require]
      211 GETTABLEKS                       R28 R0 K12 ["Hooks"]
      213 GETTABLEKS                       R28 R28 K37 ["useSwitchThread"]
      215 CALL                             R27 1 1
      216 GETIMPORT                        R28 K5 [require]
      218 GETTABLEKS                       R29 R0 K12 ["Hooks"]
      220 GETTABLEKS                       R29 R29 K38 ["useTrackThreadViewedAt"]
      222 CALL                             R28 1 1
      223 GETIMPORT                        R29 K5 [require]
      225 GETTABLEKS                       R30 R0 K39 ["FlagUtils"]
      227 CALL                             R29 1 1
      228 GETIMPORT                        R30 K5 [require]
      230 GETTABLEKS                       R31 R0 K40 ["Flags"]
      232 CALL                             R30 1 1
      233 GETIMPORT                        R31 K5 [require]
      235 GETTABLEKS                       R32 R0 K6 ["Components"]
      237 GETTABLEKS                       R32 R32 K41 ["PersistentPlanPanel"]
      239 CALL                             R31 1 1
      240 GETTABLEKS                       R32 R29 K42 ["getIsCreditMeteringEnabled"]
      242 GETTABLEKS                       R33 R29 K43 ["getShouldRestoreMostRecentThread"]
      244 GETTABLEKS                       R34 R8 K44 ["Divider"]
      246 GETTABLEKS                       R35 R8 K45 ["View"]
      248 GETTABLEKS                       R36 R16 K46 ["createNextOrder"]
      250 GETTABLEKS                       R37 R15 K47 ["createElement"]
      252 DUPCLOSURE                       R38 K48 [PROTO_2]
      253 CAPTURE                          VAL R15
      254 CAPTURE                          VAL R4
      255 CAPTURE                          VAL R27
      256 CAPTURE                          VAL R17
      257 CAPTURE                          VAL R20
      258 CAPTURE                          VAL R21
      259 DUPCLOSURE                       R39 K49 [PROTO_3]
      260 CAPTURE                          VAL R15
      261 CAPTURE                          VAL R11
      262 CAPTURE                          VAL R36
      263 CAPTURE                          VAL R37
      ...
      266 CAPTURE                          VAL R10
      267 CAPTURE                          VAL R30
      268 DUPCLOSURE                       R40 K50 [PROTO_5]
      269 CAPTURE                          VAL R30
      270 CAPTURE                          VAL R5
      271 CAPTURE                          VAL R25
      272 CAPTURE                          VAL R28
      ...
      275 CAPTURE                          VAL R15
      276 CAPTURE                          VAL R6
      277 DUPCLOSURE                       R41 K51 [PROTO_6]
      278 CAPTURE                          VAL R37
      279 CAPTURE                          VAL R2
      280 CAPTURE                          VAL R13
      281 CAPTURE                          VAL R14
      ...
      284 CAPTURE                          VAL R30
      285 CAPTURE                          VAL R19
      286 DUPCLOSURE                       R42 K52 [PROTO_7]
      287 CAPTURE                          VAL R37
      288 CAPTURE                          VAL R1
      289 CAPTURE                          VAL R2
      290 CAPTURE                          VAL R13
      ...
      293 CAPTURE                          VAL R30
      294 CAPTURE                          VAL R19
      295 DUPCLOSURE                       R43 K53 [PROTO_8]
      296 CAPTURE                          VAL R36
      297 CAPTURE                          VAL R30
      298 CAPTURE                          VAL R23
      299 CAPTURE                          VAL R22
      ...
      307 CAPTURE                          VAL R7
      308 CAPTURE                          VAL R39
      309 DUPCLOSURE                       R44 K54 [PROTO_9]
      310 CAPTURE                          VAL R26
      311 CAPTURE                          VAL R37
      312 CAPTURE                          VAL R18
      313 DUPCLOSURE                       R45 K55 [PROTO_10]
      314 CAPTURE                          VAL R15
      315 CAPTURE                          VAL R18
      316 CAPTURE                          VAL R37
      317 CAPTURE                          VAL R43
      318 DUPCLOSURE                       R46 K56 [PROTO_11]
      319 CAPTURE                          VAL R40
      320 CAPTURE                          VAL R38
      321 CAPTURE                          VAL R37
      322 CAPTURE                          VAL R16
      323 CAPTURE                          VAL R42
      324 CAPTURE                          VAL R43
      325 DUPCLOSURE                       R47 K57 [PROTO_12]
      326 CAPTURE                          VAL R40
      327 CAPTURE                          VAL R15
      328 CAPTURE                          VAL R1
      329 CAPTURE                          VAL R37
      ...
      332 CAPTURE                          VAL R44
      333 CAPTURE                          VAL R45
      334 DUPCLOSURE                       R48 K58 [PROTO_13]
      335 CAPTURE                          VAL R33
      336 CAPTURE                          VAL R37
      337 CAPTURE                          VAL R47
      338 CAPTURE                          VAL R46
