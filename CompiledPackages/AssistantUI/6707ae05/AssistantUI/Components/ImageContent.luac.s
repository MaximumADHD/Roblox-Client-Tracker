...
PROTO_3:
        ...
        9 JUMPIFNOTEQKS                    R0 K2 ["error"] ; [+22]
       11 GETUPVAL                         R0 1
       ...
       23 LOADK                            R1 K9 ["Failed to convert image data to temp ID: %*"]
       24 GETUPVAL                         R3 0
       25 GETTABLEKS                       R3 R3 K10 ["problem"]
       27 NAMECALL                         R1 R1 K11 ["format"]
       29 CALL                             R1 2 1
       30 CALL                             R0 1 0
       31 RETURN                           R0 0
       32 GETUPVAL                         R0 0
       33 GETTABLEKS                       R0 R0 K12 ["value"]
       35 GETUPVAL                         R1 1
       36 GETTABLEKS                       R2 R0 K13 ["tempId"]
       38 CALL                             R1 1 0
       39 GETUPVAL                         R1 2
       40 GETIMPORT                        R2 K6 [Vector2.new]
       42 GETTABLEKS                       R3 R0 K14 ["width"]
       44 GETTABLEKS                       R4 R0 K15 ["height"]
       46 CALL                             R2 2 -1
       47 CALL                             R1 -1 0
       48 NEWCLOSURE                       R1 P0
       49 CAPTURE                          UPVAL U3
