...
PROTO_6:
       ...
       16 LOADK                            R2 K4 ["[Remote ACP] service select useRemoteService=%* flag=%* hasRemoteDeps=%*"]
       ...
       27 CALL                             R5 -1 1
       28 GETUPVAL                         R8 1
       29 GETTABLEKS                       R8 R8 K0 ["remoteDeps"]
       31 JUMPIFNOTEQKNIL                  R8 ; [+2]
       33 LOADB                            R7 0 +1
       34 LOADB                            R7 1
       35 FASTCALL1                        TOSTRING R7 ; [+2]
       36 GETIMPORT                        R6 K6 [tostring]
       38 CALL                             R6 1 1
       ...
       46 JUMP                             ; [+5]
       47 GETUPVAL                         R1 3
       48 GETTABLEKS                       R1 R1 K8 ["listTools"]
       50 DUPTABLE                         R2 K13 [{["useInternalToolDefinitions"] = False, ["includeDisabledTools"] = True}]
       51 CALL                             R1 1 1
       52 GETUPVAL                         R2 4
       53 JUMPIFNOT                        R2 ; [+9]
       54 GETUPVAL                         R2 2
       55 GETTABLEKS                       R2 R2 K1 ["FFlagDebugLogAssistantUI"]
       57 JUMPIFNOT                        R2 ; [+4]
       58 GETIMPORT                        R2 K3 [print]
       60 LOADK                            R3 K14 ["[Remote ACP] abort service create; effect disposed"]
       61 CALL                             R2 1 0
       62 RETURN                           R0 0
       63 GETUPVAL                         R2 5
       64 MOVE                             R3 R0
       65 GETUPVAL                         R4 1
       66 GETTABLEKS                       R4 R4 K0 ["remoteDeps"]
       68 DUPTABLE                         R5 K18 [{"turn", "toolCatalog", "persistence"}]
       69 GETUPVAL                         R6 6
       70 GETUPVAL                         R7 7
       71 CALL                             R6 1 1
       72 SETTABLEKS                       R6 R5 K15 ["turn"]
       74 SETTABLEKS                       R1 R5 K16 ["toolCatalog"]
       76 GETUPVAL                         R6 1
       77 GETTABLEKS                       R6 R6 K17 ["persistence"]
       79 SETTABLEKS                       R6 R5 K17 ["persistence"]
       81 CALL                             R2 3 1
       82 GETUPVAL                         R3 8
       83 GETTABLEKS                       R3 R3 K19 ["new"]
       85 GETTABLEKS                       R4 R2 K20 ["client"]
       87 GETUPVAL                         R5 9
       88 GETTABLEKS                       R5 R5 K21 ["get"]
       90 CALL                             R5 0 1
       91 GETTABLEKS                       R5 R5 K22 ["EventLogger"]
       93 GETUPVAL                         R6 7
       94 GETTABLEKS                       R6 R6 K23 ["getToolCallMeta"]
       96 CALL                             R3 3 1
       97 SETUPVAL                         R3 10
       98 GETUPVAL                         R6 11
       99 GETUPVAL                         R7 7
      100 CALL                             R6 1 -1
      101 NAMECALL                         R4 R3 K24 ["setClientToolHandler"]
      103 CALL                             R4 -1 0
      104 NEWCLOSURE                       R6 P0
      105 CAPTURE                          UPVAL U3
      106 NAMECALL                         R4 R3 K25 ["setListTools"]
      108 CALL                             R4 2 0
      109 DUPTABLE                         R4 K29 [{"bundle", "service", "resolveAllowedTools"}]
      110 SETTABLEKS                       R2 R4 K26 ["bundle"]
      112 SETTABLEKS                       R3 R4 K27 ["service"]
      114 NEWCLOSURE                       R5 P1
      115 CAPTURE                          UPVAL U3
      116 SETTABLEKS                       R5 R4 K28 ["resolveAllowedTools"]
      118 SETUPVAL                         R4 12
      119 GETUPVAL                         R4 2
      120 GETTABLEKS                       R4 R4 K1 ["FFlagDebugLogAssistantUI"]
      122 JUMPIFNOT                        R4 ; [+4]
      123 GETIMPORT                        R4 K3 [print]
      125 LOADK                            R5 K30 ["[Remote ACP] ACPClientService ready"]
      126 CALL                             R4 1 0
      127 GETUPVAL                         R4 13
      128 GETUPVAL                         R5 12
      129 CALL                             R4 1 0
