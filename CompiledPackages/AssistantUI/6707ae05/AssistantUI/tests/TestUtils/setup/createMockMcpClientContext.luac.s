...
PROTO_4:
        0 GETUPVAL                         R1 0
        1 CALL                             R1 0 1
        2 LOADK                            R3 K0 ["%* executed"]
        3 GETUPVAL                         R5 1
        4 GETTABLEKS                       R5 R5 K1 ["name"]
        6 NAMECALL                         R3 R3 K2 ["format"]
        8 CALL                             R3 2 1
        9 NAMECALL                         R1 R1 K3 ["addText"]
       11 CALL                             R1 2 1
       12 NAMECALL                         R1 R1 K4 ["build"]
       14 CALL                             R1 1 -1
       15 RETURN                           R1 -1
...
PROTO_6:
       ...
       30 LOADK                            R7 K9 ["No handler found for tool: %*"]
       31 MOVE                             R9 R3
       32 NAMECALL                         R7 R7 K10 ["format"]
       34 CALL                             R7 2 1
       35 FASTCALL2                        ASSERT R4 R7 ; [+4]
       37 MOVE                             R6 R4
       38 GETIMPORT                        R5 K3 [assert]
       40 CALL                             R5 2 0
       41 MOVE                             R5 R4
       42 GETTABLEKS                       R6 R2 K11 ["arguments"]
       44 LOADNIL                          R7
       45 MOVE                             R8 R1
       46 CALL                             R5 3 -1
       47 RETURN                           R5 -1
