...
PROTO_16:
       ...
       17 CAPTURE                          VAL R0
       18 CAPTURE                          VAL R2
       19 NEWCLOSURE                       R13 P2
       20 CAPTURE                          REF R3
       21 CAPTURE                          REF R4
       22 CAPTURE                          REF R5
       23 CAPTURE                          REF R6
       24 CAPTURE                          REF R7
       25 NEWCLOSURE                       R14 P3
       26 CAPTURE                          REF R3
       27 CAPTURE                          REF R4
       28 CAPTURE                          VAL R12
       29 CAPTURE                          VAL R0
       30 DUPTABLE                         R15 K6 [{"cancelSessionPrompt", "getStateOfSessionPrompt"}]
       31 SETTABLEKS                       R14 R15 K4 ["cancelSessionPrompt"]
       33 SETTABLEKS                       R13 R15 K5 ["getStateOfSessionPrompt"]
       35 GETUPVAL                         R16 0
       36 GETTABLEKS                       R16 R16 K7 ["new"]
       38 NEWCLOSURE                       R17 P4
       39 CAPTURE                          VAL R0
       40 CAPTURE                          UPVAL U1
       41 CAPTURE                          UPVAL U2
       42 CAPTURE                          VAL R1
       ...
       55 CAPTURE                          UPVAL U6
       56 CALL                             R16 1 1
       57 DUPTABLE                         R17 K10 [{"promise", "cancelSessionPrompt", "getStateOfSessionPrompt", "getRequestMessageId"}]
       58 SETTABLEKS                       R16 R17 K8 ["promise"]
       60 SETTABLEKS                       R14 R17 K4 ["cancelSessionPrompt"]
       62 SETTABLEKS                       R13 R17 K5 ["getStateOfSessionPrompt"]
       64 NEWCLOSURE                       R18 P5
       65 CAPTURE                          REF R8
       66 SETTABLEKS                       R18 R17 K9 ["getRequestMessageId"]
       68 CLOSEUPVALS                      R3
       69 RETURN                           R17 1
...
MAIN:
       ...
       72 DUPCLOSURE                       R10 K18 [PROTO_0]
       73 CAPTURE                          VAL R6
       74 CAPTURE                          VAL R9
       75 CAPTURE                          VAL R8
       76 DUPCLOSURE                       R11 K19 [PROTO_1]
       77 CAPTURE                          VAL R10
       78 CAPTURE                          VAL R9
       79 DUPCLOSURE                       R12 K20 [PROTO_2]
       80 DUPCLOSURE                       R13 K21 [PROTO_16]
       81 CAPTURE                          VAL R7
       82 CAPTURE                          VAL R9
       83 CAPTURE                          VAL R8
       84 CAPTURE                          VAL R4
