PROTO_0:
        ...
        9 CALL                             R1 2 0
       10 LOADK                            R1 K3 ["createInstanceBridge_%*"]
       11 MOVE                             R3 R0
...
PROTO_3:
       ...
       22 GETTABLEKS                       R5 R3 K8 ["onTagChanged"]
       24 MOVE                             R6 R2
       25 MOVE                             R7 R4
       26 CALL                             R5 2 -1
       27 RETURN                           R5 -1
...
PROTO_6:
        0 DUPTABLE                         R2 K2 [{"onTagChanged", "toTarget"}]
        1 NEWCLOSURE                       R3 P0
        2 CAPTURE                          UPVAL U0
        3 CAPTURE                          VAL R0
        4 CAPTURE                          VAL R1
        5 SETTABLEKS                       R3 R2 K0 ["onTagChanged"]
        7 NEWCLOSURE                       R3 P1
        8 CAPTURE                          UPVAL U1
        9 CAPTURE                          VAL R1
...
PROTO_7:
        ...
        5 CAPTURE                          VAL R1
        6 GETUPVAL                         R10 0
        7 GETTABLEKS                       R9 R10 K1 ["onTagChanged"]
        9 FASTCALL2K                       ASSERT R9 K2 ; [+4]
       11 LOADK                            R10 K2 ["Invalid network key: onTagChanged"]
       12 GETIMPORT                        R8 K4 [assert]
       14 CALL                             R8 2 0
       15 LOADK                            R7 K5 ["createInstanceBridge_onTagChanged"]
       16 NEWCLOSURE                       R8 P1
       17 CAPTURE                          VAL R2
       18 CAPTURE                          VAL R0
       19 CAPTURE                          VAL R1
...
PROTO_10:
       ...
       19 CALL                             R7 2 1
       20 SETTABLEKS                       R7 R4 K5 ["bridge"]
       22 GETTABLEKS                       R5 R3 K8 ["observeTag"]
       24 MOVE                             R6 R2
       25 MOVE                             R7 R4
       26 CALL                             R5 2 -1
       27 RETURN                           R5 -1
...
PROTO_11:
       ...
       19 CALL                             R7 2 1
       20 SETTABLEKS                       R7 R4 K5 ["bridge"]
       22 GETTABLEKS                       R5 R3 K8 ["unobserveTag"]
       24 MOVE                             R6 R2
       25 MOVE                             R7 R4
       26 CALL                             R5 2 -1
       27 RETURN                           R5 -1
...
PROTO_12:
       ...
       19 CALL                             R7 2 1
       20 SETTABLEKS                       R7 R4 K5 ["bridge"]
       22 GETTABLEKS                       R5 R3 K8 ["selectTaggedInstances"]
       24 MOVE                             R6 R2
       25 MOVE                             R7 R4
       26 CALL                             R5 2 -1
       27 RETURN                           R5 -1
...
PROTO_17:
        0 DUPTABLE                         R2 K4 [{"observeTag", "unobserveTag", "selectTaggedInstances", "toTarget"}]
        1 NEWCLOSURE                       R3 P0
        2 CAPTURE                          UPVAL U0
        3 CAPTURE                          VAL R0
        4 CAPTURE                          VAL R1
        5 SETTABLEKS                       R3 R2 K0 ["observeTag"]
        7 NEWCLOSURE                       R3 P1
        8 CAPTURE                          UPVAL U1
        9 CAPTURE                          VAL R0
       10 CAPTURE                          VAL R1
       11 SETTABLEKS                       R3 R2 K1 ["unobserveTag"]
       13 NEWCLOSURE                       R3 P2
       14 CAPTURE                          UPVAL U2
       15 CAPTURE                          VAL R0
       16 CAPTURE                          VAL R1
       17 SETTABLEKS                       R3 R2 K2 ["selectTaggedInstances"]
       19 NEWCLOSURE                       R3 P3
       20 CAPTURE                          UPVAL U3
       21 CAPTURE                          VAL R1
...
PROTO_18:
        ...
        5 CAPTURE                          VAL R1
        6 GETUPVAL                         R10 0
        7 GETTABLEKS                       R9 R10 K1 ["observeTag"]
        9 FASTCALL2K                       ASSERT R9 K2 ; [+4]
       11 LOADK                            R10 K2 ["Invalid network key: observeTag"]
       12 GETIMPORT                        R8 K4 [assert]
       14 CALL                             R8 2 0
       15 LOADK                            R7 K5 ["createInstanceBridge_observeTag"]
       16 NEWCLOSURE                       R8 P1
       17 CAPTURE                          VAL R2
       18 CAPTURE                          VAL R0
       19 CAPTURE                          VAL R1
       ...
       22 CALL                             R5 3 1
       23 GETUPVAL                         R11 0
       24 GETTABLEKS                       R10 R11 K7 ["unobserveTag"]
       26 FASTCALL2K                       ASSERT R10 K8 ; [+4]
       28 LOADK                            R11 K8 ["Invalid network key: unobserveTag"]
       29 GETIMPORT                        R9 K4 [assert]
       31 CALL                             R9 2 0
       32 LOADK                            R8 K9 ["createInstanceBridge_unobserveTag"]
       33 NEWCLOSURE                       R9 P2
       34 CAPTURE                          VAL R2
       35 CAPTURE                          VAL R0
       36 CAPTURE                          VAL R1
       ...
       39 CALL                             R6 3 1
       40 GETUPVAL                         R12 0
       41 GETTABLEKS                       R11 R12 K10 ["selectTaggedInstances"]
       43 FASTCALL2K                       ASSERT R11 K11 ; [+4]
       45 LOADK                            R12 K11 ["Invalid network key: selectTaggedInstances"]
       46 GETIMPORT                        R10 K4 [assert]
       48 CALL                             R10 2 0
       49 LOADK                            R9 K12 ["createInstanceBridge_selectTaggedInstances"]
...
PROTO_23:
        ...
        1 DUPCLOSURE                       R4 K3 [PROTO_19]
        2 SETTABLEKS                       R4 R3 K0 ["toGuest"]
        4 DUPCLOSURE                       R4 K4 [PROTO_20]
...
MAIN:
       ...
       15 CALL                             R1 1 1
       16 DUPTABLE                         R2 K13 [{["onTagChanged"] = "onTagChanged", ["observeTag"] = "observeTag", ["unobserveTag"] = "unobserveTag", ["selectTaggedInstances"] = "selectTaggedInstances"}]
       17 DUPCLOSURE                       R3 K14 [PROTO_0]
       18 CAPTURE                          VAL R2
       19 DUPCLOSURE                       R4 K15 [PROTO_1]
       20 DUPCLOSURE                       R5 K16 [PROTO_7]
       21 CAPTURE                          VAL R2
       22 DUPCLOSURE                       R6 K17 [PROTO_8]
       23 DUPCLOSURE                       R7 K18 [PROTO_18]
       24 CAPTURE                          VAL R2
       25 DUPCLOSURE                       R8 K19 [PROTO_23]
       26 CAPTURE                          VAL R5
       27 CAPTURE                          VAL R7
       28 DUPTABLE                         R9 K21 [{"prepareBridges"}]
       29 SETTABLEKS                       R8 R9 K20 ["prepareBridges"]
       31 RETURN                           R9 1
