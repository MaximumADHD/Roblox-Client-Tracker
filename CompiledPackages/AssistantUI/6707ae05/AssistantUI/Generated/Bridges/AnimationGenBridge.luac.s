PROTO_0:
        ...
        9 CALL                             R1 2 0
       10 LOADK                            R1 K3 ["createAnimationGenBridge_%*"]
       11 MOVE                             R3 R0
...
PROTO_5:
       ...
       19 CALL                             R7 2 1
       20 SETTABLEKS                       R7 R4 K5 ["bridge"]
       22 GETTABLEKS                       R5 R3 K8 ["poseDeselected"]
       24 MOVE                             R6 R2
       25 MOVE                             R7 R4
       26 CALL                             R5 2 -1
       27 RETURN                           R5 -1
...
PROTO_10:
        0 DUPTABLE                         R2 K4 [{"animatorRemoved", "restartPlayback", "poseDeselected", "toTarget"}]
        1 NEWCLOSURE                       R3 P0
        2 CAPTURE                          UPVAL U0
        3 CAPTURE                          VAL R0
        4 CAPTURE                          VAL R1
       ...
       15 CAPTURE                          VAL R0
       16 CAPTURE                          VAL R1
       17 SETTABLEKS                       R3 R2 K2 ["poseDeselected"]
       19 NEWCLOSURE                       R3 P3
       20 CAPTURE                          UPVAL U3
       21 CAPTURE                          VAL R1
...
PROTO_11:
       ...
       39 CALL                             R6 3 1
       40 GETUPVAL                         R12 0
       41 GETTABLEKS                       R11 R12 K10 ["poseDeselected"]
       43 FASTCALL2K                       ASSERT R11 K11 ; [+4]
       45 LOADK                            R12 K11 ["Invalid network key: poseDeselected"]
       46 GETIMPORT                        R10 K4 [assert]
       48 CALL                             R10 2 0
       49 LOADK                            R9 K12 ["createAnimationGenBridge_poseDeselected"]
...
PROTO_20:
       ...
       19 CALL                             R7 2 1
       20 SETTABLEKS                       R7 R4 K5 ["bridge"]
       22 GETTABLEKS                       R5 R3 K8 ["beginEditPreview"]
       24 MOVE                             R6 R2
       25 MOVE                             R7 R4
       26 CALL                             R5 2 -1
       27 RETURN                           R5 -1
...
PROTO_29:
        0 DUPTABLE                         R2 K8 [{"generateAndSaveAnimationAsync", "getSelectedRigRef", "setIsPlaying", "setCurrentTime", "setPlaybackSpeed", "openInAnimationClipEditor", "beginEditPreview", "toTarget"}]
        1 NEWCLOSURE                       R3 P0
        2 CAPTURE                          UPVAL U0
        3 CAPTURE                          VAL R0
        4 CAPTURE                          VAL R1
       ...
       33 CAPTURE                          VAL R0
       34 CAPTURE                          VAL R1
       35 SETTABLEKS                       R3 R2 K5 ["openInAnimationClipEditor"]
       37 NEWCLOSURE                       R3 P6
       38 CAPTURE                          UPVAL U6
       39 CAPTURE                          VAL R0
       40 CAPTURE                          VAL R1
       41 SETTABLEKS                       R3 R2 K6 ["beginEditPreview"]
       43 NEWCLOSURE                       R3 P7
       44 CAPTURE                          UPVAL U7
       45 CAPTURE                          VAL R1
...
PROTO_30:
       ...
       90 CALL                             R9 3 1
       91 GETUPVAL                         R15 0
       92 GETTABLEKS                       R14 R15 K20 ["openInAnimationClipEditor"]
       94 FASTCALL2K                       ASSERT R14 K21 ; [+4]
       96 LOADK                            R15 K21 ["Invalid network key: openInAnimationClipEditor"]
       97 GETIMPORT                        R13 K4 [assert]
       99 CALL                             R13 2 0
      100 LOADK                            R12 K22 ["createAnimationGenBridge_openInAnimationClipEditor"]
      101 NEWCLOSURE                       R13 P6
      102 CAPTURE                          VAL R2
      103 CAPTURE                          VAL R0
      104 CAPTURE                          VAL R1
      105 NAMECALL                         R10 R3 K13 ["OnHostEvent"]
      107 CALL                             R10 3 1
      108 GETUPVAL                         R16 0
      109 GETTABLEKS                       R15 R16 K23 ["beginEditPreview"]
      111 FASTCALL2K                       ASSERT R15 K24 ; [+4]
      113 LOADK                            R16 K24 ["Invalid network key: beginEditPreview"]
      114 GETIMPORT                        R14 K4 [assert]
      116 CALL                             R14 2 0
      117 LOADK                            R13 K25 ["createAnimationGenBridge_beginEditPreview"]
...
PROTO_35:
        ...
        1 DUPCLOSURE                       R4 K3 [PROTO_31]
        2 SETTABLEKS                       R4 R3 K0 ["toGuest"]
        4 DUPCLOSURE                       R4 K4 [PROTO_32]
...
MAIN:
       ...
       15 CALL                             R1 1 1
       16 DUPTABLE                         R2 K19 [{["animatorRemoved"] = "animatorRemoved", ["restartPlayback"] = "restartPlayback", ["poseDeselected"] = "poseDeselected", ["generateAndSaveAnimationAsync"] = "generateAndSaveAnimationAsync", ["getSelectedRigRef"] = "getSelectedRigRef", ["setIsPlaying"] = "setIsPlaying", ["setCurrentTime"] = "setCurrentTime", ["setPlaybackSpeed"] = "setPlaybackSpeed", ["openInAnimationClipEditor"] = "openInAnimationClipEditor", ["beginEditPreview"] = "beginEditPreview"}]
       17 DUPCLOSURE                       R3 K20 [PROTO_0]
       18 CAPTURE                          VAL R2
       19 DUPCLOSURE                       R4 K21 [PROTO_1]
       20 DUPCLOSURE                       R5 K22 [PROTO_11]
       21 CAPTURE                          VAL R2
       22 DUPCLOSURE                       R6 K23 [PROTO_12]
       23 DUPCLOSURE                       R7 K24 [PROTO_30]
       24 CAPTURE                          VAL R2
       25 DUPCLOSURE                       R8 K25 [PROTO_35]
       26 CAPTURE                          VAL R5
       27 CAPTURE                          VAL R7
       28 DUPTABLE                         R9 K27 [{"prepareBridges"}]
       29 SETTABLEKS                       R8 R9 K26 ["prepareBridges"]
       31 RETURN                           R9 1
