...
PROTO_15:
       ...
       17 CALL                             R4 3 1
       18 CONCAT                           R1 R2 R4
       19 DUPTABLE                         R2 K9 [{"materialDescription", "baseMaterial", "materialPattern", "materialId"}]
       20 GETUPVAL                         R3 0
       21 SETTABLEKS                       R3 R2 K5 ["materialDescription"]
       23 GETIMPORT                        R3 K13 [Enum.Material.Plastic]
       25 GETTABLEKS                       R3 R3 K14 ["Name"]
       27 SETTABLEKS                       R3 R2 K6 ["baseMaterial"]
       29 GETIMPORT                        R3 K17 [Enum.MaterialPattern.Regular]
       31 GETTABLEKS                       R3 R3 K14 ["Name"]
       33 SETTABLEKS                       R3 R2 K7 ["materialPattern"]
       35 SETTABLEKS                       R1 R2 K8 ["materialId"]
       37 GETUPVAL                         R3 2
       38 GETTABLEKS                       R3 R3 K18 ["FFlagAssistantAsyncSlashCommands"]
       40 JUMPIFNOT                        R3 ; [+17]
       41 DUPTABLE                         R3 K21 [{"name", "arguments"}]
       42 GETUPVAL                         R4 3
       43 GETTABLEKS                       R4 R4 K22 ["JobRun"]
       45 SETTABLEKS                       R4 R3 K19 ["name"]
       47 DUPTABLE                         R4 K24 [{"toolName", "arguments"}]
       48 GETUPVAL                         R5 3
       49 GETTABLEKS                       R5 R5 K25 ["MaterialGen"]
       51 SETTABLEKS                       R5 R4 K23 ["toolName"]
       53 SETTABLEKS                       R2 R4 K20 ["arguments"]
       55 SETTABLEKS                       R4 R3 K20 ["arguments"]
       57 RETURN                           R3 1
       58 DUPTABLE                         R3 K21 [{"name", "arguments"}]
       59 GETUPVAL                         R4 3
       60 GETTABLEKS                       R4 R4 K25 ["MaterialGen"]
       62 SETTABLEKS                       R4 R3 K19 ["name"]
       64 SETTABLEKS                       R2 R3 K20 ["arguments"]
       66 RETURN                           R3 1
