...
PROTO_5:
        ...
        4 LOADK                            R5 K2 ["CreatorStoreInsertTool_insertFromMarketplaceAsync"]
        5 NEWCLOSURE                       R6 P0
        6 CAPTURE                          UPVAL U0
        7 CAPTURE                          UPVAL U1
        8 CAPTURE                          UPVAL U2
       ...
       10 CAPTURE                          UPVAL U3
       11 CAPTURE                          UPVAL U4
       12 NAMECALL                         R3 R1 K3 ["OnHostInvokeAsync"]
       14 CALL                             R3 3 1
       15 NEWCLOSURE                       R4 P1
       16 CAPTURE                          UPVAL U5
       17 CAPTURE                          VAL R3
       ...
       19 CAPTURE                          UPVAL U6
       20 GETUPVAL                         R5 7
       21 GETTABLEKS                       R5 R5 K4 ["define"]
       23 CALL                             R5 0 1
       24 GETUPVAL                         R7 8
       25 GETTABLEKS                       R7 R7 K5 ["CreatorStoreInsert"]
       27 NAMECALL                         R5 R5 K6 ["setName"]
       29 CALL                             R5 2 1
       30 GETUPVAL                         R7 8
       31 GETTABLEKS                       R7 R7 K7 ["replaceTokens"]
       33 LOADK                            R8 K8 ["Inserts an asset into the game.\nThis should be used alongside the {ToolNames.CreatorStoreSearch} tool, which returns searchId and optional objectTypes.\nProvide searchId to insert from that search. Optionally provide objectTypes to restrict insertion to those types (combined and deduplicated in order).\nWhen multiple assetIds are resolved, the first is inserted and the rest are available as alternatives.\n"]
       34 CALL                             R7 1 -1
       35 NAMECALL                         R5 R5 K9 ["setDescription"]
       37 CALL                             R5 -1 1
       38 LOADK                            R7 K10 ["searchId"]
       39 DUPTABLE                         R8 K14 [{["type"] = "string", ["description"]}]
       40 LOADK                            R10 K15 ["Unique ID returned by %*."]
       41 GETUPVAL                         R12 8
       42 GETTABLEKS                       R12 R12 K16 ["CreatorStoreSearch"]
       44 NAMECALL                         R10 R10 K17 ["format"]
       46 CALL                             R10 2 1
       47 MOVE                             R9 R10
       48 SETTABLEKS                       R9 R8 K13 ["description"]
       50 NAMECALL                         R5 R5 K18 ["addArgument"]
       52 CALL                             R5 3 1
       53 LOADK                            R7 K19 ["objectTypes"]
       54 DUPTABLE                         R8 K22 [{["type"] = "array", ["items"], ["description"]}]
       55 DUPTABLE                         R9 K23 [{["type"] = "string"}]
       56 SETTABLEKS                       R9 R8 K21 ["items"]
       58 LOADK                            R10 K24 ["Optional list of objectTypes returned by %*. Asset IDs for all provided types are combined in order and deduplicated. If omitted, insertion uses all cached assetIds for searchId."]
       59 GETUPVAL                         R12 8
       60 GETTABLEKS                       R12 R12 K16 ["CreatorStoreSearch"]
       62 NAMECALL                         R10 R10 K17 ["format"]
       64 CALL                             R10 2 1
       65 MOVE                             R9 R10
       66 SETTABLEKS                       R9 R8 K13 ["description"]
       68 NAMECALL                         R5 R5 K25 ["addOptionalArgument"]
       70 CALL                             R5 3 1
       71 LOADK                            R7 K26 ["assetName"]
       72 DUPTABLE                         R8 K28 [{["type"] = "string", ["description"] = "Optional display/insert name override for the inserted asset. If omitted, objectType or a generic default is used."}]
       73 NAMECALL                         R5 R5 K25 ["addOptionalArgument"]
       75 CALL                             R5 3 1
       76 MOVE                             R7 R4
       77 NAMECALL                         R5 R5 K29 ["setHandler"]
       79 CALL                             R5 2 1
       80 DUPTABLE                         R7 K37 [{["title"] = "Creator Store Insertion", ["readOnlyHint"] = False, ["destructiveHint"] = False, ["idempotentHint"] = False, ["openWorldHint"] = False}]
       81 NAMECALL                         R5 R5 K38 ["setAnnotations"]
       83 CALL                             R5 2 1
       84 NAMECALL                         R5 R5 K39 ["build"]
       86 CALL                             R5 1 1
       87 DUPTABLE                         R6 K41 [{"definition"}]
       88 SETTABLEKS                       R5 R6 K40 ["definition"]
       90 RETURN                           R6 1
...
MAIN:
       ...
       57 CALL                             R8 1 1
       58 GETTABLEKS                       R9 R0 K10 ["Util"]
       60 GETTABLEKS                       R9 R9 K20 ["CreatorStore"]
       62 GETIMPORT                        R10 K9 [require]
       64 GETTABLEKS                       R11 R9 K21 ["CreatorStoreConstants"]
       66 CALL                             R10 1 1
       67 GETIMPORT                        R11 K9 [require]
       69 GETTABLEKS                       R12 R9 K22 ["CreatorStoreSearchCache"]
       71 CALL                             R11 1 1
       72 GETIMPORT                        R12 K9 [require]
       74 GETTABLEKS                       R13 R9 K23 ["CreatorStoreTypes"]
       76 CALL                             R12 1 1
       77 GETTABLEKS                       R13 R4 K10 ["Util"]
       79 GETTABLEKS                       R13 R13 K24 ["ToolBuilder"]
       81 GETTABLEKS                       R14 R4 K10 ["Util"]
       83 GETTABLEKS                       R14 R14 K25 ["ToolResult"]
       85 GETTABLEKS                       R15 R6 K26 ["ToolNames"]
       87 DUPCLOSURE                       R16 K27 [PROTO_0]
       88 CAPTURE                          VAL R3
       89 CAPTURE                          VAL R5
       90 DUPCLOSURE                       R17 K28 [PROTO_1]
       91 CAPTURE                          VAL R11
       92 CAPTURE                          VAL R10
       93 DUPCLOSURE                       R18 K29 [PROTO_5]
       94 CAPTURE                          VAL R2
       95 CAPTURE                          VAL R1
       96 CAPTURE                          VAL R7
       97 CAPTURE                          VAL R3
