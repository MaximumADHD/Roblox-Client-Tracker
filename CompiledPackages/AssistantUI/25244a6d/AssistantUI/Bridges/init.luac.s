PROTO_0:
        0 DUPTABLE                         R1 K12 [{"AnimationGen", "AssetInsert", "Channel", "CreatorStore", "ExecuteLuau", "Instance", "MaterialGen", "MeshGen", "PrimitiveGen", "ReadFile", "SegmentMesh", "TextureGen"}]
        1 GETUPVAL                         R2 0
        2 MOVE                             R3 R0
        3 CALL                             R2 1 1
       ...
       52 MOVE                             R3 R0
       53 CALL                             R2 1 1
       54 SETTABLEKS                       R2 R1 K10 ["SegmentMesh"]
       56 GETUPVAL                         R2 11
       57 MOVE                             R3 R0
       58 CALL                             R2 1 1
       59 SETTABLEKS                       R2 R1 K11 ["TextureGen"]
       61 RETURN                           R1 1
...
MAIN:
       ...
       82 GETTABLEKS                       R12 R12 K15 ["createSegmentMeshBridge"]
       84 CALL                             R11 1 1
       85 GETIMPORT                        R12 K1 [require]
       87 GETIMPORT                        R13 K3 [script]
       89 GETTABLEKS                       R13 R13 K16 ["createTextureGenBridge"]
       91 CALL                             R12 1 1
       92 DUPCLOSURE                       R13 K17 [PROTO_0]
       93 CAPTURE                          VAL R1
       94 CAPTURE                          VAL R2
       95 CAPTURE                          VAL R3
       96 CAPTURE                          VAL R4
      ...
      103 CAPTURE                          VAL R11
      104 CAPTURE                          VAL R12
      105 DUPTABLE                         R14 K19 [{"createBridges"}]
      106 SETTABLEKS                       R13 R14 K18 ["createBridges"]
      108 RETURN                           R14 1
