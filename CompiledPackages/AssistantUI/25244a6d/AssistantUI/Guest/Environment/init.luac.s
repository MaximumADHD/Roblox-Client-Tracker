...
PROTO_30:
      ...
      608 DUPTABLE                         R4 K210 [{"startAsync", "getStatusAsync", "publishAssetAsync", "loadAssetAsync"}]
      609 GETUPVAL                         R5 3
      610 LOADK                            R6 K211 ["segmentMesh.startAsync"]
      611 CALL                             R5 1 1
      612 SETTABLEKS                       R5 R4 K204 ["startAsync"]
      614 GETUPVAL                         R5 3
      615 LOADK                            R6 K212 ["segmentMesh.getStatusAsync"]
      616 CALL                             R5 1 1
      617 SETTABLEKS                       R5 R4 K205 ["getStatusAsync"]
      619 GETUPVAL                         R5 3
      620 LOADK                            R6 K213 ["segmentMesh.publishAssetAsync"]
      621 CALL                             R5 1 1
      622 SETTABLEKS                       R5 R4 K101 ["publishAssetAsync"]
      624 GETUPVAL                         R5 3
      625 LOADK                            R6 K214 ["segmentMesh.loadAssetAsync"]
      626 CALL                             R5 1 1
      627 SETTABLEKS                       R5 R4 K74 ["loadAssetAsync"]
      629 SETTABLEKS                       R4 R3 K215 ["segmentMesh"]
      631 DUPTABLE                         R4 K210 [{"startAsync", "getStatusAsync", "publishAssetAsync", "loadAssetAsync"}]
      632 GETUPVAL                         R5 3
      633 LOADK                            R6 K216 ["textureGeneration.startAsync"]
      634 CALL                             R5 1 1
      635 SETTABLEKS                       R5 R4 K204 ["startAsync"]
      637 GETUPVAL                         R5 3
      638 LOADK                            R6 K217 ["textureGeneration.getStatusAsync"]
      639 CALL                             R5 1 1
      640 SETTABLEKS                       R5 R4 K205 ["getStatusAsync"]
      642 GETUPVAL                         R5 3
      643 LOADK                            R6 K218 ["textureGeneration.publishAssetAsync"]
      644 CALL                             R5 1 1
      645 SETTABLEKS                       R5 R4 K101 ["publishAssetAsync"]
      647 GETUPVAL                         R5 3
      648 LOADK                            R6 K219 ["textureGeneration.loadAssetAsync"]
      649 CALL                             R5 1 1
      650 SETTABLEKS                       R5 R4 K74 ["loadAssetAsync"]
      652 SETTABLEKS                       R4 R3 K220 ["textureGeneration"]
      654 DUPCLOSURE                       R4 K221 [PROTO_28]
      655 SETTABLEKS                       R4 R3 K222 ["hasInternalPermission"]
      657 DUPCLOSURE                       R4 K223 [PROTO_29]
      658 CAPTURE                          UPVAL U12
      659 SETTABLEKS                       R4 R3 K224 ["getMockPrimGenBackendData"]
      661 GETUPVAL                         R4 3
      662 LOADK                            R5 K225 ["startMultiPlayerTest"]
      663 CALL                             R4 1 1
      664 SETTABLEKS                       R4 R3 K225 ["startMultiPlayerTest"]
      666 GETUPVAL                         R4 3
      667 LOADK                            R5 K226 ["stopMultiPlayerTest"]
      668 CALL                             R4 1 1
      669 SETTABLEKS                       R4 R3 K226 ["stopMultiPlayerTest"]
      671 GETUPVAL                         R4 3
      672 LOADK                            R5 K227 ["isInMultiPlayerTest"]
      673 CALL                             R4 1 1
      674 SETTABLEKS                       R4 R3 K227 ["isInMultiPlayerTest"]
      676 GETUPVAL                         R4 3
      677 LOADK                            R5 K228 ["getStopMultiPlayerTestResults"]
      678 CALL                             R4 1 1
      679 SETTABLEKS                       R4 R3 K229 ["subscribeStopMultiPlayerTestStateChanged"]
      681 GETUPVAL                         R4 3
      682 LOADK                            R5 K230 ["createMultiPlayersServer"]
      683 CALL                             R4 1 1
      684 SETTABLEKS                       R4 R3 K230 ["createMultiPlayersServer"]
      686 GETUPVAL                         R4 3
      687 LOADK                            R5 K231 ["createMultiPlayersClient"]
      688 CALL                             R4 1 1
      689 SETTABLEKS                       R4 R3 K231 ["createMultiPlayersClient"]
      691 GETUPVAL                         R4 3
      692 LOADK                            R5 K232 ["getExperimentFeatureEnabled"]
      693 CALL                             R4 1 1
      694 SETTABLEKS                       R4 R3 K232 ["getExperimentFeatureEnabled"]
      696 GETUPVAL                         R4 3
      697 LOADK                            R5 K233 ["getOnExperimentChangedSignal"]
      698 CALL                             R4 1 1
      699 SETTABLEKS                       R4 R3 K234 ["onceExperimentFeatureEnabled"]
      701 GETUPVAL                         R4 3
      702 LOADK                            R5 K235 ["getStudioState"]
      703 CALL                             R4 1 1
      704 SETTABLEKS                       R4 R3 K235 ["getStudioState"]
      706 MOVE                             R2 R3
      707 CLOSEUPVALS                      R2
      708 RETURN                           R2 1
