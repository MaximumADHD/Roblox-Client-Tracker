...
PROTO_11:
      ...
      151 GETUPVAL                         R12 0
      152 GETTABLEKS                       R12 R12 K32 ["addContent"]
      154 SETTABLEKS                       R12 R11 K32 ["addContent"]
      156 GETUPVAL                         R12 0
      157 GETTABLEKS                       R12 R12 K33 ["editContent"]
      159 SETTABLEKS                       R12 R11 K33 ["editContent"]
      161 NEWCLOSURE                       R12 P0
      162 CAPTURE                          VAL R3
      163 SETTABLEKS                       R12 R11 K34 ["getMessageId"]
      165 CALL                             R10 1 -1
      166 NAMECALL                         R7 R7 K36 ["setClientToolConfirmationHandler"]
      168 CALL                             R7 -1 0
      169 LOADB                            R7 0
      170 LOADB                            R8 0
      171 LOADB                            R9 0
      172 LOADNIL                          R10
      173 NEWCLOSURE                       R11 P1
      ...
      203 NAMECALL                         R13 R3 K37 ["observeUpdates"]
      205 CALL                             R13 2 1
      206 MOVE                             R10 R13
      207 GETUPVAL                         R13 14
      208 GETUPVAL                         R14 0
      ...
      212 CALL                             R13 4 1
      213 GETUPVAL                         R14 0
      214 GETTABLEKS                       R14 R14 K13 ["service"]
      216 MOVE                             R16 R13
      217 NAMECALL                         R14 R14 K38 ["prompt"]
      219 CALL                             R14 2 1
      220 NAMECALL                         R14 R14 K17 ["await"]
      222 CALL                             R14 1 2
      223 JUMPIF                           R14 ; [+40]
      224 JUMPIF                           R9 ; [+39]
      225 LOADB                            R9 1
      226 LOADK                            R16 K18 ["done"]
      227 SETUPVAL                         R16 4
      228 GETUPVAL                         R16 0
      229 GETTABLEKS                       R16 R16 K13 ["service"]
      231 MOVE                             R18 R6
      232 LOADNIL                          R19
      233 NAMECALL                         R16 R16 K36 ["setClientToolConfirmationHandler"]
      235 CALL                             R16 3 0
      236 GETUPVAL                         R16 0
      237 GETTABLEKS                       R16 R16 K39 ["unregisterPromptController"]
      239 JUMPIFNOT                        R16 ; [+5]
      240 GETUPVAL                         R16 0
      241 GETTABLEKS                       R16 R16 K39 ["unregisterPromptController"]
      243 MOVE                             R17 R6
      244 CALL                             R16 1 0
      245 NAMECALL                         R16 R3 K19 ["endTurn"]
      247 CALL                             R16 1 0
      248 JUMPIFNOT                        R10 ; [+3]
      249 MOVE                             R16 R10
      250 CALL                             R16 0 0
      251 LOADNIL                          R10
      252 MOVE                             R16 R1
      253 LOADK                            R18 K40 ["prompt failed: %*"]
      254 FASTCALL1                        TOSTRING R15 ; [+3]
      255 MOVE                             R21 R15
      256 GETIMPORT                        R20 K22 [tostring]
      258 CALL                             R20 1 1
      259 NAMECALL                         R18 R18 K23 ["format"]
      261 CALL                             R18 2 1
      262 MOVE                             R17 R18
      263 CALL                             R16 1 0
      264 CLOSEUPVALS                      R7
...
MAIN:
       ...
       71 DUPCLOSURE                       R12 K18 [PROTO_12]
       72 CAPTURE                          VAL R7
       73 CAPTURE                          VAL R5
       74 CAPTURE                          VAL R8
       75 CAPTURE                          VAL R4
