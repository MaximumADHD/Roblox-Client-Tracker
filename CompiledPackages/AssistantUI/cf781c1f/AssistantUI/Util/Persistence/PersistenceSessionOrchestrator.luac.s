...
MAIN:
       ...
       39 GETTABLEKS                       R7 R7 K12 ["FFlagDebugLogAssistantUI"]
       41 CALL                             R6 1 1
       42 GETIMPORT                        R7 K5 [require]
       44 GETTABLEKS                       R8 R0 K11 ["Flags"]
       46 GETTABLEKS                       R8 R8 K13 ["FIntAssistantAutoSaveInterval"]
       48 CALL                             R7 1 1
       49 GETIMPORT                        R8 K5 [require]
       51 GETTABLEKS                       R9 R0 K11 ["Flags"]
       53 GETTABLEKS                       R9 R9 K14 ["FIntAssistantPersistenceMessageLoadLimit"]
       55 CALL                             R8 1 1
       56 GETIMPORT                        R9 K5 [require]
       58 GETTABLEKS                       R10 R0 K11 ["Flags"]
       60 GETTABLEKS                       R10 R10 K15 ["FIntAssistantPersistenceThreadLoadLimit"]
       62 CALL                             R9 1 1
       63 GETTABLEKS                       R10 R3 K16 ["PersistenceLoadStates"]
       65 GETTABLEKS                       R11 R3 K17 ["ScopeTypes"]
       67 DUPTABLE                         R12 K22 [{"Idle", "Loading", "Loaded", "Failed"}]
       68 LOADK                            R13 K23 ["idle"]
       69 SETTABLEKS                       R13 R12 K18 ["Idle"]
       71 LOADK                            R13 K24 ["loading"]
       72 SETTABLEKS                       R13 R12 K19 ["Loading"]
       74 LOADK                            R13 K25 ["loaded"]
       75 SETTABLEKS                       R13 R12 K20 ["Loaded"]
       77 LOADK                            R13 K26 ["failed"]
       78 SETTABLEKS                       R13 R12 K21 ["Failed"]
       80 DUPCLOSURE                       R13 K27 [PROTO_0]
       81 DUPCLOSURE                       R14 K28 [PROTO_1]
       82 CAPTURE                          VAL R12
       83 CAPTURE                          VAL R2
       84 DUPCLOSURE                       R15 K29 [PROTO_2]
       85 CAPTURE                          VAL R6
       86 DUPCLOSURE                       R16 K30 [PROTO_8]
       87 CAPTURE                          VAL R1
       88 CAPTURE                          VAL R6
       89 DUPCLOSURE                       R17 K31 [PROTO_12]
       90 DUPCLOSURE                       R18 K32 [PROTO_15]
       91 CAPTURE                          VAL R7
       92 CAPTURE                          VAL R6
       93 DUPCLOSURE                       R19 K33 [PROTO_18]
       94 CAPTURE                          VAL R6
       95 CAPTURE                          VAL R12
       96 CAPTURE                          VAL R2
       97 CAPTURE                          VAL R18
       98 CAPTURE                          VAL R16
       99 CAPTURE                          VAL R17
      100 DUPCLOSURE                       R20 K34 [PROTO_22]
      101 CAPTURE                          VAL R11
      102 CAPTURE                          VAL R15
      103 CAPTURE                          VAL R6
      104 CAPTURE                          VAL R12
      ...
      106 CAPTURE                          VAL R9
      107 CAPTURE                          VAL R8
      108 DUPCLOSURE                       R21 K35 [PROTO_26]
      109 CAPTURE                          VAL R11
      110 DUPCLOSURE                       R22 K36 [PROTO_29]
      111 CAPTURE                          VAL R11
      112 CAPTURE                          VAL R6
      113 DUPCLOSURE                       R23 K37 [PROTO_32]
      114 CAPTURE                          VAL R2
      115 CAPTURE                          VAL R19
      116 CAPTURE                          VAL R11
      117 CAPTURE                          VAL R15
      ...
      121 CAPTURE                          VAL R9
      122 CAPTURE                          VAL R8
      123 DUPTABLE                         R24 K39 [{"trackSessions"}]
      124 SETTABLEKS                       R23 R24 K38 ["trackSessions"]
      126 RETURN                           R24 1
