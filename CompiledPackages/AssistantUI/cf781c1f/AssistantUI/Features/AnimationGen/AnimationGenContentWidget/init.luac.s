...
PROTO_2:
       ...
       44 GETUPVAL                         R7 2
       45 GETUPVAL                         R8 5
       46 DUPTABLE                         R9 K19 [{"layoutOrder", "duration", "animatorRemovedSignal", "rigSelectedSignal", "setHostIsPlaying", "setHostCurrentTime", "setHostPlaybackSpeed"}]
       47 MOVE                             R10 R2
       48 CALL                             R10 0 1
       49 SETTABLEKS                       R10 R9 K10 ["layoutOrder"]
       51 GETTABLEKS                       R10 R0 K13 ["duration"]
       53 SETTABLEKS                       R10 R9 K13 ["duration"]
       55 GETTABLEKS                       R10 R0 K14 ["animatorRemovedSignal"]
       57 SETTABLEKS                       R10 R9 K14 ["animatorRemovedSignal"]
       59 GETTABLEKS                       R10 R0 K15 ["rigSelectedSignal"]
       61 SETTABLEKS                       R10 R9 K15 ["rigSelectedSignal"]
       63 GETTABLEKS                       R10 R0 K16 ["setHostIsPlaying"]
       65 SETTABLEKS                       R10 R9 K16 ["setHostIsPlaying"]
       67 GETTABLEKS                       R10 R0 K17 ["setHostCurrentTime"]
       69 SETTABLEKS                       R10 R9 K17 ["setHostCurrentTime"]
       71 GETTABLEKS                       R10 R0 K18 ["setHostPlaybackSpeed"]
       73 SETTABLEKS                       R10 R9 K18 ["setHostPlaybackSpeed"]
       75 CALL                             R7 2 1
       76 SETTABLEKS                       R7 R6 K8 ["PlaybackWidget"]
       78 CALL                             R3 3 -1
       79 RETURN                           R3 -1
...
MAIN:
       ...
       83 CALL                             R13 1 1
       84 GETTABLEKS                       R14 R4 K25 ["Text"]
       86 GETTABLEKS                       R15 R4 K26 ["View"]
       88 GETTABLEKS                       R16 R7 K27 ["createNextOrder"]
       90 GETTABLEKS                       R17 R6 K28 ["createElement"]
       92 DUPCLOSURE                       R18 K29 [PROTO_1]
       93 CAPTURE                          VAL R6
       94 CAPTURE                          VAL R11
       95 CAPTURE                          VAL R3
       96 CAPTURE                          VAL R17
       ...
       98 CAPTURE                          VAL R14
       99 CAPTURE                          VAL R9
      100 DUPCLOSURE                       R19 K30 [PROTO_2]
      101 CAPTURE                          VAL R3
      102 CAPTURE                          VAL R16
      103 CAPTURE                          VAL R17
      104 CAPTURE                          VAL R15
      105 CAPTURE                          VAL R18
      106 CAPTURE                          VAL R5
      107 DUPTABLE                         R20 K33 [{"toMeta", "fromMeta"}]
      108 DUPCLOSURE                       R21 K34 [PROTO_3]
      109 CAPTURE                          VAL R13
      110 SETTABLEKS                       R21 R20 K31 ["toMeta"]
      112 DUPCLOSURE                       R21 K35 [PROTO_4]
      113 CAPTURE                          VAL R13
      114 SETTABLEKS                       R21 R20 K32 ["fromMeta"]
      116 DUPTABLE                         R21 K39 [{"Type", "ContentWidget", "Serialization"}]
      117 LOADK                            R22 K4 ["AnimationGen"]
      118 SETTABLEKS                       R22 R21 K36 ["Type"]
      120 GETTABLEKS                       R22 R6 K40 ["memo"]
      122 MOVE                             R23 R19
      123 CALL                             R22 1 1
      124 SETTABLEKS                       R22 R21 K37 ["ContentWidget"]
      126 SETTABLEKS                       R20 R21 K38 ["Serialization"]
      128 RETURN                           R21 1
