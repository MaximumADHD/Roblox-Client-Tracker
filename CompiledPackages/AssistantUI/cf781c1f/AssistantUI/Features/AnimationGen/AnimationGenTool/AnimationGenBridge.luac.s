...
PROTO_21:
        0 DUPTABLE                         R2 K5 [{"generateAndSaveAnimationAsync", "getSelectedRigRef", "setIsPlaying", "setCurrentTime", "setPlaybackSpeed"}]
        1 NEWCLOSURE                       R3 P0
        2 CAPTURE                          UPVAL U0
        3 CAPTURE                          VAL R0
        4 CAPTURE                          VAL R1
...
MAIN:
       ...
       22 CALL                             R2 1 1
       23 DUPTABLE                         R3 K17 [{"animatorRemoved", "rigSelected", "generateAndSaveAnimationAsync", "getSelectedRigRef", "setIsPlaying", "setCurrentTime", "setPlaybackSpeed"}]
       ...
       45 DUPCLOSURE                       R4 K18 [PROTO_0]
       46 CAPTURE                          VAL R3
       47 DUPCLOSURE                       R5 K19 [PROTO_1]
       48 DUPCLOSURE                       R6 K20 [PROTO_8]
       49 CAPTURE                          VAL R3
       50 DUPCLOSURE                       R7 K21 [PROTO_9]
       51 DUPCLOSURE                       R8 K22 [PROTO_22]
       52 CAPTURE                          VAL R3
       53 DUPCLOSURE                       R9 K23 [PROTO_23]
       54 CAPTURE                          VAL R1
       55 CAPTURE                          VAL R8
       56 CAPTURE                          VAL R6
       57 DUPTABLE                         R10 K26 [{"prepareBridges", "createGuestContext"}]
       58 SETTABLEKS                       R9 R10 K24 ["prepareBridges"]
       60 SETTABLEKS                       R5 R10 K25 ["createGuestContext"]
       62 RETURN                           R10 1
