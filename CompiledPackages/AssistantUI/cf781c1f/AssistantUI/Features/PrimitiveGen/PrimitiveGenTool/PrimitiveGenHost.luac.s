...
PROTO_11:
       ...
       43 CALL                             R0 2 0
       44 GETUPVAL                         R0 5
       45 GETTABLEKS                       R0 R0 K15 ["bridge"]
       47 GETTABLEKS                       R0 R0 K16 ["updateContentHeader"]
       49 DUPTABLE                         R1 K20 [{"newDisplayName", "newClassName", "modelTag"}]
       50 GETUPVAL                         R2 1
       51 GETTABLEKS                       R2 R2 K1 ["Name"]
       53 SETTABLEKS                       R2 R1 K17 ["newDisplayName"]
       55 GETUPVAL                         R2 1
       56 GETTABLEKS                       R2 R2 K21 ["ClassName"]
       58 SETTABLEKS                       R2 R1 K18 ["newClassName"]
       60 GETUPVAL                         R2 6
       61 SETTABLEKS                       R2 R1 K19 ["modelTag"]
       63 CALL                             R0 1 0
       64 RETURN                           R0 0
...
PROTO_14:
       ...
       12 NEWCLOSURE                       R7 P1
       13 CAPTURE                          VAL R6
       14 LOADK                            R10 K4 ["GeneratedFolder"]
       15 NAMECALL                         R8 R0 K5 ["FindFirstChildWhichIsA"]
       17 CALL                             R8 2 1
       18 JUMPIFNOT                        R8 ; [+20]
       19 LOADK                            R11 K6 ["Model"]
       20 NAMECALL                         R9 R8 K7 ["FindFirstChildOfClass"]
       22 CALL                             R9 2 1
       23 JUMPIF                           R9 ; [+4]
       24 NAMECALL                         R10 R8 K8 ["GetChildren"]
       26 CALL                             R10 1 1
       ...
       30 CALL                             R10 0 0
       31 JUMP                             ; [+18]
       32 GETTABLEKS                       R10 R8 K9 ["ChildAdded"]
       34 MOVE                             R12 R6
       35 NAMECALL                         R10 R10 K10 ["Once"]
       37 CALL                             R10 2 0
       38 JUMP                             ; [+11]
       39 LOADNIL                          R9
       40 GETTABLEKS                       R10 R0 K9 ["ChildAdded"]
       42 NEWCLOSURE                       R12 P2
       43 CAPTURE                          REF R9
       44 CAPTURE                          VAL R6
       45 NAMECALL                         R10 R10 K11 ["Connect"]
       47 CALL                             R10 2 1
       48 MOVE                             R9 R10
       49 CLOSEUPVALS                      R9
       50 JUMPIFEQKS                       R4 K0 [""] ; [+3]
       52 CLOSEUPVALS                      R4
       53 RETURN                           R4 1
       54 GETIMPORT                        R9 K13 [coroutine.yield]
       56 CALL                             R9 0 1
       57 MOVE                             R4 R9
       58 CLOSEUPVALS                      R4
       59 RETURN                           R4 1
...
MAIN:
       ...
       67 GETTABLEKS                       R10 R0 K22 ["Flags"]
       69 GETTABLEKS                       R10 R10 K23 ["FFlagAssistantUseNewTags"]
       71 CALL                             R9 1 1
       72 GETIMPORT                        R10 K10 [require]
       74 GETTABLEKS                       R11 R0 K22 ["Flags"]
       76 GETTABLEKS                       R11 R11 K24 ["FFlagDisableNewSmartSize"]
       78 CALL                             R10 1 1
       79 GETIMPORT                        R11 K10 [require]
       81 GETTABLEKS                       R12 R0 K22 ["Flags"]
       83 GETTABLEKS                       R12 R12 K25 ["FFlagDisableOldSmartSize"]
       85 CALL                             R11 1 1
       86 GETIMPORT                        R12 K10 [require]
       88 GETTABLEKS                       R13 R0 K22 ["Flags"]
       90 GETTABLEKS                       R13 R13 K26 ["FStringProceduralScriptCapabilities"]
       92 CALL                             R12 1 1
       93 DUPTABLE                         R13 K30 [{"smartWidth", "smartHeight", "smartDepth"}]
       94 LOADK                            R14 K31 ["parameters.Size.X"]
       95 SETTABLEKS                       R14 R13 K27 ["smartWidth"]
       97 LOADK                            R14 K32 ["parameters.Size.Y"]
       98 SETTABLEKS                       R14 R13 K28 ["smartHeight"]
      100 LOADK                            R14 K33 ["parameters.Size.Z"]
      101 SETTABLEKS                       R14 R13 K29 ["smartDepth"]
      103 DUPTABLE                         R14 K37 [{"SmartWidth", "SmartHeight", "SmartDepth"}]
      104 LOADK                            R15 K31 ["parameters.Size.X"]
      105 SETTABLEKS                       R15 R14 K34 ["SmartWidth"]
      107 LOADK                            R15 K32 ["parameters.Size.Y"]
      108 SETTABLEKS                       R15 R14 K35 ["SmartHeight"]
      110 LOADK                            R15 K33 ["parameters.Size.Z"]
      111 SETTABLEKS                       R15 R14 K36 ["SmartDepth"]
      113 DUPCLOSURE                       R15 K38 [PROTO_0]
      114 DUPCLOSURE                       R16 K39 [PROTO_1]
      115 CAPTURE                          VAL R9
      116 CAPTURE                          VAL R5
      117 DUPCLOSURE                       R17 K40 [PROTO_2]
      118 DUPCLOSURE                       R18 K41 [PROTO_3]
      119 DUPCLOSURE                       R19 K42 [PROTO_5]
      120 CAPTURE                          VAL R6
      121 CAPTURE                          VAL R18
      122 DUPCLOSURE                       R20 K43 [PROTO_7]
      123 CAPTURE                          VAL R13
      124 CAPTURE                          VAL R11
      125 CAPTURE                          VAL R14
      126 CAPTURE                          VAL R10
      127 DUPCLOSURE                       R21 K44 [PROTO_8]
      128 DUPCLOSURE                       R22 K45 [PROTO_9]
      129 CAPTURE                          VAL R12
      130 DUPCLOSURE                       R23 K46 [PROTO_10]
      131 CAPTURE                          VAL R11
      132 CAPTURE                          VAL R10
      133 CAPTURE                          VAL R17
      134 CAPTURE                          VAL R19
      135 CAPTURE                          VAL R22
      136 DUPCLOSURE                       R24 K47 [PROTO_14]
      137 CAPTURE                          VAL R7
      138 DUPCLOSURE                       R25 K48 [PROTO_16]
      139 CAPTURE                          VAL R2
      140 CAPTURE                          VAL R21
      141 CAPTURE                          VAL R20
      142 CAPTURE                          VAL R23
      ...
      144 CAPTURE                          VAL R5
      145 CAPTURE                          VAL R24
      146 DUPCLOSURE                       R26 K49 [PROTO_17]
      147 CAPTURE                          VAL R1
      148 DUPCLOSURE                       R27 K50 [PROTO_19]
      149 CAPTURE                          VAL R9
      150 CAPTURE                          VAL R5
      151 CAPTURE                          VAL R1
      152 CAPTURE                          VAL R8
      153 DUPTABLE                         R28 K54 [{"addWorkspaceModelAsync", "selectModel", "listenToLinkChanges"}]
      154 SETTABLEKS                       R25 R28 K51 ["addWorkspaceModelAsync"]
      156 SETTABLEKS                       R26 R28 K52 ["selectModel"]
      158 SETTABLEKS                       R27 R28 K53 ["listenToLinkChanges"]
      160 DUPTABLE                         R29 K56 [{"bridge"}]
      161 SETTABLEKS                       R28 R29 K55 ["bridge"]
      163 RETURN                           R29 1
