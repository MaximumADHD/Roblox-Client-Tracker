...
PROTO_5:
       ...
       31 JUMPIFNOT                        R4 ; [+7]
       32 GETUPVAL                         R3 6
       33 GETTABLEKS                       R3 R3 K8 ["getUniqueTag"]
       35 LOADK                            R4 K9 ["Store"]
       36 MOVE                             R5 R2
       37 CALL                             R3 2 1
       38 JUMP                             ; [+3]
       39 LOADK                            R4 K10 ["Assistant:"]
       40 MOVE                             R5 R2
       41 CONCAT                           R3 R4 R5
       42 MOVE                             R6 R3
       43 NAMECALL                         R4 R1 K11 ["AddTag"]
       45 CALL                             R4 2 0
       46 GETIMPORT                        R4 K13 [workspace]
       48 SETTABLEKS                       R4 R1 K14 ["Parent"]
       50 GETUPVAL                         R4 1
       51 GETTABLEKS                       R4 R4 K15 ["endRecording"]
       53 GETUPVAL                         R5 2
       54 CALL                             R4 1 0
       55 MOVE                             R4 R3
       56 MOVE                             R5 R2
       57 GETTABLEKS                       R6 R1 K16 ["ClassName"]
       59 RETURN                           R4 3
...
PROTO_7:
       ...
       35 CALL                             R4 2 1
       36 GETTABLEKS                       R5 R1 K12 ["toolArgs"]
...
MAIN:
       ...
       30 GETTABLEKS                       R5 R5 K13 ["Tagging"]
       32 CALL                             R4 1 1
       33 GETIMPORT                        R5 K10 [require]
       35 GETTABLEKS                       R6 R0 K11 ["Util"]
       37 GETTABLEKS                       R6 R6 K14 ["ToolUtils"]
       39 CALL                             R5 1 1
       ...
       51 LOADK                            R9 K18 ["CreatorStore"]
       52 NAMECALL                         R7 R7 K3 ["FindFirstAncestor"]
       54 CALL                             R7 2 1
       55 GETIMPORT                        R8 K10 [require]
       57 GETTABLEKS                       R9 R7 K19 ["CreatorStoreInsertTool"]
       59 GETTABLEKS                       R9 R9 K20 ["CreatorStoreInsertBridgeTypes"]
       61 CALL                             R8 1 1
       62 GETIMPORT                        R9 K10 [require]
       64 GETTABLEKS                       R10 R0 K21 ["Flags"]
       66 GETTABLEKS                       R10 R10 K22 ["FFlagAssistantUseNewTags"]
       68 CALL                             R9 1 1
       69 DUPCLOSURE                       R10 K23 [PROTO_0]
       70 CAPTURE                          VAL R9
       71 CAPTURE                          VAL R4
       ...
       76 CAPTURE                          VAL R1
       77 CAPTURE                          VAL R6
       78 DUPCLOSURE                       R13 K26 [PROTO_4]
       79 CAPTURE                          VAL R5
       80 CAPTURE                          VAL R1
       81 DUPCLOSURE                       R14 K27 [PROTO_7]
       82 CAPTURE                          VAL R3
       83 CAPTURE                          VAL R2
       84 CAPTURE                          VAL R5
       85 CAPTURE                          VAL R9
       86 CAPTURE                          VAL R4
       87 DUPTABLE                         R15 K32 [{"selectInsertedAssets", "listenToLinkChanges", "swapAssetAsync", "insertFromMarketplaceAsync"}]
       88 SETTABLEKS                       R11 R15 K28 ["selectInsertedAssets"]
       90 SETTABLEKS                       R12 R15 K29 ["listenToLinkChanges"]
       92 SETTABLEKS                       R13 R15 K30 ["swapAssetAsync"]
       94 SETTABLEKS                       R14 R15 K31 ["insertFromMarketplaceAsync"]
       96 DUPTABLE                         R16 K34 [{"bridge"}]
       97 SETTABLEKS                       R15 R16 K33 ["bridge"]
       99 RETURN                           R16 1
