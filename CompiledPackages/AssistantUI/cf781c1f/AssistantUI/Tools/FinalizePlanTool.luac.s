...
PROTO_1:
      ...
      219 CALL                             R5 3 1
      220 DUPTABLE                         R6 K28 [{"status", "planId", "name"}]
      221 LOADK                            R7 K29 ["presented"]
      222 SETTABLEKS                       R7 R6 K26 ["status"]
      224 SETTABLEKS                       R5 R6 K27 ["planId"]
      226 SETTABLEKS                       R3 R6 K18 ["name"]
      228 GETUPVAL                         R7 3
      229 GETTABLEKS                       R7 R7 K30 ["toString"]
      231 MOVE                             R8 R6
      232 CALL                             R7 1 1
      233 GETUPVAL                         R8 4
      234 CALL                             R8 0 1
      235 MOVE                             R10 R7
      236 NAMECALL                         R8 R8 K31 ["addText"]
      238 CALL                             R8 2 1
      239 MOVE                             R10 R6
      240 NAMECALL                         R8 R8 K32 ["setStructuredContent"]
      242 CALL                             R8 2 1
      243 NAMECALL                         R8 R8 K33 ["build"]
      245 CALL                             R8 1 -1
      246 RETURN                           R8 -1
      247 DUPTABLE                         R3 K34 [{"status"}]
      248 LOADK                            R4 K29 ["presented"]
      249 SETTABLEKS                       R4 R3 K26 ["status"]
      251 GETUPVAL                         R4 3
      252 GETTABLEKS                       R4 R4 K30 ["toString"]
      254 MOVE                             R5 R3
      255 CALL                             R4 1 1
      256 GETUPVAL                         R5 4
      257 CALL                             R5 0 1
      258 MOVE                             R7 R4
      259 NAMECALL                         R5 R5 K31 ["addText"]
      261 CALL                             R5 2 1
      262 MOVE                             R7 R3
      263 NAMECALL                         R5 R5 K32 ["setStructuredContent"]
      265 CALL                             R5 2 1
      266 NAMECALL                         R5 R5 K33 ["build"]
      268 CALL                             R5 1 -1
      269 RETURN                           R5 -1
...
PROTO_7:
       ...
       10 CAPTURE                          UPVAL U2
       11 GETUPVAL                         R5 3
       12 GETTABLEKS                       R5 R5 K2 ["define"]
       14 CALL                             R5 0 1
       15 GETUPVAL                         R7 4
       16 GETTABLEKS                       R7 R7 K3 ["FinalizePlan"]
       18 NAMECALL                         R5 R5 K4 ["setName"]
       20 CALL                             R5 2 1
       21 JUMPIFNOT                        R1 ; [+2]
       22 LOADK                            R7 K5 ["Create a NEW structured plan with markdown details and todos.\nUse this tool only when creating a brand-new plan. If updating an existing plan, use update_plan instead.\n\nThe tool returns immediately after rendering the plan UI.\nThe tool result is JSON: {\"status\":\"presented\",\"planId\":\"...\",\"name\":\"...\"}.\n\nEnsure that all content is human-readable and editable by the user.\n"]
       23 JUMP                             ; [+1]
       24 LOADK                            R7 K6 ["Finalizes a structured plan with markdown details and todos.\nUse this tool to present the final structured plan when ready.\n\nThe tool returns immediately after rendering the plan UI.\nThe tool result is JSON: {\"status\":\"presented\"}.\n\nEnsure that all content is human-readable and editable by the user.\n"]
       25 NAMECALL                         R5 R5 K7 ["setDescription"]
       27 CALL                             R5 2 1
       28 JUMPIFNOT                        R1 ; [+11]
       29 LOADK                            R8 K8 ["name"]
       30 DUPTABLE                         R9 K11 [{"type", "description"}]
       31 LOADK                            R10 K12 ["string"]
       32 SETTABLEKS                       R10 R9 K9 ["type"]
       34 LOADK                            R10 K13 ["A short human-readable name for this plan, used to distinguish it from other plans in the same conversation."]
       35 SETTABLEKS                       R10 R9 K10 ["description"]
       37 NAMECALL                         R6 R5 K14 ["addArgument"]
       39 CALL                             R6 3 0
       40 LOADK                            R8 K15 ["plan"]
       41 DUPTABLE                         R9 K18 [{"type", "description", "properties", "required"}]
       42 LOADK                            R10 K19 ["object"]
       43 SETTABLEKS                       R10 R9 K9 ["type"]
       45 LOADK                            R10 K20 ["The structured final plan."]
       46 SETTABLEKS                       R10 R9 K10 ["description"]
       48 DUPTABLE                         R10 K25 [{"completeDescription", "todo", "summary", "title"}]
       49 DUPTABLE                         R11 K11 [{"type", "description"}]
       50 LOADK                            R12 K12 ["string"]
       51 SETTABLEKS                       R12 R11 K9 ["type"]
       53 LOADK                            R12 K26 ["Markdown describing all plan details."]
       54 SETTABLEKS                       R12 R11 K10 ["description"]
       56 SETTABLEKS                       R11 R10 K21 ["completeDescription"]
       58 DUPTABLE                         R11 K28 [{"type", "description", "items"}]
       59 LOADK                            R12 K29 ["array"]
       60 SETTABLEKS                       R12 R11 K9 ["type"]
       62 LOADK                            R12 K30 ["A list of todo items for the plan. This should be succint and to the point. Try to keep the list under 5 items long."]
       63 SETTABLEKS                       R12 R11 K10 ["description"]
       65 DUPTABLE                         R12 K11 [{"type", "description"}]
       66 LOADK                            R13 K12 ["string"]
       67 SETTABLEKS                       R13 R12 K9 ["type"]
       69 LOADK                            R13 K31 ["Todo text."]
       70 SETTABLEKS                       R13 R12 K10 ["description"]
       72 SETTABLEKS                       R12 R11 K27 ["items"]
       74 SETTABLEKS                       R11 R10 K22 ["todo"]
       76 DUPTABLE                         R11 K11 [{"type", "description"}]
       77 LOADK                            R12 K12 ["string"]
       78 SETTABLEKS                       R12 R11 K9 ["type"]
       80 LOADK                            R12 K32 ["A one sentence summary of the plan."]
       81 SETTABLEKS                       R12 R11 K10 ["description"]
       83 SETTABLEKS                       R11 R10 K23 ["summary"]
       85 DUPTABLE                         R11 K11 [{"type", "description"}]
       86 LOADK                            R12 K12 ["string"]
       87 SETTABLEKS                       R12 R11 K9 ["type"]
       89 LOADK                            R12 K33 ["A short 2 to 6 word title for the plan."]
       90 SETTABLEKS                       R12 R11 K10 ["description"]
       92 SETTABLEKS                       R11 R10 K24 ["title"]
       94 SETTABLEKS                       R10 R9 K16 ["properties"]
       96 NEWTABLE                         R10 0 4
       98 LOADK                            R11 K21 ["completeDescription"]
       99 LOADK                            R12 K22 ["todo"]
      100 LOADK                            R13 K23 ["summary"]
      101 LOADK                            R14 K24 ["title"]
      102 SETLIST                          R10 R11 4 [1]
      104 SETTABLEKS                       R10 R9 K17 ["required"]
      106 NAMECALL                         R6 R5 K14 ["addArgument"]
      108 CALL                             R6 3 1
      109 DUPTABLE                         R8 K38 [{"title", "readOnlyHint", "destructiveHint", "idempotentHint", "openWorldHint"}]
      110 LOADK                            R9 K39 ["Finalize Plan"]
      111 SETTABLEKS                       R9 R8 K24 ["title"]
      113 LOADB                            R9 0
      114 SETTABLEKS                       R9 R8 K34 ["readOnlyHint"]
      116 LOADB                            R9 0
      117 SETTABLEKS                       R9 R8 K35 ["destructiveHint"]
      119 LOADB                            R9 0
      120 SETTABLEKS                       R9 R8 K36 ["idempotentHint"]
      122 LOADB                            R9 0
      123 SETTABLEKS                       R9 R8 K37 ["openWorldHint"]
      125 NAMECALL                         R6 R6 K40 ["setAnnotations"]
      127 CALL                             R6 2 1
      128 MOVE                             R8 R4
      129 NAMECALL                         R6 R6 K41 ["setHandler"]
      131 CALL                             R6 2 1
      132 NAMECALL                         R6 R6 K42 ["build"]
      134 CALL                             R6 1 1
      135 DUPTABLE                         R7 K46 [{"transformInitialContent", "getTransformPreExecuteFn", "getTransformResultFn"}]
      136 DUPCLOSURE                       R8 K47 [PROTO_2]
      137 CAPTURE                          UPVAL U5
      138 SETTABLEKS                       R8 R7 K43 ["transformInitialContent"]
      140 NEWCLOSURE                       R8 P3
      141 CAPTURE                          VAL R1
      142 CAPTURE                          VAL R3
      143 SETTABLEKS                       R8 R7 K44 ["getTransformPreExecuteFn"]
      145 NEWCLOSURE                       R8 P4
      146 CAPTURE                          VAL R1
      147 SETTABLEKS                       R8 R7 K45 ["getTransformResultFn"]
      149 DUPTABLE                         R8 K51 [{"definition", "contentWidgets", "streamTransform"}]
      150 SETTABLEKS                       R6 R8 K48 ["definition"]
      152 NEWTABLE                         R9 0 1
      154 GETUPVAL                         R10 5
      155 SETLIST                          R9 R10 1 [1]
      157 SETTABLEKS                       R9 R8 K49 ["contentWidgets"]
      159 SETTABLEKS                       R7 R8 K50 ["streamTransform"]
      161 RETURN                           R8 1
...
MAIN:
       ...
       43 CALL                             R5 1 1
       44 GETTABLEKS                       R6 R3 K17 ["ToolNames"]
       46 GETTABLEKS                       R7 R2 K13 ["Util"]
       48 GETTABLEKS                       R7 R7 K18 ["ToolBuilder"]
       50 GETTABLEKS                       R8 R2 K13 ["Util"]
