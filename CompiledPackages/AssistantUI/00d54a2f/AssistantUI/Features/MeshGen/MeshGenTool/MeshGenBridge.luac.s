...
PROTO_20:
       ...
       21 CALL                             R6 2 1
       22 SETTABLEKS                       R6 R3 K5 ["bridge"]
       24 GETTABLEKS                       R4 R2 K8 ["validateHasSelectedBoundingBoxAsync"]
       26 MOVE                             R5 R3
       27 CALL                             R4 1 -1
       28 RETURN                           R4 -1
...
PROTO_29:
        0 DUPTABLE                         R2 K8 [{"generateAssetsAsync", "cancelGenerationAsync", "publishAssetsAsync", "removeSelectedBoundsAsync", "insertAssetsAsync", "selectLinkedAssets", "listenToLinkChanges", "validateHasSelectedBoundingBoxAsync"}]
        1 NEWCLOSURE                       R3 P0
        2 CAPTURE                          UPVAL U0
        3 CAPTURE                          VAL R0
        4 CAPTURE                          VAL R1
       ...
       45 CAPTURE                          VAL R0
       46 CAPTURE                          VAL R1
       47 SETTABLEKS                       R3 R2 K7 ["validateHasSelectedBoundingBoxAsync"]
       49 RETURN                           R2 1
...
PROTO_30:
      ...
      187 CALL                             R11 3 1
      188 GETUPVAL                         R16 0
      189 GETTABLEKS                       R15 R16 K15 ["validateHasSelectedBoundingBox"]
      191 GETUPVAL                         R18 0
...
MAIN:
       ...
       26 CALL                             R3 1 1
       27 DUPTABLE                         R4 K22 [{"updateContentHeader", "setPreviewState", "setPreviewImage", "generateAssets", "cancelGeneration", "selectLinkedAssets", "publishAssets", "removeSelectedBounds", "insertAssets", "listenToLinkChanges", "validateHasSelectedBoundingBox"}]
       ...
       58 LOADK                            R5 K21 ["validateHasSelectedBoundingBox"]
       59 SETTABLEKS                       R5 R4 K21 ["validateHasSelectedBoundingBox"]
