PROTO_0:
        ...
        5 LOADK                            R3 K0 ["DEPRECATED_getNextContentId should not be called when FFlagAssistantMultipleChatSupport is enabled"]
...
PROTO_1:
        ...
        4 LOADK                            R3 K0 ["getNextContentId should only be called when FFlagAssistantMultipleChatSupport is enabled"]
...
PROTO_2:
        ...
        1 CALL                             R2 0 1
        2 FASTCALL2K                       ASSERT R2 K0 ; [+4]
        4 LOADK                            R3 K0 ["getContentMetadata should only be called when FFlagAssistantMultipleChatSupport is enabled"]
        5 GETIMPORT                        R1 K2 [assert]
        7 CALL                             R1 2 0
        8 GETUPVAL                         R2 1
        9 GETTABLE                         R1 R2 R0
...
PROTO_3:
        ...
        4 LOADK                            R4 K0 ["setContentMetadata should only be called when FFlagAssistantMultipleChatSupport is enabled"]
...
MAIN:
       ...
       22 GETTABLEKS                       R4 R5 K12 ["FFlagAssistantMultipleChatSupport"]
       24 CALL                             R3 1 1
