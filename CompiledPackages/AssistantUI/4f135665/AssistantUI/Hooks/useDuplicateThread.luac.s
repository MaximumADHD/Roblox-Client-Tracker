...
PROTO_3:
        ...
        4 LOADK                            R2 K0 ["useDuplicateThread is only available when FFlagAssistantMultipleChatSupport is enabled"]
        5 GETIMPORT                        R0 K2 [assert]
        7 CALL                             R0 2 0
        8 GETUPVAL                         R1 1
        9 CALL                             R1 0 1
       10 FASTCALL2K                       ASSERT R1 K3 ; [+4]
       12 LOADK                            R2 K3 ["useDuplicateThread is only available when FFlagAssistantPersistConversations is enabled"]
       13 GETIMPORT                        R0 K2 [assert]
       15 CALL                             R0 2 0
       16 GETUPVAL                         R1 2
       17 GETTABLEKS                       R0 R1 K4 ["useContext"]
       19 GETUPVAL                         R2 3
       20 GETTABLEKS                       R1 R2 K5 ["Context"]
       22 CALL                             R0 1 1
       23 GETTABLEKS                       R1 R0 K6 ["setConversation"]
       25 GETUPVAL                         R3 2
       26 GETTABLEKS                       R2 R3 K4 ["useContext"]
       28 GETUPVAL                         R4 4
       29 GETTABLEKS                       R3 R4 K5 ["Context"]
       31 CALL                             R2 1 1
       32 GETTABLEKS                       R3 R2 K7 ["sessionId"]
       34 GETUPVAL                         R5 2
       35 GETTABLEKS                       R4 R5 K8 ["useCallback"]
       37 NEWCLOSURE                       R5 P0
       38 CAPTURE                          UPVAL U5
       39 CAPTURE                          VAL R1
       40 CAPTURE                          UPVAL U6
...
MAIN:
       ...
       88 GETTABLEKS                       R13 R14 K23 ["FFlagAssistantMultipleChatSupport"]
       90 CALL                             R12 1 1
       91 GETIMPORT                        R13 K5 [require]
       93 GETTABLEKS                       R15 R0 K22 ["Flags"]
       95 GETTABLEKS                       R14 R15 K24 ["FFlagAssistantPersistConversations"]
       97 CALL                             R13 1 1
       98 DUPCLOSURE                       R14 K25 [PROTO_0]
       99 CAPTURE                          VAL R1
      100 DUPCLOSURE                       R15 K26 [PROTO_3]
      101 CAPTURE                          VAL R12
      102 CAPTURE                          VAL R13
      103 CAPTURE                          VAL R5
      104 CAPTURE                          VAL R3
