...
PROTO_2:
        ...
        5 DUPTABLE                         R4 K9 [{"requestHandler", "processEvent", "createLLMSession", "cancelSession", "formatTools", "systemMessage"}]
        6 NEWCLOSURE                       R5 P0
        7 CAPTURE                          UPVAL U2
       ...
       25 SETTABLEKS                       R4 R3 K1 ["studioProvider"]
       27 GETTABLEKS                       R4 R0 K12 ["children"]
       29 CALL                             R1 3 -1
       30 RETURN                           R1 -1
...
PROTO_7:
       ...
       11 CAPTURE                          VAL R2
       12 MOVE                             R5 R4
       13 DUPTABLE                         R6 K5 [{"getProcessEvent", "getCreateLLMSession", "wasRequestHandlerCalled", "getLastRequestHandlerBody"}]
       14 NEWCLOSURE                       R7 P1
       15 CAPTURE                          VAL R0
       16 SETTABLEKS                       R7 R6 K1 ["getProcessEvent"]
       18 NEWCLOSURE                       R7 P2
       19 CAPTURE                          VAL R1
       20 SETTABLEKS                       R7 R6 K2 ["getCreateLLMSession"]
       22 NEWCLOSURE                       R7 P3
       23 CAPTURE                          REF R3
       24 SETTABLEKS                       R7 R6 K3 ["wasRequestHandlerCalled"]
       26 NEWCLOSURE                       R7 P4
       27 CAPTURE                          REF R3
       28 SETTABLEKS                       R7 R6 K4 ["getLastRequestHandlerBody"]
       30 CLOSEUPVALS                      R3
       31 RETURN                           R5 2
