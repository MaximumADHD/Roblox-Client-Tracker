...
PROTO_4:
        0 DUPTABLE                         R0 K7 [{"requestHandler", "processEvent", "createLLMSession", "cancelSession", "formatTools", "systemMessage", "setSlashCommandCancel"}]
        1 GETUPVAL                         R1 0
...
PROTO_5:
       ...
       93 JUMPIFNOT                        R7 ; [+82]
       94 GETUPVAL                         R8 0
       95 GETTABLEKS                       R7 R8 K2 ["useMemo"]
       97 DUPCLOSURE                       R8 K12 [PROTO_1]
       98 CAPTURE                          UPVAL U15
       99 NEWTABLE                         R9 0 0
      101 CALL                             R7 2 1
      102 GETTABLEKS                       R8 R2 K13 ["processEvent"]
      104 JUMPIF                           R8 ; [+2]
      105 GETTABLEKS                       R8 R7 K13 ["processEvent"]
      107 GETTABLEKS                       R9 R2 K14 ["createLLMSession"]
      109 JUMPIF                           R9 ; [+2]
      110 GETTABLEKS                       R9 R7 K14 ["createLLMSession"]
      112 GETTABLEKS                       R10 R2 K15 ["cancelSession"]
      114 JUMPIF                           R10 ; [+2]
      115 GETTABLEKS                       R10 R7 K15 ["cancelSession"]
      117 GETUPVAL                         R12 0
      118 GETTABLEKS                       R11 R12 K16 ["useRef"]
      120 LOADNIL                          R12
      121 CALL                             R11 1 1
      122 GETUPVAL                         R13 0
      123 GETTABLEKS                       R12 R13 K17 ["useCallback"]
      125 NEWCLOSURE                       R13 P2
      126 CAPTURE                          VAL R11
      127 NEWTABLE                         R14 0 0
      129 CALL                             R12 2 1
      130 GETUPVAL                         R14 0
      131 GETTABLEKS                       R13 R14 K17 ["useCallback"]
      133 NEWCLOSURE                       R14 P3
      134 CAPTURE                          VAL R10
      135 CAPTURE                          VAL R11
      136 NEWTABLE                         R15 0 1
      138 MOVE                             R16 R10
      139 SETLIST                          R15 R16 1 [1]
      141 CALL                             R13 2 1
      142 GETTABLEKS                       R15 R2 K11 ["requestHandler"]
      144 OR                               R14 R15 R3
      145 GETTABLEKS                       R16 R2 K7 ["formatTools"]
      147 OR                               R15 R16 R4
      148 GETTABLEKS                       R17 R2 K18 ["systemMessage"]
      150 OR                               R16 R17 R5
      151 GETUPVAL                         R18 0
      152 GETTABLEKS                       R17 R18 K2 ["useMemo"]
      154 NEWCLOSURE                       R18 P4
      155 CAPTURE                          VAL R14
      156 CAPTURE                          VAL R8
      157 CAPTURE                          VAL R9
      158 CAPTURE                          VAL R13
      ...
      169 MOVE                             R25 R16
      170 MOVE                             R26 R12
      171 SETLIST                          R19 R20 7 [1]
      173 CALL                             R17 2 1
      174 MOVE                             R6 R17
      175 JUMP                             ; [+38]
      176 GETTABLEKS                       R7 R2 K13 ["processEvent"]
      178 GETTABLEKS                       R8 R2 K14 ["createLLMSession"]
      180 GETTABLEKS                       R9 R2 K15 ["cancelSession"]
      182 JUMPIFNOT                        R7 ; [+1]
      183 JUMPIF                           R8 ; [+7]
      184 GETUPVAL                         R11 15
      185 GETTABLEKS                       R10 R11 K19 ["createProcessEventHandler"]
      187 CALL                             R10 0 3
      188 MOVE                             R7 R10
      189 MOVE                             R8 R11
      190 MOVE                             R9 R12
      191 DUPTABLE                         R10 K20 [{"requestHandler", "processEvent", "createLLMSession", "cancelSession", "formatTools", "systemMessage"}]
      192 GETTABLEKS                       R12 R2 K11 ["requestHandler"]
      194 OR                               R11 R12 R3
      195 SETTABLEKS                       R11 R10 K11 ["requestHandler"]
      197 SETTABLEKS                       R7 R10 K13 ["processEvent"]
      199 SETTABLEKS                       R8 R10 K14 ["createLLMSession"]
      201 SETTABLEKS                       R9 R10 K15 ["cancelSession"]
      203 GETTABLEKS                       R12 R2 K7 ["formatTools"]
      205 OR                               R11 R12 R4
      206 SETTABLEKS                       R11 R10 K7 ["formatTools"]
      208 GETTABLEKS                       R12 R2 K18 ["systemMessage"]
      210 OR                               R11 R12 R5
      211 SETTABLEKS                       R11 R10 K18 ["systemMessage"]
      213 MOVE                             R6 R10
      214 GETUPVAL                         R7 16
      215 GETUPVAL                         R9 17
      216 GETTABLEKS                       R8 R9 K21 ["Provider"]
      218 DUPTABLE                         R9 K23 [{"value"}]
      219 SETTABLEKS                       R6 R9 K22 ["value"]
      221 GETTABLEKS                       R10 R0 K24 ["children"]
      223 CALL                             R7 3 -1
      224 RETURN                           R7 -1
