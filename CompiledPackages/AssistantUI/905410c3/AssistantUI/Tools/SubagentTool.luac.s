PROTO_0:
        ...
        4 JUMPIFNOT                        R0 ; [+7]
        5 GETUPVAL                         R3 1
        6 GETTABLEKS                       R2 R3 K0 ["getVisibleSubagents"]
        8 MOVE                             R3 R0
        9 CALL                             R2 1 1
       10 MOVE                             R1 R2
       11 JUMP                             ; [+5]
       12 GETUPVAL                         R3 1
       13 GETTABLEKS                       R2 R3 K1 ["getAll"]
       15 CALL                             R2 0 1
       16 MOVE                             R1 R2
       17 NEWTABLE                         R2 0 0
       19 MOVE                             R3 R1
...
PROTO_2:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R0 R1 K0 ["callTool"]
        3 GETUPVAL                         R1 1
        4 GETUPVAL                         R2 2
        5 GETUPVAL                         R3 3
        6 CALL                             R0 3 -1
...
PROTO_9:
       ...
       68 JUMPIFNOT                        R7 ; [+28]
       69 GETTABLEKS                       R8 R2 K18 ["signal"]
       71 GETTABLEKS                       R7 R8 K19 ["aborted"]
       73 JUMPIFNOT                        R7 ; [+14]
       74 GETUPVAL                         R7 1
       75 CALL                             R7 0 1
       ...
       86 CALL                             R7 1 -1
       87 RETURN                           R7 -1
       88 GETTABLEKS                       R8 R2 K18 ["signal"]
       90 GETTABLEKS                       R7 R8 K21 ["abortSignal"]
       92 NEWCLOSURE                       R9 P1
       93 CAPTURE                          VAL R6
       94 NAMECALL                         R7 R7 K22 ["Connect"]
       96 CALL                             R7 2 0
       97 GETUPVAL                         R8 4
       98 GETTABLEKS                       R7 R8 K23 ["execute"]
      100 DUPTABLE                         R8 K31 [{"definition", "prompt", "requestLLM", "callTool", "formattedTools", "contentId", "onPacketReceived"}]
      101 SETTABLEKS                       R3 R8 K24 ["definition"]
      103 GETTABLEKS                       R9 R0 K32 ["task"]
      ...
      137 NEWCLOSURE                       R9 P3
      138 CAPTURE                          VAL R2
      139 SETTABLEKS                       R9 R8 K30 ["onPacketReceived"]
      141 MOVE                             R9 R6
      142 CALL                             R7 2 1
      143 GETTABLEKS                       R8 R7 K33 ["error"]
      145 JUMPIFNOT                        R8 ; [+22]
      146 GETUPVAL                         R8 1
      147 CALL                             R8 0 1
      148 LOADK                            R11 K34 ["Subagent encountered an error: %*\n\nPartial result:\n%*"]
      149 GETTABLEKS                       R13 R7 K33 ["error"]
      151 GETTABLEKS                       R14 R7 K35 ["finalAnswer"]
      153 NAMECALL                         R11 R11 K8 ["format"]
      155 CALL                             R11 3 1
      156 MOVE                             R10 R11
      157 NAMECALL                         R8 R8 K9 ["addText"]
      159 CALL                             R8 2 1
      160 LOADB                            R10 1
      161 NAMECALL                         R8 R8 K10 ["setError"]
      163 CALL                             R8 2 1
      164 NAMECALL                         R8 R8 K11 ["build"]
      166 CALL                             R8 1 -1
      167 RETURN                           R8 -1
      168 GETUPVAL                         R8 1
      169 CALL                             R8 0 1
      170 GETTABLEKS                       R10 R7 K35 ["finalAnswer"]
      172 NAMECALL                         R8 R8 K9 ["addText"]
      174 CALL                             R8 2 1
      175 NAMECALL                         R8 R8 K11 ["build"]
      177 CALL                             R8 1 -1
      178 RETURN                           R8 -1
...
PROTO_15:
        ...
        5 CAPTURE                          UPVAL U4
        6 GETUPVAL                         R3 0
        7 GETTABLEKS                       R2 R3 K1 ["getNames"]
        9 CALL                             R2 0 1
       10 GETIMPORT                        R3 K4 [table.sort]
       12 MOVE                             R4 R2
       13 CALL                             R3 1 0
       14 GETUPVAL                         R4 5
       15 GETTABLEKS                       R3 R4 K5 ["define"]
       17 CALL                             R3 0 1
       ...
       65 CALL                             R3 3 1
       66 MOVE                             R5 R1
       67 NAMECALL                         R3 R3 K22 ["setHandler"]
       69 CALL                             R3 2 1
       70 NAMECALL                         R3 R3 K23 ["build"]
       72 CALL                             R3 1 1
       73 DUPTABLE                         R4 K27 [{"transformInitialContent", "getTransformPreExecuteFn", "getTransformResultFn"}]
       74 DUPCLOSURE                       R5 K28 [PROTO_10]
       75 CAPTURE                          UPVAL U7
       76 SETTABLEKS                       R5 R4 K24 ["transformInitialContent"]
       78 DUPCLOSURE                       R5 K29 [PROTO_12]
       79 SETTABLEKS                       R5 R4 K25 ["getTransformPreExecuteFn"]
       81 DUPCLOSURE                       R5 K30 [PROTO_14]
       82 SETTABLEKS                       R5 R4 K26 ["getTransformResultFn"]
       84 DUPTABLE                         R5 K36 [{"definition", "toolCallOptions", "contentWidgets", "streamTransform", "getDescription"}]
       85 SETTABLEKS                       R3 R5 K31 ["definition"]
       87 DUPTABLE                         R6 K39 [{"timeout", "resetTimeoutOnProgress"}]
       88 LOADK                            R7 K40 [600000]
       89 SETTABLEKS                       R7 R6 K37 ["timeout"]
       91 LOADB                            R7 1
       92 SETTABLEKS                       R7 R6 K38 ["resetTimeoutOnProgress"]
       94 SETTABLEKS                       R6 R5 K32 ["toolCallOptions"]
       96 NEWTABLE                         R6 0 1
       98 GETUPVAL                         R7 7
       99 SETLIST                          R6 R7 1 [1]
      101 SETTABLEKS                       R6 R5 K33 ["contentWidgets"]
      103 SETTABLEKS                       R4 R5 K34 ["streamTransform"]
      105 GETUPVAL                         R6 6
      106 SETTABLEKS                       R6 R5 K35 ["getDescription"]
      108 RETURN                           R5 1
...
MAIN:
       ...
       53 GETTABLEKS                       R8 R9 K17 ["FFlagAssistantDynamicToolDescription"]
       55 CALL                             R7 1 1
       56 GETTABLEKS                       R9 R1 K18 ["Util"]
       58 GETTABLEKS                       R8 R9 K19 ["ToolBuilder"]
       60 GETTABLEKS                       R10 R1 K18 ["Util"]
       62 GETTABLEKS                       R9 R10 K20 ["ToolResult"]
