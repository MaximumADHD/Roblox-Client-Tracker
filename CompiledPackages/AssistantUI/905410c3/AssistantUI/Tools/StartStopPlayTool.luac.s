...
PROTO_2:
       ...
       23 GETUPVAL                         R6 1
       24 GETTABLEKS                       R5 R6 K5 ["subscribeOutput"]
       ...
       30 SETUPVAL                         R5 5
       31 GETUPVAL                         R6 1
       32 GETTABLEKS                       R5 R6 K7 ["startStopPlayAsync"]
       34 LOADB                            R6 1
       35 CALL                             R5 1 0
       36 JUMPIF                           R2 ; [+3]
       ...
       58 CALL                             R2 1 0
       59 GETUPVAL                         R3 1
       60 GETTABLEKS                       R2 R3 K7 ["startStopPlayAsync"]
       62 LOADB                            R3 0
       63 CALL                             R2 1 0
       64 GETUPVAL                         R2 7
       65 CALL                             R2 0 1
...
PROTO_8:
       ...
       24 CAPTURE                          UPVAL U5
       25 GETUPVAL                         R10 6
       26 GETTABLEKS                       R9 R10 K2 ["define"]
       28 CALL                             R9 0 1
       29 GETUPVAL                         R12 7
       30 GETTABLEKS                       R11 R12 K3 ["StartStopPlay"]
       ...
       49 CALL                             R9 3 1
       50 MOVE                             R11 R8
       51 NAMECALL                         R9 R9 K14 ["setHandler"]
       53 CALL                             R9 2 1
       54 NAMECALL                         R9 R9 K15 ["build"]
       56 CALL                             R9 1 1
       57 DUPTABLE                         R10 K19 [{"definition", "getPreExecuteWarning", "displayNameFunction"}]
       58 SETTABLEKS                       R9 R10 K16 ["definition"]
       60 DUPCLOSURE                       R11 K20 [PROTO_6]
       61 CAPTURE                          UPVAL U8
       62 SETTABLEKS                       R11 R10 K17 ["getPreExecuteWarning"]
       64 DUPCLOSURE                       R11 K21 [PROTO_7]
       65 CAPTURE                          UPVAL U9
       66 SETTABLEKS                       R11 R10 K18 ["displayNameFunction"]
       68 CLOSEUPVALS                      R3
       69 RETURN                           R10 1
...
MAIN:
       ...
       56 GETTABLEKS                       R9 R10 K19 ["FFlagAssistantGetConsoleOutputUsesFullLogHistory"]
       58 CALL                             R8 1 1
       59 GETIMPORT                        R9 K5 [require]
       61 GETTABLEKS                       R11 R0 K18 ["Flags"]
       63 GETTABLEKS                       R10 R11 K20 ["FFlagAssistantStartStopPlayBusyCheck"]
       65 CALL                             R9 1 1
       66 GETIMPORT                        R10 K5 [require]
       68 GETTABLEKS                       R12 R0 K18 ["Flags"]
       70 GETTABLEKS                       R11 R12 K21 ["FFlagDisableStartStopPlayConfirmation"]
       72 CALL                             R10 1 1
       73 GETIMPORT                        R11 K5 [require]
       75 GETTABLEKS                       R13 R0 K18 ["Flags"]
       77 GETTABLEKS                       R12 R13 K22 ["FIntAssistantDebugToolMaxOutput"]
       79 CALL                             R11 1 1
