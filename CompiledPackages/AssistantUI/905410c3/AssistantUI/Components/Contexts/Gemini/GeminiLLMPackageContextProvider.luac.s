...
PROTO_1:
       ...
       21 JUMPIF                           R5 ; [+4]
       22 GETUPVAL                         R6 2
       23 GETTABLEKS                       R5 R6 K5 ["createRequestHandler"]
       25 CALL                             R5 0 1
       26 GETTABLEKS                       R6 R0 K6 ["formatTools"]
       28 JUMPIF                           R6 ; [+3]
       29 GETUPVAL                         R7 3
       30 GETTABLEKS                       R6 R7 K6 ["formatTools"]
       32 GETTABLEKS                       R7 R0 K7 ["systemMessage"]
       34 JUMPIF                           R7 ; [+4]
       35 GETUPVAL                         R8 4
       36 GETTABLEKS                       R7 R8 K8 ["getSystemMessage"]
       38 CALL                             R7 0 1
       39 GETUPVAL                         R9 5
       40 GETTABLEKS                       R8 R9 K9 ["useMemo"]
       42 NEWCLOSURE                       R9 P0
       43 CAPTURE                          VAL R5
       44 CAPTURE                          REF R1
       45 CAPTURE                          REF R2
       ...
       65 JUMPIF                           R6 ; [+4]
       66 GETUPVAL                         R7 2
       67 GETTABLEKS                       R6 R7 K5 ["createRequestHandler"]
       69 CALL                             R6 0 1
       ...
       80 JUMPIF                           R6 ; [+3]
       81 GETUPVAL                         R7 3
       82 GETTABLEKS                       R6 R7 K6 ["formatTools"]
       84 SETTABLEKS                       R6 R5 K6 ["formatTools"]
       86 GETTABLEKS                       R6 R0 K7 ["systemMessage"]
       88 JUMPIF                           R6 ; [+4]
       89 GETUPVAL                         R7 4
       90 GETTABLEKS                       R6 R7 K8 ["getSystemMessage"]
       92 CALL                             R6 0 1
       93 SETTABLEKS                       R6 R5 K7 ["systemMessage"]
       95 MOVE                             R4 R5
       96 GETUPVAL                         R5 6
       97 GETUPVAL                         R8 7
       98 GETTABLEKS                       R7 R8 K11 ["Context"]
      100 GETTABLEKS                       R6 R7 K12 ["Provider"]
...
MAIN:
       ...
       40 GETTABLEKS                       R4 R5 K13 ["Gemini"]
       42 GETIMPORT                        R5 K5 [require]
       44 GETTABLEKS                       R6 R4 K14 ["GeminiLLMRequest"]
       46 CALL                             R5 1 1
       47 GETIMPORT                        R6 K5 [require]
       49 GETTABLEKS                       R7 R4 K15 ["GeminiLLMSystemMessage"]
       51 CALL                             R6 1 1
       52 GETIMPORT                        R7 K5 [require]
       54 GETTABLEKS                       R8 R4 K16 ["GeminiLLMToolFormat"]
       56 CALL                             R7 1 1
       57 GETIMPORT                        R8 K5 [require]
       59 GETTABLEKS                       R10 R0 K17 ["Flags"]
       61 GETTABLEKS                       R9 R10 K18 ["FFlagAssistantUseMemoizedContextValues"]
       63 CALL                             R8 1 1
