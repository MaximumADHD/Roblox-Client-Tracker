...
PROTO_5:
       ...
       70 GETUPVAL                         R10 1
       71 GETTABLEKS                       R9 R10 K5 ["Components"]
       73 GETTABLEKS                       R8 R9 K6 ["ContentWidgets"]
       75 GETTABLEKS                       R7 R8 K13 ["ScriptChangeConfirmationContentWidget"]
       77 CALL                             R6 1 1
       78 NEWTABLE                         R7 0 6
       80 MOVE                             R8 R3
       81 MOVE                             R9 R4
       ...
       84 MOVE                             R12 R1
       85 MOVE                             R13 R2
       86 SETLIST                          R7 R8 6 [1]
       88 GETUPVAL                         R8 2
       89 CALL                             R8 0 1
       90 JUMPIFNOT                        R8 ; [+7]
       91 FASTCALL2                        TABLE_INSERT R7 R6 ; [+5]
       93 MOVE                             R9 R7
       94 MOVE                             R10 R6
       95 GETIMPORT                        R8 K16 [table.insert]
       97 CALL                             R8 2 0
       98 GETUPVAL                         R9 3
       99 GETTABLEKS                       R8 R9 K17 ["registerWidgetList"]
      101 MOVE                             R9 R7
      102 CALL                             R8 1 -1
      103 RETURN                           R8 -1
...
MAIN:
       ...
       38 GETTABLEKS                       R6 R7 K15 ["FFlagAssistantMultiEditConfirmation"]
       40 CALL                             R5 1 1
       41 GETIMPORT                        R6 K5 [require]
       43 GETTABLEKS                       R8 R1 K14 ["Flags"]
       45 GETTABLEKS                       R7 R8 K16 ["FFlagAssistantPersistConversations"]
       47 CALL                             R6 1 1
       48 GETIMPORT                        R7 K5 [require]
       50 GETTABLEKS                       R9 R1 K14 ["Flags"]
       52 GETTABLEKS                       R8 R9 K17 ["FFlagAssistantRegisterWidgetsThroughTools"]
       54 CALL                             R7 1 1
       55 NEWTABLE                         R8 0 0
       57 LOADK                            R9 K18 ["MISSING"]
       58 SETTABLEKS                       R9 R0 K19 ["MISSING_CONTENT_WIDGET"]
       60 NEWCLOSURE                       R9 P0
       61 CAPTURE                          VAL R0
       62 CAPTURE                          REF R8
       63 CAPTURE                          VAL R6
       64 CAPTURE                          VAL R4
       65 SETTABLEKS                       R9 R0 K20 ["registerWidget"]
       67 NEWCLOSURE                       R9 P1
       68 CAPTURE                          VAL R7
       69 CAPTURE                          REF R8
       70 SETTABLEKS                       R9 R0 K21 ["registerWidget_DEPRECATED"]
       72 DUPCLOSURE                       R9 K22 [PROTO_4]
       73 CAPTURE                          VAL R7
       74 CAPTURE                          VAL R0
       75 SETTABLEKS                       R9 R0 K23 ["registerWidgetList"]
       77 DUPCLOSURE                       R9 K24 [PROTO_5]
       78 CAPTURE                          VAL R7
       79 CAPTURE                          VAL R1
       80 CAPTURE                          VAL R5
       81 CAPTURE                          VAL R0
       82 SETTABLEKS                       R9 R0 K25 ["registerDefaultWidgets"]
       84 NEWCLOSURE                       R9 P4
       85 CAPTURE                          VAL R7
       86 CAPTURE                          REF R8
       87 CAPTURE                          VAL R2
       88 SETTABLEKS                       R9 R0 K26 ["get"]
       90 NEWCLOSURE                       R9 P5
       91 CAPTURE                          VAL R7
       92 CAPTURE                          REF R8
       93 SETTABLEKS                       R9 R0 K27 ["clear"]
       95 CLOSEUPVALS                      R8
       96 RETURN                           R0 1
