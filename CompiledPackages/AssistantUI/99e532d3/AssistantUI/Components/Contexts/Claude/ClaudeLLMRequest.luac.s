...
PROTO_4:
        ...
        7 LOADK                            R3 K2 ["--- ClaudeLLMRequest error response body: %*"]
        8 MOVE                             R5 R0
       ...
       15 JUMPIFNOT                        R1 ; [+4]
       16 GETUPVAL                         R1 2
       17 NAMECALL                         R1 R1 K4 ["Close"]
       19 CALL                             R1 1 0
       20 RETURN                           R0 0
       21 GETUPVAL                         R2 3
       22 GETTABLEKS                       R1 R2 K5 ["parseNextChunk"]
       24 MOVE                             R2 R0
       25 CALL                             R1 1 0
       26 RETURN                           R0 0

PROTO_5:
        0 JUMPIFEQKN                       R0 K0 [200] ; [+64]
...
PROTO_7:
       ...
       15 MOVE                             R2 R3
       16 DUPTABLE                         R3 K10 [{"model", "max_tokens", "messages", "tools", "system", "stream", "tool_choice"}]
       17 SETTABLEKS                       R2 R3 K3 ["model"]
       19 LOADK                            R4 K11 [64000]
       ...
       35 LOADK                            R6 K13 ["text"]
       36 SETTABLEKS                       R6 R5 K12 ["type"]
       38 GETTABLEKS                       R6 R0 K7 ["system"]
       40 SETTABLEKS                       R6 R5 K13 ["text"]
       42 DUPTABLE                         R6 K16 [{"type"}]
       43 LOADK                            R7 K17 ["ephemeral"]
       44 SETTABLEKS                       R7 R6 K12 ["type"]
       46 SETTABLEKS                       R6 R5 K14 ["cache_control"]
       48 SETLIST                          R4 R5 1 [1]
       50 SETTABLEKS                       R4 R3 K7 ["system"]
       52 LOADB                            R4 1
       53 SETTABLEKS                       R4 R3 K8 ["stream"]
       55 DUPTABLE                         R4 K19 [{"type", "disable_parallel_tool_use"}]
       56 LOADK                            R5 K20 ["auto"]
       57 SETTABLEKS                       R5 R4 K12 ["type"]
       59 LOADB                            R5 1
       60 SETTABLEKS                       R5 R4 K18 ["disable_parallel_tool_use"]
       62 SETTABLEKS                       R4 R3 K9 ["tool_choice"]
       64 GETTABLEKS                       R5 R0 K21 ["apiKeys"]
       66 JUMPIFNOT                        R5 ; [+14]
       67 GETTABLEKS                       R6 R0 K21 ["apiKeys"]
       69 GETUPVAL                         R8 2
       70 GETTABLEKS                       R7 R8 K22 ["CLAUDE_API_KEY"]
       72 GETTABLE                         R5 R6 R7
       73 JUMPIFNOT                        R5 ; [+7]
       74 GETTABLEKS                       R5 R0 K21 ["apiKeys"]
       76 GETUPVAL                         R7 2
       77 GETTABLEKS                       R6 R7 K22 ["CLAUDE_API_KEY"]
       ...
       87 CALL                             R5 0 1
       88 JUMPIFNOT                        R5 ; [+16]
       89 GETIMPORT                        R5 K24 [print]
       91 LOADK                            R7 K25 ["--- ClaudeLLMRequest requestBody: %*"]
       92 GETUPVAL                         R11 6
       93 GETTABLEKS                       R10 R11 K26 ["Json"]
       95 GETTABLEKS                       R9 R10 K27 ["encode"]
       97 MOVE                             R10 R3
       98 CALL                             R9 1 1
       99 NAMECALL                         R7 R7 K28 ["format"]
      101 CALL                             R7 2 1
      102 MOVE                             R6 R7
      103 CALL                             R5 1 0
      104 JUMP                             ; [+13]
      105 GETIMPORT                        R5 K24 [print]
      107 LOADK                            R7 K25 ["--- ClaudeLLMRequest requestBody: %*"]
      108 GETUPVAL                         R9 7
      109 MOVE                             R11 R3
      110 NAMECALL                         R9 R9 K29 ["JSONEncode"]
      112 CALL                             R9 2 1
      113 NAMECALL                         R7 R7 K28 ["format"]
      115 CALL                             R7 2 1
      116 MOVE                             R6 R7
      117 CALL                             R5 1 0
      118 LOADNIL                          R5
      ...
      121 JUMPIFNOT                        R6 ; [+9]
      122 GETUPVAL                         R8 6
      123 GETTABLEKS                       R7 R8 K26 ["Json"]
      125 GETTABLEKS                       R6 R7 K27 ["encode"]
      127 MOVE                             R7 R3
      128 CALL                             R6 1 1
      129 MOVE                             R5 R6
      130 JUMP                             ; [+6]
      131 GETUPVAL                         R6 7
      132 MOVE                             R8 R3
      133 NAMECALL                         R6 R6 K29 ["JSONEncode"]
      135 CALL                             R6 2 1
      136 MOVE                             R5 R6
      137 GETUPVAL                         R7 8
      138 GETTABLEKS                       R6 R7 K30 ["get"]
      140 CALL                             R6 0 1
      141 GETTABLEKS                       R8 R6 K31 ["http"]
      143 GETTABLEKS                       R7 R8 K32 ["createWebStreamClient"]
      145 GETIMPORT                        R8 K36 [Enum.WebStreamClientType.RawStream]
      147 DUPTABLE                         R9 K41 [{"Method", "Url", "Headers", "Body"}]
      148 LOADK                            R10 K42 ["POST"]
      149 SETTABLEKS                       R10 R9 K37 ["Method"]
      151 LOADK                            R10 K43 ["https://api.anthropic.com/v1/messages"]
      152 SETTABLEKS                       R10 R9 K38 ["Url"]
      154 NEWTABLE                         R10 4 0
      156 LOADK                            R11 K44 ["application/json"]
      157 SETTABLEKS                       R11 R10 K45 ["content-type"]
      159 SETTABLEKS                       R4 R10 K46 ["x-api-key"]
      161 LOADK                            R11 K47 ["2023-06-01"]
      162 SETTABLEKS                       R11 R10 K48 ["anthropic-version"]
      164 SETTABLEKS                       R10 R9 K39 ["Headers"]
      166 SETTABLEKS                       R5 R9 K40 ["Body"]
      168 CALL                             R7 2 1
      169 FASTCALL2K                       ASSERT R7 K49 ; [+5]
      171 MOVE                             R9 R7
      172 LOADK                            R10 K49 ["WebStreamClient should not be nil"]
      173 GETIMPORT                        R8 K51 [assert]
      175 CALL                             R8 2 0
      176 GETUPVAL                         R9 9
      177 GETTABLEKS                       R8 R9 K52 ["createParser"]
      179 DUPTABLE                         R9 K56 [{"onEvent", "onError", "onComment"}]
      ...
      186 CAPTURE                          VAL R1
      187 SETTABLEKS                       R10 R9 K53 ["onEvent"]
      189 DUPCLOSURE                       R10 K57 [PROTO_2]
      190 CAPTURE                          UPVAL U4
      191 SETTABLEKS                       R10 R9 K54 ["onError"]
      193 DUPCLOSURE                       R10 K58 [PROTO_3]
      194 CAPTURE                          UPVAL U4
      195 SETTABLEKS                       R10 R9 K55 ["onComment"]
      197 CALL                             R8 1 1
      198 LOADB                            R9 1
      199 GETTABLEKS                       R10 R7 K59 ["MessageReceived"]
      201 NEWCLOSURE                       R12 P3
      202 CAPTURE                          UPVAL U11
      203 CAPTURE                          REF R9
      204 CAPTURE                          REF R7
      205 CAPTURE                          VAL R8
      206 NAMECALL                         R10 R10 K60 ["Connect"]
      208 CALL                             R10 2 1
      209 GETTABLEKS                       R11 R7 K61 ["Opened"]
      211 NEWCLOSURE                       R13 P4
      ...
      217 CAPTURE                          REF R9
      218 CAPTURE                          REF R7
      219 NAMECALL                         R11 R11 K60 ["Connect"]
      221 CALL                             R11 2 1
      222 GETTABLEKS                       R12 R7 K62 ["Closed"]
      224 NEWCLOSURE                       R14 P5
      225 CAPTURE                          UPVAL U4
      226 CAPTURE                          REF R10
      227 CAPTURE                          REF R11
      228 CAPTURE                          REF R7
      229 NAMECALL                         R12 R12 K63 ["Once"]
      231 CALL                             R12 2 0
      232 CLOSEUPVALS                      R2
      233 RETURN                           R0 0
...
MAIN:
       ...
       58 GETTABLEKS                       R8 R9 K22 ["FFlagAssistantClaudeErrorResponse"]
       60 CALL                             R7 1 1
       61 GETIMPORT                        R8 K9 [require]
       63 GETTABLEKS                       R10 R0 K21 ["Flags"]
       65 GETTABLEKS                       R9 R10 K23 ["FFlagAssistantJsonEncoder"]
       67 CALL                             R8 1 1
       68 GETIMPORT                        R9 K9 [require]
       70 GETTABLEKS                       R11 R0 K21 ["Flags"]
       72 GETTABLEKS                       R10 R11 K24 ["FFlagDebugLogAssistantUI"]
       74 CALL                             R9 1 1
