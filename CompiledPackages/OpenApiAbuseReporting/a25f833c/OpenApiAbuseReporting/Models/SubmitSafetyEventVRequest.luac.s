PROTO_0:
       ...
       23 CALL                             R3 2 0
       24 RETURN                           R0 1
       25 GETTABLEKS                       R3 R0 K7 ["labelSet"]
       27 JUMPIFEQKNIL                     R3 ; [+16]
       29 GETUPVAL                         R3 0
       30 GETTABLEKS                       R3 R3 K8 ["fromResponse"]
       32 GETTABLEKS                       R4 R0 K7 ["labelSet"]
       34 MOVE                             R5 R1
       35 LOADK                            R7 K9 ["%*\"labelSet\" > "]
       36 MOVE                             R9 R2
       37 NAMECALL                         R7 R7 K4 ["format"]
       39 CALL                             R7 2 1
       40 MOVE                             R6 R7
       41 CALL                             R3 3 1
       42 SETTABLEKS                       R3 R0 K7 ["labelSet"]
       44 GETUPVAL                         R3 1
       45 GETTABLEKS                       R3 R3 K8 ["fromResponse"]
       47 GETTABLEKS                       R4 R0 K10 ["safetyEvent"]
       49 MOVE                             R5 R1
       50 LOADK                            R7 K11 ["%*\"safetyEvent\" > "]
       51 MOVE                             R9 R2
       52 NAMECALL                         R7 R7 K4 ["format"]
       54 CALL                             R7 2 1
       55 MOVE                             R6 R7
       56 CALL                             R3 3 1
       57 SETTABLEKS                       R3 R0 K10 ["safetyEvent"]
       59 RETURN                           R0 1
