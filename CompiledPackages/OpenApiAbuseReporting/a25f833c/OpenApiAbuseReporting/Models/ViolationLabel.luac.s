PROTO_0:
       ...
       23 CALL                             R3 2 0
       24 RETURN                           R0 1
       25 GETTABLEKS                       R4 R0 K7 ["responsibleRobloxUserId"]
       27 FASTCALL1                        TYPEOF R4 ; [+2]
       28 GETIMPORT                        R3 K1 [typeof]
       30 CALL                             R3 1 1
       31 JUMPIFEQKS                       R3 K8 ["number"] ; [+19]
       33 LOADK                            R6 K9 ["%*\"responsibleRobloxUserId\" > Expected number, got %*"]
       34 MOVE                             R8 R2
       35 GETTABLEKS                       R10 R0 K7 ["responsibleRobloxUserId"]
       ...
       50 CALL                             R3 2 0
       51 GETTABLEKS                       R4 R0 K10 ["violationType"]
       53 FASTCALL1                        TYPEOF R4 ; [+2]
       54 GETIMPORT                        R3 K1 [typeof]
       56 CALL                             R3 1 1
       57 JUMPIFEQKS                       R3 K11 ["string"] ; [+19]
       59 LOADK                            R6 K12 ["%*\"violationType\" > Expected string, got %*"]
       60 MOVE                             R8 R2
       61 GETTABLEKS                       R10 R0 K10 ["violationType"]
