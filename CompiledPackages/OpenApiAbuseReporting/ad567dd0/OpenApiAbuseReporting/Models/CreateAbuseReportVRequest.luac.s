PROTO_0:
       ...
       22 CALL                             R3 2 0
       23 RETURN                           R0 1
       24 GETTABLEKS                       R4 R0 K7 ["tags"]
       26 FASTCALL1                        TYPEOF R4 ; [+2]
       27 GETIMPORT                        R3 K1 [typeof]
       29 CALL                             R3 1 1
       30 JUMPIFEQKS                       R3 K2 ["table"] ; [+19]
       32 LOADK                            R5 K8 ["%*\"tags\" > Expected table, got %*"]
       33 MOVE                             R7 R2
       34 GETTABLEKS                       R9 R0 K7 ["tags"]
       ...
       59 CALL                             R8 1 1
       60 JUMPIFEQKS                       R8 K9 ["string"] ; [+19]
       62 LOADK                            R10 K10 ["%*\"tags\" > Expected key of type string, got %* as %*"]
       63 MOVE                             R12 R2
       64 MOVE                             R13 R6
       ...
       78 CALL                             R8 2 0
       79 JUMP                             ; [+15]
       80 GETTABLEKS                       R8 R0 K7 ["tags"]
       82 GETUPVAL                         R9 0
       83 GETTABLEKS                       R9 R9 K11 ["fromResponse"]
       85 MOVE                             R10 R7
       86 MOVE                             R11 R1
       87 LOADK                            R12 K12 ["%*\"tags\" > [\"%*\"] > "]
       88 MOVE                             R14 R2
       89 MOVE                             R15 R6
