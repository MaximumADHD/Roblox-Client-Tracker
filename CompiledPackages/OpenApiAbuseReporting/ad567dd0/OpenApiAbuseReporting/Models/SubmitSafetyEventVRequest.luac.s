PROTO_0:
       ...
       22 CALL                             R3 2 0
       23 RETURN                           R0 1
       24 GETTABLEKS                       R3 R0 K7 ["labelSet"]
       26 JUMPIFEQKNIL                     R3 ; [+15]
       28 GETUPVAL                         R3 0
       29 GETTABLEKS                       R3 R3 K8 ["fromResponse"]
       31 GETTABLEKS                       R4 R0 K7 ["labelSet"]
       33 MOVE                             R5 R1
       34 LOADK                            R6 K9 ["%*\"labelSet\" > "]
       35 MOVE                             R8 R2
       36 NAMECALL                         R6 R6 K4 ["format"]
       38 CALL                             R6 2 1
       39 CALL                             R3 3 1
       40 SETTABLEKS                       R3 R0 K7 ["labelSet"]
       42 GETUPVAL                         R3 1
       43 GETTABLEKS                       R3 R3 K8 ["fromResponse"]
       45 GETTABLEKS                       R4 R0 K10 ["safetyEvent"]
       47 MOVE                             R5 R1
       48 LOADK                            R6 K11 ["%*\"safetyEvent\" > "]
       49 MOVE                             R8 R2
       50 NAMECALL                         R6 R6 K4 ["format"]
       52 CALL                             R6 2 1
       53 CALL                             R3 3 1
       54 SETTABLEKS                       R3 R0 K10 ["safetyEvent"]
       56 RETURN                           R0 1
...
PROTO_1:
        ...
        2 MOVE                             R2 R0
        3 CALL                             R1 1 1
        4 GETTABLEKS                       R2 R1 K3 ["labelSet"]
        6 JUMPIFEQKNIL                     R2 ; [+9]
        8 GETUPVAL                         R2 0
        9 GETTABLEKS                       R2 R2 K4 ["toRequest"]
       11 GETTABLEKS                       R3 R1 K3 ["labelSet"]
       13 CALL                             R2 1 1
       14 SETTABLEKS                       R2 R1 K3 ["labelSet"]
       16 GETUPVAL                         R2 1
       17 GETTABLEKS                       R2 R2 K4 ["toRequest"]
       19 GETTABLEKS                       R3 R1 K5 ["safetyEvent"]
       21 CALL                             R2 1 1
       22 SETTABLEKS                       R2 R1 K5 ["safetyEvent"]
       24 RETURN                           R1 1
...
MAIN:
       ...
       18 GETTABLEKS                       R4 R4 K9 ["LabelSet"]
       20 CALL                             R3 1 1
       21 GETIMPORT                        R4 K6 [require]
       23 GETTABLEKS                       R5 R0 K8 ["Models"]
       25 GETTABLEKS                       R5 R5 K10 ["SafetyEvent"]
       27 CALL                             R4 1 1
