PROTO_0:
       ...
       22 CALL                             R3 2 0
       23 RETURN                           R0 1
       24 GETTABLEKS                       R3 R0 K7 ["humanLabeler"]
       26 JUMPIFEQKNIL                     R3 ; [+15]
       28 GETUPVAL                         R3 0
       29 GETTABLEKS                       R3 R3 K8 ["fromResponse"]
       31 GETTABLEKS                       R4 R0 K7 ["humanLabeler"]
       33 MOVE                             R5 R1
       34 LOADK                            R6 K9 ["%*\"humanLabeler\" > "]
       35 MOVE                             R8 R2
       36 NAMECALL                         R6 R6 K4 ["format"]
       38 CALL                             R6 2 1
       39 CALL                             R3 3 1
       40 SETTABLEKS                       R3 R0 K7 ["humanLabeler"]
       42 GETTABLEKS                       R3 R0 K10 ["systemLabeler"]
       44 JUMPIFEQKNIL                     R3 ; [+15]
       46 GETUPVAL                         R3 1
       47 GETTABLEKS                       R3 R3 K8 ["fromResponse"]
       49 GETTABLEKS                       R4 R0 K10 ["systemLabeler"]
       51 MOVE                             R5 R1
       52 LOADK                            R6 K11 ["%*\"systemLabeler\" > "]
       53 MOVE                             R8 R2
       54 NAMECALL                         R6 R6 K4 ["format"]
       56 CALL                             R6 2 1
       57 CALL                             R3 3 1
       58 SETTABLEKS                       R3 R0 K10 ["systemLabeler"]
       60 RETURN                           R0 1
