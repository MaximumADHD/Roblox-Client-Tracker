...
PROTO_1:
        ...
        7 LOADB                            R3 1
        8 GETUPVAL                         R6 2
        9 GETTABLEKS                       R5 R6 K2 ["SIDE_TOP"]
       11 JUMPIFEQ                         R4 R5 ; [+8]
       13 GETUPVAL                         R6 2
       14 GETTABLEKS                       R5 R6 K3 ["SIDE_BOTTOM"]
       16 JUMPIFEQ                         R4 R5 ; [+2]
       18 LOADB                            R3 0 +1
       19 LOADB                            R3 1
       20 JUMPIFNOT                        R3 ; [+6]
       ...
       36 LOADB                            R5 1
       37 GETUPVAL                         R8 2
       38 GETTABLEKS                       R7 R8 K2 ["SIDE_TOP"]
       40 JUMPIFEQ                         R6 R7 ; [+8]
       42 GETUPVAL                         R8 2
       43 GETTABLEKS                       R7 R8 K3 ["SIDE_BOTTOM"]
       45 JUMPIFEQ                         R6 R7 ; [+2]
       47 LOADB                            R5 0 +1
       48 LOADB                            R5 1
       49 JUMPIFNOT                        R5 ; [+15]
       ...
       58 GETUPVAL                         R7 2
       59 GETTABLEKS                       R6 R7 K3 ["SIDE_BOTTOM"]
       ...
       73 GETUPVAL                         R7 2
       74 GETTABLEKS                       R6 R7 K9 ["SIDE_RIGHT"]
       76 JUMPIFNOTEQ                      R5 R6 ; [+2]
       78 LOADN                            R3 1
       79 MOVE                             R5 R2
       80 JUMPIFNOT                        R5 ; [+39]
       81 GETUPVAL                         R6 0
       82 GETTABLEKS                       R5 R6 K10 ["createElement"]
       84 LOADK                            R6 K11 ["Frame"]
       85 DUPTABLE                         R7 K17 [{"AnchorPoint", "Position", "Size", "BackgroundTransparency", "BorderSizePixel", "ZIndex"}]
       86 GETIMPORT                        R8 K20 [Vector2.new]
       88 LOADK                            R9 K21 [0.5]
       89 LOADK                            R10 K21 [0.5]
       90 CALL                             R8 2 1
       91 SETTABLEKS                       R8 R7 K12 ["AnchorPoint"]
       93 GETIMPORT                        R8 K24 [UDim2.fromScale]
       95 MOVE                             R9 R3
       96 MOVE                             R10 R4
       97 CALL                             R8 2 1
       98 SETTABLEKS                       R8 R7 K5 ["Position"]
      100 GETIMPORT                        R8 K26 [UDim2.fromOffset]
      102 LOADN                            R9 0
      103 LOADN                            R10 0
      104 CALL                             R8 2 1
      ...
      110 LOADN                            R8 0
      111 SETTABLEKS                       R8 R7 K15 ["BorderSizePixel"]
      113 GETTABLEKS                       R8 R0 K16 ["ZIndex"]
      115 SETTABLEKS                       R8 R7 K16 ["ZIndex"]
      117 GETTABLEKS                       R8 R0 K27 ["children"]
      119 CALL                             R5 3 1
      120 RETURN                           R5 1
