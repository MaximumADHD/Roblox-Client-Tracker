PROTO_0:
        ...
        6 GETUPVAL                         R1 1
        7 GETTABLEKS                       R1 R1 K2 ["plotToViewX"]
        9 GETUPVAL                         R2 0
       10 GETTABLEKS                       R2 R2 K3 ["Position"]
       12 CALL                             R1 1 1
       13 MOVE                             R0 R1
       14 JUMP                             ; [+13]
       15 GETUPVAL                         R1 0
       16 GETTABLEKS                       R1 R1 K0 ["Orientation"]
       18 JUMPIFNOTEQKS                    R1 K4 ["Horizontal"] ; [+9]
       20 GETUPVAL                         R1 1
       21 GETTABLEKS                       R1 R1 K5 ["plotToViewY"]
       23 GETUPVAL                         R2 0
       24 GETTABLEKS                       R2 R2 K3 ["Position"]
       26 CALL                             R1 1 1
       27 MOVE                             R0 R1
       28 LOADN                            R1 0
       29 JUMPIFLT                         R0 R1 ; [+4]
...
PROTO_1:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["OppositeAxisBounds"]
        3 JUMPIF                           R0 ; [+3]
        4 LOADN                            R0 0
        5 LOADN                            R1 1
        6 RETURN                           R0 2
        ...
        8 LOADN                            R1 0
        9 GETUPVAL                         R2 0
       10 GETTABLEKS                       R2 R2 K1 ["Orientation"]
       12 JUMPIFNOTEQKS                    R2 K2 ["Vertical"] ; [+22]
       14 GETUPVAL                         R2 1
       15 GETTABLEKS                       R2 R2 K3 ["plotToViewY"]
       17 GETUPVAL                         R3 0
       18 GETTABLEKS                       R3 R3 K0 ["OppositeAxisBounds"]
       20 GETTABLEKS                       R3 R3 K4 ["Min"]
       22 CALL                             R2 1 1
       23 MOVE                             R0 R2
       24 GETUPVAL                         R2 1
       25 GETTABLEKS                       R2 R2 K3 ["plotToViewY"]
       27 GETUPVAL                         R3 0
       28 GETTABLEKS                       R3 R3 K0 ["OppositeAxisBounds"]
       30 GETTABLEKS                       R3 R3 K5 ["Max"]
       32 CALL                             R2 1 1
       33 MOVE                             R1 R2
       34 JUMP                             ; [+25]
       35 GETUPVAL                         R2 0
       36 GETTABLEKS                       R2 R2 K1 ["Orientation"]
       38 JUMPIFNOTEQKS                    R2 K6 ["Horizontal"] ; [+21]
       40 GETUPVAL                         R2 1
       41 GETTABLEKS                       R2 R2 K7 ["plotToViewX"]
       43 GETUPVAL                         R3 0
       44 GETTABLEKS                       R3 R3 K0 ["OppositeAxisBounds"]
       46 GETTABLEKS                       R3 R3 K4 ["Min"]
       48 CALL                             R2 1 1
       49 MOVE                             R0 R2
       50 GETUPVAL                         R2 1
       51 GETTABLEKS                       R2 R2 K7 ["plotToViewX"]
       53 GETUPVAL                         R3 0
       54 GETTABLEKS                       R3 R3 K0 ["OppositeAxisBounds"]
       56 GETTABLEKS                       R3 R3 K5 ["Max"]
       58 CALL                             R2 1 1
       59 MOVE                             R1 R2
       60 LOADN                            R2 1
       61 JUMPIFLT                         R2 R0 ; [+4]
...
PROTO_2:
       ...
       30 JUMPIF                           R2 ; [+3]
       31 GETUPVAL                         R2 2
       32 GETTABLEKS                       R2 R2 K9 ["GRID_LINE_COLOR3"]
       34 GETTABLEKS                       R3 R0 K10 ["Transparency"]
       36 JUMPIF                           R3 ; [+3]
       37 GETUPVAL                         R3 2
       38 GETTABLEKS                       R3 R3 K11 ["GRID_LINE_TRANSPARENCY"]
       40 GETTABLEKS                       R4 R0 K12 ["Thickness"]
       42 JUMPIF                           R4 ; [+3]
       43 GETUPVAL                         R4 2
       44 GETTABLEKS                       R4 R4 K13 ["GRID_LINE_THICKNESS"]
       46 GETUPVAL                         R5 0
       47 GETTABLEKS                       R5 R5 K14 ["useMemo"]
       49 NEWCLOSURE                       R6 P0
       50 CAPTURE                          VAL R0
       51 CAPTURE                          VAL R1
       52 NEWTABLE                         R7 0 2
       ...
       60 CALL                             R5 2 1
       61 GETUPVAL                         R6 0
       62 GETTABLEKS                       R6 R6 K14 ["useMemo"]
       64 NEWCLOSURE                       R7 P1
       65 CAPTURE                          VAL R0
       66 CAPTURE                          VAL R1
       67 NEWTABLE                         R8 0 2
      ...
      119 CALL                             R9 4 1
      120 GETUPVAL                         R10 0
      121 GETTABLEKS                       R10 R10 K23 ["createElement"]
