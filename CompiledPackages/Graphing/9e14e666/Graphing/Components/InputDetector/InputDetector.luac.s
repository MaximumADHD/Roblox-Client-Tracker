PROTO_0:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R2 R2 K0 ["mouseToPlot"]
       ...
       14 CALL                             R3 1 0
       15 GETUPVAL                         R3 2
       16 GETTABLEKS                       R3 R3 K6 ["OnHoverStart"]
       18 JUMPIFNOT                        R3 ; [+54]
       19 GETUPVAL                         R3 2
       20 GETTABLEKS                       R3 R3 K6 ["OnHoverStart"]
       22 GETUPVAL                         R4 0
       23 GETTABLEKS                       R4 R4 K0 ["mouseToPlot"]
       ...
       44 CALL                             R3 1 0
       45 GETUPVAL                         R3 2
       46 GETTABLEKS                       R3 R3 K11 ["OnPress"]
       48 JUMPIFNOT                        R3 ; [+24]
       49 GETUPVAL                         R3 2
       50 GETTABLEKS                       R3 R3 K11 ["OnPress"]
       52 MOVE                             R4 R2
       53 CALL                             R3 1 0
       54 RETURN                           R0 0
       ...
       63 CALL                             R3 1 0
       64 GETUPVAL                         R3 2
       65 GETTABLEKS                       R3 R3 K14 ["OnRightPress"]
       67 JUMPIFNOT                        R3 ; [+5]
       68 GETUPVAL                         R3 2
...
PROTO_1:
       ...
       15 GETUPVAL                         R3 2
       16 GETTABLEKS                       R3 R3 K5 ["mouseToPlot"]
       18 GETTABLEKS                       R4 R1 K6 ["Position"]
       20 CALL                             R3 1 -1
       21 CALL                             R2 -1 0
       22 RETURN                           R0 0
       23 GETUPVAL                         R2 0
       24 GETTABLEKS                       R2 R2 K7 ["OnScroll"]
       26 JUMPIFNOT                        R2 ; [+14]
       27 GETTABLEKS                       R2 R1 K1 ["UserInputType"]
       29 GETIMPORT                        R3 K9 [Enum.UserInputType.MouseWheel]
       31 JUMPIFNOTEQ                      R2 R3 ; [+9]
       33 GETUPVAL                         R2 0
       34 GETTABLEKS                       R2 R2 K7 ["OnScroll"]
       36 GETTABLEKS                       R3 R1 K6 ["Position"]
       38 GETTABLEKS                       R3 R3 K10 ["Z"]
       40 CALL                             R2 1 0
       41 RETURN                           R0 0
...
PROTO_2:
       ...
       14 CALL                             R3 1 0
       15 GETUPVAL                         R3 2
       16 GETTABLEKS                       R3 R3 K6 ["OnHoverEnded"]
       18 JUMPIFNOT                        R3 ; [+69]
       19 GETUPVAL                         R3 2
       20 GETTABLEKS                       R3 R3 K6 ["OnHoverEnded"]
       22 MOVE                             R4 R2
       23 CALL                             R3 1 0
       24 RETURN                           R0 0
       ...
       37 GETUPVAL                         R3 2
       38 GETTABLEKS                       R3 R3 K11 ["OnRelease"]
       40 JUMPIFNOT                        R3 ; [+5]
       41 GETUPVAL                         R3 2
       42 GETTABLEKS                       R3 R3 K11 ["OnRelease"]
       44 MOVE                             R4 R2
       45 CALL                             R3 1 0
       46 GETUPVAL                         R3 2
       47 GETTABLEKS                       R3 R3 K12 ["OnClick"]
       49 JUMPIFNOT                        R3 ; [+38]
       50 GETUPVAL                         R3 3
       51 JUMPIFNOT                        R3 ; [+36]
       52 GETUPVAL                         R3 4
       53 JUMPIF                           R3 ; [+34]
       54 GETUPVAL                         R3 2
       55 GETTABLEKS                       R3 R3 K12 ["OnClick"]
       57 MOVE                             R4 R2
       58 CALL                             R3 1 0
       59 RETURN                           R0 0
       ...
       66 GETUPVAL                         R3 2
       67 GETTABLEKS                       R3 R3 K15 ["OnRightRelease"]
       69 JUMPIFNOT                        R3 ; [+5]
       70 GETUPVAL                         R3 2
       71 GETTABLEKS                       R3 R3 K15 ["OnRightRelease"]
       73 MOVE                             R4 R2
       74 CALL                             R3 1 0
       75 GETUPVAL                         R3 2
       76 GETTABLEKS                       R3 R3 K16 ["OnRightClick"]
       78 JUMPIFNOT                        R3 ; [+9]
       79 GETUPVAL                         R3 3
       80 JUMPIFNOT                        R3 ; [+7]
       81 GETUPVAL                         R3 5
       82 JUMPIF                           R3 ; [+5]
       83 GETUPVAL                         R3 2
       84 GETTABLEKS                       R3 R3 K16 ["OnRightClick"]
       86 MOVE                             R4 R2
       87 CALL                             R3 1 0
       88 RETURN                           R0 0
...
PROTO_3:
       ...
       85 GETUPVAL                         R7 2
       86 GETTABLEKS                       R7 R7 K19 ["viewToPlot"]
       88 MOVE                             R8 R5
       89 CALL                             R7 1 -1
       90 CALL                             R6 -1 0
       91 RETURN                           R0 0
...
PROTO_4:
       ...
       40 GETUPVAL                         R4 3
       41 GETTABLEKS                       R4 R4 K10 ["viewToPlot"]
       43 MOVE                             R5 R2
       44 CALL                             R4 1 -1
       45 CALL                             R3 -1 0
       46 RETURN                           R0 0
...
PROTO_5:
       ...
       37 GETUPVAL                         R4 2
       38 GETTABLEKS                       R4 R4 K10 ["viewToPlot"]
       40 MOVE                             R5 R2
       41 CALL                             R4 1 -1
       42 CALL                             R3 -1 0
       43 RETURN                           R0 0
...
PROTO_6:
       ...
       57 CALL                             R13 2 1
       58 GETUPVAL                         R14 0
       59 GETTABLEKS                       R14 R14 K7 ["useCallback"]
       ...
       75 CALL                             R14 2 1
       76 GETUPVAL                         R15 0
       77 GETTABLEKS                       R15 R15 K7 ["useCallback"]
      ...
      105 CALL                             R15 2 1
      106 GETUPVAL                         R16 0
      107 GETTABLEKS                       R16 R16 K7 ["useCallback"]
      ...
      127 CALL                             R16 2 1
      128 GETUPVAL                         R17 0
      129 GETTABLEKS                       R17 R17 K7 ["useCallback"]
      ...
      147 CALL                             R17 2 1
      148 GETUPVAL                         R18 0
      149 GETTABLEKS                       R18 R18 K7 ["useCallback"]
      ...
      165 CALL                             R18 2 1
      166 GETUPVAL                         R19 0
      167 GETTABLEKS                       R19 R19 K23 ["createElement"]
      ...
      205 GETUPVAL                         R22 0
      206 GETTABLEKS                       R22 R22 K38 ["Event"]
      208 GETTABLEKS                       R22 R22 K39 ["InputBegan"]
      210 SETTABLE                         R13 R21 R22
      211 GETUPVAL                         R22 0
      212 GETTABLEKS                       R22 R22 K38 ["Event"]
      214 GETTABLEKS                       R22 R22 K40 ["InputChanged"]
      216 SETTABLE                         R14 R21 R22
      217 GETUPVAL                         R22 0
      218 GETTABLEKS                       R22 R22 K38 ["Event"]
      220 GETTABLEKS                       R22 R22 K41 ["InputEnded"]
      222 SETTABLE                         R15 R21 R22
      223 DUPTABLE                         R22 K43 [{"DragDetector"}]
      224 GETUPVAL                         R23 0
      225 GETTABLEKS                       R23 R23 K23 ["createElement"]
      ...
      239 GETUPVAL                         R26 0
      240 GETTABLEKS                       R26 R26 K38 ["Event"]
      242 GETTABLEKS                       R26 R26 K52 ["DragStart"]
      244 SETTABLE                         R16 R25 R26
      245 GETUPVAL                         R26 0
      246 GETTABLEKS                       R26 R26 K38 ["Event"]
      248 GETTABLEKS                       R26 R26 K53 ["DragContinue"]
      250 SETTABLE                         R17 R25 R26
      251 GETUPVAL                         R26 0
      252 GETTABLEKS                       R26 R26 K38 ["Event"]
      254 GETTABLEKS                       R26 R26 K54 ["DragEnd"]
