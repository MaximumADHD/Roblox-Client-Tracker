...
PROTO_1:
        ...
        1 LOADN                            R2 0
        2 GETUPVAL                         R5 0
        3 GETTABLEKS                       R4 R5 K0 ["Side"]
        5 LOADB                            R3 1
        6 GETUPVAL                         R6 1
        7 GETTABLEKS                       R5 R6 K1 ["SIDE_TOP"]
        9 JUMPIFEQ                         R4 R5 ; [+8]
       11 GETUPVAL                         R6 1
       12 GETTABLEKS                       R5 R6 K2 ["SIDE_BOTTOM"]
       14 JUMPIFEQ                         R4 R5 ; [+2]
       16 LOADB                            R3 0 +1
       17 LOADB                            R3 1
       18 JUMPIFNOT                        R3 ; [+17]
       ...
       25 MOVE                             R1 R3
       26 GETUPVAL                         R4 0
       27 GETTABLEKS                       R3 R4 K0 ["Side"]
       29 GETUPVAL                         R5 1
       30 GETTABLEKS                       R4 R5 K2 ["SIDE_BOTTOM"]
       32 JUMPIFNOTEQ                      R3 R4 ; [+19]
       34 LOADN                            R2 1
       35 JUMP                             ; [+16]
       36 GETTABLEKS                       R3 R0 K5 ["plotToViewY"]
       38 GETUPVAL                         R5 0
       39 GETTABLEKS                       R4 R5 K4 ["Position"]
       41 CALL                             R3 1 1
       42 MOVE                             R2 R3
       43 GETUPVAL                         R4 0
       44 GETTABLEKS                       R3 R4 K0 ["Side"]
       46 GETUPVAL                         R5 1
       47 GETTABLEKS                       R4 R5 K6 ["SIDE_RIGHT"]
...
PROTO_2:
        0 GETUPVAL                         R4 0
        1 GETTABLEKS                       R3 R4 K0 ["Side"]
        3 LOADB                            R2 1
        4 GETUPVAL                         R5 1
        5 GETTABLEKS                       R4 R5 K1 ["SIDE_TOP"]
        7 JUMPIFEQ                         R3 R4 ; [+8]
        9 GETUPVAL                         R5 1
       10 GETTABLEKS                       R4 R5 K2 ["SIDE_BOTTOM"]
       12 JUMPIFEQ                         R3 R4 ; [+2]
       14 LOADB                            R2 0 +1
       15 LOADB                            R2 1
       16 JUMPIFNOT                        R2 ; [+7]
       ...
       19 GETUPVAL                         R3 0
       20 GETTABLEKS                       R2 R3 K4 ["Position"]
       22 CALL                             R1 1 1
       23 RETURN                           R1 1
       24 GETTABLEKS                       R1 R0 K5 ["isPointInViewportY"]
       26 GETUPVAL                         R3 0
       27 GETTABLEKS                       R2 R3 K4 ["Position"]
       29 CALL                             R1 1 1
       30 RETURN                           R1 1
...
PROTO_3:
       ...
       28 RETURN                           R3 1
       29 GETUPVAL                         R4 3
       30 GETTABLEKS                       R3 R4 K2 ["createElement"]
