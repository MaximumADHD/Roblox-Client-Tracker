PROTO_0:
        0 GETUPVAL                         R3 0
        1 GETTABLEKS                       R2 R3 K0 ["Orientation"]
        3 GETUPVAL                         R4 1
        4 GETTABLEKS                       R3 R4 K1 ["ORIENTATION_VERTICAL"]
        6 JUMPIFNOTEQ                      R2 R3 ; [+8]
        8 GETTABLEKS                       R1 R0 K2 ["plotToViewX"]
       10 GETUPVAL                         R3 0
       11 GETTABLEKS                       R2 R3 K3 ["Position"]
       13 CALL                             R1 1 1
       14 JUMP                             ; [+6]
       15 GETTABLEKS                       R1 R0 K4 ["plotToViewY"]
       17 GETUPVAL                         R3 0
       18 GETTABLEKS                       R2 R3 K3 ["Position"]
       20 CALL                             R1 1 1
       21 LOADN                            R2 0
       22 LOADN                            R3 1
       23 GETUPVAL                         R5 0
       24 GETTABLEKS                       R4 R5 K5 ["OppositeAxisBounds"]
       26 JUMPIFNOT                        R4 ; [+45]
       27 GETUPVAL                         R5 0
       28 GETTABLEKS                       R4 R5 K0 ["Orientation"]
       30 GETUPVAL                         R6 1
       31 GETTABLEKS                       R5 R6 K1 ["ORIENTATION_VERTICAL"]
       33 JUMPIFNOTEQ                      R4 R5 ; [+20]
       35 GETTABLEKS                       R4 R0 K4 ["plotToViewY"]
       37 GETUPVAL                         R7 0
       38 GETTABLEKS                       R6 R7 K5 ["OppositeAxisBounds"]
       40 GETTABLEKS                       R5 R6 K6 ["Min"]
       42 CALL                             R4 1 1
       43 MOVE                             R2 R4
       44 GETTABLEKS                       R4 R0 K4 ["plotToViewY"]
       46 GETUPVAL                         R7 0
       47 GETTABLEKS                       R6 R7 K5 ["OppositeAxisBounds"]
       49 GETTABLEKS                       R5 R6 K7 ["Max"]
       51 CALL                             R4 1 1
       52 MOVE                             R3 R4
       53 JUMP                             ; [+18]
       54 GETTABLEKS                       R4 R0 K2 ["plotToViewX"]
       56 GETUPVAL                         R7 0
       57 GETTABLEKS                       R6 R7 K5 ["OppositeAxisBounds"]
       59 GETTABLEKS                       R5 R6 K6 ["Min"]
       61 CALL                             R4 1 1
       62 MOVE                             R2 R4
       63 GETTABLEKS                       R4 R0 K2 ["plotToViewX"]
       65 GETUPVAL                         R7 0
       66 GETTABLEKS                       R6 R7 K5 ["OppositeAxisBounds"]
       68 GETTABLEKS                       R5 R6 K7 ["Max"]
       70 CALL                             R4 1 1
       71 MOVE                             R3 R4
       72 LOADNIL                          R4
       73 LOADNIL                          R5
       74 GETUPVAL                         R7 0
       75 GETTABLEKS                       R6 R7 K0 ["Orientation"]
       77 GETUPVAL                         R8 1
       78 GETTABLEKS                       R7 R8 K1 ["ORIENTATION_VERTICAL"]
...
PROTO_1:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R1 R2 K0 ["OppositeAxisBounds"]
        3 JUMPIFNOT                        R1 ; [+54]
        4 GETUPVAL                         R3 0
        5 GETTABLEKS                       R2 R3 K1 ["Orientation"]
        7 GETUPVAL                         R4 1
        8 GETTABLEKS                       R3 R4 K2 ["ORIENTATION_VERTICAL"]
       10 JUMPIFNOTEQ                      R2 R3 ; [+24]
       12 GETTABLEKS                       R1 R0 K3 ["isRectInViewport"]
       14 GETIMPORT                        R2 K6 [Rect.new]
       16 GETUPVAL                         R4 0
       17 GETTABLEKS                       R3 R4 K7 ["Position"]
       19 GETUPVAL                         R6 0
       20 GETTABLEKS                       R5 R6 K0 ["OppositeAxisBounds"]
       22 GETTABLEKS                       R4 R5 K8 ["Min"]
       24 GETUPVAL                         R6 0
       25 GETTABLEKS                       R5 R6 K7 ["Position"]
       27 GETUPVAL                         R8 0
       28 GETTABLEKS                       R7 R8 K0 ["OppositeAxisBounds"]
       30 GETTABLEKS                       R6 R7 K9 ["Max"]
       32 CALL                             R2 4 -1
       33 CALL                             R1 -1 1
       34 RETURN                           R1 1
       ...
       39 GETUPVAL                         R5 0
       40 GETTABLEKS                       R4 R5 K0 ["OppositeAxisBounds"]
       42 GETTABLEKS                       R3 R4 K8 ["Min"]
       44 GETUPVAL                         R5 0
       45 GETTABLEKS                       R4 R5 K7 ["Position"]
       47 GETUPVAL                         R7 0
       48 GETTABLEKS                       R6 R7 K0 ["OppositeAxisBounds"]
       50 GETTABLEKS                       R5 R6 K9 ["Max"]
       52 GETUPVAL                         R7 0
       53 GETTABLEKS                       R6 R7 K7 ["Position"]
       55 CALL                             R2 4 -1
       56 CALL                             R1 -1 1
       57 RETURN                           R1 1
       58 GETUPVAL                         R3 0
       59 GETTABLEKS                       R2 R3 K1 ["Orientation"]
       61 GETUPVAL                         R4 1
       62 GETTABLEKS                       R3 R4 K2 ["ORIENTATION_VERTICAL"]
       64 JUMPIFNOTEQ                      R2 R3 ; [+8]
       66 GETTABLEKS                       R1 R0 K10 ["isPointInViewportX"]
       68 GETUPVAL                         R3 0
       69 GETTABLEKS                       R2 R3 K7 ["Position"]
       71 CALL                             R1 1 1
       72 RETURN                           R1 1
       73 GETTABLEKS                       R1 R0 K11 ["isPointInViewportY"]
       75 GETUPVAL                         R3 0
       76 GETTABLEKS                       R2 R3 K7 ["Position"]
       78 CALL                             R1 1 1
       79 RETURN                           R1 1
...
PROTO_4:
        ...
        3 GETUPVAL                         R5 0
        4 GETTABLEKS                       R4 R5 K1 ["ORIENTATION_VERTICAL"]
        6 JUMPIFEQ                         R3 R4 ; [+10]
        8 GETTABLEKS                       R3 R0 K0 ["Orientation"]
       10 GETUPVAL                         R5 0
       11 GETTABLEKS                       R4 R5 K2 ["ORIENTATION_HORIZONTAL"]
       13 JUMPIFEQ                         R3 R4 ; [+2]
       15 LOADB                            R2 0 +1
       16 LOADB                            R2 1
       ...
       31 JUMPIF                           R1 ; [+3]
       32 GETUPVAL                         R2 1
       33 GETTABLEKS                       R1 R2 K8 ["GRID_LINE_COLOR3"]
       35 GETTABLEKS                       R2 R0 K9 ["Transparency"]
       37 JUMPIF                           R2 ; [+3]
       38 GETUPVAL                         R3 1
       39 GETTABLEKS                       R2 R3 K10 ["GRID_LINE_TRANSPARENCY"]
       41 GETTABLEKS                       R3 R0 K11 ["Thickness"]
       43 JUMPIF                           R3 ; [+3]
       44 GETUPVAL                         R4 1
       45 GETTABLEKS                       R3 R4 K12 ["GRID_LINE_THICKNESS"]
       47 GETUPVAL                         R4 2
       48 NEWCLOSURE                       R5 P0
       49 CAPTURE                          VAL R0
       50 CAPTURE                          UPVAL U0
       ...
       81 RETURN                           R6 1
       82 GETUPVAL                         R7 4
       83 GETTABLEKS                       R6 R7 K15 ["createElement"]
