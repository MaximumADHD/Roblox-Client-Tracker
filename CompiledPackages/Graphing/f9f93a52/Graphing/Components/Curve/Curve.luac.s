...
PROTO_3:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R1 R2 K0 ["viewportRectGetter"]
        3 MOVE                             R2 R0
        4 CALL                             R1 1 0
        5 GETUPVAL                         R1 1
        6 GETUPVAL                         R2 0
...
PROTO_5:
        ...
        2 CALL                             R1 1 1
        3 GETUPVAL                         R4 1
        4 GETTABLEKS                       R3 R4 K0 ["ObserveThickness"]
        6 JUMPIFNOT                        R3 ; [+6]
        7 GETUPVAL                         R3 1
        8 GETTABLEKS                       R2 R3 K0 ["ObserveThickness"]
       10 MOVE                             R3 R0
       11 CALL                             R2 1 1
       12 JUMP                             ; [+1]
       13 LOADNIL                          R2
...
PROTO_6:
        0 LOADNIL                          R0
        1 GETUPVAL                         R2 0
        2 GETTABLEKS                       R1 R2 K0 ["ObservePoints"]
        4 JUMPIFNOT                        R1 ; [+13]
        5 GETUPVAL                         R2 0
        6 GETTABLEKS                       R1 R2 K0 ["ObservePoints"]
        8 GETUPVAL                         R3 1
        9 GETTABLEKS                       R2 R3 K1 ["createComputed"]
       11 NEWCLOSURE                       R3 P0
       12 CAPTURE                          UPVAL U2
       13 CAPTURE                          UPVAL U3
       14 CAPTURE                          VAL R1
       ...
       17 JUMP                             ; [+15]
       18 GETUPVAL                         R2 0
       19 GETTABLEKS                       R1 R2 K2 ["Points"]
       21 JUMPIF                           R1 ; [+2]
       22 NEWTABLE                         R1 0 0
       24 GETUPVAL                         R3 1
       25 GETTABLEKS                       R2 R3 K1 ["createComputed"]
       27 NEWCLOSURE                       R3 P1
       28 CAPTURE                          UPVAL U2
       29 CAPTURE                          UPVAL U3
       30 CAPTURE                          VAL R1
       ...
       32 MOVE                             R0 R2
       33 GETUPVAL                         R2 1
       34 GETTABLEKS                       R1 R2 K3 ["createEffect"]
       36 NEWCLOSURE                       R2 P2
       37 CAPTURE                          REF R0
       38 CAPTURE                          UPVAL U0
       39 CAPTURE                          UPVAL U4
...
PROTO_8:
       ...
       41 LOADN                            R4 0
       42 GETUPVAL                         R6 0
       43 GETTABLEKS                       R5 R6 K13 ["useLayoutEffect"]
       45 NEWCLOSURE                       R6 P0
       46 CAPTURE                          VAL R0
       47 CAPTURE                          UPVAL U3
       48 CAPTURE                          VAL R1
      ...
      134 FORNLOOP                         R10
      135 GETUPVAL                         R11 0
      136 GETTABLEKS                       R10 R11 K22 ["createElement"]
      138 JUMPIFNOT                        R7 ; [+2]
      139 LOADK                            R11 K28 ["CanvasGroup"]
      140 JUMP                             ; [+1]
      141 LOADK                            R11 K29 ["Frame"]
      142 DUPTABLE                         R12 K34 [{"ref", "BackgroundTransparency", "BorderSizePixel", "Size", "ZIndex"}]
      143 SETTABLEKS                       R2 R12 K30 ["ref"]
      145 LOADN                            R13 1
      146 SETTABLEKS                       R13 R12 K31 ["BackgroundTransparency"]
      148 LOADN                            R13 0
      149 SETTABLEKS                       R13 R12 K32 ["BorderSizePixel"]
      151 GETIMPORT                        R13 K37 [UDim2.fromScale]
      153 LOADN                            R14 1
      154 LOADN                            R15 1
      155 CALL                             R13 2 1
      156 SETTABLEKS                       R13 R12 K33 ["Size"]
      158 GETTABLEKS                       R13 R0 K27 ["ZIndex"]
      160 SETTABLEKS                       R13 R12 K27 ["ZIndex"]
      162 MOVE                             R13 R8
      163 CALL                             R10 3 -1
      164 RETURN                           R10 -1
...
MAIN:
       ...
       38 GETTABLEKS                       R9 R0 K10 ["Util"]
       40 GETTABLEKS                       R8 R9 K13 ["useViewportBinding"]
       42 CALL                             R7 1 1
