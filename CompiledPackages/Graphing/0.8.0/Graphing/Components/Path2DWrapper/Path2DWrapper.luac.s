...
PROTO_4:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["ObserveControlPoints"]
        3 JUMPIFNOT                        R0 ; [+11]
        4 GETUPVAL                         R0 0
        5 GETTABLEKS                       R0 R0 K0 ["ObserveControlPoints"]
        7 GETUPVAL                         R1 1
        8 GETTABLEKS                       R1 R1 K1 ["createEffect"]
       10 NEWCLOSURE                       R2 P0
       11 CAPTURE                          UPVAL U2
       12 CAPTURE                          VAL R0
       13 CALL                             R1 1 -1
       14 RETURN                           R1 -1
       15 GETUPVAL                         R0 0
       16 GETTABLEKS                       R0 R0 K2 ["ControlPoints"]
       18 JUMPIFNOT                        R0 ; [+5]
       19 GETUPVAL                         R0 2
       20 GETUPVAL                         R1 0
       21 GETTABLEKS                       R1 R1 K2 ["ControlPoints"]
       23 CALL                             R0 1 0
...
PROTO_5:
       ...
       39 CAPTURE                          VAL R2
       40 GETUPVAL                         R5 0
       41 GETTABLEKS                       R5 R5 K12 ["useLayoutEffect"]
       43 NEWCLOSURE                       R6 P1
       44 CAPTURE                          VAL R0
       45 CAPTURE                          UPVAL U2
       46 CAPTURE                          VAL R4
       ...
       78 CALL                             R12 1 1
       79 GETUPVAL                         R13 0
       80 GETTABLEKS                       R13 R13 K20 ["createElement"]
      ...
      104 FORNLOOP                         R9
      105 GETUPVAL                         R9 0
      106 GETTABLEKS                       R9 R9 K20 ["createElement"]
      108 JUMPIFNOT                        R6 ; [+2]
      109 LOADK                            R10 K24 ["CanvasGroup"]
      110 JUMP                             ; [+1]
      111 LOADK                            R10 K25 ["Frame"]
      112 DUPTABLE                         R11 K31 [{["ref"], ["BackgroundTransparency"] = 1, ["BorderSizePixel"] = 0, ["Size"], ["ZIndex"]}]
      113 SETTABLEKS                       R1 R11 K26 ["ref"]
      115 GETIMPORT                        R12 K34 [UDim2.fromScale]
      117 LOADN                            R13 1
      118 LOADN                            R14 1
      119 CALL                             R12 2 1
      120 SETTABLEKS                       R12 R11 K30 ["Size"]
      122 GETTABLEKS                       R12 R0 K23 ["ZIndex"]
      124 SETTABLEKS                       R12 R11 K23 ["ZIndex"]
      126 MOVE                             R12 R7
      127 CALL                             R9 3 -1
      128 RETURN                           R9 -1
