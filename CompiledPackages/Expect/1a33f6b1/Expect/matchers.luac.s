...
PROTO_2:
       ...
       41 GETUPVAL                         R11 8
       42 GETTABLEKS                       R10 R11 K9 ["expand"]
       44 NOT                              R11 R10
       45 NOT                              R9 R11
       46 CALL                             R4 5 1
       47 CONCAT                           R2 R3 R4
...
PROTO_18:
       ...
       58 MOVE                             R10 R1
       59 GETIMPORT                        R9 K16 [getmetatable]
       61 CALL                             R9 1 1
       62 GETTABLEKS                       R8 R9 K17 ["__index"]
...
PROTO_33:
       ...
       49 JUMPIFNOT                        R3 ; [+13]
       50 GETUPVAL                         R4 8
       51 GETTABLEKS                       R3 R4 K12 ["isArray"]
       53 GETUPVAL                         R4 1
       54 CALL                             R3 1 1
       55 JUMPIFNOT                        R3 ; [+7]
       56 MOVE                             R3 R2
       ...
       69 JUMPIF                           R3 ; [+18]
       70 GETUPVAL                         R4 8
       71 GETTABLEKS                       R3 R4 K13 ["findIndex"]
       73 GETUPVAL                         R4 1
       74 NEWCLOSURE                       R5 P0
...
PROTO_37:
       ...
       38 CALL                             R5 -1 0
       39 GETUPVAL                         R6 6
       40 GETTABLEKS                       R5 R6 K14 ["findIndex"]
       42 GETUPVAL                         R7 6
       43 GETTABLEKS                       R6 R7 K15 ["from"]
       45 MOVE                             R7 R1
       46 CALL                             R6 1 1
       47 NEWCLOSURE                       R7 P0
       48 CAPTURE                          UPVAL U7
...
PROTO_39:
       ...
       13 GETUPVAL                         R10 5
       14 GETTABLEKS                       R9 R10 K4 ["expand"]
       16 NOT                              R10 R9
       17 NOT                              R8 R10
       18 CALL                             R3 5 1
       19 CONCAT                           R0 R1 R3
...
PROTO_42:
       ...
       26 LOADB                            R5 1
       27 GETUPVAL                         R7 0
       28 GETTABLEKS                       R6 R7 K8 ["isArray"]
       30 MOVE                             R7 R1
       31 CALL                             R6 1 1
       32 JUMPIF                           R6 ; [+33]
...
PROTO_44:
       ...
       25 GETUPVAL                         R11 8
       26 GETTABLEKS                       R10 R11 K10 ["expand"]
       28 NOT                              R11 R10
       29 NOT                              R9 R11
       30 CALL                             R4 5 1
       31 CONCAT                           R1 R2 R4
...
PROTO_50:
       ...
       16 GETUPVAL                         R10 6
       17 GETTABLEKS                       R9 R10 K4 ["expand"]
       19 NOT                              R10 R9
       20 NOT                              R8 R10
       21 CALL                             R3 5 1
       22 CONCAT                           R0 R1 R3
...
MAIN:
       ...
       71 GETIMPORT                        R29 K4 [require]
       73 GETTABLEKS                       R30 R0 K31 ["jasmineUtils"]
       75 CALL                             R29 1 1
       76 GETTABLEKS                       R28 R29 K32 ["equals"]
      ...
      125 CALL                             R46 1 1
      126 GETTABLEKS                       R48 R46 K51 ["RobloxInstance"]
      128 GETTABLEKS                       R47 R48 K52 ["instanceSubsetEquality"]
      130 GETTABLEKS                       R49 R46 K51 ["RobloxInstance"]
      132 GETTABLEKS                       R48 R49 K53 ["getInstanceSubset"]
