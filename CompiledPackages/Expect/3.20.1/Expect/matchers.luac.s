...
PROTO_3:
        0 DUPTABLE                         R3 K4 [{[1] = "Object.is equality", ["isNot"], ["promise"]}]
        1 GETTABLEKS                       R4 R0 K2 ["isNot"]
        3 SETTABLEKS                       R4 R3 K2 ["isNot"]
        5 GETTABLEKS                       R4 R0 K3 ["promise"]
        7 SETTABLEKS                       R4 R3 K3 ["promise"]
        9 GETUPVAL                         R4 0
       10 GETTABLEKS                       R4 R4 K5 ["is"]
       12 MOVE                             R5 R1
       13 MOVE                             R6 R2
       14 CALL                             R4 2 1
       15 LOADNIL                          R5
       ...
       31 CAPTURE                          UPVAL U6
       32 CAPTURE                          VAL R0
       33 DUPTABLE                         R6 K12 [{["actual"], ["expected"], ["message"], ["name"] = "toBe", ["pass"]}]
       34 SETTABLEKS                       R1 R6 K6 ["actual"]
       36 SETTABLEKS                       R2 R6 K7 ["expected"]
       38 SETTABLEKS                       R5 R6 K8 ["message"]
       40 SETTABLEKS                       R4 R6 K11 ["pass"]
       42 RETURN                           R6 1
...
PROTO_34:
        0 GETTABLEKS                       R3 R0 K0 ["isNot"]
        2 DUPTABLE                         R4 K4 [{["comment"] = "string.find or table.find", [2], ["promise"]}]
        3 SETTABLEKS                       R3 R4 K0 ["isNot"]
        5 GETTABLEKS                       R5 R0 K3 ["promise"]
        7 SETTABLEKS                       R5 R4 K3 ["promise"]
        9 JUMPIFNOTEQKNIL                  R1 ; [+26]
       11 GETIMPORT                        R5 K6 [error]
       13 GETUPVAL                         R6 0
       14 GETUPVAL                         R7 1
       15 GETUPVAL                         R8 2
       16 LOADK                            R9 K7 ["toContain"]
       17 LOADNIL                          R10
       18 LOADNIL                          R11
       19 MOVE                             R12 R4
       20 CALL                             R8 4 1
       21 GETIMPORT                        R9 K10 [string.format]
       23 LOADK                            R10 K11 ["%s value must not be nil"]
       24 GETUPVAL                         R11 3
       25 LOADK                            R12 K12 ["received"]
       26 CALL                             R11 1 -1
       27 CALL                             R9 -1 1
       28 GETUPVAL                         R10 4
       29 LOADK                            R11 K13 ["Received"]
       30 MOVE                             R12 R1
       31 GETUPVAL                         R13 5
       32 CALL                             R10 3 -1
       33 CALL                             R7 -1 -1
       ...
       37 MOVE                             R6 R1
       38 GETIMPORT                        R5 K15 [typeof]
       40 CALL                             R5 1 1
       41 JUMPIFNOTEQKS                    R5 K8 ["string"] ; [+90]
       43 LOADK                            R5 K16 ["%s value must be a string if %s value is a string"]
       44 GETUPVAL                         R7 6
       45 LOADK                            R8 K17 ["expected"]
       46 CALL                             R7 1 1
       47 GETUPVAL                         R8 3
       48 LOADK                            R9 K12 ["received"]
       49 CALL                             R8 1 -1
       50 NAMECALL                         R5 R5 K9 ["format"]
       52 CALL                             R5 -1 1
       53 FASTCALL1                        TYPEOF R2 ; [+3]
       54 MOVE                             R7 R2
       55 GETIMPORT                        R6 K15 [typeof]
       57 CALL                             R6 1 1
       58 JUMPIFEQKS                       R6 K8 ["string"] ; [+42]
       60 GETIMPORT                        R6 K6 [error]
       62 GETUPVAL                         R7 0
       63 GETTABLEKS                       R7 R7 K18 ["new"]
       65 GETUPVAL                         R8 1
       66 GETUPVAL                         R9 2
       67 LOADK                            R10 K7 ["toContain"]
       68 MOVE                             R11 R1
       69 FASTCALL1                        TOSTRING R2 ; [+3]
       70 MOVE                             R13 R2
       71 GETIMPORT                        R12 K20 [tostring]
       73 CALL                             R12 1 1
       74 MOVE                             R13 R4
       75 CALL                             R9 4 1
       76 MOVE                             R10 R5
       77 GETUPVAL                         R16 4
       78 LOADK                            R17 K21 ["Expected"]
       79 MOVE                             R18 R2
       80 GETUPVAL                         R19 7
       81 CALL                             R16 3 -1
       82 FASTCALL                         TOSTRING ; [+2]
       83 GETIMPORT                        R15 K20 [tostring]
       85 CALL                             R15 -1 1
       86 MOVE                             R12 R15
       87 LOADK                            R13 K22 ["\n"]
       88 GETUPVAL                         R15 4
       89 LOADK                            R16 K13 ["Received"]
       90 MOVE                             R17 R1
       91 GETUPVAL                         R18 5
       92 CALL                             R15 3 -1
       93 FASTCALL                         TOSTRING ; [+2]
       94 GETIMPORT                        R14 K20 [tostring]
       96 CALL                             R14 -1 1
       97 CONCAT                           R11 R12 R14
       98 CALL                             R8 3 -1
       99 CALL                             R7 -1 -1
      100 CALL                             R6 -1 0
      101 FASTCALL1                        TOSTRING R2 ; [+3]
      102 MOVE                             R9 R2
      103 GETIMPORT                        R8 K20 [tostring]
      105 CALL                             R8 1 1
      106 LOADN                            R9 1
      107 LOADB                            R10 1
      108 NAMECALL                         R6 R1 K23 ["find"]
      110 CALL                             R6 4 1
      111 JUMPIFNOTEQKNIL                  R6 ; [+2]
      113 LOADB                            R7 0 +1
      114 LOADB                            R7 1
      ...
      126 DUPTABLE                         R9 K26 [{"message", "pass"}]
      127 SETTABLEKS                       R8 R9 K24 ["message"]
      129 SETTABLEKS                       R7 R9 K25 ["pass"]
      131 RETURN                           R9 1
      132 GETUPVAL                         R5 10
      133 GETTABLEKS                       R5 R5 K27 ["from"]
      135 MOVE                             R6 R1
      136 CALL                             R5 1 1
      137 GETIMPORT                        R6 K29 [table.find]
      139 MOVE                             R7 R5
      140 MOVE                             R8 R2
      141 CALL                             R6 2 1
      142 JUMPIFNOTEQKNIL                  R6 ; [+2]
      144 LOADB                            R7 0 +1
      145 LOADB                            R7 1
      146 NEWCLOSURE                       R8 P1
      ...
      162 DUPTABLE                         R9 K26 [{"message", "pass"}]
      163 SETTABLEKS                       R8 R9 K24 ["message"]
      165 SETTABLEKS                       R7 R9 K25 ["pass"]
      167 RETURN                           R9 1
...
PROTO_37:
        0 GETTABLEKS                       R3 R0 K0 ["isNot"]
        2 DUPTABLE                         R4 K4 [{["comment"] = "deep equality", [2], ["promise"]}]
        3 SETTABLEKS                       R3 R4 K0 ["isNot"]
        5 GETTABLEKS                       R5 R0 K3 ["promise"]
        7 SETTABLEKS                       R5 R4 K3 ["promise"]
        9 JUMPIFNOTEQKNIL                  R1 ; [+26]
       ...
       35 CALL                             R5 -1 0
       36 GETUPVAL                         R5 6
       37 GETTABLEKS                       R5 R5 K14 ["findIndex"]
       39 GETUPVAL                         R6 6
       40 GETTABLEKS                       R6 R6 K15 ["from"]
       42 MOVE                             R7 R1
       43 CALL                             R6 1 1
       44 NEWCLOSURE                       R7 P0
       45 CAPTURE                          UPVAL U7
       ...
       64 CAPTURE                          VAL R5
       65 CAPTURE                          UPVAL U5
       66 DUPTABLE                         R8 K19 [{"message", "pass"}]
       67 SETTABLEKS                       R7 R8 K17 ["message"]
       69 SETTABLEKS                       R6 R8 K18 ["pass"]
       71 RETURN                           R8 1
...
PROTO_40:
        0 DUPTABLE                         R3 K4 [{[1] = "deep equality", ["isNot"], ["promise"]}]
        1 GETTABLEKS                       R4 R0 K2 ["isNot"]
        3 SETTABLEKS                       R4 R3 K2 ["isNot"]
        5 GETTABLEKS                       R4 R0 K3 ["promise"]
        7 SETTABLEKS                       R4 R3 K3 ["promise"]
...
PROTO_54:
       ...
       31 CAPTURE                          VAL R1
       32 CAPTURE                          VAL R0
       33 DUPTABLE                         R6 K11 [{["actual"], ["expected"], ["message"], ["name"] = "toStrictEqual", ["pass"]}]
       34 SETTABLEKS                       R1 R6 K5 ["actual"]
       36 SETTABLEKS                       R2 R6 K6 ["expected"]
       38 SETTABLEKS                       R5 R6 K7 ["message"]
       40 SETTABLEKS                       R4 R6 K10 ["pass"]
       42 RETURN                           R6 1
