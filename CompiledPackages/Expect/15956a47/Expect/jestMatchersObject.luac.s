...
MAIN:
       ...
       16 CALL                             R3 1 1
       17 GETTABLEKS                       R4 R2 K7 ["Object"]
       19 GETTABLEKS                       R5 R2 K8 ["Error"]
       21 GETIMPORT                        R6 K4 [require]
       23 GETTABLEKS                       R7 R1 K9 ["JestGetType"]
       25 CALL                             R6 1 1
       26 GETTABLEKS                       R6 R6 K10 ["getType"]
       28 GETIMPORT                        R7 K4 [require]
       30 GETTABLEKS                       R8 R0 K11 ["asymmetricMatchers"]
       32 CALL                             R7 1 1
       33 GETTABLEKS                       R7 R7 K12 ["AsymmetricMatcher"]
       35 GETIMPORT                        R8 K4 [require]
       37 GETTABLEKS                       R9 R0 K13 ["types"]
       39 CALL                             R8 1 1
       40 GETIMPORT                        R9 K4 [require]
       42 GETTABLEKS                       R10 R0 K14 ["jestMatchersObject_extracted"]
       44 CALL                             R9 1 1
       45 GETTABLEKS                       R10 R9 K15 ["JEST_MATCHERS_OBJECT"]
       47 GETTABLEKS                       R11 R3 K16 ["for_"]
       49 LOADK                            R12 K17 ["$$jest-internal-matcher"]
       50 CALL                             R11 1 1
       51 GETIMPORT                        R13 K19 [_G]
       53 GETTABLE                         R12 R13 R10
       54 JUMPIF                           R12 ; [+15]
       55 DUPTABLE                         R12 K27 [{["assertionCalls"] = 0, ["expectedAssertionsNumber"] = , ["isExpectingAssertions"] = False, ["suppressedErrors"]}]
       56 NEWTABLE                         R13 0 0
       58 SETTABLEKS                       R13 R12 K26 ["suppressedErrors"]
       60 GETIMPORT                        R13 K19 [_G]
       62 DUPTABLE                         R14 K30 [{"matchers", "state"}]
       63 NEWTABLE                         R15 0 0
       65 SETTABLEKS                       R15 R14 K28 ["matchers"]
       67 SETTABLEKS                       R12 R14 K29 ["state"]
       69 SETTABLE                         R14 R13 R10
       70 GETTABLEKS                       R12 R9 K31 ["getState"]
       72 DUPCLOSURE                       R13 K32 [PROTO_0]
       73 CAPTURE                          VAL R4
       74 CAPTURE                          VAL R10
       75 DUPCLOSURE                       R14 K33 [PROTO_1]
       76 CAPTURE                          VAL R10
       77 DUPCLOSURE                       R15 K34 [PROTO_9]
       78 CAPTURE                          VAL R5
       79 CAPTURE                          VAL R6
       80 CAPTURE                          VAL R7
       81 CAPTURE                          VAL R4
       82 CAPTURE                          VAL R10
       83 DUPTABLE                         R16 K39 [{"INTERNAL_MATCHER_FLAG", "getState", "setState", "getMatchers", "setMatchers"}]
       84 SETTABLEKS                       R11 R16 K35 ["INTERNAL_MATCHER_FLAG"]
       86 SETTABLEKS                       R12 R16 K31 ["getState"]
       88 SETTABLEKS                       R13 R16 K36 ["setState"]
       90 SETTABLEKS                       R14 R16 K37 ["getMatchers"]
       92 SETTABLEKS                       R15 R16 K38 ["setMatchers"]
       94 RETURN                           R16 1
