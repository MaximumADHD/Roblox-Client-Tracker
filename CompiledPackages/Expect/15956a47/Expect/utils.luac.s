...
PROTO_1:
       ...
       26 JUMPIFNOT                        R4 ; [+3]
       27 JUMPIF                           R2 ; [+10]
       28 JUMPIFNOTEQKNIL                  R5 ; [+9]
       30 DUPTABLE                         R6 K8 [{["hasEndProp"] = False, ["lastTraversedObject"], ["traversedPath"]}]
       31 SETTABLEKS                       R0 R6 K6 ["lastTraversedObject"]
       33 NEWTABLE                         R7 0 0
       35 SETTABLEKS                       R7 R6 K7 ["traversedPath"]
       37 RETURN                           R6 1
       38 GETUPVAL                         R6 2
       39 MOVE                             R7 R5
       40 GETUPVAL                         R8 0
       41 GETTABLEKS                       R8 R8 K9 ["slice"]
       43 MOVE                             R9 R1
       44 LOADN                            R10 2
       45 CALL                             R8 2 -1
       46 CALL                             R6 -1 1
       47 GETTABLEKS                       R7 R6 K6 ["lastTraversedObject"]
       49 JUMPIFNOTEQKNIL                  R7 ; [+3]
       51 SETTABLEKS                       R0 R6 K6 ["lastTraversedObject"]
       53 GETTABLEKS                       R8 R6 K7 ["traversedPath"]
       55 LOADN                            R9 1
       56 FASTCALL3                        TABLE_INSERT R8 R9 R3
       58 MOVE                             R10 R3
       59 GETIMPORT                        R7 K12 [table.insert]
       61 CALL                             R7 3 0
       62 JUMPIFNOT                        R2 ; [+15]
       63 JUMPIFNOTEQKNIL                  R5 ; [+2]
       65 LOADB                            R7 0 +1
       66 LOADB                            R7 1
       67 SETTABLEKS                       R7 R6 K4 ["hasEndProp"]
       69 GETTABLEKS                       R7 R6 K4 ["hasEndProp"]
       71 JUMPIF                           R7 ; [+6]
       72 GETUPVAL                         R7 0
       73 GETTABLEKS                       R7 R7 K13 ["shift"]
       75 GETTABLEKS                       R8 R6 K7 ["traversedPath"]
       77 CALL                             R7 1 0
       78 RETURN                           R6 1
       79 DUPTABLE                         R2 K16 [{["lastTraversedObject"] = , ["traversedPath"], ["value"]}]
       80 NEWTABLE                         R3 0 0
       82 SETTABLEKS                       R3 R2 K7 ["traversedPath"]
       84 SETTABLEKS                       R0 R2 K15 ["value"]
       86 RETURN                           R2 1
