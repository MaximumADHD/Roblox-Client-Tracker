...
PROTO_4:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["OnViewTypeSelected"]
...
PROTO_5:
        ...
        2 JUMPIFNOT                        R2 ; [+4]
        3 GETUPVAL                         R1 0
        4 GETTABLEKS                       R1 R1 K0 ["Disabled"]
        6 JUMP                             ; [+1]
        7 LOADNIL                          R1
        8 GETUPVAL                         R2 1
       ...
       17 GETUPVAL                         R5 2
       18 GETTABLEKS                       R5 R5 K4 ["isEnumValue"]
       20 MOVE                             R6 R3
       21 CALL                             R5 1 1
       ...
       43 GETUPVAL                         R8 7
       44 DUPTABLE                         R9 K20 [{["Enabled"], ["Icons"], ["Items"], ["HideText"] = True, ["LayoutOrder"], ["OnItemActivated"], ["OnRenderItem"], ["SelectedId"], ["Size"], ["StyleModifier"]}]
       45 GETTABLEKS                       R11 R0 K0 ["Disabled"]
       47 NOT                              R10 R11
       48 SETTABLEKS                       R10 R9 K9 ["Enabled"]
       50 NEWTABLE                         R10 0 2
       52 GETTABLEKS                       R11 R2 K21 ["GridIcon"]
       54 GETTABLEKS                       R12 R2 K22 ["ListIcon"]
       56 SETLIST                          R10 R11 2 [1]
       58 SETTABLEKS                       R10 R9 K10 ["Icons"]
       60 SETTABLEKS                       R6 R9 K11 ["Items"]
       62 GETTABLEKS                       R10 R0 K14 ["LayoutOrder"]
       64 SETTABLEKS                       R10 R9 K14 ["LayoutOrder"]
       66 NEWCLOSURE                       R10 P1
       67 CAPTURE                          VAL R0
       68 SETTABLEKS                       R10 R9 K15 ["OnItemActivated"]
       70 SETTABLEKS                       R4 R9 K16 ["OnRenderItem"]
       72 SETTABLEKS                       R3 R9 K17 ["SelectedId"]
       74 GETTABLEKS                       R10 R2 K18 ["Size"]
       76 SETTABLEKS                       R10 R9 K18 ["Size"]
       78 SETTABLEKS                       R1 R9 K19 ["StyleModifier"]
       80 CALL                             R7 2 -1
       81 RETURN                           R7 -1
...
MAIN:
       ...
       28 GETTABLEKS                       R7 R4 K10 ["Style"]
       30 GETTABLEKS                       R7 R7 K11 ["Stylizer"]
       32 GETTABLEKS                       R8 R4 K12 ["UI"]
       34 GETTABLEKS                       R9 R8 K13 ["SelectInput"]
       36 GETTABLEKS                       R10 R4 K14 ["Util"]
       38 GETTABLEKS                       R10 R10 K15 ["StyleModifier"]
       40 GETIMPORT                        R11 K4 [require]
       42 GETIMPORT                        R12 K1 [script]
       44 GETTABLEKS                       R12 R12 K16 ["ViewTypeButton"]
       46 CALL                             R11 1 1
       47 GETIMPORT                        R12 K4 [require]
       49 GETTABLEKS                       R13 R0 K17 ["Enums"]
       51 GETTABLEKS                       R13 R13 K18 ["ViewType"]
       53 CALL                             R12 1 1
