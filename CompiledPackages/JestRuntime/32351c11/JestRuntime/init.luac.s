...
PROTO_24:
       ...
       17 MOVE                             R4 R0
       18 CALL                             R2 2 1
       19 JUMPIFNOTEQKNIL                  R2 ; [+9]
       21 GETIMPORT                        R3 K7 [error]
       23 LOADK                            R4 K8 ["cannot unmock non-Instance path \"%*\""]
       24 MOVE                             R6 R0
       ...
       30 MOVE                             R1 R0
       31 GETUPVAL                         R2 2
       32 GETTABLEKS                       R2 R2 K10 ["_explicitShouldMock"]
       34 MOVE                             R4 R1
       35 LOADB                            R5 0
       36 NAMECALL                         R2 R2 K11 ["set"]
       38 CALL                             R2 3 0
       39 GETUPVAL                         R2 3
       40 RETURN                           R2 1
...
PROTO_25:
        ...
        4 CALL                             R3 1 1
        5 JUMPIFNOTEQKS                    R3 K2 ["string"] ; [+24]
       ...
       17 MOVE                             R6 R0
       18 CALL                             R4 2 1
       19 JUMPIFNOTEQKNIL                  R4 ; [+9]
       21 GETIMPORT                        R5 K7 [error]
       23 LOADK                            R6 K8 ["cannot mock non-Instance path \"%*\""]
       24 MOVE                             R8 R0
       25 NAMECALL                         R6 R6 K9 ["format"]
       27 CALL                             R6 2 1
       28 CALL                             R5 1 0
       29 MOVE                             R0 R4
       30 JUMPIFEQKNIL                     R1 ; [+7]
       32 GETUPVAL                         R3 2
       33 MOVE                             R4 R0
       34 MOVE                             R5 R1
       35 MOVE                             R6 R2
       ...
       38 MOVE                             R3 R0
       39 GETUPVAL                         R4 3
       40 GETTABLEKS                       R4 R4 K10 ["_explicitShouldMock"]
       42 MOVE                             R6 R3
       43 LOADB                            R7 1
       44 NAMECALL                         R4 R4 K11 ["set"]
       46 CALL                             R4 3 0
       47 GETUPVAL                         R4 4
       48 RETURN                           R4 1
