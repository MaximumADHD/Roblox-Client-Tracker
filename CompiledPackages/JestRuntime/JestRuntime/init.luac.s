...
PROTO_22:
  ...
  JUMPIFEQKN R20 K62 [1] [+17]
  JUMPIFEQKB R5 TRUE [+15]
  GETIMPORT R20 K12 [error]
  GETIMPORT R21 K65 [string.format]
  LOADK R23 K66 ["[Module Error]: %s did not return a valid result
"]
  LOADK R24 K67 ["	ModuleScripts must return exactly one value"]
  CONCAT R22 R23 R24
  FASTCALL1 TOSTRING R10 [+3]
  MOVE R24 R10
  GETIMPORT R23 K69 [tostring]
  CALL R23 1 1
  CALL R21 2 -1
  CALL R20 -1 0
  GETTABLEN R20 R19 1
  SETTABLEKS R20 R1 K70 ["exports"]
  RETURN R0 0
