...
MAIN:
       ...
       46 DUPTABLE                         R13 K27 [{["node"], ["editorCtx"] = , ["blockIndex"] = 0, ["LayoutOrder"] = 0}]
       47 NEWTABLE                         R14 0 0
       49 SETTABLEKS                       R14 R13 K21 ["node"]
       51 NEWTABLE                         R14 0 1
       53 MOVE                             R15 R6
       54 NEWTABLE                         R16 4 3
       56 GETIMPORT                        R20 K29 [UDim2.new]
       58 LOADN                            R21 1
       59 LOADN                            R22 0
       60 LOADN                            R23 0
       61 LOADN                            R24 0
       62 CALL                             R20 4 1
       63 SETTABLEKS                       R20 R16 K30 ["Size"]
       65 GETIMPORT                        R20 K34 [Enum.AutomaticSize.Y]
       67 SETTABLEKS                       R20 R16 K32 ["AutomaticSize"]
       69 LOADN                            R20 1
       70 SETTABLEKS                       R20 R16 K35 ["BackgroundTransparency"]
       72 MOVE                             R20 R3
       73 LOADK                            R21 K26 ["LayoutOrder"]
       74 CALL                             R20 1 1
       75 SETTABLEKS                       R20 R16 K26 ["LayoutOrder"]
       77 MOVE                             R17 R6
       78 NEWTABLE                         R18 2 1
       80 LOADK                            R20 K36 ["box auto-xy"]
       81 SETTABLEKS                       R20 R18 K37 ["Tags"]
       83 LOADN                            R20 1
       84 SETTABLEKS                       R20 R18 K26 ["LayoutOrder"]
       86 MOVE                             R19 R7
       87 DUPTABLE                         R20 K41 [{["Tags"] = "md-image", ["Image"], ["Size"], ["LayoutOrder"] = 1}]
       88 MOVE                             R21 R3
       89 LOADK                            R22 K42 ["imageUrl"]
       90 CALL                             R21 1 1
       91 SETTABLEKS                       R21 R20 K39 ["Image"]
       93 SETTABLEKS                       R9 R20 K30 ["Size"]
       95 CALL                             R19 1 -1
       96 SETLIST                          R18 R19 -1 [1]
       98 CALL                             R17 1 1
       99 MOVE                             R18 R6
      100 DUPTABLE                         R19 K48 [{["Size"], ["BackgroundColor3"], ["BackgroundTransparency"], ["BorderSizePixel"], ["BorderColor3"], ["ZIndex"] = 10}]
      101 GETIMPORT                        R20 K29 [UDim2.new]
      103 LOADN                            R21 1
      104 LOADN                            R22 0
      105 LOADN                            R23 1
      106 LOADN                            R24 0
      107 CALL                             R20 4 1
      108 SETTABLEKS                       R20 R19 K30 ["Size"]
      110 SETTABLEKS                       R10 R19 K43 ["BackgroundColor3"]
      112 MOVE                             R20 R3
      113 LOADK                            R21 K49 ["overlayTransparency"]
      114 CALL                             R20 1 1
      115 SETTABLEKS                       R20 R19 K35 ["BackgroundTransparency"]
      117 MOVE                             R20 R3
      118 LOADK                            R21 K50 ["borderSize"]
      119 CALL                             R20 1 1
      120 SETTABLEKS                       R20 R19 K44 ["BorderSizePixel"]
      122 SETTABLEKS                       R10 R19 K45 ["BorderColor3"]
      124 CALL                             R18 1 1
      125 MOVE                             R19 R8
      126 DUPTABLE                         R20 K55 [{["Size"], ["BackgroundTransparency"] = 1, ["Text"] = "", ["ZIndex"] = 11, ["OnActivated"]}]
      127 GETIMPORT                        R21 K29 [UDim2.new]
      129 LOADN                            R22 1
      130 LOADN                            R23 0
      131 LOADN                            R24 1
      132 LOADN                            R25 0
      133 CALL                             R21 4 1
      134 SETTABLEKS                       R21 R20 K30 ["Size"]
      136 MOVE                             R21 R3
      137 LOADK                            R22 K56 ["onBlockClick"]
      138 CALL                             R21 1 1
      139 SETTABLEKS                       R21 R20 K54 ["OnActivated"]
      141 CALL                             R19 1 -1
      142 SETLIST                          R16 R17 -1 [1]
      144 CALL                             R15 1 -1
      145 SETLIST                          R14 R15 -1 [1]
      147 DUPCLOSURE                       R15 K57 [PROTO_5]
      148 CAPTURE                          VAL R4
      149 CALL                             R11 4 1
      150 RETURN                           R11 1
