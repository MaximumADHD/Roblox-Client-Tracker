...
PROTO_3:
       ...
       52 CALL                             R12 -1 0
       53 LOADK                            R12 K11 ["DynComp_%*_%*"]
       54 GETTABLEKS                       R14 R3 K6 ["attributes"]
       56 GETTABLEKS                       R14 R14 K12 ["tagName"]
       58 GETTABLEKS                       R15 R3 K13 ["index"]
       60 NAMECALL                         R12 R12 K14 ["format"]
       62 CALL                             R12 3 1
       63 GETUPVAL                         R13 1
       64 MOVE                             R14 R12
       65 NEWTABLE                         R15 0 0
       ...
       71 CALL                             R13 4 1
       72 GETUPVAL                         R14 2
       73 GETTABLEKS                       R14 R14 K15 ["addStaticCustomTemplate"]
       75 MOVE                             R15 R13
       76 CALL                             R14 1 0
       77 MOVE                             R8 R13
       78 DUPTABLE                         R9 K18 [{"componentTemplate", "LayoutOrder"}]
       79 SETTABLEKS                       R8 R9 K16 ["componentTemplate"]
       81 GETTABLEKS                       R10 R0 K17 ["LayoutOrder"]
       83 SETTABLEKS                       R10 R9 K17 ["LayoutOrder"]
       85 RETURN                           R9 1
...
MAIN:
       ...
       29 DUPTABLE                         R12 K24 [{["node"], ["componentModules"], ["componentStore"] = , ["updateComponentStore"] = , ["LayoutOrder"] = 0, ["onWarn"] = }]
       30 NEWTABLE                         R13 0 0
       ...
       40 MOVE                             R14 R6
       41 NEWTABLE                         R15 4 1
       43 LOADK                            R17 K25 ["ComponentHost"]
       44 SETTABLEKS                       R17 R15 K26 ["Name"]
       46 LOADK                            R17 K27 ["box auto-xy fill-x"]
       47 SETTABLEKS                       R17 R15 K28 ["Tags"]
       49 MOVE                             R17 R3
       50 LOADK                            R18 K21 ["LayoutOrder"]
       51 CALL                             R17 1 1
       52 SETTABLEKS                       R17 R15 K21 ["LayoutOrder"]
       54 MOVE                             R16 R7
       55 DUPTABLE                         R17 K30 [{"Template"}]
       56 MOVE                             R18 R3
       57 LOADK                            R19 K31 ["componentTemplate"]
       58 CALL                             R18 1 1
       59 SETTABLEKS                       R18 R17 K29 ["Template"]
       61 CALL                             R16 1 -1
       62 SETLIST                          R15 R16 -1 [1]
       64 CALL                             R14 1 -1
       65 SETLIST                          R13 R14 -1 [1]
       67 DUPCLOSURE                       R14 K32 [PROTO_3]
       68 CAPTURE                          VAL R9
       69 CAPTURE                          VAL R4
       70 CAPTURE                          VAL R5
       71 CALL                             R10 4 1
