...
PROTO_4:
        ...
        9 LOADK                            R3 K5 ["Cannot index globalEnv with %* (expected string)"]
       10 MOVE                             R5 R1
       ...
       15 LOADN                            R4 1
       16 LOADN                            R5 2
       17 FASTCALL3                        STRING_SUB R1 R4 R5
       19 MOVE                             R3 R1
       20 GETIMPORT                        R2 K8 [string.sub]
       22 CALL                             R2 3 1
       ...
       33 CALL                             R3 1 1
       34 JUMPIFNOTEQKS                    R3 K10 ["table"] ; [+12]
       36 GETTABLEKS                       R3 R2 K11 ["_isGlobalAutomockFn"]
       38 JUMPIFNOT                        R3 ; [+8]
       39 GETTABLEKS                       R3 R2 K12 ["_maybeUnmocked"]
       41 JUMPIF                           R3 ; [+4]
       42 GETIMPORT                        R3 K4 [error]
       44 LOADK                            R4 K13 ["globalEnv has not been initialised by Jest here"]
       45 CALL                             R3 1 1
       46 RETURN                           R3 1
       47 LOADK                            R3 K14 [""]
       48 GETUPVAL                         R4 1
       ...
       59 MOVE                             R5 R1
       60 CONCAT                           R3 R4 R5
       61 GETIMPORT                        R4 K4 [error]
       63 LOADK                            R5 K16 ["Jest does not yet support mocking the %* global."]
       64 MOVE                             R7 R3
