...
MAIN:
        ...
        5 NEWTABLE                         R2 8 0
        7 DUPTABLE                         R3 K6 [{"print", "warn", "math"}]
        8 GETIMPORT                        R4 K7 [print]
       10 SETTABLEKS                       R4 R3 K3 ["print"]
       12 GETIMPORT                        R4 K8 [warn]
       14 SETTABLEKS                       R4 R3 K4 ["warn"]
       16 DUPTABLE                         R4 K10 [{"random"}]
       17 GETIMPORT                        R5 K11 [math.random]
       19 SETTABLEKS                       R5 R4 K9 ["random"]
       21 SETTABLEKS                       R4 R3 K5 ["math"]
       23 SETTABLEKS                       R2 R2 K12 ["__index"]
       25 DUPCLOSURE                       R4 K13 [PROTO_0]
       26 CAPTURE                          VAL R2
       27 SETTABLEKS                       R4 R2 K14 ["new"]
       29 DUPCLOSURE                       R4 K15 [PROTO_1]
       30 SETTABLEKS                       R4 R2 K16 ["isMockGlobalLibrary"]
       32 DUPCLOSURE                       R4 K17 [PROTO_3]
       33 CAPTURE                          VAL R3
       34 SETTABLEKS                       R4 R2 K18 ["_createGlobalAutomocks"]
       36 DUPCLOSURE                       R4 K19 [PROTO_6]
       37 SETTABLEKS                       R4 R2 K20 ["_createGlobalEnv"]
       39 DUPTABLE                         R4 K23 [{"GlobalMocker", "MOCKABLE_GLOBALS"}]
       40 SETTABLEKS                       R2 R4 K21 ["GlobalMocker"]
       42 SETTABLEKS                       R3 R4 K22 ["MOCKABLE_GLOBALS"]
       44 RETURN                           R4 1
