...
PROTO_6:
       ...
       13 CALL                             R1 2 1
       14 GETUPVAL                         R2 1
       15 GETTABLEKS                       R2 R2 K3 ["useRef"]
       17 NEWTABLE                         R3 0 0
       19 CALL                             R2 1 1
       20 GETUPVAL                         R3 1
       21 GETTABLEKS                       R3 R3 K4 ["useCallback"]
       23 NEWCLOSURE                       R4 P1
       24 CAPTURE                          VAL R2
       25 NEWTABLE                         R5 0 0
       27 CALL                             R3 2 1
       ...
       34 JUMPIFNOT                        R4 ; [+12]
       35 GETUPVAL                         R4 0
       36 GETTABLEKS                       R4 R4 K9 ["useEventConnection"]
       38 GETTABLEKS                       R5 R0 K10 ["pluginGui"]
       40 GETTABLEKS                       R5 R5 K11 ["PointerAction"]
       42 NEWCLOSURE                       R6 P2
       43 CAPTURE                          VAL R2
       44 NEWTABLE                         R7 0 0
       46 CALL                             R4 3 0
       47 GETUPVAL                         R4 1
       48 GETTABLEKS                       R4 R4 K4 ["useCallback"]
       50 NEWCLOSURE                       R5 P3
       51 CAPTURE                          VAL R1
       52 NEWTABLE                         R6 0 1
       54 MOVE                             R7 R1
       ...
       57 CALL                             R4 2 1
       58 GETUPVAL                         R5 1
       59 GETTABLEKS                       R5 R5 K12 ["useMemo"]
       61 NEWCLOSURE                       R6 P4
       62 CAPTURE                          VAL R4
       63 CAPTURE                          VAL R3
       64 NEWTABLE                         R7 0 2
       ...
       70 CALL                             R5 2 1
       71 GETUPVAL                         R6 1
       72 GETTABLEKS                       R6 R6 K13 ["createElement"]
       74 GETUPVAL                         R7 2
       75 GETTABLEKS                       R7 R7 K14 ["Provider"]
...
MAIN:
       ...
       27 GETTABLEKS                       R4 R4 K9 ["ReactUtils"]
       29 CALL                             R3 1 1
