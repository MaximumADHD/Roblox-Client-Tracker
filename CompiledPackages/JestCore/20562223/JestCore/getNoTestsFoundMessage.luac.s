PROTO_0:
        ...
        5 CALL                             R2 1 1
        6 GETUPVAL                         R3 0
        7 GETTABLEKS                       R3 R3 K0 ["toJSBoolean"]
       ...
       24 GETUPVAL                         R5 0
       25 GETTABLEKS                       R5 R5 K0 ["toJSBoolean"]
       27 LOADB                            R6 1
       28 LENGTH                           R7 R0
...
MAIN:
       ...
       27 GETTABLEKS                       R6 R6 K8 ["getNoTestFound"]
       29 CALL                             R5 1 1
       30 GETTABLEKS                       R5 R5 K9 ["default"]
       32 GETIMPORT                        R6 K4 [require]
       34 GETIMPORT                        R7 K1 [script]
       36 GETTABLEKS                       R7 R7 K2 ["Parent"]
       38 GETTABLEKS                       R7 R7 K10 ["getNoTestFoundPassWithNoTests"]
       40 CALL                             R6 1 1
       41 GETTABLEKS                       R6 R6 K9 ["default"]
       43 GETIMPORT                        R7 K4 [require]
       45 GETIMPORT                        R8 K1 [script]
       47 GETTABLEKS                       R8 R8 K2 ["Parent"]
       49 GETTABLEKS                       R8 R8 K11 ["getNoTestFoundVerbose"]
       51 CALL                             R7 1 1
       52 GETTABLEKS                       R7 R7 K9 ["default"]
       54 GETIMPORT                        R8 K4 [require]
       56 GETIMPORT                        R9 K1 [script]
       58 GETTABLEKS                       R9 R9 K2 ["Parent"]
       60 GETTABLEKS                       R9 R9 K12 ["types"]
       62 CALL                             R8 1 1
