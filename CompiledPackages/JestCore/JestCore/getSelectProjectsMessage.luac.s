...
PROTO_1:
  ...
  LOADK R3 K4 ["You provided values for --selectProjects and --ignoreProjects, but no projects were found matching the selection.
"]
  LOADK R4 K5 ["Are you ignoring all the selected projects?
"]
  CONCAT R2 R3 R4
  CALL R1 1 -1
  RETURN R1 -1
  ...
  GETUPVAL R2 1
  GETTABLEKS R1 R2 K3 ["yellow"]
  LOADK R3 K6 ["You provided values for --ignoreProjects, but no projects were found matching the selection.
"]
  LOADK R4 K7 ["Are you ignoring all projects?
"]
  CONCAT R2 R3 R4
  CALL R1 1 -1
  RETURN R1 -1
  ...
  GETUPVAL R2 1
  GETTABLEKS R1 R2 K3 ["yellow"]
  LOADK R2 K8 ["You provided values for --selectProjects but no projects were found matching the selection.
"]
  CALL R1 1 -1
  RETURN R1 -1
  GETUPVAL R2 1
  GETTABLEKS R1 R2 K3 ["yellow"]
  LOADK R2 K9 ["No projects were found.
"]
  CALL R1 1 -1
  RETURN R1 -1
