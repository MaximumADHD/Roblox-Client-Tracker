...
PROTO_7:
       ...
       22 GETUPVAL                         R3 5
       23 GETTABLEKS                       R3 R3 K8 ["new"]
       25 LOADK                            R4 K7 ["Your test suite must contain at least one test."]
       26 CALL                             R3 1 1
       27 GETTABLEKS                       R3 R3 K5 ["stack"]
       29 SETTABLEKS                       R3 R2 K5 ["stack"]
       31 CALL                             R0 2 -1
       32 RETURN                           R0 -1
       33 GETUPVAL                         R0 6
       34 GETTABLEKS                       R0 R0 K9 ["toJSBoolean"]
       36 GETUPVAL                         R1 2
       37 GETTABLEKS                       R1 R1 K10 ["leaks"]
       39 CALL                             R0 1 1
       40 JUMPIFNOT                        R0 ; [+38]
       41 LOADK                            R7 K11 ["%sYour test suite is leaking memory. Please ensure all references are cleaned.\n"]
       42 GETUPVAL                         R10 7
       43 GETTABLEKS                       R10 R10 K12 ["red"]
       ...
       68 GETUPVAL                         R4 5
       69 GETTABLEKS                       R4 R4 K8 ["new"]
       71 MOVE                             R5 R0
       72 CALL                             R4 1 1
       73 GETTABLEKS                       R4 R4 K5 ["stack"]
       ...
       82 CALL                             R0 2 0
       83 GETUPVAL                         R0 10
       84 GETTABLEKS                       R0 R0 K23 ["_dispatcher"]
       86 GETUPVAL                         R2 4
       87 GETUPVAL                         R3 2
       88 GETUPVAL                         R4 9
...
PROTO_13:
        ...
        8 GETUPVAL                         R2 0
        9 GETTABLEKS                       R2 R2 K3 ["snapshot"]
       11 GETTABLEKS                       R3 R2 K0 ["filesRemoved"]
       13 GETTABLEKS                       R4 R1 K0 ["filesRemoved"]
       15 ADD                              R3 R3 R4
       16 SETTABLEKS                       R3 R2 K0 ["filesRemoved"]
       18 GETUPVAL                         R2 0
       19 GETTABLEKS                       R2 R2 K3 ["snapshot"]
       21 GETUPVAL                         R3 1
       22 GETTABLEKS                       R3 R3 K4 ["concat"]
       24 GETUPVAL                         R5 0
       25 GETTABLEKS                       R5 R5 K3 ["snapshot"]
       27 GETTABLEKS                       R5 R5 K1 ["filesRemovedList"]
       29 JUMPIFEQKNIL                     R5 ; [+7]
       31 GETUPVAL                         R4 0
       32 GETTABLEKS                       R4 R4 K3 ["snapshot"]
       34 GETTABLEKS                       R4 R4 K1 ["filesRemovedList"]
       36 JUMP                             ; [+2]
       37 NEWTABLE                         R4 0 0
...
PROTO_21:
       ...
       17 GETUPVAL                         R4 1
       18 GETTABLEKS                       R4 R4 K7 ["_dispatcher"]
       20 MOVE                             R6 R3
       21 MOVE                             R7 R2
...
PROTO_28:
       ...
       58 JUMPIFNOT                        R3 ; [+8]
       59 GETUPVAL                         R15 1
       60 GETTABLEKS                       R15 R15 K11 ["new"]
       62 GETUPVAL                         R16 0
       63 GETTABLEKS                       R16 R16 K0 ["_globalConfig"]
       65 CALL                             R15 1 1
       66 JUMP                             ; [+7]
       67 GETUPVAL                         R15 2
       68 GETTABLEKS                       R15 R15 K11 ["new"]
       70 GETUPVAL                         R16 0
       71 GETTABLEKS                       R16 R16 K0 ["_globalConfig"]
       73 CALL                             R15 1 1
       ...
       80 GETUPVAL                         R13 0
       81 GETUPVAL                         R15 3
       82 GETTABLEKS                       R15 R15 K11 ["new"]
       84 GETUPVAL                         R16 0
       85 GETTABLEKS                       R16 R16 K0 ["_globalConfig"]
       87 CALL                             R15 1 -1
      ...
      120 GETUPVAL                         R6 0
      121 GETUPVAL                         R8 4
      122 GETTABLEKS                       R8 R8 K11 ["new"]
      124 GETUPVAL                         R9 0
      125 GETTABLEKS                       R9 R9 K0 ["_globalConfig"]
      127 CALL                             R8 1 -1
...
PROTO_35:
       ...
       40 CALL                             R0 1 2
       41 GETUPVAL                         R2 0
       42 GETTABLEKS                       R2 R2 K0 ["_globalConfig"]
       44 GETTABLEKS                       R2 R2 K11 ["testFailureExitCode"]
       46 GETUPVAL                         R3 4
       47 MOVE                             R4 R2
       48 CALL                             R3 1 0
       49 JUMPIF                           R0 ; [+4]
