...
PROTO_1:
  ...
  LOADK R7 K6 ["Provided path is invalid: you likely need to provide a different argument to --fs.readwrite.
"]
  LOADK R8 K7 ["You may need to pass in `--fs.readwrite=$PWD`"]
  CONCAT R6 R7 R8
  CALL R5 1 0
