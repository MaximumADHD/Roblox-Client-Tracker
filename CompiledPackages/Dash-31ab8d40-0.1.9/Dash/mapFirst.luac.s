PROTO_0:
  ...
  CALL R3 1 1
  LOADK R4 K2 ["table"]
  LOADK R5 K3 ["Attempted to call Dash.mapFirst with argument #1 of type {left:?} not {right:?}"]
  CALL R2 3 0
  GETUPVAL R2 0
  ...
  LOADK R5 K5 ["Attempted to call Dash.mapFirst with argument #2 of type {left:?} not {right:?}"]
  CALL R2 3 0
