...
PROTO_16:
  ...
  SETTABLEKS R3 R2 K5 ["_init"]
  NEWCLOSURE R3 P3
  CAPTURE VAL R2
  SETTABLEKS R3 R2 K6 ["isInstance"]
  NEWCLOSURE R3 P4
  CAPTURE UPVAL U0
  CAPTURE VAL R2
  SETTABLEKS R3 R2 K7 ["extend"]
  DUPCLOSURE R3 K8 [PROTO_7]
  SETTABLEKS R3 R2 K9 ["toString"]
  DUPCLOSURE R3 K10 [PROTO_8]
  SETTABLEKS R3 R2 K11 ["equals"]
  NEWCLOSURE R3 P7
  CAPTURE VAL R0
  CAPTURE UPVAL U1
  SETTABLEKS R3 R2 K12 ["__lt"]
  NEWCLOSURE R3 P8
  CAPTURE VAL R0
  CAPTURE UPVAL U1
  SETTABLEKS R3 R2 K13 ["__le"]
  NEWCLOSURE R3 P9
  CAPTURE VAL R0
  CAPTURE UPVAL U1
  SETTABLEKS R3 R2 K14 ["__add"]
  NEWCLOSURE R3 P10
  CAPTURE VAL R0
  CAPTURE UPVAL U1
  SETTABLEKS R3 R2 K15 ["__sub"]
  NEWCLOSURE R3 P11
  CAPTURE VAL R0
  CAPTURE UPVAL U1
  SETTABLEKS R3 R2 K16 ["__mul"]
  NEWCLOSURE R3 P12
  CAPTURE VAL R0
  CAPTURE UPVAL U1
  SETTABLEKS R3 R2 K17 ["__div"]
  NEWCLOSURE R3 P13
  CAPTURE VAL R0
  CAPTURE UPVAL U1
  SETTABLEKS R3 R2 K18 ["__mod"]
  CLOSEUPVALS R1
  RETURN R2 1
