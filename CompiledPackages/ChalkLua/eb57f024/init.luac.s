...
PROTO_5:
       ...
       13 LOADB                            R4 1
       14 RETURN                           R4 1
       15 NAMECALL                         R4 R1 K4 ["IsServer"]
       17 CALL                             R4 1 1
       18 JUMPIFNOT                        R4 ; [+6]
       19 NAMECALL                         R4 R1 K5 ["IsStudio"]
       21 CALL                             R4 1 1
       22 JUMPIF                           R4 ; [+2]
       23 LOADB                            R4 1
       24 RETURN                           R4 1
...
MAIN:
      ...
      420 JUMPIF                           R9 ; [+3]
      421 LOADN                            R9 0
      422 SETTABLEKS                       R9 R8 K64 ["level"]
      424 DUPTABLE                         R11 K71 [{"__call"}]
      425 DUPCLOSURE                       R12 K72 [PROTO_6]
      426 SETTABLEKS                       R12 R11 K70 ["__call"]
      428 FASTCALL2                        SETMETATABLE R8 R11 ; [+4]
      430 MOVE                             R10 R8
      431 GETIMPORT                        R9 K74 [setmetatable]
      433 CALL                             R9 2 0
      434 NEWCLOSURE                       R4 P5
      435 CAPTURE                          REF R5
      436 CAPTURE                          VAL R6
      437 DUPCLOSURE                       R5 K75 [PROTO_10]
      438 CAPTURE                          VAL R8
      439 CAPTURE                          VAL R0
      440 CAPTURE                          VAL R1
      441 NEWCLOSURE                       R9 P7
      442 CAPTURE                          REF R4
      443 GETIMPORT                        R10 K61 [string.format]
      445 LOADK                            R11 K62 ["%c[%dm"]
      446 LOADN                            R12 27
      447 LOADN                            R13 39
      448 CALL                             R10 3 1
      449 GETIMPORT                        R11 K61 [string.format]
      451 LOADK                            R12 K62 ["%c[%dm"]
      452 LOADN                            R13 27
      453 LOADN                            R14 49
      454 CALL                             R11 3 1
      455 GETIMPORT                        R12 K61 [string.format]
      457 LOADK                            R13 K62 ["%c[%dm"]
      458 LOADN                            R14 27
      459 LOADN                            R15 0
      460 CALL                             R12 3 1
      461 GETIMPORT                        R13 K55 [pairs]
      463 MOVE                             R14 R3
      464 CALL                             R13 1 3
      465 FORGPREP_NEXT                    R13
      466 MOVE                             R18 R4
      467 GETTABLEKS                       R19 R17 K56 ["open"]
      469 GETTABLEKS                       R20 R17 K57 ["close"]
      471 CALL                             R18 2 1
      472 SETTABLE                         R18 R8 R16
      473 FORGLOOP                         R13 2 ; [-8]
      475 MOVE                             R13 R4
      476 MOVE                             R14 R12
      477 MOVE                             R15 R12
      478 CALL                             R13 2 1
      479 SETTABLEKS                       R13 R8 K6 ["reset"]
      481 DUPCLOSURE                       R13 K76 [PROTO_12]
      482 NEWCLOSURE                       R14 P9
      483 CAPTURE                          VAL R9
      484 CAPTURE                          VAL R13
      485 CAPTURE                          REF R4
      486 CAPTURE                          VAL R10
      487 SETTABLEKS                       R14 R8 K77 ["rgb"]
      489 NEWCLOSURE                       R14 P10
      490 CAPTURE                          VAL R9
      491 CAPTURE                          VAL R13
      492 CAPTURE                          REF R4
      493 CAPTURE                          VAL R11
      494 SETTABLEKS                       R14 R8 K78 ["bgRgb"]
      496 DUPCLOSURE                       R14 K79 [PROTO_15]
      497 CAPTURE                          VAL R13
      498 NEWCLOSURE                       R15 P12
      499 CAPTURE                          VAL R9
      500 CAPTURE                          VAL R13
      501 CAPTURE                          REF R4
      502 CAPTURE                          VAL R10
      503 SETTABLEKS                       R15 R8 K80 ["hex"]
      505 NEWCLOSURE                       R15 P13
      506 CAPTURE                          VAL R9
      507 CAPTURE                          VAL R13
      508 CAPTURE                          REF R4
      509 CAPTURE                          VAL R11
      510 SETTABLEKS                       R15 R8 K81 ["bgHex"]
      512 NEWCLOSURE                       R15 P14
      513 CAPTURE                          VAL R9
      514 CAPTURE                          REF R4
      515 CAPTURE                          VAL R10
      516 SETTABLEKS                       R15 R8 K82 ["ansi"]
      518 NEWCLOSURE                       R15 P15
      519 CAPTURE                          VAL R9
      520 CAPTURE                          REF R4
      521 CAPTURE                          VAL R11
      522 SETTABLEKS                       R15 R8 K83 ["bgAnsi"]
      524 NEWCLOSURE                       R15 P16
      525 CAPTURE                          VAL R9
      526 CAPTURE                          REF R4
      527 CAPTURE                          VAL R10
      528 SETTABLEKS                       R15 R8 K84 ["ansi256"]
      530 NEWCLOSURE                       R15 P17
      531 CAPTURE                          VAL R9
      532 CAPTURE                          REF R4
      533 CAPTURE                          VAL R11
      534 SETTABLEKS                       R15 R8 K85 ["bgAnsi256"]
      536 CLOSEUPVALS                      R4
      537 RETURN                           R8 1
