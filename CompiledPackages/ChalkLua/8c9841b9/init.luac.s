...
MAIN:
      ...
      412 DUPTABLE                         R8 K65 [{"level"}]
      413 LOADN                            R9 2
      414 SETTABLEKS                       R9 R8 K64 ["level"]
      416 GETIMPORT                        R10 K67 [_G]
      418 GETTABLEKS                       R9 R10 K68 ["NOCOLOR"]
      420 JUMPIF                           R9 ; [+6]
      421 GETIMPORT                        R10 K70 [pcall]
      423 DUPCLOSURE                       R11 K71 [PROTO_3]
      424 CALL                             R10 1 1
      425 MOVE                             R9 R10
      426 JUMPIF                           R9 ; [+3]
      427 LOADN                            R9 0
      428 SETTABLEKS                       R9 R8 K64 ["level"]
      430 DUPTABLE                         R11 K73 [{"__call"}]
      431 DUPCLOSURE                       R12 K74 [PROTO_5]
      432 SETTABLEKS                       R12 R11 K72 ["__call"]
      434 FASTCALL2                        SETMETATABLE R8 R11 ; [+4]
      436 MOVE                             R10 R8
      437 GETIMPORT                        R9 K76 [setmetatable]
      439 CALL                             R9 2 0
      440 NEWCLOSURE                       R4 P6
      441 CAPTURE                          REF R5
      442 CAPTURE                          VAL R6
      443 DUPCLOSURE                       R5 K77 [PROTO_9]
      444 CAPTURE                          VAL R8
      445 CAPTURE                          VAL R0
      446 CAPTURE                          VAL R1
      447 NEWCLOSURE                       R9 P8
      448 CAPTURE                          REF R4
      449 GETIMPORT                        R10 K61 [string.format]
      451 LOADK                            R11 K62 ["%c[%dm"]
      452 LOADN                            R12 27
      453 LOADN                            R13 39
      454 CALL                             R10 3 1
      455 GETIMPORT                        R11 K61 [string.format]
      457 LOADK                            R12 K62 ["%c[%dm"]
      458 LOADN                            R13 27
      459 LOADN                            R14 49
      460 CALL                             R11 3 1
      461 GETIMPORT                        R12 K61 [string.format]
      463 LOADK                            R13 K62 ["%c[%dm"]
      464 LOADN                            R14 27
      465 LOADN                            R15 0
      466 CALL                             R12 3 1
      467 GETIMPORT                        R13 K55 [pairs]
      469 MOVE                             R14 R3
      470 CALL                             R13 1 3
      471 FORGPREP_NEXT                    R13
      472 MOVE                             R18 R4
      473 GETTABLEKS                       R19 R17 K56 ["open"]
      475 GETTABLEKS                       R20 R17 K57 ["close"]
      477 CALL                             R18 2 1
      478 SETTABLE                         R18 R8 R16
      479 FORGLOOP                         R13 2 ; [-8]
      481 MOVE                             R13 R4
      482 MOVE                             R14 R12
      483 MOVE                             R15 R12
      484 CALL                             R13 2 1
      485 SETTABLEKS                       R13 R8 K6 ["reset"]
      487 DUPCLOSURE                       R13 K78 [PROTO_11]
      488 NEWCLOSURE                       R14 P10
      489 CAPTURE                          VAL R9
      490 CAPTURE                          VAL R13
      491 CAPTURE                          REF R4
      492 CAPTURE                          VAL R10
      493 SETTABLEKS                       R14 R8 K79 ["rgb"]
      495 NEWCLOSURE                       R14 P11
      496 CAPTURE                          VAL R9
      497 CAPTURE                          VAL R13
      498 CAPTURE                          REF R4
      499 CAPTURE                          VAL R11
      500 SETTABLEKS                       R14 R8 K80 ["bgRgb"]
      502 DUPCLOSURE                       R14 K81 [PROTO_14]
      503 CAPTURE                          VAL R13
      504 NEWCLOSURE                       R15 P13
      505 CAPTURE                          VAL R9
      506 CAPTURE                          VAL R13
      507 CAPTURE                          REF R4
      508 CAPTURE                          VAL R10
      509 SETTABLEKS                       R15 R8 K82 ["hex"]
      511 NEWCLOSURE                       R15 P14
      512 CAPTURE                          VAL R9
      513 CAPTURE                          VAL R13
      514 CAPTURE                          REF R4
      515 CAPTURE                          VAL R11
      516 SETTABLEKS                       R15 R8 K83 ["bgHex"]
      518 NEWCLOSURE                       R15 P15
      519 CAPTURE                          VAL R9
      520 CAPTURE                          REF R4
      521 CAPTURE                          VAL R10
      522 SETTABLEKS                       R15 R8 K84 ["ansi"]
      524 NEWCLOSURE                       R15 P16
      525 CAPTURE                          VAL R9
      526 CAPTURE                          REF R4
      527 CAPTURE                          VAL R11
      528 SETTABLEKS                       R15 R8 K85 ["bgAnsi"]
      530 NEWCLOSURE                       R15 P17
      531 CAPTURE                          VAL R9
      532 CAPTURE                          REF R4
      533 CAPTURE                          VAL R10
      534 SETTABLEKS                       R15 R8 K86 ["ansi256"]
      536 NEWCLOSURE                       R15 P18
      537 CAPTURE                          VAL R9
      538 CAPTURE                          REF R4
      539 CAPTURE                          VAL R11
      540 SETTABLEKS                       R15 R8 K87 ["bgAnsi256"]
      542 CLOSEUPVALS                      R4
      543 RETURN                           R8 1
