PROTO_0:
       ...
       11 GETUPVAL                         R3 0
       12 GETTABLEKS                       R2 R3 K3 ["isArray"]
       14 MOVE                             R3 R0
       15 CALL                             R2 1 1
       16 NOT                              R1 R2
       17 RETURN                           R1 1
...
PROTO_2:
        ...
        4 GETUPVAL                         R2 0
        5 GETTABLEKS                       R1 R2 K1 ["hasRegexChars"]
        7 MOVE                             R2 R0
        8 CALL                             R1 1 1
        9 RETURN                           R1 1
...
PROTO_9:
        0 GETUPVAL                         R4 0
        1 GETTABLEKS                       R3 R4 K0 ["lastIndexOf"]
        3 MOVE                             R4 R0
        4 MOVE                             R5 R1
        5 MOVE                             R6 R2
        6 CALL                             R3 3 1
       ...
       17 GETUPVAL                         R5 1
       18 GETTABLEKS                       R4 R5 K5 ["escapeLast"]
       20 MOVE                             R5 R0
       21 MOVE                             R6 R1
       22 SUBK                             R7 R3 K2 [1]
       23 CALL                             R4 3 -1
       ...
       25 LOADK                            R4 K6 ["%s%s"]
       26 GETUPVAL                         R7 0
       27 GETTABLEKS                       R6 R7 K7 ["slice"]
       29 MOVE                             R7 R0
       30 LOADN                            R8 1
       31 MOVE                             R9 R3
       32 CALL                             R6 3 1
       33 GETUPVAL                         R8 0
       34 GETTABLEKS                       R7 R8 K7 ["slice"]
       36 MOVE                             R8 R0
       37 MOVE                             R9 R3
       38 CALL                             R7 2 -1
...
PROTO_10:
        ...
        4 MOVE                             R3 R0
        5 GETUPVAL                         R5 0
        6 GETTABLEKS                       R4 R5 K0 ["startsWith"]
        8 MOVE                             R5 R3
        9 LOADK                            R6 K1 ["./"]
       10 CALL                             R4 2 1
       11 JUMPIFNOT                        R4 ; [+10]
       12 GETUPVAL                         R5 0
       13 GETTABLEKS                       R4 R5 K2 ["slice"]
       15 MOVE                             R5 R3
       16 LOADN                            R6 3
       17 CALL                             R4 2 1
       18 MOVE                             R3 R4
...
PROTO_11:
       ...
       17 LOADK                            R5 K3 ["^"]
       18 GETUPVAL                         R8 0
       19 GETTABLEKS                       R7 R8 K0 ["toJSBoolean"]
...
MAIN:
       ...
       43 GETTABLEKS                       R12 R0 K18 ["stringUtils"]
       45 CALL                             R11 1 1
       46 GETTABLEKS                       R10 R11 K19 ["stringReplace"]
