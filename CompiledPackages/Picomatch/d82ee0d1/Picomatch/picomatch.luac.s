...
PROTO_9:
       ...
       21 CALL                             R8 1 -1
       22 CALL                             R7 -1 0
       23 JUMPIFNOTEQKS                    R0 K9 [""] ; [+3]
       25 DUPTABLE                         R7 K13 [{["isMatch"] = False, ["output"] = ""}]
       26 RETURN                           R7 1
       27 MOVE                             R7 R2
       28 JUMPIF                           R7 ; [+2]
       29 NEWTABLE                         R7 0 0
       31 GETUPVAL                         R9 1
       32 GETTABLEKS                       R9 R9 K14 ["toJSBoolean"]
       34 GETTABLEKS                       R10 R7 K15 ["format"]
       36 CALL                             R9 1 1
       37 JUMPIFNOT                        R9 ; [+3]
       38 GETTABLEKS                       R8 R7 K15 ["format"]
       40 JUMP                             ; [+11]
       41 GETUPVAL                         R9 1
       42 GETTABLEKS                       R9 R9 K14 ["toJSBoolean"]
       44 MOVE                             R10 R6
       45 CALL                             R9 1 1
       46 JUMPIFNOT                        R9 ; [+4]
       47 GETUPVAL                         R8 2
       48 GETTABLEKS                       R8 R8 K16 ["toPosixSlashes"]
       50 JUMP                             ; [+1]
       51 LOADNIL                          R8
       52 JUMPIFEQ                         R0 R5 ; [+2]
       54 LOADB                            R9 0 +1
       ...
       56 JUMPIFNOT                        R9 ; [+10]
       57 GETUPVAL                         R11 1
       58 GETTABLEKS                       R11 R11 K14 ["toJSBoolean"]
       60 MOVE                             R12 R8
       61 CALL                             R11 1 1
       62 JUMPIFNOT                        R11 ; [+4]
       63 MOVE                             R10 R8
       ...
       66 JUMP                             ; [+1]
       67 MOVE                             R10 R0
       68 JUMPIFNOTEQKB                    R9 FALSE ; [+17]
       70 GETUPVAL                         R11 1
       71 GETTABLEKS                       R11 R11 K14 ["toJSBoolean"]
       73 MOVE                             R12 R8
       74 CALL                             R11 1 1
       75 JUMPIFNOT                        R11 ; [+5]
       76 MOVE                             R11 R8
       ...
       80 JUMP                             ; [+1]
       81 MOVE                             R10 R0
       82 JUMPIFEQ                         R10 R5 ; [+2]
       84 LOADB                            R9 0 +1
       85 LOADB                            R9 1
       86 JUMPIFEQKB                       R9 FALSE ; [+5]
       88 GETTABLEKS                       R11 R7 K17 ["capture"]
       90 JUMPIFNOTEQKB                    R11 TRUE ; [+24]
       92 GETTABLEKS                       R11 R7 K18 ["matchBase"]
       94 JUMPIFEQKB                       R11 TRUE ; [+5]
       96 GETTABLEKS                       R11 R7 K19 ["basename"]
       98 JUMPIFNOTEQKB                    R11 TRUE ; [+11]
      100 GETUPVAL                         R11 3
      101 GETTABLEKS                       R11 R11 K18 ["matchBase"]
      103 MOVE                             R12 R0
      104 MOVE                             R13 R1
      105 MOVE                             R14 R2
      106 MOVE                             R15 R6
      ...
      109 JUMP                             ; [+5]
      110 MOVE                             R13 R10
      111 NAMECALL                         R11 R1 K20 ["exec"]
      113 CALL                             R11 2 1
      114 MOVE                             R9 R11
      115 DUPTABLE                         R11 K22 [{"isMatch", "match", "output"}]
      116 GETUPVAL                         R12 1
      117 GETTABLEKS                       R12 R12 K14 ["toJSBoolean"]
      119 MOVE                             R13 R9
      120 CALL                             R12 1 1
      121 SETTABLEKS                       R12 R11 K10 ["isMatch"]
      123 SETTABLEKS                       R9 R11 K21 ["match"]
      125 SETTABLEKS                       R10 R11 K12 ["output"]
      127 RETURN                           R11 1
...
PROTO_13:
       ...
       20 NEWTABLE                         R5 0 0
       22 MOVE                             R6 R1
       23 DUPTABLE                         R7 K5 [{["fastpaths"] = False}]
       24 CALL                             R4 3 -1
       25 CALL                             R2 -1 -1
       26 RETURN                           R2 -1
...
PROTO_16:
       ...
       25 CALL                             R8 1 -1
       26 CALL                             R7 -1 0
       27 DUPTABLE                         R7 K12 [{["negated"] = False, ["fastpaths"] = True}]
       28 GETTABLEKS                       R8 R4 K10 ["fastpaths"]
       30 JUMPIFEQKB                       R8 FALSE ; [+29]
       32 LOADN                            R10 1
       33 LOADN                            R11 1
       34 FASTCALL3                        STRING_SUB R0 R10 R11
       36 MOVE                             R9 R0
       37 GETIMPORT                        R8 K14 [string.sub]
       39 CALL                             R8 3 1
       40 JUMPIFEQKS                       R8 K15 ["."] ; [+11]
       42 LOADN                            R10 1
       43 LOADN                            R11 1
       44 FASTCALL3                        STRING_SUB R0 R10 R11
       46 MOVE                             R9 R0
       47 GETIMPORT                        R8 K14 [string.sub]
       49 CALL                             R8 3 1
       50 JUMPIFNOTEQKS                    R8 K16 ["*"] ; [+9]
       52 GETUPVAL                         R8 2
       53 GETTABLEKS                       R8 R8 K10 ["fastpaths"]
       55 MOVE                             R9 R0
       56 MOVE                             R10 R4
       57 CALL                             R8 2 1
       58 SETTABLEKS                       R8 R7 K17 ["output"]
       60 GETUPVAL                         R8 0
       61 GETTABLEKS                       R8 R8 K1 ["toJSBoolean"]
       63 GETTABLEKS                       R9 R7 K17 ["output"]
       65 CALL                             R8 1 1
       66 JUMPIF                           R8 ; [+5]
       67 GETUPVAL                         R8 2
       68 MOVE                             R9 R0
       ...
       71 MOVE                             R7 R8
       72 GETUPVAL                         R8 3
       73 GETTABLEKS                       R8 R8 K18 ["compileRe"]
       75 MOVE                             R9 R7
       76 MOVE                             R10 R4
       77 MOVE                             R11 R5
       78 MOVE                             R12 R6
