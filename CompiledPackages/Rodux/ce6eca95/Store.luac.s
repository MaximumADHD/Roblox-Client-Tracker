...
PROTO_7:
       ...
       75 DUPTABLE                         R5 K17 [{["type"] = "@@INIT"}]
       76 NEWTABLE                         R6 0 1
       78 MOVE                             R7 R5
       79 SETLIST                          R6 R7 1 [1]
       81 SETTABLEKS                       R6 R4 K18 ["_actionLog"]
       83 GETIMPORT                        R6 K20 [xpcall]
       85 NEWCLOSURE                       R7 P0
       86 CAPTURE                          VAL R4
       87 CAPTURE                          VAL R0
       88 CAPTURE                          VAL R1
       ...
       91 CALL                             R6 2 2
       92 JUMPIF                           R6 ; [+12]
       93 GETTABLEKS                       R8 R4 K12 ["_errorReporter"]
       95 GETTABLEKS                       R8 R8 K21 ["reportReducerError"]
       97 MOVE                             R9 R1
       98 MOVE                             R10 R5
       99 DUPTABLE                         R11 K25 [{["message"] = "Caught error in reducer with init", ["thrownValue"]}]
      100 SETTABLEKS                       R7 R11 K24 ["thrownValue"]
      102 CALL                             R8 3 0
      103 SETTABLEKS                       R1 R4 K26 ["_state"]
      105 GETTABLEKS                       R8 R4 K26 ["_state"]
      107 SETTABLEKS                       R8 R4 K27 ["_lastState"]
      109 LOADB                            R8 0
      110 SETTABLEKS                       R8 R4 K28 ["_mutatedSinceFlush"]
      112 NEWTABLE                         R8 0 0
      114 SETTABLEKS                       R8 R4 K29 ["_connections"]
      116 GETUPVAL                         R8 2
      117 GETTABLEKS                       R8 R8 K30 ["new"]
      119 MOVE                             R9 R4
      120 CALL                             R8 1 1
      121 SETTABLEKS                       R8 R4 K31 ["changed"]
      123 GETUPVAL                         R10 3
      124 FASTCALL2                        SETMETATABLE R4 R10 ; [+4]
      126 MOVE                             R9 R4
      127 GETIMPORT                        R8 K33 [setmetatable]
      129 CALL                             R8 2 0
      130 GETTABLEKS                       R8 R4 K34 ["_flushEvent"]
      132 NEWCLOSURE                       R10 P1
      133 CAPTURE                          VAL R4
      134 NAMECALL                         R8 R8 K35 ["Connect"]
      136 CALL                             R8 2 1
      137 GETTABLEKS                       R10 R4 K29 ["_connections"]
      139 FASTCALL2                        TABLE_INSERT R10 R8 ; [+4]
      141 MOVE                             R11 R8
      142 GETIMPORT                        R9 K37 [table.insert]
      144 CALL                             R9 2 0
      145 JUMPIFNOT                        R2 ; [+21]
      146 GETTABLEKS                       R9 R4 K38 ["dispatch"]
      ...
      163 CAPTURE                          REF R10
      164 SETTABLEKS                       R11 R4 K38 ["dispatch"]
      166 CLOSEUPVALS                      R10
      167 RETURN                           R4 1
