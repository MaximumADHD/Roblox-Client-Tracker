...
PROTO_3:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R1 R2 K0 ["changed"]
        3 MOVE                             R3 R0
        4 GETUPVAL                         R5 0
        5 GETTABLEKS                       R4 R5 K1 ["_lastState"]
...
PROTO_4:
        0 GETUPVAL                         R0 0
        1 GETUPVAL                         R2 0
        2 GETTABLEKS                       R1 R2 K0 ["_reducer"]
        4 GETUPVAL                         R2 1
        5 GETUPVAL                         R3 2
        6 CALL                             R1 2 1
...
PROTO_8:
      ...
      127 CALL                             R6 2 0
      128 DUPTABLE                         R6 K33 [{"type"}]
      129 LOADK                            R7 K34 ["@@INIT"]
      130 SETTABLEKS                       R7 R6 K32 ["type"]
      132 NEWTABLE                         R7 0 1
      134 MOVE                             R8 R6
      135 SETLIST                          R7 R8 1 [1]
      137 SETTABLEKS                       R7 R5 K35 ["_actionLog"]
      139 GETIMPORT                        R7 K37 [xpcall]
      141 NEWCLOSURE                       R8 P1
      142 CAPTURE                          VAL R5
      143 CAPTURE                          VAL R1
      144 CAPTURE                          VAL R6
      145 GETUPVAL                         R9 2
      146 CALL                             R7 2 2
      147 JUMPIF                           R7 ; [+15]
      148 GETTABLEKS                       R10 R5 K23 ["_errorReporter"]
      150 GETTABLEKS                       R9 R10 K38 ["reportReducerError"]
      152 MOVE                             R10 R1
      153 MOVE                             R11 R6
      154 DUPTABLE                         R12 K41 [{"message", "thrownValue"}]
      155 LOADK                            R13 K42 ["Caught error in reducer with init"]
      156 SETTABLEKS                       R13 R12 K39 ["message"]
      158 SETTABLEKS                       R8 R12 K40 ["thrownValue"]
      160 CALL                             R9 3 0
      161 SETTABLEKS                       R1 R5 K43 ["_state"]
      163 GETTABLEKS                       R9 R5 K43 ["_state"]
      165 SETTABLEKS                       R9 R5 K25 ["_lastState"]
      167 LOADB                            R9 0
      168 SETTABLEKS                       R9 R5 K44 ["_mutatedSinceFlush"]
      170 NEWTABLE                         R9 0 0
      172 SETTABLEKS                       R9 R5 K45 ["_connections"]
      174 GETUPVAL                         R11 3
      175 FASTCALL2                        SETMETATABLE R5 R11 ; [+4]
      177 MOVE                             R10 R5
      178 GETIMPORT                        R9 K47 [setmetatable]
      180 CALL                             R9 2 0
      181 GETTABLEKS                       R9 R5 K48 ["_flushEvent"]
      183 NEWCLOSURE                       R11 P2
      184 CAPTURE                          VAL R5
      185 NAMECALL                         R9 R9 K49 ["Connect"]
      187 CALL                             R9 2 1
      188 GETTABLEKS                       R11 R5 K45 ["_connections"]
      190 FASTCALL2                        TABLE_INSERT R11 R9 ; [+4]
      192 MOVE                             R12 R9
      193 GETIMPORT                        R10 K51 [table.insert]
      195 CALL                             R10 2 0
      196 JUMPIFNOT                        R2 ; [+21]
      197 GETTABLEKS                       R10 R5 K52 ["dispatch"]
      199 NEWCLOSURE                       R11 P3
      200 CAPTURE                          VAL R10
      201 CAPTURE                          VAL R5
      202 LENGTH                           R14 R2
      203 LOADN                            R12 1
      ...
      211 MOVE                             R11 R16
      212 FORNLOOP                         R12
      213 NEWCLOSURE                       R12 P4
      214 CAPTURE                          REF R11
      215 SETTABLEKS                       R12 R5 K52 ["dispatch"]
      217 CLOSEUPVALS                      R11
      218 RETURN                           R5 1
...
PROTO_10:
        ...
        4 GETUPVAL                         R0 0
        5 GETUPVAL                         R2 0
        6 GETTABLEKS                       R1 R2 K1 ["_reducer"]
        8 GETUPVAL                         R3 0
        9 GETTABLEKS                       R2 R3 K2 ["_state"]
       11 GETUPVAL                         R3 1
       12 CALL                             R1 2 1
...
PROTO_11:
       ...
       52 JUMPIF                           R2 ; [+14]
       53 GETTABLEKS                       R5 R0 K16 ["_errorReporter"]
       55 GETTABLEKS                       R4 R5 K17 ["reportReducerError"]
...
PROTO_13:
        0 GETUPVAL                         R0 0
        1 GETUPVAL                         R2 1
        2 GETTABLEKS                       R1 R2 K0 ["_flushHandler"]
        4 GETUPVAL                         R2 2
        5 CALL                             R0 2 0
        6 RETURN                           R0 0
...
PROTO_14:
       ...
       16 CALL                             R2 2 2
       17 JUMPIF                           R2 ; [+16]
       18 GETTABLEKS                       R5 R0 K4 ["_errorReporter"]
       20 GETTABLEKS                       R4 R5 K5 ["reportUpdateError"]
...
MAIN:
       ...
       13 GETTABLEKS                       R2 R3 K9 ["Signal"]
       15 CALL                             R1 1 1
       16 GETIMPORT                        R2 K5 [require]
       18 GETIMPORT                        R5 K7 [script]
       20 GETTABLEKS                       R4 R5 K8 ["Parent"]
       22 GETTABLEKS                       R3 R4 K10 ["NoYield"]
       24 CALL                             R2 1 1
