...
PROTO_8:
        0 DUPTABLE                         R1 K3 [{"suites", "tests", "title"}]
        1 NEWTABLE                         R2 0 0
        3 SETTABLEKS                       R2 R1 K0 ["suites"]
        5 NEWTABLE                         R2 0 0
        7 SETTABLEKS                       R2 R1 K1 ["tests"]
        9 LOADK                            R2 K4 [""]
       10 SETTABLEKS                       R2 R1 K2 ["title"]
       12 GETUPVAL                         R3 0
       13 GETTABLEKS                       R2 R3 K5 ["forEach"]
       15 MOVE                             R3 R0
       16 NEWCLOSURE                       R4 P0
       17 CAPTURE                          VAL R1
       18 CAPTURE                          UPVAL U0
...
PROTO_9:
        0 GETUPVAL                         R5 0
        1 GETTABLEKS                       R4 R5 K0 ["testFinished"]
        3 MOVE                             R5 R0
        4 GETTABLEKS                       R7 R1 K1 ["context"]
        6 GETTABLEKS                       R6 R7 K2 ["config"]
        8 MOVE                             R7 R2
        9 MOVE                             R8 R3
       10 CALL                             R4 4 0
       11 GETUPVAL                         R5 1
       12 GETTABLEKS                       R4 R5 K3 ["toJSBoolean"]
       14 GETTABLEKS                       R5 R2 K4 ["skipped"]
       16 CALL                             R4 1 1
       17 JUMPIF                           R4 ; [+39]
       18 GETTABLEKS                       R6 R2 K5 ["testFilePath"]
       20 GETTABLEKS                       R8 R1 K1 ["context"]
       22 GETTABLEKS                       R7 R8 K2 ["config"]
       24 MOVE                             R8 R2
       25 NAMECALL                         R4 R0 K6 ["printTestFileHeader"]
       27 CALL                             R4 4 0
       28 GETUPVAL                         R5 1
       29 GETTABLEKS                       R4 R5 K3 ["toJSBoolean"]
       31 GETTABLEKS                       R5 R2 K7 ["testExecError"]
       33 CALL                             R4 1 1
       34 JUMPIF                           R4 ; [+12]
       35 GETUPVAL                         R5 1
       36 GETTABLEKS                       R4 R5 K3 ["toJSBoolean"]
       ...
       49 GETTABLEKS                       R8 R1 K1 ["context"]
       51 GETTABLEKS                       R7 R8 K2 ["config"]
       53 MOVE                             R8 R2
       54 NAMECALL                         R4 R0 K10 ["printTestFileFailureMessage"]
       56 CALL                             R4 4 0
       57 GETUPVAL                         R5 0
       58 GETTABLEKS                       R4 R5 K11 ["forceFlushBufferedOutput"]
       60 MOVE                             R5 R0
       61 CALL                             R4 1 0
       62 RETURN                           R0 0
...
PROTO_10:
        0 GETUPVAL                         R5 0
        1 GETTABLEKS                       R4 R5 K0 ["groupTestsBySuites"]
        3 MOVE                             R5 R1
        4 CALL                             R4 1 1
        5 LOADN                            R5 0
...
PROTO_12:
       ...
       18 CALL                             R3 3 0
       19 GETUPVAL                         R4 1
       20 GETTABLEKS                       R3 R4 K6 ["forEach"]
...
PROTO_13:
        ...
        2 GETUPVAL                         R3 0
        3 GETTABLEKS                       R2 R3 K1 ["red"]
        5 GETUPVAL                         R4 1
        6 GETTABLEKS                       R3 R4 K0 ["failed"]
        8 CALL                             R2 1 -1
        9 RETURN                           R2 -1
       10 JUMPIFNOTEQKS                    R1 K2 ["pending"] ; [+9]
       12 GETUPVAL                         R3 0
       13 GETTABLEKS                       R2 R3 K3 ["yellow"]
       15 GETUPVAL                         R4 1
       16 GETTABLEKS                       R3 R4 K2 ["pending"]
       18 CALL                             R2 1 -1
       19 RETURN                           R2 -1
       20 JUMPIFNOTEQKS                    R1 K4 ["todo"] ; [+9]
       22 GETUPVAL                         R3 0
       23 GETTABLEKS                       R2 R3 K5 ["magenta"]
       25 GETUPVAL                         R4 1
       26 GETTABLEKS                       R3 R4 K4 ["todo"]
       28 CALL                             R2 1 -1
       29 RETURN                           R2 -1
       30 GETUPVAL                         R3 0
       31 GETTABLEKS                       R2 R3 K6 ["green"]
       33 GETUPVAL                         R4 1
       34 GETTABLEKS                       R3 R4 K7 ["success"]
       36 CALL                             R2 1 -1
       37 RETURN                           R2 -1
...
PROTO_17:
        0 GETUPVAL                         R4 0
        1 GETTABLEKS                       R3 R4 K0 ["toJSBoolean"]
        3 GETTABLEKS                       R5 R0 K1 ["_globalConfig"]
        5 GETTABLEKS                       R4 R5 K2 ["expand"]
        7 CALL                             R3 1 1
        8 JUMPIFNOT                        R3 ; [+9]
        9 GETUPVAL                         R4 1
       10 GETTABLEKS                       R3 R4 K3 ["forEach"]
       12 MOVE                             R4 R1
       13 NEWCLOSURE                       R5 P0
       14 CAPTURE                          VAL R0
       15 CAPTURE                          VAL R2
       ...
       41 GETUPVAL                         R5 1
       42 GETTABLEKS                       R4 R5 K3 ["forEach"]
       ...
       57 GETUPVAL                         R5 1
       58 GETTABLEKS                       R4 R5 K3 ["forEach"]
...
PROTO_20:
        0 LOADK                            R3 K0 ["  "]
        1 GETUPVAL                         R7 0
        2 GETTABLEKS                       R6 R7 K1 ["toJSBoolean"]
        4 MOVE                             R7 R2
        5 CALL                             R6 1 1
        6 JUMPIFNOT                        R6 ; [+2]
        7 MOVE                             R5 R2
...
MAIN:
       ...
       51 GETTABLEKS                       R15 R1 K16 ["RobloxShared"]
       53 CALL                             R14 1 1
       54 NEWTABLE                         R16 0 0
       56 DUPTABLE                         R17 K18 [{"__index"}]
       57 SETTABLEKS                       R13 R17 K17 ["__index"]
       59 FASTCALL2                        SETMETATABLE R16 R17 ; [+3]
       61 GETIMPORT                        R15 K20 [setmetatable]
       63 CALL                             R15 2 1
       64 SETTABLEKS                       R15 R15 K17 ["__index"]
       66 LOADK                            R16 K21 ["VerboseReporter"]
       67 SETTABLEKS                       R16 R15 K22 ["filename"]
       69 DUPCLOSURE                       R16 K23 [PROTO_0]
       70 DUPCLOSURE                       R17 K24 [PROTO_1]
       71 CAPTURE                          VAL R13
       72 CAPTURE                          VAL R15
       73 SETTABLEKS                       R17 R15 K25 ["new"]
       75 DUPCLOSURE                       R17 K26 [PROTO_3]
       76 SETTABLEKS                       R17 R15 K27 ["__wrapStdio"]
       78 DUPCLOSURE                       R17 K28 [PROTO_5]
       79 CAPTURE                          VAL R3
       80 SETTABLEKS                       R17 R15 K29 ["filterTestResults"]
       82 DUPCLOSURE                       R17 K30 [PROTO_8]
       83 CAPTURE                          VAL R3
       84 SETTABLEKS                       R17 R15 K31 ["groupTestsBySuites"]
       86 DUPCLOSURE                       R17 K32 [PROTO_9]
       87 CAPTURE                          VAL R13
       88 CAPTURE                          VAL R4
       89 SETTABLEKS                       R17 R15 K33 ["onTestResult"]
       91 DUPCLOSURE                       R17 K34 [PROTO_10]
       92 CAPTURE                          VAL R15
       93 SETTABLEKS                       R17 R15 K35 ["_logTestResults"]
       95 DUPCLOSURE                       R17 K36 [PROTO_12]
       96 CAPTURE                          VAL R4
       97 CAPTURE                          VAL R3
       98 SETTABLEKS                       R17 R15 K37 ["_logSuite"]
      100 DUPCLOSURE                       R17 K38 [PROTO_13]
      101 CAPTURE                          VAL R6
      102 CAPTURE                          VAL R11
      103 SETTABLEKS                       R17 R15 K39 ["_getIcon"]
      105 DUPCLOSURE                       R17 K40 [PROTO_14]
      106 CAPTURE                          VAL R10
      107 CAPTURE                          VAL R6
      108 SETTABLEKS                       R17 R15 K41 ["_logTest"]
      110 DUPCLOSURE                       R17 K42 [PROTO_17]
      111 CAPTURE                          VAL R4
      112 CAPTURE                          VAL R3
      113 SETTABLEKS                       R17 R15 K43 ["_logTests"]
      115 DUPCLOSURE                       R17 K44 [PROTO_19]
      116 CAPTURE                          VAL R6
      117 SETTABLEKS                       R17 R15 K45 ["_logTodoOrPendingTest"]
      119 DUPCLOSURE                       R17 K46 [PROTO_20]
      120 CAPTURE                          VAL R4
      121 SETTABLEKS                       R17 R15 K47 ["_logLine"]
      123 SETTABLEKS                       R15 R5 K15 ["default"]
      125 RETURN                           R5 1
