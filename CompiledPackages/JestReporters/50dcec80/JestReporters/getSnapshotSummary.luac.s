PROTO_0:
        0 PREPVARARGS                      0
        1 GETUPVAL                         R0 0
        2 GETTABLEKS                       R0 R0 K0 ["bold"]
        4 GETUPVAL                         R1 0
        5 GETTABLEKS                       R1 R1 K1 ["red"]
        7 GETVARARGS                       R2 -1
        8 CALL                             R1 -1 -1
        9 CALL                             R0 -1 -1
       10 RETURN                           R0 -1
...
PROTO_7:
       ...
       13 CALL                             R1 2 0
       14 GETUPVAL                         R1 3
       15 GETTABLEKS                       R1 R1 K6 ["forEach"]
...
PROTO_8:
        ...
        9 CALL                             R4 -1 0
       10 GETUPVAL                         R4 1
       11 GETTABLEKS                       R4 R4 K4 ["toJSBoolean"]
       ...
       43 CALL                             R4 2 0
       44 GETUPVAL                         R4 1
       45 GETTABLEKS                       R4 R4 K4 ["toJSBoolean"]
       ...
       83 CALL                             R4 2 0
       84 GETUPVAL                         R4 1
       85 GETTABLEKS                       R4 R4 K4 ["toJSBoolean"]
      ...
      117 CALL                             R4 2 0
      118 GETUPVAL                         R4 1
      119 GETTABLEKS                       R4 R4 K4 ["toJSBoolean"]
      ...
      234 CALL                             R6 2 0
      235 GETUPVAL                         R6 10
      236 GETTABLEKS                       R6 R6 K43 ["forEach"]
      238 MOVE                             R7 R5
      ...
      243 CALL                             R6 2 0
      244 GETUPVAL                         R4 1
      245 GETTABLEKS                       R4 R4 K4 ["toJSBoolean"]
      ...
      324 CALL                             R4 2 0
      325 GETUPVAL                         R4 10
      326 GETTABLEKS                       R4 R4 K43 ["forEach"]
...
MAIN:
       ...
       37 CALL                             R9 1 1
       38 GETTABLEKS                       R9 R9 K12 ["pluralize"]
       40 GETIMPORT                        R10 K4 [require]
       42 GETTABLEKS                       R11 R0 K13 ["utils"]
       44 CALL                             R10 1 1
       45 GETTABLEKS                       R10 R10 K14 ["formatTestPath"]
