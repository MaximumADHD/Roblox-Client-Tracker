...
PROTO_1:
       ...
       15 GETTABLEKS                       R4 R0 K5 ["_process"]
       17 GETTABLEKS                       R4 R4 K6 ["stderr"]
       19 GETUPVAL                         R6 0
       20 GETTABLEKS                       R6 R6 K7 ["charCodeAt"]
       22 MOVE                             R7 R1
       23 MOVE                             R8 R2
       24 CALL                             R6 2 -1
...
PROTO_5:
      ...
      110 JUMP                             ; [+23]
      111 GETUPVAL                         R9 0
      112 GETTABLEKS                       R9 R9 K0 ["toJSBoolean"]
      114 MOVE                             R10 R4
      115 CALL                             R9 1 1
      116 JUMPIFNOT                        R9 ; [+16]
      117 JUMPIFNOT                        R8 ; [+15]
      ...
      138 CALL                             R9 3 1
      139 GETUPVAL                         R10 6
      140 GETTABLEKS                       R10 R10 K25 ["forEach"]
      142 MOVE                             R11 R9
...
PROTO_8:
        ...
        3 GETUPVAL                         R2 1
        4 GETTABLEKS                       R2 R2 K1 ["findRelatedTests"]
        6 CALL                             R1 1 1
        7 JUMPIFNOT                        R1 ; [+2]
...
PROTO_10:
        ...
        7 JUMPIFNOT                        R5 ; [+7]
        8 GETUPVAL                         R5 1
        9 GETTABLEKS                       R5 R5 K2 ["dim"]
       11 LOADK                            R6 K3 [" within paths"]
       12 CALL                             R5 1 1
       13 MOVE                             R4 R5
       14 JUMP                             ; [+37]
       15 GETUPVAL                         R5 0
       16 GETTABLEKS                       R5 R5 K4 ["toJSBoolean"]
       18 GETTABLEKS                       R6 R2 K5 ["onlyChanged"]
       20 CALL                             R5 1 1
       21 JUMPIFNOT                        R5 ; [+7]
       22 GETUPVAL                         R5 1
       23 GETTABLEKS                       R5 R5 K2 ["dim"]
       25 LOADK                            R6 K6 [" related to changed files"]
       26 CALL                             R5 1 1
       27 MOVE                             R4 R5
       28 JUMP                             ; [+23]
       29 GETUPVAL                         R5 0
       30 GETTABLEKS                       R5 R5 K4 ["toJSBoolean"]
       32 GETTABLEKS                       R6 R2 K7 ["testPathPattern"]
       34 CALL                             R5 1 1
       35 JUMPIFNOT                        R5 ; [+16]
       36 GETUPVAL                         R6 0
       37 GETTABLEKS                       R6 R6 K4 ["toJSBoolean"]
       ...
       56 LOADK                            R6 K11 [" "]
       57 GETUPVAL                         R7 2
       58 GETTABLEKS                       R7 R7 K12 ["join"]
       60 GETUPVAL                         R8 2
       61 GETTABLEKS                       R8 R8 K13 ["map"]
...
MAIN:
       ...
       39 GETTABLEKS                       R12 R0 K13 ["BaseReporter"]
       41 CALL                             R11 1 1
       42 GETTABLEKS                       R11 R11 K14 ["default"]
       44 GETIMPORT                        R12 K4 [require]
       46 GETTABLEKS                       R13 R0 K15 ["getResultHeader"]
       48 CALL                             R12 1 1
       49 GETTABLEKS                       R12 R12 K14 ["default"]
       51 GETIMPORT                        R13 K4 [require]
       53 GETTABLEKS                       R14 R0 K16 ["getSnapshotSummary"]
       55 CALL                             R13 1 1
       56 GETTABLEKS                       R13 R13 K14 ["default"]
       58 GETIMPORT                        R14 K4 [require]
       60 GETTABLEKS                       R15 R0 K17 ["types"]
       62 CALL                             R14 1 1
       63 GETIMPORT                        R15 K4 [require]
       65 GETTABLEKS                       R16 R0 K18 ["utils"]
       67 CALL                             R15 1 1
       68 GETTABLEKS                       R15 R15 K19 ["getSummary"]
