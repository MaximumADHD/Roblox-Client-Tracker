...
PROTO_14:
       ...
       37 LOADB                            R7 0 +1
       38 LOADB                            R7 1
       39 FASTCALL1                        ASSERT R7 ; [+2]
       40 GETIMPORT                        R6 K9 [assert]
       42 CALL                             R6 1 0
       43 GETUPVAL                         R7 4
       44 GETUPVAL                         R10 5
       45 MOVE                             R12 R4
...
PROTO_15:
       ...
       15 CALL                             R1 1 1
       16 JUMPIFNOT                        R1 ; [+2]
       17 DUPTABLE                         R1 K6 [{["clear"] = "", ["content"] = ""}]
       18 RETURN                           R1 1
       19 LOADK                            R1 K7 ["\n"]
       20 GETUPVAL                         R2 1
       21 GETTABLEKS                       R2 R2 K8 ["forEach"]
       23 GETTABLEKS                       R3 R0 K9 ["_currentTests"]
       25 NAMECALL                         R3 R3 K10 ["get"]
       27 CALL                             R3 1 1
       28 NEWCLOSURE                       R4 P0
       29 CAPTURE                          UPVAL U0
       30 CAPTURE                          UPVAL U2
       ...
       35 CAPTURE                          UPVAL U6
       36 CALL                             R2 2 0
       37 GETTABLEKS                       R2 R0 K11 ["_showStatus"]
       39 JUMPIFNOT                        R2 ; [+27]
       40 GETUPVAL                         R2 0
       41 GETTABLEKS                       R2 R2 K0 ["toJSBoolean"]
       43 GETTABLEKS                       R3 R0 K12 ["_aggregatedResults"]
       45 CALL                             R2 1 1
       46 JUMPIFNOT                        R2 ; [+20]
       47 MOVE                             R2 R1
       48 LOADK                            R3 K7 ["\n"]
       49 GETUPVAL                         R5 7
       50 GETTABLEKS                       R6 R0 K12 ["_aggregatedResults"]
       52 DUPTABLE                         R7 K19 [{["currentTestCases"], ["estimatedTime"], ["roundTime"] = True, ["width"] = 0}]
       53 GETTABLEKS                       R8 R0 K20 ["_currentTestCases"]
       55 SETTABLEKS                       R8 R7 K13 ["currentTestCases"]
       57 GETTABLEKS                       R8 R0 K21 ["_estimatedTime"]
       59 SETTABLEKS                       R8 R7 K14 ["estimatedTime"]
       61 CALL                             R5 2 -1
       62 FASTCALL                         TOSTRING ; [+2]
       63 GETIMPORT                        R4 K23 [tostring]
       65 CALL                             R4 -1 1
       66 CONCAT                           R1 R2 R4
       67 LOADN                            R2 0
       68 LOADN                            R3 0
       69 GETIMPORT                        R4 K26 [utf8.len]
       71 MOVE                             R5 R1
       72 CALL                             R4 1 1
       73 JUMPIFNOTEQKNIL                  R4 ; [+2]
       75 LOADB                            R6 0 +1
       76 LOADB                            R6 1
       77 FASTCALL1                        ASSERT R6 ; [+2]
       78 GETIMPORT                        R5 K28 [assert]
       80 CALL                             R5 1 0
       81 JUMPIFNOTLT                      R3 R4 ; [+12]
       83 GETUPVAL                         R5 8
       84 GETTABLEKS                       R5 R5 K29 ["charCodeAt"]
       86 MOVE                             R6 R1
       87 MOVE                             R7 R3
       88 CALL                             R5 2 1
       89 JUMPIFNOTEQKS                    R5 K7 ["\n"] ; [+2]
       91 ADDK                             R2 R2 K30 [1]
       92 ADDK                             R3 R3 K30 [1]
       93 JUMPBACK                         ; [-13]
       94 LOADK                            R5 K7 ["\n"]
       95 MOVE                             R7 R2
       96 NAMECALL                         R5 R5 K31 ["rep"]
       98 CALL                             R5 2 1
       99 DUPTABLE                         R6 K32 [{"clear", "content"}]
      100 SETTABLEKS                       R5 R6 K3 ["clear"]
      102 SETTABLEKS                       R1 R6 K5 ["content"]
      104 SETTABLEKS                       R6 R0 K1 ["_cache"]
      106 GETTABLEKS                       R6 R0 K1 ["_cache"]
      108 CLOSEUPVALS                      R1
      109 RETURN                           R6 1
