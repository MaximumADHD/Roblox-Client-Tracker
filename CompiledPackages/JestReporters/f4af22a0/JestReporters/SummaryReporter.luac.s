...
PROTO_1:
        0 GETTABLEKS                       R3 R0 K0 ["_process"]
        2 GETTABLEKS                       R2 R3 K1 ["stderr"]
        4 MOVE                             R4 R1
...
PROTO_5:
      ...
      102 CALL                             R8 -1 1
      103 GETUPVAL                         R10 0
      104 GETTABLEKS                       R9 R10 K0 ["toJSBoolean"]
      106 MOVE                             R10 R4
      107 CALL                             R9 1 1
      108 JUMPIFNOT                        R9 ; [+16]
      109 JUMPIFNOT                        R8 ; [+15]
      ...
      130 CALL                             R9 3 1
      131 GETUPVAL                         R11 6
      132 GETTABLEKS                       R10 R11 K22 ["forEach"]
      134 MOVE                             R11 R9
...
PROTO_10:
        ...
        5 JUMPIFNOT                        R5 ; [+7]
        6 GETUPVAL                         R6 0
        7 GETTABLEKS                       R5 R6 K3 ["dim"]
        9 LOADK                            R6 K4 [" within paths"]
       10 CALL                             R5 1 1
       11 MOVE                             R4 R5
       12 JUMP                             ; [+12]
       13 GETUPVAL                         R6 1
       14 GETTABLEKS                       R5 R6 K5 ["toJSBoolean"]
       16 GETTABLEKS                       R6 R2 K6 ["testPathPattern"]
       18 CALL                             R5 1 1
       19 JUMPIFNOT                        R5 ; [+5]
       20 GETUPVAL                         R5 0
       21 GETTABLEKS                       R4 R5 K3 ["dim"]
       ...
       29 LOADK                            R6 K8 [" "]
       30 GETUPVAL                         R8 2
       31 GETTABLEKS                       R7 R8 K9 ["join"]
       33 GETUPVAL                         R9 2
       34 GETTABLEKS                       R8 R9 K10 ["map"]
...
MAIN:
       ...
       37 GETTABLEKS                       R12 R0 K12 ["BaseReporter"]
       39 CALL                             R11 1 1
       40 GETTABLEKS                       R10 R11 K13 ["default"]
       42 GETIMPORT                        R12 K4 [require]
       44 GETTABLEKS                       R13 R0 K14 ["getResultHeader"]
       46 CALL                             R12 1 1
       47 GETTABLEKS                       R11 R12 K13 ["default"]
       49 GETIMPORT                        R13 K4 [require]
       51 GETTABLEKS                       R14 R0 K15 ["getSnapshotSummary"]
       53 CALL                             R13 1 1
       54 GETTABLEKS                       R12 R13 K13 ["default"]
       56 GETIMPORT                        R13 K4 [require]
       58 GETTABLEKS                       R14 R0 K16 ["types"]
       60 CALL                             R13 1 1
       61 GETIMPORT                        R15 K4 [require]
       63 GETTABLEKS                       R16 R0 K17 ["utils"]
       65 CALL                             R15 1 1
       66 GETTABLEKS                       R14 R15 K18 ["getSummary"]
