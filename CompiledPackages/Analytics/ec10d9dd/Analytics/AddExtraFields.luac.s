PROTO_0:
        ...
        2 GETUPVAL                         R1 0
        3 GETTABLEKS                       R1 R1 K0 ["extraFields"]
        5 RETURN                           R1 1
       ...
       10 MOVE                             R0 R1
       11 GETUPVAL                         R1 0
       12 GETTABLEKS                       R1 R1 K0 ["extraFields"]
       14 LOADNIL                          R2
       15 LOADNIL                          R3
       16 FORGPREP                         R1
...
PROTO_1:
        0 GETUPVAL                         R3 0
        1 GETTABLEKS                       R3 R3 K0 ["logCounter"]
        3 MOVE                             R4 R0
        4 GETUPVAL                         R5 1
        5 MOVE                             R6 R1
        6 CALL                             R5 1 1
...
PROTO_5:
       ...
       30 CALL                             R3 2 1
       31 GETUPVAL                         R4 0
       32 GETTABLEKS                       R4 R4 K1 ["useCallback"]
       34 NEWCLOSURE                       R5 P2
       35 CAPTURE                          VAL R1
       36 CAPTURE                          VAL R2
       37 NEWTABLE                         R6 0 2
       ...
       44 CALL                             R4 2 1
       45 GETUPVAL                         R5 0
       46 GETTABLEKS                       R5 R5 K1 ["useCallback"]
       48 NEWCLOSURE                       R6 P3
       49 CAPTURE                          VAL R1
       50 CAPTURE                          VAL R2
       51 NEWTABLE                         R7 0 2
       ...
       58 CALL                             R5 2 1
       59 GETUPVAL                         R6 0
       60 GETTABLEKS                       R6 R6 K6 ["useMemo"]
       62 NEWCLOSURE                       R7 P4
       63 CAPTURE                          VAL R3
       64 CAPTURE                          VAL R4
       65 CAPTURE                          VAL R5
       ...
       74 GETUPVAL                         R7 2
       75 GETUPVAL                         R8 1
       76 GETTABLEKS                       R8 R8 K7 ["Provider"]
