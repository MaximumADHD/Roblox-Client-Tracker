...
MAIN:
       ...
       14 GETTABLEKS                       R5 R2 K7 ["util"]
       16 GETTABLEKS                       R4 R5 K8 ["inspect"]
       18 GETIMPORT                        R5 K4 [require]
       20 GETIMPORT                        R8 K1 [script]
       22 GETTABLEKS                       R7 R8 K2 ["Parent"]
       24 GETTABLEKS                       R6 R7 K9 ["getComponentName"]
       26 CALL                             R5 1 1
       27 GETIMPORT                        R6 K1 [script]
       29 LOADK                            R8 K10 ["ReactUtils"]
       30 NAMECALL                         R6 R6 K11 ["FindFirstAncestor"]
       32 CALL                             R6 2 1
       33 GETIMPORT                        R8 K13 [_G]
       35 GETTABLEKS                       R7 R8 K14 ["__DEV__"]
       37 GETIMPORT                        R8 K4 [require]
       39 GETTABLEKS                       R9 R1 K15 ["SafeFlags"]
       41 CALL                             R8 1 1
       42 GETTABLEKS                       R9 R8 K16 ["createGetFFlag"]
       44 LOADK                            R10 K17 ["ReactInstanceMapDisableErrorChecking"]
       45 CALL                             R9 1 1
       46 MOVE                             R10 R9
       47 CALL                             R10 0 1
       48 NEWTABLE                         R11 4 0
       50 DUPCLOSURE                       R12 K18 [PROTO_0]
       51 DUPCLOSURE                       R13 K19 [PROTO_1]
       52 SETTABLEKS                       R13 R11 K20 ["remove"]
       54 JUMPIFNOT                        R10 ; [+1]
       55 JUMPIFNOT                        R7 ; [+7]
       56 DUPCLOSURE                       R13 K21 [PROTO_2]
       57 CAPTURE                          VAL R3
       58 CAPTURE                          VAL R5
       59 CAPTURE                          VAL R4
       60 SETTABLEKS                       R13 R11 K22 ["get"]
       62 JUMP                             ; [+3]
       63 DUPCLOSURE                       R13 K23 [PROTO_3]
       64 SETTABLEKS                       R13 R11 K22 ["get"]
       66 DUPCLOSURE                       R13 K24 [PROTO_4]
       67 SETTABLEKS                       R13 R11 K25 ["has"]
       69 JUMPIFNOT                        R10 ; [+1]
       70 JUMPIFNOT                        R7 ; [+7]
       71 DUPCLOSURE                       R13 K26 [PROTO_5]
       72 CAPTURE                          VAL R5
       73 CAPTURE                          VAL R4
       74 CAPTURE                          VAL R3
       75 SETTABLEKS                       R13 R11 K27 ["set"]
       77 RETURN                           R11 1
       78 DUPCLOSURE                       R13 K28 [PROTO_6]
       79 SETTABLEKS                       R13 R11 K27 ["set"]
       81 RETURN                           R11 1
