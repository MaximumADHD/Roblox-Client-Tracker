...
MAIN:
       ...
       25 GETTABLEKS                       R5 R5 K9 ["ReactCurrentDispatcher"]
       27 CALL                             R4 1 1
       28 GETIMPORT                        R5 K4 [require]
       30 GETIMPORT                        R6 K1 [script]
       32 GETTABLEKS                       R6 R6 K10 ["ReactCurrentBatchConfig"]
       34 CALL                             R5 1 1
       35 GETIMPORT                        R6 K4 [require]
       37 GETIMPORT                        R7 K1 [script]
       39 GETTABLEKS                       R7 R7 K11 ["ReactCurrentOwner"]
       41 CALL                             R6 1 1
       42 GETIMPORT                        R7 K4 [require]
       44 GETIMPORT                        R8 K1 [script]
       46 GETTABLEKS                       R8 R8 K12 ["ReactDebugCurrentFrame"]
       48 CALL                             R7 1 1
       49 GETIMPORT                        R8 K4 [require]
       51 GETIMPORT                        R9 K1 [script]
       53 GETTABLEKS                       R9 R9 K13 ["IsSomeRendererActing"]
       55 CALL                             R8 1 1
