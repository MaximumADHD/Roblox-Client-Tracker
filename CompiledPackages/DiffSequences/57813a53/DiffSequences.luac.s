...
PROTO_10:
       ...
       20 CALL                             R2 -1 0
       21 GETUPVAL                         R2 0
       22 GETTABLEKS                       R2 R2 K12 ["isSafeInteger"]
       24 MOVE                             R3 R1
       25 CALL                             R2 1 1
       26 JUMPIF                           R2 ; [+14]
       27 GETIMPORT                        R2 K4 [error]
       29 GETIMPORT                        R3 K7 [string.format]
       31 LOADK                            R4 K13 ["%s: %s type %s is not a safe integer"]
       32 LOADK                            R5 K9 ["diff-sequences"]
       33 MOVE                             R6 R0
       ...
       40 CALL                             R2 -1 0
       41 LOADN                            R2 0
       42 JUMPIFNOTLT                      R1 R2 ; [+15]
       44 GETIMPORT                        R2 K4 [error]
       46 GETIMPORT                        R3 K7 [string.format]
       48 LOADK                            R4 K14 ["%s: %s type %s is a negative integer"]
       49 LOADK                            R5 K9 ["diff-sequences"]
       50 MOVE                             R6 R0
       51 FASTCALL1                        TYPE R1 ; [+3]
       52 MOVE                             R8 R1
       53 GETIMPORT                        R7 K11 [type]
       55 CALL                             R7 1 1
       56 CALL                             R3 4 -1
       57 CALL                             R2 -1 0
       58 RETURN                           R0 0
...
PROTO_12:
       ...
       76 SUB                              R7 R1 R5
       77 ADD                              R8 R4 R5
       78 JUMPIFEQ                         R0 R8 ; [+72]
       80 JUMPIFEQ                         R1 R8 ; [+70]
       82 NEWTABLE                         R9 0 1
       84 NEWTABLE                         R10 0 2
       86 MOVE                             R11 R3
       87 MOVE                             R12 R2
      ...
      102 DUPTABLE                         R12 K30 [{"aCommonFollowing", "aCommonPreceding", "aEndPreceding", "aStartFollowing", "bCommonFollowing", "bCommonPreceding", "bEndPreceding", "bStartFollowing", "nChangeFollowing", "nChangePreceding", "nCommonFollowing", "nCommonPreceding"}]
      103 LOADN                            R13 0
      104 SETTABLEKS                       R13 R12 K18 ["aCommonFollowing"]
      106 LOADN                            R13 0
      107 SETTABLEKS                       R13 R12 K19 ["aCommonPreceding"]
      109 LOADN                            R13 0
      110 SETTABLEKS                       R13 R12 K20 ["aEndPreceding"]
      112 LOADN                            R13 0
      113 SETTABLEKS                       R13 R12 K21 ["aStartFollowing"]
      115 LOADN                            R13 0
      116 SETTABLEKS                       R13 R12 K22 ["bCommonFollowing"]
      118 LOADN                            R13 0
      119 SETTABLEKS                       R13 R12 K23 ["bCommonPreceding"]
      121 LOADN                            R13 0
      122 SETTABLEKS                       R13 R12 K24 ["bEndPreceding"]
      124 LOADN                            R13 0
      125 SETTABLEKS                       R13 R12 K25 ["bStartFollowing"]
      127 LOADN                            R13 0
      128 SETTABLEKS                       R13 R12 K26 ["nChangeFollowing"]
      130 LOADN                            R13 0
      131 SETTABLEKS                       R13 R12 K27 ["nChangePreceding"]
      133 LOADN                            R13 0
      134 SETTABLEKS                       R13 R12 K28 ["nCommonFollowing"]
      136 LOADN                            R13 0
      137 SETTABLEKS                       R13 R12 K29 ["nCommonPreceding"]
      139 GETUPVAL                         R13 3
      140 LOADN                            R14 0
      141 MOVE                             R15 R4
      142 MOVE                             R16 R6
...
MAIN:
        ...
        9 CALL                             R2 1 1
       10 GETTABLEKS                       R3 R2 K6 ["Number"]
       12 DUPCLOSURE                       R4 K7 [PROTO_0]
       13 DUPCLOSURE                       R5 K8 [PROTO_1]
       14 DUPCLOSURE                       R6 K9 [PROTO_2]
       15 CAPTURE                          VAL R4
       16 DUPCLOSURE                       R7 K10 [PROTO_3]
       17 CAPTURE                          VAL R5
       18 DUPCLOSURE                       R8 K11 [PROTO_4]
       19 CAPTURE                          VAL R4
       20 CAPTURE                          VAL R5
       21 DUPCLOSURE                       R9 K12 [PROTO_5]
       22 CAPTURE                          VAL R5
       23 CAPTURE                          VAL R4
       24 DUPCLOSURE                       R10 K13 [PROTO_6]
       25 CAPTURE                          VAL R6
       26 CAPTURE                          VAL R7
       27 CAPTURE                          VAL R9
       28 CAPTURE                          VAL R8
       29 DUPCLOSURE                       R11 K14 [PROTO_9]
       30 CAPTURE                          VAL R10
       31 CAPTURE                          VAL R11
       32 DUPCLOSURE                       R12 K15 [PROTO_10]
       33 CAPTURE                          VAL R3
       34 DUPCLOSURE                       R13 K16 [PROTO_11]
       35 DUPCLOSURE                       R14 K17 [PROTO_12]
       36 CAPTURE                          VAL R12
       37 CAPTURE                          VAL R4
       38 CAPTURE                          VAL R5
       39 CAPTURE                          VAL R11
