PROTO_0:
  ...
  MOVE R1 R2
  RETURN R1 1
  GETTABLEKS R1 R0 K5 ["gameId"]
  JUMPIFNOT R1 [+20]
  GETTABLEKS R2 R0 K5 ["gameId"]
  FASTCALL1 TYPEOF R2 [+2]
  GETIMPORT R1 K1 [typeof]
  CALL R1 1 1
  JUMPIFEQKS R1 K6 ["string"] [+13]
  LOADK R2 K7 ["\"gameId\" > Expected string, got %*"]
  GETTABLEKS R5 R0 K5 ["gameId"]
  ...
  MOVE R1 R2
  RETURN R1 1
  GETTABLEKS R1 R0 K8 ["cId"]
  JUMPIFNOT R1 [+20]
  GETTABLEKS R2 R0 K8 ["cId"]
  FASTCALL1 TYPEOF R2 [+2]
  GETIMPORT R1 K1 [typeof]
  CALL R1 1 1
  JUMPIFEQKS R1 K6 ["string"] [+13]
  LOADK R2 K9 ["\"cId\" > Expected string, got %*"]
  GETTABLEKS R5 R0 K8 ["cId"]
  FASTCALL1 TYPEOF R5 [+2]
  GETIMPORT R4 K1 [typeof]
  CALL R4 1 1
  NAMECALL R2 R2 K4 ["format"]
