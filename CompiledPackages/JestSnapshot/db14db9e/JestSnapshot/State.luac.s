PROTO_0:
       ...
       11 DUPTABLE                         R5 K20 [{["_snapshotPath"], ["_initialData"], ["_snapshotData"], ["_dirty"], ["_inlineSnapshots"], ["_uncheckedKeys"], ["_counters"], ["_index"] = 0, ["expand"], ["added"] = 0, ["matched"] = 0, ["unmatched"] = 0, ["_updateSnapshot"], ["updated"] = 0, ["_snapshotFormat"]}]
       ...
       24 GETUPVAL                         R6 1
       25 GETTABLEKS                       R6 R6 K21 ["new"]
       27 GETUPVAL                         R7 2
       28 GETTABLEKS                       R7 R7 K22 ["keys"]
       30 MOVE                             R8 R3
       31 CALL                             R7 1 -1
       32 CALL                             R6 -1 1
       ...
       39 GETTABLEKS                       R7 R1 K13 ["expand"]
       41 ORK                              R6 R7 K23 [False]
       42 SETTABLEKS                       R6 R5 K13 ["expand"]
       44 GETTABLEKS                       R6 R1 K1 ["updateSnapshot"]
       46 SETTABLEKS                       R6 R5 K17 ["_updateSnapshot"]
       48 GETTABLEKS                       R6 R1 K24 ["snapshotFormat"]
       50 SETTABLEKS                       R6 R5 K19 ["_snapshotFormat"]
       52 GETUPVAL                         R8 3
       53 FASTCALL2                        SETMETATABLE R5 R8 ; [+4]
       55 MOVE                             R7 R5
       56 GETIMPORT                        R6 K26 [setmetatable]
       58 CALL                             R6 2 1
       59 RETURN                           R6 1
...
PROTO_4:
       ...
       21 JUMPIFNOT                        R3 ; [+1]
       22 NOT                              R3 R2
       23 DUPTABLE                         R4 K6 [{["deleted"] = False, ["saved"] = False}]
       24 GETTABLEKS                       R5 R0 K7 ["_dirty"]
       26 JUMPIF                           R5 ; [+7]
       27 GETTABLEKS                       R5 R0 K8 ["_uncheckedKeys"]
       29 GETTABLEKS                       R5 R5 K9 ["size"]
       31 LOADN                            R6 0
       32 JUMPIFNOTLT                      R6 R5 ; [+30]
       34 JUMPIF                           R3 ; [+28]
       35 JUMPIFNOT                        R1 ; [+16]
       36 GETTABLEKS                       R5 R0 K7 ["_dirty"]
       38 JUMPIF                           R5 ; [+4]
       39 GETTABLEKS                       R5 R0 K10 ["_updateSnapshot"]
       41 JUMPIFNOTEQKS                    R5 K11 ["all"] ; [+10]
       43 GETUPVAL                         R5 1
       44 GETTABLEKS                       R6 R0 K1 ["_snapshotData"]
       46 GETTABLEKS                       R7 R0 K12 ["_snapshotPath"]
       48 GETTABLEKS                       R7 R7 K13 ["getPath"]
       50 CALL                             R7 0 -1
       51 CALL                             R5 -1 0
       52 JUMPIFNOT                        R2 ; [+6]
       53 GETIMPORT                        R5 K15 [error]
       55 GETUPVAL                         R6 2
       56 LOADK                            R7 K16 ["Jest-Roblox: inline snapshot testing is not currently supported"]
       57 CALL                             R6 1 -1
       58 CALL                             R5 -1 0
       59 LOADB                            R5 1
       60 SETTABLEKS                       R5 R4 K5 ["saved"]
       62 RETURN                           R4 1
       63 JUMPIF                           R1 ; [+21]
       64 GETTABLEKS                       R5 R0 K12 ["_snapshotPath"]
       66 GETTABLEKS                       R5 R5 K17 ["getInstance"]
       68 CALL                             R5 0 1
       69 JUMPIFEQKNIL                     R5 ; [+15]
       71 GETTABLEKS                       R5 R0 K10 ["_updateSnapshot"]
       73 JUMPIFNOTEQKS                    R5 K11 ["all"] ; [+8]
       75 GETUPVAL                         R5 3
       76 GETTABLEKS                       R6 R0 K12 ["_snapshotPath"]
       78 GETTABLEKS                       R6 R6 K13 ["getPath"]
       80 CALL                             R6 0 -1
       81 CALL                             R5 -1 0
       82 LOADB                            R5 1
       83 SETTABLEKS                       R5 R4 K3 ["deleted"]
       85 RETURN                           R4 1
...
PROTO_8:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["_snapshotPath"]
        3 GETTABLEKS                       R0 R0 K1 ["getInstance"]
        5 CALL                             R0 0 1
