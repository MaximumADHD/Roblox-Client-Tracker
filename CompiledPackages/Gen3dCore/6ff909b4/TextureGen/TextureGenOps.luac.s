...
PROTO_8:
      ...
      229 LOADK                            R19 K43 ["requestId=%* textureGenerationId=%*"]
      230 MOVE                             R21 R4
      231 MOVE                             R22 R18
      232 NAMECALL                         R19 R19 K44 ["format"]
      234 CALL                             R19 3 1
      235 GETTABLEKS                       R20 R9 K45 ["capabilities"]
      237 JUMPIFEQKNIL                     R20 ; [+14]
      239 GETTABLEKS                       R20 R9 K45 ["capabilities"]
      241 GETTABLEKS                       R20 R20 K46 ["debugLog"]
      243 JUMPIFNOT                        R20 ; [+8]
      244 GETIMPORT                        R20 K48 [print]
      246 LOADK                            R21 K49 ["[TextureGenOps] %*"]
      247 MOVE                             R23 R19
      248 NAMECALL                         R21 R21 K44 ["format"]
      250 CALL                             R21 2 1
      251 CALL                             R20 1 0
      252 GETUPVAL                         R19 1
      253 GETTABLEKS                       R19 R19 K50 ["pollForCompletedStatus"]
      255 GETTABLEKS                       R20 R9 K51 ["getStatusAsync"]
      257 MOVE                             R21 R18
      258 DUPCLOSURE                       R22 K52 [PROTO_6]
      259 NEWCLOSURE                       R23 P2
      260 CAPTURE                          UPVAL U0
      261 CAPTURE                          VAL R1
      262 LOADK                            R24 K53 ["FailedToGenerate"]
      263 LOADK                            R25 K54 ["TextureGen"]
      264 CALL                             R19 6 1
      265 SETTABLEKS                       R19 R10 K55 ["modelRbxmUrl"]
      267 GETUPVAL                         R20 6
      268 CALL                             R20 0 1
      269 JUMPIFNOT                        R20 ; [+9]
      270 GETTABLEKS                       R20 R2 K56 ["startPreloadInsertAsync"]
      272 MOVE                             R21 R10
      273 GETTABLEKS                       R22 R9 K57 ["publishAssetAsync"]
      275 GETTABLEKS                       R23 R9 K58 ["loadAssetAsync"]
      277 MOVE                             R24 R18
      278 CALL                             R20 4 0
      279 GETTABLEKS                       R20 R1 K30 ["meshGen"]
      281 GETTABLEKS                       R20 R20 K59 ["loadModelFromUrlAsync"]
      283 MOVE                             R21 R19
      284 CALL                             R20 1 1
      285 GETTABLEKS                       R22 R11 K60 ["Name"]
      287 LOADK                            R23 K61 [" (Textured)"]
      288 CONCAT                           R21 R22 R23
      289 SETTABLEKS                       R21 R20 K60 ["Name"]
      291 SETTABLEKS                       R20 R10 K62 ["previewAssets"]
      293 MOVE                             R21 R3
      294 JUMPIFNOT                        R21 ; [+2]
      295 GETTABLEKS                       R21 R3 K63 ["setPreviewImage"]
      297 JUMPIFNOT                        R21 ; [+8]
      298 GETTABLEKS                       R22 R1 K64 ["preview"]
      300 GETTABLEKS                       R22 R22 K65 ["capturePreviewImages"]
      302 MOVE                             R23 R20
      303 MOVE                             R24 R21
      304 GETUPVAL                         R25 7
      305 CALL                             R22 3 0
      306 LOADNIL                          R22
      307 SETTABLEKS                       R22 R10 K15 ["generationThread"]
      309 DUPTABLE                         R22 K66 [{"generationId", "modelRbxmUrl"}]
      310 SETTABLEKS                       R18 R22 K42 ["generationId"]
      312 SETTABLEKS                       R19 R22 K55 ["modelRbxmUrl"]
      314 RETURN                           R22 1
...
PROTO_14:
       ...
       89 LOADB                            R4 0 +1
       90 LOADB                            R4 1
       91 LOADK                            R5 K14 ["Expected exactly one part when loading textured model asset, got %*"]
       92 LENGTH                           R7 R2
       93 NAMECALL                         R5 R5 K15 ["format"]
       95 CALL                             R5 2 1
       96 FASTCALL2                        ASSERT R4 R5 ; [+3]
       98 GETIMPORT                        R3 K6 [assert]
      100 CALL                             R3 2 0
      101 GETUPVAL                         R3 1
      102 GETTABLEKS                       R3 R3 K16 ["resolveSingleMeshPart"]
      104 GETTABLEN                        R4 R2 1
      105 CALL                             R3 1 1
      106 FASTCALL2K                       ASSERT R3 K17 ; [+5]
      108 MOVE                             R5 R3
      109 LOADK                            R6 K17 ["Textured model asset root is not a MeshPart"]
      110 GETIMPORT                        R4 K6 [assert]
      112 CALL                             R4 2 0
      113 GETUPVAL                         R4 0
      114 GETTABLEKS                       R4 R4 K18 ["sourceExportScale"]
      116 JUMPIFNOT                        R4 ; [+7]
      117 JUMPIFEQKN                       R4 K13 [1] ; [+6]
      119 GETTABLEKS                       R5 R3 K19 ["Size"]
      121 DIV                              R5 R5 R4
      122 SETTABLEKS                       R5 R3 K19 ["Size"]
      124 RETURN                           R3 1
...
PROTO_17:
       ...
       49 DUPCLOSURE                       R11 K23 [PROTO_13]
       50 CAPTURE                          UPVAL U7
...
MAIN:
       ...
       92 CAPTURE                          VAL R10
       93 DUPCLOSURE                       R16 K23 [PROTO_1]
       94 NEWTABLE                         R17 8 0
       96 GETTABLEKS                       R18 R7 K24 ["VIEW_ANGLES"]
       98 GETTABLEKS                       R19 R4 K25 ["makeTranslator"]
      100 LOADK                            R20 K26 ["TextureGen"]
      101 MOVE                             R21 R9
      102 CALL                             R19 2 1
      103 DUPCLOSURE                       R20 K27 [PROTO_2]
      104 CAPTURE                          VAL R19
      105 DUPCLOSURE                       R21 K28 [PROTO_3]
      106 DUPCLOSURE                       R22 K29 [PROTO_4]
      107 DUPCLOSURE                       R23 K30 [PROTO_8]
      108 CAPTURE                          VAL R19
      109 CAPTURE                          VAL R4
      110 CAPTURE                          VAL R13
      111 CAPTURE                          VAL R14
      ...
      114 CAPTURE                          VAL R12
      115 CAPTURE                          VAL R18
      116 SETTABLEKS                       R23 R17 K31 ["generateTextureAsync"]
      118 DUPCLOSURE                       R23 K32 [PROTO_9]
      119 SETTABLEKS                       R23 R17 K33 ["cancelGenerationAsync"]
      121 DUPCLOSURE                       R23 K34 [PROTO_17]
      122 CAPTURE                          VAL R10
      123 CAPTURE                          VAL R6
      124 CAPTURE                          VAL R4
      125 CAPTURE                          VAL R20
      ...
      129 CAPTURE                          VAL R11
      130 CAPTURE                          VAL R22
      131 SETTABLEKS                       R23 R17 K35 ["insertTexturedModelAsync"]
      133 DUPCLOSURE                       R23 K36 [PROTO_19]
      134 CAPTURE                          VAL R4
      135 CAPTURE                          VAL R14
      136 CAPTURE                          VAL R6
      137 CAPTURE                          VAL R10
      138 CAPTURE                          VAL R2
      139 SETTABLEKS                       R23 R17 K37 ["revertInsertAsync"]
      141 DUPCLOSURE                       R23 K38 [PROTO_20]
      142 CAPTURE                          VAL R14
      143 SETTABLEKS                       R23 R17 K39 ["releaseRevertSnapshot"]
      145 DUPCLOSURE                       R23 K40 [PROTO_23]
      146 CAPTURE                          VAL R8
      147 CAPTURE                          VAL R1
      148 SETTABLEKS                       R23 R17 K41 ["captureSourceInstanceImageAsync"]
      150 RETURN                           R17 1
