...
PROTO_7:
      ...
      123 MOVE                             R9 R0
      124 MOVE                             R10 R7
      125 GETTABLEKS                       R12 R1 K35 ["pollIntervalSeconds"]
      127 ORK                              R11 R12 K34 [2]
      128 GETTABLEKS                       R13 R1 K37 ["timeoutSeconds"]
      130 ORK                              R12 R13 K36 [60]
      131 MOVE                             R13 R4
      132 CALL                             R8 5 1
      133 MOVE                             R9 R4
      134 CALL                             R9 0 1
      135 JUMPIFNOT                        R9 ; [+6]
      136 LOADK                            R9 K16 ["Cancelled"]
      137 SETTABLEKS                       R9 R2 K1 ["status"]
      139 MOVE                             R9 R3
      140 CALL                             R9 0 0
      141 RETURN                           R0 0
      142 GETTABLEKS                       R9 R8 K17 ["ok"]
      144 JUMPIFNOT                        R9 ; [+4]
      145 GETTABLEKS                       R9 R8 K38 ["presignedUrl"]
      147 JUMPIFNOTEQKNIL                  R9 ; [+12]
      149 LOADK                            R9 K26 ["Failed"]
      150 SETTABLEKS                       R9 R2 K1 ["status"]
      152 GETTABLEKS                       R10 R8 K20 ["errorMessage"]
      154 ORK                              R9 R10 K39 ["Image generation did not complete"]
      155 SETTABLEKS                       R9 R2 K20 ["errorMessage"]
      157 MOVE                             R9 R3
      158 CALL                             R9 0 0
      159 RETURN                           R0 0
      160 GETTABLEKS                       R9 R8 K38 ["presignedUrl"]
      162 SETTABLEKS                       R9 R2 K38 ["presignedUrl"]
      164 GETTABLEKS                       R9 R8 K40 ["widthPx"]
      166 SETTABLEKS                       R9 R2 K40 ["widthPx"]
      168 GETTABLEKS                       R9 R8 K41 ["heightPx"]
      170 SETTABLEKS                       R9 R2 K41 ["heightPx"]
      172 GETUPVAL                         R9 2
      173 MOVE                             R10 R0
      174 GETTABLEKS                       R11 R8 K38 ["presignedUrl"]
      176 CALL                             R9 2 2
      177 MOVE                             R11 R4
      178 CALL                             R11 0 1
      179 JUMPIFNOT                        R11 ; [+6]
      180 LOADK                            R11 K16 ["Cancelled"]
      181 SETTABLEKS                       R11 R2 K1 ["status"]
      183 MOVE                             R11 R3
      184 CALL                             R11 0 0
      185 RETURN                           R0 0
      186 JUMPIFNOTEQKNIL                  R9 ; [+10]
      188 LOADK                            R11 K26 ["Failed"]
      189 SETTABLEKS                       R11 R2 K1 ["status"]
      191 ORK                              R11 R10 K42 ["Failed to download the generated image"]
      192 SETTABLEKS                       R11 R2 K20 ["errorMessage"]
      194 MOVE                             R11 R3
      195 CALL                             R11 0 0
      196 RETURN                           R0 0
      197 GETIMPORT                        R11 K44 [pcall]
      ...
      205 MOVE                             R14 R12
      206 GETIMPORT                        R13 K46 [typeof]
      208 CALL                             R13 1 1
      209 JUMPIFNOTEQKS                    R13 K47 ["string"] ; [+3]
      211 JUMPIFNOTEQKS                    R12 K48 [""] ; [+32]
      213 GETIMPORT                        R13 K22 [warn]
      215 LOADK                            R14 K49 ["[ImageSelectionOps] slot %*: base64 encode failed: %*"]
      216 GETTABLEKS                       R16 R2 K24 ["index"]
      218 FASTCALL1                        TOSTRING R12 ; [+3]
      219 MOVE                             R18 R12
      220 GETIMPORT                        R17 K29 [tostring]
      222 CALL                             R17 1 1
      223 NAMECALL                         R14 R14 K25 ["format"]
      225 CALL                             R14 3 1
      226 CALL                             R13 1 0
      227 LOADK                            R13 K26 ["Failed"]
      228 SETTABLEKS                       R13 R2 K1 ["status"]
      230 LOADK                            R13 K50 ["Failed to encode the generated image: %*"]
      231 FASTCALL1                        TOSTRING R12 ; [+3]
      232 MOVE                             R16 R12
      233 GETIMPORT                        R15 K29 [tostring]
      235 CALL                             R15 1 1
      236 NAMECALL                         R13 R13 K25 ["format"]
      238 CALL                             R13 2 1
      239 SETTABLEKS                       R13 R2 K20 ["errorMessage"]
      241 MOVE                             R13 R3
      242 CALL                             R13 0 0
      243 RETURN                           R0 0
      244 GETIMPORT                        R13 K44 [pcall]
      246 NEWCLOSURE                       R14 P1
      247 CAPTURE                          VAL R0
      248 CAPTURE                          VAL R12
      249 CALL                             R13 1 2
      250 JUMPIFNOT                        R13 ; [+10]
      251 FASTCALL1                        TYPEOF R14 ; [+3]
      252 MOVE                             R17 R14
      253 GETIMPORT                        R16 K46 [typeof]
      255 CALL                             R16 1 1
      256 JUMPIFNOTEQKS                    R16 K51 ["table"] ; [+4]
      258 GETTABLEKS                       R15 R14 K52 ["tempId"]
      260 JUMP                             ; [+1]
      261 LOADNIL                          R15
      262 FASTCALL1                        TYPEOF R15 ; [+3]
      263 MOVE                             R17 R15
      264 GETIMPORT                        R16 K46 [typeof]
      266 CALL                             R16 1 1
      267 JUMPIFNOTEQKS                    R16 K47 ["string"] ; [+3]
      269 JUMPIFNOTEQKS                    R15 K48 [""] ; [+32]
      271 GETIMPORT                        R16 K22 [warn]
      273 LOADK                            R17 K53 ["[ImageSelectionOps] slot %*: tempId conversion failed: %*"]
      274 GETTABLEKS                       R19 R2 K24 ["index"]
      276 FASTCALL1                        TOSTRING R14 ; [+3]
      277 MOVE                             R21 R14
      278 GETIMPORT                        R20 K29 [tostring]
      280 CALL                             R20 1 1
      281 NAMECALL                         R17 R17 K25 ["format"]
      283 CALL                             R17 3 1
      284 CALL                             R16 1 0
      285 LOADK                            R16 K26 ["Failed"]
      286 SETTABLEKS                       R16 R2 K1 ["status"]
      288 LOADK                            R16 K54 ["Failed to prepare the generated image for display: %*"]
      289 FASTCALL1                        TOSTRING R14 ; [+3]
      290 MOVE                             R19 R14
      291 GETIMPORT                        R18 K29 [tostring]
      293 CALL                             R18 1 1
      294 NAMECALL                         R16 R16 K25 ["format"]
      296 CALL                             R16 2 1
      297 SETTABLEKS                       R16 R2 K20 ["errorMessage"]
      299 MOVE                             R16 R3
      300 CALL                             R16 0 0
      301 RETURN                           R0 0
      302 MOVE                             R16 R4
      303 CALL                             R16 0 1
      304 JUMPIFNOT                        R16 ; [+6]
      305 LOADK                            R16 K16 ["Cancelled"]
      306 SETTABLEKS                       R16 R2 K1 ["status"]
      308 MOVE                             R16 R3
      309 CALL                             R16 0 0
      310 RETURN                           R0 0
      311 SETTABLEKS                       R12 R2 K55 ["thumbnailBase64"]
      313 SETTABLEKS                       R15 R2 K56 ["thumbnailTempId"]
      315 LOADK                            R16 K57 ["Ready"]
