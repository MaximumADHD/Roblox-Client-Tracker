...
PROTO_3:
        ...
        3 CALL                             R2 2 1
        4 OR                               R1 R2 R0
        5 LOADK                            R2 K2 ["RBXAI-GeneratedLayout-%*"]
        6 MOVE                             R4 R1
...
PROTO_7:
       ...
       21 LENGTH                           R3 R4
       22 LOADN                            R4 0
       23 JUMPIFLT                         R4 R3 ; [+57]
       25 GETIMPORT                        R3 K12 [warn]
       27 LOADK                            R4 K13 ["[GenerateLayout] downloadScript failed: success=%* statusCode=%* statusMessage=%*"]
       28 GETTABLEKS                       R7 R2 K6 ["Success"]
       30 FASTCALL1                        TOSTRING R7 ; [+2]
       31 GETIMPORT                        R6 K15 [tostring]
       33 CALL                             R6 1 1
       34 GETTABLEKS                       R8 R2 K16 ["StatusCode"]
       36 FASTCALL1                        TOSTRING R8 ; [+2]
       37 GETIMPORT                        R7 K15 [tostring]
       39 CALL                             R7 1 1
       40 GETTABLEKS                       R9 R2 K17 ["StatusMessage"]
       42 FASTCALL1                        TOSTRING R9 ; [+2]
       43 GETIMPORT                        R8 K15 [tostring]
       45 CALL                             R8 1 1
       46 NAMECALL                         R4 R4 K18 ["format"]
       48 CALL                             R4 4 1
       49 CALL                             R3 1 0
       50 GETIMPORT                        R3 K20 [error]
       52 GETTABLEKS                       R5 R0 K21 ["translator"]
       54 JUMPIFNOT                        R5 ; [+20]
       55 GETIMPORT                        R6 K23 [pcall]
       57 GETTABLEKS                       R7 R5 K24 ["getText"]
       59 MOVE                             R8 R5
       60 LOADK                            R9 K25 ["GenerateLayout"]
       61 LOADK                            R10 K26 ["LayoutMissingScriptUrl"]
       62 CALL                             R6 4 2
       63 JUMPIFNOT                        R6 ; [+11]
       64 FASTCALL1                        TYPEOF R7 ; [+3]
       65 MOVE                             R9 R7
       66 GETIMPORT                        R8 K9 [typeof]
       68 CALL                             R8 1 1
       69 JUMPIFNOTEQKS                    R8 K10 ["string"] ; [+5]
       71 JUMPIFEQKS                       R7 K27 [""] ; [+3]
       73 MOVE                             R4 R7
       74 JUMP                             ; [+4]
       75 GETUPVAL                         R7 0
       76 GETTABLEKS                       R6 R7 K26 ["LayoutMissingScriptUrl"]
       78 ORK                              R4 R6 K26 ["LayoutMissingScriptUrl"]
       79 LOADN                            R5 0
       80 CALL                             R3 2 0
       81 GETTABLEKS                       R3 R2 K7 ["Body"]
       83 RETURN                           R3 1
...
PROTO_11:
       ...
       21 LENGTH                           R4 R5
       22 LOADN                            R5 0
       23 JUMPIFLT                         R5 R4 ; [+57]
       25 GETIMPORT                        R4 K12 [warn]
       27 LOADK                            R5 K13 ["[GenerateLayout] downloadImageContent failed: success=%* statusCode=%* statusMessage=%*"]
       28 GETTABLEKS                       R8 R3 K6 ["Success"]
       30 FASTCALL1                        TOSTRING R8 ; [+2]
       31 GETIMPORT                        R7 K15 [tostring]
       33 CALL                             R7 1 1
       34 GETTABLEKS                       R9 R3 K16 ["StatusCode"]
       36 FASTCALL1                        TOSTRING R9 ; [+2]
       37 GETIMPORT                        R8 K15 [tostring]
       39 CALL                             R8 1 1
       40 GETTABLEKS                       R10 R3 K17 ["StatusMessage"]
       ...
       48 CALL                             R5 4 1
       49 CALL                             R4 1 0
       50 GETIMPORT                        R4 K20 [error]
       52 GETTABLEKS                       R6 R0 K21 ["translator"]
       54 JUMPIFNOT                        R6 ; [+20]
       55 GETIMPORT                        R7 K23 [pcall]
       57 GETTABLEKS                       R8 R6 K24 ["getText"]
       59 MOVE                             R9 R6
       60 LOADK                            R10 K25 ["GenerateLayout"]
       61 LOADK                            R11 K26 ["FailedToGenerateLayout"]
       62 CALL                             R7 4 2
       63 JUMPIFNOT                        R7 ; [+11]
       64 FASTCALL1                        TYPEOF R8 ; [+3]
       65 MOVE                             R10 R8
       66 GETIMPORT                        R9 K9 [typeof]
       68 CALL                             R9 1 1
       69 JUMPIFNOTEQKS                    R9 K10 ["string"] ; [+5]
       71 JUMPIFEQKS                       R8 K27 [""] ; [+3]
       73 MOVE                             R5 R8
       74 JUMP                             ; [+4]
       75 GETUPVAL                         R8 0
       76 GETTABLEKS                       R7 R8 K26 ["FailedToGenerateLayout"]
       78 ORK                              R5 R7 K26 ["FailedToGenerateLayout"]
       79 LOADN                            R6 0
       80 CALL                             R4 2 0
       81 GETUPVAL                         R4 1
       82 GETIMPORT                        R6 K30 [buffer.fromstring]
       84 GETTABLEKS                       R7 R3 K7 ["Body"]
       86 CALL                             R6 1 -1
       87 NAMECALL                         R4 R4 K31 ["Base64Encode"]
       89 CALL                             R4 -1 1
       90 DUPTABLE                         R5 K36 [{["type"] = "image", ["data"], ["mimeType"]}]
       91 GETIMPORT                        R6 K37 [buffer.tostring]
       93 MOVE                             R7 R4
       94 CALL                             R6 1 1
       95 SETTABLEKS                       R6 R5 K34 ["data"]
       97 ORK                              R6 R2 K38 ["image/png"]
       98 SETTABLEKS                       R6 R5 K35 ["mimeType"]
      100 RETURN                           R5 1
...
PROTO_15:
       ...
       82 LOADK                            R12 K32 ["[GenerateLayout] executeAndStoreScriptAsync: script execution failed: %*"]
       83 FASTCALL1                        TOSTRING R10 ; [+3]
       84 MOVE                             R15 R10
       85 GETIMPORT                        R14 K34 [tostring]
       87 CALL                             R14 1 1
       88 NAMECALL                         R12 R12 K19 ["format"]
       90 CALL                             R12 2 1
       91 CALL                             R11 1 0
       92 DUPTABLE                         R11 K38 [{"ok", "tag", "errorMessage"}]
       93 SETTABLEKS                       R9 R11 K35 ["ok"]
       95 SETTABLEKS                       R7 R11 K36 ["tag"]
       97 JUMPIF                           R9 ; [+6]
       98 FASTCALL1                        TOSTRING R10 ; [+3]
       99 MOVE                             R13 R10
      100 GETIMPORT                        R12 K34 [tostring]
      102 CALL                             R12 1 1
      103 JUMP                             ; [+1]
      104 LOADNIL                          R12
      105 SETTABLEKS                       R12 R11 K37 ["errorMessage"]
      107 RETURN                           R11 1
