...
PROTO_4:
        0 DUPTABLE                         R0 K5 [{[1] = False, ["setIsSymmetryEnabled"], ["isFocusFaceEnabled"] = False, ["setIsFocusFaceEnabled"]}]
        1 DUPCLOSURE                       R1 K6 [PROTO_2]
        2 SETTABLEKS                       R1 R0 K2 ["setIsSymmetryEnabled"]
        4 DUPCLOSURE                       R1 K7 [PROTO_3]
        5 SETTABLEKS                       R1 R0 K4 ["setIsFocusFaceEnabled"]
        7 RETURN                           R0 1
...
PROTO_6:
        ...
        1 DUPTABLE                         R1 K8 [{["EyesLookLeft"] = 0, ["EyesLookRight"] = 0, ["EyesLookUp"] = 0, ["EyesLookDown"] = 0}]
        2 SETTABLEKS                       R1 R0 K0 ["dragboxValues"]
        4 DUPCLOSURE                       R1 K9 [PROTO_5]
        5 SETTABLEKS                       R1 R0 K1 ["setDragboxValues"]
        7 RETURN                           R0 1
...
PROTO_9:
        0 DUPTABLE                         R0 K3 [{[1] = True, ["onClose"]}]
        1 DUPCLOSURE                       R1 K4 [PROTO_8]
        2 SETTABLEKS                       R1 R0 K2 ["onClose"]
        4 RETURN                           R0 1
...
PROTO_12:
        0 DUPTABLE                         R0 K5 [{[1], ["setSliderValuesAsync"], ["isSymmetryEnabled"] = False, ["handleSizeChange"]}]
        1 DUPTABLE                         R1 K8 [{["ChinRaiser"] = 0.5}]
        2 SETTABLEKS                       R1 R0 K0 ["sliderValues"]
        4 DUPCLOSURE                       R1 K9 [PROTO_10]
        5 SETTABLEKS                       R1 R0 K1 ["setSliderValuesAsync"]
        7 DUPCLOSURE                       R1 K10 [PROTO_11]
        8 SETTABLEKS                       R1 R0 K4 ["handleSizeChange"]
       10 RETURN                           R0 1
...
PROTO_14:
        0 DUPTABLE                         R0 K8 [{[1] = "test", ["mapping"], ["value"] = 0, ["setSliderValuesAsync"], ["isSymmetryEnabled"] = False}]
        1 DUPTABLE                         R1 K16 [{["currentValue"] = 0, ["defaultValue"] = 0, ["position"], ["rotation"] = -90, ["customWidth"] = 20}]
        2 GETIMPORT                        R2 K19 [UDim2.fromOffset]
        4 LOADN                            R3 165
        5 LOADN                            R4 240
        6 CALL                             R2 2 1
        7 SETTABLEKS                       R2 R1 K11 ["position"]
        9 SETTABLEKS                       R1 R0 K2 ["mapping"]
       11 DUPCLOSURE                       R1 K20 [PROTO_13]
       12 SETTABLEKS                       R1 R0 K5 ["setSliderValuesAsync"]
       14 RETURN                           R0 1

PROTO_15:
        0 DUPTABLE                         R0 K1 [{"LipsTogether"}]
        1 DUPTABLE                         R1 K10 [{["currentValue"] = 0, ["defaultValue"] = 0, ["position"], ["rotation"] = -90, ["customWidth"] = 20}]
        2 GETIMPORT                        R2 K13 [UDim2.fromOffset]
        4 LOADN                            R3 165
        5 LOADN                            R4 240
        6 CALL                             R2 2 1
        7 SETTABLEKS                       R2 R1 K5 ["position"]
        9 SETTABLEKS                       R1 R0 K0 ["LipsTogether"]
       11 RETURN                           R0 1
...
MAIN:
       ...
       13 GETTABLEKS                       R2 R2 K8 ["FaceControlsHandler"]
       15 CALL                             R1 1 1
       16 NEWTABLE                         R2 16 0
