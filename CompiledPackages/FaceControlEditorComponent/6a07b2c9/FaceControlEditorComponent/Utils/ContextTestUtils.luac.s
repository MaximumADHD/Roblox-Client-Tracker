PROTO_0:
        ...
        8 SETUPVAL                         R0 3
        9 GETUPVAL                         R0 1
       10 GETTABLEKS                       R0 R0 K2 ["createElement"]
...
PROTO_25:
        ...
        2 NEWTABLE                         R1 0 0
        4 NEWTABLE                         R2 0 0
        6 DUPTABLE                         R3 K5 [{[1] = "FaceControls", ["IsA"], ["GetPropertyChangedSignal"], ["Destroy"]}]
        7 DUPCLOSURE                       R4 K6 [PROTO_18]
        8 SETTABLEKS                       R4 R3 K2 ["IsA"]
       10 NEWCLOSURE                       R4 P1
       11 CAPTURE                          VAL R2
       12 SETTABLEKS                       R4 R3 K3 ["GetPropertyChangedSignal"]
       14 DUPCLOSURE                       R4 K7 [PROTO_22]
       15 SETTABLEKS                       R4 R3 K4 ["Destroy"]
       17 DUPTABLE                         R6 K10 [{"__index", "__newindex"}]
       18 NEWCLOSURE                       R7 P3
       19 CAPTURE                          VAL R1
       20 SETTABLEKS                       R7 R6 K8 ["__index"]
       22 NEWCLOSURE                       R7 P4
       23 CAPTURE                          VAL R1
       24 CAPTURE                          VAL R2
       25 SETTABLEKS                       R7 R6 K9 ["__newindex"]
       27 FASTCALL2                        SETMETATABLE R3 R6 ; [+4]
       29 MOVE                             R5 R3
       30 GETIMPORT                        R4 K12 [setmetatable]
       32 CALL                             R4 2 0
       33 RETURN                           R3 1
