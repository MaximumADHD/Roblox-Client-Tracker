...
PROTO_1:
       ...
       11 JUMPIFNOT                        R4 ; [+9]
       12 LOADK                            R3 K2 ["%* %*"]
       13 GETTABLEKS                       R5 R0 K1 ["tag"]
       15 GETTABLEKS                       R6 R1 K1 ["tag"]
       17 NAMECALL                         R3 R3 K3 ["format"]
       19 CALL                             R3 3 1
       20 JUMP                             ; [+8]
       21 GETTABLEKS                       R4 R0 K1 ["tag"]
       23 JUMPIFNOT                        R4 ; [+3]
       24 GETTABLEKS                       R3 R0 K1 ["tag"]
       26 JUMP                             ; [+2]
       27 GETTABLEKS                       R3 R1 K1 ["tag"]
       29 SETTABLEKS                       R3 R2 K1 ["tag"]
       31 RETURN                           R2 1
...
PROTO_2:
       ...
       24 JUMPIFNOT                        R11 ; [+9]
       25 LOADK                            R10 K2 ["%* %*"]
       26 GETTABLEKS                       R12 R8 K1 ["tag"]
       28 GETTABLEKS                       R13 R5 K1 ["tag"]
       30 NAMECALL                         R10 R10 K3 ["format"]
       32 CALL                             R10 3 1
       33 JUMP                             ; [+8]
       34 GETTABLEKS                       R11 R8 K1 ["tag"]
       36 JUMPIFNOT                        R11 ; [+3]
       37 GETTABLEKS                       R10 R8 K1 ["tag"]
       39 JUMP                             ; [+2]
       40 GETTABLEKS                       R10 R5 K1 ["tag"]
       42 SETTABLEKS                       R10 R9 K1 ["tag"]
       44 MOVE                             R7 R9
