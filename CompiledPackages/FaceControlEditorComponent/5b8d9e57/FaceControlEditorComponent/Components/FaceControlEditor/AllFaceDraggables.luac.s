...
PROTO_1:
        ...
        2 SETTABLE                         R1 R3 R0
        3 GETUPVAL                         R4 0
        4 GETTABLEKS                       R4 R4 K0 ["getSymmetryPair"]
        6 MOVE                             R5 R0
        7 CALL                             R4 1 1
        8 GETUPVAL                         R5 1
        9 JUMPIFNOT                        R5 ; [+2]
       ...
       12 GETUPVAL                         R5 2
       13 GETTABLEKS                       R5 R5 K1 ["splitDragboxMaps"]
       15 MOVE                             R6 R3
       16 CALL                             R5 1 1
       17 GETUPVAL                         R6 2
       18 GETTABLEKS                       R6 R6 K2 ["splitBidirectionalSliders"]
       20 MOVE                             R7 R5
       21 CALL                             R6 1 1
...
PROTO_2:
        0 NEWTABLE                         R3 0 0
        2 GETUPVAL                         R4 0
        3 GETTABLEKS                       R4 R4 K0 ["mergeDragboxMaps"]
        5 MOVE                             R5 R1
        6 CALL                             R4 1 1
        7 GETUPVAL                         R5 0
        8 GETTABLEKS                       R5 R5 K1 ["mergeDirectionalSliders"]
       10 MOVE                             R6 R4
       11 CALL                             R5 1 1
       12 MOVE                             R6 R0
       13 LOADNIL                          R7
       ...
       23 JUMPIF                           R13 ; [+3]
       24 GETUPVAL                         R13 1
       25 GETTABLEKS                       R13 R13 K7 ["SLIDER_DEFAULT_WIDTH"]
       ...
       40 GETUPVAL                         R14 2
       41 GETTABLEKS                       R14 R14 K9 ["createElement"]
       43 GETUPVAL                         R15 3
...
PROTO_3:
       ...
       48 GETUPVAL                         R14 1
       49 GETTABLEKS                       R14 R14 K11 ["createElement"]
       51 GETUPVAL                         R15 2
...
PROTO_4:
        ...
        1 GETUPVAL                         R3 1
        2 GETUPVAL                         R4 2
        3 GETTABLEKS                       R4 R4 K0 ["frontViewControls"]
        5 MOVE                             R5 R0
        6 MOVE                             R6 R1
        7 CALL                             R3 3 1
        8 RETURN                           R3 1
...
PROTO_5:
        0 GETUPVAL                         R2 0
        1 GETUPVAL                         R3 1
        2 GETTABLEKS                       R3 R3 K0 ["dragBoxControls"]
        4 MOVE                             R4 R0
        5 MOVE                             R5 R1
        6 CALL                             R2 3 1
        7 RETURN                           R2 1
...
PROTO_6:
        ...
        1 GETUPVAL                         R3 1
        2 GETUPVAL                         R4 2
        3 GETTABLEKS                       R4 R4 K0 ["sideViewControls"]
        5 MOVE                             R5 R0
        6 MOVE                             R6 R1
        7 CALL                             R3 3 1
        8 RETURN                           R3 1
...
MAIN:
       ...
       20 GETTABLEKS                       R4 R0 K10 ["Utils"]
       22 GETTABLEKS                       R4 R4 K11 ["FaceControlEditorUtils"]
       24 CALL                             R3 1 1
       25 GETIMPORT                        R4 K6 [require]
       27 GETTABLEKS                       R5 R0 K7 ["Components"]
       29 GETTABLEKS                       R5 R5 K8 ["FaceControlEditor"]
       31 GETTABLEKS                       R5 R5 K12 ["FaceSlider"]
       33 CALL                             R4 1 1
       34 GETIMPORT                        R5 K6 [require]
       36 GETTABLEKS                       R6 R0 K7 ["Components"]
       38 GETTABLEKS                       R6 R6 K8 ["FaceControlEditor"]
       40 GETTABLEKS                       R6 R6 K13 ["FaceDragbox"]
       42 CALL                             R5 1 1
       43 GETIMPORT                        R6 K6 [require]
       45 GETTABLEKS                       R7 R1 K14 ["React"]
       47 CALL                             R6 1 1
       48 GETIMPORT                        R7 K6 [require]
       50 GETTABLEKS                       R8 R0 K7 ["Components"]
       52 GETTABLEKS                       R8 R8 K8 ["FaceControlEditor"]
       54 GETTABLEKS                       R8 R8 K15 ["SymmetryHandler"]
       56 CALL                             R7 1 1
       57 NEWTABLE                         R8 4 0
       59 LOADB                            R9 0
