...
PROTO_1:
        ...
        8 LOADK                            R4 K5 ["FaceControlEditorContext_SliderValues"]
        9 MOVE                             R5 R1
       10 CALL                             R3 2 1
       11 SETTABLEKS                       R3 R2 K1 ["sliderValues"]
       13 GETUPVAL                         R3 1
       14 GETTABLEKS                       R3 R3 K6 ["useBoundAction"]
       16 LOADK                            R4 K7 ["FaceControlEditorContext_SetSliderValuesAsync"]
       17 CALL                             R3 1 1
       18 SETTABLEKS                       R3 R2 K2 ["setSliderValuesAsync"]
       20 GETUPVAL                         R3 2
       21 GETTABLEKS                       R3 R3 K8 ["createElement"]
       23 GETUPVAL                         R4 3
       24 GETTABLEKS                       R4 R4 K9 ["Provider"]
       26 DUPTABLE                         R5 K11 [{"value"}]
       27 SETTABLEKS                       R2 R5 K10 ["value"]
       29 GETTABLEKS                       R6 R0 K12 ["children"]
       31 CALL                             R3 3 -1
       32 RETURN                           R3 -1
...
PROTO_14:
      ...
      127 LOADK                            R12 K9 ["FaceControlEditorContext_SliderValues"]
      128 MOVE                             R13 R8
      129 CALL                             R11 2 0
      130 DUPTABLE                         R11 K12 [{"sliderValues", "setSliderValuesAsync"}]
      131 SETTABLEKS                       R8 R11 K10 ["sliderValues"]
      133 GETUPVAL                         R12 6
      134 GETTABLEKS                       R12 R12 K13 ["useBoundAction"]
      136 LOADK                            R13 K14 ["FaceControlEditorContext_SetSliderValuesAsync"]
      137 MOVE                             R14 R10
      138 CALL                             R12 2 1
      139 SETTABLEKS                       R12 R11 K11 ["setSliderValuesAsync"]
      141 GETUPVAL                         R12 2
      142 GETTABLEKS                       R12 R12 K15 ["createElement"]
      144 GETUPVAL                         R13 7
      145 GETTABLEKS                       R13 R13 K16 ["Provider"]
      147 DUPTABLE                         R14 K18 [{"value"}]
      148 SETTABLEKS                       R11 R14 K17 ["value"]
      150 GETTABLEKS                       R15 R0 K19 ["children"]
      152 CALL                             R12 3 -1
      153 CLOSEUPVALS                      R1
      154 RETURN                           R12 -1
...
MAIN:
       ...
       49 CALL                             R7 2 1
       50 LOADNIL                          R8
       51 DUPTABLE                         R9 K23 [{["SLIDER_VALUES"] = "FaceControlEditorContext_SliderValues"}]
       52 DUPTABLE                         R10 K26 [{["SET_SLIDER_VALUES_ASYNC"] = "FaceControlEditorContext_SetSliderValuesAsync"}]
       53 DUPTABLE                         R11 K29 [{"sliderValues", "setSliderValuesAsync"}]
       54 NEWTABLE                         R12 0 0
       56 SETTABLEKS                       R12 R11 K27 ["sliderValues"]
       58 GETTABLEKS                       R12 R5 K30 ["createUnimplemented"]
       60 LOADK                            R13 K28 ["setSliderValuesAsync"]
       61 CALL                             R12 1 1
       62 SETTABLEKS                       R12 R11 K28 ["setSliderValuesAsync"]
       64 GETTABLEKS                       R12 R4 K31 ["createContext"]
       66 MOVE                             R13 R11
       67 CALL                             R12 1 1
       68 DUPCLOSURE                       R13 K32 [PROTO_0]
       69 CAPTURE                          VAL R7
       70 DUPCLOSURE                       R14 K33 [PROTO_1]
       71 CAPTURE                          VAL R2
       72 CAPTURE                          VAL R3
       73 CAPTURE                          VAL R4
       74 CAPTURE                          VAL R12
       75 DUPCLOSURE                       R15 K34 [PROTO_2]
       76 NEWCLOSURE                       R16 P3
       77 CAPTURE                          REF R8
       78 CAPTURE                          VAL R7
       79 CAPTURE                          VAL R4
       80 CAPTURE                          VAL R15
       ...
       83 CAPTURE                          VAL R3
       84 CAPTURE                          VAL R12
       85 DUPTABLE                         R17 K40 [{"Context", "EditableDataModelProvider", "UIDataModelProvider", "getSelectedInstance", "findFaceControls"}]
       86 SETTABLEKS                       R12 R17 K35 ["Context"]
       88 SETTABLEKS                       R16 R17 K36 ["EditableDataModelProvider"]
       90 SETTABLEKS                       R14 R17 K37 ["UIDataModelProvider"]
       92 SETTABLEKS                       R13 R17 K38 ["getSelectedInstance"]
       94 SETTABLEKS                       R15 R17 K39 ["findFaceControls"]
       96 CLOSEUPVALS                      R8
       97 RETURN                           R17 1
