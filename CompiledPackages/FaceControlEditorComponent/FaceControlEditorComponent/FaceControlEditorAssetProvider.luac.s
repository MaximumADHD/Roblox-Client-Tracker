PROTO_0:
  ...
  GETUPVAL R7 2
  GETTABLEKS R6 R7 K4 ["EditableDataModelProvider"]
  ...
  GETUPVAL R8 3
  GETTABLEKS R7 R8 K4 ["EditableDataModelProvider"]
  DUPTABLE R8 K9 [{"selectedInstance", "updateContextFunction"}]
  GETTABLEKS R9 R0 K7 ["selectedInstance"]
  SETTABLEKS R9 R8 K7 ["selectedInstance"]
  GETTABLEKS R9 R0 K8 ["updateContextFunction"]
  SETTABLEKS R9 R8 K8 ["updateContextFunction"]
  CALL R6 2 1
  GETUPVAL R8 0
  GETTABLEKS R7 R8 K0 ["createElement"]
  GETUPVAL R9 4
  GETTABLEKS R8 R9 K4 ["EditableDataModelProvider"]
  DUPTABLE R9 K10 [{"selectedInstance"}]
  GETTABLEKS R10 R0 K7 ["selectedInstance"]
  SETTABLEKS R10 R9 K7 ["selectedInstance"]
  CALL R7 2 -1
  SETLIST R4 R5 -1 [1]
  SETTABLEKS R4 R3 K2 ["providers"]
  GETTABLEKS R4 R0 K11 ["children"]
  CALL R1 3 -1
  RETURN R1 -1
