PROTO_0:
  ...
  LOADK R3 K4 ["Attempted to access unitialized state. Use setState to initialize state"]
  CALL R2 1 0
  LOADNIL R2
  RETURN R2 1
...
MAIN:
  ...
  CALL R0 1 1
  NEWTABLE R1 0 0
  DUPTABLE R4 K10 [{"__index", "__newindex", "__tostring", "__metatable"}]
  DUPCLOSURE R5 K11 [PROTO_0]
  CAPTURE VAL R0
  SETTABLEKS R5 R4 K6 ["__index"]
  DUPCLOSURE R5 K12 [PROTO_1]
  CAPTURE VAL R0
  SETTABLEKS R5 R4 K7 ["__newindex"]
  DUPCLOSURE R5 K13 [PROTO_2]
  SETTABLEKS R5 R4 K8 ["__tostring"]
  LOADK R5 K14 ["UninitializedState"]
  SETTABLEKS R5 R4 K9 ["__metatable"]
