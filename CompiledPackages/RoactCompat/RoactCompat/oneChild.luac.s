PROTO_0:
  ...
  LOADK R4 K3 ["You likely don't need this at all! If you were assigning children "]
  LOADK R5 K4 ["via `React.oneChild(someChildren)`, you can simply use "]
  LOADK R6 K5 ["`someChildren` directly."]
  CONCAT R3 R4 R6
  CALL R1 2 0
  JUMPIF R0 [+2]
  LOADNIL R1
