...
PROTO_3:
       ...
       47 CALL                             R3 -1 0
       48 LOADNIL                          R3
       49 GETIMPORT                        R4 K1 [_G]
       51 GETTABLEKS                       R4 R4 K19 ["__ROACT_17_COMPAT_LEGACY_ROOT__"]
       53 JUMPIFNOT                        R4 ; [+10]
       54 GETUPVAL                         R4 2
       55 GETTABLEKS                       R4 R4 K20 ["createLegacyRoot"]
       ...
       63 JUMP                             ; [+9]
       64 GETUPVAL                         R4 2
       65 GETTABLEKS                       R4 R4 K24 ["createRoot"]
       ...
       78 CALL                             R4 1 1
       79 LOADK                            R5 K25 ["Target"]
       80 SETTABLEKS                       R5 R4 K26 ["Name"]
       82 MOVE                             R1 R4
       83 JUMPIFNOTEQKNIL                  R2 ; [+9]
       85 GETIMPORT                        R4 K1 [_G]
       87 GETTABLEKS                       R4 R4 K19 ["__ROACT_17_COMPAT_LEGACY_ROOT__"]
       89 JUMPIFNOT                        R4 ; [+2]
       90 LOADK                            R2 K27 ["ReactLegacyRoot"]
       91 JUMP                             ; [+1]
       92 LOADK                            R2 K28 ["ReactRoot"]
       93 GETIMPORT                        R4 K1 [_G]
       95 GETTABLEKS                       R4 R4 K29 ["__ROACT_17_INLINE_ACT__"]
       97 JUMPIFNOT                        R4 ; [+11]
       98 GETUPVAL                         R4 2
       99 GETTABLEKS                       R4 R4 K30 ["act"]
      ...
      108 JUMP                             ; [+11]
      109 GETUPVAL                         R6 2
      110 GETTABLEKS                       R6 R6 K31 ["createPortal"]
      112 NEWTABLE                         R7 1 0
...
PROTO_5:
        ...
        7 GETTABLEKS                       R2 R2 K3 ["__COMPAT_WARNINGS__"]
        9 JUMPIFNOT                        R2 ; [+4]
       10 GETUPVAL                         R2 0
       ...
       18 GETIMPORT                        R4 K1 [_G]
       20 GETTABLEKS                       R4 R4 K8 ["__ROACT_17_INLINE_ACT__"]
       22 JUMPIFNOT                        R4 ; [+11]
       23 GETUPVAL                         R4 1
       24 GETTABLEKS                       R4 R4 K9 ["act"]
       26 NEWCLOSURE                       R5 P0
       27 CAPTURE                          VAL R0
       28 CAPTURE                          UPVAL U1
       29 CAPTURE                          VAL R2
       ...
       36 GETUPVAL                         R6 1
       37 GETTABLEKS                       R6 R6 K11 ["createPortal"]
       39 NEWTABLE                         R7 1 0
...
PROTO_7:
       ...
       13 CALL                             R1 2 0
       14 GETIMPORT                        R1 K1 [_G]
       16 GETTABLEKS                       R1 R1 K6 ["__ROACT_17_INLINE_ACT__"]
       18 JUMPIFNOT                        R1 ; [+7]
       19 GETUPVAL                         R1 1
       20 GETTABLEKS                       R1 R1 K7 ["act"]
       22 NEWCLOSURE                       R2 P0
       23 CAPTURE                          VAL R0
       24 CALL                             R1 1 0
       25 RETURN                           R0 0
...
MAIN:
       ...
       27 GETTABLEKS                       R5 R5 K9 ["warnOnce"]
       29 CALL                             R4 1 1
