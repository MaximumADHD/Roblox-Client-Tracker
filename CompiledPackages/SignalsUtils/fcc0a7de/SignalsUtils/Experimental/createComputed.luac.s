...
MAIN:
       ...
       16 GETTABLEKS                       R3 R0 K8 ["Experimental"]
       18 GETTABLEKS                       R3 R3 K9 ["callUserSpace"]
       20 CALL                             R2 1 1
       21 DUPCLOSURE                       R3 K10 [PROTO_0]
       22 DUPCLOSURE                       R4 K11 [PROTO_1]
       23 DUPCLOSURE                       R5 K12 [PROTO_2]
       24 CAPTURE                          VAL R4
       25 DUPCLOSURE                       R6 K13 [PROTO_5]
       26 CAPTURE                          VAL R5
       27 CAPTURE                          VAL R2
       28 GETIMPORT                        R7 K15 [_G]
       30 GETTABLEKS                       R7 R7 K16 ["__SIGNALS_VALIDATION_ENABLED__"]
       32 JUMPIF                           R7 ; [+4]
       33 GETIMPORT                        R7 K15 [_G]
       35 GETTABLEKS                       R7 R7 K17 ["__DEV__"]
       37 JUMPIFNOT                        R7 ; [+2]
       38 MOVE                             R8 R6
       39 JUMP                             ; [+1]
       40 MOVE                             R8 R2
       41 DUPTABLE                         R9 K19 [{"__mode"}]
       42 LOADK                            R10 K20 ["k"]
       43 SETTABLEKS                       R10 R9 K18 ["__mode"]
       45 DUPCLOSURE                       R10 K21 [PROTO_6]
       46 CAPTURE                          VAL R9
       47 DUPCLOSURE                       R11 K22 [PROTO_17]
       48 CAPTURE                          VAL R3
       49 CAPTURE                          VAL R9
       50 CAPTURE                          VAL R8
       51 CAPTURE                          VAL R2
