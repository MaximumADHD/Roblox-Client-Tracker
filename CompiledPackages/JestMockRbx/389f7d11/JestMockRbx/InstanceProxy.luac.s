PROTO_0:
        ...
        4 LOADB                            R2 0 +1
        5 LOADB                            R2 1
        6 LOADK                            R3 K0 ["Expected ':' not '.' calling member function %*"]
        7 GETUPVAL                         R5 1
...
PROTO_6:
        ...
        4 GETTABLE                         R2 R3 R0
        5 LOADK                            R3 K1 ["Expected ':' not '.' calling member function %*"]
        6 GETUPVAL                         R5 1
...
MAIN:
        ...
        9 DUPCLOSURE                       R2 K4 [PROTO_9]
       10 CAPTURE                          VAL R1
       11 CAPTURE                          VAL R0
       12 DUPTABLE                         R3 K6 [{"new"}]
       13 SETTABLEKS                       R2 R3 K5 ["new"]
       15 RETURN                           R3 1
