...
PROTO_5:
       ...
       11 GETIMPORT                        R0 K3 [_G]
       13 GETTABLEKS                       R0 R0 K4 ["__DEV__"]
       15 JUMPIFNOT                        R0 ; [+9]
       16 GETUPVAL                         R0 0
       17 GETUPVAL                         R1 5
       18 JUMPIFNOTLT                      R1 R0 ; [+6]
       20 GETUPVAL                         R0 6
       21 GETTABLEKS                       R0 R0 K5 ["error"]
...
PROTO_8:
       ...
       13 GETTABLEKS                       R1 R1 K4 ["__DEV__"]
       15 JUMPIFNOT                        R1 ; [+9]
       16 GETUPVAL                         R1 0
       17 GETUPVAL                         R2 5
       18 JUMPIFNOTLT                      R2 R1 ; [+6]
       20 GETUPVAL                         R1 6
       21 GETTABLEKS                       R1 R1 K5 ["error"]
       ...
       24 CALL                             R1 1 0
       25 GETUPVAL                         R1 7
       26 GETTABLEKS                       R1 R1 K7 ["toJSBoolean"]
       28 MOVE                             R2 R0
       29 CALL                             R1 1 1
       30 JUMPIFNOT                        R1 ; [+4]
       31 GETUPVAL                         R1 8
...
PROTO_9:
       ...
       21 GETIMPORT                        R0 K3 [_G]
       23 GETTABLEKS                       R0 R0 K4 ["__DEV__"]
       25 JUMPIFNOT                        R0 ; [+9]
       26 GETUPVAL                         R0 0
       27 GETUPVAL                         R1 6
       28 JUMPIFNOTLT                      R1 R0 ; [+6]
       30 GETUPVAL                         R0 7
       31 GETTABLEKS                       R0 R0 K5 ["error"]
       ...
       70 GETIMPORT                        R3 K3 [_G]
       72 GETTABLEKS                       R3 R3 K4 ["__DEV__"]
       74 JUMPIFNOT                        R3 ; [+9]
       75 GETUPVAL                         R3 0
       76 GETUPVAL                         R4 6
       77 JUMPIFNOTLT                      R4 R3 ; [+6]
       79 GETUPVAL                         R3 7
       80 GETTABLEKS                       R3 R3 K5 ["error"]
       ...
       83 CALL                             R3 1 0
       84 GETUPVAL                         R3 9
       85 GETTABLEKS                       R3 R3 K9 ["toJSBoolean"]
       87 MOVE                             R4 R2
       88 CALL                             R3 1 1
       89 JUMPIFNOT                        R3 ; [+4]
       90 GETUPVAL                         R3 10
...
PROTO_12:
       ...
       26 GETIMPORT                        R0 K3 [_G]
       28 GETTABLEKS                       R0 R0 K4 ["__DEV__"]
       30 JUMPIFNOT                        R0 ; [+9]
       31 GETUPVAL                         R0 0
       32 GETUPVAL                         R1 7
       33 JUMPIFNOTLT                      R1 R0 ; [+6]
       35 GETUPVAL                         R0 8
       36 GETTABLEKS                       R0 R0 K5 ["error"]
...
PROTO_14:
       ...
       22 GETUPVAL                         R3 4
       23 GETTABLEKS                       R3 R3 K6 ["current"]
       25 GETUPVAL                         R4 3
       26 LOADB                            R5 1
       ...
       59 GETIMPORT                        R8 K1 [_G]
       61 GETTABLEKS                       R8 R8 K2 ["__DEV__"]
       63 JUMPIFNOT                        R8 ; [+8]
       64 GETUPVAL                         R8 2
       65 JUMPIFNOTLT                      R1 R8 ; [+6]
       67 GETUPVAL                         R8 1
       68 GETTABLEKS                       R8 R8 K3 ["error"]
       ...
       93 LOADB                            R8 0
       94 GETIMPORT                        R9 K1 [_G]
       96 GETTABLEKS                       R9 R9 K2 ["__DEV__"]
       98 JUMPIFNOT                        R9 ; [+18]
       99 GETUPVAL                         R10 6
      ...
      106 GETUPVAL                         R9 6
      107 GETTABLEKS                       R9 R9 K17 ["delay"]
      109 LOADN                            R10 0
      110 CALL                             R9 1 1
      ...
      138 RETURN                           R9 -1
      139 CLOSEUPVALS                      R8
      140 GETIMPORT                        R8 K1 [_G]
      142 GETTABLEKS                       R8 R8 K2 ["__DEV__"]
      144 JUMPIFNOT                        R8 ; [+8]
      145 JUMPIFEQKNIL                     R5 ; [+7]
      147 GETUPVAL                         R8 1
      148 GETTABLEKS                       R8 R8 K3 ["error"]
      ...
      176 GETIMPORT                        R10 K1 [_G]
      178 GETTABLEKS                       R10 R10 K2 ["__DEV__"]
      180 JUMPIFNOT                        R10 ; [+8]
      181 GETUPVAL                         R10 2
      182 JUMPIFNOTLT                      R1 R10 ; [+6]
      184 GETUPVAL                         R10 1
      185 GETTABLEKS                       R10 R10 K3 ["error"]
...
MAIN:
       ...
       47 CALL                             R10 1 1
       48 GETTABLEKS                       R11 R10 K14 ["__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED"]
       50 GETTABLEKS                       R11 R11 K15 ["Events"]
       ...
       62 GETIMPORT                        R18 K1 [script]
       64 GETTABLEKS                       R18 R18 K2 ["Parent"]
