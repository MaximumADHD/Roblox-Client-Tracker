...
PROTO_5:
  ...
  LOADK R2 K9 ["FIXME (roblox): enableCreateEventHandleAPI is unimplemented"]
  LOADN R3 2
  CALL R1 2 0
  LOADNIL R1
  RETURN R1 1
...
PROTO_6:
  ...
  LOADK R1 K9 ["FIXME (roblox): enableCreateEventHandleAPI is unimplemented"]
  LOADN R2 2
  CALL R0 2 0
  RETURN R0 0
...
PROTO_14:
  ...
  LOADK R5 K9 ["FIXME (roblox): createTextInstance is unimplemented"]
  LOADN R6 2
  CALL R4 2 0
  LOADNIL R4
  RETURN R4 1
...
PROTO_15:
  ...
  CALL R4 1 0
  GETIMPORT R4 K8 [error]
  LOADK R5 K9 ["FIXME (roblox): commitMount is unimplemented"]
  LOADN R6 2
  CALL R4 2 0
  RETURN R0 0
...
PROTO_24:
  ...
  LOADK R3 K9 ["FIXME (roblox): clearSuspenseBoundary is unimplemented"]
  LOADN R4 2
  CALL R2 2 0
  RETURN R0 0
...
PROTO_25:
  ...
  CALL R2 1 0
  GETIMPORT R2 K8 [error]
  LOADK R3 K9 ["FIXME (roblox): clearSuspenseBoundaryFromContainer is unimplemented"]
  LOADN R4 2
  CALL R2 2 0
  RETURN R0 0
...
PROTO_26:
  ...
  CALL R1 1 0
  GETIMPORT R1 K8 [error]
  LOADK R2 K9 ["FIXME (roblox): hideInstance is unimplemented"]
  LOADN R3 2
  CALL R1 2 0
  RETURN R0 0
...
PROTO_27:
  ...
  CALL R1 1 0
  GETIMPORT R1 K8 [error]
  LOADK R2 K9 ["FIXME (roblox): hideTextInstance is unimplemented"]
  LOADN R3 2
  CALL R1 2 0
  RETURN R0 0
...
PROTO_28:
  ...
  CALL R2 1 0
  GETIMPORT R2 K8 [error]
  LOADK R3 K9 ["FIXME (roblox): unhideInstance is unimplemented"]
  LOADN R4 2
  CALL R2 2 0
  RETURN R0 0
...
PROTO_29:
  ...
  CALL R2 1 0
  GETIMPORT R2 K8 [error]
  LOADK R3 K9 ["FIXME (roblox): unhideTextInstance is unimplemented"]
  LOADN R4 2
  CALL R2 2 0
  RETURN R0 0
