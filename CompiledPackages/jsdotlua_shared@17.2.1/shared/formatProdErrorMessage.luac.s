PROTO_0:
  ...
  LOADK R4 K11 ["Minified React error #%d; visit %s for the full message or use the non-minified dev environment for full errors and additional helpful warnings."]
  MOVE R5 R0
  MOVE R6 R1
  CALL R3 3 -1
  RETURN R3 -1
