PROTO_0:
       ...
       22 LENGTH                           R4 R3
       23 LOADN                            R5 0
       24 JUMPIFNOTLT                      R5 R4 ; [+14]
       26 GETIMPORT                        R4 K6 [error]
       28 LOADK                            R5 K7 ["Properties that are not part of %* type were passed: { \"%*\" }"]
       29 MOVE                             R7 R2
       30 GETIMPORT                        R8 K9 [table.concat]
       32 MOVE                             R9 R3
       33 LOADK                            R10 K10 ["\", \""]
       34 CALL                             R8 2 1
       35 NAMECALL                         R5 R5 K11 ["format"]
       37 CALL                             R5 3 1
       38 CALL                             R4 1 0
       39 GETIMPORT                        R4 K13 [table.clone]
       41 MOVE                             R5 R0
       42 CALL                             R4 1 1
       43 MOVE                             R5 R1
       44 LOADNIL                          R6
