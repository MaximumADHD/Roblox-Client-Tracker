PROTO_0:
       ...
       10 LOADK                            R7 K4 ["    %s\n"]
       11 GETUPVAL                         R9 0
       12 GETTABLEKS                       R9 R9 K5 ["green"]
       14 GETUPVAL                         R10 0
       15 GETTABLEKS                       R10 R10 K6 ["bold"]
       17 GETUPVAL                         R11 1
       18 GETTABLEKS                       R11 R11 K7 ["join"]
       20 GETUPVAL                         R12 2
       21 LOADK                            R13 K8 [" or "]
       22 CALL                             R11 2 -1
       23 CALL                             R10 -1 -1
       ...
       30 LOADK                            R6 K10 ["    %s"]
       31 GETUPVAL                         R8 0
       32 GETTABLEKS                       R8 R8 K11 ["red"]
       34 GETUPVAL                         R9 0
       35 GETTABLEKS                       R9 R9 K6 ["bold"]
       37 GETUPVAL                         R10 3
       38 MOVE                             R11 R1
       39 CALL                             R10 1 -1
       40 CALL                             R9 -1 -1
...
PROTO_1:
       ...
       22 LOADK                            R15 K6 ["    %s\n"]
       23 GETUPVAL                         R17 0
       24 GETTABLEKS                       R17 R17 K7 ["red"]
       26 GETUPVAL                         R18 0
       27 GETTABLEKS                       R18 R18 K8 ["bold"]
       29 MOVE                             R19 R4
       30 CALL                             R18 1 -1
       31 CALL                             R17 -1 -1
       ...
       37 LOADK                            R15 K6 ["    %s\n"]
       38 GETUPVAL                         R17 0
       39 GETTABLEKS                       R17 R17 K10 ["green"]
       41 GETUPVAL                         R18 0
       42 GETTABLEKS                       R18 R18 K8 ["bold"]
       44 GETUPVAL                         R19 1
       45 MOVE                             R20 R3
       46 CALL                             R19 1 -1
       47 CALL                             R18 -1 -1
       ...
       54 LOADK                            R14 K12 ["    %s"]
       55 GETUPVAL                         R16 0
       56 GETTABLEKS                       R16 R16 K10 ["green"]
       58 GETUPVAL                         R17 0
       59 GETTABLEKS                       R17 R17 K8 ["bold"]
       61 GETUPVAL                         R18 2
       62 GETTABLEKS                       R18 R18 K13 ["join"]
       64 GETUPVAL                         R19 3
       65 GETTABLEKS                       R19 R19 K14 ["split"]
       67 GETUPVAL                         R20 4
       68 GETTABLEKS                       R20 R20 K15 ["stringify"]
       70 MOVE                             R21 R0
       71 LOADNIL                          R22
       72 LOADN                            R23 2
       73 CALL                             R20 3 1
...
MAIN:
       ...
       30 GETTABLEKS                       R8 R0 K10 ["JestGetType"]
       32 CALL                             R7 1 1
       33 GETTABLEKS                       R7 R7 K11 ["getType"]
       35 GETIMPORT                        R8 K4 [require]
       37 GETTABLEKS                       R9 R0 K12 ["JestValidate"]
       39 CALL                             R8 1 1
       40 GETTABLEKS                       R9 R8 K13 ["ValidationError"]
       42 GETIMPORT                        R10 K4 [require]
       44 GETIMPORT                        R11 K1 [script]
       46 GETTABLEKS                       R11 R11 K2 ["Parent"]
       48 GETTABLEKS                       R11 R11 K14 ["utils"]
       50 CALL                             R10 1 1
       51 GETTABLEKS                       R11 R10 K15 ["BULLET"]
       53 GETTABLEKS                       R12 R10 K16 ["DOCUMENTATION_NOTE"]
       55 GETIMPORT                        R13 K4 [require]
       57 GETTABLEKS                       R14 R0 K17 ["RobloxShared"]
       59 CALL                             R13 1 1
       60 GETTABLEKS                       R14 R13 K18 ["nodeUtils"]
       62 GETTABLEKS                       R15 R14 K19 ["JSON"]
       64 LOADNIL                          R16
       65 NEWTABLE                         R17 0 3
       67 LOADK                            R18 K20 ["table"]
       68 LOADK                            R19 K21 ["string"]
       69 LOADK                            R20 K22 ["ModuleScript"]
       70 SETLIST                          R17 R18 3 [1]
       72 LOADK                            R18 K23 ["%sReporter Validation Error"]
       73 FASTCALL1                        TOSTRING R11 ; [+3]
       74 MOVE                             R21 R11
       75 GETIMPORT                        R20 K25 [tostring]
       77 CALL                             R20 1 1
       78 NAMECALL                         R18 R18 K26 ["format"]
       80 CALL                             R18 2 1
       81 DUPCLOSURE                       R19 K27 [PROTO_0]
       82 CAPTURE                          VAL R5
       83 CAPTURE                          VAL R2
       84 CAPTURE                          VAL R17
       85 CAPTURE                          VAL R7
       ...
       87 CAPTURE                          VAL R18
       88 CAPTURE                          VAL R12
       89 SETTABLEKS                       R19 R4 K28 ["createReporterError"]
       91 DUPCLOSURE                       R20 K29 [PROTO_1]
       92 CAPTURE                          VAL R5
       93 CAPTURE                          VAL R7
       94 CAPTURE                          VAL R2
       95 CAPTURE                          VAL R3
       ...
       98 CAPTURE                          VAL R18
       99 CAPTURE                          VAL R12
      100 SETTABLEKS                       R20 R4 K30 ["createArrayReporterError"]
      102 NEWCLOSURE                       R21 P2
      103 CAPTURE                          VAL R2
      104 CAPTURE                          REF R16
      105 CAPTURE                          VAL R19
      106 SETTABLEKS                       R21 R4 K31 ["validateReporters"]
      108 DUPCLOSURE                       R16 K32 [PROTO_4]
      109 CAPTURE                          VAL R20
      110 CLOSEUPVALS                      R16
      111 RETURN                           R4 1
