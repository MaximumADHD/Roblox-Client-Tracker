...
PROTO_8:
       ...
       44 RETURN                           R0 0
       45 GETUPVAL                         R2 3
       46 GETTABLEKS                       R2 R2 K3 ["_isLoggingEnabled"]
       48 GETUPVAL                         R3 4
       49 GETTABLEKS                       R3 R3 K4 ["DEBUG"]
       51 CALL                             R2 1 1
       52 JUMPIFNOT                        R2 ; [+8]
       ...
       62 JUMPIF                           R2 ; [+32]
       63 GETUPVAL                         R2 3
       64 GETTABLEKS                       R2 R2 K3 ["_isLoggingEnabled"]
       66 GETUPVAL                         R3 4
       67 GETTABLEKS                       R3 R3 K4 ["DEBUG"]
       69 CALL                             R2 1 1
       70 JUMPIFNOT                        R2 ; [+14]
       ...
       94 CALL                             R2 1 0
       95 GETUPVAL                         R2 6
       96 GETTABLEKS                       R2 R2 K18 ["requestOptions"]
       98 GETUPVAL                         R3 3
       99 MOVE                             R5 R2
...
PROTO_12:
       ...
       10 GETUPVAL                         R5 2
       11 GETTABLEKS                       R5 R5 K4 ["RESPONSES"]
       13 CALL                             R4 1 1
       14 JUMPIFNOT                        R4 ; [+120]
       15 NEWTABLE                         R4 0 1
       ...
       20 GETUPVAL                         R5 1
       21 GETTABLEKS                       R5 R5 K3 ["_isLoggingEnabled"]
       23 GETUPVAL                         R6 2
       24 GETTABLEKS                       R6 R6 K6 ["DEBUG"]
       26 CALL                             R5 1 1
       27 JUMPIFNOT                        R5 ; [+84]
      ...
      141 LOADNIL                          R7
      142 GETUPVAL                         R8 1
      143 GETTABLEKS                       R8 R8 K33 ["_isInternal"]
      145 JUMPIFNOT                        R8 ; [+5]
      ...
      161 JUMPIFNOT                        R7 ; [+22]
      162 GETUPVAL                         R9 1
      163 GETTABLEKS                       R9 R9 K3 ["_isLoggingEnabled"]
      165 GETUPVAL                         R10 2
      166 GETTABLEKS                       R10 R10 K6 ["DEBUG"]
      168 CALL                             R9 1 1
      169 JUMPIFNOT                        R9 ; [+10]
      ...
      183 RETURN                           R0 0
      184 GETUPVAL                         R9 1
      185 GETTABLEKS                       R9 R9 K3 ["_isLoggingEnabled"]
      187 GETUPVAL                         R10 2
      188 GETTABLEKS                       R10 R10 K6 ["DEBUG"]
      190 CALL                             R9 1 1
      191 JUMPIFNOT                        R9 ; [+10]
      ...
      205 RETURN                           R0 0
      206 GETUPVAL                         R4 1
      207 GETTABLEKS                       R4 R4 K3 ["_isLoggingEnabled"]
      209 GETUPVAL                         R5 2
      210 GETTABLEKS                       R5 R5 K6 ["DEBUG"]
      212 CALL                             R4 1 1
      213 JUMPIFNOT                        R4 ; [+11]
      ...
      225 GETUPVAL                         R4 6
      226 GETUPVAL                         R5 3
      227 GETTABLEKS                       R5 R5 K36 ["new"]
      229 MOVE                             R6 R1
      230 MOVE                             R7 R3
      231 GETUPVAL                         R8 7
      232 GETTABLEKS                       R8 R8 K41 ["UNKNOWN_ERROR"]
      234 GETUPVAL                         R9 4
      235 CALL                             R5 4 -1
      236 CALL                             R4 -1 0
      237 RETURN                           R0 0
...
PROTO_17:
       ...
       18 GETUPVAL                         R3 0
       19 GETTABLEKS                       R3 R3 K7 ["REQUESTS"]
       21 CALL                             R2 1 1
       22 JUMPIFNOT                        R2 ; [+31]
       23 NEWTABLE                         R2 0 1
...
MAIN:
       ...
       42 CAPTURE                          VAL R4
       43 CAPTURE                          VAL R5
       44 SETTABLEKS                       R6 R5 K25 ["new"]
       46 DUPCLOSURE                       R6 K26 [PROTO_3]
       47 CAPTURE                          VAL R5
       48 SETTABLEKS                       R6 R5 K27 ["mock"]
       50 DUPCLOSURE                       R6 K28 [PROTO_6]
       51 CAPTURE                          VAL R0
       52 SETTABLEKS                       R6 R5 K29 ["parseJson"]
       54 DUPCLOSURE                       R6 K30 [PROTO_11]
       55 CAPTURE                          VAL R1
       56 CAPTURE                          VAL R4
       57 SETTABLEKS                       R6 R5 K31 ["handleRetry"]
       59 DUPCLOSURE                       R6 K32 [PROTO_17]
       60 CAPTURE                          VAL R4
       61 CAPTURE                          VAL R1
       62 CAPTURE                          VAL R2
       63 CAPTURE                          VAL R3
       64 SETTABLEKS                       R6 R5 K33 ["request"]
       66 DUPCLOSURE                       R6 K34 [PROTO_18]
       67 SETTABLEKS                       R6 R5 K35 ["get"]
       69 DUPCLOSURE                       R6 K36 [PROTO_19]
       70 SETTABLEKS                       R6 R5 K37 ["post"]
       72 DUPCLOSURE                       R6 K38 [PROTO_20]
       73 SETTABLEKS                       R6 R5 K39 ["delete"]
       75 RETURN                           R5 1
