PROTO_0:
        0 GETUPVAL                         R2 0
        1 CALL                             R2 0 1
        2 GETTABLEKS                       R2 R2 K0 ["getElementError"]
        4 MOVE                             R3 R0
        5 MOVE                             R4 R1
        6 CALL                             R2 2 -1
        7 RETURN                           R2 -1
...
PROTO_4:
        0 GETUPVAL                         R1 0
        1 GETUPVAL                         R3 1
        2 GETTABLEKS                       R3 R3 K0 ["includes"]
        4 GETUPVAL                         R4 2
        5 GETUPVAL                         R5 3
        6 CALL                             R3 2 1
        7 JUMPIFNOT                        R3 ; [+12]
       ...
       20 GETUPVAL                         R3 4
       21 CALL                             R3 0 1
       22 GETTABLEKS                       R3 R3 K3 ["testIdAttribute"]
       24 GETUPVAL                         R4 3
...
PROTO_5:
       ...
       35 GETUPVAL                         R12 3
       36 GETTABLEKS                       R12 R12 K6 ["filter"]
       38 GETUPVAL                         R13 4
       39 MOVE                             R14 R1
       40 NEWTABLE                         R15 0 1
       42 MOVE                             R16 R0
       ...
       45 GETUPVAL                         R17 3
       46 GETTABLEKS                       R17 R17 K7 ["includes"]
       48 GETUPVAL                         R18 5
       49 MOVE                             R19 R0
       50 CALL                             R17 2 1
       51 JUMPIFNOT                        R17 ; [+2]
       ...
       54 GETUPVAL                         R17 6
       55 CALL                             R17 0 1
       56 GETTABLEKS                       R17 R17 K9 ["testIdAttribute"]
...
PROTO_8:
        ...
        9 GETUPVAL                         R2 1
       10 GETTABLEKS                       R2 R2 K0 ["join"]
       12 GETUPVAL                         R3 1
       13 GETTABLEKS                       R3 R3 K1 ["map"]
       15 MOVE                             R4 R1
...
PROTO_11:
       ...
       10 GETUPVAL                         R3 1
       11 CALL                             R3 0 1
       12 GETTABLEKS                       R3 R3 K3 ["getElementError"]
       14 GETUPVAL                         R4 2
       15 MOVE                             R5 R0
       16 GETVARARGS                       R6 -1
       17 CALL                             R4 -1 1
...
PROTO_16:
       ...
       30 GETUPVAL                         R4 1
       31 CALL                             R4 0 1
       32 GETTABLEKS                       R4 R4 K4 ["throwSuggestions"]
       34 JUMP                             ; [+2]
       ...
       45 GETUPVAL                         R6 4
       46 GETTABLEKS                       R6 R6 K5 ["endsWith"]
       48 GETUPVAL                         R7 5
...
PROTO_19:
       ...
       23 GETUPVAL                         R4 1
       24 CALL                             R4 0 1
       25 GETTABLEKS                       R4 R4 K1 ["throwSuggestions"]
       27 JUMP                             ; [+2]
       ...
       33 JUMPIFNOT                        R4 ; [+44]
       34 GETUPVAL                         R5 2
       35 GETTABLEKS                       R5 R5 K3 ["concat"]
       37 NEWTABLE                         R6 0 0
       39 GETUPVAL                         R7 2
       40 GETTABLEKS                       R7 R7 K4 ["from"]
       42 GETUPVAL                         R8 3
       43 GETTABLEKS                       R8 R8 K5 ["new"]
       45 GETUPVAL                         R9 2
       46 GETTABLEKS                       R9 R9 K6 ["map"]
       48 MOVE                             R10 R2
       ...
       59 GETUPVAL                         R6 6
       60 GETTABLEKS                       R6 R6 K8 ["endsWith"]
       62 GETUPVAL                         R7 7
       63 GETUPVAL                         R8 4
       64 GETTABLEN                        R9 R2 1
       65 GETUPVAL                         R10 5
       66 CALL                             R8 2 1
       67 GETTABLEKS                       R8 R8 K9 ["queryName"]
       69 CALL                             R6 2 1
       70 JUMPIF                           R6 ; [+7]
...
MAIN:
       ...
       26 GETTABLEKS                       R7 R7 K10 ["jsHelpers"]
       28 GETTABLEKS                       R7 R7 K11 ["querySelectors"]
       30 CALL                             R6 1 1
       31 GETTABLEKS                       R6 R6 K12 ["querySelectorAll"]
       33 NEWTABLE                         R7 16 0
       35 NEWTABLE                         R8 0 2
       ...
       80 GETTABLEKS                       R17 R17 K2 ["Parent"]
       82 GETTABLEKS                       R16 R17 K21 ["wait-for"]
       84 CALL                             R15 1 1
       85 GETTABLEKS                       R15 R15 K22 ["waitFor"]
       87 GETIMPORT                        R16 K4 [require]
       89 GETIMPORT                        R17 K1 [script]
       91 GETTABLEKS                       R17 R17 K2 ["Parent"]
       93 GETTABLEKS                       R17 R17 K23 ["config"]
       95 CALL                             R16 1 1
       96 GETTABLEKS                       R16 R16 K24 ["getConfig"]
       98 GETIMPORT                        R17 K4 [require]
      100 GETIMPORT                        R19 K1 [script]
      102 GETTABLEKS                       R19 R19 K2 ["Parent"]
      104 GETTABLEKS                       R18 R19 K25 ["get-node-test-id"]
      106 CALL                             R17 1 1
      107 GETTABLEKS                       R17 R17 K26 ["getNodeTestId"]
