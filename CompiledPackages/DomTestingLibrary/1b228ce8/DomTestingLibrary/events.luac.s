...
PROTO_1:
        0 GETUPVAL                         R4 0
        1 CALL                             R4 0 1
        2 GETTABLEKS                       R4 R4 K0 ["eventWrapper"]
        4 NEWCLOSURE                       R5 P0
        5 CAPTURE                          VAL R2
        6 CAPTURE                          UPVAL U1
        7 CAPTURE                          VAL R1
...
MAIN:
       ...
       26 GETTABLEKS                       R6 R6 K10 ["dispatchEvent"]
       28 CALL                             R5 1 1
       29 NEWTABLE                         R6 1 0
       31 GETIMPORT                        R7 K4 [require]
       33 GETIMPORT                        R8 K1 [script]
       35 GETTABLEKS                       R8 R8 K2 ["Parent"]
       37 GETTABLEKS                       R8 R8 K11 ["config"]
       39 CALL                             R7 1 1
       40 GETTABLEKS                       R7 R7 K12 ["getConfig"]
       42 GETIMPORT                        R8 K4 [require]
       44 GETIMPORT                        R9 K1 [script]
       46 GETTABLEKS                       R9 R9 K2 ["Parent"]
       48 GETTABLEKS                       R9 R9 K13 ["helpers"]
       50 CALL                             R8 1 1
       51 GETTABLEKS                       R8 R8 K14 ["getWindowFromNode"]
