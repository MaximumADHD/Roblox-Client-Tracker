...
PROTO_1:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["getIgnore"]
        3 CALL                             R1 0 1
        4 GETUPVAL                         R3 1
        5 GETTABLEKS                       R3 R3 K1 ["includes"]
        7 MOVE                             R4 R1
...
PROTO_2:
       ...
       17 GETIMPORT                        R4 K4 [_G]
       19 GETTABLEKS                       R4 R4 K5 ["DEBUG_PRINT_LIMIT"]
       21 GETUPVAL                         R6 1
       22 GETTABLEKS                       R6 R6 K6 ["toJSBoolean"]
       24 MOVE                             R7 R4
       25 CALL                             R6 1 1
       26 JUMPIFNOT                        R6 ; [+2]
       27 MOVE                             R5 R4
       ...
       62 GETUPVAL                         R6 4
       63 GETTABLEKS                       R6 R6 K16 ["assign"]
       65 NEWTABLE                         R7 0 0
       67 MOVE                             R8 R3
       68 DUPTABLE                         R9 K17 [{"filterNode"}]
       69 GETUPVAL                         R10 4
       70 GETTABLEKS                       R10 R10 K18 ["None"]
       72 SETTABLEKS                       R10 R9 K15 ["filterNode"]
       74 CALL                             R6 3 1
       75 GETUPVAL                         R7 5
       76 GETTABLEKS                       R7 R7 K14 ["format"]
       78 MOVE                             R8 R0
       79 GETUPVAL                         R9 4
       80 GETTABLEKS                       R9 R9 K16 ["assign"]
       82 NEWTABLE                         R10 0 0
       84 DUPTABLE                         R11 K23 [{["plugins"], ["printFunctionName"] = False, ["highlight"]}]
       85 NEWTABLE                         R12 0 1
       87 GETUPVAL                         R13 6
       88 MOVE                             R14 R5
       89 CALL                             R13 1 -1
       ...
       94 LOADB                            R12 1
       95 SETTABLEKS                       R12 R11 K22 ["highlight"]
       97 MOVE                             R12 R6
       98 CALL                             R9 3 -1
       99 CALL                             R7 -1 1
      100 JUMPIFEQKNIL                     R1 ; [+17]
      102 LENGTH                           R9 R7
      103 JUMPIFNOTLT                      R1 R9 ; [+14]
      105 LOADK                            R8 K24 ["%s..."]
      106 LOADN                            R12 1
      107 FASTCALL3                        STRING_SUB R7 R12 R1
      109 MOVE                             R11 R7
      110 MOVE                             R13 R1
      111 GETIMPORT                        R10 K27 [string.sub]
      113 CALL                             R10 3 1
      114 NAMECALL                         R8 R8 K14 ["format"]
      116 CALL                             R8 2 1
      117 RETURN                           R8 1
      118 MOVE                             R8 R7
      119 RETURN                           R8 1
...
PROTO_3:
        0 PREPVARARGS                      0
        1 GETUPVAL                         R0 0
        2 GETTABLEKS                       R0 R0 K0 ["getUserCodeFrame"]
        4 CALL                             R0 0 1
        5 GETUPVAL                         R1 1
        6 GETTABLEKS                       R1 R1 K1 ["toJSBoolean"]
        8 MOVE                             R2 R0
        9 CALL                             R1 1 1
       10 JUMPIFNOT                        R1 ; [+13]
       11 GETUPVAL                         R1 2
       12 GETTABLEKS                       R1 R1 K2 ["log"]
       14 LOADK                            R2 K3 ["%s\n\n%s"]
       15 GETUPVAL                         R4 3
       16 GETVARARGS                       R5 -1
       17 CALL                             R4 -1 1
...
MAIN:
       ...
       28 GETTABLEKS                       R7 R7 K11 ["typeError"]
       30 CALL                             R6 1 1
       31 NEWTABLE                         R7 4 0
       ...
       44 GETTABLEKS                       R10 R10 K13 ["DOMElementFilter"]
       46 CALL                             R9 1 1
       47 GETTABLEKS                       R9 R9 K14 ["default"]
       49 GETIMPORT                        R10 K4 [require]
       51 GETIMPORT                        R12 K1 [script]
       53 GETTABLEKS                       R12 R12 K2 ["Parent"]
       55 GETTABLEKS                       R11 R12 K15 ["get-user-code-frame"]
       57 CALL                             R10 1 1
       58 GETIMPORT                        R11 K4 [require]
       60 GETIMPORT                        R12 K1 [script]
       62 GETTABLEKS                       R12 R12 K2 ["Parent"]
       64 GETTABLEKS                       R12 R12 K16 ["helpers"]
       66 CALL                             R11 1 1
       67 GETTABLEKS                       R11 R11 K17 ["getDocument"]
       69 GETIMPORT                        R12 K4 [require]
       71 GETIMPORT                        R14 K1 [script]
       73 GETTABLEKS                       R14 R14 K2 ["Parent"]
