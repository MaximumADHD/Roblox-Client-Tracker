...
MAIN:
       ...
       35 CALL                             R8 1 1
       36 DUPTABLE                         R9 K24 [{"Widgets", "pendingRegisters", "pendingDeregisters", "registeredWidgets", "running", "signals"}]
       37 LOADNIL                          R10
       38 SETTABLEKS                       R10 R9 K18 ["Widgets"]
       40 NEWTABLE                         R10 0 0
       42 SETTABLEKS                       R10 R9 K19 ["pendingRegisters"]
       44 NEWTABLE                         R10 0 0
       46 SETTABLEKS                       R10 R9 K20 ["pendingDeregisters"]
       48 NEWTABLE                         R10 0 0
       50 SETTABLEKS                       R10 R9 K21 ["registeredWidgets"]
       52 LOADB                            R10 0
       53 SETTABLEKS                       R10 R9 K22 ["running"]
       55 NEWTABLE                         R10 0 0
       57 SETTABLEKS                       R10 R9 K23 ["signals"]
       59 DUPCLOSURE                       R10 K25 [PROTO_6]
       60 CAPTURE                          VAL R5
       61 CAPTURE                          VAL R9
       62 CAPTURE                          VAL R3
       63 CAPTURE                          VAL R4
       64 CAPTURE                          VAL R8
       65 SETTABLEKS                       R10 R9 K26 ["flush"]
       67 DUPCLOSURE                       R10 K27 [PROTO_8]
       68 CAPTURE                          VAL R9
       69 SETTABLEKS                       R10 R9 K28 ["run"]
       71 DUPCLOSURE                       R10 K29 [PROTO_9]
       72 CAPTURE                          VAL R8
       73 CAPTURE                          VAL R9
       74 SETTABLEKS                       R10 R9 K30 ["register"]
       76 DUPCLOSURE                       R10 K31 [PROTO_10]
       77 CAPTURE                          VAL R8
       78 CAPTURE                          VAL R9
       79 SETTABLEKS                       R10 R9 K32 ["deregister"]
       81 DUPCLOSURE                       R10 K33 [PROTO_11]
       82 CAPTURE                          VAL R7
       83 CAPTURE                          VAL R9
       84 RETURN                           R10 1
