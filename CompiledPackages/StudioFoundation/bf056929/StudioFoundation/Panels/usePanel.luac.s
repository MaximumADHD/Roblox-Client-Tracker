PROTO_0:
        ...
        3 JUMPIFNOT                        R0 ; [+21]
        4 GETUPVAL                         R0 0
        5 GETTABLEKS                       R0 R0 K1 ["registerPanelAsync"]
        7 GETUPVAL                         R1 1
        8 GETTABLEKS                       R1 R1 K2 ["current"]
       10 GETTABLEKS                       R1 R1 K3 ["anchorUri"]
       12 GETUPVAL                         R2 1
       13 GETTABLEKS                       R2 R2 K2 ["current"]
       15 GETTABLEKS                       R2 R2 K4 ["position"]
       17 GETUPVAL                         R3 0
       18 GETTABLEKS                       R3 R3 K5 ["onClose"]
       20 CALL                             R0 3 2
       21 GETUPVAL                         R2 2
       22 SETTABLEKS                       R1 R2 K2 ["current"]
       24 RETURN                           R0 1
       25 GETUPVAL                         R0 2
       26 GETTABLEKS                       R0 R0 K2 ["current"]
       28 JUMPIFNOT                        R0 ; [+8]
       29 GETUPVAL                         R0 2
       30 GETTABLEKS                       R0 R0 K2 ["current"]
       32 CALL                             R0 0 0
       33 GETUPVAL                         R0 2
       34 LOADNIL                          R1
...
PROTO_4:
       ...
       17 CALL                             R2 1 1
       18 GETUPVAL                         R3 1
       19 GETTABLEKS                       R3 R3 K5 ["useAsync"]
       21 NEWCLOSURE                       R4 P0
       22 CAPTURE                          VAL R0
       23 CAPTURE                          VAL R2
       24 CAPTURE                          VAL R1
       ...
       44 LOADNIL                          R4
       45 GETUPVAL                         R5 1
       46 GETTABLEKS                       R5 R5 K5 ["useAsync"]
       48 NEWCLOSURE                       R6 P1
       49 CAPTURE                          VAL R4
       50 CAPTURE                          VAL R0
       51 NEWTABLE                         R7 0 3
       ...
       60 CALL                             R5 2 0
       61 GETUPVAL                         R5 0
       62 GETTABLEKS                       R5 R5 K12 ["useEffect"]
       64 NEWCLOSURE                       R6 P2
       65 CAPTURE                          VAL R1
       66 NEWTABLE                         R7 0 0
       68 CALL                             R5 2 0
