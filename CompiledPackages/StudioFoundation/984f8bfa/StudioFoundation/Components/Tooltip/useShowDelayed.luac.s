...
PROTO_4:
       ...
       52 RETURN                           R0 0
       53 GETUPVAL                         R1 7
       54 GETTABLEKS                       R1 R1 K0 ["current"]
       56 JUMPIFNOT                        R1 ; [+10]
       57 GETIMPORT                        R1 K3 [task.cancel]
       59 GETUPVAL                         R2 7
       60 GETTABLEKS                       R2 R2 K0 ["current"]
       62 CALL                             R1 1 0
       63 GETUPVAL                         R1 7
       64 LOADNIL                          R2
       ...
       77 RETURN                           R0 0
       78 GETUPVAL                         R0 7
       79 GETTABLEKS                       R0 R0 K0 ["current"]
       81 JUMPIFNOT                        R0 ; [+10]
       82 GETIMPORT                        R0 K3 [task.cancel]
       84 GETUPVAL                         R1 7
       85 GETTABLEKS                       R1 R1 K0 ["current"]
       87 CALL                             R0 1 0
       88 GETUPVAL                         R0 7
       89 LOADNIL                          R1
       90 SETTABLEKS                       R1 R0 K0 ["current"]
       92 GETUPVAL                         R1 5
       93 GETTABLEKS                       R1 R1 K4 ["delay"]
      ...
      120 RETURN                           R0 0
      121 GETUPVAL                         R1 4
      122 GETTABLEKS                       R1 R1 K0 ["current"]
      124 JUMPIFNOT                        R1 ; [+10]
      125 GETIMPORT                        R1 K3 [task.cancel]
      127 GETUPVAL                         R2 4
      128 GETTABLEKS                       R2 R2 K0 ["current"]
      130 CALL                             R1 1 0
      131 GETUPVAL                         R1 4
      132 LOADNIL                          R2
...
PROTO_8:
       ...
       12 CALL                             R3 1 2
       13 GETUPVAL                         R5 0
       14 GETTABLEKS                       R5 R5 K2 ["useRef"]
       16 LOADNIL                          R6
       17 CALL                             R5 1 1
       18 GETUPVAL                         R6 0
       19 GETTABLEKS                       R6 R6 K2 ["useRef"]
       21 LOADNIL                          R7
       22 CALL                             R6 1 1
       23 GETUPVAL                         R7 0
       24 GETTABLEKS                       R7 R7 K2 ["useRef"]
       26 MOVE                             R8 R0
       27 CALL                             R7 1 1
       28 SETTABLEKS                       R0 R7 K3 ["current"]
       30 GETUPVAL                         R8 0
       31 GETTABLEKS                       R8 R8 K4 ["useCallback"]
       33 NEWCLOSURE                       R9 P0
       34 CAPTURE                          VAL R5
       35 CAPTURE                          VAL R6
       36 NEWTABLE                         R10 0 0
       38 CALL                             R8 2 1
       39 GETUPVAL                         R9 0
       40 GETTABLEKS                       R9 R9 K5 ["useEffect"]
       ...
       60 CALL                             R9 2 0
       61 GETUPVAL                         R9 0
       62 GETTABLEKS                       R9 R9 K5 ["useEffect"]
       64 NEWCLOSURE                       R10 P2
       65 CAPTURE                          VAL R8
       66 NEWTABLE                         R11 0 0
       68 CALL                             R9 2 0
       69 GETUPVAL                         R9 0
       70 GETTABLEKS                       R9 R9 K4 ["useCallback"]
