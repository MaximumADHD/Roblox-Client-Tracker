...
PROTO_1:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["useTooltipSettings"]
        3 CALL                             R1 0 1
        4 GETUPVAL                         R2 1
        5 GETTABLEKS                       R2 R2 K1 ["useValue"]
        7 CALL                             R2 0 1
        8 GETUPVAL                         R3 2
       ...
       75 LOADB                            R7 0
       76 GETUPVAL                         R8 5
       77 GETTABLEKS                       R8 R8 K16 ["useMemo"]
       79 NEWCLOSURE                       R9 P0
       80 CAPTURE                          UPVAL U6
       81 CAPTURE                          VAL R0
       82 CAPTURE                          UPVAL U7
...
MAIN:
       ...
       18 CALL                             R3 1 1
       19 GETTABLEKS                       R4 R3 K9 ["Enums"]
       21 GETTABLEKS                       R4 R4 K10 ["PopoverAlign"]
       23 GETTABLEKS                       R5 R3 K9 ["Enums"]
       25 GETTABLEKS                       R5 R5 K11 ["PopoverSide"]
       27 GETIMPORT                        R6 K6 [require]
       29 GETTABLEKS                       R7 R0 K12 ["Types"]
       31 CALL                             R6 1 1
       32 GETIMPORT                        R7 K6 [require]
       34 GETTABLEKS                       R8 R0 K13 ["Contexts"]
       36 GETTABLEKS                       R8 R8 K14 ["TooltipSettingsContext"]
       38 CALL                             R7 1 1
       39 GETIMPORT                        R8 K6 [require]
       41 GETTABLEKS                       R9 R0 K15 ["Components"]
       43 GETTABLEKS                       R9 R9 K16 ["Popover"]
       45 GETTABLEKS                       R9 R9 K17 ["PopoverContent"]
       47 CALL                             R8 1 1
       48 GETIMPORT                        R9 K6 [require]
       50 GETTABLEKS                       R10 R0 K18 ["Hooks"]
       52 GETTABLEKS                       R10 R10 K19 ["useMouseOver"]
       54 CALL                             R9 1 1
       55 GETIMPORT                        R10 K6 [require]
       57 GETTABLEKS                       R11 R0 K15 ["Components"]
       59 GETTABLEKS                       R11 R11 K16 ["Popover"]
       61 GETTABLEKS                       R11 R11 K20 ["getPosition"]
       63 CALL                             R10 1 1
       64 GETIMPORT                        R11 K6 [require]
       66 GETTABLEKS                       R12 R0 K15 ["Components"]
       68 GETTABLEKS                       R12 R12 K16 ["Popover"]
       70 GETTABLEKS                       R12 R12 K21 ["PopoverDelayGroup"]
       72 CALL                             R11 1 1
       73 GETTABLEKS                       R12 R11 K22 ["useDelayGroup"]
       75 GETIMPORT                        R13 K6 [require]
       77 GETIMPORT                        R14 K1 [script]
       79 GETTABLEKS                       R14 R14 K4 ["Parent"]
       81 GETTABLEKS                       R14 R14 K23 ["useShowDelayed"]
       83 CALL                             R13 1 1
       84 GETIMPORT                        R14 K6 [require]
       86 GETIMPORT                        R15 K1 [script]
       88 GETTABLEKS                       R15 R15 K4 ["Parent"]
       90 GETTABLEKS                       R15 R15 K24 ["TooltipContent"]
       92 CALL                             R14 1 1
       93 GETIMPORT                        R15 K6 [require]
       95 GETTABLEKS                       R16 R0 K25 ["Panels"]
       97 GETTABLEKS                       R16 R16 K26 ["PanelsContext"]
       99 CALL                             R15 1 1
      100 GETIMPORT                        R16 K6 [require]
      102 GETTABLEKS                       R17 R0 K25 ["Panels"]
      104 GETTABLEKS                       R17 R17 K27 ["usePanel"]
      106 CALL                             R16 1 1
      107 GETIMPORT                        R17 K6 [require]
      109 GETTABLEKS                       R18 R0 K15 ["Components"]
      111 GETTABLEKS                       R18 R18 K16 ["Popover"]
      113 GETTABLEKS                       R18 R18 K28 ["useAsyncOnAbsoluteSizeChanged"]
      115 CALL                             R17 1 1
