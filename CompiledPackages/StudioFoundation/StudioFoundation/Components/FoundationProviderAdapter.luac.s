...
MAIN:
  ...
  GETTABLEKS R9 R10 K15 ["getFFlagStudioFoundationThemeContext"]
  CALL R8 1 1
  CALL R8 0 1
  GETIMPORT R9 K6 [require]
  GETTABLEKS R11 R0 K16 ["Hooks"]
  GETTABLEKS R10 R11 K17 ["useThemeName"]
  CALL R9 1 1
  GETIMPORT R10 K6 [require]
  GETTABLEKS R12 R0 K18 ["Contexts"]
  GETTABLEKS R11 R12 K19 ["StudioThemeContextProvider"]
  CALL R10 1 1
  GETIMPORT R11 K6 [require]
  GETTABLEKS R13 R0 K18 ["Contexts"]
  GETTABLEKS R12 R13 K20 ["ThemeContext"]
  CALL R11 1 1
  GETIMPORT R12 K6 [require]
  GETTABLEKS R13 R0 K21 ["Types"]
  CALL R12 1 1
  GETTABLEKS R13 R3 K22 ["ContextServices"]
  GETIMPORT R14 K6 [require]
  GETTABLEKS R16 R0 K23 ["Util"]
  GETTABLEKS R15 R16 K24 ["isStyleSheetPolyfillOn"]
  CALL R14 1 1
  CALL R14 0 1
  GETIMPORT R15 K26 [game]
  LOADK R17 K27 ["DebugDeveloperFrameworkSdk"]
  NAMECALL R15 R15 K28 ["GetFastFlag"]
  CALL R15 2 1
  JUMPIFNOT R14 [+8]
  JUMPIFNOT R15 [+7]
  GETIMPORT R16 K30 [warn]
  LOADK R17 K31 ["Your foundation code is running with Foundation styles polyfill. useStyleTag won't work.
		...
		"]
  GETIMPORT R18 K34 [debug.traceback]
  CALL R18 0 -1
  CALL R16 -1 0
