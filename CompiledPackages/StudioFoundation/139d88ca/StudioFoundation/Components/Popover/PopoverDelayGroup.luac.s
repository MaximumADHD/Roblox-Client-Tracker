...
PROTO_2:
       ...
       35 CALL                             R4 2 1
       36 GETUPVAL                         R5 0
       37 GETTABLEKS                       R5 R5 K4 ["createElement"]
       39 GETUPVAL                         R6 1
       40 GETTABLEKS                       R6 R6 K5 ["Provider"]
...
PROTO_6:
       ...
       24 RETURN                           R0 0
       25 GETUPVAL                         R1 7
       26 GETTABLEKS                       R1 R1 K2 ["timeout"]
       28 LOADN                            R2 0
       29 JUMPIFNOTLT                      R2 R1 ; [+11]
       31 GETIMPORT                        R1 K5 [task.delay]
       33 GETUPVAL                         R2 7
       34 GETTABLEKS                       R2 R2 K2 ["timeout"]
       36 MOVE                             R3 R0
       37 CALL                             R1 2 1
       38 NEWCLOSURE                       R2 P1
       39 CAPTURE                          VAL R1
       40 RETURN                           R2 1
       41 GETUPVAL                         R1 6
       42 GETTABLEKS                       R1 R1 K1 ["current"]
       44 GETUPVAL                         R2 4
       45 JUMPIFEQ                         R1 R2 ; [+2]
       47 RETURN                           R0 0
       48 GETUPVAL                         R1 1
...
PROTO_7:
       ...
       14 GETUPVAL                         R5 0
       15 GETTABLEKS                       R5 R5 K4 ["useContext"]
       17 GETUPVAL                         R6 1
       18 CALL                             R5 1 1
       19 GETTABLEKS                       R6 R5 K5 ["currentIdRef"]
       21 GETTABLEKS                       R7 R5 K6 ["setCurrentId"]
       23 GETUPVAL                         R8 0
       24 GETTABLEKS                       R8 R8 K7 ["useLayoutEffect"]
       26 NEWCLOSURE                       R9 P0
       27 CAPTURE                          VAL R1
       28 CAPTURE                          VAL R7
       29 CAPTURE                          UPVAL U2
...
MAIN:
       ...
       26 DUPTABLE                         R6 K15 [{["timeout"] = 0, ["currentIdRef"], ["setCurrentId"]}]
       27 GETTABLEKS                       R7 R2 K16 ["createRef"]
       29 CALL                             R7 0 1
       30 SETTABLEKS                       R7 R6 K13 ["currentIdRef"]
       32 GETTABLEKS                       R7 R3 K17 ["noop"]
       34 SETTABLEKS                       R7 R6 K14 ["setCurrentId"]
       36 CALL                             R5 1 1
       37 DUPCLOSURE                       R6 K18 [PROTO_2]
       38 CAPTURE                          VAL R2
       39 CAPTURE                          VAL R5
       40 DUPCLOSURE                       R7 K19 [PROTO_3]
       41 CAPTURE                          VAL R2
       42 CAPTURE                          VAL R5
       43 DUPCLOSURE                       R8 K20 [PROTO_7]
       44 CAPTURE                          VAL R2
       45 CAPTURE                          VAL R5
       46 CAPTURE                          VAL R3
       47 DUPTABLE                         R9 K24 [{"PopoverDelayGroup", "useDelayGroup", "useDelayGroupContext"}]
       48 SETTABLEKS                       R6 R9 K21 ["PopoverDelayGroup"]
       50 SETTABLEKS                       R8 R9 K22 ["useDelayGroup"]
       52 SETTABLEKS                       R7 R9 K23 ["useDelayGroupContext"]
       54 RETURN                           R9 1
