...
PROTO_1:
        ...
        2 MOVE                             R4 R1
        3 DUPTABLE                         R5 K13 [{["Id"], ["InitialEnabled"] = False, ["MinSize"], ["Modal"] = False, ["Tooltip"] = True, ["Resizable"] = True, ["Size"], ["Title"] = "Tooltip", ["ZIndex"] = 100}]
        4 SETTABLEKS                       R1 R5 K1 ["Id"]
        6 GETIMPORT                        R6 K16 [Vector2.new]
        8 LOADN                            R7 50
        9 LOADN                            R8 50
       10 CALL                             R6 2 1
       11 SETTABLEKS                       R6 R5 K4 ["MinSize"]
       13 GETIMPORT                        R6 K16 [Vector2.new]
       15 LOADN                            R7 220
       16 LOADN                            R8 224
       17 CALL                             R6 2 1
       18 SETTABLEKS                       R6 R5 K9 ["Size"]
       20 NAMECALL                         R2 R2 K17 ["CreateQWidgetPluginGui"]
       22 CALL                             R2 3 1
       23 GETIMPORT                        R3 K21 [Enum.ZIndexBehavior.Sibling]
       25 SETTABLEKS                       R3 R2 K19 ["ZIndexBehavior"]
       27 MOVE                             R3 R2
       28 GETUPVAL                         R4 0
       29 GETTABLEKS                       R4 R4 K22 ["join"]
       31 GETTABLEKS                       R5 R0 K23 ["_pluginUri"]
       33 DUPTABLE                         R6 K27 [{["Category"] = "Panels", ["ItemId"]}]
       34 SETTABLEKS                       R1 R6 K26 ["ItemId"]
       36 CALL                             R4 2 -1
       37 RETURN                           R3 -1
...
PROTO_2:
       ...
       31 JUMPIFNOT                        R2 ; [+7]
       32 LOADK                            R1 K7 ["/%*"]
       33 GETTABLEKS                       R3 R0 K6 ["_uriScope"]
       35 NAMECALL                         R1 R1 K8 ["format"]
       37 CALL                             R1 2 1
       38 JUMP                             ; [+1]
       39 LOADK                            R1 K9 [""]
       40 LOADK                            R2 K10 ["Tooltip_%*%*"]
       41 GETIMPORT                        R4 K13 [math.random]
       43 CALL                             R4 0 1
       44 MOVE                             R5 R1
       45 NAMECALL                         R2 R2 K8 ["format"]
       47 CALL                             R2 3 1
       48 MOVE                             R5 R2
       49 NAMECALL                         R3 R0 K14 ["_createTooltipPanelAsync"]
       51 CALL                             R3 2 2
       52 SETTABLEKS                       R3 R0 K0 ["_panel"]
       54 SETTABLEKS                       R4 R0 K1 ["_panelUri"]
       56 LOADB                            R5 0
       57 SETTABLEKS                       R5 R0 K2 ["_creating"]
       59 RETURN                           R3 2

PROTO_3:
        0 GETUPVAL                         R1 0
        1 GETUPVAL                         R2 1
        2 GETTABLEKS                       R2 R2 K0 ["_currentToken"]
        4 JUMPIFEQ                         R1 R2 ; [+2]
        6 LOADB                            R0 0 +1
        7 LOADB                            R0 1
        8 RETURN                           R0 1
...
PROTO_4:
        0 GETUPVAL                         R2 0
        1 GETUPVAL                         R3 1
        2 GETTABLEKS                       R3 R3 K0 ["_currentToken"]
        4 JUMPIFEQ                         R2 R3 ; [+2]
        6 LOADB                            R1 0 +1
        7 LOADB                            R1 1
        8 JUMPIFNOT                        R1 ; [+4]
        9 GETUPVAL                         R1 1
       10 GETTABLEKS                       R1 R1 K1 ["_panelUri"]
       12 JUMPIF                           R1 ; [+1]
       13 RETURN                           R0 0
       14 GETUPVAL                         R1 1
       15 GETTABLEKS                       R1 R1 K2 ["_panels"]
       17 GETUPVAL                         R3 1
       18 GETTABLEKS                       R3 R3 K1 ["_panelUri"]
       20 MOVE                             R4 R0
...
PROTO_5:
       ...
       17 GETUPVAL                         R3 1
       18 GETTABLEKS                       R3 R3 K1 ["_panelUri"]
       20 DUPTABLE                         R4 K9 [{["TargetWidgetUri"], ["TargetAnchorPoint"], ["SubjectAnchorPoint"], ["Offset"], ["AutoHide"] = True}]
       21 GETTABLEKS                       R5 R0 K10 ["targetWidgetUri"]
       23 SETTABLEKS                       R5 R4 K3 ["TargetWidgetUri"]
       25 GETTABLEKS                       R5 R0 K11 ["targetAnchorPoint"]
       27 SETTABLEKS                       R5 R4 K4 ["TargetAnchorPoint"]
       29 GETTABLEKS                       R5 R0 K12 ["subjectAnchorPoint"]
       31 SETTABLEKS                       R5 R4 K5 ["SubjectAnchorPoint"]
       33 GETTABLEKS                       R5 R0 K13 ["offset"]
       35 SETTABLEKS                       R5 R4 K6 ["Offset"]
       37 NAMECALL                         R1 R1 K14 ["SetAttachmentAsync"]
       39 CALL                             R1 3 0
       40 RETURN                           R0 0
...
PROTO_6:
        ...
        8 JUMPIFNOT                        R0 ; [+4]
        9 GETUPVAL                         R0 1
       10 GETTABLEKS                       R0 R0 K1 ["_panel"]
       12 JUMPIF                           R0 ; [+1]
       13 RETURN                           R0 0
       14 GETUPVAL                         R0 1
       15 GETTABLEKS                       R0 R0 K1 ["_panel"]
       17 LOADB                            R1 0
...
PROTO_7:
       ...
       12 MOVE                             R7 R3
       13 DUPTABLE                         R8 K10 [{["TargetWidgetUri"], ["TargetAnchorPoint"], ["SubjectAnchorPoint"], ["Offset"], ["AutoHide"] = True}]
       14 GETTABLEKS                       R9 R1 K11 ["targetWidgetUri"]
       16 SETTABLEKS                       R9 R8 K4 ["TargetWidgetUri"]
       18 GETTABLEKS                       R9 R1 K12 ["targetAnchorPoint"]
       20 SETTABLEKS                       R9 R8 K5 ["TargetAnchorPoint"]
       22 GETTABLEKS                       R9 R1 K13 ["subjectAnchorPoint"]
       24 SETTABLEKS                       R9 R8 K6 ["SubjectAnchorPoint"]
       26 GETTABLEKS                       R9 R1 K14 ["offset"]
       28 SETTABLEKS                       R9 R8 K7 ["Offset"]
       30 NAMECALL                         R5 R5 K15 ["SetAttachmentAsync"]
       32 CALL                             R5 3 0
       33 GETTABLEKS                       R5 R0 K3 ["_panels"]
       35 MOVE                             R7 R3
       36 NAMECALL                         R5 R5 K16 ["ShowIfAttachedAsync"]
       38 CALL                             R5 2 0
       39 NEWCLOSURE                       R5 P0
       40 CAPTURE                          VAL R4
       41 CAPTURE                          VAL R0
       42 DUPTABLE                         R6 K21 [{"container", "setSizeAsync", "updateAsync", "close"}]
       43 SETTABLEKS                       R2 R6 K17 ["container"]
       45 NEWCLOSURE                       R7 P1
       46 CAPTURE                          VAL R4
       47 CAPTURE                          VAL R0
       48 SETTABLEKS                       R7 R6 K18 ["setSizeAsync"]
       50 NEWCLOSURE                       R7 P2
       51 CAPTURE                          VAL R4
       52 CAPTURE                          VAL R0
       53 SETTABLEKS                       R7 R6 K19 ["updateAsync"]
       55 NEWCLOSURE                       R7 P3
       56 CAPTURE                          VAL R4
       57 CAPTURE                          VAL R0
       58 SETTABLEKS                       R7 R6 K20 ["close"]
       60 RETURN                           R6 1
...
MAIN:
       ...
       11 GETTABLEKS                       R2 R2 K7 ["StudioUri"]
       13 CALL                             R1 1 1
