...
PROTO_13:
       ...
       14 LOADK                            R5 K8 ["DialogStory%*"]
       15 GETUPVAL                         R7 2
       16 NAMECALL                         R5 R5 K9 ["format"]
       18 CALL                             R5 2 1
       19 SETTABLEKS                       R5 R4 K6 ["ItemId"]
       21 CALL                             R2 2 1
       22 GETUPVAL                         R3 1
       23 GETTABLEKS                       R3 R3 K2 ["join"]
       25 MOVE                             R4 R2
       26 DUPTABLE                         R5 K11 [{["Category"] = "Widgets"}]
       27 CALL                             R3 2 1
       28 GETUPVAL                         R4 3
       29 GETUPVAL                         R5 4
       30 DUPTABLE                         R6 K22 [{["uri"], ["type"], ["title"] = "Dialog Title", ["description"] = "This is a description for the dialog. It provides more details about the purpose of the dialog.", ["primaryAction"], ["secondaryAction"], ["tertiaryAction"], ["autoClose"]}]
       31 SETTABLEKS                       R2 R6 K12 ["uri"]
       33 GETUPVAL                         R7 2
       34 SETTABLEKS                       R7 R6 K13 ["type"]
       36 DUPTABLE                         R7 K26 [{["uri"], ["text"] = "Primary", ["onActivated"]}]
       37 GETUPVAL                         R8 1
       38 GETTABLEKS                       R8 R8 K27 ["child"]
       40 MOVE                             R9 R3
       41 LOADK                            R10 K24 ["Primary"]
       42 CALL                             R8 2 1
       43 SETTABLEKS                       R8 R7 K12 ["uri"]
       45 DUPCLOSURE                       R8 K28 [PROTO_10]
       46 SETTABLEKS                       R8 R7 K25 ["onActivated"]
       48 SETTABLEKS                       R7 R6 K18 ["primaryAction"]
       50 DUPTABLE                         R7 K30 [{["uri"], ["text"] = "Secondary", ["onActivated"]}]
       51 GETUPVAL                         R8 1
       52 GETTABLEKS                       R8 R8 K27 ["child"]
       54 MOVE                             R9 R3
       55 LOADK                            R10 K29 ["Secondary"]
       56 CALL                             R8 2 1
       57 SETTABLEKS                       R8 R7 K12 ["uri"]
       59 DUPCLOSURE                       R8 K31 [PROTO_11]
       60 SETTABLEKS                       R8 R7 K25 ["onActivated"]
       62 SETTABLEKS                       R7 R6 K19 ["secondaryAction"]
       64 DUPTABLE                         R7 K33 [{["uri"], ["text"] = "Tertiary", ["onActivated"]}]
       65 GETUPVAL                         R8 1
       66 GETTABLEKS                       R8 R8 K27 ["child"]
       68 MOVE                             R9 R3
       69 LOADK                            R10 K32 ["Tertiary"]
       70 CALL                             R8 2 1
       71 SETTABLEKS                       R8 R7 K12 ["uri"]
       73 DUPCLOSURE                       R8 K34 [PROTO_12]
       74 SETTABLEKS                       R8 R7 K25 ["onActivated"]
       76 SETTABLEKS                       R7 R6 K20 ["tertiaryAction"]
       78 GETTABLEKS                       R7 R0 K35 ["controls"]
       80 GETTABLEKS                       R7 R7 K21 ["autoClose"]
       82 SETTABLEKS                       R7 R6 K21 ["autoClose"]
       84 CALL                             R4 2 -1
       85 RETURN                           R4 -1
