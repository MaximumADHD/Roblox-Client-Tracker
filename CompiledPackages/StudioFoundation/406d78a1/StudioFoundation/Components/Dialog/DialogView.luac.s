...
PROTO_9:
       ...
       77 DUPTABLE                         R14 K15 [{["tag"] = "component-dialog-view col flex-y-between gap-small auto-y padding-x-large padding-y-medium bg-surface-200", ["onAbsoluteSizeChanged"], ["testId"] = "--dialog", ["Size"]}]
       ...
       96 DUPTABLE                         R18 K26 [{["tag"] = "row flex-x-between items-start gap-medium size-full-0 auto-y padding-bottom-medium", ["LayoutOrder"]}]
       97 MOVE                             R19 R1
       98 CALL                             R19 0 1
      ...
      186 DUPTABLE                         R22 K55 [{["tag"] = "col fill gap-medium auto-y", ["LayoutOrder"]}]
      187 MOVE                             R23 R1
      188 CALL                             R23 0 1
      ...
      196 DUPTABLE                         R26 K63 [{["tag"] = "size-full-0 auto-y text-title-medium text-wrap text-align-x-left text-align-y-center", ["Text"], ["Visible"], ["LayoutOrder"], ["testId"] = "--dialog-title"}]
      ...
      212 DUPTABLE                         R26 K66 [{["tag"] = "grow size-full-0 auto-y text-body-small text-wrap text-align-x-left text-align-y-top", ["Text"], ["Visible"], ["LayoutOrder"], ["testId"] = "--dialog-description"}]
