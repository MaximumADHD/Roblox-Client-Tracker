...
game:DefineFastFlag("StudioAudioDiscoveryPluginV4", false)
game:DefineFastFlag("StudioAudioDiscoveryPluginV5", false)
game:DefineFastFlag("StudioAudioDiscoveryPluginV6", false)
