return function()
	...
	describe("RemoveRangeFromList", function()
		...
		it("should remove elements properly from the first list", function()
			local a = {1, 2, 3}
			local b = Immutable.RemoveRangeFromList(a, 2, 1)
		...
		it("should remove elements properly from the second list", function()
			local a = {1, 2, 3, 4, 5, 6}
		...
		it("should remove elements properly from the third list", function()
			local a = {1, 2, 3, 4, 5, 6}
		...
		it("should remove elements properly from the fourth list", function()
