...
PROTO_1:
       ...
       24 GETTABLEKS                       R3 R3 K6 ["focusGui"]
       26 JUMPIF                           R3 ; [+4]
       27 GETIMPORT                        R3 K8 [Instance.new]
       29 LOADK                            R4 K9 ["ScreenGui"]
       30 CALL                             R3 1 1
       31 GETTABLEKS                       R4 R0 K0 ["props"]
       33 GETTABLEKS                       R4 R4 K10 ["storeState"]
       35 GETUPVAL                         R5 2
       36 GETTABLEKS                       R5 R5 K11 ["Store"]
       38 GETTABLEKS                       R5 R5 K5 ["new"]
       40 GETUPVAL                         R6 3
       41 CALL                             R6 0 1
       42 MOVE                             R7 R4
       43 NEWTABLE                         R8 0 1
       45 GETUPVAL                         R9 2
       46 GETTABLEKS                       R9 R9 K12 ["thunkMiddleware"]
       48 SETLIST                          R8 R9 1 [1]
       50 CALL                             R5 3 1
       51 GETUPVAL                         R6 4
       52 GETTABLEKS                       R6 R6 K13 ["Networking"]
       54 GETTABLEKS                       R6 R6 K3 ["mock"]
       56 CALL                             R6 0 1
       57 GETUPVAL                         R7 0
       58 GETTABLEKS                       R7 R7 K14 ["provide"]
       60 NEWTABLE                         R8 0 7
       62 GETUPVAL                         R9 0
       63 GETTABLEKS                       R9 R9 K15 ["Plugin"]
       65 GETTABLEKS                       R9 R9 K5 ["new"]
       67 MOVE                             R10 R2
       68 CALL                             R9 1 1
       69 GETUPVAL                         R10 0
       70 GETTABLEKS                       R10 R10 K16 ["Focus"]
       72 GETTABLEKS                       R10 R10 K5 ["new"]
       74 MOVE                             R11 R3
       75 CALL                             R10 1 1
       76 GETUPVAL                         R11 5
       77 CALL                             R11 0 1
       78 MOVE                             R12 R1
       79 GETUPVAL                         R13 0
       80 GETTABLEKS                       R13 R13 K11 ["Store"]
       82 GETTABLEKS                       R13 R13 K5 ["new"]
       84 MOVE                             R14 R5
       85 CALL                             R13 1 1
       86 GETUPVAL                         R14 6
       87 GETTABLEKS                       R14 R14 K5 ["new"]
       89 MOVE                             R15 R6
       90 CALL                             R14 1 1
       91 GETUPVAL                         R15 0
       92 GETTABLEKS                       R15 R15 K17 ["Mouse"]
       94 GETTABLEKS                       R15 R15 K5 ["new"]
      ...
      104 GETUPVAL                         R11 7
      105 GETTABLEKS                       R11 R11 K19 ["Children"]
...
MAIN:
       ...
       29 GETTABLEKS                       R4 R4 K10 ["createMainReducer"]
       31 CALL                             R3 1 1
       32 GETIMPORT                        R4 K4 [require]
       34 GETTABLEKS                       R5 R0 K5 ["Packages"]
       36 GETTABLEKS                       R5 R5 K11 ["Http"]
       38 CALL                             R4 1 1
       39 GETIMPORT                        R5 K4 [require]
       41 GETTABLEKS                       R6 R0 K8 ["Src"]
       43 GETTABLEKS                       R6 R6 K12 ["ContextServices"]
       45 GETTABLEKS                       R6 R6 K13 ["NetworkingContext"]
       47 CALL                             R5 1 1
       48 GETIMPORT                        R6 K4 [require]
       50 GETTABLEKS                       R7 R0 K8 ["Src"]
       52 GETTABLEKS                       R7 R7 K14 ["Resources"]
       54 GETTABLEKS                       R7 R7 K15 ["MakeTheme"]
       56 CALL                             R6 1 1
       57 GETIMPORT                        R7 K4 [require]
       59 GETTABLEKS                       R8 R0 K5 ["Packages"]
       61 GETTABLEKS                       R8 R8 K16 ["Framework"]
       63 CALL                             R7 1 1
       64 GETTABLEKS                       R8 R7 K17 ["TestHelpers"]
       66 GETTABLEKS                       R8 R8 K18 ["Instances"]
       68 GETTABLEKS                       R8 R8 K19 ["MockPlugin"]
