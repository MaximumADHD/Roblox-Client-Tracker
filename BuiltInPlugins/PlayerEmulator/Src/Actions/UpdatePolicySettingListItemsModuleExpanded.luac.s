PROTO_0:
  ...
  LOADK R3 K3 ["Expected policyListItemsModuleExpanded to be a bool"]
  GETIMPORT R1 K5 [assert]
  CALL R1 2 0
  DUPTABLE R1 K7 [{"policyListItemsModuleExpanded"}]
  SETTABLEKS R0 R1 K6 ["policyListItemsModuleExpanded"]
  RETURN R1 1
