...
PROTO_1:
  ...
  DUPTABLE R2 K8 [{"GetClientId", "GetSessionId"}]
  GETTABLEKS R3 R1 K9 ["fn"]
  CALL R3 0 1
  SETTABLEKS R3 R2 K6 ["GetClientId"]
  GETTABLEKS R3 R1 K9 ["fn"]
  CALL R3 0 1
  SETTABLEKS R3 R2 K7 ["GetSessionId"]
  RETURN R2 1
...
MAIN:
  ...
  CALL R0 2 1
  NEWTABLE R1 4 0
  LOADK R2 K4 ["RbxAnalyticsService"]
