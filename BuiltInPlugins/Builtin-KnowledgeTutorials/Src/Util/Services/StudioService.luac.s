...
PROTO_1:
  ...
  DUPTABLE R2 K10 [{"GetClassIcon", "GetUserId", "PromptImportFile", "PromptImportFiles"}]
  GETTABLEKS R3 R1 K11 ["fn"]
  CALL R3 0 1
  SETTABLEKS R3 R2 K6 ["GetClassIcon"]
  GETTABLEKS R3 R1 K11 ["fn"]
  CALL R3 0 1
  SETTABLEKS R3 R2 K7 ["GetUserId"]
  GETTABLEKS R3 R1 K11 ["fn"]
  CALL R3 0 1
  SETTABLEKS R3 R2 K8 ["PromptImportFile"]
  GETTABLEKS R3 R1 K11 ["fn"]
  CALL R3 0 1
  SETTABLEKS R3 R2 K9 ["PromptImportFiles"]
  RETURN R2 1
