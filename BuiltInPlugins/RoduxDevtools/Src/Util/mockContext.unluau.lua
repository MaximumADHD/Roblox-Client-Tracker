...
local var4 = {}
local var167 = var3.Analytics.mock()
local var6 = var3.Localization.mock()
local var173 = require(var0.Packages.Rodux).Store
var173 = require(var0.Src.Reducers.MainReducer)
local var7 = var3.Store.new(var173.new(var173, nil, nil, nil))
