PROTO_0:
       ...
       11 LOADK                            R4 K5 ["Expected searchTerm to be a string, received %s"]
       12 FASTCALL1                        TYPE R0 ; [+3]
       13 MOVE                             R6 R0
       14 GETIMPORT                        R5 K7 [type]
       16 CALL                             R5 1 1
       17 CALL                             R3 2 -1
       18 FASTCALL                         ASSERT ; [+2]
       19 GETIMPORT                        R1 K9 [assert]
       21 CALL                             R1 -1 0
       22 DUPTABLE                         R1 K11 [{"searchTerm"}]
       23 SETTABLEKS                       R0 R1 K10 ["searchTerm"]
       25 RETURN                           R1 1
