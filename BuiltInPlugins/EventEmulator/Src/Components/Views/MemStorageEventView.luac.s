...
PROTO_2:
        ...
        3 GETTABLEKS                       R2 R2 K1 ["SetMemStoragePair"]
        5 NEWTABLE                         R3 1 0
        7 SETTABLE                         R1 R3 R0
        8 CALL                             R2 1 0
        9 RETURN                           R0 0
...
PROTO_3:
        ...
        3 GETTABLEKS                       R0 R0 K1 ["SetMemStoragePair"]
        5 GETUPVAL                         R1 1
        6 CALL                             R0 1 0
        7 RETURN                           R0 0
...
PROTO_4:
       ...
       13 GETTABLEKS                       R2 R2 K3 ["KeyValuePair"]
       15 CALL                             R0 2 0
       16 RETURN                           R0 0
...
PROTO_5:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["props"]
        3 GETTABLEKS                       R0 R0 K1 ["KeyValuePair"]
        5 GETTABLEKS                       R0 R0 K2 ["Key"]
        7 GETUPVAL                         R1 0
        8 GETTABLEKS                       R1 R1 K0 ["props"]
       10 GETTABLEKS                       R1 R1 K1 ["KeyValuePair"]
       12 GETTABLEKS                       R1 R1 K3 ["Value"]
       14 GETUPVAL                         R3 0
       15 GETTABLEKS                       R3 R3 K5 ["state"]
       17 GETTABLEKS                       R3 R3 K6 ["SelectedRoute"]
       19 ORK                              R2 R3 K4 [""]
       20 GETUPVAL                         R3 1
       21 GETTABLEKS                       R3 R3 K7 ["GetValue"]
       23 JUMPIFNOTEQ                      R2 R3 ; [+6]
       25 GETUPVAL                         R3 2
       26 GETTABLEKS                       R3 R3 K7 ["GetValue"]
       28 MOVE                             R4 R0
       29 CALL                             R3 1 0
       30 GETUPVAL                         R3 1
       31 GETTABLEKS                       R3 R3 K8 ["SetValue"]
       33 JUMPIFNOTEQ                      R2 R3 ; [+12]
       35 GETUPVAL                         R3 2
       36 GETTABLEKS                       R3 R3 K8 ["SetValue"]
       38 MOVE                             R4 R0
       39 MOVE                             R5 R1
       40 CALL                             R3 2 1
       41 JUMPIFNOT                        R3 ; [+4]
       ...
       45 CALL                             R4 1 0
       46 GETUPVAL                         R3 1
       47 GETTABLEKS                       R3 R3 K11 ["NewEntry"]
       49 JUMPIFNOTEQ                      R2 R3 ; [+12]
       51 GETUPVAL                         R3 2
       52 GETTABLEKS                       R3 R3 K8 ["SetValue"]
       54 MOVE                             R4 R0
       55 MOVE                             R5 R1
       56 CALL                             R3 2 1
       57 JUMPIFNOT                        R3 ; [+4]
...
PROTO_6:
        ...
        1 GETUPVAL                         R2 0
        2 GETTABLEKS                       R2 R2 K2 ["GetValue"]
...
PROTO_7:
        0 PREPVARARGS                      0
        1 GETUPVAL                         R0 0
        2 GETTABLEKS                       R0 R0 K0 ["OnChange"]
        4 LOADK                            R1 K1 ["Key"]
        5 GETVARARGS                       R2 -1
        6 CALL                             R0 -1 0
        7 RETURN                           R0 0
...
PROTO_9:
       ...
       51 GETUPVAL                         R12 4
       52 GETTABLEKS                       R12 R12 K25 ["GetValue"]
       54 SETTABLEKS                       R12 R11 K21 ["SelectedKey"]
       56 GETUPVAL                         R12 5
       57 GETTABLEKS                       R12 R12 K12 ["Switch"]
...
PROTO_10:
        ...
        3 GETTABLEKS                       R3 R3 K4 ["MemStoragePair"]
...
MAIN:
       ...
       52 GETTABLEKS                       R9 R9 K15 ["Actions"]
       ...
       68 GETTABLEKS                       R13 R13 K18 ["Util"]
       70 GETTABLEKS                       R13 R13 K19 ["Constants"]
       72 CALL                             R12 1 1
       73 GETTABLEKS                       R13 R12 K20 ["MEM_STORAGE_ORDER"]
       75 GETTABLEKS                       R14 R12 K21 ["INPUT_PANE_LAYOUT"]
       77 GETTABLEKS                       R15 R12 K22 ["ROUTES"]
       79 GETTABLEKS                       R15 R15 K23 ["MemStorage"]
       81 GETTABLEKS                       R16 R12 K24 ["OPERATION_SUCCESSFUL"]
       83 GETTABLEKS                       R17 R12 K25 ["VIEW_ID"]
       85 GETTABLEKS                       R17 R17 K23 ["MemStorage"]
       87 GETTABLEKS                       R18 R3 K26 ["UI"]
       89 GETTABLEKS                       R19 R18 K27 ["RadioButtonList"]
       91 GETTABLEKS                       R20 R18 K28 ["Pane"]
       93 GETTABLEKS                       R21 R0 K11 ["Src"]
       95 GETTABLEKS                       R21 R21 K29 ["Operations"]
