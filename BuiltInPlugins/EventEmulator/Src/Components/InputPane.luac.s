PROTO_0:
        ...
        5 LOADK                            R2 K2 ["Frame"]
        6 GETUPVAL                         R3 1
        7 GETTABLEKS                       R3 R3 K3 ["RBXEvent"]
        9 JUMPIFNOTEQ                      R1 R3 ; [+2]
       11 GETUPVAL                         R2 2
       12 GETUPVAL                         R3 1
       13 GETTABLEKS                       R3 R3 K4 ["Theme"]
       15 JUMPIFNOTEQ                      R1 R3 ; [+2]
       17 GETUPVAL                         R2 3
       18 GETUPVAL                         R3 1
       19 GETTABLEKS                       R3 R3 K5 ["MemStorage"]
...
PROTO_2:
        ...
        6 GETTABLEKS                       R4 R2 K3 ["Layout"]
        8 GETTABLEKS                       R4 R4 K4 ["Vertical"]
       10 GETUPVAL                         R5 0
       11 GETTABLEKS                       R5 R5 K5 ["createElement"]
       13 GETUPVAL                         R6 1
       ...
       28 GETUPVAL                         R8 3
       29 GETTABLEKS                       R8 R8 K14 ["InputPane"]
...
MAIN:
       ...
       42 GETTABLEKS                       R9 R9 K15 ["Components"]
       ...
       56 GETTABLEKS                       R13 R9 K18 ["Views"]
       58 GETTABLEKS                       R13 R13 K19 ["RBXEventView"]
       60 CALL                             R12 1 1
       61 GETIMPORT                        R13 K4 [require]
       63 GETTABLEKS                       R14 R9 K18 ["Views"]
       65 GETTABLEKS                       R14 R14 K20 ["ThemeView"]
       67 CALL                             R13 1 1
       68 GETIMPORT                        R14 K4 [require]
       70 GETTABLEKS                       R15 R9 K18 ["Views"]
       72 GETTABLEKS                       R15 R15 K21 ["MemStorageEventView"]
       74 CALL                             R14 1 1
       75 GETIMPORT                        R15 K4 [require]
       77 GETTABLEKS                       R16 R0 K14 ["Src"]
       79 GETTABLEKS                       R16 R16 K22 ["Util"]
       81 GETTABLEKS                       R16 R16 K23 ["Constants"]
       83 CALL                             R15 1 1
