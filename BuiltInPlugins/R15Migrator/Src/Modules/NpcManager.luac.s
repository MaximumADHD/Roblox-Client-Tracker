...
MAIN:
  ...
  CAPTURE VAL R13
  CAPTURE VAL R12
  SETTABLEKS R36 R0 K108 ["getAdapterData"]
  DUPCLOSURE R36 K109 [PROTO_24]
  DUPCLOSURE R37 K110 [PROTO_25]
  SETTABLEKS R37 R0 K111 ["FindInstanceUnderNewModel"]
  DUPCLOSURE R37 K112 [PROTO_26]
  CAPTURE VAL R7
  CAPTURE VAL R10
  CAPTURE VAL R0
  SETTABLEKS R37 R0 K113 ["ReplaceModel"]
  DUPCLOSURE R37 K114 [PROTO_27]
  SETTABLEKS R37 R0 K115 ["FixRootAttachment"]
  DUPCLOSURE R37 K116 [PROTO_28]
  CAPTURE VAL R0
  SETTABLEKS R37 R0 K117 ["GetNumCharactersHaveWarnings"]
  DUPCLOSURE R37 K118 [PROTO_29]
  CAPTURE VAL R0
  SETTABLEKS R37 R0 K119 ["GetNpcHasWarnings"]
  DUPCLOSURE R37 K120 [PROTO_30]
  CAPTURE VAL R0
  SETTABLEKS R37 R0 K121 ["GetNumCharactersHaveCustomMesh"]
  DUPCLOSURE R37 K122 [PROTO_31]
  CAPTURE VAL R29
  CAPTURE VAL R23
  CAPTURE VAL R5
  CAPTURE VAL R6
  SETTABLEKS R37 R0 K123 ["GetNpcHasCustomMesh"]
  DUPCLOSURE R37 K124 [PROTO_34]
  CAPTURE VAL R21
  CAPTURE VAL R29
  CAPTURE VAL R24
  CAPTURE VAL R6
  ...
  CAPTURE VAL R0
  CAPTURE VAL R36
  SETTABLEKS R37 R0 K125 ["ConvertR6ToR15"]
  RETURN R0 1
