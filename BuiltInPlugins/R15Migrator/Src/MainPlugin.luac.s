...
PROTO_16:
  ...
  CAPTURE VAL R0
  CAPTURE UPVAL U6
  SETTABLEKS R2 R0 K10 ["onScriptAnalysisCallback"]
  NEWCLOSURE R2 P6
  CAPTURE VAL R0
  CAPTURE UPVAL U6
  SETTABLEKS R2 R0 K11 ["onScriptDestroyingCallback"]
  NEWCLOSURE R2 P7
  CAPTURE VAL R0
  ...
  GETUPVAL R3 13
  GETTABLEKS R2 R3 K14 ["new"]
  GETTABLEKS R3 R0 K11 ["onScriptDestroyingCallback"]
  CALL R2 1 1
  SETTABLEKS R2 R0 K26 ["scriptConversionContext"]
  GETUPVAL R3 14
  GETTABLEKS R2 R3 K14 ["new"]
  CALL R2 0 1
  SETTABLEKS R2 R0 K27 ["networkInterface"]
  GETTABLEKS R3 R1 K28 ["Plugin"]
  GETTABLEKS R2 R3 K29 ["Unloading"]
  NEWCLOSURE R4 P8
  CAPTURE VAL R0
  NAMECALL R2 R2 K30 ["Connect"]
  CALL R2 2 0
  GETUPVAL R2 0
  JUMPIFNOT R2 [+4]
  MOVE R4 R1
  NAMECALL R2 R0 K31 ["initToolbarAndButton"]
  CALL R2 2 0
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R17 R18 K27 ["SetDiagnostics"]
  CALL R16 1 1
  GETIMPORT R17 K11 [require]
  GETTABLEKS R20 R3 K12 ["Src"]
  GETTABLEKS R19 R20 K26 ["Actions"]
  GETTABLEKS R18 R19 K28 ["ResetConvertedCharacters"]
  CALL R17 1 1
  GETIMPORT R18 K11 [require]
  GETTABLEKS R21 R3 K12 ["Src"]
  GETTABLEKS R20 R21 K29 ["Components"]
  GETTABLEKS R19 R20 K30 ["MainView"]
  CALL R18 1 1
  GETIMPORT R19 K11 [require]
  GETTABLEKS R22 R3 K12 ["Src"]
  GETTABLEKS R21 R22 K29 ["Components"]
  GETTABLEKS R20 R21 K31 ["LoadingScreenPrompt"]
  CALL R19 1 1
  GETTABLEKS R21 R3 K12 ["Src"]
  GETTABLEKS R20 R21 K32 ["Contexts"]
  GETIMPORT R21 K11 [require]
  GETTABLEKS R22 R20 K33 ["ScriptConversionContext"]
  CALL R21 1 1
  GETIMPORT R22 K11 [require]
  GETTABLEKS R23 R20 K34 ["NetworkInterface"]
  CALL R22 1 1
  GETTABLEKS R24 R3 K12 ["Src"]
  GETTABLEKS R23 R24 K35 ["Thunks"]
  GETIMPORT R24 K11 [require]
  GETTABLEKS R25 R23 K36 ["OnDiagnosticsUpdated"]
  CALL R24 1 1
  GETIMPORT R25 K11 [require]
  GETTABLEKS R26 R23 K37 ["ScanAllAnimations"]
  CALL R25 1 1
  GETIMPORT R26 K11 [require]
  GETTABLEKS R30 R3 K12 ["Src"]
  GETTABLEKS R29 R30 K38 ["Util"]
  GETTABLEKS R28 R29 K39 ["ScriptAnalysis"]
  GETTABLEKS R27 R28 K40 ["ScriptScanner"]
  CALL R26 1 1
  GETIMPORT R27 K11 [require]
  GETTABLEKS R31 R3 K12 ["Src"]
  GETTABLEKS R30 R31 K38 ["Util"]
  GETTABLEKS R29 R30 K39 ["ScriptAnalysis"]
  GETTABLEKS R28 R29 K41 ["Constants"]
  CALL R27 1 1
  GETIMPORT R28 K11 [require]
  GETTABLEKS R31 R3 K12 ["Src"]
  GETTABLEKS R30 R31 K38 ["Util"]
  GETTABLEKS R29 R30 K42 ["AnalyticsGlobals"]
  CALL R28 1 1
  GETIMPORT R29 K11 [require]
  GETTABLEKS R32 R3 K12 ["Src"]
  GETTABLEKS R31 R32 K43 ["Reducers"]
  GETTABLEKS R30 R31 K44 ["MainReducer"]
  CALL R29 1 1
  GETIMPORT R30 K11 [require]
  GETTABLEKS R33 R3 K12 ["Src"]
  GETTABLEKS R32 R33 K45 ["Resources"]
  GETTABLEKS R31 R32 K46 ["MakeTheme"]
  CALL R30 1 1
  GETIMPORT R31 K11 [require]
  GETTABLEKS R34 R3 K12 ["Src"]
  GETTABLEKS R33 R34 K45 ["Resources"]
  GETTABLEKS R32 R33 K47 ["createAnalyticsHandlers"]
  CALL R31 1 1
  GETTABLEKS R35 R3 K12 ["Src"]
  GETTABLEKS R34 R35 K45 ["Resources"]
  GETTABLEKS R33 R34 K48 ["Localization"]
  GETTABLEKS R32 R33 K49 ["SourceStrings"]
  GETTABLEKS R36 R3 K12 ["Src"]
  GETTABLEKS R35 R36 K45 ["Resources"]
  GETTABLEKS R34 R35 K48 ["Localization"]
  GETTABLEKS R33 R34 K50 ["LocalizedStrings"]
  GETTABLEKS R34 R5 K51 ["PureComponent"]
  LOADK R36 K52 ["MainPlugin"]
  NAMECALL R34 R34 K53 ["extend"]
  CALL R34 2 1
  DUPCLOSURE R35 K54 [PROTO_0]
  SETTABLEKS R35 R34 K55 ["initToolbarAndButton"]
  DUPCLOSURE R35 K56 [PROTO_2]
  CAPTURE VAL R16
  CAPTURE VAL R17
  SETTABLEKS R35 R34 K57 ["setupFinalizedEvent"]
  DUPCLOSURE R35 K58 [PROTO_16]
  CAPTURE VAL R0
  CAPTURE VAL R2
  CAPTURE VAL R25
  CAPTURE VAL R28
  ...
  CAPTURE VAL R21
  CAPTURE VAL R22
  SETTABLEKS R35 R34 K59 ["init"]
  DUPCLOSURE R35 K60 [PROTO_17]
  CAPTURE VAL R0
  CAPTURE VAL R5
  CAPTURE VAL R10
  SETTABLEKS R35 R34 K61 ["renderButtons"]
  ...
  CAPTURE VAL R18
  CAPTURE VAL R19
  SETTABLEKS R35 R34 K63 ["render"]
  JUMPIFNOT R0 [+3]
  DUPCLOSURE R35 K64 [PROTO_20]
  SETTABLEKS R35 R34 K65 ["didUpdate"]
  RETURN R34 1
