...
PROTO_19:
  GETUPVAL R1 0
  GETTABLEKS R0 R1 K0 ["SuccessfullyPublishedDateTime"]
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K1 ["Plugin"]
  GETIMPORT R4 K3 [game]
  GETTABLEKS R3 R4 K4 ["GameId"]
  NAMECALL R0 R0 K5 ["getSetting"]
  CALL R0 3 1
  ...
  JUMPIF R3 [+3]
  GETUPVAL R4 2
  GETTABLEKS R3 R4 K6 ["isR15ConvertedExperience"]
  ...
  CALL R2 -1 0
  GETUPVAL R3 4
  GETTABLEKS R2 R3 K11 ["getAllTabsData"]
  GETUPVAL R4 2
...
PROTO_20:
  ...
  GETIMPORT R4 K3 [game]
  GETTABLEKS R3 R4 K4 ["GameId"]
  GETIMPORT R4 K7 [DateTime.now]
  CALL R4 0 1
  NAMECALL R4 R4 K8 ["ToIsoDate"]
  CALL R4 1 -1
  NAMECALL R0 R0 K9 ["setSetting"]
  CALL R0 -1 0
  GETUPVAL R0 2
  CALL R0 0 0
  RETURN R0 0
...
PROTO_22:
  ...
  CAPTURE VAL R0
  CAPTURE UPVAL U10
  SETTABLEKS R2 R0 K12 ["onScriptAnalysisCallback"]
  NEWCLOSURE R2 P7
  CAPTURE VAL R0
  CAPTURE UPVAL U10
  SETTABLEKS R2 R0 K13 ["onScriptDestroyingCallback"]
  NEWCLOSURE R2 P8
  CAPTURE VAL R0
  ...
  NEWTABLE R5 0 1
  GETUPVAL R7 11
  GETTABLEKS R6 R7 K17 ["thunkMiddleware"]
  SETLIST R5 R6 1 [1]
  LOADNIL R6
  CALL R2 4 1
  SETTABLEKS R2 R0 K18 ["store"]
  GETUPVAL R4 13
  GETTABLEKS R3 R4 K19 ["Localization"]
  GETTABLEKS R2 R3 K16 ["new"]
  DUPTABLE R3 K23 [{"stringResourceTable", "translationResourceTable", "pluginName"}]
  GETUPVAL R4 14
  SETTABLEKS R4 R3 K20 ["stringResourceTable"]
  GETUPVAL R4 15
  SETTABLEKS R4 R3 K21 ["translationResourceTable"]
  LOADK R4 K24 ["R15Migrator"]
  SETTABLEKS R4 R3 K22 ["pluginName"]
  CALL R2 1 1
  ...
  GETUPVAL R3 17
  GETTABLEKS R2 R3 K16 ["new"]
  GETTABLEKS R3 R0 K13 ["onScriptDestroyingCallback"]
  CALL R2 1 1
  SETTABLEKS R2 R0 K28 ["scriptConversionContext"]
  GETUPVAL R3 18
  GETTABLEKS R2 R3 K16 ["new"]
  CALL R2 0 1
  SETTABLEKS R2 R0 K29 ["networkInterface"]
  GETUPVAL R4 13
  GETTABLEKS R3 R4 K30 ["API"]
  GETTABLEKS R2 R3 K16 ["new"]
  CALL R2 0 1
  SETTABLEKS R2 R0 K31 ["api"]
  GETUPVAL R3 19
  GETTABLEKS R2 R3 K16 ["new"]
  GETUPVAL R4 20
  GETTABLEKS R3 R4 K32 ["CrossPluginCommunicationName"]
  CALL R2 1 1
  SETTABLEKS R2 R0 K33 ["communication"]
  GETTABLEKS R2 R0 K33 ["communication"]
  GETUPVAL R6 20
  GETTABLEKS R5 R6 K34 ["CrossPluginCommunicationInstructions"]
  GETTABLEKS R4 R5 K35 ["Open"]
  NEWCLOSURE R5 P9
  CAPTURE VAL R0
  ...
  CAPTURE UPVAL U28
  GETUPVAL R4 21
  GETTABLEKS R3 R4 K37 ["IsR15ConvertedExperience"]
  GETTABLEKS R5 R1 K38 ["Plugin"]
  GETIMPORT R7 K40 [game]
  GETTABLEKS R6 R7 K41 ["GameId"]
  NAMECALL R3 R3 K42 ["getBooleanSetting"]
  CALL R3 3 1
  SETTABLEKS R3 R0 K43 ["isR15ConvertedExperience"]
  MOVE R3 R2
  CALL R3 0 0
  GETTABLEKS R3 R0 K33 ["communication"]
  GETUPVAL R7 20
  GETTABLEKS R6 R7 K34 ["CrossPluginCommunicationInstructions"]
  GETTABLEKS R5 R6 K44 ["Published"]
  NEWCLOSURE R6 P11
  CAPTURE UPVAL U21
  CAPTURE VAL R1
  CAPTURE VAL R2
  ...
  CALL R3 3 0
  GETTABLEKS R4 R1 K38 ["Plugin"]
  GETTABLEKS R3 R4 K45 ["Unloading"]
  NEWCLOSURE R5 P12
  CAPTURE VAL R0
  NAMECALL R3 R3 K36 ["Connect"]
  CALL R3 2 0
  ...
  JUMPIFNOT R3 [+4]
  MOVE R5 R1
  NAMECALL R3 R0 K46 ["initToolbarAndButton"]
  CALL R3 2 0
  GETTABLEKS R3 R0 K18 ["store"]
  GETUPVAL R5 29
  GETTABLEKS R6 R0 K29 ["networkInterface"]
  CALL R5 1 -1
  NAMECALL R3 R3 K47 ["dispatch"]
  CALL R3 -1 0
  RETURN R0 0
...
MAIN:
  ...
  CAPTURE VAL R33
  CAPTURE VAL R31
  SETTABLEKS R51 R50 K74 ["init"]
  DUPCLOSURE R51 K75 [PROTO_23]
  CAPTURE VAL R0
  CAPTURE VAL R6
  CAPTURE VAL R11
  SETTABLEKS R51 R50 K76 ["renderButtons"]
  DUPCLOSURE R51 K77 [PROTO_24]
  CAPTURE VAL R6
  CAPTURE VAL R21
  CAPTURE VAL R22
  CAPTURE VAL R23
  SETTABLEKS R51 R50 K78 ["renderMain"]
  DUPCLOSURE R51 K79 [PROTO_26]
  CAPTURE VAL R13
  CAPTURE VAL R14
  CAPTURE VAL R16
  CAPTURE VAL R15
  ...
  CAPTURE VAL R21
  CAPTURE VAL R22
  SETTABLEKS R51 R50 K80 ["render"]
  JUMPIFNOT R0 [+3]
  DUPCLOSURE R51 K81 [PROTO_27]
