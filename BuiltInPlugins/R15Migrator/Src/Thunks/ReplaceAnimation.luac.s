...
PROTO_1:
  ...
  CALL R11 1 1
  GETUPVAL R13 2
  GETTABLEKS R12 R13 K11 ["getConvertedKeyframeSequence"]
  MOVE R13 R9
  CALL R12 1 1
  NEWTABLE R13 0 0
  LOADN R14 0
  GETTABLEKS R15 R11 K12 ["refs"]
  LOADNIL R16
  LOADNIL R17
  FORGPREP R15
  GETUPVAL R23 4
  GETTABLEKS R22 R23 K13 ["LocalAsset"]
  NAMECALL R20 R19 K10 ["IsA"]
  CALL R20 2 1
  JUMPIFNOT R20 [+27]
  NAMECALL R20 R18 K14 ["ClearAllChildren"]
  CALL R20 1 0
  NAMECALL R20 R12 K15 ["GetChildren"]
  CALL R20 1 3
  FORGPREP R20
  NAMECALL R25 R24 K16 ["Clone"]
  CALL R25 1 1
  SETTABLEKS R18 R25 K17 ["Parent"]
  FORGLOOP R20 2 [-6]
  ...
  GETUPVAL R20 5
  MOVE R22 R18
  NAMECALL R20 R20 K21 ["removeTag"]
  CALL R20 2 0
  JUMP [+57]
  GETUPVAL R23 4
  GETTABLEKS R22 R23 K22 ["AnimationInstance"]
  NAMECALL R20 R19 K10 ["IsA"]
  CALL R20 2 1
  JUMPIFNOT R20 [+17]
  GETTABLEKS R20 R10 K23 ["url"]
  SETTABLEKS R20 R18 K24 ["AnimationId"]
  FASTCALL2 TABLE_INSERT R13 R18 [+5]
  MOVE R21 R13
  MOVE R22 R18
  GETIMPORT R20 K20 [table.insert]
  ...
  JUMP [+33]
  GETUPVAL R23 4
  GETTABLEKS R22 R23 K25 ["AssetIdString"]
  NAMECALL R20 R19 K10 ["IsA"]
  CALL R20 2 1
  JUMPIFNOT R20 [+26]
  GETTABLEKS R20 R18 K26 ["scriptInstance"]
  GETTABLE R21 R4 R20
  JUMPIFNOT R21 [+12]
  GETTABLE R22 R4 R20
  DUPTABLE R23 K29 [{"ref", "info"}]
  SETTABLEKS R18 R23 K27 ["ref"]
  SETTABLEKS R9 R23 K28 ["info"]
  FASTCALL2 TABLE_INSERT R22 R23 [+3]
  GETIMPORT R21 K20 [table.insert]
  CALL R21 2 0
  JUMP [+10]
  NEWTABLE R21 0 1
  DUPTABLE R22 K29 [{"ref", "info"}]
  SETTABLEKS R18 R22 K27 ["ref"]
  SETTABLEKS R9 R22 K28 ["info"]
  SETLIST R21 R22 1 [1]
  SETTABLE R21 R4 R20
  ADDK R14 R14 K30 [1]
  FORGLOOP R15 2 [-93]
  ...
  NAMECALL R15 R11 K31 ["complete"]
  CALL R15 1 0
  JUMP [+4]
  MOVE R17 R13
  NAMECALL R15 R11 K32 ["removeRefs"]
  CALL R15 2 0
  GETUPVAL R17 6
  GETTABLEKS R18 R9 K8 ["id"]
  MOVE R19 R11
  CALL R17 2 -1
  NAMECALL R15 R0 K33 ["dispatch"]
  CALL R15 -1 0
  FORGLOOP R5 2 [-148]
  GETUPVAL R5 7
  MOVE R6 R4
