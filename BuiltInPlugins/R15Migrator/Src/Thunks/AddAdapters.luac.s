PROTO_0:
       ...
       14 FORGPREP_NEXT                    R1
       15 GETUPVAL                         R6 2
       16 GETTABLEKS                       R6 R6 K5 ["SetupUnificationScripts"]
       18 MOVE                             R7 R5
       19 CALL                             R6 1 0
       20 GETUPVAL                         R6 3
       21 MOVE                             R8 R5
       ...
       25 FORGLOOP                         R1 2 ; [-11]
       27 GETUPVAL                         R1 4
       28 GETTABLEKS                       R1 R1 K7 ["SetAdapted"]
       30 LOADB                            R2 1
       31 CALL                             R1 1 0
       32 GETUPVAL                         R3 5
       33 LOADB                            R4 1
...
MAIN:
       ...
       20 GETTABLEKS                       R4 R1 K10 ["QuickAccessTagging"]
       22 CALL                             R3 1 1
       23 GETTABLEKS                       R3 R3 K11 ["CharactersConvertedToR15Tagging"]
       25 GETTABLEKS                       R4 R0 K4 ["Src"]
       27 GETTABLEKS                       R4 R4 K12 ["Actions"]
       29 GETIMPORT                        R5 K7 [require]
       31 GETTABLEKS                       R6 R4 K13 ["SetAdapted"]
       33 CALL                             R5 1 1
       34 GETTABLEKS                       R6 R0 K4 ["Src"]
       36 GETTABLEKS                       R6 R6 K14 ["Modules"]
       38 GETIMPORT                        R7 K7 [require]
       40 GETTABLEKS                       R8 R6 K15 ["NpcManager"]
       42 CALL                             R7 1 1
       43 GETIMPORT                        R8 K7 [require]
       45 GETTABLEKS                       R9 R0 K4 ["Src"]
       47 GETTABLEKS                       R9 R9 K5 ["Util"]
       49 GETTABLEKS                       R9 R9 K16 ["SaveInterface"]
       51 CALL                             R8 1 1
