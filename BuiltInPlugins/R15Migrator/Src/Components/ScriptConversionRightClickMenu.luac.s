...
MAIN:
  ...
  GETTABLEKS R3 R4 K9 ["ConfirmRevertDialog"]
  CALL R2 1 1
  GETIMPORT R3 K4 [require]
  GETTABLEKS R6 R0 K7 ["Src"]
  GETTABLEKS R5 R6 K10 ["Util"]
  GETTABLEKS R4 R5 K11 ["showDialog"]
  CALL R3 1 1
  GETIMPORT R4 K4 [require]
  GETTABLEKS R7 R0 K7 ["Src"]
  GETTABLEKS R6 R7 K10 ["Util"]
  GETTABLEKS R5 R6 K12 ["ScriptReplacement"]
  CALL R4 1 1
  GETIMPORT R5 K4 [require]
  GETTABLEKS R9 R0 K7 ["Src"]
  GETTABLEKS R8 R9 K10 ["Util"]
  GETTABLEKS R7 R8 K13 ["ScriptHistory"]
  GETTABLEKS R6 R7 K14 ["selectionHasScriptBackups"]
  CALL R5 1 1
  GETIMPORT R6 K4 [require]
  GETTABLEKS R10 R0 K7 ["Src"]
  GETTABLEKS R9 R10 K10 ["Util"]
  GETTABLEKS R8 R9 K13 ["ScriptHistory"]
  GETTABLEKS R7 R8 K15 ["ChunkUtil"]
  CALL R6 1 1
  ...
  CAPTURE VAL R3
  CAPTURE VAL R2
  SETTABLEKS R14 R9 K23 ["promptRevertScripts"]
  DUPCLOSURE R14 K24 [PROTO_7]
  CAPTURE VAL R4
  SETTABLEKS R14 R9 K25 ["addGoToScriptItem"]
  DUPCLOSURE R14 K26 [PROTO_8]
  SETTABLEKS R14 R9 K27 ["addSeparator"]
  DUPCLOSURE R14 K28 [PROTO_10]
  SETTABLEKS R14 R9 K29 ["addSuggestionItems"]
  DUPCLOSURE R14 K30 [PROTO_12]
  SETTABLEKS R14 R9 K31 ["addUndoRevertItem"]
  DUPCLOSURE R14 K32 [PROTO_14]
  SETTABLEKS R14 R9 K33 ["addRevertScriptItem"]
  DUPCLOSURE R14 K34 [PROTO_16]
  SETTABLEKS R14 R9 K35 ["addReplaceSelectedItem"]
  DUPCLOSURE R14 K36 [PROTO_18]
  CAPTURE VAL R4
  SETTABLEKS R14 R9 K37 ["addDiffScriptItem"]
  DUPCLOSURE R14 K38 [PROTO_19]
  DUPCLOSURE R15 K39 [PROTO_20]
  CAPTURE VAL R5
  DUPCLOSURE R16 K40 [PROTO_21]
  DUPCLOSURE R17 K41 [PROTO_22]
  DUPCLOSURE R18 K42 [PROTO_23]
  DUPCLOSURE R19 K43 [PROTO_24]
  CAPTURE VAL R6
  DUPCLOSURE R20 K44 [PROTO_25]
  CAPTURE VAL R5
  CAPTURE VAL R19
  CAPTURE VAL R8
  SETTABLEKS R20 R9 K45 ["show"]
  RETURN R9 1
