...
PROTO_21:
  ...
  MOVE R8 R1
  MOVE R9 R5
  NAMECALL R6 R0 K15 ["addRevertScriptItem"]
  CALL R6 3 0
  GETTABLEKS R7 R1 K4 ["selectedScriptItems"]
  LOADNIL R8
  LOADNIL R9
  FORGPREP R7
  GETTABLEKS R13 R1 K16 ["completedScripts"]
  GETTABLEKS R14 R11 K13 ["scriptId"]
  GETTABLE R12 R13 R14
  JUMPIFNOT R12 [+2]
  LOADB R6 0
  ...
  MOVE R8 R1
  MOVE R9 R5
  NAMECALL R6 R0 K17 ["addReplaceSelectedItem"]
  CALL R6 3 0
  GETUPVAL R6 0
  MOVE R7 R2
  MOVE R8 R5
...
MAIN:
  ...
  GETTABLEKS R6 R5 K14 ["showContextMenu"]
  NEWTABLE R7 8 0
  ...
  CAPTURE VAL R3
  CAPTURE VAL R2
  SETTABLEKS R12 R7 K20 ["promptRevertScripts"]
  DUPCLOSURE R12 K21 [PROTO_7]
  CAPTURE VAL R4
  SETTABLEKS R12 R7 K22 ["addGoToScriptItem"]
  DUPCLOSURE R12 K23 [PROTO_8]
  SETTABLEKS R12 R7 K24 ["addSeparator"]
  DUPCLOSURE R12 K25 [PROTO_10]
  SETTABLEKS R12 R7 K26 ["addSuggestionItems"]
  DUPCLOSURE R12 K27 [PROTO_12]
  SETTABLEKS R12 R7 K28 ["addUndoRevertItem"]
  DUPCLOSURE R12 K29 [PROTO_14]
  SETTABLEKS R12 R7 K30 ["addRevertScriptItem"]
  DUPCLOSURE R12 K31 [PROTO_16]
  SETTABLEKS R12 R7 K32 ["addReplaceSelectedItem"]
  DUPCLOSURE R12 K33 [PROTO_17]
  DUPCLOSURE R13 K34 [PROTO_18]
  DUPCLOSURE R14 K35 [PROTO_19]
  DUPCLOSURE R15 K36 [PROTO_20]
  DUPCLOSURE R16 K37 [PROTO_21]
  CAPTURE VAL R6
  SETTABLEKS R16 R7 K38 ["show"]
  RETURN R7 1
