PROTO_0:
  ...
  GETUPVAL R4 0
  GETTABLEKS R3 R4 K2 ["Expanded"]
  GETUPVAL R4 1
  GETTABLE R2 R3 R4
  SETTABLEKS R2 R1 K0 ["expanded"]
  SETTABLEKS R1 R0 K3 ["state"]
  GETUPVAL R2 0
  GETTABLEKS R1 R2 K4 ["OnExpandedChanged"]
  SETTABLEKS R1 R0 K5 ["onExpandedChanged"]
  RETURN R0 0
...
PROTO_2:
  GETUPVAL R1 0
  GETTABLEKS R0 R1 K0 ["onExpandedChanged"]
  GETUPVAL R1 1
  CALL R0 1 0
  GETUPVAL R0 0
...
PROTO_7:
  ...
  CAPTURE VAL R0
  CAPTURE UPVAL U8
  SETTABLEKS R4 R3 K4 ["render"]
  DUPCLOSURE R4 K5 [PROTO_6]
  CAPTURE UPVAL U9
  GETUPVAL R6 10
  GETTABLEKS R5 R6 K6 ["withContext"]
  DUPTABLE R6 K8 [{"Localization"}]
  GETUPVAL R8 10
...
PROTO_8:
  ...
  GETTABLEKS R2 R0 K1 ["conversionListExpanded"]
  CALL R1 1 1
  GETUPVAL R2 1
  GETUPVAL R5 1
  GETTABLE R4 R1 R5
  NOT R3 R4
  SETTABLE R3 R1 R2
  DUPTABLE R2 K2 [{"conversionListExpanded"}]
  SETTABLEKS R1 R2 K1 ["conversionListExpanded"]
  RETURN R2 1
...
PROTO_15:
  DUPTABLE R1 K2 [{"expanded", "conversionListExpanded"}]
  NEWTABLE R2 4 0
  LOADB R3 1
  SETTABLEKS R3 R2 K3 ["Convert"]
  LOADB R3 1
  SETTABLEKS R3 R2 K4 ["Test"]
  LOADB R3 1
  SETTABLEKS R3 R2 K5 ["ReadyToPublish"]
  LOADB R3 1
  SETTABLEKS R3 R2 K6 ["Publish"]
  SETTABLEKS R2 R1 K0 ["expanded"]
  NEWTABLE R2 4 0
  GETUPVAL R4 0
  GETTABLEKS R3 R4 K7 ["CharacterConversion"]
  LOADB R4 1
  SETTABLE R4 R2 R3
  GETUPVAL R4 0
  ...
  SETTABLE R4 R2 R3
  GETUPVAL R4 0
  GETTABLEKS R3 R4 K9 ["ScriptConversion"]
  LOADB R4 1
  SETTABLE R4 R2 R3
  SETTABLEKS R2 R1 K1 ["conversionListExpanded"]
  SETTABLEKS R1 R0 K10 ["state"]
  NEWCLOSURE R1 P0
  CAPTURE VAL R0
  CAPTURE UPVAL U1
  SETTABLEKS R1 R0 K11 ["conversionListExpandedChanged"]
  DUPTABLE R1 K15 [{"Stylizer", "Expanded", "OnExpandedChanged"}]
  GETTABLEKS R3 R0 K16 ["props"]
  GETTABLEKS R2 R3 K12 ["Stylizer"]
  SETTABLEKS R2 R1 K12 ["Stylizer"]
  GETTABLEKS R3 R0 K10 ["state"]
  GETTABLEKS R2 R3 K1 ["conversionListExpanded"]
  SETTABLEKS R2 R1 K13 ["Expanded"]
  GETTABLEKS R2 R0 K11 ["conversionListExpandedChanged"]
  SETTABLEKS R2 R1 K14 ["OnExpandedChanged"]
  NEWTABLE R2 0 3
  DUPTABLE R3 K21 [{"keys", "values", "tabTarget", "headerCellComponent"}]
  NEWTABLE R4 0 0
  SETTABLEKS R4 R3 K17 ["keys"]
  NEWTABLE R4 0 0
  SETTABLEKS R4 R3 K18 ["values"]
  GETUPVAL R5 0
  GETTABLEKS R4 R5 K7 ["CharacterConversion"]
  SETTABLEKS R4 R3 K19 ["tabTarget"]
  GETGLOBAL R4 K22 ["getHeaderCellComponent"]
  LOADK R5 K23 ["Characters"]
  GETUPVAL R7 0
  GETTABLEKS R6 R7 K7 ["CharacterConversion"]
  MOVE R7 R1
  CALL R4 3 1
  SETTABLEKS R4 R3 K20 ["headerCellComponent"]
  SETTABLEN R3 R2 1
  DUPTABLE R3 K21 [{"keys", "values", "tabTarget", "headerCellComponent"}]
  NEWTABLE R4 0 0
  SETTABLEKS R4 R3 K17 ["keys"]
  ...
  SETTABLEKS R4 R3 K18 ["values"]
  GETUPVAL R5 0
  GETTABLEKS R4 R5 K8 ["AnimationConversion"]
  SETTABLEKS R4 R3 K19 ["tabTarget"]
  GETGLOBAL R4 K22 ["getHeaderCellComponent"]
  LOADK R5 K24 ["Animation"]
  GETUPVAL R7 0
  GETTABLEKS R6 R7 K8 ["AnimationConversion"]
  MOVE R7 R1
  CALL R4 3 1
  SETTABLEKS R4 R3 K20 ["headerCellComponent"]
  SETTABLEN R3 R2 2
  ...
  SETTABLEKS R4 R3 K18 ["values"]
  GETUPVAL R5 0
  GETTABLEKS R4 R5 K9 ["ScriptConversion"]
  SETTABLEKS R4 R3 K19 ["tabTarget"]
  GETGLOBAL R4 K22 ["getHeaderCellComponent"]
  LOADK R5 K25 ["Scripts"]
  GETUPVAL R7 0
  GETTABLEKS R6 R7 K9 ["ScriptConversion"]
  MOVE R7 R1
  CALL R4 3 1
  SETTABLEKS R4 R3 K20 ["headerCellComponent"]
  SETTABLEN R3 R2 3
  SETTABLEKS R2 R0 K26 ["sections"]
  NEWTABLE R2 0 0
  SETTABLEKS R2 R0 K27 ["buttons"]
  GETTABLEKS R5 R0 K16 ["props"]
  GETTABLEKS R4 R5 K28 ["characters"]
  GETTABLEKS R6 R0 K16 ["props"]
  GETTABLEKS R5 R6 K29 ["charactersConverted"]
  NAMECALL R2 R0 K30 ["updateCharacters"]
  CALL R2 3 0
  GETTABLEKS R5 R0 K16 ["props"]
  GETTABLEKS R4 R5 K31 ["animations"]
  NAMECALL R2 R0 K32 ["updateAnimations"]
  CALL R2 2 0
  GETTABLEKS R5 R0 K16 ["props"]
  GETTABLEKS R4 R5 K33 ["scripts"]
  NAMECALL R2 R0 K34 ["updateScripts"]
  CALL R2 2 0
  NEWTABLE R4 4 0
  LOADB R5 1
  SETTABLEN R5 R4 2
  ...
  SETTABLEN R5 R4 1
  GETTABLEKS R6 R0 K16 ["props"]
  GETTABLEKS R5 R6 K35 ["sortSelection"]
  NAMECALL R2 R0 K36 ["sortConversionEntries"]
  CALL R2 3 0
  NEWCLOSURE R2 P1
  CAPTURE VAL R0
  CAPTURE UPVAL U1
  SETTABLEKS R2 R0 K37 ["onExpandedChanged"]
  NEWCLOSURE R2 P2
  CAPTURE VAL R0
  SETTABLEKS R2 R0 K38 ["setSelectedTab"]
  NEWCLOSURE R2 P3
  CAPTURE VAL R0
  SETTABLEKS R2 R0 K39 ["setSortSelection"]
  RETURN R0 0
...
PROTO_22:
  GETTABLEKS R5 R0 K0 ["sections"]
  GETTABLEN R4 R5 1
  GETTABLEKS R3 R4 K1 ["keys"]
  GETTABLEKS R6 R0 K0 ["sections"]
  GETTABLEN R5 R6 1
...
PROTO_23:
  ...
  LOADNIL R8
  FORGPREP R6
  GETTABLEKS R11 R10 K3 ["animationAssetInfo"]
  DUPTABLE R12 K7 [{"target", "text", "complete"}]
  GETTABLEKS R13 R11 K8 ["instance"]
  SETTABLEKS R13 R12 K4 ["target"]
  GETUPVAL R13 0
  GETTABLEKS R14 R10 K9 ["name"]
  CALL R13 1 1
  SETTABLEKS R13 R12 K5 ["text"]
  GETIMPORT R14 K11 [next]
  GETTABLEKS R15 R10 K12 ["refs"]
  CALL R14 1 1
  NOT R13 R14
  SETTABLEKS R13 R12 K6 ["complete"]
  GETTABLE R13 R2 R9
  JUMPIF R13 [+8]
  SETTABLE R12 R2 R9
  ...
  CALL R13 2 0
  ADDK R4 R4 K16 [1]
  GETIMPORT R13 K11 [next]
  GETTABLEKS R14 R10 K12 ["refs"]
  CALL R13 1 1
  JUMPIF R13 [+1]
  ADDK R5 R5 K16 [1]
  FORGLOOP R6 2 [-40]
  GETTABLEKS R7 R0 K0 ["sections"]
  GETTABLEN R6 R7 2
  SETTABLEKS R4 R6 K17 ["total"]
  GETTABLEKS R7 R0 K0 ["sections"]
  GETTABLEN R6 R7 2
  SETTABLEKS R5 R6 K6 ["complete"]
  RETURN R0 0
...
PROTO_24:
  ...
  JUMPIF R2 [+1]
  RETURN R0 0
  GETTABLEKS R4 R0 K2 ["sections"]
  GETTABLEN R3 R4 3
  GETTABLEKS R2 R3 K3 ["keys"]
  GETTABLEKS R5 R0 K2 ["sections"]
  GETTABLEN R4 R5 3
  ...
  CALL R13 1 1
  MOVE R12 R13
  DUPTABLE R13 K10 [{"target", "text"}]
  SETTABLEKS R11 R13 K8 ["target"]
...
PROTO_34:
  GETTABLEKS R1 R0 K0 ["props"]
  GETTABLEKS R2 R0 K1 ["state"]
  GETTABLEKS R3 R2 K2 ["conversionListExpanded"]
  GETTABLEKS R4 R1 K3 ["Localization"]
  NEWTABLE R5 1 0
  NAMECALL R6 R0 K4 ["getSortAndRefreshRow"]
  CALL R6 1 1
  SETTABLEKS R6 R5 K5 ["sortAndRefresh"]
  GETTABLEKS R6 R0 K6 ["sections"]
  LOADNIL R7
  LOADNIL R8
  FORGPREP R6
  GETUPVAL R12 0
  ...
  GETUPVAL R12 1
  DUPTABLE R13 K13 [{"LayoutOrder", "Rows", "Title", "HeaderCellComponent", "OnClick"}]
  SETTABLEKS R9 R13 K8 ["LayoutOrder"]
  GETTABLEKS R16 R10 K14 ["tabTarget"]
  GETTABLE R15 R3 R16
  JUMPIFNOT R15 [+3]
  GETTABLEKS R14 R10 K15 ["values"]
  JUMPIF R14 [+2]
  NEWTABLE R14 0 0
  SETTABLEKS R14 R13 K9 ["Rows"]
  LOADK R16 K16 ["Summary"]
  LOADK R17 K17 ["ConvertHeader"]
  DUPTABLE R18 K20 [{"currentAmount", "total"}]
  GETTABLEKS R20 R10 K21 ["complete"]
  FASTCALL1 TOSTRING R20 [+2]
  GETIMPORT R19 K23 [tostring]
  CALL R19 1 1
  SETTABLEKS R19 R18 K18 ["currentAmount"]
  GETTABLEKS R20 R10 K19 ["total"]
  FASTCALL1 TOSTRING R20 [+2]
  GETIMPORT R19 K23 [tostring]
  CALL R19 1 1
  SETTABLEKS R19 R18 K19 ["total"]
  NAMECALL R14 R4 K24 ["getText"]
  CALL R14 4 1
  SETTABLEKS R14 R13 K10 ["Title"]
  GETTABLEKS R14 R10 K25 ["headerCellComponent"]
  SETTABLEKS R14 R13 K11 ["HeaderCellComponent"]
  NEWCLOSURE R14 P0
  CAPTURE VAL R0
  CAPTURE VAL R10
  SETTABLEKS R14 R13 K12 ["OnClick"]
  CALL R11 2 1
  SETTABLE R11 R5 R9
  FORGLOOP R6 2 [-54]
  RETURN R5 1
...
MAIN:
  ...
  GETTABLEKS R26 R22 K33 ["AnimationConversion"]
  GETTABLEKS R25 R26 K34 ["constants"]
  CALL R24 1 1
  GETTABLEKS R23 R24 K35 ["AssetType"]
  GETIMPORT R24 K10 [require]
  GETTABLEKS R25 R22 K36 ["TabsData"]
  CALL R24 1 1
  GETIMPORT R25 K10 [require]
  GETTABLEKS R26 R22 K37 ["SortData"]
  CALL R25 1 1
  GETIMPORT R26 K10 [require]
  GETIMPORT R29 K6 [script]
  GETTABLEKS R28 R29 K38 ["Parent"]
  GETTABLEKS R27 R28 K39 ["StatusTable"]
  CALL R26 1 1
  GETTABLEKS R28 R2 K17 ["Src"]
  GETTABLEKS R27 R28 K40 ["Thunks"]
  GETIMPORT R28 K10 [require]
  GETTABLEKS R29 R27 K41 ["LoadCharacterMetadata"]
  CALL R28 1 1
  GETIMPORT R29 K10 [require]
  GETTABLEKS R30 R27 K42 ["AddAdapters"]
  CALL R29 1 1
  GETIMPORT R30 K10 [require]
  GETTABLEKS R31 R27 K43 ["RemoveAdapters"]
  CALL R30 1 1
  GETTABLEKS R32 R2 K17 ["Src"]
  GETTABLEKS R31 R32 K44 ["Actions"]
  GETIMPORT R32 K10 [require]
  GETTABLEKS R33 R31 K45 ["SetSelectedTab"]
  CALL R32 1 1
  GETIMPORT R33 K10 [require]
  GETTABLEKS R34 R31 K46 ["SetSortSelection"]
  CALL R33 1 1
  GETIMPORT R35 K10 [require]
  GETTABLEKS R38 R2 K17 ["Src"]
  GETTABLEKS R37 R38 K47 ["Resources"]
  GETTABLEKS R36 R37 K48 ["Constants"]
  CALL R35 1 1
  GETTABLEKS R34 R35 K49 ["StatusTableData"]
  GETIMPORT R35 K10 [require]
  GETTABLEKS R38 R2 K17 ["Src"]
  GETTABLEKS R37 R38 K30 ["Util"]
  GETTABLEKS R36 R37 K50 ["sanitizeString"]
  CALL R35 1 1
  GETIMPORT R36 K10 [require]
  GETTABLEKS R39 R2 K17 ["Src"]
  GETTABLEKS R38 R39 K51 ["Modules"]
  GETTABLEKS R37 R38 K52 ["NpcIdManager"]
  CALL R36 1 1
  GETTABLEKS R37 R4 K53 ["PureComponent"]
  LOADK R39 K54 ["SummaryPane"]
  NAMECALL R37 R37 K55 ["extend"]
  CALL R37 2 1
  DUPCLOSURE R38 K56 [PROTO_7]
  CAPTURE VAL R4
  CAPTURE VAL R21
  CAPTURE VAL R20
  CAPTURE VAL R12
  ...
  CAPTURE VAL R5
  CAPTURE VAL R6
  SETGLOBAL R38 K57 ["getHeaderCellComponent"]
  DUPCLOSURE R38 K58 [PROTO_15]
  CAPTURE VAL R24
  CAPTURE VAL R7
  SETTABLEKS R38 R37 K59 ["init"]
  DUPCLOSURE R38 K60 [PROTO_16]
  SETTABLEKS R38 R37 K61 ["didMount"]
  DUPCLOSURE R38 K62 [PROTO_20]
  CAPTURE VAL R25
  SETTABLEKS R38 R37 K63 ["sortConversionEntries"]
  DUPCLOSURE R38 K64 [PROTO_22]
  CAPTURE VAL R36
  CAPTURE VAL R35
  SETTABLEKS R38 R37 K65 ["updateCharacters"]
  DUPCLOSURE R38 K66 [PROTO_23]
  CAPTURE VAL R35
  SETTABLEKS R38 R37 K67 ["updateAnimations"]
  DUPCLOSURE R38 K68 [PROTO_24]
  CAPTURE VAL R35
  SETTABLEKS R38 R37 K69 ["updateScripts"]
  DUPCLOSURE R38 K70 [PROTO_25]
  SETTABLEKS R38 R37 K71 ["willUpdate"]
  ...
  CAPTURE VAL R21
  CAPTURE VAL R13
  SETTABLEKS R38 R37 K73 ["renderHeader"]
  DUPCLOSURE R38 K74 [PROTO_29]
  CAPTURE VAL R4
  CAPTURE VAL R14
  CAPTURE VAL R1
  CAPTURE VAL R0
  SETTABLEKS R38 R37 K75 ["getRadioButtons"]
  DUPCLOSURE R38 K76 [PROTO_31]
  CAPTURE VAL R4
  CAPTURE VAL R12
  CAPTURE VAL R13
  CAPTURE VAL R17
  CAPTURE VAL R25
  SETTABLEKS R38 R37 K77 ["getSorter"]
  DUPCLOSURE R38 K78 [PROTO_32]
  CAPTURE VAL R4
  CAPTURE VAL R12
  CAPTURE VAL R18
  SETTABLEKS R38 R37 K79 ["getSortAndRefreshRow"]
  DUPCLOSURE R38 K80 [PROTO_34]
  CAPTURE VAL R4
  CAPTURE VAL R26
  SETTABLEKS R38 R37 K81 ["getConversionItems"]
  DUPCLOSURE R38 K82 [PROTO_36]
  CAPTURE VAL R20
  CAPTURE VAL R4
  CAPTURE VAL R11
  CAPTURE VAL R10
  CAPTURE VAL R26
  CAPTURE VAL R13
  SETTABLEKS R38 R37 K83 ["render"]
  DUPCLOSURE R38 K84 [PROTO_37]
  DUPCLOSURE R39 K85 [PROTO_43]
  CAPTURE VAL R28
  CAPTURE VAL R29
  CAPTURE VAL R30
  CAPTURE VAL R32
  CAPTURE VAL R33
  GETTABLEKS R40 R5 K86 ["withContext"]
  DUPTABLE R41 K90 [{"Stylizer", "Localization", "ScriptConversionContext", "Analytics"}]
  GETTABLEKS R42 R5 K87 ["Stylizer"]
  SETTABLEKS R42 R41 K87 ["Stylizer"]
  GETTABLEKS R42 R5 K88 ["Localization"]
  SETTABLEKS R42 R41 K88 ["Localization"]
  SETTABLEKS R8 R41 K19 ["ScriptConversionContext"]
  GETTABLEKS R42 R5 K89 ["Analytics"]
  SETTABLEKS R42 R41 K89 ["Analytics"]
  CALL R40 1 1
  MOVE R41 R37
  CALL R40 1 1
  MOVE R37 R40
  GETTABLEKS R40 R6 K91 ["connect"]
  MOVE R41 R38
  MOVE R42 R39
  CALL R40 2 1
  MOVE R41 R37
