...
local var9 = require(var0.Src.Components.PublishWarning.Buttons)
local var10 = var1.PureComponent:extend("PublishWarningDialog")
function var10.render(arg1)
   ...
   local var71 = {}
   local var75 = {}
   var75.Text = var1:getText("PublishWarning", "Warning")
   ...
   local var93 = {}
   var93.Text = var1:getText("PublishWarning", "Detail")
   ...
   local var114 = {}
   var114.OnCancel = var0.OnCancel
   var114.OnContinue = var0.OnContinue
