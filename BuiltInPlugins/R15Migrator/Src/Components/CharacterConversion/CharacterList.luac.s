...
PROTO_3:
  ...
  GETTABLEKS R3 R4 K6 ["SetCharacterSelection"]
  MOVE R4 R2
  CALL R3 1 0
  RETURN R0 0
...
PROTO_12:
  ...
  NEWCLOSURE R1 P3
  CAPTURE VAL R0
  SETTABLEKS R1 R0 K7 ["plainToggleSelect"]
  NEWCLOSURE R1 P4
  CAPTURE UPVAL U2
  CAPTURE VAL R0
  SETTABLEKS R1 R0 K8 ["controlSelect"]
  NEWCLOSURE R1 P5
  CAPTURE VAL R0
...
PROTO_17:
  ...
  RETURN R0 0
  GETUPVAL R1 0
  GETTABLEKS R0 R1 K4 ["plainToggleSelect"]
  GETUPVAL R1 1
  CALL R0 1 0
  RETURN R0 0
...
MAIN:
  ...
  DUPCLOSURE R22 K41 [PROTO_21]
  CAPTURE VAL R3
  CAPTURE VAL R10
  CAPTURE VAL R16
  CAPTURE VAL R1
  SETTABLEKS R22 R21 K42 ["renderNestedItem"]
  DUPCLOSURE R22 K43 [PROTO_22]
  CAPTURE VAL R3
  CAPTURE VAL R17
  CAPTURE VAL R18
  ...
  CALL R22 1 1
  MOVE R21 R22
  DUPCLOSURE R22 K48 [PROTO_23]
  DUPCLOSURE R23 K49 [PROTO_26]
  CAPTURE VAL R8
  CAPTURE VAL R13
