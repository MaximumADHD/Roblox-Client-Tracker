...
MAIN:
  ...
  GETTABLEKS R11 R9 K19 ["SelectAllRow"]
  CALL R10 1 1
  GETIMPORT R11 K4 [require]
  GETTABLEKS R13 R9 K20 ["CharacterConversion"]
  GETTABLEKS R12 R13 K21 ["SplitView"]
  CALL R11 1 1
  GETIMPORT R12 K4 [require]
  GETTABLEKS R14 R9 K20 ["CharacterConversion"]
  GETTABLEKS R13 R14 K22 ["ExpandableCharacterListItem"]
  CALL R12 1 1
  GETIMPORT R13 K4 [require]
  GETTABLEKS R16 R0 K10 ["Src"]
  GETTABLEKS R15 R16 K23 ["Thunks"]
  GETTABLEKS R14 R15 K24 ["CreateWorldModels"]
  CALL R13 1 1
  GETTABLEKS R14 R2 K25 ["ContextServices"]
  GETTABLEKS R15 R2 K26 ["UI"]
  GETTABLEKS R16 R15 K27 ["ExpandablePane"]
  GETTABLEKS R17 R15 K28 ["ScrollingFrame"]
  GETTABLEKS R18 R15 K29 ["KeyboardListener"]
  GETTABLEKS R19 R2 K11 ["Util"]
  GETTABLEKS R20 R19 K30 ["deepCopy"]
  GETTABLEKS R21 R3 K31 ["PureComponent"]
  LOADK R23 K32 ["CharacterConversionList"]
  ...
  CAPTURE VAL R7
  SETTABLEKS R22 R21 K37 ["getCharacterStatusKey"]
  DUPCLOSURE R22 K38 [PROTO_18]
  CAPTURE VAL R3
  CAPTURE VAL R12
  CAPTURE VAL R11
  CAPTURE VAL R1
  SETTABLEKS R22 R21 K39 ["renderItem"]
  DUPCLOSURE R22 K40 [PROTO_21]
  CAPTURE VAL R3
  CAPTURE VAL R10
  CAPTURE VAL R16
  CAPTURE VAL R1
  SETTABLEKS R22 R21 K41 ["renderNestedItem"]
  DUPCLOSURE R22 K42 [PROTO_22]
  CAPTURE VAL R3
  CAPTURE VAL R17
  CAPTURE VAL R18
  SETTABLEKS R22 R21 K43 ["render"]
  GETTABLEKS R22 R14 K44 ["withContext"]
  DUPTABLE R23 K46 [{"Stylizer"}]
  GETTABLEKS R24 R14 K45 ["Stylizer"]
  SETTABLEKS R24 R23 K45 ["Stylizer"]
  CALL R22 1 1
  MOVE R23 R21
  CALL R22 1 1
  MOVE R21 R22
  DUPCLOSURE R22 K47 [PROTO_23]
  DUPCLOSURE R23 K48 [PROTO_26]
  CAPTURE VAL R8
  CAPTURE VAL R13
  GETTABLEKS R24 R4 K49 ["connect"]
  MOVE R25 R22
  MOVE R26 R23
  CALL R24 2 1
  MOVE R25 R21
