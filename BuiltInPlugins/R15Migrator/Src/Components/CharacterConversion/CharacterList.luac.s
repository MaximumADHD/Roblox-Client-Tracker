...
PROTO_11:
  ...
  CAPTURE UPVAL U2
  CAPTURE VAL R0
  SETTABLEKS R1 R0 K6 ["onKeyPressed"]
  NEWCLOSURE R1 P1
  CAPTURE UPVAL U2
  CAPTURE VAL R0
  SETTABLEKS R1 R0 K7 ["onKeyReleased"]
  NEWCLOSURE R1 P2
  CAPTURE VAL R0
  SETTABLEKS R1 R0 K8 ["plainSelect"]
  NEWCLOSURE R1 P3
  CAPTURE UPVAL U3
  CAPTURE VAL R0
  SETTABLEKS R1 R0 K9 ["plainToggleSelect"]
  NEWCLOSURE R1 P4
  CAPTURE VAL R0
  SETTABLEKS R1 R0 K10 ["selectAll"]
  DUPCLOSURE R1 K11 [PROTO_5]
  SETTABLEKS R1 R0 K12 ["selectInRange"]
  NEWCLOSURE R1 P6
  CAPTURE VAL R0
  SETTABLEKS R1 R0 K13 ["areAllChildrenSelected"]
  NEWCLOSURE R1 P7
  CAPTURE VAL R0
  CAPTURE UPVAL U3
  SETTABLEKS R1 R0 K14 ["toggleSelectAllChildren"]
  DUPCLOSURE R1 K15 [PROTO_8]
  SETTABLEKS R1 R0 K16 ["getSelectionRangeData"]
  NEWCLOSURE R1 P9
  CAPTURE VAL R0
  CAPTURE UPVAL U3
  SETTABLEKS R1 R0 K17 ["shiftSelect"]
  NEWCLOSURE R1 P10
  CAPTURE VAL R0
  SETTABLEKS R1 R0 K18 ["isItemSelected"]
  RETURN R0 0
