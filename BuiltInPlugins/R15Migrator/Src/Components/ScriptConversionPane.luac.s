...
PROTO_4:
  ...
  LOADK R6 K3 ["onInitialScriptAnalysisScan"]
  NAMECALL R4 R3 K4 ["getHandler"]
  CALL R4 2 1
  MOVE R5 R2
  CALL R4 1 0
  NAMECALL R4 R0 K5 ["initConnections"]
  CALL R4 1 0
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R17 R18 K27 ["DocumentationUrls"]
  CALL R16 1 1
  GETTABLEKS R17 R3 K28 ["PureComponent"]
  LOADK R19 K29 ["ScriptConversionPane"]
  ...
  SETTABLEKS R18 R17 K34 ["initConnections"]
  DUPCLOSURE R18 K35 [PROTO_4]
  SETTABLEKS R18 R17 K36 ["didMount"]
  DUPCLOSURE R18 K37 [PROTO_5]
  SETTABLEKS R18 R17 K38 ["didUpdate"]
  DUPCLOSURE R18 K39 [PROTO_6]
  SETTABLEKS R18 R17 K40 ["getScriptExpandablePaneSize"]
  DUPCLOSURE R18 K41 [PROTO_7]
  SETTABLEKS R18 R17 K42 ["hasScripts"]
  DUPCLOSURE R18 K43 [PROTO_9]
  CAPTURE VAL R10
  CAPTURE VAL R3
  CAPTURE VAL R7
  CAPTURE VAL R8
  ...
  DUPCLOSURE R18 K45 [PROTO_10]
  SETTABLEKS R18 R17 K46 ["willUnmount"]
  GETTABLEKS R18 R5 K47 ["withContext"]
  DUPTABLE R19 K51 [{"Analytics", "Stylizer", "Localization"}]
  GETTABLEKS R20 R5 K48 ["Analytics"]
  SETTABLEKS R20 R19 K48 ["Analytics"]
  GETTABLEKS R20 R5 K49 ["Stylizer"]
  SETTABLEKS R20 R19 K49 ["Stylizer"]
  GETTABLEKS R20 R5 K50 ["Localization"]
  SETTABLEKS R20 R19 K50 ["Localization"]
  CALL R18 1 1
  MOVE R19 R17
  CALL R18 1 1
  MOVE R17 R18
  DUPCLOSURE R18 K52 [PROTO_11]
