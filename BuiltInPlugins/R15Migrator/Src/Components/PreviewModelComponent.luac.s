...
MAIN:
  ...
  CAPTURE VAL R9
  CAPTURE VAL R17
  GETIMPORT R21 K34 [Instance.new]
  LOADK R22 K35 ["WorldModel"]
  CALL R21 1 1
  GETIMPORT R22 K37 [game]
  LOADK R24 K38 ["Players"]
  NAMECALL R22 R22 K39 ["GetService"]
  CALL R22 2 1
  GETIMPORT R24 K34 [Instance.new]
  LOADK R25 K40 ["HumanoidDescription"]
  CALL R24 1 1
  GETIMPORT R25 K44 [Enum.HumanoidRigType.R6]
  NAMECALL R22 R22 K45 ["CreateHumanoidModelFromDescription"]
  CALL R22 3 1
  SETTABLEKS R21 R22 K2 ["Parent"]
  DUPCLOSURE R22 K46 [PROTO_1]
  DUPCLOSURE R23 K47 [PROTO_6]
  CAPTURE VAL R18
  SETTABLEKS R23 R19 K48 ["init"]
  DUPCLOSURE R23 K49 [PROTO_7]
  SETTABLEKS R23 R19 K50 ["willMount"]
  DUPCLOSURE R23 K51 [PROTO_8]
  SETTABLEKS R23 R19 K52 ["willUpdate"]
  ...
  SETTABLEKS R5 R24 K10 ["Analytics"]
  SETTABLEKS R6 R24 K11 ["Localization"]
  SETTABLEKS R8 R24 K14 ["Stylizer"]
  SETTABLEKS R7 R24 K12 ["Plugin"]
  CALL R23 1 1
  MOVE R24 R19
  CALL R23 1 1
  MOVE R19 R23
