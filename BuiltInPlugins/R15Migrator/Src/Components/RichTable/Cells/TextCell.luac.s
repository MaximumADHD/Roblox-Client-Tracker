PROTO_0:
  ...
  DUPTABLE R11 K47 [{"Text", "Tooltip"}]
  GETUPVAL R13 0
  GETTABLEKS R12 R13 K25 ["createElement"]
  GETUPVAL R13 2
  DUPTABLE R14 K50 [{"Text", "TextTruncate", "Size", "TextXAlignment"}]
  SETTABLEKS R5 R14 K46 ["Text"]
  GETIMPORT R15 K53 [Enum.TextTruncate.AtEnd]
  SETTABLEKS R15 R14 K48 ["TextTruncate"]
  GETIMPORT R15 K55 [UDim2.fromScale]
  LOADN R16 1
  LOADN R17 1
  CALL R15 2 1
  SETTABLEKS R15 R14 K31 ["Size"]
  GETIMPORT R15 K56 [Enum.TextXAlignment.Left]
  ...
  GETTABLEKS R12 R13 K25 ["createElement"]
  GETUPVAL R13 3
  DUPTABLE R14 K58 [{"MaxWidth", "Text", "TextXAlignment"}]
  GETTABLEKS R16 R2 K23 ["Tooltip"]
  GETTABLEKS R15 R16 K57 ["MaxWidth"]
  SETTABLEKS R15 R14 K57 ["MaxWidth"]
  SETTABLEKS R6 R14 K46 ["Text"]
  GETIMPORT R15 K56 [Enum.TextXAlignment.Left]
  SETTABLEKS R15 R14 K49 ["TextXAlignment"]
  CALL R12 2 1
