...
MAIN:
  ...
  CAPTURE VAL R3
  SETTABLEKS R5 R4 K17 ["HasScriptBackup"]
  DUPCLOSURE R5 K18 [PROTO_2]
  CAPTURE VAL R3
  SETTABLEKS R5 R4 K19 ["RemoveScriptBackupChunks"]
  DUPCLOSURE R5 K20 [PROTO_3]
  CAPTURE VAL R1
  SETTABLEKS R5 R4 K21 ["DidSourceChange"]
  DUPCLOSURE R5 K22 [PROTO_4]
  CAPTURE VAL R1
  DUPCLOSURE R6 K23 [PROTO_5]
  CAPTURE VAL R1
  SETTABLEKS R6 R4 K24 ["AppendChunk"]
  DUPCLOSURE R6 K25 [PROTO_6]
  CAPTURE VAL R1
  SETTABLEKS R6 R4 K26 ["ReplaceWithChunk"]
  DUPCLOSURE R6 K27 [PROTO_7]
  CAPTURE VAL R3
  SETTABLEKS R6 R4 K28 ["SplitIntoChunks"]
  DUPCLOSURE R6 K29 [PROTO_8]
  SETTABLEKS R6 R4 K30 ["GetScriptSourceFromChunks"]
  RETURN R4 1
