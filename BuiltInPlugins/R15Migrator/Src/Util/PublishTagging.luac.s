...
MAIN:
  ...
  CAPTURE VAL R4
  CAPTURE VAL R6
  SETTABLEKS R7 R6 K35 ["clearPublishTags"]
  DUPCLOSURE R7 K36 [PROTO_7]
  CAPTURE VAL R2
  CAPTURE VAL R5
  CAPTURE VAL R0
  CAPTURE VAL R4
  SETTABLEKS R7 R6 K37 ["checkPublishTags"]
  DUPCLOSURE R7 K38 [PROTO_8]
  CAPTURE VAL R2
  CAPTURE VAL R5
  SETTABLEKS R7 R6 K39 ["setPublishBlocked"]
  DUPCLOSURE R7 K40 [PROTO_9]
  CAPTURE VAL R2
  CAPTURE VAL R5
  SETTABLEKS R7 R6 K41 ["publishingIsBlocked"]
  DUPCLOSURE R7 K42 [PROTO_10]
  CAPTURE VAL R2
  SETTABLEKS R7 R6 K43 ["prepareToPublish"]
  RETURN R6 1
