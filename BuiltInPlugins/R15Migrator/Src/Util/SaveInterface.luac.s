...
PROTO_18:
  ...
  NAMECALL R11 R6 K17 ["FindFirstChildWhichIsA"]
  CALL R11 2 1
  LOADK R14 K18 ["name"]
  NAMECALL R12 R6 K19 ["GetAttribute"]
  CALL R12 2 1
  DUPTABLE R13 K22 [{"assetIdR15To", "keyframeSeqR15", "name"}]
  SETTABLEKS R10 R13 K20 ["assetIdR15To"]
  SETTABLEKS R11 R13 K21 ["keyframeSeqR15"]
  SETTABLEKS R12 R13 K18 ["name"]
  SETTABLE R13 R1 R7
  FORGLOOP R2 2 [-41]
  RETURN R1 1
...
MAIN:
  ...
  GETTABLEKS R5 R6 K14 ["AnimationConversion"]
  GETIMPORT R6 K10 [require]
  GETTABLEKS R7 R5 K15 ["AnimationConversionManager"]
  CALL R6 1 1
  LOADNIL R7
  NEWCLOSURE R8 P0
  CAPTURE REF R7
  ...
  CAPTURE REF R7
  CAPTURE VAL R1
  SETTABLEKS R9 R0 K16 ["isRootSaveFolderChildOf"]
  NEWCLOSURE R9 P2
  CAPTURE REF R7
  CAPTURE VAL R1
  SETTABLEKS R9 R0 K17 ["isRootSaveFolderDescendantOf"]
  NEWCLOSURE R9 P3
  CAPTURE REF R7
  CAPTURE VAL R1
  SETTABLEKS R9 R0 K18 ["isRootSaveFolder"]
  NEWCLOSURE R9 P4
  CAPTURE REF R7
  CAPTURE VAL R1
  SETTABLEKS R9 R0 K19 ["isDescendantOfSaveFolder"]
  DUPCLOSURE R9 K20 [PROTO_6]
  SETTABLEKS R9 R0 K21 ["getConversionId"]
  DUPCLOSURE R9 K22 [PROTO_7]
  CAPTURE VAL R0
  SETTABLEKS R9 R0 K23 ["hasConvertedFrom"]
  NEWCLOSURE R9 P7
  CAPTURE REF R7
  CAPTURE VAL R1
  CAPTURE VAL R2
  SETTABLEKS R9 R0 K24 ["addConvertibleCharacters"]
  NEWCLOSURE R9 P8
  CAPTURE REF R7
  CAPTURE VAL R1
  SETTABLEKS R9 R0 K25 ["getR6Characters"]
  NEWCLOSURE R9 P9
  CAPTURE REF R7
  CAPTURE VAL R1
  CAPTURE VAL R2
  SETTABLEKS R9 R0 K26 ["addScriptConversionRules"]
  NEWCLOSURE R9 P10
  CAPTURE REF R7
  CAPTURE VAL R1
  CAPTURE VAL R2
  SETTABLEKS R9 R0 K27 ["getScriptConversionRules"]
  DUPCLOSURE R9 K28 [PROTO_12]
  SETTABLEKS R9 R0 K29 ["isConvertibleKeyframeSequence"]
  NEWCLOSURE R9 P12
  CAPTURE REF R7
  CAPTURE VAL R1
  CAPTURE VAL R2
  SETTABLEKS R9 R0 K30 ["addConvertibleKeyframeSequences"]
  NEWCLOSURE R9 P13
  CAPTURE REF R7
  CAPTURE VAL R1
  SETTABLEKS R9 R0 K31 ["getOriginalR6KeyframeSequences"]
  NEWCLOSURE R9 P14
  CAPTURE REF R7
  CAPTURE VAL R1
  CAPTURE VAL R6
  SETTABLEKS R9 R0 K32 ["addConvertibleAssets"]
  NEWCLOSURE R9 P15
  CAPTURE REF R7
  CAPTURE VAL R1
  SETTABLEKS R9 R0 K33 ["setTargetAssetId"]
  DUPCLOSURE R9 K34 [PROTO_17]
  CAPTURE VAL R6
  CAPTURE VAL R0
  SETTABLEKS R9 R0 K35 ["addConvertibleAnimations"]
  NEWCLOSURE R9 P17
  CAPTURE REF R7
  CAPTURE VAL R1
  SETTABLEKS R9 R0 K36 ["getAllConvertedAnimationAssetIds"]
  CLOSEUPVALS R7
  RETURN R0 1
