...
PROTO_19:
  ...
  CALL R9 2 0
  GETUPVAL R10 5
  GETTABLEKS R9 R10 K19 ["clearTags"]
  MOVE R10 R8
  CALL R9 1 0
  FORGLOOP R2 2 [-45]
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R8 R9 K18 ["QuickAccessTagging"]
  CALL R7 1 1
  GETTABLEKS R10 R3 K11 ["Src"]
  GETTABLEKS R9 R10 K16 ["Util"]
  GETTABLEKS R8 R9 K19 ["AnimationConversion"]
  GETIMPORT R9 K10 [require]
  GETTABLEKS R10 R8 K20 ["AnimationConversionManager"]
  CALL R9 1 1
  LOADNIL R10
  NEWCLOSURE R11 P0
  CAPTURE REF R10
  ...
  CAPTURE REF R10
  CAPTURE VAL R1
  SETTABLEKS R13 R0 K22 ["isRootSaveFolderChildOf"]
  NEWCLOSURE R13 P3
  CAPTURE REF R10
  CAPTURE VAL R1
  SETTABLEKS R13 R0 K23 ["isRootSaveFolderDescendantOf"]
  NEWCLOSURE R13 P4
  CAPTURE REF R10
  CAPTURE VAL R1
  SETTABLEKS R13 R0 K24 ["isRootSaveFolder"]
  NEWCLOSURE R13 P5
  CAPTURE REF R10
  CAPTURE VAL R1
  SETTABLEKS R13 R0 K25 ["isDescendantOfSaveFolder"]
  DUPCLOSURE R13 K26 [PROTO_7]
  CAPTURE VAL R1
  SETTABLEKS R13 R0 K27 ["doesSaveFolderExistInDM"]
  DUPCLOSURE R13 K28 [PROTO_8]
  CAPTURE VAL R1
  SETTABLEKS R13 R0 K29 ["removeAllSavedData"]
  DUPCLOSURE R13 K30 [PROTO_10]
  SETTABLEKS R13 R0 K31 ["conversionIdFilter"]
  DUPCLOSURE R13 K32 [PROTO_11]
  SETTABLEKS R13 R0 K33 ["removeConversionId"]
  DUPCLOSURE R13 K34 [PROTO_12]
  SETTABLEKS R13 R0 K35 ["getConversionId"]
  DUPCLOSURE R13 K36 [PROTO_13]
  CAPTURE VAL R0
  SETTABLEKS R13 R0 K37 ["hasConvertedFrom"]
  NEWCLOSURE R13 P12
  CAPTURE REF R10
  CAPTURE VAL R1
  CAPTURE VAL R2
  CAPTURE VAL R6
  CAPTURE VAL R7
  SETTABLEKS R13 R0 K38 ["addConvertibleCharacters"]
  NEWCLOSURE R13 P13
  CAPTURE REF R10
  CAPTURE VAL R1
  SETTABLEKS R13 R0 K39 ["getR6Characters"]
  NEWCLOSURE R13 P14
  CAPTURE REF R10
  CAPTURE VAL R1
  CAPTURE VAL R2
  SETTABLEKS R13 R0 K40 ["addScriptConversionRules"]
  NEWCLOSURE R13 P15
  CAPTURE REF R10
  CAPTURE VAL R1
  CAPTURE VAL R2
  SETTABLEKS R13 R0 K41 ["getScriptConversionRules"]
  DUPCLOSURE R13 K42 [PROTO_18]
  SETTABLEKS R13 R0 K43 ["isConvertibleKeyframeSequence"]
  NEWCLOSURE R13 P17
  CAPTURE REF R10
  CAPTURE VAL R1
  CAPTURE VAL R2
  ...
  CAPTURE VAL R6
  CAPTURE VAL R7
  SETTABLEKS R13 R0 K44 ["addConvertibleKeyframeSequences"]
  NEWCLOSURE R13 P18
  CAPTURE REF R10
  CAPTURE VAL R1
  SETTABLEKS R13 R0 K45 ["getR6KeyframeSequence"]
  NEWCLOSURE R13 P19
  CAPTURE REF R10
  CAPTURE VAL R1
  CAPTURE VAL R0
  SETTABLEKS R13 R0 K46 ["getOriginalR6KeyframeSequences"]
  NEWCLOSURE R13 P20
  CAPTURE REF R10
  CAPTURE VAL R1
  CAPTURE VAL R9
  ...
  CAPTURE VAL R6
  CAPTURE VAL R7
  SETTABLEKS R13 R0 K47 ["addConvertibleAssetIds"]
  NEWCLOSURE R13 P21
  CAPTURE REF R10
  CAPTURE VAL R1
  SETTABLEKS R13 R0 K48 ["setTargetAssetId"]
  DUPCLOSURE R13 K49 [PROTO_24]
  CAPTURE VAL R9
  CAPTURE VAL R0
  SETTABLEKS R13 R0 K50 ["addConvertibleAnimations"]
  NEWCLOSURE R13 P23
  CAPTURE REF R10
  CAPTURE VAL R1
  SETTABLEKS R13 R0 K51 ["getAllSavedAnimationAssetIds"]
  CLOSEUPVALS R10
  RETURN R0 1
