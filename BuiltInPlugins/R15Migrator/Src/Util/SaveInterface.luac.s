...
MAIN:
  ...
  SETTABLEKS R11 R0 K27 ["getConversionId"]
  DUPCLOSURE R11 K28 [PROTO_8]
  CAPTURE VAL R0
  SETTABLEKS R11 R0 K29 ["hasConvertedFrom"]
  NEWCLOSURE R11 P8
  CAPTURE REF R9
  CAPTURE VAL R1
  CAPTURE VAL R2
  CAPTURE VAL R6
  SETTABLEKS R11 R0 K30 ["addConvertibleCharacters"]
  NEWCLOSURE R11 P9
  CAPTURE REF R9
  CAPTURE VAL R1
  SETTABLEKS R11 R0 K31 ["getR6Characters"]
  NEWCLOSURE R11 P10
  CAPTURE REF R9
  CAPTURE VAL R1
  CAPTURE VAL R2
  SETTABLEKS R11 R0 K32 ["addScriptConversionRules"]
  NEWCLOSURE R11 P11
  CAPTURE REF R9
  CAPTURE VAL R1
  CAPTURE VAL R2
  SETTABLEKS R11 R0 K33 ["getScriptConversionRules"]
  DUPCLOSURE R11 K34 [PROTO_13]
  SETTABLEKS R11 R0 K35 ["isConvertibleKeyframeSequence"]
  NEWCLOSURE R11 P13
  CAPTURE REF R9
  CAPTURE VAL R1
  CAPTURE VAL R2
  CAPTURE VAL R5
  CAPTURE VAL R6
  SETTABLEKS R11 R0 K36 ["addConvertibleKeyframeSequences"]
  NEWCLOSURE R11 P14
  CAPTURE REF R9
  CAPTURE VAL R1
  SETTABLEKS R11 R0 K37 ["getR6KeyframeSequence"]
  NEWCLOSURE R11 P15
  CAPTURE REF R9
  CAPTURE VAL R1
  CAPTURE VAL R0
  SETTABLEKS R11 R0 K38 ["getOriginalR6KeyframeSequences"]
  NEWCLOSURE R11 P16
  CAPTURE REF R9
  CAPTURE VAL R1
  CAPTURE VAL R8
  CAPTURE VAL R5
  CAPTURE VAL R6
  SETTABLEKS R11 R0 K39 ["addConvertibleAssetIds"]
  NEWCLOSURE R11 P17
  CAPTURE REF R9
  CAPTURE VAL R1
  SETTABLEKS R11 R0 K40 ["setTargetAssetId"]
  DUPCLOSURE R11 K41 [PROTO_19]
  CAPTURE VAL R8
  CAPTURE VAL R0
  SETTABLEKS R11 R0 K42 ["addConvertibleAnimations"]
  NEWCLOSURE R11 P19
  CAPTURE REF R9
  CAPTURE VAL R1
  SETTABLEKS R11 R0 K43 ["getAllSavedAnimationAssetIds"]
  CLOSEUPVALS R9
  RETURN R0 1
