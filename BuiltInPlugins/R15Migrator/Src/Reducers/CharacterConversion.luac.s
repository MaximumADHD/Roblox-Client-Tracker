...
MAIN:
  ...
  GETTABLEKS R10 R3 K15 ["ResetAllCharacterConversion"]
  CALL R9 1 1
  DUPCLOSURE R10 K16 [PROTO_0]
  GETTABLEKS R11 R1 K17 ["createReducer"]
  MOVE R12 R10
  CALL R12 0 1
  NEWTABLE R13 8 0
  GETTABLEKS R14 R5 K18 ["name"]
  DUPCLOSURE R15 K19 [PROTO_1]
  CAPTURE VAL R2
  SETTABLE R15 R13 R14
  GETTABLEKS R14 R4 K18 ["name"]
  DUPCLOSURE R15 K20 [PROTO_2]
  CAPTURE VAL R2
  SETTABLE R15 R13 R14
  GETTABLEKS R14 R6 K18 ["name"]
  DUPCLOSURE R15 K21 [PROTO_3]
  CAPTURE VAL R2
  SETTABLE R15 R13 R14
  GETTABLEKS R14 R7 K18 ["name"]
  DUPCLOSURE R15 K22 [PROTO_4]
  CAPTURE VAL R2
  SETTABLE R15 R13 R14
  GETTABLEKS R14 R8 K18 ["name"]
  DUPCLOSURE R15 K23 [PROTO_5]
  CAPTURE VAL R2
  SETTABLE R15 R13 R14
  GETTABLEKS R14 R9 K18 ["name"]
