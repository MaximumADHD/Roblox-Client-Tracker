PROTO_0:
       ...
       30 GETUPVAL                         R3 4
       31 GETUPVAL                         R4 1
       32 GETTABLEKS                       R4 R4 K0 ["None"]
       34 CALL                             R3 1 -1
       35 NAMECALL                         R1 R0 K1 ["dispatch"]
       37 CALL                             R1 -1 0
       38 GETUPVAL                         R3 5
       39 GETUPVAL                         R4 6
       40 GETTABLEKS                       R4 R4 K9 ["TABS_KEYS"]
       42 GETTABLEKS                       R4 R4 K0 ["None"]
       44 CALL                             R3 1 -1
       45 NAMECALL                         R1 R0 K1 ["dispatch"]
       47 CALL                             R1 -1 0
       48 GETUPVAL                         R3 7
       49 GETUPVAL                         R4 8
       50 GETTABLEKS                       R4 R4 K10 ["TOOL_MODE"]
       52 GETTABLEKS                       R4 R4 K0 ["None"]
       54 CALL                             R3 1 -1
...
MAIN:
       ...
       33 GETTABLEKS                       R6 R6 K12 ["Actions"]
       35 GETTABLEKS                       R6 R6 K13 ["SetAccessoryTypeInfo"]
       37 CALL                             R5 1 1
       38 GETIMPORT                        R6 K4 [require]
       40 GETTABLEKS                       R7 R0 K11 ["Src"]
       42 GETTABLEKS                       R7 R7 K12 ["Actions"]
       44 GETTABLEKS                       R7 R7 K14 ["SetAttachmentPoint"]
       46 CALL                             R6 1 1
       47 GETIMPORT                        R7 K4 [require]
       49 GETTABLEKS                       R8 R0 K11 ["Src"]
       51 GETTABLEKS                       R8 R8 K12 ["Actions"]
       53 GETTABLEKS                       R8 R8 K15 ["SelectPreviewTab"]
       55 CALL                             R7 1 1
       56 GETIMPORT                        R8 K4 [require]
       58 GETTABLEKS                       R9 R0 K11 ["Src"]
       60 GETTABLEKS                       R9 R9 K12 ["Actions"]
       62 GETTABLEKS                       R9 R9 K16 ["SetToolMode"]
       64 CALL                             R8 1 1
       65 GETIMPORT                        R9 K4 [require]
       67 GETTABLEKS                       R10 R0 K11 ["Src"]
       69 GETTABLEKS                       R10 R10 K12 ["Actions"]
       71 GETTABLEKS                       R10 R10 K17 ["SetEditingCage"]
       73 CALL                             R9 1 1
       74 GETIMPORT                        R10 K4 [require]
       76 GETTABLEKS                       R11 R0 K11 ["Src"]
       78 GETTABLEKS                       R11 R11 K8 ["Util"]
       80 GETTABLEKS                       R11 R11 K18 ["Constants"]
       82 CALL                             R10 1 1
