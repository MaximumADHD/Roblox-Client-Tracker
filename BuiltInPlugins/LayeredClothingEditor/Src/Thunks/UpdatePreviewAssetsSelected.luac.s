PROTO_0:
       ...
       21 JUMPIFNOT                        R3 ; [+9]
       22 GETUPVAL                         R4 0
       23 GETTABLEKS                       R4 R4 K3 ["List"]
       25 GETTABLEKS                       R4 R4 K4 ["removeValue"]
       27 MOVE                             R5 R3
       28 MOVE                             R6 R0
       29 CALL                             R4 2 -1
       30 RETURN                           R4 -1
...
PROTO_2:
        ...
        5 GETTABLEKS                       R2 R2 K2 ["selectedTab"]
        7 GETUPVAL                         R3 0
        8 GETTABLEKS                       R4 R1 K1 ["previewStatus"]
       10 GETTABLEKS                       R4 R4 K3 ["selectedAssets"]
       12 CALL                             R3 1 1
       13 GETUPVAL                         R4 1
       14 JUMPIFNOT                        R4 ; [+41]
       15 GETUPVAL                         R4 2
       16 GETTABLEKS                       R4 R4 K4 ["isTabMultiSelect"]
       18 MOVE                             R5 R2
       19 CALL                             R4 1 1
       20 GETUPVAL                         R5 3
       21 GETUPVAL                         R6 1
       ...
       28 JUMPIFNOT                        R5 ; [+27]
       29 GETUPVAL                         R5 5
       30 GETTABLEKS                       R5 R5 K5 ["TABS_KEYS"]
       32 GETTABLEKS                       R5 R5 K6 ["Avatars"]
       ...
       42 JUMP                             ; [+13]
       43 GETUPVAL                         R5 5
       44 GETTABLEKS                       R5 R5 K5 ["TABS_KEYS"]
       46 GETTABLEKS                       R5 R5 K9 ["Clothing"]
       ...
       56 GETUPVAL                         R6 5
       57 GETTABLEKS                       R6 R6 K5 ["TABS_KEYS"]
       59 GETTABLEKS                       R6 R6 K6 ["Avatars"]
       ...
       73 JUMPIF                           R4 ; [+26]
       74 GETUPVAL                         R4 5
       75 GETTABLEKS                       R4 R4 K5 ["TABS_KEYS"]
       77 GETTABLEKS                       R4 R4 K6 ["Avatars"]
       79 GETUPVAL                         R5 2
       80 GETTABLEKS                       R5 R5 K13 ["getTabInfo"]
       82 MOVE                             R6 R4
       83 CALL                             R5 1 1
...
MAIN:
       ...
       42 GETTABLEKS                       R8 R8 K14 ["Actions"]
       44 GETTABLEKS                       R8 R8 K15 ["SetPreviewAssetsSelected"]
       46 CALL                             R7 1 1
       47 GETIMPORT                        R8 K4 [require]
       49 GETTABLEKS                       R9 R0 K13 ["Src"]
       51 GETTABLEKS                       R9 R9 K9 ["Util"]
       53 GETTABLEKS                       R9 R9 K16 ["AnalyticsGlobals"]
       55 CALL                             R8 1 1
