...
PROTO_5:
        0 MOVE                             R2 R0
        1 GETUPVAL                         R3 0
        2 GETTABLEKS                       R3 R3 K0 ["isAvatar"]
        4 MOVE                             R4 R0
        5 CALL                             R3 1 1
        6 JUMPIFNOT                        R3 ; [+6]
        7 GETUPVAL                         R3 1
...
PROTO_6:
        ...
        6 GETUPVAL                         R3 0
        7 GETTABLEKS                       R3 R3 K2 ["isAvatar"]
        9 MOVE                             R4 R1
       10 CALL                             R3 1 1
       11 JUMPIFNOT                        R3 ; [+21]
       12 GETUPVAL                         R3 1
       ...
       17 MOVE                             R4 R2
       18 GETUPVAL                         R5 0
       19 GETTABLEKS                       R5 R5 K2 ["isAvatar"]
       21 MOVE                             R6 R2
       22 CALL                             R5 1 1
       23 JUMPIFNOT                        R5 ; [+6]
       24 GETUPVAL                         R5 1
       ...
       35 MOVE                             R4 R2
       36 GETUPVAL                         R5 0
       37 GETTABLEKS                       R5 R5 K2 ["isAvatar"]
       39 MOVE                             R6 R2
       40 CALL                             R5 1 1
       41 JUMPIFNOT                        R5 ; [+6]
       42 GETUPVAL                         R5 1
...
PROTO_8:
        ...
        2 CALL                             R4 1 1
        3 GETTABLEKS                       R5 R4 K1 ["selectItem"]
        5 GETTABLEKS                       R5 R5 K2 ["accessoryTypeInfo"]
        7 GETTABLEKS                       R6 R4 K1 ["selectItem"]
        9 GETTABLEKS                       R6 R6 K3 ["attachmentPoint"]
       11 GETTABLEKS                       R7 R4 K1 ["selectItem"]
       13 GETTABLEKS                       R7 R7 K4 ["size"]
...
PROTO_9:
       ...
       14 CALL                             R6 1 1
       15 GETTABLEKS                       R7 R4 K4 ["selectItem"]
       17 GETTABLEKS                       R7 R7 K5 ["accessoryTypeInfo"]
       19 GETTABLEKS                       R8 R4 K4 ["selectItem"]
       21 GETTABLEKS                       R8 R8 K6 ["attachmentPoint"]
...
PROTO_11:
        ...
        4 RETURN                           R0 0
        5 GETUPVAL                         R1 2
        6 GETTABLEKS                       R1 R1 K0 ["isClothes"]
        8 GETUPVAL                         R2 0
        9 CALL                             R1 1 1
       10 JUMPIFNOT                        R1 ; [+45]
       11 GETUPVAL                         R1 2
       12 GETTABLEKS                       R1 R1 K1 ["hasAnyCage"]
       14 GETUPVAL                         R2 0
       15 CALL                             R1 1 1
       16 JUMPIFNOT                        R1 ; [+20]
       17 GETUPVAL                         R1 3
       ...
       56 GETUPVAL                         R1 7
       57 GETTABLEKS                       R1 R1 K4 ["HasPublished"]
       59 JUMPIFNOT                        R1 ; [+21]
       60 GETUPVAL                         R1 7
       61 GETTABLEKS                       R1 R1 K6 ["FirstAction"]
       63 JUMPIF                           R1 ; [+17]
       64 GETUPVAL                         R1 7
       65 GETUPVAL                         R2 10
       66 GETTABLEKS                       R2 R2 K7 ["ACTIONS"]
       68 GETTABLEKS                       R2 R2 K8 ["Generate"]
       ...
       76 CALL                             R1 2 1
       77 GETUPVAL                         R2 7
       78 GETTABLEKS                       R2 R2 K6 ["FirstAction"]
       80 CALL                             R1 1 0
       81 RETURN                           R0 0
...
MAIN:
       ...
       25 CALL                             R3 1 1
       26 GETTABLEKS                       R4 R3 K12 ["Util"]
       28 GETTABLEKS                       R4 R4 K13 ["AccessoryAndBodyToolShared"]
       ...
       42 GETTABLEKS                       R11 R2 K19 ["Src"]
       44 GETTABLEKS                       R11 R11 K12 ["Util"]
       46 GETTABLEKS                       R11 R11 K20 ["Constants"]
       48 CALL                             R10 1 1
       49 GETIMPORT                        R11 K9 [require]
       51 GETTABLEKS                       R12 R2 K19 ["Src"]
       53 GETTABLEKS                       R12 R12 K12 ["Util"]
       55 GETTABLEKS                       R12 R12 K21 ["AnalyticsGlobals"]
       57 CALL                             R11 1 1
