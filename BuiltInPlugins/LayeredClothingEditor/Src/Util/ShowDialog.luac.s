...
PROTO_2:
        ...
        8 JUMPIF                           R6 ; [+4]
        9 GETUPVAL                         R6 1
       10 GETTABLEKS                       R6 R6 K1 ["RunRhodiumTests"]
       12 CALL                             R6 0 1
       13 LOADNIL                          R7
       14 JUMPIFNOT                        R6 ; [+6]
       15 GETUPVAL                         R8 2
       16 GETTABLEKS                       R8 R8 K2 ["mock"]
       18 CALL                             R8 0 1
       19 MOVE                             R7 R8
       20 JUMP                             ; [+5]
       21 GETUPVAL                         R8 2
       22 GETTABLEKS                       R8 R8 K3 ["makePluginTheme"]
       24 CALL                             R8 0 1
       25 MOVE                             R7 R8
       26 GETUPVAL                         R8 3
       27 GETTABLEKS                       R8 R8 K4 ["provide"]
       29 NEWTABLE                         R9 0 4
       31 MOVE                             R10 R1
       32 MOVE                             R11 R7
       33 MOVE                             R12 R0
       34 GETUPVAL                         R13 4
       35 GETTABLEKS                       R13 R13 K5 ["new"]
       ...
       46 NEWTABLE                         R10 0 1
       48 GETUPVAL                         R11 0
       49 GETTABLEKS                       R11 R11 K8 ["createElement"]
       51 MOVE                             R12 R2
       52 GETUPVAL                         R13 5
...
MAIN:
       ...
       38 GETTABLEKS                       R7 R7 K12 ["Resources"]
       40 GETTABLEKS                       R7 R7 K13 ["PluginTheme"]
       42 CALL                             R6 1 1
       43 GETIMPORT                        R7 K4 [require]
       45 GETTABLEKS                       R8 R0 K11 ["Src"]
       47 GETTABLEKS                       R8 R8 K14 ["Util"]
       49 GETTABLEKS                       R8 R8 K15 ["DebugFlags"]
       51 CALL                             R7 1 1
       52 GETIMPORT                        R8 K4 [require]
       54 GETTABLEKS                       R9 R0 K5 ["Packages"]
       56 GETTABLEKS                       R9 R9 K16 ["Cryo"]
       58 CALL                             R8 1 1
