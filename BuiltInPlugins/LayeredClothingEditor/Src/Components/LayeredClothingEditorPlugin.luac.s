...
PROTO_7:
  ...
  LOADK R7 K35 [""]
  JUMP [+1]
  LOADK R7 K36 ["rbxlocaltheme://AccessoryFittingTool"]
  GETTABLEKS R8 R0 K26 ["localization"]
  LOADK R10 K33 ["Main"]
  LOADK R11 K37 ["ToolbarButton"]
  NAMECALL R8 R8 K31 ["getText"]
  CALL R8 3 -1
  NAMECALL R3 R2 K38 ["CreateButton"]
  CALL R3 -1 1
  SETTABLEKS R3 R0 K39 ["toolbarButton"]
  GETUPVAL R3 11
  GETTABLEKS R5 R0 K1 ["plugin"]
  MOVE R6 R2
  GETTABLEKS R7 R0 K26 ["localization"]
  GETTABLEKS R8 R0 K14 ["analytics"]
  NAMECALL R3 R3 K40 ["init"]
  CALL R3 5 0
  NEWCLOSURE R3 P0
  CAPTURE VAL R0
  CAPTURE UPVAL U12
  CAPTURE VAL R1
  SETTABLEKS R3 R0 K41 ["onClose"]
  NEWCLOSURE R3 P1
  CAPTURE UPVAL U13
  CAPTURE VAL R0
  CAPTURE VAL R1
  CAPTURE UPVAL U12
  SETTABLEKS R3 R0 K42 ["onToggleWidget"]
  GETUPVAL R5 0
  GETTABLEKS R4 R5 K43 ["PluginActions"]
  ...
  CALL R5 2 -1
  CALL R3 -1 1
  SETTABLEKS R3 R0 K44 ["pluginActions"]
  GETUPVAL R4 15
  GETTABLEKS R3 R4 K5 ["new"]
  GETUPVAL R5 16
  GETTABLEKS R4 R5 K45 ["SIGNAL_KEYS"]
  CALL R3 1 1
  SETTABLEKS R3 R0 K46 ["signals"]
  GETUPVAL R4 17
  GETTABLEKS R3 R4 K5 ["new"]
  CALL R3 0 1
  SETTABLEKS R3 R0 K47 ["editingItemContext"]
  GETUPVAL R4 18
  GETTABLEKS R3 R4 K5 ["new"]
  CALL R3 0 1
  GETUPVAL R7 16
  GETTABLEKS R6 R7 K48 ["DEFAULT_FALLOFF"]
  NAMECALL R4 R3 K49 ["setFalloff"]
  CALL R4 2 0
  GETUPVAL R5 19
  GETTABLEKS R4 R5 K5 ["new"]
  NEWTABLE R5 1 0
  GETUPVAL R8 16
  GETTABLEKS R7 R8 K50 ["TOOL_MODE"]
  GETTABLEKS R6 R7 K51 ["Point"]
  SETTABLE R3 R5 R6
  CALL R4 1 1
  SETTABLEKS R4 R0 K52 ["meshEditingContext"]
  GETTABLEKS R5 R0 K39 ["toolbarButton"]
  GETTABLEKS R4 R5 K53 ["Click"]
  GETTABLEKS R6 R0 K42 ["onToggleWidget"]
  NAMECALL R4 R4 K54 ["connect"]
  CALL R4 2 0
  NEWCLOSURE R4 P2
  CAPTURE VAL R1
  CAPTURE VAL R0
  CAPTURE UPVAL U16
  SETTABLEKS R4 R0 K55 ["onFocus"]
  NEWCLOSURE R4 P3
  CAPTURE UPVAL U13
  CAPTURE VAL R0
  SETTABLEKS R4 R0 K56 ["onWidgetEnabledChanged"]
  RETURN R0 0
...
MAIN:
  ...
  LOADK R34 K53 ["FixAvatarTabPluginsNotLoadingOnNonEnglishBuilds"]
  NAMECALL R32 R32 K54 ["GetFastFlag"]
  CALL R32 2 1
  GETIMPORT R33 K20 [game]
  LOADK R35 K55 ["EnableRibbonPlugin"]
  NAMECALL R33 R33 K54 ["GetFastFlag"]
  CALL R33 2 1
  DUPCLOSURE R34 K56 [PROTO_0]
  CAPTURE VAL R27
  CAPTURE VAL R8
  SETTABLEKS R34 R30 K57 ["showEditorInPlayModeError"]
