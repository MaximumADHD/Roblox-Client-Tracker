...
PROTO_8:
  ...
  LOADK R10 K30 ["Main"]
  LOADK R11 K34 ["ToolbarButton"]
  NAMECALL R8 R8 K32 ["getText"]
  CALL R8 3 -1
  NAMECALL R3 R2 K35 ["CreateButton"]
  CALL R3 -1 1
  SETTABLEKS R3 R0 K36 ["toolbarButton"]
  GETUPVAL R3 9
  GETTABLEKS R5 R0 K1 ["plugin"]
  MOVE R6 R2
  GETTABLEKS R7 R0 K26 ["localization"]
  GETTABLEKS R8 R0 K14 ["analytics"]
  NAMECALL R3 R3 K37 ["init"]
  CALL R3 5 0
  NEWCLOSURE R3 P0
  CAPTURE VAL R0
  CAPTURE UPVAL U10
  CAPTURE VAL R1
  SETTABLEKS R3 R0 K38 ["onClose"]
  NEWCLOSURE R3 P1
  CAPTURE UPVAL U11
  CAPTURE VAL R0
  CAPTURE VAL R1
  CAPTURE UPVAL U10
  SETTABLEKS R3 R0 K39 ["onToggleWidget"]
  GETUPVAL R5 0
  GETTABLEKS R4 R5 K40 ["PluginActions"]
  ...
  CALL R5 2 -1
  CALL R3 -1 1
  SETTABLEKS R3 R0 K41 ["pluginActions"]
  GETUPVAL R4 13
  GETTABLEKS R3 R4 K5 ["new"]
  GETUPVAL R5 14
  GETTABLEKS R4 R5 K42 ["SIGNAL_KEYS"]
  CALL R3 1 1
  SETTABLEKS R3 R0 K43 ["signals"]
  GETUPVAL R4 15
  GETTABLEKS R3 R4 K5 ["new"]
  CALL R3 0 1
  SETTABLEKS R3 R0 K44 ["editingItemContext"]
  GETUPVAL R4 16
  GETTABLEKS R3 R4 K5 ["new"]
  CALL R3 0 1
  GETUPVAL R7 14
  GETTABLEKS R6 R7 K45 ["DEFAULT_FALLOFF"]
  NAMECALL R4 R3 K46 ["setFalloff"]
  CALL R4 2 0
  GETUPVAL R5 17
  GETTABLEKS R4 R5 K5 ["new"]
  NEWTABLE R5 1 0
  GETUPVAL R8 14
  GETTABLEKS R7 R8 K47 ["TOOL_MODE"]
  GETTABLEKS R6 R7 K48 ["Point"]
  SETTABLE R3 R5 R6
  CALL R4 1 1
  SETTABLEKS R4 R0 K49 ["meshEditingContext"]
  GETTABLEKS R5 R0 K36 ["toolbarButton"]
  GETTABLEKS R4 R5 K50 ["Click"]
  GETTABLEKS R6 R0 K39 ["onToggleWidget"]
  NAMECALL R4 R4 K51 ["connect"]
  CALL R4 2 0
  NEWCLOSURE R4 P2
  CAPTURE VAL R1
  CAPTURE VAL R0
  CAPTURE UPVAL U14
  SETTABLEKS R4 R0 K52 ["onFocus"]
  NEWCLOSURE R4 P3
  CAPTURE UPVAL U11
  CAPTURE VAL R0
  SETTABLEKS R4 R0 K53 ["onWidgetEnabledChanged"]
  RETURN R0 0
