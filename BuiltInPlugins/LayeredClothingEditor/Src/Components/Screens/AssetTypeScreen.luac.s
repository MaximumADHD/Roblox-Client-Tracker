...
MAIN:
  ...
  LOADK R22 K32 ["AFTHideScaleTypeForLC"]
  LOADB R23 0
  NAMECALL R20 R20 K33 ["DefineFastFlag"]
  CALL R20 3 1
  GETTABLEKS R21 R17 K34 ["wrap"]
  MOVE R22 R19
  ...
  CAPTURE VAL R13
  CAPTURE VAL R14
  SETTABLEKS R21 R19 K36 ["init"]
  DUPCLOSURE R21 K37 [PROTO_3]
  CAPTURE VAL R20
  SETTABLEKS R21 R19 K38 ["didMount"]
  DUPCLOSURE R21 K39 [PROTO_4]
  CAPTURE VAL R1
  CAPTURE VAL R15
  CAPTURE VAL R9
  SETTABLEKS R21 R19 K40 ["render"]
  DUPCLOSURE R21 K41 [PROTO_5]
  CAPTURE VAL R20
  SETTABLEKS R21 R19 K42 ["willUnmount"]
  MOVE R21 R6
  DUPTABLE R22 K45 [{"Stylizer", "Localization", "EditingItemContext"}]
  GETTABLEKS R23 R5 K43 ["Stylizer"]
  SETTABLEKS R23 R22 K43 ["Stylizer"]
  GETTABLEKS R23 R5 K44 ["Localization"]
  SETTABLEKS R23 R22 K44 ["Localization"]
  SETTABLEKS R12 R22 K19 ["EditingItemContext"]
  CALL R21 1 1
  MOVE R22 R19
  CALL R21 1 1
  MOVE R19 R21
  DUPCLOSURE R21 K46 [PROTO_6]
  GETTABLEKS R22 R2 K47 ["connect"]
  MOVE R23 R21
  LOADNIL R24
  CALL R22 2 1
  MOVE R23 R19
