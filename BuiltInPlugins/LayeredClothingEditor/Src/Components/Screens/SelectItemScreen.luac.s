...
PROTO_6:
  ...
  LOADB R5 0
  RETURN R5 1
  LOADK R6 K10 ["LayeredClothingEditorPreview"]
  NAMECALL R4 R0 K11 ["FindFirstAncestor"]
  CALL R4 2 1
...
MAIN:
  ...
  GETTABLEKS R22 R23 K34 ["GetFFlagDebugLCEditAvatarCage"]
  CALL R21 1 1
  GETTABLEKS R23 R3 K33 ["Flags"]
  GETTABLEKS R22 R23 K35 ["GetFFlagAFTSelectModelGroup"]
  GETTABLEKS R23 R11 K9 ["Util"]
  GETTABLEKS R24 R23 K36 ["Typecheck"]
  GETTABLEKS R25 R24 K37 ["wrap"]
  MOVE R26 R20
  GETIMPORT R27 K1 [script]
  CALL R25 2 0
  DUPCLOSURE R25 K38 [PROTO_10]
  CAPTURE VAL R5
  CAPTURE VAL R6
  CAPTURE VAL R19
  CAPTURE VAL R18
  ...
  CAPTURE VAL R22
  CAPTURE VAL R21
  SETTABLEKS R25 R20 K39 ["init"]
  DUPCLOSURE R25 K40 [PROTO_11]
  SETTABLEKS R25 R20 K41 ["didMount"]
  DUPCLOSURE R25 K42 [PROTO_12]
  CAPTURE VAL R1
  CAPTURE VAL R17
  CAPTURE VAL R10
  SETTABLEKS R25 R20 K43 ["render"]
  DUPCLOSURE R25 K44 [PROTO_13]
  SETTABLEKS R25 R20 K45 ["willUnmount"]
  MOVE R25 R13
  DUPTABLE R26 K49 [{"Plugin", "Stylizer", "Localization", "EditingItemContext"}]
  GETTABLEKS R27 R12 K46 ["Plugin"]
  SETTABLEKS R27 R26 K46 ["Plugin"]
  GETTABLEKS R27 R12 K47 ["Stylizer"]
  SETTABLEKS R27 R26 K47 ["Stylizer"]
  GETTABLEKS R27 R12 K48 ["Localization"]
  SETTABLEKS R27 R26 K48 ["Localization"]
  SETTABLEKS R14 R26 K21 ["EditingItemContext"]
  CALL R25 1 1
  MOVE R26 R20
  CALL R25 1 1
  MOVE R20 R25
