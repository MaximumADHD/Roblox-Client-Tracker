PROTO_0:
        0 GETUPVAL                         R1 0
        1 GETUPVAL                         R3 1
        2 GETTABLEKS                       R3 R3 K0 ["screenInfo"]
        4 GETTABLE                         R2 R3 R0
...
PROTO_1:
        0 LOADNIL                          R1
        1 GETUPVAL                         R3 0
        2 GETTABLEKS                       R3 R3 K0 ["screenToIndexMap"]
        4 GETUPVAL                         R4 1
        5 GETTABLE                         R2 R3 R4
        6 JUMPIFNOTEQ                      R0 R2 ; [+27]
        8 GETUPVAL                         R2 0
        9 GETTABLEKS                       R2 R2 K1 ["props"]
       11 GETTABLEKS                       R2 R2 K2 ["EditingItemContext"]
       13 NAMECALL                         R2 R2 K3 ["getSourceItem"]
       15 CALL                             R2 1 1
       16 GETUPVAL                         R3 2
       17 GETTABLEKS                       R3 R3 K4 ["isAvatar"]
       19 MOVE                             R4 R2
       20 CALL                             R3 1 1
       21 JUMPIFNOT                        R3 ; [+6]
       22 GETUPVAL                         R3 0
       23 GETTABLEKS                       R3 R3 K0 ["screenToIndexMap"]
       25 GETUPVAL                         R4 3
       26 GETTABLE                         R1 R3 R4
       27 JUMP                             ; [+7]
       28 GETUPVAL                         R3 0
       29 GETTABLEKS                       R3 R3 K0 ["screenToIndexMap"]
       31 GETUPVAL                         R4 4
       32 GETTABLE                         R1 R3 R4
       33 JUMP                             ; [+1]
       34 ADDK                             R1 R0 K5 [1]
       35 GETUPVAL                         R3 0
       36 GETTABLEKS                       R3 R3 K6 ["screens"]
       38 LENGTH                           R2 R3
       39 MOD                              R1 R1 R2
       40 JUMPIFNOTEQKN                    R1 K7 [0] ; [+6]
       42 GETUPVAL                         R3 0
       43 GETTABLEKS                       R3 R3 K6 ["screens"]
       45 LENGTH                           R2 R3
       46 JUMPIF                           R2 ; [+1]
       47 MOVE                             R2 R1
       48 RETURN                           R2 1
...
PROTO_3:
        ...
        9 GETUPVAL                         R3 1
       10 GETTABLEKS                       R3 R3 K7 ["SCREENS"]
       12 GETTABLEKS                       R3 R3 K8 ["Select"]
       14 SETTABLEKS                       R3 R2 K4 ["Id"]
       16 GETUPVAL                         R3 2
       17 SETTABLEKS                       R3 R2 K5 ["Component"]
       19 DUPTABLE                         R3 K6 [{"Id", "Component"}]
       20 GETUPVAL                         R4 1
       21 GETTABLEKS                       R4 R4 K7 ["SCREENS"]
       23 GETTABLEKS                       R4 R4 K9 ["AssetType"]
       25 SETTABLEKS                       R4 R3 K4 ["Id"]
       27 GETUPVAL                         R4 3
       28 SETTABLEKS                       R4 R3 K5 ["Component"]
       30 DUPTABLE                         R4 K6 [{"Id", "Component"}]
       31 GETUPVAL                         R5 1
       32 GETTABLEKS                       R5 R5 K7 ["SCREENS"]
       34 GETTABLEKS                       R5 R5 K10 ["Edit"]
...
MAIN:
       ...
       22 CALL                             R2 1 1
       23 GETTABLEKS                       R3 R2 K8 ["Contexts"]
       25 GETTABLEKS                       R3 R3 K9 ["EditingItemContext"]
       27 GETTABLEKS                       R4 R2 K10 ["Util"]
       29 GETTABLEKS                       R4 R4 K11 ["AccessoryAndBodyToolShared"]
       31 GETTABLEKS                       R5 R4 K12 ["ItemCharacteristics"]
       33 GETIMPORT                        R6 K4 [require]
       35 GETTABLEKS                       R7 R0 K5 ["Packages"]
       37 GETTABLEKS                       R7 R7 K13 ["Framework"]
       39 CALL                             R6 1 1
       ...
       52 GETTABLEKS                       R12 R12 K19 ["Components"]
       54 GETTABLEKS                       R12 R12 K20 ["Screens"]
       56 GETTABLEKS                       R12 R12 K21 ["AssetTypeScreen"]
       58 CALL                             R11 1 1
       59 GETIMPORT                        R12 K4 [require]
       61 GETTABLEKS                       R13 R0 K18 ["Src"]
       63 GETTABLEKS                       R13 R13 K19 ["Components"]
       65 GETTABLEKS                       R13 R13 K20 ["Screens"]
       67 GETTABLEKS                       R13 R13 K22 ["EditorScreen"]
       69 CALL                             R12 1 1
       70 GETIMPORT                        R13 K4 [require]
       72 GETTABLEKS                       R14 R0 K18 ["Src"]
       74 GETTABLEKS                       R14 R14 K19 ["Components"]
       76 GETTABLEKS                       R14 R14 K20 ["Screens"]
       78 GETTABLEKS                       R14 R14 K23 ["SelectItemScreen"]
       80 CALL                             R13 1 1
       81 GETIMPORT                        R14 K4 [require]
       83 GETTABLEKS                       R15 R0 K18 ["Src"]
       85 GETTABLEKS                       R15 R15 K19 ["Components"]
       87 GETTABLEKS                       R15 R15 K20 ["Screens"]
       89 GETTABLEKS                       R15 R15 K24 ["GenerateScreen"]
       91 CALL                             R14 1 1
       92 GETIMPORT                        R15 K4 [require]
       94 GETTABLEKS                       R16 R0 K18 ["Src"]
       96 GETTABLEKS                       R16 R16 K19 ["Components"]
       98 GETTABLEKS                       R16 R16 K25 ["Preview"]
      100 GETTABLEKS                       R16 R16 K26 ["SelectedEditingItem"]
      102 CALL                             R15 1 1
      103 GETIMPORT                        R16 K4 [require]
      105 GETTABLEKS                       R17 R0 K18 ["Src"]
      107 GETTABLEKS                       R17 R17 K10 ["Util"]
      109 GETTABLEKS                       R17 R17 K27 ["AnalyticsGlobals"]
      111 CALL                             R16 1 1
      112 GETIMPORT                        R17 K4 [require]
      114 GETTABLEKS                       R18 R0 K18 ["Src"]
      116 GETTABLEKS                       R18 R18 K10 ["Util"]
      118 GETTABLEKS                       R18 R18 K28 ["Constants"]
      120 CALL                             R17 1 1
