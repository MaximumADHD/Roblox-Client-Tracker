PROTO_0:
        ...
        3 GETTABLEKS                       R1 R1 K1 ["SetToolMode"]
        5 MOVE                             R2 R0
        6 CALL                             R1 1 0
        7 GETUPVAL                         R1 0
        8 GETTABLEKS                       R1 R1 K0 ["props"]
       10 GETTABLEKS                       R1 R1 K2 ["Signals"]
       12 GETUPVAL                         R3 1
       13 GETTABLEKS                       R3 R3 K3 ["SIGNAL_KEYS"]
       15 GETTABLEKS                       R3 R3 K4 ["SelectionChanged"]
       17 NAMECALL                         R1 R1 K5 ["get"]
       19 CALL                             R1 2 1
       20 NAMECALL                         R1 R1 K6 ["Fire"]
       22 CALL                             R1 1 0
       23 GETUPVAL                         R1 0
       24 GETTABLEKS                       R1 R1 K0 ["props"]
       26 GETTABLEKS                       R1 R1 K2 ["Signals"]
       28 GETUPVAL                         R3 1
       29 GETTABLEKS                       R3 R3 K3 ["SIGNAL_KEYS"]
       31 GETTABLEKS                       R3 R3 K7 ["ToolChanged"]
...
PROTO_2:
       ...
       10 GETUPVAL                         R7 0
       11 GETTABLEKS                       R7 R7 K5 ["EDIT_MODE"]
       13 GETTABLEKS                       R7 R7 K6 ["Mesh"]
       15 JUMPIFEQ                         R4 R7 ; [+2]
       17 LOADB                            R6 0 +1
       18 LOADB                            R6 1
       19 LOADB                            R7 0
       ...
       22 NOT                              R7 R6
       23 GETUPVAL                         R8 1
       24 GETTABLEKS                       R8 R8 K7 ["RunRhodiumTests"]
       26 CALL                             R8 0 1
       27 JUMPIF                           R8 ; [+4]
       28 GETUPVAL                         R8 1
       29 GETTABLEKS                       R8 R8 K8 ["RunTests"]
       31 CALL                             R8 0 1
       32 GETUPVAL                         R9 2
       33 GETTABLEKS                       R9 R9 K9 ["createFragment"]
       35 DUPTABLE                         R10 K13 [{"WorkspaceEditorControls", "MeshPartTool", "LuaMeshEditingModuleWrapper"}]
       36 GETUPVAL                         R11 2
       37 GETTABLEKS                       R11 R11 K14 ["createElement"]
       39 GETUPVAL                         R12 3
       40 CALL                             R11 1 1
       ...
       53 JUMPIFNOT                        R7 ; [+6]
       54 GETUPVAL                         R11 2
       55 GETTABLEKS                       R11 R11 K14 ["createElement"]
       57 GETUPVAL                         R12 5
       58 CALL                             R11 1 1
       59 JUMPIF                           R11 ; [+1]
       60 LOADNIL                          R11
...
PROTO_3:
        ...
        3 GETTABLEKS                       R3 R3 K1 ["LuaMeshEditingModuleContext"]
        5 GETTABLEKS                       R4 R1 K2 ["ToolMode"]
        7 GETTABLEKS                       R5 R0 K0 ["props"]
        9 GETTABLEKS                       R5 R5 K2 ["ToolMode"]
       11 JUMPIFEQ                         R4 R5 ; [+40]
       13 GETTABLEKS                       R4 R1 K2 ["ToolMode"]
       15 GETUPVAL                         R5 0
       16 GETTABLEKS                       R5 R5 K3 ["TOOL_MODE"]
       18 GETTABLEKS                       R5 R5 K4 ["Point"]
       20 JUMPIFEQ                         R4 R5 ; [+10]
       22 GETTABLEKS                       R4 R1 K2 ["ToolMode"]
       24 GETUPVAL                         R5 0
       25 GETTABLEKS                       R5 R5 K3 ["TOOL_MODE"]
       27 GETTABLEKS                       R5 R5 K5 ["Lattice"]
       ...
       40 GETUPVAL                         R5 0
       41 GETTABLEKS                       R5 R5 K3 ["TOOL_MODE"]
       43 GETTABLEKS                       R5 R5 K7 ["Reset"]
       45 JUMPIFEQ                         R4 R5 ; [+6]
       47 LOADNIL                          R6
       ...
       60 GETTABLEKS                       R5 R0 K0 ["props"]
       62 GETTABLEKS                       R5 R5 K2 ["ToolMode"]
       64 JUMPIFEQ                         R4 R5 ; [+7]
...
MAIN:
       ...
       43 GETTABLEKS                       R7 R7 K13 ["Signals"]
       45 GETTABLEKS                       R8 R3 K12 ["Contexts"]
       47 GETTABLEKS                       R8 R8 K14 ["LuaMeshEditingModuleContext"]
       49 GETIMPORT                        R9 K4 [require]
       51 GETTABLEKS                       R10 R0 K15 ["Src"]
       53 GETTABLEKS                       R10 R10 K16 ["Components"]
       55 GETTABLEKS                       R10 R10 K17 ["MeshPartTool"]
       57 CALL                             R9 1 1
       58 GETIMPORT                        R10 K4 [require]
       60 GETTABLEKS                       R11 R0 K15 ["Src"]
       62 GETTABLEKS                       R11 R11 K16 ["Components"]
       64 GETTABLEKS                       R11 R11 K18 ["Draggers"]
       66 GETTABLEKS                       R11 R11 K19 ["LuaMeshEditingModuleWrapper"]
       68 CALL                             R10 1 1
       69 GETIMPORT                        R11 K4 [require]
       71 GETTABLEKS                       R12 R0 K15 ["Src"]
       73 GETTABLEKS                       R12 R12 K20 ["Actions"]
       75 GETTABLEKS                       R12 R12 K21 ["SetToolMode"]
       77 CALL                             R11 1 1
       78 GETIMPORT                        R12 K4 [require]
       80 GETTABLEKS                       R13 R0 K15 ["Src"]
       82 GETTABLEKS                       R13 R13 K22 ["Util"]
       84 GETTABLEKS                       R13 R13 K23 ["Constants"]
       86 CALL                             R12 1 1
       87 GETIMPORT                        R13 K4 [require]
       89 GETTABLEKS                       R14 R0 K15 ["Src"]
       91 GETTABLEKS                       R14 R14 K22 ["Util"]
       93 GETTABLEKS                       R14 R14 K24 ["DebugFlags"]
       95 CALL                             R13 1 1
      ...
      106 GETTABLEKS                       R16 R16 K16 ["Components"]
      108 GETTABLEKS                       R16 R16 K28 ["Editor"]
      110 GETTABLEKS                       R16 R16 K29 ["WorkspaceEditorControls"]
      112 CALL                             R15 1 1
