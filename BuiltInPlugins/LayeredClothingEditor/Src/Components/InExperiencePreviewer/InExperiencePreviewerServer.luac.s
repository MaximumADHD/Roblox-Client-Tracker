PROTO_0:
       ...
       42 CALL                             R9 2 0
       43 NAMECALL                         R9 R7 K11 ["GetPrimaryPartCFrame"]
       45 CALL                             R9 1 1
       46 GETTABLEKS                       R9 R9 K12 ["p"]
       48 JUMPIFNOT                        R3 ; [+11]
       49 GETUPVAL                         R10 0
...
PROTO_1:
        ...
        8 GETUPVAL                         R2 0
        9 GETTABLEKS                       R2 R2 K5 ["PREVIEW_REMOTE_EVENT_NAME"]
...
PROTO_4:
        ...
        1 GETUPVAL                         R2 1
        2 GETUPVAL                         R4 2
        3 GETTABLEKS                       R4 R4 K0 ["Avatars"]
        5 GETUPVAL                         R5 2
        6 GETTABLEKS                       R5 R5 K1 ["CurrentIndex"]
        8 GETTABLE                         R3 R4 R5
        9 LOADB                            R4 1
...
PROTO_6:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["diedHandle"]
        3 JUMPIFNOT                        R1 ; [+6]
        4 GETUPVAL                         R1 0
        5 GETTABLEKS                       R1 R1 K0 ["diedHandle"]
        7 NAMECALL                         R1 R1 K1 ["Disconnect"]
        9 CALL                             R1 1 0
       10 GETUPVAL                         R1 0
       11 LOADK                            R4 K2 ["Humanoid"]
       12 NAMECALL                         R2 R0 K3 ["WaitForChild"]
       14 CALL                             R2 2 1
       15 GETTABLEKS                       R2 R2 K4 ["Died"]
       17 NEWCLOSURE                       R4 P0
       18 CAPTURE                          UPVAL U1
       19 CAPTURE                          UPVAL U2
       20 CAPTURE                          UPVAL U0
...
PROTO_7:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R2 R2 K0 ["playerPreviewAvatarData"]
...
PROTO_8:
        0 GETUPVAL                         R3 0
        1 GETTABLEKS                       R3 R3 K0 ["playerPreviewAvatarData"]
...
PROTO_9:
        ...
        6 GETUPVAL                         R3 0
        7 GETTABLEKS                       R3 R3 K1 ["PlayerAdded"]
        9 NEWCLOSURE                       R5 P0
       10 CAPTURE                          VAL R0
       ...
       20 GETTABLEKS                       R3 R0 K6 ["previewChangedEvent"]
       22 GETTABLEKS                       R3 R3 K7 ["OnServerEvent"]
       24 NEWCLOSURE                       R5 P1
       25 CAPTURE                          VAL R0
...
MAIN:
       ...
       35 GETTABLEKS                       R5 R5 K13 ["Constants"]
       37 CALL                             R4 1 1
       38 NEWTABLE                         R5 8 0
