...
MAIN:
  ...
  LOADK R7 K14 ["InExperiencePreviewUseSpawnLocation"]
  LOADB R8 0
  ...
  CAPTURE VAL R5
  CAPTURE VAL R2
  SETTABLEKS R7 R6 K17 ["switchToAvatar"]
  DUPCLOSURE R7 K18 [PROTO_1]
  CAPTURE VAL R4
  CAPTURE VAL R1
  SETTABLEKS R7 R6 K19 ["initRemoteEvents"]
  DUPCLOSURE R7 K20 [PROTO_2]
  SETTABLEKS R7 R6 K21 ["destroyRemoteEvents"]
  DUPCLOSURE R7 K22 [PROTO_3]
  CAPTURE VAL R1
  CAPTURE VAL R4
  SETTABLEKS R7 R6 K23 ["initPlayerPreviewData"]
  DUPCLOSURE R7 K24 [PROTO_9]
  CAPTURE VAL R0
  CAPTURE VAL R5
  SETTABLEKS R7 R6 K25 ["initConnections"]
  DUPCLOSURE R7 K26 [PROTO_10]
  SETTABLEKS R7 R6 K27 ["destroyConnections"]
  DUPCLOSURE R7 K28 [PROTO_11]
  CAPTURE VAL R0
  SETTABLEKS R7 R6 K29 ["init"]
  DUPCLOSURE R7 K30 [PROTO_12]
  SETTABLEKS R7 R6 K31 ["shutdown"]
  RETURN R6 1
