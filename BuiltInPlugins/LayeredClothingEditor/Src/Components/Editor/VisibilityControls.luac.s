...
MAIN:
  ...
  LOADK R22 K34 ["FixAFTOpacityModeBug"]
  LOADB R23 0
  NAMECALL R20 R20 K35 ["DefineFastFlag"]
  CALL R20 3 1
  DUPTABLE R21 K37 [{"Offset"}]
  LOADN R22 0
  SETTABLEKS R22 R21 K36 ["Offset"]
  SETTABLEKS R21 R17 K38 ["defaultProps"]
  DUPCLOSURE R21 K39 [PROTO_4]
  CAPTURE VAL R16
  CAPTURE VAL R20
  CAPTURE VAL R4
  SETTABLEKS R21 R17 K40 ["init"]
  DUPCLOSURE R21 K41 [PROTO_5]
  SETTABLEKS R21 R17 K42 ["didMount"]
  DUPCLOSURE R21 K43 [PROTO_6]
  SETTABLEKS R21 R17 K44 ["didUpdate"]
  DUPCLOSURE R21 K45 [PROTO_7]
  CAPTURE VAL R16
  CAPTURE VAL R19
  CAPTURE VAL R1
  CAPTURE VAL R12
  ...
  MOVE R21 R9
  DUPTABLE R22 K50 [{"Analytics", "EditingItemContext", "Localization", "Stylizer"}]
  GETTABLEKS R23 R8 K47 ["Analytics"]
  SETTABLEKS R23 R22 K47 ["Analytics"]
  SETTABLEKS R3 R22 K9 ["EditingItemContext"]
  GETTABLEKS R23 R8 K48 ["Localization"]
  SETTABLEKS R23 R22 K48 ["Localization"]
  GETTABLEKS R23 R8 K49 ["Stylizer"]
