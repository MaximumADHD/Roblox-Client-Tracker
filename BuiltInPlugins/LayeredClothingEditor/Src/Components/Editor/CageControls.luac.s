...
MAIN:
  ...
  CALL R22 1 1
  GETTABLEKS R24 R3 K36 ["Flags"]
  GETTABLEKS R23 R24 K37 ["GetFFlagAFTSupportAdditionalAnalyticsLogging"]
  GETTABLEKS R24 R1 K38 ["PureComponent"]
  LOADK R26 K39 ["CageControls"]
  NAMECALL R24 R24 K40 ["extend"]
  CALL R24 2 1
  GETTABLEKS R25 R13 K15 ["Util"]
  GETTABLEKS R26 R25 K41 ["LayoutOrderIterator"]
  DUPCLOSURE R27 K42 [PROTO_6]
  CAPTURE VAL R9
  CAPTURE VAL R23
  CAPTURE VAL R22
  SETTABLEKS R27 R24 K43 ["init"]
  DUPCLOSURE R27 K44 [PROTO_7]
  CAPTURE VAL R1
  CAPTURE VAL R19
  CAPTURE VAL R21
  SETTABLEKS R27 R24 K45 ["renderButton"]
  DUPCLOSURE R27 K46 [PROTO_8]
  CAPTURE VAL R9
  SETTABLEKS R27 R24 K47 ["didMount"]
  ...
  CAPTURE VAL R12
  CAPTURE VAL R6
  SETTABLEKS R27 R24 K49 ["render"]
  DUPCLOSURE R27 K50 [PROTO_12]
  CAPTURE VAL R10
  CAPTURE VAL R11
  MOVE R28 R15
  DUPTABLE R29 K54 [{"Analytics", "Signals", "Localization", "EditingItemContext", "Stylizer"}]
  MOVE R31 R23
  CALL R31 0 1
  JUMPIFNOT R31 [+3]
  GETTABLEKS R30 R14 K51 ["Analytics"]
  JUMP [+1]
  LOADNIL R30
  SETTABLEKS R30 R29 K51 ["Analytics"]
  SETTABLEKS R4 R29 K10 ["Signals"]
  GETTABLEKS R30 R14 K52 ["Localization"]
  SETTABLEKS R30 R29 K52 ["Localization"]
  SETTABLEKS R5 R29 K11 ["EditingItemContext"]
  GETTABLEKS R30 R14 K53 ["Stylizer"]
  SETTABLEKS R30 R29 K53 ["Stylizer"]
  CALL R28 1 1
  MOVE R29 R24
  CALL R28 1 1
  MOVE R24 R28
  GETTABLEKS R28 R2 K55 ["connect"]
  LOADNIL R29
  MOVE R30 R27
  CALL R28 2 1
  MOVE R29 R24
