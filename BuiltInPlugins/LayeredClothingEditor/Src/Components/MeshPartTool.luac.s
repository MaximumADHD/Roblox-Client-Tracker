...
PROTO_15:
  ...
  CALL R10 3 -1
  RETURN R10 -1
  GETTABLEKS R7 R4 K11 ["Position"]
  GETUPVAL R9 1
  GETTABLEKS R8 R9 K12 ["createElement"]
  GETUPVAL R10 1
  GETTABLEKS R9 R10 K13 ["Portal"]
  DUPTABLE R10 K15 [{"target"}]
  GETUPVAL R11 2
  SETTABLEKS R11 R10 K14 ["target"]
  DUPTABLE R11 K17 [{"BoundingBox"}]
  MOVE R14 R5
  MOVE R15 R6
  MOVE R16 R7
  GETTABLEKS R17 R4 K7 ["Parent"]
  NAMECALL R12 R0 K18 ["renderBorderedBox"]
  CALL R12 5 1
  SETTABLEKS R12 R11 K16 ["BoundingBox"]
  CALL R8 3 -1
  RETURN R8 -1
...
MAIN:
  ...
  LOADK R5 K7 ["ChangeHistoryService"]
  ...
  GETTABLEKS R8 R9 K16 ["AvatarToolsShared"]
  CALL R7 1 1
  GETTABLEKS R9 R7 K17 ["Util"]
  GETTABLEKS R8 R9 K18 ["AccessoryAndBodyToolShared"]
  GETTABLEKS R9 R8 K19 ["Constants"]
  GETTABLEKS R10 R8 K20 ["AccessoryUtil"]
  GETTABLEKS R11 R8 K21 ["ItemCharacteristics"]
  GETIMPORT R12 K12 [require]
  GETTABLEKS R15 R4 K22 ["Src"]
  GETTABLEKS R14 R15 K23 ["Actions"]
  GETTABLEKS R13 R14 K24 ["SetAttachmentPoint"]
  CALL R12 1 1
  GETIMPORT R13 K12 [require]
  GETTABLEKS R16 R4 K22 ["Src"]
  GETTABLEKS R15 R16 K23 ["Actions"]
  GETTABLEKS R14 R15 K25 ["SetItemSize"]
  CALL R13 1 1
  GETIMPORT R14 K12 [require]
  GETTABLEKS R17 R4 K22 ["Src"]
  GETTABLEKS R16 R17 K23 ["Actions"]
  GETTABLEKS R15 R16 K26 ["SetMeshScale"]
  CALL R14 1 1
  GETIMPORT R15 K12 [require]
  GETTABLEKS R18 R4 K22 ["Src"]
  GETTABLEKS R17 R18 K27 ["Thunks"]
  GETTABLEKS R16 R17 K28 ["VerifyBounds"]
  CALL R15 1 1
  GETIMPORT R16 K12 [require]
  GETTABLEKS R19 R4 K22 ["Src"]
  GETTABLEKS R18 R19 K23 ["Actions"]
  GETTABLEKS R17 R18 K29 ["SetControlsPanelBlockerActivity"]
  CALL R16 1 1
  GETIMPORT R17 K12 [require]
  GETTABLEKS R20 R4 K22 ["Src"]
  GETTABLEKS R19 R20 K23 ["Actions"]
  GETTABLEKS R18 R19 K30 ["SetControlsPanelBlockerMessage"]
  CALL R17 1 1
  GETIMPORT R18 K12 [require]
  GETTABLEKS R21 R4 K22 ["Src"]
  GETTABLEKS R20 R21 K23 ["Actions"]
  GETTABLEKS R19 R20 K31 ["SetWorkspacePreviewSelectionEnabled"]
  CALL R18 1 1
  GETTABLEKS R20 R7 K32 ["Contexts"]
  GETTABLEKS R19 R20 K33 ["EditingItemContext"]
  GETTABLEKS R21 R7 K32 ["Contexts"]
  GETTABLEKS R20 R21 K34 ["Signals"]
  GETIMPORT R21 K12 [require]
  GETTABLEKS R24 R4 K22 ["Src"]
  GETTABLEKS R23 R24 K17 ["Util"]
  GETTABLEKS R22 R23 K19 ["Constants"]
  CALL R21 1 1
  GETIMPORT R22 K12 [require]
  GETTABLEKS R25 R4 K22 ["Src"]
  GETTABLEKS R24 R25 K17 ["Util"]
  GETTABLEKS R23 R24 K35 ["AnalyticsGlobals"]
  CALL R22 1 1
  GETIMPORT R23 K12 [require]
  GETTABLEKS R25 R4 K13 ["Packages"]
  GETTABLEKS R24 R25 K36 ["Framework"]
  CALL R23 1 1
  GETTABLEKS R24 R23 K37 ["ContextServices"]
  GETTABLEKS R25 R24 K38 ["withContext"]
  GETTABLEKS R27 R7 K39 ["Flags"]
  GETTABLEKS R26 R27 K40 ["GetFFlagAFTSelectHandleOnly"]
  GETTABLEKS R27 R5 K41 ["PureComponent"]
  LOADK R29 K42 ["MeshPartTool"]
  NAMECALL R27 R27 K43 ["extend"]
  CALL R27 2 1
  DUPCLOSURE R28 K44 [PROTO_0]
  SETTABLEKS R28 R27 K45 ["getHandleAttachment"]
  ...
  CAPTURE VAL R3
  SETTABLEKS R28 R27 K49 ["activate"]
  DUPCLOSURE R28 K50 [PROTO_11]
  CAPTURE VAL R26
  CAPTURE VAL R3
  CAPTURE VAL R21
  CAPTURE VAL R2
  SETTABLEKS R28 R27 K51 ["didMount"]
  DUPCLOSURE R28 K52 [PROTO_12]
  CAPTURE VAL R26
  SETTABLEKS R28 R27 K53 ["didUpdate"]
  DUPCLOSURE R28 K54 [PROTO_13]
  CAPTURE VAL R9
  CAPTURE VAL R5
  SETTABLEKS R28 R27 K55 ["renderLinks"]
  DUPCLOSURE R28 K56 [PROTO_14]
  CAPTURE VAL R5
  SETTABLEKS R28 R27 K57 ["renderBorderedBox"]
  DUPCLOSURE R28 K58 [PROTO_15]
  CAPTURE VAL R0
  CAPTURE VAL R5
  CAPTURE VAL R1
  SETTABLEKS R28 R27 K59 ["render"]
  DUPCLOSURE R28 K60 [PROTO_16]
  SETTABLEKS R28 R27 K61 ["deactivate"]
  DUPCLOSURE R28 K62 [PROTO_17]
  CAPTURE VAL R26
  SETTABLEKS R28 R27 K63 ["willUnmount"]
  MOVE R28 R25
  DUPTABLE R29 K67 [{"Analytics", "Stylizer", "Localization", "EditingItemContext", "Signals"}]
  GETTABLEKS R30 R24 K64 ["Analytics"]
  SETTABLEKS R30 R29 K64 ["Analytics"]
  GETTABLEKS R30 R24 K65 ["Stylizer"]
  SETTABLEKS R30 R29 K65 ["Stylizer"]
  MOVE R31 R26
  CALL R31 0 1
  JUMPIFNOT R31 [+3]
  GETTABLEKS R30 R24 K66 ["Localization"]
  JUMP [+1]
  LOADNIL R30
  SETTABLEKS R30 R29 K66 ["Localization"]
  SETTABLEKS R19 R29 K33 ["EditingItemContext"]
  SETTABLEKS R20 R29 K34 ["Signals"]
  CALL R28 1 1
  MOVE R29 R27
  CALL R28 1 1
  MOVE R27 R28
