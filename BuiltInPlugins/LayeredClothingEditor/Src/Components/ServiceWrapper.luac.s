PROTO_0:
      ...
      102 GETTABLEKS                       R3 R3 K17 ["pluginActions"]
      ...
      116 GETTABLEKS                       R3 R3 K19 ["signals"]
      ...
      127 CALL                             R1 2 0
      128 GETTABLEKS                       R3 R0 K0 ["props"]
      130 GETTABLEKS                       R3 R3 K21 ["editingItemContext"]
      ...
      141 CALL                             R1 2 0
      142 GETTABLEKS                       R3 R0 K0 ["props"]
      144 GETTABLEKS                       R3 R3 K23 ["meshEditingContext"]
...
PROTO_1:
        ...
        6 GETTABLEKS                       R2 R2 K2 ["analytics"]
        8 GETTABLEKS                       R4 R0 K0 ["props"]
       10 GETUPVAL                         R5 0
       11 GETTABLEKS                       R5 R5 K3 ["Children"]
       ...
       24 GETTABLEKS                       R6 R6 K6 ["store"]
       26 GETTABLEKS                       R7 R0 K0 ["props"]
       28 GETTABLEKS                       R7 R7 K7 ["theme"]
       30 GETTABLEKS                       R8 R0 K0 ["props"]
       32 GETTABLEKS                       R8 R8 K8 ["pluginActions"]
       34 GETTABLEKS                       R9 R0 K0 ["props"]
       36 GETTABLEKS                       R9 R9 K9 ["signals"]
       38 GETTABLEKS                       R10 R0 K0 ["props"]
       40 GETTABLEKS                       R10 R10 K10 ["editingItemContext"]
       42 GETTABLEKS                       R11 R0 K0 ["props"]
       44 GETTABLEKS                       R11 R11 K11 ["meshEditingContext"]
       46 GETUPVAL                         R12 1
       47 GETTABLEKS                       R12 R12 K12 ["provide"]
       ...
       54 MOVE                             R17 R7
       55 GETUPVAL                         R18 1
       56 GETTABLEKS                       R18 R18 K13 ["Store"]
       58 GETTABLEKS                       R18 R18 K14 ["new"]
       60 MOVE                             R19 R6
       61 CALL                             R18 1 1
       62 GETUPVAL                         R19 1
       63 GETTABLEKS                       R19 R19 K15 ["API"]
       65 GETTABLEKS                       R19 R19 K14 ["new"]
       67 CALL                             R19 0 1
       68 MOVE                             R20 R8
       69 MOVE                             R21 R9
       70 GETUPVAL                         R22 1
       71 GETTABLEKS                       R22 R22 K16 ["Mouse"]
       73 GETTABLEKS                       R22 R22 K14 ["new"]
       75 MOVE                             R23 R5
       76 CALL                             R22 1 1
       77 MOVE                             R23 R10
       78 MOVE                             R24 R11
       79 GETUPVAL                         R25 2
       80 GETTABLEKS                       R25 R25 K14 ["new"]
       82 CALL                             R25 0 1
       83 GETUPVAL                         R26 3
       84 GETTABLEKS                       R26 R26 K14 ["new"]
       86 CALL                             R26 0 1
       87 GETUPVAL                         R27 4
       88 GETTABLEKS                       R27 R27 K14 ["new"]
       90 CALL                             R27 0 -1
...
MAIN:
       ...
       32 GETTABLEKS                       R5 R3 K10 ["Contexts"]
       34 GETTABLEKS                       R5 R5 K11 ["AssetServiceWrapper"]
       36 GETTABLEKS                       R6 R3 K10 ["Contexts"]
       38 GETTABLEKS                       R6 R6 K12 ["StudioServiceWrapper"]
       40 GETTABLEKS                       R7 R3 K10 ["Contexts"]
       42 GETTABLEKS                       R7 R7 K13 ["MannequinContext"]
