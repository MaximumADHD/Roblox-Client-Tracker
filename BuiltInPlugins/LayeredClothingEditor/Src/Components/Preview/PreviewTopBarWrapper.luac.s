PROTO_0:
        ...
        3 GETTABLEKS                       R1 R1 K1 ["SetSearchFilter"]
        5 MOVE                             R2 R0
        6 CALL                             R1 1 0
        7 RETURN                           R0 0
...
PROTO_1:
       ...
       12 GETUPVAL                         R4 1
       13 GETTABLEKS                       R4 R4 K6 ["SELECTOR_MODE"]
       15 GETTABLEKS                       R4 R4 K2 ["Preview"]
       17 MOVE                             R5 R2
       18 CALL                             R3 2 0
       19 RETURN                           R0 0
...
PROTO_2:
        ...
        2 GETUPVAL                         R2 0
        3 GETTABLEKS                       R2 R2 K2 ["getTabs"]
        5 CALL                             R2 0 -1
        6 CALL                             R1 -1 3
        7 FORGPREP_NEXT                    R1
        8 GETUPVAL                         R6 1
        9 GETTABLEKS                       R6 R6 K3 ["isInstanceValidForTab"]
       11 MOVE                             R7 R4
       12 MOVE                             R8 R0
       13 CALL                             R6 2 1
       14 JUMPIFNOT                        R6 ; [+1]
...
PROTO_3:
        ...
        7 CALL                             R3 1 1
        8 GETUPVAL                         R4 1
        9 GETTABLEKS                       R4 R4 K3 ["getTabInfo"]
       11 MOVE                             R5 R0
       12 CALL                             R4 1 1
       13 JUMPIFNOT                        R4 ; [+5]
...
PROTO_4:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["getTabForInstance"]
        3 MOVE                             R2 R0
        4 CALL                             R1 1 1
        5 JUMPIFNOT                        R1 ; [+2]
        6 LOADB                            R1 1
...
PROTO_5:
        ...
        2 CALL                             R0 1 0
        3 GETUPVAL                         R0 2
        4 GETTABLEKS                       R0 R0 K0 ["getTabForInstance"]
        6 GETUPVAL                         R1 1
        7 CALL                             R0 1 1
        8 JUMPIFNOT                        R0 ; [+10]
        9 GETUPVAL                         R1 3
       10 GETTABLEKS                       R1 R1 K1 ["AddUserAddedAssetForPreview"]
       12 MOVE                             R2 R0
       13 GETUPVAL                         R3 1
       ...
       24 JUMPIFNOT                        R1 ; [+26]
       25 GETUPVAL                         R1 2
       26 GETTABLEKS                       R1 R1 K5 ["previewFolder"]
       28 GETUPVAL                         R3 1
       29 NAMECALL                         R1 R1 K6 ["addFolderPath"]
       31 CALL                             R1 2 0
       32 GETUPVAL                         R1 2
       33 GETTABLEKS                       R1 R1 K5 ["previewFolder"]
       35 GETUPVAL                         R3 2
       36 GETTABLEKS                       R3 R3 K7 ["props"]
       38 GETTABLEKS                       R3 R3 K8 ["UserAddedAssets"]
       40 GETUPVAL                         R4 2
       41 GETTABLEKS                       R4 R4 K9 ["isInstanceValidForTab"]
       43 GETUPVAL                         R5 2
       44 GETTABLEKS                       R5 R5 K7 ["props"]
       46 GETTABLEKS                       R5 R5 K1 ["AddUserAddedAssetForPreview"]
...
PROTO_6:
       ...
       23 GETTABLEKS                       R4 R4 K2 ["Localization"]
...
PROTO_10:
        ...
        6 GETTABLEKS                       R3 R3 K3 ["UserAddedAssets"]
        8 CALL                             R2 1 1
        9 JUMPIF                           R2 ; [+5]
...
MAIN:
       ...
       47 GETTABLEKS                       R9 R4 K14 ["Util"]
       49 GETTABLEKS                       R9 R9 K15 ["AccessoryAndBodyToolShared"]
       ...
       61 GETTABLEKS                       R15 R0 K5 ["Packages"]
       63 GETTABLEKS                       R15 R15 K20 ["Framework"]
       65 CALL                             R14 1 1
       ...
       78 GETTABLEKS                       R21 R0 K25 ["Src"]
       80 GETTABLEKS                       R21 R21 K26 ["Actions"]
       82 GETTABLEKS                       R21 R21 K27 ["SetSearchFilter"]
       84 CALL                             R20 1 1
       85 GETIMPORT                        R21 K4 [require]
       87 GETTABLEKS                       R22 R0 K25 ["Src"]
       89 GETTABLEKS                       R22 R22 K28 ["Thunks"]
       91 GETTABLEKS                       R22 R22 K29 ["StartSelectingFromExplorer"]
       93 CALL                             R21 1 1
       94 GETIMPORT                        R22 K4 [require]
       96 GETTABLEKS                       R23 R0 K25 ["Src"]
       98 GETTABLEKS                       R23 R23 K28 ["Thunks"]
      100 GETTABLEKS                       R23 R23 K30 ["FinishSelectingFromExplorer"]
      102 CALL                             R22 1 1
      103 GETIMPORT                        R23 K4 [require]
      105 GETTABLEKS                       R24 R0 K25 ["Src"]
      107 GETTABLEKS                       R24 R24 K28 ["Thunks"]
      109 GETTABLEKS                       R24 R24 K31 ["DeleteUserAddedAssetForPreview"]
      111 CALL                             R23 1 1
      112 GETIMPORT                        R24 K4 [require]
      114 GETTABLEKS                       R25 R0 K25 ["Src"]
      116 GETTABLEKS                       R25 R25 K28 ["Thunks"]
      118 GETTABLEKS                       R25 R25 K32 ["AddUserAddedAssetForPreview"]
      120 CALL                             R24 1 1
      121 GETTABLEKS                       R25 R4 K33 ["Contexts"]
      123 GETTABLEKS                       R25 R25 K34 ["EditingItemContext"]
      125 GETIMPORT                        R26 K4 [require]
      127 GETTABLEKS                       R27 R0 K25 ["Src"]
      129 GETTABLEKS                       R27 R27 K14 ["Util"]
      131 GETTABLEKS                       R27 R27 K16 ["Constants"]
      133 CALL                             R26 1 1
      134 GETIMPORT                        R27 K4 [require]
      136 GETTABLEKS                       R28 R0 K25 ["Src"]
      138 GETTABLEKS                       R28 R28 K14 ["Util"]
      140 GETTABLEKS                       R28 R28 K35 ["ShowDialog"]
      142 CALL                             R27 1 1
