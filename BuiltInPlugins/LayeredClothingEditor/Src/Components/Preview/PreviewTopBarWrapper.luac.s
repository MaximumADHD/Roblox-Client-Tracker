...
PROTO_1:
  ...
  JUMP [+5]
  LOADK R4 K2 ["Preview"]
  LOADK R5 K5 ["PanelBlockerAddItem"]
  NAMECALL R2 R1 K4 ["getText"]
  CALL R2 3 1
  GETTABLEKS R3 R0 K6 ["StartSelectingFromExplorer"]
  GETUPVAL R6 2
  GETTABLEKS R5 R6 K7 ["SELECTOR_MODE"]
...
PROTO_6:
  ...
  JUMP [+1]
  LOADNIL R11
  SETTABLEKS R11 R10 K14 ["OnClose"]
  NEWCLOSURE R11 P0
  CAPTURE VAL R2
  CAPTURE VAL R0
  CAPTURE UPVAL U0
...
MAIN:
  ...
  CALL R27 1 1
  GETTABLEKS R29 R4 K36 ["Flags"]
  GETTABLEKS R28 R29 K37 ["GetFFlagEscapeInputBlocker"]
  GETTABLEKS R29 R1 K38 ["PureComponent"]
  LOADK R31 K39 ["PreviewTopBarWrapper"]
  NAMECALL R29 R29 K40 ["extend"]
  CALL R29 2 1
  GETTABLEKS R30 R19 K41 ["wrap"]
  MOVE R31 R29
  ...
  MOVE R30 R16
  DUPTABLE R31 K51 [{"Stylizer", "Localization", "Plugin", "EditingItemContext"}]
  GETTABLEKS R32 R15 K48 ["Stylizer"]
  SETTABLEKS R32 R31 K48 ["Stylizer"]
  GETTABLEKS R32 R15 K49 ["Localization"]
  SETTABLEKS R32 R31 K49 ["Localization"]
  GETTABLEKS R32 R15 K50 ["Plugin"]
  SETTABLEKS R32 R31 K50 ["Plugin"]
  SETTABLEKS R25 R31 K34 ["EditingItemContext"]
  CALL R30 1 1
  MOVE R31 R29
  CALL R30 1 1
  MOVE R29 R30
