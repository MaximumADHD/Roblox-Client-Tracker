return function()
	...
	itSKIP("transparency sliders exist for caged item", function()
	...
	itSKIP("transparency sliders exist for rigid item", function()
		runRhodiumTest(function()
	...
	itSKIP("change mesh transparency for clothes", function()
	...
	itSKIP("change inner cage transparency for clothes", function()
	...
	itSKIP("change outer cage transparency for clothes", function()
		runRhodiumTest(function()
			TestHelper.goToEditScreenFromStart(true)
			expect(TestHelper.waitForXPathInstance(PointToolTabButton)).to.be.ok()
			TestHelper.clickXPath(PointToolTabButton)
