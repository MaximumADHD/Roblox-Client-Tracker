return function()
	...
	describe("Move Handle", function()
		itSKIP("Dragging handle in Point Mode will properly move points", function()
		...
		itSKIP("Dragging handle in Lattice Mode will properly move points", function()
			runRhodiumTest(function(container, store, dragger)
				store:dispatch(SetDraggerType(Enum.RibbonTool.Move))
	...
	describe("Scale Handle", function()
		itSKIP("Dragging handle in Point Mode will properly scale points", function()
			runRhodiumTest(function(container, store, dragger)
				store:dispatch(SetFalloff(0))
		...
		itSKIP("Dragging handle with Ctrl pressed will scale uniformly", function()
			runRhodiumTest(function(container, store, dragger)
				store:dispatch(SetFalloff(0))
				store:dispatch(SetDraggerType(Enum.RibbonTool.Scale))
	...
	describe("Select Handle", function()
		itSKIP("Can select a single point", function()
			runRhodiumTest(function(container, store, dragger)
				store:dispatch(SetFalloff(0))
				goToPointTool(store)
				dragger.Fixture:select()
		...
		itSKIP("Can double click to select multiple points", function()
			runRhodiumTest(function(container, store, dragger)
				store:dispatch(SetFalloff(0))
				goToPointTool(store)
				dragger.Fixture:select()
		...
		itSKIP("Can multi-select via dragging", function()
			runRhodiumTest(function(container, store, dragger)
				store:dispatch(SetFalloff(0))
				goToPointTool(store)
		...
		itSKIP("Can multi-select via ctrl + click", function()
			runRhodiumTest(function(container, store, dragger)
				store:dispatch(SetFalloff(0))
				goToPointTool(store)
