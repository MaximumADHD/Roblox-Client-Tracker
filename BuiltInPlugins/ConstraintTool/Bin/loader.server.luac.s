PROTO_0:
  ...
  GETUPVAL R3 3
  LOADB R4 0
  SETTABLEKS R4 R3 K9 ["ForceShowConstraintDetails"]
  LOADNIL R3
  SETUPVAL R3 2
  RETURN R0 0
...
PROTO_1:
  ...
  GETUPVAL R1 3
  LOADB R2 1
  SETTABLEKS R2 R1 K5 ["ForceShowConstraintDetails"]
  GETIMPORT R1 K3 [plugin]
  LOADB R3 0
...
PROTO_2:
  ...
  GETUPVAL R2 4
  LOADB R3 0
  SETTABLEKS R3 R2 K9 ["ForceShowConstraintDetails"]
  LOADNIL R2
  SETUPVAL R2 3
  RETURN R0 0
...
PROTO_3:
  ...
  GETUPVAL R3 4
  LOADB R4 0
  SETTABLEKS R4 R3 K13 ["ForceShowConstraintDetails"]
  LOADNIL R3
  SETUPVAL R3 3
  RETURN R0 0
...
PROTO_8:
  ...
  JUMP [+16]
  GETIMPORT R1 K3 [plugin]
  NAMECALL R1 R1 K10 ["GetSelectedRibbonTool"]
  CALL R1 1 1
  SETUPVAL R1 4
  GETUPVAL R1 5
  LOADB R2 1
  SETTABLEKS R2 R1 K9 ["ForceShowConstraintDetails"]
  GETIMPORT R1 K3 [plugin]
  LOADB R3 0
  NAMECALL R1 R1 K11 ["Activate"]
  CALL R1 2 0
  GETUPVAL R2 2
  GETTABLE R1 R2 R0
  SETUPVAL R0 3
