...
MAIN:
  ...
  LOADK R5 K18 ["SimEnableCreateBone"]
  ...
  GETTABLEKS R10 R11 K30 ["PluginLoader"]
  CALL R9 1 1
  GETTABLEKS R10 R9 K31 ["PluginLoaderBuilder"]
  LOADNIL R11
  NEWTABLE R12 0 0
  LOADB R13 0
  LOADNIL R14
  ...
  CAPTURE VAL R12
  CAPTURE REF R14
  GETTABLEKS R18 R5 K32 ["InputEnded"]
  NEWCLOSURE R20 P3
  CAPTURE REF R13
  CAPTURE REF R11
  CAPTURE VAL R12
  CAPTURE REF R14
  NAMECALL R18 R18 K33 ["Connect"]
  CALL R18 2 0
  MOVE R18 R6
  LOADNIL R19
  LOADNIL R20
  FORGPREP R18
  JUMPIFNOT R2 [+4]
  LOADK R24 K34 ["rbxlocaltheme://Ribbon"]
  MOVE R25 R21
  CONCAT R23 R24 R25
  JUMP [+11]
  MOVE R26 R21
  NAMECALL R24 R4 K35 ["GetClassIcon"]
  CALL R24 2 1
  GETTABLEKS R23 R24 K36 ["Image"]
  LOADK R25 K37 ["Standard"]
  LOADK R26 K38 ["Large"]
  NAMECALL R23 R23 K39 ["gsub"]
  CALL R23 3 1
  JUMPIFNOT R3 [+3]
  JUMPIFNOTEQKS R21 K40 ["Bone"] [+2]
  LOADK R23 K41 ["rbxlocaltheme://Placeholder"]
  DUPTABLE R24 K46 [{"getName", "getDescription", "icon", "enabled"}]
  DUPCLOSURE R25 K47 [PROTO_4]
  SETTABLEKS R25 R24 K42 ["getName"]
  DUPCLOSURE R25 K48 [PROTO_5]
  SETTABLEKS R25 R24 K43 ["getDescription"]
  SETTABLEKS R23 R24 K44 ["icon"]
  LOADB R25 0
  SETTABLEKS R25 R24 K45 ["enabled"]
  DUPTABLE R25 K54 [{"plugin", "pluginName", "translationResourceTable", "fallbackResourceTable", "getToolbarName", "buttonInfo"}]
  GETIMPORT R26 K25 [plugin]
  SETTABLEKS R26 R25 K24 ["plugin"]
  LOADK R26 K6 ["ConstraintTool"]
  SETTABLEKS R26 R25 K49 ["pluginName"]
  SETTABLEKS R8 R25 K50 ["translationResourceTable"]
  SETTABLEKS R7 R25 K51 ["fallbackResourceTable"]
  NEWCLOSURE R26 P6
  CAPTURE VAL R21
  SETTABLEKS R26 R25 K52 ["getToolbarName"]
  SETTABLEKS R24 R25 K53 ["buttonInfo"]
  LOADB R26 1
  SETTABLEKS R26 R24 K45 ["enabled"]
  GETTABLEKS R26 R10 K55 ["build"]
  MOVE R27 R25
  CALL R26 1 1
  NEWCLOSURE R27 P7
  CAPTURE VAL R21
  ...
  CAPTURE REF R11
  CAPTURE REF R14
  DUPTABLE R28 K58 [{"pluginLoaderContext", "enabled", "closeCallback"}]
  SETTABLEKS R26 R28 K56 ["pluginLoaderContext"]
  LOADB R29 0
  SETTABLEKS R29 R28 K45 ["enabled"]
  SETTABLEKS R27 R28 K57 ["closeCallback"]
  SETTABLE R28 R12 R21
  GETIMPORT R28 K1 [require]
  GETIMPORT R31 K3 [script]
  GETTABLEKS R30 R31 K4 ["Parent"]
  GETTABLEKS R29 R30 K59 ["main"]
  CALL R28 1 1
  GETTABLE R29 R12 R21
  GETTABLEKS R30 R26 K60 ["mainButtonClickedSignal"]
  NEWCLOSURE R32 P8
  CAPTURE VAL R29
  CAPTURE VAL R21
  CAPTURE VAL R12
  ...
  CAPTURE REF R14
  CAPTURE REF R13
  NAMECALL R30 R30 K33 ["Connect"]
  CALL R30 2 0
  GETIMPORT R30 K63 [task.spawn]
  NEWCLOSURE R31 P9
  CAPTURE VAL R26
  CAPTURE VAL R28
  CAPTURE VAL R29
