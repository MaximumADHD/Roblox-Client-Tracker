...
PROTO_4:
  ...
  CALL R2 3 0
  GETUPVAL R1 3
  NAMECALL R1 R1 K5 ["_getConstraintData"]
  CALL R1 1 1
  GETUPVAL R2 4
  JUMPIF R2 [+10]
  GETTABLEKS R2 R1 K6 ["Attachments"]
  JUMPIFEQKN R2 K7 [1] [+7]
  GETUPVAL R2 5
  JUMPIFEQKS R2 K8 ["WeldConstraint"] [+4]
  GETUPVAL R2 5
  JUMPIFNOTEQKS R2 K9 ["NoCollisionConstraint"] [+6]
  GETUPVAL R2 3
  NAMECALL R2 R2 K10 ["_onUndo"]
  CALL R2 1 0
  RETURN R0 0
  GETUPVAL R3 1
  GETTABLEN R2 R3 1
  ...
  JUMPIFNOTEQKS R2 K12 ["initial"] [+28]
  GETUPVAL R2 6
  NAMECALL R2 R2 K13 ["GetCanUndo"]
  CALL R2 1 1
  JUMPIFNOT R2 [+22]
  GETUPVAL R2 7
  NAMECALL R2 R2 K14 ["Disconnect"]
  CALL R2 1 0
  GETUPVAL R2 6
  NAMECALL R2 R2 K15 ["Undo"]
  CALL R2 1 0
...
PROTO_6:
  ...
  JUMPIFNOTEQKS R3 K12 ["initial"] [+28]
  GETUPVAL R3 6
