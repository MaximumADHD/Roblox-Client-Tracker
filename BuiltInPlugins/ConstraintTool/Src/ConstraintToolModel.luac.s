...
MAIN:
  ...
  LOADK R16 K29 ["SimEnableCreateBone"]
  NAMECALL R14 R14 K27 ["GetFastFlag"]
  CALL R14 2 1
  NEWTABLE R15 64 0
  SETTABLEKS R15 R15 K30 ["__index"]
  LOADK R16 K31 [""]
  GETIMPORT R17 K34 [Color3.fromRGB]
  LOADN R18 255
  LOADN R19 255
  LOADN R20 0
  CALL R17 3 1
  GETIMPORT R18 K34 [Color3.fromRGB]
  LOADN R19 255
  LOADN R20 170
  LOADN R21 0
  CALL R18 3 1
  GETIMPORT R19 K34 [Color3.fromRGB]
  LOADN R20 0
  LOADN R21 255
  LOADN R22 0
  CALL R19 3 1
  GETIMPORT R20 K34 [Color3.fromRGB]
  LOADN R21 255
  LOADN R22 0
  LOADN R23 0
  CALL R20 3 1
  GETIMPORT R21 K34 [Color3.fromRGB]
  LOADN R22 121
  LOADN R23 172
  LOADN R24 255
  CALL R21 3 1
  GETIMPORT R22 K34 [Color3.fromRGB]
  LOADN R23 255
  LOADN R24 0
  LOADN R25 0
  CALL R22 3 1
  GETIMPORT R23 K34 [Color3.fromRGB]
  LOADN R24 108
  LOADN R25 107
  LOADN R26 107
  CALL R23 3 1
  GETIMPORT R24 K37 [table.freeze]
  DUPTABLE R25 K43 [{"AllowDragSelect", "ShowLocalSpaceIndicator", "WasAutoSelected", "ShowPivotIndicator", "ShowDragSelect"}]
  LOADB R26 1
  SETTABLEKS R26 R25 K38 ["AllowDragSelect"]
  LOADB R26 0
  SETTABLEKS R26 R25 K39 ["ShowLocalSpaceIndicator"]
  LOADB R26 0
  SETTABLEKS R26 R25 K40 ["WasAutoSelected"]
  LOADB R26 0
  SETTABLEKS R26 R25 K41 ["ShowPivotIndicator"]
  LOADB R26 1
  SETTABLEKS R26 R25 K42 ["ShowDragSelect"]
  CALL R24 1 1
  GETIMPORT R25 K37 [table.freeze]
  DUPTABLE R26 K45 [{"AnalyticsName"}]
  LOADB R27 1
  SETTABLEKS R27 R26 K44 ["AnalyticsName"]
  CALL R25 1 1
  GETIMPORT R26 K37 [table.freeze]
  DUPTABLE R27 K48 [{"WeldConstraint", "NoCollisionConstraint"}]
  LOADB R28 1
  SETTABLEKS R28 R27 K46 ["WeldConstraint"]
  LOADB R28 1
  SETTABLEKS R28 R27 K47 ["NoCollisionConstraint"]
  CALL R26 1 1
  GETIMPORT R27 K37 [table.freeze]
  NEWTABLE R28 0 6
  LOADK R29 K49 [{1, 0, 0}]
  LOADK R30 K50 [{-1, 0, 0}]
  LOADK R31 K51 [{0, 1, 0}]
  ...
  CAPTURE VAL R11
  CAPTURE REF R16
  SETTABLEKS R29 R15 K56 ["new"]
  DUPCLOSURE R29 K58 [PROTO_3]
  SETTABLEKS R29 R15 K59 ["_connectGizmoScale"]
  DUPCLOSURE R29 K60 [PROTO_4]
  SETTABLEKS R29 R15 K61 ["_onUndo"]
  DUPCLOSURE R29 K62 [PROTO_5]
  SETTABLEKS R29 R15 K63 ["_onRedo"]
  DUPCLOSURE R29 K64 [PROTO_6]
  SETTABLEKS R29 R15 K65 ["_resizeAttachmentAdorns"]
  DUPCLOSURE R29 K66 [PROTO_7]
  CAPTURE VAL R19
  SETTABLEKS R29 R15 K67 ["_createAttachmentAdornment"]
  DUPCLOSURE R29 K68 [PROTO_8]
  CAPTURE VAL R1
  SETTABLEKS R29 R15 K69 ["_initAttachmentAdornment"]
  DUPCLOSURE R29 K70 [PROTO_9]
  CAPTURE VAL R21
  CAPTURE VAL R26
  CAPTURE VAL R1
  SETTABLEKS R29 R15 K71 ["_initSelectionHighlight"]
  DUPCLOSURE R29 K72 [PROTO_10]
  CAPTURE VAL R17
  CAPTURE VAL R18
  SETTABLEKS R29 R15 K73 ["_createAttachmentAdornmentArrows"]
  DUPCLOSURE R29 K74 [PROTO_11]
  SETTABLEKS R29 R15 K75 ["_orientAttachmentAdornment"]
  DUPCLOSURE R29 K76 [PROTO_12]
  SETTABLEKS R29 R15 K77 ["setMouseCursor"]
  DUPCLOSURE R29 K78 [PROTO_13]
  CAPTURE VAL R26
  CAPTURE VAL R4
  SETTABLEKS R29 R15 K79 ["render"]
  DUPCLOSURE R29 K80 [PROTO_14]
  SETTABLEKS R29 R15 K81 ["update"]
  DUPCLOSURE R29 K82 [PROTO_15]
  SETTABLEKS R29 R15 K83 ["getSchema"]
  DUPCLOSURE R29 K84 [PROTO_16]
  SETTABLEKS R29 R15 K85 ["doesAllowDragSelect"]
  DUPCLOSURE R29 K86 [PROTO_17]
  SETTABLEKS R29 R15 K87 ["shouldShowDragSelect"]
  DUPCLOSURE R29 K88 [PROTO_18]
  SETTABLEKS R29 R15 K89 ["shouldShowLocalSpaceIndicator"]
  DUPCLOSURE R29 K90 [PROTO_19]
  SETTABLEKS R29 R15 K91 ["shouldShowSelectionDot"]
  DUPCLOSURE R29 K92 [PROTO_20]
  SETTABLEKS R29 R15 K93 ["shouldUseCollisionTransparency"]
  DUPCLOSURE R29 K94 [PROTO_21]
  SETTABLEKS R29 R15 K95 ["shouldAlignDraggedObjects"]
  DUPCLOSURE R29 K96 [PROTO_22]
  CAPTURE VAL R12
  SETTABLEKS R29 R15 K97 ["getRaycastIgnoreList"]
  DUPCLOSURE R29 K98 [PROTO_23]
  CAPTURE VAL R26
  SETTABLEKS R29 R15 K99 ["_setInitialInstanceTransparency"]
  DUPCLOSURE R29 K100 [PROTO_24]
  CAPTURE VAL R26
  CAPTURE VAL R7
  CAPTURE VAL R21
  CAPTURE VAL R22
  ...
  CAPTURE VAL R19
  CAPTURE VAL R20
  SETTABLEKS R29 R15 K101 ["_updateAttachment"]
  DUPCLOSURE R29 K102 [PROTO_25]
  CAPTURE VAL R27
  CAPTURE VAL R8
  SETTABLEKS R29 R15 K103 ["_rotateAttachment"]
  DUPCLOSURE R29 K104 [PROTO_26]
  CAPTURE VAL R26
  CAPTURE VAL R0
  CAPTURE VAL R12
  SETTABLEKS R29 R15 K105 ["_closeTool"]
  DUPCLOSURE R29 K106 [PROTO_28]
  CAPTURE VAL R1
  SETTABLEKS R29 R15 K107 ["_processSelected"]
  DUPCLOSURE R29 K108 [PROTO_29]
  SETTABLEKS R29 R15 K109 ["_processDeselected"]
  DUPCLOSURE R29 K110 [PROTO_30]
  SETTABLEKS R29 R15 K111 ["_processSelectionChanged"]
  DUPCLOSURE R29 K112 [PROTO_31]
  SETTABLEKS R29 R15 K113 ["_setConstraintType"]
  DUPCLOSURE R29 K114 [PROTO_32]
  CAPTURE VAL R5
  SETTABLEKS R29 R15 K115 ["_getConstraintData"]
  DUPCLOSURE R29 K116 [PROTO_33]
  SETTABLEKS R29 R15 K117 ["_createConstraintVisuals"]
  DUPCLOSURE R29 K118 [PROTO_34]
  SETTABLEKS R29 R15 K119 ["_removeConstraintVisuals"]
  DUPCLOSURE R29 K120 [PROTO_35]
  SETTABLEKS R29 R15 K121 ["_removeAttachmentAdorns"]
  GETIMPORT R29 K37 [table.freeze]
  NEWTABLE R30 8 0
  GETIMPORT R31 K125 [Enum.KeyCode.RightShift]
  LOADB R32 1
  SETTABLE R32 R30 R31
  GETIMPORT R31 K127 [Enum.KeyCode.LeftShift]
  LOADB R32 1
  SETTABLE R32 R30 R31
  GETIMPORT R31 K129 [Enum.KeyCode.RightControl]
  LOADB R32 1
  SETTABLE R32 R30 R31
  GETIMPORT R31 K131 [Enum.KeyCode.LeftControl]
  LOADB R32 1
  SETTABLE R32 R30 R31
  GETIMPORT R31 K133 [Enum.KeyCode.RightAlt]
  LOADB R32 1
  SETTABLE R32 R30 R31
  GETIMPORT R31 K135 [Enum.KeyCode.LeftAlt]
  LOADB R32 1
  SETTABLE R32 R30 R31
  CALL R29 1 1
  DUPCLOSURE R30 K136 [PROTO_36]
  CAPTURE VAL R13
  CAPTURE VAL R29
  SETTABLEKS R30 R15 K137 ["_processKeyDown"]
  DUPCLOSURE R30 K138 [PROTO_37]
  CAPTURE VAL R29
  SETTABLEKS R30 R15 K139 ["_processKeyUp"]
  DUPCLOSURE R30 K140 [PROTO_38]
  CAPTURE VAL R26
  SETTABLEKS R30 R15 K141 ["_clearInitialInstance"]
  DUPCLOSURE R30 K142 [PROTO_40]
  CAPTURE VAL R26
  SETTABLEKS R30 R15 K143 ["_selectInitialInstance"]
  DUPCLOSURE R30 K144 [PROTO_41]
  CAPTURE VAL R26
  SETTABLEKS R30 R15 K145 ["_canMouseDown"]
  NEWCLOSURE R30 P38
  CAPTURE VAL R0
  CAPTURE REF R16
  CAPTURE VAL R26
  ...
  CAPTURE VAL R9
  CAPTURE VAL R12
  SETTABLEKS R30 R15 K146 ["_processMouseDown"]
  DUPCLOSURE R30 K147 [PROTO_43]
  CAPTURE VAL R0
  SETTABLEKS R30 R15 K148 ["_processMouseUp"]
  DUPCLOSURE R30 K149 [PROTO_44]
  SETTABLEKS R30 R15 K150 ["_processViewChanged"]
  DUPCLOSURE R30 K151 [PROTO_45]
  SETTABLEKS R30 R15 K152 ["_scheduleRender"]
  CLOSEUPVALS R16
  RETURN R15 1
