...
local UtilityFunctionsMath = require(Plugin.Src.Util.UtilityFunctionsMath)
...
function Template:apply(playerChoiceDescription)
	playerChoiceDescription.HeightScale = UtilityFunctionsMath.clamp(playerChoiceDescription.HeightScale,
		self.ScalesMin.height, self.ScalesMax.height)
	playerChoiceDescription.WidthScale = UtilityFunctionsMath.clamp(playerChoiceDescription.WidthScale,
		self.ScalesMin.width, self.ScalesMax.width)
	playerChoiceDescription.HeadScale = UtilityFunctionsMath.clamp(playerChoiceDescription.HeadScale,
		self.ScalesMin.head, self.ScalesMax.head)
	playerChoiceDescription.BodyTypeScale = UtilityFunctionsMath.clamp( playerChoiceDescription.BodyTypeScale,
		self.ScalesMin.bodyType, self.ScalesMax.bodyType)
	playerChoiceDescription.ProportionScale = UtilityFunctionsMath.clamp(playerChoiceDescription.ProportionScale,
