...
function RadioButton:init(initialProps)
	...
	if not (FFlagStudioAddMonetizationToGameSettings or FFlagGameSettingsPlaceSettings) then
		self.state = {
...
function RadioButton:render()
	...
	local DEPRECATED_descriptionWidth = self.state.DescriptionWidth
	...
	if FFlagStudioAddMonetizationToGameSettings or FFlagGameSettingsPlaceSettings then
		...
		return Roact.createElement("Frame", {
			...
			Button = Roact.createElement("ImageButton", {
				...
				TitleLabel = Roact.createElement("TextButton", Cryo.Dictionary.join(theme.fontStyle.Normal, {
					BackgroundTransparency = 1,
					BorderSizePixel = 0,
					Size = UDim2.new(0, DEPRECATED_titleWidth, 1, 0),
					AnchorPoint = Vector2.new(0, 0.5),
					Position = UDim2.new(1, 5, 0.5, 0),
				...
				DescriptionLabel = Roact.createElement("TextButton", Cryo.Dictionary.join(theme.fontStyle.Subtext,{
					BackgroundTransparency = 1,
					BorderSizePixel = 0,
					Size = UDim2.new(0, DEPRECATED_descriptionWidth, 1, 0),
					Position = UDim2.new(1, 5, 1, 1),
