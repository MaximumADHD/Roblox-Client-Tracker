				...
				if box.Id == "Console" and not box.Selected then
					local dialogProps = {
						...
						Entries = FFlagStudioConvertGameSettingsToDevFramework and {
							...
							FFlagAddMissingConsoleAgreementTextInGameSettings and localized:getText("General", "ContentDialogItem5") or nil,
...
local function displayContents(page, localized)
	...
	return createContents(props, localized, addThumbnail, addIcon, page)
end
