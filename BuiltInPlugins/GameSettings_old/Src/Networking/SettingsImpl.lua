...
local Requests = {
	...
	DeveloperProducts = FFlagEnableDevProductsInGameSettings and require(RequestsFolder.DeveloperProducts) or nil,
	...
	return Promise.new(function(resolve, reject)
		spawn(function()
			...
			elseif (not canManage) then
				...
				if FFlagEnableDevProductsInGameSettings then
...
function SettingsImpl:SaveAll(state)
	...
	return self:CanManagePlace():andThen(function(canManage)
		...
		if FFlagEnableDevProductsInGameSettings and saveInfo.NewDevProducts then
		...
		if FFlagEnableDevProductsInGameSettings and saveInfo.UpdateDevProducts then
