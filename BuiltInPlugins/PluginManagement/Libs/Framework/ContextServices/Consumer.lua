--[[
	...
	table ContextMap<name><ContextItem>:
	...
	function Render(table values) = A callback used to render
...
function Consumer:init(props)
	...
	assert(contextMap ~= nil, "Consumer expects a ContextMap prop.")
	assert(props.Render ~= nil, "Consumer expects a Render prop.")
