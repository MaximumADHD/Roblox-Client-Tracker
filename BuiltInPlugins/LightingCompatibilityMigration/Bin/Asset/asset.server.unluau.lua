...
local var0 = script:FindFirstAncestor("LightingCompatibilityMigration")
local var1 = require(var0.Packages.TestLoader)
var1.launch("LightingCompatibilityMigration", var0.Src)
if var1.isCli() then
end
if not require(var0.Bin.Common.defineLuaFlags).getFFlagEnableLightingCompatibilityMigration() then
end
