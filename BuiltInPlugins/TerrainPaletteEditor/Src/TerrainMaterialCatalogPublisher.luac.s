...
PROTO_1:
        ...
        3 MOVE                             R2 R0
        4 CALL                             R1 1 1
        5 DUPTABLE                         R2 K2 [{"Fire"}]
        6 NEWCLOSURE                       R3 P0
        7 CAPTURE                          VAL R1
        8 SETTABLEKS                       R3 R2 K1 ["Fire"]
       10 RETURN                           R2 1
...
PROTO_3:
        ...
        6 GETUPVAL                         R2 0
        7 GETUPVAL                         R3 1
        8 GETTABLEKS                       R3 R3 K0 ["new"]
       10 MOVE                             R4 R2
       11 CALL                             R3 1 1
       12 DUPTABLE                         R1 K2 [{"Fire"}]
       13 NEWCLOSURE                       R4 P0
       14 CAPTURE                          VAL R3
       15 SETTABLEKS                       R4 R1 K1 ["Fire"]
       17 DUPTABLE                         R2 K4 [{"publish"}]
       18 NEWCLOSURE                       R3 P1
       19 CAPTURE                          VAL R1
       20 CAPTURE                          UPVAL U2
       21 SETTABLEKS                       R3 R2 K3 ["publish"]
       23 RETURN                           R2 1
