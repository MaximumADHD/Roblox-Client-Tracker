...
MAIN:
  ...
  DUPTABLE R8 K26 [{"assetsTable", "bulkImporterRunning", "editingAssets", "isFetchingAssets", "recentAssets", "recentViewToggled", "searchTerm", "selectedAssets", "selectionIndex", "universeName", "view", "hasLinkedScripts"}]
  DUPTABLE R9 K31 [{"assets", "assetPreviewData", "assetsModerationData", "index"}]
  NEWTABLE R10 0 0
  SETTABLEKS R10 R9 K27 ["assets"]
  NEWTABLE R10 0 0
  SETTABLEKS R10 R9 K28 ["assetPreviewData"]
  NEWTABLE R10 0 0
  SETTABLEKS R10 R9 K29 ["assetsModerationData"]
  LOADN R10 0
  SETTABLEKS R10 R9 K30 ["index"]
  ...
  GETTABLEKS R9 R3 K33 ["LIST"]
  SETTABLEKS R9 R8 K24 ["view"]
  LOADB R9 0
  SETTABLEKS R9 R8 K25 ["hasLinkedScripts"]
  DUPTABLE R9 K54 [{"SetAssets", "SetBulkImporterRunning", "SetEditingAssets", "SetIsFetchingAssets", "SetRecentAssets", "SetRecentViewToggled", "SetSearchTerm", "SetSelectedAssets", "SetSelectionIndex", "SetUniverseName", "SetView", "SetAssetPreviewData", "SetAssetOwnerName", "SetRootTreeViewInstance", "SetHasLinkedScripts", "SetAssetFavorited", "SetAssetFavoriteCount", "IncrementAssetFavoriteCount", "SetAssetsModerationData", "ChangeAssetAlias"}]
  DUPCLOSURE R10 K55 [PROTO_0]
  CAPTURE VAL R1
  SETTABLEKS R10 R9 K34 ["SetAssets"]
  DUPCLOSURE R10 K56 [PROTO_1]
  CAPTURE VAL R1
  SETTABLEKS R10 R9 K35 ["SetBulkImporterRunning"]
  DUPCLOSURE R10 K57 [PROTO_2]
  CAPTURE VAL R1
  SETTABLEKS R10 R9 K36 ["SetEditingAssets"]
  DUPCLOSURE R10 K58 [PROTO_3]
  CAPTURE VAL R1
  SETTABLEKS R10 R9 K37 ["SetIsFetchingAssets"]
  DUPCLOSURE R10 K59 [PROTO_4]
  CAPTURE VAL R1
  SETTABLEKS R10 R9 K38 ["SetRecentAssets"]
  DUPCLOSURE R10 K60 [PROTO_5]
  CAPTURE VAL R1
  SETTABLEKS R10 R9 K39 ["SetRecentViewToggled"]
  DUPCLOSURE R10 K61 [PROTO_6]
  CAPTURE VAL R1
  SETTABLEKS R10 R9 K40 ["SetSearchTerm"]
  DUPCLOSURE R10 K62 [PROTO_7]
  CAPTURE VAL R1
  SETTABLEKS R10 R9 K41 ["SetSelectedAssets"]
  DUPCLOSURE R10 K63 [PROTO_8]
  CAPTURE VAL R1
  SETTABLEKS R10 R9 K42 ["SetSelectionIndex"]
  DUPCLOSURE R10 K64 [PROTO_9]
  CAPTURE VAL R1
  SETTABLEKS R10 R9 K43 ["SetUniverseName"]
  DUPCLOSURE R10 K65 [PROTO_10]
  CAPTURE VAL R1
  SETTABLEKS R10 R9 K44 ["SetView"]
  DUPCLOSURE R10 K66 [PROTO_11]
  CAPTURE VAL R1
  SETTABLEKS R10 R9 K45 ["SetAssetPreviewData"]
  DUPCLOSURE R10 K67 [PROTO_12]
  CAPTURE VAL R6
  SETTABLEKS R10 R9 K46 ["SetAssetOwnerName"]
  DUPCLOSURE R10 K68 [PROTO_13]
  CAPTURE VAL R6
  SETTABLEKS R10 R9 K47 ["SetRootTreeViewInstance"]
  DUPCLOSURE R10 K69 [PROTO_14]
  CAPTURE VAL R1
  SETTABLEKS R10 R9 K48 ["SetHasLinkedScripts"]
  DUPCLOSURE R10 K70 [PROTO_15]
  CAPTURE VAL R6
  SETTABLEKS R10 R9 K49 ["SetAssetFavorited"]
  DUPCLOSURE R10 K71 [PROTO_16]
  CAPTURE VAL R6
  SETTABLEKS R10 R9 K50 ["SetAssetFavoriteCount"]
  DUPCLOSURE R10 K72 [PROTO_17]
  CAPTURE VAL R1
  CAPTURE VAL R6
  SETTABLEKS R10 R9 K51 ["IncrementAssetFavoriteCount"]
  DUPCLOSURE R10 K73 [PROTO_18]
  CAPTURE VAL R1
  SETTABLEKS R10 R9 K52 ["SetAssetsModerationData"]
  DUPCLOSURE R10 K74 [PROTO_19]
  CAPTURE VAL R6
  SETTABLEKS R10 R9 K53 ["ChangeAssetAlias"]
  CALL R7 2 -1
  RETURN R7 -1
