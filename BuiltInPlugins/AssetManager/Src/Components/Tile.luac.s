...
MAIN:
  ...
  CAPTURE VAL R25
  CAPTURE VAL R27
  SETTABLEKS R30 R28 K47 ["init"]
  DUPCLOSURE R30 K48 [PROTO_12]
  SETTABLEKS R30 R28 K49 ["didMount"]
  DUPCLOSURE R30 K50 [PROTO_13]
  CAPTURE VAL R25
  SETTABLEKS R30 R28 K51 ["didUpdate"]
  DUPCLOSURE R30 K52 [PROTO_14]
  CAPTURE VAL R8
  CAPTURE VAL R24
  CAPTURE VAL R22
  CAPTURE VAL R23
  ...
  CAPTURE VAL R13
  CAPTURE VAL R12
  SETTABLEKS R30 R28 K53 ["render"]
  MOVE R30 R5
  DUPTABLE R31 K60 [{"Analytics", "API", "Localization", "Mouse", "Plugin", "Stylizer"}]
  GETTABLEKS R32 R4 K54 ["Analytics"]
  SETTABLEKS R32 R31 K54 ["Analytics"]
  GETTABLEKS R32 R4 K55 ["API"]
  SETTABLEKS R32 R31 K55 ["API"]
  GETTABLEKS R32 R4 K56 ["Localization"]
  SETTABLEKS R32 R31 K56 ["Localization"]
  GETTABLEKS R32 R4 K57 ["Mouse"]
  SETTABLEKS R32 R31 K57 ["Mouse"]
  GETTABLEKS R32 R4 K58 ["Plugin"]
  SETTABLEKS R32 R31 K58 ["Plugin"]
  GETTABLEKS R32 R4 K59 ["Stylizer"]
  SETTABLEKS R32 R31 K59 ["Stylizer"]
  CALL R30 1 1
  MOVE R31 R28
  CALL R30 1 1
  MOVE R28 R30
  DUPCLOSURE R30 K61 [PROTO_15]
  DUPCLOSURE R31 K62 [PROTO_22]
  CAPTURE VAL R18
  CAPTURE VAL R19
  CAPTURE VAL R20
  CAPTURE VAL R21
