--[[
	...
	Required Props:
		Instance element: The instance to display.
		number indent: The level of indentation this item appears at.
		boolean canExpand: Whether this item has children and can be expanded.
		boolean isExpanded: Whether this item is showing its children.
		boolean isSelected: Whether this item is the selected item.
		number rowIndex: The order in which this item appears in the list.
		callback toggleSelected: Fired when this item is clicked.
]]
