...
PROTO_1:
  ...
  GETUPVAL R7 0
  GETUPVAL R10 1
  GETTABLEKS R9 R10 K6 ["MODELS"]
  GETTABLEKS R8 R9 K1 ["Path"]
  JUMPIFEQ R7 R8 [+2]
  LOADB R6 0 +1
  LOADB R6 1
  NEWTABLE R7 8 0
  SETTABLEKS R1 R7 K7 ["Images/"]
  SETTABLEKS R2 R7 K8 ["Meshes/"]
  SETTABLEKS R3 R7 K9 ["Scripts/"]
  SETTABLEKS R4 R7 K10 ["Audio/"]
  SETTABLEKS R5 R7 K11 ["Video/"]
  SETTABLEKS R6 R7 K12 ["Models/"]
  MOVE R8 R1
  JUMPIF R8 [+9]
  MOVE R8 R2
  JUMPIF R8 [+7]
  ...
  JUMPIFNOT R8 [+36]
  GETUPVAL R12 4
  GETTABLEKS R11 R12 K13 ["API"]
  GETTABLEKS R10 R11 K14 ["Universes"]
  GETTABLEKS R9 R10 K15 ["getAliases"]
  GETIMPORT R11 K17 [game]
  GETTABLEKS R10 R11 K18 ["GameId"]
  MOVE R11 R0
  CALL R9 2 1
