...
PROTO_6:
  ...
  GETUPVAL R3 1
  GETTABLEKS R4 R1 K3 ["NextPageCursor"]
  SETTABLEKS R4 R3 K4 ["nextPageCursor"]
  GETIMPORT R3 K6 [pairs]
  GETTABLEKS R4 R1 K7 ["Aliases"]
  CALL R3 1 3
  FORGPREP_NEXT R3
  GETUPVAL R8 2
  GETIMPORT R9 K11 [Enum.AssetType.Image]
  JUMPIFNOTEQ R8 R9 [+8]
  GETIMPORT R8 K14 [string.find]
  GETTABLEKS R9 R7 K15 ["Name"]
  LOADK R10 K16 ["Images/"]
  CALL R8 2 1
  JUMPIF R8 [+66]
  GETUPVAL R8 2
  GETIMPORT R9 K18 [Enum.AssetType.MeshPart]
  JUMPIFNOTEQ R8 R9 [+8]
  GETIMPORT R8 K14 [string.find]
  GETTABLEKS R9 R7 K15 ["Name"]
  LOADK R10 K19 ["Meshes/"]
  CALL R8 2 1
  JUMPIF R8 [+54]
  GETUPVAL R8 2
  GETIMPORT R9 K21 [Enum.AssetType.Lua]
  JUMPIFNOTEQ R8 R9 [+8]
  GETIMPORT R8 K14 [string.find]
  GETTABLEKS R9 R7 K15 ["Name"]
  LOADK R10 K22 ["Scripts/"]
  CALL R8 2 1
  JUMPIF R8 [+42]
  GETUPVAL R8 3
  CALL R8 0 1
  JUMPIFNOT R8 [+12]
  GETUPVAL R8 2
  GETIMPORT R9 K24 [Enum.AssetType.Audio]
  JUMPIFNOTEQ R8 R9 [+8]
  GETIMPORT R8 K14 [string.find]
  GETTABLEKS R9 R7 K15 ["Name"]
  LOADK R10 K25 ["Audio/"]
  ...
  JUMPIFNOT R8 [+12]
  GETUPVAL R8 2
  GETIMPORT R9 K27 [Enum.AssetType.Video]
  JUMPIFNOTEQ R8 R9 [+8]
  GETIMPORT R8 K14 [string.find]
  GETTABLEKS R9 R7 K15 ["Name"]
  LOADK R10 K28 ["Video/"]
  ...
  JUMPIF R8 [+12]
  GETUPVAL R8 2
  GETIMPORT R9 K30 [Enum.AssetType.Model]
  JUMPIFNOTEQ R8 R9 [+194]
  GETIMPORT R8 K14 [string.find]
  GETTABLEKS R9 R7 K15 ["Name"]
  LOADK R10 K31 ["Models/"]
  CALL R8 2 1
  JUMPIFNOT R8 [+186]
  NEWTABLE R8 8 0
  GETTABLEKS R10 R7 K32 ["TargetId"]
  FASTCALL1 TOSTRING R10 [+2]
  GETIMPORT R9 K34 [tostring]
  CALL R9 1 1
  GETUPVAL R10 2
  SETTABLEKS R10 R8 K35 ["assetType"]
  GETTABLEKS R10 R7 K36 ["Asset"]
  SETTABLEKS R10 R8 K37 ["asset"]
  GETTABLEKS R10 R7 K32 ["TargetId"]
  SETTABLEKS R10 R8 K38 ["id"]
  GETUPVAL R10 2
  GETIMPORT R11 K11 [Enum.AssetType.Image]
  JUMPIFNOTEQ R10 R11 [+18]
  GETIMPORT R10 K14 [string.find]
  GETTABLEKS R11 R7 K15 ["Name"]
  LOADK R12 K16 ["Images/"]
  CALL R10 2 1
  JUMPIFNOT R10 [+10]
  GETIMPORT R10 K40 [string.gsub]
  GETTABLEKS R11 R7 K15 ["Name"]
  LOADK R12 K16 ["Images/"]
  LOADK R13 K41 [""]
  CALL R10 3 1
  SETTABLEKS R10 R8 K42 ["name"]
  JUMP [+116]
  GETUPVAL R10 2
  GETIMPORT R11 K18 [Enum.AssetType.MeshPart]
  JUMPIFNOTEQ R10 R11 [+18]
  GETIMPORT R10 K14 [string.find]
  GETTABLEKS R11 R7 K15 ["Name"]
  LOADK R12 K19 ["Meshes/"]
  CALL R10 2 1
  JUMPIFNOT R10 [+10]
  GETIMPORT R10 K40 [string.gsub]
  GETTABLEKS R11 R7 K15 ["Name"]
  ...
  JUMP [+94]
  GETUPVAL R10 2
  GETIMPORT R11 K21 [Enum.AssetType.Lua]
  JUMPIFNOTEQ R10 R11 [+19]
  GETIMPORT R10 K14 [string.find]
  GETTABLEKS R11 R7 K15 ["Name"]
  LOADK R12 K22 ["Scripts/"]
  CALL R10 2 1
  JUMPIFNOT R10 [+11]
  LOADB R2 1
  GETIMPORT R10 K40 [string.gsub]
  ...
  JUMPIFNOT R10 [+22]
  GETUPVAL R10 2
  GETIMPORT R11 K24 [Enum.AssetType.Audio]
  JUMPIFNOTEQ R10 R11 [+18]
  GETIMPORT R10 K14 [string.find]
  GETTABLEKS R11 R7 K15 ["Name"]
  LOADK R12 K25 ["Audio/"]
  ...
  JUMPIFNOT R10 [+22]
  GETUPVAL R10 2
  GETIMPORT R11 K27 [Enum.AssetType.Video]
  JUMPIFNOTEQ R10 R11 [+18]
  GETIMPORT R10 K14 [string.find]
  GETTABLEKS R11 R7 K15 ["Name"]
  LOADK R12 K28 ["Video/"]
  ...
  JUMP [+21]
  GETUPVAL R10 2
  GETIMPORT R11 K30 [Enum.AssetType.Model]
  JUMPIFNOTEQ R10 R11 [+17]
  GETIMPORT R10 K14 [string.find]
  GETTABLEKS R11 R7 K15 ["Name"]
  LOADK R12 K31 ["Models/"]
  CALL R10 2 1
  JUMPIFNOT R10 [+9]
  GETIMPORT R10 K40 [string.gsub]
  GETTABLEKS R11 R7 K15 ["Name"]
  ...
  SETTABLEKS R10 R8 K42 ["name"]
  GETUPVAL R10 5
  SETTABLEKS R10 R8 K43 ["layoutOrder"]
  GETUPVAL R10 1
  GETUPVAL R13 6
  GETTABLEKS R12 R13 K44 ["Dictionary"]
  GETTABLEKS R11 R12 K45 ["join"]
  GETUPVAL R13 1
  GETTABLEKS R12 R13 K46 ["assets"]
  NEWTABLE R13 1 0
  SETTABLE R8 R13 R9
  CALL R11 2 1
  SETTABLEKS R11 R10 K46 ["assets"]
  GETUPVAL R11 5
  ADDK R10 R11 K47 [1]
  SETUPVAL R10 5
  GETUPVAL R11 7
  GETTABLEKS R12 R8 K38 ["id"]
...
MAIN:
  ...
  LOADK R15 K28 ["AssetManagerMigrateAliasesEndpoint"]
  NAMECALL R13 R13 K27 ["GetFastFlag"]
  CALL R13 2 1
  DUPCLOSURE R14 K29 [PROTO_16]
  CAPTURE VAL R4
  CAPTURE VAL R11
  CAPTURE VAL R12
  CAPTURE VAL R10
