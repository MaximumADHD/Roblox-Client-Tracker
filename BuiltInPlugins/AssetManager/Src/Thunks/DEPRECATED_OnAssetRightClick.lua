...
local FFlagFixAssetManagerInsertWithLocation = game:GetFastFlag("FixAssetManagerInsertWithLocation")
local FFlagAssetManagerAddNewPlaceBehavior = game:GetFastFlag("AssetManagerAddNewPlaceBehavior")
