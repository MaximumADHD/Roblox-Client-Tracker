--[[
	A slider with two carets to allow selection of a range of values.

	Required Props:
		number Min: Min value of the slider
		number Max: Max value of the slider
		number LowerRangeValue: Current value for the lower range handle
		number UpperRangeValue: Current value for the upper range handle
...
function RangeSlider:init()
    ...
    self.setValuesFromInput = function(input)
        ...
        local lowerValue = math.min(mouseClickValue, self.staticRangeDuringInput)
        ...
        local upperValue = math.max(mouseClickValue, self.staticRangeDuringInput)
    ...
    self.onInputBegan = function(rbx, input)
        ...
        elseif isUserInputTypeClick(input.UserInputType) then
			...
			self.staticRangeDuringInput = self.getStaticRangeValueDuringInput(input)
...
function RangeSlider:render()
    ...
    local minKnobBackground = style.LowerKnobBackground
    ...
    return Roact.createElement("Frame", {
        ...
        LowerKnob = Roact.createElement(Container, {
