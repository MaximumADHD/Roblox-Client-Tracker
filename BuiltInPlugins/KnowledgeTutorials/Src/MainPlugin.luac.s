...
PROTO_2:
  ...
  GETUPVAL R5 2
  GETTABLEKS R4 R5 K31 ["Design"]
  GETTABLEKS R3 R4 K13 ["new"]
  GETTABLEKS R4 R0 K30 ["design"]
  CALL R3 1 1
  SETTABLEKS R3 R0 K32 ["designContext"]
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R9 R10 K18 ["defineLuaFlags"]
  CALL R8 1 1
  GETTABLEKS R9 R8 K19 ["getFFlagKnowledgeTutorialsAvoidHanging"]
  CALL R9 0 1
  ...
  CALL R10 1 1
  GETTABLEKS R11 R10 K22 ["ServerStorage"]
  GETTABLEKS R13 R3 K23 ["UI"]
  GETTABLEKS R12 R13 K24 ["DockWidget"]
  GETTABLEKS R14 R3 K23 ["UI"]
  GETTABLEKS R13 R14 K25 ["Dialog"]
  GETTABLEKS R14 R4 K26 ["View"]
  GETTABLEKS R15 R3 K27 ["ContextServices"]
  GETTABLEKS R16 R15 K28 ["Plugin"]
  GETTABLEKS R17 R15 K29 ["Mouse"]
  GETTABLEKS R20 R3 K30 ["Style"]
  GETTABLEKS R19 R20 K31 ["Themes"]
  GETTABLEKS R18 R19 K32 ["StudioTheme"]
  GETTABLEKS R20 R3 K33 ["Styling"]
  GETTABLEKS R19 R20 K34 ["registerPluginStyles"]
  ...
  GETTABLEKS R24 R25 K39 ["Telemetry"]
  GETTABLEKS R23 R24 K40 ["TelemetryProtocol"]
  CALL R22 1 1
  GETIMPORT R23 K5 [require]
  GETTABLEKS R27 R0 K6 ["Src"]
  GETTABLEKS R26 R27 K20 ["Util"]
  GETTABLEKS R25 R26 K39 ["Telemetry"]
  GETTABLEKS R24 R25 K41 ["TelemetryContext"]
  CALL R23 1 1
  GETIMPORT R24 K5 [require]
  GETTABLEKS R28 R0 K6 ["Src"]
  GETTABLEKS R27 R28 K20 ["Util"]
  GETTABLEKS R26 R27 K39 ["Telemetry"]
  GETTABLEKS R25 R26 K42 ["KnowledgeTutorialsTelemetryEvent"]
  CALL R24 1 1
  GETTABLEKS R26 R0 K6 ["Src"]
  GETTABLEKS R25 R26 K13 ["Components"]
  GETIMPORT R26 K5 [require]
  GETTABLEKS R27 R25 K43 ["TutorialAvailableDialog"]
  CALL R26 1 1
  GETIMPORT R27 K5 [require]
  GETTABLEKS R28 R25 K44 ["TutorialCompletionDialog"]
  CALL R27 1 1
  GETIMPORT R28 K5 [require]
  GETTABLEKS R29 R25 K45 ["Topbar"]
  CALL R28 1 1
  GETIMPORT R29 K5 [require]
  GETTABLEKS R30 R25 K46 ["TableOfContents"]
  CALL R29 1 1
  GETIMPORT R30 K5 [require]
  GETTABLEKS R31 R25 K47 ["TutorialHome"]
  CALL R30 1 1
  GETIMPORT R31 K5 [require]
  GETTABLEKS R32 R25 K48 ["TutorialSection"]
  CALL R31 1 1
  GETIMPORT R32 K5 [require]
  GETTABLEKS R35 R0 K6 ["Src"]
  GETTABLEKS R34 R35 K20 ["Util"]
  GETTABLEKS R33 R34 K49 ["getTutorialData"]
  CALL R32 1 1
  GETTABLEKS R33 R2 K50 ["PureComponent"]
  LOADK R35 K51 ["MainPlugin"]
  ...
  CAPTURE VAL R5
  CAPTURE VAL R19
  SETTABLEKS R34 R33 K54 ["init"]
  DUPCLOSURE R34 K55 [PROTO_3]
  CAPTURE VAL R32
  SETTABLEKS R34 R33 K56 ["loadTutorialData"]
  DUPCLOSURE R34 K57 [PROTO_4]
  SETTABLEKS R34 R33 K58 ["didMount"]
  DUPCLOSURE R34 K59 [PROTO_5]
  SETTABLEKS R34 R33 K60 ["willUnmount"]
  DUPCLOSURE R34 K61 [PROTO_6]
  CAPTURE VAL R24
  SETTABLEKS R34 R33 K62 ["onCloseAvailableDialog"]
  DUPCLOSURE R34 K63 [PROTO_7]
  CAPTURE VAL R24
  SETTABLEKS R34 R33 K64 ["onCloseCompletionDialog"]
  DUPCLOSURE R34 K65 [PROTO_8]
  CAPTURE VAL R24
  SETTABLEKS R34 R33 K66 ["onStartTutorial"]
  DUPCLOSURE R34 K67 [PROTO_9]
  CAPTURE VAL R24
  SETTABLEKS R34 R33 K68 ["onRestartTutorial"]
  DUPCLOSURE R34 K69 [PROTO_10]
  CAPTURE VAL R24
  SETTABLEKS R34 R33 K70 ["onRateTutorial"]
  DUPCLOSURE R34 K71 [PROTO_11]
  CAPTURE VAL R2
  CAPTURE VAL R13
  CAPTURE VAL R6
  SETTABLEKS R34 R33 K72 ["createDialog"]
  DUPCLOSURE R34 K73 [PROTO_28]
  CAPTURE VAL R15
  CAPTURE VAL R16
  CAPTURE VAL R17
  CAPTURE VAL R2
