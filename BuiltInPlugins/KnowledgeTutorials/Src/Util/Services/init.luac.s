PROTO_0:
        ...
        4 GETTABLEKS                       R1 R1 K4 ["ServerStorage"]
        6 CALL                             R0 1 1
        7 GETUPVAL                         R1 0
        8 GETUPVAL                         R3 1
        9 GETTABLEKS                       R3 R3 K5 ["isCli"]
       11 CALL                             R3 0 1
       12 JUMPIFNOT                        R3 ; [+4]
       ...
       24 GETIMPORT                        R2 K3 [script]
       26 GETTABLEKS                       R2 R2 K8 ["StartPageService"]
       28 CALL                             R1 1 1
       29 GETUPVAL                         R2 0
       30 GETUPVAL                         R4 1
       31 GETTABLEKS                       R4 R4 K5 ["isCli"]
       33 CALL                             R4 0 1
       34 JUMPIFNOT                        R4 ; [+4]
       ...
       46 GETIMPORT                        R3 K3 [script]
       48 GETTABLEKS                       R3 R3 K9 ["Selection"]
       50 CALL                             R2 1 1
       51 GETUPVAL                         R3 0
       52 GETUPVAL                         R5 1
       53 GETTABLEKS                       R5 R5 K5 ["isCli"]
       55 CALL                             R5 0 1
       56 JUMPIFNOT                        R5 ; [+4]
       ...
       68 GETIMPORT                        R4 K3 [script]
       70 GETTABLEKS                       R4 R4 K10 ["StudioService"]
       72 CALL                             R3 1 1
       73 GETUPVAL                         R4 0
       74 GETUPVAL                         R6 1
       75 GETTABLEKS                       R6 R6 K5 ["isCli"]
       77 CALL                             R6 0 1
       78 JUMPIFNOT                        R6 ; [+4]
       ...
       90 GETIMPORT                        R5 K3 [script]
       92 GETTABLEKS                       R5 R5 K11 ["RbxAnalyticsService"]
       94 CALL                             R4 1 1
       95 GETUPVAL                         R5 0
       96 GETUPVAL                         R7 1
       97 GETTABLEKS                       R7 R7 K5 ["isCli"]
       99 CALL                             R7 0 1
      100 JUMPIFNOT                        R7 ; [+4]
      ...
      112 GETIMPORT                        R6 K3 [script]
      114 GETTABLEKS                       R6 R6 K12 ["TutorialService"]
      116 CALL                             R5 1 1
      117 GETUPVAL                         R6 0
      118 GETUPVAL                         R8 1
      119 GETTABLEKS                       R8 R8 K5 ["isCli"]
      121 CALL                             R8 0 1
      122 JUMPIFNOT                        R8 ; [+4]
      ...
      134 GETIMPORT                        R7 K3 [script]
      136 GETTABLEKS                       R7 R7 K13 ["DataModel"]
      138 CALL                             R6 1 1
      139 GETUPVAL                         R7 0
      140 GETUPVAL                         R9 1
      141 GETTABLEKS                       R9 R9 K5 ["isCli"]
      143 CALL                             R9 0 1
      144 JUMPIFNOT                        R9 ; [+4]
      ...
      156 GETIMPORT                        R8 K3 [script]
      158 GETTABLEKS                       R8 R8 K14 ["MarketplaceService"]
      160 CALL                             R7 1 1
      161 GETUPVAL                         R8 0
      162 GETUPVAL                         R10 1
      163 GETTABLEKS                       R10 R10 K5 ["isCli"]
      165 CALL                             R10 0 1
      166 JUMPIFNOT                        R10 ; [+4]
