...
MAIN:
  ...
  CALL R6 1 1
  JUMP [+4]
  GETTABLEKS R7 R4 K18 ["Util"]
  GETTABLEKS R6 R7 K17 ["Promise"]
  GETTABLEKS R7 R2 K19 ["BaseUrl"]
  LOADK R10 K20 ["https://www."]
  NAMECALL R8 R7 K21 ["find"]
  CALL R8 2 1
  JUMPIFNOTEQKN R8 K22 [1] [+7]
  LOADN R10 13
  NAMECALL R8 R7 K23 ["sub"]
  CALL R8 2 1
  MOVE R7 R8
  JUMP [+11]
  LOADK R10 K24 ["http://www."]
  NAMECALL R8 R7 K21 ["find"]
  CALL R8 2 1
  JUMPIFNOTEQKN R8 K22 [1] [+6]
  LOADN R10 12
  NAMECALL R8 R7 K23 ["sub"]
  CALL R8 2 1
  MOVE R7 R8
  ...
  NEWCLOSURE R10 P1
  CAPTURE REF R7
  SETTABLEKS R10 R9 K26 ["BuildRobloxUrl"]
  DUPCLOSURE R10 K27 [PROTO_4]
  CAPTURE VAL R8
  CAPTURE VAL R6
  CAPTURE VAL R0
  SETTABLEKS R10 R9 K28 ["Request"]
  DUPCLOSURE R10 K29 [PROTO_8]
  CAPTURE VAL R8
  CAPTURE VAL R6
  CAPTURE VAL R1
  SETTABLEKS R10 R9 K30 ["RequestInternal"]
  CLOSEUPVALS R7
  RETURN R9 1
