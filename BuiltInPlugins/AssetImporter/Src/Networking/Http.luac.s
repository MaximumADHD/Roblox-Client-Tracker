...
MAIN:
  ...
  GETTABLEKS R6 R2 K16 ["BaseUrl"]
  LOADK R9 K17 ["https://www."]
  NAMECALL R7 R6 K18 ["find"]
  CALL R7 2 1
  JUMPIFNOTEQKN R7 K19 [1] [+7]
  LOADN R9 13
  NAMECALL R7 R6 K20 ["sub"]
  CALL R7 2 1
  MOVE R6 R7
  JUMP [+11]
  LOADK R9 K21 ["http://www."]
  NAMECALL R7 R6 K18 ["find"]
  CALL R7 2 1
  JUMPIFNOTEQKN R7 K19 [1] [+6]
  LOADN R9 12
  NAMECALL R7 R6 K20 ["sub"]
  CALL R7 2 1
  MOVE R6 R7
  ...
  NEWCLOSURE R9 P1
  CAPTURE REF R6
  SETTABLEKS R9 R8 K23 ["BuildRobloxUrl"]
  DUPCLOSURE R9 K24 [PROTO_4]
  CAPTURE VAL R7
  CAPTURE VAL R5
  CAPTURE VAL R0
  SETTABLEKS R9 R8 K25 ["Request"]
  DUPCLOSURE R9 K26 [PROTO_8]
  CAPTURE VAL R7
  CAPTURE VAL R5
  CAPTURE VAL R1
  SETTABLEKS R9 R8 K27 ["RequestInternal"]
  CLOSEUPVALS R6
  RETURN R8 1
