...
MAIN:
  ...
  SETTABLEKS R2 R1 K5 ["isLastImport"]
  DUPCLOSURE R2 K6 [PROTO_1]
  SETTABLEKS R2 R1 K7 ["isDefault"]
  DUPCLOSURE R2 K8 [PROTO_2]
  CAPTURE VAL R0
  SETTABLEKS R2 R1 K9 ["createTemplateFromLastImport"]
  DUPCLOSURE R2 K10 [PROTO_3]
  SETTABLEKS R2 R1 K11 ["applyImportDataToSession"]
  DUPCLOSURE R2 K12 [PROTO_4]
  CAPTURE VAL R0
  CAPTURE VAL R1
  SETTABLEKS R2 R1 K13 ["getNameList"]
  DUPCLOSURE R2 K14 [PROTO_5]
  CAPTURE VAL R1
  CAPTURE VAL R0
  SETTABLEKS R2 R1 K15 ["resolveTemplate"]
  DUPCLOSURE R2 K16 [PROTO_6]
  CAPTURE VAL R1
  SETTABLEKS R2 R1 K17 ["initializeTemplates"]
  RETURN R1 1
