...
MAIN:
  ...
  SETTABLEKS R3 R2 K9 ["isLastImport"]
  DUPCLOSURE R3 K10 [PROTO_1]
  SETTABLEKS R3 R2 K11 ["isDefault"]
  DUPCLOSURE R3 K12 [PROTO_2]
  CAPTURE VAL R0
  SETTABLEKS R3 R2 K13 ["createTemplateFromLastImport"]
  DUPCLOSURE R3 K14 [PROTO_3]
  SETTABLEKS R3 R2 K15 ["applyImportDataToSession"]
  DUPCLOSURE R3 K16 [PROTO_4]
  CAPTURE VAL R0
  CAPTURE VAL R2
  SETTABLEKS R3 R2 K17 ["getNameList"]
  DUPCLOSURE R3 K18 [PROTO_5]
  CAPTURE VAL R2
  CAPTURE VAL R0
  SETTABLEKS R3 R2 K19 ["resolveTemplate"]
  DUPCLOSURE R3 K20 [PROTO_6]
  CAPTURE VAL R2
  SETTABLEKS R3 R2 K21 ["initializeTemplates"]
  RETURN R2 1
