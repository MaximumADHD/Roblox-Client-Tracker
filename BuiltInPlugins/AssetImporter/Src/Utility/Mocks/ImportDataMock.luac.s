...
MAIN:
  ...
  CAPTURE VAL R3
  SETTABLEKS R5 R4 K19 ["AddMockStatus"]
  DUPCLOSURE R5 K20 [PROTO_4]
  SETTABLEKS R5 R4 K21 ["GetStatuses"]
  DUPCLOSURE R5 K22 [PROTO_5]
  SETTABLEKS R5 R4 K23 ["IsA"]
  DUPCLOSURE R5 K24 [PROTO_6]
  SETTABLEKS R5 R4 K25 ["_addChild"]
  DUPCLOSURE R5 K26 [PROTO_7]
  SETTABLEKS R5 R4 K27 ["_removeChild"]
  DUPCLOSURE R5 K28 [PROTO_8]
  SETTABLEKS R5 R4 K29 ["GetChildren"]
  DUPCLOSURE R5 K30 [PROTO_9]
  SETTABLEKS R5 R4 K31 ["SetParent"]
  DUPCLOSURE R5 K32 [PROTO_10]
  SETTABLEKS R5 R4 K33 ["Destroy"]
  DUPCLOSURE R5 K34 [PROTO_11]
  SETTABLEKS R5 R4 K35 ["AddPreviewInstance"]
  DUPCLOSURE R5 K36 [PROTO_12]
  SETTABLEKS R5 R4 K37 ["GetPreview"]
  RETURN R4 1
