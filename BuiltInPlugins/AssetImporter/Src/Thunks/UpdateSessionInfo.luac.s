PROTO_0:
  ...
  JUMP [+3]
  LOADB R4 0
  SETTABLEKS R4 R3 K10 ["validSession"]
  GETUPVAL R5 6
  ...
  CALL R5 0 1
  JUMPIFNOT R5 [+24]
  NAMECALL R8 R0 K12 ["getState"]
  CALL R8 1 1
  GETTABLEKS R7 R8 K13 ["Sessions"]
  GETTABLEKS R6 R7 K14 ["sessionQueue"]
  GETUPVAL R8 0
  GETTABLEKS R7 R8 K15 ["filepath"]
  GETTABLE R5 R6 R7
  GETUPVAL R8 8
  MOVE R9 R4
  CALL R8 1 -1
  NAMECALL R6 R0 K16 ["dispatch"]
  CALL R6 -1 0
  GETUPVAL R8 9
  MOVE R9 R5
  MOVE R10 R4
  ...
  NAMECALL R6 R0 K16 ["dispatch"]
  CALL R6 -1 0
  NAMECALL R7 R0 K12 ["getState"]
  CALL R7 1 1
  GETTABLEKS R6 R7 K17 ["Dialogs"]
  GETTABLEKS R5 R6 K18 ["showPreview"]
  JUMPIFNOT R5 [+6]
  GETUPVAL R7 10
  MOVE R8 R4
  CALL R7 1 -1
...
MAIN:
  ...
  GETTABLEKS R6 R7 K13 ["UpdateSessionCount"]
  CALL R5 1 1
  GETIMPORT R6 K7 [require]
  GETTABLEKS R9 R0 K4 ["Src"]
  GETTABLEKS R8 R9 K14 ["Utility"]
  GETTABLEKS R7 R8 K15 ["GetErrorChecked"]
  CALL R6 1 1
  GETIMPORT R7 K7 [require]
  GETTABLEKS R10 R0 K4 ["Src"]
  GETTABLEKS R9 R10 K14 ["Utility"]
  GETTABLEKS R8 R9 K16 ["GetCheckedCount"]
  CALL R7 1 1
  GETIMPORT R8 K7 [require]
  GETTABLEKS R12 R0 K4 ["Src"]
  GETTABLEKS R11 R12 K14 ["Utility"]
  GETTABLEKS R10 R11 K17 ["Status"]
  GETTABLEKS R9 R10 K18 ["countStatusLevelsForTree"]
  CALL R8 1 1
  GETIMPORT R9 K7 [require]
  GETTABLEKS R12 R0 K4 ["Src"]
  GETTABLEKS R11 R12 K14 ["Utility"]
  GETTABLEKS R10 R11 K19 ["isAssetNameValid"]
  CALL R9 1 1
  GETIMPORT R10 K7 [require]
  GETTABLEKS R13 R0 K4 ["Src"]
  GETTABLEKS R12 R13 K20 ["Flags"]
  GETTABLEKS R11 R12 K21 ["getFFlagAssetImportEnableMultipleFiles"]
  CALL R10 1 1
  GETIMPORT R11 K7 [require]
  GETTABLEKS R14 R0 K4 ["Src"]
  GETTABLEKS R13 R14 K20 ["Flags"]
  GETTABLEKS R12 R13 K22 ["getFFlagAssetImportDisallowEmptyRootNames"]
  CALL R11 1 1
