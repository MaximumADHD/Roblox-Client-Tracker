...
PROTO_14:
  ...
  JUMPIFNOTEQ R12 R2 [+14]
  GETUPVAL R14 2
  GETUPVAL R16 3
  GETTABLEKS R15 R16 K5 ["update"]
  MOVE R16 R11
  DUPTABLE R17 K6 [{"currentPreset"}]
  SETTABLEKS R1 R17 K4 ["currentPreset"]
  CALL R15 2 -1
  CALL R14 -1 -1
  NAMECALL R12 R5 K7 ["dispatch"]
  CALL R12 -1 0
  FORGLOOP R6 2 [-26]
  JUMP [+49]
...
PROTO_32:
  ...
  MOVE R4 R2
  DUPTABLE R5 K13 [{"currentPreset"}]
  GETTABLEKS R6 R0 K6 ["defaultName"]
  SETTABLEKS R6 R5 K12 ["currentPreset"]
  CALL R3 2 1
  GETTABLEKS R4 R0 K0 ["_store"]
  GETUPVAL R6 5
  MOVE R7 R3
  ...
  NAMECALL R4 R4 K14 ["dispatch"]
  CALL R4 -1 0
  NAMECALL R4 R0 K4 ["hasCustomDefault"]
  CALL R4 1 1
  JUMPIFNOT R4 [+52]
  GETTABLEKS R4 R2 K5 ["validSession"]
  JUMPIFNOT R4 [+49]
  GETTABLEKS R6 R0 K6 ["defaultName"]
  MOVE R7 R2
  NAMECALL R4 R0 K7 ["resolvePreset"]
  CALL R4 3 0
  RETURN R0 0
  ...
  LOADNIL R6
  FORGPREP R4
  GETTABLEKS R9 R0 K6 ["defaultName"]
  JUMPIFNOTEQ R8 R9 [+3]
  MOVE R3 R7
  JUMP [+2]
  FORGLOOP R4 2 [-7]
  ...
  GETTABLEKS R4 R0 K0 ["_store"]
  GETUPVAL R6 6
  GETTABLEKS R7 R0 K6 ["defaultName"]
  CALL R6 1 -1
  NAMECALL R4 R4 K14 ["dispatch"]
  CALL R4 -1 0
  GETTABLEKS R6 R0 K6 ["defaultName"]
...
MAIN:
  ...
  GETTABLEKS R12 R13 K20 ["DEPRECATED_SetSessionQueue"]
  CALL R11 1 1
  ...
  GETTABLEKS R21 R22 K32 ["getFFlagImportQueueFixFileMiscount"]
  CALL R20 1 1
  LOADK R23 K33 ["PresetController"]
  NAMECALL R21 R4 K34 ["extend"]
  CALL R21 2 1
  DUPCLOSURE R22 K35 [PROTO_0]
  CAPTURE VAL R21
  SETTABLEKS R22 R21 K36 ["new"]
  DUPCLOSURE R22 K37 [PROTO_6]
  SETGLOBAL R22 K38 ["wrapAssetImportService"]
  DUPCLOSURE R22 K39 [PROTO_9]
  CAPTURE VAL R21
  SETTABLEKS R22 R21 K40 ["mock"]
  DUPCLOSURE R22 K41 [PROTO_10]
  SETTABLEKS R22 R21 K42 ["destroy"]
  DUPCLOSURE R22 K43 [PROTO_11]
  SETTABLEKS R22 R21 K44 ["_filter"]
  DUPCLOSURE R22 K45 [PROTO_12]
  CAPTURE VAL R5
  CAPTURE VAL R19
  CAPTURE VAL R10
  CAPTURE VAL R18
  ...
  CAPTURE VAL R8
  CAPTURE VAL R9
  SETTABLEKS R22 R21 K46 ["save"]
  DUPCLOSURE R22 K47 [PROTO_13]
  SETTABLEKS R22 R21 K48 ["createPresetFromLastImport"]
  ...
  CAPTURE VAL R11
  CAPTURE VAL R8
  SETTABLEKS R22 R21 K50 ["DEPRECATED_updateQueueItems"]
  DUPCLOSURE R22 K51 [PROTO_15]
  CAPTURE VAL R17
  CAPTURE VAL R20
  CAPTURE VAL R12
  CAPTURE VAL R15
  CAPTURE VAL R11
  CAPTURE VAL R8
  SETTABLEKS R22 R21 K52 ["_updateQueueItems"]
  DUPCLOSURE R22 K53 [PROTO_16]
  CAPTURE VAL R19
  SETTABLEKS R22 R21 K54 ["rename"]
  DUPCLOSURE R22 K55 [PROTO_17]
  CAPTURE VAL R9
  SETTABLEKS R22 R21 K56 ["DEPRECATED_rename"]
  DUPCLOSURE R22 K57 [PROTO_18]
  CAPTURE VAL R18
  CAPTURE VAL R19
  CAPTURE VAL R9
  CAPTURE VAL R10
  SETTABLEKS R22 R21 K58 ["delete"]
  DUPCLOSURE R22 K59 [PROTO_19]
  SETTABLEKS R22 R21 K60 ["setDefault"]
  DUPCLOSURE R22 K61 [PROTO_20]
  SETTABLEKS R22 R21 K62 ["hasCustomDefault"]
  DUPCLOSURE R22 K63 [PROTO_21]
  SETTABLEKS R22 R21 K64 ["applyPresetToAllSessions"]
  DUPCLOSURE R22 K65 [PROTO_22]
  CAPTURE VAL R17
  CAPTURE VAL R18
  CAPTURE VAL R12
  SETTABLEKS R22 R21 K66 ["applyImportDataToSession"]
  DUPCLOSURE R22 K67 [PROTO_23]
  SETTABLEKS R22 R21 K68 ["isDefault"]
  DUPCLOSURE R22 K69 [PROTO_24]
  SETTABLEKS R22 R21 K70 ["isLastImport"]
  DUPCLOSURE R22 K71 [PROTO_25]
  SETTABLEKS R22 R21 K72 ["isStudioDefault"]
  DUPCLOSURE R22 K73 [PROTO_26]
  SETTABLEKS R22 R21 K74 ["reset"]
  DUPCLOSURE R22 K75 [PROTO_27]
  CAPTURE VAL R15
  CAPTURE VAL R19
  CAPTURE VAL R18
  CAPTURE VAL R13
  ...
  CAPTURE VAL R17
  CAPTURE VAL R12
  SETTABLEKS R22 R21 K76 ["resolvePreset"]
  DUPCLOSURE R22 K77 [PROTO_28]
  CAPTURE VAL R18
  CAPTURE VAL R17
  CAPTURE VAL R9
  CAPTURE VAL R13
  CAPTURE VAL R14
  CAPTURE VAL R10
  SETTABLEKS R22 R21 K78 ["DEPRECATED_resolvePreset"]
  DUPCLOSURE R22 K79 [PROTO_30]
  CAPTURE VAL R6
  CAPTURE VAL R19
  CAPTURE VAL R7
  SETTABLEKS R22 R21 K80 ["getNameList"]
  DUPCLOSURE R22 K81 [PROTO_31]
  SETTABLEKS R22 R21 K82 ["getAllPresets"]
  DUPCLOSURE R22 K83 [PROTO_32]
  CAPTURE VAL R18
  CAPTURE VAL R17
  CAPTURE VAL R20
  CAPTURE VAL R15
  ...
  CAPTURE VAL R8
  CAPTURE VAL R9
  SETTABLEKS R22 R21 K84 ["initializePresets"]
  DUPCLOSURE R22 K85 [PROTO_33]
  CAPTURE VAL R16
  CAPTURE VAL R6
  SETTABLEKS R22 R21 K86 ["getNumPresetsRemaining"]
  RETURN R21 1
