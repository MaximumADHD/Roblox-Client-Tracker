...
PROTO_24:
  GETTABLEKS R3 R2 K0 ["session"]
  JUMPIFNOT R3 [+4]
  NAMECALL R4 R3 K1 ["GetImportTree"]
  CALL R4 1 1
  JUMPIF R4 [+1]
  RETURN R0 0
  NAMECALL R4 R3 K2 ["Reset"]
  CALL R4 1 0
  MOVE R7 R1
  NAMECALL R5 R0 K3 ["isLastImport"]
  CALL R5 2 1
  JUMPIFNOT R5 [+8]
  GETTABLEKS R4 R0 K4 ["_assetImportServiceWrapper"]
  GETTABLEKS R6 R0 K5 ["lastImportName"]
  NAMECALL R4 R4 K6 ["GetPreset"]
  CALL R4 2 1
  JUMP [+6]
  GETTABLEKS R4 R0 K4 ["_assetImportServiceWrapper"]
  MOVE R6 R1
  ...
  CALL R4 2 1
  MOVE R7 R4
  NAMECALL R5 R3 K7 ["ApplyPreset"]
  CALL R5 2 0
  GETUPVAL R6 0
  GETTABLEKS R5 R6 K8 ["update"]
  MOVE R6 R2
  DUPTABLE R7 K10 [{"currentPreset"}]
  SETTABLEKS R1 R7 K9 ["currentPreset"]
  CALL R5 2 1
  ...
  NAMECALL R9 R9 K18 ["dispatch"]
  CALL R9 -1 0
  GETTABLEKS R6 R0 K11 ["_store"]
  GETUPVAL R8 5
  MOVE R9 R5
  CALL R8 1 -1
  NAMECALL R6 R6 K18 ["dispatch"]
  CALL R6 -1 0
  RETURN R0 0
...
PROTO_25:
  ...
  CALL R3 0 1
  JUMPIFNOT R3 [+5]
  NAMECALL R3 R2 K6 ["GetImportTree"]
  CALL R3 1 1
  JUMPIF R3 [+1]
  RETURN R0 0
  FASTCALL2K ASSERT R2 K7 [+5]
  MOVE R4 R2
  LOADK R5 K7 ["Session does not exist!"]
...
PROTO_29:
  ...
  CALL R4 -1 0
  RETURN R0 0
  NAMECALL R2 R0 K15 ["getNameList"]
  CALL R2 1 1
  LOADNIL R3
  MOVE R4 R2
  LOADNIL R5
  ...
  NAMECALL R4 R0 K16 ["DEPRECATED_resolvePreset"]
  CALL R4 2 0
  RETURN R0 0
  GETTABLEKS R4 R0 K0 ["_store"]
  GETUPVAL R6 3
  GETTABLEKS R7 R0 K17 ["studioDefaultName"]
  CALL R6 1 -1
  NAMECALL R4 R4 K14 ["dispatch"]
  CALL R4 -1 0
  RETURN R0 0
...
MAIN:
  ...
  CAPTURE VAL R7
  CAPTURE VAL R8
  SETTABLEKS R18 R17 K43 ["save"]
  DUPCLOSURE R18 K44 [PROTO_13]
  SETTABLEKS R18 R17 K45 ["createPresetFromLastImport"]
  DUPCLOSURE R18 K46 [PROTO_14]
  CAPTURE VAL R14
  CAPTURE VAL R10
  CAPTURE VAL R7
  SETTABLEKS R18 R17 K47 ["_updateQueueItems"]
  DUPCLOSURE R18 K48 [PROTO_15]
  SETTABLEKS R18 R17 K49 ["rename"]
  DUPCLOSURE R18 K50 [PROTO_16]
  CAPTURE VAL R8
  SETTABLEKS R18 R17 K51 ["DEPRECATED_rename"]
  DUPCLOSURE R18 K52 [PROTO_17]
  CAPTURE VAL R16
  CAPTURE VAL R8
  CAPTURE VAL R9
  SETTABLEKS R18 R17 K53 ["delete"]
  DUPCLOSURE R18 K54 [PROTO_18]
  SETTABLEKS R18 R17 K55 ["setDefault"]
  DUPCLOSURE R18 K56 [PROTO_19]
  SETTABLEKS R18 R17 K57 ["hasCustomDefault"]
  DUPCLOSURE R18 K58 [PROTO_20]
  CAPTURE VAL R16
  CAPTURE VAL R11
  SETTABLEKS R18 R17 K59 ["applyImportDataToSession"]
  DUPCLOSURE R18 K60 [PROTO_21]
  SETTABLEKS R18 R17 K61 ["isDefault"]
  DUPCLOSURE R18 K62 [PROTO_22]
  SETTABLEKS R18 R17 K63 ["isLastImport"]
  DUPCLOSURE R18 K64 [PROTO_23]
  SETTABLEKS R18 R17 K65 ["isStudioDefault"]
  DUPCLOSURE R18 K66 [PROTO_24]
  CAPTURE VAL R14
  CAPTURE VAL R12
  CAPTURE VAL R13
  CAPTURE VAL R9
  CAPTURE VAL R7
  CAPTURE VAL R11
  SETTABLEKS R18 R17 K67 ["resolvePreset"]
  DUPCLOSURE R18 K68 [PROTO_25]
  CAPTURE VAL R16
  CAPTURE VAL R8
  CAPTURE VAL R12
  CAPTURE VAL R13
  CAPTURE VAL R9
  SETTABLEKS R18 R17 K69 ["DEPRECATED_resolvePreset"]
  DUPCLOSURE R18 K70 [PROTO_27]
  CAPTURE VAL R5
  CAPTURE VAL R6
  SETTABLEKS R18 R17 K71 ["getNameList"]
  DUPCLOSURE R18 K72 [PROTO_28]
  SETTABLEKS R18 R17 K73 ["getAllPresets"]
  DUPCLOSURE R18 K74 [PROTO_29]
  CAPTURE VAL R16
  CAPTURE VAL R14
  CAPTURE VAL R10
  CAPTURE VAL R8
  SETTABLEKS R18 R17 K75 ["initializePresets"]
  DUPCLOSURE R18 K76 [PROTO_30]
  CAPTURE VAL R15
  CAPTURE VAL R5
  SETTABLEKS R18 R17 K77 ["getNumPresetsRemaining"]
  RETURN R17 1
