...
PROTO_20:
  ...
  MOVE R4 R2
  LOADK R5 K4 ["Session does not exist!"]
  GETIMPORT R3 K6 [assert]
  CALL R3 2 0
  NAMECALL R3 R2 K7 ["Reset"]
  CALL R3 1 0
  GETTABLEKS R3 R0 K0 ["_store"]
  GETUPVAL R5 1
  MOVE R6 R1
  ...
  LOADNIL R3
  MOVE R6 R1
  NAMECALL R4 R0 K9 ["isLastImport"]
  CALL R4 2 1
  JUMPIFNOT R4 [+9]
  GETTABLEKS R4 R0 K10 ["_assetImportServiceWrapper"]
  GETTABLEKS R6 R0 K11 ["lastImportName"]
  NAMECALL R4 R4 K12 ["GetPreset"]
  CALL R4 2 1
  MOVE R3 R4
  JUMP [+7]
  GETTABLEKS R4 R0 K10 ["_assetImportServiceWrapper"]
  ...
  MOVE R3 R4
  MOVE R6 R3
  NAMECALL R4 R2 K13 ["ApplyPreset"]
  CALL R4 2 0
  NEWTABLE R4 0 0
  GETUPVAL R6 0
  CALL R6 0 1
  ...
  GETTABLEKS R5 R6 K14 ["importDataChecked"]
  JUMP [+7]
  ...
  LOADNIL R8
  FORGPREP R6
  GETTABLEKS R11 R9 K15 ["ShouldImport"]
  SETTABLE R11 R4 R9
  FORGLOOP R6 2 [-4]
  GETTABLEKS R6 R0 K0 ["_store"]
  GETUPVAL R8 2
  ...
  GETTABLEKS R6 R7 K16 ["selectedImportItem"]
  JUMP [+7]
  GETTABLEKS R7 R0 K0 ["_store"]
  NAMECALL R7 R7 K1 ["getState"]
  CALL R7 1 1
  GETTABLEKS R6 R7 K16 ["selectedImportItem"]
  JUMPIFNOT R6 [+11]
  NAMECALL R7 R6 K17 ["GetPreview"]
  CALL R7 1 1
  GETTABLEKS R8 R0 K0 ["_store"]
  GETUPVAL R10 3
  MOVE R11 R7
  CALL R10 1 -1
  NAMECALL R8 R8 K8 ["dispatch"]
  CALL R8 -1 0
  GETTABLEKS R7 R0 K0 ["_store"]
  GETUPVAL R9 4
  LOADB R10 0
...
PROTO_24:
  ...
  CALL R3 -1 0
  RETURN R0 0
  GETTABLEKS R1 R0 K6 ["_plugin"]
  LOADK R3 K7 ["AssetImporter_DefaultPreset"]
  NAMECALL R1 R1 K8 ["GetSetting"]
  CALL R1 2 1
  JUMPIF R1 [+2]
  GETTABLEKS R1 R0 K5 ["studioDefaultName"]
  ...
  FORGPREP R4
  MOVE R11 R8
  NAMECALL R9 R0 K9 ["isStudioDefault"]
  CALL R9 2 1
  JUMPIFNOT R9 [+2]
  MOVE R3 R7
  JUMP [+5]
  GETTABLEKS R9 R0 K1 ["defaultName"]
  JUMPIFNOTEQ R8 R9 [+2]
  MOVE R2 R7
  FORGLOOP R4 2 [-13]
  JUMPIFNOT R2 [+18]
  GETTABLEKS R4 R0 K2 ["_store"]
  GETUPVAL R6 1
  GETTABLEKS R7 R0 K1 ["defaultName"]
  CALL R6 1 -1
  NAMECALL R4 R4 K3 ["dispatch"]
  CALL R4 -1 0
  GETTABLEKS R6 R0 K1 ["defaultName"]
  NAMECALL R4 R0 K4 ["resolvePreset"]
  CALL R4 2 0
  MOVE R4 R2
  GETTABLEKS R5 R0 K1 ["defaultName"]
  RETURN R4 2
  GETTABLEKS R4 R0 K2 ["_store"]
  GETUPVAL R6 1
  GETTABLEKS R7 R0 K5 ["studioDefaultName"]
  CALL R6 1 -1
  NAMECALL R4 R4 K3 ["dispatch"]
  CALL R4 -1 0
  MOVE R4 R3
  GETTABLEKS R5 R0 K5 ["studioDefaultName"]
  RETURN R4 2
...
MAIN:
  ...
  GETTABLEKS R13 R14 K24 ["getFFlagAssetImportFixDropdownRender"]
  CALL R12 1 1
  GETIMPORT R13 K5 [require]
  GETTABLEKS R16 R0 K6 ["Src"]
  GETTABLEKS R15 R16 K22 ["Flags"]
  GETTABLEKS R14 R15 K25 ["getFFlagAssetImportRefactorReducer"]
  CALL R13 1 1
  GETIMPORT R14 K5 [require]
  GETTABLEKS R17 R0 K6 ["Src"]
  GETTABLEKS R16 R17 K22 ["Flags"]
  GETTABLEKS R15 R16 K26 ["getFFlagAssetImportRefactorFileOpen"]
  CALL R14 1 1
