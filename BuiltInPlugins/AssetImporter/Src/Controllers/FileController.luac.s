...
PROTO_16:
  ...
  CALL R9 1 1
  GETTABLEKS R8 R9 K11 ["Dialogs"]
  GETTABLEKS R7 R8 K12 ["showQueue"]
  JUMPIFNOT R7 [+11]
  MOVE R9 R4
  NAMECALL R7 R0 K13 ["requestPreview"]
  CALL R7 2 0
  JUMP [+6]
  JUMPIFNOT R6 [+5]
  JUMPIFNOT R5 [+4]
...
MAIN:
  ...
  GETTABLEKS R20 R21 K30 ["getFFlagImportQueueRibbonDropdown"]
  CALL R19 1 1
  GETIMPORT R20 K9 [require]
  GETTABLEKS R23 R1 K14 ["Src"]
  GETTABLEKS R22 R23 K27 ["Flags"]
  GETTABLEKS R21 R22 K31 ["getFFlagCinCancelParse"]
  CALL R20 1 1
