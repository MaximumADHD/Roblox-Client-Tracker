...
MAIN:
  ...
  GETTABLEKS R16 R17 K24 ["getFFlagAssetImportEnableMultipleFiles"]
  CALL R15 1 1
  GETIMPORT R16 K5 [require]
  GETTABLEKS R19 R0 K10 ["Src"]
  GETTABLEKS R18 R19 K23 ["Flags"]
  GETTABLEKS R17 R18 K25 ["getFFlagAssetImportUseUploadId"]
  CALL R16 1 1
  LOADK R19 K26 ["FileController"]
  ...
  CAPTURE VAL R5
  SETTABLEKS R18 R17 K33 ["DEPRECATED_cleanupPreview"]
  DUPCLOSURE R18 K34 [PROTO_9]
  CAPTURE VAL R7
  CAPTURE VAL R10
  SETTABLEKS R18 R17 K35 ["DEPRECATED_onSessionCanceled"]
  ...
  CAPTURE VAL R6
  CAPTURE VAL R9
  SETTABLEKS R18 R17 K39 ["onPluginButtonClicked"]
  DUPCLOSURE R18 K40 [PROTO_14]
  CAPTURE VAL R15
  CAPTURE VAL R9
  CAPTURE VAL R7
  CAPTURE VAL R6
  SETTABLEKS R18 R17 K41 ["requestFilePicker"]
  DUPCLOSURE R18 K42 [PROTO_15]
  SETTABLEKS R18 R17 K43 ["_onFilePicked"]
  DUPCLOSURE R18 K44 [PROTO_17]
  SETTABLEKS R18 R17 K45 ["requestFileSwap"]
  DUPCLOSURE R18 K46 [PROTO_18]
  SETTABLEKS R18 R17 K47 ["_onFileSwapped"]
  DUPCLOSURE R18 K48 [PROTO_20]
  CAPTURE VAL R13
  SETTABLEKS R18 R17 K49 ["requestPreview"]
  DUPCLOSURE R18 K50 [PROTO_21]
  CAPTURE VAL R7
  CAPTURE VAL R6
  CAPTURE VAL R10
  CAPTURE VAL R8
  SETTABLEKS R18 R17 K51 ["DEPRECATED_onImport"]
  DUPCLOSURE R18 K52 [PROTO_22]
  CAPTURE VAL R10
  SETTABLEKS R18 R17 K53 ["DEPRECATED_onImportCompleted"]
  RETURN R17 1
