...
MAIN:
  ...
  GETTABLEKS R17 R18 K27 ["getFFlagAssetImportOneFileAlwaysShowsPreview"]
  CALL R16 1 1
  GETIMPORT R17 K9 [require]
  GETTABLEKS R20 R1 K14 ["Src"]
  GETTABLEKS R19 R20 K26 ["Flags"]
  GETTABLEKS R18 R19 K28 ["getFFlagImportQueueRibbonDropdown"]
  CALL R17 1 1
  GETIMPORT R18 K9 [require]
  GETTABLEKS R21 R1 K14 ["Src"]
  GETTABLEKS R20 R21 K26 ["Flags"]
  GETTABLEKS R19 R20 K29 ["getFFlagCinCancelParse"]
  CALL R18 1 1
  LOADK R21 K30 ["FileController"]
  ...
  DUPCLOSURE R20 K34 [PROTO_8]
  CAPTURE VAL R19
  SETTABLEKS R20 R19 K35 ["mock"]
  DUPCLOSURE R20 K36 [PROTO_9]
  CAPTURE VAL R6
  SETTABLEKS R20 R19 K37 ["DEPRECATED_cleanupPreview"]
  DUPCLOSURE R20 K38 [PROTO_10]
  CAPTURE VAL R8
  CAPTURE VAL R10
  SETTABLEKS R20 R19 K39 ["DEPRECATED_onSessionCanceled"]
  DUPCLOSURE R20 K40 [PROTO_11]
  SETTABLEKS R20 R19 K41 ["destroy"]
  MOVE R20 R17
  CALL R20 0 1
  JUMPIFNOT R20 [+4]
  DUPCLOSURE R20 K42 [PROTO_12]
  CAPTURE VAL R9
  SETTABLEKS R20 R19 K43 ["onQueueButtonClicked"]
  DUPCLOSURE R20 K44 [PROTO_13]
  CAPTURE VAL R18
  CAPTURE VAL R9
  SETTABLEKS R20 R19 K45 ["onPluginButtonClicked"]
  DUPCLOSURE R20 K46 [PROTO_15]
  CAPTURE VAL R18
  SETTABLEKS R20 R19 K47 ["requestFilePicker"]
  DUPCLOSURE R20 K48 [PROTO_16]
  CAPTURE VAL R16
  CAPTURE VAL R11
  CAPTURE VAL R18
  CAPTURE VAL R7
  SETTABLEKS R20 R19 K49 ["_onFilePicked"]
  DUPCLOSURE R20 K50 [PROTO_18]
  CAPTURE VAL R18
  SETTABLEKS R20 R19 K51 ["requestFileSwap"]
  DUPCLOSURE R20 K52 [PROTO_19]
  CAPTURE VAL R14
  SETTABLEKS R20 R19 K53 ["_onFileSwapped"]
  DUPCLOSURE R20 K54 [PROTO_20]
  CAPTURE VAL R0
  CAPTURE VAL R15
  SETTABLEKS R20 R19 K55 ["pickTextureFileWithPrompt"]
  DUPCLOSURE R20 K56 [PROTO_22]
  CAPTURE VAL R14
  SETTABLEKS R20 R19 K57 ["requestPreview"]
  RETURN R19 1
