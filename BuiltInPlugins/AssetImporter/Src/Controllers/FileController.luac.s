...
PROTO_21:
  ...
  GETTABLEKS R2 R3 K3 ["activeQueueItem"]
  GETTABLEKS R3 R0 K0 ["_store"]
  GETUPVAL R5 1
  MOVE R6 R2
  CALL R5 1 -1
  ...
  NAMECALL R4 R4 K1 ["getState"]
  CALL R4 1 1
  GETTABLEKS R3 R4 K7 ["Dialogs"]
  GETTABLEKS R2 R3 K8 ["uploading"]
  JUMPIFNOT R2 [+1]
  RETURN R0 0
  GETTABLEKS R2 R0 K9 ["_presetController"]
  NAMECALL R4 R1 K10 ["GetImportTree"]
  CALL R4 1 -1
  NAMECALL R2 R2 K11 ["createPresetFromLastImport"]
  CALL R2 -1 0
  NAMECALL R2 R1 K12 ["Upload"]
  CALL R2 1 0
  GETTABLEKS R2 R0 K0 ["_store"]
  GETUPVAL R4 3
  LOADB R5 0
...
MAIN:
  ...
  GETTABLEKS R13 R14 K21 ["Uploader"]
  CALL R12 1 1
  GETTABLEKS R14 R0 K10 ["Src"]
  GETTABLEKS R13 R14 K22 ["Thunks"]
  GETIMPORT R14 K5 [require]
  GETTABLEKS R15 R13 K23 ["ShowImportPreview"]
  CALL R14 1 1
  GETIMPORT R15 K5 [require]
  GETTABLEKS R16 R13 K24 ["ShowUploadWidget"]
  CALL R15 1 1
  GETIMPORT R16 K5 [require]
  GETTABLEKS R17 R13 K25 ["LoadManagedGroups"]
  CALL R16 1 1
  ...
  GETTABLEKS R19 R20 K28 ["getFFlagAssetImportUseQueueItem"]
  CALL R18 1 1
  GETIMPORT R19 K5 [require]
  GETTABLEKS R22 R0 K10 ["Src"]
  GETTABLEKS R21 R22 K26 ["Flags"]
  GETTABLEKS R20 R21 K29 ["getFFlagAssetImportRefactorUploadWidgets"]
  CALL R19 1 1
  ...
  CAPTURE VAL R5
  SETTABLEKS R22 R21 K38 ["DEPRECATED_cleanupPreview"]
  DUPCLOSURE R22 K39 [PROTO_9]
  CAPTURE VAL R7
  CAPTURE VAL R10
  SETTABLEKS R22 R21 K40 ["DEPRECATED_onSessionCanceled"]
  ...
  CAPTURE VAL R7
  CAPTURE VAL R6
  SETTABLEKS R22 R21 K44 ["onPluginButtonClicked"]
  DUPCLOSURE R22 K45 [PROTO_14]
  CAPTURE VAL R17
  CAPTURE VAL R18
  CAPTURE VAL R7
  CAPTURE VAL R6
  SETTABLEKS R22 R21 K46 ["requestFilePicker"]
  DUPCLOSURE R22 K47 [PROTO_15]
  SETTABLEKS R22 R21 K48 ["_onFilePicked"]
  DUPCLOSURE R22 K49 [PROTO_17]
  SETTABLEKS R22 R21 K50 ["requestFileSwap"]
  DUPCLOSURE R22 K51 [PROTO_18]
  CAPTURE VAL R14
  SETTABLEKS R22 R21 K52 ["_onFileSwapped"]
  DUPCLOSURE R22 K53 [PROTO_20]
  CAPTURE VAL R14
  SETTABLEKS R22 R21 K54 ["requestPreview"]
  DUPCLOSURE R22 K55 [PROTO_21]
  CAPTURE VAL R19
  CAPTURE VAL R15
  CAPTURE VAL R12
  CAPTURE VAL R7
  ...
  CAPTURE VAL R10
  CAPTURE VAL R8
  SETTABLEKS R22 R21 K56 ["DEPRECATED_onImport"]
  DUPCLOSURE R22 K57 [PROTO_22]
  CAPTURE VAL R10
  SETTABLEKS R22 R21 K58 ["DEPRECATED_onImportCompleted"]
  RETURN R21 1
