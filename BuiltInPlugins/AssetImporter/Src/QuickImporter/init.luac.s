...
MAIN:
  ...
  GETTABLEKS R10 R11 K20 ["Dialogs"]
  GETTABLEKS R9 R10 K21 ["AdHocDialogue"]
  CALL R8 1 1
  GETIMPORT R9 K10 [require]
  GETTABLEKS R14 R2 K17 ["Src"]
  GETTABLEKS R13 R14 K19 ["Components"]
  GETTABLEKS R12 R13 K20 ["Dialogs"]
  GETTABLEKS R11 R12 K22 ["UploadWidgets"]
  GETTABLEKS R10 R11 K23 ["FailureWidget"]
  CALL R9 1 1
  GETIMPORT R10 K10 [require]
  GETTABLEKS R13 R2 K17 ["Src"]
  GETTABLEKS R12 R13 K18 ["Types"]
  GETTABLEKS R11 R12 K24 ["QueuedSession"]
  CALL R10 1 1
  GETIMPORT R11 K10 [require]
  GETTABLEKS R14 R2 K17 ["Src"]
  GETTABLEKS R13 R14 K25 ["Controllers"]
  GETTABLEKS R12 R13 K26 ["PresetController"]
  CALL R11 1 1
  GETIMPORT R12 K10 [require]
  GETTABLEKS R15 R2 K17 ["Src"]
  GETTABLEKS R14 R15 K27 ["Thunks"]
  GETTABLEKS R13 R14 K28 ["InsertModelInWorkspace"]
  CALL R12 1 1
  GETIMPORT R13 K10 [require]
  GETTABLEKS R16 R2 K17 ["Src"]
  GETTABLEKS R15 R16 K29 ["Utility"]
  GETTABLEKS R14 R15 K30 ["reportUploadedAssetId"]
  CALL R13 1 1
  GETTABLEKS R17 R2 K17 ["Src"]
  GETTABLEKS R16 R17 K31 ["Resources"]
  GETTABLEKS R15 R16 K16 ["Localization"]
  GETTABLEKS R14 R15 K32 ["LocalizedStrings"]
  GETTABLEKS R18 R2 K17 ["Src"]
  GETTABLEKS R17 R18 K31 ["Resources"]
  GETTABLEKS R16 R17 K16 ["Localization"]
  GETTABLEKS R15 R16 K33 ["SourceStrings"]
  GETIMPORT R16 K10 [require]
  GETTABLEKS R19 R2 K17 ["Src"]
  GETTABLEKS R18 R19 K34 ["QuickImporter"]
  GETTABLEKS R17 R18 K35 ["QuickImportActionUri"]
  CALL R16 1 1
  NEWTABLE R17 8 0
  SETTABLEKS R17 R17 K36 ["__index"]
  ...
  CAPTURE VAL R11
  CAPTURE VAL R17
  SETTABLEKS R18 R17 K38 ["new"]
  DUPCLOSURE R18 K39 [PROTO_2]
  CAPTURE VAL R16
  CAPTURE VAL R0
  SETTABLEKS R18 R17 K40 ["registerAction"]
  DUPCLOSURE R18 K41 [PROTO_3]
  SETTABLEKS R18 R17 K42 ["destroy"]
  DUPCLOSURE R18 K43 [PROTO_4]
  CAPTURE VAL R4
  SETTABLEKS R18 R17 K44 ["_importFailed"]
  DUPCLOSURE R18 K45 [PROTO_7]
  CAPTURE VAL R1
  CAPTURE VAL R5
  CAPTURE VAL R8
  CAPTURE VAL R9
  CAPTURE VAL R10
  SETTABLEKS R18 R17 K46 ["_createFailureDialog"]
  DUPCLOSURE R18 K47 [PROTO_10]
  CAPTURE VAL R0
  CAPTURE VAL R13
  CAPTURE VAL R12
  SETTABLEKS R18 R17 K48 ["run"]
  RETURN R17 1
