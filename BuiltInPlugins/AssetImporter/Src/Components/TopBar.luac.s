PROTO_0:
  ...
  CALL R3 0 1
  JUMPIFNOT R3 [+5]
  NAMECALL R3 R1 K1 ["GetPreview"]
  CALL R3 1 1
  MOVE R2 R3
  JUMP [+8]
  GETTABLEKS R3 R0 K2 ["AssetImportSession"]
  GETTABLEKS R5 R1 K3 ["Id"]
  NAMECALL R3 R3 K4 ["GetInstance"]
  CALL R3 2 1
  MOVE R2 R3
  GETTABLEKS R3 R0 K5 ["UpdatePreviewInstance"]
  MOVE R4 R2
  CALL R3 1 0
  RETURN R0 0
...
PROTO_3:
  ...
  CALL R8 0 1
  JUMPIFNOT R8 [+5]
  NAMECALL R8 R6 K19 ["GetPreview"]
  CALL R8 1 1
  MOVE R7 R8
  JUMP [+8]
  GETTABLEKS R8 R5 K11 ["AssetImportSession"]
  GETTABLEKS R10 R6 K20 ["Id"]
  NAMECALL R8 R8 K21 ["GetInstance"]
  CALL R8 2 1
  MOVE R7 R8
  GETTABLEKS R8 R5 K22 ["UpdatePreviewInstance"]
  MOVE R9 R7
  CALL R8 1 0
  GETUPVAL R7 1
  GETTABLEKS R6 R7 K5 ["props"]
  GETTABLEKS R5 R6 K23 ["SetSettingsChanged"]
  LOADB R6 0
  CALL R5 1 0
  RETURN R0 0
...
PROTO_4:
  ...
  CALL R3 0 1
  JUMPIFNOT R3 [+5]
  NAMECALL R3 R1 K11 ["GetPreview"]
  CALL R3 1 1
  MOVE R2 R3
  JUMP [+8]
  GETTABLEKS R3 R0 K5 ["AssetImportSession"]
  GETTABLEKS R5 R1 K12 ["Id"]
  NAMECALL R3 R3 K13 ["GetInstance"]
  CALL R3 2 1
  MOVE R2 R3
  GETTABLEKS R3 R0 K14 ["UpdatePreviewInstance"]
  MOVE R4 R2
  CALL R3 1 0
  GETTABLEKS R1 R0 K15 ["SetSettingsChanged"]
  LOADB R2 0
  CALL R1 1 0
  RETURN R0 0
...
MAIN:
  ...
  CAPTURE VAL R25
  CAPTURE VAL R27
  SETTABLEKS R31 R28 K48 ["init"]
  DUPCLOSURE R31 K49 [PROTO_6]
  CAPTURE VAL R26
  CAPTURE VAL R25
  SETTABLEKS R31 R28 K50 ["didMount"]
  ...
  CAPTURE VAL R12
  CAPTURE VAL R19
  SETTABLEKS R31 R28 K52 ["render"]
  MOVE R31 R5
  DUPTABLE R32 K53 [{"Localization", "Stylizer", "PresetController"}]
  SETTABLEKS R6 R32 K11 ["Localization"]
  SETTABLEKS R7 R32 K13 ["Stylizer"]
  MOVE R34 R26
  CALL R34 0 1
  JUMPIFNOT R34 [+2]
  MOVE R33 R20
  JUMP [+1]
  LOADNIL R33
  SETTABLEKS R33 R32 K30 ["PresetController"]
  CALL R31 1 1
  MOVE R32 R28
  CALL R31 1 1
  MOVE R28 R31
  DUPCLOSURE R31 K54 [PROTO_9]
  DUPCLOSURE R32 K55 [PROTO_14]
  CAPTURE VAL R21
  CAPTURE VAL R22
  CAPTURE VAL R23
  CAPTURE VAL R24
  GETTABLEKS R33 R2 K56 ["connect"]
  MOVE R34 R31
  MOVE R35 R32
  CALL R33 2 1
  MOVE R34 R28
