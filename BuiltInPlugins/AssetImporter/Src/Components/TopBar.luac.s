PROTO_0:
  ...
  CALL R1 2 1
  GETTABLEKS R2 R0 K2 ["FileController"]
  MOVE R4 R1
  NAMECALL R2 R2 K5 ["requestPreview"]
  CALL R2 2 0
  RETURN R0 0
  GETTABLEKS R1 R0 K2 ["FileController"]
  GETTABLEKS R3 R0 K3 ["FileName"]
...
MAIN:
  ...
  MOVE R22 R5
  DUPTABLE R23 K41 [{"Localization", "Stylizer", "PresetController", "FileController"}]
  SETTABLEKS R6 R23 K12 ["Localization"]
  SETTABLEKS R7 R23 K14 ["Stylizer"]
  SETTABLEKS R14 R23 K25 ["PresetController"]
  MOVE R25 R21
  CALL R25 0 1
  JUMPIFNOT R25 [+2]
  MOVE R24 R15
  JUMP [+1]
  MOVE R24 R16
  SETTABLEKS R24 R23 K26 ["FileController"]
  CALL R22 1 1
  MOVE R23 R20
  CALL R22 1 1
  MOVE R20 R22
