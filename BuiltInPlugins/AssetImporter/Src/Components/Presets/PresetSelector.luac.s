...
PROTO_5:
  ...
  CALL R5 0 1
  JUMPIFNOT R5 [+5]
  GETTABLEKS R5 R1 K3 ["QueueItem"]
  GETTABLEKS R4 R5 K4 ["currentPreset"]
  JUMP [+2]
  GETTABLEKS R4 R1 K6 ["SettingsChanged"]
  GETTABLEKS R5 R1 K7 ["PresetController"]
  MOVE R7 R3
  GETTABLEKS R8 R1 K3 ["QueueItem"]
  NAMECALL R5 R5 K8 ["getNameList"]
  CALL R5 3 1
  GETTABLEKS R6 R1 K7 ["PresetController"]
  MOVE R8 R3
  NAMECALL R6 R6 K9 ["isLastImport"]
  CALL R6 2 1
  LOADNIL R7
  JUMPIFNOT R6 [+8]
  GETTABLEKS R8 R1 K10 ["Localization"]
  LOADK R10 K11 ["Templates"]
  LOADK R11 K12 ["LastImportTooltip"]
  ...
  GETTABLEKS R8 R1 K10 ["Localization"]
  LOADK R10 K11 ["Templates"]
  LOADK R11 K14 ["ModifiedTemplateTooltip"]
  NAMECALL R8 R8 K13 ["getText"]
  CALL R8 3 1
  MOVE R7 R8
  GETUPVAL R8 2
  ...
  GETUPVAL R10 4
  DUPTABLE R11 K25 [{"Items", "LayoutOrder", "OnRenderItem", "OnItemActivated", "SelectedIndex", "Size", "Width", "Enabled", "TextTruncate"}]
  SETTABLEKS R5 R11 K16 ["Items"]
  GETTABLEKS R12 R1 K17 ["LayoutOrder"]
  SETTABLEKS R12 R11 K17 ["LayoutOrder"]
  GETTABLEKS R12 R0 K26 ["renderDropdownItem"]
  SETTABLEKS R12 R11 K18 ["OnRenderItem"]
  GETTABLEKS R12 R0 K27 ["onItemActivated"]
  SETTABLEKS R12 R11 K19 ["OnItemActivated"]
  SETTABLEKS R8 R11 K20 ["SelectedIndex"]
  GETUPVAL R13 0
  CALL R13 0 1
  JUMPIFNOT R13 [+3]
  GETTABLEKS R12 R1 K21 ["Size"]
  JUMP [+1]
  LOADNIL R12
  ...
  CALL R13 0 1
  JUMPIF R13 [+7]
  GETTABLEKS R14 R2 K28 ["TemplateDropDown"]
  GETTABLEKS R13 R14 K29 ["X"]
  GETTABLEKS R12 R13 K30 ["Offset"]
  JUMP [+1]
  LOADNIL R12
  SETTABLEKS R12 R11 K22 ["Width"]
  GETUPVAL R13 0
  CALL R13 0 1
  JUMPIFNOT R13 [+3]
  GETTABLEKS R12 R1 K23 ["Enabled"]
  JUMP [+1]
  LOADNIL R12
  SETTABLEKS R12 R11 K23 ["Enabled"]
  ...
  GETUPVAL R11 5
  DUPTABLE R12 K34 [{"LayoutOrder", "Size"}]
  LOADN R13 3
  SETTABLEKS R13 R12 K17 ["LayoutOrder"]
  GETTABLEKS R13 R2 K28 ["TemplateDropDown"]
  SETTABLEKS R13 R12 K21 ["Size"]
  NEWTABLE R13 0 1
  GETUPVAL R15 3
  GETTABLEKS R14 R15 K15 ["createElement"]
  GETUPVAL R15 6
  DUPTABLE R16 K37 [{"Text", "Child"}]
  SETTABLEKS R7 R16 K35 ["Text"]
  SETTABLEKS R9 R16 K36 ["Child"]
  CALL R14 2 -1
  SETLIST R13 R14 -1 [1]
  CALL R10 3 -1
  RETURN R10 -1
...
MAIN:
  ...
  GETTABLEKS R16 R15 K23 ["StyleModifier"]
  GETTABLEKS R17 R4 K24 ["findIndex"]
  GETIMPORT R18 K5 [require]
  GETTABLEKS R21 R0 K25 ["Src"]
  GETTABLEKS R20 R21 K26 ["Controllers"]
  GETTABLEKS R19 R20 K27 ["PresetController"]
  CALL R18 1 1
  GETIMPORT R19 K5 [require]
  GETTABLEKS R22 R0 K25 ["Src"]
  GETTABLEKS R21 R22 K28 ["Actions"]
  GETTABLEKS R20 R21 K29 ["SetCurrentPreset"]
  CALL R19 1 1
  ...
  GETTABLEKS R22 R23 K32 ["getFFlagAssetImportUploadWidgetCleanup"]
  CALL R21 1 1
  ...
  SETTABLEKS R24 R22 K43 ["defaultProps"]
  ...
  MOVE R24 R6
  DUPTABLE R25 K48 [{"Localization", "Stylizer", "PresetController"}]
  SETTABLEKS R7 R25 K13 ["Localization"]
  SETTABLEKS R8 R25 K15 ["Stylizer"]
  SETTABLEKS R18 R25 K27 ["PresetController"]
  CALL R24 1 1
  MOVE R25 R22
  CALL R24 1 1
  MOVE R22 R24
  ...
  CAPTURE VAL R20
  DUPCLOSURE R25 K50 [PROTO_8]
  CAPTURE VAL R20
  CAPTURE VAL R19
  GETTABLEKS R26 R2 K51 ["connect"]
  MOVE R27 R24
  MOVE R28 R25
  CALL R26 2 1
  MOVE R27 R22
