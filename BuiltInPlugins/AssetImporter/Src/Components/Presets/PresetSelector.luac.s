...
PROTO_5:
  ...
  GETUPVAL R9 3
  DUPTABLE R10 K25 [{"Items", "LayoutOrder", "OnRenderItem", "OnItemActivated", "SelectedIndex", "Size", "Width", "Enabled", "TextTruncate"}]
  SETTABLEKS R4 R10 K16 ["Items"]
  GETTABLEKS R11 R1 K17 ["LayoutOrder"]
  SETTABLEKS R11 R10 K17 ["LayoutOrder"]
  GETTABLEKS R11 R0 K26 ["renderDropdownItem"]
  SETTABLEKS R11 R10 K18 ["OnRenderItem"]
  GETTABLEKS R11 R0 K27 ["onItemActivated"]
  SETTABLEKS R11 R10 K19 ["OnItemActivated"]
  SETTABLEKS R7 R10 K20 ["SelectedIndex"]
  GETUPVAL R12 0
  CALL R12 0 1
  JUMPIFNOT R12 [+3]
  ...
  GETIMPORT R11 K33 [Enum.TextTruncate.AtEnd]
  ...
  GETTABLEKS R12 R2 K28 ["TemplateDropDown"]
  SETTABLEKS R12 R11 K21 ["Size"]
  NEWTABLE R12 0 1
  GETUPVAL R14 2
  GETTABLEKS R13 R14 K15 ["createElement"]
  GETUPVAL R14 5
  DUPTABLE R15 K37 [{"Text", "Child"}]
  SETTABLEKS R6 R15 K35 ["Text"]
  SETTABLEKS R8 R15 K36 ["Child"]
  CALL R13 2 -1
  SETLIST R12 R13 -1 [1]
  CALL R9 3 -1
  RETURN R9 -1
