PROTO_0:
  ...
  GETTABLEKS R1 R2 K0 ["props"]
  GETTABLEKS R0 R1 K1 ["FileController"]
  NAMECALL R0 R0 K3 ["requestFilePicker"]
  CALL R0 1 0
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R23 R24 K33 ["getFFlagCinCancelParse"]
  CALL R22 1 1
  GETIMPORT R23 K5 [require]
  GETTABLEKS R26 R0 K24 ["Src"]
  GETTABLEKS R25 R26 K32 ["Flags"]
  GETTABLEKS R24 R25 K34 ["getFFlagCinSetDefaultCreator"]
  CALL R23 1 1
  GETTABLEKS R24 R1 K35 ["PureComponent"]
  LOADK R26 K36 ["QueueControls"]
  ...
  CAPTURE VAL R1
  CAPTURE VAL R15
  SETTABLEKS R25 R24 K41 ["_createIconButton"]
  ...
  MOVE R25 R5
  DUPTABLE R26 K44 [{"FileController", "QueueController", "Analytics", "Localization", "Stylizer"}]
  MOVE R28 R23
  CALL R28 0 1
  JUMPIFNOT R28 [+2]
  MOVE R27 R18
  JUMP [+1]
  MOVE R27 R17
  SETTABLEKS R27 R26 K27 ["FileController"]
  SETTABLEKS R19 R26 K28 ["QueueController"]
