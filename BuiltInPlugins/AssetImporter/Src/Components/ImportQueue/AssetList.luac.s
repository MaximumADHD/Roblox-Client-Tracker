...
PROTO_3:
  ...
  CALL R3 2 0
  RETURN R0 0
  GETTABLEKS R3 R1 K8 ["DEPRECATED_UpdateSessionInfo"]
  GETUPVAL R5 4
  GETTABLEKS R4 R5 K9 ["update"]
  GETTABLE R5 R2 R0
  DUPTABLE R6 K10 [{"enabled"}]
  GETTABLE R9 R2 R0
...
MAIN:
  ...
  CAPTURE VAL R22
  SETTABLEKS R26 R25 K46 ["_getColumns"]
  ...
  MOVE R26 R6
  DUPTABLE R27 K49 [{"Localization", "Stylizer", "QueueController"}]
  SETTABLEKS R7 R27 K13 ["Localization"]
  SETTABLEKS R8 R27 K15 ["Stylizer"]
  SETTABLEKS R19 R27 K31 ["QueueController"]
  CALL R26 1 1
  MOVE R27 R25
  CALL R26 1 1
  MOVE R25 R26
