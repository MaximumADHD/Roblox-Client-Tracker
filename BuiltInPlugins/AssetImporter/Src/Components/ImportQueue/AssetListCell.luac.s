...
PROTO_2:
  GETUPVAL R0 0
  LOADK R2 K0 ["Model"]
  NAMECALL R0 R0 K1 ["GetClassIcon"]
  CALL R0 2 -1
  RETURN R0 -1
...
PROTO_21:
  ...
  GETUPVAL R13 6
  DUPTABLE R14 K36 [{"tag", "onStateChanged"}]
  LOADK R15 K37 ["auto-xy anchor-center-center position-center-center"]
  SETTABLEKS R15 R14 K34 ["tag"]
  GETUPVAL R16 7
  CALL R16 0 1
  JUMPIFNOT R16 [+3]
  GETTABLEKS R15 R0 K35 ["onStateChanged"]
  JUMP [+1]
  LOADNIL R15
  SETTABLEKS R15 R14 K35 ["onStateChanged"]
  MOVE R15 R9
  CALL R12 3 1
...
MAIN:
  ...
  GETTABLEKS R32 R33 K47 ["getFFlagCinAssetUploadStatusWidget"]
  CALL R31 1 1
  GETTABLEKS R32 R4 K48 ["PureComponent"]
  LOADK R34 K49 ["AssetListCell"]
  NAMECALL R32 R32 K50 ["extend"]
  CALL R32 2 1
  DUPCLOSURE R33 K51 [PROTO_15]
  CAPTURE VAL R2
  CAPTURE VAL R30
  CAPTURE VAL R4
  CAPTURE VAL R13
  ...
  DUPCLOSURE R33 K53 [PROTO_16]
  CAPTURE VAL R4
  CAPTURE VAL R11
  SETTABLEKS R33 R32 K54 ["renderCheckboxCell"]
  DUPCLOSURE R33 K55 [PROTO_17]
  CAPTURE VAL R17
  CAPTURE VAL R14
  CAPTURE VAL R4
  CAPTURE VAL R15
  SETTABLEKS R33 R32 K56 ["renderAssetCell"]
  DUPCLOSURE R33 K57 [PROTO_18]
  CAPTURE VAL R4
  CAPTURE VAL R24
  SETTABLEKS R33 R32 K58 ["renderPresetCell"]
  DUPCLOSURE R33 K59 [PROTO_19]
  CAPTURE VAL R4
  CAPTURE VAL R25
  SETTABLEKS R33 R32 K60 ["renderCreatorCell"]
  DUPCLOSURE R33 K61 [PROTO_20]
  CAPTURE VAL R4
  CAPTURE VAL R15
  CAPTURE VAL R26
  SETTABLEKS R33 R32 K62 ["renderPathCell"]
  DUPCLOSURE R33 K63 [PROTO_21]
  CAPTURE VAL R30
  CAPTURE VAL R3
  CAPTURE VAL R20
  CAPTURE VAL R19
  ...
  CAPTURE VAL R21
  CAPTURE VAL R31
  SETTABLEKS R33 R32 K64 ["renderStatusCell"]
  DUPCLOSURE R33 K65 [PROTO_22]
  SETTABLEKS R33 R32 K66 ["getContent"]
  DUPCLOSURE R33 K67 [PROTO_23]
  CAPTURE VAL R9
  CAPTURE VAL R4
  CAPTURE VAL R15
  SETTABLEKS R33 R32 K68 ["render"]
  GETTABLEKS R33 R7 K69 ["withContext"]
  DUPTABLE R34 K71 [{"Localization", "FileController", "PresetController", "QueueController", "Plugin"}]
  SETTABLEKS R8 R34 K17 ["Localization"]
  SETTABLEKS R27 R34 K43 ["FileController"]
  SETTABLEKS R28 R34 K44 ["PresetController"]
  SETTABLEKS R29 R34 K45 ["QueueController"]
  GETTABLEKS R35 R7 K70 ["Plugin"]
