...
MAIN:
  ...
  MOVE R19 R5
  DUPTABLE R20 K38 [{"Localization", "Stylizer", "PresetController"}]
  SETTABLEKS R6 R20 K11 ["Localization"]
  SETTABLEKS R7 R20 K13 ["Stylizer"]
  MOVE R22 R17
  CALL R22 0 1
  JUMPIFNOT R22 [+2]
  MOVE R21 R11
  JUMP [+1]
  LOADNIL R21
  SETTABLEKS R21 R20 K19 ["PresetController"]
  CALL R19 1 1
  MOVE R20 R18
  CALL R19 1 1
  MOVE R18 R19
