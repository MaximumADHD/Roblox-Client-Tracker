...
PROTO_2:
  ...
  JUMPIFNOT R1 [+9]
  GETTABLEKS R1 R0 K4 ["SelectedImportItem"]
  NAMECALL R1 R1 K5 ["GetPreview"]
  CALL R1 1 1
  GETTABLEKS R2 R0 K6 ["UpdatePreviewInstance"]
  MOVE R3 R1
  CALL R2 1 0
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R19 R20 K31 ["getAssetPreviewProps"]
  CALL R18 1 1
  GETIMPORT R19 K4 [require]
  GETTABLEKS R22 R0 K16 ["Src"]
  GETTABLEKS R21 R22 K30 ["Utility"]
  GETTABLEKS R20 R21 K32 ["getAssetRenderModel"]
  CALL R19 1 1
  GETIMPORT R20 K4 [require]
  GETTABLEKS R23 R0 K16 ["Src"]
  GETTABLEKS R22 R23 K30 ["Utility"]
  GETTABLEKS R21 R22 K33 ["loadAnimation"]
  CALL R20 1 1
  LOADN R22 255
  LOADN R23 1
  LOADN R24 255
  ...
  LOADK R24 K38 ["PreviewContainer"]
  ...
  CAPTURE VAL R18
  SETTABLEKS R23 R22 K43 ["handleCameraTransition"]
  ...
  MOVE R23 R5
  DUPTABLE R24 K50 [{"Stylizer"}]
  SETTABLEKS R6 R24 K12 ["Stylizer"]
  CALL R23 1 1
  MOVE R24 R22
  CALL R23 1 1
  MOVE R22 R23
