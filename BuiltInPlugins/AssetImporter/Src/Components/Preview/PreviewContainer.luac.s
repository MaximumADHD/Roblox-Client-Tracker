...
PROTO_2:
  ...
  CALL R2 0 1
  JUMPIFNOT R2 [+7]
  GETTABLEKS R2 R0 K4 ["SelectedImportItem"]
  NAMECALL R2 R2 K5 ["GetPreview"]
  CALL R2 1 1
  MOVE R1 R2
  JUMP [+10]
  GETTABLEKS R2 R0 K6 ["AssetImportSession"]
  GETTABLEKS R5 R0 K4 ["SelectedImportItem"]
  GETTABLEKS R4 R5 K7 ["Id"]
  NAMECALL R2 R2 K8 ["GetInstance"]
  CALL R2 2 1
  MOVE R1 R2
  GETTABLEKS R2 R0 K9 ["UpdatePreviewInstance"]
  MOVE R3 R1
  CALL R2 1 0
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R19 R20 K30 ["getFFlagCinPreviewInstances"]
  CALL R18 1 1
