...
PROTO_2:
  ...
  NAMECALL R1 R1 K2 ["GetRigVisualization"]
  CALL R1 1 1
  NAMECALL R2 R1 K3 ["Clone"]
  CALL R2 1 1
  SETTABLEKS R2 R0 K4 ["viewportFrameModel"]
  GETTABLEKS R3 R0 K0 ["props"]
  GETTABLEKS R2 R3 K5 ["PreviewInstance"]
  GETTABLEKS R3 R0 K6 ["centerModel"]
  MOVE R4 R2
  CALL R3 1 0
  GETTABLEKS R3 R0 K7 ["viewportFrameRef"]
  NAMECALL R3 R3 K8 ["getValue"]
  CALL R3 1 1
  JUMPIFNOT R3 [+4]
  GETTABLEKS R4 R0 K4 ["viewportFrameModel"]
