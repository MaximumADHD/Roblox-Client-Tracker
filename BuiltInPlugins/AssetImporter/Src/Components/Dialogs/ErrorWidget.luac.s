PROTO_0:
  ...
  JUMPIFNOT R1 [+41]
  LOADNIL R3
  GETTABLEKS R5 R1 K5 ["Errors"]
  LENGTH R4 R5
  LOADN R5 0
  JUMPIFNOTLT R5 R4 [+7]
  GETTABLEKS R5 R1 K5 ["Errors"]
  GETTABLEN R4 R5 1
  GETTABLEKS R3 R4 K6 ["StatusType"]
  JUMP [+11]
  GETTABLEKS R5 R1 K7 ["Warnings"]
  LENGTH R4 R5
  LOADN R5 0
  JUMPIFNOTLT R5 R4 [+6]
  GETTABLEKS R5 R1 K7 ["Warnings"]
  ...
  SETTABLEKS R3 R9 K9 ["type"]
  NAMECALL R5 R0 K4 ["getText"]
  CALL R5 4 1
  MOVE R4 R5
  RETURN R4 1
  LOADK R5 K2 ["Error"]
  LOADK R6 K11 ["DefaultNoStatus"]
...
MAIN:
  ...
  GETTABLEKS R15 R16 K23 ["getFFlagCinMoveSessionErrors"]
  CALL R14 1 1
  GETIMPORT R15 K4 [require]
  GETTABLEKS R18 R0 K19 ["Src"]
  GETTABLEKS R17 R18 K22 ["Flags"]
  GETTABLEKS R16 R17 K24 ["getFFlagCinSessionErrorMsg"]
  CALL R15 1 1
  GETTABLEKS R16 R2 K25 ["PureComponent"]
  LOADK R18 K26 ["ErrorWidget"]
  ...
  CAPTURE VAL R11
  CAPTURE VAL R17
  SETTABLEKS R18 R16 K30 ["render"]
  MOVE R18 R6
  DUPTABLE R19 K31 [{"Localization", "Stylizer"}]
