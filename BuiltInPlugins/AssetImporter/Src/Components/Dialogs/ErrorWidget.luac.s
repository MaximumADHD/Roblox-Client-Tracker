...
PROTO_3:
  ...
  GETUPVAL R18 4
  DUPTABLE R19 K63 [{"Text", "TextSize", "TextXAlignment", "Size", "LayoutOrder"}]
  GETTABLEKS R21 R2 K67 ["AssetImportSession"]
  JUMPIF R21 [+2]
  LOADK R20 K68 [""]
  JUMP [+26]
  GETUPVAL R23 5
  GETTABLEKS R22 R23 K69 ["values"]
  NAMECALL R23 R21 K70 ["GetStatuses"]
  CALL R23 1 -1
  CALL R22 -1 1
  LENGTH R23 R22
  LOADN R24 1
  ...
  LOADK R25 K19 ["Error"]
  GETTABLEN R27 R22 1
  GETTABLEKS R26 R27 K71 ["Type"]
  NAMECALL R23 R1 K21 ["getText"]
  CALL R23 3 1
  MOVE R20 R23
  JUMP [+6]
  LOADK R25 K19 ["Error"]
  LOADK R26 K72 ["DefaultNoStatus"]
  NAMECALL R23 R1 K21 ["getText"]
  CALL R23 3 1
  MOVE R20 R23
  SETTABLEKS R20 R19 K16 ["Text"]
...
MAIN:
  ...
  GETTABLEKS R12 R10 K21 ["TextLabel"]
  GETTABLEKS R13 R10 K22 ["StyledDialog"]
  GETIMPORT R14 K5 [require]
  GETTABLEKS R17 R0 K10 ["Src"]
  GETTABLEKS R16 R17 K23 ["Actions"]
  GETTABLEKS R15 R16 K24 ["SetShowError"]
  CALL R14 1 1
  GETIMPORT R15 K5 [require]
  GETTABLEKS R18 R0 K10 ["Src"]
  GETTABLEKS R17 R18 K11 ["Flags"]
  GETTABLEKS R16 R17 K25 ["getFFlagDebugAssetImportPlugin"]
  CALL R15 1 1
