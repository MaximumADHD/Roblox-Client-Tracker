...
PROTO_10:
  ...
  GETUPVAL R4 0
  GETTABLEKS R3 R4 K2 ["props"]
  GETTABLEKS R2 R3 K3 ["SetSelectedImportItem"]
  MOVE R3 R1
  CALL R2 1 0
  JUMPIFNOT R1 [+17]
  GETUPVAL R4 0
...
PROTO_12:
  ...
  GETTABLEKS R2 R3 K2 ["SelectedImportItem"]
  NAMECALL R0 R0 K3 ["applyImportDataToSession"]
  CALL R0 2 0
  RETURN R0 0
  GETUPVAL R1 2
  GETTABLEKS R0 R1 K3 ["applyImportDataToSession"]
  GETUPVAL R3 1
...
PROTO_13:
  ...
  NEWTABLE R2 0 1
  DUPTABLE R3 K6 [{"Text", "OnItemClicked"}]
  LOADK R6 K7 ["AssetImportTree"]
  LOADK R7 K8 ["RightClickApplyToAll"]
  ...
  CAPTURE UPVAL U0
  CAPTURE UPVAL U2
  SETTABLEKS R4 R3 K5 ["OnItemClicked"]
  SETLIST R2 R3 1 [1]
  GETUPVAL R3 3
  MOVE R4 R0
  MOVE R5 R2
...
PROTO_15:
  GETUPVAL R1 0
  GETTABLEKS R0 R1 K0 ["createContextMenu"]
  CALL R0 0 0
  RETURN R0 0
...
PROTO_16:
  ...
  DUPTABLE R11 K20 [{"Toolbar", "Separator", "TreeView"}]
  GETUPVAL R13 5
  GETTABLEKS R12 R13 K10 ["createElement"]
  GETUPVAL R13 7
  DUPTABLE R14 K25 [{"Expansion", "LayoutOrder", "OnExpansionChange", "Size"}]
  GETTABLEKS R15 R1 K21 ["Expansion"]
  SETTABLEKS R15 R14 K21 ["Expansion"]
  NAMECALL R15 R5 K26 ["getNextOrder"]
  CALL R15 1 1
  SETTABLEKS R15 R14 K22 ["LayoutOrder"]
  GETTABLEKS R15 R1 K27 ["SetExpansion"]
  SETTABLEKS R15 R14 K23 ["OnExpansionChange"]
  ...
  GETTABLEKS R12 R13 K10 ["createElement"]
  GETUPVAL R13 8
  DUPTABLE R14 K31 [{"DominantAxis", "LayoutOrder"}]
  GETIMPORT R15 K33 [Enum.DominantAxis.Width]
  SETTABLEKS R15 R14 K30 ["DominantAxis"]
  NAMECALL R15 R5 K26 ["getNextOrder"]
  CALL R15 1 1
  SETTABLEKS R15 R14 K22 ["LayoutOrder"]
  CALL R12 2 1
  SETTABLEKS R12 R11 K18 ["Separator"]
  GETUPVAL R13 5
  GETTABLEKS R12 R13 K10 ["createElement"]
  GETUPVAL R13 9
  DUPTABLE R14 K45 [{"RootItems", "Selection", "Expansion", "Checked", "LayoutOrder", "Size", "OnSelectionChange", "OnExpansionChange", "OnCheck", "GetChildren", "GetContents", "ExpandableRoot", "AfterItem", "ToggleAncestors", "ToggleDescendants", "OnRightClick"}]
  GETTABLEKS R15 R1 K6 ["Instances"]
  JUMPIF R15 [+2]
  NEWTABLE R15 0 0
  SETTABLEKS R15 R14 K34 ["RootItems"]
  GETTABLEKS R16 R1 K46 ["SelectedImportItem"]
  JUMPIFNOT R16 [+7]
  NEWTABLE R15 1 0
  GETTABLEKS R16 R1 K46 ["SelectedImportItem"]
  LOADB R17 1
  ...
  JUMPIF R15 [+2]
  NEWTABLE R15 0 0
  SETTABLEKS R15 R14 K35 ["Selection"]
  GETTABLEKS R15 R1 K21 ["Expansion"]
  SETTABLEKS R15 R14 K21 ["Expansion"]
  ...
  CALL R15 4 1
  SETTABLEKS R15 R14 K24 ["Size"]
  GETTABLEKS R15 R0 K47 ["SelectItem"]
  SETTABLEKS R15 R14 K36 ["OnSelectionChange"]
  GETTABLEKS R15 R1 K27 ["SetExpansion"]
  SETTABLEKS R15 R14 K23 ["OnExpansionChange"]
  GETTABLEKS R15 R0 K48 ["setChecked"]
  SETTABLEKS R15 R14 K37 ["OnCheck"]
  GETTABLEKS R15 R0 K49 ["getChildren"]
  SETTABLEKS R15 R14 K38 ["GetChildren"]
  GETTABLEKS R15 R0 K50 ["getContents"]
  SETTABLEKS R15 R14 K39 ["GetContents"]
  LOADB R15 0
  SETTABLEKS R15 R14 K40 ["ExpandableRoot"]
  GETTABLEKS R15 R0 K51 ["afterItem"]
  SETTABLEKS R15 R14 K41 ["AfterItem"]
  GETUPVAL R15 10
  SETTABLEKS R15 R14 K42 ["ToggleAncestors"]
  GETUPVAL R17 9
  GETTABLEKS R16 R17 K52 ["DownPropagators"]
  GETTABLEKS R15 R16 K53 ["toggleAllChildren"]
  SETTABLEKS R15 R14 K43 ["ToggleDescendants"]
  SETTABLEKS R7 R14 K44 ["OnRightClick"]
  CALL R12 2 1
  SETTABLEKS R12 R11 K19 ["TreeView"]
  CALL R8 3 -1
  RETURN R8 -1
...
MAIN:
  ...
  LOADK R31 K44 ["UseImportNameForRoot"]
  LOADB R32 0
  ...
  GETTABLEKS R31 R32 K47 ["getFFlagAinStatusesV2Release"]
  CALL R30 1 1
