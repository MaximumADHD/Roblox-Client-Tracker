...
MAIN:
  ...
  GETTABLEKS R29 R30 K34 ["Utility"]
  ...
  GETTABLEKS R31 R32 K48 ["getEFAinSettingsBulkShouldImportEnabled"]
  CALL R30 1 1
  GETTABLEKS R31 R2 K49 ["PureComponent"]
  LOADK R33 K50 ["AssetImportTree"]
  ...
  CAPTURE VAL R11
  CAPTURE VAL R13
  SETTABLEKS R35 R31 K56 ["init"]
  DUPCLOSURE R35 K57 [PROTO_15]
  CAPTURE VAL R22
  CAPTURE VAL R2
  CAPTURE VAL R14
  CAPTURE VAL R24
  SETTABLEKS R35 R31 K58 ["getStatusIcon"]
  ...
  CAPTURE VAL R30
  CAPTURE VAL R33
  SETTABLEKS R35 R31 K60 ["render"]
  MOVE R35 R5
  DUPTABLE R36 K62 [{"Localization", "Stylizer", "Plugin", "PresetController"}]
  SETTABLEKS R6 R36 K12 ["Localization"]
  SETTABLEKS R7 R36 K13 ["Stylizer"]
  GETTABLEKS R37 R4 K61 ["Plugin"]
  SETTABLEKS R37 R36 K61 ["Plugin"]
  SETTABLEKS R26 R36 K40 ["PresetController"]
  CALL R35 1 1
  MOVE R36 R31
  CALL R35 1 1
  MOVE R31 R35
  DUPCLOSURE R35 K63 [PROTO_18]
  DUPCLOSURE R36 K64 [PROTO_23]
  CAPTURE VAL R18
  CAPTURE VAL R19
  CAPTURE VAL R20
  CAPTURE VAL R21
  GETTABLEKS R37 R3 K65 ["connect"]
  MOVE R38 R35
  MOVE R39 R36
  CALL R37 2 1
  MOVE R38 R31
