...
MAIN:
  ...
  GETTABLEKS R33 R34 K49 ["getFFlagAssetImporterApplyToAllFixes"]
  CALL R32 1 1
  GETTABLEKS R33 R2 K50 ["PureComponent"]
  LOADK R35 K51 ["AssetImportTree"]
  NAMECALL R33 R33 K52 ["extend"]
  CALL R33 2 1
  DUPCLOSURE R34 K53 [PROTO_1]
  DUPCLOSURE R35 K54 [PROTO_2]
  CAPTURE VAL R23
  CAPTURE VAL R2
  CAPTURE VAL R11
  CAPTURE VAL R14
  DUPCLOSURE R36 K55 [PROTO_4]
  CAPTURE VAL R9
  DUPCLOSURE R37 K56 [PROTO_6]
  CAPTURE VAL R32
  CAPTURE VAL R28
  DUPCLOSURE R38 K57 [PROTO_14]
  CAPTURE VAL R30
  CAPTURE VAL R25
  CAPTURE VAL R17
  CAPTURE VAL R35
  ...
  CAPTURE VAL R26
  CAPTURE VAL R15
  SETTABLEKS R38 R33 K58 ["init"]
  DUPCLOSURE R38 K59 [PROTO_16]
  CAPTURE VAL R17
  CAPTURE VAL R24
  CAPTURE VAL R29
  CAPTURE VAL R37
  ...
  CAPTURE VAL R10
  CAPTURE VAL R36
  SETTABLEKS R38 R33 K60 ["render"]
  MOVE R38 R5
  DUPTABLE R39 K62 [{"Localization", "Stylizer", "Plugin", "PresetController"}]
  SETTABLEKS R6 R39 K11 ["Localization"]
  SETTABLEKS R7 R39 K12 ["Stylizer"]
  GETTABLEKS R40 R4 K61 ["Plugin"]
  SETTABLEKS R40 R39 K61 ["Plugin"]
  MOVE R41 R31
  CALL R41 0 1
  JUMPIFNOT R41 [+2]
  MOVE R40 R27
  JUMP [+1]
  LOADNIL R40
  SETTABLEKS R40 R39 K40 ["PresetController"]
  CALL R38 1 1
  MOVE R39 R33
  CALL R38 1 1
  MOVE R33 R38
  DUPCLOSURE R38 K63 [PROTO_17]
  DUPCLOSURE R39 K64 [PROTO_22]
  CAPTURE VAL R19
  CAPTURE VAL R20
  CAPTURE VAL R21
  CAPTURE VAL R22
