...
PROTO_17:
  ...
  SETTABLEKS R2 R1 K2 ["SelectedImportItem"]
  GETTABLEKS R2 R0 K10 ["importDataExpansion"]
  JUMPIF R2 [+2]
  NEWTABLE R2 0 0
  SETTABLEKS R2 R1 K3 ["Expansion"]
...
MAIN:
  ...
  GETTABLEKS R31 R32 K48 ["getFFlagAssetImportRefactorReducer"]
  CALL R30 1 1
  ...
  CAPTURE VAL R10
  CAPTURE VAL R34
  SETTABLEKS R36 R31 K59 ["render"]
  MOVE R36 R5
  DUPTABLE R37 K61 [{"Localization", "Stylizer", "Plugin", "PresetController"}]
  SETTABLEKS R6 R37 K12 ["Localization"]
  SETTABLEKS R7 R37 K13 ["Stylizer"]
  GETTABLEKS R38 R4 K60 ["Plugin"]
  SETTABLEKS R38 R37 K60 ["Plugin"]
  SETTABLEKS R26 R37 K40 ["PresetController"]
  CALL R36 1 1
  MOVE R37 R31
  CALL R36 1 1
  MOVE R31 R36
  DUPCLOSURE R36 K62 [PROTO_17]
  CAPTURE VAL R30
  DUPCLOSURE R37 K63 [PROTO_22]
  CAPTURE VAL R19
  CAPTURE VAL R20
  CAPTURE VAL R21
  CAPTURE VAL R22
