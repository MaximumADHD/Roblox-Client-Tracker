...
MAIN:
  ...
  GETTABLEKS R33 R34 K49 ["getFFlagAssetImporterCustomPresets"]
  CALL R32 1 1
  GETIMPORT R33 K4 [require]
  GETTABLEKS R36 R0 K23 ["Src"]
  GETTABLEKS R35 R36 K48 ["Flags"]
  GETTABLEKS R34 R35 K50 ["getFFlagCinPreviewInstances"]
  CALL R33 1 1
  GETIMPORT R34 K4 [require]
  GETTABLEKS R37 R0 K23 ["Src"]
  GETTABLEKS R36 R37 K48 ["Flags"]
  GETTABLEKS R35 R36 K51 ["getFFlagAssetImporterApplyToAllFixes"]
  CALL R34 1 1
  GETTABLEKS R35 R2 K52 ["PureComponent"]
  LOADK R37 K53 ["AssetImportTree"]
  NAMECALL R35 R35 K54 ["extend"]
  CALL R35 2 1
  DUPCLOSURE R36 K55 [PROTO_1]
  DUPCLOSURE R37 K56 [PROTO_3]
  DUPCLOSURE R38 K57 [PROTO_4]
  CAPTURE VAL R23
  CAPTURE VAL R2
  CAPTURE VAL R11
  CAPTURE VAL R14
  ...
  CAPTURE VAL R9
  DUPCLOSURE R40 K59 [PROTO_8]
  CAPTURE VAL R34
  CAPTURE VAL R29
  DUPCLOSURE R41 K60 [PROTO_16]
  CAPTURE VAL R31
  CAPTURE VAL R25
  CAPTURE VAL R33
  CAPTURE VAL R17
  ...
  CAPTURE VAL R10
  CAPTURE VAL R39
  SETTABLEKS R41 R35 K63 ["render"]
  MOVE R41 R5
  DUPTABLE R42 K65 [{"Localization", "Stylizer", "Plugin", "PresetController"}]
  SETTABLEKS R6 R42 K11 ["Localization"]
  SETTABLEKS R7 R42 K12 ["Stylizer"]
  GETTABLEKS R43 R4 K64 ["Plugin"]
  SETTABLEKS R43 R42 K64 ["Plugin"]
  MOVE R44 R32
  CALL R44 0 1
  JUMPIFNOT R44 [+2]
  MOVE R43 R27
  JUMP [+1]
  LOADNIL R43
  SETTABLEKS R43 R42 K40 ["PresetController"]
  CALL R41 1 1
  MOVE R42 R35
  CALL R41 1 1
  MOVE R35 R41
  DUPCLOSURE R41 K66 [PROTO_19]
  DUPCLOSURE R42 K67 [PROTO_24]
  CAPTURE VAL R19
  CAPTURE VAL R20
  CAPTURE VAL R21
  CAPTURE VAL R22
  GETTABLEKS R43 R3 K68 ["connect"]
  MOVE R44 R41
  MOVE R45 R42
  CALL R43 2 1
  MOVE R44 R35
