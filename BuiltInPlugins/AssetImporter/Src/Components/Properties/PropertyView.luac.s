...
MAIN:
  ...
  CALL R15 1 1
  GETTABLEKS R16 R5 K27 ["shallowEqual"]
  GETTABLEKS R18 R0 K10 ["Src"]
  GETTABLEKS R17 R18 K28 ["Utility"]
  GETIMPORT R18 K5 [require]
  GETTABLEKS R19 R17 K29 ["createCalloutComponents"]
  CALL R18 1 1
  GETIMPORT R19 K5 [require]
  GETTABLEKS R20 R17 K30 ["GetEditorFromType"]
  CALL R19 1 1
  GETIMPORT R20 K5 [require]
  GETTABLEKS R21 R17 K31 ["GetErrorChecked"]
  CALL R20 1 1
  GETIMPORT R21 K5 [require]
  GETTABLEKS R24 R0 K10 ["Src"]
  GETTABLEKS R23 R24 K32 ["Actions"]
  GETTABLEKS R22 R23 K33 ["SetErrorNodeChecked"]
  CALL R21 1 1
  GETIMPORT R22 K5 [require]
  GETTABLEKS R25 R0 K10 ["Src"]
  GETTABLEKS R24 R25 K32 ["Actions"]
  GETTABLEKS R23 R24 K34 ["SetSettingsChanged"]
  CALL R22 1 1
  GETIMPORT R23 K5 [require]
  GETTABLEKS R26 R0 K10 ["Src"]
  GETTABLEKS R25 R26 K11 ["Flags"]
  GETTABLEKS R24 R25 K35 ["getFFlagChooseAnimationForRestPose"]
  CALL R23 1 1
  GETIMPORT R24 K5 [require]
  GETTABLEKS R27 R0 K10 ["Src"]
  GETTABLEKS R26 R27 K11 ["Flags"]
  GETTABLEKS R25 R26 K36 ["getFFlagImporterOpensAvatarPreviewerBetaCheck"]
  CALL R24 1 1
  GETIMPORT R25 K5 [require]
  GETTABLEKS R28 R0 K10 ["Src"]
  GETTABLEKS R27 R28 K11 ["Flags"]
  GETTABLEKS R26 R27 K37 ["getFFlagAssetImportTrackPropertyChange"]
  CALL R25 1 1
  GETTABLEKS R26 R1 K38 ["PureComponent"]
  LOADK R28 K39 ["PropertyView"]
  ...
  CAPTURE VAL R25
  CAPTURE VAL R27
  SETTABLEKS R29 R26 K44 ["_connect"]
  DUPCLOSURE R29 K45 [PROTO_5]
  SETTABLEKS R29 R26 K46 ["_disconnect"]
  DUPCLOSURE R29 K47 [PROTO_10]
  CAPTURE VAL R20
  CAPTURE VAL R23
  CAPTURE VAL R25
  CAPTURE VAL R27
  SETTABLEKS R29 R26 K48 ["init"]
  DUPCLOSURE R29 K49 [PROTO_11]
  SETTABLEKS R29 R26 K50 ["didMount"]
  DUPCLOSURE R29 K51 [PROTO_12]
  SETTABLEKS R29 R26 K52 ["willUnmount"]
  DUPCLOSURE R29 K53 [PROTO_13]
  SETTABLEKS R29 R26 K54 ["didUpdate"]
  MOVE R29 R25
  CALL R29 0 1
  JUMPIFNOT R29 [+4]
  DUPCLOSURE R29 K55 [PROTO_14]
  CAPTURE VAL R27
  SETTABLEKS R29 R26 K56 ["getDerivedStateFromProps"]
  DUPCLOSURE R29 K57 [PROTO_15]
  CAPTURE VAL R27
  CAPTURE VAL R19
  CAPTURE VAL R24
  CAPTURE VAL R18
  ...
  CAPTURE VAL R14
  CAPTURE VAL R12
  SETTABLEKS R29 R26 K58 ["render"]
  MOVE R29 R25
  CALL R29 0 1
  JUMPIFNOT R29 [+4]
  DUPCLOSURE R29 K59 [PROTO_16]
  CAPTURE VAL R16
  SETTABLEKS R29 R26 K60 ["shouldUpdate"]
  MOVE R29 R7
  DUPTABLE R30 K61 [{"Localization", "Stylizer"}]
  SETTABLEKS R8 R30 K16 ["Localization"]
  SETTABLEKS R9 R30 K17 ["Stylizer"]
  CALL R29 1 1
  MOVE R30 R26
  CALL R29 1 1
  MOVE R26 R29
  DUPCLOSURE R29 K62 [PROTO_17]
  DUPCLOSURE R30 K63 [PROTO_21]
  CAPTURE VAL R22
  CAPTURE VAL R15
  CAPTURE VAL R21
  GETTABLEKS R31 R2 K64 ["connect"]
  MOVE R32 R29
  MOVE R33 R30
  CALL R31 2 1
  MOVE R32 R26
