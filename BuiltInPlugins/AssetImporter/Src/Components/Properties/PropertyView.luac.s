...
PROTO_6:
  ...
  CALL R2 2 0
  JUMP [+13]
  GETTABLEKS R2 R0 K12 ["DEPRECATED_UpdateSessionInfo"]
  GETUPVAL R4 3
  GETTABLEKS R3 R4 K13 ["update"]
  GETTABLEKS R4 R0 K9 ["ActiveQueueItem"]
  DUPTABLE R5 K11 [{"settingsChanged"}]
  LOADB R6 1
  SETTABLEKS R6 R5 K10 ["settingsChanged"]
  CALL R3 2 -1
  CALL R2 -1 0
...
PROTO_7:
  ...
  JUMPIFNOTEQKS R3 K3 ["ImportName"] [+33]
  ...
  CALL R3 2 0
  JUMP [+13]
  GETTABLEKS R3 R1 K9 ["DEPRECATED_UpdateSessionInfo"]
  GETUPVAL R5 2
  GETTABLEKS R4 R5 K10 ["update"]
  GETTABLEKS R5 R1 K6 ["ActiveQueueItem"]
  DUPTABLE R6 K8 [{"settingsChanged"}]
  LOADB R7 1
  SETTABLEKS R7 R6 K7 ["settingsChanged"]
  CALL R4 2 -1
  CALL R3 -1 0
...
PROTO_8:
  ...
  CALL R4 2 0
  JUMP [+13]
  GETTABLEKS R4 R1 K13 ["DEPRECATED_UpdateSessionInfo"]
  GETUPVAL R6 3
  GETTABLEKS R5 R6 K14 ["update"]
  GETTABLEKS R6 R1 K10 ["ActiveQueueItem"]
  DUPTABLE R7 K12 [{"settingsChanged"}]
  LOADB R8 1
  SETTABLEKS R8 R7 K11 ["settingsChanged"]
  CALL R5 2 -1
  CALL R4 -1 0
...
PROTO_21:
  DUPTABLE R1 K4 [{"UpdatePreviewInstance", "SetErrorNodeChecked", "DEPRECATED_UpdateSessionInfo", "UpdateQueueItem"}]
  NEWCLOSURE R2 P0
  CAPTURE VAL R0
  CAPTURE UPVAL U0
  ...
  CAPTURE VAL R0
  CAPTURE UPVAL U3
  SETTABLEKS R2 R1 K2 ["DEPRECATED_UpdateSessionInfo"]
  GETUPVAL R3 2
  CALL R3 0 1
  JUMPIFNOT R3 [+4]
  NEWCLOSURE R2 P3
  ...
  JUMP [+1]
  LOADNIL R2
  SETTABLEKS R2 R1 K3 ["UpdateQueueItem"]
  RETURN R1 1
...
MAIN:
  ...
  GETTABLEKS R16 R17 K25 ["DEPRECATED_UpdateSessionInfo"]
  CALL R15 1 1
  GETIMPORT R16 K5 [require]
  GETTABLEKS R19 R0 K19 ["Src"]
  GETTABLEKS R18 R19 K23 ["Thunks"]
  GETTABLEKS R17 R18 K26 ["UpdateQueueItem"]
  CALL R16 1 1
  GETTABLEKS R17 R4 K27 ["shallowEqual"]
  GETTABLEKS R19 R0 K19 ["Src"]
  GETTABLEKS R18 R19 K28 ["Utility"]
  GETIMPORT R19 K5 [require]
  GETTABLEKS R20 R18 K29 ["createCalloutComponents"]
  CALL R19 1 1
  GETIMPORT R20 K5 [require]
  GETTABLEKS R21 R18 K30 ["GetEditorFromType"]
  CALL R20 1 1
  GETIMPORT R21 K5 [require]
  GETTABLEKS R22 R18 K31 ["GetErrorChecked"]
  CALL R21 1 1
  GETIMPORT R22 K5 [require]
  GETTABLEKS R25 R0 K19 ["Src"]
  GETTABLEKS R24 R25 K32 ["Actions"]
  GETTABLEKS R23 R24 K33 ["SetErrorNodeChecked"]
  CALL R22 1 1
  ...
  GETTABLEKS R27 R28 K39 ["getFFlagImportQueueSessionThunksRefactor"]
  CALL R26 1 1
