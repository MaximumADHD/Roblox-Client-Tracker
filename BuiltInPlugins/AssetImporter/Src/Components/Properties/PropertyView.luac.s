...
MAIN:
  ...
  GETTABLEKS R25 R26 K36 ["getFFlagAssetImportTrackPropertyChange"]
  CALL R24 1 1
  GETTABLEKS R25 R1 K37 ["PureComponent"]
  LOADK R27 K38 ["PropertyView"]
  ...
  CAPTURE VAL R24
  CAPTURE VAL R26
  SETTABLEKS R28 R25 K43 ["_connect"]
  DUPCLOSURE R28 K44 [PROTO_5]
  SETTABLEKS R28 R25 K45 ["_disconnect"]
  DUPCLOSURE R28 K46 [PROTO_10]
  CAPTURE VAL R20
  CAPTURE VAL R23
  CAPTURE VAL R24
  CAPTURE VAL R26
  SETTABLEKS R28 R25 K47 ["init"]
  DUPCLOSURE R28 K48 [PROTO_11]
  SETTABLEKS R28 R25 K49 ["didMount"]
  DUPCLOSURE R28 K50 [PROTO_12]
  SETTABLEKS R28 R25 K51 ["willUnmount"]
  DUPCLOSURE R28 K52 [PROTO_13]
  SETTABLEKS R28 R25 K53 ["didUpdate"]
  MOVE R28 R24
  CALL R28 0 1
  JUMPIFNOT R28 [+4]
  DUPCLOSURE R28 K54 [PROTO_14]
  CAPTURE VAL R26
  SETTABLEKS R28 R25 K55 ["getDerivedStateFromProps"]
  DUPCLOSURE R28 K56 [PROTO_15]
  CAPTURE VAL R26
  CAPTURE VAL R19
  CAPTURE VAL R18
  CAPTURE VAL R1
  ...
  CAPTURE VAL R14
  CAPTURE VAL R12
  SETTABLEKS R28 R25 K57 ["render"]
  MOVE R28 R24
  CALL R28 0 1
  JUMPIFNOT R28 [+4]
  DUPCLOSURE R28 K58 [PROTO_16]
  CAPTURE VAL R16
  SETTABLEKS R28 R25 K59 ["shouldUpdate"]
  MOVE R28 R7
  DUPTABLE R29 K60 [{"Localization", "Stylizer"}]
  SETTABLEKS R8 R29 K16 ["Localization"]
  SETTABLEKS R9 R29 K17 ["Stylizer"]
  CALL R28 1 1
  MOVE R29 R25
  CALL R28 1 1
  MOVE R25 R28
  DUPCLOSURE R28 K61 [PROTO_17]
  DUPCLOSURE R29 K62 [PROTO_21]
  CAPTURE VAL R22
  CAPTURE VAL R15
  CAPTURE VAL R21
  GETTABLEKS R30 R2 K63 ["connect"]
  MOVE R31 R28
  MOVE R32 R29
  CALL R30 2 1
  MOVE R31 R25
