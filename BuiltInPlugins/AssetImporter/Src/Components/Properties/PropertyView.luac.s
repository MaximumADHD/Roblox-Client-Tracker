...
MAIN:
  ...
  GETTABLEKS R24 R25 K36 ["getFFlagUnlinkImporterAndAvatarPreview"]
  CALL R23 1 1
  GETTABLEKS R24 R1 K37 ["PureComponent"]
  LOADK R26 K38 ["PropertyView"]
  ...
  CAPTURE VAL R25
  SETTABLEKS R27 R24 K43 ["_connect"]
  DUPCLOSURE R27 K44 [PROTO_4]
  SETTABLEKS R27 R24 K45 ["_disconnect"]
  DUPCLOSURE R27 K46 [PROTO_9]
  CAPTURE VAL R20
  CAPTURE VAL R25
  SETTABLEKS R27 R24 K47 ["init"]
  DUPCLOSURE R27 K48 [PROTO_10]
  SETTABLEKS R27 R24 K49 ["didMount"]
  DUPCLOSURE R27 K50 [PROTO_11]
  SETTABLEKS R27 R24 K51 ["willUnmount"]
  DUPCLOSURE R27 K52 [PROTO_12]
  SETTABLEKS R27 R24 K53 ["didUpdate"]
  DUPCLOSURE R27 K54 [PROTO_13]
  CAPTURE VAL R25
  SETTABLEKS R27 R24 K55 ["getDerivedStateFromProps"]
  DUPCLOSURE R27 K56 [PROTO_14]
  CAPTURE VAL R25
  CAPTURE VAL R19
  CAPTURE VAL R23
  CAPTURE VAL R18
  ...
  CAPTURE VAL R13
  CAPTURE VAL R11
  SETTABLEKS R27 R24 K57 ["render"]
  DUPCLOSURE R27 K58 [PROTO_15]
  CAPTURE VAL R16
  SETTABLEKS R27 R24 K59 ["shouldUpdate"]
  MOVE R27 R6
  DUPTABLE R28 K60 [{"Localization", "Stylizer"}]
  ...
  CALL R27 1 1
  MOVE R24 R27
  DUPCLOSURE R27 K61 [PROTO_16]
  DUPCLOSURE R28 K62 [PROTO_20]
  CAPTURE VAL R14
  CAPTURE VAL R21
  CAPTURE VAL R15
  GETTABLEKS R29 R2 K63 ["connect"]
  MOVE R30 R27
  MOVE R31 R28
  CALL R29 2 1
  MOVE R30 R24
