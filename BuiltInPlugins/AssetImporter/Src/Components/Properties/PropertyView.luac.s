...
PROTO_4:
  ...
  CALL R4 2 1
  SETTABLEKS R4 R0 K5 ["_changedConnection"]
  RETURN R0 0
  GETTABLEKS R3 R0 K0 ["props"]
  GETTABLEKS R2 R3 K2 ["Instance"]
  ...
  NEWCLOSURE R5 P1
  CAPTURE VAL R0
  NAMECALL R3 R2 K4 ["Connect"]
  CALL R3 2 1
  SETTABLEKS R3 R0 K5 ["_changedConnection"]
  RETURN R0 0
...
PROTO_16:
  ...
  GETTABLEKS R4 R1 K1 ["PropertyMetadata"]
  GETTABLEKS R5 R3 K2 ["value"]
  GETTABLEKS R6 R2 K2 ["value"]
  JUMPIFEQ R5 R6 [+3]
  LOADB R5 1
  RETURN R5 1
  GETTABLEKS R6 R3 K3 ["dependencies"]
  GETTABLEKS R7 R2 K3 ["dependencies"]
  MOVE R8 R6
  LOADNIL R9
  LOADNIL R10
  FORGPREP R8
...
MAIN:
  ...
  CALL R14 1 1
  GETTABLEKS R16 R3 K10 ["Dash"]
  GETTABLEKS R15 R16 K25 ["shallowEqual"]
  GETIMPORT R16 K5 [require]
  GETTABLEKS R19 R0 K19 ["Src"]
  GETTABLEKS R18 R19 K26 ["Utility"]
  GETTABLEKS R17 R18 K27 ["createCalloutComponents"]
  CALL R16 1 1
  GETIMPORT R17 K5 [require]
  GETTABLEKS R20 R0 K19 ["Src"]
  GETTABLEKS R19 R20 K26 ["Utility"]
  GETTABLEKS R18 R19 K28 ["GetEditorFromType"]
  CALL R17 1 1
  GETIMPORT R18 K5 [require]
  GETTABLEKS R21 R0 K19 ["Src"]
  GETTABLEKS R20 R21 K26 ["Utility"]
  GETTABLEKS R19 R20 K29 ["GetErrorChecked"]
  CALL R18 1 1
  GETIMPORT R19 K5 [require]
  GETTABLEKS R22 R0 K19 ["Src"]
  GETTABLEKS R21 R22 K30 ["Actions"]
  GETTABLEKS R20 R21 K31 ["SetErrorNodeChecked"]
  CALL R19 1 1
  GETIMPORT R20 K5 [require]
  GETTABLEKS R23 R0 K19 ["Src"]
  GETTABLEKS R22 R23 K30 ["Actions"]
  GETTABLEKS R21 R22 K32 ["SetSettingsChanged"]
  CALL R20 1 1
  GETIMPORT R21 K5 [require]
  GETTABLEKS R24 R0 K19 ["Src"]
  GETTABLEKS R23 R24 K33 ["Flags"]
  GETTABLEKS R22 R23 K34 ["getFFlagAssetImportRefactorReducer"]
  CALL R21 1 1
  GETIMPORT R22 K5 [require]
  GETTABLEKS R25 R0 K19 ["Src"]
  GETTABLEKS R24 R25 K33 ["Flags"]
  GETTABLEKS R23 R24 K35 ["getFFlagChooseAnimationForRestPose"]
  CALL R22 1 1
  GETIMPORT R23 K5 [require]
  GETTABLEKS R26 R0 K19 ["Src"]
  GETTABLEKS R25 R26 K33 ["Flags"]
  GETTABLEKS R24 R25 K36 ["getFFlagImporterOpensAvatarPreviewerBetaCheck"]
  CALL R23 1 1
  GETIMPORT R24 K5 [require]
  GETTABLEKS R27 R0 K19 ["Src"]
  GETTABLEKS R26 R27 K33 ["Flags"]
  GETTABLEKS R25 R26 K37 ["getFFlagAssetImportTrackPropertyChange"]
  CALL R24 1 1
  GETTABLEKS R25 R1 K38 ["PureComponent"]
  LOADK R27 K39 ["PropertyView"]
  NAMECALL R25 R25 K40 ["extend"]
  CALL R25 2 1
  DUPCLOSURE R26 K41 [PROTO_0]
  DUPCLOSURE R27 K42 [PROTO_1]
  DUPCLOSURE R28 K43 [PROTO_4]
  CAPTURE VAL R24
  CAPTURE VAL R26
  SETTABLEKS R28 R25 K44 ["_connect"]
  DUPCLOSURE R28 K45 [PROTO_5]
  SETTABLEKS R28 R25 K46 ["_disconnect"]
  DUPCLOSURE R28 K47 [PROTO_10]
  CAPTURE VAL R18
  CAPTURE VAL R22
  CAPTURE VAL R24
  CAPTURE VAL R26
  SETTABLEKS R28 R25 K48 ["init"]
  DUPCLOSURE R28 K49 [PROTO_11]
  SETTABLEKS R28 R25 K50 ["didMount"]
  DUPCLOSURE R28 K51 [PROTO_12]
  SETTABLEKS R28 R25 K52 ["willUnmount"]
  DUPCLOSURE R28 K53 [PROTO_13]
  SETTABLEKS R28 R25 K54 ["didUpdate"]
  MOVE R28 R24
  CALL R28 0 1
  JUMPIFNOT R28 [+4]
  DUPCLOSURE R28 K55 [PROTO_14]
  CAPTURE VAL R26
  SETTABLEKS R28 R25 K56 ["getDerivedStateFromProps"]
  ...
  CAPTURE VAL R13
  CAPTURE VAL R11
  SETTABLEKS R28 R25 K58 ["render"]
  MOVE R28 R24
  CALL R28 0 1
  JUMPIFNOT R28 [+4]
  DUPCLOSURE R28 K59 [PROTO_16]
  CAPTURE VAL R15
  SETTABLEKS R28 R25 K60 ["shouldUpdate"]
  MOVE R28 R6
  DUPTABLE R29 K61 [{"Localization", "Stylizer"}]
  ...
  CALL R28 1 1
  MOVE R25 R28
  DUPCLOSURE R28 K62 [PROTO_17]
  CAPTURE VAL R21
  DUPCLOSURE R29 K63 [PROTO_21]
  CAPTURE VAL R20
  CAPTURE VAL R14
  CAPTURE VAL R19
  GETTABLEKS R30 R2 K64 ["connect"]
  MOVE R31 R28
  MOVE R32 R29
  CALL R30 2 1
  MOVE R31 R25
