...
PROTO_6:
  ...
  CALL R3 1 -1
  CALL R2 -1 0
  GETTABLEKS R2 R0 K8 ["UpdateQueueItem"]
  GETTABLEKS R3 R0 K9 ["ActiveQueueItem"]
  DUPTABLE R4 K11 [{"settingsChanged"}]
  LOADB R5 1
  SETTABLEKS R5 R4 K10 ["settingsChanged"]
  CALL R2 2 0
  GETTABLEKS R2 R0 K12 ["OnInteract"]
  CALL R2 0 0
  GETUPVAL R2 0
  NEWTABLE R4 0 0
...
PROTO_7:
  ...
  JUMPIFNOTEQKS R3 K3 ["ImportName"] [+16]
  GETTABLEKS R4 R1 K4 ["Instance"]
  GETTABLEKS R3 R4 K3 ["ImportName"]
  JUMPIFEQ R3 R0 [+10]
  GETTABLEKS R3 R1 K5 ["UpdateQueueItem"]
  GETTABLEKS R4 R1 K6 ["ActiveQueueItem"]
  DUPTABLE R5 K8 [{"settingsChanged"}]
  LOADB R6 1
  SETTABLEKS R6 R5 K7 ["settingsChanged"]
  CALL R3 2 0
  ...
  GETUPVAL R5 0
  GETTABLEKS R4 R5 K0 ["props"]
  GETTABLEKS R3 R4 K9 ["UpdatePreviewInstance"]
  GETUPVAL R6 0
  GETTABLEKS R5 R6 K0 ["props"]
  GETTABLEKS R4 R5 K4 ["Instance"]
  NAMECALL R4 R4 K10 ["GetPreview"]
  CALL R4 1 -1
  CALL R3 -1 0
  GETTABLEKS R3 R1 K11 ["SetErrorNodeChecked"]
  GETUPVAL R4 2
  GETTABLEKS R5 R1 K12 ["ImportTree"]
  CALL R4 1 -1
  CALL R3 -1 0
  GETTABLEKS R3 R1 K13 ["OnInteract"]
  CALL R3 0 0
  RETURN R0 0
...
PROTO_8:
  ...
  CALL R5 1 -1
  CALL R4 -1 0
  GETTABLEKS R4 R1 K9 ["UpdateQueueItem"]
  GETTABLEKS R5 R1 K10 ["ActiveQueueItem"]
  DUPTABLE R6 K12 [{"settingsChanged"}]
  LOADB R7 1
  SETTABLEKS R7 R6 K11 ["settingsChanged"]
  CALL R4 2 0
  GETTABLEKS R4 R1 K13 ["OnInteract"]
  CALL R4 0 0
  RETURN R0 0
...
PROTO_20:
  DUPTABLE R1 K3 [{"UpdatePreviewInstance", "SetErrorNodeChecked", "UpdateQueueItem"}]
  NEWCLOSURE R2 P0
  CAPTURE VAL R0
  CAPTURE UPVAL U0
  SETTABLEKS R2 R1 K0 ["UpdatePreviewInstance"]
  NEWCLOSURE R2 P1
  CAPTURE VAL R0
  CAPTURE UPVAL U1
  SETTABLEKS R2 R1 K1 ["SetErrorNodeChecked"]
  NEWCLOSURE R2 P2
  CAPTURE VAL R0
  CAPTURE UPVAL U2
  SETTABLEKS R2 R1 K2 ["UpdateQueueItem"]
  RETURN R1 1
...
MAIN:
  ...
  GETTABLEKS R23 R24 K34 ["QueuedSession"]
  CALL R22 1 1
  GETIMPORT R23 K5 [require]
  GETTABLEKS R26 R0 K19 ["Src"]
  GETTABLEKS R25 R26 K35 ["Flags"]
  GETTABLEKS R24 R25 K36 ["getFFlagChooseAnimationForRestPose"]
  CALL R23 1 1
  GETIMPORT R24 K5 [require]
  GETTABLEKS R27 R0 K19 ["Src"]
  GETTABLEKS R26 R27 K35 ["Flags"]
  GETTABLEKS R25 R26 K37 ["getFFlagUnlinkImporterAndAvatarPreview"]
  CALL R24 1 1
  ...
  DUPCLOSURE R28 K45 [PROTO_4]
  SETTABLEKS R28 R25 K46 ["_disconnect"]
  DUPCLOSURE R28 K47 [PROTO_9]
  CAPTURE VAL R20
  CAPTURE VAL R23
  CAPTURE VAL R26
  ...
  DUPCLOSURE R28 K53 [PROTO_12]
  SETTABLEKS R28 R25 K54 ["didUpdate"]
  DUPCLOSURE R28 K55 [PROTO_13]
  CAPTURE VAL R26
  SETTABLEKS R28 R25 K56 ["getDerivedStateFromProps"]
  DUPCLOSURE R28 K57 [PROTO_14]
  CAPTURE VAL R26
  CAPTURE VAL R19
  CAPTURE VAL R24
  CAPTURE VAL R18
