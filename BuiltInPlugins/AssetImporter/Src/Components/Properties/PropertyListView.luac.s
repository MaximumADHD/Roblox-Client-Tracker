...
MAIN:
  ...
  GETTABLEKS R26 R27 K40 ["StatusLevel"]
  CALL R25 1 1
  GETTABLEKS R26 R5 K41 ["Dash"]
  GETTABLEKS R27 R26 K42 ["omit"]
  GETTABLEKS R28 R26 K43 ["join"]
  GETIMPORT R29 K8 [require]
  GETTABLEKS R32 R0 K9 ["Src"]
  GETTABLEKS R31 R32 K44 ["Flags"]
  GETTABLEKS R30 R31 K45 ["getFFlagImporterOpensAvatarPreviewerBetaCheck"]
  CALL R29 1 1
  GETIMPORT R30 K8 [require]
  GETTABLEKS R33 R0 K9 ["Src"]
  GETTABLEKS R32 R33 K44 ["Flags"]
  GETTABLEKS R31 R32 K46 ["getFFlagAssetImportCustomPresetPolish"]
  CALL R30 1 1
  GETTABLEKS R31 R3 K47 ["PureComponent"]
  LOADK R33 K48 ["PropertyListView"]
  NAMECALL R31 R31 K49 ["extend"]
  CALL R31 2 1
  NEWTABLE R32 2 0
  GETTABLEKS R33 R25 K50 ["Error"]
  SETTABLEKS R33 R32 K51 ["Errors"]
  GETTABLEKS R33 R25 K52 ["Warning"]
  SETTABLEKS R33 R32 K53 ["Warnings"]
  DUPCLOSURE R33 K54 [PROTO_2]
  SETTABLEKS R33 R31 K55 ["init"]
  DUPCLOSURE R33 K56 [PROTO_3]
  SETTABLEKS R33 R31 K57 ["willUpdate"]
  DUPCLOSURE R33 K58 [PROTO_4]
  CAPTURE VAL R23
  CAPTURE VAL R3
  CAPTURE VAL R16
  ...
  CAPTURE VAL R11
  CAPTURE VAL R16
  SETTABLEKS R36 R31 K62 ["createHeader"]
  DUPCLOSURE R36 K63 [PROTO_10]
  CAPTURE VAL R33
  CAPTURE VAL R21
  CAPTURE VAL R22
  CAPTURE VAL R34
  ...
  CAPTURE VAL R6
  CAPTURE VAL R29
  SETTABLEKS R36 R31 K64 ["buildSection"]
  DUPCLOSURE R36 K65 [PROTO_11]
  CAPTURE VAL R24
  CAPTURE VAL R3
  CAPTURE VAL R15
  SETTABLEKS R36 R31 K66 ["render"]
  MOVE R36 R8
  DUPTABLE R37 K67 [{"Localization", "Stylizer"}]
  SETTABLEKS R9 R37 K18 ["Localization"]
  SETTABLEKS R10 R37 K19 ["Stylizer"]
  CALL R36 1 1
  MOVE R37 R31
  CALL R36 1 1
  MOVE R31 R36
  DUPCLOSURE R36 K68 [PROTO_12]
  GETTABLEKS R37 R4 K69 ["connect"]
  MOVE R38 R36
  CALL R37 1 1
  MOVE R38 R31
  CALL R37 1 -1
