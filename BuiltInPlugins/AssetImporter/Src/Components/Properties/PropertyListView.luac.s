...
MAIN:
  ...
  GETTABLEKS R28 R29 K44 ["getFFlagAssetImportEnableMultipleFiles"]
  CALL R27 1 1
  GETTABLEKS R28 R2 K45 ["PureComponent"]
  LOADK R30 K46 ["PropertyListView"]
  NAMECALL R28 R28 K47 ["extend"]
  CALL R28 2 1
  DUPCLOSURE R29 K48 [PROTO_2]
  SETTABLEKS R29 R28 K49 ["init"]
  DUPCLOSURE R29 K50 [PROTO_3]
  SETTABLEKS R29 R28 K51 ["willUpdate"]
  DUPCLOSURE R29 K52 [PROTO_4]
  CAPTURE VAL R25
  CAPTURE VAL R2
  CAPTURE VAL R15
  DUPCLOSURE R30 K53 [PROTO_5]
  CAPTURE VAL R2
  CAPTURE VAL R20
  DUPCLOSURE R31 K54 [PROTO_6]
  CAPTURE VAL R1
  DUPCLOSURE R32 K55 [PROTO_8]
  CAPTURE VAL R17
  CAPTURE VAL R1
  CAPTURE VAL R18
  CAPTURE VAL R2
  ...
  CAPTURE VAL R10
  CAPTURE VAL R15
  SETTABLEKS R32 R28 K56 ["createHeader"]
  ...
  CAPTURE VAL R12
  CAPTURE VAL R18
  SETTABLEKS R32 R28 K58 ["buildSection"]
  DUPCLOSURE R32 K59 [PROTO_11]
  CAPTURE VAL R26
  CAPTURE VAL R2
  CAPTURE VAL R14
  SETTABLEKS R32 R28 K60 ["render"]
  MOVE R32 R7
  DUPTABLE R33 K61 [{"Localization", "Stylizer"}]
  SETTABLEKS R8 R33 K17 ["Localization"]
  SETTABLEKS R9 R33 K18 ["Stylizer"]
  CALL R32 1 1
  MOVE R33 R28
  CALL R32 1 1
  MOVE R28 R32
  DUPCLOSURE R32 K62 [PROTO_12]
  CAPTURE VAL R27
  GETTABLEKS R33 R3 K63 ["connect"]
  MOVE R34 R32
  CALL R33 1 1
  MOVE R34 R28
  CALL R33 1 -1
