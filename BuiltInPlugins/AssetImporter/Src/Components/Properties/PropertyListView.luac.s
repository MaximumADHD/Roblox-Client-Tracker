...
PROTO_12:
  ...
  RETURN R1 1
  DUPTABLE R1 K3 [{"CurrentPreset", "SettingsChanged", "AssetImportSession"}]
  GETTABLEKS R2 R0 K5 ["currentPreset"]
  SETTABLEKS R2 R1 K0 ["CurrentPreset"]
  GETTABLEKS R2 R0 K6 ["settingsChanged"]
  SETTABLEKS R2 R1 K1 ["SettingsChanged"]
...
MAIN:
  ...
  GETTABLEKS R27 R28 K41 ["Flags"]
  GETTABLEKS R26 R27 K42 ["getFFlagAssetImportRefactorReducer"]
  CALL R25 1 1
  GETTABLEKS R26 R5 K43 ["Dash"]
  GETTABLEKS R27 R26 K44 ["omit"]
  GETTABLEKS R28 R26 K45 ["join"]
  ...
  CALL R29 1 1
  GETTABLEKS R30 R3 K47 ["PureComponent"]
  LOADK R32 K48 ["PropertyListView"]
  NAMECALL R30 R30 K49 ["extend"]
  CALL R30 2 1
  DUPCLOSURE R31 K50 [PROTO_2]
  SETTABLEKS R31 R30 K51 ["init"]
  DUPCLOSURE R31 K52 [PROTO_3]
  SETTABLEKS R31 R30 K53 ["willUpdate"]
  DUPCLOSURE R31 K54 [PROTO_4]
  CAPTURE VAL R23
  CAPTURE VAL R3
  CAPTURE VAL R16
  DUPCLOSURE R32 K55 [PROTO_5]
  CAPTURE VAL R3
  CAPTURE VAL R18
  DUPCLOSURE R33 K56 [PROTO_6]
  CAPTURE VAL R1
  DUPCLOSURE R34 K57 [PROTO_8]
  CAPTURE VAL R27
  CAPTURE VAL R1
  CAPTURE VAL R28
  CAPTURE VAL R3
  ...
  CAPTURE VAL R11
  CAPTURE VAL R16
  SETTABLEKS R34 R30 K58 ["createHeader"]
  DUPCLOSURE R34 K59 [PROTO_10]
  CAPTURE VAL R31
  CAPTURE VAL R21
  CAPTURE VAL R22
  CAPTURE VAL R32
  ...
  CAPTURE VAL R6
  CAPTURE VAL R29
  SETTABLEKS R34 R30 K60 ["buildSection"]
  DUPCLOSURE R34 K61 [PROTO_11]
  CAPTURE VAL R24
  CAPTURE VAL R3
  CAPTURE VAL R15
  SETTABLEKS R34 R30 K62 ["render"]
  MOVE R34 R8
  DUPTABLE R35 K63 [{"Localization", "Stylizer"}]
  SETTABLEKS R9 R35 K19 ["Localization"]
  SETTABLEKS R10 R35 K20 ["Stylizer"]
  CALL R34 1 1
  MOVE R35 R30
  CALL R34 1 1
  MOVE R30 R34
  DUPCLOSURE R34 K64 [PROTO_12]
  CAPTURE VAL R25
  GETTABLEKS R35 R4 K65 ["connect"]
  MOVE R36 R34
  CALL R35 1 1
  MOVE R36 R30
  CALL R35 1 -1
