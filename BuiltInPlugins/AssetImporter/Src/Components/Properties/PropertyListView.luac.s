...
PROTO_2:
  ...
  CALL R1 1 1
  DUPTABLE R4 K6 [{"expanded", "absoluteHorizontalSize", "showReimportCallout"}]
  DUPTABLE R5 K9 [{"FileGeneral", "ObjectGeneral"}]
  LOADB R6 1
  SETTABLEKS R6 R5 K7 ["FileGeneral"]
  LOADB R6 1
  SETTABLEKS R6 R5 K8 ["ObjectGeneral"]
  SETTABLEKS R5 R4 K3 ["expanded"]
  LOADN R5 0
  SETTABLEKS R5 R4 K4 ["absoluteHorizontalSize"]
  GETUPVAL R5 0
  CALL R5 0 1
  JUMPIFNOT R5 [+9]
  GETUPVAL R6 1
  GETTABLEKS R5 R6 K10 ["shouldShowCallout"]
  MOVE R6 R1
  GETTABLEKS R8 R0 K0 ["props"]
  GETTABLEKS R7 R8 K11 ["Filename"]
  CALL R5 2 1
  SETTABLEKS R5 R4 K5 ["showReimportCallout"]
  NAMECALL R2 R0 K12 ["setState"]
  CALL R2 2 0
  GETTABLEKS R3 R0 K0 ["props"]
  GETTABLEKS R2 R3 K13 ["Instance"]
  NAMECALL R2 R2 K14 ["GetStatuses"]
  CALL R2 1 1
  SETTABLEKS R2 R0 K15 ["statuses"]
  NEWCLOSURE R2 P0
  CAPTURE VAL R0
  SETTABLEKS R2 R0 K16 ["onContentResize"]
  NEWCLOSURE R2 P1
  CAPTURE VAL R0
  SETTABLEKS R2 R0 K17 ["refreshForStatusCompatibility"]
  RETURN R0 0

PROTO_3:
  GETTABLEKS R3 R1 K0 ["Instance"]
  NAMECALL R3 R3 K1 ["GetStatuses"]
  CALL R3 1 1
  SETTABLEKS R3 R0 K2 ["statuses"]
  RETURN R0 0
...
PROTO_10:
  ...
  GETUPVAL R13 6
  DUPTABLE R14 K51 [{"Expanded", "OnExpandedChanged", "Layout", "LayoutOrder", "Style", "Text", "HeaderOverride"}]
  ...
  MOVE R19 R10
  MOVE R20 R11
  NAMECALL R15 R0 K59 ["createHeader"]
  CALL R15 5 1
  SETTABLEKS R15 R14 K50 ["HeaderOverride"]
  GETUPVAL R15 7
  MOVE R16 R7
  MOVE R17 R6
  CALL R15 2 -1
...
PROTO_11:
  GETUPVAL R0 0
  DUPTABLE R2 K1 [{"showReimportCallout"}]
  LOADB R3 0
  SETTABLEKS R3 R2 K0 ["showReimportCallout"]
...
PROTO_12:
  ...
  GETTABLEKS R8 R9 K27 ["showReimportCallout"]
  JUMPIFNOT R8 [+11]
  GETUPVAL R8 4
  GETTABLEKS R7 R8 K5 ["createElement"]
  GETUPVAL R8 5
  DUPTABLE R9 K29 [{"onDismiss"}]
  NEWCLOSURE R10 P0
  CAPTURE VAL R0
  SETTABLEKS R10 R9 K28 ["onDismiss"]
  CALL R7 2 1
  JUMP [+1]
  LOADNIL R7
  GETUPVAL R9 4
  ...
  GETUPVAL R10 4
  GETTABLEKS R9 R10 K30 ["Fragment"]
  LOADNIL R10
  MOVE R11 R2
  CALL R8 3 -1
  SETLIST R6 R7 -1 [1]
...
PROTO_13:
  DUPTABLE R1 K2 [{"AssetImportSession", "Filename"}]
...
MAIN:
  ...
  GETTABLEKS R11 R8 K20 ["Stylizer"]
  GETTABLEKS R13 R6 K21 ["Util"]
  GETTABLEKS R12 R13 K22 ["StyleModifier"]
  GETTABLEKS R13 R6 K23 ["UI"]
  GETTABLEKS R14 R13 K24 ["ExpandablePane"]
  GETTABLEKS R15 R13 K25 ["Pane"]
  GETTABLEKS R16 R13 K26 ["ScrollingFrame"]
  GETTABLEKS R17 R13 K27 ["TextLabel"]
  GETTABLEKS R18 R13 K28 ["Image"]
  GETTABLEKS R19 R7 K29 ["omit"]
  GETTABLEKS R20 R7 K30 ["join"]
  ...
  GETTABLEKS R23 R24 K33 ["PropertyView"]
  CALL R22 1 1
  GETIMPORT R23 K5 [require]
  GETTABLEKS R27 R0 K6 ["Src"]
  GETTABLEKS R26 R27 K34 ["Components"]
  GETTABLEKS R25 R26 K35 ["Properties"]
  GETTABLEKS R24 R25 K36 ["PropertyStatus"]
  CALL R23 1 1
  GETIMPORT R24 K5 [require]
  GETIMPORT R27 K1 [script]
  GETTABLEKS R26 R27 K32 ["Parent"]
  GETTABLEKS R25 R26 K37 ["ReimportCallout"]
  CALL R24 1 1
  GETIMPORT R25 K5 [require]
  GETTABLEKS R28 R0 K6 ["Src"]
  GETTABLEKS R27 R28 K7 ["Utility"]
  GETTABLEKS R26 R27 K38 ["createCalloutComponents"]
  CALL R25 1 1
  GETIMPORT R26 K5 [require]
  GETTABLEKS R30 R0 K6 ["Src"]
  GETTABLEKS R29 R30 K7 ["Utility"]
  GETTABLEKS R28 R29 K39 ["Status"]
  GETTABLEKS R27 R28 K40 ["filterStatusesForProp"]
  CALL R26 1 1
  GETIMPORT R27 K5 [require]
  GETTABLEKS R31 R0 K6 ["Src"]
  GETTABLEKS R30 R31 K7 ["Utility"]
  GETTABLEKS R29 R30 K39 ["Status"]
  GETTABLEKS R28 R29 K41 ["getHighestSeverityStatus"]
  CALL R27 1 1
  GETIMPORT R28 K5 [require]
  GETTABLEKS R32 R0 K6 ["Src"]
  GETTABLEKS R31 R32 K7 ["Utility"]
  GETTABLEKS R30 R31 K39 ["Status"]
  GETTABLEKS R29 R30 K42 ["GetLocalizedStatusMessage"]
  CALL R28 1 1
  GETIMPORT R29 K5 [require]
  GETTABLEKS R32 R0 K6 ["Src"]
  GETTABLEKS R31 R32 K7 ["Utility"]
  GETTABLEKS R30 R31 K43 ["getPropertiesForInstance"]
  CALL R29 1 1
  GETIMPORT R30 K5 [require]
  GETTABLEKS R33 R0 K6 ["Src"]
  GETTABLEKS R32 R33 K44 ["Controllers"]
  GETTABLEKS R31 R32 K45 ["ReimportCalloutController"]
  CALL R30 1 1
  GETIMPORT R31 K5 [require]
  GETTABLEKS R34 R0 K6 ["Src"]
  GETTABLEKS R33 R34 K46 ["Flags"]
  GETTABLEKS R32 R33 K47 ["getFFlagUnlinkImporterAndAvatarPreview"]
  CALL R31 1 1
  GETIMPORT R32 K5 [require]
  GETTABLEKS R35 R0 K6 ["Src"]
  GETTABLEKS R34 R35 K46 ["Flags"]
  GETTABLEKS R33 R34 K48 ["getFFlagShowNewReimportCallout"]
  CALL R32 1 1
  ...
  SETTABLEKS R34 R33 K55 ["willUpdate"]
  DUPCLOSURE R34 K56 [PROTO_4]
  CAPTURE VAL R28
  CAPTURE VAL R4
  CAPTURE VAL R17
  DUPCLOSURE R35 K57 [PROTO_5]
  CAPTURE VAL R4
  CAPTURE VAL R22
  DUPCLOSURE R36 K58 [PROTO_6]
  CAPTURE VAL R2
  ...
  CAPTURE VAL R12
  CAPTURE VAL R17
  SETTABLEKS R37 R33 K60 ["createHeader"]
  DUPCLOSURE R37 K61 [PROTO_10]
  CAPTURE VAL R34
  CAPTURE VAL R26
  CAPTURE VAL R27
  CAPTURE VAL R35
  ...
  CAPTURE VAL R14
  CAPTURE VAL R20
  SETTABLEKS R37 R33 K62 ["buildSection"]
  DUPCLOSURE R37 K63 [PROTO_12]
  CAPTURE VAL R29
  CAPTURE VAL R4
  CAPTURE VAL R16
  CAPTURE VAL R32
  CAPTURE VAL R3
  CAPTURE VAL R24
  SETTABLEKS R37 R33 K64 ["render"]
  MOVE R37 R9
  DUPTABLE R38 K66 [{"Localization", "Stylizer", "Plugin"}]
  SETTABLEKS R10 R38 K19 ["Localization"]
  SETTABLEKS R11 R38 K20 ["Stylizer"]
  GETTABLEKS R39 R8 K65 ["Plugin"]
  SETTABLEKS R39 R38 K65 ["Plugin"]
  CALL R37 1 1
  MOVE R38 R33
  CALL R37 1 1
  MOVE R33 R37
  DUPCLOSURE R37 K67 [PROTO_13]
  CAPTURE VAL R32
  GETTABLEKS R38 R5 K68 ["connect"]
  MOVE R39 R37
  CALL R38 1 1
  MOVE R39 R33
  CALL R38 1 -1
