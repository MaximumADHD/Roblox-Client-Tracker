...
PROTO_5:
  ...
  GETUPVAL R4 2
  MOVE R5 R1
  DUPTABLE R6 K9 [{"Text", "RichText", "TextWrapped", "TextXAlignment", "TextSize", "AutomaticSize", "Size", "OnClick"}]
  LOADK R7 K10 ["Have you imported this before? Try <b>Reimport</b> for faster, one-click updates. <u>Learn more</u>."]
  SETTABLEKS R7 R6 K1 ["Text"]
  LOADB R7 1
  SETTABLEKS R7 R6 K2 ["RichText"]
  LOADB R7 1
  SETTABLEKS R7 R6 K3 ["TextWrapped"]
  GETIMPORT R7 K13 [Enum.TextXAlignment.Left]
  SETTABLEKS R7 R6 K4 ["TextXAlignment"]
  LOADN R7 18
  SETTABLEKS R7 R6 K5 ["TextSize"]
  GETIMPORT R7 K15 [Enum.AutomaticSize.XY]
...
PROTO_12:
  ...
  CALL R6 3 1
  LENGTH R7 R6
  JUMPIFNOTEQKN R7 K14 [0] [+25]
  GETUPVAL R7 2
  CALL R7 0 1
  JUMPIFNOT R7 [+21]
  GETUPVAL R7 3
  GETTABLEKS R9 R3 K15 ["Filename"]
  NAMECALL R7 R7 K16 ["getFileSeenCount"]
  CALL R7 2 1
  JUMPIFNOTEQKN R7 K17 [2] [+14]
  MOVE R9 R6
  GETUPVAL R10 4
  GETTABLEKS R11 R3 K6 ["localization"]
  DUPTABLE R12 K19 [{"LayoutOrder"}]
  LENGTH R13 R6
  ...
  CALL R8 -1 0
  NEWTABLE R7 0 0
  GETIMPORT R8 K24 [pairs]
  GETTABLEKS R9 R2 K25 ["Properties"]
  CALL R8 1 3
  FORGPREP_NEXT R8
  GETTABLEKS R13 R12 K26 ["ShouldHide"]
  JUMPIFNOT R13 [+8]
  GETTABLEKS R13 R12 K26 ["ShouldHide"]
  GETTABLEKS R14 R3 K27 ["Instance"]
  GETTABLEKS R15 R3 K28 ["AssetImportSession"]
  CALL R13 2 1
  JUMPIF R13 [+37]
  GETUPVAL R13 1
  GETTABLEKS R14 R12 K29 ["Name"]
  GETTABLEKS R15 R0 K13 ["statuses"]
  CALL R13 2 1
  GETUPVAL R14 5
  MOVE R15 R13
  CALL R14 1 1
  DUPTABLE R15 K34 [{"importData", "layoutOrder", "propertyMetadata", "localization", "status"}]
  GETTABLEKS R16 R3 K27 ["Instance"]
  SETTABLEKS R16 R15 K30 ["importData"]
  LENGTH R17 R6
  ADD R16 R11 R17
  SETTABLEKS R16 R15 K31 ["layoutOrder"]
  SETTABLEKS R12 R15 K32 ["propertyMetadata"]
  GETTABLEKS R16 R3 K11 ["Localization"]
  SETTABLEKS R16 R15 K6 ["localization"]
  SETTABLEKS R14 R15 K33 ["status"]
  MOVE R17 R7
  GETUPVAL R18 6
  MOVE R19 R15
  MOVE R20 R4
  GETTABLEKS R21 R0 K35 ["refreshForStatusCompatibility"]
  CALL R18 3 -1
  FASTCALL TABLE_INSERT [+2]
  ...
  FORGLOOP R8 2 [-49]
  LENGTH R8 R6
  JUMPIFNOTEQKN R8 K14 [0] [+6]
  LENGTH R8 R7
  JUMPIFNOTEQKN R8 K14 [0] [+3]
  LOADNIL R8
  RETURN R8 1
  GETTABLEKS R10 R0 K8 ["state"]
  GETTABLEKS R9 R10 K36 ["expanded"]
  ...
  LOADNIL R10
  JUMPIFNOT R9 [+29]
  DUPTABLE R11 K41 [{"StatusLevel", "StatusMessage", "StatusContext", "Position"}]
  GETTABLEKS R13 R4 K1 ["Status"]
  GETTABLEKS R12 R13 K42 ["Level"]
  SETTABLEKS R12 R11 K37 ["StatusLevel"]
  GETTABLEKS R13 R4 K1 ["Status"]
  GETTABLEKS R12 R13 K43 ["Type"]
  SETTABLEKS R12 R11 K38 ["StatusMessage"]
  GETTABLEKS R13 R4 K1 ["Status"]
  GETTABLEKS R12 R13 K44 ["Context"]
  SETTABLEKS R12 R11 K39 ["StatusContext"]
  ...
  LOADNIL R11
  GETUPVAL R13 8
  GETTABLEKS R12 R13 K48 ["createElement"]
  GETUPVAL R13 9
  DUPTABLE R14 K55 [{"Expanded", "OnExpandedChanged", "Layout", "LayoutOrder", "Style", "Text", "HeaderOverride"}]
  SETTABLEKS R8 R14 K49 ["Expanded"]
  NEWCLOSURE R15 P0
  CAPTURE VAL R0
  CAPTURE UPVAL U10
  CAPTURE VAL R2
  CAPTURE VAL R8
  SETTABLEKS R15 R14 K50 ["OnExpandedChanged"]
  GETIMPORT R15 K59 [Enum.FillDirection.Vertical]
  SETTABLEKS R15 R14 K51 ["Layout"]
  SETTABLEKS R1 R14 K18 ["LayoutOrder"]
  LOADK R15 K60 ["ImportTree"]
  SETTABLEKS R15 R14 K52 ["Style"]
  GETTABLEKS R15 R3 K11 ["Localization"]
  LOADK R17 K61 ["Sections"]
  GETTABLEKS R18 R2 K12 ["Section"]
  NAMECALL R15 R15 K62 ["getText"]
  CALL R15 3 1
  ...
  MOVE R19 R10
  MOVE R20 R11
  NAMECALL R15 R0 K63 ["createHeader"]
  CALL R15 5 1
  SETTABLEKS R15 R14 K54 ["HeaderOverride"]
  GETUPVAL R15 10
  MOVE R16 R7
  MOVE R17 R6
  CALL R15 2 -1
...
MAIN:
  ...
  GETTABLEKS R17 R12 K27 ["LinkText"]
  GETTABLEKS R18 R12 K28 ["Image"]
  GETTABLEKS R19 R6 K29 ["omit"]
  GETTABLEKS R20 R6 K30 ["join"]
  ...
  GETTABLEKS R27 R0 K6 ["Src"]
  GETTABLEKS R26 R27 K7 ["Utility"]
  GETTABLEKS R25 R26 K37 ["createCalloutComponents"]
  CALL R24 1 1
  GETIMPORT R25 K5 [require]
  GETTABLEKS R29 R0 K6 ["Src"]
  GETTABLEKS R28 R29 K7 ["Utility"]
  GETTABLEKS R27 R28 K38 ["Status"]
  GETTABLEKS R26 R27 K39 ["filterStatusesForProp"]
  CALL R25 1 1
  GETIMPORT R26 K5 [require]
  GETTABLEKS R30 R0 K6 ["Src"]
  GETTABLEKS R29 R30 K7 ["Utility"]
  GETTABLEKS R28 R29 K38 ["Status"]
  GETTABLEKS R27 R28 K40 ["getHighestSeverityStatus"]
  CALL R26 1 1
  GETIMPORT R27 K5 [require]
  GETTABLEKS R31 R0 K6 ["Src"]
  GETTABLEKS R30 R31 K7 ["Utility"]
  GETTABLEKS R29 R30 K38 ["Status"]
  GETTABLEKS R28 R29 K41 ["GetLocalizedStatusMessage"]
  CALL R27 1 1
  GETIMPORT R28 K5 [require]
  GETTABLEKS R31 R0 K6 ["Src"]
  GETTABLEKS R30 R31 K7 ["Utility"]
  GETTABLEKS R29 R30 K42 ["getPropertiesForInstance"]
  CALL R28 1 1
  GETIMPORT R29 K5 [require]
  GETTABLEKS R32 R0 K6 ["Src"]
  GETTABLEKS R31 R32 K43 ["Controllers"]
  GETTABLEKS R30 R31 K44 ["ReimportCalloutController"]
  CALL R29 1 1
  GETIMPORT R30 K5 [require]
  GETTABLEKS R33 R0 K6 ["Src"]
  GETTABLEKS R32 R33 K45 ["Flags"]
  GETTABLEKS R31 R32 K46 ["getFFlagUnlinkImporterAndAvatarPreview"]
  CALL R30 1 1
  GETIMPORT R31 K5 [require]
  GETTABLEKS R34 R0 K6 ["Src"]
  GETTABLEKS R33 R34 K45 ["Flags"]
  GETTABLEKS R32 R33 K47 ["getFFlagShowReimportCallout"]
  CALL R31 1 1
  GETTABLEKS R32 R3 K48 ["PureComponent"]
  LOADK R34 K49 ["PropertyListView"]
  NAMECALL R32 R32 K50 ["extend"]
  CALL R32 2 1
  DUPCLOSURE R33 K51 [PROTO_2]
  SETTABLEKS R33 R32 K52 ["init"]
  DUPCLOSURE R33 K53 [PROTO_3]
  SETTABLEKS R33 R32 K54 ["willUpdate"]
  ...
  CAPTURE VAL R3
  CAPTURE VAL R22
  DUPCLOSURE R36 K58 [PROTO_8]
  CAPTURE VAL R2
  DUPCLOSURE R37 K59 [PROTO_10]
  CAPTURE VAL R19
  CAPTURE VAL R2
  CAPTURE VAL R20
  CAPTURE VAL R3
  ...
  CAPTURE VAL R11
  CAPTURE VAL R16
  SETTABLEKS R37 R32 K60 ["createHeader"]
  ...
  CAPTURE VAL R13
  CAPTURE VAL R20
  SETTABLEKS R37 R32 K62 ["buildSection"]
  DUPCLOSURE R37 K63 [PROTO_13]
  CAPTURE VAL R28
  CAPTURE VAL R3
  CAPTURE VAL R15
  SETTABLEKS R37 R32 K64 ["render"]
  MOVE R37 R8
  DUPTABLE R38 K65 [{"Localization", "Stylizer"}]
  SETTABLEKS R9 R38 K18 ["Localization"]
  SETTABLEKS R10 R38 K19 ["Stylizer"]
  CALL R37 1 1
  MOVE R38 R32
  CALL R37 1 1
  MOVE R32 R37
  DUPCLOSURE R37 K66 [PROTO_14]
  CAPTURE VAL R31
  GETTABLEKS R38 R4 K67 ["connect"]
  MOVE R39 R37
  CALL R38 1 1
  MOVE R39 R32
  CALL R38 1 -1
