...
MAIN:
  ...
  CALL R24 1 1
  GETTABLEKS R25 R5 K39 ["Dash"]
  GETTABLEKS R26 R25 K40 ["omit"]
  GETTABLEKS R27 R25 K41 ["join"]
  GETIMPORT R28 K8 [require]
  GETTABLEKS R31 R0 K9 ["Src"]
  GETTABLEKS R30 R31 K42 ["Flags"]
  GETTABLEKS R29 R30 K43 ["getFFlagImporterOpensAvatarPreviewerBetaCheck"]
  CALL R28 1 1
  GETTABLEKS R29 R3 K44 ["PureComponent"]
  LOADK R31 K45 ["PropertyListView"]
  NAMECALL R29 R29 K46 ["extend"]
  CALL R29 2 1
  DUPCLOSURE R30 K47 [PROTO_2]
  SETTABLEKS R30 R29 K48 ["init"]
  DUPCLOSURE R30 K49 [PROTO_3]
  SETTABLEKS R30 R29 K50 ["willUpdate"]
  DUPCLOSURE R30 K51 [PROTO_4]
  CAPTURE VAL R23
  CAPTURE VAL R3
  CAPTURE VAL R16
  ...
  CAPTURE VAL R11
  CAPTURE VAL R16
  SETTABLEKS R33 R29 K55 ["createHeader"]
  ...
  CAPTURE VAL R6
  CAPTURE VAL R28
  SETTABLEKS R33 R29 K57 ["buildSection"]
  DUPCLOSURE R33 K58 [PROTO_11]
  CAPTURE VAL R24
  CAPTURE VAL R3
  CAPTURE VAL R15
  SETTABLEKS R33 R29 K59 ["render"]
  MOVE R33 R8
  DUPTABLE R34 K60 [{"Localization", "Stylizer"}]
  SETTABLEKS R9 R34 K18 ["Localization"]
  SETTABLEKS R10 R34 K19 ["Stylizer"]
  CALL R33 1 1
  MOVE R34 R29
  CALL R33 1 1
  MOVE R29 R33
  DUPCLOSURE R33 K61 [PROTO_12]
  GETTABLEKS R34 R4 K62 ["connect"]
  MOVE R35 R33
  CALL R34 1 1
  MOVE R35 R29
  CALL R34 1 -1
