...
MAIN:
  ...
  GETTABLEKS R33 R34 K48 ["getFFlagImporterOpensAvatarPreviewer2"]
  CALL R32 1 1
  GETIMPORT R33 K8 [require]
  GETTABLEKS R36 R0 K9 ["Src"]
  GETTABLEKS R35 R36 K46 ["Flags"]
  GETTABLEKS R34 R35 K49 ["getFFlagImporterOpensAvatarPreviewerBetaCheck"]
  CALL R33 1 1
  GETIMPORT R34 K8 [require]
  GETTABLEKS R37 R0 K9 ["Src"]
  GETTABLEKS R36 R37 K46 ["Flags"]
  GETTABLEKS R35 R36 K50 ["getFFlagAssetImportCustomPresetPolish"]
  CALL R34 1 1
  GETTABLEKS R35 R3 K51 ["PureComponent"]
  LOADK R37 K52 ["PropertyListView"]
  NAMECALL R35 R35 K53 ["extend"]
  CALL R35 2 1
  NEWTABLE R36 2 0
  GETTABLEKS R37 R27 K54 ["Error"]
  SETTABLEKS R37 R36 K55 ["Errors"]
  GETTABLEKS R37 R27 K56 ["Warning"]
  ...
  CAPTURE VAL R31
  SETTABLEKS R38 R35 K59 ["init"]
  MOVE R38 R31
  CALL R38 0 1
  JUMPIFNOT R38 [+3]
  DUPCLOSURE R38 K60 [PROTO_3]
  SETTABLEKS R38 R35 K61 ["willUpdate"]
  ...
  CAPTURE VAL R11
  CAPTURE VAL R16
  SETTABLEKS R43 R35 K68 ["createHeader"]
  ...
  CAPTURE VAL R32
  CAPTURE VAL R33
  SETTABLEKS R43 R35 K70 ["buildSection"]
