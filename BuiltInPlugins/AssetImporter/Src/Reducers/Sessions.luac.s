...
PROTO_2:
  ...
  GETTABLEKS R5 R1 K1 ["queueItem"]
  CALL R4 1 1
  GETTABLEKS R5 R0 K3 ["activeSessionCount"]
  JUMPIFNOT R3 [+3]
  JUMPIF R4 [+2]
  SUBK R5 R5 K4 [1]
  JUMP [+3]
  ...
  GETUPVAL R6 1
  MOVE R7 R0
  DUPTABLE R8 K5 [{"activeSessionCount", "sessionQueue"}]
  SETTABLEKS R5 R8 K3 ["activeSessionCount"]
  GETUPVAL R9 1
...
MAIN:
  ...
  GETTABLEKS R15 R4 K21 ["DEPRECATED_UpdateQueueItem"]
  CALL R14 1 1
  ...
  GETTABLEKS R18 R19 K27 ["getFFlagImportQueuePerSessionState"]
  CALL R17 1 1
  GETIMPORT R18 K5 [require]
  GETTABLEKS R21 R0 K10 ["Src"]
  GETTABLEKS R20 R21 K26 ["Flags"]
  GETTABLEKS R19 R20 K28 ["getFFlagImportQueueSessionThunksRefactor"]
  CALL R18 1 1
  DUPTABLE R19 K37 [{"activeSessionCount", "parsing", "progress", "progressGoal", "searchTerm", "sessionCount", "sessionQueue", "uploading"}]
  LOADN R20 0
  SETTABLEKS R20 R19 K29 ["activeSessionCount"]
  LOADB R20 0
  SETTABLEKS R20 R19 K30 ["parsing"]
  LOADN R20 0
  SETTABLEKS R20 R19 K31 ["progress"]
  LOADN R20 0
  SETTABLEKS R20 R19 K32 ["progressGoal"]
  LOADK R20 K38 [""]
  SETTABLEKS R20 R19 K33 ["searchTerm"]
  LOADN R20 0
  SETTABLEKS R20 R19 K34 ["sessionCount"]
  NEWTABLE R20 0 0
  SETTABLEKS R20 R19 K35 ["sessionQueue"]
  LOADB R20 0
  SETTABLEKS R20 R19 K36 ["uploading"]
  GETTABLEKS R20 R1 K39 ["createReducer"]
  MOVE R21 R19
  NEWTABLE R22 16 0
  GETTABLEKS R23 R8 K40 ["name"]
  DUPCLOSURE R24 K41 [PROTO_0]
  CAPTURE VAL R19
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R5 K40 ["name"]
  DUPCLOSURE R24 K42 [PROTO_1]
  CAPTURE VAL R3
  CAPTURE VAL R17
  CAPTURE VAL R16
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R14 K40 ["name"]
  MOVE R25 R18
  CALL R25 0 1
  JUMPIFNOT R25 [+2]
  LOADNIL R24
  JUMP [+3]
  DUPCLOSURE R24 K43 [PROTO_2]
  CAPTURE VAL R16
  CAPTURE VAL R3
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R7 K40 ["name"]
  ...
  CAPTURE VAL R16
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R6 K40 ["name"]
  DUPCLOSURE R24 K45 [PROTO_4]
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R9 K40 ["name"]
  DUPCLOSURE R24 K46 [PROTO_5]
  CAPTURE VAL R3
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R10 K40 ["name"]
  DUPCLOSURE R24 K47 [PROTO_6]
  CAPTURE VAL R3
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R11 K40 ["name"]
  DUPCLOSURE R24 K48 [PROTO_7]
  CAPTURE VAL R3
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R12 K40 ["name"]
  DUPCLOSURE R24 K49 [PROTO_8]
  CAPTURE VAL R3
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R13 K40 ["name"]
  MOVE R25 R17
  CALL R25 0 1
  JUMPIFNOT R25 [+3]
  DUPCLOSURE R24 K50 [PROTO_9]
  CAPTURE VAL R3
  JUMP [+1]
  LOADNIL R24
  SETTABLE R24 R22 R23
