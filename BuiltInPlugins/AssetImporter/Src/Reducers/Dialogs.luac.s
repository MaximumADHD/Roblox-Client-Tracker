...
MAIN:
  ...
  GETTABLEKS R17 R18 K22 ["Types"]
  CALL R16 1 1
  DUPTABLE R17 K32 [{"managedGroups", "showError", "showParsingWidget", "showPreview", "showProgress", "showQueue", "showUploadWidget", "uploadWidgetItem"}]
  NEWTABLE R18 0 0
  SETTABLEKS R18 R17 K24 ["managedGroups"]
  LOADB R18 0
  SETTABLEKS R18 R17 K25 ["showError"]
  LOADB R18 0
  SETTABLEKS R18 R17 K26 ["showParsingWidget"]
  LOADB R18 0
  ...
  NEWTABLE R18 0 0
  SETTABLEKS R18 R17 K31 ["uploadWidgetItem"]
  GETTABLEKS R18 R1 K33 ["createReducer"]
  MOVE R19 R17
  NEWTABLE R20 16 0
  GETTABLEKS R21 R5 K34 ["name"]
  DUPCLOSURE R22 K35 [PROTO_0]
  CAPTURE VAL R17
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R6 K34 ["name"]
  DUPCLOSURE R22 K36 [PROTO_1]
  CAPTURE VAL R3
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R7 K34 ["name"]
  DUPCLOSURE R22 K37 [PROTO_2]
  CAPTURE VAL R3
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R8 K34 ["name"]
  DUPCLOSURE R22 K38 [PROTO_3]
  CAPTURE VAL R3
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R9 K34 ["name"]
  DUPCLOSURE R22 K39 [PROTO_4]
  CAPTURE VAL R3
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R10 K34 ["name"]
  DUPCLOSURE R22 K40 [PROTO_5]
  CAPTURE VAL R3
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R12 K34 ["name"]
  DUPCLOSURE R22 K41 [PROTO_6]
  CAPTURE VAL R3
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R11 K34 ["name"]
  DUPCLOSURE R22 K42 [PROTO_7]
  CAPTURE VAL R3
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R13 K34 ["name"]
  DUPCLOSURE R22 K43 [PROTO_8]
  CAPTURE VAL R3
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R14 K34 ["name"]
