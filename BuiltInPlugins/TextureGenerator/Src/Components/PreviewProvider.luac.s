PROTO_0:
       ...
       25 CALL                             R9 0 1
       26 GETUPVAL                         R10 0
       27 GETTABLEKS                       R10 R10 K0 ["useState"]
       29 LOADN                            R11 0
       30 CALL                             R10 1 2
       31 GETUPVAL                         R12 0
       32 GETTABLEKS                       R12 R12 K0 ["useState"]
       34 LOADN                            R13 0
       35 CALL                             R12 1 2
       36 GETUPVAL                         R14 0
       37 GETTABLEKS                       R14 R14 K1 ["createElement"]
       39 GETUPVAL                         R15 6
       40 GETTABLEKS                       R15 R15 K2 ["Provider"]
...
MAIN:
       ...
       20 GETTABLEKS                       R3 R3 K10 ["PreviewsContext"]
       22 CALL                             R2 1 1
       23 GETIMPORT                        R3 K5 [require]
       25 GETTABLEKS                       R4 R0 K8 ["Src"]
       27 GETTABLEKS                       R4 R4 K11 ["Hooks"]
       29 GETTABLEKS                       R4 R4 K12 ["useAddOrUpdateModelToPreview"]
       31 CALL                             R3 1 1
       32 GETIMPORT                        R4 K5 [require]
       34 GETTABLEKS                       R5 R0 K8 ["Src"]
       36 GETTABLEKS                       R5 R5 K11 ["Hooks"]
       38 GETTABLEKS                       R5 R5 K13 ["useAddOrUpdatePreview"]
       40 CALL                             R4 1 1
       41 GETIMPORT                        R5 K5 [require]
       43 GETTABLEKS                       R6 R0 K8 ["Src"]
       45 GETTABLEKS                       R6 R6 K11 ["Hooks"]
       47 GETTABLEKS                       R6 R6 K14 ["useErrorStates"]
       49 CALL                             R5 1 1
       50 GETIMPORT                        R6 K5 [require]
       52 GETTABLEKS                       R7 R0 K8 ["Src"]
       54 GETTABLEKS                       R7 R7 K11 ["Hooks"]
       56 GETTABLEKS                       R7 R7 K15 ["useRemovePreview"]
       58 CALL                             R6 1 1
       59 GETIMPORT                        R7 K5 [require]
       61 GETTABLEKS                       R8 R0 K8 ["Src"]
       63 GETTABLEKS                       R8 R8 K11 ["Hooks"]
       65 GETTABLEKS                       R8 R8 K16 ["useUpdatePreview"]
       67 CALL                             R7 1 1
