...
PROTO_5:
  ...
  GETUPVAL R10 13
  GETTABLEKS R9 R10 K42 ["addOrUpdatePreview"]
  MOVE R10 R8
  CALL R9 1 0
  DUPTABLE R9 K45 [{"hash", "uuid"}]
  SETTABLEKS R2 R9 K43 ["hash"]
  GETTABLEKS R10 R8 K44 ["uuid"]
  SETTABLEKS R10 R9 K44 ["uuid"]
  GETUPVAL R11 13
  GETTABLEKS R10 R11 K46 ["addOrUpdateModelToPreview"]
  MOVE R11 R9
  CALL R10 1 0
  GETUPVAL R10 15
  LOADK R12 K47 ["GeneratedPreview"]
  GETUPVAL R13 8
  MOVE R14 R0
  GETUPVAL R16 6
  GETTABLEKS R15 R16 K48 ["seed"]
  MOVE R16 R6
  GETUPVAL R18 6
  GETTABLEKS R17 R18 K36 ["smartUVUnwrap"]
  GETUPVAL R19 6
  GETTABLEKS R18 R19 K37 ["promptMasking"]
  GETTABLEKS R19 R8 K44 ["uuid"]
  NAMECALL R10 R10 K49 ["report"]
  CALL R10 9 0
  GETUPVAL R10 16
  GETUPVAL R11 17
  GETUPVAL R12 13
