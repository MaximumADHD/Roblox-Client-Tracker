...
PROTO_8:
  ...
  CALL R5 1 1
  GETTABLEKS R6 R0 K5 ["Generation"]
  GETTABLEKS R7 R6 K6 ["status"]
  LOADNIL R8
  GETUPVAL R11 6
  GETTABLEKS R10 R11 K7 ["STATUS"]
  GETTABLEKS R9 R10 K8 ["COMPLETED"]
  JUMPIFNOTEQ R7 R9 [+5]
  GETTABLEKS R9 R6 K10 ["prompt"]
  ORK R8 R9 K9 [""]
  JUMP [+12]
  GETTABLEKS R9 R6 K11 ["message"]
  JUMPIFNOT R9 [+3]
  GETTABLEKS R8 R6 K11 ["message"]
  JUMP [+6]
  GETTABLEKS R9 R6 K12 ["errors"]
  JUMPIFNOT R9 [+3]
  GETTABLEKS R9 R6 K12 ["errors"]
  GETTABLEN R8 R9 1
  GETTABLEKS R9 R6 K13 ["textureIds"]
  GETTABLEKS R10 R6 K14 ["meshParts"]
  GETUPVAL R12 0
  GETTABLEKS R11 R12 K15 ["useMemo"]
  NEWCLOSURE R12 P0
  CAPTURE VAL R10
  CAPTURE VAL R9
  CAPTURE UPVAL U7
  ...
  MOVE R15 R12
  CALL R13 2 1
  GETTABLEKS R14 R6 K16 ["rotation"]
  GETUPVAL R16 0
  GETTABLEKS R15 R16 K15 ["useMemo"]
  NEWCLOSURE R16 P2
  CAPTURE VAL R14
  CAPTURE UPVAL U6
  NEWTABLE R17 0 1
  ...
  CALL R15 2 1
  GETUPVAL R16 13
  LOADK R18 K17 ["GenerationCard"]
  NAMECALL R16 R16 K1 ["use"]
  CALL R16 2 1
  GETUPVAL R18 0
  GETTABLEKS R17 R18 K18 ["createElement"]
  GETUPVAL R18 14
  DUPTABLE R19 K24 [{"AutomaticSize", "HorizontalAlignment", "Layout", "Padding", "VerticalAlignment"}]
  GETIMPORT R20 K27 [Enum.AutomaticSize.Y]
  SETTABLEKS R20 R19 K19 ["AutomaticSize"]
  GETIMPORT R20 K29 [Enum.HorizontalAlignment.Left]
  SETTABLEKS R20 R19 K20 ["HorizontalAlignment"]
  GETIMPORT R20 K32 [Enum.FillDirection.Horizontal]
  SETTABLEKS R20 R19 K21 ["Layout"]
  GETTABLEKS R20 R16 K22 ["Padding"]
  SETTABLEKS R20 R19 K22 ["Padding"]
  GETIMPORT R20 K34 [Enum.VerticalAlignment.Center]
  SETTABLEKS R20 R19 K23 ["VerticalAlignment"]
  DUPTABLE R20 K38 [{"InstanceView", "PromptLabel", "Button"}]
  JUMPIFNOT R11 [+45]
  GETUPVAL R22 0
  GETTABLEKS R21 R22 K18 ["createElement"]
  GETUPVAL R22 15
  DUPTABLE R23 K47 [{"LayoutOrder", "Model", "Size", "Static", "BackgroundColor3", "FocusDirection", "LightColor", "LightDirection"}]
  NAMECALL R24 R4 K48 ["getNextOrder"]
  CALL R24 1 1
  SETTABLEKS R24 R23 K39 ["LayoutOrder"]
  SETTABLEKS R11 R23 K40 ["Model"]
  GETTABLEKS R24 R16 K49 ["InstanceViewSize"]
  SETTABLEKS R24 R23 K41 ["Size"]
  LOADB R24 1
  SETTABLEKS R24 R23 K42 ["Static"]
  GETTABLEKS R24 R16 K50 ["BackgroundColor"]
  SETTABLEKS R24 R23 K43 ["BackgroundColor3"]
  SETTABLEKS R15 R23 K44 ["FocusDirection"]
  GETIMPORT R24 K52 [Color3.new]
  LOADN R25 1
  LOADN R26 1
  LOADN R27 1
  CALL R24 3 1
  SETTABLEKS R24 R23 K45 ["LightColor"]
  LOADN R26 1
  LOADN R27 1
  LOADN R28 1
  FASTCALL VECTOR [+2]
  GETIMPORT R25 K54 [Vector3.new]
  CALL R25 3 1
  MINUS R24 R25
  SETTABLEKS R24 R23 K46 ["LightDirection"]
  CALL R21 2 1
  JUMP [+1]
  LOADNIL R21
  SETTABLEKS R21 R20 K35 ["InstanceView"]
  GETUPVAL R22 0
  GETTABLEKS R21 R22 K18 ["createElement"]
  GETUPVAL R22 16
  DUPTABLE R23 K61 [{"LayoutOrder", "Size", "Style", "Text", "TextTruncate", "TextXAlignment", "TextYAlignment", "TextWrapped"}]
  NAMECALL R24 R4 K48 ["getNextOrder"]
  CALL R24 1 1
  SETTABLEKS R24 R23 K39 ["LayoutOrder"]
  GETTABLEKS R24 R16 K62 ["PromptLabelSize"]
  SETTABLEKS R24 R23 K41 ["Size"]
  GETUPVAL R27 6
  GETTABLEKS R26 R27 K7 ["STATUS"]
  GETTABLEKS R25 R26 K63 ["FAILED"]
  JUMPIFNOTEQ R7 R25 [+3]
  LOADK R24 K64 ["Warning"]
  JUMP [+1]
  LOADNIL R24
  SETTABLEKS R24 R23 K55 ["Style"]
  SETTABLEKS R8 R23 K56 ["Text"]
  GETIMPORT R24 K66 [Enum.TextTruncate.AtEnd]
  SETTABLEKS R24 R23 K57 ["TextTruncate"]
  GETIMPORT R24 K67 [Enum.TextXAlignment.Left]
  SETTABLEKS R24 R23 K58 ["TextXAlignment"]
  GETIMPORT R24 K68 [Enum.TextYAlignment.Center]
  SETTABLEKS R24 R23 K59 ["TextYAlignment"]
  LOADB R24 1
  SETTABLEKS R24 R23 K60 ["TextWrapped"]
  CALL R21 2 1
  SETTABLEKS R21 R20 K36 ["PromptLabel"]
  GETUPVAL R22 0
  GETTABLEKS R21 R22 K18 ["createElement"]
  GETUPVAL R22 14
  DUPTABLE R23 K70 [{"LayoutOrder", "Size", "OnClick"}]
  NAMECALL R24 R4 K48 ["getNextOrder"]
  CALL R24 1 1
  SETTABLEKS R24 R23 K39 ["LayoutOrder"]
  GETTABLEKS R24 R16 K71 ["MenuButtonSize"]
  SETTABLEKS R24 R23 K41 ["Size"]
  NEWCLOSURE R24 P3
  CAPTURE VAL R7
  CAPTURE UPVAL U6
  ...
  CAPTURE VAL R3
  CAPTURE VAL R13
  SETTABLEKS R24 R23 K69 ["OnClick"]
  DUPTABLE R24 K73 [{"Icon"}]
  GETUPVAL R28 6
  GETTABLEKS R27 R28 K7 ["STATUS"]
  GETTABLEKS R26 R27 K63 ["FAILED"]
  JUMPIFNOTEQ R7 R26 [+35]
  GETUPVAL R26 0
  GETTABLEKS R25 R26 K18 ["createElement"]
  GETUPVAL R26 18
  DUPTABLE R27 K77 [{"AnchorPoint", "Image", "Position", "Size", "Style"}]
  GETIMPORT R28 K79 [Vector2.new]
  LOADK R29 K80 [0.5]
  LOADK R30 K80 [0.5]
  CALL R28 2 1
  SETTABLEKS R28 R27 K74 ["AnchorPoint"]
  LOADK R28 K81 ["rbxasset://textures/DeveloperFramework/close.png"]
  SETTABLEKS R28 R27 K75 ["Image"]
  GETIMPORT R28 K84 [UDim2.fromScale]
  LOADK R29 K80 [0.5]
  LOADK R30 K80 [0.5]
  CALL R28 2 1
  SETTABLEKS R28 R27 K76 ["Position"]
  GETIMPORT R28 K86 [UDim2.fromOffset]
  LOADN R29 16
  LOADN R30 16
  CALL R28 2 1
  SETTABLEKS R28 R27 K41 ["Size"]
  LOADK R28 K87 ["ColoredWarning"]
  SETTABLEKS R28 R27 K55 ["Style"]
  CALL R25 2 1
  JUMP [+30]
  GETUPVAL R26 0
  GETTABLEKS R25 R26 K18 ["createElement"]
  GETUPVAL R26 18
  DUPTABLE R27 K88 [{"AnchorPoint", "Image", "Position", "Size"}]
  GETIMPORT R28 K79 [Vector2.new]
  LOADK R29 K80 [0.5]
  LOADK R30 K80 [0.5]
  CALL R28 2 1
  SETTABLEKS R28 R27 K74 ["AnchorPoint"]
  LOADK R28 K89 ["rbxasset://textures/StudioSharedUI/MeatballMenu.png"]
  SETTABLEKS R28 R27 K75 ["Image"]
  GETIMPORT R28 K84 [UDim2.fromScale]
  LOADK R29 K80 [0.5]
  LOADK R30 K80 [0.5]
  ...
  SETTABLEKS R28 R27 K41 ["Size"]
  CALL R25 2 1
  SETTABLEKS R25 R24 K72 ["Icon"]
  CALL R21 3 1
  SETTABLEKS R21 R20 K37 ["Button"]
  CALL R17 3 -1
  RETURN R17 -1
...
MAIN:
  ...
  GETTABLEKS R11 R7 K20 ["Pane"]
  GETTABLEKS R12 R7 K21 ["showContextMenu"]
  GETTABLEKS R13 R7 K22 ["TextLabel"]
  GETTABLEKS R14 R7 K23 ["TimeProgressBar"]
  GETTABLEKS R16 R2 K24 ["Util"]
  GETTABLEKS R15 R16 K25 ["StyleModifier"]
  GETTABLEKS R17 R2 K24 ["Util"]
  GETTABLEKS R16 R17 K26 ["LayoutOrderIterator"]
  GETTABLEKS R18 R2 K13 ["ContextServices"]
  GETTABLEKS R17 R18 K27 ["Stylizer"]
  GETTABLEKS R19 R0 K28 ["Src"]
  GETTABLEKS R18 R19 K29 ["Hooks"]
  GETIMPORT R19 K9 [require]
  GETTABLEKS R20 R18 K30 ["useSelectedMeshParts"]
  CALL R19 1 1
  ...
  GETTABLEKS R24 R0 K28 ["Src"]
  GETTABLEKS R23 R24 K24 ["Util"]
  GETTABLEKS R22 R23 K32 ["GenerationsContext"]
  CALL R21 1 1
  GETIMPORT R22 K9 [require]
  GETTABLEKS R25 R0 K28 ["Src"]
  GETTABLEKS R24 R25 K24 ["Util"]
  GETTABLEKS R23 R24 K33 ["SelectionWrapper"]
  CALL R22 1 1
