...
PROTO_5:
  ...
  JUMPIFNOT R2 [+90]
  GETUPVAL R2 7
  LOADK R4 K47 ["ExportGeneratedTexture"]
  GETUPVAL R6 2
  GETTABLEKS R5 R6 K48 ["serverId"]
  GETUPVAL R7 2
  GETTABLEKS R6 R7 K49 ["meshParts"]
  GETUPVAL R8 2
  GETTABLEKS R7 R8 K50 ["prompt"]
  GETUPVAL R9 2
  GETTABLEKS R8 R9 K51 ["seed"]
  GETUPVAL R10 2
  GETTABLEKS R9 R10 K52 ["rotation"]
  GETUPVAL R11 2
  GETTABLEKS R10 R11 K53 ["smartUVUnwrap"]
  GETUPVAL R12 2
  GETTABLEKS R11 R12 K54 ["promptMasking"]
  GETUPVAL R13 2
  GETTABLEKS R12 R13 K13 ["textureIds"]
  ...
  GETTABLEKS R3 R4 K59 ["uuid"]
  SETTABLEKS R3 R2 K59 ["uuid"]
  CALL R1 1 0
  GETUPVAL R1 6
  CALL R1 0 1
  JUMPIFNOT R1 [+29]
  GETUPVAL R1 7
  LOADK R3 K63 ["RemoveGeneratedTexture"]
  GETUPVAL R5 2
  GETTABLEKS R4 R5 K48 ["serverId"]
  GETUPVAL R6 2
  GETTABLEKS R5 R6 K49 ["meshParts"]
  GETUPVAL R7 2
  GETTABLEKS R6 R7 K50 ["prompt"]
  GETUPVAL R8 2
  GETTABLEKS R7 R8 K51 ["seed"]
  GETUPVAL R9 2
  GETTABLEKS R8 R9 K52 ["rotation"]
  GETUPVAL R10 2
  GETTABLEKS R9 R10 K53 ["smartUVUnwrap"]
  GETUPVAL R11 2
  GETTABLEKS R10 R11 K54 ["promptMasking"]
  GETUPVAL R12 2
  GETTABLEKS R11 R12 K13 ["textureIds"]
...
PROTO_9:
  ...
  GETUPVAL R6 1
  GETTABLEKS R5 R6 K0 ["Generation"]
...
MAIN:
  ...
  CALL R28 1 1
  DUPCLOSURE R29 K42 [PROTO_0]
  CAPTURE VAL R20
  DUPCLOSURE R30 K43 [PROTO_2]
  CAPTURE VAL R3
  CAPTURE VAL R23
  DUPCLOSURE R31 K44 [PROTO_3]
  DUPCLOSURE R32 K45 [PROTO_4]
  CAPTURE VAL R6
  CAPTURE VAL R16
  CAPTURE VAL R17
  CAPTURE VAL R3
