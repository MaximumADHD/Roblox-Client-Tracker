PROTO_0:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["_pointLocationData"]
        3 RETURN                           R0 1
...
PROTO_2:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["_refreshingCount"]
        3 JUMPIFNOTEQKN                    R0 K1 [0] ; [+23]
        5 GETUPVAL                         R0 0
        6 GETTABLEKS                       R0 R0 K2 ["_pointLocationData"]
        8 JUMPIFNOT                        R0 ; [+7]
        9 GETUPVAL                         R0 0
       10 GETUPVAL                         R2 0
       11 GETTABLEKS                       R2 R2 K2 ["_pointLocationData"]
       13 NAMECALL                         R0 R0 K3 ["addWaypoint"]
       15 CALL                             R0 2 0
       16 GETUPVAL                         R0 0
       17 GETUPVAL                         R2 1
       18 GETTABLEKS                       R2 R2 K4 ["getDedupedPositionsFromContext"]
       20 GETUPVAL                         R3 0
       21 GETTABLEKS                       R3 R3 K5 ["_meshEditingContext"]
       23 CALL                             R2 1 -1
...
PROTO_3:
       ...
       40 GETUPVAL                         R2 2
       41 GETTABLEKS                       R2 R2 K11 ["getDedupedPositionsFromContext"]
       ...
       72 GETTABLEKS                       R2 R1 K2 ["_meshEditingContext"]
       74 GETTABLEKS                       R2 R2 K18 ["meshDataChanged"]
       76 NEWCLOSURE                       R4 P2
       77 CAPTURE                          VAL R1
       78 CAPTURE                          UPVAL U2
...
PROTO_15:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["_updateSelectedPointTask"]
        3 GETUPVAL                         R1 1
...
PROTO_17:
       ...
       32 MOVE                             R7 R4
       33 MOVE                             R8 R3
       34 GETTABLEKS                       R9 R0 K6 ["_pointLocationData"]
       36 GETTABLEKS                       R9 R9 K11 ["VertexData"]
...
PROTO_20:
        ...
        4 LOADNIL                          R1
        5 RETURN                           R1 1
        6 GETTABLEKS                       R1 R0 K0 ["_dummy"]
        8 GETTABLEKS                       R1 R1 K1 ["PrimaryPart"]
...
PROTO_21:
        0 GETUPVAL                         R3 0
        1 GETTABLEKS                       R3 R3 K0 ["applyTransformControlPoints"]
       ...
       10 CALL                             R3 4 1
       11 GETUPVAL                         R4 0
       12 GETTABLEKS                       R4 R4 K0 ["applyTransformControlPoints"]
       ...
       21 CALL                             R4 4 1
       22 GETUPVAL                         R5 0
       23 GETTABLEKS                       R5 R5 K5 ["getTransformedPoints"]
...
MAIN:
       ...
       25 GETTABLEKS                       R4 R4 K11 ["Signal"]
       27 CALL                             R3 1 1
       28 GETIMPORT                        R4 K5 [require]
       30 GETTABLEKS                       R5 R0 K10 ["Util"]
       32 GETTABLEKS                       R5 R5 K12 ["TransformPointsHelpers"]
       34 CALL                             R4 1 1
       ...
       44 GETTABLEKS                       R7 R7 K15 ["VertexToolBaseUtils"]
       46 CALL                             R6 1 1
       47 GETIMPORT                        R7 K5 [require]
       49 GETTABLEKS                       R8 R0 K14 ["Tools"]
       51 GETTABLEKS                       R8 R8 K16 ["VertexToolUndoStack"]
       53 CALL                             R7 1 1
       54 GETIMPORT                        R8 K5 [require]
       56 GETTABLEKS                       R9 R0 K10 ["Util"]
       58 GETTABLEKS                       R9 R9 K17 ["applySymmetryMap"]
       60 CALL                             R8 1 1
       61 GETIMPORT                        R9 K5 [require]
       63 GETTABLEKS                       R10 R0 K10 ["Util"]
       65 GETTABLEKS                       R10 R10 K18 ["softSelectPoints"]
       67 CALL                             R9 1 1
