...
MAIN:
  ...
  GETTABLEKS R17 R18 K27 ["DEPRECATED_StudioAssetServiceWrapper"]
  CALL R16 1 1
  ...
  GETTABLEKS R19 R20 K30 ["DEPRECATED_PlacesServiceWrapper"]
  CALL R18 1 1
  GETIMPORT R19 K12 [require]
  GETTABLEKS R22 R4 K25 ["Src"]
  GETTABLEKS R21 R22 K26 ["Util"]
  GETTABLEKS R20 R21 K31 ["SelectionWrapper"]
  CALL R19 1 1
  GETIMPORT R20 K12 [require]
  GETTABLEKS R23 R4 K25 ["Src"]
  GETTABLEKS R22 R23 K26 ["Util"]
  GETTABLEKS R21 R22 K32 ["UGCValidationContext"]
  CALL R20 1 1
  GETIMPORT R21 K12 [require]
  GETTABLEKS R24 R4 K25 ["Src"]
  GETTABLEKS R23 R24 K28 ["Resources"]
  GETTABLEKS R22 R23 K33 ["createAnalyticsHandlers"]
  CALL R21 1 1
  GETTABLEKS R25 R4 K25 ["Src"]
  GETTABLEKS R24 R25 K28 ["Resources"]
  GETTABLEKS R23 R24 K34 ["Localization"]
  GETTABLEKS R22 R23 K35 ["SourceStrings"]
  GETTABLEKS R26 R4 K25 ["Src"]
  GETTABLEKS R25 R26 K28 ["Resources"]
  GETTABLEKS R24 R25 K34 ["Localization"]
  GETTABLEKS R23 R24 K36 ["LocalizedStrings"]
  GETTABLEKS R25 R4 K25 ["Src"]
  GETTABLEKS R24 R25 K37 ["Components"]
  GETIMPORT R25 K12 [require]
  GETTABLEKS R26 R24 K38 ["App"]
  CALL R25 1 1
  GETIMPORT R26 K12 [require]
  GETTABLEKS R27 R24 K39 ["TestInExperienceManager"]
  CALL R26 1 1
  GETIMPORT R27 K12 [require]
  GETTABLEKS R30 R4 K25 ["Src"]
  GETTABLEKS R29 R30 K40 ["Flags"]
  GETTABLEKS R28 R29 K41 ["getFFlagAvatarPreviewerMultiSubmit"]
  CALL R27 1 1
  GETIMPORT R28 K12 [require]
  GETTABLEKS R31 R4 K25 ["Src"]
  GETTABLEKS R30 R31 K40 ["Flags"]
  GETTABLEKS R29 R30 K42 ["getFFlagAvatarPreviewerTestingScreen"]
  CALL R28 1 1
  GETIMPORT R29 K12 [require]
  GETTABLEKS R32 R4 K25 ["Src"]
  GETTABLEKS R31 R32 K40 ["Flags"]
  GETTABLEKS R30 R31 K43 ["getFFlagAvatarPreviewerUGCValidationNotice"]
  CALL R29 1 1
  GETIMPORT R30 K12 [require]
  GETTABLEKS R33 R4 K25 ["Src"]
  GETTABLEKS R32 R33 K40 ["Flags"]
  GETTABLEKS R31 R32 K44 ["getFFlagImporterOpensAvatarPreviewer2"]
  CALL R30 1 1
  GETIMPORT R31 K12 [require]
  GETTABLEKS R34 R4 K25 ["Src"]
  GETTABLEKS R33 R34 K40 ["Flags"]
  GETTABLEKS R32 R33 K45 ["getFFlagImporterOpensAvatarPreviewerBetaCheck"]
  CALL R31 1 1
  GETTABLEKS R32 R7 K46 ["PureComponent"]
  ...
  CAPTURE VAL R7
  CAPTURE VAL R11
  SETTABLEKS R33 R32 K52 ["renderButtons"]
  MOVE R33 R30
  CALL R33 0 1
  JUMPIFNOT R33 [+6]
  MOVE R33 R31
  ...
  SETTABLEKS R33 R32 K54 ["willUnmount"]
