...
MAIN:
  ...
  GETTABLEKS R29 R30 K42 ["getFFlagImporterOpensAvatarPreviewer2"]
  CALL R28 1 1
  GETIMPORT R29 K12 [require]
  GETTABLEKS R32 R4 K25 ["Src"]
  GETTABLEKS R31 R32 K39 ["Flags"]
  GETTABLEKS R30 R31 K43 ["getFFlagImporterOpensAvatarPreviewerBetaCheck"]
  CALL R29 1 1
  GETTABLEKS R30 R7 K44 ["PureComponent"]
  LOADK R32 K45 ["MainPlugin"]
  NAMECALL R30 R30 K46 ["extend"]
  CALL R30 2 1
  DUPCLOSURE R31 K47 [PROTO_6]
  CAPTURE VAL R13
  CAPTURE VAL R21
  CAPTURE VAL R22
  CAPTURE VAL R28
  ...
  CAPTURE VAL R7
  CAPTURE VAL R11
  SETTABLEKS R31 R30 K50 ["renderButtons"]
  MOVE R31 R28
  CALL R31 0 1
  JUMPIFNOT R31 [+6]
  MOVE R31 R29
