...
MAIN:
  ...
  GETTABLEKS R12 R13 K21 ["EquipmentStateContext"]
  CALL R11 1 1
  GETIMPORT R12 K5 [require]
  GETIMPORT R15 K1 [script]
  GETTABLEKS R14 R15 K22 ["Parent"]
  GETTABLEKS R13 R14 K23 ["StageType"]
  CALL R12 1 1
  GETTABLEKS R14 R1 K24 ["ContextServices"]
  GETTABLEKS R13 R14 K25 ["Localization"]
  DUPTABLE R14 K29 [{"tabs", "render", "getPreviewCameraModifications"}]
  MOVE R16 R6
  CALL R16 0 1
  JUMPIFNOT R16 [+7]
  NEWTABLE R15 0 2
  LOADK R16 K30 ["animations_face"]
  LOADK R17 K31 ["accessories_face"]
  SETLIST R15 R16 2 [1]
  JUMP [+5]
  NEWTABLE R15 0 1
  LOADK R16 K32 ["face"]
  SETLIST R15 R16 1 [1]
  SETTABLEKS R15 R14 K26 ["tabs"]
