PROTO_0:
        ...
        3 GETUPVAL                         R5 1
        4 GETUPVAL                         R6 2
        5 GETTABLEKS                       R6 R6 K1 ["Avatar"]
        7 GETTABLEKS                       R6 R6 K2 ["WorldModel"]
        9 CALL                             R5 1 1
       10 GETUPVAL                         R6 3
...
PROTO_1:
       ...
       12 GETTABLEKS                       R4 R4 K3 ["WorldModel"]
       14 CALL                             R3 1 1
       15 GETUPVAL                         R4 3
       16 GETTABLEKS                       R5 R0 K2 ["Avatar"]
       18 GETTABLEKS                       R5 R5 K3 ["WorldModel"]
       20 LOADK                            R6 K4 ["completedAutoSetupSurvey"]
       21 LOADB                            R7 0
       22 CALL                             R4 3 2
       23 GETUPVAL                         R6 3
       24 GETTABLEKS                       R7 R0 K2 ["Avatar"]
       26 GETTABLEKS                       R7 R7 K3 ["WorldModel"]
       28 GETUPVAL                         R8 4
       29 GETTABLEKS                       R8 R8 K5 ["ATTRIBUTE_AUTO_SETUP_INPUT_ASSET"]
       31 LOADNIL                          R9
       32 CALL                             R6 3 1
       33 GETUPVAL                         R7 5
       34 LOADB                            R8 0
       35 CALL                             R7 1 1
       36 GETUPVAL                         R8 6
       37 GETTABLEKS                       R8 R8 K6 ["useCallback"]
       39 NEWCLOSURE                       R9 P0
       40 CAPTURE                          VAL R1
       41 CAPTURE                          UPVAL U7
       42 CAPTURE                          VAL R0
       ...
       54 GETUPVAL                         R10 6
       55 GETTABLEKS                       R10 R10 K8 ["Fragment"]
       57 NEWTABLE                         R11 0 0
      ...
      107 GETUPVAL                         R16 6
      108 GETTABLEKS                       R16 R16 K25 ["Event"]
      110 GETTABLEKS                       R16 R16 K26 ["Activated"]
...
MAIN:
       ...
       52 GETTABLEKS                       R7 R7 K16 ["useCreatedByAutoSetup"]
       54 CALL                             R6 1 1
       55 GETIMPORT                        R7 K5 [require]
       57 GETTABLEKS                       R8 R0 K9 ["Src"]
       59 GETTABLEKS                       R8 R8 K15 ["Hooks"]
       61 GETTABLEKS                       R8 R8 K17 ["useSerializedState"]
       63 CALL                             R7 1 1
       64 GETIMPORT                        R8 K5 [require]
       66 GETTABLEKS                       R9 R0 K9 ["Src"]
       68 GETTABLEKS                       R9 R9 K15 ["Hooks"]
       70 GETTABLEKS                       R9 R9 K18 ["useToggleState"]
       72 CALL                             R8 1 1
       ...
       88 GETTABLEKS                       R11 R11 K21 ["findUnderlyingMeshAssetIds"]
       90 CALL                             R10 1 1
       91 GETTABLEKS                       R11 R1 K22 ["ContextServices"]
       93 GETTABLEKS                       R11 R11 K23 ["Analytics"]
       95 GETTABLEKS                       R12 R1 K22 ["ContextServices"]
       97 GETTABLEKS                       R12 R12 K24 ["Stylizer"]
