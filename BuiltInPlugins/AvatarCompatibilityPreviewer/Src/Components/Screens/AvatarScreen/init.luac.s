...
MAIN:
  ...
  GETTABLEKS R45 R46 K56 ["getFFlagAvatarPreviewerPickTabsMenu"]
  CALL R44 1 1
  GETIMPORT R45 K5 [require]
  GETTABLEKS R48 R0 K17 ["Src"]
  GETTABLEKS R47 R48 K53 ["Flags"]
  GETTABLEKS R46 R47 K57 ["getFFlagAvatarPreviewerReorganizeCheckFace"]
  CALL R45 1 1
  ...
  CAPTURE VAL R21
  GETIMPORT R49 K62 [pcall]
  DUPCLOSURE R50 K63 [PROTO_1]
  CALL R49 1 1
  DUPCLOSURE R50 K64 [PROTO_2]
  CAPTURE VAL R32
  CAPTURE VAL R34
  CAPTURE VAL R43
  CAPTURE VAL R28
  DUPCLOSURE R51 K65 [PROTO_11]
  CAPTURE VAL R8
  CAPTURE VAL R3
  CAPTURE VAL R38
  CAPTURE VAL R39
