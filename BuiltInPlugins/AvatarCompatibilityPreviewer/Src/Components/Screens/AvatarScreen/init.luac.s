...
PROTO_11:
  ...
  GETTABLEKS R36 R37 K22 ["createElement"]
  GETUPVAL R37 25
  DUPTABLE R38 K59 [{"SelectedTab", "SelectedPalette", "SetSelectedPalette", "ScrollingFrameProps"}]
  SETTABLEKS R7 R38 K52 ["SelectedTab"]
...
MAIN:
  ...
  GETTABLEKS R45 R46 K56 ["getFFlagAvatarPreviewerReorganizeCheckFace"]
  CALL R44 1 1
  GETIMPORT R45 K5 [require]
  GETTABLEKS R48 R0 K17 ["Src"]
  GETTABLEKS R47 R48 K53 ["Flags"]
  GETTABLEKS R46 R47 K57 ["getFFlagAvatarPreviewerTestWithAssets"]
  CALL R45 1 1
  GETIMPORT R46 K5 [require]
  GETTABLEKS R49 R0 K17 ["Src"]
  GETTABLEKS R48 R49 K53 ["Flags"]
  GETTABLEKS R47 R48 K58 ["getFFlagAvatarPreviewerSkinToneAlphaDetection"]
  CALL R46 1 1
  DUPCLOSURE R47 K59 [PROTO_0]
  CAPTURE VAL R21
  GETIMPORT R48 K61 [pcall]
  DUPCLOSURE R49 K62 [PROTO_1]
  CALL R48 1 1
  DUPCLOSURE R49 K63 [PROTO_2]
  CAPTURE VAL R32
  CAPTURE VAL R34
  CAPTURE VAL R43
  CAPTURE VAL R28
  DUPCLOSURE R50 K64 [PROTO_11]
  CAPTURE VAL R8
  CAPTURE VAL R3
  CAPTURE VAL R38
  CAPTURE VAL R39
