...
PROTO_11:
  ...
  GETUPVAL R42 27
  DUPTABLE R43 K91 [{"Dummy", "Avatar", "RevertToDefault", "Textured", "SetTextured", "ResetCameraSignal"}]
  ...
  GETTABLEKS R44 R4 K17 ["isTextured"]
  SETTABLEKS R44 R43 K88 ["Textured"]
  GETTABLEKS R44 R4 K92 ["setIsTextured"]
  SETTABLEKS R44 R43 K89 ["SetTextured"]
  GETTABLEKS R44 R19 K20 ["current"]
  SETTABLEKS R44 R43 K90 ["ResetCameraSignal"]
  CALL R41 2 1
  SETTABLEKS R41 R39 K93 ["DummyPreview"]
  GETUPVAL R42 1
  GETTABLEKS R41 R42 K22 ["createElement"]
  GETUPVAL R42 28
  DUPTABLE R43 K94 [{"Avatar"}]
  SETTABLEKS R6 R43 K5 ["Avatar"]
  CALL R41 2 1
  SETTABLEKS R41 R39 K95 ["UGCValidationNotice"]
  GETTABLEKS R41 R4 K4 ["stage"]
  JUMPIFNOTEQKS R41 K96 ["CheckBody"] [+20]
  GETUPVAL R41 1
  GETTABLEKS R40 R41 K22 ["createElement"]
  GETUPVAL R43 4
  GETTABLEKS R42 R43 K96 ["CheckBody"]
  GETTABLEKS R41 R42 K97 ["render"]
  DUPTABLE R42 K98 [{"Avatar", "Dummy", "SelectedTab"}]
  ...
  JUMP [+31]
  GETTABLEKS R41 R4 K4 ["stage"]
  JUMPIFNOTEQKS R41 K99 ["CheckFace"] [+18]
  GETUPVAL R41 1
  GETTABLEKS R40 R41 K22 ["createElement"]
  GETUPVAL R43 4
  GETTABLEKS R42 R43 K99 ["CheckFace"]
  GETTABLEKS R41 R42 K97 ["render"]
  DUPTABLE R42 K100 [{"Avatar", "Dummy"}]
  GETTABLEKS R43 R0 K5 ["Avatar"]
  SETTABLEKS R43 R42 K5 ["Avatar"]
  SETTABLEKS R18 R42 K86 ["Dummy"]
  CALL R40 2 1
  ...
  SETTABLEKS R44 R43 K5 ["Avatar"]
  CALL R41 2 1
  SETTABLEKS R41 R39 K105 ["ContextualSurveyDialogButton"]
  CALL R36 3 1
  ...
  GETTABLEKS R24 R25 K22 ["createElement"]
  GETUPVAL R25 31
  DUPTABLE R26 K107 [{"WorldModel", "Dummy", "UpdateHumanoidDescription"}]
  ...
  JUMP [+1]
  LOADNIL R27
  SETTABLEKS R27 R26 K106 ["UpdateHumanoidDescription"]
  CALL R24 2 1
  SETTABLEKS R24 R23 K108 ["InitialImport"]
  GETUPVAL R26 18
  GETTABLEKS R25 R26 K109 ["EDITING_TOOLS_GUI_NAMES"]
  GETTABLEKS R24 R25 K110 ["EditingToolbar"]
  GETUPVAL R25 33
  CALL R25 0 1
  JUMPIFNOT R25 [+10]
  GETUPVAL R25 34
  ...
  GETUPVAL R26 35
  DUPTABLE R27 K112 [{"worldModel"}]
  SETTABLEKS R6 R27 K111 ["worldModel"]
  CALL R25 2 1
  ...
  GETTABLEKS R24 R25 K22 ["createElement"]
  GETUPVAL R25 36
  DUPTABLE R26 K114 [{"providers"}]
  NEWTABLE R27 0 2
  GETUPVAL R29 1
  GETTABLEKS R28 R29 K22 ["createElement"]
  GETUPVAL R30 37
  GETTABLEKS R29 R30 K115 ["Provider"]
  DUPTABLE R30 K118 [{"openPalette", "value"}]
  LOADN R31 3
  SETTABLEKS R31 R30 K116 ["openPalette"]
  DUPTABLE R31 K125 [{"openPalette", "focusedAttachments", "setFocusedAttachments", "dummyPreviewLocked", "incrementDummyPreviewLock", "decrementDummyPreviewLock", "resetCamera", "stage"}]
  ...
  JUMP [+1]
  LOADNIL R32
  SETTABLEKS R32 R31 K119 ["focusedAttachments"]
  GETUPVAL R33 15
  JUMPIFNOT R33 [+2]
  MOVE R32 R14
  JUMP [+1]
  LOADNIL R32
  SETTABLEKS R32 R31 K120 ["setFocusedAttachments"]
  ...
  GETUPVAL R31 38
  GETTABLEKS R30 R31 K115 ["Provider"]
  CALL R29 1 -1
  SETLIST R27 R28 -1 [1]
  SETTABLEKS R27 R26 K113 ["providers"]
  MOVE R27 R23
  CALL R24 3 -1
  RETURN R24 -1
  GETUPVAL R25 1
  ...
  DUPTABLE R26 K114 [{"providers"}]
  NEWTABLE R27 0 2
  DUPTABLE R28 K130 [{"provider", "value"}]
  GETUPVAL R30 37
  GETTABLEKS R29 R30 K115 ["Provider"]
  SETTABLEKS R29 R28 K129 ["provider"]
  DUPTABLE R29 K131 [{"openPalette", "resetCamera", "stage", "dummyPreviewLocked", "incrementDummyPreviewLock", "decrementDummyPreviewLock"}]
  SETTABLEKS R12 R29 K116 ["openPalette"]
  SETTABLEKS R20 R29 K124 ["resetCamera"]
  SETTABLEKS R5 R29 K4 ["stage"]
  GETTABLEKS R31 R21 K126 ["amount"]
  LOADN R32 0
  JUMPIFLT R32 R31 [+2]
  LOADB R30 0 +1
  LOADB R30 1
  SETTABLEKS R30 R29 K121 ["dummyPreviewLocked"]
  GETTABLEKS R30 R21 K127 ["increment"]
  SETTABLEKS R30 R29 K122 ["incrementDummyPreviewLock"]
  GETTABLEKS R30 R21 K128 ["decrement"]
  SETTABLEKS R30 R29 K123 ["decrementDummyPreviewLock"]
  SETTABLEKS R29 R28 K117 ["value"]
  DUPTABLE R29 K132 [{"provider"}]
  GETUPVAL R31 38
  GETTABLEKS R30 R31 K115 ["Provider"]
  SETTABLEKS R30 R29 K129 ["provider"]
  SETLIST R27 R28 2 [1]
  SETTABLEKS R27 R26 K113 ["providers"]
  MOVE R27 R23
  CALL R24 3 -1
...
MAIN:
  ...
  GETTABLEKS R42 R43 K54 ["getFFlagAvatarPreviewerEditingTools"]
  CALL R41 1 1
  MOVE R42 R41
  CALL R42 0 1
  ...
  GETTABLEKS R44 R45 K55 ["getFFlagAvatarPreviewerProportionControls"]
  CALL R43 1 1
  MOVE R44 R43
  CALL R44 0 1
  ...
  GETTABLEKS R46 R47 K56 ["getFFlagAvatarPreviewerTestWithAssets"]
  CALL R45 1 1
  DUPCLOSURE R46 K57 [PROTO_0]
  CAPTURE VAL R20
  GETIMPORT R47 K59 [pcall]
  DUPCLOSURE R48 K60 [PROTO_1]
  CALL R47 1 1
  DUPCLOSURE R48 K61 [PROTO_2]
  CAPTURE VAL R31
  CAPTURE VAL R33
  CAPTURE VAL R42
  CAPTURE VAL R44
  CAPTURE VAL R27
  DUPCLOSURE R49 K62 [PROTO_11]
  CAPTURE VAL R8
  CAPTURE VAL R3
  CAPTURE VAL R37
  CAPTURE VAL R38
