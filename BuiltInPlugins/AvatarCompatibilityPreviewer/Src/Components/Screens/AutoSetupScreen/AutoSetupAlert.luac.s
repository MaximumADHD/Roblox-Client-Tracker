...
"]
  ...
  GETUPVAL R6 3
  DUPTABLE R7 K22 [{"Title", "Description", "PrimaryAction"}]
  LOADK R10 K8 ["AvatarScreen"]
  LOADK R11 K23 ["AutoSetupInProgressTitle"]
  NAMECALL R8 R1 K10 ["getText"]
  CALL R8 3 1
  SETTABLEKS R8 R7 K19 ["Title"]
  SETTABLEKS R4 R7 K20 ["Description"]
  DUPTABLE R8 K26 [{"Text", "OnClick"}]
  LOADK R11 K8 ["AvatarScreen"]
  LOADK R12 K27 ["AutoSetupInProgressActionText"]
  NAMECALL R9 R1 K10 ["getText"]
  CALL R9 3 1
  SETTABLEKS R9 R8 K24 ["Text"]
  GETTABLEKS R10 R0 K28 ["cancelDialogOpen"]
  GETTABLEKS R9 R10 K29 ["enable"]
  SETTABLEKS R9 R8 K25 ["OnClick"]
  SETTABLEKS R8 R7 K21 ["PrimaryAction"]
  CALL R5 2 -1
  RETURN R5 -1
  GETTABLEKS R5 R0 K2 ["autoSetupState"]
  GETTABLEKS R4 R5 K3 ["type"]
  JUMPIFNOTEQKS R4 K30 ["error"] [+33]
  GETTABLEKS R4 R2 K29 ["enable"]
  JUMPIFNOT R4 [+29]
  GETUPVAL R5 2
  GETTABLEKS R4 R5 K18 ["createElement"]
  GETUPVAL R5 3
  DUPTABLE R6 K33 [{"Title", "Description", "Style", "OnClose"}]
  LOADK R9 K8 ["AvatarScreen"]
  LOADK R10 K34 ["AutoSetupErrorTitle"]
  NAMECALL R7 R1 K10 ["getText"]
  CALL R7 3 1
  SETTABLEKS R7 R6 K19 ["Title"]
  LOADK R9 K8 ["AvatarScreen"]
  GETTABLEKS R11 R0 K2 ["autoSetupState"]
  GETTABLEKS R10 R11 K30 ["error"]
  NAMECALL R7 R1 K10 ["getText"]
  CALL R7 3 1
  SETTABLEKS R7 R6 K20 ["Description"]
  LOADK R7 K35 ["Error"]
  SETTABLEKS R7 R6 K31 ["Style"]
  SETTABLEKS R3 R6 K32 ["OnClose"]
  CALL R4 2 -1
  RETURN R4 -1
  LOADNIL R4
  RETURN R4 1
