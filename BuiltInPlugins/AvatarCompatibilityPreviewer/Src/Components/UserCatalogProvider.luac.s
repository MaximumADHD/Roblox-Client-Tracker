...
PROTO_3:
  ...
  NAMECALL R9 R8 K3 ["FindFirstChild"]
  CALL R9 2 1
  JUMPIFEQKNIL R9 [+51]
  LOADK R12 K4 ["ObjectValue"]
  NAMECALL R10 R9 K5 ["IsA"]
  CALL R10 2 1
  JUMPIFNOT R10 [+45]
  LOADK R13 K4 ["ObjectValue"]
  NAMECALL R11 R9 K5 ["IsA"]
  CALL R11 2 1
  GETUPVAL R13 3
  GETTABLEKS R12 R13 K6 ["LUAU_ANALYZE_ERROR"]
  FASTCALL2 ASSERT R11 R12 [+3]
  GETIMPORT R10 K8 [assert]
  CALL R10 2 0
  GETTABLEKS R10 R9 K9 ["Value"]
  JUMPIFNOTEQ R10 R2 [+30]
  LOADK R12 K10 ["RBX_Palette"]
  NAMECALL R10 R8 K11 ["GetAttribute"]
  CALL R10 2 1
  GETTABLEKS R11 R1 K12 ["Key"]
  JUMPIFNOTEQ R10 R11 [+22]
  GETUPVAL R11 4
  GETTABLEKS R10 R11 K13 ["removeEquippedItem"]
  DUPTABLE R11 K16 [{"palette", "item"}]
  SETTABLEKS R1 R11 K14 ["palette"]
  DUPTABLE R12 K19 [{"source", "instance"}]
  GETUPVAL R14 3
  GETTABLEKS R13 R14 K20 ["SOURCE_INSTANCE"]
  SETTABLEKS R13 R12 K17 ["source"]
  SETTABLEKS R8 R12 K18 ["instance"]
  SETTABLEKS R12 R11 K15 ["item"]
  CALL R10 1 0
  NAMECALL R10 R8 K21 ["Destroy"]
  CALL R10 1 0
  JUMP [+2]
  FORGLOOP R4 2 [-59]
  GETIMPORT R4 K24 [Instance.new]
  LOADK R5 K4 ["ObjectValue"]
  CALL R4 1 1
  GETUPVAL R6 3
  GETTABLEKS R5 R6 K2 ["REFERENCE_VALUE_NAME"]
  SETTABLEKS R5 R4 K25 ["Name"]
  SETTABLEKS R2 R4 K9 ["Value"]
  SETTABLEKS R0 R4 K26 ["Parent"]
  LOADK R7 K10 ["RBX_Palette"]
  GETTABLEKS R8 R1 K12 ["Key"]
  NAMECALL R5 R0 K27 ["SetAttribute"]
  CALL R5 3 0
  GETUPVAL R5 5
  NAMECALL R5 R5 K28 ["GenerateGUID"]
  CALL R5 1 1
  SETTABLEKS R5 R0 K25 ["Name"]
  SETTABLEKS R3 R0 K26 ["Parent"]
  RETURN R0 0
...
PROTO_14:
  ...
  GETUPVAL R6 1
  NAMECALL R6 R6 K7 ["GetChildren"]
  CALL R6 1 1
  DUPCLOSURE R7 K8 [PROTO_12]
  CAPTURE UPVAL U6
  CALL R5 2 -1
  CALL R4 -1 0
  NEWCLOSURE R4 P5
...
PROTO_15:
  ...
  CAPTURE UPVAL U7
  NEWTABLE R10 0 1
  GETTABLEKS R11 R4 K8 ["removeEquippedItem"]
  SETLIST R10 R11 1 [1]
  CALL R8 2 1
  JUMP [+1]
  LOADNIL R8
  ...
  SETLIST R11 R12 1 [1]
  CALL R9 2 0
  DUPTABLE R9 K13 [{"equippableItems", "addNewItem", "removeItem"}]
  SETTABLEKS R5 R9 K10 ["equippableItems"]
  SETTABLEKS R7 R9 K11 ["addNewItem"]
  SETTABLEKS R8 R9 K12 ["removeItem"]
  GETUPVAL R11 0
  GETTABLEKS R10 R11 K14 ["createElement"]
  GETUPVAL R12 12
  GETTABLEKS R11 R12 K15 ["Provider"]
  DUPTABLE R12 K17 [{"value"}]
  SETTABLEKS R9 R12 K16 ["value"]
...
MAIN:
  ...
  GETTABLEKS R13 R14 K25 ["getFFlagAvatarPreviewerRemoveItemsFromPalette"]
  CALL R12 1 1
  GETIMPORT R13 K10 [require]
  GETTABLEKS R16 R2 K15 ["Src"]
  GETTABLEKS R15 R16 K24 ["Flags"]
  GETTABLEKS R14 R15 K26 ["getFFlagAvatarPreviewerUGCAvatarServiceContext"]
  CALL R13 1 1
  MOVE R14 R12
  CALL R14 0 1
  MOVE R15 R13
