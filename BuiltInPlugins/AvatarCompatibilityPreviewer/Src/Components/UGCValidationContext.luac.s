...
PROTO_10:
  ...
  CAPTURE UPVAL U3
  LOADNIL R6
  DUPTABLE R7 K10 [{"skipValidateHSR"}]
  LOADB R8 1
  SETTABLEKS R8 R7 K9 ["skipValidateHSR"]
  CALL R1 6 1
  NEWCLOSURE R3 P1
  CAPTURE UPVAL U4
  CAPTURE UPVAL U3
...
MAIN:
  ...
  CALL R7 3 1
  DUPTABLE R8 K22 [{"cachedResponses", "validateBundle"}]
  NEWTABLE R9 0 0
  SETTABLEKS R9 R8 K20 ["cachedResponses"]
  MOVE R9 R5
  LOADK R10 K21 ["validateBundle"]
  CALL R9 1 1
  SETTABLEKS R9 R8 K21 ["validateBundle"]
  GETTABLEKS R9 R2 K23 ["createContext"]
  MOVE R10 R8
  CALL R9 1 1
  DUPCLOSURE R10 K24 [PROTO_12]
  CAPTURE VAL R6
  CAPTURE VAL R2
  CAPTURE VAL R4
  CAPTURE VAL R3
