PROTO_0:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["DEFAULT_SKIN_TONE"]
        3 GETUPVAL                         R1 1
        4 LOADNIL                          R2
        5 LOADNIL                          R3
        6 FORGPREP                         R1
        7 GETTABLEKS                       R6 R5 K1 ["palette"]
        9 GETTABLEKS                       R6 R6 K2 ["Key"]
       11 JUMPIFNOTEQKS                    R6 K3 ["Skin"] ; [+15]
       13 GETTABLEKS                       R6 R5 K4 ["item"]
       15 GETTABLEKS                       R6 R6 K5 ["source"]
       17 GETUPVAL                         R7 0
       18 GETTABLEKS                       R7 R7 K6 ["SOURCE_BUILTIN"]
...
PROTO_1:
       ...
       22 RETURN                           R5 1
       23 GETUPVAL                         R5 4
       24 GETTABLEKS                       R5 R5 K6 ["DEFAULT_SKIN_TONE"]
       26 RETURN                           R5 1
       27 FORGLOOP                         R0 2 ; [-16]
       29 GETUPVAL                         R0 4
       30 GETTABLEKS                       R0 R0 K6 ["DEFAULT_SKIN_TONE"]
       32 RETURN                           R0 1
...
PROTO_2:
       ...
       16 CALL                             R4 1 2
       17 GETUPVAL                         R6 0
       18 GETTABLEKS                       R6 R6 K0 ["useMemo"]
       20 NEWCLOSURE                       R7 P1
       21 CAPTURE                          UPVAL U2
       22 CAPTURE                          VAL R2
       23 CAPTURE                          VAL R4
