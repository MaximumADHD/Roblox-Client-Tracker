...
PROTO_2:
  ...
  CALL R3 2 1
  GETUPVAL R4 6
  GETTABLEKS R6 R0 K8 ["Avatar"]
  GETTABLEKS R5 R6 K9 ["WorldModel"]
  LOADK R6 K10 ["CameraPosition"]
  GETUPVAL R8 7
  GETTABLEKS R7 R8 K11 ["DEFAULT_CAMERA_ANGLE"]
  CALL R4 3 2
  GETUPVAL R6 8
  CALL R6 0 1
  JUMPIF R6 [+3]
  ...
  NEWTABLE R8 2 0
  LOADN R9 255
  SETTABLEKS R9 R8 K13 ["ZIndex"]
  GETUPVAL R11 10
  GETTABLEKS R10 R11 K14 ["Event"]
  GETTABLEKS R9 R10 K15 ["InputBegan"]
  SETTABLE R3 R8 R9
  DUPTABLE R9 K18 [{"Background", "DummyPreview"}]
  GETUPVAL R11 1
  GETTABLEKS R10 R11 K12 ["createElement"]
  GETUPVAL R11 11
  CALL R10 1 1
  SETTABLEKS R10 R9 K16 ["Background"]
  GETTABLEKS R11 R0 K6 ["Dummy"]
  JUMPIFNOT R11 [+29]
  GETUPVAL R11 1
  GETTABLEKS R10 R11 K12 ["createElement"]
  GETUPVAL R11 12
  DUPTABLE R12 K25 [{"Model", "ResetCameraSignal", "InitialCameraPosition", "SetInitialCameraPosition", "GetCameraModifications", "Static"}]
  GETTABLEKS R13 R0 K6 ["Dummy"]
  SETTABLEKS R13 R12 K19 ["Model"]
  GETTABLEKS R13 R0 K20 ["ResetCameraSignal"]
  SETTABLEKS R13 R12 K20 ["ResetCameraSignal"]
  SETTABLEKS R4 R12 K21 ["InitialCameraPosition"]
  SETTABLEKS R5 R12 K22 ["SetInitialCameraPosition"]
  GETTABLEKS R14 R1 K26 ["stage"]
  GETTABLEKS R13 R14 K27 ["getPreviewCameraModifications"]
  SETTABLEKS R13 R12 K23 ["GetCameraModifications"]
  GETTABLEKS R13 R1 K28 ["dummyPreviewLocked"]
  SETTABLEKS R13 R12 K24 ["Static"]
  CALL R10 2 1
  JUMP [+27]
  GETUPVAL R11 1
  GETTABLEKS R10 R11 K12 ["createElement"]
  GETUPVAL R11 13
  DUPTABLE R12 K32 [{"AnchorPoint", "Position", "Size"}]
  ...
  CALL R10 2 1
  SETTABLEKS R10 R9 K17 ["DummyPreview"]
  CALL R6 3 -1
  RETURN R6 -1
  GETUPVAL R7 1
  GETTABLEKS R6 R7 K12 ["createElement"]
  LOADK R7 K40 ["ImageLabel"]
  NEWTABLE R8 8 0
  LOADN R9 1
  SETTABLEKS R9 R8 K41 ["BackgroundTransparency"]
  GETTABLEKS R9 R2 K42 ["BackgroundImage"]
  SETTABLEKS R9 R8 K43 ["Image"]
  GETIMPORT R9 K39 [UDim2.fromScale]
  LOADN R10 1
  LOADN R11 1
  CALL R9 2 1
  ...
  GETTABLEKS R9 R10 K15 ["InputBegan"]
  SETTABLE R3 R8 R9
  DUPTABLE R9 K44 [{"DummyPreview"}]
  GETTABLEKS R11 R0 K6 ["Dummy"]
  JUMPIFNOT R11 [+15]
  GETUPVAL R11 1
  GETTABLEKS R10 R11 K12 ["createElement"]
  GETUPVAL R11 14
  DUPTABLE R12 K45 [{"Dummy", "ResetCameraSignal"}]
  GETTABLEKS R13 R0 K6 ["Dummy"]
...
MAIN:
  ...
  GETTABLEKS R19 R20 K29 ["getFFlagAvatarPreviewerSkinToneAlphaDetection"]
  CALL R18 1 1
