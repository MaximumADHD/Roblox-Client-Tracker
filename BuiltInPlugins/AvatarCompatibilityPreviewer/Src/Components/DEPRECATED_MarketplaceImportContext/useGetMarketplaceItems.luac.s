...
PROTO_2:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["initializeItemStatus"]
        3 MOVE                             R2 R0
        4 CALL                             R1 1 2
       ...
       32 RETURN                           R5 1
       33 GETUPVAL                         R5 0
       34 GETTABLEKS                       R5 R5 K9 ["processBundleData"]
       36 MOVE                             R6 R4
       37 MOVE                             R7 R1
       38 MOVE                             R8 R2
       39 CALL                             R5 3 1
       ...
       46 GETUPVAL                         R8 0
       47 GETTABLEKS                       R8 R8 K13 ["buildAssetFetchList"]
       49 MOVE                             R9 R2
       50 CALL                             R8 1 1
       ...
       78 RETURN                           R11 1
       79 GETUPVAL                         R11 0
       80 GETTABLEKS                       R11 R11 K14 ["processAssetData"]
       82 MOVE                             R12 R10
       83 MOVE                             R13 R6
       84 MOVE                             R14 R1
       85 CALL                             R11 3 1
       86 GETUPVAL                         R12 0
       87 GETTABLEKS                       R12 R12 K15 ["findLostIds"]
       89 MOVE                             R13 R1
       90 CALL                             R12 1 1
       91 GETUPVAL                         R13 0
       92 GETTABLEKS                       R13 R13 K16 ["buildItemRows"]
       94 MOVE                             R14 R0
       95 MOVE                             R15 R1
       96 MOVE                             R16 R7
       ...
       99 CALL                             R13 4 1
      100 GETUPVAL                         R14 0
      101 GETTABLEKS                       R14 R14 K18 ["buildErrorData"]
...
MAIN:
       ...
       20 GETTABLEKS                       R3 R3 K10 ["MarketplaceCatalogUtils"]
       22 CALL                             R2 1 1
       23 GETIMPORT                        R3 K5 [require]
       25 GETTABLEKS                       R4 R0 K8 ["Src"]
       27 GETTABLEKS                       R4 R4 K11 ["Components"]
       29 GETTABLEKS                       R4 R4 K12 ["AvatarEditorServiceContext"]
       31 CALL                             R3 1 1
       ...
       45 GETTABLEKS                       R6 R6 K16 ["Analytics"]
       47 GETIMPORT                        R7 K5 [require]
       49 GETTABLEKS                       R8 R0 K8 ["Src"]
