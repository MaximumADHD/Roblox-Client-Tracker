...
PROTO_2:
  ...
  GETTABLEKS R7 R8 K21 ["Key"]
  JUMPIFNOTEQKS R7 K22 ["Shoes"] [+21]
  GETUPVAL R7 6
  GETTABLEKS R9 R6 K14 ["item"]
  GETTABLEKS R8 R9 K6 ["instance"]
  CALL R7 1 1
  JUMPIFEQKNIL R7 [+125]
  DUPTABLE R10 K8 [{"instance", "assetType"}]
  SETTABLEKS R7 R10 K6 ["instance"]
  LOADK R11 K22 ["Shoes"]
  ...
  CALL R8 2 0
  GETTABLEKS R8 R6 K20 ["palette"]
  GETTABLEKS R7 R8 K23 ["PublishAssetType"]
  JUMPIFEQKNIL R7 [+107]
  GETTABLEKS R10 R6 K20 ["palette"]
  GETTABLEKS R9 R10 K23 ["PublishAssetType"]
  ...
  MOVE R9 R7
  NEWTABLE R10 0 1
  LOADK R11 K24 ["Handle"]
  SETLIST R10 R11 1 [1]
  CALL R8 2 0
  GETUPVAL R12 3
  GETTABLEKS R11 R12 K25 ["REFERENCE_VALUE_NAME"]
  NAMECALL R9 R7 K26 ["FindFirstChild"]
  CALL R9 2 1
  JUMPIFEQKNIL R9 [+6]
  LOADK R12 K27 ["ObjectValue"]
  NAMECALL R10 R9 K28 ["IsA"]
  CALL R10 2 1
  JUMPIF R10 [+2]
  LOADNIL R8
  JUMP [+19]
  LOADK R13 K27 ["ObjectValue"]
  NAMECALL R11 R9 K28 ["IsA"]
  CALL R11 2 1
  GETUPVAL R13 3
  ...
  CALL R10 2 0
  GETTABLEKS R8 R9 K29 ["Value"]
  JUMPIFNOT R8 [+4]
  GETTABLEKS R10 R9 K29 ["Value"]
  GETTABLEKS R8 R10 K30 ["Name"]
  JUMPIFEQKNIL R8 [+3]
  SETTABLEKS R8 R7 K30 ["Name"]
  LOADK R11 K31 ["ValueBase"]
  LOADB R12 1
  NAMECALL R9 R7 K32 ["FindFirstChildWhichIsA"]
  CALL R9 3 1
  JUMPIFEQKNIL R9 [+5]
  NAMECALL R10 R9 K33 ["Destroy"]
  CALL R10 1 0
  JUMPBACK [-11]
  NAMECALL R9 R7 K34 ["GetAttributes"]
  CALL R9 1 3
  FORGPREP R9
  MOVE R16 R12
  LOADNIL R17
  NAMECALL R14 R7 K35 ["SetAttribute"]
  CALL R14 3 0
  FORGLOOP R9 1 [-6]
  DUPTABLE R11 K8 [{"instance", "assetType"}]
  SETTABLEKS R7 R11 K6 ["instance"]
  GETTABLEKS R13 R6 K20 ["palette"]
  GETTABLEKS R12 R13 K23 ["PublishAssetType"]
...
MAIN:
  ...
  GETTABLEKS R8 R9 K15 ["SubmitDialog"]
  GETTABLEKS R7 R8 K16 ["createModelForShoes"]
  CALL R6 1 1
  GETIMPORT R7 K5 [require]
  GETTABLEKS R10 R0 K10 ["Src"]
  GETTABLEKS R9 R10 K11 ["Util"]
  GETTABLEKS R8 R9 K17 ["filterDescendants"]
  CALL R7 1 1
  GETIMPORT R8 K5 [require]
  GETTABLEKS R11 R0 K10 ["Src"]
  GETTABLEKS R10 R11 K18 ["Flags"]
  GETTABLEKS R9 R10 K19 ["getFFlagAvatarPreviewerSortClothingUI"]
  CALL R8 1 1
