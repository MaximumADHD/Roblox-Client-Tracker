...
PROTO_5:
  ...
  GETUPVAL R4 2
  DUPTABLE R5 K10 [{"key", "ItemData", "IsUserProvided", "LayoutOrder", "Size", "Delete"}]
  LOADK R7 K11 ["item_%*_%*"]
  ...
  GETUPVAL R9 0
  GETTABLEKS R8 R9 K14 ["SOURCE_BUILTIN"]
  JUMPIFEQ R7 R8 [+6]
  NEWCLOSURE R6 P0
  CAPTURE UPVAL U6
  CAPTURE UPVAL U7
...
MAIN:
  ...
  GETTABLEKS R8 R9 K16 ["getFFlagAvatarPreviewerRemoveItemsFromPalette"]
  CALL R7 1 1
