...
PROTO_11:
  ...
  JUMPIFEQKNIL R22 [+4]
  GETUPVAL R22 4
  GETTABLE R20 R22 R21
  JUMP [+29]
  LOADK R24 K63 ["^Left(.+)$"]
  NAMECALL R22 R21 K64 ["match"]
  CALL R22 2 1
  JUMPIFEQKNIL R22 [+8]
  LOADK R24 K65 ["Right"]
  MOVE R25 R22
  CONCAT R23 R24 R25
  GETUPVAL R24 4
  SETTABLE R23 R24 R21
  MOVE R20 R23
  JUMP [+16]
  LOADK R25 K66 ["^Right(.+)$"]
  NAMECALL R23 R21 K64 ["match"]
  CALL R23 2 1
  JUMPIFEQKNIL R23 [+8]
  LOADK R25 K67 ["Left"]
  MOVE R26 R23
  CONCAT R24 R25 R26
  GETUPVAL R25 4
  SETTABLE R24 R25 R21
  MOVE R20 R24
  JUMP [+3]
  GETUPVAL R24 4
  SETTABLE R21 R24 R21
  MOVE R20 R21
  GETTABLEKS R21 R19 K29 ["targetName"]
  JUMPIFNOTEQ R20 R21 [+25]
  MOVE R20 R6
  GETTABLEKS R21 R13 K29 ["targetName"]
