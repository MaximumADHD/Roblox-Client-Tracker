...
PROTO_12:
  ...
  CALL R15 1 2
  JUMPIFNOT R15 [+2]
  JUMPIFNOTEQKNIL R14 [+15]
  GETIMPORT R17 K18 [warn]
  LOADK R19 K26 ["createSymmetryMapAsync - %*:GetUVs() failed with error %*"]
  NAMECALL R21 R13 K27 ["GetFullName"]
  CALL R21 1 1
  MOVE R22 R16
  NAMECALL R19 R19 K28 ["format"]
  CALL R19 3 1
  MOVE R18 R19
  CALL R17 1 0
  CLOSEUPVALS R14
  ...
  LOADNIL R19
  FORGPREP R17
  DUPTABLE R24 K33 [{"targetName", "vertex", "uv", "side"}]
  GETTABLEKS R25 R13 K34 ["Name"]
  SETTABLEKS R25 R24 K29 ["targetName"]
  SETTABLEKS R20 R24 K30 ["vertex"]
  GETTABLEKS R26 R21 K35 ["X"]
  GETTABLEKS R27 R21 K36 ["Y"]
  FASTCALL2 VECTOR R26 R27 [+3]
  GETIMPORT R25 K39 [Vector3.new]
  CALL R25 2 1
  SETTABLEKS R25 R24 K31 ["uv"]
  GETTABLEKS R26 R21 K35 ["X"]
  LOADK R27 K40 [3.5]
  JUMPIFNOTLE R27 R26 [+3]
  LOADK R25 K41 ["right"]
  JUMP [+1]
  LOADK R25 K42 ["left"]
  SETTABLEKS R25 R24 K32 ["side"]
  FASTCALL2 TABLE_INSERT R5 R24 [+4]
  MOVE R23 R5
  GETIMPORT R22 K45 [table.insert]
  CALL R22 2 0
  FORGLOOP R17 2 [-35]
  CLOSEUPVALS R14
  FORGLOOP R9 2 [-66]
  ...
  LOADK R16 K61 ["Find points with UV"]
  CALL R15 1 0
  MOVE R15 R8
  MOVE R16 R14
  CALL R15 1 3
  ...
  JUMPIFEQ R22 R23 [+6]
  GETIMPORT R22 K68 [table.remove]
  MOVE R23 R18
  MOVE R24 R21
  CALL R22 2 0
  FORNLOOP R19
...
MAIN:
  ...
  GETTABLEKS R6 R7 K13 ["binarySearchRange"]
  CALL R5 1 1
  NEWTABLE R6 0 0
  DUPCLOSURE R7 K14 [PROTO_0]
  CAPTURE VAL R6
  DUPCLOSURE R8 K15 [PROTO_1]
  DUPCLOSURE R9 K16 [PROTO_12]
  CAPTURE VAL R0
  CAPTURE VAL R1
  CAPTURE VAL R2
  CAPTURE VAL R5
