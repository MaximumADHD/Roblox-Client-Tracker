...
MAIN:
  ...
  GETTABLEKS R7 R8 K14 ["useAsync"]
  CALL R6 1 1
  GETIMPORT R7 K7 [require]
  GETTABLEKS R9 R1 K15 ["MeshEditingContexts"]
  GETTABLEKS R8 R9 K16 ["CageEditingContext"]
  CALL R7 1 1
  GETIMPORT R8 K7 [require]
  GETTABLEKS R10 R1 K17 ["Components"]
  GETTABLEKS R9 R10 K18 ["FreeformMeshEditingComponent"]
  CALL R8 1 1
  GETIMPORT R9 K7 [require]
  GETTABLEKS R10 R1 K12 ["Types"]
  CALL R9 1 1
  GETTABLEKS R10 R4 K19 ["ContextServices"]
  GETTABLEKS R11 R10 K20 ["Mouse"]
  GETTABLEKS R12 R10 K21 ["Plugin"]
  GETTABLEKS R14 R2 K22 ["Contexts"]
  GETTABLEKS R13 R14 K23 ["LuaMeshEditingModuleContext"]
