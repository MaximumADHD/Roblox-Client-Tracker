...
PROTO_8:
  ...
  GETUPVAL R11 8
  DUPTABLE R12 K15 [{"Mouse", "Plugin", "VertexToolBase", "Radius", "Falloff", "Mannequin", "OnChangeSelectedPositions"}]
  ...
  GETTABLEKS R13 R0 K14 ["OnChangeSelectedPositions"]
  SETTABLEKS R13 R12 K14 ["OnChangeSelectedPositions"]
  CALL R10 2 1
  RETURN R10 1
...
MAIN:
  ...
  GETTABLEKS R9 R10 K18 ["useUndoRedoActions"]
  CALL R8 1 1
  GETIMPORT R9 K7 [require]
  GETTABLEKS R11 R1 K19 ["MeshEditingContexts"]
  GETTABLEKS R10 R11 K20 ["CageEditingContext"]
  CALL R9 1 1
  GETIMPORT R10 K7 [require]
  GETTABLEKS R12 R1 K13 ["Components"]
  GETTABLEKS R11 R12 K21 ["FreeformMeshEditingComponent"]
  CALL R10 1 1
  GETTABLEKS R11 R4 K22 ["ContextServices"]
  GETTABLEKS R12 R11 K23 ["Mouse"]
  GETTABLEKS R13 R11 K24 ["Plugin"]
  GETTABLEKS R15 R2 K25 ["Contexts"]
