...
PROTO_4:
  ...
  NEWTABLE R5 0 2
  LOADK R6 K5 ["Head"]
  LOADK R7 K11 ["FaceCenterAttachment"]
  SETLIST R5 R6 2 [1]
  MOVE R6 R3
  MOVE R7 R5
  CALL R6 1 1
  ...
  NEWTABLE R5 0 2
  LOADK R6 K5 ["Head"]
  LOADK R7 K12 ["FaceFrontAttachment"]
  SETLIST R5 R6 2 [1]
  MOVE R6 R3
  MOVE R7 R5
  CALL R6 1 1
  ...
  LOADK R7 K14 ["BodyFrontAttachment"]
  SETLIST R5 R6 2 [1]
  MOVE R6 R3
  MOVE R7 R5
  CALL R6 1 1
  ...
  NEWTABLE R5 0 2
  LOADK R6 K13 ["UpperTorso"]
  LOADK R7 K15 ["BodyBackAttachment"]
  SETLIST R5 R6 2 [1]
  MOVE R6 R3
  MOVE R7 R5
  CALL R6 1 1
  ...
  NEWTABLE R5 0 2
  LOADK R6 K13 ["UpperTorso"]
  LOADK R7 K17 ["WristRigAttachment"]
  SETLIST R5 R6 2 [1]
  MOVE R6 R3
  MOVE R7 R5
  CALL R6 1 1
  ...
  CALL R7 2 0
  NEWTABLE R5 0 2
  LOADK R6 K18 ["LowerTorso"]
  LOADK R7 K19 ["WaistBackAttachment"]
  SETLIST R5 R6 2 [1]
  MOVE R6 R3
  MOVE R7 R5
  CALL R6 1 1
  ...
  NEWTABLE R5 0 2
  LOADK R6 K18 ["LowerTorso"]
  LOADK R7 K20 ["WaistCenterAttachment"]
  SETLIST R5 R6 2 [1]
  MOVE R6 R3
  MOVE R7 R5
  CALL R6 1 1
  ...
  NEWTABLE R5 0 2
  LOADK R6 K18 ["LowerTorso"]
  LOADK R7 K21 ["WaistFrontAttachment"]
  SETLIST R5 R6 2 [1]
  MOVE R6 R3
  MOVE R7 R5
  CALL R6 1 1
  ...
  NEWTABLE R5 0 2
  LOADK R6 K13 ["UpperTorso"]
  LOADK R7 K22 ["LeftCollarAttachment"]
  SETLIST R5 R6 2 [1]
  NEWTABLE R6 0 2
  LOADK R7 K13 ["UpperTorso"]
  LOADK R8 K23 ["RightCollarAttachment"]
  SETLIST R6 R7 2 [1]
  MOVE R7 R3
  MOVE R8 R5
  CALL R7 1 1
  ...
  CALL R8 1 1
  JUMPIFEQKNIL R8 [+16]
  GETTABLEKS R9 R7 K24 ["name"]
  SETTABLEKS R9 R8 K25 ["symmetricalPartner"]
  FASTCALL2 TABLE_INSERT R1 R8 [+5]
  MOVE R10 R1
  MOVE R11 R8
  GETIMPORT R9 K9 [table.insert]
  CALL R9 2 0
  GETTABLEKS R9 R8 K24 ["name"]
  SETTABLEKS R9 R7 K25 ["symmetricalPartner"]
  ...
  CALL R8 2 0
  NEWTABLE R5 0 2
  LOADK R6 K26 ["LeftUpperArm"]
  LOADK R7 K27 ["LeftShoulderAttachment"]
  SETLIST R5 R6 2 [1]
  NEWTABLE R6 0 2
  LOADK R7 K28 ["RightUpperArm"]
  LOADK R8 K29 ["RightShoulderAttachment"]
  SETLIST R6 R7 2 [1]
  MOVE R7 R3
  MOVE R8 R5
  CALL R7 1 1
  ...
  CALL R8 2 0
  NEWTABLE R5 0 2
  LOADK R6 K30 ["LeftHand"]
  LOADK R7 K31 ["LeftGripAttachment"]
  SETLIST R5 R6 2 [1]
  NEWTABLE R6 0 2
  LOADK R7 K32 ["RightHand"]
  LOADK R8 K33 ["RightGripAttachment"]
  SETLIST R6 R7 2 [1]
  MOVE R7 R3
  MOVE R8 R5
  CALL R7 1 1
  ...
  CALL R8 2 0
  NEWTABLE R5 0 2
  LOADK R6 K34 ["LeftFoot"]
  LOADK R7 K35 ["LeftFootAttachment"]
  SETLIST R5 R6 2 [1]
  NEWTABLE R6 0 2
  LOADK R7 K36 ["RightFoot"]
  LOADK R8 K37 ["RightFootAttachment"]
  SETLIST R6 R7 2 [1]
  MOVE R7 R3
  MOVE R8 R5
  CALL R7 1 1
...
MAIN:
  ...
  GETTABLEKS R5 R6 K11 ["EditingTools"]
  GETTABLEKS R4 R5 K12 ["BodyPointsTool"]
  CALL R3 1 1
