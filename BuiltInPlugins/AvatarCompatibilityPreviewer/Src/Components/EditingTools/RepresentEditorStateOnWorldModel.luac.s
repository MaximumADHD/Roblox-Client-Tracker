...
PROTO_17:
  ...
  CALL R5 2 1
  GETUPVAL R7 7
  GETTABLEKS R6 R7 K13 ["useRefToState"]
  MOVE R7 R4
  CALL R6 1 1
  GETUPVAL R8 7
  ...
  SETLIST R11 R12 2 [1]
  CALL R9 2 0
  GETTABLEKS R9 R0 K10 ["includeAccessories"]
  JUMPIFNOT R9 [+25]
  GETTABLEKS R9 R8 K14 ["amount"]
  LOADN R10 0
  JUMPIFNOTLT R10 R9 [+21]
  GETUPVAL R10 1
  GETTABLEKS R9 R10 K15 ["createElement"]
  GETUPVAL R10 11
  DUPTABLE R11 K18 [{"key", "dummy"}]
  LOADK R13 K19 ["GiveDummyInstancesClothing%*"]
  GETTABLEKS R15 R8 K14 ["amount"]
  NAMECALL R13 R13 K20 ["format"]
  CALL R13 2 1
  MOVE R12 R13
  SETTABLEKS R12 R11 K16 ["key"]
  GETTABLEKS R12 R0 K9 ["worldModel"]
  SETTABLEKS R12 R11 K17 ["dummy"]
  CALL R9 2 -1
  RETURN R9 -1
  LOADNIL R9
  RETURN R9 1
