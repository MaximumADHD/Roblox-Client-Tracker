...
PROTO_28:
  ...
  DUPCLOSURE R2 K5 [PROTO_26]
  SETTABLEKS R2 R1 K2 ["endDrag"]
  DUPCLOSURE R2 K6 [PROTO_27]
...
PROTO_32:
  ...
  GETUPVAL R31 13
  DUPTABLE R32 K37 [{"adornee", "cframe", "selected", "color", "transparency", "showOrientation", "onMouseEnter", "onMouseLeave"}]
  GETTABLEKS R34 R0 K12 ["worldModel"]
  GETTABLEKS R33 R34 K38 ["PrimaryPart"]
  ...
  JUMP [+1]
  LOADNIL R33
  SETTABLEKS R33 R32 K34 ["showOrientation"]
  NEWCLOSURE R33 P10
  CAPTURE VAL R10
  CAPTURE VAL R26
  SETTABLEKS R33 R32 K35 ["onMouseEnter"]
  NEWCLOSURE R33 P11
  CAPTURE VAL R10
  CAPTURE VAL R26
  SETTABLEKS R33 R32 K36 ["onMouseLeave"]
  CALL R30 2 1
  SETTABLE R30 R2 R29
  FORGLOOP R22 2 [-99]
  GETUPVAL R22 14
  ...
  GETUPVAL R29 1
  GETTABLEKS R28 R29 K44 ["Fragment"]
  NEWTABLE R29 0 0
  NEWTABLE R30 2 0
  GETUPVAL R33 10
  GETTABLEKS R32 R33 K45 ["EDITING_TOOLS_GUI_NAMES"]
  GETTABLEKS R31 R32 K46 ["BodyPoints"]
  GETUPVAL R33 20
  GETTABLEKS R32 R33 K47 ["createPortal"]
  GETUPVAL R34 1
  GETTABLEKS R33 R34 K28 ["createElement"]
  LOADK R34 K48 ["Folder"]
  DUPTABLE R35 K50 [{"ref"}]
  SETTABLEKS R5 R35 K49 ["ref"]
  MOVE R36 R2
  DUPTABLE R37 K52 [{"Dragger"}]
  ...
  MOVE R40 R26
  CALL R38 2 1
  SETTABLEKS R38 R37 K51 ["Dragger"]
  CALL R33 4 1
  GETUPVAL R34 22
  GETUPVAL R37 10
  ...
  GETUPVAL R33 10
  GETTABLEKS R32 R33 K45 ["EDITING_TOOLS_GUI_NAMES"]
  GETTABLEKS R31 R32 K53 ["BodyPointsToolToolbar"]
  GETUPVAL R33 1
  GETTABLEKS R32 R33 K28 ["createElement"]
  GETUPVAL R34 23
  GETTABLEKS R33 R34 K54 ["Toolbar"]
  DUPTABLE R34 K56 [{"HorizontalItems"}]
  NEWTABLE R35 0 4
  DUPTABLE R36 K62 [{"Type", "Tooltip", "Icon", "OnClick", "Selected"}]
  LOADK R37 K63 ["Button"]
  SETTABLEKS R37 R36 K57 ["Type"]
  LOADK R37 K64 ["Projection"]
  SETTABLEKS R37 R36 K58 ["Tooltip"]
  GETTABLEKS R37 R1 K65 ["ProjectionImage"]
  SETTABLEKS R37 R36 K59 ["Icon"]
  GETTABLEKS R37 R12 K66 ["toggle"]
  SETTABLEKS R37 R36 K60 ["OnClick"]
  GETTABLEKS R37 R12 K13 ["enabled"]
  SETTABLEKS R37 R36 K61 ["Selected"]
  DUPTABLE R37 K62 [{"Type", "Tooltip", "Icon", "OnClick", "Selected"}]
  LOADK R38 K63 ["Button"]
  SETTABLEKS R38 R37 K57 ["Type"]
  LOADK R38 K67 ["Symmetrical"]
  SETTABLEKS R38 R37 K58 ["Tooltip"]
  GETTABLEKS R38 R1 K68 ["SymmetricalImage"]
  SETTABLEKS R38 R37 K59 ["Icon"]
  GETTABLEKS R38 R13 K66 ["toggle"]
  SETTABLEKS R38 R37 K60 ["OnClick"]
  GETTABLEKS R38 R13 K13 ["enabled"]
  SETTABLEKS R38 R37 K61 ["Selected"]
  DUPTABLE R38 K69 [{"Type"}]
  LOADK R39 K70 ["Separator"]
  SETTABLEKS R39 R38 K57 ["Type"]
  GETTABLEKS R40 R0 K71 ["additionalToolbarItems"]
  FASTCALL1 TABLE_UNPACK R40 [+2]
  GETIMPORT R39 K73 [unpack]
  CALL R39 1 -1
  SETLIST R35 R36 -1 [1]
  SETTABLEKS R35 R34 K55 ["HorizontalItems"]
  CALL R32 2 1
  SETTABLE R32 R30 R31
  CALL R27 3 -1
  RETURN R27 -1
