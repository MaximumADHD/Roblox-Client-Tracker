PROTO_0:
        ...
        9 CALL                             R0 1 0
       10 GETUPVAL                         R0 2
       11 GETTABLEKS                       R0 R0 K1 ["Model"]
       13 JUMPIFNOTEQKNIL                  R0 ; [+2]
       15 RETURN                           R0 0
       16 GETUPVAL                         R2 2
       17 GETTABLEKS                       R2 R2 K1 ["Model"]
       19 JUMPIFNOTEQKNIL                  R2 ; [+2]
       21 LOADB                            R1 0 +1
       22 LOADB                            R1 1
       23 GETUPVAL                         R2 3
       24 GETTABLEKS                       R2 R2 K2 ["LUAU_ANALYZE_ERROR"]
       ...
       34 CALL                             R0 1 1
       35 GETUPVAL                         R1 2
       36 GETTABLEKS                       R1 R1 K1 ["Model"]
       38 LOADK                            R2 K9 ["Dummy"]
       39 SETTABLEKS                       R2 R1 K10 ["Name"]
       41 GETUPVAL                         R1 2
       42 GETTABLEKS                       R1 R1 K1 ["Model"]
       44 SETTABLEKS                       R0 R1 K11 ["Parent"]
       46 GETUPVAL                         R1 2
       47 GETTABLEKS                       R1 R1 K1 ["Model"]
       49 GETTABLEKS                       R1 R1 K12 ["PrimaryPart"]
       51 SETTABLEKS                       R1 R0 K12 ["PrimaryPart"]
       53 GETUPVAL                         R1 2
       54 GETTABLEKS                       R1 R1 K1 ["Model"]
       ...
       66 CALL                             R1 -1 0
       67 JUMP                             ; [+8]
       68 NAMECALL                         R3 R0 K18 ["GetPivot"]
       70 CALL                             R3 1 1
       71 GETTABLEKS                       R3 R3 K19 ["Rotation"]
       ...
       80 MOVE                             R2 R0
       81 GETUPVAL                         R3 2
       82 GETTABLEKS                       R3 R3 K1 ["Model"]
       84 GETUPVAL                         R4 5
       85 GETTABLEKS                       R4 R4 K20 ["PlatformHeight"]
       87 GETUPVAL                         R5 5
       88 GETTABLEKS                       R5 R5 K21 ["PlatformSize"]
       90 CALL                             R1 4 -1
       91 RETURN                           R1 -1
...
PROTO_1:
       ...
       22 RETURN                           R0 0
       23 GETUPVAL                         R2 1
       24 GETTABLEKS                       R2 R2 K5 ["GetCameraModifications"]
       26 MOVE                             R3 R1
       27 CALL                             R2 1 1
       28 GETUPVAL                         R3 2
...
PROTO_10:
       ...
       23 CALL                             R2 1 2
       24 GETUPVAL                         R4 1
       25 GETTABLEKS                       R4 R4 K8 ["useEffect"]
       27 NEWCLOSURE                       R5 P0
       28 CAPTURE                          VAL R2
       29 CAPTURE                          VAL R3
       30 CAPTURE                          VAL R0
       ...
       40 CALL                             R4 2 0
       41 GETUPVAL                         R4 1
       42 GETTABLEKS                       R4 R4 K7 ["useState"]
       44 GETIMPORT                        R5 K11 [Instance.new]
       46 LOADK                            R6 K12 ["Camera"]
       47 CALL                             R5 1 -1
       48 CALL                             R4 -1 1
       49 GETUPVAL                         R5 1
       50 GETTABLEKS                       R5 R5 K7 ["useState"]
       52 GETIMPORT                        R6 K14 [CFrame.new]
       54 CALL                             R6 0 -1
       55 CALL                             R5 -1 2
       56 GETUPVAL                         R7 1
       57 GETTABLEKS                       R7 R7 K15 ["useRef"]
       ...
       79 LOADB                            R9 1
       80 GETUPVAL                         R10 2
       81 GETTABLEKS                       R10 R10 K21 ["LUAU_ANALYZE_ERROR"]
       83 FASTCALL2                        ASSERT R9 R10 ; [+3]
       85 GETIMPORT                        R8 K4 [assert]
       87 CALL                             R8 2 0
       88 GETUPVAL                         R8 1
       89 GETTABLEKS                       R8 R8 K22 ["useCallback"]
       91 NEWCLOSURE                       R9 P1
       92 CAPTURE                          VAL R7
       93 CAPTURE                          VAL R0
       94 CAPTURE                          VAL R4
      ...
      102 CALL                             R8 2 1
      103 GETUPVAL                         R9 1
      104 GETTABLEKS                       R9 R9 K22 ["useCallback"]
      ...
      117 CALL                             R9 2 1
      118 GETUPVAL                         R10 1
      119 GETTABLEKS                       R10 R10 K8 ["useEffect"]
      ...
      131 CALL                             R10 2 0
      132 GETUPVAL                         R10 1
      133 GETTABLEKS                       R10 R10 K22 ["useCallback"]
      ...
      140 CALL                             R10 2 1
      141 GETUPVAL                         R11 1
      142 GETTABLEKS                       R11 R11 K8 ["useEffect"]
      ...
      155 CALL                             R11 2 0
      156 GETUPVAL                         R11 1
      157 GETTABLEKS                       R11 R11 K8 ["useEffect"]
      ...
      166 CALL                             R11 2 0
      167 GETTABLEKS                       R11 R7 K20 ["current"]
      169 GETTABLEKS                       R11 R11 K17 ["focus"]
      171 JUMPIFNOT                        R2 ; [+71]
      172 GETUPVAL                         R12 1
      173 GETTABLEKS                       R12 R12 K25 ["createElement"]
      175 GETUPVAL                         R13 5
...
MAIN:
       ...
       45 GETTABLEKS                       R6 R6 K14 ["Screens"]
       47 GETTABLEKS                       R6 R6 K15 ["AvatarScreen"]
       49 GETTABLEKS                       R6 R6 K16 ["Stages"]
       51 GETTABLEKS                       R6 R6 K17 ["StageType"]
       53 CALL                             R5 1 1
       54 GETTABLEKS                       R6 R1 K18 ["UI"]
       56 GETTABLEKS                       R7 R6 K19 ["AssetRenderModel"]
       58 GETTABLEKS                       R8 R1 K20 ["ContextServices"]
       60 GETTABLEKS                       R8 R8 K21 ["Stylizer"]
       62 GETIMPORT                        R9 K5 [require]
       64 GETTABLEKS                       R10 R0 K9 ["Src"]
       66 GETTABLEKS                       R10 R10 K10 ["Util"]
       68 GETTABLEKS                       R10 R10 K22 ["Constants"]
       70 CALL                             R9 1 1
       71 GETIMPORT                        R10 K5 [require]
       73 GETTABLEKS                       R11 R0 K9 ["Src"]
       75 GETTABLEKS                       R11 R11 K23 ["Resources"]
       77 GETTABLEKS                       R11 R11 K24 ["Theme"]
       79 CALL                             R10 1 1
       80 GETIMPORT                        R11 K5 [require]
       82 GETTABLEKS                       R12 R0 K9 ["Src"]
       84 GETTABLEKS                       R12 R12 K25 ["Types"]
       86 CALL                             R11 1 1
