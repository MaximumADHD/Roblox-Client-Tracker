...
PROTO_4:
  ...
  GETTABLEKS R10 R3 K6 ["Position"]
  GETTABLEKS R13 R4 K8 ["Magnitude"]
  GETTABLEKS R14 R3 K14 ["LookVector"]
  MUL R12 R13 R14
  MULK R11 R12 K7 [2]
  ADD R9 R10 R11
  GETTABLEKS R12 R4 K8 ["Magnitude"]
  GETTABLEKS R13 R3 K15 ["RightVector"]
  MUL R11 R12 R13
  MULK R10 R11 K10 [1]
  SUB R8 R9 R10
  GETTABLEKS R11 R4 K8 ["Magnitude"]
  GETTABLEKS R12 R3 K16 ["UpVector"]
  MUL R10 R11 R12
  MULK R9 R10 K12 [0.5]
  ADD R7 R8 R9
  GETTABLEKS R8 R3 K6 ["Position"]
  CALL R6 2 1
  GETTABLEKS R9 R6 K17 ["Rotation"]
  GETTABLEKS R10 R3 K6 ["Position"]
  ADD R8 R9 R10
  GETTABLEKS R10 R6 K14 ["LookVector"]
  MUL R9 R10 R5
  SUB R7 R8 R9
  RETURN R7 1
...
MAIN:
  ...
  SETTABLEKS R3 R2 K10 ["getCuboidDiameter"]
  DUPCLOSURE R3 K11 [PROTO_1]
  CAPTURE VAL R2
  SETTABLEKS R3 R2 K12 ["fitBoundingBoxToCamera"]
  DUPCLOSURE R3 K13 [PROTO_2]
  SETTABLEKS R3 R2 K14 ["fitSphereToCamera"]
  DUPCLOSURE R3 K15 [PROTO_3]
  CAPTURE VAL R2
  SETTABLEKS R3 R2 K16 ["getZoomedCFrame"]
  DUPCLOSURE R3 K17 [PROTO_4]
  CAPTURE VAL R2
  CAPTURE VAL R1
  SETTABLEKS R3 R2 K18 ["getAngledAndZoomedCFrame"]
  DUPCLOSURE R3 K19 [PROTO_5]
  CAPTURE VAL R2
  SETTABLEKS R3 R2 K20 ["zoomToExtents"]
  DUPCLOSURE R3 K21 [PROTO_6]
  SETTABLEKS R3 R2 K22 ["zoomIsRequired"]
  RETURN R2 1
