...
PROTO_1:
  ...
  LOADK R2 K0 ["FFlagAvatarPreviewerUGCValidationNotice is not enabled"]
  GETIMPORT R0 K2 [assert]
  CALL R0 2 0
  DUPTABLE R1 K6 [{"validateBundleReadyForUpload", "_metadataResponse", "_metadataResponsePromise"}]
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K3 ["validateBundleReadyForUpload"]
  SETTABLEKS R2 R1 K3 ["validateBundleReadyForUpload"]
  LOADNIL R2
  SETTABLEKS R2 R1 K4 ["_metadataResponse"]
  LOADNIL R2
  SETTABLEKS R2 R1 K5 ["_metadataResponsePromise"]
  GETUPVAL R2 2
...
MAIN:
  ...
  GETTABLEKS R7 R8 K15 ["getFFlagAvatarPreviewerUGCValidationNotice"]
  CALL R6 1 1
  ...
  LOADK R11 K19 ["UGCValidationContext"]
  ...
  CAPTURE VAL R4
  CAPTURE VAL R9
  SETTABLEKS R12 R9 K26 ["mockAlwaysPasses"]
  DUPCLOSURE R12 K27 [PROTO_5]
  CAPTURE VAL R2
  CAPTURE VAL R4
  CAPTURE VAL R9
  SETTABLEKS R12 R9 K28 ["mockAlwaysFails"]
  DUPCLOSURE R12 K29 [PROTO_7]
  CAPTURE VAL R2
  CAPTURE VAL R4
  CAPTURE VAL R9
  SETTABLEKS R12 R9 K30 ["mockNeverReturns"]
  DUPCLOSURE R12 K31 [PROTO_9]
  CAPTURE VAL R9
  SETTABLEKS R12 R9 K32 ["mockUnauthorized"]
  ...
  CAPTURE VAL R2
  CAPTURE VAL R5
  SETTABLEKS R12 R9 K34 ["useBundlesMetadata"]
  RETURN R9 1
