...
PROTO_9:
  DUPTABLE R3 K9 [{"Key", "Items", "PreviewComponent", "PublishAssetType", "WearBuiltin", "WearInstance", "CreateCustomInstanceFromSelection", "UpdateInstances", "UpdateInstance_DEPRECATED"}]
  ...
  GETUPVAL R4 4
  SETTABLEKS R4 R3 K8 ["UpdateInstance_DEPRECATED"]
  RETURN R3 1
...
PROTO_12:
  NEWCLOSURE R4 P0
  CAPTURE VAL R1
  DUPTABLE R5 K10 [{"Key", "Items", "PreviewComponent", "PublishAssetType", "WearBuiltin", "CreateCustomInstanceFromSelection", "WearInstance", "UpdateInstances", "UpdateInstance_DEPRECATED", "PreferredLayer"}]
  ...
  GETUPVAL R6 4
  SETTABLEKS R6 R5 K8 ["UpdateInstance_DEPRECATED"]
  GETUPVAL R7 5
  CALL R7 0 1
  JUMPIFNOT R7 [+2]
  MOVE R6 R3
  JUMP [+1]
  LOADNIL R6
  SETTABLEKS R6 R5 K9 ["PreferredLayer"]
  RETURN R5 1
...
MAIN:
  ...
  GETTABLEKS R12 R13 K22 ["getFFlagAvatarPreviewerInsertInMarketplaceOrder"]
  CALL R11 1 1
  NEWTABLE R12 16 0
  ...
  DUPCLOSURE R19 K35 [PROTO_16]
  CAPTURE VAL R12
  CAPTURE VAL R13
  CAPTURE VAL R14
  SETTABLEKS R19 R12 K36 ["createBodyCategory"]
  DUPCLOSURE R19 K37 [PROTO_19]
  CAPTURE VAL R12
  SETTABLEKS R19 R12 K38 ["createHeadPalette"]
  DUPCLOSURE R19 K39 [PROTO_22]
  CAPTURE VAL R3
  CAPTURE VAL R5
  CAPTURE VAL R7
  CAPTURE VAL R13
