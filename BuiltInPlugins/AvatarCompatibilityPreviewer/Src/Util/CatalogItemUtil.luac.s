...
PROTO_28:
  ...
  DUPCLOSURE R2 K11 [PROTO_23]
  SETTABLEKS R2 R1 K3 ["WearBuiltin"]
  GETUPVAL R3 2
  CALL R3 0 1
  JUMPIFNOT R3 [+3]
  DUPCLOSURE R2 K12 [PROTO_24]
  CAPTURE UPVAL U3
  JUMP [+1]
  GETUPVAL R2 4
...
PROTO_31:
  ...
  SETTABLEKS R2 R1 K0 ["Key"]
  SETTABLEKS R0 R1 K1 ["Items"]
  DUPCLOSURE R2 K8 [PROTO_29]
  CAPTURE UPVAL U0
  CAPTURE UPVAL U1
  CAPTURE UPVAL U2
  SETTABLEKS R2 R1 K2 ["PreviewComponent"]
  DUPCLOSURE R2 K9 [PROTO_30]
  SETTABLEKS R2 R1 K3 ["WearBuiltin"]
  GETUPVAL R2 3
  SETTABLEKS R2 R1 K4 ["CreateCustomInstanceFromSelection"]
  GETUPVAL R2 4
...
MAIN:
  ...
  CAPTURE VAL R14
  CAPTURE VAL R16
  SETTABLEKS R17 R11 K28 ["basicAccessoryPalette"]
  DUPCLOSURE R17 K29 [PROTO_11]
  CAPTURE VAL R6
  CAPTURE VAL R14
  CAPTURE VAL R15
  CAPTURE VAL R16
  SETTABLEKS R17 R11 K30 ["layeredClothingPalette"]
  DUPCLOSURE R17 K31 [PROTO_13]
  CAPTURE VAL R6
  SETTABLEKS R17 R11 K32 ["createBodyPalette"]
  DUPCLOSURE R17 K33 [PROTO_15]
  CAPTURE VAL R11
  CAPTURE VAL R12
  CAPTURE VAL R13
  SETTABLEKS R17 R11 K34 ["createBodyCategory"]
  DUPCLOSURE R17 K35 [PROTO_18]
  CAPTURE VAL R11
  SETTABLEKS R17 R11 K36 ["createHeadPalette"]
  DUPCLOSURE R17 K37 [PROTO_21]
  CAPTURE VAL R3
  CAPTURE VAL R5
  CAPTURE VAL R7
  CAPTURE VAL R12
  CAPTURE VAL R13
  SETTABLEKS R17 R11 K38 ["createBodyAnimationPalette"]
  DUPCLOSURE R17 K39 [PROTO_28]
  CAPTURE VAL R3
  CAPTURE VAL R6
  CAPTURE VAL R10
  CAPTURE VAL R14
  ...
  CAPTURE VAL R13
  CAPTURE VAL R7
  SETTABLEKS R17 R11 K40 ["shoesPalette"]
  DUPCLOSURE R17 K41 [PROTO_31]
  CAPTURE VAL R3
  CAPTURE VAL R5
  CAPTURE VAL R7
  CAPTURE VAL R12
  CAPTURE VAL R13
  SETTABLEKS R17 R11 K42 ["emotionPalette"]
  DUPCLOSURE R17 K43 [PROTO_35]
  CAPTURE VAL R8
  CAPTURE VAL R12
  CAPTURE VAL R13
  SETTABLEKS R17 R11 K44 ["skinPalette"]
  RETURN R11 1
