...
MAIN:
  ...
  CAPTURE VAL R15
  CAPTURE VAL R17
  SETTABLEKS R18 R12 K29 ["basicAccessoryPalette"]
  DUPCLOSURE R18 K30 [PROTO_12]
  CAPTURE VAL R6
  CAPTURE VAL R15
  CAPTURE VAL R16
  CAPTURE VAL R17
  SETTABLEKS R18 R12 K31 ["layeredClothingPalette"]
  DUPCLOSURE R18 K32 [PROTO_14]
  CAPTURE VAL R6
  SETTABLEKS R18 R12 K33 ["createBodyPalette"]
  DUPCLOSURE R18 K34 [PROTO_16]
  CAPTURE VAL R12
  CAPTURE VAL R13
  CAPTURE VAL R14
  SETTABLEKS R18 R12 K35 ["createBodyCategory"]
  DUPCLOSURE R18 K36 [PROTO_19]
  CAPTURE VAL R12
  SETTABLEKS R18 R12 K37 ["createHeadPalette"]
  DUPCLOSURE R18 K38 [PROTO_22]
  CAPTURE VAL R3
  CAPTURE VAL R5
  CAPTURE VAL R7
  CAPTURE VAL R13
  CAPTURE VAL R14
  SETTABLEKS R18 R12 K39 ["createBodyAnimationPalette"]
  DUPCLOSURE R18 K40 [PROTO_29]
  CAPTURE VAL R3
  CAPTURE VAL R6
  CAPTURE VAL R11
  CAPTURE VAL R15
  ...
  CAPTURE VAL R14
  CAPTURE VAL R7
  SETTABLEKS R18 R12 K41 ["shoesPalette"]
  DUPCLOSURE R18 K42 [PROTO_32]
  CAPTURE VAL R3
  CAPTURE VAL R5
  CAPTURE VAL R7
  CAPTURE VAL R13
  CAPTURE VAL R14
  SETTABLEKS R18 R12 K43 ["emotionPalette"]
  DUPCLOSURE R18 K44 [PROTO_36]
  CAPTURE VAL R8
  CAPTURE VAL R13
  CAPTURE VAL R14
  SETTABLEKS R18 R12 K45 ["skinPalette"]
  RETURN R12 1
