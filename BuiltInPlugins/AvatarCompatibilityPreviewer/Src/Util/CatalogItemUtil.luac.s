...
PROTO_3:
  ...
  CALL R8 1 2
  JUMPIFNOT R8 [+34]
  JUMPIFNOTEQ R9 R1 [+33]
  JUMP [+6]
  GETTABLEKS R8 R7 K18 ["AssetType"]
  GETTABLEKS R9 R1 K19 ["Name"]
  JUMPIFNOTEQ R8 R9 [+26]
  GETTABLEKS R8 R7 K20 ["Attachments"]
  LOADNIL R9
  LOADNIL R10
  FORGPREP R8
...
PROTO_30:
  ...
  SETTABLEKS R2 R1 K0 ["Key"]
  SETTABLEKS R0 R1 K1 ["Items"]
  DUPCLOSURE R2 K8 [PROTO_28]
  CAPTURE UPVAL U0
  CAPTURE UPVAL U1
  CAPTURE UPVAL U2
  SETTABLEKS R2 R1 K2 ["PreviewComponent"]
  DUPCLOSURE R2 K9 [PROTO_29]
  SETTABLEKS R2 R1 K3 ["WearBuiltin"]
  GETUPVAL R2 3
  SETTABLEKS R2 R1 K4 ["CreateCustomInstanceFromSelection"]
  GETUPVAL R2 4
...
PROTO_34:
  ...
  GETUPVAL R2 1
  SETTABLEKS R2 R1 K4 ["CreateCustomInstanceFromSelection"]
  DUPCLOSURE R2 K10 [PROTO_31]
  SETTABLEKS R2 R1 K5 ["WearBuiltin"]
  GETUPVAL R2 2
  SETTABLEKS R2 R1 K6 ["WearInstance"]
  DUPTABLE R2 K13 [{"serialize", "deserialize"}]
  DUPCLOSURE R3 K14 [PROTO_32]
  SETTABLEKS R3 R2 K11 ["serialize"]
  DUPCLOSURE R3 K15 [PROTO_33]
  SETTABLEKS R3 R2 K12 ["deserialize"]
...
MAIN:
  ...
  GETTABLEKS R13 R14 K23 ["getFFlagAvatarPreviewerFixTShirtImportingAgain"]
  CALL R12 1 1
  GETIMPORT R13 K5 [require]
  GETTABLEKS R16 R0 K10 ["Src"]
  GETTABLEKS R15 R16 K20 ["Flags"]
  GETTABLEKS R14 R15 K24 ["getFFlagAvatarPreviewerImportMeshPartsAsAccessories"]
  CALL R13 1 1
  NEWTABLE R14 16 0
  ...
  CAPTURE VAL R17
  CAPTURE VAL R20
  SETTABLEKS R21 R14 K32 ["basicAccessoryPalette"]
  ...
  CAPTURE VAL R19
  CAPTURE VAL R20
  SETTABLEKS R21 R14 K34 ["layeredClothingPalette"]
  DUPCLOSURE R21 K35 [PROTO_14]
  CAPTURE VAL R6
  SETTABLEKS R21 R14 K36 ["createBodyPalette"]
  DUPCLOSURE R21 K37 [PROTO_16]
  CAPTURE VAL R14
  CAPTURE VAL R15
  CAPTURE VAL R16
  SETTABLEKS R21 R14 K38 ["createBodyCategory"]
  DUPCLOSURE R21 K39 [PROTO_19]
  CAPTURE VAL R14
  SETTABLEKS R21 R14 K40 ["createHeadPalette"]
  DUPCLOSURE R21 K41 [PROTO_22]
  CAPTURE VAL R3
  CAPTURE VAL R5
  CAPTURE VAL R7
  CAPTURE VAL R15
  CAPTURE VAL R16
  SETTABLEKS R21 R14 K42 ["createBodyAnimationPalette"]
  DUPCLOSURE R21 K43 [PROTO_27]
  CAPTURE VAL R3
  CAPTURE VAL R6
  CAPTURE VAL R11
  CAPTURE VAL R15
  CAPTURE VAL R16
  SETTABLEKS R21 R14 K44 ["shoesPalette"]
  DUPCLOSURE R21 K45 [PROTO_30]
  CAPTURE VAL R3
  CAPTURE VAL R5
  CAPTURE VAL R7
  CAPTURE VAL R15
  CAPTURE VAL R16
  SETTABLEKS R21 R14 K46 ["emotionPalette"]
  DUPCLOSURE R21 K47 [PROTO_34]
  CAPTURE VAL R8
  CAPTURE VAL R15
  CAPTURE VAL R16
  SETTABLEKS R21 R14 K48 ["skinPalette"]
  RETURN R14 1
