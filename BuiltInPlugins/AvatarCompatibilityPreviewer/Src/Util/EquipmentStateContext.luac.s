...
MAIN:
  ...
  DUPTABLE R5 K33 [{"accessories", "animation", "clothing", "emotion", "gear", "makeup", "patches"}]
  NEWTABLE R6 0 0
  ...
  NEWTABLE R6 0 0
  SETTABLEKS R6 R5 K31 ["makeup"]
  NEWTABLE R6 0 0
  SETTABLEKS R6 R5 K32 ["patches"]
  SETTABLEKS R5 R4 K23 ["avatarAssets"]
  GETTABLEKS R5 R1 K34 ["createContext"]
  MOVE R6 R4
  CALL R5 1 -1
  RETURN R5 -1
