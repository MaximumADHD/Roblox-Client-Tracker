...
PROTO_29:
  ...
  CALL R8 3 0
  GETUPVAL R9 3
  GETTABLEKS R8 R9 K15 ["computeValidScaleAsync"]
  MOVE R9 R0
  MOVE R10 R7
  CALL R8 2 1
  GETUPVAL R9 4
  ...
  JUMPIFNOT R9 [+22]
  GETUPVAL R10 3
  GETTABLEKS R9 R10 K16 ["translateBodyPartsToFinalCFrame"]
  MOVE R10 R7
  CALL R9 1 0
  GETUPVAL R10 3
  GETTABLEKS R9 R10 K17 ["applyLayeredClothingProportions"]
  MOVE R10 R2
  GETTABLEKS R11 R8 K18 ["proportions"]
  CALL R9 2 0
  GETUPVAL R10 3
  GETTABLEKS R9 R10 K19 ["assignLayeredClothing"]
  MOVE R10 R7
  CALL R9 1 0
  GETUPVAL R10 3
  GETTABLEKS R9 R10 K20 ["removeExtraAttachmentParts"]
  MOVE R10 R7
  CALL R9 1 0
  GETUPVAL R10 3
  GETTABLEKS R9 R10 K21 ["applyScale"]
  MOVE R10 R7
  MOVE R11 R8
  CALL R9 2 0
  GETUPVAL R10 3
  GETTABLEKS R9 R10 K22 ["applyAnimationsScript"]
  MOVE R10 R7
  CALL R9 1 0
  GETUPVAL R10 3
  GETTABLEKS R9 R10 K23 ["applyProportions"]
  MOVE R10 R7
  GETTABLEKS R11 R8 K18 ["proportions"]
  CALL R9 2 0
  GETUPVAL R10 3
  GETTABLEKS R9 R10 K24 ["renameModel"]
  MOVE R10 R7
  MOVE R11 R3
  CALL R9 2 0
  GETUPVAL R10 3
  GETTABLEKS R9 R10 K25 ["wearAccessories"]
  MOVE R10 R7
  GETTABLEKS R11 R3 K26 ["accessories"]
  CALL R9 2 0
  GETUPVAL R10 3
  GETTABLEKS R9 R10 K27 ["ensureSurfaceAppearances"]
  MOVE R10 R7
  CALL R9 1 0
  GETUPVAL R9 5
  CALL R9 0 1
  JUMPIFNOT R9 [+5]
  GETUPVAL R10 3
  GETTABLEKS R9 R10 K28 ["ensureBodyColors"]
  MOVE R10 R7
  CALL R9 1 0
  GETUPVAL R9 6
  SETTABLEKS R9 R7 K29 ["Parent"]
  GETUPVAL R10 3
  GETTABLEKS R9 R10 K30 ["setPivotOffset"]
  MOVE R10 R7
  CALL R9 1 0
  GETUPVAL R10 3
  GETTABLEKS R9 R10 K31 ["positionInWorkspace"]
  MOVE R10 R7
  MOVE R11 R3
  CALL R9 2 0
  GETUPVAL R10 6
  GETTABLEKS R9 R10 K32 ["CurrentCamera"]
  JUMPIFEQKNIL R9 [+24]
  GETUPVAL R11 7
  GETTABLEKS R10 R11 K33 ["zoomIsRequired"]
  MOVE R11 R9
  MOVE R12 R7
  CALL R10 2 1
  JUMPIFNOT R10 [+16]
  GETTABLEKS R12 R9 K34 ["ViewportSize"]
  GETTABLEKS R11 R12 K35 ["X"]
  GETTABLEKS R13 R9 K34 ["ViewportSize"]
  GETTABLEKS R12 R13 K36 ["Y"]
  DIV R10 R11 R12
  GETUPVAL R12 7
  GETTABLEKS R11 R12 K37 ["zoomToExtents"]
  MOVE R12 R9
  MOVE R13 R7
  MOVE R14 R10
  CALL R11 3 0
  ...
  MOVE R13 R7
  SETLIST R12 R13 1 [1]
  NAMECALL R10 R1 K38 ["Set"]
  CALL R10 2 0
  JUMPIFNOT R6 [+7]
  GETUPVAL R10 0
  MOVE R12 R6
  GETIMPORT R13 K42 [Enum.FinishRecordingOperation.Commit]
  NAMECALL R10 R10 K43 ["FinishRecording"]
  CALL R10 3 0
  RETURN R0 0
