PROTO_0:
        0 GETUPVAL                         R4 0
        1 GETTABLEKS                       R4 R4 K0 ["types"]
        3 GETTABLE                         R3 R4 R0
        4 GETTABLEKS                       R3 R3 K1 ["GuessMaxHeight"]
        6 GETUPVAL                         R5 0
        7 GETTABLEKS                       R5 R5 K0 ["types"]
        9 GETTABLE                         R4 R5 R1
       10 GETTABLEKS                       R4 R4 K1 ["GuessMaxHeight"]
       12 JUMPIFLT                         R3 R4 ; [+2]
       14 LOADB                            R2 0 +1
       15 LOADB                            R2 1
       16 RETURN                           R2 1
...
PROTO_1:
       ...
       27 FORGPREP                         R8
       28 GETUPVAL                         R14 1
       29 GETTABLEKS                       R14 R14 K1 ["types"]
       ...
       50 CALL                             R8 2 0
       51 GETUPVAL                         R8 1
       52 GETTABLEKS                       R8 R8 K13 ["setAvatarPartScaleTypeValueObjects"]
       54 MOVE                             R9 R0
       55 MOVE                             R10 R3
       56 CALL                             R8 2 0
       57 GETUPVAL                         R8 2
       58 GETTABLEKS                       R8 R8 K14 ["setBodyProportionScale"]
       60 GETTABLEKS                       R9 R0 K15 ["Humanoid"]
       62 GETTABLEKS                       R10 R4 K16 ["BodyProportionScale"]
       64 CALL                             R8 2 0
       65 GETUPVAL                         R8 2
       66 GETTABLEKS                       R8 R8 K17 ["setBodyTypeScale"]
...
MAIN:
       ...
       13 GETTABLEKS                       R2 R2 K8 ["AvatarScalingTypes"]
       15 CALL                             R1 1 1
       ...
       34 GETTABLEKS                       R5 R5 K7 ["Util"]
       36 GETTABLEKS                       R5 R5 K12 ["HumanoidValueUtil"]
       38 CALL                             R4 1 1
