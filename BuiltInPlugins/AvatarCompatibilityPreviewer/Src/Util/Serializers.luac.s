...
PROTO_2:
  ...
  MOVE R5 R6
  CALL R4 1 0
  DUPTABLE R4 K22 [{"palette", "item", "isHidden"}]
  SETTABLEKS R2 R4 K0 ["palette"]
  SETTABLEKS R3 R4 K8 ["item"]
  GETTABLEKS R5 R1 K21 ["isHidden"]
  SETTABLEKS R5 R4 K21 ["isHidden"]
  RETURN R4 1
...
MAIN:
  ...
  GETTABLEKS R8 R9 K19 ["getFFlagAvatarPreviewerNewAnimations"]
  CALL R7 1 1
  GETIMPORT R8 K1 [game]
  LOADK R10 K20 ["AvatarPreviewerRemoveIncorrectIfTrue"]
  LOADB R11 0
  ...
  CAPTURE VAL R6
  CAPTURE VAL R7
  SETTABLEKS R10 R9 K23 ["createEquippedItemsSerializer"]
  DUPTABLE R10 K26 [{"serialize", "deserialize"}]
  DUPCLOSURE R11 K27 [PROTO_6]
  CAPTURE VAL R0
  CAPTURE VAL R2
  CAPTURE VAL R3
  SETTABLEKS R11 R10 K24 ["serialize"]
  ...
  CAPTURE VAL R3
  CAPTURE VAL R4
  SETTABLEKS R11 R10 K25 ["deserialize"]
  SETTABLEKS R10 R9 K29 ["equippedItems_DEPRECATED"]
  RETURN R9 1
