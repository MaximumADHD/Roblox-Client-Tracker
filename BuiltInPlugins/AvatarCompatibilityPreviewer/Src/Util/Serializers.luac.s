PROTO_0:
        ...
        5 GETUPVAL                         R3 0
        6 GETTABLEKS                       R3 R3 K2 ["SOURCE_BUILTIN"]
        8 JUMPIFNOTEQ                      R2 R3 ; [+32]
       10 DUPTABLE                         R2 K4 [{"source", "builtinItem"}]
       11 GETUPVAL                         R3 0
       12 GETTABLEKS                       R3 R3 K2 ["SOURCE_BUILTIN"]
       14 SETTABLEKS                       R3 R2 K1 ["source"]
       16 GETTABLEKS                       R4 R0 K5 ["palette"]
       18 GETTABLEKS                       R4 R4 K6 ["Serializer"]
       20 JUMPIFNOT                        R4 ; [+12]
       21 GETTABLEKS                       R3 R0 K5 ["palette"]
       23 GETTABLEKS                       R3 R3 K6 ["Serializer"]
       25 GETTABLEKS                       R3 R3 K7 ["serialize"]
       27 GETTABLEKS                       R4 R0 K0 ["item"]
       29 GETTABLEKS                       R4 R4 K3 ["builtinItem"]
       31 CALL                             R3 1 1
       32 JUMP                             ; [+4]
       33 GETTABLEKS                       R3 R0 K0 ["item"]
       ...
       45 GETUPVAL                         R3 0
       46 GETTABLEKS                       R3 R3 K8 ["SOURCE_INSTANCE"]
       48 JUMPIFNOTEQ                      R2 R3 ; [+17]
       50 DUPTABLE                         R2 K10 [{"source", "key"}]
       51 GETUPVAL                         R3 0
       52 GETTABLEKS                       R3 R3 K8 ["SOURCE_INSTANCE"]
       54 SETTABLEKS                       R3 R2 K1 ["source"]
       56 GETTABLEKS                       R3 R0 K0 ["item"]
       58 GETTABLEKS                       R3 R3 K11 ["instance"]
       ...
       67 CALL                             R2 0 1
       68 JUMPIFNOT                        R2 ; [+23]
       69 GETTABLEKS                       R2 R0 K0 ["item"]
       71 GETTABLEKS                       R2 R2 K1 ["source"]
       73 GETUPVAL                         R3 0
       74 GETTABLEKS                       R3 R3 K13 ["SOURCE_MARKETPLACE"]
       76 JUMPIFNOTEQ                      R2 R3 ; [+15]
       78 DUPTABLE                         R2 K15 [{"source", "marketplaceItem"}]
       79 GETUPVAL                         R3 0
       80 GETTABLEKS                       R3 R3 K13 ["SOURCE_MARKETPLACE"]
       82 SETTABLEKS                       R3 R2 K1 ["source"]
       84 GETTABLEKS                       R3 R0 K0 ["item"]
...
PROTO_2:
       ...
       11 LOADB                            R4 1
       12 GETUPVAL                         R5 1
       13 GETTABLEKS                       R5 R5 K1 ["LUAU_ANALYZE_ERROR"]
       15 FASTCALL2                        ASSERT R4 R5 ; [+3]
       17 GETIMPORT                        R3 K3 [assert]
       19 CALL                             R3 2 0
       20 LOADNIL                          R3
       21 GETTABLEKS                       R4 R1 K4 ["item"]
       23 GETTABLEKS                       R4 R4 K5 ["source"]
       25 GETUPVAL                         R5 1
       26 GETTABLEKS                       R5 R5 K6 ["SOURCE_BUILTIN"]
       28 JUMPIFNOTEQ                      R4 R5 ; [+28]
       30 DUPTABLE                         R4 K8 [{"source", "builtinItem"}]
       31 GETUPVAL                         R5 1
       32 GETTABLEKS                       R5 R5 K6 ["SOURCE_BUILTIN"]
       34 SETTABLEKS                       R5 R4 K5 ["source"]
       36 GETTABLEKS                       R6 R2 K9 ["Serializer"]
       38 JUMPIFNOT                        R6 ; [+10]
       39 GETTABLEKS                       R5 R2 K9 ["Serializer"]
       41 GETTABLEKS                       R5 R5 K10 ["deserialize"]
       43 GETTABLEKS                       R6 R1 K4 ["item"]
       45 GETTABLEKS                       R6 R6 K7 ["builtinItem"]
       47 CALL                             R5 1 1
       48 JUMP                             ; [+4]
       49 GETTABLEKS                       R5 R1 K4 ["item"]
       ...
       61 GETUPVAL                         R5 1
       62 GETTABLEKS                       R5 R5 K11 ["SOURCE_INSTANCE"]
       64 JUMPIFNOTEQ                      R4 R5 ; [+23]
       66 GETUPVAL                         R4 2
       67 GETTABLEKS                       R6 R1 K4 ["item"]
       69 GETTABLEKS                       R6 R6 K12 ["key"]
       ...
       79 GETUPVAL                         R6 1
       80 GETTABLEKS                       R6 R6 K11 ["SOURCE_INSTANCE"]
       ...
       89 CALL                             R4 0 1
       90 JUMPIFNOT                        R4 ; [+37]
       91 GETTABLEKS                       R4 R1 K4 ["item"]
       93 GETTABLEKS                       R4 R4 K5 ["source"]
       95 GETUPVAL                         R5 1
       96 GETTABLEKS                       R5 R5 K16 ["SOURCE_MARKETPLACE"]
      ...
      103 RETURN                           R4 1
      104 GETUPVAL                         R4 5
      105 GETTABLEKS                       R4 R4 K17 ["extractUniqueId"]
      107 GETTABLEKS                       R5 R1 K4 ["item"]
      109 GETTABLEKS                       R5 R5 K18 ["marketplaceItem"]
      111 CALL                             R4 1 1
      112 GETUPVAL                         R5 4
...
PROTO_3:
        ...
        4 CALL                             R1 2 1
        5 GETUPVAL                         R2 1
        6 GETTABLEKS                       R2 R2 K1 ["collectArray"]
        8 MOVE                             R3 R1
        9 NEWCLOSURE                       R4 P0
       10 CAPTURE                          UPVAL U2
       11 CAPTURE                          UPVAL U3
...
MAIN:
       ...
       42 GETTABLEKS                       R6 R6 K16 ["getPaletteFromKey"]
       44 CALL                             R5 1 1
       45 GETIMPORT                        R6 K9 [require]
       47 GETTABLEKS                       R7 R1 K12 ["Src"]
       49 GETTABLEKS                       R7 R7 K13 ["Util"]
       51 GETTABLEKS                       R7 R7 K17 ["MarketplaceCatalogUtils"]
       53 CALL                             R6 1 1
       54 GETIMPORT                        R7 K9 [require]
       56 GETTABLEKS                       R8 R1 K12 ["Src"]
       58 GETTABLEKS                       R8 R8 K18 ["Flags"]
       60 GETTABLEKS                       R8 R8 K19 ["getFFlagAvatarPreviewerLookComposer"]
       62 CALL                             R7 1 1
       63 NEWTABLE                         R8 0 0
