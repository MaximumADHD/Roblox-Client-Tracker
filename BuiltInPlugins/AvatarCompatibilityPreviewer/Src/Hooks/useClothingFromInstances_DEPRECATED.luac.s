PROTO_0:
        ...
        8 LOADB                            R1 1
        9 GETUPVAL                         R2 1
       10 GETTABLEKS                       R2 R2 K0 ["LUAU_ANALYZE_ERROR"]
       ...
       20 NEWTABLE                         R1 0 0
       22 GETUPVAL                         R2 3
       23 GETTABLEKS                       R2 R2 K4 ["equippedItems"]
       25 LOADNIL                          R3
       26 LOADNIL                          R4
       27 FORGPREP                         R2
       28 GETTABLEKS                       R7 R6 K5 ["item"]
       30 GETTABLEKS                       R7 R7 K6 ["source"]
       32 GETUPVAL                         R8 1
       33 GETTABLEKS                       R8 R8 K7 ["SOURCE_INSTANCE"]
       35 JUMPIFNOTEQ                      R7 R8 ; [+60]
       37 GETTABLEKS                       R9 R6 K5 ["item"]
       39 GETTABLEKS                       R9 R9 K6 ["source"]
       41 GETUPVAL                         R10 1
       42 GETTABLEKS                       R10 R10 K7 ["SOURCE_INSTANCE"]
       44 JUMPIFEQ                         R9 R10 ; [+2]
       46 LOADB                            R8 0 +1
       47 LOADB                            R8 1
       48 GETUPVAL                         R9 1
       49 GETTABLEKS                       R9 R9 K0 ["LUAU_ANALYZE_ERROR"]
       51 FASTCALL2                        ASSERT R8 R9 ; [+3]
       53 GETIMPORT                        R7 K2 [assert]
       55 CALL                             R7 2 0
       56 GETUPVAL                         R8 2
       57 GETTABLEKS                       R8 R8 K3 ["current"]
       ...
       67 GETTABLEKS                       R7 R6 K9 ["palette"]
       69 GETTABLEKS                       R7 R7 K10 ["UpdateInstances"]
       71 JUMPIFEQKNIL                     R7 ; [+24]
       73 GETTABLEKS                       R7 R6 K9 ["palette"]
       75 GETTABLEKS                       R7 R7 K10 ["UpdateInstances"]
       ...
       83 JUMPIF                           R7 ; [+12]
       84 GETTABLEKS                       R7 R6 K9 ["palette"]
       86 GETTABLEKS                       R7 R7 K11 ["WearInstance"]
       88 GETTABLEKS                       R8 R6 K5 ["item"]
       90 GETTABLEKS                       R8 R8 K12 ["instance"]
       92 GETUPVAL                         R9 0
       93 MOVE                             R10 R5
       94 CALL                             R7 3 1
       ...
       96 FORGLOOP                         R2 2 ; [-69]
       98 GETUPVAL                         R2 4
       99 GETTABLEKS                       R2 R2 K3 ["current"]
      101 LOADNIL                          R3
      102 LOADNIL                          R4
      103 FORGPREP                         R2
      ...
      107 GETUPVAL                         R8 2
      108 GETTABLEKS                       R8 R8 K3 ["current"]
      110 GETTABLE                         R7 R8 R6
      111 JUMPIFEQKNIL                     R7 ; [+15]
      113 GETUPVAL                         R10 2
      114 GETTABLEKS                       R10 R10 K3 ["current"]
      ...
      129 GETUPVAL                         R2 4
      130 GETUPVAL                         R3 3
      131 GETTABLEKS                       R3 R3 K4 ["equippedItems"]
...
PROTO_3:
        ...
        8 CALL                             R1 2 0
        9 GETUPVAL                         R1 1
       10 GETTABLEKS                       R1 R1 K3 ["useContext"]
       12 GETUPVAL                         R2 2
       13 CALL                             R1 1 1
       14 GETUPVAL                         R2 1
       15 GETTABLEKS                       R2 R2 K4 ["useRef"]
       17 NEWTABLE                         R3 0 0
       19 CALL                             R2 1 1
       20 GETUPVAL                         R3 1
       21 GETTABLEKS                       R3 R3 K4 ["useRef"]
       23 NEWTABLE                         R4 0 0
       25 CALL                             R3 1 1
       ...
       31 LOADB                            R5 1
       32 GETUPVAL                         R6 3
       33 GETTABLEKS                       R6 R6 K6 ["LUAU_ANALYZE_ERROR"]
       ...
       45 LOADB                            R5 1
       46 GETUPVAL                         R6 3
       47 GETTABLEKS                       R6 R6 K6 ["LUAU_ANALYZE_ERROR"]
       49 FASTCALL2                        ASSERT R5 R6 ; [+3]
       51 GETIMPORT                        R4 K2 [assert]
       53 CALL                             R4 2 0
       54 GETUPVAL                         R4 1
       55 GETTABLEKS                       R4 R4 K7 ["useEffect"]
       57 NEWCLOSURE                       R5 P0
       58 CAPTURE                          VAL R0
       59 CAPTURE                          UPVAL U3
       60 CAPTURE                          VAL R2
       ...
       70 CALL                             R4 2 0
       71 GETUPVAL                         R4 1
       72 GETTABLEKS                       R4 R4 K7 ["useEffect"]
       74 NEWCLOSURE                       R5 P1
       75 CAPTURE                          VAL R2
       76 NEWTABLE                         R6 0 1
       78 MOVE                             R7 R0
...
MAIN:
       ...
       45 GETTABLEKS                       R6 R6 K14 ["getFFlagAvatarPreviewerEditingTools"]
       47 CALL                             R5 1 1
