...
PROTO_3:
  ...
  LOADK R2 K0 ["FFlagAvatarPreviewerAutoSetup is not enabled"]
  GETIMPORT R0 K2 [assert]
  CALL R0 2 0
  GETUPVAL R0 1
  CALL R0 0 1
  ...
  JUMPIFEQKNIL R1 [+5]
  DUPTABLE R3 K5 [{"avatar"}]
  SETTABLEKS R1 R3 K4 ["avatar"]
  JUMP [+7]
  JUMPIFEQKNIL R0 [+5]
  DUPTABLE R3 K7 [{"autoSetupTarget"}]
  SETTABLEKS R0 R3 K6 ["autoSetupTarget"]
  JUMP [+1]
  LOADNIL R3
  CALL R2 1 2
  GETUPVAL R5 3
