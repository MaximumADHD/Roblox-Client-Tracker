...
PROTO_6:
  ...
  CALL R4 1 1
  SETTABLEKS R3 R4 K6 ["HeadColor"]
  SETTABLEKS R3 R4 K7 ["TorsoColor"]
  SETTABLEKS R3 R4 K8 ["LeftArmColor"]
  SETTABLEKS R3 R4 K9 ["RightArmColor"]
  SETTABLEKS R3 R4 K10 ["LeftLegColor"]
  SETTABLEKS R3 R4 K11 ["RightLegColor"]
  MOVE R1 R4
  GETUPVAL R4 1
  GETTABLEKS R3 R4 K4 ["avatarAssets"]
  GETTABLEKS R2 R3 K25 ["patches"]
...
PROTO_7:
  ...
  GETTABLEKS R5 R2 K3 ["avatarAssets"]
  GETTABLEKS R4 R5 K4 ["clothing"]
  GETUPVAL R6 3
  GETTABLEKS R5 R6 K5 ["collectArray"]
  GETTABLEKS R7 R2 K3 ["avatarAssets"]
  GETTABLEKS R6 R7 K6 ["accessories"]
  DUPCLOSURE R7 K7 [PROTO_5]
  CALL R5 2 -1
  CALL R3 -1 1
  GETUPVAL R5 0
...
MAIN:
  ...
  GETTABLEKS R9 R10 K17 ["getFFlagAvatarPreviewerImportBodyColors"]
  CALL R8 1 1
