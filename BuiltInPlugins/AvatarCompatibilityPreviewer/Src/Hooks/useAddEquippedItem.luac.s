...
PROTO_3:
  ...
  JUMPIFNOT R3 [+33]
  GETUPVAL R5 1
  GETTABLEKS R4 R5 K4 ["palette"]
  GETTABLEKS R3 R4 K5 ["MaxItems"]
  ...
  JUMP [+25]
  GETUPVAL R4 0
  GETTABLEKS R3 R4 K8 ["count"]
  MOVE R4 R1
  NEWCLOSURE R5 P1
  CAPTURE UPVAL U1
  CALL R3 2 1
  GETUPVAL R6 1
  GETTABLEKS R5 R6 K4 ["palette"]
  GETTABLEKS R4 R5 K5 ["MaxItems"]
  JUMPIFNOTLE R4 R3 [+12]
  ...
  GETUPVAL R5 1
  GETTABLEKS R4 R5 K4 ["palette"]
  GETTABLEKS R3 R4 K9 ["PreferredLayer"]
  ...
  MOVE R6 R1
  GETUPVAL R9 1
  GETTABLEKS R8 R9 K4 ["palette"]
  GETTABLEKS R7 R8 K9 ["PreferredLayer"]
  CALL R5 2 1
  GETUPVAL R6 1
...
MAIN:
  ...
  GETTABLEKS R6 R7 K14 ["getFFlagAvatarPreviewerMakeup"]
  CALL R5 1 1
