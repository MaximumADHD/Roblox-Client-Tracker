...
PROTO_13:
       ...
       27 CALL                             R3 1 2
       28 GETUPVAL                         R5 1
       29 GETTABLEKS                       R5 R5 K2 ["useCallback"]
       31 NEWCLOSURE                       R6 P1
       32 CAPTURE                          VAL R3
       33 CAPTURE                          UPVAL U5
       34 CAPTURE                          UPVAL U6
       ...
       40 CALL                             R5 2 1
       41 GETUPVAL                         R6 1
       42 GETTABLEKS                       R6 R6 K3 ["useState"]
       44 MOVE                             R7 R5
       45 CALL                             R6 1 2
       46 GETUPVAL                         R8 7
       47 GETTABLEKS                       R9 R1 K4 ["SelectionChanged"]
       ...
       60 CALL                             R8 3 0
       61 GETUPVAL                         R8 1
       62 GETTABLEKS                       R8 R8 K5 ["useEffect"]
       64 NEWCLOSURE                       R9 P3
       65 CAPTURE                          VAL R3
       66 CAPTURE                          VAL R7
       67 CAPTURE                          UPVAL U9
       ...
       75 CALL                             R8 2 0
       76 GETUPVAL                         R8 1
       77 GETTABLEKS                       R8 R8 K6 ["useMemo"]
       79 NEWCLOSURE                       R9 P4
       80 CAPTURE                          VAL R6
...
MAIN:
      ...
      103 GETTABLEKS                       R13 R13 K24 ["Flags"]
      105 GETTABLEKS                       R13 R13 K25 ["getFFlagAvatarPreviewerSelectionStability"]
      107 CALL                             R12 1 1
      ...
      111 CAPTURE                          VAL R5
      112 CAPTURE                          VAL R9
      113 DUPCLOSURE                       R14 K27 [PROTO_2]
      114 DUPCLOSURE                       R15 K28 [PROTO_3]
      115 CAPTURE                          VAL R0
      116 DUPCLOSURE                       R16 K29 [PROTO_4]
      117 CAPTURE                          VAL R13
      118 DUPCLOSURE                       R17 K30 [PROTO_5]
      119 DUPCLOSURE                       R18 K31 [PROTO_13]
      120 CAPTURE                          VAL R8
      121 CAPTURE                          VAL R3
      122 CAPTURE                          VAL R0
      123 CAPTURE                          VAL R15
