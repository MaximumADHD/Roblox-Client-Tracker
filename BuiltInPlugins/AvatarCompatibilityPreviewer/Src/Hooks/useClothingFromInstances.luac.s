PROTO_0:
  ...
  GETTABLEKS R7 R8 K9 ["UpdateInstances"]
  JUMPIFEQKNIL R7 [+49]
  GETTABLEKS R8 R6 K8 ["palette"]
  GETTABLEKS R7 R8 K9 ["UpdateInstances"]
  GETTABLE R8 R0 R6
  ...
  JUMP [+40]
  GETTABLEKS R8 R6 K8 ["palette"]
  GETTABLEKS R7 R8 K10 ["UpdateInstance_DEPRECATED"]
  JUMPIFEQKNIL R7 [+35]
  GETTABLEKS R8 R6 K8 ["palette"]
  GETTABLEKS R7 R8 K10 ["UpdateInstance_DEPRECATED"]
  ...
  JUMP [+23]
  GETTABLEKS R8 R6 K8 ["palette"]
  GETTABLEKS R7 R8 K12 ["WearInstance"]
  GETTABLEKS R9 R6 K5 ["item"]
  GETTABLEKS R8 R9 K11 ["instance"]
  GETUPVAL R9 0
  MOVE R10 R5
...
MAIN:
  ...
  GETTABLEKS R7 R8 K15 ["getFFlagAvatarPreviewerFixUserInsertedClothingOrdering"]
  CALL R6 1 1
