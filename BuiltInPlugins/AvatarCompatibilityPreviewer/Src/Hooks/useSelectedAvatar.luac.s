...
PROTO_12:
       ...
       43 JUMPIFNOT                        R8 ; [+9]
       44 GETUPVAL                         R8 1
       45 GETTABLEKS                       R8 R8 K4 ["useContext"]
       47 GETUPVAL                         R9 4
       48 GETTABLEKS                       R9 R9 K5 ["Context"]
       50 CALL                             R8 1 1
       51 MOVE                             R7 R8
       52 JUMP                             ; [+1]
       53 LOADNIL                          R7
       ...
       69 CALL                             R8 3 0
       70 GETUPVAL                         R8 1
       71 GETTABLEKS                       R8 R8 K2 ["useCallback"]
       73 NEWCLOSURE                       R9 P3
       74 CAPTURE                          VAL R3
       75 CAPTURE                          UPVAL U6
       76 CAPTURE                          UPVAL U2
       ...
       86 CALL                             R8 2 1
       87 GETUPVAL                         R9 1
       88 GETTABLEKS                       R9 R9 K3 ["useState"]
       90 NEWCLOSURE                       R10 P4
       91 CAPTURE                          VAL R8
       92 CAPTURE                          UPVAL U6
       93 CALL                             R9 1 2
       94 GETUPVAL                         R11 1
       95 GETTABLEKS                       R11 R11 K7 ["useEffect"]
      ...
      109 CALL                             R11 2 0
      110 GETUPVAL                         R11 1
      111 GETTABLEKS                       R11 R11 K8 ["useMemo"]
      ...
      125 CALL                             R11 2 1
      126 GETUPVAL                         R12 1
      127 GETTABLEKS                       R12 R12 K8 ["useMemo"]
