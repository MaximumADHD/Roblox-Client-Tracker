PROTO_0:
  ...
  LOADK R7 K8 ["Reference child wasn't a part of reference"]
  GETIMPORT R5 K2 [assert]
  CALL R5 2 0
  JUMPIFEQ R4 R0 [+2]
  JUMPBACK [-33]
  ...
  FORNPREP R6
  GETTABLE R11 R3 R8
  NAMECALL R9 R5 K9 ["FindFirstChild"]
  CALL R9 2 1
  ...
  LOADB R11 1
  GETUPVAL R13 0
  GETTABLEKS R12 R13 K10 ["LUAU_ANALYZE_ERROR"]
  FASTCALL2 ASSERT R11 R12 [+3]
  GETIMPORT R10 K2 [assert]
  CALL R10 2 0
  MOVE R5 R9
  FORNLOOP R6
  GETTABLEKS R6 R5 K11 ["ClassName"]
  GETTABLEKS R7 R1 K11 ["ClassName"]
  JUMPIFEQ R6 R7 [+3]
  LOADNIL R6
  RETURN R6 1
  RETURN R5 1
...
PROTO_2:
  ...
  LOADB R7 1
  GETUPVAL R9 4
  GETTABLEKS R8 R9 K0 ["LUAU_ANALYZE_ERROR"]
  ...
  CALL R6 2 1
  JUMPIFEQKNIL R6 [+56]
  LOADK R9 K10 ["Attachment"]
  NAMECALL R7 R6 K6 ["IsA"]
  CALL R7 2 1
  JUMPIFNOT R7 [+50]
  LOADB R8 0
  JUMPIFEQKNIL R6 [+5]
  LOADK R10 K10 ["Attachment"]
  ...
  CALL R7 2 0
  LOADK R9 K11 ["AccessoryWeld"]
  NAMECALL R7 R5 K8 ["FindFirstChild"]
  CALL R7 2 1
  JUMPIFEQKNIL R7 [+30]
  LOADK R10 K12 ["Weld"]
  ...
  CALL R9 2 1
  GETUPVAL R11 4
  GETTABLEKS R10 R11 K0 ["LUAU_ANALYZE_ERROR"]
  FASTCALL2 ASSERT R9 R10 [+3]
  GETIMPORT R8 K2 [assert]
  CALL R8 2 0
  GETTABLEKS R8 R6 K3 ["CFrame"]
  SETTABLEKS R8 R7 K13 ["C0"]
  GETUPVAL R9 0
  GETTABLEKS R8 R9 K3 ["CFrame"]
  SETTABLEKS R8 R7 K14 ["C1"]
  FORGLOOP R0 2 [-87]
  RETURN R0 0
...
PROTO_4:
  ...
  GETUPVAL R4 2
  GETIMPORT R6 K8 [Enum.CageType.Outer]
  NAMECALL R4 R4 K9 ["GetVertices"]
  CALL R4 2 -1
  NAMECALL R1 R0 K10 ["ModifyVertices"]
  CALL R1 -1 0
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R7 R8 K14 ["getFFlagAvatarPreviewerProportionControls"]
  CALL R6 1 1
