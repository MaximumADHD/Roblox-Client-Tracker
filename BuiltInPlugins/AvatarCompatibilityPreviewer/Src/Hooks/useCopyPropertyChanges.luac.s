PROTO_0:
  ...
  LOADK R7 K13 ["Reference child wasn't a part of reference"]
  GETIMPORT R5 K2 [assert]
  CALL R5 2 0
  JUMPIFEQ R4 R0 [+2]
  JUMPBACK [-50]
  ...
  FORNPREP R6
  GETTABLE R11 R3 R8
  NAMECALL R9 R5 K14 ["FindFirstChild"]
  CALL R9 2 1
  ...
  LOADB R11 1
  GETUPVAL R13 1
  GETTABLEKS R12 R13 K15 ["LUAU_ANALYZE_ERROR"]
  FASTCALL2 ASSERT R11 R12 [+3]
  GETIMPORT R10 K2 [assert]
  CALL R10 2 0
  MOVE R5 R9
  FORNLOOP R6
  GETTABLEKS R6 R5 K16 ["ClassName"]
  GETTABLEKS R7 R1 K16 ["ClassName"]
  JUMPIFEQ R6 R7 [+3]
  LOADNIL R6
  RETURN R6 1
  RETURN R5 1
...
MAIN:
  ...
  GETTABLEKS R7 R8 K14 ["getFFlagAvatarPreviewerReplicateEditorStateOnWorldModel"]
  CALL R6 1 1
