PROTO_0:
       ...
       15 JUMPIFNOT                        R2 ; [+6]
       16 GETUPVAL                         R2 4
       17 GETTABLEKS                       R1 R2 K1 ["deserialize"]
       19 MOVE                             R2 R0
       20 CALL                             R1 1 1
       21 RETURN                           R1 1
       22 MOVE                             R1 R0
...
PROTO_3:
        ...
        3 JUMPIFNOT                        R4 ; [+6]
        4 GETUPVAL                         R4 2
        5 GETTABLEKS                       R3 R4 K0 ["serialize"]
        7 GETUPVAL                         R4 3
        8 CALL                             R3 1 1
        9 JUMP                             ; [+1]
       10 GETUPVAL                         R3 3
...
PROTO_4:
        0 GETUPVAL                         R7 0
        1 GETTABLEKS                       R5 R7 K0 ["ATTRIBUTE_PREFIX"]
        3 MOVE                             R6 R1
        4 CONCAT                           R4 R5 R6
        5 GETUPVAL                         R6 1
        6 GETTABLEKS                       R5 R6 K1 ["useMemo"]
        8 NEWCLOSURE                       R6 P0
        9 CAPTURE                          UPVAL U2
       10 CAPTURE                          VAL R0
       11 CAPTURE                          VAL R4
       ...
       59 MOVE                             R8 R5
       60 GETUPVAL                         R10 1
       61 GETTABLEKS                       R9 R10 K10 ["useCallback"]
       ...
       75 CALL                             R9 2 1
       76 GETUPVAL                         R11 1
       77 GETTABLEKS                       R10 R11 K11 ["useEffect"]
...
MAIN:
       ...
       36 GETTABLEKS                       R5 R6 K13 ["getFFlagDebugAvatarPreviewerAvoidSerialization"]
       38 CALL                             R4 1 1
