...
PROTO_6:
  ...
  GETUPVAL R0 4
  GETUPVAL R2 1
  NAMECALL R0 R0 K4 ["LoadAnimation"]
  CALL R0 2 1
  SETUPVAL R0 3
  GETUPVAL R0 2
  GETIMPORT R2 K2 [game]
...
PROTO_8:
  ...
  GETUPVAL R1 4
  GETUPVAL R5 5
  GETTABLEKS R4 R5 K10 ["TestAssets"]
  GETTABLEKS R3 R4 K11 ["idle"]
  NAMECALL R1 R1 K12 ["RegisterAnimationClip"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K13 ["AnimationId"]
  JUMP [+8]
  LOADK R2 K14 ["rbxassetid://%*"]
  GETUPVAL R4 6
  NAMECALL R2 R2 K15 ["format"]
  CALL R2 2 1
  MOVE R1 R2
  SETTABLEKS R1 R0 K13 ["AnimationId"]
  GETUPVAL R1 7
...
MAIN:
  ...
  LOADK R10 K19 ["DebugAvatarPreviewerUseLocalAnimationsOnly"]
  LOADB R11 0
