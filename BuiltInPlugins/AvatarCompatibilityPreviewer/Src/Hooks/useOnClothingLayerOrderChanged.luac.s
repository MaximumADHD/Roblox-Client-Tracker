PROTO_0:
  ...
  CALL R10 1 1
  GETUPVAL R12 3
  GETTABLEKS R11 R12 K1 ["layerType"]
  JUMPIFNOTEQ R10 R11 [+19]
  JUMP [+5]
  GETUPVAL R10 2
  MOVE R11 R9
  CALL R10 1 1
  JUMPIFNOTEQKS R10 K2 ["layered"] [+13]
  ADDK R4 R4 K3 [1]
  JUMPIFNOTEQ R4 R0 [+3]
  MOVE R2 R8
  JUMP [+3]
  ...
  NEWTABLE R5 0 4
  LOADK R6 K4 ["Couldn't resolve true indices of layered clothing"]
  LOADK R8 K5 ["Swapping %* with %*"]
  MOVE R10 R0
  MOVE R11 R1
  NAMECALL R8 R8 K6 ["format"]
  CALL R8 3 1
  MOVE R7 R8
  LOADK R9 K7 ["trueLayeredClothingIndex = %*"]
  MOVE R11 R2
  NAMECALL R9 R9 K6 ["format"]
  CALL R9 2 1
  MOVE R8 R9
  LOADK R10 K8 ["#equipmentState.equippedItems = %*"]
  GETUPVAL R14 0
  ...
  LOADNIL R8
  FORGPREP R6
  LOADK R14 K9 ["	%*. %* (Layered clothing = %*)"]
  MOVE R16 R9
  GETTABLEKS R18 R10 K10 ["palette"]
  GETTABLEKS R17 R18 K11 ["Key"]
  GETIMPORT R19 K14 [table.find]
  GETUPVAL R21 4
  GETTABLEKS R20 R21 K15 ["clothing"]
  GETTABLEKS R21 R10 K10 ["palette"]
  CALL R19 2 1
...
"]
  ...
  CALL R6 -1 0
  GETUPVAL R6 0
  GETTABLEKS R5 R6 K23 ["moveEquippedItemsToIndex"]
  MOVE R6 R2
  MOVE R7 R3
  CALL R5 2 0
  RETURN R0 0
...
PROTO_1:
  ...
  CAPTURE UPVAL U4
  NEWTABLE R4 0 1
  GETTABLEKS R5 R1 K2 ["equippedItems"]
  SETLIST R4 R5 1 [1]
  CALL R2 2 -1
  RETURN R2 -1
...
MAIN:
  ...
  GETTABLEKS R6 R7 K15 ["getFFlagAvatarPreviewerMakeup"]
  CALL R5 1 1
  GETIMPORT R6 K5 [require]
  GETTABLEKS R9 R0 K8 ["Src"]
  GETTABLEKS R8 R9 K11 ["Util"]
  GETTABLEKS R7 R8 K16 ["getItemAccessoryType"]
  CALL R6 1 1
