...
PROTO_43:
  ...
  JUMPIFNOT R0 [+65]
  GETUPVAL R1 3
  GETTABLEKS R0 R1 K0 ["SetupType"]
  JUMPIFEQKS R0 K1 ["Unspecified"] [+61]
  GETUPVAL R1 3
  GETTABLEKS R0 R1 K2 ["ClothingOnly"]
  JUMPIFNOT R0 [+56]
  GETUPVAL R0 4
  LOADK R2 K3 ["autoSetupClothingOnlyFinish"]
  GETUPVAL R3 3
  NAMECALL R0 R0 K4 ["report"]
  CALL R0 3 0
  GETUPVAL R1 3
  GETTABLEKS R0 R1 K5 ["shouldCreateTemplateBody"]
  JUMPIFNOT R0 [+36]
  GETUPVAL R1 5
  GETTABLEKS R0 R1 K6 ["createTemplateBodyFromOutfitId"]
  GETUPVAL R2 6
  GETTABLEKS R1 R2 K7 ["TEMPLATE_BODY_OUTFIT_ID"]
  CALL R0 1 1
  GETUPVAL R1 7
  NAMECALL R1 R1 K8 ["Clone"]
  CALL R1 1 1
  NAMECALL R2 R1 K9 ["GetDescendants"]
  CALL R2 1 3
  FORGPREP R2
  LOADK R9 K10 ["BasePart"]
  NAMECALL R7 R6 K11 ["IsA"]
  CALL R7 2 1
  JUMPIFNOT R7 [+2]
  SETTABLEKS R0 R6 K12 ["Parent"]
  FORGLOOP R2 2 [-8]
  SETUPVAL R0 7
  GETUPVAL R3 5
  GETTABLEKS R2 R3 K13 ["insertBodyAsync"]
  LOADNIL R3
  GETUPVAL R4 8
  GETUPVAL R5 7
  GETUPVAL R6 9
  ...
  JUMP [+32]
  GETUPVAL R1 5
  GETTABLEKS R0 R1 K14 ["insertClothingAsync"]
  GETUPVAL R1 8
  GETUPVAL R2 7
  GETUPVAL R3 9
  GETUPVAL R4 10
  ...
  JUMPIFNOT R0 [+11]
  GETUPVAL R1 5
  GETTABLEKS R0 R1 K13 ["insertBodyAsync"]
  GETUPVAL R1 13
  GETUPVAL R2 8
  GETUPVAL R3 7
  GETUPVAL R4 9
  ...
  CALL R0 1 0
  GETUPVAL R0 4
  LOADK R2 K15 ["autoSetupFinish"]
  GETIMPORT R4 K18 [os.clock]
  CALL R4 0 1
  GETUPVAL R5 16
  SUB R3 R4 R5
  GETUPVAL R4 10
  ...
  CALL R0 5 0
  GETUPVAL R0 4
  LOADK R2 K19 ["autoSetupAssetsGenerated"]
  GETUPVAL R3 17
  GETUPVAL R4 10
  CALL R3 1 1
  GETUPVAL R4 18
...
PROTO_45:
  ...
  CALL R2 1 0
  GETIMPORT R2 K13 [os.clock]
  CALL R2 0 1
  GETTABLEKS R3 R0 K14 ["model"]
  JUMPIFNOTEQKNIL R3 [+6]
  GETIMPORT R3 K16 [error]
  LOADK R4 K17 ["Must have model"]
  CALL R3 1 0
  RETURN R0 0
  GETUPVAL R3 4
  CALL R3 0 1
  JUMPIFNOT R3 [+15]
  GETUPVAL R4 5
  GETTABLEKS R3 R4 K18 ["collapseTopLevelFolders"]
  ...
  CALL R3 1 0
  GETUPVAL R4 5
  GETTABLEKS R3 R4 K19 ["setModelIntendedName"]
  MOVE R4 R0
  CALL R3 1 0
  GETUPVAL R4 7
  GETTABLEKS R3 R4 K20 ["computeHashSerializeContext"]
  NEWTABLE R4 0 1
  GETTABLEKS R5 R0 K14 ["model"]
  SETLIST R4 R5 1 [1]
  DUPTABLE R5 K23 [{"ignoreUniformScaleChanges", "ignoreAccessories"}]
  LOADB R6 0
  SETTABLEKS R6 R5 K21 ["ignoreUniformScaleChanges"]
  LOADB R6 1
  SETTABLEKS R6 R5 K22 ["ignoreAccessories"]
  CALL R3 2 1
  GETUPVAL R5 7
  GETTABLEKS R4 R5 K24 ["hashCharacter"]
  GETTABLEKS R5 R0 K14 ["model"]
  MOVE R6 R3
  CALL R4 2 1
  GETUPVAL R5 8
  ...
  CALL R5 1 0
  GETUPVAL R7 10
  GETTABLEKS R6 R7 K25 ["current"]
  GETTABLE R5 R6 R4
  JUMPIFEQKNIL R5 [+30]
  GETTABLEKS R6 R5 K26 ["PrimaryPart"]
  JUMPIFEQKNIL R6 [+26]
  GETUPVAL R10 11
  GETTABLEKS R9 R10 K27 ["ATTRIBUTE_AUTO_SETUP_INPUT_ASSET"]
  NAMECALL R7 R5 K28 ["GetAttribute"]
  CALL R7 2 1
  ORK R6 R7 K10 [""]
  GETIMPORT R7 K31 [task.spawn]
  NEWCLOSURE R8 P0
  CAPTURE UPVAL U8
  CAPTURE UPVAL U12
  CAPTURE UPVAL U13
  ...
  JUMPIFNOT R6 [+12]
  GETUPVAL R6 19
  LOADK R8 K32 ["autoSetupRequested"]
  GETUPVAL R10 5
  GETTABLEKS R9 R10 K33 ["getClothingCategoryCounts"]
  GETTABLEKS R10 R0 K14 ["model"]
  CALL R9 1 -1
  NAMECALL R6 R6 K34 ["report"]
  CALL R6 -1 0
  JUMP [+5]
  GETUPVAL R6 19
  LOADK R8 K32 ["autoSetupRequested"]
  ...
  MOVE R6 R7
  GETUPVAL R7 25
  DUPTABLE R8 K39 [{"timeStart", "assetId", "modelHash"}]
  SETTABLEKS R2 R8 K36 ["timeStart"]
  LOADK R9 K40 ["no model uploaded"]
  SETTABLEKS R9 R8 K37 ["assetId"]
  SETTABLEKS R4 R8 K38 ["modelHash"]
  SETTABLEKS R8 R7 K25 ["current"]
  GETUPVAL R7 1
  MOVE R8 R6
  CALL R7 1 0
  GETUPVAL R8 17
  GETTABLEKS R7 R8 K41 ["autoSetupClickedSignal"]
  JUMPIFEQKNIL R7 [+7]
  GETUPVAL R8 17
  GETTABLEKS R7 R8 K41 ["autoSetupClickedSignal"]
  NAMECALL R7 R7 K42 ["Fire"]
  CALL R7 1 0
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R30 R31 K44 ["getFFlagAvatarPreviewerSortClothingUI"]
  CALL R29 1 1
  GETIMPORT R30 K11 [require]
  GETTABLEKS R33 R3 K12 ["Src"]
  GETTABLEKS R32 R33 K38 ["Flags"]
  GETTABLEKS R31 R32 K45 ["getFFlagDebugAvatarPreviewerSharedCache"]
  CALL R30 1 1
  GETIMPORT R31 K11 [require]
  GETTABLEKS R34 R3 K12 ["Src"]
  GETTABLEKS R33 R34 K38 ["Flags"]
  GETTABLEKS R32 R33 K46 ["getFFlagFixLayeredClothingAssignment"]
  CALL R31 1 1
  GETIMPORT R32 K11 [require]
  GETTABLEKS R35 R3 K12 ["Src"]
  GETTABLEKS R34 R35 K38 ["Flags"]
  GETTABLEKS R33 R34 K47 ["getFFlagIncludeBodyColorsInAutoSetup"]
  CALL R32 1 1
  GETIMPORT R33 K11 [require]
  GETTABLEKS R36 R3 K12 ["Src"]
  GETTABLEKS R35 R36 K38 ["Flags"]
  GETTABLEKS R34 R35 K48 ["getFFlagNoAvatarAutoSetupInputModelUpload"]
  CALL R33 1 1
  GETIMPORT R34 K11 [require]
  GETTABLEKS R37 R3 K12 ["Src"]
  GETTABLEKS R36 R37 K15 ["Util"]
  GETTABLEKS R35 R36 K49 ["getRotationInXZPlane"]
  CALL R34 1 1
  GETIMPORT R35 K11 [require]
  GETTABLEKS R38 R3 K12 ["Src"]
  GETTABLEKS R37 R38 K38 ["Flags"]
  GETTABLEKS R36 R37 K50 ["getFIntAvatarPreviewerMaxSerializedModelToSendBytes"]
  CALL R35 1 1
  GETIMPORT R36 K11 [require]
  GETTABLEKS R40 R3 K12 ["Src"]
  GETTABLEKS R39 R40 K13 ["Components"]
  GETTABLEKS R38 R39 K51 ["DisambiguationMenuContext"]
  GETTABLEKS R37 R38 K52 ["inferLoneMeshPartAssignment"]
  CALL R36 1 1
  GETIMPORT R37 K11 [require]
  GETTABLEKS R41 R3 K12 ["Src"]
  GETTABLEKS R40 R41 K13 ["Components"]
  GETTABLEKS R39 R40 K51 ["DisambiguationMenuContext"]
  GETTABLEKS R38 R39 K53 ["assignLoneMeshParts"]
  CALL R37 1 1
  GETIMPORT R38 K11 [require]
  GETTABLEKS R41 R3 K12 ["Src"]
  GETTABLEKS R40 R41 K15 ["Util"]
  GETTABLEKS R39 R40 K54 ["renameChildrenForClothing"]
  CALL R38 1 1
  DUPTABLE R39 K63 [{"Created", "Pending", "Processing", "Finalizing", "Completed", "Invalid", "Failed", "Canceled"}]
  LOADN R40 1
  SETTABLEKS R40 R39 K55 ["Created"]
  LOADN R40 2
  SETTABLEKS R40 R39 K56 ["Pending"]
  LOADN R40 3
  SETTABLEKS R40 R39 K57 ["Processing"]
  LOADN R40 4
  SETTABLEKS R40 R39 K58 ["Finalizing"]
  LOADN R40 5
  SETTABLEKS R40 R39 K59 ["Completed"]
  LOADN R40 101
  SETTABLEKS R40 R39 K60 ["Invalid"]
  LOADN R40 102
  SETTABLEKS R40 R39 K61 ["Failed"]
  LOADN R40 103
  SETTABLEKS R40 R39 K62 ["Canceled"]
  DUPCLOSURE R40 K64 [PROTO_0]
  CAPTURE VAL R25
  CAPTURE VAL R7
  CAPTURE VAL R13
  CAPTURE VAL R12
  ...
  CAPTURE VAL R9
  CAPTURE VAL R2
  DUPCLOSURE R47 K71 [PROTO_13]
  CAPTURE VAL R25
  CAPTURE VAL R27
  DUPCLOSURE R48 K72 [PROTO_14]
  CAPTURE VAL R25
  DUPCLOSURE R49 K73 [PROTO_15]
  CAPTURE VAL R25
  CAPTURE VAL R18
  DUPCLOSURE R50 K74 [PROTO_16]
  CAPTURE VAL R25
  CAPTURE VAL R18
  DUPCLOSURE R51 K75 [PROTO_17]
  CAPTURE VAL R25
  CAPTURE VAL R18
  CAPTURE VAL R15
  DUPCLOSURE R52 K76 [PROTO_18]
  CAPTURE VAL R25
  CAPTURE VAL R6
  CAPTURE VAL R27
  CAPTURE VAL R15
  DUPCLOSURE R53 K77 [PROTO_20]
  CAPTURE VAL R25
  CAPTURE VAL R31
  DUPCLOSURE R54 K78 [PROTO_22]
  CAPTURE VAL R25
  CAPTURE VAL R32
  DUPCLOSURE R55 K79 [PROTO_23]
  CAPTURE VAL R25
  CAPTURE VAL R31
  DUPCLOSURE R56 K80 [PROTO_24]
  CAPTURE VAL R25
  CAPTURE VAL R31
  CAPTURE VAL R23
  CAPTURE VAL R18
  ...
  CAPTURE VAL R53
  CAPTURE VAL R37
  DUPCLOSURE R57 K81 [PROTO_25]
  CAPTURE VAL R25
  DUPCLOSURE R58 K82 [PROTO_26]
  CAPTURE VAL R25
  CAPTURE VAL R57
  CAPTURE VAL R12
  DUPCLOSURE R59 K83 [PROTO_27]
  CAPTURE VAL R0
  CAPTURE VAL R12
  CAPTURE VAL R25
  CAPTURE VAL R5
  ...
  CAPTURE VAL R46
  CAPTURE VAL R10
  DUPCLOSURE R60 K84 [PROTO_28]
  CAPTURE VAL R8
  CAPTURE VAL R35
  DUPCLOSURE R61 K85 [PROTO_47]
  CAPTURE VAL R14
  CAPTURE VAL R17
  CAPTURE VAL R16
  CAPTURE VAL R4
