...
MAIN:
  ...
  GETTABLEKS R17 R18 K29 ["getFFlagAvatarPreviewerAutoSetupFixPositioning"]
  CALL R16 1 1
  GETIMPORT R17 K11 [require]
  GETTABLEKS R20 R3 K16 ["Src"]
  GETTABLEKS R19 R20 K26 ["Flags"]
  GETTABLEKS R18 R19 K30 ["getFFlagAvatarPreviewerDisableETA"]
  CALL R17 1 1
  GETIMPORT R18 K11 [require]
  GETTABLEKS R21 R3 K16 ["Src"]
  GETTABLEKS R20 R21 K26 ["Flags"]
  GETTABLEKS R19 R20 K31 ["getFFlagAvatarPreviewerFixMeshSwitching"]
  CALL R18 1 1
  GETIMPORT R19 K11 [require]
  GETTABLEKS R22 R3 K16 ["Src"]
  GETTABLEKS R21 R22 K26 ["Flags"]
  GETTABLEKS R20 R21 K32 ["getFFlagAvatarPreviewerProportionControls"]
  CALL R19 1 1
  GETIMPORT R20 K11 [require]
  GETTABLEKS R23 R3 K16 ["Src"]
  GETTABLEKS R22 R23 K26 ["Flags"]
  GETTABLEKS R21 R22 K33 ["getFFlagAvatarPreviewerAutoSetupTelemetry"]
  CALL R20 1 1
  GETTABLEKS R22 R5 K34 ["ContextServices"]
  GETTABLEKS R21 R22 K35 ["Analytics"]
  DUPCLOSURE R22 K36 [PROTO_0]
  DUPCLOSURE R23 K37 [PROTO_2]
  CAPTURE VAL R4
  CAPTURE VAL R7
  DUPCLOSURE R24 K38 [PROTO_14]
  CAPTURE VAL R21
  CAPTURE VAL R6
  CAPTURE VAL R8
  CAPTURE VAL R10
