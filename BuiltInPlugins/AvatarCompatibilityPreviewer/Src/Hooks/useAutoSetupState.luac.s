...
PROTO_5:
  ...
  JUMPIFNOT R3 [+14]
  GETUPVAL R6 3
  GETTABLEKS R5 R6 K39 ["ATTRIBUTE_AUTO_SETUP_INPUT_ASSET"]
  GETUPVAL R6 9
  GETUPVAL R10 0
  GETTABLEKS R9 R10 K6 ["bodies"]
  GETTABLEN R8 R9 1
  GETTABLEKS R7 R8 K40 ["MeshId"]
  CALL R6 1 -1
  NAMECALL R3 R0 K37 ["SetAttribute"]
  CALL R3 -1 0
  GETIMPORT R5 K42 [CFrame.lookAt]
  MOVE R6 R2
  GETTABLEKS R9 R1 K27 ["Position"]
  GETTABLEKS R8 R9 K43 ["X"]
  GETTABLEKS R9 R2 K32 ["Y"]
  GETTABLEKS R11 R1 K27 ["Position"]
  GETTABLEKS R10 R11 K44 ["Z"]
  FASTCALL VECTOR [+2]
  ...
  MOVE R6 R0
  SETLIST R5 R6 1 [1]
  NAMECALL R3 R3 K45 ["Set"]
  CALL R3 2 0
  GETUPVAL R3 11
  DUPTABLE R4 K47 [{"type"}]
  LOADK R5 K48 ["none"]
  SETTABLEKS R5 R4 K46 ["type"]
  CALL R3 1 0
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R21 R22 K33 ["getFFlagAvatarPreviewerAutoSetupTelemetryV2"]
  CALL R20 1 1
