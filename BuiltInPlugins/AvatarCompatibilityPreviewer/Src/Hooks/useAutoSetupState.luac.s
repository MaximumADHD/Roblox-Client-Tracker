...
PROTO_5:
  ...
  GETTABLEKS R4 R0 K14 ["PrimaryPart"]
  JUMPIFNOTEQKNIL R4 [+2]
  LOADB R3 0 +1
  LOADB R3 1
  FASTCALL2K ASSERT R3 K15 [+4]
  LOADK R4 K15 ["Auto setup returned model with no primary part"]
  ...
  GETTABLEN R4 R5 1
  GETTABLEKS R3 R4 K16 ["Size"]
  GETUPVAL R7 0
  GETTABLEKS R6 R7 K6 ["bodies"]
  GETTABLEN R5 R6 1
  GETTABLEKS R4 R5 K17 ["MeshSize"]
  DIV R2 R3 R4
  GETTABLEKS R5 R2 K18 ["X"]
  NAMECALL R3 R0 K19 ["ScaleTo"]
  CALL R3 2 0
  GETUPVAL R2 4
  SETTABLEKS R2 R0 K20 ["Parent"]
  GETTABLEKS R2 R0 K14 ["PrimaryPart"]
  NAMECALL R4 R0 K21 ["GetBoundingBox"]
  CALL R4 1 1
  GETTABLEKS R6 R0 K14 ["PrimaryPart"]
  GETTABLEKS R5 R6 K22 ["CFrame"]
  NAMECALL R5 R5 K23 ["Inverse"]
  CALL R5 1 1
  MUL R3 R4 R5
  SETTABLEKS R3 R2 K24 ["PivotOffset"]
  GETUPVAL R7 0
  GETTABLEKS R6 R7 K6 ["bodies"]
  GETTABLEN R5 R6 1
  GETTABLEKS R4 R5 K25 ["ExtentsCFrame"]
  NAMECALL R2 R0 K26 ["PivotTo"]
  CALL R2 2 0
  GETUPVAL R2 5
  MOVE R3 R0
  GETUPVAL R6 0
  ...
  CALL R2 2 0
  GETUPVAL R5 0
  GETTABLEKS R2 R5 K27 ["otherChildren"]
  LOADNIL R3
  LOADNIL R4
  FORGPREP R2
  NAMECALL R7 R6 K28 ["Clone"]
  CALL R7 1 1
  SETTABLEKS R0 R7 K20 ["Parent"]
  FORGLOOP R2 2 [-6]
  GETUPVAL R5 4
  GETTABLEKS R4 R5 K29 ["CurrentCamera"]
  FASTCALL2K ASSERT R4 K30 [+4]
  LOADK R5 K30 ["No Workspace Camera"]
  GETIMPORT R3 K2 [assert]
  CALL R3 2 1
  GETTABLEKS R2 R3 K22 ["CFrame"]
  GETTABLEKS R5 R2 K31 ["Position"]
  GETTABLEKS R7 R2 K33 ["LookVector"]
  MULK R6 R7 K32 [10]
  ADD R4 R5 R6
  LOADN R6 0
  GETUPVAL R12 0
  ...
  GETTABLEN R10 R11 1
  GETTABLEKS R9 R10 K16 ["Size"]
  GETTABLEKS R8 R9 K35 ["Y"]
  MULK R7 R8 K34 [0.5]
  LOADN R8 0
  FASTCALL VECTOR [+2]
  GETIMPORT R5 K38 [Vector3.new]
  CALL R5 3 1
  ADD R3 R4 R5
  GETUPVAL R4 6
  CALL R4 0 1
  ...
  JUMPIFNOT R4 [+8]
  GETUPVAL R7 2
  GETTABLEKS R6 R7 K39 ["ATTRIBUTE_CREATED_BY_AUTO_SETUP"]
  LOADB R7 1
  NAMECALL R4 R0 K40 ["SetAttribute"]
  CALL R4 3 0
  JUMP [+11]
  GETUPVAL R9 2
  GETTABLEKS R7 R9 K41 ["ATTRIBUTE_PREFIX"]
  GETUPVAL R9 2
  GETTABLEKS R8 R9 K39 ["ATTRIBUTE_CREATED_BY_AUTO_SETUP"]
  CONCAT R6 R7 R8
  LOADB R7 1
  NAMECALL R4 R0 K40 ["SetAttribute"]
  CALL R4 3 0
  ...
  NAMECALL R4 R0 K40 ["SetAttribute"]
  CALL R4 -1 0
  GETIMPORT R6 K45 [CFrame.lookAt]
  MOVE R7 R3
  GETTABLEKS R10 R2 K31 ["Position"]
  GETTABLEKS R9 R10 K18 ["X"]
  GETTABLEKS R10 R3 K35 ["Y"]
  GETTABLEKS R12 R2 K31 ["Position"]
  GETTABLEKS R11 R12 K46 ["Z"]
  FASTCALL VECTOR [+2]
  GETIMPORT R8 K38 [Vector3.new]
  CALL R8 3 1
  CALL R6 2 -1
  NAMECALL R4 R0 K26 ["PivotTo"]
  CALL R4 -1 0
  GETUPVAL R4 9
  NEWTABLE R6 0 1
  MOVE R7 R0
  SETLIST R6 R7 1 [1]
  NAMECALL R4 R4 K47 ["Set"]
  CALL R4 2 0
  GETUPVAL R4 10
  DUPTABLE R5 K49 [{"type"}]
  LOADK R6 K50 ["none"]
  SETTABLEKS R6 R5 K48 ["type"]
  CALL R4 1 0
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R15 R16 K27 ["getFFlagAvatarPreviewerAutoSetupDisablePublish"]
  CALL R14 1 1
  GETIMPORT R15 K11 [require]
  GETTABLEKS R18 R3 K16 ["Src"]
  GETTABLEKS R17 R18 K26 ["Flags"]
  GETTABLEKS R16 R17 K28 ["getFFlagAvatarPreviewerFixMeshSwitching"]
  CALL R15 1 1
  ...
  GETTABLEKS R18 R19 K30 ["getFFlagAvatarPreviewerAutoSetupTelemetry"]
  CALL R17 1 1
  GETIMPORT R18 K11 [require]
  GETTABLEKS R21 R3 K16 ["Src"]
  GETTABLEKS R20 R21 K26 ["Flags"]
  GETTABLEKS R19 R20 K31 ["getFFlagAvatarPreviewerAutoSetupTelemetryV2"]
  CALL R18 1 1
  GETTABLEKS R20 R5 K32 ["ContextServices"]
  GETTABLEKS R19 R20 K33 ["Analytics"]
  DUPCLOSURE R20 K34 [PROTO_0]
  DUPCLOSURE R21 K35 [PROTO_2]
  CAPTURE VAL R4
  CAPTURE VAL R7
  DUPCLOSURE R22 K36 [PROTO_14]
  CAPTURE VAL R19
  CAPTURE VAL R6
  CAPTURE VAL R8
  CAPTURE VAL R10
