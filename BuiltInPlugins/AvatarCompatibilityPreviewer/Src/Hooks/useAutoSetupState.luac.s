...
PROTO_45:
  ...
  MOVE R5 R6
  GETUPVAL R6 23
  DUPTABLE R7 K37 [{"timeStart", "assetId", "modelHash"}]
  SETTABLEKS R1 R7 K34 ["timeStart"]
  LOADK R8 K38 ["no model uploaded"]
  SETTABLEKS R8 R7 K35 ["assetId"]
  SETTABLEKS R3 R7 K36 ["modelHash"]
  SETTABLEKS R7 R6 K25 ["current"]
  GETUPVAL R6 1
  MOVE R7 R5
  CALL R6 1 0
  GETUPVAL R7 17
  GETTABLEKS R6 R7 K39 ["autoSetupClickedSignal"]
  JUMPIFEQKNIL R6 [+7]
  GETUPVAL R7 17
  GETTABLEKS R6 R7 K39 ["autoSetupClickedSignal"]
  NAMECALL R6 R6 K40 ["Fire"]
  CALL R6 1 0
  RETURN R0 0
