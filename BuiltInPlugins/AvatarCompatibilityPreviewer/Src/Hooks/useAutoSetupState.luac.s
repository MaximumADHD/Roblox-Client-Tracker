...
PROTO_5:
  ...
  CALL R4 3 0
  GETUPVAL R7 2
  GETTABLEKS R6 R7 K41 ["ATTRIBUTE_AUTO_SETUP_INPUT_ASSET"]
  GETUPVAL R7 6
  GETUPVAL R11 0
  GETTABLEKS R10 R11 K6 ["bodies"]
  GETTABLEN R9 R10 1
  GETTABLEKS R8 R9 K42 ["MeshId"]
  CALL R7 1 -1
  NAMECALL R4 R0 K40 ["SetAttribute"]
  CALL R4 -1 0
  GETIMPORT R6 K44 [CFrame.lookAt]
  MOVE R7 R3
  GETTABLEKS R10 R2 K31 ["Position"]
  GETTABLEKS R9 R10 K18 ["X"]
  GETTABLEKS R10 R3 K35 ["Y"]
  GETTABLEKS R12 R2 K31 ["Position"]
  GETTABLEKS R11 R12 K45 ["Z"]
  FASTCALL VECTOR [+2]
  ...
  MOVE R7 R0
  SETLIST R6 R7 1 [1]
  NAMECALL R4 R4 K46 ["Set"]
  CALL R4 2 0
  GETUPVAL R4 8
  DUPTABLE R5 K48 [{"type"}]
  LOADK R6 K49 ["none"]
  SETTABLEKS R6 R5 K47 ["type"]
  CALL R4 1 0
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R15 R16 K27 ["getFFlagAvatarPreviewerScaleAfterAutosetup"]
  CALL R14 1 1
  GETTABLEKS R16 R5 K28 ["ContextServices"]
  GETTABLEKS R15 R16 K29 ["Analytics"]
  DUPCLOSURE R16 K30 [PROTO_0]
  DUPCLOSURE R17 K31 [PROTO_2]
  CAPTURE VAL R4
  CAPTURE VAL R7
  DUPCLOSURE R18 K32 [PROTO_14]
  CAPTURE VAL R15
  CAPTURE VAL R6
  CAPTURE VAL R8
  CAPTURE VAL R10
