...
MAIN:
  ...
  GETTABLEKS R13 R14 K25 ["getFFlagAvatarPreviewerAutoSetupFixPositioning"]
  CALL R12 1 1
  GETIMPORT R13 K11 [require]
  GETTABLEKS R16 R3 K16 ["Src"]
  GETTABLEKS R15 R16 K24 ["Flags"]
  GETTABLEKS R14 R15 K26 ["getFFlagAvatarPreviewerDisableETA"]
  CALL R13 1 1
  GETIMPORT R14 K11 [require]
  GETTABLEKS R17 R3 K16 ["Src"]
  GETTABLEKS R16 R17 K24 ["Flags"]
  GETTABLEKS R15 R16 K27 ["getFFlagAvatarPreviewerFixBrokenTests"]
  CALL R14 1 1
  GETIMPORT R15 K11 [require]
  GETTABLEKS R18 R3 K16 ["Src"]
  GETTABLEKS R17 R18 K24 ["Flags"]
  GETTABLEKS R16 R17 K28 ["getFFlagAvatarPreviewerProportionControls"]
  CALL R15 1 1
  GETTABLEKS R17 R5 K29 ["ContextServices"]
  GETTABLEKS R16 R17 K30 ["Analytics"]
