--[[
	Post to activate a universe

	Example
	POST https://develop.roblox.com/v1/universes/2681549088/activate

	Documented at : https://develop.roblox.com/docs#!/Universes/post_v1_universes_universeId_activate
...
return function(networkingImpl, baseUrl)
	...
	return function(universeId)
		...
		local url = baseUrl.composeUrl(baseUrl.DEVELOP_URL, string.format("v1/universes/%d/activate", universeId))
