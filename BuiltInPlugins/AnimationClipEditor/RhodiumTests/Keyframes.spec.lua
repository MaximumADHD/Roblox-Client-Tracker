return function()
	...
	it("should be able to add a keyframe without a track", function()
		runTest(function(test)
			...
			store:dispatch(ValueChanged("Root", "Head", 0, CFrame.new()))
			TestHelpers.delay()
	...
	it("should be able to add a keyframe to an existing track", function()
		runTest(function(test)
			...
			TestHelpers.loadAnimation(store, emptyData)
			store:dispatch(ValueChanged("Root", "Head", 0, CFrame.new()))
			store:dispatch(ValueChanged("Root", "Head", 1, CFrame.new()))
			TestHelpers.delay()
	...
	it("should be able to add a keyframe under an existing summary keyframe", function()
		runTest(function(test)
			...
			TestHelpers.loadAnimation(store, emptyData)
			store:dispatch(ValueChanged("Root", "Head", 0, CFrame.new()))
			store:dispatch(ValueChanged("Root", "UpperTorso", 0, CFrame.new()))
			TestHelpers.delay()
