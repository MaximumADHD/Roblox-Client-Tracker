...
MAIN:
  ...
  GETTABLEKS R11 R1 K25 ["LuaFlags"]
  GETTABLEKS R10 R11 K26 ["GetFFlagRigInfoCache"]
  CALL R9 1 1
  DUPTABLE R10 K28 [{"plugin"}]
  LOADNIL R11
  SETTABLEKS R11 R10 K27 ["plugin"]
  ...
  CAPTURE VAL R0
  CAPTURE VAL R7
  SETTABLEKS R11 R10 K32 ["loadAnimation"]
  DUPCLOSURE R11 K33 [PROTO_2]
  SETTABLEKS R11 R10 K34 ["delay"]
  DUPCLOSURE R11 K35 [PROTO_3]
  CAPTURE VAL R4
  CAPTURE VAL R10
  SETTABLEKS R11 R10 K36 ["clickInstance"]
  DUPCLOSURE R11 K37 [PROTO_4]
  CAPTURE VAL R5
  CAPTURE VAL R10
  SETTABLEKS R11 R10 K38 ["runTest"]
  RETURN R10 1
