...
local var14 = require(var1.Src.Thunks.Exporting.LoadAnimation)
local var15 = require(var1.Src.Thunks.SortAndSetTracks)
local var16 = require(var1.Src.Actions.SetPast)
local var17 = require(var1.Src.Actions.SetFuture)
local var18 = require(var1.Src.Actions.SetSelectedKeyframes)
local var19 = require(var1.Src.Actions.SetLegacyAnimationInstances)
local var20 = require(var1.LuaFlags.GetFFlagAnimSavesMigration)
local var21 = require(var1.LuaFlags.GetFFlagMigrationDialog)
return function(arg1, arg2)
   return function(arg1, arg2)
      local var0 = var3:GetTags(arg1.animation)
      local var1 = var3:GetTags(arg2.animation)
