PROTO_0:
       ...
       37 JUMPIFNOT                        R3 ; [+53]
       38 GETUPVAL                         R7 2
       39 GETTABLEKS                       R7 R7 K9 ["getAnimator"]
       41 MOVE                             R8 R4
       42 CALL                             R7 1 1
       43 JUMPIFNOT                        R7 ; [+47]
       44 GETTABLEKS                       R8 R2 K10 ["Metadata"]
       46 GETTABLEKS                       R8 R8 K11 ["EndTick"]
       48 GETUPVAL                         R11 3
       49 LOADN                            R12 0
       ...
       55 CALL                             R10 3 1
       56 GETUPVAL                         R11 0
       57 GETTABLEKS                       R11 R11 K15 ["TICK_FREQUENCY"]
       59 DIV                              R9 R10 R11
       ...
       81 FORGPREP_NEXT                    R8
       82 GETUPVAL                         R13 4
       83 GETTABLEKS                       R13 R13 K24 ["stepRigAnimation"]
       85 MOVE                             R14 R4
       86 MOVE                             R15 R12
       87 GETUPVAL                         R16 3
       88 CALL                             R13 3 0
       ...
       91 JUMPIF                           R5 ; [+6]
       92 GETUPVAL                         R7 5
       93 GETTABLEKS                       R7 R7 K25 ["getNearestTick"]
       95 GETUPVAL                         R8 3
       96 CALL                             R7 1 1
       97 SETUPVAL                         R7 3
       98 GETUPVAL                         R9 6
      ...
      103 CALL                             R7 -1 0
      104 GETTABLEKS                       R7 R1 K2 ["Status"]
      106 GETTABLEKS                       R7 R7 K27 ["VisualizeBones"]
      108 GETUPVAL                         R8 7
      109 GETTABLEKS                       R8 R8 K28 ["updateMicrobones"]
      111 MOVE                             R9 R4
      112 MOVE                             R10 R7
      113 CALL                             R8 2 0
      114 GETUPVAL                         R8 4
      115 GETTABLEKS                       R8 R8 K29 ["updateSimulatedAnimConstraintParts"]
      117 MOVE                             R9 R4
      118 CALL                             R8 1 0
      119 RETURN                           R0 0
...
MAIN:
       ...
       47 GETTABLEKS                       R10 R0 K15 ["LuaFlags"]
       49 GETTABLEKS                       R10 R10 K16 ["GetFFlagEngineAnimator"]
       51 CALL                             R9 1 1
