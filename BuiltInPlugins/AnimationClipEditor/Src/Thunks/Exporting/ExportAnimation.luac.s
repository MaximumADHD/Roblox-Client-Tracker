...
PROTO_1:
        ...
        4 MOVE                             R7 R0
        5 GETUPVAL                         R9 3
        6 GETTABLEKS                       R9 R9 K1 ["Metadata"]
        8 JUMPIFNOT                        R9 ; [+6]
        9 GETUPVAL                         R8 3
       10 GETTABLEKS                       R8 R8 K1 ["Metadata"]
       12 GETTABLEKS                       R8 R8 K2 ["Guid"]
       14 JUMP                             ; [+1]
       15 LOADNIL                          R8
...
PROTO_2:
       ...
       14 JUMPIF                           R4 ; [+1]
       15 RETURN                           R0 0
       16 GETTABLEKS                       R5 R2 K5 ["Metadata"]
       18 GETTABLEKS                       R5 R5 K6 ["Name"]
       20 GETUPVAL                         R8 0
       21 MOVE                             R9 R5
       22 GETUPVAL                         R10 1
       23 GETUPVAL                         R11 2
       ...
       27 CALL                             R6 -1 0
       28 GETUPVAL                         R6 3
       29 GETTABLEKS                       R6 R6 K8 ["getAnimSavesFolder"]
       31 MOVE                             R7 R4
       32 CALL                             R6 1 2
       33 JUMPIFNOT                        R3 ; [+1]
       34 MOVE                             R6 R7
       ...
       43 LOADNIL                          R9
       44 GETUPVAL                         R10 4
       45 GETTABLEKS                       R10 R10 K10 ["SelectionChanged"]
       ...
       55 LOADNIL                          R11
       56 GETUPVAL                         R12 6
       57 GETTABLEKS                       R12 R12 K12 ["hasFacsData"]
       59 MOVE                             R13 R2
       60 CALL                             R12 1 1
       61 MOVE                             R10 R12
       62 GETUPVAL                         R12 6
       63 GETTABLEKS                       R12 R12 K13 ["isChannelAnimation"]
       65 MOVE                             R13 R2
       66 CALL                             R12 1 1
       67 JUMPIFNOT                        R12 ; [+6]
       68 GETUPVAL                         R12 7
       69 GETTABLEKS                       R12 R12 K14 ["ANIMATION_TYPE"]
       71 GETTABLEKS                       R11 R12 K15 ["CurveAnimation"]
       73 JUMP                             ; [+5]
       74 GETUPVAL                         R12 7
       75 GETTABLEKS                       R12 R12 K14 ["ANIMATION_TYPE"]
       ...
       86 JUMPIFNOT                        R12 ; [+21]
       87 GETUPVAL                         R15 7
       88 GETTABLEKS                       R15 R15 K18 ["ANIMATION_UPLOAD_SUCCESS_EVENT_NAME"]
