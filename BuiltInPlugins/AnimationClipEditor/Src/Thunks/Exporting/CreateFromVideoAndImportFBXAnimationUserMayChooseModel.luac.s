PROTO_0:
  ...
  RETURN R0 0
  GETUPVAL R0 5
  NAMECALL R0 R0 K1 ["showImportAnimModelChoicePrompt"]
  CALL R0 1 0
  RETURN R0 0
...
PROTO_2:
  ...
  JUMP [+5]
  GETUPVAL R11 4
  GETTABLEKS R10 R11 K6 ["fromRigAnimation"]
  MOVE R11 R9
  CALL R10 1 1
  GETTABLEKS R11 R10 K7 ["Metadata"]
  GETUPVAL R13 5
  GETTABLEKS R12 R13 K8 ["DEFAULT_IMPORTED_NAME"]
  ...
  CALL R11 -1 0
  JUMPIFNOT R9 [+3]
  NAMECALL R11 R9 K11 ["Destroy"]
  CALL R11 1 0
  LOADK R13 K12 ["onCreateFromVideo"]
  GETTABLEKS R15 R10 K7 ["Metadata"]
  JUMPIFNOT R15 [+5]
  GETTABLEKS R15 R10 K7 ["Metadata"]
  GETTABLEKS R14 R15 K13 ["Guid"]
  JUMP [+1]
  LOADNIL R14
  NAMECALL R11 R4 K14 ["report"]
  CALL R11 3 0
  RETURN R0 0
  GETIMPORT R10 K16 [warn]
  MOVE R11 R9
  CALL R10 1 0
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R14 R15 K24 ["GetFFlagAnimSavesMigration"]
  CALL R13 1 1
  GETIMPORT R14 K5 [require]
  GETTABLEKS R16 R0 K23 ["LuaFlags"]
  GETTABLEKS R15 R16 K25 ["GetFFlagRigUtilsMigration2"]
  CALL R14 1 1
  GETIMPORT R15 K27 [game]
  LOADK R17 K28 ["AlwaysImportAnimationFromVideoBasedOnFBXModel"]
  LOADB R18 0
