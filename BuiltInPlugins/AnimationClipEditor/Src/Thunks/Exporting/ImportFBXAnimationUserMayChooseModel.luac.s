...
PROTO_2:
  ...
  JUMP [+5]
  GETUPVAL R7 3
  GETTABLEKS R6 R7 K6 ["fromRigAnimation"]
  MOVE R7 R5
  CALL R6 1 1
  GETTABLEKS R7 R6 K7 ["Metadata"]
  GETUPVAL R9 4
  GETTABLEKS R8 R9 K8 ["DEFAULT_IMPORTED_NAME"]
  SETTABLEKS R8 R7 K9 ["Name"]
  GETUPVAL R8 5
  GETTABLEKS R7 R8 K10 ["clearTrackSequences"]
  MOVE R8 R6
  CALL R7 1 0
  GETUPVAL R9 6
  MOVE R10 R6
  ...
  CALL R7 -1 0
  JUMPIFNOT R5 [+3]
  NAMECALL R7 R5 K12 ["Destroy"]
  CALL R7 1 0
  GETUPVAL R7 7
  LOADK R9 K13 ["onImportFbxAnimation"]
  GETTABLEKS R11 R6 K7 ["Metadata"]
  JUMPIFNOT R11 [+5]
  GETTABLEKS R11 R6 K7 ["Metadata"]
  GETTABLEKS R10 R11 K14 ["Guid"]
  JUMP [+1]
  LOADNIL R10
...
MAIN:
  ...
  GETTABLEKS R9 R10 K18 ["GetFFlagAnimSavesMigration"]
  CALL R8 1 1
  GETIMPORT R9 K5 [require]
  GETTABLEKS R11 R0 K17 ["LuaFlags"]
  GETTABLEKS R10 R11 K19 ["GetFFlagRigUtilsMigration2"]
  CALL R9 1 1
