PROTO_0:
  ...
  JUMP [+27]
  GETUPVAL R13 7
  GETTABLEKS R12 R13 K10 ["isChannelAnimation"]
  MOVE R13 R5
  CALL R12 1 1
  JUMPIFNOT R12 [+11]
  GETUPVAL R13 6
  GETTABLEKS R12 R13 K11 ["toCurveAnimation"]
  MOVE R13 R5
  MOVE R14 R4
  CALL R12 2 4
  MOVE R8 R12
  ...
  JUMP [+10]
  GETUPVAL R13 6
  GETTABLEKS R12 R13 K12 ["toKeyframeSequence"]
  MOVE R13 R5
  MOVE R14 R4
  CALL R12 2 4
  MOVE R8 R12
  ...
  CALL R13 -1 0
  GETUPVAL R15 7
  GETTABLEKS R14 R15 K10 ["isChannelAnimation"]
  MOVE R15 R5
  CALL R14 1 1
  JUMPIFNOT R14 [+6]
  GETUPVAL R15 11
...
MAIN:
  ...
  GETTABLEKS R12 R1 K21 ["LuaFlags"]
  GETTABLEKS R11 R12 K22 ["GetFFlagEngineAnimator"]
  CALL R10 1 1
  GETIMPORT R11 K9 [require]
  GETTABLEKS R13 R1 K21 ["LuaFlags"]
  GETTABLEKS R12 R13 K23 ["GetFFlagFixMissingAnimRigDataBug"]
  CALL R11 1 1
