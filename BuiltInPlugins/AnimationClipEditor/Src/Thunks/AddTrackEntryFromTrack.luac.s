PROTO_0:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R2 R2 K0 ["trackListEntry"]
        3 GETTABLEKS                       R3 R1 K1 ["Type"]
        5 JUMPIF                           R3 ; [+5]
        6 GETUPVAL                         R3 1
        7 GETTABLEKS                       R3 R3 K2 ["TRACK_TYPES"]
        9 GETTABLEKS                       R3 R3 K3 ["CFrame"]
       11 CALL                             R2 1 1
       ...
       36 GETUPVAL                         R9 1
       37 GETTABLEKS                       R9 R9 K2 ["TRACK_TYPES"]
       39 GETTABLEKS                       R9 R9 K9 ["IkData"]
       ...
       50 JUMP                             ; [+33]
       51 GETUPVAL                         R8 0
       52 GETTABLEKS                       R8 R8 K0 ["trackListEntry"]
       ...
       62 GETUPVAL                         R9 4
       63 GETTABLEKS                       R9 R9 K10 ["getRotationType"]
       65 GETUPVAL                         R10 5
       66 CALL                             R9 1 1
       67 GETUPVAL                         R10 4
       68 GETTABLEKS                       R10 R10 K11 ["getEulerAnglesOrder"]
       70 GETUPVAL                         R11 5
       71 CALL                             R10 1 1
       72 GETUPVAL                         R11 4
       73 GETTABLEKS                       R11 R11 K12 ["createTrackListEntryComponents"]
       75 MOVE                             R12 R8
...
PROTO_1:
       ...
       38 GETUPVAL                         R8 6
       39 GETTABLEKS                       R8 R8 K8 ["List"]
       41 GETTABLEKS                       R8 R8 K9 ["join"]
       43 MOVE                             R9 R4
       44 NEWTABLE                         R10 0 1
       46 MOVE                             R11 R6
       ...
       65 JUMPIFNOT                        R15 ; [+5]
       66 GETTABLEKS                       R14 R7 K12 ["Metadata"]
       68 GETTABLEKS                       R14 R14 K13 ["Guid"]
       70 JUMP                             ; [+1]
       71 LOADNIL                          R14
...
MAIN:
       ...
       47 GETTABLEKS                       R6 R6 K14 ["SortAndSetTracks"]
       49 CALL                             R5 1 1
