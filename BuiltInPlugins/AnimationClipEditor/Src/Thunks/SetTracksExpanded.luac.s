PROTO_0:
        ...
        7 GETUPVAL                         R2 1
        8 GETTABLEKS                       R2 R2 K2 ["TRACK_TYPES"]
       10 GETTABLEKS                       R2 R2 K3 ["CFrame"]
...
PROTO_1:
        ...
        2 CALL                             R1 1 1
        3 GETUPVAL                         R2 0
        4 GETTABLEKS                       R3 R1 K1 ["Status"]
        6 GETTABLEKS                       R3 R3 K2 ["Tracks"]
        8 CALL                             R2 1 1
        9 GETTABLEKS                       R3 R1 K3 ["AnimationData"]
       11 GETUPVAL                         R4 1
       12 GETTABLEKS                       R4 R4 K4 ["isChannelAnimation"]
       14 MOVE                             R5 R3
       15 CALL                             R4 1 1
       ...
       29 CAPTURE                          VAL R10
       30 GETUPVAL                         R11 6
       31 GETTABLEKS                       R11 R11 K7 ["findTrackEntry"]
       33 MOVE                             R12 R2
       34 MOVE                             R13 R9
       35 CALL                             R11 2 1
       36 MOVE                             R12 R10
...
MAIN:
       ...
       49 GETTABLEKS                       R6 R6 K13 ["SetTracks"]
       51 CALL                             R5 1 1
