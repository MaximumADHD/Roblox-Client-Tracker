...
PROTO_6:
        ...
        1 JUMPIF                           R2 ; [+3]
        2 GETUPVAL                         R2 0
        3 GETTABLEKS                       R2 R2 K0 ["COMPONENT_PATH_BASE_SCALE"]
        5 MOVE                             R1 R2
        6 GETUPVAL                         R2 1
        7 GETTABLEKS                       R2 R2 K1 ["getSortedComponents"]
        9 MOVE                             R3 R0
       10 CALL                             R2 1 1
       11 JUMPIFNOT                        R2 ; [+28]
       12 MOVE                             R3 R2
       ...
       33 GETUPVAL                         R11 0
       34 GETTABLEKS                       R11 R11 K0 ["COMPONENT_PATH_BASE_SCALE"]
       36 MUL                              R10 R1 R11
       37 CALL                             R8 2 0
       38 FORGLOOP                         R3 2 ; [-23]
       40 RETURN                           R0 0
...
PROTO_7:
       ...
       31 JUMPIFNOT                        R5 ; [+41]
       32 GETUPVAL                         R5 0
       33 GETTABLEKS                       R5 R5 K11 ["buildRigHierarchy"]
       35 MOVE                             R6 R2
       36 CALL                             R5 1 1
       37 GETUPVAL                         R6 0
       38 GETTABLEKS                       R6 R6 K12 ["getUnusedRigTracks"]
       40 MOVE                             R7 R2
       41 GETUPVAL                         R8 1
       42 CALL                             R6 2 1
       43 MOVE                             R4 R6
       ...
       55 MOVE                             R3 R7
       56 GETUPVAL                         R6 4
       57 GETTABLEKS                       R6 R6 K13 ["filterFacsTracks"]
       59 GETUPVAL                         R7 1
       60 CALL                             R6 1 1
       61 GETUPVAL                         R7 5
       62 GETTABLEKS                       R7 R7 K14 ["List"]
       64 GETTABLEKS                       R7 R7 K15 ["join"]
       66 MOVE                             R8 R3
       67 GETUPVAL                         R9 6
       68 MOVE                             R10 R6
       69 CALL                             R9 1 1
       ...
       76 MOVE                             R3 R5
       77 GETUPVAL                         R5 4
       78 GETTABLEKS                       R5 R5 K16 ["getUnusedFacs"]
       80 GETUPVAL                         R6 1
       81 CALL                             R5 1 1
       82 GETUPVAL                         R6 7
       83 CALL                             R6 0 1
...
MAIN:
       ...
       20 GETTABLEKS                       R3 R3 K10 ["SetTracks"]
       22 CALL                             R2 1 1
       ...
       49 GETTABLEKS                       R9 R0 K16 ["LuaFlags"]
       51 GETTABLEKS                       R9 R9 K17 ["GetFFlagFixDynamicTrackSelection"]
       53 CALL                             R8 1 1
