PROTO_0:
       ...
       18 JUMPIFNOT                        R7 ; [+24]
       19 GETUPVAL                         R7 1
       20 GETTABLEKS                       R7 R7 K4 ["deleteKeyframe"]
       22 MOVE                             R8 R1
       23 MOVE                             R9 R5
       24 CALL                             R7 2 0
       25 GETUPVAL                         R7 2
       ...
       28 GETUPVAL                         R11 4
       29 GETUPVAL                         R13 5
       30 GETTABLEKS                       R13 R13 K6 ["Metadata"]
       32 JUMPIFNOT                        R13 ; [+6]
       33 GETUPVAL                         R12 5
       34 GETTABLEKS                       R12 R12 K6 ["Metadata"]
       36 GETTABLEKS                       R12 R12 K7 ["Guid"]
       38 JUMP                             ; [+1]
       39 LOADNIL                          R12
...
PROTO_1:
       ...
       11 GETTABLEKS                       R4 R4 K4 ["EditorMode"]
       13 JUMPIFNOT                        R3 ; [+1]
       14 JUMPIF                           R2 ; [+1]
       15 RETURN                           R0 0
       16 GETUPVAL                         R5 0
       ...
       24 CALL                             R5 2 1
       25 GETUPVAL                         R6 0
       26 GETTABLEKS                       R6 R6 K5 ["Dictionary"]
       28 GETTABLEKS                       R6 R6 K6 ["join"]
       30 NEWTABLE                         R7 0 0
       ...
       44 GETUPVAL                         R12 0
       45 GETTABLEKS                       R12 R12 K5 ["Dictionary"]
       47 GETTABLEKS                       R12 R12 K6 ["join"]
       49 NEWTABLE                         R13 0 0
       ...
       59 GETUPVAL                         R12 0
       60 GETTABLEKS                       R12 R12 K5 ["Dictionary"]
       62 GETTABLEKS                       R12 R12 K6 ["join"]
       64 NEWTABLE                         R13 0 0
       66 GETTABLEKS                       R15 R5 K7 ["Instances"]
       68 GETTABLE                         R14 R15 R9
       69 GETTABLEKS                       R14 R14 K10 ["Tracks"]
       71 CALL                             R12 2 1
       ...
       94 LOADB                            R19 0
       95 GETUPVAL                         R20 2
       96 GETTABLEKS                       R20 R20 K11 ["traverse"]
       98 MOVE                             R21 R16
       99 MOVE                             R22 R17
...
MAIN:
       ...
       65 GETTABLEKS                       R8 R8 K17 ["SelectionUtils"]
       67 CALL                             R7 1 1
