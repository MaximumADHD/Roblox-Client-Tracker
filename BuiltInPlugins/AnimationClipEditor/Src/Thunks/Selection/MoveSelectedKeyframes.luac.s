PROTO_0:
        ...
        3 RETURN                           R0 0
        4 GETUPVAL                         R2 0
        5 GETTABLEKS                       R2 R2 K1 ["Dictionary"]
        7 GETTABLEKS                       R2 R2 K2 ["keys"]
       ...
       37 GETUPVAL                         R11 4
       38 GETUPVAL                         R12 5
       39 GETTABLEKS                       R12 R12 K6 ["SNAP_MODES"]
       41 GETTABLEKS                       R12 R12 K7 ["None"]
       43 JUMPIFEQ                         R11 R12 ; [+8]
       45 GETUPVAL                         R11 6
       46 GETTABLEKS                       R11 R11 K8 ["getNearestFrame"]
       48 MOVE                             R12 R10
       49 GETUPVAL                         R13 7
       50 CALL                             R11 2 1
       51 MOVE                             R10 R11
       ...
       53 SUB                              R13 R9 R14
       54 GETUPVAL                         R15 5
       55 GETTABLEKS                       R15 R15 K9 ["MAX_ANIMATION_LENGTH"]
       57 GETUPVAL                         R17 9
       58 SUB                              R16 R17 R9
       59 SUB                              R14 R15 R16
       ...
       69 JUMPIFNOT                        R11 ; [+69]
       70 GETUPVAL                         R11 10
       71 GETTABLEKS                       R11 R11 K14 ["moveKeyframe"]
       73 MOVE                             R12 R1
       74 MOVE                             R13 R9
       75 MOVE                             R14 R10
       76 CALL                             R11 3 0
       77 GETUPVAL                         R11 10
       78 GETTABLEKS                       R11 R11 K15 ["moveNamedKeyframe"]
       80 GETUPVAL                         R12 11
       81 MOVE                             R13 R9
       82 MOVE                             R14 R10
       83 CALL                             R11 3 0
       ...
       86 GETUPVAL                         R12 5
       87 GETTABLEKS                       R12 R12 K17 ["TRACK_TYPES"]
       89 GETTABLEKS                       R12 R12 K18 ["Quaternion"]
      ...
      106 GETUPVAL                         R12 5
      107 GETTABLEKS                       R12 R12 K17 ["TRACK_TYPES"]
      109 GETTABLEKS                       R12 R12 K20 ["Facs"]
      ...
      120 SETUPVAL                         R11 13
      121 GETUPVAL                         R11 10
      122 GETTABLEKS                       R11 R11 K21 ["setKeyframeData"]
      124 MOVE                             R12 R1
      125 MOVE                             R13 R10
      126 DUPTABLE                         R14 K23 [{"Value"}]
      127 GETTABLEKS                       R18 R1 K19 ["Data"]
      129 GETTABLE                         R17 R18 R10
      130 GETTABLEKS                       R17 R17 K22 ["Value"]
      132 GETUPVAL                         R18 12
      133 SUB                              R16 R17 R18
      134 GETUPVAL                         R17 13
      135 ADD                              R15 R16 R17
...
PROTO_1:
        ...
        4 JUMPIFNOT                        R3 ; [+4]
        5 GETUPVAL                         R2 0
        6 GETTABLEKS                       R2 R2 K1 ["selectedKeyframes"]
        8 JUMPIF                           R2 ; [+4]
        9 GETTABLEKS                       R2 R1 K2 ["Status"]
       11 GETTABLEKS                       R2 R2 K3 ["SelectedKeyframes"]
       13 GETUPVAL                         R4 0
       14 JUMPIFNOT                        R4 ; [+4]
       15 GETUPVAL                         R3 0
       16 GETTABLEKS                       R3 R3 K4 ["animationData"]
       18 JUMPIF                           R3 ; [+2]
       19 GETTABLEKS                       R3 R1 K5 ["AnimationData"]
       21 GETTABLEKS                       R4 R1 K2 ["Status"]
       23 GETTABLEKS                       R4 R4 K6 ["FrameRate"]
       25 GETTABLEKS                       R5 R1 K2 ["Status"]
       27 GETTABLEKS                       R5 R5 K7 ["SnapMode"]
       29 JUMPIFNOT                        R3 ; [+1]
       30 JUMPIF                           R2 ; [+1]
       31 RETURN                           R0 0
       32 GETUPVAL                         R6 1
       ...
       64 LOADB                            R7 1
       65 GETUPVAL                         R8 5
       66 GETTABLEKS                       R8 R8 K12 ["getSelectionBounds"]
       68 MOVE                             R9 R6
       69 MOVE                             R10 R2
       70 CALL                             R8 2 2
       71 GETUPVAL                         R10 2
       ...
       81 GETUPVAL                         R17 1
       82 GETTABLEKS                       R17 R17 K8 ["Dictionary"]
       84 GETTABLEKS                       R17 R17 K9 ["join"]
       86 NEWTABLE                         R18 0 0
       ...
       96 GETUPVAL                         R17 1
       97 GETTABLEKS                       R17 R17 K8 ["Dictionary"]
       99 GETTABLEKS                       R17 R17 K9 ["join"]
      101 NEWTABLE                         R18 0 0
      103 GETTABLEKS                       R20 R6 K10 ["Instances"]
      105 GETTABLE                         R19 R20 R14
      106 GETTABLEKS                       R19 R19 K15 ["Tracks"]
      108 CALL                             R17 2 1
      ...
      130 GETUPVAL                         R23 6
      131 GETTABLEKS                       R23 R23 K16 ["traverse"]
      133 MOVE                             R24 R21
      134 MOVE                             R25 R22
