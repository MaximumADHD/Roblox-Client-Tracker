...
MAIN:
  ...
  GETTABLEKS R45 R1 K64 ["LuaFlags"]
  GETTABLEKS R44 R45 K65 ["GetFFlagFacialAnimationRecordingInStudio"]
  CALL R43 1 1
  GETIMPORT R44 K9 [require]
  GETTABLEKS R46 R1 K64 ["LuaFlags"]
  GETTABLEKS R45 R46 K66 ["GetFFlagTimelineUnitSeconds"]
  CALL R44 1 1
  ...
  CAPTURE VAL R18
  CAPTURE VAL R30
  SETTABLEKS R45 R37 K68 ["handleButtonClick"]
  DUPCLOSURE R45 K69 [PROTO_2]
  SETTABLEKS R45 R37 K70 ["createPluginButton"]
  DUPCLOSURE R45 K71 [PROTO_13]
  CAPTURE VAL R3
  CAPTURE VAL R31
  CAPTURE VAL R22
  CAPTURE VAL R23
  ...
  CAPTURE VAL R8
  CAPTURE VAL R7
  SETTABLEKS R45 R37 K74 ["getPluginSettings"]
  DUPCLOSURE R45 K75 [PROTO_15]
  CAPTURE VAL R44
  CAPTURE VAL R30
  SETTABLEKS R45 R37 K76 ["setPluginSettings"]
  DUPCLOSURE R45 K77 [PROTO_16]
  CAPTURE VAL R30
  DUPCLOSURE R46 K78 [PROTO_17]
  CAPTURE VAL R30
  DUPCLOSURE R47 K79 [PROTO_18]
  CAPTURE VAL R30
  DUPCLOSURE R48 K80 [PROTO_19]
  CAPTURE VAL R30
  SETTABLEKS R48 R37 K81 ["didMount"]
  DUPCLOSURE R48 K82 [PROTO_20]
  CAPTURE VAL R41
  CAPTURE VAL R30
  SETTABLEKS R48 R37 K83 ["willUnmount"]
