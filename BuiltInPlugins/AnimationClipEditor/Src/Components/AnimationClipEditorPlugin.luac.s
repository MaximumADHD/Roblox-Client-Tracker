...
PROTO_10:
  ...
  CALL R6 2 0
  GETTABLEKS R7 R1 K45 ["pluginLoaderContext"]
  GETTABLEKS R6 R7 K46 ["mainButtonClickedSignal"]
  NEWCLOSURE R8 P1
  CAPTURE VAL R0
  CAPTURE VAL R1
  ...
  GETTABLEKS R8 R0 K50 ["props"]
  GETTABLEKS R7 R8 K0 ["plugin"]
  GETTABLEKS R6 R7 K51 ["Deactivation"]
  NEWCLOSURE R8 P4
  CAPTURE VAL R1
  CAPTURE VAL R0
  CAPTURE UPVAL U18
  NAMECALL R6 R6 K47 ["Connect"]
  CALL R6 2 1
  SETTABLEKS R6 R0 K52 ["deactivationListener"]
  GETTABLEKS R7 R0 K50 ["props"]
  GETTABLEKS R6 R7 K0 ["plugin"]
  NAMECALL R6 R6 K53 ["GetMouse"]
  CALL R6 1 1
  SETTABLEKS R6 R0 K54 ["mouse"]
  GETUPVAL R6 19
  CALL R6 0 1
  SETTABLEKS R6 R0 K55 ["theme"]
  NEWCLOSURE R6 P5
  CAPTURE VAL R0
  SETTABLEKS R6 R0 K56 ["closeWidget"]
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R38 R2 K63 ["LuaFlags"]
  GETTABLEKS R37 R38 K64 ["GetFFlagFacialAnimationRecordingInStudio"]
  CALL R36 1 1
  DUPCLOSURE R37 K65 [PROTO_1]
  CAPTURE VAL R1
  CAPTURE VAL R21
  CAPTURE VAL R35
  CAPTURE VAL R3
  ...
  CAPTURE VAL R18
  CAPTURE VAL R9
  SETTABLEKS R37 R31 K66 ["handleButtonClick"]
  DUPCLOSURE R37 K67 [PROTO_2]
  SETTABLEKS R37 R31 K68 ["createPluginButton"]
  DUPCLOSURE R37 K69 [PROTO_10]
  CAPTURE VAL R4
  CAPTURE VAL R19
  CAPTURE VAL R14
  CAPTURE VAL R15
  ...
  CAPTURE VAL R23
  CAPTURE VAL R13
  SETTABLEKS R37 R31 K70 ["init"]
  DUPCLOSURE R37 K71 [PROTO_11]
  CAPTURE VAL R18
  CAPTURE VAL R27
  CAPTURE VAL R26
  CAPTURE VAL R25
  CAPTURE VAL R24
  SETTABLEKS R37 R31 K72 ["getPluginSettings"]
  DUPCLOSURE R37 K73 [PROTO_12]
  CAPTURE VAL R18
  SETTABLEKS R37 R31 K74 ["setPluginSettings"]
  DUPCLOSURE R37 K75 [PROTO_13]
  CAPTURE VAL R18
  DUPCLOSURE R38 K76 [PROTO_14]
  CAPTURE VAL R18
  DUPCLOSURE R39 K77 [PROTO_15]
  CAPTURE VAL R18
  DUPCLOSURE R40 K78 [PROTO_16]
  CAPTURE VAL R18
  SETTABLEKS R40 R31 K79 ["didMount"]
  DUPCLOSURE R40 K80 [PROTO_17]
  CAPTURE VAL R18
  SETTABLEKS R40 R31 K81 ["willUnmount"]
  DUPCLOSURE R40 K82 [PROTO_18]
  CAPTURE VAL R3
  CAPTURE VAL R8
  CAPTURE VAL R0
  CAPTURE VAL R11
