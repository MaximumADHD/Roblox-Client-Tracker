...
PROTO_12:
  ...
  GETTABLEKS R8 R0 K53 ["props"]
  GETTABLEKS R7 R8 K0 ["plugin"]
  GETTABLEKS R6 R7 K54 ["Deactivation"]
  NEWCLOSURE R8 P5
  CAPTURE VAL R1
  CAPTURE VAL R0
  CAPTURE UPVAL U19
  NAMECALL R6 R6 K50 ["Connect"]
  CALL R6 2 1
  SETTABLEKS R6 R0 K55 ["deactivationListener"]
  GETTABLEKS R7 R0 K53 ["props"]
  GETTABLEKS R6 R7 K0 ["plugin"]
  NAMECALL R6 R6 K56 ["GetMouse"]
  CALL R6 1 1
  SETTABLEKS R6 R0 K57 ["mouse"]
  GETUPVAL R6 20
  CALL R6 0 1
  SETTABLEKS R6 R0 K58 ["theme"]
  NEWCLOSURE R6 P6
  CAPTURE VAL R0
  SETTABLEKS R6 R0 K59 ["closeWidget"]
  RETURN R0 0
...
PROTO_19:
  ...
  CALL R1 1 0
  GETTABLEKS R1 R0 K2 ["dockWidget"]
  JUMPIF R1 [+2]
  LOADNIL R2
  JUMP [+6]
  GETUPVAL R5 0
  GETTABLEKS R4 R5 K3 ["ANIMATION_UPLOAD_SUCCESS_EVENT_NAME"]
  NAMECALL R2 R1 K4 ["FindFirstChild"]
  CALL R2 2 1
  JUMPIFNOT R2 [+3]
  NAMECALL R3 R2 K5 ["Destroy"]
  CALL R3 1 0
  NAMECALL R1 R0 K6 ["setPluginSettings"]
  CALL R1 1 0
  GETTABLEKS R1 R0 K7 ["theme"]
...
MAIN:
  ...
  GETTABLEKS R39 R2 K64 ["LuaFlags"]
  GETTABLEKS R38 R39 K65 ["GetFFlagFacialAnimationRecordingInStudio"]
  CALL R37 1 1
  DUPCLOSURE R38 K66 [PROTO_1]
  CAPTURE VAL R1
  CAPTURE VAL R21
  CAPTURE VAL R35
  CAPTURE VAL R3
  ...
  CAPTURE VAL R18
  CAPTURE VAL R9
  SETTABLEKS R38 R31 K67 ["handleButtonClick"]
  DUPCLOSURE R38 K68 [PROTO_2]
  SETTABLEKS R38 R31 K69 ["createPluginButton"]
  DUPCLOSURE R38 K70 [PROTO_12]
  CAPTURE VAL R4
  CAPTURE VAL R19
  CAPTURE VAL R14
  CAPTURE VAL R15
  ...
  CAPTURE VAL R23
  CAPTURE VAL R13
  SETTABLEKS R38 R31 K71 ["init"]
  DUPCLOSURE R38 K72 [PROTO_13]
  CAPTURE VAL R18
  CAPTURE VAL R27
  CAPTURE VAL R26
  CAPTURE VAL R25
  CAPTURE VAL R24
  SETTABLEKS R38 R31 K73 ["getPluginSettings"]
  DUPCLOSURE R38 K74 [PROTO_14]
  CAPTURE VAL R18
  SETTABLEKS R38 R31 K75 ["setPluginSettings"]
  DUPCLOSURE R38 K76 [PROTO_15]
  CAPTURE VAL R18
  DUPCLOSURE R39 K77 [PROTO_16]
  CAPTURE VAL R18
  DUPCLOSURE R40 K78 [PROTO_17]
  CAPTURE VAL R18
  DUPCLOSURE R41 K79 [PROTO_18]
  CAPTURE VAL R18
  SETTABLEKS R41 R31 K80 ["didMount"]
  DUPCLOSURE R41 K81 [PROTO_19]
  CAPTURE VAL R18
  SETTABLEKS R41 R31 K82 ["willUnmount"]
  DUPCLOSURE R41 K83 [PROTO_20]
  CAPTURE VAL R3
  CAPTURE VAL R8
  CAPTURE VAL R0
  CAPTURE VAL R11
