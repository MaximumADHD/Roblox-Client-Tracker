...
MAIN:
  ...
  LOADK R37 K61 ["ACEDeferredSignals"]
  LOADB R38 0
  NAMECALL R35 R35 K62 ["DefineFastFlag"]
  CALL R35 3 1
  GETIMPORT R36 K1 [game]
  LOADK R38 K63 ["ACETemporaryToolHack"]
  LOADB R39 0
  ...
  DUPCLOSURE R38 K74 [PROTO_16]
  CAPTURE VAL R18
  SETTABLEKS R38 R31 K75 ["setPluginSettings"]
  DUPCLOSURE R38 K76 [PROTO_17]
  CAPTURE VAL R18
  DUPCLOSURE R39 K77 [PROTO_18]
  CAPTURE VAL R18
  DUPCLOSURE R40 K78 [PROTO_19]
  CAPTURE VAL R18
  DUPCLOSURE R41 K79 [PROTO_20]
  CAPTURE VAL R18
  SETTABLEKS R41 R31 K80 ["didMount"]
  DUPCLOSURE R41 K81 [PROTO_21]
  CAPTURE VAL R36
  CAPTURE VAL R18
  SETTABLEKS R41 R31 K82 ["willUnmount"]
  DUPCLOSURE R41 K83 [PROTO_22]
  CAPTURE VAL R3
  CAPTURE VAL R8
  CAPTURE VAL R0
  CAPTURE VAL R11
