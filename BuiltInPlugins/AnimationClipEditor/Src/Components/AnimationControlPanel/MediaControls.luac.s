...
PROTO_3:
  ...
  GETTABLEKS R7 R8 K1 ["Stylizer"]
  GETTABLEKS R6 R7 K2 ["button"]
  GETUPVAL R8 0
  GETTABLEKS R7 R8 K3 ["createElement"]
  LOADK R8 K4 ["Frame"]
  DUPTABLE R9 K8 [{"LayoutOrder", "Size", "BackgroundTransparency"}]
  GETTABLEKS R10 R0 K9 ["layoutOrderIterator"]
  NAMECALL R10 R10 K10 ["getNextOrder"]
  CALL R10 1 1
  SETTABLEKS R10 R9 K5 ["LayoutOrder"]
  GETIMPORT R10 K13 [UDim2.new]
  LOADN R11 0
  GETUPVAL R13 1
  GETTABLEKS R12 R13 K14 ["TIMELINE_HEIGHT"]
  LOADN R13 0
  GETUPVAL R15 1
  ...
  DUPTABLE R10 K16 [{"Button"}]
  GETUPVAL R12 0
  GETTABLEKS R11 R12 K3 ["createElement"]
  GETUPVAL R12 2
  DUPTABLE R13 K20 [{"ZIndex", "Size", "Style", "OnClick"}]
  LOADN R14 1
  ...
  JUMPIFNOT R1 [+3]
  GETTABLEKS R14 R6 K21 ["ActiveControl"]
  JUMPIF R14 [+2]
  GETTABLEKS R14 R6 K22 ["MediaControl"]
  SETTABLEKS R14 R13 K18 ["Style"]
  NEWCLOSURE R14 P0
  CAPTURE VAL R0
  CAPTURE VAL R3
  SETTABLEKS R14 R13 K19 ["OnClick"]
  DUPTABLE R14 K25 [{"Image", "Tooltip"}]
  GETUPVAL R16 0
  GETTABLEKS R15 R16 K3 ["createElement"]
  LOADK R16 K26 ["ImageLabel"]
  DUPTABLE R17 K28 [{"BackgroundTransparency", "Size", "Image", "ImageColor3"}]
  LOADN R18 1
  ...
  SETTABLEKS R2 R17 K23 ["Image"]
  JUMPIFNOT R1 [+3]
  GETTABLEKS R18 R4 K29 ["iconHighlightColor"]
  JUMPIF R18 [+2]
  GETTABLEKS R18 R4 K30 ["iconColor"]
  SETTABLEKS R18 R17 K27 ["ImageColor3"]
  CALL R15 2 1
  ...
  GETTABLEKS R15 R16 K3 ["createElement"]
  GETUPVAL R16 3
  DUPTABLE R17 K32 [{"TextKey"}]
  SETTABLEKS R5 R17 K31 ["TextKey"]
  CALL R15 2 1
  SETTABLEKS R15 R14 K24 ["Tooltip"]
  CALL R11 3 1
  SETTABLEKS R11 R10 K15 ["Button"]
  CALL R7 3 -1
  RETURN R7 -1
...
MAIN:
  ...
  GETTABLEKS R11 R0 K19 ["LuaFlags"]
  GETTABLEKS R10 R11 K20 ["GetFFlagRhodium"]
  CALL R9 1 1
  GETTABLEKS R10 R1 K21 ["PureComponent"]
  LOADK R12 K22 ["MediaControls"]
  ...
  CAPTURE VAL R7
  CAPTURE VAL R8
  SETTABLEKS R11 R10 K25 ["makeButton"]
  DUPCLOSURE R11 K26 [PROTO_1]
  CAPTURE VAL R1
  CAPTURE VAL R5
  CAPTURE VAL R7
  CAPTURE VAL R8
  SETTABLEKS R11 R10 K27 ["makeToggle"]
  MOVE R11 R9
  CALL R11 0 1
  JUMPIF R11 [+7]
  ...
  CAPTURE VAL R7
  CAPTURE VAL R8
  SETTABLEKS R11 R10 K29 ["makePlayToggle_deprecated"]
  DUPCLOSURE R11 K30 [PROTO_5]
  CAPTURE VAL R1
  CAPTURE VAL R5
  CAPTURE VAL R7
  CAPTURE VAL R8
  SETTABLEKS R11 R10 K31 ["makePlayToggle"]
  ...
  GETTABLEKS R13 R3 K34 ["Stylizer"]
