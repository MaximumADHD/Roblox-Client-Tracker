PROTO_0:
       ...
       17 GETUPVAL                         R11 1
       18 GETTABLEKS                       R10 R11 K8 ["parseTime"]
       ...
       26 LOADN                            R12 0
       27 GETUPVAL                         R15 2
       28 GETTABLEKS                       R14 R15 K10 ["TICK_FREQUENCY"]
       30 GETUPVAL                         R16 2
       31 GETTABLEKS                       R15 R16 K11 ["MAX_ANIMATION_LENGTH"]
       33 MUL                              R13 R14 R15
       ...
       45 CALL                             R10 1 0
       46 GETUPVAL                         R11 1
       47 GETTABLEKS                       R10 R11 K15 ["formatTime"]
       49 MOVE                             R11 R9
       50 MOVE                             R12 R8
       51 MOVE                             R13 R4
       52 CALL                             R10 3 1
...
PROTO_1:
       ...
       11 GETTABLEKS                       R7 R3 K4 ["Metadata"]
       13 GETTABLEKS                       R6 R7 K5 ["EndTick"]
       15 GETTABLEKS                       R7 R2 K6 ["TimelineUnit"]
       17 GETUPVAL                         R10 1
       18 GETTABLEKS                       R9 R10 K8 ["parseTime"]
       ...
       25 ORK                              R8 R9 K7 [0]
       26 GETUPVAL                         R14 2
       27 GETTABLEKS                       R13 R14 K10 ["TICK_FREQUENCY"]
       29 FASTCALL2                        MATH_MAX R6 R13 ; [+4]
       31 MOVE                             R12 R6
       32 GETIMPORT                        R11 K13 [math.max]
       34 CALL                             R11 2 1
       35 GETUPVAL                         R13 2
       36 GETTABLEKS                       R12 R13 K14 ["MAX_ANIMATION_LENGTH"]
       ...
       44 MOVE                             R8 R9
       45 GETUPVAL                         R10 1
       46 GETTABLEKS                       R9 R10 K17 ["formatTime"]
       48 MOVE                             R10 R8
       49 MOVE                             R11 R4
       50 MOVE                             R12 R7
       51 CALL                             R9 3 1
...
PROTO_3:
       ...
       28 LOADN                            R14 0
       29 GETUPVAL                         R16 1
       30 GETTABLEKS                       R15 R16 K18 ["TIME_DISPLAY_WIDTH"]
       32 LOADN                            R16 1
       33 LOADN                            R17 0
       34 CALL                             R13 4 1
       ...
       80 GETUPVAL                         R18 3
       81 GETTABLEKS                       R17 R18 K43 ["formatTime"]
       83 MOVE                             R18 R4
       84 MOVE                             R19 R6
       85 MOVE                             R20 R3
       86 CALL                             R17 3 1
      ...
      104 GETUPVAL                         R19 0
      105 GETTABLEKS                       R18 R19 K9 ["createElement"]
      107 GETUPVAL                         R19 4
      ...
      118 GETUPVAL                         R15 0
      119 GETTABLEKS                       R14 R15 K9 ["createElement"]
      ...
      156 GETUPVAL                         R15 0
      157 GETTABLEKS                       R14 R15 K9 ["createElement"]
      159 GETUPVAL                         R15 2
      ...
      170 GETUPVAL                         R18 3
      171 GETTABLEKS                       R17 R18 K43 ["formatTime"]
      173 MOVE                             R18 R5
      174 MOVE                             R19 R6
      175 MOVE                             R20 R3
      176 CALL                             R17 3 1
      ...
      196 GETUPVAL                         R19 0
      197 GETTABLEKS                       R18 R19 K9 ["createElement"]
      199 GETUPVAL                         R19 4
...
MAIN:
       ...
       29 GETTABLEKS                       R4 R5 K11 ["StringUtils"]
       31 CALL                             R3 1 1
       ...
       47 GETTABLEKS                       R9 R10 K15 ["Components"]
       49 GETTABLEKS                       R8 R9 K16 ["TextBox"]
       51 CALL                             R7 1 1
       52 GETIMPORT                        R8 K5 [require]
       54 GETTABLEKS                       R11 R0 K8 ["Src"]
       56 GETTABLEKS                       R10 R11 K15 ["Components"]
       58 GETTABLEKS                       R9 R10 K17 ["Tooltip"]
       60 CALL                             R8 1 1
