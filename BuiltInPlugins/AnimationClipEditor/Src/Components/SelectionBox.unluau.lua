...
local function fun0(arg1)
   ...
   local var92 = {}
   var92.OnDragMoved = var0.OnDragMoved
   var92.OnDragEnded = var0.OnDragEnded
   local var97 = {}
   local var104 = {}
   var104.BackgroundTransparency = 1
   var104.Position = UDim2.new(0, var3.Min.X, 0, var3.Min.Y)
   var104.Size = UDim2.new(0, var3.Width, 0, var3.Height)
   var104.ClipsDescendants = true
   local var122 = {}
   local var126 = {}
   ...
   var97.Extents = var1.createElement("Frame", var104, var122)
   return var1.createElement(var4, var92, var97)
end
