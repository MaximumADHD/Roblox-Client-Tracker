...
PROTO_45:
  DUPTABLE R1 K10 [{"AddWaypoint", "SetEvents", "SelectEvent", "DeselectEvent", "DeleteSelectedEvents", "MoveSelectedEvents", "DeselectAllEvents", "SetRightClickContextInfo", "SetEventEditingTick", "SetPlayState"}]
  NEWCLOSURE R2 P0
  CAPTURE VAL R0
  CAPTURE UPVAL U0
  ...
  CAPTURE UPVAL U6
  CAPTURE UPVAL U7
  SETTABLEKS R2 R1 K4 ["DeleteSelectedEvents"]
  GETUPVAL R3 5
  CALL R3 0 1
  JUMPIFNOT R3 [+4]
  NEWCLOSURE R2 P5
  ...
  CAPTURE VAL R0
  CAPTURE UPVAL U8
  SETTABLEKS R2 R1 K5 ["MoveSelectedEvents"]
  NEWCLOSURE R2 P7
  CAPTURE VAL R0
  CAPTURE UPVAL U2
  CAPTURE UPVAL U9
  SETTABLEKS R2 R1 K6 ["DeselectAllEvents"]
  NEWCLOSURE R2 P8
  CAPTURE VAL R0
  CAPTURE UPVAL U7
  SETTABLEKS R2 R1 K7 ["SetRightClickContextInfo"]
  NEWCLOSURE R3 P9
  CAPTURE VAL R0
  CAPTURE UPVAL U10
  ORK R2 R3 K11 []
  SETTABLEKS R2 R1 K8 ["SetEventEditingTick"]
  NEWCLOSURE R2 P10
  CAPTURE VAL R0
  CAPTURE UPVAL U11
  SETTABLEKS R2 R1 K9 ["SetPlayState"]
  RETURN R1 1
...
MAIN:
  ...
  GETTABLEKS R35 R0 K47 ["LuaFlags"]
  GETTABLEKS R34 R35 K48 ["GetFFlagFilterEvents"]
  CALL R33 1 1
  GETTABLEKS R34 R1 K49 ["PureComponent"]
  LOADK R36 K50 ["EventsController"]
  ...
  DUPCLOSURE R35 K54 [PROTO_16]
  CAPTURE VAL R14
  SETTABLEKS R35 R34 K55 ["handleTimelineInputBegan"]
  DUPCLOSURE R35 K56 [PROTO_17]
  CAPTURE VAL R14
  SETTABLEKS R35 R34 K57 ["handleTimelineInputEnded"]
  DUPCLOSURE R35 K58 [PROTO_18]
  SETTABLEKS R35 R34 K59 ["handleEventRightClick"]
  DUPCLOSURE R35 K60 [PROTO_19]
  SETTABLEKS R35 R34 K61 ["handleEventInputBegan"]
  DUPCLOSURE R35 K62 [PROTO_20]
  SETTABLEKS R35 R34 K63 ["handleEventInputEnded"]
  DUPCLOSURE R35 K64 [PROTO_21]
  CAPTURE VAL R10
  CAPTURE VAL R16
  CAPTURE VAL R9
  SETTABLEKS R35 R34 K65 ["refreshEventNames"]
  DUPCLOSURE R35 K66 [PROTO_23]
  CAPTURE VAL R33
  SETTABLEKS R35 R34 K67 ["didUpdate"]
  DUPCLOSURE R35 K68 [PROTO_24]
  CAPTURE VAL R33
  SETTABLEKS R35 R34 K69 ["didMount"]
  DUPCLOSURE R35 K70 [PROTO_32]
  CAPTURE VAL R1
  CAPTURE VAL R11
  CAPTURE VAL R18
  CAPTURE VAL R33
  ...
  CAPTURE VAL R20
  CAPTURE VAL R32
  SETTABLEKS R35 R34 K71 ["render"]
  DUPCLOSURE R35 K72 [PROTO_33]
  DUPCLOSURE R36 K73 [PROTO_45]
  CAPTURE VAL R21
  CAPTURE VAL R22
  CAPTURE VAL R31
  CAPTURE VAL R23
  ...
  CAPTURE VAL R28
  MOVE R37 R6
  DUPTABLE R38 K75 [{"Analytics"}]
  GETTABLEKS R39 R5 K74 ["Analytics"]
  SETTABLEKS R39 R38 K74 ["Analytics"]
  CALL R37 1 1
  MOVE R38 R34
  CALL R37 1 1
  MOVE R34 R37
  GETTABLEKS R37 R2 K76 ["connect"]
  MOVE R38 R35
  MOVE R39 R36
  CALL R37 2 1
  MOVE R38 R34
