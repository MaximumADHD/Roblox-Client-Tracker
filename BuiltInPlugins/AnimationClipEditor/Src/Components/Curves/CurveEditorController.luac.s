...
PROTO_35:
       ...
       12 JUMPIFEQ                         R3 R4 ; [+27]
       14 MOVE                             R5 R1
       15 NAMECALL                         R3 R0 K3 ["updateTracks"]
       17 CALL                             R3 2 2
       18 GETTABLEKS                       R5 R0 K0 ["props"]
       20 GETTABLEKS                       R5 R5 K4 ["TestSetCurveEditorScroll"]
       22 JUMPIFEQKNIL                     R3 ; [+3]
       24 MOVE                             R6 R3
       25 JUMP                             ; [+4]
       26 GETTABLEKS                       R6 R0 K5 ["state"]
       28 GETTABLEKS                       R6 R6 K6 ["MinValue"]
       30 JUMPIFEQKNIL                     R4 ; [+3]
       32 MOVE                             R7 R4
       33 JUMP                             ; [+4]
       34 GETTABLEKS                       R7 R0 K5 ["state"]
       36 GETTABLEKS                       R7 R7 K7 ["MaxValue"]
       38 CALL                             R5 2 0
       39 RETURN                           R0 0
       40 GETTABLEKS                       R3 R0 K0 ["props"]
       42 GETTABLEKS                       R3 R3 K4 ["TestSetCurveEditorScroll"]
       44 GETTABLEKS                       R4 R0 K5 ["state"]
       46 GETTABLEKS                       R4 R4 K6 ["MinValue"]
       48 GETTABLEKS                       R5 R0 K5 ["state"]
       50 GETTABLEKS                       R5 R5 K7 ["MaxValue"]
       52 CALL                             R3 2 0
       53 RETURN                           R0 0
...
PROTO_38:
       ...
       10 GETTABLEKS                       R3 R3 K3 ["PluginActions"]
       12 NEWTABLE                         R4 0 0
       14 SETTABLEKS                       R4 R0 K4 ["Connections"]
       16 NEWTABLE                         R4 0 0
       18 SETTABLEKS                       R4 R0 K5 ["Actions"]
       20 LOADK                            R8 K6 ["ResizeCanvas"]
       21 NAMECALL                         R6 R3 K7 ["get"]
       23 CALL                             R6 2 1
       24 NEWCLOSURE                       R7 P0
       25 CAPTURE                          VAL R0
       26 NAMECALL                         R4 R0 K8 ["addAction"]
       28 CALL                             R4 3 0
       29 GETTABLEKS                       R4 R0 K2 ["props"]
       31 GETTABLEKS                       R4 R4 K9 ["TestSetCurveEditorScroll"]
       33 JUMPIFEQKNIL                     R1 ; [+3]
       35 MOVE                             R5 R1
       36 JUMP                             ; [+4]
       37 GETTABLEKS                       R5 R0 K10 ["state"]
       39 GETTABLEKS                       R5 R5 K11 ["MinValue"]
       41 JUMPIFEQKNIL                     R2 ; [+3]
       43 MOVE                             R6 R2
       44 JUMP                             ; [+4]
       45 GETTABLEKS                       R6 R0 K10 ["state"]
       47 GETTABLEKS                       R6 R6 K12 ["MaxValue"]
       49 CALL                             R4 2 0
       50 RETURN                           R0 0
