...
PROTO_2:
  ...
  SUB R9 R10 R6
  DIV R7 R8 R9
  GETTABLEKS R11 R1 K9 ["X"]
  GETTABLEKS R12 R2 K10 ["StartTick"]
  SUB R10 R11 R12
  GETTABLEKS R12 R2 K11 ["AbsoluteSize"]
  GETTABLEKS R11 R12 K9 ["X"]
  MUL R9 R10 R11
  GETTABLEKS R11 R2 K12 ["EndTick"]
  GETTABLEKS R12 R2 K10 ["StartTick"]
  SUB R10 R11 R12
  DIV R8 R9 R10
  GETTABLEKS R11 R1 K13 ["Y"]
  SUB R10 R4 R11
  SUB R11 R4 R3
  DIV R9 R10 R11
  MUL R10 R5 R6
  ...
  GETUPVAL R13 0
  GETTABLEKS R12 R13 K14 ["CURVE_CANVAS_PADDING"]
  MUL R10 R11 R12
  GETTABLEKS R14 R2 K11 ["AbsoluteSize"]
  GETTABLEKS R13 R14 K13 ["Y"]
  MUL R12 R9 R13
  LOADN R14 1
  LOADN R16 2
  GETUPVAL R18 0
  GETTABLEKS R17 R18 K14 ["CURVE_CANVAS_PADDING"]
  MUL R15 R16 R17
  SUB R13 R14 R15
  MUL R11 R12 R13
  ADD R9 R10 R11
...
PROTO_3:
  ...
  SUB R3 R4 R5
  LOADN R5 1
  GETTABLEKS R7 R2 K3 ["VerticalZoom"]
  FASTCALL2K MATH_MIN R7 K4 [+4]
  LOADK R8 K4 [0.99]
  GETIMPORT R6 K7 [math.min]
  CALL R6 2 1
  SUB R4 R5 R6
  GETTABLEKS R7 R2 K8 ["AbsoluteSize"]
  GETTABLEKS R6 R7 K9 ["Y"]
  LOADN R8 1
  LOADN R10 2
  GETUPVAL R12 0
  GETTABLEKS R11 R12 K10 ["CURVE_CANVAS_PADDING"]
  MUL R9 R10 R11
  SUB R7 R8 R9
  MUL R5 R6 R7
  GETTABLEKS R8 R2 K11 ["EndTick"]
  GETTABLEKS R9 R2 K12 ["StartTick"]
  SUB R7 R8 R9
  GETTABLEKS R9 R2 K8 ["AbsoluteSize"]
