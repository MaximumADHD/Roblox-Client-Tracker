...
MAIN:
  ...
  LOADK R18 K32 ["ACESanitizeAnimations"]
  LOADB R19 0
  ...
  CAPTURE VAL R15
  SETTABLEKS R19 R17 K46 ["makeImportMenu"]
  DUPCLOSURE R19 K47 [PROTO_11]
  SETTABLEKS R19 R17 K48 ["makePriorityMenu"]
  DUPCLOSURE R19 K49 [PROTO_12]
  SETTABLEKS R19 R17 K50 ["makeAction"]
  DUPCLOSURE R19 K51 [PROTO_15]
  CAPTURE VAL R5
  CAPTURE VAL R16
  SETTABLEKS R19 R17 K52 ["makeMenuActions"]
  DUPCLOSURE R19 K53 [PROTO_16]
  CAPTURE VAL R1
  CAPTURE VAL R8
  SETTABLEKS R19 R17 K54 ["render"]
  MOVE R19 R7
  DUPTABLE R20 K58 [{"Localization", "Plugin", "Analytics"}]
  GETTABLEKS R21 R6 K55 ["Localization"]
  SETTABLEKS R21 R20 K55 ["Localization"]
  GETTABLEKS R21 R6 K56 ["Plugin"]
  SETTABLEKS R21 R20 K56 ["Plugin"]
  GETTABLEKS R21 R6 K57 ["Analytics"]
  SETTABLEKS R21 R20 K57 ["Analytics"]
  CALL R19 1 1
  MOVE R20 R17
  CALL R19 1 1
  MOVE R17 R19
  DUPCLOSURE R19 K59 [PROTO_17]
  DUPCLOSURE R20 K60 [PROTO_22]
  CAPTURE VAL R11
  CAPTURE VAL R10
  CAPTURE VAL R14
  CAPTURE VAL R12
  CAPTURE VAL R13
  GETTABLEKS R21 R2 K61 ["connect"]
  MOVE R22 R19
  MOVE R23 R20
  CALL R21 2 1
  MOVE R22 R17
