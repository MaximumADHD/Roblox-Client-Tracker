...
PROTO_9:
  ...
  NAMECALL R8 R8 K19 ["FindFirstChildOfClass"]
  CALL R8 2 1
  JUMPIFNOT R8 [+11]
  LOADK R11 K18 ["Humanoid"]
  NAMECALL R9 R8 K20 ["IsA"]
  CALL R9 2 1
  JUMPIFNOT R9 [+6]
  GETTABLEKS R9 R8 K21 ["RigType"]
  GETIMPORT R10 K25 [Enum.HumanoidRigType.R15]
  JUMPIFEQ R9 R10 [+3]
  LOADB R7 0
  JUMP [+11]
  GETTABLEKS R9 R8 K26 ["Parent"]
  JUMPIFNOT R9 [+5]
  LOADK R12 K27 ["Model"]
...
MAIN:
  ...
  LOADK R19 K33 ["ACESanitizeAnimations"]
  LOADB R20 0
  NAMECALL R17 R17 K32 ["DefineFastFlag"]
  CALL R17 3 1
  GETIMPORT R18 K5 [require]
  GETTABLEKS R20 R0 K34 ["LuaFlags"]
  GETTABLEKS R19 R20 K35 ["GetFFlagForceR6HumanoidRootPart"]
  CALL R18 1 1
  ...
  DUPCLOSURE R21 K48 [PROTO_9]
  CAPTURE VAL R16
  CAPTURE VAL R18
  CAPTURE VAL R4
  SETTABLEKS R21 R19 K49 ["makeImportMenu"]
  DUPCLOSURE R21 K50 [PROTO_11]
  SETTABLEKS R21 R19 K51 ["makePriorityMenu"]
  DUPCLOSURE R21 K52 [PROTO_12]
  SETTABLEKS R21 R19 K53 ["makeAction"]
  DUPCLOSURE R21 K54 [PROTO_15]
  CAPTURE VAL R6
  CAPTURE VAL R17
  SETTABLEKS R21 R19 K55 ["makeMenuActions"]
  DUPCLOSURE R21 K56 [PROTO_16]
  CAPTURE VAL R1
  CAPTURE VAL R9
  SETTABLEKS R21 R19 K57 ["render"]
  MOVE R21 R8
  DUPTABLE R22 K61 [{"Localization", "Plugin", "Analytics"}]
  GETTABLEKS R23 R7 K58 ["Localization"]
  SETTABLEKS R23 R22 K58 ["Localization"]
  GETTABLEKS R23 R7 K59 ["Plugin"]
  SETTABLEKS R23 R22 K59 ["Plugin"]
  GETTABLEKS R23 R7 K60 ["Analytics"]
  SETTABLEKS R23 R22 K60 ["Analytics"]
  CALL R21 1 1
  MOVE R22 R19
  CALL R21 1 1
  MOVE R19 R21
  DUPCLOSURE R21 K62 [PROTO_17]
  DUPCLOSURE R22 K63 [PROTO_22]
  CAPTURE VAL R12
  CAPTURE VAL R11
  CAPTURE VAL R15
  CAPTURE VAL R13
  CAPTURE VAL R14
  GETTABLEKS R23 R2 K64 ["connect"]
  MOVE R24 R21
  MOVE R25 R22
  CALL R23 2 1
  MOVE R24 R19
