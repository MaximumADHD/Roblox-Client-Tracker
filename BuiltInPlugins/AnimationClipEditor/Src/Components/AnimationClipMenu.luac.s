...
MAIN:
  ...
  GETTABLEKS R18 R19 K34 ["GetFFlagForceR6HumanoidRootPart"]
  CALL R17 1 1
  ...
  CAPTURE VAL R5
  SETTABLEKS R19 R18 K43 ["makeLoadMenu"]
  DUPCLOSURE R19 K44 [PROTO_7]
  CAPTURE VAL R5
  CAPTURE VAL R6
  SETTABLEKS R19 R18 K45 ["makeSaveAsMenu"]
  DUPCLOSURE R19 K46 [PROTO_8]
  DUPCLOSURE R20 K47 [PROTO_9]
  CAPTURE VAL R16
  CAPTURE VAL R17
  CAPTURE VAL R4
  SETTABLEKS R20 R18 K48 ["makeImportMenu"]
  DUPCLOSURE R20 K49 [PROTO_11]
  SETTABLEKS R20 R18 K50 ["makePriorityMenu"]
  DUPCLOSURE R20 K51 [PROTO_12]
  SETTABLEKS R20 R18 K52 ["makeAction"]
  DUPCLOSURE R20 K53 [PROTO_15]
  CAPTURE VAL R6
  SETTABLEKS R20 R18 K54 ["makeMenuActions"]
  DUPCLOSURE R20 K55 [PROTO_16]
  CAPTURE VAL R1
  CAPTURE VAL R9
  SETTABLEKS R20 R18 K56 ["render"]
  MOVE R20 R8
  ...
  CALL R20 1 1
  MOVE R18 R20
  DUPCLOSURE R20 K61 [PROTO_17]
  DUPCLOSURE R21 K62 [PROTO_22]
  CAPTURE VAL R12
  CAPTURE VAL R11
  CAPTURE VAL R15
  CAPTURE VAL R13
