...
PROTO_11:
  ...
  JUMPIFNOT R9 [+9]
  GETUPVAL R10 1
  GETTABLEKS R9 R10 K6 ["canUseIK"]
  GETTABLEKS R10 R2 K7 ["RootInstance"]
  CALL R9 1 2
  MOVE R7 R9
  MOVE R8 R10
  JUMP [+8]
...
MAIN:
  ...
  GETTABLEKS R28 R29 K36 ["GetFFlagRigIK"]
  CALL R27 1 1
  GETIMPORT R28 K5 [require]
  GETTABLEKS R30 R0 K34 ["LuaFlags"]
  GETTABLEKS R29 R30 K37 ["GetFFlagSelectFromViewport"]
  CALL R28 1 1
  GETTABLEKS R29 R1 K38 ["PureComponent"]
  LOADK R31 K39 ["IKController"]
  NAMECALL R29 R29 K40 ["extend"]
  CALL R29 2 1
  DUPCLOSURE R30 K41 [PROTO_8]
  CAPTURE VAL R26
  CAPTURE VAL R24
  CAPTURE VAL R22
  CAPTURE VAL R27
  ...
  SETTABLEKS R30 R29 K44 ["didUpdate"]
  ...
  MOVE R30 R6
  DUPTABLE R31 K49 [{"Stylizer", "Localization", "Analytics"}]
  GETTABLEKS R32 R5 K47 ["Stylizer"]
  SETTABLEKS R32 R31 K47 ["Stylizer"]
  GETTABLEKS R32 R5 K14 ["Localization"]
  SETTABLEKS R32 R31 K14 ["Localization"]
  GETTABLEKS R32 R5 K48 ["Analytics"]
  SETTABLEKS R32 R31 K48 ["Analytics"]
  CALL R30 1 1
  MOVE R31 R29
  CALL R30 1 1
  MOVE R29 R30
  DUPCLOSURE R30 K50 [PROTO_12]
  DUPCLOSURE R31 K51 [PROTO_20]
  CAPTURE VAL R20
  CAPTURE VAL R10
  CAPTURE VAL R9
  CAPTURE VAL R18
