...
PROTO_7:
  ...
  GETTABLEKS R3 R7 K3 ["RootInstance"]
  CALL R2 1 5
  NEWTABLE R7 0 0
  GETUPVAL R10 0
  GETTABLEKS R9 R10 K2 ["props"]
  GETTABLEKS R8 R9 K4 ["PinnedParts"]
  GETUPVAL R11 0
  GETTABLEKS R10 R11 K2 ["props"]
  GETTABLEKS R9 R10 K5 ["IKMode"]
  GETUPVAL R12 2
  GETTABLEKS R11 R12 K6 ["IK_MODE"]
  GETTABLEKS R10 R11 K7 ["BodyPart"]
  ...
  JUMPIFNOT R1 [+90]
  GETUPVAL R10 1
  GETTABLEKS R9 R10 K11 ["getPartByName"]
  GETUPVAL R12 0
  GETTABLEKS R11 R12 K2 ["props"]
  GETTABLEKS R10 R11 K3 ["RootInstance"]
  MOVE R11 R1
  CALL R9 2 1
  JUMPIFNOT R9 [+79]
  GETUPVAL R12 0
  GETTABLEKS R11 R12 K2 ["props"]
  GETTABLEKS R10 R11 K5 ["IKMode"]
  GETUPVAL R13 2
  GETTABLEKS R12 R13 K6 ["IK_MODE"]
  GETTABLEKS R11 R12 K7 ["BodyPart"]
  JUMPIFNOTEQ R10 R11 [+9]
  GETUPVAL R11 3
  GETTABLEKS R10 R11 K12 ["pinForLimbMode"]
  MOVE R11 R9
  MOVE R12 R3
  MOVE R13 R6
  CALL R10 3 1
  ...
  JUMPIFNOT R10 [+9]
  GETUPVAL R11 0
  GETTABLEKS R10 R11 K13 ["makeChainHelper"]
  MOVE R11 R7
  MOVE R12 R3
  GETTABLE R14 R3 R1
  GETTABLEKS R13 R14 K14 ["Part1"]
  CALL R10 3 0
  GETUPVAL R10 4
  CALL R10 0 1
  JUMPIFNOT R10 [+13]
  ...
  JUMPIFNOT R10 [+11]
  GETUPVAL R11 0
  GETTABLEKS R10 R11 K15 ["makeChainHelperAnimationConstraint"]
  MOVE R11 R7
  MOVE R12 R6
  GETTABLE R15 R6 R1
  GETTABLEKS R14 R15 K16 ["Attachment1"]
  ...
  CALL R10 1 3
  FORGPREP_NEXT R10
  GETTABLEKS R15 R13 K10 ["Name"]
  JUMPIFEQ R15 R1 [+19]
  JUMPIFNOT R14 [+17]
  GETUPVAL R16 0
  GETTABLEKS R15 R16 K13 ["makeChainHelper"]
  MOVE R16 R7
  MOVE R17 R3
  MOVE R18 R13
  CALL R15 3 0
  ...
  JUMPIFNOT R15 [+7]
  GETUPVAL R16 0
  GETTABLEKS R15 R16 K15 ["makeChainHelperAnimationConstraint"]
  MOVE R16 R7
  MOVE R17 R6
  MOVE R18 R13
  CALL R15 3 0
...
MAIN:
  ...
  MOVE R22 R6
  DUPTABLE R23 K46 [{"Stylizer", "Localization", "Analytics"}]
  GETTABLEKS R24 R5 K44 ["Stylizer"]
  SETTABLEKS R24 R23 K44 ["Stylizer"]
  GETTABLEKS R24 R5 K14 ["Localization"]
  SETTABLEKS R24 R23 K14 ["Localization"]
  GETTABLEKS R24 R5 K45 ["Analytics"]
  SETTABLEKS R24 R23 K45 ["Analytics"]
  CALL R22 1 1
  MOVE R23 R21
  CALL R22 1 1
  MOVE R21 R22
  DUPCLOSURE R22 K47 [PROTO_12]
  DUPCLOSURE R23 K48 [PROTO_20]
  CAPTURE VAL R14
  CAPTURE VAL R17
  CAPTURE VAL R16
  CAPTURE VAL R13
