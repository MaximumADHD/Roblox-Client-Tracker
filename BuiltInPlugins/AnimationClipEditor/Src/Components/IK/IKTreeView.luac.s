PROTO_0:
       ...
       27 LOADNIL                          R4
       28 FORGPREP                         R2
       29 GETTABLEKS                       R7 R6 K8 ["Attachment0"]
       31 GETTABLEKS                       R7 R7 K9 ["Parent"]
       33 GETTABLEKS                       R7 R7 K3 ["Name"]
       35 JUMPIFNOTEQ                      R7 R0 ; [+13]
       37 GETTABLEKS                       R9 R6 K10 ["Attachment1"]
       39 GETTABLEKS                       R9 R9 K9 ["Parent"]
       41 GETTABLEKS                       R9 R9 K3 ["Name"]
...
PROTO_1:
        ...
        9 GETTABLEKS                       R2 R2 K5 ["SetSelectedTracks"]
       11 NEWTABLE                         R3 0 1
       13 NEWTABLE                         R4 0 1
       15 MOVE                             R5 R1
...
PROTO_3:
        ...
        1 NEWTABLE                         R3 0 0
        3 GETUPVAL                         R4 0
        4 GETTABLEKS                       R4 R4 K0 ["getChildren"]
        6 MOVE                             R5 R0
        7 CALL                             R4 1 1
        8 GETIMPORT                        R5 K2 [ipairs]
       10 GETUPVAL                         R6 0
       11 GETTABLEKS                       R6 R6 K3 ["state"]
       13 GETTABLEKS                       R6 R6 K4 ["treeArray"]
       15 CALL                             R5 1 3
       ...
       27 JUMPIFNOT                        R1 ; [+7]
       28 GETUPVAL                         R16 0
       29 GETTABLEKS                       R16 R16 K5 ["props"]
       31 GETTABLEKS                       R16 R16 K6 ["Chain"]
       ...
       64 SUB                              R7 R5 R2
       65 GETUPVAL                         R8 1
       66 GETTABLEKS                       R8 R8 K16 ["TRACK_HEIGHT"]
       68 MUL                              R6 R7 R8
       69 RETURN                           R6 1
...
PROTO_6:
       ...
       10 GETTABLEKS                       R4 R4 K4 ["expandedItems"]
       12 GETTABLE                         R3 R4 R0
       13 JUMPIFNOT                        R3 ; [+19]
       14 GETUPVAL                         R3 0
       15 GETTABLEKS                       R3 R3 K5 ["getChildren"]
       17 MOVE                             R4 R0
       18 CALL                             R3 1 1
       ...
       24 GETUPVAL                         R9 0
       25 GETTABLEKS                       R9 R9 K8 ["contributeItem"]
       27 MOVE                             R10 R8
       28 ADDK                             R11 R1 K9 [1]
       29 MOVE                             R12 R2
       30 CALL                             R9 3 0
...
PROTO_7:
        ...
        4 GETTABLEKS                       R1 R1 K1 ["expandedItems"]
...
PROTO_8:
       ...
       16 GETUPVAL                         R8 0
       17 GETTABLEKS                       R8 R8 K21 ["getVerticalLineHeight"]
       19 SETTABLEKS                       R8 R7 K5 ["GetVerticalLineHeight"]
       21 GETUPVAL                         R9 0
       22 GETTABLEKS                       R9 R9 K22 ["state"]
       24 GETTABLEKS                       R9 R9 K23 ["expandedItems"]
       26 GETTABLE                         R8 R9 R6
       27 SETTABLEKS                       R8 R7 K6 ["IsExpanded"]
       29 GETUPVAL                         R10 0
       30 GETTABLEKS                       R10 R10 K24 ["getChildren"]
       32 MOVE                             R11 R6
       33 CALL                             R10 1 1
       34 LENGTH                           R9 R10
       ...
       45 GETUPVAL                         R8 0
       46 GETTABLEKS                       R8 R8 K26 ["onInputBegan"]
       48 SETTABLEKS                       R8 R7 K10 ["OnInputBegan"]
       50 GETUPVAL                         R8 0
       51 GETTABLEKS                       R8 R8 K27 ["toggleExpanded"]
...
PROTO_9:
        0 NEWTABLE                         R1 0 0
        2 GETUPVAL                         R2 0
        3 GETTABLEKS                       R2 R2 K0 ["getMotors"]
        5 GETTABLEKS                       R3 R0 K1 ["props"]
        7 GETTABLEKS                       R3 R3 K2 ["RootInstance"]
        9 CALL                             R2 1 1
       10 GETUPVAL                         R3 0
       11 GETTABLEKS                       R3 R3 K3 ["getAnimationConstraints"]
       13 GETTABLEKS                       R4 R0 K1 ["props"]
       15 GETTABLEKS                       R4 R4 K2 ["RootInstance"]
       17 CALL                             R3 1 1
       18 GETIMPORT                        R4 K5 [ipairs]
       20 MOVE                             R5 R2
       21 CALL                             R4 1 3
       22 FORGPREP_INEXT                   R4
       23 GETTABLEKS                       R9 R8 K6 ["Part1"]
       25 GETTABLEKS                       R9 R9 K7 ["Name"]
       27 LOADB                            R10 1
       ...
       33 LOADNIL                          R6
       34 FORGPREP                         R4
       35 GETTABLEKS                       R9 R8 K8 ["Attachment1"]
       37 GETTABLEKS                       R9 R9 K9 ["Parent"]
       39 GETTABLEKS                       R9 R9 K7 ["Name"]
       41 LOADB                            R10 1
...
MAIN:
       ...
       29 GETTABLEKS                       R4 R4 K11 ["RigInfo"]
       31 CALL                             R3 1 1
       32 GETIMPORT                        R4 K5 [require]
       34 GETTABLEKS                       R5 R0 K6 ["Packages"]
       36 GETTABLEKS                       R5 R5 K12 ["Roact"]
       38 CALL                             R4 1 1
       ...
       58 GETTABLEKS                       R11 R11 K18 ["Components"]
