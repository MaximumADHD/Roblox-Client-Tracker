...
MAIN:
  ...
  GETTABLEKS R22 R23 K38 ["GetFFlagRigVisualization"]
  CALL R21 1 1
  GETIMPORT R22 K26 [game]
  LOADK R24 K39 ["ACEImprovedErrorList"]
  LOADB R25 0
  NAMECALL R22 R22 K40 ["DefineFastFlag"]
  CALL R22 3 1
  GETTABLEKS R23 R1 K41 ["PureComponent"]
  LOADK R25 K42 ["InstanceSelector"]
  NAMECALL R23 R23 K43 ["extend"]
  CALL R23 2 1
  ...
  SETTABLEKS R29 R23 K50 ["isCurrentRootInstance"]
  DUPCLOSURE R29 K51 [PROTO_6]
  CAPTURE VAL R24
  CAPTURE VAL R9
  SETTABLEKS R29 R23 K52 ["selectValidInstance"]
  ...
  CAPTURE VAL R17
  CAPTURE VAL R11
  SETTABLEKS R29 R23 K54 ["showErrorDialogs"]
  ...
  CAPTURE VAL R9
  CAPTURE VAL R8
  SETTABLEKS R29 R23 K56 ["init"]
  DUPCLOSURE R29 K57 [PROTO_17]
  CAPTURE VAL R14
  SETTABLEKS R29 R23 K58 ["didMount"]
  ...
  CAPTURE VAL R17
  CAPTURE VAL R1
  SETTABLEKS R29 R23 K60 ["render"]
  DUPCLOSURE R29 K61 [PROTO_19]
  CAPTURE VAL R17
  SETTABLEKS R29 R23 K62 ["willUnmount"]
  MOVE R29 R5
  DUPTABLE R30 K66 [{"Plugin", "Mouse", "Analytics", "Signals"}]
  GETTABLEKS R31 R4 K63 ["Plugin"]
  SETTABLEKS R31 R30 K63 ["Plugin"]
  GETTABLEKS R31 R4 K64 ["Mouse"]
  SETTABLEKS R31 R30 K64 ["Mouse"]
  GETTABLEKS R31 R4 K65 ["Analytics"]
  SETTABLEKS R31 R30 K65 ["Analytics"]
  SETTABLEKS R18 R30 K33 ["Signals"]
  CALL R29 1 1
  MOVE R30 R23
  CALL R29 1 1
  MOVE R23 R29
  DUPCLOSURE R29 K67 [PROTO_20]
  DUPCLOSURE R30 K68 [PROTO_23]
  CAPTURE VAL R19
  CAPTURE VAL R20
  CAPTURE VAL R6
  GETTABLEKS R31 R2 K69 ["connect"]
  MOVE R32 R29
  MOVE R33 R30
  CALL R31 2 1
  MOVE R32 R23
