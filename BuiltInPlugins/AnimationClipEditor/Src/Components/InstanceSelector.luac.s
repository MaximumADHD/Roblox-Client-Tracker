...
MAIN:
  ...
  GETTABLEKS R20 R21 K36 ["GetFFlagBoneReferences"]
  CALL R19 1 1
  GETIMPORT R20 K5 [require]
  GETTABLEKS R22 R0 K35 ["LuaFlags"]
  GETTABLEKS R21 R22 K37 ["GetFFlagFixMultipleOutlines"]
  CALL R20 1 1
  GETTABLEKS R21 R1 K38 ["PureComponent"]
  LOADK R23 K39 ["InstanceSelector"]
  ...
  SETTABLEKS R27 R21 K47 ["isCurrentRootInstance"]
  DUPCLOSURE R27 K48 [PROTO_6]
  CAPTURE VAL R22
  CAPTURE VAL R9
  SETTABLEKS R27 R21 K49 ["selectValidInstance"]
  DUPCLOSURE R27 K50 [PROTO_7]
  CAPTURE VAL R11
  CAPTURE VAL R1
  CAPTURE VAL R10
  SETTABLEKS R27 R21 K51 ["showErrorDialogs"]
  DUPCLOSURE R27 K52 [PROTO_14]
  CAPTURE VAL R14
  CAPTURE VAL R15
  CAPTURE VAL R1
  CAPTURE VAL R20
  ...
  CAPTURE VAL R9
  CAPTURE VAL R8
  SETTABLEKS R27 R21 K53 ["init"]
  DUPCLOSURE R27 K54 [PROTO_17]
  CAPTURE VAL R12
  SETTABLEKS R27 R21 K55 ["didMount"]
  DUPCLOSURE R27 K56 [PROTO_18]
  CAPTURE VAL R13
  CAPTURE VAL R7
  CAPTURE VAL R15
  CAPTURE VAL R1
  CAPTURE VAL R19
  SETTABLEKS R27 R21 K57 ["render"]
  DUPCLOSURE R27 K58 [PROTO_19]
  CAPTURE VAL R15
  SETTABLEKS R27 R21 K59 ["willUnmount"]
  MOVE R27 R5
  DUPTABLE R28 K63 [{"Plugin", "Mouse", "Analytics", "Signals"}]
  GETTABLEKS R29 R4 K60 ["Plugin"]
  SETTABLEKS R29 R28 K60 ["Plugin"]
  GETTABLEKS R29 R4 K61 ["Mouse"]
  SETTABLEKS R29 R28 K61 ["Mouse"]
  GETTABLEKS R29 R4 K62 ["Analytics"]
  SETTABLEKS R29 R28 K62 ["Analytics"]
  SETTABLEKS R16 R28 K31 ["Signals"]
  CALL R27 1 1
  MOVE R28 R21
  CALL R27 1 1
  MOVE R21 R27
  DUPCLOSURE R27 K64 [PROTO_20]
  CAPTURE VAL R19
  DUPCLOSURE R28 K65 [PROTO_23]
  CAPTURE VAL R17
  CAPTURE VAL R18
  CAPTURE VAL R6
  GETTABLEKS R29 R2 K66 ["connect"]
  MOVE R30 R27
  MOVE R31 R28
  CALL R29 2 1
  MOVE R30 R21
