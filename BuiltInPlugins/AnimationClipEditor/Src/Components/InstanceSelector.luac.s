...
PROTO_7:
  ...
  GETUPVAL R13 5
  DUPTABLE R14 K11 [{"ErrorType", "Entries"}]
  GETTABLEKS R15 R7 K12 ["ID"]
  SETTABLEKS R15 R14 K9 ["ErrorType"]
  SETTABLEKS R9 R14 K10 ["Entries"]
  CALL R12 2 -1
  CALL R10 -1 0
...
PROTO_13:
  ...
  CALL R5 2 0
  GETUPVAL R5 3
  NAMECALL R7 R2 K18 ["get"]
  CALL R7 1 1
  MOVE R8 R4
  NAMECALL R5 R5 K19 ["showErrorDialogs"]
  CALL R5 3 0
  RETURN R0 0
  JUMPIFNOT R0 [+97]
  JUMPIFNOT R2 [+96]
  ...
  GETTABLEKS R3 R4 K16 ["UpdateRootInstance"]
  LOADNIL R4
  GETUPVAL R7 3
  GETTABLEKS R6 R7 K9 ["props"]
  GETTABLEKS R5 R6 K17 ["Analytics"]
  CALL R3 2 0
  RETURN R0 0
  LOADB R3 0
  JUMPIFEQKNIL R1 [+24]
  ...
  CALL R5 2 0
  GETUPVAL R6 3
  GETTABLEKS R5 R6 K20 ["deselectAndRemoveSelectedTrackInstances"]
  CALL R5 0 0
  RETURN R0 0
  GETUPVAL R6 3
  GETTABLEKS R5 R6 K20 ["deselectAndRemoveSelectedTrackInstances"]
  CALL R5 0 0
  NAMECALL R5 R2 K18 ["get"]
  CALL R5 1 1
...
PROTO_18:
  ...
  JUMP [+71]
  GETUPVAL R8 3
  GETTABLEKS R7 R8 K6 ["getOrCreateMicroboneFolder"]
  CALL R7 0 1
  JUMPIFNOT R3 [+66]
  NAMECALL R8 R7 K7 ["GetChildren"]
  CALL R8 1 1
  ...
  FORGPREP_NEXT R9
  LOADK R16 K10 ["Cone"]
  NAMECALL R14 R13 K11 ["FindFirstChild"]
  CALL R14 2 1
  JUMPIFNOT R14 [+23]
  GETTABLEKS R15 R13 K10 ["Cone"]
  GETTABLEKS R14 R15 K12 ["Color3"]
  GETUPVAL R16 4
  GETTABLEKS R15 R16 K13 ["BONE_COLOR_SELECTED"]
  JUMPIFNOTEQ R14 R15 [+15]
  GETTABLEKS R14 R13 K10 ["Cone"]
  GETUPVAL R16 4
  GETTABLEKS R15 R16 K14 ["BONE_COLOR_DEFAULT"]
  SETTABLEKS R15 R14 K12 ["Color3"]
  GETTABLEKS R14 R13 K10 ["Cone"]
  GETUPVAL R16 4
  GETTABLEKS R15 R16 K15 ["BONE_TRANSPARENCY_DEFAULT"]
  SETTABLEKS R15 R14 K16 ["Transparency"]
  LOADK R16 K17 ["Sphere"]
  NAMECALL R14 R13 K11 ["FindFirstChild"]
  CALL R14 2 1
  JUMPIFNOT R14 [+23]
  GETTABLEKS R15 R13 K17 ["Sphere"]
  GETTABLEKS R14 R15 K12 ["Color3"]
  GETUPVAL R16 4
  GETTABLEKS R15 R16 K13 ["BONE_COLOR_SELECTED"]
  JUMPIFNOTEQ R14 R15 [+15]
  GETTABLEKS R14 R13 K17 ["Sphere"]
  GETUPVAL R16 4
  GETTABLEKS R15 R16 K14 ["BONE_COLOR_DEFAULT"]
  SETTABLEKS R15 R14 K12 ["Color3"]
  GETTABLEKS R14 R13 K17 ["Sphere"]
  ...
  SETTABLEKS R15 R14 K16 ["Transparency"]
  FORGLOOP R9 2 [-57]
  GETTABLEKS R7 R2 K18 ["SelectedTrackInstances"]
  JUMPIFNOT R7 [+145]
  GETIMPORT R7 K20 [ipairs]
  GETTABLEKS R8 R2 K18 ["SelectedTrackInstances"]
  CALL R7 1 3
  FORGPREP_INEXT R7
  GETUPVAL R12 1
  CALL R12 0 1
  ...
  JUMPIFNOT R3 [+12]
  GETUPVAL R13 2
  GETTABLEKS R12 R13 K21 ["isBone"]
  MOVE R13 R11
  CALL R12 1 1
  JUMPIFNOT R12 [+6]
  GETUPVAL R13 2
  GETTABLEKS R12 R13 K22 ["selectBone"]
  MOVE R13 R11
  CALL R12 1 0
  JUMP [+121]
  LOADK R13 K23 ["SelectionBox"]
  MOVE R14 R10
  CONCAT R12 R13 R14
  GETUPVAL R14 5
  GETTABLEKS R13 R14 K24 ["createElement"]
  LOADK R14 K23 ["SelectionBox"]
  DUPTABLE R15 K30 [{"Archivable", "Adornee", "LineThickness", "Transparency", "SurfaceTransparency", "StudioSelectionBox"}]
  LOADB R16 0
  SETTABLEKS R16 R15 K25 ["Archivable"]
  SETTABLEKS R11 R15 K26 ["Adornee"]
  LOADN R16 1
  SETTABLEKS R16 R15 K27 ["LineThickness"]
  LOADK R16 K31 [0.5]
  SETTABLEKS R16 R15 K16 ["Transparency"]
  LOADK R16 K32 [0.8]
  SETTABLEKS R16 R15 K28 ["SurfaceTransparency"]
  LOADB R16 1
  SETTABLEKS R16 R15 K29 ["StudioSelectionBox"]
  CALL R13 2 1
  SETTABLE R13 R6 R12
  JUMP [+93]
  JUMPIFNOT R3 [+65]
  GETTABLEKS R12 R11 K33 ["Parent"]
  JUMPIFEQKNIL R12 [+7]
  GETTABLEKS R13 R11 K33 ["Parent"]
  GETTABLEKS R12 R13 K34 ["Name"]
  JUMPIFEQKS R12 K35 ["RBX_MICROBONE_NODES"] [+29]
  LOADK R13 K23 ["SelectionBox"]
  MOVE R14 R10
  CONCAT R12 R13 R14
  GETUPVAL R14 5
  ...
  JUMPIFNOT R11 [+12]
  LOADK R14 K10 ["Cone"]
  NAMECALL R12 R11 K11 ["FindFirstChild"]
  CALL R12 2 1
  JUMPIFNOT R12 [+7]
  GETTABLEKS R12 R11 K10 ["Cone"]
  GETUPVAL R14 4
  GETTABLEKS R13 R14 K13 ["BONE_COLOR_SELECTED"]
  SETTABLEKS R13 R12 K12 ["Color3"]
  JUMPIFNOT R11 [+40]
  LOADK R14 K17 ["Sphere"]
  NAMECALL R12 R11 K11 ["FindFirstChild"]
  CALL R12 2 1
  JUMPIFNOT R12 [+35]
  GETTABLEKS R12 R11 K17 ["Sphere"]
  GETUPVAL R14 4
  GETTABLEKS R13 R14 K13 ["BONE_COLOR_SELECTED"]
  SETTABLEKS R13 R12 K12 ["Color3"]
  JUMP [+27]
  ...
  CALL R13 2 1
  SETTABLE R13 R6 R12
  FORGLOOP R7 2 [inext] [-138]
  MOVE R7 R4
  JUMPIFNOT R7 [+17]
  GETUPVAL R8 5
  GETTABLEKS R7 R8 K24 ["createElement"]
  LOADK R8 K23 ["SelectionBox"]
  DUPTABLE R9 K36 [{"Archivable", "Adornee", "LineThickness", "StudioSelectionBox"}]
  LOADB R10 0
  SETTABLEKS R10 R9 K25 ["Archivable"]
  SETTABLEKS R4 R9 K26 ["Adornee"]
  LOADN R10 2
  SETTABLEKS R10 R9 K27 ["LineThickness"]
  LOADB R10 1
  SETTABLEKS R10 R9 K29 ["StudioSelectionBox"]
  CALL R7 2 1
  SETTABLEKS R7 R6 K37 ["HoverBox"]
  GETUPVAL R8 5
  GETTABLEKS R7 R8 K24 ["createElement"]
  GETUPVAL R9 5
  GETTABLEKS R8 R9 K38 ["Portal"]
  DUPTABLE R9 K40 [{"target"}]
  SETTABLEKS R5 R9 K39 ["target"]
  MOVE R10 R6
  CALL R7 3 -1
  RETURN R7 -1
...
MAIN:
  ...
  GETTABLEKS R23 R0 K37 ["LuaFlags"]
  GETTABLEKS R22 R23 K38 ["GetFFlagFixMultipleOutlines"]
  CALL R21 1 1
  GETIMPORT R22 K5 [require]
  GETTABLEKS R24 R0 K37 ["LuaFlags"]
  GETTABLEKS R23 R24 K39 ["GetFFlagRigVisualization"]
  CALL R22 1 1
  GETIMPORT R23 K26 [game]
  LOADK R25 K40 ["ACEImprovedErrorList"]
  LOADB R26 0
  NAMECALL R23 R23 K41 ["DefineFastFlag"]
  CALL R23 3 1
  GETTABLEKS R24 R1 K42 ["PureComponent"]
  LOADK R26 K43 ["InstanceSelector"]
  NAMECALL R24 R24 K44 ["extend"]
  CALL R24 2 1
  DUPCLOSURE R25 K45 [PROTO_0]
  CAPTURE VAL R25
  DUPCLOSURE R26 K46 [PROTO_1]
  DUPCLOSURE R27 K47 [PROTO_2]
  CAPTURE VAL R16
  CAPTURE VAL R21
  ...
  SETTABLEKS R30 R24 K51 ["isCurrentRootInstance"]
  DUPCLOSURE R30 K52 [PROTO_6]
  CAPTURE VAL R25
  CAPTURE VAL R9
  SETTABLEKS R30 R24 K53 ["selectValidInstance"]
  ...
  CAPTURE VAL R17
  CAPTURE VAL R11
  SETTABLEKS R30 R24 K55 ["showErrorDialogs"]
  DUPCLOSURE R30 K56 [PROTO_14]
  CAPTURE VAL R16
  CAPTURE VAL R17
  CAPTURE VAL R1
  CAPTURE VAL R21
  ...
  CAPTURE VAL R9
  CAPTURE VAL R8
  SETTABLEKS R30 R24 K57 ["init"]
  DUPCLOSURE R30 K58 [PROTO_17]
  CAPTURE VAL R14
  SETTABLEKS R30 R24 K59 ["didMount"]
  DUPCLOSURE R30 K60 [PROTO_18]
  CAPTURE VAL R15
  CAPTURE VAL R22
  CAPTURE VAL R10
  CAPTURE VAL R7
  CAPTURE VAL R17
  CAPTURE VAL R1
  SETTABLEKS R30 R24 K61 ["render"]
  DUPCLOSURE R30 K62 [PROTO_19]
  CAPTURE VAL R17
  SETTABLEKS R30 R24 K63 ["willUnmount"]
  MOVE R30 R5
  DUPTABLE R31 K67 [{"Plugin", "Mouse", "Analytics", "Signals"}]
  GETTABLEKS R32 R4 K64 ["Plugin"]
  SETTABLEKS R32 R31 K64 ["Plugin"]
  GETTABLEKS R32 R4 K65 ["Mouse"]
  SETTABLEKS R32 R31 K65 ["Mouse"]
  GETTABLEKS R32 R4 K66 ["Analytics"]
  SETTABLEKS R32 R31 K66 ["Analytics"]
  SETTABLEKS R18 R31 K33 ["Signals"]
  CALL R30 1 1
  MOVE R31 R24
  CALL R30 1 1
  MOVE R24 R30
  DUPCLOSURE R30 K68 [PROTO_20]
  DUPCLOSURE R31 K69 [PROTO_23]
  CAPTURE VAL R19
  CAPTURE VAL R20
  CAPTURE VAL R6
  GETTABLEKS R32 R2 K70 ["connect"]
  MOVE R33 R30
  MOVE R34 R31
  CALL R32 2 1
  MOVE R33 R24
