...
PROTO_12:
       ...
       14 CAPTURE                          VAL R0
       15 CAPTURE                          UPVAL U1
       16 SETTABLEKS                       R3 R0 K8 ["onAddEvent"]
       18 NEWCLOSURE                       R3 P2
       19 CAPTURE                          VAL R0
       20 CAPTURE                          UPVAL U1
       21 SETTABLEKS                       R3 R0 K9 ["onRenameEvent"]
       23 NEWCLOSURE                       R3 P3
       24 CAPTURE                          VAL R0
       25 CAPTURE                          UPVAL U1
       26 SETTABLEKS                       R3 R0 K10 ["onSetEventValue"]
       28 NEWCLOSURE                       R3 P4
       29 CAPTURE                          VAL R0
       30 CAPTURE                          UPVAL U1
       31 SETTABLEKS                       R3 R0 K11 ["onDeleteEvent"]
       33 NEWCLOSURE                       R3 P5
       34 CAPTURE                          VAL R0
       35 CAPTURE                          UPVAL U1
       36 SETTABLEKS                       R3 R0 K12 ["onDeleteAllEvents"]
       38 NEWCLOSURE                       R3 P6
       39 CAPTURE                          VAL R0
       40 CAPTURE                          UPVAL U1
       41 SETTABLEKS                       R3 R0 K13 ["onRenameAllEvents"]
       43 NEWCLOSURE                       R3 P7
       44 CAPTURE                          VAL R0
       45 SETTABLEKS                       R3 R0 K14 ["showDeleteAllPrompt"]
       47 NEWCLOSURE                       R3 P8
       48 CAPTURE                          VAL R0
       49 CAPTURE                          UPVAL U2
       50 SETTABLEKS                       R3 R0 K15 ["hideDeleteAllPrompt"]
       52 NEWCLOSURE                       R3 P9
       53 CAPTURE                          VAL R0
       54 SETTABLEKS                       R3 R0 K16 ["showRenameAllPrompt"]
       56 NEWCLOSURE                       R3 P10
       57 CAPTURE                          VAL R0
       58 CAPTURE                          UPVAL U2
       59 SETTABLEKS                       R3 R0 K17 ["hideRenameAllPrompt"]
       61 NEWCLOSURE                       R3 P11
       62 CAPTURE                          VAL R0
       63 CAPTURE                          UPVAL U3
       64 SETTABLEKS                       R3 R0 K18 ["getUnusedEvents"]
       66 RETURN                           R0 0
