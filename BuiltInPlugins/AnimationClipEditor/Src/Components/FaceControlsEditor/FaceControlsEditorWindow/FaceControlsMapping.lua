...
if GetFFlagFaceControlsEditorBugBash2Update() then
	FaceControlsMapping.FacsControlToFaceSliderInfoMap = {
		...
		MouthLeft = {
			currentValue = 0.5,
			defaultValue = 0.5,
			position = UDim2.new(0, 106, 0, 240),
			rotation = 0,
			customWidth = 80,
			Tooltip = "Mouth",
		},
		...
		LeftLowerLipDepressor = {
			currentValue = 0,
			defaultValue = 0,
			position = UDim2.new(0, 120, 0, 274),
			rotation = 65,
		},
		LeftLipCornerPuller = {
			currentValue = 0,
			defaultValue = 0,
			position = UDim2.new(0, 138, 0, 216),
			rotation = -50,
		},
		...
		LeftUpperLipRaiser = {
			currentValue = 0,
			defaultValue = 0,
			position = UDim2.new(0, 118, 0, 204),
			rotation = -65,
		},
		...
		RightLowerLipDepressor = {
			currentValue = 0,
			defaultValue = 0,
			position = UDim2.new(0, 53, 0, 274),
			rotation = 114,
		},
		RightLipCornerPuller = {
			currentValue = 0,
			defaultValue = 0,
			position = UDim2.new(0, 36, 0, 216),
			rotation = -130,
		},
		...
		JawDrop = {
			currentValue = 0,
			defaultValue = 0,
			position = UDim2.new(0, 118, 0, 562),
			rotation = 90,
			customWidth = 40,
		}, --sideView
		JawLeft = {
		...
		LeftBrowLowerer = {
			currentValue = 0,
			defaultValue = 0,
			position = UDim2.new(0, 122, 0, 100),
			rotation = 100,
			customWidth = 36,
		},
		LeftOuterBrowRaiser = {
		...
		LeftInnerBrowRaiser = {
			currentValue = 0,
			defaultValue = 0,
			position = UDim2.new(0, 105, 0, 58),
			rotation = -90,
		},
		RightBrowLowerer = {
			currentValue = 0,
			defaultValue = 0,
			position = UDim2.new(0, 56, 0, 100),
			rotation = 80,
			customWidth = 36,
		},
		...
		LeftEyeUpperLidRaiser = {
			currentValue = 0.5,
			defaultValue = 0.5,
			position = UDim2.new(0, 111, 0, 125),
			rotation = -90,
			Tooltip = "LeftEye",
		},
		LeftEyeClosed = {
			currentValue = 0.5,
			defaultValue = 0.5,
			position = UDim2.new(0, 111, 0, 143),
			rotation = -90,
			customWidth = 44,
			Tooltip = "LeftEye",
		},
		...
		TongueDown = {
			currentValue = 0.5,
			defaultValue = 0.5,
			position = UDim2.new(0, 168, 0, 475),
			rotation = 90,
			customWidth = 50,
			Tooltip = "Tongue",
		}, --sideView
		TongueUp = {
			currentValue = 0.5,
			defaultValue = 0.5,
			position = UDim2.new(0, 164, 0, 475),
			rotation = 90,
			customWidth = 50,
			Tooltip = "Tongue",
		}, --sideView
	...
	FaceControlsMapping.FacsControlToFaceSliderInfoMap = {
		...
		TongueDown = {
			currentValue = 0.5,
			defaultValue = 0.5,
			position = UDim2.new(0, 168, 0, 515),
			rotation = 90,
			customWidth = 50,
			Tooltip = "Tongue",
		}, -- 270, 90
		TongueUp = {
			currentValue = 0.5,
			defaultValue = 0.5,
			position = UDim2.new(0, 164, 0, 515),
			rotation = 90,
			customWidth = 50,
			Tooltip = "Tongue",
		},
