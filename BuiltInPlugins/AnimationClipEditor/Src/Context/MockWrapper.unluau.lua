...
function var14.getMockGlobals(arg1)
   ...
   local var142 = var2
   var142 = var0.storeState
   local var148 = var2.thunkMiddleware
   local var7 = var0.theme
   if not var7 then
      var7 = var8(true)
   end
   local var155 = var4.PluginActions
   var155 = var3
   local var158 = {}
   var158.id = "rerunLastStory"
   var158.text = "MOCK"
   local var10 = {}
   var10.focusGui = var2
   var10.plugin = var3
   ...
   var10.theme = var7
   var10.mouse = var4
   var10.store = var142.Store.new(var9, var142, {})
   var10.analytics = var4.Analytics.mock()
   var10.pluginActions = var155.new(var155, {})
