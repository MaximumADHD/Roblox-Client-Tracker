...
PROTO_5:
  ...
  CALL R4 1 1
  MOVE R1 R4
  DUPTABLE R4 K7 [{"pivotTick", "newTick", "animationData", "selectedEvents"}]
  SETTABLEKS R2 R4 K3 ["pivotTick"]
  SETTABLEKS R2 R4 K4 ["newTick"]
  SETTABLEKS R0 R4 K5 ["animationData"]
  SETTABLEKS R1 R4 K6 ["selectedEvents"]
  GETUPVAL R7 2
  FASTCALL2 SETMETATABLE R4 R7 [+4]
  MOVE R6 R4
...
MAIN:
  ...
  GETTABLEKS R7 R0 K13 ["LuaFlags"]
  GETTABLEKS R6 R7 K14 ["GetFFlagFilterEvents"]
  CALL R5 1 1
  NEWTABLE R6 8 0
  ...
  CAPTURE VAL R4
  CAPTURE VAL R6
  SETTABLEKS R7 R6 K19 ["newTangentContext"]
  DUPCLOSURE R7 K20 [PROTO_2]
  SETTABLEKS R7 R6 K21 ["moveKeyframes"]
  DUPCLOSURE R7 K22 [PROTO_3]
  SETTABLEKS R7 R6 K23 ["scaleKeyframes"]
  MOVE R7 R5
  CALL R7 0 1
  JUMPIFNOT R7 [+7]
  ...
  CAPTURE VAL R3
  CAPTURE VAL R6
  SETTABLEKS R7 R6 K25 ["newEvents"]
  JUMP [+6]
  ...
  SETTABLEKS R7 R6 K28 ["moveEvents"]
  RETURN R6 1
