PROTO_0:
  ...
  SETTABLE R12 R3 R11
  JUMP [+14]
  GETTABLEKS R11 R10 K4 ["part0"]
  JUMPIFNOT R11 [+4]
  GETTABLEKS R11 R10 K4 ["part0"]
  LOADB R12 1
  SETTABLE R12 R3 R11
  GETTABLEKS R11 R10 K5 ["part1"]
  JUMPIFNOT R11 [+4]
  GETTABLEKS R11 R10 K5 ["part1"]
  LOADB R12 1
  SETTABLE R12 R3 R11
  ...
  JUMPIFNOT R6 [+27]
  GETUPVAL R7 0
  GETTABLEKS R6 R7 K6 ["getAnimationConstraints"]
  MOVE R7 R0
  CALL R6 1 1
  MOVE R7 R6
  LOADNIL R8
  ...
  DUPTABLE R12 K11 [{"ID"}]
  GETUPVAL R15 4
  GETTABLEKS R14 R15 K12 ["RIG_ERRORS"]
  GETTABLEKS R13 R14 K13 ["NameCollision"]
  SETTABLEKS R13 R12 K10 ["ID"]
  SETLIST R11 R12 1 [1]
  RETURN R11 1
  GETTABLEKS R11 R9 K9 ["Name"]
  LOADB R12 1
  SETTABLE R12 R4 R11
  FORGLOOP R6 2 [-22]
  GETUPVAL R6 1
  ...
  GETUPVAL R15 4
  GETTABLEKS R14 R15 K12 ["RIG_ERRORS"]
  GETTABLEKS R13 R14 K14 ["BoneNameCollision"]
  SETTABLEKS R13 R12 K10 ["ID"]
  SETLIST R11 R12 1 [1]
  RETURN R11 1
  GETTABLEKS R11 R10 K9 ["Name"]
  LOADB R12 1
  SETTABLE R12 R5 R11
  FORGLOOP R6 2 [-22]
  NEWTABLE R6 0 0
...
PROTO_6:
  ...
  CALL R3 1 1
  MOVE R2 R3
  DUPTABLE R3 K17 [{"errorList", "motorsMap", "partsWithMultipleParents", "motorsWithMissingPart0", "motorsWithMissingPart1", "unanchoredPartExists", "motors", "parts", "root", "bones", "animConstraints", "animConstraintsMap", "animConstraintsWithMissingAttachment0", "animConstraintsWithMissingAttachment1", "rig"}]
  NEWTABLE R4 0 0
  SETTABLEKS R4 R3 K2 ["errorList"]
  NEWTABLE R4 0 0
  SETTABLEKS R4 R3 K3 ["motorsMap"]
  NEWTABLE R4 0 0
  SETTABLEKS R4 R3 K4 ["partsWithMultipleParents"]
  NEWTABLE R4 0 0
  SETTABLEKS R4 R3 K5 ["motorsWithMissingPart0"]
  NEWTABLE R4 0 0
  SETTABLEKS R4 R3 K6 ["motorsWithMissingPart1"]
  LOADB R4 0
  SETTABLEKS R4 R3 K7 ["unanchoredPartExists"]
  GETUPVAL R5 2
  GETTABLEKS R4 R5 K18 ["getMotors"]
  MOVE R5 R0
  CALL R4 1 1
  SETTABLEKS R4 R3 K8 ["motors"]
  SETTABLEKS R2 R3 K9 ["parts"]
  GETUPVAL R5 2
  GETTABLEKS R4 R5 K19 ["findRootPart"]
  MOVE R5 R0
  CALL R4 1 1
  SETTABLEKS R4 R3 K10 ["root"]
  GETUPVAL R5 2
  GETTABLEKS R4 R5 K20 ["getBones"]
  MOVE R5 R0
  CALL R4 1 1
  SETTABLEKS R4 R3 K11 ["bones"]
  GETUPVAL R5 3
  CALL R5 0 1
  JUMPIFNOT R5 [+6]
  GETUPVAL R5 2
  GETTABLEKS R4 R5 K21 ["getAnimationConstraints"]
  MOVE R5 R0
  CALL R4 1 1
  JUMP [+2]
  NEWTABLE R4 0 0
  SETTABLEKS R4 R3 K12 ["animConstraints"]
  NEWTABLE R4 0 0
  SETTABLEKS R4 R3 K13 ["animConstraintsMap"]
  NEWTABLE R4 0 0
  SETTABLEKS R4 R3 K14 ["animConstraintsWithMissingAttachment0"]
  NEWTABLE R4 0 0
  SETTABLEKS R4 R3 K15 ["animConstraintsWithMissingAttachment1"]
  SETTABLEKS R0 R3 K16 ["rig"]
  GETUPVAL R4 4
  MOVE R5 R3
  CALL R4 1 0
  GETUPVAL R4 3
  ...
  MOVE R5 R3
  CALL R4 1 0
  GETTABLEKS R6 R3 K2 ["errorList"]
  LENGTH R5 R6
  LOADN R6 0
  JUMPIFLT R6 R5 [+2]
  LOADB R4 0 +1
  LOADB R4 1
  GETTABLEKS R5 R3 K2 ["errorList"]
  RETURN R4 2
...
MAIN:
  ...
  LOADK R8 K16 ["ACEFixMoreDuplicatePartNames"]
  LOADB R9 0
  NAMECALL R6 R6 K17 ["DefineFastFlag"]
  CALL R6 3 1
  GETIMPORT R7 K15 [game]
  LOADK R9 K18 ["ACEBoneNameCollision"]
  LOADB R10 0
  ...
  CAPTURE VAL R12
  CAPTURE VAL R14
  SETTABLEKS R15 R8 K26 ["rigHasErrors"]
  RETURN R8 1
