...
PROTO_12:
       ...
       55 CALL                             R13 0 1
       56 JUMPIFNOT                        R13 ; [+7]
       57 GETTABLEKS                       R13 R12 K8 ["Parent"]
       59 LOADK                            R15 K11 ["Bone"]
       60 NAMECALL                         R13 R13 K10 ["IsA"]
       62 CALL                             R13 2 1
       63 JUMPIF                           R13 ; [+8]
       64 GETTABLEKS                       R15 R12 K2 ["Name"]
       66 FASTCALL2                        TABLE_INSERT R7 R15 ; [+4]
       68 MOVE                             R14 R7
       69 GETIMPORT                        R13 K5 [table.insert]
       71 CALL                             R13 2 0
       72 FORGLOOP                         R8 2 ; [-29]
       74 LENGTH                           R8 R7
       75 LOADN                            R9 0
...
MAIN:
       ...
       61 GETTABLEKS                       R10 R0 K19 ["LuaFlags"]
       63 GETTABLEKS                       R10 R10 K21 ["GetFFlagRootMotion"]
       65 CALL                             R9 1 1
       66 NEWTABLE                         R10 1 0
       ...
       79 CAPTURE                          VAL R5
       80 CAPTURE                          VAL R4
       81 DUPCLOSURE                       R14 K25 [PROTO_6]
       82 CAPTURE                          VAL R6
       83 CAPTURE                          VAL R4
       84 CAPTURE                          VAL R5
       85 CAPTURE                          VAL R3
       86 DUPCLOSURE                       R15 K26 [PROTO_7]
       87 CAPTURE                          VAL R6
       88 CAPTURE                          VAL R4
       89 CAPTURE                          VAL R5
       90 DUPCLOSURE                       R16 K27 [PROTO_9]
       91 CAPTURE                          VAL R6
       92 CAPTURE                          VAL R5
       93 CAPTURE                          VAL R4
       94 DUPCLOSURE                       R17 K28 [PROTO_10]
       95 CAPTURE                          VAL R6
       96 CAPTURE                          VAL R7
       97 CAPTURE                          VAL R4
       98 CAPTURE                          VAL R5
       99 DUPCLOSURE                       R18 K29 [PROTO_11]
      100 CAPTURE                          VAL R6
      101 CAPTURE                          VAL R4
      102 CAPTURE                          VAL R5
      103 DUPCLOSURE                       R19 K30 [PROTO_12]
      104 CAPTURE                          VAL R6
      105 CAPTURE                          VAL R4
      106 CAPTURE                          VAL R5
      107 CAPTURE                          VAL R8
      108 DUPCLOSURE                       R20 K31 [PROTO_13]
      109 CAPTURE                          VAL R4
      110 CAPTURE                          VAL R6
      111 CAPTURE                          VAL R11
      112 CAPTURE                          VAL R12
      ...
      118 CAPTURE                          VAL R18
      119 CAPTURE                          VAL R19
      120 SETTABLEKS                       R20 R10 K32 ["validate"]
      122 RETURN                           R10 1
