...
PROTO_18:
  ...
  CALL R5 2 1
  JUMPIFNOT R5 [+6]
  GETTABLEKS R5 R3 K3 ["RigType"]
  GETIMPORT R6 K7 [Enum.HumanoidRigType.R15]
  JUMPIFEQ R5 R6 [+3]
  LOADB R4 0
  JUMP [+11]
  GETTABLEKS R5 R3 K8 ["Parent"]
  JUMPIFNOT R5 [+5]
  LOADK R8 K9 ["Model"]
  ...
  LOADK R5 K13 ["AnimationRigData"]
  MOVE R6 R2
  CALL R4 2 1
  MOVE R7 R3
  NAMECALL R5 R4 K14 ["LoadFromHumanoid"]
  CALL R5 2 1
  JUMPIF R5 [+4]
  NAMECALL R6 R4 K15 ["Destroy"]
  CALL R6 1 0
  RETURN R0 0
  GETTABLEKS R7 R1 K16 ["Name"]
  LOADK R8 K13 ["AnimationRigData"]
  CONCAT R6 R7 R8
  SETTABLEKS R6 R4 K16 ["Name"]
  GETTABLEKS R6 R0 K17 ["Metadata"]
  SETTABLEKS R4 R6 K18 ["AnimationRig"]
  RETURN R0 0
...
PROTO_24:
  ...
  JUMPIFNOT R13 [+16]
  GETUPVAL R14 1
  GETTABLEKS R13 R14 K17 ["getRigInfo"]
  MOVE R14 R1
  CALL R13 1 1
  GETTABLEKS R8 R13 K18 ["Parts"]
  GETTABLEKS R9 R13 K19 ["PartNameToMotor"]
  GETTABLEKS R10 R13 K20 ["PartNameToConstraint"]
  GETTABLEKS R12 R13 K21 ["PartNameToAnimConstraint"]
  GETTABLEKS R11 R13 K22 ["BoneNameToBone"]
  JUMP [+10]
  GETUPVAL R14 1
  GETTABLEKS R13 R14 K17 ["getRigInfo"]
  MOVE R14 R1
  ...
  MOVE R12 R17
  NEWTABLE R13 0 0
  GETTABLEKS R15 R0 K23 ["Instances"]
  GETTABLEKS R14 R15 K24 ["Root"]
  GETTABLEKS R17 R14 K25 ["Type"]
  GETUPVAL R20 2
  GETTABLEKS R19 R20 K26 ["INSTANCE_TYPES"]
  GETTABLEKS R18 R19 K27 ["Rig"]
  JUMPIFEQ R17 R18 [+2]
  LOADB R16 0 +1
  LOADB R16 1
  FASTCALL2K ASSERT R16 K28 [+4]
  LOADK R17 K28 ["Can only export Rig animations to KeyframeSequence."]
  GETIMPORT R15 K2 [assert]
  CALL R15 2 0
  GETTABLEKS R15 R14 K29 ["Tracks"]
  GETUPVAL R16 3
  MOVE R17 R15
  MOVE R18 R9
  MOVE R19 R11
  MOVE R20 R12
  CALL R16 4 1
  GETIMPORT R17 K31 [pairs]
  MOVE R18 R15
  CALL R17 1 3
  FORGPREP_NEXT R17
  GETIMPORT R22 K31 [pairs]
  GETTABLEKS R23 R21 K32 ["Keyframes"]
  CALL R22 1 3
  FORGPREP_NEXT R22
  GETUPVAL R29 2
  GETTABLEKS R28 R29 K33 ["TICK_FREQUENCY"]
  DIV R27 R26 R28
  GETTABLE R28 R13 R26
  JUMPIF R28 [+10]
  GETIMPORT R29 K9 [Instance.new]
  LOADK R30 K34 ["Keyframe"]
  CALL R29 1 1
  SETTABLEKS R27 R29 K35 ["Time"]
  SETTABLEKS R5 R29 K36 ["Parent"]
  MOVE R28 R29
  SETTABLE R28 R13 R26
  GETTABLEKS R29 R21 K25 ["Type"]
  GETTABLEKS R31 R21 K37 ["Data"]
  ...
  FORGLOOP R22 2 [-35]
  FORGLOOP R17 2 [-43]
  GETIMPORT R17 K40 [ipairs]
  GETTABLEKS R18 R3 K32 ["Keyframes"]
  CALL R17 1 3
  FORGPREP_INEXT R17
  GETTABLEKS R23 R3 K37 ["Data"]
  ...
  GETIMPORT R30 K9 [Instance.new]
  LOADK R31 K41 ["KeyframeMarker"]
  MOVE R32 R29
  CALL R30 2 1
  SETTABLEKS R26 R30 K11 ["Name"]
  SETTABLEKS R27 R30 K42 ["Value"]
  ADDK R7 R7 K38 [1]
  FORGLOOP R23 2 [-27]
  FORGLOOP R17 2 [inext] [-37]
  GETUPVAL R17 5
  MOVE R18 R0
  MOVE R19 R1
  MOVE R20 R5
  CALL R17 3 0
  NAMECALL R17 R5 K43 ["GetKeyframes"]
  CALL R17 1 1
  MOVE R18 R5
  LENGTH R19 R17
  MOVE R20 R6
...
PROTO_27:
  ...
  JUMPIFNOT R7 [+12]
  GETUPVAL R8 1
  GETTABLEKS R7 R8 K15 ["getRigInfo"]
  MOVE R8 R1
  CALL R7 1 1
  GETTABLEKS R4 R7 K16 ["PartNameToMotor"]
  GETTABLEKS R6 R7 K17 ["PartNameToAnimConstraint"]
  GETTABLEKS R5 R7 K18 ["BoneNameToBone"]
  JUMP [+11]
  LOADNIL R7
  GETUPVAL R9 1
  GETTABLEKS R8 R9 K15 ["getRigInfo"]
  MOVE R9 R1
  CALL R8 1 5
  MOVE R7 R8
  MOVE R4 R9
  ...
  LOADN R8 0
  LOADN R9 0
  GETTABLEKS R11 R0 K19 ["Instances"]
  GETTABLEKS R10 R11 K20 ["Root"]
  GETTABLEKS R13 R10 K21 ["Type"]
  GETUPVAL R16 2
  GETTABLEKS R15 R16 K22 ["INSTANCE_TYPES"]
  GETTABLEKS R14 R15 K23 ["Rig"]
  JUMPIFEQ R13 R14 [+2]
  LOADB R12 0 +1
  LOADB R12 1
  FASTCALL2K ASSERT R12 K24 [+4]
  LOADK R13 K24 ["Can only export Rig animations to CurveAnimation."]
  GETIMPORT R11 K2 [assert]
  CALL R11 2 0
  GETTABLEKS R11 R10 K25 ["Tracks"]
  GETUPVAL R12 3
  MOVE R13 R11
  MOVE R14 R4
  MOVE R15 R5
  ...
  MOVE R21 R12
  CALL R18 3 1
  GETTABLEKS R19 R17 K21 ["Type"]
  GETUPVAL R22 2
  GETTABLEKS R21 R22 K28 ["TRACK_TYPES"]
  GETTABLEKS R20 R21 K29 ["CFrame"]
  JUMPIFNOTEQ R19 R20 [+57]
  MOVE R21 R16
  NAMECALL R19 R18 K30 ["FindFirstChild"]
  CALL R19 2 1
  JUMPIF R19 [+5]
  GETIMPORT R19 K7 [Instance.new]
  LOADK R20 K31 ["Folder"]
  MOVE R21 R18
  CALL R19 2 1
  MOVE R18 R19
  SETTABLEKS R16 R18 K9 ["Name"]
  GETGLOBAL R19 K32 ["makeVector3Curve"]
  GETTABLEKS R21 R17 K33 ["Components"]
  GETUPVAL R24 2
  GETTABLEKS R23 R24 K34 ["PROPERTY_KEYS"]
  GETTABLEKS R22 R23 K35 ["Position"]
  GETTABLE R20 R21 R22
  CALL R19 1 1
  JUMPIFNOT R19 [+9]
  GETUPVAL R22 2
  GETTABLEKS R21 R22 K34 ["PROPERTY_KEYS"]
  GETTABLEKS R20 R21 K35 ["Position"]
  SETTABLEKS R20 R19 K9 ["Name"]
  SETTABLEKS R18 R19 K36 ["Parent"]
  GETGLOBAL R20 K37 ["makeRotationCurve"]
  GETTABLEKS R22 R17 K33 ["Components"]
  GETUPVAL R25 2
  GETTABLEKS R24 R25 K34 ["PROPERTY_KEYS"]
  GETTABLEKS R23 R24 K38 ["Rotation"]
  GETTABLE R21 R22 R23
  CALL R20 1 1
  JUMPIFNOT R20 [+28]
  GETUPVAL R23 2
  GETTABLEKS R22 R23 K34 ["PROPERTY_KEYS"]
  GETTABLEKS R21 R22 K38 ["Rotation"]
  SETTABLEKS R21 R20 K9 ["Name"]
  SETTABLEKS R18 R20 K36 ["Parent"]
  JUMP [+18]
  GETTABLEKS R19 R17 K21 ["Type"]
  GETUPVAL R22 2
  GETTABLEKS R21 R22 K28 ["TRACK_TYPES"]
  GETTABLEKS R20 R21 K39 ["Facs"]
  JUMPIFNOTEQ R19 R20 [+10]
  GETGLOBAL R19 K40 ["makeFacsCurve"]
  MOVE R20 R17
  CALL R19 1 1
  JUMPIFNOT R19 [+4]
  SETTABLEKS R16 R19 K9 ["Name"]
  SETTABLEKS R18 R19 K36 ["Parent"]
  GETUPVAL R20 5
  GETTABLEKS R19 R20 K41 ["countKeyframes"]
  MOVE R20 R17
  CALL R19 1 1
  ADD R7 R7 R19
  ADDK R8 R8 K42 [1]
  FORGLOOP R13 2 [-96]
  NEWTABLE R13 0 0
  GETTABLEKS R14 R0 K43 ["Events"]
  GETIMPORT R15 K27 [pairs]
  GETTABLEKS R16 R14 K44 ["Data"]
  CALL R15 1 3
  FORGPREP_NEXT R15
  GETIMPORT R20 K27 [pairs]
  MOVE R21 R19
  CALL R20 1 3
  FORGPREP_NEXT R20
  GETTABLE R25 R13 R23
  JUMPIF R25 [+3]
  NEWTABLE R25 0 0
  SETTABLE R25 R13 R23
  GETTABLE R25 R13 R23
  SETTABLE R24 R25 R18
  FORGLOOP R20 2 [-8]
  FORGLOOP R15 2 [-15]
  GETUPVAL R15 6
  JUMPIFNOT R15 [+18]
  GETTABLEKS R15 R14 K45 ["NamedKeyframes"]
  JUMPIFNOT R15 [+15]
  NEWTABLE R15 0 0
  GETIMPORT R16 K27 [pairs]
  GETTABLEKS R17 R14 K45 ["NamedKeyframes"]
  CALL R16 1 3
  FORGPREP_NEXT R16
  SETTABLE R20 R15 R19
  FORGLOOP R16 2 [-2]
  GETUPVAL R17 2
  GETTABLEKS R16 R17 K46 ["NAMED_KEYFRAMES_CHANNEL"]
  SETTABLE R15 R13 R16
  GETIMPORT R15 K27 [pairs]
  MOVE R16 R13
  CALL R15 1 3
  FORGPREP_NEXT R15
  GETIMPORT R20 K7 [Instance.new]
  LOADK R21 K47 ["MarkerCurve"]
  CALL R20 1 1
  SETTABLEKS R18 R20 K9 ["Name"]
  SETTABLEKS R3 R20 K36 ["Parent"]
  GETIMPORT R21 K27 [pairs]
  MOVE R22 R19
  CALL R21 1 3
  FORGPREP_NEXT R21
  GETUPVAL R28 2
  GETTABLEKS R27 R28 K48 ["TICK_FREQUENCY"]
  DIV R26 R24 R27
  MOVE R29 R26
  MOVE R30 R25
  NAMECALL R27 R20 K49 ["InsertMarkerAtTime"]
  CALL R27 3 0
  ADDK R9 R9 K42 [1]
  FORGLOOP R21 2 [-11]
  FORGLOOP R15 2 [-26]
...
MAIN:
  ...
  GETTABLEKS R12 R13 K20 ["GetFFlagGetRigInfo"]
  CALL R11 1 1
  GETIMPORT R12 K22 [game]
  LOADK R14 K23 ["ACENamedKeyframesChannel"]
  LOADB R15 0
  NAMECALL R12 R12 K24 ["DefineFastFlag"]
  CALL R12 3 1
  ...
  CAPTURE VAL R5
  SETGLOBAL R23 K35 ["fillFloatCurve"]
  DUPCLOSURE R23 K36 [PROTO_11]
  CAPTURE VAL R5
  SETGLOBAL R23 K37 ["fillQuaternionCurve"]
  DUPCLOSURE R23 K38 [PROTO_12]
  CAPTURE VAL R5
  SETGLOBAL R23 K39 ["makeVector3Curve"]
  DUPCLOSURE R23 K40 [PROTO_13]
  SETGLOBAL R23 K41 ["makeQuaternionCurve"]
  DUPCLOSURE R23 K42 [PROTO_14]
  CAPTURE VAL R5
  SETGLOBAL R23 K43 ["makeEulerCurve"]
  DUPCLOSURE R23 K44 [PROTO_15]
  CAPTURE VAL R5
  SETGLOBAL R23 K45 ["makeRotationCurve"]
  DUPCLOSURE R23 K46 [PROTO_16]
  SETGLOBAL R23 K47 ["makeFacsCurve"]
  ...
  CAPTURE VAL R4
  CAPTURE VAL R8
  SETGLOBAL R25 K51 ["readCurve"]
  DUPCLOSURE R25 K52 [PROTO_20]
  CAPTURE VAL R4
  CAPTURE VAL R5
  SETGLOBAL R25 K53 ["readFacsCurves"]
  ...
  CAPTURE VAL R16
  CAPTURE VAL R17
  SETTABLEKS R25 R14 K55 ["fromKeyframeSequence"]
  DUPCLOSURE R25 K56 [PROTO_24]
  CAPTURE VAL R11
  CAPTURE VAL R7
  CAPTURE VAL R5
  CAPTURE VAL R19
  CAPTURE VAL R21
  CAPTURE VAL R24
  SETTABLEKS R25 R14 K57 ["toKeyframeSequence"]
  ...
  CAPTURE VAL R6
  CAPTURE VAL R12
  SETTABLEKS R25 R14 K59 ["fromCurveAnimation"]
  ...
  CAPTURE VAL R12
  CAPTURE VAL R24
  SETTABLEKS R25 R14 K61 ["toCurveAnimation"]
  RETURN R14 1
