...
PROTO_24:
  ...
  LOADK R30 K29 ["Keyframe"]
  CALL R29 1 1
  SETTABLEKS R27 R29 K30 ["Time"]
  SETTABLEKS R5 R29 K31 ["Parent"]
  MOVE R28 R29
  SETTABLE R28 R13 R26
  GETTABLEKS R29 R21 K20 ["Type"]
  GETTABLEKS R31 R21 K32 ["Data"]
  ...
  FORGLOOP R22 2 [-35]
  FORGLOOP R17 2 [-43]
  GETIMPORT R17 K35 [ipairs]
  GETTABLEKS R18 R3 K27 ["Keyframes"]
  CALL R17 1 3
  FORGPREP_INEXT R17
  GETTABLEKS R23 R3 K32 ["Data"]
  ...
  LOADK R31 K29 ["Keyframe"]
  CALL R30 1 1
  SETTABLEKS R28 R30 K30 ["Time"]
  SETTABLEKS R5 R30 K31 ["Parent"]
  MOVE R29 R30
  SETTABLE R29 R13 R21
  GETIMPORT R30 K9 [Instance.new]
  LOADK R31 K36 ["KeyframeMarker"]
  MOVE R32 R29
  CALL R30 2 1
  SETTABLEKS R26 R30 K11 ["Name"]
  SETTABLEKS R27 R30 K37 ["Value"]
  ADDK R7 R7 K33 [1]
  FORGLOOP R23 2 [-27]
  ...
  MOVE R20 R5
  CALL R17 3 0
  NAMECALL R17 R5 K38 ["GetKeyframes"]
  CALL R17 1 1
  MOVE R18 R5
  LENGTH R19 R17
  MOVE R20 R6
...
PROTO_27:
  ...
  GETGLOBAL R21 K29 ["makeVector3Curve"]
  ...
  GETGLOBAL R22 K34 ["makeRotationCurve"]
  ...
  JUMPIFNOTEQ R21 R22 [+10]
  GETGLOBAL R21 K37 ["makeFacsCurve"]
  MOVE R22 R19
  CALL R21 1 1
  JUMPIFNOT R21 [+4]
...
MAIN:
  ...
  LOADK R13 K22 ["ACENamedKeyframesChannel"]
  LOADB R14 0
  NAMECALL R11 R11 K23 ["DefineFastFlag"]
  CALL R11 3 1
  ...
  CAPTURE VAL R5
  SETGLOBAL R22 K34 ["fillFloatCurve"]
  DUPCLOSURE R22 K35 [PROTO_11]
  CAPTURE VAL R5
  SETGLOBAL R22 K36 ["fillQuaternionCurve"]
  DUPCLOSURE R22 K37 [PROTO_12]
  CAPTURE VAL R5
  SETGLOBAL R22 K38 ["makeVector3Curve"]
  DUPCLOSURE R22 K39 [PROTO_13]
  SETGLOBAL R22 K40 ["makeQuaternionCurve"]
  DUPCLOSURE R22 K41 [PROTO_14]
  CAPTURE VAL R5
  SETGLOBAL R22 K42 ["makeEulerCurve"]
  DUPCLOSURE R22 K43 [PROTO_15]
  CAPTURE VAL R5
  SETGLOBAL R22 K44 ["makeRotationCurve"]
  DUPCLOSURE R22 K45 [PROTO_16]
  SETGLOBAL R22 K46 ["makeFacsCurve"]
  DUPCLOSURE R22 K47 [PROTO_17]
  ...
  CAPTURE VAL R4
  CAPTURE VAL R8
  SETGLOBAL R24 K50 ["readCurve"]
  DUPCLOSURE R24 K51 [PROTO_20]
  CAPTURE VAL R4
  CAPTURE VAL R5
  SETGLOBAL R24 K52 ["readFacsCurves"]
  DUPCLOSURE R24 K53 [PROTO_23]
  CAPTURE VAL R14
  CAPTURE VAL R4
  CAPTURE VAL R5
  CAPTURE VAL R6
  CAPTURE VAL R15
  CAPTURE VAL R16
  SETTABLEKS R24 R13 K54 ["fromKeyframeSequence"]
  DUPCLOSURE R24 K55 [PROTO_24]
  CAPTURE VAL R7
  CAPTURE VAL R5
  CAPTURE VAL R18
  CAPTURE VAL R20
  CAPTURE VAL R23
  SETTABLEKS R24 R13 K56 ["toKeyframeSequence"]
  DUPCLOSURE R24 K57 [PROTO_26]
  CAPTURE VAL R4
  CAPTURE VAL R5
  CAPTURE VAL R17
  CAPTURE VAL R9
  CAPTURE VAL R6
  CAPTURE VAL R11
  SETTABLEKS R24 R13 K58 ["fromCurveAnimation"]
  DUPCLOSURE R24 K59 [PROTO_27]
  CAPTURE VAL R7
  CAPTURE VAL R5
  CAPTURE VAL R18
  CAPTURE VAL R21
  ...
  CAPTURE VAL R11
  CAPTURE VAL R23
  SETTABLEKS R24 R13 K60 ["toCurveAnimation"]
  RETURN R13 1
