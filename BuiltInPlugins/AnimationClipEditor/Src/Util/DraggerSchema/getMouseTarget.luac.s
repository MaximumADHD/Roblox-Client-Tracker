...
PROTO_3:
  ...
  JUMPIFNOT R10 [+10]
  GETUPVAL R11 3
  GETTABLEKS R10 R11 K25 ["getBoneHit"]
  MOVE R11 R1
  ...
  JUMPIFNOT R14 [+11]
  GETUPVAL R15 0
  GETTABLEKS R14 R15 K26 ["getRigInfo"]
  GETTABLEKS R15 R0 K0 ["RootInstance"]
  CALL R14 1 1
  GETTABLEKS R11 R14 K27 ["PartNameToMotor"]
  GETTABLEKS R13 R14 K28 ["BoneNameToBone"]
  JUMP [+11]
  LOADNIL R14
  GETUPVAL R16 0
  GETTABLEKS R15 R16 K26 ["getRigInfo"]
  GETTABLEKS R16 R0 K0 ["RootInstance"]
  CALL R15 1 4
  MOVE R14 R15
  MOVE R11 R16
  MOVE R14 R17
  MOVE R13 R18
  GETUPVAL R15 5
  GETTABLEKS R14 R15 K29 ["getOrCreateMicroboneFolder"]
  CALL R14 0 1
  GETUPVAL R15 6
  MOVE R16 R1
  MOVE R17 R14
  ...
  MOVE R13 R9
  MOVE R16 R12
  NAMECALL R14 R8 K30 ["IsDescendantOf"]
  CALL R14 2 1
  MOVE R11 R14
  JUMPIFNOT R11 [+13]
  LOADK R16 K31 ["BasePart"]
  NAMECALL R14 R8 K32 ["IsA"]
  CALL R14 2 1
  MOVE R11 R14
  JUMPIFNOT R11 [+7]
  GETTABLEKS R15 R8 K33 ["Name"]
...
MAIN:
  ...
  GETTABLEKS R11 R1 K20 ["LuaFlags"]
  GETTABLEKS R10 R11 K22 ["GetFFlagRigVisualization"]
  CALL R9 1 1
