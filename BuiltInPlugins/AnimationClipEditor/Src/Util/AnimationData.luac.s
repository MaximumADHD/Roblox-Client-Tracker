...
MAIN:
  ...
  CAPTURE VAL R14
  CAPTURE VAL R6
  SETTABLEKS R15 R14 K24 ["newRigAnimation"]
  DUPCLOSURE R15 K25 [PROTO_2]
  CAPTURE VAL R6
  CAPTURE VAL R10
  SETTABLEKS R15 R14 K26 ["toCFrameArray"]
  DUPCLOSURE R15 K27 [PROTO_3]
  CAPTURE VAL R14
  CAPTURE VAL R12
  CAPTURE VAL R6
  SETTABLEKS R15 R14 K28 ["fromCFrameArray"]
  DUPCLOSURE R15 K29 [PROTO_4]
  CAPTURE VAL R10
  SETTABLEKS R15 R14 K30 ["addEvent"]
  DUPCLOSURE R15 K31 [PROTO_5]
  CAPTURE VAL R10
  CAPTURE VAL R7
  SETTABLEKS R15 R14 K32 ["moveEvents"]
  DUPCLOSURE R15 K33 [PROTO_6]
  CAPTURE VAL R10
  SETTABLEKS R15 R14 K34 ["deleteEvents"]
  DUPCLOSURE R15 K35 [PROTO_7]
  SETTABLEKS R15 R14 K36 ["setEventValue"]
  DUPCLOSURE R15 K37 [PROTO_8]
  CAPTURE VAL R9
  CAPTURE VAL R10
  SETTABLEKS R15 R14 K38 ["removeEvent"]
  DUPCLOSURE R15 K39 [PROTO_9]
  CAPTURE VAL R12
  CAPTURE VAL R13
  SETTABLEKS R15 R14 K40 ["addTrack"]
  DUPCLOSURE R15 K41 [PROTO_10]
  CAPTURE VAL R10
  CAPTURE VAL R1
  CAPTURE VAL R12
  SETTABLEKS R15 R14 K42 ["addKeyframe"]
  DUPCLOSURE R15 K43 [PROTO_11]
  CAPTURE VAL R10
  CAPTURE VAL R14
  SETTABLEKS R15 R14 K44 ["addDefaultKeyframe"]
  DUPCLOSURE R15 K45 [PROTO_12]
  CAPTURE VAL R13
  CAPTURE VAL R14
  SETTABLEKS R15 R14 K46 ["moveNamedKeyframe"]
  DUPCLOSURE R15 K47 [PROTO_13]
  CAPTURE VAL R10
  CAPTURE VAL R7
  SETTABLEKS R15 R14 K48 ["moveKeyframe"]
  DUPCLOSURE R15 K49 [PROTO_14]
  CAPTURE VAL R10
  SETTABLEKS R15 R14 K50 ["deleteKeyframe"]
  DUPCLOSURE R15 K51 [PROTO_15]
  CAPTURE VAL R1
  SETTABLEKS R15 R14 K52 ["setKeyframeData"]
  DUPCLOSURE R15 K53 [PROTO_16]
  CAPTURE VAL R6
  SETTABLEKS R15 R14 K54 ["setKeyframeName"]
  DUPCLOSURE R15 K55 [PROTO_17]
  CAPTURE VAL R9
  CAPTURE VAL R13
  CAPTURE VAL R14
  SETTABLEKS R15 R14 K56 ["validateKeyframeNames"]
  DUPCLOSURE R15 K57 [PROTO_19]
  CAPTURE VAL R13
  CAPTURE VAL R9
  SETTABLEKS R15 R14 K58 ["setEndTick"]
  DUPCLOSURE R15 K59 [PROTO_20]
  CAPTURE VAL R6
  SETTABLEKS R15 R14 K60 ["getMaximumLength"]
  DUPCLOSURE R15 K61 [PROTO_21]
  SETTABLEKS R15 R14 K62 ["setLooping"]
  DUPCLOSURE R15 K63 [PROTO_22]
  SETTABLEKS R15 R14 K64 ["isQuantized"]
  DUPCLOSURE R15 K65 [PROTO_24]
  CAPTURE VAL R6
  CAPTURE VAL R13
  SETTABLEKS R15 R14 K66 ["removeExtraKeyframes"]
  DUPCLOSURE R15 K67 [PROTO_26]
  CAPTURE VAL R9
  CAPTURE VAL R6
  SETTABLEKS R15 R14 K68 ["getSelectionBounds"]
  DUPCLOSURE R15 K69 [PROTO_27]
  CAPTURE VAL R6
  CAPTURE VAL R1
  SETTABLEKS R15 R14 K70 ["getEventBounds"]
  DUPCLOSURE R15 K71 [PROTO_28]
  CAPTURE VAL R13
  CAPTURE VAL R6
  CAPTURE VAL R14
  SETTABLEKS R15 R14 K72 ["promoteToChannels"]
  DUPCLOSURE R15 K73 [PROTO_29]
  SETTABLEKS R15 R14 K74 ["isChannelAnimation"]
  DUPCLOSURE R15 K75 [PROTO_30]
  CAPTURE VAL R9
  SETTABLEKS R15 R14 K76 ["getTrack"]
  DUPCLOSURE R15 K77 [PROTO_31]
  CAPTURE VAL R6
  SETTABLEKS R15 R14 K78 ["hasFacsData"]
  DUPCLOSURE R15 K79 [PROTO_32]
  CAPTURE VAL R6
  CAPTURE VAL R8
  CAPTURE VAL R3
  CAPTURE VAL R10
  ...
  CAPTURE VAL R6
  CAPTURE VAL R9
  SETTABLEKS R16 R14 K81 ["clearTrackSequences"]
  RETURN R14 1
