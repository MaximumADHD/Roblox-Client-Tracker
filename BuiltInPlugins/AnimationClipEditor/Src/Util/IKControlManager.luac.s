...
MAIN:
  ...
  DUPTABLE R6 K46 [{"Root", "Waist", "Neck", "LeftWrist", "LeftAnkle", "RightWrist", "RightAnkle", "RightShoulder", "RightElbow", "LeftShoulder", "LeftElbow", "LeftKnee", "LeftHip", "RightKnee", "RightHip"}]
  GETIMPORT R7 K49 [CFrame.identity]
  SETTABLEKS R7 R6 K31 ["Root"]
  GETIMPORT R7 K49 [CFrame.identity]
  SETTABLEKS R7 R6 K32 ["Waist"]
  GETIMPORT R7 K49 [CFrame.identity]
  SETTABLEKS R7 R6 K33 ["Neck"]
  GETIMPORT R7 K49 [CFrame.identity]
  SETTABLEKS R7 R6 K34 ["LeftWrist"]
  GETIMPORT R7 K49 [CFrame.identity]
  SETTABLEKS R7 R6 K35 ["LeftAnkle"]
  GETIMPORT R7 K49 [CFrame.identity]
  SETTABLEKS R7 R6 K36 ["RightWrist"]
  GETIMPORT R7 K49 [CFrame.identity]
  SETTABLEKS R7 R6 K37 ["RightAnkle"]
  GETIMPORT R7 K51 [CFrame.fromOrientation]
  LOADK R8 K52 [0.408]
  LOADK R9 K53 [0.326]
  LOADK R10 K54 [0.48]
  CALL R7 3 1
  SETTABLEKS R7 R6 K38 ["RightShoulder"]
  GETIMPORT R7 K51 [CFrame.fromOrientation]
  LOADK R8 K55 [1.165]
  LOADK R9 K56 [-0.111]
  LOADK R10 K57 [-0.342]
  ...
  LOADK R10 K59 [-0.48]
  CALL R7 3 1
  SETTABLEKS R7 R6 K40 ["LeftShoulder"]
  GETIMPORT R7 K51 [CFrame.fromOrientation]
  LOADK R8 K55 [1.165]
  LOADK R9 K60 [0.111]
  LOADK R10 K61 [0.342]
  CALL R7 3 1
  SETTABLEKS R7 R6 K41 ["LeftElbow"]
  GETIMPORT R7 K51 [CFrame.fromOrientation]
  LOADK R8 K62 [-1.398]
  LOADK R9 K63 [-0.098]
  LOADK R10 K64 [0.119]
  CALL R7 3 1
  SETTABLEKS R7 R6 K42 ["LeftKnee"]
  GETIMPORT R7 K51 [CFrame.fromOrientation]
  LOADK R8 K65 [0.561]
  LOADK R9 K66 [-0.018]
  LOADK R10 K67 [0.031]
  CALL R7 3 1
  SETTABLEKS R7 R6 K43 ["LeftHip"]
  GETIMPORT R7 K51 [CFrame.fromOrientation]
  LOADK R8 K68 [-1.399]
  LOADK R9 K69 [0.055]
  LOADK R10 K70 [-0.066]
  CALL R7 3 1
  SETTABLEKS R7 R6 K44 ["RightKnee"]
  GETIMPORT R7 K51 [CFrame.fromOrientation]
  LOADK R8 K65 [0.561]
  LOADK R9 K71 [0.018]
  LOADK R10 K72 [-0.031]
  ...
  DUPCLOSURE R7 K73 [PROTO_0]
  CAPTURE VAL R2
  CAPTURE VAL R3
  CAPTURE VAL R0
  SETTABLEKS R7 R0 K74 ["new"]
  DUPCLOSURE R7 K75 [PROTO_1]
  SETTABLEKS R7 R0 K76 ["cleanUp"]
  DUPCLOSURE R7 K77 [PROTO_2]
  CAPTURE VAL R6
  DUPCLOSURE R8 K78 [PROTO_3]
  SETTABLEKS R8 R0 K79 ["getOrCreateIKControl"]
  DUPCLOSURE R8 K80 [PROTO_4]
  DUPCLOSURE R9 K81 [PROTO_5]
  CAPTURE VAL R2
  SETTABLEKS R9 R0 K82 ["getJoint"]
  DUPCLOSURE R9 K83 [PROTO_6]
  CAPTURE VAL R5
  SETTABLEKS R9 R0 K84 ["setupIKControl"]
  DUPCLOSURE R9 K85 [PROTO_7]
  CAPTURE VAL R7
  CAPTURE VAL R4
  SETTABLEKS R9 R0 K86 ["solve"]
  DUPCLOSURE R9 K87 [PROTO_8]
  DUPCLOSURE R10 K88 [PROTO_9]
  CAPTURE VAL R9
  SETTABLEKS R10 R0 K89 ["getTransforms"]
  DUPCLOSURE R10 K90 [PROTO_10]
  SETTABLEKS R10 R0 K91 ["getSelectedPart"]
  DUPCLOSURE R10 K92 [PROTO_11]
  SETTABLEKS R10 R0 K93 ["getModel"]
  RETURN R0 1
