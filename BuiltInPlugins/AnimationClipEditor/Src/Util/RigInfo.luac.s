...
MAIN:
  ...
  GETTABLEKS R8 R0 K10 ["LuaFlags"]
  GETTABLEKS R7 R8 K14 ["GetFFlagRigInfoCache"]
  CALL R6 1 1
  GETIMPORT R7 K16 [game]
  LOADK R9 K17 ["ACEIgnoreAnimSavesObjectValue"]
  LOADB R10 0
  NAMECALL R7 R7 K18 ["DefineFastFlag"]
  CALL R7 3 1
  DUPTABLE R8 K21 [{"Cache", "FaceControlsCache"}]
  DUPTABLE R9 K24 [{"CacheRig", "CacheData"}]
  LOADNIL R10
  SETTABLEKS R10 R9 K22 ["CacheRig"]
  LOADNIL R10
  SETTABLEKS R10 R9 K23 ["CacheData"]
  SETTABLEKS R9 R8 K19 ["Cache"]
  DUPTABLE R9 K24 [{"CacheRig", "CacheData"}]
  LOADNIL R10
  SETTABLEKS R10 R9 K22 ["CacheRig"]
  LOADNIL R10
  SETTABLEKS R10 R9 K23 ["CacheData"]
  SETTABLEKS R9 R8 K20 ["FaceControlsCache"]
  DUPCLOSURE R9 K25 [PROTO_0]
  CAPTURE VAL R7
  CAPTURE VAL R9
  DUPCLOSURE R10 K26 [PROTO_1]
  CAPTURE VAL R2
  SETTABLEKS R10 R8 K27 ["getTemporaryConstraints"]
  DUPCLOSURE R10 K28 [PROTO_2]
  CAPTURE VAL R8
  SETTABLEKS R10 R8 K29 ["usingTemporaryConstraints"]
  DUPCLOSURE R10 K30 [PROTO_3]
  CAPTURE VAL R8
  CAPTURE VAL R9
  SETTABLEKS R10 R8 K31 ["getConstraints"]
  DUPCLOSURE R10 K32 [PROTO_5]
  CAPTURE VAL R8
  CAPTURE VAL R3
  CAPTURE VAL R1
  SETTABLEKS R10 R8 K33 ["buildRigHierarchy"]
  DUPCLOSURE R10 K34 [PROTO_6]
  CAPTURE VAL R5
  CAPTURE VAL R8
  CAPTURE VAL R3
  CAPTURE VAL R9
  SETTABLEKS R10 R8 K35 ["findRootPart"]
  DUPCLOSURE R10 K36 [PROTO_7]
  SETTABLEKS R10 R8 K37 ["getAnimationController"]
  DUPCLOSURE R10 K38 [PROTO_8]
  CAPTURE VAL R8
  SETTABLEKS R10 R8 K39 ["getAnimator"]
  DUPCLOSURE R10 K40 [PROTO_9]
  SETTABLEKS R10 R8 K41 ["getPart0"]
  DUPCLOSURE R10 K42 [PROTO_10]
  SETTABLEKS R10 R8 K43 ["getPart1"]
  DUPCLOSURE R10 K44 [PROTO_11]
  CAPTURE VAL R9
  SETTABLEKS R10 R8 K45 ["getMotors"]
  DUPCLOSURE R10 K46 [PROTO_12]
  CAPTURE VAL R9
  CAPTURE VAL R2
  SETTABLEKS R10 R8 K47 ["getBones"]
  DUPCLOSURE R10 K48 [PROTO_13]
  CAPTURE VAL R9
  SETTABLEKS R10 R8 K49 ["getAnimationConstraints"]
  DUPCLOSURE R10 K50 [PROTO_15]
  CAPTURE VAL R8
  CAPTURE VAL R5
  CAPTURE VAL R3
  CAPTURE VAL R2
  SETTABLEKS R10 R8 K51 ["getUnusedRigTracks"]
  DUPCLOSURE R10 K52 [PROTO_16]
  CAPTURE VAL R8
  SETTABLEKS R10 R8 K53 ["clearCache"]
  ...
  CAPTURE VAL R2
  CAPTURE VAL R5
  SETTABLEKS R10 R8 K55 ["getRigInfo"]
  DUPCLOSURE R10 K56 [PROTO_18]
  CAPTURE VAL R6
  CAPTURE VAL R8
  CAPTURE VAL R9
  CAPTURE VAL R4
  SETTABLEKS R10 R8 K57 ["getFaceControls"]
  DUPCLOSURE R10 K58 [PROTO_19]
  CAPTURE VAL R5
  CAPTURE VAL R8
  CAPTURE VAL R3
  SETTABLEKS R10 R8 K59 ["getPartByName"]
  DUPCLOSURE R10 K60 [PROTO_20]
  CAPTURE VAL R5
  CAPTURE VAL R8
  SETTABLEKS R10 R8 K61 ["getBoneByName"]
  RETURN R8 1
