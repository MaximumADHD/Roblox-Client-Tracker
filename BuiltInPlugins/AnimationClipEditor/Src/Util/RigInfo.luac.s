...
PROTO_16:
  ...
  CALL R10 0 1
  JUMPIFNOT R10 [+12]
  DUPTABLE R10 K19 [{"Parts", "PartNameToMotor", "PartNameToConstraint", "PartNameToAnimConstraint", "BoneNameToBone"}]
  SETTABLEKS R1 R10 K14 ["Parts"]
  SETTABLEKS R5 R10 K15 ["PartNameToMotor"]
  SETTABLEKS R6 R10 K16 ["PartNameToConstraint"]
  SETTABLEKS R7 R10 K17 ["PartNameToAnimConstraint"]
  SETTABLEKS R8 R10 K18 ["BoneNameToBone"]
  RETURN R10 1
  MOVE R10 R1
  MOVE R11 R5
  MOVE R12 R6
...
MAIN:
  ...
  GETTABLEKS R5 R6 K12 ["GetFFlagFaceControlsValidation"]
  CALL R4 1 1
  GETIMPORT R5 K5 [require]
  GETTABLEKS R7 R0 K10 ["LuaFlags"]
  GETTABLEKS R6 R7 K13 ["GetFFlagGetRigInfo"]
  CALL R5 1 1
  NEWTABLE R6 32 0
  ...
  CAPTURE VAL R2
  SETTABLEKS R8 R6 K16 ["getTemporaryConstraints"]
  DUPCLOSURE R8 K17 [PROTO_2]
  CAPTURE VAL R6
  SETTABLEKS R8 R6 K18 ["usingTemporaryConstraints"]
  DUPCLOSURE R8 K19 [PROTO_3]
  CAPTURE VAL R6
  CAPTURE VAL R7
  SETTABLEKS R8 R6 K20 ["getConstraints"]
  DUPCLOSURE R8 K21 [PROTO_5]
  CAPTURE VAL R6
  CAPTURE VAL R3
  CAPTURE VAL R1
  SETTABLEKS R8 R6 K22 ["buildRigHierarchy"]
  DUPCLOSURE R8 K23 [PROTO_6]
  CAPTURE VAL R5
  CAPTURE VAL R6
  CAPTURE VAL R3
  CAPTURE VAL R7
  SETTABLEKS R8 R6 K24 ["findRootPart"]
  DUPCLOSURE R8 K25 [PROTO_7]
  SETTABLEKS R8 R6 K26 ["getAnimationController"]
  DUPCLOSURE R8 K27 [PROTO_8]
  CAPTURE VAL R6
  SETTABLEKS R8 R6 K28 ["getAnimator"]
  DUPCLOSURE R8 K29 [PROTO_9]
  SETTABLEKS R8 R6 K30 ["getPart0"]
  DUPCLOSURE R8 K31 [PROTO_10]
  SETTABLEKS R8 R6 K32 ["getPart1"]
  DUPCLOSURE R8 K33 [PROTO_11]
  CAPTURE VAL R7
  SETTABLEKS R8 R6 K34 ["getMotors"]
  DUPCLOSURE R8 K35 [PROTO_12]
  CAPTURE VAL R7
  CAPTURE VAL R2
  SETTABLEKS R8 R6 K36 ["getBones"]
  DUPCLOSURE R8 K37 [PROTO_13]
  CAPTURE VAL R7
  SETTABLEKS R8 R6 K38 ["getAnimationConstraints"]
  DUPCLOSURE R8 K39 [PROTO_15]
  CAPTURE VAL R6
  CAPTURE VAL R5
  CAPTURE VAL R3
  CAPTURE VAL R2
  SETTABLEKS R8 R6 K40 ["getUnusedRigTracks"]
  DUPCLOSURE R8 K41 [PROTO_16]
  CAPTURE VAL R6
  CAPTURE VAL R3
  CAPTURE VAL R7
  CAPTURE VAL R2
  CAPTURE VAL R5
  SETTABLEKS R8 R6 K42 ["getRigInfo"]
  DUPCLOSURE R8 K43 [PROTO_17]
  CAPTURE VAL R7
  CAPTURE VAL R4
  SETTABLEKS R8 R6 K44 ["getFaceControls"]
  DUPCLOSURE R8 K45 [PROTO_18]
  CAPTURE VAL R5
  CAPTURE VAL R6
  CAPTURE VAL R3
  SETTABLEKS R8 R6 K46 ["getPartByName"]
  DUPCLOSURE R8 K47 [PROTO_19]
  CAPTURE VAL R5
  CAPTURE VAL R6
  SETTABLEKS R8 R6 K48 ["getBoneByName"]
  RETURN R6 1
