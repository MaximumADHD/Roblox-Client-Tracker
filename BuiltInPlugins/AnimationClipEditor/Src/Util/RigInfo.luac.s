...
MAIN:
  ...
  GETTABLEKS R6 R7 K13 ["GetFFlagForceR6HumanoidRootPart"]
  CALL R5 1 1
  ...
  SETTABLEKS R10 R8 K35 ["isR15Humanoid"]
  DUPCLOSURE R10 K36 [PROTO_7]
  SETTABLEKS R10 R8 K37 ["isR6Humanoid"]
  ...
  CAPTURE VAL R3
  CAPTURE VAL R9
  SETTABLEKS R10 R8 K39 ["findRootPart"]
  DUPCLOSURE R10 K40 [PROTO_9]
  SETTABLEKS R10 R8 K41 ["getAnimationController"]
  DUPCLOSURE R10 K42 [PROTO_10]
  CAPTURE VAL R8
  SETTABLEKS R10 R8 K43 ["getAnimator"]
  DUPCLOSURE R10 K44 [PROTO_11]
  SETTABLEKS R10 R8 K45 ["getPart0"]
  DUPCLOSURE R10 K46 [PROTO_12]
  SETTABLEKS R10 R8 K47 ["getPart1"]
  DUPCLOSURE R10 K48 [PROTO_13]
  CAPTURE VAL R9
  SETTABLEKS R10 R8 K49 ["getMotors"]
  DUPCLOSURE R10 K50 [PROTO_14]
  CAPTURE VAL R9
  SETTABLEKS R10 R8 K51 ["getBones"]
  DUPCLOSURE R10 K52 [PROTO_15]
  CAPTURE VAL R9
  SETTABLEKS R10 R8 K53 ["getAnimationConstraints"]
  DUPCLOSURE R10 K54 [PROTO_17]
  CAPTURE VAL R8
  CAPTURE VAL R3
  CAPTURE VAL R2
  SETTABLEKS R10 R8 K55 ["getUnusedRigTracks"]
  DUPCLOSURE R10 K56 [PROTO_18]
  CAPTURE VAL R8
  SETTABLEKS R10 R8 K57 ["clearCache"]
  DUPCLOSURE R10 K58 [PROTO_19]
  CAPTURE VAL R4
  CAPTURE VAL R8
  CAPTURE VAL R3
  CAPTURE VAL R9
  SETTABLEKS R10 R8 K59 ["getRigInfo"]
  DUPCLOSURE R10 K60 [PROTO_20]
  CAPTURE VAL R4
  CAPTURE VAL R8
  CAPTURE VAL R9
  SETTABLEKS R10 R8 K61 ["getFaceControls"]
  DUPCLOSURE R10 K62 [PROTO_21]
  CAPTURE VAL R8
  CAPTURE VAL R3
  SETTABLEKS R10 R8 K63 ["getPartByName"]
  DUPCLOSURE R10 K64 [PROTO_22]
  CAPTURE VAL R8
  SETTABLEKS R10 R8 K65 ["getBoneByName"]
  RETURN R8 1
