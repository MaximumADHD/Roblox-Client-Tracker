...
PROTO_6:
  ...
  JUMPIFNOT R4 [+12]
  GETUPVAL R5 2
  GETTABLEKS R4 R5 K3 ["getRigInfo"]
  MOVE R5 R0
  CALL R4 1 1
  GETTABLEKS R1 R4 K4 ["PartNameToMotor"]
  GETTABLEKS R3 R4 K5 ["PartNameToAnimConstraint"]
  GETTABLEKS R2 R4 K6 ["BoneNameToBone"]
  JUMP [+11]
  LOADNIL R4
  GETUPVAL R6 2
  ...
  MOVE R8 R0
  CALL R6 2 1
  GETIMPORT R7 K14 [ipairs]
  MOVE R8 R6
  CALL R7 1 3
  FORGPREP_INEXT R7
  GETTABLEKS R12 R11 K10 ["Name"]
  JUMPIFNOTEQ R12 R4 [+7]
...
MAIN:
  ...
  LOADK R9 K18 ["ACEPrimaryPartPriority"]
  LOADB R10 0
