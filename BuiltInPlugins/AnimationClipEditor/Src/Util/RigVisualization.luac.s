PROTO_0:
        0 GETTABLEKS                       R1 R0 K0 ["TransformedWorldCFrame"]
...
PROTO_1:
        ...
        7 CALL                             R3 2 1
        8 JUMPIFNOT                        R3 ; [+11]
        9 GETTABLEKS                       R4 R2 K3 ["TransformedWorldCFrame"]
       11 GETTABLEKS                       R4 R4 K4 ["Position"]
       13 GETTABLEKS                       R5 R0 K3 ["TransformedWorldCFrame"]
       15 GETTABLEKS                       R5 R5 K4 ["Position"]
       17 SUB                              R3 R4 R5
...
PROTO_2:
       ...
       14 GETUPVAL                         R5 0
       15 GETTABLEKS                       R5 R5 K1 ["fuzzyEq"]
       17 MOVE                             R9 R4
...
PROTO_3:
       ...
       81 MOVE                             R8 R2
       82 GETUPVAL                         R9 3
       83 GETTABLEKS                       R9 R9 K19 ["BONE_LINK_TRANSPARENCY"]
       85 GETUPVAL                         R10 3
       86 GETTABLEKS                       R10 R10 K20 ["BONE_CONE_COLOR"]
       88 LOADN                            R11 0
      ...
      106 LOADN                            R10 1
      107 GETUPVAL                         R11 3
      108 GETTABLEKS                       R11 R11 K23 ["BONE_LINK_COLOR"]
      110 LOADN                            R12 0
      111 LOADN                            R13 0
      ...
      133 JUMPIFNOT                        R7 ; [+4]
      134 GETUPVAL                         R6 3
      135 GETTABLEKS                       R6 R6 K24 ["BONE_TRANSPARENCY_DEFAULT"]
      137 JUMP                             ; [+1]
      138 LOADN                            R6 1
      139 SETTABLEKS                       R6 R4 K6 ["Transparency"]
      141 GETUPVAL                         R8 3
      142 GETTABLEKS                       R8 R8 K25 ["LENGTH_TO_RADIUS_RATIO"]
      144 DIV                              R7 R1 R8
...
PROTO_4:
        0 LOADB                            R3 0
        1 GETTABLEKS                       R4 R0 K0 ["TransformedWorldCFrame"]
        3 GETTABLEKS                       R4 R4 K1 ["Position"]
        5 NEWCLOSURE                       R5 P0
        6 CAPTURE                          VAL R1
        7 CAPTURE                          VAL R0
        8 CAPTURE                          UPVAL U0
       ...
       21 CALL                             R11 2 1
       22 JUMPIFNOT                        R11 ; [+24]
       23 GETTABLEKS                       R11 R10 K0 ["TransformedWorldCFrame"]
       25 GETTABLEKS                       R11 R11 K1 ["Position"]
       27 SUB                              R12 R11 R4
       28 GETTABLEKS                       R12 R12 K7 ["Magnitude"]
       ...
       61 CALL                             R9 2 1
       62 JUMPIFNOT                        R9 ; [+12]
       63 GETTABLEKS                       R9 R6 K0 ["TransformedWorldCFrame"]
       65 GETTABLEKS                       R9 R9 K1 ["Position"]
       67 SUB                              R10 R9 R4
       68 GETTABLEKS                       R10 R10 K7 ["Magnitude"]
       70 GETUPVAL                         R11 1
       71 GETTABLEKS                       R11 R11 K13 ["LEAF_BONE_LENGTH_RATIO"]
       73 MUL                              R7 R10 R11
       74 JUMP                             ; [+1]
       75 LOADN                            R7 1
       76 MOVE                             R9 R5
...
PROTO_5:
        0 GETTABLEKS                       R3 R0 K0 ["TransformedWorldCFrame"]
       ...
       34 MOVE                             R10 R6
       35 GETUPVAL                         R11 1
       36 GETTABLEKS                       R11 R11 K14 ["BONE_NODE_TRANSPARENCY"]
       38 GETUPVAL                         R12 1
       39 GETTABLEKS                       R12 R12 K15 ["BONE_NODE_COLOR"]
       41 LOADN                            R13 0
      ...
      103 GETTABLEKS                       R13 R11 K0 ["TransformedWorldCFrame"]
      105 GETTABLEKS                       R13 R13 K1 ["Position"]
      107 GETTABLEKS                       R14 R0 K0 ["TransformedWorldCFrame"]
      109 GETTABLEKS                       R14 R14 K1 ["Position"]
      111 SUB                              R12 R13 R14
      112 GETTABLEKS                       R10 R12 K23 ["Magnitude"]
      114 MOVE                             R9 R10
      115 GETUPVAL                         R10 1
      116 GETTABLEKS                       R10 R10 K24 ["LENGTH_TO_RADIUS_RATIO"]
      118 DIV                              R8 R9 R10
      119 SETTABLEKS                       R8 R7 K25 ["Radius"]
      121 JUMPIFNOT                        R2 ; [+4]
      122 GETUPVAL                         R8 1
      123 GETTABLEKS                       R8 R8 K26 ["BONE_TRANSPARENCY_DEFAULT"]
      125 JUMP                             ; [+1]
      126 LOADN                            R8 1
...
PROTO_6:
        ...
        4 GETUPVAL                         R2 0
        5 GETTABLEKS                       R2 R2 K3 ["FOLDERS"]
        7 GETTABLEKS                       R2 R2 K4 ["Microbones"]
...
PROTO_7:
       ...
       16 CALL                             R1 1 1
       17 GETUPVAL                         R2 0
       18 GETTABLEKS                       R2 R2 K3 ["FOLDERS"]
       20 GETTABLEKS                       R2 R2 K4 ["Microbones"]
       22 SETTABLEKS                       R2 R1 K10 ["Name"]
       24 LOADB                            R2 0
       25 SETTABLEKS                       R2 R1 K11 ["Archivable"]
       27 GETIMPORT                        R2 K1 [game]
       29 GETTABLEKS                       R2 R2 K2 ["Workspace"]
...
PROTO_8:
       ...
       19 GETTABLEKS                       R5 R5 K7 ["Position"]
       21 GETTABLEKS                       R6 R0 K6 ["CFrame"]
       23 GETTABLEKS                       R6 R6 K8 ["LookVector"]
       25 GETTABLEKS                       R7 R1 K9 ["Origin"]
       27 GETTABLEKS                       R8 R1 K10 ["Direction"]
       29 GETTABLEKS                       R8 R8 K11 ["Unit"]
       31 CALL                             R4 4 2
       32 JUMPIF                           R4 ; [+2]
       33 LOADNIL                          R6
       34 RETURN                           R6 1
...
PROTO_9:
        ...
        4 GETTABLEKS                       R3 R3 K3 ["Workspace"]
        6 GETUPVAL                         R5 0
        7 GETTABLEKS                       R5 R5 K4 ["FOLDERS"]
        9 GETTABLEKS                       R5 R5 K5 ["Microbones"]
       ...
       39 GETUPVAL                         R13 0
       40 GETTABLEKS                       R13 R13 K15 ["BONE_COLOR_SELECTED"]
       42 JUMPIFEQ                         R12 R13 ; [+11]
       44 GETUPVAL                         R12 0
       45 GETTABLEKS                       R12 R12 K16 ["BONE_COLOR_DEFAULT"]
       47 SETTABLEKS                       R12 R10 K14 ["Color3"]
       49 GETUPVAL                         R12 0
       50 GETTABLEKS                       R12 R12 K17 ["BONE_TRANSPARENCY_DEFAULT"]
       ...
       62 GETUPVAL                         R13 0
       63 GETTABLEKS                       R13 R13 K15 ["BONE_COLOR_SELECTED"]
       65 JUMPIFEQ                         R12 R13 ; [+11]
       67 GETUPVAL                         R12 0
       68 GETTABLEKS                       R12 R12 K16 ["BONE_COLOR_DEFAULT"]
       70 SETTABLEKS                       R12 R11 K14 ["Color3"]
       72 GETUPVAL                         R12 0
       73 GETTABLEKS                       R12 R12 K17 ["BONE_TRANSPARENCY_DEFAULT"]
...
PROTO_11:
        ...
        8 RETURN                           R0 0
        9 GETIMPORT                        R3 K4 [game]
       11 GETTABLEKS                       R3 R3 K5 ["Workspace"]
       13 GETUPVAL                         R5 0
       14 GETTABLEKS                       R5 R5 K6 ["FOLDERS"]
       16 GETTABLEKS                       R5 R5 K7 ["Microbones"]
       ...
       25 CALL                             R4 1 1
       26 GETUPVAL                         R5 0
       27 GETTABLEKS                       R5 R5 K6 ["FOLDERS"]
       29 GETTABLEKS                       R5 R5 K7 ["Microbones"]
       31 SETTABLEKS                       R5 R4 K13 ["Name"]
       33 LOADB                            R5 0
       34 SETTABLEKS                       R5 R4 K14 ["Archivable"]
       36 GETIMPORT                        R5 K4 [game]
       38 GETTABLEKS                       R5 R5 K5 ["Workspace"]
       ...
       48 MOVE                             R2 R3
       49 GETUPVAL                         R3 1
       50 GETTABLEKS                       R3 R3 K18 ["getRigInfo"]
       52 MOVE                             R4 R0
       53 CALL                             R3 1 1
...
PROTO_13:
       ...
       20 JUMPIFNOT                        R3 ; [+5]
       21 GETUPVAL                         R3 0
       22 GETTABLEKS                       R3 R3 K7 ["BONE_COLOR_SELECTED"]
       ...
       31 JUMPIFNOT                        R3 ; [+5]
       32 GETUPVAL                         R3 0
       33 GETTABLEKS                       R3 R3 K7 ["BONE_COLOR_SELECTED"]
...
PROTO_14:
       ...
       43 GETUPVAL                         R10 0
       44 GETTABLEKS                       R10 R10 K16 ["BONE_COLOR_SELECTED"]
       46 JUMPIFNOTEQ                      R9 R10 ; [+11]
       48 GETUPVAL                         R9 0
       49 GETTABLEKS                       R9 R9 K17 ["BONE_COLOR_DEFAULT"]
       51 SETTABLEKS                       R9 R7 K15 ["Color3"]
       53 GETUPVAL                         R9 0
       54 GETTABLEKS                       R9 R9 K18 ["BONE_TRANSPARENCY_DEFAULT"]
       ...
       66 GETUPVAL                         R10 0
       67 GETTABLEKS                       R10 R10 K16 ["BONE_COLOR_SELECTED"]
       69 JUMPIFNOTEQ                      R9 R10 ; [+11]
       71 GETUPVAL                         R9 0
       72 GETTABLEKS                       R9 R9 K17 ["BONE_COLOR_DEFAULT"]
       74 SETTABLEKS                       R9 R8 K15 ["Color3"]
       76 GETUPVAL                         R9 0
       77 GETTABLEKS                       R9 R9 K18 ["BONE_TRANSPARENCY_DEFAULT"]
...
PROTO_15:
        ...
        5 GETTABLEKS                       R2 R0 K0 ["Parent"]
        7 GETTABLEKS                       R2 R2 K1 ["Name"]
        9 GETUPVAL                         R3 0
       10 GETTABLEKS                       R3 R3 K2 ["FOLDERS"]
       12 GETTABLEKS                       R3 R3 K3 ["Microbones"]
       14 JUMPIFEQ                         R2 R3 ; [+2]
       16 LOADB                            R1 0 +1
       17 LOADB                            R1 1
       18 RETURN                           R1 1
...
MAIN:
       ...
       20 GETTABLEKS                       R3 R3 K10 ["DraggerFramework"]
       22 GETIMPORT                        R4 K5 [require]
       24 GETTABLEKS                       R5 R3 K11 ["Utility"]
       26 GETTABLEKS                       R5 R5 K9 ["Math"]
       28 CALL                             R4 1 1
