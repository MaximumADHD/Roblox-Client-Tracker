...
MAIN:
  ...
  GETTABLEKS R11 R12 K18 ["GetFFlagRigInfoCache"]
  CALL R10 1 1
  NEWTABLE R11 8 0
  ...
  CAPTURE VAL R4
  DUPCLOSURE R20 K27 [PROTO_8]
  CAPTURE VAL R7
  CAPTURE VAL R19
  DUPCLOSURE R21 K28 [PROTO_9]
  CAPTURE VAL R7
  SETTABLEKS R21 R11 K29 ["clearMicrobones"]
  DUPCLOSURE R21 K30 [PROTO_10]
  CAPTURE VAL R7
  CAPTURE VAL R10
  CAPTURE VAL R8
  CAPTURE VAL R16
  SETTABLEKS R21 R11 K31 ["updateMicrobones"]
  DUPCLOSURE R21 K32 [PROTO_11]
  CAPTURE VAL R9
  CAPTURE VAL R8
  CAPTURE VAL R20
  SETTABLEKS R21 R11 K33 ["getBoneHit"]
  DUPCLOSURE R21 K34 [PROTO_12]
  CAPTURE VAL R7
  SETTABLEKS R21 R11 K35 ["selectBone"]
  DUPCLOSURE R21 K36 [PROTO_13]
  CAPTURE VAL R7
  SETTABLEKS R21 R11 K37 ["deselectBones"]
  DUPCLOSURE R21 K38 [PROTO_14]
  CAPTURE VAL R7
  SETTABLEKS R21 R11 K39 ["isBone"]
  RETURN R11 1
