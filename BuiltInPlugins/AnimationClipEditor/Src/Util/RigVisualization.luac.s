...
MAIN:
  ...
  LOADK R13 K21 ["ACEShowBoneLeaves"]
  LOADB R14 0
  ...
  CAPTURE VAL R7
  SETTABLEKS R22 R12 K33 ["clearMicrobones"]
  DUPCLOSURE R22 K34 [PROTO_11]
  CAPTURE VAL R7
  CAPTURE VAL R10
  CAPTURE VAL R8
  CAPTURE VAL R17
  SETTABLEKS R22 R12 K35 ["updateMicrobones"]
  DUPCLOSURE R22 K36 [PROTO_12]
  CAPTURE VAL R9
  CAPTURE VAL R8
  CAPTURE VAL R21
  SETTABLEKS R22 R12 K37 ["getBoneHit"]
  DUPCLOSURE R22 K38 [PROTO_13]
  CAPTURE VAL R7
  SETTABLEKS R22 R12 K39 ["selectBone"]
  DUPCLOSURE R22 K40 [PROTO_14]
  CAPTURE VAL R7
  SETTABLEKS R22 R12 K41 ["deselectBones"]
  DUPCLOSURE R22 K42 [PROTO_15]
  CAPTURE VAL R7
  SETTABLEKS R22 R12 K43 ["isBone"]
  RETURN R12 1
