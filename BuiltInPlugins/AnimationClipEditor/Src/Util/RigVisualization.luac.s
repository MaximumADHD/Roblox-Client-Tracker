...
MAIN:
  ...
  GETTABLEKS R10 R11 K17 ["GetFFlagRigInfoCache"]
  CALL R9 1 1
  GETIMPORT R10 K19 [game]
  LOADK R12 K20 ["ACEShowBoneLeaves"]
  LOADB R13 0
  ...
  CAPTURE VAL R7
  SETTABLEKS R21 R11 K32 ["clearMicrobones"]
  DUPCLOSURE R21 K33 [PROTO_11]
  CAPTURE VAL R7
  CAPTURE VAL R9
  CAPTURE VAL R8
  CAPTURE VAL R16
  SETTABLEKS R21 R11 K34 ["updateMicrobones"]
  DUPCLOSURE R21 K35 [PROTO_12]
  CAPTURE VAL R8
  CAPTURE VAL R20
  SETTABLEKS R21 R11 K36 ["getBoneHit"]
  DUPCLOSURE R21 K37 [PROTO_13]
  CAPTURE VAL R7
  SETTABLEKS R21 R11 K38 ["selectBone"]
  DUPCLOSURE R21 K39 [PROTO_14]
  CAPTURE VAL R7
  SETTABLEKS R21 R11 K40 ["deselectBones"]
  DUPCLOSURE R21 K41 [PROTO_15]
  CAPTURE VAL R7
  SETTABLEKS R21 R11 K42 ["isBone"]
  RETURN R11 1
