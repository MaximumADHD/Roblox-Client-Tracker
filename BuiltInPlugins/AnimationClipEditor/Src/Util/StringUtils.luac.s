...
PROTO_3:
        0 GETUPVAL                         R3 0
        1 GETTABLEKS                       R3 R3 K0 ["TIMELINE_UNITS"]
        3 GETTABLEKS                       R3 R3 K1 ["SecondsDecimal"]
       ...
       12 JUMPIFNOT                        R3 ; [+5]
       13 GETUPVAL                         R5 0
       14 GETTABLEKS                       R5 R5 K4 ["TICK_FREQUENCY"]
       16 MUL                              R4 R3 R5
       17 RETURN                           R4 1
       18 LOADNIL                          R4
       19 RETURN                           R4 1
       20 GETUPVAL                         R3 0
       21 GETTABLEKS                       R3 R3 K0 ["TIMELINE_UNITS"]
       23 GETTABLEKS                       R3 R3 K5 ["Frames"]
       ...
       32 JUMPIFNOT                        R3 ; [+6]
       33 GETUPVAL                         R6 0
       34 GETTABLEKS                       R6 R6 K4 ["TICK_FREQUENCY"]
       36 MUL                              R5 R3 R6
       37 DIV                              R4 R5 R1
       38 RETURN                           R4 1
       39 LOADNIL                          R4
       ...
       76 GETUPVAL                         R8 0
       77 GETTABLEKS                       R8 R8 K4 ["TICK_FREQUENCY"]
       79 MUL                              R6 R7 R8
       80 DIV                              R5 R6 R1
       81 RETURN                           R5 1
       82 LENGTH                           R5 R4
       ...
       89 ADD                              R6 R7 R8
       90 GETUPVAL                         R7 0
       91 GETTABLEKS                       R7 R7 K4 ["TICK_FREQUENCY"]
       93 MUL                              R5 R6 R7
       94 RETURN                           R5 1
       95 LOADNIL                          R5
       96 RETURN                           R5 1
...
PROTO_4:
        0 GETUPVAL                         R3 0
        1 GETTABLEKS                       R3 R3 K0 ["TIMELINE_UNITS"]
        3 GETTABLEKS                       R3 R3 K1 ["Frames"]
        5 JUMPIFNOTEQ                      R2 R3 ; [+15]
        7 MUL                              R6 R0 R1
        8 GETUPVAL                         R7 0
        9 GETTABLEKS                       R7 R7 K2 ["TICK_FREQUENCY"]
       11 DIV                              R5 R6 R7
       ...
       20 RETURN                           R3 1
       21 GETUPVAL                         R3 0
       22 GETTABLEKS                       R3 R3 K0 ["TIMELINE_UNITS"]
       24 GETTABLEKS                       R3 R3 K8 ["Seconds"]
       26 JUMPIFNOTEQ                      R2 R3 ; [+44]
       28 GETUPVAL                         R3 1
       29 GETTABLEKS                       R3 R3 K9 ["getNearestTick"]
       31 MUL                              R5 R0 R1
       32 GETUPVAL                         R6 0
       33 GETTABLEKS                       R6 R6 K2 ["TICK_FREQUENCY"]
       35 DIV                              R4 R5 R6
       36 CALL                             R3 1 1
       ...
       70 RETURN                           R6 1
       71 GETUPVAL                         R3 0
       72 GETTABLEKS                       R3 R3 K0 ["TIMELINE_UNITS"]
       74 GETTABLEKS                       R3 R3 K17 ["SecondsDecimal"]
       76 JUMPIFNOTEQ                      R2 R3 ; [+15]
       78 GETUPVAL                         R4 2
       79 GETTABLEKS                       R4 R4 K18 ["round"]
       81 GETUPVAL                         R6 0
       82 GETTABLEKS                       R6 R6 K2 ["TICK_FREQUENCY"]
       84 DIV                              R5 R0 R6
       85 LOADN                            R6 2
       86 CALL                             R4 2 -1
