...
local IKWindow = require(Plugin.SrcDeprecated.Components.IK.IKWindow)
local R15IKRig = require(Plugin.SrcDeprecated.Components.IK.R15IKRig)

local ToggleIKEnabled = require(Plugin.SrcDeprecated.Thunks.ToggleIKEnabled)
local ToggleShowTree = require(Plugin.SrcDeprecated.Thunks.ToggleShowTree)
local TogglePinnedPart = require(Plugin.SrcDeprecated.Thunks.TogglePinnedPart)
