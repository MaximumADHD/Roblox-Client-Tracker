...
local DoubleClickDetector = require(Plugin.SrcDeprecated.Util.DoubleClickDetector)

local Preview = require(Plugin.SrcDeprecated.Util.Preview)
local EventTrack = require(Plugin.SrcDeprecated.Components.EventTrack)
local SelectionBox = require(Plugin.SrcDeprecated.Components.SelectionBox)
local EventActions = require(Plugin.SrcDeprecated.Components.EventActions)
...
local EditEventsDialog = require(Plugin.SrcDeprecated.Components.EditEventsDialog.EditEventsDialog)
