...
local BaseTrack = require(Plugin.SrcDeprecated.Components.BaseTrack)

local Constants = require(Plugin.SrcDeprecated.Util.Constants)
local TrackUtils = require(Plugin.SrcDeprecated.Util.TrackUtils)
local Keyframe = require(Plugin.SrcDeprecated.Components.Timeline.Keyframe)
local KeyframeCluster = require(Plugin.SrcDeprecated.Components.KeyframeCluster)
