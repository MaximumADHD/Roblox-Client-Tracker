...
local AnimationClipMenu = require(Plugin.SrcDeprecated.Components.AnimationClipMenu)
local ContextButton = require(Plugin.SrcDeprecated.Components.ContextButton)
...
local ImportKeyframeSequence = require(Plugin.SrcDeprecated.Thunks.Exporting.ImportKeyframeSequence)
local ImportFBXAnimation = require(Plugin.SrcDeprecated.Thunks.Exporting.ImportFBXAnimation)
