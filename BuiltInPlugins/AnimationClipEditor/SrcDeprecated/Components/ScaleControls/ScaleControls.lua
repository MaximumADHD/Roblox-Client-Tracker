...
local ScaleHandle = require(Plugin.SrcDeprecated.Components.ScaleControls.ScaleHandle)
local TimeTag = require(Plugin.SrcDeprecated.Components.ScaleControls.TimeTag)
