...
local Preview = require(Plugin.SrcDeprecated.Util.Preview)
...
local DopeSheet = require(Plugin.SrcDeprecated.Components.DopeSheet)
local EventsController = require(Plugin.SrcDeprecated.Components.EventsController)
local SelectionBox = require(Plugin.SrcDeprecated.Components.SelectionBox)
local TimelineActions = require(Plugin.SrcDeprecated.Components.TimelineActions)
local ScaleControls = require(Plugin.SrcDeprecated.Components.ScaleControls.ScaleControls)
local TextEntryPrompt = require(Plugin.SrcDeprecated.Components.TextEntryPrompt)
local ActionToast = require(Plugin.SrcDeprecated.Components.Toast.ActionToast)
local NoticeToast = require(Plugin.SrcDeprecated.Components.Toast.NoticeToast)
...
local DeselectKeyframesAtFrame = require(Plugin.SrcDeprecated.Thunks.Selection.DeselectKeyframesAtFrame)
