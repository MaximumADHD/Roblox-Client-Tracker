...
MAIN:
       ...
       28 GETTABLEKS                       R4 R5 K2 ["Parent"]
       30 GETTABLEKS                       R3 R4 K10 ["commonInit"]
       32 CALL                             R2 1 1
       33 MOVE                             R3 R2
       34 CALL                             R3 0 0
       ...
       87 GETTABLEKS                       R12 R13 K2 ["Parent"]
       89 GETTABLEKS                       R11 R12 K30 ["defineLuaFlags"]
       91 CALL                             R10 1 0
       92 NEWTABLE                         R12 0 1
       94 MOVE                             R13 R8
      ...
      104 LOADK                            R11 K32 ["----------------------------------"]
      105 CALL                             R10 1 0
      106 GETTABLEKS                       R2 R1 K8 ["RunningUnderCLI"]
      108 CALL                             R2 0 1
      109 JUMPIFNOT                        R2 ; [+4]
      110 GETIMPORT                        R2 K34 [pcall]
      112 DUPCLOSURE                       R3 K35 [PROTO_0]
      113 CALL                             R2 1 0
      114 RETURN                           R0 0
