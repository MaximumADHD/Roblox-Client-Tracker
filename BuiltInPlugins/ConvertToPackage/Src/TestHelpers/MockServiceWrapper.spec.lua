...
local withLocalization = if FFlagUpdateConvertToPackageToDFContextServices then nil else require(Plugin.Packages.UILibrary).Localizing.withLocalization
...
return function()
	...
	describe("Localization", function()
		...
		it("should supply a functional localization object to its children", function()
			local element = Roact.createElement(MockServiceWrapper, {}, {
				TestElement = Roact.createElement(if FFlagUpdateConvertToPackageToDFContextServices then createTestLocalizedElement() else function()
	...
	describe("Theme", function()
		...
		it("should supply a functional theme object to its children", function()
			local element = Roact.createElement(MockServiceWrapper, {}, {
				TestElement = Roact.createElement(if FFlagUpdateConvertToPackageToDFContextServices then createTestThemedElement() else function()
