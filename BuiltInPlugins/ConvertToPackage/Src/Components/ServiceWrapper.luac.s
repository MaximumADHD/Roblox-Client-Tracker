PROTO_0:
        ...
        2 GETUPVAL                         R6 0
        3 GETTABLEKS                       R6 R6 K1 ["Children"]
        5 GETTABLE                         R4 R5 R6
       ...
       18 GETTABLEKS                       R4 R4 K5 ["networkInterface"]
       ...
       32 GETTABLEKS                       R4 R4 K7 ["localization"]
      ...
      102 GETTABLEKS                       R4 R4 K17 ["focusGui"]
...
PROTO_1:
       ...
       18 GETUPVAL                         R11 0
       19 GETTABLEKS                       R11 R11 K8 ["Children"]
       21 GETTABLE                         R9 R10 R11
       22 GETUPVAL                         R10 1
       23 GETTABLEKS                       R10 R10 K9 ["provide"]
       25 NEWTABLE                         R11 0 7
       27 GETUPVAL                         R12 1
       28 GETTABLEKS                       R12 R12 K10 ["Store"]
       30 GETTABLEKS                       R12 R12 K11 ["new"]
       32 MOVE                             R13 R2
       33 CALL                             R12 1 1
       34 GETUPVAL                         R13 1
       35 GETTABLEKS                       R13 R13 K12 ["Focus"]
       37 GETTABLEKS                       R13 R13 K11 ["new"]
       39 MOVE                             R14 R6
       40 CALL                             R13 1 1
       41 MOVE                             R14 R4
       42 MOVE                             R15 R7
       43 GETUPVAL                         R16 1
       44 GETTABLEKS                       R16 R16 K13 ["Plugin"]
       46 GETTABLEKS                       R16 R16 K11 ["new"]
       48 MOVE                             R17 R3
       49 CALL                             R16 1 1
       50 GETUPVAL                         R17 2
       51 GETTABLEKS                       R17 R17 K11 ["new"]
       53 MOVE                             R18 R8
       54 CALL                             R17 1 1
       55 GETUPVAL                         R18 1
       56 GETTABLEKS                       R18 R18 K14 ["Mouse"]
       58 GETTABLEKS                       R18 R18 K11 ["new"]
       60 MOVE                             R19 R5
       61 CALL                             R18 1 -1
...
MAIN:
       ...
       27 GETTABLEKS                       R6 R6 K8 ["ContextServices"]
       29 GETTABLEKS                       R6 R6 K10 ["NetworkContext"]
       31 CALL                             R5 1 1
