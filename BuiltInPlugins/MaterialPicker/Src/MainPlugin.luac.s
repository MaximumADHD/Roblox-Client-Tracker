...
MAIN:
  ...
  LOADK R29 K44 ["EnableRibbonPlugin"]
  NAMECALL R27 R27 K45 ["GetFastFlag"]
  CALL R27 2 1
  GETIMPORT R28 K43 [game]
  LOADK R30 K46 ["ReplaceIsCheckableWithCheckable"]
  NAMECALL R28 R28 K47 ["GetEngineFeature"]
  CALL R28 2 1
  GETTABLEKS R30 R0 K6 ["Src"]
  GETTABLEKS R29 R30 K48 ["Components"]
  GETIMPORT R30 K5 [require]
  GETTABLEKS R31 R29 K49 ["MainView"]
  CALL R30 1 1
  GETTABLEKS R31 R6 K50 ["PureComponent"]
  LOADK R33 K51 ["MainPlugin"]
  ...
  LOADK R34 K57 ["Light"]
  CALL R32 2 1
  GETIMPORT R33 K55 [string.format]
  LOADK R34 K56 ["rbxasset://textures/MaterialFramework/%s/Material.png"]
  LOADK R35 K58 ["Dark"]
  CALL R33 2 1
  DUPCLOSURE R34 K59 [PROTO_0]
  CAPTURE VAL R32
  CAPTURE VAL R33
  DUPCLOSURE R35 K60 [PROTO_21]
  CAPTURE VAL R6
  CAPTURE VAL R16
  CAPTURE VAL R24
  CAPTURE VAL R25
  ...
  CAPTURE VAL R0
  CAPTURE VAL R28
  SETTABLEKS R35 R31 K61 ["init"]
  DUPCLOSURE R35 K62 [PROTO_22]
  CAPTURE VAL R24
  SETTABLEKS R35 R31 K63 ["willUnmount"]
  DUPCLOSURE R35 K64 [PROTO_24]
  CAPTURE VAL R6
  CAPTURE VAL R9
  CAPTURE VAL R27
  CAPTURE VAL R24
