...
MAIN:
  ...
  GETTABLEKS R26 R27 K40 ["getFFlagEnableRibbonPlugin"]
  CALL R25 1 1
  GETIMPORT R26 K5 [require]
  GETTABLEKS R29 R0 K6 ["Src"]
  GETTABLEKS R28 R29 K38 ["Flags"]
  GETTABLEKS R27 R28 K41 ["getFFlagStudioUriWildcard"]
  CALL R26 1 1
  GETIMPORT R27 K5 [require]
  GETTABLEKS R30 R0 K6 ["Src"]
  GETTABLEKS R29 R30 K38 ["Flags"]
  GETTABLEKS R28 R29 K42 ["getFFlagMaterialPickerOpenCooldown"]
  CALL R27 1 1
  GETIMPORT R28 K44 [game]
  LOADK R30 K45 ["EnableRibbonPluginFeature"]
  NAMECALL R28 R28 K46 ["GetEngineFeature"]
  CALL R28 2 1
  JUMPIF R28 [+5]
  GETIMPORT R29 K48 [pcall]
  NEWCLOSURE R30 P0
  CAPTURE REF R28
  CALL R29 1 0
  GETIMPORT R29 K44 [game]
  LOADK R31 K49 ["ReplaceIsCheckableWithCheckable"]
  NAMECALL R29 R29 K46 ["GetEngineFeature"]
  CALL R29 2 1
  GETTABLEKS R31 R0 K6 ["Src"]
  GETTABLEKS R30 R31 K50 ["Components"]
  GETIMPORT R31 K5 [require]
  GETTABLEKS R32 R30 K51 ["MainView"]
  CALL R31 1 1
  GETTABLEKS R32 R6 K52 ["PureComponent"]
  LOADK R34 K53 ["MainPlugin"]
  NAMECALL R32 R32 K54 ["extend"]
  CALL R32 2 1
  GETIMPORT R33 K57 [string.format]
  LOADK R34 K58 ["rbxasset://textures/MaterialFramework/%s/Material.png"]
  LOADK R35 K59 ["Light"]
  CALL R33 2 1
  GETIMPORT R34 K57 [string.format]
  LOADK R35 K58 ["rbxasset://textures/MaterialFramework/%s/Material.png"]
  LOADK R36 K60 ["Dark"]
  CALL R34 2 1
  DUPCLOSURE R35 K61 [PROTO_1]
  CAPTURE VAL R33
  CAPTURE VAL R34
  GETIMPORT R36 K44 [game]
  LOADK R38 K62 ["MaterialPickerOpenCooldownMillis"]
  LOADN R39 238
  NAMECALL R36 R36 K63 ["DefineFastInt"]
  CALL R36 3 1
  DIVK R37 R36 K64 [1000]
  DUPCLOSURE R38 K65 [PROTO_22]
  CAPTURE VAL R6
  CAPTURE VAL R16
  CAPTURE VAL R24
  CAPTURE VAL R27
  ...
  CAPTURE VAL R0
  CAPTURE VAL R29
  SETTABLEKS R38 R32 K66 ["init"]
  DUPCLOSURE R38 K67 [PROTO_23]
  CAPTURE VAL R24
  SETTABLEKS R38 R32 K68 ["willUnmount"]
  NEWCLOSURE R38 P4
  CAPTURE VAL R6
  CAPTURE VAL R9
  CAPTURE REF R28
  ...
  CAPTURE VAL R1
  CAPTURE VAL R2
  SETTABLEKS R38 R32 K69 ["renderButtons"]
  ...
  CAPTURE VAL R31
  CAPTURE VAL R24
  SETTABLEKS R38 R32 K71 ["renderPopup"]
  DUPCLOSURE R38 K72 [PROTO_29]
  CAPTURE VAL R12
  CAPTURE VAL R14
  CAPTURE VAL R13
  CAPTURE VAL R6
