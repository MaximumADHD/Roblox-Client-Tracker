...
MAIN:
  ...
  LOADK R4 K12 ["StyleEditor"]
  GETTABLEKS R5 R1 K13 ["Src"]
  CALL R3 2 0
  GETTABLEKS R3 R2 K14 ["isCli"]
  CALL R3 0 1
  JUMPIF R3 [+4]
  GETTABLEKS R3 R2 K15 ["hasInternalPermission"]
  CALL R3 0 1
  JUMPIF R3 [+1]
  RETURN R0 0
  GETIMPORT R3 K17 [game]
  LOADK R5 K18 ["EnableStyleEditor"]
  ...
  GETTABLEKS R4 R5 K20 ["React"]
  CALL R3 1 1
  GETIMPORT R4 K3 [require]
  GETTABLEKS R6 R1 K9 ["Packages"]
  GETTABLEKS R5 R6 K21 ["ReactRoblox"]
  CALL R4 1 1
  ...
  LOADNIL R7
  LOADNIL R8
  GETTABLEKS R9 R2 K15 ["hasInternalPermission"]
  CALL R9 0 1
  JUMPIFNOT R9 [+10]
  GETTABLEKS R10 R5 K24 ["DeveloperTools"]
  GETTABLEKS R9 R10 K25 ["forPlugin"]
  GETTABLEKS R10 R1 K26 ["Name"]
  ...
  CAPTURE REF R8
  GETIMPORT R11 K1 [plugin]
  GETTABLEKS R10 R11 K27 ["Unloading"]
  NEWCLOSURE R12 P1
  CAPTURE REF R8
  CAPTURE REF R7
