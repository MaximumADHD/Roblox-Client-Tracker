PROTO_0:
       ...
       10 GETUPVAL                         R1 2
       11 GETTABLEKS                       R1 R1 K7 ["OnChanged"]
       13 GETUPVAL                         R2 0
       14 CALL                             R1 1 0
       15 RETURN                           R0 0
...
PROTO_2:
       ...
       12 GETUPVAL                         R4 0
       13 GETTABLEKS                       R4 R4 K7 ["createElement"]
       15 GETUPVAL                         R5 1
       16 NEWTABLE                         R6 1 0
       18 GETUPVAL                         R7 0
       19 GETTABLEKS                       R7 R7 K8 ["Tag"]
       21 LOADK                            R8 K9 ["X-Middle X-PadS X-RowM"]
       22 SETTABLE                         R8 R6 R7
       23 DUPTABLE                         R7 K10 [{"Bold", "Italic"}]
       24 GETUPVAL                         R8 0
       25 GETTABLEKS                       R8 R8 K7 ["createElement"]
       27 GETUPVAL                         R9 1
       28 NEWTABLE                         R10 1 0
       30 GETUPVAL                         R11 0
       31 GETTABLEKS                       R11 R11 K8 ["Tag"]
       33 JUMPIFNOT                        R3 ; [+5]
       34 GETUPVAL                         R12 2
       ...
       46 NEWTABLE                         R14 2 0
       48 GETUPVAL                         R15 0
       49 GETTABLEKS                       R15 R15 K16 ["Event"]
       51 GETTABLEKS                       R15 R15 K17 ["Activated"]
       ...
       75 GETUPVAL                         R8 0
       76 GETTABLEKS                       R8 R8 K7 ["createElement"]
       78 GETUPVAL                         R9 1
       79 NEWTABLE                         R10 1 0
       81 GETUPVAL                         R11 0
       82 GETTABLEKS                       R11 R11 K8 ["Tag"]
       84 JUMPIFNOT                        R2 ; [+5]
       85 GETUPVAL                         R12 2
       ...
       93 GETUPVAL                         R12 0
       94 GETTABLEKS                       R12 R12 K7 ["createElement"]
       96 LOADK                            R13 K15 ["TextButton"]
       97 NEWTABLE                         R14 2 0
       99 GETUPVAL                         R15 0
      100 GETTABLEKS                       R15 R15 K16 ["Event"]
      102 GETTABLEKS                       R15 R15 K17 ["Activated"]
...
MAIN:
       ...
       31 CALL                             R3 1 1
       32 GETTABLEKS                       R4 R3 K9 ["Styling"]
       34 GETTABLEKS                       R4 R4 K10 ["joinTags"]
       36 GETTABLEKS                       R5 R3 K11 ["UI"]
       38 GETTABLEKS                       R5 R5 K12 ["Pane"]
       40 GETIMPORT                        R6 K4 [require]
       42 GETTABLEKS                       R7 R0 K13 ["Src"]
       44 GETTABLEKS                       R7 R7 K14 ["Renderers"]
       46 GETTABLEKS                       R7 R7 K15 ["RendererTypes"]
       48 CALL                             R6 1 1
       ...
       60 GETTABLEKS                       R9 R9 K17 ["Reducers"]
       62 GETTABLEKS                       R9 R9 K18 ["RootReducer"]
       64 CALL                             R8 1 1
