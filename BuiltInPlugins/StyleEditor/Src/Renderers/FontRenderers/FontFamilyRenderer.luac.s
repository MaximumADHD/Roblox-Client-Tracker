...
PROTO_3:
  ...
  DUPTABLE R7 K9 [{"Label"}]
  GETUPVAL R9 0
  GETTABLEKS R8 R9 K0 ["createElement"]
  GETUPVAL R9 2
  NEWTABLE R10 4 0
  LOADB R11 1
  SETTABLEKS R11 R10 K10 ["RichText"]
  GETIMPORT R11 K13 [string.format]
  LOADK R12 K14 ["<font family='%s' size='18'>%s</font>"]
  GETTABLEKS R13 R0 K15 ["Id"]
  GETTABLEKS R14 R0 K8 ["Label"]
  CALL R11 3 1
