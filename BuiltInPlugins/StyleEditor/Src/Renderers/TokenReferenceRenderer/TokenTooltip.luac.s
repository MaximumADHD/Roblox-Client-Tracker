...
PROTO_1:
        ...
        9 NEWTABLE                         R6 0 0
       11 GETTABLEKS                       R9 R0 K1 ["TokenInfo"]
       13 GETTABLEKS                       R8 R9 K2 ["Error"]
       15 GETUPVAL                         R10 4
       16 GETTABLEKS                       R9 R10 K3 ["None"]
       18 JUMPIFNOTEQ                      R8 R9 ; [+2]
       20 LOADB                            R7 0 +1
       21 LOADB                            R7 1
       22 JUMPIFNOT                        R7 ; [+77]
       23 GETUPVAL                         R9 5
       24 GETTABLEKS                       R11 R0 K1 ["TokenInfo"]
       26 GETTABLEKS                       R10 R11 K2 ["Error"]
       28 GETTABLE                         R8 R9 R10
       29 JUMPIF                           R8 ; [+3]
       30 GETUPVAL                         R9 5
       31 GETTABLEKS                       R8 R9 K4 ["Unknown"]
       33 LOADK                            R11 K5 ["Label"]
       34 MOVE                             R12 R8
       35 DUPTABLE                         R13 K8 [{"expectedType", "actualType"}]
       36 GETTABLEKS                       R16 R0 K1 ["TokenInfo"]
       38 GETTABLEKS                       R15 R16 K9 ["ExpectedTypes"]
       40 JUMPIFNOT                        R15 ; [+9]
       41 GETIMPORT                        R14 K12 [table.concat]
       43 GETTABLEKS                       R16 R0 K1 ["TokenInfo"]
       45 GETTABLEKS                       R15 R16 K9 ["ExpectedTypes"]
       47 LOADK                            R16 K13 [", "]
       48 CALL                             R14 2 1
       49 JUMP                             ; [+1]
       50 LOADNIL                          R14
       51 SETTABLEKS                       R14 R13 K6 ["expectedType"]
       53 GETTABLEKS                       R16 R0 K1 ["TokenInfo"]
       55 GETTABLEKS                       R15 R16 K14 ["Value"]
       ...
       67 GETUPVAL                         R12 6
       68 GETTABLEKS                       R11 R12 K20 ["createElement"]
       70 GETUPVAL                         R12 7
       71 NEWTABLE                         R13 4 0
       73 MOVE                             R14 R3
       74 CALL                             R14 0 1
      ...
      110 GETTABLEKS                       R13 R0 K1 ["TokenInfo"]
      112 GETTABLEKS                       R12 R13 K14 ["Value"]
      ...
      138 LOADK                            R13 K39 ["%s"]
      139 GETTABLEKS                       R16 R0 K1 ["TokenInfo"]
      141 GETTABLEKS                       R15 R16 K14 ["Value"]
      ...
      150 GETUPVAL                         R13 6
      151 GETTABLEKS                       R12 R13 K27 ["Tag"]
      153 LOADK                            R13 K28 ["X-FitX"]
      154 SETTABLE                         R13 R11 R12
      155 CALL                             R9 2 1
      156 SETTABLEKS                       R9 R8 K31 ["TypeLabel"]
      158 GETTABLEKS                       R10 R0 K1 ["TokenInfo"]
      160 GETTABLEKS                       R9 R10 K40 ["Source"]
      162 JUMPIFNOT                        R9 ; [+65]
      163 GETUPVAL                         R10 6
      164 GETTABLEKS                       R9 R10 K20 ["createElement"]
      166 GETUPVAL                         R10 11
      ...
      202 GETUPVAL                         R17 6
      203 GETTABLEKS                       R16 R17 K27 ["Tag"]
      205 LOADK                            R17 K28 ["X-FitX"]
      206 SETTABLE                         R17 R15 R16
      207 CALL                             R13 2 1
      208 SETTABLEKS                       R13 R12 K42 ["LeadingLabel"]
      210 GETUPVAL                         R14 6
      211 GETTABLEKS                       R13 R14 K20 ["createElement"]
      213 GETUPVAL                         R14 12
      214 DUPTABLE                         R15 K46 [{"Source", "LayoutOrder"}]
      215 GETTABLEKS                       R17 R0 K1 ["TokenInfo"]
      217 GETTABLEKS                       R16 R17 K40 ["Source"]
      ...
      230 MOVE                             R6 R8
      231 GETUPVAL                         R9 6
      232 GETTABLEKS                       R8 R9 K20 ["createElement"]
      234 GETUPVAL                         R9 13
      235 DUPTABLE                         R10 K49 [{"Content", "ContentExtents"}]
      236 GETUPVAL                         R12 6
      237 GETTABLEKS                       R11 R12 K20 ["createElement"]
      239 GETUPVAL                         R12 11
      240 NEWTABLE                         R13 2 0
      242 GETUPVAL                         R15 6
      243 GETTABLEKS                       R14 R15 K27 ["Tag"]
      245 LOADK                            R15 K50 ["X-Column X-Fit"]
      246 SETTABLE                         R15 R13 R14
      247 GETUPVAL                         R16 6
      248 GETTABLEKS                       R15 R16 K51 ["Change"]
      250 GETTABLEKS                       R14 R15 K52 ["AbsoluteSize"]
...
MAIN:
       ...
       35 GETTABLEKS                       R7 R3 K9 ["UI"]
       37 GETTABLEKS                       R6 R7 K12 ["Tooltip"]
       39 GETTABLEKS                       R8 R3 K13 ["Styling"]
       41 GETTABLEKS                       R7 R8 K14 ["joinTags"]
       43 GETIMPORT                        R8 K4 [require]
       45 GETTABLEKS                       R11 R0 K15 ["Src"]
       47 GETTABLEKS                       R10 R11 K16 ["Hooks"]
       49 GETTABLEKS                       R9 R10 K17 ["useLayoutOrderCounter"]
       51 CALL                             R8 1 1
       52 GETIMPORT                        R9 K4 [require]
       54 GETTABLEKS                       R12 R0 K15 ["Src"]
       56 GETTABLEKS                       R11 R12 K16 ["Hooks"]
       58 GETTABLEKS                       R10 R11 K18 ["useFrameworkContext"]
       60 CALL                             R9 1 1
       61 GETIMPORT                        R10 K4 [require]
       63 GETTABLEKS                       R13 R0 K15 ["Src"]
       65 GETTABLEKS                       R12 R13 K19 ["Enums"]
       67 GETTABLEKS                       R11 R12 K20 ["TokenValidationError"]
       69 CALL                             R10 1 1
       70 GETIMPORT                        R11 K4 [require]
       72 GETTABLEKS                       R14 R0 K15 ["Src"]
       74 GETTABLEKS                       R13 R14 K21 ["Resources"]
       76 GETTABLEKS                       R12 R13 K22 ["PluginStyles"]
       78 CALL                             R11 1 1
       79 GETIMPORT                        R12 K4 [require]
       81 GETTABLEKS                       R15 R0 K15 ["Src"]
       83 GETTABLEKS                       R14 R15 K23 ["Reducers"]
       85 GETTABLEKS                       R13 R14 K24 ["RootReducer"]
       87 CALL                             R12 1 1
       88 GETIMPORT                        R13 K4 [require]
       90 GETIMPORT                        R16 K1 [script]
       92 GETTABLEKS                       R15 R16 K2 ["Parent"]
       94 GETTABLEKS                       R14 R15 K25 ["TokenSourceLink"]
       96 CALL                             R13 1 1
       97 GETIMPORT                        R14 K4 [require]
       99 GETIMPORT                        R17 K1 [script]
      101 GETTABLEKS                       R16 R17 K2 ["Parent"]
      103 GETTABLEKS                       R15 R16 K26 ["TokenValuePreview"]
      105 CALL                             R14 1 1
      106 GETIMPORT                        R15 K4 [require]
      108 GETIMPORT                        R18 K1 [script]
      110 GETTABLEKS                       R17 R18 K2 ["Parent"]
      112 GETTABLEKS                       R16 R17 K27 ["Types"]
      114 CALL                             R15 1 1
