...
PROTO_8:
       ...
       10 JUMPIFEQ                         R2 R3 ; [+6]
       12 GETUPVAL                         R3 2
       13 GETTABLEKS                       R3 R3 K1 ["OnChanged"]
       15 MOVE                             R4 R2
       16 CALL                             R3 1 0
       17 GETUPVAL                         R2 3
       18 LOADNIL                          R3
...
PROTO_11:
       ...
       23 GETUPVAL                         R9 1
       24 NEWTABLE                         R10 4 0
       26 GETTABLEKS                       R11 R0 K10 ["BrickColor"]
       28 GETTABLEKS                       R11 R11 K11 ["Color"]
       30 SETTABLEKS                       R11 R10 K12 ["BackgroundColor3"]
       32 LOADN                            R11 1
       33 SETTABLEKS                       R11 R10 K3 ["LayoutOrder"]
       35 GETUPVAL                         R11 0
       36 GETTABLEKS                       R11 R11 K5 ["Tag"]
       ...
       54 GETTABLEKS                       R11 R0 K10 ["BrickColor"]
       56 GETTABLEKS                       R11 R11 K14 ["Name"]
       58 SETTABLEKS                       R11 R10 K8 ["Text"]
       60 GETUPVAL                         R11 0
       61 GETTABLEKS                       R11 R11 K5 ["Tag"]
...
PROTO_12:
       ...
       48 CALL                             R11 1 1
       49 JUMPIF                           R11 ; [+5]
       50 GETTABLEKS                       R11 R0 K0 ["Schema"]
       52 GETTABLEKS                       R11 R11 K4 ["GetDefaultValue"]
       54 CALL                             R11 0 1
       55 GETTABLEKS                       R9 R11 K3 ["Color"]
       57 GETTABLEKS                       R10 R11 K5 ["Name"]
       59 GETUPVAL                         R11 5
       60 GETTABLEKS                       R11 R11 K6 ["createElement"]
       62 GETUPVAL                         R12 6
       63 NEWTABLE                         R13 0 0
       65 DUPTABLE                         R14 K8 [{"Input"}]
       66 GETUPVAL                         R15 5
       67 GETTABLEKS                       R15 R15 K6 ["createElement"]
       69 GETUPVAL                         R16 7
...
MAIN:
       ...
       31 GETTABLEKS                       R6 R6 K12 ["IconButton"]
       ...
       43 GETTABLEKS                       R9 R9 K15 ["TextLabel"]
       ...
       62 GETTABLEKS                       R13 R13 K21 ["Dash"]
       64 CALL                             R12 1 1
       65 GETTABLEKS                       R13 R12 K22 ["map"]
       67 GETTABLEKS                       R14 R12 K23 ["filter"]
       69 GETIMPORT                        R15 K4 [require]
       71 GETIMPORT                        R16 K1 [script]
       73 GETTABLEKS                       R16 R16 K24 ["getAllBrickColors"]
       75 CALL                             R15 1 1
       76 GETIMPORT                        R16 K4 [require]
       78 GETTABLEKS                       R17 R0 K16 ["Src"]
       80 GETTABLEKS                       R17 R17 K25 ["Renderers"]
       82 GETTABLEKS                       R17 R17 K26 ["RendererTypes"]
       84 CALL                             R16 1 1
