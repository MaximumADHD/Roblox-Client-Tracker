PROTO_0:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["OnHoverStart"]
        3 JUMPIFNOT                        R0 ; [+4]
        4 GETUPVAL                         R0 0
        5 GETTABLEKS                       R0 R0 K0 ["OnHoverStart"]
        7 CALL                             R0 0 0
        8 RETURN                           R0 0

PROTO_1:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["OnHoverEnd"]
        3 JUMPIFNOT                        R0 ; [+4]
        4 GETUPVAL                         R0 0
        5 GETTABLEKS                       R0 R0 K0 ["OnHoverEnd"]
        7 CALL                             R0 0 0
        8 RETURN                           R0 0
...
PROTO_3:
        ...
        2 CALL                             R0 1 0
        3 GETUPVAL                         R0 1
        4 GETTABLEKS                       R0 R0 K0 ["OnDragEnd"]
        6 JUMPIFNOT                        R0 ; [+4]
        7 GETUPVAL                         R0 1
        8 GETTABLEKS                       R0 R0 K0 ["OnDragEnd"]
       10 CALL                             R0 0 0
       11 RETURN                           R0 0
...
PROTO_4:
        ...
        6 CALL                             R2 1 0
        7 GETUPVAL                         R2 2
        8 GETTABLEKS                       R2 R2 K0 ["OnDragStart"]
       10 JUMPIFNOT                        R2 ; [+4]
       11 GETUPVAL                         R2 2
       12 GETTABLEKS                       R2 R2 K0 ["OnDragStart"]
       14 CALL                             R2 0 0
       15 RETURN                           R0 0
...
PROTO_6:
       ...
       67 LOADK                            R5 K14 [""]
       68 GETUPVAL                         R6 0
       69 GETTABLEKS                       R6 R6 K3 ["createElement"]
       71 LOADK                            R7 K15 ["TextButton"]
       72 NEWTABLE                         R8 4 0
       74 GETIMPORT                        R9 K18 [UDim2.fromScale]
       76 GETTABLEKS                       R10 R0 K19 ["Position"]
       ...
       98 GETUPVAL                         R9 0
       99 GETTABLEKS                       R9 R9 K25 ["Event"]
      101 GETTABLEKS                       R9 R9 K26 ["InputBegan"]
...
MAIN:
       ...
       26 CALL                             R3 1 1
       27 GETTABLEKS                       R4 R3 K9 ["Styling"]
       29 GETTABLEKS                       R4 R4 K10 ["joinTags"]
       31 GETTABLEKS                       R5 R3 K11 ["UI"]
       33 GETTABLEKS                       R5 R5 K12 ["DragListener"]
       35 GETTABLEKS                       R6 R3 K11 ["UI"]
       37 GETTABLEKS                       R6 R6 K13 ["HoverArea"]
       39 GETTABLEKS                       R7 R3 K14 ["Util"]
       41 GETTABLEKS                       R7 R7 K15 ["isInputMainPress"]
       43 GETIMPORT                        R8 K4 [require]
       45 GETTABLEKS                       R9 R0 K16 ["Src"]
       47 GETTABLEKS                       R9 R9 K17 ["Resources"]
       49 GETTABLEKS                       R9 R9 K18 ["PluginStyles"]
       51 CALL                             R8 1 1
       ...
       60 GETTABLEKS                       R11 R11 K21 ["Flags"]
       62 GETTABLEKS                       R11 R11 K22 ["getFFlagStyleEditorFixKeypointHoverDrag"]
       64 CALL                             R10 1 1
       65 CALL                             R10 0 1
