...
PROTO_23:
  ...
  DUPTABLE R31 K45 [{"OnClick", "ForwardRef", "Color", "Transparency", "Size"}]
  ...
  SETTABLEKS R31 R30 K46 ["LeadingComponentProps"]
  SETTABLEKS R20 R30 K47 ["OnFocusLost"]
  SETTABLEKS R21 R30 K48 ["OnTextChanged"]
  GETTABLEKS R32 R0 K49 ["AutomaticSize"]
  JUMPIFNOT R32 [+10]
  GETIMPORT R31 K51 [UDim2.new]
  LOADN R32 1
  LOADN R33 0
  LOADN R34 0
  GETTABLEKS R36 R0 K53 ["MinimumHeight"]
  ORK R35 R36 K52 [24]
  CALL R31 4 1
  JUMP [+5]
  GETIMPORT R31 K55 [UDim2.fromScale]
  LOADN R32 1
  LOADN R33 1
  CALL R31 2 1
  SETTABLEKS R31 R30 K44 ["Size"]
  ...
  SETTABLEKS R14 R30 K47 ["OnFocusLost"]
...
MAIN:
  ...
  GETTABLEKS R22 R23 K32 ["PluginStyles"]
  CALL R21 1 1
  GETIMPORT R22 K4 [require]
  GETTABLEKS R25 R0 K18 ["Src"]
  GETTABLEKS R24 R25 K33 ["Flags"]
  GETTABLEKS R23 R24 K34 ["getFFlagStyleEditorSequenceCrash"]
  CALL R22 1 1
  CALL R22 0 1
  ...
  GETTABLEKS R27 R28 K19 ["Renderers"]
  GETTABLEKS R26 R27 K37 ["RendererTypes"]
  CALL R25 1 1
  GETIMPORT R26 K4 [require]
  GETTABLEKS R30 R0 K18 ["Src"]
  GETTABLEKS R29 R30 K19 ["Renderers"]
  GETTABLEKS R28 R29 K20 ["SequenceRenderers"]
  GETTABLEKS R27 R28 K36 ["Types"]
  CALL R26 1 1
  GETIMPORT R27 K40 [ColorSequence.new]
  ...
  CALL R28 3 -1
  CALL R27 -1 1
  LOADK R30 K44 ["Icon16"]
  NAMECALL R28 R21 K45 ["GetAttribute"]
  CALL R28 2 1
