...
MAIN:
  ...
  GETTABLEKS R25 R26 K36 ["RendererTypes"]
  CALL R24 1 1
  GETIMPORT R25 K4 [require]
  GETTABLEKS R29 R0 K18 ["Src"]
  GETTABLEKS R28 R29 K19 ["Renderers"]
  GETTABLEKS R27 R28 K20 ["SequenceRenderers"]
  GETTABLEKS R26 R27 K35 ["Types"]
  CALL R25 1 1
  GETIMPORT R26 K39 [ColorSequence.new]
  ...
  CALL R27 3 -1
  CALL R26 -1 1
  LOADK R29 K43 ["Icon16"]
  NAMECALL R27 R21 K44 ["GetAttribute"]
  CALL R27 2 1
  ...
  CAPTURE VAL R22
  CAPTURE VAL R11
  DUPCLOSURE R30 K47 [PROTO_6]
  CAPTURE VAL R11
  DUPCLOSURE R31 K48 [PROTO_8]
  DUPCLOSURE R32 K49 [PROTO_23]
  CAPTURE VAL R3
  CAPTURE VAL R2
  CAPTURE VAL R20
  CAPTURE VAL R17
