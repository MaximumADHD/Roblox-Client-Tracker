...
MAIN:
  ...
  GETTABLEKS R12 R13 K22 ["getFFlagStyleEditorFixWarnings"]
  CALL R11 1 1
  CALL R11 0 1
  GETIMPORT R12 K4 [require]
  GETTABLEKS R15 R0 K15 ["Src"]
  GETTABLEKS R14 R15 K21 ["Flags"]
  GETTABLEKS R13 R14 K23 ["getFFlagStyleEditorFixSequenceNumPrecision"]
  CALL R12 1 1
  CALL R12 0 1
  ...
  GETTABLEKS R17 R18 K18 ["Renderers"]
  GETTABLEKS R16 R17 K19 ["SequenceRenderers"]
  GETTABLEKS R15 R16 K24 ["Types"]
  CALL R14 1 1
  DUPTABLE R15 K29 [{"Type", "Min", "Max", "Precision"}]
  LOADK R16 K30 ["Number"]
  ...
  JUMP [+1]
  LOADNIL R16
  SETTABLEKS R16 R15 K28 ["Precision"]
