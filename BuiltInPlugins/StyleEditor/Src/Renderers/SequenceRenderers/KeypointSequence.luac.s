...
PROTO_3:
  ...
  CALL R2 3 1
  SETTABLEKS R2 R1 K2 ["Time"]
  GETTABLEKS R3 R1 K8 ["Value"]
  FASTCALL1 TYPEOF R3 [+2]
  GETIMPORT R2 K10 [typeof]
  CALL R2 1 1
  JUMPIFNOTEQKS R2 K11 ["number"] [+11]
  GETTABLEKS R3 R1 K8 ["Value"]
  LOADN R4 0
  LOADN R5 1
  FASTCALL MATH_CLAMP [+2]
  ...
  LOADNIL R6
  FORGPREP R4
  GETTABLEKS R9 R1 K2 ["Time"]
  GETTABLEKS R10 R8 K2 ["Time"]
  JUMPIFNOTEQ R9 R10 [+6]
  GETTABLEKS R9 R1 K2 ["Time"]
  SUBK R9 R9 K13 [0.001]
  SETTABLEKS R9 R1 K2 ["Time"]
  GETUPVAL R9 1
  JUMPIFNOT R9 [+11]
  GETTABLEKS R9 R1 K2 ["Time"]
  LOADK R10 K3 [0.01]
...
MAIN:
  ...
  GETTABLEKS R8 R9 K17 ["getFFlagStyleEditorSequenceCrash"]
  CALL R7 1 1
  CALL R7 0 1
  NEWTABLE R8 8 0
  LOADN R9 20
  SETTABLEKS R9 R8 K18 ["MAX_KEYPOINT_COUNT"]
  DUPCLOSURE R9 K19 [PROTO_1]
  SETTABLEKS R9 R8 K20 ["updateIndexMut"]
  DUPCLOSURE R9 K21 [PROTO_2]
  CAPTURE VAL R5
  CAPTURE VAL R2
  CAPTURE VAL R8
  SETTABLEKS R9 R8 K22 ["updateSelected"]
  ...
  CAPTURE VAL R4
  SETTABLEKS R9 R8 K26 ["removeSelected"]
  DUPCLOSURE R9 K27 [PROTO_5]
  SETTABLEKS R9 R8 K28 ["isFixedKeypointSelected"]
  DUPCLOSURE R9 K29 [PROTO_6]
  CAPTURE VAL R3
  SETTABLEKS R9 R8 K30 ["select"]
  DUPCLOSURE R9 K31 [PROTO_7]
  SETTABLEKS R9 R8 K32 ["selectedKeypoint"]
  RETURN R8 1
