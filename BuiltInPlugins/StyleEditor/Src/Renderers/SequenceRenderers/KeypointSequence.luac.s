...
MAIN:
  ...
  SETTABLEKS R8 R7 K17 ["updateIndexMut"]
  DUPCLOSURE R8 K18 [PROTO_2]
  CAPTURE VAL R5
  CAPTURE VAL R2
  CAPTURE VAL R7
  SETTABLEKS R8 R7 K19 ["updateSelected"]
  DUPCLOSURE R8 K20 [PROTO_3]
  CAPTURE VAL R2
  CAPTURE VAL R4
  SETTABLEKS R8 R7 K21 ["add"]
  DUPCLOSURE R8 K22 [PROTO_4]
  CAPTURE VAL R4
  SETTABLEKS R8 R7 K23 ["removeSelected"]
  DUPCLOSURE R8 K24 [PROTO_5]
  SETTABLEKS R8 R7 K25 ["isFixedKeypointSelected"]
  DUPCLOSURE R8 K26 [PROTO_6]
  CAPTURE VAL R3
  SETTABLEKS R8 R7 K27 ["select"]
  DUPCLOSURE R8 K28 [PROTO_7]
  SETTABLEKS R8 R7 K29 ["selectedKeypoint"]
  RETURN R7 1
