PROTO_0:
        0 GETUPVAL                         R0 0
        1 GETUPVAL                         R2 1
        2 GETTABLEKS                       R1 R2 K0 ["tweenInfoToString"]
        4 GETUPVAL                         R3 2
...
PROTO_2:
        0 GETUPVAL                         R3 0
        1 GETTABLEKS                       R2 R3 K0 ["parseTweenInfoString"]
        3 MOVE                             R3 R0
        4 CALL                             R2 1 1
        5 JUMPIFNOTEQKNIL                  R2 ; [+11]
        7 GETUPVAL                         R3 1
        8 GETUPVAL                         R5 0
        9 GETTABLEKS                       R4 R5 K1 ["tweenInfoToString"]
       11 GETUPVAL                         R6 2
       ...
       17 GETUPVAL                         R3 1
       18 GETUPVAL                         R5 0
       19 GETTABLEKS                       R4 R5 K1 ["tweenInfoToString"]
       21 MOVE                             R5 R2
       22 CALL                             R4 1 -1
       23 CALL                             R3 -1 0
       24 GETUPVAL                         R4 2
       25 GETTABLEKS                       R3 R4 K3 ["OnChanged"]
       27 MOVE                             R4 R2
       28 CALL                             R3 1 0
       29 RETURN                           R0 0
...
PROTO_3:
        0 GETUPVAL                         R1 0
        1 GETUPVAL                         R3 1
        2 GETTABLEKS                       R2 R3 K0 ["tweenInfoToString"]
        4 GETTABLEKS                       R3 R0 K1 ["Value"]
        6 CALL                             R2 1 -1
        7 CALL                             R1 -1 2
        8 GETUPVAL                         R4 1
        9 GETTABLEKS                       R3 R4 K2 ["parseTweenInfoString"]
       11 MOVE                             R4 R1
       12 CALL                             R3 1 1
       ...
       54 GETUPVAL                         R12 4
       55 GETTABLEKS                       R11 R12 K4 ["createElement"]
       57 GETUPVAL                         R12 6
       58 NEWTABLE                         R13 8 0
...
MAIN:
       ...
       35 GETTABLEKS                       R7 R8 K13 ["TextInput"]
       37 GETIMPORT                        R8 K4 [require]
       39 GETTABLEKS                       R11 R0 K14 ["Src"]
       41 GETTABLEKS                       R10 R11 K15 ["Util"]
       43 GETTABLEKS                       R9 R10 K16 ["TransitionParamUtil"]
       45 CALL                             R8 1 1
       46 GETIMPORT                        R9 K4 [require]
       48 GETTABLEKS                       R11 R0 K14 ["Src"]
       50 GETTABLEKS                       R10 R11 K17 ["Types"]
       52 CALL                             R9 1 1
       53 GETIMPORT                        R10 K4 [require]
       55 GETTABLEKS                       R13 R0 K14 ["Src"]
       57 GETTABLEKS                       R12 R13 K18 ["Renderers"]
       59 GETTABLEKS                       R11 R12 K19 ["RendererTypes"]
       61 CALL                             R10 1 1
