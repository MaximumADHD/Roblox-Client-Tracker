...
PROTO_1:
  ...
  JUMP [+18]
  GETUPVAL R0 1
  NAMECALL R0 R0 K10 ["GetStyleRules"]
  CALL R0 1 1
  GETUPVAL R1 2
  LENGTH R3 R0
  LOADN R4 0
  ...
  LENGTH R5 R0
  GETTABLE R4 R0 R5
  GETTABLEKS R3 R4 K9 ["Priority"]
  ADDK R2 R3 K11 [1]
  JUMP [+1]
  LOADN R2 1
  SETTABLEKS R2 R1 K9 ["Priority"]
  GETUPVAL R0 2
  GETUPVAL R1 1
  SETTABLEKS R1 R0 K12 ["Parent"]
  GETIMPORT R0 K16 [Enum.FinishRecordingOperation.Commit]
  RETURN R0 1
...
MAIN:
  ...
  GETTABLEKS R8 R9 K17 ["getFFlagStyleEditorTagsPriority"]
  CALL R7 1 1
  CALL R7 0 1
