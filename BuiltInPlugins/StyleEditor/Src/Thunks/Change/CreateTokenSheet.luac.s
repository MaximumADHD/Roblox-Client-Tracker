PROTO_0:
       ...
       22 LOADK                            R4 K7 ["Tokens"]
       23 NAMECALL                         R1 R1 K8 ["SetAttribute"]
       25 CALL                             R1 3 0
       26 GETUPVAL                         R1 3
       27 GETTABLEKS                       R1 R1 K9 ["setAsToken"]
       29 GETUPVAL                         R2 0
       30 GETUPVAL                         R3 2
       31 GETUPVAL                         R4 1
       32 CALL                             R1 3 0
       33 GETIMPORT                        R1 K13 [Enum.FinishRecordingOperation.Commit]
       35 RETURN                           R1 1
...
PROTO_1:
       ...
       15 DUPTABLE                         R7 K10 [{["Name"] = "StyleEditor/CreateTokenSheet", ["DisplayName"] = "StyleEditor - Create Token Sheet", ["DoChange"]}]
       16 NEWCLOSURE                       R8 P0
       17 CAPTURE                          REF R4
       18 CAPTURE                          VAL R3
       19 CAPTURE                          VAL R5
       20 CAPTURE                          UPVAL U0
       21 SETTABLEKS                       R8 R7 K9 ["DoChange"]
       23 CALL                             R6 1 0
       24 JUMPIFNOT                        R4 ; [+11]
       25 GETUPVAL                         R6 1
       26 GETTABLEKS                       R6 R6 K11 ["createItemId"]
       28 MOVE                             R7 R4
       29 CALL                             R6 1 1
       30 GETUPVAL                         R9 2
       31 MOVE                             R10 R6
       32 CALL                             R9 1 -1
       33 NAMECALL                         R7 R0 K12 ["dispatch"]
       35 CALL                             R7 -1 0
       36 CLOSEUPVALS                      R4
       37 RETURN                           R4 1
