...
MAIN:
  ...
  GETIMPORT R57 K6 [script]
  GETTABLEKS R56 R57 K72 ["buildTree"]
  CALL R55 1 1
  NEWTABLE R56 0 1
  DUPTABLE R57 K76 [{"Name", "Key", "Width"}]
  LOADK R58 K73 ["Name"]
  SETTABLEKS R58 R57 K73 ["Name"]
  LOADK R58 K73 ["Name"]
  SETTABLEKS R58 R57 K74 ["Key"]
  GETIMPORT R58 K79 [UDim.new]
  LOADN R59 1
  LOADN R60 0
  CALL R58 2 1
  SETTABLEKS R58 R57 K75 ["Width"]
  SETLIST R56 R57 1 [1]
  GETTABLEKS R58 R32 K80 ["EditTree"]
  GETTABLEKS R57 R58 K78 ["new"]
  DUPTABLE R58 K83 [{"getChildren", "getId"}]
  DUPCLOSURE R59 K84 [PROTO_0]
  SETTABLEKS R59 R58 K81 ["getChildren"]
  DUPCLOSURE R59 K85 [PROTO_1]
  SETTABLEKS R59 R58 K82 ["getId"]
  CALL R57 1 1
  GETTABLEKS R58 R3 K86 ["PureComponent"]
  LOADK R60 K87 ["MainPage"]
  NAMECALL R58 R58 K88 ["extend"]
  CALL R58 2 1
  DUPCLOSURE R59 K89 [PROTO_19]
  CAPTURE VAL R46
  CAPTURE VAL R56
  CAPTURE VAL R34
  CAPTURE VAL R11
  ...
  CAPTURE VAL R49
  CAPTURE VAL R33
  SETTABLEKS R59 R58 K90 ["init"]
  DUPCLOSURE R59 K91 [PROTO_20]
  CAPTURE VAL R39
  CAPTURE VAL R0
  CAPTURE VAL R14
  SETTABLEKS R59 R58 K92 ["didUpdate"]
  DUPCLOSURE R59 K93 [PROTO_21]
  SETTABLEKS R59 R58 K94 ["willUnmount"]
  NEWCLOSURE R59 P5
  CAPTURE VAL R47
  CAPTURE VAL R46
  CAPTURE REF R58
  CAPTURE VAL R57
  SETTABLEKS R59 R58 K95 ["applySearch"]
  ...
  CAPTURE VAL R57
  CAPTURE VAL R48
  SETTABLEKS R59 R58 K97 ["getDerivedStateFromProps"]
  NEWCLOSURE R59 P7
  CAPTURE VAL R57
  CAPTURE VAL R48
  CAPTURE REF R58
  ...
  CAPTURE VAL R50
  CAPTURE VAL R31
  SETTABLEKS R59 R58 K98 ["render"]
  MOVE R59 R9
  DUPTABLE R60 K101 [{"Localization", "Plugin"}]
  GETTABLEKS R61 R8 K99 ["Localization"]
  SETTABLEKS R61 R60 K99 ["Localization"]
  GETTABLEKS R61 R8 K100 ["Plugin"]
  SETTABLEKS R61 R60 K100 ["Plugin"]
  CALL R59 1 1
  MOVE R60 R58
  CALL R59 1 1
  MOVE R58 R59
  GETTABLEKS R59 R4 K102 ["connect"]
  DUPCLOSURE R60 K103 [PROTO_27]
  MOVE R61 R35
  CALL R59 2 1
  MOVE R60 R58
  CALL R59 1 -1
