...
PROTO_2:
  ...
  GETUPVAL R5 3
  GETTABLEKS R4 R5 K8 ["DEPRECATED_isNestedPseudoInstance"]
  MOVE R5 R1
  CALL R4 1 1
  JUMPIFNOT R4 [+7]
  GETUPVAL R4 4
...
PROTO_14:
  ...
  SETLIST R5 R6 3 [1]
  GETUPVAL R6 1
  NAMECALL R7 R0 K9 ["GetDescendants"]
  CALL R7 1 1
  NEWCLOSURE R8 P0
  CAPTURE UPVAL U2
  CAPTURE VAL R4
...
MAIN:
  ...
  GETTABLEKS R6 R7 K16 ["getEngineFeatureNestedPseudoInstance"]
  CALL R5 1 1
  CALL R5 0 1
  ...
  GETTABLEKS R10 R11 K21 ["ModernIcons"]
  CALL R9 1 1
  GETIMPORT R10 K8 [require]
  GETTABLEKS R13 R1 K13 ["Src"]
  GETTABLEKS R12 R13 K11 ["Util"]
  GETTABLEKS R11 R12 K22 ["SelectorHelpers"]
  CALL R10 1 1
  GETIMPORT R11 K8 [require]
  GETTABLEKS R14 R1 K13 ["Src"]
  GETTABLEKS R13 R14 K11 ["Util"]
  GETTABLEKS R12 R13 K23 ["StyleRuleHelpers"]
  CALL R11 1 1
  GETIMPORT R12 K8 [require]
  GETTABLEKS R15 R1 K13 ["Src"]
  GETTABLEKS R14 R15 K11 ["Util"]
  GETTABLEKS R13 R14 K24 ["TreeTableHelpers"]
  CALL R12 1 1
  GETIMPORT R13 K8 [require]
  GETTABLEKS R15 R1 K9 ["Packages"]
  GETTABLEKS R14 R15 K25 ["Dash"]
  CALL R13 1 1
  GETTABLEKS R14 R13 K26 ["collectArray"]
  GETTABLEKS R15 R13 K27 ["forEach"]
  GETTABLEKS R16 R13 K28 ["join"]
  GETTABLEKS R17 R13 K29 ["map"]
  GETTABLEKS R18 R13 K30 ["startsWith"]
  GETIMPORT R19 K33 [table.insert]
  GETIMPORT R20 K8 [require]
  GETTABLEKS R23 R1 K13 ["Src"]
  GETTABLEKS R22 R23 K20 ["Resources"]
  ...
  LOADK R26 K38 ["Name"]
  SETTABLEKS R26 R25 K38 ["Name"]
  LOADK R26 K38 ["Name"]
  SETTABLEKS R26 R25 K39 ["Key"]
  ...
  SETLIST R24 R25 1 [1]
  SETTABLEKS R24 R23 K45 ["Columns"]
  GETTABLEKS R24 R3 K43 ["new"]
  DUPTABLE R25 K48 [{"getChildren", "getId"}]
  DUPCLOSURE R26 K49 [PROTO_0]
  SETTABLEKS R26 R25 K46 ["getChildren"]
  DUPCLOSURE R26 K50 [PROTO_1]
  SETTABLEKS R26 R25 K47 ["getId"]
  CALL R24 1 1
  SETTABLEKS R24 R23 K12 ["EditTree"]
  ...
  CAPTURE VAL R16
  CAPTURE VAL R21
  SETTABLEKS R28 R23 K55 ["buildTree"]
  DUPCLOSURE R28 K56 [PROTO_19]
  CAPTURE VAL R0
  CAPTURE VAL R9
  CAPTURE VAL R15
  CAPTURE VAL R18
  ...
  CAPTURE VAL R16
  CAPTURE VAL R21
  SETTABLEKS R28 R23 K57 ["DEPRECATED_buildTree"]
  RETURN R23 1
