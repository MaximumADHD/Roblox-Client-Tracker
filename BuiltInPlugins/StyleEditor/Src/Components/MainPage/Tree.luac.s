...
MAIN:
  ...
  CALL R2 1 1
  GETTABLEKS R4 R2 K11 ["SharedFlags"]
  GETTABLEKS R3 R4 K12 ["getFFlagDevFrameworkMoveEditTree"]
  CALL R3 0 1
  JUMPIFNOT R3 [+5]
  GETTABLEKS R5 R2 K13 ["Util"]
  GETTABLEKS R4 R5 K14 ["EditTree"]
  JUMP [+6]
  GETTABLEKS R6 R2 K15 ["UI"]
  GETTABLEKS R5 R6 K16 ["TreeTable"]
  GETTABLEKS R4 R5 K14 ["EditTree"]
  GETIMPORT R5 K8 [require]
  GETTABLEKS R8 R1 K17 ["Src"]
  GETTABLEKS R7 R8 K18 ["Flags"]
  GETTABLEKS R6 R7 K19 ["getFFlagStyleEditorQueries"]
  CALL R5 1 1
  CALL R5 0 1
  GETIMPORT R6 K8 [require]
  GETTABLEKS R9 R1 K17 ["Src"]
  GETTABLEKS R8 R9 K13 ["Util"]
  GETTABLEKS R7 R8 K20 ["DesignHelpers"]
  CALL R6 1 1
  GETIMPORT R7 K8 [require]
  GETTABLEKS R10 R1 K17 ["Src"]
  GETTABLEKS R9 R10 K13 ["Util"]
  GETTABLEKS R8 R9 K21 ["MenuHelpers"]
  CALL R7 1 1
  GETIMPORT R8 K8 [require]
  GETTABLEKS R11 R1 K17 ["Src"]
  GETTABLEKS R10 R11 K13 ["Util"]
  GETTABLEKS R9 R10 K22 ["StyleSchema"]
  CALL R8 1 1
  GETIMPORT R9 K8 [require]
  GETTABLEKS R12 R1 K17 ["Src"]
  GETTABLEKS R11 R12 K23 ["Resources"]
  GETTABLEKS R10 R11 K24 ["ModernIcons"]
  CALL R9 1 1
  GETIMPORT R10 K8 [require]
  GETTABLEKS R13 R1 K17 ["Src"]
  GETTABLEKS R12 R13 K13 ["Util"]
  GETTABLEKS R11 R12 K25 ["SelectorHelpers"]
  CALL R10 1 1
  GETIMPORT R11 K8 [require]
  GETTABLEKS R14 R1 K17 ["Src"]
  GETTABLEKS R13 R14 K13 ["Util"]
  GETTABLEKS R12 R13 K26 ["StyleRuleHelpers"]
  CALL R11 1 1
  GETIMPORT R12 K8 [require]
  GETTABLEKS R15 R1 K17 ["Src"]
  GETTABLEKS R14 R15 K13 ["Util"]
  GETTABLEKS R13 R14 K27 ["TreeTableHelpers"]
  CALL R12 1 1
  GETIMPORT R13 K8 [require]
  GETTABLEKS R15 R1 K9 ["Packages"]
  GETTABLEKS R14 R15 K28 ["Dash"]
  CALL R13 1 1
  GETTABLEKS R14 R13 K29 ["collectArray"]
  GETTABLEKS R15 R13 K30 ["forEach"]
  GETTABLEKS R16 R13 K31 ["join"]
  GETTABLEKS R17 R13 K32 ["map"]
  GETTABLEKS R18 R13 K33 ["startsWith"]
  GETIMPORT R19 K36 [table.insert]
  GETIMPORT R20 K8 [require]
  GETTABLEKS R23 R1 K17 ["Src"]
  GETTABLEKS R22 R23 K23 ["Resources"]
  GETTABLEKS R21 R22 K37 ["PluginStyles"]
  CALL R20 1 1
  LOADK R23 K38 ["Icon16"]
  NAMECALL R21 R20 K39 ["GetAttribute"]
  CALL R21 2 1
  GETIMPORT R22 K8 [require]
  GETTABLEKS R24 R1 K17 ["Src"]
  GETTABLEKS R23 R24 K40 ["Types"]
  CALL R22 1 1
  NEWTABLE R23 4 0
  NEWTABLE R24 0 1
  DUPTABLE R25 K44 [{"Name", "Key", "Width"}]
  LOADK R26 K41 ["Name"]
  SETTABLEKS R26 R25 K41 ["Name"]
  LOADK R26 K41 ["Name"]
  SETTABLEKS R26 R25 K42 ["Key"]
  GETIMPORT R26 K47 [UDim.new]
  LOADN R27 1
  LOADN R28 0
  CALL R26 2 1
  SETTABLEKS R26 R25 K43 ["Width"]
  SETLIST R24 R25 1 [1]
  SETTABLEKS R24 R23 K48 ["Columns"]
  GETTABLEKS R24 R4 K46 ["new"]
  DUPTABLE R25 K51 [{"getChildren", "getId"}]
  DUPCLOSURE R26 K52 [PROTO_0]
  SETTABLEKS R26 R25 K49 ["getChildren"]
  DUPCLOSURE R26 K53 [PROTO_1]
  SETTABLEKS R26 R25 K50 ["getId"]
  CALL R24 1 1
  SETTABLEKS R24 R23 K14 ["EditTree"]
  DUPCLOSURE R25 K54 [PROTO_3]
  CAPTURE VAL R14
  CAPTURE VAL R11
  CAPTURE VAL R8
  CAPTURE VAL R16
  ...
  CAPTURE VAL R16
  CAPTURE VAL R21
  SETTABLEKS R28 R23 K58 ["buildTree"]
  RETURN R23 1
