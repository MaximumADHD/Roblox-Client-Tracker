...
MAIN:
  ...
  GETTABLEKS R28 R29 K44 ["getFFlagStyleEditorPreviewParentSize"]
  CALL R27 1 1
  CALL R27 0 1
  GETIMPORT R28 K12 [require]
  GETTABLEKS R31 R5 K25 ["Src"]
  GETTABLEKS R30 R31 K37 ["Flags"]
  GETTABLEKS R29 R30 K45 ["getFFlagStyleEditorNewRuleRenameFix"]
  CALL R28 1 1
  CALL R28 0 1
  GETIMPORT R29 K12 [require]
  GETTABLEKS R32 R5 K25 ["Src"]
  GETTABLEKS R31 R32 K46 ["Enums"]
  GETTABLEKS R30 R31 K47 ["ActionClickedEventType"]
  CALL R29 1 1
  GETIMPORT R30 K12 [require]
  GETTABLEKS R33 R5 K25 ["Src"]
  GETTABLEKS R32 R33 K46 ["Enums"]
  GETTABLEKS R31 R32 K48 ["InstancesHaveVariant"]
  CALL R30 1 1
  GETIMPORT R31 K12 [require]
  GETTABLEKS R34 R5 K25 ["Src"]
  GETTABLEKS R33 R34 K49 ["Util"]
  GETTABLEKS R32 R33 K50 ["mapDispatchToProps"]
  CALL R31 1 1
  GETIMPORT R32 K12 [require]
  GETTABLEKS R35 R5 K25 ["Src"]
  GETTABLEKS R34 R35 K32 ["Resources"]
  GETTABLEKS R33 R34 K51 ["PluginStyles"]
  CALL R32 1 1
  GETIMPORT R33 K12 [require]
  GETTABLEKS R36 R5 K25 ["Src"]
  GETTABLEKS R35 R36 K49 ["Util"]
  GETTABLEKS R34 R35 K52 ["recordChange"]
  CALL R33 1 1
  MOVE R34 R0
  CALL R33 1 1
  GETIMPORT R34 K12 [require]
  GETTABLEKS R37 R5 K25 ["Src"]
  GETTABLEKS R36 R37 K49 ["Util"]
  GETTABLEKS R35 R36 K53 ["SelectorHelpers"]
  CALL R34 1 1
  GETIMPORT R35 K12 [require]
  GETTABLEKS R38 R5 K25 ["Src"]
  GETTABLEKS R37 R38 K49 ["Util"]
  GETTABLEKS R36 R37 K23 ["Styling"]
  CALL R35 1 1
  GETIMPORT R36 K12 [require]
  GETTABLEKS R39 R5 K25 ["Src"]
  GETTABLEKS R38 R39 K54 ["Components"]
  GETTABLEKS R37 R38 K55 ["SelectorPropertyTable"]
  CALL R36 1 1
  GETIMPORT R37 K12 [require]
  GETTABLEKS R40 R5 K25 ["Src"]
  GETTABLEKS R39 R40 K54 ["Components"]
  GETTABLEKS R38 R39 K56 ["StyleRulePreview"]
  CALL R37 1 1
  GETIMPORT R38 K59 [UDim2.fromOffset]
  LOADN R39 200
  LOADN R40 100
  CALL R38 2 1
  LOADK R41 K60 ["Padding"]
  NAMECALL R39 R32 K61 ["GetAttribute"]
  CALL R39 2 1
  GETTABLEKS R40 R6 K62 ["PureComponent"]
  LOADK R42 K63 ["StyleRuleView"]
  NAMECALL R40 R40 K64 ["extend"]
  CALL R40 2 1
  NEWCLOSURE R41 P0
  CAPTURE VAL R6
  CAPTURE REF R40
  ...
  CAPTURE VAL R26
  CAPTURE VAL R28
  SETTABLEKS R41 R40 K65 ["init"]
  DUPCLOSURE R41 K66 [PROTO_19]
  SETTABLEKS R41 R40 K67 ["createPreviewInstanceFromSelectorLink"]
  NEWCLOSURE R41 P2
  CAPTURE VAL R6
  CAPTURE VAL R4
  CAPTURE VAL R25
  CAPTURE REF R40
  CAPTURE VAL R27
  SETTABLEKS R41 R40 K68 ["getPreview"]
  NEWCLOSURE R41 P3
  CAPTURE VAL R28
  CAPTURE REF R40
  CAPTURE VAL R6
  ...
  DUPCLOSURE R41 K70 [PROTO_24]
  SETTABLEKS R41 R40 K71 ["didUpdate"]
  DUPCLOSURE R41 K72 [PROTO_25]
  CAPTURE VAL R3
  SETTABLEKS R41 R40 K73 ["didMount"]
  DUPCLOSURE R41 K74 [PROTO_26]
  SETTABLEKS R41 R40 K75 ["willUnmount"]
  DUPCLOSURE R41 K76 [PROTO_27]
  CAPTURE VAL R30
  CAPTURE VAL R6
  CAPTURE VAL R14
  CAPTURE VAL R34
  ...
  CAPTURE VAL R37
  CAPTURE VAL R36
  SETTABLEKS R41 R40 K77 ["render"]
  MOVE R41 R10
  DUPTABLE R42 K78 [{"Localization"}]
  SETTABLEKS R11 R42 K19 ["Localization"]
  CALL R41 1 1
  MOVE R42 R40
  CALL R41 1 1
  MOVE R40 R41
  GETTABLEKS R41 R7 K79 ["connect"]
  DUPCLOSURE R42 K80 [PROTO_28]
  CAPTURE VAL R28
  MOVE R43 R31
  CALL R41 2 1
  MOVE R42 R40
