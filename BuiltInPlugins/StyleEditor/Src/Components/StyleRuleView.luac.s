...
PROTO_9:
  ...
  GETTABLEKS R2 R1 K2 ["hasVariant"]
  GETUPVAL R4 1
  ...
  RETURN R0 0
  GETUPVAL R4 2
  GETTABLEKS R3 R4 K13 ["getSelectorChain"]
  MOVE R4 R2
  CALL R3 1 1
  GETUPVAL R4 3
  DUPTABLE R5 K17 [{"Name", "DisplayName", "DoChange"}]
  LOADK R6 K18 ["StyleEditor.ApplyTags"]
  SETTABLEKS R6 R5 K14 ["Name"]
  LOADK R6 K19 ["StyleEditor - Apply Tag(s)"]
  SETTABLEKS R6 R5 K15 ["DisplayName"]
  NEWCLOSURE R6 P0
  CAPTURE VAL R1
  CAPTURE VAL R3
  CAPTURE UPVAL U1
  ...
  CAPTURE VAL R2
  CAPTURE UPVAL U4
  SETTABLEKS R6 R5 K16 ["DoChange"]
  CALL R4 1 0
  GETUPVAL R4 0
  DUPTABLE R6 K20 [{"hasVariant"}]
  GETTABLEKS R8 R1 K2 ["hasVariant"]
  GETUPVAL R10 1
...
MAIN:
  ...
  GETTABLEKS R24 R25 K38 ["PluginStyles"]
  CALL R23 1 1
  LOADK R26 K39 ["ButtonHeight"]
  NAMECALL R24 R23 K40 ["GetAttribute"]
  CALL R24 2 1
  LOADK R27 K41 ["PaddingSm"]
  NAMECALL R25 R23 K40 ["GetAttribute"]
  CALL R25 2 1
  LOADK R28 K42 ["Spacing"]
  NAMECALL R26 R23 K40 ["GetAttribute"]
  CALL R26 2 1
  LOADK R29 K43 ["TitleTextSize"]
  NAMECALL R27 R23 K40 ["GetAttribute"]
  CALL R27 2 1
  GETTABLEKS R28 R6 K44 ["PureComponent"]
  LOADK R30 K45 ["StyleRuleView"]
  ...
  CAPTURE VAL R27
  CAPTURE VAL R24
  SETTABLEKS R29 R28 K49 ["estimateScrollHeight"]
  DUPCLOSURE R29 K50 [PROTO_14]
  SETTABLEKS R29 R28 K51 ["createPreviewInstanceFromSelectorLink"]
  NEWCLOSURE R29 P3
  CAPTURE VAL R4
  CAPTURE REF R28
  SETTABLEKS R29 R28 K52 ["isVisible"]
  NEWCLOSURE R29 P4
  CAPTURE VAL R6
  CAPTURE VAL R4
  CAPTURE REF R28
  SETTABLEKS R29 R28 K53 ["getPreview"]
  NEWCLOSURE R29 P5
  CAPTURE REF R28
  CAPTURE VAL R6
  CAPTURE VAL R19
  SETTABLEKS R29 R28 K54 ["getDerivedStateFromProps"]
  DUPCLOSURE R29 K55 [PROTO_21]
  SETTABLEKS R29 R28 K56 ["didUpdate"]
  DUPCLOSURE R29 K57 [PROTO_22]
  CAPTURE VAL R3
  SETTABLEKS R29 R28 K58 ["didMount"]
  DUPCLOSURE R29 K59 [PROTO_23]
  SETTABLEKS R29 R28 K60 ["willUnmount"]
  DUPCLOSURE R29 K61 [PROTO_24]
  CAPTURE VAL R18
  CAPTURE VAL R6
  CAPTURE VAL R14
  CAPTURE VAL R19
  ...
  CAPTURE VAL R21
  CAPTURE VAL R20
  SETTABLEKS R29 R28 K62 ["render"]
  MOVE R29 R10
  DUPTABLE R30 K63 [{"Localization"}]
  SETTABLEKS R11 R30 K19 ["Localization"]
  CALL R29 1 1
  MOVE R30 R28
  CALL R29 1 1
  MOVE R28 R29
  GETTABLEKS R29 R7 K64 ["connect"]
  DUPCLOSURE R30 K65 [PROTO_25]
  CALL R29 1 1
  MOVE R30 R28
  CALL R29 1 -1
  CLOSEUPVALS R28
