...
MAIN:
  ...
  GETTABLEKS R24 R25 K39 ["getFFlagStyleEditorPreviewParentSize"]
  CALL R23 1 1
  CALL R23 0 1
  GETIMPORT R24 K12 [require]
  GETTABLEKS R27 R5 K25 ["Src"]
  GETTABLEKS R26 R27 K36 ["Flags"]
  GETTABLEKS R25 R26 K40 ["getFFlagStyleEditorNewRuleRenameFix"]
  CALL R24 1 1
  CALL R24 0 1
  GETIMPORT R25 K12 [require]
  GETTABLEKS R28 R5 K25 ["Src"]
  GETTABLEKS R27 R28 K36 ["Flags"]
  GETTABLEKS R26 R27 K41 ["getFFlagStyleEditorShowPseudoPreview"]
  CALL R25 1 1
  CALL R25 0 1
  GETIMPORT R26 K12 [require]
  GETTABLEKS R29 R5 K25 ["Src"]
  GETTABLEKS R28 R29 K42 ["Enums"]
  GETTABLEKS R27 R28 K43 ["ActionClickedEventType"]
  CALL R26 1 1
  GETIMPORT R27 K12 [require]
  GETTABLEKS R30 R5 K25 ["Src"]
  GETTABLEKS R29 R30 K42 ["Enums"]
  GETTABLEKS R28 R29 K44 ["InstancesHaveVariant"]
  CALL R27 1 1
  GETIMPORT R28 K12 [require]
  GETTABLEKS R31 R5 K25 ["Src"]
  GETTABLEKS R30 R31 K45 ["Util"]
  GETTABLEKS R29 R30 K46 ["mapDispatchToProps"]
  CALL R28 1 1
  GETIMPORT R29 K12 [require]
  GETTABLEKS R32 R5 K25 ["Src"]
  GETTABLEKS R31 R32 K29 ["Resources"]
  GETTABLEKS R30 R31 K47 ["PluginStyles"]
  CALL R29 1 1
  GETIMPORT R30 K12 [require]
  GETTABLEKS R33 R5 K25 ["Src"]
  GETTABLEKS R32 R33 K45 ["Util"]
  GETTABLEKS R31 R32 K48 ["recordChange"]
  CALL R30 1 1
  MOVE R31 R0
  CALL R30 1 1
  GETIMPORT R31 K12 [require]
  GETTABLEKS R34 R5 K25 ["Src"]
  GETTABLEKS R33 R34 K45 ["Util"]
  GETTABLEKS R32 R33 K49 ["SelectorHelpers"]
  CALL R31 1 1
  ...
  GETTABLEKS R35 R36 K50 ["Components"]
  GETTABLEKS R34 R35 K51 ["SelectorPropertyTable"]
  CALL R33 1 1
  GETIMPORT R34 K12 [require]
  GETTABLEKS R37 R5 K25 ["Src"]
  GETTABLEKS R36 R37 K50 ["Components"]
  GETTABLEKS R35 R36 K52 ["StyleRulePreview"]
  CALL R34 1 1
  GETIMPORT R35 K55 [UDim2.fromOffset]
  LOADN R36 200
  LOADN R37 100
  CALL R35 2 1
  LOADK R38 K56 ["Padding"]
  NAMECALL R36 R29 K57 ["GetAttribute"]
  CALL R36 2 1
  GETTABLEKS R37 R6 K58 ["PureComponent"]
  LOADK R39 K59 ["StyleRuleView"]
  NAMECALL R37 R37 K60 ["extend"]
  CALL R37 2 1
  NEWCLOSURE R38 P0
  CAPTURE VAL R6
  CAPTURE REF R37
  ...
  CAPTURE VAL R20
  CAPTURE VAL R24
  SETTABLEKS R38 R37 K61 ["init"]
  DUPCLOSURE R38 K62 [PROTO_19]
  SETTABLEKS R38 R37 K63 ["createPreviewInstanceFromSelectorLink"]
  NEWCLOSURE R38 P2
  CAPTURE VAL R6
  CAPTURE VAL R4
  CAPTURE VAL R22
  ...
  CAPTURE VAL R25
  CAPTURE VAL R23
  SETTABLEKS R38 R37 K64 ["getPreview"]
  NEWCLOSURE R38 P3
  CAPTURE VAL R24
  CAPTURE REF R37
  CAPTURE VAL R6
  CAPTURE VAL R31
  SETTABLEKS R38 R37 K65 ["getDerivedStateFromProps"]
  DUPCLOSURE R38 K66 [PROTO_25]
  SETTABLEKS R38 R37 K67 ["didUpdate"]
  DUPCLOSURE R38 K68 [PROTO_26]
  CAPTURE VAL R3
  SETTABLEKS R38 R37 K69 ["didMount"]
  DUPCLOSURE R38 K70 [PROTO_27]
  SETTABLEKS R38 R37 K71 ["willUnmount"]
  DUPCLOSURE R38 K72 [PROTO_28]
  CAPTURE VAL R27
  CAPTURE VAL R6
  CAPTURE VAL R14
  CAPTURE VAL R31
  ...
  MOVE R38 R10
  DUPTABLE R39 K74 [{"Localization"}]
  SETTABLEKS R11 R39 K19 ["Localization"]
  CALL R38 1 1
  MOVE R39 R37
  CALL R38 1 1
  MOVE R37 R38
  GETTABLEKS R38 R7 K75 ["connect"]
  DUPCLOSURE R39 K76 [PROTO_29]
  CAPTURE VAL R24
  MOVE R40 R28
  CALL R38 2 1
  MOVE R39 R37
