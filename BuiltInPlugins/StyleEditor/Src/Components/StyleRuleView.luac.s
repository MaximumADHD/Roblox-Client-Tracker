...
MAIN:
  ...
  GETTABLEKS R28 R29 K43 ["Enums"]
  GETTABLEKS R27 R28 K44 ["ActionClickedEventType"]
  CALL R26 1 1
  GETIMPORT R27 K12 [require]
  GETTABLEKS R30 R5 K25 ["Src"]
  GETTABLEKS R29 R30 K43 ["Enums"]
  GETTABLEKS R28 R29 K45 ["InstancesHaveVariant"]
  CALL R27 1 1
  GETIMPORT R28 K12 [require]
  GETTABLEKS R31 R5 K25 ["Src"]
  GETTABLEKS R30 R31 K46 ["Util"]
  GETTABLEKS R29 R30 K47 ["mapDispatchToProps"]
  CALL R28 1 1
  GETIMPORT R29 K12 [require]
  GETTABLEKS R32 R5 K25 ["Src"]
  GETTABLEKS R31 R32 K46 ["Util"]
  GETTABLEKS R30 R31 K48 ["recordChange"]
  CALL R29 1 1
  MOVE R30 R0
  CALL R29 1 1
  GETIMPORT R30 K12 [require]
  GETTABLEKS R33 R5 K25 ["Src"]
  GETTABLEKS R32 R33 K46 ["Util"]
  GETTABLEKS R31 R32 K49 ["SelectorHelpers"]
  CALL R30 1 1
  GETIMPORT R31 K12 [require]
  GETTABLEKS R34 R5 K25 ["Src"]
  GETTABLEKS R33 R34 K46 ["Util"]
  GETTABLEKS R32 R33 K23 ["Styling"]
  CALL R31 1 1
  GETIMPORT R32 K12 [require]
  GETTABLEKS R35 R5 K25 ["Src"]
  GETTABLEKS R34 R35 K50 ["Components"]
  GETTABLEKS R33 R34 K51 ["SelectorPropertyTable"]
  CALL R32 1 1
  GETIMPORT R33 K12 [require]
  GETTABLEKS R36 R5 K25 ["Src"]
  GETTABLEKS R35 R36 K50 ["Components"]
  GETTABLEKS R34 R35 K52 ["StyleRulePreview"]
  CALL R33 1 1
  GETIMPORT R34 K55 [UDim2.fromOffset]
  LOADN R35 200
  LOADN R36 100
  CALL R34 2 1
  GETTABLEKS R35 R6 K56 ["PureComponent"]
  LOADK R37 K57 ["StyleRuleView"]
  NAMECALL R35 R35 K58 ["extend"]
  CALL R35 2 1
  NEWCLOSURE R36 P0
  CAPTURE VAL R6
  CAPTURE REF R35
  ...
  CAPTURE VAL R23
  CAPTURE VAL R34
  SETTABLEKS R36 R35 K59 ["init"]
  DUPCLOSURE R36 K60 [PROTO_17]
  SETTABLEKS R36 R35 K61 ["createPreviewInstanceFromSelectorLink"]
  NEWCLOSURE R36 P2
  CAPTURE VAL R6
  CAPTURE VAL R4
  CAPTURE VAL R25
  CAPTURE REF R35
  SETTABLEKS R36 R35 K62 ["getPreview"]
  NEWCLOSURE R36 P3
  CAPTURE REF R35
  CAPTURE VAL R6
  CAPTURE VAL R30
  SETTABLEKS R36 R35 K63 ["getDerivedStateFromProps"]
  DUPCLOSURE R36 K64 [PROTO_22]
  SETTABLEKS R36 R35 K65 ["didUpdate"]
  DUPCLOSURE R36 K66 [PROTO_23]
  CAPTURE VAL R3
  SETTABLEKS R36 R35 K67 ["didMount"]
  DUPCLOSURE R36 K68 [PROTO_24]
  SETTABLEKS R36 R35 K69 ["willUnmount"]
  DUPCLOSURE R36 K70 [PROTO_25]
  CAPTURE VAL R27
  CAPTURE VAL R6
  CAPTURE VAL R14
  CAPTURE VAL R30
  ...
  CAPTURE VAL R33
  CAPTURE VAL R32
  SETTABLEKS R36 R35 K71 ["render"]
  MOVE R36 R10
  DUPTABLE R37 K72 [{"Localization"}]
  SETTABLEKS R11 R37 K19 ["Localization"]
  CALL R36 1 1
  MOVE R37 R35
  CALL R36 1 1
  MOVE R35 R36
  GETTABLEKS R36 R7 K73 ["connect"]
  DUPCLOSURE R37 K74 [PROTO_26]
  MOVE R38 R28
  CALL R36 2 1
  MOVE R37 R35
  CALL R36 1 -1
