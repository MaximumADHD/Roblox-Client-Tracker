...
PROTO_23:
  ...
  CALL R14 1 1
  JUMPIFNOT R14 [+22]
  LOADK R17 K23 ["UIComponent"]
  NAMECALL R15 R14 K12 ["IsA"]
  CALL R15 2 1
  JUMPIF R15 [+17]
  LOADN R15 1
  SETTABLEKS R15 R5 K24 ["BackgroundTransparency"]
...
MAIN:
  ...
  GETTABLEKS R21 R22 K35 ["getFFlagStyleEditorStyleLinkInsertWhenNil"]
  CALL R20 1 1
  CALL R20 0 1
  GETIMPORT R21 K12 [require]
  GETTABLEKS R24 R5 K25 ["Src"]
  GETTABLEKS R23 R24 K34 ["Flags"]
  GETTABLEKS R22 R23 K36 ["getFFlagStyleEditorNewRuleRenameFix"]
  CALL R21 1 1
  CALL R21 0 1
  GETIMPORT R22 K12 [require]
  GETTABLEKS R25 R5 K25 ["Src"]
  GETTABLEKS R24 R25 K34 ["Flags"]
  GETTABLEKS R23 R24 K37 ["getFFlagStyleEditorShowPseudoPreview"]
  CALL R22 1 1
  CALL R22 0 1
  ...
  GETTABLEKS R29 R30 K45 ["SelectorHelpers"]
  CALL R28 1 1
  ...
  GETTABLEKS R32 R33 K46 ["Components"]
  GETTABLEKS R31 R32 K47 ["SelectorPropertyTable"]
  CALL R30 1 1
  GETIMPORT R31 K12 [require]
  GETTABLEKS R34 R5 K25 ["Src"]
  GETTABLEKS R33 R34 K46 ["Components"]
  GETTABLEKS R32 R33 K48 ["StyleRulePreview"]
  CALL R31 1 1
  GETIMPORT R32 K51 [UDim2.fromOffset]
  LOADN R33 200
  LOADN R34 100
  CALL R32 2 1
  LOADK R35 K52 ["Padding"]
  NAMECALL R33 R26 K53 ["GetAttribute"]
  CALL R33 2 1
  GETTABLEKS R34 R6 K54 ["PureComponent"]
  LOADK R36 K55 ["StyleRuleView"]
  NAMECALL R34 R34 K56 ["extend"]
  CALL R34 2 1
  NEWCLOSURE R35 P0
  CAPTURE VAL R6
  CAPTURE REF R34
  ...
  CAPTURE VAL R32
  CAPTURE VAL R21
  SETTABLEKS R35 R34 K57 ["init"]
  DUPCLOSURE R35 K58 [PROTO_19]
  SETTABLEKS R35 R34 K59 ["createPreviewInstanceFromSelectorLink"]
  NEWCLOSURE R35 P2
  CAPTURE VAL R6
  CAPTURE VAL R4
  CAPTURE REF R34
  CAPTURE VAL R22
  SETTABLEKS R35 R34 K60 ["getPreview"]
  NEWCLOSURE R35 P3
  CAPTURE VAL R21
  CAPTURE REF R34
  CAPTURE VAL R6
  CAPTURE VAL R28
  SETTABLEKS R35 R34 K61 ["getDerivedStateFromProps"]
  DUPCLOSURE R35 K62 [PROTO_25]
  SETTABLEKS R35 R34 K63 ["didUpdate"]
  DUPCLOSURE R35 K64 [PROTO_26]
  CAPTURE VAL R3
  SETTABLEKS R35 R34 K65 ["didMount"]
  DUPCLOSURE R35 K66 [PROTO_27]
  SETTABLEKS R35 R34 K67 ["willUnmount"]
  DUPCLOSURE R35 K68 [PROTO_28]
  CAPTURE VAL R24
  CAPTURE VAL R6
  CAPTURE VAL R14
  CAPTURE VAL R28
  ...
  MOVE R35 R10
  DUPTABLE R36 K70 [{"Localization"}]
  SETTABLEKS R11 R36 K19 ["Localization"]
  CALL R35 1 1
  MOVE R36 R34
  CALL R35 1 1
  MOVE R34 R35
  GETTABLEKS R35 R7 K71 ["connect"]
  DUPCLOSURE R36 K72 [PROTO_29]
  CAPTURE VAL R21
  MOVE R37 R25
  CALL R35 2 1
  MOVE R36 R34
