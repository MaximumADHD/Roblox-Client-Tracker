...
PROTO_5:
        ...
        3 GETUPVAL                         R3 1
        4 JUMPIFNOT                        R3 ; [+3]
        5 GETTABLEKS                       R2 R1 K1 ["ThemeSheets"]
        7 JUMP                             ; [+4]
        8 GETUPVAL                         R2 2
        9 GETTABLEKS                       R3 R0 K2 ["Themes_DEPRECATED"]
       11 CALL                             R2 1 1
       12 LOADNIL                          R3
       13 MOVE                             R4 R2
       14 LOADNIL                          R5
       ...
       24 JUMPIFNOT                        R5 ; [+5]
       25 GETUPVAL                         R4 0
       26 GETTABLEKS                       R4 R4 K3 ["findActiveThemeInFolder"]
       28 CALL                             R4 0 1
       29 JUMP                             ; [+2]
       30 GETTABLEKS                       R4 R0 K4 ["SelectedTheme"]
       32 GETTABLEKS                       R5 R1 K5 ["dispatch"]
       34 GETUPVAL                         R6 5
       35 MOVE                             R7 R3
       36 MOVE                             R8 R4
       37 CALL                             R6 2 -1
       38 CALL                             R5 -1 0
       39 DUPTABLE                         R5 K6 [{"Themes_DEPRECATED", "SelectedTheme"}]
       40 GETUPVAL                         R7 1
       41 JUMPIFNOT                        R7 ; [+2]
       42 LOADNIL                          R6
       43 JUMP                             ; [+1]
       44 MOVE                             R6 R2
       45 SETTABLEKS                       R6 R5 K2 ["Themes_DEPRECATED"]
       47 SETTABLEKS                       R3 R5 K4 ["SelectedTheme"]
       49 RETURN                           R5 1
...
PROTO_7:
        0 DUPTABLE                         R1 K3 [{[1] = , ["SelectedTheme"] = }]
        ...
        9 CAPTURE                          UPVAL U4
       10 CAPTURE                          UPVAL U5
       11 SETTABLEKS                       R1 R0 K5 ["updateThemes"]
       13 NEWCLOSURE                       R1 P1
       14 CAPTURE                          VAL R0
       15 CAPTURE                          UPVAL U2
       16 CAPTURE                          UPVAL U3
       17 CAPTURE                          UPVAL U5
       18 SETTABLEKS                       R1 R0 K6 ["findActiveThemeInFolder"]
       20 NEWCLOSURE                       R1 P2
       21 CAPTURE                          VAL R0
       22 CAPTURE                          UPVAL U0
       23 CAPTURE                          UPVAL U6
       24 CAPTURE                          UPVAL U7
       25 CAPTURE                          UPVAL U8
       26 SETTABLEKS                       R1 R0 K7 ["toggleThemes"]
       28 GETTABLEKS                       R1 R0 K5 ["updateThemes"]
       30 CALL                             R1 0 0
       31 RETURN                           R0 0

PROTO_8:
        0 GETTABLEKS                       R3 R0 K0 ["props"]
        2 GETTABLEKS                       R5 R1 K1 ["IsDirty"]
        4 GETTABLEKS                       R6 R3 K1 ["IsDirty"]
        6 JUMPIFLT                         R6 R5 ; [+2]
        8 LOADB                            R4 0 +1
        9 LOADB                            R4 1
       10 GETUPVAL                         R6 0
       ...
       12 GETUPVAL                         R5 1
       13 JUMPIFNOT                        R5 ; [+17]
       14 GETTABLEKS                       R6 R1 K2 ["ThemeSheets"]
       16 GETTABLEKS                       R7 R3 K2 ["ThemeSheets"]
       18 JUMPIFNOTEQ                      R6 R7 ; [+2]
       20 LOADB                            R5 0 +1
       21 LOADB                            R5 1
       22 JUMP                             ; [+8]
       23 GETTABLEKS                       R6 R1 K3 ["RootItem_DEPRECATED"]
       25 GETTABLEKS                       R7 R3 K3 ["RootItem_DEPRECATED"]
       27 JUMPIFNOTEQ                      R6 R7 ; [+2]
       29 LOADB                            R5 0 +1
       30 LOADB                            R5 1
       31 JUMPIF                           R4 ; [+1]
       32 JUMPIFNOT                        R5 ; [+3]
       33 GETTABLEKS                       R6 R0 K4 ["updateThemes"]
       35 CALL                             R6 0 0
       36 RETURN                           R0 0
...
MAIN:
      ...
      131 GETTABLEKS                       R25 R25 K36 ["getFFlagStyleEditorFixThemeFolderActivation"]
      133 CALL                             R24 1 1
      134 CALL                             R24 0 1
      135 GETTABLEKS                       R25 R1 K37 ["PureComponent"]
      137 LOADK                            R27 K38 ["ThemesView"]
      138 NAMECALL                         R25 R25 K39 ["extend"]
      140 CALL                             R25 2 1
      141 DUPTABLE                         R26 K43 [{["Title"] = "", ["ThemeSheets"]}]
      142 NEWTABLE                         R27 0 0
      144 SETTABLEKS                       R27 R26 K42 ["ThemeSheets"]
      146 SETTABLEKS                       R26 R25 K44 ["defaultProps"]
      148 DUPCLOSURE                       R26 K45 [PROTO_7]
      149 CAPTURE                          VAL R23
      150 CAPTURE                          VAL R8
      151 CAPTURE                          VAL R19
      152 CAPTURE                          VAL R11
      ...
      156 CAPTURE                          VAL R24
      157 CAPTURE                          VAL R22
      158 SETTABLEKS                       R26 R25 K46 ["init"]
      160 DUPCLOSURE                       R26 K47 [PROTO_8]
      161 CAPTURE                          VAL R23
      162 CAPTURE                          VAL R24
      163 SETTABLEKS                       R26 R25 K48 ["didUpdate"]
      165 DUPCLOSURE                       R26 K49 [PROTO_9]
      166 CAPTURE                          VAL R23
      167 CAPTURE                          VAL R1
      168 CAPTURE                          VAL R20
      169 CAPTURE                          VAL R16
      170 CAPTURE                          VAL R15
      171 CAPTURE                          VAL R14
      172 SETTABLEKS                       R26 R25 K50 ["render"]
      174 MOVE                             R26 R5
      175 DUPTABLE                         R27 K51 [{"Localization"}]
      176 SETTABLEKS                       R6 R27 K11 ["Localization"]
      178 CALL                             R26 1 1
      179 MOVE                             R27 R25
      180 CALL                             R26 1 1
      181 MOVE                             R25 R26
      182 GETTABLEKS                       R26 R2 K52 ["connect"]
      184 DUPCLOSURE                       R27 K53 [PROTO_10]
      185 MOVE                             R28 R21
      186 CALL                             R26 2 1
      187 MOVE                             R27 R25
      188 CALL                             R26 1 -1
