...
PROTO_11:
  ...
  CALL R6 1 0
  RETURN R0 0
  GETTABLEKS R7 R5 K16 ["SetParentValue"]
  FASTCALL1 TYPEOF R7 [+2]
  GETIMPORT R6 K18 [typeof]
  CALL R6 1 1
  JUMPIFNOTEQKS R6 K19 ["function"] [+6]
  GETTABLEKS R6 R5 K16 ["SetParentValue"]
  MOVE R7 R0
  CALL R6 1 0
  RETURN R0 0
  GETUPVAL R6 1
  GETTABLEKS R9 R4 K2 ["table"]
  GETTABLEKS R8 R9 K3 ["Items"]
  MOVE R9 R5
  NAMECALL R6 R6 K20 ["getParent"]
  CALL R6 3 1
  GETTABLEKS R7 R6 K7 ["Instance"]
  JUMPIF R7 [+6]
  GETIMPORT R8 K9 [warn]
  LOADK R9 K10 ["Table row without valid StyleRule reference:"]
  MOVE R10 R6
  CALL R8 2 0
  RETURN R0 0
  GETUPVAL R9 6
  GETTABLEKS R8 R9 K21 ["NAME_COLUMN_INDEX"]
  ...
  RETURN R0 0
  GETUPVAL R9 6
  GETTABLEKS R8 R9 K22 ["VALUE_COLUMN_INDEX"]
