...
MAIN:
  ...
  DUPTABLE R20 K27 [{"Name", "Key", "Width"}]
  LOADK R21 K32 ["Value"]
  SETTABLEKS R21 R20 K24 ["Name"]
  LOADK R21 K32 ["Value"]
  SETTABLEKS R21 R20 K25 ["Key"]
  GETIMPORT R21 K30 [UDim.new]
  LOADK R22 K31 [0.5]
  LOADN R23 0
  CALL R21 2 1
  SETTABLEKS R21 R20 K26 ["Width"]
  SETLIST R18 R19 2 [1]
  SETTABLEKS R18 R17 K33 ["Columns"]
  LOADN R18 1
  SETTABLEKS R18 R17 K34 ["NAME_COLUMN_INDEX"]
  LOADN R18 2
  SETTABLEKS R18 R17 K35 ["VALUE_COLUMN_INDEX"]
  DUPCLOSURE R18 K36 [PROTO_0]
  SETTABLEKS R18 R17 K37 ["getItemChildren"]
  DUPCLOSURE R18 K38 [PROTO_1]
  SETTABLEKS R18 R17 K39 ["getItemId"]
  GETTABLEKS R18 R2 K29 ["new"]
  DUPTABLE R19 K42 [{"getChildren", "getId"}]
  GETTABLEKS R20 R17 K37 ["getItemChildren"]
  SETTABLEKS R20 R19 K40 ["getChildren"]
  GETTABLEKS R20 R17 K39 ["getItemId"]
  SETTABLEKS R20 R19 K41 ["getId"]
  CALL R18 1 1
  SETTABLEKS R18 R17 K8 ["EditTree"]
  DUPCLOSURE R19 K43 [PROTO_3]
  CAPTURE VAL R15
  CAPTURE VAL R8
  CAPTURE VAL R11
  CAPTURE VAL R17
  ...
  CAPTURE VAL R12
  CAPTURE VAL R4
  SETTABLEKS R19 R17 K44 ["_buildStyleRule"]
  DUPCLOSURE R19 K45 [PROTO_4]
  CAPTURE VAL R15
  CAPTURE VAL R6
  CAPTURE VAL R12
  CAPTURE VAL R9
  SETTABLEKS R19 R17 K46 ["_buildEmptyRow"]
  ...
  CAPTURE VAL R9
  CAPTURE VAL R17
  SETTABLEKS R19 R17 K48 ["_buildProperties"]
  DUPCLOSURE R19 K49 [PROTO_7]
  CAPTURE VAL R17
  CAPTURE VAL R18
  SETTABLEKS R19 R17 K50 ["buildItems"]
  DUPCLOSURE R19 K51 [PROTO_8]
  CAPTURE VAL R17
  SETTABLEKS R19 R17 K52 ["expandNewRows"]
  RETURN R17 1
