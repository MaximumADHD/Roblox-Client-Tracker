...
PROTO_11:
  ...
  GETUPVAL R2 0
  GETUPVAL R4 1
  GETTABLEKS R3 R4 K5 ["PropertySchema"]
...
PROTO_16:
  ...
  CALL R4 1 1
  GETUPVAL R5 1
  GETTABLEKS R7 R1 K5 ["table"]
  DUPTABLE R8 K7 [{"Children"}]
  GETTABLEKS R10 R1 K5 ["table"]
  GETTABLEKS R9 R10 K8 ["Items"]
  SETTABLEKS R9 R8 K6 ["Children"]
  DUPTABLE R9 K7 [{"Children"}]
  SETTABLEKS R4 R9 K6 ["Children"]
  NAMECALL R5 R5 K9 ["updateItems"]
  CALL R5 4 0
  GETTABLEKS R6 R1 K5 ["table"]
  ...
  SETTABLEKS R4 R11 K8 ["Items"]
  CALL R9 2 1
  SETTABLEKS R9 R8 K5 ["table"]
  CALL R6 2 -1
  RETURN R6 -1
  RETURN R1 1
...
MAIN:
  ...
  GETTABLEKS R17 R18 K28 ["RootReducer"]
  CALL R16 1 1
  GETIMPORT R17 K9 [require]
  GETTABLEKS R19 R2 K10 ["Packages"]
  GETTABLEKS R18 R19 K29 ["Dash"]
  CALL R17 1 1
  GETTABLEKS R18 R17 K30 ["collectArray"]
  GETTABLEKS R19 R17 K31 ["filter"]
  GETTABLEKS R20 R17 K32 ["join"]
  GETTABLEKS R21 R17 K33 ["mapOne"]
  GETTABLEKS R22 R17 K34 ["copy"]
  GETIMPORT R23 K37 [table.insert]
  GETTABLEKS R25 R9 K38 ["EditTree"]
  GETTABLEKS R24 R25 K39 ["new"]
  DUPTABLE R25 K42 [{"getChildren", "getId"}]
  DUPCLOSURE R26 K43 [PROTO_0]
  SETTABLEKS R26 R25 K40 ["getChildren"]
  DUPCLOSURE R26 K44 [PROTO_1]
  SETTABLEKS R26 R25 K41 ["getId"]
  CALL R24 1 1
  NEWTABLE R25 0 1
  DUPTABLE R26 K48 [{"Name", "Key", "Width"}]
  LOADK R27 K45 ["Name"]
  SETTABLEKS R27 R26 K45 ["Name"]
  LOADK R27 K45 ["Name"]
  SETTABLEKS R27 R26 K46 ["Key"]
  GETIMPORT R27 K50 [UDim.new]
  LOADN R28 1
  LOADN R29 0
  CALL R27 2 1
  SETTABLEKS R27 R26 K47 ["Width"]
  SETLIST R25 R26 1 [1]
  GETTABLEKS R26 R3 K51 ["PureComponent"]
  LOADK R28 K52 ["DerivesTable"]
  NAMECALL R26 R26 K53 ["extend"]
  CALL R26 2 1
  ...
  CAPTURE VAL R18
  CAPTURE VAL R13
  SETTABLEKS R27 R26 K55 ["init"]
  DUPCLOSURE R27 K56 [PROTO_10]
  CAPTURE VAL R19
  CAPTURE VAL R1
  SETTABLEKS R27 R26 K57 ["getAllSheets"]
  DUPCLOSURE R27 K58 [PROTO_11]
  CAPTURE VAL R20
  CAPTURE VAL R12
  SETTABLEKS R27 R26 K59 ["getEmptyRow"]
  NEWCLOSURE R27 P5
  CAPTURE VAL R20
  CAPTURE VAL R12
  CAPTURE VAL R18
  ...
  CAPTURE VAL R23
  CAPTURE VAL R24
  SETTABLEKS R27 R26 K60 ["getItems"]
  NEWCLOSURE R27 P6
  CAPTURE REF R26
  CAPTURE VAL R24
  CAPTURE VAL R20
  SETTABLEKS R27 R26 K61 ["getDerivedStateFromProps"]
  DUPCLOSURE R27 K62 [PROTO_17]
  CAPTURE VAL R20
  CAPTURE VAL R10
  CAPTURE VAL R3
  CAPTURE VAL R9
  SETTABLEKS R27 R26 K63 ["render"]
  MOVE R27 R7
  DUPTABLE R28 K65 [{"Localization"}]
  GETTABLEKS R29 R6 K64 ["Localization"]
  SETTABLEKS R29 R28 K64 ["Localization"]
  CALL R27 1 1
  MOVE R28 R26
  CALL R27 1 1
  MOVE R26 R27
  GETTABLEKS R27 R4 K66 ["connect"]
  DUPCLOSURE R28 K67 [PROTO_18]
  CALL R27 1 1
  MOVE R28 R26
  CALL R27 1 -1
  CLOSEUPVALS R26
