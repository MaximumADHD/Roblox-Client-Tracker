...
PROTO_2:
  ...
  GETTABLEKS R8 R3 K6 ["Packages"]
  GETTABLEKS R7 R8 K9 ["DeveloperTools"]
  CALL R6 1 1
  GETIMPORT R7 K1 [require]
  GETTABLEKS R9 R3 K6 ["Packages"]
  GETTABLEKS R8 R9 K10 ["TestLoader"]
  CALL R7 1 1
  GETIMPORT R8 K1 [require]
  GETTABLEKS R10 R3 K11 ["Src"]
  GETTABLEKS R9 R10 K12 ["MainPlugin"]
  CALL R8 1 1
  LOADNIL R9
  LOADNIL R10
  GETTABLEKS R11 R7 K13 ["hasInternalPermission"]
  CALL R11 0 1
  JUMPIFNOT R11 [+7]
  GETTABLEKS R11 R6 K14 ["forPlugin"]
  GETTABLEKS R12 R3 K15 ["Name"]
  MOVE R13 R0
  CALL R11 2 1
  MOVE R10 R11
  NEWCLOSURE R11 P0
