...
PROTO_2:
  ...
  LOADK R6 K8 ["EnableTerrainEditor2"]
  ...
  GETTABLEKS R6 R7 K12 ["ReactRoblox"]
  CALL R5 1 1
  GETIMPORT R6 K1 [require]
  GETTABLEKS R9 R3 K10 ["Packages"]
  GETTABLEKS R8 R9 K13 ["Dev"]
  GETTABLEKS R7 R8 K14 ["DeveloperTools"]
  CALL R6 1 1
  GETIMPORT R7 K1 [require]
  GETTABLEKS R9 R3 K10 ["Packages"]
  GETTABLEKS R8 R9 K15 ["TestLoader"]
  CALL R7 1 1
  GETIMPORT R8 K1 [require]
  GETTABLEKS R10 R3 K16 ["Src"]
  GETTABLEKS R9 R10 K17 ["MainPlugin"]
  CALL R8 1 1
  LOADNIL R9
  LOADNIL R10
  GETTABLEKS R11 R7 K18 ["hasInternalPermission"]
  CALL R11 0 1
  JUMPIFNOT R11 [+7]
  GETTABLEKS R11 R6 K19 ["forPlugin"]
  GETTABLEKS R12 R3 K20 ["Name"]
  MOVE R13 R0
  CALL R11 2 1
  MOVE R10 R11
  NEWCLOSURE R11 P0
  ...
  CAPTURE VAL R5
  CAPTURE REF R10
  GETTABLEKS R12 R0 K21 ["Unloading"]
  NEWCLOSURE R14 P1
  CAPTURE REF R10
  CAPTURE REF R9
  NAMECALL R12 R12 K22 ["Connect"]
  CALL R12 2 0
  MOVE R12 R11
  CALL R12 0 0
  CLOSEUPVALS R9
