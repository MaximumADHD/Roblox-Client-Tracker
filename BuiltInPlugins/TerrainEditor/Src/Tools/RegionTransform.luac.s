...
MAIN:
  ...
  GETTABLEKS R26 R27 K40 ["getFFlagTerrainEditorUseDeleteOperation"]
  CALL R25 1 1
  GETIMPORT R26 K5 [require]
  GETTABLEKS R29 R0 K10 ["Src"]
  GETTABLEKS R28 R29 K11 ["Flags"]
  GETTABLEKS R27 R28 K41 ["getFFlagTerrainEditorTimeStatistic"]
  CALL R26 1 1
  NEWTABLE R27 0 1
  DUPTABLE R28 K45 [{"Defaults", "Id", "Schema"}]
  NEWTABLE R29 4 0
  GETTABLEKS R30 R15 K46 ["MergeEmpty"]
  LOADB R31 0
  SETTABLE R31 R29 R30
  GETTABLEKS R30 R15 K47 ["LiveEdit"]
  LOADB R31 1
  SETTABLE R31 R29 R30
  GETTABLEKS R30 R15 K48 ["ForcePreview"]
  LOADB R31 0
  SETTABLE R31 R29 R30
  GETTABLEKS R30 R15 K25 ["TransformMode"]
  GETTABLEKS R31 R14 K49 ["Move"]
  SETTABLE R31 R29 R30
  SETTABLEKS R29 R28 K42 ["Defaults"]
  GETTABLEKS R29 R8 K26 ["TransformSettings"]
  ...
  JUMP [+1]
  MOVE R29 R6
  SETTABLEKS R29 R28 K44 ["Schema"]
  SETLIST R27 R28 1 [1]
  NEWTABLE R28 0 1
  DUPTABLE R29 K50 [{"Id", "Schema"}]
  GETTABLEKS R30 R9 K51 ["Region"]
  SETTABLEKS R30 R29 K43 ["Id"]
  DUPTABLE R30 K56 [{"Type", "Color", "Wireframe", "Rotation"}]
  GETTABLEKS R31 R9 K51 ["Region"]
  SETTABLEKS R31 R30 K52 ["Type"]
  GETIMPORT R31 K59 [Color3.new]
  LOADN R32 0
  LOADN R33 0
  LOADN R34 1
  CALL R31 3 1
  ...
  LOADB R31 1
  SETTABLEKS R31 R30 K54 ["Wireframe"]
  LOADB R31 1
  SETTABLEKS R31 R30 K55 ["Rotation"]
  SETTABLEKS R30 R29 K44 ["Schema"]
  SETLIST R28 R29 1 [1]
  GETTABLEKS R31 R17 K17 ["Transform"]
  GETTABLEKS R32 R16 K60 ["Edit"]
  MOVE R33 R27
  MOVE R34 R28
  NAMECALL R29 R2 K58 ["new"]
  CALL R29 5 1
  ...
  CAPTURE VAL R4
  CAPTURE VAL R1
  SETTABLEKS R30 R29 K62 ["startOperation"]
  DUPCLOSURE R30 K63 [PROTO_4]
  CAPTURE VAL R2
  CAPTURE VAL R8
  CAPTURE VAL R15
  SETTABLEKS R30 R29 K64 ["init"]
  ...
  CAPTURE VAL R5
  CAPTURE VAL R6
  SETTABLEKS R30 R29 K66 ["getValues"]
  ...
  CAPTURE VAL R8
  CAPTURE VAL R15
  SETTABLEKS R30 R29 K68 ["checkSize"]
  ...
  CAPTURE VAL R15
  CAPTURE VAL R17
  SETTABLEKS R30 R29 K70 ["activate"]
  DUPCLOSURE R30 K71 [PROTO_9]
  CAPTURE VAL R2
  CAPTURE VAL R9
  CAPTURE VAL R8
  CAPTURE VAL R3
  CAPTURE VAL R22
  CAPTURE VAL R5
  SETTABLEKS R30 R29 K72 ["gizmos"]
  DUPCLOSURE R30 K73 [PROTO_10]
  SETTABLEKS R30 R29 K74 ["operation"]
  DUPCLOSURE R30 K75 [PROTO_11]
  SETTABLEKS R30 R29 K76 ["note"]
  DUPCLOSURE R30 K77 [PROTO_12]
  CAPTURE VAL R2
  CAPTURE VAL R12
  CAPTURE VAL R3
  CAPTURE VAL R22
  ...
  CAPTURE VAL R14
  CAPTURE VAL R6
  SETTABLEKS R30 R29 K78 ["deactivate"]
  DUPCLOSURE R30 K79 [PROTO_13]
  CAPTURE VAL R2
  SETTABLEKS R30 R29 K80 ["saveGizmos"]
  DUPCLOSURE R30 K81 [PROTO_14]
  CAPTURE VAL R2
  SETTABLEKS R30 R29 K82 ["saveForm"]
  DUPCLOSURE R30 K83 [PROTO_16]
  CAPTURE VAL R15
  CAPTURE VAL R8
  CAPTURE VAL R10
  SETTABLEKS R30 R29 K84 ["updateMode"]
  DUPCLOSURE R30 K85 [PROTO_17]
  CAPTURE VAL R13
  CAPTURE VAL R15
  CAPTURE VAL R25
  CAPTURE VAL R11
  SETTABLEKS R30 R29 K86 ["updateValues"]
  DUPCLOSURE R30 K87 [PROTO_18]
  CAPTURE VAL R15
  CAPTURE VAL R13
  CAPTURE VAL R21
  CAPTURE VAL R14
  ...
  CAPTURE VAL R19
  CAPTURE VAL R8
  SETTABLEKS R30 R29 K88 ["transform"]
  DUPCLOSURE R30 K89 [PROTO_19]
  CAPTURE VAL R15
  CAPTURE VAL R19
  CAPTURE VAL R17
  CAPTURE VAL R26
  SETTABLEKS R30 R29 K90 ["reportAnalytics"]
  RETURN R29 1
