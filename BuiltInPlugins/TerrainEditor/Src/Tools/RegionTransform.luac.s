...
MAIN:
  ...
  GETTABLEKS R25 R26 K39 ["getFFlagTerrainEditorTimeStatistic"]
  CALL R24 1 1
  NEWTABLE R25 0 1
  DUPTABLE R26 K43 [{"Defaults", "Id", "Schema"}]
  NEWTABLE R27 4 0
  GETTABLEKS R28 R14 K44 ["MergeEmpty"]
  LOADB R29 0
  SETTABLE R29 R27 R28
  GETTABLEKS R28 R14 K45 ["LiveEdit"]
  LOADB R29 1
  SETTABLE R29 R27 R28
  GETTABLEKS R28 R14 K46 ["ForcePreview"]
  LOADB R29 0
  SETTABLE R29 R27 R28
  GETTABLEKS R28 R14 K24 ["TransformMode"]
  GETTABLEKS R29 R13 K47 ["Move"]
  SETTABLE R29 R27 R28
  SETTABLEKS R27 R26 K40 ["Defaults"]
  GETTABLEKS R27 R7 K25 ["TransformSettings"]
  ...
  SETLIST R26 R27 1 [1]
  GETTABLEKS R29 R16 K16 ["Transform"]
  GETTABLEKS R30 R15 K58 ["Edit"]
  MOVE R31 R25
  MOVE R32 R26
