...
MAIN:
  ...
  GETTABLEKS R11 R7 K22 ["Note"]
  GETTABLEKS R12 R7 K23 ["OperationSource"]
  GETTABLEKS R13 R7 K24 ["MaterialSettings"]
  GETTABLEKS R14 R7 K25 ["PluginAction"]
  GETTABLEKS R15 R7 K26 ["SelectionSettings"]
  GETTABLEKS R16 R7 K27 ["TransformMode"]
  GETTABLEKS R17 R7 K28 ["TransformSettings"]
  GETTABLEKS R18 R7 K29 ["Tab"]
  GETTABLEKS R19 R7 K30 ["Tool"]
  GETTABLEKS R21 R0 K10 ["Src"]
  GETTABLEKS R20 R21 K31 ["Util"]
  GETIMPORT R21 K5 [require]
  GETTABLEKS R22 R20 K32 ["AnalyticsHelper"]
  CALL R21 1 1
  GETIMPORT R22 K5 [require]
  GETTABLEKS R23 R20 K33 ["ApplyTransform"]
  CALL R22 1 1
  GETIMPORT R23 K5 [require]
  GETTABLEKS R24 R20 K34 ["ConvertTransformToRegion"]
  CALL R23 1 1
  GETIMPORT R24 K5 [require]
  GETTABLEKS R25 R20 K35 ["SettingsHelper"]
  CALL R24 1 1
  GETIMPORT R25 K5 [require]
  GETTABLEKS R27 R20 K36 ["Operations"]
  GETTABLEKS R26 R27 K37 ["TransformOperation"]
  CALL R25 1 1
  GETIMPORT R26 K39 [game]
  LOADK R28 K40 ["SmoothTerrainMaxCppRegion"]
  NAMECALL R26 R26 K41 ["GetFastInt"]
  CALL R26 2 1
  GETIMPORT R27 K5 [require]
  GETTABLEKS R30 R0 K10 ["Src"]
  GETTABLEKS R29 R30 K11 ["Flags"]
  GETTABLEKS R28 R29 K42 ["getFFlagTerrainEditorUseDeleteOperation"]
  CALL R27 1 1
  NEWTABLE R28 0 1
  DUPTABLE R29 K46 [{"Defaults", "Id", "Schema"}]
  NEWTABLE R30 4 0
  GETTABLEKS R31 R17 K47 ["MergeEmpty"]
  LOADB R32 0
  SETTABLE R32 R30 R31
  GETTABLEKS R31 R17 K48 ["LiveEdit"]
  LOADB R32 1
  SETTABLE R32 R30 R31
  GETTABLEKS R31 R17 K49 ["ForcePreview"]
  LOADB R32 0
  SETTABLE R32 R30 R31
  GETTABLEKS R31 R17 K27 ["TransformMode"]
  GETTABLEKS R32 R16 K50 ["Move"]
  SETTABLE R32 R30 R31
  SETTABLEKS R30 R29 K43 ["Defaults"]
  GETTABLEKS R30 R8 K28 ["TransformSettings"]
  ...
  JUMP [+1]
  MOVE R30 R6
  SETTABLEKS R30 R29 K45 ["Schema"]
  SETLIST R28 R29 1 [1]
  NEWTABLE R29 0 1
  DUPTABLE R30 K51 [{"Id", "Schema"}]
  GETTABLEKS R31 R10 K52 ["Region"]
  SETTABLEKS R31 R30 K44 ["Id"]
  DUPTABLE R31 K57 [{"Type", "Color", "Wireframe", "Rotation"}]
  GETTABLEKS R32 R10 K52 ["Region"]
  SETTABLEKS R32 R31 K53 ["Type"]
  GETIMPORT R32 K60 [Color3.new]
  LOADN R33 0
  LOADN R34 0
  LOADN R35 1
  CALL R32 3 1
  SETTABLEKS R32 R31 K54 ["Color"]
  LOADB R32 1
  SETTABLEKS R32 R31 K55 ["Wireframe"]
  LOADB R32 1
  SETTABLEKS R32 R31 K56 ["Rotation"]
  SETTABLEKS R31 R30 K45 ["Schema"]
  SETLIST R29 R30 1 [1]
  GETTABLEKS R32 R19 K17 ["Transform"]
  GETTABLEKS R33 R18 K61 ["Edit"]
  MOVE R34 R28
  MOVE R35 R29
  NAMECALL R30 R2 K59 ["new"]
  CALL R30 5 1
  DUPCLOSURE R31 K62 [PROTO_2]
  CAPTURE VAL R8
  CAPTURE VAL R3
  CAPTURE VAL R24
  CAPTURE VAL R5
  ...
  CAPTURE VAL R4
  CAPTURE VAL R1
  SETTABLEKS R31 R30 K63 ["startOperation"]
  DUPCLOSURE R31 K64 [PROTO_4]
  CAPTURE VAL R2
  CAPTURE VAL R8
  CAPTURE VAL R17
  SETTABLEKS R31 R30 K65 ["init"]
  DUPCLOSURE R31 K66 [PROTO_5]
  CAPTURE VAL R3
  CAPTURE VAL R24
  CAPTURE VAL R8
  CAPTURE VAL R5
  CAPTURE VAL R6
  SETTABLEKS R31 R30 K67 ["getValues"]
  DUPCLOSURE R31 K68 [PROTO_6]
  CAPTURE VAL R23
  CAPTURE VAL R26
  CAPTURE VAL R27
  CAPTURE VAL R8
  CAPTURE VAL R17
  SETTABLEKS R31 R30 K69 ["checkSize"]
  DUPCLOSURE R31 K70 [PROTO_8]
  CAPTURE VAL R2
  CAPTURE VAL R15
  CAPTURE VAL R16
  CAPTURE VAL R23
  ...
  CAPTURE VAL R17
  CAPTURE VAL R19
  SETTABLEKS R31 R30 K71 ["activate"]
  DUPCLOSURE R31 K72 [PROTO_9]
  CAPTURE VAL R2
  CAPTURE VAL R10
  CAPTURE VAL R8
  CAPTURE VAL R3
  CAPTURE VAL R24
  CAPTURE VAL R5
  SETTABLEKS R31 R30 K73 ["gizmos"]
  DUPCLOSURE R31 K74 [PROTO_10]
  SETTABLEKS R31 R30 K75 ["operation"]
  DUPCLOSURE R31 K76 [PROTO_11]
  SETTABLEKS R31 R30 K77 ["note"]
  DUPCLOSURE R31 K78 [PROTO_12]
  CAPTURE VAL R2
  CAPTURE VAL R14
  CAPTURE VAL R3
  CAPTURE VAL R24
  ...
  CAPTURE VAL R16
  CAPTURE VAL R6
  SETTABLEKS R31 R30 K79 ["deactivate"]
  DUPCLOSURE R31 K80 [PROTO_13]
  CAPTURE VAL R2
  SETTABLEKS R31 R30 K81 ["saveGizmos"]
  DUPCLOSURE R31 K82 [PROTO_14]
  CAPTURE VAL R2
  SETTABLEKS R31 R30 K83 ["saveForm"]
  DUPCLOSURE R31 K84 [PROTO_16]
  CAPTURE VAL R17
  CAPTURE VAL R8
  CAPTURE VAL R11
  SETTABLEKS R31 R30 K85 ["updateMode"]
  DUPCLOSURE R31 K86 [PROTO_17]
  CAPTURE VAL R15
  CAPTURE VAL R17
  CAPTURE VAL R27
  CAPTURE VAL R12
  SETTABLEKS R31 R30 K87 ["updateValues"]
  DUPCLOSURE R31 K88 [PROTO_18]
  CAPTURE VAL R17
  CAPTURE VAL R15
  CAPTURE VAL R23
  CAPTURE VAL R16
  CAPTURE VAL R22
  CAPTURE VAL R8
  SETTABLEKS R31 R30 K89 ["transform"]
  DUPCLOSURE R31 K90 [PROTO_19]
  CAPTURE VAL R17
  CAPTURE VAL R21
  CAPTURE VAL R19
  SETTABLEKS R31 R30 K91 ["reportAnalytics"]
  RETURN R30 1
