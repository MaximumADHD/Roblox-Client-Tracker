...
MAIN:
  ...
  GETTABLEKS R17 R18 K27 ["AnalyticsHelper"]
  CALL R16 1 1
  ...
  NEWTABLE R20 16 0
  GETTABLEKS R21 R7 K17 ["BrushMode"]
  GETTABLEKS R22 R6 K32 ["Add"]
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R7 K19 ["BrushShape"]
  ...
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R7 K23 ["PivotPosition"]
  GETTABLEKS R22 R12 K39 ["Center"]
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R7 K24 ["Snapping"]
  GETTABLEKS R22 R13 K40 ["Off"]
  SETTABLE R22 R20 R21
  ...
  GETTABLEKS R20 R9 K18 ["BrushSettings"]
  SETTABLEKS R20 R19 K30 ["Id"]
  DUPTABLE R20 K31 [{"Defaults", "Id"}]
  NEWTABLE R21 2 0
  GETTABLEKS R22 R11 K51 ["AutoMaterial"]
  LOADB R23 0
  SETTABLE R23 R21 R22
  GETTABLEKS R22 R11 K52 ["SourceMaterial"]
  GETIMPORT R23 K56 [Enum.Material.Grass]
  SETTABLE R23 R21 R22
  SETTABLEKS R21 R20 K29 ["Defaults"]
  GETTABLEKS R21 R9 K22 ["MaterialSettings"]
  ...
  DUPCLOSURE R21 K75 [PROTO_9]
  CAPTURE VAL R3
  CAPTURE VAL R2
  SETTABLEKS R21 R20 K76 ["deactivate"]
  DUPCLOSURE R21 K77 [PROTO_10]
  CAPTURE VAL R16
  CAPTURE VAL R15
  CAPTURE VAL R3
