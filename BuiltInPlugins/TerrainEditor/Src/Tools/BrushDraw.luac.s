...
MAIN:
  ...
  GETTABLEKS R18 R19 K27 ["SettingsHelper"]
  CALL R17 1 1
  ...
  GETTABLEKS R23 R5 K33 ["Add"]
  SETTABLE R23 R21 R22
  GETTABLEKS R22 R6 K17 ["BrushShape"]
  GETTABLEKS R23 R7 K34 ["Sphere"]
  SETTABLE R23 R21 R22
  GETTABLEKS R22 R6 K35 ["BrushSize"]
  DUPTABLE R23 K39 [{"Height", "Locked", "Size"}]
  LOADN R24 6
  SETTABLEKS R24 R23 K36 ["Height"]
  LOADB R24 1
  SETTABLEKS R24 R23 K37 ["Locked"]
  LOADN R24 6
  SETTABLEKS R24 R23 K38 ["Size"]
  SETTABLE R23 R21 R22
  GETTABLEKS R22 R6 K21 ["PivotPosition"]
  GETTABLEKS R23 R11 K40 ["Center"]
  SETTABLE R23 R21 R22
  GETTABLEKS R22 R6 K23 ["Snapping"]
  GETTABLEKS R23 R13 K41 ["Off"]
  SETTABLE R23 R21 R22
  GETTABLEKS R22 R6 K42 ["State"]
  ...
  SETTABLE R23 R21 R22
  GETTABLEKS R22 R6 K48 ["IgnoreWater"]
  LOADB R23 0
  SETTABLE R23 R21 R22
  GETTABLEKS R22 R6 K49 ["IgnoreParts"]
  LOADB R23 1
  SETTABLE R23 R21 R22
  GETTABLEKS R22 R6 K50 ["TemporarySmooth"]
  LOADB R23 0
  SETTABLE R23 R21 R22
  GETTABLEKS R22 R6 K51 ["WaterAutofill"]
  LOADB R23 0
  SETTABLE R23 R21 R22
  ...
  NEWTABLE R22 2 0
  GETTABLEKS R23 R10 K52 ["AutoMaterial"]
  LOADB R24 0
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R10 K53 ["SourceMaterial"]
  ...
  SETTABLEKS R22 R21 K58 ["Schema"]
  DUPTABLE R22 K59 [{"Id", "Schema"}]
  GETTABLEKS R23 R9 K63 ["Brush"]
  SETTABLEKS R23 R22 K31 ["Id"]
  DUPTABLE R23 K62 [{"Type"}]
  GETTABLEKS R24 R9 K63 ["Brush"]
  SETTABLEKS R24 R23 K61 ["Type"]
  SETTABLEKS R23 R22 K58 ["Schema"]
  SETLIST R20 R21 2 [1]
  GETTABLEKS R23 R15 K64 ["Draw"]
  GETTABLEKS R24 R14 K65 ["Edit"]
  MOVE R25 R19
  MOVE R26 R20
  NAMECALL R21 R2 K46 ["new"]
  CALL R21 5 1
  DUPCLOSURE R22 K66 [PROTO_2]
  CAPTURE VAL R2
  CAPTURE VAL R8
  CAPTURE VAL R6
  CAPTURE VAL R17
  SETTABLEKS R22 R21 K67 ["init"]
  DUPCLOSURE R22 K68 [PROTO_3]
  CAPTURE VAL R2
  SETTABLEKS R22 R21 K69 ["saveForm"]
  DUPCLOSURE R22 K70 [PROTO_4]
  CAPTURE VAL R2
  SETTABLEKS R22 R21 K71 ["saveGizmos"]
  DUPCLOSURE R22 K72 [PROTO_5]
  CAPTURE VAL R3
  CAPTURE VAL R1
  SETTABLEKS R22 R21 K73 ["startOperation"]
  DUPCLOSURE R22 K74 [PROTO_8]
  CAPTURE VAL R2
  CAPTURE VAL R18
  CAPTURE VAL R8
  CAPTURE VAL R6
  CAPTURE VAL R12
  CAPTURE VAL R15
  SETTABLEKS R22 R21 K75 ["activate"]
  DUPCLOSURE R22 K76 [PROTO_9]
  CAPTURE VAL R2
  SETTABLEKS R22 R21 K77 ["deactivate"]
  DUPCLOSURE R22 K78 [PROTO_10]
  CAPTURE VAL R16
  CAPTURE VAL R15
  SETTABLEKS R22 R21 K79 ["reportAnalytics"]
  RETURN R21 1
