...
MAIN:
  ...
  GETTABLEKS R21 R12 K39 ["Center"]
  SETTABLE R21 R19 R20
  GETTABLEKS R20 R7 K24 ["Snapping"]
  GETTABLEKS R21 R13 K40 ["Off"]
  SETTABLE R21 R19 R20
  ...
  LOADB R21 1
  SETTABLE R21 R19 R20
  GETTABLEKS R20 R7 K49 ["TemporarySmooth"]
  LOADB R21 0
  SETTABLE R21 R19 R20
  GETTABLEKS R20 R7 K50 ["WaterAutofill"]
  LOADB R21 0
  SETTABLE R21 R19 R20
  ...
  NEWTABLE R20 2 0
  GETTABLEKS R21 R11 K51 ["AutoMaterial"]
  LOADB R22 0
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R11 K52 ["SourceMaterial"]
  GETIMPORT R22 K55 [Enum.Material.Grass]
  SETTABLE R22 R20 R21
  ...
  GETTABLEKS R20 R10 K57 ["Plane"]
  SETTABLEKS R20 R19 K29 ["Id"]
  DUPTABLE R20 K59 [{"Type"}]
  GETTABLEKS R21 R10 K57 ["Plane"]
  ...
  SETLIST R18 R19 2 [1]
  GETTABLEKS R21 R15 K60 ["Draw"]
  GETTABLEKS R22 R14 K61 ["Edit"]
  MOVE R23 R17
  MOVE R24 R18
  NAMECALL R19 R1 K45 ["new"]
  CALL R19 5 1
  DUPCLOSURE R20 K62 [PROTO_2]
  CAPTURE VAL R1
  CAPTURE VAL R9
  CAPTURE VAL R7
  CAPTURE VAL R16
  ...
  DUPCLOSURE R20 K64 [PROTO_3]
  CAPTURE VAL R1
  SETTABLEKS R20 R19 K65 ["saveForm"]
  DUPCLOSURE R20 K66 [PROTO_4]
  CAPTURE VAL R1
  SETTABLEKS R20 R19 K67 ["saveGizmos"]
  DUPCLOSURE R20 K68 [PROTO_7]
  CAPTURE VAL R1
  CAPTURE VAL R4
  SETTABLEKS R20 R19 K69 ["activate"]
  DUPCLOSURE R20 K70 [PROTO_8]
  CAPTURE VAL R1
