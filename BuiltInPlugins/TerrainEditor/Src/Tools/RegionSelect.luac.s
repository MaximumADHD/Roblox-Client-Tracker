...
MAIN:
  ...
  GETTABLEKS R18 R19 K26 ["getFFlagTerrainEditorErrorHandling"]
  CALL R17 1 1
  NEWTABLE R18 0 1
  DUPTABLE R19 K29 [{"Defaults", "Id"}]
  NEWTABLE R20 0 0
  SETTABLEKS R20 R19 K27 ["Defaults"]
  GETTABLEKS R20 R3 K15 ["SelectionSettings"]
  SETTABLEKS R20 R19 K28 ["Id"]
  SETLIST R18 R19 1 [1]
  NEWTABLE R19 0 1
  DUPTABLE R20 K31 [{"Id", "Schema"}]
  GETTABLEKS R21 R5 K32 ["Region"]
  SETTABLEKS R21 R20 K28 ["Id"]
  DUPTABLE R21 K36 [{"Type", "Wireframe", "Rotation"}]
  GETTABLEKS R22 R5 K32 ["Region"]
  SETTABLEKS R22 R21 K33 ["Type"]
  LOADB R22 1
  SETTABLEKS R22 R21 K34 ["Wireframe"]
  LOADB R22 0
  SETTABLEKS R22 R21 K35 ["Rotation"]
  SETTABLEKS R21 R20 K30 ["Schema"]
  SETLIST R19 R20 1 [1]
  GETTABLEKS R22 R10 K37 ["Select"]
  GETTABLEKS R23 R9 K38 ["Edit"]
  MOVE R24 R18
  MOVE R25 R19
  NAMECALL R20 R1 K39 ["new"]
  CALL R20 5 1
  ...
  CAPTURE VAL R8
  CAPTURE VAL R15
  SETTABLEKS R21 R20 K41 ["fillAir"]
  ...
  CAPTURE VAL R8
  CAPTURE VAL R12
  SETTABLEKS R21 R20 K43 ["copy"]
  DUPCLOSURE R21 K44 [PROTO_2]
  CAPTURE VAL R17
  SETTABLEKS R21 R20 K45 ["delete"]
  DUPCLOSURE R21 K46 [PROTO_3]
  CAPTURE VAL R17
  CAPTURE VAL R16
  CAPTURE VAL R3
  CAPTURE VAL R14
  ...
  CAPTURE VAL R11
  CAPTURE VAL R10
  SETTABLEKS R21 R20 K49 ["paste"]
  DUPCLOSURE R21 K50 [PROTO_5]
  CAPTURE VAL R17
  CAPTURE VAL R16
  CAPTURE VAL R3
  CAPTURE VAL R14
  ...
  CAPTURE VAL R11
  CAPTURE VAL R10
  SETTABLEKS R21 R20 K51 ["duplicate"]
  DUPCLOSURE R21 K52 [PROTO_6]
  SETTABLEKS R21 R20 K53 ["operation"]
  DUPCLOSURE R21 K54 [PROTO_14]
  CAPTURE VAL R1
  CAPTURE VAL R7
  CAPTURE VAL R10
  SETTABLEKS R21 R20 K55 ["activate"]
  DUPCLOSURE R21 K56 [PROTO_15]
  CAPTURE VAL R1
  SETTABLEKS R21 R20 K57 ["deactivate"]
  RETURN R20 1
