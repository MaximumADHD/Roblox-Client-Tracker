...
PROTO_2:
  ...
  NEWTABLE R6 4 0
  GETUPVAL R8 6
  GETTABLEKS R7 R8 K21 ["TerrainRegionBuffer"]
  SETTABLE R2 R6 R7
  GETUPVAL R8 6
  GETTABLEKS R7 R8 K22 ["TerrainRegionBufferSize"]
  GETUPVAL R10 5
  GETTABLEKS R9 R10 K12 ["Size"]
  GETTABLE R8 R1 R9
  SETTABLE R8 R6 R7
  GETUPVAL R8 6
  GETTABLEKS R7 R8 K23 ["TerrainRegionBufferTransform"]
  GETUPVAL R10 5
  GETTABLEKS R9 R10 K11 ["Transform"]
  GETTABLE R8 R1 R9
  SETTABLE R8 R6 R7
...
MAIN:
  ...
  GETTABLEKS R8 R5 K18 ["PluginAction"]
  GETTABLEKS R9 R5 K19 ["SelectionSettings"]
  GETTABLEKS R10 R5 K20 ["Tab"]
  GETTABLEKS R11 R5 K21 ["Tool"]
  ...
  GETTABLEKS R16 R14 K25 ["ConvertTransformToRegion"]
  CALL R15 1 1
  GETIMPORT R16 K5 [require]
  GETTABLEKS R17 R14 K26 ["SettingsHelper"]
  CALL R16 1 1
  GETIMPORT R17 K5 [require]
  GETTABLEKS R20 R0 K8 ["Src"]
  GETTABLEKS R19 R20 K9 ["Flags"]
  GETTABLEKS R18 R19 K27 ["getFFlagTerrainEditorFocusIssues"]
  CALL R17 1 1
  NEWTABLE R18 0 1
  DUPTABLE R19 K31 [{"Defaults", "Id", "Schema"}]
  NEWTABLE R20 0 0
  SETTABLEKS R20 R19 K28 ["Defaults"]
  GETTABLEKS R20 R6 K19 ["SelectionSettings"]
  ...
  GETTABLEKS R21 R7 K33 ["Region"]
  SETTABLEKS R21 R20 K29 ["Id"]
  DUPTABLE R21 K37 [{"Type", "Wireframe", "Rotation"}]
  GETTABLEKS R22 R7 K33 ["Region"]
  SETTABLEKS R22 R21 K34 ["Type"]
  LOADB R22 1
  SETTABLEKS R22 R21 K35 ["Wireframe"]
  LOADB R22 0
  SETTABLEKS R22 R21 K36 ["Rotation"]
  SETTABLEKS R21 R20 K30 ["Schema"]
  SETLIST R19 R20 1 [1]
  GETTABLEKS R22 R11 K38 ["Select"]
  GETTABLEKS R23 R10 K39 ["Edit"]
  MOVE R24 R18
  MOVE R25 R19
  NAMECALL R20 R1 K40 ["new"]
  CALL R20 5 1
  ...
  CAPTURE VAL R3
  CAPTURE VAL R9
  SETTABLEKS R21 R20 K44 ["delete"]
  DUPCLOSURE R21 K45 [PROTO_2]
  CAPTURE VAL R2
  CAPTURE VAL R16
  CAPTURE VAL R6
  CAPTURE VAL R3
  ...
  CAPTURE VAL R13
  CAPTURE VAL R4
  SETTABLEKS R21 R20 K46 ["cut"]
  DUPCLOSURE R21 K47 [PROTO_3]
  CAPTURE VAL R2
  CAPTURE VAL R16
  CAPTURE VAL R6
  CAPTURE VAL R4
  ...
  CAPTURE VAL R12
  CAPTURE VAL R11
  SETTABLEKS R21 R20 K48 ["paste"]
  DUPCLOSURE R21 K49 [PROTO_4]
  CAPTURE VAL R2
  CAPTURE VAL R16
  CAPTURE VAL R6
  CAPTURE VAL R3
  ...
  CAPTURE VAL R4
  CAPTURE VAL R11
  SETTABLEKS R21 R20 K50 ["duplicate"]
  DUPCLOSURE R21 K51 [PROTO_13]
  CAPTURE VAL R1
  CAPTURE VAL R8
  CAPTURE VAL R17
  SETTABLEKS R21 R20 K52 ["activate"]
  DUPCLOSURE R21 K53 [PROTO_14]
  CAPTURE VAL R1
  SETTABLEKS R21 R20 K54 ["deactivate"]
  RETURN R20 1
