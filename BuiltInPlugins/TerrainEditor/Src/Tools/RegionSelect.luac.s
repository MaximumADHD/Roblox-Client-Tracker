...
MAIN:
  ...
  GETTABLEKS R19 R6 K19 ["SelectionSettings"]
  ...
  SETLIST R17 R18 1 [1]
  NEWTABLE R18 0 1
  DUPTABLE R19 K31 [{"Id", "Schema"}]
  GETTABLEKS R20 R7 K32 ["Region"]
  SETTABLEKS R20 R19 K28 ["Id"]
  DUPTABLE R20 K36 [{"Type", "Wireframe", "Rotation"}]
  GETTABLEKS R21 R7 K32 ["Region"]
  SETTABLEKS R21 R20 K33 ["Type"]
  LOADB R21 1
  SETTABLEKS R21 R20 K34 ["Wireframe"]
  LOADB R21 0
  SETTABLEKS R21 R20 K35 ["Rotation"]
  SETTABLEKS R20 R19 K29 ["Schema"]
  SETLIST R18 R19 1 [1]
  GETTABLEKS R21 R11 K37 ["Select"]
  GETTABLEKS R22 R10 K38 ["Edit"]
  MOVE R23 R17
  MOVE R24 R18
  NAMECALL R19 R1 K39 ["new"]
  CALL R19 5 1
  ...
  CAPTURE VAL R1
  CAPTURE VAL R8
  SETTABLEKS R20 R19 K51 ["activate"]
  DUPCLOSURE R20 K52 [PROTO_13]
  CAPTURE VAL R1
  SETTABLEKS R20 R19 K53 ["deactivate"]
  RETURN R19 1
