...
MAIN:
  ...
  GETTABLEKS R15 R12 K23 ["Operations"]
  GETTABLEKS R14 R15 K24 ["FillOperation"]
  CALL R13 1 1
  NEWTABLE R14 0 2
  DUPTABLE R15 K28 [{"Defaults", "Id", "Schema"}]
  NEWTABLE R16 0 0
  SETTABLEKS R16 R15 K25 ["Defaults"]
  GETTABLEKS R16 R6 K29 ["SelectionSettings"]
  SETTABLEKS R16 R15 K26 ["Id"]
  SETTABLEKS R4 R15 K27 ["Schema"]
  DUPTABLE R16 K28 [{"Defaults", "Id", "Schema"}]
  NEWTABLE R17 4 0
  GETTABLEKS R18 R9 K17 ["FillMode"]
  GETTABLEKS R19 R7 K30 ["Fill"]
  SETTABLE R19 R17 R18
  GETTABLEKS R18 R9 K31 ["SourceMaterial"]
  GETIMPORT R19 K34 [Enum.Material.Grass]
  SETTABLE R19 R17 R18
  GETTABLEKS R18 R9 K35 ["TargetMaterial"]
  GETIMPORT R19 K34 [Enum.Material.Grass]
  SETTABLE R19 R17 R18
  SETTABLEKS R17 R16 K25 ["Defaults"]
  GETTABLEKS R17 R6 K19 ["MaterialSettings"]
  SETTABLEKS R17 R16 K26 ["Id"]
  SETTABLEKS R3 R16 K27 ["Schema"]
  SETLIST R14 R15 2 [1]
  NEWTABLE R15 0 1
  DUPTABLE R16 K36 [{"Id", "Schema"}]
  GETTABLEKS R17 R8 K37 ["Region"]
  SETTABLEKS R17 R16 K26 ["Id"]
  DUPTABLE R17 K41 [{"Type", "Wireframe", "Rotation"}]
  GETTABLEKS R18 R8 K37 ["Region"]
  ...
  DUPCLOSURE R17 K46 [PROTO_2]
  CAPTURE VAL R2
  CAPTURE VAL R6
  CAPTURE VAL R9
  SETTABLEKS R17 R16 K47 ["init"]
  DUPCLOSURE R17 K48 [PROTO_3]
