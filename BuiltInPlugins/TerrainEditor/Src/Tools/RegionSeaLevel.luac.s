...
MAIN:
  ...
  LOADK R19 K31 [{64, 32, 64}]
  SETTABLE R19 R17 R18
  GETTABLEKS R18 R8 K32 ["SnapToVoxels"]
  LOADB R19 1
  SETTABLE R19 R17 R18
  GETTABLEKS R18 R8 K33 ["Transform"]
  ...
  GETTABLEKS R18 R6 K39 ["Region"]
  SETTABLEKS R18 R17 K28 ["Id"]
  DUPTABLE R18 K43 [{"Type", "Wireframe", "Rotation"}]
  GETTABLEKS R19 R6 K39 ["Region"]
  SETTABLEKS R19 R18 K40 ["Type"]
  LOADB R19 0
  SETTABLEKS R19 R18 K41 ["Wireframe"]
  LOADB R19 0
  SETTABLEKS R19 R18 K42 ["Rotation"]
  SETTABLEKS R18 R17 K37 ["Schema"]
  SETLIST R16 R17 1 [1]
  GETTABLEKS R19 R11 K44 ["SeaLevel"]
  GETTABLEKS R20 R10 K45 ["Edit"]
  MOVE R21 R15
  MOVE R22 R16
  NAMECALL R17 R2 K35 ["new"]
  CALL R17 5 1
  ...
  CAPTURE VAL R13
  CAPTURE VAL R1
  SETTABLEKS R18 R17 K49 ["create"]
  DUPCLOSURE R18 K50 [PROTO_4]
  CAPTURE VAL R4
  CAPTURE VAL R7
  CAPTURE VAL R5
  CAPTURE VAL R9
  ...
  CAPTURE VAL R14
  CAPTURE VAL R1
  SETTABLEKS R18 R17 K51 ["evaporate"]
  DUPCLOSURE R18 K52 [PROTO_7]
  CAPTURE VAL R2
  CAPTURE VAL R4
  CAPTURE VAL R8
  SETTABLEKS R18 R17 K53 ["init"]
  DUPCLOSURE R18 K54 [PROTO_8]
  CAPTURE VAL R4
  CAPTURE VAL R8
  SETTABLEKS R18 R17 K55 ["setDisabledState"]
  DUPCLOSURE R18 K56 [PROTO_9]
  SETTABLEKS R18 R17 K57 ["operation"]
  DUPCLOSURE R18 K58 [PROTO_10]
  CAPTURE VAL R2
  CAPTURE VAL R11
