...
MAIN:
  ...
  LOADK R16 K25 ["TerrainEditorEvaporateDisablesButtons"]
  LOADB R17 0
  NAMECALL R14 R14 K26 ["DefineFastFlag"]
  CALL R14 3 1
  NEWTABLE R15 0 1
  DUPTABLE R16 K29 [{"Defaults", "Id"}]
  NEWTABLE R17 4 0
  GETTABLEKS R18 R8 K30 ["Size"]
  LOADN R20 64
  LOADN R21 32
  LOADN R22 64
  FASTCALL VECTOR [+2]
  ...
  SETLIST R16 R17 1 [1]
  GETTABLEKS R19 R11 K45 ["SeaLevel"]
  GETTABLEKS R20 R10 K46 ["Edit"]
  MOVE R21 R15
  MOVE R22 R16
  NAMECALL R17 R2 K32 ["new"]
  CALL R17 5 1
  DUPCLOSURE R18 K47 [PROTO_0]
  CAPTURE VAL R2
  SETTABLEKS R18 R17 K48 ["startOperation"]
  ...
  CAPTURE VAL R13
  CAPTURE VAL R1
  SETTABLEKS R18 R17 K50 ["create"]
  DUPCLOSURE R18 K51 [PROTO_4]
  CAPTURE VAL R4
  CAPTURE VAL R7
  CAPTURE VAL R5
  CAPTURE VAL R9
  ...
  CAPTURE VAL R14
  CAPTURE VAL R1
  SETTABLEKS R18 R17 K52 ["evaporate"]
  DUPCLOSURE R18 K53 [PROTO_7]
  CAPTURE VAL R2
  CAPTURE VAL R4
  CAPTURE VAL R8
  ...
  CAPTURE VAL R4
  CAPTURE VAL R8
  SETTABLEKS R18 R17 K56 ["setDisabledState"]
  DUPCLOSURE R18 K57 [PROTO_9]
  SETTABLEKS R18 R17 K58 ["operation"]
