...
MAIN:
  ...
  GETTABLEKS R17 R8 K30 ["SnapToVoxels"]
  LOADB R18 1
  SETTABLE R18 R16 R17
  GETTABLEKS R17 R8 K31 ["Transform"]
  GETIMPORT R18 K33 [CFrame.new]
  CALL R18 0 1
  SETTABLE R18 R16 R17
  ...
  SETLIST R14 R15 1 [1]
  NEWTABLE R15 0 1
  DUPTABLE R16 K35 [{"Id", "Schema"}]
  GETTABLEKS R17 R6 K36 ["Region"]
  SETTABLEKS R17 R16 K24 ["Id"]
  DUPTABLE R17 K40 [{"Type", "Wireframe", "Rotation"}]
  GETTABLEKS R18 R6 K36 ["Region"]
  SETTABLEKS R18 R17 K37 ["Type"]
  LOADB R18 0
  SETTABLEKS R18 R17 K38 ["Wireframe"]
  LOADB R18 0
  SETTABLEKS R18 R17 K39 ["Rotation"]
  SETTABLEKS R17 R16 K34 ["Schema"]
  SETLIST R15 R16 1 [1]
  GETTABLEKS R18 R11 K41 ["SeaLevel"]
  GETTABLEKS R19 R10 K42 ["Edit"]
  MOVE R20 R14
  MOVE R21 R15
  NAMECALL R16 R2 K28 ["new"]
  CALL R16 5 1
  DUPCLOSURE R17 K43 [PROTO_0]
  CAPTURE VAL R2
  SETTABLEKS R17 R16 K44 ["startOperation"]
  ...
  CAPTURE VAL R13
  CAPTURE VAL R1
  SETTABLEKS R17 R16 K48 ["evaporate"]
  DUPCLOSURE R17 K49 [PROTO_6]
  CAPTURE VAL R2
  CAPTURE VAL R4
  CAPTURE VAL R8
  SETTABLEKS R17 R16 K50 ["init"]
  DUPCLOSURE R17 K51 [PROTO_7]
  CAPTURE VAL R4
  CAPTURE VAL R8
  SETTABLEKS R17 R16 K52 ["setDisabledState"]
  DUPCLOSURE R17 K53 [PROTO_8]
  SETTABLEKS R17 R16 K54 ["operation"]
  DUPCLOSURE R17 K55 [PROTO_9]
  CAPTURE VAL R2
  CAPTURE VAL R11
  SETTABLEKS R17 R16 K56 ["activate"]
  RETURN R16 1
