...
MAIN:
  ...
  GETTABLEKS R10 R5 K21 ["FlattenPlane"]
  GETTABLEKS R11 R5 K22 ["Gizmo"]
  ...
  SETTABLE R20 R18 R19
  GETTABLEKS R19 R6 K37 ["Strength"]
  LOADN R20 1
  SETTABLE R20 R18 R19
  GETTABLEKS R19 R6 K38 ["FixedYPlane"]
  LOADN R20 0
  SETTABLE R20 R18 R19
  GETTABLEKS R19 R6 K20 ["FlattenMode"]
  GETTABLEKS R20 R9 K39 ["Both"]
  SETTABLE R20 R18 R19
  GETTABLEKS R19 R6 K21 ["FlattenPlane"]
  GETTABLEKS R20 R10 K40 ["Auto"]
  SETTABLE R20 R18 R19
  GETTABLEKS R19 R6 K23 ["PivotPosition"]
  GETTABLEKS R20 R12 K41 ["Center"]
  SETTABLE R20 R18 R19
  GETTABLEKS R19 R6 K24 ["Snapping"]
  GETTABLEKS R20 R13 K42 ["Off"]
  SETTABLE R20 R18 R19
  GETTABLEKS R19 R6 K43 ["State"]
  DUPTABLE R20 K45 [{"Position"}]
  LOADN R22 0
  LOADN R23 0
  LOADN R24 0
  FASTCALL VECTOR [+2]
  GETIMPORT R21 K48 [Vector3.new]
  CALL R21 3 1
  SETTABLEKS R21 R20 K44 ["Position"]
  SETTABLE R20 R18 R19
  GETTABLEKS R19 R6 K49 ["IgnoreWater"]
  LOADB R20 0
  SETTABLE R20 R18 R19
  GETTABLEKS R19 R6 K50 ["IgnoreParts"]
  LOADB R20 1
  SETTABLE R20 R18 R19
  GETTABLEKS R19 R6 K51 ["PullTerrain"]
  LOADB R20 1
  SETTABLE R20 R18 R19
  GETTABLEKS R19 R6 K52 ["WaterAutofill"]
  LOADB R20 0
  SETTABLE R20 R18 R19
  ...
  DUPCLOSURE R19 K65 [PROTO_5]
  CAPTURE VAL R1
  CAPTURE VAL R4
  SETTABLEKS R19 R18 K66 ["activate"]
  DUPCLOSURE R19 K67 [PROTO_6]
  CAPTURE VAL R1
  SETTABLEKS R19 R18 K68 ["deactivate"]
  RETURN R18 1
