...
PROTO_7:
  ...
  GETTABLEKS R10 R9 K2 ["Children"]
  LOADNIL R11
  LOADNIL R12
  FORGPREP R10
  GETTABLEKS R16 R8 K18 ["Storage"]
  GETTABLEKS R17 R14 K0 ["Id"]
  GETTABLE R15 R16 R17
  GETUPVAL R17 3
  GETTABLEKS R16 R17 K19 ["LocalSubform"]
  JUMPIFNOTEQ R15 R16 [+7]
  GETUPVAL R15 4
  GETTABLEKS R16 R14 K20 ["Value"]
  CALL R15 1 1
  SETTABLEKS R15 R14 K20 ["Value"]
  FORGLOOP R10 2 [-17]
...
MAIN:
  ...
  GETTABLEKS R14 R15 K22 ["getFFlagTerrainEditorSubformComponent"]
  CALL R13 1 1
  GETIMPORT R14 K5 [require]
  GETTABLEKS R17 R0 K10 ["Src"]
  GETTABLEKS R16 R17 K20 ["Flags"]
  GETTABLEKS R15 R16 K23 ["getFFlagTerrainEditorAnalytics"]
  CALL R14 1 1
  NEWTABLE R15 32 0
  SETTABLEKS R15 R15 K24 ["__index"]
  ...
  CAPTURE VAL R10
  CAPTURE VAL R6
  SETTABLEKS R16 R15 K30 ["registerSettings"]
  DUPCLOSURE R16 K31 [PROTO_3]
  SETTABLEKS R16 R15 K32 ["registerShortcuts"]
  DUPCLOSURE R16 K33 [PROTO_4]
  CAPTURE VAL R15
  SETTABLEKS R16 R15 K34 ["empty"]
  DUPCLOSURE R16 K35 [PROTO_5]
  CAPTURE VAL R13
  CAPTURE VAL R7
  SETTABLEKS R16 R15 K36 ["getPayload"]
  ...
  CAPTURE VAL R5
  CAPTURE VAL R2
  SETTABLEKS R16 R15 K38 ["setPayload"]
  DUPCLOSURE R16 K39 [PROTO_8]
  CAPTURE VAL R13
  CAPTURE VAL R10
  CAPTURE VAL R7
  CAPTURE VAL R6
  SETTABLEKS R16 R15 K40 ["form"]
  DUPCLOSURE R16 K41 [PROTO_9]
  SETTABLEKS R16 R15 K42 ["gizmos"]
  DUPCLOSURE R16 K43 [PROTO_11]
  SETTABLEKS R16 R15 K44 ["saveForm"]
  DUPCLOSURE R16 K45 [PROTO_13]
  SETTABLEKS R16 R15 K46 ["saveGizmos"]
  DUPCLOSURE R16 K47 [PROTO_14]
  SETTABLEKS R16 R15 K48 ["getCategory"]
  DUPCLOSURE R16 K49 [PROTO_15]
  SETTABLEKS R16 R15 K50 ["getTile"]
  DUPCLOSURE R16 K51 [PROTO_19]
  SETTABLEKS R16 R15 K52 ["activateShortcuts"]
  DUPCLOSURE R16 K53 [PROTO_20]
  SETTABLEKS R16 R15 K54 ["deactivateShortcuts"]
  DUPCLOSURE R16 K55 [PROTO_21]
  SETTABLEKS R16 R15 K56 ["activate"]
  DUPCLOSURE R16 K57 [PROTO_22]
  SETTABLEKS R16 R15 K58 ["reportAnalytics"]
  DUPCLOSURE R16 K59 [PROTO_23]
  CAPTURE VAL R14
  SETTABLEKS R16 R15 K60 ["deactivate"]
  DUPCLOSURE R16 K61 [PROTO_24]
  SETTABLEKS R16 R15 K62 ["startOperation"]
  DUPCLOSURE R16 K63 [PROTO_25]
  SETTABLEKS R16 R15 K64 ["operation"]
  DUPCLOSURE R16 K65 [PROTO_26]
  SETTABLEKS R16 R15 K66 ["note"]
  RETURN R15 1
