...
PROTO_4:
  ...
  FORGLOOP R6 2 [-67]
  RETURN R3 2
  GETTABLEKS R5 R0 K5 ["_configuration"]
  LOADNIL R6
  LOADNIL R7
  FORGPREP R5
  ...
  LOADNIL R12
  FORGPREP R10
  GETTABLEKS R16 R9 K8 ["Defaults"]
  GETTABLE R15 R16 R13
  JUMPIF R15 [+5]
  GETTABLEKS R16 R9 K7 ["Id"]
  GETTABLE R15 R3 R16
  LOADNIL R16
  ...
  GETUPVAL R18 3
  GETTABLEKS R17 R18 K10 ["LocalSession"]
  JUMPIFNOTEQ R16 R17 [+6]
  GETTABLEKS R17 R9 K7 ["Id"]
  GETTABLE R16 R4 R17
  SETTABLE R15 R16 R14
  JUMP [+24]
  GETTABLEKS R18 R9 K7 ["Id"]
  GETTABLE R17 R3 R18
  GETTABLE R16 R17 R14
  JUMPIFNOT R16 [+15]
  GETTABLEKS R19 R9 K7 ["Id"]
  GETTABLE R18 R3 R19
  GETTABLE R17 R18 R14
  FASTCALL1 TYPEOF R17 [+2]
  GETIMPORT R16 K12 [typeof]
  CALL R16 1 1
...
MAIN:
  ...
  LOADK R13 K22 ["TerrainEditorNestedSettingsFix"]
  LOADB R14 0
  ...
  CAPTURE VAL R6
  CAPTURE VAL R3
  SETTABLEKS R13 R12 K30 ["registerSettings"]
  DUPCLOSURE R13 K31 [PROTO_5]
  SETTABLEKS R13 R12 K32 ["registerShortcuts"]
  DUPCLOSURE R13 K33 [PROTO_6]
  CAPTURE VAL R12
  SETTABLEKS R13 R12 K34 ["empty"]
  DUPCLOSURE R13 K35 [PROTO_7]
  CAPTURE VAL R4
  SETTABLEKS R13 R12 K36 ["getPayload"]
  DUPCLOSURE R13 K37 [PROTO_9]
  CAPTURE VAL R6
  CAPTURE VAL R4
  CAPTURE VAL R10
  SETTABLEKS R13 R12 K38 ["setPayload"]
  DUPCLOSURE R13 K39 [PROTO_10]
  SETTABLEKS R13 R12 K40 ["getShouldBeCompact"]
  DUPCLOSURE R13 K41 [PROTO_12]
  CAPTURE VAL R6
  CAPTURE VAL R4
  SETTABLEKS R13 R12 K42 ["form"]
  DUPCLOSURE R13 K43 [PROTO_13]
  SETTABLEKS R13 R12 K44 ["gizmos"]
  DUPCLOSURE R13 K45 [PROTO_15]
  SETTABLEKS R13 R12 K46 ["saveForm"]
  DUPCLOSURE R13 K47 [PROTO_17]
  SETTABLEKS R13 R12 K48 ["saveGizmos"]
  DUPCLOSURE R13 K49 [PROTO_18]
  SETTABLEKS R13 R12 K50 ["checkDisabledState"]
  DUPCLOSURE R13 K51 [PROTO_19]
  SETTABLEKS R13 R12 K52 ["getCategory"]
  DUPCLOSURE R13 K53 [PROTO_20]
  SETTABLEKS R13 R12 K54 ["getTile"]
  DUPCLOSURE R13 K55 [PROTO_24]
  SETTABLEKS R13 R12 K56 ["activateShortcuts"]
  DUPCLOSURE R13 K57 [PROTO_25]
  SETTABLEKS R13 R12 K58 ["deactivateShortcuts"]
  DUPCLOSURE R13 K59 [PROTO_28]
  SETTABLEKS R13 R12 K60 ["activate"]
  DUPCLOSURE R13 K61 [PROTO_29]
  SETTABLEKS R13 R12 K62 ["reportAnalytics"]
  DUPCLOSURE R13 K63 [PROTO_30]
  SETTABLEKS R13 R12 K64 ["deactivate"]
  DUPCLOSURE R13 K65 [PROTO_31]
  SETTABLEKS R13 R12 K66 ["startOperation"]
  DUPCLOSURE R13 K67 [PROTO_32]
  SETTABLEKS R13 R12 K68 ["operation"]
  DUPCLOSURE R13 K69 [PROTO_33]
  SETTABLEKS R13 R12 K70 ["reportError"]
  DUPCLOSURE R13 K71 [PROTO_34]
  SETTABLEKS R13 R12 K72 ["clearError"]
  DUPCLOSURE R13 K73 [PROTO_35]
  SETTABLEKS R13 R12 K74 ["hasError"]
  DUPCLOSURE R13 K75 [PROTO_36]
  SETTABLEKS R13 R12 K76 ["setValidateFunction"]
  DUPCLOSURE R13 K77 [PROTO_37]
  SETTABLEKS R13 R12 K78 ["getValidateFunction"]
  DUPCLOSURE R13 K79 [PROTO_38]
  SETTABLEKS R13 R12 K80 ["setDisabledState"]
  DUPCLOSURE R13 K81 [PROTO_39]
  CAPTURE VAL R9
  SETTABLEKS R13 R12 K82 ["finishOperation"]
  DUPCLOSURE R13 K83 [PROTO_40]
  SETTABLEKS R13 R12 K84 ["note"]
  RETURN R12 1
