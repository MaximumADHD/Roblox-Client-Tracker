...
MAIN:
  ...
  GETTABLEKS R18 R19 K28 ["getFFlagTerrainEditorManualPlaneLockRelative"]
  CALL R17 1 1
  NEWTABLE R18 0 1
  DUPTABLE R19 K31 [{"Defaults", "Id"}]
  NEWTABLE R20 8 0
  GETTABLEKS R21 R8 K19 ["BrushShape"]
  GETTABLEKS R22 R9 K32 ["Sphere"]
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R8 K33 ["BrushSize"]
  ...
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R8 K38 ["Strength"]
  LOADN R22 1
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R8 K22 ["PivotPosition"]
  GETTABLEKS R22 R12 K39 ["Center"]
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R8 K24 ["Snapping"]
  GETTABLEKS R22 R14 K40 ["Off"]
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R8 K41 ["State"]
  ...
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R8 K47 ["IgnoreWater"]
  LOADB R22 0
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R8 K48 ["IgnoreParts"]
  LOADB R22 1
  SETTABLE R22 R20 R21
  SETTABLEKS R20 R19 K29 ["Defaults"]
  GETTABLEKS R20 R10 K18 ["BrushSettings"]
  SETTABLEKS R20 R19 K30 ["Id"]
  SETLIST R18 R19 1 [1]
  NEWTABLE R19 0 2
  DUPTABLE R20 K50 [{"Id", "Schema"}]
  GETTABLEKS R21 R11 K51 ["Brush"]
  SETTABLEKS R21 R20 K30 ["Id"]
  DUPTABLE R21 K53 [{"Type"}]
  GETTABLEKS R22 R11 K51 ["Brush"]
  SETTABLEKS R22 R21 K52 ["Type"]
  SETTABLEKS R21 R20 K49 ["Schema"]
  DUPTABLE R21 K50 [{"Id", "Schema"}]
  GETTABLEKS R22 R11 K54 ["Plane"]
  SETTABLEKS R22 R21 K30 ["Id"]
  DUPTABLE R22 K53 [{"Type"}]
  GETTABLEKS R23 R11 K54 ["Plane"]
  SETTABLEKS R23 R22 K52 ["Type"]
  SETTABLEKS R22 R21 K49 ["Schema"]
  SETLIST R19 R20 2 [1]
  GETTABLEKS R22 R16 K55 ["Smooth"]
  GETTABLEKS R23 R15 K56 ["Edit"]
  MOVE R24 R18
  MOVE R25 R19
  ...
  CAPTURE VAL R6
  CAPTURE VAL R4
  SETTABLEKS R21 R20 K58 ["init"]
  DUPCLOSURE R21 K59 [PROTO_3]
  CAPTURE VAL R2
  SETTABLEKS R21 R20 K60 ["saveForm"]
  DUPCLOSURE R21 K61 [PROTO_4]
  CAPTURE VAL R2
  SETTABLEKS R21 R20 K62 ["saveGizmos"]
  DUPCLOSURE R21 K63 [PROTO_5]
  CAPTURE VAL R5
  CAPTURE VAL R1
  SETTABLEKS R21 R20 K64 ["startOperation"]
  DUPCLOSURE R21 K65 [PROTO_8]
  CAPTURE VAL R2
  CAPTURE VAL R10
  CAPTURE VAL R8
  CAPTURE VAL R13
  CAPTURE VAL R16
  SETTABLEKS R21 R20 K66 ["activate"]
  DUPCLOSURE R21 K67 [PROTO_9]
  CAPTURE VAL R2
  SETTABLEKS R21 R20 K68 ["deactivate"]
  DUPCLOSURE R21 K69 [PROTO_10]
  CAPTURE VAL R3
  CAPTURE VAL R16
  SETTABLEKS R21 R20 K70 ["reportAnalytics"]
  RETURN R20 1
