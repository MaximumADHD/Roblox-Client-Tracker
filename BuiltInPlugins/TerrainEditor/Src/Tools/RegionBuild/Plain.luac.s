MAIN:
  ...
  DUPTABLE R15 K41 [{"Unit", "MaterialList"}]
  GETTABLEKS R16 R8 K42 ["Percentage"]
  SETTABLEKS R16 R15 K39 ["Unit"]
  NEWTABLE R16 0 1
  DUPTABLE R17 K47 [{"Material", "MinHeight", "MaxHeight", "MinSlope", "MaxSlope"}]
  GETIMPORT R18 K50 [Enum.Material.Grass]
  SETTABLEKS R18 R17 K38 ["Material"]
  LOADN R18 0
  SETTABLEKS R18 R17 K43 ["MinHeight"]
  LOADN R18 1
  SETTABLEKS R18 R17 K44 ["MaxHeight"]
  LOADN R18 0
  SETTABLEKS R18 R17 K45 ["MinSlope"]
  LOADN R18 90
  SETTABLEKS R18 R17 K46 ["MaxSlope"]
  SETLIST R16 R17 1 [1]
  SETTABLEKS R16 R15 K40 ["MaterialList"]
  SETTABLE R15 R13 R14
  GETTABLEKS R14 R5 K51 ["Size"]
  LOADN R16 244
  LOADN R17 50
  LOADN R18 244
  FASTCALL VECTOR [+2]
  GETIMPORT R15 K53 [Vector3.new]
  CALL R15 3 1
  SETTABLE R15 R13 R14
  GETTABLEKS R14 R5 K54 ["SnapToVoxels"]
  LOADB R15 1
  SETTABLE R15 R13 R14
  GETTABLEKS R14 R5 K55 ["Transform"]
  GETIMPORT R15 K57 [CFrame.new]
  CALL R15 0 1
  SETTABLE R15 R13 R14
  ...
  SETLIST R11 R12 1 [1]
  NEWTABLE R12 0 1
  DUPTABLE R13 K58 [{"Id", "Schema"}]
  GETTABLEKS R14 R7 K59 ["Region"]
  SETTABLEKS R14 R13 K22 ["Id"]
  DUPTABLE R14 K63 [{"Type", "Wireframe", "Rotation"}]
  GETTABLEKS R15 R7 K59 ["Region"]
  SETTABLEKS R15 R14 K60 ["Type"]
  LOADB R15 0
  SETTABLEKS R15 R14 K61 ["Wireframe"]
  LOADB R15 0
  SETTABLEKS R15 R14 K62 ["Rotation"]
  SETTABLEKS R14 R13 K23 ["Schema"]
  SETLIST R12 R13 1 [1]
  GETTABLEKS R15 R10 K64 ["Plain"]
  GETTABLEKS R16 R9 K65 ["None"]
  MOVE R17 R11
  MOVE R18 R12
