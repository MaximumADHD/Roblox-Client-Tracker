MAIN:
  ...
  LOADN R15 0
  SETTABLE R15 R13 R14
  GETTABLEKS R14 R5 K37 ["NoiseScale"]
  LOADK R15 K38 [0.4]
  SETTABLE R15 R13 R14
  ...
  GETIMPORT R18 K55 [Enum.Material.Rock]
  ...
  GETIMPORT R19 K58 [Enum.Material.Grass]
  ...
  DUPTABLE R19 K52 [{"Material", "MinHeight", "MaxHeight", "MinSlope", "MaxSlope", "Priority"}]
  GETIMPORT R20 K61 [Enum.Material.Ground]
  SETTABLEKS R20 R19 K39 ["Material"]
  LOADK R20 K59 [0.1]
  SETTABLEKS R20 R19 K47 ["MinHeight"]
  LOADK R20 K62 [0.8]
  SETTABLEKS R20 R19 K48 ["MaxHeight"]
  LOADN R20 0
  SETTABLEKS R20 R19 K49 ["MinSlope"]
  LOADN R20 20
  SETTABLEKS R20 R19 K50 ["MaxSlope"]
  LOADN R20 3
  SETTABLEKS R20 R19 K51 ["Priority"]
  DUPTABLE R20 K52 [{"Material", "MinHeight", "MaxHeight", "MinSlope", "MaxSlope", "Priority"}]
  GETIMPORT R21 K64 [Enum.Material.Mud]
  SETTABLEKS R21 R20 K39 ["Material"]
  LOADN R21 0
  SETTABLEKS R21 R20 K47 ["MinHeight"]
  LOADK R21 K56 [0.7]
  SETTABLEKS R21 R20 K48 ["MaxHeight"]
  LOADN R21 0
  SETTABLEKS R21 R20 K49 ["MinSlope"]
  LOADN R21 30
  SETTABLEKS R21 R20 K50 ["MaxSlope"]
  LOADN R21 2
  SETTABLEKS R21 R20 K51 ["Priority"]
  SETLIST R16 R17 4 [1]
  SETTABLEKS R16 R15 K44 ["MaterialList"]
  SETTABLE R15 R13 R14
  GETTABLEKS R14 R5 K65 ["PlacementMode"]
  LOADB R15 1
  SETTABLE R15 R13 R14
  GETTABLEKS R14 R5 K66 ["Size"]
  LOADN R16 200
  LOADN R17 100
  LOADN R18 200
  FASTCALL VECTOR [+2]
  GETIMPORT R15 K68 [Vector3.new]
  CALL R15 3 1
  SETTABLE R15 R13 R14
  GETTABLEKS R14 R5 K69 ["SnapToVoxels"]
  LOADB R15 1
  SETTABLE R15 R13 R14
  GETTABLEKS R14 R5 K70 ["Transform"]
  GETIMPORT R15 K72 [CFrame.new]
  CALL R15 0 1
  SETTABLE R15 R13 R14
  ...
  SETLIST R11 R12 1 [1]
  NEWTABLE R12 0 2
  DUPTABLE R13 K73 [{"Id", "Schema"}]
  GETTABLEKS R14 R7 K74 ["Region"]
  SETTABLEKS R14 R13 K22 ["Id"]
  DUPTABLE R14 K78 [{"Type", "Wireframe", "Rotation"}]
  GETTABLEKS R15 R7 K74 ["Region"]
  SETTABLEKS R15 R14 K75 ["Type"]
  LOADB R15 0
  SETTABLEKS R15 R14 K76 ["Wireframe"]
  LOADB R15 0
  SETTABLEKS R15 R14 K77 ["Rotation"]
  SETTABLEKS R14 R13 K23 ["Schema"]
  DUPTABLE R14 K73 [{"Id", "Schema"}]
  GETTABLEKS R15 R7 K79 ["Placement"]
  SETTABLEKS R15 R14 K22 ["Id"]
  DUPTABLE R15 K80 [{"Type"}]
  GETTABLEKS R16 R7 K79 ["Placement"]
  SETTABLEKS R16 R15 K75 ["Type"]
  SETTABLEKS R15 R14 K23 ["Schema"]
  SETLIST R12 R13 2 [1]
  GETTABLEKS R15 R10 K81 ["Mountain"]
