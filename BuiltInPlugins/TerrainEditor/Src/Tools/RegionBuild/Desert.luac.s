MAIN:
  ...
  GETIMPORT R18 K55 [Enum.Material.Sand]
  ...
  SETTABLE R15 R13 R14
  GETTABLEKS R14 R5 K56 ["PlacementMode"]
  LOADB R15 1
  SETTABLE R15 R13 R14
  GETTABLEKS R14 R5 K57 ["Size"]
  LOADN R16 244
  LOADN R17 50
  LOADN R18 244
  FASTCALL VECTOR [+2]
  GETIMPORT R15 K59 [Vector3.new]
  CALL R15 3 1
  SETTABLE R15 R13 R14
  GETTABLEKS R14 R5 K60 ["SnapToVoxels"]
  LOADB R15 1
  SETTABLE R15 R13 R14
  GETTABLEKS R14 R5 K61 ["Transform"]
  GETIMPORT R15 K63 [CFrame.new]
  CALL R15 0 1
  SETTABLE R15 R13 R14
  ...
  SETLIST R11 R12 1 [1]
  NEWTABLE R12 0 2
  DUPTABLE R13 K64 [{"Id", "Schema"}]
  GETTABLEKS R14 R7 K65 ["Region"]
  SETTABLEKS R14 R13 K22 ["Id"]
  DUPTABLE R14 K69 [{"Type", "Wireframe", "Rotation"}]
  GETTABLEKS R15 R7 K65 ["Region"]
  SETTABLEKS R15 R14 K66 ["Type"]
  LOADB R15 0
  SETTABLEKS R15 R14 K67 ["Wireframe"]
  LOADB R15 0
  SETTABLEKS R15 R14 K68 ["Rotation"]
  SETTABLEKS R14 R13 K23 ["Schema"]
  DUPTABLE R14 K64 [{"Id", "Schema"}]
  GETTABLEKS R15 R7 K70 ["Placement"]
  SETTABLEKS R15 R14 K22 ["Id"]
  DUPTABLE R15 K71 [{"Type"}]
  GETTABLEKS R16 R7 K70 ["Placement"]
  SETTABLEKS R16 R15 K66 ["Type"]
  SETTABLEKS R15 R14 K23 ["Schema"]
  SETLIST R12 R13 2 [1]
  GETTABLEKS R15 R10 K72 ["Desert"]
  GETTABLEKS R16 R9 K73 ["None"]
  MOVE R17 R11
  MOVE R18 R12
