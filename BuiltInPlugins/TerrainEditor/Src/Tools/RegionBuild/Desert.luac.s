MAIN:
  ...
  GETIMPORT R18 K51 [Enum.Material.Sand]
  ...
  CALL R15 3 1
  SETTABLE R15 R13 R14
  GETTABLEKS R14 R5 K55 ["SnapToVoxels"]
  LOADB R15 1
  SETTABLE R15 R13 R14
  GETTABLEKS R14 R5 K56 ["Transform"]
  GETIMPORT R15 K58 [CFrame.new]
  CALL R15 0 1
  SETTABLE R15 R13 R14
  ...
  SETLIST R11 R12 1 [1]
  NEWTABLE R12 0 1
  DUPTABLE R13 K59 [{"Id", "Schema"}]
  GETTABLEKS R14 R7 K60 ["Region"]
  SETTABLEKS R14 R13 K22 ["Id"]
  DUPTABLE R14 K64 [{"Type", "Wireframe", "Rotation"}]
  GETTABLEKS R15 R7 K60 ["Region"]
  SETTABLEKS R15 R14 K61 ["Type"]
  LOADB R15 0
  SETTABLEKS R15 R14 K62 ["Wireframe"]
  LOADB R15 0
  SETTABLEKS R15 R14 K63 ["Rotation"]
  SETTABLEKS R14 R13 K23 ["Schema"]
  SETLIST R12 R13 1 [1]
  GETTABLEKS R15 R10 K65 ["Desert"]
  GETTABLEKS R16 R9 K66 ["None"]
  MOVE R17 R11
  MOVE R18 R12
