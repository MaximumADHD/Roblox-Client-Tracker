MAIN:
  ...
  GETIMPORT R18 K55 [Enum.Material.Sandstone]
  ...
  SETTABLE R15 R13 R14
  GETTABLEKS R14 R5 K58 ["PlacementMode"]
  LOADB R15 1
  SETTABLE R15 R13 R14
  GETTABLEKS R14 R5 K59 ["RimHeight"]
  LOADK R15 K60 [0.3]
  SETTABLE R15 R13 R14
  ...
  LOADB R15 1
  SETTABLE R15 R13 R14
  GETTABLEKS R14 R5 K65 ["TopRadius"]
  LOADK R15 K66 [0.1]
  SETTABLE R15 R13 R14
  GETTABLEKS R14 R5 K67 ["Transform"]
  GETIMPORT R15 K69 [CFrame.new]
  CALL R15 0 1
  SETTABLE R15 R13 R14
  ...
  SETLIST R11 R12 1 [1]
  NEWTABLE R12 0 2
  DUPTABLE R13 K70 [{"Id", "Schema"}]
  GETTABLEKS R14 R7 K71 ["Region"]
  SETTABLEKS R14 R13 K22 ["Id"]
  DUPTABLE R14 K75 [{"Type", "Wireframe", "Rotation"}]
  GETTABLEKS R15 R7 K71 ["Region"]
  SETTABLEKS R15 R14 K72 ["Type"]
  LOADB R15 0
  SETTABLEKS R15 R14 K73 ["Wireframe"]
  LOADB R15 0
  SETTABLEKS R15 R14 K74 ["Rotation"]
  SETTABLEKS R14 R13 K23 ["Schema"]
  DUPTABLE R14 K70 [{"Id", "Schema"}]
  GETTABLEKS R15 R7 K76 ["Placement"]
  SETTABLEKS R15 R14 K22 ["Id"]
  DUPTABLE R15 K77 [{"Type"}]
  GETTABLEKS R16 R7 K76 ["Placement"]
  SETTABLEKS R16 R15 K72 ["Type"]
  SETTABLEKS R15 R14 K23 ["Schema"]
  SETLIST R12 R13 2 [1]
  GETTABLEKS R15 R10 K78 ["Mesa"]
