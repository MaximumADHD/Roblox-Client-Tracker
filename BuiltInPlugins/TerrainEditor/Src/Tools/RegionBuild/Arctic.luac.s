MAIN:
  ...
  LOADB R15 1
  SETTABLE R15 R13 R14
  GETTABLEKS R14 R5 K59 ["Size"]
  LOADN R16 244
  LOADN R17 100
  LOADN R18 244
  FASTCALL VECTOR [+2]
  GETIMPORT R15 K61 [Vector3.new]
  CALL R15 3 1
  SETTABLE R15 R13 R14
  GETTABLEKS R14 R5 K62 ["SnapToVoxels"]
  LOADB R15 1
  SETTABLE R15 R13 R14
  GETTABLEKS R14 R5 K63 ["Transform"]
  GETIMPORT R15 K65 [CFrame.new]
  CALL R15 0 1
  SETTABLE R15 R13 R14
  ...
  SETLIST R11 R12 1 [1]
  NEWTABLE R12 0 2
  DUPTABLE R13 K66 [{"Id", "Schema"}]
  GETTABLEKS R14 R7 K67 ["Region"]
  SETTABLEKS R14 R13 K22 ["Id"]
  DUPTABLE R14 K71 [{"Type", "Wireframe", "Rotation"}]
  GETTABLEKS R15 R7 K67 ["Region"]
  SETTABLEKS R15 R14 K68 ["Type"]
  LOADB R15 0
  SETTABLEKS R15 R14 K69 ["Wireframe"]
  LOADB R15 0
  SETTABLEKS R15 R14 K70 ["Rotation"]
  SETTABLEKS R14 R13 K23 ["Schema"]
  DUPTABLE R14 K66 [{"Id", "Schema"}]
  GETTABLEKS R15 R7 K72 ["Placement"]
  SETTABLEKS R15 R14 K22 ["Id"]
  DUPTABLE R15 K73 [{"Type"}]
  GETTABLEKS R16 R7 K72 ["Placement"]
  SETTABLEKS R16 R15 K68 ["Type"]
  SETTABLEKS R15 R14 K23 ["Schema"]
  SETLIST R12 R13 2 [1]
  GETTABLEKS R15 R10 K74 ["Arctic"]
