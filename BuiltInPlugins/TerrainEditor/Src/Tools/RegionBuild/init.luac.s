...
PROTO_1:
  ...
  JUMPIFNOT R0 [+7]
  GETUPVAL R1 0
  GETTABLEKS R0 R1 K11 ["OnInternalsChanged"]
  NAMECALL R0 R0 K12 ["Fire"]
  CALL R0 1 0
  RETURN R0 0
  GETUPVAL R1 0
  GETTABLEKS R0 R1 K13 ["OnGizmoChanged"]
  NAMECALL R0 R0 K12 ["Fire"]
  CALL R0 1 0
  RETURN R0 0
...
PROTO_2:
  ...
  CAPTURE UPVAL U1
  CAPTURE UPVAL U6
  SETTABLEKS R16 R15 K16 ["OnClick"]
  SETTABLEKS R15 R14 K7 ["Schema"]
  SETTABLE R14 R12 R13
  SETTABLE R12 R10 R11
  SETTABLEKS R10 R9 K18 ["_overrides"]
  FORGLOOP R3 2 [-63]
  RETURN R0 0
