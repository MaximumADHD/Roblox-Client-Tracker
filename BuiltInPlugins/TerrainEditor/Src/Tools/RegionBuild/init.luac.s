...
PROTO_14:
  ...
  CALL R2 1 0
  GETTABLEKS R2 R0 K4 ["_onFormChangedForwarder"]
  JUMPIFNOT R2 [+5]
  GETTABLEKS R2 R0 K4 ["_onFormChangedForwarder"]
  NAMECALL R2 R2 K5 ["Disconnect"]
  CALL R2 1 0
  GETTABLEKS R2 R0 K6 ["_onGizmoChangedForwarder"]
  JUMPIFNOT R2 [+5]
  GETTABLEKS R2 R0 K6 ["_onGizmoChangedForwarder"]
  NAMECALL R2 R2 K5 ["Disconnect"]
  CALL R2 1 0
  GETTABLEKS R2 R0 K7 ["_mouseDownConnection"]
  JUMPIFNOT R2 [+5]
  GETTABLEKS R2 R0 K7 ["_mouseDownConnection"]
  NAMECALL R2 R2 K5 ["Disconnect"]
  CALL R2 1 0
  GETTABLEKS R2 R0 K8 ["_onUndoConnection"]
  JUMPIFNOT R2 [+5]
  GETTABLEKS R2 R0 K8 ["_onUndoConnection"]
  NAMECALL R2 R2 K5 ["Disconnect"]
  CALL R2 1 0
  NAMECALL R2 R0 K9 ["cancelRecording"]
  CALL R2 1 0
  NAMECALL R2 R0 K10 ["destroyStamp"]
  CALL R2 1 0
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R5 R6 K14 ["getFFlagUseMaterialLUT"]
  CALL R4 1 1
