...
PROTO_2:
  ...
  NEWTABLE R3 1 0
  GETUPVAL R5 2
  GETTABLEKS R4 R5 K8 ["TransformSettings"]
  NEWTABLE R5 2 0
  GETUPVAL R7 6
  GETTABLEKS R6 R7 K9 ["SourceMaterial"]
  DUPTABLE R7 K4 [{"Schema"}]
  DUPTABLE R8 K11 [{"AllowAir"}]
  LOADB R9 1
  SETTABLEKS R9 R8 K10 ["AllowAir"]
  SETTABLEKS R8 R7 K3 ["Schema"]
  SETTABLE R7 R5 R6
  GETUPVAL R7 6
  GETTABLEKS R6 R7 K12 ["TargetMaterial"]
  DUPTABLE R7 K4 [{"Schema"}]
  DUPTABLE R8 K11 [{"AllowAir"}]
  LOADB R9 1
  SETTABLEKS R9 R8 K10 ["AllowAir"]
  ...
  SETTABLEKS R3 R0 K7 ["_overrides"]
  LOADN R3 0
  SETTABLEKS R3 R0 K13 ["_brushTime"]
  LOADN R3 0
  SETTABLEKS R3 R0 K14 ["_brushUsages"]
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R20 R21 K30 ["getFFlagTerrainEditorMiscBrushImprovements"]
  CALL R19 1 1
  ...
  NEWTABLE R23 8 0
  GETTABLEKS R24 R8 K19 ["BrushShape"]
  GETTABLEKS R25 R9 K35 ["Sphere"]
  SETTABLE R25 R23 R24
  GETTABLEKS R24 R8 K36 ["BrushSize"]
  DUPTABLE R25 K40 [{"Height", "Locked", "Size"}]
  LOADN R26 6
  SETTABLEKS R26 R25 K37 ["Height"]
  LOADB R26 1
  SETTABLEKS R26 R25 K38 ["Locked"]
  LOADN R26 6
  SETTABLEKS R26 R25 K39 ["Size"]
  SETTABLE R25 R23 R24
  GETTABLEKS R24 R8 K24 ["PivotPosition"]
  GETTABLEKS R25 R14 K41 ["Center"]
  SETTABLE R25 R23 R24
  GETTABLEKS R24 R8 K26 ["Snapping"]
  GETTABLEKS R25 R16 K42 ["Off"]
  SETTABLE R25 R23 R24
  GETTABLEKS R24 R8 K43 ["State"]
  DUPTABLE R25 K45 [{"Position"}]
  LOADN R27 0
  LOADN R28 0
  LOADN R29 0
  FASTCALL VECTOR [+2]
  GETIMPORT R26 K48 [Vector3.new]
  CALL R26 3 1
  SETTABLEKS R26 R25 K44 ["Position"]
  SETTABLE R25 R23 R24
  GETTABLEKS R24 R8 K49 ["IgnoreWater"]
  LOADB R25 0
  SETTABLE R25 R23 R24
  GETTABLEKS R24 R8 K50 ["IgnoreParts"]
  LOADB R25 1
  SETTABLE R25 R23 R24
  SETTABLEKS R23 R22 K32 ["Defaults"]
  GETTABLEKS R23 R10 K18 ["BrushSettings"]
  SETTABLEKS R23 R22 K33 ["Id"]
  DUPTABLE R23 K34 [{"Defaults", "Id"}]
  NEWTABLE R24 4 0
  GETTABLEKS R25 R13 K22 ["MaterialMode"]
  GETTABLEKS R26 R12 K51 ["Paint"]
  SETTABLE R26 R24 R25
  GETTABLEKS R25 R13 K52 ["SourceMaterial"]
  GETIMPORT R26 K56 [Enum.Material.Grass]
  SETTABLE R26 R24 R25
  GETTABLEKS R25 R13 K57 ["TargetMaterial"]
  GETIMPORT R26 K56 [Enum.Material.Grass]
  SETTABLE R26 R24 R25
  ...
  GETTABLEKS R24 R11 K60 ["Brush"]
  SETTABLEKS R24 R23 K33 ["Id"]
  DUPTABLE R24 K62 [{"Type"}]
  GETTABLEKS R25 R11 K60 ["Brush"]
  SETTABLEKS R25 R24 K61 ["Type"]
  SETTABLEKS R24 R23 K58 ["Schema"]
  DUPTABLE R24 K59 [{"Id", "Schema"}]
  GETTABLEKS R25 R11 K63 ["Plane"]
  SETTABLEKS R25 R24 K33 ["Id"]
  DUPTABLE R25 K62 [{"Type"}]
  GETTABLEKS R26 R11 K63 ["Plane"]
  SETTABLEKS R26 R25 K61 ["Type"]
  SETTABLEKS R25 R24 K58 ["Schema"]
  SETLIST R22 R23 2 [1]
  GETTABLEKS R25 R18 K51 ["Paint"]
  GETTABLEKS R26 R17 K64 ["Edit"]
  MOVE R27 R21
  MOVE R28 R22
  NAMECALL R23 R2 K47 ["new"]
  CALL R23 5 1
  DUPCLOSURE R24 K65 [PROTO_2]
  CAPTURE VAL R2
  CAPTURE VAL R20
  CAPTURE VAL R10
  CAPTURE VAL R8
  ...
  DUPCLOSURE R24 K67 [PROTO_3]
  CAPTURE VAL R2
  SETTABLEKS R24 R23 K68 ["saveForm"]
  DUPCLOSURE R24 K69 [PROTO_4]
  CAPTURE VAL R2
  SETTABLEKS R24 R23 K70 ["saveGizmos"]
  DUPCLOSURE R24 K71 [PROTO_5]
  CAPTURE VAL R5
  CAPTURE VAL R1
  SETTABLEKS R24 R23 K72 ["startOperation"]
  DUPCLOSURE R24 K73 [PROTO_8]
  CAPTURE VAL R2
  CAPTURE VAL R19
  CAPTURE VAL R10
  CAPTURE VAL R8
  ...
  DUPCLOSURE R24 K75 [PROTO_9]
  CAPTURE VAL R2
  SETTABLEKS R24 R23 K76 ["deactivate"]
  DUPCLOSURE R24 K77 [PROTO_10]
  CAPTURE VAL R3
  CAPTURE VAL R18
