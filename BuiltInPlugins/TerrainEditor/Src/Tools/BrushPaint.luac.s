...
MAIN:
  ...
  LOADN R27 0
  FASTCALL VECTOR [+2]
  GETIMPORT R24 K45 [Vector3.new]
  CALL R24 3 1
  SETTABLEKS R24 R23 K41 ["Position"]
  SETTABLE R23 R21 R22
  GETTABLEKS R22 R8 K46 ["IgnoreWater"]
  LOADB R23 0
  SETTABLE R23 R21 R22
  GETTABLEKS R22 R8 K47 ["IgnoreParts"]
  LOADB R23 1
  SETTABLE R23 R21 R22
  ...
  GETTABLEKS R24 R12 K48 ["Paint"]
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R13 K49 ["SourceMaterial"]
  GETIMPORT R24 K53 [Enum.Material.Grass]
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R13 K54 ["TargetMaterial"]
  GETIMPORT R24 K53 [Enum.Material.Grass]
  SETTABLE R24 R22 R23
  ...
  GETTABLEKS R22 R11 K57 ["Brush"]
  SETTABLEKS R22 R21 K30 ["Id"]
  DUPTABLE R22 K59 [{"Type"}]
  GETTABLEKS R23 R11 K57 ["Brush"]
  ...
  GETTABLEKS R24 R11 K60 ["Plane"]
  SETTABLEKS R24 R23 K58 ["Type"]
  SETTABLEKS R23 R22 K55 ["Schema"]
  SETLIST R20 R21 2 [1]
  GETTABLEKS R23 R18 K48 ["Paint"]
  GETTABLEKS R24 R17 K61 ["Edit"]
  MOVE R25 R19
  MOVE R26 R20
  NAMECALL R21 R2 K44 ["new"]
  CALL R21 5 1
  DUPCLOSURE R22 K62 [PROTO_2]
  CAPTURE VAL R2
  CAPTURE VAL R10
  CAPTURE VAL R8
  CAPTURE VAL R6
  ...
  CAPTURE VAL R15
  CAPTURE VAL R18
  SETTABLEKS R22 R21 K71 ["activate"]
  DUPCLOSURE R22 K72 [PROTO_9]
  CAPTURE VAL R2
  SETTABLEKS R22 R21 K73 ["deactivate"]
  DUPCLOSURE R22 K74 [PROTO_10]
  CAPTURE VAL R3
  CAPTURE VAL R18
  SETTABLEKS R22 R21 K75 ["reportAnalytics"]
  RETURN R21 1
