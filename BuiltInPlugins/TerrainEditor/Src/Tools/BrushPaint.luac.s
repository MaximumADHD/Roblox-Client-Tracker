...
MAIN:
  ...
  GETTABLEKS R20 R21 K30 ["getFFlagTerrainEditorManualPlaneLockRelative"]
  CALL R19 1 1
  NEWTABLE R20 0 2
  DUPTABLE R21 K33 [{"Defaults", "Id"}]
  NEWTABLE R22 8 0
  GETTABLEKS R23 R8 K19 ["BrushShape"]
  GETTABLEKS R24 R9 K34 ["Sphere"]
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R8 K35 ["BrushSize"]
  DUPTABLE R24 K39 [{"Height", "Locked", "Size"}]
  LOADN R25 6
  SETTABLEKS R25 R24 K36 ["Height"]
  LOADB R25 1
  SETTABLEKS R25 R24 K37 ["Locked"]
  LOADN R25 6
  SETTABLEKS R25 R24 K38 ["Size"]
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R8 K24 ["PivotPosition"]
  GETTABLEKS R24 R14 K40 ["Center"]
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R8 K26 ["Snapping"]
  GETTABLEKS R24 R16 K41 ["Off"]
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R8 K42 ["State"]
  DUPTABLE R24 K44 [{"Position"}]
  LOADN R26 0
  LOADN R27 0
  LOADN R28 0
  FASTCALL VECTOR [+2]
  ...
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R8 K48 ["IgnoreWater"]
  LOADB R24 0
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R8 K49 ["IgnoreParts"]
  LOADB R24 1
  SETTABLE R24 R22 R23
  SETTABLEKS R22 R21 K31 ["Defaults"]
  GETTABLEKS R22 R10 K18 ["BrushSettings"]
  SETTABLEKS R22 R21 K32 ["Id"]
  DUPTABLE R22 K33 [{"Defaults", "Id"}]
  NEWTABLE R23 4 0
  GETTABLEKS R24 R13 K22 ["MaterialMode"]
  GETTABLEKS R25 R12 K50 ["Paint"]
  SETTABLE R25 R23 R24
  GETTABLEKS R24 R13 K51 ["SourceMaterial"]
  GETIMPORT R25 K55 [Enum.Material.Grass]
  SETTABLE R25 R23 R24
  GETTABLEKS R24 R13 K56 ["TargetMaterial"]
  GETIMPORT R25 K55 [Enum.Material.Grass]
  SETTABLE R25 R23 R24
  SETTABLEKS R23 R22 K31 ["Defaults"]
  GETTABLEKS R23 R10 K23 ["MaterialSettings"]
  SETTABLEKS R23 R22 K32 ["Id"]
  SETLIST R20 R21 2 [1]
  NEWTABLE R21 0 2
  DUPTABLE R22 K58 [{"Id", "Schema"}]
  GETTABLEKS R23 R11 K59 ["Brush"]
  SETTABLEKS R23 R22 K32 ["Id"]
  DUPTABLE R23 K61 [{"Type"}]
  GETTABLEKS R24 R11 K59 ["Brush"]
  SETTABLEKS R24 R23 K60 ["Type"]
  SETTABLEKS R23 R22 K57 ["Schema"]
  DUPTABLE R23 K58 [{"Id", "Schema"}]
  ...
  SETTABLEKS R24 R23 K57 ["Schema"]
  SETLIST R21 R22 2 [1]
  GETTABLEKS R24 R18 K50 ["Paint"]
  GETTABLEKS R25 R17 K63 ["Edit"]
  MOVE R26 R20
  MOVE R27 R21
  NAMECALL R22 R2 K46 ["new"]
  CALL R22 5 1
  ...
  DUPCLOSURE R23 K74 [PROTO_9]
  CAPTURE VAL R2
  SETTABLEKS R23 R22 K75 ["deactivate"]
  DUPCLOSURE R23 K76 [PROTO_10]
  CAPTURE VAL R3
  CAPTURE VAL R18
