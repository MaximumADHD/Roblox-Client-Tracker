...
MAIN:
  ...
  GETTABLEKS R4 R5 K11 ["getFFlagTerrainEditorClearFix"]
  CALL R3 1 1
  ...
  CAPTURE VAL R6
  CAPTURE VAL R7
  SETTABLEKS R13 R12 K29 ["updateDisabled"]
  DUPCLOSURE R13 K30 [PROTO_5]
  CAPTURE VAL R1
  CAPTURE VAL R3
  CAPTURE VAL R9
  SETTABLEKS R13 R12 K31 ["activate"]
  MOVE R13 R3
  CALL R13 0 1
  JUMPIFNOT R13 [+4]
  DUPCLOSURE R13 K32 [PROTO_6]
  CAPTURE VAL R1
  SETTABLEKS R13 R12 K33 ["deactivate"]
  RETURN R12 1
