...
MAIN:
  ...
  GETTABLEKS R5 R6 K14 ["SculptOperation"]
  CALL R4 1 1
  GETIMPORT R5 K5 [require]
  GETTABLEKS R7 R0 K10 ["Src"]
  GETTABLEKS R6 R7 K15 ["Types"]
  CALL R5 1 1
  GETTABLEKS R6 R5 K16 ["BrushMode"]
  GETTABLEKS R7 R5 K17 ["BrushSettings"]
  GETTABLEKS R8 R5 K18 ["BrushShape"]
  GETTABLEKS R9 R5 K19 ["Category"]
  GETTABLEKS R10 R5 K20 ["Gizmo"]
  GETTABLEKS R11 R5 K21 ["PivotPosition"]
  GETTABLEKS R12 R5 K22 ["PlaneLock"]
  GETTABLEKS R13 R5 K23 ["MaterialSettings"]
  ...
  GETTABLEKS R18 R19 K28 ["getFFlagTerrainEditorPivotPositionSculpt"]
  CALL R17 1 1
  NEWTABLE R18 0 2
  DUPTABLE R19 K31 [{"Defaults", "Id"}]
  NEWTABLE R20 16 0
  GETTABLEKS R21 R7 K16 ["BrushMode"]
  GETTABLEKS R22 R6 K32 ["Add"]
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R7 K18 ["BrushShape"]
  GETTABLEKS R22 R8 K33 ["Sphere"]
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R7 K34 ["BrushSize"]
  DUPTABLE R22 K38 [{"Height", "Locked", "Size"}]
  LOADN R23 6
  SETTABLEKS R23 R22 K35 ["Height"]
  LOADB R23 1
  SETTABLEKS R23 R22 K36 ["Locked"]
  LOADN R23 6
  SETTABLEKS R23 R22 K37 ["Size"]
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R7 K21 ["PivotPosition"]
  MOVE R23 R17
  CALL R23 0 1
  JUMPIFNOT R23 [+3]
  GETTABLEKS R22 R11 K39 ["Center"]
  JUMP [+1]
  LOADNIL R22
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R7 K40 ["Strength"]
  LOADN R22 1
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R7 K41 ["State"]
  DUPTABLE R22 K43 [{"Position"}]
  LOADN R24 0
  LOADN R25 0
  LOADN R26 0
  FASTCALL VECTOR [+2]
  GETIMPORT R23 K46 [Vector3.new]
  CALL R23 3 1
  SETTABLEKS R23 R22 K42 ["Position"]
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R7 K47 ["IgnoreWater"]
  LOADB R22 0
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R7 K48 ["IgnoreParts"]
  LOADB R22 1
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R7 K49 ["TemporarySmooth"]
  LOADB R22 0
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R7 K50 ["WaterAutofill"]
  LOADB R22 0
  SETTABLE R22 R20 R21
  SETTABLEKS R20 R19 K29 ["Defaults"]
  GETTABLEKS R20 R9 K17 ["BrushSettings"]
  SETTABLEKS R20 R19 K30 ["Id"]
  DUPTABLE R20 K31 [{"Defaults", "Id"}]
  NEWTABLE R21 2 0
  GETTABLEKS R22 R13 K51 ["AutoMaterial"]
  LOADB R23 0
  SETTABLE R23 R21 R22
  GETTABLEKS R22 R13 K52 ["SourceMaterial"]
  GETIMPORT R23 K56 [Enum.Material.Grass]
  SETTABLE R23 R21 R22
  ...
  GETTABLEKS R21 R10 K59 ["Brush"]
  SETTABLEKS R21 R20 K30 ["Id"]
  DUPTABLE R21 K61 [{"Type"}]
  GETTABLEKS R22 R10 K59 ["Brush"]
  SETTABLEKS R22 R21 K60 ["Type"]
  SETTABLEKS R21 R20 K57 ["Schema"]
  DUPTABLE R21 K58 [{"Id", "Schema"}]
  GETTABLEKS R22 R10 K62 ["Plane"]
  SETTABLEKS R22 R21 K30 ["Id"]
  DUPTABLE R22 K61 [{"Type"}]
  GETTABLEKS R23 R10 K62 ["Plane"]
  SETTABLEKS R23 R22 K60 ["Type"]
  SETTABLEKS R22 R21 K57 ["Schema"]
  SETLIST R19 R20 2 [1]
  GETTABLEKS R22 R15 K63 ["Sculpt"]
  GETTABLEKS R23 R14 K64 ["Edit"]
  MOVE R24 R18
  MOVE R25 R19
  NAMECALL R20 R2 K45 ["new"]
  CALL R20 5 1
  DUPCLOSURE R21 K65 [PROTO_0]
  CAPTURE VAL R2
  SETTABLEKS R21 R20 K66 ["init"]
  DUPCLOSURE R21 K67 [PROTO_1]
  CAPTURE VAL R2
  SETTABLEKS R21 R20 K68 ["saveForm"]
  DUPCLOSURE R21 K69 [PROTO_2]
  CAPTURE VAL R2
  SETTABLEKS R21 R20 K70 ["saveGizmos"]
  DUPCLOSURE R21 K71 [PROTO_3]
  CAPTURE VAL R4
  CAPTURE VAL R1
  SETTABLEKS R21 R20 K72 ["startOperation"]
  DUPCLOSURE R21 K73 [PROTO_6]
  CAPTURE VAL R2
  CAPTURE VAL R16
  CAPTURE VAL R9
  CAPTURE VAL R7
  CAPTURE VAL R12
  CAPTURE VAL R15
  SETTABLEKS R21 R20 K74 ["activate"]
  DUPCLOSURE R21 K75 [PROTO_7]
  CAPTURE VAL R2
  SETTABLEKS R21 R20 K76 ["deactivate"]
  DUPCLOSURE R21 K77 [PROTO_8]
  CAPTURE VAL R3
  CAPTURE VAL R15
  SETTABLEKS R21 R20 K78 ["reportAnalytics"]
  RETURN R20 1
