...
MAIN:
  ...
  GETTABLEKS R19 R20 K29 ["getFFlagTerrainEditorPivotPositionSculpt"]
  CALL R18 1 1
  ...
  NEWTABLE R22 16 0
  GETTABLEKS R23 R9 K18 ["BrushMode"]
  GETTABLEKS R24 R8 K34 ["Add"]
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R9 K20 ["BrushShape"]
  GETTABLEKS R24 R10 K35 ["Sphere"]
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R9 K36 ["BrushSize"]
  DUPTABLE R24 K40 [{"Height", "Locked", "Size"}]
  LOADN R25 6
  SETTABLEKS R25 R24 K37 ["Height"]
  LOADB R25 1
  SETTABLEKS R25 R24 K38 ["Locked"]
  LOADN R25 6
  SETTABLEKS R25 R24 K39 ["Size"]
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R9 K23 ["PivotPosition"]
  MOVE R25 R18
  CALL R25 0 1
  JUMPIFNOT R25 [+3]
  GETTABLEKS R24 R13 K41 ["Center"]
  JUMP [+1]
  LOADNIL R24
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R9 K42 ["Strength"]
  LOADN R24 1
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R9 K43 ["State"]
  DUPTABLE R24 K45 [{"Position"}]
  LOADN R26 0
  LOADN R27 0
  LOADN R28 0
  FASTCALL VECTOR [+2]
  GETIMPORT R25 K48 [Vector3.new]
  CALL R25 3 1
  SETTABLEKS R25 R24 K44 ["Position"]
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R9 K49 ["IgnoreWater"]
  LOADB R24 0
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R9 K50 ["IgnoreParts"]
  LOADB R24 1
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R9 K51 ["TemporarySmooth"]
  LOADB R24 0
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R9 K52 ["WaterAutofill"]
  LOADB R24 0
  SETTABLE R24 R22 R23
  SETTABLEKS R22 R21 K31 ["Defaults"]
  GETTABLEKS R22 R11 K19 ["BrushSettings"]
  SETTABLEKS R22 R21 K32 ["Id"]
  DUPTABLE R22 K33 [{"Defaults", "Id"}]
  NEWTABLE R23 2 0
  GETTABLEKS R24 R15 K53 ["AutoMaterial"]
  LOADB R25 0
  SETTABLE R25 R23 R24
  GETTABLEKS R24 R15 K54 ["SourceMaterial"]
  GETIMPORT R25 K58 [Enum.Material.Grass]
  SETTABLE R25 R23 R24
  SETTABLEKS R23 R22 K31 ["Defaults"]
  GETTABLEKS R23 R11 K25 ["MaterialSettings"]
  SETTABLEKS R23 R22 K32 ["Id"]
  SETLIST R20 R21 2 [1]
  NEWTABLE R21 0 2
  DUPTABLE R22 K60 [{"Id", "Schema"}]
  GETTABLEKS R23 R12 K61 ["Brush"]
  SETTABLEKS R23 R22 K32 ["Id"]
  DUPTABLE R23 K63 [{"Type"}]
  GETTABLEKS R24 R12 K61 ["Brush"]
  SETTABLEKS R24 R23 K62 ["Type"]
  SETTABLEKS R23 R22 K59 ["Schema"]
  DUPTABLE R23 K60 [{"Id", "Schema"}]
  GETTABLEKS R24 R12 K64 ["Plane"]
  SETTABLEKS R24 R23 K32 ["Id"]
  DUPTABLE R24 K63 [{"Type"}]
  GETTABLEKS R25 R12 K64 ["Plane"]
  SETTABLEKS R25 R24 K62 ["Type"]
  SETTABLEKS R24 R23 K59 ["Schema"]
  SETLIST R21 R22 2 [1]
  GETTABLEKS R24 R17 K65 ["Sculpt"]
  GETTABLEKS R25 R16 K66 ["Edit"]
  MOVE R26 R20
  MOVE R27 R21
  NAMECALL R22 R2 K47 ["new"]
  CALL R22 5 1
