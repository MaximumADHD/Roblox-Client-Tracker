...
MAIN:
  ...
  GETTABLEKS R25 R26 K34 ["getFFlagTerrainEditorGenerateBiomesFix"]
  CALL R24 1 1
  GETIMPORT R25 K5 [require]
  GETTABLEKS R28 R0 K10 ["Src"]
  GETTABLEKS R27 R28 K13 ["Flags"]
  GETTABLEKS R26 R27 K35 ["getFFlagTerrainEditorTimeStatistic"]
  CALL R25 1 1
  NEWTABLE R26 0 2
  ...
  CALL R30 0 1
  JUMPIFNOT R30 [+6]
  DUPCLOSURE R30 K68 [PROTO_9]
  CAPTURE VAL R2
  CAPTURE VAL R17
  CAPTURE VAL R16
  SETTABLEKS R30 R28 K69 ["saveForm"]
  DUPCLOSURE R30 K70 [PROTO_10]
