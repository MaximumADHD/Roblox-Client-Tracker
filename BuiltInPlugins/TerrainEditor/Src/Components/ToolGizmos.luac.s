...
PROTO_2:
  ...
  CALL R10 2 1
  GETUPVAL R11 6
  GETTABLEKS R12 R2 K1 ["Activation"]
  MOVE R13 R4
  NEWTABLE R14 0 0
  CALL R11 3 0
  GETUPVAL R11 6
  GETTABLEKS R12 R2 K2 ["Focused"]
  MOVE R13 R6
  NEWTABLE R14 0 0
  CALL R11 3 0
  GETUPVAL R11 7
  ...
  FORGPREP R12
  GETUPVAL R18 11
  GETTABLEKS R20 R16 K5 ["Schema"]
  GETTABLEKS R19 R20 K6 ["Type"]
  GETTABLE R17 R18 R19
  JUMPIF R17 [+12]
  GETIMPORT R18 K8 [error]
  LOADK R20 K9 ["No renderer found for gizmo schema %*"]
  GETTABLEKS R23 R16 K5 ["Schema"]
  GETTABLEKS R22 R23 K6 ["Type"]
  NAMECALL R20 R20 K10 ["format"]
  CALL R20 2 1
  MOVE R19 R20
  CALL R18 1 0
  GETTABLEKS R18 R16 K11 ["Id"]
  GETUPVAL R20 9
  GETTABLEKS R19 R20 K4 ["createElement"]
  MOVE R20 R17
  GETUPVAL R22 12
  GETTABLEKS R21 R22 K12 ["join"]
  MOVE R22 R16
  DUPTABLE R23 K15 [{"Tool", "Save"}]
  GETUPVAL R25 8
  CALL R25 0 1
  JUMPIFNOT R25 [+3]
  GETTABLEKS R24 R9 K16 ["_name"]
  JUMP [+5]
  NAMECALL R25 R1 K3 ["getTool"]
  CALL R25 1 1
  GETTABLEKS R24 R25 K16 ["_name"]
  SETTABLEKS R24 R23 K13 ["Tool"]
  NEWCLOSURE R24 P1
  CAPTURE VAL R7
  CAPTURE VAL R8
  SETTABLEKS R24 R23 K14 ["Save"]
  CALL R21 2 -1
  CALL R19 -1 1
  ...
  JUMPIFNOT R10 [+12]
  GETUPVAL R13 13
  GETTABLEKS R12 R13 K17 ["Note"]
  GETUPVAL R14 9
  GETTABLEKS R13 R14 K4 ["createElement"]
  GETUPVAL R14 14
  DUPTABLE R15 K19 [{"Key"}]
  SETTABLEKS R10 R15 K18 ["Key"]
  CALL R13 2 1
...
MAIN:
  ...
  CALL R20 1 1
  NEWTABLE R21 4 0
  GETTABLEKS R22 R18 K19 ["Brush"]
  SETTABLE R9 R21 R22
  GETTABLEKS R22 R18 K20 ["Plane"]
  SETTABLE R10 R21 R22
  GETTABLEKS R22 R18 K21 ["Region"]
