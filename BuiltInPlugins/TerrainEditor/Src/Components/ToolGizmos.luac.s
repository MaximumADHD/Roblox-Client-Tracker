...
PROTO_2:
  ...
  FORGPREP R12
  GETUPVAL R18 9
  GETTABLEKS R20 R16 K4 ["Schema"]
  GETTABLEKS R19 R20 K5 ["Type"]
  GETTABLE R17 R18 R19
  JUMPIF R17 [+12]
  GETIMPORT R18 K7 [error]
  LOADK R20 K8 ["No renderer found for gizmo schema %*"]
  GETTABLEKS R23 R16 K4 ["Schema"]
  GETTABLEKS R22 R23 K5 ["Type"]
  NAMECALL R20 R20 K9 ["format"]
  CALL R20 2 1
  MOVE R19 R20
  CALL R18 1 0
  GETTABLEKS R18 R16 K10 ["Id"]
  GETUPVAL R20 7
  GETTABLEKS R19 R20 K3 ["createElement"]
  MOVE R20 R17
  GETUPVAL R22 10
  GETTABLEKS R21 R22 K11 ["join"]
  MOVE R22 R16
  DUPTABLE R23 K15 [{"Tool", "FromSelf", "Save"}]
  GETTABLEKS R24 R7 K16 ["_name"]
  SETTABLEKS R24 R23 K12 ["Tool"]
  SETTABLEKS R8 R23 K13 ["FromSelf"]
  NEWCLOSURE R24 P1
  CAPTURE VAL R5
  CAPTURE VAL R6
...
MAIN:
  ...
  CALL R20 1 1
  NEWTABLE R21 4 0
  GETTABLEKS R22 R19 K19 ["Brush"]
  SETTABLE R9 R21 R22
  GETTABLEKS R22 R19 K20 ["Placement"]
  MOVE R24 R20
  CALL R24 0 1
  JUMPIFNOT R24 [+2]
  MOVE R23 R10
  ...
  GETTABLEKS R22 R19 K21 ["Plane"]
  SETTABLE R11 R21 R22
  GETTABLEKS R22 R19 K22 ["Region"]
