...
PROTO_10:
  ...
  GETUPVAL R35 16
  DUPTABLE R36 K79 [{"Expansion", "ExpandByDefault", "Items", "LabelHeight", "LabelWidth", "LayoutOrder", "OnChange", "OnExpansionChange", "Renderers", "Size", "UseScrollingFrame"}]
  ...
  LOADNIL R37
  JUMP [+5]
  GETIMPORT R37 K81 [UDim.new]
  LOADN R38 0
  LOADN R39 110
  CALL R37 2 1
  SETTABLEKS R37 R36 K73 ["LabelWidth"]
  LOADN R37 1
  ...
  CAPTURE UPVAL U7
  CAPTURE VAL R0
  SETTABLEKS R37 R36 K75 ["OnChange"]
  SETTABLEKS R19 R36 K76 ["OnExpansionChange"]
  DUPTABLE R37 K85 [{"Elevation", "Material", "Slope"}]
  GETUPVAL R38 18
  SETTABLEKS R38 R37 K82 ["Elevation"]
  GETUPVAL R38 19
  SETTABLEKS R38 R37 K83 ["Material"]
  GETUPVAL R38 20
  SETTABLEKS R38 R37 K84 ["Slope"]
  SETTABLEKS R37 R36 K77 ["Renderers"]
  JUMPIFNOT R14 [+16]
  GETIMPORT R37 K13 [UDim2.new]
  LOADN R38 1
  LOADN R39 0
  LOADN R40 1
  GETTABLEKS R45 R10 K86 ["Reset"]
  GETTABLEKS R44 R45 K9 ["Size"]
  GETTABLEKS R43 R44 K50 ["Y"]
  GETTABLEKS R42 R43 K87 ["Offset"]
  MINUS R41 R42
  CALL R37 4 1
  JUMP [+5]
  ...
  SETTABLEKS R14 R36 K78 ["UseScrollingFrame"]
  CALL R34 2 1
  SETTABLEKS R34 R33 K67 ["Form"]
  GETUPVAL R35 11
  GETTABLEKS R34 R35 K8 ["createElement"]
  GETUPVAL R35 13
  DUPTABLE R36 K89 [{"LayoutOrder", "LeftIcon", "OnClick", "Size", "Text"}]
  LOADN R37 2
  SETTABLEKS R37 R36 K74 ["LayoutOrder"]
  GETTABLEKS R38 R10 K86 ["Reset"]
  GETTABLEKS R37 R38 K90 ["Icon"]
  SETTABLEKS R37 R36 K88 ["LeftIcon"]
  GETTABLEKS R37 R3 K91 ["OnReset"]
...
MAIN:
  ...
  GETTABLEKS R21 R22 K34 ["getFFlagDevFrameworkFormAutoResize"]
  CALL R20 1 1
  GETIMPORT R21 K5 [require]
  GETTABLEKS R23 R0 K24 ["Src"]
  GETTABLEKS R22 R23 K35 ["Types"]
  CALL R21 1 1
  GETTABLEKS R22 R21 K36 ["Category"]
  GETIMPORT R23 K5 [require]
  GETTABLEKS R26 R0 K24 ["Src"]
  GETTABLEKS R25 R26 K37 ["Resources"]
  GETTABLEKS R24 R25 K38 ["Theme"]
  CALL R23 1 1
  DUPTABLE R24 K42 [{"MaterialIndex", "Multiple", "None"}]
  LOADK R25 K39 ["MaterialIndex"]
  SETTABLEKS R25 R24 K39 ["MaterialIndex"]
  LOADK R25 K40 ["Multiple"]
  SETTABLEKS R25 R24 K40 ["Multiple"]
  LOADK R25 K41 ["None"]
  SETTABLEKS R25 R24 K41 ["None"]
