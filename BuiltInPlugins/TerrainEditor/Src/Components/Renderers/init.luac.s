MAIN:
  ...
  GETTABLEKS R3 R4 K9 ["getFFlagTerrainEditorMigrateFoundationFonts"]
  CALL R2 1 1
  DUPTABLE R3 K24 [{"BrushSize", "Button", "ConfirmGeneration", "DelayedSlider", "Label", "Image", "Material", "MaterialRanges", "MultiSelection", "PlaneLock", "Seed", "SegmentedControl", "TerrainType", "Upgrade"}]
  ...
  GETIMPORT R4 K5 [require]
  GETIMPORT R6 K1 [script]
  GETTABLEKS R5 R6 K21 ["SegmentedControl"]
  CALL R4 1 1
  JUMP [+1]
  LOADNIL R4
  SETTABLEKS R4 R3 K21 ["SegmentedControl"]
  GETIMPORT R4 K5 [require]
  GETIMPORT R6 K1 [script]
  GETTABLEKS R5 R6 K22 ["TerrainType"]
  CALL R4 1 1
  SETTABLEKS R4 R3 K22 ["TerrainType"]
  GETIMPORT R4 K5 [require]
  GETIMPORT R6 K1 [script]
  GETTABLEKS R5 R6 K23 ["Upgrade"]
  CALL R4 1 1
  SETTABLEKS R4 R3 K23 ["Upgrade"]
  RETURN R3 1
