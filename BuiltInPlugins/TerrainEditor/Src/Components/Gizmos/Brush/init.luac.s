...
PROTO_1:
  ...
  JUMP [+2]
  GETTABLEKS R13 R0 K13 ["Save"]
  CALL R10 3 2
  GETUPVAL R12 6
  GETUPVAL R15 2
  GETTABLEKS R14 R15 K14 ["PivotPosition"]
  GETTABLE R13 R2 R14
  GETTABLEKS R14 R10 K15 ["Position"]
  MOVE R15 R6
  CALL R12 3 1
  GETUPVAL R13 7
  LOADK R15 K16 ["Brush"]
  NAMECALL R13 R13 K17 ["use"]
  CALL R13 2 1
  GETTABLEKS R15 R13 K18 ["CenterRadiusMultiplier"]
  GETTABLEKS R16 R10 K19 ["Distance"]
  MUL R14 R15 R16
  GETTABLEKS R15 R13 K20 ["CenterTransparency"]
  GETTABLEKS R16 R13 K21 ["Color"]
  GETTABLEKS R17 R13 K22 ["MainTransparency"]
  GETUPVAL R20 8
  GETTABLEKS R19 R20 K23 ["Manual"]
  ...
  GETUPVAL R19 6
  GETUPVAL R22 2
  GETTABLEKS R21 R22 K14 ["PivotPosition"]
  GETTABLE R20 R2 R21
  GETTABLEKS R21 R11 K15 ["Position"]
  MOVE R22 R6
  CALL R19 3 1
  LOADB R20 0
  GETUPVAL R22 8
  ...
  NOT R20 R9
  GETUPVAL R23 8
  GETTABLEKS R22 R23 K23 ["Manual"]
  JUMPIFNOTEQ R7 R22 [+6]
  GETTABLEKS R23 R8 K15 ["Position"]
  SUB R22 R8 R23
  ADD R21 R22 R19
  JUMP [+7]
  ...
  GETIMPORT R24 K36 [Vector3.yAxis]
  GETUPVAL R27 2
  GETTABLEKS R26 R27 K39 ["FixedPlane"]
  GETTABLE R25 R2 R26
  MUL R23 R24 R25
  ADD R19 R22 R23
  GETIMPORT R22 K26 [CFrame.lookAt]
