...
MAIN:
  ...
  GETTABLEKS R11 R12 K19 ["getFFlagTerrainEditorRelativeShortcuts"]
  CALL R10 1 1
  GETIMPORT R11 K5 [require]
  GETTABLEKS R13 R0 K13 ["Src"]
  GETTABLEKS R12 R13 K20 ["Types"]
  CALL R11 1 1
  GETTABLEKS R12 R11 K21 ["BrushMode"]
  GETTABLEKS R13 R11 K22 ["BrushSettings"]
  GETTABLEKS R14 R11 K23 ["MaterialSettings"]
  GETTABLEKS R15 R11 K24 ["PluginAction"]
  LOADK R18 K25 ["ShortcutController"]
  NAMECALL R16 R3 K26 ["extend"]
  CALL R16 2 1
  ...
  SETTABLEKS R17 R16 K30 ["isMouseMoveReserved"]
  DUPCLOSURE R17 K31 [PROTO_7]
  SETTABLEKS R17 R16 K32 ["isMouseDownReserved"]
  DUPCLOSURE R17 K33 [PROTO_8]
  SETTABLEKS R17 R16 K34 ["isAltDown"]
  DUPCLOSURE R17 K35 [PROTO_9]
  SETTABLEKS R17 R16 K36 ["isShiftDown"]
  DUPCLOSURE R17 K37 [PROTO_10]
  SETTABLEKS R17 R16 K38 ["isControlDown"]
  DUPCLOSURE R17 K39 [PROTO_11]
  SETTABLEKS R17 R16 K40 ["isBDown"]
  DUPCLOSURE R17 K41 [PROTO_21]
  CAPTURE VAL R13
  CAPTURE VAL R10
  SETTABLEKS R17 R16 K42 ["onBrushChanged"]
  MOVE R17 R9
  CALL R17 0 1
  JUMPIFNOT R17 [+11]
  DUPCLOSURE R17 K43 [PROTO_26]
  CAPTURE VAL R7
  CAPTURE VAL R8
  CAPTURE VAL R14
  SETTABLEKS R17 R16 K44 ["onMaterialPicked"]
  DUPCLOSURE R17 K45 [PROTO_28]
  CAPTURE VAL R12
  SETTABLEKS R17 R16 K46 ["onBrushMode"]
  JUMP [+10]
  DUPCLOSURE R17 K47 [PROTO_33]
  CAPTURE VAL R7
  CAPTURE VAL R8
  CAPTURE VAL R14
  SETTABLEKS R17 R16 K44 ["onMaterialPicked"]
  DUPCLOSURE R17 K48 [PROTO_35]
  CAPTURE VAL R12
  SETTABLEKS R17 R16 K46 ["onBrushMode"]
  DUPCLOSURE R17 K49 [PROTO_37]
  SETTABLEKS R17 R16 K50 ["onTemporarySmooth"]
  DUPCLOSURE R17 K51 [PROTO_40]
  CAPTURE VAL R15
  SETTABLEKS R17 R16 K52 ["onToggleEdit"]
  DUPCLOSURE R17 K53 [PROTO_41]
  CAPTURE VAL R13
  CAPTURE VAL R14
  SETTABLEKS R17 R16 K54 ["registerShortcut"]
  DUPCLOSURE R17 K55 [PROTO_42]
  CAPTURE VAL R13
  CAPTURE VAL R14
  SETTABLEKS R17 R16 K56 ["supportsShortcut"]
  DUPCLOSURE R17 K57 [PROTO_43]
  SETTABLEKS R17 R16 K58 ["getMouse"]
  DUPCLOSURE R17 K59 [PROTO_44]
  SETTABLEKS R17 R16 K60 ["IsMouseDown"]
  DUPCLOSURE R17 K61 [PROTO_45]
  SETTABLEKS R17 R16 K62 ["Enable"]
  DUPCLOSURE R17 K63 [PROTO_46]
  SETTABLEKS R17 R16 K64 ["Disable"]
  DUPCLOSURE R17 K65 [PROTO_47]
  SETTABLEKS R17 R16 K66 ["SetEnabled"]
  DUPCLOSURE R17 K67 [PROTO_48]
  SETTABLEKS R17 R16 K68 ["Connect"]
  RETURN R16 1
