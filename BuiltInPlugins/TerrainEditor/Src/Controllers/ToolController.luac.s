...
PROTO_6:
  ...
  DUPTABLE R18 K24 [{"ChangeHistoryService", "CoreGui", "Selection", "ShorelineUpgraderService", "Terrain"}]
...
MAIN:
  ...
  GETTABLEKS R7 R8 K17 ["BaseTool"]
  CALL R6 1 1
  GETTABLEKS R7 R3 K18 ["Util"]
  GETTABLEKS R8 R7 K19 ["Signal"]
  GETTABLEKS R9 R2 K20 ["findIndex"]
  GETIMPORT R10 K9 [require]
  GETTABLEKS R12 R1 K15 ["Src"]
  GETTABLEKS R11 R12 K16 ["Tools"]
  CALL R10 1 1
  GETIMPORT R11 K9 [require]
  GETTABLEKS R13 R1 K15 ["Src"]
  GETTABLEKS R12 R13 K21 ["Types"]
  CALL R11 1 1
  GETTABLEKS R12 R11 K22 ["Tab"]
  ...
  GETTABLEKS R15 R16 K25 ["ShortcutController"]
  CALL R14 1 1
  LOADK R17 K26 ["ToolController"]
  NAMECALL R15 R5 K27 ["extend"]
  CALL R15 2 1
  ...
  SETTABLEKS R16 R15 K35 ["getTabs"]
  DUPCLOSURE R16 K36 [PROTO_10]
  SETTABLEKS R16 R15 K37 ["getTabIndex"]
  DUPCLOSURE R16 K38 [PROTO_11]
  SETTABLEKS R16 R15 K39 ["getToolbar"]
  DUPCLOSURE R16 K40 [PROTO_12]
  SETTABLEKS R16 R15 K41 ["getToolIndex"]
  DUPCLOSURE R16 K42 [PROTO_13]
  CAPTURE VAL R6
  SETTABLEKS R16 R15 K43 ["getTool"]
  DUPCLOSURE R16 K44 [PROTO_14]
  SETTABLEKS R16 R15 K45 ["setToolIndex"]
  DUPCLOSURE R16 K46 [PROTO_15]
  SETTABLEKS R16 R15 K47 ["setTabIndex"]
  DUPCLOSURE R16 K48 [PROTO_16]
  SETTABLEKS R16 R15 K49 ["setTabAndToolIndex"]
  DUPCLOSURE R16 K50 [PROTO_18]
  CAPTURE VAL R9
  SETTABLEKS R16 R15 K51 ["selectTabAndTool"]
  RETURN R15 1
