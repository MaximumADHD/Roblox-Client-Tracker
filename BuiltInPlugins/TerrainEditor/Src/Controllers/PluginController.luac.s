...
PROTO_1:
  ...
  LOADK R6 K34 ["Global"]
  NAMECALL R4 R4 K35 ["GetSetting"]
  CALL R4 2 1
  JUMPIF R4 [+2]
  NEWTABLE R4 0 0
  CALL R3 1 1
  GETUPVAL R5 13
  GETTABLEKS R4 R5 K36 ["join"]
  GETTABLEKS R5 R2 K5 ["_store"]
  MOVE R6 R3
  CALL R4 2 1
  SETTABLEKS R4 R2 K5 ["_store"]
  GETTABLEKS R4 R2 K4 ["_plugin"]
  GETTABLEKS R3 R4 K37 ["Deactivation"]
  NEWCLOSURE R5 P0
  CAPTURE VAL R2
  NAMECALL R3 R3 K38 ["Connect"]
  CALL R3 2 1
  SETTABLEKS R3 R2 K39 ["_deactivationListener"]
  RETURN R2 1
...
MAIN:
  ...
  GETTABLEKS R19 R20 K27 ["getFFlagTerrainEditorDebugSavedSettings"]
  CALL R18 1 1
  GETIMPORT R19 K5 [require]
  GETTABLEKS R22 R0 K11 ["Src"]
  GETTABLEKS R21 R22 K26 ["Flags"]
  GETTABLEKS R20 R21 K28 ["getFFlagTerrainEditorGenerationFeature"]
  CALL R19 1 1
  GETIMPORT R20 K5 [require]
  GETTABLEKS R23 R0 K11 ["Src"]
  GETTABLEKS R22 R23 K26 ["Flags"]
  GETTABLEKS R21 R22 K29 ["getFFlagTerrainEditorRibbonBarFix"]
  CALL R20 1 1
  LOADK R23 K30 ["PluginController"]
  NAMECALL R21 R3 K31 ["extend"]
  CALL R21 2 1
  ...
  CAPTURE VAL R21
  SETTABLEKS R22 R21 K35 ["mock"]
  DUPCLOSURE R22 K36 [PROTO_3]
  SETTABLEKS R22 R21 K37 ["isMocking"]
  DUPCLOSURE R22 K38 [PROTO_4]
  SETTABLEKS R22 R21 K39 ["getPlugin"]
  DUPCLOSURE R22 K40 [PROTO_5]
  SETTABLEKS R22 R21 K41 ["getEnabled"]
  DUPCLOSURE R22 K42 [PROTO_6]
  CAPTURE VAL R16
  SETTABLEKS R22 R21 K43 ["setGlobal"]
  DUPCLOSURE R22 K44 [PROTO_7]
  SETTABLEKS R22 R21 K45 ["getGlobal"]
  DUPCLOSURE R22 K46 [PROTO_8]
  CAPTURE VAL R16
  SETTABLEKS R22 R21 K47 ["setSetting"]
  DUPCLOSURE R22 K48 [PROTO_9]
  CAPTURE VAL R17
  SETTABLEKS R22 R21 K49 ["getSetting"]
  DUPCLOSURE R22 K50 [PROTO_10]
  SETTABLEKS R22 R21 K51 ["toggle"]
  DUPCLOSURE R22 K52 [PROTO_11]
  SETTABLEKS R22 R21 K53 ["enable"]
  DUPCLOSURE R22 K54 [PROTO_12]
  SETTABLEKS R22 R21 K55 ["disable"]
  DUPCLOSURE R22 K56 [PROTO_13]
  CAPTURE VAL R20
  SETTABLEKS R22 R21 K57 ["resume"]
  DUPCLOSURE R22 K58 [PROTO_14]
  SETTABLEKS R22 R21 K59 ["pause"]
  DUPCLOSURE R22 K60 [PROTO_15]
  SETTABLEKS R22 R21 K61 ["destroy"]
  RETURN R21 1
