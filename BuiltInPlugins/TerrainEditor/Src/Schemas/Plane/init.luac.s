MAIN:
  ...
  MOVE R5 R3
  DUPTABLE R6 K16 [{"dispatchWorldClick", "getMouseTarget", "Selection", "SelectionInfo", "TransformHandlesImplementation"}]
  ...
  GETIMPORT R7 K5 [require]
  GETIMPORT R9 K1 [script]
  GETTABLEKS R8 R9 K13 ["Selection"]
  CALL R7 1 1
  ...
  GETIMPORT R7 K5 [require]
  GETIMPORT R9 K1 [script]
  GETTABLEKS R8 R9 K15 ["TransformHandlesImplementation"]
  CALL R7 1 1
  SETTABLEKS R7 R6 K15 ["TransformHandlesImplementation"]
  CALL R4 2 -1
  RETURN R4 -1
