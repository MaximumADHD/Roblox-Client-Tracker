MAIN:
  ...
  GETTABLEKS R5 R6 K12 ["getFFlagTerrainEditorPlaneSelectionFix"]
  CALL R4 1 1
  GETTABLEKS R5 R1 K13 ["join"]
  MOVE R6 R3
  DUPTABLE R7 K21 [{"dispatchWorldClick", "getMouseTarget", "getNextSelectables", "isExclusiveSelectable", "Selection", "SelectionInfo", "TransformHandlesImplementation"}]
  ...
  CALL R8 1 1
  SETTABLEKS R8 R7 K18 ["Selection"]
  GETIMPORT R8 K5 [require]
  GETIMPORT R10 K1 [script]
  GETTABLEKS R9 R10 K19 ["SelectionInfo"]
  CALL R8 1 1
  SETTABLEKS R8 R7 K19 ["SelectionInfo"]
  GETIMPORT R8 K5 [require]
  GETIMPORT R10 K1 [script]
  GETTABLEKS R9 R10 K20 ["TransformHandlesImplementation"]
  CALL R8 1 1
  SETTABLEKS R8 R7 K20 ["TransformHandlesImplementation"]
  CALL R5 2 -1
  RETURN R5 -1
