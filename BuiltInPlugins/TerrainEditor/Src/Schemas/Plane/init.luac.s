MAIN:
  ...
  MOVE R5 R3
  DUPTABLE R6 K17 [{"dispatchWorldClick", "getMouseTarget", "getNextSelectables", "Selection", "SelectionInfo", "TransformHandlesImplementation"}]
  ...
  GETIMPORT R7 K5 [require]
  GETIMPORT R9 K1 [script]
  GETTABLEKS R8 R9 K15 ["SelectionInfo"]
  CALL R7 1 1
  SETTABLEKS R7 R6 K15 ["SelectionInfo"]
  GETIMPORT R7 K5 [require]
  GETIMPORT R9 K1 [script]
  GETTABLEKS R8 R9 K16 ["TransformHandlesImplementation"]
  CALL R7 1 1
  SETTABLEKS R7 R6 K16 ["TransformHandlesImplementation"]
  CALL R4 2 -1
  RETURN R4 -1
