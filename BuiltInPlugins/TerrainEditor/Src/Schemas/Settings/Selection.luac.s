...
PROTO_8:
  ...
  DUPTABLE R10 K25 [{"DataId", "Id", "Height", "Schema", "Value"}]
  GETUPVAL R12 1
  GETTABLEKS R11 R12 K22 ["Transform"]
  ...
  GETUPVAL R13 1
  GETTABLEKS R12 R13 K29 ["SnapToVoxels"]
  ...
  SETLIST R7 R8 4 [1]
  DUPTABLE R8 K35 [{"Category", "Data", "Overrides"}]
  GETUPVAL R9 6
  SETTABLEKS R9 R8 K32 ["Category"]
  SETTABLEKS R1 R8 K33 ["Data"]
  SETTABLEKS R3 R8 K34 ["Overrides"]
  CALL R5 3 -1
  RETURN R5 -1
...
MAIN:
  ...
  GETTABLEKS R10 R11 K18 ["getFFlagTerrainEditorExplicitVectorHeight"]
  CALL R9 1 1
  GETTABLEKS R10 R3 K11 ["SelectionSettings"]
  NEWTABLE R11 2 0
  NEWTABLE R12 4 0
  GETTABLEKS R13 R4 K19 ["Size"]
  GETTABLEKS R14 R5 K20 ["GlobalPersistent"]
