...
PROTO_7:
  ...
  DUPTABLE R22 K53 [{"Id", "Layout", "Schema", "Value"}]
  GETUPVAL R24 1
  GETTABLEKS R23 R24 K54 ["Commit"]
  SETTABLEKS R23 R22 K1 ["Id"]
  GETIMPORT R23 K58 [Enum.FillDirection.Vertical]
  SETTABLEKS R23 R22 K52 ["Layout"]
  DUPTABLE R23 K59 [{"Label", "Type"}]
  GETUPVAL R26 6
  GETUPVAL R28 1
  GETTABLEKS R27 R28 K54 ["Commit"]
  NAMECALL R24 R4 K60 ["getText"]
  CALL R24 3 1
  SETTABLEKS R24 R23 K50 ["Label"]
  LOADK R24 K61 ["Button"]
  SETTABLEKS R24 R23 K6 ["Type"]
  SETTABLEKS R23 R22 K2 ["Schema"]
  LOADB R23 1
  SETTABLEKS R23 R22 K11 ["Value"]
  SETLIST R7 R8 15 [1]
  DUPTABLE R8 K65 [{"Category", "Data", "Overrides"}]
  GETUPVAL R9 6
  SETTABLEKS R9 R8 K62 ["Category"]
  SETTABLEKS R1 R8 K63 ["Data"]
  SETTABLEKS R3 R8 K64 ["Overrides"]
  CALL R5 3 -1
  RETURN R5 -1
