...
PROTO_9:
  ...
  MOVE R6 R0
  NEWTABLE R7 0 7
  DUPTABLE R8 K5 [{"Id", "Height", "Schema", "Validate"}]
  GETUPVAL R10 1
  ...
  DUPTABLE R9 K21 [{"DataId", "Id", "Height", "Hidden", "Schema", "Validate", "Value"}]
  GETUPVAL R11 1
  GETTABLEKS R10 R11 K22 ["Transform"]
  SETTABLEKS R10 R9 K18 ["DataId"]
  GETUPVAL R11 1
  GETTABLEKS R10 R11 K23 ["Position"]
  ...
  GETUPVAL R12 1
  GETTABLEKS R11 R12 K22 ["Transform"]
  GETTABLE R10 R1 R11
  SETTABLEKS R10 R9 K20 ["Value"]
  DUPTABLE R10 K25 [{"DataId", "Id", "Height", "Schema", "Validate", "Value"}]
  GETUPVAL R12 1
  GETTABLEKS R11 R12 K22 ["Transform"]
  SETTABLEKS R11 R10 K18 ["DataId"]
  GETUPVAL R12 1
  GETTABLEKS R11 R12 K26 ["Rotation"]
  ...
  JUMP [+1]
  LOADNIL R11
  SETTABLEKS R11 R10 K2 ["Height"]
  DUPTABLE R11 K11 [{"Type", "Components", "GetValue", "GetComponents"}]
  LOADK R12 K12 ["Vector"]
  ...
  LOADK R15 K15 ["Z"]
  SETLIST R12 R13 3 [1]
  SETTABLEKS R12 R11 K8 ["Components"]
  NEWCLOSURE R12 P6
  CAPTURE VAL R1
  CAPTURE UPVAL U1
  SETTABLEKS R12 R11 K9 ["GetValue"]
  DUPCLOSURE R12 K27 [PROTO_7]
  SETTABLEKS R12 R11 K10 ["GetComponents"]
  ...
  CAPTURE UPVAL U6
  CAPTURE UPVAL U1
  SETTABLEKS R11 R10 K4 ["Validate"]
  GETUPVAL R13 1
  GETTABLEKS R12 R13 K22 ["Transform"]
  GETTABLE R11 R1 R12
  SETTABLEKS R11 R10 K20 ["Value"]
  DUPTABLE R11 K28 [{"Id", "Schema"}]
  GETUPVAL R13 1
  GETTABLEKS R12 R13 K29 ["MergeEmpty"]
  SETTABLEKS R12 R11 K1 ["Id"]
  DUPTABLE R12 K30 [{"Type"}]
  LOADK R13 K31 ["Checkbox"]
  SETTABLEKS R13 R12 K7 ["Type"]
  SETTABLEKS R12 R11 K3 ["Schema"]
  DUPTABLE R12 K28 [{"Id", "Schema"}]
  GETUPVAL R14 1
  GETTABLEKS R13 R14 K32 ["LiveEdit"]
  SETTABLEKS R13 R12 K1 ["Id"]
  DUPTABLE R13 K30 [{"Type"}]
  LOADK R14 K31 ["Checkbox"]
  SETTABLEKS R14 R13 K7 ["Type"]
  SETTABLEKS R13 R12 K3 ["Schema"]
  DUPTABLE R13 K28 [{"Id", "Schema"}]
  GETUPVAL R15 1
  GETTABLEKS R14 R15 K33 ["SnapToVoxels"]
  SETTABLEKS R14 R13 K1 ["Id"]
  DUPTABLE R14 K30 [{"Type"}]
  LOADK R15 K31 ["Checkbox"]
  SETTABLEKS R15 R14 K7 ["Type"]
  SETTABLEKS R14 R13 K3 ["Schema"]
  DUPTABLE R14 K35 [{"Id", "Layout", "Schema"}]
  GETUPVAL R16 1
  GETTABLEKS R15 R16 K36 ["Apply"]
  SETTABLEKS R15 R14 K1 ["Id"]
  GETIMPORT R15 K40 [Enum.FillDirection.Vertical]
  SETTABLEKS R15 R14 K34 ["Layout"]
  DUPTABLE R15 K42 [{"Label", "Type"}]
  GETUPVAL R18 6
  GETUPVAL R20 1
  GETTABLEKS R19 R20 K36 ["Apply"]
  NAMECALL R16 R4 K43 ["getText"]
  CALL R16 3 1
  SETTABLEKS R16 R15 K41 ["Label"]
  LOADK R16 K44 ["Button"]
  SETTABLEKS R16 R15 K7 ["Type"]
  SETTABLEKS R15 R14 K3 ["Schema"]
  SETLIST R7 R8 7 [1]
  DUPTABLE R8 K48 [{"Category", "Data", "Overrides"}]
  GETUPVAL R9 6
  SETTABLEKS R9 R8 K45 ["Category"]
  SETTABLEKS R1 R8 K46 ["Data"]
  SETTABLEKS R3 R8 K47 ["Overrides"]
  CALL R5 3 -1
  RETURN R5 -1
...
MAIN:
  ...
  GETTABLEKS R11 R12 K18 ["getFFlagTerrainEditorExplicitVectorHeight"]
  CALL R10 1 1
  NEWTABLE R11 2 0
  NEWTABLE R12 16 0
  ...
  GETTABLEKS R14 R5 K27 ["GlobalPersistent"]
  SETTABLE R14 R12 R13
  ...
  GETTABLEKS R14 R5 K31 ["GlobalSession"]
  SETTABLE R14 R12 R13
  GETTABLEKS R13 R4 K32 ["TerrainRegionBuffer"]
  GETTABLEKS R14 R5 K31 ["GlobalSession"]
  SETTABLE R14 R12 R13
  GETTABLEKS R13 R4 K33 ["TerrainRegionBufferSize"]
  GETTABLEKS R14 R5 K31 ["GlobalSession"]
  SETTABLE R14 R12 R13
  GETTABLEKS R13 R4 K34 ["TerrainRegionBufferTransform"]
  GETTABLEKS R14 R5 K31 ["GlobalSession"]
  SETTABLE R14 R12 R13
  GETTABLEKS R13 R4 K35 ["TerrainRegionSize"]
  GETTABLEKS R14 R5 K31 ["GlobalSession"]
  SETTABLE R14 R12 R13
  GETTABLEKS R13 R4 K36 ["TerrainRegionTransform"]
  GETTABLEKS R14 R5 K31 ["GlobalSession"]
  SETTABLE R14 R12 R13
  GETTABLEKS R13 R4 K37 ["Transform"]
  GETTABLEKS R14 R5 K27 ["GlobalPersistent"]
  SETTABLE R14 R12 R13
  GETTABLEKS R13 R4 K38 ["TransformMode"]
  GETTABLEKS R14 R5 K31 ["GlobalSession"]
  SETTABLE R14 R12 R13
  SETTABLEKS R12 R11 K12 ["Storage"]
  DUPCLOSURE R12 K39 [PROTO_9]
  CAPTURE VAL R1
  CAPTURE VAL R4
  CAPTURE VAL R10
  CAPTURE VAL R9
  ...
  CAPTURE VAL R8
  CAPTURE VAL R7
  SETTABLEKS R12 R11 K40 ["Generator"]
  RETURN R11 1
