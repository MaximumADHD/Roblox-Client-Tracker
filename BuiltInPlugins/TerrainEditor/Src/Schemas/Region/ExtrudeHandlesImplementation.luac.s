...
MAIN:
  ...
  GETTABLEKS R7 R8 K15 ["getFFlagTerrainEditorPredetermineVoxelAlignment"]
  CALL R6 1 1
  NEWTABLE R7 16 0
  ...
  SETTABLEKS R8 R7 K20 ["getBoundingBox"]
  DUPCLOSURE R8 K21 [PROTO_2]
  SETTABLEKS R8 R7 K22 ["shouldScaleFromCenter"]
  DUPCLOSURE R8 K23 [PROTO_3]
  CAPTURE VAL R5
  SETTABLEKS R8 R7 K24 ["axesToScale"]
  DUPCLOSURE R8 K25 [PROTO_4]
  CAPTURE VAL R1
  CAPTURE VAL R3
  SETTABLEKS R8 R7 K26 ["getMinMaxSizes"]
  DUPCLOSURE R8 K27 [PROTO_5]
  SETTABLEKS R8 R7 K28 ["beginScale"]
  DUPCLOSURE R8 K29 [PROTO_6]
  CAPTURE VAL R6
  CAPTURE VAL R2
  CAPTURE VAL R3
  SETTABLEKS R8 R7 K30 ["updateScale"]
  DUPCLOSURE R8 K31 [PROTO_7]
  SETTABLEKS R8 R7 K32 ["getPriority"]
  DUPCLOSURE R8 K33 [PROTO_8]
  SETTABLEKS R8 R7 K34 ["endScale"]
  DUPCLOSURE R8 K35 [PROTO_9]
  SETTABLEKS R8 R7 K36 ["render"]
  RETURN R7 1
