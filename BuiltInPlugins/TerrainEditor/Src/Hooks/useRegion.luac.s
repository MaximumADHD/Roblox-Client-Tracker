...
PROTO_10:
  ...
  LOADN R10 0
  GETUPVAL R12 13
  GETTABLEKS R11 R12 K31 ["VoxelResolution"]
  MUL R9 R10 R11
  LOADN R11 0
  GETUPVAL R13 13
  GETTABLEKS R12 R13 K31 ["VoxelResolution"]
  MUL R10 R11 R12
  LOADN R12 0
  GETUPVAL R14 13
  GETTABLEKS R13 R14 K31 ["VoxelResolution"]
  MUL R11 R12 R13
  FASTCALL VECTOR [+2]
  GETIMPORT R8 K32 [Vector3.new]
  CALL R8 3 1
  SETTABLEKS R8 R7 K22 ["Max"]
  LOADB R8 1
  SETTABLEKS R8 R7 K23 ["UseVolume"]
  ...
  MOVE R4 R0
  DUPTABLE R5 K34 [{"ShowBoundingBox", "Summonable", "Outset"}]
  LOADB R6 0
  SETTABLEKS R6 R5 K18 ["ShowBoundingBox"]
  LOADB R6 0
  SETTABLEKS R6 R5 K19 ["Summonable"]
  LOADN R6 1
  SETTABLEKS R6 R5 K33 ["Outset"]
  GETUPVAL R8 12
  GETTABLEKS R7 R8 K35 ["TransformHandlesImplementation"]
  ...
  MOVE R5 R0
  DUPTABLE R6 K34 [{"ShowBoundingBox", "Summonable", "Outset"}]
  LOADB R7 0
  SETTABLEKS R7 R6 K18 ["ShowBoundingBox"]
  LOADB R7 0
  SETTABLEKS R7 R6 K19 ["Summonable"]
  LOADN R7 1
  SETTABLEKS R7 R6 K33 ["Outset"]
  GETUPVAL R9 12
  GETTABLEKS R8 R9 K35 ["TransformHandlesImplementation"]
  GETTABLEKS R7 R8 K3 ["new"]
  MOVE R8 R0
  CALL R7 1 -1
  CALL R4 -1 -1
  FASTCALL TABLE_INSERT [+2]
  GETIMPORT R2 K38 [table.insert]
  CALL R2 -1 0
  DUPTABLE R2 K43 [{"Mouse", "DraggerContext", "DraggerSchema", "DraggerSettings"}]
  GETUPVAL R4 2
  GETTABLEKS R3 R4 K4 ["Parent"]
  NAMECALL R3 R3 K44 ["GetMouse"]
  CALL R3 1 1
  SETTABLEKS R3 R2 K39 ["Mouse"]
  SETTABLEKS R0 R2 K40 ["DraggerContext"]
  GETUPVAL R3 12
  SETTABLEKS R3 R2 K41 ["DraggerSchema"]
  DUPTABLE R3 K52 [{"AnalyticsName", "AllowDragSelect", "AllowFreeformDrag", "ShowDragSelect", "ShowLocalSpaceIndicator", "ShowPivotIndicator", "HandlesList"}]
  LOADK R4 K53 ["TerrainEditorRegion"]
  SETTABLEKS R4 R3 K45 ["AnalyticsName"]
  LOADB R4 1
  SETTABLEKS R4 R3 K46 ["AllowDragSelect"]
  LOADB R4 0
  SETTABLEKS R4 R3 K47 ["AllowFreeformDrag"]
  LOADB R4 0
  SETTABLEKS R4 R3 K48 ["ShowDragSelect"]
  LOADB R4 1
  SETTABLEKS R4 R3 K49 ["ShowLocalSpaceIndicator"]
  LOADB R4 1
  SETTABLEKS R4 R3 K50 ["ShowPivotIndicator"]
  SETTABLEKS R1 R3 K51 ["HandlesList"]
  SETTABLEKS R3 R2 K42 ["DraggerSettings"]
  RETURN R2 1
...
MAIN:
  ...
  GETTABLEKS R28 R29 K41 ["getFFlagTerrainEditorErrorHandling"]
  CALL R27 1 1
  GETIMPORT R28 K7 [require]
  GETTABLEKS R31 R0 K13 ["Src"]
  GETTABLEKS R30 R31 K39 ["Flags"]
  GETTABLEKS R29 R30 K42 ["getFFlagTerrainEditorCopyPasteFix"]
  CALL R28 1 1
  ...
  CALL R29 2 1
  NEWTABLE R30 8 0
  GETTABLEKS R31 R22 K47 ["Build"]
  MOVE R33 R26
  CALL R33 0 1
  JUMPIFNOT R33 [+3]
  GETTABLEKS R32 R18 K29 ["BuildSettings"]
  JUMP [+1]
  LOADNIL R32
  SETTABLE R32 R30 R31
  GETTABLEKS R31 R22 K48 ["Transform"]
  GETTABLEKS R32 R18 K36 ["TransformSettings"]
  SETTABLE R32 R30 R31
  GETTABLEKS R31 R22 K49 ["Select"]
  GETTABLEKS R32 R18 K33 ["SelectionSettings"]
  SETTABLE R32 R30 R31
  GETTABLEKS R31 R22 K50 ["Generate"]
  GETTABLEKS R32 R18 K33 ["SelectionSettings"]
  SETTABLE R32 R30 R31
  GETTABLEKS R31 R22 K51 ["Fill"]
  GETTABLEKS R32 R18 K33 ["SelectionSettings"]
  SETTABLE R32 R30 R31
  GETTABLEKS R31 R22 K52 ["Import"]
  GETTABLEKS R32 R18 K33 ["SelectionSettings"]
  SETTABLE R32 R30 R31
  GETTABLEKS R31 R22 K53 ["SeaLevel"]
  GETTABLEKS R32 R18 K32 ["SeaLevelSettings"]
  SETTABLE R32 R30 R31
  GETTABLEKS R31 R22 K54 ["Mock"]
  GETTABLEKS R32 R18 K33 ["SelectionSettings"]
  SETTABLE R32 R30 R31
  NEWTABLE R31 8 0
  GETTABLEKS R32 R22 K47 ["Build"]
  MOVE R34 R26
  CALL R34 0 1
  JUMPIFNOT R34 [+2]
  MOVE R33 R17
  ...
  GETTABLEKS R32 R22 K48 ["Transform"]
  SETTABLE R24 R31 R32
  GETTABLEKS R32 R22 K49 ["Select"]
  SETTABLE R21 R31 R32
  GETTABLEKS R32 R22 K50 ["Generate"]
  SETTABLE R21 R31 R32
  GETTABLEKS R32 R22 K51 ["Fill"]
  SETTABLE R21 R31 R32
  GETTABLEKS R32 R22 K52 ["Import"]
  SETTABLE R21 R31 R32
  GETTABLEKS R32 R22 K53 ["SeaLevel"]
  SETTABLE R20 R31 R32
  GETTABLEKS R32 R22 K54 ["Mock"]
  SETTABLE R21 R31 R32
  DUPCLOSURE R32 K55 [PROTO_17]
  CAPTURE VAL R25
  CAPTURE VAL R6
  CAPTURE VAL R30
  CAPTURE VAL R31
