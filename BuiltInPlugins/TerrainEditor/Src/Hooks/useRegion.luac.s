...
PROTO_8:
  ...
  GETUPVAL R7 9
  GETTABLEKS R6 R7 K17 ["ExtrudeHandlesImplementation"]
  ...
  MOVE R4 R0
  DUPTABLE R5 K19 [{"ShowBoundingBox", "Summonable", "Outset"}]
  LOADB R6 0
  SETTABLEKS R6 R5 K14 ["ShowBoundingBox"]
  LOADB R6 0
  SETTABLEKS R6 R5 K15 ["Summonable"]
  LOADN R6 1
  SETTABLEKS R6 R5 K18 ["Outset"]
  GETUPVAL R8 9
  GETTABLEKS R7 R8 K20 ["TransformHandlesImplementation"]
  ...
  MOVE R5 R0
  DUPTABLE R6 K19 [{"ShowBoundingBox", "Summonable", "Outset"}]
  LOADB R7 0
  SETTABLEKS R7 R6 K14 ["ShowBoundingBox"]
  LOADB R7 0
  SETTABLEKS R7 R6 K15 ["Summonable"]
  LOADN R7 1
  SETTABLEKS R7 R6 K18 ["Outset"]
  GETUPVAL R9 9
  ...
  CALL R2 -1 0
  DUPTABLE R2 K28 [{"Mouse", "DraggerContext", "DraggerSchema", "DraggerSettings"}]
  GETUPVAL R4 2
  GETTABLEKS R3 R4 K4 ["Parent"]
  NAMECALL R3 R3 K29 ["GetMouse"]
  CALL R3 1 1
  SETTABLEKS R3 R2 K24 ["Mouse"]
  SETTABLEKS R0 R2 K25 ["DraggerContext"]
  GETUPVAL R3 9
  SETTABLEKS R3 R2 K26 ["DraggerSchema"]
  DUPTABLE R3 K37 [{"AnalyticsName", "AllowDragSelect", "AllowFreeformDrag", "ShowDragSelect", "ShowLocalSpaceIndicator", "ShowPivotIndicator", "HandlesList"}]
  LOADK R4 K38 ["TerrainEditorRegion"]
  SETTABLEKS R4 R3 K30 ["AnalyticsName"]
  LOADB R4 1
  SETTABLEKS R4 R3 K31 ["AllowDragSelect"]
  LOADB R4 0
  SETTABLEKS R4 R3 K32 ["AllowFreeformDrag"]
  LOADB R4 0
  SETTABLEKS R4 R3 K33 ["ShowDragSelect"]
  LOADB R4 1
  SETTABLEKS R4 R3 K34 ["ShowLocalSpaceIndicator"]
  LOADB R4 1
  SETTABLEKS R4 R3 K35 ["ShowPivotIndicator"]
  SETTABLEKS R1 R3 K36 ["HandlesList"]
  SETTABLEKS R3 R2 K27 ["DraggerSettings"]
  RETURN R2 1
...
MAIN:
  ...
  GETTABLEKS R25 R26 K34 ["Controllers"]
  GETTABLEKS R24 R25 K35 ["PluginController"]
  CALL R23 1 1
  GETIMPORT R24 K37 [game]
  LOADK R26 K38 ["StudioService"]
  NAMECALL R24 R24 K39 ["GetService"]
  CALL R24 2 1
  NEWTABLE R25 8 0
  GETTABLEKS R26 R20 K40 ["Transform"]
  GETTABLEKS R27 R16 K33 ["TransformSettings"]
  SETTABLE R27 R25 R26
  GETTABLEKS R26 R20 K41 ["Select"]
  GETTABLEKS R27 R16 K30 ["SelectionSettings"]
  SETTABLE R27 R25 R26
  GETTABLEKS R26 R20 K42 ["Generate"]
  GETTABLEKS R27 R16 K30 ["SelectionSettings"]
  SETTABLE R27 R25 R26
  GETTABLEKS R26 R20 K43 ["Fill"]
  GETTABLEKS R27 R16 K30 ["SelectionSettings"]
  SETTABLE R27 R25 R26
  GETTABLEKS R26 R20 K44 ["Import"]
  GETTABLEKS R27 R16 K30 ["SelectionSettings"]
  SETTABLE R27 R25 R26
  GETTABLEKS R26 R20 K45 ["SeaLevel"]
  GETTABLEKS R27 R16 K29 ["SeaLevelSettings"]
  SETTABLE R27 R25 R26
  GETTABLEKS R26 R20 K46 ["Mock"]
  GETTABLEKS R27 R16 K30 ["SelectionSettings"]
  SETTABLE R27 R25 R26
  NEWTABLE R26 8 0
  GETTABLEKS R27 R20 K40 ["Transform"]
  SETTABLE R22 R26 R27
  GETTABLEKS R27 R20 K41 ["Select"]
  SETTABLE R19 R26 R27
  GETTABLEKS R27 R20 K42 ["Generate"]
  SETTABLE R19 R26 R27
  GETTABLEKS R27 R20 K43 ["Fill"]
  SETTABLE R19 R26 R27
  GETTABLEKS R27 R20 K44 ["Import"]
  SETTABLE R19 R26 R27
  GETTABLEKS R27 R20 K45 ["SeaLevel"]
  SETTABLE R18 R26 R27
  GETTABLEKS R27 R20 K46 ["Mock"]
  SETTABLE R19 R26 R27
