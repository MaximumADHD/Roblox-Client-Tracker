...
PROTO_1:
  GETUPVAL R6 0
  GETUPVAL R8 1
  GETTABLEKS R7 R8 K1 ["BrushSettings"]
  GETTABLE R5 R6 R7
  GETUPVAL R7 2
  GETTABLEKS R6 R7 K2 ["BaseSize"]
  GETTABLE R4 R5 R6
  DIVK R3 R4 K0 [2]
  GETUPVAL R5 3
  GETTABLEKS R4 R5 K3 ["VoxelResolution"]
  MUL R2 R3 R4
  GETUPVAL R4 3
  GETTABLEKS R3 R4 K4 ["TerrainCacheMultiplier"]
  MUL R1 R2 R3
  GETUPVAL R3 3
  GETTABLEKS R2 R3 K5 ["TerrainCacheMaxRadius"]
  FASTCALL2 MATH_MIN R1 R2 [+3]
  GETIMPORT R0 K8 [math.min]
  CALL R0 2 1
  RETURN R0 1
...
PROTO_5:
  ...
  GETUPVAL R10 1
  GETUPVAL R12 2
  GETTABLEKS R11 R12 K7 ["BrushSettings"]
  GETTABLE R9 R10 R11
  GETUPVAL R11 3
  GETTABLEKS R10 R11 K57 ["BaseSize"]
  GETTABLE R8 R9 R10
  CALL R6 2 1
  GETUPVAL R9 1
  GETUPVAL R11 2
  ...
  GETTABLE R8 R9 R10
  GETUPVAL R10 3
  GETTABLEKS R9 R10 K58 ["FixedPlane"]
  GETTABLE R7 R8 R9
  JUMPIFNOT R7 [+18]
  GETTABLEKS R8 R6 K59 ["X"]
  GETUPVAL R11 1
  GETUPVAL R13 2
  GETTABLEKS R12 R13 K7 ["BrushSettings"]
  GETTABLE R10 R11 R12
  GETUPVAL R12 3
  GETTABLEKS R11 R12 K60 ["FixedPlanePosition"]
  GETTABLE R9 R10 R11
  GETTABLEKS R10 R6 K61 ["Z"]
  FASTCALL VECTOR [+2]
  GETIMPORT R7 K62 [Vector3.new]
  CALL R7 3 1
  MOVE R6 R7
  SUB R8 R6 R0
...
MAIN:
  ...
  GETTABLEKS R14 R15 K24 ["getSnappedToGrid"]
  CALL R13 1 1
  ...
  CALL R17 1 1
  GETTABLEKS R18 R17 K32 ["BrushSettings"]
  GETTABLEKS R19 R17 K33 ["Categories"]
  GETTABLEKS R20 R17 K34 ["MaterialSettings"]
  GETTABLEKS R21 R17 K35 ["PlaneLock"]
  GETTABLEKS R22 R17 K36 ["Snapping"]
  GETTABLEKS R23 R17 K37 ["Tools"]
