...
MAIN:
  ...
  GETTABLEKS R28 R29 K42 ["getFFlagTerrainEditorFixDrawIgnoreParts"]
  CALL R27 1 1
  GETIMPORT R28 K5 [require]
  GETTABLEKS R31 R0 K12 ["Src"]
  GETTABLEKS R30 R31 K41 ["Flags"]
  GETTABLEKS R29 R30 K43 ["getFFlagTerrainEditorRaycastCacheFix"]
  CALL R28 1 1
  GETIMPORT R29 K5 [require]
  GETTABLEKS R32 R0 K12 ["Src"]
  GETTABLEKS R31 R32 K41 ["Flags"]
  GETTABLEKS R30 R31 K44 ["getFFlagTerrainEditorBrushPerformanceEnhancements"]
  CALL R29 1 1
  DUPCLOSURE R30 K45 [PROTO_17]
  CAPTURE VAL R6
  CAPTURE VAL R5
  CAPTURE VAL R4
  CAPTURE VAL R12
