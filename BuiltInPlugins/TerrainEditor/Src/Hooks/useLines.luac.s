...
PROTO_1:
        ...
        2 GETUPVAL                         R0 1
        3 GETUPVAL                         R1 2
        4 GETTABLEKS                       R1 R1 K0 ["Transform"]
        6 JUMPIFNOTEQ                      R0 R1 ; [+65]
        8 GETUPVAL                         R2 3
        9 GETUPVAL                         R3 4
       10 GETTABLEKS                       R3 R3 K1 ["TransformSettings"]
       12 GETTABLE                         R1 R2 R3
       13 GETUPVAL                         R2 5
       14 GETTABLEKS                       R2 R2 K2 ["TransformMode"]
       16 GETTABLE                         R0 R1 R2
       17 LOADNIL                          R1
       18 GETUPVAL                         R2 6
       19 GETTABLEKS                       R2 R2 K3 ["Paste"]
       21 JUMPIFNOTEQ                      R0 R2 ; [+11]
       23 GETUPVAL                         R3 3
       24 GETUPVAL                         R4 4
       25 GETTABLEKS                       R4 R4 K1 ["TransformSettings"]
       27 GETTABLE                         R2 R3 R4
       28 GETUPVAL                         R3 5
       29 GETTABLEKS                       R3 R3 K4 ["TerrainRegionBuffer"]
       31 GETTABLE                         R1 R2 R3
       32 JUMP                             ; [+19]
       33 GETUPVAL                         R2 6
       34 GETTABLEKS                       R2 R2 K5 ["Duplicate"]
       36 JUMPIFEQ                         R0 R2 ; [+6]
       38 GETUPVAL                         R2 6
       39 GETTABLEKS                       R2 R2 K6 ["Import"]
       41 JUMPIFNOTEQ                      R0 R2 ; [+10]
       43 GETUPVAL                         R3 3
       44 GETUPVAL                         R4 4
       45 GETTABLEKS                       R4 R4 K1 ["TransformSettings"]
       47 GETTABLE                         R2 R3 R4
       48 GETUPVAL                         R3 5
       49 GETTABLEKS                       R3 R3 K7 ["TerrainRegion"]
       ...
       73 GETUPVAL                         R1 9
       74 GETUPVAL                         R3 10
       75 GETTABLEKS                       R3 R3 K0 ["Transform"]
       77 GETUPVAL                         R4 10
       78 GETTABLEKS                       R4 R4 K10 ["Size"]
