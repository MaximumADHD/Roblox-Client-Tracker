...
PROTO_1:
        ...
        3 LOADK                            R3 K1 ["Studio.Test.Tabs.%*:[]"]
        4 MOVE                             R5 R0
        5 NAMECALL                         R3 R3 K2 ["format"]
        7 CALL                             R3 2 1
        8 MOVE                             R2 R3
        9 CALL                             R1 1 1
       10 GETTABLEKS                       R1 R1 K3 ["Parent"]
       12 GETTABLEKS                       R1 R1 K3 ["Parent"]
       14 GETUPVAL                         R2 1
       15 GETTABLEKS                       R2 R2 K4 ["fireEvent"]
       17 GETTABLEKS                       R2 R2 K5 ["click"]
       19 MOVE                             R3 R1
       20 CALL                             R2 1 0
       21 RETURN                           R0 0
...
PROTO_2:
        ...
        7 LOADK                            R4 K1 ["Studio.Test.BaseTool.%*:[]"]
        8 MOVE                             R6 R0
       ...
       16 GETTABLEKS                       R2 R2 K4 ["ButtonContainer"]
       18 GETTABLEKS                       R1 R2 K5 ["Button"]
       20 JUMP                             ; [+14]
       21 GETUPVAL                         R2 1
       22 GETTABLEKS                       R2 R2 K0 ["getByText"]
       24 LOADK                            R4 K1 ["Studio.Test.BaseTool.%*:[]"]
       25 MOVE                             R6 R0
       26 NAMECALL                         R4 R4 K2 ["format"]
       28 CALL                             R4 2 1
       29 MOVE                             R3 R4
       30 CALL                             R2 1 1
       31 GETTABLEKS                       R2 R2 K3 ["Parent"]
       33 GETTABLEKS                       R1 R2 K3 ["Parent"]
       35 GETUPVAL                         R2 2
       36 GETTABLEKS                       R2 R2 K6 ["fireEvent"]
       38 GETTABLEKS                       R2 R2 K7 ["click"]
       40 MOVE                             R3 R1
       41 CALL                             R2 1 0
       42 RETURN                           R0 0
...
PROTO_6:
        ...
        9 MOVE                             R3 R4
       10 CALL                             R2 1 1
       11 GETTABLEKS                       R2 R2 K3 ["Parent"]
       13 GETTABLEKS                       R2 R2 K3 ["Parent"]
       15 GETTABLEKS                       R2 R2 K3 ["Parent"]
       17 GETTABLEKS                       R2 R2 K4 ["Property"]
       19 LOADK                            R5 K5 ["PropertyCell"]
       20 NAMECALL                         R3 R2 K6 ["FindFirstChild"]
       22 CALL                             R3 2 1
       23 JUMPIFNOT                        R3 ; [+5]
       24 GETTABLEKS                       R3 R2 K5 ["PropertyCell"]
       26 GETTABLEKS                       R3 R3 K7 ["Content"]
       28 RETURN                           R3 1
...
PROTO_15:
       ...
       32 CALL                             R6 2 1
       33 GETUPVAL                         R7 1
       34 GETTABLEKS                       R7 R7 K3 ["fireEvent"]
       36 GETTABLEKS                       R7 R7 K4 ["click"]
       38 MOVE                             R8 R6
       39 CALL                             R7 1 0
       40 RETURN                           R0 0
...
PROTO_22:
       ...
       16 JUMP                             ; [+16]
       17 GETUPVAL                         R3 1
       18 GETTABLEKS                       R3 R3 K3 ["getByText"]
       ...
       32 MOVE                             R2 R3
       33 GETUPVAL                         R3 2
       34 GETTABLEKS                       R3 R3 K7 ["MaybeScrollTo"]
       36 MOVE                             R4 R2
       37 CALL                             R3 1 0
       38 GETUPVAL                         R3 3
       39 GETTABLEKS                       R3 R3 K8 ["fireEvent"]
       41 GETTABLEKS                       R3 R3 K9 ["click"]
       43 MOVE                             R4 R2
       44 CALL                             R3 1 0
       45 RETURN                           R0 0
