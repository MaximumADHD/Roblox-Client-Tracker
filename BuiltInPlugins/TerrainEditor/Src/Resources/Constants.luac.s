MAIN:
  PREPVARARGS 0
  DUPTABLE R0 K15 [{"AspectRatioThreshold", "GridLineWidth", "MaxScaleFactor", "MaximumOccupancy", "MinimumOccupancy", "MinimumSmooth", "RayLength", "TerrainCacheMaxRadius", "TerrainCacheMultiplier", "TerrainCacheUpdateThreshold", "VoxelResolution", "MaxRegion", "MaxBuildRegion", "MaxMaterialListSize", "MaxImportVolume"}]
  LOADK R1 K16 [0.1]
  ...
  LOADN R1 0
  SETTABLEKS R1 R0 K12 ["MaxBuildRegion"]
  LOADN R1 5
  SETTABLEKS R1 R0 K13 ["MaxMaterialListSize"]
  LOADK R1 K20 [274877906944]
  SETTABLEKS R1 R0 K14 ["MaxImportVolume"]
  RETURN R0 1
