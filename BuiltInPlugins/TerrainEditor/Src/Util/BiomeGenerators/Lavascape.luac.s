PROTO_0:
  ...
  LOADN R21 1
  GETUPVAL R23 2
  GETTABLEKS R22 R23 K12 ["Threshold"]
  MOVE R23 R12
  LOADK R24 K14 [0.975]
  LOADN R25 0
  CALL R22 3 1
  ...
  LOADK R21 K25 [0.4]
  CALL R18 3 1
  ADDK R23 R6 K26 [0.02]
  LOADK R27 K13 [0.5]
  MULK R28 R15 K13 [0.5]
  ADD R26 R27 R28
  MUL R25 R16 R26
  MULK R24 R25 K26 [0.02]
  ADD R22 R23 R24
  MULK R23 R15 K27 [0.05]
  ADD R21 R22 R23
  MULK R22 R18 K28 [0.3]
  ADD R20 R21 R22
  LOADN R23 1
  SUB R22 R23 R1
  ADDK R23 R6 K29 [0.01]
  JUMPIFLT R23 R22 [+4]
  LOADN R22 0
  ...
  GETIMPORT R20 K34 [Enum.Material.Rock]
  JUMP [+8]
  LOADN R21 1
  JUMPIFNOTLT R16 R21 [+4]
  GETIMPORT R20 K36 [Enum.Material.CrackedLava]
  JUMP [+2]
  GETIMPORT R20 K38 [Enum.Material.Basalt]
  GETIMPORT R22 K36 [Enum.Material.CrackedLava]
  JUMPIFNOTEQ R20 R22 [+8]
  LOADN R23 1
  SUB R22 R23 R1
  JUMPIFNOTLT R22 R6 [+4]
  GETIMPORT R21 K38 [Enum.Material.Basalt]
  JUMP [+1]
  MOVE R21 R20
  MOVE R22 R19
  MOVE R23 R21
