PROTO_0:
  ...
  MULK R13 R8 K12 [0.1]
  ADD R11 R12 R13
  SUBK R13 R6 K15 [0.015]
  JUMPIFNOTLT R11 R13 [+4]
  GETIMPORT R12 K19 [Enum.Material.Mud]
  JUMP [+7]
  JUMPIFNOTLT R11 R6 [+4]
  GETIMPORT R12 K21 [Enum.Material.Ground]
  JUMP [+2]
  GETIMPORT R12 K23 [Enum.Material.Grass]
  GETIMPORT R13 K25 [Enum.Material.Slate]
  MOVE R14 R10
  MOVE R15 R12
  MOVE R16 R13
  RETURN R14 3
