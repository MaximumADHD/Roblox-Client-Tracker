...
PROTO_1:
  ...
  ADD R18 R20 R21
  LOADN R20 0
  JUMPIFNOTLT R20 R18 [+33]
  LOADN R20 1
  JUMPIFNOTLT R18 R20 [+30]
  MOVE R22 R18
  LOADN R25 0
  JUMPIFLT R25 R2 [+2]
  LOADB R24 0 +1
  ...
  MINUS R27 R28
  DIV R26 R27 R2
  FASTCALL1 MATH_EXP R26 [+2]
  GETIMPORT R25 K20 [math.exp]
  CALL R25 1 1
  MUL R24 R25 R3
  SUB R21 R23 R24
  LOADN R22 0
