PROTO_0:
  ...
  JUMPIFNOT R31 [+6]
  LOADN R28 1
  GETIMPORT R19 K41 [Enum.Material.Water]
  GETIMPORT R20 K41 [Enum.Material.Water]
  LOADB R22 1
  ...
  GETIMPORT R33 K43 [Enum.Material.Air]
  JUMP [+4]
  JUMPIFNOT R22 [+2]
  MOVE R33 R19
  JUMP [+1]
  ...
  LOADN R35 0
  JUMPIFLE R32 R35 [+7]
  GETIMPORT R35 K43 [Enum.Material.Air]
  JUMPIFEQ R33 R35 [+2]
  LOADB R34 0 +1
  LOADB R34 1
  MOVE R35 R33
