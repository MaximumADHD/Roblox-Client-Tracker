...
MAIN:
  ...
  GETTABLEKS R6 R7 K13 ["getFFlagTerrainEditorBrushPerformanceEnhancements"]
  CALL R5 1 1
  MOVE R6 R5
  CALL R6 0 1
  NEWTABLE R7 64 0
  ...
  SETTABLEKS R8 R7 K20 ["start"]
  DUPCLOSURE R8 K21 [PROTO_4]
  SETTABLEKS R8 R7 K22 ["pause"]
  DUPCLOSURE R8 K23 [PROTO_5]
  SETTABLEKS R8 R7 K24 ["resume"]
  DUPCLOSURE R8 K25 [PROTO_6]
  SETTABLEKS R8 R7 K26 ["togglePause"]
  DUPCLOSURE R8 K27 [PROTO_7]
  SETTABLEKS R8 R7 K28 ["cancel"]
  DUPCLOSURE R8 K29 [PROTO_8]
  SETTABLEKS R8 R7 K30 ["getName"]
  DUPCLOSURE R8 K31 [PROTO_9]
  SETTABLEKS R8 R7 K32 ["setName"]
  DUPCLOSURE R8 K33 [PROTO_10]
  SETTABLEKS R8 R7 K34 ["getDescription"]
  DUPCLOSURE R8 K35 [PROTO_11]
  SETTABLEKS R8 R7 K36 ["setDescription"]
  DUPCLOSURE R8 K37 [PROTO_12]
  SETTABLEKS R8 R7 K38 ["getOptions"]
  DUPCLOSURE R8 K39 [PROTO_13]
  SETTABLEKS R8 R7 K40 ["setOptions"]
  DUPCLOSURE R8 K41 [PROTO_14]
  CAPTURE VAL R1
  SETTABLEKS R8 R7 K42 ["updateOptions"]
  DUPCLOSURE R8 K43 [PROTO_15]
  SETTABLEKS R8 R7 K44 ["updatePayload"]
  DUPCLOSURE R8 K45 [PROTO_16]
  SETTABLEKS R8 R7 K46 ["canCancel"]
  DUPCLOSURE R8 K47 [PROTO_17]
  SETTABLEKS R8 R7 K48 ["canPause"]
  DUPCLOSURE R8 K49 [PROTO_18]
  SETTABLEKS R8 R7 K50 ["canResume"]
  DUPCLOSURE R8 K51 [PROTO_19]
  SETTABLEKS R8 R7 K52 ["hasStarted"]
  DUPCLOSURE R8 K53 [PROTO_20]
  SETTABLEKS R8 R7 K54 ["isPaused"]
  DUPCLOSURE R8 K55 [PROTO_21]
  SETTABLEKS R8 R7 K56 ["wasCanceled"]
  DUPCLOSURE R8 K57 [PROTO_22]
  SETTABLEKS R8 R7 K58 ["hasFinished"]
  DUPCLOSURE R8 K59 [PROTO_23]
  SETTABLEKS R8 R7 K60 ["isRunning"]
  DUPCLOSURE R8 K61 [PROTO_24]
  SETTABLEKS R8 R7 K62 ["didError"]
  DUPCLOSURE R8 K63 [PROTO_25]
  SETTABLEKS R8 R7 K64 ["getErrorMessage"]
  DUPCLOSURE R8 K65 [PROTO_26]
  SETTABLEKS R8 R7 K66 ["getProgress"]
  DUPCLOSURE R8 K67 [PROTO_27]
  SETTABLEKS R8 R7 K68 ["_setProgress"]
  DUPCLOSURE R8 K69 [PROTO_28]
  SETTABLEKS R8 R7 K70 ["getStepsTaken"]
  DUPCLOSURE R8 K71 [PROTO_29]
  SETTABLEKS R8 R7 K72 ["getCurrentTimeTaken"]
  DUPCLOSURE R8 K73 [PROTO_30]
  SETTABLEKS R8 R7 K74 ["getTimeTaken"]
  DUPCLOSURE R8 K75 [PROTO_31]
  SETTABLEKS R8 R7 K76 ["getYieldTime"]
  DUPCLOSURE R8 K77 [PROTO_32]
  SETTABLEKS R8 R7 K78 ["getWorkTime"]
  DUPCLOSURE R8 K79 [PROTO_33]
  SETTABLEKS R8 R7 K80 ["addTimeStatistic"]
  DUPCLOSURE R8 K81 [PROTO_34]
  SETTABLEKS R8 R7 K82 ["skipBudget"]
  DUPCLOSURE R8 K83 [PROTO_35]
  SETTABLEKS R8 R7 K84 ["getTimeStatistic"]
  DUPCLOSURE R8 K85 [PROTO_36]
  SETTABLEKS R8 R7 K86 ["_yield"]
  DUPCLOSURE R8 K87 [PROTO_37]
  SETTABLEKS R8 R7 K88 ["_handleError"]
  DUPCLOSURE R8 K89 [PROTO_39]
  SETTABLEKS R8 R7 K90 ["_runCallback"]
  DUPCLOSURE R8 K91 [PROTO_40]
  CAPTURE VAL R6
  SETTABLEKS R8 R7 K92 ["_runOperation"]
  RETURN R7 1
