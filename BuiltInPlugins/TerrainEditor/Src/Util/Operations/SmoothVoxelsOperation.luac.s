...
PROTO_1:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R2 R2 K0 ["SmoothVoxelsUpgraderService"]
        3 NAMECALL                         R2 R2 K1 ["Start"]
        5 CALL                             R2 1 0
        6 GETUPVAL                         R2 0
        7 GETTABLEKS                       R2 R2 K0 ["SmoothVoxelsUpgraderService"]
        9 GETTABLEKS                       R2 R2 K2 ["Status"]
       11 NEWCLOSURE                       R4 P0
       12 CAPTURE                          VAL R0
...
PROTO_2:
       ...
       10 GETUPVAL                         R3 0
       11 GETUPVAL                         R4 1
       12 GETTABLEKS                       R4 R4 K4 ["Terrain"]
       14 JUMPIFNOT                        R4 ; [+6]
       15 GETUPVAL                         R4 1
       16 GETTABLEKS                       R4 R4 K4 ["Terrain"]
...
PROTO_3:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["SmoothVoxelsUpgraderService"]
        3 NAMECALL                         R0 R0 K1 ["Cancel"]
        5 CALL                             R0 1 0
        6 GETUPVAL                         R0 1
        7 GETUPVAL                         R1 0
        8 GETTABLEKS                       R1 R1 K2 ["Terrain"]
       10 JUMPIFNOT                        R1 ; [+6]
       11 GETUPVAL                         R1 0
       12 GETTABLEKS                       R1 R1 K2 ["Terrain"]
...
PROTO_4:
        ...
        7 GETUPVAL                         R0 1
        8 GETUPVAL                         R1 0
        9 GETTABLEKS                       R1 R1 K3 ["Terrain"]
       11 JUMPIFNOT                        R1 ; [+6]
       12 GETUPVAL                         R1 0
       13 GETTABLEKS                       R1 R1 K3 ["Terrain"]
