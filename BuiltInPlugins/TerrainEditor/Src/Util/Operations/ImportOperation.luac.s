...
PROTO_1:
  ...
  LOADB R7 1
  CALL R4 3 1
  GETIMPORT R5 K7 [Region3.new]
  GETTABLEKS R7 R4 K8 ["Min"]
  GETTABLEKS R10 R7 K10 ["X"]
  MULK R9 R10 K9 [4]
  GETTABLEKS R11 R7 K11 ["Y"]
  MULK R10 R11 K9 [4]
  GETTABLEKS R12 R7 K12 ["Z"]
  MULK R11 R12 K9 [4]
  FASTCALL VECTOR [+2]
  GETIMPORT R8 K14 [Vector3.new]
  CALL R8 3 1
  MOVE R6 R8
  GETTABLEKS R8 R4 K15 ["Max"]
  GETTABLEKS R11 R8 K10 ["X"]
  MULK R10 R11 K9 [4]
  GETTABLEKS R12 R8 K11 ["Y"]
  MULK R11 R12 K9 [4]
  GETTABLEKS R13 R8 K12 ["Z"]
  MULK R12 R13 K9 [4]
  FASTCALL VECTOR [+2]
  ...
  CALL R5 2 1
  GETUPVAL R9 4
  GETTABLEKS R8 R9 K16 ["Heightmap"]
  GETTABLE R7 R1 R8
  GETTABLEKS R6 R7 K17 ["Image"]
  JUMPIF R6 [+7]
  GETUPVAL R7 0
  GETTABLEKS R6 R7 K18 ["State"]
  LOADN R7 1
  SETTABLEKS R7 R6 K19 ["Progress"]
  RETURN R0 0
  GETUPVAL R10 4
  GETTABLEKS R9 R10 K16 ["Heightmap"]
  GETTABLE R8 R1 R9
  GETTABLEKS R7 R8 K17 ["Image"]
  GETTABLEKS R6 R7 K20 ["File"]
  NAMECALL R6 R6 K21 ["GetTemporaryId"]
  CALL R6 1 1
  GETUPVAL R10 4
  ...
  GETTABLEKS R7 R8 K17 ["Image"]
  JUMPIFNOT R7 [+6]
  GETTABLEKS R8 R7 K20 ["File"]
  NAMECALL R8 R8 K21 ["GetTemporaryId"]
  CALL R8 1 1
  JUMP [+1]
  LOADK R8 K23 [""]
  GETUPVAL R9 5
  ...
  MOVE R13 R8
  GETUPVAL R16 4
  GETTABLEKS R15 R16 K24 ["DefaultMaterial"]
  GETTABLE R14 R1 R15
  NAMECALL R9 R9 K25 ["ImportHeightmap"]
  CALL R9 5 0
  GETUPVAL R10 0
  GETTABLEKS R9 R10 K18 ["State"]
  LOADN R10 1
  SETTABLEKS R10 R9 K19 ["Progress"]
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R13 R14 K24 ["getFFlagTerrainEditorTimeStatistic"]
  CALL R12 1 1
