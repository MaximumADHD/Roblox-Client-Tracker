...
PROTO_1:
  ...
  MULK R9 R10 K6 [4]
  SUB R6 R6 R9
  GETIMPORT R7 K17 [Region3.new]
  MOVE R8 R5
  MOVE R9 R6
  CALL R7 2 1
  GETUPVAL R11 6
  GETTABLEKS R10 R11 K18 ["Heightmap"]
  GETTABLE R9 R1 R10
  GETTABLEKS R8 R9 K19 ["Image"]
  JUMPIF R8 [+7]
  GETUPVAL R9 0
  GETTABLEKS R8 R9 K20 ["State"]
  LOADN R9 1
  SETTABLEKS R9 R8 K21 ["Progress"]
  RETURN R0 0
  GETUPVAL R12 6
  GETTABLEKS R11 R12 K18 ["Heightmap"]
  GETTABLE R10 R1 R11
  GETTABLEKS R9 R10 K19 ["Image"]
  GETTABLEKS R8 R9 K22 ["File"]
  NAMECALL R8 R8 K23 ["GetTemporaryId"]
  CALL R8 1 1
  GETUPVAL R12 6
  GETTABLEKS R11 R12 K24 ["Colormap"]
  GETTABLE R10 R1 R11
  GETTABLEKS R9 R10 K19 ["Image"]
  JUMPIFNOT R9 [+6]
  GETTABLEKS R10 R9 K22 ["File"]
  ...
  MOVE R15 R10
  GETUPVAL R18 6
  GETTABLEKS R17 R18 K26 ["DefaultMaterial"]
  GETTABLE R16 R1 R17
  NAMECALL R11 R11 K27 ["ImportHeightmap"]
  CALL R11 5 0
  GETUPVAL R12 0
  GETTABLEKS R11 R12 K20 ["State"]
  LOADN R12 1
  SETTABLEKS R12 R11 K21 ["Progress"]
  RETURN R0 0
...
PROTO_8:
  ...
  CALL R5 -1 0
  GETUPVAL R4 5
  GETTABLEKS R3 R4 K13 ["ChangeHistoryService"]
  LOADK R5 K14 ["ImportAction"]
  NAMECALL R3 R3 K15 ["SetWaypoint"]
  CALL R3 2 0
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R14 R15 K25 ["getFFlagTerrainEditorTimeStatistic"]
  CALL R13 1 1
  GETIMPORT R14 K5 [require]
  GETTABLEKS R17 R0 K6 ["Src"]
  GETTABLEKS R16 R17 K24 ["Flags"]
  GETTABLEKS R15 R16 K26 ["getFFlagTerrainEditorHeightmapFixes"]
  CALL R14 1 1
