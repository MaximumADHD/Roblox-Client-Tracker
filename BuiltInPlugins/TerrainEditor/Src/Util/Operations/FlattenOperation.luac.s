...
PROTO_5:
  ...
  MOVE R46 R50
  GETUPVAL R50 9
  GETTABLEKS R49 R50 K36 ["Terrain"]
  MOVE R51 R34
  GETUPVAL R53 5
  GETTABLEKS R52 R53 K19 ["VoxelResolution"]
  NAMECALL R49 R49 K37 ["ReadVoxels"]
  CALL R49 3 2
  MOVE R47 R49
  MOVE R48 R50
  NEWCLOSURE R49 P0
  ...
  JUMPIFNOT R53 [+10]
  GETUPVAL R56 16
  GETTABLEKS R55 R56 K52 ["NormalizeBrushTimer"]
  MOVE R56 R40
  MOVE R57 R6
  MOVE R58 R5
  CALL R55 3 -1
  NAMECALL R53 R1 K53 ["addTimeStatistic"]
  CALL R53 -1 0
  JUMPIFNOT R12 [+12]
  GETUPVAL R54 9
  GETTABLEKS R53 R54 K36 ["Terrain"]
  MOVE R55 R34
  GETUPVAL R57 5
  GETTABLEKS R56 R57 K19 ["VoxelResolution"]
  MOVE R57 R47
  MOVE R58 R48
  NAMECALL R53 R53 K54 ["WriteVoxels"]
  CALL R53 5 0
  GETUPVAL R54 9
  GETTABLEKS R53 R54 K36 ["Terrain"]
  MOVE R55 R34
