PROTO_0:
  ...
  GETTABLE R6 R2 R7
  GETUPVAL R9 1
  GETTABLEKS R8 R9 K6 ["FixedPlane"]
  GETTABLE R7 R2 R8
  GETUPVAL R10 1
...
PROTO_5:
  ...
  LOADB R15 1
  GETUPVAL R19 4
  GETTABLEKS R18 R19 K17 ["Sphere"]
  JUMPIFNOTEQ R7 R18 [+3]
  MOVE R17 R6
  JUMP [+1]
  MOVE R17 R5
  GETUPVAL R19 5
  GETTABLEKS R18 R19 K18 ["VoxelResolution"]
  MUL R16 R17 R18
  GETUPVAL R19 5
  GETTABLEKS R18 R19 K18 ["VoxelResolution"]
  MUL R17 R6 R18
  MULK R18 R17 K19 [0.5]
  GETTABLEKS R19 R2 K20 ["Plane"]
  GETTABLEKS R20 R2 K21 ["PlanePosition"]
  GETTABLEKS R22 R19 K22 ["X"]
  FASTCALL1 MATH_ABS R22 [+2]
  GETIMPORT R21 K25 [math.abs]
  CALL R21 1 1
  GETTABLEKS R23 R19 K26 ["Y"]
  FASTCALL1 MATH_ABS R23 [+2]
  GETIMPORT R22 K25 [math.abs]
  CALL R22 1 1
  GETTABLEKS R24 R19 K27 ["Z"]
  ...
  GETUPVAL R25 6
  GETUPVAL R28 1
  GETTABLEKS R27 R28 K31 ["PivotPosition"]
  GETTABLE R26 R3 R27
  GETTABLEKS R27 R13 K32 ["Position"]
  MOVE R28 R16
  CALL R25 3 1
  GETUPVAL R26 7
  GETTABLEKS R27 R2 K32 ["Position"]
  MOVE R28 R25
  MOVE R29 R18
  CALL R26 3 1
  LENGTH R28 R26
  GETTABLE R27 R26 R28
  SETTABLEKS R27 R2 K32 ["Position"]
  GETUPVAL R27 8
  MOVE R28 R25
  MOVE R29 R18
  MOVE R30 R16
  ...
  LOADNIL R31
  FORGPREP R29
  GETIMPORT R34 K34 [Region3.new]
  MOVE R35 R27
  MOVE R36 R28
  CALL R34 2 1
  GETTABLEKS R37 R28 K22 ["X"]
  GETTABLEKS R38 R27 K22 ["X"]
  SUB R36 R37 R38
  MULK R35 R36 K19 [0.5]
  GETUPVAL R37 9
  GETTABLEKS R36 R37 K35 ["Terrain"]
  MOVE R38 R34
  GETUPVAL R40 5
  GETTABLEKS R39 R40 K18 ["VoxelResolution"]
  ...
  GETUPVAL R39 9
  GETTABLEKS R38 R39 K35 ["Terrain"]
  MOVE R40 R34
  GETUPVAL R42 5
  GETTABLEKS R41 R42 K18 ["VoxelResolution"]
  NAMECALL R38 R38 K36 ["ReadVoxels"]
  CALL R38 3 2
  LENGTH R40 R36
  GETTABLEN R42 R36 1
  LENGTH R41 R42
  ...
  MOVE R45 R49
  GETUPVAL R49 9
  GETTABLEKS R48 R49 K35 ["Terrain"]
  MOVE R50 R34
  GETUPVAL R52 5
  GETTABLEKS R51 R52 K18 ["VoxelResolution"]
  NAMECALL R48 R48 K36 ["ReadVoxels"]
  CALL R48 3 2
  MOVE R46 R48
  MOVE R47 R49
  NEWCLOSURE R48 P0
  ...
  CAPTURE VAL R15
  CAPTURE VAL R49
  GETTABLEKS R52 R24 K22 ["X"]
  JUMPIFEQKN R52 K37 [0] [+32]
  DUPTABLE R52 K40 [{"Direction", "Increment", "Size"}]
  GETIMPORT R53 K42 [Vector3.xAxis]
  SETTABLEKS R53 R52 K38 ["Direction"]
  GETTABLEKS R53 R24 K22 ["X"]
  SETTABLEKS R53 R52 K39 ["Increment"]
  ...
  DUPTABLE R54 K43 [{"Direction", "Size"}]
  GETIMPORT R55 K47 [Vector3.zAxis]
  SETTABLEKS R55 R54 K38 ["Direction"]
  ...
  CALL R55 3 0
  JUMP [+69]
  GETTABLEKS R52 R24 K26 ["Y"]
  JUMPIFEQKN R52 K37 [0] [+32]
  DUPTABLE R52 K40 [{"Direction", "Increment", "Size"}]
  GETIMPORT R53 K45 [Vector3.yAxis]
  SETTABLEKS R53 R52 K38 ["Direction"]
  GETTABLEKS R53 R24 K26 ["Y"]
  SETTABLEKS R53 R52 K39 ["Increment"]
  SETTABLEKS R41 R52 K8 ["Size"]
  DUPTABLE R53 K43 [{"Direction", "Size"}]
  GETIMPORT R54 K42 [Vector3.xAxis]
  SETTABLEKS R54 R53 K38 ["Direction"]
  ...
  CALL R55 3 0
  JUMP [+34]
  GETTABLEKS R52 R24 K27 ["Z"]
  JUMPIFEQKN R52 K37 [0] [+31]
  DUPTABLE R52 K40 [{"Direction", "Increment", "Size"}]
  GETIMPORT R53 K47 [Vector3.zAxis]
  SETTABLEKS R53 R52 K38 ["Direction"]
  GETTABLEKS R53 R24 K27 ["Z"]
  SETTABLEKS R53 R52 K39 ["Increment"]
  ...
  SETTABLEKS R40 R53 K8 ["Size"]
  DUPTABLE R54 K43 [{"Direction", "Size"}]
  GETIMPORT R55 K45 [Vector3.yAxis]
  SETTABLEKS R55 R54 K38 ["Direction"]
  ...
  JUMPIFNOT R12 [+12]
  GETUPVAL R53 9
  GETTABLEKS R52 R53 K35 ["Terrain"]
  MOVE R54 R34
  GETUPVAL R56 5
  GETTABLEKS R55 R56 K18 ["VoxelResolution"]
  MOVE R56 R46
  MOVE R57 R47
  NAMECALL R52 R52 K48 ["WriteVoxels"]
  CALL R52 5 0
  GETUPVAL R53 9
  GETTABLEKS R52 R53 K35 ["Terrain"]
  MOVE R54 R34
...
MAIN:
  ...
  GETTABLEKS R14 R11 K22 ["Categories"]
