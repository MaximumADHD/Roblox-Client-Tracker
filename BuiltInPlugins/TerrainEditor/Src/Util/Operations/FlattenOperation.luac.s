...
PROTO_1:
  ...
  JUMPIFNOT R63 [+37]
  MUL R66 R60 R10
  MULK R65 R66 K48 [0.1]
  FASTCALL1 MATH_LOG R6 [+3]
  MOVE R68 R6
  GETIMPORT R67 K51 [math.log]
  CALL R67 1 1
  DIVK R66 R67 K49 [8]
  MUL R64 R65 R66
  GETUPVAL R66 5
  GETTABLEKS R65 R66 K52 ["MinimumOccupancy"]
  FASTCALL2 MATH_MAX R64 R65 [+3]
  GETIMPORT R63 K54 [math.max]
  CALL R63 2 1
  MOVE R61 R63
  MUL R66 R60 R10
  MULK R65 R66 K48 [0.1]
  ...
  JUMP [+4]
  MUL R63 R60 R10
  MULK R61 R63 K48 [0.1]
  MUL R63 R60 R10
  MULK R62 R63 K48 [0.1]
  LOADB R63 0
  JUMPIFNOT R12 [+78]
  LOADN R66 1
  MOVE R64 R39
...
MAIN:
  ...
  GETTABLEKS R20 R21 K28 ["getFFlagTerrainEditorMiscBrushImprovements"]
  CALL R19 1 1
  MOVE R20 R19
  CALL R20 0 1
  GETTABLEKS R21 R1 K29 ["VoxelResolution"]
