...
PROTO_1:
  ...
  FORNPREP R5
  LOADN R10 1
  GETTABLEKS R8 R0 K14 ["_sliceZ"]
  LOADN R9 1
  FORNPREP R8
  MOVE R13 R7
  MOVE R14 R10
  NAMECALL R11 R0 K15 ["getIndex"]
  CALL R11 3 1
  GETTABLEKS R12 R0 K16 ["_getRotatedPoint"]
  SUBK R13 R7 K17 [0.5]
  SUBK R14 R10 K17 [0.5]
  CALL R12 2 2
  GETUPVAL R16 2
  MUL R15 R12 R16
  GETTABLEKS R16 R2 K18 ["X"]
  SUB R14 R15 R16
  GETUPVAL R17 2
  MUL R16 R13 R17
  GETTABLEKS R17 R2 K19 ["Y"]
  SUB R15 R16 R17
  GETUPVAL R16 3
  MOVE R17 R14
  MOVE R18 R15
  ...
  MOVE R20 R4
  CALL R16 4 1
  MULK R17 R16 K17 [0.5]
  ADDK R16 R17 K17 [0.5]
  GETUPVAL R18 4
