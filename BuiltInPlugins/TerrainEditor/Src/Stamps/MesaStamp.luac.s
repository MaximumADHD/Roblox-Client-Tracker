...
PROTO_3:
  ...
  GETTABLE R7 R8 R9
  GETUPVAL R9 1
  GETTABLEKS R8 R9 K9 ["RimHeight"]
  GETTABLE R6 R7 R8
  GETIMPORT R7 K12 [table.create]
  GETTABLEKS R9 R0 K13 ["_sliceX"]
  GETTABLEKS R10 R0 K14 ["_sliceZ"]
  MUL R8 R9 R10
  LOADN R9 0
  CALL R7 2 1
  SETTABLEKS R7 R0 K15 ["_noiseMap"]
  JUMPIFNOT R5 [+1]
  JUMPIF R6 [+5]
  GETIMPORT R7 K17 [warn]
  LOADK R8 K18 ["Missing parameters!"]
  CALL R7 1 0
  RETURN R0 0
  DUPTABLE R7 K22 [{"center2d", "hillWidth", "hillHeight"}]
  GETIMPORT R8 K25 [Vector2.new]
  LOADK R9 K26 [0.5]
  LOADK R10 K26 [0.5]
  CALL R8 2 1
  SETTABLEKS R8 R7 K19 ["center2d"]
  LOADK R8 K27 [0.2]
  SETTABLEKS R8 R7 K20 ["hillWidth"]
  LOADK R9 K28 [1.2]
  ADD R8 R9 R5
  SETTABLEKS R8 R7 K21 ["hillHeight"]
  DUPTABLE R8 K33 [{"frequency", "amplitude", "offset", "seed"}]
  MULK R10 R1 K35 [5]
  MULK R9 R10 K34 [2]
  SETTABLEKS R9 R8 K29 ["frequency"]
  MULK R10 R2 K37 [0.16]
  MULK R9 R10 K36 [3]
  SETTABLEKS R9 R8 K30 ["amplitude"]
  SETTABLEKS R3 R8 K31 ["offset"]
  SETTABLEKS R4 R8 K32 ["seed"]
  LOADN R10 0
  ...
  LOADB R9 0
  JUMPIFNOT R9 [+10]
  GETIMPORT R10 K12 [table.create]
  GETTABLEKS R12 R0 K13 ["_sliceX"]
  GETTABLEKS R13 R0 K14 ["_sliceZ"]
  MUL R11 R12 R13
  LOADN R12 0
  CALL R10 2 1
  JUMP [+1]
  LOADNIL R10
  LOADN R13 1
  GETTABLEKS R11 R0 K13 ["_sliceX"]
  LOADN R12 1
  FORNPREP R11
  LOADN R16 1
  GETTABLEKS R14 R0 K14 ["_sliceZ"]
  LOADN R15 1
  FORNPREP R14
  MOVE R19 R13
  MOVE R20 R16
  ...
  GETTABLEKS R20 R0 K13 ["_sliceX"]
  DIV R19 R13 R20
  GETTABLEKS R21 R0 K14 ["_sliceZ"]
  DIV R20 R16 R21
  CALL R18 2 1
  GETUPVAL R19 2
  MOVE R20 R18
  ...
  LOADNIL R22
  CALL R19 3 1
  GETTABLEKS R20 R0 K15 ["_noiseMap"]
  ...
  CALL R20 3 1
  SUB R21 R20 R19
  SETTABLE R21 R10 R17
  FORNLOOP R14
  FORNLOOP R11
  JUMPIFNOT R9 [+30]
  NAMECALL R11 R0 K39 ["addErosion"]
  CALL R11 1 0
  LOADN R13 1
  GETTABLEKS R11 R0 K13 ["_sliceX"]
  LOADN R12 1
  ...
  NAMECALL R17 R0 K38 ["getIndex"]
  CALL R17 3 1
  GETTABLEKS R18 R0 K15 ["_noiseMap"]
  GETTABLE R19 R18 R17
  GETTABLE R21 R10 R17
  GETTABLEKS R23 R0 K15 ["_noiseMap"]
  GETTABLE R22 R23 R17
  MUL R20 R21 R22
  ADD R19 R19 R20
  ...
  FORNPREP R12
  LOADN R17 1
  GETTABLEKS R15 R0 K14 ["_sliceZ"]
  LOADN R16 1
  FORNPREP R15
  MOVE R20 R14
  MOVE R21 R17
  NAMECALL R18 R0 K38 ["getIndex"]
  CALL R18 3 1
  GETTABLEKS R20 R0 K15 ["_noiseMap"]
  GETTABLE R19 R20 R18
  LOADN R20 1
  JUMPIFNOTLT R19 R20 [+10]
  GETTABLEKS R19 R0 K15 ["_noiseMap"]
