...
PROTO_1:
  ...
  GETUPVAL R12 1
  GETTABLEKS R11 R12 K11 ["TalusHeight"]
  GETTABLE R9 R10 R11
  SUB R7 R8 R9
  DUPTABLE R8 K15 [{"center2d", "hillWidth", "hillHeight"}]
  GETIMPORT R9 K18 [Vector2.new]
  LOADK R10 K19 [0.5]
  LOADK R11 K19 [0.5]
  CALL R9 2 1
  SETTABLEKS R9 R8 K12 ["center2d"]
  LOADK R9 K20 [0.2]
  SETTABLEKS R9 R8 K13 ["hillWidth"]
  LOADN R10 1
  MULK R11 R6 K21 [1.2]
  ADD R9 R10 R11
  SETTABLEKS R9 R8 K14 ["hillHeight"]
  LOADN R10 0
  ...
  LOADB R9 0
  JUMPIFNOT R9 [+13]
  DUPTABLE R10 K26 [{"frequency", "amplitude", "offset", "seed"}]
  MULK R11 R1 K27 [0.05]
  SETTABLEKS R11 R10 K22 ["frequency"]
  MULK R12 R2 K29 [0.16]
  MULK R11 R12 K28 [3]
  SETTABLEKS R11 R10 K23 ["amplitude"]
  SETTABLEKS R3 R10 K24 ["offset"]
  SETTABLEKS R4 R10 K25 ["seed"]
  JUMP [+1]
  LOADNIL R10
  MOVE R13 R8
  MOVE R14 R10
  NAMECALL R11 R0 K30 ["generateHill"]
  CALL R11 3 0
  JUMPIFNOT R9 [+6]
  NAMECALL R11 R0 K31 ["addErosion"]
  CALL R11 1 0
  NAMECALL R11 R0 K32 ["addMacroNoise"]
  CALL R11 1 0
  LOADB R11 0
  LOADN R12 0
  ...
  JUMPIFNOT R11 [+62]
  LOADN R14 1
  GETTABLEKS R12 R0 K33 ["_mapSize"]
  LOADN R13 1
  FORNPREP R12
  GETTABLEKS R16 R0 K34 ["_noiseMap"]
  GETTABLE R15 R16 R14
  LOADN R16 1
  JUMPIFNOTLT R15 R16 [+51]
  JUMPIFNOTEQKN R5 K35 [90] [+11]
  GETTABLEKS R15 R0 K34 ["_noiseMap"]
  GETTABLE R16 R15 R14
  GETTABLEKS R19 R0 K34 ["_noiseMap"]
  GETTABLE R18 R19 R14
  MUL R17 R7 R18
  SUB R16 R16 R17
  SETTABLE R16 R15 R14
  JUMP [+38]
  JUMPIFNOTEQKN R5 K36 [0] [+6]
  GETTABLEKS R15 R0 K34 ["_noiseMap"]
  LOADN R16 1
  SETTABLE R16 R15 R14
  JUMP [+31]
  LOADN R16 1
  SUB R15 R16 R7
  MULK R18 R5 K7 [3.14159265358979]
  DIVK R17 R18 K37 [180]
  FASTCALL1 MATH_TAN R17 [+2]
  GETIMPORT R16 K40 [math.tan]
  CALL R16 1 1
  GETTABLEKS R21 R0 K34 ["_noiseMap"]
  GETTABLE R20 R21 R14
  SUBK R19 R20 K41 [1]
  MUL R18 R16 R19
  ADDK R17 R18 K41 [1]
  JUMPIFNOTLE R15 R17 [+5]
  GETTABLEKS R18 R0 K34 ["_noiseMap"]
  ...
  ADDK R18 R19 K41 [1]
  DIV R20 R15 R18
  GETTABLEKS R22 R0 K34 ["_noiseMap"]
  GETTABLE R21 R22 R14
  MUL R19 R20 R21
  GETTABLEKS R20 R0 K34 ["_noiseMap"]
