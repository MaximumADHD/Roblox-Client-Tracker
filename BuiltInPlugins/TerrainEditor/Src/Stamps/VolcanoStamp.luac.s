...
PROTO_3:
  ...
  LOADN R7 0
  LOADN R10 1
  GETTABLEKS R8 R0 K9 ["_sliceX"]
  LOADN R9 1
  FORNPREP R8
  LOADN R13 1
  GETTABLEKS R11 R0 K10 ["_sliceZ"]
  LOADN R12 1
  FORNPREP R11
  MOVE R16 R10
  MOVE R17 R13
  NAMECALL R14 R0 K27 ["getIndex"]
  CALL R14 3 1
  GETTABLEKS R16 R0 K11 ["_noiseMap"]
  GETTABLE R15 R16 R14
  LOADN R16 1
  JUMPIFNOTLT R16 R15 [+18]
  GETTABLEKS R18 R0 K9 ["_sliceX"]
  DIV R17 R10 R18
  LOADN R18 0
  GETTABLEKS R20 R0 K10 ["_sliceZ"]
  DIV R19 R13 R20
  FASTCALL VECTOR [+2]
  GETIMPORT R16 K30 [Vector3.new]
  CALL R16 3 1
  SUB R18 R16 R6
  GETTABLEKS R17 R18 K31 ["magnitude"]
  ...
  LOADN R12 1
  FORNPREP R11
  GETTABLEKS R16 R0 K9 ["_sliceX"]
  DIV R15 R10 R16
  LOADN R16 0
  GETTABLEKS R18 R0 K10 ["_sliceZ"]
  DIV R17 R13 R18
  FASTCALL VECTOR [+2]
  GETIMPORT R14 K30 [Vector3.new]
  CALL R14 3 1
  SUB R16 R14 R6
  GETTABLEKS R15 R16 K31 ["magnitude"]
  ...
  MOVE R20 R10
  MOVE R21 R13
  NAMECALL R18 R0 K27 ["getIndex"]
  CALL R18 3 1
  GETTABLEKS R20 R0 K11 ["_noiseMap"]
  GETTABLE R19 R20 R18
  LOADN R20 1
  JUMPIFLT R20 R19 [+3]
  JUMPIFNOTLT R17 R19 [+5]
  GETTABLEKS R20 R0 K11 ["_noiseMap"]
  ...
  GETTABLEKS R20 R0 K12 ["_fillBottomPositions"]
  LOADB R21 1
  SETTABLE R21 R20 R18
  FORNLOOP R11
  FORNLOOP R8
