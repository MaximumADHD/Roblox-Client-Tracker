...
PROTO_2:
  ...
  LOADB R5 0
  LOADB R6 0
  GETTABLEKS R11 R0 K4 ["_payload"]
  GETUPVAL R13 0
  GETTABLEKS R12 R13 K0 ["BuildSettings"]
  GETTABLE R10 R11 R12
  GETUPVAL R12 1
  GETTABLEKS R11 R12 K7 ["AdvancedNoise"]
  GETTABLE R9 R10 R11
  GETTABLEKS R8 R9 K6 ["Children"]
  GETUPVAL R10 1
  GETTABLEKS R9 R10 K8 ["Rotation"]
  GETTABLE R7 R8 R9
  JUMPIFNOT R3 [+99]
  GETUPVAL R10 1
  ...
  GETTABLEKS R11 R0 K9 ["_region"]
  NAMECALL R9 R0 K10 ["revertRegion"]
  CALL R9 2 0
  NAMECALL R9 R0 K11 ["setupRegion"]
  CALL R9 1 0
  ...
  LOADB R5 1
  GETUPVAL R10 1
  GETTABLEKS R9 R10 K12 ["BlendingEdge"]
  GETTABLE R8 R3 R9
  JUMPIFNOT R8 [+4]
  MOVE R11 R8
  NAMECALL R9 R0 K13 ["updateBlendingFactorMap"]
  CALL R9 2 0
  GETUPVAL R11 1
  ...
  GETTABLEKS R11 R12 K7 ["AdvancedNoise"]
  GETTABLE R10 R3 R11
  GETTABLEKS R9 R10 K6 ["Children"]
  JUMPIFNOT R9 [+20]
  GETUPVAL R13 1
  GETTABLEKS R12 R13 K7 ["AdvancedNoise"]
  GETTABLE R11 R3 R12
  GETTABLEKS R10 R11 K6 ["Children"]
  GETUPVAL R12 1
  GETTABLEKS R11 R12 K8 ["Rotation"]
  GETTABLE R9 R10 R11
  JUMPIFNOT R9 [+9]
  GETTABLEKS R9 R0 K14 ["_addRotationY"]
  JUMPIFNOT R9 [+6]
  GETTABLEKS R9 R0 K15 ["_rotationY"]
  JUMPIFEQ R9 R7 [+3]
  LOADB R6 1
  JUMP [+1]
  LOADB R6 0
  JUMPIF R6 [+26]
  GETUPVAL R11 1
  GETTABLEKS R10 R11 K3 ["Transform"]
  GETTABLE R9 R3 R10
  JUMPIFNOT R9 [+1]
  JUMPIFNOT R5 [+20]
  GETUPVAL R11 1
  ...
  JUMPIF R9 [+15]
  GETUPVAL R11 1
  GETTABLEKS R10 R11 K16 ["Material"]
  GETTABLE R9 R3 R10
  JUMPIF R9 [+10]
  GETUPVAL R11 1
  GETTABLEKS R10 R11 K17 ["MaterialLUT"]
  GETTABLE R9 R3 R10
  JUMPIF R9 [+5]
  GETUPVAL R11 1
  GETTABLEKS R10 R11 K18 ["WaterLevel"]
  GETTABLE R9 R3 R10
  JUMPIFNOT R9 [+1]
  LOADB R4 0
  GETTABLEKS R11 R0 K4 ["_payload"]
  ...
  GETTABLE R10 R11 R12
  GETUPVAL R12 1
  GETTABLEKS R11 R12 K12 ["BlendingEdge"]
  GETTABLE R9 R10 R11
  LOADN R10 0
  JUMPIFLT R10 R9 [+2]
  LOADB R8 0 +1
  LOADB R8 1
  SETTABLEKS R8 R0 K19 ["_addBlending"]
  SETTABLEKS R7 R0 K15 ["_rotationY"]
  GETTABLEKS R8 R0 K14 ["_addRotationY"]
  JUMPIF R8 [+10]
  JUMPIFNOT R7 [+9]
  LOADN R8 0
  JUMPIFNOTLT R8 R7 [+7]
  ...
  JUMPIFNOTLT R7 R8 [+4]
  LOADB R8 1
  SETTABLEKS R8 R0 K14 ["_addRotationY"]
  GETTABLEKS R9 R0 K14 ["_addRotationY"]
  JUMPIFNOT R9 [+11]
  GETTABLEKS R11 R0 K21 ["_rotatedSlice"]
  GETTABLEKS R12 R0 K22 ["_sliceX"]
  SUB R10 R11 R12
  DIVK R9 R10 K20 [2]
  ...
  JUMP [+1]
  LOADN R8 0
  SETTABLEKS R8 R0 K26 ["_rotatedXOffset"]
  GETTABLEKS R9 R0 K14 ["_addRotationY"]
  JUMPIFNOT R9 [+11]
  GETTABLEKS R11 R0 K21 ["_rotatedSlice"]
  GETTABLEKS R12 R0 K27 ["_sliceZ"]
  SUB R10 R11 R12
  DIVK R9 R10 K20 [2]
  FASTCALL1 MATH_FLOOR R9 [+2]
  GETIMPORT R8 K25 [math.floor]
  ...
  JUMP [+1]
  LOADN R8 0
  SETTABLEKS R8 R0 K28 ["_rotatedZOffset"]
  GETTABLEKS R9 R0 K14 ["_addRotationY"]
  JUMPIFNOT R9 [+3]
  GETTABLEKS R8 R0 K21 ["_rotatedSlice"]
  JUMP [+2]
  GETTABLEKS R8 R0 K22 ["_sliceX"]
  SETTABLEKS R8 R0 K29 ["_rotatedSliceX"]
  GETTABLEKS R9 R0 K14 ["_addRotationY"]
  JUMPIFNOT R9 [+3]
  GETTABLEKS R8 R0 K21 ["_rotatedSlice"]
  JUMP [+2]
  GETTABLEKS R8 R0 K27 ["_sliceZ"]
  SETTABLEKS R8 R0 K30 ["_rotatedSliceZ"]
  MOVE R10 R4
  MOVE R11 R6
  NAMECALL R8 R0 K31 ["generateStamp"]
  CALL R8 3 0
  RETURN R0 0
...
PROTO_4:
  ...
  GETTABLEKS R7 R0 K12 ["_sliceX"]
  POWK R6 R7 K4 [2]
  GETTABLEKS R8 R0 K16 ["_sliceZ"]
  POWK R7 R8 K4 [2]
  ADD R5 R6 R7
  FASTCALL1 MATH_SQRT R5 [+2]
  GETIMPORT R4 K19 [math.sqrt]
  CALL R4 1 1
  FASTCALL1 MATH_CEIL R4 [+2]
  GETIMPORT R3 K21 [math.ceil]
  CALL R3 1 1
  SETTABLEKS R3 R0 K22 ["_rotatedSlice"]
  GETTABLEKS R5 R0 K9 ["_region"]
  NAMECALL R3 R0 K23 ["cacheRegion"]
  CALL R3 2 0
  ...
  GETTABLE R6 R7 R8
  GETUPVAL R8 1
  GETTABLEKS R7 R8 K24 ["BlendingEdge"]
  GETTABLE R5 R6 R7
  NAMECALL R3 R0 K25 ["updateBlendingFactorMap"]
  CALL R3 2 0
  RETURN R0 0
...
PROTO_6:
  GETTABLEKS R5 R0 K0 ["_rotatedSlice"]
  SUBK R6 R1 K1 [1]
  MUL R4 R5 R6
  ADD R3 R4 R2
  RETURN R3 1
...
PROTO_7:
  GETTABLEKS R3 R0 K0 ["_addRotationY"]
  JUMPIFNOT R3 [+6]
  MOVE R5 R1
  MOVE R6 R2
  NAMECALL R3 R0 K1 ["getRotatedIndex"]
  CALL R3 3 -1
  RETURN R3 -1
  MOVE R5 R1
  MOVE R6 R2
  NAMECALL R3 R0 K2 ["getIndex"]
  CALL R3 3 -1
  RETURN R3 -1

PROTO_8:
  GETTABLEKS R6 R0 K0 ["_rotatedXOffset"]
  ADD R5 R1 R6
  GETTABLEKS R7 R0 K1 ["_rotatedZOffset"]
  ADD R6 R2 R7
  NAMECALL R3 R0 K2 ["getSliceIndex"]
  CALL R3 3 -1
  RETURN R3 -1
...
PROTO_9:
  ...
  GETIMPORT R4 K4 [Vector3.zero]
  JUMPIFNOTEQ R3 R4 [+2]
  RETURN R0 0
  JUMPIFNOT R1 [+20]
  GETIMPORT R3 K7 [debug.profilebegin]
  LOADK R4 K8 ["TG_GenerateNoise"]
  CALL R3 1 0
  NAMECALL R3 R0 K9 ["generateNoiseMap"]
  CALL R3 1 0
  GETIMPORT R3 K11 [debug.profileend]
  CALL R3 0 0
  GETIMPORT R3 K7 [debug.profilebegin]
  LOADK R4 K12 ["TG_GenerateHeight"]
  CALL R3 1 0
  NAMECALL R3 R0 K13 ["generateHeightMap"]
  CALL R3 1 0
  GETIMPORT R3 K11 [debug.profileend]
  CALL R3 0 0
  GETTABLEKS R3 R0 K14 ["_addRotationY"]
  JUMPIFNOT R3 [+12]
  JUMPIF R1 [+1]
  JUMPIFNOT R2 [+10]
  GETIMPORT R3 K7 [debug.profilebegin]
  LOADK R4 K15 ["TG_RotateHeight"]
  CALL R3 1 0
  NAMECALL R3 R0 K16 ["generateRotatedHeightMap"]
  CALL R3 1 0
  GETIMPORT R3 K11 [debug.profileend]
  CALL R3 0 0
  GETIMPORT R3 K7 [debug.profilebegin]
  LOADK R4 K17 ["TG_BlendHeight"]
  CALL R3 1 0
  NAMECALL R3 R0 K18 ["blendHeightMap"]
  CALL R3 1 0
  GETIMPORT R3 K11 [debug.profileend]
  CALL R3 0 0
  GETIMPORT R3 K7 [debug.profilebegin]
  LOADK R4 K19 ["TG_GenerateOccupancyMap"]
  CALL R3 1 0
  NAMECALL R3 R0 K20 ["generateOccupancyMap"]
  CALL R3 1 0
  GETIMPORT R3 K11 [debug.profileend]
  CALL R3 0 0
  GETIMPORT R3 K7 [debug.profilebegin]
  LOADK R4 K21 ["TG_GenerateSlopeMap"]
  CALL R3 1 0
  NAMECALL R3 R0 K22 ["generateSlopeMap"]
  CALL R3 1 0
  GETIMPORT R3 K11 [debug.profileend]
  CALL R3 0 0
  GETIMPORT R3 K7 [debug.profilebegin]
  LOADK R4 K23 ["TG_GenerateMaterial"]
  CALL R3 1 0
  NAMECALL R3 R0 K24 ["generateMaterialMap"]
  CALL R3 1 0
  GETIMPORT R3 K11 [debug.profileend]
  CALL R3 0 0
  GETIMPORT R3 K7 [debug.profilebegin]
  LOADK R4 K25 ["TG_BlendMaterialMap"]
  CALL R3 1 0
  NAMECALL R3 R0 K26 ["blendMaterialMap"]
  CALL R3 1 0
  GETIMPORT R3 K11 [debug.profileend]
  CALL R3 0 0
  GETIMPORT R3 K7 [debug.profilebegin]
  LOADK R4 K27 ["TG_PostProcessing"]
  CALL R3 1 0
  NAMECALL R3 R0 K28 ["postProcessing"]
  CALL R3 1 0
  GETIMPORT R3 K11 [debug.profileend]
  CALL R3 0 0
  GETUPVAL R3 0
  CALL R3 0 1
  JUMPIFNOT R3 [+3]
  NAMECALL R3 R0 K29 ["debugDraw"]
  CALL R3 1 0
  GETTABLEKS R4 R0 K30 ["_services"]
  GETTABLEKS R3 R4 K31 ["Terrain"]
  GETTABLEKS R5 R0 K0 ["_region"]
  GETUPVAL R6 1
  GETTABLEKS R7 R0 K32 ["_materialMap"]
  GETTABLEKS R8 R0 K33 ["_occupancyMap"]
  NAMECALL R3 R3 K34 ["WriteVoxels"]
  CALL R3 5 0
  RETURN R0 0

PROTO_10:
  GETIMPORT R1 K2 [table.create]
  GETTABLEKS R3 R0 K3 ["_rotatedSliceX"]
  GETTABLEKS R4 R0 K4 ["_rotatedSliceZ"]
  MUL R2 R3 R4
  LOADN R3 0
  CALL R1 2 1
...
PROTO_12:
  PREPVARARGS 1
  GETTABLEKS R2 R0 K0 ["_sliceX"]
  GETTABLEKS R3 R0 K1 ["_sliceZ"]
  MUL R1 R2 R3
  GETTABLEKS R2 R0 K2 ["_heightMap"]
  JUMPIFNOT R2 [+5]
  GETTABLEKS R3 R0 K2 ["_heightMap"]
  LENGTH R2 R3
  JUMPIFEQ R2 R1 [+8]
  ...
  LOADN R4 0
  CALL R2 2 1
  SETTABLEKS R2 R0 K2 ["_heightMap"]
  GETTABLEKS R2 R0 K6 ["_addRotationY"]
  JUMPIFNOT R2 [+48]
  GETTABLEKS R3 R0 K7 ["_rotatedSlice"]
  GETTABLEKS R4 R0 K7 ["_rotatedSlice"]
  MUL R2 R3 R4
  GETTABLEKS R3 R0 K8 ["_outterHeightMap"]
  JUMPIFNOT R3 [+5]
  GETTABLEKS R4 R0 K8 ["_outterHeightMap"]
  LENGTH R3 R4
  JUMPIFEQ R3 R2 [+8]
  GETIMPORT R3 K5 [table.create]
  MOVE R4 R2
  LOADN R5 0
  CALL R3 2 1
  SETTABLEKS R3 R0 K8 ["_outterHeightMap"]
  GETUPVAL R3 0
  CALL R3 0 1
  JUMPIFNOT R3 [+9]
  GETTABLEKS R4 R0 K9 ["_noiseMap"]
  LENGTH R3 R4
  JUMPIFEQ R2 R3 [+5]
  GETIMPORT R3 K11 [warn]
  LOADK R4 K12 ["NoiseMap has wrong size!"]
  CALL R3 1 0
  LOADN R5 1
  MOVE R3 R2
  LOADN R4 1
  FORNPREP R3
  GETTABLEKS R6 R0 K8 ["_outterHeightMap"]
  GETTABLEKS R10 R0 K9 ["_noiseMap"]
  GETTABLE R9 R10 R5
  GETVARARGS R10 -1
  NAMECALL R7 R0 K13 ["getHeightFromNoise"]
  CALL R7 -1 1
  SETTABLE R7 R6 R5
  FORNLOOP R3
  RETURN R0 0
  ...
  CALL R2 0 1
  JUMPIFNOT R2 [+9]
  GETTABLEKS R3 R0 K9 ["_noiseMap"]
  LENGTH R2 R3
  JUMPIFEQ R1 R2 [+5]
  GETIMPORT R2 K11 [warn]
  LOADK R3 K12 ["NoiseMap has wrong size!"]
  CALL R2 1 0
  LOADN R4 1
  MOVE R2 R1
  LOADN R3 1
  ...
  GETTABLEKS R9 R0 K9 ["_noiseMap"]
  GETTABLE R8 R9 R4
  GETVARARGS R9 -1
  NAMECALL R6 R0 K13 ["getHeightFromNoise"]
  CALL R6 -1 1
  SETTABLE R6 R5 R4
  FORNLOOP R2
  RETURN R0 0
...
PROTO_13:
  ...
  MOVE R6 R2
  MOVE R7 R3
  NAMECALL R4 R0 K5 ["createHeightMapWithNoise"]
  CALL R4 3 0
  RETURN R0 0

PROTO_14:
  GETTABLEKS R2 R0 K0 ["_rotationY"]
  FASTCALL1 MATH_RAD R2 [+2]
  GETIMPORT R1 K3 [math.rad]
  CALL R1 1 1
  GETUPVAL R2 0
  GETTABLEKS R3 R0 K4 ["_sliceX"]
  GETTABLEKS R4 R0 K5 ["_sliceZ"]
  MOVE R5 R1
  CALL R2 3 1
  LOADN R5 1
  GETTABLEKS R3 R0 K4 ["_sliceX"]
  ...
  SUBK R11 R8 K6 [0.5]
  CALL R9 2 2
  GETTABLEKS R14 R0 K7 ["_rotatedXOffset"]
  ADD R13 R9 R14
  FASTCALL1 MATH_FLOOR R13 [+2]
  GETIMPORT R12 K9 [math.floor]
  CALL R12 1 1
  LOADN R13 1
  GETTABLEKS R14 R0 K10 ["_rotatedSlice"]
  FASTCALL MATH_CLAMP [+2]
  GETIMPORT R11 K12 [math.clamp]
  CALL R11 3 1
  GETTABLEKS R15 R0 K13 ["_rotatedZOffset"]
  ADD R14 R10 R15
  FASTCALL1 MATH_FLOOR R14 [+2]
  GETIMPORT R13 K9 [math.floor]
  CALL R13 1 1
  LOADN R14 1
  GETTABLEKS R15 R0 K10 ["_rotatedSlice"]
  FASTCALL MATH_CLAMP [+2]
  GETIMPORT R12 K12 [math.clamp]
  CALL R12 3 1
  MOVE R15 R5
  MOVE R16 R8
  NAMECALL R13 R0 K14 ["getIndex"]
  CALL R13 3 1
  MOVE R16 R11
  MOVE R17 R12
  NAMECALL R14 R0 K15 ["getRotatedIndex"]
  CALL R14 3 1
  GETTABLEKS R15 R0 K16 ["_heightMap"]
  GETTABLEKS R17 R0 K17 ["_outterHeightMap"]
...
PROTO_16:
  ...
  LOADK R2 K5 ["HeightMap has wrong size! Can't generate OccupancyMap."]
  CALL R1 1 0
  GETIMPORT R1 K8 [table.create]
  GETTABLEKS R2 R0 K0 ["_sliceX"]
  CALL R1 1 1
  SETTABLEKS R1 R0 K9 ["_occupancyMap"]
  LOADN R3 1
  GETTABLEKS R1 R0 K0 ["_sliceX"]
  LOADN R2 1
  FORNPREP R1
  ...
  GETTABLE R7 R8 R3
  GETIMPORT R8 K8 [table.create]
  GETTABLEKS R9 R0 K1 ["_sliceZ"]
  LOADN R10 0
  CALL R8 2 1
  SETTABLE R8 R7 R6
  FORNLOOP R4
  ...
  CALL R8 3 1
  GETTABLEKS R10 R0 K2 ["_heightMap"]
  GETTABLE R9 R10 R8
  FASTCALL1 MATH_FLOOR R9 [+3]
  MOVE R11 R9
...
PROTO_20:
  ...
  LOADK R2 K4 ["HeightMap has wrong size! Can't blend height maps."]
  CALL R1 1 0
  LOADN R3 1
  GETTABLEKS R4 R0 K1 ["_heightMap"]
  LENGTH R1 R4
  LOADN R2 1
  FORNPREP R1
  ...
  SETTABLE R5 R6 R3
  GETTABLEKS R6 R0 K5 ["_blendingFactorMap"]
  LOADN R7 1
  SETTABLE R7 R6 R3
  JUMP [+14]
  GETTABLEKS R6 R0 K6 ["_addBlending"]
  JUMPIFNOT R6 [+11]
  GETTABLEKS R7 R0 K5 ["_blendingFactorMap"]
  GETTABLE R6 R7 R3
...
MAIN:
  ...
  SETTABLEKS R14 R12 K42 ["getRotatedIndex"]
  DUPCLOSURE R14 K43 [PROTO_7]
  SETTABLEKS R14 R12 K44 ["getSliceIndex"]
  DUPCLOSURE R14 K45 [PROTO_8]
  SETTABLEKS R14 R12 K46 ["getRotatedIndexWithOffset"]
  DUPCLOSURE R14 K47 [PROTO_9]
  CAPTURE VAL R10
  CAPTURE VAL R2
  SETTABLEKS R14 R12 K48 ["generateStamp"]
  DUPCLOSURE R14 K49 [PROTO_10]
  SETTABLEKS R14 R12 K50 ["generateNoiseMap"]
  DUPCLOSURE R14 K51 [PROTO_11]
  SETTABLEKS R14 R12 K52 ["getHeightFromNoise"]
  DUPCLOSURE R14 K53 [PROTO_12]
  CAPTURE VAL R10
  SETTABLEKS R14 R12 K54 ["createHeightMapWithNoise"]
  DUPCLOSURE R14 K55 [PROTO_13]
  CAPTURE VAL R5
  CAPTURE VAL R4
  SETTABLEKS R14 R12 K56 ["generateHeightMap"]
  DUPCLOSURE R14 K57 [PROTO_14]
  CAPTURE VAL R9
  SETTABLEKS R14 R12 K58 ["generateRotatedHeightMap"]
  DUPCLOSURE R14 K59 [PROTO_15]
  SETTABLEKS R14 R12 K60 ["generateSlopeMap"]
  DUPCLOSURE R14 K61 [PROTO_16]
  CAPTURE VAL R10
  SETTABLEKS R14 R12 K62 ["generateOccupancyMap"]
  DUPCLOSURE R14 K63 [PROTO_17]
  CAPTURE VAL R5
  CAPTURE VAL R4
  SETTABLEKS R14 R12 K64 ["generateMaterialMap"]
  DUPCLOSURE R14 K65 [PROTO_18]
  CAPTURE VAL R5
  CAPTURE VAL R4
  CAPTURE VAL R2
  SETTABLEKS R14 R12 K66 ["fillInternalMaterial"]
  DUPCLOSURE R14 K67 [PROTO_19]
  CAPTURE VAL R7
  SETTABLEKS R14 R12 K68 ["updateBlendingFactorMap"]
  DUPCLOSURE R14 K69 [PROTO_20]
  CAPTURE VAL R10
  SETTABLEKS R14 R12 K70 ["blendHeightMap"]
  DUPCLOSURE R14 K71 [PROTO_21]
  CAPTURE VAL R8
  SETTABLEKS R14 R12 K72 ["blendMaterialMap"]
  DUPCLOSURE R14 K73 [PROTO_22]
  SETTABLEKS R14 R12 K74 ["postProcessing"]
  DUPCLOSURE R14 K75 [PROTO_23]
  SETTABLEKS R14 R12 K76 ["commit"]
  DUPCLOSURE R14 K77 [PROTO_24]
  SETTABLEKS R14 R12 K78 ["destroy"]
  DUPCLOSURE R14 K79 [PROTO_25]
  CAPTURE VAL R2
  SETTABLEKS R14 R12 K80 ["cacheRegion"]
  DUPCLOSURE R14 K81 [PROTO_26]
  CAPTURE VAL R2
  SETTABLEKS R14 R12 K82 ["revertRegion"]
  DUPCLOSURE R14 K83 [PROTO_27]
  SETTABLEKS R14 R12 K84 ["clearRegionCache"]
  DUPCLOSURE R14 K85 [PROTO_28]
  CAPTURE VAL R13
  SETTABLEKS R14 R12 K86 ["debugDrawArray"]
  DUPCLOSURE R14 K87 [PROTO_29]
  CAPTURE VAL R13
  SETTABLEKS R14 R12 K88 ["debugDraw"]
  RETURN R12 1
