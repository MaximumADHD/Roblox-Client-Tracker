...
PROTO_9:
  ...
  LOADN R13 0
  LOADN R14 0
  GETTABLEKS R15 R0 K6 ["_minNeighborHeight"]
  SETTABLE R10 R15 R8
  MOVE R15 R1
  LOADNIL R16
  LOADNIL R17
  ...
  LOADB R22 0
  LOADN R23 0
  JUMPIFNOTLT R23 R20 [+16]
  LOADB R22 0
  GETTABLEKS R23 R0 K3 ["_sliceX"]
  JUMPIFNOTLE R20 R23 [+11]
  LOADB R22 0
  LOADN R23 0
  JUMPIFNOTLT R23 R21 [+7]
  GETTABLEKS R23 R0 K4 ["_sliceZ"]
  JUMPIFLE R21 R23 [+2]
  LOADB R22 0 +1
  LOADB R22 1
  JUMPIFNOT R22 [+9]
  GETTABLEKS R24 R0 K8 ["_heightMap"]
  MOVE R27 R20
  MOVE R28 R21
  NAMECALL R25 R0 K7 ["getIndex"]
  CALL R25 3 1
  GETTABLE R23 R24 R25
  JUMP [+1]
  LOADN R23 0
  FASTCALL1 MATH_FLOOR R23 [+3]
  MOVE R25 R23
  GETIMPORT R24 K11 [math.floor]
  CALL R24 1 1
  GETTABLEKS R25 R0 K6 ["_minNeighborHeight"]
  GETTABLEKS R28 R0 K6 ["_minNeighborHeight"]
  GETTABLE R27 R28 R8
  FASTCALL2 MATH_MIN R27 R24 [+4]
  MOVE R28 R24
  GETIMPORT R26 K13 [math.min]
  CALL R26 2 1
  SETTABLE R26 R25 R8
  JUMPIFNOT R22 [+21]
  GETTABLEN R25 R19 1
  JUMPIFNOTEQKN R25 K14 [0] [+9]
  SUB R26 R23 R9
  FASTCALL1 MATH_ABS R26 [+2]
  GETIMPORT R25 K16 [math.abs]
  CALL R25 1 1
  ADD R11 R11 R25
  ADDK R12 R12 K17 [1]
  JUMP [+10]
  GETTABLEN R25 R19 2
  JUMPIFNOTEQKN R25 K14 [0] [+8]
  SUB R26 R23 R9
  FASTCALL1 MATH_ABS R26 [+2]
  GETIMPORT R25 K16 [math.abs]
  CALL R25 1 1
  ...
  DIV R11 R11 R12
  DIV R13 R13 R14
  GETTABLEKS R15 R0 K5 ["_slopeMap"]
  MUL R20 R11 R11
  MUL R21 R13 R13
  ADD R19 R20 R21
  DIVK R18 R19 K18 [2]
  FASTCALL1 MATH_SQRT R18 [+2]
  GETIMPORT R17 K20 [math.sqrt]
  CALL R17 1 1
  FASTCALL1 MATH_ATAN R17 [+2]
  GETIMPORT R16 K22 [math.atan]
  CALL R16 1 1
  SETTABLE R16 R15 R8
  FORNLOOP R5
  FORNLOOP R2
...
PROTO_13:
  ...
  SETTABLE R8 R7 R3
  GETTABLEKS R6 R0 K0 ["_heightMap"]
  GETTABLEKS R9 R0 K0 ["_heightMap"]
  GETTABLE R8 R9 R3
  LOADN R9 1
...
MAIN:
  ...
  CAPTURE VAL R7
  SETTABLEKS R14 R12 K54 ["updateBlendingFactorMap"]
  DUPCLOSURE R14 K55 [PROTO_13]
  SETTABLEKS R14 R12 K56 ["blendHeightMap"]
  DUPCLOSURE R14 K57 [PROTO_14]
  CAPTURE VAL R8
  SETTABLEKS R14 R12 K58 ["blendMaterialMap"]
  DUPCLOSURE R14 K59 [PROTO_15]
  SETTABLEKS R14 R12 K60 ["postProcessing"]
  DUPCLOSURE R14 K61 [PROTO_16]
  SETTABLEKS R14 R12 K62 ["commit"]
  DUPCLOSURE R14 K63 [PROTO_17]
  SETTABLEKS R14 R12 K64 ["destroy"]
  DUPCLOSURE R14 K65 [PROTO_18]
  CAPTURE VAL R2
  SETTABLEKS R14 R12 K66 ["cacheRegion"]
  DUPCLOSURE R14 K67 [PROTO_19]
  CAPTURE VAL R2
  SETTABLEKS R14 R12 K68 ["revertRegion"]
  DUPCLOSURE R14 K69 [PROTO_20]
  SETTABLEKS R14 R12 K70 ["clearRegionCache"]
  DUPCLOSURE R14 K71 [PROTO_21]
  CAPTURE VAL R13
  SETTABLEKS R14 R12 K72 ["debugDrawArray"]
  DUPCLOSURE R14 K73 [PROTO_22]
  CAPTURE VAL R13
  SETTABLEKS R14 R12 K74 ["debugDraw"]
  RETURN R12 1
