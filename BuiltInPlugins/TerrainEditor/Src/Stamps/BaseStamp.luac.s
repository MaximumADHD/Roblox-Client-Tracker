...
PROTO_6:
  ...
  JUMPIFNOTEQ R1 R2 [+2]
  RETURN R0 0
  GETIMPORT R1 K7 [debug.profilebegin]
  LOADK R2 K8 ["TG_GenerateNoise"]
  CALL R1 1 0
  NAMECALL R1 R0 K9 ["generateNoiseMap"]
  CALL R1 1 0
  GETIMPORT R1 K11 [debug.profileend]
  CALL R1 0 0
  GETIMPORT R1 K7 [debug.profilebegin]
  LOADK R2 K12 ["TG_GenerateHeight"]
  CALL R1 1 0
  NAMECALL R1 R0 K13 ["generateHeightMap"]
  CALL R1 1 0
  GETIMPORT R1 K11 [debug.profileend]
  CALL R1 0 0
  GETTABLEKS R4 R0 K14 ["_payload"]
  GETUPVAL R6 0
  GETTABLEKS R5 R6 K15 ["BuildSettings"]
  GETTABLE R3 R4 R5
  GETUPVAL R5 1
  GETTABLEKS R4 R5 K16 ["BlendingEdge"]
  GETTABLE R2 R3 R4
  LOADN R3 0
  JUMPIFLT R3 R2 [+2]
  LOADB R1 0 +1
  ...
  LOADK R3 K17 ["TG_BlendHeight"]
  CALL R2 1 0
  NAMECALL R2 R0 K18 ["blendHeightMap"]
  CALL R2 1 0
  GETIMPORT R2 K11 [debug.profileend]
  CALL R2 0 0
  GETIMPORT R2 K7 [debug.profilebegin]
  LOADK R3 K19 ["TG_GenerateOccupancyMap"]
  CALL R2 1 0
  NAMECALL R2 R0 K20 ["generateOccupancyMap"]
  CALL R2 1 0
  GETIMPORT R2 K11 [debug.profileend]
  CALL R2 0 0
  GETIMPORT R2 K7 [debug.profilebegin]
  LOADK R3 K21 ["TG_GenerateSlopeMap"]
  CALL R2 1 0
  NAMECALL R2 R0 K22 ["generateSlopeMap"]
  CALL R2 1 0
  GETIMPORT R2 K11 [debug.profileend]
  CALL R2 0 0
  GETIMPORT R2 K7 [debug.profilebegin]
  LOADK R3 K23 ["TG_GenerateMaterial"]
  CALL R2 1 0
  NAMECALL R2 R0 K24 ["generateMaterialMap"]
  CALL R2 1 0
  GETIMPORT R2 K11 [debug.profileend]
  CALL R2 0 0
  JUMPIFNOT R1 [+10]
  GETIMPORT R2 K7 [debug.profilebegin]
  LOADK R3 K25 ["TG_BlendMaterialMap"]
  CALL R2 1 0
  NAMECALL R2 R0 K26 ["blendMaterialMap"]
  CALL R2 1 0
  GETIMPORT R2 K11 [debug.profileend]
  CALL R2 0 0
  GETIMPORT R2 K7 [debug.profilebegin]
  LOADK R3 K27 ["TG_PostProcessing"]
  CALL R2 1 0
  NAMECALL R2 R0 K28 ["postProcessing"]
  CALL R2 1 0
  GETIMPORT R2 K11 [debug.profileend]
  CALL R2 0 0
  GETTABLEKS R3 R0 K29 ["_services"]
  GETTABLEKS R2 R3 K30 ["Terrain"]
  GETTABLEKS R4 R0 K0 ["_region"]
  GETUPVAL R5 2
  GETTABLEKS R6 R0 K31 ["_materialMap"]
  GETTABLEKS R7 R0 K32 ["_occupancyMap"]
  NAMECALL R2 R2 K33 ["WriteVoxels"]
  CALL R2 5 0
  RETURN R0 0
...
PROTO_9:
  ...
  CALL R9 1 1
  LOADN R10 0
  GETTABLEKS R11 R0 K6 ["_minNeighborHeight"]
  SETTABLE R9 R11 R8
  MOVE R11 R1
  LOADNIL R12
  LOADNIL R13
  ...
  LOADB R18 0
  LOADN R19 0
  JUMPIFNOTLT R19 R16 [+16]
  LOADB R18 0
  GETTABLEKS R19 R0 K3 ["_sliceX"]
  JUMPIFNOTLE R16 R19 [+11]
  LOADB R18 0
  LOADN R19 0
  JUMPIFNOTLT R19 R17 [+7]
  GETTABLEKS R19 R0 K4 ["_sliceZ"]
  JUMPIFLE R17 R19 [+2]
  LOADB R18 0 +1
  LOADB R18 1
  JUMPIFNOT R18 [+9]
  GETTABLEKS R20 R0 K8 ["_heightMap"]
  MOVE R23 R16
  MOVE R24 R17
  NAMECALL R21 R0 K7 ["getIndex"]
  CALL R21 3 1
  GETTABLE R19 R20 R21
  JUMP [+1]
  LOADN R19 0
  GETTABLEKS R20 R0 K6 ["_minNeighborHeight"]
  GETTABLEKS R23 R0 K6 ["_minNeighborHeight"]
  GETTABLE R22 R23 R8
  FASTCALL1 MATH_FLOOR R19 [+3]
  MOVE R24 R19
  GETIMPORT R23 K11 [math.floor]
  CALL R23 1 1
  FASTCALL2 MATH_MIN R22 R23 [+3]
  GETIMPORT R21 K13 [math.min]
  CALL R21 2 1
  SETTABLE R21 R20 R8
  GETTABLEN R20 R15 1
  JUMPIFEQKN R20 K14 [0] [+4]
  GETTABLEN R20 R15 2
  JUMPIFNOTEQKN R20 K14 [0] [+14]
  JUMPIFNOT R18 [+12]
  SUB R23 R19 R9
  FASTCALL1 MATH_ABS R23 [+2]
  GETIMPORT R22 K16 [math.abs]
  CALL R22 1 1
  FASTCALL2 MATH_MAX R10 R22 [+4]
  MOVE R21 R10
  ...
  FASTCALL1 MATH_ATAN R10 [+3]
  MOVE R13 R10
  GETIMPORT R12 K20 [math.atan]
  CALL R12 1 1
  SETTABLE R12 R11 R8
  FORNLOOP R5
  FORNLOOP R2
