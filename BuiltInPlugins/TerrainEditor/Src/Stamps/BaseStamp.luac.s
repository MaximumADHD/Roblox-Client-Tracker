...
PROTO_9:
  ...
  MOVE R19 R9
  GETIMPORT R18 K15 [math.abs]
  CALL R18 1 1
  FASTCALL1 MATH_ABS R10 [+3]
  MOVE R20 R10
  GETIMPORT R19 K15 [math.abs]
  CALL R19 1 1
  ADD R17 R18 R19
...
PROTO_11:
  ...
  GETTABLE R1 R2 R3
  DUPTABLE R2 K12 [{"HeightInPercentage", "HeightInStud", "Position", "Slope"}]
  LOADN R3 0
  SETTABLEKS R3 R2 K8 ["HeightInPercentage"]
  LOADN R3 0
  SETTABLEKS R3 R2 K9 ["HeightInStud"]
  GETIMPORT R3 K15 [Vector3.zero]
  ...
  GETTABLEKS R8 R0 K16 ["_sliceY"]
  CALL R7 1 1
  SETTABLE R7 R6 R5
  LOADN R8 1
  GETTABLEKS R6 R0 K16 ["_sliceY"]
  LOADN R7 1
  FORNPREP R6
  GETTABLEKS R10 R0 K4 ["_materialMap"]
  GETTABLE R9 R10 R5
  GETIMPORT R10 K2 [table.create]
  GETTABLEKS R11 R0 K17 ["_sliceZ"]
  GETIMPORT R12 K20 [Enum.Material.Air]
  CALL R10 2 1
  SETTABLE R10 R9 R8
  LOADN R11 1
  ...
  GETTABLEKS R13 R0 K24 ["_slopeMap"]
  MOVE R16 R5
  MOVE R17 R11
  ...
  GETTABLE R12 R13 R8
  GETUPVAL R14 3
  GETTABLEKS R13 R14 K26 ["FromPreset"]
  MOVE R14 R1
  MOVE R15 R2
  CALL R13 2 1
  JUMPIF R13 [+1]
