...
PROTO_1:
  ...
  LOADN R10 1
  FORNPREP R9
  GETTABLEKS R13 R0 K23 ["_noiseMap"]
  GETTABLE R12 R13 R11
  GETUPVAL R14 2
  GETTABLEKS R13 R14 K24 ["Max"]
  MOVE R14 R12
  MOVE R15 R7
  LOADK R16 K25 [0.1]
  CALL R13 3 1
  JUMPIFNOTLT R7 R13 [+30]
  LOADN R15 0
  ...
  POWK R16 R17 K29 [4]
  SUB R14 R15 R16
  GETTABLEKS R15 R0 K23 ["_noiseMap"]
  MUL R17 R14 R8
  SUB R16 R7 R17
...
PROTO_2:
  ...
  ADD R9 R10 R11
  SETTABLE R9 R8 R4
  GETTABLEKS R9 R0 K10 ["_rimPositions"]
  GETTABLE R8 R9 R4
  JUMPIFNOT R8 [+10]
  ...
  LOADN R3 1
  FORNPREP R2
  GETTABLEKS R6 R0 K14 ["_fillBottomPositions"]
  GETTABLE R5 R6 R4
  JUMPIFNOT R5 [+12]
...
PROTO_3:
  ...
  MULK R4 R5 K4 [0.25]
  ADDK R3 R4 K5 [0.5]
  GETTABLEKS R7 R0 K6 ["_medianHeightCache"]
  GETTABLEKS R8 R0 K7 ["_meanHeightCache"]
  SUB R6 R7 R8
  ...
  MOVE R5 R4
  JUMPIFNOT R5 [+10]
  GETTABLEKS R7 R0 K11 ["_sliceY"]
  GETTABLEKS R8 R0 K6 ["_medianHeightCache"]
  SUB R6 R7 R8
  LOADN R7 5
  JUMPIFLT R6 R7 [+2]
  LOADB R5 0 +1
  ...
  GETTABLEKS R7 R0 K15 ["_mapSize"]
  LOADN R8 0
  CALL R6 2 1
  SETTABLEKS R6 R0 K16 ["_heightMapFromNoise"]
  GETIMPORT R6 K14 [table.create]
  GETTABLEKS R7 R0 K15 ["_mapSize"]
  LOADB R8 0
  CALL R6 2 1
  SETTABLEKS R6 R0 K17 ["_rimPositions"]
  LOADN R8 1
  GETTABLEKS R6 R0 K15 ["_mapSize"]
  LOADN R7 1
  FORNPREP R6
  GETTABLEKS R11 R0 K18 ["_noiseMap"]
  GETTABLE R10 R11 R8
  LOADN R11 255
  MOVE R12 R2
  FASTCALL MATH_CLAMP [+2]
  GETIMPORT R9 K20 [math.clamp]
  CALL R9 3 1
  GETTABLEKS R10 R0 K17 ["_rimPositions"]
  JUMPIFLE R2 R9 [+2]
  LOADB R11 0 +1
  LOADB R11 1
  SETTABLE R11 R10 R8
  JUMPIFNOT R5 [+4]
  GETTABLEKS R11 R0 K21 ["_heightmapCache"]
  GETTABLE R10 R11 R8
  JUMP [+2]
  GETTABLEKS R10 R0 K11 ["_sliceY"]
  ADD R12 R3 R9
  MUL R11 R10 R12
  GETTABLEKS R12 R0 K16 ["_heightMapFromNoise"]
  MOVE R14 R11
  LOADN R15 1
  GETTABLEKS R16 R0 K11 ["_sliceY"]
  FASTCALL MATH_CLAMP [+2]
