...
PROTO_1:
  ...
  GETTABLEKS R5 R0 K6 ["_heightMapSize"]
  LOADN R6 0
  CALL R4 2 1
...
PROTO_4:
  ...
  FORNLOOP R13
  LOADN R15 1
  GETTABLEKS R13 R0 K29 ["_sliceX"]
  LOADN R14 1
  FORNPREP R13
  LOADN R18 1
  GETTABLEKS R16 R0 K30 ["_sliceZ"]
  LOADN R17 1
  FORNPREP R16
  GETTABLEKS R19 R0 K31 ["_getRotatedPoint"]
  SUBK R20 R15 K32 [0.5]
  SUBK R21 R18 K32 [0.5]
  CALL R19 2 2
  GETUPVAL R23 2
  MUL R22 R19 R23
  GETTABLEKS R23 R3 K33 ["X"]
  ADD R21 R22 R23
  GETUPVAL R24 2
  MUL R23 R20 R24
  GETTABLEKS R24 R3 K34 ["Y"]
  ADD R22 R23 R24
  MOVE R26 R21
  LOADN R27 0
  MOVE R28 R22
  ...
  LOADN R24 0
  LOADN R25 0
  JUMPIFNOTEQKN R12 K37 [1] [+9]
  MOVE R28 R19
  MOVE R29 R20
  NAMECALL R26 R0 K38 ["getHeightGradient"]
  CALL R26 3 2
  MOVE R24 R26
  MOVE R25 R27
  JUMP [+8]
  ...
  MOVE R30 R24
  FASTCALL VECTOR [+2]
  GETIMPORT R27 K36 [Vector3.new]
  CALL R27 3 1
  MULK R26 R27 K39 [2000]
  MOVE R29 R23
  MOVE R30 R26
  NAMECALL R27 R8 K40 ["SampleDirectional"]
  CALL R27 3 1
  GETTABLE R29 R6 R12
  MUL R28 R29 R2
  MUL R27 R27 R28
  MOVE R30 R15
  MOVE R31 R18
  NAMECALL R28 R0 K41 ["getIndex"]
  CALL R28 3 1
  GETTABLEKS R29 R0 K28 ["_noiseMap"]
