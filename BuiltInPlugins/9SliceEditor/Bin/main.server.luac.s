...
PROTO_2:
       ...
       10 GETUPVAL                         R2 1
       11 GETTABLEKS                       R2 R2 K3 ["Packages"]
       13 GETTABLEKS                       R2 R2 K4 ["Roact"]
       15 CALL                             R1 1 1
       ...
       54 CALL                             R4 3 0
       55 GETIMPORT                        R4 K8 [plugin]
       57 GETTABLEKS                       R4 R4 K17 ["Unloading"]
       59 NEWCLOSURE                       R6 P0
       60 CAPTURE                          UPVAL U3
       61 CAPTURE                          UPVAL U2
       62 CAPTURE                          VAL R1
...
MAIN:
       ...
       11 GETTABLEKS                       R1 R1 K7 ["defineFlags"]
       13 CALL                             R0 1 0
       ...
       18 JUMPIF                           R0 ; [+1]
       19 LOADB                            R1 0
       20 GETIMPORT                        R2 K5 [script]
       22 GETTABLEKS                       R2 R2 K6 ["Parent"]
       24 GETTABLEKS                       R2 R2 K6 ["Parent"]
       26 GETIMPORT                        R3 K3 [require]
       28 GETTABLEKS                       R4 R2 K11 ["Src"]
       30 GETTABLEKS                       R4 R4 K12 ["Util"]
       32 GETTABLEKS                       R4 R4 K13 ["DebugFlags"]
       34 CALL                             R3 1 1
       ...
       42 GETIMPORT                        R5 K5 [script]
       44 GETTABLEKS                       R5 R5 K6 ["Parent"]
       46 GETTABLEKS                       R5 R5 K15 ["commonInit"]
       48 CALL                             R4 1 1
       49 MOVE                             R5 R4
       50 CALL                             R5 0 0
       51 LOADNIL                          R5
       52 LOADNIL                          R6
       53 GETIMPORT                        R7 K1 [plugin]
       55 GETTABLEKS                       R7 R7 K16 ["HostDataModelType"]
       ...
       66 CALL                             R7 0 1
       67 JUMPIFNOT                        R7 ; [+15]
       68 GETIMPORT                        R7 K3 [require]
       70 GETTABLEKS                       R8 R2 K22 ["Packages"]
       72 GETTABLEKS                       R8 R8 K23 ["DeveloperTools"]
       74 CALL                             R7 1 1
       75 GETTABLEKS                       R7 R7 K24 ["forPlugin"]
