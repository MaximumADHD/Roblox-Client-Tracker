...
PROTO_8:
       ...
       59 GETUPVAL                         R14 0
       60 JUMPIFNOT                        R14 ; [+11]
       61 LOADK                            R16 K18 ["ProceduralModel"]
       62 NAMECALL                         R14 R12 K19 ["IsA"]
       64 CALL                             R14 2 1
       65 JUMPIFNOT                        R14 ; [+6]
       66 GETTABLEKS                       R14 R0 K16 ["_originalDimensionMap"]
       68 GETTABLEKS                       R15 R12 K17 ["Size"]
       70 SETTABLE                         R15 R14 R12
       71 JUMP                             ; [+6]
       72 GETTABLEKS                       R14 R0 K16 ["_originalDimensionMap"]
       74 NAMECALL                         R15 R12 K20 ["GetScale"]
       76 CALL                             R15 1 1
       77 SETTABLE                         R15 R14 R12
       78 FORGLOOP                         R9 1 ; [-20]
       80 GETUPVAL                         R9 0
       81 JUMPIFNOT                        R9 ; [+6]
       82 NAMECALL                         R9 R2 K21 ["getSingleSelectionInterface"]
       84 CALL                             R9 1 1
       85 SETTABLEKS                       R9 R0 K22 ["_singleSelectionInterface"]
       87 JUMP                             ; [+5]
       88 NAMECALL                         R9 R2 K23 ["isSelectionSinglePart_DEPRECATED"]
       90 CALL                             R9 1 1
       91 SETTABLEKS                       R9 R0 K24 ["_isSinglePartMode"]
       93 GETTABLEKS                       R9 R0 K25 ["_jointMaker"]
       95 GETTABLEKS                       R11 R0 K8 ["_allParts"]
       97 GETTABLEKS                       R12 R0 K15 ["_rootModelMap"]
       99 NAMECALL                         R9 R9 K26 ["pickUpParts"]
      101 CALL                             R9 3 0
      102 GETUPVAL                         R9 1
      103 NAMECALL                         R9 R9 K27 ["IsRunning"]
      105 CALL                             R9 1 1
      106 JUMPIFNOT                        R9 ; [+5]
      107 GETTABLEKS                       R9 R0 K25 ["_jointMaker"]
      109 NAMECALL                         R9 R9 K28 ["anchorParts"]
      111 CALL                             R9 1 0
      112 GETTABLEKS                       R9 R0 K25 ["_jointMaker"]
      114 NAMECALL                         R9 R9 K29 ["breakJointsToOutsiders"]
      116 CALL                             R9 1 0
      117 NAMECALL                         R9 R0 K30 ["_unjoinRoots"]
      119 CALL                             R9 1 0
      120 MOVE                             R11 R7
      121 NAMECALL                         R9 R0 K31 ["_recordLooseAttachmentFixup"]
      123 CALL                             R9 2 0
      124 GETTABLEKS                       R11 R0 K13 ["_loosePartMap"]
      126 NAMECALL                         R9 R0 K32 ["_recordLoosePartFixup"]
      128 CALL                             R9 2 0
      129 GETTABLEKS                       R9 R0 K33 ["_draggerContext"]
      131 NAMECALL                         R9 R9 K34 ["areCollisionsEnabled"]
      133 CALL                             R9 1 1
      134 JUMPIF                           R9 ; [+8]
      135 GETUPVAL                         R10 2
      136 GETTABLEKS                       R9 R10 K3 ["new"]
      138 GETTABLEKS                       R10 R0 K8 ["_allParts"]
      140 CALL                             R9 1 1
      141 SETTABLEKS                       R9 R0 K35 ["_temporaryTransparency"]
      143 LOADK                            R9 K36 [{0, 0, 0}]
      144 SETTABLEKS                       R9 R0 K37 ["_lastDeltaSize"]
      146 RETURN                           R0 0
...
PROTO_11:
       ...
       27 JUMP                             ; [+1]
       28 MOVE                             R4 R5
       29 GETTABLEKS                       R6 R1 K8 ["Y"]
       31 GETUPVAL                         R7 0
       32 CALL                             R7 0 1
       33 JUMPIFNOT                        R7 ; [+6]
       34 SUBK                             R7 R2 K3 [0.001]
       35 LOADK                            R8 K4 [1E-05]
       36 JUMPIFNOTLT                      R7 R8 ; [+3]
       38 MOVE                             R5 R6
       39 JUMP                             ; [+13]
       40 DIV                              R9 R6 R2
       41 FASTCALL1                        MATH_FLOOR R9 ; [+2]
       42 GETIMPORT                        R8 K7 [math.floor]
       44 CALL                             R8 1 1
       45 MUL                              R7 R8 R2
       46 SUB                              R8 R6 R7
       47 LOADK                            R9 K3 [0.001]
       48 JUMPIFNOTLT                      R8 R9 ; [+3]
       50 MOVE                             R5 R7
       51 JUMP                             ; [+1]
       52 MOVE                             R5 R6
       53 GETTABLEKS                       R7 R1 K9 ["Z"]
       55 GETUPVAL                         R8 0
       56 CALL                             R8 0 1
       57 JUMPIFNOT                        R8 ; [+6]
       58 SUBK                             R8 R2 K3 [0.001]
       59 LOADK                            R9 K4 [1E-05]
       60 JUMPIFNOTLT                      R8 R9 ; [+3]
       62 MOVE                             R6 R7
       63 JUMP                             ; [+13]
       64 DIV                              R10 R7 R2
       65 FASTCALL1                        MATH_FLOOR R10 ; [+2]
       66 GETIMPORT                        R9 K7 [math.floor]
       68 CALL                             R9 1 1
       69 MUL                              R8 R9 R2
       70 SUB                              R9 R7 R8
       71 LOADK                            R10 K3 [0.001]
       72 JUMPIFNOTLT                      R9 R10 ; [+3]
       74 MOVE                             R6 R8
       75 JUMP                             ; [+1]
       76 MOVE                             R6 R7
       77 FASTCALL                         VECTOR ; [+2]
       78 GETIMPORT                        R3 K12 [Vector3.new]
       80 CALL                             R3 3 1
       81 RETURN                           R3 1
...
MAIN:
       ...
       70 CALL                             R11 1 1
       71 GETIMPORT                        R12 K9 [require]
       73 GETTABLEKS                       R14 R3 K17 ["Flags"]
       75 GETTABLEKS                       R13 R14 K20 ["getFFlagDraggerEditProcModels"]
       77 CALL                             R12 1 1
       78 MOVE                             R13 R12
       79 CALL                             R13 0 1
       80 GETIMPORT                        R14 K23 [CFrame.new]
       82 CALL                             R14 0 1
       83 FASTCALL                         VECTOR ; [+2]
       84 GETIMPORT                        R15 K25 [Vector3.new]
       86 CALL                             R15 0 1
       87 LOADK                            R17 K27 [{1, 1, 1}]
       88 MULK                             R16 R17 K26 [∞]
       89 NEWTABLE                         R17 32 0
       91 SETTABLEKS                       R17 R17 K28 ["__index"]
       93 DUPCLOSURE                       R18 K29 [PROTO_0]
       94 CAPTURE                          VAL R4
       95 CAPTURE                          VAL R17
       96 SETTABLEKS                       R18 R17 K22 ["new"]
       98 DUPCLOSURE                       R18 K30 [PROTO_1]
       99 CAPTURE                          VAL R13
      100 CAPTURE                          VAL R15
      101 SETTABLEKS                       R18 R17 K31 ["getBoundingBox"]
      103 DUPCLOSURE                       R18 K32 [PROTO_2]
      104 SETTABLEKS                       R18 R17 K33 ["shouldScaleFromCenter"]
      106 DUPCLOSURE                       R18 K34 [PROTO_3]
      107 DUPCLOSURE                       R19 K35 [PROTO_4]
      108 CAPTURE                          VAL R10
      109 CAPTURE                          VAL R13
      110 SETTABLEKS                       R19 R17 K36 ["axesToScale"]
      112 DUPCLOSURE                       R19 K37 [PROTO_5]
      113 CAPTURE                          VAL R7
      114 CAPTURE                          VAL R15
      115 CAPTURE                          VAL R16
      116 SETTABLEKS                       R19 R17 K38 ["getMinMaxSizes"]
      118 DUPCLOSURE                       R19 K39 [PROTO_6]
      119 CAPTURE                          VAL R8
      120 SETTABLEKS                       R19 R17 K40 ["_unjoinRoots"]
      122 DUPCLOSURE                       R19 K41 [PROTO_7]
      123 SETTABLEKS                       R19 R17 K42 ["_rejoinRoots"]
      125 DUPCLOSURE                       R19 K43 [PROTO_8]
      126 CAPTURE                          VAL R13
      127 CAPTURE                          VAL R0
      128 CAPTURE                          VAL R6
      129 SETTABLEKS                       R19 R17 K44 ["beginScale"]
      131 DUPCLOSURE                       R19 K45 [PROTO_9]
      132 CAPTURE                          VAL R7
      133 CAPTURE                          VAL R9
      134 SETTABLEKS                       R19 R17 K16 ["getSoftSnaps"]
      136 DUPCLOSURE                       R19 K46 [PROTO_10]
      137 CAPTURE                          VAL R11
      138 DUPCLOSURE                       R20 K47 [PROTO_11]
      139 CAPTURE                          VAL R11
      140 SETTABLEKS                       R20 R17 K48 ["_maybeSnapPartSizeBackDownToGrid"]
      142 DUPCLOSURE                       R20 K49 [PROTO_12]
      143 DUPCLOSURE                       R21 K50 [PROTO_13]
      144 DUPCLOSURE                       R22 K51 [PROTO_14]
      145 DUPCLOSURE                       R23 K52 [PROTO_18]
      146 CAPTURE                          VAL R13
      147 SETTABLEKS                       R23 R17 K53 ["updateScale"]
      149 DUPCLOSURE                       R23 K54 [PROTO_19]
      150 SETTABLEKS                       R23 R17 K55 ["endScale"]
      152 DUPCLOSURE                       R23 K56 [PROTO_20]
      153 CAPTURE                          VAL R5
      154 SETTABLEKS                       R23 R17 K57 ["render"]
      156 DUPCLOSURE                       R23 K58 [PROTO_21]
      157 SETTABLEKS                       R23 R17 K59 ["_binarySearchForGoodPartSize"]
      159 DUPCLOSURE                       R23 K60 [PROTO_23]
      160 SETTABLEKS                       R23 R17 K61 ["_recordLooseAttachmentFixup"]
      162 DUPCLOSURE                       R23 K62 [PROTO_24]
      163 SETTABLEKS                       R23 R17 K63 ["_applyLooseAttachmentFixup"]
      165 DUPCLOSURE                       R23 K64 [PROTO_25]
      166 CAPTURE                          VAL R14
      167 SETTABLEKS                       R23 R17 K65 ["_recordLoosePartFixup"]
      169 DUPCLOSURE                       R23 K66 [PROTO_26]
      170 SETTABLEKS                       R23 R17 K67 ["_applyLoosePartFixup"]
      172 RETURN                           R17 1
