...
MAIN:
  ...
  LOADK R18 K31 ["DeferredPivotEditor"]
  LOADB R19 0
  NAMECALL R16 R16 K32 ["DefineFastFlag"]
  CALL R16 3 1
  DUPCLOSURE R17 K33 [PROTO_1]
  CAPTURE VAL R15
  SETTABLEKS R17 R14 K34 ["init"]
  DUPCLOSURE R17 K35 [PROTO_3]
  CAPTURE VAL R16
  SETTABLEKS R17 R14 K36 ["didMount"]
  DUPCLOSURE R17 K37 [PROTO_4]
  SETTABLEKS R17 R14 K38 ["willUnmount"]
  DUPCLOSURE R17 K39 [PROTO_5]
  SETTABLEKS R17 R14 K40 ["willUpdate"]
  MOVE R17 R15
  CALL R17 0 1
  JUMPIFNOT R17 [+3]
  DUPCLOSURE R17 K41 [PROTO_6]
  SETTABLEKS R17 R14 K42 ["didUpdate"]
  ...
  CAPTURE VAL R1
  CAPTURE VAL R10
  SETTABLEKS R17 R14 K44 ["_onClearPivot"]
  ...
  CAPTURE VAL R8
  CAPTURE VAL R11
  SETTABLEKS R17 R14 K46 ["render"]
  MOVE R17 R6
  DUPTABLE R18 K48 [{"Plugin"}]
  GETTABLEKS R19 R5 K47 ["Plugin"]
