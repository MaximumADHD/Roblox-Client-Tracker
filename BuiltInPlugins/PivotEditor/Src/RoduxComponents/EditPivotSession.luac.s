...
PROTO_3:
  ...
  GETTABLEKS R5 R6 K5 ["DraggerContext"]
  SETTABLEKS R5 R0 K6 ["_draggerContext"]
  ...
  GETIMPORT R8 K11 [settings]
  CALL R8 0 1
  GETUPVAL R11 1
  GETTABLEKS R10 R11 K12 ["Selection"]
  ...
  GETUPVAL R7 2
  GETTABLEKS R6 R7 K13 ["Transform"]
  JUMPIFEQ R1 R6 [+2]
  LOADB R5 0 +1
  LOADB R5 1
  GETUPVAL R7 3
  ...
  GETUPVAL R7 4
  DUPTABLE R8 K19 [{"Mouse", "DraggerContext", "DraggerSchema", "DraggerSettings"}]
  SETTABLEKS R4 R8 K16 ["Mouse"]
  GETTABLEKS R9 R0 K6 ["_draggerContext"]
  SETTABLEKS R9 R8 K5 ["DraggerContext"]
  GETUPVAL R9 1
  SETTABLEKS R9 R8 K17 ["DraggerSchema"]
  DUPTABLE R9 K25 [{"AnalyticsName", "AllowDragSelect", "AllowFreeformDrag", "ShowLocalSpaceIndicator", "HandlesList"}]
  LOADK R10 K26 ["EditPivot"]
  SETTABLEKS R10 R9 K20 ["AnalyticsName"]
  LOADB R10 0
  SETTABLEKS R10 R9 K21 ["AllowDragSelect"]
  SETTABLEKS R5 R9 K22 ["AllowFreeformDrag"]
  LOADB R10 0
  SETTABLEKS R10 R9 K23 ["ShowLocalSpaceIndicator"]
  NAMECALL R10 R0 K27 ["_getCurrentDraggerHandles"]
  CALL R10 1 1
  SETTABLEKS R10 R9 K24 ["HandlesList"]
  SETTABLEKS R9 R8 K18 ["DraggerSettings"]
  CALL R6 2 1
  SETTABLEKS R6 R2 K28 ["DraggerToolComponent"]
  GETUPVAL R6 3
  GETTABLEKS R5 R6 K15 ["createElement"]
  GETUPVAL R6 5
  CALL R5 1 1
  SETTABLEKS R5 R2 K29 ["SelectionUpdaterBound"]
  GETUPVAL R6 3
  GETTABLEKS R5 R6 K30 ["createFragment"]
  MOVE R6 R2
  CALL R5 1 -1
  RETURN R5 -1

PROTO_4:
  GETTABLEKS R3 R1 K0 ["statusMessage"]
  GETUPVAL R6 0
  ...
  MOVE R7 R4
  NAMECALL R5 R5 K3 ["setPivotIndicator"]
  CALL R5 2 0
  GETTABLEKS R6 R0 K4 ["props"]
  GETTABLEKS R5 R6 K0 ["statusMessage"]
  JUMPIFEQ R5 R3 [+47]
  GETUPVAL R7 0
  GETTABLEKS R6 R7 K1 ["None"]
  JUMPIFEQ R5 R6 [+9]
  GETTABLEKS R7 R0 K4 ["props"]
  GETTABLEKS R6 R7 K5 ["ToastNotification"]
  MOVE R8 R5
  ...
  GETTABLEKS R8 R9 K5 ["ToastNotification"]
  MOVE R10 R7
  MOVE R11 R3
...
MAIN:
  ...
  CAPTURE VAL R16
  SETTABLEKS R20 R18 K36 ["didMount"]
  ...
  CAPTURE VAL R8
  CAPTURE VAL R9
  SETTABLEKS R20 R18 K38 ["_getCurrentDraggerHandles"]
  ...
  CAPTURE VAL R6
  CAPTURE VAL R12
  SETTABLEKS R20 R18 K40 ["render"]
  DUPCLOSURE R20 K41 [PROTO_4]
  CAPTURE VAL R16
  SETTABLEKS R20 R18 K42 ["willUpdate"]
  DUPCLOSURE R20 K43 [PROTO_5]
  SETTABLEKS R20 R18 K44 ["willUnmount"]
  MOVE R20 R5
  DUPTABLE R21 K47 [{"Localization", "Plugin", "ToastNotification"}]
  GETTABLEKS R22 R4 K45 ["Localization"]
  SETTABLEKS R22 R21 K45 ["Localization"]
  GETTABLEKS R22 R4 K46 ["Plugin"]
  SETTABLEKS R22 R21 K46 ["Plugin"]
  ...
  DUPCLOSURE R21 K49 [PROTO_9]
  CAPTURE VAL R13
  CAPTURE VAL R14
  GETTABLEKS R22 R2 K50 ["connect"]
  MOVE R23 R20
  MOVE R24 R21
  CALL R22 2 1
  MOVE R23 R18
