PROTO_0:
       ...
       12 JUMPIF                           R4 ; [+15]
       13 GETUPVAL                         R4 0
       14 GETTABLEKS                       R4 R4 K2 ["Store"]
       16 GETTABLEKS                       R4 R4 K3 ["new"]
       18 GETUPVAL                         R5 1
       19 LOADNIL                          R6
       20 NEWTABLE                         R7 0 1
       22 GETUPVAL                         R8 0
       23 GETTABLEKS                       R8 R8 K4 ["thunkMiddleware"]
       25 SETLIST                          R7 R8 1 [1]
       27 CALL                             R4 3 1
       28 GETUPVAL                         R5 2
       29 GETTABLEKS                       R5 R5 K5 ["provide"]
       31 NEWTABLE                         R6 0 3
       33 GETUPVAL                         R7 2
       34 GETTABLEKS                       R7 R7 K0 ["Plugin"]
       36 GETTABLEKS                       R7 R7 K3 ["new"]
       38 MOVE                             R8 R2
       39 CALL                             R7 1 1
       40 GETUPVAL                         R8 2
       41 GETTABLEKS                       R8 R8 K1 ["Mouse"]
       43 GETTABLEKS                       R8 R8 K3 ["new"]
       45 MOVE                             R9 R3
       46 CALL                             R8 1 1
       47 GETUPVAL                         R9 2
       48 GETTABLEKS                       R9 R9 K2 ["Store"]
       50 GETTABLEKS                       R9 R9 K3 ["new"]
       52 MOVE                             R10 R4
       53 CALL                             R9 1 -1
