...
PROTO_6:
       ...
       24 GETTABLEKS                       R3 R4 K6 ["selectInvalidSelection"]
       26 GETUPVAL                         R5 2
       27 GETTABLEKS                       R4 R5 K4 ["ProceduralModel"]
       29 CALL                             R3 1 0
       30 RETURN                           R0 0
       31 MOVE                             R3 R2
       32 JUMPIFNOT                        R3 ; [+18]
       ...
       41 JUMPIFEQ                         R2 R4 ; [+9]
       43 GETIMPORT                        R5 K9 [workspace]
       45 GETTABLEKS                       R4 R5 K10 ["Terrain"]
       47 JUMPIFNOTEQ                      R2 R4 ; [+2]
       49 LOADB                            R3 0 +1
       50 LOADB                            R3 1
       51 JUMPIFNOT                        R3 ; [+7]
       52 GETTABLEKS                       R4 R0 K2 ["props"]
       54 GETTABLEKS                       R3 R4 K11 ["selectObjectForEditing"]
       56 MOVE                             R4 R2
       57 CALL                             R3 1 0
       58 RETURN                           R0 0
       59 GETTABLEKS                       R4 R0 K2 ["props"]
       61 GETTABLEKS                       R3 R4 K6 ["selectInvalidSelection"]
       63 GETUPVAL                         R5 2
       64 GETTABLEKS                       R4 R5 K12 ["InvalidTarget"]
       66 CALL                             R3 1 0
       67 RETURN                           R0 0
       68 LENGTH                           R2 R1
       69 LOADN                            R3 1
       70 JUMPIFNOTLT                      R3 R2 ; [+10]
       72 GETTABLEKS                       R3 R0 K2 ["props"]
       74 GETTABLEKS                       R2 R3 K6 ["selectInvalidSelection"]
       76 GETUPVAL                         R4 2
       77 GETTABLEKS                       R3 R4 K13 ["MultipleSelection"]
       79 CALL                             R2 1 0
       80 RETURN                           R0 0
       81 GETTABLEKS                       R3 R0 K2 ["props"]
       83 GETTABLEKS                       R2 R3 K6 ["selectInvalidSelection"]
       85 GETUPVAL                         R4 2
       86 GETTABLEKS                       R3 R4 K14 ["NoSelection"]
       88 CALL                             R2 1 0
       89 RETURN                           R0 0
...
MAIN:
       ...
       33 GETTABLEKS                       R8 R0 K9 ["Packages"]
       35 GETTABLEKS                       R7 R8 K14 ["DraggerFramework"]
       37 GETTABLEKS                       R6 R7 K15 ["Flags"]
       39 GETTABLEKS                       R5 R6 K16 ["getFFlagDraggerEditProcModels"]
       41 CALL                             R4 1 1
