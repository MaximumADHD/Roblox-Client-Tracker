...
MAIN:
  ...
  GETTABLEKS R13 R1 K19 ["Flags"]
  GETTABLEKS R12 R13 K21 ["getFFlagDraggerSettings"]
  CALL R11 1 1
  NEWTABLE R12 16 0
  ...
  CAPTURE VAL R11
  CAPTURE VAL R9
  SETTABLEKS R13 R12 K18 ["getSoftSnaps"]
  DUPCLOSURE R13 K26 [PROTO_2]
  SETTABLEKS R13 R12 K27 ["_selectedIsActive"]
  DUPCLOSURE R13 K28 [PROTO_3]
  CAPTURE VAL R5
  SETTABLEKS R13 R12 K29 ["_setCurrentSnap"]
  DUPCLOSURE R13 K30 [PROTO_4]
  SETTABLEKS R13 R12 K31 ["beginDrag"]
  DUPCLOSURE R13 K32 [PROTO_5]
  CAPTURE VAL R3
  DUPCLOSURE R14 K33 [PROTO_6]
  CAPTURE VAL R10
  CAPTURE VAL R13
  SETTABLEKS R14 R12 K34 ["_findNewSnapTargetImpl"]
  DUPCLOSURE R14 K35 [PROTO_7]
  SETTABLEKS R14 R12 K36 ["_findNewSnapTargetViaCollision"]
  DUPCLOSURE R14 K37 [PROTO_8]
  CAPTURE VAL R4
  SETTABLEKS R14 R12 K38 ["updateDrag"]
  DUPCLOSURE R14 K39 [PROTO_9]
  CAPTURE VAL R8
  SETTABLEKS R14 R12 K40 ["endDrag"]
  DUPCLOSURE R14 K41 [PROTO_10]
  SETTABLEKS R14 R12 K42 ["getSnapPoints"]
  DUPCLOSURE R14 K43 [PROTO_11]
  CAPTURE VAL R2
  CAPTURE VAL R7
  CAPTURE VAL R6
  SETTABLEKS R14 R12 K44 ["render"]
  RETURN R12 1
