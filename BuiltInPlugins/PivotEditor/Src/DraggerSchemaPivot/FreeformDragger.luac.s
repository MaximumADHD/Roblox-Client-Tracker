...
PROTO_2:
  ...
  GETUPVAL R6 6
  DUPTABLE R7 K33 [{"DragTarget", "SourceSize", "Scale", "GridSize", "Color", "PrimaryColor"}]
  GETTABLEKS R8 R0 K0 ["_lastDragTarget"]
  SETTABLEKS R8 R7 K29 ["DragTarget"]
  GETIMPORT R9 K37 [Vector3.one]
  MULK R8 R9 K34 [4]
  ...
  GETTABLEKS R8 R0 K14 ["_draggerContext"]
  NAMECALL R8 R8 K40 ["getGridColor"]
  CALL R8 1 1
  SETTABLEKS R8 R7 K7 ["Color"]
  GETTABLEKS R8 R0 K14 ["_draggerContext"]
  NAMECALL R8 R8 K41 ["getChosenColor"]
  CALL R8 1 1
  SETTABLEKS R8 R7 K32 ["PrimaryColor"]
  CALL R5 2 1
  SETTABLEKS R5 R1 K42 ["TargetGrid"]
  GETUPVAL R6 1
  GETTABLEKS R5 R6 K5 ["createElement"]
  GETUPVAL R6 7
  DUPTABLE R7 K43 [{"DragTarget", "DraggerContext"}]
  GETTABLEKS R8 R0 K0 ["_lastDragTarget"]
  SETTABLEKS R8 R7 K29 ["DragTarget"]
  GETTABLEKS R8 R0 K14 ["_draggerContext"]
  SETTABLEKS R8 R7 K17 ["DraggerContext"]
  CALL R5 2 1
  SETTABLEKS R5 R1 K44 ["TargetSoftSnapView"]
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K45 ["createFragment"]
  MOVE R3 R1
  CALL R2 1 -1
  RETURN R2 -1
...
PROTO_5:
  ...
  GETUPVAL R3 3
  GETTABLEKS R5 R0 K10 ["_dragInfo"]
  GETTABLEKS R4 R5 K11 ["ClickedSelectable"]
  GETTABLEKS R5 R2 K12 ["mainCFrame"]
  CALL R3 2 0
  RETURN R0 0
  NEWCLOSURE R2 P0
  CAPTURE VAL R0
  ...
  GETTABLEKS R5 R6 K11 ["ClickedSelectable"]
  GETTABLEKS R6 R3 K12 ["mainCFrame"]
  CALL R4 2 0
  RETURN R0 0
