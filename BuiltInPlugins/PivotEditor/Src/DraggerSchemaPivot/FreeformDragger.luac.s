...
PROTO_2:
  ...
  GETUPVAL R6 6
  DUPTABLE R7 K34 [{"DragTarget", "SourceSize", "Scale", "GridSize", "MajorStep", "Color", "PrimaryColor"}]
  GETTABLEKS R8 R0 K0 ["_lastDragTarget"]
  SETTABLEKS R8 R7 K29 ["DragTarget"]
  GETIMPORT R9 K38 [Vector3.one]
  MULK R8 R9 K35 [4]
  SETTABLEKS R8 R7 K30 ["SourceSize"]
  SETTABLEKS R4 R7 K9 ["Scale"]
  GETTABLEKS R9 R0 K14 ["_draggerContext"]
  NAMECALL R9 R9 K39 ["getGridSnapEnabled"]
  CALL R9 1 1
  JUMPIFNOT R9 [+6]
  GETTABLEKS R8 R0 K14 ["_draggerContext"]
  NAMECALL R8 R8 K40 ["getGridSize"]
  CALL R8 1 1
  JUMP [+1]
  LOADNIL R8
  SETTABLEKS R8 R7 K31 ["GridSize"]
  GETUPVAL R9 7
  CALL R9 0 1
  JUMPIFNOT R9 [+6]
  GETTABLEKS R8 R0 K14 ["_draggerContext"]
  NAMECALL R8 R8 K41 ["getMajorGridIncrement"]
  CALL R8 1 1
  JUMP [+1]
  LOADNIL R8
  SETTABLEKS R8 R7 K32 ["MajorStep"]
  GETTABLEKS R8 R0 K14 ["_draggerContext"]
  NAMECALL R8 R8 K42 ["getGridColor"]
  CALL R8 1 1
  SETTABLEKS R8 R7 K7 ["Color"]
  GETTABLEKS R8 R0 K14 ["_draggerContext"]
  NAMECALL R8 R8 K43 ["getChosenColor"]
  CALL R8 1 1
  SETTABLEKS R8 R7 K33 ["PrimaryColor"]
  CALL R5 2 1
  SETTABLEKS R5 R1 K44 ["TargetGrid"]
  GETUPVAL R6 1
  GETTABLEKS R5 R6 K5 ["createElement"]
  GETUPVAL R6 8
  DUPTABLE R7 K45 [{"DragTarget", "DraggerContext"}]
  GETTABLEKS R8 R0 K0 ["_lastDragTarget"]
  SETTABLEKS R8 R7 K29 ["DragTarget"]
  GETTABLEKS R8 R0 K14 ["_draggerContext"]
  SETTABLEKS R8 R7 K17 ["DraggerContext"]
  CALL R5 2 1
  SETTABLEKS R5 R1 K46 ["TargetSoftSnapView"]
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K47 ["createFragment"]
  MOVE R3 R1
  CALL R2 1 -1
  RETURN R2 -1
...
PROTO_5:
  ...
  GETUPVAL R3 4
  GETTABLEKS R5 R0 K11 ["_dragInfo"]
  GETTABLEKS R4 R5 K12 ["ClickedSelectable"]
  GETTABLEKS R5 R2 K13 ["mainCFrame"]
  CALL R3 2 0
  RETURN R0 0
  NEWCLOSURE R2 P0
  CAPTURE VAL R0
  ...
  GETUPVAL R4 4
  GETTABLEKS R6 R0 K11 ["_dragInfo"]
  GETTABLEKS R5 R6 K12 ["ClickedSelectable"]
  GETTABLEKS R6 R3 K13 ["mainCFrame"]
  CALL R4 2 0
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R18 R3 K25 ["Flags"]
  GETTABLEKS R17 R18 K27 ["getFFlagDraggerSettings"]
  CALL R16 1 1
  FASTCALL VECTOR [+2]
  GETIMPORT R17 K30 [Vector3.new]
  CALL R17 0 1
  DUPTABLE R18 K37 [{"MinusZ", "PlusZ", "MinusY", "PlusY", "MinusX", "PlusX"}]
  DUPTABLE R19 K40 [{"Offset", "Color"}]
  GETIMPORT R20 K43 [CFrame.fromMatrix]
  MOVE R21 R17
  LOADN R23 1
  LOADN R24 0
  LOADN R25 0
  ...
  CALL R23 3 1
  CALL R20 3 1
  SETTABLEKS R20 R19 K38 ["Offset"]
  GETTABLEKS R20 R6 K44 ["Z_AXIS"]
  SETTABLEKS R20 R19 K39 ["Color"]
  SETTABLEKS R19 R18 K31 ["MinusZ"]
  DUPTABLE R19 K40 [{"Offset", "Color"}]
  GETIMPORT R20 K43 [CFrame.fromMatrix]
  MOVE R21 R17
  LOADN R23 1
  ...
  CALL R20 3 1
  SETTABLEKS R20 R19 K38 ["Offset"]
  GETTABLEKS R20 R6 K45 ["Y_AXIS"]
  SETTABLEKS R20 R19 K39 ["Color"]
  SETTABLEKS R19 R18 K33 ["MinusY"]
  DUPTABLE R19 K40 [{"Offset", "Color"}]
  GETIMPORT R20 K43 [CFrame.fromMatrix]
  MOVE R21 R17
  LOADN R23 0
  ...
  CALL R20 3 1
  SETTABLEKS R20 R19 K38 ["Offset"]
  GETTABLEKS R20 R6 K46 ["X_AXIS"]
  SETTABLEKS R20 R19 K39 ["Color"]
  SETTABLEKS R19 R18 K35 ["MinusX"]
  DUPTABLE R19 K40 [{"Offset", "Color"}]
  GETIMPORT R20 K43 [CFrame.fromMatrix]
  MOVE R21 R17
  LOADN R23 0
  ...
  GETTABLEKS R20 R6 K46 ["X_AXIS"]
  SETTABLEKS R20 R19 K39 ["Color"]
  SETTABLEKS R19 R18 K36 ["PlusX"]
  NEWTABLE R19 16 0
  SETTABLEKS R19 R19 K47 ["__index"]
  DUPCLOSURE R20 K48 [PROTO_0]
  CAPTURE VAL R19
  CAPTURE VAL R11
  SETTABLEKS R20 R19 K29 ["new"]
  DUPCLOSURE R20 K49 [PROTO_1]
  SETTABLEKS R20 R19 K50 ["_selectedIsActive"]
  ...
  CAPTURE VAL R16
  CAPTURE VAL R10
  SETTABLEKS R20 R19 K56 ["_updateNoSnap"]
  DUPCLOSURE R20 K57 [PROTO_6]
  CAPTURE VAL R15
  CAPTURE VAL R0
  CAPTURE VAL R11
  SETTABLEKS R20 R19 K58 ["_recomputeSnapPoints"]
  DUPCLOSURE R20 K59 [PROTO_7]
  CAPTURE VAL R10
  SETTABLEKS R20 R19 K60 ["_snapToSnapPoints"]
  DUPCLOSURE R20 K61 [PROTO_8]
  SETTABLEKS R20 R19 K62 ["_updateSnap"]
  DUPCLOSURE R20 K63 [PROTO_9]
  SETTABLEKS R20 R19 K64 ["update"]
  DUPCLOSURE R20 K65 [PROTO_10]
  CAPTURE VAL R14
  SETTABLEKS R20 R19 K66 ["destroy"]
  RETURN R19 1
