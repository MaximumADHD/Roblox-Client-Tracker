PROTO_0:
  GETUPVAL R0 0
  LOADK R1 K0 ["LocalizationTools"]
  SETTABLEKS R1 R0 K1 ["Name"]
  GETUPVAL R1 1
  GETTABLEKS R0 R1 K2 ["createElement"]
  GETUPVAL R1 2
  DUPTABLE R2 K5 [{"Plugin", "pluginLoaderContext"}]
  GETUPVAL R3 0
  SETTABLEKS R3 R2 K3 ["Plugin"]
  GETUPVAL R4 3
  ORK R3 R4 K6 []
...
PROTO_2:
  ...
  CALL R7 2 0
  LOADK R7 K11 ["LocalizationTools"]
  SETTABLEKS R7 R0 K12 ["Name"]
  GETTABLEKS R7 R3 K13 ["createElement"]
  MOVE R8 R4
  DUPTABLE R9 K16 [{"Plugin", "pluginLoaderContext"}]
  SETTABLEKS R0 R9 K14 ["Plugin"]
  ORK R10 R1 K17 []
  SETTABLEKS R10 R9 K15 ["pluginLoaderContext"]
  CALL R7 2 1
  GETTABLEKS R8 R3 K18 ["mount"]
  MOVE R9 R7
  CALL R8 1 1
  MOVE R5 R8
  CLOSEUPVALS R5
