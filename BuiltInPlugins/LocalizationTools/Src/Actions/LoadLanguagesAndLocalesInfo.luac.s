PROTO_0:
  ...
  LOADK R4 K3 ["Expected allLanguages to be a table"]
  ...
  LOADK R4 K6 ["Expected localesToLanguages to be a table"]
  GETIMPORT R2 K5 [assert]
  CALL R2 2 0
  DUPTABLE R2 K9 [{"allLanguages", "localesToLanguages"}]
  SETTABLEKS R0 R2 K7 ["allLanguages"]
  SETTABLEKS R1 R2 K8 ["localesToLanguages"]
  RETURN R2 1
