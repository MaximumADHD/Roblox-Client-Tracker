...
PROTO_8:
  GETUPVAL R2 0
  GETTABLEKS R1 R2 K0 ["LocalizationSource"]
  GETTABLEKS R0 R1 K1 ["SourceStrings"]
  GETUPVAL R3 0
  GETTABLEKS R2 R3 K0 ["LocalizationSource"]
  GETTABLEKS R1 R2 K2 ["LocalizedStrings"]
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K3 ["shouldUseTestCustomLocale"]
  CALL R2 0 1
  JUMPIFNOT R2 [+13]
  GETIMPORT R2 K5 [print]
  LOADK R3 K6 ["Toolbox using test custom locale"]
  CALL R2 1 0
  GETUPVAL R3 2
  GETTABLEKS R2 R3 K7 ["createTestCustomLocaleLocalization"]
  GETUPVAL R4 1
  GETTABLEKS R3 R4 K8 ["getOrCreateTestCustomLocale"]
  CALL R3 0 -1
  CALL R2 -1 -1
  RETURN R2 -1
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K9 ["shouldUseTestRealLocale"]
  CALL R2 0 1
  JUMPIFNOT R2 [+14]
  GETIMPORT R2 K5 [print]
  LOADK R3 K10 ["Toolbox using test real locale"]
  CALL R2 1 0
  GETUPVAL R3 2
  GETTABLEKS R2 R3 K11 ["createTestRealLocaleLocalization"]
  MOVE R3 R1
  GETUPVAL R5 1
  GETTABLEKS R4 R5 K12 ["getOrCreateTestRealLocale"]
  CALL R4 0 -1
  CALL R2 -1 -1
  RETURN R2 -1
  GETUPVAL R3 2
  GETTABLEKS R2 R3 K13 ["new"]
  DUPTABLE R3 K18 [{"getLocaleId", "getTranslator", "getFallbackTranslator", "localeIdChanged"}]
  NEWCLOSURE R4 P0
  CAPTURE UPVAL U3
  SETTABLEKS R4 R3 K14 ["getLocaleId"]
  NEWCLOSURE R4 P1
  CAPTURE VAL R1
  SETTABLEKS R4 R3 K15 ["getTranslator"]
  NEWCLOSURE R4 P2
  CAPTURE VAL R0
  SETTABLEKS R4 R3 K16 ["getFallbackTranslator"]
  GETUPVAL R4 3
  LOADK R6 K19 ["StudioLocaleId"]
  NAMECALL R4 R4 K20 ["GetPropertyChangedSignal"]
  CALL R4 2 1
  SETTABLEKS R4 R3 K17 ["localeIdChanged"]
  CALL R2 1 -1
  RETURN R2 -1
...
PROTO_12:
  ...
  JUMP [+1]
  LOADNIL R22
  SETTABLEKS R22 R21 K37 ["hasSubsequent"]
  MOVE R22 R18
  CALL R19 3 1
  GETUPVAL R20 17
  CALL R20 0 1
  ...
  SETTABLEKS R22 R27 K47 ["localization"]
...
PROTO_26:
  ...
  GETTABLEKS R14 R15 K20 ["getFFlagToolboxTutorialLimits"]
  CALL R13 1 1
  ...
  GETTABLEKS R48 R49 K73 ["Flags"]
  GETTABLEKS R47 R48 K75 ["getFFlagToolboxSubmitCompleted"]
  CALL R46 1 1
  GETTABLEKS R47 R18 K46 ["ContextServices"]
  GETTABLEKS R49 R18 K4 ["Util"]
  GETTABLEKS R48 R49 K76 ["ThunkWithArgsMiddleware"]
  GETIMPORT R49 K15 [require]
  GETTABLEKS R50 R16 K77 ["Dash"]
  CALL R49 1 1
  ...
  NAMECALL R55 R55 K22 ["GetService"]
  CALL R55 2 1
  MOVE R56 R36
  CALL R56 0 1
  JUMPIF R56 [+1]
  RETURN R0 0
  GETTABLEKS R57 R47 K41 ["Localization"]
