...
PROTO_23:
  ...
  GETTABLEKS R11 R12 K18 ["getFFlagRemoveItemTags"]
  CALL R10 1 1
  ...
  CALL R42 1 1
  GETTABLEKS R43 R16 K44 ["ContextServices"]
  ...
  GETTABLEKS R49 R2 K75 ["Resources"]
  GETTABLEKS R48 R49 K76 ["Localization"]
  GETTABLEKS R47 R48 K77 ["SourceStrings"]
  GETTABLEKS R50 R2 K75 ["Resources"]
  GETTABLEKS R49 R50 K76 ["Localization"]
  GETTABLEKS R48 R49 K78 ["LocalizedStrings"]
  GETIMPORT R49 K6 [game]
  LOADK R51 K79 ["HttpService"]
  NAMECALL R49 R49 K21 ["GetService"]
  CALL R49 2 1
  GETIMPORT R50 K6 [game]
  LOADK R52 K80 ["RobloxPluginGuiService"]
  NAMECALL R50 R50 K21 ["GetService"]
  CALL R50 2 1
  GETIMPORT R51 K6 [game]
  LOADK R53 K81 ["StudioAssetService"]
  ...
  JUMPIF R52 [+1]
  RETURN R0 0
  GETTABLEKS R53 R43 K76 ["Localization"]
  ...
  NEWTABLE R54 1 0
  GETTABLEKS R56 R16 K75 ["Resources"]
  GETTABLEKS R55 R56 K89 ["LOCALIZATION_PROJECT_NAME"]
  DUPTABLE R56 K90 [{"stringResourceTable", "translationResourceTable"}]
  GETTABLEKS R58 R16 K75 ["Resources"]
  GETTABLEKS R57 R58 K77 ["SourceStrings"]
  SETTABLEKS R57 R56 K83 ["stringResourceTable"]
  GETTABLEKS R58 R16 K75 ["Resources"]
  GETTABLEKS R57 R58 K78 ["LocalizedStrings"]
