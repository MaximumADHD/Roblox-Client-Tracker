...
PROTO_23:
  ...
  LOADK R14 K20 ["StudioService"]
  NAMECALL R12 R12 K21 ["GetService"]
  CALL R12 2 1
  NAMECALL R13 R12 K22 ["HasInternalPermission"]
  CALL R13 1 1
  GETTABLEKS R14 R2 K23 ["Packages"]
  GETIMPORT R15 K14 [require]
  GETTABLEKS R16 R14 K24 ["Roact"]
  CALL R15 1 1
  GETIMPORT R16 K14 [require]
  GETTABLEKS R17 R14 K25 ["Framework"]
  CALL R16 1 1
  GETIMPORT R17 K14 [require]
  GETTABLEKS R19 R14 K26 ["Dev"]
  GETTABLEKS R18 R19 K27 ["DeveloperTools"]
  CALL R17 1 1
  JUMPIFNOT R4 [+13]
  GETTABLEKS R18 R15 K28 ["setGlobalConfig"]
  DUPTABLE R19 K32 [{"elementTracing", "propValidation", "typeChecks"}]
  LOADB R20 1
  SETTABLEKS R20 R19 K29 ["elementTracing"]
  LOADB R20 1
  SETTABLEKS R20 R19 K30 ["propValidation"]
  LOADB R20 1
  SETTABLEKS R20 R19 K31 ["typeChecks"]
  CALL R18 1 0
  GETIMPORT R18 K14 [require]
  GETTABLEKS R19 R14 K33 ["Rodux"]
  CALL R18 1 1
  GETIMPORT R19 K14 [require]
  GETTABLEKS R20 R3 K34 ["InsertAsset"]
  CALL R19 1 1
  GETIMPORT R20 K14 [require]
  GETTABLEKS R22 R3 K35 ["Analytics"]
  GETTABLEKS R21 R22 K36 ["AssetAnalyticsContextItem"]
  CALL R20 1 1
  GETIMPORT R21 K14 [require]
  GETTABLEKS R22 R3 K37 ["DebugFlags"]
  CALL R21 1 1
  GETIMPORT R22 K14 [require]
  GETTABLEKS R23 R3 K38 ["Settings"]
  CALL R22 1 1
  GETIMPORT R23 K14 [require]
  GETTABLEKS R24 R3 K39 ["ToolboxTheme"]
  CALL R23 1 1
  GETIMPORT R24 K14 [require]
  GETTABLEKS R25 R3 K40 ["AssetConfigTheme"]
  CALL R24 1 1
  GETIMPORT R25 K14 [require]
  GETTABLEKS R26 R3 K41 ["AssetConfigConstants"]
  CALL R25 1 1
  GETIMPORT R26 K14 [require]
  GETTABLEKS R27 R3 K42 ["AssetConfigUtil"]
  CALL R26 1 1
  GETIMPORT R27 K14 [require]
  GETTABLEKS R29 R3 K35 ["Analytics"]
  GETTABLEKS R28 R29 K43 ["makeToolboxAnalyticsContext"]
  CALL R27 1 1
  GETIMPORT R28 K14 [require]
  GETTABLEKS R31 R2 K3 ["Src"]
  GETTABLEKS R30 R31 K44 ["ContextServices"]
  GETTABLEKS R29 R30 K45 ["IXPContext"]
  CALL R28 1 1
  GETTABLEKS R29 R21 K46 ["shouldDebugWarnings"]
  CALL R29 0 1
  JUMPIFNOT R29 [+13]
  GETIMPORT R31 K14 [require]
  GETTABLEKS R32 R14 K25 ["Framework"]
  CALL R31 1 1
  GETTABLEKS R30 R31 K4 ["Util"]
  GETTABLEKS R29 R30 K47 ["Promise"]
  GETIMPORT R30 K49 [warn]
  SETTABLEKS R30 R29 K50 ["onUnhandledRejection"]
  GETIMPORT R29 K14 [require]
  GETTABLEKS R32 R2 K3 ["Src"]
  GETTABLEKS R31 R32 K51 ["Types"]
  GETTABLEKS R30 R31 K52 ["Background"]
  CALL R29 1 1
  GETIMPORT R30 K14 [require]
  GETTABLEKS R33 R2 K3 ["Src"]
  GETTABLEKS R32 R33 K51 ["Types"]
  GETTABLEKS R31 R32 K53 ["Suggestion"]
  CALL R30 1 1
  GETIMPORT R31 K14 [require]
  GETTABLEKS R34 R2 K3 ["Src"]
  GETTABLEKS R33 R34 K51 ["Types"]
  GETTABLEKS R32 R33 K54 ["ConfigTypes"]
  CALL R31 1 1
  GETIMPORT R32 K14 [require]
  GETTABLEKS R35 R2 K3 ["Src"]
  GETTABLEKS R34 R35 K55 ["Components"]
  GETTABLEKS R33 R34 K56 ["ToolboxPlugin"]
  CALL R32 1 1
  GETIMPORT R34 K14 [require]
  GETTABLEKS R37 R2 K3 ["Src"]
  GETTABLEKS R36 R37 K4 ["Util"]
  GETTABLEKS R35 R36 K57 ["ToolboxUtilities"]
  CALL R34 1 1
  GETTABLEKS R33 R34 K58 ["getToolboxEnabled"]
  GETIMPORT R34 K14 [require]
  GETTABLEKS R37 R2 K3 ["Src"]
  GETTABLEKS R36 R37 K4 ["Util"]
  GETTABLEKS R35 R36 K59 ["ToolboxCommunication"]
  CALL R34 1 1
  GETIMPORT R35 K14 [require]
  GETTABLEKS R38 R2 K3 ["Src"]
  GETTABLEKS R37 R38 K60 ["Reducers"]
  GETTABLEKS R36 R37 K61 ["ToolboxReducer"]
  CALL R35 1 1
  GETIMPORT R36 K14 [require]
  GETTABLEKS R39 R2 K3 ["Src"]
  GETTABLEKS R38 R39 K60 ["Reducers"]
  GETTABLEKS R37 R38 K62 ["AssetConfigReducer"]
  CALL R36 1 1
  GETIMPORT R37 K14 [require]
  GETTABLEKS R40 R2 K3 ["Src"]
  GETTABLEKS R39 R40 K63 ["Networking"]
  GETTABLEKS R38 R39 K64 ["NetworkInterface"]
  CALL R37 1 1
  GETIMPORT R38 K14 [require]
  GETTABLEKS R42 R2 K3 ["Src"]
  GETTABLEKS R41 R42 K55 ["Components"]
  GETTABLEKS R40 R41 K65 ["AssetConfiguration"]
  GETTABLEKS R39 R40 K66 ["AssetConfigWrapper"]
  CALL R38 1 1
  GETIMPORT R39 K14 [require]
  GETTABLEKS R42 R2 K3 ["Src"]
  GETTABLEKS R41 R42 K55 ["Components"]
  GETTABLEKS R40 R41 K67 ["ToolboxServiceWrapper"]
  CALL R39 1 1
  GETIMPORT R40 K14 [require]
  GETTABLEKS R44 R2 K3 ["Src"]
  GETTABLEKS R43 R44 K63 ["Networking"]
  GETTABLEKS R42 R43 K68 ["Requests"]
  GETTABLEKS R41 R42 K69 ["GetRolesRequest"]
  CALL R40 1 1
  GETIMPORT R41 K14 [require]
  GETTABLEKS R45 R2 K3 ["Src"]
  GETTABLEKS R44 R45 K63 ["Networking"]
  GETTABLEKS R43 R44 K68 ["Requests"]
  GETTABLEKS R42 R43 K70 ["GetRolesDebugRequest"]
  CALL R41 1 1
  GETIMPORT R42 K14 [require]
  GETTABLEKS R45 R2 K3 ["Src"]
  GETTABLEKS R44 R45 K17 ["Flags"]
  ...
  GETTABLEKS R44 R45 K72 ["getFFlagEnableUploadingGroupBundles"]
  CALL R43 1 1
  GETTABLEKS R44 R16 K44 ["ContextServices"]
  GETTABLEKS R46 R16 K4 ["Util"]
  GETTABLEKS R45 R46 K73 ["ThunkWithArgsMiddleware"]
  GETIMPORT R46 K14 [require]
  GETTABLEKS R47 R14 K74 ["Dash"]
  CALL R46 1 1
  GETTABLEKS R47 R46 K75 ["find"]
  GETTABLEKS R50 R2 K76 ["Resources"]
  GETTABLEKS R49 R50 K77 ["Localization"]
  GETTABLEKS R48 R49 K78 ["SourceStrings"]
  GETTABLEKS R51 R2 K76 ["Resources"]
  GETTABLEKS R50 R51 K77 ["Localization"]
  GETTABLEKS R49 R50 K79 ["LocalizedStrings"]
  GETIMPORT R50 K6 [game]
  LOADK R52 K80 ["HttpService"]
  NAMECALL R50 R50 K21 ["GetService"]
  CALL R50 2 1
  GETIMPORT R51 K6 [game]
  LOADK R53 K81 ["RobloxPluginGuiService"]
  NAMECALL R51 R51 K21 ["GetService"]
  CALL R51 2 1
  GETIMPORT R52 K6 [game]
  LOADK R54 K82 ["StudioAssetService"]
  ...
  JUMPIF R53 [+1]
  RETURN R0 0
  GETTABLEKS R54 R44 K77 ["Localization"]
  ...
  NEWTABLE R55 1 0
  GETTABLEKS R57 R16 K76 ["Resources"]
  GETTABLEKS R56 R57 K90 ["LOCALIZATION_PROJECT_NAME"]
  DUPTABLE R57 K91 [{"stringResourceTable", "translationResourceTable"}]
  GETTABLEKS R59 R16 K76 ["Resources"]
  GETTABLEKS R58 R59 K78 ["SourceStrings"]
  SETTABLEKS R58 R57 K84 ["stringResourceTable"]
  GETTABLEKS R59 R16 K76 ["Resources"]
  GETTABLEKS R58 R59 K79 ["LocalizedStrings"]
