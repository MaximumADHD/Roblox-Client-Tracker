...
PROTO_2:
       ...
       37 RETURN                           R0 0
       38 GETUPVAL                         R0 5
       39 GETTABLEKS                       R0 R0 K0 ["current"]
       41 SETUPVAL                         R0 7
       42 RETURN                           R0 0
...
PROTO_8:
        0 GETUPVAL                         R3 0
        1 GETTABLEKS                       R3 R3 K0 ["useReducer"]
        3 DUPCLOSURE                       R4 K1 [PROTO_1]
        4 LOADN                            R5 0
        5 CALL                             R3 2 2
        6 GETUPVAL                         R5 0
        7 GETTABLEKS                       R5 R5 K2 ["useRef"]
        9 LOADNIL                          R6
       10 CALL                             R5 1 1
       11 GETUPVAL                         R6 0
       12 GETTABLEKS                       R6 R6 K2 ["useRef"]
       14 LOADNIL                          R7
       15 CALL                             R6 1 1
       16 GETUPVAL                         R7 0
       ...
       65 CALL                             R13 1 0
       66 GETUPVAL                         R13 0
       67 GETTABLEKS                       R13 R13 K15 ["useLayoutEffect"]
       ...
       77 CALL                             R13 1 0
       78 GETUPVAL                         R13 0
       79 GETTABLEKS                       R13 R13 K15 ["useLayoutEffect"]
...
MAIN:
       ...
       20 GETTABLEKS                       R3 R3 K9 ["useStore"]
       22 CALL                             R2 1 1
       23 DUPCLOSURE                       R3 K10 [PROTO_0]
       24 DUPCLOSURE                       R4 K11 [PROTO_8]
       25 CAPTURE                          VAL R1
       26 SETGLOBAL                        R4 K12 ["useSelectorWithStore"]
       28 DUPCLOSURE                       R4 K13 [PROTO_9]
       29 CAPTURE                          VAL R3
       30 CAPTURE                          VAL R2
       31 SETGLOBAL                        R4 K14 ["useSelector"]
       33 GETGLOBAL                        R4 K14 ["useSelector"]
       35 RETURN                           R4 1
