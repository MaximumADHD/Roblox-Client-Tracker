PROTO_0:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R2 R2 K0 ["union"]
        3 GETUPVAL                         R3 0
        4 GETTABLEKS                       R3 R3 K1 ["strictInterface"]
        6 NEWTABLE                         R4 0 0
        8 CALL                             R3 1 1
        9 GETUPVAL                         R4 0
       10 GETTABLEKS                       R4 R4 K2 ["interface"]
       12 DUPTABLE                         R5 K6 [{"Id", "Name", "Type"}]
       13 GETUPVAL                         R6 0
       14 GETTABLEKS                       R6 R6 K7 ["number"]
       16 SETTABLEKS                       R6 R5 K3 ["Id"]
       18 GETUPVAL                         R6 0
       19 GETTABLEKS                       R6 R6 K8 ["string"]
       21 SETTABLEKS                       R6 R5 K4 ["Name"]
       23 GETUPVAL                         R6 1
       24 GETTABLEKS                       R6 R6 K9 ["isValidCreatorType"]
...
MAIN:
       ...
       20 GETTABLEKS                       R4 R0 K9 ["Src"]
       22 GETTABLEKS                       R4 R4 K7 ["Util"]
       24 GETIMPORT                        R5 K5 [require]
       26 GETTABLEKS                       R6 R4 K10 ["CreatorInfoHelper"]
       28 CALL                             R5 1 1
       29 GETIMPORT                        R6 K5 [require]
       31 GETTABLEKS                       R7 R1 K6 ["Framework"]
       33 CALL                             R6 1 1
       34 GETTABLEKS                       R6 R6 K7 ["Util"]
       36 GETTABLEKS                       R6 R6 K11 ["Typecheck"]
       38 GETTABLEKS                       R6 R6 K12 ["t"]
       40 MOVE                             R7 R3
       41 GETIMPORT                        R8 K1 [script]
       43 GETTABLEKS                       R8 R8 K13 ["Name"]
