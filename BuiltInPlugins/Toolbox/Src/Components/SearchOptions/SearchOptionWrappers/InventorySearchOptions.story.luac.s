...
PROTO_2:
  ...
  GETUPVAL R5 2
  DUPTABLE R6 K5 [{"IsShownByDefault", "OnRender"}]
  LOADB R7 1
  SETTABLEKS R7 R6 K3 ["IsShownByDefault"]
  DUPCLOSURE R7 K6 [PROTO_1]
  CAPTURE UPVAL U0
  CAPTURE UPVAL U3
  SETTABLEKS R7 R6 K4 ["OnRender"]
  CALL R4 2 1
...
MAIN:
  ...
  GETTABLEKS R3 R4 K9 ["InventorySearchOptions"]
  CALL R2 1 1
  ...
  LOADK R6 K9 ["InventorySearchOptions"]
  SETTABLEKS R6 R5 K14 ["name"]
  LOADK R6 K18 ["The Search Option component for Inventory"]
