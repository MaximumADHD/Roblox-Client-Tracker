PROTO_0:
  ...
  CALL R2 0 1
  JUMPIFNOT R2 [+3]
  GETTABLEKS R2 R1 K2 ["shouldIgnoreDateAndIXPChecks"]
  RETURN R2 1
  GETTABLEKS R2 R1 K3 ["Settings"]
  LOADK R4 K4 ["Plugin"]
  NAMECALL R2 R2 K5 ["get"]
  CALL R2 2 1
  NAMECALL R3 R2 K6 ["getLastAnnouncementViewedKey"]
  CALL R3 1 1
  GETUPVAL R5 2
  GETTABLEKS R4 R5 K7 ["getAnnouncementConfiguration"]
  CALL R4 0 1
  GETTABLEKS R6 R4 K9 ["Date"]
  ORK R5 R6 K8 [""]
  LOADB R6 0
  LOADB R7 0
  LOADB R8 0
  GETTABLEKS R9 R4 K10 ["IXPComparisonDefinitionKey"]
  GETTABLEKS R10 R4 K11 ["IXPComparisonVariableKey"]
  JUMPIFEQKNIL R9 [+20]
  JUMPIFEQKS R9 K8 [""] [+18]
  JUMPIFEQKNIL R10 [+16]
  JUMPIFEQKS R10 K8 [""] [+14]
  GETTABLEKS R11 R1 K12 ["checkUserInIXP"]
  LOADB R12 0
  JUMPIFEQKNIL R11 [+7]
  MOVE R12 R11
  GETTABLEKS R13 R1 K13 ["IXP"]
  MOVE R14 R9
  MOVE R15 R10
  CALL R12 3 1
  MOVE R8 R12
  ...
  LOADB R8 1
  JUMPIFEQKS R5 K8 [""] [+69]
  LOADK R13 K14 ["(%d+)-(%d+)-(%d+) (%d+):(%d+):(%d+)"]
  NAMECALL R11 R5 K15 ["match"]
  CALL R11 2 6
  DUPTABLE R17 K22 [{"year", "month", "day", "hour", "min", "sec"}]
  FASTCALL1 TONUMBER R11 [+3]
  MOVE R19 R11
  GETIMPORT R18 K24 [tonumber]
  CALL R18 1 1
  SETTABLEKS R18 R17 K16 ["year"]
  FASTCALL1 TONUMBER R12 [+3]
  MOVE R19 R12
  GETIMPORT R18 K24 [tonumber]
  CALL R18 1 1
  SETTABLEKS R18 R17 K17 ["month"]
  FASTCALL1 TONUMBER R13 [+3]
  MOVE R19 R13
  GETIMPORT R18 K24 [tonumber]
  CALL R18 1 1
  SETTABLEKS R18 R17 K18 ["day"]
  FASTCALL1 TONUMBER R14 [+3]
  MOVE R19 R14
  GETIMPORT R18 K24 [tonumber]
  CALL R18 1 1
  SETTABLEKS R18 R17 K19 ["hour"]
  FASTCALL1 TONUMBER R15 [+3]
  MOVE R19 R15
  GETIMPORT R18 K24 [tonumber]
  CALL R18 1 1
  SETTABLEKS R18 R17 K20 ["min"]
  FASTCALL1 TONUMBER R16 [+3]
  MOVE R19 R16
  GETIMPORT R18 K24 [tonumber]
  CALL R18 1 1
  SETTABLEKS R18 R17 K21 ["sec"]
  GETIMPORT R18 K27 [os.time]
  MOVE R19 R17
  CALL R18 1 1
  GETIMPORT R20 K30 [os.difftime]
  GETIMPORT R21 K27 [os.time]
  CALL R21 0 1
  MOVE R22 R18
  CALL R20 2 1
  DIVK R19 R20 K28 [86400]
  FASTCALL1 MATH_FLOOR R19 [+3]
  MOVE R21 R19
  GETIMPORT R20 K33 [math.floor]
  CALL R20 1 1
  LOADN R21 30
  JUMPIFNOTLT R21 R20 [+2]
  LOADB R6 1
  GETTABLEKS R11 R4 K34 ["LatestUserId"]
  JUMPIFNOT R11 [+14]
  JUMPIFEQKS R11 K8 [""] [+13]
  FASTCALL1 TONUMBER R11 [+3]
  MOVE R13 R11
  GETIMPORT R12 K24 [tonumber]
  CALL R12 1 1
  MOVE R11 R12
  GETUPVAL R12 3
  CALL R12 0 1
  ...
  LOADB R7 0 +1
  LOADB R7 1
  GETTABLEKS R12 R0 K35 ["isEnabled"]
  JUMPIFNOT R12 [+11]
  LOADB R12 0
  JUMPIFEQKS R5 K8 [""] [+9]
  LOADB R12 0
...
PROTO_2:
  ...
  CALL R5 0 1
  JUMPIFNOT R5 [+9]
  GETTABLEKS R5 R0 K12 ["onCloseDialog"]
  JUMPIFNOT R5 [+6]
  GETUPVAL R7 0
  GETTABLEKS R6 R7 K0 ["props"]
  GETTABLEKS R5 R6 K12 ["onCloseDialog"]
  CALL R5 0 0
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R29 R19 K36 ["SharedFlags"]
  GETTABLEKS R28 R29 K37 ["getFFlagToolboxFallbackAnnouncement"]
  CALL R27 1 1
  ...
  LOADN R31 110
  CALL R29 2 1
  GETTABLEKS R30 R4 K41 ["PureComponent"]
  LOADK R32 K42 ["AnnouncementDialog"]
  ...
  MOVE R31 R17
  DUPTABLE R32 K54 [{"IXP", "Localization", "Settings", "Stylizer", "Modal"}]
  SETTABLEKS R15 R32 K50 ["IXP"]
  GETTABLEKS R33 R16 K51 ["Localization"]
  SETTABLEKS R33 R32 K51 ["Localization"]
  SETTABLEKS R25 R32 K34 ["Settings"]
  GETTABLEKS R33 R16 K52 ["Stylizer"]
  SETTABLEKS R33 R32 K52 ["Stylizer"]
  SETTABLEKS R26 R32 K53 ["Modal"]
  CALL R31 1 1
  MOVE R32 R30
  CALL R31 1 1
  MOVE R30 R31
  ...
  CAPTURE VAL R4
  CAPTURE REF R30
  SETGLOBAL R31 K55 ["TypedComponent"]
  MOVE R31 R24
  GETGLOBAL R32 K55 ["TypedComponent"]
  CALL R31 1 -1
  CLOSEUPVALS R30
  RETURN R31 -1
