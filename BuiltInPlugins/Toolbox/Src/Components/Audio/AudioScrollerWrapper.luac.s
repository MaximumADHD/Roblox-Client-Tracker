PROTO_0:
        ...
        1 JUMPIFNOT                        R4 ; [+30]
        2 GETUPVAL                         R4 1
        3 GETTABLEKS                       R4 R4 K0 ["SwimlaneName"]
        5 GETUPVAL                         R5 2
       ...
       22 MOVE                             R12 R2
       23 GETUPVAL                         R13 4
       24 GETTABLEKS                       R13 R13 K3 ["size"]
       26 GETUPVAL                         R14 4
       27 GETTABLEKS                       R14 R14 K4 ["position"]
       29 MOVE                             R15 R7
       30 CALL                             R8 7 -1
       31 RETURN                           R8 -1
       32 LOADNIL                          R4
...
PROTO_2:
        ...
        2 GETTABLEKS                       R2 R0 K1 ["AssetLogicWrapperProps"]
        4 GETTABLEKS                       R2 R2 K2 ["LogAssetImpression"]
        6 GETUPVAL                         R3 0
        7 GETTABLEKS                       R3 R3 K3 ["use"]
        9 CALL                             R3 0 1
       10 GETUPVAL                         R4 1
       11 GETTABLEKS                       R4 R4 K3 ["use"]
       13 CALL                             R4 0 1
       14 GETUPVAL                         R5 2
       ...
       26 CALL                             R5 1 2
       27 GETUPVAL                         R7 2
       28 GETTABLEKS                       R7 R7 K11 ["useCallback"]
       30 NEWCLOSURE                       R8 P0
       31 CAPTURE                          VAL R2
       32 CAPTURE                          VAL R0
       33 CAPTURE                          VAL R3
       ...
       42 CALL                             R7 2 1
       43 GETUPVAL                         R8 2
       44 GETTABLEKS                       R8 R8 K11 ["useCallback"]
       46 NEWCLOSURE                       R9 P1
       47 CAPTURE                          VAL R6
       48 NEWTABLE                         R10 0 0
       50 CALL                             R8 2 1
       ...
       54 CALL                             R9 1 1
       55 GETUPVAL                         R10 2
       56 GETTABLEKS                       R10 R10 K12 ["createElement"]
       58 GETUPVAL                         R11 4
       59 NEWTABLE                         R12 4 0
       61 GETTABLEKS                       R13 R9 K13 ["backgroundColor"]
       63 SETTABLEKS                       R13 R12 K14 ["BackgroundColor"]
       65 GETUPVAL                         R13 2
       66 GETTABLEKS                       R13 R13 K15 ["Change"]
       68 GETTABLEKS                       R13 R13 K16 ["AbsoluteSize"]
       70 SETTABLE                         R8 R12 R13
       71 GETUPVAL                         R13 2
       72 GETTABLEKS                       R13 R13 K15 ["Change"]
       74 GETTABLEKS                       R13 R13 K17 ["AbsolutePosition"]
       76 SETTABLE                         R8 R12 R13
       77 DUPTABLE                         R13 K19 [{"AudioScroller"}]
       78 GETUPVAL                         R14 5
       79 GETTABLEKS                       R14 R14 K20 ["Generator"]
      ...
      110 GETTABLEKS                       R16 R0 K1 ["AssetLogicWrapperProps"]
      112 GETTABLEKS                       R16 R16 K28 ["CanInsertAsset"]
      114 SETTABLEKS                       R16 R15 K28 ["CanInsertAsset"]
      116 SETTABLEKS                       R7 R15 K29 ["LogImpression"]
      118 GETTABLEKS                       R16 R0 K1 ["AssetLogicWrapperProps"]
      120 GETTABLEKS                       R16 R16 K30 ["OnAssetPreviewButtonClicked"]
      122 SETTABLEKS                       R16 R15 K30 ["OnAssetPreviewButtonClicked"]
      124 GETTABLEKS                       R16 R0 K1 ["AssetLogicWrapperProps"]
      126 GETTABLEKS                       R16 R16 K31 ["TryInsert"]
      128 SETTABLEKS                       R16 R15 K31 ["TryInsert"]
      130 GETTABLEKS                       R16 R0 K1 ["AssetLogicWrapperProps"]
      132 GETTABLEKS                       R16 R16 K32 ["TryOpenAssetConfig"]
...
MAIN:
       ...
       27 GETTABLEKS                       R4 R4 K11 ["AssetLogicTypes"]
       29 CALL                             R3 1 1
       30 GETIMPORT                        R4 K5 [require]
       32 GETTABLEKS                       R5 R0 K9 ["Src"]
       34 GETTABLEKS                       R5 R5 K12 ["Components"]
       36 GETTABLEKS                       R5 R5 K13 ["Audio"]
       38 GETTABLEKS                       R5 R5 K14 ["AudioScroller"]
       40 CALL                             R4 1 1
       41 GETIMPORT                        R5 K5 [require]
       43 GETTABLEKS                       R6 R0 K9 ["Src"]
       45 GETTABLEKS                       R6 R6 K12 ["Components"]
       47 GETTABLEKS                       R6 R6 K15 ["ResultsFetcher"]
       49 CALL                             R5 1 1
       50 GETIMPORT                        R6 K5 [require]
       52 GETTABLEKS                       R7 R0 K9 ["Src"]
       54 GETTABLEKS                       R7 R7 K16 ["ContextServices"]
       56 GETTABLEKS                       R7 R7 K17 ["NavigationContext"]
       58 CALL                             R6 1 1
       59 GETIMPORT                        R7 K5 [require]
       61 GETTABLEKS                       R8 R0 K9 ["Src"]
       63 GETTABLEKS                       R8 R8 K18 ["Util"]
       65 GETTABLEKS                       R8 R8 K19 ["Analytics"]
       67 GETTABLEKS                       R8 R8 K20 ["AssetAnalyticsContextItem"]
       69 CALL                             R7 1 1
       70 GETTABLEKS                       R8 R2 K21 ["UI"]
       72 GETTABLEKS                       R8 R8 K22 ["Pane"]
       74 GETTABLEKS                       R9 R2 K16 ["ContextServices"]
       76 GETTABLEKS                       R9 R9 K23 ["Stylizer"]
