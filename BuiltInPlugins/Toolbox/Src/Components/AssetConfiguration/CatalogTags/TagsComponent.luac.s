...
MAIN:
  ...
  GETTABLEKS R7 R3 K14 ["Cryo"]
  CALL R6 1 1
  GETIMPORT R7 K4 [require]
  GETTABLEKS R8 R3 K15 ["Framework"]
  CALL R7 1 1
  ...
  GETTABLEKS R11 R8 K17 ["AssetConfigConstants"]
  CALL R10 1 1
  GETIMPORT R11 K4 [require]
  GETTABLEKS R12 R8 K18 ["trimString"]
  CALL R11 1 1
  MOVE R13 R2
  CALL R13 0 1
  JUMPIFNOT R13 [+2]
  ...
  GETTABLEKS R13 R8 K19 ["TagsUtil"]
  CALL R12 1 1
  GETTABLEKS R13 R7 K20 ["ContextServices"]
  ...
  CALL R15 1 1
  GETTABLEKS R17 R7 K6 ["Util"]
  GETTABLEKS R16 R17 K23 ["StyleModifier"]
  GETTABLEKS R18 R7 K6 ["Util"]
  GETTABLEKS R17 R18 K24 ["GetTextSize"]
  GETTABLEKS R18 R7 K25 ["UI"]
  GETTABLEKS R19 R18 K26 ["RoundBox"]
  GETTABLEKS R21 R7 K27 ["Wrappers"]
  GETTABLEKS R20 R21 K28 ["withForwardRef"]
  GETTABLEKS R22 R0 K5 ["Src"]
  GETTABLEKS R21 R22 K29 ["Components"]
  GETIMPORT R22 K4 [require]
  GETTABLEKS R23 R21 K30 ["DropdownItemsList"]
  CALL R22 1 1
  GETIMPORT R23 K4 [require]
  GETTABLEKS R26 R21 K31 ["AssetConfiguration"]
  GETTABLEKS R25 R26 K32 ["CatalogTags"]
  GETTABLEKS R24 R25 K33 ["CatalogTag"]
  CALL R23 1 1
  GETIMPORT R24 K4 [require]
  GETTABLEKS R28 R0 K5 ["Src"]
  GETTABLEKS R27 R28 K34 ["Networking"]
  GETTABLEKS R26 R27 K35 ["Requests"]
  GETTABLEKS R25 R26 K36 ["GetTagSuggestionsRequest"]
  CALL R24 1 1
  GETIMPORT R25 K4 [require]
  GETTABLEKS R28 R0 K5 ["Src"]
  GETTABLEKS R27 R28 K37 ["Actions"]
  GETTABLEKS R26 R27 K38 ["SetTagSuggestions"]
  CALL R25 1 1
  LOADN R28 5
  GETTABLEKS R29 R9 K40 ["FONT_SIZE_MEDIUM"]
  ADD R27 R28 R29
  ADDK R26 R27 K39 [5]
  GETTABLEKS R27 R4 K41 ["PureComponent"]
  LOADK R29 K42 ["TagsComponent"]
  ...
  SETTABLEKS R28 R27 K47 ["canAddTags"]
  DUPCLOSURE R28 K48 [PROTO_8]
  CAPTURE VAL R12
  CAPTURE VAL R6
  SETTABLEKS R28 R27 K49 ["addTag"]
  DUPCLOSURE R28 K50 [PROTO_9]
  SETTABLEKS R28 R27 K51 ["removeTag"]
  DUPCLOSURE R28 K52 [PROTO_10]
  SETTABLEKS R28 R27 K53 ["getDropdownItems"]
  DUPCLOSURE R28 K54 [PROTO_11]
  SETTABLEKS R28 R27 K55 ["clearSuggestions"]
  DUPCLOSURE R28 K56 [PROTO_12]
  SETTABLEKS R28 R27 K57 ["didMount"]
  DUPCLOSURE R28 K58 [PROTO_17]
  CAPTURE VAL R9
  CAPTURE VAL R17
  CAPTURE VAL R4
  CAPTURE VAL R23
  ...
  DUPCLOSURE R28 K60 [PROTO_18]
  DUPCLOSURE R29 K61 [PROTO_21]
  CAPTURE VAL R24
  CAPTURE VAL R25
  MOVE R30 R14
  DUPTABLE R31 K65 [{"Stylizer", "Localization", "Network"}]
  GETTABLEKS R32 R13 K62 ["Stylizer"]
  SETTABLEKS R32 R31 K62 ["Stylizer"]
  GETTABLEKS R32 R13 K63 ["Localization"]
  SETTABLEKS R32 R31 K63 ["Localization"]
  SETTABLEKS R15 R31 K64 ["Network"]
  CALL R30 1 1
  MOVE R31 R27
  CALL R30 1 1
  MOVE R27 R30
