PROTO_0:
       ...
       10 GETTABLEKS                       R4 R0 K4 ["Parent"]
       12 GETTABLEKS                       R4 R4 K5 ["BackgroundColor3"]
...
PROTO_1:
        ...
        7 RETURN                           R0 0
        8 GETUPVAL                         R1 0
        9 GETTABLEKS                       R1 R1 K2 ["colorChanged"]
       11 JUMPIFNOT                        R1 ; [+10]
       12 GETUPVAL                         R1 0
       13 GETTABLEKS                       R1 R1 K2 ["colorChanged"]
       ...
       38 GETUPVAL                         R1 0
       39 GETTABLEKS                       R1 R1 K0 ["ref"]
       41 GETTABLEKS                       R1 R1 K1 ["current"]
       43 JUMPIFNOTEQKNIL                  R1 ; [+2]
       45 RETURN                           R0 0
       46 GETUPVAL                         R2 0
       47 DUPTABLE                         R4 K9 [{"backgroundColor"}]
       48 GETTABLEKS                       R5 R1 K4 ["Parent"]
       50 GETTABLEKS                       R5 R5 K5 ["BackgroundColor3"]
...
PROTO_2:
       ...
       17 GETUPVAL                         R2 1
       18 GETTABLEKS                       R2 R2 K4 ["createRef"]
       20 CALL                             R2 0 1
...
PROTO_3:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["parentChanged"]
        3 CALL                             R0 0 0
        4 RETURN                           R0 0
...
PROTO_6:
       ...
       45 GETUPVAL                         R7 0
       46 GETTABLEKS                       R7 R7 K5 ["Dictionary"]
       48 GETTABLEKS                       R7 R7 K6 ["join"]
       50 MOVE                             R8 R4
       ...
       58 CALL                             R10 3 1
       59 JUMPIF                           R10 ; [+8]
       60 GETTABLEKS                       R10 R1 K16 ["assetConfig"]
       62 GETTABLEKS                       R10 R10 K17 ["packagePermissions"]
       64 GETTABLEKS                       R10 R10 K18 ["subjectThumbnail"]
       66 GETTABLEKS                       R10 R10 K19 ["defaultImageColor"]
       ...
       91 RETURN                           R5 -1
       92 GETUPVAL                         R5 2
       93 GETTABLEKS                       R5 R5 K9 ["createElement"]
       95 LOADK                            R6 K10 ["ImageLabel"]
       96 GETUPVAL                         R7 0
       97 GETTABLEKS                       R7 R7 K5 ["Dictionary"]
       99 GETTABLEKS                       R7 R7 K6 ["join"]
      101 MOVE                             R8 R4
      102 NEWTABLE                         R9 8 0
      104 GETUPVAL                         R10 2
      105 GETTABLEKS                       R10 R10 K28 ["Ref"]
      ...
      116 CALL                             R10 3 1
      117 JUMPIF                           R10 ; [+8]
      118 GETTABLEKS                       R10 R1 K16 ["assetConfig"]
      120 GETTABLEKS                       R10 R10 K17 ["packagePermissions"]
      122 GETTABLEKS                       R10 R10 K18 ["subjectThumbnail"]
      124 GETTABLEKS                       R10 R10 K19 ["defaultImageColor"]
      126 SETTABLEKS                       R10 R9 K11 ["ImageColor3"]
      128 LOADN                            R10 0
      129 SETTABLEKS                       R10 R9 K30 ["ImageTransparency"]
      131 GETTABLEKS                       R10 R1 K16 ["assetConfig"]
      133 GETTABLEKS                       R10 R10 K17 ["packagePermissions"]
      135 GETTABLEKS                       R10 R10 K18 ["subjectThumbnail"]
      137 GETTABLEKS                       R10 R10 K31 ["backgroundColor"]
      ...
      153 JUMPIFNOT                        R9 ; [+29]
      154 GETUPVAL                         R9 2
      155 GETTABLEKS                       R9 R9 K9 ["createElement"]
      ...
      171 GETUPVAL                         R12 3
      172 GETTABLEKS                       R12 R12 K40 ["AVATAR_MASK"]
      174 SETTABLEKS                       R12 R11 K36 ["Image"]
      176 GETTABLEKS                       R12 R0 K41 ["state"]
      178 GETTABLEKS                       R12 R12 K31 ["backgroundColor"]
...
MAIN:
       ...
       19 GETTABLEKS                       R2 R2 K7 ["getFFlagAACPermissionsPage"]
       21 CALL                             R1 1 1
