...
PROTO_6:
  ...
  CALL R1 2 0
  DUPTABLE R1 K10 [{"assetFetchStatus", "showDropdown"}]
  LOADNIL R2
  SETTABLEKS R2 R1 K8 ["assetFetchStatus"]
  LOADB R2 0
  SETTABLEKS R2 R1 K9 ["showDropdown"]
  SETTABLEKS R1 R0 K11 ["state"]
  LOADB R1 0
  SETTABLEKS R1 R0 K12 ["isMounted"]
  NEWCLOSURE R1 P0
  CAPTURE VAL R0
  SETTABLEKS R1 R0 K13 ["onItemActivated"]
  NEWCLOSURE R1 P1
  CAPTURE UPVAL U1
  CAPTURE UPVAL U2
  CAPTURE VAL R0
  SETTABLEKS R1 R0 K14 ["onDropdownRenderItem"]
  NEWCLOSURE R1 P2
  CAPTURE VAL R0
  SETTABLEKS R1 R0 K15 ["openDropdown"]
  NEWCLOSURE R1 P3
  CAPTURE VAL R0
  SETTABLEKS R1 R0 K16 ["closeDropdown"]
  NEWCLOSURE R1 P4
  CAPTURE VAL R0
  SETTABLEKS R1 R0 K17 ["onDelete"]
  RETURN R0 0
