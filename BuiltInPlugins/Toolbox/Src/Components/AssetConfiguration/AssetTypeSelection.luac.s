...
MAIN:
  ...
  GETTABLEKS R17 R18 K27 ["getFFlagToolboxDeprecateAssetSelection"]
  CALL R16 1 1
  GETTABLEKS R18 R0 K9 ["Src"]
  GETTABLEKS R17 R18 K28 ["Actions"]
  GETIMPORT R18 K5 [require]
  GETTABLEKS R19 R17 K29 ["SetCurrentScreen"]
  CALL R18 1 1
  GETIMPORT R19 K5 [require]
  GETTABLEKS R20 R17 K30 ["SetUploadAssetType"]
  CALL R19 1 1
  ...
  GETTABLEKS R24 R20 K18 ["AssetConfiguration"]
  GETTABLEKS R23 R24 K32 ["GoToNextScreen"]
  CALL R22 1 1
  MOVE R21 R22
  GETTABLEKS R22 R4 K33 ["ContextServices"]
  GETTABLEKS R23 R22 K34 ["withContext"]
  GETTABLEKS R24 R2 K35 ["PureComponent"]
  LOADK R26 K36 ["AssetTypeSelection"]
  ...
  CAPTURE VAL R8
  CAPTURE VAL R9
  SETTABLEKS R25 R24 K41 ["getSelectorItems"]
  DUPCLOSURE R25 K42 [PROTO_2]
  CAPTURE VAL R7
  SETTABLEKS R25 R24 K43 ["canSkip"]
  ...
  CAPTURE VAL R19
  MOVE R27 R23
  DUPTABLE R28 K48 [{"Stylizer", "Localization"}]
  GETTABLEKS R29 R22 K47 ["Stylizer"]
  SETTABLEKS R29 R28 K47 ["Stylizer"]
  GETTABLEKS R29 R22 K14 ["Localization"]
  SETTABLEKS R29 R28 K14 ["Localization"]
  CALL R27 1 1
  MOVE R28 R24
  CALL R27 1 1
  MOVE R24 R27
