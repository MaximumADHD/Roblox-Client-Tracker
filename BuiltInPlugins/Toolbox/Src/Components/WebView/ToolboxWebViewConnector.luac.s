...
PROTO_19:
        ...
        4 GETUPVAL                         R3 0
        5 GETTABLEKS                       R3 R3 K2 ["getTabKeyForCategoryName"]
        7 MOVE                             R4 R2
        8 CALL                             R3 1 1
        9 GETUPVAL                         R4 0
       10 GETTABLEKS                       R4 R4 K3 ["MARKETPLACE_KEY"]
       12 JUMPIFNOTEQ                      R3 R4 ; [+10]
       14 GETUPVAL                         R4 1
       15 GETTABLEKS                       R4 R4 K4 ["setEventTarget"]
       17 GETUPVAL                         R5 2
       18 GETTABLEKS                       R5 R5 K5 ["ANALYTICS_TARGET"]
       20 GETTABLEKS                       R5 R5 K6 ["WebView"]
       22 CALL                             R4 1 0
...
PROTO_20:
       ...
       23 GETTABLEKS                       R3 R3 K6 ["WebViewManagerContext"]
       25 NAMECALL                         R3 R3 K7 ["get"]
       27 CALL                             R3 1 1
       28 JUMPIFNOT                        R2 ; [+54]
       29 GETTABLEKS                       R5 R0 K0 ["props"]
       31 GETTABLEKS                       R5 R5 K1 ["tutorialAssetIds"]
       33 JUMPIFNOT                        R2 ; [+13]
       ...
       52 GETTABLEKS                       R10 R10 K1 ["tutorialAssetIds"]
       54 JUMPIFNOT                        R10 ; [+5]
       55 GETTABLEKS                       R9 R0 K0 ["props"]
       57 GETTABLEKS                       R9 R9 K1 ["tutorialAssetIds"]
       59 JUMP                             ; [+2]
       60 NEWTABLE                         R9 0 0
       ...
       66 JUMPIFNOT                        R4 ; [+6]
       67 GETUPVAL                         R9 1
       68 GETTABLEKS                       R9 R9 K16 ["TutorialStep"]
       70 GETTABLEKS                       R9 R9 K17 ["SEARCH"]
       72 JUMP                             ; [+5]
       73 GETUPVAL                         R9 1
       74 GETTABLEKS                       R9 R9 K16 ["TutorialStep"]
       76 GETTABLEKS                       R9 R9 K18 ["NONE"]
