...
PROTO_12:
       ...
       38 MOVE                             R13 R3
       39 GETIMPORT                        R12 K11 [type]
       41 CALL                             R12 1 1
       42 JUMPIFNOTEQKS                    R12 K12 ["table"] ; [+3]
       44 GETTABLEN                        R11 R3 1
       45 JUMP                             ; [+1]
       46 MOVE                             R11 R3
       47 JUMPIFNOT                        R11 ; [+3]
       48 GETTABLEKS                       R12 R11 K13 ["UniqueId"]
       50 JUMP                             ; [+1]
       51 LOADNIL                          R12
       52 SETTABLEKS                       R12 R10 K14 ["sourceAssetUniqueId"]
       54 GETUPVAL                         R12 1
       55 CALL                             R12 0 1
       56 JUMPIFNOT                        R12 ; [+10]
       57 GETTABLEKS                       R12 R0 K15 ["senders"]
       59 GETTABLEKS                       R12 R12 K16 ["sendEventDeferred"]
       61 MOVE                             R13 R8
       62 LOADK                            R14 K17 ["Marketplace"]
       63 LOADK                            R15 K18 ["MarketplaceInsert"]
       64 MOVE                             R16 R10
       65 CALL                             R12 4 0
       66 JUMP                             ; [+11]
       67 GETTABLEKS                       R12 R0 K15 ["senders"]
       69 GETTABLEKS                       R12 R12 K16 ["sendEventDeferred"]
       71 GETUPVAL                         R13 2
       72 GETTABLEKS                       R13 R13 K1 ["eventTarget"]
       74 LOADK                            R14 K17 ["Marketplace"]
       75 LOADK                            R15 K18 ["MarketplaceInsert"]
       76 MOVE                             R16 R10
       77 CALL                             R12 4 0
       78 JUMPIFNOTEQKNIL                  R3 ; [+2]
       80 RETURN                           R0 0
       81 GETIMPORT                        R12 K20 [ipairs]
       83 GETUPVAL                         R13 0
       84 GETTABLEKS                       R13 R13 K21 ["InsertRemainsCheckDelays"]
       86 CALL                             R12 1 3
       87 FORGPREP_INEXT                   R12
       88 GETUPVAL                         R17 0
       89 GETTABLEKS                       R17 R17 K22 ["schedule"]
       91 MOVE                             R18 R16
       92 NEWCLOSURE                       R19 P0
       93 CAPTURE                          VAL R3
       94 CAPTURE                          VAL R0
       95 CAPTURE                          VAL R16
       96 CAPTURE                          VAL R10
