...
PROTO_1:
       ...
       70 CALL                             R15 1 1
       71 GETUPVAL                         R16 2
       72 GETTABLEKS                       R16 R16 K11 ["NAME_CHARACTER_LIMIT"]
       ...
       84 CALL                             R14 1 1
       85 GETUPVAL                         R15 2
       86 GETTABLEKS                       R15 R15 K13 ["DESCRIPTION_CHARACTER_LIMIT"]
       88 JUMPIFLE                         R14 R15 ; [+2]
       90 LOADB                            R11 0 +1
       91 LOADB                            R11 1
       92 GETUPVAL                         R14 3
       93 GETTABLEKS                       R14 R14 K14 ["isCatalogAsset"]
       95 MOVE                             R15 R5
       96 CALL                             R14 1 1
       97 JUMPIF                           R14 ; [+6]
       98 GETUPVAL                         R14 3
       99 GETTABLEKS                       R14 R14 K15 ["isUGCBundleType"]
      101 MOVE                             R15 R5
      102 CALL                             R14 1 1
      ...
      113 LENGTH                           R13 R1
      114 GETUPVAL                         R14 2
      115 GETTABLEKS                       R14 R14 K11 ["NAME_CHARACTER_LIMIT"]
      ...
      129 LENGTH                           R12 R2
      130 GETUPVAL                         R13 2
      131 GETTABLEKS                       R13 R13 K13 ["DESCRIPTION_CHARACTER_LIMIT"]
      133 JUMPIFLE                         R12 R13 ; [+2]
      135 LOADB                            R11 0 +1
      136 LOADB                            R11 1
      137 GETUPVAL                         R12 3
      138 GETTABLEKS                       R12 R12 K14 ["isCatalogAsset"]
      140 MOVE                             R13 R5
      141 CALL                             R12 1 1
      142 JUMPIF                           R12 ; [+6]
      143 GETUPVAL                         R12 3
      144 GETTABLEKS                       R12 R12 K15 ["isUGCBundleType"]
      146 MOVE                             R13 R5
      147 CALL                             R12 1 1
      ...
      164 JUMPIFNOT                        R12 ; [+7]
      165 GETUPVAL                         R12 4
      166 GETTABLEKS                       R12 R12 K16 ["isValidAssetMedia"]
      168 MOVE                             R13 R6
      169 CALL                             R12 1 1
      170 JUMPIFNOT                        R12 ; [+1]
      171 MOVE                             R12 R8
      172 GETUPVAL                         R13 2
      173 GETTABLEKS                       R13 R13 K17 ["FLOW_TYPE"]
      175 GETTABLEKS                       R13 R13 K18 ["UPLOAD_FLOW"]
      177 JUMPIFNOTEQ                      R4 R13 ; [+24]
      179 JUMPIFNOTEQKNIL                  R5 ; [+3]
      181 LOADB                            R12 0
      182 RETURN                           R12 1
      183 GETUPVAL                         R13 3
      184 GETTABLEKS                       R13 R13 K14 ["isCatalogAsset"]
      186 MOVE                             R14 R5
      187 CALL                             R13 1 1
      188 JUMPIF                           R13 ; [+6]
      189 GETUPVAL                         R13 3
      190 GETTABLEKS                       R13 R13 K15 ["isUGCBundleType"]
      192 MOVE                             R14 R5
      193 CALL                             R13 1 1
      194 JUMPIFNOT                        R13 ; [+6]
      195 MOVE                             R13 R12
...
MAIN:
       ...
       69 GETTABLEKS                       R11 R0 K3 ["Src"]
       71 GETTABLEKS                       R11 R11 K19 ["Flags"]
       73 GETTABLEKS                       R11 R11 K20 ["getFFlagToolboxFixDescriptionCharCnt"]
       75 CALL                             R10 1 1
       76 NEWTABLE                         R11 8 0
