...
MAIN:
  ...
  GETTABLEKS R3 R4 K9 ["getFFlagToolboxEnableAssetRows"]
  CALL R2 1 1
  GETIMPORT R3 K7 [require]
  GETTABLEKS R7 R0 K4 ["Src"]
  GETTABLEKS R6 R7 K5 ["Util"]
  GETTABLEKS R5 R6 K8 ["SharedFlags"]
  GETTABLEKS R4 R5 K10 ["getFFlagToolboxPillsForCreators"]
  CALL R3 1 1
  GETIMPORT R4 K7 [require]
  GETTABLEKS R8 R0 K4 ["Src"]
  GETTABLEKS R7 R8 K5 ["Util"]
  GETTABLEKS R6 R7 K8 ["SharedFlags"]
  GETTABLEKS R5 R6 K11 ["getFFlagToolboxEnableSearchOptionsRefactor"]
  CALL R4 1 1
  GETIMPORT R5 K7 [require]
  GETTABLEKS R8 R0 K4 ["Src"]
  GETTABLEKS R7 R8 K12 ["Flags"]
  GETTABLEKS R6 R7 K13 ["getFFlagUpdateAlertIcon"]
  CALL R5 1 1
  ...
  GETTABLEKS R9 R7 K16 ["Framework"]
  CALL R8 1 1
  GETIMPORT R9 K7 [require]
  GETTABLEKS R10 R7 K17 ["Cryo"]
  CALL R9 1 1
  GETIMPORT R10 K7 [require]
  GETTABLEKS R11 R7 K18 ["Dash"]
  CALL R10 1 1
  GETIMPORT R11 K7 [require]
  GETTABLEKS R12 R1 K19 ["Colors"]
  CALL R11 1 1
  GETIMPORT R12 K7 [require]
  GETTABLEKS R13 R1 K20 ["isCli"]
  CALL R12 1 1
  GETTABLEKS R15 R8 K21 ["Style"]
  GETTABLEKS R14 R15 K22 ["Themes"]
  GETTABLEKS R13 R14 K23 ["DarkTheme"]
  GETTABLEKS R15 R8 K21 ["Style"]
  GETTABLEKS R14 R15 K24 ["getRawComponentStyle"]
  GETTABLEKS R17 R8 K21 ["Style"]
  GETTABLEKS R16 R17 K22 ["Themes"]
  GETTABLEKS R15 R16 K25 ["LightTheme"]
  GETTABLEKS R18 R8 K21 ["Style"]
  GETTABLEKS R17 R18 K22 ["Themes"]
  GETTABLEKS R16 R17 K26 ["StudioTheme"]
  GETTABLEKS R18 R8 K21 ["Style"]
  GETTABLEKS R17 R18 K19 ["Colors"]
  GETTABLEKS R19 R8 K21 ["Style"]
  GETTABLEKS R18 R19 K27 ["StyleKey"]
  GETTABLEKS R20 R8 K21 ["Style"]
  GETTABLEKS R19 R20 K28 ["ComponentSymbols"]
  GETTABLEKS R21 R8 K5 ["Util"]
  GETTABLEKS R20 R21 K29 ["StyleModifier"]
  GETTABLEKS R22 R8 K30 ["UI"]
  ...
  GETTABLEKS R23 R24 K29 ["StyleModifier"]
