PROTO_0:
        ...
        4 RETURN                           R0 0
        5 GETUPVAL                         R3 0
        6 GETTABLEKS                       R3 R3 K0 ["isUGCBundleType"]
        8 MOVE                             R4 R1
        9 CALL                             R3 1 1
       10 JUMPIFNOTEQKB                    R3 FALSE ; [+2]
       12 RETURN                           R0 0
       13 GETUPVAL                         R3 0
       14 GETTABLEKS                       R3 R3 K1 ["getAllowedAssetTypesByBundleType"]
       16 MOVE                             R4 R2
       17 MOVE                             R5 R1
       18 CALL                             R3 2 1
       ...
       25 FORGPREP_NEXT                    R4
       26 GETUPVAL                         R12 1
       27 GETTABLEKS                       R12 R12 K5 ["UGC_BODY_PART_NAMES_TO_ASSET_TYPE"]
       ...
       36 LOADB                            R9 1
       37 GETUPVAL                         R13 1
       38 GETTABLEKS                       R13 R13 K7 ["UGC_BUNDLE_PART_NAMES_TO_ASSET_TYPE"]
       ...
       63 FORGLOOP                         R4 2 ; [-38]
       65 GETUPVAL                         R4 0
       66 GETTABLEKS                       R4 R4 K12 ["sanitizeForValidation"]
       68 MOVE                             R5 R0
       69 CALL                             R4 1 0
       70 RETURN                           R0 0
...
MAIN:
       ...
       22 GETTABLEKS                       R3 R3 K9 ["AssetConfigUtil"]
       24 CALL                             R2 1 1
       25 NEWTABLE                         R3 1 0
