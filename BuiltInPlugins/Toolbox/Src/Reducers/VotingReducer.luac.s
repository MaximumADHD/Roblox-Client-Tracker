PROTO_0:
        ...
        3 LOADB                            R3 1
        4 GETUPVAL                         R4 0
        5 GETTABLEKS                       R4 R4 K0 ["Dictionary"]
        7 GETTABLEKS                       R4 R4 K1 ["join"]
        9 MOVE                             R5 R0
       10 NEWTABLE                         R6 1 0
       12 GETUPVAL                         R7 0
       13 GETTABLEKS                       R7 R7 K0 ["Dictionary"]
       15 GETTABLEKS                       R7 R7 K1 ["join"]
...
PROTO_1:
       ...
       36 ADDK                             R6 R6 K5 [1]
       37 GETUPVAL                         R7 0
       38 GETTABLEKS                       R7 R7 K6 ["Dictionary"]
       40 GETTABLEKS                       R7 R7 K7 ["join"]
       42 MOVE                             R8 R0
       43 NEWTABLE                         R9 1 0
       45 GETUPVAL                         R10 0
...
PROTO_2:
       ...
       17 SUBK                             R5 R5 K5 [1]
       18 GETUPVAL                         R6 0
       19 GETTABLEKS                       R6 R6 K6 ["Dictionary"]
       21 GETTABLEKS                       R6 R6 K7 ["join"]
       23 MOVE                             R7 R0
       24 NEWTABLE                         R8 1 0
       26 GETUPVAL                         R9 0
...
PROTO_3:
        ...
        2 NEWTABLE                         R2 0 0
        4 GETUPVAL                         R3 0
        5 GETTABLEKS                       R3 R3 K0 ["Dictionary"]
...
PROTO_4:
        ...
        2 NEWTABLE                         R4 0 0
        4 GETUPVAL                         R5 0
        5 GETTABLEKS                       R5 R5 K0 ["Dictionary"]
        7 GETTABLEKS                       R5 R5 K1 ["join"]
        9 MOVE                             R6 R0
       10 NEWTABLE                         R7 1 0
       12 GETUPVAL                         R8 0
       13 GETTABLEKS                       R8 R8 K0 ["Dictionary"]
       15 GETTABLEKS                       R8 R8 K1 ["join"]
       17 MOVE                             R9 R4
...
PROTO_5:
        ...
        6 CALL                             R3 1 3
        7 FORGPREP_INEXT                   R3
        8 GETTABLEKS                       R9 R7 K3 ["Asset"]
       10 GETTABLEKS                       R9 R9 K4 ["Id"]
       12 GETTABLE                         R8 R0 R9
       13 GETTABLEKS                       R9 R7 K3 ["Asset"]
       15 GETTABLEKS                       R9 R9 K4 ["Id"]
       17 GETTABLEKS                       R10 R7 K5 ["Voting"]
       19 SETTABLE                         R10 R2 R9
       20 FORGLOOP                         R3 2 [inext] ; [-13]
       22 GETUPVAL                         R3 0
       23 GETTABLEKS                       R3 R3 K6 ["Dictionary"]
       25 GETTABLEKS                       R3 R3 K7 ["join"]
       27 MOVE                             R4 R0
       28 MOVE                             R5 R2
       29 CALL                             R3 2 -1
       30 RETURN                           R3 -1
...
MAIN:
       ...
       27 GETTABLEKS                       R5 R5 K10 ["GetAssets"]
       29 CALL                             R4 1 1
       30 GETIMPORT                        R5 K5 [require]
       32 GETTABLEKS                       R6 R0 K8 ["Src"]
       34 GETTABLEKS                       R6 R6 K9 ["Actions"]
       36 GETTABLEKS                       R6 R6 K11 ["GetVote"]
       38 CALL                             R5 1 1
       39 GETIMPORT                        R6 K5 [require]
       41 GETTABLEKS                       R7 R0 K8 ["Src"]
       43 GETTABLEKS                       R7 R7 K9 ["Actions"]
       45 GETTABLEKS                       R7 R7 K12 ["GetAssetsVotingData"]
       47 CALL                             R6 1 1
       48 GETIMPORT                        R7 K5 [require]
       50 GETTABLEKS                       R8 R0 K8 ["Src"]
       52 GETTABLEKS                       R8 R8 K9 ["Actions"]
       54 GETTABLEKS                       R8 R8 K13 ["PostInsertAsset"]
       56 CALL                             R7 1 1
       57 GETIMPORT                        R8 K5 [require]
       59 GETTABLEKS                       R9 R0 K8 ["Src"]
       61 GETTABLEKS                       R9 R9 K9 ["Actions"]
       63 GETTABLEKS                       R9 R9 K14 ["PostUnvote"]
       65 CALL                             R8 1 1
       66 GETIMPORT                        R9 K5 [require]
       68 GETTABLEKS                       R10 R0 K8 ["Src"]
       70 GETTABLEKS                       R10 R10 K9 ["Actions"]
       72 GETTABLEKS                       R10 R10 K15 ["PostVote"]
       74 CALL                             R9 1 1
       75 GETIMPORT                        R10 K5 [require]
       77 GETTABLEKS                       R11 R0 K8 ["Src"]
       79 GETTABLEKS                       R11 R11 K9 ["Actions"]
       81 GETTABLEKS                       R11 R11 K16 ["SetVoteLoading"]
       83 CALL                             R10 1 1
