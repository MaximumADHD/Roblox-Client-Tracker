PROTO_0:
        0 JUMPIF                           R1 ; [+10]
        1 GETUPVAL                         R4 0
        2 GETTABLEKS                       R4 R4 K0 ["shouldDebugWarnings"]
        4 CALL                             R4 0 1
        5 JUMPIFNOT                        R4 ; [+4]
       ...
       16 GETUPVAL                         R7 1
       17 GETTABLEKS                       R7 R7 K6 ["None"]
       19 SETTABLEKS                       R7 R6 K4 ["Voting"]
       21 GETIMPORT                        R7 K8 [ipairs]
       23 MOVE                             R8 R1
       24 CALL                             R7 1 3
       25 FORGPREP_INEXT                   R7
       26 GETTABLEKS                       R12 R11 K9 ["Asset"]
       28 GETTABLEKS                       R12 R12 K10 ["Id"]
       30 LENGTH                           R14 R5
       ...
       38 ADD                              R15 R14 R13
       39 GETUPVAL                         R17 2
       40 GETTABLEKS                       R17 R17 K14 ["round"]
       42 GETUPVAL                         R19 3
       43 GETTABLEKS                       R19 R19 K15 ["TOOLBOX_ITEM_SEARCH_LIMIT"]
       45 DIV                              R18 R14 R19
       46 LOADN                            R19 0
       47 CALL                             R17 2 1
       ...
       52 NEWTABLE                         R17 0 0
       54 GETUPVAL                         R18 1
       55 GETTABLEKS                       R18 R18 K17 ["Dictionary"]
       57 GETTABLEKS                       R18 R18 K18 ["join"]
       59 MOVE                             R19 R17
       ...
       70 GETUPVAL                         R18 1
       71 GETTABLEKS                       R18 R18 K17 ["Dictionary"]
       73 GETTABLEKS                       R18 R18 K18 ["join"]
       75 MOVE                             R19 R11
       76 MOVE                             R20 R6
       77 CALL                             R18 2 1
       ...
       97 JUMPIFNOT                        R3 ; [+7]
       98 GETUPVAL                         R10 4
       99 GETTABLEKS                       R10 R10 K27 ["isNextPageAvailable"]
      101 MOVE                             R11 R3
      102 CALL                             R10 1 1
      103 NOT                              R9 R10
      104 JUMP                             ; [+23]
      ...
      127 MOVE                             R9 R11
      128 GETUPVAL                         R10 1
      129 GETTABLEKS                       R10 R10 K17 ["Dictionary"]
      131 GETTABLEKS                       R10 R10 K18 ["join"]
      133 MOVE                             R11 R0
      134 DUPTABLE                         R12 K32 [{"idToAssetMap", "idsToRender", "totalAssets", "assetsReceived", "hasReachedBottom", "currentCursor"}]
      135 GETUPVAL                         R13 1
      136 GETTABLEKS                       R13 R13 K17 ["Dictionary"]
      138 GETTABLEKS                       R13 R13 K18 ["join"]
      ...
      149 GETUPVAL                         R13 1
      150 GETTABLEKS                       R13 R13 K33 ["List"]
      152 GETTABLEKS                       R13 R13 K18 ["join"]
      ...
      170 JUMPIF                           R13 ; [+4]
      171 GETUPVAL                         R13 4
      172 GETTABLEKS                       R13 R13 K34 ["createDefaultCursor"]
      174 CALL                             R13 0 1
...
PROTO_4:
       ...
       32 CALL                             R3 2 1
       33 GETUPVAL                         R4 0
       34 GETTABLEKS                       R4 R4 K3 ["Dictionary"]
       36 GETTABLEKS                       R4 R4 K4 ["join"]
       ...
       52 GETUPVAL                         R6 0
       53 GETTABLEKS                       R6 R6 K3 ["Dictionary"]
       55 GETTABLEKS                       R6 R6 K4 ["join"]
       57 MOVE                             R7 R0
       58 DUPTABLE                         R8 K9 [{"idToAssetMap"}]
       59 GETUPVAL                         R9 0
       60 GETTABLEKS                       R9 R9 K3 ["Dictionary"]
       62 GETTABLEKS                       R9 R9 K4 ["join"]
...
PROTO_14:
       ...
       16 JUMPIFNOT                        R2 ; [+26]
       17 GETUPVAL                         R3 0
       18 GETTABLEKS                       R3 R3 K2 ["Dictionary"]
       20 GETTABLEKS                       R3 R3 K3 ["join"]
       22 MOVE                             R4 R0
       23 DUPTABLE                         R5 K4 [{"idToAssetMap"}]
       24 GETUPVAL                         R6 0
       25 GETTABLEKS                       R6 R6 K2 ["Dictionary"]
       27 GETTABLEKS                       R6 R6 K3 ["join"]
...
MAIN:
       ...
       44 CALL                             R8 1 1
       45 GETTABLEKS                       R9 R8 K9 ["Util"]
       47 GETTABLEKS                       R9 R9 K14 ["Math"]
       49 GETTABLEKS                       R10 R0 K8 ["Src"]
       51 GETTABLEKS                       R10 R10 K15 ["Actions"]
       53 GETIMPORT                        R11 K5 [require]
       55 GETTABLEKS                       R12 R10 K16 ["ClearAssets"]
       57 CALL                             R11 1 1
       58 GETIMPORT                        R12 K5 [require]
       60 GETTABLEKS                       R13 R0 K8 ["Src"]
       62 GETTABLEKS                       R13 R13 K15 ["Actions"]
       64 GETTABLEKS                       R13 R13 K17 ["SetAssetMediaIds"]
       66 CALL                             R12 1 1
      ...
      126 GETTABLEKS                       R25 R25 K15 ["Actions"]
      128 GETTABLEKS                       R25 R25 K29 ["UpdateAssetData"]
      130 CALL                             R24 1 1
      131 GETIMPORT                        R25 K5 [require]
      133 GETTABLEKS                       R26 R0 K8 ["Src"]
      135 GETTABLEKS                       R26 R26 K9 ["Util"]
      137 GETTABLEKS                       R26 R26 K30 ["SharedFlags"]
      139 GETTABLEKS                       R26 R26 K31 ["getFFlagToolboxCodeUnderstandingSummary"]
      141 CALL                             R25 1 1
