...
PROTO_2:
        ...
        2 LOADN                            R4 50
        3 MOVE                             R5 R0
        4 NAMECALL                         R1 R1 K0 ["getVersionHistory"]
        6 CALL                             R1 4 1
        7 NEWCLOSURE                       R3 P0
        8 CAPTURE                          UPVAL U2
        9 CAPTURE                          UPVAL U3
...
PROTO_3:
        ...
        7 LOADN                            R6 50
        8 MOVE                             R7 R2
        9 NAMECALL                         R3 R3 K1 ["getVersionHistory"]
       11 CALL                             R3 4 1
       12 NEWCLOSURE                       R5 P0
       13 CAPTURE                          UPVAL U2
       14 CAPTURE                          UPVAL U3
       ...
       23 RETURN                           R1 -1
       24 GETUPVAL                         R1 5
       25 GETTABLEKS                       R1 R1 K3 ["resolve"]
       27 MOVE                             R2 R0
       28 CALL                             R1 1 -1
       29 RETURN                           R1 -1
...
PROTO_8:
       ...
       15 LOADN                            R9 50
       16 LOADNIL                          R10
       17 NAMECALL                         R6 R0 K0 ["getVersionHistory"]
       19 CALL                             R6 4 1
       20 NEWCLOSURE                       R8 P2
       21 CAPTURE                          UPVAL U0
       22 CAPTURE                          VAL R3
...
PROTO_9:
        0 GETTABLEKS                       R3 R0 K0 ["assetVersionNumber"]
        2 GETTABLEKS                       R4 R1 K0 ["assetVersionNumber"]
        4 JUMPIFLT                         R4 R3 ; [+2]
        6 LOADB                            R2 0 +1
        7 LOADB                            R2 1
        8 RETURN                           R2 1
...
PROTO_10:
        ...
        9 GETTABLEKS                       R4 R2 K5 ["data"]
       11 DUPCLOSURE                       R5 K6 [PROTO_9]
       12 CALL                             R3 2 0
       13 GETUPVAL                         R3 1
       14 GETUPVAL                         R5 2
       15 GETTABLEKS                       R6 R2 K5 ["data"]
       17 CALL                             R5 1 -1
       18 NAMECALL                         R3 R3 K7 ["dispatch"]
       20 CALL                             R3 -1 0
       21 RETURN                           R0 0
...
PROTO_12:
        0 MOVE                             R5 R1
        1 NAMECALL                         R3 R0 K0 ["getVersionHistoryWithNotes"]
        3 CALL                             R3 2 1
        4 NEWCLOSURE                       R5 P0
        5 CAPTURE                          UPVAL U0
        6 CAPTURE                          VAL R2
...
MAIN:
       ...
       32 GETTABLEKS                       R4 R4 K12 ["SetPackageDescriptions"]
       34 CALL                             R3 1 1
       35 GETIMPORT                        R4 K8 [require]
       37 GETTABLEKS                       R5 R0 K9 ["Src"]
       39 GETTABLEKS                       R5 R5 K10 ["Actions"]
       41 GETTABLEKS                       R5 R5 K13 ["SetVersionHistoryData"]
       43 CALL                             R4 1 1
       44 GETIMPORT                        R5 K8 [require]
       46 GETTABLEKS                       R6 R0 K9 ["Src"]
       48 GETTABLEKS                       R6 R6 K10 ["Actions"]
       50 GETTABLEKS                       R6 R6 K14 ["SetVersionHistoryWithDescriptions"]
       52 CALL                             R5 1 1
       53 GETIMPORT                        R6 K8 [require]
       55 GETTABLEKS                       R7 R0 K9 ["Src"]
       57 GETTABLEKS                       R7 R7 K15 ["Flags"]
       59 GETTABLEKS                       R7 R7 K16 ["getFFlagFetchFullVersionHistoryWithVersionNotesV2"]
       61 CALL                             R6 1 1
       62 GETIMPORT                        R7 K8 [require]
       64 GETTABLEKS                       R8 R0 K17 ["Packages"]
       66 GETTABLEKS                       R8 R8 K18 ["Framework"]
       68 CALL                             R7 1 1
       69 GETTABLEKS                       R8 R7 K19 ["Util"]
       71 GETTABLEKS                       R8 R8 K20 ["Promise"]
       73 DUPCLOSURE                       R9 K21 [PROTO_0]
       74 DUPCLOSURE                       R10 K22 [PROTO_8]
       75 CAPTURE                          VAL R1
       76 CAPTURE                          VAL R8
       77 CAPTURE                          VAL R9
       78 CAPTURE                          VAL R3
       79 CAPTURE                          VAL R4
       80 CAPTURE                          VAL R2
       81 DUPCLOSURE                       R11 K23 [PROTO_12]
       82 CAPTURE                          VAL R1
       83 CAPTURE                          VAL R5
       84 CAPTURE                          VAL R2
       85 DUPCLOSURE                       R12 K24 [PROTO_14]
       86 CAPTURE                          VAL R6
       87 CAPTURE                          VAL R11
       88 CAPTURE                          VAL R10
       89 RETURN                           R12 1
