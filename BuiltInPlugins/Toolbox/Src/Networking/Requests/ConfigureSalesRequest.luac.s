...
PROTO_2:
        ...
        6 GETUPVAL                         R4 3
        7 GETUPVAL                         R5 4
        8 GETTABLEKS                       R5 R5 K1 ["ASSET_STATUS"]
       10 GETTABLEKS                       R5 R5 K2 ["OnSale"]
       12 JUMPIFEQ                         R4 R5 ; [+2]
       14 LOADB                            R3 0 +1
       15 LOADB                            R3 1
       16 JUMPIFNOT                        R3 ; [+6]
       17 GETUPVAL                         R4 4
       18 GETTABLEKS                       R4 R4 K1 ["ASSET_STATUS"]
       20 GETTABLEKS                       R4 R4 K2 ["OnSale"]
       22 JUMPIF                           R4 ; [+5]
       23 GETUPVAL                         R4 4
       24 GETTABLEKS                       R4 R4 K1 ["ASSET_STATUS"]
       26 GETTABLEKS                       R4 R4 K3 ["OffSale"]
       28 JUMPIFNOT                        R3 ; [+2]
       29 GETUPVAL                         R5 5
       30 JUMPIF                           R5 ; [+1]
       31 LOADNIL                          R5
       ...
       49 GETUPVAL                         R6 6
       50 GETUPVAL                         R7 4
       51 GETTABLEKS                       R7 R7 K1 ["ASSET_STATUS"]
       53 GETTABLEKS                       R7 R7 K2 ["OnSale"]
...
MAIN:
       ...
       17 GETTABLEKS                       R2 R2 K7 ["AssetConfigConstants"]
       19 CALL                             R1 1 1
       ...
       35 GETTABLEKS                       R4 R4 K10 ["UploadResult"]
       37 CALL                             R3 1 1
