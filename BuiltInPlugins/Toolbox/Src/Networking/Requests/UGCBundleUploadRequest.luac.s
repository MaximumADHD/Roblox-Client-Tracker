...
MAIN:
  ...
  CALL R27 1 1
  DUPTABLE R28 K44 [{"bundlePartsUploadError", "bundleUploadAssetsStep"}]
  DUPTABLE R29 K48 [{"Body", "DynamicHead", "Shoes"}]
  LOADK R30 K49 ["BundlePartsUploadError"]
  SETTABLEKS R30 R29 K45 ["Body"]
  LOADK R30 K49 ["BundlePartsUploadError"]
  SETTABLEKS R30 R29 K46 ["DynamicHead"]
  LOADK R30 K50 ["ShoesBundlePartsUploadError"]
  SETTABLEKS R30 R29 K47 ["Shoes"]
  SETTABLEKS R29 R28 K42 ["bundlePartsUploadError"]
  DUPTABLE R29 K48 [{"Body", "DynamicHead", "Shoes"}]
  LOADK R30 K51 ["BundleUploadAssetsStep"]
  SETTABLEKS R30 R29 K45 ["Body"]
  LOADK R30 K51 ["BundleUploadAssetsStep"]
  SETTABLEKS R30 R29 K46 ["DynamicHead"]
  LOADK R30 K52 ["ShoesBundleUploadAssetsStep"]
  SETTABLEKS R30 R29 K47 ["Shoes"]
  SETTABLEKS R29 R28 K43 ["bundleUploadAssetsStep"]
  DUPCLOSURE R29 K53 [PROTO_0]
  DUPCLOSURE R30 K54 [PROTO_1]
  DUPCLOSURE R31 K55 [PROTO_2]
  DUPCLOSURE R32 K56 [PROTO_3]
  DUPCLOSURE R33 K57 [PROTO_4]
  DUPCLOSURE R34 K58 [PROTO_5]
  CAPTURE VAL R23
  CAPTURE VAL R24
  CAPTURE VAL R22
  CAPTURE VAL R25
