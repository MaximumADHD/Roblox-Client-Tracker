...
MAIN:
  ...
  GETTABLEKS R8 R9 K20 ["getFFlagRemoveItemTags"]
  CALL R7 1 1
  ...
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K93 ["getAllowedItemTypes"]
  MOVE R19 R5
  CALL R19 0 1
  JUMPIFNOT R19 [+4]
  DUPCLOSURE R19 K94 [PROTO_36]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K95 ["getUploadPermissionStatus"]
  MOVE R19 R7
  CALL R19 0 1
  JUMPIF R19 [+4]
  DUPCLOSURE R19 K96 [PROTO_37]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K97 ["getTagsMetadata"]
  DUPCLOSURE R19 K98 [PROTO_38]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K99 ["uploadCatalogItem"]
  DUPCLOSURE R19 K100 [PROTO_39]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K101 ["uploadCatalogItemFormat"]
  DUPCLOSURE R19 K102 [PROTO_40]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K103 ["getCreatorMarketplaceQuotas"]
  DUPCLOSURE R19 K104 [PROTO_41]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K105 ["getPublishingRequirements"]
  DUPCLOSURE R19 K106 [PROTO_42]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K107 ["getThumbnailStatus"]
  DUPCLOSURE R19 K108 [PROTO_43]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K109 ["getIsVerifiedCreator"]
  DUPCLOSURE R19 K110 [PROTO_44]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K111 ["getHomeConfiguration"]
  DUPCLOSURE R19 K112 [PROTO_45]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K113 ["getUniverseInfo"]
  DUPCLOSURE R19 K114 [PROTO_46]
  CAPTURE VAL R3
  CAPTURE VAL R11
  SETTABLEKS R19 R12 K115 ["purchaseAsset"]
  DUPCLOSURE R19 K116 [PROTO_47]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K117 ["getDefaultCreateBundleDataSharing"]
  DUPCLOSURE R19 K118 [PROTO_48]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K119 ["postCreateBundleDataSharing"]
  DUPCLOSURE R19 K120 [PROTO_49]
  CAPTURE VAL R3
  CAPTURE VAL R9
  SETTABLEKS R19 R12 K121 ["getPurchaserStatus"]
  DUPCLOSURE R19 K122 [PROTO_50]
  CAPTURE VAL R3
  CAPTURE VAL R10
  SETTABLEKS R19 R12 K123 ["getFiatProduct"]
  DUPCLOSURE R19 K124 [PROTO_51]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K125 ["getIsOwnedByUser"]
  DUPCLOSURE R19 K126 [PROTO_52]
  SETTABLEKS R19 R12 K127 ["getIsAssetOpenForUse"]
  DUPCLOSURE R19 K128 [PROTO_53]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K129 ["getPluginInfo"]
  DUPCLOSURE R19 K130 [PROTO_54]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K131 ["getItemUploadFee"]
  DUPCLOSURE R19 K132 [PROTO_55]
  CAPTURE VAL R3
  CAPTURE VAL R1
  SETTABLEKS R19 R12 K133 ["getDevelopAssetMetadata"]
  DUPCLOSURE R19 K134 [PROTO_56]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K135 ["getItem"]
  DUPCLOSURE R19 K136 [PROTO_57]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K137 ["getAssetPermissions"]
  RETURN R12 1
