MAIN:
  ...
  GETIMPORT R3 K41 [Color3.new]
  LOADN R4 0
  LOADK R5 K42 [0.7]
  LOADN R6 0
  CALL R3 3 1
  SETTABLEKS R3 R2 K43 ["INSTALL_GREEN"]
  GETIMPORT R3 K41 [Color3.new]
  LOADK R4 K44 [0.9]
  LOADN R5 0
  LOADN R6 0
  CALL R3 3 1
  SETTABLEKS R3 R2 K45 ["INSTALL_RED"]
  GETIMPORT R3 K10 [Color3.fromRGB]
  LOADN R4 60
  LOADN R5 60
  LOADN R6 60
  CALL R3 3 1
  SETTABLEKS R3 R2 K46 ["BUTTON_CTA_BG_DISABLED_DARK"]
  GETIMPORT R3 K10 [Color3.fromRGB]
  LOADN R4 244
  LOADN R5 100
  LOADN R6 93
  CALL R3 3 1
  SETTABLEKS R3 R2 K47 ["WARNING_TEXT_COLOR"]
  MOVE R3 R1
  MOVE R4 R2
  LOADK R5 K48 ["Colors"]
  CALL R3 2 -1
