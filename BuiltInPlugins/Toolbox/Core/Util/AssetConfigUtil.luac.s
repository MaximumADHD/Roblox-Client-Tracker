...
PROTO_38:
  ...
  JUMPIFNOTEQKS R6 K2 ["OriginalPosition"] [+15]
  GETTABLEKS R6 R5 K3 ["Parent"]
  LOADK R8 K4 ["Attachment"]
  ...
  JUMP [+17]
  GETTABLEKS R6 R5 K1 ["Name"]
  JUMPIFNOTEQKS R6 K8 ["OriginalSize"] [+14]
  GETTABLEKS R6 R5 K3 ["Parent"]
...
PROTO_39:
  ...
  JUMPIFNOT R1 [+5]
  GETUPVAL R2 2
  GETTABLEKS R1 R2 K0 ["resetAvatarBodyPartsToOriginalSizeAndPosition"]
  MOVE R2 R0
  CALL R1 1 0
  GETUPVAL R1 3
  MOVE R2 R0
  ...
  JUMPIFEQKS R6 K5 ["OriginalSize"] [+5]
  GETTABLEKS R6 R5 K4 ["Name"]
  JUMPIFNOTEQKS R6 K6 ["OriginalPosition"] [+7]
  ...
  JUMPIFNOT R6 [+8]
  GETTABLEKS R6 R5 K4 ["Name"]
  JUMPIFNOTEQKS R6 K9 ["AccessoryWeld"] [+5]
  NAMECALL R6 R5 K7 ["Destroy"]
  CALL R6 1 0
  JUMP [+30]
  GETUPVAL R6 4
  ...
  CALL R6 2 1
  JUMPIFNOT R6 [+22]
  GETTABLEKS R6 R5 K11 ["Parent"]
  LOADK R8 K12 ["Accessory"]
  NAMECALL R6 R6 K3 ["IsA"]
  CALL R6 2 1
  JUMPIF R6 [+15]
  GETTABLEKS R6 R5 K13 ["TextureID"]
  JUMPIFNOTEQKS R6 K14 [""] [+12]
  LOADK R8 K15 ["SurfaceAppearance"]
  NAMECALL R6 R5 K16 ["FindFirstChildWhichIsA"]
  CALL R6 2 1
  JUMPIF R6 [+6]
  GETIMPORT R6 K19 [Instance.new]
  LOADK R7 K15 ["SurfaceAppearance"]
  CALL R6 1 1
...
MAIN:
  ...
  GETTABLEKS R20 R21 K34 ["getLocalizedAssetTextMap"]
  CALL R19 1 1
  GETIMPORT R20 K6 [require]
  GETTABLEKS R22 R1 K29 ["SharedFlags"]
  GETTABLEKS R21 R22 K35 ["getFFlagEnableUGCUploadFlowAnalytics"]
  CALL R20 1 1
  GETIMPORT R21 K23 [game]
  LOADK R23 K36 ["EnableUGCBundleUnknownMeshPartFiltering"]
  NAMECALL R21 R21 K25 ["GetFastFlag"]
  CALL R21 2 1
  GETIMPORT R22 K6 [require]
  GETTABLEKS R24 R1 K29 ["SharedFlags"]
  GETTABLEKS R23 R24 K37 ["getFFlagEnableUGCBundleUploadBodyScale"]
  CALL R22 1 1
  GETIMPORT R23 K6 [require]
  GETTABLEKS R25 R1 K29 ["SharedFlags"]
  GETTABLEKS R24 R25 K38 ["getFFlagEnableBodyScaleValidationSupport"]
  CALL R23 1 1
  GETIMPORT R24 K23 [game]
  ...
  CAPTURE VAL R2
  SETTABLEKS R27 R26 K43 ["isUGCBundleType"]
  DUPCLOSURE R27 K44 [PROTO_2]
  CAPTURE VAL R2
  SETTABLEKS R27 R26 K45 ["isReadyForSale"]
  DUPCLOSURE R27 K46 [PROTO_3]
  CAPTURE VAL R2
  SETTABLEKS R27 R26 K47 ["isOnSale"]
  DUPCLOSURE R27 K48 [PROTO_4]
  SETTABLEKS R27 R26 K49 ["getMarketplaceFeesPercentage"]
  DUPCLOSURE R27 K50 [PROTO_5]
  CAPTURE VAL R26
  SETTABLEKS R27 R26 K51 ["calculatePotentialEarning"]
  DUPCLOSURE R27 K52 [PROTO_6]
  SETTABLEKS R27 R26 K53 ["getPriceRange"]
  DUPCLOSURE R27 K54 [PROTO_7]
  CAPTURE VAL R26
  SETTABLEKS R27 R26 K55 ["getMinPrice"]
  DUPCLOSURE R27 K56 [PROTO_8]
  CAPTURE VAL R26
  SETTABLEKS R27 R26 K57 ["getPriceInfo"]
  DUPCLOSURE R27 K58 [PROTO_9]
  CAPTURE VAL R10
  SETTABLEKS R27 R26 K59 ["hasAllowedAssetTypesForRelease"]
  DUPCLOSURE R27 K60 [PROTO_10]
  CAPTURE VAL R24
  CAPTURE VAL R2
  CAPTURE VAL R11
  SETTABLEKS R27 R26 K61 ["promptImagePicker"]
  DUPCLOSURE R27 K62 [PROTO_11]
  CAPTURE VAL R2
  SETTABLEKS R27 R26 K63 ["isCatalogAsset"]
  DUPCLOSURE R27 K64 [PROTO_12]
  CAPTURE VAL R2
  SETTABLEKS R27 R26 K65 ["isMarketplaceAsset"]
  DUPCLOSURE R27 K66 [PROTO_13]
  CAPTURE VAL R26
  SETTABLEKS R27 R26 K67 ["isCreatorStoreAssetNotIncludingAnimation"]
  DUPCLOSURE R27 K68 [PROTO_14]
  CAPTURE VAL R2
  SETTABLEKS R27 R26 K69 ["isBuyableMarketplaceAsset"]
  DUPCLOSURE R27 K70 [PROTO_15]
  CAPTURE VAL R2
  CAPTURE VAL R26
  SETTABLEKS R27 R26 K71 ["getFlowStartScreen"]
  DUPCLOSURE R27 K72 [PROTO_16]
  CAPTURE VAL R2
  SETTABLEKS R27 R26 K73 ["getGenreTypes"]
  DUPCLOSURE R27 K74 [PROTO_17]
  CAPTURE VAL R2
  SETTABLEKS R27 R26 K75 ["getGenreIndex"]
  DUPCLOSURE R27 K76 [PROTO_18]
  CAPTURE VAL R2
  SETTABLEKS R27 R26 K77 ["getGenreName"]
  DUPCLOSURE R27 K78 [PROTO_19]
  CAPTURE VAL R4
  SETTABLEKS R27 R26 K79 ["getOwnerDropDownContent"]
  DUPCLOSURE R27 K80 [PROTO_21]
  SETTABLEKS R27 R26 K81 ["getClonedInstances"]
  DUPCLOSURE R27 K82 [PROTO_22]
  CAPTURE VAL R2
  CAPTURE VAL R26
  CAPTURE VAL R12
  SETTABLEKS R27 R26 K83 ["getPreviewType"]
  DUPCLOSURE R27 K84 [PROTO_23]
  CAPTURE VAL R5
  CAPTURE VAL R2
  SETTABLEKS R27 R26 K85 ["getResultThumbnail"]
  DUPCLOSURE R27 K86 [PROTO_24]
  CAPTURE VAL R13
  CAPTURE VAL R14
  CAPTURE VAL R26
  SETTABLEKS R27 R26 K87 ["isPackagePublishAllowed"]
  DUPCLOSURE R27 K88 [PROTO_25]
  SETTABLEKS R27 R26 K89 ["isPackage"]
  DUPCLOSURE R27 K90 [PROTO_26]
  CAPTURE VAL R26
  SETTABLEKS R27 R26 K91 ["getUGCBodyBundleAssetQuantities"]
  DUPCLOSURE R27 K92 [PROTO_28]
  CAPTURE VAL R22
  SETTABLEKS R27 R26 K93 ["getBodyScaleValues"]
  DUPCLOSURE R27 K94 [PROTO_29]
  CAPTURE VAL R2
  SETTABLEKS R27 R26 K95 ["getUGCBundleTypeFromString"]
  DUPCLOSURE R27 K96 [PROTO_30]
  CAPTURE VAL R7
  SETTABLEKS R27 R26 K97 ["getAllowedAssetTypeSettingsForBundle"]
  DUPCLOSURE R27 K98 [PROTO_31]
  CAPTURE VAL R26
  CAPTURE VAL R2
  SETTABLEKS R27 R26 K99 ["getAllowedAssetTypeEnumsForBundle"]
  DUPCLOSURE R27 K100 [PROTO_32]
  CAPTURE VAL R26
  CAPTURE VAL R2
  SETTABLEKS R27 R26 K101 ["getAllowedAssetTypeEnumsForBundleWithSettings"]
  DUPCLOSURE R27 K102 [PROTO_33]
  SETTABLEKS R27 R26 K103 ["isAllowedUGCAssetType"]
  DUPCLOSURE R27 K104 [PROTO_34]
  CAPTURE VAL R26
  CAPTURE VAL R2
  CAPTURE VAL R9
  SETTABLEKS R27 R26 K105 ["getUGCBodyPartsAssetTypeMap"]
  DUPCLOSURE R27 K106 [PROTO_35]
  SETTABLEKS R27 R26 K107 ["AssetTypeRequiresFolderForUpload"]
  DUPCLOSURE R27 K108 [PROTO_36]
  CAPTURE VAL R26
  SETTABLEKS R27 R26 K109 ["createUGCBodyPartFolders"]
  DUPCLOSURE R27 K110 [PROTO_37]
  CAPTURE VAL R2
  SETTABLEKS R27 R26 K111 ["getLocalizedUGCBundleName"]
  DUPCLOSURE R27 K112 [PROTO_38]
  CAPTURE VAL R23
  SETTABLEKS R27 R26 K113 ["resetAvatarBodyPartsToOriginalSizeAndPosition"]
  DUPCLOSURE R27 K114 [PROTO_39]
  CAPTURE VAL R17
  CAPTURE VAL R23
  CAPTURE VAL R26
  CAPTURE VAL R3
  CAPTURE VAL R16
  SETTABLEKS R27 R26 K115 ["sanitizeForValidation"]
  MOVE R27 R18
  CALL R27 0 1
  JUMPIFNOT R27 [+8]
  DUPCLOSURE R27 K116 [PROTO_40]
  CAPTURE VAL R26
  SETTABLEKS R27 R26 K117 ["getOptionalAssetTypesForBundle"]
  DUPCLOSURE R27 K118 [PROTO_41]
  CAPTURE VAL R26
  SETTABLEKS R27 R26 K119 ["getOptionalBodyPartsNotFound"]
  JUMPIFNOT R21 [+8]
  DUPCLOSURE R27 K120 [PROTO_42]
  CAPTURE VAL R26
  SETTABLEKS R27 R26 K121 ["getAllowedAssetTypesByBundleType"]
  DUPCLOSURE R27 K122 [PROTO_43]
  CAPTURE VAL R2
  SETTABLEKS R27 R26 K123 ["getUnknownMeshPartNames"]
  DUPCLOSURE R27 K124 [PROTO_44]
  CAPTURE VAL R26
  SETTABLEKS R27 R26 K125 ["getAvatarAssetTypeAsString"]
  RETURN R26 1
