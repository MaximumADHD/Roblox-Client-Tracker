...
MAIN:
  ...
  DUPCLOSURE R26 K91 [PROTO_28]
  CAPTURE VAL R22
  SETTABLEKS R26 R25 K92 ["getBodyScaleValues"]
  DUPCLOSURE R26 K93 [PROTO_29]
  CAPTURE VAL R2
  SETTABLEKS R26 R25 K94 ["getUGCBundleTypeFromString"]
  DUPCLOSURE R26 K95 [PROTO_30]
  CAPTURE VAL R7
  SETTABLEKS R26 R25 K96 ["getAllowedAssetTypeSettingsForBundle"]
  DUPCLOSURE R26 K97 [PROTO_31]
  CAPTURE VAL R25
  CAPTURE VAL R2
  SETTABLEKS R26 R25 K98 ["getAllowedAssetTypeEnumsForBundle"]
  DUPCLOSURE R26 K99 [PROTO_32]
  CAPTURE VAL R25
  CAPTURE VAL R2
  SETTABLEKS R26 R25 K100 ["getAllowedAssetTypeEnumsForBundleWithSettings"]
  DUPCLOSURE R26 K101 [PROTO_33]
  SETTABLEKS R26 R25 K102 ["isAllowedUGCAssetType"]
  DUPCLOSURE R26 K103 [PROTO_34]
  CAPTURE VAL R25
  CAPTURE VAL R2
  CAPTURE VAL R9
  SETTABLEKS R26 R25 K104 ["getUGCBodyPartsAssetTypeMap"]
  DUPCLOSURE R26 K105 [PROTO_35]
  SETTABLEKS R26 R25 K106 ["AssetTypeRequiresFolderForUpload"]
  DUPCLOSURE R26 K107 [PROTO_36]
  CAPTURE VAL R25
  SETTABLEKS R26 R25 K108 ["createUGCBodyPartFolders"]
  DUPCLOSURE R26 K109 [PROTO_37]
  CAPTURE VAL R2
  SETTABLEKS R26 R25 K110 ["getLocalizedUGCBundleName"]
  DUPCLOSURE R26 K111 [PROTO_38]
  CAPTURE VAL R17
  CAPTURE VAL R3
  CAPTURE VAL R16
  SETTABLEKS R26 R25 K112 ["sanitizeForValidation"]
  MOVE R26 R18
  CALL R26 0 1
  JUMPIFNOT R26 [+8]
  DUPCLOSURE R26 K113 [PROTO_39]
  CAPTURE VAL R25
  SETTABLEKS R26 R25 K114 ["getOptionalAssetTypesForBundle"]
  DUPCLOSURE R26 K115 [PROTO_40]
  CAPTURE VAL R25
  SETTABLEKS R26 R25 K116 ["getOptionalBodyPartsNotFound"]
  JUMPIFNOT R21 [+8]
  DUPCLOSURE R26 K117 [PROTO_41]
  CAPTURE VAL R25
  SETTABLEKS R26 R25 K118 ["getAllowedAssetTypesByBundleType"]
  DUPCLOSURE R26 K119 [PROTO_42]
  CAPTURE VAL R2
  SETTABLEKS R26 R25 K120 ["getUnknownMeshPartNames"]
  DUPCLOSURE R26 K121 [PROTO_43]
  CAPTURE VAL R25
  SETTABLEKS R26 R25 K122 ["getAvatarAssetTypeAsString"]
  RETURN R25 1
