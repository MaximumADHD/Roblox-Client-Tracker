...
MAIN:
  ...
  GETTABLEKS R9 R10 K16 ["getFFlagToolboxAddAssetConfigPriceRedirectLink"]
  CALL R8 1 1
  NEWTABLE R9 16 0
  DUPCLOSURE R10 K17 [PROTO_0]
  CAPTURE VAL R6
  SETTABLEKS R10 R9 K18 ["getCurrentTab"]
  DUPCLOSURE R10 K19 [PROTO_1]
  CAPTURE VAL R6
  CAPTURE VAL R4
  SETTABLEKS R10 R9 K20 ["getCategory"]
  DUPCLOSURE R10 K21 [PROTO_2]
  CAPTURE VAL R9
  SETTABLEKS R10 R9 K22 ["getCategoryForPageInfo"]
  DUPCLOSURE R10 K23 [PROTO_3]
  CAPTURE VAL R4
  SETTABLEKS R10 R9 K24 ["getSortType"]
  DUPCLOSURE R10 K25 [PROTO_4]
  CAPTURE VAL R9
  SETTABLEKS R10 R9 K26 ["getSortTypeForPageInfo"]
  DUPCLOSURE R10 K27 [PROTO_5]
  CAPTURE VAL R4
  SETTABLEKS R10 R9 K28 ["getGroupId"]
  DUPCLOSURE R10 K29 [PROTO_6]
  CAPTURE VAL R9
  SETTABLEKS R10 R9 K30 ["getGroupIdForPageInfo"]
  DUPCLOSURE R10 K31 [PROTO_7]
  CAPTURE VAL R6
  CAPTURE VAL R4
  SETTABLEKS R10 R9 K32 ["getEngineAssetTypeForPageInfoCategory"]
  DUPCLOSURE R10 K33 [PROTO_8]
  CAPTURE VAL R9
  SETTABLEKS R10 R9 K34 ["getBackendNameForPageInfoCategory"]
  DUPCLOSURE R10 K35 [PROTO_9]
  CAPTURE VAL R9
  CAPTURE VAL R5
  SETTABLEKS R10 R9 K36 ["isDeveloperCategory"]
  DUPCLOSURE R10 K37 [PROTO_10]
  CAPTURE VAL R9
  CAPTURE VAL R5
  SETTABLEKS R10 R9 K38 ["isPackagesCategory"]
  DUPCLOSURE R10 K39 [PROTO_11]
  CAPTURE VAL R9
  CAPTURE VAL R6
  SETTABLEKS R10 R9 K40 ["getRequestInfo"]
  DUPCLOSURE R10 K41 [PROTO_12]
  CAPTURE VAL R9
  CAPTURE VAL R3
  SETTABLEKS R10 R9 K42 ["isPageInfoStale"]
  RETURN R9 1
