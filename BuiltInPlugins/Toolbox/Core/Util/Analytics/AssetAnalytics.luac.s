...
PROTO_10:
  GETUPVAL R4 0
  GETTABLEKS R3 R4 K0 ["isAssetTrackable"]
  MOVE R4 R1
  MOVE R5 R2
  CALL R3 2 1
  JUMPIF R3 [+1]
  RETURN R0 0
  GETTABLEKS R4 R0 K1 ["senders"]
  GETTABLEKS R3 R4 K2 ["sendEventDeferred"]
  LOADK R4 K3 ["studio"]
  LOADK R5 K4 ["Marketplace"]
  LOADK R6 K5 ["MarketplaceAssetPreview"]
  GETUPVAL R8 0
  GETTABLEKS R7 R8 K6 ["getTrackingAttributes"]
  MOVE R8 R1
  MOVE R9 R2
  CALL R7 2 -1
  CALL R3 -1 0
...
MAIN:
  ...
  GETTABLEKS R12 R10 K20 ["AssetSubTypes"]
  CALL R11 1 1
  ...
  GETTABLEKS R14 R15 K22 ["Senders"]
  CALL R13 1 1
  GETIMPORT R14 K9 [require]
  GETTABLEKS R18 R1 K13 ["Core"]
  GETTABLEKS R17 R18 K14 ["Util"]
  GETTABLEKS R16 R17 K23 ["SharedFlags"]
  GETTABLEKS R15 R16 K24 ["getFFlagToolboxListviewAnalytics"]
  CALL R14 1 1
  NEWTABLE R15 32 0
  ...
  LOADN R19 88
  SETLIST R16 R17 3 [1]
  SETTABLEKS R16 R15 K26 ["InsertRemainsCheckDelays"]
  ...
  CAPTURE VAL R0
  SETTABLEKS R16 R15 K32 ["getNavigationContext"]
  DUPCLOSURE R16 K33 [PROTO_4]
  SETTABLEKS R16 R15 K34 ["schedule"]
  DUPCLOSURE R16 K35 [PROTO_5]
  SETTABLEKS R16 R15 K36 ["getAssetCategoryName"]
  DUPCLOSURE R16 K37 [PROTO_6]
  SETTABLEKS R16 R15 K38 ["isAssetDataTrackable"]
  DUPCLOSURE R16 K39 [PROTO_7]
  CAPTURE VAL R15
  SETTABLEKS R16 R15 K40 ["isAssetTrackable"]
  DUPCLOSURE R16 K41 [PROTO_8]
  CAPTURE VAL R3
  CAPTURE VAL R15
  CAPTURE VAL R7
  CAPTURE VAL R12
  SETTABLEKS R16 R15 K42 ["getTrackingAttributes"]
  DUPCLOSURE R16 K43 [PROTO_9]
  CAPTURE VAL R15
  CAPTURE VAL R14
  CAPTURE VAL R5
  CAPTURE VAL R12
  SETTABLEKS R16 R15 K44 ["logImpression"]
  DUPCLOSURE R16 K45 [PROTO_10]
  CAPTURE VAL R15
  SETTABLEKS R16 R15 K46 ["logPreview"]
  DUPCLOSURE R16 K47 [PROTO_12]
  CAPTURE VAL R15
  CAPTURE VAL R14
  CAPTURE VAL R5
  SETTABLEKS R16 R15 K48 ["logInsert"]
  DUPCLOSURE R16 K49 [PROTO_13]
  SETTABLEKS R16 R15 K50 ["logRemainsOrDeleted"]
  DUPCLOSURE R16 K51 [PROTO_14]
  CAPTURE VAL R0
  SETTABLEKS R16 R15 K52 ["logNavigationButtonInteraction"]
  DUPCLOSURE R16 K53 [PROTO_15]
  SETTABLEKS R16 R15 K54 ["logPageView"]
  DUPCLOSURE R16 K55 [PROTO_16]
  SETTABLEKS R16 R15 K56 ["logGoBack"]
  DUPCLOSURE R16 K57 [PROTO_17]
  SETTABLEKS R16 R15 K58 ["onCallToActionBannerClicked"]
  DUPCLOSURE R16 K59 [PROTO_18]
  CAPTURE VAL R15
  CAPTURE VAL R5
  SETTABLEKS R16 R15 K60 ["logAssetMediaImpression"]
  DUPCLOSURE R16 K61 [PROTO_19]
  CAPTURE VAL R15
  CAPTURE VAL R5
  SETTABLEKS R16 R15 K62 ["onAssetDescriptionLinkClicked"]
  RETURN R15 1
