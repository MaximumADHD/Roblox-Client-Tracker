...
PROTO_10:
  ...
  CALL R5 0 1
  JUMPIFNOT R5 [+35]
  GETTABLEKS R5 R1 K2 ["FiatProduct"]
  JUMPIFNOT R5 [+4]
  GETTABLEKS R6 R1 K2 ["FiatProduct"]
  GETTABLEKS R5 R6 K3 ["PurchasePrice"]
  GETUPVAL R8 2
  GETTABLEKS R7 R8 K4 ["Dictionary"]
  GETTABLEKS R6 R7 K5 ["join"]
  MOVE R7 R4
  DUPTABLE R8 K9 [{"buyerStatus", "currencyCode", "fiatPrice"}]
  SETTABLEKS R3 R8 K6 ["buyerStatus"]
  JUMPIFNOT R5 [+3]
  GETTABLEKS R9 R5 K7 ["currencyCode"]
  JUMP [+1]
  LOADNIL R9
  SETTABLEKS R9 R8 K7 ["currencyCode"]
  JUMPIFNOT R5 [+6]
  GETUPVAL R10 3
  GETTABLEKS R9 R10 K10 ["calculateQuantity"]
  MOVE R10 R5
  CALL R9 1 1
  JUMP [+1]
  LOADNIL R9
  SETTABLEKS R9 R8 K8 ["fiatPrice"]
  CALL R6 2 1
  MOVE R4 R6
  GETTABLEKS R6 R0 K11 ["senders"]
  GETTABLEKS R5 R6 K12 ["sendEventDeferred"]
  LOADK R6 K13 ["studio"]
  LOADK R7 K14 ["Marketplace"]
  LOADK R8 K15 ["MarketplaceAssetPreview"]
  MOVE R9 R4
  CALL R5 4 0
  RETURN R0 0
...
MAIN:
  ...
  LOADN R22 88
  SETLIST R19 R20 3 [1]
  SETTABLEKS R19 R18 K30 ["InsertRemainsCheckDelays"]
  ...
  CAPTURE VAL R0
  SETTABLEKS R19 R18 K36 ["getNavigationContext"]
  DUPCLOSURE R19 K37 [PROTO_4]
  SETTABLEKS R19 R18 K38 ["schedule"]
  DUPCLOSURE R19 K39 [PROTO_5]
  SETTABLEKS R19 R18 K40 ["getAssetCategoryName"]
  DUPCLOSURE R19 K41 [PROTO_6]
  SETTABLEKS R19 R18 K42 ["isAssetDataTrackable"]
  DUPCLOSURE R19 K43 [PROTO_7]
  CAPTURE VAL R18
  SETTABLEKS R19 R18 K44 ["isAssetTrackable"]
  DUPCLOSURE R19 K45 [PROTO_8]
  CAPTURE VAL R3
  CAPTURE VAL R18
  CAPTURE VAL R8
  CAPTURE VAL R14
  SETTABLEKS R19 R18 K46 ["getTrackingAttributes"]
  DUPCLOSURE R19 K47 [PROTO_9]
  CAPTURE VAL R18
  CAPTURE VAL R16
  CAPTURE VAL R5
  CAPTURE VAL R14
  SETTABLEKS R19 R18 K48 ["logImpression"]
  DUPCLOSURE R19 K49 [PROTO_10]
  CAPTURE VAL R18
  CAPTURE VAL R17
  CAPTURE VAL R3
  CAPTURE VAL R11
  SETTABLEKS R19 R18 K50 ["logPreview"]
  DUPCLOSURE R19 K51 [PROTO_12]
  CAPTURE VAL R18
  CAPTURE VAL R16
  CAPTURE VAL R5
  SETTABLEKS R19 R18 K52 ["logInsert"]
  DUPCLOSURE R19 K53 [PROTO_13]
  SETTABLEKS R19 R18 K54 ["logRemainsOrDeleted"]
  DUPCLOSURE R19 K55 [PROTO_14]
  CAPTURE VAL R0
  SETTABLEKS R19 R18 K56 ["logNavigationButtonInteraction"]
  DUPCLOSURE R19 K57 [PROTO_15]
  SETTABLEKS R19 R18 K58 ["logPageView"]
  DUPCLOSURE R19 K59 [PROTO_16]
  SETTABLEKS R19 R18 K60 ["logGoBack"]
  DUPCLOSURE R19 K61 [PROTO_17]
  SETTABLEKS R19 R18 K62 ["onCallToActionBannerClicked"]
  DUPCLOSURE R19 K63 [PROTO_18]
  CAPTURE VAL R18
  CAPTURE VAL R5
  SETTABLEKS R19 R18 K64 ["logAssetMediaImpression"]
  DUPCLOSURE R19 K65 [PROTO_19]
  CAPTURE VAL R18
  CAPTURE VAL R5
  SETTABLEKS R19 R18 K66 ["onAssetDescriptionLinkClicked"]
  RETURN R18 1
