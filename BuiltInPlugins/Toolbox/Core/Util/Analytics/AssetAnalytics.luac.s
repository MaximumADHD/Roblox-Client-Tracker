...
PROTO_3:
  ...
  CALL R5 0 1
  JUMPIFNOT R5 [+29]
  NAMECALL R5 R0 K1 ["getNavigationRoute"]
  CALL R5 1 1
  GETIMPORT R6 K4 [table.find]
  MOVE R7 R5
  GETUPVAL R10 1
  GETTABLEKS R9 R10 K5 ["NAVIGATION"]
  GETTABLEKS R8 R9 K6 ["RESULTS"]
  CALL R6 2 1
  ...
  LOADB R4 0 +1
  LOADB R4 1
  DUPTABLE R5 K12 [{"navBreadcrumbs", "navSwimlane", "navSeeAll", "navSeeAllSubcategory"}]
  GETUPVAL R6 2
  MOVE R8 R2
  NAMECALL R6 R6 K13 ["JSONEncode"]
  CALL R6 2 1
  SETTABLEKS R6 R5 K8 ["navBreadcrumbs"]
  SETTABLEKS R1 R5 K9 ["navSwimlane"]
  SETTABLEKS R3 R5 K10 ["navSeeAll"]
  SETTABLEKS R4 R5 K11 ["navSeeAllSubcategory"]
  RETURN R5 1
