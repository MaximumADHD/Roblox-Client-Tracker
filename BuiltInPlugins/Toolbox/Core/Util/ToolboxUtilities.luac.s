...
MAIN:
  ...
  NEWTABLE R10 0 0
  GETIMPORT R11 K88 [pairs]
  GETIMPORT R12 K91 [Enum.AssetType]
  NAMECALL R12 R12 K92 ["GetEnumItems"]
  CALL R12 1 -1
  CALL R11 -1 3
  FORGPREP_NEXT R11
  GETTABLEKS R16 R15 K93 ["Name"]
  SETTABLE R15 R10 R16
  FORGLOOP R11 2 [-4]
  NEWCLOSURE R11 P13
  CAPTURE REF R7
  CAPTURE VAL R10
  SETTABLEKS R11 R9 K94 ["getAssetConfigDistributionQuotas"]
  NEWCLOSURE R11 P14
  CAPTURE REF R7
  SETTABLEKS R11 R9 K95 ["getAnnouncementConfiguration"]
  NEWCLOSURE R11 P15
  CAPTURE REF R7
  SETTABLEKS R11 R9 K96 ["getVerificationDocumentationUrl"]
  NEWCLOSURE R11 P16
  CAPTURE REF R7
  SETTABLEKS R11 R9 K97 ["getAudioPrivacyLearnMoreUrl"]
  NEWCLOSURE R11 P17
  CAPTURE REF R7
  SETTABLEKS R11 R9 K98 ["getVideoPrivacyLearnMoreUrl"]
  NEWCLOSURE R11 P18
  CAPTURE REF R7
  SETTABLEKS R11 R9 K99 ["getSafetyLearnMoreUrl"]
  NEWCLOSURE R11 P19
  CAPTURE REF R7
  SETTABLEKS R11 R9 K100 ["getAppealsPortalUrl"]
  NEWCLOSURE R11 P20
  CAPTURE REF R7
  SETTABLEKS R11 R9 K101 ["getCreatorDashboardBaseUrl"]
  JUMPIFNOT R2 [+4]
  NEWCLOSURE R11 P21
  CAPTURE REF R7
  SETTABLEKS R11 R9 K102 ["getCreatorDashboardCatalogConfigUrlExtension"]
  NEWCLOSURE R11 P22
  CAPTURE REF R7
  SETTABLEKS R11 R9 K103 ["hideAssetConfigDistributeLearnMoreLink"]
  NEWCLOSURE R11 P23
  CAPTURE REF R7
  SETTABLEKS R11 R9 K104 ["getMarketplaceAssetConfigUrl"]
  MOVE R11 R4
  CALL R11 0 1
  JUMPIFNOT R11 [+4]
  NEWCLOSURE R11 P24
  CAPTURE REF R7
  SETTABLEKS R11 R9 K105 ["getMarketplaceOnboardingUrl"]
  NEWCLOSURE R11 P25
  CAPTURE REF R7
  SETTABLEKS R11 R9 K106 ["getOwnershipPollingWaitTimeInSec"]
  NEWCLOSURE R11 P26
  CAPTURE REF R7
  SETTABLEKS R11 R9 K107 ["getOwnershipPollingMaxRetries"]
  CLOSEUPVALS R7
  RETURN R9 1
