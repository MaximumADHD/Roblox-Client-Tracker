...
MAIN:
  ...
  GETTABLEKS R5 R6 K11 ["getFFlagEnableUpdatedToolboxSearchBarIcons"]
  CALL R4 1 1
  GETIMPORT R5 K7 [require]
  GETTABLEKS R9 R0 K4 ["Core"]
  GETTABLEKS R8 R9 K5 ["Util"]
  GETTABLEKS R7 R8 K8 ["SharedFlags"]
  GETTABLEKS R6 R7 K12 ["getFFlagToolboxPillsForCreators"]
  CALL R5 1 1
  GETIMPORT R6 K7 [require]
  GETTABLEKS R10 R0 K4 ["Core"]
  GETTABLEKS R9 R10 K5 ["Util"]
  GETTABLEKS R8 R9 K8 ["SharedFlags"]
  GETTABLEKS R7 R8 K13 ["getFFlagToolboxEnableSearchOptionsRefactor"]
  CALL R6 1 1
  GETIMPORT R7 K7 [require]
  GETTABLEKS R11 R0 K4 ["Core"]
  GETTABLEKS R10 R11 K5 ["Util"]
  GETTABLEKS R9 R10 K8 ["SharedFlags"]
  GETTABLEKS R8 R9 K14 ["getFFlagToolboxTutorialLimits"]
  CALL R7 1 1
  GETIMPORT R8 K7 [require]
  GETTABLEKS R10 R1 K8 ["SharedFlags"]
  GETTABLEKS R9 R10 K15 ["getFFlagEnableUGCUploadingDataSharing"]
  CALL R8 1 1
