...
PROTO_4:
  ...
  RETURN R3 1
  GETTABLEKS R3 R2 K13 ["Username"]
  RETURN R3 1
  GETIMPORT R3 K15 [error]
  LOADK R4 K16 ["Unknown creatorType: '%s'"]
  MOVE R6 R1
...
MAIN:
  ...
  SETTABLEKS R3 R2 K8 ["getCreatorTypeValueFromName"]
  DUPCLOSURE R3 K9 [PROTO_1]
  SETTABLEKS R3 R2 K10 ["isValidCreatorType"]
  DUPCLOSURE R3 K11 [PROTO_2]
  SETTABLEKS R3 R2 K12 ["backendToClient"]
  DUPCLOSURE R3 K13 [PROTO_3]
  SETTABLEKS R3 R2 K14 ["clientToBackend"]
  DUPCLOSURE R3 K15 [PROTO_4]
  CAPTURE VAL R2
  CAPTURE VAL R0
  SETTABLEKS R3 R2 K16 ["getNameFromResult"]
  DUPCLOSURE R3 K17 [PROTO_5]
  CAPTURE VAL R2
  SETTABLEKS R3 R2 K18 ["isCached"]
  RETURN R2 1
