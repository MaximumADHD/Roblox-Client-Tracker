PROTO_0:
  ...
  LOADK R4 K3 ["SetCanManageAsset expects a boolean."]
  ...
  LOADK R4 K7 ["SetCanManageAsset expects an asset id."]
  GETIMPORT R2 K5 [assert]
  CALL R2 2 0
  DUPTABLE R2 K10 [{"canManage", "assetId"}]
  SETTABLEKS R0 R2 K8 ["canManage"]
  SETTABLEKS R1 R2 K9 ["assetId"]
  RETURN R2 1
