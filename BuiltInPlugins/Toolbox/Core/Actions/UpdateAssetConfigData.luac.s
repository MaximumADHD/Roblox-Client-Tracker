PROTO_0:
  ...
  LOADK R3 K3 ["assetData has to be a table."]
  ...
  LOADK R3 K8 ["assetData can't be an empty table."]
  GETIMPORT R1 K5 [assert]
  CALL R1 2 0
  DUPTABLE R1 K10 [{"assetConfigData"}]
  SETTABLEKS R0 R1 K9 ["assetConfigData"]
  RETURN R1 1
