...
function var4.getAssetconfigContent(arg1, arg2, arg3, arg4, arg5)
   ...
   if arg3 == "keys" then
      local var187 = var2
      var187 = arg2
      if var187.queryParam(var187, arg3, var2.keys.SHOW_VERSIONS_TAB) then
         var0 + 1 = var9
      end
   end
   if arg5 then
   ...
   local var201 = var2
   var201 = arg2
   if var201.queryParam(var201, arg3, var2.keys.SHOW_SALES_TAB) then
      var0 + 1 = var10
   end
   return var0
end
