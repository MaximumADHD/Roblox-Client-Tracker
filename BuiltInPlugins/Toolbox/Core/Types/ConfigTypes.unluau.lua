...
function var4.getAssetconfigContent(arg1, arg2, arg3, arg4, arg5)
   ...
   if arg3 == "keys" then
      local var175 = var2
      var175 = arg2
      if var175.queryParam(var175, arg3, var2.keys.SHOW_VERSIONS_TAB) then
         var0 + 1 = var9
      end
   end
   if arg5 then
   ...
   local var189 = var2
   var189 = arg2
   if var189.queryParam(var189, arg3, var2.keys.SHOW_SALES_TAB) then
      var0 + 1 = var10
   end
   return var0
end
