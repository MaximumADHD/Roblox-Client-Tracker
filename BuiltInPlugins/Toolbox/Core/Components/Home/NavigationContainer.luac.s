...
PROTO_13:
  ...
  GETUPVAL R12 0
  CALL R11 1 1
  DUPTABLE R12 K11 [{"CategoryName", "SortName", "SearchSource", "QueryParams"}]
  SETTABLEKS R2 R12 K7 ["CategoryName"]
  SETTABLEKS R3 R12 K8 ["SortName"]
  GETUPVAL R15 1
  GETTABLEKS R14 R15 K12 ["SEARCH_SOURCE"]
  GETTABLEKS R13 R14 K13 ["CATEGORY"]
  ...
  GETUPVAL R8 1
  GETTABLEKS R7 R8 K3 ["NAVIGATION"]
  GETTABLEKS R6 R7 K14 ["SUBCATEGORY"]
  GETUPVAL R8 1
  GETTABLEKS R7 R8 K5 ["HOMEVIEW_SEARCH_CATEGORY"]
  MOVE R8 R0
  GETUPVAL R10 2
  ...
  GETUPVAL R12 0
  CALL R11 1 1
  DUPTABLE R12 K18 [{"CategoryName", "SortName", "SubcategoryPath", "SubcategoryDict", "TopKeywords", "QueryParams"}]
  SETTABLEKS R2 R12 K7 ["CategoryName"]
  SETTABLEKS R3 R12 K8 ["SortName"]
  NEWTABLE R13 0 1
  MOVE R14 R0
  SETLIST R13 R14 1 [1]
  SETTABLEKS R13 R12 K15 ["SubcategoryPath"]
  GETTABLEKS R13 R1 K19 ["children"]
  SETTABLEKS R13 R12 K16 ["SubcategoryDict"]
  GETUPVAL R14 0
  GETTABLEKS R13 R14 K17 ["TopKeywords"]
  SETTABLEKS R13 R12 K17 ["TopKeywords"]
  GETUPVAL R14 4
  CALL R14 0 1
  JUMPIFNOT R14 [+2]
  MOVE R13 R4
  JUMP [+1]
  LOADNIL R13
  SETTABLEKS R13 R12 K10 ["QueryParams"]
  CALL R9 3 -1
  CALL R5 -1 0
  RETURN R0 0
...
PROTO_15:
  ...
  GETUPVAL R13 0
  CALL R12 1 1
  DUPTABLE R13 K9 [{"CategoryName", "SearchTerm", "SectionName", "SortName", "QueryParams"}]
  SETTABLEKS R1 R13 K4 ["CategoryName"]
  SETTABLEKS R3 R13 K5 ["SearchTerm"]
  SETTABLEKS R0 R13 K6 ["SectionName"]
  SETTABLEKS R2 R13 K7 ["SortName"]
  SETTABLEKS R5 R13 K8 ["QueryParams"]
  CALL R10 3 -1
  CALL R6 -1 0
  RETURN R0 0
...
PROTO_18:
  ...
  JUMP [+1]
  LOADNIL R13
  SETTABLEKS R13 R12 K9 ["QueryParams"]
  CALL R9 3 -1
  CALL R5 -1 0
  RETURN R0 0
...
PROTO_19:
  ...
  GETUPVAL R12 0
  CALL R11 1 1
  DUPTABLE R12 K10 [{"CategoryName", "SectionName", "SortName", "SearchSource", "QueryParams"}]
...
PROTO_25:
  ...
  MOVE R12 R0
  CALL R11 1 1
  DUPTABLE R12 K11 [{"CategoryName", "OnClickBack", "SearchTerm", "SectionName", "Size", "SortName", "SearchSource", "QueryParams"}]
  SETTABLEKS R2 R12 K1 ["CategoryName"]
  NEWCLOSURE R13 P0
  CAPTURE VAL R0
  SETTABLEKS R13 R12 K9 ["OnClickBack"]
  SETTABLEKS R4 R12 K3 ["SearchTerm"]
  SETTABLEKS R3 R12 K2 ["SectionName"]
  ...
  SETTABLEKS R5 R12 K4 ["SortName"]
  SETTABLEKS R6 R12 K5 ["SearchSource"]
  SETTABLEKS R7 R12 K6 ["QueryParams"]
  CALL R10 2 -1
  CALL R8 -1 -1
  RETURN R8 -1
...
MAIN:
  ...
  GETTABLEKS R3 R4 K10 ["getFFlagToolboxTrackCurrentSubcategory"]
  CALL R2 1 1
  ...
  GETTABLEKS R6 R3 K13 ["Cryo"]
  CALL R5 1 1
  GETIMPORT R6 K5 [require]
  GETTABLEKS R7 R3 K14 ["Roact"]
  CALL R6 1 1
  GETIMPORT R7 K5 [require]
  GETTABLEKS R8 R3 K15 ["RoactRodux"]
  CALL R7 1 1
  GETIMPORT R8 K5 [require]
  GETTABLEKS R10 R0 K11 ["Packages"]
  GETTABLEKS R9 R10 K16 ["RoactNavigation"]
  CALL R8 1 1
  ...
  GETTABLEKS R12 R13 K20 ["Category"]
  CALL R11 1 1
  ...
  GETTABLEKS R14 R3 K22 ["Dash"]
  CALL R13 1 1
  GETIMPORT R14 K5 [require]
  GETTABLEKS R17 R0 K6 ["Core"]
  GETTABLEKS R16 R17 K23 ["Components"]
  GETTABLEKS R15 R16 K24 ["AssetLogicWrapper"]
  CALL R14 1 1
  GETIMPORT R15 K5 [require]
  GETTABLEKS R19 R0 K6 ["Core"]
  GETTABLEKS R18 R19 K23 ["Components"]
  GETTABLEKS R17 R18 K25 ["Categorization"]
  GETTABLEKS R16 R17 K26 ["HomeView"]
  CALL R15 1 1
  GETIMPORT R16 K5 [require]
  GETTABLEKS R20 R0 K6 ["Core"]
  GETTABLEKS R19 R20 K23 ["Components"]
  GETTABLEKS R18 R19 K27 ["Audio"]
  GETTABLEKS R17 R18 K28 ["AudioWrapper"]
  CALL R16 1 1
  GETIMPORT R17 K5 [require]
  GETTABLEKS R21 R0 K6 ["Core"]
  GETTABLEKS R20 R21 K23 ["Components"]
  GETTABLEKS R19 R20 K27 ["Audio"]
  GETTABLEKS R18 R19 K29 ["AudioViewIXPWrapper"]
  CALL R17 1 1
  GETIMPORT R18 K5 [require]
  GETTABLEKS R22 R0 K6 ["Core"]
  GETTABLEKS R21 R22 K23 ["Components"]
  GETTABLEKS R20 R21 K30 ["Font"]
  GETTABLEKS R19 R20 K31 ["FontView"]
  CALL R18 1 1
  GETIMPORT R19 K5 [require]
  GETTABLEKS R23 R0 K6 ["Core"]
  GETTABLEKS R22 R23 K23 ["Components"]
  GETTABLEKS R21 R22 K25 ["Categorization"]
  GETTABLEKS R20 R21 K32 ["ResultsView"]
  CALL R19 1 1
  GETIMPORT R20 K5 [require]
  GETTABLEKS R24 R0 K6 ["Core"]
  GETTABLEKS R23 R24 K23 ["Components"]
  GETTABLEKS R22 R23 K25 ["Categorization"]
  GETTABLEKS R21 R22 K33 ["SubcategoriesView"]
  CALL R20 1 1
  GETIMPORT R21 K5 [require]
  GETTABLEKS R25 R0 K6 ["Core"]
  GETTABLEKS R24 R25 K23 ["Components"]
  GETTABLEKS R23 R24 K25 ["Categorization"]
  GETTABLEKS R22 R23 K34 ["SubcategoriesSwimlaneView"]
  CALL R21 1 1
  GETIMPORT R22 K5 [require]
  GETTABLEKS R25 R0 K6 ["Core"]
  GETTABLEKS R24 R25 K18 ["ContextServices"]
  GETTABLEKS R23 R24 K35 ["NavigationContext"]
  CALL R22 1 1
  GETIMPORT R23 K5 [require]
  GETTABLEKS R26 R0 K6 ["Core"]
  GETTABLEKS R25 R26 K18 ["ContextServices"]
  GETTABLEKS R24 R25 K36 ["Settings"]
  CALL R23 1 1
  GETIMPORT R24 K5 [require]
  GETTABLEKS R27 R0 K6 ["Core"]
  GETTABLEKS R26 R27 K18 ["ContextServices"]
  GETTABLEKS R25 R26 K37 ["NetworkContext"]
  CALL R24 1 1
  GETIMPORT R25 K5 [require]
  GETTABLEKS R29 R0 K6 ["Core"]
  GETTABLEKS R28 R29 K7 ["Util"]
  GETTABLEKS R27 R28 K38 ["Analytics"]
  GETTABLEKS R26 R27 K39 ["AssetAnalyticsContextItem"]
  CALL R25 1 1
  GETIMPORT R26 K5 [require]
  GETTABLEKS R29 R0 K6 ["Core"]
  GETTABLEKS R28 R29 K40 ["Thunks"]
  GETTABLEKS R27 R28 K41 ["GetPageInfoAnalyticsContextInfo"]
  CALL R26 1 1
  GETIMPORT R27 K5 [require]
  GETTABLEKS R31 R0 K6 ["Core"]
  GETTABLEKS R30 R31 K42 ["Networking"]
  GETTABLEKS R29 R30 K43 ["Requests"]
  GETTABLEKS R28 R29 K44 ["UpdatePageInfoAndSendRequest"]
  CALL R27 1 1
  ...
  NEWTABLE R30 0 4
  NEWTABLE R31 1 0
  GETTABLEKS R33 R9 K47 ["NAVIGATION"]
  GETTABLEKS R32 R33 K48 ["HOME"]
  DUPCLOSURE R34 K49 [PROTO_16]
  CAPTURE VAL R17
  CAPTURE VAL R18
  CAPTURE VAL R15
  CAPTURE VAL R6
  ...
  NEWTABLE R32 1 0
  GETTABLEKS R34 R9 K47 ["NAVIGATION"]
  GETTABLEKS R33 R34 K50 ["ALL_SUBCATEGORIES"]
  DUPCLOSURE R35 K51 [PROTO_20]
  CAPTURE VAL R6
  CAPTURE VAL R20
  CAPTURE VAL R13
  CAPTURE VAL R29
  ...
  NEWTABLE R33 1 0
  GETTABLEKS R35 R9 K47 ["NAVIGATION"]
  GETTABLEKS R34 R35 K52 ["SUBCATEGORY"]
  DUPCLOSURE R36 K53 [PROTO_23]
  CAPTURE VAL R6
  CAPTURE VAL R21
  CAPTURE VAL R13
  CAPTURE VAL R29
  ...
  NEWTABLE R34 1 0
  GETTABLEKS R36 R9 K47 ["NAVIGATION"]
  GETTABLEKS R35 R36 K54 ["RESULTS"]
  DUPCLOSURE R37 K55 [PROTO_25]
  CAPTURE VAL R6
  CAPTURE VAL R19
  CAPTURE VAL R13
  CAPTURE VAL R29
  ...
  SETLIST R30 R31 4 [1]
  GETTABLEKS R31 R6 K56 ["PureComponent"]
  LOADK R33 K57 ["NavigationContainer"]
  NAMECALL R31 R31 K58 ["extend"]
  CALL R31 2 1
  DUPCLOSURE R32 K59 [PROTO_26]
  CAPTURE VAL R9
  CAPTURE VAL R8
  CAPTURE VAL R30
  CAPTURE VAL R10
