...
MAIN:
  ...
  GETTABLEKS R27 R28 K7 ["Util"]
  GETTABLEKS R26 R27 K37 ["Analytics"]
  GETTABLEKS R25 R26 K38 ["AssetAnalyticsContextItem"]
  CALL R24 1 1
  GETIMPORT R25 K5 [require]
  GETTABLEKS R28 R0 K6 ["Core"]
  GETTABLEKS R27 R28 K39 ["Thunks"]
  GETTABLEKS R26 R27 K40 ["GetPageInfoAnalyticsContextInfo"]
  CALL R25 1 1
  GETIMPORT R26 K5 [require]
  GETTABLEKS R30 R0 K6 ["Core"]
  GETTABLEKS R29 R30 K41 ["Networking"]
  GETTABLEKS R28 R29 K42 ["Requests"]
  GETTABLEKS R27 R28 K43 ["UpdatePageInfoAndSendRequest"]
  CALL R26 1 1
  DUPCLOSURE R27 K44 [PROTO_11]
  CAPTURE VAL R5
  CAPTURE VAL R4
  CAPTURE VAL R12
  CAPTURE VAL R26
  ...
  NEWTABLE R29 0 4
  NEWTABLE R30 1 0
  GETTABLEKS R32 R8 K46 ["NAVIGATION"]
  GETTABLEKS R31 R32 K47 ["HOME"]
  ...
  NEWTABLE R31 1 0
  GETTABLEKS R33 R8 K46 ["NAVIGATION"]
  GETTABLEKS R32 R33 K49 ["ALL_SUBCATEGORIES"]
  ...
  NEWTABLE R32 1 0
  GETTABLEKS R34 R8 K46 ["NAVIGATION"]
  GETTABLEKS R33 R34 K51 ["SUBCATEGORY"]
  DUPCLOSURE R35 K52 [PROTO_23]
  CAPTURE VAL R5
  CAPTURE VAL R20
  CAPTURE VAL R12
  CAPTURE VAL R28
  ...
  NEWTABLE R33 1 0
  GETTABLEKS R35 R8 K46 ["NAVIGATION"]
  GETTABLEKS R34 R35 K53 ["RESULTS"]
  ...
  SETLIST R29 R30 4 [1]
  GETTABLEKS R30 R5 K55 ["PureComponent"]
  LOADK R32 K56 ["NavigationContainer"]
  NAMECALL R30 R30 K57 ["extend"]
  CALL R30 2 1
