...
PROTO_13:
  ...
  JUMP [+1]
  LOADNIL R13
  SETTABLEKS R13 R12 K11 ["SwimlaneName"]
  CALL R9 3 -1
  CALL R5 -1 0
  RETURN R0 0
  GETUPVAL R6 0
...
PROTO_15:
  ...
  GETUPVAL R12 0
  CALL R11 1 1
  DUPTABLE R12 K9 [{"CategoryName", "SearchTerm", "SectionName", "SortName", "QueryParams"}]
...
MAIN:
  ...
  GETTABLEKS R33 R0 K6 ["Core"]
  GETTABLEKS R32 R33 K7 ["Util"]
  GETTABLEKS R31 R32 K8 ["SharedFlags"]
  GETTABLEKS R30 R31 K47 ["getFFlagAddMoreAudioSwimlaneAnalytics"]
  CALL R29 1 1
  ...
  NEWTABLE R32 0 4
  NEWTABLE R33 1 0
  GETTABLEKS R35 R8 K50 ["NAVIGATION"]
  GETTABLEKS R34 R35 K51 ["HOME"]
  DUPCLOSURE R36 K52 [PROTO_16]
  CAPTURE VAL R28
  CAPTURE VAL R16
  CAPTURE VAL R17
  CAPTURE VAL R18
  ...
  NEWTABLE R34 1 0
  GETTABLEKS R36 R8 K50 ["NAVIGATION"]
  GETTABLEKS R35 R36 K53 ["ALL_SUBCATEGORIES"]
  DUPCLOSURE R37 K54 [PROTO_20]
  CAPTURE VAL R5
  CAPTURE VAL R20
  CAPTURE VAL R12
  CAPTURE VAL R31
  ...
  NEWTABLE R35 1 0
  GETTABLEKS R37 R8 K50 ["NAVIGATION"]
  GETTABLEKS R36 R37 K55 ["SUBCATEGORY"]
  DUPCLOSURE R38 K56 [PROTO_23]
  CAPTURE VAL R5
  CAPTURE VAL R21
  CAPTURE VAL R12
  CAPTURE VAL R31
  ...
  NEWTABLE R36 1 0
  GETTABLEKS R38 R8 K50 ["NAVIGATION"]
  GETTABLEKS R37 R38 K57 ["RESULTS"]
  DUPCLOSURE R39 K58 [PROTO_25]
  CAPTURE VAL R5
  CAPTURE VAL R19
  CAPTURE VAL R12
  CAPTURE VAL R31
  ...
  SETLIST R32 R33 4 [1]
  GETTABLEKS R33 R5 K59 ["PureComponent"]
  LOADK R35 K60 ["NavigationContainer"]
  NAMECALL R33 R33 K61 ["extend"]
  CALL R33 2 1
  DUPCLOSURE R34 K62 [PROTO_26]
  CAPTURE VAL R8
  CAPTURE VAL R7
  CAPTURE VAL R32
  CAPTURE VAL R9
