...
MAIN:
  ...
  GETTABLEKS R16 R17 K29 ["getFFlagToolboxContextualRecommendations"]
  CALL R15 1 1
  GETIMPORT R16 K5 [require]
  GETTABLEKS R20 R0 K6 ["Core"]
  GETTABLEKS R19 R20 K17 ["Util"]
  GETTABLEKS R18 R19 K27 ["SharedFlags"]
  ...
  CALL R17 1 1
  GETTABLEKS R18 R2 K32 ["useState"]
  GETTABLEKS R19 R2 K33 ["useCallback"]
  ...
  GETIMPORT R3 K5 [require]
  GETTABLEKS R4 R2 K36 ["Framework"]
  CALL R3 1 1
  GETIMPORT R4 K5 [require]
  GETTABLEKS R5 R2 K37 ["Roact"]
  CALL R4 1 1
  GETIMPORT R5 K5 [require]
  GETTABLEKS R6 R2 K38 ["RoactRodux"]
  CALL R5 1 1
  GETIMPORT R6 K5 [require]
  GETTABLEKS R7 R2 K39 ["Dash"]
  CALL R6 1 1
  GETTABLEKS R9 R0 K6 ["Core"]
  ...
  CALL R8 1 1
  GETIMPORT R9 K5 [require]
  GETTABLEKS R10 R7 K40 ["HorizontalList"]
  CALL R9 1 1
  GETIMPORT R10 K5 [require]
  GETTABLEKS R13 R0 K6 ["Core"]
  ...
  GETIMPORT R16 K5 [require]
  GETTABLEKS R19 R0 K6 ["Core"]
  GETTABLEKS R18 R19 K41 ["Models"]
  GETTABLEKS R17 R18 K42 ["AssetInfo"]
  CALL R16 1 1
  GETIMPORT R17 K5 [require]
  GETTABLEKS R20 R0 K6 ["Core"]
  ...
  GETTABLEKS R20 R21 K43 ["withContext"]
  ...
  GETTABLEKS R23 R24 K29 ["getFFlagToolboxContextualRecommendations"]
  CALL R22 1 1
  GETIMPORT R23 K5 [require]
  GETTABLEKS R27 R0 K6 ["Core"]
  GETTABLEKS R26 R27 K17 ["Util"]
  GETTABLEKS R25 R26 K27 ["SharedFlags"]
  GETTABLEKS R24 R25 K30 ["getFFlagToolboxContextualRecommendationsShadowTraffic"]
  CALL R23 1 1
  GETIMPORT R24 K5 [require]
  GETTABLEKS R27 R0 K6 ["Core"]
  GETTABLEKS R26 R27 K7 ["Flags"]
  GETTABLEKS R25 R26 K31 ["getFFlagQualityFiltersInToolboxSearch"]
  CALL R24 1 1
  GETTABLEKS R25 R4 K44 ["PureComponent"]
  LOADK R27 K45 ["AssetSwimlane"]
  NAMECALL R25 R25 K46 ["extend"]
  CALL R25 2 1
  DUPCLOSURE R26 K47 [PROTO_8]
  SETTABLEKS R26 R25 K48 ["init"]
  DUPCLOSURE R26 K49 [PROTO_13]
  CAPTURE VAL R22
  CAPTURE VAL R4
  CAPTURE VAL R11
  CAPTURE VAL R13
  ...
  MOVE R27 R20
  DUPTABLE R28 K54 [{"Modal", "Network"}]
  SETTABLEKS R14 R28 K52 ["Modal"]
  SETTABLEKS R15 R28 K53 ["Network"]
  CALL R27 1 1
  MOVE R28 R25
  CALL R27 1 1
  MOVE R25 R27
