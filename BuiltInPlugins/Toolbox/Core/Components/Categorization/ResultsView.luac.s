...
MAIN:
  ...
  CALL R17 1 1
  GETTABLEKS R19 R3 K34 ["UI"]
  GETTABLEKS R18 R19 K35 ["LoadingIndicator"]
  GETTABLEKS R20 R3 K34 ["UI"]
  GETTABLEKS R19 R20 K36 ["LinkText"]
  GETTABLEKS R20 R2 K37 ["useCallback"]
  GETTABLEKS R21 R9 K38 ["TOOLBOX_ITEM_SEARCH_LIMIT"]
  ...
  GETTABLEKS R24 R8 K47 ["FREE_MODELS"]
  GETTABLEKS R23 R24 K48 ["name"]
  SETTABLEKS R23 R22 K19 ["Category"]
  LOADNIL R23
  SETTABLEKS R23 R22 K40 ["SearchTerm"]
  LOADNIL R23
  SETTABLEKS R23 R22 K41 ["SectionName"]
  GETTABLEKS R23 R14 K49 ["getDefaultSortNameForCategory"]
  GETTABLEKS R25 R8 K47 ["FREE_MODELS"]
  GETTABLEKS R24 R25 K48 ["name"]
  CALL R23 1 1
  SETTABLEKS R23 R22 K42 ["SortName"]
  DUPCLOSURE R23 K50 [PROTO_0]
  DUPCLOSURE R24 K51 [PROTO_1]
  DUPCLOSURE R25 K52 [PROTO_4]
  CAPTURE VAL R4
  CAPTURE VAL R22
  CAPTURE VAL R3
  CAPTURE VAL R12
  ...
  CALL R5 1 1
  GETIMPORT R6 K5 [require]
  GETTABLEKS R7 R2 K54 ["RoactRodux"]
  CALL R6 1 1
  GETIMPORT R7 K5 [require]
  GETTABLEKS R8 R2 K12 ["Dash"]
  CALL R7 1 1
  GETTABLEKS R8 R4 K25 ["ContextServices"]
  GETTABLEKS R9 R8 K55 ["withContext"]
  GETIMPORT R10 K5 [require]
  GETTABLEKS R13 R0 K6 ["Core"]
  GETTABLEKS R12 R13 K25 ["ContextServices"]
  GETTABLEKS R11 R12 K26 ["NetworkContext"]
  CALL R10 1 1
  GETTABLEKS R11 R4 K34 ["UI"]
  GETTABLEKS R12 R11 K35 ["LoadingIndicator"]
  GETTABLEKS R13 R11 K36 ["LinkText"]
  GETTABLEKS R14 R11 K56 ["Pane"]
  GETTABLEKS R15 R11 K57 ["TextLabel"]
  GETIMPORT R16 K5 [require]
  ...
  GETTABLEKS R27 R28 K58 ["Models"]
  GETTABLEKS R26 R27 K59 ["AssetInfo"]
  CALL R25 1 1
  ...
  GETTABLEKS R28 R29 K33 ["getFFlagQualityFiltersInToolboxSearch"]
  CALL R27 1 1
  GETTABLEKS R28 R22 K38 ["TOOLBOX_ITEM_SEARCH_LIMIT"]
  GETTABLEKS R29 R3 K60 ["PureComponent"]
  LOADK R31 K61 ["ResultsView"]
  NAMECALL R29 R29 K62 ["extend"]
  CALL R29 2 1
  DUPTABLE R30 K43 [{"Size", "Category", "SearchTerm", "SectionName", "SortName"}]
  ...
  GETTABLEKS R32 R23 K47 ["FREE_MODELS"]
  GETTABLEKS R31 R32 K48 ["name"]
  SETTABLEKS R31 R30 K19 ["Category"]
  LOADNIL R31
  SETTABLEKS R31 R30 K40 ["SearchTerm"]
  LOADNIL R31
  SETTABLEKS R31 R30 K41 ["SectionName"]
  GETTABLEKS R31 R5 K49 ["getDefaultSortNameForCategory"]
  GETTABLEKS R33 R23 K47 ["FREE_MODELS"]
  GETTABLEKS R32 R33 K48 ["name"]
  CALL R31 1 1
  SETTABLEKS R31 R30 K42 ["SortName"]
  SETTABLEKS R30 R29 K63 ["defaultProps"]
  DUPCLOSURE R30 K64 [PROTO_7]
  CAPTURE VAL R20
  CAPTURE VAL R3
  CAPTURE VAL R13
  SETTABLEKS R30 R29 K65 ["init"]
  DUPCLOSURE R30 K66 [PROTO_10]
  CAPTURE VAL R19
  CAPTURE VAL R22
  CAPTURE VAL R28
  CAPTURE VAL R27
  ...
  DUPCLOSURE R30 K68 [PROTO_11]
  CAPTURE VAL R27
  SETGLOBAL R30 K69 ["mapStateToProps"]
  MOVE R30 R9
  DUPTABLE R31 K72 [{"Localization", "Stylizer", "Network"}]
  GETTABLEKS R32 R8 K22 ["Localization"]
  SETTABLEKS R32 R31 K22 ["Localization"]
  GETTABLEKS R32 R8 K70 ["Stylizer"]
  SETTABLEKS R32 R31 K70 ["Stylizer"]
  SETTABLEKS R10 R31 K71 ["Network"]
  CALL R30 1 1
  MOVE R31 R29
  CALL R30 1 1
  MOVE R29 R30
  GETTABLEKS R30 R6 K73 ["connect"]
  GETGLOBAL R31 K69 ["mapStateToProps"]
  CALL R30 1 1
  MOVE R31 R29
  CALL R30 1 -1
  RETURN R30 -1
