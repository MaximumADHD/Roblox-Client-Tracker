...
MAIN:
  ...
  GETTABLEKS R26 R27 K37 ["getFFlagToolboxAudioDiscoveryUXImprovements"]
  CALL R25 1 1
  GETIMPORT R26 K6 [require]
  GETTABLEKS R30 R0 K9 ["Core"]
  GETTABLEKS R29 R30 K30 ["Util"]
  GETTABLEKS R28 R29 K36 ["SharedFlags"]
  GETTABLEKS R27 R28 K38 ["getFFlagToolboxFixInventoryGridSearch"]
  CALL R26 1 1
  GETIMPORT R27 K6 [require]
  GETTABLEKS R31 R0 K9 ["Core"]
  GETTABLEKS R30 R31 K30 ["Util"]
  GETTABLEKS R29 R30 K36 ["SharedFlags"]
  GETTABLEKS R28 R29 K39 ["getFFlagToolboxContextualRecommendations"]
  CALL R27 1 1
  GETTABLEKS R28 R21 K40 ["TOOLBOX_ITEM_SEARCH_LIMIT"]
  GETTABLEKS R29 R2 K41 ["PureComponent"]
  LOADK R31 K42 ["ResultsView"]
  NAMECALL R29 R29 K43 ["extend"]
  CALL R29 2 1
  DUPTABLE R30 K48 [{"Size", "Category", "SearchTerm", "SectionName", "SortName"}]
  ...
  GETTABLEKS R32 R22 K52 ["FREE_MODELS"]
  GETTABLEKS R31 R32 K53 ["name"]
  SETTABLEKS R31 R30 K32 ["Category"]
  LOADNIL R31
  SETTABLEKS R31 R30 K45 ["SearchTerm"]
  LOADNIL R31
  SETTABLEKS R31 R30 K46 ["SectionName"]
  GETTABLEKS R31 R4 K54 ["getDefaultSortNameForCategory"]
  GETTABLEKS R33 R22 K52 ["FREE_MODELS"]
  GETTABLEKS R32 R33 K53 ["name"]
  CALL R31 1 1
  SETTABLEKS R31 R30 K47 ["SortName"]
  SETTABLEKS R30 R29 K55 ["defaultProps"]
  DUPCLOSURE R30 K56 [PROTO_2]
  CAPTURE VAL R19
  CAPTURE VAL R2
  CAPTURE VAL R12
  SETTABLEKS R30 R29 K57 ["init"]
  DUPCLOSURE R30 K58 [PROTO_5]
  CAPTURE VAL R27
  CAPTURE VAL R18
  CAPTURE VAL R21
  CAPTURE VAL R28
  ...
  CAPTURE VAL R16
  CAPTURE VAL R26
  SETTABLEKS R30 R29 K59 ["render"]
  DUPCLOSURE R30 K60 [PROTO_6]
  CAPTURE VAL R27
  SETGLOBAL R30 K61 ["mapStateToProps"]
  MOVE R30 R8
  DUPTABLE R31 K64 [{"Localization", "Stylizer", "Network"}]
  GETTABLEKS R32 R7 K28 ["Localization"]
  SETTABLEKS R32 R31 K28 ["Localization"]
  GETTABLEKS R32 R7 K62 ["Stylizer"]
  SETTABLEKS R32 R31 K62 ["Stylizer"]
  SETTABLEKS R9 R31 K63 ["Network"]
  CALL R30 1 1
  MOVE R31 R29
  CALL R30 1 1
  MOVE R29 R30
  GETTABLEKS R30 R5 K65 ["connect"]
  GETGLOBAL R31 K61 ["mapStateToProps"]
  CALL R30 1 1
  MOVE R31 R29
  CALL R30 1 -1
  RETURN R30 -1
