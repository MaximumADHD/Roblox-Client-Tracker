...
MAIN:
  ...
  GETTABLEKS R28 R29 K40 ["getFFlagQualityFiltersInToolboxSearch"]
  CALL R27 1 1
  GETTABLEKS R28 R21 K41 ["TOOLBOX_ITEM_SEARCH_LIMIT"]
  GETTABLEKS R29 R2 K42 ["PureComponent"]
  LOADK R31 K43 ["ResultsView"]
  NAMECALL R29 R29 K44 ["extend"]
  CALL R29 2 1
  DUPTABLE R30 K49 [{"Size", "Category", "SearchTerm", "SectionName", "SortName"}]
  ...
  GETTABLEKS R32 R22 K53 ["FREE_MODELS"]
  GETTABLEKS R31 R32 K54 ["name"]
  SETTABLEKS R31 R30 K32 ["Category"]
  LOADNIL R31
  SETTABLEKS R31 R30 K46 ["SearchTerm"]
  LOADNIL R31
  SETTABLEKS R31 R30 K47 ["SectionName"]
  GETTABLEKS R31 R4 K55 ["getDefaultSortNameForCategory"]
  GETTABLEKS R33 R22 K53 ["FREE_MODELS"]
  GETTABLEKS R32 R33 K54 ["name"]
  CALL R31 1 1
  SETTABLEKS R31 R30 K48 ["SortName"]
  SETTABLEKS R30 R29 K56 ["defaultProps"]
  DUPCLOSURE R30 K57 [PROTO_2]
  CAPTURE VAL R19
  CAPTURE VAL R2
  CAPTURE VAL R12
  SETTABLEKS R30 R29 K58 ["init"]
  DUPCLOSURE R30 K59 [PROTO_5]
  CAPTURE VAL R26
  CAPTURE VAL R18
  CAPTURE VAL R21
  CAPTURE VAL R28
  ...
  DUPCLOSURE R30 K61 [PROTO_6]
  CAPTURE VAL R26
  CAPTURE VAL R27
  SETGLOBAL R30 K62 ["mapStateToProps"]
  MOVE R30 R8
  DUPTABLE R31 K65 [{"Localization", "Stylizer", "Network"}]
  GETTABLEKS R32 R7 K28 ["Localization"]
  SETTABLEKS R32 R31 K28 ["Localization"]
  GETTABLEKS R32 R7 K63 ["Stylizer"]
  SETTABLEKS R32 R31 K63 ["Stylizer"]
  SETTABLEKS R9 R31 K64 ["Network"]
  CALL R30 1 1
  MOVE R31 R29
  CALL R30 1 1
  MOVE R29 R30
  GETTABLEKS R30 R5 K66 ["connect"]
  GETGLOBAL R31 K62 ["mapStateToProps"]
  CALL R30 1 1
  MOVE R31 R29
  CALL R30 1 -1
  RETURN R30 -1
