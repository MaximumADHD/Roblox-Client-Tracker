...
MAIN:
  ...
  GETTABLEKS R42 R1 K12 ["Core"]
  GETTABLEKS R41 R42 K13 ["Util"]
  GETTABLEKS R40 R41 K57 ["ToolboxCommunication"]
  CALL R39 1 1
  JUMP [+1]
  LOADNIL R39
  GETTABLEKS R40 R3 K58 ["PureComponent"]
  LOADK R42 K59 ["Header"]
  NAMECALL R40 R40 K60 ["extend"]
  CALL R40 2 1
  GETIMPORT R41 K62 [settings]
  LOADNIL R42
  JUMPIFNOT R0 [+21]
  NEWTABLE R43 4 0
  GETTABLEKS R45 R13 K63 ["MY_PACKAGES"]
  GETTABLEKS R44 R45 K64 ["name"]
  LOADB R45 1
  SETTABLE R45 R43 R44
  GETTABLEKS R45 R13 K65 ["GROUP_PACKAGES"]
  GETTABLEKS R44 R45 K64 ["name"]
  LOADB R45 1
  SETTABLE R45 R43 R44
  GETTABLEKS R45 R13 K66 ["CREATIONS_GROUP_PACKAGES"]
  GETTABLEKS R44 R45 K64 ["name"]
  LOADB R45 1
  SETTABLE R45 R43 R44
  MOVE R42 R43
  ...
  CAPTURE VAL R14
  CAPTURE VAL R37
  SETTABLEKS R43 R40 K67 ["init"]
  DUPCLOSURE R43 K68 [PROTO_8]
  CAPTURE VAL R0
  SETTABLEKS R43 R40 K69 ["willUpdate"]
  NEWCLOSURE R43 P2
  CAPTURE VAL R0
  CAPTURE REF R11
  CAPTURE VAL R17
  ...
  CAPTURE VAL R14
  CAPTURE VAL R8
  SETTABLEKS R43 R40 K70 ["render"]
  DUPCLOSURE R43 K71 [PROTO_10]
  CAPTURE VAL R5
  CAPTURE VAL R9
  SETTABLEKS R43 R40 K72 ["checkRecentAssetInsertion"]
  DUPCLOSURE R43 K73 [PROTO_11]
  DUPCLOSURE R44 K74 [PROTO_12]
  DUPCLOSURE R45 K75 [PROTO_13]
  DUPCLOSURE R46 K76 [PROTO_15]
  SETTABLEKS R46 R40 K77 ["addTabRefreshCallback"]
  DUPCLOSURE R46 K78 [PROTO_16]
  SETTABLEKS R46 R40 K79 ["removeTabRefreshCallback"]
  DUPCLOSURE R46 K80 [PROTO_17]
  CAPTURE VAL R0
  SETTABLEKS R46 R40 K81 ["didMount"]
  DUPCLOSURE R46 K82 [PROTO_18]
  SETTABLEKS R46 R40 K83 ["willUnmount"]
  MOVE R46 R22
  DUPTABLE R47 K87 [{"IXP", "Settings", "Stylizer", "Localization", "Network"}]
  JUMPIF R0 [+6]
  MOVE R49 R34
  CALL R49 0 1
  JUMPIF R49 [+3]
  ...
  JUMP [+1]
  LOADNIL R48
  SETTABLEKS R48 R47 K84 ["IXP"]
  SETTABLEKS R23 R47 K36 ["Settings"]
  GETTABLEKS R48 R21 K85 ["Stylizer"]
  SETTABLEKS R48 R47 K85 ["Stylizer"]
  GETTABLEKS R48 R21 K19 ["Localization"]
  SETTABLEKS R48 R47 K19 ["Localization"]
  SETTABLEKS R24 R47 K86 ["Network"]
  CALL R46 1 1
  MOVE R47 R40
  CALL R46 1 1
  MOVE R40 R46
  DUPCLOSURE R46 K88 [PROTO_19]
  SETGLOBAL R46 K89 ["isSearchFiltered"]
  DUPCLOSURE R46 K90 [PROTO_20]
  CAPTURE VAL R13
  CAPTURE VAL R34
  CAPTURE VAL R37
  CAPTURE VAL R38
  DUPCLOSURE R47 K91 [PROTO_26]
  CAPTURE VAL R31
  CAPTURE VAL R32
  CAPTURE VAL R30
  CAPTURE VAL R34
