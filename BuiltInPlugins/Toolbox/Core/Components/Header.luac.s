...
MAIN:
  ...
  GETTABLEKS R16 R17 K28 ["LayoutMode"]
  CALL R15 1 1
  GETIMPORT R16 K9 [require]
  GETTABLEKS R19 R1 K12 ["Core"]
  GETTABLEKS R18 R19 K26 ["Types"]
  GETTABLEKS R17 R18 K29 ["AnalyticsTypes"]
  CALL R16 1 1
  GETIMPORT R17 K9 [require]
  GETTABLEKS R18 R2 K30 ["Framework"]
  CALL R17 1 1
  GETTABLEKS R19 R17 K13 ["Util"]
  GETTABLEKS R18 R19 K31 ["deepCopy"]
  GETTABLEKS R20 R17 K32 ["UI"]
  GETTABLEKS R19 R20 K33 ["IconButton"]
  GETTABLEKS R21 R17 K32 ["UI"]
  GETTABLEKS R20 R21 K34 ["Tooltip"]
  GETIMPORT R21 K9 [require]
  GETTABLEKS R24 R1 K12 ["Core"]
  GETTABLEKS R23 R24 K35 ["ContextServices"]
  GETTABLEKS R22 R23 K36 ["IXPContext"]
  CALL R21 1 1
  GETIMPORT R23 K9 [require]
  GETTABLEKS R24 R2 K30 ["Framework"]
  CALL R23 1 1
  GETTABLEKS R22 R23 K35 ["ContextServices"]
  GETTABLEKS R23 R22 K37 ["withContext"]
  GETIMPORT R24 K9 [require]
  GETTABLEKS R27 R1 K12 ["Core"]
  GETTABLEKS R26 R27 K35 ["ContextServices"]
  GETTABLEKS R25 R26 K38 ["Settings"]
  CALL R24 1 1
  GETIMPORT R25 K9 [require]
  GETTABLEKS R28 R1 K12 ["Core"]
  GETTABLEKS R27 R28 K35 ["ContextServices"]
  GETTABLEKS R26 R27 K39 ["NetworkContext"]
  CALL R25 1 1
  GETIMPORT R26 K9 [require]
  GETTABLEKS R29 R1 K12 ["Core"]
  GETTABLEKS R28 R29 K40 ["Components"]
  GETTABLEKS R27 R28 K41 ["DropdownMenu"]
  CALL R26 1 1
  GETIMPORT R27 K9 [require]
  GETTABLEKS R30 R1 K12 ["Core"]
  GETTABLEKS R29 R30 K40 ["Components"]
  GETTABLEKS R28 R29 K42 ["SearchBarWithAutocomplete"]
  CALL R27 1 1
  ...
  GETTABLEKS R37 R38 K54 ["getFFlagToolboxListviewAnalytics"]
  CALL R36 1 1
  GETIMPORT R37 K9 [require]
  GETTABLEKS R40 R1 K12 ["Core"]
  GETTABLEKS R39 R40 K13 ["Util"]
  GETTABLEKS R38 R39 K55 ["ToolboxCommunication"]
  CALL R37 1 1
  GETTABLEKS R38 R3 K56 ["PureComponent"]
  LOADK R40 K57 ["Header"]
  NAMECALL R38 R38 K58 ["extend"]
  CALL R38 2 1
  GETIMPORT R39 K60 [settings]
  LOADNIL R40
  JUMPIFNOT R0 [+21]
  NEWTABLE R41 4 0
  GETTABLEKS R43 R14 K61 ["MY_PACKAGES"]
  GETTABLEKS R42 R43 K62 ["name"]
  LOADB R43 1
  SETTABLE R43 R41 R42
  GETTABLEKS R43 R14 K63 ["GROUP_PACKAGES"]
  GETTABLEKS R42 R43 K62 ["name"]
  LOADB R43 1
  SETTABLE R43 R41 R42
  GETTABLEKS R43 R14 K64 ["CREATIONS_GROUP_PACKAGES"]
  GETTABLEKS R42 R43 K62 ["name"]
  LOADB R43 1
  SETTABLE R43 R41 R42
  MOVE R40 R41
  ...
  CAPTURE VAL R15
  CAPTURE VAL R36
  SETTABLEKS R41 R38 K65 ["init"]
  DUPCLOSURE R41 K66 [PROTO_8]
  CAPTURE VAL R0
  SETTABLEKS R41 R38 K67 ["willUpdate"]
  NEWCLOSURE R41 P2
  CAPTURE VAL R0
  CAPTURE REF R11
  CAPTURE VAL R18
  ...
  CAPTURE VAL R15
  CAPTURE VAL R8
  SETTABLEKS R41 R38 K68 ["render"]
  DUPCLOSURE R41 K69 [PROTO_10]
  CAPTURE VAL R5
  CAPTURE VAL R9
  SETTABLEKS R41 R38 K70 ["checkRecentAssetInsertion"]
  DUPCLOSURE R41 K71 [PROTO_11]
  DUPCLOSURE R42 K72 [PROTO_12]
  DUPCLOSURE R43 K73 [PROTO_13]
  DUPCLOSURE R44 K74 [PROTO_15]
  SETTABLEKS R44 R38 K75 ["addTabRefreshCallback"]
  DUPCLOSURE R44 K76 [PROTO_16]
  SETTABLEKS R44 R38 K77 ["removeTabRefreshCallback"]
  DUPCLOSURE R44 K78 [PROTO_17]
  CAPTURE VAL R0
  SETTABLEKS R44 R38 K79 ["didMount"]
  DUPCLOSURE R44 K80 [PROTO_18]
  SETTABLEKS R44 R38 K81 ["willUnmount"]
  MOVE R44 R23
  DUPTABLE R45 K85 [{"IXP", "Settings", "Stylizer", "Localization", "Network"}]
  JUMPIF R0 [+6]
  MOVE R47 R34
  CALL R47 0 1
  JUMPIF R47 [+3]
  ...
  JUMP [+1]
  LOADNIL R46
  SETTABLEKS R46 R45 K82 ["IXP"]
  SETTABLEKS R24 R45 K38 ["Settings"]
  GETTABLEKS R46 R22 K83 ["Stylizer"]
  SETTABLEKS R46 R45 K83 ["Stylizer"]
  GETTABLEKS R46 R22 K19 ["Localization"]
  SETTABLEKS R46 R45 K19 ["Localization"]
  SETTABLEKS R25 R45 K84 ["Network"]
  CALL R44 1 1
  MOVE R45 R38
  CALL R44 1 1
  MOVE R38 R44
  DUPCLOSURE R44 K86 [PROTO_19]
  SETGLOBAL R44 K87 ["isSearchFiltered"]
  DUPCLOSURE R44 K88 [PROTO_20]
  CAPTURE VAL R14
  CAPTURE VAL R34
  CAPTURE VAL R36
  DUPCLOSURE R45 K89 [PROTO_26]
  CAPTURE VAL R31
  CAPTURE VAL R32
  CAPTURE VAL R30
  CAPTURE VAL R34
