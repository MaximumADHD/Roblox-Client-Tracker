...
PROTO_9:
  ...
  LOADB R26 0
  LOADB R25 1
  DUPTABLE R28 K55 [{"LayoutOrder", "OnSearchRequested", "OnTextChanged", "SearchTerm", "Style", "Width", "OnSearchOptionsToggled", "SearchIsFiltered", "ShowRecentSearchesInAutoComplete"}]
  LOADN R29 1
  SETTABLEKS R29 R28 K46 ["LayoutOrder"]
  SETTABLEKS R10 R28 K47 ["OnSearchRequested"]
  GETTABLEKS R29 R0 K56 ["onSearchTextChanged"]
  ...
  LOADNIL R29
  JUMP [+1]
  LOADK R29 K57 ["ToolboxSearchBar"]
  SETTABLEKS R29 R28 K50 ["Style"]
  SETTABLEKS R20 R28 K51 ["Width"]
  GETTABLEKS R29 R0 K35 ["onSearchOptionsToggled"]
  SETTABLEKS R29 R28 K52 ["OnSearchOptionsToggled"]
  SETTABLEKS R15 R28 K53 ["SearchIsFiltered"]
  GETUPVAL R30 9
  CALL R30 0 1
  JUMPIFNOT R30 [+16]
  LOADB R29 1
  GETTABLEKS R31 R0 K58 ["state"]
  GETTABLEKS R30 R31 K21 ["searchTerm"]
  JUMPIFEQKS R30 K59 [""] [+11]
  GETTABLEKS R31 R0 K58 ["state"]
  GETTABLEKS R30 R31 K21 ["searchTerm"]
  JUMPIFEQKNIL R30 [+2]
  LOADB R29 0 +1
  ...
  JUMP [+1]
  LOADNIL R29
  SETTABLEKS R29 R28 K54 ["ShowRecentSearchesInAutoComplete"]
  GETUPVAL R30 11
  GETTABLEKS R29 R30 K60 ["createElement"]
  GETUPVAL R30 12
  MOVE R31 R28
  CALL R29 2 1
  GETUPVAL R31 11
  GETTABLEKS R30 R31 K60 ["createElement"]
  LOADK R31 K61 ["ImageButton"]
  DUPTABLE R32 K68 [{"Position", "Size", "BackgroundColor3", "BorderSizePixel", "ZIndex", "AutoButtonColor"}]
  GETTABLEKS R33 R1 K62 ["Position"]
  SETTABLEKS R33 R32 K62 ["Position"]
  GETIMPORT R33 K71 [UDim2.new]
  LOADN R34 1
  LOADN R35 0
  LOADN R36 0
  GETUPVAL R38 8
  GETTABLEKS R37 R38 K72 ["HEADER_HEIGHT"]
  CALL R33 4 1
  SETTABLEKS R33 R32 K63 ["Size"]
  GETTABLEKS R33 R22 K73 ["backgroundColor"]
  SETTABLEKS R33 R32 K64 ["BackgroundColor3"]
  LOADN R33 0
  SETTABLEKS R33 R32 K65 ["BorderSizePixel"]
  LOADN R33 2
  SETTABLEKS R33 R32 K66 ["ZIndex"]
  LOADB R33 0
  SETTABLEKS R33 R32 K67 ["AutoButtonColor"]
  DUPTABLE R33 K80 [{"UIPadding", "UIListLayout", "CategoryMenu", "SearchBar", "ToggleListViewButton", "GroupMenu"}]
  GETUPVAL R35 11
  GETTABLEKS R34 R35 K60 ["createElement"]
  LOADK R35 K74 ["UIPadding"]
  DUPTABLE R36 K85 [{"PaddingBottom", "PaddingLeft", "PaddingRight", "PaddingTop"}]
  GETIMPORT R37 K87 [UDim.new]
  LOADN R38 0
  GETUPVAL R40 8
  GETTABLEKS R39 R40 K38 ["HEADER_OUTER_PADDING"]
  CALL R37 2 1
  SETTABLEKS R37 R36 K81 ["PaddingBottom"]
  GETIMPORT R37 K87 [UDim.new]
  LOADN R38 0
  GETUPVAL R40 8
  GETTABLEKS R39 R40 K38 ["HEADER_OUTER_PADDING"]
  CALL R37 2 1
  SETTABLEKS R37 R36 K82 ["PaddingLeft"]
  GETIMPORT R37 K87 [UDim.new]
  LOADN R38 0
  GETUPVAL R40 8
  GETTABLEKS R39 R40 K38 ["HEADER_OUTER_PADDING"]
  CALL R37 2 1
  SETTABLEKS R37 R36 K83 ["PaddingRight"]
  GETIMPORT R37 K87 [UDim.new]
  LOADN R38 0
  GETUPVAL R40 8
  GETTABLEKS R39 R40 K38 ["HEADER_OUTER_PADDING"]
  CALL R37 2 1
  SETTABLEKS R37 R36 K84 ["PaddingTop"]
  CALL R34 2 1
  SETTABLEKS R34 R33 K74 ["UIPadding"]
  GETUPVAL R35 11
  GETTABLEKS R34 R35 K60 ["createElement"]
  LOADK R35 K75 ["UIListLayout"]
  DUPTABLE R36 K91 [{"FillDirection", "SortOrder", "Padding"}]
  GETIMPORT R37 K94 [Enum.FillDirection.Horizontal]
  SETTABLEKS R37 R36 K88 ["FillDirection"]
  GETIMPORT R37 K95 [Enum.SortOrder.LayoutOrder]
  SETTABLEKS R37 R36 K89 ["SortOrder"]
  GETIMPORT R37 K87 [UDim.new]
  LOADN R38 0
  GETUPVAL R40 8
  GETTABLEKS R39 R40 K34 ["HEADER_INNER_PADDING"]
  CALL R37 2 1
  SETTABLEKS R37 R36 K90 ["Padding"]
  CALL R34 2 1
  SETTABLEKS R34 R33 K75 ["UIListLayout"]
  GETUPVAL R35 11
  GETTABLEKS R34 R35 K60 ["createElement"]
  GETUPVAL R35 13
  DUPTABLE R36 K102 [{"Disabled", "Position", "Size", "LayoutOrder", "visibleDropDownCount", "selectedDropDownIndex", "items", "menuKey", "onItemClicked"}]
  GETUPVAL R38 10
  CALL R38 0 1
  JUMPIFNOT R38 [+3]
  GETTABLEKS R37 R1 K103 ["hasTutorialLimits"]
  JUMP [+1]
  LOADNIL R37
  SETTABLEKS R37 R36 K96 ["Disabled"]
  GETIMPORT R37 K71 [UDim2.new]
  LOADN R38 0
  LOADN R39 0
  LOADN R40 0
  LOADN R41 0
  CALL R37 4 1
  SETTABLEKS R37 R36 K62 ["Position"]
  JUMPIFNOT R25 [+8]
  GETIMPORT R37 K71 [UDim2.new]
  LOADN R38 1
  LOADN R39 0
  ...
  LOADN R41 0
  CALL R37 4 1
  SETTABLEKS R37 R36 K63 ["Size"]
  LOADN R37 0
  SETTABLEKS R37 R36 K46 ["LayoutOrder"]
  LOADN R37 8
  SETTABLEKS R37 R36 K97 ["visibleDropDownCount"]
  SETTABLEKS R7 R36 K98 ["selectedDropDownIndex"]
  SETTABLEKS R6 R36 K99 ["items"]
  JUMPIF R23 [+2]
  LOADK R37 K10 ["category"]
  JUMP [+1]
  LOADNIL R37
  SETTABLEKS R37 R36 K100 ["menuKey"]
  SETTABLEKS R8 R36 K101 ["onItemClicked"]
  CALL R34 2 1
  SETTABLEKS R34 R33 K76 ["CategoryMenu"]
  AND R34 R26 R29
  SETTABLEKS R34 R33 K77 ["SearchBar"]
  GETUPVAL R35 14
  CALL R35 0 1
  JUMPIFNOT R35 [+78]
  JUMPIFNOT R14 [+77]
  ...
  GETTABLEKS R34 R35 K60 ["createElement"]
  GETUPVAL R35 15
  DUPTABLE R36 K111 [{"BackgroundStyle", "Cursor", "IconColor", "IconSize", "LayoutOrder", "LeftIcon", "OnClick", "Padding", "Size", "TooltipText"}]
  LOADK R37 K112 ["None"]
  SETTABLEKS R37 R36 K104 ["BackgroundStyle"]
  LOADK R37 K113 ["PointingHand"]
  SETTABLEKS R37 R36 K105 ["Cursor"]
  GETTABLEKS R37 R22 K114 ["iconColor"]
  SETTABLEKS R37 R36 K106 ["IconColor"]
  GETUPVAL R38 8
  GETTABLEKS R37 R38 K33 ["HEADER_OPTIONSBUTTON_WIDTH"]
  SETTABLEKS R37 R36 K107 ["IconSize"]
  LOADN R37 2
  SETTABLEKS R37 R36 K46 ["LayoutOrder"]
  GETTABLEKS R38 R1 K115 ["layoutMode"]
  GETUPVAL R40 16
  GETTABLEKS R39 R40 K116 ["ListView"]
  JUMPIFNOTEQ R38 R39 [+5]
  GETUPVAL R38 17
  GETTABLEKS R37 R38 K117 ["GALLERY_ICON"]
  JUMP [+3]
  GETUPVAL R38 17
  GETTABLEKS R37 R38 K118 ["LIST_ICON"]
  SETTABLEKS R37 R36 K108 ["LeftIcon"]
  GETTABLEKS R37 R0 K119 ["toggleLayoutMode"]
  SETTABLEKS R37 R36 K109 ["OnClick"]
  LOADN R37 2
  SETTABLEKS R37 R36 K90 ["Padding"]
  GETIMPORT R37 K121 [UDim2.fromOffset]
  MOVE R38 R17
  GETUPVAL R40 8
  GETTABLEKS R39 R40 K122 ["HEADER_OPTIONSBUTTON_HEIGHT"]
  CALL R37 2 1
  SETTABLEKS R37 R36 K63 ["Size"]
  GETTABLEKS R38 R1 K115 ["layoutMode"]
  GETUPVAL R40 16
  ...
  LOADK R39 K123 ["General"]
  LOADK R40 K124 ["GridView"]
  NAMECALL R37 R3 K125 ["getText"]
  CALL R37 3 1
  JUMP [+5]
  LOADK R39 K123 ["General"]
  LOADK R40 K116 ["ListView"]
  NAMECALL R37 R3 K125 ["getText"]
  CALL R37 3 1
  SETTABLEKS R37 R36 K110 ["TooltipText"]
  CALL R34 2 1
  JUMP [+1]
  LOADNIL R34
  SETTABLEKS R34 R33 K78 ["ToggleListViewButton"]
  MOVE R34 R21
  JUMPIFNOT R34 [+39]
  GETUPVAL R35 11
  GETTABLEKS R34 R35 K60 ["createElement"]
  GETUPVAL R35 13
  DUPTABLE R36 K126 [{"Position", "Size", "LayoutOrder", "visibleDropDownCount", "selectedDropDownIndex", "items", "menuKey", "onItemClicked"}]
  GETIMPORT R37 K71 [UDim2.new]
  LOADN R38 0
  LOADN R39 0
  LOADN R40 0
  ...
  LOADN R37 8
  SETTABLEKS R37 R36 K97 ["visibleDropDownCount"]
  SETTABLEKS R12 R36 K98 ["selectedDropDownIndex"]
  SETTABLEKS R11 R36 K99 ["items"]
  LOADK R37 K127 ["id"]
  SETTABLEKS R37 R36 K100 ["menuKey"]
  SETTABLEKS R13 R36 K101 ["onItemClicked"]
  CALL R34 2 1
  SETTABLEKS R34 R33 K79 ["GroupMenu"]
  CALL R30 3 -1
  RETURN R30 -1
...
MAIN:
  ...
  GETTABLEKS R40 R1 K12 ["Core"]
  GETTABLEKS R39 R40 K13 ["Util"]
  GETTABLEKS R38 R39 K54 ["ToolboxCommunication"]
  CALL R37 1 1
  JUMP [+1]
  LOADNIL R37
  GETTABLEKS R38 R3 K55 ["PureComponent"]
  LOADK R40 K56 ["Header"]
  NAMECALL R38 R38 K57 ["extend"]
  CALL R38 2 1
  GETIMPORT R39 K59 [settings]
  LOADNIL R40
  JUMPIFNOT R0 [+21]
  NEWTABLE R41 4 0
  GETTABLEKS R43 R13 K60 ["MY_PACKAGES"]
  GETTABLEKS R42 R43 K61 ["name"]
  LOADB R43 1
  SETTABLE R43 R41 R42
  GETTABLEKS R43 R13 K62 ["GROUP_PACKAGES"]
  GETTABLEKS R42 R43 K61 ["name"]
  LOADB R43 1
  SETTABLE R43 R41 R42
  GETTABLEKS R43 R13 K63 ["CREATIONS_GROUP_PACKAGES"]
  GETTABLEKS R42 R43 K61 ["name"]
  LOADB R43 1
  SETTABLE R43 R41 R42
  MOVE R40 R41
  ...
  CAPTURE VAL R14
  CAPTURE VAL R35
  SETTABLEKS R41 R38 K64 ["init"]
  DUPCLOSURE R41 K65 [PROTO_8]
  CAPTURE VAL R0
  SETTABLEKS R41 R38 K66 ["willUpdate"]
  NEWCLOSURE R41 P2
  CAPTURE VAL R0
  CAPTURE REF R11
  CAPTURE VAL R17
  ...
  CAPTURE VAL R14
  CAPTURE VAL R8
  SETTABLEKS R41 R38 K67 ["render"]
  DUPCLOSURE R41 K68 [PROTO_10]
  CAPTURE VAL R5
  CAPTURE VAL R9
  SETTABLEKS R41 R38 K69 ["checkRecentAssetInsertion"]
  DUPCLOSURE R41 K70 [PROTO_11]
  DUPCLOSURE R42 K71 [PROTO_12]
  DUPCLOSURE R43 K72 [PROTO_13]
  DUPCLOSURE R44 K73 [PROTO_15]
  SETTABLEKS R44 R38 K74 ["addTabRefreshCallback"]
  DUPCLOSURE R44 K75 [PROTO_16]
  SETTABLEKS R44 R38 K76 ["removeTabRefreshCallback"]
  DUPCLOSURE R44 K77 [PROTO_17]
  CAPTURE VAL R0
  SETTABLEKS R44 R38 K78 ["didMount"]
  DUPCLOSURE R44 K79 [PROTO_18]
  SETTABLEKS R44 R38 K80 ["willUnmount"]
  MOVE R44 R22
  DUPTABLE R45 K84 [{"IXP", "Settings", "Stylizer", "Localization", "Network"}]
  JUMPIF R0 [+6]
  MOVE R47 R33
  CALL R47 0 1
  JUMPIF R47 [+3]
  ...
  JUMP [+1]
  LOADNIL R46
  SETTABLEKS R46 R45 K81 ["IXP"]
  SETTABLEKS R23 R45 K36 ["Settings"]
  GETTABLEKS R46 R21 K82 ["Stylizer"]
  SETTABLEKS R46 R45 K82 ["Stylizer"]
  GETTABLEKS R46 R21 K19 ["Localization"]
  SETTABLEKS R46 R45 K19 ["Localization"]
  SETTABLEKS R24 R45 K83 ["Network"]
  CALL R44 1 1
  MOVE R45 R38
  CALL R44 1 1
  MOVE R38 R44
  DUPCLOSURE R44 K85 [PROTO_19]
  SETGLOBAL R44 K86 ["isSearchFiltered"]
  DUPCLOSURE R44 K87 [PROTO_20]
  CAPTURE VAL R13
  CAPTURE VAL R33
  CAPTURE VAL R35
  CAPTURE VAL R36
