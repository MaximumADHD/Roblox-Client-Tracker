...
MAIN:
  ...
  GETTABLEKS R39 R1 K12 ["Core"]
  GETTABLEKS R38 R39 K13 ["Util"]
  GETTABLEKS R37 R38 K53 ["ToolboxCommunication"]
  CALL R36 1 1
  GETTABLEKS R37 R3 K54 ["PureComponent"]
  LOADK R39 K55 ["Header"]
  NAMECALL R37 R37 K56 ["extend"]
  CALL R37 2 1
  GETIMPORT R38 K58 [settings]
  LOADNIL R39
  JUMPIFNOT R0 [+21]
  NEWTABLE R40 4 0
  GETTABLEKS R42 R13 K59 ["MY_PACKAGES"]
  GETTABLEKS R41 R42 K60 ["name"]
  LOADB R42 1
  SETTABLE R42 R40 R41
  GETTABLEKS R42 R13 K61 ["GROUP_PACKAGES"]
  GETTABLEKS R41 R42 K60 ["name"]
  LOADB R42 1
  SETTABLE R42 R40 R41
  GETTABLEKS R42 R13 K62 ["CREATIONS_GROUP_PACKAGES"]
  GETTABLEKS R41 R42 K60 ["name"]
  LOADB R42 1
  SETTABLE R42 R40 R41
  MOVE R39 R40
  ...
  CAPTURE VAL R14
  CAPTURE VAL R35
  SETTABLEKS R40 R37 K63 ["init"]
  DUPCLOSURE R40 K64 [PROTO_8]
  CAPTURE VAL R0
  SETTABLEKS R40 R37 K65 ["willUpdate"]
  NEWCLOSURE R40 P2
  CAPTURE VAL R0
  CAPTURE REF R11
  CAPTURE VAL R17
  ...
  CAPTURE VAL R14
  CAPTURE VAL R8
  SETTABLEKS R40 R37 K66 ["render"]
  DUPCLOSURE R40 K67 [PROTO_10]
  CAPTURE VAL R5
  CAPTURE VAL R9
  SETTABLEKS R40 R37 K68 ["checkRecentAssetInsertion"]
  DUPCLOSURE R40 K69 [PROTO_11]
  DUPCLOSURE R41 K70 [PROTO_12]
  DUPCLOSURE R42 K71 [PROTO_13]
  DUPCLOSURE R43 K72 [PROTO_15]
  SETTABLEKS R43 R37 K73 ["addTabRefreshCallback"]
  DUPCLOSURE R43 K74 [PROTO_16]
  SETTABLEKS R43 R37 K75 ["removeTabRefreshCallback"]
  DUPCLOSURE R43 K76 [PROTO_17]
  CAPTURE VAL R0
  SETTABLEKS R43 R37 K77 ["didMount"]
  DUPCLOSURE R43 K78 [PROTO_18]
  SETTABLEKS R43 R37 K79 ["willUnmount"]
  MOVE R43 R22
  DUPTABLE R44 K83 [{"IXP", "Settings", "Stylizer", "Localization", "Network"}]
  JUMPIF R0 [+6]
  MOVE R46 R33
  CALL R46 0 1
  JUMPIF R46 [+3]
  ...
  JUMP [+1]
  LOADNIL R45
  SETTABLEKS R45 R44 K80 ["IXP"]
  SETTABLEKS R23 R44 K36 ["Settings"]
  GETTABLEKS R45 R21 K81 ["Stylizer"]
  SETTABLEKS R45 R44 K81 ["Stylizer"]
  GETTABLEKS R45 R21 K19 ["Localization"]
  SETTABLEKS R45 R44 K19 ["Localization"]
  SETTABLEKS R24 R44 K82 ["Network"]
  CALL R43 1 1
  MOVE R44 R37
  CALL R43 1 1
  MOVE R37 R43
  DUPCLOSURE R43 K84 [PROTO_19]
  SETGLOBAL R43 K85 ["isSearchFiltered"]
  DUPCLOSURE R43 K86 [PROTO_20]
  CAPTURE VAL R13
  CAPTURE VAL R33
  CAPTURE VAL R35
  DUPCLOSURE R44 K87 [PROTO_26]
  CAPTURE VAL R30
  CAPTURE VAL R31
  CAPTURE VAL R29
  CAPTURE VAL R33
