...
MAIN:
  ...
  GETTABLEKS R41 R1 K12 ["Core"]
  GETTABLEKS R40 R41 K13 ["Util"]
  GETTABLEKS R39 R40 K56 ["ToolboxCommunication"]
  CALL R38 1 1
  GETTABLEKS R39 R3 K57 ["PureComponent"]
  LOADK R41 K58 ["Header"]
  NAMECALL R39 R39 K59 ["extend"]
  CALL R39 2 1
  GETIMPORT R40 K61 [settings]
  LOADNIL R41
  JUMPIFNOT R0 [+30]
  NEWTABLE R42 4 0
  GETTABLEKS R44 R15 K62 ["MY_PACKAGES"]
  GETTABLEKS R43 R44 K63 ["name"]
  LOADB R44 1
  SETTABLE R44 R42 R43
  GETTABLEKS R44 R15 K64 ["GROUP_PACKAGES"]
  GETTABLEKS R43 R44 K63 ["name"]
  LOADB R44 1
  SETTABLE R44 R42 R43
  GETTABLEKS R44 R15 K65 ["CREATIONS_GROUP_PACKAGES"]
  GETTABLEKS R43 R44 K63 ["name"]
  LOADB R44 1
  SETTABLE R44 R42 R43
  MOVE R41 R42
  ...
  CALL R42 0 1
  JUMPIFNOT R42 [+6]
  GETTABLEKS R43 R15 K66 ["SHARED_PACKAGES"]
  GETTABLEKS R42 R43 K63 ["name"]
  LOADB R43 1
  ...
  CAPTURE VAL R16
  CAPTURE VAL R37
  SETTABLEKS R42 R39 K67 ["init"]
  DUPCLOSURE R42 K68 [PROTO_8]
  CAPTURE VAL R0
  SETTABLEKS R42 R39 K69 ["willUpdate"]
  NEWCLOSURE R42 P2
  CAPTURE VAL R0
  CAPTURE REF R11
  CAPTURE VAL R19
  ...
  CAPTURE VAL R16
  CAPTURE VAL R8
  SETTABLEKS R42 R39 K70 ["render"]
  DUPCLOSURE R42 K71 [PROTO_10]
  CAPTURE VAL R5
  CAPTURE VAL R9
  SETTABLEKS R42 R39 K72 ["checkRecentAssetInsertion"]
  DUPCLOSURE R42 K73 [PROTO_11]
  DUPCLOSURE R43 K74 [PROTO_12]
  DUPCLOSURE R44 K75 [PROTO_13]
  DUPCLOSURE R45 K76 [PROTO_15]
  SETTABLEKS R45 R39 K77 ["addTabRefreshCallback"]
  DUPCLOSURE R45 K78 [PROTO_16]
  SETTABLEKS R45 R39 K79 ["removeTabRefreshCallback"]
  DUPCLOSURE R45 K80 [PROTO_17]
  CAPTURE VAL R0
  SETTABLEKS R45 R39 K81 ["didMount"]
  DUPCLOSURE R45 K82 [PROTO_18]
  SETTABLEKS R45 R39 K83 ["willUnmount"]
  MOVE R45 R24
  DUPTABLE R46 K87 [{"IXP", "Settings", "Stylizer", "Localization", "Network"}]
  JUMPIF R0 [+6]
  MOVE R48 R35
  CALL R48 0 1
  JUMPIF R48 [+3]
  ...
  JUMP [+1]
  LOADNIL R47
  SETTABLEKS R47 R46 K84 ["IXP"]
  SETTABLEKS R25 R46 K39 ["Settings"]
  GETTABLEKS R47 R23 K85 ["Stylizer"]
  SETTABLEKS R47 R46 K85 ["Stylizer"]
  GETTABLEKS R47 R23 K19 ["Localization"]
  SETTABLEKS R47 R46 K19 ["Localization"]
  SETTABLEKS R26 R46 K86 ["Network"]
  CALL R45 1 1
  MOVE R46 R39
  CALL R45 1 1
  MOVE R39 R45
  DUPCLOSURE R45 K88 [PROTO_19]
  SETGLOBAL R45 K89 ["isSearchFiltered"]
  DUPCLOSURE R45 K90 [PROTO_20]
  CAPTURE VAL R15
  CAPTURE VAL R35
  CAPTURE VAL R37
