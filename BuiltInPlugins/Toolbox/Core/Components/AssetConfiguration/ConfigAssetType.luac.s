...
PROTO_40:
  ...
  CALL R1 2 2
  GETUPVAL R4 1
  GETTABLEKS R3 R4 K4 ["isFolderStructureEnabled"]
  JUMPIFNOT R3 [+51]
  GETUPVAL R4 1
  GETTABLEKS R3 R4 K4 ["isFolderStructureEnabled"]
  CALL R3 0 1
  JUMPIFNOT R3 [+46]
  GETUPVAL R4 1
  GETTABLEKS R3 R4 K5 ["ValidateAsset"]
  MOVE R4 R0
  GETUPVAL R6 2
  GETTABLEKS R5 R6 K2 ["instances"]
  CALL R4 1 1
  GETUPVAL R6 3
  GETTABLEKS R5 R6 K3 ["currentAssetType"]
  DUPTABLE R6 K10 [{"source", "enforceR15FolderStructure", "telemetry_bundle_id", "telemetry_root_id"}]
  LOADK R7 K11 ["Toolbox"]
  SETTABLEKS R7 R6 K6 ["source"]
  LOADB R7 0
  SETTABLEKS R7 R6 K7 ["enforceR15FolderStructure"]
  LOADK R7 K12 [""]
  SETTABLEKS R7 R6 K8 ["telemetry_bundle_id"]
  LOADK R7 K12 [""]
  SETTABLEKS R7 R6 K9 ["telemetry_root_id"]
  CALL R3 3 1
  GETUPVAL R5 1
  ...
  JUMPIFNOT R4 [+12]
  GETUPVAL R5 1
  GETTABLEKS R4 R5 K14 ["combineResultsIntoLegacy"]
  MOVE R5 R1
  MOVE R6 R2
  MOVE R7 R3
  NEWCLOSURE R8 P1
  ...
  MOVE R2 R5
  GETUPVAL R4 5
  GETTABLEKS R3 R4 K15 ["validationCallback"]
  MOVE R4 R1
  MOVE R5 R2
  CALL R3 2 0
  RETURN R0 0
...
MAIN:
  ...
  CALL R45 1 1
  GETIMPORT R46 K5 [game]
  LOADK R48 K62 ["ToolboxConfigAssetTypeAgeIDVerificationLink"]
  LOADK R49 K63 ["https://en.help.roblox.com/hc/en-us/articles/4407282410644-Age-ID-Verification"]
  NAMECALL R46 R46 K64 ["DefineFastString"]
  CALL R46 3 1
  GETIMPORT R47 K5 [game]
  LOADK R49 K65 ["ToolboxConfigAssetTypePremiumLink"]
  LOADK R50 K66 ["https://www.roblox.com/premium/membership"]
  NAMECALL R47 R47 K64 ["DefineFastString"]
  CALL R47 3 1
  GETIMPORT R48 K5 [game]
  LOADK R50 K67 ["ToolboxFixUGCBundleValidationCryoThingy1"]
  LOADB R51 0
  NAMECALL R48 R48 K52 ["DefineFastFlag"]
  CALL R48 3 1
  GETIMPORT R49 K5 [game]
  LOADK R51 K68 ["ToolboxShowAnimationAssetSelection"]
  LOADB R52 0
  NAMECALL R49 R49 K52 ["DefineFastFlag"]
  CALL R49 3 1
  GETIMPORT R50 K5 [game]
  LOADK R52 K69 ["ToolboxRemoveRestrictedAssetWarning2"]
  NAMECALL R50 R50 K70 ["GetFastFlag"]
  CALL R50 2 1
  GETIMPORT R51 K10 [require]
  GETTABLEKS R54 R0 K18 ["Core"]
  GETTABLEKS R53 R54 K56 ["Flags"]
  GETTABLEKS R52 R53 K71 ["getFFlagEnableUploadingEmote"]
  CALL R51 1 1
  ...
  NAMECALL R56 R56 K70 ["GetFastFlag"]
  CALL R56 2 1
  JUMPIFNOT R56 [+22]
  NEWTABLE R56 0 3
  ...
  CAPTURE VAL R12
  CAPTURE VAL R38
  SETTABLEKS R57 R52 K81 ["init"]
  DUPCLOSURE R57 K82 [PROTO_15]
  SETTABLEKS R57 R52 K83 ["getAvatarItemCategoryErrorsPrimaryText"]
  DUPCLOSURE R57 K84 [PROTO_16]
  SETTABLEKS R57 R52 K85 ["getAvatarItemCategoryErrors"]
  DUPCLOSURE R57 K86 [PROTO_17]
  SETTABLEKS R57 R52 K87 ["selectedRadioButtonKeyFor"]
  DUPCLOSURE R57 K88 [PROTO_18]
  SETTABLEKS R57 R52 K89 ["isAvatarItemCategorySelected"]
  DUPCLOSURE R57 K90 [PROTO_22]
  CAPTURE VAL R3
  CAPTURE VAL R42
  CAPTURE VAL R13
  CAPTURE VAL R36
  SETTABLEKS R57 R52 K91 ["onAssetTypeChanged"]
  DUPCLOSURE R57 K92 [PROTO_24]
  CAPTURE VAL R36
  CAPTURE VAL R3
  SETTABLEKS R57 R52 K93 ["resetValidation"]
  DUPCLOSURE R57 K94 [PROTO_25]
  SETTABLEKS R57 R52 K95 ["cancelValidationTasks"]
  DUPCLOSURE R57 K96 [PROTO_26]
  SETTABLEKS R57 R52 K97 ["getErrorMessageWithCount"]
  DUPCLOSURE R57 K98 [PROTO_27]
  CAPTURE VAL R36
  SETTABLEKS R57 R52 K99 ["getValidationStatusMessage"]
  DUPCLOSURE R57 K100 [PROTO_28]
  CAPTURE VAL R36
  SETTABLEKS R57 R52 K101 ["getValidationStatusColor"]
  DUPCLOSURE R57 K102 [PROTO_29]
  SETTABLEKS R57 R52 K103 ["getAssetCategoryIndex"]
  NEWCLOSURE R57 P13
  CAPTURE VAL R13
  CAPTURE REF R55
  CAPTURE VAL R19
  CAPTURE VAL R20
  SETTABLEKS R57 R52 K104 ["getDropdownItemsFor"]
  DUPCLOSURE R57 K105 [PROTO_32]
  SETTABLEKS R57 R52 K106 ["getDropdownItems"]
  DUPCLOSURE R57 K107 [PROTO_33]
  CAPTURE VAL R13
  CAPTURE VAL R21
  CAPTURE VAL R5
  CAPTURE VAL R25
  CAPTURE VAL R15
  CAPTURE VAL R20
  SETTABLEKS R57 R52 K108 ["getMissingOptionalPartsMessage"]
  DUPCLOSURE R57 K109 [PROTO_34]
  CAPTURE VAL R13
  CAPTURE VAL R21
  CAPTURE VAL R5
  CAPTURE VAL R25
  CAPTURE VAL R15
  SETTABLEKS R57 R52 K110 ["getUnknownMeshPartMessage"]
  MOVE R57 R42
  CALL R57 0 1
  JUMPIFNOT R57 [+7]
  DUPCLOSURE R57 K111 [PROTO_37]
  CAPTURE VAL R1
  CAPTURE VAL R46
  CAPTURE VAL R47
  CAPTURE VAL R50
  SETTABLEKS R57 R52 K112 ["getUgcRestrictionsWarningText"]
  DUPCLOSURE R57 K113 [PROTO_41]
  CAPTURE VAL R36
  CAPTURE VAL R13
  CAPTURE VAL R14
  CAPTURE VAL R7
  SETTABLEKS R57 R52 K114 ["didUpdate"]
  DUPCLOSURE R57 K115 [PROTO_42]
  SETTABLEKS R57 R52 K116 ["willUnmount"]
  DUPCLOSURE R57 K117 [PROTO_44]
  CAPTURE VAL R21
  CAPTURE VAL R36
  CAPTURE VAL R15
  CAPTURE VAL R42
  ...
  CAPTURE VAL R25
  CAPTURE VAL R45
  SETTABLEKS R57 R52 K118 ["render"]
  DUPCLOSURE R57 K119 [PROTO_45]
  DUPCLOSURE R58 K120 [PROTO_48]
  CAPTURE VAL R27
  CAPTURE VAL R28
  MOVE R59 R9
  DUPTABLE R60 K122 [{"Stylizer", "Localization"}]
  GETTABLEKS R61 R8 K121 ["Stylizer"]
  SETTABLEKS R61 R60 K121 ["Stylizer"]
  GETTABLEKS R61 R8 K30 ["Localization"]
  SETTABLEKS R61 R60 K30 ["Localization"]
  CALL R59 1 1
  MOVE R60 R52
  CALL R59 1 1
  MOVE R52 R59
  GETTABLEKS R59 R6 K123 ["connect"]
  MOVE R60 R57
  MOVE R61 R58
  CALL R59 2 1
  MOVE R60 R52
