...
function Permissions:renderContent(theme, localization, localized)
	...
	local canViewCollaborators = self.props.CurrentUserPackagePermission == PermissionsConstants.OwnKey
		or self.props.CurrentUserPackagePermission == PermissionsConstants.EditKey
	...
	return Roact.createElement(ScrollingFrame, {
		...
		SearchbarWidget = canManagePermissions
			and isUserOwnedPackage
			and Roact.createElement(CollaboratorSearchWidget, {
				LayoutOrder = orderIterator:getNextOrder(),
				Enabled = true,
		...
		RevokedWarningMessage = canManagePermissions and Roact.createElement("TextLabel", {
			...
			Text = isUserOwnedPackage and localized.PackagePermissions.Warning.UserOwned
				or localized.PackagePermissions.Warning.GroupOwned,
		...
		CollaboratorListWidget = canViewCollaborators
			and isUserOwnedPackage
			and Roact.createElement(CollaboratorsWidget, {
				LayoutOrder = orderIterator:getNextOrder(),
				Enabled = true,
