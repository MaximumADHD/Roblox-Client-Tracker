...
MAIN:
  ...
  GETTABLEKS R19 R20 K26 ["getFFlagToolboxCleanupLegacyContext"]
  CALL R18 1 1
  DUPCLOSURE R19 K27 [PROTO_0]
  GETTABLEKS R20 R2 K28 ["PureComponent"]
  LOADK R22 K29 ["CollaboratorsWidget"]
  ...
  CAPTURE VAL R8
  SETTABLEKS R21 R20 K34 ["render"]
  MOVE R22 R18
  CALL R22 0 1
  JUMPIFNOT R22 [+2]
  LOADK R21 K34 ["render"]
  JUMP [+1]
  LOADK R21 K35 ["renderContent"]
  ...
  MOVE R21 R11
  DUPTABLE R22 K39 [{"Stylizer", "Localization"}]
  GETTABLEKS R23 R10 K37 ["Stylizer"]
  SETTABLEKS R23 R22 K37 ["Stylizer"]
  GETTABLEKS R23 R10 K38 ["Localization"]
