...
MAIN:
  ...
  GETTABLEKS R30 R0 K10 ["Core"]
  GETTABLEKS R29 R30 K11 ["Util"]
  GETTABLEKS R28 R29 K37 ["SharedFlags"]
  GETTABLEKS R27 R28 K38 ["getFFlagToolboxCleanupLegacyContext"]
  CALL R26 1 1
  LOADN R29 5
  GETTABLEKS R30 R8 K40 ["FONT_SIZE_MEDIUM"]
  ADD R28 R29 R30
  ADDK R27 R28 K39 [5]
  GETTABLEKS R28 R2 K41 ["PureComponent"]
  LOADK R30 K42 ["TagsComponent"]
  NAMECALL R28 R28 K43 ["extend"]
  CALL R28 2 1
  DUPCLOSURE R29 K44 [PROTO_6]
  CAPTURE VAL R2
  CAPTURE VAL R10
  SETTABLEKS R29 R28 K45 ["init"]
  DUPCLOSURE R29 K46 [PROTO_7]
  SETTABLEKS R29 R28 K47 ["canAddTags"]
  DUPCLOSURE R29 K48 [PROTO_8]
  CAPTURE VAL R11
  CAPTURE VAL R4
  SETTABLEKS R29 R28 K49 ["addTag"]
  DUPCLOSURE R29 K50 [PROTO_9]
  SETTABLEKS R29 R28 K51 ["removeTag"]
  DUPCLOSURE R29 K52 [PROTO_10]
  SETTABLEKS R29 R28 K53 ["getDropdownItems"]
  DUPCLOSURE R29 K54 [PROTO_11]
  SETTABLEKS R29 R28 K55 ["clearSuggestions"]
  DUPCLOSURE R29 K56 [PROTO_12]
  SETTABLEKS R29 R28 K57 ["didMount"]
  MOVE R29 R26
  CALL R29 0 1
  JUMPIF R29 [+4]
  DUPCLOSURE R29 K58 [PROTO_14]
  CAPTURE VAL R25
  SETTABLEKS R29 R28 K59 ["render"]
  MOVE R30 R26
  CALL R30 0 1
  JUMPIFNOT R30 [+2]
  LOADK R29 K59 ["render"]
  JUMP [+1]
  LOADK R29 K60 ["renderContents"]
  DUPCLOSURE R30 K61 [PROTO_19]
  CAPTURE VAL R8
  CAPTURE VAL R16
  CAPTURE VAL R2
  CAPTURE VAL R22
  ...
  DUPCLOSURE R29 K62 [PROTO_20]
  DUPCLOSURE R30 K63 [PROTO_23]
  CAPTURE VAL R23
  CAPTURE VAL R24
  MOVE R31 R13
  DUPTABLE R32 K67 [{"Stylizer", "Localization", "Network"}]
  GETTABLEKS R33 R12 K64 ["Stylizer"]
  SETTABLEKS R33 R32 K64 ["Stylizer"]
  GETTABLEKS R33 R12 K65 ["Localization"]
  SETTABLEKS R33 R32 K65 ["Localization"]
  SETTABLEKS R14 R32 K66 ["Network"]
  CALL R31 1 1
  MOVE R32 R28
  CALL R31 1 1
  MOVE R28 R31
  GETTABLEKS R31 R3 K68 ["connect"]
  MOVE R32 R29
  MOVE R33 R30
  CALL R31 2 1
  MOVE R32 R28
