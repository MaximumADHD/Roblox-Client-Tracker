...
PROTO_9:
  ...
  GETTABLEKS R8 R4 K5 ["Items"]
  GETTABLEKS R9 R4 K6 ["ItemHeight"]
  GETTABLEKS R10 R4 K7 ["CurrentTab"]
  GETTABLEKS R11 R4 K8 ["SelectParentRef"]
  GETTABLEKS R12 R1 K9 ["sideTab"]
  MOVE R15 R8
  MOVE R16 R10
  MOVE R17 R9
  MOVE R18 R1
  ...
  MOVE R20 R11
  MOVE R21 R12
  NAMECALL R13 R0 K10 ["createSideButtons"]
  CALL R13 8 1
  GETUPVAL R15 0
  GETTABLEKS R14 R15 K11 ["createElement"]
  LOADK R15 K12 ["Frame"]
  DUPTABLE R16 K15 [{"Position", "Size", "BackgroundTransparency", "BorderSizePixel", "LayoutOrder"}]
  SETTABLEKS R7 R16 K4 ["Position"]
  SETTABLEKS R6 R16 K3 ["Size"]
  LOADN R17 1
  SETTABLEKS R17 R16 K13 ["BackgroundTransparency"]
  LOADN R17 0
  SETTABLEKS R17 R16 K14 ["BorderSizePixel"]
  SETTABLEKS R5 R16 K2 ["LayoutOrder"]
  MOVE R17 R13
  CALL R14 3 -1
  RETURN R14 -1
...
MAIN:
  ...
  CAPTURE VAL R7
  CAPTURE VAL R8
  SETTABLEKS R14 R13 K25 ["createSideButtons"]
  DUPCLOSURE R14 K26 [PROTO_8]
  CAPTURE VAL R10
  SETTABLEKS R14 R13 K27 ["render"]
  DUPCLOSURE R14 K28 [PROTO_9]
  CAPTURE VAL R2
  SETTABLEKS R14 R13 K29 ["renderContent"]
  DUPCLOSURE R14 K30 [PROTO_11]
  MOVE R15 R12
  DUPTABLE R16 K32 [{"Stylizer", "Localization"}]
  GETTABLEKS R17 R11 K31 ["Stylizer"]
  SETTABLEKS R17 R16 K31 ["Stylizer"]
  GETTABLEKS R17 R11 K14 ["Localization"]
  SETTABLEKS R17 R16 K14 ["Localization"]
  CALL R15 1 1
  MOVE R16 R13
  CALL R15 1 1
  MOVE R13 R15
  GETTABLEKS R15 R3 K33 ["connect"]
  MOVE R16 R14
  CALL R15 1 1
  MOVE R16 R13
  CALL R15 1 -1
