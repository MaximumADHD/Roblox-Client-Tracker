...
MAIN:
  ...
  GETTABLEKS R5 R6 K14 ["getFFlagToolboxUseGetAllowedItemTypes"]
  CALL R4 1 1
  GETTABLEKS R5 R0 K15 ["Packages"]
  GETIMPORT R6 K11 [require]
  GETTABLEKS R7 R5 K16 ["Roact"]
  CALL R6 1 1
  GETIMPORT R7 K11 [require]
  GETTABLEKS R8 R5 K17 ["RoactRodux"]
  CALL R7 1 1
  GETIMPORT R8 K11 [require]
  GETTABLEKS R9 R5 K18 ["Framework"]
  CALL R8 1 1
  ...
  GETTABLEKS R11 R12 K22 ["AssetConfiguration"]
  GETIMPORT R12 K11 [require]
  GETTABLEKS R13 R11 K23 ["SalesComponent"]
  CALL R12 1 1
  MOVE R14 R4
  CALL R14 0 1
  JUMPIFNOT R14 [+2]
  ...
  GETTABLEKS R23 R20 K35 ["LayoutOrderIterator"]
  CALL R22 1 1
  GETIMPORT R23 K11 [require]
  GETTABLEKS R24 R20 K36 ["AssetConfigUtil"]
  CALL R23 1 1
  GETIMPORT R24 K11 [require]
  GETTABLEKS R25 R20 K37 ["AssetConfigConstants"]
  CALL R24 1 1
  JUMPIFNOT R3 [+2]
  LOADN R25 30
  JUMP [+1]
  ...
  JUMP [+1]
  LOADNIL R26
  GETTABLEKS R27 R6 K38 ["PureComponent"]
  LOADK R29 K39 ["SalesPage"]
  ...
  DUPCLOSURE R28 K43 [PROTO_2]
  CAPTURE VAL R24
  SETTABLEKS R28 R27 K44 ["didMount"]
  DUPCLOSURE R28 K45 [PROTO_3]
  CAPTURE VAL R24
  SETTABLEKS R28 R27 K46 ["willUpdate"]
  JUMPIFNOT R3 [+9]
  ...
  CAPTURE VAL R26
  CAPTURE VAL R21
  SETTABLEKS R28 R27 K48 ["renderCreatorDashboardLinkContent"]
  DUPCLOSURE R28 K49 [PROTO_7]
  CAPTURE VAL R3
  CAPTURE VAL R23
  CAPTURE VAL R1
  CAPTURE VAL R19
  ...
  CAPTURE VAL R21
  CAPTURE VAL R2
  SETTABLEKS R28 R27 K50 ["render"]
  DUPCLOSURE R28 K51 [PROTO_8]
  DUPCLOSURE R29 K52 [PROTO_10]
  CAPTURE VAL R14
  CAPTURE VAL R24
  MOVE R30 R10
  DUPTABLE R31 K55 [{"Stylizer", "Localization"}]
  GETTABLEKS R32 R9 K53 ["Stylizer"]
  SETTABLEKS R32 R31 K53 ["Stylizer"]
  GETTABLEKS R32 R9 K54 ["Localization"]
  SETTABLEKS R32 R31 K54 ["Localization"]
  CALL R30 1 1
  MOVE R31 R27
  CALL R30 1 1
  MOVE R27 R30
  GETTABLEKS R30 R7 K56 ["connect"]
  MOVE R31 R28
  MOVE R32 R29
  CALL R30 2 1
  MOVE R31 R27
