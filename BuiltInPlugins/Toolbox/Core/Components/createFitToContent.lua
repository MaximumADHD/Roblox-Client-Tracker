...
-- TODO Delete this file once Toolbox's RadioButtons.lua & SearchOptionsEntry.lua are replaced with DF components. This model is deprecated in favor of AutomaticSize in-engine.
