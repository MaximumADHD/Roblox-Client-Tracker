...
MAIN:
  ...
  GETTABLEKS R10 R11 K18 ["ContextHelper"]
  CALL R9 1 1
  ...
  GETTABLEKS R14 R15 K12 ["ContextServices"]
  GETTABLEKS R13 R14 K21 ["ModalContext"]
  CALL R12 1 1
  GETIMPORT R13 K9 [require]
  GETTABLEKS R16 R1 K14 ["Core"]
  GETTABLEKS R15 R16 K22 ["Components"]
  GETTABLEKS R14 R15 K23 ["TooltipWrapper"]
  CALL R13 1 1
  GETTABLEKS R14 R3 K24 ["PureComponent"]
  LOADK R16 K25 ["VerifiedCreatorBadge"]
  ...
  MOVE R15 R6
  DUPTABLE R16 K34 [{"Localization", "Stylizer", "Modal"}]
  GETTABLEKS R17 R5 K31 ["Localization"]
  SETTABLEKS R17 R16 K31 ["Localization"]
  GETTABLEKS R17 R5 K32 ["Stylizer"]
  SETTABLEKS R17 R16 K32 ["Stylizer"]
  SETTABLEKS R12 R16 K33 ["Modal"]
  CALL R15 1 1
  MOVE R16 R14
  CALL R15 1 1
  MOVE R14 R15
