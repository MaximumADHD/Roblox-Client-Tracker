...
MAIN:
  ...
  GETTABLEKS R36 R34 K48 ["UpdatePageInfoAndSendRequest"]
  CALL R35 1 1
  GETIMPORT R36 K4 [require]
  GETTABLEKS R37 R34 K49 ["ChangeMarketplaceTab"]
  CALL R36 1 1
  GETIMPORT R37 K4 [require]
  GETTABLEKS R38 R34 K50 ["GetToolboxManageableGroupsRequest"]
  CALL R37 1 1
  GETIMPORT R38 K4 [require]
  GETTABLEKS R39 R34 K51 ["GetRolesRequest"]
  CALL R38 1 1
  GETIMPORT R39 K4 [require]
  GETTABLEKS R40 R34 K52 ["GetRolesDebugRequest"]
  CALL R39 1 1
  GETIMPORT R40 K4 [require]
  GETTABLEKS R41 R34 K53 ["GetRobuxBalance"]
  CALL R40 1 1
  GETIMPORT R41 K4 [require]
  GETTABLEKS R44 R0 K5 ["Core"]
  GETTABLEKS R43 R44 K54 ["ContextServices"]
  GETTABLEKS R42 R43 K55 ["IXPContext"]
  CALL R41 1 1
  GETTABLEKS R42 R10 K54 ["ContextServices"]
  GETTABLEKS R43 R42 K56 ["withContext"]
  GETIMPORT R44 K4 [require]
  GETTABLEKS R47 R0 K5 ["Core"]
  GETTABLEKS R46 R47 K54 ["ContextServices"]
  GETTABLEKS R45 R46 K57 ["Settings"]
  CALL R44 1 1
  GETIMPORT R45 K4 [require]
  GETTABLEKS R48 R0 K5 ["Core"]
  GETTABLEKS R47 R48 K54 ["ContextServices"]
  GETTABLEKS R46 R47 K58 ["ModalContext"]
  CALL R45 1 1
  GETIMPORT R46 K4 [require]
  GETTABLEKS R49 R0 K5 ["Core"]
  GETTABLEKS R48 R49 K54 ["ContextServices"]
  GETTABLEKS R47 R48 K59 ["NetworkContext"]
  CALL R46 1 1
  GETIMPORT R47 K4 [require]
  GETTABLEKS R50 R0 K5 ["Core"]
  GETTABLEKS R49 R50 K29 ["Types"]
  GETTABLEKS R48 R49 K60 ["HomeTypes"]
  CALL R47 1 1
  GETIMPORT R48 K4 [require]
  GETTABLEKS R51 R0 K5 ["Core"]
  GETTABLEKS R50 R51 K61 ["Actions"]
  GETTABLEKS R49 R50 K62 ["SetLayoutMode"]
  CALL R48 1 1
  GETIMPORT R49 K4 [require]
  GETTABLEKS R52 R0 K5 ["Core"]
  GETTABLEKS R51 R52 K63 ["Thunks"]
  GETTABLEKS R50 R51 K64 ["LogMarketplaceSearchAnalytics"]
  CALL R49 1 1
  GETIMPORT R50 K12 [game]
  LOADK R52 K65 ["DebugToolboxGetRolesRequest"]
  NAMECALL R50 R50 K14 ["GetFastFlag"]
  CALL R50 2 1
  GETIMPORT R51 K4 [require]
  GETTABLEKS R55 R0 K5 ["Core"]
  GETTABLEKS R54 R55 K6 ["Util"]
  GETTABLEKS R53 R54 K7 ["SharedFlags"]
  GETTABLEKS R52 R53 K66 ["getFFlagToolboxContentManagementCombineTabs"]
  CALL R51 1 1
  GETIMPORT R52 K4 [require]
  GETTABLEKS R56 R0 K5 ["Core"]
  GETTABLEKS R55 R56 K6 ["Util"]
  GETTABLEKS R54 R55 K7 ["SharedFlags"]
  GETTABLEKS R53 R54 K67 ["getFFlagToolboxEnableAssetRows"]
  CALL R52 1 1
  GETIMPORT R53 K4 [require]
  GETTABLEKS R57 R0 K5 ["Core"]
  GETTABLEKS R56 R57 K6 ["Util"]
  GETTABLEKS R55 R56 K7 ["SharedFlags"]
  GETTABLEKS R54 R55 K68 ["getIsIXPEnabledForListView"]
  CALL R53 1 1
  GETIMPORT R54 K4 [require]
  GETTABLEKS R58 R0 K5 ["Core"]
  GETTABLEKS R57 R58 K6 ["Util"]
  GETTABLEKS R56 R57 K7 ["SharedFlags"]
  GETTABLEKS R55 R56 K69 ["getFFlagToolboxUpdateSearchOptionsAnalytics"]
  CALL R54 1 1
  GETIMPORT R55 K4 [require]
  GETTABLEKS R58 R0 K5 ["Core"]
  GETTABLEKS R57 R58 K29 ["Types"]
  ...
  GETTABLEKS R60 R42 K94 ["Stylizer"]
  SETTABLEKS R60 R59 K94 ["Stylizer"]
  GETTABLEKS R60 R42 K95 ["Localization"]
  SETTABLEKS R60 R59 K95 ["Localization"]
  SETTABLEKS R44 R59 K57 ["Settings"]
  SETTABLEKS R45 R59 K96 ["Modal"]
  SETTABLEKS R46 R59 K97 ["Network"]
  CALL R58 1 1
  MOVE R59 R57
  CALL R58 1 1
  MOVE R57 R58
