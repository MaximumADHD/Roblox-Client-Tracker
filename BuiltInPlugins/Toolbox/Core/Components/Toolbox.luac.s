...
PROTO_15:
  ...
  JUMPIFNOTEQ R13 R25 [+42]
  JUMPIFNOT R6 [+2]
  JUMPIFNOTEQKS R6 K25 [""] [+39]
  JUMPIFNOTEQKS R7 K25 [""] [+37]
  JUMPIFNOTEQKNIL R10 [+35]
  JUMPIFNOTEQKNIL R11 [+33]
  GETUPVAL R26 0
  CALL R26 0 1
  JUMPIFNOT R26 [+5]
  JUMPIFEQKNIL R12 [+2]
...
MAIN:
  ...
  GETTABLEKS R58 R59 K72 ["getFFlagToolboxAddSortIntentFiltering"]
  CALL R57 1 1
  GETIMPORT R58 K4 [require]
  GETTABLEKS R61 R0 K5 ["Core"]
  GETTABLEKS R60 R61 K30 ["Types"]
  GETTABLEKS R59 R60 K73 ["LayoutMode"]
  CALL R58 1 1
  GETIMPORT R59 K4 [require]
  GETTABLEKS R62 R0 K5 ["Core"]
  GETTABLEKS R61 R62 K30 ["Types"]
  GETTABLEKS R60 R61 K74 ["Background"]
  CALL R59 1 1
  GETTABLEKS R60 R9 K75 ["PureComponent"]
  LOADK R62 K76 ["Toolbox"]
  NAMECALL R60 R60 K77 ["extend"]
  CALL R60 2 1
  DUPTABLE R61 K79 [{"Size"}]
  ...
  LOADN R66 0
  CALL R62 4 1
  SETTABLEKS R62 R61 K78 ["Size"]
  SETTABLEKS R61 R60 K83 ["defaultProps"]
  DUPCLOSURE R61 K84 [PROTO_0]
  CAPTURE VAL R54
  CAPTURE VAL R59
  CAPTURE VAL R22
  CAPTURE VAL R53
  ...
  CAPTURE VAL R55
  CAPTURE VAL R58
  SETTABLEKS R61 R60 K85 ["handleInitialSettings"]
  DUPCLOSURE R61 K86 [PROTO_8]
  CAPTURE VAL R15
  CAPTURE VAL R35
  CAPTURE VAL R56
  CAPTURE VAL R22
  ...
  CAPTURE VAL R16
  CAPTURE VAL R5
  SETTABLEKS R61 R60 K87 ["init"]
  DUPCLOSURE R61 K88 [PROTO_9]
  SETTABLEKS R61 R60 K89 ["didUpdate"]
  DUPCLOSURE R61 K90 [PROTO_13]
  CAPTURE VAL R13
  CAPTURE VAL R22
  CAPTURE VAL R18
  CAPTURE VAL R5
  CAPTURE VAL R6
  CAPTURE VAL R15
  SETTABLEKS R61 R60 K91 ["didMount"]
  DUPCLOSURE R61 K92 [PROTO_14]
  SETTABLEKS R61 R60 K93 ["willUnmount"]
  DUPCLOSURE R61 K94 [PROTO_15]
  CAPTURE VAL R57
  CAPTURE VAL R22
  CAPTURE VAL R15
  CAPTURE VAL R1
  ...
  CAPTURE VAL R28
  CAPTURE VAL R29
  SETTABLEKS R61 R60 K95 ["render"]
  MOVE R61 R45
  DUPTABLE R62 K101 [{"IXP", "Stylizer", "Localization", "Settings", "Modal", "Network"}]
  MOVE R64 R53
  CALL R64 0 1
  JUMPIF R64 [+3]
  MOVE R64 R54
  ...
  JUMP [+1]
  LOADNIL R63
  SETTABLEKS R63 R62 K96 ["IXP"]
  GETTABLEKS R63 R44 K97 ["Stylizer"]
  SETTABLEKS R63 R62 K97 ["Stylizer"]
  GETTABLEKS R63 R44 K98 ["Localization"]
  SETTABLEKS R63 R62 K98 ["Localization"]
  SETTABLEKS R46 R62 K59 ["Settings"]
  SETTABLEKS R47 R62 K99 ["Modal"]
  SETTABLEKS R48 R62 K100 ["Network"]
  CALL R61 1 1
  MOVE R62 R60
  CALL R61 1 1
  MOVE R60 R61
  DUPCLOSURE R61 K102 [PROTO_16]
  CAPTURE VAL R22
  CAPTURE VAL R57
  CAPTURE VAL R8
  CAPTURE VAL R4
  DUPCLOSURE R62 K103 [PROTO_24]
  CAPTURE VAL R52
  CAPTURE VAL R41
  CAPTURE VAL R40
  CAPTURE VAL R37
  ...
  CAPTURE VAL R54
  CAPTURE VAL R50
  GETTABLEKS R63 R10 K104 ["connect"]
  MOVE R64 R61
  MOVE R65 R62
  CALL R63 2 1
  MOVE R64 R60
