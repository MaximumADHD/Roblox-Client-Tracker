...
MAIN:
  ...
  GETTABLEKS R54 R55 K68 ["getFFlagToolboxUpdateSearchOptionsAnalytics"]
  CALL R53 1 1
  GETIMPORT R54 K4 [require]
  GETTABLEKS R57 R0 K5 ["Core"]
  GETTABLEKS R56 R57 K28 ["Types"]
  GETTABLEKS R55 R56 K69 ["LayoutMode"]
  CALL R54 1 1
  GETIMPORT R55 K4 [require]
  GETTABLEKS R58 R0 K5 ["Core"]
  GETTABLEKS R57 R58 K28 ["Types"]
  GETTABLEKS R56 R57 K70 ["Background"]
  CALL R55 1 1
  GETTABLEKS R56 R7 K71 ["PureComponent"]
  LOADK R58 K72 ["Toolbox"]
  NAMECALL R56 R56 K73 ["extend"]
  CALL R56 2 1
  DUPTABLE R57 K75 [{"Size"}]
  GETIMPORT R58 K78 [UDim2.new]
  LOADN R59 1
  LOADN R60 0
  LOADN R61 1
  LOADN R62 0
  ...
  SETTABLEKS R57 R56 K79 ["defaultProps"]
  DUPCLOSURE R57 K80 [PROTO_0]
  CAPTURE VAL R51
  CAPTURE VAL R55
  CAPTURE VAL R20
  CAPTURE VAL R50
  ...
  CAPTURE VAL R52
  CAPTURE VAL R54
  SETTABLEKS R57 R56 K81 ["handleInitialSettings"]
  DUPCLOSURE R57 K82 [PROTO_8]
  CAPTURE VAL R13
  CAPTURE VAL R53
  CAPTURE VAL R20
  CAPTURE VAL R16
  ...
  DUPCLOSURE R57 K84 [PROTO_9]
  SETTABLEKS R57 R56 K85 ["didUpdate"]
  DUPCLOSURE R57 K86 [PROTO_13]
  CAPTURE VAL R11
  CAPTURE VAL R20
  CAPTURE VAL R16
  CAPTURE VAL R3
  CAPTURE VAL R4
  CAPTURE VAL R13
  SETTABLEKS R57 R56 K87 ["didMount"]
  DUPCLOSURE R57 K88 [PROTO_14]
  SETTABLEKS R57 R56 K89 ["willUnmount"]
  DUPCLOSURE R57 K90 [PROTO_15]
  CAPTURE VAL R20
  CAPTURE VAL R13
  CAPTURE VAL R1
  CAPTURE VAL R7
  ...
  CAPTURE VAL R26
  CAPTURE VAL R27
  SETTABLEKS R57 R56 K91 ["render"]
  MOVE R57 R42
  DUPTABLE R58 K97 [{"IXP", "Stylizer", "Localization", "Settings", "Modal", "Network"}]
  MOVE R60 R50
  CALL R60 0 1
  JUMPIF R60 [+3]
  MOVE R60 R51
  ...
  JUMP [+1]
  LOADNIL R59
  SETTABLEKS R59 R58 K92 ["IXP"]
  GETTABLEKS R59 R41 K93 ["Stylizer"]
  SETTABLEKS R59 R58 K93 ["Stylizer"]
  GETTABLEKS R59 R41 K94 ["Localization"]
  SETTABLEKS R59 R58 K94 ["Localization"]
  SETTABLEKS R43 R58 K56 ["Settings"]
  SETTABLEKS R44 R58 K95 ["Modal"]
  SETTABLEKS R45 R58 K96 ["Network"]
  CALL R57 1 1
  MOVE R58 R56
  CALL R57 1 1
  MOVE R56 R57
  DUPCLOSURE R57 K98 [PROTO_16]
  CAPTURE VAL R20
  CAPTURE VAL R6
  DUPCLOSURE R58 K99 [PROTO_24]
  CAPTURE VAL R49
  CAPTURE VAL R38
  CAPTURE VAL R37
  CAPTURE VAL R34
  ...
  CAPTURE VAL R51
  CAPTURE VAL R47
  GETTABLEKS R59 R8 K100 ["connect"]
  MOVE R60 R57
  MOVE R61 R58
  CALL R59 2 1
  MOVE R60 R56
