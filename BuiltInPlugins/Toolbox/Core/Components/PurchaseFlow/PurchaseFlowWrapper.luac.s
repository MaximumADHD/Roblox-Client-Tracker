...
MAIN:
  ...
  GETTABLEKS R12 R13 K22 ["DebugFlags"]
  CALL R11 1 1
  GETIMPORT R12 K6 [require]
  GETTABLEKS R15 R0 K7 ["Core"]
  GETTABLEKS R14 R15 K8 ["Util"]
  GETTABLEKS R13 R14 K23 ["FiatUtil"]
  CALL R12 1 1
  GETIMPORT R13 K6 [require]
  GETTABLEKS R16 R0 K7 ["Core"]
  GETTABLEKS R15 R16 K8 ["Util"]
  GETTABLEKS R14 R15 K24 ["Urls"]
  CALL R13 1 1
  GETIMPORT R14 K6 [require]
  GETTABLEKS R15 R1 K25 ["Framework"]
  CALL R14 1 1
  GETTABLEKS R15 R14 K26 ["ContextServices"]
  GETTABLEKS R16 R15 K27 ["Stylizer"]
  ...
  GETTABLEKS R19 R20 K30 ["AssetLogicTypes"]
  CALL R18 1 1
  GETIMPORT R19 K6 [require]
  GETTABLEKS R22 R0 K7 ["Core"]
  GETTABLEKS R21 R22 K29 ["Types"]
  GETTABLEKS R20 R21 K31 ["SubsequentDialogStatus"]
  CALL R19 1 1
  GETIMPORT R20 K6 [require]
  GETTABLEKS R23 R0 K7 ["Core"]
  GETTABLEKS R22 R23 K32 ["Actions"]
  GETTABLEKS R21 R22 K33 ["EnqueueSubsequentDialog"]
  CALL R20 1 1
  GETIMPORT R21 K6 [require]
  GETTABLEKS R25 R0 K7 ["Core"]
  GETTABLEKS R24 R25 K34 ["Networking"]
  GETTABLEKS R23 R24 K35 ["Requests"]
  GETTABLEKS R22 R23 K36 ["PurchaseAssetRequest"]
  CALL R21 1 1
  GETIMPORT R22 K6 [require]
  GETTABLEKS R25 R0 K7 ["Core"]
  GETTABLEKS R24 R25 K32 ["Actions"]
  GETTABLEKS R23 R24 K37 ["SetPurchaseDialogVisibility"]
  CALL R22 1 1
