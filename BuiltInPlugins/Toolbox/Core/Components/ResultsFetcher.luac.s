...
PROTO_9:
  ...
  JUMPIFNOT R4 [+22]
  GETUPVAL R5 14
  GETTABLEKS R4 R5 K31 ["sectionName"]
  GETUPVAL R6 15
  GETTABLEKS R5 R6 K32 ["CONTEXTUAL_RECOMMENDATIONS_HOME_CONFIG_SECTION_NAME"]
  JUMPIFNOTEQ R4 R5 [+15]
  GETUPVAL R5 16
  GETTABLEKS R4 R5 K33 ["contextualRecommendationsPollingFrequencyInSeconds"]
  JUMPIFEQKNIL R4 [+10]
  GETUPVAL R6 11
  GETTABLEKS R5 R6 K29 ["props"]
  GETTABLEKS R4 R5 K34 ["setContextualRecommendationsPollingFrequency"]
  GETUPVAL R6 16
  GETTABLEKS R5 R6 K33 ["contextualRecommendationsPollingFrequencyInSeconds"]
  CALL R4 1 0
  RETURN R1 1
...
PROTO_10:
  ...
  LOADNIL R1
  GETUPVAL R2 1
  DUPTABLE R4 K15 [{"categoryName", "sectionName", "keyword", "ownerId", "sortType", "tags", "cursor", "limit", "includeOnlyVerifiedCreators", "queryParams", "searchSource", "assetsInCameraViewport", "assetsInCameraVicinity"}]
  GETUPVAL R6 2
  ...
  GETUPVAL R6 2
  GETTABLEKS R5 R6 K16 ["searchTerm"]
  SETTABLEKS R5 R4 K4 ["keyword"]
  GETUPVAL R5 3
  CALL R5 0 1
  SETTABLEKS R5 R4 K5 ["ownerId"]
  GETUPVAL R6 2
  GETTABLEKS R5 R6 K17 ["sortName"]
  ...
  NAMECALL R2 R2 K18 ["getToolboxItems"]
  CALL R2 2 1
  NEWCLOSURE R4 P0
  CAPTURE REF R1
  CAPTURE UPVAL U0
  ...
  CLOSEUPVALS R1
  RETURN R0 0
  GETTABLEKS R3 R2 K21 ["responseBody"]
  NEWTABLE R4 0 0
  NEWTABLE R5 0 0
  GETIMPORT R6 K23 [ipairs]
  GETTABLEKS R7 R3 K24 ["data"]
  CALL R6 1 3
  FORGPREP_INEXT R6
  GETTABLEKS R13 R10 K25 ["id"]
  FASTCALL2 TABLE_INSERT R4 R13 [+4]
  MOVE R12 R4
  GETIMPORT R11 K28 [table.insert]
  CALL R11 2 0
  GETTABLEKS R11 R10 K25 ["id"]
  JUMPIFNOT R11 [+8]
  GETTABLEKS R11 R10 K25 ["id"]
  DUPTABLE R12 K30 [{"searchResultSource"}]
  GETTABLEKS R13 R10 K29 ["searchResultSource"]
  SETTABLEKS R13 R12 K29 ["searchResultSource"]
  SETTABLE R12 R5 R11
  FORGLOOP R6 2 [inext] [-20]
  GETUPVAL R6 1
  MOVE R8 R4
  NAMECALL R6 R6 K31 ["getItemDetailsAssetIds"]
  CALL R6 2 1
  NEWCLOSURE R8 P1
  CAPTURE REF R1
  CAPTURE UPVAL U0
  ...
  CLOSEUPVALS R1
  RETURN R0 0
  GETTABLEKS R7 R6 K21 ["responseBody"]
  NEWTABLE R8 0 0
  GETIMPORT R9 K33 [pairs]
  GETTABLEKS R10 R7 K24 ["data"]
  CALL R9 1 3
  FORGPREP_NEXT R9
  GETUPVAL R15 6
  GETTABLEKS R14 R15 K34 ["fromItemDetailsRequest"]
  MOVE R15 R13
  CALL R14 1 1
  GETTABLEKS R15 R13 K35 ["Asset"]
  JUMPIFNOT R15 [+16]
  GETTABLEKS R16 R13 K35 ["Asset"]
  GETTABLEKS R15 R16 K25 ["id"]
  JUMPIFNOT R15 [+11]
  GETUPVAL R16 6
  GETTABLEKS R15 R16 K36 ["AddContextToItemDetails"]
  MOVE R16 R14
  GETTABLEKS R19 R13 K35 ["Asset"]
  GETTABLEKS R18 R19 K25 ["id"]
  GETTABLE R17 R5 R18
  CALL R15 2 1
  MOVE R14 R15
  GETTABLEKS R15 R14 K35 ["Asset"]
  JUMPIFNOT R15 [+5]
  GETTABLEKS R16 R14 K35 ["Asset"]
  GETTABLEKS R15 R16 K37 ["Id"]
  SETTABLE R14 R8 R15
  FORGLOOP R9 2 [-33]
  GETUPVAL R9 0
  LOADB R10 0
  SETTABLEKS R10 R9 K38 ["loadingMutex"]
  GETUPVAL R10 0
  GETTABLEKS R9 R10 K39 ["canceled"]
  JUMPIFNOT R9 [+6]
  GETUPVAL R9 0
  LOADB R10 0
  SETTABLEKS R10 R9 K39 ["canceled"]
  CLOSEUPVALS R1
  RETURN R0 0
  GETUPVAL R9 0
  NEWCLOSURE R11 P2
...
PROTO_19:
  DUPTABLE R1 K2 [{"dispatchGetAssetsVotingData", "setContextualRecommendationsPollingFrequency"}]
  NEWCLOSURE R2 P0
  CAPTURE VAL R0
  CAPTURE UPVAL U0
  ...
  JUMP [+1]
  LOADNIL R2
  SETTABLEKS R2 R1 K1 ["setContextualRecommendationsPollingFrequency"]
  RETURN R1 1
...
MAIN:
  ...
  CAPTURE VAL R19
  CAPTURE VAL R10
  SETTABLEKS R22 R21 K42 ["fetchResults"]
  DUPCLOSURE R22 K43 [PROTO_14]
  SETTABLEKS R22 R21 K44 ["render"]
  DUPCLOSURE R22 K45 [PROTO_15]
  SETTABLEKS R22 R21 K46 ["didMount"]
  GETTABLEKS R22 R2 K34 ["PureComponent"]
  LOADK R24 K47 ["ResultsFetcherRoduxWrapper"]
  NAMECALL R22 R22 K36 ["extend"]
  CALL R22 2 1
  DUPCLOSURE R23 K48 [PROTO_16]
  CAPTURE VAL R2
  CAPTURE VAL R21
  SETTABLEKS R23 R22 K44 ["render"]
  DUPCLOSURE R23 K49 [PROTO_19]
  CAPTURE VAL R17
  CAPTURE VAL R19
  CAPTURE VAL R18
  NEWCLOSURE R24 P7
  CAPTURE VAL R2
  CAPTURE REF R22
  SETGLOBAL R24 K50 ["TypedResultsFetcher"]
  DUPCLOSURE R24 K51 [PROTO_21]
  CAPTURE VAL R2
  CAPTURE VAL R21
  SETGLOBAL R24 K52 ["NoRoduxTypedResultsFetcher"]
  GETTABLEKS R24 R3 K53 ["connect"]
  LOADNIL R25
  MOVE R26 R23
  CALL R24 2 1
  MOVE R25 R22
  CALL R24 1 1
  MOVE R22 R24
  DUPTABLE R24 K57 [{"Component", "Generator", "NoRoduxGenerator"}]
  SETTABLEKS R21 R24 K54 ["Component"]
  GETGLOBAL R25 K50 ["TypedResultsFetcher"]
  SETTABLEKS R25 R24 K55 ["Generator"]
  GETGLOBAL R25 K52 ["NoRoduxTypedResultsFetcher"]
  SETTABLEKS R25 R24 K56 ["NoRoduxGenerator"]
  CLOSEUPVALS R22
  RETURN R24 1
