...
MAIN:
  ...
  GETTABLEKS R21 R22 K34 ["getFFlagQualityFiltersInToolboxSearch"]
  CALL R20 1 1
  GETTABLEKS R21 R2 K35 ["PureComponent"]
  LOADK R23 K36 ["ResultsFetcher"]
  ...
  CAPTURE VAL R2
  CAPTURE REF R22
  SETGLOBAL R24 K51 ["TypedResultsFetcher"]
  DUPCLOSURE R24 K52 [PROTO_21]
  CAPTURE VAL R2
  CAPTURE VAL R21
  SETGLOBAL R24 K53 ["NoRoduxTypedResultsFetcher"]
  GETTABLEKS R24 R3 K54 ["connect"]
  LOADNIL R25
  MOVE R26 R23
  CALL R24 2 1
  MOVE R25 R22
  CALL R24 1 1
  MOVE R22 R24
  DUPTABLE R24 K58 [{"Component", "Generator", "NoRoduxGenerator"}]
  SETTABLEKS R21 R24 K55 ["Component"]
  GETGLOBAL R25 K51 ["TypedResultsFetcher"]
  SETTABLEKS R25 R24 K56 ["Generator"]
  GETGLOBAL R25 K53 ["NoRoduxTypedResultsFetcher"]
  SETTABLEKS R25 R24 K57 ["NoRoduxGenerator"]
  CLOSEUPVALS R22
  RETURN R24 1
