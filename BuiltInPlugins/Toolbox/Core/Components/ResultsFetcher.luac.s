...
MAIN:
  ...
  CAPTURE VAL R19
  CAPTURE VAL R10
  SETTABLEKS R21 R20 K41 ["fetchResults"]
  DUPCLOSURE R21 K42 [PROTO_14]
  SETTABLEKS R21 R20 K43 ["render"]
  DUPCLOSURE R21 K44 [PROTO_15]
  SETTABLEKS R21 R20 K45 ["didMount"]
  GETTABLEKS R21 R2 K33 ["PureComponent"]
  LOADK R23 K46 ["ResultsFetcherRoduxWrapper"]
  NAMECALL R21 R21 K35 ["extend"]
  CALL R21 2 1
  DUPCLOSURE R22 K47 [PROTO_16]
  CAPTURE VAL R2
  CAPTURE VAL R20
  ...
  CAPTURE VAL R2
  CAPTURE REF R21
  SETGLOBAL R23 K49 ["TypedResultsFetcher"]
  DUPCLOSURE R23 K50 [PROTO_21]
  CAPTURE VAL R2
  CAPTURE VAL R20
  SETGLOBAL R23 K51 ["NoRoduxTypedResultsFetcher"]
  ...
  CALL R23 1 1
  MOVE R21 R23
  DUPTABLE R23 K56 [{"Component", "Generator", "NoRoduxGenerator"}]
  SETTABLEKS R20 R23 K53 ["Component"]
  GETGLOBAL R24 K49 ["TypedResultsFetcher"]
  SETTABLEKS R24 R23 K54 ["Generator"]
  GETGLOBAL R24 K51 ["NoRoduxTypedResultsFetcher"]
  SETTABLEKS R24 R23 K55 ["NoRoduxGenerator"]
  CLOSEUPVALS R21
  RETURN R23 1
