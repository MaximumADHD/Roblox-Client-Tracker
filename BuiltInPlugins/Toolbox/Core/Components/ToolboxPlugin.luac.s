...
MAIN:
  ...
  CALL R5 1 1
  GETTABLEKS R7 R2 K14 ["Core"]
  GETTABLEKS R6 R7 K15 ["Util"]
  GETIMPORT R7 K11 [require]
  GETTABLEKS R8 R2 K16 ["SharedPluginConstants"]
  CALL R7 1 1
  ...
  GETTABLEKS R15 R6 K26 ["makeTheme"]
  CALL R14 1 1
  GETIMPORT R16 K11 [require]
  GETTABLEKS R17 R3 K27 ["Framework"]
  CALL R16 1 1
  GETTABLEKS R15 R16 K28 ["ContextServices"]
  GETTABLEKS R16 R15 K29 ["withContext"]
  GETIMPORT R18 K11 [require]
  GETTABLEKS R19 R3 K27 ["Framework"]
  CALL R18 1 1
  GETTABLEKS R17 R18 K15 ["Util"]
  GETIMPORT R18 K11 [require]
  GETTABLEKS R21 R2 K14 ["Core"]
  GETTABLEKS R20 R21 K28 ["ContextServices"]
  GETTABLEKS R19 R20 K30 ["NavigationContext"]
  CALL R18 1 1
  GETIMPORT R19 K11 [require]
  GETTABLEKS R21 R6 K31 ["Analytics"]
  GETTABLEKS R20 R21 K31 ["Analytics"]
  CALL R19 1 1
  GETTABLEKS R20 R4 K32 ["PureComponent"]
  LOADK R22 K33 ["ToolboxPlugin"]
  ...
  MOVE R21 R16
  DUPTABLE R22 K44 [{"Localization"}]
  GETTABLEKS R23 R15 K43 ["Localization"]
  SETTABLEKS R23 R22 K43 ["Localization"]
  CALL R21 1 1
  MOVE R22 R20
  CALL R21 1 1
  MOVE R20 R21
  DUPCLOSURE R21 K45 [PROTO_13]
  CAPTURE VAL R13
  GETTABLEKS R22 R5 K46 ["connect"]
  LOADNIL R23
  MOVE R24 R21
  CALL R22 2 1
  MOVE R23 R20
