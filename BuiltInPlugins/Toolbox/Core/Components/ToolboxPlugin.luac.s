...
PROTO_11:
  ...
  CALL R22 0 1
  GETUPVAL R24 5
  GETTABLEKS R23 R24 K44 ["new"]
  DUPTABLE R24 K46 [{"namespace", "plugin"}]
  LOADK R25 K47 ["toolbox"]
  SETTABLEKS R25 R24 K45 ["namespace"]
  ...
  GETUPVAL R23 6
  DUPTABLE R24 K48 [{"plugin", "pluginGui", "theme", "networkInterface", "localization"}]
  SETTABLEKS R3 R24 K2 ["plugin"]
  ...
  GETUPVAL R27 7
  DUPTABLE R28 K51 [{"initialWidth", "backgrounds", "suggestions", "tryOpenAssetConfig", "plugin", "pluginGui", "pluginLoaderContext", "onMouseEnter"}]
  SETTABLEKS R12 R28 K49 ["initialWidth"]
  ...
  GETTABLEKS R29 R0 K52 ["onDockWidgetInteraction"]
  SETTABLEKS R29 R28 K50 ["onMouseEnter"]
  CALL R26 2 -1
  SETLIST R25 R26 -1 [1]
  CALL R22 3 -1
  SETLIST R21 R22 -1 [1]
...
MAIN:
  ...
  MOVE R22 R15
  DUPTABLE R23 K46 [{"Localization", "IXP"}]
  GETTABLEKS R24 R14 K44 ["Localization"]
  SETTABLEKS R24 R23 K44 ["Localization"]
  SETTABLEKS R18 R23 K45 ["IXP"]
  CALL R22 1 1
  MOVE R23 R21
  CALL R22 1 1
  MOVE R21 R22
