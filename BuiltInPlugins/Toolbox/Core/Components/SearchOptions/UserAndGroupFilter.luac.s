...
PROTO_4:
  ...
  CALL R3 2 0
  RETURN R0 0
  GETTABLEKS R3 R2 K4 ["IsSearching"]
  JUMPIF R3 [+11]
  GETTABLEKS R4 R2 K5 ["Network"]
  GETTABLEKS R3 R4 K6 ["networkInterface"]
  GETTABLEKS R4 R2 K7 ["userGroupSearchRequest"]
  MOVE R5 R3
  MOVE R6 R0
  GETTABLEKS R7 R2 K3 ["manageableGroups"]
  CALL R4 3 0
  RETURN R0 0
...
MAIN:
  ...
  MOVE R25 R10
  DUPTABLE R26 K50 [{"Network"}]
  SETTABLEKS R11 R26 K49 ["Network"]
  CALL R25 1 1
  MOVE R26 R24
  CALL R25 1 1
  MOVE R24 R25
