...
local var6 = require(var2.Core.Util.SharedFlags.getFFlagToolboxTutorialLimits)
...
local var29 = require(var7.Framework).ContextServices.withContext
...
local var36 = require(var7.Framework).Util.deepEqual
local var37 = require(var7.Dash)
local var38 = require(var2.Core.Util.SharedFlags.getFFlagToolboxTutorialLimits)
local var39 = require(var2.Core.ContextServices.NavigationContext)
return function()
