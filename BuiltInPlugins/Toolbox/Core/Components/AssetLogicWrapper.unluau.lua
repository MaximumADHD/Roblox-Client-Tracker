...
local var5 = require(var2.Core.Util.SharedFlags.getFFlagToolboxSeparatePurchaseStatusDialogsFromAssetPreview)
local var6 = require(var2.Core.Util.SharedFlags.getFFlagToolboxAddFiatPricesIntoAssetTile)
