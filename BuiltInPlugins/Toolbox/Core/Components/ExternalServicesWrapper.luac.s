PROTO_0:
  ...
  GETUPVAL R10 5
  DUPTABLE R11 K11 [{"theme"}]
  SETTABLEKS R3 R11 K2 ["theme"]
  DUPTABLE R12 K13 [{"LocalizationProvider"}]
  GETUPVAL R14 4
  GETTABLEKS R13 R14 K10 ["createElement"]
  GETUPVAL R14 6
  DUPTABLE R15 K14 [{"localization"}]
  SETTABLEKS R5 R15 K4 ["localization"]
  DUPTABLE R16 K16 [{"CameraProvider"}]
  GETUPVAL R18 4
  GETTABLEKS R17 R18 K10 ["createElement"]
  GETUPVAL R18 7
  NEWTABLE R19 0 0
  GETUPVAL R22 4
  GETTABLEKS R21 R22 K7 ["Children"]
  GETTABLE R20 R1 R21
  CALL R17 3 1
  SETTABLEKS R17 R16 K15 ["CameraProvider"]
  CALL R13 3 1
  SETTABLEKS R13 R12 K12 ["LocalizationProvider"]
  CALL R9 3 1
...
MAIN:
  ...
  GETTABLEKS R10 R11 K18 ["getFFlagToolboxFinallyRemoveLegacyContext"]
  CALL R9 1 1
  GETTABLEKS R10 R2 K19 ["Component"]
  LOADK R12 K20 ["ExternalServicesWrapper"]
