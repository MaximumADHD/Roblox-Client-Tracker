...
MAIN:
  ...
  GETTABLEKS R32 R33 K46 ["Models"]
  GETTABLEKS R31 R32 K47 ["AssetInfo"]
  CALL R30 1 1
  GETIMPORT R31 K6 [require]
  GETTABLEKS R34 R0 K15 ["Core"]
  GETTABLEKS R33 R34 K48 ["Types"]
  GETTABLEKS R32 R33 K49 ["Category"]
  CALL R31 1 1
  GETIMPORT R32 K6 [require]
  GETTABLEKS R36 R0 K15 ["Core"]
  GETTABLEKS R35 R36 K21 ["Components"]
  GETTABLEKS R34 R35 K23 ["Audio"]
  GETTABLEKS R33 R34 K50 ["GetAudioTableSizes"]
  CALL R32 1 1
  GETIMPORT R33 K6 [require]
  GETTABLEKS R37 R0 K15 ["Core"]
  GETTABLEKS R36 R37 K16 ["Util"]
  GETTABLEKS R35 R36 K51 ["SharedFlags"]
  GETTABLEKS R34 R35 K52 ["getFFlagToolboxRefactorAudioConstantsForItemRow"]
  CALL R33 1 1
  GETTABLEKS R34 R2 K53 ["PureComponent"]
  LOADK R36 K54 ["AudioRow"]
  NAMECALL R34 R34 K55 ["extend"]
  CALL R34 2 1
  DUPCLOSURE R35 K56 [PROTO_0]
  SETGLOBAL R35 K57 ["secondsToMinuteString"]
  DUPTABLE R35 K60 [{"Artist", "MusicAlbum"}]
  LOADK R36 K61 ["---"]
  SETTABLEKS R36 R35 K58 ["Artist"]
  LOADK R36 K61 ["---"]
  SETTABLEKS R36 R35 K59 ["MusicAlbum"]
  DUPCLOSURE R36 K62 [PROTO_1]
  CAPTURE VAL R5
  CAPTURE VAL R35
  SETGLOBAL R36 K63 ["audioDetailsWithDefaults"]
  ...
  CAPTURE VAL R6
  CAPTURE VAL R28
  SETTABLEKS R36 R34 K65 ["init"]
  DUPCLOSURE R36 K66 [PROTO_23]
  SETTABLEKS R36 R34 K67 ["didUpdate"]
  DUPCLOSURE R36 K68 [PROTO_24]
  CAPTURE VAL R32
  CAPTURE VAL R26
  CAPTURE VAL R9
  SETTABLEKS R36 R34 K69 ["render"]
  MOVE R36 R12
  DUPTABLE R37 K75 [{"AssetAnalytics", "Stylizer", "Localization", "Plugin", "Settings", "Network"}]
  SETTABLEKS R21 R37 K70 ["AssetAnalytics"]
  GETTABLEKS R38 R11 K71 ["Stylizer"]
  SETTABLEKS R38 R37 K71 ["Stylizer"]
  GETTABLEKS R38 R11 K72 ["Localization"]
  SETTABLEKS R38 R37 K72 ["Localization"]
  GETTABLEKS R38 R11 K73 ["Plugin"]
  SETTABLEKS R38 R37 K73 ["Plugin"]
  SETTABLEKS R23 R37 K37 ["Settings"]
  SETTABLEKS R24 R37 K74 ["Network"]
  CALL R36 1 1
  MOVE R37 R34
  CALL R36 1 1
  MOVE R34 R36
  ...
  CAPTURE VAL R2
  CAPTURE REF R34
  SETGLOBAL R38 K79 ["TypedAudioRow"]
  DUPTABLE R38 K82 [{"Component", "Generator"}]
  SETTABLEKS R34 R38 K80 ["Component"]
  GETGLOBAL R39 K79 ["TypedAudioRow"]
  SETTABLEKS R39 R38 K81 ["Generator"]
  CLOSEUPVALS R34
  RETURN R38 1
