...
MAIN:
  ...
  LOADK R31 K47 ["ToolboxSampleProductMUS418"]
  NAMECALL R29 R29 K48 ["GetEngineFeature"]
  CALL R29 2 1
  GETTABLEKS R30 R2 K49 ["PureComponent"]
  LOADK R32 K50 ["AudioRow"]
  NAMECALL R30 R30 K51 ["extend"]
  CALL R30 2 1
  DUPCLOSURE R31 K52 [PROTO_0]
  SETGLOBAL R31 K53 ["secondsToMinuteString"]
  DUPTABLE R31 K56 [{"Artist", "MusicAlbum"}]
  LOADK R32 K57 ["---"]
  SETTABLEKS R32 R31 K54 ["Artist"]
  LOADK R32 K57 ["---"]
  SETTABLEKS R32 R31 K55 ["MusicAlbum"]
  DUPCLOSURE R32 K58 [PROTO_1]
  CAPTURE VAL R5
  CAPTURE VAL R31
  SETGLOBAL R32 K59 ["audioDetailsWithDefaults"]
  DUPCLOSURE R32 K60 [PROTO_25]
  CAPTURE VAL R29
  CAPTURE VAL R19
  CAPTURE VAL R12
  CAPTURE VAL R5
  ...
  CAPTURE VAL R6
  CAPTURE VAL R21
  SETTABLEKS R32 R30 K61 ["init"]
  DUPCLOSURE R32 K62 [PROTO_26]
  SETTABLEKS R32 R30 K63 ["didUpdate"]
  DUPCLOSURE R32 K64 [PROTO_27]
  CAPTURE VAL R25
  CAPTURE VAL R20
  CAPTURE VAL R9
  SETTABLEKS R32 R30 K65 ["render"]
  MOVE R32 R11
  DUPTABLE R33 K71 [{"AssetAnalytics", "Stylizer", "Localization", "Plugin", "Settings", "Network"}]
  SETTABLEKS R14 R33 K66 ["AssetAnalytics"]
  GETTABLEKS R34 R10 K67 ["Stylizer"]
  SETTABLEKS R34 R33 K67 ["Stylizer"]
  GETTABLEKS R34 R10 K68 ["Localization"]
  SETTABLEKS R34 R33 K68 ["Localization"]
  GETTABLEKS R34 R10 K69 ["Plugin"]
  SETTABLEKS R34 R33 K69 ["Plugin"]
  SETTABLEKS R16 R33 K27 ["Settings"]
  SETTABLEKS R17 R33 K70 ["Network"]
  CALL R32 1 1
  MOVE R33 R30
  CALL R32 1 1
  MOVE R30 R32
  DUPCLOSURE R32 K72 [PROTO_28]
  DUPCLOSURE R33 K73 [PROTO_31]
  CAPTURE VAL R15
  CAPTURE VAL R18
  GETTABLEKS R34 R3 K74 ["connect"]
  MOVE R35 R32
  MOVE R36 R33
  CALL R34 2 1
  MOVE R35 R30
  ...
  CAPTURE VAL R2
  CAPTURE REF R30
  SETGLOBAL R34 K75 ["TypedAudioRow"]
  DUPTABLE R34 K78 [{"Component", "Generator"}]
  SETTABLEKS R30 R34 K76 ["Component"]
  GETGLOBAL R35 K75 ["TypedAudioRow"]
  SETTABLEKS R35 R34 K77 ["Generator"]
  CLOSEUPVALS R30
  RETURN R34 1
