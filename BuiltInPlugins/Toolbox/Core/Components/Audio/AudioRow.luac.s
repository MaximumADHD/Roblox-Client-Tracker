...
PROTO_24:
  ...
  DUPCLOSURE R2 K20 [PROTO_19]
  SETTABLEKS R2 R0 K21 ["isCapitalizedIgnoreLocale"]
  NEWCLOSURE R2 P15
  CAPTURE VAL R0
  CAPTURE UPVAL U5
  CAPTURE UPVAL U6
  SETTABLEKS R2 R0 K22 ["getTags"]
  NEWCLOSURE R2 P16
  CAPTURE VAL R0
  CAPTURE UPVAL U7
  CAPTURE UPVAL U4
  CAPTURE UPVAL U8
  SETTABLEKS R2 R0 K23 ["getColumns"]
  NEWCLOSURE R2 P17
  CAPTURE VAL R0
  CAPTURE UPVAL U6
  CAPTURE UPVAL U4
  ...
  CAPTURE UPVAL U8
  CAPTURE UPVAL U11
  SETTABLEKS R2 R0 K24 ["renderIcon"]
  NEWCLOSURE R2 P18
  CAPTURE VAL R0
  CAPTURE UPVAL U9
  CAPTURE UPVAL U12
  SETTABLEKS R2 R0 K25 ["renderExpandedContent"]
  RETURN R0 0
...
MAIN:
  ...
  LOADK R30 K45 ["ToolboxSampleProductMUS418"]
  NAMECALL R28 R28 K46 ["GetEngineFeature"]
  CALL R28 2 1
  GETTABLEKS R29 R2 K47 ["PureComponent"]
  LOADK R31 K48 ["AudioRow"]
  NAMECALL R29 R29 K49 ["extend"]
  CALL R29 2 1
  DUPCLOSURE R30 K50 [PROTO_0]
  SETGLOBAL R30 K51 ["secondsToMinuteString"]
  DUPTABLE R30 K54 [{"Artist", "MusicAlbum"}]
  LOADK R31 K55 ["---"]
  SETTABLEKS R31 R30 K52 ["Artist"]
  LOADK R31 K55 ["---"]
  SETTABLEKS R31 R30 K53 ["MusicAlbum"]
  DUPCLOSURE R31 K56 [PROTO_1]
  CAPTURE VAL R5
  CAPTURE VAL R30
  SETGLOBAL R31 K57 ["audioDetailsWithDefaults"]
  DUPCLOSURE R31 K58 [PROTO_24]
  CAPTURE VAL R28
  CAPTURE VAL R19
  CAPTURE VAL R12
  CAPTURE VAL R5
  ...
  CAPTURE VAL R6
  CAPTURE VAL R21
  SETTABLEKS R31 R29 K59 ["init"]
  DUPCLOSURE R31 K60 [PROTO_25]
  SETTABLEKS R31 R29 K61 ["didUpdate"]
  DUPCLOSURE R31 K62 [PROTO_26]
  CAPTURE VAL R25
  CAPTURE VAL R20
  CAPTURE VAL R9
  SETTABLEKS R31 R29 K63 ["render"]
  MOVE R31 R11
  DUPTABLE R32 K69 [{"AssetAnalytics", "Stylizer", "Localization", "Plugin", "Settings", "Network"}]
  SETTABLEKS R14 R32 K64 ["AssetAnalytics"]
  GETTABLEKS R33 R10 K65 ["Stylizer"]
  SETTABLEKS R33 R32 K65 ["Stylizer"]
  GETTABLEKS R33 R10 K66 ["Localization"]
  SETTABLEKS R33 R32 K66 ["Localization"]
  GETTABLEKS R33 R10 K67 ["Plugin"]
  SETTABLEKS R33 R32 K67 ["Plugin"]
  SETTABLEKS R16 R32 K27 ["Settings"]
  SETTABLEKS R17 R32 K68 ["Network"]
  CALL R31 1 1
  MOVE R32 R29
  CALL R31 1 1
  MOVE R29 R31
  DUPCLOSURE R31 K70 [PROTO_27]
  DUPCLOSURE R32 K71 [PROTO_30]
  CAPTURE VAL R15
  CAPTURE VAL R18
  GETTABLEKS R33 R3 K72 ["connect"]
  MOVE R34 R31
  MOVE R35 R32
  CALL R33 2 1
  MOVE R34 R29
  ...
  CAPTURE VAL R2
  CAPTURE REF R29
  SETGLOBAL R33 K73 ["TypedAudioRow"]
  DUPTABLE R33 K76 [{"Component", "Generator"}]
  SETTABLEKS R29 R33 K74 ["Component"]
  GETGLOBAL R34 K73 ["TypedAudioRow"]
  SETTABLEKS R34 R33 K75 ["Generator"]
  CLOSEUPVALS R29
  RETURN R33 1
