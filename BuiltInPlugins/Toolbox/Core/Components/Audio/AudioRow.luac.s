...
PROTO_29:
  ...
  DUPCLOSURE R4 K21 [PROTO_24]
  SETTABLEKS R4 R0 K22 ["isCapitalizedIgnoreLocale"]
  NEWCLOSURE R4 P18
  CAPTURE VAL R0
  SETTABLEKS R4 R0 K23 ["getTags"]
  NEWCLOSURE R4 P19
  CAPTURE VAL R0
  CAPTURE UPVAL U8
  CAPTURE UPVAL U9
  CAPTURE UPVAL U7
  CAPTURE UPVAL U10
  SETTABLEKS R4 R0 K24 ["getColumns"]
  NEWCLOSURE R4 P20
  CAPTURE VAL R0
  CAPTURE UPVAL U11
  CAPTURE UPVAL U7
  ...
  CAPTURE UPVAL U10
  CAPTURE UPVAL U14
  SETTABLEKS R4 R0 K25 ["renderIcon"]
  NEWCLOSURE R4 P21
  CAPTURE VAL R0
  CAPTURE UPVAL U12
  CAPTURE UPVAL U15
  SETTABLEKS R4 R0 K26 ["renderExpandedContent"]
  RETURN R0 0
...
MAIN:
  ...
  CALL R30 1 1
  GETIMPORT R31 K48 [game]
  LOADK R33 K49 ["ToolboxSampleProductMUS418"]
  NAMECALL R31 R31 K50 ["GetEngineFeature"]
  CALL R31 2 1
  GETTABLEKS R32 R2 K51 ["PureComponent"]
  LOADK R34 K52 ["AudioRow"]
  NAMECALL R32 R32 K53 ["extend"]
  CALL R32 2 1
  DUPCLOSURE R33 K54 [PROTO_0]
  SETGLOBAL R33 K55 ["secondsToMinuteString"]
  DUPTABLE R33 K58 [{"Artist", "MusicAlbum"}]
  LOADK R34 K59 ["---"]
  SETTABLEKS R34 R33 K56 ["Artist"]
  LOADK R34 K59 ["---"]
  SETTABLEKS R34 R33 K57 ["MusicAlbum"]
  DUPCLOSURE R34 K60 [PROTO_1]
  CAPTURE VAL R5
  CAPTURE VAL R33
  SETGLOBAL R34 K61 ["audioDetailsWithDefaults"]
  DUPCLOSURE R34 K62 [PROTO_29]
  CAPTURE VAL R31
  CAPTURE VAL R19
  CAPTURE VAL R28
  CAPTURE VAL R12
  ...
  CAPTURE VAL R6
  CAPTURE VAL R21
  SETTABLEKS R34 R32 K63 ["init"]
  DUPCLOSURE R34 K64 [PROTO_30]
  SETTABLEKS R34 R32 K65 ["didUpdate"]
  DUPCLOSURE R34 K66 [PROTO_31]
  CAPTURE VAL R25
  CAPTURE VAL R20
  CAPTURE VAL R9
  SETTABLEKS R34 R32 K67 ["render"]
  MOVE R34 R11
  DUPTABLE R35 K73 [{"AssetAnalytics", "Stylizer", "Localization", "Plugin", "Settings", "Network"}]
  SETTABLEKS R14 R35 K68 ["AssetAnalytics"]
  GETTABLEKS R36 R10 K69 ["Stylizer"]
  SETTABLEKS R36 R35 K69 ["Stylizer"]
  GETTABLEKS R36 R10 K70 ["Localization"]
  SETTABLEKS R36 R35 K70 ["Localization"]
  GETTABLEKS R36 R10 K71 ["Plugin"]
  SETTABLEKS R36 R35 K71 ["Plugin"]
  SETTABLEKS R16 R35 K27 ["Settings"]
  SETTABLEKS R17 R35 K72 ["Network"]
  CALL R34 1 1
  MOVE R35 R32
  CALL R34 1 1
  MOVE R32 R34
  DUPCLOSURE R34 K74 [PROTO_32]
  DUPCLOSURE R35 K75 [PROTO_35]
  CAPTURE VAL R15
  CAPTURE VAL R18
  GETTABLEKS R36 R3 K76 ["connect"]
  MOVE R37 R34
  MOVE R38 R35
  CALL R36 2 1
  MOVE R37 R32
  ...
  CAPTURE VAL R2
  CAPTURE REF R32
  SETGLOBAL R36 K77 ["TypedAudioRow"]
  DUPTABLE R36 K80 [{"Component", "Generator"}]
  SETTABLEKS R32 R36 K78 ["Component"]
  GETGLOBAL R37 K77 ["TypedAudioRow"]
  SETTABLEKS R37 R36 K79 ["Generator"]
  CLOSEUPVALS R32
  RETURN R36 1
