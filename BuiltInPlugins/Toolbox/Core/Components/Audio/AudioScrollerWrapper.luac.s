PROTO_0:
  ...
  JUMPIFNOT R5 [+17]
  GETUPVAL R6 2
  GETTABLEKS R5 R6 K0 ["SwimlaneName"]
  GETUPVAL R6 3
  ...
  CALL R7 1 1
  GETTABLEKS R8 R7 K2 ["getNavigationContext"]
  MOVE R9 R6
  MOVE R10 R5
  CALL R8 2 1
  MOVE R4 R8
  ...
  GETUPVAL R12 5
  GETTABLEKS R11 R12 K4 ["position"]
  MOVE R12 R4
  CALL R5 7 -1
  RETURN R5 -1
  LOADNIL R4
...
PROTO_2:
  ...
  DUPTABLE R15 K33 [{"Assets", "RenderTopContent", "PageSize", "FetchNextPage", "Loading", "ParentAbsoluteSize", "ParentAbsolutePosition", "CanInsertAsset", "LogImpression", "OnAssetPreviewButtonClicked", "TryInsert", "TryOpenAssetConfig"}]
  GETTABLEKS R16 R1 K34 ["assets"]
  ...
  GETTABLEKS R16 R1 K35 ["fetchNextPage"]
  SETTABLEKS R16 R15 K24 ["FetchNextPage"]
  GETTABLEKS R16 R1 K36 ["loading"]
...
MAIN:
  ...
  GETTABLEKS R9 R10 K22 ["getFFlagAddMoreAudioSwimlaneAnalytics"]
  CALL R8 1 1
  GETTABLEKS R10 R2 K23 ["UI"]
  GETTABLEKS R9 R10 K24 ["Pane"]
  GETTABLEKS R11 R2 K16 ["ContextServices"]
