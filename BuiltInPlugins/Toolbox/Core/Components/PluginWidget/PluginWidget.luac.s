...
PROTO_3:
  ...
  LOADK R7 K10 ["ScreenGui"]
  NAMECALL R5 R5 K11 ["IsA"]
  CALL R5 2 1
  JUMPIF R5 [+4]
  GETTABLEKS R5 R0 K9 ["widget"]
  ...
  GETTABLEKS R5 R0 K9 ["widget"]
  GETTABLEKS R6 R1 K12 ["ZIndexBehavior"]
  JUMPIF R6 [+2]
  GETIMPORT R6 K15 [Enum.ZIndexBehavior.Global]
  SETTABLEKS R6 R5 K12 ["ZIndexBehavior"]
  GETTABLEKS R5 R0 K9 ["widget"]
  ...
  GETTABLEKS R5 R6 K19 ["AncestryChanged"]
  NEWCLOSURE R7 P1
  CAPTURE VAL R0
  CAPTURE UPVAL U1
  NAMECALL R5 R5 K18 ["connect"]
  CALL R5 2 0
  GETTABLEKS R5 R1 K20 ["ForwardRef"]
  JUMPIFNOT R5 [+4]
  MOVE R6 R5
...
MAIN:
  ...
  GETTABLEKS R6 R7 K12 ["getFFlagToolboxCreatorDropdownReset"]
  CALL R5 1 1
