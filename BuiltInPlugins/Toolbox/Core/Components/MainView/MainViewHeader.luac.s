...
MAIN:
  ...
  GETTABLEKS R23 R24 K35 ["getFFlagToolboxNavigationClearsAudioSearch"]
  CALL R22 1 1
  GETTABLEKS R23 R2 K36 ["PureComponent"]
  LOADK R25 K37 ["MainViewHeader"]
  NAMECALL R23 R23 K38 ["extend"]
  CALL R23 2 1
  GETIMPORT R24 K5 [require]
  GETTABLEKS R28 R0 K9 ["Core"]
  GETTABLEKS R27 R28 K25 ["Components"]
  GETTABLEKS R26 R27 K39 ["SearchOptions"]
  GETTABLEKS R25 R26 K40 ["SearchTags"]
  CALL R24 1 1
  DUPCLOSURE R25 K41 [PROTO_15]
  CAPTURE VAL R21
  CAPTURE VAL R14
  CAPTURE VAL R22
  CAPTURE VAL R15
  ...
  CAPTURE VAL R17
  CAPTURE VAL R16
  SETTABLEKS R25 R23 K44 ["render"]
  MOVE R25 R12
  DUPTABLE R26 K47 [{"Localization", "Settings", "Network"}]
  GETTABLEKS R27 R11 K45 ["Localization"]
  SETTABLEKS R27 R26 K45 ["Localization"]
  SETTABLEKS R8 R26 K15 ["Settings"]
  SETTABLEKS R13 R26 K46 ["Network"]
  CALL R25 1 1
  MOVE R26 R23
  CALL R25 1 1
  MOVE R23 R25
  DUPCLOSURE R25 K48 [PROTO_18]
  CAPTURE VAL R14
  CAPTURE VAL R9
  CAPTURE VAL R21
  CAPTURE VAL R20
