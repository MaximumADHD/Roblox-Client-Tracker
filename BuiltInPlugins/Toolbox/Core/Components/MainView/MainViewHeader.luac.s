...
MAIN:
  ...
  GETTABLEKS R24 R25 K36 ["getFFlagToolboxNavigationClearsAudioSearch"]
  CALL R23 1 1
  GETTABLEKS R24 R2 K37 ["PureComponent"]
  LOADK R26 K38 ["MainViewHeader"]
  NAMECALL R24 R24 K39 ["extend"]
  CALL R24 2 1
  GETIMPORT R25 K5 [require]
  GETTABLEKS R29 R0 K9 ["Core"]
  GETTABLEKS R28 R29 K25 ["Components"]
  GETTABLEKS R27 R28 K40 ["SearchOptions"]
  GETTABLEKS R26 R27 K41 ["SearchTags"]
  CALL R25 1 1
  DUPCLOSURE R26 K42 [PROTO_15]
  CAPTURE VAL R22
  CAPTURE VAL R14
  CAPTURE VAL R23
  CAPTURE VAL R15
  CAPTURE VAL R5
  SETTABLEKS R26 R24 K43 ["init"]
  ...
  CAPTURE VAL R16
  CAPTURE VAL R18
  SETTABLEKS R26 R24 K45 ["render"]
  MOVE R26 R12
  DUPTABLE R27 K48 [{"Localization", "Settings", "Network"}]
  GETTABLEKS R28 R11 K46 ["Localization"]
  SETTABLEKS R28 R27 K46 ["Localization"]
  SETTABLEKS R8 R27 K15 ["Settings"]
  SETTABLEKS R13 R27 K47 ["Network"]
  CALL R26 1 1
  MOVE R27 R24
  CALL R26 1 1
  MOVE R24 R26
  DUPCLOSURE R26 K49 [PROTO_18]
  CAPTURE VAL R14
  CAPTURE VAL R9
  CAPTURE VAL R22
  CAPTURE VAL R21
  DUPCLOSURE R27 K50 [PROTO_20]
  CAPTURE VAL R19
