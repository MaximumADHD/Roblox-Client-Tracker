...
MAIN:
  ...
  CALL R30 1 1
  GETTABLEKS R31 R3 K49 ["PureComponent"]
  LOADK R33 K36 ["MainView"]
  ...
  MOVE R32 R13
  DUPTABLE R33 K57 [{"Settings", "Localization", "Network"}]
  SETTABLEKS R14 R33 K24 ["Settings"]
  GETTABLEKS R34 R12 K55 ["Localization"]
  SETTABLEKS R34 R33 K55 ["Localization"]
  SETTABLEKS R15 R33 K56 ["Network"]
  CALL R32 1 1
  MOVE R33 R31
  CALL R32 1 1
  MOVE R31 R32
  DUPCLOSURE R32 K58 [PROTO_3]
  CAPTURE VAL R10
  CAPTURE VAL R28
  CAPTURE VAL R5
  CAPTURE VAL R29
  DUPCLOSURE R33 K59 [PROTO_5]
  CAPTURE VAL R25
  GETTABLEKS R34 R4 K60 ["connect"]
  MOVE R35 R32
  MOVE R36 R33
  CALL R34 2 1
  MOVE R35 R31
