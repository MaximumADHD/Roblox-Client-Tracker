...
MAIN:
  ...
  GETTABLEKS R27 R3 K9 ["Core"]
  GETTABLEKS R26 R27 K10 ["Util"]
  GETTABLEKS R25 R26 K35 ["SharedFlags"]
  GETTABLEKS R24 R25 K36 ["getFFlagToolboxAddFiatPricesIntoAssetTile"]
  CALL R23 1 1
  GETIMPORT R24 K13 [require]
  GETTABLEKS R28 R3 K9 ["Core"]
  GETTABLEKS R27 R28 K10 ["Util"]
  GETTABLEKS R26 R27 K35 ["SharedFlags"]
  GETTABLEKS R25 R26 K37 ["getFFlagToolboxSeparatePurchaseStatusDialogsFromAssetPreview"]
  CALL R24 1 1
  GETIMPORT R25 K13 [require]
  GETTABLEKS R27 R4 K35 ["SharedFlags"]
  GETTABLEKS R26 R27 K38 ["getFFlagToolboxEnableFiatPurchasing"]
  CALL R25 1 1
  LOADNIL R26
  LOADNIL R27
  MOVE R28 R25
  CALL R28 0 1
  JUMPIFNOT R28 [+8]
  GETTABLEKS R28 R10 K39 ["getOwnershipPollingMaxRetries"]
  CALL R28 0 1
  MOVE R26 R28
  GETTABLEKS R28 R10 K40 ["getOwnershipPollingWaitTimeInSec"]
  CALL R28 0 1
  MOVE R27 R28
  ...
  CAPTURE VAL R15
  CAPTURE VAL R19
  DUPCLOSURE R31 K44 [PROTO_4]
  DUPCLOSURE R32 K45 [PROTO_5]
  CAPTURE VAL R15
  CAPTURE VAL R19
  NEWCLOSURE R33 P5
  CAPTURE REF R26
