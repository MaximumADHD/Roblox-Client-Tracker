...
PROTO_12:
  ...
  GETUPVAL R5 7
  GETUPVAL R7 8
  GETTABLEKS R6 R7 K15 ["Waiting"]
  CALL R5 1 -1
  NAMECALL R3 R0 K16 ["dispatch"]
  CALL R3 -1 0
  GETUPVAL R4 1
  CALL R4 0 1
  JUMPIFNOT R4 [+27]
  GETUPVAL R4 9
  JUMPIFNOT R4 [+25]
  DUPTABLE R3 K19 [{"expectedPrice", "productKey"}]
  GETUPVAL R4 9
  SETTABLEKS R4 R3 K17 ["expectedPrice"]
  DUPTABLE R4 K23 [{"productNamespace", "productType", "productTargetId"}]
  LOADK R5 K24 ["PRODUCT_NAMESPACE_CREATOR_MARKETPLACE_ASSET"]
  SETTABLEKS R5 R4 K20 ["productNamespace"]
  GETUPVAL R6 10
  GETTABLEKS R5 R6 K25 ["convertAssetTypeToProductType"]
  GETUPVAL R6 5
  CALL R5 1 1
  SETTABLEKS R5 R4 K21 ["productType"]
  GETUPVAL R6 3
  FASTCALL1 TOSTRING R6 [+2]
  GETIMPORT R5 K27 [tostring]
  CALL R5 1 1
  SETTABLEKS R5 R4 K22 ["productTargetId"]
  SETTABLEKS R4 R3 K18 ["productKey"]
  JUMP [+13]
  DUPTABLE R3 K30 [{"expectedPrice", "assetId", "assetType", "searchId"}]
  GETUPVAL R4 11
  SETTABLEKS R4 R3 K17 ["expectedPrice"]
  GETUPVAL R4 3
  SETTABLEKS R4 R3 K28 ["assetId"]
  GETUPVAL R4 5
  SETTABLEKS R4 R3 K29 ["assetType"]
  GETUPVAL R4 6
  SETTABLEKS R4 R3 K11 ["searchId"]
  NEWCLOSURE R4 P0
  CAPTURE UPVAL U4
  CAPTURE UPVAL U1
  CAPTURE UPVAL U9
  ...
  MOVE R8 R3
  GETUPVAL R9 5
  NAMECALL R5 R5 K31 ["purchaseAsset"]
  CALL R5 4 1
  NEWCLOSURE R7 P1
  CAPTURE UPVAL U16
  CAPTURE UPVAL U17
