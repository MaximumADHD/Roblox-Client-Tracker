PROTO_0:
  ...
  GETUPVAL R6 5
  GETUPVAL R7 6
  DUPTABLE R8 K16 [{"searchTerm", "sortIndex", "categoryName", "targetPage", "currentPage", "requestReason", "isTopKeyword", "searchSource", "querySource", "originalUserQuery", "originalCorrection", "queryParams"}]
  GETUPVAL R9 2
  ...
  LOADN R9 0
  SETTABLEKS R9 R8 K8 ["currentPage"]
  GETUPVAL R10 7
  GETTABLEKS R9 R10 K17 ["StartSearch"]
  SETTABLEKS R9 R8 K9 ["requestReason"]
  GETUPVAL R10 8
  ORK R9 R10 K18 [False]
  SETTABLEKS R9 R8 K10 ["isTopKeyword"]
  GETUPVAL R10 2
  JUMPIFNOT R10 [+6]
  GETUPVAL R11 9
  GETTABLEKS R10 R11 K19 ["SEARCH_SOURCE"]
  GETTABLEKS R9 R10 K20 ["KEYWORD"]
  JUMP [+1]
  LOADNIL R9
  SETTABLEKS R9 R8 K11 ["searchSource"]
  GETUPVAL R10 10
  JUMPIFNOT R10 [+5]
  GETUPVAL R10 11
  CALL R10 0 1
  ...
  JUMP [+5]
  GETUPVAL R11 12
  GETTABLEKS R10 R11 K21 ["QuerySource"]
  GETTABLEKS R9 R10 K22 ["OriginalUserQuery"]
  SETTABLEKS R9 R8 K12 ["querySource"]
  GETUPVAL R10 13
  JUMPIFNOT R10 [+5]
  GETUPVAL R10 11
  CALL R10 0 1
  ...
  JUMP [+1]
  LOADNIL R9
  SETTABLEKS R9 R8 K13 ["originalUserQuery"]
  GETUPVAL R10 14
  JUMPIFNOT R10 [+5]
  GETUPVAL R10 11
  CALL R10 0 1
  ...
  JUMP [+1]
  LOADNIL R9
  SETTABLEKS R9 R8 K14 ["originalCorrection"]
  GETUPVAL R10 15
  CALL R10 0 1
  JUMPIFNOT R10 [+4]
  GETUPVAL R10 16
  GETTABLEKS R9 R10 K23 ["None"]
  JUMP [+1]
  LOADNIL R9
  SETTABLEKS R9 R8 K15 ["queryParams"]
  CALL R5 3 -1
