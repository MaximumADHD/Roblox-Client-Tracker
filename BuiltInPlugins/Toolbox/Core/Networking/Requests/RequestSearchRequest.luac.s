PROTO_0:
  ...
  GETUPVAL R6 5
  GETUPVAL R7 6
  DUPTABLE R8 K18 [{"audioSearchInfo", "additionalAudioSearchInfo", "searchTerm", "sortIndex", "categoryName", "targetPage", "currentPage", "requestReason", "isTopKeyword", "searchSource", "querySource", "originalUserQuery", "originalCorrection", "queryParams"}]
  GETUPVAL R10 7
  CALL R10 0 1
  JUMPIFNOT R10 [+4]
  GETUPVAL R10 8
