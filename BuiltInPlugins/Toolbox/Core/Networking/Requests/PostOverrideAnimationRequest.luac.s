...
PROTO_1:
  ...
  LOADK R2 K4 ["Got false response from PostOverrideAnimation, code:"]
  GETTABLEKS R3 R0 K0 ["code"]
  CALL R1 2 0
  GETUPVAL R1 2
  GETUPVAL R3 3
  LOADB R4 0
  ...
  JUMP [+1]
  LOADK R1 K8 ["Upload failed with unknown error"]
  GETUPVAL R2 2
  GETUPVAL R4 4
  MOVE R5 R1
  CALL R4 1 -1
  ...
  GETUPVAL R3 6
  GETUPVAL R6 7
  GETTABLEKS R5 R6 K10 ["SCREENS"]
  GETTABLEKS R4 R5 K11 ["UPLOADING_ASSET"]
  CALL R3 1 -1
  NAMECALL R1 R1 K5 ["dispatch"]
  CALL R1 -1 0
  GETUPVAL R1 2
  ...
  CALL R1 -1 0
  GETUPVAL R2 2
  NAMECALL R2 R2 K12 ["getState"]
  CALL R2 1 1
  GETTABLEKS R1 R2 K13 ["deleteLocal"]
  GETUPVAL R2 8
  CALL R2 0 1
  JUMPIFNOT R2 [+6]
  GETUPVAL R2 9
  ...
  JUMPIFNOT R3 [+5]
  GETUPVAL R3 11
  LOADK R5 K14 ["AnimationClipEditor"]
  NAMECALL R3 R3 K15 ["FindFirstChild"]
  CALL R3 2 1
  MOVE R4 R3
  JUMPIFNOT R4 [+4]
  LOADK R6 K16 ["animationUploadSuccess"]
  NAMECALL R4 R3 K15 ["FindFirstChild"]
  CALL R4 2 1
  JUMPIFNOT R4 [+5]
  MOVE R7 R2
  MOVE R8 R1
  NAMECALL R5 R4 K17 ["Fire"]
  CALL R5 3 0
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R12 R9 K19 ["FireAnimationUploadSuccessEvent"]
  CALL R11 1 1
  GETIMPORT R12 K8 [require]
  GETTABLEKS R15 R0 K9 ["Core"]
  GETTABLEKS R14 R15 K20 ["Flags"]
  GETTABLEKS R13 R14 K21 ["getFFlagToolboxDeleteAnimationOnUpload"]
  CALL R12 1 1
  GETIMPORT R13 K8 [require]
  GETTABLEKS R16 R0 K9 ["Core"]
  GETTABLEKS R15 R16 K20 ["Flags"]
  GETTABLEKS R14 R15 K22 ["getFFlagToolboxFixOverrideAnimationError"]
  CALL R13 1 1
