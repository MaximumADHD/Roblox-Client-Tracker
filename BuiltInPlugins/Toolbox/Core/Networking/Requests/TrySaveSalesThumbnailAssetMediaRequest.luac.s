...
PROTO_5:
  ...
  CALL R9 0 0
  GETUPVAL R10 6
  GETTABLEKS R9 R10 K24 ["iconFile"]
  JUMPIFNOT R9 [+18]
  GETUPVAL R10 6
  ...
  GETUPVAL R13 6
  GETTABLEKS R12 R13 K24 ["iconFile"]
  NAMECALL R9 R9 K25 ["uploadAssetThumbnail"]
  CALL R9 3 1
  MOVE R11 R7
  MOVE R12 R7
  ...
  GETUPVAL R11 2
  GETUPVAL R14 3
  GETTABLEKS R13 R14 K26 ["SCREENS"]
  GETTABLEKS R12 R13 K27 ["UPLOADING_ASSET"]
  CALL R11 1 -1
  NAMECALL R9 R0 K28 ["dispatch"]
  CALL R9 -1 0
  GETUPVAL R11 4
  MOVE R12 R1
  CALL R11 1 -1
...
MAIN:
  ...
  GETTABLEKS R14 R15 K21 ["getFFlagToolboxM3Configuration"]
  CALL R13 1 1
