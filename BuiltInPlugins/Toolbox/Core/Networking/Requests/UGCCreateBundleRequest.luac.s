...
PROTO_4:
  ...
  LOADK R8 K4 [0.85]
  GETUPVAL R9 9
  LOADK R11 K5 ["AssetConfig"]
  LOADK R12 K6 ["BundleUploadStepNumber"]
  DUPTABLE R13 K9 [{"currentStep", "totalSteps"}]
  LOADN R14 3
  SETTABLEKS R14 R13 K7 ["currentStep"]
  LOADN R14 4
  SETTABLEKS R14 R13 K8 ["totalSteps"]
  NAMECALL R9 R9 K10 ["getText"]
  CALL R9 4 1
  GETUPVAL R10 9
  LOADK R12 K5 ["AssetConfig"]
  LOADK R13 K11 ["BundleUploadCreateBundleStep"]
  ...
  JUMPIFNOT R5 [+12]
  GETUPVAL R6 4
  GETTABLEKS R5 R6 K13 ["UGCUploadRequestBundleCreationStatusEvent"]
  GETUPVAL R8 4
  GETTABLEKS R7 R8 K14 ["Status"]
  GETTABLEKS R6 R7 K15 ["Start"]
  MOVE R7 R2
  GETUPVAL R8 5
  GETUPVAL R9 6
  CALL R5 4 0
  ...
  GETUPVAL R11 5
  GETUPVAL R12 17
  NAMECALL R5 R5 K16 ["postCreateBundle"]
  CALL R5 7 1
  MOVE R7 R3
  MOVE R8 R4
...
MAIN:
  ...
  GETTABLEKS R16 R8 K26 ["getRobuxMessageToAppend"]
  CALL R15 1 1
