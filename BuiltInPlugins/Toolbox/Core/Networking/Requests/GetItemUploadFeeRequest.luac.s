...
PROTO_2:
  ...
  GETUPVAL R6 6
  NAMECALL R3 R3 K1 ["getItemUploadFee"]
  CALL R3 3 1
  MOVE R5 R1
  MOVE R6 R2
...
PROTO_6:
  ...
  GETUPVAL R5 5
  GETUPVAL R6 6
  NAMECALL R3 R3 K0 ["getItemUploadFee"]
  CALL R3 3 1
  MOVE R5 R1
  MOVE R6 R2
...
MAIN:
  ...
  GETTABLEKS R7 R4 K13 ["AssetConfigConstants"]
  CALL R6 1 1
  GETIMPORT R7 K5 [require]
  GETTABLEKS R10 R0 K6 ["Core"]
  GETTABLEKS R9 R10 K14 ["Flags"]
  GETTABLEKS R8 R9 K15 ["getFFlagToolboxUGCBundleTypesEnum"]
  CALL R7 1 1
  MOVE R8 R7
  CALL R8 0 1
  JUMPIFNOT R8 [+6]
