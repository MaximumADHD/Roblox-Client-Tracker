...
PROTO_13:
  ...
  LOADN R6 1
  GETUPVAL R8 5
  GETTABLEKS R7 R8 K3 ["NAME_CHARACTER_LIMIT"]
  NAMECALL R4 R4 K4 ["sub"]
  CALL R4 3 1
  JUMP [+1]
  LOADK R4 K5 [""]
  SETUPVAL R4 4
  ...
  LOADN R6 1
  GETUPVAL R8 5
  GETTABLEKS R7 R8 K6 ["DESCRIPTION_CHARACTER_LIMIT"]
  NAMECALL R4 R4 K4 ["sub"]
  CALL R4 3 1
  JUMP [+1]
  LOADK R4 K5 [""]
  ...
  LOADN R9 0
  GETUPVAL R10 14
  LOADK R12 K7 ["AssetConfig"]
  LOADK R13 K8 ["BundleUploadStepNumber"]
  DUPTABLE R14 K11 [{"currentStep", "totalSteps"}]
  LOADN R15 1
  SETTABLEKS R15 R14 K9 ["currentStep"]
  LOADN R15 4
  SETTABLEKS R15 R14 K10 ["totalSteps"]
  NAMECALL R10 R10 K12 ["getText"]
  CALL R10 4 1
  GETUPVAL R11 14
  LOADK R13 K7 ["AssetConfig"]
  LOADK R14 K13 ["BundleUploadPrepareStep"]
  ...
  GETTABLEKS R9 R10 K16 ["UPLOADING_ASSET"]
  CALL R8 1 -1
  NAMECALL R6 R0 K14 ["dispatch"]
  CALL R6 -1 0
  GETUPVAL R7 0
  GETTABLEKS R6 R7 K17 ["getUGCBodyBundleAssetQuantities"]
  MOVE R7 R2
  GETUPVAL R8 12
  GETUPVAL R9 1
  CALL R6 3 1
  JUMPIFNOTEQKNIL R6 [+25]
  GETUPVAL R9 24
  GETUPVAL R13 14
  LOADK R15 K7 ["AssetConfig"]
  LOADK R16 K18 ["ValidationErrorUnknown"]
  ...
  JUMPIFNOT R7 [+10]
  GETUPVAL R8 10
  GETTABLEKS R7 R8 K19 ["UGCUploadRequestOperationIdEvent"]
  GETUPVAL R10 10
  GETTABLEKS R9 R10 K20 ["Status"]
  GETTABLEKS R8 R9 K21 ["Start"]
  MOVE R9 R1
  CALL R7 2 0
  GETUPVAL R7 21
  GETUPVAL R9 1
  ...
  GETUPVAL R12 6
  MOVE R13 R3
  NAMECALL R7 R7 K22 ["postBundleCreationContext"]
  CALL R7 6 1
  MOVE R9 R4
  MOVE R10 R5
