...
MAIN:
  ...
  GETTABLEKS R31 R2 K9 ["Core"]
  GETTABLEKS R30 R31 K35 ["Flags"]
  GETTABLEKS R29 R30 K42 ["getFFlagFixBundleUploadInstancesUsed"]
  CALL R28 1 1
  GETIMPORT R29 K12 [require]
  GETTABLEKS R30 R11 K43 ["getRobuxMessageToAppend"]
  CALL R29 1 1
  DUPTABLE R30 K46 [{"bundlePartsUploadError", "bundleUploadAssetsStep"}]
  DUPTABLE R31 K50 [{"Body", "DynamicHead", "Shoes"}]
  LOADK R32 K51 ["BundlePartsUploadError"]
  SETTABLEKS R32 R31 K47 ["Body"]
  LOADK R32 K51 ["BundlePartsUploadError"]
  SETTABLEKS R32 R31 K48 ["DynamicHead"]
  LOADK R32 K52 ["ShoesBundlePartsUploadError"]
  SETTABLEKS R32 R31 K49 ["Shoes"]
  SETTABLEKS R31 R30 K44 ["bundlePartsUploadError"]
  DUPTABLE R31 K50 [{"Body", "DynamicHead", "Shoes"}]
  LOADK R32 K53 ["BundleUploadAssetsStep"]
  SETTABLEKS R32 R31 K47 ["Body"]
  LOADK R32 K53 ["BundleUploadAssetsStep"]
  SETTABLEKS R32 R31 K48 ["DynamicHead"]
  LOADK R32 K54 ["ShoesBundleUploadAssetsStep"]
  SETTABLEKS R32 R31 K49 ["Shoes"]
  SETTABLEKS R31 R30 K45 ["bundleUploadAssetsStep"]
  DUPCLOSURE R31 K55 [PROTO_0]
  DUPCLOSURE R32 K56 [PROTO_1]
  DUPCLOSURE R33 K57 [PROTO_2]
  DUPCLOSURE R34 K58 [PROTO_3]
  DUPCLOSURE R35 K59 [PROTO_4]
