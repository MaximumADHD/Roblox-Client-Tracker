...
PROTO_5:
  ...
  NEWTABLE R6 2 0
  LOADN R7 0
  LOADK R8 K8 ["CreationContextAuthorizationDenied"]
  SETTABLE R8 R6 R7
  LOADK R7 K9 ["CreationContextUserNotFound"]
  SETTABLEN R7 R6 10
  NEWTABLE R7 2 0
  LOADN R8 0
  LOADK R9 K10 ["CreationContextTokenValidationFailed"]
  SETTABLE R9 R7 R8
  LOADK R8 K11 ["CreationContextDoesNotHavePermission"]
  SETTABLEN R8 R7 9
  GETUPVAL R8 1
  CALL R8 0 1
  JUMPIFNOT R8 [+4]
  LOADK R8 K12 ["CreationContextMissingIDVerification"]
  SETTABLEN R8 R7 106
  LOADK R8 K13 ["CreationContextAccessBlocked"]
  SETTABLEN R8 R7 107
  NEWTABLE R8 1 0
  LOADK R9 K14 ["CreationContextDailyLimitReached"]
  SETTABLEN R9 R8 11
  NEWTABLE R9 0 1
  LOADK R10 K15 ["CreationContextServiceUnavailable"]
  SETTABLEN R10 R9 1
  NEWTABLE R10 8 0
  LOADN R11 144
  SETTABLE R5 R10 R11
  ...
  SETTABLE R9 R10 R11
  LOADNIL R11
  GETTABLEKS R13 R2 K16 ["StatusCode"]
  GETTABLE R12 R10 R13
  JUMPIFEQKNIL R12 [+50]
  GETTABLEKS R13 R2 K17 ["Body"]
  JUMPIFEQKNIL R13 [+46]
  GETTABLEKS R14 R2 K17 ["Body"]
  GETTABLEKS R13 R14 K18 ["errors"]
  JUMPIFEQKNIL R13 [+40]
  GETTABLEKS R16 R2 K17 ["Body"]
  GETTABLEKS R13 R16 K18 ["errors"]
  LOADNIL R14
  LOADNIL R15
  FORGPREP R13
  GETTABLEKS R19 R17 K19 ["code"]
  GETTABLE R18 R12 R19
  JUMPIFEQKNIL R18 [+18]
  JUMPIFNOTEQKNIL R11 [+8]
  LOADK R21 K20 ["AssetConfig"]
  MOVE R22 R18
  NAMECALL R19 R1 K21 ["getText"]
  CALL R19 3 1
  MOVE R11 R19
  JUMP [+8]
  MOVE R19 R11
...
"]
  ...
  JUMPIFNOT R13 [+14]
  GETUPVAL R14 4
  GETTABLEKS R13 R14 K23 ["UGCUploadRequestOperationIdEvent"]
  GETUPVAL R16 4
  GETTABLEKS R15 R16 K24 ["Status"]
  GETTABLEKS R14 R15 K25 ["Failure"]
  MOVE R15 R3
  LOADNIL R16
  GETUPVAL R17 5
  MOVE R18 R2
  ...
  CALL R13 4 0
  GETUPVAL R14 6
  GETTABLEKS R13 R14 K26 ["shouldDebugWarnings"]
  CALL R13 0 1
  JUMPIFNOT R13 [+5]
  GETIMPORT R13 K28 [warn]
  LOADK R14 K29 ["Could not create UGC Bundle context and received response:"]
  MOVE R15 R2
  CALL R13 2 0
  JUMPIFEQKNIL R11 [+8]
  GETUPVAL R15 7
  MOVE R16 R11
  CALL R15 1 -1
  NAMECALL R13 R0 K30 ["dispatch"]
  CALL R13 -1 0
  JUMP [+16]
  GETUPVAL R15 7
  LOADK R21 K20 ["AssetConfig"]
  LOADK R22 K31 ["BundleContextCreationError"]
  NAMECALL R19 R1 K21 ["getText"]
  CALL R19 3 1
  MOVE R17 R19
  GETUPVAL R18 2
