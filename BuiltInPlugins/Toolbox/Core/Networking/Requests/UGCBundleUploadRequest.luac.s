...
PROTO_7:
  ...
  LOADK R10 K21 ["BundleUploadStepNumber"]
  DUPTABLE R11 K24 [{"currentStep", "totalSteps"}]
  LOADN R12 2
  SETTABLEKS R12 R11 K22 ["currentStep"]
  LOADN R12 4
  SETTABLEKS R12 R11 K23 ["totalSteps"]
  ...
  JUMPIFNOT R12 [+6]
  GETUPVAL R13 19
  GETTABLEKS R12 R13 K26 ["bundleUploadAssetsStep"]
  GETUPVAL R13 20
  GETTABLE R11 R12 R13
  JUMP [+1]
  LOADK R11 K27 ["BundleUploadAssetsStep"]
  NAMECALL R8 R8 K25 ["getText"]
  CALL R8 3 -1
  CALL R5 -1 -1
  NAMECALL R3 R3 K28 ["dispatch"]
  CALL R3 -1 0
  GETUPVAL R3 21
  MOVE R4 R1
  CALL R3 1 0
...
MAIN:
  ...
  GETTABLEKS R24 R11 K32 ["SharedFlags"]
  GETTABLEKS R23 R24 K35 ["getFFlagEnableNewToolboxCreationContextErrors"]
  CALL R22 1 1
  GETIMPORT R23 K12 [require]
  GETTABLEKS R25 R11 K32 ["SharedFlags"]
  GETTABLEKS R24 R25 K36 ["getFFlagEnableUGCBundleUploadBodyScale"]
  CALL R23 1 1
  GETIMPORT R24 K12 [require]
  GETTABLEKS R26 R11 K32 ["SharedFlags"]
  GETTABLEKS R25 R26 K37 ["getFFlagEnableBodyColorSetUploadSupport"]
  CALL R24 1 1
  GETIMPORT R25 K12 [require]
  GETTABLEKS R28 R2 K9 ["Core"]
  GETTABLEKS R27 R28 K38 ["Flags"]
  GETTABLEKS R26 R27 K39 ["getFFlagEnableUploadingGroupBundles"]
  CALL R25 1 1
  GETIMPORT R26 K12 [require]
  GETTABLEKS R29 R2 K9 ["Core"]
  GETTABLEKS R28 R29 K38 ["Flags"]
  GETTABLEKS R27 R28 K40 ["getFFlagEnableUploadingShoes"]
  CALL R26 1 1
  GETIMPORT R27 K12 [require]
  GETTABLEKS R30 R2 K9 ["Core"]
  GETTABLEKS R29 R30 K38 ["Flags"]
  GETTABLEKS R28 R29 K41 ["getFFlagFixBundleUploadInstancesUsed"]
  CALL R27 1 1
