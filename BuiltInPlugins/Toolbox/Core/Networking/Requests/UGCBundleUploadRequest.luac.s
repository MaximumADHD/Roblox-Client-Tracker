PROTO_0:
  ...
  SETTABLEN R8 R7 9
  NEWTABLE R8 1 0
  LOADK R9 K11 ["CreationContextDailyLimitReached"]
  SETTABLEN R9 R8 11
  NEWTABLE R9 0 1
  LOADK R10 K12 ["CreationContextServiceUnavailable"]
  SETTABLEN R10 R9 1
  NEWTABLE R10 8 0
  LOADN R11 144
  SETTABLE R5 R10 R11
  ...
  SETTABLE R9 R10 R11
  LOADNIL R11
  GETTABLEKS R13 R2 K13 ["StatusCode"]
  GETTABLE R12 R10 R13
  JUMPIFEQKNIL R12 [+51]
  GETTABLEKS R13 R2 K14 ["Body"]
  JUMPIFEQKNIL R13 [+47]
  GETTABLEKS R14 R2 K14 ["Body"]
  GETTABLEKS R13 R14 K15 ["errors"]
  JUMPIFEQKNIL R13 [+41]
  GETTABLEKS R16 R2 K14 ["Body"]
  GETTABLEKS R13 R16 K15 ["errors"]
  LOADNIL R14
  LOADNIL R15
  FORGPREP R13
  GETTABLEKS R19 R17 K16 ["code"]
  GETTABLE R18 R12 R19
  JUMPIFEQKNIL R18 [+18]
  JUMPIFNOTEQKNIL R11 [+8]
  LOADK R21 K17 ["AssetConfig"]
  MOVE R22 R18
  NAMECALL R19 R1 K18 ["getText"]
  CALL R19 3 1
  MOVE R11 R19
  JUMP [+8]
  MOVE R19 R11
...
"]
  ...
  JUMPIFNOT R13 [+12]
  GETUPVAL R14 3
  GETTABLEKS R13 R14 K20 ["UGCUploadRequestOperationIdEvent"]
  GETUPVAL R16 3
  GETTABLEKS R15 R16 K21 ["Status"]
  GETTABLEKS R14 R15 K22 ["Failure"]
  MOVE R15 R3
  LOADNIL R16
  MOVE R17 R2
  CALL R13 4 0
  GETUPVAL R14 4
  GETTABLEKS R13 R14 K23 ["shouldDebugWarnings"]
  CALL R13 0 1
  JUMPIFNOT R13 [+5]
  GETIMPORT R13 K25 [warn]
  LOADK R14 K26 ["Could not create UGC Bundle context and received response:"]
  MOVE R15 R2
  CALL R13 2 0
  JUMPIFEQKNIL R11 [+8]
  GETUPVAL R15 5
  ...
  JUMPIFNOT R17 [+12]
  LOADK R21 K17 ["AssetConfig"]
  LOADK R22 K28 ["BundleContextCreationError"]
  NAMECALL R19 R1 K18 ["getText"]
  CALL R19 3 1
  MOVE R17 R19
  GETUPVAL R18 1
  ...
  LOADK R19 K28 ["BundleContextCreationError"]
  NAMECALL R16 R1 K18 ["getText"]
  CALL R16 3 1
  CALL R15 1 -1
  NAMECALL R13 R0 K27 ["dispatch"]
  CALL R13 -1 0
...
PROTO_2:
  ...
  ADD R5 R6 R7
  GETUPVAL R6 12
  LOADK R8 K12 ["AssetConfig"]
  LOADK R9 K13 ["BundleUploadStepNumber"]
  DUPTABLE R10 K16 [{"currentStep", "totalSteps"}]
  LOADN R11 2
  SETTABLEKS R11 R10 K14 ["currentStep"]
  LOADN R11 4
  SETTABLEKS R11 R10 K15 ["totalSteps"]
  NAMECALL R6 R6 K17 ["getText"]
  CALL R6 4 1
  GETUPVAL R7 12
  LOADK R9 K12 ["AssetConfig"]
  LOADK R10 K18 ["BundleUploadAssetsStep"]
  NAMECALL R7 R7 K17 ["getText"]
  CALL R7 3 -1
  CALL R4 -1 -1
  NAMECALL R2 R2 K19 ["dispatch"]
  CALL R2 -1 0
  GETUPVAL R2 13
  MOVE R3 R1
  CALL R2 1 0
...
PROTO_4:
  ...
  GETUPVAL R4 3
  GETTABLEKS R3 R4 K1 ["Status"]
  GETTABLEKS R2 R3 K4 ["Failure"]
  GETUPVAL R3 4
  GETUPVAL R4 5
  LOADNIL R5
  LOADK R6 K5 ["Bundle Upload Assets Error"]
  CALL R1 5 0
  GETUPVAL R2 15
  ...
  LOADK R2 K9 ["Unexpected UGCBundleUploadRequest: Incorrect number of asset ids "]
  CALL R1 1 0
  GETUPVAL R1 6
  GETUPVAL R3 16
  GETUPVAL R5 17
  ...
  LOADK R10 K11 ["BundlePartsUploadError"]
  ...
  JUMP [+6]
  GETUPVAL R4 12
  LOADK R6 K10 ["AssetConfig"]
  LOADK R7 K11 ["BundlePartsUploadError"]
...
PROTO_5:
  ...
  JUMP [+6]
  GETUPVAL R4 8
  LOADK R6 K7 ["AssetConfig"]
  LOADK R7 K8 ["BundlePartsUploadError"]
...
PROTO_6:
  ...
  GETTABLEKS R4 R5 K10 ["createUGCBodyPartFolders"]
  GETUPVAL R5 6
  GETUPVAL R6 10
  GETUPVAL R7 4
  LOADB R8 1
  ...
  JUMP [+6]
  GETUPVAL R4 14
  LOADK R6 K12 ["AssetConfig"]
  LOADK R7 K36 ["ValidationErrorUnknown"]
...
PROTO_8:
  ...
  JUMPIFNOT R2 [+6]
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K0 ["getAvatarAssetTypeAsString"]
  GETUPVAL R3 2
  CALL R2 1 1
  MOVE R1 R2
  GETUPVAL R2 3
  ...
  GETUPVAL R9 15
  LOADK R11 K6 ["AssetConfig"]
  LOADK R12 K17 ["ValidationErrorUnknown"]
  NAMECALL R9 R9 K11 ["getText"]
  CALL R9 3 1
  CALL R8 1 -1
...
MAIN:
  ...
  GETTABLEKS R21 R22 K33 ["getFFlagMoveToolboxCodeToUGCValidation"]
  CALL R20 1 1
  GETIMPORT R21 K12 [require]
  GETTABLEKS R23 R11 K32 ["SharedFlags"]
  GETTABLEKS R22 R23 K34 ["getFFlagEnableUGCUploadFlowAnalytics"]
  CALL R21 1 1
  GETIMPORT R22 K1 [game]
  LOADK R24 K35 ["FixCreateUGCBodyPartFoldersCall"]
  LOADB R25 0
  NAMECALL R22 R22 K36 ["DefineFastFlag"]
  CALL R22 3 1
  GETIMPORT R23 K12 [require]
  GETTABLEKS R25 R11 K32 ["SharedFlags"]
  GETTABLEKS R24 R25 K37 ["getFFlagEnableCreateUGCBundleCreationFeeErrorCodes"]
  CALL R23 1 1
