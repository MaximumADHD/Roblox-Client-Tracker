...
PROTO_2:
  ...
  JUMPIFNOT R5 [+7]
  GETUPVAL R5 6
  GETTABLEKS R4 R5 K7 ["computeTranslatedErrorMessage"]
  MOVE R5 R0
  GETUPVAL R6 7
  CALL R4 2 1
  JUMP [+1]
...
PROTO_3:
  ...
  GETUPVAL R5 5
  MOVE R6 R2
  NAMECALL R3 R3 K21 ["CreateAssetOrAssetVersionAndPollAssetWithTelemetryAsyncWithAddParamErrorJson"]
  CALL R3 3 -1
  RETURN R3 -1
  GETUPVAL R3 4
  GETUPVAL R5 5
  MOVE R6 R2
  NAMECALL R3 R3 K22 ["CreateAssetOrAssetVersionAndPollAssetWithTelemetryAsyncWithAddParam"]
  CALL R3 3 -1
  RETURN R3 -1
  GETUPVAL R2 4
  GETUPVAL R4 5
  ...
  LOADN R13 0
  NAMECALL R2 R2 K23 ["CreateAssetOrAssetVersionAndPollAssetWithTelemetryAsync"]
  CALL R2 11 -1
  RETURN R2 -1
...
MAIN:
  ...
  GETTABLEKS R14 R9 K18 ["SharedFlags"]
  GETTABLEKS R13 R14 K19 ["getFFlagToolboxTranslateUploadError"]
  CALL R12 1 1
  MOVE R14 R12
  CALL R14 0 1
  JUMPIFNOT R14 [+6]
  GETIMPORT R13 K4 [require]
  GETTABLEKS R14 R9 K20 ["AssetUploadUtil"]
  CALL R13 1 1
  JUMP [+1]
  LOADNIL R13
