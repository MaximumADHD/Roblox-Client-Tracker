...
MAIN:
  ...
  GETTABLEKS R8 R9 K19 ["getFFlagToolboxSaves"]
  CALL R7 1 1
  ...
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K88 ["getSave"]
  JUMP [+4]
  DUPCLOSURE R19 K89 [PROTO_34]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K90 ["getFavorited"]
  DUPCLOSURE R19 K91 [PROTO_35]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K92 ["getMetaData"]
  DUPCLOSURE R19 K93 [PROTO_36]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K94 ["getAllowedItemTypes"]
  MOVE R19 R6
  CALL R19 0 1
  JUMPIFNOT R19 [+4]
  DUPCLOSURE R19 K95 [PROTO_37]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K96 ["getUploadPermissionStatus"]
  DUPCLOSURE R19 K97 [PROTO_38]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K98 ["getTagsMetadata"]
  DUPCLOSURE R19 K99 [PROTO_39]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K100 ["uploadCatalogItem"]
  DUPCLOSURE R19 K101 [PROTO_40]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K102 ["uploadCatalogItemFormat"]
  DUPCLOSURE R19 K103 [PROTO_41]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K104 ["getCreatorMarketplaceQuotas"]
  DUPCLOSURE R19 K105 [PROTO_42]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K106 ["getPublishingRequirements"]
  DUPCLOSURE R19 K107 [PROTO_43]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K108 ["getThumbnailStatus"]
  DUPCLOSURE R19 K109 [PROTO_44]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K110 ["getIsVerifiedCreator"]
  DUPCLOSURE R19 K111 [PROTO_45]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K112 ["getHomeConfiguration"]
  DUPCLOSURE R19 K113 [PROTO_46]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K114 ["getUniverseInfo"]
  DUPCLOSURE R19 K115 [PROTO_47]
  CAPTURE VAL R3
  CAPTURE VAL R11
  SETTABLEKS R19 R12 K116 ["purchaseAsset"]
  DUPCLOSURE R19 K117 [PROTO_48]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K118 ["getDefaultCreateBundleDataSharing"]
  DUPCLOSURE R19 K119 [PROTO_49]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K120 ["postCreateBundleDataSharing"]
  MOVE R19 R5
  CALL R19 0 1
  JUMPIFNOT R19 [+5]
  ...
  CAPTURE VAL R3
  CAPTURE VAL R9
  SETTABLEKS R19 R12 K122 ["getPurchaserStatus"]
  DUPCLOSURE R19 K123 [PROTO_51]
  CAPTURE VAL R3
  CAPTURE VAL R10
  SETTABLEKS R19 R12 K124 ["getFiatProduct"]
  DUPCLOSURE R19 K125 [PROTO_52]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K126 ["getIsOwnedByUser"]
  DUPCLOSURE R19 K127 [PROTO_53]
  SETTABLEKS R19 R12 K128 ["getIsAssetOpenForUse"]
  DUPCLOSURE R19 K129 [PROTO_54]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K130 ["getPluginInfo"]
