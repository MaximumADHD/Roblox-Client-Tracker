...
MAIN:
  ...
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K91 ["getAllowedItemTypes"]
  MOVE R18 R6
  CALL R18 0 1
  JUMPIFNOT R18 [+4]
  DUPCLOSURE R18 K92 [PROTO_36]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K93 ["getUploadPermissionStatus"]
  DUPCLOSURE R18 K94 [PROTO_37]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K95 ["getTagsMetadata"]
  DUPCLOSURE R18 K96 [PROTO_38]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K97 ["uploadCatalogItem"]
  DUPCLOSURE R18 K98 [PROTO_39]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K99 ["uploadCatalogItemFormat"]
  DUPCLOSURE R18 K100 [PROTO_40]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K101 ["getCreatorMarketplaceQuotas"]
  DUPCLOSURE R18 K102 [PROTO_41]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K103 ["getPublishingRequirements"]
  DUPCLOSURE R18 K104 [PROTO_42]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K105 ["getThumbnailStatus"]
  DUPCLOSURE R18 K106 [PROTO_43]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K107 ["getIsVerifiedCreator"]
  DUPCLOSURE R18 K108 [PROTO_44]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K109 ["getHomeConfiguration"]
  DUPCLOSURE R18 K110 [PROTO_45]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K111 ["getUniverseInfo"]
  DUPCLOSURE R18 K112 [PROTO_46]
  CAPTURE VAL R3
  CAPTURE VAL R10
  SETTABLEKS R18 R11 K113 ["purchaseAsset"]
  DUPCLOSURE R18 K114 [PROTO_47]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K115 ["getDefaultCreateBundleDataSharing"]
  DUPCLOSURE R18 K116 [PROTO_48]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K117 ["postCreateBundleDataSharing"]
  MOVE R18 R5
  CALL R18 0 1
  JUMPIFNOT R18 [+5]
  ...
  CAPTURE VAL R3
  CAPTURE VAL R8
  SETTABLEKS R18 R11 K119 ["getPurchaserStatus"]
  DUPCLOSURE R18 K120 [PROTO_50]
  CAPTURE VAL R3
  CAPTURE VAL R9
  SETTABLEKS R18 R11 K121 ["getFiatProduct"]
  DUPCLOSURE R18 K122 [PROTO_51]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K123 ["getIsOwnedByUser"]
  DUPCLOSURE R18 K124 [PROTO_52]
  SETTABLEKS R18 R11 K125 ["getIsAssetOpenForUse"]
  DUPCLOSURE R18 K126 [PROTO_53]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K127 ["getPluginInfo"]
  RETURN R11 1
