...
PROTO_46:
  ...
  GETUPVAL R5 0
  GETTABLEKS R4 R5 K0 ["resolve"]
  DUPTABLE R5 K2 [{"checkoutUrl"}]
  LOADK R6 K3 ["http://create.roblox.com"]
  SETTABLEKS R6 R5 K1 ["checkoutUrl"]
  CALL R4 1 -1
  RETURN R4 -1
  GETUPVAL R5 0
  GETTABLEKS R4 R5 K0 ["resolve"]
  DUPTABLE R5 K5 [{"responseBody"}]
  DUPTABLE R6 K7 [{"purchased"}]
  LOADB R7 1
  SETTABLEKS R7 R6 K6 ["purchased"]
  SETTABLEKS R6 R5 K4 ["responseBody"]
  CALL R4 1 -1
  RETURN R4 -1
...
MAIN:
  ...
  GETTABLEKS R7 R8 K19 ["getFFlagToolboxMigrateOffItemConfig"]
  CALL R6 1 1
  GETIMPORT R7 K9 [require]
  GETTABLEKS R11 R0 K13 ["Core"]
  GETTABLEKS R10 R11 K11 ["Util"]
  GETTABLEKS R9 R10 K18 ["SharedFlags"]
  GETTABLEKS R8 R9 K20 ["getFFlagEnableUGCUploadingDataSharing"]
  CALL R7 1 1
  ...
  GETTABLEKS R10 R11 K24 ["FiatUtil"]
  CALL R9 1 1
  NEWTABLE R10 64 0
  SETTABLEKS R10 R10 K25 ["__index"]
  DUPCLOSURE R11 K26 [PROTO_0]
  CAPTURE VAL R10
  SETTABLEKS R11 R10 K27 ["new"]
  DUPCLOSURE R11 K28 [PROTO_1]
  DUPCLOSURE R12 K29 [PROTO_2]
  CAPTURE VAL R11
  SETTABLEKS R12 R10 K30 ["fakeAssetFactory"]
  DUPCLOSURE R12 K31 [PROTO_3]
  DUPCLOSURE R13 K32 [PROTO_4]
  DUPCLOSURE R14 K33 [PROTO_5]
  SETTABLEKS R14 R10 K34 ["fakeToolboxItemFactory"]
  DUPCLOSURE R14 K35 [PROTO_6]
  DUPCLOSURE R15 K36 [PROTO_7]
  DUPCLOSURE R16 K37 [PROTO_8]
  CAPTURE VAL R11
  CAPTURE VAL R3
  SETTABLEKS R16 R10 K38 ["getAssets"]
  DUPCLOSURE R16 K39 [PROTO_9]
  CAPTURE VAL R3
  SETTABLEKS R16 R10 K40 ["postAssetCheckPermissions"]
  DUPCLOSURE R16 K41 [PROTO_10]
  CAPTURE VAL R15
  CAPTURE VAL R3
  SETTABLEKS R16 R10 K42 ["getToolboxItems"]
  DUPCLOSURE R16 K43 [PROTO_11]
  CAPTURE VAL R11
  CAPTURE VAL R3
  SETTABLEKS R16 R10 K44 ["getItemDetails"]
  DUPCLOSURE R16 K45 [PROTO_12]
  CAPTURE VAL R11
  CAPTURE VAL R3
  SETTABLEKS R16 R10 K46 ["getItemDetailsAssetIds"]
  DUPCLOSURE R16 K47 [PROTO_13]
  CAPTURE VAL R3
  SETTABLEKS R16 R10 K48 ["getDevelopAsset"]
  DUPCLOSURE R16 K49 [PROTO_14]
  CAPTURE VAL R3
  DUPCLOSURE R17 K50 [PROTO_15]
  CAPTURE VAL R16
  SETTABLEKS R17 R10 K51 ["getAssetCreations"]
  DUPCLOSURE R17 K52 [PROTO_16]
  CAPTURE VAL R16
  SETTABLEKS R17 R10 K53 ["getAssetGroupCreations"]
  MOVE R17 R6
  CALL R17 0 1
  JUMPIF R17 [+4]
  DUPCLOSURE R17 K54 [PROTO_17]
  CAPTURE VAL R3
  SETTABLEKS R17 R10 K55 ["getGroupAnimations"]
  DUPCLOSURE R17 K56 [PROTO_18]
  CAPTURE VAL R12
  CAPTURE VAL R3
  SETTABLEKS R17 R10 K57 ["getAssetCreationDetails"]
  DUPCLOSURE R17 K58 [PROTO_19]
  CAPTURE VAL R5
  CAPTURE VAL R3
  SETTABLEKS R17 R10 K59 ["getCreatorInfo"]
  DUPCLOSURE R17 K60 [PROTO_20]
  CAPTURE VAL R3
  SETTABLEKS R17 R10 K61 ["configureSales"]
  DUPCLOSURE R17 K62 [PROTO_21]
  CAPTURE VAL R3
  SETTABLEKS R17 R10 K63 ["updateSales"]
  DUPCLOSURE R17 K64 [PROTO_22]
  CAPTURE VAL R3
  SETTABLEKS R17 R10 K65 ["resolveAssets"]
  DUPCLOSURE R17 K66 [PROTO_23]
  CAPTURE VAL R3
  SETTABLEKS R17 R10 K67 ["getVote"]
  DUPCLOSURE R17 K68 [PROTO_24]
  CAPTURE VAL R3
  SETTABLEKS R17 R10 K69 ["postVote"]
  DUPCLOSURE R17 K70 [PROTO_25]
  CAPTURE VAL R3
  SETTABLEKS R17 R10 K71 ["postUnvote"]
  DUPCLOSURE R17 K72 [PROTO_26]
  CAPTURE VAL R3
  SETTABLEKS R17 R10 K73 ["postFavorite"]
  DUPCLOSURE R17 K74 [PROTO_27]
  CAPTURE VAL R3
  SETTABLEKS R17 R10 K75 ["deleteFavorite"]
  DUPCLOSURE R17 K76 [PROTO_28]
  SETTABLEKS R17 R10 K77 ["postInsertAsset"]
  DUPCLOSURE R17 K78 [PROTO_29]
  CAPTURE VAL R3
  SETTABLEKS R17 R10 K79 ["getManageableGroups"]
  DUPCLOSURE R17 K80 [PROTO_30]
  CAPTURE VAL R3
  SETTABLEKS R17 R10 K81 ["getUsers"]
  DUPCLOSURE R17 K82 [PROTO_31]
  CAPTURE VAL R3
  SETTABLEKS R17 R10 K83 ["getHasEditPermissionForAsset"]
  DUPCLOSURE R17 K84 [PROTO_32]
  CAPTURE VAL R3
  SETTABLEKS R17 R10 K85 ["getRobuxBalance"]
  DUPCLOSURE R17 K86 [PROTO_33]
  CAPTURE VAL R3
  SETTABLEKS R17 R10 K87 ["getFavoriteCounts"]
  DUPCLOSURE R17 K88 [PROTO_34]
  CAPTURE VAL R3
  SETTABLEKS R17 R10 K89 ["getFavorited"]
  DUPCLOSURE R17 K90 [PROTO_35]
  CAPTURE VAL R3
  SETTABLEKS R17 R10 K91 ["getMetaData"]
  DUPCLOSURE R17 K92 [PROTO_36]
  CAPTURE VAL R3
  SETTABLEKS R17 R10 K93 ["getTagsMetadata"]
  DUPCLOSURE R17 K94 [PROTO_37]
  CAPTURE VAL R3
  SETTABLEKS R17 R10 K95 ["uploadCatalogItem"]
  DUPCLOSURE R17 K96 [PROTO_38]
  CAPTURE VAL R3
  SETTABLEKS R17 R10 K97 ["uploadCatalogItemFormat"]
  DUPCLOSURE R17 K98 [PROTO_39]
  CAPTURE VAL R3
  SETTABLEKS R17 R10 K99 ["getCreatorMarketplaceQuotas"]
  DUPCLOSURE R17 K100 [PROTO_40]
  CAPTURE VAL R3
  SETTABLEKS R17 R10 K101 ["getPublishingRequirements"]
  DUPCLOSURE R17 K102 [PROTO_41]
  CAPTURE VAL R3
  SETTABLEKS R17 R10 K103 ["getThumbnailStatus"]
  DUPCLOSURE R17 K104 [PROTO_42]
  CAPTURE VAL R3
  SETTABLEKS R17 R10 K105 ["getIsVerifiedCreator"]
  DUPCLOSURE R17 K106 [PROTO_43]
  CAPTURE VAL R3
  SETTABLEKS R17 R10 K107 ["getHomeConfiguration"]
  DUPCLOSURE R17 K108 [PROTO_44]
  CAPTURE VAL R3
  CAPTURE VAL R1
  CAPTURE VAL R8
  SETTABLEKS R17 R10 K109 ["getAudioConfiguration"]
  DUPCLOSURE R17 K110 [PROTO_45]
  CAPTURE VAL R3
  SETTABLEKS R17 R10 K111 ["getUniverseInfo"]
  DUPCLOSURE R17 K112 [PROTO_46]
  CAPTURE VAL R3
  SETTABLEKS R17 R10 K113 ["purchaseAsset"]
  MOVE R17 R7
  CALL R17 0 1
  JUMPIFNOT R17 [+4]
  DUPCLOSURE R17 K114 [PROTO_47]
  CAPTURE VAL R3
  SETTABLEKS R17 R10 K115 ["postCreateBundleDataSharing"]
  DUPCLOSURE R17 K116 [PROTO_48]
  CAPTURE VAL R3
  CAPTURE VAL R9
