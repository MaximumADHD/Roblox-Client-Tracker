...
MAIN:
  ...
  CAPTURE VAL R10
  SETTABLEKS R11 R9 K29 ["fakeAssetFactory"]
  DUPCLOSURE R11 K30 [PROTO_3]
  DUPCLOSURE R12 K31 [PROTO_4]
  DUPCLOSURE R13 K32 [PROTO_5]
  SETTABLEKS R13 R9 K33 ["fakeToolboxItemFactory"]
  DUPCLOSURE R13 K34 [PROTO_6]
  DUPCLOSURE R14 K35 [PROTO_7]
  DUPCLOSURE R15 K36 [PROTO_8]
  CAPTURE VAL R10
  CAPTURE VAL R3
  SETTABLEKS R15 R9 K37 ["getAssets"]
  DUPCLOSURE R15 K38 [PROTO_9]
  CAPTURE VAL R3
  SETTABLEKS R15 R9 K39 ["postAssetCheckPermissions"]
  DUPCLOSURE R15 K40 [PROTO_10]
  CAPTURE VAL R14
  CAPTURE VAL R3
  SETTABLEKS R15 R9 K41 ["getToolboxItems"]
  DUPCLOSURE R15 K42 [PROTO_11]
  CAPTURE VAL R10
  CAPTURE VAL R3
  SETTABLEKS R15 R9 K43 ["getItemDetails"]
  DUPCLOSURE R15 K44 [PROTO_12]
  CAPTURE VAL R10
  CAPTURE VAL R3
  SETTABLEKS R15 R9 K45 ["getItemDetailsAssetIds"]
  DUPCLOSURE R15 K46 [PROTO_13]
  CAPTURE VAL R3
  SETTABLEKS R15 R9 K47 ["getDevelopAsset"]
  DUPCLOSURE R15 K48 [PROTO_14]
  CAPTURE VAL R3
  DUPCLOSURE R16 K49 [PROTO_15]
  CAPTURE VAL R15
  SETTABLEKS R16 R9 K50 ["getAssetCreations"]
  DUPCLOSURE R16 K51 [PROTO_16]
  CAPTURE VAL R15
  SETTABLEKS R16 R9 K52 ["getAssetGroupCreations"]
  MOVE R16 R6
  CALL R16 0 1
  JUMPIF R16 [+4]
  DUPCLOSURE R16 K53 [PROTO_17]
  CAPTURE VAL R3
  SETTABLEKS R16 R9 K54 ["getGroupAnimations"]
  DUPCLOSURE R16 K55 [PROTO_18]
  CAPTURE VAL R11
  CAPTURE VAL R3
  SETTABLEKS R16 R9 K56 ["getAssetCreationDetails"]
  DUPCLOSURE R16 K57 [PROTO_19]
  CAPTURE VAL R5
  CAPTURE VAL R3
  SETTABLEKS R16 R9 K58 ["getCreatorInfo"]
  DUPCLOSURE R16 K59 [PROTO_20]
  CAPTURE VAL R3
  SETTABLEKS R16 R9 K60 ["configureSales"]
  DUPCLOSURE R16 K61 [PROTO_21]
  CAPTURE VAL R3
  SETTABLEKS R16 R9 K62 ["updateSales"]
  DUPCLOSURE R16 K63 [PROTO_22]
  CAPTURE VAL R3
  SETTABLEKS R16 R9 K64 ["resolveAssets"]
  DUPCLOSURE R16 K65 [PROTO_23]
  CAPTURE VAL R3
  SETTABLEKS R16 R9 K66 ["getVote"]
  DUPCLOSURE R16 K67 [PROTO_24]
  CAPTURE VAL R3
  SETTABLEKS R16 R9 K68 ["postVote"]
  DUPCLOSURE R16 K69 [PROTO_25]
  CAPTURE VAL R3
  SETTABLEKS R16 R9 K70 ["postUnvote"]
  DUPCLOSURE R16 K71 [PROTO_26]
  CAPTURE VAL R3
  SETTABLEKS R16 R9 K72 ["postFavorite"]
  DUPCLOSURE R16 K73 [PROTO_27]
  CAPTURE VAL R3
  SETTABLEKS R16 R9 K74 ["deleteFavorite"]
  DUPCLOSURE R16 K75 [PROTO_28]
  SETTABLEKS R16 R9 K76 ["postInsertAsset"]
  DUPCLOSURE R16 K77 [PROTO_29]
  CAPTURE VAL R3
  SETTABLEKS R16 R9 K78 ["getManageableGroups"]
  DUPCLOSURE R16 K79 [PROTO_30]
  CAPTURE VAL R3
  SETTABLEKS R16 R9 K80 ["getUsers"]
  DUPCLOSURE R16 K81 [PROTO_31]
  CAPTURE VAL R3
  SETTABLEKS R16 R9 K82 ["getHasEditPermissionForAsset"]
  DUPCLOSURE R16 K83 [PROTO_32]
  CAPTURE VAL R3
  SETTABLEKS R16 R9 K84 ["getRobuxBalance"]
  DUPCLOSURE R16 K85 [PROTO_33]
  CAPTURE VAL R3
  SETTABLEKS R16 R9 K86 ["getFavoriteCounts"]
  DUPCLOSURE R16 K87 [PROTO_34]
  CAPTURE VAL R3
  SETTABLEKS R16 R9 K88 ["getFavorited"]
  DUPCLOSURE R16 K89 [PROTO_35]
  CAPTURE VAL R3
  SETTABLEKS R16 R9 K90 ["getMetaData"]
  DUPCLOSURE R16 K91 [PROTO_36]
  CAPTURE VAL R3
  SETTABLEKS R16 R9 K92 ["getTagsMetadata"]
  DUPCLOSURE R16 K93 [PROTO_37]
  CAPTURE VAL R3
  SETTABLEKS R16 R9 K94 ["uploadCatalogItem"]
  DUPCLOSURE R16 K95 [PROTO_38]
  CAPTURE VAL R3
  SETTABLEKS R16 R9 K96 ["uploadCatalogItemFormat"]
  DUPCLOSURE R16 K97 [PROTO_39]
  CAPTURE VAL R3
  SETTABLEKS R16 R9 K98 ["getCreatorMarketplaceQuotas"]
  DUPCLOSURE R16 K99 [PROTO_40]
  CAPTURE VAL R3
  SETTABLEKS R16 R9 K100 ["getPublishingRequirements"]
  DUPCLOSURE R16 K101 [PROTO_41]
  CAPTURE VAL R3
  SETTABLEKS R16 R9 K102 ["getThumbnailStatus"]
  DUPCLOSURE R16 K103 [PROTO_42]
  CAPTURE VAL R3
  SETTABLEKS R16 R9 K104 ["getIsVerifiedCreator"]
  DUPCLOSURE R16 K105 [PROTO_43]
  CAPTURE VAL R3
  SETTABLEKS R16 R9 K106 ["getHomeConfiguration"]
  DUPCLOSURE R16 K107 [PROTO_44]
  CAPTURE VAL R3
  CAPTURE VAL R1
  CAPTURE VAL R8
  SETTABLEKS R16 R9 K108 ["getAudioConfiguration"]
  DUPCLOSURE R16 K109 [PROTO_45]
  CAPTURE VAL R3
  SETTABLEKS R16 R9 K110 ["getUniverseInfo"]
  MOVE R16 R7
  CALL R16 0 1
  JUMPIFNOT R16 [+4]
  DUPCLOSURE R16 K111 [PROTO_46]
  CAPTURE VAL R3
  SETTABLEKS R16 R9 K112 ["postCreateBundleDataSharing"]
  RETURN R9 1
