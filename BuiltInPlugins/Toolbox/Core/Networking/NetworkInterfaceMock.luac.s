...
MAIN:
  ...
  CAPTURE VAL R3
  SETTABLEKS R20 R13 K90 ["getFavorited"]
  DUPCLOSURE R20 K91 [PROTO_34]
  CAPTURE VAL R3
  SETTABLEKS R20 R13 K92 ["getMetaData"]
  MOVE R20 R7
  CALL R20 0 1
  JUMPIFNOT R20 [+4]
  DUPCLOSURE R20 K93 [PROTO_35]
  CAPTURE VAL R3
  SETTABLEKS R20 R13 K94 ["getUploadPermissionStatus"]
  DUPCLOSURE R20 K95 [PROTO_36]
  CAPTURE VAL R3
  SETTABLEKS R20 R13 K96 ["getTagsMetadata"]
  DUPCLOSURE R20 K97 [PROTO_37]
  CAPTURE VAL R3
  SETTABLEKS R20 R13 K98 ["uploadCatalogItem"]
  DUPCLOSURE R20 K99 [PROTO_38]
  CAPTURE VAL R3
  SETTABLEKS R20 R13 K100 ["uploadCatalogItemFormat"]
  DUPCLOSURE R20 K101 [PROTO_39]
  CAPTURE VAL R3
  SETTABLEKS R20 R13 K102 ["getCreatorMarketplaceQuotas"]
  DUPCLOSURE R20 K103 [PROTO_40]
  CAPTURE VAL R3
  SETTABLEKS R20 R13 K104 ["getPublishingRequirements"]
  DUPCLOSURE R20 K105 [PROTO_41]
  CAPTURE VAL R3
  SETTABLEKS R20 R13 K106 ["getThumbnailStatus"]
  DUPCLOSURE R20 K107 [PROTO_42]
  CAPTURE VAL R3
  SETTABLEKS R20 R13 K108 ["getIsVerifiedCreator"]
  DUPCLOSURE R20 K109 [PROTO_43]
  CAPTURE VAL R3
  SETTABLEKS R20 R13 K110 ["getHomeConfiguration"]
  DUPCLOSURE R20 K111 [PROTO_44]
  CAPTURE VAL R3
  SETTABLEKS R20 R13 K112 ["getUniverseInfo"]
  DUPCLOSURE R20 K113 [PROTO_45]
  CAPTURE VAL R3
  CAPTURE VAL R12
  SETTABLEKS R20 R13 K114 ["purchaseAsset"]
  MOVE R20 R8
  CALL R20 0 1
  JUMPIFNOT R20 [+8]
  DUPCLOSURE R20 K115 [PROTO_46]
  CAPTURE VAL R3
  SETTABLEKS R20 R13 K116 ["getDefaultCreateBundleDataSharing"]
  DUPCLOSURE R20 K117 [PROTO_47]
  CAPTURE VAL R3
  SETTABLEKS R20 R13 K118 ["postCreateBundleDataSharing"]
  MOVE R20 R6
  CALL R20 0 1
  JUMPIFNOT R20 [+5]
  ...
  CAPTURE VAL R3
  CAPTURE VAL R10
  SETTABLEKS R20 R13 K120 ["getPurchaserStatus"]
  DUPCLOSURE R20 K121 [PROTO_49]
  CAPTURE VAL R3
  CAPTURE VAL R11
  SETTABLEKS R20 R13 K122 ["getFiatProduct"]
  DUPCLOSURE R20 K123 [PROTO_50]
  CAPTURE VAL R3
  SETTABLEKS R20 R13 K124 ["getIsOwnedByUser"]
  DUPCLOSURE R20 K125 [PROTO_51]
  SETTABLEKS R20 R13 K126 ["getIsAssetOpenForUse"]
  RETURN R13 1
