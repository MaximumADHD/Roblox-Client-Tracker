...
MAIN:
  ...
  GETTABLEKS R9 R10 K21 ["getFFlagAssetConfigLinkToCreatorStore"]
  CALL R8 1 1
  ...
  CAPTURE VAL R3
  SETTABLEKS R20 R13 K94 ["getTagsMetadata"]
  DUPCLOSURE R20 K95 [PROTO_36]
  CAPTURE VAL R3
  SETTABLEKS R20 R13 K96 ["uploadCatalogItem"]
  DUPCLOSURE R20 K97 [PROTO_37]
  CAPTURE VAL R3
  SETTABLEKS R20 R13 K98 ["uploadCatalogItemFormat"]
  DUPCLOSURE R20 K99 [PROTO_38]
  CAPTURE VAL R3
  SETTABLEKS R20 R13 K100 ["getCreatorMarketplaceQuotas"]
  DUPCLOSURE R20 K101 [PROTO_39]
  CAPTURE VAL R3
  SETTABLEKS R20 R13 K102 ["getPublishingRequirements"]
  DUPCLOSURE R20 K103 [PROTO_40]
  CAPTURE VAL R3
  SETTABLEKS R20 R13 K104 ["getThumbnailStatus"]
  DUPCLOSURE R20 K105 [PROTO_41]
  CAPTURE VAL R3
  SETTABLEKS R20 R13 K106 ["getIsVerifiedCreator"]
  DUPCLOSURE R20 K107 [PROTO_42]
  CAPTURE VAL R3
  SETTABLEKS R20 R13 K108 ["getHomeConfiguration"]
  DUPCLOSURE R20 K109 [PROTO_43]
  CAPTURE VAL R3
  SETTABLEKS R20 R13 K110 ["getUniverseInfo"]
  DUPCLOSURE R20 K111 [PROTO_44]
  CAPTURE VAL R3
  CAPTURE VAL R12
  SETTABLEKS R20 R13 K112 ["purchaseAsset"]
  MOVE R20 R7
  CALL R20 0 1
  JUMPIFNOT R20 [+4]
  DUPCLOSURE R20 K113 [PROTO_45]
  CAPTURE VAL R3
  SETTABLEKS R20 R13 K114 ["postCreateBundleDataSharing"]
  MOVE R20 R6
  CALL R20 0 1
  JUMPIFNOT R20 [+5]
  ...
  CAPTURE VAL R3
  CAPTURE VAL R10
  SETTABLEKS R20 R13 K116 ["getPurchaserStatus"]
  DUPCLOSURE R20 K117 [PROTO_47]
  CAPTURE VAL R3
  CAPTURE VAL R11
  SETTABLEKS R20 R13 K118 ["getFiatProduct"]
  MOVE R20 R8
  CALL R20 0 1
  JUMPIF R20 [+5]
  ...
  CAPTURE VAL R3
  CAPTURE VAL R11
  SETTABLEKS R20 R13 K120 ["configureFiatProduct"]
  DUPCLOSURE R20 K121 [PROTO_49]
  CAPTURE VAL R3
  SETTABLEKS R20 R13 K122 ["getIsOwnedByUser"]
  DUPCLOSURE R20 K123 [PROTO_50]
  SETTABLEKS R20 R13 K124 ["getIsAssetOpenForUse"]
  RETURN R13 1
