...
MAIN:
  ...
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K87 ["getSave"]
  JUMP [+4]
  DUPCLOSURE R18 K88 [PROTO_34]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K89 ["getFavorited"]
  DUPCLOSURE R18 K90 [PROTO_35]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K91 ["getMetaData"]
  DUPCLOSURE R18 K92 [PROTO_36]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K93 ["getAllowedItemTypes"]
  MOVE R18 R5
  CALL R18 0 1
  JUMPIFNOT R18 [+4]
  DUPCLOSURE R18 K94 [PROTO_37]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K95 ["getUploadPermissionStatus"]
  DUPCLOSURE R18 K96 [PROTO_38]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K97 ["getTagsMetadata"]
  DUPCLOSURE R18 K98 [PROTO_39]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K99 ["uploadCatalogItem"]
  DUPCLOSURE R18 K100 [PROTO_40]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K101 ["uploadCatalogItemFormat"]
  DUPCLOSURE R18 K102 [PROTO_41]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K103 ["getCreatorMarketplaceQuotas"]
  DUPCLOSURE R18 K104 [PROTO_42]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K105 ["getPublishingRequirements"]
  DUPCLOSURE R18 K106 [PROTO_43]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K107 ["getThumbnailStatus"]
  DUPCLOSURE R18 K108 [PROTO_44]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K109 ["getIsVerifiedCreator"]
  DUPCLOSURE R18 K110 [PROTO_45]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K111 ["getHomeConfiguration"]
  DUPCLOSURE R18 K112 [PROTO_46]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K113 ["getUniverseInfo"]
  DUPCLOSURE R18 K114 [PROTO_47]
  CAPTURE VAL R3
  CAPTURE VAL R10
  SETTABLEKS R18 R11 K115 ["purchaseAsset"]
  DUPCLOSURE R18 K116 [PROTO_48]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K117 ["getDefaultCreateBundleDataSharing"]
  DUPCLOSURE R18 K118 [PROTO_49]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K119 ["postCreateBundleDataSharing"]
  DUPCLOSURE R18 K120 [PROTO_50]
  CAPTURE VAL R3
  CAPTURE VAL R8
  SETTABLEKS R18 R11 K121 ["getPurchaserStatus"]
  DUPCLOSURE R18 K122 [PROTO_51]
  CAPTURE VAL R3
  CAPTURE VAL R9
  SETTABLEKS R18 R11 K123 ["getFiatProduct"]
  DUPCLOSURE R18 K124 [PROTO_52]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K125 ["getIsOwnedByUser"]
  DUPCLOSURE R18 K126 [PROTO_53]
  SETTABLEKS R18 R11 K127 ["getIsAssetOpenForUse"]
  DUPCLOSURE R18 K128 [PROTO_54]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K129 ["getPluginInfo"]
  DUPCLOSURE R18 K130 [PROTO_55]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K131 ["getItemUploadFee"]
  DUPCLOSURE R18 K132 [PROTO_56]
  CAPTURE VAL R3
  CAPTURE VAL R1
  SETTABLEKS R18 R11 K133 ["getDevelopAssetMetadata"]
  DUPCLOSURE R18 K134 [PROTO_57]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K135 ["getItem"]
  DUPCLOSURE R18 K136 [PROTO_58]
  CAPTURE VAL R3
  SETTABLEKS R18 R11 K137 ["getAssetPermissions"]
  RETURN R11 1
