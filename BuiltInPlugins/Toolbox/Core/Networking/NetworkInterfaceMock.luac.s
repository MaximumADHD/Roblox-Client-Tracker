...
MAIN:
  ...
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K93 ["getTagsMetadata"]
  DUPCLOSURE R19 K94 [PROTO_36]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K95 ["uploadCatalogItem"]
  DUPCLOSURE R19 K96 [PROTO_37]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K97 ["uploadCatalogItemFormat"]
  DUPCLOSURE R19 K98 [PROTO_38]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K99 ["getCreatorMarketplaceQuotas"]
  DUPCLOSURE R19 K100 [PROTO_39]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K101 ["getPublishingRequirements"]
  DUPCLOSURE R19 K102 [PROTO_40]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K103 ["getThumbnailStatus"]
  DUPCLOSURE R19 K104 [PROTO_41]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K105 ["getIsVerifiedCreator"]
  DUPCLOSURE R19 K106 [PROTO_42]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K107 ["getHomeConfiguration"]
  DUPCLOSURE R19 K108 [PROTO_43]
  CAPTURE VAL R3
  CAPTURE VAL R1
  CAPTURE VAL R8
  SETTABLEKS R19 R12 K109 ["getAudioConfiguration"]
  DUPCLOSURE R19 K110 [PROTO_44]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K111 ["getUniverseInfo"]
  DUPCLOSURE R19 K112 [PROTO_45]
  CAPTURE VAL R3
  CAPTURE VAL R11
  SETTABLEKS R19 R12 K113 ["purchaseAsset"]
  MOVE R19 R7
  CALL R19 0 1
  JUMPIFNOT R19 [+4]
  DUPCLOSURE R19 K114 [PROTO_46]
  CAPTURE VAL R3
  SETTABLEKS R19 R12 K115 ["postCreateBundleDataSharing"]
  MOVE R19 R6
  CALL R19 0 1
  JUMPIFNOT R19 [+5]
  ...
  CAPTURE VAL R3
  CAPTURE VAL R9
  SETTABLEKS R19 R12 K117 ["getPurchaserStatus"]
  DUPCLOSURE R19 K118 [PROTO_48]
  CAPTURE VAL R3
  CAPTURE VAL R10
  SETTABLEKS R19 R12 K119 ["getFiatProduct"]
  DUPCLOSURE R19 K120 [PROTO_49]
  CAPTURE VAL R3
  CAPTURE VAL R10
  SETTABLEKS R19 R12 K121 ["configureFiatProduct"]
  RETURN R12 1
