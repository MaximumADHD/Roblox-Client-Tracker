...
MAIN:
  ...
  CALL R24 1 1
  GETTABLEKS R26 R8 K30 ["SharedFlags"]
  GETTABLEKS R25 R26 K31 ["getFFlagAssetPreviewContentAttribution"]
  GETIMPORT R26 K5 [require]
  GETTABLEKS R30 R0 K8 ["Core"]
  GETTABLEKS R29 R30 K9 ["Util"]
  GETTABLEKS R28 R29 K30 ["SharedFlags"]
  GETTABLEKS R27 R28 K32 ["getFFlagToolboxCodeUnderstandingSummary"]
  CALL R26 1 1
  GETIMPORT R27 K5 [require]
  GETTABLEKS R29 R4 K30 ["SharedFlags"]
  GETTABLEKS R28 R29 K33 ["getFFlagToolboxEnableFiatPurchasing"]
  CALL R27 1 1
  DUPCLOSURE R28 K34 [PROTO_0]
  CAPTURE VAL R6
  CAPTURE VAL R2
  CAPTURE VAL R9
  CAPTURE VAL R5
  CAPTURE VAL R7
  GETTABLEKS R29 R3 K35 ["createReducer"]
  DUPTABLE R30 K53 [{"idToAssetMap", "idsToRender", "isLoading", "totalAssets", "assetsReceived", "hasReachedBottom", "currentCursor", "previewModel", "previewAssetId", "previewSwimlaneName", "isPreviewing", "mostRecentAssetInsertTime", "manageableAssets", "previewPluginData", "creatingUniverseName", "creatingUniverseRootPlaceId", "codeSummaryMap"}]
  NEWTABLE R31 0 0
  SETTABLEKS R31 R30 K36 ["idToAssetMap"]
  NEWTABLE R31 0 0
  SETTABLEKS R31 R30 K37 ["idsToRender"]
  LOADB R31 1
  SETTABLEKS R31 R30 K38 ["isLoading"]
  LOADN R31 0
  SETTABLEKS R31 R30 K39 ["totalAssets"]
  LOADN R31 0
  SETTABLEKS R31 R30 K40 ["assetsReceived"]
  LOADB R31 0
  SETTABLEKS R31 R30 K41 ["hasReachedBottom"]
  GETTABLEKS R31 R7 K54 ["createDefaultCursor"]
  CALL R31 0 1
  SETTABLEKS R31 R30 K42 ["currentCursor"]
  LOADNIL R31
  SETTABLEKS R31 R30 K43 ["previewModel"]
  LOADNIL R31
  SETTABLEKS R31 R30 K44 ["previewAssetId"]
  LOADNIL R31
  SETTABLEKS R31 R30 K45 ["previewSwimlaneName"]
  LOADB R31 0
  SETTABLEKS R31 R30 K46 ["isPreviewing"]
  LOADN R31 0
  SETTABLEKS R31 R30 K47 ["mostRecentAssetInsertTime"]
  NEWTABLE R31 0 0
  SETTABLEKS R31 R30 K48 ["manageableAssets"]
  LOADNIL R31
  SETTABLEKS R31 R30 K49 ["previewPluginData"]
  LOADNIL R31
  SETTABLEKS R31 R30 K50 ["creatingUniverseName"]
  LOADNIL R31
  SETTABLEKS R31 R30 K51 ["creatingUniverseRootPlaceId"]
  MOVE R32 R26
  CALL R32 0 1
  JUMPIFNOT R32 [+3]
  NEWTABLE R31 0 0
  JUMP [+1]
  LOADNIL R31
  SETTABLEKS R31 R30 K52 ["codeSummaryMap"]
  NEWTABLE R31 16 0
  ...
  DUPCLOSURE R33 K60 [PROTO_5]
  CAPTURE VAL R28
  SETTABLE R33 R31 R32
  GETTABLEKS R32 R16 K55 ["name"]
  DUPCLOSURE R33 K61 [PROTO_6]
  CAPTURE VAL R2
  SETTABLE R33 R31 R32
  GETTABLEKS R32 R17 K55 ["name"]
  DUPCLOSURE R33 K62 [PROTO_7]
  CAPTURE VAL R2
  SETTABLE R33 R31 R32
  ...
  CAPTURE VAL R2
  SETTABLE R33 R31 R32
  GETTABLEKS R32 R22 K55 ["name"]
  DUPCLOSURE R33 K66 [PROTO_11]
  CAPTURE VAL R2
  SETTABLE R33 R31 R32
  GETTABLEKS R32 R23 K55 ["name"]
  MOVE R34 R25
  CALL R34 0 1
  JUMPIFNOT R34 [+3]
  DUPCLOSURE R33 K67 [PROTO_12]
  CAPTURE VAL R2
  JUMP [+1]
  LOADNIL R33
  SETTABLE R33 R31 R32
  ...
  CALL R34 0 1
  JUMPIFNOT R34 [+3]
  DUPCLOSURE R33 K68 [PROTO_13]
  CAPTURE VAL R2
  JUMP [+1]
  LOADNIL R33
  SETTABLE R33 R31 R32
  GETTABLEKS R32 R24 K55 ["name"]
  MOVE R34 R27
  CALL R34 0 1
  JUMPIFNOT R34 [+3]
