...
MAIN:
  ...
  CALL R26 1 1
  DUPCLOSURE R27 K33 [PROTO_0]
  CAPTURE VAL R6
  CAPTURE VAL R2
  CAPTURE VAL R9
  CAPTURE VAL R5
  CAPTURE VAL R7
  GETTABLEKS R28 R3 K34 ["createReducer"]
  DUPTABLE R29 K52 [{"idToAssetMap", "idsToRender", "isLoading", "totalAssets", "assetsReceived", "hasReachedBottom", "currentCursor", "previewModel", "previewAssetId", "previewSwimlaneName", "isPreviewing", "mostRecentAssetInsertTime", "manageableAssets", "previewPluginData", "creatingUniverseName", "creatingUniverseRootPlaceId", "codeSummaryMap"}]
  NEWTABLE R30 0 0
  SETTABLEKS R30 R29 K35 ["idToAssetMap"]
  NEWTABLE R30 0 0
  SETTABLEKS R30 R29 K36 ["idsToRender"]
  LOADB R30 1
  SETTABLEKS R30 R29 K37 ["isLoading"]
  LOADN R30 0
  SETTABLEKS R30 R29 K38 ["totalAssets"]
  LOADN R30 0
  SETTABLEKS R30 R29 K39 ["assetsReceived"]
  LOADB R30 0
  SETTABLEKS R30 R29 K40 ["hasReachedBottom"]
  GETTABLEKS R30 R7 K53 ["createDefaultCursor"]
  CALL R30 0 1
  SETTABLEKS R30 R29 K41 ["currentCursor"]
  LOADNIL R30
  SETTABLEKS R30 R29 K42 ["previewModel"]
  LOADNIL R30
  SETTABLEKS R30 R29 K43 ["previewAssetId"]
  LOADNIL R30
  SETTABLEKS R30 R29 K44 ["previewSwimlaneName"]
  LOADB R30 0
  SETTABLEKS R30 R29 K45 ["isPreviewing"]
  LOADN R30 0
  SETTABLEKS R30 R29 K46 ["mostRecentAssetInsertTime"]
  NEWTABLE R30 0 0
  SETTABLEKS R30 R29 K47 ["manageableAssets"]
  LOADNIL R30
  SETTABLEKS R30 R29 K48 ["previewPluginData"]
  LOADNIL R30
  SETTABLEKS R30 R29 K49 ["creatingUniverseName"]
  LOADNIL R30
  SETTABLEKS R30 R29 K50 ["creatingUniverseRootPlaceId"]
  MOVE R31 R26
  CALL R31 0 1
  JUMPIFNOT R31 [+3]
  NEWTABLE R30 0 0
  JUMP [+1]
  LOADNIL R30
  SETTABLEKS R30 R29 K51 ["codeSummaryMap"]
  NEWTABLE R30 16 0
  ...
  CAPTURE VAL R2
  SETTABLE R32 R30 R31
  GETTABLEKS R31 R22 K54 ["name"]
  DUPCLOSURE R32 K65 [PROTO_11]
  CAPTURE VAL R2
  SETTABLE R32 R30 R31
  GETTABLEKS R31 R23 K54 ["name"]
  MOVE R33 R25
  CALL R33 0 1
  JUMPIFNOT R33 [+3]
