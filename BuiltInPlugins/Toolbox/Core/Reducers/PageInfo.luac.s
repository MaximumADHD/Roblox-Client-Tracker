...
MAIN:
  ...
  GETTABLEKS R29 R30 K33 ["SharedFlags"]
  GETTABLEKS R28 R29 K39 ["getFFlagToolboxAddSortIntentFiltering"]
  CALL R27 1 1
  GETTABLEKS R28 R8 K40 ["SORT_OPTIONS"]
  LOADNIL R29
  MOVE R30 R25
  CALL R30 0 1
  JUMPIFNOT R30 [+3]
  GETTABLEKS R29 R7 K41 ["DEFAULT_TAB"]
  JUMP [+8]
  MOVE R30 R21
  CALL R30 0 1
  JUMPIFNOT R30 [+3]
  GETTABLEKS R29 R7 K42 ["INVENTORY"]
  JUMP [+2]
  GETTABLEKS R29 R7 K43 ["MARKETPLACE"]
  DUPCLOSURE R30 K44 [PROTO_0]
  GETTABLEKS R31 R4 K45 ["createReducer"]
  DUPTABLE R32 K70 [{"audioSearchInfo", "categories", "categoryName", "searchTerm", "sorts", "sortIndex", "groups", "groupIndex", "targetPage", "currentPage", "selectedBackgroundIndex", "hoveredBackgroundIndex", "requestReason", "lastLoggedSearchId", "correctionState", "correctedQuery", "userQuery", "creatorTargetIds", "excludeGroupCreations", "groupTargetIds", "includeUnverifiedCreators", "uiSortIntent", "sortDirection", "layoutMode"}]
  LOADNIL R33
  SETTABLEKS R33 R32 K46 ["audioSearchInfo"]
  SETTABLEKS R29 R32 K47 ["categories"]
  ...
  JUMP [+1]
  LOADNIL R33
  SETTABLEKS R33 R32 K64 ["excludeGroupCreations"]
  MOVE R34 R23
  CALL R34 0 1
  JUMPIFNOT R34 [+3]
  GETTABLEKS R33 R3 K77 ["None"]
