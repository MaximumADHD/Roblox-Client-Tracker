...
MAIN:
  ...
  GETTABLEKS R9 R10 K22 ["getFFlagCAP1107"]
  CALL R8 1 1
  GETIMPORT R9 K8 [require]
  GETTABLEKS R12 R1 K9 ["Src"]
  GETTABLEKS R11 R12 K21 ["Flags"]
  GETTABLEKS R10 R11 K23 ["getFIntCAP1107ThrottleHundredthsPercentage"]
  CALL R9 1 1
  GETIMPORT R10 K8 [require]
  GETTABLEKS R13 R1 K9 ["Src"]
  GETTABLEKS R12 R13 K21 ["Flags"]
  GETTABLEKS R11 R12 K24 ["getFFlagCAPDataSharingToEventIngest"]
  CALL R10 1 1
  GETIMPORT R12 K8 [require]
  GETTABLEKS R15 R1 K9 ["Src"]
  GETTABLEKS R14 R15 K12 ["Util"]
  GETTABLEKS R13 R14 K16 ["PublishPlaceAsUtilities"]
  CALL R12 1 1
  GETTABLEKS R11 R12 K25 ["sendAnalyticsToKibana"]
  GETIMPORT R12 K8 [require]
  GETTABLEKS R14 R1 K26 ["Packages"]
  GETTABLEKS R13 R14 K27 ["Cryo"]
  CALL R12 1 1
  DUPTABLE R13 K29 [{"isActive"}]
  LOADB R14 1
  SETTABLEKS R14 R13 K28 ["isActive"]
  DUPTABLE R14 K35 [{"description", "genre", "name", "playableDevices", "isFriendsOnly"}]
  LOADB R15 1
  SETTABLEKS R15 R14 K30 ["description"]
  LOADB R15 1
  SETTABLEKS R15 R14 K31 ["genre"]
  LOADB R15 1
  SETTABLEKS R15 R14 K32 ["name"]
  LOADB R15 1
  SETTABLEKS R15 R14 K33 ["playableDevices"]
  LOADB R15 1
  SETTABLEKS R15 R14 K34 ["isFriendsOnly"]
  MOVE R15 R6
  CALL R15 0 1
  JUMPIFNOT R15 [+3]
  LOADB R15 1
  SETTABLEKS R15 R14 K36 ["OptInLocations"]
  ...
  CAPTURE VAL R10
  CAPTURE VAL R3
  DUPTABLE R19 K42 [{"saveAll"}]
  SETTABLEKS R18 R19 K41 ["saveAll"]
  RETURN R19 1
