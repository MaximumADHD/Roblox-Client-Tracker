...
PROTO_1:
  ...
  CALL R1 -1 0
  GETUPVAL R1 1
  NAMECALL R1 R1 K2 ["GetUserId"]
  CALL R1 1 1
  DUPTABLE R2 K5 [{"Url", "Method"}]
  GETUPVAL R4 2
  GETTABLEKS R3 R4 K6 ["BuildRobloxUrl"]
  LOADK R4 K7 ["groups"]
  LOADK R5 K8 ["v2/users/%d/groups/roles"]
  MOVE R6 R1
  CALL R3 3 1
...
MAIN:
  ...
  GETTABLEKS R5 R6 K14 ["getFFlagCAP1107"]
  CALL R4 1 1
