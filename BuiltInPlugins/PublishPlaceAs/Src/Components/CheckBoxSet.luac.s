...
PROTO_1:
  ...
  GETUPVAL R20 1
  DUPTABLE R21 K49 [{"Checked", "Disabled", "Key", "LayoutOrder", "OnClick", "Text"}]
  LOADB R22 0
  GETTABLEKS R23 R16 K50 ["Selected"]
  JUMPIFEQKNIL R23 [+3]
  GETTABLEKS R22 R16 K50 ["Selected"]
  SETTABLEKS R22 R21 K44 ["Checked"]
  NOT R22 R6
  SETTABLEKS R22 R21 K45 ["Disabled"]
  GETTABLEKS R22 R16 K51 ["Id"]
  SETTABLEKS R22 R21 K46 ["Key"]
  SETTABLEKS R15 R21 K4 ["LayoutOrder"]
  NEWCLOSURE R22 P0
  CAPTURE VAL R7
  CAPTURE VAL R16
  SETTABLEKS R22 R21 K47 ["OnClick"]
  GETTABLEKS R22 R16 K2 ["Title"]
  SETTABLEKS R22 R21 K48 ["Text"]
  DUPTABLE R22 K53 [{"Link"}]
  GETTABLEKS R23 R16 K54 ["LinkTextFrame"]
  SETTABLEKS R23 R22 K52 ["Link"]
  CALL R19 3 -1
  FASTCALL TABLE_INSERT [+2]
  GETIMPORT R17 K56 [table.insert]
  CALL R17 -1 0
  ...
  GETUPVAL R14 0
  GETTABLEKS R13 R14 K57 ["Children"]
  GETTABLE R12 R1 R13
  JUMPIFNOT R12 [+12]
  GETUPVAL R14 2
  GETTABLEKS R13 R14 K58 ["Dictionary"]
  GETTABLEKS R12 R13 K59 ["join"]
  GETUPVAL R15 0
  GETTABLEKS R14 R15 K57 ["Children"]
  GETTABLE R13 R1 R14
  MOVE R14 R9
  CALL R12 2 1
  MOVE R9 R12
  ...
  LOADK R13 K60 ["TextLabel"]
  DUPTABLE R14 K68 [{"LayoutOrder", "Size", "BackgroundTransparency", "Text", "TextSize", "TextXAlignment", "TextYAlignment", "Font", "TextColor3"}]
  LENGTH R16 R5
  ADDK R15 R16 K3 [1]
  ...
  LOADN R15 1
  SETTABLEKS R15 R14 K62 ["BackgroundTransparency"]
  SETTABLEKS R8 R14 K48 ["Text"]
  LOADN R15 16
  SETTABLEKS R15 R14 K63 ["TextSize"]
  GETIMPORT R15 K70 [Enum.TextXAlignment.Left]
  SETTABLEKS R15 R14 K64 ["TextXAlignment"]
  GETIMPORT R15 K72 [Enum.TextYAlignment.Center]
  SETTABLEKS R15 R14 K65 ["TextYAlignment"]
  GETTABLEKS R16 R2 K73 ["checkboxset"]
  GETTABLEKS R15 R16 K74 ["font"]
  SETTABLEKS R15 R14 K66 ["Font"]
  GETTABLEKS R16 R2 K73 ["checkboxset"]
  GETTABLEKS R15 R16 K75 ["error"]
  SETTABLEKS R15 R14 K67 ["TextColor3"]
  CALL R12 2 1
  SETTABLEKS R12 R9 K76 ["Error"]
  LENGTH R13 R5
  MULK R12 R13 K77 [28]
  GETTABLEKS R13 R1 K78 ["MaxHeight"]
  JUMPIFNOT R13 [+3]
  GETTABLEKS R13 R1 K78 ["MaxHeight"]
  ADD R12 R12 R13
  GETTABLEKS R13 R1 K79 ["AbsoluteMaxHeight"]
  JUMPIFNOT R13 [+2]
  GETTABLEKS R12 R1 K79 ["AbsoluteMaxHeight"]
  GETUPVAL R14 0
  GETTABLEKS R13 R14 K17 ["createElement"]
  GETUPVAL R14 3
  DUPTABLE R15 K80 [{"LayoutOrder", "Title"}]
