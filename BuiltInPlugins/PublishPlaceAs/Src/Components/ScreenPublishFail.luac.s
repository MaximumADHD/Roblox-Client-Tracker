...
PROTO_8:
  ...
  DUPTABLE R3 K9 [{"Id", "Name", "ParentGameName", "ParentGameId", "Settings", "IsPublishing", "Message"}]
  GETTABLEKS R4 R2 K10 ["id"]
  SETTABLEKS R4 R3 K2 ["Id"]
  GETTABLEKS R4 R2 K11 ["name"]
  SETTABLEKS R4 R3 K3 ["Name"]
  GETTABLEKS R4 R2 K12 ["parentGameName"]
  SETTABLEKS R4 R3 K4 ["ParentGameName"]
  GETTABLEKS R4 R2 K13 ["parentGameId"]
  SETTABLEKS R4 R3 K5 ["ParentGameId"]
  GETTABLEKS R4 R2 K14 ["settings"]
  SETTABLEKS R4 R3 K6 ["Settings"]
  GETTABLEKS R5 R0 K0 ["PublishedPlace"]
  GETTABLEKS R4 R5 K15 ["isPublishing"]
  SETTABLEKS R4 R3 K7 ["IsPublishing"]
  GETTABLEKS R4 R2 K16 ["message"]
  SETTABLEKS R4 R3 K8 ["Message"]
  RETURN R3 1
