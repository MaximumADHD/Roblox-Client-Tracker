...
function TilePlace:init()
	...
	if self.props.Id then
		self.thumbnailUrl = FFlagBatchThumbnailAddNewThumbnailTypes and string.format("rbxthumb://type=AutoGeneratedAsset&id=%i&w=%i&h=%i", self.props.Id, ASSET_SIZE, ASSET_SIZE)
			or string.format("rbxthumb://type=Asset&id=%i&w=%i&h=%i", self.props.Id, ASSET_SIZE, ASSET_SIZE)
	end
end
