...
PROTO_2:
  GETUPVAL R1 0
  GETTABLEKS R0 R1 K0 ["retryThread"]
  JUMPIFEQKNIL R0 [+11]
  GETIMPORT R0 K3 [task.cancel]
  GETUPVAL R2 0
  GETTABLEKS R1 R2 K0 ["retryThread"]
  CALL R0 1 0
  GETUPVAL R0 0
  LOADNIL R1
  SETTABLEKS R1 R0 K0 ["retryThread"]
  GETUPVAL R0 0
...
PROTO_3:
  GETIMPORT R4 K3 [Enum.StudioPlaceUpdateFailureReason.TeamCreateConflict]
  JUMPIFNOTEQ R3 R4 [+33]
  GETUPVAL R7 0
  GETTABLEKS R6 R7 K4 ["props"]
  GETTABLEKS R5 R6 K5 ["Progress"]
  GETTABLEKS R4 R5 K6 ["FailCount"]
  GETUPVAL R5 1
  JUMPIFNOTLT R4 R5 [+23]
  GETUPVAL R6 0
  GETTABLEKS R5 R6 K4 ["props"]
  GETTABLEKS R4 R5 K7 ["DispatchFailCount"]
  GETUPVAL R9 0
  GETTABLEKS R8 R9 K4 ["props"]
  GETTABLEKS R7 R8 K5 ["Progress"]
  GETTABLEKS R6 R7 K6 ["FailCount"]
  ADDK R5 R6 K8 [1]
  CALL R4 1 0
  GETIMPORT R4 K10 [spawn]
  NEWCLOSURE R5 P0
  CAPTURE UPVAL U0
  CAPTURE UPVAL U2
  CAPTURE UPVAL U3
  ...
  GETUPVAL R6 0
  GETTABLEKS R5 R6 K4 ["props"]
  GETTABLEKS R4 R5 K11 ["OpenPublishSuccessfulPage"]
  GETUPVAL R8 0
  GETTABLEKS R7 R8 K4 ["props"]
  GETTABLEKS R6 R7 K5 ["Progress"]
  GETTABLEKS R5 R6 K12 ["Place"]
  GETUPVAL R9 0
  GETTABLEKS R8 R9 K4 ["props"]
  GETTABLEKS R7 R8 K5 ["Progress"]
  GETTABLEKS R6 R7 K13 ["Universe"]
  CALL R4 2 0
  JUMP [+21]
  GETUPVAL R6 0
  GETTABLEKS R5 R6 K4 ["props"]
  GETTABLEKS R4 R5 K14 ["OpenPublishFailPage"]
  GETUPVAL R8 0
  GETTABLEKS R7 R8 K4 ["props"]
  GETTABLEKS R6 R7 K5 ["Progress"]
  GETTABLEKS R5 R6 K12 ["Place"]
  ...
  GETUPVAL R6 0
  GETTABLEKS R5 R6 K4 ["props"]
  GETTABLEKS R4 R5 K15 ["DispatchRequestInFlight"]
  LOADB R5 0
  CALL R4 1 0
  RETURN R0 0
...
PROTO_5:
  ...
  GETTABLEKS R3 R4 K6 ["CloseMode"]
  NAMECALL R1 R1 K7 ["requestClose"]
  CALL R1 2 0
  RETURN R0 0
...
PROTO_6:
  ...
  JUMPIFNOTEQKB R7 FALSE [+49]
  GETTABLEKS R8 R1 K6 ["Progress"]
  GETTABLEKS R7 R8 K8 ["FailCount"]
  JUMPIFNOTEQKN R7 K9 [0] [+43]
  GETUPVAL R7 0
  ...
  CALL R8 3 1
  GETTABLEKS R10 R1 K6 ["Progress"]
  GETTABLEKS R9 R10 K8 ["FailCount"]
  LOADN R10 0
  JUMPIFNOTLT R10 R9 [+7]
  LOADK R11 K19 ["General"]
  LOADK R12 K23 ["UploadErrorRetry"]
...
PROTO_9:
  GETUPVAL R1 0
  GETUPVAL R2 1
  DUPTABLE R3 K1 [{"failCount"}]
  SETTABLEKS R0 R3 K0 ["failCount"]
  CALL R2 1 -1
  CALL R1 -1 0
  RETURN R0 0
...
PROTO_12:
  DUPTABLE R1 K4 [{"DispatchRequestInFlight", "DispatchFailCount", "OpenPublishSuccessfulPage", "OpenPublishFailPage"}]
  NEWCLOSURE R2 P0
  CAPTURE VAL R0
  CAPTURE UPVAL U0
  ...
  CAPTURE VAL R0
  CAPTURE UPVAL U0
  SETTABLEKS R2 R1 K1 ["DispatchFailCount"]
  NEWCLOSURE R2 P2
  CAPTURE VAL R0
  CAPTURE UPVAL U1
  CAPTURE UPVAL U2
  CAPTURE UPVAL U3
  SETTABLEKS R2 R1 K2 ["OpenPublishSuccessfulPage"]
  NEWCLOSURE R2 P3
  CAPTURE VAL R0
  CAPTURE UPVAL U1
  CAPTURE UPVAL U2
  CAPTURE UPVAL U3
  SETTABLEKS R2 R1 K3 ["OpenPublishFailPage"]
  RETURN R1 1
...
MAIN:
  ...
  SETTABLEKS R19 R16 K34 ["init"]
  DUPCLOSURE R19 K35 [PROTO_4]
  CAPTURE VAL R1
  CAPTURE VAL R17
  CAPTURE VAL R18
  SETTABLEKS R19 R16 K36 ["didMount"]
  DUPCLOSURE R19 K37 [PROTO_5]
  CAPTURE VAL R2
  SETTABLEKS R19 R16 K38 ["willUnmount"]
  DUPCLOSURE R19 K39 [PROTO_6]
  CAPTURE VAL R1
  CAPTURE VAL R4
  CAPTURE VAL R10
  CAPTURE VAL R9
  SETTABLEKS R19 R16 K40 ["render"]
  MOVE R19 R7
  DUPTABLE R20 K43 [{"Stylizer", "Localization"}]
  GETTABLEKS R21 R6 K41 ["Stylizer"]
  SETTABLEKS R21 R20 K41 ["Stylizer"]
  GETTABLEKS R21 R6 K42 ["Localization"]
  SETTABLEKS R21 R20 K42 ["Localization"]
  CALL R19 1 1
  MOVE R20 R16
  CALL R19 1 1
  MOVE R16 R19
