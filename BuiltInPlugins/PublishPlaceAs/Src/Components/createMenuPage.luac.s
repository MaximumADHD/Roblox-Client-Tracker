...
PROTO_3:
        ...
        2 GETTABLEKS                       R1 R2 K1 ["GetPlayerAcceptances"]
        4 JUMPIFNOT                        R1 ; [+13]
        5 GETTABLEKS                       R2 R0 K0 ["props"]
        7 GETTABLEKS                       R1 R2 K2 ["API"]
        9 NAMECALL                         R1 R1 K3 ["get"]
       11 CALL                             R1 1 1
       12 GETTABLEKS                       R3 R0 K0 ["props"]
       14 GETTABLEKS                       R2 R3 K1 ["GetPlayerAcceptances"]
       16 MOVE                             R3 R1
       17 CALL                             R2 1 0
       18 RETURN                           R0 0
...
PROTO_4:
        ...
        1 JUMPIFNOT                        R1 ; [+6]
        2 GETUPVAL                         R1 0
        3 GETTABLEKS                       R3 R0 K0 ["AbsoluteContentSize"]
...
PROTO_5:
       ...
       41 GETUPVAL                         R11 1
       42 GETTABLEKS                       R10 R11 K17 ["Dictionary"]
       44 GETTABLEKS                       R9 R10 K18 ["join"]
       46 MOVE                             R10 R2
       47 DUPTABLE                         R11 K21 [{"Padding", "Layout"}]
       48 GETUPVAL                         R13 0
       49 GETTABLEKS                       R12 R13 K5 ["createElement"]
       ...
       71 JUMPIFNOT                        R12 ; [+26]
       72 GETUPVAL                         R13 0
       73 GETTABLEKS                       R12 R13 K5 ["createElement"]
       ...
       89 GETUPVAL                         R17 0
       90 GETTABLEKS                       R16 R17 K31 ["Change"]
       92 GETTABLEKS                       R15 R16 K32 ["AbsoluteContentSize"]
...
PROTO_6:
        0 GETUPVAL                         R4 0
        1 GETTABLEKS                       R3 R4 K0 ["NewGameSettings"]
        3 GETTABLEKS                       R2 R3 K1 ["changed"]
        5 GETTABLE                         R1 R2 R0
        6 JUMPIFEQKNIL                     R1 ; [+8]
        8 GETUPVAL                         R4 0
        9 GETTABLEKS                       R3 R4 K0 ["NewGameSettings"]
       11 GETTABLEKS                       R2 R3 K1 ["changed"]
       13 GETTABLE                         R1 R2 R0
       14 RETURN                           R1 1
       15 GETUPVAL                         R4 0
       16 GETTABLEKS                       R3 R4 K0 ["NewGameSettings"]
       18 GETTABLEKS                       R2 R3 K2 ["current"]
...
PROTO_8:
        ...
        2 CALL                             R4 1 1
        3 GETTABLEKS                       R3 R4 K1 ["NewGameSettings"]
        5 GETTABLEKS                       R2 R3 K2 ["changed"]
        7 GETUPVAL                         R3 0
        8 GETTABLE                         R1 R2 R3
        9 GETUPVAL                         R2 1
       10 JUMPIFEQ                         R1 R2 ; [+9]
...
PROTO_12:
       ...
       22 GETUPVAL                         R6 4
       23 GETTABLEKS                       R5 R6 K9 ["Stylizer"]
       25 SETTABLEKS                       R5 R4 K9 ["Stylizer"]
       27 GETUPVAL                         R6 4
       28 GETTABLEKS                       R5 R6 K10 ["Localization"]
       30 SETTABLEKS                       R5 R4 K10 ["Localization"]
       32 GETUPVAL                         R6 4
       33 GETTABLEKS                       R5 R6 K11 ["Mouse"]
       35 SETTABLEKS                       R5 R4 K11 ["Mouse"]
       37 GETUPVAL                         R6 4
       38 GETTABLEKS                       R5 R6 K12 ["API"]
       ...
       51 CAPTURE                          UPVAL U6
       52 GETUPVAL                         R6 7
       53 GETTABLEKS                       R5 R6 K14 ["connect"]
       55 MOVE                             R6 R3
       56 MOVE                             R7 R4
       57 CALL                             R5 2 1
       58 MOVE                             R6 R2
...
MAIN:
       ...
       36 GETTABLEKS                       R5 R6 K11 ["getFFlagPublishPlaceFixRenderThrash"]
       38 CALL                             R4 1 1
       39 GETIMPORT                        R5 K4 [require]
       41 GETTABLEKS                       R7 R0 K5 ["Packages"]
       43 GETTABLEKS                       R6 R7 K12 ["Framework"]
       45 CALL                             R5 1 1
       ...
       58 GETTABLEKS                       R12 R13 K17 ["Actions"]
       60 GETTABLEKS                       R11 R12 K18 ["AddChange"]
       62 CALL                             R10 1 1
