...
function TileGame:init()
	...
	if not FFlagStudioFixSwappingGroupTabs then
...
function TileGame:render()
	return Theming.withTheme(function(theme)
		return Localizing.withLocalization(function(localizing)
			...
			if FFlagStudioFixSwappingGroupTabs then
				self.thumbnailUrl = FFlagBatchThumbnailAddNewThumbnailTypes and string.format("rbxthumb://type=AutoGeneratedAsset&id=%i&w=%i&h=%i", props.Id, ICON_SIZE, ICON_SIZE)
					or string.format("rbxthumb://type=GameIcon&id=%i&w=%i&h=%i", props.Id, ICON_SIZE, ICON_SIZE)
			end
