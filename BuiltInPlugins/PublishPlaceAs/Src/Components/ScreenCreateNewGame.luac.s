...
PROTO_8:
  ...
  RETURN R0 0
  GETUPVAL R5 7
  DUPTABLE R7 K7 [{"bottomText"}]
  GETUPVAL R8 11
  GETUPVAL R10 0
  LOADK R11 K8 ["ErrorEmailNotEqual"]
...
PROTO_10:
  ...
  DUPTABLE R3 K5 [{"Changed", "ReadyToSave", "IsPublishing", "ChangedOptInLocations"}]
  GETTABLEKS R4 R2 K6 ["changed"]
  SETTABLEKS R4 R3 K1 ["Changed"]
  GETIMPORT R5 K8 [next]
  GETTABLEKS R6 R2 K9 ["errors"]
  CALL R5 1 1
  JUMPIFEQKNIL R5 [+2]
  LOADB R4 0 +1
  LOADB R4 1
  SETTABLEKS R4 R3 K2 ["ReadyToSave"]
  GETTABLEKS R5 R0 K10 ["PublishedPlace"]
  GETTABLEKS R4 R5 K11 ["isPublishing"]
  SETTABLEKS R4 R3 K3 ["IsPublishing"]
  GETTABLEKS R5 R2 K6 ["changed"]
  GETTABLEKS R4 R5 K12 ["OptInLocations"]
  SETTABLEKS R4 R3 K4 ["ChangedOptInLocations"]
  RETURN R3 1
...
PROTO_16:
  DUPTABLE R1 K5 [{"OpenPublishSuccessfulPage", "OpenPublishFailPage", "DispatchLoadGroups", "dispatchSetIsPublishing", "dispatchSetExistingUniverseConfiguration"}]
  NEWCLOSURE R2 P0
  CAPTURE VAL R0
  CAPTURE UPVAL U0
  CAPTURE UPVAL U1
  ...
  CAPTURE VAL R0
  CAPTURE UPVAL U4
  SETTABLEKS R2 R1 K3 ["dispatchSetIsPublishing"]
  NEWCLOSURE R2 P4
  CAPTURE VAL R0
  CAPTURE UPVAL U5
  SETTABLEKS R2 R1 K4 ["dispatchSetExistingUniverseConfiguration"]
  RETURN R1 1
...
MAIN:
  ...
  GETTABLEKS R21 R22 K33 ["PublishPlaceAsUtilities"]
  CALL R20 1 1
  GETTABLEKS R19 R20 K34 ["shouldShowDevPublishLocations"]
  GETIMPORT R21 K4 [require]
  GETTABLEKS R24 R0 K13 ["Src"]
  GETTABLEKS R23 R24 K32 ["Util"]
  GETTABLEKS R22 R23 K33 ["PublishPlaceAsUtilities"]
  CALL R21 1 1
  GETTABLEKS R20 R21 K35 ["sendAnalyticsToKibana"]
  GETIMPORT R21 K37 [game]
  LOADK R23 K38 ["LuobuDevPublishAnalyticsHundredthsPercentage"]
  NAMECALL R21 R21 K39 ["GetFastInt"]
  CALL R21 2 1
  GETTABLEKS R23 R3 K11 ["UI"]
  GETTABLEKS R22 R23 K40 ["TextInputDialog"]
  GETIMPORT R23 K4 [require]
  GETTABLEKS R26 R0 K13 ["Src"]
  GETTABLEKS R25 R26 K32 ["Util"]
  GETTABLEKS R24 R25 K41 ["KeyProvider"]
  CALL R23 1 1
  GETTABLEKS R24 R23 K42 ["getOptInLocationsKeyName"]
  CALL R24 0 1
  GETTABLEKS R25 R23 K43 ["getChinaKeyName"]
  CALL R25 0 1
  GETTABLEKS R26 R23 K44 ["getLuobuStudioDevPublishKeyName"]
  CALL R26 0 1
  GETTABLEKS R27 R23 K45 ["getSelectedKeyName"]
  CALL R27 0 1
  GETTABLEKS R28 R23 K46 ["getCreateNewGameKeyName"]
  CALL R28 0 1
  GETIMPORT R29 K37 [game]
  LOADK R31 K47 ["StudioPublishService"]
  NAMECALL R29 R29 K48 ["GetService"]
  CALL R29 2 1
  NEWTABLE R30 0 1
  LOADK R31 K24 ["BasicInfo"]
  SETLIST R30 R31 1 [1]
  GETTABLEKS R31 R1 K49 ["PureComponent"]
  LOADK R33 K50 ["ScreenCreateNewGame"]
  NAMECALL R31 R31 K51 ["extend"]
  CALL R31 2 1
  DUPCLOSURE R32 K52 [PROTO_2]
  CAPTURE VAL R1
  CAPTURE VAL R25
  SETTABLEKS R32 R31 K53 ["init"]
  DUPCLOSURE R32 K54 [PROTO_4]
  CAPTURE VAL R29
  SETTABLEKS R32 R31 K55 ["didMount"]
  DUPCLOSURE R32 K56 [PROTO_5]
  SETTABLEKS R32 R31 K57 ["willUnmount"]
  DUPCLOSURE R32 K58 [PROTO_9]
  CAPTURE VAL R1
  CAPTURE VAL R11
  CAPTURE VAL R30
  CAPTURE VAL R10
  ...
  CAPTURE VAL R22
  CAPTURE VAL R7
  SETTABLEKS R32 R31 K59 ["render"]
  MOVE R32 R5
  DUPTABLE R33 K63 [{"Stylizer", "Localization", "API"}]
  GETTABLEKS R34 R4 K60 ["Stylizer"]
  SETTABLEKS R34 R33 K60 ["Stylizer"]
  GETTABLEKS R34 R4 K61 ["Localization"]
  SETTABLEKS R34 R33 K61 ["Localization"]
  GETTABLEKS R34 R4 K62 ["API"]
  SETTABLEKS R34 R33 K62 ["API"]
  CALL R32 1 1
  MOVE R33 R31
  CALL R32 1 1
  MOVE R31 R32
  DUPCLOSURE R32 K64 [PROTO_10]
  DUPCLOSURE R33 K65 [PROTO_16]
  CAPTURE VAL R17
  CAPTURE VAL R16
  CAPTURE VAL R9
  CAPTURE VAL R18
