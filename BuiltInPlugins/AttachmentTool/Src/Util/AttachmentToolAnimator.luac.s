...
PROTO_1:
  DUPTABLE R2 K1 [{"_attachmentToolModel"}]
  SETTABLEKS R0 R2 K0 ["_attachmentToolModel"]
  GETUPVAL R3 0
...
PROTO_3:
  GETTABLEKS R4 R0 K0 ["_attachmentToolModel"]
  GETTABLEKS R3 R4 K1 ["_lastDragTarget"]
  JUMPIFNOT R2 [+12]
  GETTABLEKS R5 R0 K0 ["_attachmentToolModel"]
  ...
  GETTABLEKS R11 R0 K0 ["_attachmentToolModel"]
  ...
  MUL R11 R6 R8
  MUL R10 R11 R7
  GETTABLEKS R12 R0 K0 ["_attachmentToolModel"]
