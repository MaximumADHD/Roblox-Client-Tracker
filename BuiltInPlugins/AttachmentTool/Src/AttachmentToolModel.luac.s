...
PROTO_2:
  ...
  LOADK R14 K4 ["Unexpected AttachmentToolModel prop `"]
  MOVE R15 R10
  LOADK R16 K5 ["`"]
  CONCAT R13 R14 R16
  CALL R12 1 0
  ...
  MOVE R17 R11
  LOADK R18 K7 ["` missing from AttachmentToolModel props"]
  CONCAT R15 R16 R18
  CALL R14 1 0
  JUMP [+1]
  SETTABLE R13 R7 R11
...
MAIN:
  ...
  GETTABLEKS R11 R2 K21 ["Flags"]
  GETTABLEKS R10 R11 K22 ["getFFlagDraggerSnapToPartsLua"]
  CALL R9 1 1
  NEWTABLE R10 32 0
  ...
  CALL R11 0 1
  DUPTABLE R12 K32 [{"AllowDragSelect", "ShowLocalSpaceIndicator", "WasAutoSelected", "ShowPivotIndicator", "ShowDragSelect"}]
  LOADB R13 1
  SETTABLEKS R13 R12 K27 ["AllowDragSelect"]
  LOADB R13 0
  SETTABLEKS R13 R12 K28 ["ShowLocalSpaceIndicator"]
  LOADB R13 0
  SETTABLEKS R13 R12 K29 ["WasAutoSelected"]
  LOADB R13 0
  SETTABLEKS R13 R12 K30 ["ShowPivotIndicator"]
  LOADB R13 1
  SETTABLEKS R13 R12 K31 ["ShowDragSelect"]
  DUPTABLE R13 K34 [{"AnalyticsName"}]
  LOADB R14 1
  SETTABLEKS R14 R13 K33 ["AnalyticsName"]
  ...
  CAPTURE VAL R8
  CAPTURE VAL R1
  SETTABLEKS R14 R10 K25 ["new"]
  DUPCLOSURE R14 K36 [PROTO_3]
  CAPTURE VAL R3
  SETTABLEKS R14 R10 K37 ["render"]
  DUPCLOSURE R14 K38 [PROTO_4]
  SETTABLEKS R14 R10 K39 ["update"]
  DUPCLOSURE R14 K40 [PROTO_5]
  SETTABLEKS R14 R10 K41 ["getSelectionWrapper"]
  DUPCLOSURE R14 K42 [PROTO_6]
  SETTABLEKS R14 R10 K43 ["getSchema"]
  DUPCLOSURE R14 K44 [PROTO_7]
  SETTABLEKS R14 R10 K45 ["doesAllowDragSelect"]
  DUPCLOSURE R14 K46 [PROTO_8]
  SETTABLEKS R14 R10 K47 ["shouldShowDragSelect"]
  DUPCLOSURE R14 K48 [PROTO_9]
  SETTABLEKS R14 R10 K49 ["shouldShowLocalSpaceIndicator"]
  DUPCLOSURE R14 K50 [PROTO_10]
  SETTABLEKS R14 R10 K51 ["shouldShowSelectionDot"]
  DUPCLOSURE R14 K52 [PROTO_11]
  SETTABLEKS R14 R10 K53 ["shouldUseCollisionTransparency"]
  DUPCLOSURE R14 K54 [PROTO_12]
  SETTABLEKS R14 R10 K55 ["shouldAlignDraggedObjects"]
  DUPCLOSURE R14 K56 [PROTO_13]
  SETTABLEKS R14 R10 K57 ["_isDraggingAttachment"]
  DUPCLOSURE R14 K58 [PROTO_14]
  CAPTURE VAL R6
  CAPTURE VAL R11
  CAPTURE VAL R9
  CAPTURE VAL R1
  CAPTURE VAL R4
  SETTABLEKS R14 R10 K59 ["_updateAttachment"]
  DUPCLOSURE R14 K60 [PROTO_15]
  CAPTURE VAL R6
  SETTABLEKS R14 R10 K61 ["_rotateAttachment"]
  DUPCLOSURE R14 K62 [PROTO_16]
  SETTABLEKS R14 R10 K63 ["_isAttachmentInSelection"]
  DUPCLOSURE R14 K64 [PROTO_17]
  SETTABLEKS R14 R10 K65 ["_closeTool"]
  DUPCLOSURE R14 K66 [PROTO_20]
  CAPTURE VAL R4
  SETTABLEKS R14 R10 K67 ["_processSelected"]
  DUPCLOSURE R14 K68 [PROTO_21]
  SETTABLEKS R14 R10 K69 ["_onUndo"]
  DUPCLOSURE R14 K70 [PROTO_22]
  SETTABLEKS R14 R10 K71 ["_onRedo"]
  DUPCLOSURE R14 K72 [PROTO_23]
  CAPTURE VAL R1
  SETTABLEKS R14 R10 K73 ["_processDeselected"]
  DUPCLOSURE R14 K74 [PROTO_24]
  SETTABLEKS R14 R10 K75 ["_processSelectionChanged"]
  GETIMPORT R14 K78 [table.freeze]
  NEWTABLE R15 8 0
  GETIMPORT R16 K82 [Enum.KeyCode.RightShift]
  LOADB R17 1
  SETTABLE R17 R15 R16
  GETIMPORT R16 K84 [Enum.KeyCode.LeftShift]
  LOADB R17 1
  SETTABLE R17 R15 R16
  GETIMPORT R16 K86 [Enum.KeyCode.RightControl]
  LOADB R17 1
  SETTABLE R17 R15 R16
  GETIMPORT R16 K88 [Enum.KeyCode.LeftControl]
  LOADB R17 1
  SETTABLE R17 R15 R16
  GETIMPORT R16 K90 [Enum.KeyCode.RightAlt]
  LOADB R17 1
  SETTABLE R17 R15 R16
  GETIMPORT R16 K92 [Enum.KeyCode.LeftAlt]
  LOADB R17 1
  SETTABLE R17 R15 R16
  CALL R14 1 1
  DUPCLOSURE R15 K93 [PROTO_25]
  CAPTURE VAL R14
  SETTABLEKS R15 R10 K94 ["_processKeyDown"]
  DUPCLOSURE R15 K95 [PROTO_26]
  CAPTURE VAL R14
  SETTABLEKS R15 R10 K96 ["_processKeyUp"]
  DUPCLOSURE R15 K97 [PROTO_27]
  SETTABLEKS R15 R10 K98 ["_processMouseDown"]
  DUPCLOSURE R15 K99 [PROTO_28]
  CAPTURE VAL R1
  SETTABLEKS R15 R10 K100 ["_processMouseUp"]
  DUPCLOSURE R15 K101 [PROTO_29]
  SETTABLEKS R15 R10 K102 ["_processViewChanged"]
  DUPCLOSURE R15 K103 [PROTO_30]
  SETTABLEKS R15 R10 K104 ["_updateSelectionInfo"]
  DUPCLOSURE R15 K105 [PROTO_31]
  SETTABLEKS R15 R10 K106 ["_processMouseEnter"]
  DUPCLOSURE R15 K107 [PROTO_32]
  SETTABLEKS R15 R10 K108 ["_processMouseLeave"]
  DUPCLOSURE R15 K109 [PROTO_33]
  SETTABLEKS R15 R10 K110 ["_scheduleRender"]
  RETURN R10 1
