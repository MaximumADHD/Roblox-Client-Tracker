...
local ButtonDefinitions = {
	[1] = {
		Image = "rbxasset://textures/AlignmentTool/align_mode_min.png",
		Mode = AlignmentMode.Min,
	},
	[2] = {
		Image = "rbxasset://textures/AlignmentTool/align_mode_center.png",
		Mode = AlignmentMode.Center,
	},
	[3] = {
		Image = "rbxasset://textures/AlignmentTool/align_mode_max.png",
