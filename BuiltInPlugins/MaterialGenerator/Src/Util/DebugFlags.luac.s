PROTO_0:
  GETUPVAL R0 0
  LOADK R2 K0 ["MaterialGeneratorFlags"]
...
MAIN:
  ...
  CAPTURE VAL R0
  DUPTABLE R6 K21 [{"RunningUnderCLI", "RunTests", "LogTestsQuiet", "LogAnalytics", "RunDeveloperFrameworkTests", "EnableRoactConfigs", "ForceGenerationError"}]
  ORK R8 R4 K22 [False]
  ...
  LOADK R8 K20 ["ForceGenerationError"]
  LOADB R9 0
  NEWCLOSURE R7 P1
  CAPTURE VAL R0
  CAPTURE VAL R8
  CAPTURE VAL R9
  SETTABLEKS R7 R6 K20 ["ForceGenerationError"]
  RETURN R6 1
