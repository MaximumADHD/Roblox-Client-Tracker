...
PROTO_7:
  ...
  LOADNIL R6
  CALL R5 1 2
  DUPTABLE R7 K12 [{"promptGroups", "materialStates", "addMaterials", "removeMaterial", "removeAllMaterials", "hasBaseMaterial", "markHasBaseMaterial", "getMaterialStatus", "setMaterialStatus", "previewMaterial", "setPreviewMaterial"}]
  ...
  SETTABLEKS R5 R7 K10 ["previewMaterial"]
  SETTABLEKS R6 R7 K11 ["setPreviewMaterial"]
  GETUPVAL R9 0
  GETTABLEKS R8 R9 K20 ["createElement"]
  GETUPVAL R10 1
  GETTABLEKS R9 R10 K21 ["Provider"]
  DUPTABLE R10 K23 [{"value"}]
  SETTABLEKS R7 R10 K22 ["value"]
  GETTABLEKS R11 R0 K24 ["children"]
  CALL R8 3 -1
  RETURN R8 -1
