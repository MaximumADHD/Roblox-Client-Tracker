...
MAIN:
  ...
  GETTABLEKS R30 R27 K39 ["GenerateMaterialMaps"]
  CALL R29 1 1
  GETIMPORT R30 K4 [require]
  GETTABLEKS R31 R27 K40 ["RemoveMaterial"]
  CALL R30 1 1
  GETIMPORT R31 K4 [require]
  GETTABLEKS R32 R27 K41 ["UpdateMaterial"]
  CALL R31 1 1
  GETIMPORT R32 K4 [require]
  GETTABLEKS R33 R27 K42 ["UploadMaterial"]
  CALL R32 1 1
  GETTABLEKS R34 R0 K14 ["Src"]
  GETTABLEKS R33 R34 K43 ["Components"]
  GETIMPORT R34 K4 [require]
  GETTABLEKS R35 R33 K44 ["Browser"]
  CALL R34 1 1
  GETIMPORT R35 K4 [require]
  GETTABLEKS R36 R33 K45 ["Editor"]
  CALL R35 1 1
  GETIMPORT R36 K4 [require]
  GETTABLEKS R37 R33 K46 ["Header"]
  CALL R36 1 1
  GETIMPORT R37 K4 [require]
  GETTABLEKS R38 R33 K47 ["MaterialView"]
  CALL R37 1 1
  GETIMPORT R38 K4 [require]
  GETTABLEKS R39 R33 K48 ["TextureBrowser"]
  CALL R38 1 1
  GETIMPORT R39 K4 [require]
  GETTABLEKS R40 R33 K49 ["ErrorBox"]
  CALL R39 1 1
  GETIMPORT R40 K4 [require]
  GETTABLEKS R41 R33 K50 ["MaterialVariantProvider"]
  CALL R40 1 1
  GETIMPORT R41 K4 [require]
  GETTABLEKS R44 R0 K14 ["Src"]
  GETTABLEKS R43 R44 K51 ["Controllers"]
  GETTABLEKS R42 R43 K52 ["MaterialPreviewController"]
  CALL R41 1 1
  GETTABLEKS R43 R0 K14 ["Src"]
  GETTABLEKS R42 R43 K53 ["Enum"]
  GETIMPORT R43 K4 [require]
  GETTABLEKS R44 R42 K54 ["GenerationErrorType"]
  CALL R43 1 1
  GETIMPORT R44 K4 [require]
  GETTABLEKS R47 R0 K14 ["Src"]
  GETTABLEKS R46 R47 K55 ["Flags"]
  GETTABLEKS R45 R46 K56 ["getFFlagConcurrentMaterialMapsRequests"]
  CALL R44 1 1
  GETIMPORT R45 K4 [require]
  GETTABLEKS R48 R0 K14 ["Src"]
  GETTABLEKS R47 R48 K55 ["Flags"]
  GETTABLEKS R46 R47 K57 ["getFFlagMaterialGeneratorNewUI"]
  CALL R45 1 1
  GETIMPORT R46 K4 [require]
  GETTABLEKS R49 R0 K14 ["Src"]
  GETTABLEKS R48 R49 K55 ["Flags"]
  GETTABLEKS R47 R48 K58 ["getFFlagMaterialGeneratorSupportVariations2"]
  CALL R46 1 1
  GETTABLEKS R47 R1 K59 ["join"]
  GETTABLEKS R48 R4 K60 ["PureComponent"]
  LOADK R50 K61 ["MainView"]
  NAMECALL R48 R48 K62 ["extend"]
  CALL R48 2 1
  DUPCLOSURE R49 K63 [PROTO_1]
  CAPTURE VAL R4
  SETTABLEKS R49 R48 K64 ["init"]
  DUPCLOSURE R49 K65 [PROTO_2]
  SETTABLEKS R49 R48 K66 ["didMount"]
  DUPCLOSURE R49 K67 [PROTO_3]
  CAPTURE VAL R43
  SETTABLEKS R49 R48 K68 ["didUpdate"]
  DUPCLOSURE R49 K69 [PROTO_12]
  CAPTURE VAL R16
  CAPTURE VAL R45
  CAPTURE VAL R47
  CAPTURE VAL R43
  ...
  CAPTURE VAL R40
  CAPTURE VAL R35
  SETTABLEKS R49 R48 K70 ["render"]
  DUPCLOSURE R49 K71 [PROTO_13]
  CAPTURE VAL R43
  SETTABLEKS R49 R48 K72 ["_getErrorMesssage"]
  MOVE R49 R9
  DUPTABLE R50 K73 [{"Analytics", "Localization", "MaterialPreviewController", "StudioServices", "Stylizer"}]
  SETTABLEKS R10 R50 K17 ["Analytics"]
  SETTABLEKS R11 R50 K18 ["Localization"]
  MOVE R52 R45
  CALL R52 0 1
  JUMPIFNOT R52 [+2]
  LOADNIL R51
  JUMP [+1]
  MOVE R51 R41
  SETTABLEKS R51 R50 K52 ["MaterialPreviewController"]
  SETTABLEKS R18 R50 K28 ["StudioServices"]
  SETTABLEKS R12 R50 K20 ["Stylizer"]
  CALL R49 1 1
  MOVE R50 R48
  CALL R49 1 1
  MOVE R48 R49
  DUPCLOSURE R49 K74 [PROTO_14]
  DUPCLOSURE R50 K75 [PROTO_25]
  CAPTURE VAL R45
  CAPTURE VAL R20
  CAPTURE VAL R24
  CAPTURE VAL R43
