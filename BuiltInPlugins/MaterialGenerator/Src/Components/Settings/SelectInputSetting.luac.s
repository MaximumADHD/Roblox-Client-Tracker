...
PROTO_2:
  ...
  GETTABLEKS R4 R1 K8 ["Disabled"]
  GETTABLEKS R5 R1 K9 ["Items"]
  GETTABLEKS R6 R1 K10 ["LabelWidth"]
  GETUPVAL R7 0
  ...
  GETUPVAL R13 3
  DUPTABLE R14 K18 [{"HorizontalAlignment", "Layout", "LayoutOrder", "Size", "Spacing", "VerticalAlignment"}]
  GETIMPORT R15 K21 [Enum.HorizontalAlignment.Left]
  SETTABLEKS R15 R14 K13 ["HorizontalAlignment"]
  GETIMPORT R15 K24 [Enum.FillDirection.Horizontal]
  SETTABLEKS R15 R14 K14 ["Layout"]
  GETTABLEKS R15 R1 K15 ["LayoutOrder"]
  SETTABLEKS R15 R14 K15 ["LayoutOrder"]
  SETTABLEKS R7 R14 K2 ["Size"]
  SETTABLEKS R3 R14 K16 ["Spacing"]
  GETIMPORT R15 K26 [Enum.VerticalAlignment.Top]
  SETTABLEKS R15 R14 K17 ["VerticalAlignment"]
  DUPTABLE R15 K29 [{"Label", "SelectInput"}]
  GETUPVAL R17 2
  GETTABLEKS R16 R17 K12 ["createElement"]
  GETUPVAL R17 4
  DUPTABLE R18 K33 [{"LayoutOrder", "Size", "StyleModifier", "Text", "TextXAlignment"}]
  LOADN R19 1
  ...
  GETTABLEKS R19 R1 K9 ["Items"]
  SETTABLEKS R19 R18 K9 ["Items"]
  LOADN R19 2
  SETTABLEKS R19 R18 K15 ["LayoutOrder"]
  ...
  SETTABLEKS R19 R18 K2 ["Size"]
  CALL R16 2 1
  SETTABLEKS R16 R15 K28 ["SelectInput"]
  CALL R12 3 -1
  RETURN R12 -1
