...
PROTO_1:
  ...
  JUMPIFNOT R1 [+4]
  GETUPVAL R14 10
  GETTABLEKS R13 R14 K43 ["BrowserSize"]
  JUMP [+3]
  GETUPVAL R14 10
  GETTABLEKS R13 R14 K44 ["BrowserHiddenSize"]
  SETTABLEKS R13 R12 K9 ["Size"]
  CALL R10 2 1
...
PROTO_3:
  ...
  GETUPVAL R4 2
  CALL R3 1 1
  GETTABLEKS R4 R3 K2 ["errorMessage"]
  GETUPVAL R5 3
  GETUPVAL R6 4
  CALL R5 1 2
  GETUPVAL R8 5
  ...
  DUPTABLE R13 K11 [{"HorizontalAlignment", "Layout", "Style", "VerticalAlignment"}]
  GETIMPORT R14 K14 [Enum.HorizontalAlignment.Left]
  SETTABLEKS R14 R13 K7 ["HorizontalAlignment"]
  JUMPIFNOT R6 [+3]
  GETTABLEKS R14 R6 K15 ["fillDirection"]
  JUMP [+1]
  LOADNIL R14
  SETTABLEKS R14 R13 K8 ["Layout"]
  LOADK R14 K16 ["Box"]
  SETTABLEKS R14 R13 K9 ["Style"]
  GETIMPORT R14 K18 [Enum.VerticalAlignment.Top]
  ...
  GETUPVAL R14 8
  MOVE R15 R12
  DUPTABLE R16 K22 [{"MainContent", "Editor"}]
  MOVE R17 R10
  CALL R17 0 1
  SETTABLEKS R17 R16 K20 ["MainContent"]
  JUMPIFNOT R2 [+17]
  JUMPIFNOT R6 [+16]
  GETUPVAL R18 0
  GETTABLEKS R17 R18 K19 ["createElement"]
  GETUPVAL R18 12
  DUPTABLE R19 K25 [{"LayoutOrder", "Size"}]
  NAMECALL R20 R7 K26 ["getNextOrder"]
  CALL R20 1 1
  SETTABLEKS R20 R19 K23 ["LayoutOrder"]
  GETTABLEKS R20 R6 K27 ["editorSize"]
  SETTABLEKS R20 R19 K24 ["Size"]
  CALL R17 2 1
  JUMP [+2]
  LOADNIL R17
  JUMP [0]
  SETTABLEKS R17 R16 K21 ["Editor"]
  CALL R13 3 -1
  RETURN R13 -1
...
MAIN:
  ...
  GETTABLEKS R15 R16 K24 ["useResponsiveLayout"]
  CALL R14 1 1
  GETIMPORT R15 K5 [require]
  GETTABLEKS R18 R0 K18 ["Src"]
  GETTABLEKS R17 R18 K25 ["Resources"]
  GETTABLEKS R16 R17 K26 ["AppLayout"]
  CALL R15 1 1
  ...
  GETTABLEKS R18 R19 K28 ["GenerationContext"]
  CALL R17 1 1
  GETIMPORT R18 K5 [require]
  GETTABLEKS R21 R0 K18 ["Src"]
  GETTABLEKS R20 R21 K16 ["Util"]
  GETTABLEKS R19 R20 K29 ["PreviewContext"]
  CALL R18 1 1
