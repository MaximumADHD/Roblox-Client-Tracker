...
MAIN:
  ...
  CAPTURE REF R8
  CAPTURE VAL R7
  SETTABLEKS R17 R16 K13 ["connectSelectionInstancesChanged"]
  DUPCLOSURE R17 K14 [PROTO_6]
  CAPTURE VAL R7
  SETTABLEKS R17 R16 K15 ["disconnectSelectionInstancesChanged"]
  DUPCLOSURE R17 K16 [PROTO_7]
  CAPTURE VAL R9
  SETTABLEKS R17 R16 K17 ["connectFilteredSelectionChanged"]
  DUPCLOSURE R17 K18 [PROTO_8]
  CAPTURE VAL R1
  CAPTURE VAL R9
  SETTABLEKS R17 R16 K19 ["disconnectFilteredSelectionChanged"]
  DUPCLOSURE R17 K20 [PROTO_9]
  CAPTURE VAL R9
  DUPCLOSURE R18 K21 [PROTO_10]
  DUPCLOSURE R19 K22 [PROTO_11]
  CAPTURE VAL R18
  DUPCLOSURE R20 K23 [PROTO_12]
  DUPCLOSURE R21 K24 [PROTO_13]
  CAPTURE VAL R19
  SETTABLEKS R21 R16 K25 ["passesGuiFilter"]
  DUPCLOSURE R21 K26 [PROTO_14]
  CAPTURE VAL R16
  SETTABLEKS R21 R16 K27 ["onDescendantAddedToStarterGui"]
  DUPCLOSURE R21 K28 [PROTO_15]
  CAPTURE VAL R16
  SETTABLEKS R21 R16 K29 ["onParentChanged"]
  NEWCLOSURE R21 P15
  CAPTURE REF R4
  CAPTURE VAL R6
  CAPTURE VAL R2
  ...
  CAPTURE REF R10
  CAPTURE VAL R9
  SETTABLEKS R21 R16 K30 ["onSelectionChanged"]
  NEWCLOSURE R21 P16
  CAPTURE REF R3
  SETTABLEKS R21 R16 K31 ["getRawSelection"]
  NEWCLOSURE R21 P17
  CAPTURE REF R4
  SETTABLEKS R21 R16 K32 ["getFilteredSelection"]
  NEWCLOSURE R21 P18
  CAPTURE REF R5
  SETTABLEKS R21 R16 K33 ["getFilteredSelectionCommonAncestors"]
  NEWCLOSURE R21 P19
  CAPTURE REF R3
  SETTABLEKS R21 R16 K34 ["hasSelection"]
  NEWCLOSURE R21 P20
  CAPTURE REF R4
  SETTABLEKS R21 R16 K35 ["hasFilteredSelection"]
  NEWCLOSURE R21 P21
  CAPTURE VAL R1
  CAPTURE REF R3
  CAPTURE REF R11
  CAPTURE VAL R2
  SETTABLEKS R21 R16 K36 ["setSelection"]
  NEWCLOSURE R21 P22
  CAPTURE REF R11
  SETTABLEKS R21 R16 K37 ["isSelectionBeingChangedByUIEditor"]
  NEWCLOSURE R21 P23
  CAPTURE REF R10
  CAPTURE VAL R9
  SETTABLEKS R21 R16 K38 ["setSuppressFilteredSelectionChanged"]
  CLOSEUPVALS R3
  RETURN R16 1
