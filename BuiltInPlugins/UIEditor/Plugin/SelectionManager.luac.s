...
PROTO_16:
  ...
  MOVE R9 R6
  MOVE R10 R1
  NAMECALL R7 R7 K10 ["findItemInTable"]
  CALL R7 3 1
  JUMPIFEQKN R7 K11 [0] [+3]
  LOADB R5 1
  JUMP [+6]
  GETUPVAL R7 7
  ...
  CALL R2 1 3
  FORGPREP_INEXT R2
  NAMECALL R7 R6 K14 ["onSelectionChanged"]
  CALL R7 1 0
...
MAIN:
  ...
  GETTABLEKS R4 R5 K12 ["GetFFlagUIEditorNoPartSelection"]
  CALL R3 1 1
  CALL R3 0 1
  NEWTABLE R4 0 0
  NEWTABLE R5 0 0
  ...
  CAPTURE REF R9
  CAPTURE VAL R8
  SETTABLEKS R18 R17 K15 ["connectSelectionInstancesChanged"]
  DUPCLOSURE R18 K16 [PROTO_6]
  CAPTURE VAL R8
  SETTABLEKS R18 R17 K17 ["disconnectSelectionInstancesChanged"]
  DUPCLOSURE R18 K18 [PROTO_7]
  CAPTURE VAL R10
  SETTABLEKS R18 R17 K19 ["connectFilteredSelectionChanged"]
  DUPCLOSURE R18 K20 [PROTO_8]
  CAPTURE VAL R1
  CAPTURE VAL R10
  SETTABLEKS R18 R17 K21 ["disconnectFilteredSelectionChanged"]
  DUPCLOSURE R18 K22 [PROTO_9]
  CAPTURE VAL R10
  DUPCLOSURE R19 K23 [PROTO_10]
  DUPCLOSURE R20 K24 [PROTO_11]
  CAPTURE VAL R19
  DUPCLOSURE R21 K25 [PROTO_12]
  DUPCLOSURE R22 K26 [PROTO_13]
  CAPTURE VAL R20
  SETTABLEKS R22 R17 K27 ["passesGuiFilter"]
  DUPCLOSURE R22 K28 [PROTO_14]
  CAPTURE VAL R17
  SETTABLEKS R22 R17 K29 ["onDescendantAddedToStarterGui"]
  DUPCLOSURE R22 K30 [PROTO_15]
  CAPTURE VAL R17
  SETTABLEKS R22 R17 K31 ["onParentChanged"]
  NEWCLOSURE R22 P15
  CAPTURE REF R5
  CAPTURE VAL R7
  CAPTURE VAL R2
  ...
  CAPTURE REF R11
  CAPTURE VAL R10
  SETTABLEKS R22 R17 K32 ["onSelectionChanged"]
  NEWCLOSURE R22 P16
  CAPTURE REF R4
  SETTABLEKS R22 R17 K33 ["getRawSelection"]
  NEWCLOSURE R22 P17
  CAPTURE REF R5
  SETTABLEKS R22 R17 K34 ["getFilteredSelection"]
  NEWCLOSURE R22 P18
  CAPTURE REF R6
  SETTABLEKS R22 R17 K35 ["getFilteredSelectionCommonAncestors"]
  NEWCLOSURE R22 P19
  CAPTURE REF R4
  SETTABLEKS R22 R17 K36 ["hasSelection"]
  NEWCLOSURE R22 P20
  CAPTURE REF R5
  SETTABLEKS R22 R17 K37 ["hasFilteredSelection"]
  NEWCLOSURE R22 P21
  CAPTURE VAL R1
  CAPTURE REF R4
  CAPTURE VAL R3
  CAPTURE REF R12
  CAPTURE VAL R2
  SETTABLEKS R22 R17 K38 ["setSelection"]
  NEWCLOSURE R22 P22
  CAPTURE REF R12
  SETTABLEKS R22 R17 K39 ["isSelectionBeingChangedByUIEditor"]
  NEWCLOSURE R22 P23
  CAPTURE REF R11
  CAPTURE VAL R10
  SETTABLEKS R22 R17 K40 ["setSuppressFilteredSelectionChanged"]
  CLOSEUPVALS R4
  RETURN R17 1
