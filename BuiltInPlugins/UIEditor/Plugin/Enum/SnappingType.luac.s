PROTO_0:
        ...
        3 RETURN                           R3 1
        4 GETUPVAL                         R3 0
        5 GETTABLEKS                       R3 R3 K0 ["MoveXY"]
        7 JUMPIFNOTEQ                      R1 R3 ; [+15]
        9 LOADB                            R3 1
       10 GETUPVAL                         R4 0
       11 GETTABLEKS                       R4 R4 K1 ["MoveX"]
       13 JUMPIFEQ                         R2 R4 ; [+8]
       15 GETUPVAL                         R4 0
       16 GETTABLEKS                       R4 R4 K2 ["MoveY"]
       18 JUMPIFEQ                         R2 R4 ; [+2]
       20 LOADB                            R3 0 +1
       21 LOADB                            R3 1
       22 RETURN                           R3 1
       23 GETUPVAL                         R3 0
       24 GETTABLEKS                       R3 R3 K3 ["ResizeXpYp"]
       26 JUMPIFNOTEQ                      R1 R3 ; [+15]
       28 LOADB                            R3 1
       29 GETUPVAL                         R4 0
       30 GETTABLEKS                       R4 R4 K4 ["ResizeXp"]
       32 JUMPIFEQ                         R2 R4 ; [+8]
       34 GETUPVAL                         R4 0
       35 GETTABLEKS                       R4 R4 K5 ["ResizeYp"]
       37 JUMPIFEQ                         R2 R4 ; [+2]
       39 LOADB                            R3 0 +1
       40 LOADB                            R3 1
       41 RETURN                           R3 1
       42 GETUPVAL                         R3 0
       43 GETTABLEKS                       R3 R3 K6 ["ResizeXnYp"]
       45 JUMPIFNOTEQ                      R1 R3 ; [+15]
       47 LOADB                            R3 1
       48 GETUPVAL                         R4 0
       49 GETTABLEKS                       R4 R4 K7 ["ResizeXn"]
       51 JUMPIFEQ                         R2 R4 ; [+8]
       53 GETUPVAL                         R4 0
       54 GETTABLEKS                       R4 R4 K5 ["ResizeYp"]
       56 JUMPIFEQ                         R2 R4 ; [+2]
       58 LOADB                            R3 0 +1
       59 LOADB                            R3 1
       60 RETURN                           R3 1
       61 GETUPVAL                         R3 0
       62 GETTABLEKS                       R3 R3 K8 ["ResizeXpYn"]
       64 JUMPIFNOTEQ                      R1 R3 ; [+15]
       66 LOADB                            R3 1
       67 GETUPVAL                         R4 0
       68 GETTABLEKS                       R4 R4 K4 ["ResizeXp"]
       70 JUMPIFEQ                         R2 R4 ; [+8]
       72 GETUPVAL                         R4 0
       73 GETTABLEKS                       R4 R4 K9 ["ResizeYn"]
       75 JUMPIFEQ                         R2 R4 ; [+2]
       77 LOADB                            R3 0 +1
       78 LOADB                            R3 1
       79 RETURN                           R3 1
       80 GETUPVAL                         R3 0
       81 GETTABLEKS                       R3 R3 K10 ["ResizeXnYn"]
       83 JUMPIFNOTEQ                      R1 R3 ; [+15]
       85 LOADB                            R3 1
       86 GETUPVAL                         R4 0
       87 GETTABLEKS                       R4 R4 K7 ["ResizeXn"]
       89 JUMPIFEQ                         R2 R4 ; [+8]
       91 GETUPVAL                         R4 0
       92 GETTABLEKS                       R4 R4 K9 ["ResizeYn"]
       94 JUMPIFEQ                         R2 R4 ; [+2]
       96 LOADB                            R3 0 +1
       97 LOADB                            R3 1
       98 RETURN                           R3 1
