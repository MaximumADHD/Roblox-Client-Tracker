...
PROTO_1:
  ...
  LOADK R15 K8 ["Position"]
  NAMECALL R13 R4 K9 ["GetStyled"]
  CALL R13 2 1
  MOVE R14 R5
  LOADK R17 K10 ["AnchorPoint"]
  NAMECALL R15 R4 K9 ["GetStyled"]
  CALL R15 2 -1
  NAMECALL R8 R8 K11 ["convertAbsolutePositionToScaleOrOffset"]
  CALL R8 -1 1
...
PROTO_6:
  ...
  FORNPREP R4
  MOVE R8 R2
  GETGLOBAL R9 K5 ["getHighestZIndexOfSelfAndDescendants"]
  GETTABLE R10 R3 R6
  MOVE R11 R1
  CALL R9 2 -1
  FASTCALL MATH_MAX [+2]
...
PROTO_9:
  ...
  GETTABLE R11 R2 R5
  LOADK R13 K2 ["Position"]
  NAMECALL R11 R11 K3 ["GetStyled"]
  CALL R11 2 -1
  SETLIST R8 R9 -1 [1]
  ...
  GETUPVAL R3 6
  MOVE R5 R2
  NAMECALL R3 R3 K8 ["getExtentsFromGuis"]
  CALL R3 2 1
  SETUPVAL R3 5
  GETUPVAL R3 7
  NAMECALL R3 R3 K9 ["setToMoveIcon"]
  CALL R3 1 0
  GETUPVAL R3 8
  NAMECALL R3 R3 K10 ["createSelectionAdorns"]
  CALL R3 1 0
  GETUPVAL R3 9
  MOVE R5 R1
  NAMECALL R3 R3 K11 ["onMoveBegan"]
  CALL R3 2 0
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R3 R4 K7 ["Extents2D"]
  CALL R2 1 1
  GETIMPORT R3 K1 [require]
  GETIMPORT R6 K3 [script]
  GETTABLEKS R5 R6 K4 ["Parent"]
  GETTABLEKS R4 R5 K8 ["GlobalValues"]
  CALL R3 1 1
  GETIMPORT R4 K1 [require]
  GETIMPORT R7 K3 [script]
  GETTABLEKS R6 R7 K4 ["Parent"]
  GETTABLEKS R5 R6 K9 ["MouseIconManager"]
  CALL R4 1 1
  ...
  GETTABLEKS R7 R8 K11 ["SnappingPointManager"]
  CALL R6 1 1
  ...
  GETTABLEKS R9 R10 K13 ["Convert"]
  CALL R8 1 1
  GETIMPORT R9 K1 [require]
  GETIMPORT R13 K3 [script]
  GETTABLEKS R12 R13 K4 ["Parent"]
  GETTABLEKS R11 R12 K14 ["Enum"]
  GETTABLEKS R10 R11 K15 ["SnappingType"]
  CALL R9 1 1
  ...
  LOADK R13 K20 ["ChangeHistoryService"]
  ...
  CAPTURE VAL R19
  CAPTURE REF R13
  DUPCLOSURE R21 K22 [PROTO_3]
  DUPCLOSURE R22 K23 [PROTO_4]
  CAPTURE VAL R22
  DUPCLOSURE R23 K24 [PROTO_5]
  DUPCLOSURE R24 K25 [PROTO_6]
  SETGLOBAL R24 K26 ["getHighestZIndexOfSelfAndDescendants"]
  DUPCLOSURE R24 K27 [PROTO_7]
  SETGLOBAL R24 K28 ["incrementZIndexOfSelfAndDescendantsBy"]
  NEWTABLE R24 16 0
  NEWCLOSURE R25 P8
  CAPTURE REF R14
  SETTABLEKS R25 R24 K29 ["isDragInProgress"]
  NEWCLOSURE R25 P9
  CAPTURE REF R16
  CAPTURE VAL R5
  CAPTURE REF R13
  ...
  CAPTURE VAL R0
  CAPTURE REF R12
  SETTABLEKS R25 R24 K30 ["startDrag"]
  NEWCLOSURE R25 P10
  CAPTURE REF R15
  CAPTURE VAL R1
  CAPTURE VAL R11
  ...
  CAPTURE VAL R4
  CAPTURE REF R12
  SETTABLEKS R25 R24 K31 ["finishDrag"]
  NEWCLOSURE R25 P11
  CAPTURE REF R15
  CAPTURE VAL R7
  CAPTURE REF R13
  ...
  CAPTURE VAL R19
  CAPTURE REF R12
  SETTABLEKS R25 R24 K32 ["updateDrag"]
  DUPCLOSURE R25 K33 [PROTO_12]
  CAPTURE VAL R5
  CAPTURE VAL R0
  CAPTURE VAL R4
  SETTABLEKS R25 R24 K34 ["onSelectionChanged"]
  DUPCLOSURE R25 K35 [PROTO_13]
  CAPTURE VAL R24
  CAPTURE VAL R19
  CAPTURE VAL R21
  SETTABLEKS R25 R24 K36 ["bump"]
  NEWCLOSURE R25 P14
  CAPTURE REF R12
  SETTABLEKS R25 R24 K37 ["setActionMediator"]
  LOADN R25 1
  SETTABLEKS R25 R24 K38 ["UP"]
  LOADN R25 2
  SETTABLEKS R25 R24 K39 ["DOWN"]
  LOADN R25 3
  SETTABLEKS R25 R24 K40 ["LEFT"]
  LOADN R25 4
  SETTABLEKS R25 R24 K41 ["RIGHT"]
  CLOSEUPVALS R12
  RETURN R24 1
