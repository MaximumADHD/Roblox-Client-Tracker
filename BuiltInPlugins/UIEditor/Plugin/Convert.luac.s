...
PROTO_1:
  ...
  GETUPVAL R21 2
  JUMPIFNOT R21 [+15]
  LOADK R23 K18 ["ScrollingFrame"]
  NAMECALL R21 R5 K19 ["IsA"]
  CALL R21 2 1
  JUMPIFNOT R21 [+5]
  GETTABLEKS R22 R5 K20 ["AbsoluteCanvasSize"]
  SUB R21 R22 R9
  SUB R20 R21 R10
  JUMP [+9]
  ...
  LOADN R21 1
  LOADN R22 1
  GETTABLEKS R23 R20 K21 ["X"]
  JUMPIFEQKN R23 K22 [0] [+3]
  GETTABLEKS R21 R20 K21 ["X"]
  GETTABLEKS R23 R20 K23 ["Y"]
  JUMPIFEQKN R23 K22 [0] [+3]
  GETTABLEKS R22 R20 K23 ["Y"]
  GETIMPORT R23 K24 [Vector2.new]
  MOVE R24 R21
  MOVE R25 R22
  CALL R23 2 1
  MOVE R20 R23
  JUMPIFNOT R1 [+31]
  GETIMPORT R23 K24 [Vector2.new]
  GETTABLEKS R25 R4 K21 ["X"]
  GETTABLEKS R24 R25 K25 ["Offset"]
  GETTABLEKS R26 R4 K23 ["Y"]
  GETTABLEKS R25 R26 K25 ["Offset"]
  CALL R23 2 1
  SUB R26 R19 R9
  SUB R25 R26 R23
  DIV R24 R25 R20
  GETIMPORT R25 K7 [UDim2.new]
  GETTABLEKS R26 R24 K21 ["X"]
  GETTABLEKS R28 R4 K21 ["X"]
  GETTABLEKS R27 R28 K25 ["Offset"]
  GETTABLEKS R28 R24 K23 ["Y"]
  GETTABLEKS R30 R4 K23 ["Y"]
  GETTABLEKS R29 R30 K25 ["Offset"]
  CALL R25 4 1
  MOVE R7 R25
  RETURN R7 1
  GETIMPORT R24 K24 [Vector2.new]
  GETTABLEKS R26 R4 K21 ["X"]
  GETTABLEKS R25 R26 K26 ["Scale"]
  GETTABLEKS R27 R4 K23 ["Y"]
  GETTABLEKS R26 R27 K26 ["Scale"]
  CALL R24 2 1
  ...
  SUB R24 R25 R23
  GETIMPORT R25 K7 [UDim2.new]
  GETTABLEKS R27 R4 K21 ["X"]
  GETTABLEKS R26 R27 K26 ["Scale"]
  GETTABLEKS R27 R24 K21 ["X"]
  GETTABLEKS R29 R4 K23 ["Y"]
  GETTABLEKS R28 R29 K26 ["Scale"]
  GETTABLEKS R29 R24 K23 ["Y"]
  CALL R25 4 1
  MOVE R7 R25
  RETURN R7 1
...
MAIN:
  ...
  LOADK R4 K10 ["UIEditorFixScrollingFrame"]
  LOADB R5 0
  ...
  CAPTURE VAL R1
  CAPTURE VAL R0
  SETTABLEKS R4 R3 K13 ["convertAbsoluteSizeToScaleOrOffset"]
  DUPCLOSURE R4 K14 [PROTO_1]
  CAPTURE VAL R1
  CAPTURE VAL R0
  CAPTURE VAL R2
  SETTABLEKS R4 R3 K15 ["convertAbsolutePositionToScaleOrOffset"]
  DUPCLOSURE R4 K16 [PROTO_2]
  SETTABLEKS R4 R3 K17 ["convertAbsoluteToScaleOrOffset"]
  RETURN R3 1
