...
PROTO_3:
        ...
        7 RETURN                           R0 0
        8 GETUPVAL                         R3 0
        9 GETTABLEKS                       R2 R3 K2 ["maskBackgroundParent"]
       11 GETTABLEKS                       R1 R2 K3 ["BackgroundColor3"]
...
PROTO_4:
       ...
       52 RETURN                           R0 0
       53 GETUPVAL                         R4 0
       54 GETTABLEKS                       R3 R4 K4 ["maskBackgroundParent"]
       56 GETTABLEKS                       R2 R3 K7 ["BackgroundColor3"]
...
PROTO_7:
       ...
       13 DUPTABLE                         R6 K9 [{"Size", "BackgroundColor3", "BackgroundTransparency", "BorderSizePixel", "Image"}]
       14 GETIMPORT                        R7 K12 [UDim2.fromScale]
       16 LOADN                            R8 1
       17 LOADN                            R9 1
       18 CALL                             R7 2 1
       19 SETTABLEKS                       R7 R6 K4 ["Size"]
       21 GETTABLEKS                       R8 R3 K13 ["subjectThumbnail"]
       23 GETTABLEKS                       R7 R8 K14 ["background"]
       25 SETTABLEKS                       R7 R6 K5 ["BackgroundColor3"]
       27 LOADN                            R7 0
       28 SETTABLEKS                       R7 R6 K6 ["BackgroundTransparency"]
       30 LOADN                            R7 0
       31 SETTABLEKS                       R7 R6 K7 ["BorderSizePixel"]
       33 SETTABLEKS                       R2 R6 K8 ["Image"]
       35 DUPTABLE                         R7 K16 [{"Mask"}]
       36 GETUPVAL                         R9 2
       37 GETTABLEKS                       R8 R9 K2 ["createElement"]
       39 LOADK                            R9 K3 ["ImageLabel"]
       40 NEWTABLE                         R10 4 0
       42 GETUPVAL                         R12 2
       43 GETTABLEKS                       R11 R12 K17 ["Ref"]
       45 GETUPVAL                         R13 0
       46 GETTABLEKS                       R12 R13 K18 ["maskRef"]
       48 SETTABLE                         R12 R10 R11
       49 GETIMPORT                        R11 K12 [UDim2.fromScale]
       51 LOADN                            R12 1
       52 LOADN                            R13 1
       53 CALL                             R11 2 1
       54 SETTABLEKS                       R11 R10 K4 ["Size"]
       56 LOADN                            R11 1
       57 SETTABLEKS                       R11 R10 K6 ["BackgroundTransparency"]
       59 GETTABLEKS                       R12 R3 K13 ["subjectThumbnail"]
       61 GETTABLEKS                       R11 R12 K19 ["maskImage"]
       63 SETTABLEKS                       R11 R10 K8 ["Image"]
       65 CALL                             R8 2 1
       66 SETTABLEKS                       R8 R7 K15 ["Mask"]
       68 CALL                             R4 3 -1
       69 RETURN                           R4 -1
