PROTO_0:
        ...
        3 JUMPIFNOT                        R0 ; [+7]
        4 GETUPVAL                         R0 1
        5 GETTABLEKS                       R0 R0 K1 ["ButtonClicked"]
        7 GETUPVAL                         R1 0
...
PROTO_1:
        ...
        6 GETUPVAL                         R5 0
        7 GETTABLEKS                       R5 R5 K3 ["Children"]
        9 GETTABLE                         R4 R1 R5
       ...
       64 MOVE                             R12 R5
       65 GETUPVAL                         R13 0
       66 GETTABLEKS                       R13 R13 K6 ["createElement"]
       68 GETUPVAL                         R14 1
       ...
       82 LOADN                            R17 0
       83 GETUPVAL                         R18 2
       84 GETTABLEKS                       R18 R18 K41 ["BUTTON_WIDTH"]
       86 LOADN                            R19 1
       87 LOADN                            R20 0
       88 CALL                             R16 4 1
       ...
       95 JUMP                             ; [+3]
       96 GETUPVAL                         R16 3
       97 GETTABLEKS                       R16 R16 K43 ["Disabled"]
      ...
      117 GETUPVAL                         R6 0
      118 GETTABLEKS                       R6 R6 K6 ["createElement"]
      120 LOADK                            R7 K45 ["Frame"]
      121 DUPTABLE                         R8 K50 [{["LayoutOrder"], ["Size"], ["AnchorPoint"], ["Position"], ["BackgroundTransparency"] = 1}]
      122 GETTABLEKS                       R10 R1 K16 ["LayoutOrder"]
      124 ORK                              R9 R10 K49 [1]
      ...
      131 LOADN                            R12 0
      132 GETUPVAL                         R13 2
      133 GETTABLEKS                       R13 R13 K51 ["BUTTON_HEIGHT"]
      135 CALL                             R9 4 1
...
MAIN:
       ...
       39 GETTABLEKS                       R10 R10 K8 ["Util"]
       41 GETTABLEKS                       R10 R10 K15 ["DEPRECATED_Constants"]
       43 CALL                             R9 1 1
