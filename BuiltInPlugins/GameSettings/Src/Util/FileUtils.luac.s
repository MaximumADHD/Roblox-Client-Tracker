...
PROTO_6:
  ...
  LOADK R7 K13 ["--EA0A21C3-8388-4038-9BD5-92C8B1B7BF8E
...
"]
  ...
  MOVE R10 R2
  CALL R6 4 1
  DUPTABLE R7 K19 [{"Url", "Method", "Body", "CachePolicy", "Headers"}]
  SETTABLEKS R1 R7 K14 ["Url"]
  LOADK R8 K20 ["POST"]
  SETTABLEKS R8 R7 K15 ["Method"]
  SETTABLEKS R6 R7 K16 ["Body"]
  GETIMPORT R8 K24 [Enum.HttpCachePolicy.None]
  SETTABLEKS R8 R7 K17 ["CachePolicy"]
  NEWTABLE R8 1 0
  LOADK R9 K25 ["multipart/form-data; boundary=EA0A21C3-8388-4038-9BD5-92C8B1B7BF8E"]
  SETTABLEKS R9 R8 K26 ["Content-Type"]
  SETTABLEKS R8 R7 K18 ["Headers"]
  RETURN R7 1
...
MAIN:
  ...
  GETTABLEKS R6 R7 K18 ["Dialog"]
  GETTABLEKS R5 R6 K19 ["SimpleDialog"]
  CALL R4 1 1
  GETIMPORT R5 K15 [require]
  GETTABLEKS R9 R3 K16 ["Src"]
  GETTABLEKS R8 R9 K17 ["Components"]
  GETTABLEKS R7 R8 K18 ["Dialog"]
  GETTABLEKS R6 R7 K20 ["ListDialog"]
  CALL R5 1 1
  GETIMPORT R6 K15 [require]
  GETTABLEKS R9 R3 K16 ["Src"]
  GETTABLEKS R8 R9 K21 ["Util"]
  GETTABLEKS R7 R8 K22 ["DEPRECATED_Constants"]
  CALL R6 1 1
  NEWTABLE R7 4 0
  ...
  CAPTURE VAL R0
  CAPTURE VAL R8
  SETTABLEKS R12 R7 K28 ["PromptForGameIcon"]
  DUPCLOSURE R12 K29 [PROTO_5]
  CAPTURE VAL R1
  CAPTURE VAL R6
  CAPTURE VAL R0
  CAPTURE VAL R9
  SETTABLEKS R12 R7 K30 ["PromptForThumbnails"]
  DUPCLOSURE R12 K31 [PROTO_6]
  SETTABLEKS R12 R7 K32 ["GetAssetPublishRequestInfo"]
  DUPCLOSURE R12 K33 [PROTO_7]
  CAPTURE VAL R2
  SETTABLEKS R12 R7 K34 ["CreatePostV1AssetsUpload"]
  RETURN R7 1
