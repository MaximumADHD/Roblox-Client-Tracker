return function()
	...
	it(
		"should remove all empty tables and keys that are tables that are marked as Cryo.None when that key exists",
		function()
			local table1 = { key1 = { key2 = "test" } }
	...
	it(
		"should not remove tables marked as NONE in the original table even when there is a key in the merging table",
		function()
			local table1 = { key1 = { key2 = Cryo.None } }
