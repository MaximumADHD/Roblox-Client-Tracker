...
PROTO_6:
  ...
  JUMPIFNOT R6 [+6]
  LOADK R7 K9 ["General"]
  LOADK R8 K27 ["ErrorsOnSaveBodyExp"]
  NAMECALL R5 R2 K11 ["getText"]
  CALL R5 3 1
  JUMP [+5]
  LOADK R7 K9 ["General"]
  LOADK R8 K28 ["ErrorsOnSaveBody"]
  NAMECALL R5 R2 K11 ["getText"]
  CALL R5 3 1
  SETTABLEKS R5 R4 K5 ["Header"]
  NEWTABLE R5 0 1
  LOADK R8 K9 ["General"]
  LOADK R9 K29 ["ReplyOK"]
  NAMECALL R6 R2 K11 ["getText"]
  CALL R6 3 -1
  SETLIST R5 R6 -1 [1]
  SETTABLEKS R5 R4 K7 ["Buttons"]
...
MAIN:
  ...
  GETTABLEKS R3 R4 K5 ["Flags"]
  GETTABLEKS R2 R3 K6 ["getFFlagGameSettingsGameToExperience"]
  CALL R1 1 1
  GETIMPORT R2 K4 [require]
  GETTABLEKS R5 R0 K7 ["Src"]
  GETTABLEKS R4 R5 K8 ["Thunks"]
  GETTABLEKS R3 R4 K9 ["SaveChanges"]
  CALL R2 1 1
  GETIMPORT R3 K4 [require]
  GETTABLEKS R7 R0 K7 ["Src"]
  GETTABLEKS R6 R7 K10 ["Components"]
  GETTABLEKS R5 R6 K11 ["Dialog"]
  GETTABLEKS R4 R5 K12 ["WarningDialog"]
  CALL R3 1 1
  GETIMPORT R4 K4 [require]
  GETTABLEKS R8 R0 K7 ["Src"]
  GETTABLEKS R7 R8 K10 ["Components"]
  GETTABLEKS R6 R7 K11 ["Dialog"]
  GETTABLEKS R5 R6 K13 ["SimpleDialog"]
  CALL R4 1 1
