PROTO_0:
  ...
  GETIMPORT R3 K1 [type]
  CALL R3 1 1
  JUMPIFEQKS R3 K3 ["nil"] [+2]
  LOADB R2 0 +1
  LOADB R2 1
  GETIMPORT R3 K6 [string.format]
  LOADK R4 K7 ["SetEditDevProductId requires a number or nil, not %s"]
  FASTCALL1 TYPE R0 [+3]
  MOVE R6 R0
  ...
  CALL R1 -1 0
  DUPTABLE R1 K11 [{"editDevProductId"}]
  SETTABLEKS R0 R1 K10 ["editDevProductId"]
  RETURN R1 1
