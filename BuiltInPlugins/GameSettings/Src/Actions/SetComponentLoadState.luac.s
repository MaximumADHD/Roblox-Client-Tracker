PROTO_0:
  ...
  LOADK R7 K8 [" requires componentName to be a string, not %s"]
  CONCAT R5 R6 R7
  FASTCALL1 TYPEOF R0 [+3]
  MOVE R7 R0
  ...
  GETIMPORT R2 K10 [assert]
  CALL R2 -1 0
  DUPTABLE R2 K15 [{"componentName", "loadState"}]
  SETTABLEKS R0 R2 K13 ["componentName"]
  SETTABLEKS R1 R2 K14 ["loadState"]
  RETURN R2 1
