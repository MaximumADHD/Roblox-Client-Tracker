...
PROTO_6:
  ...
  LOADB R3 1
  FASTCALL2K ASSERT R3 K5 [+4]
  LOADK R4 K5 ["Setting group owner name in non-group owned game"]
  GETIMPORT R2 K7 [assert]
  CALL R2 2 0
  GETUPVAL R4 0
  GETTABLEKS R3 R4 K8 ["Dictionary"]
  GETTABLEKS R2 R3 K9 ["join"]
  MOVE R3 R0
  DUPTABLE R4 K11 [{"groupOwnerName"}]
  GETTABLEKS R5 R1 K10 ["groupOwnerName"]
  SETTABLEKS R5 R4 K10 ["groupOwnerName"]
  CALL R2 2 -1
  RETURN R2 -1
...
MAIN:
  ...
  DUPTABLE R5 K23 [{"ResetStore", "SetCreatorType", "SetCreatorId", "SetCreatorName", "SetCreatorFriends", "SetGroupOwnerId", "SetGroupOwnerName"}]
  ...
  CAPTURE VAL R1
  SETTABLEKS R6 R5 K22 ["SetGroupOwnerName"]
  CALL R3 2 -1
  RETURN R3 -1
