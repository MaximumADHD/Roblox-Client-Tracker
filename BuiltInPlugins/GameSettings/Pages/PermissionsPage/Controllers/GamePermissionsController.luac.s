...
MAIN:
  ...
  SETTABLEKS R7 R6 K15 ["universesV1GET"]
  DUPCLOSURE R7 K16 [PROTO_2]
  SETTABLEKS R7 R6 K17 ["universesActivateV1POST"]
  DUPCLOSURE R7 K18 [PROTO_3]
  SETTABLEKS R7 R6 K19 ["universesDeactivateV1POST"]
  DUPCLOSURE R7 K20 [PROTO_4]
  SETTABLEKS R7 R6 K21 ["configurationV2GET"]
  DUPCLOSURE R7 K22 [PROTO_5]
  SETTABLEKS R7 R6 K23 ["configurationV2PATCH"]
  DUPCLOSURE R7 K24 [PROTO_6]
  SETTABLEKS R7 R6 K25 ["permissionsV2GET"]
  DUPCLOSURE R7 K26 [PROTO_7]
  SETTABLEKS R7 R6 K27 ["permissionsBatchedV2POST"]
  DUPCLOSURE R7 K28 [PROTO_8]
  SETTABLEKS R7 R6 K29 ["permissionsBatchedV2DELETE"]
  DUPCLOSURE R7 K30 [PROTO_9]
  SETTABLEKS R7 R6 K31 ["isFriendsOnly"]
  DUPCLOSURE R7 K32 [PROTO_10]
  SETTABLEKS R7 R6 K33 ["setFriendsOnly"]
  DUPCLOSURE R7 K34 [PROTO_11]
  SETTABLEKS R7 R6 K35 ["isActive"]
  DUPCLOSURE R7 K36 [PROTO_12]
  SETTABLEKS R7 R6 K37 ["setActive"]
  DUPCLOSURE R7 K38 [PROTO_13]
  CAPTURE VAL R3
  SETTABLEKS R7 R6 K39 ["getPermissions"]
  DUPCLOSURE R7 K40 [PROTO_14]
  CAPTURE VAL R4
  SETTABLEKS R7 R6 K41 ["setPermissions"]
  RETURN R6 1
