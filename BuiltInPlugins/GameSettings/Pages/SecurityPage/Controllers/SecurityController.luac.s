...
MAIN:
  ...
  CAPTURE VAL R2
  SETTABLEKS R4 R2 K14 ["new"]
  DUPCLOSURE R4 K15 [PROTO_1]
  SETTABLEKS R4 R2 K16 ["configurationV2GET"]
  DUPCLOSURE R4 K17 [PROTO_2]
  SETTABLEKS R4 R2 K18 ["configurationV2PATCH"]
  DUPCLOSURE R4 K19 [PROTO_3]
  SETTABLEKS R4 R2 K20 ["GetPermission"]
  DUPCLOSURE R4 K21 [PROTO_4]
  SETTABLEKS R4 R2 K22 ["SetChangedPermissions"]
  DUPCLOSURE R4 K23 [PROTO_5]
  SETTABLEKS R4 R2 K24 ["GetThirdPartyPurchasesAllowed"]
  DUPCLOSURE R4 K25 [PROTO_6]
  SETTABLEKS R4 R2 K26 ["SetThirdPartyPurchasesAllowed"]
  DUPCLOSURE R4 K27 [PROTO_7]
  SETTABLEKS R4 R2 K28 ["GetThirdPartyTeleportsAllowed"]
  DUPCLOSURE R4 K29 [PROTO_8]
  SETTABLEKS R4 R2 K30 ["SetThirdPartyTeleportsAllowed"]
  DUPCLOSURE R4 K31 [PROTO_9]
  SETTABLEKS R4 R2 K32 ["GetHttpEnabled"]
  DUPCLOSURE R4 K33 [PROTO_10]
  SETTABLEKS R4 R2 K34 ["SetHttpEnabled"]
  DUPCLOSURE R4 K35 [PROTO_11]
  SETTABLEKS R4 R2 K36 ["GetStudioAccessToApisAllowed"]
  DUPCLOSURE R4 K37 [PROTO_12]
  SETTABLEKS R4 R2 K38 ["SetStudioAccessToApisAllowed"]
  DUPCLOSURE R4 K39 [PROTO_13]
  SETTABLEKS R4 R2 K40 ["GetSecrets"]
  DUPCLOSURE R4 K41 [PROTO_14]
  SETTABLEKS R4 R2 K42 ["SetSecrets"]
  DUPCLOSURE R4 K43 [PROTO_16]
  CAPTURE VAL R1
  SETTABLEKS R4 R2 K44 ["GetSecretsAsTableRows"]
  DUPCLOSURE R4 K45 [PROTO_17]
  CAPTURE VAL R2
  SETTABLEKS R4 R2 K46 ["SetSecretsFromSecretsAsTableRows"]
  JUMPIFNOT R3 [+44]
  ...
  GETTABLEKS R7 R8 K47 ["Networking"]
  GETTABLEKS R6 R7 K48 ["Http"]
  CALL R5 1 1
  GETIMPORT R6 K10 [game]
  LOADK R8 K49 ["HttpService"]
  NAMECALL R6 R6 K50 ["GetService"]
  CALL R6 2 1
  DUPCLOSURE R7 K51 [PROTO_19]
  CAPTURE VAL R5
  CAPTURE VAL R6
  DUPCLOSURE R8 K52 [PROTO_20]
  CAPTURE VAL R5
  CAPTURE VAL R7
  DUPCLOSURE R9 K53 [PROTO_23]
  CAPTURE VAL R5
  CAPTURE VAL R7
