...
MAIN:
  ...
  GETTABLEKS R6 R7 K15 ["getFFlagSecretsHandleConversionErrors"]
  CALL R5 1 1
  CALL R5 0 1
  DUPCLOSURE R6 K16 [PROTO_0]
  CAPTURE VAL R2
  SETTABLEKS R6 R2 K17 ["new"]
  DUPCLOSURE R6 K18 [PROTO_1]
  SETTABLEKS R6 R2 K19 ["configurationV2GET"]
  DUPCLOSURE R6 K20 [PROTO_2]
  SETTABLEKS R6 R2 K21 ["configurationV2PATCH"]
  DUPCLOSURE R6 K22 [PROTO_3]
  SETTABLEKS R6 R2 K23 ["GetPermission"]
  DUPCLOSURE R6 K24 [PROTO_4]
  SETTABLEKS R6 R2 K25 ["SetChangedPermissions"]
  DUPCLOSURE R6 K26 [PROTO_5]
  SETTABLEKS R6 R2 K27 ["GetThirdPartyPurchasesAllowed"]
  DUPCLOSURE R6 K28 [PROTO_6]
  SETTABLEKS R6 R2 K29 ["SetThirdPartyPurchasesAllowed"]
  DUPCLOSURE R6 K30 [PROTO_7]
  SETTABLEKS R6 R2 K31 ["GetThirdPartyTeleportsAllowed"]
  DUPCLOSURE R6 K32 [PROTO_8]
  SETTABLEKS R6 R2 K33 ["SetThirdPartyTeleportsAllowed"]
  DUPCLOSURE R6 K34 [PROTO_9]
  SETTABLEKS R6 R2 K35 ["GetHttpEnabled"]
  DUPCLOSURE R6 K36 [PROTO_10]
  SETTABLEKS R6 R2 K37 ["SetHttpEnabled"]
  DUPCLOSURE R6 K38 [PROTO_11]
  SETTABLEKS R6 R2 K39 ["GetStudioAccessToApisAllowed"]
  DUPCLOSURE R6 K40 [PROTO_12]
  SETTABLEKS R6 R2 K41 ["SetStudioAccessToApisAllowed"]
  DUPCLOSURE R6 K42 [PROTO_13]
  SETTABLEKS R6 R2 K43 ["GetSecrets"]
  DUPCLOSURE R6 K44 [PROTO_14]
  SETTABLEKS R6 R2 K45 ["SetSecrets"]
  DUPCLOSURE R6 K46 [PROTO_17]
  CAPTURE VAL R5
  CAPTURE VAL R1
  SETTABLEKS R6 R2 K47 ["GetSecretsAsTableRows"]
  DUPCLOSURE R6 K48 [PROTO_18]
  CAPTURE VAL R2
  SETTABLEKS R6 R2 K49 ["SetSecretsFromSecretsAsTableRows"]
  JUMPIFNOT R3 [+44]
  ...
  GETTABLEKS R10 R6 K5 ["Src"]
  GETTABLEKS R9 R10 K50 ["Networking"]
  GETTABLEKS R8 R9 K51 ["Http"]
  CALL R7 1 1
  GETIMPORT R8 K10 [game]
  LOADK R10 K52 ["HttpService"]
  NAMECALL R8 R8 K53 ["GetService"]
  CALL R8 2 1
  DUPCLOSURE R9 K54 [PROTO_20]
  CAPTURE VAL R7
  CAPTURE VAL R8
  DUPCLOSURE R10 K55 [PROTO_21]
  CAPTURE VAL R7
  CAPTURE VAL R9
  ...
  CAPTURE VAL R11
  SETTABLEKS R12 R2 K58 ["GetMeshTextureApiAmpStatus"]
  DUPCLOSURE R12 K59 [PROTO_26]
  SETTABLEKS R12 R2 K60 ["GetMeshTextureApisAllowed"]
  DUPCLOSURE R12 K61 [PROTO_27]
  SETTABLEKS R12 R2 K62 ["SetMeshTextureApisAllowed"]
  DUPCLOSURE R6 K63 [PROTO_28]
  CAPTURE VAL R4
  SETTABLEKS R6 R2 K64 ["GetInsertFreeAssetsAllowed"]
  DUPCLOSURE R6 K65 [PROTO_29]
  CAPTURE VAL R4
  SETTABLEKS R6 R2 K66 ["SetInsertFreeAssetsAllowed"]
  RETURN R2 1
