...
MAIN:
  ...
  GETTABLEKS R24 R13 K28 ["Components"]
  GETTABLEKS R23 R24 K34 ["Secrets"]
  CALL R22 1 1
  ...
  LOADK R27 K39 ["IdVerificationLink"]
  LOADK R28 K40 ["https://www.roblox.com/my/account#!/info"]
  NAMECALL R25 R25 K38 ["DefineFastString"]
  CALL R25 3 1
  GETIMPORT R26 K16 [game]
  LOADK R28 K41 ["CreatorIdVerificationLink"]
  LOADK R29 K42 ["https://create.roblox.com/docs/production/publishing/account-verification"]
  ...
  CAPTURE VAL R16
  CAPTURE VAL R17
  DUPCLOSURE R28 K44 [PROTO_12]
  CAPTURE VAL R21
  DUPCLOSURE R29 K45 [PROTO_19]
  CAPTURE VAL R21
  CAPTURE VAL R10
  DUPCLOSURE R30 K46 [PROTO_20]
  DUPCLOSURE R31 K47 [PROTO_21]
  CAPTURE VAL R10
  DUPCLOSURE R32 K48 [PROTO_22]
  CAPTURE VAL R10
  GETTABLEKS R33 R1 K49 ["PureComponent"]
  GETIMPORT R36 K1 [script]
  GETTABLEKS R35 R36 K35 ["Name"]
  NAMECALL R33 R33 K50 ["extend"]
  CALL R33 2 1
  JUMPIFNOT R10 [+7]
  DUPCLOSURE R34 K51 [PROTO_23]
  SETTABLEKS R34 R33 K52 ["isGroupGame"]
  DUPCLOSURE R34 K53 [PROTO_24]
  CAPTURE VAL R11
  SETTABLEKS R34 R33 K54 ["isLoggedInUserGameOwner"]
  DUPCLOSURE R34 K55 [PROTO_35]
  CAPTURE VAL R10
  CAPTURE VAL R9
  CAPTURE VAL R1
  CAPTURE VAL R7
  ...
  CAPTURE VAL R29
  CAPTURE VAL R23
  SETTABLEKS R34 R33 K56 ["render"]
  MOVE R34 R5
  DUPTABLE R35 K59 [{"Localization", "Stylizer"}]
  GETTABLEKS R36 R4 K57 ["Localization"]
  SETTABLEKS R36 R35 K57 ["Localization"]
  GETTABLEKS R36 R4 K58 ["Stylizer"]
  SETTABLEKS R36 R35 K58 ["Stylizer"]
  CALL R34 1 1
  MOVE R35 R33
  CALL R34 1 1
  MOVE R33 R34
  ...
  GETTABLEKS R36 R37 K60 ["Networking"]
  GETTABLEKS R35 R36 K61 ["settingFromState"]
  CALL R34 1 1
  GETTABLEKS R35 R2 K62 ["connect"]
  DUPCLOSURE R36 K63 [PROTO_38]
  CAPTURE VAL R34
  CAPTURE VAL R10
  CAPTURE VAL R31
  CAPTURE VAL R30
  DUPCLOSURE R37 K64 [PROTO_41]
  CAPTURE VAL R19
  CAPTURE VAL R32
  CALL R35 2 1
  MOVE R36 R33
  CALL R35 1 1
  MOVE R33 R35
  SETTABLEKS R23 R33 K65 ["LocalizationId"]
  RETURN R33 1
