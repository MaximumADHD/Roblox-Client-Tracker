...
PROTO_15:
  ...
  JUMPIFNOT R4 [+6]
  GETTABLEKS R5 R3 K4 ["responseBody"]
  GETTABLEKS R4 R5 K5 ["showRewardedAdsToggle"]
  JUMPIFNOTEQKNIL R4 [+3]
  LOADB R4 0
  RETURN R4 1
  GETTABLEKS R6 R3 K4 ["responseBody"]
  GETTABLEKS R5 R6 K5 ["showRewardedAdsToggle"]
  JUMPIFEQKB R5 TRUE [+2]
  LOADB R4 0 +1
  LOADB R4 1
  RETURN R4 1
  MOVE R4 R1
  NAMECALL R2 R0 K6 ["developerAdsStatsV1GET"]
  CALL R2 2 1
  NAMECALL R2 R2 K7 ["await"]
  CALL R2 1 1
  GETTABLEKS R4 R2 K4 ["responseBody"]
  GETTABLEKS R3 R4 K5 ["showRewardedAdsToggle"]
  RETURN R3 1
...
MAIN:
  ...
  CALL R4 1 1
  GETTABLEKS R5 R4 K10 ["GetFFlagEnableDeveloperAdsStatsApiMonetizationPageFix"]
  CALL R5 0 1
  SETTABLEKS R0 R0 K11 ["__index"]
  DUPCLOSURE R6 K12 [PROTO_0]
  CAPTURE VAL R0
  SETTABLEKS R6 R0 K13 ["new"]
  DUPCLOSURE R6 K14 [PROTO_1]
  SETTABLEKS R6 R0 K15 ["economyV1GET"]
  DUPCLOSURE R6 K16 [PROTO_2]
  SETTABLEKS R6 R0 K17 ["configurationV2GET"]
  DUPCLOSURE R6 K18 [PROTO_3]
  SETTABLEKS R6 R0 K19 ["configurationV2PATCH"]
  DUPCLOSURE R6 K20 [PROTO_4]
  SETTABLEKS R6 R0 K21 ["developerAdsStatsV1GET"]
  DUPCLOSURE R6 K22 [PROTO_5]
  SETTABLEKS R6 R0 K23 ["vipServersV1GET"]
  DUPCLOSURE R6 K24 [PROTO_6]
  SETTABLEKS R6 R0 K25 ["developerProductsV2GET"]
  DUPCLOSURE R6 K26 [PROTO_7]
  SETTABLEKS R6 R0 K27 ["developerProductsCreateV1POST"]
  DUPCLOSURE R6 K28 [PROTO_8]
  SETTABLEKS R6 R0 K29 ["developerProductsUpdateV1POST"]
  DUPCLOSURE R6 K30 [PROTO_9]
  SETTABLEKS R6 R0 K31 ["badgesV1GET"]
  DUPCLOSURE R6 K32 [PROTO_10]
  SETTABLEKS R6 R0 K33 ["getTaxRate"]
  DUPCLOSURE R6 K34 [PROTO_11]
  SETTABLEKS R6 R0 K35 ["getMinimumFee"]
  DUPCLOSURE R6 K36 [PROTO_13]
  CAPTURE VAL R3
  SETTABLEKS R6 R0 K37 ["getIsUniverseEligibleForRewardedOnDemandAds"]
  DUPCLOSURE R6 K38 [PROTO_15]
  CAPTURE VAL R5
  SETTABLEKS R6 R0 K39 ["getShowRewardedAdsToggle"]
  DUPCLOSURE R6 K40 [PROTO_16]
  SETTABLEKS R6 R0 K41 ["getIsRewardedOnDemandAdsAllowed"]
  DUPCLOSURE R6 K42 [PROTO_17]
  SETTABLEKS R6 R0 K43 ["setIsRewardedOnDemandAdsAllowed"]
  DUPCLOSURE R6 K44 [PROTO_18]
  SETTABLEKS R6 R0 K45 ["getPaidAccessEnabled"]
  DUPCLOSURE R6 K46 [PROTO_19]
  SETTABLEKS R6 R0 K47 ["setPaidAccessEnabled"]
  DUPCLOSURE R6 K48 [PROTO_20]
  SETTABLEKS R6 R0 K49 ["getPaidAccessPrice"]
  DUPCLOSURE R6 K50 [PROTO_21]
  SETTABLEKS R6 R0 K51 ["setPaidAccessPrice"]
  DUPCLOSURE R6 K52 [PROTO_22]
  SETTABLEKS R6 R0 K53 ["getVIPServersEnabled"]
  DUPCLOSURE R6 K54 [PROTO_23]
  SETTABLEKS R6 R0 K55 ["setVIPServersEnabled"]
  DUPCLOSURE R6 K56 [PROTO_24]
  SETTABLEKS R6 R0 K57 ["getVIPServersPrice"]
  DUPCLOSURE R6 K58 [PROTO_25]
  SETTABLEKS R6 R0 K59 ["setVIPServersPrice"]
  DUPCLOSURE R6 K60 [PROTO_26]
  SETTABLEKS R6 R0 K61 ["getVIPServersActiveServersCount"]
  DUPCLOSURE R6 K62 [PROTO_27]
  SETTABLEKS R6 R0 K63 ["getVIPServersActiveSubscriptionsCount"]
  DUPCLOSURE R6 K64 [PROTO_28]
  SETTABLEKS R6 R0 K65 ["getDeveloperProducts"]
  DUPCLOSURE R6 K66 [PROTO_29]
  CAPTURE VAL R2
  SETTABLEKS R6 R0 K67 ["getDeveloperProductsV2"]
  DUPCLOSURE R6 K68 [PROTO_30]
  SETTABLEKS R6 R0 K69 ["createDevProduct"]
  DUPCLOSURE R6 K70 [PROTO_31]
  SETTABLEKS R6 R0 K71 ["updateDevProduct"]
  DUPCLOSURE R6 K72 [PROTO_32]
  SETTABLEKS R6 R0 K73 ["getBadges"]
  RETURN R0 1
