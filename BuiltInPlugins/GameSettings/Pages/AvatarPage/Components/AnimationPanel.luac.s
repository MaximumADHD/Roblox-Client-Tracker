...
PROTO_1:
        0 NEWTABLE                         R1 2 0
        2 GETUPVAL                         R2 0
        3 GETTABLEKS                       R2 R2 K0 ["AnimationStandard"]
        5 GETUPVAL                         R3 1
        6 GETTABLEKS                       R3 R3 K1 ["setAnimationStandard"]
        8 SETTABLE                         R3 R1 R2
        9 GETUPVAL                         R2 0
       10 GETTABLEKS                       R2 R2 K2 ["PlayerChoice"]
       12 GETUPVAL                         R3 1
       13 GETTABLEKS                       R3 R3 K3 ["setAnimationPlayerChoice"]
       15 SETTABLE                         R3 R1 R2
       16 GETTABLEKS                       R2 R0 K4 ["props"]
       18 GETTABLEKS                       R3 R2 K5 ["Localization"]
       20 GETTABLEKS                       R4 R2 K6 ["Mouse"]
       22 GETUPVAL                         R5 2
       23 GETTABLEKS                       R5 R5 K7 ["createElement"]
       25 GETUPVAL                         R6 3
       26 DUPTABLE                         R7 K14 [{"Title", "Buttons", "Enabled", "LayoutOrder", "Selected", "Mouse", "SelectionChanged"}]
       27 LOADK                            R10 K15 ["General"]
       28 LOADK                            R11 K16 ["TitleAnimation"]
       ...
       37 GETUPVAL                         R10 0
       38 GETTABLEKS                       R10 R10 K0 ["AnimationStandard"]
       40 SETTABLEKS                       R10 R9 K18 ["Id"]
       42 LOADK                            R12 K15 ["General"]
       43 LOADK                            R13 K0 ["AnimationStandard"]
       44 NAMECALL                         R10 R3 K17 ["getText"]
       46 CALL                             R10 3 1
       47 SETTABLEKS                       R10 R9 K8 ["Title"]
       49 DUPTABLE                         R10 K19 [{"Id", "Title"}]
       50 GETUPVAL                         R11 0
       51 GETTABLEKS                       R11 R11 K2 ["PlayerChoice"]
       53 SETTABLEKS                       R11 R10 K18 ["Id"]
       55 LOADK                            R13 K15 ["General"]
       56 LOADK                            R14 K20 ["AnimationPlayerChoice"]
       57 NAMECALL                         R11 R3 K17 ["getText"]
       59 CALL                             R11 3 1
       60 SETTABLEKS                       R11 R10 K8 ["Title"]
       62 SETLIST                          R8 R9 2 [1]
       64 SETTABLEKS                       R8 R7 K9 ["Buttons"]
       66 GETTABLEKS                       R8 R0 K4 ["props"]
       68 GETTABLEKS                       R8 R8 K21 ["IsEnabled"]
       70 SETTABLEKS                       R8 R7 K10 ["Enabled"]
       72 GETTABLEKS                       R8 R0 K4 ["props"]
       74 GETTABLEKS                       R8 R8 K11 ["LayoutOrder"]
       76 SETTABLEKS                       R8 R7 K11 ["LayoutOrder"]
       78 GETUPVAL                         R8 4
       79 GETTABLEKS                       R8 R8 K22 ["getStateModelTemplate"]
       81 GETTABLEKS                       R9 R0 K4 ["props"]
       83 CALL                             R8 1 1
       84 GETTABLEKS                       R8 R8 K23 ["AnimationValue"]
       86 SETTABLEKS                       R8 R7 K12 ["Selected"]
       88 NAMECALL                         R8 R4 K24 ["get"]
       90 CALL                             R8 1 1
...
MAIN:
       ...
       65 LOADK                            R11 K17 ["ComponentAnimationPanel"]
