...
PROTO_39:
  ...
  CALL R2 1 -1
  RETURN R2 -1
  NAMECALL R2 R0 K3 ["hasPermissionToEdit"]
  CALL R2 1 1
  JUMPIF R2 [+6]
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K2 ["createElement"]
...
MAIN:
  ...
  GETTABLEKS R16 R17 K27 ["RedirectToAvatarSettings"]
  CALL R15 1 1
  GETIMPORT R16 K8 [require]
  GETTABLEKS R20 R2 K15 ["Src"]
  GETTABLEKS R19 R20 K25 ["Components"]
  GETTABLEKS R18 R19 K28 ["SettingsPages"]
  GETTABLEKS R17 R18 K29 ["SettingsPage"]
  CALL R16 1 1
  GETIMPORT R17 K8 [require]
  GETTABLEKS R21 R2 K15 ["Src"]
  GETTABLEKS R20 R21 K25 ["Components"]
  GETTABLEKS R19 R20 K28 ["SettingsPages"]
  GETTABLEKS R18 R19 K30 ["InsufficientPermissionsPage"]
  CALL R17 1 1
  GETIMPORT R18 K8 [require]
  GETTABLEKS R21 R2 K15 ["Src"]
  GETTABLEKS R20 R21 K31 ["Flags"]
  GETTABLEKS R19 R20 K32 ["getFFlagEnableAvatarSettings"]
  CALL R18 1 1
  GETIMPORT R20 K5 [script]
  GETTABLEKS R19 R20 K33 ["Name"]
  DUPCLOSURE R20 K34 [PROTO_16]
  CAPTURE VAL R7
  CAPTURE VAL R11
  DUPCLOSURE R21 K35 [PROTO_27]
  CAPTURE VAL R7
  DUPCLOSURE R22 K36 [PROTO_28]
  DUPCLOSURE R23 K37 [PROTO_32]
  CAPTURE VAL R9
  CAPTURE VAL R10
  CAPTURE VAL R8
  CAPTURE VAL R12
  CAPTURE VAL R13
  CAPTURE VAL R11
  DUPCLOSURE R24 K38 [PROTO_33]
  DUPCLOSURE R25 K39 [PROTO_34]
  GETTABLEKS R26 R3 K40 ["PureComponent"]
  GETIMPORT R29 K5 [script]
  GETTABLEKS R28 R29 K33 ["Name"]
  NAMECALL R26 R26 K41 ["extend"]
  CALL R26 2 1
  DUPCLOSURE R27 K42 [PROTO_35]
  CAPTURE VAL R0
  SETTABLEKS R27 R26 K43 ["hasPermissionToEdit"]
  DUPCLOSURE R27 K44 [PROTO_37]
  CAPTURE VAL R3
  CAPTURE VAL R14
  SETTABLEKS R27 R26 K45 ["createChildren"]
  DUPCLOSURE R27 K46 [PROTO_39]
  CAPTURE VAL R18
  CAPTURE VAL R3
  CAPTURE VAL R15
  CAPTURE VAL R17
  ...
  MOVE R27 R6
  DUPTABLE R28 K51 [{"Localization", "Stylizer", "Mouse"}]
  GETTABLEKS R29 R5 K48 ["Localization"]
  SETTABLEKS R29 R28 K48 ["Localization"]
  GETTABLEKS R29 R5 K49 ["Stylizer"]
  SETTABLEKS R29 R28 K49 ["Stylizer"]
  GETTABLEKS R29 R5 K50 ["Mouse"]
  SETTABLEKS R29 R28 K50 ["Mouse"]
  CALL R27 1 1
  MOVE R28 R26
  CALL R27 1 1
  MOVE R26 R27
  ...
  GETTABLEKS R29 R30 K52 ["Networking"]
  GETTABLEKS R28 R29 K53 ["settingFromState"]
  CALL R27 1 1
  GETTABLEKS R28 R4 K54 ["connect"]
  DUPCLOSURE R29 K55 [PROTO_41]
  CAPTURE VAL R27
  CAPTURE VAL R22
  DUPCLOSURE R30 K56 [PROTO_44]
  CAPTURE VAL R8
  CAPTURE VAL R23
  CALL R28 2 1
  MOVE R29 R26
  CALL R28 1 1
  MOVE R26 R28
  SETTABLEKS R19 R26 K57 ["LocalizationId"]
  RETURN R26 1
