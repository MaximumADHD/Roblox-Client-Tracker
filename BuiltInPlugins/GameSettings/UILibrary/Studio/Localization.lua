--[[
	...
	For example, your DevelopmentReferenceTable.csv should look something like this :
		...
		Studio.MoneyManager.Sell.LimitedValue,shows how much an item is worth,,,%s is worth %d %s

	And your TranslationReferenceTable.csv should look something like this :
		Key,Context,Example,Source,de,es,es-es,ja,ko
		Studio.MoneyManager.Sell.LimitedValue,%s ist fünf %d %s,%s vale %d %s,%s vale %d %s,%sは%d%sの価値がある,%s은 %d의 가치가있다.
