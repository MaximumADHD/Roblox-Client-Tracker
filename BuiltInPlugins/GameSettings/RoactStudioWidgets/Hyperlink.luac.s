PROTO_0:
        0 GETUPVAL                         R3 0
        1 GETTABLEKS                       R3 R3 K0 ["calculateTextSize"]
        3 MOVE                             R4 R0
        4 MOVE                             R5 R1
        5 MOVE                             R6 R2
        6 CALL                             R3 3 1
...
PROTO_4:
        ...
        5 GETTABLEKS                       R2 R2 K3 ["TextSize"]
        7 ORK                              R1 R2 K1 [22]
        8 GETUPVAL                         R2 2
        9 GETUPVAL                         R3 1
       10 CALL                             R2 1 1
       ...
       20 GETUPVAL                         R6 1
       21 GETTABLEKS                       R6 R6 K2 ["props"]
       23 GETTABLEKS                       R6 R6 K7 ["Text"]
       ...
       40 GETTABLEKS                       R6 R6 K14 ["Size"]
       42 JUMPIF                           R6 ; [+24]
       43 GETUPVAL                         R7 1
       44 GETTABLEKS                       R7 R7 K2 ["props"]
       46 GETTABLEKS                       R7 R7 K7 ["Text"]
       48 GETIMPORT                        R8 K11 [Enum.Font.SourceSans]
       50 GETUPVAL                         R9 0
       51 GETTABLEKS                       R9 R9 K15 ["calculateTextSize"]
       53 MOVE                             R10 R7
       54 MOVE                             R11 R1
       55 MOVE                             R12 R8
       56 CALL                             R9 3 1
       ...
       69 GETUPVAL                         R6 1
       70 GETTABLEKS                       R6 R6 K21 ["Position"]
       72 SETTABLEKS                       R6 R5 K21 ["Position"]
       74 GETIMPORT                        R6 K24 [Enum.TextXAlignment.Left]
       76 SETTABLEKS                       R6 R5 K22 ["TextXAlignment"]
       78 GETUPVAL                         R6 1
       79 GETTABLEKS                       R6 R6 K2 ["props"]
       81 GETTABLEKS                       R6 R6 K25 ["LayoutOrder"]
       83 SETTABLEKS                       R6 R5 K25 ["LayoutOrder"]
       85 GETUPVAL                         R6 3
       86 GETTABLEKS                       R6 R6 K26 ["Event"]
       88 GETTABLEKS                       R6 R6 K27 ["MouseEnter"]
       90 NEWCLOSURE                       R7 P1
       91 CAPTURE                          UPVAL U1
       92 CAPTURE                          UPVAL U4
       93 SETTABLE                         R7 R5 R6
       94 GETUPVAL                         R6 3
       95 GETTABLEKS                       R6 R6 K26 ["Event"]
       97 GETTABLEKS                       R6 R6 K28 ["MouseLeave"]
       99 NEWCLOSURE                       R7 P2
      100 CAPTURE                          UPVAL U1
      101 CAPTURE                          UPVAL U4
      102 SETTABLE                         R7 R5 R6
      103 GETUPVAL                         R6 3
      104 GETTABLEKS                       R6 R6 K26 ["Event"]
      106 GETTABLEKS                       R6 R6 K29 ["Activated"]
...
PROTO_6:
        ...
        3 GETTABLEKS                       R3 R3 K3 ["Style"]
        5 JUMPIFNOT                        R3 ; [+7]
        6 GETTABLEKS                       R2 R0 K2 ["props"]
        8 GETTABLEKS                       R2 R2 K3 ["Style"]
       10 GETTABLEKS                       R2 R2 K0 ["HyperlinkColor"]
       12 JUMPIF                           R2 ; [+4]
       13 GETUPVAL                         R2 0
       14 GETTABLEKS                       R2 R2 K4 ["getHyperlinkTextTextColor"]
       16 CALL                             R2 0 1
