...
MAIN:
  ...
  CALL R2 1 1
  GETTABLEKS R4 R1 K6 ["Src"]
  GETTABLEKS R3 R4 K7 ["Util"]
  GETIMPORT R4 K4 [require]
  GETTABLEKS R5 R3 K8 ["Utils"]
  CALL R4 1 1
  GETIMPORT R5 K4 [require]
  GETTABLEKS R6 R3 K9 ["Constants"]
  CALL R5 1 1
  GETIMPORT R6 K4 [require]
  GETTABLEKS R8 R1 K10 ["Packages"]
  GETTABLEKS R7 R8 K11 ["TestLoader"]
  CALL R6 1 1
  ...
  CAPTURE VAL R5
  CAPTURE VAL R4
  SETTABLEKS R7 R0 K13 ["fetchAllTexturesFromWorkspace"]
  DUPCLOSURE R7 K14 [PROTO_2]
  CAPTURE VAL R5
  CAPTURE VAL R4
  SETTABLEKS R7 R0 K15 ["replaceAllTexturesWithId"]
  DUPCLOSURE R7 K16 [PROTO_4]
  SETTABLEKS R7 R0 K17 ["zoomToExtentsAndSelectInstance"]
  RETURN R0 1
