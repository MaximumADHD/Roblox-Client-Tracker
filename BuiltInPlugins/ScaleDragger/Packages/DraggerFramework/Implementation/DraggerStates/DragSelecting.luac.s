...
PROTO_1:
        ...
        1 GETUPVAL                         R3 0
        2 GETTABLEKS                       R3 R3 K3 ["new"]
        4 NAMECALL                         R4 R0 K4 ["getSelectionWrapper"]
        6 CALL                             R4 1 1
        7 NAMECALL                         R5 R0 K5 ["getSchema"]
        9 CALL                             R5 1 1
       10 GETTABLEKS                       R5 R5 K6 ["beginBoxSelect"]
       12 NAMECALL                         R6 R0 K5 ["getSchema"]
       14 CALL                             R6 1 1
       15 GETTABLEKS                       R6 R6 K7 ["updateBoxSelect"]
       17 JUMPIF                           R6 ; [+1]
       18 DUPCLOSURE                       R6 K8 [PROTO_0]
       19 NAMECALL                         R7 R0 K5 ["getSchema"]
       21 CALL                             R7 1 1
       22 GETTABLEKS                       R7 R7 K9 ["endBoxSelect"]
       24 CALL                             R3 4 1
...
PROTO_4:
        0 GETTABLEKS                       R1 R0 K0 ["_draggerToolModel"]
        2 GETTABLEKS                       R1 R1 K1 ["_sessionAnalytics"]
        4 GETTABLEKS                       R3 R0 K0 ["_draggerToolModel"]
        6 GETTABLEKS                       R3 R3 K1 ["_sessionAnalytics"]
        8 GETTABLEKS                       R3 R3 K3 ["dragSelects"]
       10 ADDK                             R2 R3 K2 [1]
...
PROTO_5:
        0 GETTABLEKS                       R1 R0 K0 ["_draggerToolModel"]
        2 GETUPVAL                         R3 0
        3 GETTABLEKS                       R3 R3 K1 ["getArrow"]
        5 CALL                             R3 0 -1
       ...
       16 CALL                             R1 1 1
       17 JUMPIF                           R1 ; [+7]
       18 GETTABLEKS                       R1 R0 K0 ["_draggerToolModel"]
       20 GETTABLEKS                       R1 R1 K6 ["_draggerContext"]
       ...
       30 JUMPIFNOT                        R2 ; [+18]
       31 GETUPVAL                         R2 1
       32 GETTABLEKS                       R2 R2 K9 ["createElement"]
       34 GETUPVAL                         R3 2
       35 DUPTABLE                         R4 K12 [{"DragStartLocation", "DragEndLocation"}]
       36 SETTABLEKS                       R1 R4 K10 ["DragStartLocation"]
       38 GETTABLEKS                       R5 R0 K0 ["_draggerToolModel"]
       40 GETTABLEKS                       R5 R5 K6 ["_draggerContext"]
...
PROTO_8:
        ...
        7 GETTABLEKS                       R3 R3 K3 ["_draggerContext"]
       ...
       21 GETTABLEKS                       R3 R3 K3 ["_draggerContext"]
...
MAIN:
       ...
       20 GETTABLEKS                       R4 R4 K7 ["DragSelectionView"]
       22 CALL                             R3 1 1
       ...
       34 GETTABLEKS                       R6 R6 K11 ["DragSelector"]
       36 CALL                             R5 1 1
       37 GETIMPORT                        R6 K4 [require]
       39 GETTABLEKS                       R7 R0 K10 ["Utility"]
       41 GETTABLEKS                       R7 R7 K12 ["StandardCursor"]
       43 CALL                             R6 1 1
       44 GETIMPORT                        R7 K4 [require]
       46 GETTABLEKS                       R8 R0 K13 ["Flags"]
       48 GETTABLEKS                       R8 R8 K14 ["getFFlagNextGenDraggers"]
       50 CALL                             R7 1 1
       51 NEWTABLE                         R8 16 0
