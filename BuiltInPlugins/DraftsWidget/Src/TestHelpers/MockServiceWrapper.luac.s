PROTO_0:
        ...
        2 GETTABLEKS                       R1 R1 K1 ["draftsService"]
        4 JUMPIF                           R1 ; [+10]
        5 GETUPVAL                         R2 0
        6 GETTABLEKS                       R2 R2 K2 ["new"]
        8 GETUPVAL                         R3 0
        9 GETTABLEKS                       R3 R3 K3 ["TestCases"]
       11 GETTABLEKS                       R3 R3 K4 ["DEFAULT"]
       13 CALL                             R2 1 1
       14 MOVE                             R1 R2
       15 GETTABLEKS                       R2 R0 K0 ["props"]
       17 GETTABLEKS                       R2 R2 K5 ["localization"]
       19 JUMPIF                           R2 ; [+5]
       20 GETUPVAL                         R3 1
       21 GETTABLEKS                       R3 R3 K6 ["mock"]
       23 CALL                             R3 0 1
       24 MOVE                             R2 R3
       25 GETTABLEKS                       R3 R0 K0 ["props"]
       27 GETTABLEKS                       R3 R3 K7 ["plugin"]
       29 JUMPIF                           R3 ; [+5]
       30 GETUPVAL                         R4 2
       31 GETTABLEKS                       R4 R4 K2 ["new"]
       33 CALL                             R4 0 1
       34 MOVE                             R3 R4
       35 GETTABLEKS                       R4 R0 K0 ["props"]
       37 GETTABLEKS                       R4 R4 K8 ["storeState"]
       39 GETUPVAL                         R5 3
       40 GETTABLEKS                       R5 R5 K9 ["Store"]
       42 GETTABLEKS                       R5 R5 K2 ["new"]
       44 GETUPVAL                         R6 4
       45 MOVE                             R7 R4
       46 NEWTABLE                         R8 0 1
       48 GETUPVAL                         R9 3
       49 GETTABLEKS                       R9 R9 K10 ["thunkMiddleware"]
       51 SETLIST                          R8 R9 1 [1]
       53 CALL                             R5 3 1
       54 GETTABLEKS                       R6 R0 K0 ["props"]
       56 GETTABLEKS                       R6 R6 K11 ["theme"]
       58 JUMPIF                           R6 ; [+4]
       59 GETUPVAL                         R7 5
       60 LOADB                            R8 1
       61 CALL                             R7 1 1
       62 MOVE                             R6 R7
       63 GETUPVAL                         R7 6
       64 GETTABLEKS                       R7 R7 K12 ["createElement"]
       66 GETUPVAL                         R8 7
       ...
       80 GETUPVAL                         R12 6
       81 GETTABLEKS                       R12 R12 K15 ["Children"]
...
MAIN:
       ...
       38 GETTABLEKS                       R7 R7 K12 ["Reducers"]
       40 GETTABLEKS                       R7 R7 K13 ["MainReducer"]
       42 CALL                             R6 1 1
       43 GETIMPORT                        R7 K4 [require]
       45 GETTABLEKS                       R8 R0 K11 ["Src"]
       47 GETTABLEKS                       R8 R8 K14 ["TestHelpers"]
       49 GETTABLEKS                       R8 R8 K15 ["MockDraftsService"]
       51 CALL                             R7 1 1
       52 GETIMPORT                        R8 K4 [require]
       54 GETTABLEKS                       R9 R0 K11 ["Src"]
       56 GETTABLEKS                       R9 R9 K14 ["TestHelpers"]
       58 GETTABLEKS                       R9 R9 K16 ["MockPlugin"]
       60 CALL                             R8 1 1
       61 GETIMPORT                        R9 K4 [require]
       63 GETTABLEKS                       R10 R0 K11 ["Src"]
       65 GETTABLEKS                       R10 R10 K17 ["Resources"]
       67 GETTABLEKS                       R10 R10 K18 ["MakeTheme"]
       69 CALL                             R9 1 1
       70 GETIMPORT                        R10 K4 [require]
       72 GETTABLEKS                       R11 R0 K11 ["Src"]
       74 GETTABLEKS                       R11 R11 K19 ["Components"]
       76 GETTABLEKS                       R11 R11 K20 ["ServiceWrapper"]
       78 CALL                             R10 1 1
