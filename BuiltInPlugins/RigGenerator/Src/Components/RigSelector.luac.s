...
PROTO_2:
  ...
  JUMP [+13]
  GETIMPORT R10 K21 [workspace]
  SETTABLEKS R10 R5 K47 ["Parent"]
  GETUPVAL R10 4
  NEWTABLE R12 0 1
  MOVE R13 R5
  SETLIST R12 R13 1 [1]
  NAMECALL R10 R10 K48 ["Set"]
  CALL R10 2 0
  LOADK R12 K53 ["rigInsert"]
...
MAIN:
  ...
  GETTABLEKS R5 R6 K13 ["getFFlagRigGeneratorCHSFix"]
  CALL R4 1 1
  ...
  GETTABLEKS R9 R7 K19 ["Analytics"]
  GETTABLEKS R10 R7 K20 ["Localization"]
  GETTABLEKS R12 R6 K21 ["Style"]
  GETTABLEKS R11 R12 K22 ["Stylizer"]
  GETTABLEKS R12 R6 K23 ["UI"]
  GETTABLEKS R13 R12 K24 ["Pane"]
  GETTABLEKS R14 R12 K25 ["RadioButtonList"]
  GETTABLEKS R15 R12 K26 ["TextLabel"]
  GETTABLEKS R16 R12 K27 ["TitledFrame"]
  GETIMPORT R17 K10 [require]
  GETTABLEKS R20 R3 K11 ["Src"]
  GETTABLEKS R19 R20 K28 ["Util"]
  GETTABLEKS R18 R19 K29 ["BodyShape"]
  CALL R17 1 1
  GETIMPORT R18 K10 [require]
  GETTABLEKS R21 R3 K11 ["Src"]
  GETTABLEKS R20 R21 K30 ["Components"]
  GETTABLEKS R19 R20 K31 ["RigList"]
  CALL R18 1 1
  GETTABLEKS R19 R5 K32 ["PureComponent"]
  LOADK R21 K33 ["RigSelector"]
  ...
  CAPTURE VAL R0
  CAPTURE VAL R2
  SETTABLEKS R22 R19 K38 ["insertRig"]
  DUPCLOSURE R22 K39 [PROTO_3]
  CAPTURE VAL R17
  SETTABLEKS R22 R19 K40 ["init"]
  ...
  CAPTURE VAL R17
  CAPTURE VAL R18
  SETTABLEKS R22 R19 K42 ["render"]
  MOVE R22 R8
  DUPTABLE R23 K43 [{"Analytics", "Localization", "Stylizer"}]
  SETTABLEKS R9 R23 K19 ["Analytics"]
  SETTABLEKS R10 R23 K20 ["Localization"]
  SETTABLEKS R11 R23 K22 ["Stylizer"]
  CALL R22 1 1
  MOVE R23 R19
  CALL R22 1 1
  MOVE R19 R22
