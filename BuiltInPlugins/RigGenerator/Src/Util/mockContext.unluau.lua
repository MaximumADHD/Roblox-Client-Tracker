...
local var4 = {}
local var67 = var3.Analytics.mock()
local var6 = var3.Localization.mock()
local var73 = require(var0.Packages.Rodux).Store
var73 = require(var0.Src.Reducers.MainReducer)
local var7 = var3.Store.new(var73.new(var73, nil, nil, nil))
