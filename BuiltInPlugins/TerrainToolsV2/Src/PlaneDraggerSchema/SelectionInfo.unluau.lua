...
function var0.new(arg1, arg2)
   ...
   local var8 = {}
   var8._planeCFrame = arg2[1].planeCFrame
...
function var0.getBoundingBox(arg1)
   if arg1._draggerContext:shouldUseLocalSpace() then
      return arg1._planeCFrameVector3.new(),Vector3.new(),
   end
   return CFrame.new(arg1._planeCFrame.Position)Vector3.new(),Vector3.new(),
end
