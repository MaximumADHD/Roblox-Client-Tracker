PROTO_0:
  ...
  CALL R2 2 0
  DUPTABLE R3 K6 [{"_planeCFrame", "_draggerContext"}]
  GETTABLEN R5 R1 1
  GETTABLEKS R4 R5 K7 ["planeCFrame"]
  SETTABLEKS R4 R3 K4 ["_planeCFrame"]
...
PROTO_2:
  ...
  CALL R1 1 1
  JUMPIFNOT R1 [+11]
  GETTABLEKS R1 R0 K2 ["_planeCFrame"]
  FASTCALL VECTOR [+2]
  ...
  GETTABLEKS R3 R0 K2 ["_planeCFrame"]
...
PROTO_3:
  GETTABLEKS R1 R0 K0 ["_planeCFrame"]
  FASTCALL VECTOR [+2]
