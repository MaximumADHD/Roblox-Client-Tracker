...
PROTO_2:
  DUPTABLE R6 K7 [{"_changeHistoryService", "_smoothVoxelsUpgraderService", "_analytics", "_plugin", "_store", "_terrain", "_mock"}]
  ...
  GETIMPORT R7 K9 [game]
  LOADK R9 K12 ["SmoothVoxelsUpgraderService"]
  NAMECALL R7 R7 K11 ["GetService"]
  CALL R7 2 1
  SETTABLEKS R7 R6 K1 ["_smoothVoxelsUpgraderService"]
  ...
  CALL R6 1 1
  LOADK R9 K16 ["SmoothVoxelsUpgraded"]
  ...
  CALL R7 2 1
  SETTABLEKS R7 R5 K19 ["_onSmoothVoxelsUpgradedChanged"]
  LOADK R9 K20 ["ShorelinesUpgraded"]
  NAMECALL R7 R6 K17 ["GetPropertyChangedSignal"]
  CALL R7 2 1
  NEWCLOSURE R9 P1
  CAPTURE VAL R5
  NAMECALL R7 R7 K18 ["Connect"]
  CALL R7 2 1
  SETTABLEKS R7 R5 K21 ["_onShorelinesUpgradedChanged"]
  GETTABLEKS R7 R5 K3 ["_plugin"]
  LOADK R9 K22 ["UpgradeSmoothVoxels_DontAsk"]
  NAMECALL R7 R7 K23 ["GetSetting"]
  CALL R7 2 1
  SETTABLEKS R7 R5 K24 ["_dontAsk"]
  NAMECALL R7 R5 K25 ["checkUpgradeCapability"]
  CALL R7 1 0
  RETURN R5 1
...
PROTO_3:
  ...
  JUMPIFNOT R1 [+1]
  RETURN R0 0
  GETTABLEKS R1 R0 K1 ["_onSmoothVoxelsUpgradedChanged"]
  JUMPIFNOT R1 [+5]
  GETTABLEKS R1 R0 K1 ["_onSmoothVoxelsUpgradedChanged"]
  NAMECALL R1 R1 K2 ["Disconnect"]
  CALL R1 1 0
  GETTABLEKS R1 R0 K3 ["_onShorelinesUpgradedChanged"]
  JUMPIFNOT R1 [+5]
  GETTABLEKS R1 R0 K3 ["_onShorelinesUpgradedChanged"]
  NAMECALL R1 R1 K2 ["Disconnect"]
  CALL R1 1 0
...
PROTO_4:
  ...
  LOADK R4 K4 ["UpgradeSmoothVoxels_DontAsk"]
  MOVE R5 R1
  NAMECALL R2 R2 K5 ["SetSetting"]
  CALL R2 3 0
  GETTABLEKS R2 R0 K6 ["_analytics"]
  LOADK R4 K7 ["upgradeSmoothVoxelsDismiss"]
  MOVE R5 R1
...
PROTO_5:
  ...
  MOVE R2 R1
  JUMPIFNOT R2 [+3]
  NAMECALL R2 R1 K3 ["CanSmoothVoxelsBeUpgraded"]
  CALL R2 1 1
...
PROTO_6:
  ...
  GETTABLEKS R1 R2 K5 ["SmoothVoxelsUpgradePercent"]
  LOADN R2 0
  JUMPIFLE R2 R1 [+4]
  LOADN R2 1
  JUMPIFNOTLT R1 R2 [+20]
  GETTABLEKS R2 R0 K6 ["_smoothVoxelsUpgraderService"]
  NAMECALL R2 R2 K7 ["Cancel"]
  CALL R2 1 0
  GETTABLEKS R2 R0 K8 ["_analytics"]
  LOADK R4 K9 ["upgradeSmoothVoxelsCancel"]
...
PROTO_8:
  ...
  GETTABLEKS R2 R0 K2 ["_smoothVoxelsUpgraderService"]
  NAMECALL R2 R2 K3 ["Start"]
  CALL R2 1 0
  GETTABLEKS R3 R0 K2 ["_smoothVoxelsUpgraderService"]
  ...
  CALL R2 2 0
  GETTABLEKS R2 R0 K6 ["_analytics"]
  LOADK R4 K7 ["upgradeSmoothVoxelsAction"]
  MOVE R5 R1
  NAMECALL R2 R2 K8 ["report"]
  CALL R2 3 0
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R4 R2 K9 ["SetSmoothVoxelsUpgradePercent"]
  CALL R3 1 1
  GETIMPORT R4 K4 [require]
  GETTABLEKS R5 R2 K10 ["SetSmoothVoxelsUpgradePossible"]
  CALL R4 1 1
  GETIMPORT R5 K4 [require]
  GETTABLEKS R6 R2 K11 ["SetSmoothVoxelsUpgradeSuggestion"]
  CALL R5 1 1
  GETTABLEKS R6 R1 K12 ["ContextServices"]
  GETTABLEKS R7 R6 K13 ["ContextItem"]
  LOADK R10 K14 ["SmoothVoxelsController"]
