--[[
	Deprecated in favour of new redesigned progress frame
]]
...
local DEPRECATED_ProgressFrame = Roact.PureComponent:extend(script.Name)

function DEPRECATED_ProgressFrame:render()
...
return DEPRECATED_ProgressFrame
