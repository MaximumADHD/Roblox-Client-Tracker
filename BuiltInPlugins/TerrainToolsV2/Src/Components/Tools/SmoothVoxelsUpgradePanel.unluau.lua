...
local var12 = game:GetFastString("SmoothVoxels_LearnMoreUrl")
local var13 = var3.PureComponent:extend(script.Name)
local function fun2(arg1)
   local var0 = arg1.props
   local var1 = var0.Localization
   local var2 = var0.SmoothVoxelsController
   local var3 = var0.Theme:get()
   local var4 = var0.SmoothVoxelsUpgradePercent
   local var5 = 0
   if var5 <= var4 then
      if 1 > var4 then
         local var0 = false
   ...
   var85.Title = var1:getText("UpgradeSmoothVoxels", "Title")
   ...
   var116.Text = var1:getText("UpgradeSmoothVoxels", "Description") ... "\n\n" ... var1:getText("UpgradeSmoothVoxels", "Explanation")
   ...
   var152.Text = var1:getText("UpgradeSmoothVoxels", "LearnMore")
   var152.LinkText = var1:getText("UpgradeSmoothVoxels", "LearnMoreLink")
   ...
   local var8 = {}
   var8.Key = "UpgradeSmoothVoxels"
   var8.Name = var1:getText("UpgradeSmoothVoxels", "ActionButton")
   var8.Active = false
...
var203.SmoothVoxelsController = require(var0.Src.Util.SmoothVoxelsController)
...
return require(var0.Packages.RoactRodux).connect(function(arg1)
   local var0 = {}
   var0.SmoothVoxelsUpgradePercent = arg1.Tools.SmoothVoxelsUpgradePercent
   return var0
end, function()
end)(var13)
