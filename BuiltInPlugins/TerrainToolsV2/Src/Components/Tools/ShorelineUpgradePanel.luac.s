...
PROTO_2:
  ...
  CALL R4 1 1
  GETTABLEKS R5 R1 K5 ["ShorelinesUpgradePercent"]
  LOADB R6 0
  LOADN R7 0
  JUMPIFNOTLE R7 R5 [+6]
  LOADN R7 1
  ...
  LOADK R17 K21 ["UpgradeShorelines"]
  LOADK R18 K18 ["Title"]
  ...
  LOADK R29 K21 ["UpgradeShorelines"]
...
"]
  LOADK R28 K21 ["UpgradeShorelines"]
  ...
  LOADK R25 K21 ["UpgradeShorelines"]
  ...
  LOADK R21 K21 ["UpgradeShorelines"]
  SETTABLEKS R21 R20 K73 ["Key"]
  LOADK R23 K21 ["UpgradeShorelines"]
...
PROTO_3:
  DUPTABLE R1 K1 [{"ShorelinesUpgradePercent"}]
...
MAIN:
  ...
  GETTABLEKS R12 R13 K21 ["ShorelineController"]
  CALL R11 1 1
  ...
  LOADK R17 K26 ["Shorelines_LearnMoreUrl"]
  ...
  MOVE R17 R6
  DUPTABLE R18 K38 [{"Localization", "Theme", "ShorelineController", "Terrain", "analytics", "Plugin"}]
  ...
  SETTABLEKS R11 R18 K21 ["ShorelineController"]
