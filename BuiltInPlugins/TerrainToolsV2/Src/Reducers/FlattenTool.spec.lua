...
return function()
	...
	describe("SetIgnoreParts", function()
		it("should set the current ignoreParts", function()
			local state = FlattenTool(nil, SetIgnoreParts(true))
		...
		it("should preserve immutability", function()
			local immutabilityPreserved = testImmutability(FlattenTool, SetIgnoreParts(true))
			expect(immutabilityPreserved).to.equal(true)
		end)
	end)
	...
	describe("SetSnapToVoxels", function()
		it("should set the current snapToVoxels", function()
			local state = FlattenTool(nil, SetSnapToVoxels(true))
		...
		it("should preserve immutability", function()
			local immutabilityPreserved = testImmutability(FlattenTool, SetSnapToVoxels(true))
			expect(immutabilityPreserved).to.equal(true)
		end)
	end)
