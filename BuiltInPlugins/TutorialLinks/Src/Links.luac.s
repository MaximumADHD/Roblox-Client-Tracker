...
MAIN:
  ...
  DUPTABLE R3 K9 [{"connections"}]
  NEWTABLE R4 0 0
  SETTABLEKS R4 R3 K8 ["connections"]
  DUPCLOSURE R4 K10 [PROTO_0]
  CAPTURE VAL R3
  SETTABLEKS R4 R3 K11 ["addLinks"]
  DUPCLOSURE R4 K12 [PROTO_1]
  CAPTURE VAL R3
  SETTABLEKS R4 R3 K13 ["removeLinks"]
  DUPCLOSURE R4 K14 [PROTO_2]
  CAPTURE VAL R3
  SETTABLEKS R4 R3 K15 ["addGui"]
  DUPCLOSURE R4 K16 [PROTO_4]
  CAPTURE VAL R0
  CAPTURE VAL R3
  CAPTURE VAL R2
  SETTABLEKS R4 R3 K17 ["addLink"]
  RETURN R3 1
