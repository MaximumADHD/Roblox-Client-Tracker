PROTO_0:
        ...
        5 GETUPVAL                         R0 0
        6 GETTABLEKS                       R0 R0 K4 ["createElement"]
        8 GETUPVAL                         R1 1
...
MAIN:
       ...
       23 JUMPIF                           R0 ; [+1]
       24 RETURN                           R0 0
       25 GETIMPORT                        R0 K5 [script]
       27 GETTABLEKS                       R0 R0 K6 ["Parent"]
       29 GETTABLEKS                       R0 R0 K6 ["Parent"]
       31 GETIMPORT                        R1 K3 [require]
       33 GETTABLEKS                       R2 R0 K13 ["Src"]
       35 GETTABLEKS                       R2 R2 K14 ["Util"]
       37 GETTABLEKS                       R2 R2 K15 ["DebugFlags"]
       39 CALL                             R1 1 1
       ...
       47 GETTABLEKS                       R3 R0 K13 ["Src"]
       49 GETTABLEKS                       R3 R3 K14 ["Util"]
       51 GETTABLEKS                       R3 R3 K17 ["commonInit"]
       53 CALL                             R2 1 1
       54 MOVE                             R3 R2
       55 CALL                             R3 0 0
       56 GETIMPORT                        R3 K3 [require]
       58 GETTABLEKS                       R4 R0 K13 ["Src"]
       60 GETTABLEKS                       R4 R4 K18 ["MainPlugin"]
       62 CALL                             R3 1 1
       63 LOADNIL                          R4
       64 GETIMPORT                        R5 K3 [require]
       66 GETTABLEKS                       R6 R0 K19 ["Packages"]
