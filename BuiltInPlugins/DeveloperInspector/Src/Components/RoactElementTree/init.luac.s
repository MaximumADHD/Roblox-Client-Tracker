PROTO_0:
       ...
       12 GETTABLEKS                       R3 R3 K3 ["toggleInstance"]
       14 NEWTABLE                         R4 1 0
...
PROTO_1:
        ...
        9 JUMPIFNOT                        R2 ; [+5]
       10 GETUPVAL                         R3 0
       11 GETTABLEKS                       R3 R3 K3 ["onToggleInstance"]
       13 MOVE                             R4 R0
       14 CALL                             R3 1 0
       15 GETUPVAL                         R3 0
       16 GETTABLEKS                       R3 R3 K1 ["props"]
       18 GETTABLEKS                       R3 R3 K4 ["selectInstance"]
       20 NEWTABLE                         R4 1 0
       22 LOADB                            R5 1
       23 SETTABLE                         R5 R4 R1
       24 CALL                             R3 1 0
       25 GETUPVAL                         R3 0
       26 GETTABLEKS                       R3 R3 K1 ["props"]
       28 GETTABLEKS                       R3 R3 K5 ["Inspector"]
       30 NAMECALL                         R3 R3 K6 ["get"]
       32 CALL                             R3 1 1
       33 NAMECALL                         R4 R3 K7 ["getTargetApi"]
       35 CALL                             R4 1 1
       36 GETUPVAL                         R5 1
       37 GETTABLEKS                       R5 R5 K8 ["isInstance"]
       39 MOVE                             R6 R4
       40 CALL                             R5 1 1
       41 JUMPIFNOT                        R5 ; [+5]
...
PROTO_2:
        ...
        8 GETTABLEKS                       R1 R1 K3 ["Inspector"]
       10 NAMECALL                         R1 R1 K4 ["get"]
       12 CALL                             R1 1 1
       13 NAMECALL                         R2 R1 K5 ["getTargetApi"]
       15 CALL                             R2 1 1
       16 GETUPVAL                         R3 1
       17 GETTABLEKS                       R3 R3 K6 ["isInstance"]
       19 MOVE                             R4 R2
       20 CALL                             R3 1 1
       21 JUMPIFNOT                        R3 ; [+7]
       22 GETTABLEKS                       R5 R0 K0 ["item"]
       24 GETTABLEKS                       R5 R5 K7 ["Path"]
...
PROTO_3:
        0 GETTABLEKS                       R1 R0 K0 ["item"]
        2 GETUPVAL                         R2 0
        3 GETTABLEKS                       R2 R2 K1 ["hoveredItem"]
        5 JUMPIFEQ                         R1 R2 ; [+2]
        7 RETURN                           R0 0
        8 GETUPVAL                         R1 0
        9 GETTABLEKS                       R1 R1 K2 ["props"]
       11 GETTABLEKS                       R1 R1 K3 ["Inspector"]
       13 NAMECALL                         R1 R1 K4 ["get"]
       15 CALL                             R1 1 1
       16 NAMECALL                         R2 R1 K5 ["getTargetApi"]
       18 CALL                             R2 1 1
       19 GETUPVAL                         R3 1
       20 GETTABLEKS                       R3 R3 K6 ["isInstance"]
       22 MOVE                             R4 R2
       23 CALL                             R3 1 1
       24 JUMPIFNOT                        R3 ; [+3]
...
PROTO_4:
        ...
        1 MOVE                             R3 R1
        2 GETUPVAL                         R4 1
        3 GETTABLEKS                       R4 R4 K0 ["item"]
        5 GETTABLEKS                       R4 R4 K1 ["Path"]
        7 CALL                             R2 2 1
        8 JUMPIFNOT                        R2 ; [+1]
        9 RETURN                           R0 1
       10 LOADNIL                          R2
...
MAIN:
       ...
       43 GETTABLEKS                       R6 R6 K12 ["RoactElementRow"]
       45 CALL                             R5 1 1
       ...
       78 GETTABLEKS                       R17 R0 K9 ["Src"]
       80 GETTABLEKS                       R17 R17 K26 ["Actions"]
       82 GETIMPORT                        R18 K4 [require]
       84 GETTABLEKS                       R19 R17 K27 ["RoactInspector"]
       86 GETTABLEKS                       R19 R19 K28 ["SelectInstance"]
       88 CALL                             R18 1 1
       89 GETIMPORT                        R19 K4 [require]
       91 GETTABLEKS                       R20 R17 K27 ["RoactInspector"]
       93 GETTABLEKS                       R20 R20 K29 ["ToggleInstance"]
       95 CALL                             R19 1 1
