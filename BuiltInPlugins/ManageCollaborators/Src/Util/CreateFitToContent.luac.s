...
PROTO_2:
       ...
       39 JUMPIFNOT                        R2 ; [+26]
       40 GETUPVAL                         R2 1
       41 GETTABLEKS                       R2 R2 K10 ["Dictionary"]
       43 GETTABLEKS                       R2 R2 K11 ["join"]
       45 NEWTABLE                         R3 1 0
       47 GETUPVAL                         R4 0
       48 GETTABLEKS                       R4 R4 K12 ["createElement"]
       50 GETUPVAL                         R5 2
       ...
       58 GETUPVAL                         R7 0
       59 GETTABLEKS                       R7 R7 K5 ["Children"]
       ...
       65 JUMP                             ; [+24]
       66 GETUPVAL                         R2 1
       67 GETTABLEKS                       R2 R2 K10 ["Dictionary"]
       69 GETTABLEKS                       R2 R2 K11 ["join"]
       71 NEWTABLE                         R3 1 0
       73 GETUPVAL                         R4 0
       74 GETTABLEKS                       R4 R4 K12 ["createElement"]
       76 GETUPVAL                         R5 2
       ...
       84 GETUPVAL                         R6 0
       85 GETTABLEKS                       R6 R6 K5 ["Children"]
       87 GETTABLE                         R4 R5 R6
       88 CALL                             R2 2 1
       89 MOVE                             R1 R2
       90 GETUPVAL                         R2 1
       91 GETTABLEKS                       R2 R2 K10 ["Dictionary"]
       93 GETTABLEKS                       R2 R2 K11 ["join"]
       95 GETTABLEKS                       R3 R0 K0 ["props"]
       97 NEWTABLE                         R4 2 0
       99 GETUPVAL                         R5 0
      100 GETTABLEKS                       R5 R5 K5 ["Children"]
      102 SETTABLE                         R1 R4 R5
      103 GETUPVAL                         R5 0
      104 GETTABLEKS                       R5 R5 K15 ["Ref"]
      106 GETTABLEKS                       R6 R0 K16 ["containerRef"]
      108 SETTABLE                         R6 R4 R5
      109 CALL                             R2 2 1
      110 GETUPVAL                         R3 0
      111 GETTABLEKS                       R3 R3 K12 ["createElement"]
      113 GETUPVAL                         R4 3
      114 MOVE                             R5 R2
      115 CALL                             R3 2 -1
      116 RETURN                           R3 -1
...
PROTO_5:
        ...
        7 GETTABLEKS                       R3 R0 K3 ["containerRef"]
        9 GETTABLEKS                       R3 R3 K1 ["current"]
