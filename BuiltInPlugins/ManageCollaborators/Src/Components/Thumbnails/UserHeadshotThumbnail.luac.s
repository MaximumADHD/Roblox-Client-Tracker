...
PROTO_3:
  ...
  GETTABLEKS R2 R3 K4 ["subjectThumbnail"]
  GETTABLEKS R1 R2 K5 ["backgroundColor"]
  JUMP [+5]
  GETUPVAL R3 0
  GETTABLEKS R2 R3 K6 ["maskBackgroundParent"]
  GETTABLEKS R1 R2 K7 ["BackgroundColor3"]
  SETTABLEKS R1 R0 K8 ["ImageColor3"]
  RETURN R0 0
...
PROTO_4:
  ...
  GETTABLEKS R3 R4 K12 ["subjectThumbnail"]
  GETTABLEKS R2 R3 K13 ["backgroundColor"]
  JUMP [+5]
  GETUPVAL R4 0
  GETTABLEKS R3 R4 K4 ["maskBackgroundParent"]
  GETTABLEKS R2 R3 K7 ["BackgroundColor3"]
  SETTABLEKS R2 R1 K14 ["ImageColor3"]
  RETURN R0 0
...
PROTO_7:
  ...
  JUMPIFNOT R13 [+5]
  GETTABLEKS R13 R4 K14 ["subjectThumbnail"]
  GETTABLEKS R12 R13 K21 ["backgroundColor"]
  JUMP [+1]
  LOADNIL R12
  SETTABLEKS R12 R11 K22 ["ImageColor3"]
  CALL R9 2 1
...
MAIN:
  ...
  LOADK R10 K21 ["FixThumbnailBackgroundManageCollaborators"]
  LOADB R11 0
  NAMECALL R8 R8 K22 ["DefineFastFlag"]
  CALL R8 3 1
  DUPCLOSURE R9 K23 [PROTO_0]
  SETTABLEKS R9 R7 K24 ["getThumbnail"]
  DUPCLOSURE R9 K25 [PROTO_2]
  CAPTURE VAL R8
  CAPTURE VAL R1
  SETTABLEKS R9 R7 K26 ["init"]
  DUPCLOSURE R9 K27 [PROTO_5]
  CAPTURE VAL R8
  SETTABLEKS R9 R7 K28 ["didMount"]
  DUPCLOSURE R9 K29 [PROTO_6]
  CAPTURE VAL R8
  SETTABLEKS R9 R7 K30 ["willUnmount"]
  DUPCLOSURE R9 K31 [PROTO_8]
  CAPTURE VAL R1
  CAPTURE VAL R6
  CAPTURE VAL R8
  SETTABLEKS R9 R7 K32 ["render"]
  MOVE R9 R5
  DUPTABLE R10 K33 [{"Stylizer"}]
