...
MAIN:
  ...
  CALL R34 0 1
  MOVE R32 R34
  GETTABLEKS R34 R1 K63 ["PureComponent"]
  LOADK R36 K64 ["CollaboratorSearchWidget"]
  NAMECALL R34 R34 K65 ["extend"]
  CALL R34 2 1
  JUMPIFNOT R30 [+4]
  DUPCLOSURE R35 K66 [PROTO_0]
  CAPTURE VAL R1
  SETTABLEKS R35 R34 K67 ["init"]
  DUPCLOSURE R35 K68 [PROTO_1]
  CAPTURE VAL R10
  SETTABLEKS R35 R34 K69 ["isLoading"]
  DUPCLOSURE R35 K70 [PROTO_2]
  SETTABLEKS R35 R34 K71 ["isFriend"]
  DUPCLOSURE R35 K72 [PROTO_5]
  CAPTURE VAL R10
  CAPTURE VAL R9
  SETTABLEKS R35 R34 K73 ["getMatches"]
  DUPCLOSURE R35 K74 [PROTO_6]
  CAPTURE VAL R9
  CAPTURE VAL R1
  CAPTURE VAL R16
  CAPTURE VAL R30
  ...
  CAPTURE VAL R17
  CAPTURE VAL R15
  SETTABLEKS R35 R34 K75 ["getResults"]
  NEWCLOSURE R35 P5
  CAPTURE VAL R28
  CAPTURE VAL R1
  CAPTURE VAL R29
