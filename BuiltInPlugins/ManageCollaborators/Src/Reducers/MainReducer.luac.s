MAIN:
       ...
       29 GETTABLEKS                       R4 R5 K9 ["Permissions"]
       31 CALL                             R3 1 1
       32 GETIMPORT                        R4 K4 [require]
       34 GETIMPORT                        R7 K1 [script]
       36 GETTABLEKS                       R6 R7 K2 ["Parent"]
       38 GETTABLEKS                       R5 R6 K10 ["GranularPermissions"]
       40 CALL                             R4 1 1
       41 GETIMPORT                        R5 K4 [require]
       43 GETIMPORT                        R8 K1 [script]
       45 GETTABLEKS                       R7 R8 K2 ["Parent"]
       47 GETTABLEKS                       R6 R7 K11 ["GroupMetadata"]
       49 CALL                             R5 1 1
       50 GETIMPORT                        R6 K4 [require]
       52 GETIMPORT                        R9 K1 [script]
       54 GETTABLEKS                       R8 R9 K2 ["Parent"]
       56 GETTABLEKS                       R7 R8 K12 ["GroupRolePermissions"]
       58 CALL                             R6 1 1
       59 GETIMPORT                        R7 K4 [require]
       61 GETIMPORT                        R10 K1 [script]
       63 GETTABLEKS                       R9 R10 K2 ["Parent"]
       65 GETTABLEKS                       R8 R9 K13 ["GameOwnerMetadata"]
       67 CALL                             R7 1 1
       68 GETIMPORT                        R8 K4 [require]
       70 GETIMPORT                        R11 K1 [script]
       72 GETTABLEKS                       R10 R11 K2 ["Parent"]
       74 GETTABLEKS                       R9 R10 K14 ["CollaboratorSearch"]
       76 CALL                             R8 1 1
       77 GETIMPORT                        R9 K4 [require]
       79 GETIMPORT                        R12 K1 [script]
       81 GETTABLEKS                       R11 R12 K2 ["Parent"]
       83 GETTABLEKS                       R10 R11 K15 ["LoadState"]
       85 CALL                             R9 1 1
       86 GETIMPORT                        R10 K4 [require]
       88 GETIMPORT                        R13 K1 [script]
       90 GETTABLEKS                       R12 R13 K2 ["Parent"]
       92 GETTABLEKS                       R11 R12 K16 ["SaveState"]
       94 CALL                             R10 1 1
       95 GETIMPORT                        R11 K4 [require]
       97 GETIMPORT                        R14 K1 [script]
       99 GETTABLEKS                       R13 R14 K2 ["Parent"]
      101 GETTABLEKS                       R12 R13 K17 ["FilterPills"]
      103 CALL                             R11 1 1
      104 GETIMPORT                        R12 K4 [require]
      106 GETTABLEKS                       R15 R0 K18 ["Src"]
      108 GETTABLEKS                       R14 R15 K19 ["Reducers"]
      110 GETTABLEKS                       R13 R14 K20 ["CanCollaborateResponses"]
      112 CALL                             R12 1 1
      113 LOADNIL                          R13
      ...
      125 GETTABLEKS                       R17 R18 K2 ["Parent"]
      127 GETTABLEKS                       R16 R17 K25 ["SearchItemLogs"]
      129 CALL                             R15 1 1
      130 MOVE                             R13 R15
