...
MAIN:
  ...
  GETTABLEKS R3 R4 K9 ["WebKeyConstants"]
  CALL R2 1 1
  NEWTABLE R3 0 3
  GETTABLEKS R4 R1 K10 ["NoAccessKey"]
  GETTABLEKS R5 R1 K11 ["PlayKey"]
  GETTABLEKS R6 R1 K12 ["EditKey"]
  SETLIST R3 R4 3 [1]
  NEWTABLE R4 0 0
  ...
  CAPTURE VAL R1
  SETTABLEKS R8 R7 K18 ["_getGroupsForRoles"]
  DUPCLOSURE R8 K19 [PROTO_3]
  CAPTURE VAL R1
  SETTABLEKS R8 R7 K20 ["diffPermissionChanges"]
  DUPCLOSURE R8 K21 [PROTO_4]
  CAPTURE VAL R4
  CAPTURE VAL R1
  CAPTURE VAL R2
  CAPTURE VAL R3
  SETTABLEKS R8 R7 K22 ["_resolvePermissionChanges"]
  DUPCLOSURE R8 K23 [PROTO_5]
  CAPTURE VAL R7
  SETTABLEKS R8 R7 K24 ["SerializePermissions"]
  RETURN R7 1
