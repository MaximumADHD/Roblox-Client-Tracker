...
MAIN:
  ...
  LOADK R8 K18 ["ApiProxyToUsersApiGetUserByUsernamesEnabled"]
  ...
  SETTABLEKS R8 R7 K24 ["universesV1GET"]
  DUPCLOSURE R8 K25 [PROTO_2]
  SETTABLEKS R8 R7 K26 ["universesActivateV1POST"]
  DUPCLOSURE R8 K27 [PROTO_3]
  SETTABLEKS R8 R7 K28 ["universesDeactivateV1POST"]
  DUPCLOSURE R8 K29 [PROTO_4]
  SETTABLEKS R8 R7 K30 ["configurationV2GET"]
  DUPCLOSURE R8 K31 [PROTO_5]
  SETTABLEKS R8 R7 K32 ["configurationV2PATCH"]
  DUPCLOSURE R8 K33 [PROTO_6]
  SETTABLEKS R8 R7 K34 ["permissionsV2GET"]
  DUPCLOSURE R8 K35 [PROTO_7]
  SETTABLEKS R8 R7 K36 ["permissionsBatchedV2POST"]
  DUPCLOSURE R8 K37 [PROTO_8]
  SETTABLEKS R8 R7 K38 ["permissionsBatchedV2DELETE"]
  DUPCLOSURE R8 K39 [PROTO_9]
  CAPTURE VAL R4
  SETTABLEKS R8 R7 K40 ["wwwSearchUsers"]
  DUPCLOSURE R8 K41 [PROTO_10]
  SETTABLEKS R8 R7 K42 ["apiGetByUsernameV1GET"]
  DUPCLOSURE R8 K43 [PROTO_11]
  SETTABLEKS R8 R7 K44 ["usersGetByUsernamesV1POST"]
  DUPCLOSURE R8 K45 [PROTO_12]
  CAPTURE VAL R4
  SETTABLEKS R8 R7 K46 ["searchGroupsV1GET"]
  DUPCLOSURE R8 K47 [PROTO_13]
  SETTABLEKS R8 R7 K48 ["isFriendsOnly"]
  DUPCLOSURE R8 K49 [PROTO_14]
  SETTABLEKS R8 R7 K50 ["setFriendsOnly"]
  DUPCLOSURE R8 K51 [PROTO_15]
  SETTABLEKS R8 R7 K52 ["isActive"]
  DUPCLOSURE R8 K53 [PROTO_16]
  SETTABLEKS R8 R7 K54 ["setActive"]
  DUPCLOSURE R8 K55 [PROTO_17]
  CAPTURE VAL R2
  SETTABLEKS R8 R7 K56 ["getPermissions"]
  DUPCLOSURE R8 K57 [PROTO_18]
  CAPTURE VAL R3
  SETTABLEKS R8 R7 K58 ["setPermissions"]
  DUPCLOSURE R8 K59 [PROTO_19]
  CAPTURE VAL R4
  CAPTURE VAL R6
  SETTABLEKS R8 R7 K60 ["searchUsers"]
  DUPCLOSURE R8 K61 [PROTO_20]
  CAPTURE VAL R4
  SETTABLEKS R8 R7 K62 ["searchGroups"]
  DUPCLOSURE R8 K63 [PROTO_21]
  CAPTURE VAL R5
  SETTABLEKS R8 R7 K64 ["creatorEligibilitiesPOST"]
  DUPCLOSURE R8 K65 [PROTO_22]
  CAPTURE VAL R4
  CAPTURE VAL R1
  SETTABLEKS R8 R7 K66 ["search"]
  DUPCLOSURE R8 K67 [PROTO_23]
  SETTABLEKS R8 R7 K68 ["guidelinesPOST"]
  DUPCLOSURE R8 K69 [PROTO_24]
  SETTABLEKS R8 R7 K70 ["getMinimumAgeRecommendation"]
  RETURN R7 1
