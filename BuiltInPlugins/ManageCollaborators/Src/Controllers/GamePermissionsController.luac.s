...
PROTO_18:
  ...
  MOVE R7 R1
  SETLIST R6 R7 1 [1]
  NAMECALL R4 R0 K14 ["usersGetByUsernamesV1POST"]
  CALL R4 2 1
  NAMECALL R4 R4 K1 ["await"]
  CALL R4 1 1
  GETTABLEKS R5 R4 K2 ["responseBody"]
  GETTABLEKS R6 R5 K15 ["responseCode"]
  JUMPIFEQKN R6 K16 [200] [+30]
  GETTABLEKS R6 R5 K17 ["errors"]
  JUMPIFNOT R6 [+21]
  GETTABLEKS R7 R5 K17 ["errors"]
  LENGTH R6 R7
  LOADN R7 0
  JUMPIFNOTLT R7 R6 [+16]
  GETIMPORT R6 K19 [error]
  LOADK R8 K20 ["Failed to find user"]
  GETTABLEKS R12 R5 K17 ["errors"]
  GETTABLEN R11 R12 1
  GETTABLEKS R10 R11 K21 ["message"]
  ...
  RETURN R6 -1
  GETIMPORT R6 K19 [error]
  LOADK R7 K20 ["Failed to find user"]
  CALL R6 1 -1
  RETURN R6 -1
  NEWTABLE R6 0 0
  GETIMPORT R7 K5 [pairs]
  GETTABLEKS R8 R5 K24 ["data"]
  CALL R7 1 3
  FORGPREP_NEXT R7
  NEWTABLE R14 2 0
  GETUPVAL R16 0
  GETTABLEKS R15 R16 K6 ["SubjectNameKey"]
  GETTABLEKS R16 R11 K25 ["name"]
  SETTABLE R16 R14 R15
  GETUPVAL R16 0
  GETTABLEKS R15 R16 K8 ["SubjectIdKey"]
  GETTABLEKS R16 R11 K26 ["id"]
  SETTABLE R16 R14 R15
...
MAIN:
  ...
  SETTABLEKS R7 R6 K22 ["universesV1GET"]
  DUPCLOSURE R7 K23 [PROTO_2]
  SETTABLEKS R7 R6 K24 ["universesActivateV1POST"]
  DUPCLOSURE R7 K25 [PROTO_3]
  SETTABLEKS R7 R6 K26 ["universesDeactivateV1POST"]
  DUPCLOSURE R7 K27 [PROTO_4]
  SETTABLEKS R7 R6 K28 ["configurationV2GET"]
  DUPCLOSURE R7 K29 [PROTO_5]
  SETTABLEKS R7 R6 K30 ["configurationV2PATCH"]
  DUPCLOSURE R7 K31 [PROTO_6]
  SETTABLEKS R7 R6 K32 ["permissionsV2GET"]
  DUPCLOSURE R7 K33 [PROTO_7]
  SETTABLEKS R7 R6 K34 ["permissionsBatchedV2POST"]
  DUPCLOSURE R7 K35 [PROTO_8]
  SETTABLEKS R7 R6 K36 ["permissionsBatchedV2DELETE"]
  DUPCLOSURE R7 K37 [PROTO_9]
  CAPTURE VAL R4
  SETTABLEKS R7 R6 K38 ["wwwSearchUsers"]
  DUPCLOSURE R7 K39 [PROTO_10]
  SETTABLEKS R7 R6 K40 ["usersGetByUsernamesV1POST"]
  DUPCLOSURE R7 K41 [PROTO_11]
  CAPTURE VAL R4
  SETTABLEKS R7 R6 K42 ["searchGroupsV1GET"]
  DUPCLOSURE R7 K43 [PROTO_12]
  SETTABLEKS R7 R6 K44 ["isFriendsOnly"]
  DUPCLOSURE R7 K45 [PROTO_13]
  SETTABLEKS R7 R6 K46 ["setFriendsOnly"]
  DUPCLOSURE R7 K47 [PROTO_14]
  SETTABLEKS R7 R6 K48 ["isActive"]
  DUPCLOSURE R7 K49 [PROTO_15]
  SETTABLEKS R7 R6 K50 ["setActive"]
  DUPCLOSURE R7 K51 [PROTO_16]
  CAPTURE VAL R2
  SETTABLEKS R7 R6 K52 ["getPermissions"]
  DUPCLOSURE R7 K53 [PROTO_17]
  CAPTURE VAL R3
  SETTABLEKS R7 R6 K54 ["setPermissions"]
  DUPCLOSURE R7 K55 [PROTO_18]
  CAPTURE VAL R4
  SETTABLEKS R7 R6 K56 ["searchUsers"]
  DUPCLOSURE R7 K57 [PROTO_19]
  CAPTURE VAL R4
  SETTABLEKS R7 R6 K58 ["searchGroups"]
  DUPCLOSURE R7 K59 [PROTO_20]
  CAPTURE VAL R5
  SETTABLEKS R7 R6 K60 ["creatorEligibilitiesPOST"]
  DUPCLOSURE R7 K61 [PROTO_21]
  CAPTURE VAL R4
  CAPTURE VAL R1
  SETTABLEKS R7 R6 K62 ["search"]
  DUPCLOSURE R7 K63 [PROTO_22]
  SETTABLEKS R7 R6 K64 ["guidelinesPOST"]
  DUPCLOSURE R7 K65 [PROTO_23]
  SETTABLEKS R7 R6 K66 ["getMinimumAgeRecommendation"]
  RETURN R6 1
