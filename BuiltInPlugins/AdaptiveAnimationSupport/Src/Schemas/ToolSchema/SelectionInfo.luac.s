PROTO_0:
        ...
        5 CALL                             R3 1 1
        6 JUMPIFNOTEQKS                    R3 K2 ["table"] ; [+3]
        8 GETTABLEKS                       R2 R2 K3 ["joint"]
       10 JUMPIFNOT                        R2 ; [+6]
       11 GETUPVAL                         R3 0
       12 GETTABLEKS                       R3 R3 K4 ["getGlobalCoordinateFrame"]
       14 MOVE                             R4 R2
       15 CALL                             R3 1 1
       16 JUMPIF                           R3 ; [+3]
       17 GETIMPORT                        R3 K7 [CFrame.new]
       19 CALL                             R3 0 1
       20 DUPTABLE                         R5 K10 [{"_selectionItem", "_draggerContext"}]
       21 DUPTABLE                         R6 K12 [{"joint", "Transform"}]
       22 SETTABLEKS                       R2 R6 K3 ["joint"]
       24 SETTABLEKS                       R3 R6 K11 ["Transform"]
       26 SETTABLEKS                       R6 R5 K8 ["_selectionItem"]
       28 SETTABLEKS                       R0 R5 K9 ["_draggerContext"]
       30 GETUPVAL                         R6 1
       31 FASTCALL2                        SETMETATABLE R5 R6 ; [+3]
       33 GETIMPORT                        R4 K14 [setmetatable]
       35 CALL                             R4 2 1
       36 GETUPVAL                         R5 2
       37 GETTABLEKS                       R5 R5 K6 ["new"]
       39 CALL                             R5 0 1
       40 SETTABLEKS                       R5 R4 K15 ["SelectionChanged"]
       42 RETURN                           R4 1
