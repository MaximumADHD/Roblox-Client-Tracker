...
PROTO_1:
  ...
  GETUPVAL R4 0
  GETTABLEKS R3 R4 K7 ["getGlobalCoordinateFrame"]
  GETTABLEKS R4 R0 K6 ["_initialJoint"]
  CALL R3 1 1
  SETTABLEKS R3 R0 K8 ["_initialWorldCFrame"]
  GETUPVAL R4 0
  GETTABLEKS R3 R4 K9 ["getJointTransform"]
  GETTABLEKS R4 R0 K6 ["_initialJoint"]
  CALL R3 1 1
  JUMPIF R3 [+2]
  GETIMPORT R3 K11 [CFrame.identity]
  SETTABLEKS R3 R0 K5 ["_initialTransform"]
  RETURN R0 0
...
PROTO_2:
  ...
  JUMPIF R2 [+1]
  RETURN R1 1
  GETTABLEKS R2 R0 K1 ["_applyJointTransform"]
  JUMPIFNOT R2 [+11]
  GETTABLEKS R2 R0 K1 ["_applyJointTransform"]
  GETTABLEKS R3 R0 K0 ["_initialJoint"]
  MOVE R4 R1
