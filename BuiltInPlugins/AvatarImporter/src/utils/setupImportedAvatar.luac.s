...
MAIN:
  ...
  GETTABLEKS R4 R5 K8 ["Globals"]
  CALL R3 1 1
  LOADNIL R4
  NAMECALL R5 R1 K9 ["isBundleConfigurationEnabled"]
  CALL R5 1 1
  JUMPIFNOT R5 [+36]
  ...
  CALL R6 1 1
  LOADK R7 K18 ["AvatarImporterConfigurer"]
  SETTABLEKS R7 R6 K19 ["Name"]
  SETTABLEKS R5 R6 K2 ["Parent"]
  GETIMPORT R7 K4 [require]
  GETTABLEKS R10 R0 K5 ["src"]
  GETTABLEKS R9 R10 K20 ["configurer"]
  GETTABLEKS R8 R9 K21 ["Configurer"]
  CALL R7 1 1
  GETTABLEKS R8 R7 K15 ["new"]
  MOVE R9 R6
  CALL R8 1 1
  MOVE R4 R8
  GETTABLEKS R10 R3 K22 ["plugin"]
  GETTABLEKS R11 R3 K23 ["toolbar"]
  NAMECALL R8 R4 K24 ["createButtons"]
  CALL R8 3 0
  GETIMPORT R5 K11 [game]
  LOADK R7 K25 ["Workspace"]
  NAMECALL R5 R5 K13 ["GetService"]
  CALL R5 2 1
  GETIMPORT R6 K11 [game]
  LOADK R8 K26 ["Selection"]
