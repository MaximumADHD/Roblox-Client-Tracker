...
PROTO_19:
  ...
  NAMECALL R21 R21 K14 ["GetAttribute"]
  CALL R21 2 1
  MUL R19 R20 R21
  ...
  MOVE R21 R20
  JUMPIFNOT R21 [+2]
  GETTABLEKS R21 R5 K43 ["hasChildren"]
  JUMPIFNOT R20 [+2]
  MOVE R22 R19
  JUMP [+1]
  LOADN R22 0
  ...
  GETTABLEKS R24 R7 K44 ["Actions"]
  JUMPIFNOT R24 [+88]
  ADD R22 R22 R9
  NEWTABLE R23 0 0
  GETIMPORT R24 K46 [ipairs]
  GETTABLEKS R25 R7 K44 ["Actions"]
  CALL R24 1 3
  FORGPREP_INEXT R24
  GETTABLEKS R29 R28 K47 ["Id"]
  GETUPVAL R32 3
  GETTABLEKS R31 R32 K48 ["LAYERVIEW_ACTIONS"]
  GETTABLEKS R30 R31 K49 ["NoOp"]
  JUMPIFNOTEQ R29 R30 [+20]
  LOADK R30 K50 ["Action "]
  MOVE R31 R27
  CONCAT R29 R30 R31
  GETUPVAL R31 4
  ...
  GETUPVAL R31 5
  NEWTABLE R32 2 0
  SETTABLEKS R27 R32 K52 ["LayoutOrder"]
  GETUPVAL R34 4
  GETTABLEKS R33 R34 K53 ["Tag"]
  LOADK R34 K54 ["ActionIcon"]
  ...
  GETIMPORT R33 K58 [UDim2.fromOffset]
  MOVE R34 R8
  MOVE R35 R8
  CALL R33 2 1
  ...
  LOADK R34 K54 ["ActionIcon"]
  SETTABLE R34 R32 R33
  DUPTABLE R33 K61 [{"Icon"}]
  GETUPVAL R35 4
  GETTABLEKS R34 R35 K51 ["createElement"]
  GETUPVAL R35 7
  DUPTABLE R36 K63 [{"Image"}]
  GETTABLEKS R37 R28 K60 ["Icon"]
  SETTABLEKS R37 R36 K62 ["Image"]
  CALL R34 2 1
  SETTABLEKS R34 R33 K60 ["Icon"]
  CALL R30 3 1
  SETTABLE R30 R23 R29
  ADD R29 R8 R9
  ADD R22 R22 R29
  ...
  CALL R25 4 1
  GETUPVAL R27 4
  GETTABLEKS R26 R27 K51 ["createElement"]
  GETUPVAL R27 5
  NEWTABLE R28 4 0
  LOADK R29 K65 ["Box"]
  SETTABLEKS R29 R28 K28 ["Style"]
  GETIMPORT R29 K64 [UDim2.new]
  GETTABLEKS R30 R4 K66 ["Scale"]
  GETTABLEKS R31 R4 K67 ["Offset"]
  LOADN R32 1
  LOADN R33 0
  CALL R29 4 1
  SETTABLEKS R29 R28 K40 ["Size"]
  GETUPVAL R31 4
  GETTABLEKS R30 R31 K68 ["Change"]
  GETTABLEKS R29 R30 K69 ["AbsoluteSize"]
  GETTABLEKS R30 R0 K70 ["onAbsoluteSizeChanged"]
  SETTABLE R30 R28 R29
  GETUPVAL R30 4
  GETTABLEKS R29 R30 K53 ["Tag"]
  GETUPVAL R30 8
  LOADK R31 K71 ["LayerViewCell"]
  GETTABLEKS R33 R5 K41 ["depth"]
  JUMPIFNOTEQKN R33 K72 [0] [+3]
  LOADK R32 K73 ["Section"]
  JUMP [+1]
  LOADNIL R32
  CALL R30 2 1
  SETTABLE R30 R28 R29
  DUPTABLE R29 K76 [{"Left", "Right"}]
  GETUPVAL R31 4
  GETTABLEKS R30 R31 K51 ["createElement"]
  GETUPVAL R31 5
  NEWTABLE R32 4 0
  GETTABLEKS R33 R1 K2 ["ColumnIndex"]
  SETTABLEKS R33 R32 K52 ["LayoutOrder"]
  ...
  JUMP [+1]
  LOADNIL R33
  SETTABLEKS R33 R32 K77 ["Position"]
  GETUPVAL R34 4
  GETTABLEKS R33 R34 K53 ["Tag"]
  LOADK R34 K78 ["X-RowS X-Middle"]
  SETTABLE R34 R32 R33
  DUPTABLE R33 K81 [{"Toggle", "Text"}]
  JUMPIFNOT R21 [+73]
  GETUPVAL R35 4
  GETTABLEKS R34 R35 K51 ["createElement"]
  GETUPVAL R35 5
  DUPTABLE R36 K83 [{"AutomaticSize", "LayoutOrder"}]
  GETIMPORT R37 K86 [Enum.AutomaticSize.XY]
  SETTABLEKS R37 R36 K82 ["AutomaticSize"]
  LOADN R37 1
  SETTABLEKS R37 R36 K52 ["LayoutOrder"]
  DUPTABLE R37 K61 [{"Icon"}]
  GETUPVAL R39 4
  GETTABLEKS R38 R39 K51 ["createElement"]
  LOADK R39 K87 ["ImageButton"]
  NEWTABLE R40 8 0
  GETIMPORT R41 K58 [UDim2.fromOffset]
  MOVE R42 R18
  MOVE R43 R18
  CALL R41 2 1
  SETTABLEKS R41 R40 K40 ["Size"]
  LOADN R41 1
  SETTABLEKS R41 R40 K88 ["BackgroundTransparency"]
  GETTABLEKS R42 R14 K39 ["Arrow"]
  GETTABLEKS R41 R42 K62 ["Image"]
  SETTABLEKS R41 R40 K62 ["Image"]
  GETTABLEKS R42 R14 K39 ["Arrow"]
  GETTABLEKS R41 R42 K89 ["Color"]
  SETTABLEKS R41 R40 K90 ["ImageColor3"]
  GETIMPORT R41 K92 [Vector2.new]
  MOVE R42 R18
  MOVE R43 R18
  CALL R41 2 1
  SETTABLEKS R41 R40 K93 ["ImageRectSize"]
  JUMPIFNOT R17 [+5]
  GETTABLEKS R42 R14 K39 ["Arrow"]
  GETTABLEKS R41 R42 K94 ["ExpandedOffset"]
  JUMP [+4]
  GETTABLEKS R42 R14 K39 ["Arrow"]
  GETTABLEKS R41 R42 K95 ["CollapsedOffset"]
  SETTABLEKS R41 R40 K96 ["ImageRectOffset"]
  GETUPVAL R43 4
  GETTABLEKS R42 R43 K97 ["Event"]
  GETTABLEKS R41 R42 K98 ["Activated"]
  GETTABLEKS R42 R0 K99 ["onToggle"]
  ...
  JUMP [+1]
  LOADNIL R34
  SETTABLEKS R34 R33 K79 ["Toggle"]
  JUMPIFNOT R11 [+26]
  GETTABLEKS R35 R7 K100 ["Disabled"]
  JUMPIF R35 [+23]
  GETTABLEKS R34 R0 K101 ["getPropertyCell"]
  DUPTABLE R35 K104 [{"OnDoubleClick", "OnPressed", "Schema", "Size", "Value"}]
  GETTABLEKS R36 R0 K105 ["onDoubleClick"]
  SETTABLEKS R36 R35 K102 ["OnDoubleClick"]
  GETTABLEKS R36 R0 K106 ["onPressed"]
  SETTABLEKS R36 R35 K103 ["OnPressed"]
  ...
  GETTABLEKS R34 R35 K51 ["createElement"]
  GETUPVAL R35 9
  DUPTABLE R36 K109 [{"LayoutOrder", "Size", "Position", "Text", "TextXAlignment", "ref"}]
  LOADN R37 3
  SETTABLEKS R37 R36 K52 ["LayoutOrder"]
  SETTABLEKS R25 R36 K40 ["Size"]
  GETIMPORT R37 K58 [UDim2.fromOffset]
  LOADN R38 5
  LOADN R39 0
  CALL R37 2 1
  SETTABLEKS R37 R36 K77 ["Position"]
  SETTABLEKS R10 R36 K80 ["Text"]
  GETIMPORT R37 K110 [Enum.TextXAlignment.Left]
  SETTABLEKS R37 R36 K107 ["TextXAlignment"]
  GETTABLEKS R37 R0 K111 ["textRef"]
  SETTABLEKS R37 R36 K108 ["ref"]
  CALL R34 2 1
  SETTABLEKS R34 R33 K80 ["Text"]
  CALL R30 3 1
  SETTABLEKS R30 R29 K74 ["Left"]
  JUMPIFNOT R23 [+34]
  GETUPVAL R31 4
  GETTABLEKS R30 R31 K51 ["createElement"]
  GETUPVAL R31 5
  NEWTABLE R32 4 0
  GETIMPORT R33 K92 [Vector2.new]
  LOADN R34 1
  LOADK R35 K112 [0.5]
  CALL R33 2 1
  SETTABLEKS R33 R32 K113 ["AnchorPoint"]
  GETIMPORT R33 K86 [Enum.AutomaticSize.XY]
  SETTABLEKS R33 R32 K82 ["AutomaticSize"]
  GETIMPORT R33 K64 [UDim2.new]
  LOADN R34 1
  LOADN R35 253
  LOADK R36 K112 [0.5]
  ...
  GETUPVAL R34 4
  GETTABLEKS R33 R34 K53 ["Tag"]
  LOADK R34 K114 ["X-RowS"]
  SETTABLE R34 R32 R33
  MOVE R33 R23
  CALL R30 3 1
  JUMP [+1]
  LOADNIL R30
  SETTABLEKS R30 R29 K75 ["Right"]
  CALL R26 3 -1
  RETURN R26 -1
