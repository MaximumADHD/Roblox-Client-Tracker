...
MAIN:
  ...
  CALL R10 1 1
  GETTABLEKS R11 R2 K24 ["copy"]
  GETTABLEKS R12 R3 K25 ["ContextServices"]
  GETTABLEKS R13 R12 K26 ["withContext"]
  GETTABLEKS R14 R3 K27 ["UI"]
  GETTABLEKS R15 R14 K28 ["Pane"]
  GETTABLEKS R17 R1 K17 ["Src"]
  GETTABLEKS R16 R17 K29 ["Actions"]
  GETIMPORT R17 K9 [require]
  GETTABLEKS R18 R16 K30 ["SetActiveLayersFilter"]
  CALL R17 1 1
  GETIMPORT R18 K9 [require]
  GETTABLEKS R19 R16 K31 ["SetHistoryField"]
  CALL R18 1 1
  GETIMPORT R19 K9 [require]
  GETTABLEKS R20 R16 K32 ["SetLayerFilter"]
  CALL R19 1 1
  ...
  GETTABLEKS R29 R26 K40 ["Constants"]
  CALL R28 1 1
  ...
  CALL R34 1 1
  GETTABLEKS R35 R4 K47 ["PureComponent"]
  LOADK R37 K48 ["MainComponent"]
  NAMECALL R35 R35 K49 ["extend"]
  CALL R35 2 1
  MOVE R37 R8
  CALL R37 0 1
  JUMPIFNOT R37 [+3]
  GETTABLEKS R36 R9 K50 ["Context"]
  JUMP [+1]
  LOADNIL R36
  SETTABLEKS R36 R35 K51 ["contextType"]
  DUPCLOSURE R36 K52 [PROTO_1]
  SETTABLEKS R36 R35 K53 ["init"]
  DUPCLOSURE R36 K54 [PROTO_2]
  CAPTURE VAL R28
  SETTABLEKS R36 R35 K55 ["readSettings"]
  DUPCLOSURE R36 K56 [PROTO_3]
  CAPTURE VAL R7
  CAPTURE VAL R0
  CAPTURE VAL R27
  CAPTURE VAL R26
  SETTABLEKS R36 R35 K57 ["didMount"]
  DUPCLOSURE R36 K58 [PROTO_4]
  SETTABLEKS R36 R35 K59 ["willUnmount"]
  DUPCLOSURE R36 K60 [PROTO_5]
  CAPTURE VAL R34
  CAPTURE VAL R11
  CAPTURE VAL R4
  CAPTURE VAL R15
  ...
  CAPTURE VAL R22
  CAPTURE VAL R27
  SETTABLEKS R36 R35 K61 ["render"]
  MOVE R36 R13
  DUPTABLE R37 K64 [{"Analytics", "Plugin"}]
  GETTABLEKS R38 R12 K62 ["Analytics"]
  SETTABLEKS R38 R37 K62 ["Analytics"]
  GETTABLEKS R38 R12 K63 ["Plugin"]
  SETTABLEKS R38 R37 K63 ["Plugin"]
  CALL R36 1 1
  MOVE R37 R35
  CALL R36 1 1
  MOVE R35 R36
  DUPCLOSURE R36 K65 [PROTO_6]
  DUPCLOSURE R37 K66 [PROTO_13]
  CAPTURE VAL R30
  CAPTURE VAL R17
  CAPTURE VAL R31
  CAPTURE VAL R18
