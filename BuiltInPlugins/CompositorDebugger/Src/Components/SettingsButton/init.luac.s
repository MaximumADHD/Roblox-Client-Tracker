...
MAIN:
  ...
  MOVE R16 R5
  DUPTABLE R17 K33 [{"Analytics", "Localization", "Plugin", "Stylizer"}]
  ...
  GETTABLEKS R19 R3 K12 ["Style"]
  GETTABLEKS R18 R19 K13 ["Stylizer"]
  SETTABLEKS R18 R17 K13 ["Stylizer"]
  CALL R16 1 1
  MOVE R17 R15
  CALL R16 1 1
  MOVE R15 R16
  DUPCLOSURE R16 K34 [PROTO_5]
  DUPCLOSURE R17 K35 [PROTO_8]
  CAPTURE VAL R8
  CAPTURE VAL R9
