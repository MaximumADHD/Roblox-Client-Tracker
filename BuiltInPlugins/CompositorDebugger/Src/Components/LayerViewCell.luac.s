...
PROTO_14:
  ...
  LOADN R7 0
  CALL R5 2 1
  GETTABLEKS R6 R1 K10 ["Row"]
  GETTABLEKS R7 R1 K11 ["CellProps"]
  GETTABLEKS R9 R6 K12 ["item"]
  GETTABLE R8 R9 R4
  LOADNIL R9
  LOADNIL R10
  LOADB R11 0
  ...
  MOVE R13 R8
  GETIMPORT R12 K14 [typeof]
  CALL R12 1 1
  JUMPIFNOTEQKS R12 K15 ["table"] [+15]
  GETTABLEKS R13 R8 K16 ["Value"]
  FASTCALL1 TOSTRING R13 [+2]
  GETIMPORT R12 K18 [tostring]
  CALL R12 1 1
  MOVE R9 R12
  GETTABLEKS R10 R8 K19 ["LeftIcon"]
  GETTABLEKS R12 R8 K20 ["Schema"]
  JUMPIFNOT R12 [+8]
  LOADB R11 1
  JUMP [+6]
  ...
  CALL R12 1 1
  MOVE R9 R12
  GETTABLEKS R13 R1 K21 ["Tooltip"]
  OR R12 R13 R9
  LOADB R13 0
  JUMPIFEQKNIL R12 [+12]
  LOADB R13 0
  JUMPIFEQKS R12 K22 [""] [+9]
  GETTABLEKS R14 R0 K23 ["state"]
  GETTABLEKS R13 R14 K24 ["textOverflows"]
  JUMPIFNOT R13 [+3]
  GETTABLEKS R14 R7 K25 ["DisableTooltip"]
  NOT R13 R14
  GETUPVAL R14 0
  GETTABLEKS R15 R1 K26 ["Style"]
  GETTABLEKS R16 R7 K27 ["CellStyle"]
  CALL R14 2 1
  GETTABLEKS R17 R1 K29 ["RowIndex"]
  MODK R16 R17 K28 [2]
  JUMPIFNOTEQKN R16 K30 [1] [+4]
  ...
  JUMPIFNOT R17 [+19]
  GETTABLEKS R19 R1 K29 ["RowIndex"]
  MODK R18 R19 K28 [2]
  JUMPIFNOTEQKN R18 K30 [1] [+8]
  GETUPVAL R20 1
  ...
  FASTCALL1 TYPEOF R8 [+3]
  MOVE R27 R8
  GETIMPORT R26 K14 [typeof]
  CALL R26 1 1
  JUMPIFNOTEQKS R26 K15 ["table"] [+109]
  ...
  GETTABLEKS R31 R30 K54 ["Id"]
  JUMP [+3]
  LOADK R32 K63 ["Action"]
  MOVE R33 R29
  CONCAT R31 R32 R33
  GETUPVAL R33 3
  GETTABLEKS R32 R33 K58 ["createElement"]
  LOADK R33 K64 ["ImageButton"]
  NEWTABLE R34 8 0
  GETTABLEKS R36 R30 K62 ["Icon"]
  GETTABLEKS R35 R36 K39 ["Size"]
  SETTABLEKS R35 R34 K39 ["Size"]
  ...
  SETTABLEKS R35 R34 K60 ["BackgroundTransparency"]
  GETTABLEKS R36 R30 K62 ["Icon"]
  GETTABLEKS R35 R36 K65 ["Image"]
  SETTABLEKS R35 R34 K65 ["Image"]
  GETTABLEKS R35 R14 K66 ["Text"]
  SETTABLEKS R35 R34 K67 ["ImageColor3"]
  GETUPVAL R37 3
  GETTABLEKS R36 R37 K68 ["Event"]
  GETTABLEKS R35 R36 K69 ["Activated"]
  NEWCLOSURE R36 P0
  CAPTURE VAL R7
  CAPTURE VAL R30
  CAPTURE VAL R6
  ...
  GETTABLEKS R33 R34 K70 ["X"]
  GETTABLEKS R32 R33 K71 ["Offset"]
  GETTABLEKS R33 R14 K51 ["CellSpacing"]
  ADD R31 R32 R33
  ADD R24 R24 R31
  FORGLOOP R26 2 [inext] [-93]
  LOADN R26 0
  JUMPIFNOT R10 [+10]
  GETTABLEKS R28 R14 K51 ["CellSpacing"]
  GETTABLEKS R31 R10 K39 ["Size"]
  GETTABLEKS R30 R31 K70 ["X"]
  GETTABLEKS R29 R30 K71 ["Offset"]
  ADD R27 R28 R29
  ADD R26 R26 R27
  JUMPIFNOT R23 [+4]
  GETTABLEKS R28 R14 K51 ["CellSpacing"]
  ...
  NEWTABLE R30 8 0
  LOADK R31 K74 ["Box"]
  SETTABLEKS R31 R30 K26 ["Style"]
  SETTABLEKS R16 R30 K75 ["BackgroundColor3"]
  LOADN R31 1
  SETTABLEKS R31 R30 K76 ["BorderSizePixel"]
  GETTABLEKS R31 R14 K77 ["Border"]
  SETTABLEKS R31 R30 K78 ["BorderColor3"]
  GETIMPORT R31 K73 [UDim2.new]
  GETTABLEKS R32 R5 K79 ["Scale"]
  GETTABLEKS R33 R5 K71 ["Offset"]
  LOADN R34 1
  LOADN R35 0
  CALL R31 4 1
  SETTABLEKS R31 R30 K39 ["Size"]
  GETUPVAL R33 3
  GETTABLEKS R32 R33 K80 ["Change"]
  GETTABLEKS R31 R32 K81 ["AbsoluteSize"]
  GETTABLEKS R32 R0 K82 ["onAbsoluteSizeChanged"]
  SETTABLE R32 R30 R31
  LOADB R31 1
  SETTABLEKS R31 R30 K83 ["ClipsDescendants"]
  DUPTABLE R31 K84 [{"Tooltip", "Left", "Right"}]
  MOVE R32 R13
  JUMPIFNOT R32 [+18]
  GETUPVAL R33 3
  GETTABLEKS R32 R33 K58 ["createElement"]
  GETUPVAL R33 6
  DUPTABLE R34 K87 [{"MaxWidth", "Text", "TextXAlignment"}]
  GETTABLEKS R36 R14 K21 ["Tooltip"]
  GETTABLEKS R35 R36 K85 ["MaxWidth"]
  SETTABLEKS R35 R34 K85 ["MaxWidth"]
  SETTABLEKS R12 R34 K66 ["Text"]
  GETIMPORT R35 K89 [Enum.TextXAlignment.Left]
  SETTABLEKS R35 R34 K86 ["TextXAlignment"]
  CALL R32 2 1
  SETTABLEKS R32 R31 K21 ["Tooltip"]
  GETUPVAL R33 3
  GETTABLEKS R32 R33 K58 ["createElement"]
  GETUPVAL R33 4
  DUPTABLE R34 K95 [{"Layout", "LayoutOrder", "Padding", "Spacing", "HorizontalAlignment", "VerticalAlignment", "Size"}]
  GETIMPORT R35 K98 [Enum.FillDirection.Horizontal]
  SETTABLEKS R35 R34 K90 ["Layout"]
  GETTABLEKS R35 R1 K3 ["ColumnIndex"]
  SETTABLEKS R35 R34 K59 ["LayoutOrder"]
  SETTABLEKS R22 R34 K91 ["Padding"]
  GETTABLEKS R35 R14 K51 ["CellSpacing"]
  SETTABLEKS R35 R34 K92 ["Spacing"]
  GETIMPORT R35 K99 [Enum.HorizontalAlignment.Left]
  SETTABLEKS R35 R34 K93 ["HorizontalAlignment"]
  GETIMPORT R35 K101 [Enum.VerticalAlignment.Center]
  SETTABLEKS R35 R34 K94 ["VerticalAlignment"]
  GETIMPORT R35 K73 [UDim2.new]
  LOADN R36 1
  MINUS R37 R24
  LOADN R38 1
  LOADN R39 0
  CALL R35 4 1
  SETTABLEKS R35 R34 K39 ["Size"]
  DUPTABLE R35 K103 [{"Toggle", "LeftIcon", "Text"}]
  JUMPIFNOT R23 [+73]
  GETUPVAL R37 3
  GETTABLEKS R36 R37 K58 ["createElement"]
  GETUPVAL R37 4
  DUPTABLE R38 K105 [{"AutomaticSize", "LayoutOrder"}]
  GETIMPORT R39 K107 [Enum.AutomaticSize.XY]
  SETTABLEKS R39 R38 K104 ["AutomaticSize"]
  LOADN R39 1
  SETTABLEKS R39 R38 K59 ["LayoutOrder"]
  DUPTABLE R39 K108 [{"Icon"}]
  GETUPVAL R41 3
  GETTABLEKS R40 R41 K58 ["createElement"]
  LOADK R41 K64 ["ImageButton"]
  NEWTABLE R42 8 0
  GETIMPORT R43 K110 [UDim2.fromOffset]
  MOVE R44 R18
  MOVE R45 R18
  CALL R43 2 1
  ...
  GETTABLEKS R43 R44 K65 ["Image"]
  SETTABLEKS R43 R42 K65 ["Image"]
  GETTABLEKS R44 R14 K38 ["Arrow"]
  GETTABLEKS R43 R44 K111 ["Color"]
  SETTABLEKS R43 R42 K67 ["ImageColor3"]
  GETIMPORT R43 K113 [Vector2.new]
  MOVE R44 R18
  MOVE R45 R18
  CALL R43 2 1
  SETTABLEKS R43 R42 K114 ["ImageRectSize"]
  JUMPIFNOT R17 [+5]
  GETTABLEKS R44 R14 K38 ["Arrow"]
  GETTABLEKS R43 R44 K115 ["ExpandedOffset"]
  JUMP [+4]
  GETTABLEKS R44 R14 K38 ["Arrow"]
  GETTABLEKS R43 R44 K116 ["CollapsedOffset"]
  SETTABLEKS R43 R42 K117 ["ImageRectOffset"]
  GETUPVAL R45 3
  GETTABLEKS R44 R45 K68 ["Event"]
  GETTABLEKS R43 R44 K69 ["Activated"]
  ...
  JUMP [+1]
  LOADNIL R36
  SETTABLEKS R36 R35 K102 ["Toggle"]
  JUMPIFNOT R10 [+13]
  GETUPVAL R37 3
  GETTABLEKS R36 R37 K58 ["createElement"]
  GETUPVAL R37 7
  GETUPVAL R38 0
  DUPTABLE R39 K119 [{"LayoutOrder"}]
  LOADN R40 2
  ...
  JUMPIFNOT R11 [+26]
  GETTABLEKS R37 R8 K120 ["Disabled"]
  JUMPIF R37 [+23]
  GETTABLEKS R36 R0 K121 ["getPropertyCell"]
  DUPTABLE R37 K124 [{"OnDoubleClick", "OnPressed", "Schema", "Size", "Value"}]
  GETTABLEKS R38 R0 K125 ["onDoubleClick"]
  SETTABLEKS R38 R37 K122 ["OnDoubleClick"]
  GETTABLEKS R38 R0 K126 ["onPressed"]
  SETTABLEKS R38 R37 K123 ["OnPressed"]
  GETTABLEKS R38 R8 K20 ["Schema"]
  SETTABLEKS R38 R37 K20 ["Schema"]
  SETTABLEKS R27 R37 K39 ["Size"]
  GETTABLEKS R38 R8 K16 ["Value"]
  SETTABLEKS R38 R37 K16 ["Value"]
  CALL R36 1 1
  JUMP [+6]
  GETTABLEKS R36 R0 K127 ["getTextElement"]
  MOVE R37 R1
  MOVE R38 R9
  MOVE R39 R27
  CALL R36 3 1
  ...
  GETTABLEKS R32 R33 K58 ["createElement"]
  GETUPVAL R33 4
  DUPTABLE R34 K130 [{"AnchorPoint", "AutomaticSize", "Layout", "VerticalAlignment", "Position", "Spacing"}]
  GETIMPORT R35 K113 [Vector2.new]
  LOADN R36 1
  LOADK R37 K131 [0.5]
  CALL R35 2 1
  SETTABLEKS R35 R34 K128 ["AnchorPoint"]
  GETIMPORT R35 K107 [Enum.AutomaticSize.XY]
  SETTABLEKS R35 R34 K104 ["AutomaticSize"]
  GETIMPORT R35 K98 [Enum.FillDirection.Horizontal]
  SETTABLEKS R35 R34 K90 ["Layout"]
  GETIMPORT R35 K101 [Enum.VerticalAlignment.Center]
  SETTABLEKS R35 R34 K94 ["VerticalAlignment"]
  ...
  LOADN R39 0
  CALL R35 4 1
  SETTABLEKS R35 R34 K129 ["Position"]
  GETTABLEKS R35 R14 K51 ["CellSpacing"]
  SETTABLEKS R35 R34 K92 ["Spacing"]
  MOVE R35 R25
  CALL R32 3 1
...
MAIN:
  ...
  GETTABLEKS R20 R0 K26 ["LuaFlags"]
  GETTABLEKS R19 R20 K27 ["GetFFlagTestRefactoring"]
  CALL R18 1 1
  GETTABLEKS R19 R1 K28 ["PureComponent"]
  LOADK R21 K29 ["LayerViewCell"]
  ...
  SETTABLEKS R20 R19 K34 ["didUpdate"]
