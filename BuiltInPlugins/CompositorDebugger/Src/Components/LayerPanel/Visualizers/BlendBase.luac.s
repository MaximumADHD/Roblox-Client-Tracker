...
PROTO_4:
  ...
  LOADN R13 1
  GETTABLEKS R14 R9 K8 ["Y"]
  SUB R12 R13 R14
  CALL R10 2 1
  GETTABLEKS R12 R2 K23 ["min"]
  GETTABLEKS R15 R2 K24 ["max"]
  GETTABLEKS R16 R2 K23 ["min"]
  SUB R14 R15 R16
  MUL R13 R10 R14
  ADD R11 R12 R13
  GETTABLEKS R12 R1 K25 ["SetOverride"]
  GETTABLEKS R13 R3 K26 ["id"]
  LOADK R14 K27 ["targetPosition"]
  GETUPVAL R18 0
...
PROTO_11:
  ...
  LOADN R22 1
  GETTABLEKS R23 R15 K31 ["Y"]
  SUB R21 R22 R23
  CALL R19 2 1
  SETTABLEKS R19 R18 K19 ["Position"]
  GETIMPORT R19 K34 [Vector2.new]
  LOADK R20 K35 [0.5]
  LOADK R21 K35 [0.5]
  CALL R19 2 1
  ...
  GETTABLEKS R20 R3 K26 ["Dot"]
  GETTABLEKS R19 R20 K36 ["Color"]
  SETTABLEKS R19 R18 K23 ["ImageColor3"]
  LOADN R19 3
  SETTABLEKS R19 R18 K24 ["ZIndex"]
  DUPTABLE R19 K38 [{"Tooltip"}]
  JUMPIF R5 [+15]
  GETUPVAL R21 0
  GETTABLEKS R20 R21 K15 ["createElement"]
  GETUPVAL R21 1
  DUPTABLE R22 K40 [{"Text"}]
  GETTABLEKS R23 R0 K41 ["makeTooltipText"]
  ...
  JUMP [+1]
  LOADNIL R20
  SETTABLEKS R20 R19 K37 ["Tooltip"]
  CALL R16 3 1
  SETTABLE R16 R6 R12
  FORGLOOP R7 2 [-107]
  ...
  GETTABLEKS R7 R8 K42 ["targetPosition"]
  JUMPIFNOT R7 [+135]
  GETTABLEKS R8 R1 K43 ["Overrides"]
  JUMPIFNOT R8 [+5]
  GETTABLEKS R8 R1 K43 ["Overrides"]
  GETTABLEKS R7 R8 K42 ["targetPosition"]
  JUMPIF R7 [+1]
  ...
  GETTABLEKS R8 R9 K42 ["targetPosition"]
  ...
  JUMPIFNOT R7 [+5]
  GETTABLEKS R15 R3 K44 ["Cursor"]
  GETTABLEKS R14 R15 K45 ["Override"]
  JUMP [+4]
  GETTABLEKS R15 R3 K44 ["Cursor"]
  ...
  GETTABLEKS R14 R0 K46 ["cursor"]
  SETTABLEKS R14 R13 K47 ["ref"]
  GETUPVAL R16 0
  GETTABLEKS R15 R16 K48 ["Event"]
  GETTABLEKS R14 R15 K49 ["InputBegan"]
  GETTABLEKS R15 R0 K50 ["onDragStarted"]
  SETTABLE R15 R13 R14
  JUMPIFNOT R5 [+33]
  DUPTABLE R14 K52 [{"DragListener", "Tooltip"}]
  GETUPVAL R16 0
  GETTABLEKS R15 R16 K15 ["createElement"]
  GETUPVAL R16 2
  DUPTABLE R17 K55 [{"OnDragMoved", "OnDragEnded"}]
  GETTABLEKS R18 R0 K56 ["onDragMoved"]
  SETTABLEKS R18 R17 K53 ["OnDragMoved"]
  GETTABLEKS R18 R0 K57 ["onDragEnded"]
  SETTABLEKS R18 R17 K54 ["OnDragEnded"]
  CALL R15 2 1
  SETTABLEKS R15 R14 K51 ["DragListener"]
  GETUPVAL R16 0
  GETTABLEKS R15 R16 K15 ["createElement"]
  GETUPVAL R16 3
  DUPTABLE R17 K40 [{"Text"}]
  GETTABLEKS R18 R0 K41 ["makeTooltipText"]
  LOADNIL R19
  MOVE R20 R9
  CALL R18 2 1
  SETTABLEKS R18 R17 K39 ["Text"]
  CALL R15 2 1
  SETTABLEKS R15 R14 K37 ["Tooltip"]
  JUMP [+1]
  LOADNIL R14
  CALL R11 3 1
  SETTABLEKS R11 R6 K46 ["cursor"]
  RETURN R6 1
...
PROTO_12:
  ...
  LOADN R17 0
  LOADN R19 1
  GETTABLEKS R23 R2 K28 ["min"]
  GETTABLEKS R22 R23 K6 ["Y"]
  SUB R21 R11 R22
  GETTABLEKS R24 R2 K29 ["max"]
  GETTABLEKS R23 R24 K6 ["Y"]
  GETTABLEKS R25 R2 K28 ["min"]
  GETTABLEKS R24 R25 K6 ["Y"]
  SUB R22 R23 R24
  DIV R20 R21 R22
  SUB R18 R19 R20
  CALL R16 2 1
...
MAIN:
  ...
  LOADK R21 K28 ["CDFixVector3TargetPosition"]
  LOADB R22 0
  NAMECALL R19 R19 K29 ["DefineFastFlag"]
  CALL R19 3 1
  GETTABLEKS R20 R1 K30 ["PureComponent"]
  LOADK R22 K31 ["BlendBase"]
  NAMECALL R20 R20 K32 ["extend"]
  CALL R20 2 1
  DUPCLOSURE R21 K33 [PROTO_0]
  DUPCLOSURE R22 K34 [PROTO_10]
  CAPTURE VAL R1
  CAPTURE VAL R19
  CAPTURE VAL R17
  SETTABLEKS R22 R20 K35 ["init"]
  DUPCLOSURE R22 K36 [PROTO_11]
  CAPTURE VAL R1
  CAPTURE VAL R10
  CAPTURE VAL R11
  CAPTURE VAL R13
  SETTABLEKS R22 R20 K37 ["createDots"]
  DUPCLOSURE R22 K38 [PROTO_12]
  CAPTURE VAL R1
  CAPTURE VAL R9
  SETTABLEKS R22 R20 K39 ["createAxes"]
  DUPCLOSURE R22 K40 [PROTO_13]
  SETTABLEKS R22 R20 K41 ["calculateExtents"]
  DUPCLOSURE R22 K42 [PROTO_14]
  SETTABLEKS R22 R20 K43 ["didUpdate"]
  DUPCLOSURE R22 K44 [PROTO_15]
  SETTABLEKS R22 R20 K45 ["didMount"]
  DUPCLOSURE R22 K46 [PROTO_16]
  CAPTURE VAL R1
  CAPTURE VAL R9
  SETTABLEKS R22 R20 K47 ["render"]
  MOVE R22 R5
  DUPTABLE R23 K48 [{"Analytics", "Localization"}]
