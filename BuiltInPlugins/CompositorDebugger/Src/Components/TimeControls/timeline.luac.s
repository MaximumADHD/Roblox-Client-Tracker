...
PROTO_6:
  ...
  DIV R14 R11 R4
  SUBRK R13 R12 K14 ["tostring"]
  LOADK R15 K13 ["Tick_"]
  FASTCALL1 TOSTRING R11 [+3]
  MOVE R17 R11
  GETIMPORT R16 K15 [tostring]
  CALL R16 1 1
  CONCAT R14 R15 R16
  GETUPVAL R16 1
  GETTABLEKS R15 R16 K16 ["createElement"]
  GETUPVAL R16 2
  DUPTABLE R17 K23 [{"ZIndex", "Position", "Tick", "Color", "Width", "Height", "TextAlignment"}]
  LOADN R18 1
  ...
  GETTABLEKS R18 R19 K19 ["Color"]
  SETTABLEKS R18 R17 K19 ["Color"]
  GETTABLEKS R18 R12 K20 ["Width"]
  SETTABLEKS R18 R17 K20 ["Width"]
  GETTABLEKS R18 R12 K21 ["Height"]
  SETTABLEKS R18 R17 K21 ["Height"]
  GETTABLEKS R18 R12 K22 ["TextAlignment"]
  SETTABLEKS R18 R17 K22 ["TextAlignment"]
  CALL R15 2 1
  SETTABLE R15 R1 R14
  FORNLOOP R9
  RETURN R0 0
