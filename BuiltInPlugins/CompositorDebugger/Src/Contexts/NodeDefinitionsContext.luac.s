...
MAIN:
  ...
  CALL R4 1 1
  NEWTABLE R5 8 0
  GETIMPORT R6 K17 [Enum.AnimationNodeType.AddNode]
  LOADB R7 1
  SETTABLE R7 R5 R6
  GETIMPORT R6 K19 [Enum.AnimationNodeType.BlendNode]
  LOADB R7 1
  SETTABLE R7 R5 R6
  GETIMPORT R6 K21 [Enum.AnimationNodeType.ClipNode]
  LOADB R7 1
  SETTABLE R7 R5 R6
  GETIMPORT R6 K23 [Enum.AnimationNodeType.SelectNode]
  LOADB R7 1
  SETTABLE R7 R5 R6
  GETIMPORT R6 K25 [Enum.AnimationNodeType.SubtractNode]
  LOADB R7 1
  SETTABLE R7 R5 R6
  ...
  CAPTURE VAL R5
  CAPTURE VAL R2
  DUPTABLE R7 K28 [{"nodeGroups"}]
  MOVE R8 R6
  CALL R8 0 1
  SETTABLEKS R8 R7 K27 ["nodeGroups"]
  GETTABLEKS R8 R3 K29 ["createContext"]
  MOVE R9 R7
  CALL R8 1 1
  ...
  CAPTURE VAL R3
  CAPTURE VAL R8
  DUPTABLE R10 K33 [{"Context", "Provider"}]
  SETTABLEKS R8 R10 K31 ["Context"]
  SETTABLEKS R9 R10 K32 ["Provider"]
  RETURN R10 1
