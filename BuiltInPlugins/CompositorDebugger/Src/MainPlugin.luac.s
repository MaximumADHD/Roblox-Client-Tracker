...
PROTO_8:
  ...
  GETUPVAL R19 10
  GETTABLEKS R18 R19 K58 ["Provider"]
  CALL R17 1 1
  GETUPVAL R19 4
  GETTABLEKS R18 R19 K13 ["createElement"]
  GETUPVAL R20 11
  GETTABLEKS R19 R20 K58 ["Provider"]
  CALL R18 1 1
  GETUPVAL R20 4
  ...
  GETUPVAL R22 13
  GETTABLEKS R21 R22 K58 ["Provider"]
  CALL R20 1 -1
  SETLIST R15 R16 -1 [1]
  SETTABLEKS R15 R14 K45 ["providers"]
  DUPTABLE R15 K59 [{"MainComponent"}]
  MOVE R16 R4
  JUMPIFNOT R16 [+5]
  GETUPVAL R17 4
  GETTABLEKS R16 R17 K13 ["createElement"]
...
MAIN:
  ...
  GETTABLEKS R7 R8 K15 ["DockWidget"]
