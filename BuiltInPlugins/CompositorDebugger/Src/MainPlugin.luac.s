...
MAIN:
  ...
  GETTABLEKS R23 R24 K37 ["getFFlagCompositorNodeView"]
  CALL R22 1 1
  GETIMPORT R23 K5 [require]
  GETTABLEKS R26 R0 K6 ["Src"]
  GETTABLEKS R25 R26 K38 ["Contexts"]
  GETTABLEKS R24 R25 K39 ["DebuggerViewModeContext"]
  CALL R23 1 1
  GETIMPORT R24 K5 [require]
  GETTABLEKS R27 R0 K6 ["Src"]
  GETTABLEKS R26 R27 K38 ["Contexts"]
  GETTABLEKS R25 R26 K40 ["NodeDefinitionsContext"]
  CALL R24 1 1
  GETTABLEKS R25 R2 K41 ["PureComponent"]
  ...
  CAPTURE VAL R22
  CAPTURE VAL R21
  SETTABLEKS R26 R25 K47 ["didUpdate"]
  DUPCLOSURE R26 K48 [PROTO_8]
  CAPTURE VAL R8
  CAPTURE VAL R9
  CAPTURE VAL R10
  CAPTURE VAL R11
