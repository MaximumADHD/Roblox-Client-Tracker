...
PROTO_8:
  ...
  DUPTABLE R11 K43 [{"DEPRECATED_MainComponent", "MainComponent", "StyleLink"}]
  GETUPVAL R13 6
  CALL R13 0 1
  JUMPIF R13 [+8]
  MOVE R12 R4
  ...
  JUMP [+1]
  LOADNIL R12
  SETTABLEKS R12 R11 K40 ["DEPRECATED_MainComponent"]
  GETUPVAL R13 6
  CALL R13 0 1
  JUMPIFNOT R13 [+114]
  GETUPVAL R13 4
  GETTABLEKS R12 R13 K13 ["createElement"]
  GETUPVAL R14 8
  GETTABLEKS R13 R14 K44 ["ContextStack"]
  DUPTABLE R14 K46 [{"providers"}]
  NEWTABLE R15 0 8
  GETUPVAL R17 4
  GETTABLEKS R16 R17 K13 ["createElement"]
  GETUPVAL R18 9
  GETTABLEKS R17 R18 K47 ["FoundationProvider"]
  DUPTABLE R18 K52 [{"theme", "device", "derives", "overlayGui"}]
  GETUPVAL R22 9
  GETTABLEKS R21 R22 K53 ["Enums"]
  GETTABLEKS R20 R21 K54 ["Theme"]
  GETTABLEKS R19 R20 K55 ["Dark"]
  SETTABLEKS R19 R18 K48 ["theme"]
  LOADK R19 K56 ["Desktop"]
  SETTABLEKS R19 R18 K49 ["device"]
  NEWTABLE R19 0 1
  GETTABLEKS R20 R0 K57 ["design"]
  SETLIST R19 R20 1 [1]
  SETTABLEKS R19 R18 K50 ["derives"]
  GETTABLEKS R20 R1 K33 ["PluginLoaderContext"]
  GETTABLEKS R19 R20 K34 ["mainDockWidget"]
  SETTABLEKS R19 R18 K51 ["overlayGui"]
  CALL R16 2 1
  GETUPVAL R18 4
  GETTABLEKS R17 R18 K13 ["createElement"]
  GETUPVAL R20 10
  GETTABLEKS R19 R20 K58 ["NetworkingContext"]
  GETTABLEKS R18 R19 K59 ["EditableDataModelProvider"]
  CALL R17 1 1
  GETUPVAL R19 4
  GETTABLEKS R18 R19 K13 ["createElement"]
  GETUPVAL R21 10
  GETTABLEKS R20 R21 K60 ["PlayStateContext"]
  GETTABLEKS R19 R20 K61 ["UIDataModelProvider"]
  CALL R18 1 1
  GETUPVAL R20 4
  GETTABLEKS R19 R20 K13 ["createElement"]
  GETUPVAL R21 11
  GETTABLEKS R20 R21 K62 ["Provider"]
  CALL R19 1 1
  GETUPVAL R21 4
  GETTABLEKS R20 R21 K13 ["createElement"]
  GETUPVAL R22 12
  GETTABLEKS R21 R22 K62 ["Provider"]
  CALL R20 1 1
  GETUPVAL R22 4
  ...
  GETUPVAL R24 14
  GETTABLEKS R23 R24 K62 ["Provider"]
  CALL R22 1 1
  GETUPVAL R24 4
  GETTABLEKS R23 R24 K13 ["createElement"]
  GETUPVAL R26 10
  GETTABLEKS R25 R26 K63 ["AnimationPreviewContext"]
  GETTABLEKS R24 R25 K59 ["EditableDataModelProvider"]
  CALL R23 1 -1
  SETLIST R15 R16 -1 [1]
  SETTABLEKS R15 R14 K45 ["providers"]
  DUPTABLE R15 K64 [{"MainComponent"}]
  MOVE R16 R4
  JUMPIFNOT R16 [+5]
  GETUPVAL R17 4
  GETTABLEKS R16 R17 K13 ["createElement"]
  GETUPVAL R17 7
  CALL R16 1 1
  SETTABLEKS R16 R15 K41 ["MainComponent"]
  CALL R12 3 1
  JUMP [+1]
  LOADNIL R12
  ...
  DUPTABLE R14 K66 [{"StyleSheet"}]
  GETTABLEKS R15 R0 K57 ["design"]
  SETTABLEKS R15 R14 K65 ["StyleSheet"]
  CALL R12 2 1
...
MAIN:
  ...
  CALL R26 1 1
  GETTABLEKS R27 R4 K43 ["PureComponent"]
  LOADK R29 K44 ["MainPlugin"]
  ...
  CAPTURE VAL R23
  CAPTURE VAL R21
  SETTABLEKS R28 R27 K49 ["didUpdate"]
