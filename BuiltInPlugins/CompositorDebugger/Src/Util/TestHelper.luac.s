...
MAIN:
  ...
  CAPTURE VAL R6
  CAPTURE VAL R7
  SETTABLEKS R8 R7 K17 ["findDeepInstance"]
  DUPCLOSURE R8 K18 [PROTO_1]
  CAPTURE VAL R7
  SETTABLEKS R8 R7 K19 ["getLayerView"]
  DUPCLOSURE R8 K20 [PROTO_2]
  CAPTURE VAL R7
  SETTABLEKS R8 R7 K21 ["getLayerTree"]
  DUPCLOSURE R8 K22 [PROTO_3]
  CAPTURE VAL R5
  CAPTURE VAL R7
  SETTABLEKS R8 R7 K23 ["getLayerViewItem"]
  DUPCLOSURE R8 K24 [PROTO_4]
  CAPTURE VAL R7
  SETTABLEKS R8 R7 K25 ["getLayerViewLabel"]
  DUPCLOSURE R8 K26 [PROTO_5]
  CAPTURE VAL R7
  SETTABLEKS R8 R7 K27 ["getLayerViewValue"]
  DUPCLOSURE R8 K28 [PROTO_6]
  CAPTURE VAL R7
  SETTABLEKS R8 R7 K29 ["getLayerViewTextBox"]
  DUPCLOSURE R8 K30 [PROTO_7]
  CAPTURE VAL R7
  SETTABLEKS R8 R7 K31 ["getLayerViewCheckBox"]
  DUPCLOSURE R8 K32 [PROTO_8]
  CAPTURE VAL R7
  CAPTURE VAL R6
  CAPTURE VAL R4
  SETTABLEKS R8 R7 K33 ["getLayerViewDeleteButton"]
  DUPCLOSURE R8 K34 [PROTO_9]
  CAPTURE VAL R7
  CAPTURE VAL R4
  SETTABLEKS R8 R7 K35 ["getLayerViewHistoryButton"]
  DUPCLOSURE R8 K36 [PROTO_10]
  CAPTURE VAL R7
  SETTABLEKS R8 R7 K37 ["getLayerTreeItem"]
  DUPCLOSURE R8 K38 [PROTO_11]
  CAPTURE VAL R7
  SETTABLEKS R8 R7 K39 ["getLayerPanelTab"]
  DUPCLOSURE R8 K40 [PROTO_12]
  DUPCLOSURE R9 K41 [PROTO_13]
  CAPTURE VAL R8
  SETTABLEKS R9 R7 K42 ["makeHistoryGraphProperties"]
  DUPCLOSURE R9 K43 [PROTO_15]
  CAPTURE VAL R2
  CAPTURE VAL R1
  SETTABLEKS R9 R7 K44 ["clickComponent"]
  DUPCLOSURE R9 K45 [PROTO_17]
  CAPTURE VAL R2
  CAPTURE VAL R1
  SETTABLEKS R9 R7 K46 ["clearText"]
  DUPCLOSURE R9 K47 [PROTO_19]
  CAPTURE VAL R2
  CAPTURE VAL R1
  SETTABLEKS R9 R7 K48 ["sendText"]
  DUPCLOSURE R9 K49 [PROTO_21]
  CAPTURE VAL R2
  CAPTURE VAL R1
  SETTABLEKS R9 R7 K50 ["dragComponent"]
  DUPCLOSURE R9 K51 [PROTO_22]
  CAPTURE VAL R7
  SETTABLEKS R9 R7 K52 ["getLayerViewCell"]
  DUPCLOSURE R9 K53 [PROTO_23]
  CAPTURE VAL R7
  SETTABLEKS R9 R7 K54 ["checkLayerViewItemLabels"]
  DUPCLOSURE R9 K55 [PROTO_24]
  CAPTURE VAL R7
  SETTABLEKS R9 R7 K56 ["getBlendDots"]
  DUPCLOSURE R9 K57 [PROTO_25]
  SETTABLEKS R9 R7 K58 ["repeatFlakyTest"]
  RETURN R7 1
