...
-- TODO (rcary) delete this line
local FFlagEnableGlobalWindPlugin = true
-- TODO (rcary) uncomment this line
-- local FFlagEnableGlobalWindPlugin = game:GetFastFlag("EnableGlobalWindPlugin")

if not FFlagEnableGlobalWindPlugin then
	return
end
