...
function MainPlugin:init(props)
	...
	self.localization = ContextServices.Localization.new({
		...
		pluginName = "GlobalWind",
	})
	--[[
		TODO (rcary): Each plugin is expected to provide a createEventHandlers
		function to the constructor which should return a table mapping
		event -> eventHandler.
	--]]
...
function MainPlugin:renderButtons(toolbar)
	...
	return {
		Toggle = Roact.createElement(PluginButton, {
			...
			--TODO (rcary): Change Icon. Can be empty string if QT is managing the icon
...
function MainPlugin:render()
	...
	return ContextServices.provide({
		...
		MainWidget = Roact.createElement(DockWidget, {
			...
			-- TODO (rcary): Switch out ExampleComponent with your component
