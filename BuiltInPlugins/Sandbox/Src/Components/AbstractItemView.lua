...
local fflagDebugMultiselect = game:DefineFastFlag("DebugStudioSandboxMultiselect", false)
-- Enable when Sandbox C++ code is compatible with multiselect and when UserInputService works with lua widgets
local fflagEnableMultiselect = game:DefineFastFlag("StudioSandboxMultiselectEnabled", false)
...
function AbstractItemView:init()
	...
	self.getPressedModifiers = function()
		if not fflagEnableMultiselect then return {} end
