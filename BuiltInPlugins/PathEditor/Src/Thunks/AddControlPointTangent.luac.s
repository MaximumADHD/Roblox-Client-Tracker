PROTO_0:
  ...
  GETIMPORT R9 K15 [Vector2.one]
  GETUPVAL R11 0
  GETTABLE R10 R2 R11
  GETUPVAL R11 5
  GETTABLEKS R13 R9 K16 ["Unit"]
  GETUPVAL R16 6
  ...
  CALL R11 2 1
  SETTABLEKS R11 R10 K18 ["LeftTangent"]
  GETUPVAL R11 0
  GETTABLE R10 R2 R11
  GETUPVAL R11 5
  GETTABLEKS R13 R9 K16 ["Unit"]
  ...
  GETTABLEKS R13 R14 K11 ["Parent"]
  CALL R11 2 1
  SETTABLEKS R11 R10 K19 ["RightTangent"]
  JUMP [+282]
  GETUPVAL R9 0
  LOADN R10 1
  ...
  CALL R13 3 1
  SUB R11 R12 R13
  GETTABLEKS R12 R11 K20 ["Y"]
  JUMPIFNOTEQKN R12 K21 [0] [+7]
  GETTABLEKS R12 R11 K22 ["X"]
  JUMPIFNOTEQKN R12 K21 [0] [+3]
  GETIMPORT R11 K15 [Vector2.one]
  GETUPVAL R13 0
  GETTABLE R12 R2 R13
  GETUPVAL R13 5
  GETTABLEKS R15 R11 K16 ["Unit"]
  GETUPVAL R18 6
  GETTABLEKS R17 R18 K17 ["DefaultTangentLength"]
  MINUS R16 R17
  MUL R14 R15 R16
  GETTABLEKS R16 R1 K2 ["SelectedObject"]
  GETTABLEKS R15 R16 K11 ["Parent"]
  CALL R13 2 1
  SETTABLEKS R13 R12 K18 ["LeftTangent"]
  GETUPVAL R13 0
  GETTABLE R12 R2 R13
  GETUPVAL R13 5
  GETTABLEKS R15 R11 K16 ["Unit"]
  ...
  GETTABLEKS R15 R16 K11 ["Parent"]
  CALL R13 2 1
  SETTABLEKS R13 R12 K19 ["RightTangent"]
  JUMP [+209]
  JUMPIFNOT R5 [+76]
  GETTABLEKS R11 R1 K6 ["ControlPoints"]
  LENGTH R10 R11
  ...
  GETUPVAL R15 0
  GETTABLE R14 R2 R15
  GETTABLEKS R13 R14 K18 ["LeftTangent"]
  SETTABLEKS R13 R12 K18 ["LeftTangent"]
  GETTABLE R12 R2 R6
  GETUPVAL R15 0
  GETTABLE R14 R2 R15
  GETTABLEKS R13 R14 K19 ["RightTangent"]
  SETTABLEKS R13 R12 K19 ["RightTangent"]
  JUMP [+132]
  GETUPVAL R9 0
