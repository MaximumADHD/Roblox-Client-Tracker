...
local var4 = {}
local var65 = var3.Analytics.mock()
local var6 = var3.Localization.mock()
local var71 = require(var0.Packages.Rodux).Store
var71 = require(var0.Src.Reducers.MainReducer)
local var7 = var3.Store.new(var71.new(var71, nil, nil, nil))
