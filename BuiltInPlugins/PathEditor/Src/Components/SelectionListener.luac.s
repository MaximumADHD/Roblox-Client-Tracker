...
MAIN:
  ...
  LOADK R20 K27 ["PathEditorFixActionBindings"]
  LOADB R21 0
  NAMECALL R18 R18 K28 ["defineFastFlag"]
  CALL R18 3 1
  GETTABLEKS R19 R2 K29 ["PureComponent"]
  LOADK R21 K30 ["SelectionListener"]
  NAMECALL R19 R19 K31 ["extend"]
  CALL R19 2 1
  DUPCLOSURE R20 K32 [PROTO_0]
  SETTABLEKS R20 R19 K33 ["addAction"]
  DUPCLOSURE R20 K34 [PROTO_1]
  SETTABLEKS R20 R19 K35 ["enableActions"]
  DUPCLOSURE R20 K36 [PROTO_2]
  SETTABLEKS R20 R19 K37 ["disableActions"]
  DUPCLOSURE R20 K38 [PROTO_8]
  CAPTURE VAL R18
  CAPTURE VAL R5
  SETTABLEKS R20 R19 K39 ["init"]
  DUPCLOSURE R20 K40 [PROTO_9]
  SETTABLEKS R20 R19 K41 ["didMount"]
  DUPCLOSURE R20 K42 [PROTO_10]
  SETTABLEKS R20 R19 K43 ["willUnmount"]
  DUPCLOSURE R20 K44 [PROTO_11]
  SETTABLEKS R20 R19 K45 ["render"]
  MOVE R20 R7
  DUPTABLE R21 K48 [{"PluginActions", "Mouse"}]
  GETTABLEKS R22 R6 K46 ["PluginActions"]
  SETTABLEKS R22 R21 K46 ["PluginActions"]
  GETTABLEKS R22 R6 K47 ["Mouse"]
  SETTABLEKS R22 R21 K47 ["Mouse"]
  CALL R20 1 1
  MOVE R21 R19
  CALL R20 1 1
  MOVE R19 R20
  GETTABLEKS R20 R3 K49 ["connect"]
