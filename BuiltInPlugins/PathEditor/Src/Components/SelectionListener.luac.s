...
MAIN:
  ...
  LOADK R25 K35 ["SelectionListener"]
  NAMECALL R23 R23 K36 ["extend"]
  CALL R23 2 1
  DUPCLOSURE R24 K37 [PROTO_0]
  SETTABLEKS R24 R23 K38 ["addAction"]
  DUPCLOSURE R24 K39 [PROTO_1]
  SETTABLEKS R24 R23 K40 ["enableActions"]
  DUPCLOSURE R24 K41 [PROTO_2]
  SETTABLEKS R24 R23 K42 ["disableActions"]
  ...
  SETTABLEKS R24 R23 K46 ["didMount"]
  DUPCLOSURE R24 K47 [PROTO_10]
  SETTABLEKS R24 R23 K48 ["willUnmount"]
  DUPCLOSURE R24 K49 [PROTO_11]
  SETTABLEKS R24 R23 K50 ["render"]
  MOVE R24 R7
  DUPTABLE R25 K53 [{"PluginActions", "Mouse"}]
  GETTABLEKS R26 R6 K51 ["PluginActions"]
  SETTABLEKS R26 R25 K51 ["PluginActions"]
  GETTABLEKS R26 R6 K52 ["Mouse"]
  SETTABLEKS R26 R25 K52 ["Mouse"]
  CALL R24 1 1
  MOVE R25 R23
  CALL R24 1 1
  MOVE R23 R24
  GETTABLEKS R24 R3 K54 ["connect"]
  DUPCLOSURE R25 K55 [PROTO_12]
  DUPCLOSURE R26 K56 [PROTO_21]
  CAPTURE VAL R15
  CAPTURE VAL R19
  CAPTURE VAL R12
  CAPTURE VAL R14
