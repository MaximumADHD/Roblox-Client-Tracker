...
PROTO_14:
  ...
  CALL R4 2 1
  GETTABLEKS R5 R2 K16 ["isDragging"]
  JUMPIF R5 [+2]
  GETTABLEKS R5 R2 K17 ["isDragStarting"]
  CALL R3 2 0
  RETURN R0 0
  GETTABLEKS R3 R1 K15 ["OnHoverMoved"]
  GETIMPORT R4 K10 [Vector2.new]
...
MAIN:
  ...
  LOADK R20 K30 ["PathEditorRotation"]
  NAMECALL R18 R18 K31 ["GetFastFlag"]
  CALL R18 2 1
  GETTABLEKS R19 R3 K32 ["Component"]
  LOADK R21 K33 ["DraggablePoint"]
  NAMECALL R19 R19 K34 ["extend"]
  CALL R19 2 1
  DUPTABLE R20 K49 [{"Style", "ZIndex", "AbsolutePosition", "FollowCursorOnDrag", "OnSelected", "OnMouse1Down", "OnHover", "OnHoverMoved", "OnHoverEnd", "OnDeselected", "OnDragStart", "OnDragMoved", "OnDragEnd", "OnDoubleClicked", "OnRightClicked"}]
  LOADK R21 K50 ["ControlPoint"]
  SETTABLEKS R21 R20 K17 ["Style"]
  LOADN R21 0
  SETTABLEKS R21 R20 K35 ["ZIndex"]
  GETIMPORT R21 K53 [Vector2.new]
  LOADN R22 0
  LOADN R23 0
  CALL R21 2 1
  SETTABLEKS R21 R20 K36 ["AbsolutePosition"]
  LOADB R21 1
  SETTABLEKS R21 R20 K37 ["FollowCursorOnDrag"]
  DUPCLOSURE R21 K54 [PROTO_0]
  SETTABLEKS R21 R20 K38 ["OnSelected"]
  DUPCLOSURE R21 K55 [PROTO_1]
  SETTABLEKS R21 R20 K39 ["OnMouse1Down"]
  DUPCLOSURE R21 K56 [PROTO_2]
  SETTABLEKS R21 R20 K40 ["OnHover"]
  LOADNIL R21
  SETTABLEKS R21 R20 K41 ["OnHoverMoved"]
  DUPCLOSURE R21 K57 [PROTO_3]
  SETTABLEKS R21 R20 K42 ["OnHoverEnd"]
  DUPCLOSURE R21 K58 [PROTO_4]
  SETTABLEKS R21 R20 K43 ["OnDeselected"]
  DUPCLOSURE R21 K59 [PROTO_5]
  SETTABLEKS R21 R20 K44 ["OnDragStart"]
  DUPCLOSURE R21 K60 [PROTO_6]
  SETTABLEKS R21 R20 K45 ["OnDragMoved"]
  DUPCLOSURE R21 K61 [PROTO_7]
  SETTABLEKS R21 R20 K46 ["OnDragEnd"]
  DUPCLOSURE R21 K62 [PROTO_8]
  SETTABLEKS R21 R20 K47 ["OnDoubleClicked"]
  DUPCLOSURE R21 K63 [PROTO_9]
  SETTABLEKS R21 R20 K48 ["OnRightClicked"]
  SETTABLEKS R20 R19 K64 ["defaultProps"]
  DUPCLOSURE R20 K65 [PROTO_15]
  CAPTURE VAL R10
  CAPTURE VAL R18
  SETTABLEKS R20 R19 K66 ["init"]
  DUPCLOSURE R20 K67 [PROTO_16]
  CAPTURE VAL R13
  SETTABLEKS R20 R19 K68 ["didUpdate"]
  DUPCLOSURE R20 K69 [PROTO_17]
  CAPTURE VAL R12
  CAPTURE VAL R5
  CAPTURE VAL R11
  CAPTURE VAL R3
  ...
  CAPTURE VAL R15
  CAPTURE VAL R0
  SETTABLEKS R20 R19 K70 ["render"]
  MOVE R20 R7
  DUPTABLE R21 K71 [{"Stylizer"}]
  SETTABLEKS R8 R21 K18 ["Stylizer"]
  CALL R20 1 1
  MOVE R21 R19
  CALL R20 1 1
  MOVE R19 R20
