...
PROTO_6:
  ...
  JUMP [+48]
  GETTABLEKS R11 R1 K7 ["AddPointSubMode"]
  JUMPIFNOTEQKS R11 K10 ["Unselected"] [+45]
  JUMPIFNOT R8 [+43]
  ...
  GETTABLEKS R13 R2 K17 ["dragLocation"]
  CALL R11 2 1
  GETTABLEN R12 R11 2
  GETTABLEN R13 R11 3
  JUMPIFEQKNIL R12 [+24]
  GETUPVAL R15 5
  GETTABLEKS R14 R15 K22 ["SnapToSegmentEpsilon"]
  JUMPIFNOTLT R12 R14 [+19]
  GETUPVAL R14 0
  ...
  JUMPIFNOT R9 [+37]
  JUMPIFEQKNIL R6 [+36]
  GETTABLEKS R12 R1 K7 ["AddPointSubMode"]
  JUMPIFNOTEQKS R12 K8 ["Append"] [+17]
  NEWTABLE R12 0 2
  GETUPVAL R13 7
  MOVE R14 R5
  GETTABLEKS R15 R6 K24 ["RightTangent"]
  GETTABLEKS R16 R6 K24 ["RightTangent"]
  CALL R13 3 1
  GETUPVAL R14 7
  MOVE R15 R7
  CALL R14 1 -1
  ...
  GETUPVAL R13 7
  MOVE R14 R5
  GETTABLEKS R15 R6 K25 ["LeftTangent"]
  GETTABLEKS R16 R6 K25 ["LeftTangent"]
  CALL R13 3 1
  GETUPVAL R14 7
  MOVE R15 R7
  CALL R14 1 -1
