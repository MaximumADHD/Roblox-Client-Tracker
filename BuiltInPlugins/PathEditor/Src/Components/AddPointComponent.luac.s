...
MAIN:
  ...
  CALL R27 1 1
  GETTABLEKS R28 R3 K38 ["Component"]
  ...
  GETTABLEKS R20 R21 K30 ["Util"]
  GETIMPORT R21 K8 [require]
  GETTABLEKS R22 R20 K48 ["getAbsolutePosition"]
  CALL R21 1 1
  GETIMPORT R22 K8 [require]
  ...
  CALL R24 1 1
  GETIMPORT R25 K8 [require]
  GETTABLEKS R26 R20 K49 ["getUDim2OffsetFromScale"]
  CALL R25 1 1
  GETIMPORT R26 K8 [require]
  GETTABLEKS R27 R20 K32 ["getPositionMatchesControlPoint"]
  CALL R26 1 1
  GETIMPORT R27 K8 [require]
  GETTABLEKS R28 R20 K50 ["getPosOnCurveOffset"]
  CALL R27 1 1
  GETIMPORT R28 K8 [require]
  GETTABLEKS R29 R20 K31 ["getClosestControlPointToPosition"]
  CALL R28 1 1
  GETIMPORT R29 K1 [game]
  LOADK R31 K51 ["PathEditorInsertPointSnappingFix"]
  LOADB R32 0
  NAMECALL R29 R29 K52 ["defineFastFlag"]
  CALL R29 3 1
  GETTABLEKS R30 R3 K38 ["Component"]
  LOADK R32 K39 ["AddPointComponent"]
  NAMECALL R30 R30 K40 ["extend"]
  CALL R30 2 1
  ...
  GETTABLEKS R31 R4 K45 ["connect"]
  DUPCLOSURE R32 K55 [PROTO_21]
  DUPCLOSURE R33 K56 [PROTO_27]
  CAPTURE VAL R10
  CAPTURE VAL R12
  CAPTURE VAL R11
  CAPTURE VAL R7
