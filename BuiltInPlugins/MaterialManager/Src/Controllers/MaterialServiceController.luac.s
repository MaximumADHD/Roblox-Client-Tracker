...
PROTO_16:
  ...
  MOVE R8 R1
  MOVE R9 R2
  NAMECALL R6 R0 K0 ["getMaterialWrapper"]
  CALL R6 3 1
  MOVE R9 R5
  GETTABLEKS R11 R6 K1 ["MaterialVariant"]
  NOT R10 R11
  NAMECALL R7 R0 K2 ["addCategory"]
  CALL R7 3 1
  FASTCALL2K ASSERT R7 K3 [+5]
  MOVE R9 R7
  LOADK R10 K3 ["Category to which a Material is added should exist, or be created"]
  GETIMPORT R8 K5 [assert]
  CALL R8 2 0
  GETTABLEKS R9 R7 K6 ["Materials"]
  FASTCALL2 TABLE_INSERT R9 R6 [+4]
  MOVE R10 R6
  GETIMPORT R8 K9 [table.insert]
  CALL R8 2 0
  JUMPIFNOT R2 [+60]
  GETTABLEKS R8 R0 K10 ["_materialPaths"]
  SETTABLE R5 R8 R2
  GETTABLEKS R8 R0 K11 ["_materialWrappers"]
  SETTABLE R6 R8 R2
  GETIMPORT R8 K13 [ipairs]
  NAMECALL R9 R2 K14 ["GetChildren"]
  CALL R9 1 -1
  CALL R8 -1 3
  FORGPREP_INEXT R8
  GETTABLEKS R16 R0 K15 ["_materialChangedListeners"]
  GETTABLE R15 R16 R12
  NOT R14 R15
  FASTCALL2K ASSERT R14 K16 [+4]
  LOADK R15 K16 ["Already connected to material changed"]
  GETIMPORT R13 K5 [assert]
  CALL R13 2 0
  GETTABLEKS R13 R0 K15 ["_materialChangedListeners"]
  GETTABLEKS R14 R12 K17 ["Changed"]
  NEWCLOSURE R16 P0
  CAPTURE VAL R0
  CAPTURE VAL R2
  CAPTURE UPVAL U1
  NAMECALL R14 R14 K18 ["Connect"]
  CALL R14 2 1
  SETTABLE R14 R13 R12
  FORGLOOP R8 2 [inext] [-23]
  GETTABLEKS R9 R0 K15 ["_materialChangedListeners"]
  GETTABLE R8 R9 R2
  JUMPIFNOT R8 [+6]
  GETTABLEKS R9 R0 K15 ["_materialChangedListeners"]
  GETTABLE R8 R9 R2
  ...
  SETTABLE R9 R8 R2
  JUMP [+17]
  GETTABLEKS R8 R0 K20 ["_store"]
  GETUPVAL R10 2
  MOVE R11 R1
  GETTABLEKS R12 R0 K21 ["_materialServiceWrapper"]
  NAMECALL R12 R12 K22 ["asService"]
  CALL R12 1 1
  MOVE R14 R1
  NAMECALL R12 R12 K23 ["GetOverrideStatus"]
  CALL R12 2 -1
  CALL R10 -1 -1
  NAMECALL R8 R8 K24 ["dispatch"]
  CALL R8 -1 0
  GETUPVAL R9 3
  GETTABLE R8 R9 R1
  JUMPIFNOT R8 [+4]
  MOVE R10 R1
  NAMECALL R8 R0 K25 ["updateOverrides"]
  CALL R8 2 0
  GETTABLEKS R8 R0 K20 ["_store"]
  GETUPVAL R10 1
  MOVE R11 R6
  ...
  JUMPIFNOT R8 [+19]
  JUMPIF R4 [+35]
  GETTABLEKS R10 R0 K20 ["_store"]
  NAMECALL R10 R10 K26 ["getState"]
  CALL R10 1 1
  GETTABLEKS R9 R10 K27 ["MaterialBrowserReducer"]
  GETTABLEKS R8 R9 K28 ["Path"]
  GETUPVAL R9 5
  MOVE R10 R8
  MOVE R11 R5
  CALL R9 2 1
  JUMPIFNOT R9 [+21]
  NAMECALL R9 R0 K29 ["updateMaterialList"]
  CALL R9 1 0
  RETURN R0 0
  GETTABLEKS R10 R0 K20 ["_store"]
  NAMECALL R10 R10 K26 ["getState"]
