...
function MaterialInformation:render()
	...
	return Roact.createElement(Pane, {
		...
		ColorMap = self.createTextureElement(
			localization:getText("MaterialInformation", "Color"),
			colorMap,
			layoutOrderIterator:getNextOrder()
		),
		NormalMap = self.createTextureElement(
			localization:getText("MaterialInformation", "Normal"),
			normalMap,
			layoutOrderIterator:getNextOrder()
		),
		MetalnessMap = self.createTextureElement(
			localization:getText("MaterialInformation", "Metalness"),
			metalnessMap,
			layoutOrderIterator:getNextOrder()
		),
		RoughnessMap = self.createTextureElement(
			localization:getText("MaterialInformation", "Roughness"),
			roughnessMap,
			layoutOrderIterator:getNextOrder()
		),
	})
