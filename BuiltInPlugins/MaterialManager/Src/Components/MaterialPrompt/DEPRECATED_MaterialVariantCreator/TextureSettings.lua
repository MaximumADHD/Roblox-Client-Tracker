		...
		if mapType == TextureMaps.ColorMap then
			...
			self:setState(function(state)
				return {
					...
					urlColorMap = if file then "" else state.urlColorMap,
				}
			end)
		elseif mapType == TextureMaps.MetalnessMap then
			...
			self:setState(function(state)
				return {
					...
					urlMetalnessMap = if file then "" else state.urlMetalnessMap,
				}
			end)
		elseif mapType == TextureMaps.NormalMap then
			...
			self:setState(function(state)
				return {
					...
					urlNormalMap = if file then "" else state.urlNormalMap,
				}
			end)
		elseif mapType == TextureMaps.RoughnessMap then
			...
			self:setState(function(state)
				return {
					...
					urlRoughnessMap = if file then "" else state.urlRoughnessMap,
				}
			end)
		end
	end
