...
local DEPRECATED_MaterialPrompt = Roact.PureComponent:extend("DEPRECATED_MaterialPrompt")

function DEPRECATED_MaterialPrompt:hasValidName()
	return if self.props.Name and self.props.Name ~= "" then true else false
end

function DEPRECATED_MaterialPrompt:getNameError()
...
function DEPRECATED_MaterialPrompt:getBaseMaterialError()
	local props: _Props = self.props
	local localization = props.Localization
...
function DEPRECATED_MaterialPrompt:createTempMaterialVariant()
	local props: _Props = self.props
...
function DEPRECATED_MaterialPrompt:init()
	self:setState({
		saveAttempt = false,
...
function DEPRECATED_MaterialPrompt:didMount()
	local props: _Props = self.props
...
function DEPRECATED_MaterialPrompt:render()
	local props: _Props = self.props
	local localization = props.Localization
...
DEPRECATED_MaterialPrompt = withContext({
	Analytics = Analytics,
...
return RoactRodux.connect(mapStateToProps, mapDispatchToProps)(DEPRECATED_MaterialPrompt)
