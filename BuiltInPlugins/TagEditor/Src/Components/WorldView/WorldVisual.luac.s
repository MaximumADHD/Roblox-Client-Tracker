PROTO_0:
       ...
       50 CALL                             R9 1 0
       51 GETUPVAL                         R9 5
       52 GETTABLEKS                       R9 R9 K14 ["createElement"]
       54 MOVE                             R10 R8
       ...
       78 FORGLOOP                         R3 2 ; [-70]
       80 GETUPVAL                         R3 5
       81 GETTABLEKS                       R3 R3 K14 ["createElement"]
       83 GETUPVAL                         R4 5
       84 GETTABLEKS                       R4 R4 K21 ["Portal"]
       86 DUPTABLE                         R5 K23 [{"target"}]
       87 GETUPVAL                         R6 6
       88 SETTABLEKS                       R6 R5 K22 ["target"]
       90 DUPTABLE                         R6 K25 [{"TagEditorWorldView"}]
       91 GETUPVAL                         R7 5
       92 GETTABLEKS                       R7 R7 K14 ["createElement"]
...
MAIN:
       ...
       30 GETTABLEKS                       R4 R4 K11 ["BoxAdorn"]
       32 CALL                             R3 1 1
       33 GETIMPORT                        R4 K8 [require]
       35 GETIMPORT                        R5 K5 [script]
       37 GETTABLEKS                       R5 R5 K6 ["Parent"]
       39 GETTABLEKS                       R5 R5 K12 ["SphereAdorn"]
       41 CALL                             R4 1 1
       42 GETIMPORT                        R5 K8 [require]
       44 GETIMPORT                        R6 K5 [script]
       46 GETTABLEKS                       R6 R6 K6 ["Parent"]
       48 GETTABLEKS                       R6 R6 K13 ["OutlineAdorn"]
       50 CALL                             R5 1 1
       51 GETIMPORT                        R6 K8 [require]
       53 GETIMPORT                        R7 K5 [script]
       55 GETTABLEKS                       R7 R7 K6 ["Parent"]
       57 GETTABLEKS                       R7 R7 K14 ["IconAdorn"]
       59 CALL                             R6 1 1
       60 GETIMPORT                        R7 K8 [require]
       62 GETIMPORT                        R8 K5 [script]
       64 GETTABLEKS                       R8 R8 K6 ["Parent"]
       66 GETTABLEKS                       R8 R8 K15 ["TextAdorn"]
       68 CALL                             R7 1 1
