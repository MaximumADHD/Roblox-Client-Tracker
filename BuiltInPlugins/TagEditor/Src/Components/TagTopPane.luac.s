...
PROTO_1:
  ...
  CALL R1 1 0
  RETURN R0 0
  GETTABLEKS R1 R0 K6 ["groupMenu"]
  JUMPIFNOT R1 [+20]
  GETUPVAL R2 1
  GETTABLEKS R1 R2 K2 ["Get"]
  CALL R1 0 1
  GETTABLEKS R3 R0 K6 ["groupMenu"]
  NAMECALL R1 R1 K7 ["DeleteGroup"]
  CALL R1 2 0
  GETUPVAL R1 2
  JUMPIFNOT R1 [+5]
  GETTABLEKS R1 R0 K8 ["openGroupMenu"]
  LOADNIL R2
  CALL R1 1 0
  RETURN R0 0
  GETTABLEKS R1 R0 K8 ["openGroupMenu"]
...
MAIN:
  ...
  SETTABLEKS R24 R23 K39 ["updateExtents"]
