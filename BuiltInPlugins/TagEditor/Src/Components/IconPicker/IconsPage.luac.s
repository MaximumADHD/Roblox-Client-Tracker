...
PROTO_2:
       ...
       10 CALL                             R0 3 0
       11 GETUPVAL                         R0 1
       12 GETTABLEKS                       R0 R0 K3 ["closeFunc"]
       14 CALL                             R0 0 0
       15 RETURN                           R0 0

PROTO_3:
        0 GETUPVAL                         R4 0
        1 GETTABLEKS                       R4 R4 K0 ["Lookup"]
        3 MOVE                             R5 R0
        4 CALL                             R4 1 1
        5 GETUPVAL                         R5 1
        6 GETTABLEKS                       R5 R5 K1 ["props"]
        8 NEWTABLE                         R6 16 0
       ...
       33 GETUPVAL                         R7 2
       34 GETTABLEKS                       R7 R7 K13 ["Event"]
       36 GETTABLEKS                       R7 R7 K14 ["MouseEnter"]
       38 NEWCLOSURE                       R8 P0
       39 CAPTURE                          UPVAL U1
       40 CAPTURE                          VAL R5
       41 CAPTURE                          VAL R0
       ...
       43 GETUPVAL                         R7 2
       44 GETTABLEKS                       R7 R7 K13 ["Event"]
       46 GETTABLEKS                       R7 R7 K15 ["MouseLeave"]
       48 NEWCLOSURE                       R8 P1
       49 CAPTURE                          UPVAL U1
       50 CAPTURE                          VAL R5
       ...
       55 GETTABLEKS                       R7 R7 K16 ["MouseButton1Click"]
       57 NEWCLOSURE                       R8 P2
       58 CAPTURE                          UPVAL U3
       59 CAPTURE                          VAL R5
       60 CAPTURE                          VAL R0
...
PROTO_5:
        ...
        4 GETTABLEKS                       R2 R2 K2 ["IconsPage"]
        6 NEWTABLE                         R3 0 0
        8 LOADN                            R4 1
...
MAIN:
       ...
       47 GETTABLEKS                       R9 R9 K14 ["FamFamFam"]
       49 CALL                             R8 1 1
       50 GETIMPORT                        R9 K4 [require]
       52 GETTABLEKS                       R10 R0 K15 ["Src"]
       54 GETTABLEKS                       R10 R10 K16 ["IconCategories"]
       56 CALL                             R9 1 1
       57 GETIMPORT                        R10 K4 [require]
       59 GETTABLEKS                       R11 R0 K15 ["Src"]
       61 GETTABLEKS                       R11 R11 K17 ["TagManager"]
       63 CALL                             R10 1 1
