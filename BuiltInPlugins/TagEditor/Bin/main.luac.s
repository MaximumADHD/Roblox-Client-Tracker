...
PROTO_2:
       ...
       11 GETIMPORT                        R4 K7 [script]
       13 GETTABLEKS                       R4 R4 K8 ["Parent"]
       15 GETTABLEKS                       R4 R4 K9 ["defineLuaFlags"]
       17 CALL                             R3 1 0
       18 GETIMPORT                        R3 K5 [require]
       20 GETIMPORT                        R4 K7 [script]
       22 GETTABLEKS                       R4 R4 K8 ["Parent"]
       24 GETTABLEKS                       R4 R4 K10 ["commonInit"]
       26 CALL                             R3 1 1
       27 MOVE                             R4 R3
       28 CALL                             R4 0 0
       29 GETIMPORT                        R4 K7 [script]
       31 GETTABLEKS                       R4 R4 K8 ["Parent"]
       33 GETTABLEKS                       R4 R4 K8 ["Parent"]
       35 JUMPIF                           R2 ; [+13]
       36 GETIMPORT                        R5 K5 [require]
       38 GETTABLEKS                       R6 R4 K11 ["Src"]
       40 GETTABLEKS                       R6 R6 K12 ["Util"]
       42 GETTABLEKS                       R6 R6 K13 ["shouldPluginRun"]
       44 CALL                             R5 1 1
       45 MOVE                             R6 R5
       46 CALL                             R6 0 1
       47 JUMPIF                           R6 ; [+1]
       ...
       51 GETTABLEKS                       R6 R4 K14 ["Packages"]
       53 GETTABLEKS                       R6 R6 K15 ["Roact"]
       55 CALL                             R5 1 1
       56 GETIMPORT                        R6 K5 [require]
       58 GETTABLEKS                       R7 R4 K11 ["Src"]
       60 GETTABLEKS                       R7 R7 K16 ["MainPlugin"]
       62 CALL                             R6 1 1
       63 GETIMPORT                        R7 K5 [require]
       65 GETTABLEKS                       R8 R4 K11 ["Src"]
       67 GETTABLEKS                       R8 R8 K12 ["Util"]
       69 GETTABLEKS                       R8 R8 K17 ["hasInternalPermission"]
       71 CALL                             R7 1 1
       72 CALL                             R7 0 1
       73 LOADNIL                          R8
       74 LOADNIL                          R9
       ...
       78 GETTABLEKS                       R11 R4 K14 ["Packages"]
       80 GETTABLEKS                       R11 R11 K18 ["DeveloperTools"]
       82 CALL                             R10 1 1
       83 GETTABLEKS                       R10 R10 K19 ["forPlugin"]
