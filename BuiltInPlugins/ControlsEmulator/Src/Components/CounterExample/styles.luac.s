MAIN:
  ...
  CALL R9 2 1
  MOVE R10 R2
  LOADK R11 K41 ["> TextButton"]
  DUPTABLE R12 K31 [{"TextSize", "Font", "TextColor3", "Size", "BackgroundTransparency", "TextXAlignment", "TextYAlignment"}]
  LOADN R13 50
  SETTABLEKS R13 R12 K24 ["TextSize"]
  GETIMPORT R13 K34 [Enum.Font.Gotham]
  SETTABLEKS R13 R12 K25 ["Font"]
  LOADK R13 K35 ["$TextPrimary"]
  SETTABLEKS R13 R12 K26 ["TextColor3"]
  ...
  GETIMPORT R13 K39 [Enum.TextXAlignment.Center]
  SETTABLEKS R13 R12 K29 ["TextXAlignment"]
  GETIMPORT R13 K40 [Enum.TextYAlignment.Center]
