...
MAIN:
  ...
  CAPTURE REF R4
  CAPTURE REF R5
  SETTABLEKS R8 R0 K11 ["newRequest"]
  NEWCLOSURE R8 P1
  CAPTURE REF R7
  SETTABLEKS R8 R0 K12 ["activeStreamId"]
  NEWCLOSURE R8 P2
  CAPTURE REF R7
  SETTABLEKS R8 R0 K13 ["setActiveStreamId"]
  NEWCLOSURE R8 P3
  CAPTURE REF R4
  CAPTURE REF R6
  CAPTURE REF R5
  CAPTURE REF R7
  SETTABLEKS R8 R0 K14 ["requestStreamSubscription"]
  NEWCLOSURE R8 P4
  CAPTURE VAL R2
  CAPTURE REF R4
  SETTABLEKS R8 R0 K15 ["storeStreamPacket"]
  NEWCLOSURE R8 P5
  CAPTURE VAL R2
  CAPTURE REF R4
  CAPTURE REF R5
  ...
  CAPTURE REF R5
  CAPTURE VAL R2
  SETTABLEKS R9 R0 K16 ["activeStreamEnded"]
  NEWCLOSURE R9 P7
  CAPTURE VAL R3
  CAPTURE REF R4
  SETTABLEKS R9 R0 K17 ["isRequestEnded"]
  NEWCLOSURE R9 P8
  CAPTURE REF R4
  SETTABLEKS R9 R0 K18 ["packetExists"]
  NEWCLOSURE R9 P9
  CAPTURE REF R4
  CAPTURE REF R6
  SETTABLEKS R9 R0 K19 ["handleEarliestPacketForStream"]
  NEWCLOSURE R9 P10
  CAPTURE VAL R2
  CAPTURE REF R4
  CAPTURE VAL R3
  ...
  CAPTURE REF R5
  CAPTURE REF R7
  SETTABLEKS R9 R0 K20 ["requestEnded"]
  NEWCLOSURE R9 P11
  CAPTURE REF R4
  CAPTURE REF R5
  CAPTURE REF R6
  CAPTURE REF R7
  SETTABLEKS R9 R0 K21 ["clear"]
  NEWCLOSURE R9 P12
  CAPTURE REF R4
  SETTABLEKS R9 R0 K22 ["getStreamCache"]
  CLOSEUPVALS R4
  RETURN R0 1
