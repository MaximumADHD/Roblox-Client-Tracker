...
local var471 = require(var15)
var15.Name = var471
var471 = var9
var459.InsertAssetInstant = require(var471)
var459.SetPropertyInstant = require(var10)
var459.InstantiateInstant = require(var8)
var21.parallel = var459
local var480 = {}
...
var21.sequential = var480
var480 = require(var0.Src.Flags.getFFlagConvAICodeRunner)
if var480() then
