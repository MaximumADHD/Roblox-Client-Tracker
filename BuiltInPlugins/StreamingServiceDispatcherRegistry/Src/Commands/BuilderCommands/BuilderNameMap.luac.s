...
MAIN:
  ...
  GETTABLEKS R7 R8 K15 ["getFFlagAddStreamingServiceDispatcherTests"]
  CALL R6 1 1
  DUPTABLE R7 K26 [{"assetCacheMap", "g2g", "guid2instance", "guidToInfo", "chatBulletMap", "altDataMap", "requestRegionAdornments", "requestMetadata", "activeDraftGuids", "draftModeModels"}]
  NEWTABLE R8 0 0
  SETTABLEKS R8 R7 K16 ["assetCacheMap"]
  NEWTABLE R8 0 0
  SETTABLEKS R8 R7 K17 ["g2g"]
  NEWTABLE R8 0 0
  SETTABLEKS R8 R7 K18 ["guid2instance"]
  NEWTABLE R8 0 0
  SETTABLEKS R8 R7 K19 ["guidToInfo"]
  NEWTABLE R8 0 0
  SETTABLEKS R8 R7 K20 ["chatBulletMap"]
  NEWTABLE R8 0 0
  SETTABLEKS R8 R7 K21 ["altDataMap"]
  NEWTABLE R8 0 0
  SETTABLEKS R8 R7 K22 ["requestRegionAdornments"]
  NEWTABLE R8 0 0
  SETTABLEKS R8 R7 K23 ["requestMetadata"]
  LOADNIL R8
  SETTABLEKS R8 R7 K24 ["activeDraftGuids"]
  NEWTABLE R8 0 0
  SETTABLEKS R8 R7 K25 ["draftModeModels"]
  MOVE R8 R5
  CALL R8 0 1
  JUMPIFNOT R8 [+4]
  NEWTABLE R8 0 0
  SETTABLEKS R8 R7 K27 ["cachedAssetAttributionInfo"]
  LOADN R8 1
  SETTABLEKS R8 R7 K28 ["recordingActionNumber"]
  NEWTABLE R8 0 0
  SETTABLEKS R8 R7 K29 ["requestToRecordName"]
  NEWTABLE R8 0 0
  NEWTABLE R9 0 0
  DUPCLOSURE R10 K30 [PROTO_0]
  CAPTURE VAL R3
  CAPTURE VAL R8
  SETTABLEKS R10 R7 K31 ["get"]
  DUPCLOSURE R10 K32 [PROTO_1]
  CAPTURE VAL R8
  SETTABLEKS R10 R7 K33 ["set"]
  LOADNIL R10
  LOADNIL R11
  NEWCLOSURE R12 P2
  CAPTURE REF R11
  CAPTURE VAL R2
  CAPTURE VAL R7
  SETTABLEKS R12 R7 K34 ["StartRecordingActions"]
  NEWCLOSURE R12 P3
  CAPTURE REF R11
  CAPTURE VAL R2
  CAPTURE VAL R7
  CAPTURE REF R10
  CAPTURE VAL R4
  SETTABLEKS R12 R7 K35 ["EndRecordingActions"]
  DUPCLOSURE R12 K36 [PROTO_4]
  CAPTURE VAL R7
  DUPCLOSURE R13 K37 [PROTO_7]
  CAPTURE VAL R9
  CAPTURE VAL R7
  SETTABLEKS R13 R7 K38 ["GetRequestFolder"]
  DUPCLOSURE R13 K39 [PROTO_8]
  CAPTURE VAL R7
  SETTABLEKS R13 R7 K40 ["GetRequestMetadata"]
  DUPCLOSURE R13 K41 [PROTO_9]
  CAPTURE VAL R7
  SETTABLEKS R13 R7 K42 ["SetRequestMetadata"]
  DUPCLOSURE R13 K43 [PROTO_10]
  CAPTURE VAL R6
  CAPTURE VAL R7
  SETTABLEKS R13 R7 K44 ["clear"]
  DUPCLOSURE R13 K45 [PROTO_11]
  SETTABLEKS R13 R7 K46 ["destroy"]
  CLOSEUPVALS R10
  RETURN R7 1
