...
MAIN:
  ...
  CALL R3 2 1
  DUPTABLE R4 K14 [{"assetCacheMap", "guidToInfo", "chatBulletMap", "altDataMap", "requestRegionAdornments", "requestMetadata"}]
  NEWTABLE R5 0 0
  SETTABLEKS R5 R4 K8 ["assetCacheMap"]
  NEWTABLE R5 0 0
  SETTABLEKS R5 R4 K9 ["guidToInfo"]
  NEWTABLE R5 0 0
  SETTABLEKS R5 R4 K10 ["chatBulletMap"]
  NEWTABLE R5 0 0
  SETTABLEKS R5 R4 K11 ["altDataMap"]
  NEWTABLE R5 0 0
  SETTABLEKS R5 R4 K12 ["requestRegionAdornments"]
  NEWTABLE R5 0 0
  SETTABLEKS R5 R4 K13 ["requestMetadata"]
  JUMPIFNOT R2 [+12]
  NEWTABLE R5 0 0
  SETTABLEKS R5 R4 K8 ["assetCacheMap"]
  NEWTABLE R5 0 0
  SETTABLEKS R5 R4 K15 ["g2g"]
  NEWTABLE R5 0 0
  SETTABLEKS R5 R4 K16 ["guid2instance"]
  JUMPIFNOT R3 [+7]
  LOADNIL R5
  SETTABLEKS R5 R4 K17 ["activeDraftGuids"]
  NEWTABLE R5 0 0
  SETTABLEKS R5 R4 K18 ["draftModeModels"]
  NEWTABLE R5 0 0
  NEWTABLE R6 0 0
  DUPCLOSURE R7 K19 [PROTO_0]
  CAPTURE VAL R1
  CAPTURE VAL R5
  SETTABLEKS R7 R4 K20 ["get"]
  DUPCLOSURE R7 K21 [PROTO_1]
  CAPTURE VAL R5
  SETTABLEKS R7 R4 K22 ["set"]
  LOADNIL R7
  LOADNIL R8
  NEWCLOSURE R9 P2
  CAPTURE REF R8
  CAPTURE VAL R0
  SETTABLEKS R9 R4 K23 ["StartRecordingActions"]
  NEWCLOSURE R9 P3
  CAPTURE REF R8
  CAPTURE VAL R0
  CAPTURE REF R7
  SETTABLEKS R9 R4 K24 ["EndRecordingActions"]
  DUPCLOSURE R9 K25 [PROTO_4]
  CAPTURE VAL R4
  DUPCLOSURE R10 K26 [PROTO_7]
  CAPTURE VAL R6
  CAPTURE VAL R4
  SETTABLEKS R10 R4 K27 ["GetRequestFolder"]
  DUPCLOSURE R10 K28 [PROTO_8]
  CAPTURE VAL R4
  SETTABLEKS R10 R4 K29 ["GetRequestMetadata"]
  DUPCLOSURE R10 K30 [PROTO_9]
  CAPTURE VAL R4
  SETTABLEKS R10 R4 K31 ["SetRequestMetadata"]
  DUPCLOSURE R10 K32 [PROTO_10]
  SETTABLEKS R10 R4 K33 ["destroy"]
  CLOSEUPVALS R7
  RETURN R4 1
