...
MAIN:
  ...
  CALL R8 1 1
  DUPTABLE R9 K28 [{"assetCacheMap", "g2g", "guid2instance", "guidToInfo", "chatBulletMap", "altDataMap", "requestRegionAdornments", "requestMetadata", "activeDraftGuids", "draftModeModels"}]
  NEWTABLE R10 0 0
  SETTABLEKS R10 R9 K18 ["assetCacheMap"]
  NEWTABLE R10 0 0
  SETTABLEKS R10 R9 K19 ["g2g"]
  NEWTABLE R10 0 0
  SETTABLEKS R10 R9 K20 ["guid2instance"]
  NEWTABLE R10 0 0
  SETTABLEKS R10 R9 K21 ["guidToInfo"]
  NEWTABLE R10 0 0
  SETTABLEKS R10 R9 K22 ["chatBulletMap"]
  NEWTABLE R10 0 0
  SETTABLEKS R10 R9 K23 ["altDataMap"]
  NEWTABLE R10 0 0
  SETTABLEKS R10 R9 K24 ["requestRegionAdornments"]
  NEWTABLE R10 0 0
  SETTABLEKS R10 R9 K25 ["requestMetadata"]
  LOADNIL R10
  SETTABLEKS R10 R9 K26 ["activeDraftGuids"]
  NEWTABLE R10 0 0
  SETTABLEKS R10 R9 K27 ["draftModeModels"]
  MOVE R10 R5
  CALL R10 0 1
  JUMPIFNOT R10 [+4]
  NEWTABLE R10 0 0
  SETTABLEKS R10 R9 K29 ["cachedAssetAttributionInfo"]
  MOVE R10 R7
  CALL R10 0 1
  JUMPIFNOT R10 [+7]
  LOADN R10 1
  SETTABLEKS R10 R9 K30 ["recordingActionNumber"]
  NEWTABLE R10 0 0
  SETTABLEKS R10 R9 K31 ["requestToRecordName"]
  NEWTABLE R10 0 0
  NEWTABLE R11 0 0
  DUPCLOSURE R12 K32 [PROTO_0]
  CAPTURE VAL R3
  CAPTURE VAL R10
  SETTABLEKS R12 R9 K33 ["get"]
  DUPCLOSURE R12 K34 [PROTO_1]
  CAPTURE VAL R10
  SETTABLEKS R12 R9 K35 ["set"]
  LOADNIL R12
  LOADNIL R13
  NEWCLOSURE R14 P2
  CAPTURE REF R13
  ...
  CAPTURE VAL R9
  CAPTURE VAL R6
  SETTABLEKS R14 R9 K36 ["StartRecordingActions"]
  NEWCLOSURE R14 P3
  CAPTURE REF R13
  CAPTURE VAL R2
  CAPTURE VAL R7
  ...
  CAPTURE REF R12
  CAPTURE VAL R4
  SETTABLEKS R14 R9 K37 ["EndRecordingActions"]
  ...
  CAPTURE VAL R11
  CAPTURE VAL R9
  SETTABLEKS R15 R9 K40 ["GetRequestFolder"]
  DUPCLOSURE R15 K41 [PROTO_8]
  CAPTURE VAL R9
  SETTABLEKS R15 R9 K42 ["GetRequestMetadata"]
  DUPCLOSURE R15 K43 [PROTO_9]
  CAPTURE VAL R9
  SETTABLEKS R15 R9 K44 ["SetRequestMetadata"]
  DUPCLOSURE R15 K45 [PROTO_10]
  SETTABLEKS R15 R9 K46 ["destroy"]
  CLOSEUPVALS R12
  RETURN R9 1
