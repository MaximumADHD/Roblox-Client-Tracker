...
MAIN:
  ...
  CALL R1 2 1
  DUPTABLE R2 K11 [{"assetCacheMap", "guidToInfo", "chatBulletMap", "altDataMap", "requestRegionAdornments", "requestMetadata"}]
  NEWTABLE R3 0 0
  SETTABLEKS R3 R2 K5 ["assetCacheMap"]
  NEWTABLE R3 0 0
  SETTABLEKS R3 R2 K6 ["guidToInfo"]
  NEWTABLE R3 0 0
  SETTABLEKS R3 R2 K7 ["chatBulletMap"]
  NEWTABLE R3 0 0
  SETTABLEKS R3 R2 K8 ["altDataMap"]
  NEWTABLE R3 0 0
  SETTABLEKS R3 R2 K9 ["requestRegionAdornments"]
  NEWTABLE R3 0 0
  SETTABLEKS R3 R2 K10 ["requestMetadata"]
  NEWTABLE R3 0 0
  NEWTABLE R4 0 0
  DUPCLOSURE R5 K12 [PROTO_0]
  CAPTURE VAL R1
  CAPTURE VAL R3
  SETTABLEKS R5 R2 K13 ["get"]
  DUPCLOSURE R5 K14 [PROTO_1]
  CAPTURE VAL R3
  SETTABLEKS R5 R2 K15 ["set"]
  LOADNIL R5
  LOADNIL R6
  NEWCLOSURE R7 P2
  CAPTURE REF R6
  CAPTURE VAL R0
  SETTABLEKS R7 R2 K16 ["StartRecordingActions"]
  NEWCLOSURE R7 P3
  CAPTURE REF R6
  CAPTURE VAL R0
  CAPTURE REF R5
  SETTABLEKS R7 R2 K17 ["EndRecordingActions"]
  DUPCLOSURE R7 K18 [PROTO_4]
  CAPTURE VAL R2
  DUPCLOSURE R8 K19 [PROTO_7]
  CAPTURE VAL R4
  CAPTURE VAL R2
  SETTABLEKS R8 R2 K20 ["GetRequestFolder"]
  DUPCLOSURE R8 K21 [PROTO_8]
  CAPTURE VAL R2
  SETTABLEKS R8 R2 K22 ["GetRequestMetadata"]
  DUPCLOSURE R8 K23 [PROTO_9]
  CAPTURE VAL R2
  SETTABLEKS R8 R2 K24 ["SetRequestMetadata"]
  DUPCLOSURE R8 K25 [PROTO_10]
  SETTABLEKS R8 R2 K26 ["destroy"]
  CLOSEUPVALS R5
  RETURN R2 1
