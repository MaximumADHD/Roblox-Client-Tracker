PROTO_0:
  ...
  JUMPIFNOT R6 [+7]
  GETUPVAL R7 0
  GETTABLEKS R6 R7 K20 ["set"]
  GETTABLEKS R7 R1 K14 ["newInstanceId"]
  MOVE R8 R5
  CALL R6 2 0
  SETTABLEKS R5 R1 K21 ["direct_instance"]
  GETUPVAL R6 4
  GETTABLEKS R8 R0 K4 ["requestId"]
  LOADK R9 K22 ["SetProperty"]
  GETUPVAL R11 3
  CALL R11 0 1
  JUMPIFNOT R11 [+3]
  ...
  JUMPIF R10 [+1]
  MOVE R10 R0
  NAMECALL R6 R6 K23 ["ExecuteCommandAsync"]
  CALL R6 4 0
  GETUPVAL R7 2
  GETTABLEKS R6 R7 K24 ["getRequestParent"]
  MOVE R7 R5
  GETTABLEKS R8 R0 K4 ["requestId"]
  CALL R6 2 1
  SETTABLEKS R6 R5 K25 ["Parent"]
  GETUPVAL R7 0
  GETTABLEKS R6 R7 K26 ["EndRecordingActions"]
  GETTABLEKS R7 R0 K4 ["requestId"]
  CALL R6 1 0
  GETUPVAL R6 5
  GETTABLEKS R8 R0 K4 ["requestId"]
  MOVE R9 R4
  NAMECALL R6 R6 K27 ["AssetInserted"]
  CALL R6 3 0
  GETUPVAL R7 2
  GETTABLEKS R6 R7 K28 ["modifyChatWithInstanceLink"]
  GETTABLEKS R7 R0 K4 ["requestId"]
  MOVE R8 R5
  LOADK R9 K29 ["added"]
