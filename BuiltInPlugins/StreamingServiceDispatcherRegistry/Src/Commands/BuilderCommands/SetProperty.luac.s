...
PROTO_4:
  ...
  CALL R8 2 1
  JUMPIFNOT R8 [+12]
  GETIMPORT R8 K36 [game]
  LOADK R10 K37 ["ScriptEditorService"]
  NAMECALL R8 R8 K38 ["GetService"]
  CALL R8 2 1
  MOVE R10 R5
  NEWCLOSURE R11 P0
  CAPTURE VAL R6
  NAMECALL R8 R8 K39 ["UpdateSourceAsync"]
  CALL R8 3 0
  GETTABLEKS R8 R6 K40 ["color"]
  JUMPIFNOT R8 [+70]
  GETTABLEKS R8 R6 K40 ["color"]
  ...
  MOVE R10 R8
  GETIMPORT R9 K42 [typeof]
  CALL R9 1 1
  JUMPIFNOTEQKS R9 K43 ["string"] [+8]
  GETIMPORT R9 K46 [Color3.fromHex]
  MOVE R10 R8
  CALL R9 1 1
  SETTABLEKS R9 R5 K47 ["Color"]
  JUMP [+11]
  GETIMPORT R9 K49 [Color3.fromRGB]
  GETTABLEKS R10 R8 K50 ["r"]
  GETTABLEKS R11 R8 K51 ["g"]
  GETTABLEKS R12 R8 K52 ["b"]
  CALL R9 3 1
  SETTABLEKS R9 R5 K47 ["Color"]
  NAMECALL R8 R5 K53 ["GetDescendants"]
  CALL R8 1 3
  FORGPREP R8
  GETTABLEKS R13 R6 K40 ["color"]
  ...
  MOVE R15 R13
  GETIMPORT R14 K42 [typeof]
  CALL R14 1 1
  JUMPIFNOTEQKS R14 K43 ["string"] [+8]
  GETIMPORT R14 K46 [Color3.fromHex]
  MOVE R15 R13
  CALL R14 1 1
  SETTABLEKS R14 R12 K47 ["Color"]
  JUMP [+11]
  GETIMPORT R14 K49 [Color3.fromRGB]
  GETTABLEKS R15 R13 K50 ["r"]
  GETTABLEKS R16 R13 K51 ["g"]
  GETTABLEKS R17 R13 K52 ["b"]
  CALL R14 3 1
  SETTABLEKS R14 R12 K47 ["Color"]
  FORGLOOP R8 2 [-33]
  GETTABLEKS R8 R6 K54 ["material"]
  JUMPIFNOT R8 [+12]
  LOADK R10 K16 ["BasePart"]
  NAMECALL R8 R5 K17 ["IsA"]
  CALL R8 2 1
  JUMPIFNOT R8 [+7]
  GETIMPORT R9 K57 [Enum.Material]
  GETTABLEKS R10 R6 K54 ["material"]
  GETTABLE R8 R9 R10
  SETTABLEKS R8 R5 K56 ["Material"]
  MOVE R8 R3
  JUMPIF R8 [+11]
  GETTABLEKS R8 R6 K58 ["position"]
  JUMPIF R8 [+8]
  GETTABLEKS R8 R6 K59 ["elevation"]
  JUMPIF R8 [+5]
  GETTABLEKS R8 R6 K60 ["rotation"]
  JUMPIF R8 [+2]
  GETTABLEKS R8 R6 K61 ["referenceInstance"]
  JUMPIFNOT R8 [+10]
  GETUPVAL R10 2
  ...
  JUMPIF R3 [+5]
  GETUPVAL R10 0
  GETTABLEKS R9 R10 K62 ["EndRecordingActions"]
  MOVE R10 R1
  CALL R9 1 0
  GETUPVAL R9 3
  CALL R9 0 1
...
MAIN:
  ...
  GETTABLEKS R7 R0 K6 ["Src"]
  GETTABLEKS R6 R7 K12 ["ContextCollectors"]
  GETTABLEKS R5 R6 K13 ["RecentInstancesContext"]
  CALL R4 1 1
  GETIMPORT R5 K5 [require]
  GETTABLEKS R8 R0 K6 ["Src"]
  GETTABLEKS R7 R8 K14 ["Flags"]
  GETTABLEKS R6 R7 K15 ["getFFlagCAPRecentInstancesContext"]
  CALL R5 1 1
