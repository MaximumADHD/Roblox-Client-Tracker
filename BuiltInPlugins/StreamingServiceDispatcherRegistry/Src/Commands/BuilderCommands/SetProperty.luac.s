...
PROTO_4:
  ...
  NEWCLOSURE R11 P0
  CAPTURE VAL R6
  NAMECALL R8 R8 K35 ["UpdateSourceAsync"]
  CALL R8 3 0
  GETTABLEKS R8 R6 K36 ["color"]
  JUMPIFNOT R8 [+70]
  GETTABLEKS R8 R6 K36 ["color"]
  ...
  MOVE R10 R8
  GETIMPORT R9 K38 [typeof]
  CALL R9 1 1
  JUMPIFNOTEQKS R9 K39 ["string"] [+8]
  GETIMPORT R9 K42 [Color3.fromHex]
  MOVE R10 R8
  CALL R9 1 1
  SETTABLEKS R9 R5 K43 ["Color"]
  JUMP [+11]
  GETIMPORT R9 K45 [Color3.fromRGB]
  GETTABLEKS R10 R8 K46 ["r"]
  GETTABLEKS R11 R8 K47 ["g"]
  GETTABLEKS R12 R8 K48 ["b"]
  CALL R9 3 1
  SETTABLEKS R9 R5 K43 ["Color"]
  NAMECALL R8 R5 K49 ["GetDescendants"]
  CALL R8 1 3
  FORGPREP R8
  GETTABLEKS R13 R6 K36 ["color"]
  ...
  MOVE R15 R13
  GETIMPORT R14 K38 [typeof]
  CALL R14 1 1
  JUMPIFNOTEQKS R14 K39 ["string"] [+8]
  GETIMPORT R14 K42 [Color3.fromHex]
  MOVE R15 R13
  CALL R14 1 1
  SETTABLEKS R14 R12 K43 ["Color"]
  JUMP [+11]
  GETIMPORT R14 K45 [Color3.fromRGB]
  GETTABLEKS R15 R13 K46 ["r"]
  GETTABLEKS R16 R13 K47 ["g"]
  GETTABLEKS R17 R13 K48 ["b"]
  CALL R14 3 1
  SETTABLEKS R14 R12 K43 ["Color"]
  FORGLOOP R8 2 [-33]
  GETTABLEKS R8 R6 K50 ["material"]
  JUMPIFNOT R8 [+12]
  LOADK R10 K16 ["BasePart"]
  NAMECALL R8 R5 K17 ["IsA"]
  CALL R8 2 1
  JUMPIFNOT R8 [+7]
  GETIMPORT R9 K53 [Enum.Material]
  GETTABLEKS R10 R6 K50 ["material"]
  GETTABLE R8 R9 R10
  SETTABLEKS R8 R5 K52 ["Material"]
  MOVE R8 R3
  JUMPIF R8 [+11]
  GETTABLEKS R8 R6 K54 ["position"]
  JUMPIF R8 [+8]
  GETTABLEKS R8 R6 K55 ["elevation"]
  JUMPIF R8 [+5]
  GETTABLEKS R8 R6 K56 ["rotation"]
  JUMPIF R8 [+2]
  GETTABLEKS R8 R6 K57 ["referenceInstance"]
  JUMPIFNOT R8 [+10]
  GETUPVAL R10 2
  ...
  JUMPIF R3 [+5]
  GETUPVAL R10 0
  GETTABLEKS R9 R10 K58 ["EndRecordingActions"]
  MOVE R10 R1
  CALL R9 1 0
  GETUPVAL R9 4
  CALL R9 0 1
  JUMPIFNOT R9 [+5]
  GETUPVAL R10 5
  GETTABLEKS R9 R10 K59 ["registerInstance"]
  MOVE R10 R5
  CALL R9 1 0
  RETURN R0 0
