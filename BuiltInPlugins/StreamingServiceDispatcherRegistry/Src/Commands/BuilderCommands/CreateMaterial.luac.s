...
PROTO_5:
  ...
  JUMPIFNOT R1 [+7]
  GETUPVAL R2 2
  GETTABLEKS R1 R2 K0 ["GetPluginComponent"]
  LOADK R2 K1 ["MaterialGenerator"]
  CALL R1 1 1
  MOVE R0 R1
  JUMP [+8]
  GETUPVAL R2 3
  GETTABLEKS R1 R2 K2 ["Parent"]
  LOADK R4 K1 ["MaterialGenerator"]
  NAMECALL R2 R1 K0 ["GetPluginComponent"]
  CALL R2 2 1
  MOVE R0 R2
  NEWTABLE R1 0 0
  GETUPVAL R5 4
  GETTABLEKS R2 R5 K3 ["materialVariants"]
  LOADNIL R3
  LOADNIL R4
  FORGPREP R2
  SUBK R7 R5 K4 [1]
  ...
  GETUPVAL R0 6
  GETUPVAL R2 4
  NAMECALL R0 R0 K12 ["DEPRECATED_UploadMaterialVariantsAsync"]
  CALL R0 2 -1
  RETURN R0 -1
...
MAIN:
  ...
  GETTABLEKS R15 R16 K25 ["getFFlagAddStreamingServiceDispatcherTests"]
  CALL R14 1 1
  GETIMPORT R15 K5 [require]
  GETTABLEKS R18 R0 K6 ["Src"]
  GETTABLEKS R17 R18 K21 ["Flags"]
  GETTABLEKS R16 R17 K26 ["getFFlagRejectMaterialGeneratorError"]
  CALL R15 1 1
  GETIMPORT R16 K5 [require]
  GETTABLEKS R19 R0 K6 ["Src"]
  GETTABLEKS R18 R19 K21 ["Flags"]
  GETTABLEKS R17 R18 K27 ["getFFlagConvAIAddClientAlerts"]
  CALL R16 1 1
  ...
  CAPTURE VAL R10
  CAPTURE VAL R4
  DUPCLOSURE R24 K35 [PROTO_13]
  CAPTURE VAL R23
  DUPCLOSURE R25 K36 [PROTO_14]
  CAPTURE VAL R10
  CAPTURE VAL R23
  CAPTURE VAL R9
  CAPTURE VAL R11
