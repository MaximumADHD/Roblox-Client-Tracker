...
PROTO_3:
  ...
  JUMPIFNOT R13 [+7]
  GETUPVAL R14 5
  GETTABLEKS R13 R14 K15 ["guid2instance"]
  NAMECALL R14 R10 K16 ["GetDebugId"]
  CALL R14 1 1
...
PROTO_4:
  ...
  DUPTABLE R13 K10 [{"instanceId", "className", "instanceName", "size", "pos"}]
  SETTABLEKS R8 R13 K5 ["instanceId"]
  GETTABLEKS R14 R8 K11 ["ClassName"]
  SETTABLEKS R14 R13 K6 ["className"]
  GETTABLEKS R14 R8 K12 ["Name"]
  SETTABLEKS R14 R13 K7 ["instanceName"]
  SETTABLEKS R10 R13 K8 ["size"]
  SETTABLEKS R9 R13 K9 ["pos"]
  FASTCALL2 TABLE_INSERT R12 R13 [+3]
  GETIMPORT R11 K15 [table.insert]
  CALL R11 2 0
  FORGLOOP R4 2 [-39]
  GETUPVAL R4 6
  NAMECALL R4 R4 K16 ["GetSettings"]
  CALL R4 1 1
  GETTABLEKS R3 R4 K17 ["UseInventoryAssets"]
  SETTABLEKS R3 R1 K18 ["use_inventory_assets"]
  RETURN R1 1
...
MAIN:
  ...
  CALL R11 2 1
  GETIMPORT R12 K26 [OverlapParams.new]
  CALL R12 0 1
  LOADB R13 1
  SETTABLEKS R13 R12 K27 ["BruteForceAllSlow"]
  ...
  CAPTURE VAL R7
  CAPTURE VAL R16
  SETTABLEKS R17 R5 K33 ["register"]
  DUPCLOSURE R17 K34 [PROTO_7]
  CAPTURE VAL R0
  SETTABLEKS R17 R5 K35 ["unregister"]
  RETURN R5 1
