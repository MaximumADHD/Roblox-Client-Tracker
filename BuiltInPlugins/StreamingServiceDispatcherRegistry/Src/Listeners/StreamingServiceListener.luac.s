...
PROTO_15:
  JUMPIFNOTEQKS R1 K0 ["attribution"] [+62]
  MOVE R5 R2
  NAMECALL R3 R0 K1 ["getActionInstance"]
  CALL R3 2 3
  LENGTH R6 R3
  LOADN R7 0
  JUMPIFNOTLT R7 R6 [+83]
  GETUPVAL R8 0
...
MAIN:
  ...
  GETTABLEKS R23 R24 K34 ["getFFlagConvAICodeRunnerExecuteCommand"]
  CALL R22 1 1
  GETIMPORT R23 K6 [require]
  GETTABLEKS R26 R1 K7 ["Src"]
  GETTABLEKS R25 R26 K30 ["Flags"]
  GETTABLEKS R24 R25 K35 ["getFFlagFixCurrentCameraPlacement"]
  CALL R23 1 1
  GETIMPORT R24 K6 [require]
  GETTABLEKS R27 R1 K7 ["Src"]
  GETTABLEKS R26 R27 K30 ["Flags"]
  GETTABLEKS R25 R26 K36 ["getFFlagAddStreamingServiceDispatcherTests"]
  CALL R24 1 1
  GETIMPORT R25 K6 [require]
  GETTABLEKS R28 R1 K7 ["Src"]
  GETTABLEKS R27 R28 K30 ["Flags"]
  GETTABLEKS R26 R27 K37 ["getFFlagConvAIFixEmptyBubbleBug"]
  CALL R25 1 1
  GETIMPORT R26 K6 [require]
  GETTABLEKS R29 R1 K7 ["Src"]
  GETTABLEKS R28 R29 K30 ["Flags"]
  GETTABLEKS R27 R28 K38 ["getFFlagAutoNormalizeBoundingBoxesForInsertedAssets"]
  CALL R26 1 1
  GETIMPORT R27 K6 [require]
  GETTABLEKS R30 R1 K7 ["Src"]
  GETTABLEKS R29 R30 K30 ["Flags"]
  GETTABLEKS R28 R29 K39 ["getFFlagCAPRemoveDisclaimer"]
  CALL R27 1 1
  LOADB R28 0
  NEWCLOSURE R29 P0
  CAPTURE VAL R21
  CAPTURE REF R28
  CAPTURE VAL R25
  SETGLOBAL R29 K40 ["handleCachedPacketsForStream"]
  DUPCLOSURE R29 K41 [PROTO_1]
  CAPTURE VAL R13
  CAPTURE VAL R7
  DUPCLOSURE R30 K42 [PROTO_2]
  CAPTURE VAL R15
  SETTABLEKS R30 R0 K43 ["getActionInstance"]
  DUPCLOSURE R30 K44 [PROTO_3]
  CAPTURE VAL R15
  CAPTURE VAL R20
  SETTABLEKS R30 R0 K45 ["getActionInstanceFromGuid"]
  DUPCLOSURE R30 K46 [PROTO_4]
  CAPTURE VAL R19
  CAPTURE VAL R15
  SETTABLEKS R30 R0 K47 ["onShiftAssetToId"]
  ...
  CAPTURE VAL R10
  CAPTURE VAL R29
  SETTABLEKS R30 R0 K49 ["onShiftAssetVariant"]
  ...
  CAPTURE VAL R6
  CAPTURE VAL R27
  SETTABLEKS R33 R0 K54 ["onAction"]
  DUPCLOSURE R33 K55 [PROTO_15]
  CAPTURE VAL R15
  CAPTURE VAL R13
  CAPTURE VAL R24
  CAPTURE VAL R16
  SETTABLEKS R33 R0 K56 ["getPluginInfo"]
  DUPCLOSURE R33 K57 [PROTO_31]
  CAPTURE VAL R5
  CAPTURE VAL R8
  CAPTURE VAL R6
  CAPTURE VAL R18
  ...
  CAPTURE VAL R17
  CAPTURE VAL R13
  DUPCLOSURE R34 K58 [PROTO_32]
  CAPTURE VAL R5
  SETTABLEKS R34 R0 K59 ["destroy"]
  DUPCLOSURE R34 K60 [PROTO_33]
  CAPTURE VAL R33
  CAPTURE VAL R0
  SETTABLEKS R34 R0 K61 ["new"]
  CLOSEUPVALS R28
  RETURN R0 1
