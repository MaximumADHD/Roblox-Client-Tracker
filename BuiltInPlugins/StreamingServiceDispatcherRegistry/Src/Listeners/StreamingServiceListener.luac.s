...
MAIN:
  ...
  SETGLOBAL R18 K31 ["handleCachedPacketsForStream"]
  ...
  CAPTURE VAL R12
  CAPTURE VAL R16
  SETTABLEKS R19 R0 K34 ["getActionInstance"]
  DUPCLOSURE R19 K35 [PROTO_3]
  CAPTURE VAL R12
  CAPTURE VAL R17
  SETTABLEKS R19 R0 K36 ["getActionInstanceFromGuid"]
  DUPCLOSURE R19 K37 [PROTO_4]
  CAPTURE VAL R12
  SETTABLEKS R19 R0 K38 ["onShiftAssetToId"]
  ...
  CAPTURE VAL R7
  CAPTURE VAL R18
  SETTABLEKS R19 R0 K40 ["onShiftAssetVariant"]
  DUPCLOSURE R19 K41 [PROTO_8]
  CAPTURE VAL R2
  CAPTURE VAL R10
  DUPCLOSURE R20 K42 [PROTO_10]
  DUPCLOSURE R21 K43 [PROTO_11]
  CAPTURE VAL R0
  CAPTURE VAL R7
  CAPTURE VAL R20
  CAPTURE VAL R1
  ...
  CAPTURE VAL R21
  CAPTURE VAL R4
  SETTABLEKS R22 R0 K45 ["onAction"]
  DUPCLOSURE R22 K46 [PROTO_15]
  CAPTURE VAL R13
  CAPTURE VAL R12
  SETTABLEKS R22 R0 K47 ["getPluginInfo"]
  DUPCLOSURE R22 K48 [PROTO_30]
  CAPTURE VAL R3
  CAPTURE VAL R6
  CAPTURE VAL R4
  CAPTURE VAL R2
  ...
  CAPTURE VAL R11
  CAPTURE VAL R17
  DUPCLOSURE R23 K49 [PROTO_31]
  CAPTURE VAL R15
  CAPTURE VAL R3
  SETTABLEKS R23 R0 K50 ["destroy"]
  DUPCLOSURE R23 K51 [PROTO_32]
  CAPTURE VAL R22
  CAPTURE VAL R0
  SETTABLEKS R23 R0 K52 ["new"]
  RETURN R0 1
