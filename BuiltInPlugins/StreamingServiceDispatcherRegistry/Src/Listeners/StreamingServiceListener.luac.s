...
PROTO_5:
  ...
  JUMP [+22]
  GETUPVAL R5 1
  GETTABLEKS R4 R5 K13 ["getRequestCFrame"]
  GETTABLEKS R5 R0 K14 ["requestId"]
  CALL R4 1 1
  GETTABLEKS R7 R3 K9 ["Position"]
  NAMECALL R5 R4 K15 ["PointToObjectSpace"]
  CALL R5 2 1
  DUPTABLE R6 K8 [{"x", "z"}]
  ...
  GETUPVAL R4 4
  SETTABLEKS R4 R1 K16 ["altDataId"]
  GETUPVAL R2 0
  GETUPVAL R3 5
  SETTABLEKS R3 R2 K17 ["assetId"]
  GETUPVAL R2 6
  LOADB R3 1
  SETTABLEKS R3 R2 K18 ["deferedSelection"]
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K19 ["isAssetCached"]
  GETUPVAL R3 5
  CALL R2 1 1
  JUMPIF R2 [+5]
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K20 ["loadAssetAsync"]
  GETUPVAL R3 5
  CALL R2 1 0
  GETUPVAL R2 7
  GETTABLEKS R4 R0 K14 ["requestId"]
  LOADK R5 K21 ["InsertAsset"]
  GETUPVAL R7 8
  CALL R7 0 1
  JUMPIFNOT R7 [+3]
  ...
  JUMPIF R6 [+1]
  MOVE R6 R0
  NAMECALL R2 R2 K22 ["ExecuteCommandAsync"]
  CALL R2 4 0
  GETUPVAL R5 9
  GETTABLEKS R4 R5 K23 ["guidToInfo"]
  GETUPVAL R5 4
  GETTABLE R3 R4 R5
  GETTABLEKS R2 R3 K24 ["instance"]
  GETUPVAL R3 10
  NAMECALL R3 R3 K25 ["Get"]
  CALL R3 1 1
  LOADB R4 0
  LOADN R7 1
  LENGTH R5 R3
  ...
  GETUPVAL R5 10
  MOVE R7 R3
  NAMECALL R5 R5 K26 ["Set"]
  CALL R5 2 0
  GETUPVAL R5 2
  LOADK R7 K27 ["AssetId"]
  NAMECALL R5 R5 K28 ["GetAttribute"]
  CALL R5 2 1
  LOADK R8 K27 ["AssetId"]
  NAMECALL R6 R2 K28 ["GetAttribute"]
  CALL R6 2 1
  GETUPVAL R7 11
  GETTABLEKS R9 R0 K14 ["requestId"]
  MOVE R10 R5
  MOVE R11 R6
  NAMECALL R7 R7 K29 ["AlternativeAssetSelected"]
  CALL R7 4 0
  GETUPVAL R7 2
  LOADNIL R8
  SETTABLEKS R8 R7 K30 ["Parent"]
  GETUPVAL R7 6
  LOADB R8 0
  SETTABLEKS R8 R7 K18 ["deferedSelection"]
  GETUPVAL R7 12
  SUBK R7 R7 K31 [1]
  SETUPVAL R7 12
  GETUPVAL R7 13
  NAMECALL R7 R7 K32 ["Fire"]
  CALL R7 1 0
  RETURN R0 0
...
PROTO_16:
  ...
  CALL R5 0 1
  JUMPIFNOT R5 [+12]
  SETTABLEKS R1 R3 K2 ["command"]
  MOVE R5 R4
  JUMPIF R5 [+7]
  GETTABLEKS R5 R3 K3 ["arguments"]
  JUMPIFNOT R5 [+4]
  GETTABLEKS R6 R3 K3 ["arguments"]
  GETTABLEKS R5 R6 K4 ["syncStreamId"]
  MOVE R4 R5
  GETUPVAL R6 2
