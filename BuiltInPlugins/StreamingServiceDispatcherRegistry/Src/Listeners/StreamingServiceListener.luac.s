...
MAIN:
  ...
  CAPTURE VAL R22
  CAPTURE REF R23
  SETGLOBAL R24 K35 ["handleCachedPacketsForStream"]
  DUPCLOSURE R24 K36 [PROTO_1]
  CAPTURE VAL R13
  CAPTURE VAL R7
  DUPCLOSURE R25 K37 [PROTO_2]
  CAPTURE VAL R15
  SETTABLEKS R25 R0 K38 ["getActionInstance"]
  DUPCLOSURE R25 K39 [PROTO_3]
  CAPTURE VAL R15
  CAPTURE VAL R20
  SETTABLEKS R25 R0 K40 ["getActionInstanceFromGuid"]
  DUPCLOSURE R25 K41 [PROTO_4]
  CAPTURE VAL R19
  CAPTURE VAL R15
  SETTABLEKS R25 R0 K42 ["onShiftAssetToId"]
  ...
  CAPTURE VAL R10
  CAPTURE VAL R24
  SETTABLEKS R25 R0 K44 ["onShiftAssetVariant"]
  ...
  CAPTURE VAL R27
  CAPTURE VAL R6
  SETTABLEKS R28 R0 K49 ["onAction"]
  DUPCLOSURE R28 K50 [PROTO_15]
  CAPTURE VAL R15
  CAPTURE VAL R13
  CAPTURE VAL R16
  SETTABLEKS R28 R0 K51 ["getPluginInfo"]
  DUPCLOSURE R28 K52 [PROTO_31]
  CAPTURE VAL R5
  CAPTURE VAL R8
  CAPTURE VAL R6
  CAPTURE VAL R21
  ...
  CAPTURE VAL R17
  CAPTURE VAL R13
  DUPCLOSURE R29 K53 [PROTO_32]
  CAPTURE VAL R5
  SETTABLEKS R29 R0 K54 ["destroy"]
  DUPCLOSURE R29 K55 [PROTO_33]
  CAPTURE VAL R28
  CAPTURE VAL R0
  SETTABLEKS R29 R0 K56 ["new"]
  CLOSEUPVALS R23
  RETURN R0 1
