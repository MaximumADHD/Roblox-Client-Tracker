...
PROTO_31:
  ...
  GETTABLEKS R7 R8 K5 ["Cache"]
  GETTABLEKS R6 R7 K6 ["StreamCache"]
  CALL R5 1 1
  GETTABLEKS R6 R4 K7 ["Stream"]
  NEWCLOSURE R8 P0
  CAPTURE REF R3
  CAPTURE UPVAL U4
  CAPTURE VAL R5
  ...
  CALL R6 2 1
  SETTABLEKS R6 R0 K9 ["_streamConn"]
  GETTABLEKS R6 R4 K10 ["RequestStarted"]
  NEWCLOSURE R8 P1
  CAPTURE VAL R5
  NAMECALL R6 R6 K8 ["Connect"]
  CALL R6 2 1
  SETTABLEKS R6 R0 K11 ["_requestStartedConn"]
  GETTABLEKS R6 R4 K12 ["RequestEnded"]
  NEWCLOSURE R8 P2
  CAPTURE VAL R5
  NAMECALL R6 R6 K8 ["Connect"]
  CALL R6 2 1
  SETTABLEKS R6 R0 K13 ["_requestEndedConn"]
  GETTABLEKS R6 R4 K14 ["ConversationCleared"]
  DUPCLOSURE R8 K15 [PROTO_19]
  CAPTURE UPVAL U5
  NAMECALL R6 R6 K8 ["Connect"]
  CALL R6 2 1
  SETTABLEKS R6 R0 K16 ["_conversationClearedConn"]
  GETTABLEKS R6 R4 K17 ["SequentialCommandsFinished"]
  NEWCLOSURE R8 P4
  CAPTURE REF R2
  NAMECALL R6 R6 K8 ["Connect"]
  CALL R6 2 1
  SETTABLEKS R6 R0 K18 ["_commandsFinished"]
  GETTABLEKS R6 R2 K19 ["FindVariationsSignal"]
  NEWCLOSURE R8 P5
  CAPTURE VAL R0
  CAPTURE UPVAL U6
  CAPTURE UPVAL U7
  NAMECALL R6 R6 K8 ["Connect"]
  CALL R6 2 1
  SETTABLEKS R6 R0 K20 ["_findVariations"]
  GETTABLEKS R6 R2 K21 ["SetMaterialSettingsSignal"]
  NEWCLOSURE R8 P6
  CAPTURE VAL R0
  NAMECALL R6 R6 K8 ["Connect"]
  CALL R6 2 1
  SETTABLEKS R6 R0 K22 ["_setMaterialSettings"]
  GETTABLEKS R6 R2 K23 ["ActionActivatedSignal"]
  NEWCLOSURE R8 P7
  CAPTURE VAL R0
  NAMECALL R6 R6 K8 ["Connect"]
  CALL R6 2 1
  SETTABLEKS R6 R0 K24 ["_onActionConnection"]
  GETTABLEKS R6 R2 K25 ["ShiftVariationSignal"]
  NEWCLOSURE R8 P8
  CAPTURE VAL R0
  NAMECALL R6 R6 K8 ["Connect"]
  CALL R6 2 1
  SETTABLEKS R6 R0 K26 ["_onShiftAssetVariation"]
  GETTABLEKS R6 R2 K27 ["ShiftToAssetIdSignal"]
  NEWCLOSURE R8 P9
  CAPTURE VAL R0
  NAMECALL R6 R6 K8 ["Connect"]
  CALL R6 2 1
  SETTABLEKS R6 R0 K28 ["_onShiftAssetToId"]
  GETTABLEKS R6 R4 K10 ["RequestStarted"]
  DUPCLOSURE R8 K29 [PROTO_26]
  CAPTURE UPVAL U8
  NAMECALL R6 R6 K8 ["Connect"]
  CALL R6 2 1
  SETTABLEKS R6 R0 K30 ["_requestStartedConnection"]
  GETTABLEKS R6 R4 K31 ["RequestError"]
  DUPCLOSURE R8 K32 [PROTO_27]
  CAPTURE UPVAL U9
  CAPTURE UPVAL U8
  NAMECALL R6 R6 K8 ["Connect"]
  CALL R6 2 1
  SETTABLEKS R6 R0 K33 ["_requestErrorConnection"]
  GETTABLEKS R6 R4 K12 ["RequestEnded"]
  DUPCLOSURE R8 K34 [PROTO_28]
  CAPTURE UPVAL U8
  NAMECALL R6 R6 K8 ["Connect"]
  CALL R6 2 1
  SETTABLEKS R6 R0 K35 ["_requestEndedConnection"]
  GETTABLEKS R6 R4 K17 ["SequentialCommandsFinished"]
  DUPCLOSURE R8 K36 [PROTO_29]
  CAPTURE UPVAL U8
  CAPTURE UPVAL U10
  NAMECALL R6 R6 K8 ["Connect"]
  CALL R6 2 1
  SETTABLEKS R6 R0 K37 ["_sequentialCommandsFinishedConnection"]
  NEWCLOSURE R8 P14
  CAPTURE VAL R0
  NAMECALL R6 R1 K38 ["SetPluginInfoCallback"]
  CALL R6 2 0
  CLOSEUPVALS R2
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R23 R24 K34 ["getFFlagFixAssistantLuaTests"]
  CALL R22 1 1
  GETIMPORT R23 K6 [require]
  GETTABLEKS R26 R1 K7 ["Src"]
  GETTABLEKS R25 R26 K30 ["Flags"]
  GETTABLEKS R24 R25 K35 ["getFFlagConvAIFixStreamCreationTiming"]
  CALL R23 1 1
  LOADB R24 0
  NEWCLOSURE R25 P0
  CAPTURE VAL R23
  CAPTURE REF R24
  SETGLOBAL R25 K36 ["handleCachedPacketsForStream"]
  DUPCLOSURE R25 K37 [PROTO_1]
  CAPTURE VAL R13
  CAPTURE VAL R7
  DUPCLOSURE R26 K38 [PROTO_2]
  CAPTURE VAL R15
  SETTABLEKS R26 R0 K39 ["getActionInstance"]
  DUPCLOSURE R26 K40 [PROTO_3]
  CAPTURE VAL R15
  CAPTURE VAL R20
  SETTABLEKS R26 R0 K41 ["getActionInstanceFromGuid"]
  DUPCLOSURE R26 K42 [PROTO_4]
  CAPTURE VAL R19
  CAPTURE VAL R15
  SETTABLEKS R26 R0 K43 ["onShiftAssetToId"]
  ...
  CAPTURE VAL R10
  CAPTURE VAL R25
  SETTABLEKS R26 R0 K45 ["onShiftAssetVariant"]
  DUPCLOSURE R26 K46 [PROTO_8]
  CAPTURE VAL R4
  CAPTURE VAL R12
  DUPCLOSURE R27 K47 [PROTO_10]
  DUPCLOSURE R28 K48 [PROTO_11]
  CAPTURE VAL R0
  CAPTURE VAL R9
  CAPTURE VAL R27
  CAPTURE VAL R3
  DUPCLOSURE R29 K49 [PROTO_14]
  CAPTURE VAL R9
  CAPTURE VAL R11
  CAPTURE VAL R25
  CAPTURE VAL R28
  CAPTURE VAL R6
  SETTABLEKS R29 R0 K50 ["onAction"]
  DUPCLOSURE R29 K51 [PROTO_15]
  CAPTURE VAL R15
  CAPTURE VAL R13
  CAPTURE VAL R16
  SETTABLEKS R29 R0 K52 ["getPluginInfo"]
