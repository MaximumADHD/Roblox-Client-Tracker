...
PROTO_5:
  ...
  GETUPVAL R5 6
  LOADB R6 0
  SETTABLEKS R6 R5 K20 ["deferedSelection"]
  GETUPVAL R5 13
  SUBK R5 R5 K35 [1]
  SETUPVAL R5 13
  GETUPVAL R5 14
  NAMECALL R5 R5 K36 ["Fire"]
  CALL R5 1 0
  RETURN R0 0
...
MAIN:
  ...
  LOADK R11 K13 ["ConvAIFirstVariationFix"]
  NAMECALL R9 R9 K12 ["GetFastFlag"]
  CALL R9 2 1
  LOADNIL R10
  JUMPIFNOT R8 [+7]
  ...
  LOADK R25 K35 ["ConvAIFixVariantShiftBug"]
  NAMECALL R23 R23 K12 ["GetFastFlag"]
  CALL R23 2 1
  DUPCLOSURE R24 K36 [PROTO_0]
  SETGLOBAL R24 K37 ["handleCachedPacketsForStream"]
  ...
  CAPTURE VAL R15
  CAPTURE VAL R18
  SETTABLEKS R25 R0 K40 ["getActionInstance"]
  DUPCLOSURE R25 K41 [PROTO_3]
  CAPTURE VAL R15
  CAPTURE VAL R22
  CAPTURE VAL R19
  SETTABLEKS R25 R0 K42 ["getActionInstanceFromGuid"]
  DUPCLOSURE R25 K43 [PROTO_4]
  CAPTURE VAL R9
  CAPTURE VAL R15
  SETTABLEKS R25 R0 K44 ["onShiftAssetToId"]
  NEWCLOSURE R25 P5
  CAPTURE VAL R9
  CAPTURE VAL R15
  CAPTURE VAL R20
  ...
  CAPTURE REF R10
  CAPTURE VAL R24
  SETTABLEKS R25 R0 K45 ["onShiftAssetVariant"]
  ...
  CAPTURE VAL R27
  CAPTURE VAL R4
  SETTABLEKS R28 R0 K50 ["onAction"]
  DUPCLOSURE R28 K51 [PROTO_15]
  CAPTURE VAL R15
  CAPTURE VAL R14
  CAPTURE VAL R16
  SETTABLEKS R28 R0 K52 ["getPluginInfo"]
  DUPCLOSURE R28 K53 [PROTO_30]
  CAPTURE VAL R3
  CAPTURE VAL R6
  CAPTURE VAL R4
  CAPTURE VAL R2
  ...
  CAPTURE VAL R14
  CAPTURE VAL R19
  DUPCLOSURE R29 K54 [PROTO_31]
  CAPTURE VAL R3
  SETTABLEKS R29 R0 K55 ["destroy"]
  DUPCLOSURE R29 K56 [PROTO_32]
  CAPTURE VAL R28
  CAPTURE VAL R0
  SETTABLEKS R29 R0 K57 ["new"]
  CLOSEUPVALS R10
  RETURN R0 1
