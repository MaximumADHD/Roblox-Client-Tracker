...
MAIN:
  ...
  CAPTURE REF R27
  CAPTURE VAL R25
  SETGLOBAL R28 K39 ["handleCachedPacketsForStream"]
  DUPCLOSURE R28 K40 [PROTO_1]
  CAPTURE VAL R13
  CAPTURE VAL R7
  DUPCLOSURE R29 K41 [PROTO_2]
  CAPTURE VAL R15
  SETTABLEKS R29 R0 K42 ["getActionInstance"]
  DUPCLOSURE R29 K43 [PROTO_3]
  CAPTURE VAL R15
  CAPTURE VAL R20
  SETTABLEKS R29 R0 K44 ["getActionInstanceFromGuid"]
  DUPCLOSURE R29 K45 [PROTO_4]
  CAPTURE VAL R19
  CAPTURE VAL R15
  SETTABLEKS R29 R0 K46 ["onShiftAssetToId"]
  ...
  CAPTURE VAL R10
  CAPTURE VAL R28
  SETTABLEKS R29 R0 K48 ["onShiftAssetVariant"]
  DUPCLOSURE R29 K49 [PROTO_8]
  CAPTURE VAL R4
  CAPTURE VAL R12
  DUPCLOSURE R30 K50 [PROTO_10]
  DUPCLOSURE R31 K51 [PROTO_11]
  CAPTURE VAL R0
  CAPTURE VAL R9
  CAPTURE VAL R30
  CAPTURE VAL R3
  ...
  CAPTURE VAL R31
  CAPTURE VAL R6
  SETTABLEKS R32 R0 K53 ["onAction"]
  DUPCLOSURE R32 K54 [PROTO_15]
  CAPTURE VAL R15
  CAPTURE VAL R13
  CAPTURE VAL R24
  CAPTURE VAL R16
  SETTABLEKS R32 R0 K55 ["getPluginInfo"]
  DUPCLOSURE R32 K56 [PROTO_31]
  CAPTURE VAL R5
  CAPTURE VAL R8
  CAPTURE VAL R6
  CAPTURE VAL R18
  ...
  CAPTURE VAL R17
  CAPTURE VAL R13
  DUPCLOSURE R33 K57 [PROTO_32]
  CAPTURE VAL R5
  SETTABLEKS R33 R0 K58 ["destroy"]
  DUPCLOSURE R33 K59 [PROTO_33]
  CAPTURE VAL R32
  CAPTURE VAL R0
  SETTABLEKS R33 R0 K60 ["new"]
  CLOSEUPVALS R27
  RETURN R0 1
