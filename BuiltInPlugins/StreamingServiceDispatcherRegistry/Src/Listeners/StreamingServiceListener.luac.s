...
MAIN:
  ...
  LOADK R10 K11 ["ConversationalAIAcceptanceService"]
  NAMECALL R8 R8 K4 ["GetService"]
  CALL R8 2 1
  GETIMPORT R9 K13 [script]
  LOADK R11 K14 ["StreamingServiceDispatcherRegistry"]
  NAMECALL R9 R9 K15 ["FindFirstAncestor"]
  CALL R9 2 1
  ...
  GETTABLEKS R12 R9 K20 ["SharedPluginConstants"]
  CALL R11 1 1
  GETIMPORT R12 K17 [require]
  GETTABLEKS R15 R9 K21 ["Src"]
  GETTABLEKS R14 R15 K22 ["Utils"]
  GETTABLEKS R13 R14 K22 ["Utils"]
  CALL R12 1 1
  ...
  CAPTURE VAL R8
  CAPTURE VAL R21
  SETTABLEKS R22 R0 K45 ["onShiftAssetVariant"]
  DUPCLOSURE R22 K46 [PROTO_8]
  CAPTURE VAL R2
  CAPTURE VAL R11
  DUPCLOSURE R23 K47 [PROTO_10]
  DUPCLOSURE R24 K48 [PROTO_11]
  CAPTURE VAL R0
  CAPTURE VAL R7
  CAPTURE VAL R23
  CAPTURE VAL R1
  ...
  CAPTURE VAL R24
  CAPTURE VAL R4
  SETTABLEKS R25 R0 K50 ["onAction"]
  DUPCLOSURE R25 K51 [PROTO_15]
  CAPTURE VAL R14
  CAPTURE VAL R12
  CAPTURE VAL R15
  SETTABLEKS R25 R0 K52 ["getPluginInfo"]
  DUPCLOSURE R25 K53 [PROTO_31]
  CAPTURE VAL R3
  CAPTURE VAL R6
  CAPTURE VAL R4
  CAPTURE VAL R20
  ...
  CAPTURE VAL R20
  CAPTURE VAL R3
  SETTABLEKS R26 R0 K55 ["destroy"]
  DUPCLOSURE R26 K56 [PROTO_33]
  CAPTURE VAL R25
  CAPTURE VAL R0
  SETTABLEKS R26 R0 K57 ["new"]
  RETURN R0 1
