...
PROTO_5:
  ...
  GETUPVAL R2 7
  GETTABLEKS R4 R0 K4 ["requestId"]
  LOADK R5 K21 ["InsertAssetInstant"]
  MOVE R6 R0
  NAMECALL R2 R2 K22 ["InvokeCommand"]
  CALL R2 4 0
  GETUPVAL R5 8
...
PROTO_7:
  ...
  JUMPIFNOT R8 [+11]
  GETUPVAL R9 2
  GETTABLEKS R8 R9 K8 ["isAssetCached"]
  MOVE R9 R6
  CALL R8 1 1
  JUMPIF R8 [+5]
  GETUPVAL R9 2
  GETTABLEKS R8 R9 K9 ["loadAssetAsync"]
  MOVE R9 R6
  CALL R8 1 0
  LOADN R8 0
  GETIMPORT R9 K12 [Instance.new]
  LOADK R10 K13 ["BindableEvent"]
  CALL R9 1 1
  GETUPVAL R10 3
  LOADK R12 K14 ["Assistant Variation Swap"]
  NAMECALL R10 R10 K15 ["TryBeginRecording"]
  CALL R10 2 1
  MOVE R11 R3
  LOADNIL R12
  LOADNIL R13
...
MAIN:
  ...
  CALL R15 2 1
  GETIMPORT R16 K2 [game]
  LOADK R18 K28 ["ConvAIIncomingLinks"]
  NAMECALL R16 R16 K27 ["GetFastFlag"]
  CALL R16 2 1
  GETIMPORT R17 K2 [game]
  LOADK R19 K29 ["ConvAIAddDraftModeForSceneCreate"]
  NAMECALL R17 R17 K27 ["GetFastFlag"]
  CALL R17 2 1
  GETIMPORT R18 K2 [game]
  LOADK R20 K30 ["FixAssetVariationCaching"]
  NAMECALL R18 R18 K27 ["GetFastFlag"]
  CALL R18 2 1
  GETIMPORT R19 K2 [game]
  LOADK R21 K31 ["ConvAIExecuteCommandAsync"]
  NAMECALL R19 R19 K27 ["GetFastFlag"]
  CALL R19 2 1
  GETIMPORT R20 K2 [game]
  LOADK R22 K32 ["ConvAI_ConditionalDropdown"]
  NAMECALL R20 R20 K27 ["GetFastFlag"]
  CALL R20 2 1
  DUPCLOSURE R21 K33 [PROTO_0]
  SETGLOBAL R21 K34 ["handleCachedPacketsForStream"]
  ...
  CAPTURE VAL R12
  CAPTURE VAL R16
  SETTABLEKS R22 R0 K37 ["getActionInstance"]
  DUPCLOSURE R22 K38 [PROTO_3]
  CAPTURE VAL R12
  CAPTURE VAL R20
  CAPTURE VAL R17
  SETTABLEKS R22 R0 K39 ["getActionInstanceFromGuid"]
  DUPCLOSURE R22 K40 [PROTO_4]
  CAPTURE VAL R12
  SETTABLEKS R22 R0 K41 ["onShiftAssetToId"]
  ...
  CAPTURE VAL R7
  CAPTURE VAL R21
  SETTABLEKS R22 R0 K43 ["onShiftAssetVariant"]
  ...
  CAPTURE VAL R24
  CAPTURE VAL R4
  SETTABLEKS R25 R0 K48 ["onAction"]
  DUPCLOSURE R25 K49 [PROTO_15]
  CAPTURE VAL R13
  CAPTURE VAL R12
  SETTABLEKS R25 R0 K50 ["getPluginInfo"]
  DUPCLOSURE R25 K51 [PROTO_30]
  CAPTURE VAL R3
  CAPTURE VAL R6
  CAPTURE VAL R4
  CAPTURE VAL R2
  ...
  CAPTURE VAL R15
  CAPTURE VAL R3
  SETTABLEKS R26 R0 K53 ["destroy"]
  DUPCLOSURE R26 K54 [PROTO_32]
  CAPTURE VAL R25
  CAPTURE VAL R0
  SETTABLEKS R26 R0 K55 ["new"]
  RETURN R0 1
