...
MAIN:
  ...
  LOADK R6 K7 ["StreamingService"]
  NAMECALL R4 R4 K4 ["GetService"]
  CALL R4 2 1
  GETIMPORT R5 K2 [game]
  LOADK R7 K8 ["ChatbotUIService"]
  NAMECALL R5 R5 K4 ["GetService"]
  CALL R5 2 1
  GETIMPORT R6 K2 [game]
  LOADK R8 K9 ["TweenService"]
  NAMECALL R6 R6 K4 ["GetService"]
  CALL R6 2 1
  GETIMPORT R7 K2 [game]
  LOADK R9 K10 ["HttpService"]
  NAMECALL R7 R7 K4 ["GetService"]
  CALL R7 2 1
  GETIMPORT R8 K2 [game]
  LOADK R10 K11 ["Selection"]
  NAMECALL R8 R8 K4 ["GetService"]
  CALL R8 2 1
  GETIMPORT R9 K2 [game]
  LOADK R11 K12 ["CAPInstanceInsertionTelemetry"]
  NAMECALL R9 R9 K13 ["GetFastFlag"]
  CALL R9 2 1
  LOADNIL R10
  JUMPIFNOT R9 [+7]
  GETIMPORT R11 K2 [game]
  LOADK R13 K14 ["ConversationalAIAcceptanceService"]
  NAMECALL R11 R11 K4 ["GetService"]
  CALL R11 2 1
  MOVE R10 R11
  ...
  GETTABLEKS R14 R11 K20 ["Packages"]
  GETTABLEKS R13 R14 K21 ["Dash"]
  CALL R12 1 1
  GETIMPORT R13 K19 [require]
  GETTABLEKS R14 R11 K22 ["SharedPluginConstants"]
  CALL R13 1 1
  GETIMPORT R14 K19 [require]
  GETTABLEKS R17 R11 K23 ["Src"]
  GETTABLEKS R16 R17 K24 ["Utils"]
  GETTABLEKS R15 R16 K24 ["Utils"]
  CALL R14 1 1
  GETIMPORT R15 K19 [require]
  GETTABLEKS R19 R11 K23 ["Src"]
  GETTABLEKS R18 R19 K25 ["Commands"]
  GETTABLEKS R17 R18 K26 ["BuilderCommands"]
  GETTABLEKS R16 R17 K27 ["BuilderNameMap"]
  CALL R15 1 1
  ...
  CALL R16 1 1
  GETIMPORT R17 K19 [require]
  GETTABLEKS R20 R11 K23 ["Src"]
  GETTABLEKS R19 R20 K25 ["Commands"]
  GETTABLEKS R18 R19 K29 ["DisplayError"]
  CALL R17 1 1
  GETIMPORT R18 K2 [game]
  LOADK R20 K30 ["ConvAIIncomingLinks"]
  NAMECALL R18 R18 K13 ["GetFastFlag"]
  CALL R18 2 1
  GETIMPORT R19 K2 [game]
  LOADK R21 K31 ["ConvAIAddDraftModeForSceneCreate"]
  NAMECALL R19 R19 K13 ["GetFastFlag"]
  CALL R19 2 1
  GETIMPORT R20 K2 [game]
  LOADK R22 K32 ["FixAssetVariationCaching"]
  NAMECALL R20 R20 K13 ["GetFastFlag"]
  CALL R20 2 1
  GETIMPORT R21 K2 [game]
  LOADK R23 K33 ["ConvAIExecuteCommandAsync"]
  NAMECALL R21 R21 K13 ["GetFastFlag"]
  CALL R21 2 1
  GETIMPORT R22 K2 [game]
  LOADK R24 K34 ["ConvAI_ConditionalDropdown"]
  NAMECALL R22 R22 K13 ["GetFastFlag"]
  CALL R22 2 1
  ...
  CAPTURE REF R10
  CAPTURE VAL R23
  SETTABLEKS R24 R0 K44 ["onShiftAssetVariant"]
  DUPCLOSURE R24 K45 [PROTO_8]
  CAPTURE VAL R3
  CAPTURE VAL R13
  DUPCLOSURE R25 K46 [PROTO_10]
  DUPCLOSURE R26 K47 [PROTO_11]
  CAPTURE VAL R0
  CAPTURE VAL R8
  CAPTURE VAL R25
  CAPTURE VAL R1
  DUPCLOSURE R27 K48 [PROTO_14]
  CAPTURE VAL R8
  CAPTURE VAL R12
  CAPTURE VAL R23
  CAPTURE VAL R26
  CAPTURE VAL R5
  SETTABLEKS R27 R0 K49 ["onAction"]
  DUPCLOSURE R27 K50 [PROTO_15]
  CAPTURE VAL R15
  CAPTURE VAL R14
  CAPTURE VAL R16
  SETTABLEKS R27 R0 K51 ["getPluginInfo"]
  DUPCLOSURE R27 K52 [PROTO_30]
  CAPTURE VAL R4
  CAPTURE VAL R7
  CAPTURE VAL R5
  CAPTURE VAL R3
  ...
  CAPTURE VAL R14
  CAPTURE VAL R19
  DUPCLOSURE R28 K53 [PROTO_31]
  CAPTURE VAL R4
  SETTABLEKS R28 R0 K54 ["destroy"]
  DUPCLOSURE R28 K55 [PROTO_32]
  CAPTURE VAL R27
  CAPTURE VAL R0
  SETTABLEKS R28 R0 K56 ["new"]
  CLOSEUPVALS R10
  RETURN R0 1
