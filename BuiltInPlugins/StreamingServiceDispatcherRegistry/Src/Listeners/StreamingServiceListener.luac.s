...
MAIN:
  ...
  GETTABLEKS R24 R25 K35 ["getFFlagAddStreamingServiceDispatcherTests"]
  CALL R23 1 1
  GETIMPORT R24 K6 [require]
  GETTABLEKS R27 R1 K7 ["Src"]
  GETTABLEKS R26 R27 K30 ["Flags"]
  GETTABLEKS R25 R26 K36 ["getFFlagConvAIFixEmptyBubbleBug"]
  CALL R24 1 1
  GETIMPORT R25 K6 [require]
  GETTABLEKS R28 R1 K7 ["Src"]
  GETTABLEKS R27 R28 K30 ["Flags"]
  GETTABLEKS R26 R27 K37 ["getFFlagAutoNormalizeBoundingBoxesForInsertedAssets"]
  CALL R25 1 1
  LOADB R26 0
  NEWCLOSURE R27 P0
  CAPTURE VAL R21
  CAPTURE REF R26
  CAPTURE VAL R24
  SETGLOBAL R27 K38 ["handleCachedPacketsForStream"]
  DUPCLOSURE R27 K39 [PROTO_1]
  CAPTURE VAL R13
  CAPTURE VAL R7
  DUPCLOSURE R28 K40 [PROTO_2]
  CAPTURE VAL R15
  SETTABLEKS R28 R0 K41 ["getActionInstance"]
  DUPCLOSURE R28 K42 [PROTO_3]
  CAPTURE VAL R15
  CAPTURE VAL R20
  SETTABLEKS R28 R0 K43 ["getActionInstanceFromGuid"]
  DUPCLOSURE R28 K44 [PROTO_4]
  CAPTURE VAL R19
  CAPTURE VAL R15
  SETTABLEKS R28 R0 K45 ["onShiftAssetToId"]
  ...
  CAPTURE VAL R10
  CAPTURE VAL R27
  SETTABLEKS R28 R0 K47 ["onShiftAssetVariant"]
  ...
  CAPTURE VAL R30
  CAPTURE VAL R6
  SETTABLEKS R31 R0 K52 ["onAction"]
  DUPCLOSURE R31 K53 [PROTO_15]
  CAPTURE VAL R15
  CAPTURE VAL R13
  CAPTURE VAL R23
  CAPTURE VAL R16
  SETTABLEKS R31 R0 K54 ["getPluginInfo"]
  DUPCLOSURE R31 K55 [PROTO_31]
  CAPTURE VAL R5
  CAPTURE VAL R8
  CAPTURE VAL R6
  CAPTURE VAL R18
  ...
  CAPTURE VAL R17
  CAPTURE VAL R13
  DUPCLOSURE R32 K56 [PROTO_32]
  CAPTURE VAL R5
  SETTABLEKS R32 R0 K57 ["destroy"]
  DUPCLOSURE R32 K58 [PROTO_33]
  CAPTURE VAL R31
  CAPTURE VAL R0
  SETTABLEKS R32 R0 K59 ["new"]
  CLOSEUPVALS R26
  RETURN R0 1
