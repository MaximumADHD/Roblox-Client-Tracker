...
function ThemeData:init()
	...
	if FastFlags:isUseNewThemeAPIOn() then
		ThemeData.DataStyleMap = {
			...
			[ThemeData.ColorAndImageNamesMap.NotchesBackgroundColor] = {Style = Enum.StudioStyleGuideColor.TabBar, Modifier = Enum.StudioStyleGuideModifier.Default, Color = Color3.fromRGB(233, 233, 233),},
			...
			[ThemeData.ColorAndImageNamesMap.ShadeColor] = {Style = Enum.StudioStyleGuideColor.TabBar, Modifier = Enum.StudioStyleGuideModifier.Default, Color = Color3.fromRGB(245, 245, 245),},
