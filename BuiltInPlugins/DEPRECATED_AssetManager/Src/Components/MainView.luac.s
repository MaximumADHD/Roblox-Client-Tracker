...
PROTO_15:
  ...
  GETTABLEKS R24 R25 K39 ["createElement"]
  GETUPVAL R25 10
  DUPTABLE R26 K111 [{"Size", "LayoutOrder", "OnOpenAssetPreview", "OnAssetPreviewClose", "OnOpenConfirmRemovePlaceDialog", "Enabled"}]
  GETIMPORT R27 K47 [UDim2.new]
  LOADN R28 1
  LOADN R29 0
  LOADN R30 1
  ...
  CALL R27 1 1
  SETTABLEKS R27 R26 K61 ["LayoutOrder"]
  GETTABLEKS R27 R0 K112 ["openAssetPreview"]
  SETTABLEKS R27 R26 K108 ["OnOpenAssetPreview"]
  GETTABLEKS R27 R0 K113 ["closeAssetPreview"]
  SETTABLEKS R27 R26 K109 ["OnAssetPreviewClose"]
  GETTABLEKS R27 R0 K114 ["openConfirmRemovePlaceDialog"]
  SETTABLEKS R27 R26 K110 ["OnOpenConfirmRemovePlaceDialog"]
  ...
  GETTABLEKS R24 R25 K39 ["createElement"]
  GETUPVAL R25 11
  DUPTABLE R26 K115 [{"Size", "LayoutOrder", "Enabled"}]
  GETIMPORT R27 K47 [UDim2.new]
  LOADN R28 1
  LOADN R29 0
  JUMPIFNOT R11 [+2]
  ...
  GETTABLEKS R24 R25 K39 ["createElement"]
  GETUPVAL R25 12
  DUPTABLE R26 K121 [{"Style", "Enabled", "Title", "MinContentSize", "Buttons", "OnButtonPressed", "OnClose"}]
  LOADK R27 K122 ["Alert"]
  SETTABLEKS R27 R26 K77 ["Style"]
  GETTABLEKS R28 R0 K5 ["state"]
  GETTABLEKS R27 R28 K123 ["showConfirmRemovePlaceDialog"]
  SETTABLEKS R27 R26 K103 ["Enabled"]
  LOADK R27 K8 [""]
  SETTABLEKS R27 R26 K116 ["Title"]
  GETTABLEKS R28 R2 K13 ["MainView"]
  GETTABLEKS R27 R28 K124 ["ConfirmRemovePlaceDialogSize"]
  SETTABLEKS R27 R26 K117 ["MinContentSize"]
  NEWTABLE R27 0 2
  DUPTABLE R28 K126 [{"Key", "Text"}]
  LOADK R29 K127 ["Confirm"]
  SETTABLEKS R29 R28 K125 ["Key"]
  SETTABLEKS R17 R28 K62 ["Text"]
  DUPTABLE R29 K126 [{"Key", "Text"}]
  LOADK R30 K128 ["Cancel"]
  SETTABLEKS R30 R29 K125 ["Key"]
  SETTABLEKS R18 R29 K62 ["Text"]
  SETLIST R27 R28 2 [1]
  SETTABLEKS R27 R26 K118 ["Buttons"]
  NEWCLOSURE R27 P1
  CAPTURE UPVAL U13
  CAPTURE VAL R0
  SETTABLEKS R27 R26 K119 ["OnButtonPressed"]
  NEWCLOSURE R27 P2
  CAPTURE VAL R0
  SETTABLEKS R27 R26 K120 ["OnClose"]
  DUPTABLE R27 K130 [{"Contents"}]
  GETUPVAL R29 3
  GETTABLEKS R28 R29 K39 ["createElement"]
  LOADK R29 K59 ["TextLabel"]
  DUPTABLE R30 K131 [{"BackgroundTransparency", "Position", "Size", "Font", "Text", "TextColor3", "TextSize", "TextXAlignment", "TextWrapped"}]
  LOADN R31 1
  SETTABLEKS R31 R30 K43 ["BackgroundTransparency"]
  GETIMPORT R31 K133 [UDim2.fromScale]
  LOADN R32 0
  LOADN R33 0
  CALL R31 2 1
  ...
  CALL R28 2 1
  SETTABLEKS R28 R27 K129 ["Contents"]
  CALL R24 3 1
...
MAIN:
  ...
  CAPTURE VAL R1
  CAPTURE VAL R15
  SETTABLEKS R30 R26 K43 ["init"]
  DUPCLOSURE R30 K44 [PROTO_9]
  CAPTURE VAL R24
  SETTABLEKS R30 R26 K45 ["didMount"]
  DUPCLOSURE R30 K46 [PROTO_10]
  SETTABLEKS R30 R26 K47 ["willUnmount"]
  DUPCLOSURE R30 K48 [PROTO_11]
  CAPTURE VAL R20
  CAPTURE VAL R29
  SETTABLEKS R30 R26 K49 ["didUpdate"]
  NEWCLOSURE R30 P5
  CAPTURE VAL R12
  CAPTURE REF R27
  CAPTURE VAL R13
  ...
  CAPTURE VAL R9
  CAPTURE VAL R25
  SETTABLEKS R30 R26 K50 ["render"]
  MOVE R30 R5
  DUPTABLE R31 K54 [{"API", "Stylizer", "Localization"}]
  GETTABLEKS R32 R4 K51 ["API"]
  SETTABLEKS R32 R31 K51 ["API"]
  GETTABLEKS R32 R4 K52 ["Stylizer"]
  SETTABLEKS R32 R31 K52 ["Stylizer"]
  GETTABLEKS R32 R4 K53 ["Localization"]
