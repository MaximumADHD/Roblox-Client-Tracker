...
PROTO_9:
  ...
  NEWCLOSURE R1 P6
  CAPTURE VAL R0
  SETTABLEKS R1 R0 K22 ["getScripts"]
  NEWCLOSURE R1 P7
  CAPTURE VAL R0
  SETTABLEKS R1 R0 K23 ["hasScripts"]
  RETURN R0 0
...
PROTO_19:
  ...
  RETURN R3 1
  DUPTABLE R3 K14 [{"AssetsTable", "CurrentScreen", "UniverseName", "HasLinkedScripts", "RecentAssets", "RecentViewToggled"}]
  GETTABLEKS R4 R2 K7 ["assetsTable"]
  SETTABLEKS R4 R3 K1 ["AssetsTable"]
  GETTABLEKS R5 R0 K8 ["Screen"]
  GETTABLEKS R4 R5 K9 ["currentScreen"]
  ...
  SETTABLEKS R4 R3 K13 ["HasLinkedScripts"]
  GETTABLEKS R4 R2 K11 ["recentAssets"]
  SETTABLEKS R4 R3 K4 ["RecentAssets"]
  GETTABLEKS R4 R2 K12 ["recentViewToggled"]
  SETTABLEKS R4 R3 K5 ["RecentViewToggled"]
...
MAIN:
  ...
  GETTABLEKS R31 R32 K42 ["ModernIcons"]
  CALL R30 1 1
  GETIMPORT R31 K33 [game]
  LOADK R33 K43 ["DisableLinkedScriptStudioEditing"]
  NAMECALL R31 R31 K41 ["GetFastFlag"]
  CALL R31 2 1
  GETIMPORT R32 K4 [require]
  GETTABLEKS R35 R0 K19 ["Src"]
  GETTABLEKS R34 R35 K44 ["Flags"]
  GETTABLEKS R33 R34 K45 ["getFFlagAddConfirmRemovePlaceDialog"]
  CALL R32 1 1
  DUPCLOSURE R33 K46 [PROTO_0]
  CAPTURE VAL R30
  DUPCLOSURE R34 K47 [PROTO_9]
  CAPTURE VAL R20
  CAPTURE VAL R1
  CAPTURE VAL R15
  CAPTURE VAL R31
  SETTABLEKS R34 R26 K48 ["init"]
  DUPCLOSURE R34 K49 [PROTO_11]
  CAPTURE VAL R31
  CAPTURE VAL R24
  SETTABLEKS R34 R26 K50 ["didMount"]
  DUPCLOSURE R34 K51 [PROTO_12]
  SETTABLEKS R34 R26 K52 ["willUnmount"]
  JUMPIFNOT R31 [+6]
  DUPCLOSURE R34 K53 [PROTO_13]
  CAPTURE VAL R20
  CAPTURE VAL R33
  SETTABLEKS R34 R26 K54 ["didUpdate"]
  JUMP [+6]
  NEWCLOSURE R34 P5
  CAPTURE REF R29
  CAPTURE VAL R20
  ...
  CAPTURE VAL R9
  CAPTURE VAL R25
  SETTABLEKS R34 R26 K55 ["render"]
  MOVE R34 R5
  DUPTABLE R35 K59 [{"API", "Stylizer", "Localization"}]
  GETTABLEKS R36 R4 K56 ["API"]
  SETTABLEKS R36 R35 K56 ["API"]
  GETTABLEKS R36 R4 K57 ["Stylizer"]
  SETTABLEKS R36 R35 K57 ["Stylizer"]
  GETTABLEKS R36 R4 K58 ["Localization"]
  SETTABLEKS R36 R35 K58 ["Localization"]
  CALL R34 1 1
  MOVE R35 R26
  CALL R34 1 1
  MOVE R26 R34
