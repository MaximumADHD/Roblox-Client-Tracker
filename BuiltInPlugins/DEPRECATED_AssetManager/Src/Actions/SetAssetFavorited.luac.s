PROTO_0:
       ...
       11 LOADK                            R5 K6 ["SetAssetFavorited requires assetId to be a number, not %s"]
       ...
       26 CALL                             R4 1 1
       27 JUMPIFEQKS                       R4 K9 ["boolean"] ; [+2]
       29 LOADB                            R3 0 +1
       30 LOADB                            R3 1
       31 GETIMPORT                        R4 K5 [string.format]
       33 LOADK                            R5 K10 ["SetAssetFavorited requires isAssetFavorited to be a boolean, not %s"]
       ...
       43 CALL                             R2 -1 0
       44 DUPTABLE                         R2 K13 [{"assetId", "isAssetFavorited"}]
       45 SETTABLEKS                       R0 R2 K11 ["assetId"]
       47 SETTABLEKS                       R1 R2 K12 ["isAssetFavorited"]
       49 RETURN                           R2 1
