PROTO_0:
       ...
       11 LOADK                            R5 K6 ["SetRootTreeViewInstance requires assetId to be a number, not %s"]
       ...
       23 MOVE                             R5 R1
       24 GETIMPORT                        R4 K10 [typeof]
       26 CALL                             R4 1 1
       27 JUMPIFEQKS                       R4 K11 ["Instance"] ; [+2]
       29 LOADB                            R3 0 +1
       30 LOADB                            R3 1
       31 GETIMPORT                        R4 K5 [string.format]
       33 LOADK                            R5 K12 ["SetRootTreeViewInstance requires rootTreeViewInstance a String, not %s"]
       ...
       43 CALL                             R2 -1 0
       44 DUPTABLE                         R2 K15 [{"assetId", "rootTreeViewInstance"}]
       45 SETTABLEKS                       R0 R2 K13 ["assetId"]
       47 SETTABLEKS                       R1 R2 K14 ["rootTreeViewInstance"]
       49 RETURN                           R2 1
