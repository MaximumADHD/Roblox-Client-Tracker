PROTO_0:
       ...
       10 GETUPVAL                         R5 0
       11 GETTABLEKS                       R5 R5 K3 ["Screen"]
       13 GETTABLEKS                       R5 R5 K4 ["Path"]
       15 NAMECALL                         R2 R2 K5 ["report"]
       17 CALL                             R2 3 0
       18 GETUPVAL                         R4 2
       19 GETUPVAL                         R5 0
       20 GETTABLEKS                       R5 R5 K3 ["Screen"]
       22 CALL                             R4 1 -1
       23 NAMECALL                         R2 R0 K6 ["dispatch"]
       25 CALL                             R2 -1 0
       26 RETURN                           R0 0
       27 GETUPVAL                         R2 0
       28 GETTABLEKS                       R2 R2 K7 ["assetType"]
       30 GETIMPORT                        R3 K11 [Enum.AssetType.Place]
       32 JUMPIFNOTEQ                      R2 R3 ; [+9]
       34 GETUPVAL                         R3 3
       35 GETUPVAL                         R5 0
       36 GETTABLEKS                       R5 R5 K12 ["id"]
       ...
       72 GETUPVAL                         R7 0
       73 GETTABLEKS                       R7 R7 K23 ["name"]
       75 CONCAT                           R5 R6 R7
       76 LOADB                            R6 0
       77 GETUPVAL                         R7 0
       78 GETTABLEKS                       R7 R7 K12 ["id"]
       ...
       91 GETUPVAL                         R3 3
       92 GETUPVAL                         R5 0
       93 GETTABLEKS                       R5 R5 K12 ["id"]
       95 GETUPVAL                         R6 0
       96 GETTABLEKS                       R6 R6 K23 ["name"]
      ...
      109 GETUPVAL                         R3 3
      110 GETUPVAL                         R5 0
      111 GETTABLEKS                       R5 R5 K12 ["id"]
      113 GETUPVAL                         R6 0
      114 GETTABLEKS                       R6 R6 K23 ["name"]
      ...
      138 CALL                             R3 1 1
      139 GETTABLEKS                       R4 R3 K36 ["AssetManagerReducer"]
      141 GETTABLEKS                       R4 R4 K37 ["searchTerm"]
...
MAIN:
       ...
       15 GETTABLEKS                       R2 R2 K7 ["SetScreen"]
       17 CALL                             R1 1 1
       18 GETIMPORT                        R2 K4 [require]
       20 GETTABLEKS                       R3 R0 K5 ["Src"]
       22 GETTABLEKS                       R3 R3 K8 ["Util"]
       24 GETTABLEKS                       R3 R3 K9 ["AssetManagerUtilities"]
       26 CALL                             R2 1 1
       27 GETTABLEKS                       R2 R2 K10 ["enableAudioImport"]
       29 GETIMPORT                        R3 K4 [require]
       31 GETTABLEKS                       R4 R0 K5 ["Src"]
       33 GETTABLEKS                       R4 R4 K8 ["Util"]
       35 GETTABLEKS                       R4 R4 K9 ["AssetManagerUtilities"]
       37 CALL                             R3 1 1
       38 GETTABLEKS                       R3 R3 K11 ["enableVideoImport"]
