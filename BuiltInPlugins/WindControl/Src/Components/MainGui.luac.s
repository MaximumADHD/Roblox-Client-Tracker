...
PROTO_8:
  ...
  LOADK R8 K12 [0.5]
  LOADK R9 K12 [0.5]
  JUMPIFNOTLT R3 R7 [+11]
  LOADK R12 K14 ["WindControl_PositionX"]
  ...
  LOADK R10 K12 [0.5]
  LOADK R11 K12 [0.5]
  JUMPIFNOTLT R3 R9 [+11]
  LOADK R14 K18 ["WindControl_PositionY"]
  ...
  MOVE R11 R7
  CALL R9 2 1
  SETTABLEKS R9 R2 K22 ["AnchorPoint"]
  GETIMPORT R9 K25 [UDim2.fromScale]
  MOVE R10 R6
  MOVE R11 R8
  CALL R9 2 1
  SETTABLEKS R9 R2 K26 ["Position"]
  RETURN R0 0
...
PROTO_10:
  ...
  ADD R11 R10 R12
  DIV R9 R11 R7
  LOADK R12 K17 ["WindControl_PositionX"]
  MOVE R13 R8
  ...
  ADD R13 R12 R14
  DIV R11 R13 R9
  LOADK R14 K20 ["WindControl_PositionY"]
  MOVE R15 R10
  ...
  MOVE R11 R7
  CALL R9 2 1
  SETTABLEKS R9 R2 K24 ["AnchorPoint"]
  GETIMPORT R9 K27 [UDim2.fromScale]
  MOVE R10 R6
  MOVE R11 R8
  CALL R9 2 1
  SETTABLEKS R9 R2 K28 ["Position"]
  RETURN R0 0
