...
function var7.render(arg1)
   ...
   var25.Color3 = var2
   local var299 = var4
   local var300 = arg1._light
   local var301 = var300.Face
   var299 = var8
   var301 = var9
   var300 = var10
   arg1:_setCFrameValues(var299[var301], var299, var301, var300, var11, var0 * Vector3.fromNormalId(arg1._light.Face).magnitude, var3, var5)
end
...
function var7._setAncestry(arg1)
   if var3 then
      ...
      assert(var0, "Trapezoidal Prism Wireframe should have valid Adornee.")
...
function var7._setCFrameValues(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9)
   ...
   local var626 = CFrame.Angles(0, 0, 0.785398163397448)
   var626 = var0
   arg1._handles.bottomLeftOutline.CFrame = arg1._offset * arg2 * CFrame.new(var7, var8, var9) * var626 * CFrame.Angles(var626, 0, 0)
   local var647 = CFrame.Angles(0, 0, -0.785398163397448)
   var647 = var0
   arg1._handles.bottomRightOutline.CFrame = arg1._offset * arg2 * CFrame.new(var7, var8, var9) * var647 * CFrame.Angles(var647, 0, 0)
      ...
      if not arg1._parent:IsA("Attachment") then
         if arg1._parent:IsA("BasePart") then
            arg1._sizeListener = arg1._parent:GetPropertyChangedSignal("Size"):Connect(function(arg1)
               ...
               var25.Color3 = var2
               local var988 = var4
               local var989 = arg1._light
               local var990 = var989.Face
               var988 = var8
               var990 = var9
               var989 = var10
               arg1:_setCFrameValues(var988[var990], var988, var990, var989, var11, var0 * Vector3.fromNormalId(arg1._light.Face).magnitude, var3, var5)
            end)
         end
      end
   end
