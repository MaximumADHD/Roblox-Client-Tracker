...
MAIN:
  ...
  GETTABLEKS R3 R4 K8 ["getFFlagLightGuidesRenderErrors"]
  CALL R2 1 1
  MOVE R3 R2
  CALL R3 0 1
  ...
  GETTABLEKS R5 R6 K9 ["getFFlagLightGuidesHideNestedAttachments"]
  CALL R4 1 1
  MOVE R5 R4
  CALL R5 0 1
  ...
  GETTABLEKS R7 R8 K10 ["getFFlagLightGuidesSupportNestedAttachments"]
  CALL R6 1 1
  MOVE R7 R6
  CALL R7 0 1
  GETTABLEKS R9 R0 K5 ["Src"]
  GETTABLEKS R8 R9 K11 ["Utility"]
  GETIMPORT R9 K4 [require]
  GETTABLEKS R10 R8 K12 ["Constants"]
  CALL R9 1 1
  GETTABLEKS R10 R9 K13 ["THICKNESS"]
  GETTABLEKS R11 R9 K14 ["TRANSPARENCY"]
  NEWTABLE R12 16 0
  SETTABLEKS R12 R12 K15 ["__index"]
  DUPCLOSURE R13 K16 [PROTO_0]
  CAPTURE VAL R12
  SETTABLEKS R13 R12 K17 ["new"]
  DUPCLOSURE R13 K18 [PROTO_1]
  CAPTURE VAL R10
  SETTABLEKS R13 R12 K19 ["render"]
  DUPCLOSURE R13 K20 [PROTO_2]
  SETTABLEKS R13 R12 K21 ["pool"]
  DUPCLOSURE R13 K22 [PROTO_3]
  CAPTURE VAL R3
  SETTABLEKS R13 R12 K23 ["adorn"]
  DUPCLOSURE R13 K24 [PROTO_4]
  SETTABLEKS R13 R12 K25 ["destroy"]
  DUPCLOSURE R13 K26 [PROTO_5]
  SETTABLEKS R13 R12 K27 ["setGuidesFolder"]
  DUPCLOSURE R13 K28 [PROTO_6]
  CAPTURE VAL R7
  CAPTURE VAL R5
  SETTABLEKS R13 R12 K29 ["_setAncestry"]
  DUPCLOSURE R13 K30 [PROTO_7]
  CAPTURE VAL R10
  CAPTURE VAL R11
  SETTABLEKS R13 R12 K31 ["_setHandles"]
  DUPCLOSURE R13 K32 [PROTO_8]
  SETTABLEKS R13 R12 K33 ["_removeHandles"]
  DUPCLOSURE R13 K34 [PROTO_14]
  CAPTURE VAL R7
  SETTABLEKS R13 R12 K35 ["_setListeners"]
  DUPCLOSURE R13 K36 [PROTO_15]
  CAPTURE VAL R7
  SETTABLEKS R13 R12 K37 ["_removeListeners"]
  RETURN R12 1
