...
PROTO_13:
  ...
  GETTABLEKS R1 R0 K11 ["_attachmentListener"]
  JUMPIF R1 [+20]
  GETTABLEKS R1 R0 K5 ["_parent"]
  LOADK R3 K6 ["Attachment"]
  NAMECALL R1 R1 K7 ["IsA"]
  ...
  NAMECALL R1 R1 K3 ["Connect"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K11 ["_attachmentListener"]
  RETURN R0 0
...
PROTO_14:
  ...
  NAMECALL R1 R1 K1 ["Disconnect"]
  CALL R1 1 0
  GETTABLEKS R1 R0 K3 ["_attachmentListener"]
  JUMPIFNOT R1 [+5]
  GETTABLEKS R1 R0 K3 ["_attachmentListener"]
  NAMECALL R1 R1 K1 ["Disconnect"]
  CALL R1 1 0
  ...
  LOADNIL R1
  SETTABLEKS R1 R0 K3 ["_attachmentListener"]
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R5 R6 K10 ["getFFlagLightGuidesAttachmentErrors"]
  CALL R4 1 1
  GETIMPORT R5 K4 [require]
  GETTABLEKS R8 R0 K5 ["Src"]
  GETTABLEKS R7 R8 K9 ["Flags"]
  GETTABLEKS R6 R7 K11 ["getFFlagLightGuidesRenderErrors"]
  CALL R5 1 1
  MOVE R6 R4
  CALL R6 0 1
  MOVE R7 R5
  CALL R7 0 1
  NEWTABLE R8 8 0
  GETIMPORT R9 K15 [Enum.NormalId.Back]
  GETIMPORT R10 K18 [CFrame.fromMatrix]
  FASTCALL VECTOR [+2]
  ...
  CALL R10 4 1
  SETTABLE R10 R8 R9
  GETIMPORT R9 K23 [Enum.NormalId.Front]
  GETIMPORT R10 K18 [CFrame.fromMatrix]
  FASTCALL VECTOR [+2]
  GETIMPORT R11 K21 [Vector3.new]
  CALL R11 0 1
  ...
  CALL R10 4 1
  SETTABLE R10 R8 R9
  GETIMPORT R9 K25 [Enum.NormalId.Right]
  GETIMPORT R10 K18 [CFrame.fromMatrix]
  FASTCALL VECTOR [+2]
  GETIMPORT R11 K21 [Vector3.new]
  CALL R11 0 1
  ...
  CALL R10 4 1
  SETTABLE R10 R8 R9
  GETIMPORT R9 K27 [Enum.NormalId.Left]
  GETIMPORT R10 K18 [CFrame.fromMatrix]
  FASTCALL VECTOR [+2]
  GETIMPORT R11 K21 [Vector3.new]
  CALL R11 0 1
  ...
  CALL R10 4 1
  SETTABLE R10 R8 R9
  GETIMPORT R9 K29 [Enum.NormalId.Bottom]
  GETIMPORT R10 K18 [CFrame.fromMatrix]
  FASTCALL VECTOR [+2]
  GETIMPORT R11 K21 [Vector3.new]
  CALL R11 0 1
  ...
  CALL R10 4 1
  SETTABLE R10 R8 R9
  GETIMPORT R9 K31 [Enum.NormalId.Top]
  GETIMPORT R10 K18 [CFrame.fromMatrix]
  FASTCALL VECTOR [+2]
  GETIMPORT R11 K21 [Vector3.new]
  CALL R11 0 1
  ...
  CALL R10 4 1
  SETTABLE R10 R8 R9
  GETTABLEKS R9 R3 K32 ["THICKNESS"]
  GETTABLEKS R10 R3 K33 ["TRANSPARENCY"]
  NEWTABLE R11 16 0
  SETTABLEKS R11 R11 K34 ["__index"]
  ...
  SETTABLEKS R12 R11 K39 ["pool"]
  DUPCLOSURE R12 K40 [PROTO_3]
  CAPTURE VAL R7
  SETTABLEKS R12 R11 K41 ["adorn"]
  DUPCLOSURE R12 K42 [PROTO_4]
  SETTABLEKS R12 R11 K43 ["destroy"]
  DUPCLOSURE R12 K44 [PROTO_5]
  SETTABLEKS R12 R11 K45 ["setGuidesFolder"]
  DUPCLOSURE R12 K46 [PROTO_6]
  CAPTURE VAL R6
  SETTABLEKS R12 R11 K47 ["_setAncestry"]
  DUPCLOSURE R12 K48 [PROTO_7]
  SETTABLEKS R12 R11 K49 ["_setCFrameValues"]
  DUPCLOSURE R12 K50 [PROTO_8]
  CAPTURE VAL R9
  CAPTURE VAL R10
  SETTABLEKS R12 R11 K51 ["_setHandles"]
  DUPCLOSURE R12 K52 [PROTO_9]
  SETTABLEKS R12 R11 K53 ["_removeHandles"]
  DUPCLOSURE R12 K54 [PROTO_13]
  SETTABLEKS R12 R11 K55 ["_setListeners"]
  DUPCLOSURE R12 K56 [PROTO_14]
  SETTABLEKS R12 R11 K57 ["_removeListeners"]
  RETURN R11 1
