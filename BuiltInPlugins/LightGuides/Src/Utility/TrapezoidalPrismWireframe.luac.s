...
MAIN:
  ...
  CALL R6 4 1
  SETTABLE R6 R4 R5
  GETIMPORT R5 K20 [Enum.NormalId.Front]
  GETIMPORT R6 K15 [CFrame.fromMatrix]
  FASTCALL VECTOR [+2]
  GETIMPORT R7 K18 [Vector3.new]
  CALL R7 0 1
  ...
  CALL R6 4 1
  SETTABLE R6 R4 R5
  GETIMPORT R5 K22 [Enum.NormalId.Right]
  GETIMPORT R6 K15 [CFrame.fromMatrix]
  FASTCALL VECTOR [+2]
  GETIMPORT R7 K18 [Vector3.new]
  CALL R7 0 1
  ...
  CALL R6 4 1
  SETTABLE R6 R4 R5
  GETIMPORT R5 K24 [Enum.NormalId.Left]
  GETIMPORT R6 K15 [CFrame.fromMatrix]
  FASTCALL VECTOR [+2]
  GETIMPORT R7 K18 [Vector3.new]
  CALL R7 0 1
  ...
  CALL R6 4 1
  SETTABLE R6 R4 R5
  GETIMPORT R5 K26 [Enum.NormalId.Bottom]
  GETIMPORT R6 K15 [CFrame.fromMatrix]
  FASTCALL VECTOR [+2]
  GETIMPORT R7 K18 [Vector3.new]
  CALL R7 0 1
  ...
  CALL R6 4 1
  SETTABLE R6 R4 R5
  GETIMPORT R5 K28 [Enum.NormalId.Top]
  GETIMPORT R6 K15 [CFrame.fromMatrix]
  FASTCALL VECTOR [+2]
  GETIMPORT R7 K18 [Vector3.new]
  CALL R7 0 1
  ...
  CALL R6 4 1
  SETTABLE R6 R4 R5
  GETTABLEKS R5 R3 K29 ["THICKNESS"]
  GETTABLEKS R6 R3 K30 ["TRANSPARENCY"]
  NEWTABLE R7 16 0
  SETTABLEKS R7 R7 K31 ["__index"]
  ...
  SETTABLEKS R8 R7 K36 ["pool"]
  DUPCLOSURE R8 K37 [PROTO_3]
  SETTABLEKS R8 R7 K38 ["adorn"]
  DUPCLOSURE R8 K39 [PROTO_4]
  SETTABLEKS R8 R7 K40 ["destroy"]
  DUPCLOSURE R8 K41 [PROTO_5]
  SETTABLEKS R8 R7 K42 ["setGuidesFolder"]
  DUPCLOSURE R8 K43 [PROTO_6]
  SETTABLEKS R8 R7 K44 ["_setAncestry"]
  DUPCLOSURE R8 K45 [PROTO_7]
  SETTABLEKS R8 R7 K46 ["_setCFrameValues"]
  DUPCLOSURE R8 K47 [PROTO_8]
  CAPTURE VAL R5
  CAPTURE VAL R6
  SETTABLEKS R8 R7 K48 ["_setHandles"]
  DUPCLOSURE R8 K49 [PROTO_9]
  SETTABLEKS R8 R7 K50 ["_removeHandles"]
  DUPCLOSURE R8 K51 [PROTO_13]
  SETTABLEKS R8 R7 K52 ["_setListeners"]
  DUPCLOSURE R8 K53 [PROTO_14]
  SETTABLEKS R8 R7 K54 ["_removeListeners"]
  RETURN R7 1
