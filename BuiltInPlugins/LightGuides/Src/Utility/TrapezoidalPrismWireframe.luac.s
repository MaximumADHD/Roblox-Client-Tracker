...
MAIN:
  ...
  CALL R5 0 1
  NEWTABLE R6 8 0
  GETIMPORT R7 K14 [Enum.NormalId.Back]
  GETIMPORT R8 K17 [CFrame.fromMatrix]
  FASTCALL VECTOR [+2]
  GETIMPORT R9 K20 [Vector3.new]
  CALL R9 0 1
  LOADN R11 1
  LOADN R12 0
  LOADN R13 0
  ...
  LOADN R15 1
  FASTCALL VECTOR [+2]
  GETIMPORT R12 K20 [Vector3.new]
  CALL R12 3 1
  CALL R8 4 1
  SETTABLE R8 R6 R7
  GETIMPORT R7 K22 [Enum.NormalId.Front]
  GETIMPORT R8 K17 [CFrame.fromMatrix]
  FASTCALL VECTOR [+2]
  GETIMPORT R9 K20 [Vector3.new]
  CALL R9 0 1
  ...
  CALL R8 4 1
  SETTABLE R8 R6 R7
  GETIMPORT R7 K24 [Enum.NormalId.Right]
  GETIMPORT R8 K17 [CFrame.fromMatrix]
  FASTCALL VECTOR [+2]
  GETIMPORT R9 K20 [Vector3.new]
  CALL R9 0 1
  ...
  CALL R8 4 1
  SETTABLE R8 R6 R7
  GETIMPORT R7 K26 [Enum.NormalId.Left]
  GETIMPORT R8 K17 [CFrame.fromMatrix]
  FASTCALL VECTOR [+2]
  GETIMPORT R9 K20 [Vector3.new]
  CALL R9 0 1
  ...
  CALL R8 4 1
  SETTABLE R8 R6 R7
  GETIMPORT R7 K28 [Enum.NormalId.Bottom]
  GETIMPORT R8 K17 [CFrame.fromMatrix]
  FASTCALL VECTOR [+2]
  GETIMPORT R9 K20 [Vector3.new]
  CALL R9 0 1
  ...
  CALL R8 4 1
  SETTABLE R8 R6 R7
  GETIMPORT R7 K30 [Enum.NormalId.Top]
  GETIMPORT R8 K17 [CFrame.fromMatrix]
  FASTCALL VECTOR [+2]
  GETIMPORT R9 K20 [Vector3.new]
  CALL R9 0 1
  ...
  CALL R8 4 1
  SETTABLE R8 R6 R7
  GETTABLEKS R7 R3 K31 ["THICKNESS"]
  GETTABLEKS R8 R3 K32 ["TRANSPARENCY"]
  NEWTABLE R9 16 0
  SETTABLEKS R9 R9 K33 ["__index"]
  DUPCLOSURE R10 K34 [PROTO_0]
  CAPTURE VAL R9
  SETTABLEKS R10 R9 K19 ["new"]
  DUPCLOSURE R10 K35 [PROTO_1]
  CAPTURE VAL R6
  SETTABLEKS R10 R9 K36 ["render"]
  DUPCLOSURE R10 K37 [PROTO_2]
  SETTABLEKS R10 R9 K38 ["pool"]
  DUPCLOSURE R10 K39 [PROTO_3]
  SETTABLEKS R10 R9 K40 ["adorn"]
  DUPCLOSURE R10 K41 [PROTO_4]
  SETTABLEKS R10 R9 K42 ["destroy"]
  DUPCLOSURE R10 K43 [PROTO_5]
  SETTABLEKS R10 R9 K44 ["setGuidesFolder"]
  DUPCLOSURE R10 K45 [PROTO_6]
  CAPTURE VAL R5
  SETTABLEKS R10 R9 K46 ["_setAncestry"]
  DUPCLOSURE R10 K47 [PROTO_7]
  SETTABLEKS R10 R9 K48 ["_setCFrameValues"]
  DUPCLOSURE R10 K49 [PROTO_8]
  CAPTURE VAL R7
  CAPTURE VAL R8
  SETTABLEKS R10 R9 K50 ["_setHandles"]
  DUPCLOSURE R10 K51 [PROTO_9]
  SETTABLEKS R10 R9 K52 ["_removeHandles"]
  DUPCLOSURE R10 K53 [PROTO_13]
  SETTABLEKS R10 R9 K54 ["_setListeners"]
  DUPCLOSURE R10 K55 [PROTO_14]
  SETTABLEKS R10 R9 K56 ["_removeListeners"]
  RETURN R9 1
