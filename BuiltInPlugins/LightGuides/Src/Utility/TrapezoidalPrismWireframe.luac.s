...
PROTO_6:
  ...
  CALL R3 2 1
  JUMPIF R3 [+21]
  NAMECALL R3 R0 K16 ["_removeHandles"]
  CALL R3 1 0
  LOADB R3 0
  RETURN R3 1
  JUMP [+15]
  ...
  LOADB R3 0
  RETURN R3 1
  SETTABLEKS R1 R0 K18 ["_adornee"]
  SETTABLEKS R2 R0 K19 ["_offset"]
  GETTABLEKS R4 R0 K0 ["_light"]
  GETTABLEKS R3 R4 K1 ["Parent"]
  SETTABLEKS R3 R0 K20 ["_parent"]
  LOADB R3 1
  RETURN R3 1
...
MAIN:
  ...
  GETTABLEKS R5 R2 K9 ["supportDetachedAttachments"]
  CALL R4 1 1
  GETIMPORT R5 K4 [require]
  GETTABLEKS R6 R2 K10 ["findPVAncestor"]
  CALL R5 1 1
  NEWTABLE R6 8 0
  ...
  CALL R8 4 1
  SETTABLE R8 R6 R7
  GETIMPORT R7 K25 [Enum.NormalId.Front]
  GETIMPORT R8 K17 [CFrame.fromMatrix]
  FASTCALL VECTOR [+2]
  GETIMPORT R9 K20 [Vector3.new]
  CALL R9 0 1
  ...
  CALL R8 4 1
  SETTABLE R8 R6 R7
  GETIMPORT R7 K29 [Enum.NormalId.Right]
  GETIMPORT R8 K17 [CFrame.fromMatrix]
  FASTCALL VECTOR [+2]
  GETIMPORT R9 K20 [Vector3.new]
  CALL R9 0 1
  ...
  CALL R8 4 1
  SETTABLE R8 R6 R7
  GETIMPORT R7 K31 [Enum.NormalId.Left]
  GETIMPORT R8 K17 [CFrame.fromMatrix]
  FASTCALL VECTOR [+2]
  GETIMPORT R9 K20 [Vector3.new]
  CALL R9 0 1
  ...
  CALL R8 4 1
  SETTABLE R8 R6 R7
  GETIMPORT R7 K33 [Enum.NormalId.Bottom]
  GETIMPORT R8 K17 [CFrame.fromMatrix]
  FASTCALL VECTOR [+2]
  GETIMPORT R9 K20 [Vector3.new]
  CALL R9 0 1
  ...
  CALL R8 4 1
  SETTABLE R8 R6 R7
  GETIMPORT R7 K36 [Enum.NormalId.Top]
  GETIMPORT R8 K17 [CFrame.fromMatrix]
  FASTCALL VECTOR [+2]
  GETIMPORT R9 K20 [Vector3.new]
  CALL R9 0 1
  ...
  CALL R8 4 1
  SETTABLE R8 R6 R7
  GETTABLEKS R7 R3 K37 ["THICKNESS"]
  GETTABLEKS R8 R3 K38 ["TRANSPARENCY"]
  NEWTABLE R9 16 0
  SETTABLEKS R9 R9 K39 ["__index"]
  DUPCLOSURE R10 K40 [PROTO_0]
  CAPTURE VAL R9
  SETTABLEKS R10 R9 K19 ["new"]
  DUPCLOSURE R10 K41 [PROTO_1]
  CAPTURE VAL R6
  SETTABLEKS R10 R9 K42 ["render"]
  DUPCLOSURE R10 K43 [PROTO_2]
  SETTABLEKS R10 R9 K44 ["pool"]
  DUPCLOSURE R10 K45 [PROTO_3]
  CAPTURE VAL R4
  CAPTURE VAL R5
  SETTABLEKS R10 R9 K46 ["adorn"]
  DUPCLOSURE R10 K47 [PROTO_4]
  SETTABLEKS R10 R9 K48 ["destroy"]
  DUPCLOSURE R10 K49 [PROTO_5]
  SETTABLEKS R10 R9 K50 ["setGuidesFolder"]
  DUPCLOSURE R10 K51 [PROTO_6]
  CAPTURE VAL R4
  SETTABLEKS R10 R9 K52 ["_setAncestry"]
  DUPCLOSURE R10 K53 [PROTO_7]
  SETTABLEKS R10 R9 K54 ["_setCFrameValues"]
  DUPCLOSURE R10 K55 [PROTO_8]
  CAPTURE VAL R7
  CAPTURE VAL R8
  SETTABLEKS R10 R9 K56 ["_setHandles"]
  DUPCLOSURE R10 K57 [PROTO_9]
  SETTABLEKS R10 R9 K58 ["_removeHandles"]
  DUPCLOSURE R10 K59 [PROTO_14]
  SETTABLEKS R10 R9 K60 ["_setListeners"]
  DUPCLOSURE R10 K61 [PROTO_15]
  SETTABLEKS R10 R9 K62 ["_removeListeners"]
  RETURN R9 1
