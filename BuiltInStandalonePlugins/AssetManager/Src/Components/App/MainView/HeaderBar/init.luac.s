PROTO_0:
  ...
  GETIMPORT R8 K7 [Enum.FillDirection.Horizontal]
  SETTABLEKS R8 R7 K8 ["Layout"]
  GETUPVAL R9 4
  GETTABLEKS R8 R9 K9 ["Tag"]
  LOADK R9 K10 ["TopBar HeaderBar X-Left X-Row X-Stroke"]
  SETTABLE R9 R7 R8
  DUPTABLE R8 K13 [{"ScopeTitleContainer", "Options"}]
  GETUPVAL R10 4
  GETTABLEKS R9 R10 K2 ["createElement"]
  GETUPVAL R10 5
  NEWTABLE R11 2 0
  NAMECALL R12 R1 K14 ["getNextOrder"]
  CALL R12 1 1
  SETTABLEKS R12 R11 K3 ["LayoutOrder"]
  GETUPVAL R13 4
  GETTABLEKS R12 R13 K9 ["Tag"]
  LOADK R13 K15 ["Header X-Pad X-Left X-Middle"]
  SETTABLE R13 R11 R12
  DUPTABLE R12 K17 [{"ScopeTitle"}]
  GETUPVAL R14 4
  GETTABLEKS R13 R14 K2 ["createElement"]
  GETUPVAL R14 6
  NEWTABLE R15 2 0
  GETTABLEKS R17 R4 K18 ["Selection"]
  GETTABLEKS R16 R17 K19 ["Name"]
  SETTABLEKS R16 R15 K20 ["Text"]
  GETUPVAL R17 4
  GETTABLEKS R16 R17 K9 ["Tag"]
  LOADK R17 K21 ["Title X-Fit X-PadS"]
  SETTABLE R17 R15 R16
  CALL R13 2 1
  SETTABLEKS R13 R12 K16 ["ScopeTitle"]
  CALL R9 3 1
  SETTABLEKS R9 R8 K11 ["ScopeTitleContainer"]
  GETUPVAL R10 4
  GETTABLEKS R9 R10 K2 ["createElement"]
  GETUPVAL R10 5
  NEWTABLE R11 2 0
  ...
  GETUPVAL R13 4
  GETTABLEKS R12 R13 K9 ["Tag"]
  LOADK R13 K22 ["Options X-Right X-RowM X-Middle X-PadS"]
  SETTABLE R13 R11 R12
  NEWTABLE R12 0 0
  CALL R9 3 1
  SETTABLEKS R9 R8 K12 ["Options"]
  CALL R5 3 -1
  RETURN R5 -1
