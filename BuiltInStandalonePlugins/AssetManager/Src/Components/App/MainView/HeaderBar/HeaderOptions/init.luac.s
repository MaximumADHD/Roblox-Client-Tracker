...
PROTO_9:
  ...
  DUPTABLE R14 K11 [{"CreatorFilter", "AssetTypeFilter", "ClearFiltersButton", "ViewTypeSelector"}]
  GETUPVAL R16 4
  ...
  LOADK R20 K13 ["Filters"]
  LOADK R21 K14 ["Owner"]
  NAMECALL R18 R2 K15 ["getText"]
  CALL R18 3 1
  SETTABLEKS R18 R17 K16 ["PlaceholderText"]
  SETTABLEKS R6 R17 K17 ["SelectedIndex"]
  NAMECALL R18 R3 K18 ["getOwners"]
  CALL R18 1 1
  SETTABLEKS R18 R17 K19 ["Items"]
  NEWCLOSURE R18 P2
  CAPTURE VAL R7
  CAPTURE VAL R3
  CAPTURE UPVAL U9
  SETTABLEKS R18 R17 K20 ["OnItemActivated"]
  DUPCLOSURE R18 K21 [PROTO_3]
  CAPTURE VAL R8
  CAPTURE UPVAL U9
  SETTABLEKS R18 R17 K22 ["OnRenderItem"]
  LOADB R18 1
  SETTABLEKS R18 R17 K23 ["UseAutoWidth"]
  GETIMPORT R18 K27 [Enum.TextTruncate.AtEnd]
  SETTABLEKS R18 R17 K25 ["TextTruncate"]
  GETUPVAL R18 10
  LOADK R20 K28 ["FilterSize"]
  NAMECALL R18 R18 K29 ["GetAttribute"]
  CALL R18 2 1
  ...
  CALL R15 2 1
  SETTABLEKS R15 R14 K7 ["CreatorFilter"]
  GETUPVAL R16 4
  GETTABLEKS R15 R16 K3 ["createElement"]
  GETUPVAL R16 8
  NEWTABLE R17 16 0
  ...
  SETTABLEKS R18 R17 K4 ["LayoutOrder"]
  LOADK R20 K13 ["Filters"]
  LOADK R21 K32 ["AssetTypes"]
  NAMECALL R18 R2 K15 ["getText"]
  CALL R18 3 1
  SETTABLEKS R18 R17 K16 ["PlaceholderText"]
  SETTABLEKS R4 R17 K17 ["SelectedIndex"]
  GETUPVAL R19 11
  GETTABLEKS R18 R19 K33 ["getEnumAsList"]
  GETUPVAL R20 11
  GETTABLEKS R19 R20 K34 ["AssetType"]
  CALL R18 1 1
  SETTABLEKS R18 R17 K19 ["Items"]
  NEWCLOSURE R18 P4
  CAPTURE VAL R5
  ...
  SETTABLE R19 R17 R18
  CALL R15 2 1
  SETTABLEKS R15 R14 K8 ["AssetTypeFilter"]
  GETUPVAL R16 4
  GETTABLEKS R15 R16 K3 ["createElement"]
  GETUPVAL R16 7
  NEWTABLE R17 4 0
  ...
  GETUPVAL R19 4
  GETTABLEKS R18 R19 K5 ["Tag"]
  LOADK R19 K37 ["ClearFilter"]
  SETTABLE R19 R17 R18
  DUPTABLE R18 K39 [{"ClearFiltersIcon"}]
  GETUPVAL R20 4
  GETTABLEKS R19 R20 K3 ["createElement"]
  GETUPVAL R20 12
  NEWTABLE R21 2 0
  GETUPVAL R23 13
  GETTABLEKS R22 R23 K40 ["CLEAR_ICON"]
  SETTABLEKS R22 R21 K41 ["Image"]
  GETUPVAL R23 4
  GETTABLEKS R22 R23 K5 ["Tag"]
  LOADK R23 K42 ["FilterImage"]
  SETTABLE R23 R21 R22
  CALL R19 2 1
  SETTABLEKS R19 R18 K38 ["ClearFiltersIcon"]
  CALL R15 3 1
  SETTABLEKS R15 R14 K9 ["ClearFiltersButton"]
  GETUPVAL R16 4
  GETTABLEKS R15 R16 K3 ["createElement"]
  GETUPVAL R16 14
  NEWTABLE R17 8 0
  ...
  CAPTURE VAL R9
  CAPTURE VAL R3
  SETTABLEKS R18 R17 K43 ["OnGridTileSizeChanged"]
  NEWCLOSURE R18 P8
  CAPTURE UPVAL U11
  CAPTURE VAL R9
  CAPTURE VAL R3
  SETTABLEKS R18 R17 K44 ["OnViewTypeSelected"]
  GETTABLEKS R19 R9 K45 ["ViewType"]
  GETTABLEKS R18 R19 K46 ["rawValue"]
  CALL R18 0 1
  SETTABLEKS R18 R17 K47 ["Default"]
  GETTABLEKS R18 R9 K48 ["GridSize"]
  SETTABLEKS R18 R17 K49 ["DefaultGridTileSize"]
  GETUPVAL R19 4
  GETTABLEKS R18 R19 K5 ["Tag"]
  LOADK R19 K50 ["IconOnly"]
  SETTABLE R19 R17 R18
  CALL R15 2 1
  SETTABLEKS R15 R14 K10 ["ViewTypeSelector"]
  CALL R11 3 -1
  RETURN R11 -1
