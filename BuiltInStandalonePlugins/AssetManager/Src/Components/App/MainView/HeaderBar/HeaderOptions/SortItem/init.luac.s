...
PROTO_1:
  ...
  LOADK R5 K5 ["Bold"]
  GETUPVAL R9 4
  GETTABLEKS R6 R9 K6 ["ARROW_UP_ICON"]
  JUMP [+7]
  LOADK R5 K5 ["Bold"]
  GETUPVAL R9 4
  GETTABLEKS R6 R9 K7 ["ARROW_DOWN_ICON"]
  JUMP [+2]
  LOADK R5 K8 [""]
  LOADK R6 K8 [""]
  ...
  CALL R15 1 1
  SETTABLEKS R15 R14 K12 ["LayoutOrder"]
  SETTABLEKS R6 R14 K31 ["Image"]
  GETUPVAL R16 5
  GETTABLEKS R15 R16 K18 ["Tag"]
  LOADK R16 K32 ["Icon16"]
  SETTABLE R16 R14 R15
  CALL R12 2 1
  JUMP [+1]
  LOADNIL R12
