PROTO_0:
  ...
  DUPTABLE R3 K5 [{"name", "LayoutOrder", "tag"}]
  GETUPVAL R7 1
  GETTABLEKS R6 R7 K6 ["Enums"]
  GETTABLEKS R5 R6 K7 ["IconName"]
  GETTABLEKS R4 R5 K8 ["DiamondSimplified"]
  SETTABLEKS R4 R3 K2 ["name"]
  GETTABLEKS R4 R0 K3 ["LayoutOrder"]
  SETTABLEKS R4 R3 K3 ["LayoutOrder"]
  LOADK R4 K9 ["bg-action-subtle"]
...
PROTO_5:
  ...
  CALL R20 0 1
  JUMPIFNOT R20 [+19]
  GETTABLEKS R20 R6 K31 ["AssetType"]
  GETUPVAL R23 11
  GETTABLEKS R22 R23 K31 ["AssetType"]
  GETTABLEKS R21 R22 K32 ["Folder"]
  ...
  GETTABLEKS R19 R20 K13 ["createElement"]
  GETUPVAL R20 14
  DUPTABLE R21 K34 [{"AssetId", "AssetType"}]
  ...
  GETTABLEKS R20 R6 K35 ["IsPackage"]
  JUMPIFNOT R20 [+15]
  GETUPVAL R20 9
  GETTABLEKS R19 R20 K13 ["createElement"]
  GETUPVAL R21 15
  GETTABLEKS R20 R21 K36 ["Image"]
  DUPTABLE R21 K39 [{"ZIndex", "tag"}]
  LOADN R22 2
  SETTABLEKS R22 R21 K37 ["ZIndex"]
  LOADK R22 K40 ["icon-packageLink anchor-bottom-right am-size-icon bg-over-media-0 radius-small data-testid=package-link-icon"]
  SETTABLEKS R22 R21 K38 ["tag"]
  CALL R19 2 1
  JUMP [+1]
  LOADNIL R19
