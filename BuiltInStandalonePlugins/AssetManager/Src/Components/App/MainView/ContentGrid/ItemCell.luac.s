...
PROTO_4:
  ...
  GETUPVAL R16 10
  NEWTABLE R17 2 0
  NAMECALL R18 R1 K39 ["getNextOrder"]
  CALL R18 1 1
  SETTABLEKS R18 R17 K15 ["LayoutOrder"]
  GETUPVAL R19 9
  GETTABLEKS R18 R19 K21 ["Tag"]
  LOADK R19 K40 ["am-padding-celldata am-size-full-celldata X-Column X-Left X-Middle"]
  SETTABLE R19 R17 R18
  DUPTABLE R18 K43 [{"NameTag", "TypeTag"}]
  ...
  GETUPVAL R20 14
  NEWTABLE R21 8 0
  NAMECALL R22 R1 K39 ["getNextOrder"]
  CALL R22 1 1
  SETTABLEKS R22 R21 K15 ["LayoutOrder"]
  GETTABLEKS R22 R6 K6 ["DisplayName"]
  SETTABLEKS R22 R21 K44 ["Text"]
  LOADB R22 1
  SETTABLEKS R22 R21 K45 ["ShouldFocus"]
  NEWCLOSURE R22 P3
  CAPTURE VAL R4
  SETTABLEKS R22 R21 K46 ["OnFocusLost"]
  GETUPVAL R23 9
  ...
  GETTABLEKS R22 R6 K6 ["DisplayName"]
  SETTABLEKS R22 R21 K44 ["Text"]
  GETIMPORT R22 K51 [Enum.TextTruncate.AtEnd]
  SETTABLEKS R22 R21 K49 ["TextTruncate"]
  GETUPVAL R23 9
  GETTABLEKS R22 R23 K21 ["Tag"]
  LOADK R23 K47 ["Left"]
  SETTABLE R23 R21 R22
  DUPTABLE R22 K53 [{"Tooltip"}]
  JUMPIFNOT R10 [+11]
  GETUPVAL R24 9
  GETTABLEKS R23 R24 K13 ["createElement"]
  GETUPVAL R24 16
  DUPTABLE R25 K54 [{"Text"}]
  GETTABLEKS R26 R6 K6 ["DisplayName"]
  SETTABLEKS R26 R25 K44 ["Text"]
  CALL R23 2 1
  JUMP [+1]
  LOADNIL R23
  SETTABLEKS R23 R22 K52 ["Tooltip"]
  CALL R19 3 1
  SETTABLEKS R19 R18 K41 ["NameTag"]
  GETUPVAL R20 9
  GETTABLEKS R19 R20 K13 ["createElement"]
  GETUPVAL R20 15
  NEWTABLE R21 8 0
  GETIMPORT R22 K57 [Enum.AutomaticSize.XY]
  SETTABLEKS R22 R21 K55 ["AutomaticSize"]
  NAMECALL R22 R1 K39 ["getNextOrder"]
  CALL R22 1 1
  SETTABLEKS R22 R21 K15 ["LayoutOrder"]
  ...
  SETTABLE R23 R21 R22
  CALL R19 2 1
  SETTABLEKS R19 R18 K42 ["TypeTag"]
  CALL R15 3 1
