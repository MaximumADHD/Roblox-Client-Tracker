...
PROTO_4:
  ...
  MODK R10 R11 K3 [2]
  JUMPIFNOTEQKN R10 K5 [0] [+3]
  LOADK R9 K6 ["ContrastRow"]
  JUMP [+1]
  LOADK R9 K7 [""]
  GETTABLEKS R11 R6 K8 ["AssetId"]
  GETTABLE R10 R7 R11
  JUMPIFNOT R10 [+1]
  LOADK R9 K9 ["SelectedRow"]
  GETUPVAL R10 8
  MOVE R11 R6
  MOVE R12 R4
  MOVE R13 R5
  ...
  CAPTURE VAL R0
  CAPTURE VAL R1
  SETTABLEKS R14 R13 K13 ["OnClick"]
  NEWCLOSURE R14 P1
  CAPTURE UPVAL U11
  CAPTURE VAL R6
  CAPTURE VAL R2
  CAPTURE VAL R3
  SETTABLEKS R14 R13 K14 ["OnRightClick"]
  GETUPVAL R15 9
  GETTABLEKS R14 R15 K15 ["Tag"]
  LOADK R16 K16 ["ItemRow X-FitX X-Row X-Left X-Middle %*"]
  MOVE R18 R9
...
MAIN:
  ...
  GETTABLEKS R17 R18 K26 ["renderContextMenu"]
  CALL R16 1 1
  ...
  GETTABLEKS R18 R19 K28 ["DoubleClickDetector"]
