PROTO_0:
        ...
        9 GETUPVAL                         R5 3
       10 GETTABLEKS                       R4 R5 K2 ["Tooltip"]
       ...
       31 GETUPVAL                         R9 3
       32 GETTABLEKS                       R8 R9 K13 ["Enums"]
       34 GETTABLEKS                       R7 R8 K14 ["PopoverSide"]
       36 GETTABLEKS                       R6 R7 K15 ["Top"]
       38 SETTABLEKS                       R6 R5 K6 ["side"]
       40 GETUPVAL                         R9 3
       41 GETTABLEKS                       R8 R9 K13 ["Enums"]
       43 GETTABLEKS                       R7 R8 K16 ["PopoverAlign"]
       45 GETTABLEKS                       R6 R7 K17 ["Center"]
       47 SETTABLEKS                       R6 R5 K7 ["align"]
       49 GETUPVAL                         R7 2
       50 GETTABLEKS                       R6 R7 K1 ["createElement"]
       52 GETUPVAL                         R8 3
       53 GETTABLEKS                       R7 R8 K18 ["Icon"]
       55 DUPTABLE                         R8 K23 [{"name", "size", "style", "variant"}]
       56 GETUPVAL                         R12 3
       57 GETTABLEKS                       R11 R12 K13 ["Enums"]
       59 GETTABLEKS                       R10 R11 K24 ["IconName"]
       61 GETTABLEKS                       R9 R10 K25 ["TriangleExclamation"]
       63 SETTABLEKS                       R9 R8 K19 ["name"]
       65 GETUPVAL                         R12 3
       66 GETTABLEKS                       R11 R12 K13 ["Enums"]
       68 GETTABLEKS                       R10 R11 K26 ["IconSize"]
       70 GETTABLEKS                       R9 R10 K27 ["Small"]
       72 SETTABLEKS                       R9 R8 K20 ["size"]
       74 GETTABLEKS                       R11 R2 K28 ["Color"]
       76 GETTABLEKS                       R10 R11 K29 ["System"]
       78 GETTABLEKS                       R9 R10 K30 ["Warning"]
       80 SETTABLEKS                       R9 R8 K21 ["style"]
       82 GETUPVAL                         R12 3
       83 GETTABLEKS                       R11 R12 K13 ["Enums"]
       85 GETTABLEKS                       R10 R11 K31 ["IconVariant"]
       87 GETTABLEKS                       R9 R10 K32 ["Filled"]
...
PROTO_3:
       ...
       52 GETUPVAL                         R7 3
       53 GETTABLEKS                       R6 R7 K10 ["Dropdown"]
       55 GETTABLEKS                       R5 R6 K11 ["Root"]
       ...
       62 GETUPVAL                         R9 1
       63 GETTABLEKS                       R8 R9 K1 ["PermissionsAction"]
       65 GETTABLEKS                       R10 R0 K22 ["Item"]
       67 GETTABLEKS                       R9 R10 K23 ["Action"]
...
PROTO_8:
       ...
       67 GETUPVAL                         R12 2
       68 GETTABLEKS                       R11 R12 K8 ["createElement"]
       70 GETUPVAL                         R12 7
...
PROTO_9:
       ...
       20 GETUPVAL                         R8 4
       21 GETTABLEKS                       R7 R8 K5 ["useMemo"]
       23 NEWCLOSURE                       R8 P0
       24 CAPTURE                          VAL R2
       25 NEWTABLE                         R9 0 1
       27 MOVE                             R10 R4
       ...
       30 CALL                             R7 2 1
       31 GETUPVAL                         R9 4
       32 GETTABLEKS                       R8 R9 K6 ["useCallback"]
       34 NEWCLOSURE                       R9 P1
       35 CAPTURE                          VAL R2
       36 NEWTABLE                         R10 0 0
       38 CALL                             R8 2 1
       39 GETUPVAL                         R10 4
       40 GETTABLEKS                       R9 R10 K6 ["useCallback"]
       42 NEWCLOSURE                       R10 P2
       43 CAPTURE                          VAL R2
       44 NEWTABLE                         R11 0 0
       46 CALL                             R9 2 1
       47 GETUPVAL                         R11 4
       48 GETTABLEKS                       R10 R11 K6 ["useCallback"]
       50 NEWCLOSURE                       R11 P3
       51 CAPTURE                          VAL R2
       52 NEWTABLE                         R12 0 0
       54 CALL                             R10 2 1
       55 GETUPVAL                         R12 4
       56 GETTABLEKS                       R11 R12 K7 ["createElement"]
       58 GETUPVAL                         R13 5
       59 GETTABLEKS                       R12 R13 K8 ["View"]
       ...
       66 GETUPVAL                         R16 4
       67 GETTABLEKS                       R15 R16 K7 ["createElement"]
       69 GETUPVAL                         R16 6
      ...
      113 GETUPVAL                         R19 8
      114 GETTABLEKS                       R18 R19 K29 ["map"]
      116 MOVE                             R19 R6
...
MAIN:
       ...
       47 GETTABLEKS                       R10 R11 K16 ["Controllers"]
       49 GETTABLEKS                       R9 R10 K17 ["PluginController"]
       51 CALL                             R8 1 1
       52 GETIMPORT                        R9 K5 [require]
       54 GETTABLEKS                       R13 R0 K15 ["Src"]
       56 GETTABLEKS                       R12 R13 K18 ["Util"]
       58 GETTABLEKS                       R11 R12 K19 ["Dialogs"]
       60 GETTABLEKS                       R10 R11 K20 ["useQuickShareState"]
       62 CALL                             R9 1 1
       63 GETIMPORT                        R10 K5 [require]
       65 GETIMPORT                        R12 K1 [script]
       67 GETTABLEKS                       R11 R12 K21 ["CollaboratorsDropdown"]
       69 CALL                             R10 1 1
       70 GETIMPORT                        R11 K5 [require]
       72 GETIMPORT                        R14 K1 [script]
       74 GETTABLEKS                       R13 R14 K22 ["Parent"]
       76 GETTABLEKS                       R12 R13 K23 ["SelectedView"]
       78 CALL                             R11 1 1
       79 GETIMPORT                        R12 K5 [require]
       81 GETIMPORT                        R15 K1 [script]
       83 GETTABLEKS                       R14 R15 K22 ["Parent"]
       85 GETTABLEKS                       R13 R14 K24 ["SelectedEntry"]
       87 CALL                             R12 1 1
       88 GETIMPORT                        R13 K5 [require]
       90 GETTABLEKS                       R15 R0 K15 ["Src"]
       92 GETTABLEKS                       R14 R15 K25 ["Types"]
       94 CALL                             R13 1 1
       95 GETIMPORT                        R14 K5 [require]
       97 GETTABLEKS                       R17 R0 K15 ["Src"]
       99 GETTABLEKS                       R16 R17 K26 ["Resources"]
      101 GETTABLEKS                       R15 R16 K27 ["StyleConstants"]
      103 CALL                             R14 1 1
