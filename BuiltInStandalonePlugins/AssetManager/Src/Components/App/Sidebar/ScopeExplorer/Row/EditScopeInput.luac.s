...
PROTO_2:
        ...
        3 ADDK                             R2 R3 K3 [-40]
        4 GETUPVAL                         R5 1
        5 GETTABLEKS                       R4 R5 K4 ["IconWidthXSmall"]
        7 GETUPVAL                         R6 2
        8 GETTABLEKS                       R5 R6 K5 ["Depth"]
       10 MUL                              R3 R4 R5
       11 SUB                              R1 R2 R3
       12 LOADN                            R2 0
       13 CALL                             R0 2 -1
...
PROTO_3:
        ...
        7 CALL                             R1 2 0
        8 GETUPVAL                         R2 1
        9 GETTABLEKS                       R1 R2 K3 ["use"]
       11 CALL                             R1 0 1
       12 GETUPVAL                         R3 2
       13 GETTABLEKS                       R2 R3 K3 ["use"]
       15 CALL                             R2 0 1
       16 GETUPVAL                         R4 3
       17 GETTABLEKS                       R3 R4 K3 ["use"]
       19 CALL                             R3 0 1
       20 GETUPVAL                         R4 4
       21 CALL                             R4 0 1
       22 GETUPVAL                         R6 5
       ...
       35 CALL                             R5 2 1
       36 GETUPVAL                         R7 5
       37 GETTABLEKS                       R6 R7 K6 ["useCallback"]
       39 NEWCLOSURE                       R7 P1
       40 CAPTURE                          VAL R2
       41 CAPTURE                          VAL R1
       42 CAPTURE                          VAL R5
       ...
       51 CALL                             R6 2 1
       52 GETUPVAL                         R8 5
       53 GETTABLEKS                       R7 R8 K4 ["useMemo"]
       55 NEWCLOSURE                       R8 P2
       56 CAPTURE                          VAL R4
       57 CAPTURE                          UPVAL U7
       58 CAPTURE                          VAL R0
       ...
       66 CALL                             R7 2 1
       67 GETUPVAL                         R9 5
       68 GETTABLEKS                       R8 R9 K8 ["createElement"]
       70 GETUPVAL                         R10 8
       71 GETTABLEKS                       R9 R10 K9 ["View"]
       ...
       81 GETUPVAL                         R12 5
       82 GETTABLEKS                       R11 R12 K8 ["createElement"]
       84 GETUPVAL                         R12 9
       ...
       92 GETTABLEKS                       R15 R0 K5 ["StagedFolder"]
       94 GETTABLEKS                       R14 R15 K20 ["Path"]
       96 SETTABLEKS                       R14 R13 K15 ["ItemPath"]
       98 GETUPVAL                         R16 10
       99 GETTABLEKS                       R15 R16 K21 ["AssetType"]
      101 GETTABLEKS                       R14 R15 K22 ["Folder"]
...
MAIN:
       ...
       45 GETTABLEKS                       R8 R9 K15 ["Constants"]
       47 CALL                             R7 1 1
       48 GETIMPORT                        R8 K5 [require]
       50 GETTABLEKS                       R11 R0 K12 ["Src"]
       52 GETTABLEKS                       R10 R11 K14 ["Resources"]
       54 GETTABLEKS                       R9 R10 K16 ["StyleConstants"]
       56 CALL                             R8 1 1
       57 GETIMPORT                        R9 K5 [require]
       59 GETTABLEKS                       R12 R0 K12 ["Src"]
       61 GETTABLEKS                       R11 R12 K17 ["Controllers"]
       63 GETTABLEKS                       R10 R11 K18 ["ExplorerController"]
       65 CALL                             R9 1 1
       66 GETIMPORT                        R10 K5 [require]
       68 GETTABLEKS                       R13 R0 K12 ["Src"]
       70 GETTABLEKS                       R12 R13 K17 ["Controllers"]
       72 GETTABLEKS                       R11 R12 K19 ["ItemsController"]
       74 CALL                             R10 1 1
       75 GETIMPORT                        R11 K5 [require]
       77 GETTABLEKS                       R14 R0 K12 ["Src"]
       79 GETTABLEKS                       R13 R14 K20 ["Hooks"]
       81 GETTABLEKS                       R12 R13 K21 ["useSidebarWidth"]
       83 CALL                             R11 1 1
       84 GETIMPORT                        R12 K5 [require]
       86 GETTABLEKS                       R16 R0 K12 ["Src"]
       88 GETTABLEKS                       R15 R16 K22 ["Components"]
       90 GETTABLEKS                       R14 R15 K23 ["Shared"]
       92 GETTABLEKS                       R13 R14 K24 ["EditNameInput"]
       94 CALL                             R12 1 1
       95 GETIMPORT                        R13 K5 [require]
       97 GETTABLEKS                       R16 R0 K12 ["Src"]
       99 GETTABLEKS                       R15 R16 K25 ["Flags"]
      101 GETTABLEKS                       R14 R15 K26 ["getFFlagAmrOrganizationFoundation"]
      103 CALL                             R13 1 1
