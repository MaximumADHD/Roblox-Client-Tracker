PROTO_0:
  ...
  MOVE R5 R6
  SETTABLE R5 R3 R4
  DUPTABLE R4 K10 [{"Icon"}]
  GETUPVAL R6 1
  GETTABLEKS R5 R6 K3 ["createElement"]
  GETUPVAL R6 3
  NEWTABLE R7 2 0
  GETTABLEKS R8 R0 K11 ["Image"]
  SETTABLEKS R8 R7 K11 ["Image"]
  GETUPVAL R9 1
  GETTABLEKS R8 R9 K6 ["Tag"]
  GETUPVAL R9 4
  LOADK R10 K12 ["Icon16 X-PadL X-AnchorCenter"]
  GETUPVAL R13 1
  GETTABLEKS R12 R13 K6 ["Tag"]
  GETTABLE R11 R0 R12
  CALL R9 2 1
  SETTABLE R9 R7 R8
  DUPTABLE R8 K14 [{"Tooltip"}]
  GETTABLEKS R10 R0 K13 ["Tooltip"]
  JUMPIFNOT R10 [+11]
  GETUPVAL R10 1
  GETTABLEKS R9 R10 K3 ["createElement"]
  GETUPVAL R10 5
  DUPTABLE R11 K16 [{"Text"}]
  GETTABLEKS R12 R0 K13 ["Tooltip"]
