PROTO_0:
  ...
  GETUPVAL R6 2
  NEWTABLE R7 2 0
  GETTABLEKS R8 R0 K8 ["Image"]
  SETTABLEKS R8 R7 K8 ["Image"]
  GETUPVAL R9 0
  GETTABLEKS R8 R9 K3 ["Tag"]
  GETUPVAL R9 3
  LOADK R10 K9 ["Icon16 X-PadL X-AnchorCenter"]
  GETUPVAL R13 0
  GETTABLEKS R12 R13 K3 ["Tag"]
  GETTABLE R11 R0 R12
  CALL R9 2 1
  SETTABLE R9 R7 R8
  DUPTABLE R8 K11 [{"Tooltip"}]
  GETTABLEKS R10 R0 K10 ["Tooltip"]
  JUMPIFNOT R10 [+11]
  GETUPVAL R10 0
  GETTABLEKS R9 R10 K0 ["createElement"]
  GETUPVAL R10 4
  DUPTABLE R11 K13 [{"Text"}]
  GETTABLEKS R12 R0 K10 ["Tooltip"]
