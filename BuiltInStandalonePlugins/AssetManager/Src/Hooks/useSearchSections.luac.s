...
PROTO_2:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R0 R1 K0 ["ShowSearchOptions"]
        3 JUMPIFNOT                        R0 ; [+57]
        4 NEWTABLE                         R0 0 0
        6 GETUPVAL                         R1 1
        7 LOADN                            R2 0
       ...
       11 GETUPVAL                         R6 2
       12 GETTABLEKS                       R5 R6 K5 ["AssetType"]
       14 GETTABLEKS                       R4 R5 K6 ["Folder"]
       ...
       38 GETUPVAL                         R6 0
       39 GETTABLEKS                       R5 R6 K10 ["SearchOptions"]
       41 GETTABLEKS                       R4 R5 K5 ["AssetType"]
...
PROTO_6:
        ...
        2 MOVE                             R2 R0
        3 GETUPVAL                         R4 0
        4 GETTABLEKS                       R3 R4 K0 ["OnLayoutFolderLimitChanged"]
        6 NEWCLOSURE                       R5 P0
        7 CAPTURE                          UPVAL U1
        8 CAPTURE                          UPVAL U0
       ...
       16 MOVE                             R2 R0
       17 GETUPVAL                         R4 2
       18 GETTABLEKS                       R3 R4 K5 ["OnSearchFolderCountChanged"]
       20 NEWCLOSURE                       R5 P1
       21 CAPTURE                          UPVAL U3
       22 CAPTURE                          UPVAL U2
...
PROTO_7:
       ...
       18 CALL                             R4 -1 2
       19 GETUPVAL                         R7 4
       20 GETTABLEKS                       R6 R7 K3 ["useMemo"]
       22 NEWCLOSURE                       R7 P0
       23 CAPTURE                          VAL R0
       24 NEWTABLE                         R8 0 1
       26 MOVE                             R9 R2
       ...
       29 CALL                             R6 2 1
       30 GETUPVAL                         R8 4
       31 GETTABLEKS                       R7 R8 K1 ["useState"]
       ...
       51 CALL                             R9 2 1
       52 GETUPVAL                         R11 4
       53 GETTABLEKS                       R10 R11 K3 ["useMemo"]
       ...
       67 CALL                             R10 2 1
       68 GETUPVAL                         R12 4
       69 GETTABLEKS                       R11 R12 K5 ["useEffect"]
...
MAIN:
       ...
       36 GETTABLEKS                       R5 R6 K13 ["useItems"]
       38 CALL                             R4 1 1
       39 GETIMPORT                        R5 K5 [require]
       41 GETTABLEKS                       R8 R0 K8 ["Src"]
       43 GETTABLEKS                       R7 R8 K12 ["Hooks"]
       45 GETTABLEKS                       R6 R7 K14 ["useSearchInfo"]
       47 CALL                             R5 1 1
       48 GETIMPORT                        R6 K5 [require]
       50 GETTABLEKS                       R9 R0 K8 ["Src"]
       52 GETTABLEKS                       R8 R9 K15 ["Controllers"]
       54 GETTABLEKS                       R7 R8 K16 ["ItemsController"]
       56 CALL                             R6 1 1
       57 GETIMPORT                        R7 K5 [require]
       59 GETTABLEKS                       R10 R0 K8 ["Src"]
       61 GETTABLEKS                       R9 R10 K15 ["Controllers"]
       63 GETTABLEKS                       R8 R9 K17 ["LayoutController"]
       65 CALL                             R7 1 1
