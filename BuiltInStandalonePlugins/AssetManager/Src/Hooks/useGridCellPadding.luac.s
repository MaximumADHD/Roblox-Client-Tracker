PROTO_0:
        0 GETUPVAL                         R0 0
        1 GETUPVAL                         R1 1
        2 NAMECALL                         R1 R1 K0 ["getGridCellPadding"]
        4 CALL                             R1 1 -1
        5 CALL                             R0 -1 0
        6 GETUPVAL                         R0 2
        7 GETUPVAL                         R1 1
        8 NAMECALL                         R1 R1 K1 ["getGridCellsPerRow"]
       10 CALL                             R1 1 -1
       11 CALL                             R0 -1 0
       12 RETURN                           R0 0
...
PROTO_2:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["OnGridStateUpdated"]
        3 NEWCLOSURE                       R2 P0
        4 CAPTURE                          UPVAL U1
        5 CAPTURE                          UPVAL U0
        6 CAPTURE                          UPVAL U2
...
PROTO_3:
        ...
        7 NAMECALL                         R2 R0 K2 ["getGridCellPadding"]
        9 CALL                             R2 1 -1
       10 CALL                             R1 -1 2
       11 GETUPVAL                         R3 1
       12 GETTABLEKS                       R3 R3 K1 ["useState"]
       14 NAMECALL                         R4 R0 K3 ["getGridCellsPerRow"]
       16 CALL                             R4 1 -1
       17 CALL                             R3 -1 2
       18 GETUPVAL                         R5 1
