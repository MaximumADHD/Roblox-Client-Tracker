...
PROTO_3:
        ...
        2 MOVE                             R2 R0
        3 GETUPVAL                         R4 0
        4 GETTABLEKS                       R3 R4 K0 ["OnDragMove"]
        6 GETUPVAL                         R5 1
       ...
       14 MOVE                             R2 R0
       15 GETUPVAL                         R4 2
       16 GETTABLEKS                       R3 R4 K5 ["OnExpansionChanged"]
       18 NEWCLOSURE                       R5 P0
       19 CAPTURE                          UPVAL U2
       20 CAPTURE                          UPVAL U3
       21 CAPTURE                          UPVAL U4
...
PROTO_4:
       ...
       33 CALL                             R6 2 1
       34 GETUPVAL                         R8 2
       35 GETTABLEKS                       R7 R8 K5 ["useEffect"]
       37 NEWCLOSURE                       R8 P1
       38 CAPTURE                          VAL R2
       39 CAPTURE                          VAL R6
       40 CAPTURE                          VAL R3
...
MAIN:
       ...
       29 GETTABLEKS                       R4 R5 K12 ["Input"]
       31 CALL                             R3 1 1
       32 GETIMPORT                        R4 K5 [require]
       34 GETTABLEKS                       R7 R0 K8 ["Src"]
       36 GETTABLEKS                       R6 R7 K11 ["Controllers"]
       38 GETTABLEKS                       R5 R6 K13 ["ExplorerController"]
       40 CALL                             R4 1 1
       41 GETIMPORT                        R5 K5 [require]
       43 GETTABLEKS                       R8 R0 K8 ["Src"]
       45 GETTABLEKS                       R7 R8 K9 ["Util"]
       47 GETTABLEKS                       R6 R7 K14 ["isPositionInFrame"]
       49 CALL                             R5 1 1
