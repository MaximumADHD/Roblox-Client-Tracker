...
PROTO_17:
  ...
  NAMECALL R1 R0 K4 ["setScope"]
  CALL R1 2 0
  LOADB R1 1
  SETTABLEKS R1 R0 K0 ["_showSearchOptions"]
  LOADB R1 1
  SETTABLEKS R1 R0 K5 ["_isDefaultSearchState"]
  GETTABLEKS R1 R0 K6 ["OnIsDefaultSearchStateChanged"]
  GETTABLEKS R3 R0 K5 ["_isDefaultSearchState"]
  NAMECALL R1 R1 K7 ["Fire"]
  CALL R1 2 0
  GETTABLEKS R1 R0 K8 ["OnShowSearchOptionsChanged"]
  LOADB R3 1
  NAMECALL R1 R1 K7 ["Fire"]
  CALL R1 2 0
  GETUPVAL R2 1
  GETTABLEKS R1 R2 K9 ["createSearchSessionId"]
  CALL R1 0 1
  SETTABLEKS R1 R0 K10 ["_searchSessionId"]
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R10 R11 K18 ["getFFlagAmrUpdatedItemsCache"]
  CALL R9 1 1
