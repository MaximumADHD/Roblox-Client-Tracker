...
PROTO_4:
  ...
  CALL R6 1 1
  JUMP [+3]
  NAMECALL R6 R1 K25 ["getSelection"]
  CALL R6 1 1
  ...
  CAPTURE VAL R4
  CAPTURE UPVAL U5
  SETTABLEKS R5 R4 K29 ["_updateSourceList"]
  GETTABLEKS R6 R4 K10 ["_connections"]
  GETTABLEKS R8 R4 K3 ["_explorerController"]
  GETTABLEKS R7 R8 K30 ["OnExplorerItemsChanged"]
  NEWCLOSURE R9 P1
  CAPTURE VAL R4
  NAMECALL R7 R7 K31 ["Connect"]
  CALL R7 2 -1
  FASTCALL TABLE_INSERT [+2]
  GETIMPORT R5 K34 [table.insert]
  CALL R5 -1 0
  GETUPVAL R5 1
  CALL R5 0 1
  JUMPIFNOT R5 [+16]
  ...
  GETTABLEKS R7 R8 K35 ["OnCurrentScopeChanged"]
  NEWCLOSURE R9 P2
  CAPTURE VAL R4
  NAMECALL R7 R7 K31 ["Connect"]
  CALL R7 2 -1
  ...
  GETTABLEKS R6 R4 K10 ["_connections"]
  GETTABLEKS R8 R4 K2 ["_pluginController"]
  GETTABLEKS R7 R8 K36 ["OnSelectionChanged"]
  NEWCLOSURE R9 P3
  CAPTURE VAL R4
  NAMECALL R7 R7 K31 ["Connect"]
  CALL R7 2 -1
...
PROTO_19:
  ...
  GETTABLEKS R2 R3 K8 ["Model"]
  SETTABLEKS R2 R1 K5 ["AssetType"]
  GETTABLEKS R2 R0 K12 ["_explorerController"]
  NAMECALL R2 R2 K13 ["getSelection"]
  CALL R2 1 1
  SETTABLEKS R2 R1 K6 ["ScopeInfo"]
  SETTABLEKS R1 R0 K11 ["_searchOptions"]
  JUMP [+25]
  ...
  NAMECALL R2 R2 K13 ["getSelection"]
  CALL R2 1 1
  GETTABLEKS R1 R2 K14 ["Id"]
  DUPTABLE R2 K7 [{"AssetType", "ScopeInfo"}]
  GETUPVAL R5 1
  GETTABLEKS R4 R5 K5 ["AssetType"]
  GETTABLEKS R3 R4 K8 ["Model"]
  SETTABLEKS R3 R2 K5 ["AssetType"]
  GETTABLEKS R3 R0 K12 ["_explorerController"]
  MOVE R5 R1
  NAMECALL R3 R3 K15 ["getScopeById"]
  CALL R3 2 1
  SETTABLEKS R3 R2 K6 ["ScopeInfo"]
  SETTABLEKS R2 R0 K11 ["_searchOptions"]
  GETTABLEKS R1 R0 K16 ["OnSearchOptionsChanged"]
  GETIMPORT R3 K19 [table.clone]
  GETTABLEKS R4 R0 K11 ["_searchOptions"]
  CALL R3 1 -1
  NAMECALL R1 R1 K2 ["Fire"]
  CALL R1 -1 0
  GETTABLEKS R1 R0 K20 ["OnSearchClosed"]
  NAMECALL R1 R1 K2 ["Fire"]
  CALL R1 1 0
  LOADK R1 K3 [""]
  SETTABLEKS R1 R0 K21 ["_searchSessionId"]
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R10 R11 K18 ["getFFlagAmrPluginCurrentScope"]
  CALL R9 1 1
  GETIMPORT R10 K5 [require]
  GETTABLEKS R13 R0 K13 ["Src"]
  GETTABLEKS R12 R13 K17 ["Flags"]
  GETTABLEKS R11 R12 K19 ["getFFlagAmrGroupsRefactor"]
  CALL R10 1 1
  LOADK R13 K20 ["SearchController"]
  NAMECALL R11 R4 K21 ["extend"]
  CALL R11 2 1
  ...
  CAPTURE VAL R11
  SETTABLEKS R12 R11 K25 ["mock"]
  DUPCLOSURE R12 K26 [PROTO_6]
  CAPTURE VAL R6
  SETTABLEKS R12 R11 K27 ["destroy"]
  DUPCLOSURE R12 K28 [PROTO_7]
  SETTABLEKS R12 R11 K29 ["getSearchTerm"]
  DUPCLOSURE R12 K30 [PROTO_8]
  SETTABLEKS R12 R11 K31 ["setSearchTerm"]
  DUPCLOSURE R12 K32 [PROTO_9]
  SETTABLEKS R12 R11 K33 ["getSourceList"]
  DUPCLOSURE R12 K34 [PROTO_10]
  CAPTURE VAL R7
  SETTABLEKS R12 R11 K35 ["requestSearch"]
  DUPCLOSURE R12 K36 [PROTO_11]
  SETTABLEKS R12 R11 K37 ["getSearchOptions"]
  DUPCLOSURE R12 K38 [PROTO_12]
  SETTABLEKS R12 R11 K39 ["setSearchOptions"]
  DUPCLOSURE R12 K40 [PROTO_13]
  SETTABLEKS R12 R11 K41 ["setScope"]
  DUPCLOSURE R12 K42 [PROTO_14]
  CAPTURE VAL R10
  SETTABLEKS R12 R11 K43 ["setScope_DEPRECATED"]
  DUPCLOSURE R12 K44 [PROTO_15]
  SETTABLEKS R12 R11 K45 ["setAssetTypeFilter"]
  DUPCLOSURE R12 K46 [PROTO_16]
  SETTABLEKS R12 R11 K47 ["getIsDefaultSearchState"]
  DUPCLOSURE R12 K48 [PROTO_17]
  SETTABLEKS R12 R11 K49 ["getShowSearchOptions"]
  DUPCLOSURE R12 K50 [PROTO_18]
  CAPTURE VAL R7
  SETTABLEKS R12 R11 K51 ["showSearchOptions"]
  DUPCLOSURE R12 K52 [PROTO_19]
  CAPTURE VAL R9
  CAPTURE VAL R8
  CAPTURE VAL R10
  SETTABLEKS R12 R11 K53 ["hideSearchOptions"]
  DUPCLOSURE R12 K54 [PROTO_20]
  SETTABLEKS R12 R11 K55 ["getSearchId"]
  RETURN R11 1
