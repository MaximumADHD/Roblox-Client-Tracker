...
PROTO_2:
  ...
  GETTABLE R8 R1 R6
  GETUPVAL R11 0
  GETTABLEKS R10 R11 K0 ["AssetType"]
  GETTABLEKS R9 R10 K1 ["Place"]
  JUMPIFNOTEQ R8 R9 [+42]
  LOADB R9 1
  GETTABLEKS R10 R2 K2 ["Type"]
  GETUPVAL R13 0
  GETTABLEKS R12 R13 K3 ["ScopeType"]
  GETTABLEKS R11 R12 K4 ["ProjectPlaces"]
  JUMPIFEQ R10 R11 [+12]
  GETTABLEKS R10 R2 K2 ["Type"]
  GETUPVAL R13 0
  GETTABLEKS R12 R13 K3 ["ScopeType"]
  GETTABLEKS R11 R12 K5 ["Universe"]
  JUMPIFEQ R10 R11 [+2]
  LOADB R9 0 +1
  LOADB R9 1
  FASTCALL2K ASSERT R9 K6 [+4]
  LOADK R10 K6 ["Not browsing universe for this place"]
  GETIMPORT R8 K8 [assert]
  CALL R8 2 0
  GETUPVAL R8 1
  GETTABLEKS R11 R2 K9 ["Id"]
  LOADK R12 K10 ["https://create.roblox.com/dashboard/creations/experiences/%*/places/%*/configure"]
  MOVE R14 R11
  MOVE R15 R7
  NAMECALL R12 R12 K11 ["format"]
  CALL R12 3 1
  MOVE R10 R12
  NAMECALL R8 R8 K12 ["openLink"]
  CALL R8 2 0
  JUMP [+7]
  GETUPVAL R8 2
  GETUPVAL R10 3
  MOVE R11 R7
  CALL R10 1 -1
  NAMECALL R8 R8 K13 ["OpenBrowserWindow"]
  CALL R8 -1 0
  FORGLOOP R3 2 [-57]
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R7 R8 K15 ["getFFlagAmrUpdatedItemsCache"]
  CALL R6 1 1
