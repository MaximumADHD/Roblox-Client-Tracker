...
PROTO_3:
       ...
       43 DUPTABLE                         R4 K12 [{"ExplorerController", "LayoutController", "ItemsController"}]
       44 GETUPVAL                         R5 8
       ...
       56 JUMPIF                           R2 ; [+43]
       57 GETUPVAL                         R2 10
       58 NAMECALL                         R2 R2 K13 ["getScopeAnalyticsContext"]
       60 CALL                             R2 1 1
       61 GETUPVAL                         R3 12
       62 GETTABLEKS                       R3 R3 K2 ["sendShareEvent"]
       64 DUPTABLE                         R4 K18 [{"shareType", "currentRootId", "currentRootType", "currentFolderId", "assetIds", "viewMode"}]
       65 GETUPVAL                         R5 12
       66 GETTABLEKS                       R5 R5 K19 ["Enums"]
       68 GETTABLEKS                       R5 R5 K7 ["ShareType"]
       70 GETTABLEKS                       R5 R5 K8 ["OpenUse"]
       72 SETTABLEKS                       R5 R4 K3 ["shareType"]
       74 GETTABLEKS                       R5 R2 K14 ["currentRootId"]
       76 SETTABLEKS                       R5 R4 K14 ["currentRootId"]
       78 GETTABLEKS                       R5 R2 K15 ["currentRootType"]
       80 SETTABLEKS                       R5 R4 K15 ["currentRootType"]
       82 GETTABLEKS                       R5 R2 K16 ["currentFolderId"]
       84 SETTABLEKS                       R5 R4 K16 ["currentFolderId"]
       86 GETUPVAL                         R5 6
       87 SETTABLEKS                       R5 R4 K4 ["assetIds"]
       89 GETUPVAL                         R5 13
       90 GETUPVAL                         R6 9
       91 NAMECALL                         R6 R6 K20 ["getBrowserLayout"]
       93 CALL                             R6 1 1
       94 GETTABLEKS                       R6 R6 K21 ["ViewType"]
       96 CALL                             R5 1 1
       97 SETTABLEKS                       R5 R4 K17 ["viewMode"]
       99 CALL                             R3 1 0
      100 RETURN                           R0 0
...
PROTO_6:
       ...
       40 CAPTURE                          UPVAL U6
       41 CAPTURE                          UPVAL U7
       42 DUPTABLE                         R12 K9 [{"Title", "Size", "Type"}]
       43 LOADK                            R15 K10 ["ContextMenu"]
       44 LOADK                            R16 K11 ["OpenUse"]
       45 NAMECALL                         R13 R3 K12 ["getText"]
       47 CALL                             R13 3 1
       48 SETTABLEKS                       R13 R12 K6 ["Title"]
       50 GETUPVAL                         R13 8
       51 GETTABLEKS                       R13 R13 K13 ["ConfirmDialogSize"]
       53 SETTABLEKS                       R13 R12 K7 ["Size"]
       55 GETUPVAL                         R13 0
       56 GETTABLEKS                       R13 R13 K14 ["DialogType"]
       58 GETTABLEKS                       R13 R13 K15 ["Confirm"]
       60 SETTABLEKS                       R13 R12 K8 ["Type"]
       62 DUPTABLE                         R13 K20 [{"Text", "LinkText", "LinkUrl", "ConfirmCallback"}]
       63 LOADK                            R16 K11 ["OpenUse"]
       64 LOADK                            R17 K21 ["ConfirmText"]
       65 NAMECALL                         R14 R3 K12 ["getText"]
       67 CALL                             R14 3 1
       68 SETTABLEKS                       R14 R13 K16 ["Text"]
       70 LOADK                            R16 K11 ["OpenUse"]
       71 LOADK                            R17 K22 ["LearnMore"]
       72 NAMECALL                         R14 R3 K12 ["getText"]
       74 CALL                             R14 3 1
       75 SETTABLEKS                       R14 R13 K17 ["LinkText"]
       77 GETUPVAL                         R14 9
       78 CALL                             R14 0 1
       79 SETTABLEKS                       R14 R13 K18 ["LinkUrl"]
       ...
       85 CAPTURE                          VAL R10
       86 CAPTURE                          VAL R11
       87 SETTABLEKS                       R14 R13 K19 ["ConfirmCallback"]
       89 MOVE                             R16 R12
       90 MOVE                             R17 R13
       91 NAMECALL                         R14 R1 K23 ["setDialog"]
       93 CALL                             R14 3 0
       94 RETURN                           R0 0
