...
MAIN:
  ...
  GETTABLEKS R9 R0 K32 ["Src"]
  GETTABLEKS R8 R9 K33 ["Resources"]
  GETTABLEKS R7 R8 K34 ["Localization"]
  GETTABLEKS R6 R7 K35 ["SourceStrings"]
  GETTABLEKS R10 R0 K32 ["Src"]
  GETTABLEKS R9 R10 K33 ["Resources"]
  GETTABLEKS R8 R9 K34 ["Localization"]
  GETTABLEKS R7 R8 K36 ["LocalizedStrings"]
  DUPTABLE R8 K42 [{"plugin", "pluginName", "getToolbarName", "translationResourceTable", "fallbackResourceTable", "buttonInfo"}]
  ...
  CAPTURE VAL R4
  SETTABLEKS R9 R8 K38 ["getToolbarName"]
  SETTABLEKS R7 R8 K39 ["translationResourceTable"]
  SETTABLEKS R6 R8 K40 ["fallbackResourceTable"]
  SETTABLEKS R5 R8 K41 ["buttonInfo"]
  DUPTABLE R9 K48 [{"id", "dockWidgetPluginGuiInfo", "getDockTitle", "zIndexBehavior"}]
  LOADK R10 K2 ["AssetManager"]
  SETTABLEKS R10 R9 K44 ["id"]
  ...
  LOADN R17 200
  CALL R10 7 1
  SETTABLEKS R10 R9 K45 ["dockWidgetPluginGuiInfo"]
  DUPCLOSURE R10 K56 [PROTO_3]
  SETTABLEKS R10 R9 K46 ["getDockTitle"]
  GETIMPORT R10 K59 [Enum.ZIndexBehavior.Sibling]
  SETTABLEKS R10 R9 K47 ["zIndexBehavior"]
  SETTABLEKS R9 R8 K60 ["dockWidgetInfo"]
  GETTABLEKS R9 R3 K61 ["build"]
  MOVE R10 R8
  CALL R9 1 1
  ...
  GETTABLEKS R13 R14 K64 ["Asset"]
  GETTABLEKS R12 R13 K65 ["setupAssetsDm"]
  CALL R11 1 1
  MOVE R12 R11
