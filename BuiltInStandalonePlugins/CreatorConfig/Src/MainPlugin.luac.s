...
MAIN:
  ...
  CALL R17 1 1
  GETTABLEKS R18 R17 K34 ["getFFlagRegisterActionsPluginLoader"]
  CALL R18 0 1
  GETTABLEKS R19 R17 K35 ["getFFlagEnableCreatorConfigSystemMenu"]
  CALL R19 0 1
  GETTABLEKS R20 R17 K36 ["getFFlagOnCloseSkipActionTrigger"]
  CALL R20 0 1
  GETTABLEKS R21 R17 K37 ["getFFlagCreatorConfigDmChangedListener"]
  CALL R21 0 1
  OR R22 R18 R19
  ...
  CAPTURE VAL R21
  CAPTURE REF R26
  SETTABLEKS R27 R23 K45 ["init"]
  DUPCLOSURE R27 K46 [PROTO_16]
  CAPTURE VAL R22
  SETTABLEKS R27 R23 K47 ["didUpdate"]
  DUPCLOSURE R27 K48 [PROTO_17]
  CAPTURE VAL R6
  CAPTURE VAL R7
  CAPTURE VAL R8
  CAPTURE VAL R10
  ...
  CAPTURE VAL R4
  CAPTURE VAL R16
  SETTABLEKS R27 R23 K49 ["render"]
  DUPCLOSURE R27 K50 [PROTO_18]
  SETTABLEKS R27 R23 K51 ["willUnmount"]
  CLOSEUPVALS R26
  RETURN R23 1
