...
PROTO_14:
  ...
  GETUPVAL R2 1
  GETUPVAL R4 0
  GETTABLEKS R3 R4 K7 ["onWidgetEnabledChanged"]
  DUPTABLE R4 K9 [{"Enabled"}]
  SETTABLEKS R2 R4 K8 ["Enabled"]
  CALL R3 1 0
  RETURN R0 0
...
PROTO_15:
  ...
  JUMPIFNOT R5 [+9]
  GETTABLEKS R5 R1 K10 ["Plugin"]
  LOADK R7 K40 ["DmChanged"]
  NEWCLOSURE R8 P8
  CAPTURE VAL R0
  CAPTURE UPVAL U11
  NAMECALL R5 R5 K41 ["OnInvoke"]
  CALL R5 3 0
  RETURN R0 0
...
MAIN:
  ...
  CALL R21 0 1
  GETTABLEKS R22 R17 K38 ["getFFlagCreatorConfigDmChangedListener"]
  CALL R22 0 1
  JUMPIFNOT R19 [+2]
  MOVE R23 R18
  JUMPIF R23 [+1]
  ...
  CALL R26 1 1
  GETTABLEKS R25 R26 K43 ["WebViewManagerContext"]
  GETTABLEKS R26 R11 K44 ["fromAction"]
  ...
  DUPCLOSURE R28 K47 [PROTO_16]
  CAPTURE VAL R23
  SETTABLEKS R28 R24 K48 ["didUpdate"]
  ...
  DUPCLOSURE R28 K51 [PROTO_18]
  SETTABLEKS R28 R24 K52 ["willUnmount"]
  CLOSEUPVALS R27
  RETURN R24 1
