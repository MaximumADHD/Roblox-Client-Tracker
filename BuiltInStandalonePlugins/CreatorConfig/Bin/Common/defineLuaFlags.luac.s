...
MAIN:
  ...
  CALL R0 1 1
  DUPTABLE R1 K11 [{"getFFlagEnableCreatorConfig", "getFFlagEnableRibbonPlugin", "getFFlagRegisterActionsPluginLoader", "getFFlagEnableCreatorConfigSystemMenu", "getFFlagOnCloseSkipActionTrigger"}]
  MOVE R2 R0
  LOADK R3 K12 ["EnableCreatorConfig"]
  CALL R2 1 1
  ...
  MOVE R2 R0
  LOADK R3 K15 ["EnableCreatorConfigSystemMenu"]
  CALL R2 1 1
  SETTABLEKS R2 R1 K9 ["getFFlagEnableCreatorConfigSystemMenu"]
  MOVE R2 R0
  LOADK R3 K16 ["CreatorConfigOnCloseSkipActionTrigger"]
  CALL R2 1 1
  SETTABLEKS R2 R1 K10 ["getFFlagOnCloseSkipActionTrigger"]
  RETURN R1 1
