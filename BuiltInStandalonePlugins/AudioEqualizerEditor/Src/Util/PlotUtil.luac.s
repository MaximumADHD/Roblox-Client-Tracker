...
PROTO_6:
  ...
  LOADN R8 1
  GETUPVAL R13 0
  GETTABLEKS R12 R13 K5 ["getYMin"]
  CALL R12 0 1
  SUB R11 R6 R12
  GETUPVAL R14 0
  GETTABLEKS R13 R14 K6 ["getYMax"]
  CALL R13 0 1
  GETUPVAL R15 0
  GETTABLEKS R14 R15 K5 ["getYMin"]
  CALL R14 0 1
  SUB R12 R13 R14
  DIV R10 R11 R12
  GETUPVAL R11 1
...
PROTO_7:
  ...
  POW R8 R5 R9
  GETUPVAL R11 0
  GETTABLEKS R10 R11 K8 ["getYMax"]
  CALL R10 0 1
  GETUPVAL R12 0
  GETTABLEKS R11 R12 K9 ["getYMin"]
  CALL R11 0 1
  SUB R9 R10 R11
  MUL R7 R8 R9
  GETUPVAL R9 0
  GETTABLEKS R8 R9 K9 ["getYMin"]
  CALL R8 0 1
  ADD R6 R7 R8
