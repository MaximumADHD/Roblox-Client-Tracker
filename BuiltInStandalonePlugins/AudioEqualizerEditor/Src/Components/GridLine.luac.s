PROTO_0:
  ...
  JUMPIFNOTEQKS R2 K4 ["Vertical"] [+22]
  GETIMPORT R2 K2 [Vector2.new]
  GETUPVAL R4 0
  GETTABLEKS R3 R4 K5 ["Position"]
  GETUPVAL R5 1
  GETTABLEKS R4 R5 K6 ["Y_MIN"]
  CALL R2 2 1
  MOVE R0 R2
  GETIMPORT R2 K2 [Vector2.new]
  GETUPVAL R4 0
  GETTABLEKS R3 R4 K5 ["Position"]
  GETUPVAL R5 1
  GETTABLEKS R4 R5 K7 ["Y_MAX"]
  CALL R2 2 1
  MOVE R1 R2
  JUMP [+25]
  GETUPVAL R3 0
  GETTABLEKS R2 R3 K3 ["Orientation"]
  JUMPIFNOTEQKS R2 K8 ["Horizontal"] [+21]
  GETIMPORT R2 K2 [Vector2.new]
  GETUPVAL R4 1
  GETTABLEKS R3 R4 K9 ["X_MIN"]
  GETUPVAL R5 0
