...
PROTO_2:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["mouseToPlot"]
        3 MOVE                             R2 R0
        4 GETUPVAL                         R3 1
        5 GETTABLEKS                       R3 R3 K1 ["PlotRef"]
        7 GETTABLEKS                       R3 R3 K2 ["current"]
        9 CALL                             R1 2 1
       10 MOVE                             R0 R1
       11 GETUPVAL                         R1 1
       12 GETTABLEKS                       R1 R1 K3 ["FilterHook"]
       14 GETTABLEKS                       R1 R1 K4 ["setFrequency"]
       16 GETTABLEKS                       R2 R0 K5 ["X"]
       18 CALL                             R1 1 0
       19 GETUPVAL                         R1 2
       20 JUMPIFNOT                        R1 ; [+8]
       21 GETUPVAL                         R1 1
       22 GETTABLEKS                       R1 R1 K3 ["FilterHook"]
       24 GETTABLEKS                       R1 R1 K6 ["setGain"]
...
PROTO_3:
        ...
        3 GETTABLEKS                       R1 R1 K1 ["setFilterType"]
        5 MOVE                             R2 R0
        6 CALL                             R1 1 0
        7 RETURN                           R0 0
...
PROTO_4:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["getContextMenuItems"]
        3 GETUPVAL                         R1 1
        4 GETUPVAL                         R2 2
        5 CALL                             R0 2 1
        6 GETUPVAL                         R1 3
...
PROTO_5:
        ...
        1 JUMPIFNOT                        R1 ; [+25]
        2 GETUPVAL                         R1 1
        3 GETTABLEKS                       R1 R1 K0 ["log2"]
        5 GETUPVAL                         R2 2
        6 GETTABLEKS                       R2 R2 K1 ["FilterHook"]
        8 GETTABLEKS                       R2 R2 K2 ["q"]
       10 CALL                             R1 1 1
       ...
       19 CALL                             R2 2 1
       20 GETUPVAL                         R3 2
       21 GETTABLEKS                       R3 R3 K1 ["FilterHook"]
       23 GETTABLEKS                       R3 R3 K7 ["setQ"]
       25 MOVE                             R4 R2
       26 CALL                             R3 1 0
       27 RETURN                           R0 0
...
PROTO_6:
       ...
       13 GETTABLEKS                       R4 R0 K4 ["FilterHook"]
       15 GETTABLEKS                       R4 R4 K5 ["bypass"]
       17 NOT                              R3 R4
       18 GETUPVAL                         R4 2
       19 LOADK                            R5 K6 [""]
       20 CALL                             R4 1 2
       21 GETUPVAL                         R6 3
       22 GETTABLEKS                       R6 R6 K7 ["hasGain"]
       24 GETTABLEKS                       R7 R0 K4 ["FilterHook"]
       26 GETTABLEKS                       R7 R7 K8 ["filterType"]
       28 CALL                             R6 1 1
       29 GETUPVAL                         R7 3
       30 GETTABLEKS                       R7 R7 K9 ["hasQ"]
       32 GETTABLEKS                       R8 R0 K4 ["FilterHook"]
       34 GETTABLEKS                       R8 R8 K8 ["filterType"]
       36 CALL                             R7 1 1
       37 GETUPVAL                         R8 4
       38 NEWCLOSURE                       R9 P0
       39 CAPTURE                          VAL R5
       ...
       58 GETTABLEKS                       R14 R0 K4 ["FilterHook"]
       60 GETTABLEKS                       R14 R14 K8 ["filterType"]
       62 GETTABLEKS                       R15 R0 K4 ["FilterHook"]
       64 GETTABLEKS                       R15 R15 K11 ["setGain"]
       66 GETTABLEKS                       R16 R0 K4 ["FilterHook"]
       68 GETTABLEKS                       R16 R16 K12 ["setFrequency"]
       ...
       75 CAPTURE                          VAL R0
       76 NEWTABLE                         R13 0 1
       78 GETTABLEKS                       R14 R0 K4 ["FilterHook"]
       80 GETTABLEKS                       R14 R14 K13 ["setFilterType"]
      ...
      102 GETTABLEKS                       R16 R0 K4 ["FilterHook"]
      104 GETTABLEKS                       R16 R16 K8 ["filterType"]
      106 GETTABLEKS                       R17 R0 K4 ["FilterHook"]
      108 GETTABLEKS                       R17 R17 K14 ["q"]
      110 GETTABLEKS                       R18 R0 K4 ["FilterHook"]
      112 GETTABLEKS                       R18 R18 K15 ["setQ"]
...
MAIN:
       ...
       33 GETTABLEKS                       R8 R6 K14 ["UI"]
       35 GETTABLEKS                       R8 R8 K15 ["Pane"]
       37 GETTABLEKS                       R9 R6 K14 ["UI"]
       39 GETTABLEKS                       R9 R9 K16 ["showContextMenu"]
       41 GETIMPORT                        R10 K6 [require]
       43 GETTABLEKS                       R11 R1 K17 ["Src"]
       45 GETTABLEKS                       R11 R11 K18 ["Types"]
       47 CALL                             R10 1 1
       48 GETIMPORT                        R11 K6 [require]
       50 GETTABLEKS                       R12 R0 K19 ["ControlPoint"]
       52 CALL                             R11 1 1
       53 GETIMPORT                        R12 K6 [require]
       55 GETTABLEKS                       R13 R1 K17 ["Src"]
       57 GETTABLEKS                       R13 R13 K20 ["Util"]
       59 GETTABLEKS                       R13 R13 K21 ["FilterTypeUtil"]
       61 CALL                             R12 1 1
       62 GETIMPORT                        R13 K6 [require]
       64 GETTABLEKS                       R14 R1 K17 ["Src"]
       66 GETTABLEKS                       R14 R14 K20 ["Util"]
       68 GETTABLEKS                       R14 R14 K22 ["PlotUtil"]
       70 CALL                             R13 1 1
