PROTO_0:
  ...
  GETUPVAL R0 2
  GETUPVAL R2 3
  GETTABLEKS R1 R2 K14 ["FILTER"]
  JUMPIFNOTEQ R0 R1 [+24]
  GETUPVAL R0 4
  DUPTABLE R1 K19 [{"InstanceType", "FilterType", "Frequency", "Gain", "Q", "Bypass"}]
  GETUPVAL R3 3
  GETTABLEKS R2 R3 K14 ["FILTER"]
  SETTABLEKS R2 R1 K1 ["InstanceType"]
  GETUPVAL R2 12
  SETTABLEKS R2 R1 K15 ["FilterType"]
  GETUPVAL R2 13
  SETTABLEKS R2 R1 K16 ["Frequency"]
  GETUPVAL R2 14
  SETTABLEKS R2 R1 K17 ["Gain"]
  GETUPVAL R2 15
  SETTABLEKS R2 R1 K18 ["Q"]
  GETUPVAL R2 16
  SETTABLEKS R2 R1 K6 ["Bypass"]
  CALL R0 1 0
  RETURN R0 0
...
MAIN:
  ...
  CALL R1 1 1
  GETTABLEKS R2 R1 K9 ["getFFlagAudioEqualizerEditorSanitizeMidRange"]
  CALL R2 0 1
  ...
  GETTABLEKS R9 R10 K18 ["PlotUtil"]
  CALL R8 1 1
