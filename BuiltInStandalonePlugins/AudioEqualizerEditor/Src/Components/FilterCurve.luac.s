...
PROTO_1:
       ...
       22 CALL                             R0 2 0
       23 GETUPVAL                         R0 0
       24 GETTABLEKS                       R0 R0 K0 ["current"]
       26 GETUPVAL                         R1 1
       27 GETTABLEKS                       R1 R1 K5 ["FilterHook"]
       29 GETTABLEKS                       R1 R1 K6 ["filterType"]
       31 SETTABLEKS                       R1 R0 K7 ["FilterType"]
       33 GETUPVAL                         R1 1
       34 GETTABLEKS                       R1 R1 K5 ["FilterHook"]
       36 GETTABLEKS                       R1 R1 K8 ["frequency"]
       38 SETTABLEKS                       R1 R0 K9 ["Frequency"]
       40 GETUPVAL                         R1 1
       41 GETTABLEKS                       R1 R1 K5 ["FilterHook"]
       43 GETTABLEKS                       R1 R1 K10 ["gain"]
       45 SETTABLEKS                       R1 R0 K11 ["Gain"]
       47 GETUPVAL                         R1 1
       48 GETTABLEKS                       R1 R1 K5 ["FilterHook"]
       50 GETTABLEKS                       R1 R1 K12 ["q"]
       52 SETTABLEKS                       R1 R0 K13 ["Q"]
       54 NEWTABLE                         R1 0 0
       56 NEWTABLE                         R2 0 0
       58 GETUPVAL                         R3 1
       59 GETTABLEKS                       R3 R3 K5 ["FilterHook"]
       61 GETTABLEKS                       R3 R3 K8 ["frequency"]
       63 LOADN                            R4 1
       64 GETUPVAL                         R5 2
       65 GETTABLEKS                       R5 R5 K14 ["getXMin"]
       67 CALL                             R5 0 1
       ...
       81 MOVE                             R10 R6
       82 GETUPVAL                         R11 1
       83 GETTABLEKS                       R11 R11 K19 ["PlotAbsoluteSize"]
       85 CALL                             R9 2 -1
       ...
       92 MUL                              R3 R3 R4
       93 GETUPVAL                         R8 2
       94 GETTABLEKS                       R8 R8 K14 ["getXMin"]
       96 CALL                             R8 0 1
       97 JUMPIFNOTLT                      R8 R7 ; [+12]
       99 GETUPVAL                         R8 2
      100 GETTABLEKS                       R8 R8 K14 ["getXMin"]
      102 CALL                             R8 0 1
      103 JUMPIFNOTLT                      R3 R8 ; [+6]
      105 GETUPVAL                         R8 2
      106 GETTABLEKS                       R8 R8 K14 ["getXMin"]
      108 CALL                             R8 0 1
      109 MOVE                             R3 R8
      110 JUMPBACK                         ; [-47]
      111 GETUPVAL                         R5 1
      112 GETTABLEKS                       R5 R5 K5 ["FilterHook"]
      114 GETTABLEKS                       R3 R5 K8 ["frequency"]
      116 LOADN                            R4 1
      117 GETUPVAL                         R5 2
      118 GETTABLEKS                       R5 R5 K24 ["getXMax"]
      120 CALL                             R5 0 1
      ...
      134 MOVE                             R10 R6
      135 GETUPVAL                         R11 1
      136 GETTABLEKS                       R11 R11 K19 ["PlotAbsoluteSize"]
      138 CALL                             R9 2 -1
      ...
      145 MUL                              R3 R3 R4
      146 GETUPVAL                         R8 2
      147 GETTABLEKS                       R8 R8 K24 ["getXMax"]
      149 CALL                             R8 0 1
      150 JUMPIFNOTLT                      R7 R8 ; [+12]
      152 GETUPVAL                         R8 2
      153 GETTABLEKS                       R8 R8 K24 ["getXMax"]
      155 CALL                             R8 0 1
      156 JUMPIFNOTLT                      R8 R3 ; [+6]
      158 GETUPVAL                         R8 2
      159 GETTABLEKS                       R8 R8 K24 ["getXMax"]
      161 CALL                             R8 0 1
      162 MOVE                             R3 R8
      163 JUMPBACK                         ; [-47]
      164 GETUPVAL                         R5 4
...
PROTO_2:
        ...
        1 LOADNIL                          R2
        2 CALL                             R1 1 1
        3 GETTABLEKS                       R3 R0 K0 ["FilterHook"]
        5 GETTABLEKS                       R3 R3 K1 ["bypass"]
        7 NOT                              R2 R3
        8 GETUPVAL                         R3 1
...
MAIN:
       ...
       53 GETTABLEKS                       R11 R11 K19 ["Path2DUtil"]
       55 CALL                             R10 1 1
