PROTO_0:
  ...
  GETTABLEN R1 R0 1
  GETUPVAL R3 2
  GETTABLEKS R2 R3 K4 ["getDistanceAttenuation"]
  MOVE R3 R1
  CALL R2 1 1
  LOADK R4 K5 ["%* \"%*\""]
  GETTABLEKS R6 R1 K6 ["ClassName"]
  ...
  LOADK R6 K12 ["OnOpen"]
  GETUPVAL R8 3
  GETTABLEKS R7 R8 K13 ["stringifyCurveTable"]
  MOVE R8 R2
  CALL R7 1 1
  GETUPVAL R8 4
  MOVE R9 R3
  NAMECALL R4 R4 K14 ["Invoke"]
  CALL R4 5 0
  GETUPVAL R4 4
  ADDK R4 R4 K15 [1]
  SETUPVAL R4 4
...
MAIN:
  ...
  RETURN R0 0
  GETIMPORT R3 K17 [game]
  LOADK R5 K20 ["EnableAudioListenerDistanceAttenuationLua"]
  NAMECALL R3 R3 K19 ["GetFastFlag"]
  CALL R3 2 1
  GETIMPORT R4 K9 [require]
  GETTABLEKS R7 R0 K6 ["Bin"]
  GETTABLEKS R6 R7 K7 ["Common"]
  GETTABLEKS R5 R6 K21 ["pluginType"]
  CALL R4 1 1
  GETIMPORT R5 K9 [require]
  GETTABLEKS R7 R0 K14 ["Src"]
  GETTABLEKS R6 R7 K22 ["Types"]
  CALL R5 1 1
  GETIMPORT R6 K9 [require]
  GETTABLEKS R9 R0 K14 ["Src"]
  GETTABLEKS R8 R9 K23 ["Util"]
  GETTABLEKS R7 R8 K24 ["DistanceAttenuationUtil"]
  CALL R6 1 1
  GETIMPORT R7 K9 [require]
  GETTABLEKS R10 R0 K14 ["Src"]
  GETTABLEKS R9 R10 K23 ["Util"]
  GETTABLEKS R8 R9 K25 ["SerializationUtil"]
  CALL R7 1 1
  NEWTABLE R8 0 0
  LOADN R9 0
  NEWCLOSURE R10 P0
  ...
  LOADK R13 K26 ["OnEdit"]
  NEWCLOSURE R14 P1
  CAPTURE VAL R7
  CAPTURE REF R8
  CAPTURE VAL R3
  CAPTURE VAL R6
  NAMECALL R11 R11 K27 ["OnInvoke"]
  CALL R11 3 0
  GETIMPORT R11 K1 [plugin]
  LOADK R13 K28 ["OnStopEditing"]
  NEWCLOSURE R14 P2
  CAPTURE REF R8
  NAMECALL R11 R11 K27 ["OnInvoke"]
  CALL R11 3 0
  ...
  LOADK R14 K29 ["MoveAttenuationCurveEditorSignal"]
  NAMECALL R12 R12 K19 ["GetFastFlag"]
  CALL R12 2 1
  JUMPIFNOT R12 [+14]
  GETIMPORT R12 K17 [game]
  LOADK R14 K30 ["SoundService"]
  NAMECALL R12 R12 K31 ["GetService"]
  CALL R12 2 1
  GETTABLEKS R13 R12 K32 ["OpenAttenuationCurveEditorSignal"]
  MOVE R15 R10
  ...
  JUMP [+13]
  GETIMPORT R12 K17 [game]
  LOADK R14 K34 ["GuiService"]
  NAMECALL R12 R12 K31 ["GetService"]
  CALL R12 2 1
  GETTABLEKS R13 R12 K35 ["OpenAttenuationCurveEditor"]
  MOVE R15 R10
  NAMECALL R13 R13 K33 ["Connect"]
  CALL R13 2 1
  MOVE R11 R13
  GETTABLEKS R12 R4 K36 ["get"]
  CALL R12 0 1
  GETTABLEKS R13 R4 K37 ["asset"]
  JUMPIFEQ R12 R13 [+3]
  CLOSEUPVALS R8
  RETURN R0 0
