...
MAIN:
  ...
  LOADK R13 K28 ["MoveAttenuationCurveEditorSignal"]
  NAMECALL R11 R11 K19 ["GetFastFlag"]
  CALL R11 2 1
  JUMPIFNOT R11 [+14]
  GETIMPORT R11 K17 [game]
  LOADK R13 K29 ["SoundService"]
  NAMECALL R11 R11 K30 ["GetService"]
  CALL R11 2 1
  GETTABLEKS R12 R11 K31 ["OpenAttenuationCurveEditorSignal"]
  MOVE R14 R9
  NAMECALL R12 R12 K32 ["Connect"]
  CALL R12 2 1
  MOVE R10 R12
  JUMP [+13]
  GETIMPORT R11 K17 [game]
  LOADK R13 K33 ["GuiService"]
  NAMECALL R11 R11 K30 ["GetService"]
  CALL R11 2 1
  GETTABLEKS R12 R11 K34 ["OpenAttenuationCurveEditor"]
  MOVE R14 R9
  NAMECALL R12 R12 K32 ["Connect"]
  CALL R12 2 1
  MOVE R10 R12
  GETTABLEKS R11 R3 K35 ["get"]
  CALL R11 0 1
  GETTABLEKS R12 R3 K36 ["asset"]
  JUMPIFEQ R11 R12 [+3]
  CLOSEUPVALS R7
  RETURN R0 0
