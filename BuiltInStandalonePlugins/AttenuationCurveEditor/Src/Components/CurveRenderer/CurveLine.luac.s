PROTO_0:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["clampLineToRect"]
        3 GETUPVAL                         R1 1
        4 GETTABLEKS                       R1 R1 K1 ["StartPoint"]
        6 GETUPVAL                         R2 1
        7 GETTABLEKS                       R2 R2 K2 ["EndPoint"]
        9 GETUPVAL                         R3 1
       10 GETTABLEKS                       R3 R3 K3 ["PlotRect"]
       12 CALL                             R0 3 1
       13 JUMPIF                           R0 ; [+2]
       14 LOADNIL                          R1
       15 RETURN                           R1 1
       16 GETUPVAL                         R1 0
       17 GETTABLEKS                       R1 R1 K4 ["plotToAbsolutePosition"]
       19 GETTABLEN                        R2 R0 1
       20 GETUPVAL                         R3 1
       21 GETTABLEKS                       R3 R3 K3 ["PlotRect"]
       23 GETUPVAL                         R4 1
       24 GETTABLEKS                       R4 R4 K5 ["PlotAbsoluteSize"]
       26 CALL                             R1 3 1
       27 GETUPVAL                         R2 0
       28 GETTABLEKS                       R2 R2 K4 ["plotToAbsolutePosition"]
       30 GETTABLEN                        R3 R0 2
       31 GETUPVAL                         R4 1
       32 GETTABLEKS                       R4 R4 K3 ["PlotRect"]
       34 GETUPVAL                         R5 1
       35 GETTABLEKS                       R5 R5 K5 ["PlotAbsoluteSize"]
       37 CALL                             R2 3 1
       38 ADD                              R4 R1 R2
       39 DIVK                             R3 R4 K6 [2]
       40 SUB                              R4 R2 R1
       ...
       50 LOADN                            R6 4
       51 GETUPVAL                         R7 1
       52 GETTABLEKS                       R7 R7 K12 ["IsEndLine"]
       54 JUMPIFNOT                        R7 ; [+1]
       55 LOADN                            R6 2
...
MAIN:
       ...
       26 CALL                             R4 1 1
       27 GETTABLEKS                       R5 R4 K11 ["Styling"]
       29 GETTABLEKS                       R5 R5 K12 ["joinTags"]
