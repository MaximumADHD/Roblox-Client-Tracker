...
PROTO_2:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R2 R2 K0 ["tableToCurve"]
        3 MOVE                             R3 R0
        4 CALL                             R2 1 1
        5 GETTABLEKS                       R2 R2 K1 ["Keypoints"]
        7 GETUPVAL                         R3 0
        8 GETTABLEKS                       R3 R3 K0 ["tableToCurve"]
       10 MOVE                             R4 R1
       11 CALL                             R3 1 1
       12 GETTABLEKS                       R3 R3 K1 ["Keypoints"]
       14 LENGTH                           R4 R2
       15 LENGTH                           R5 R3
       16 JUMPIFEQ                         R4 R5 ; [+3]
       18 LOADB                            R6 0
       ...
       22 LOADN                            R7 1
       23 FORNPREP                         R6
       24 GETTABLE                         R10 R2 R8
       25 GETTABLE                         R11 R3 R8
       26 SUB                              R9 R10 R11
       27 GETTABLEKS                       R9 R9 K2 ["Magnitude"]
...
PROTO_9:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["tableToCurve"]
        3 GETUPVAL                         R2 0
        4 GETTABLEKS                       R2 R2 K1 ["destringifyCurveTable"]
        6 MOVE                             R3 R0
        7 CALL                             R2 1 -1
        8 CALL                             R1 -1 1
        9 GETTABLEKS                       R1 R1 K2 ["Keypoints"]
       11 RETURN                           R1 1
