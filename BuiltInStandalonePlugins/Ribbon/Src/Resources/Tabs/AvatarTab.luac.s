MAIN:
  ...
  SETLIST R5 R6 16 [1]
  DUPTABLE R6 K59 [{"Id", "Type", "Action", "FastFlag"}]
  LOADK R22 K60 ["R15Migrator"]
  SETTABLEKS R22 R6 K12 ["Id"]
  LOADK R22 K17 ["IconButton"]
  SETTABLEKS R22 R6 K13 ["Type"]
  MOVE R22 R3
  LOADK R23 K60 ["R15Migrator"]
  LOADK R24 K49 ["Toggle"]
  CALL R22 2 1
  SETTABLEKS R22 R6 K14 ["Action"]
  DUPTABLE R22 K62 [{"EnableIfAll"}]
  NEWTABLE R23 0 1
  LOADK R24 K63 ["DebugR15MigratorPlugin"]
  SETLIST R23 R24 1 [1]
  SETTABLEKS R23 R22 K61 ["EnableIfAll"]
  SETTABLEKS R22 R6 K58 ["FastFlag"]
  SETLIST R5 R6 1 [17]
  RETURN R5 1
