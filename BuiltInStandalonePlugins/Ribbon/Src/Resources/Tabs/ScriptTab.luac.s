MAIN:
  ...
  DUPTABLE R13 K51 [{"Id", "Type", "Action", "DEPRECATED_FastFlag", "FastFlag"}]
  LOADK R14 K52 ["CodeSnippets"]
  SETTABLEKS R14 R13 K12 ["Id"]
  LOADK R14 K17 ["IconButton"]
  SETTABLEKS R14 R13 K13 ["Type"]
  MOVE R14 R3
  LOADK R15 K52 ["CodeSnippets"]
  LOADK R16 K39 ["Toggle"]
  CALL R14 2 1
  SETTABLEKS R14 R13 K14 ["Action"]
  LOADK R14 K53 ["CodeSnippet_Alpha4"]
  SETTABLEKS R14 R13 K49 ["DEPRECATED_FastFlag"]
  LOADK R14 K53 ["CodeSnippet_Alpha4"]
  SETTABLEKS R14 R13 K50 ["FastFlag"]
  DUPTABLE R14 K51 [{"Id", "Type", "Action", "DEPRECATED_FastFlag", "FastFlag"}]
  LOADK R22 K54 ["ControlsEmulator"]
  SETTABLEKS R22 R14 K12 ["Id"]
  LOADK R22 K17 ["IconButton"]
  SETTABLEKS R22 R14 K13 ["Type"]
  MOVE R22 R3
  LOADK R23 K54 ["ControlsEmulator"]
  LOADK R24 K39 ["Toggle"]
  CALL R22 2 1
  SETTABLEKS R22 R14 K14 ["Action"]
  LOADK R22 K55 ["StudioDeviceEmulatorGamepadEmulation"]
  SETTABLEKS R22 R14 K49 ["DEPRECATED_FastFlag"]
  LOADK R22 K55 ["StudioDeviceEmulatorGamepadEmulation"]
  SETTABLEKS R22 R14 K50 ["FastFlag"]
  SETLIST R5 R6 9 [17]
  RETURN R5 1
