MAIN:
  ...
  CALL R17 3 1
  MOVE R18 R3
  LOADK R19 K111 [".Component-SplitButton > #StateLayer"]
  NEWTABLE R20 0 0
  NEWTABLE R21 0 1
  MOVE R22 R3
  LOADK R23 K110 ["> #RibbonTool"]
  NEWTABLE R24 0 0
  NEWTABLE R25 0 1
  MOVE R26 R3
  LOADK R27 K81 ["::UIPadding"]
  DUPTABLE R28 K112 [{"PaddingLeft"}]
  LOADK R29 K113 ["$SplitButtonPaddingLeftLarge"]
  SETTABLEKS R29 R28 K82 ["PaddingLeft"]
  CALL R26 2 -1
  SETLIST R25 R26 -1 [1]
  CALL R22 3 -1
  SETLIST R21 R22 -1 [1]
