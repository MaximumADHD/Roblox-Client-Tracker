...
PROTO_7:
  ...
  GETUPVAL R12 8
  LOADK R13 K15 ["Component-RibbonTab State-Editing X-Fit"]
  GETUPVAL R15 9
  CALL R15 0 1
  JUMPIFNOT R15 [+10]
  LOADK R15 K16 ["data-testid=%*"]
  GETUPVAL R17 10
  ...
  GETTABLEKS R11 R12 K19 ["FocusLost"]
  NEWCLOSURE R12 P1
  CAPTURE VAL R0
  SETTABLE R12 R10 R11
  GETUPVAL R13 7
  GETTABLEKS R12 R13 K20 ["Change"]
  GETTABLEKS R11 R12 K21 ["TextFits"]
  ...
  GETUPVAL R13 8
  LOADK R14 K25 ["Component-RibbonTab X-Fit"]
  JUMPIF R8 [+2]
  ...
  CALL R17 0 1
  JUMPIFNOT R17 [+10]
  LOADK R17 K16 ["data-testid=%*"]
  GETUPVAL R19 10
  GETTABLEKS R20 R0 K0 ["Uri"]
  CALL R19 1 1
  NAMECALL R17 R17 K17 ["format"]
  CALL R17 2 1
  MOVE R16 R17
  JUMP [+1]
  LOADNIL R16
  ...
  GETUPVAL R14 7
  GETTABLEKS R13 R14 K18 ["Event"]
  GETTABLEKS R12 R13 K31 ["InputBegan"]
  NEWCLOSURE R13 P4
  CAPTURE VAL R6
  CAPTURE VAL R2
  CAPTURE UPVAL U11
  ...
  GETUPVAL R14 7
  GETTABLEKS R13 R14 K18 ["Event"]
  GETTABLEKS R12 R13 K32 ["MouseEnter"]
  NEWCLOSURE R13 P5
  CAPTURE VAL R2
  CAPTURE VAL R3
  SETTABLE R13 R11 R12
...
MAIN:
  ...
  GETTABLEKS R12 R2 K23 ["useEffect"]
  GETIMPORT R13 K5 [require]
  GETTABLEKS R16 R0 K9 ["Src"]
  GETTABLEKS R15 R16 K12 ["Hooks"]
  GETTABLEKS R14 R15 K24 ["TooltipSettings"]
  CALL R13 1 1
  GETIMPORT R14 K5 [require]
  GETTABLEKS R17 R0 K9 ["Src"]
  GETTABLEKS R16 R17 K12 ["Hooks"]
  GETTABLEKS R15 R16 K25 ["useTooltip"]
  CALL R14 1 1
