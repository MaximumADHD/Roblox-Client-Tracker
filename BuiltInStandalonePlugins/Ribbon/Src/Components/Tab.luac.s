...
PROTO_3:
  ...
  GETUPVAL R7 4
  LOADK R8 K10 ["Component-RibbonTab X-CornerM X-Fit X-PadTab"]
  GETTABLEKS R10 R0 K11 ["Enabled"]
  JUMPIFNOTEQKB R10 FALSE [+3]
  LOADK R9 K12 ["State-Disabled"]
  JUMP [+6]
  GETTABLEKS R10 R0 K13 ["Selected"]
  JUMPIFNOT R10 [+2]
  LOADK R9 K14 ["State-Selected"]
  JUMP [+1]
  LOADK R9 K15 ["State-Default"]
  CALL R7 2 1
  SETTABLE R7 R5 R6
  CALL R3 2 -1
  CLOSEUPVALS R1
...
MAIN:
  ...
  GETTABLEKS R9 R10 K16 ["useWidgets"]
  CALL R8 1 1
