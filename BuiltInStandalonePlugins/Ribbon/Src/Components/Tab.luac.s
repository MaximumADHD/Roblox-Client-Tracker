...
PROTO_4:
  ...
  GETTABLEKS R8 R9 K15 ["FocusLost"]
  NEWCLOSURE R9 P1
  CAPTURE VAL R0
  SETTABLE R9 R7 R8
  GETUPVAL R10 6
  GETTABLEKS R9 R10 K16 ["Change"]
  GETTABLEKS R8 R9 K17 ["TextFits"]
  DUPCLOSURE R9 K18 [PROTO_2]
  SETTABLE R9 R7 R8
  CALL R5 2 -1
  RETURN R5 -1
  GETTABLEKS R6 R0 K19 ["Enabled"]
  JUMPIFNOTEQKNIL R6 [+3]
  LOADB R5 1
  JUMP [+2]
  GETTABLEKS R5 R0 K19 ["Enabled"]
  GETUPVAL R6 5
  LOADK R7 K20 ["TextButton"]
  NEWTABLE R8 8 0
  ...
  GETUPVAL R10 7
  LOADK R11 K21 ["Component-RibbonTab X-Fit"]
  JUMPIF R5 [+2]
  LOADK R12 K22 ["State-Disabled"]
  JUMP [+6]
  GETTABLEKS R13 R0 K23 ["Selected"]
  JUMPIFNOT R13 [+2]
  LOADK R12 K24 ["State-Selected"]
  JUMP [+1]
  LOADK R12 K25 ["State-Default"]
  GETUPVAL R14 8
  CALL R14 0 1
  JUMPIFNOT R14 [+10]
  ...
  GETTABLEKS R9 R10 K26 ["Activated"]
  GETTABLEKS R11 R0 K27 ["OnSelected"]
  JUMPIFNOT R11 [+4]
  NEWCLOSURE R10 P3
  CAPTURE VAL R0
  CAPTURE VAL R2
  ...
  GETUPVAL R11 6
  GETTABLEKS R10 R11 K14 ["Event"]
  GETTABLEKS R9 R10 K28 ["MouseButton2Click"]
  LENGTH R11 R3
  LOADN R12 0
