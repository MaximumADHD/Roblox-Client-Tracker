...
PROTO_4:
  ...
  CALL R14 0 1
  JUMPIF R14 [+2]
  LOADK R13 K30 ["X-RowSpace100"]
  JUMP [+1]
  LOADNIL R13
  LOADK R14 K31 ["Component-CollaboratorRibbon X-Middle X-Fit Role-Surface"]
  CALL R12 2 1
  SETTABLE R12 R10 R11
  DUPTABLE R11 K34 [{"CollaboratorContainer", "CollaboratorButton"}]
  LENGTH R13 R4
  LOADN R14 0
  JUMPIFNOTLT R14 R13 [+37]
  GETUPVAL R13 1
  ...
  GETTABLEKS R16 R0 K39 ["OnClick"]
  SETTABLE R16 R14 R15
  GETUPVAL R16 1
  GETTABLEKS R15 R16 K7 ["Tag"]
  GETUPVAL R16 3
  LOADK R17 K40 ["X-Middle X-Fit Role-Surface"]
  JUMPIFNOT R6 [+2]
  LOADK R18 K41 ["X-Row"]
  JUMP [+6]
  GETUPVAL R19 5
  ...
  JUMP [+1]
  LOADNIL R12
  SETTABLEKS R12 R11 K32 ["CollaboratorContainer"]
  GETUPVAL R13 1
  GETTABLEKS R12 R13 K5 ["createElement"]
  GETUPVAL R13 6
  DUPTABLE R14 K45 [{"IsTeamCreateOn"}]
  LENGTH R16 R4
  LOADN R17 0
  JUMPIFLT R17 R16 [+2]
  LOADB R15 0 +1
  LOADB R15 1
  SETTABLEKS R15 R14 K44 ["IsTeamCreateOn"]
  CALL R12 2 1
  SETTABLEKS R12 R11 K33 ["CollaboratorButton"]
  CALL R8 3 -1
  RETURN R8 -1
