...
PROTO_4:
  ...
  GETTABLEKS R21 R12 K13 ["IsIdle"]
  SETTABLEKS R21 R20 K13 ["IsIdle"]
  GETTABLEKS R21 R12 K14 ["CollaboratorColor3"]
  SETTABLEKS R21 R20 K15 ["RingColor"]
  GETUPVAL R22 1
  GETTABLEKS R21 R22 K7 ["Tag"]
  LOADK R22 K16 ["RibbonElement"]
  ...
  LOADK R14 K17 ["Component-OverflowBubble RibbonElement Role-Surface"]
  SETTABLE R14 R12 R13
  DUPTABLE R13 K19 [{"Text"}]
  GETUPVAL R15 1
  GETTABLEKS R14 R15 K5 ["createElement"]
  LOADK R15 K20 ["TextLabel"]
  NEWTABLE R16 2 0
  LOADK R18 K21 ["+%*"]
  LENGTH R21 R4
  SUBK R20 R21 K22 [4]
  ...
  GETUPVAL R18 1
  GETTABLEKS R17 R18 K7 ["Tag"]
  LOADK R18 K24 ["X-AnchorCenter Role-Surface X-Fit"]
  SETTABLE R18 R16 R17
  CALL R14 2 1
  SETTABLEKS R14 R13 K18 ["Text"]
  CALL R10 3 -1
  FASTCALL TABLE_INSERT [+2]
  GETIMPORT R8 K27 [table.insert]
  CALL R8 -1 0
  GETUPVAL R9 1
  GETTABLEKS R8 R9 K5 ["createElement"]
  LOADK R9 K6 ["Frame"]
  NEWTABLE R10 2 0
  GETTABLEKS R11 R0 K28 ["LayoutOrder"]
  SETTABLEKS R11 R10 K28 ["LayoutOrder"]
  GETUPVAL R12 1
  GETTABLEKS R11 R12 K7 ["Tag"]
  LOADK R12 K29 ["Component-CollaboratorRibbon X-RowSpace100 X-Middle X-Fit Role-Surface"]
  SETTABLE R12 R10 R11
  DUPTABLE R11 K32 [{"CollaboratorContainer", "CollaboratorButton"}]
  LENGTH R13 R4
  LOADN R14 0
  JUMPIFNOTLT R14 R13 [+32]
  GETUPVAL R13 1
  GETTABLEKS R12 R13 K5 ["createElement"]
  LOADK R13 K33 ["TextButton"]
  NEWTABLE R14 4 0
  LOADK R15 K34 [""]
  SETTABLEKS R15 R14 K18 ["Text"]
  GETUPVAL R17 1
  GETTABLEKS R16 R17 K35 ["Event"]
  GETTABLEKS R15 R16 K36 ["Activated"]
  GETTABLEKS R16 R0 K37 ["OnClick"]
  SETTABLE R16 R14 R15
  GETUPVAL R16 1
  GETTABLEKS R15 R16 K7 ["Tag"]
  GETUPVAL R16 3
  LOADK R17 K38 ["X-Middle X-Fit Role-Surface"]
  JUMPIFNOT R6 [+2]
  LOADK R18 K39 ["X-Row"]
  JUMP [+1]
  LOADK R18 K40 ["X-RowSpace50"]
  CALL R16 2 1
  SETTABLE R16 R14 R15
  MOVE R15 R7
  CALL R12 3 1
  JUMP [+1]
  LOADNIL R12
  SETTABLEKS R12 R11 K30 ["CollaboratorContainer"]
  GETUPVAL R13 1
  GETTABLEKS R12 R13 K5 ["createElement"]
  GETUPVAL R13 5
  DUPTABLE R14 K42 [{"IsTeamCreateOn"}]
  LENGTH R16 R4
  LOADN R17 0
  JUMPIFLT R17 R16 [+2]
  LOADB R15 0 +1
  LOADB R15 1
  SETTABLEKS R15 R14 K41 ["IsTeamCreateOn"]
  CALL R12 2 1
  SETTABLEKS R12 R11 K31 ["CollaboratorButton"]
  CALL R8 3 -1
  RETURN R8 -1
