MAIN:
  ...
  DUPTABLE R10 K36 [{"AnchorPoint", "BorderSizePixel", "Position", "Size", "BackgroundColor3"}]
  LOADK R11 K16 ["$AnchorCenter"]
  SETTABLEKS R11 R10 K12 ["AnchorPoint"]
  LOADK R11 K37 ["$BorderNone"]
  ...
  LOADK R11 K38 ["$SemanticColorComponentMediaFill"]
  ...
  MOVE R13 R2
  LOADK R14 K39 [".Idle"]
  DUPTABLE R15 K40 [{"Size"}]
  LOADK R16 K41 ["$AvatarXS"]
