...
PROTO_4:
  ...
  GETUPVAL R9 4
  LOADK R10 K9 ["Role-Surface X-FitY X-Middle"]
  GETUPVAL R12 5
  CALL R12 0 1
  JUMPIFNOT R12 [+10]
  LOADK R12 K10 ["data-testid=%*"]
  GETUPVAL R14 6
  GETTABLEKS R15 R0 K11 ["Uri"]
  CALL R14 1 1
  ...
  CALL R9 2 1
  SETTABLE R9 R7 R8
  DUPTABLE R8 K14 [{"Icon", "Content"}]
  GETTABLEKS R10 R0 K2 ["Icon"]
  JUMPIFNOT R10 [+25]
  GETUPVAL R10 3
  GETTABLEKS R9 R10 K3 ["createElement"]
  LOADK R10 K15 ["ImageLabel"]
  ...
  LOADK R13 K24 ["Role-Surface X-Fit X-Middle"]
  SETTABLE R13 R11 R12
  DUPTABLE R12 K26 [{"TitleFrame", "Text"}]
  GETUPVAL R14 3
  ...
  DUPTABLE R16 K30 [{"Title", "Spacer", "Shortcuts"}]
  ...
  LOADB R20 1
  SETTABLEKS R20 R19 K32 ["RichText"]
  ...
  GETUPVAL R21 3
  GETTABLEKS R20 R21 K8 ["Tag"]
  LOADK R21 K34 ["Role-Surface X-FitY"]
  SETTABLE R21 R19 R20
  CALL R17 2 1
  SETTABLEKS R17 R16 K28 ["Spacer"]
  ...
  CALL R13 3 1
  SETTABLEKS R13 R12 K25 ["TitleFrame"]
  ...
  SETTABLEKS R16 R15 K19 ["LayoutOrder"]
  LOADB R16 1
  SETTABLEKS R16 R15 K32 ["RichText"]
  ...
  LOADK R10 K39 ["Role-Tooltip X-Fill"]
  SETTABLE R10 R8 R9
...
MAIN:
  ...
  CAPTURE VAL R5
  CAPTURE VAL R22
  LOADK R27 K37 ["Tooltip_%*"]
  GETIMPORT R29 K40 [math.random]
  CALL R29 0 1
