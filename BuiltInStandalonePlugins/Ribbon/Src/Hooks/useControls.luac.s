...
PROTO_10:
  GETUPVAL R0 0
  GETUPVAL R2 1
  NAMECALL R0 R0 K0 ["MultiBindToChanged"]
  CALL R0 2 -1
  RETURN R0 -1
...
MAIN:
  ...
  DUPTABLE R10 K23 [{"SettingsBindings", "ActionBindings"}]
  NEWTABLE R11 0 0
  SETTABLEKS R11 R10 K21 ["SettingsBindings"]
  NEWTABLE R11 0 0
  SETTABLEKS R11 R10 K22 ["ActionBindings"]
  GETIMPORT R11 K5 [require]
  GETTABLEKS R14 R0 K10 ["Src"]
  GETTABLEKS R13 R14 K24 ["SharedFlags"]
  GETTABLEKS R12 R13 K25 ["getFFlagStudioCommandBridgesMultiBind"]
  CALL R11 1 1
  MOVE R12 R11
  CALL R12 0 1
  GETIMPORT R13 K27 [game]
  LOADK R15 K28 ["LuaRibbonPerformanceImprovement"]
  LOADB R16 0
  NAMECALL R13 R13 K29 ["DefineFastFlag"]
  CALL R13 3 1
  DUPCLOSURE R14 K30 [PROTO_18]
  CAPTURE VAL R3
  CAPTURE VAL R2
  CAPTURE VAL R4
  CAPTURE VAL R7
