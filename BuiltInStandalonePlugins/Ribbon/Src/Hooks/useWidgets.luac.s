...
MAIN:
  ...
  CALL R8 1 1
  DUPTABLE R9 K24 [{"Widgets", "pendingRegisters", "pendingDeregisters", "registeredWidgets", "running"}]
  LOADNIL R10
  SETTABLEKS R10 R9 K19 ["Widgets"]
  NEWTABLE R10 0 0
  SETTABLEKS R10 R9 K20 ["pendingRegisters"]
  NEWTABLE R10 0 0
  SETTABLEKS R10 R9 K21 ["pendingDeregisters"]
  NEWTABLE R10 0 0
  SETTABLEKS R10 R9 K22 ["registeredWidgets"]
  LOADB R10 0
  SETTABLEKS R10 R9 K23 ["running"]
  DUPCLOSURE R10 K25 [PROTO_1]
  CAPTURE VAL R4
  CAPTURE VAL R9
  CAPTURE VAL R3
  SETTABLEKS R10 R9 K26 ["flush"]
  DUPCLOSURE R10 K27 [PROTO_3]
  CAPTURE VAL R9
  SETTABLEKS R10 R9 K28 ["run"]
  DUPCLOSURE R10 K29 [PROTO_4]
  CAPTURE VAL R8
  CAPTURE VAL R9
  SETTABLEKS R10 R9 K30 ["register"]
  DUPCLOSURE R10 K31 [PROTO_5]
  CAPTURE VAL R8
  CAPTURE VAL R9
  SETTABLEKS R10 R9 K32 ["deregister"]
