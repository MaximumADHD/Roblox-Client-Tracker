...
PROTO_3:
  ...
  RETURN R0 0
  GETTABLEKS R3 R2 K0 ["Id"]
  JUMPIFNOTEQKS R3 K16 ["Duplicate"] [+18]
  GETUPVAL R3 6
  MOVE R4 R0
  CALL R3 1 1
  JUMPIF R3 [+5]
  ...
  RETURN R0 0
  GETTABLEKS R3 R2 K0 ["Id"]
  JUMPIFNOTEQKS R3 K18 ["Delete"] [+15]
  GETUPVAL R3 9
  MOVE R4 R0
  CALL R3 1 1
  JUMPIF R3 [+5]
  GETIMPORT R3 K3 [warn]
  LOADK R4 K19 ["Cannot delete this tab"]
  CALL R3 1 0
  RETURN R0 0
  GETUPVAL R3 10
  SETTABLEKS R0 R3 K20 ["current"]
  GETUPVAL R3 11
  CALL R3 0 0
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R11 R12 K21 ["useActiveTabIdentifier"]
  CALL R10 1 1
  GETIMPORT R11 K5 [require]
  GETTABLEKS R14 R0 K9 ["Src"]
  GETTABLEKS R13 R14 K20 ["Hooks"]
  GETTABLEKS R12 R13 K22 ["useLocalizedTabNames"]
  CALL R11 1 1
  GETTABLEKS R14 R1 K23 ["UI"]
  GETTABLEKS R13 R14 K20 ["Hooks"]
  GETTABLEKS R12 R13 K24 ["useDialog"]
  GETTABLEKS R14 R1 K13 ["Util"]
  GETTABLEKS R13 R14 K25 ["DialogAction"]
  ...
  GETTABLEKS R16 R17 K29 ["Plugin"]
  GETTABLEKS R17 R7 K30 ["hasToggleableVisibility"]
  GETTABLEKS R18 R7 K31 ["isAddButton"]
  GETTABLEKS R19 R7 K32 ["isDeletable"]
  GETTABLEKS R20 R7 K33 ["isDuplicable"]
  GETTABLEKS R21 R7 K34 ["isRenamable"]
  GETTABLEKS R22 R7 K35 ["shouldCopyCustomTools"]
  GETTABLEKS R23 R2 K36 ["useCallback"]
  GETTABLEKS R24 R2 K37 ["useContext"]
  GETTABLEKS R25 R2 K38 ["useMemo"]
  GETTABLEKS R26 R2 K39 ["useState"]
  GETTABLEKS R27 R2 K40 ["useRef"]
  DUPCLOSURE R28 K41 [PROTO_13]
  CAPTURE VAL R15
  CAPTURE VAL R16
  CAPTURE VAL R10
  CAPTURE VAL R24
