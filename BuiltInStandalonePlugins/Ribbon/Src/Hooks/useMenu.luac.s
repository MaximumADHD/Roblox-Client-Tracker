...
PROTO_3:
  ...
  DUPTABLE R7 K15 [{"GrabsMouse"}]
  LOADB R8 0
  SETTABLEKS R8 R7 K14 ["GrabsMouse"]
  ...
  GETUPVAL R5 1
  GETTABLEKS R4 R5 K21 ["createRoot"]
  MOVE R5 R3
  CALL R4 1 1
  DUPTABLE R5 K28 [{"depth", "uri", "panel", "root", "open", "Panels"}]
  GETUPVAL R8 0
  LENGTH R7 R8
  ADDK R6 R7 K29 [1]
  SETTABLEKS R6 R5 K22 ["depth"]
  GETUPVAL R6 2
  NAMECALL R7 R0 K30 ["GetUri"]
  CALL R7 1 1
  DUPTABLE R8 K33 [{"Category", "ItemId"}]
  LOADK R9 K27 ["Panels"]
  SETTABLEKS R9 R8 K31 ["Category"]
  SETTABLEKS R2 R8 K32 ["ItemId"]
  CALL R6 2 1
  SETTABLEKS R6 R5 K23 ["uri"]
  SETTABLEKS R3 R5 K24 ["panel"]
  SETTABLEKS R4 R5 K25 ["root"]
  LOADB R6 0
  SETTABLEKS R6 R5 K26 ["open"]
  LOADK R8 K27 ["Panels"]
  NAMECALL R6 R0 K34 ["GetPluginComponent"]
  CALL R6 2 1
  SETTABLEKS R6 R5 K27 ["Panels"]
  GETUPVAL R6 0
  SETTABLE R5 R6 R1
  NEWCLOSURE R8 P0
  CAPTURE UPVAL U0
  CAPTURE VAL R5
  CAPTURE UPVAL U3
  NAMECALL R6 R3 K35 ["BindToClose"]
  CALL R6 2 0
  RETURN R5 1
...
MAIN:
  ...
  GETTABLEKS R15 R16 K24 ["getFFlagStudioEnableInteractionTelemetry"]
  CALL R14 1 1
