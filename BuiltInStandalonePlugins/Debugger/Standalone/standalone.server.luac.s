PROTO_0:
       ...
       31 LOADNIL                          R1
       32 SETUPVAL                         R1 5
       33 GETIMPORT                        R2 K9 [require]
       35 GETUPVAL                         R5 0
       36 GETTABLEKS                       R4 R5 K10 ["Packages"]
       38 GETTABLEKS                       R3 R4 K11 ["DeveloperTools"]
       40 CALL                             R2 1 1
       41 GETTABLEKS                       R1 R2 K12 ["forStandalonePlugin"]
       43 GETUPVAL                         R3 0
       44 GETTABLEKS                       R2 R3 K2 ["Name"]
...
MAIN:
       ...
       15 GETTABLEKS                       R2 R3 K4 ["Parent"]
       17 GETTABLEKS                       R1 R2 K5 ["Common"]
       19 GETIMPORT                        R2 K7 [require]
       21 GETTABLEKS                       R3 R1 K8 ["defineLuaFlags"]
       23 CALL                             R2 1 0
       24 GETIMPORT                        R2 K7 [require]
       26 GETTABLEKS                       R6 R1 K4 ["Parent"]
       28 GETTABLEKS                       R5 R6 K9 ["Src"]
       30 GETTABLEKS                       R4 R5 K10 ["Util"]
       32 GETTABLEKS                       R3 R4 K11 ["DebugFlags"]
       34 CALL                             R2 1 1
       ...
       66 GETTABLEKS                       R7 R0 K21 ["Packages"]
       68 GETTABLEKS                       R6 R7 K22 ["Roact"]
       70 CALL                             R5 1 1
       71 GETIMPORT                        R6 K7 [require]
       73 GETTABLEKS                       R8 R0 K9 ["Src"]
       75 GETTABLEKS                       R7 R8 K23 ["MainPlugin"]
       77 CALL                             R6 1 1
       78 LOADNIL                          R7
       79 LOADNIL                          R8
       80 NEWCLOSURE                       R9 P0
       ...
       89 CAPTURE                          REF R7
       90 CAPTURE                          VAL R5
       91 GETIMPORT                        R12 K1 [plugin]
       93 GETTABLEKS                       R11 R12 K24 ["Unloading"]
       95 MOVE                             R13 R10
