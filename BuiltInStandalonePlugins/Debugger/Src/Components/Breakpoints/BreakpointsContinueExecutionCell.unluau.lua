...
local var8 = var1.PureComponent:extend("BreakpointsContinueExecutionCell")
function var8.init(arg1)
   function arg1.onCheckboxClicked()
      local var0 = arg1.props.Row
      game:GetService("MetaBreakpointManager"):GetBreakpointById(var0.item.id):SetContinueExecution(var0.item.continueExecution)
      arg1.props.Analytics:report(var4.MetaBreakpointContinueExecutionChanged, "LuaBreakpointsTable")
   end
