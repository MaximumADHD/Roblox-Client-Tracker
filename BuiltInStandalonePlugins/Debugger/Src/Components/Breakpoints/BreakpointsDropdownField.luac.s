...
PROTO_1:
  ...
  GETUPVAL R4 1
  GETTABLEKS R3 R4 K3 ["BreakpointsColumnsEdited"]
  GETUPVAL R4 2
  MOVE R5 R0
  CALL R4 1 -1
...
PROTO_2:
  ...
  SETTABLEN R2 R1 1
  GETUPVAL R3 0
  GETTABLEKS R2 R3 K1 ["SourceLine"]
  SETTABLEN R2 R1 2
  GETUPVAL R3 0
  GETTABLEKS R2 R3 K2 ["Condition"]
  SETTABLEN R2 R1 3
  GETUPVAL R3 0
  GETTABLEKS R2 R3 K3 ["LogMessage"]
  SETTABLEN R2 R1 4
  GETUPVAL R3 0
  GETTABLEKS R2 R3 K4 ["ContinueExecution"]
  SETTABLEN R2 R1 5
  GETUPVAL R3 0
  GETTABLEKS R2 R3 K5 ["RemoveOnHit"]
  SETTABLEN R2 R1 6
  SETTABLEKS R1 R0 K6 ["keyColumns"]
  NEWCLOSURE R1 P0
  CAPTURE VAL R0
  CAPTURE UPVAL U1
  CAPTURE UPVAL U2
  SETTABLEKS R1 R0 K7 ["clickCallback"]
  RETURN R0 0
...
PROTO_3:
  ...
  LOADK R7 K16 ["BreakpointsWindow"]
...
PROTO_4:
  GETTABLEKS R3 R0 K0 ["Breakpoint"]
  GETTABLEKS R2 R3 K1 ["listOfEnabledColumns"]
  NEWTABLE R3 0 0
  GETUPVAL R6 0
  GETTABLEKS R5 R6 K2 ["SourceLine"]
  ...
  SETTABLEN R4 R3 3
  GETUPVAL R6 0
  GETTABLEKS R5 R6 K6 ["LogMessage"]
  GETIMPORT R6 K4 [pairs]
  MOVE R7 R2
  CALL R6 1 3
  FORGPREP_NEXT R6
  ...
  SETTABLEN R4 R3 4
  GETUPVAL R6 0
  GETTABLEKS R5 R6 K7 ["ContinueExecution"]
  GETIMPORT R6 K4 [pairs]
  MOVE R7 R2
  CALL R6 1 3
  FORGPREP_NEXT R6
  ...
  SETTABLEN R4 R3 5
  GETUPVAL R6 0
  GETTABLEKS R5 R6 K8 ["RemoveOnHit"]
  GETIMPORT R6 K4 [pairs]
  MOVE R7 R2
  CALL R6 1 3
  FORGPREP_NEXT R6
  ...
  LOADB R4 0
  SETTABLEN R4 R3 6
  DUPTABLE R4 K10 [{"ColumnStates"}]
  SETTABLEKS R3 R4 K9 ["ColumnStates"]
  RETURN R4 1
...
MAIN:
  ...
  GETTABLEKS R14 R11 K22 ["BreakpointsWindow"]
  GETTABLEKS R13 R14 K23 ["BreakpointColumnFilter"]
  CALL R12 1 1
  GETTABLEKS R14 R0 K13 ["Src"]
  GETTABLEKS R13 R14 K24 ["Models"]
  GETIMPORT R14 K4 [require]
  GETTABLEKS R15 R13 K25 ["BreakpointTableColumnEnum"]
  CALL R14 1 1
  ...
  LOADK R18 K29 ["BreakpointsDropdownField"]
