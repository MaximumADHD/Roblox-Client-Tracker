...
PROTO_1:
        ...
        3 GETTABLEKS                       R1 R1 K1 ["onVariablesFilterChange"]
        5 MOVE                             R2 R0
        6 CALL                             R1 1 0
        7 GETUPVAL                         R1 0
       ...
       12 GETUPVAL                         R3 1
       13 GETTABLEKS                       R3 R3 K3 ["VariablesColumnsEdited"]
       15 GETUPVAL                         R4 2
       16 MOVE                             R5 R0
       17 CALL                             R4 1 -1
...
PROTO_2:
        ...
        3 SETTABLEN                        R2 R1 1
        4 GETUPVAL                         R2 0
        5 GETTABLEKS                       R2 R2 K1 ["Scope"]
        7 SETTABLEN                        R2 R1 2
        8 GETUPVAL                         R2 0
        9 GETTABLEKS                       R2 R2 K2 ["Value"]
       11 SETTABLEN                        R2 R1 3
       12 GETUPVAL                         R2 0
       13 GETTABLEKS                       R2 R2 K3 ["DataType"]
...
PROTO_3:
        ...
        9 GETUPVAL                         R5 1
       10 DUPTABLE                         R6 K17 [{["KeyTexts"], ["ClickCallback"], ["KeyStates"], ["Localization"], ["Style"], ["Widget"] = "Watch", ["DropdownWidth"] = 200, ["HamburgerMenu"] = True, ["ShouldShowDropdownIcon"] = False, ["LayoutOrder"]}]
       11 GETTABLEKS                       R7 R0 K18 ["keyColumns"]
       13 SETTABLEKS                       R7 R6 K4 ["KeyTexts"]
       15 GETTABLEKS                       R7 R0 K19 ["clickCallback"]
       17 SETTABLEKS                       R7 R6 K5 ["ClickCallback"]
       19 GETTABLEKS                       R7 R1 K20 ["ColumnStates"]
       21 SETTABLEKS                       R7 R6 K6 ["KeyStates"]
       23 SETTABLEKS                       R3 R6 K2 ["Localization"]
       25 SETTABLEKS                       R2 R6 K7 ["Style"]
       27 GETTABLEKS                       R7 R1 K16 ["LayoutOrder"]
       29 SETTABLEKS                       R7 R6 K16 ["LayoutOrder"]
       31 CALL                             R4 2 -1
       32 RETURN                           R4 -1

PROTO_4:
        0 GETTABLEKS                       R2 R0 K0 ["Watch"]
        2 GETTABLEKS                       R2 R2 K1 ["listOfVariablesColumns"]
        4 NEWTABLE                         R3 0 0
        6 GETUPVAL                         R5 0
        7 GETTABLEKS                       R5 R5 K2 ["Scope"]
       ...
       38 GETUPVAL                         R5 0
       39 GETTABLEKS                       R5 R5 K6 ["DataType"]
       ...
       54 DUPTABLE                         R4 K8 [{"ColumnStates"}]
       55 SETTABLEKS                       R3 R4 K7 ["ColumnStates"]
       57 RETURN                           R4 1
...
PROTO_6:
        0 DUPTABLE                         R1 K1 [{"onVariablesFilterChange"}]
        1 NEWCLOSURE                       R2 P0
        2 CAPTURE                          VAL R0
        3 CAPTURE                          UPVAL U0
        4 SETTABLEKS                       R2 R1 K0 ["onVariablesFilterChange"]
        6 RETURN                           R1 1
...
MAIN:
       ...
       97 LOADK                            R18 K29 ["VariablesDropdownField"]
