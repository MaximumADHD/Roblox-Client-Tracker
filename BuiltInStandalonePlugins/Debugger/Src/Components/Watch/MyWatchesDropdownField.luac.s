...
PROTO_1:
  ...
  GETTABLEKS R1 R2 K1 ["onMyWatchesFilterChange"]
  MOVE R2 R0
  CALL R1 1 0
  GETUPVAL R3 0
  GETTABLEKS R2 R3 K0 ["props"]
  ...
  GETUPVAL R4 1
  GETTABLEKS R3 R4 K3 ["MyWatchesColumnsEdited"]
  GETUPVAL R4 2
  MOVE R5 R0
  CALL R4 1 -1
...
PROTO_2:
  ...
  SETTABLEN R2 R1 2
  GETUPVAL R3 0
  GETTABLEKS R2 R3 K2 ["DataType"]
  SETTABLEN R2 R1 3
  SETTABLEKS R1 R0 K3 ["keyColumns"]
  NEWCLOSURE R1 P0
  CAPTURE VAL R0
  CAPTURE UPVAL U1
  CAPTURE UPVAL U2
  SETTABLEKS R1 R0 K4 ["clickCallback"]
  RETURN R0 0
...
PROTO_4:
  ...
  GETTABLEKS R2 R3 K1 ["listOfMyWatchesColumns"]
  NEWTABLE R3 0 0
  GETUPVAL R6 0
  ...
  LOADB R4 0
  SETTABLEN R4 R3 3
  DUPTABLE R4 K7 [{"ColumnStates"}]
  SETTABLEKS R3 R4 K6 ["ColumnStates"]
  RETURN R4 1
...
PROTO_6:
  DUPTABLE R1 K1 [{"onMyWatchesFilterChange"}]
  NEWCLOSURE R2 P0
  CAPTURE VAL R0
  CAPTURE UPVAL U0
  SETTABLEKS R2 R1 K0 ["onMyWatchesFilterChange"]
  RETURN R1 1
...
MAIN:
  ...
  GETTABLEKS R13 R14 K23 ["MyWatchesFilterChange"]
  CALL R12 1 1
  GETTABLEKS R14 R0 K13 ["Src"]
  GETTABLEKS R13 R14 K24 ["Models"]
  GETIMPORT R14 K4 [require]
  GETTABLEKS R16 R13 K22 ["Watch"]
  GETTABLEKS R15 R16 K25 ["MyWatchesColumnEnum"]
  CALL R14 1 1
  ...
  LOADK R18 K29 ["MyWatchesDropdownField"]
