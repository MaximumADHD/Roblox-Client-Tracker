PROTO_0:
       ...
       19 GETUPVAL                         R10 0
       20 GETTABLEKS                       R10 R10 K8 ["List"]
       22 GETTABLEKS                       R10 R10 K1 ["join"]
       24 GETTABLEKS                       R12 R0 K2 ["stateTokenToCallstackVars"]
       26 GETTABLEKS                       R13 R1 K4 ["debuggerStateToken"]
       28 GETTABLE                         R11 R12 R13
       29 GETTABLEKS                       R11 R11 K5 ["threadList"]
       31 NEWTABLE                         R12 0 1
       33 GETUPVAL                         R13 1
       34 GETTABLEKS                       R13 R13 K9 ["fromData"]
       36 MOVE                             R14 R1
       37 CALL                             R13 1 -1
       38 SETLIST                          R12 R13 -1 [1]
       40 CALL                             R10 2 1
       41 SETTABLEKS                       R10 R9 K5 ["threadList"]
       43 GETTABLEKS                       R11 R0 K2 ["stateTokenToCallstackVars"]
       45 GETTABLEKS                       R12 R1 K4 ["debuggerStateToken"]
       47 GETTABLE                         R10 R11 R12
       48 GETTABLEKS                       R10 R10 K6 ["threadIdToFrameList"]
...
PROTO_1:
       ...
       12 RETURN                           R0 1
       13 GETUPVAL                         R2 0
       14 GETTABLEKS                       R2 R2 K4 ["Dictionary"]
       16 GETTABLEKS                       R2 R2 K5 ["join"]
       18 MOVE                             R3 R0
       19 DUPTABLE                         R4 K6 [{"stateTokenToCallstackVars"}]
       20 GETUPVAL                         R5 0
       21 GETTABLEKS                       R5 R5 K4 ["Dictionary"]
       23 GETTABLEKS                       R5 R5 K5 ["join"]
       ...
       32 GETUPVAL                         R10 0
       33 GETTABLEKS                       R10 R10 K4 ["Dictionary"]
       35 GETTABLEKS                       R10 R10 K5 ["join"]
       37 GETTABLEKS                       R12 R0 K0 ["stateTokenToCallstackVars"]
       39 GETTABLEKS                       R13 R1 K1 ["debuggerStateToken"]
       41 GETTABLE                         R11 R12 R13
       42 GETTABLEKS                       R11 R11 K7 ["threadIdToFrameList"]
       44 NEWTABLE                         R12 1 0
       ...
       54 GETTABLEKS                       R11 R0 K0 ["stateTokenToCallstackVars"]
       56 GETTABLEKS                       R12 R1 K1 ["debuggerStateToken"]
       58 GETTABLE                         R10 R11 R12
       59 GETTABLEKS                       R10 R10 K8 ["threadList"]
...
PROTO_2:
        ...
        8 GETTABLEKS                       R6 R0 K0 ["stateTokenToCallstackVars"]
       10 GETTABLEKS                       R7 R1 K1 ["debuggerStateToken"]
       12 GETTABLE                         R5 R6 R7
       13 GETTABLEKS                       R5 R5 K2 ["threadIdToFrameList"]
       ...
       25 CALL                             R2 1 0
       26 GETUPVAL                         R2 0
       27 GETTABLEKS                       R2 R2 K6 ["Dictionary"]
       29 GETTABLEKS                       R2 R2 K7 ["join"]
       31 MOVE                             R3 R0
       32 DUPTABLE                         R4 K8 [{"stateTokenToCallstackVars"}]
       33 GETUPVAL                         R5 0
       34 GETTABLEKS                       R5 R5 K6 ["Dictionary"]
       36 GETTABLEKS                       R5 R5 K7 ["join"]
       ...
       50 JUMPIFNOT                        R11 ; [+8]
       51 GETTABLEKS                       R11 R0 K0 ["stateTokenToCallstackVars"]
       53 GETTABLEKS                       R12 R1 K1 ["debuggerStateToken"]
       55 GETTABLE                         R10 R11 R12
       56 GETTABLEKS                       R10 R10 K9 ["threadList"]
       58 JUMPIF                           R10 ; [+2]
       59 NEWTABLE                         R10 0 0
       ...
       68 JUMPIFNOT                        R11 ; [+8]
       69 GETTABLEKS                       R11 R0 K0 ["stateTokenToCallstackVars"]
       71 GETTABLEKS                       R12 R1 K1 ["debuggerStateToken"]
       73 GETTABLE                         R10 R11 R12
       74 GETTABLEKS                       R10 R10 K2 ["threadIdToFrameList"]
       76 JUMPIF                           R10 ; [+2]
       77 NEWTABLE                         R10 0 0
...
PROTO_3:
        ...
        4 GETTABLEKS                       R6 R0 K2 ["stateTokenToCallstackVars"]
        6 GETTABLEKS                       R7 R1 K3 ["debuggerStateToken"]
        8 GETTABLE                         R4 R6 R7
        9 GETTABLEKS                       R4 R4 K4 ["threadList"]
       11 CALL                             R3 1 3
       ...
       40 CALL                             R3 1 0
       41 GETUPVAL                         R3 0
       42 GETTABLEKS                       R3 R3 K11 ["Dictionary"]
       44 GETTABLEKS                       R3 R3 K12 ["join"]
       46 GETTABLEKS                       R5 R0 K2 ["stateTokenToCallstackVars"]
       48 GETTABLEKS                       R6 R1 K3 ["debuggerStateToken"]
       50 GETTABLE                         R4 R5 R6
       51 GETTABLEKS                       R4 R4 K13 ["threadIdToFrameList"]
       53 NEWTABLE                         R5 0 0
       55 CALL                             R3 2 1
       ...
       60 GETUPVAL                         R4 0
       61 GETTABLEKS                       R4 R4 K11 ["Dictionary"]
       63 GETTABLEKS                       R4 R4 K12 ["join"]
       65 MOVE                             R5 R0
       66 DUPTABLE                         R6 K14 [{"stateTokenToCallstackVars"}]
       67 GETUPVAL                         R7 0
       68 GETTABLEKS                       R7 R7 K11 ["Dictionary"]
       70 GETTABLEKS                       R7 R7 K12 ["join"]
...
MAIN:
       ...
       33 GETTABLEKS                       R6 R3 K11 ["Callstack"]
       35 GETTABLEKS                       R6 R6 K12 ["AddCallstack"]
       37 CALL                             R5 1 1
       38 GETIMPORT                        R6 K4 [require]
       40 GETTABLEKS                       R7 R3 K11 ["Callstack"]
       42 GETTABLEKS                       R7 R7 K13 ["AddThreadId"]
       44 CALL                             R6 1 1
       45 GETIMPORT                        R7 K4 [require]
       47 GETTABLEKS                       R8 R3 K14 ["Common"]
       49 GETTABLEKS                       R8 R8 K15 ["Resumed"]
       51 CALL                             R7 1 1
       52 GETIMPORT                        R8 K4 [require]
       54 GETTABLEKS                       R9 R3 K14 ["Common"]
       56 GETTABLEKS                       R9 R9 K16 ["ClearConnectionData"]
       58 CALL                             R8 1 1
       59 GETIMPORT                        R9 K4 [require]
       61 GETTABLEKS                       R10 R3 K14 ["Common"]
       63 GETTABLEKS                       R10 R10 K17 ["SimPaused"]
       65 CALL                             R9 1 1
       66 GETIMPORT                        R10 K4 [require]
       68 GETTABLEKS                       R11 R3 K11 ["Callstack"]
       70 GETTABLEKS                       R11 R11 K18 ["ColumnFilterChange"]
       72 CALL                             R10 1 1
       ...
       85 GETTABLEKS                       R14 R4 K11 ["Callstack"]
       87 GETTABLEKS                       R14 R14 K21 ["CallstackRow"]
       89 CALL                             R13 1 1
       90 GETIMPORT                        R14 K4 [require]
       92 GETTABLEKS                       R15 R4 K11 ["Callstack"]
       94 GETTABLEKS                       R15 R15 K22 ["ColumnEnum"]
       96 CALL                             R14 1 1
