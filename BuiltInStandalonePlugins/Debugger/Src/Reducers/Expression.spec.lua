...
return function()
	...
	describe(ChangeExpression.name, function() 
		it("should update the expression in place", function()
			...
			local state = WatchReducer(prepState2, ChangeExpression(stepStateBundle, "ChangeExpression Test1", "ChangeExpression Test3"))
		...
		it("should not allow duplicates", function()
			...
			local state = WatchReducer(prepState2, ChangeExpression(stepStateBundle, "ChangeExpression Test1", "ChangeExpression Test2"))
		...
		it("not allow changing what isn't there", function()			
			local state = WatchReducer(nil, ChangeExpression(stepStateBundle, "ChangeExpression Test1", "ChangeExpression Test2"))
		...
		it("should remove the expression from the roots", function()
			...
			local state = WatchReducer(prepState3, ChangeExpression(stepStateBundle, "ChangeExpression Test1", "ChangeExpression Test3"))
			expect(state).to.be.ok()
			expect(state.listOfExpressions).to.be.ok()
			expect(#state.listOfExpressions).to.equal(2)
			expect(state.listOfExpressions[1]).to.equal("ChangeExpression Test3")
			expect(state.listOfExpressions[2]).to.equal("ChangeExpression Test2")
			expect(#state.stateTokenToRoots[defaultDebuggerToken][2][2].Watches).to.equal(0)
		end)
		...
		it("should preserve immutability", function()
			...
			local immutabilityPreserved = testImmutability(WatchReducer, ChangeExpression(stepStateBundle, "ChangeExpression Test1", "ChangeExpression Test3"), prepState3)
			expect(immutabilityPreserved).to.equal(true)
		end)
	end)
	...
	describe(RemoveExpression.name, function() 
		it("should remove the expression from the list of expressions", function()
			...
			local state = WatchReducer(prepState, RemoveExpression(stepStateBundle, "RemoveExpression Test"))
		...
		it("should remove the expression from the roots", function()
			...
			local state = WatchReducer(prepState3, RemoveExpression(stepStateBundle, "RemoveExpression Test"))
			expect(state).to.be.ok()
			expect(state.listOfExpressions).to.be.ok()
			expect(#state.listOfExpressions).to.equal(0)
			expect(#state.stateTokenToRoots[defaultDebuggerToken][2][2].Watches).to.equal(0)
		...
		it("should preserve immutability", function()
			...
			local immutabilityPreserved = testImmutability(WatchReducer, RemoveExpression(stepStateBundle, "RemoveExpression Test"), prepState3)
			expect(immutabilityPreserved).to.equal(true)
		end)
	end)
end
