PROTO_0:
        0 GETTABLEKS                       R6 R1 K0 ["item"]
        2 GETTABLEKS                       R6 R6 K1 ["isEnabled"]
        4 NOT                              R5 R6
        5 GETTABLEKS                       R6 R1 K0 ["item"]
        7 GETTABLEKS                       R6 R6 K2 ["context"]
       ...
       15 JUMPIFNOT                        R5 ; [+8]
       16 GETUPVAL                         R8 0
       17 GETTABLEKS                       R8 R8 K4 ["EnableMetaBreakpoint"]
       19 MOVE                             R9 R3
       20 NAMECALL                         R6 R2 K5 ["report"]
       22 CALL                             R6 3 0
       23 RETURN                           R0 0
       24 GETUPVAL                         R8 0
       25 GETTABLEKS                       R8 R8 K6 ["DisableMetaBreakpoint"]
       27 MOVE                             R9 R3
       28 NAMECALL                         R6 R2 K5 ["report"]
       30 CALL                             R6 3 0
       31 RETURN                           R0 0
       32 GETUPVAL                         R6 1
       33 GETTABLEKS                       R6 R6 K7 ["GetIntForGST"]
       35 GETTABLEKS                       R7 R1 K0 ["item"]
       37 GETTABLEKS                       R7 R7 K2 ["context"]
       39 CALL                             R6 1 1
       ...
       50 JUMPIFNOT                        R4 ; [+10]
       51 GETUPVAL                         R9 1
       52 GETTABLEKS                       R9 R9 K12 ["kInvalidDebuggerConnectionId"]
       54 JUMPIFEQ                         R4 R9 ; [+6]
       56 MOVE                             R11 R4
       ...
       66 CALL                             R9 2 0
       67 JUMP                             ; [+9]
       68 GETTABLEKS                       R11 R1 K0 ["item"]
       70 GETTABLEKS                       R11 R11 K14 ["scriptGUID"]
       72 MOVE                             R12 R6
       73 MOVE                             R13 R5
       ...
       77 JUMPIFNOT                        R5 ; [+8]
       78 GETUPVAL                         R11 0
       79 GETTABLEKS                       R11 R11 K16 ["EnableBreakpoint"]
       81 MOVE                             R12 R3
       82 NAMECALL                         R9 R2 K5 ["report"]
       84 CALL                             R9 3 0
       85 RETURN                           R0 0
       86 GETUPVAL                         R11 0
       87 GETTABLEKS                       R11 R11 K17 ["DisableBreakpoint"]
       89 MOVE                             R12 R3
