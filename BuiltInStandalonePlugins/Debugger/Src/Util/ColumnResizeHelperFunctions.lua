...
module.fetchDeletedColumnsSize = function(numOfDefaultColumns, oldColumnNumber, PrevColumnFilter, oldColumnNameToSize, newColumnSet)
    ...
    for i = numOfDefaultColumns + 1, oldColumnNumber do
        if newColumnSet[PrevColumnFilter[i-numOfDefaultColumns]] == nil then
            deletedColumnsSize = deletedColumnsSize + oldColumnNameToSize[PrevColumnFilter[i-numOfDefaultColumns]].Scale
        end
    end
    return deletedColumnsSize
end

module.updatedSizesAfterRemovingColumns = function(columnNumber, deletedColumnsSize, oldColumnNameToSize, defaultColumns, ColumnFilter)
    local updatedSizes = {}
...
module.updatedSizesAfterAddingColumns = function(columnNumber, oldColumnNumber, oldColumnNameToSize, ColumnFilter, defaultColumns)
    local updatedSizes = {}
