...
PROTO_1:
       ...
       13 GETTABLEKS                       R3 R3 K7 ["PlaceId"]
...
PROTO_7:
        ...
        6 NEWTABLE                         R3 32 0
        8 GETUPVAL                         R4 1
        9 GETTABLEKS                       R4 R4 K0 ["RemoveMetaBreakpoint"]
       11 SETTABLE                         R2 R3 R4
       12 GETUPVAL                         R4 1
       13 GETTABLEKS                       R4 R4 K1 ["RemoveAllMetaBreakpoints"]
       15 SETTABLE                         R2 R3 R4
       16 GETUPVAL                         R4 1
       17 GETTABLEKS                       R4 R4 K2 ["EnableMetaBreakpoint"]
       19 SETTABLE                         R2 R3 R4
       20 GETUPVAL                         R4 1
       21 GETTABLEKS                       R4 R4 K3 ["DisableMetaBreakpoint"]
       23 SETTABLE                         R2 R3 R4
       24 GETUPVAL                         R4 1
       25 GETTABLEKS                       R4 R4 K4 ["EnableBreakpoint"]
       27 SETTABLE                         R2 R3 R4
       28 GETUPVAL                         R4 1
       29 GETTABLEKS                       R4 R4 K5 ["DisableBreakpoint"]
       31 SETTABLE                         R2 R3 R4
       32 GETUPVAL                         R4 1
       33 GETTABLEKS                       R4 R4 K6 ["EnableAllMetaBreakpoints"]
       35 SETTABLE                         R2 R3 R4
       36 GETUPVAL                         R4 1
       37 GETTABLEKS                       R4 R4 K7 ["DisableAllMetaBreakpoints"]
       39 SETTABLE                         R2 R3 R4
       40 GETUPVAL                         R4 1
       41 GETTABLEKS                       R4 R4 K8 ["MetaBreakpointConditionChanged"]
       43 SETTABLE                         R2 R3 R4
       44 GETUPVAL                         R4 1
       45 GETTABLEKS                       R4 R4 K9 ["MetaBreakpointLogMessageChanged"]
       47 SETTABLE                         R2 R3 R4
       48 GETUPVAL                         R4 1
       49 GETTABLEKS                       R4 R4 K10 ["MetaBreakpointContinueExecutionChanged"]
       51 SETTABLE                         R2 R3 R4
       52 GETUPVAL                         R4 1
       53 GETTABLEKS                       R4 R4 K11 ["MetaBreakpointRemoveOnHitChanged"]
       55 SETTABLE                         R2 R3 R4
       56 GETUPVAL                         R4 1
       57 GETTABLEKS                       R4 R4 K12 ["CallstackStepInto"]
       59 SETTABLE                         R2 R3 R4
       60 GETUPVAL                         R4 1
       61 GETTABLEKS                       R4 R4 K13 ["CallstackStepOver"]
       63 SETTABLE                         R2 R3 R4
       64 GETUPVAL                         R4 1
       65 GETTABLEKS                       R4 R4 K14 ["CallstackStepOut"]
       67 SETTABLE                         R2 R3 R4
       68 GETUPVAL                         R4 1
       69 GETTABLEKS                       R4 R4 K15 ["CallstackChangeFrame"]
       71 SETTABLE                         R2 R3 R4
       72 GETUPVAL                         R4 1
       73 GETTABLEKS                       R4 R4 K16 ["WatchAdded"]
       75 SETTABLE                         R2 R3 R4
       76 GETUPVAL                         R4 1
       77 GETTABLEKS                       R4 R4 K17 ["WatchScopeEdited"]
       79 NEWCLOSURE                       R5 P2
       80 CAPTURE                          VAL R0
       81 CAPTURE                          UPVAL U0
       82 SETTABLE                         R5 R3 R4
       83 GETUPVAL                         R4 1
       84 GETTABLEKS                       R4 R4 K18 ["BreakpointsColumnsEdited"]
       86 NEWCLOSURE                       R5 P3
       87 CAPTURE                          VAL R0
       88 CAPTURE                          UPVAL U0
       89 SETTABLE                         R5 R3 R4
       90 GETUPVAL                         R4 1
       91 GETTABLEKS                       R4 R4 K19 ["CallstackColumnsEdited"]
       93 NEWCLOSURE                       R5 P4
       94 CAPTURE                          VAL R0
       95 CAPTURE                          UPVAL U0
       96 SETTABLE                         R5 R3 R4
       97 GETUPVAL                         R4 1
       98 GETTABLEKS                       R4 R4 K20 ["VariablesColumnsEdited"]
      100 NEWCLOSURE                       R5 P5
      101 CAPTURE                          VAL R0
      102 CAPTURE                          UPVAL U0
      103 SETTABLE                         R5 R3 R4
      104 GETUPVAL                         R4 1
      105 GETTABLEKS                       R4 R4 K21 ["MyWatchesColumnsEdited"]
...
MAIN:
       ...
       15 GETTABLEKS                       R2 R2 K7 ["AnalyticsEventNames"]
       17 CALL                             R1 1 1
