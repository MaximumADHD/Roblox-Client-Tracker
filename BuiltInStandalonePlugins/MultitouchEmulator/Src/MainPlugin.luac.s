...
MAIN:
  ...
  CALL R15 1 1
  GETTABLEKS R16 R15 K32 ["getFFlagEnableRibbonPlugin"]
  CALL R16 0 1
  GETTABLEKS R17 R15 K33 ["getFFlagRegisterActionsPluginLoader"]
  CALL R17 0 1
  AND R18 R17 R16
  GETTABLEKS R19 R1 K34 ["PureComponent"]
  LOADK R21 K35 ["MainPlugin"]
  NAMECALL R19 R19 K36 ["extend"]
  CALL R19 2 1
  GETTABLEKS R20 R11 K37 ["fromAction"]
  LOADK R21 K2 ["MultitouchEmulator"]
  LOADK R22 K38 ["Toggle"]
  CALL R20 2 1
  DUPCLOSURE R21 K39 [PROTO_12]
  CAPTURE VAL R18
  CAPTURE VAL R20
  CAPTURE VAL R6
  CAPTURE VAL R13
  ...
  CAPTURE VAL R3
  CAPTURE VAL R12
  SETTABLEKS R21 R19 K40 ["init"]
  DUPCLOSURE R21 K41 [PROTO_13]
  CAPTURE VAL R18
  SETTABLEKS R21 R19 K42 ["didUpdate"]
  DUPCLOSURE R21 K43 [PROTO_14]
  CAPTURE VAL R6
  CAPTURE VAL R7
  CAPTURE VAL R8
  CAPTURE VAL R9
  CAPTURE VAL R1
  CAPTURE VAL R5
  SETTABLEKS R21 R19 K44 ["render"]
  DUPCLOSURE R21 K45 [PROTO_15]
  SETTABLEKS R21 R19 K46 ["willUnmount"]
  RETURN R19 1
