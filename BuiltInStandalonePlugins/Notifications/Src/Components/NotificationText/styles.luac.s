MAIN:
  ...
  LOADK R10 K32 ["$CardSubjectTextSize"]
  SETTABLEKS R10 R9 K21 ["TextSize"]
  GETIMPORT R10 K34 [Enum.Font.SourceSans]
  SETTABLEKS R10 R9 K22 ["Font"]
  LOADB R10 1
  SETTABLEKS R10 R9 K23 ["TextWrapped"]
  GETIMPORT R10 K36 [Enum.TextTruncate.AtEnd]
  SETTABLEKS R10 R9 K24 ["TextTruncate"]
  GETIMPORT R10 K38 [Enum.TextXAlignment.Left]
  SETTABLEKS R10 R9 K25 ["TextXAlignment"]
  GETIMPORT R10 K40 [Enum.TextYAlignment.Top]
  SETTABLEKS R10 R9 K26 ["TextYAlignment"]
  NEWTABLE R10 0 1
  MOVE R11 R2
  LOADK R12 K41 ["::UISizeConstraint"]
  DUPTABLE R13 K44 [{"MaxSize", "MinSize"}]
  GETIMPORT R14 K46 [Vector2.new]
  LOADK R15 K47 [∞]
  LOADN R16 36
  CALL R14 2 1
  SETTABLEKS R14 R13 K42 ["MaxSize"]
  GETIMPORT R14 K46 [Vector2.new]
  LOADN R15 0
  LOADN R16 18
  CALL R14 2 1
  SETTABLEKS R14 R13 K43 ["MinSize"]
  CALL R11 2 -1
  SETLIST R10 R11 -1 [1]
  CALL R7 3 1
  MOVE R8 R2
  LOADK R9 K48 ["> #Subline"]
  DUPTABLE R10 K49 [{"Size", "AutomaticSize", "BackgroundTransparency", "TextColor3", "TextSize", "Font", "TextWrapped", "TextTruncate", "TextXAlignment", "TextYAlignment"}]
  ...
  CALL R8 3 1
  MOVE R9 R2
  LOADK R10 K51 ["> #ElapsedTime"]
  DUPTABLE R11 K52 [{"Size", "AutomaticSize", "BackgroundTransparency", "TextColor3", "TextSize", "Font", "TextTruncate", "TextXAlignment", "TextYAlignment"}]
  ...
  LOADK R12 K50 ["$TextSecondary"]
  SETTABLEKS R12 R11 K20 ["TextColor3"]
  LOADN R12 15
  SETTABLEKS R12 R11 K21 ["TextSize"]
  GETIMPORT R12 K34 [Enum.Font.SourceSans]
  ...
  GETIMPORT R12 K40 [Enum.TextYAlignment.Top]
