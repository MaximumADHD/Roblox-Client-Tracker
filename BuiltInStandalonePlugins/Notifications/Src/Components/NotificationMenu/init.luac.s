...
PROTO_1:
        0 GETUPVAL                         R0 0
        1 GETUPVAL                         R1 1
        2 GETTABLEKS                       R1 R1 K0 ["MENU_OPTIONS"]
        4 NEWCLOSURE                       R2 P0
        5 CAPTURE                          UPVAL U2
        6 CALL                             R0 2 -1
        7 RETURN                           R0 -1
...
PROTO_2:
        0 GETUPVAL                         R3 0
        1 GETUPVAL                         R5 1
        2 LOADK                            R7 K0 ["Header"]
        3 MOVE                             R8 R1
        4 NAMECALL                         R5 R5 K1 ["getText"]
        6 CALL                             R5 3 1
        7 GETUPVAL                         R6 2
        8 GETTABLEKS                       R6 R6 K2 ["TEXT_SIZE"]
       10 GETUPVAL                         R7 2
       11 GETTABLEKS                       R7 R7 K3 ["TEXT_FONT"]
       13 GETIMPORT                        R8 K6 [Vector2.new]
       15 LOADK                            R9 K7 [∞]
       16 LOADK                            R10 K7 [∞]
       17 CALL                             R8 2 -1
       18 NAMECALL                         R3 R3 K8 ["GetTextSize"]
       20 CALL                             R3 -1 1
       21 GETTABLEKS                       R3 R3 K9 ["X"]
       23 GETUPVAL                         R4 2
       24 GETTABLEKS                       R4 R4 K10 ["TEXT_WIDTH_PADDING"]
       26 ADD                              R2 R3 R4
...
PROTO_4:
        0 GETUPVAL                         R1 0
        1 GETUPVAL                         R3 1
        2 GETTABLEKS                       R3 R3 K1 ["BORDER_SIZE"]
        4 MULK                             R2 R3 K0 [2]
        5 SUB                              R0 R1 R2
        6 RETURN                           R0 1
...
PROTO_6:
        ...
        2 GETUPVAL                         R1 0
        3 GETTABLEKS                       R1 R1 K1 ["OnMarkAllAsReadClicked"]
        5 RETURN                           R1 1
        6 JUMPIFNOTEQKS                    R0 K2 ["Settings"] ; [+5]
        8 GETUPVAL                         R1 0
        9 GETTABLEKS                       R1 R1 K3 ["OnSettingsClicked"]
       11 RETURN                           R1 1
       12 NEWCLOSURE                       R1 P0
       13 CAPTURE                          VAL R0
       14 RETURN                           R1 1
...
PROTO_7:
       ...
       15 LOADN                            R8 0
       16 GETUPVAL                         R9 2
       17 GETTABLEKS                       R9 R9 K7 ["BUTTON_HEIGHT"]
       19 CALL                             R5 4 1
       ...
       30 GETUPVAL                         R5 0
       31 GETTABLEKS                       R5 R5 K12 ["Event"]
       33 GETTABLEKS                       R5 R5 K13 ["MouseButton1Click"]
       35 GETUPVAL                         R6 4
       36 MOVE                             R7 R0
       37 CALL                             R6 1 1
       38 SETTABLE                         R6 R4 R5
       39 GETUPVAL                         R5 0
       40 GETTABLEKS                       R5 R5 K14 ["Tag"]
...
PROTO_8:
       ...
       26 CALL                             R3 2 1
       27 GETUPVAL                         R4 1
       28 GETTABLEKS                       R4 R4 K1 ["useMemo"]
       30 NEWCLOSURE                       R5 P2
       31 CAPTURE                          VAL R3
       32 CAPTURE                          UPVAL U3
       33 NEWTABLE                         R6 0 1
       ...
       38 CALL                             R4 2 1
       39 GETUPVAL                         R5 1
       40 GETTABLEKS                       R5 R5 K2 ["useCallback"]
       42 NEWCLOSURE                       R6 P3
       43 CAPTURE                          VAL R0
       44 NEWTABLE                         R7 0 2
       ...
       62 NEWTABLE                         R9 0 1
       64 GETUPVAL                         R10 1
       65 GETTABLEKS                       R10 R10 K5 ["createElement"]
       ...
       90 LOADN                            R16 0
       91 GETUPVAL                         R17 3
       92 GETTABLEKS                       R17 R17 K17 ["TOTAL_MENU_HEIGHT"]
       94 CALL                             R13 4 1
       95 SETTABLEKS                       R13 R12 K18 ["Size"]
       97 GETUPVAL                         R13 1
       98 GETTABLEKS                       R13 R13 K19 ["Tag"]
      ...
      119 LOADN                            R18 0
      120 GETUPVAL                         R19 3
      121 GETTABLEKS                       R19 R19 K21 ["BORDER_SIZE"]
      123 LOADN                            R20 0
      124 GETUPVAL                         R21 3
      125 GETTABLEKS                       R21 R21 K21 ["BORDER_SIZE"]
      127 CALL                             R17 4 1
      ...
      134 LOADN                            R20 0
      135 GETUPVAL                         R21 3
      136 GETTABLEKS                       R21 R21 K22 ["INNER_MENU_HEIGHT"]
      138 CALL                             R17 4 1
      139 SETTABLEKS                       R17 R16 K18 ["Size"]
      141 GETUPVAL                         R17 1
      142 GETTABLEKS                       R17 R17 K19 ["Tag"]
      144 LOADK                            R18 K23 ["Component-NotificationMenuInner"]
      145 SETTABLE                         R18 R16 R17
      146 GETUPVAL                         R17 2
      147 GETUPVAL                         R18 3
      148 GETTABLEKS                       R18 R18 K24 ["MENU_OPTIONS"]
...
MAIN:
       ...
       34 GETTABLEKS                       R6 R2 K11 ["ContextServices"]
       36 GETTABLEKS                       R6 R6 K12 ["Localization"]
       38 GETTABLEKS                       R7 R2 K13 ["UI"]
       40 GETTABLEKS                       R7 R7 K14 ["CaptureFocus"]
       42 GETIMPORT                        R8 K16 [game]
       44 LOADK                            R10 K17 ["TextService"]
       45 NAMECALL                         R8 R8 K18 ["GetService"]
       47 CALL                             R8 2 1
       48 GETIMPORT                        R9 K4 [require]
       50 GETTABLEKS                       R10 R0 K19 ["Src"]
       52 GETTABLEKS                       R10 R10 K20 ["Components"]
       54 GETTABLEKS                       R10 R10 K21 ["NotificationMenu"]
       56 GETTABLEKS                       R10 R10 K22 ["constants"]
       58 CALL                             R9 1 1
