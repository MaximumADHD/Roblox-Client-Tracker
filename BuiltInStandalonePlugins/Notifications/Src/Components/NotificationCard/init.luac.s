...
PROTO_9:
  ...
  DUPTABLE R30 K37 [{"Icon", "Content", "StatusIndicator", "Status"}]
  GETUPVAL R32 1
  GETTABLEKS R31 R32 K17 ["createElement"]
  LOADK R32 K38 ["ImageLabel"]
  NEWTABLE R33 4 0
  SETTABLEKS R17 R33 K39 ["Image"]
  LOADN R34 1
  ...
  LOADK R37 K40 ["%*"]
  MOVE R39 R18
  NAMECALL R37 R37 K41 ["format"]
  CALL R37 2 1
  MOVE R36 R37
  GETUPVAL R39 3
  GETTABLEKS R38 R39 K42 ["User"]
  JUMPIFNOTEQ R11 R38 [+3]
  LOADK R37 K43 ["Component-NotificationCard-User"]
  JUMP [+1]
  LOADNIL R37
  CALL R35 2 1
  ...
  GETTABLEKS R31 R32 K17 ["createElement"]
  GETUPVAL R32 14
  DUPTABLE R33 K47 [{"Subject", "Subline", "ElapsedTime", "LayoutOrder"}]
  SETTABLEKS R19 R33 K44 ["Subject"]
  SETTABLEKS R4 R33 K45 ["Subline"]
  SETTABLEKS R15 R33 K46 ["ElapsedTime"]
  LOADN R34 2
  SETTABLEKS R34 R33 K19 ["LayoutOrder"]
  CALL R31 2 1
  ...
  GETUPVAL R35 1
  GETTABLEKS R34 R35 K20 ["Tag"]
  LOADK R35 K48 ["X-Middle"]
  SETTABLE R35 R33 R34
  LOADN R34 3
  SETTABLEKS R34 R33 K19 ["LayoutOrder"]
  DUPTABLE R34 K50 [{"Indicator"}]
  GETUPVAL R36 1
  GETTABLEKS R35 R36 K17 ["createElement"]
  LOADK R36 K38 ["ImageLabel"]
  NEWTABLE R37 2 0
  GETIMPORT R38 K53 [UDim2.new]
  LOADN R39 0
  LOADN R40 0
  LOADK R41 K54 [0.5]
  LOADN R42 0
  ...
  SETTABLE R20 R37 R38
  CALL R35 2 1
  SETTABLEKS R35 R34 K49 ["Indicator"]
  CALL R31 3 1
  JUMP [+1]
  LOADNIL R31
  ...
  GETTABLEKS R31 R32 K17 ["createElement"]
  GETUPVAL R32 16
  DUPTABLE R33 K57 [{"LayoutOrder", "ReadStatusIconTag", "ElapsedTime"}]
  LOADN R34 3
  SETTABLEKS R34 R33 K19 ["LayoutOrder"]
  SETTABLEKS R20 R33 K56 ["ReadStatusIconTag"]
  SETTABLEKS R15 R33 K46 ["ElapsedTime"]
  CALL R31 2 1
  JUMP [+1]
  LOADNIL R31
  SETTABLEKS R31 R30 K36 ["Status"]
  CALL R27 3 1
...
MAIN:
  ...
  GETTABLEKS R7 R8 K14 ["NotificationStatus"]
  CALL R6 1 1
  GETIMPORT R7 K4 [require]
  GETTABLEKS R10 R0 K15 ["Src"]
  GETTABLEKS R9 R10 K16 ["Clients"]
  GETTABLEKS R8 R9 K17 ["NotificationClient"]
  CALL R7 1 1
  GETIMPORT R8 K4 [require]
  GETTABLEKS R11 R0 K15 ["Src"]
  GETTABLEKS R10 R11 K18 ["Contexts"]
  GETTABLEKS R9 R10 K19 ["NotificationsContext"]
  CALL R8 1 1
  GETIMPORT R9 K4 [require]
  GETTABLEKS R12 R0 K15 ["Src"]
  GETTABLEKS R11 R12 K18 ["Contexts"]
  GETTABLEKS R10 R11 K20 ["AnalyticsContext"]
  CALL R9 1 1
  GETIMPORT R10 K4 [require]
  GETTABLEKS R13 R0 K15 ["Src"]
  GETTABLEKS R12 R13 K18 ["Contexts"]
  GETTABLEKS R11 R12 K21 ["MenuVisibleContext"]
  CALL R10 1 1
  GETIMPORT R11 K4 [require]
  GETTABLEKS R14 R0 K15 ["Src"]
  GETTABLEKS R13 R14 K22 ["Enums"]
  GETTABLEKS R12 R13 K23 ["NotificationTargetType"]
  CALL R11 1 1
  GETIMPORT R12 K4 [require]
  GETTABLEKS R16 R0 K15 ["Src"]
  GETTABLEKS R15 R16 K24 ["Util"]
  GETTABLEKS R14 R15 K25 ["SharedFlags"]
  GETTABLEKS R13 R14 K26 ["getFFlagNotificationRedesignM1Q42025"]
  CALL R12 1 1
  GETIMPORT R13 K4 [require]
  GETTABLEKS R16 R0 K15 ["Src"]
  GETTABLEKS R15 R16 K24 ["Util"]
  GETTABLEKS R14 R15 K27 ["IconGetters"]
  CALL R13 1 1
  GETTABLEKS R14 R13 K28 ["getDynamicIconPath"]
  GETTABLEKS R15 R13 K29 ["getReadStatusIconTag"]
  GETTABLEKS R16 R13 K30 ["getStaticIconTag"]
  GETIMPORT R17 K4 [require]
  GETTABLEKS R20 R0 K15 ["Src"]
  GETTABLEKS R19 R20 K24 ["Util"]
  GETTABLEKS R18 R19 K31 ["interpolateNotificationSubject"]
  CALL R17 1 1
  GETIMPORT R18 K4 [require]
  GETTABLEKS R21 R0 K15 ["Src"]
  GETTABLEKS R20 R21 K24 ["Util"]
  GETTABLEKS R19 R20 K32 ["useRelativeTime"]
  CALL R18 1 1
  GETIMPORT R19 K4 [require]
  GETTABLEKS R22 R0 K15 ["Src"]
  GETTABLEKS R21 R22 K24 ["Util"]
  GETTABLEKS R20 R21 K33 ["optional"]
  CALL R19 1 1
  GETIMPORT R20 K4 [require]
  GETTABLEKS R23 R0 K15 ["Src"]
  GETTABLEKS R22 R23 K24 ["Util"]
  GETTABLEKS R21 R22 K34 ["TimeConstants"]
  CALL R20 1 1
