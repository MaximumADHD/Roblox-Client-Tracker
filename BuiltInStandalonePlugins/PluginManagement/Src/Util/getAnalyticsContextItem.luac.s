...
PROTO_7:
        ...
        6 CAPTURE                          VAL R1
        7 CAPTURE                          VAL R0
        8 DUPTABLE                         R4 K4 [{"TryUpdatePlugin", "TryUpdateAllPlugins", "UpdatePluginSuccess", "UpdatePluginFailure"}]
        9 NEWCLOSURE                       R5 P3
       10 CAPTURE                          VAL R1
       11 CAPTURE                          VAL R0
       12 SETTABLEKS                       R5 R4 K0 ["TryUpdatePlugin"]
       14 NEWCLOSURE                       R5 P4
       15 CAPTURE                          VAL R1
       16 CAPTURE                          VAL R0
       17 SETTABLEKS                       R5 R4 K1 ["TryUpdateAllPlugins"]
       19 NEWCLOSURE                       R5 P5
       20 CAPTURE                          VAL R1
       21 CAPTURE                          VAL R0
       22 SETTABLEKS                       R5 R4 K2 ["UpdatePluginSuccess"]
       24 NEWCLOSURE                       R5 P6
       25 CAPTURE                          VAL R1
       26 CAPTURE                          VAL R0
       27 SETTABLEKS                       R5 R4 K3 ["UpdatePluginFailure"]
       29 RETURN                           R4 1
...
PROTO_8:
        ...
        4 GETTABLEKS                       R1 R1 K2 ["new"]
        6 DUPCLOSURE                       R2 K3 [PROTO_7]
        7 CAPTURE                          UPVAL U1
        8 MOVE                             R3 R0
        9 CALL                             R1 2 -1
       10 RETURN                           R1 -1
