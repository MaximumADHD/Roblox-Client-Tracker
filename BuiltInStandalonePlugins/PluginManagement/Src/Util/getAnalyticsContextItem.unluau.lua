...
return function()
   return var2.Analytics.new(function(arg1)
      local function var0(arg1, arg2)
         arg2 = arg2 or {}
         local var363 = {}
         var363.studioSid = arg1:GetSessionId()
         local var369 = arg1:GetClientId()
         var363.clientId = var369
         var369 = arg2
         arg1:SendEventDeferred("studio", "PluginManagement", arg1, var1.Dictionary.join(var363, var369))
      end
