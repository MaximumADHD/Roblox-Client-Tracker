...
PROTO_22:
  ...
  GETUPVAL R11 3
  GETTABLEKS R10 R11 K5 ["fflagAnnotationsReflectPreselectedThread"]
  JUMPIFNOT R10 [+6]
  GETTABLEKS R10 R5 K6 ["Selected"]
  JUMPIFNOT R10 [+3]
  GETTABLEKS R9 R5 K6 ["Selected"]
  JUMP [+1]
  LOADNIL R9
  CALL R8 1 2
  GETUPVAL R11 0
  ...
  GETUPVAL R11 4
  CALL R10 1 1
  GETTABLEKS R11 R10 K8 ["isTagDropdownOpen"]
  GETUPVAL R13 0
  ...
  CALL R15 1 1
  GETUPVAL R18 3
  GETTABLEKS R17 R18 K10 ["fflagCOLLAB8949AnnotationsAddPluginTelemetry"]
  JUMPIFNOT R17 [+5]
  GETUPVAL R16 8
  ...
  CALL R17 2 0
  GETUPVAL R18 0
  GETTABLEKS R17 R18 K9 ["useRef"]
  LOADB R18 0
  CALL R17 1 1
  LOADB R18 0
  SETTABLEKS R18 R17 K12 ["current"]
  GETUPVAL R19 0
  ...
  GETUPVAL R20 23
  DUPTABLE R21 K15 [{"GameId"}]
  GETIMPORT R23 K17 [game]
  GETTABLEKS R22 R23 K14 ["GameId"]
  SETTABLEKS R22 R21 K14 ["GameId"]
  DUPTABLE R22 K19 [{"Manager"}]
  GETUPVAL R24 0
  ...
  GETUPVAL R28 0
  GETTABLEKS R27 R28 K26 ["Event"]
  GETTABLEKS R26 R27 K27 ["MouseMoved"]
  NEWCLOSURE R27 P4
  CAPTURE VAL R5
  CAPTURE UPVAL U13
  CAPTURE VAL R14
  ...
  GETUPVAL R28 0
  GETTABLEKS R27 R28 K26 ["Event"]
  GETTABLEKS R26 R27 K28 ["MouseLeave"]
  NEWCLOSURE R27 P5
  CAPTURE VAL R14
  SETTABLE R27 R25 R26
  DUPTABLE R26 K30 [{"Element"}]
  MOVE R27 R18
  CALL R27 0 1
  SETTABLEKS R27 R26 K29 ["Element"]
  CALL R23 3 1
  SETTABLEKS R23 R22 K18 ["Manager"]
  CALL R19 3 -1
  RETURN R19 -1
