...
PROTO_8:
  ...
  CALL R1 2 1
  GETUPVAL R2 4
  LOADK R4 K11 ["Selected"]
  NAMECALL R2 R2 K12 ["GetPropertyChangedSignal"]
  CALL R2 2 1
  NEWCLOSURE R4 P2
  CAPTURE UPVAL U1
  CAPTURE UPVAL U3
  ...
  CALL R2 2 1
  GETUPVAL R4 2
  GETTABLEKS R3 R4 K13 ["Deactivation"]
  NEWCLOSURE R5 P3
  CAPTURE UPVAL U5
  CAPTURE UPVAL U6
  CAPTURE UPVAL U3
  ...
  CALL R3 2 1
  GETUPVAL R5 5
  GETTABLEKS R4 R5 K14 ["Button1Down"]
  NEWCLOSURE R6 P4
  CAPTURE UPVAL U1
  CAPTURE UPVAL U3
  CAPTURE UPVAL U8
...
PROTO_12:
  ...
  GETUPVAL R3 3
  MOVE R6 R1
  NAMECALL R4 R3 K1 ["createAnnotation"]
  CALL R4 2 0
  GETUPVAL R5 4
  GETTABLEKS R4 R5 K1 ["createAnnotation"]
  MOVE R5 R2
  MOVE R6 R1
  CALL R4 2 0
  RETURN R0 0
...
PROTO_13:
  ...
  GETUPVAL R0 0
  GETUPVAL R2 1
  GETTABLEKS R1 R2 K17 ["Selected"]
  JUMPIFNOTEQ R0 R1 [+54]
  GETUPVAL R1 10
  ...
  GETTABLEKS R1 R2 K1 ["createElement"]
  GETUPVAL R2 11
  DUPTABLE R3 K23 [{"Position", "Annotation", "OnCancel", "OnReply"}]
  GETIMPORT R4 K14 [UDim2.fromOffset]
  GETTABLEKS R5 R0 K15 ["X"]
  GETTABLEKS R6 R0 K16 ["Y"]
  CALL R4 2 1
  SETTABLEKS R4 R3 K7 ["Position"]
  GETUPVAL R4 10
  SETTABLEKS R4 R3 K21 ["Annotation"]
  NEWCLOSURE R4 P2
  CAPTURE UPVAL U8
  CAPTURE UPVAL U12
  CAPTURE UPVAL U1
...
PROTO_14:
  ...
  LOADK R10 K7 ["AnnotationsService"]
  ...
  LOADK R11 K11 ["Frame"]
  DUPTABLE R12 K14 [{"BackgroundTransparency", "ref"}]
  LOADN R13 1
  SETTABLEKS R13 R12 K12 ["BackgroundTransparency"]
  SETTABLEKS R4 R12 K13 ["ref"]
  DUPTABLE R13 K16 [{"Element"}]
  MOVE R14 R9
  CALL R14 0 1
  SETTABLEKS R14 R13 K15 ["Element"]
  CALL R10 3 -1
  RETURN R10 -1
