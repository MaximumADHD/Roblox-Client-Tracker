...
PROTO_1:
       ...
       21 GETTABLEKS                       R6 R1 K2 ["HeaderInfo"]
       23 GETTABLEKS                       R6 R6 K3 ["HeaderText"]
       25 NAMECALL                         R3 R2 K4 ["SetAttribute"]
       27 CALL                             R3 3 0
       28 LOADK                            R5 K5 ["AdorneeClass"]
       29 GETTABLEKS                       R6 R1 K2 ["HeaderInfo"]
       31 GETTABLEKS                       R6 R6 K5 ["AdorneeClass"]
...
PROTO_5:
       ...
       31 JUMPIFNOT                        R5 ; [+10]
       32 GETTABLEKS                       R4 R0 K10 ["MultipleDocumentInterfaceInstance"]
       34 GETTABLEKS                       R4 R4 K11 ["DataModelSessionEnded"]
...
PROTO_6:
        ...
        2 GETUPVAL                         R3 1
        3 GETTABLEKS                       R3 R3 K0 ["AnnotationsLoadingStatus"]
...
PROTO_7:
        ...
        2 GETUPVAL                         R3 1
        3 GETTABLEKS                       R3 R3 K0 ["ResolvedLoadingStatus"]
        5 NAMECALL                         R0 R0 K1 ["SetItem"]
        7 CALL                             R0 3 0
        8 RETURN                           R0 0
...
PROTO_8:
        ...
        9 GETUPVAL                         R0 1
       10 GETUPVAL                         R1 2
       11 GETTABLEKS                       R1 R1 K2 ["PlacingNew"]
       13 SETTABLEKS                       R1 R0 K3 ["Mode"]
       15 GETIMPORT                        R0 K5 [game]
       17 GETTABLEKS                       R0 R0 K6 ["CoreGui"]
...
PROTO_9:
        ...
        7 GETUPVAL                         R0 1
        8 GETUPVAL                         R1 2
        9 GETTABLEKS                       R1 R1 K3 ["None"]
       11 SETTABLEKS                       R1 R0 K4 ["Mode"]
       13 GETIMPORT                        R0 K6 [game]
       15 GETTABLEKS                       R0 R0 K7 ["CoreGui"]
...
PROTO_17:
        0 GETUPVAL                         R0 0
        1 GETTABLEKS                       R0 R0 K0 ["AnnotationsLoadingStatus"]
        3 GETUPVAL                         R1 1
        4 GETTABLEKS                       R1 R1 K1 ["Loading"]
        6 JUMPIFEQ                         R0 R1 ; [+11]
        8 GETUPVAL                         R1 1
        9 GETTABLEKS                       R1 R1 K2 ["Success"]
       11 JUMPIFEQ                         R0 R1 ; [+6]
       13 GETUPVAL                         R1 0
       14 LOADB                            R3 0
       ...
       21 GETUPVAL                         R1 1
       22 GETTABLEKS                       R1 R1 K1 ["Loading"]
       24 JUMPIFEQ                         R0 R1 ; [+11]
       26 GETUPVAL                         R1 1
       27 GETTABLEKS                       R1 R1 K2 ["Success"]
       29 JUMPIFEQ                         R0 R1 ; [+6]
       31 GETUPVAL                         R1 0
       32 LOADB                            R3 1
...
PROTO_19:
        ...
        1 GETUPVAL                         R4 0
        2 GETTABLEKS                       R4 R4 K0 ["AnnotationsLoadingStatus"]
        4 NAMECALL                         R1 R0 K1 ["SetItem"]
        6 CALL                             R1 3 0
        7 LOADK                            R3 K2 ["ResolvedLoadingStatus"]
        8 GETUPVAL                         R4 0
        9 GETTABLEKS                       R4 R4 K2 ["ResolvedLoadingStatus"]
...
MAIN:
       ...
       13 GETTABLEKS                       R2 R2 K8 ["AnnotationEditingMode"]
       15 CALL                             R1 1 1
       ...
       29 GETTABLEKS                       R4 R4 K11 ["zoomToAnnotation"]
       31 CALL                             R3 1 1
       32 GETIMPORT                        R4 K5 [require]
       34 GETTABLEKS                       R5 R0 K6 ["Src"]
       36 GETTABLEKS                       R5 R5 K10 ["Util"]
       38 GETTABLEKS                       R5 R5 K12 ["selectAnnotation"]
       40 CALL                             R4 1 1
       41 GETIMPORT                        R5 K5 [require]
       43 GETTABLEKS                       R6 R0 K6 ["Src"]
       45 GETTABLEKS                       R6 R6 K7 ["Enums"]
       47 GETTABLEKS                       R6 R6 K13 ["AnnotationRequestStatus"]
       49 CALL                             R5 1 1
