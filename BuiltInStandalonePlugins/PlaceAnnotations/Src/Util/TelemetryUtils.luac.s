...
MAIN:
       ...
       24 CALL                             R2 1 1
       25 DUPTABLE                         R3 K21 [{["eventName"] = "StudioAnnotationsAction", ["backends"], ["throttlingPercentage"], ["lastUpdated"], ["description"] = "Reports when a Studio annotation/comment popup or the annotations plugin widget is opened/closed, including: \n- action name “Plugin” for plugin widget, “Popover” for existing comment popover, “Popup” for new adding comment popup\n- concatenated with \"Open\" or \"Close\" depending on the action taken", ["links"] = "https://roblox.atlassian.net/wiki/x/RoGF4"}]
       26 NEWTABLE                         R4 0 2
       28 LOADK                            R5 K22 ["EventIngest"]
       29 LOADK                            R6 K23 ["Points"]
       30 SETLIST                          R4 R5 2 [1]
       32 SETTABLEKS                       R4 R3 K14 ["backends"]
       34 GETTABLEKS                       R4 R2 K24 ["fintAnnotationsPluginActionThrottleHundredthsPercent"]
       36 SETTABLEKS                       R4 R3 K15 ["throttlingPercentage"]
       38 NEWTABLE                         R4 0 3
       40 LOADN                            R5 25
       41 LOADN                            R6 7
       42 LOADN                            R7 31
       43 SETLIST                          R4 R5 3 [1]
       45 SETTABLEKS                       R4 R3 K16 ["lastUpdated"]
       47 DUPCLOSURE                       R4 K25 [PROTO_0]
       48 CAPTURE                          VAL R1
       49 DUPTABLE                         R5 K28 [{"getTelemetryEvent", "AnnotationsPluginActionEvent"}]
       50 SETTABLEKS                       R4 R5 K26 ["getTelemetryEvent"]
       52 SETTABLEKS                       R3 R5 K27 ["AnnotationsPluginActionEvent"]
       54 RETURN                           R5 1
