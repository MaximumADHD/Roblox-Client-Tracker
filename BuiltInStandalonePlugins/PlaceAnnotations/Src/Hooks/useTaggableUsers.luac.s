...
PROTO_1:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R2 R2 K0 ["DeserializePermissions"]
        3 MOVE                             R3 R0
       ...
       15 GETUPVAL                         R7 1
       16 GETTABLEKS                       R7 R7 K6 ["UserSubjectKey"]
       18 GETTABLE                         R5 R2 R7
       19 CALL                             R4 1 3
       20 FORGPREP_NEXT                    R4
       21 GETUPVAL                         R10 1
       22 GETTABLEKS                       R10 R10 K7 ["SubjectNameKey"]
       ...
       39 GETUPVAL                         R7 1
       40 GETTABLEKS                       R7 R7 K11 ["GroupSubject"]
       42 JUMPIFNOTEQ                      R6 R7 ; [+35]
       44 GETIMPORT                        R6 K5 [pairs]
       46 GETUPVAL                         R9 1
       47 GETTABLEKS                       R9 R9 K12 ["RoleSubjectKey"]
       ...
       62 JUMPIFNOT                        R6 ; [+15]
       63 GETUPVAL                         R7 2
       64 GETTABLEKS                       R7 R7 K15 ["getAllUsersInRolesets"]
       66 MOVE                             R8 R6
       67 GETUPVAL                         R9 3
       68 GETTABLEKS                       R9 R9 K16 ["Dictionary"]
       70 GETTABLEKS                       R9 R9 K17 ["keys"]
       72 MOVE                             R10 R5
       73 CALL                             R9 1 1
       74 LOADN                            R10 0
       75 CALL                             R7 3 1
       ...
       77 SETUPVAL                         R4 4
       78 GETUPVAL                         R6 3
       79 GETTABLEKS                       R6 R6 K16 ["Dictionary"]
       81 GETTABLEKS                       R6 R6 K18 ["join"]
       83 MOVE                             R7 R3
       84 MOVE                             R8 R4
       85 CALL                             R6 2 1
       86 LOADB                            R7 1
...
PROTO_2:
       ...
       13 JUMPIFNOT                        R6 ; [+26]
       14 GETUPVAL                         R6 3
       15 GETTABLEKS                       R6 R6 K2 ["userHasRoleset"]
       17 GETUPVAL                         R7 2
       ...
       42 GETUPVAL                         R1 5
       43 GETUPVAL                         R2 6
       44 GETTABLEKS                       R2 R2 K8 ["Dictionary"]
       46 GETTABLEKS                       R2 R2 K9 ["join"]
       48 MOVE                             R3 R0
       49 GETUPVAL                         R4 7
       50 CALL                             R2 2 -1
       51 CALL                             R1 -1 0
...
PROTO_3:
       ...
       22 GETUPVAL                         R2 3
       23 GETTABLEKS                       R2 R2 K4 ["GroupSubject"]
       ...
       37 GETUPVAL                         R4 5
       38 GETTABLEKS                       R4 R4 K6 ["Dictionary"]
       40 GETTABLEKS                       R4 R4 K7 ["values"]
       42 GETUPVAL                         R5 6
       43 CALL                             R4 1 1
       44 LENGTH                           R3 R4
       ...
       83 CALL                             R6 1 0
       84 GETUPVAL                         R7 5
       85 GETTABLEKS                       R7 R7 K6 ["Dictionary"]
       87 GETTABLEKS                       R7 R7 K7 ["values"]
       89 MOVE                             R8 R2
       90 CALL                             R7 1 1
       91 LENGTH                           R6 R7
       92 LOADN                            R7 5000
      ...
      105 GETUPVAL                         R7 3
      106 GETTABLEKS                       R7 R7 K4 ["GroupSubject"]
      ...
      127 GETUPVAL                         R12 16
      128 GETTABLEKS                       R12 R12 K14 ["userHasRoleset"]
      ...
      141 GETUPVAL                         R7 17
      142 GETUPVAL                         R8 5
      143 GETTABLEKS                       R8 R8 K6 ["Dictionary"]
      145 GETTABLEKS                       R8 R8 K16 ["join"]
      147 GETUPVAL                         R9 15
      148 MOVE                             R10 R6
      149 CALL                             R8 2 -1
      150 CALL                             R7 -1 0
...
PROTO_5:
       ...
       15 CALL                             R7 1 2
       16 GETUPVAL                         R9 0
       17 GETTABLEKS                       R9 R9 K0 ["useState"]
       19 NEWTABLE                         R10 0 0
       21 CALL                             R9 1 2
       22 GETUPVAL                         R11 0
       23 GETTABLEKS                       R11 R11 K0 ["useState"]
       25 NEWTABLE                         R12 0 0
       27 CALL                             R11 1 2
       28 GETUPVAL                         R13 0
       29 GETTABLEKS                       R13 R13 K0 ["useState"]
       31 LOADB                            R14 0
       32 CALL                             R13 1 2
       33 GETUPVAL                         R15 0
       34 GETTABLEKS                       R15 R15 K1 ["useEffect"]
       ...
       50 CALL                             R15 2 0
       51 GETUPVAL                         R15 0
       52 GETTABLEKS                       R15 R15 K1 ["useEffect"]
       ...
       80 CALL                             R15 2 0
       81 GETUPVAL                         R15 2
       82 GETTABLEKS                       R15 R15 K2 ["Dictionary"]
       84 GETTABLEKS                       R15 R15 K3 ["join"]
       86 MOVE                             R16 R3
       87 MOVE                             R17 R9
       88 CALL                             R15 2 1
       89 MOVE                             R16 R15
...
MAIN:
       ...
       25 GETTABLEKS                       R4 R4 K10 ["Networking"]
       27 GETTABLEKS                       R4 R4 K11 ["DeserializeFromRequest"]
       29 CALL                             R3 1 1
       30 GETTABLEKS                       R3 R3 K12 ["Deserialize"]
       32 GETIMPORT                        R4 K5 [require]
       34 GETTABLEKS                       R5 R0 K9 ["Src"]
       36 GETTABLEKS                       R5 R5 K10 ["Networking"]
       38 GETTABLEKS                       R5 R5 K13 ["Requests"]
       40 GETTABLEKS                       R5 R5 K14 ["GetUniverseMetadata"]
       42 CALL                             R4 1 1
       43 GETIMPORT                        R5 K5 [require]
       45 GETTABLEKS                       R6 R0 K9 ["Src"]
       47 GETTABLEKS                       R6 R6 K10 ["Networking"]
       49 GETTABLEKS                       R6 R6 K13 ["Requests"]
       51 GETTABLEKS                       R6 R6 K15 ["GetPermissions"]
       53 CALL                             R5 1 1
       54 GETIMPORT                        R6 K5 [require]
       56 GETTABLEKS                       R7 R0 K9 ["Src"]
       58 GETTABLEKS                       R7 R7 K10 ["Networking"]
       60 GETTABLEKS                       R7 R7 K13 ["Requests"]
       62 GETTABLEKS                       R7 R7 K16 ["GetGroupInfo"]
       64 CALL                             R6 1 1
       65 GETIMPORT                        R7 K5 [require]
       67 GETTABLEKS                       R8 R0 K9 ["Src"]
       69 GETTABLEKS                       R8 R8 K17 ["Util"]
       71 GETTABLEKS                       R8 R8 K18 ["PermissionsConstants"]
       73 CALL                             R7 1 1
       74 GETIMPORT                        R8 K5 [require]
       76 GETTABLEKS                       R9 R0 K9 ["Src"]
       78 GETTABLEKS                       R9 R9 K17 ["Util"]
       80 GETTABLEKS                       R9 R9 K19 ["GroupUtils"]
       82 CALL                             R8 1 1
       83 LOADNIL                          R9
       84 NEWTABLE                         R10 0 0
       86 LOADNIL                          R11
