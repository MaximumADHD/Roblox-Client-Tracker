MAIN:
  ...
  LOADK R21 K46 ["$FontSizeM"]
  SETTABLEKS R21 R20 K42 ["TextSize"]
  LOADK R21 K47 ["$FontBold"]
  SETTABLEKS R21 R20 K43 ["Font"]
  CALL R18 2 1
  MOVE R19 R2
  LOADK R20 K48 ["> #CreationTime"]
  DUPTABLE R21 K49 [{"TextColor3", "TextSize"}]
  LOADK R22 K50 ["$TextSecondary"]
  SETTABLEKS R22 R21 K41 ["TextColor3"]
  LOADK R22 K51 ["$FontSizeS"]
  ...
  DUPTABLE R16 K55 [{"Size", "AutomaticSize", "TextWrapped", "TextColor3", "TextSize", "BackgroundTransparency", "LineHeight", "TextXAlignment"}]
