PROTO_0:
       ...
       13 MOVE                             R0 R1
       14 GETUPVAL                         R1 0
       15 GETTABLEKS                       R1 R1 K5 ["OnSubmit"]
       17 MOVE                             R2 R0
       18 CALL                             R1 1 0
       19 RETURN                           R0 0
...
PROTO_4:
       ...
       27 LOADB                            R2 1
       28 GETUPVAL                         R3 2
       29 GETTABLEKS                       R3 R3 K8 ["useContext"]
       31 GETUPVAL                         R4 3
       32 CALL                             R3 1 1
       ...
       48 CALL                             R5 2 1
       49 GETUPVAL                         R6 2
       50 GETTABLEKS                       R6 R6 K12 ["useEffect"]
       52 NEWCLOSURE                       R7 P1
       53 CAPTURE                          UPVAL U4
       54 CAPTURE                          VAL R2
       55 CAPTURE                          VAL R4
       ...
       74 GETUPVAL                         R10 2
       75 GETTABLEKS                       R10 R10 K13 ["createElement"]
       ...
       87 GETUPVAL                         R13 2
       88 GETTABLEKS                       R13 R13 K25 ["Event"]
       90 GETTABLEKS                       R13 R13 K26 ["Activated"]
      ...
      115 GETUPVAL                         R13 2
      116 GETTABLEKS                       R13 R13 K25 ["Event"]
      118 GETTABLEKS                       R13 R13 K26 ["Activated"]
      120 SETTABLE                         R5 R12 R13
      121 GETUPVAL                         R13 2
      122 GETTABLEKS                       R13 R13 K16 ["Tag"]
      124 JUMPIFNOT                        R2 ; [+2]
      125 LOADNIL                          R14
      126 JUMP                             ; [+1]
...
MAIN:
       ...
       44 GETTABLEKS                       R9 R0 K19 ["Src"]
       46 GETTABLEKS                       R9 R9 K20 ["Contexts"]
       48 GETTABLEKS                       R9 R9 K21 ["TagDropdownContext"]
       50 CALL                             R8 1 1
       51 GETTABLEKS                       R8 R8 K21 ["TagDropdownContext"]
       53 GETIMPORT                        R9 K5 [require]
       55 GETTABLEKS                       R10 R0 K19 ["Src"]
       57 GETTABLEKS                       R10 R10 K22 ["Types"]
       59 CALL                             R9 1 1
