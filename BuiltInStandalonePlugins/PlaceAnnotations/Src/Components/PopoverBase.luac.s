...
PROTO_1:
        ...
        7 JUMPIF                           R2 ; [+5]
        8 GETUPVAL                         R2 1
        9 GETTABLEKS                       R2 R2 K4 ["OnFocusLost"]
       11 CALL                             R2 0 0
       12 RETURN                           R0 0
       ...
       25 JUMPIFNOT                        R2 ; [+55]
       26 GETUPVAL                         R2 3
       27 GETTABLEKS                       R2 R2 K8 ["current"]
       29 JUMPIFNOT                        R2 ; [+51]
       30 GETUPVAL                         R3 3
       31 GETTABLEKS                       R3 R3 K8 ["current"]
       ...
       76 JUMPIF                           R2 ; [+4]
       77 GETUPVAL                         R2 1
       78 GETTABLEKS                       R2 R2 K4 ["OnFocusLost"]
       80 CALL                             R2 0 0
       81 RETURN                           R0 0
...
PROTO_3:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["DebounceFocusLost"]
        3 NOT                              R0 R1
        4 GETUPVAL                         R1 1
        5 GETTABLEKS                       R1 R1 K1 ["InputEnded"]
        7 NEWCLOSURE                       R3 P0
        8 CAPTURE                          UPVAL U2
        9 CAPTURE                          UPVAL U0
       10 CAPTURE                          REF R0
...
PROTO_5:
        ...
        9 CALL                             R2 0 1
       10 GETUPVAL                         R3 3
       11 GETTABLEKS                       R3 R3 K2 ["useRef"]
       13 LOADNIL                          R4
       14 CALL                             R3 1 1
       15 GETUPVAL                         R4 3
       16 GETTABLEKS                       R4 R4 K3 ["useState"]
       ...
       33 CALL                             R6 3 1
       34 GETUPVAL                         R7 3
       35 GETTABLEKS                       R7 R7 K12 ["useContext"]
       37 GETUPVAL                         R8 5
       38 CALL                             R7 1 1
       39 GETTABLEKS                       R8 R7 K13 ["isTagDropdownOpen"]
       41 GETUPVAL                         R9 3
       42 GETTABLEKS                       R9 R9 K14 ["useEffect"]
...
MAIN:
       ...
       37 GETTABLEKS                       R6 R1 K13 ["Enums"]
       39 GETTABLEKS                       R6 R6 K14 ["StateLayerAffordance"]
       41 GETTABLEKS                       R7 R1 K15 ["Hooks"]
       43 GETTABLEKS                       R7 R7 K16 ["useTokens"]
       45 GETIMPORT                        R8 K5 [require]
       47 GETTABLEKS                       R9 R0 K8 ["Src"]
       49 GETTABLEKS                       R9 R9 K15 ["Hooks"]
       51 GETTABLEKS                       R9 R9 K17 ["useViewportPosition"]
       53 CALL                             R8 1 1
       54 GETIMPORT                        R9 K5 [require]
       56 GETTABLEKS                       R10 R0 K8 ["Src"]
       58 GETTABLEKS                       R10 R10 K18 ["Contexts"]
       60 GETTABLEKS                       R10 R10 K19 ["TagDropdownContext"]
       62 CALL                             R9 1 1
       63 GETTABLEKS                       R9 R9 K19 ["TagDropdownContext"]
