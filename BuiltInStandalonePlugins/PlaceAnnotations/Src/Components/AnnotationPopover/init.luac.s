...
PROTO_13:
  ...
  GETTABLEKS R23 R24 K14 ["createElement"]
  GETUPVAL R24 8
  DUPTABLE R25 K54 [{"OnClick"}]
  NEWCLOSURE R26 P4
  CAPTURE UPVAL U7
  CAPTURE VAL R2
  CAPTURE VAL R0
  SETTABLEKS R26 R25 K53 ["OnClick"]
  CALL R23 2 1
  ...
  LOADK R23 K55 ["Component-Divider"]
  ...
  GETTABLEKS R15 R16 K14 ["createElement"]
  GETUPVAL R16 9
  DUPTABLE R17 K57 [{"LayoutOrder", "MaxY"}]
  LOADN R18 1
  SETTABLEKS R18 R17 K15 ["LayoutOrder"]
  LOADN R18 250
  SETTABLEKS R18 R17 K56 ["MaxY"]
  NEWTABLE R18 1 1
  GETUPVAL R21 2
  ...
  CALL R20 2 1
  SETTABLEKS R20 R18 K58 ["Comment"]
  FASTCALL1 TABLE_UNPACK R10 [+3]
  MOVE R20 R10
  GETIMPORT R19 K60 [table.unpack]
  CALL R19 1 -1
  SETLIST R18 R19 -1 [1]
  CALL R15 3 1
  ...
  SETTABLEKS R18 R17 K15 ["LayoutOrder"]
  LOADN R18 1
  SETTABLEKS R18 R17 K61 ["BackgroundTransparency"]
  GETIMPORT R18 K65 [Enum.AutomaticSize.Y]
  SETTABLEKS R18 R17 K63 ["AutomaticSize"]
  ...
  LOADK R19 K70 ["X-RowM"]
  SETTABLE R19 R17 R18
  DUPTABLE R18 K73 [{"Avatar", "TextInput"}]
  GETUPVAL R20 2
  GETTABLEKS R19 R20 K14 ["createElement"]
  LOADK R20 K74 ["ImageLabel"]
  NEWTABLE R21 4 0
  LOADK R23 K75 ["rbxthumb://type=AvatarHeadShot&id=%*&filters=circular&w=150&h=150"]
  GETUPVAL R25 6
  NAMECALL R25 R25 K46 ["GetUserId"]
  CALL R25 1 1
  NAMECALL R23 R23 K76 ["format"]
  CALL R23 2 1
  MOVE R22 R23
  SETTABLEKS R22 R21 K77 ["Image"]
  LOADN R22 0
  SETTABLEKS R22 R21 K15 ["LayoutOrder"]
  GETUPVAL R23 2
  GETTABLEKS R22 R23 K21 ["Tag"]
  LOADK R23 K78 ["Component-Avatar"]
  SETTABLE R23 R21 R22
  CALL R19 2 1
  SETTABLEKS R19 R18 K71 ["Avatar"]
  GETUPVAL R20 2
  GETTABLEKS R19 R20 K14 ["createElement"]
  LOADK R20 K79 ["TextBox"]
  NEWTABLE R21 8 0
  LOADN R22 1
  SETTABLEKS R22 R21 K15 ["LayoutOrder"]
  LOADK R24 K80 ["Reply"]
  LOADK R25 K81 ["Placeholder"]
  NAMECALL R22 R1 K44 ["getText"]
  CALL R22 3 1
  SETTABLEKS R22 R21 K82 ["PlaceholderText"]
  GETIMPORT R22 K84 [UDim2.new]
  LOADN R23 1
  LOADN R24 216
  LOADN R25 0
  LOADN R26 0
  ...
  GETTABLEKS R22 R23 K86 ["Focused"]
  NEWCLOSURE R23 P6
  CAPTURE VAL R8
  SETTABLE R23 R21 R22
  GETUPVAL R24 2
  GETTABLEKS R23 R24 K50 ["Event"]
  GETTABLEKS R22 R23 K87 ["FocusLost"]
  NEWCLOSURE R23 P7
  CAPTURE VAL R8
  SETTABLE R23 R21 R22
  GETUPVAL R23 2
  GETTABLEKS R22 R23 K21 ["Tag"]
  LOADK R23 K88 ["Component-TextInput"]
  SETTABLE R23 R21 R22
  CALL R19 2 1
  SETTABLEKS R19 R18 K72 ["TextInput"]
  CALL R15 3 1
  ...
  GETTABLEKS R15 R16 K14 ["createElement"]
  GETUPVAL R16 10
  DUPTABLE R17 K90 [{"LayoutOrder", "Text", "OnCancel", "OnSubmit"}]
  LOADN R18 3
  SETTABLEKS R18 R17 K15 ["LayoutOrder"]
  ...
  CAPTURE VAL R6
  CAPTURE VAL R0
  SETTABLEKS R18 R17 K89 ["OnSubmit"]
  CALL R15 2 1
