...
PROTO_6:
  ...
  CALL R0 1 0
  GETUPVAL R0 2
  NAMECALL R0 R0 K1 ["isDoubleClick"]
  CALL R0 1 1
  JUMPIFNOT R0 [+21]
  GETUPVAL R1 3
  ...
  CALL R0 2 0
  GETUPVAL R1 3
  GETTABLEKS R0 R1 K4 ["syncEditAnnotation"]
  GETUPVAL R1 4
  GETUPVAL R3 5
  GETTABLEKS R2 R3 K3 ["Annotation"]
  DUPTABLE R3 K6 [{"SingleClick"}]
  LOADB R4 0
  SETTABLEKS R4 R3 K5 ["SingleClick"]
  CALL R0 3 0
  RETURN R0 0
  GETUPVAL R1 3
  GETTABLEKS R0 R1 K7 ["selectAnnotation"]
  GETUPVAL R1 4
  GETUPVAL R3 5
  GETTABLEKS R2 R3 K3 ["Annotation"]
  CALL R0 2 0
