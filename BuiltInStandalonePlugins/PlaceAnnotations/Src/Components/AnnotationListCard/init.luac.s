...
PROTO_15:
  ...
  GETUPVAL R34 7
  GETTABLEKS R33 R34 K41 ["fflagAnnotationsCardDoubleClickZoom"]
  JUMPIFNOT R33 [+78]
  GETUPVAL R33 3
  GETTABLEKS R32 R33 K9 ["createElement"]
  GETUPVAL R33 14
  DUPTABLE R34 K45 [{"DropdownItems", "OnSelect", "Disabled"}]
  DUPTABLE R35 K48 [{"ZoomTo", "Delete"}]
  LOADK R38 K49 ["Dropdown"]
  LOADK R39 K46 ["ZoomTo"]
  NAMECALL R36 R2 K50 ["getText"]
  CALL R36 3 1
  SETTABLEKS R36 R35 K46 ["ZoomTo"]
  GETTABLEKS R38 R0 K7 ["Annotation"]
  GETTABLEKS R37 R38 K51 ["AuthorId"]
  GETUPVAL R38 15
  NAMECALL R38 R38 K52 ["GetUserId"]
  CALL R38 1 1
  ...
  LOADK R42 K53 ["DeleteThread"]
  NAMECALL R39 R2 K50 ["getText"]
  CALL R39 3 1
  SETTABLEKS R39 R38 K23 ["Text"]
  GETUPVAL R41 3
  GETTABLEKS R40 R41 K24 ["Event"]
  GETTABLEKS R39 R40 K54 ["Activated"]
  NEWCLOSURE R40 P5
  CAPTURE UPVAL U7
  CAPTURE VAL R14
  CAPTURE UPVAL U12
  ...
  LOADK R40 K55 ["Component-DropdownItem Delete"]
  SETTABLE R40 R38 R39
  CALL R36 2 1
  JUMP [+1]
  LOADNIL R36
  SETTABLEKS R36 R35 K47 ["Delete"]
  ...
  CAPTURE VAL R1
  CAPTURE VAL R0
  SETTABLEKS R35 R34 K43 ["OnSelect"]
  GETUPVAL R37 4
  GETTABLEKS R36 R37 K56 ["InProgress"]
  JUMPIFEQ R8 R36 [+2]
  LOADB R35 0 +1
  LOADB R35 1
  SETTABLEKS R35 R34 K44 ["Disabled"]
  CALL R32 2 1
  JUMP [+64]
  GETTABLEKS R34 R0 K7 ["Annotation"]
  GETTABLEKS R33 R34 K51 ["AuthorId"]
  GETUPVAL R34 15
  NAMECALL R34 R34 K52 ["GetUserId"]
  CALL R34 1 1
  JUMPIFNOTEQ R33 R34 [+54]
  GETUPVAL R33 3
  GETTABLEKS R32 R33 K9 ["createElement"]
  GETUPVAL R33 14
  DUPTABLE R34 K57 [{"DropdownItems", "Disabled"}]
  NEWTABLE R35 0 1
  GETUPVAL R37 3
  GETTABLEKS R36 R37 K9 ["createElement"]
  LOADK R37 K20 ["TextButton"]
  ...
  GETTABLEKS R32 R33 K9 ["createElement"]
  GETUPVAL R33 16
  DUPTABLE R34 K60 [{"Resolved", "OnClick", "Disabled"}]
  GETTABLEKS R36 R0 K7 ["Annotation"]
  GETTABLEKS R35 R36 K58 ["Resolved"]
  SETTABLEKS R35 R34 K58 ["Resolved"]
  NEWCLOSURE R35 P8
  CAPTURE UPVAL U12
  CAPTURE VAL R1
  CAPTURE VAL R0
  SETTABLEKS R35 R34 K59 ["OnClick"]
  GETUPVAL R37 4
  GETTABLEKS R36 R37 K56 ["InProgress"]
  JUMPIFEQ R8 R36 [+2]
  LOADB R35 0 +1
  ...
  GETTABLEKS R28 R29 K9 ["createElement"]
  GETUPVAL R29 17
  DUPTABLE R30 K61 [{"LayoutOrder", "Annotation"}]
  LOADN R31 0
  ...
  JUMPIFEQKN R29 K62 [0] [+50]
  GETUPVAL R29 3
  GETTABLEKS R28 R29 K9 ["createElement"]
  LOADK R29 K63 ["TextLabel"]
  DUPTABLE R30 K64 [{"Text", "LayoutOrder"}]
  GETTABLEKS R33 R0 K7 ["Annotation"]
  GETTABLEKS R32 R33 K33 ["ReplyCount"]
  JUMPIFNOTEQKN R32 K65 [1] [+7]
  LOADK R33 K18 ["Card"]
  LOADK R34 K66 ["SingleReply"]
  NAMECALL R31 R2 K50 ["getText"]
  CALL R31 3 1
  JUMP [+25]
  LOADK R33 K18 ["Card"]
  LOADK R34 K67 ["ManyReplies"]
  DUPTABLE R35 K69 [{"replyCount"}]
  GETTABLEKS R38 R0 K7 ["Annotation"]
  GETTABLEKS R37 R38 K33 ["ReplyCount"]
  LOADN R38 100
  JUMPIFNOTLT R37 R38 [+10]
  GETIMPORT R36 K72 [string.format]
  LOADK R37 K73 ["%d"]
  ...
  JUMP [+1]
  LOADK R36 K74 ["99+"]
  SETTABLEKS R36 R35 K68 ["replyCount"]
  NAMECALL R31 R2 K50 ["getText"]
  CALL R31 4 1
  ...
  GETUPVAL R22 7
  GETTABLEKS R21 R22 K75 ["fflagAnnotationsFixForPolyfillOff"]
  JUMPIFNOT R21 [+27]
  MOVE R20 R13
  JUMPIFNOT R20 [+26]
  GETUPVAL R21 3
  GETTABLEKS R20 R21 K9 ["createElement"]
  GETUPVAL R21 18
  DUPTABLE R22 K78 [{"Text", "OnCancel", "OnDelete"}]
  LOADK R25 K79 ["ConfirmDeleteDialog"]
  LOADK R26 K53 ["DeleteThread"]
  NAMECALL R23 R2 K50 ["getText"]
  CALL R23 3 1
  SETTABLEKS R23 R22 K23 ["Text"]
  NEWCLOSURE R23 P9
  CAPTURE VAL R14
  SETTABLEKS R23 R22 K76 ["OnCancel"]
  NEWCLOSURE R23 P10
  CAPTURE VAL R14
  CAPTURE UPVAL U12
  CAPTURE VAL R1
  CAPTURE VAL R0
  SETTABLEKS R23 R22 K77 ["OnDelete"]
  CALL R20 2 1
  JUMP [+1]
  LOADNIL R20
