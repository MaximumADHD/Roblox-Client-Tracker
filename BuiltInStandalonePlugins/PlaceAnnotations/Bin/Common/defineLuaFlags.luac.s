...
MAIN:
  ...
  NAMECALL R1 R1 K49 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K28 ["fflagAnnotationsOpenPanelOnCreate"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K8 ["AnnotationCreationLocksCamera"]
  NAMECALL R1 R1 K49 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K29 ["fflagAnnotationCreationLocksCamera"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K9 ["AnnotationsTaggedYouLabel"]
  NAMECALL R1 R1 K49 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K30 ["fflagAnnotationsTaggedYouLabel"]
  GETIMPORT R1 K1 [game]
  ...
  LOADK R4 K50 ["EnableRibbonPluginFeature"]
  NAMECALL R2 R2 K51 ["GetEngineFeature"]
  CALL R2 2 1
  JUMPIF R2 [+5]
  GETIMPORT R3 K53 [pcall]
  NEWCLOSURE R4 P0
  CAPTURE REF R2
  CALL R3 1 0
  MOVE R1 R2
  CLOSEUPVALS R2
  SETTABLEKS R1 R0 K35 ["fflagIsModernRibbon"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K14 ["AnnotationsUseStateCallbacks"]
  NAMECALL R1 R1 K49 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K36 ["fflagAnnotationsUseStateCallbacks"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K15 ["COLLAB9285AnnotationsPerPlaceNotifPrefs3"]
  NAMECALL R1 R1 K49 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K37 ["fflagCOLLAB9285AnnotationsPerPlaceNotifPrefs"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K16 ["EnableStudioAnnotationsNotifications"]
  NAMECALL R1 R1 K49 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K38 ["fflagEnableStudioAnnotationsNotifications"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K17 ["EnableStudioAnnotationsNotificationsExperiment"]
  NAMECALL R1 R1 K49 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K39 ["fflagEnableStudioAnnotationsNotificationsExperiment"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K18 ["AnnotationsPerThreadNotifPrefs"]
  NAMECALL R1 R1 K49 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K40 ["fflagAnnotationsPerThreadNotifPrefs"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K19 ["COLLAB9434FixEscCursorAndTagInput"]
  NAMECALL R1 R1 K49 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K41 ["fflagCOLLAB9434FixEscCursorAndTagInput"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K20 ["COLLAB9449FixAnnotationsHeightCacheEdits2"]
  NAMECALL R1 R1 K49 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K42 ["fflagCOLLAB9449FixAnnotationsHeightCacheEdits"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K21 ["AnnotationsFixEditHeightAndCursor"]
  NAMECALL R1 R1 K49 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K43 ["fflagAnnotationsFixEditHeightAndCursor"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K22 ["AnnotationsHeightCacheLoadingFixes"]
  NAMECALL R1 R1 K49 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K44 ["fflagAnnotationsHeightCacheLoadingFixes"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K23 ["AnnotationsReflectPreselectedThread"]
  NAMECALL R1 R1 K49 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K45 ["fflagAnnotationsReflectPreselectedThread"]
  RETURN R0 1
