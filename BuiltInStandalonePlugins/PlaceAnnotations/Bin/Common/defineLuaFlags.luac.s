MAIN:
  ...
  GETIMPORT R1 K1 [game]
  LOADK R3 K41 ["AnnotationsSyncTagging"]
  NAMECALL R1 R1 K38 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K23 ["fflagAnnotationsSyncTagging"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K42 ["AnnotationsReleaseCallout"]
  LOADB R4 0
  ...
  GETIMPORT R1 K1 [game]
  LOADK R3 K43 ["COLLAB7954AnnotationsLoadRecentReplies"]
  NAMECALL R1 R1 K38 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K27 ["fflagCOLLAB7954AnnotationsLoadRecentReplies"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K10 ["AnnotationsCardDoubleClickZoom"]
  NAMECALL R1 R1 K38 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K28 ["fflagAnnotationsCardDoubleClickZoom"]
  GETIMPORT R1 K1 [game]
  ...
  NAMECALL R1 R1 K38 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K32 ["fflagCOLLAB8272WidgetEnabled"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K15 ["COLLAB8324KeepOpenOnSubmit"]
  NAMECALL R1 R1 K38 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K33 ["fflagCOLLAB8324KeepOpenOnSubmit"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K16 ["AnnotationsCheckRolesetResponse"]
  NAMECALL R1 R1 K38 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K34 ["fflagAnnotationsCheckRolesetResponse"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K17 ["AnnotationsFixForPolyfillOff"]
  NAMECALL R1 R1 K38 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K35 ["fflagAnnotationsFixForPolyfillOff"]
  RETURN R0 1
