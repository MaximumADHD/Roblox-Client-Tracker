MAIN:
  ...
  CALL R0 3 0
  GETIMPORT R0 K1 [game]
  LOADK R2 K15 ["COLLAB8964DoubleClickZoomTo"]
  LOADB R3 0
  NAMECALL R0 R0 K3 ["DefineFastFlag"]
  CALL R0 3 0
  DUPTABLE R0 K30 [{"fflagCOLLAB6176PlaceAnnotations", "fflagAnnotationsModernColors", "fflagAnnotationsMaxTextLength", "fflagAnnotationsReleaseCallout", "fintAnnotationsPointerMaxSize", "fintAnnotationsPointerMinSize", "fflagAnnotationsOpenPanelOnCreate", "fflagAnnotationCreationLocksCamera", "fflagAnnotationsTaggedYouLabel", "fflagCOLLAB8272WidgetEnabled", "fflagCOLLAB8324KeepOpenOnSubmit", "fflagAnnotationsFixForPolyfillOff", "fflagCOLLAB8658AnnotationsDisableNonTCRestore", "fflagCOLLAB8964DoubleClickZoomTo"}]
  GETIMPORT R1 K1 [game]
  LOADK R3 K31 ["COLLAB6176PlaceAnnotations"]
  NAMECALL R1 R1 K32 ["GetFastFlag"]
  CALL R1 2 1
  JUMPIFNOT R1 [+6]
  GETIMPORT R1 K1 [game]
  LOADK R3 K33 ["COLLAB6176PlaceAnnotationsStudio"]
  NAMECALL R1 R1 K32 ["GetFastFlag"]
  CALL R1 2 1
  ...
  GETIMPORT R1 K1 [game]
  LOADK R3 K35 ["AnnotationsReleaseCallout"]
  LOADB R4 0
  NAMECALL R1 R1 K3 ["DefineFastFlag"]
  CALL R1 3 1
  SETTABLEKS R1 R0 K19 ["fflagAnnotationsReleaseCallout"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K6 ["AnnotationsPointerMaxSize"]
  NAMECALL R1 R1 K34 ["GetFastInt"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K20 ["fintAnnotationsPointerMaxSize"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K7 ["AnnotationsPointerMinSize"]
  NAMECALL R1 R1 K34 ["GetFastInt"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K21 ["fintAnnotationsPointerMinSize"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K8 ["AnnotationsOpenPanelOnCreate"]
  NAMECALL R1 R1 K32 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K22 ["fflagAnnotationsOpenPanelOnCreate"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K9 ["AnnotationCreationLocksCamera"]
  NAMECALL R1 R1 K32 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K23 ["fflagAnnotationCreationLocksCamera"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K10 ["AnnotationsTaggedYouLabel"]
  NAMECALL R1 R1 K32 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K24 ["fflagAnnotationsTaggedYouLabel"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K11 ["COLLAB8272WidgetEnabled"]
  NAMECALL R1 R1 K32 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K25 ["fflagCOLLAB8272WidgetEnabled"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K12 ["COLLAB8324KeepOpenOnSubmit"]
  NAMECALL R1 R1 K32 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K26 ["fflagCOLLAB8324KeepOpenOnSubmit"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K13 ["AnnotationsFixForPolyfillOff2"]
  NAMECALL R1 R1 K32 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K27 ["fflagAnnotationsFixForPolyfillOff"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K14 ["COLLAB8658AnnotationsDisableNonTCRestore"]
  NAMECALL R1 R1 K32 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K28 ["fflagCOLLAB8658AnnotationsDisableNonTCRestore"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K15 ["COLLAB8964DoubleClickZoomTo"]
  NAMECALL R1 R1 K32 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K29 ["fflagCOLLAB8964DoubleClickZoomTo"]
  RETURN R0 1
