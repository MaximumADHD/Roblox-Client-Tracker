MAIN:
  ...
  GETIMPORT R1 K1 [game]
  LOADK R3 K31 ["AnnotationsReleaseCallout"]
  LOADB R4 0
  NAMECALL R1 R1 K3 ["DefineFastFlag"]
  CALL R1 3 1
  SETTABLEKS R1 R0 K17 ["fflagAnnotationsReleaseCallout"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K6 ["AnnotationsPointerMaxSize"]
  NAMECALL R1 R1 K30 ["GetFastInt"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K18 ["fintAnnotationsPointerMaxSize"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K7 ["AnnotationsPointerMinSize"]
  NAMECALL R1 R1 K30 ["GetFastInt"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K19 ["fintAnnotationsPointerMinSize"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K8 ["AnnotationsOpenPanelOnCreate"]
  NAMECALL R1 R1 K28 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K20 ["fflagAnnotationsOpenPanelOnCreate"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K9 ["AnnotationCreationLocksCamera"]
  NAMECALL R1 R1 K28 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K21 ["fflagAnnotationCreationLocksCamera"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K10 ["AnnotationsTaggedYouLabel"]
  NAMECALL R1 R1 K28 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K22 ["fflagAnnotationsTaggedYouLabel"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K11 ["COLLAB8272WidgetEnabled"]
  NAMECALL R1 R1 K28 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K23 ["fflagCOLLAB8272WidgetEnabled"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K12 ["COLLAB8324KeepOpenOnSubmit"]
  NAMECALL R1 R1 K28 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K24 ["fflagCOLLAB8324KeepOpenOnSubmit"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K13 ["AnnotationsFixForPolyfillOff2"]
  NAMECALL R1 R1 K28 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K25 ["fflagAnnotationsFixForPolyfillOff"]
  RETURN R0 1
