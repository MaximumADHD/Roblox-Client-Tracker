...
MAIN:
  ...
  GETTABLEKS R8 R3 K35 ["createRoot"]
  MOVE R9 R7
  CALL R8 1 1
  GETTABLEKS R11 R4 K36 ["createElement"]
  MOVE R12 R5
  DUPTABLE R13 K38 [{"Plugin"}]
  GETIMPORT R14 K1 [plugin]
  SETTABLEKS R14 R13 K37 ["Plugin"]
  CALL R11 2 -1
  NAMECALL R9 R8 K39 ["render"]
  CALL R9 -1 0
  GETIMPORT R10 K1 [plugin]
  GETTABLEKS R9 R10 K40 ["Unloading"]
  NEWCLOSURE R11 P0
  CAPTURE REF R8
  CAPTURE REF R6
  ...
  GETTABLEKS R10 R11 K42 ["pluginType"]
  CALL R9 1 1
  GETTABLEKS R10 R9 K43 ["get"]
  CALL R10 0 1
  GETTABLEKS R11 R9 K44 ["Asset"]
  JUMPIFEQ R10 R11 [+3]
  CLOSEUPVALS R6
  RETURN R0 0
