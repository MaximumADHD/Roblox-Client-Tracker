...
MAIN:
  ...
  CALL R4 1 1
  GETTABLEKS R5 R2 K22 ["fflagCOLLAB8658AnnotationsDisableNonTCRestore"]
  JUMPIFNOT R5 [+24]
  NAMECALL R6 R3 K23 ["GetCollaboratorsList"]
  CALL R6 1 1
  LENGTH R5 R6
  JUMPIFNOTEQKN R5 K24 [0] [+10]
  GETIMPORT R5 K1 [plugin]
  GETTABLEKS R7 R4 K25 ["TCEnabledKey"]
  LOADB R8 0
  NAMECALL R5 R5 K26 ["SetItem"]
  CALL R5 3 0
  RETURN R0 0
  GETIMPORT R5 K1 [plugin]
  GETTABLEKS R7 R4 K25 ["TCEnabledKey"]
  ...
  GETTABLEKS R11 R6 K45 ["createRoot"]
  MOVE R12 R10
  CALL R11 1 1
  GETTABLEKS R14 R7 K46 ["createElement"]
  MOVE R15 R8
  ...
  CALL R12 2 0
  GETTABLEKS R12 R2 K22 ["fflagCOLLAB8658AnnotationsDisableNonTCRestore"]
  JUMPIFNOT R12 [+12]
  GETIMPORT R12 K1 [plugin]
  GETTABLEKS R14 R4 K52 ["PlaceIdKey"]
  GETIMPORT R16 K17 [game]
  GETTABLEKS R15 R16 K53 ["PlaceId"]
  NAMECALL R12 R12 K26 ["SetItem"]
  CALL R12 3 0
  JUMP [+10]
  GETIMPORT R12 K1 [plugin]
  LOADK R14 K53 ["PlaceId"]
  GETIMPORT R16 K17 [game]
  GETTABLEKS R15 R16 K53 ["PlaceId"]
  NAMECALL R12 R12 K26 ["SetItem"]
  CALL R12 3 0
  GETTABLEKS R12 R2 K54 ["fflagCOLLAB8949AnnotationsAddPluginTelemetry"]
  JUMPIFNOT R12 [+27]
  GETIMPORT R12 K1 [plugin]
  GETTABLEKS R14 R4 K55 ["UniverseIdKey"]
  GETIMPORT R16 K17 [game]
  GETTABLEKS R15 R16 K56 ["GameId"]
  NAMECALL R12 R12 K26 ["SetItem"]
  CALL R12 3 0
  GETIMPORT R12 K17 [game]
  LOADK R14 K57 ["StudioService"]
  NAMECALL R12 R12 K19 ["GetService"]
  CALL R12 2 1
  GETIMPORT R13 K1 [plugin]
  GETTABLEKS R15 R4 K58 ["UserIdKey"]
  NAMECALL R16 R12 K59 ["GetUserId"]
  CALL R16 1 -1
  NAMECALL R13 R13 K26 ["SetItem"]
  CALL R13 -1 0
  GETIMPORT R12 K7 [require]
  GETTABLEKS R15 R0 K13 ["Bin"]
  GETTABLEKS R14 R15 K14 ["Common"]
  GETTABLEKS R13 R14 K60 ["pluginType"]
  CALL R12 1 1
  GETTABLEKS R13 R12 K61 ["get"]
  CALL R13 0 1
  GETTABLEKS R14 R12 K62 ["Asset"]
  JUMPIFEQ R13 R14 [+3]
  CLOSEUPVALS R9
  RETURN R0 0
