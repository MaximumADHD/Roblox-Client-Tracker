...
PROTO_3:
  ...
  CALL R9 3 1
  MUL R8 R2 R9
  NAMECALL R6 R6 K7 ["pointToWorldSpace"]
  CALL R6 2 1
  MOVE R7 R3
  MOVE R8 R4
  MOVE R9 R1
...
PROTO_4:
  ...
  LOADN R13 255
  FASTCALL VECTOR [+2]
  GETIMPORT R10 K15 [Vector3.new]
  CALL R10 3 1
  MUL R9 R5 R10
  NAMECALL R7 R7 K16 ["pointToWorldSpace"]
  CALL R7 2 1
  MOVE R8 R2
  MOVE R9 R3
  MOVE R10 R1
...
PROTO_6:
  ...
  MOVE R3 R4
  MOVE R6 R2
  NAMECALL R4 R1 K9 ["pointToObjectSpace"]
  CALL R4 2 1
  MOVE R2 R4
  MOVE R6 R3
  NAMECALL R4 R1 K9 ["pointToObjectSpace"]
...
PROTO_9:
  ...
  CALL R3 1 1
  MOVE R2 R3
  GETGLOBAL R3 K5 ["extentsToCFrameAndSize"]
  GETGLOBAL R4 K6 ["getExtents"]
  MOVE R5 R2
  CALL R4 1 1
  MOVE R5 R2
  CALL R3 2 2
  JUMPIFNOT R4 [+2]
  SETTABLEKS R4 R0 K7 ["Size"]
  JUMPIFNOT R3 [+2]
