...
PROTO_1:
        ...
        2 CALL                             R4 1 1
        3 GETIMPORT                        R5 K2 [workspace]
        5 GETTABLEKS                       R5 R5 K3 ["CurrentCamera"]
        7 MOVE                             R6 R3
        8 JUMPIF                           R6 ; [+2]
        9 NEWTABLE                         R6 0 0
       ...
       80 CALL                             R14 4 0
       81 JUMPIFNOT                        R12 ; [+75]
       82 GETTABLEKS                       R14 R5 K18 ["CoordinateFrame"]
       84 MOVE                             R16 R12
       85 NAMECALL                         R14 R14 K19 ["pointToObjectSpace"]
       87 CALL                             R14 2 1
       88 GETTABLEKS                       R14 R14 K20 ["Z"]
       90 LOADN                            R15 0
...
PROTO_3:
        ...
        1 SETUPVAL                         R1 0
        2 GETUPVAL                         R1 1
        3 GETTABLEKS                       R1 R1 K0 ["setPlaneVisibility"]
        5 LOADB                            R2 0
        6 CALL                             R1 1 0
        7 SETUPVAL                         R0 2
        8 NEWTABLE                         R1 0 0
...
PROTO_5:
        ...
        5 GETUPVAL                         R3 1
        6 GETTABLEKS                       R3 R3 K0 ["X"]
        8 SUB                              R1 R2 R3
        9 GETTABLEKS                       R3 R0 K1 ["Y"]
       11 GETUPVAL                         R4 1
       12 GETTABLEKS                       R4 R4 K1 ["Y"]
       14 SUB                              R2 R3 R4
       15 GETUPVAL                         R4 2
       ...
       63 LOADN                            R5 0
       64 GETUPVAL                         R6 1
       65 GETTABLEKS                       R6 R6 K0 ["X"]
       67 LOADN                            R7 0
       68 GETUPVAL                         R8 1
       69 GETTABLEKS                       R8 R8 K1 ["Y"]
       71 CALL                             R4 4 1
       ...
       78 LOADN                            R5 0
       79 GETUPVAL                         R7 1
       80 GETTABLEKS                       R7 R7 K0 ["X"]
       82 ADD                              R6 R7 R1
       83 LOADN                            R7 0
       84 GETUPVAL                         R8 1
       85 GETTABLEKS                       R8 R8 K1 ["Y"]
       87 CALL                             R4 4 1
       ...
       94 LOADN                            R5 0
       95 GETUPVAL                         R6 1
       96 GETTABLEKS                       R6 R6 K0 ["X"]
       98 LOADN                            R7 0
       99 GETUPVAL                         R8 1
      100 GETTABLEKS                       R8 R8 K1 ["Y"]
      102 CALL                             R4 4 1
      ...
      109 LOADN                            R5 0
      110 GETUPVAL                         R6 1
      111 GETTABLEKS                       R6 R6 K0 ["X"]
      113 LOADN                            R7 0
      114 GETUPVAL                         R9 1
      115 GETTABLEKS                       R9 R9 K1 ["Y"]
      117 ADD                              R8 R9 R2
      118 CALL                             R4 4 1
...
MAIN:
        ...
        7 GETTABLEKS                       R1 R1 K5 ["Adornments"]
        9 CALL                             R0 1 1
       10 LOADNIL                          R1
       11 NEWTABLE                         R2 0 4
       13 NEWTABLE                         R3 0 0
