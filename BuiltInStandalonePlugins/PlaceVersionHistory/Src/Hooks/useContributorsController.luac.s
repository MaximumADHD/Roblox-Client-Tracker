...
PROTO_2:
       ...
       22 GETUPVAL                         R1 3
       23 GETTABLEKS                       R1 R1 K3 ["placeId"]
       25 SETTABLEKS                       R1 R0 K3 ["placeId"]
       27 GETUPVAL                         R1 4
       28 SETTABLEKS                       R1 R0 K4 ["pageSize"]
       30 GETUPVAL                         R1 2
       31 GETUPVAL                         R2 5
       32 GETTABLEKS                       R2 R2 K6 ["getContributors"]
       34 MOVE                             R3 R0
       35 CALL                             R2 1 1
       36 NEWCLOSURE                       R4 P0
       37 CAPTURE                          UPVAL U0
...
PROTO_8:
       ...
       10 CALL                             R2 1 2
       11 GETUPVAL                         R4 0
       12 GETTABLEKS                       R4 R4 K1 ["useState"]
       14 LOADK                            R5 K2 [""]
       15 CALL                             R4 1 2
       16 GETUPVAL                         R6 0
       ...
       26 CALL                             R7 1 2
       27 GETUPVAL                         R9 0
       28 GETTABLEKS                       R9 R9 K0 ["useContext"]
       30 GETUPVAL                         R10 2
       31 CALL                             R9 1 1
       32 GETUPVAL                         R10 0
       33 GETTABLEKS                       R10 R10 K3 ["useRef"]
       35 LOADNIL                          R11
       36 CALL                             R10 1 1
       37 GETUPVAL                         R11 0
       38 GETTABLEKS                       R11 R11 K4 ["useLayoutEffect"]
       ...
       56 CALL                             R11 2 0
       57 GETUPVAL                         R11 0
       58 GETTABLEKS                       R11 R11 K4 ["useLayoutEffect"]
...
MAIN:
       ...
       37 GETTABLEKS                       R7 R0 K13 ["Bin"]
       39 GETTABLEKS                       R7 R7 K14 ["Common"]
       41 GETTABLEKS                       R7 R7 K15 ["flags"]
       43 CALL                             R6 1 1
