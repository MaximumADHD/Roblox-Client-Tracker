PROTO_0:
       ...
       20 LOADB                            R1 1
       21 GETUPVAL                         R3 1
       22 GETTABLEKS                       R2 R3 K4 ["setIsHovered"]
       24 MOVE                             R3 R1
       25 CALL                             R2 1 0
       26 RETURN                           R0 0
...
PROTO_1:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R1 R2 K0 ["toggle"]
        3 GETTABLEKS                       R0 R1 K1 ["enabled"]
        5 JUMPIF                           R0 ; [+5]
        6 GETUPVAL                         R1 1
        7 GETTABLEKS                       R0 R1 K2 ["setIsHovered"]
        9 LOADB                            R1 0
       10 CALL                             R0 1 0
       11 RETURN                           R0 0
...
PROTO_2:
       ...
       12 JUMPIFNOT                        R4 ; [+5]
       13 GETTABLEKS                       R4 R2 K1 ["widget"]
       15 GETTABLEKS                       R3 R4 K2 ["WindowFocusReleased"]
       17 JUMP                             ; [+1]
       18 LOADNIL                          R3
       19 GETUPVAL                         R4 3
       20 MOVE                             R5 R3
       21 GETTABLEKS                       R7 R0 K3 ["toggle"]
       23 GETTABLEKS                       R6 R7 K4 ["disable"]
       25 NEWTABLE                         R7 0 1
       27 GETTABLEKS                       R8 R0 K3 ["toggle"]
       29 SETLIST                          R7 R8 1 [1]
       31 CALL                             R4 3 0
       32 GETUPVAL                         R5 0
       33 GETTABLEKS                       R4 R5 K5 ["useCallback"]
       35 NEWCLOSURE                       R5 P0
       36 CAPTURE                          UPVAL U4
       37 CAPTURE                          VAL R1
       38 NEWTABLE                         R6 0 0
       40 CALL                             R4 2 1
       41 GETUPVAL                         R6 0
       42 GETTABLEKS                       R5 R6 K6 ["useEffect"]
       44 NEWCLOSURE                       R6 P1
       45 CAPTURE                          VAL R0
       46 CAPTURE                          VAL R1
       47 NEWTABLE                         R7 0 1
       49 GETTABLEKS                       R9 R0 K3 ["toggle"]
       51 GETTABLEKS                       R8 R9 K7 ["enabled"]
       53 SETLIST                          R7 R8 1 [1]
       55 CALL                             R5 2 0
       56 GETUPVAL                         R6 0
       57 GETTABLEKS                       R5 R6 K8 ["createElement"]
       59 GETUPVAL                         R8 4
       60 GETTABLEKS                       R7 R8 K9 ["Popover"]
       62 GETTABLEKS                       R6 R7 K10 ["Root"]
       64 DUPTABLE                         R7 K12 [{"isOpen"}]
       65 GETTABLEKS                       R9 R0 K3 ["toggle"]
       67 GETTABLEKS                       R8 R9 K7 ["enabled"]
       69 SETTABLEKS                       R8 R7 K11 ["isOpen"]
       71 DUPTABLE                         R8 K15 [{"Anchor", "Content"}]
       72 GETUPVAL                         R10 0
       73 GETTABLEKS                       R9 R10 K8 ["createElement"]
       75 GETUPVAL                         R12 4
       76 GETTABLEKS                       R11 R12 K9 ["Popover"]
       78 GETTABLEKS                       R10 R11 K13 ["Anchor"]
       80 DUPTABLE                         R11 K17 [{"LayoutOrder"}]
       81 GETTABLEKS                       R12 R0 K16 ["LayoutOrder"]
       83 SETTABLEKS                       R12 R11 K16 ["LayoutOrder"]
       85 GETTABLEKS                       R13 R0 K18 ["children"]
       87 GETTABLEKS                       R12 R13 K13 ["Anchor"]
       89 CALL                             R9 3 1
       90 SETTABLEKS                       R9 R8 K13 ["Anchor"]
       92 GETTABLEKS                       R10 R0 K3 ["toggle"]
       94 GETTABLEKS                       R9 R10 K7 ["enabled"]
       96 JUMPIFNOT                        R9 ; [+71]
       97 GETUPVAL                         R10 0
       98 GETTABLEKS                       R9 R10 K8 ["createElement"]
      100 GETUPVAL                         R12 4
      101 GETTABLEKS                       R11 R12 K9 ["Popover"]
      103 GETTABLEKS                       R10 R11 K14 ["Content"]
      105 DUPTABLE                         R11 K23 [{"onPressedOutside", "side", "align", "hasArrow"}]
      106 GETTABLEKS                       R13 R0 K3 ["toggle"]
      108 GETTABLEKS                       R12 R13 K4 ["disable"]
      ...
      136 GETUPVAL                         R14 0
      137 GETTABLEKS                       R13 R14 K8 ["createElement"]
      139 GETUPVAL                         R15 4
      140 GETTABLEKS                       R14 R15 K27 ["View"]
      ...
      149 GETUPVAL                         R20 4
      150 GETTABLEKS                       R19 R20 K36 ["Enums"]
      152 GETTABLEKS                       R18 R19 K37 ["StateLayerAffordance"]
      154 GETTABLEKS                       R17 R18 K38 ["None"]
      156 SETTABLEKS                       R17 R16 K34 ["affordance"]
      158 SETTABLEKS                       R16 R15 K31 ["stateLayer"]
      160 GETTABLEKS                       R17 R0 K18 ["children"]
      162 GETTABLEKS                       R16 R17 K14 ["Content"]
      164 CALL                             R13 3 1
