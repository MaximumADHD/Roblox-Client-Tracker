...
PROTO_40:
  ...
  DUPCLOSURE R3 K2 [PROTO_19]
  SETTABLEKS R3 R2 K3 ["isRobloxScriptSecurity"]
  DUPCLOSURE R3 K4 [PROTO_20]
...
MAIN:
  ...
  GETTABLEKS R16 R17 K29 ["FFlagMCPAssistantSecureStorage"]
  CALL R15 1 1
  GETIMPORT R16 K16 [require]
  GETTABLEKS R19 R0 K22 ["Src"]
  GETTABLEKS R18 R19 K27 ["Flags"]
  GETTABLEKS R17 R18 K30 ["FFlagStudioAssistantBridgeScriptDiff"]
  CALL R16 1 1
  GETTABLEKS R18 R8 K27 ["Flags"]
  GETTABLEKS R17 R18 K31 ["FFlagAssistantPerUserSettings"]
  GETTABLEKS R19 R9 K32 ["Http"]
  ...
  CALL R19 1 1
  GETTABLEKS R20 R9 K38 ["Url"]
  GETTABLEKS R21 R20 K34 ["new"]
  LOADNIL R22
  CALL R21 1 1
  DUPCLOSURE R22 K39 [PROTO_17]
  CAPTURE VAL R17
  CAPTURE VAL R15
  DUPCLOSURE R23 K40 [PROTO_40]
  CAPTURE VAL R22
  CAPTURE VAL R16
  CAPTURE VAL R6
  CAPTURE VAL R4
