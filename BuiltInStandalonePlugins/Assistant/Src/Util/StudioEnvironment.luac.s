...
PROTO_13:
  ...
  NEWCLOSURE R7 P6
  CAPTURE VAL R4
  SETTABLEKS R7 R2 K7 ["convertImageDataToTempIdAsync"]
  JUMP [+8]
  ...
  CAPTURE UPVAL U2
  SETTABLEKS R7 R2 K11 ["copyToClipboard"]
  DUPCLOSURE R7 K12 [PROTO_11]
  CAPTURE UPVAL U2
  SETTABLEKS R7 R2 K13 ["getClassIcon"]
  NEWCLOSURE R7 P11
  CAPTURE VAL R1
  SETTABLEKS R7 R2 K14 ["getNetworking"]
  GETUPVAL R7 3
  JUMPIFNOT R5 [+2]
  MOVE R8 R6
  JUMPIF R8 [+1]
  LOADNIL R8
  CALL R7 1 1
  SETTABLEKS R7 R2 K15 ["EventLogger"]
  RETURN R2 1
