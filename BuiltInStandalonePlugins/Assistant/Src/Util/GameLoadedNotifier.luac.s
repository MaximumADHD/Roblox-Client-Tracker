...
PROTO_2:
  ...
  GETUPVAL R0 0
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K3 ["GAME_LOADED_KEY"]
  LOADNIL R3
  NAMECALL R0 R0 K4 ["FireGuest"]
  CALL R0 3 0
  RETURN R0 0
...
PROTO_3:
  ...
  CALL R4 2 0
  GETUPVAL R7 1
  GETTABLEKS R6 R7 K16 ["REQUEST_GAME_LOADED_KEY"]
  NEWCLOSURE R7 P2
  CAPTURE VAL R2
  CAPTURE UPVAL U1
  NAMECALL R4 R2 K17 ["OnHostEvent"]
  CALL R4 3 0
  RETURN R0 0
...
PROTO_4:
  ...
  CALL R4 1 0
  GETUPVAL R7 0
  GETTABLEKS R6 R7 K8 ["REQUEST_GAME_LOADED_KEY"]
  LOADNIL R7
  NAMECALL R4 R0 K9 ["FireHost"]
  CALL R4 3 0
  RETURN R3 1
...
MAIN:
  ...
  LOADK R5 K14 ["GameLoadedNotifier_RequestGameLoaded"]
  SETTABLEKS R5 R4 K15 ["REQUEST_GAME_LOADED_KEY"]
  ...
  CAPTURE VAL R4
  SETTABLEKS R5 R4 K19 ["subscribeGameLoaded"]
  RETURN R4 1
