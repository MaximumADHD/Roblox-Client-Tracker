...
PROTO_4:
  ...
  LENGTH R7 R6
  LOADN R8 0
  JUMPIFNOTLT R8 R7 [+146]
  JUMPIFNOTLT R4 R5 [+144]
...
MAIN:
  ...
  GETTABLEKS R7 R3 K17 ["Util"]
  GETTABLEKS R6 R7 K18 ["ToolBuilder"]
  GETTABLEKS R8 R3 K17 ["Util"]
  GETTABLEKS R7 R8 K19 ["ToolResult"]
  GETIMPORT R8 K9 [require]
  GETTABLEKS R11 R0 K13 ["Src"]
  GETTABLEKS R10 R11 K20 ["Flags"]
  GETTABLEKS R9 R10 K21 ["FIntGameTreeDefaultHeadLimit"]
  CALL R8 1 1
  CALL R8 0 1
  GETIMPORT R9 K9 [require]
  GETTABLEKS R12 R0 K13 ["Src"]
  GETTABLEKS R11 R12 K20 ["Flags"]
  GETTABLEKS R10 R11 K22 ["FIntGameTreeDefaultMaxDepth"]
  CALL R9 1 1
  CALL R9 0 1
  GETIMPORT R10 K9 [require]
  GETTABLEKS R13 R0 K13 ["Src"]
  GETTABLEKS R12 R13 K20 ["Flags"]
  GETTABLEKS R11 R12 K23 ["FIntGameTreeMaxAbsoluteDepth"]
  CALL R10 1 1
  CALL R10 0 1
  NEWTABLE R11 0 3
  LOADK R12 K24 ["^CoreGui"]
  LOADK R13 K25 ["^PlayerGui"]
  LOADK R14 K26 ["^LoadedCode"]
  SETLIST R11 R12 3 [1]
