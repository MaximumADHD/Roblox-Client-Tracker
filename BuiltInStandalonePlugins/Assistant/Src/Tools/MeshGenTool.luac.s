...
PROTO_33:
  GETUPVAL R5 0
  GETTABLEKS R4 R5 K0 ["observeLinkChanges"]
  GETUPVAL R5 1
  MOVE R6 R3
  NEWCLOSURE R7 P0
  CAPTURE UPVAL U2
...
PROTO_34:
  ...
  MOVE R19 R17
  LOADK R21 K32 ["Assistant-MeshGenLink-%*"]
  MOVE R23 R3
  ...
  JUMPIFNOTEQKN R18 K18 [1] [+21]
  LOADK R19 K32 ["Assistant-MeshGenLink-%*"]
  MOVE R21 R3
  NAMECALL R19 R19 K24 ["format"]
  CALL R19 2 1
  MOVE R18 R19
  GETUPVAL R20 4
  GETTABLEKS R19 R20 K33 ["observeLinkChanges"]
  GETUPVAL R20 5
  MOVE R21 R18
  NEWCLOSURE R22 P0
  CAPTURE UPVAL U6
  ...
  JUMPIFNOT R11 [+110]
  JUMPIFNOT R12 [+109]
  GETIMPORT R19 K36 [CFrame.new]
  MOVE R20 R11
  CALL R19 1 1
  GETIMPORT R20 K38 [CFrame.fromOrientation]
  GETTABLEKS R21 R12 K39 ["X"]
  GETTABLEKS R22 R12 K40 ["Y"]
  GETTABLEKS R23 R12 K41 ["Z"]
  CALL R20 3 1
  MUL R18 R19 R20
  MOVE R21 R18
  NAMECALL R19 R17 K42 ["PivotTo"]
  CALL R19 2 0
  ...
  JUMPIFNOT R11 [+29]
  JUMPIFNOT R12 [+28]
  GETTABLEKS R20 R19 K43 ["Size"]
  GETTABLEKS R21 R19 K44 ["Position"]
  GETTABLEKS R23 R19 K46 ["Orientation"]
  MULK R22 R23 K45 [0.0174532925199433]
  MOVE R25 R10
  LOADK R26 K47 [0.01]
  NAMECALL R23 R20 K48 ["FuzzyEq"]
  CALL R23 3 1
  JUMPIFNOT R23 [+15]
  MOVE R25 R11
  LOADK R26 K47 [0.01]
  NAMECALL R23 R21 K48 ["FuzzyEq"]
  CALL R23 3 1
  JUMPIFNOT R23 [+9]
  MOVE R25 R12
  LOADK R26 K47 [0.01]
  NAMECALL R23 R22 K48 ["FuzzyEq"]
  CALL R23 3 1
  JUMPIFNOT R23 [+3]
  LOADNIL R23
  SETTABLEKS R23 R19 K49 ["Parent"]
  DUPTABLE R20 K50 [{"requestId"}]
  ...
  JUMPIFNOT R23 [+13]
  NAMECALL R24 R23 K51 ["Destroy"]
  CALL R24 1 0
  LOADNIL R24
  SETTABLEKS R24 R21 K9 ["boundingBoxGhost"]
  JUMP [+6]
  GETUPVAL R19 4
  GETTABLEKS R18 R19 K52 ["setPositionOnGround"]
  MOVE R19 R17
  LOADB R20 1
  CALL R18 2 0
  GETIMPORT R18 K54 [workspace]
  SETTABLEKS R18 R17 K49 ["Parent"]
  GETTABLEKS R18 R13 K55 ["endRecording"]
  MOVE R19 R2
  CALL R18 1 0
  RETURN R0 0
...
PROTO_72:
  ...
  JUMPIF R4 [+4]
  GETUPVAL R4 3
  NAMECALL R4 R4 K9 ["SendMeshGenActivatedTelemetry"]
  CALL R4 1 0
  LOADNIL R4
  LOADNIL R5
  LOADNIL R6
  ...
  LOADNIL R9
  GETUPVAL R12 4
  GETTABLEKS R11 R12 K11 ["shouldUseSelection"]
  ORK R10 R11 K10 [False]
  GETUPVAL R11 5
  LOADNIL R12
  DUPTABLE R13 K13 [{"requestId", "value"}]
  ...
  CAPTURE UPVAL U1
  CAPTURE UPVAL U13
  DUPTABLE R14 K30 [{"type", "mode", "expanded", "initialUseSelection", "generationName", "generationState", "insertState", "isPublished", "previewInstance", "previewImages", "runGeneration", "cancelGeneration", "publishAssets", "insertMeshPart", "setUseSelection", "shouldShowChip", "onChipClicked"}]
  GETUPVAL R16 7
  GETTABLEKS R15 R16 K31 ["Type"]
  SETTABLEKS R15 R14 K14 ["type"]
  GETUPVAL R16 14
  CALL R16 0 1
  JUMPIFNOT R16 [+6]
  GETUPVAL R17 7
  GETTABLEKS R16 R17 K32 ["Modes"]
  GETTABLEKS R15 R16 K33 ["Generated"]
  JUMP [+1]
  LOADNIL R15
  SETTABLEKS R15 R14 K15 ["mode"]
  LOADB R15 1
  SETTABLEKS R15 R14 K16 ["expanded"]
  SETTABLEKS R10 R14 K17 ["initialUseSelection"]
  ...
  GETTABLEKS R16 R17 K35 ["GenerationState"]
  GETTABLEKS R15 R16 K36 ["GeneratingMesh"]
  JUMP [+7]
  GETUPVAL R18 7
  GETTABLEKS R17 R18 K34 ["Enums"]
  GETTABLEKS R16 R17 K35 ["GenerationState"]
  GETTABLEKS R15 R16 K37 ["None"]
  SETTABLEKS R15 R14 K18 ["generationState"]
  GETUPVAL R18 7
  GETTABLEKS R17 R18 K34 ["Enums"]
  GETTABLEKS R16 R17 K38 ["InsertionState"]
  GETTABLEKS R15 R16 K37 ["None"]
  SETTABLEKS R15 R14 K19 ["insertState"]
  LOADB R15 0
  SETTABLEKS R15 R14 K20 ["isPublished"]
  LOADNIL R15
  SETTABLEKS R15 R14 K21 ["previewInstance"]
  GETIMPORT R15 K41 [table.create]
  LOADN R16 4
  LOADK R17 K8 [""]
  CALL R15 2 1
  SETTABLEKS R15 R14 K22 ["previewImages"]
  NEWCLOSURE R15 P3
  CAPTURE REF R3
  CAPTURE VAL R13
  SETTABLEKS R15 R14 K23 ["runGeneration"]
  NEWCLOSURE R15 P4
  CAPTURE REF R3
  CAPTURE UPVAL U8
  CAPTURE UPVAL U16
  ...
  CAPTURE REF R6
  CAPTURE UPVAL U7
  SETTABLEKS R15 R14 K24 ["cancelGeneration"]
  NEWCLOSURE R15 P5
  CAPTURE VAL R2
  CAPTURE UPVAL U17
  CAPTURE REF R5
  ...
  CAPTURE REF R9
  CAPTURE REF R8
  SETTABLEKS R15 R14 K25 ["publishAssets"]
  NEWCLOSURE R15 P6
  CAPTURE VAL R2
  CAPTURE UPVAL U18
  CAPTURE VAL R0
  ...
  CAPTURE REF R5
  CAPTURE REF R7
  SETTABLEKS R15 R14 K26 ["insertMeshPart"]
  NEWCLOSURE R15 P7
  CAPTURE UPVAL U5
  CAPTURE VAL R1
  SETTABLEKS R15 R14 K27 ["setUseSelection"]
  LOADB R15 0
  SETTABLEKS R15 R14 K28 ["shouldShowChip"]
  NEWCLOSURE R15 P8
  CAPTURE UPVAL U19
  CAPTURE VAL R2
  SETTABLEKS R15 R14 K29 ["onChipClicked"]
  GETUPVAL R15 14
  CALL R15 0 1
  JUMPIFNOT R15 [+16]
  GETUPVAL R16 20
  GETTABLEKS R15 R16 K42 ["editContent"]
  DUPTABLE R16 K46 [{"messageId", "contentId", "transformFn"}]
  SETTABLEKS R0 R16 K43 ["messageId"]
  GETUPVAL R17 11
  SETTABLEKS R17 R16 K44 ["contentId"]
  NEWCLOSURE R17 P9
  CAPTURE UPVAL U21
  CAPTURE VAL R14
  SETTABLEKS R17 R16 K45 ["transformFn"]
  CALL R15 1 0
  JUMP [+23]
  GETUPVAL R15 22
  GETUPVAL R16 4
  CALL R15 1 2
  GETUPVAL R18 20
  GETTABLEKS R17 R18 K47 ["addToolContent"]
  MOVE R18 R0
  DUPTABLE R19 K51 [{"toolUse", "toolResult", "content"}]
  SETTABLEKS R15 R19 K48 ["toolUse"]
  SETTABLEKS R16 R19 K49 ["toolResult"]
  SETTABLEKS R14 R19 K50 ["content"]
  CALL R17 2 1
  SETUPVAL R17 11
  GETUPVAL R18 11
  FASTCALL2K ASSERT R18 K52 [+4]
  LOADK R19 K52 ["Failed to add content"]
  GETIMPORT R17 K54 [assert]
  CALL R17 2 0
  GETUPVAL R15 23
  MOVE R16 R0
  GETUPVAL R17 11
  CALL R15 2 1
  GETTABLEKS R4 R15 K55 ["updateGenState"]
  GETTABLEKS R5 R15 K56 ["updateInsertState"]
  GETTABLEKS R6 R15 K57 ["setGenerationFailure"]
  GETTABLEKS R7 R15 K58 ["setInsertionFailure"]
  GETTABLEKS R8 R15 K59 ["setPreviewInstance"]
  GETTABLEKS R9 R15 K60 ["setIsPublished"]
  GETUPVAL R16 15
  JUMPIFNOT R16 [+3]
  GETTABLEKS R16 R14 K23 ["runGeneration"]
  CALL R16 0 0
  CLOSEUPVALS R3
  RETURN R0 0
...
PROTO_81:
  ...
  DUPCLOSURE R37 K60 [PROTO_78]
  CAPTURE UPVAL U7
  DUPTABLE R38 K67 [{"definition", "slashCommands", "streamTransform", "getPreExecuteWarning", "displayNameFunction", "toolCallOptions"}]
  SETTABLEKS R35 R38 K61 ["definition"]
  NEWTABLE R39 0 1
  MOVE R40 R36
  SETLIST R39 R40 1 [1]
  SETTABLEKS R39 R38 K62 ["slashCommands"]
  GETUPVAL R40 15
  CALL R40 0 1
  JUMPIFNOT R40 [+4]
  DUPTABLE R39 K69 [{"transformInitialContent"}]
  SETTABLEKS R37 R39 K68 ["transformInitialContent"]
  JUMP [+3]
  GETUPVAL R40 27
  GETTABLEKS R39 R40 K70 ["None"]
  SETTABLEKS R39 R38 K63 ["streamTransform"]
  DUPCLOSURE R39 K71 [PROTO_79]
  SETTABLEKS R39 R38 K64 ["getPreExecuteWarning"]
  DUPCLOSURE R39 K72 [PROTO_80]
  CAPTURE UPVAL U18
  SETTABLEKS R39 R38 K65 ["displayNameFunction"]
  GETUPVAL R40 15
  CALL R40 0 1
  JUMPIFNOT R40 [+5]
  DUPTABLE R39 K74 [{"resetTimeoutOnProgress"}]
  LOADB R40 1
  SETTABLEKS R40 R39 K73 ["resetTimeoutOnProgress"]
  JUMP [+1]
  LOADNIL R39
  SETTABLEKS R39 R38 K66 ["toolCallOptions"]
  RETURN R38 1
...
MAIN:
  ...
  GETTABLEKS R12 R13 K22 ["ContentWidgets"]
  GETTABLEKS R11 R12 K23 ["MeshGenContentWidget"]
  CALL R10 1 1
  GETIMPORT R11 K16 [require]
  GETTABLEKS R13 R0 K17 ["Packages"]
  GETTABLEKS R12 R13 K24 ["ModelContextProtocol"]
  CALL R11 1 1
  ...
  GETTABLEKS R15 R16 K26 ["Tools"]
  GETTABLEKS R14 R15 K27 ["ToolTypes"]
  CALL R13 1 1
  ...
  GETTABLEKS R20 R21 K35 ["FFlagDebugConvAIMeshGenDynamicPreview"]
  CALL R19 1 1
  GETIMPORT R20 K16 [require]
  GETTABLEKS R23 R0 K20 ["Src"]
  GETTABLEKS R22 R23 K31 ["Flags"]
  GETTABLEKS R21 R22 K36 ["FFlagMCPAssistantLongRunningToolCalls"]
  CALL R20 1 1
  GETIMPORT R21 K16 [require]
  GETTABLEKS R24 R0 K20 ["Src"]
  GETTABLEKS R23 R24 K31 ["Flags"]
  GETTABLEKS R22 R23 K37 ["FFlagMCPAssistantSlashCommandMenu"]
  CALL R21 1 1
  GETTABLEKS R24 R8 K38 ["Resources"]
  GETTABLEKS R23 R24 K39 ["Localization"]
  GETTABLEKS R22 R23 K40 ["Translator"]
  GETTABLEKS R24 R8 K41 ["Guest"]
  GETTABLEKS R23 R24 K42 ["Environment"]
  GETTABLEKS R25 R8 K21 ["Components"]
  GETTABLEKS R24 R25 K43 ["ExternalHooks"]
  GETTABLEKS R26 R8 K30 ["Utils"]
  GETTABLEKS R25 R26 K26 ["Tools"]
  GETTABLEKS R26 R8 K44 ["UIToolRegistry"]
  GETTABLEKS R28 R11 K29 ["Util"]
  GETTABLEKS R27 R28 K45 ["ToolBuilder"]
  GETTABLEKS R29 R11 K29 ["Util"]
  GETTABLEKS R28 R29 K46 ["ToolResult"]
  GETTABLEKS R29 R13 K47 ["ToolNames"]
  MOVE R30 R28
  CALL R30 0 1
  LOADK R32 K48 ["Success"]
  NAMECALL R30 R30 K49 ["addText"]
  CALL R30 2 1
  NAMECALL R30 R30 K50 ["build"]
  CALL R30 1 1
  NEWTABLE R31 0 0
  NEWTABLE R32 0 0
  LOADN R33 0
  DUPCLOSURE R34 K51 [PROTO_0]
  CAPTURE VAL R25
  CAPTURE VAL R29
  CAPTURE VAL R30
  DUPCLOSURE R35 K52 [PROTO_1]
  CAPTURE VAL R32
  DUPCLOSURE R36 K53 [PROTO_2]
  CAPTURE VAL R19
  NEWCLOSURE R37 P3
  CAPTURE VAL R19
  CAPTURE VAL R2
