...
PROTO_23:
  ...
  JUMPIFNOT R2 [+10]
  GETUPVAL R4 1
  GETTABLEKS R3 R4 K4 ["get"]
  CALL R3 0 1
  GETTABLEKS R2 R3 K5 ["getScriptSource"]
  MOVE R3 R0
  CALL R2 1 1
  MOVE R1 R2
  JUMP [+2]
  GETTABLEKS R1 R0 K6 ["Source"]
  JUMPIFNOT R1 [+3]
  JUMPIFEQKS R1 K7 [""] [+2]
  RETURN R1 1
  LOADNIL R1
...
PROTO_29:
  ...
  JUMPIF R4 [+1]
  RETURN R3 1
  NAMECALL R5 R0 K0 ["GetFullName"]
  CALL R5 1 1
  GETUPVAL R6 1
  MOVE R7 R4
  GETTABLEKS R8 R1 K1 ["patternMatcher"]
  GETTABLEKS R9 R1 K2 ["multiline"]
  CALL R6 3 1
  LENGTH R7 R6
  LOADN R8 0
  JUMPIFNOTLT R8 R7 [+51]
  GETTABLEKS R7 R1 K3 ["outputMode"]
  JUMPIFNOTEQKS R7 K4 ["files_with_matches"] [+10]
  ...
  RETURN R3 1
  GETTABLEKS R7 R1 K3 ["outputMode"]
  JUMPIFNOTEQKS R7 K14 ["content"] [+17]
  GETUPVAL R7 2
  MOVE R8 R2
  MOVE R9 R5
  MOVE R10 R4
  MOVE R11 R6
  GETTABLEKS R12 R1 K15 ["showLineNumbers"]
  GETTABLEKS R13 R1 K16 ["contextBefore"]
  GETTABLEKS R14 R1 K17 ["contextAfter"]
  GETTABLEKS R15 R1 K18 ["headLimit"]
  MOVE R16 R3
  CALL R7 9 1
  MOVE R3 R7
  RETURN R3 1
...
MAIN:
  ...
  GETTABLEKS R8 R4 K18 ["ToolNames"]
  GETTABLEKS R10 R1 K19 ["Guest"]
  GETTABLEKS R9 R10 K20 ["Environment"]
  ...
  NEWCLOSURE R25 P14
  CAPTURE REF R23
  DUPCLOSURE R26 K31 [PROTO_18]
  DUPCLOSURE R23 K32 [PROTO_20]
  CAPTURE VAL R24
  CAPTURE VAL R25
  CAPTURE VAL R26
  DUPCLOSURE R27 K33 [PROTO_21]
  DUPCLOSURE R28 K34 [PROTO_22]
  DUPCLOSURE R29 K35 [PROTO_23]
  CAPTURE VAL R5
  CAPTURE VAL R9
  DUPCLOSURE R30 K36 [PROTO_24]
  NEWCLOSURE R31 P21
  CAPTURE REF R23
  DUPCLOSURE R32 K37 [PROTO_26]
  DUPCLOSURE R33 K38 [PROTO_27]
  DUPCLOSURE R34 K39 [PROTO_28]
  CAPTURE VAL R22
  CAPTURE VAL R18
  DUPCLOSURE R35 K40 [PROTO_29]
  CAPTURE VAL R29
  CAPTURE VAL R32
  CAPTURE VAL R33
  DUPCLOSURE R36 K41 [PROTO_30]
  CAPTURE VAL R34
  CAPTURE VAL R30
  CAPTURE VAL R31
  CAPTURE VAL R35
  DUPCLOSURE R37 K42 [PROTO_33]
  CAPTURE VAL R36
  CAPTURE VAL R7
  CAPTURE VAL R6
  CAPTURE VAL R8
