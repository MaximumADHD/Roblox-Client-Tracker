...
PROTO_23:
  ...
  CALL R2 0 1
  GETTABLEKS R1 R2 K5 ["getScriptSource"]
  MOVE R2 R0
  CALL R1 1 1
  JUMPIFNOT R1 [+3]
  JUMPIFEQKS R1 K6 [""] [+2]
...
MAIN:
  ...
  GETTABLEKS R8 R1 K16 ["Guest"]
  GETTABLEKS R7 R8 K17 ["Environment"]
  ...
  NEWCLOSURE R23 P14
  CAPTURE REF R21
  DUPCLOSURE R24 K28 [PROTO_18]
  DUPCLOSURE R21 K29 [PROTO_20]
  CAPTURE VAL R22
  CAPTURE VAL R23
  CAPTURE VAL R24
  DUPCLOSURE R25 K30 [PROTO_21]
  DUPCLOSURE R26 K31 [PROTO_22]
  DUPCLOSURE R27 K32 [PROTO_23]
  CAPTURE VAL R7
  DUPCLOSURE R28 K33 [PROTO_24]
  NEWCLOSURE R29 P21
  CAPTURE REF R21
  DUPCLOSURE R30 K34 [PROTO_26]
  DUPCLOSURE R31 K35 [PROTO_27]
  DUPCLOSURE R32 K36 [PROTO_28]
  CAPTURE VAL R20
  CAPTURE VAL R16
  DUPCLOSURE R33 K37 [PROTO_29]
  CAPTURE VAL R27
  CAPTURE VAL R30
  CAPTURE VAL R31
  DUPCLOSURE R34 K38 [PROTO_30]
  CAPTURE VAL R32
  CAPTURE VAL R28
  CAPTURE VAL R29
  CAPTURE VAL R33
  DUPCLOSURE R35 K39 [PROTO_33]
  CAPTURE VAL R34
  CAPTURE VAL R5
  CAPTURE VAL R4
  CAPTURE VAL R6
