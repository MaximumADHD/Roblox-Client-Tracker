...
PROTO_7:
  ...
  CALL R5 2 1
  LOADK R8 K8 ["Upload a batch of images from http server to Roblox Asset Server, returning imagePath to assetId map, "]
  LOADK R9 K9 ["such as {\"http://localhost/image.png\" : \"rbxassetid://12345678\", \"https://www.figma.com/api/mcp/asset/6dcff81e-b394-4640-b3b1-123456789\" : \"rbxassetid://12345679\"}."]
  CONCAT R7 R8 R9
  NAMECALL R5 R5 K10 ["setDescription"]
  CALL R5 2 1
  LOADK R7 K11 ["imagePaths"]
  DUPTABLE R8 K15 [{"type", "description", "items"}]
  LOADK R9 K16 ["array"]
  SETTABLEKS R9 R8 K12 ["type"]
  LOADK R9 K17 ["An array of image paths to be uploaded."]
  SETTABLEKS R9 R8 K13 ["description"]
  DUPTABLE R9 K18 [{"type"}]
  LOADK R10 K19 ["string"]
  SETTABLEKS R10 R9 K12 ["type"]
  SETTABLEKS R9 R8 K14 ["items"]
  NAMECALL R5 R5 K20 ["addArgument"]
  CALL R5 3 1
  MOVE R7 R4
  NAMECALL R5 R5 K21 ["setHandler"]
  CALL R5 2 1
  NAMECALL R5 R5 K22 ["build"]
  CALL R5 1 1
  DUPTABLE R6 K27 [{"toolCallOptions", "definition", "getPreExecuteWarning", "displayNameFunction"}]
  DUPTABLE R7 K29 [{"timeout"}]
  LOADK R8 K30 [200000000]
  SETTABLEKS R8 R7 K28 ["timeout"]
  SETTABLEKS R7 R6 K23 ["toolCallOptions"]
  SETTABLEKS R5 R6 K24 ["definition"]
  DUPCLOSURE R7 K31 [PROTO_5]
  SETTABLEKS R7 R6 K25 ["getPreExecuteWarning"]
  DUPCLOSURE R7 K32 [PROTO_6]
  CAPTURE UPVAL U5
  SETTABLEKS R7 R6 K26 ["displayNameFunction"]
  RETURN R6 1
