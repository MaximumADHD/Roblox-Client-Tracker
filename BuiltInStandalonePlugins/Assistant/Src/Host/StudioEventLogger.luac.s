...
MAIN:
  ...
  NEWTABLE R19 0 0
  GETTABLEKS R23 R5 K31 ["Backends"]
  GETTABLEKS R22 R23 K32 ["EventIngest"]
  FASTCALL2 TABLE_INSERT R19 R22 [+4]
  MOVE R21 R19
  GETIMPORT R20 K34 [table.insert]
  CALL R20 2 0
  GETTABLEKS R23 R5 K31 ["Backends"]
  GETTABLEKS R22 R23 K35 ["Points"]
  FASTCALL2 TABLE_INSERT R19 R22 [+4]
  MOVE R21 R19
  GETIMPORT R20 K34 [table.insert]
  CALL R20 2 0
  MOVE R18 R19
  CALL R17 1 1
  GETIMPORT R18 K30 [table.freeze]
  DUPTABLE R19 K40 [{"eventName", "backends", "description", "lastUpdated"}]
  LOADK R21 K41 ["%*%*"]
  LOADK R23 K42 ["StudioAssistant"]
  LOADK R24 K43 ["UserMessageSent"]
  NAMECALL R21 R21 K44 ["format"]
  CALL R21 3 1
  MOVE R20 R21
  SETTABLEKS R20 R19 K36 ["eventName"]
  NEWTABLE R20 0 1
  GETTABLEKS R22 R5 K31 ["Backends"]
  GETTABLEKS R21 R22 K45 ["RobloxTelemetryCounter"]
  SETLIST R20 R21 1 [1]
  SETTABLEKS R20 R19 K37 ["backends"]
  LOADK R20 K46 ["Incrementing count of user messages sent."]
  SETTABLEKS R20 R19 K38 ["description"]
  NEWTABLE R20 0 3
  LOADN R21 25
  LOADN R22 7
  LOADN R23 21
  SETLIST R20 R21 3 [1]
  SETTABLEKS R20 R19 K39 ["lastUpdated"]
  CALL R18 1 1
  GETIMPORT R19 K30 [table.freeze]
  DUPTABLE R20 K48 [{"eventName", "backends", "description", "throttlingPercentage", "lastUpdated"}]
  LOADK R21 K49 ["CAPMessageSent"]
  SETTABLEKS R21 R20 K36 ["eventName"]
  SETTABLEKS R17 R20 K37 ["backends"]
  LOADK R21 K50 ["User message sent event with request ID."]
  SETTABLEKS R21 R20 K38 ["description"]
  MOVE R21 R9
  CALL R21 0 1
  SETTABLEKS R21 R20 K47 ["throttlingPercentage"]
  NEWTABLE R21 0 3
  LOADN R22 25
  LOADN R23 7
  LOADN R24 25
  SETLIST R21 R22 3 [1]
  SETTABLEKS R21 R20 K39 ["lastUpdated"]
  CALL R19 1 1
  GETIMPORT R20 K30 [table.freeze]
  DUPTABLE R21 K40 [{"eventName", "backends", "description", "lastUpdated"}]
  LOADK R22 K51 ["CAPAPIKeyAdded"]
  SETTABLEKS R22 R21 K36 ["eventName"]
  SETTABLEKS R17 R21 K37 ["backends"]
  LOADK R22 K52 ["User added an API key for an LLM provider."]
  SETTABLEKS R22 R21 K38 ["description"]
  NEWTABLE R22 0 3
  LOADN R23 25
  LOADN R24 11
  LOADN R25 4
  SETLIST R22 R23 3 [1]
  SETTABLEKS R22 R21 K39 ["lastUpdated"]
  CALL R20 1 1
  GETIMPORT R21 K30 [table.freeze]
  DUPTABLE R22 K40 [{"eventName", "backends", "description", "lastUpdated"}]
  LOADK R23 K53 ["CAPUserFeedbackThumbsUp"]
  SETTABLEKS R23 R22 K36 ["eventName"]
  SETTABLEKS R17 R22 K37 ["backends"]
  LOADK R23 K54 ["User feedback thumbs up event with message context."]
  SETTABLEKS R23 R22 K38 ["description"]
  NEWTABLE R23 0 3
  LOADN R24 25
  LOADN R25 7
  LOADN R26 25
  SETLIST R23 R24 3 [1]
  SETTABLEKS R23 R22 K39 ["lastUpdated"]
  CALL R21 1 1
  GETIMPORT R22 K30 [table.freeze]
  DUPTABLE R23 K40 [{"eventName", "backends", "description", "lastUpdated"}]
  LOADK R24 K55 ["CAPUserFeedbackThumbsDown"]
  SETTABLEKS R24 R23 K36 ["eventName"]
  SETTABLEKS R17 R23 K37 ["backends"]
  LOADK R24 K56 ["User feedback thumbs down event with message context."]
  SETTABLEKS R24 R23 K38 ["description"]
  NEWTABLE R24 0 3
  LOADN R25 25
  LOADN R26 7
  LOADN R27 25
  SETLIST R24 R25 3 [1]
  SETTABLEKS R24 R23 K39 ["lastUpdated"]
  CALL R22 1 1
  GETIMPORT R23 K30 [table.freeze]
  DUPTABLE R24 K40 [{"eventName", "backends", "description", "lastUpdated"}]
  LOADK R26 K41 ["%*%*"]
  LOADK R28 K42 ["StudioAssistant"]
  LOADK R29 K57 ["ThumbsUp"]
  NAMECALL R26 R26 K44 ["format"]
  CALL R26 3 1
  MOVE R25 R26
  SETTABLEKS R25 R24 K36 ["eventName"]
  NEWTABLE R25 0 1
  GETTABLEKS R27 R5 K31 ["Backends"]
  GETTABLEKS R26 R27 K45 ["RobloxTelemetryCounter"]
  SETLIST R25 R26 1 [1]
  SETTABLEKS R25 R24 K37 ["backends"]
  LOADK R25 K58 ["Incrementing count of thumbs up events."]
  SETTABLEKS R25 R24 K38 ["description"]
  NEWTABLE R25 0 3
  LOADN R26 25
  LOADN R27 7
  LOADN R28 21
  SETLIST R25 R26 3 [1]
  SETTABLEKS R25 R24 K39 ["lastUpdated"]
  CALL R23 1 1
  GETIMPORT R24 K30 [table.freeze]
  DUPTABLE R25 K40 [{"eventName", "backends", "description", "lastUpdated"}]
  LOADK R27 K41 ["%*%*"]
  LOADK R29 K42 ["StudioAssistant"]
  LOADK R30 K59 ["ThumbsDown"]
  NAMECALL R27 R27 K44 ["format"]
  CALL R27 3 1
  MOVE R26 R27
  SETTABLEKS R26 R25 K36 ["eventName"]
  NEWTABLE R26 0 1
  GETTABLEKS R28 R5 K31 ["Backends"]
  GETTABLEKS R27 R28 K45 ["RobloxTelemetryCounter"]
  SETLIST R26 R27 1 [1]
  SETTABLEKS R26 R25 K37 ["backends"]
  LOADK R26 K60 ["Incrementing count of thumbs down events."]
  SETTABLEKS R26 R25 K38 ["description"]
  NEWTABLE R26 0 3
  LOADN R27 25
  LOADN R28 7
  LOADN R29 21
  SETLIST R26 R27 3 [1]
  SETTABLEKS R26 R25 K39 ["lastUpdated"]
  CALL R24 1 1
  GETIMPORT R25 K30 [table.freeze]
  DUPTABLE R26 K40 [{"eventName", "backends", "description", "lastUpdated"}]
  LOADK R28 K41 ["%*%*"]
  LOADK R30 K42 ["StudioAssistant"]
  LOADK R31 K61 ["InitialResponseLatency"]
  NAMECALL R28 R28 K44 ["format"]
  CALL R28 3 1
  MOVE R27 R28
  SETTABLEKS R27 R26 K36 ["eventName"]
  NEWTABLE R27 0 1
  GETTABLEKS R29 R5 K31 ["Backends"]
  GETTABLEKS R28 R29 K62 ["RobloxTelemetryStat"]
  SETLIST R27 R28 1 [1]
  SETTABLEKS R27 R26 K37 ["backends"]
  LOADK R27 K63 ["Initial response latency, in seconds. Time between making initial HTTP request and receiving first SignalR message."]
  SETTABLEKS R27 R26 K38 ["description"]
  NEWTABLE R27 0 3
  LOADN R28 25
  LOADN R29 7
  LOADN R30 21
  SETLIST R27 R28 3 [1]
  SETTABLEKS R27 R26 K39 ["lastUpdated"]
  CALL R25 1 1
  GETIMPORT R26 K30 [table.freeze]
  DUPTABLE R27 K40 [{"eventName", "backends", "description", "lastUpdated"}]
  LOADK R29 K41 ["%*%*"]
  LOADK R31 K42 ["StudioAssistant"]
  LOADK R32 K64 ["RequestJourney"]
  NAMECALL R29 R29 K44 ["format"]
  CALL R29 3 1
  MOVE R28 R29
  SETTABLEKS R28 R27 K36 ["eventName"]
  NEWTABLE R28 0 1
  GETTABLEKS R30 R5 K31 ["Backends"]
  GETTABLEKS R29 R30 K62 ["RobloxTelemetryStat"]
  SETLIST R28 R29 1 [1]
  SETTABLEKS R28 R27 K37 ["backends"]
  LOADK R28 K65 ["User request journey duration in seconds. Time between sending first message to request ended."]
  SETTABLEKS R28 R27 K38 ["description"]
  NEWTABLE R28 0 3
  LOADN R29 25
  LOADN R30 10
  LOADN R31 22
  SETLIST R28 R29 3 [1]
  SETTABLEKS R28 R27 K39 ["lastUpdated"]
  CALL R26 1 1
  GETIMPORT R27 K30 [table.freeze]
  DUPTABLE R28 K40 [{"eventName", "backends", "description", "lastUpdated"}]
  LOADK R29 K66 ["CAPRequestJourney"]
  SETTABLEKS R29 R28 K36 ["eventName"]
  SETTABLEKS R17 R28 K37 ["backends"]
  LOADK R29 K67 ["User request journey detail."]
  SETTABLEKS R29 R28 K38 ["description"]
  NEWTABLE R29 0 3
  LOADN R30 25
  LOADN R31 11
  LOADN R32 1
  SETLIST R29 R30 3 [1]
  SETTABLEKS R29 R28 K39 ["lastUpdated"]
  CALL R27 1 1
  GETIMPORT R28 K30 [table.freeze]
  DUPTABLE R29 K40 [{"eventName", "backends", "description", "lastUpdated"}]
  LOADK R31 K41 ["%*%*"]
  LOADK R33 K42 ["StudioAssistant"]
  LOADK R34 K68 ["ErrorEvent"]
  NAMECALL R31 R31 K44 ["format"]
  CALL R31 3 1
  MOVE R30 R31
  SETTABLEKS R30 R29 K36 ["eventName"]
  NEWTABLE R30 0 1
  GETTABLEKS R32 R5 K31 ["Backends"]
  GETTABLEKS R31 R32 K45 ["RobloxTelemetryCounter"]
  SETLIST R30 R31 1 [1]
  SETTABLEKS R30 R29 K37 ["backends"]
  LOADK R30 K69 ["Incrementing count of error events with error type attached."]
  SETTABLEKS R30 R29 K38 ["description"]
  NEWTABLE R30 0 3
  LOADN R31 25
  LOADN R32 7
  LOADN R33 21
  SETLIST R30 R31 3 [1]
  SETTABLEKS R30 R29 K39 ["lastUpdated"]
  CALL R28 1 1
  GETIMPORT R29 K30 [table.freeze]
  DUPTABLE R30 K48 [{"eventName", "backends", "description", "throttlingPercentage", "lastUpdated"}]
  LOADK R32 K41 ["%*%*"]
  LOADK R34 K42 ["StudioAssistant"]
  LOADK R35 K70 ["MarkdownError"]
  NAMECALL R32 R32 K44 ["format"]
  CALL R32 3 1
  MOVE R31 R32
  SETTABLEKS R31 R30 K36 ["eventName"]
  NEWTABLE R31 0 1
  GETTABLEKS R33 R5 K31 ["Backends"]
  GETTABLEKS R32 R33 K35 ["Points"]
  SETLIST R31 R32 1 [1]
  SETTABLEKS R31 R30 K37 ["backends"]
  LOADK R31 K71 ["Collection of markdown error events, with markdown attached."]
  SETTABLEKS R31 R30 K38 ["description"]
  MOVE R31 R8
  CALL R31 0 1
  SETTABLEKS R31 R30 K47 ["throttlingPercentage"]
  NEWTABLE R31 0 3
  LOADN R32 25
  LOADN R33 7
  LOADN R34 21
  SETLIST R31 R32 3 [1]
  SETTABLEKS R31 R30 K39 ["lastUpdated"]
  CALL R29 1 1
  GETIMPORT R30 K30 [table.freeze]
  DUPTABLE R31 K40 [{"eventName", "backends", "description", "lastUpdated"}]
  LOADK R32 K72 ["CAPMessageResubmitted"]
  SETTABLEKS R32 R31 K36 ["eventName"]
  SETTABLEKS R17 R31 K37 ["backends"]
  LOADK R32 K73 ["User message retry/resubmit event with request ID."]
  SETTABLEKS R32 R31 K38 ["description"]
  NEWTABLE R32 0 3
  LOADN R33 25
  LOADN R34 8
  LOADN R35 7
  SETLIST R32 R33 3 [1]
  SETTABLEKS R32 R31 K39 ["lastUpdated"]
  CALL R30 1 1
  GETIMPORT R31 K30 [table.freeze]
  DUPTABLE R32 K40 [{"eventName", "backends", "description", "lastUpdated"}]
  LOADK R33 K74 ["CAPStopGeneration"]
  SETTABLEKS R33 R32 K36 ["eventName"]
  SETTABLEKS R17 R32 K37 ["backends"]
  LOADK R33 K75 ["User stop generation event with request ID."]
  SETTABLEKS R33 R32 K38 ["description"]
  NEWTABLE R33 0 3
  LOADN R34 25
  LOADN R35 8
  LOADN R36 7
  SETLIST R33 R34 3 [1]
  SETTABLEKS R33 R32 K39 ["lastUpdated"]
  CALL R31 1 1
  GETIMPORT R32 K30 [table.freeze]
  DUPTABLE R33 K40 [{"eventName", "backends", "description", "lastUpdated"}]
  LOADK R34 K76 ["CAPToolEnded"]
  SETTABLEKS R34 R33 K36 ["eventName"]
  SETTABLEKS R17 R33 K37 ["backends"]
  LOADK R34 K77 ["Tool invocation ended event with request ID and tool name"]
  SETTABLEKS R34 R33 K38 ["description"]
  NEWTABLE R34 0 3
  LOADN R35 25
  LOADN R36 7
  LOADN R37 21
  SETLIST R34 R35 3 [1]
  SETTABLEKS R34 R33 K39 ["lastUpdated"]
  CALL R32 1 1
  GETIMPORT R33 K30 [table.freeze]
  DUPTABLE R34 K40 [{"eventName", "backends", "description", "lastUpdated"}]
  LOADK R35 K78 ["CAPToolStarted"]
  SETTABLEKS R35 R34 K36 ["eventName"]
  SETTABLEKS R17 R34 K37 ["backends"]
  LOADK R35 K79 ["Tool invocation started event with request ID and tool name."]
  SETTABLEKS R35 R34 K38 ["description"]
  NEWTABLE R35 0 3
  LOADN R36 25
  LOADN R37 8
  LOADN R38 7
  SETLIST R35 R36 3 [1]
  SETTABLEKS R35 R34 K39 ["lastUpdated"]
  CALL R33 1 1
  GETIMPORT R34 K30 [table.freeze]
  DUPTABLE R35 K40 [{"eventName", "backends", "description", "lastUpdated"}]
  LOADK R36 K80 ["CAPToolConfirmationShown"]
  SETTABLEKS R36 R35 K36 ["eventName"]
  SETTABLEKS R17 R35 K37 ["backends"]
  LOADK R36 K81 ["Tool confirmation dialog shown event with request ID, tool name, and warning message."]
  SETTABLEKS R36 R35 K38 ["description"]
  NEWTABLE R36 0 3
  LOADN R37 25
  LOADN R38 9
  LOADN R39 19
  SETLIST R36 R37 3 [1]
  SETTABLEKS R36 R35 K39 ["lastUpdated"]
  CALL R34 1 1
  GETIMPORT R35 K30 [table.freeze]
  DUPTABLE R36 K40 [{"eventName", "backends", "description", "lastUpdated"}]
  LOADK R37 K82 ["CAPToolConfirmationResult"]
  SETTABLEKS R37 R36 K36 ["eventName"]
  SETTABLEKS R17 R36 K37 ["backends"]
  LOADK R37 K83 ["Tool confirmation dialog result event with request ID and user choice."]
  SETTABLEKS R37 R36 K38 ["description"]
  NEWTABLE R37 0 3
  LOADN R38 25
  LOADN R39 9
  LOADN R40 19
  SETLIST R37 R38 3 [1]
  SETTABLEKS R37 R36 K39 ["lastUpdated"]
  CALL R35 1 1
  DUPCLOSURE R36 K84 [PROTO_3]
  CAPTURE VAL R13
  DUPCLOSURE R37 K85 [PROTO_4]
  CAPTURE VAL R13
  CAPTURE VAL R1
  DUPCLOSURE R38 K86 [PROTO_5]
  DUPCLOSURE R39 K87 [PROTO_6]
  CAPTURE VAL R4
  MOVE R40 R10
  CALL R40 0 1
  GETTABLEKS R41 R12 K88 ["new"]
  MOVE R42 R2
  MOVE R43 R11
  CALL R43 0 -1
  CALL R41 -1 1
  DUPCLOSURE R42 K89 [PROTO_7]
  CAPTURE VAL R41
  CAPTURE VAL R40
  DUPCLOSURE R43 K90 [PROTO_8]
  CAPTURE VAL R4
  CAPTURE VAL R41
  CAPTURE VAL R40
  DUPCLOSURE R44 K91 [PROTO_24]
  CAPTURE VAL R5
  CAPTURE VAL R18
  CAPTURE VAL R4
  CAPTURE VAL R41
