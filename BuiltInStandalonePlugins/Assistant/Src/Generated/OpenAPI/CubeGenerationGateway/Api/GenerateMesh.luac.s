PROTO_0:
        0 GETUPVAL                         R7 0
        1 GETTABLEKS                       R7 R7 K0 ["buildRequest"]
        3 LOADK                            R8 K1 ["POST"]
        4 GETUPVAL                         R9 1
        5 GETTABLEKS                       R9 R9 K2 ["host"]
        7 LOADK                            R10 K3 ["/api/v1/mesh-generations"]
        8 GETUPVAL                         R11 1
        9 GETTABLEKS                       R11 R11 K4 ["pathPrefix"]
       11 GETUPVAL                         R12 1
       12 GETTABLEKS                       R12 R12 K5 ["baseUrl"]
       14 CALL                             R7 5 1
       15 LOADK                            R9 K6 ["robloxctx-rcc"]
       16 MOVE                             R10 R0
       17 NAMECALL                         R7 R7 K7 ["addHeaderParameter"]
       19 CALL                             R7 3 1
       20 LOADK                            R9 K8 ["roblox-universe-id"]
       21 MOVE                             R10 R1
       22 NAMECALL                         R7 R7 K7 ["addHeaderParameter"]
       24 CALL                             R7 3 1
       25 LOADK                            R9 K9 ["robloxctx-authenticated-userid"]
       26 MOVE                             R10 R2
       27 NAMECALL                         R7 R7 K7 ["addHeaderParameter"]
       29 CALL                             R7 3 1
       30 LOADK                            R9 K10 ["roblox-place-id"]
       31 MOVE                             R10 R3
       32 NAMECALL                         R7 R7 K7 ["addHeaderParameter"]
       34 CALL                             R7 3 1
       35 LOADK                            R9 K11 ["roblox-game-id"]
       36 MOVE                             R10 R4
       37 NAMECALL                         R7 R7 K7 ["addHeaderParameter"]
       39 CALL                             R7 3 1
       40 LOADK                            R9 K12 ["generation-service-user-id"]
       41 MOVE                             R10 R5
       42 NAMECALL                         R7 R7 K7 ["addHeaderParameter"]
       44 CALL                             R7 3 1
       45 GETUPVAL                         R9 2
       46 MOVE                             R10 R6
       47 NAMECALL                         R7 R7 K13 ["setBody"]
       49 CALL                             R7 3 1
       50 GETUPVAL                         R9 3
       51 NAMECALL                         R7 R7 K14 ["sendAsync"]
       53 CALL                             R7 2 -1
       54 RETURN                           R7 -1
...
PROTO_1:
       ...
       14 CALL                             R6 5 1
       15 LOADK                            R8 K6 ["{meshGenerationId}"]
       16 MOVE                             R9 R5
...
MAIN:
       ...
       27 GETTABLEKS                       R6 R6 K11 ["GenerateMeshRequest"]
       29 CALL                             R5 1 1
       30 GETIMPORT                        R6 K7 [require]
       32 GETTABLEKS                       R7 R0 K10 ["Models"]
       34 GETTABLEKS                       R7 R7 K12 ["GenerateMeshResponse"]
       36 CALL                             R6 1 1
       37 GETIMPORT                        R7 K7 [require]
       39 GETTABLEKS                       R8 R0 K10 ["Models"]
       41 GETTABLEKS                       R8 R8 K13 ["GetMeshGenerationStatusResponse"]
       43 CALL                             R7 1 1
       44 NEWTABLE                         R8 2 0
