PROTO_0:
       ...
       19 CALL                             R1 3 1
       20 GETUPVAL                         R3 3
       21 NAMECALL                         R1 R1 K7 ["sendAsync"]
       23 CALL                             R1 2 -1
       24 RETURN                           R1 -1
...
MAIN:
       ...
       27 GETTABLEKS                       R6 R6 K11 ["GenerateMaterialRequest"]
       29 CALL                             R5 1 1
       30 GETIMPORT                        R6 K7 [require]
       32 GETTABLEKS                       R7 R0 K10 ["Models"]
       34 GETTABLEKS                       R7 R7 K12 ["GenerateMaterialOperationResponse"]
       36 CALL                             R6 1 1
       37 GETIMPORT                        R7 K7 [require]
       39 GETTABLEKS                       R8 R0 K10 ["Models"]
       41 GETTABLEKS                       R8 R8 K13 ["GetGenerateMaterialRequest"]
       43 CALL                             R7 1 1
       44 GETIMPORT                        R8 K7 [require]
       46 GETTABLEKS                       R9 R0 K10 ["Models"]
       48 GETTABLEKS                       R9 R9 K14 ["GetGenerateMaterialOperationResponse"]
       50 CALL                             R8 1 1
       51 GETIMPORT                        R9 K7 [require]
       53 GETTABLEKS                       R10 R0 K10 ["Models"]
       55 GETTABLEKS                       R10 R10 K15 ["UploadMaterialAsyncRequest"]
       57 CALL                             R9 1 1
       58 GETIMPORT                        R10 K7 [require]
       60 GETTABLEKS                       R11 R0 K10 ["Models"]
       62 GETTABLEKS                       R11 R11 K16 ["UploadMaterialAsyncResponse"]
       64 CALL                             R10 1 1
       65 GETIMPORT                        R11 K7 [require]
       67 GETTABLEKS                       R12 R0 K10 ["Models"]
       69 GETTABLEKS                       R12 R12 K17 ["GetUploadMaterialAsyncRequest"]
       71 CALL                             R11 1 1
       72 GETIMPORT                        R12 K7 [require]
       74 GETTABLEKS                       R13 R0 K10 ["Models"]
       76 GETTABLEKS                       R13 R13 K18 ["GetUploadMaterialAsyncResponse"]
       78 CALL                             R12 1 1
       79 NEWTABLE                         R13 8 0
