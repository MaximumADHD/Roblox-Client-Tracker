PROTO_0:
       ...
       84 CALL                             R3 2 0
       85 GETTABLEKS                       R3 R0 K13 ["data"]
       87 JUMPIFEQKNIL                     R3 ; [+86]
       89 GETTABLEKS                       R4 R0 K13 ["data"]
       91 FASTCALL1                        TYPEOF R4 ; [+2]
       92 GETIMPORT                        R3 K1 [typeof]
       94 CALL                             R3 1 1
       95 JUMPIFEQKS                       R3 K2 ["table"] ; [+20]
       97 LOADK                            R6 K14 ["%*\"data\" > Expected table, got %*"]
       98 MOVE                             R8 R2
       99 GETTABLEKS                       R10 R0 K13 ["data"]
      ...
      125 CALL                             R8 1 1
      126 JUMPIFEQKS                       R8 K11 ["string"] ; [+20]
      128 LOADK                            R11 K15 ["%*\"data\" > Expected key of type string, got %* as %*"]
      129 MOVE                             R13 R2
      130 MOVE                             R14 R6
      ...
      151 CALL                             R8 1 1
      152 JUMPIFEQKS                       R8 K2 ["table"] ; [+19]
      154 LOADK                            R11 K16 ["%*\"data\" > [\"%*\"] > Expected table, got %*"]
      155 MOVE                             R13 R2
      156 MOVE                             R14 R6
