...
PROTO_6:
       ...
       30 JUMPIFNOT                        R5 ; [+9]
       31 GETUPVAL                         R5 2
       32 GETTABLEKS                       R5 R5 K3 ["useState"]
       ...
       39 JUMP                             ; [+7]
       40 GETUPVAL                         R5 2
       41 GETTABLEKS                       R5 R5 K3 ["useState"]
       43 LOADB                            R6 1
       44 CALL                             R5 1 2
       45 MOVE                             R3 R5
       46 MOVE                             R4 R6
       47 GETUPVAL                         R5 2
       48 GETTABLEKS                       R5 R5 K6 ["useRef"]
       50 LOADNIL                          R6
       51 CALL                             R5 1 1
       52 GETUPVAL                         R6 0
       53 CALL                             R6 0 1
       54 JUMPIFNOT                        R6 ; [+16]
       55 GETUPVAL                         R6 4
       56 GETTABLEKS                       R6 R6 K7 ["useEventConnection"]
       ...
       70 JUMP                             ; [+15]
       71 GETUPVAL                         R6 4
       72 GETTABLEKS                       R6 R6 K7 ["useEventConnection"]
       ...
       85 CALL                             R6 3 0
       86 GETUPVAL                         R6 2
       87 GETTABLEKS                       R6 R6 K10 ["useEffect"]
       89 NEWCLOSURE                       R7 P2
       90 CAPTURE                          VAL R5
       91 NEWTABLE                         R8 0 0
       93 CALL                             R6 2 0
...
MAIN:
       ...
       36 GETTABLEKS                       R5 R5 K13 ["FFlagAssistantNotificationManager"]
       38 CALL                             R4 1 1
       39 GETIMPORT                        R5 K5 [require]
       41 GETTABLEKS                       R6 R0 K6 ["Src"]
       43 GETTABLEKS                       R6 R6 K12 ["Flags"]
       45 GETTABLEKS                       R6 R6 K14 ["FIntAssistantDisconnectDelaySeconds"]
       47 CALL                             R5 1 1
