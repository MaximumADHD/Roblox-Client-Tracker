PROTO_0:
       ...
       23 CALL                             R3 2 0
       24 RETURN                           R0 1
       25 GETTABLEKS                       R3 R0 K7 ["materials"]
       27 JUMPIFEQKNIL                     R3 ; [+77]
       29 GETTABLEKS                       R4 R0 K7 ["materials"]
       31 FASTCALL1                        TYPEOF R4 ; [+2]
       32 GETIMPORT                        R3 K1 [typeof]
       34 CALL                             R3 1 1
       35 JUMPIFEQKS                       R3 K2 ["table"] ; [+20]
       37 LOADK                            R6 K8 ["%*\"materials\" > Expected table, got %*"]
       38 MOVE                             R8 R2
       39 GETTABLEKS                       R10 R0 K7 ["materials"]
       ...
       54 CALL                             R3 2 0
       55 JUMP                             ; [+49]
       56 GETTABLEKS                       R3 R0 K7 ["materials"]
       58 LOADNIL                          R4
       59 LOADNIL                          R5
       60 FORGPREP                         R3
       ...
       68 LOADK                            R11 K10 ["%*\"materials\" > Expected index of type number, got %* as %*"]
       69 MOVE                             R13 R2
       70 MOVE                             R14 R6
       ...
       85 CALL                             R8 2 0
       86 JUMP                             ; [+16]
       87 GETTABLEKS                       R8 R0 K7 ["materials"]
       89 GETUPVAL                         R10 0
       90 GETTABLEKS                       R9 R10 K11 ["fromResponse"]
       92 MOVE                             R10 R7
       93 MOVE                             R11 R1
       94 LOADK                            R13 K12 ["%*\"materials\" > [%*] > "]
       95 MOVE                             R15 R2
       96 MOVE                             R16 R6
      ...
      105 GETTABLEKS                       R3 R0 K13 ["balanceRemaining"]
      107 JUMPIFEQKNIL                     R3 ; [+27]
      109 GETTABLEKS                       R4 R0 K13 ["balanceRemaining"]
      111 FASTCALL1                        TYPEOF R4 ; [+2]
      112 GETIMPORT                        R3 K1 [typeof]
      114 CALL                             R3 1 1
      115 JUMPIFEQKS                       R3 K9 ["number"] ; [+19]
      117 LOADK                            R6 K14 ["%*\"balanceRemaining\" > Expected number, got %*"]
      118 MOVE                             R8 R2
      119 GETTABLEKS                       R10 R0 K13 ["balanceRemaining"]
      ...
      134 CALL                             R3 2 0
      135 GETTABLEKS                       R3 R0 K15 ["error"]
      137 JUMPIFEQKNIL                     R3 ; [+16]
      139 GETUPVAL                         R4 1
      140 GETTABLEKS                       R3 R4 K11 ["fromResponse"]
      142 GETTABLEKS                       R4 R0 K15 ["error"]
      144 MOVE                             R5 R1
      145 LOADK                            R7 K16 ["%*\"error\" > "]
      146 MOVE                             R9 R2
      147 NAMECALL                         R7 R7 K4 ["format"]
      149 CALL                             R7 2 1
      150 MOVE                             R6 R7
      151 CALL                             R3 3 1
      152 SETTABLEKS                       R3 R0 K15 ["error"]
      154 GETTABLEKS                       R3 R0 K17 ["filteredText"]
      156 JUMPIFEQKNIL                     R3 ; [+27]
      158 GETTABLEKS                       R4 R0 K17 ["filteredText"]
      160 FASTCALL1                        TYPEOF R4 ; [+2]
      161 GETIMPORT                        R3 K1 [typeof]
      163 CALL                             R3 1 1
      164 JUMPIFEQKS                       R3 K18 ["string"] ; [+19]
      166 LOADK                            R6 K19 ["%*\"filteredText\" > Expected string, got %*"]
      167 MOVE                             R8 R2
      168 GETTABLEKS                       R10 R0 K17 ["filteredText"]
      170 FASTCALL1                        TYPEOF R10 ; [+2]
      171 GETIMPORT                        R9 K1 [typeof]
      173 CALL                             R9 1 1
      174 NAMECALL                         R6 R6 K4 ["format"]
      176 CALL                             R6 3 1
      177 MOVE                             R5 R6
      178 FASTCALL2                        TABLE_INSERT R1 R5 ; [+4]
      180 MOVE                             R4 R1
      181 GETIMPORT                        R3 K6 [table.insert]
      183 CALL                             R3 2 0
      184 RETURN                           R0 1
...
PROTO_1:
        ...
        2 MOVE                             R2 R0
        3 CALL                             R1 1 1
        4 GETTABLEKS                       R2 R1 K3 ["materials"]
        6 JUMPIFEQKNIL                     R2 ; [+23]
        8 GETIMPORT                        R2 K2 [table.clone]
       10 GETTABLEKS                       R3 R1 K3 ["materials"]
       12 CALL                             R2 1 1
       13 SETTABLEKS                       R2 R1 K3 ["materials"]
       15 GETTABLEKS                       R2 R1 K3 ["materials"]
       17 LOADNIL                          R3
       18 LOADNIL                          R4
       19 FORGPREP                         R2
       20 GETTABLEKS                       R7 R1 K3 ["materials"]
       22 GETUPVAL                         R9 0
       ...
       28 FORGLOOP                         R2 2 ; [-9]
       30 GETTABLEKS                       R2 R1 K5 ["error"]
       32 JUMPIFEQKNIL                     R2 ; [+9]
       34 GETUPVAL                         R3 1
       35 GETTABLEKS                       R2 R3 K4 ["toRequest"]
       37 GETTABLEKS                       R3 R1 K5 ["error"]
       39 CALL                             R2 1 1
       40 SETTABLEKS                       R2 R1 K5 ["error"]
       42 RETURN                           R1 1
...
MAIN:
       ...
       29 GETTABLEKS                       R6 R7 K11 ["TextToImagePublicError"]
       31 CALL                             R5 1 1
