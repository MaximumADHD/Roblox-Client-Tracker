PROTO_0:
       ...
       23 CALL                             R3 2 0
       24 RETURN                           R0 1
       25 GETTABLEKS                       R3 R0 K7 ["artifacts"]
       27 JUMPIFEQKNIL                     R3 ; [+77]
       29 GETTABLEKS                       R4 R0 K7 ["artifacts"]
       31 FASTCALL1                        TYPEOF R4 ; [+2]
       32 GETIMPORT                        R3 K1 [typeof]
       34 CALL                             R3 1 1
       35 JUMPIFEQKS                       R3 K2 ["table"] ; [+20]
       37 LOADK                            R6 K8 ["%*\"artifacts\" > Expected table, got %*"]
       38 MOVE                             R8 R2
       39 GETTABLEKS                       R10 R0 K7 ["artifacts"]
       ...
       54 CALL                             R3 2 0
       55 JUMP                             ; [+49]
       56 GETTABLEKS                       R3 R0 K7 ["artifacts"]
       58 LOADNIL                          R4
       59 LOADNIL                          R5
       60 FORGPREP                         R3
       ...
       68 LOADK                            R11 K10 ["%*\"artifacts\" > Expected index of type number, got %* as %*"]
       69 MOVE                             R13 R2
       70 MOVE                             R14 R6
       ...
       85 CALL                             R8 2 0
       86 JUMP                             ; [+16]
       87 GETTABLEKS                       R8 R0 K7 ["artifacts"]
       89 GETUPVAL                         R10 0
       90 GETTABLEKS                       R9 R10 K11 ["fromResponse"]
       92 MOVE                             R10 R7
       93 MOVE                             R11 R1
       94 LOADK                            R13 K12 ["%*\"artifacts\" > [%*] > "]
       95 MOVE                             R15 R2
       96 MOVE                             R16 R6
      ...
      105 GETTABLEKS                       R3 R0 K13 ["filteredText"]
      107 JUMPIFEQKNIL                     R3 ; [+27]
      109 GETTABLEKS                       R4 R0 K13 ["filteredText"]
      111 FASTCALL1                        TYPEOF R4 ; [+2]
      112 GETIMPORT                        R3 K1 [typeof]
      114 CALL                             R3 1 1
      115 JUMPIFEQKS                       R3 K14 ["string"] ; [+19]
      117 LOADK                            R6 K15 ["%*\"filteredText\" > Expected string, got %*"]
      118 MOVE                             R8 R2
      119 GETTABLEKS                       R10 R0 K13 ["filteredText"]
      ...
      134 CALL                             R3 2 0
      135 GETTABLEKS                       R3 R0 K16 ["newBalance"]
      137 JUMPIFEQKNIL                     R3 ; [+27]
      139 GETTABLEKS                       R4 R0 K16 ["newBalance"]
      141 FASTCALL1                        TYPEOF R4 ; [+2]
      142 GETIMPORT                        R3 K1 [typeof]
      144 CALL                             R3 1 1
      145 JUMPIFEQKS                       R3 K9 ["number"] ; [+19]
      147 LOADK                            R6 K17 ["%*\"newBalance\" > Expected number, got %*"]
      148 MOVE                             R8 R2
      149 GETTABLEKS                       R10 R0 K16 ["newBalance"]
      ...
      164 CALL                             R3 2 0
      165 GETTABLEKS                       R3 R0 K18 ["error"]
      167 JUMPIFEQKNIL                     R3 ; [+16]
      169 GETUPVAL                         R4 1
      170 GETTABLEKS                       R3 R4 K11 ["fromResponse"]
      172 GETTABLEKS                       R4 R0 K18 ["error"]
      174 MOVE                             R5 R1
      175 LOADK                            R7 K19 ["%*\"error\" > "]
      176 MOVE                             R9 R2
      177 NAMECALL                         R7 R7 K4 ["format"]
      179 CALL                             R7 2 1
      180 MOVE                             R6 R7
      181 CALL                             R3 3 1
      182 SETTABLEKS                       R3 R0 K18 ["error"]
      184 RETURN                           R0 1
...
PROTO_1:
        ...
        2 MOVE                             R2 R0
        3 CALL                             R1 1 1
        4 GETTABLEKS                       R2 R1 K3 ["artifacts"]
        6 JUMPIFEQKNIL                     R2 ; [+23]
        8 GETIMPORT                        R2 K2 [table.clone]
       10 GETTABLEKS                       R3 R1 K3 ["artifacts"]
       12 CALL                             R2 1 1
       13 SETTABLEKS                       R2 R1 K3 ["artifacts"]
       15 GETTABLEKS                       R2 R1 K3 ["artifacts"]
       17 LOADNIL                          R3
       18 LOADNIL                          R4
       19 FORGPREP                         R2
       20 GETTABLEKS                       R7 R1 K3 ["artifacts"]
       22 GETUPVAL                         R9 0
...
MAIN:
       ...
       22 GETTABLEKS                       R5 R6 K10 ["ColorMapArtifact"]
       24 CALL                             R4 1 1
