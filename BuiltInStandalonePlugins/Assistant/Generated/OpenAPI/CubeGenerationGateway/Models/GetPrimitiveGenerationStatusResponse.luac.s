PROTO_0:
       ...
       23 CALL                             R3 2 0
       24 RETURN                           R0 1
       25 GETTABLEKS                       R3 R0 K7 ["primitiveGenerationId"]
       27 JUMPIFEQKNIL                     R3 ; [+27]
       29 GETTABLEKS                       R4 R0 K7 ["primitiveGenerationId"]
       31 FASTCALL1                        TYPEOF R4 ; [+2]
       32 GETIMPORT                        R3 K1 [typeof]
       34 CALL                             R3 1 1
       35 JUMPIFEQKS                       R3 K8 ["string"] ; [+19]
       37 LOADK                            R6 K9 ["%*\"primitiveGenerationId\" > Expected string, got %*"]
       38 MOVE                             R8 R2
       39 GETTABLEKS                       R10 R0 K7 ["primitiveGenerationId"]
      ...
      239 GETUPVAL                         R10 0
      240 GETTABLEKS                       R9 R10 K22 ["fromResponse"]
      242 MOVE                             R10 R7
      243 MOVE                             R11 R1
      ...
      259 GETUPVAL                         R4 1
      260 GETTABLEKS                       R3 R4 K22 ["fromResponse"]
...
MAIN:
       ...
       22 GETTABLEKS                       R5 R6 K10 ["PrimitiveGenCompletedResult"]
       24 CALL                             R4 1 1
       25 GETIMPORT                        R5 K7 [require]
       27 GETTABLEKS                       R7 R0 K9 ["Models"]
       29 GETTABLEKS                       R6 R7 K11 ["PrimitiveGenProgressUpdateDto"]
       31 CALL                             R5 1 1
