PROTO_0:
       ...
       95 CALL                             R3 2 0
       96 GETTABLEKS                       R3 R0 K15 ["isError"]
       98 JUMPIFEQKNIL                     R3 ; [+27]
      100 GETTABLEKS                       R4 R0 K15 ["isError"]
      102 FASTCALL1                        TYPEOF R4 ; [+2]
      103 GETIMPORT                        R3 K1 [typeof]
      105 CALL                             R3 1 1
      106 JUMPIFEQKS                       R3 K16 ["boolean"] ; [+19]
      108 LOADK                            R6 K17 ["%*\"isError\" > Expected boolean, got %*"]
      109 MOVE                             R8 R2
      110 GETTABLEKS                       R10 R0 K15 ["isError"]
      112 FASTCALL1                        TYPEOF R10 ; [+2]
      113 GETIMPORT                        R9 K1 [typeof]
      115 CALL                             R9 1 1
      116 NAMECALL                         R6 R6 K4 ["format"]
      118 CALL                             R6 3 1
      119 MOVE                             R5 R6
      120 FASTCALL2                        TABLE_INSERT R1 R5 ; [+4]
      122 MOVE                             R4 R1
      123 GETIMPORT                        R3 K6 [table.insert]
      125 CALL                             R3 2 0
      126 RETURN                           R0 1
