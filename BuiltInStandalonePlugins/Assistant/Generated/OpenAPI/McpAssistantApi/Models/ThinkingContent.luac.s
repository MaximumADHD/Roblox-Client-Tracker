PROTO_0:
       ...
       54 CALL                             R3 2 0
       55 GETTABLEKS                       R4 R0 K10 ["thinking"]
       57 FASTCALL1                        TYPEOF R4 ; [+2]
       58 GETIMPORT                        R3 K1 [typeof]
       60 CALL                             R3 1 1
       61 JUMPIFEQKS                       R3 K8 ["string"] ; [+19]
       63 LOADK                            R6 K11 ["%*\"thinking\" > Expected string, got %*"]
       64 MOVE                             R8 R2
       65 GETTABLEKS                       R10 R0 K10 ["thinking"]
       ...
       80 CALL                             R3 2 0
       81 GETTABLEKS                       R4 R0 K12 ["signature"]
       83 FASTCALL1                        TYPEOF R4 ; [+2]
       84 GETIMPORT                        R3 K1 [typeof]
       86 CALL                             R3 1 1
       87 JUMPIFEQKS                       R3 K8 ["string"] ; [+19]
       89 LOADK                            R6 K13 ["%*\"signature\" > Expected string, got %*"]
       90 MOVE                             R8 R2
       91 GETTABLEKS                       R10 R0 K12 ["signature"]
