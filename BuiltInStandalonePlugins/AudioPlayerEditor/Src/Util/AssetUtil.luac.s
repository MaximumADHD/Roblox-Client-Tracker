...
PROTO_6:
       ...
       35 LOADK                            R2 K10 ["%* \"%*\""]
       36 GETTABLEKS                       R4 R1 K11 ["ClassName"]
       38 GETTABLEKS                       R5 R1 K12 ["Name"]
       40 NAMECALL                         R2 R2 K13 ["format"]
       42 CALL                             R2 3 1
       43 LENGTH                           R3 R0
       44 LOADN                            R4 1
       45 JUMPIFNOTLT                      R4 R3 ; [+9]
       47 LOADK                            R3 K14 ["%* (%* items)"]
       48 GETTABLEKS                       R5 R1 K11 ["ClassName"]
       50 LENGTH                           R6 R0
       51 NAMECALL                         R3 R3 K13 ["format"]
       53 CALL                             R3 3 1
       54 MOVE                             R2 R3
       55 GETUPVAL                         R3 2
       56 GETTABLEKS                       R3 R3 K15 ["setupForInstance"]
       58 MOVE                             R4 R1
       59 CALL                             R3 1 0
       60 GETUPVAL                         R3 4
       61 GETTABLEKS                       R3 R3 K16 ["getInstanceData"]
       63 MOVE                             R4 R1
       64 CALL                             R3 1 1
       65 SETUPVAL                         R3 3
       66 GETUPVAL                         R3 0
       67 LOADK                            R5 K17 ["OnOpen"]
       68 GETUPVAL                         R6 3
       69 MOVE                             R7 R2
       70 NAMECALL                         R3 R3 K18 ["Invoke"]
       72 CALL                             R3 4 0
       73 GETUPVAL                         R3 5
       74 JUMPIFNOT                        R3 ; [+4]
       75 GETUPVAL                         R3 5
       76 NAMECALL                         R3 R3 K19 ["Disconnect"]
       78 CALL                             R3 1 0
       79 GETTABLEKS                       R3 R1 K20 ["Changed"]
       81 NEWCLOSURE                       R5 P0
       82 CAPTURE                          UPVAL U4
       83 CAPTURE                          VAL R1
       84 CAPTURE                          UPVAL U3
       85 CAPTURE                          UPVAL U0
       86 NAMECALL                         R3 R3 K21 ["Connect"]
       88 CALL                             R3 2 1
       89 SETUPVAL                         R3 5
       90 RETURN                           R0 0
