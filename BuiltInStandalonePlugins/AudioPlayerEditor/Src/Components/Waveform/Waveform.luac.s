...
PROTO_1:
        ...
        2 GETUPVAL                         R3 1
        3 GETTABLEKS                       R2 R3 K0 ["TimePosition"]
        5 SETTABLEKS                       R2 R1 K0 ["TimePosition"]
        7 GETUPVAL                         R3 1
        8 GETTABLEKS                       R2 R3 K1 ["HoveredPosition"]
...
PROTO_2:
        ...
        2 CALL                             R0 1 0
        3 GETUPVAL                         R1 2
        4 GETTABLEKS                       R0 R1 K0 ["TimeLength"]
        6 LOADN                            R1 0
        7 JUMPIFNOTLE                      R0 R1 ; [+2]
        9 RETURN                           R0 0
       10 GETUPVAL                         R1 3
       11 GETTABLEKS                       R0 R1 K1 ["fetchWaveform"]
       13 GETUPVAL                         R1 4
       14 GETUPVAL                         R2 0
       15 CALL                             R0 2 0
       16 RETURN                           R0 0
...
PROTO_4:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R0 R1 K0 ["TimeLength"]
        3 LOADN                            R1 0
       ...
       18 DIV                              R8 R9 R1
       19 GETUPVAL                         R10 0
       20 GETTABLEKS                       R9 R10 K0 ["TimeLength"]
       22 MUL                              R7 R8 R9
       23 GETUPVAL                         R8 2
       ...
       37 CALL                             R10 1 1
       38 GETUPVAL                         R13 0
       39 GETTABLEKS                       R12 R13 K6 ["Volume"]
       41 ORK                              R11 R12 K1 [1]
       42 MUL                              R9 R10 R11
       43 LOADN                            R12 0
       44 LOADN                            R13 1
       ...
       55 GETUPVAL                         R12 7
       56 GETTABLEKS                       R11 R12 K10 ["createElement"]
       58 GETUPVAL                         R12 8
       ...
       63 MINUS                            R16 R9
       64 GETUPVAL                         R20 0
       65 GETTABLEKS                       R19 R20 K0 ["TimeLength"]
       67 DIV                              R18 R19 R1
       68 ADD                              R17 R7 R18
       69 MOVE                             R18 R9
       70 CALL                             R14 4 1
...
PROTO_5:
       ...
       19 LOADN                            R2 0
       20 GETUPVAL                         R6 0
       21 GETTABLEKS                       R5 R6 K2 ["HoveredPosition"]
       23 ORK                              R4 R5 K1 [0]
       24 GETUPVAL                         R6 0
       25 GETTABLEKS                       R5 R6 K3 ["TimePosition"]
       27 FASTCALL2                        MATH_MIN R4 R5 ; [+3]
       29 GETIMPORT                        R3 K6 [math.min]
       31 CALL                             R3 2 1
       32 GETUPVAL                         R5 0
       33 GETTABLEKS                       R4 R5 K3 ["TimePosition"]
       35 GETUPVAL                         R8 0
       36 GETTABLEKS                       R7 R8 K2 ["HoveredPosition"]
       38 ORK                              R6 R7 K1 [0]
       39 GETUPVAL                         R8 0
       40 GETTABLEKS                       R7 R8 K3 ["TimePosition"]
       42 FASTCALL2                        MATH_MAX R6 R7 ; [+3]
       44 GETIMPORT                        R5 K8 [math.max]
       46 CALL                             R5 2 1
       47 GETUPVAL                         R7 0
       48 GETTABLEKS                       R6 R7 K0 ["TimeLength"]
...
PROTO_6:
        ...
        4 GETTABLEKS                       R4 R5 K1 ["System"]
        6 GETTABLEKS                       R3 R4 K2 ["Neutral"]
        8 GETTABLEKS                       R2 R3 K3 ["Color3"]
       10 GETTABLEKS                       R6 R1 K0 ["Color"]
       12 GETTABLEKS                       R5 R6 K1 ["System"]
       14 GETTABLEKS                       R4 R5 K4 ["Contrast"]
       16 GETTABLEKS                       R3 R4 K3 ["Color3"]
       18 GETTABLEKS                       R7 R1 K0 ["Color"]
       20 GETTABLEKS                       R6 R7 K5 ["ActionSoftEmphasis"]
       22 GETTABLEKS                       R5 R6 K6 ["Background"]
       24 GETTABLEKS                       R4 R5 K3 ["Color3"]
       26 GETTABLEKS                       R8 R1 K0 ["Color"]
       28 GETTABLEKS                       R7 R8 K7 ["ActionEmphasis"]
       30 GETTABLEKS                       R6 R7 K6 ["Background"]
       32 GETTABLEKS                       R5 R6 K3 ["Color3"]
       ...
       61 CALL                             R8 1 2
       62 GETUPVAL                         R11 1
       63 GETTABLEKS                       R10 R11 K15 ["useEffect"]
       ...
       76 CALL                             R10 2 0
       77 GETUPVAL                         R11 1
       78 GETTABLEKS                       R10 R11 K16 ["useState"]
       80 NEWTABLE                         R11 0 0
       82 CALL                             R10 1 2
       83 GETUPVAL                         R13 1
       84 GETTABLEKS                       R12 R13 K15 ["useEffect"]
      ...
      101 CALL                             R12 2 0
      102 GETUPVAL                         R13 1
      103 GETTABLEKS                       R12 R13 K10 ["useMemo"]
      ...
      124 CALL                             R12 2 1
      125 GETUPVAL                         R14 1
      126 GETTABLEKS                       R13 R14 K10 ["useMemo"]
      ...
      146 CALL                             R13 2 1
      147 GETUPVAL                         R15 1
      148 GETTABLEKS                       R14 R15 K20 ["createElement"]
      150 GETUPVAL                         R16 1
      151 GETTABLEKS                       R15 R16 K21 ["Fragment"]
      153 NEWTABLE                         R16 0 0
      155 GETUPVAL                         R18 5
      156 GETTABLEKS                       R17 R18 K22 ["join"]
      158 MOVE                             R18 R12
      159 MOVE                             R19 R13
      160 CALL                             R17 2 -1
      161 CALL                             R14 -1 -1
...
MAIN:
       ...
       36 GETTABLEKS                       R6 R7 K12 ["Graphing"]
       38 CALL                             R5 1 1
       ...
       49 GETTABLEKS                       R9 R10 K17 ["PlayerUtil"]
       51 CALL                             R8 1 1
       52 GETIMPORT                        R9 K5 [require]
       54 GETTABLEKS                       R11 R0 K15 ["Src"]
       56 GETTABLEKS                       R10 R11 K18 ["Types"]
       58 CALL                             R9 1 1
