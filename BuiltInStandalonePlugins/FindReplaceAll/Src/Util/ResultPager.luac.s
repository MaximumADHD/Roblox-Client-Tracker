PROTO_0:
        0 SUBK                             R4 R0 K0 [1]
        1 GETUPVAL                         R5 0
        2 GETTABLEKS                       R5 R5 K1 ["DEFAULT_PAGE_SIZE"]
        4 DIV                              R3 R4 R5
...
PROTO_1:
        0 SUBK                             R2 R0 K0 [1]
        1 GETUPVAL                         R3 0
        2 GETTABLEKS                       R3 R3 K1 ["DEFAULT_PAGE_SIZE"]
        4 MUL                              R1 R2 R3
        5 RETURN                           R1 1

PROTO_2:
        0 GETUPVAL                         R3 0
        1 GETTABLEKS                       R3 R3 K0 ["DEFAULT_PAGE_SIZE"]
        3 DIV                              R2 R0 R3
...
PROTO_3:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R1 R1 K0 ["startResultIndexFromPage"]
        3 MOVE                             R2 R0
        4 CALL                             R1 1 1
        5 GETUPVAL                         R4 1
        6 GETTABLEKS                       R4 R4 K2 ["DEFAULT_PAGE_SIZE"]
        8 ADD                              R3 R1 R4
        9 SUBK                             R2 R3 K1 [1]
       10 RETURN                           R1 2
