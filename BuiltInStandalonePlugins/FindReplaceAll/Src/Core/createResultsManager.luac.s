...
PROTO_6:
       ...
       19 GETUPVAL                         R2 2
       20 GETTABLEKS                       R2 R2 K2 ["copy"]
       22 GETUPVAL                         R3 1
       23 GETTABLEKS                       R3 R3 K0 ["get"]
       25 CALL                             R3 0 -1
       26 CALL                             R2 -1 1
       27 LOADNIL                          R3
       ...
       36 CALL                             R3 2 0
       37 GETUPVAL                         R1 5
       38 GETTABLEKS                       R1 R1 K4 ["replace"]
...
PROTO_7:
       ...
       36 CALL                             R3 2 0
       37 GETUPVAL                         R1 5
       38 GETTABLEKS                       R1 R1 K4 ["findNext"]
       40 CALL                             R1 0 0
       41 RETURN                           R0 0
...
PROTO_8:
       ...
       36 CALL                             R3 2 0
       37 GETUPVAL                         R1 5
       38 GETTABLEKS                       R1 R1 K4 ["findPrevious"]
       40 CALL                             R1 0 0
       41 RETURN                           R0 0
...
PROTO_12:
       ...
       43 RETURN                           R5 1
       44 GETUPVAL                         R5 7
       45 GETTABLEKS                       R5 R5 K2 ["get"]
       47 CALL                             R5 0 1
       48 GETUPVAL                         R6 9
       49 GETTABLEKS                       R6 R6 K3 ["shallowEqual"]
       51 MOVE                             R7 R5
       52 MOVE                             R8 R4
       53 CALL                             R6 2 1
       54 JUMPIF                           R6 ; [+32]
...
PROTO_15:
       ...
       67 SETUPVAL                         R8 5
       68 GETUPVAL                         R8 6
       69 GETTABLEKS                       R8 R8 K13 ["getResults"]
       71 MOVE                             R9 R5
       72 MOVE                             R10 R7
       73 GETUPVAL                         R12 7
       74 GETTABLEKS                       R12 R12 K14 ["get"]
       76 CALL                             R12 0 1
       77 NEWTABLE                         R13 0 0
       79 MOVE                             R14 R12
       80 LOADNIL                          R15
...
PROTO_16:
       ...
       35 JUMPIFNOT                        R1 ; [+54]
       36 GETUPVAL                         R1 9
       37 GETTABLEKS                       R1 R1 K3 ["get"]
       39 CALL                             R1 0 1
       40 JUMPIFNOT                        R1 ; [+44]
       41 GETTABLEKS                       R2 R1 K4 ["Guid"]
       43 GETTABLEKS                       R3 R0 K5 ["Selected"]
       45 GETTABLEKS                       R3 R3 K4 ["Guid"]
       47 JUMPIFEQ                         R2 R3 ; [+37]
       49 GETTABLEKS                       R3 R0 K5 ["Selected"]
       51 GETTABLEKS                       R3 R3 K4 ["Guid"]
       53 GETUPVAL                         R5 10
       54 GETTABLEKS                       R5 R5 K3 ["get"]
       56 CALL                             R5 0 1
       ...
       61 LOADB                            R2 1
       62 JUMPIFNOT                        R2 ; [+22]
       63 GETTABLEKS                       R2 R0 K5 ["Selected"]
       65 GETTABLEKS                       R2 R2 K4 ["Guid"]
       67 GETUPVAL                         R3 11
       68 GETTABLEKS                       R3 R3 K6 ["copy"]
       70 GETUPVAL                         R4 10
       71 GETTABLEKS                       R4 R4 K3 ["get"]
       73 CALL                             R4 0 -1
       74 CALL                             R3 -1 1
       75 LOADNIL                          R4
...
PROTO_17:
        ...
        1 LOADN                            R5 1
        2 GETUPVAL                         R7 0
        3 GETTABLEKS                       R7 R7 K0 ["get"]
        5 CALL                             R7 0 1
        6 GETUPVAL                         R8 1
        7 GETTABLEKS                       R8 R8 K1 ["resultRowHeight"]
        9 IDIV                             R6 R7 R8
       10 ADD                              R4 R5 R6
       11 GETUPVAL                         R5 2
       12 GETTABLEKS                       R5 R5 K2 ["EXTRA_NODES"]
       14 SUB                              R3 R4 R5
       15 FASTCALL2                        MATH_MAX R2 R3 ; [+3]
       17 GETIMPORT                        R1 K5 [math.max]
       19 CALL                             R1 2 1
       20 GETUPVAL                         R2 2
       21 GETTABLEKS                       R2 R2 K6 ["WINDOW_RADIUS"]
       23 GETUPVAL                         R3 3
       24 ADDK                             R3 R3 K7 [1]
       25 SETUPVAL                         R3 3
       26 GETUPVAL                         R3 3
       ...
       44 JUMPIFNOT                        R0 ; [+46]
       45 GETUPVAL                         R5 8
       46 GETTABLEKS                       R5 R5 K8 ["getResults"]
       48 LOADN                            R6 0
       49 LOADN                            R7 1
       50 GETUPVAL                         R9 9
       51 GETTABLEKS                       R9 R9 K0 ["get"]
       53 CALL                             R9 0 1
       54 NEWTABLE                         R10 0 0
       56 MOVE                             R11 R9
       57 LOADNIL                          R12
...
PROTO_18:
        ...
        1 LOADN                            R4 1
        2 GETUPVAL                         R6 0
        3 GETTABLEKS                       R6 R6 K0 ["get"]
        5 CALL                             R6 0 1
        6 GETUPVAL                         R7 1
        7 GETTABLEKS                       R7 R7 K1 ["resultRowHeight"]
        9 IDIV                             R5 R6 R7
       10 ADD                              R3 R4 R5
       11 GETUPVAL                         R4 2
       12 GETTABLEKS                       R4 R4 K2 ["EXTRA_NODES"]
       14 SUB                              R2 R3 R4
       15 FASTCALL2                        MATH_MAX R1 R2 ; [+3]
       17 GETIMPORT                        R0 K5 [math.max]
       19 CALL                             R0 2 1
       20 GETUPVAL                         R1 2
       21 GETTABLEKS                       R1 R1 K6 ["WINDOW_RADIUS"]
       23 GETUPVAL                         R2 3
...
PROTO_19:
        ...
        4 CALL                             R0 1 2
        5 GETUPVAL                         R2 0
        6 GETTABLEKS                       R2 R2 K0 ["create"]
        8 LOADN                            R3 0
        9 CALL                             R2 1 2
       10 GETUPVAL                         R4 0
       11 GETTABLEKS                       R4 R4 K0 ["create"]
       13 LOADN                            R5 0
       14 CALL                             R4 1 2
       15 GETUPVAL                         R6 0
       16 GETTABLEKS                       R6 R6 K0 ["create"]
       18 LOADN                            R7 0
       19 CALL                             R6 1 2
       20 GETUPVAL                         R8 0
       21 GETTABLEKS                       R8 R8 K0 ["create"]
       23 NEWTABLE                         R9 0 0
       25 CALL                             R8 1 2
       26 GETUPVAL                         R10 0
       27 GETTABLEKS                       R10 R10 K0 ["create"]
       29 NEWTABLE                         R11 0 0
       31 CALL                             R10 1 2
       32 GETUPVAL                         R12 1
       33 GETTABLEKS                       R12 R12 K1 ["new"]
       35 CALL                             R12 0 1
       36 GETUPVAL                         R13 0
       37 GETTABLEKS                       R13 R13 K0 ["create"]
       39 LOADNIL                          R14
       40 CALL                             R13 1 2
       41 GETUPVAL                         R15 0
       42 GETTABLEKS                       R15 R15 K0 ["create"]
       44 LOADNIL                          R16
       45 CALL                             R15 1 2
       46 GETUPVAL                         R17 1
       47 GETTABLEKS                       R17 R17 K1 ["new"]
       49 CALL                             R17 0 1
       50 GETUPVAL                         R18 0
       51 GETTABLEKS                       R18 R18 K0 ["create"]
       53 LOADN                            R19 0
       54 CALL                             R18 1 2
       55 LOADNIL                          R20
       56 LOADN                            R21 0
