PROTO_0:
        ...
        7 LOADN                            R6 1
        8 GETUPVAL                         R8 1
        9 GETTABLEKS                       R8 R8 K0 ["get"]
       11 CALL                             R8 0 1
       12 GETUPVAL                         R9 2
       13 GETTABLEKS                       R9 R9 K1 ["resultRowHeight"]
       15 IDIV                             R7 R8 R9
       16 ADD                              R5 R6 R7
       17 GETUPVAL                         R6 3
       18 GETTABLEKS                       R6 R6 K2 ["EXTRA_NODES"]
       20 SUB                              R4 R5 R6
       ...
       51 SUBK                             R9 R5 K6 [1]
       52 GETUPVAL                         R10 2
       53 GETTABLEKS                       R10 R10 K1 ["resultRowHeight"]
       55 MUL                              R8 R9 R10
...
PROTO_2:
       ...
       18 LOADNIL                          R4
       19 FORGPREP                         R2
       20 GETTABLEKS                       R7 R6 K3 ["datum"]
       22 GETTABLEKS                       R7 R7 K4 ["id"]
       24 GETUPVAL                         R8 2
       25 GETTABLEKS                       R8 R8 K5 ["nilId"]
       27 JUMPIFEQ                         R7 R8 ; [+11]
       29 GETTABLEKS                       R9 R6 K3 ["datum"]
       31 GETTABLEKS                       R9 R9 K4 ["id"]
       ...
       41 GETTABLEKS                       R7 R7 K9 ["set"]
       43 MOVE                             R8 R6
       44 CALL                             R7 1 0
       45 FORGLOOP                         R2 2 ; [-26]
       47 GETUPVAL                         R2 4
       48 GETTABLEKS                       R2 R2 K10 ["setViewingInstances"]
       50 MOVE                             R3 R1
       51 CALL                             R2 1 0
       52 RETURN                           R0 0
...
PROTO_4:
       ...
       15 LOADNIL                          R6
       16 FORGPREP                         R4
       17 GETTABLEKS                       R9 R8 K0 ["datum"]
       19 GETTABLEKS                       R9 R9 K1 ["id"]
       21 GETUPVAL                         R10 3
       22 GETTABLEKS                       R10 R10 K2 ["nilId"]
       24 JUMPIFEQ                         R9 R10 ; [+11]
       26 GETTABLEKS                       R11 R8 K0 ["datum"]
       28 GETTABLEKS                       R11 R11 K1 ["id"]
       30 FASTCALL2                        TABLE_INSERT R3 R11 ; [+4]
       32 MOVE                             R10 R3
       33 GETIMPORT                        R9 K5 [table.insert]
       35 CALL                             R9 2 0
       36 GETUPVAL                         R9 6
       37 GETTABLEKS                       R9 R9 K6 ["create"]
       39 MOVE                             R10 R8
       40 CALL                             R9 1 2
       ...
       60 CALL                             R4 2 0
       61 GETUPVAL                         R4 7
       62 GETTABLEKS                       R4 R4 K13 ["setViewingInstances"]
       64 MOVE                             R5 R3
       65 CALL                             R4 1 0
       66 GETUPVAL                         R4 8
       67 GETUPVAL                         R5 9
       ...
       78 NEWTABLE                         R5 0 4
       80 GETUPVAL                         R6 10
       81 GETTABLEKS                       R6 R6 K15 ["changedSignal"]
       83 MOVE                             R8 R4
       84 NAMECALL                         R6 R6 K16 ["Connect"]
       86 CALL                             R6 2 1
       87 GETUPVAL                         R7 11
       88 GETTABLEKS                       R7 R7 K15 ["changedSignal"]
       90 MOVE                             R9 R4
       91 NAMECALL                         R7 R7 K16 ["Connect"]
       93 CALL                             R7 2 1
       94 GETUPVAL                         R8 1
       95 GETTABLEKS                       R8 R8 K15 ["changedSignal"]
       97 MOVE                             R10 R4
       98 NAMECALL                         R8 R8 K16 ["Connect"]
      100 CALL                             R8 2 1
      101 GETUPVAL                         R9 0
      102 GETTABLEKS                       R9 R9 K15 ["changedSignal"]
      104 MOVE                             R11 R4
...
PROTO_5:
        ...
        8 GETUPVAL                         R7 1
        9 GETTABLEKS                       R7 R7 K2 ["resultRowHeight"]
       11 DIV                              R5 R6 R7
       12 FASTCALL1                        MATH_CEIL R5 ; [+2]
       13 GETIMPORT                        R4 K5 [math.ceil]
       15 CALL                             R4 1 1
       16 GETUPVAL                         R6 2
       17 GETTABLEKS                       R6 R6 K7 ["EXTRA_NODES"]
       19 MULK                             R5 R6 K6 [2]
       20 ADD                              R3 R4 R5
       21 GETTABLEKS                       R4 R0 K8 ["resultManager"]
       23 GETTABLEKS                       R4 R4 K9 ["hoveredObservable"]
       25 GETTABLEKS                       R5 R0 K8 ["resultManager"]
       27 GETTABLEKS                       R5 R5 K10 ["selectedObservable"]
       29 GETTABLEKS                       R6 R0 K8 ["resultManager"]
       31 GETTABLEKS                       R6 R6 K11 ["resultsObservable"]
       33 GETTABLEKS                       R7 R0 K8 ["resultManager"]
       35 GETTABLEKS                       R7 R7 K12 ["scrollHeightObservable"]
       37 GETUPVAL                         R8 0
       38 GETTABLEKS                       R8 R8 K13 ["useEffect"]
       40 NEWCLOSURE                       R9 P0
       41 CAPTURE                          VAL R6
       42 CAPTURE                          VAL R7
       43 CAPTURE                          UPVAL U1
...
MAIN:
       ...
       38 GETTABLEKS                       R5 R5 K13 ["Observable"]
       40 CALL                             R4 1 1
