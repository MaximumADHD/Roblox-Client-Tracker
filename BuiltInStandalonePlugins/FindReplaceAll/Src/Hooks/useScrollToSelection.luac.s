PROTO_0:
        ...
        5 RETURN                           R0 0
        6 GETUPVAL                         R3 1
        7 GETTABLEKS                       R3 R3 K1 ["resultRowHeight"]
        9 MUL                              R2 R3 R0
       10 GETTABLEKS                       R4 R1 K2 ["CanvasPosition"]
       12 GETTABLEKS                       R4 R4 K3 ["Y"]
       14 GETUPVAL                         R6 1
       15 GETTABLEKS                       R6 R6 K1 ["resultRowHeight"]
       17 DIVK                             R5 R6 K4 [2]
       18 ADD                              R3 R4 R5
       ...
       29 ADD                              R4 R5 R6
       30 GETUPVAL                         R6 1
       31 GETTABLEKS                       R6 R6 K1 ["resultRowHeight"]
       33 DIVK                             R5 R6 K4 [2]
       34 ADD                              R3 R4 R5
       ...
       43 GETUPVAL                         R4 1
       44 GETTABLEKS                       R4 R4 K1 ["resultRowHeight"]
       46 JUMPIFNOTLE                      R3 R4 ; [+2]
       48 LOADN                            R3 0
       49 GETUPVAL                         R6 1
       50 GETTABLEKS                       R6 R6 K1 ["resultRowHeight"]
       52 SUBK                             R7 R0 K7 [1]
       53 MUL                              R5 R6 R7
       54 SUB                              R4 R5 R3
...
PROTO_4:
        ...
        8 CALL                             R2 2 1
        9 GETUPVAL                         R3 0
       10 GETTABLEKS                       R3 R3 K1 ["useEffect"]
       12 NEWCLOSURE                       R4 P1
       13 CAPTURE                          VAL R1
       14 CAPTURE                          VAL R2
       15 NEWTABLE                         R5 0 0
...
MAIN:
       ...
       29 GETTABLEKS                       R4 R4 K12 ["Signal"]
       31 CALL                             R3 1 1
