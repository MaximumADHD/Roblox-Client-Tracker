...
PROTO_2:
        ...
        6 GETUPVAL                         R3 1
        7 GETUPVAL                         R5 2
        8 GETTABLEKS                       R4 R5 K0 ["searchBarRef"]
       10 MOVE                             R5 R2
       11 CALL                             R3 2 1
       12 JUMPIFNOT                        R3 ; [+3]
       13 GETUPVAL                         R3 3
       ...
       19 JUMPIFNOT                        R1 ; [+29]
       20 GETUPVAL                         R4 2
       21 GETTABLEKS                       R3 R4 K1 ["onSearchRequested"]
       23 JUMPIFNOT                        R3 ; [+7]
       24 GETUPVAL                         R3 4
       25 CALL                             R3 0 1
       26 JUMPIF                           R3 ; [+4]
       27 GETUPVAL                         R4 2
       28 GETTABLEKS                       R3 R4 K1 ["onSearchRequested"]
       30 CALL                             R3 0 0
       31 GETTABLEKS                       R3 R0 K2 ["Text"]
       33 JUMPIFEQKS                       R3 K3 [""] ; [+7]
       35 GETUPVAL                         R4 2
       36 GETTABLEKS                       R3 R4 K4 ["onUpdateSearchHistory"]
       38 GETTABLEKS                       R4 R0 K2 ["Text"]
       40 CALL                             R3 1 0
       41 GETUPVAL                         R4 2
       42 GETTABLEKS                       R3 R4 K5 ["onFocusLost"]
       44 MOVE                             R4 R0
       45 MOVE                             R5 R1
       46 MOVE                             R6 R2
       47 GETUPVAL                         R7 3
...
PROTO_4:
        ...
        2 LOADN                            R3 1
        3 GETUPVAL                         R5 0
        4 GETTABLEKS                       R4 R5 K1 ["MAX_SEARCH_HISTORY_LENGTH"]
       ...
       26 CALL                             R2 1 0
       27 GETUPVAL                         R3 4
       28 GETTABLEKS                       R2 R3 K5 ["onSearchbarTextChanged"]
       30 MOVE                             R3 R1
       31 CALL                             R2 1 0
       32 GETUPVAL                         R3 4
       33 GETTABLEKS                       R2 R3 K6 ["onTextBoxChanged"]
       35 MOVE                             R3 R0
       36 CALL                             R2 1 0
       37 RETURN                           R0 0
...
PROTO_5:
       ...
       14 CALL                             R1 2 0
       15 GETUPVAL                         R2 0
       16 GETTABLEKS                       R1 R2 K5 ["initialSearchText"]
       18 JUMPIFNOT                        R1 ; [+18]
       19 NAMECALL                         R1 R0 K6 ["CaptureFocus"]
       21 CALL                             R1 1 0
       22 GETUPVAL                         R2 0
       23 GETTABLEKS                       R1 R2 K5 ["initialSearchText"]
...
PROTO_6:
        ...
        2 LOADN                            R1 2
        3 GETUPVAL                         R3 0
        4 GETTABLEKS                       R2 R3 K0 ["searchBarToggleOptions"]
        6 JUMPIF                           R2 ; [+3]
        7 NEWTABLE                         R2 0 0
        9 RETURN                           R2 1
       10 GETUPVAL                         R5 0
       11 GETTABLEKS                       R2 R5 K0 ["searchBarToggleOptions"]
       13 LOADNIL                          R3
       14 LOADNIL                          R4
       15 FORGPREP                         R2
       16 ADDK                             R1 R1 K1 [1]
...
PROTO_7:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R0 R1 K0 ["searchBarLeftIcon"]
        3 JUMPIF                           R0 ; [+2]
        4 LOADNIL                          R0
        5 RETURN                           R0 1
        6 GETUPVAL                         R0 1
       ...
       23 GETUPVAL                         R8 2
       24 GETTABLEKS                       R7 R8 K2 ["Tag"]
       26 GETUPVAL                         R10 0
       27 GETTABLEKS                       R9 R10 K0 ["searchBarLeftIcon"]
       29 GETTABLEKS                       R8 R9 K8 ["tags"]
...
PROTO_8:
        ...
        1 CALL                             R1 0 1
        2 GETUPVAL                         R3 1
        3 GETTABLEKS                       R2 R3 K0 ["useBinding"]
        5 LOADB                            R3 0
        6 CALL                             R2 1 2
        7 GETUPVAL                         R5 1
        8 GETTABLEKS                       R4 R5 K0 ["useBinding"]
       10 LOADK                            R5 K1 [""]
       11 CALL                             R4 1 2
       12 GETUPVAL                         R7 1
       13 GETTABLEKS                       R6 R7 K2 ["useState"]
       15 LOADB                            R7 0
       16 CALL                             R6 1 2
       17 GETUPVAL                         R9 1
       18 GETTABLEKS                       R8 R9 K3 ["useCallback"]
       20 NEWCLOSURE                       R9 P0
       21 CAPTURE                          VAL R0
       22 CAPTURE                          VAL R7
       23 NEWTABLE                         R10 0 1
       ...
       29 CALL                             R8 2 1
       30 GETUPVAL                         R10 1
       31 GETTABLEKS                       R9 R10 K3 ["useCallback"]
       ...
       44 CALL                             R9 2 1
       45 GETUPVAL                         R11 1
       46 GETTABLEKS                       R10 R11 K3 ["useCallback"]
       ...
       66 CALL                             R10 2 1
       67 GETUPVAL                         R12 1
       68 GETTABLEKS                       R11 R12 K3 ["useCallback"]
       ...
       80 CALL                             R11 2 1
       81 GETUPVAL                         R13 1
       82 GETTABLEKS                       R12 R13 K3 ["useCallback"]
       ...
       98 CALL                             R12 2 1
       99 GETUPVAL                         R14 1
      100 GETTABLEKS                       R13 R14 K11 ["useEffect"]
      ...
      127 GETUPVAL                         R19 1
      128 GETTABLEKS                       R18 R19 K16 ["Tag"]
      ...
      151 GETUPVAL                         R23 1
      152 GETTABLEKS                       R22 R23 K16 ["Tag"]
      ...
      181 GETUPVAL                         R24 1
      182 GETTABLEKS                       R23 R24 K30 ["Change"]
      184 GETTABLEKS                       R22 R23 K31 ["Text"]
      186 SETTABLE                         R12 R21 R22
      187 GETUPVAL                         R24 1
      188 GETTABLEKS                       R23 R24 K32 ["Event"]
      190 GETTABLEKS                       R22 R23 K33 ["Focused"]
      192 SETTABLE                         R9 R21 R22
      193 GETUPVAL                         R24 1
      194 GETTABLEKS                       R23 R24 K32 ["Event"]
      196 GETTABLEKS                       R22 R23 K34 ["FocusLost"]
      198 SETTABLE                         R10 R21 R22
      199 GETUPVAL                         R23 1
      200 GETTABLEKS                       R22 R23 K16 ["Tag"]
      ...
      216 GETUPVAL                         R24 1
      217 GETTABLEKS                       R23 R24 K32 ["Event"]
      219 GETTABLEKS                       R22 R23 K38 ["MouseButton1Up"]
      221 SETTABLE                         R11 R21 R22
      222 GETUPVAL                         R23 1
      223 GETTABLEKS                       R22 R23 K16 ["Tag"]
...
MAIN:
       ...
       20 GETTABLEKS                       R3 R4 K10 ["isInputInsideGui"]
       22 CALL                             R2 1 1
       23 GETIMPORT                        R3 K5 [require]
       25 GETTABLEKS                       R7 R0 K8 ["Src"]
       27 GETTABLEKS                       R6 R7 K11 ["Components"]
       29 GETTABLEKS                       R5 R6 K12 ["SearchBox"]
       31 GETTABLEKS                       R4 R5 K13 ["ToggleButton"]
       33 CALL                             R3 1 1
       34 GETIMPORT                        R4 K5 [require]
       36 GETTABLEKS                       R7 R0 K8 ["Src"]
       38 GETTABLEKS                       R6 R7 K14 ["Hooks"]
       40 GETTABLEKS                       R5 R6 K15 ["useLiveSearchingSetting"]
       42 CALL                             R4 1 1
       43 GETIMPORT                        R5 K5 [require]
       45 GETTABLEKS                       R8 R0 K8 ["Src"]
       47 GETTABLEKS                       R7 R8 K9 ["Util"]
       49 GETTABLEKS                       R6 R7 K16 ["Constants"]
       51 CALL                             R5 1 1
       52 GETIMPORT                        R6 K5 [require]
       54 GETTABLEKS                       R8 R0 K8 ["Src"]
       56 GETTABLEKS                       R7 R8 K17 ["Types"]
       58 CALL                             R6 1 1
