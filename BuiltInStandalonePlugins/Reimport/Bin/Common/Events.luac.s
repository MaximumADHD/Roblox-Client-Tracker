...
PROTO_1:
  ...
  RETURN R0 0
  GETTABLEN R3 R2 1
  GETTABLEKS R4 R3 K2 ["Shortcuts"]
  JUMPIFEQKNIL R4 [+6]
  GETTABLEKS R5 R3 K2 ["Shortcuts"]
  LENGTH R4 R5
  JUMPIFNOTEQKN R4 K1 [0] [+9]
  SETTABLEKS R1 R3 K2 ["Shortcuts"]
  GETUPVAL R4 0
  MOVE R6 R3
  LOADB R7 1
...
PROTO_6:
  ...
  MOVE R3 R1
  NEWTABLE R4 0 1
  LOADK R5 K13 ["Shift+Alt+R"]
  SETLIST R4 R5 1 [1]
  CALL R2 2 0
  GETUPVAL R4 0
  GETTABLEKS R3 R4 K14 ["REIMPORT_RELATIVE_TO_THIS"]
  ...
  CALL R3 2 1
  SETTABLEKS R3 R0 K16 ["reimport_rel"]
  GETUPVAL R5 0
  GETTABLEKS R4 R5 K17 ["CONFIGURE"]
  ...
  CALL R4 2 1
  SETTABLEKS R4 R0 K19 ["configure"]
  GETUPVAL R5 8
  GETTABLEKS R4 R5 K20 ["Unloading"]
  NEWCLOSURE R6 P3
  CAPTURE VAL R0
  NAMECALL R4 R4 K11 ["Connect"]
  CALL R4 2 0
...
MAIN:
  ...
  CAPTURE VAL R6
  CAPTURE VAL R1
  SETTABLEKS R12 R9 K26 ["registerActions"]
  RETURN R9 1
