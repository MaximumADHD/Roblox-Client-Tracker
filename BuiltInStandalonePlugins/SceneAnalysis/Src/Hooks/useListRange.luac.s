...
PROTO_1:
        ...
        5 CALL                             R6 0 1
        6 GETUPVAL                         R7 1
        7 GETTABLEKS                       R7 R7 K1 ["rowHeight"]
        9 IDIV                             R5 R6 R7
       10 ADD                              R3 R4 R5
       11 GETUPVAL                         R4 2
       ...
       25 SUBK                             R4 R5 K6 [1]
       26 GETUPVAL                         R5 4
       27 GETTABLEKS                       R5 R5 K7 ["getNodeAtIndex"]
       29 MOVE                             R6 R4
       30 CALL                             R5 1 1
       31 LOADNIL                          R6
       32 JUMPIFNOT                        R5 ; [+25]
       ...
       49 SUBK                             R9 R4 K6 [1]
       50 GETUPVAL                         R10 1
       51 GETTABLEKS                       R10 R10 K1 ["rowHeight"]
       53 MUL                              R8 R9 R10
       ...
       61 JUMPIFNOT                        R7 ; [+11]
       62 GETUPVAL                         R8 6
       63 GETTABLE                         R7 R8 R3
       64 GETTABLEKS                       R7 R7 K13 ["set"]
       66 JUMPIFNOT                        R7 ; [+6]
       67 GETUPVAL                         R8 6
       68 GETTABLE                         R7 R8 R3
       69 GETTABLEKS                       R7 R7 K13 ["set"]
       71 MOVE                             R8 R6
       72 CALL                             R7 1 0
       73 FORNLOOP                         R1
       74 RETURN                           R0 0
...
PROTO_3:
       ...
       34 NEWTABLE                         R2 0 3
       36 GETUPVAL                         R3 5
       37 GETTABLEKS                       R3 R3 K5 ["changedSignal"]
       39 MOVE                             R5 R1
       40 NAMECALL                         R3 R3 K6 ["Connect"]
       42 CALL                             R3 2 1
       43 GETUPVAL                         R4 8
       44 GETTABLEKS                       R4 R4 K7 ["getOrderObservable"]
       46 CALL                             R4 0 1
       47 GETTABLEKS                       R4 R4 K5 ["changedSignal"]
       49 MOVE                             R6 R1
       50 NAMECALL                         R4 R4 K6 ["Connect"]
       52 CALL                             R4 2 1
       53 GETUPVAL                         R5 8
       54 GETTABLEKS                       R5 R5 K8 ["getNodesObservable"]
       56 CALL                             R5 0 1
       57 GETTABLEKS                       R5 R5 K5 ["changedSignal"]
       59 MOVE                             R7 R1
...
PROTO_4:
        ...
        5 CALL                             R3 1 2
        6 GETUPVAL                         R8 1
        7 GETTABLEKS                       R8 R8 K1 ["rowHeight"]
        9 DIV                              R7 R1 R8
       10 FASTCALL1                        MATH_CEIL R7 ; [+2]
       11 GETIMPORT                        R6 K4 [math.ceil]
       13 CALL                             R6 1 1
       14 GETUPVAL                         R8 2
       15 GETTABLEKS                       R8 R8 K6 ["EXTRA_NODES"]
       17 MULK                             R7 R8 K5 [2]
       18 ADD                              R5 R6 R7
       19 GETUPVAL                         R6 0
       20 GETTABLEKS                       R6 R6 K7 ["useEffect"]
       22 NEWCLOSURE                       R7 P0
       23 CAPTURE                          VAL R5
       24 CAPTURE                          UPVAL U3
       25 CAPTURE                          UPVAL U4
