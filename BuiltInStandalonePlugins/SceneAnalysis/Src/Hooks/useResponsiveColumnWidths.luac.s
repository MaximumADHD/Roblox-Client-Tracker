...
PROTO_2:
        ...
        5 CALL                             R3 1 2
        6 GETUPVAL                         R6 1
        7 GETTABLEKS                       R5 R6 K1 ["useCallback"]
        9 NEWCLOSURE                       R6 P0
       10 CAPTURE                          VAL R1
       11 CAPTURE                          VAL R2
       12 CAPTURE                          UPVAL U2
       ...
       23 CALL                             R5 2 1
       24 GETUPVAL                         R7 0
       25 GETTABLEKS                       R6 R7 K2 ["useEffect"]
       27 MOVE                             R7 R1
       28 MOVE                             R8 R5
       29 NEWTABLE                         R9 0 1
       31 MOVE                             R10 R5
       ...
       46 CALL                             R6 3 0
       47 GETUPVAL                         R7 1
       48 GETTABLEKS                       R6 R7 K2 ["useEffect"]
       50 NEWCLOSURE                       R7 P1
       51 CAPTURE                          VAL R5
       52 NEWTABLE                         R8 0 1
       54 MOVE                             R9 R5
...
MAIN:
       ...
       20 GETTABLEKS                       R3 R4 K10 ["Observable"]
       22 CALL                             R2 1 1
       23 GETIMPORT                        R3 K5 [require]
       25 GETTABLEKS                       R6 R0 K8 ["Src"]
       27 GETTABLEKS                       R5 R6 K9 ["Util"]
       29 GETTABLEKS                       R4 R5 K11 ["calculateResponsiveWidths"]
       31 CALL                             R3 1 1
