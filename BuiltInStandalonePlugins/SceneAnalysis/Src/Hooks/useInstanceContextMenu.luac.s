PROTO_0:
        ...
        3 JUMPIFNOT                        R1 ; [+10]
        4 GETUPVAL                         R2 0
        5 GETTABLEKS                       R1 R2 K0 ["onRightClick"]
        7 JUMPIFNOT                        R1 ; [+6]
        8 GETUPVAL                         R2 0
        9 GETTABLEKS                       R1 R2 K0 ["onRightClick"]
       11 MOVE                             R2 R0
       12 CALL                             R1 1 0
       13 RETURN                           R0 0
       14 GETUPVAL                         R2 0
       15 GETTABLEKS                       R1 R2 K1 ["getNodeById"]
       17 MOVE                             R2 R0
       18 CALL                             R1 1 1
       19 JUMPIFNOT                        R1 ; [+3]
...
PROTO_1:
        ...
        4 JUMPIFNOT                        R1 ; [+10]
        5 GETUPVAL                         R2 1
        6 GETTABLEKS                       R1 R2 K0 ["onRightClick"]
        8 JUMPIFNOT                        R1 ; [+6]
        9 GETUPVAL                         R2 1
       10 GETTABLEKS                       R1 R2 K0 ["onRightClick"]
       12 MOVE                             R2 R0
       13 CALL                             R1 1 0
       14 RETURN                           R0 0
       15 GETUPVAL                         R2 1
       16 GETTABLEKS                       R1 R2 K1 ["getNodeById"]
       18 MOVE                             R2 R0
       19 CALL                             R1 1 1
       20 JUMPIFNOT                        R1 ; [+11]
...
PROTO_3:
       ...
       30 JUMPIFNOT                        R4 ; [+39]
       31 GETUPVAL                         R5 1
       32 GETTABLEKS                       R4 R5 K10 ["getNodeById"]
       34 JUMPIFNOT                        R4 ; [+35]
       35 GETUPVAL                         R5 1
       36 GETTABLEKS                       R4 R5 K10 ["getNodeById"]
       38 MOVE                             R5 R1
       39 CALL                             R4 1 1
       40 MOVE                             R5 R4
       41 JUMPIFNOT                        R5 ; [+2]
...
MAIN:
       ...
       33 GETTABLEKS                       R7 R8 K14 ["AssetDMBridge"]
       35 CALL                             R6 1 1
