PROTO_0:
  ...
  GETUPVAL R10 2
  DUPTABLE R11 K8 [{"userId", "playerName", "currentPartyId", "LayoutOrder"}]
  ...
  SETTABLEKS R6 R11 K7 ["LayoutOrder"]
  CALL R9 2 1
  SETTABLE R9 R2 R8
  FORGLOOP R3 2 [inext] [-24]
  GETUPVAL R4 1
  GETTABLEKS R3 R4 K4 ["createElement"]
  GETUPVAL R5 3
  GETTABLEKS R4 R5 K9 ["View"]
  DUPTABLE R5 K11 [{"tag", "LayoutOrder"}]
  LOADK R6 K12 ["size-full-0 auto-y col gap-small bg-surface-100 radius-medium"]
  SETTABLEKS R6 R5 K10 ["tag"]
  GETTABLEKS R6 R0 K7 ["LayoutOrder"]
  SETTABLEKS R6 R5 K7 ["LayoutOrder"]
  DUPTABLE R6 K15 [{"Header", "PlayersContainer"}]
  GETUPVAL R8 1
  GETTABLEKS R7 R8 K4 ["createElement"]
  GETUPVAL R8 4
  DUPTABLE R9 K20 [{"partyName", "playerCount", "showDeleteButton", "partyId", "LayoutOrder"}]
  GETTABLEKS R10 R0 K16 ["partyName"]
  SETTABLEKS R10 R9 K16 ["partyName"]
  GETTABLEKS R11 R0 K2 ["players"]
  LENGTH R10 R11
  SETTABLEKS R10 R9 K17 ["playerCount"]
  GETTABLEKS R11 R0 K19 ["partyId"]
  GETUPVAL R13 5
  GETTABLEKS R12 R13 K21 ["UNASSIGNED_PARTY_ID"]
  JUMPIFNOTEQ R11 R12 [+2]
  LOADB R10 0 +1
  LOADB R10 1
  SETTABLEKS R10 R9 K18 ["showDeleteButton"]
  GETTABLEKS R10 R0 K19 ["partyId"]
  SETTABLEKS R10 R9 K19 ["partyId"]
  MOVE R10 R1
  CALL R10 0 1
  ...
  LOADK R10 K22 ["size-full-0 auto-y col gap-small padding-small"]
  ...
  MOVE R10 R2
  CALL R7 3 1
  SETTABLEKS R7 R6 K14 ["PlayersContainer"]
  CALL R3 3 -1
  RETURN R3 -1
