...
PROTO_12:
  ...
  GETTABLEKS R3 R4 K15 ["new"]
  DUPCLOSURE R4 K23 [PROTO_11]
  NEWTABLE R5 0 0
  CALL R3 2 1
  SETTABLEKS R3 R0 K24 ["analytics"]
  GETUPVAL R4 5
  GETTABLEKS R3 R4 K15 ["new"]
  CALL R3 0 1
  ...
  SETLIST R9 R10 1 [1]
  CALL R5 4 1
  SETTABLEKS R5 R0 K29 ["design"]
  RETURN R0 0
  GETUPVAL R3 8
  GETTABLEKS R4 R1 K4 ["Plugin"]
  CALL R3 1 1
  SETTABLEKS R3 R0 K29 ["design"]
  RETURN R0 0
...
PROTO_14:
  ...
  DUPTABLE R15 K50 [{"EmulationEventsHandler", "PartyContextProvider"}]
  GETUPVAL R17 4
  GETTABLEKS R16 R17 K12 ["createElement"]
  GETUPVAL R17 7
  CALL R16 1 1
  SETTABLEKS R16 R15 K48 ["EmulationEventsHandler"]
  GETUPVAL R17 4
  GETTABLEKS R16 R17 K12 ["createElement"]
  GETUPVAL R18 8
  GETTABLEKS R17 R18 K51 ["provider"]
  NEWTABLE R18 0 0
  DUPTABLE R19 K53 [{"App"}]
  GETUPVAL R21 4
  GETTABLEKS R20 R21 K12 ["createElement"]
  GETUPVAL R21 9
  NEWTABLE R22 0 0
  CALL R20 2 1
  SETTABLEKS R20 R19 K52 ["App"]
  CALL R16 3 1
  SETTABLEKS R16 R15 K49 ["PartyContextProvider"]
  CALL R12 3 1
...
MAIN:
  ...
  CALL R4 1 1
  GETTABLEKS R6 R4 K13 ["Components"]
  GETTABLEKS R5 R6 K14 ["FoundationProviderAdapter"]
  GETTABLEKS R7 R4 K15 ["Util"]
  GETTABLEKS R6 R7 K16 ["StudioUri"]
  GETTABLEKS R8 R2 K17 ["UI"]
  GETTABLEKS R7 R8 K18 ["DockWidget"]
  GETTABLEKS R8 R2 K19 ["ContextServices"]
  GETTABLEKS R9 R8 K20 ["Plugin"]
  GETTABLEKS R10 R8 K21 ["Mouse"]
  GETTABLEKS R11 R8 K22 ["Design"]
  GETTABLEKS R14 R2 K23 ["Style"]
  GETTABLEKS R13 R14 K24 ["Themes"]
  GETTABLEKS R12 R13 K25 ["StudioTheme"]
  GETTABLEKS R14 R2 K26 ["Styling"]
  GETTABLEKS R13 R14 K27 ["registerPluginStyles"]
  GETTABLEKS R17 R0 K28 ["Src"]
  ...
  GETTABLEKS R18 R0 K28 ["Src"]
  GETTABLEKS R17 R18 K33 ["Contexts"]
  GETIMPORT R18 K5 [require]
  GETTABLEKS R19 R16 K34 ["App"]
  CALL R18 1 1
  GETIMPORT R19 K5 [require]
  GETTABLEKS R20 R16 K35 ["EmulationEventsHandler"]
  CALL R19 1 1
  GETIMPORT R20 K5 [require]
  GETTABLEKS R21 R17 K36 ["PartyContext"]
  CALL R20 1 1
  GETTABLEKS R22 R4 K37 ["SharedFlags"]
  GETTABLEKS R21 R22 K38 ["getFFlagStudioFoundationPluginMigration"]
  CALL R21 0 1
  GETTABLEKS R22 R3 K39 ["getFFlagEnableRibbonPlugin"]
  CALL R22 0 1
  GETTABLEKS R23 R3 K40 ["getFFlagRegisterActionsPluginLoader"]
  CALL R23 0 1
  AND R24 R23 R22
  GETTABLEKS R25 R1 K41 ["PureComponent"]
  LOADK R27 K42 ["MainPlugin"]
  NAMECALL R25 R25 K43 ["extend"]
  CALL R25 2 1
  GETTABLEKS R26 R6 K44 ["fromAction"]
  LOADK R27 K2 ["PartyEmulator"]
  LOADK R28 K45 ["Toggle"]
  CALL R26 2 1
  ...
  CAPTURE VAL R4
  CAPTURE VAL R13
  SETTABLEKS R27 R25 K47 ["init"]
  DUPCLOSURE R27 K48 [PROTO_13]
  CAPTURE VAL R24
  SETTABLEKS R27 R25 K49 ["didUpdate"]
  ...
  DUPCLOSURE R27 K52 [PROTO_15]
  SETTABLEKS R27 R25 K53 ["willUnmount"]
  RETURN R25 1
