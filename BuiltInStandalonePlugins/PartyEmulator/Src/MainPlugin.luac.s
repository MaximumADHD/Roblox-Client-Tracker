...
MAIN:
  ...
  CALL R20 1 1
  GETTABLEKS R21 R3 K37 ["getFFlagRegisterActionsPluginLoader"]
  CALL R21 0 1
  GETTABLEKS R22 R1 K38 ["PureComponent"]
  LOADK R24 K39 ["MainPlugin"]
  NAMECALL R22 R22 K40 ["extend"]
  CALL R22 2 1
  GETTABLEKS R23 R6 K41 ["fromAction"]
  LOADK R24 K2 ["PartyEmulator"]
  LOADK R25 K42 ["Toggle"]
  CALL R23 2 1
  DUPCLOSURE R24 K43 [PROTO_12]
  CAPTURE VAL R21
  CAPTURE VAL R23
  CAPTURE VAL R8
  CAPTURE VAL R14
  ...
  DUPCLOSURE R24 K45 [PROTO_13]
  CAPTURE VAL R21
  SETTABLEKS R24 R22 K46 ["didUpdate"]
  DUPCLOSURE R24 K47 [PROTO_14]
  CAPTURE VAL R8
  CAPTURE VAL R9
  CAPTURE VAL R10
  CAPTURE VAL R11
  ...
  DUPCLOSURE R24 K49 [PROTO_15]
  SETTABLEKS R24 R22 K50 ["willUnmount"]
  RETURN R22 1
