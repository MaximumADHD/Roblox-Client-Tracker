...
MAIN:
  ...
  CALL R20 1 1
  GETTABLEKS R21 R3 K37 ["getFFlagEnableRibbonPlugin"]
  CALL R21 0 1
  GETTABLEKS R22 R3 K38 ["getFFlagRegisterActionsPluginLoader"]
  CALL R22 0 1
  AND R23 R22 R21
  GETTABLEKS R24 R1 K39 ["PureComponent"]
  LOADK R26 K40 ["MainPlugin"]
  NAMECALL R24 R24 K41 ["extend"]
  CALL R24 2 1
  GETTABLEKS R25 R6 K42 ["fromAction"]
  LOADK R26 K2 ["PartyEmulator"]
  LOADK R27 K43 ["Toggle"]
  CALL R25 2 1
  ...
  CAPTURE VAL R4
  CAPTURE VAL R13
  SETTABLEKS R26 R24 K45 ["init"]
  DUPCLOSURE R26 K46 [PROTO_13]
  CAPTURE VAL R23
  SETTABLEKS R26 R24 K47 ["didUpdate"]
  ...
  CAPTURE VAL R20
  CAPTURE VAL R18
  SETTABLEKS R26 R24 K49 ["render"]
  DUPCLOSURE R26 K50 [PROTO_15]
  SETTABLEKS R26 R24 K51 ["willUnmount"]
  RETURN R24 1
