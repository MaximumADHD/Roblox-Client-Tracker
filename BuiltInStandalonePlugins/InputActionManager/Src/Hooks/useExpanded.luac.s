...
PROTO_1:
       ...
       20 GETUPVAL                         R2 0
       21 GETTABLEKS                       R2 R2 K3 ["bindings"]
       23 LENGTH                           R1 R2
       24 LOADN                            R2 0
       25 JUMPIFLT                         R2 R1 ; [+2]
       27 LOADB                            R0 0 +1
...
PROTO_3:
       ...
       10 GETTABLEKS                       R6 R3 K3 ["expansionsRef"]
       12 GETTABLEKS                       R6 R6 K4 ["current"]
       14 GETTABLE                         R5 R6 R0
       15 CALL                             R4 1 2
       16 GETUPVAL                         R6 0
       17 GETTABLEKS                       R6 R6 K5 ["useCallback"]
       19 NEWCLOSURE                       R7 P0
       20 CAPTURE                          VAL R3
       21 CAPTURE                          VAL R0
       22 CAPTURE                          VAL R5
       ...
       29 CALL                             R6 2 1
       30 GETUPVAL                         R7 0
       31 GETTABLEKS                       R7 R7 K6 ["useMemo"]
       33 NEWCLOSURE                       R8 P1
       34 CAPTURE                          VAL R1
       35 CAPTURE                          VAL R2
       36 NEWTABLE                         R9 0 1
       ...
       41 CALL                             R7 2 1
       42 GETUPVAL                         R8 0
       43 GETTABLEKS                       R8 R8 K7 ["useEffect"]
       45 NEWCLOSURE                       R9 P2
       46 CAPTURE                          VAL R5
       47 CAPTURE                          VAL R3
       48 CAPTURE                          VAL R0
