...
PROTO_3:
       ...
       35 RETURN                           R1 1
       36 GETUPVAL                         R7 1
       37 GETTABLEKS                       R4 R7 K4 ["bindings"]
       39 LOADNIL                          R5
       40 LOADNIL                          R6
       41 FORGPREP                         R4
       42 GETUPVAL                         R10 3
       43 GETTABLEKS                       R9 R10 K5 ["getBinding"]
       45 MOVE                             R10 R8
       46 CALL                             R9 1 1
       47 JUMPIFNOT                        R9 ; [+114]
      ...
      150 MOVE                             R12 R1
      151 GETUPVAL                         R14 3
      152 GETTABLEKS                       R13 R14 K14 ["subscribe"]
      154 MOVE                             R14 R8
...
PROTO_8:
       ...
       24 CALL                             R3 2 1
       25 GETUPVAL                         R5 0
       26 GETTABLEKS                       R4 R5 K3 ["useCallback"]
       28 DUPCLOSURE                       R5 K4 [PROTO_1]
       29 CAPTURE                          UPVAL U3
       30 NEWTABLE                         R6 0 0
       32 CALL                             R4 2 1
       33 GETUPVAL                         R6 0
       34 GETTABLEKS                       R5 R6 K5 ["useState"]
       36 LOADNIL                          R6
       37 CALL                             R5 1 2
       38 GETUPVAL                         R8 0
       39 GETTABLEKS                       R7 R8 K3 ["useCallback"]
       41 NEWCLOSURE                       R8 P2
       42 CAPTURE                          VAL R2
       43 CAPTURE                          VAL R0
       44 CAPTURE                          VAL R6
       ...
       55 CALL                             R7 2 1
       56 GETUPVAL                         R9 0
       57 GETTABLEKS                       R8 R9 K6 ["useEffect"]
       59 NEWCLOSURE                       R9 P3
       60 CAPTURE                          VAL R7
       61 NEWTABLE                         R10 0 2
       63 MOVE                             R11 R0
...
MAIN:
       ...
       20 GETTABLEKS                       R3 R4 K10 ["DatamodelReference"]
       22 CALL                             R2 1 1
       23 GETIMPORT                        R3 K5 [require]
       25 GETTABLEKS                       R6 R0 K8 ["Src"]
       27 GETTABLEKS                       R5 R6 K9 ["Contexts"]
       29 GETTABLEKS                       R4 R5 K11 ["SchemaKeyCodes"]
       31 CALL                             R3 1 1
