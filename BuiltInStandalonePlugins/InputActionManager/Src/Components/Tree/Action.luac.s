PROTO_0:
        ...
        9 RETURN                           R0 1
       10 GETUPVAL                         R1 2
       11 GETTABLEKS                       R0 R1 K0 ["createNextOrder"]
       13 CALL                             R0 0 1
       14 NEWTABLE                         R1 1 0
       16 GETUPVAL                         R4 0
       17 GETTABLEKS                       R3 R4 K1 ["KeyCode"]
       19 LENGTH                           R2 R3
       20 LOADN                            R3 1
       21 JUMPIFNOTLE                      R2 R3 ; [+47]
       23 GETUPVAL                         R4 0
       24 GETTABLEKS                       R3 R4 K2 ["CompoundDirection"]
       26 LENGTH                           R2 R3
       27 JUMPIFNOTEQKN                    R2 K3 [0] ; [+41]
       29 GETUPVAL                         R3 3
       30 GETTABLEKS                       R2 R3 K4 ["createElement"]
       32 GETUPVAL                         R3 4
       33 DUPTABLE                         R4 K10 [{"action", "bindings", "index", "LayoutOrder", "name"}]
       34 GETUPVAL                         R5 1
       35 SETTABLEKS                       R5 R4 K5 ["action"]
       37 GETUPVAL                         R8 0
       38 GETTABLEKS                       R7 R8 K1 ["KeyCode"]
       40 LENGTH                           R6 R7
       41 LOADN                            R7 0
       42 JUMPIFNOTLT                      R7 R6 ; [+6]
       44 GETUPVAL                         R7 0
       45 GETTABLEKS                       R6 R7 K1 ["KeyCode"]
      ...
      161 RETURN                           R1 1
      162 GETUPVAL                         R5 0
      163 GETTABLEKS                       R2 R5 K1 ["KeyCode"]
      165 LOADNIL                          R3
      166 LOADNIL                          R4
      167 FORGPREP                         R2
      ...
      173 MOVE                             R7 R8
      174 GETUPVAL                         R9 3
      175 GETTABLEKS                       R8 R9 K4 ["createElement"]
      177 GETUPVAL                         R9 4
      ...
      194 GETUPVAL                         R5 0
      195 GETTABLEKS                       R2 R5 K2 ["CompoundDirection"]
      197 LOADNIL                          R3
      198 LOADNIL                          R4
      199 FORGPREP                         R2
      ...
      205 MOVE                             R7 R8
      206 GETUPVAL                         R9 3
      207 GETTABLEKS                       R8 R9 K4 ["createElement"]
      209 GETUPVAL                         R9 5
...
PROTO_1:
       ...
       13 CALL                             R3 3 2
       14 GETUPVAL                         R6 3
       15 GETTABLEKS                       R5 R6 K2 ["useMemo"]
       17 NEWCLOSURE                       R6 P0
       18 CAPTURE                          VAL R2
       19 CAPTURE                          VAL R1
       20 CAPTURE                          UPVAL U4
       ...
       36 RETURN                           R6 1
       37 GETUPVAL                         R7 3
       38 GETTABLEKS                       R6 R7 K3 ["createElement"]
       40 GETUPVAL                         R7 8
...
MAIN:
       ...
       38 GETTABLEKS                       R6 R7 K14 ["SummaryRow"]
       40 CALL                             R5 1 1
       41 GETIMPORT                        R6 K5 [require]
       43 GETTABLEKS                       R10 R0 K11 ["Src"]
       45 GETTABLEKS                       R9 R10 K12 ["Components"]
       47 GETTABLEKS                       R8 R9 K13 ["Tree"]
       49 GETTABLEKS                       R7 R8 K15 ["CompoundDirectionBinding"]
       51 CALL                             R6 1 1
       52 GETIMPORT                        R7 K5 [require]
       54 GETTABLEKS                       R11 R0 K11 ["Src"]
       56 GETTABLEKS                       R10 R11 K12 ["Components"]
       58 GETTABLEKS                       R9 R10 K13 ["Tree"]
       60 GETTABLEKS                       R8 R9 K16 ["KeyCodeBinding"]
       62 CALL                             R7 1 1
       63 GETIMPORT                        R8 K5 [require]
       65 GETTABLEKS                       R10 R0 K11 ["Src"]
       67 GETTABLEKS                       R9 R10 K17 ["Types"]
       69 CALL                             R8 1 1
       70 GETIMPORT                        R9 K5 [require]
       72 GETTABLEKS                       R12 R0 K11 ["Src"]
       74 GETTABLEKS                       R11 R12 K18 ["Hooks"]
       76 GETTABLEKS                       R10 R11 K19 ["useBindings"]
       78 CALL                             R9 1 1
       79 GETIMPORT                        R10 K5 [require]
       81 GETTABLEKS                       R13 R0 K11 ["Src"]
       83 GETTABLEKS                       R12 R13 K18 ["Hooks"]
       85 GETTABLEKS                       R11 R12 K20 ["useExpanded"]
       87 CALL                             R10 1 1
       88 GETIMPORT                        R11 K5 [require]
       90 GETTABLEKS                       R14 R0 K11 ["Src"]
       92 GETTABLEKS                       R13 R14 K18 ["Hooks"]
       94 GETTABLEKS                       R12 R13 K21 ["useItem"]
       96 CALL                             R11 1 1
