PROTO_0:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R0 R1 K0 ["property"]
        3 JUMPIFNOTEQKS                    R0 K1 ["keyCode"] ; [+7]
        5 GETUPVAL                         R2 0
        6 GETTABLEKS                       R1 R2 K2 ["action"]
        8 GETTABLEKS                       R0 R1 K3 ["type"]
       10 RETURN                           R0 1
...
PROTO_1:
        ...
        3 GETIMPORT                        R3 K6 [Enum.KeyCode.Unknown]
        5 GETTABLEKS                       R2 R3 K7 ["Value"]
...
PROTO_2:
        0 GETUPVAL                         R1 0
        1 GETTABLEKS                       R0 R1 K0 ["binding"]
        3 JUMPIF                           R0 ; [+5]
        4 GETIMPORT                        R1 K4 [Enum.KeyCode.Unknown]
        6 GETTABLEKS                       R0 R1 K5 ["Value"]
        8 RETURN                           R0 1
        9 GETUPVAL                         R2 0
       10 GETTABLEKS                       R1 R2 K0 ["binding"]
       12 GETUPVAL                         R3 0
       13 GETTABLEKS                       R2 R3 K6 ["property"]
       15 GETTABLE                         R0 R1 R2
       16 JUMPIFNOT                        R0 ; [+3]
       17 GETTABLEKS                       R1 R0 K5 ["Value"]
       19 RETURN                           R1 1
       20 GETIMPORT                        R2 K4 [Enum.KeyCode.Unknown]
       22 GETTABLEKS                       R1 R2 K5 ["Value"]
       24 RETURN                           R1 1
...
PROTO_3:
       ...
       14 CALL                             R1 2 0
       15 GETUPVAL                         R2 0
       16 GETTABLEKS                       R1 R2 K6 ["binding"]
       18 JUMPIFNOT                        R1 ; [+35]
       ...
       25 NEWTABLE                         R2 0 0
       27 GETUPVAL                         R4 0
       28 GETTABLEKS                       R3 R4 K11 ["property"]
       ...
       42 CALL                             R3 2 0
       43 GETUPVAL                         R4 1
       44 GETTABLEKS                       R3 R4 K14 ["updateBinding"]
       46 GETUPVAL                         R6 0
       47 GETTABLEKS                       R5 R6 K6 ["binding"]
       49 GETTABLEKS                       R4 R5 K15 ["uuid"]
       51 MOVE                             R5 R2
       52 CALL                             R3 2 0
       53 RETURN                           R0 0
       ...
       61 LOADK                            R4 K19 ["%*%*"]
       62 GETUPVAL                         R8 0
       63 GETTABLEKS                       R7 R8 K20 ["action"]
       65 GETTABLEKS                       R6 R7 K16 ["name"]
       67 GETUPVAL                         R8 0
       68 GETTABLEKS                       R7 R8 K21 ["schema"]
       70 NAMECALL                         R4 R4 K13 ["format"]
       72 CALL                             R4 3 1
       73 MOVE                             R3 R4
       74 SETTABLEKS                       R3 R2 K16 ["name"]
       76 GETUPVAL                         R5 0
       77 GETTABLEKS                       R4 R5 K20 ["action"]
       79 GETTABLEKS                       R3 R4 K15 ["uuid"]
       81 SETTABLEKS                       R3 R2 K17 ["parentUuid"]
       83 GETUPVAL                         R4 0
       84 GETTABLEKS                       R3 R4 K11 ["property"]
       86 SETTABLE                         R1 R2 R3
       87 GETUPVAL                         R4 1
       88 GETTABLEKS                       R3 R4 K14 ["updateBinding"]
       90 LOADNIL                          R4
       91 MOVE                             R5 R2
       92 CALL                             R3 2 0
       93 RETURN                           R0 0
...
PROTO_4:
       ...
       42 CALL                             R4 2 1
       43 GETUPVAL                         R6 0
       44 GETTABLEKS                       R5 R6 K2 ["useMemo"]
       46 NEWCLOSURE                       R6 P2
       47 CAPTURE                          VAL R0
       48 NEWTABLE                         R7 0 2
       ...
       56 CALL                             R5 2 1
       57 GETUPVAL                         R7 0
       58 GETTABLEKS                       R6 R7 K7 ["useCallback"]
       60 NEWCLOSURE                       R7 P3
       61 CAPTURE                          VAL R0
       62 CAPTURE                          VAL R1
       63 NEWTABLE                         R8 0 2
       ...
       71 CALL                             R6 2 1
       72 GETUPVAL                         R8 0
       73 GETTABLEKS                       R7 R8 K8 ["createElement"]
       75 GETUPVAL                         R8 3
       ...
       85 GETUPVAL                         R12 0
       86 GETTABLEKS                       R11 R12 K8 ["createElement"]
       88 GETUPVAL                         R12 4
      ...
      100 GETUPVAL                         R17 5
      101 GETTABLEKS                       R16 R17 K25 ["Enums"]
      103 GETTABLEKS                       R15 R16 K26 ["InputSize"]
      105 GETTABLEKS                       R14 R15 K27 ["Small"]
...
MAIN:
       ...
       20 CALL                             R2 1 1
       21 GETTABLEKS                       R4 R2 K9 ["Dropdown"]
       23 GETTABLEKS                       R3 R4 K10 ["Root"]
       25 GETTABLEKS                       R4 R2 K11 ["View"]
       27 GETIMPORT                        R5 K5 [require]
       29 GETTABLEKS                       R8 R0 K12 ["Src"]
       31 GETTABLEKS                       R7 R8 K13 ["Contexts"]
       33 GETTABLEKS                       R6 R7 K14 ["DatamodelReference"]
       35 CALL                             R5 1 1
       36 GETIMPORT                        R6 K5 [require]
       38 GETTABLEKS                       R9 R0 K12 ["Src"]
       40 GETTABLEKS                       R8 R9 K13 ["Contexts"]
       42 GETTABLEKS                       R7 R8 K15 ["SchemaKeyCodes"]
       44 CALL                             R6 1 1
       45 GETIMPORT                        R7 K5 [require]
       47 GETTABLEKS                       R9 R0 K12 ["Src"]
       49 GETTABLEKS                       R8 R9 K16 ["Types"]
       51 CALL                             R7 1 1
