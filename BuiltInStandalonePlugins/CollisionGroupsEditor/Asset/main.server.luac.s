...
PROTO_14:
  ...
  GETTABLEKS R5 R0 K5 ["otherGroupName"]
  NAMECALL R2 R2 K10 ["CollisionGroupsAreCollidable"]
  CALL R2 3 1
  NOT R1 R2
  GETUPVAL R2 2
  LOADK R4 K11 ["Setting group collision state"]
  ...
  GETTABLEKS R5 R0 K5 ["otherGroupName"]
  MOVE R6 R1
  NAMECALL R2 R2 K13 ["CollisionGroupSetCollidable"]
  CALL R2 4 0
  GETUPVAL R2 2
  LOADK R4 K14 ["Set group collision state"]
  NAMECALL R2 R2 K12 ["SetWaypoint"]
  CALL R2 2 0
  NEWTABLE R2 0 0
  GETUPVAL R3 3
  ...
  LOADK R7 K17 ["Groups"]
  MOVE R8 R3
  NAMECALL R5 R5 K18 ["SetItem"]
  CALL R5 3 0
  GETIMPORT R5 K16 [plugin]
  LOADK R7 K19 ["SelectedGroupIds"]
  MOVE R8 R4
  NAMECALL R5 R5 K18 ["SetItem"]
  CALL R5 3 0
  GETIMPORT R3 K16 [plugin]
  LOADK R5 K20 ["SetStateAndRefresh"]
  MOVE R6 R2
...
MAIN:
  ...
  CAPTURE VAL R15
  DUPCLOSURE R18 K25 [PROTO_9]
  CAPTURE VAL R2
  NEWTABLE R19 0 0
  DUPCLOSURE R20 K26 [PROTO_17]
  CAPTURE VAL R19
  CAPTURE VAL R16
  CAPTURE VAL R6
  CAPTURE VAL R7
  ...
  CAPTURE REF R25
  CAPTURE VAL R26
  GETIMPORT R30 K29 [plugin]
  GETTABLEKS R29 R30 K30 ["MultipleDocumentInterfaceInstance"]
  MOVE R30 R28
  GETTABLEKS R31 R29 K31 ["FocusedDataModelSession"]
  CALL R30 1 0
  CLOSEUPVALS R10
  RETURN R0 0
