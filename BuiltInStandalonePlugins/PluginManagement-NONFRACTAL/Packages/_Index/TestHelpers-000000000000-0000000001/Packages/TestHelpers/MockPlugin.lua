...
--[[
	MockQWidgetPluginGui
]]
local MockQWidgetPluginGui = {}
do
	MockQWidgetPluginGui.__index = MockQWidgetPluginGui

	function MockQWidgetPluginGui.new(pluginId, pluginGuiOptions)
		local initiallyEnabled = true
		if pluginGuiOptions.InitialEnabled then
			initiallyEnabled = pluginGuiOptions.InitialEnabled == true
		end

		local mockQWidget = Instance.new("BillboardGui")
		mockQWidget.Enabled = initiallyEnabled
...
function MockPlugin:CreateQWidgetPluginGui(pluginId, pluginGuiOptions)
	return MockQWidgetPluginGui.new(pluginId, pluginGuiOptions)
end
