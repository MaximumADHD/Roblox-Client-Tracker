MAIN:
  ...
  CALL R1 1 1
  GETTABLEKS R2 R1 K9 ["getFFlagEnableFlipbook"]
  CALL R2 0 1
  JUMPIF R2 [+1]
  RETURN R0 0
  ...
  CALL R3 2 1
  NAMECALL R3 R3 K20 ["HasInternalPermission"]
  CALL R3 1 1
  JUMPIF R3 [+1]
  RETURN R0 0
  ...
  GETTABLEKS R4 R5 K21 ["pluginType"]
  CALL R3 1 1
  GETTABLEKS R4 R3 K22 ["get"]
  CALL R4 0 1
  GETTABLEKS R5 R3 K23 ["Standalone"]
  JUMPIFEQ R4 R5 [+2]
  RETURN R0 0
  GETIMPORT R4 K5 [require]
  GETTABLEKS R7 R0 K6 ["Bin"]
  GETTABLEKS R6 R7 K7 ["Common"]
  GETTABLEKS R5 R6 K24 ["setup"]
  CALL R4 1 1
  MOVE R5 R4
