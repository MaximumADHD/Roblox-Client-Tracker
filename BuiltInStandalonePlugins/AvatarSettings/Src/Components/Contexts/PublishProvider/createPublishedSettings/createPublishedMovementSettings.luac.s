PROTO_0:
        ...
        1 CALL                             R0 0 1
        2 JUMPIFNOT                        R0 ; [+18]
        3 DUPTABLE                         R0 K18 [{[1], ["collisionHitAndTouchDetectionSetting"], ["collisionMethodSetting"], ["collisionSizeSetting"] = {0, 0, 0}, ["characterControllerModeSetting"], ["defaultAbilitiesEnableClimbingSetting"] = True, ["defaultAbilitiesEnableCrouchingSetting"] = True, ["defaultAbilitiesEnableFallingDownSetting"] = True, ["defaultAbilitiesEnableGettingUpSetting"] = True, ["defaultAbilitiesEnableHoldingSetting"] = True, ["defaultAbilitiesEnableJumpingSetting"] = True, ["defaultAbilitiesEnableReachingSetting"] = True, ["defaultAbilitiesEnableRunningSetting"] = True, ["defaultAbilitiesEnableSittingSetting"] = True, ["defaultAbilitiesEnableSprintingSetting"] = True, ["defaultAbilitiesEnableSwimmingSetting"] = True}]
        4 GETIMPORT                        R1 K22 [Enum.AvatarSettingsCollisionMode.Default]
        6 SETTABLEKS                       R1 R0 K0 ["collisionSetting"]
        8 GETIMPORT                        R1 K25 [Enum.AvatarSettingsHitAndTouchDetectionMode.UseCollider]
       10 SETTABLEKS                       R1 R0 K1 ["collisionHitAndTouchDetectionSetting"]
       12 GETIMPORT                        R1 K28 [Enum.AvatarSettingsLegacyCollisionMode.InnerBoxColliders]
       14 SETTABLEKS                       R1 R0 K2 ["collisionMethodSetting"]
       16 GETIMPORT                        R1 K31 [Enum.AvatarSettingsCharacterControllerMode.LegacyHumanoid]
       18 SETTABLEKS                       R1 R0 K5 ["characterControllerModeSetting"]
       20 RETURN                           R0 1
       21 DUPTABLE                         R0 K32 [{[1], ["collisionHitAndTouchDetectionSetting"], ["collisionMethodSetting"], ["collisionSizeSetting"] = {0, 0, 0}, ["characterControllerModeSetting"], ["defaultAbilitiesEnableRunningSetting"] = True, ["defaultAbilitiesEnableJumpingSetting"] = True, ["defaultAbilitiesEnableSittingSetting"] = True, ["defaultAbilitiesEnableFallingDownSetting"] = True, ["defaultAbilitiesEnableGettingUpSetting"] = True, ["defaultAbilitiesEnableClimbingSetting"] = True, ["defaultAbilitiesEnableSwimmingSetting"] = True}]
       22 GETIMPORT                        R1 K22 [Enum.AvatarSettingsCollisionMode.Default]
       24 SETTABLEKS                       R1 R0 K0 ["collisionSetting"]
       26 GETIMPORT                        R1 K25 [Enum.AvatarSettingsHitAndTouchDetectionMode.UseCollider]
       28 SETTABLEKS                       R1 R0 K1 ["collisionHitAndTouchDetectionSetting"]
       30 GETIMPORT                        R1 K28 [Enum.AvatarSettingsLegacyCollisionMode.InnerBoxColliders]
       32 SETTABLEKS                       R1 R0 K2 ["collisionMethodSetting"]
       34 GETIMPORT                        R1 K31 [Enum.AvatarSettingsCharacterControllerMode.LegacyHumanoid]
