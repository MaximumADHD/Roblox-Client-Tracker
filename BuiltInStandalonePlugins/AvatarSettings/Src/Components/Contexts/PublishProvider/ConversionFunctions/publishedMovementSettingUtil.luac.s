...
MAIN:
  ...
  CALL R4 1 1
  NEWTABLE R5 4 0
  DUPTABLE R6 K17 [{"nonAssetIdSettingKeys"}]
  GETTABLEKS R7 R3 K18 ["movementSettingKeys"]
  ...
  CAPTURE VAL R4
  CAPTURE VAL R6
  SETTABLEKS R8 R5 K21 ["isEqual"]
  DUPCLOSURE R8 K22 [PROTO_2]
  CAPTURE VAL R4
  CAPTURE VAL R6
  SETTABLEKS R8 R5 K23 ["setPublishedMovementSetting"]
  DUPCLOSURE R8 K24 [PROTO_3]
  CAPTURE VAL R4
  CAPTURE VAL R6
  SETTABLEKS R8 R5 K25 ["setUnpublishedMovementSetting"]
  RETURN R5 1
