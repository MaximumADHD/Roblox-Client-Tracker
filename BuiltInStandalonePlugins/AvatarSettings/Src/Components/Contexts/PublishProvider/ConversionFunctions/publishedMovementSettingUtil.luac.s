PROTO_0:
        ...
        4 MOVE                             R6 R0
        5 MOVE                             R7 R1
        6 LOADK                            R8 K1 ["movement setting"]
        7 MOVE                             R9 R2
        8 MOVE                             R10 R3
        9 CALL                             R4 6 0
       10 RETURN                           R0 0
...
PROTO_1:
        ...
        4 MOVE                             R4 R0
        5 MOVE                             R5 R1
        6 LOADK                            R6 K1 ["movement setting"]
        7 CALL                             R2 4 -1
        8 RETURN                           R2 -1
...
PROTO_2:
       ...
       18 MOVE                             R6 R0
       19 MOVE                             R7 R1
       20 LOADK                            R8 K1 ["movement setting"]
       21 MOVE                             R9 R2
       22 MOVE                             R10 R3
       23 CALL                             R4 6 0
       24 RETURN                           R0 0
...
MAIN:
       ...
       58 CALL                             R4 1 1
       59 NEWTABLE                         R5 4 0
       61 DUPTABLE                         R6 K17 [{"nonAssetIdSettingKeys"}]
       62 GETTABLEKS                       R7 R3 K18 ["movementSettingKeys"]
       64 SETTABLEKS                       R7 R6 K16 ["nonAssetIdSettingKeys"]
       66 DUPCLOSURE                       R7 K19 [PROTO_0]
       67 CAPTURE                          VAL R4
       68 CAPTURE                          VAL R6
       69 DUPCLOSURE                       R8 K20 [PROTO_1]
       70 CAPTURE                          VAL R4
       71 CAPTURE                          VAL R6
       72 SETTABLEKS                       R8 R5 K21 ["isEqual"]
       74 DUPCLOSURE                       R8 K22 [PROTO_2]
       75 CAPTURE                          VAL R4
       76 CAPTURE                          VAL R6
       77 SETTABLEKS                       R8 R5 K23 ["setPublishedMovementSetting"]
       79 DUPCLOSURE                       R8 K24 [PROTO_3]
       80 CAPTURE                          VAL R4
       81 CAPTURE                          VAL R6
       82 SETTABLEKS                       R8 R5 K25 ["setUnpublishedMovementSetting"]
       84 RETURN                           R5 1
