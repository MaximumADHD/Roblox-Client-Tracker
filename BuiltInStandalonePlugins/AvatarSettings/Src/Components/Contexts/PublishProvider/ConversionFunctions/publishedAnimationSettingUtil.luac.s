PROTO_0:
        ...
        4 MOVE                             R6 R0
        5 MOVE                             R7 R1
        6 LOADK                            R8 K1 ["animation setting"]
        7 MOVE                             R9 R2
        8 MOVE                             R10 R3
        9 CALL                             R4 6 0
       10 RETURN                           R0 0
...
PROTO_1:
        ...
        4 MOVE                             R4 R0
        5 MOVE                             R5 R1
        6 LOADK                            R6 K1 ["animation setting"]
        7 CALL                             R2 4 -1
        8 RETURN                           R2 -1
...
PROTO_2:
       ...
       18 MOVE                             R6 R0
       19 MOVE                             R7 R1
       20 LOADK                            R8 K1 ["animation setting"]
       21 MOVE                             R9 R2
       22 MOVE                             R10 R3
       23 CALL                             R4 6 0
       24 RETURN                           R0 0
...
MAIN:
       ...
       62 GETTABLEKS                       R7 R3 K19 ["animationSettingKeys"]
       64 SETTABLEKS                       R7 R6 K16 ["nonAssetIdSettingKeys"]
       66 GETTABLEKS                       R7 R3 K20 ["animationSettingAssetIdKeys"]
       ...
       79 CAPTURE                          VAL R4
       80 CAPTURE                          VAL R6
       81 SETTABLEKS                       R8 R5 K25 ["setPublishedAnimationSetting"]
       83 DUPCLOSURE                       R8 K26 [PROTO_3]
       84 CAPTURE                          VAL R4
       85 CAPTURE                          VAL R6
       86 SETTABLEKS                       R8 R5 K27 ["setUnpublishedAnimationSetting"]
       88 RETURN                           R5 1
