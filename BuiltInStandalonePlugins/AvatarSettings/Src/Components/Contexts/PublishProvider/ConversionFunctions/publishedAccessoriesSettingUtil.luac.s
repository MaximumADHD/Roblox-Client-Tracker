PROTO_0:
  ...
  MOVE R6 R0
  MOVE R7 R1
  LOADK R8 K1 ["accessories setting"]
  MOVE R9 R2
  MOVE R10 R3
  CALL R4 6 0
  RETURN R0 0
...
PROTO_1:
  ...
  MOVE R4 R0
  MOVE R5 R1
  LOADK R6 K1 ["accessories setting"]
  CALL R2 4 -1
  RETURN R2 -1
...
PROTO_2:
  ...
  MOVE R3 R0
  MOVE R4 R1
  LOADK R5 K1 ["accessories setting"]
  CALL R2 3 1
  GETUPVAL R4 0
...
MAIN:
  ...
  GETTABLEKS R7 R3 K19 ["accessoriesSettingKeys"]
  SETTABLEKS R7 R6 K16 ["nonAssetIdSettingKeys"]
  GETTABLEKS R7 R3 K20 ["accessoriesSettingAssetIdKeys"]
  ...
  CAPTURE VAL R4
  CAPTURE VAL R6
  SETTABLEKS R8 R5 K25 ["setPublishedAccessoriesSetting"]
  DUPCLOSURE R8 K26 [PROTO_3]
  CAPTURE VAL R4
  CAPTURE VAL R6
  SETTABLEKS R8 R5 K27 ["setUnpublishedAccessoriesSetting"]
  RETURN R5 1
