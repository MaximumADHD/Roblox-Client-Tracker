...
PROTO_4:
  ...
  GETUPVAL R11 7
  GETUPVAL R12 8
  DUPTABLE R13 K33 [{"text", "layoutOrder", "showWarning"}]
  LOADK R16 K13 ["AccessoriesSettings"]
  LOADK R17 K34 ["AccessoryScaleSection"]
  ...
  LOADB R14 1
  SETTABLEKS R14 R13 K32 ["showWarning"]
  DUPTABLE R14 K39 [{"UIListLayout", "AccessoryScaleModeSelector", "LimitMethodTitleFrame", "LimitBoundsTitleFrame"}]
  GETUPVAL R15 7
  LOADK R16 K35 ["UIListLayout"]
  DUPTABLE R17 K41 [{"Padding"}]
  ...
  LOADK R21 K48 ["AccessoryScaleSectionPlayerChoiceSubText"]
  JUMP [+1]
  LOADK R21 K49 ["AccessoryScaleSectionCustomLimitSubText"]
  NAMECALL R18 R1 K15 ["getText"]
  CALL R18 3 1
  SETTABLEKS R18 R17 K45 ["subText"]
  CALL R15 2 1
  SETTABLEKS R15 R14 K36 ["AccessoryScaleModeSelector"]
  MOVE R15 R10
  JUMPIFNOT R15 [+89]
  GETUPVAL R15 7
  GETUPVAL R16 10
  ...
  SETTABLEKS R8 R17 K52 ["minTextLabelWidth"]
  LOADK R20 K13 ["AccessoriesSettings"]
  LOADK R21 K55 ["AccessoryScaleSectionLimitMethod"]
  NAMECALL R18 R1 K15 ["getText"]
  CALL R18 3 1
  SETTABLEKS R18 R17 K30 ["text"]
  DUPTABLE R18 K57 [{"LimitMethodSelectInput"}]
  GETUPVAL R19 7
  GETUPVAL R20 11
  DUPTABLE R21 K65 [{"PlaceholderText", "Items", "Size", "OnRenderItem", "UseAutoWidth", "SelectedId", "OnItemActivated"}]
  LOADK R22 K66 ["Remove"]
  SETTABLEKS R22 R21 K58 ["PlaceholderText"]
  NEWTABLE R22 0 2
  DUPTABLE R23 K8 [{"Id", "Label"}]
  GETIMPORT R24 K69 [Enum.AvatarSettingsAccessoryLimitMethod.Scale]
  SETTABLEKS R24 R23 K6 ["Id"]
  LOADK R26 K13 ["AccessoriesSettings"]
  LOADK R27 K70 ["AccessoryScaleSectionLimitMethodScale"]
  NAMECALL R24 R1 K15 ["getText"]
  CALL R24 3 1
  SETTABLEKS R24 R23 K7 ["Label"]
  DUPTABLE R24 K8 [{"Id", "Label"}]
  GETIMPORT R25 K71 [Enum.AvatarSettingsAccessoryLimitMethod.Remove]
  SETTABLEKS R25 R24 K6 ["Id"]
  LOADK R27 K13 ["AccessoriesSettings"]
  LOADK R28 K72 ["AccessoryScaleSectionLimitMethodRemove"]
  NAMECALL R25 R1 K15 ["getText"]
  CALL R25 3 1
  SETTABLEKS R25 R24 K7 ["Label"]
  SETLIST R22 R23 2 [1]
  SETTABLEKS R22 R21 K59 ["Items"]
  GETIMPORT R22 K75 [UDim2.fromOffset]
  LOADN R23 128
  GETUPVAL R25 4
  GETTABLEKS R24 R25 K76 ["STANDARD_HEIGHT"]
  CALL R22 2 1
  SETTABLEKS R22 R21 K60 ["Size"]
  GETUPVAL R22 12
  SETTABLEKS R22 R21 K61 ["OnRenderItem"]
  LOADB R22 1
  SETTABLEKS R22 R21 K62 ["UseAutoWidth"]
  SETTABLEKS R7 R21 K63 ["SelectedId"]
  NEWCLOSURE R22 P2
  CAPTURE VAL R7
  CAPTURE VAL R5
  SETTABLEKS R22 R21 K64 ["OnItemActivated"]
  CALL R19 2 1
  SETTABLEKS R19 R18 K56 ["LimitMethodSelectInput"]
  CALL R15 3 1
  SETTABLEKS R15 R14 K37 ["LimitMethodTitleFrame"]
  MOVE R15 R10
  JUMPIFNOT R15 [+57]
  GETUPVAL R15 7
  GETUPVAL R16 10
  ...
  SETTABLEKS R8 R17 K52 ["minTextLabelWidth"]
  LOADK R20 K13 ["AccessoriesSettings"]
  LOADK R21 K77 ["AccessoryScaleSectionLimitBounds"]
  NAMECALL R18 R1 K15 ["getText"]
  CALL R18 3 1
  SETTABLEKS R18 R17 K30 ["text"]
  DUPTABLE R18 K79 [{"Input"}]
  GETUPVAL R19 7
  GETUPVAL R20 13
  DUPTABLE R21 K81 [{"layoutOrder", "value", "setValue", "text"}]
  MOVE R22 R2
  CALL R22 0 1
  ...
  SETTABLEKS R22 R21 K80 ["setValue"]
  LOADK R24 K82 ["General"]
  LOADK R25 K83 ["PaddingAroundAvatar"]
  NAMECALL R22 R1 K15 ["getText"]
  CALL R22 3 1
  SETTABLEKS R22 R21 K30 ["text"]
  CALL R19 2 1
  SETTABLEKS R19 R18 K78 ["Input"]
  CALL R15 3 1
  SETTABLEKS R15 R14 K38 ["LimitBoundsTitleFrame"]
  CALL R11 3 -1
  RETURN R11 -1
...
MAIN:
  ...
  GETTABLEKS R17 R7 K27 ["createNextOrder"]
  GETTABLEKS R18 R6 K28 ["createElement"]
