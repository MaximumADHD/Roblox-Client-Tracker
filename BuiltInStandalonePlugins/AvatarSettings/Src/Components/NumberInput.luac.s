PROTO_0:
        ...
        4 JUMPIFNOT                        R2 ; [+6]
        5 GETUPVAL                         R3 1
        6 GETTABLEKS                       R3 R3 K0 ["setValue"]
        8 MOVE                             R4 R2
        9 CALL                             R3 1 0
       10 RETURN                           R0 0
       11 RETURN                           R0 0
...
PROTO_1:
        0 GETUPVAL                         R2 0
        1 GETTABLEKS                       R2 R2 K0 ["contextMenuProps"]
        3 JUMPIFNOT                        R2 ; [+14]
       ...
       11 GETUPVAL                         R3 2
       12 GETUPVAL                         R4 0
       13 GETTABLEKS                       R4 R4 K0 ["contextMenuProps"]
       15 GETTABLEKS                       R4 R4 K5 ["menuActions"]
       17 CALL                             R2 2 0
       18 RETURN                           R0 0
...
PROTO_3:
       ...
       24 GETUPVAL                         R8 6
       25 GETTABLEKS                       R8 R8 K6 ["Event"]
       27 GETTABLEKS                       R8 R8 K7 ["InputBegan"]
       29 NEWCLOSURE                       R9 P1
       30 CAPTURE                          VAL R0
       31 CAPTURE                          UPVAL U7
       32 CAPTURE                          VAL R4
       ...
       62 LOADN                            R17 48
       63 GETUPVAL                         R18 9
       64 GETTABLEKS                       R18 R18 K27 ["STANDARD_HEIGHT"]
       66 CALL                             R16 2 1
