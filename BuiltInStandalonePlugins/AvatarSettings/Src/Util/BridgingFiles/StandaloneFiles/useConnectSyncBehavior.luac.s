PROTO_0:
        0 GETUPVAL                         R0 0
        1 GETUPVAL                         R2 1
        2 GETTABLEKS                       R2 R2 K0 ["onInitialization"]
       ...
       15 GETTABLEKS                       R0 R0 K4 ["settings"]
       17 JUMPIFNOT                        R0 ; [+11]
       18 GETUPVAL                         R0 3
       19 GETTABLEKS                       R0 R0 K3 ["current"]
       21 GETTABLEKS                       R0 R0 K4 ["settings"]
       23 GETTABLEKS                       R0 R0 K5 ["navigationBarSettings"]
       25 GETTABLEKS                       R0 R0 K6 ["setPreviewToggled"]
       27 LOADB                            R1 0
       28 CALL                             R0 1 0
       29 RETURN                           R0 0
...
PROTO_1:
        0 GETUPVAL                         R0 0
        1 GETUPVAL                         R2 1
        2 GETTABLEKS                       R2 R2 K0 ["CreateAvatarRules"]
        4 GETTABLEKS                       R2 R2 K1 ["fromPlugin"]
        6 NAMECALL                         R0 R0 K2 ["Invoke"]
        8 CALL                             R0 2 0
        9 RETURN                           R0 0
...
PROTO_4:
       ...
       14 GETUPVAL                         R0 0
       15 GETUPVAL                         R2 1
       16 GETTABLEKS                       R2 R2 K3 ["CreateAvatarRules"]
       18 GETTABLEKS                       R2 R2 K1 ["fromAssetDm"]
       20 NEWCLOSURE                       R3 P1
       21 CAPTURE                          UPVAL U0
       22 CAPTURE                          UPVAL U1
       ...
       30 GETUPVAL                         R2 0
       31 GETUPVAL                         R4 1
       32 GETTABLEKS                       R4 R4 K7 ["syncAvatarSettings"]
       34 NEWCLOSURE                       R5 P2
       35 CAPTURE                          UPVAL U4
       36 CAPTURE                          UPVAL U3
       37 CAPTURE                          VAL R0
       ...
       49 GETUPVAL                         R2 0
       50 GETUPVAL                         R4 1
       51 GETTABLEKS                       R4 R4 K0 ["onInitialization"]
       53 GETTABLEKS                       R4 R4 K11 ["fromPlugin"]
       55 NAMECALL                         R2 R2 K12 ["Invoke"]
       57 CALL                             R2 2 0
       58 GETUPVAL                         R2 0
       59 GETUPVAL                         R4 1
       60 GETTABLEKS                       R4 R4 K3 ["CreateAvatarRules"]
       62 GETTABLEKS                       R4 R4 K11 ["fromPlugin"]
...
MAIN:
       ...
       40 GETTABLEKS                       R5 R5 K14 ["InvokeKeys"]
       42 CALL                             R4 1 1
       43 GETIMPORT                        R5 K5 [require]
       45 GETTABLEKS                       R6 R0 K6 ["Src"]
       47 GETTABLEKS                       R6 R6 K7 ["Util"]
       49 GETTABLEKS                       R6 R6 K15 ["BridgingFiles"]
       51 GETTABLEKS                       R6 R6 K16 ["StandaloneFiles"]
       53 GETTABLEKS                       R6 R6 K17 ["syncPropertiesFromAssetDm"]
       55 CALL                             R5 1 1
       56 GETIMPORT                        R6 K5 [require]
       58 GETTABLEKS                       R7 R0 K6 ["Src"]
       60 GETTABLEKS                       R7 R7 K18 ["Flags"]
       62 GETTABLEKS                       R7 R7 K19 ["getFFlagFixPreviewToggleOn"]
       64 CALL                             R6 1 1
