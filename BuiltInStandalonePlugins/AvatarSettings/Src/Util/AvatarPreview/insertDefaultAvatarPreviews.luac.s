...
PROTO_3:
  ...
  FORGLOOP R3 2 [-3]
  GETUPVAL R4 2
  GETTABLEKS R3 R4 K4 ["avatarAccessoryRules"]
  CALL R3 0 1
  JUMPIFNOT R3 [+12]
  JUMPIFNOTEQKS R1 K5 ["Accessories"] [+11]
  GETTABLEKS R4 R3 K6 ["AccessoryMode"]
  GETIMPORT R5 K10 [Enum.AvatarSettingsAccessoryMode.PlayerChoice]
  JUMPIFEQ R4 R5 [+5]
  GETUPVAL R4 3
  LOADB R5 1
  MOVE R6 R1
  CALL R4 2 0
  GETUPVAL R5 2
  GETTABLEKS R4 R5 K11 ["avatarClothingRules"]
  CALL R4 0 1
  JUMPIFNOT R4 [+12]
  JUMPIFNOTEQKS R1 K12 ["Clothing"] [+11]
  GETTABLEKS R5 R4 K13 ["ClothingMode"]
  GETIMPORT R6 K15 [Enum.AvatarSettingsClothingMode.PlayerChoice]
  JUMPIFEQ R5 R6 [+5]
  GETUPVAL R5 3
  LOADB R6 1
  MOVE R7 R1
...
MAIN:
  ...
  GETTABLEKS R6 R7 K19 ["placeAvatars"]
  CALL R5 1 1
  GETIMPORT R6 K9 [require]
  GETTABLEKS R10 R0 K10 ["Src"]
  GETTABLEKS R9 R10 K11 ["Util"]
  GETTABLEKS R8 R9 K12 ["AvatarPreview"]
  GETTABLEKS R7 R8 K20 ["previewFolderUtils"]
  CALL R6 1 1
  GETIMPORT R7 K9 [require]
  GETTABLEKS R11 R0 K10 ["Src"]
  GETTABLEKS R10 R11 K11 ["Util"]
  GETTABLEKS R9 R10 K12 ["AvatarPreview"]
  GETTABLEKS R8 R9 K21 ["showBounds"]
  CALL R7 1 1
  GETIMPORT R8 K9 [require]
  GETTABLEKS R11 R0 K10 ["Src"]
  GETTABLEKS R10 R11 K11 ["Util"]
  GETTABLEKS R9 R10 K22 ["AvatarSettingsProviderTypes"]
  CALL R8 1 1
  NEWTABLE R9 2 0
  DUPCLOSURE R10 K23 [PROTO_0]
  CAPTURE VAL R6
  SETTABLEKS R10 R9 K24 ["addHumanoidsToPreviewFolder"]
  ...
  CAPTURE VAL R4
  CAPTURE VAL R7
  SETTABLEKS R12 R9 K28 ["insertToFolder"]
  RETURN R9 1
