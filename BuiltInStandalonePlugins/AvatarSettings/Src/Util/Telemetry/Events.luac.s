MAIN:
      ...
      205 LOADK                            R13 K34 ["AbilitySwimmingToggled"]
      206 LOADK                            R14 K35 ["Counter to track whether abilities swimming enabled is toggled. Additional fields: enabled = [true, false]"]
      207 SETLIST                          R12 R13 2 [1]
      209 NEWTABLE                         R13 0 2
      211 LOADK                            R14 K36 ["AccessorySoundToggled"]
      212 LOADK                            R15 K37 ["Counter to track whether accessories sound enabled is toggled. Additional fields: enabled = [true, false]"]
      213 SETLIST                          R13 R14 2 [1]
      215 NEWTABLE                         R14 0 2
      217 LOADK                            R15 K38 ["AccessoryVFXToggled"]
      218 LOADK                            R16 K39 ["Counter to track whether accessories vfx enabled is toggled. Additional fields: enabled = [true, false]"]
      219 SETLIST                          R14 R15 2 [1]
      221 NEWTABLE                         R15 0 2
      223 LOADK                            R16 K40 ["AvatarTypeMenuOpened"]
      224 LOADK                            R17 K41 ["Counter to track avatar type dropdown opens"]
      225 SETLIST                          R15 R16 2 [1]
      227 NEWTABLE                         R16 0 2
      229 LOADK                            R17 K42 ["PreviewToggled"]
      230 LOADK                            R18 K43 ["Counter to track preview button toggles"]
      231 SETLIST                          R16 R17 2 [1]
      233 NEWTABLE                         R17 0 2
      235 LOADK                            R18 K44 ["RevertChangesPressed"]
      236 LOADK                            R19 K45 ["Counter to track revert changes button presses"]
      237 SETLIST                          R17 R18 2 [1]
      239 NEWTABLE                         R18 0 2
      241 LOADK                            R19 K46 ["SaveChangesPressed"]
      242 LOADK                            R20 K47 ["Counter to track save changes button presses"]
      243 SETLIST                          R18 R19 2 [1]
      245 NEWTABLE                         R19 0 2
      247 LOADK                            R20 K48 ["SwitchedToTab"]
      248 LOADK                            R21 K49 ["Counter to track category tab switching. Additional fields: tabName = [General, Body, Clothing,  Accessories, Movement]"]
      249 SETLIST                          R19 R20 2 [1]
      251 NEWTABLE                         R20 0 2
      253 LOADK                            R21 K50 ["PublishedWithPreset"]
      254 LOADK                            R22 K51 ["Counter to track published with preset. Additional fields: presetType = [PlayerChoice, ConsistentGameplay, None]"]
      255 SETLIST                          R20 R21 2 [1]
      257 SETLIST                          R5 R6 15 [1]
      259 NEWTABLE                         R6 0 14
      261 NEWTABLE                         R7 0 3
      263 LOADK                            R8 K52 ["AbilityCharacterControllerMode"]
      264 LOADK                            R9 K53 ["abilityCharacterControllerMode"]
      265 LOADK                            R10 K54 ["LegacyHumanoid, LuaCharacterController"]
      266 SETLIST                          R7 R8 3 [1]
      268 NEWTABLE                         R8 0 3
      270 LOADK                            R9 K55 ["AccessoriesLimitMethod"]
      271 LOADK                            R10 K56 ["limitMethod"]
      272 LOADK                            R11 K57 ["Scale, Remove"]
      273 SETLIST                          R8 R9 3 [1]
      275 NEWTABLE                         R9 0 3
      277 LOADK                            R10 K58 ["AccessoryCustomLimitMode"]
      278 LOADK                            R11 K59 ["accessoryCustomLimitMode"]
      279 LOADK                            R12 K60 ["PlayerChoice, CustomLimit"]
      280 SETLIST                          R9 R10 3 [1]
      282 NEWTABLE                         R10 0 3
      284 LOADK                            R11 K61 ["AnimationClipsMode"]
      285 LOADK                            R12 K62 ["animationClipsMode"]
      286 LOADK                            R13 K63 ["PlayerChoice, CustomClips"]
      287 SETLIST                          R10 R11 3 [1]
      289 NEWTABLE                         R11 0 3
      291 LOADK                            R12 K64 ["AnimationPacksMode"]
      292 LOADK                            R13 K65 ["animationPacksMode"]
      293 LOADK                            R14 K66 ["PlayerChoice, StandardR15, StandardR6"]
      294 SETLIST                          R11 R12 3 [1]
      296 NEWTABLE                         R12 0 3
      298 LOADK                            R13 K67 ["AppearanceMode"]
      299 LOADK                            R14 K68 ["appearanceMode"]
      300 LOADK                            R15 K69 ["PlayerChoice, CustomParts"]
      301 SETLIST                          R12 R13 3 [1]
      303 NEWTABLE                         R13 0 3
      305 LOADK                            R14 K70 ["AvatarType"]
      306 LOADK                            R15 K71 ["avatarType"]
      307 LOADK                            R16 K72 ["R15, R6, PlayerChoice"]
      308 SETLIST                          R13 R14 3 [1]
      310 NEWTABLE                         R14 0 3
      312 LOADK                            R15 K73 ["BuildMode"]
      313 LOADK                            R16 K74 ["buildMode"]
      314 LOADK                            R17 K75 ["PlayerChoice, CustomBuild"]
      315 SETLIST                          R14 R15 3 [1]
      317 NEWTABLE                         R15 0 3
      319 LOADK                            R16 K76 ["ClothingCustomLimitMode"]
      320 LOADK                            R17 K77 ["clothingCustomLimitMode"]
      321 LOADK                            R18 K60 ["PlayerChoice, CustomLimit"]
      322 SETLIST                          R15 R16 3 [1]
      324 NEWTABLE                         R16 0 3
      326 LOADK                            R17 K78 ["CollisionMode"]
      327 LOADK                            R18 K79 ["mode"]
      328 LOADK                            R19 K80 ["Default, SingleCollider, Legacy"]
      329 SETLIST                          R16 R17 3 [1]
      331 NEWTABLE                         R17 0 3
      333 LOADK                            R18 K81 ["CustomAccessoryMode"]
      334 LOADK                            R19 K82 ["customAccessoryMode"]
      335 LOADK                            R20 K83 ["PlayerChoice, CustomAccessories"]
      336 SETLIST                          R17 R18 3 [1]
      338 NEWTABLE                         R18 0 3
      340 LOADK                            R19 K84 ["CustomClothingMode"]
      341 LOADK                            R20 K77 ["clothingCustomLimitMode"]
      342 LOADK                            R21 K85 ["PlayerChoice, CustomClothing"]
      343 SETLIST                          R18 R19 3 [1]
      345 NEWTABLE                         R19 0 3
      347 LOADK                            R20 K86 ["Preset"]
      348 LOADK                            R21 K87 ["presetType"]
      349 LOADK                            R22 K88 ["PlayerChoice, ConsistentGameplay"]
      350 SETLIST                          R19 R20 3 [1]
      352 NEWTABLE                         R20 0 3
      354 LOADK                            R21 K89 ["ScaleMode"]
      355 LOADK                            R22 K90 ["scaleMode"]
