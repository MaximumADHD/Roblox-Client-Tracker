MAIN:
  ...
  GETTABLEKS R6 R7 K14 ["showSaveOrPublishPlaceToRoblox"]
  CALL R5 1 1
  ...
  GETTABLEKS R7 R8 K15 ["connectRefreshPluginState"]
  CALL R6 1 1
  DUPTABLE R7 K16 [{"onPublishSettings", "onDiscardSettings", "setupHolds", "showSaveOrPublishPlaceToRoblox", "connectRefreshPluginState"}]
  SETTABLEKS R2 R7 K11 ["onPublishSettings"]
  SETTABLEKS R3 R7 K12 ["onDiscardSettings"]
  SETTABLEKS R4 R7 K13 ["setupHolds"]
  SETTABLEKS R5 R7 K14 ["showSaveOrPublishPlaceToRoblox"]
  SETTABLEKS R6 R7 K15 ["connectRefreshPluginState"]
  RETURN R7 1
