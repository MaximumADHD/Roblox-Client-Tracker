...
PROTO_15:
  ...
  NAMECALL R3 R2 K5 ["OnInvoke"]
  CALL R3 3 0
  LOADK R5 K7 ["PreviewSetMainButtonEnabled"]
  NEWCLOSURE R6 P2
  CAPTURE VAL R0
  NAMECALL R3 R2 K5 ["OnInvoke"]
  CALL R3 3 0
  ...
  NEWCLOSURE R3 P7
  CAPTURE VAL R0
  SETTABLEKS R3 R0 K12 ["onDockWidgetCreated"]
  GETUPVAL R5 4
  ...
  GETTABLEKS R3 R4 K14 ["new"]
  CALL R3 0 1
  SETTABLEKS R3 R0 K21 ["telemetry"]
  JUMP [+11]
  GETUPVAL R5 4
  GETTABLEKS R4 R5 K22 ["Analytics"]
  GETTABLEKS R3 R4 K14 ["new"]
  DUPCLOSURE R4 K23 [PROTO_14]
  NEWTABLE R5 0 0
  CALL R3 2 1
