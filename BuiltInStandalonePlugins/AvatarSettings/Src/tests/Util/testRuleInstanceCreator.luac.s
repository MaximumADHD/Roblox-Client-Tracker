...
PROTO_1:
  ...
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K19 ["VALID_MOOD_ASSETID"]
  GETTABLEKS R1 R2 K15 ["assetId"]
  SETTABLEKS R1 R0 K20 ["CustomMoodId"]
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K21 ["VALID_EYEBROW_ASSETID"]
  GETTABLEKS R1 R2 K15 ["assetId"]
  SETTABLEKS R1 R0 K22 ["CustomEyebrowId"]
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K23 ["VALID_EYELASH_ASSETID"]
  GETTABLEKS R1 R2 K15 ["assetId"]
  SETTABLEKS R1 R0 K24 ["CustomEyelashId"]
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K25 ["VALID_TORSO_ASSETID"]
  GETTABLEKS R1 R2 K15 ["assetId"]
  SETTABLEKS R1 R0 K26 ["CustomTorsoId"]
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K27 ["VALID_LEFTARM_ASSETID"]
  GETTABLEKS R1 R2 K15 ["assetId"]
  SETTABLEKS R1 R0 K28 ["CustomLeftArmId"]
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K29 ["VALID_RIGHTARM_ASSETID"]
  GETTABLEKS R1 R2 K15 ["assetId"]
  SETTABLEKS R1 R0 K30 ["CustomRightArmId"]
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K31 ["VALID_LEFTLEG_ASSETID"]
  GETTABLEKS R1 R2 K15 ["assetId"]
  SETTABLEKS R1 R0 K32 ["CustomLeftLegId"]
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K33 ["VALID_RIGHTLEG_ASSETID"]
  GETTABLEKS R1 R2 K15 ["assetId"]
  SETTABLEKS R1 R0 K34 ["CustomRightLegId"]
  GETIMPORT R1 K37 [Enum.AvatarSettingsCustomBodyType.BundleId]
  SETTABLEKS R1 R0 K38 ["CustomBodyType"]
  LOADN R1 7
  SETTABLEKS R1 R0 K39 ["CustomBodyBundleId"]
  LOADB R1 0
  SETTABLEKS R1 R0 K40 ["KeepPlayerHead"]
  GETIMPORT R1 K43 [Enum.AvatarSettingsBuildMode.CustomBuild]
  SETTABLEKS R1 R0 K44 ["BuildMode"]
  GETIMPORT R1 K8 [NumberRange.new]
  LOADK R2 K45 [0.1]
  LOADK R3 K46 [0.2]
  CALL R1 2 1
  SETTABLEKS R1 R0 K47 ["CustomHeightScale"]
  GETIMPORT R1 K8 [NumberRange.new]
  LOADK R2 K45 [0.1]
  LOADK R3 K46 [0.2]
  CALL R1 2 1
  SETTABLEKS R1 R0 K48 ["CustomWidthScale"]
  GETIMPORT R1 K8 [NumberRange.new]
  LOADK R2 K45 [0.1]
  LOADK R3 K46 [0.2]
  CALL R1 2 1
  SETTABLEKS R1 R0 K49 ["CustomHeadScale"]
  GETIMPORT R1 K8 [NumberRange.new]
  LOADK R2 K45 [0.1]
  LOADK R3 K46 [0.2]
  CALL R1 2 1
  SETTABLEKS R1 R0 K50 ["CustomBodyTypeScale"]
  GETIMPORT R1 K8 [NumberRange.new]
  LOADK R2 K45 [0.1]
  LOADK R3 K46 [0.2]
  CALL R1 2 1
  SETTABLEKS R1 R0 K51 ["CustomProportionsScale"]
  RETURN R0 1
