PROTO_0:
        ...
        3 CALL                             R2 1 1
        4 GETUPVAL                         R3 0
        5 GETTABLEKS                       R3 R3 K4 ["AssetIds"]
        7 GETTABLEKS                       R3 R3 K5 ["INVALID_ANIMATION_ASSETID"]
        9 GETTABLEKS                       R3 R3 K6 ["assetId"]
       11 JUMPIFNOTEQ                      R0 R3 ; [+2]
       13 RETURN                           R2 1
       14 GETIMPORT                        R3 K10 [Enum.AssetType.IdleAnimation]
       16 GETTABLEKS                       R3 R3 K11 ["Value"]
       18 JUMPIFEQ                         R1 R3 ; [+37]
       20 GETIMPORT                        R3 K13 [Enum.AssetType.SwimAnimation]
       22 GETTABLEKS                       R3 R3 K11 ["Value"]
       24 JUMPIFEQ                         R1 R3 ; [+31]
       26 GETIMPORT                        R3 K2 [Instance.new]
       28 LOADK                            R4 K14 ["Animation"]
       29 CALL                             R3 1 1
       30 SETTABLEKS                       R2 R3 K15 ["Parent"]
       32 GETIMPORT                        R5 K16 [Enum.AssetType.Animation]
       34 GETTABLEKS                       R5 R5 K11 ["Value"]
       ...
       43 JUMP                             ; [+9]
       44 GETUPVAL                         R5 1
       45 GETTABLEKS                       R5 R5 K19 ["ANIMATIONID_PREFIX"]
       ...
       55 RETURN                           R2 1
       56 GETIMPORT                        R3 K10 [Enum.AssetType.IdleAnimation]
       58 GETTABLEKS                       R3 R3 K11 ["Value"]
       ...
       77 GETUPVAL                         R8 1
       78 GETTABLEKS                       R8 R8 K19 ["ANIMATIONID_PREFIX"]
       ...
       89 FORNLOOP                         R3
       90 RETURN                           R2 1
       91 GETIMPORT                        R3 K13 [Enum.AssetType.SwimAnimation]
       93 GETTABLEKS                       R3 R3 K11 ["Value"]
      ...
      106 GETUPVAL                         R5 1
      107 GETTABLEKS                       R5 R5 K19 ["ANIMATIONID_PREFIX"]
      ...
      126 GETUPVAL                         R6 1
      127 GETTABLEKS                       R6 R6 K19 ["ANIMATIONID_PREFIX"]
...
MAIN:
       ...
       24 GETTABLEKS                       R3 R3 K10 ["TestConstants"]
       26 CALL                             R2 1 1
