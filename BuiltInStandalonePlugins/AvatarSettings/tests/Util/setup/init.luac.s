...
PROTO_52:
  GETUPVAL R1 0
  GETTABLEKS R0 R1 K0 ["minMaxToggle"]
  JUMPIFNOT R0 [+77]
  GETUPVAL R1 0
  GETTABLEKS R0 R1 K0 ["minMaxToggle"]
  LOADK R5 K1 ["GuiObject"]
  ...
  GETTABLEKS R4 R0 K9 ["AbsolutePosition"]
  GETTABLEKS R3 R4 K10 ["X"]
  GETTABLEKS R6 R0 K12 ["AbsoluteSize"]
  GETTABLEKS R5 R6 K10 ["X"]
  DIVK R4 R5 K11 [2]
  ADD R2 R3 R4
  GETTABLEKS R5 R0 K9 ["AbsolutePosition"]
  GETTABLEKS R4 R5 K13 ["Y"]
  GETTABLEKS R7 R0 K12 ["AbsoluteSize"]
  ...
  CALL R0 1 0
  GETUPVAL R0 5
  LOADK R2 K16 ["SetMinMaxToggle"]
  LOADB R3 1
  NAMECALL R0 R0 K17 ["FindFirstChild"]
  CALL R0 3 1
  SETUPVAL R0 4
  GETUPVAL R0 0
  GETUPVAL R2 4
  ...
  JUMP [+1]
  LOADNIL R1
  SETTABLEKS R1 R0 K0 ["minMaxToggle"]
  RETURN R0 0
...
PROTO_53:
  ...
  CAPTURE REF R5
  CAPTURE REF R1
  SETTABLEKS R7 R6 K21 ["toggleMinMax"]
  CLOSEUPVALS R1
  RETURN R6 1
...
PROTO_59:
  ...
  CAPTURE UPVAL U3
  CAPTURE UPVAL U7
  DUPCLOSURE R31 K33 [PROTO_53]
  CAPTURE UPVAL U9
  CAPTURE UPVAL U3
  CAPTURE UPVAL U7
  CAPTURE UPVAL U4
  DUPCLOSURE R32 K34 [PROTO_56]
  CAPTURE UPVAL U9
  CAPTURE UPVAL U10
  CAPTURE UPVAL U3
  CAPTURE UPVAL U7
  DUPCLOSURE R33 K35 [PROTO_57]
  CAPTURE UPVAL U9
  DUPCLOSURE R34 K36 [PROTO_58]
  CAPTURE VAL R30
  CAPTURE UPVAL U8
  CAPTURE UPVAL U10
