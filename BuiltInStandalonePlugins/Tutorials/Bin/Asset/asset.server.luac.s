...
MAIN:
  ...
  LOADK R12 K27 ["StudioSpotlight"]
  NAMECALL R10 R10 K18 ["GetFastFlag"]
  CALL R10 2 1
  GETIMPORT R11 K7 [require]
  GETTABLEKS R14 R0 K13 ["Src"]
  GETTABLEKS R13 R14 K28 ["Components"]
  GETTABLEKS R12 R13 K29 ["AssetRoot"]
  CALL R11 1 1
  NEWCLOSURE R12 P0
  CAPTURE VAL R0
  CAPTURE VAL R3
  ...
  GETTABLEKS R13 R14 K30 ["Unloading"]
  NEWCLOSURE R15 P1
  CAPTURE REF R6
  CAPTURE VAL R10
  NAMECALL R13 R13 K31 ["Connect"]
  CALL R13 2 0
  CLOSEUPVALS R6
  RETURN R0 0
