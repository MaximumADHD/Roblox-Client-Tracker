...
MAIN:
  ...
  GETIMPORT R16 K230 [table.insert]
  CALL R16 2 0
  DUPTABLE R16 K239 [{"id", "allowedPlaceIds", "onStart", "onComplete", "steps"}]
  LOADK R17 K240 ["StudioTour3"]
  SETTABLEKS R17 R16 K43 ["id"]
  NEWTABLE R17 0 2
  LOADK R18 K241 [81362103443151]
  LOADK R19 K242 [88926143951080]
  SETLIST R17 R18 2 [1]
  SETTABLEKS R17 R16 K235 ["allowedPlaceIds"]
  DUPCLOSURE R17 K243 [PROTO_17]
  CAPTURE VAL R5
  SETTABLEKS R17 R16 K236 ["onStart"]
  DUPCLOSURE R17 K244 [PROTO_18]
  CAPTURE VAL R5
