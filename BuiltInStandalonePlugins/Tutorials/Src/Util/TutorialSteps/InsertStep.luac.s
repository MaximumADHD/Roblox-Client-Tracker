PROTO_0:
        0 GETUPVAL                         R3 0
        1 GETTABLEKS                       R3 R3 K0 ["data"]
        3 GETTABLEKS                       R3 R3 K1 ["className"]
        5 NAMECALL                         R1 R0 K2 ["IsA"]
        7 CALL                             R1 2 1
        8 JUMPIFNOT                        R1 ; [+41]
        9 GETUPVAL                         R1 0
       10 GETTABLEKS                       R1 R1 K0 ["data"]
       12 GETTABLEKS                       R1 R1 K3 ["properties"]
       14 JUMPIFNOT                        R1 ; [+14]
       15 GETUPVAL                         R1 0
       16 GETTABLEKS                       R1 R1 K0 ["data"]
       18 GETTABLEKS                       R1 R1 K3 ["properties"]
       20 LOADNIL                          R2
       21 LOADNIL                          R3
       22 FORGPREP                         R1
       ...
       27 FORGLOOP                         R1 2 ; [-5]
       29 GETUPVAL                         R1 0
       30 GETTABLEKS                       R1 R1 K0 ["data"]
       32 GETTABLEKS                       R1 R1 K4 ["instanceId"]
       34 JUMPIFNOT                        R1 ; [+11]
       35 GETUPVAL                         R1 0
       36 GETTABLEKS                       R1 R1 K5 ["tutorial"]
       38 GETTABLEKS                       R1 R1 K6 ["instances"]
       40 GETUPVAL                         R2 0
       41 GETTABLEKS                       R2 R2 K0 ["data"]
       43 GETTABLEKS                       R2 R2 K4 ["instanceId"]
