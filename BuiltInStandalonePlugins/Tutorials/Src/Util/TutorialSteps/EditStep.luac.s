...
MAIN:
  ...
  LOADK R5 K10 ["TutorialsDraggerSteps"]
  ...
  GETTABLEKS R6 R7 K15 ["TutorialStep"]
  CALL R5 1 1
  GETTABLEKS R6 R5 K16 ["extend"]
  LOADK R7 K17 ["Edit"]
  CALL R6 1 1
  LOADB R7 1
  SETTABLEKS R7 R6 K18 ["showComplete"]
  DUPCLOSURE R7 K19 [PROTO_2]
  CAPTURE VAL R3
  CAPTURE VAL R4
  SETTABLEKS R7 R6 K20 ["bind"]
  DUPCLOSURE R7 K21 [PROTO_6]
  CAPTURE VAL R2
  CAPTURE VAL R3
  SETTABLEKS R7 R6 K22 ["update"]
  DUPCLOSURE R7 K23 [PROTO_7]
  SETTABLEKS R7 R6 K24 ["unbind"]
  RETURN R6 1
