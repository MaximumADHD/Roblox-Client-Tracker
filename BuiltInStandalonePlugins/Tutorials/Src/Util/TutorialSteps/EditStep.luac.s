...
PROTO_2:
        ...
        2 LOADB                            R2 0
        3 GETUPVAL                         R7 0
        4 GETTABLEKS                       R6 R7 K0 ["data"]
        6 GETTABLEKS                       R3 R6 K1 ["changes"]
        8 LOADNIL                          R4
        9 LOADNIL                          R5
       10 FORGPREP                         R3
       ...
       34 FORGLOOP                         R3 2 ; [-24]
       36 GETUPVAL                         R5 0
       37 GETTABLEKS                       R4 R5 K4 ["watches"]
       ...
       47 CALL                             R3 2 0
       48 GETUPVAL                         R5 0
       49 GETTABLEKS                       R4 R5 K8 ["connections"]
       ...
       61 JUMPIFNOT                        R2 ; [+13]
       62 GETUPVAL                         R5 0
       63 GETTABLEKS                       R4 R5 K8 ["connections"]
...
PROTO_3:
       ...
       18 MOVE                             R5 R2
       19 GETTABLEKS                       R7 R0 K6 ["data"]
       21 GETTABLEKS                       R6 R7 K7 ["className"]
       23 NEWCLOSURE                       R7 P0
       24 CAPTURE                          VAL R0
       25 CAPTURE                          UPVAL U0
...
PROTO_4:
        ...
        2 GETUPVAL                         R4 0
        3 GETTABLEKS                       R3 R4 K0 ["instance"]
        5 MOVE                             R5 R1
        6 NAMECALL                         R3 R3 K1 ["GetAttribute"]
        8 CALL                             R3 2 1
        9 GETUPVAL                         R7 0
       10 GETTABLEKS                       R6 R7 K2 ["initialValues"]
       12 GETTABLEKS                       R5 R6 K3 ["Attributes"]
       ...
       19 RETURN                           R2 1
       20 GETUPVAL                         R4 0
       21 GETTABLEKS                       R3 R4 K0 ["instance"]
       23 MOVE                             R5 R1
...
PROTO_5:
       ...
       11 GETUPVAL                         R5 1
       12 GETTABLEKS                       R4 R5 K1 ["instance"]
       14 GETTABLE                         R3 R4 R1
       15 GETUPVAL                         R6 1
       16 GETTABLEKS                       R5 R6 K2 ["initialValues"]
       ...
       23 RETURN                           R2 1
       24 GETUPVAL                         R5 1
       25 GETTABLEKS                       R4 R5 K1 ["instance"]
...
PROTO_6:
        0 GETUPVAL                         R1 0
        1 GETUPVAL                         R4 1
        2 GETTABLEKS                       R3 R4 K0 ["data"]
        4 GETTABLEKS                       R2 R3 K1 ["changes"]
        6 NEWCLOSURE                       R3 P0
        7 CAPTURE                          UPVAL U0
        8 CAPTURE                          VAL R0
        9 CALL                             R1 2 1
...
MAIN:
       ...
       28 GETTABLEKS                       R5 R6 K11 ["TutorialStep"]
       30 CALL                             R4 1 1
