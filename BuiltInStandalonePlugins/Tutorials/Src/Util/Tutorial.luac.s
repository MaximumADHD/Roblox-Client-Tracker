...
MAIN:
  ...
  GETIMPORT R16 K28 [table.find]
  NEWTABLE R17 32 0
  DUPTABLE R18 K30 [{"__index"}]
  SETTABLEKS R17 R18 K29 ["__index"]
  ...
  CAPTURE VAL R6
  CAPTURE VAL R18
  SETTABLEKS R20 R17 K33 ["new"]
  DUPCLOSURE R20 K34 [PROTO_4]
  CAPTURE VAL R13
  SETTABLEKS R20 R17 K35 ["start"]
  DUPCLOSURE R20 K36 [PROTO_5]
  SETTABLEKS R20 R17 K37 ["setWidget"]
  DUPCLOSURE R20 K38 [PROTO_6]
  SETTABLEKS R20 R17 K39 ["resetAttachment"]
  DUPCLOSURE R20 K40 [PROTO_7]
  CAPTURE VAL R12
  SETTABLEKS R20 R17 K41 ["attachTo"]
  ...
  CAPTURE VAL R12
  CAPTURE VAL R2
  SETTABLEKS R20 R17 K43 ["setStep"]
  DUPCLOSURE R20 K44 [PROTO_13]
  CAPTURE VAL R9
  SETTABLEKS R20 R17 K45 ["showCallout"]
  DUPCLOSURE R20 K46 [PROTO_14]
  SETTABLEKS R20 R17 K47 ["getCurrentStep"]
  DUPCLOSURE R20 K48 [PROTO_15]
  CAPTURE VAL R13
  CAPTURE VAL R16
  SETTABLEKS R20 R17 K49 ["getCurrentStepData"]
  DUPCLOSURE R20 K50 [PROTO_20]
  CAPTURE VAL R13
  SETTABLEKS R20 R17 K51 ["increment"]
  DUPCLOSURE R20 K52 [PROTO_21]
  SETTABLEKS R20 R17 K53 ["back"]
  DUPCLOSURE R20 K54 [PROTO_22]
  CAPTURE VAL R13
  SETTABLEKS R20 R17 K55 ["finishIncrement"]
  JUMPIFNOT R13 [+14]
  DUPCLOSURE R20 K56 [PROTO_23]
  SETTABLEKS R20 R17 K57 ["selectTopic"]
  DUPCLOSURE R20 K58 [PROTO_25]
  CAPTURE VAL R3
  SETTABLEKS R20 R17 K59 ["getTopicStep"]
  DUPCLOSURE R20 K60 [PROTO_26]
  CAPTURE VAL R12
  SETTABLEKS R20 R17 K61 ["showSpotlight"]
  DUPCLOSURE R20 K62 [PROTO_27]
  SETTABLEKS R20 R17 K63 ["setToolboxLimits"]
  DUPCLOSURE R20 K64 [PROTO_29]
  SETTABLEKS R20 R17 K65 ["syncChildren"]
  RETURN R17 1
