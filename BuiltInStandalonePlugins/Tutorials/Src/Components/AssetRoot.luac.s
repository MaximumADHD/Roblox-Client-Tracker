...
PROTO_5:
  ...
  JUMPIFNOT R0 [+33]
  GETUPVAL R0 1
  JUMPIFNOTEQKS R0 K0 ["RibbonWalkthrough"] [+26]
  GETUPVAL R0 2
  NAMECALL R0 R0 K1 ["HideSpotlight"]
  CALL R0 1 0
  GETUPVAL R2 3
  GETTABLEKS R1 R2 K2 ["props"]
  GETTABLEKS R0 R1 K3 ["Plugin"]
  LOADK R3 K4 ["Spotlight"]
  NAMECALL R1 R0 K5 ["GetPluginComponent"]
  CALL R1 2 1
  NAMECALL R2 R1 K6 ["HideSpotlightAsync"]
  CALL R2 1 0
  GETUPVAL R2 3
  DUPTABLE R4 K8 [{"isTutorialHidden"}]
  LOADB R5 1
  SETTABLEKS R5 R4 K7 ["isTutorialHidden"]
  NAMECALL R2 R2 K9 ["setState"]
  CALL R2 2 0
  RETURN R0 0
  GETUPVAL R0 4
  NAMECALL R0 R0 K10 ["PromptClosePlace"]
  CALL R0 1 0
  RETURN R0 0
  GETUPVAL R0 4
  NAMECALL R0 R0 K10 ["PromptClosePlace"]
...
PROTO_7:
  DUPTABLE R2 K7 [{"tutorialData", "tutorialDialogEnabled", "completed", "completedDialogEnabled", "pressedKeys", "widget", "isTutorialHidden"}]
  LOADNIL R3
  ...
  LOADB R3 0
  SETTABLEKS R3 R2 K6 ["isTutorialHidden"]
  ...
  GETTABLEKS R2 R3 K10 ["new"]
  CALL R2 0 1
  SETTABLEKS R2 R0 K13 ["telemetry"]
  GETUPVAL R4 3
  GETTABLEKS R3 R4 K14 ["Localization"]
  GETTABLEKS R2 R3 K10 ["new"]
  DUPTABLE R3 K19 [{"stringResourceTable", "translationResourceTable", "pluginName", "libraries"}]
  GETUPVAL R4 4
  SETTABLEKS R4 R3 K15 ["stringResourceTable"]
  GETUPVAL R4 5
  SETTABLEKS R4 R3 K16 ["translationResourceTable"]
  LOADK R4 K20 ["Tutorials"]
  ...
  SETTABLEKS R7 R6 K15 ["stringResourceTable"]
  GETUPVAL R9 6
  GETTABLEKS R8 R9 K21 ["Resources"]
  GETTABLEKS R7 R8 K25 ["LocalizedStrings"]
  SETTABLEKS R7 R6 K16 ["translationResourceTable"]
  SETTABLE R6 R4 R5
  SETTABLEKS R4 R3 K18 ["libraries"]
  CALL R2 1 1
  SETTABLEKS R2 R0 K26 ["localization"]
  GETUPVAL R4 3
  GETTABLEKS R3 R4 K27 ["Analytics"]
  GETTABLEKS R2 R3 K10 ["new"]
  DUPCLOSURE R3 K28 [PROTO_1]
  NEWTABLE R4 0 0
  CALL R2 2 1
  ...
  CAPTURE VAL R0
  CAPTURE UPVAL U9
  SETTABLEKS R2 R0 K30 ["log"]
  GETUPVAL R3 10
  GETTABLEKS R2 R3 K10 ["new"]
  LOADK R3 K31 ["Toolbox"]
  CALL R2 1 1
  SETTABLEKS R2 R0 K32 ["toolboxConnection"]
  LOADNIL R2
  GETUPVAL R3 11
  JUMPIFNOT R3 [+9]
  GETUPVAL R3 12
  NAMECALL R3 R3 K33 ["ShouldLaunchTutorial"]
  CALL R3 1 1
  JUMPIFNOT R3 [+2]
  LOADK R2 K34 ["StudioTour3"]
  JUMP [+3]
  LOADK R2 K35 ["RibbonWalkthrough"]
  JUMP [+1]
  LOADK R2 K34 ["StudioTour3"]
  GETUPVAL R5 13
  GETTABLEKS R4 R5 K36 ["Src"]
  GETTABLEKS R3 R4 K20 ["Tutorials"]
  MOVE R5 R2
  NAMECALL R3 R3 K37 ["FindFirstChild"]
  CALL R3 2 1
  JUMPIFNOT R3 [+29]
  LOADK R6 K38 ["ModuleScript"]
  NAMECALL R4 R3 K39 ["IsA"]
  CALL R4 2 1
  JUMPIFNOT R4 [+24]
  GETIMPORT R4 K41 [require]
  MOVE R5 R3
  CALL R4 1 1
  GETUPVAL R6 14
  GETTABLEKS R5 R6 K10 ["new"]
  GETIMPORT R6 K43 [game]
  MOVE R7 R4
  GETTABLEKS R8 R0 K26 ["localization"]
  GETTABLEKS R9 R0 K32 ["toolboxConnection"]
  GETTABLEKS R10 R1 K44 ["Plugin"]
  CALL R5 5 1
  SETTABLEKS R5 R0 K45 ["tutorial"]
  GETTABLEKS R7 R0 K45 ["tutorial"]
  NAMECALL R5 R0 K46 ["loadTutorial"]
  CALL R5 2 0
  NEWCLOSURE R4 P2
  CAPTURE VAL R0
  SETTABLEKS R4 R0 K47 ["onBack"]
  NEWCLOSURE R4 P3
  CAPTURE VAL R0
  SETTABLEKS R4 R0 K48 ["onNext"]
  NEWCLOSURE R4 P4
  CAPTURE UPVAL U11
  CAPTURE REF R2
  CAPTURE UPVAL U15
  CAPTURE VAL R0
  CAPTURE UPVAL U8
  SETTABLEKS R4 R0 K49 ["onQuit"]
  NEWCLOSURE R4 P5
  CAPTURE VAL R0
  SETTABLEKS R4 R0 K50 ["onSelectTopic"]
  CLOSEUPVALS R2
  RETURN R0 0
...
PROTO_9:
  ...
  GETTABLEKS R1 R2 K2 ["widget"]
  JUMPIF R1 [+15]
  NAMECALL R1 R0 K3 ["createWidget"]
  CALL R1 1 1
  DUPTABLE R4 K4 [{"widget"}]
  SETTABLEKS R1 R4 K2 ["widget"]
...
PROTO_12:
  GETUPVAL R1 0
  DUPTABLE R3 K2 [{"completed", "completedDialogEnabled"}]
  LOADB R4 1
  SETTABLEKS R4 R3 K0 ["completed"]
  GETUPVAL R5 1
  JUMPIFNOT R5 [+2]
  MOVE R4 R0
  JUMP [+1]
  LOADNIL R4
  SETTABLEKS R4 R3 K1 ["completedDialogEnabled"]
...
PROTO_25:
  ...
  GETTABLEKS R4 R2 K4 ["completed"]
  GETTABLEKS R5 R2 K5 ["completedDialogEnabled"]
  GETTABLEKS R6 R0 K6 ["localization"]
  GETTABLEKS R10 R0 K0 ["tutorial"]
  ...
  GETUPVAL R13 5
  CALL R13 0 1
  GETTABLEKS R14 R0 K6 ["localization"]
  ...
  JUMPIFNOT R12 [+6]
  JUMPIF R4 [+5]
  GETTABLEKS R12 R2 K46 ["isTutorialHidden"]
  JUMPIF R12 [+2]
  MOVE R11 R7
  JUMP [+6]
  GETUPVAL R12 10
...
MAIN:
  ...
  LOADK R9 K15 ["StudioWidgetsService"]
  ...
  CALL R11 1 1
  GETTABLEKS R12 R11 K20 ["UI"]
  GETTABLEKS R13 R12 K21 ["Dialog"]
  GETTABLEKS R15 R11 K22 ["Util"]
  GETTABLEKS R14 R15 K23 ["CrossPluginCommunication"]
  GETTABLEKS R15 R11 K24 ["ContextServices"]
  GETTABLEKS R16 R15 K25 ["Mouse"]
  GETTABLEKS R17 R15 K26 ["Store"]
  GETIMPORT R18 K4 [require]
  GETTABLEKS R22 R0 K27 ["Src"]
  GETTABLEKS R21 R22 K22 ["Util"]
  GETTABLEKS R20 R21 K28 ["Telemetry"]
  GETTABLEKS R19 R20 K29 ["TelemetryProtocol"]
  CALL R18 1 1
  GETIMPORT R19 K4 [require]
  GETTABLEKS R23 R0 K27 ["Src"]
  GETTABLEKS R22 R23 K22 ["Util"]
  GETTABLEKS R21 R22 K28 ["Telemetry"]
  GETTABLEKS R20 R21 K30 ["SkipStep"]
  CALL R19 1 1
  GETIMPORT R20 K4 [require]
  GETTABLEKS R24 R0 K27 ["Src"]
  GETTABLEKS R23 R24 K22 ["Util"]
  GETTABLEKS R22 R23 K28 ["Telemetry"]
  GETTABLEKS R21 R22 K31 ["StartStep"]
  CALL R20 1 1
  GETIMPORT R21 K4 [require]
  GETTABLEKS R25 R0 K27 ["Src"]
  GETTABLEKS R24 R25 K22 ["Util"]
  GETTABLEKS R23 R24 K28 ["Telemetry"]
  GETTABLEKS R22 R23 K32 ["CompleteStep"]
  CALL R21 1 1
  GETIMPORT R22 K4 [require]
  GETTABLEKS R26 R0 K27 ["Src"]
  GETTABLEKS R25 R26 K22 ["Util"]
  GETTABLEKS R24 R25 K28 ["Telemetry"]
  GETTABLEKS R23 R24 K33 ["IntermediateStep"]
  CALL R22 1 1
  GETIMPORT R23 K4 [require]
  GETTABLEKS R27 R0 K27 ["Src"]
  GETTABLEKS R26 R27 K22 ["Util"]
  GETTABLEKS R25 R26 K28 ["Telemetry"]
  GETTABLEKS R24 R25 K34 ["ExtraAction"]
  CALL R23 1 1
  GETIMPORT R24 K4 [require]
  GETTABLEKS R28 R0 K27 ["Src"]
  GETTABLEKS R27 R28 K22 ["Util"]
  GETTABLEKS R26 R27 K28 ["Telemetry"]
  GETTABLEKS R25 R26 K35 ["TelemetryProtocolTypes"]
  CALL R24 1 1
  GETIMPORT R25 K38 [Vector2.new]
  LOADN R26 204
  LOADN R27 44
  CALL R25 2 1
  GETTABLEKS R29 R0 K27 ["Src"]
  GETTABLEKS R28 R29 K39 ["Resources"]
  GETTABLEKS R27 R28 K40 ["Localization"]
  GETTABLEKS R26 R27 K41 ["SourceStrings"]
  GETTABLEKS R30 R0 K27 ["Src"]
  GETTABLEKS R29 R30 K39 ["Resources"]
  GETTABLEKS R28 R29 K40 ["Localization"]
  GETTABLEKS R27 R28 K42 ["LocalizedStrings"]
  GETIMPORT R28 K4 [require]
  GETTABLEKS R31 R0 K27 ["Src"]
  GETTABLEKS R30 R31 K43 ["Reducers"]
  GETTABLEKS R29 R30 K44 ["MainReducer"]
  CALL R28 1 1
  GETIMPORT R29 K4 [require]
  GETTABLEKS R32 R0 K27 ["Src"]
  GETTABLEKS R31 R32 K39 ["Resources"]
  GETTABLEKS R30 R31 K45 ["MakeTheme"]
  CALL R29 1 1
  GETIMPORT R30 K4 [require]
  GETTABLEKS R33 R0 K27 ["Src"]
  GETTABLEKS R32 R33 K22 ["Util"]
  GETTABLEKS R31 R32 K46 ["Tutorial"]
  CALL R30 1 1
  GETTABLEKS R32 R0 K27 ["Src"]
  GETTABLEKS R31 R32 K47 ["Components"]
  GETIMPORT R32 K4 [require]
  GETTABLEKS R33 R31 K48 ["CompletedTutorialDialog"]
  CALL R32 1 1
  GETIMPORT R33 K4 [require]
  GETTABLEKS R34 R31 K49 ["TourWidget"]
  CALL R33 1 1
  GETIMPORT R34 K4 [require]
  GETTABLEKS R37 R0 K27 ["Src"]
  GETTABLEKS R36 R37 K50 ["Flags"]
  GETTABLEKS R35 R36 K51 ["getFFlagEnableRibbonTour"]
  CALL R34 1 1
  CALL R34 0 1
  GETTABLEKS R35 R1 K52 ["PureComponent"]
  LOADK R37 K53 ["AssetRoot"]
  NAMECALL R35 R35 K54 ["extend"]
  CALL R35 2 1
  DUPCLOSURE R36 K55 [PROTO_7]
  CAPTURE VAL R2
  CAPTURE VAL R28
  CAPTURE VAL R18
  CAPTURE VAL R15
  ...
  CAPTURE VAL R30
  CAPTURE VAL R7
  SETTABLEKS R36 R35 K56 ["init"]
  DUPCLOSURE R36 K57 [PROTO_9]
  SETTABLEKS R36 R35 K58 ["didMount"]
  DUPCLOSURE R36 K59 [PROTO_10]
  SETTABLEKS R36 R35 K60 ["createWidget"]
  DUPCLOSURE R36 K61 [PROTO_11]
  SETTABLEKS R36 R35 K62 ["willUnmount"]
  ...
  CAPTURE VAL R9
  CAPTURE VAL R23
  SETTABLEKS R36 R35 K64 ["loadTutorial"]
  DUPCLOSURE R36 K65 [PROTO_25]
  CAPTURE VAL R1
  CAPTURE VAL R33
  CAPTURE VAL R15
  CAPTURE VAL R17
