...
PROTO_7:
  ...
  GETUPVAL R4 11
  GETTABLEKS R3 R4 K32 ["Src"]
  GETTABLEKS R2 R3 K19 ["Tutorials"]
  LOADK R4 K33 ["StudioTour3"]
  NAMECALL R2 R2 K34 ["FindFirstChild"]
  CALL R2 2 1
  JUMPIFNOT R2 [+45]
  LOADK R5 K35 ["ModuleScript"]
  NAMECALL R3 R2 K36 ["IsA"]
  CALL R3 2 1
  JUMPIFNOT R3 [+40]
  GETIMPORT R3 K38 [require]
  MOVE R4 R2
  CALL R3 1 1
  GETUPVAL R4 12
  JUMPIFNOT R4 [+14]
  GETTABLEKS R4 R3 K39 ["allowedPlaceIds"]
  JUMPIFNOT R4 [+11]
  GETIMPORT R4 K42 [table.find]
  GETTABLEKS R5 R3 K39 ["allowedPlaceIds"]
  GETIMPORT R7 K44 [game]
  GETTABLEKS R6 R7 K45 ["PlaceId"]
  CALL R4 2 1
  JUMPIF R4 [+1]
  RETURN R0 0
  GETUPVAL R5 13
  GETTABLEKS R4 R5 K9 ["new"]
  GETIMPORT R5 K44 [game]
  MOVE R6 R3
  GETTABLEKS R7 R0 K25 ["localization"]
  GETTABLEKS R8 R0 K31 ["toolboxConnection"]
  GETTABLEKS R9 R1 K46 ["Plugin"]
  CALL R4 5 1
  SETTABLEKS R4 R0 K47 ["tutorial"]
  GETTABLEKS R6 R0 K47 ["tutorial"]
  NAMECALL R4 R0 K48 ["loadTutorial"]
  CALL R4 2 0
  NEWCLOSURE R3 P2
  CAPTURE VAL R0
  SETTABLEKS R3 R0 K49 ["onBack"]
  NEWCLOSURE R3 P3
  CAPTURE VAL R0
  SETTABLEKS R3 R0 K50 ["onNext"]
  DUPCLOSURE R3 K51 [PROTO_5]
  CAPTURE UPVAL U8
  SETTABLEKS R3 R0 K52 ["onQuit"]
  NEWCLOSURE R3 P5
  CAPTURE VAL R0
  SETTABLEKS R3 R0 K53 ["onSelectTopic"]
  RETURN R0 0
