...
PROTO_7:
  ...
  JUMPIFNOT R3 [+9]
  GETUPVAL R3 12
  NAMECALL R3 R3 K32 ["ShouldLaunchTutorial"]
  CALL R3 1 1
  JUMPIFNOT R3 [+2]
  LOADK R2 K33 ["StudioTour3"]
  JUMP [+3]
  LOADK R2 K34 ["RibbonWalkthrough"]
  JUMP [+1]
  LOADK R2 K33 ["StudioTour3"]
  GETUPVAL R5 13
  GETTABLEKS R4 R5 K35 ["Src"]
  GETTABLEKS R3 R4 K19 ["Tutorials"]
  MOVE R5 R2
  NAMECALL R3 R3 K36 ["FindFirstChild"]
  CALL R3 2 1
  JUMPIFNOT R3 [+45]
  LOADK R6 K37 ["ModuleScript"]
  NAMECALL R4 R3 K38 ["IsA"]
  CALL R4 2 1
  JUMPIFNOT R4 [+40]
  GETIMPORT R4 K40 [require]
  MOVE R5 R3
  CALL R4 1 1
  GETUPVAL R5 14
  JUMPIFNOT R5 [+14]
  GETTABLEKS R5 R4 K41 ["allowedPlaceIds"]
  JUMPIFNOT R5 [+11]
  GETIMPORT R5 K44 [table.find]
  GETTABLEKS R6 R4 K41 ["allowedPlaceIds"]
  GETIMPORT R8 K46 [game]
  GETTABLEKS R7 R8 K47 ["PlaceId"]
  CALL R5 2 1
  JUMPIF R5 [+1]
  RETURN R0 0
  GETUPVAL R6 15
  GETTABLEKS R5 R6 K9 ["new"]
  GETIMPORT R6 K46 [game]
  MOVE R7 R4
  GETTABLEKS R8 R0 K25 ["localization"]
  GETTABLEKS R9 R0 K31 ["toolboxConnection"]
  GETTABLEKS R10 R1 K48 ["Plugin"]
  CALL R5 5 1
  SETTABLEKS R5 R0 K49 ["tutorial"]
  GETTABLEKS R7 R0 K49 ["tutorial"]
  NAMECALL R5 R0 K50 ["loadTutorial"]
  CALL R5 2 0
  NEWCLOSURE R4 P2
  CAPTURE VAL R0
  SETTABLEKS R4 R0 K51 ["onBack"]
  NEWCLOSURE R4 P3
  CAPTURE VAL R0
  SETTABLEKS R4 R0 K52 ["onNext"]
  DUPCLOSURE R4 K53 [PROTO_5]
  CAPTURE UPVAL U8
