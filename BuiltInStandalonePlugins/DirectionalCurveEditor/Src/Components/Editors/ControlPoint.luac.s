...
PROTO_7:
  ...
  CALL R11 2 1
  LOADK R12 K7 [""]
  GETTABLEKS R13 R0 K8 ["IsDragging"]
  JUMPIFNOT R13 [+2]
  LOADK R12 K9 ["Pressed"]
  JUMP [+7]
  JUMPIFNOT R1 [+2]
  LOADK R12 K10 ["Hovered"]
  JUMP [+4]
  GETTABLEKS R13 R0 K11 ["IsSelected"]
  JUMPIFNOT R13 [+1]
  LOADK R12 K12 ["Selected"]
  JUMPIF R6 [+3]
  GETTABLEKS R13 R0 K8 ["IsDragging"]
  JUMPIFNOT R13 [+61]
  GETUPVAL R14 5
  ...
  GETTABLEKS R17 R5 K18 ["X"]
  GETTABLEKS R18 R5 K19 ["Y"]
  CALL R16 2 1
  SETTABLEKS R16 R15 K2 ["Position"]
  GETUPVAL R17 5
  GETTABLEKS R16 R17 K20 ["Tag"]
  GETUPVAL R17 6
  LOADK R18 K21 ["SequenceKeypoint"]
  MOVE R19 R12
  CALL R17 2 1
  ...
  DUPTABLE R16 K26 [{"HoverArea", "DragListener"}]
  GETUPVAL R18 5
  GETTABLEKS R17 R18 K13 ["createElement"]
  GETUPVAL R18 7
  DUPTABLE R19 K30 [{"Cursor", "MouseEnter", "MouseLeave"}]
  GETUPVAL R20 8
  SETTABLEKS R20 R19 K27 ["Cursor"]
  SETTABLEKS R7 R19 K28 ["MouseEnter"]
  SETTABLEKS R8 R19 K29 ["MouseLeave"]
  CALL R17 2 1
  SETTABLEKS R17 R16 K24 ["HoverArea"]
  GETTABLEKS R17 R0 K8 ["IsDragging"]
  JUMPIFNOT R17 [+10]
  GETUPVAL R18 5
  GETTABLEKS R17 R18 K13 ["createElement"]
  GETUPVAL R18 9
  DUPTABLE R19 K33 [{"OnDragMoved", "OnDragEnded"}]
  SETTABLEKS R9 R19 K31 ["OnDragMoved"]
  SETTABLEKS R10 R19 K32 ["OnDragEnded"]
  CALL R17 2 1
  SETTABLEKS R17 R16 K25 ["DragListener"]
  CALL R13 3 1
  RETURN R13 1
