...
PROTO_14:
  ...
  GETUPVAL R19 10
  GETTABLEKS R18 R19 K66 ["NO_CONNECTED_GAMEPAD_ID"]
  JUMPIFEQ R17 R18 [+31]
  GETUPVAL R17 6
  GETTABLEKS R16 R17 K8 ["createElement"]
  GETUPVAL R17 17
  ...
  GETUPVAL R20 6
  GETTABLEKS R19 R20 K44 ["Tag"]
  LOADK R20 K67 ["Component-DeviceBlueprint"]
  SETTABLE R20 R18 R19
  GETUPVAL R19 13
  NAMECALL R19 R19 K46 ["getNextOrder"]
  CALL R19 1 1
  ...
  GETUPVAL R21 5
  GETTABLEKS R20 R21 K68 ["state"]
  GETTABLEKS R19 R20 K69 ["activeInputs"]
  SETTABLEKS R19 R18 K69 ["activeInputs"]
  CALL R16 2 1
  JUMP [+1]
  LOADNIL R16
...
MAIN:
  ...
  CALL R30 2 1
  GETTABLEKS R31 R28 K47 ["values"]
  GETTABLEKS R32 R20 K48 ["GAMEPAD_TYPE_TO_ID"]
  CALL R31 1 1
