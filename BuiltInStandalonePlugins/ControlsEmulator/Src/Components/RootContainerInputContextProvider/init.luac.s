...
PROTO_1:
       ...
       13 GETUPVAL                         R5 1
       14 GETTABLEKS                       R5 R5 K3 ["Provider"]
       16 DUPTABLE                         R6 K5 [{"value"}]
       17 GETTABLEKS                       R8 R1 K6 ["current"]
       19 JUMPIFNOT                        R8 ; [+20]
       20 DUPTABLE                         R7 K10 [{"InputChanged", "InputEnded", "InputBegan"}]
       21 GETTABLEKS                       R8 R1 K6 ["current"]
       23 GETTABLEKS                       R8 R8 K7 ["InputChanged"]
       25 SETTABLEKS                       R8 R7 K7 ["InputChanged"]
       27 GETTABLEKS                       R8 R1 K6 ["current"]
       29 GETTABLEKS                       R8 R8 K8 ["InputEnded"]
       31 SETTABLEKS                       R8 R7 K8 ["InputEnded"]
       33 GETTABLEKS                       R8 R1 K6 ["current"]
       35 GETTABLEKS                       R8 R8 K9 ["InputBegan"]
       37 SETTABLEKS                       R8 R7 K9 ["InputBegan"]
       39 JUMP                             ; [+3]
       40 GETUPVAL                         R7 2
       41 GETTABLEKS                       R7 R7 K11 ["DEFAULT_ROOT_CONTAINER_INPUT_CONTEXT_STATE"]
