MAIN:
  ...
  DUPTABLE R22 K81 [{"BackgroundTransparency", "Size", "Position", "TextWrapped", "TextColor3", "TextXAlignment", "TextYAlignment", "TextSize"}]
  LOADN R23 1
  ...
  LOADK R23 K82 ["$TextPrimary"]
  SETTABLEKS R23 R22 K77 ["TextColor3"]
  GETIMPORT R23 K84 [Enum.TextXAlignment.Left]
  SETTABLEKS R23 R22 K78 ["TextXAlignment"]
  GETIMPORT R23 K85 [Enum.TextYAlignment.Center]
  SETTABLEKS R23 R22 K79 ["TextYAlignment"]
  LOADN R23 11
  SETTABLEKS R23 R22 K80 ["TextSize"]
  CALL R20 2 1
  MOVE R21 R2
  LOADK R22 K86 [">> #ButtonsContainer"]
  DUPTABLE R23 K88 [{"Size", "AutomaticSize", "BackgroundTransparency"}]
  ...
  GETIMPORT R24 K89 [Enum.AutomaticSize.Y]
  SETTABLEKS R24 R23 K87 ["AutomaticSize"]
  LOADN R24 1
  SETTABLEKS R24 R23 K75 ["BackgroundTransparency"]
  NEWTABLE R24 0 2
  MOVE R25 R2
  LOADK R26 K21 ["::UIListLayout"]
  DUPTABLE R27 K90 [{"FillDirection", "SortOrder", "Padding", "HorizontalAlignment"}]
  ...
  CALL R25 2 1
  MOVE R26 R2
  LOADK R27 K91 [">> .Button"]
  DUPTABLE R28 K92 [{"Size", "BackgroundColor3", "TextColor3"}]
  ...
  LOADK R29 K93 ["$PrimaryButtonColor"]
  SETTABLEKS R29 R28 K60 ["BackgroundColor3"]
  LOADK R29 K94 ["$PrimaryButtonTextColor"]
