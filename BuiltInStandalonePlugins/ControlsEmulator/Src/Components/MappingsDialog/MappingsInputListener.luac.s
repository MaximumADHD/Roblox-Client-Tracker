...
PROTO_2:
        ...
        3 JUMPIFNOT                        R0 ; [+20]
        4 GETUPVAL                         R1 0
        5 GETTABLEKS                       R0 R1 K1 ["InputChanged"]
        7 JUMPIFNOT                        R0 ; [+16]
        8 GETUPVAL                         R1 0
        9 GETTABLEKS                       R0 R1 K2 ["InputEnded"]
       11 JUMPIFNOT                        R0 ; [+12]
       12 GETUPVAL                         R0 1
       13 GETUPVAL                         R2 0
       14 GETTABLEKS                       R1 R2 K2 ["InputEnded"]
       16 NEWCLOSURE                       R3 P0
       17 CAPTURE                          UPVAL U2
       18 CAPTURE                          UPVAL U3
...
PROTO_3:
       ...
       20 GETUPVAL                         R7 3
       21 CALL                             R6 1 1
       22 GETTABLEKS                       R5 R6 K3 ["setMapping"]
       24 GETUPVAL                         R7 0
       25 GETTABLEKS                       R6 R7 K4 ["useEffect"]
       27 NEWCLOSURE                       R7 P0
       28 CAPTURE                          VAL R2
       29 CAPTURE                          VAL R1
       30 CAPTURE                          VAL R4
       ...
       39 CALL                             R6 2 0
       40 GETUPVAL                         R7 0
       41 GETTABLEKS                       R6 R7 K5 ["createElement"]
       43 LOADK                            R7 K6 ["Frame"]
       44 NEWTABLE                         R8 1 0
       46 GETUPVAL                         R10 0
       47 GETTABLEKS                       R9 R10 K7 ["Tag"]
       49 GETUPVAL                         R12 0
       50 GETTABLEKS                       R11 R12 K7 ["Tag"]
...
MAIN:
       ...
       29 GETTABLEKS                       R4 R5 K11 ["MappingsContext"]
       31 CALL                             R3 1 1
       32 GETIMPORT                        R4 K5 [require]
       34 GETTABLEKS                       R7 R0 K8 ["Src"]
       36 GETTABLEKS                       R6 R7 K9 ["Util"]
       38 GETTABLEKS                       R5 R6 K12 ["MappingsActionsContext"]
       40 CALL                             R4 1 1
