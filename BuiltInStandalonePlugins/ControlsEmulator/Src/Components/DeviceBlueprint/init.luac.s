...
PROTO_6:
  ...
  RETURN R1 -1
  GETTABLEKS R1 R0 K0 ["type"]
  JUMPIFNOTEQKS R1 K12 ["Trigger"] [+32]
  GETUPVAL R2 0
  GETTABLEKS R1 R2 K2 ["createElement"]
  GETUPVAL R2 3
  DUPTABLE R3 K11 [{"Text", "Position", "Size", "keyCode", "inputState"}]
...
PROTO_9:
  ...
  LOADK R12 K10 ["Component-DeviceBlueprint Width-Scaling"]
  ...
  GETUPVAL R16 6
  LOADK R17 K14 ["Component-ControllerLayout"]
  LOADK R18 K15 ["Width-Scaling"]
  GETTABLEKS R20 R1 K16 ["displayMappings"]
  JUMPIFNOT R20 [+2]
  LOADK R19 K17 ["Mappings-Visible"]
  JUMP [+1]
  LOADNIL R19
  CALL R16 3 1
  SETTABLE R16 R14 R15
  DUPTABLE R15 K21 [{"GamepadBlueprint", "GamepadControls", "Overlay"}]
  LOADB R16 0
  JUMPIFEQKNIL R7 [+34]
  MOVE R16 R4
  JUMPIFNOT R16 [+31]
  ...
  LOADK R17 K22 ["ImageLabel"]
  NEWTABLE R18 4 0
  GETUPVAL R20 2
  GETTABLEKS R19 R20 K9 ["Tag"]
  LOADK R20 K23 ["Width-Scaling Blueprint-Image"]
  SETTABLE R20 R18 R19
  JUMPIFNOTEQKS R2 K24 ["Dark"] [+6]
  GETTABLEKS R20 R7 K25 ["DeviceImage"]
  GETTABLEKS R19 R20 K26 ["srcDark"]
  JUMP [+4]
  GETTABLEKS R20 R7 K25 ["DeviceImage"]
  GETTABLEKS R19 R20 K27 ["srcLight"]
  SETTABLEKS R19 R18 K28 ["Image"]
  GETUPVAL R19 7
  NAMECALL R19 R19 K29 ["getNextOrder"]
  CALL R19 1 1
  SETTABLEKS R19 R18 K11 ["LayoutOrder"]
  CALL R16 2 1
  SETTABLEKS R16 R15 K18 ["GamepadBlueprint"]
  LOADB R16 0
  JUMPIFEQKNIL R7 [+45]
  GETUPVAL R17 2
  GETTABLEKS R16 R17 K7 ["createElement"]
  ...
  SETTABLEKS R19 R18 K11 ["LayoutOrder"]
  GETUPVAL R20 8
  GETTABLEKS R19 R20 K31 ["map"]
  GETUPVAL R21 8
  GETTABLEKS R20 R21 K32 ["filter"]
  GETUPVAL R23 0
  ...
  CALL R19 2 -1
  CALL R16 -1 1
  SETTABLEKS R16 R15 K19 ["GamepadControls"]
  GETUPVAL R17 2
  GETTABLEKS R16 R17 K7 ["createElement"]
  LOADK R17 K8 ["Frame"]
  NEWTABLE R18 4 0
  ...
  SETTABLEKS R19 R18 K11 ["LayoutOrder"]
  LOADB R19 0
  SETTABLEKS R19 R18 K34 ["Interactable"]
  NEWTABLE R19 0 1
  GETUPVAL R21 8
  GETTABLEKS R20 R21 K31 ["map"]
  GETUPVAL R22 8
  ...
  SETLIST R19 R20 -1 [1]
  CALL R16 3 1
  SETTABLEKS R16 R15 K20 ["Overlay"]
  CALL R12 3 1
...
MAIN:
  ...
  GETTABLEKS R11 R12 K19 ["MappingsWidgets"]
  GETTABLEKS R10 R11 K20 ["CrossLayoutMappings"]
  CALL R9 1 1
  GETIMPORT R10 K5 [require]
  GETTABLEKS R14 R0 K9 ["Src"]
  GETTABLEKS R13 R14 K15 ["Components"]
  GETTABLEKS R12 R13 K19 ["MappingsWidgets"]
  GETTABLEKS R11 R12 K21 ["ButtonMapping"]
  CALL R10 1 1
  ...
  GETTABLEKS R13 R14 K23 ["MappingsContext"]
  CALL R12 1 1
  ...
  GETTABLEKS R15 R16 K25 ["Cryo"]
  CALL R14 1 1
  GETTABLEKS R16 R2 K26 ["Style"]
  GETTABLEKS R15 R16 K27 ["ThemeSwitcher"]
  GETTABLEKS R17 R2 K28 ["Styling"]
  GETTABLEKS R16 R17 K29 ["joinTags"]
  DUPTABLE R17 K31 [{"activeInputs"}]
  NEWTABLE R18 0 0
  SETTABLEKS R18 R17 K30 ["activeInputs"]
  NEWTABLE R18 4 0
  GETIMPORT R19 K35 [Enum.GamepadType.Unknown]
  GETIMPORT R20 K5 [require]
  GETTABLEKS R22 R3 K36 ["DeviceControlData"]
  GETTABLEKS R21 R22 K37 ["Generic"]
  CALL R20 1 1
  SETTABLE R20 R18 R19
  GETIMPORT R19 K39 [Enum.GamepadType.PS4]
  GETIMPORT R20 K5 [require]
  GETTABLEKS R22 R3 K36 ["DeviceControlData"]
  GETTABLEKS R21 R22 K40 ["Playstation4"]
  CALL R20 1 1
  SETTABLE R20 R18 R19
  GETIMPORT R19 K42 [Enum.GamepadType.PS5]
  GETIMPORT R20 K5 [require]
  GETTABLEKS R22 R3 K36 ["DeviceControlData"]
  GETTABLEKS R21 R22 K43 ["Playstation5"]
  CALL R20 1 1
  SETTABLE R20 R18 R19
  GETIMPORT R19 K45 [Enum.GamepadType.XboxOne]
  GETIMPORT R20 K5 [require]
  GETTABLEKS R22 R3 K36 ["DeviceControlData"]
  GETTABLEKS R21 R22 K46 ["XBox"]
  CALL R20 1 1
  SETTABLE R20 R18 R19
