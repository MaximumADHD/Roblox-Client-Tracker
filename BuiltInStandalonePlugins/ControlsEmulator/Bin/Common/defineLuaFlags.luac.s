...
PROTO_3:
        0 GETIMPORT                        R0 K1 [game]
        2 LOADK                            R2 K2 ["StudioControlsEmulatorWaitForDeviceEmulator"]
        3 NAMECALL                         R0 R0 K3 ["GetFastFlag"]
        5 CALL                             R0 2 -1
        6 RETURN                           R0 -1
...
MAIN:
       ...
       24 LOADK                            R2 K6 ["StudioControlsEmulatorWaitForDeviceEmulator"]
       25 LOADB                            R3 0
       26 NAMECALL                         R0 R0 K3 ["DefineFastFlag"]
       28 CALL                             R0 3 0
       29 DUPTABLE                         R0 K12 [{"getFFlagRemoveAutoOpenBehavior", "getFFlagStudioDeviceSimulatorAndroidTV", "getFFlagReconnectDeviceSignalOnReopen", "getFFlagWaitForDeviceEmulator", "getEngineFeatureEnableMicroGamepadKeycodes"}]
       30 DUPCLOSURE                       R1 K13 [PROTO_0]
       31 SETTABLEKS                       R1 R0 K7 ["getFFlagRemoveAutoOpenBehavior"]
       33 DUPCLOSURE                       R1 K14 [PROTO_1]
       34 SETTABLEKS                       R1 R0 K8 ["getFFlagStudioDeviceSimulatorAndroidTV"]
       36 DUPCLOSURE                       R1 K15 [PROTO_2]
       37 SETTABLEKS                       R1 R0 K9 ["getFFlagReconnectDeviceSignalOnReopen"]
       39 DUPCLOSURE                       R1 K16 [PROTO_3]
       40 SETTABLEKS                       R1 R0 K10 ["getFFlagWaitForDeviceEmulator"]
       42 DUPCLOSURE                       R1 K17 [PROTO_4]
       43 SETTABLEKS                       R1 R0 K11 ["getEngineFeatureEnableMicroGamepadKeycodes"]
       45 RETURN                           R0 1
