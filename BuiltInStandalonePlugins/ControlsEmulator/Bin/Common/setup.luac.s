...
PROTO_6:
  ...
  JUMPIFEQKNIL R1 [+14]
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K1 ["mainDockWidget"]
  LOADB R3 1
...
PROTO_8:
  ...
  MOVE R8 R11
  JUMPIFEQKNIL R8 [+12]
  GETTABLEKS R11 R7 K50 ["mainDockWidget"]
  LOADB R12 1
  SETTABLEKS R12 R11 K51 ["Enabled"]
  JUMP [+5]
  GETIMPORT R11 K53 [warn]
  LOADK R12 K54 ["Failed to get currently emulated device: "]
  MOVE R13 R10
  CALL R11 2 0
  ...
  CAPTURE VAL R7
  CALL R11 1 0
  GETTABLEKS R11 R7 K55 ["pluginLoader"]
  NAMECALL R11 R11 K56 ["waitForUserInteraction"]
  CALL R11 1 1
  JUMPIF R11 [+1]
  RETURN R0 0
  MOVE R12 R1
...
MAIN:
  ...
  GETTABLEKS R7 R8 K20 ["pluginType"]
  CALL R6 1 1
  DUPCLOSURE R7 K21 [PROTO_8]
  CAPTURE VAL R0
  CAPTURE VAL R3
  CAPTURE VAL R2
  CAPTURE VAL R6
