...
PROTO_4:
       ...
       10 CALL                             R1 1 1
       11 GETUPVAL                         R2 1
       12 GETTABLEKS                       R2 R2 K4 ["useToggleState"]
       14 CALL                             R2 0 1
       15 GETUPVAL                         R3 2
       ...
       25 CALL                             R3 2 1
       26 GETUPVAL                         R4 1
       27 GETTABLEKS                       R4 R4 K6 ["useEventConnection"]
       29 GETTABLEKS                       R5 R0 K7 ["dockWidget"]
       31 GETTABLEKS                       R5 R5 K8 ["PluginDragEntered"]
       33 NEWCLOSURE                       R6 P1
       34 CAPTURE                          VAL R2
       35 NEWTABLE                         R7 0 0
       37 CALL                             R4 3 0
       38 GETUPVAL                         R4 1
       39 GETTABLEKS                       R4 R4 K6 ["useEventConnection"]
       41 GETTABLEKS                       R5 R0 K7 ["dockWidget"]
       43 GETTABLEKS                       R5 R5 K9 ["PluginDragLeft"]
       45 NEWCLOSURE                       R6 P2
       46 CAPTURE                          VAL R2
       47 NEWTABLE                         R7 0 0
       49 CALL                             R4 3 0
       50 GETUPVAL                         R4 2
       51 GETTABLEKS                       R4 R4 K10 ["useRef"]
       53 GETUPVAL                         R5 3
       54 GETTABLEKS                       R5 R5 K11 ["Signal"]
       56 GETTABLEKS                       R5 R5 K12 ["new"]
       58 CALL                             R5 0 -1
       59 CALL                             R4 -1 1
       60 GETUPVAL                         R5 1
       61 GETTABLEKS                       R5 R5 K6 ["useEventConnection"]
       63 GETTABLEKS                       R6 R0 K7 ["dockWidget"]
       65 GETTABLEKS                       R6 R6 K13 ["PluginDragDropped"]
       67 NEWCLOSURE                       R7 P3
       68 CAPTURE                          VAL R2
       69 CAPTURE                          VAL R4
       70 NEWTABLE                         R8 0 0
       ...
       73 GETUPVAL                         R5 4
       74 GETUPVAL                         R6 3
       75 GETTABLEKS                       R6 R6 K14 ["Components"]
       77 GETTABLEKS                       R6 R6 K15 ["Contexts"]
       79 GETTABLEKS                       R6 R6 K16 ["DragDropContextProvider"]
