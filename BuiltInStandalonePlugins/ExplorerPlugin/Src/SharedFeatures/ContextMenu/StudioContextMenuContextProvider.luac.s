...
PROTO_7:
  ...
  JUMP [+78]
  GETTABLEKS R14 R13 K3 ["type"]
  JUMPIFNOTEQKS R14 K11 ["action"] [+75]
  ...
  GETUPVAL R15 6
  JUMPIFNOT R15 [+6]
  GETTABLEKS R16 R14 K18 ["Text"]
  LOADK R17 K19 ["     "]
  CONCAT R15 R16 R17
  SETTABLEKS R15 R14 K18 ["Text"]
  GETTABLEKS R18 R13 K11 ["action"]
  GETTABLEKS R17 R18 K12 ["state"]
  GETTABLEKS R16 R17 K20 ["Shortcuts"]
  GETTABLEN R15 R16 1
  JUMPIFNOTEQKNIL R15 [+5]
  LOADK R16 K21 [""]
  SETTABLEKS R16 R14 K22 ["DefaultShortcut"]
  JUMP [+10]
  SETTABLEKS R15 R14 K22 ["DefaultShortcut"]
  GETUPVAL R16 6
  JUMPIF R16 [+6]
...
PROTO_10:
  ...
  GETTABLEKS R8 R9 K10 ["getFFlagExplorerStreaming"]
  CALL R8 0 1
  JUMPIFNOT R8 [+3]
  GETUPVAL R7 10
  CALL R7 0 1
  ...
  GETTABLEKS R9 R10 K13 ["ContextMenuContextProvider"]
  DUPTABLE R10 K18 [{"showContextMenu", "actionTriggeredSignal", "showStreamingContextMenu", "streamingActionTriggeredSignal"}]
  SETTABLEKS R6 R10 K14 ["showContextMenu"]
  SETTABLEKS R4 R10 K15 ["actionTriggeredSignal"]
  MOVE R11 R7
  JUMPIFNOT R11 [+2]
  GETTABLEKS R11 R7 K16 ["showStreamingContextMenu"]
  SETTABLEKS R11 R10 K16 ["showStreamingContextMenu"]
  MOVE R11 R7
  JUMPIFNOT R11 [+2]
  GETTABLEKS R11 R7 K17 ["streamingActionTriggeredSignal"]
  SETTABLEKS R11 R10 K17 ["streamingActionTriggeredSignal"]
...
MAIN:
  ...
  GETTABLEKS R14 R15 K11 ["SharedFeatures"]
  GETTABLEKS R13 R14 K12 ["ContextMenu"]
  GETTABLEKS R12 R13 K24 ["useStreamingContextMenu"]
  CALL R11 1 1
  GETIMPORT R12 K1 [game]
  LOADK R14 K25 ["ExplorerContextMenuPadding"]
  LOADB R15 0
  NAMECALL R12 R12 K26 ["DefineFastFlag"]
  CALL R12 3 1
  GETTABLEKS R14 R5 K27 ["ContextServices"]
  GETTABLEKS R13 R14 K28 ["Localization"]
  GETTABLEKS R14 R6 K29 ["createElement"]
  NEWTABLE R15 0 0
  LOADN R16 0
  NEWCLOSURE R17 P0
  CAPTURE REF R16
