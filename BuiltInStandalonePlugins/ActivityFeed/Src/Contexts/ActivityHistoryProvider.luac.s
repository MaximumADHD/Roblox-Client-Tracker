...
PROTO_5:
  DUPTABLE R0 K7 [{"activityHistoryClient", "showSaveOrPublishPlaceToRobloxFn", "useCollaborators", "usePlaceAndUniverseId", "useConnectToDataModelSessionEffect", "openBrowserLink", "contextType"}]
  GETUPVAL R2 0
  ...
  GETUPVAL R2 0
  GETTABLEKS R1 R2 K5 ["openBrowserLink"]
  JUMPIF R1 [+1]
  DUPCLOSURE R1 K12 [PROTO_4]
  SETTABLEKS R1 R0 K5 ["openBrowserLink"]
  GETUPVAL R2 0
  GETTABLEKS R1 R2 K6 ["contextType"]
  SETTABLEKS R1 R0 K6 ["contextType"]
  RETURN R0 1
...
PROTO_6:
  ...
  GETTABLEKS R10 R0 K7 ["useConnectToDataModelSessionEffect"]
  SETLIST R3 R4 7 [1]
  CALL R1 2 1
  GETUPVAL R3 0
  GETTABLEKS R2 R3 K8 ["createElement"]
  GETUPVAL R4 2
  GETTABLEKS R3 R4 K9 ["Provider"]
  DUPTABLE R4 K11 [{"value"}]
  SETTABLEKS R1 R4 K10 ["value"]
