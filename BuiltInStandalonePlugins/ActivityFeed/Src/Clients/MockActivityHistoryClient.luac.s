...
PROTO_3:
  ...
  LOADK R1 K2 ["mock unsubscribe"]
  CALL R0 1 0
  RETURN R0 0

PROTO_4:
  GETIMPORT R1 K1 [print]
  LOADK R2 K2 ["mock subscribe"]
  CALL R1 1 0
...
PROTO_6:
  ...
  GETUPVAL R13 1
  SUB R12 R13 R2
  DIVK R11 R12 K0 [10800000]
  FASTCALL1 MATH_FLOOR R11 [+2]
  GETIMPORT R10 K3 [math.floor]
  CALL R10 1 1
  GETUPVAL R11 0
  ...
  MOVE R5 R8
  MOVE R6 R9
  DUPTABLE R7 K9 [{"responseCode", "responseBody"}]
  LOADN R8 200
  SETTABLEKS R8 R7 K7 ["responseCode"]
  DUPTABLE R8 K14 [{"events", "nextCursor", "previousCursor", "hasMore"}]
  SETTABLEKS R4 R8 K10 ["events"]
  SETTABLEKS R5 R8 K11 ["nextCursor"]
  SETTABLEKS R6 R8 K12 ["previousCursor"]
  LOADNIL R9
  SETTABLEKS R9 R8 K13 ["hasMore"]
  SETTABLEKS R8 R7 K8 ["responseBody"]
...
MAIN:
  ...
  CAPTURE VAL R1
  DUPTABLE R15 K29 [{"activityFeedRTEEffect", "fetchActivityHistory", "fetchUsernames", "useCollaborators"}]
  SETTABLEKS R11 R15 K25 ["activityFeedRTEEffect"]
  SETTABLEKS R12 R15 K26 ["fetchActivityHistory"]
  SETTABLEKS R13 R15 K27 ["fetchUsernames"]
  SETTABLEKS R14 R15 K28 ["useCollaborators"]
  RETURN R15 1
