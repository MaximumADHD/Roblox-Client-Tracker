...
MAIN:
  ...
  GETTABLEKS R3 R4 K9 ["MockActivityHistoryEvents"]
  CALL R2 1 1
  ...
  GETIMPORT R6 K15 [DateTime.now]
  CALL R6 0 1
  GETTABLEKS R5 R6 K16 ["UnixTimestampMillis"]
  LENGTH R6 R2
  ...
  CAPTURE VAL R4
  DUPTABLE R13 K26 [{"activityFeedRTEEffect", "fetchActivityHistory", "fetchUsernames"}]
  SETTABLEKS R10 R13 K23 ["activityFeedRTEEffect"]
  SETTABLEKS R11 R13 K24 ["fetchActivityHistory"]
  SETTABLEKS R12 R13 K25 ["fetchUsernames"]
  RETURN R13 1
