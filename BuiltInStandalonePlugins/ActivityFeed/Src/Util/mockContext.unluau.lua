...
local var4 = {}
local var266 = var3.Analytics.mock()
local var6 = var3.Localization.mock()
local var272 = require(var0.Packages.Rodux).Store
var272 = require(var0.Src.Reducers.MainReducer)
local var7 = var3.Store.new(var272.new(var272, nil, nil, nil))
