...
MAIN:
       ...
       30 JUMPIF                           R1 ; [+1]
       31 RETURN                           R0 0
       32 GETIMPORT                        R1 K3 [script]
       34 GETTABLEKS                       R1 R1 K4 ["Parent"]
       36 GETTABLEKS                       R1 R1 K4 ["Parent"]
       38 GETTABLEKS                       R1 R1 K4 ["Parent"]
       40 GETIMPORT                        R2 K1 [require]
       42 GETTABLEKS                       R3 R1 K10 ["Packages"]
       44 GETTABLEKS                       R3 R3 K11 ["TestLoader"]
       46 CALL                             R2 1 1
       ...
       61 JUMPIF                           R1 ; [+1]
       62 RETURN                           R0 0
       63 GETIMPORT                        R1 K3 [script]
       65 GETTABLEKS                       R1 R1 K4 ["Parent"]
       67 GETTABLEKS                       R1 R1 K4 ["Parent"]
       69 GETTABLEKS                       R1 R1 K4 ["Parent"]
       ...
       80 GETTABLEKS                       R4 R1 K10 ["Packages"]
       82 GETTABLEKS                       R4 R4 K11 ["TestLoader"]
       84 CALL                             R3 1 1
      ...
      102 GETTABLEKS                       R6 R1 K10 ["Packages"]
      104 GETTABLEKS                       R6 R6 K21 ["React"]
      106 CALL                             R5 1 1
      107 GETIMPORT                        R6 K1 [require]
      109 GETTABLEKS                       R7 R1 K10 ["Packages"]
      111 GETTABLEKS                       R7 R7 K22 ["ReactRoblox"]
      113 CALL                             R6 1 1
      114 GETIMPORT                        R7 K1 [require]
      116 GETTABLEKS                       R8 R1 K14 ["Src"]
      118 GETTABLEKS                       R8 R8 K23 ["MainPlugin"]
      120 CALL                             R7 1 1
      121 LOADNIL                          R8
      ...
      127 CAPTURE                          VAL R6
      128 CAPTURE                          VAL R4
      129 GETIMPORT                        R10 K9 [plugin]
      131 GETTABLEKS                       R10 R10 K24 ["Unloading"]
