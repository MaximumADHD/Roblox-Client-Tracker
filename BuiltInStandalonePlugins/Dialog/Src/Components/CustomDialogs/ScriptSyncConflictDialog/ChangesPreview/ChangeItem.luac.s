PROTO_0:
        ...
        9 GETUPVAL                         R6 0
       10 GETTABLEKS                       R5 R6 K7 ["GetTextBoundsAsync"]
       12 GETUPVAL                         R6 0
       13 MOVE                             R7 R2
       14 CALL                             R4 3 2
       15 JUMPIFNOT                        R4 ; [+4]
       ...
       37 GETUPVAL                         R12 0
       38 GETTABLEKS                       R11 R12 K7 ["GetTextBoundsAsync"]
       40 GETUPVAL                         R12 0
       41 MOVE                             R13 R2
       42 CALL                             R10 3 2
       43 JUMPIFNOT                        R10 ; [+5]
       ...
       66 GETUPVAL                         R13 0
       67 GETTABLEKS                       R12 R13 K7 ["GetTextBoundsAsync"]
       69 GETUPVAL                         R13 0
       70 MOVE                             R14 R2
       71 CALL                             R11 3 2
       72 JUMPIFNOT                        R11 ; [+5]
...
PROTO_2:
        ...
        7 GETUPVAL                         R2 1
        8 GETTABLEKS                       R1 R2 K5 ["FontSize"]
       10 SETTABLEKS                       R1 R0 K6 ["Size"]
       12 LOADK                            R1 K7 [∞]
       13 SETTABLEKS                       R1 R0 K8 ["Width"]
       15 GETUPVAL                         R1 2
       16 GETUPVAL                         R3 3
       17 GETTABLEKS                       R2 R3 K9 ["change"]
       19 GETUPVAL                         R3 4
       20 MOVE                             R4 R0
       21 CALL                             R1 3 1
...
PROTO_4:
       ...
       17 GETUPVAL                         R3 1
       18 GETTABLEKS                       R2 R3 K0 ["Font"]
       20 CALL                             R1 1 1
       21 JUMP                             ; [+3]
       22 GETUPVAL                         R2 1
       23 GETTABLEKS                       R1 R2 K0 ["Font"]
...
PROTO_5:
       ...
       10 GETUPVAL                         R4 1
       11 GETTABLEKS                       R3 R4 K4 ["useState"]
       13 LOADN                            R4 0
       14 CALL                             R3 1 2
       15 GETUPVAL                         R6 1
       16 GETTABLEKS                       R5 R6 K4 ["useState"]
       18 GETTABLEKS                       R6 R0 K5 ["change"]
       20 CALL                             R5 1 2
       21 GETUPVAL                         R8 1
       22 GETTABLEKS                       R7 R8 K6 ["useCallback"]
       24 NEWCLOSURE                       R8 P0
       25 CAPTURE                          VAL R4
       26 NEWTABLE                         R9 0 0
       28 CALL                             R7 2 1
       29 GETUPVAL                         R9 1
       30 GETTABLEKS                       R8 R9 K7 ["useEffect"]
       32 NEWCLOSURE                       R9 P1
       33 CAPTURE                          VAL R3
       34 CAPTURE                          VAL R2
       35 CAPTURE                          UPVAL U2
       ...
       56 GETUPVAL                         R12 3
       57 GETUPVAL                         R14 0
       58 GETTABLEKS                       R13 R14 K15 ["Image"]
       ...
       71 GETUPVAL                         R12 3
       72 GETUPVAL                         R14 0
       73 GETTABLEKS                       R13 R14 K13 ["Text"]
