...
PROTO_6:
  ...
  DUPTABLE R6 K22 [{"creatorType", "creatorTargetId"}]
  LOADK R7 K23 ["User"]
  SETTABLEKS R7 R6 K20 ["creatorType"]
  GETUPVAL R8 8
  NAMECALL R8 R8 K24 ["GetUserId"]
  CALL R8 1 -1
  FASTCALL TOSTRING [+2]
  GETIMPORT R7 K26 [tostring]
  CALL R7 -1 1
  SETTABLEKS R7 R6 K21 ["creatorTargetId"]
...
PROTO_8:
  ...
  DUPTABLE R7 K22 [{"creatorType"}]
  LOADK R8 K23 ["Group"]
  SETTABLEKS R8 R7 K21 ["creatorType"]
...
PROTO_14:
  ...
  GETUPVAL R5 6
  DUPTABLE R6 K7 [{"PageName", "Tabs", "CanSwapBetweenViews", "IsDefaultGridView", "HasSearchBar"}]
  LOADK R7 K8 ["Experiences"]
  SETTABLEKS R7 R6 K2 ["PageName"]
  NEWTABLE R7 0 4
  DUPTABLE R8 K14 [{"Title", "FailedTitle", "Key", "PageComponent", "Dropdowns"}]
  LOADK R11 K15 ["Plugin"]
  LOADK R12 K16 ["ExperiencesPage.Owned"]
  NAMECALL R9 R0 K17 ["getText"]
  CALL R9 3 1
  SETTABLEKS R9 R8 K9 ["Title"]
  LOADK R11 K15 ["Plugin"]
  LOADK R12 K18 ["NoExperiencesToDisplay"]
  NAMECALL R9 R0 K17 ["getText"]
  CALL R9 3 1
  ...
  GETUPVAL R9 7
  SETTABLEKS R9 R8 K12 ["PageComponent"]
  DUPTABLE R9 K22 [{"SortDropdown", "DefaultSortIndex"}]
  SETTABLEKS R3 R9 K20 ["SortDropdown"]
  LOADN R10 4
  SETTABLEKS R10 R9 K21 ["DefaultSortIndex"]
  SETTABLEKS R9 R8 K13 ["Dropdowns"]
  DUPTABLE R9 K14 [{"Title", "FailedTitle", "Key", "PageComponent", "Dropdowns"}]
  LOADK R12 K15 ["Plugin"]
  LOADK R13 K23 ["ExperiencesPage.Group"]
  NAMECALL R10 R0 K17 ["getText"]
  CALL R10 3 1
  SETTABLEKS R10 R9 K9 ["Title"]
  LOADK R12 K15 ["Plugin"]
  LOADK R13 K24 ["NoGroupExperiencesToDisplay"]
  NAMECALL R10 R0 K17 ["getText"]
  CALL R10 3 1
  SETTABLEKS R10 R9 K10 ["FailedTitle"]
  LOADK R10 K25 ["Group"]
  SETTABLEKS R10 R9 K11 ["Key"]
  GETUPVAL R10 8
  SETTABLEKS R10 R9 K12 ["PageComponent"]
  DUPTABLE R10 K27 [{"SortDropdown", "DefaultSortIndex", "GroupDropdown"}]
  SETTABLEKS R3 R10 K20 ["SortDropdown"]
  LOADN R11 4
  SETTABLEKS R11 R10 K21 ["DefaultSortIndex"]
  LENGTH R12 R1
  LOADN R13 0
  ...
  JUMP [+1]
  LOADNIL R11
  SETTABLEKS R11 R10 K26 ["GroupDropdown"]
  SETTABLEKS R10 R9 K13 ["Dropdowns"]
  DUPTABLE R10 K14 [{"Title", "FailedTitle", "Key", "PageComponent", "Dropdowns"}]
  LOADK R13 K15 ["Plugin"]
  LOADK R14 K28 ["ExperiencesPage.Shared"]
  NAMECALL R11 R0 K17 ["getText"]
  CALL R11 3 1
  SETTABLEKS R11 R10 K9 ["Title"]
  LOADK R13 K15 ["Plugin"]
  LOADK R14 K29 ["NoSharedExperiencesToDisplay"]
  NAMECALL R11 R0 K17 ["getText"]
  CALL R11 3 1
  SETTABLEKS R11 R10 K10 ["FailedTitle"]
  LOADK R11 K30 ["Shared"]
  SETTABLEKS R11 R10 K11 ["Key"]
  GETUPVAL R11 9
  SETTABLEKS R11 R10 K12 ["PageComponent"]
  DUPTABLE R11 K22 [{"SortDropdown", "DefaultSortIndex"}]
  SETTABLEKS R3 R11 K20 ["SortDropdown"]
  LOADN R12 4
  SETTABLEKS R12 R11 K21 ["DefaultSortIndex"]
  SETTABLEKS R11 R10 K13 ["Dropdowns"]
  DUPTABLE R11 K14 [{"Title", "FailedTitle", "Key", "PageComponent", "Dropdowns"}]
  LOADK R14 K15 ["Plugin"]
  LOADK R15 K31 ["ExperiencesPage.Local"]
  NAMECALL R12 R0 K17 ["getText"]
  CALL R12 3 1
  SETTABLEKS R12 R11 K9 ["Title"]
  LOADK R14 K15 ["Plugin"]
  LOADK R15 K32 ["NoLocalFilesToDisplay"]
  NAMECALL R12 R0 K17 ["getText"]
  CALL R12 3 1
  SETTABLEKS R12 R11 K10 ["FailedTitle"]
  LOADK R12 K33 ["Local"]
  SETTABLEKS R12 R11 K11 ["Key"]
  GETUPVAL R12 10
  SETTABLEKS R12 R11 K12 ["PageComponent"]
  NEWTABLE R12 0 0
  SETTABLEKS R12 R11 K13 ["Dropdowns"]
  SETLIST R7 R8 4 [1]
...
MAIN:
  ...
  GETTABLEKS R7 R8 K14 ["getFFlagLuaStartPageHidePublicPrivateToggle"]
  CALL R6 1 1
  CALL R6 0 1
