...
MAIN:
  ...
  GETTABLEKS R22 R23 K34 ["SortingOptions"]
  CALL R21 1 1
  GETIMPORT R22 K5 [require]
  GETTABLEKS R25 R0 K11 ["Src"]
  GETTABLEKS R24 R25 K32 ["Util"]
  GETTABLEKS R23 R24 K35 ["Services"]
  CALL R22 1 1
  GETTABLEKS R23 R22 K36 ["StartPageManager"]
  GETTABLEKS R24 R22 K37 ["StudioService"]
  GETIMPORT R25 K5 [require]
  GETTABLEKS R29 R0 K11 ["Src"]
  GETTABLEKS R28 R29 K32 ["Util"]
  GETTABLEKS R27 R28 K38 ["Telemetry"]
  GETTABLEKS R26 R27 K39 ["TelemetryContext"]
  CALL R25 1 1
  GETIMPORT R26 K5 [require]
  GETTABLEKS R30 R0 K11 ["Src"]
  GETTABLEKS R29 R30 K32 ["Util"]
  GETTABLEKS R28 R29 K38 ["Telemetry"]
  GETTABLEKS R27 R28 K40 ["StartPageTelemetryEvent"]
  CALL R26 1 1
  ...
  CAPTURE VAL R8
  CAPTURE VAL R21
  DUPTABLE R31 K49 [{"searchKey", "isArchived", "isTemplates", "pageSize"}]
  LOADK R32 K50 ["Experiences"]
  SETTABLEKS R32 R31 K45 ["searchKey"]
  LOADB R32 0
  SETTABLEKS R32 R31 K46 ["isArchived"]
  LOADB R32 0
  SETTABLEKS R32 R31 K47 ["isTemplates"]
  LOADN R32 30
  SETTABLEKS R32 R31 K48 ["pageSize"]
