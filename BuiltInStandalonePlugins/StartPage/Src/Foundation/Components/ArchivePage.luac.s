...
PROTO_8:
  ...
  GETUPVAL R5 6
  DUPTABLE R6 K8 [{"PageName", "Tabs", "CanSwapBetweenViews", "IsDefaultGridView", "HasSearchBar", "CellPadding"}]
  LOADK R7 K9 ["Archive"]
  SETTABLEKS R7 R6 K2 ["PageName"]
  NEWTABLE R7 0 2
  DUPTABLE R8 K15 [{"Title", "FailedTitle", "Key", "PageComponent", "Dropdowns"}]
  LOADK R11 K16 ["Plugin"]
  LOADK R12 K17 ["ArchivePage.Owned"]
  ...
  LOADK R13 K24 ["ArchivePage.Group"]
...
MAIN:
  ...
  GETTABLEKS R6 R7 K13 ["getFFlagLuaStartPageTableContextMenu"]
  CALL R5 1 1
  CALL R5 0 1
  ...
  GETTABLEKS R16 R17 K28 ["ContextMenuActions"]
  CALL R15 1 1
  GETIMPORT R16 K5 [require]
  GETTABLEKS R19 R0 K11 ["Src"]
  GETTABLEKS R18 R19 K29 ["Network"]
  GETTABLEKS R17 R18 K30 ["DiscoverGroups"]
  CALL R16 1 1
  ...
  GETTABLEKS R21 R22 K25 ["Foundation"]
  GETTABLEKS R20 R21 K22 ["Components"]
  GETTABLEKS R19 R20 K32 ["NoResultsFound"]
  CALL R18 1 1
  ...
  GETTABLEKS R23 R24 K36 ["getFFlagLuaStartPagePlaceOpenAttributionTelemetry"]
  CALL R22 1 1
  CALL R22 0 1
  GETTABLEKS R23 R10 K37 ["StudioService"]
  GETIMPORT R24 K5 [require]
  GETTABLEKS R28 R0 K11 ["Src"]
  GETTABLEKS R27 R28 K19 ["Util"]
  GETTABLEKS R26 R27 K38 ["Telemetry"]
  GETTABLEKS R25 R26 K39 ["TelemetryContext"]
  CALL R24 1 1
  GETIMPORT R25 K5 [require]
  GETTABLEKS R29 R0 K11 ["Src"]
  GETTABLEKS R28 R29 K19 ["Util"]
  GETTABLEKS R27 R28 K38 ["Telemetry"]
  GETTABLEKS R26 R27 K40 ["StartPageTelemetryEvent"]
  CALL R25 1 1
  GETIMPORT R26 K43 [UDim2.new]
  LOADN R27 0
  LOADN R28 200
  LOADN R29 0
  LOADN R30 200
  ...
  CAPTURE VAL R7
  CAPTURE VAL R20
  DUPTABLE R29 K49 [{"searchKey", "isArchived", "isTemplates", "pageSize"}]
  LOADK R30 K50 ["Archive"]
  SETTABLEKS R30 R29 K45 ["searchKey"]
  LOADB R30 1
  SETTABLEKS R30 R29 K46 ["isArchived"]
  LOADB R30 0
  SETTABLEKS R30 R29 K47 ["isTemplates"]
  LOADN R30 30
  SETTABLEKS R30 R29 K48 ["pageSize"]
  NEWTABLE R30 0 1
  LOADK R31 K51 ["RestoreArchive"]
  SETLIST R30 R31 1 [1]
