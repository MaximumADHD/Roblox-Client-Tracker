...
PROTO_7:
  ...
  GETUPVAL R2 2
  DUPTABLE R3 K8 [{"PageName", "HideTabs", "Tabs", "CanSwapBetweenViews", "IsDefaultGridView", "HasSearchBar"}]
  LOADK R4 K9 ["Recents"]
  SETTABLEKS R4 R3 K2 ["PageName"]
  LOADB R4 1
  SETTABLEKS R4 R3 K3 ["HideTabs"]
  NEWTABLE R4 0 1
  DUPTABLE R5 K15 [{"Title", "FailedTitle", "Key", "PageComponent", "Dropdowns"}]
  LOADK R8 K16 ["Plugin"]
  LOADK R9 K17 ["RecentsPage.Title"]
  NAMECALL R6 R0 K18 ["getText"]
  CALL R6 3 1
  SETTABLEKS R6 R5 K10 ["Title"]
  LOADK R8 K16 ["Plugin"]
  LOADK R9 K19 ["NoExperiencesToDisplay"]
  NAMECALL R6 R0 K18 ["getText"]
  CALL R6 3 1
  SETTABLEKS R6 R5 K11 ["FailedTitle"]
  LOADK R6 K9 ["Recents"]
  SETTABLEKS R6 R5 K12 ["Key"]
  GETUPVAL R6 3
  SETTABLEKS R6 R5 K13 ["PageComponent"]
  NEWTABLE R6 0 0
  SETTABLEKS R6 R5 K14 ["Dropdowns"]
  SETLIST R4 R5 1 [1]
...
MAIN:
  ...
  GETTABLEKS R5 R6 K12 ["getFFlagLuaStartPageHidePublicPrivateToggle"]
  CALL R4 1 1
  CALL R4 0 1
  ...
  JUMP [+1]
  LOADK R30 K46 [""]
  LOADK R31 K47 ["Archive"]
  LOADK R32 K48 ["RemoveRecent"]
  SETLIST R26 R27 6 [1]
