...
PROTO_23:
       ...
       25 CALL                             R0 2 1
       26 GETUPVAL                         R1 1
       27 GETTABLEKS                       R1 R1 K3 ["targetCount"]
       29 JUMPIFNOTEQKNIL                  R1 ; [+36]
       31 GETUPVAL                         R1 1
       32 GETTABLEKS                       R1 R1 K4 ["requestedCount"]
       34 JUMPIFNOTEQKNIL                  R1 ; [+31]
       36 GETUPVAL                         R1 1
       37 GETUPVAL                         R2 5
       38 GETTABLEKS                       R2 R2 K5 ["pageSize"]
       40 SETTABLEKS                       R2 R1 K4 ["requestedCount"]
       42 GETUPVAL                         R1 1
       43 GETUPVAL                         R2 5
       44 GETTABLEKS                       R2 R2 K5 ["pageSize"]
       46 SETTABLEKS                       R2 R1 K5 ["pageSize"]
       48 GETUPVAL                         R1 1
       49 GETUPVAL                         R2 5
       50 GETTABLEKS                       R2 R2 K6 ["sortFn"]
       52 SETTABLEKS                       R2 R1 K6 ["sortFn"]
       54 GETUPVAL                         R1 4
       55 JUMPIFNOT                        R1 ; [+4]
       56 GETUPVAL                         R1 1
       57 LOADNIL                          R2
       58 SETTABLEKS                       R2 R1 K7 ["needsRefetch"]
       60 GETUPVAL                         R1 6
       61 GETUPVAL                         R2 7
       62 LOADN                            R3 0
       63 GETUPVAL                         R4 8
       ...
       65 CALL                             R1 4 0
       66 GETUPVAL                         R1 1
       67 GETTABLEKS                       R1 R1 K8 ["dirty"]
       69 JUMPIFNOT                        R1 ; [+4]
       70 GETUPVAL                         R1 3
       71 NAMECALL                         R1 R1 K9 ["refresh"]
       73 CALL                             R1 1 0
       74 NEWCLOSURE                       R1 P1
       75 CAPTURE                          VAL R0
       76 CAPTURE                          UPVAL U5
...
PROTO_25:
       ...
       47 CALL                             R9 2 1
       48 MOVE                             R10 R6
       49 GETTABLEKS                       R11 R5 K4 ["targetCount"]
       51 MOVE                             R12 R9
       52 RETURN                           R10 3
