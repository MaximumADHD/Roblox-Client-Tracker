...
PROTO_8:
  ...
  MOVE R6 R8
  JUMP [+39]
  GETTABLEKS R10 R5 K10 ["composeUrl"]
  GETUPVAL R13 1
  GETTABLEKS R12 R13 K17 ["EXPERIENCES_SEARCH_URL"]
  GETTABLEKS R11 R12 K12 ["Prefix"]
  GETUPVAL R14 1
  GETTABLEKS R13 R14 K17 ["EXPERIENCES_SEARCH_URL"]
  GETTABLEKS R12 R13 K13 ["Url"]
  CALL R12 0 1
  MOVE R13 R0
  CALL R10 3 1
  MOVE R8 R10
  LOADK R10 K18 ["&surface=StudioStartPage&PageIndex=%*"]
  MOVE R12 R1
...
MAIN:
  ...
  GETTABLEKS R21 R22 K18 ["Network"]
  GETTABLEKS R20 R21 K35 ["DiscoverTeamCreateStatus"]
  CALL R19 1 1
  ...
  GETTABLEKS R22 R23 K38 ["StartPageTelemetryEvent"]
  CALL R21 1 1
  GETIMPORT R22 K5 [require]
  GETTABLEKS R25 R0 K6 ["Src"]
  GETTABLEKS R24 R25 K18 ["Network"]
  GETTABLEKS R23 R24 K39 ["GameCache"]
  CALL R22 1 1
  DUPCLOSURE R23 K40 [PROTO_0]
  MOVE R24 R11
  GETTABLEKS R25 R7 K41 ["validate"]
  CALL R24 1 1
  MOVE R25 R11
  GETTABLEKS R26 R8 K41 ["validate"]
  CALL R25 1 1
