...
MAIN:
  ...
  GETTABLEKS R13 R10 K23 ["Design"]
  GETTABLEKS R16 R3 K24 ["Style"]
  GETTABLEKS R15 R16 K25 ["Themes"]
  GETTABLEKS R14 R15 K26 ["StudioTheme"]
  GETTABLEKS R16 R3 K27 ["Styling"]
  GETTABLEKS R15 R16 K28 ["registerPluginStyles"]
  GETTABLEKS R17 R4 K29 ["Components"]
  GETTABLEKS R16 R17 K30 ["FoundationProviderAdapter"]
  GETTABLEKS R20 R0 K8 ["Src"]
  GETTABLEKS R19 R20 K31 ["Resources"]
  GETTABLEKS R18 R19 K32 ["Localization"]
  GETTABLEKS R17 R18 K33 ["SourceStrings"]
  GETTABLEKS R21 R0 K8 ["Src"]
  GETTABLEKS R20 R21 K31 ["Resources"]
  GETTABLEKS R19 R20 K32 ["Localization"]
  GETTABLEKS R18 R19 K34 ["LocalizedStrings"]
  MOVE R19 R7
  LOADK R20 K35 ["LoginPageCloseOnStartPageOpen"]
  CALL R19 1 1
  ...
  GETTABLEKS R23 R24 K39 ["TelemetryProtocolTypes"]
  CALL R22 1 1
  GETIMPORT R23 K5 [require]
  GETTABLEKS R27 R0 K8 ["Src"]
  GETTABLEKS R26 R27 K10 ["Foundation"]
  GETTABLEKS R25 R26 K29 ["Components"]
  GETTABLEKS R24 R25 K40 ["PageController"]
  CALL R23 1 1
  GETIMPORT R24 K5 [require]
  GETTABLEKS R26 R0 K8 ["Src"]
  GETTABLEKS R25 R26 K41 ["Types"]
  CALL R24 1 1
  GETIMPORT R25 K5 [require]
  GETTABLEKS R28 R0 K8 ["Src"]
  GETTABLEKS R27 R28 K9 ["Util"]
  GETTABLEKS R26 R27 K42 ["Services"]
  CALL R25 1 1
  GETTABLEKS R26 R25 K43 ["StartPageManager"]
  GETTABLEKS R27 R1 K44 ["PureComponent"]
  ...
  CAPTURE VAL R5
  SETTABLEKS R28 R27 K50 ["didMount"]
  DUPCLOSURE R28 K51 [PROTO_4]
  CAPTURE VAL R5
  SETTABLEKS R28 R27 K52 ["willUnmount"]
  DUPCLOSURE R28 K53 [PROTO_7]
  CAPTURE VAL R19
  CAPTURE VAL R10
  CAPTURE VAL R11
  CAPTURE VAL R21
