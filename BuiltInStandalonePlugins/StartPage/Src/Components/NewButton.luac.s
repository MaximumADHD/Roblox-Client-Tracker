...
PROTO_1:
  ...
  GETUPVAL R10 3
  GETTABLEKS R9 R10 K7 ["Event"]
  GETTABLEKS R8 R9 K8 ["Activated"]
  DUPCLOSURE R9 K9 [PROTO_0]
  CAPTURE UPVAL U4
  SETTABLE R9 R7 R8
  GETUPVAL R10 3
  GETTABLEKS R9 R10 K7 ["Event"]
  GETTABLEKS R8 R9 K10 ["MouseEnter"]
  SETTABLE R3 R7 R8
  GETUPVAL R10 3
  GETTABLEKS R9 R10 K7 ["Event"]
  GETTABLEKS R8 R9 K11 ["MouseLeave"]
  SETTABLE R4 R7 R8
  GETUPVAL R9 3
  GETTABLEKS R8 R9 K12 ["Tag"]
  LOADK R9 K13 ["X-Row X-Middle StartPage-MenuBackground StartPage-ButtonPadding StartPage-RoundedCorner8"]
  SETTABLE R9 R7 R8
  DUPTABLE R8 K16 [{"PlusIcon", "Text"}]
  GETUPVAL R10 3
  ...
  NAMECALL R12 R2 K20 ["getNextOrder"]
  CALL R12 1 1
  SETTABLEKS R12 R11 K21 ["LayoutOrder"]
  GETUPVAL R13 3
  GETTABLEKS R12 R13 K12 ["Tag"]
  LOADK R13 K22 ["X-PadS X-Corner StartPage-ButtonBackgroundColor"]
  ...
  LOADK R17 K23 ["StartPage-PlusIcon X-AnchorCenter"]
  SETTABLE R17 R15 R16
  CALL R13 2 -1
  SETLIST R12 R13 -1 [1]
  CALL R9 3 1
  SETTABLEKS R9 R8 K14 ["PlusIcon"]
  GETUPVAL R10 3
  GETTABLEKS R9 R10 K3 ["createElement"]
  LOADK R10 K24 ["TextLabel"]
  NEWTABLE R11 4 0
  LOADK R14 K25 ["Plugin"]
  LOADK R15 K26 ["NewFile"]
  ...
  GETUPVAL R13 3
  GETTABLEKS R12 R13 K12 ["Tag"]
  LOADK R13 K28 ["X-Fit X-Pad StartPage-NoBackground StartPage-TextSize StartPage-FontBold StartPage-TextColor"]
  SETTABLE R13 R11 R12
  CALL R9 2 1
