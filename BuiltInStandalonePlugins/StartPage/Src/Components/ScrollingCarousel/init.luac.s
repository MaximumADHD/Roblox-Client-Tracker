...
PROTO_8:
  ...
  DUPTABLE R18 K9 [{"key", "Size", "Cell"}]
  SETTABLEKS R12 R18 K6 ["key"]
  GETTABLEKS R19 R0 K10 ["CellSize"]
  SETTABLEKS R19 R18 K7 ["Size"]
  SETTABLEKS R13 R18 K8 ["Cell"]
  CALL R16 2 -1
  ...
  GETTABLEKS R13 R0 K15 ["Position"]
  SETTABLEKS R13 R12 K15 ["Position"]
  GETUPVAL R15 3
  GETTABLEKS R14 R15 K16 ["Change"]
  GETTABLEKS R13 R14 K17 ["AbsoluteSize"]
  NEWCLOSURE R14 P2
  CAPTURE VAL R4
  SETTABLE R14 R12 R13
  GETUPVAL R14 3
  GETTABLEKS R13 R14 K18 ["Tag"]
  LOADK R14 K19 ["X-Transparent"]
  SETTABLE R14 R12 R13
  GETTABLEKS R13 R0 K20 ["LayoutOrder"]
  ...
  GETUPVAL R15 5
  DUPTABLE R16 K23 [{"Size", "Position", "IsArrowRight", "OnClick"}]
  GETIMPORT R17 K25 [UDim2.new]
  LOADN R18 0
  LOADN R19 100
  LOADN R20 0
  GETTABLEKS R23 R0 K10 ["CellSize"]
  GETTABLEKS R22 R23 K26 ["Height"]
  GETTABLEKS R21 R22 K27 ["Offset"]
  CALL R17 4 1
  ...
  LOADB R17 0
  SETTABLEKS R17 R16 K21 ["IsArrowRight"]
  NEWCLOSURE R17 P3
  CAPTURE VAL R9
  SETTABLEKS R17 R16 K22 ["OnClick"]
  CALL R14 2 1
  JUMP [+1]
  LOADNIL R14
  GETUPVAL R16 3
  ...
  NEWTABLE R17 8 0
  LOADN R18 0
  SETTABLEKS R18 R17 K28 ["ScrollBarThickness"]
  GETIMPORT R18 K32 [Enum.FillDirection.Horizontal]
  SETTABLEKS R18 R17 K33 ["Layout"]
  GETIMPORT R18 K36 [Enum.ScrollingDirection.X]
  SETTABLEKS R18 R17 K34 ["ScrollingDirection"]
  SETTABLEKS R5 R17 K37 ["ForwardRef"]
  LOADB R18 1
  SETTABLEKS R18 R17 K38 ["ScrollingEnabled"]
  SETTABLEKS R7 R17 K39 ["OnScrollUpdate"]
  GETUPVAL R19 3
  GETTABLEKS R18 R19 K18 ["Tag"]
  LOADK R19 K40 ["X-Fill X-RowM X-Middle StartPage-PadScrollingCarouselLeft X-Transparent"]
  SETTABLE R19 R17 R18
  MOVE R18 R8
  CALL R15 3 1
  GETTABLEKS R17 R5 K41 ["current"]
  JUMPIFNOT R17 [+51]
  GETTABLEKS R19 R5 K41 ["current"]
  GETTABLEKS R18 R19 K42 ["AbsoluteCanvasSize"]
  GETTABLEKS R20 R6 K35 ["X"]
  ADD R19 R3 R20
  GETTABLEKS R20 R18 K35 ["X"]
  JUMPIFLT R19 R20 [+2]
  LOADB R17 0 +1
  LOADB R17 1
  JUMPIFNOT R17 [+37]
  ...
  GETTABLEKS R16 R17 K4 ["createElement"]
  GETUPVAL R17 5
  DUPTABLE R18 K43 [{"Size", "Position", "OnClick", "IsArrowRight"}]
  GETIMPORT R19 K25 [UDim2.new]
  LOADN R20 0
  LOADN R21 100
  LOADN R22 0
  GETTABLEKS R25 R0 K10 ["CellSize"]
  GETTABLEKS R24 R25 K26 ["Height"]
  GETTABLEKS R23 R24 K27 ["Offset"]
  CALL R19 4 1
  SETTABLEKS R19 R18 K7 ["Size"]
  GETIMPORT R19 K25 [UDim2.new]
  LOADN R20 1
  ...
  NEWCLOSURE R19 P4
  CAPTURE VAL R9
  SETTABLEKS R19 R18 K22 ["OnClick"]
  LOADB R19 1
  SETTABLEKS R19 R18 K21 ["IsArrowRight"]
  CALL R16 2 1
  JUMP [+1]
  LOADNIL R16
  SETLIST R13 R14 3 [1]
