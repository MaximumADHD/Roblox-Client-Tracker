...
PROTO_8:
  ...
  JUMP [+1]
  LOADK R19 K39 ["X-RowM X-Middle StartPage-PadScrollingCarouselLeft X-Transparent"]
  SETTABLE R19 R17 R18
  MOVE R18 R8
  CALL R15 3 1
  GETTABLEKS R17 R5 K40 ["current"]
  JUMPIFNOT R17 [+51]
  GETTABLEKS R19 R5 K40 ["current"]
  GETTABLEKS R18 R19 K41 ["AbsoluteCanvasSize"]
  ...
  GETTABLEKS R16 R17 K4 ["createElement"]
  GETUPVAL R17 5
  DUPTABLE R18 K42 [{"Size", "Position", "OnClick", "IsArrowRight"}]
...
MAIN:
  ...
  GETTABLEKS R8 R7 K16 ["ScrollingFrame"]
  GETIMPORT R9 K18 [game]
  LOADK R11 K19 ["TweenService"]
  NAMECALL R9 R9 K20 ["GetService"]
  CALL R9 2 1
  GETIMPORT R10 K5 [require]
  GETTABLEKS R14 R0 K6 ["Src"]
  GETTABLEKS R13 R14 K21 ["Components"]
  GETTABLEKS R12 R13 K22 ["ScrollingCarousel"]
  GETTABLEKS R11 R12 K23 ["Chevron"]
  CALL R10 1 1
