...
PROTO_7:
  ...
  GETUPVAL R16 4
  GETTABLEKS R15 R16 K5 ["Tag"]
  LOADK R16 K36 ["StartPage-SearchBar StartPage-TextSize StartPage-DisabledTextColor"]
  SETTABLE R16 R14 R15
  CALL R12 2 1
  ...
  LOADK R13 K37 ["X-Fill X-Right X-Middle X-Transparent"]
  ...
  LOADK R17 K38 ["X-Fit X-RowM X-Pad X-Middle X-Transparent"]
  SETTABLE R17 R15 R16
  DUPTABLE R16 K41 [{"Pill", "CancelButton"}]
  GETUPVAL R18 4
  GETTABLEKS R17 R18 K1 ["createElement"]
  GETUPVAL R18 6
  DUPTABLE R19 K42 [{"LayoutOrder", "Text"}]
  MOVE R20 R2
  CALL R20 0 1
  SETTABLEKS R20 R19 K15 ["LayoutOrder"]
  LOADK R22 K19 ["Plugin"]
  LOADK R23 K43 ["TypePill"]
  ...
  CALL R17 2 1
  SETTABLEKS R17 R16 K39 ["Pill"]
  GETTABLEKS R18 R0 K18 ["Text"]
  JUMPIFEQKS R18 K44 [""] [+19]
  GETTABLEKS R18 R0 K45 ["ShouldShowCancel"]
  JUMPIFNOT R18 [+15]
  GETUPVAL R18 4
  GETTABLEKS R17 R18 K1 ["createElement"]
  GETUPVAL R18 7
  DUPTABLE R19 K47 [{"LayoutOrder", "OnActivated"}]
  MOVE R20 R2
  CALL R20 0 1
  SETTABLEKS R20 R19 K15 ["LayoutOrder"]
  GETTABLEKS R20 R0 K48 ["OnCancelled"]
  SETTABLEKS R20 R19 K46 ["OnActivated"]
  CALL R17 2 1
  JUMP [+1]
  LOADNIL R17
  SETTABLEKS R17 R16 K40 ["CancelButton"]
  CALL R13 3 -1
  SETLIST R12 R13 -1 [1]
  CALL R9 3 -1
  SETLIST R7 R8 -1 [1]
...
PROTO_9:
  ...
  LOADK R21 K13 ["X-ColumnS X-Transparent"]
  ...
  LOADK R25 K19 ["X-Middle X-Corner StartPage-Highlight"]
  SETTABLE R25 R23 R24
  NEWTABLE R24 0 1
  GETUPVAL R26 4
  GETTABLEKS R25 R26 K2 ["createElement"]
  LOADK R26 K20 ["TextLabel"]
  NEWTABLE R27 4 0
  LOADK R30 K21 ["Plugin"]
  LOADK R31 K22 ["QuerySearch"]
  DUPTABLE R32 K24 [{"query"}]
  GETTABLEKS R33 R0 K11 ["Query"]
  SETTABLEKS R33 R32 K23 ["query"]
  NAMECALL R28 R1 K25 ["getText"]
  CALL R28 4 1
  SETTABLEKS R28 R27 K26 ["Text"]
  GETIMPORT R28 K30 [Enum.TextTruncate.AtEnd]
  SETTABLEKS R28 R27 K28 ["TextTruncate"]
  GETUPVAL R29 4
  GETTABLEKS R28 R29 K6 ["Tag"]
  LOADK R29 K31 ["X-Fit X-Pad StartPage-Font StartPage-TextSize X-Transparent StartPage-TextColor"]
  ...
  GETUPVAL R25 4
  GETTABLEKS R24 R25 K6 ["Tag"]
  LOADK R25 K7 ["X-Transparent"]
  SETTABLE R25 R23 R24
  NEWTABLE R24 0 1
  GETUPVAL R26 4
  GETTABLEKS R25 R26 K2 ["createElement"]
  GETTABLEKS R26 R0 K33 ["ResultComponent"]
  DUPTABLE R27 K43 [{"Size", "DisplayComponent", "HasParentLoaded", "MaxCount", "Dropdowns", "InitialContentHasLoaded", "CellComponent", "CellSize", "CellPadding", "BaseQuery"}]
  GETUPVAL R29 5
  JUMPIFNOT R29 [+2]
  LOADNIL R28
  JUMP [+7]
  ...
  GETUPVAL R28 6
  SETTABLEKS R28 R27 K34 ["DisplayComponent"]
  GETUPVAL R29 5
  JUMPIFNOT R29 [+2]
  LOADNIL R28
  JUMP [+3]
  GETTABLEKS R29 R0 K44 ["AreSearchResultsLoading"]
  NOT R28 R29
  SETTABLEKS R28 R27 K35 ["HasParentLoaded"]
  LOADN R28 6
  SETTABLEKS R28 R27 K36 ["MaxCount"]
  GETTABLEKS R28 R0 K37 ["Dropdowns"]
  SETTABLEKS R28 R27 K37 ["Dropdowns"]
  NEWCLOSURE R28 P0
  CAPTURE VAL R4
  CAPTURE VAL R6
  CAPTURE VAL R0
  SETTABLEKS R28 R27 K38 ["InitialContentHasLoaded"]
  GETUPVAL R28 7
  SETTABLEKS R28 R27 K39 ["CellComponent"]
  GETIMPORT R28 K10 [UDim2.new]
  LOADN R29 1
  LOADN R30 0
  LOADN R31 0
  LOADN R32 90
  CALL R28 4 1
  SETTABLEKS R28 R27 K40 ["CellSize"]
  GETIMPORT R28 K10 [UDim2.new]
  LOADN R29 0
  LOADN R30 0
  LOADN R31 0
  LOADN R32 0
  CALL R28 4 1
  SETTABLEKS R28 R27 K41 ["CellPadding"]
  GETUPVAL R28 8
  GETTABLEKS R29 R0 K42 ["BaseQuery"]
  DUPTABLE R30 K46 [{"search"}]
  GETTABLEKS R31 R0 K11 ["Query"]
  SETTABLEKS R31 R30 K45 ["search"]
  CALL R28 2 1
  SETTABLEKS R28 R27 K42 ["BaseQuery"]
  CALL R25 2 -1
  SETLIST R24 R25 -1 [1]
  CALL R21 3 1
  JUMP [+1]
  ...
  CALL R24 0 1
  SETTABLEKS R24 R23 K18 ["LayoutOrder"]
  LOADK R26 K21 ["Plugin"]
  LOADK R27 K48 ["SeeAllMatchingExperiences"]
  NAMECALL R24 R1 K25 ["getText"]
  CALL R24 3 1
  SETTABLEKS R24 R23 K26 ["Text"]
  GETUPVAL R26 4
  GETTABLEKS R25 R26 K49 ["Event"]
  GETTABLEKS R24 R25 K50 ["Activated"]
  GETTABLEKS R25 R0 K51 ["MoreExperiencesRequested"]
  SETTABLE R25 R23 R24
  GETUPVAL R26 4
  GETTABLEKS R25 R26 K49 ["Event"]
  GETTABLEKS R24 R25 K52 ["MouseEnter"]
  SETTABLE R7 R23 R24
  GETUPVAL R26 4
  GETTABLEKS R25 R26 K49 ["Event"]
  GETTABLEKS R24 R25 K53 ["MouseLeave"]
  SETTABLE R8 R23 R24
  GETUPVAL R25 4
  GETTABLEKS R24 R25 K6 ["Tag"]
  LOADK R25 K54 ["X-Fit X-Pad X-Transparent StartPage-Font StartPage-LinkTextColor StartPage-TextSize"]
  SETTABLE R25 R23 R24
  CALL R21 2 1
...
PROTO_21:
  ...
  LOADK R23 K26 ["X-Fill X-Transparent"]
...
MAIN:
  ...
  GETTABLEKS R7 R3 K15 ["useContext"]
  ...
  GETTABLEKS R25 R23 K37 ["StudioService"]
  ...
  GETTABLEKS R29 R30 K39 ["Network"]
  GETTABLEKS R28 R29 K40 ["DiscoverCreatorEligibilityAndOpenPlace"]
  CALL R27 1 1
  JUMP [+9]
  GETIMPORT R27 K5 [require]
  GETTABLEKS R30 R0 K6 ["Src"]
  GETTABLEKS R29 R30 K41 ["DEPRECATED_Network"]
  GETTABLEKS R28 R29 K40 ["DiscoverCreatorEligibilityAndOpenPlace"]
  CALL R27 1 1
