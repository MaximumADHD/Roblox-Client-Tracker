PROTO_0:
  ...
  MOVE R1 R2
  RETURN R1 1
  GETTABLEKS R1 R0 K5 ["eligibilityByCreator"]
  JUMPIFNOT R1 [+38]
  ...
  LOADK R3 K6 ["\"eligibilityByCreator\" > Expected table, got %*"]
  FASTCALL1 TYPEOF R1 [+3]
  MOVE R6 R1
  ...
  CALL R7 1 1
  JUMPIFNOT R7 [+8]
  LOADK R9 K8 ["\"eligibilityByCreator\" > [%*] > %*"]
  MOVE R11 R5
  MOVE R12 R7
...
MAIN:
  ...
  GETTABLEKS R2 R3 K8 ["CreatorEligibility"]
  CALL R1 1 1
