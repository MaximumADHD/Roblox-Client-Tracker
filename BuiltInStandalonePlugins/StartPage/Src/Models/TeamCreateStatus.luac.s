PROTO_0:
  ...
  MOVE R1 R2
  RETURN R1 1
  GETTABLEKS R1 R0 K8 ["isEnabled"]
  JUMPIFNOT R1 [+20]
  GETTABLEKS R2 R0 K8 ["isEnabled"]
  FASTCALL1 TYPEOF R2 [+2]
  GETIMPORT R1 K1 [typeof]
  CALL R1 1 1
  JUMPIFEQKS R1 K9 ["boolean"] [+13]
  LOADK R2 K10 ["\"isEnabled\" > Expected boolean, got %*"]
  GETTABLEKS R5 R0 K8 ["isEnabled"]
  FASTCALL1 TYPEOF R5 [+2]
  GETIMPORT R4 K1 [typeof]
  CALL R4 1 1
  NAMECALL R2 R2 K4 ["format"]
