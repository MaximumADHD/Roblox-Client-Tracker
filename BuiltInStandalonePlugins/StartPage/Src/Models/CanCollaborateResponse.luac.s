PROTO_0:
       ...
       10 CALL                             R6 1 1
       11 JUMPIFEQKS                       R6 K3 ["boolean"] ; [+112]
       ...
       27 JUMPIFEQKNIL                     R5 ; [+96]
       29 FASTCALL1                        TYPEOF R5 ; [+3]
       30 MOVE                             R7 R5
       31 GETIMPORT                        R6 K2 [typeof]
       33 CALL                             R6 1 1
       34 JUMPIFEQKS                       R6 K7 ["string"] ; [+89]
       ...
       50 JUMPIFEQKNIL                     R5 ; [+73]
       52 FASTCALL1                        TYPEOF R5 ; [+3]
       53 MOVE                             R7 R5
       54 GETIMPORT                        R6 K2 [typeof]
       56 CALL                             R6 1 1
       57 JUMPIFEQKS                       R6 K10 ["number"] ; [+66]
       ...
       73 JUMPIFEQKNIL                     R5 ; [+50]
       75 FASTCALL1                        TYPEOF R5 ; [+3]
       76 MOVE                             R7 R5
       77 GETIMPORT                        R6 K2 [typeof]
       79 CALL                             R6 1 1
       80 JUMPIFEQKS                       R6 K13 ["table"] ; [+43]
       ...
       92 RETURN                           R6 1
       93 JUMP                             ; [+30]
       94 JUMPIFNOTEQKS                    R4 K15 ["UniverseId"] ; [+22]
       96 JUMPIFEQKNIL                     R5 ; [+27]
       98 FASTCALL1                        TYPEOF R5 ; [+3]
       99 MOVE                             R7 R5
      100 GETIMPORT                        R6 K2 [typeof]
      102 CALL                             R6 1 1
      103 JUMPIFEQKS                       R6 K10 ["number"] ; [+20]
      ...
      115 RETURN                           R6 1
      116 JUMP                             ; [+7]
      117 LOADK                            R7 K17 ["\"responseBody\" > Unexpected key \"%*\""]
      118 MOVE                             R9 R4
      119 NAMECALL                         R7 R7 K5 ["format"]
      121 CALL                             R7 2 1
      122 MOVE                             R6 R7
      123 RETURN                           R6 1
      124 FORGLOOP                         R1 2 ; [-121]
      126 LOADNIL                          R1
      127 RETURN                           R1 1
