PROTO_0:
       ...
       53 RETURN                           R8 1
       54 FORGLOOP                         R2 2 ; [-14]
       56 GETTABLEKS                       R2 R0 K9 ["totalResults"]
       58 JUMPIFNOT                        R2 ; [+19]
       59 GETTABLEKS                       R3 R0 K9 ["totalResults"]
       61 FASTCALL1                        TYPEOF R3 ; [+2]
       62 GETIMPORT                        R2 K1 [typeof]
       64 CALL                             R2 1 1
       65 JUMPIFEQKS                       R2 K10 ["number"] ; [+12]
       67 LOADK                            R2 K11 ["\"totalResults\" > Expected number, got %*"]
       68 GETTABLEKS                       R5 R0 K9 ["totalResults"]
       70 FASTCALL1                        TYPEOF R5 ; [+2]
       71 GETIMPORT                        R4 K1 [typeof]
       73 CALL                             R4 1 1
       74 NAMECALL                         R2 R2 K4 ["format"]
       76 CALL                             R2 2 1
       77 RETURN                           R2 1
       78 LOADNIL                          R2
       79 RETURN                           R2 1
