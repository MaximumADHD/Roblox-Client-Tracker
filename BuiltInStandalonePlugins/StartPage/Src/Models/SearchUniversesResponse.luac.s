PROTO_0:
  ...
  RETURN R8 1
  FORGLOOP R2 2 [-15]
  GETTABLEKS R2 R0 K9 ["totalResults"]
  JUMPIFNOT R2 [+20]
  GETTABLEKS R3 R0 K9 ["totalResults"]
  FASTCALL1 TYPEOF R3 [+2]
  GETIMPORT R2 K1 [typeof]
  CALL R2 1 1
  JUMPIFEQKS R2 K10 ["number"] [+13]
  LOADK R3 K11 ["\"totalResults\" > Expected number, got %*"]
  GETTABLEKS R6 R0 K9 ["totalResults"]
