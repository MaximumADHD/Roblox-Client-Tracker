...
PROTO_1:
        0 GETUPVAL                         R1 0
        1 GETUPVAL                         R2 1
        2 GETTABLEKS                       R2 R2 K0 ["DisplaySettings"]
        4 CALL                             R1 1 1
        5 GETTABLE                         R3 R1 R0
        6 NOT                              R2 R3
        7 SETTABLE                         R2 R1 R0
        8 GETUPVAL                         R2 1
        9 GETTABLEKS                       R2 R2 K1 ["SetDisplaySettings"]
       11 JUMPIFNOT                        R2 ; [+5]
       12 GETUPVAL                         R2 1
       13 GETTABLEKS                       R2 R2 K1 ["SetDisplaySettings"]
       15 MOVE                             R3 R1
       16 CALL                             R2 1 0
       17 RETURN                           R0 0
...
PROTO_3:
       ...
       20 GETUPVAL                         R6 5
       21 GETTABLEKS                       R6 R6 K9 ["DisplaySettings"]
...
PROTO_5:
        ...
        6 GETTABLEKS                       R3 R3 K2 ["Consumer"]
        8 CALL                             R2 1 1
        9 GETUPVAL                         R4 1
       10 GETTABLEKS                       R4 R4 K3 ["Localization"]
       ...
       46 CAPTURE                          VAL R5
       47 GETUPVAL                         R8 4
       48 GETTABLEKS                       R8 R8 K7 ["createElement"]
       50 GETUPVAL                         R9 5
      ...
      103 GETUPVAL                         R11 4
      104 GETTABLEKS                       R11 R11 K27 ["Tag"]
      106 LOADK                            R12 K28 ["TopButton"]
      107 SETTABLE                         R12 R10 R11
      108 GETUPVAL                         R11 4
      109 GETTABLEKS                       R11 R11 K29 ["Event"]
      111 GETTABLEKS                       R11 R11 K30 ["Activated"]
      ...
      130 CALL                             R8 1 0
      131 GETTABLEKS                       R8 R0 K0 ["DataHook"]
      133 GETTABLEKS                       R8 R8 K36 ["instanceType"]
      ...
      158 GETUPVAL                         R11 4
      159 GETTABLEKS                       R11 R11 K27 ["Tag"]
...
MAIN:
       ...
       33 GETTABLEKS                       R8 R5 K13 ["UI"]
       35 GETTABLEKS                       R8 R8 K15 ["Checkbox"]
       37 GETTABLEKS                       R9 R5 K16 ["Util"]
       39 GETTABLEKS                       R9 R9 K17 ["LayoutOrderIterator"]
       41 GETTABLEKS                       R10 R9 K18 ["new"]
       43 CALL                             R10 0 1
       44 GETIMPORT                        R11 K6 [require]
       46 GETTABLEKS                       R12 R1 K7 ["Packages"]
       48 GETTABLEKS                       R12 R12 K19 ["Dash"]
       50 CALL                             R11 1 1
       51 GETTABLEKS                       R12 R11 K20 ["copy"]
       53 GETIMPORT                        R13 K6 [require]
       55 GETTABLEKS                       R14 R1 K21 ["Src"]
       57 GETTABLEKS                       R14 R14 K22 ["Types"]
       59 CALL                             R13 1 1
