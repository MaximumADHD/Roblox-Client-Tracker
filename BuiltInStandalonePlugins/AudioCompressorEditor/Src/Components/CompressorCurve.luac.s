...
PROTO_1:
        ...
        1 GETUPVAL                         R3 1
        2 GETUPVAL                         R4 2
        3 GETTABLEKS                       R4 R4 K0 ["plotToAbs"]
        5 MOVE                             R5 R0
        6 GETUPVAL                         R6 3
        7 GETTABLEKS                       R6 R6 K1 ["PlotAbsoluteSize"]
        9 CALL                             R4 2 -1
       10 CALL                             R3 -1 -1
...
PROTO_2:
        ...
        9 LOADN                            R3 0
       10 GETUPVAL                         R4 2
       11 GETTABLEKS                       R4 R4 K3 ["DataHook"]
       ...
       23 GETUPVAL                         R6 0
       24 GETUPVAL                         R7 1
       25 GETTABLEKS                       R7 R7 K5 ["plotToAbs"]
       27 MOVE                             R8 R3
       28 GETUPVAL                         R9 2
       29 GETTABLEKS                       R9 R9 K6 ["PlotAbsoluteSize"]
       31 CALL                             R7 2 -1
       32 CALL                             R6 -1 -1
       ...
       39 GETUPVAL                         R5 2
       40 GETTABLEKS                       R5 R5 K3 ["DataHook"]
       42 GETTABLEKS                       R5 R5 K10 ["threshold"]
       44 GETUPVAL                         R6 2
       45 GETTABLEKS                       R6 R6 K3 ["DataHook"]
       47 GETTABLEKS                       R6 R6 K10 ["threshold"]
       49 CALL                             R4 2 1
       50 ADD                              R3 R4 R2
       51 MOVE                             R5 R0
       52 GETUPVAL                         R6 0
       53 GETUPVAL                         R7 1
       54 GETTABLEKS                       R7 R7 K5 ["plotToAbs"]
       56 MOVE                             R8 R3
       57 GETUPVAL                         R9 2
       58 GETTABLEKS                       R9 R9 K6 ["PlotAbsoluteSize"]
       60 CALL                             R7 2 -1
       61 CALL                             R6 -1 -1
       ...
       68 GETUPVAL                         R6 2
       69 GETTABLEKS                       R6 R6 K3 ["DataHook"]
       71 GETTABLEKS                       R6 R6 K10 ["threshold"]
       73 GETUPVAL                         R7 2
       74 GETTABLEKS                       R7 R7 K3 ["DataHook"]
       76 GETTABLEKS                       R7 R7 K10 ["threshold"]
       78 CALL                             R5 2 1
       79 ADD                              R4 R5 R2
      ...
      103 GETUPVAL                         R6 0
      104 GETUPVAL                         R7 1
      105 GETTABLEKS                       R7 R7 K5 ["plotToAbs"]
      107 MOVE                             R8 R3
      108 GETUPVAL                         R9 2
      109 GETTABLEKS                       R9 R9 K6 ["PlotAbsoluteSize"]
      111 CALL                             R7 2 -1
      112 CALL                             R6 -1 -1
...
MAIN:
       ...
       38 GETTABLEKS                       R7 R7 K14 ["PlotUtil"]
       40 CALL                             R6 1 1
