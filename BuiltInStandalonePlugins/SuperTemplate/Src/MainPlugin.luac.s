...
MAIN:
  ...
  CALL R18 1 1
  GETTABLEKS R19 R18 K35 ["getFFlagEnableRibbonPlugin"]
  CALL R19 0 1
  GETTABLEKS R20 R18 K36 ["getFFlagRegisterActionsPluginLoader"]
  CALL R20 0 1
  AND R21 R20 R19
  ...
  CALL R22 2 1
  GETTABLEKS R23 R12 K40 ["fromAction"]
  LOADK R24 K2 ["SuperTemplate"]
  LOADK R25 K41 ["Toggle"]
  CALL R23 2 1
  DUPCLOSURE R24 K42 [PROTO_12]
  CAPTURE VAL R21
  CAPTURE VAL R23
  CAPTURE VAL R7
  CAPTURE VAL R14
  ...
  CAPTURE VAL R3
  CAPTURE VAL R13
  SETTABLEKS R24 R22 K43 ["init"]
  DUPCLOSURE R24 K44 [PROTO_13]
  CAPTURE VAL R21
  SETTABLEKS R24 R22 K45 ["didUpdate"]
