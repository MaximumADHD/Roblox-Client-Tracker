...
PROTO_2:
        ...
        3 CALL                             R0 0 1
        4 GETUPVAL                         R3 1
        5 LOADK                            R5 K1 ["ConstraintScaleUpdated"]
        6 NEWCLOSURE                       R6 P0
        7 CAPTURE                          UPVAL U2
...
PROTO_3:
        0 GETUPVAL                         R0 0
        1 LOADK                            R2 K0 ["RequestConstraintScaleUpdate"]
...
PROTO_4:
        ...
        1 JUMPIFNOT                        R0 ; [+6]
        2 GETUPVAL                         R0 1
        3 LOADK                            R2 K0 ["SetConstraintScale"]
        4 GETUPVAL                         R3 0
...
PROTO_5:
       ...
       17 CALL                             R3 2 0
       18 GETUPVAL                         R4 0
       19 GETTABLEKS                       R3 R4 K1 ["useEffect"]
       21 NEWCLOSURE                       R4 P1
       22 CAPTURE                          VAL R0
       23 NEWTABLE                         R5 0 0
       25 CALL                             R3 2 0
       26 GETUPVAL                         R4 0
       27 GETTABLEKS                       R3 R4 K1 ["useEffect"]
       29 NEWCLOSURE                       R4 P2
       30 CAPTURE                          VAL R1
       31 CAPTURE                          VAL R0
       32 NEWTABLE                         R5 0 1
