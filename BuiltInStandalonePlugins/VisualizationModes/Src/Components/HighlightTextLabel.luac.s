...
PROTO_3:
  ...
  JUMPIFNOT R4 [+18]
  ADDK R6 R6 K2 [1]
  LOADK R15 K3 ["Highlight"]
  MOVE R16 R6
  CONCAT R14 R15 R16
  GETUPVAL R16 1
  GETTABLEKS R15 R16 K4 ["createElement"]
  GETUPVAL R16 2
  DUPTABLE R17 K7 [{"Text", "StartIndex", "FinishIndex"}]
  SETTABLEKS R1 R17 K1 ["Text"]
  SETTABLEKS R7 R17 K5 ["StartIndex"]
  SETTABLEKS R8 R17 K6 ["FinishIndex"]
  CALL R15 2 1
  SETTABLE R15 R5 R14
  JUMP [+17]
  MOVE R15 R3
  ...
  GETUPVAL R17 2
  DUPTABLE R18 K7 [{"Text", "StartIndex", "FinishIndex"}]
  SETTABLEKS R1 R18 K1 ["Text"]
  SETTABLEKS R7 R18 K5 ["StartIndex"]
  SETTABLEKS R8 R18 K6 ["FinishIndex"]
  CALL R16 2 -1
  ...
  JUMPIFNOT R4 [+18]
  ADDK R6 R6 K2 [1]
  LOADK R10 K3 ["Highlight"]
  MOVE R11 R6
  CONCAT R9 R10 R11
  GETUPVAL R11 1
  GETTABLEKS R10 R11 K4 ["createElement"]
  GETUPVAL R11 2
  DUPTABLE R12 K7 [{"Text", "StartIndex", "FinishIndex"}]
  SETTABLEKS R1 R12 K1 ["Text"]
  SETTABLEKS R7 R12 K5 ["StartIndex"]
  SETTABLEKS R8 R12 K6 ["FinishIndex"]
  CALL R10 2 1
  SETTABLE R10 R5 R9
  JUMP [+17]
  MOVE R10 R3
  ...
  GETUPVAL R12 2
  DUPTABLE R13 K7 [{"Text", "StartIndex", "FinishIndex"}]
  SETTABLEKS R1 R13 K1 ["Text"]
  SETTABLEKS R7 R13 K5 ["StartIndex"]
  SETTABLEKS R8 R13 K6 ["FinishIndex"]
  CALL R11 2 -1
  FASTCALL TABLE_INSERT [+2]
  ...
  GETUPVAL R11 1
  GETTABLEKS R10 R11 K11 ["Fragment"]
  NEWTABLE R11 0 0
  MOVE R12 R5
  CALL R9 3 -1
  RETURN R9 -1
...
MAIN:
  ...
  GETTABLEKS R6 R7 K16 ["getFFlagStudioVisualizationModesTestWarningsFix"]
  CALL R5 1 1
