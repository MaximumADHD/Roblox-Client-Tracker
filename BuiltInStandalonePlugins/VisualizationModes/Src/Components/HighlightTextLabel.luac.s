...
PROTO_3:
  ...
  JUMPIFEQKNIL R6 [+20]
  ADDK R4 R4 K2 [1]
  LOADK R13 K3 ["Highlight"]
  MOVE R14 R4
  CONCAT R12 R13 R14
  GETUPVAL R14 0
  GETTABLEKS R13 R14 K4 ["createElement"]
  GETUPVAL R14 1
  DUPTABLE R15 K7 [{"Text", "StartIndex", "FinishIndex"}]
  SETTABLEKS R1 R15 K1 ["Text"]
  SETTABLEKS R5 R15 K5 ["StartIndex"]
  SETTABLEKS R6 R15 K6 ["FinishIndex"]
  CALL R13 2 1
  SETTABLE R13 R3 R12
  MOVE R5 R11
  MOVE R6 R11
  ...
  JUMPIFEQKNIL R6 [+18]
  ADDK R4 R4 K2 [1]
  LOADK R8 K3 ["Highlight"]
  MOVE R9 R4
  CONCAT R7 R8 R9
  GETUPVAL R9 0
  GETTABLEKS R8 R9 K4 ["createElement"]
  GETUPVAL R9 1
  DUPTABLE R10 K7 [{"Text", "StartIndex", "FinishIndex"}]
  SETTABLEKS R1 R10 K1 ["Text"]
  SETTABLEKS R5 R10 K5 ["StartIndex"]
  SETTABLEKS R6 R10 K6 ["FinishIndex"]
  CALL R8 2 1
  SETTABLE R8 R3 R7
  GETUPVAL R8 0
