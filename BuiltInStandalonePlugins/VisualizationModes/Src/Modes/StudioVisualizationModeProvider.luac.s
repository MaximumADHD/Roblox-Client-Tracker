...
PROTO_1:
       ...
       21 CALL                             R2 1 0
       22 GETUPVAL                         R2 4
       23 GETTABLEKS                       R2 R2 K6 ["createRoot"]
       ...
       39 GETUPVAL                         R4 5
       40 GETTABLEKS                       R4 R4 K12 ["provide"]
       42 NEWTABLE                         R5 0 2
       44 GETTABLEKS                       R6 R1 K4 ["_localization"]
       46 GETUPVAL                         R7 5
       47 GETTABLEKS                       R7 R7 K13 ["Plugin"]
       49 GETTABLEKS                       R7 R7 K2 ["new"]
       51 MOVE                             R8 R0
       52 CALL                             R7 1 -1
       53 SETLIST                          R5 R6 -1 [1]
       55 DUPTABLE                         R6 K15 [{"StudioVisualizationModes"}]
       56 GETUPVAL                         R7 4
       57 GETTABLEKS                       R7 R7 K16 ["createPortal"]
       59 GETUPVAL                         R8 6
       60 GETTABLEKS                       R8 R8 K17 ["createElement"]
       62 GETUPVAL                         R9 7
       63 GETTABLEKS                       R9 R9 K18 ["Provider"]
       ...
       72 NEWTABLE                         R11 0 1
       74 GETUPVAL                         R12 6
       75 GETTABLEKS                       R12 R12 K17 ["createElement"]
       77 GETUPVAL                         R13 8
       78 GETUPVAL                         R15 9
       79 CALL                             R15 0 1
       80 JUMPIFNOT                        R15 ; [+2]
...
MAIN:
       ...
       19 GETTABLEKS                       R3 R3 K12 ["Localization"]
       21 GETTABLEKS                       R3 R3 K13 ["createLocalization"]
       23 CALL                             R2 1 1
       24 GETIMPORT                        R3 K9 [require]
       26 GETTABLEKS                       R4 R0 K14 ["Packages"]
       28 GETTABLEKS                       R4 R4 K15 ["Framework"]
       30 CALL                             R3 1 1
       31 GETIMPORT                        R4 K9 [require]
       33 GETTABLEKS                       R5 R0 K10 ["Src"]
       35 GETTABLEKS                       R5 R5 K16 ["Util"]
       37 GETTABLEKS                       R5 R5 K17 ["Maid"]
       39 CALL                             R4 1 1
       40 GETIMPORT                        R5 K9 [require]
       42 GETTABLEKS                       R6 R0 K14 ["Packages"]
       44 GETTABLEKS                       R6 R6 K18 ["React"]
       46 CALL                             R5 1 1
       47 GETIMPORT                        R6 K9 [require]
       49 GETTABLEKS                       R7 R0 K14 ["Packages"]
       51 GETTABLEKS                       R7 R7 K19 ["ReactRoblox"]
       53 CALL                             R6 1 1
       54 GETIMPORT                        R7 K9 [require]
       56 GETTABLEKS                       R8 R0 K10 ["Src"]
       58 GETTABLEKS                       R8 R8 K20 ["Modes"]
       60 GETTABLEKS                       R8 R8 K21 ["StudioVisualizationModes"]
       62 CALL                             R7 1 1
       63 GETIMPORT                        R8 K9 [require]
       65 GETTABLEKS                       R9 R0 K10 ["Src"]
       67 GETTABLEKS                       R9 R9 K22 ["Flags"]
       69 GETTABLEKS                       R9 R9 K23 ["getFFlagStudioVisualizationModesTestSupport"]
       71 CALL                             R8 1 1
       72 GETIMPORT                        R9 K9 [require]
       74 GETTABLEKS                       R10 R0 K10 ["Src"]
       76 GETTABLEKS                       R10 R10 K24 ["Contexts"]
       78 GETTABLEKS                       R10 R10 K25 ["ActionsContext"]
       80 CALL                             R9 1 1
