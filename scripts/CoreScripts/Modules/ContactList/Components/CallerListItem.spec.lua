return function()
	...
	local function createCallerListItem(callerId, status, localUserId, endUtc, startUtc)
	...
	it("should mount and unmount without errors", function()
		local element = createCallerListItem(
			2,
			"CallMissed",
			1,
	...
	describe("CallerListItem - dynamic timestamp formatting", function()
		...
		it("should display correct timestamp string for current day", function()
			...
			local element = createCallerListItem(2, "CallFinished", 2, currentTimeUtc, currentTimeUtc - 100000)
			local folder = Instance.new("Folder")
			local instance = Roact.mount(element, folder)
			local statusElement: TextLabel = folder:FindFirstChild("DetailsText", true) :: TextLabel
		...
		it("should display correct timestamp string for the previous day", function()
			...
			local element = createCallerListItem(2, "CallFinished", 2, previousDayUtc, previousDayUtc - 100000)
			local folder = Instance.new("Folder")
			local instance = Roact.mount(element, folder)
			local statusElement: TextLabel = folder:FindFirstChild("DetailsText", true) :: TextLabel
		...
		it("should display correct timestamp string for within a week", function()
			...
			local element = createCallerListItem(2, "CallFinished", 2, withinWeekUtc, withinWeekUtc - 100000)
			local folder = Instance.new("Folder")
			local instance = Roact.mount(element, folder)
			local statusElement: TextLabel = folder:FindFirstChild("DetailsText", true) :: TextLabel
		...
		it("should display correct timestamp string for more than a week", function()
			...
			local element = createCallerListItem(2, "CallFinished", 2, moreThanYearUtc, moreThanYearUtc - 100000)
			local folder = Instance.new("Folder")
			local instance = Roact.mount(element, folder)
			local statusElement: TextLabel = folder:FindFirstChild("DetailsText", true) :: TextLabel
