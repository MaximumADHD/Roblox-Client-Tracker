...
return{
	...
	["Common.AssetTypes.Label.Game"] = [[Juego]],
	...
	["Common.AssetTypes.Label.HatAccessories"] = [[Accesorios para el sombrero]],
...
Certifico que soy mayor de 18 años y que soy el progenitor o tutor del propietario de la cuenta. Autorizo esta compra y acepto los Términos de uso.]],
	["CoreScripts.PurchasePrompt.PurchaseDetails.ScaryModalTwo"] = [[Ya has gastado mucho dinero en Roblox este mes. ¿Seguro que quieres continuar? Esta compra requiere el intercambio de moneda real. Debe ser el progenitor o tutor del propietario quien autorice esta transacción.]],
	...
	["CoreScripts.PurchasePrompt.PurchaseFailed.NotForSaleHere"] = [[El objeto no se puede vender en este juego. No se te ha cobrado.]],
