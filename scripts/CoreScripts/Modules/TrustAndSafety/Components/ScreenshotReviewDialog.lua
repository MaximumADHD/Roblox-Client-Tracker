...
local function ScreenshotReviewDialog(props: Props)
	...
	return React.createElement("TextButton", {
		...
		Container = React.createElement("Frame", {
			Size = if props.viewportHeight >= 800 then UDim2.new(0, 800, 0, 800) else UDim2.new(0, 800, 1, 0),
				...
				HeaderAndContent = React.createElement("Frame", {
					...
					ScreenshotBody = React.createElement("Frame", {
						...
						Description = React.createElement("TextLabel", {
							Text = "If the problem is not in this scene, you can “Retake” the screenshot,\nor “Describe Scene” instead.",
