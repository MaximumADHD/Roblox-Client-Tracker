return function()
    ...
    describe("LanguageSelectionEntryMount", function()
        it("should create and destroy without errors", function()
            local languageSelectionEntry = Roact.createElement(LanguageSelectionEntry, {
                LayoutOrder = 2,
                ButtonRef = nil,
                canOpen = nil,
                canCaptureFocus = nil,
                ...
                ThemeProvider = Roact.createElement(UIBlox.Core.Style.Provider, {
                    ...
                    LocalizationProvider = Roact.createElement(LocalizationProvider, {
                        ...
                        FocusHandlerContextProvider = Roact.createElement(FocusHandlerContextProvider, {}, {
                            LanguageSelectionEntry = languageSelectionEntry,
                        }),
                    }),
                }),
            })
