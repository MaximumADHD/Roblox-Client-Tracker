...
function AssetDetailBottomBar:renderWithProviders(stylePalette, localized, getSelectionCursor)
	...
	return Roact.createElement("Frame", {
		...
		GradientFrame = Roact.createElement("Frame", {
			...
			Position = UDim2.new(0, 0, 0, -BOTTOM_BAR_GRADIENT_SIZE),
			BackgroundColor3 = theme.BackgroundDefault.Color,
			BorderSizePixel = 0,
		}, {
		...
		ActionBar = Roact.createElement(ActionBar, {
			button = {
				props = {
					layoutOrder = 3,
					size = UDim2.new(0, BUTTON_WIDTH, 0, IBConstants.BUTTON_HEIGHT),
					text = text,
					icon = icon,
			...
			icons = {
				{
					props = {
						...
						onActivated = function()
							--TODO: AVBURST-8603 Create Context Menu and Open it
						end,
					},
				},
				{
