...
local FFlagFacialAnimationShowInfoMessageWhenNoDynamicHead = true
local FFlagUseLoadStreamAnimationForClone = true
local FFlagSelfViewFixCloneOrientation = true
local FFlagSelfViewMakeClonePartsNonTransparent = true
local FFlagSelfViewCleanupImprovements = true
local FFlagSelfViewDontHideOnSwapCharacter = true
local FFlagSelfViewCleanupOnClosing = true
...
local function syncTrack(animator, track)
	...
	elseif track.Animation:IsA("TrackerStreamAnimation") then
		if
			FFlagUseLoadStreamAnimationForClone and EngineFeatureHasFeatureLoadStreamAnimationForSelfieViewApiEnabled
		then
