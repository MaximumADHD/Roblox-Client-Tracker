...
local function ConnectAvatarEditorServiceEvents(store)
	...
	table.insert(
		connections,
		AvatarEditorService.OpenPromptSaveAvatar:Connect(function(humanoidDescription, rigType)
	...
	table.insert(
		connections,
		AvatarEditorService.OpenAllowInventoryReadAccess:Connect(function()
	...
	table.insert(
		connections,
		AvatarEditorService.OpenPromptCreateOufit:Connect(function(humanoidDescription, rigType)
	...
	table.insert(
		connections,
		AvatarEditorService.OpenPromptSetFavorite:Connect(function(itemId, itemType, isFavorited)
	...
	table.insert(
		connections,
		AvatarEditorService.OpenPromptDeleteOutfit:Connect(function(outfitId)
	...
	table.insert(
		connections,
		AvatarEditorService.OpenPromptRenameOutfit:Connect(function(outfitId)
	...
	table.insert(
		connections,
		AvatarEditorService.OpenPromptUpdateOutfit:Connect(function(outfitId, humanoidDescription, rigType)
