...
return {
	...
	},
	{
		...
		Values = {
			...
			["id"] = "Pesan teks akan diterjemahkan ke bahasa yang diatur di Pengaturan. Ketuk simbol di depan pesan untuk melihat pesan dalam bahasa orisinal. Kamu dapat mematikan penerjemahan di menu Pengaturan.",
			["ja"] = "文章のチャットが設定言語に翻訳されます。メッセージの前にあるシンボルをタップすると、原文が見えます。設定メニューで翻訳をオフにできます。",
			["ko"] = "채팅이 사용자의 언어로 번역됩니다. 메시지 앞의 기호를 탭하면 이를 원래 언어로 확인할 수 있습니다. 설정 메뉴에서 번역 기능을 끌 수 있습니다.",
