...
return {
    ...
    },
    {
        ...
        Values = {
            ...
            ["ja"] = "この体験はチャットバージョン [{RBX_NUMBER}.{RBX_NUMBER}] を実行しています。",
    ...
    },
    {
        ...
        Values = {
            ...
            ["es"] = "Tu amigo(a) {RBX_NAME} se unió a la experiencia.",
            ["es-es"] = "Tu amigo(a) {RBX_NAME} se unió a la experiencia.",
            ["fr"] = "Ton ami(e) {RBX_NAME} a rejoint l'expérience.",
            ["it"] = "Il tuo amico {RBX_NAME} è entrato nell'esperienza.",
            ["ja"] = "あなたの友人、{RBX_NAME} さんが体験に参加しました。",
            ["ko"] = "친구 {RBX_NAME}님이 체험에 참가했어요.",
