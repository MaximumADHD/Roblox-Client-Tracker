...
local PageContainerSinglePane = Roact.PureComponent:extend("PageContainerSinglePane")
PageContainerSinglePane.validateProps = t.strictInterface({
	currentPage = t.string,
	visible = t.boolean,
})

function PageContainerSinglePane:init(props)
...
function PageContainerSinglePane:render()
	local pageElements = {}
...
function PageContainerSinglePane:didUpdate(oldProps, oldState)
