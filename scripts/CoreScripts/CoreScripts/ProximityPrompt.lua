...
local UpdateProximityPromptXboxButtonImages = require(RobloxGui.Modules.Flags.FFlagUpdateProximityPromptXboxButtonImages)
...
if UpdateProximityPromptXboxButtonImages then
	GamepadButtonImage = {
		[Enum.KeyCode.ButtonX] = "rbxasset://textures/ui/Controls/xboxX.png",
		[Enum.KeyCode.ButtonY] = "rbxasset://textures/ui/Controls/xboxY.png",
		[Enum.KeyCode.ButtonA] = "rbxasset://textures/ui/Controls/xboxA.png",
