...
local GetFFlagBatchVoiceParticipantsUpdates = if FFlagRemoveScriptRefAsReturnInVoiceChatCore then VoiceChatCore.Flags.GetFFlagBatchVoiceParticipantsUpdates else require(VoiceChatCore.Flags.GetFFlagBatchVoiceParticipantsUpdates)
