...
void main()
{
    ...
    float f39 = f29.z;
    vec3 f40 = -CB0[16].xyz;
    float f41 = dot(f18, f40) * ((1.0 - ((step(f38.x, f39) * clamp(CB0[29].z + (CB0[29].w * abs(f39 - 0.5)), 0.0, 1.0)) * f38.y)) * f36.y);
