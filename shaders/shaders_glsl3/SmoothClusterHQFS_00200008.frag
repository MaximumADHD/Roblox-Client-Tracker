...
void main()
{
    ...
    float f78 = f72.y;
    float f79 = f72.z;
    vec3 f80 = (((((((f29.xyz * (f29.w * 120.0)) * 1.0) + (((vec3(1.0) - (f59 * f21)) * CB0[15].xyz) * f52)) + ((vec3(1.0) - (f69 * f21)) * (((((((CB0[40].xyz * f74) + (CB0[42].xyz * f75)) + (CB0[44].xyz * f76)) + (CB0[41].xyz * f77)) + (CB0[43].xyz * f78)) + (CB0[45].xyz * f79)) + (((((((CB0[34].xyz * f74) + (CB0[36].xyz * f75)) + (CB0[38].xyz * f76)) + (CB0[35].xyz * f77)) + (CB0[37].xyz * f78)) + (CB0[39].xyz * f79)) * f31)))) + ((CB0[32].xyz + (CB0[33].xyz * (f31 * (2.0 - CB0[14].w)))) * 1.0)) + vec3((f5.z * 2.0) * f15)) * (f13 * f13)) + (((((f59 * (min((f60 + (f60 * f60)) / (((f61 * f61) * ((f55 * 3.0) + 0.5)) * ((f54 * 0.75) + 0.25)), 65504.0) * f52)) * CB0[15].xyz) * (CB0[14].w * CB0[14].w)) * (f15 * VARYING0.w)) + ((mix(f65, textureLod(PrefilteredEnvTexture, f63, f62).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f22.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f31)) * f69) * f21));
    vec4 f81 = vec4(0.0);
    f81.x = f80.x;
    vec4 f82 = f81;
    f82.y = f80.y;
