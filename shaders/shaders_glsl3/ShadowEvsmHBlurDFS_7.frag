...
void main()
{
    ...
    float f3 = -CB1[1].w;
    float f4 = -exp(f3 * f1);
    float f5 = (2.0 * texture(EvsmTexture0Texture, (CB1[1].xy * vec2(-3.0, 0.0)) + VARYING0).x) - 1.0;
    float f6 = (2.0 * (((CB1[2].y / (f5 - CB1[2].x)) * CB1[2].z) + (f5 * CB1[2].w))) - 1.0;
    float f7 = exp(CB1[1].z * f6);
    float f8 = -exp(f3 * f6);
    float f9 = (2.0 * texture(EvsmTexture0Texture, (CB1[1].xy * vec2(-2.0, 0.0)) + VARYING0).x) - 1.0;
    float f10 = (2.0 * (((CB1[2].y / (f9 - CB1[2].x)) * CB1[2].z) + (f9 * CB1[2].w))) - 1.0;
    float f11 = exp(CB1[1].z * f10);
    float f12 = -exp(f3 * f10);
    float f13 = (2.0 * texture(EvsmTexture0Texture, (CB1[1].xy * vec2(-1.0, 0.0)) + VARYING0).x) - 1.0;
