...
void main()
{
    ...
    vec4 v3 = vec4(dot(CB0[20], v1), dot(CB0[21], v1), dot(CB0[22], v1), 0.0);
    v3.w = COLOR1.z * 0.0039215688593685626983642578125;
    vec4 v4 = vec4(v0, 0.0);
    v4.w = inversesqrt(0.1745329201221466064453125 * COLOR1.y);
    gl_Position = v2;
    VARYING0 = TEXCOORD0;
    VARYING1 = TEXCOORD1;
    VARYING2 = COLOR0;
