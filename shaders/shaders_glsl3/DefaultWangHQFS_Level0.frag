...
void main()
{
    ...
    float f49 = f39.z;
    vec3 f50 = -CB0[16].xyz;
    float f51 = (dot(f28, f50) * CB0[14].w) * ((1.0 - ((step(f48.x, f49) * clamp(CB0[29].z + (CB0[29].w * abs(f49 - 0.5)), 0.0, 1.0)) * f48.y)) * f46.y);
