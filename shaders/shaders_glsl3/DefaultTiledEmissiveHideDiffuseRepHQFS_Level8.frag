...
void main()
{
    ...
    float f91 = f85.y;
    float f92 = f85.z;
    vec3 f93 = (((((((f39.xyz * (f39.w * 120.0)) * 1.0) + (((f74 - (f69 * f73)) * CB0[15].xyz) * f62)) + ((f74 - (f82 * f73)) * (((((((CB0[40].xyz * f87) + (CB0[42].xyz * f88)) + (CB0[44].xyz * f89)) + (CB0[41].xyz * f90)) + (CB0[43].xyz * f91)) + (CB0[45].xyz * f92)) + (((((((CB0[34].xyz * f87) + (CB0[36].xyz * f88)) + (CB0[38].xyz * f89)) + (CB0[35].xyz * f90)) + (CB0[37].xyz * f91)) + (CB0[39].xyz * f92)) * f41)))) + (CB0[32].xyz + ((CB0[33].xyz * (2.0 - CB0[14].w)) * f41))) + vec3(((1.0 - f15.w) * 2.0) * f2)) * f27.xyz) + ((((f69 * (((f70 + (f70 * f70)) / (((f71 * f71) * ((f65 * 3.0) + 0.5)) * ((f64 * 0.75) + 0.25))) * f62)) * CB0[15].xyz) * (CB0[14].w * CB0[14].w)) + ((mix(f78, textureLod(PrefilteredEnvTexture, f76, f75).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f30.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f41)) * f82) * f28));
    vec4 f94 = vec4(0.0);
    f94.x = f93.x;
    vec4 f95 = f94;
    f95.y = f93.y;
