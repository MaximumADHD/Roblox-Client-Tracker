...
void main()
{
    ...
    float v33 = CB1[gl_InstanceID * 7 + 6].z * 0.50359570980072021484375;
    ...
    v38.z = v35.z;
    vec4 v39 = v38;
    v39.w = (v34 * CB0[28].w) * (CB1[gl_InstanceID * 7 + 6].z * exp2((v33 * dot(v20, normalize(v22 + v19))) - v33));
    vec4 v40 = vec4(dot(CB0[25], v24), dot(CB0[26], v24), dot(CB0[27], v24), 0.0);
    v40.w = CB1[gl_InstanceID * 7 + 6].w;
    gl_Position = v25;
