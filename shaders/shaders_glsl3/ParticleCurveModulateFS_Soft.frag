...
void main()
{
    ...
    vec4 f5 = f4;
    f5.z = f2.z;
    float f6 = (f0.w * f1.w) * (clamp(VARYING3.w * abs((texture(depthTexTexture, gl_FragCoord.xy * CB0[45].xy).x * 500.0) - gl_FragCoord.w), 0.0, 1.0) * clamp(exp2((CB0[13].z * VARYING0.z) + CB0[13].x) - CB0[13].w, 0.0, 1.0));
    vec4 f7 = f5;
    f7.w = f6;
    vec4 f8 = f7;
    f8.w = f6;
