...
void main()
{
    ...
    f3.w = (f0.w * f1.w) * clamp(VARYING3.w * abs((texture(depthTexTexture, VARYING3.xy).x * 500.0) - VARYING3.z), 0.0, 1.0);
    vec3 f4 = vec3(CB0[15].x);
    vec4 f5 = texture(LightingAtlasTexture, VARYING2);
    ...
    _entryPointOutput = vec4(f8.x, f8.y, f8.z, f3.w);
}
