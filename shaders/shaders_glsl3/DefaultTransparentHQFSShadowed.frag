...
void main()
{
    ...
    float f9 = f8.y;
    vec3 f10 = VARYING7.xyz - CB0[25].xyz;
    vec3 f11 = VARYING7.xyz - CB0[26].xyz;
    vec3 f12 = VARYING7.xyz - CB0[27].xyz;
    vec4 f13 = vec4(VARYING7.xyz, 1.0) * mat4(CB8[((dot(f10, f10) < CB0[25].w) ? 0 : ((dot(f11, f11) < CB0[26].w) ? 1 : ((dot(f12, f12) < CB0[27].w) ? 2 : 3))) * 4 + 0], CB8[((dot(f10, f10) < CB0[25].w) ? 0 : ((dot(f11, f11) < CB0[26].w) ? 1 : ((dot(f12, f12) < CB0[27].w) ? 2 : 3))) * 4 + 1], CB8[((dot(f10, f10) < CB0[25].w) ? 0 : ((dot(f11, f11) < CB0[26].w) ? 1 : ((dot(f12, f12) < CB0[27].w) ? 2 : 3))) * 4 + 2], CB8[((dot(f10, f10) < CB0[25].w) ? 0 : ((dot(f11, f11) < CB0[26].w) ? 1 : ((dot(f12, f12) < CB0[27].w) ? 2 : 3))) * 4 + 3]);
    ...
    float f27 = f19 - f25;
    float f28 = (dot(f1, f2) > 0.0) ? mix(f9, mix(min((f18 <= f22) ? 1.0 : clamp(((f23 / (f23 + (f24 * f24))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0), (f19 <= f25) ? 1.0 : clamp(((f26 / (f26 + (f27 * f27))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0)), f9, clamp((length(VARYING7.xyz - CB0[7].xyz) * CB0[29].y) - (CB0[29].x * CB0[29].y), 0.0, 1.0)), CB0[30].x) : 0.0;
