...
void main()
{
    ...
    vec3 f38 = (((mix(vec3(1.0), CB4[int(VARYING9.x + 0.5) * 1 + 0].xyz, vec3(f35.w)) * f35.xyz) * f6.x) + ((mix(vec3(1.0), CB4[int(VARYING9.y + 0.5) * 1 + 0].xyz, vec3(f36.w)) * f36.xyz) * f6.y)) + ((mix(vec3(1.0), CB4[int(VARYING9.z + 0.5) * 1 + 0].xyz, vec3(f37.w)) * f37.xyz) * f6.z);
    vec3 f39 = f38 * f38;
