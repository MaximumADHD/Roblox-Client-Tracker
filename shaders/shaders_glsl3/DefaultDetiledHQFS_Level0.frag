...
void main()
{
    ...
    vec4 f31 = vec4((mix(vec3(1.0), VARYING2.xyz, vec3(clamp(f13.w + CB2[2].w, 0.0, 1.0))) * f13.xyz) * (1.0 + (f29 * CB2[0].z)), VARYING2.w);
    ...
    float f53 = max(f30.y, 0.04500000178813934326171875);
