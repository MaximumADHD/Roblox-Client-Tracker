...
void main()
{
    ...
    float f56 = f46.z;
    vec3 f57 = -CB0[16].xyz;
    float f58 = (dot(f35, f57) * CB0[14].w) * ((1.0 - ((step(f55.x, f56) * clamp(CB0[29].z + (CB0[29].w * abs(f56 - 0.5)), 0.0, 1.0)) * f55.y)) * f53.y);
