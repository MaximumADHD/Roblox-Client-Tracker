...
void main()
{
    ...
    vec3 f56 = ((((((((vec3(1.0) - (f37 * f19)) * CB0[10].xyz) * f30) + (CB0[12].xyz * clamp(-f28, 0.0, 1.0))) + (((vec3(1.0) - f43) * f54) * CB0[25].w)) + (CB0[27].xyz + (CB0[28].xyz * f16))) * f26) + (((f37 * (((f38 + (f38 * f38)) / (((f39 * f39) * ((f33 * 3.0) + 0.5)) * ((f32 * 0.75) + 0.25))) * f30)) * CB0[10].xyz) + f55)) + ((f14.xyz * (f14.w * 120.0)).xyz * mix(f26, f55 * (1.0 / (max(max(f54.x, f54.y), f54.z) + 0.00999999977648258209228515625)), f43 * (f19 * (1.0 - f16))));
