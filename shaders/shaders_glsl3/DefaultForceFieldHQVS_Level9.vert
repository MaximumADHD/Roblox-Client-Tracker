...
void main()
{
    ...
    vec4 v26 = vec4(v10, v11, v12, 1.0) * mat4(CB0[0], CB0[1], CB0[2], CB0[3]);
    vec2 v27 = TEXCOORD0.zw * v20;
    v27.x = max(0.0500000007450580596923828125, mix(1.0 - v3.w, 0.0, v4));
    vec3 v28 = ((v13 + (vec3(v14, v15, v16) * 6.0)).yxz * CB0[21].xyz) + CB0[22].xyz;
    vec4 v29 = vec4(0.0);
    v29.x = v28.x;
    vec4 v30 = v29;
    v30.y = v28.y;
    ...
    vec4 v33 = vec4(v10, v11, v12, 0.0);
    v33.w = CB1[gl_InstanceID * 7 + 6].w;
    vec4 v34 = vec4(v14, v15, v16, 0.0);
    v34.w = inversesqrt(0.1745329201221466064453125 * CB1[gl_InstanceID * 7 + 6].z);
    gl_Position = v26;
    VARYING0 = (TEXCOORD0.xy * v18) + CB1[gl_InstanceID * 7 + 6].xy;
    VARYING1 = v27;
    VARYING2 = v25;
    VARYING3 = v32;
    VARYING4 = vec4(CB0[11].xyz - v13, v26.w);
    VARYING5 = v34;
    VARYING6 = v33;
