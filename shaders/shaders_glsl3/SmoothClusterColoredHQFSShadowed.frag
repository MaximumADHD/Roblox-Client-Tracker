...
void main()
{
    ...
    vec3 f44 = (f10 * f10).xyz;
    float f45 = f13.y;
    float f46 = CB0[26].w * f11;
    ...
    vec3 f77 = (((((((((vec3(1.0) - (f56 * f46)) * CB0[10].xyz) * f49) * f42) + ((vec3(1.0) - f65) * (((((((CB0[35].xyz * f70) + (CB0[37].xyz * f71)) + (CB0[39].xyz * f72)) + (CB0[36].xyz * f73)) + (CB0[38].xyz * f74)) + (CB0[40].xyz * f75)) + (((((((CB0[29].xyz * f70) + (CB0[31].xyz * f71)) + (CB0[33].xyz * f72)) + (CB0[30].xyz * f73)) + (CB0[32].xyz * f74)) + (CB0[34].xyz * f75)) * f22)))) + (CB0[27].xyz + (CB0[28].xyz * f22))) + vec3((f13.z * 2.0) * f11)) * f44) + ((((((f56 * (((f57 + (f57 * f57)) / (((f58 * f58) * ((f52 * 3.0) + 0.5)) * ((f51 * 0.75) + 0.25))) * f49)) * CB0[10].xyz) * f42) * f11) * VARYING0.w) + f76)) + (f21 * mix(f44, f76 * (1.0 / (max(max(f76.x, f76.y), f76.z) + 0.00999999977648258209228515625)), f65 * (f46 * (1.0 - f22))));
