...
void main()
{
    ...
    vec3 f53 = (((((((vec3(1.0) - (f50 * (CB0[26].w * f11))) * CB0[10].xyz) * f43) * f40) + min((f19.xyz * (f19.w * 120.0)).xyz + (CB0[8].xyz + (CB0[9].xyz * f20.x)), vec3(CB0[16].w))) + vec3((f13.z * 2.0) * f11)) * (f10 * f10).xyz) + (((((f50 * (((f51 + (f51 * f51)) / (((f52 * f52) * ((f46 * 3.0) + 0.5)) * ((f45 * 0.75) + 0.25))) * f43)) * CB0[10].xyz) * f40) * f11) * VARYING0.w);
