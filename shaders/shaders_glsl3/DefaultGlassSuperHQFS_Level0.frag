...
void main()
{
    ...
    float f48 = CB0[14].w * CB0[14].w;
    vec3 f49 = -CB0[16].xyz;
    float f50 = (dot(f22, f49) * CB0[14].w) * ((1.0 - ((step(f44.x, f45) * clamp(CB0[29].z + (CB0[29].w * abs(f45 - 0.5)), 0.0, 1.0)) * f44.y)) * f41.y);
    ...
    vec4 f105 = mix(mix(f104, vec4(mix(((((f42 * f17) + ((((vec3(1.0) - (f59 * f27)) * CB0[15].xyz) * f52) + (CB0[17].xyz * clamp(-f50, 0.0, 1.0)))) + (((vec3(1.0) - (f64 * f27)) * (((((((CB0[40].xyz * f69) + (CB0[42].xyz * f70)) + (CB0[44].xyz * f71)) + (CB0[41].xyz * f72)) + (CB0[43].xyz * f73)) + (CB0[45].xyz * f74)) + (((((((CB0[34].xyz * f69) + (CB0[36].xyz * f70)) + (CB0[38].xyz * f71)) + (CB0[35].xyz * f72)) + (CB0[37].xyz * f73)) + (CB0[39].xyz * f74)) * f43))) * f17)) + (CB0[32].xyz + ((CB0[33].xyz * (2.0 - CB0[14].w)) * f43))) * (f23 * f17), f47, vec3(VARYING7.w)), 1.0), vec4(f17)), vec4(f47, 1.0), vec4(((f75 * f75) * 0.800000011920928955078125) * f18)) + vec4((((f59 * (((f60 + (f60 * f60)) / (((f61 * f61) * ((f55 * 3.0) + 0.5)) * ((f54 * 0.75) + 0.25))) * f52)) * CB0[15].xyz) * f48) + (((mix(f34, f32, f46) * f64) * f27) * (f48 * f17)), 0.0);
