...
void main()
{
    ...
    vec3 f36 = (min((f33.xyz * (f33.w * 120.0)) + (CB0[8].xyz + (CB0[9].xyz * f34.x)), vec3(CB0[16].w)) + (VARYING6 * ((1.0 - ((step(f35.x, VARYING5.z) * clamp(CB0[24].z + (CB0[24].w * abs(VARYING5.z - 0.5)), 0.0, 1.0)) * f35.y)) * f34.y))) * (f22 * f22);
    vec4 f37 = vec4(0.0);
    f37.x = f36.x;
    vec4 f38 = f37;
    f38.y = f36.y;
