...
void main()
{
    ...
    vec4 f55 = vec4(f41, 1.0) * mat4(CB4[((dot(f52, f52) < CB0[46].w) ? 0 : ((dot(f53, f53) < CB0[47].w) ? 1 : ((dot(f54, f54) < CB0[48].w) ? 2 : 3))) * 4 + 0], CB4[((dot(f52, f52) < CB0[46].w) ? 0 : ((dot(f53, f53) < CB0[47].w) ? 1 : ((dot(f54, f54) < CB0[48].w) ? 2 : 3))) * 4 + 1], CB4[((dot(f52, f52) < CB0[46].w) ? 0 : ((dot(f53, f53) < CB0[47].w) ? 1 : ((dot(f54, f54) < CB0[48].w) ? 2 : 3))) * 4 + 2], CB4[((dot(f52, f52) < CB0[46].w) ? 0 : ((dot(f53, f53) < CB0[47].w) ? 1 : ((dot(f54, f54) < CB0[48].w) ? 2 : 3))) * 4 + 3]);
    ...
    float f69 = f61 - f67;
    float f70 = (f27 * CB0[14].w) * (((f27 * CB0[52].x) > 0.0) ? mix(min((f60 <= f64) ? 1.0 : clamp(((f65 / (f65 + (f66 * f66))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0), (f61 <= f67) ? 1.0 : clamp(((f68 / (f68 + (f69 * f69))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0)), f51, clamp((length(f41 - CB0[11].xyz) * CB0[51].y) - (CB0[51].x * CB0[51].y), 0.0, 1.0)) : f51);
    vec3 f71;
    vec3 f72;
    if (f70 > 0.0)
    {
    ...
    float f102 = f96.y;
    float f103 = f96.z;
    vec3 f104 = (((f72 + (((vec3(f93) - (f92 * (f35 * f93))) * ((((((((CB0[40].xyz * f98) + (CB0[42].xyz * f99)) + (CB0[44].xyz * f100)) + (CB0[41].xyz * f101)) + (CB0[43].xyz * f102)) + (CB0[45].xyz * f103)) * CB0[30].w) + ((((((((CB0[34].xyz * f98) + (CB0[36].xyz * f99)) + (CB0[38].xyz * f100)) + (CB0[35].xyz * f101)) + (CB0[37].xyz * f102)) + (CB0[39].xyz * f103)) * CB0[30].w) * f50))) * 1.0)) + ((CB0[32].xyz + (CB0[33].xyz * (f50 * (2.0 - CB0[14].w)))) * 1.0)) * f32.xyz) + (f71 + ((mix(f88, textureLod(PrefilteredEnvTexture, f86, f85).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f38.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f50)) * f92) * f35));
    vec4 f105 = vec4(0.0);
    f105.x = f104.x;
    vec4 f106 = f105;
    f106.y = f104.y;
