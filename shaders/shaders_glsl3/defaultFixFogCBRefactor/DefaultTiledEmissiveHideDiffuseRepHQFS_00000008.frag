...
void main()
{
    ...
    vec4 f49 = vec4(f35, 1.0) * mat4(CB4[((dot(f46, f46) < CB0[46].w) ? 0 : ((dot(f47, f47) < CB0[47].w) ? 1 : ((dot(f48, f48) < CB0[48].w) ? 2 : 3))) * 4 + 0], CB4[((dot(f46, f46) < CB0[46].w) ? 0 : ((dot(f47, f47) < CB0[47].w) ? 1 : ((dot(f48, f48) < CB0[48].w) ? 2 : 3))) * 4 + 1], CB4[((dot(f46, f46) < CB0[46].w) ? 0 : ((dot(f47, f47) < CB0[47].w) ? 1 : ((dot(f48, f48) < CB0[48].w) ? 2 : 3))) * 4 + 2], CB4[((dot(f46, f46) < CB0[46].w) ? 0 : ((dot(f47, f47) < CB0[47].w) ? 1 : ((dot(f48, f48) < CB0[48].w) ? 2 : 3))) * 4 + 3]);
    ...
    float f63 = f55 - f61;
    float f64 = (f21 * CB0[14].w) * (((f21 * CB0[52].x) > 0.0) ? mix(min((f54 <= f58) ? 1.0 : clamp(((f59 / (f59 + (f60 * f60))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0), (f55 <= f61) ? 1.0 : clamp(((f62 / (f62 + (f63 * f63))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0)), f45, clamp((length(f35 - CB0[11].xyz) * CB0[51].y) - (CB0[51].x * CB0[51].y), 0.0, 1.0)) : f45);
    vec3 f65;
    vec3 f66;
    if (f64 > 0.0)
    {
    ...
    float f96 = f90.y;
    float f97 = f90.z;
    vec3 f98 = ((((f66 + (((vec3(f87) - (f86 * (f29 * f87))) * ((((((((CB0[40].xyz * f92) + (CB0[42].xyz * f93)) + (CB0[44].xyz * f94)) + (CB0[41].xyz * f95)) + (CB0[43].xyz * f96)) + (CB0[45].xyz * f97)) * CB0[30].w) + ((((((((CB0[34].xyz * f92) + (CB0[36].xyz * f93)) + (CB0[38].xyz * f94)) + (CB0[35].xyz * f95)) + (CB0[37].xyz * f96)) + (CB0[39].xyz * f97)) * CB0[30].w) * f44))) * 1.0)) + ((CB0[32].xyz + (CB0[33].xyz * (f44 * (2.0 - CB0[14].w)))) * 1.0)) + vec3(((1.0 - f14.w) * 2.0) * f2)) * f26.xyz) + (f65 + ((mix(f82, textureLod(PrefilteredEnvTexture, f80, f79).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f32.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f44)) * f86) * f29));
    vec4 f99 = vec4(0.0);
    f99.x = f98.x;
    vec4 f100 = f99;
    f100.y = f98.y;
