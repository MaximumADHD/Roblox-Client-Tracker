...
void main()
{
    ...
    vec3 f41;
    if (!(CB5[f38 * 3 + 2].w == 0.0))
    {
        f41 = (mix(vec3(1.0), CB5[f38 * 3 + 2].xyz, vec3(f35.w)) * f35.xyz) * f6.x;
    }
    else
    {
        ...
        float f43 = f42.x;
        float f44 = f42.y;
        float f45 = CB5[f38 * 3 + 2].x * f35.y;
        float f46 = (CB5[f38 * 3 + 2].y * f43) - (CB5[f38 * 3 + 2].z * f44);
        float f47 = (CB5[f38 * 3 + 2].z * f43) + (CB5[f38 * 3 + 2].y * f44);
        float f48 = f45 - f47;
        f41 = (vec3(f48, f45, f48) + (vec3(f46, f47, f46) * vec3(1.0, 1.0, -1.0))) * f6.x;
    }
    vec3 f49;
    if (!(CB5[f39 * 3 + 2].w == 0.0))
    {
        f49 = f41 + ((mix(vec3(1.0), CB5[f39 * 3 + 2].xyz, vec3(f36.w)) * f36.xyz) * f6.y);
    }
    else
    {
        ...
        float f51 = f50.x;
        float f52 = f50.y;
        float f53 = CB5[f39 * 3 + 2].x * f36.y;
        float f54 = (CB5[f39 * 3 + 2].y * f51) - (CB5[f39 * 3 + 2].z * f52);
        float f55 = (CB5[f39 * 3 + 2].z * f51) + (CB5[f39 * 3 + 2].y * f52);
        float f56 = f53 - f55;
        f49 = f41 + ((vec3(f56, f53, f56) + (vec3(f54, f55, f54) * vec3(1.0, 1.0, -1.0))) * f6.y);
    }
    vec3 f57;
    if (!(CB5[f40 * 3 + 2].w == 0.0))
    {
        f57 = f49 + ((mix(vec3(1.0), CB5[f40 * 3 + 2].xyz, vec3(f37.w)) * f37.xyz) * f6.z);
    }
    else
    {
        ...
        float f59 = f58.x;
        float f60 = f58.y;
        float f61 = CB5[f40 * 3 + 2].x * f37.y;
        float f62 = (CB5[f40 * 3 + 2].y * f59) - (CB5[f40 * 3 + 2].z * f60);
        float f63 = (CB5[f40 * 3 + 2].z * f59) + (CB5[f40 * 3 + 2].y * f60);
        float f64 = f61 - f63;
    ...
    vec4 f88 = vec4(f75, 1.0) * mat4(CB4[((dot(f85, f85) < CB0[46].w) ? 0 : ((dot(f86, f86) < CB0[47].w) ? 1 : ((dot(f87, f87) < CB0[48].w) ? 2 : 3))) * 4 + 0], CB4[((dot(f85, f85) < CB0[46].w) ? 0 : ((dot(f86, f86) < CB0[47].w) ? 1 : ((dot(f87, f87) < CB0[48].w) ? 2 : 3))) * 4 + 1], CB4[((dot(f85, f85) < CB0[46].w) ? 0 : ((dot(f86, f86) < CB0[47].w) ? 1 : ((dot(f87, f87) < CB0[48].w) ? 2 : 3))) * 4 + 2], CB4[((dot(f85, f85) < CB0[46].w) ? 0 : ((dot(f86, f86) < CB0[47].w) ? 1 : ((dot(f87, f87) < CB0[48].w) ? 2 : 3))) * 4 + 3]);
    ...
    vec3 f126 = (vec3((f26.z * 2.0) * f67) + (((f114 - (f111 * f113)) * ((((((((CB0[40].xyz * f119) + (CB0[42].xyz * f120)) + (CB0[44].xyz * f121)) + (CB0[41].xyz * f122)) + (CB0[43].xyz * f123)) + (CB0[45].xyz * f124)) * CB0[30].w) + ((((((((CB0[34].xyz * f119) + (CB0[36].xyz * f120)) + (CB0[38].xyz * f121)) + (CB0[35].xyz * f122)) + (CB0[37].xyz * f123)) + (CB0[39].xyz * f124)) * CB0[30].w) * f83))) * 1.0)) + ((CB0[32].xyz + (CB0[33].xyz * (f83 * (2.0 - CB0[14].w)))) * 1.0);
    float f127 = (f69 * CB0[14].w) * (((f69 * CB0[52].x) > 0.0) ? mix(min((f93 <= f97) ? 1.0 : clamp(((f98 / (f98 + (f99 * f99))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0), (f94 <= f100) ? 1.0 : clamp(((f101 / (f101 + (f102 * f102))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0)), f84, clamp((length(f75 - CB0[11].xyz) * CB0[51].y) - (CB0[51].x * CB0[51].y), 0.0, 1.0)) : f84);
    vec3 f128;
    vec3 f129;
    if (f127 > 0.0)
    {
