...
void main()
{
    ...
    float f40 = f32.z;
    vec3 f41 = -CB0[16].xyz;
    float f42 = dot(f14, f41) * ((1.0 - ((step(f39.x, f40) * clamp(CB0[29].z + (CB0[29].w * abs(f40 - 0.5)), 0.0, 1.0)) * f39.y)) * f37.y);
    vec3 f43 = normalize(f21 + f41);
    float f44 = clamp(f42, 0.0, 1.0);
    float f45 = f23 * f23;
    float f46 = max(0.001000000047497451305389404296875, dot(f14, f43));
    ...
    vec3 f57 = f14 * f14;
    bvec3 f58 = lessThan(f14, vec3(0.0));
    ...
    float f65 = f59.y;
    float f66 = f59.z;
    vec3 f67 = (((((f36.xyz * (f36.w * 120.0)) + ((((vec3(1.0) - (f51 * f22)) * CB0[15].xyz) * f44) + (CB0[17].xyz * clamp(-f42, 0.0, 1.0)))) + (((vec3(1.0) - (f56 * f22)) * ((((((((CB0[40].xyz * f61) + (CB0[42].xyz * f62)) + (CB0[44].xyz * f63)) + (CB0[41].xyz * f64)) + (CB0[43].xyz * f65)) + (CB0[45].xyz * f66)) * CB0[30].w) + ((((((((CB0[34].xyz * f61) + (CB0[36].xyz * f62)) + (CB0[38].xyz * f63)) + (CB0[35].xyz * f64)) + (CB0[37].xyz * f65)) + (CB0[39].xyz * f66)) * CB0[30].w) * f38))) * 1.0)) + ((CB0[32].xyz + (CB0[33].xyz * f38)) * 1.0)) * mix(f19.xyz, f28, vec3(VARYING7.w))) + ((((f51 * (((f52 + (f52 * f52)) / (((f53 * f53) * ((f47 * 3.0) + 0.5)) * ((f46 * 0.75) + 0.25))) * f44)) * CB0[15].xyz) * 1.0) + ((mix(f30, f28, vec3(f38)) * f56) * f22));
    vec4 f68 = vec4(0.0);
    f68.x = f67.x;
    vec4 f69 = f68;
    f69.y = f67.y;
