...
void main()
{
    ...
    vec4 f8 = f7;
    f8.z = f5.z;
    float f9 = length(VARYING3.xyz);
    vec3 f10 = VARYING3.xyz / vec3(f9);
    ...
    vec3 f13 = -f10;
    vec3 f14 = reflect(f13, f1);
    float f15 = VARYING5.w * f11;
    vec3 f16 = mix(vec3(0.039999999105930328369140625), f8.xyz, vec3(f15));
    ...
    vec4 f31 = vec4(f17, 1.0) * mat4(CB4[((dot(f28, f28) < CB0[46].w) ? 0 : ((dot(f29, f29) < CB0[47].w) ? 1 : ((dot(f30, f30) < CB0[48].w) ? 2 : 3))) * 4 + 0], CB4[((dot(f28, f28) < CB0[46].w) ? 0 : ((dot(f29, f29) < CB0[47].w) ? 1 : ((dot(f30, f30) < CB0[48].w) ? 2 : 3))) * 4 + 1], CB4[((dot(f28, f28) < CB0[46].w) ? 0 : ((dot(f29, f29) < CB0[47].w) ? 1 : ((dot(f30, f30) < CB0[48].w) ? 2 : 3))) * 4 + 2], CB4[((dot(f28, f28) < CB0[46].w) ? 0 : ((dot(f29, f29) < CB0[47].w) ? 1 : ((dot(f30, f30) < CB0[48].w) ? 2 : 3))) * 4 + 3]);
    ...
    float f45 = f37 - f43;
    float f46 = (f3 * CB0[14].w) * (((f3 * CB0[52].x) > 0.0) ? mix(min((f36 <= f40) ? 1.0 : clamp(((f41 / (f41 + (f42 * f42))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0), (f37 <= f43) ? 1.0 : clamp(((f44 / (f44 + (f45 * f45))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0)), f27, clamp((length(f17 - CB0[11].xyz) * CB0[51].y) - (CB0[51].x * CB0[51].y), 0.0, 1.0)) : f27);
    vec3 f47;
    vec3 f48;
    if (f46 > 0.0)
    {
        vec3 f49 = normalize(f10 + f2);
        float f50 = clamp(f46, 0.0, 1.0);
        float f51 = f12 * f12;
        float f52 = max(0.001000000047497451305389404296875, dot(f1, f49));
        float f53 = dot(f2, f49);
        float f54 = 1.0 - f53;
        float f55 = f54 * f54;
        ...
        f47 = ((f57 * (((f58 + (f58 * f58)) / (((f59 * f59) * ((f53 * 3.0) + 0.5)) * ((f52 * 0.75) + 0.25))) * f50)) * CB0[15].xyz) * (CB0[14].w * CB0[14].w);
    }
    else
    {
        f48 = f25;
    ...
    vec4 f65 = texture(PrecomputedBRDFTexture, vec2(f12, max(9.9999997473787516355514526367188e-05, dot(f1, f10))));
    float f66 = f65.x;
    float f67 = f65.y;
    vec3 f68 = ((f16 * f66) + vec3(f67)) / vec3(f66 + f67);
    float f69 = 1.0 - f15;
    vec3 f70 = f1 * f1;
    bvec3 f71 = lessThan(f1, vec3(0.0));
    ...
    float f78 = f72.y;
    float f79 = f72.z;
    vec3 f80 = (((f48 + (((vec3(f69) - (f68 * (f11 * f69))) * ((((((((CB0[40].xyz * f74) + (CB0[42].xyz * f75)) + (CB0[44].xyz * f76)) + (CB0[41].xyz * f77)) + (CB0[43].xyz * f78)) + (CB0[45].xyz * f79)) * CB0[30].w) + ((((((((CB0[34].xyz * f74) + (CB0[36].xyz * f75)) + (CB0[38].xyz * f76)) + (CB0[35].xyz * f77)) + (CB0[37].xyz * f78)) + (CB0[39].xyz * f79)) * CB0[30].w) * f26))) * 1.0)) + ((CB0[32].xyz + (CB0[33].xyz * (f26 * (2.0 - CB0[14].w)))) * 1.0)) * f8.xyz) + (f47 + ((mix(f64, textureLod(PrefilteredEnvTexture, f62, f61).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f14.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f26)) * f68) * f11));
    vec4 f81 = vec4(0.0);
    f81.x = f80.x;
    vec4 f82 = f81;
    f82.y = f80.y;
    ...
    vec4 f84 = f83;
    f84.w = 1.0;
    float f85 = clamp(exp2((CB0[18].z * f9) + CB0[18].x) - CB0[18].w, 0.0, 1.0);
