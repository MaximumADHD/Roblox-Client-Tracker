...
void main()
{
    ...
    vec3 v19 = vec3(0.0);
    v19.x = float((TEXCOORD0.x == TEXCOORD0.y) || (TEXCOORD0.x == TEXCOORD0.z));
    vec3 v20 = v19;
    v20.y = float((TEXCOORD0.y == TEXCOORD0.x) || (TEXCOORD0.y == TEXCOORD0.z));
    vec3 v21 = v20;
    v21.z = float((TEXCOORD0.z == TEXCOORD0.x) || (TEXCOORD0.z == TEXCOORD0.y));
    vec4 v22 = vec4(0.0);
    v22.x = TEXCOORD0.x;
    vec4 v23 = v22;
    v23.y = TEXCOORD0.y;
    ...
    vec4 v26 = v24;
    v26.w = (dot(v21, v18) * 20.0) - 19.0;
    gl_Position = v4;
    VARYING0 = vec4(v18, (abs(POSITION.w) > 3.0) ? 0.0 : 1.0);
