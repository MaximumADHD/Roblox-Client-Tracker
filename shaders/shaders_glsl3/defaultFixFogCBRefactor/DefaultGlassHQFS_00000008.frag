...
void main()
{
    ...
    vec4 f53 = vec4(f39, 1.0) * mat4(CB4[((dot(f50, f50) < CB0[46].w) ? 0 : ((dot(f51, f51) < CB0[47].w) ? 1 : ((dot(f52, f52) < CB0[48].w) ? 2 : 3))) * 4 + 0], CB4[((dot(f50, f50) < CB0[46].w) ? 0 : ((dot(f51, f51) < CB0[47].w) ? 1 : ((dot(f52, f52) < CB0[48].w) ? 2 : 3))) * 4 + 1], CB4[((dot(f50, f50) < CB0[46].w) ? 0 : ((dot(f51, f51) < CB0[47].w) ? 1 : ((dot(f52, f52) < CB0[48].w) ? 2 : 3))) * 4 + 2], CB4[((dot(f50, f50) < CB0[46].w) ? 0 : ((dot(f51, f51) < CB0[47].w) ? 1 : ((dot(f52, f52) < CB0[48].w) ? 2 : 3))) * 4 + 3]);
