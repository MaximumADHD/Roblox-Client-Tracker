...
void main()
{
    ...
    float f82 = f76.y;
    float f83 = f76.z;
    vec3 f84 = ((((f54 + (((vec3(1.0) - (f73 * f21)) * ((((((((CB0[40].xyz * f78) + (CB0[42].xyz * f79)) + (CB0[44].xyz * f80)) + (CB0[41].xyz * f81)) + (CB0[43].xyz * f82)) + (CB0[45].xyz * f83)) * CB0[30].w) + ((((((((CB0[34].xyz * f78) + (CB0[36].xyz * f79)) + (CB0[38].xyz * f80)) + (CB0[35].xyz * f81)) + (CB0[37].xyz * f82)) + (CB0[39].xyz * f83)) * CB0[30].w) * f32))) * 1.0)) + ((CB0[32].xyz + (CB0[33].xyz * (f32 * (2.0 - CB0[14].w)))) * 1.0)) + vec3((f5.z * 2.0) * f15)) * (f13 * f13)) + ((f53 * (f15 * VARYING0.w)) + ((mix(f69, textureLod(PrefilteredEnvTexture, f67, f66).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f22.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f32)) * f73) * f21));
    vec4 f85 = vec4(0.0);
    f85.x = f84.x;
    vec4 f86 = f85;
    f86.y = f84.y;
