...
void main()
{
    ...
    vec3 f11 = (((mix(vec3(1.0), CB5[int(VARYING9.x + 0.5) * 3 + 2].xyz, vec3(f8.w)) * f8.xyz) * VARYING0.x) + ((mix(vec3(1.0), CB5[int(VARYING9.y + 0.5) * 3 + 2].xyz, vec3(f9.w)) * f9.xyz) * VARYING0.y)) + ((mix(vec3(1.0), CB5[int(VARYING9.z + 0.5) * 3 + 2].xyz, vec3(f10.w)) * f10.xyz) * VARYING0.z);
    vec3 f12 = f11 * f11;
    ...
    float f63 = f57.y;
    float f64 = f57.z;
    vec3 f65 = ((((((f26.xyz * (f26.w * 120.0)) + ((((f46 - (f41 * f45)) * CB0[15].xyz) * f34) + (CB0[17].xyz * (f44 * clamp(-f32, 0.0, 1.0))))) + (((f46 - (f54 * f45)) * ((((((((CB0[40].xyz * f59) + (CB0[42].xyz * f60)) + (CB0[44].xyz * f61)) + (CB0[41].xyz * f62)) + (CB0[43].xyz * f63)) + (CB0[45].xyz * f64)) * CB0[30].w) + ((((((((CB0[34].xyz * f59) + (CB0[36].xyz * f60)) + (CB0[38].xyz * f61)) + (CB0[35].xyz * f62)) + (CB0[37].xyz * f63)) + (CB0[39].xyz * f64)) * CB0[30].w) * f28))) * 1.0)) + ((CB0[32].xyz + (CB0[33].xyz * f28)) * 1.0)) + vec3((f6.z * 2.0) * f13)) * f12) + (((((f41 * (((f42 + (f42 * f42)) / (((f43 * f43) * ((f37 * 3.0) + 0.5)) * ((f36 * 0.75) + 0.25))) * f34)) * CB0[15].xyz) * 1.0) * (f13 * VARYING0.w)) + ((mix(f50, textureLod(PrefilteredEnvTexture, f48, f47).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f19.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f28)) * f54) * f18));
    vec4 f66 = vec4(0.0);
    f66.x = f65.x;
    vec4 f67 = f66;
    f67.y = f65.y;
