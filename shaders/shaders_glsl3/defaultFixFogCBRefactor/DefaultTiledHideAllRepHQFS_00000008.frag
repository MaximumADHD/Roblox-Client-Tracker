...
void main()
{
    ...
    vec4 f52 = vec4(f38, 1.0) * mat4(CB4[((dot(f49, f49) < CB0[46].w) ? 0 : ((dot(f50, f50) < CB0[47].w) ? 1 : ((dot(f51, f51) < CB0[48].w) ? 2 : 3))) * 4 + 0], CB4[((dot(f49, f49) < CB0[46].w) ? 0 : ((dot(f50, f50) < CB0[47].w) ? 1 : ((dot(f51, f51) < CB0[48].w) ? 2 : 3))) * 4 + 1], CB4[((dot(f49, f49) < CB0[46].w) ? 0 : ((dot(f50, f50) < CB0[47].w) ? 1 : ((dot(f51, f51) < CB0[48].w) ? 2 : 3))) * 4 + 2], CB4[((dot(f49, f49) < CB0[46].w) ? 0 : ((dot(f50, f50) < CB0[47].w) ? 1 : ((dot(f51, f51) < CB0[48].w) ? 2 : 3))) * 4 + 3]);
    ...
    float f66 = f58 - f64;
    float f67 = (f24 * CB0[14].w) * (((f24 * CB0[52].x) > 0.0) ? mix(min((f57 <= f61) ? 1.0 : clamp(((f62 / (f62 + (f63 * f63))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0), (f58 <= f64) ? 1.0 : clamp(((f65 / (f65 + (f66 * f66))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0)), f48, clamp((length(f38 - CB0[11].xyz) * CB0[51].y) - (CB0[51].x * CB0[51].y), 0.0, 1.0)) : f48);
    vec3 f68;
    vec3 f69;
    if (f67 > 0.0)
    {
