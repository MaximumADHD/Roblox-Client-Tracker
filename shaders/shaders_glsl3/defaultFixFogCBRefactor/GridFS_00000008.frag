...
void main()
{
    ...
    vec4 f24 = vec4(f14, 1.0) * mat4(CB4[((dot(f21, f21) < CB0[46].w) ? 0 : ((dot(f22, f22) < CB0[47].w) ? 1 : ((dot(f23, f23) < CB0[48].w) ? 2 : 3))) * 4 + 0], CB4[((dot(f21, f21) < CB0[46].w) ? 0 : ((dot(f22, f22) < CB0[47].w) ? 1 : ((dot(f23, f23) < CB0[48].w) ? 2 : 3))) * 4 + 1], CB4[((dot(f21, f21) < CB0[46].w) ? 0 : ((dot(f22, f22) < CB0[47].w) ? 1 : ((dot(f23, f23) < CB0[48].w) ? 2 : 3))) * 4 + 2], CB4[((dot(f21, f21) < CB0[46].w) ? 0 : ((dot(f22, f22) < CB0[47].w) ? 1 : ((dot(f23, f23) < CB0[48].w) ? 2 : 3))) * 4 + 3]);
    ...
    vec4 f45 = f43;
    f45.w = f44;
    float f46 = clamp(exp2((CB0[18].z * f13) + CB0[18].x) - CB0[18].w, 0.0, 1.0);
    vec3 f47 = textureLod(PrefilteredEnvTexture, vec4(-(VARYING4.xyz / vec3(f13)), 0.0).xyz, max(CB0[18].y, f46) * 5.0).xyz;
