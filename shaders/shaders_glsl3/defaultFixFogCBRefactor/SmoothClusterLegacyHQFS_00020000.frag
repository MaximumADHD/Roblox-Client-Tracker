...
void main()
{
    ...
    if (!(CB5[f9 * 3 + 2].w == 0.0))
    {
        f12 = (mix(vec3(1.0), CB5[f9 * 3 + 2].xyz, vec3(f6.w)) * f6.xyz) * VARYING0.x;
    }
    else
    {
        ...
        float f14 = f13.x;
        float f15 = f13.y;
        float f16 = CB5[f9 * 3 + 2].x * f6.y;
        float f17 = (CB5[f9 * 3 + 2].y * f14) - (CB5[f9 * 3 + 2].z * f15);
        float f18 = (CB5[f9 * 3 + 2].z * f14) + (CB5[f9 * 3 + 2].y * f15);
        float f19 = f16 - f18;
        f12 = (vec3(f19, f16, f19) + (vec3(f17, f18, f17) * vec3(1.0, 1.0, -1.0))) * VARYING0.x;
    }
    vec3 f20;
    if (!(CB5[f10 * 3 + 2].w == 0.0))
    {
        f20 = f12 + ((mix(vec3(1.0), CB5[f10 * 3 + 2].xyz, vec3(f7.w)) * f7.xyz) * VARYING0.y);
    }
    else
    {
        ...
        float f22 = f21.x;
        float f23 = f21.y;
        float f24 = CB5[f10 * 3 + 2].x * f7.y;
        float f25 = (CB5[f10 * 3 + 2].y * f22) - (CB5[f10 * 3 + 2].z * f23);
        float f26 = (CB5[f10 * 3 + 2].z * f22) + (CB5[f10 * 3 + 2].y * f23);
        float f27 = f24 - f26;
    ...
    {
        f28 = f20 + ((mix(vec3(1.0), CB5[f11 * 3 + 2].xyz, vec3(f8.w)) * f8.xyz) * VARYING0.z);
    }
    else
    {
        ...
        float f30 = f29.x;
        float f31 = f29.y;
        float f32 = CB5[f11 * 3 + 2].x * f8.y;
        float f33 = (CB5[f11 * 3 + 2].y * f30) - (CB5[f11 * 3 + 2].z * f31);
        float f34 = (CB5[f11 * 3 + 2].z * f30) + (CB5[f11 * 3 + 2].y * f31);
        float f35 = f32 - f34;
    ...
    float f88 = f82.y;
    float f89 = f82.z;
    vec3 f90 = ((((((f51.xyz * (f51.w * 120.0)) + ((((f71 - (f66 * f70)) * CB0[15].xyz) * f59) + (CB0[17].xyz * (f69 * clamp(-f57, 0.0, 1.0))))) + (((f71 - (f79 * f70)) * ((((((((CB0[40].xyz * f84) + (CB0[42].xyz * f85)) + (CB0[44].xyz * f86)) + (CB0[41].xyz * f87)) + (CB0[43].xyz * f88)) + (CB0[45].xyz * f89)) * CB0[30].w) + ((((((((CB0[34].xyz * f84) + (CB0[36].xyz * f85)) + (CB0[38].xyz * f86)) + (CB0[35].xyz * f87)) + (CB0[37].xyz * f88)) + (CB0[39].xyz * f89)) * CB0[30].w) * f53))) * 1.0)) + ((CB0[32].xyz + (CB0[33].xyz * f53)) * 1.0)) + vec3((f5.z * 2.0) * f37)) * f36) + (((((f66 * (((f67 + (f67 * f67)) / (((f68 * f68) * ((f62 * 3.0) + 0.5)) * ((f61 * 0.75) + 0.25))) * f59)) * CB0[15].xyz) * 1.0) * (f37 * VARYING0.w)) + ((mix(f75, textureLod(PrefilteredEnvTexture, f73, f72).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f44.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f53)) * f79) * f43));
    vec4 f91 = vec4(0.0);
    f91.x = f90.x;
    vec4 f92 = f91;
    f92.y = f90.y;
