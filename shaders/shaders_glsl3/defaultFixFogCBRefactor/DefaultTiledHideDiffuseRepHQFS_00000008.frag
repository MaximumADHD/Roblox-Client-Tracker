...
void main()
{
    ...
    vec4 f48 = vec4(f34, 1.0) * mat4(CB4[((dot(f45, f45) < CB0[46].w) ? 0 : ((dot(f46, f46) < CB0[47].w) ? 1 : ((dot(f47, f47) < CB0[48].w) ? 2 : 3))) * 4 + 0], CB4[((dot(f45, f45) < CB0[46].w) ? 0 : ((dot(f46, f46) < CB0[47].w) ? 1 : ((dot(f47, f47) < CB0[48].w) ? 2 : 3))) * 4 + 1], CB4[((dot(f45, f45) < CB0[46].w) ? 0 : ((dot(f46, f46) < CB0[47].w) ? 1 : ((dot(f47, f47) < CB0[48].w) ? 2 : 3))) * 4 + 2], CB4[((dot(f45, f45) < CB0[46].w) ? 0 : ((dot(f46, f46) < CB0[47].w) ? 1 : ((dot(f47, f47) < CB0[48].w) ? 2 : 3))) * 4 + 3]);
