...
void main()
{
    ...
    vec3 f9 = (((mix(vec3(1.0), CB5[int(VARYING9.x + 0.5) * 3 + 2].xyz, vec3(f6.w)) * f6.xyz) * VARYING0.x) + ((mix(vec3(1.0), CB5[int(VARYING9.y + 0.5) * 3 + 2].xyz, vec3(f7.w)) * f7.xyz) * VARYING0.y)) + ((mix(vec3(1.0), CB5[int(VARYING9.z + 0.5) * 3 + 2].xyz, vec3(f8.w)) * f8.xyz) * VARYING0.z);
    vec3 f10 = f9 * f9;
    ...
    float f29 = f19.z;
    vec3 f30 = -CB0[16].xyz;
    float f31 = dot(f12, f30) * ((1.0 - ((step(f28.x, f29) * clamp(CB0[29].z + (CB0[29].w * abs(f29 - 0.5)), 0.0, 1.0)) * f28.y)) * f26.y);
    vec3 f32 = normalize(f13 + f30);
    ...
    float f62 = f56.y;
    float f63 = f56.z;
    vec3 f64 = ((((((f25.xyz * (f25.w * 120.0)) + ((((f45 - (f40 * f44)) * CB0[15].xyz) * f33) + (CB0[17].xyz * (f43 * clamp(-f31, 0.0, 1.0))))) + (((f45 - (f53 * f44)) * ((((((((CB0[40].xyz * f58) + (CB0[42].xyz * f59)) + (CB0[44].xyz * f60)) + (CB0[41].xyz * f61)) + (CB0[43].xyz * f62)) + (CB0[45].xyz * f63)) * CB0[30].w) + ((((((((CB0[34].xyz * f58) + (CB0[36].xyz * f59)) + (CB0[38].xyz * f60)) + (CB0[35].xyz * f61)) + (CB0[37].xyz * f62)) + (CB0[39].xyz * f63)) * CB0[30].w) * f27))) * 1.0)) + ((CB0[32].xyz + (CB0[33].xyz * f27)) * 1.0)) + vec3((f5.z * 2.0) * f11)) * f10) + (((((f40 * (((f41 + (f41 * f41)) / (((f42 * f42) * ((f36 * 3.0) + 0.5)) * ((f35 * 0.75) + 0.25))) * f33)) * CB0[15].xyz) * 1.0) * (f11 * VARYING0.w)) + ((mix(f49, textureLod(PrefilteredEnvTexture, f47, f46).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f18.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f27)) * f53) * f17));
    vec4 f65 = vec4(0.0);
    f65.x = f64.x;
    vec4 f66 = f65;
    f66.y = f64.y;
