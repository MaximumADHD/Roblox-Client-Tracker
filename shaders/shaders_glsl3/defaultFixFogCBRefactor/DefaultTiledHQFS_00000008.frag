...
void main()
{
    ...
    vec4 f47 = vec4(f33, 1.0) * mat4(CB4[((dot(f44, f44) < CB0[46].w) ? 0 : ((dot(f45, f45) < CB0[47].w) ? 1 : ((dot(f46, f46) < CB0[48].w) ? 2 : 3))) * 4 + 0], CB4[((dot(f44, f44) < CB0[46].w) ? 0 : ((dot(f45, f45) < CB0[47].w) ? 1 : ((dot(f46, f46) < CB0[48].w) ? 2 : 3))) * 4 + 1], CB4[((dot(f44, f44) < CB0[46].w) ? 0 : ((dot(f45, f45) < CB0[47].w) ? 1 : ((dot(f46, f46) < CB0[48].w) ? 2 : 3))) * 4 + 2], CB4[((dot(f44, f44) < CB0[46].w) ? 0 : ((dot(f45, f45) < CB0[47].w) ? 1 : ((dot(f46, f46) < CB0[48].w) ? 2 : 3))) * 4 + 3]);
    ...
    float f61 = f53 - f59;
    float f62 = (f19 * CB0[14].w) * (((f19 * CB0[52].x) > 0.0) ? mix(min((f52 <= f56) ? 1.0 : clamp(((f57 / (f57 + (f58 * f58))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0), (f53 <= f59) ? 1.0 : clamp(((f60 / (f60 + (f61 * f61))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0)), f43, clamp((length(f33 - CB0[11].xyz) * CB0[51].y) - (CB0[51].x * CB0[51].y), 0.0, 1.0)) : f43);
    vec3 f63;
    vec3 f64;
    if (f62 > 0.0)
    {
    ...
    float f94 = f88.y;
    float f95 = f88.z;
    vec3 f96 = (((f64 + (((vec3(f85) - (f84 * (f27 * f85))) * ((((((((CB0[40].xyz * f90) + (CB0[42].xyz * f91)) + (CB0[44].xyz * f92)) + (CB0[41].xyz * f93)) + (CB0[43].xyz * f94)) + (CB0[45].xyz * f95)) * CB0[30].w) + ((((((((CB0[34].xyz * f90) + (CB0[36].xyz * f91)) + (CB0[38].xyz * f92)) + (CB0[35].xyz * f93)) + (CB0[37].xyz * f94)) + (CB0[39].xyz * f95)) * CB0[30].w) * f42))) * 1.0)) + ((CB0[32].xyz + (CB0[33].xyz * (f42 * (2.0 - CB0[14].w)))) * 1.0)) * f24.xyz) + (f63 + ((mix(f80, textureLod(PrefilteredEnvTexture, f78, f77).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f30.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f42)) * f84) * f27));
    vec4 f97 = vec4(0.0);
    f97.x = f96.x;
    vec4 f98 = f97;
    f98.y = f96.y;
