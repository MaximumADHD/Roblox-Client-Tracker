...
void main()
{
    ...
    vec3 f32;
    if (!(CB5[f29 * 3 + 2].w == 0.0))
    {
        f32 = (mix(vec3(1.0), CB5[f29 * 3 + 2].xyz, vec3(f26.w)) * f26.xyz) * f5.x;
    }
    else
    {
        ...
        float f34 = f33.x;
        float f35 = f33.y;
        float f36 = CB5[f29 * 3 + 2].x * f26.y;
        float f37 = (CB5[f29 * 3 + 2].y * f34) - (CB5[f29 * 3 + 2].z * f35);
        float f38 = (CB5[f29 * 3 + 2].z * f34) + (CB5[f29 * 3 + 2].y * f35);
        float f39 = f36 - f38;
        f32 = (vec3(f39, f36, f39) + (vec3(f37, f38, f37) * vec3(1.0, 1.0, -1.0))) * f5.x;
    }
    vec3 f40;
    if (!(CB5[f30 * 3 + 2].w == 0.0))
    {
        f40 = f32 + ((mix(vec3(1.0), CB5[f30 * 3 + 2].xyz, vec3(f27.w)) * f27.xyz) * f5.y);
    }
    else
    {
        ...
        float f42 = f41.x;
        float f43 = f41.y;
        float f44 = CB5[f30 * 3 + 2].x * f27.y;
        float f45 = (CB5[f30 * 3 + 2].y * f42) - (CB5[f30 * 3 + 2].z * f43);
        float f46 = (CB5[f30 * 3 + 2].z * f42) + (CB5[f30 * 3 + 2].y * f43);
        float f47 = f44 - f46;
        f40 = f32 + ((vec3(f47, f44, f47) + (vec3(f45, f46, f45) * vec3(1.0, 1.0, -1.0))) * f5.y);
    }
    vec3 f48;
    if (!(CB5[f31 * 3 + 2].w == 0.0))
    {
        f48 = f40 + ((mix(vec3(1.0), CB5[f31 * 3 + 2].xyz, vec3(f28.w)) * f28.xyz) * f5.z);
    }
    else
    {
        ...
        float f50 = f49.x;
        float f51 = f49.y;
        float f52 = CB5[f31 * 3 + 2].x * f28.y;
        float f53 = (CB5[f31 * 3 + 2].y * f50) - (CB5[f31 * 3 + 2].z * f51);
        float f54 = (CB5[f31 * 3 + 2].z * f50) + (CB5[f31 * 3 + 2].y * f51);
        float f55 = f52 - f54;
    ...
    vec4 f89 = vec4(f75, 1.0) * mat4(CB4[((dot(f86, f86) < CB0[46].w) ? 0 : ((dot(f87, f87) < CB0[47].w) ? 1 : ((dot(f88, f88) < CB0[48].w) ? 2 : 3))) * 4 + 0], CB4[((dot(f86, f86) < CB0[46].w) ? 0 : ((dot(f87, f87) < CB0[47].w) ? 1 : ((dot(f88, f88) < CB0[48].w) ? 2 : 3))) * 4 + 1], CB4[((dot(f86, f86) < CB0[46].w) ? 0 : ((dot(f87, f87) < CB0[47].w) ? 1 : ((dot(f88, f88) < CB0[48].w) ? 2 : 3))) * 4 + 2], CB4[((dot(f86, f86) < CB0[46].w) ? 0 : ((dot(f87, f87) < CB0[47].w) ? 1 : ((dot(f88, f88) < CB0[48].w) ? 2 : 3))) * 4 + 3]);
    ...
    if (f104 > 0.0)
    {
        ...
        f105 = ((f115 * (((f116 + (f116 * f116)) / (((f117 * f117) * ((f111 * 3.0) + 0.5)) * ((f110 * 0.75) + 0.25))) * f108)) * CB0[15].xyz) * (CB0[14].w * CB0[14].w);
    }
    else
    {
        f106 = f83;
