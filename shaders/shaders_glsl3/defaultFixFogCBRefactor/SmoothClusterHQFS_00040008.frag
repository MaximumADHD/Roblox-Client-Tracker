...
void main()
{
    ...
    vec3 f73 = (vec3((f6.z * 2.0) * f14) + (((f61 - (f58 * f60)) * ((((((((CB0[40].xyz * f66) + (CB0[42].xyz * f67)) + (CB0[44].xyz * f68)) + (CB0[41].xyz * f69)) + (CB0[43].xyz * f70)) + (CB0[45].xyz * f71)) * CB0[30].w) + ((((((((CB0[34].xyz * f66) + (CB0[36].xyz * f67)) + (CB0[38].xyz * f68)) + (CB0[35].xyz * f69)) + (CB0[37].xyz * f70)) + (CB0[39].xyz * f71)) * CB0[30].w) * f30))) * 1.0)) + ((CB0[32].xyz + (CB0[33].xyz * (f30 * (2.0 - CB0[14].w)))) * 1.0);
