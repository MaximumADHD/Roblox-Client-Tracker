...
void main()
{
    ...
    vec3 f10 = (min((f7.xyz * (f7.w * 120.0)) + (CB0[32].xyz + (CB0[33].xyz * f8.x)), vec3(CB0[21].w)) + (VARYING3 * ((1.0 - ((step(f9.x, VARYING1.z) * clamp(CB0[29].z + (CB0[29].w * abs(VARYING1.z - 0.5)), 0.0, 1.0)) * f9.y)) * f8.y))) * f3;
    vec4 f11 = vec4(0.0);
    f11.x = f10.x;
    vec4 f12 = f11;
    f12.y = f10.y;
