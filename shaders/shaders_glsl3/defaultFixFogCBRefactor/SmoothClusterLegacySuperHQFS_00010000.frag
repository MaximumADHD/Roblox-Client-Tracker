...
void main()
{
    ...
    f46.z = f45;
    vec4 f47 = f36;
    f47.x = CB5[f29 * 3 + 2].x * f26.y;
    vec4 f48 = f47;
    f48.y = (CB5[f29 * 3 + 2].y * f33) - (CB5[f29 * 3 + 2].z * f35);
    vec4 f49 = f48;
    f49.z = (CB5[f29 * 3 + 2].z * f33) + (CB5[f29 * 3 + 2].y * f35);
    vec4 f50 = f41;
    f50.x = CB5[f30 * 3 + 2].x * f27.y;
    vec4 f51 = f50;
    f51.y = (CB5[f30 * 3 + 2].y * f38) - (CB5[f30 * 3 + 2].z * f40);
    vec4 f52 = f51;
    f52.z = (CB5[f30 * 3 + 2].z * f38) + (CB5[f30 * 3 + 2].y * f40);
    vec4 f53 = f46;
    f53.x = CB5[f31 * 3 + 2].x * f28.y;
    vec4 f54 = f53;
    f54.y = (CB5[f31 * 3 + 2].y * f43) - (CB5[f31 * 3 + 2].z * f45);
    vec4 f55 = f54;
    f55.z = (CB5[f31 * 3 + 2].z * f43) + (CB5[f31 * 3 + 2].y * f45);
    ...
    float f113 = f107.y;
    float f114 = f107.z;
    vec3 f115 = ((((((f79.xyz * (f79.w * 120.0)) + ((((vec3(1.0) - (f94 * f71)) * CB0[15].xyz) * f87) + (CB0[17].xyz * clamp(-f85, 0.0, 1.0)))) + (((vec3(1.0) - (f104 * f71)) * ((((((((CB0[40].xyz * f109) + (CB0[42].xyz * f110)) + (CB0[44].xyz * f111)) + (CB0[41].xyz * f112)) + (CB0[43].xyz * f113)) + (CB0[45].xyz * f114)) * CB0[30].w) + ((((((((CB0[34].xyz * f109) + (CB0[36].xyz * f110)) + (CB0[38].xyz * f111)) + (CB0[35].xyz * f112)) + (CB0[37].xyz * f113)) + (CB0[39].xyz * f114)) * CB0[30].w) * f81))) * 1.0)) + ((CB0[32].xyz + (CB0[33].xyz * f81)) * 1.0)) + vec3((f25.z * 2.0) * f60)) * (f59 * f59)) + (((((f94 * (((f95 + (f95 * f95)) / (((f96 * f96) * ((f90 * 3.0) + 0.5)) * ((f89 * 0.75) + 0.25))) * f87)) * CB0[15].xyz) * 1.0) * (f60 * VARYING0.w)) + ((mix(f100, textureLod(PrefilteredEnvTexture, f98, f97).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f72.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f81)) * f104) * f71));
    vec4 f116 = vec4(0.0);
    f116.x = f115.x;
    vec4 f117 = f116;
    f117.y = f115.y;
