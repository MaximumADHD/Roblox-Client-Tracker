...
void main()
{
    ...
    vec4 f9 = vec4(VARYING1, 1.0) * mat4(CB4[((dot(f6, f6) < CB0[46].w) ? 0 : ((dot(f7, f7) < CB0[47].w) ? 1 : ((dot(f8, f8) < CB0[48].w) ? 2 : 3))) * 4 + 0], CB4[((dot(f6, f6) < CB0[46].w) ? 0 : ((dot(f7, f7) < CB0[47].w) ? 1 : ((dot(f8, f8) < CB0[48].w) ? 2 : 3))) * 4 + 1], CB4[((dot(f6, f6) < CB0[46].w) ? 0 : ((dot(f7, f7) < CB0[47].w) ? 1 : ((dot(f8, f8) < CB0[48].w) ? 2 : 3))) * 4 + 2], CB4[((dot(f6, f6) < CB0[46].w) ? 0 : ((dot(f7, f7) < CB0[47].w) ? 1 : ((dot(f8, f8) < CB0[48].w) ? 2 : 3))) * 4 + 3]);
    ...
    float f14 = exp(CB0[51].z * f13);
    float f15 = -exp((-CB0[51].w) * f13);
    vec2 f16 = (f12 * CB0[52].y) * vec2(f14, f15);
    vec2 f17 = f16 * f16;
    float f18 = f10.x;
    ...
    float f23 = f15 - f21;
    float f24 = ((CB0[52].x > 0.0) ? mix(min((f14 <= f18) ? 1.0 : clamp(((f19 / (f19 + (f20 * f20))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0), (f15 <= f21) ? 1.0 : clamp(((f22 / (f22 + (f23 * f23))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0)), f5, clamp((length(VARYING1 - CB0[11].xyz) * CB0[51].y) - (CB0[51].x * CB0[51].y), 0.0, 1.0)) : f5) * CB0[14].w;
