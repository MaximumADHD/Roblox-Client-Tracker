...
void main()
{
    ...
    vec4 f37 = vec4(f23, 1.0) * mat4(CB4[((dot(f34, f34) < CB0[46].w) ? 0 : ((dot(f35, f35) < CB0[47].w) ? 1 : ((dot(f36, f36) < CB0[48].w) ? 2 : 3))) * 4 + 0], CB4[((dot(f34, f34) < CB0[46].w) ? 0 : ((dot(f35, f35) < CB0[47].w) ? 1 : ((dot(f36, f36) < CB0[48].w) ? 2 : 3))) * 4 + 1], CB4[((dot(f34, f34) < CB0[46].w) ? 0 : ((dot(f35, f35) < CB0[47].w) ? 1 : ((dot(f36, f36) < CB0[48].w) ? 2 : 3))) * 4 + 2], CB4[((dot(f34, f34) < CB0[46].w) ? 0 : ((dot(f35, f35) < CB0[47].w) ? 1 : ((dot(f36, f36) < CB0[48].w) ? 2 : 3))) * 4 + 3]);
    ...
    float f84 = f78.y;
    float f85 = f78.z;
    vec3 f86 = ((((f54 + (((vec3(f75) - (f74 * (f21 * f75))) * ((((((((CB0[40].xyz * f80) + (CB0[42].xyz * f81)) + (CB0[44].xyz * f82)) + (CB0[41].xyz * f83)) + (CB0[43].xyz * f84)) + (CB0[45].xyz * f85)) * CB0[30].w) + ((((((((CB0[34].xyz * f80) + (CB0[36].xyz * f81)) + (CB0[38].xyz * f82)) + (CB0[35].xyz * f83)) + (CB0[37].xyz * f84)) + (CB0[39].xyz * f85)) * CB0[30].w) * f32))) * 1.0)) + ((CB0[32].xyz + (CB0[33].xyz * (f32 * (2.0 - CB0[14].w)))) * 1.0)) + vec3((f6.z * 2.0) * f14)) * f12) + ((f53 * (f14 * VARYING0.w)) + ((mix(f70, textureLod(PrefilteredEnvTexture, f68, f67).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f22.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f32)) * f74) * f21));
    vec4 f87 = vec4(0.0);
    f87.x = f86.x;
    vec4 f88 = f87;
    f88.y = f86.y;
