...
void main()
{
    ...
    vec4 f46 = vec4(f32, 1.0) * mat4(CB4[((dot(f43, f43) < CB0[46].w) ? 0 : ((dot(f44, f44) < CB0[47].w) ? 1 : ((dot(f45, f45) < CB0[48].w) ? 2 : 3))) * 4 + 0], CB4[((dot(f43, f43) < CB0[46].w) ? 0 : ((dot(f44, f44) < CB0[47].w) ? 1 : ((dot(f45, f45) < CB0[48].w) ? 2 : 3))) * 4 + 1], CB4[((dot(f43, f43) < CB0[46].w) ? 0 : ((dot(f44, f44) < CB0[47].w) ? 1 : ((dot(f45, f45) < CB0[48].w) ? 2 : 3))) * 4 + 2], CB4[((dot(f43, f43) < CB0[46].w) ? 0 : ((dot(f44, f44) < CB0[47].w) ? 1 : ((dot(f45, f45) < CB0[48].w) ? 2 : 3))) * 4 + 3]);
    ...
    float f93 = f87.y;
    float f94 = f87.z;
    vec3 f95 = (((f63 + (((vec3(f84) - (f83 * (f26 * f84))) * ((((((((CB0[40].xyz * f89) + (CB0[42].xyz * f90)) + (CB0[44].xyz * f91)) + (CB0[41].xyz * f92)) + (CB0[43].xyz * f93)) + (CB0[45].xyz * f94)) * CB0[30].w) + ((((((((CB0[34].xyz * f89) + (CB0[36].xyz * f90)) + (CB0[38].xyz * f91)) + (CB0[35].xyz * f92)) + (CB0[37].xyz * f93)) + (CB0[39].xyz * f94)) * CB0[30].w) * f41))) * 1.0)) + ((CB0[32].xyz + (CB0[33].xyz * (f41 * (2.0 - CB0[14].w)))) * 1.0)) * f23.xyz) + (f62 + ((mix(f79, textureLod(PrefilteredEnvTexture, f77, f76).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f29.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f41)) * f83) * f26));
    vec4 f96 = vec4(0.0);
    f96.x = f95.x;
    vec4 f97 = f96;
    f97.y = f95.y;
