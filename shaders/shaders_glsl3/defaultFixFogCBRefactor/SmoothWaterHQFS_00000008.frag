...
void main()
{
    ...
    vec4 f15 = vec4(f0, 1.0) * mat4(CB4[((dot(f12, f12) < CB0[46].w) ? 0 : ((dot(f13, f13) < CB0[47].w) ? 1 : ((dot(f14, f14) < CB0[48].w) ? 2 : 3))) * 4 + 0], CB4[((dot(f12, f12) < CB0[46].w) ? 0 : ((dot(f13, f13) < CB0[47].w) ? 1 : ((dot(f14, f14) < CB0[48].w) ? 2 : 3))) * 4 + 1], CB4[((dot(f12, f12) < CB0[46].w) ? 0 : ((dot(f13, f13) < CB0[47].w) ? 1 : ((dot(f14, f14) < CB0[48].w) ? 2 : 3))) * 4 + 2], CB4[((dot(f12, f12) < CB0[46].w) ? 0 : ((dot(f13, f13) < CB0[47].w) ? 1 : ((dot(f14, f14) < CB0[48].w) ? 2 : 3))) * 4 + 3]);
    ...
    if (f59 > 0.0)
    {
        ...
        f60 = (((vec3(f67) + (vec3(0.0199999995529651641845703125) * (1.0 - f67))) * (((f68 + (f68 * f68)) / (((f69 * f69) * ((f64 * 3.0) + 0.5)) * ((f63 * 0.75) + 0.25))) * clamp(f59, 0.0, 1.0))) * CB0[15].xyz) * (CB0[14].w * CB0[14].w);
    }
    else
    {
        f60 = vec3(0.0);
    }
    vec3 f70 = mix(((min(f9 + (CB0[32].xyz + (CB0[33].xyz * (f10 * (2.0 - CB0[14].w)))), vec3(CB0[21].w)) + ((((((((CB0[40].xyz * f52) + (CB0[42].xyz * f53)) + (CB0[44].xyz * f54)) + (CB0[41].xyz * f55)) + (CB0[43].xyz * f56)) + (CB0[45].xyz * f57)) * CB0[30].w) + ((((((((CB0[34].xyz * f52) + (CB0[36].xyz * f53)) + (CB0[38].xyz * f54)) + (CB0[35].xyz * f55)) + (CB0[37].xyz * f56)) + (CB0[39].xyz * f57)) * CB0[30].w) * f10))) + (CB0[15].xyz * f30)) * CB3[1].xyz, ((textureLod(PrefilteredEnvTexture, vec4(f47, 0.0).xyz, 0.0).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f47.y * 1.58823525905609130859375, 0.0, 1.0)))) * f10) + (f9 * 0.100000001490116119384765625), vec3((clamp(0.7799999713897705078125 - (2.5 * abs(dot(f44, f45))), 0.0, 1.0) + 0.300000011920928955078125) * (VARYING0.w * CB3[2].z))) + (f60 * clamp(1.0 - (VARYING7.w * CB0[28].y), 0.0, 1.0));
    vec4 f71 = vec4(0.0);
    f71.x = f70.x;
    vec4 f72 = f71;
    f72.y = f70.y;
    ...
    vec4 f74 = f73;
    f74.w = 1.0;
    vec3 f75 = textureLod(PrefilteredEnvTexture, vec4(f46, 0.0).xyz, max(CB0[18].y, VARYING6.w) * 5.0).xyz;
