...
void main()
{
    ...
    float f16 = f15.y;
    vec3 f17 = (((VARYING6.xyz * f16) + min((f14.xyz * (f14.w * 120.0)) + (CB0[13].xyz + (CB0[14].xyz * f15.x)), vec3(CB0[21].w))) * (f9.xyz * VARYING2.w)) + (CB0[15].xyz * ((VARYING6.w * f16) * 0.100000001490116119384765625));
    vec4 f18 = vec4(0.0);
    f18.x = f17.x;
    vec4 f19 = f18;
    f19.y = f17.y;
    ...
    vec4 f32 = f31;
    f32.z = f29.z;
    float f33 = 1.0 - ((1.0 - VARYING2.w) * f22);
    vec4 f34 = f32;
    f34.w = f33;
    vec4 f35 = f34;
    f35.w = f33;
