...
void main()
{
    ...
    vec4 v20 = CB1[gl_InstanceID * 7 + 4] * mix(vec4(COLOR0.xyz, TEXCOORD1.w) * 0.0039215688593685626983642578125, vec4(1.0), vec4(max(sign(CB1[gl_InstanceID * 7 + 3].w), 0.0)));
    vec3 v21 = CB0[11].xyz - v11;
    vec3 v22 = -CB0[16].xyz;
    float v23 = dot(v15, v22);
    vec4 v24 = vec4(v8, v9, v10, 1.0);
    vec4 v25 = v24 * mat4(CB0[0], CB0[1], CB0[2], CB0[3]);
    vec3 v26 = ((v11 + (v15 * 6.0)).yxz * CB0[21].xyz) + CB0[22].xyz;
    vec4 v27 = vec4(0.0);
    v27.x = v26.x;
    vec4 v28 = v27;
    v28.y = v26.y;
    ...
    vec4 v36 = vec4(dot(CB0[25], v24), dot(CB0[26], v24), dot(CB0[27], v24), 0.0);
    ...
    vec3 v39 = (CB0[15].xyz * v38) + (CB0[17].xyz * clamp(-v23, 0.0, 1.0));
    vec4 v40 = vec4(0.0);
    v40.x = v39.x;
    vec4 v41 = v40;
    v41.y = v39.y;
    ...
    v42.z = v39.z;
    vec4 v43 = v42;
    v43.w = (v38 * CB0[28].w) * (CB1[gl_InstanceID * 7 + 6].z * exp2((v37 * dot(v15, normalize(v22 + normalize(v21)))) - v37));
    gl_Position = v25;
