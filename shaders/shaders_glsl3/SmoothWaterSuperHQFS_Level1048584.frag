...
void main()
{
    ...
    vec3 f95 = normalize(f1 + f39);
    float f96 = f34 * f34;
    float f97 = max(0.001000000047497451305389404296875, dot(f37, f95));
    ...
    vec4 f108 = f107;
    f108.w = 1.0;
    vec3 f109 = textureLod(PrefilteredEnvTexture, vec4(f61, 0.0).xyz, max(CB0[13].y, VARYING6.w) * 5.0).xyz;
