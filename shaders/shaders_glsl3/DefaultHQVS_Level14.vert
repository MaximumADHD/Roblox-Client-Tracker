...
void main()
{
    ...
    vec3 v20 = ((v15 + (vec3(v16, v17, v18) * 6.0)).yxz * CB0[16].xyz) + CB0[17].xyz;
    vec4 v21 = vec4(v20.x, v20.y, v20.z, vec4(0.0).w);
    v21.w = 0.0;
    vec4 v22 = vec4(v12, v13, v14, 0.0);
    v22.w = COLOR1.z * 0.0039215688593685626983642578125;
    vec4 v23 = vec4(v16, v17, v18, 0.0);
    v23.w = inversesqrt(0.1745329201221466064453125 * COLOR1.y);
    gl_Position = v19;
    VARYING0 = TEXCOORD0;
    VARYING1 = TEXCOORD1;
    VARYING2 = COLOR0;
