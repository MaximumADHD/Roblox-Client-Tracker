...
void main()
{
    ...
    vec4 v24 = vec4(v12, v13, v14, 1.0) * mat4(CB0[0], CB0[1], CB0[2], CB0[3]);
    vec3 v25 = v21;
    v25.x = TEXCOORD1.x;
    vec3 v26 = v25;
    v26.y = TEXCOORD1.y;
    ...
    v38.z = v35.z;
    vec4 v39 = v38;
    v39.w = (v34 * CB0[28].w) * (COLOR1.y * exp2((v33 * dot(v19, normalize(v22 + normalize(v20)))) - v33));
    gl_Position = v24;
    VARYING0 = TEXCOORD0;
    VARYING1 = v26;
    VARYING2 = COLOR0;
