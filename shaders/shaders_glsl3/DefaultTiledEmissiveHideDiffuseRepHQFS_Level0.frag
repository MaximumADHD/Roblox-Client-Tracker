...
void main()
{
    ...
    float f41 = f31.z;
    vec3 f42 = -CB0[16].xyz;
    float f43 = (dot(f20, f42) * CB0[14].w) * ((1.0 - ((step(f40.x, f41) * clamp(CB0[29].z + (CB0[29].w * abs(f41 - 0.5)), 0.0, 1.0)) * f40.y)) * f38.y);
