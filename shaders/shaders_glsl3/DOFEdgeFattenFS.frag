...
void main()
{
    ...
    vec4 f1 = texture(colorTexture, VARYING0 + f0.xy);
    vec4 f2 = texture(colorTexture, VARYING0 + f0.zy);
    vec4 f3 = texture(colorTexture, VARYING0 + f0.xw);
    vec4 f4 = texture(colorTexture, VARYING0 + f0.zw);
    vec4 f5 = texture(colorTexture, VARYING0);
    float f6 = f1.w;
    float f7 = f2.w;
    float f8 = f4.w;
    float f9 = f3.w;
