...
void main()
{
    ...
    gl_Position = v4;
    VARYING0 = vec4(vec3(v18.x ? vec3(1.0).x : vec3(0.0).x, v18.y ? vec3(1.0).y : vec3(0.0).y, v18.z ? vec3(1.0).z : vec3(0.0).z), (abs(POSITION.w) > 3.0) ? 0.0 : 1.0);
    ...
    VARYING6 = v1;
    VARYING7 = vec3(v19.x ? vec3(1.0).x : vec3(0.0).x, v19.y ? vec3(1.0).y : vec3(0.0).y, v19.z ? vec3(1.0).z : vec3(0.0).z);
    VARYING8 = v5;
