...
void main()
{
    ...
    float f4 = f3.w;
    vec4 f5 = vec4(mix(vec4(texture(DiffuseMapTexture, VARYING0).xyz * VARYING2.xyz, f4).xyz, f3.xyz, vec3(f4)), f4);
