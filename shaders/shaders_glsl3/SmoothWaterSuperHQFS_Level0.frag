...
void main()
{
    ...
    vec4 f87 = f86;
    f87.w = 1.0;
    vec3 f88 = textureLod(PrefilteredEnvTexture, vec4(f39, 0.0).xyz, max(CB0[13].y, VARYING6.w) * 5.0).xyz;
    bvec3 f89 = bvec3(!(CB0[13].w == 0.0));
    vec3 f90 = mix(vec3(f89.x ? CB0[14].xyz.x : f88.x, f89.y ? CB0[14].xyz.y : f88.y, f89.z ? CB0[14].xyz.z : f88.z), f87.xyz, vec3(VARYING6.w));
    vec4 f91 = f87;
    f91.x = f90.x;
    vec4 f92 = f91;
    f92.y = f90.y;
