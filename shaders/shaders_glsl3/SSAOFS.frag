...
void main()
{
    vec4 f0 = textureLod(depthBufferTexture, VARYING0, 0.0);
    float f1 = f0.x;
    ...
    for (int f11 = 0; f11 < 8; )
    {
        ...
        vec2 f18 = f10;
        f18.x = textureLod(depthBufferTexture, VARYING0 + f17, f7).x;
        vec2 f19 = f18;
        f19.y = textureLod(depthBufferTexture, VARYING0 - f17, f7).x;
