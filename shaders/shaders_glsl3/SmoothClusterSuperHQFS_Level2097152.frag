...
void main()
{
    ...
    float f60 = f50.z;
    vec3 f61 = -CB0[16].xyz;
    float f62 = (dot(f45, f61) * CB0[14].w) * ((1.0 - ((step(f59.x, f60) * clamp(CB0[29].z + (CB0[29].w * abs(f60 - 0.5)), 0.0, 1.0)) * f59.y)) * f57.y);
