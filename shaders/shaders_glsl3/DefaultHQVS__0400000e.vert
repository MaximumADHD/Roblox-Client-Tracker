...
void main()
{
    ...
    vec4 v21 = vec4(v14, v15, v16, 1.0) * mat4(CB0[0], CB0[1], CB0[2], CB0[3]);
    vec3 v22 = ((v17 + (vec3(v18, v19, v20) * 6.0)).yxz * CB0[21].xyz) + CB0[22].xyz;
    vec4 v23 = vec4(0.0);
    v23.x = v22.x;
    vec4 v24 = v23;
    v24.y = v22.y;
    ...
    vec4 v26 = v25;
    v26.w = 0.0;
    vec4 v27 = vec4(v14, v15, v16, 0.0);
    v27.w = COLOR1.z * 0.0039215688593685626983642578125;
    vec4 v28 = vec4(v18, v19, v20, 0.0);
    v28.w = inversesqrt(COLOR1.y * 0.174534320831298828125);
    gl_Position = v21;
    VARYING0 = TEXCOORD0;
    VARYING1 = COLOR0;
    VARYING2 = v26;
    VARYING3 = vec4(CB0[11].xyz - v17, v21.w);
    VARYING4 = v28;
    VARYING5 = v27;
}
