...
void main()
{
    ...
    float f40 = f32.z;
    vec3 f41 = -CB0[16].xyz;
    float f42 = (dot(f17, f41) * CB0[14].w) * ((1.0 - ((step(f39.x, f40) * clamp(CB0[29].z + (CB0[29].w * abs(f40 - 0.5)), 0.0, 1.0)) * f39.y)) * f37.y);
