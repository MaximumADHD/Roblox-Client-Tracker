...
void main()
{
    ...
    f36.w = f35;
    vec3 f37 = mix(CB0[14].xyz, sqrt(clamp(f36.xyz * CB0[15].y, vec3(0.0), vec3(1.0))).xyz, vec3(clamp((CB0[13].x * length(VARYING4.xyz)) + CB0[13].y, 0.0, 1.0)));
    vec4 f38 = vec4(f37.x, f37.y, f37.z, f36.w);
    f38.w = f35;
