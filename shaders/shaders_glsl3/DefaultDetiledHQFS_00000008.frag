...
void main()
{
    ...
    if (f76 > 0.0)
    {
        vec3 f79 = normalize(f1 - CB0[16].xyz);
        ...
        f77 = ((f87 * (((f88 + (f88 * f88)) / max(((f89 * f89) * ((f83 * 3.0) + 0.5)) * ((f82 * 0.75) + 0.25), 3.0999999580672010779380798339844e-05)) * f80)) * CB0[15].xyz) * (CB0[14].w * CB0[14].w);
    }
    else
    {
        f78 = f55;
