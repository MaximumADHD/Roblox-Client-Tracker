...
void main()
{
    ...
    vec3 f35 = (((((((((vec3(1.0) - (f32 * (CB0[26].w * f11))) * 1.0) * CB0[10].xyz) * f25) + ((CB0[12].xyz * 1.0) * clamp(-f24, 0.0, 1.0))) * f20) + min((f17.xyz * (f17.w * 120.0)).xyz + (CB0[8].xyz + (CB0[9].xyz * f18.x)), vec3(CB0[16].w))) + vec3((f13.z * 2.0) * f11)) * (f10 * f10).xyz) + ((((((f32 * ((f33 + (f33 * f33)) / (((f34 * f34) * ((f28 * 3.0) + 0.5)) * ((f27 * 0.75) + 0.25)))) * CB0[10].xyz) * f25) * f20) * f11) * VARYING0.w);
