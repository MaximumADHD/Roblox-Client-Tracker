...
void main()
{
    ...
    vec4 v19 = vec4(v17.x, v17.y, vec4(0.0).z, vec4(0.0).w);
    v19.x = max(0.0500000007450580596923828125, mix((COLOR0 * 0.0039215688593685626983642578125).x, 0.0, float(CB1[gl_InstanceID * 7 + 3].w > 0.0)));
    float v20 = v18.w;
    vec4 v21 = (vec4(10.0) * CB0[23].z) + vec4((0.5 * v20) * CB0[23].y);
    vec4 v22 = vec4(v9 - (CB0[11].xyz * abs(CB1[gl_InstanceID * 7 + 3].w)), 0.0);
    v22.w = CB1[gl_InstanceID * 7 + 6].w;
    vec4 v23 = vec4(v10, v11, v12, CB1[gl_InstanceID * 7 + 6].w);
    v23.w = inversesqrt(0.1745329201221466064453125 * CB1[gl_InstanceID * 7 + 6].z);
    gl_Position = v18;
    VARYING0 = vec4(v15.x, v15.y, v21.x, v21.y);
    VARYING1 = vec4(v19.x, v19.y, v21.z, v21.w);
    VARYING2 = CB1[gl_InstanceID * 7 + 4];
    VARYING3 = ((v9 + (vec3(v10, v11, v12) * 6.0)).yxz * CB0[16].xyz) + CB0[17].xyz;
    VARYING4 = vec4(CB0[7].xyz - v9, v20);
    VARYING5 = v23;
    VARYING6 = v22;
