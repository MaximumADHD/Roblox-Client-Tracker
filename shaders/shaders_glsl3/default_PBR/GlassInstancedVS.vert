...
void main()
{
    ...
    float v27 = (clamp(2.0 - (dot(v13, normalize(v24.xyz)) * 3.0), 0.0, 1.0) * 0.300000011920928955078125) * clamp(v25, 0.0, 1.0);
    vec4 v28 = v18;
    ...
    v33.w = (v31 * CB0[23].w) * (CB1[gl_InstanceID * 7 + 6].z * exp2((v30 * dot(v13, normalize(v19 + normalize(v21)))) - v30));
    gl_Position = v23;
