...
void main()
{
    ...
    vec3 f8 = (f0 * f0).xyz;
    vec3 f9 = (((VARYING5.xyz * f7) + min((f4.xyz * (f4.w * 120.0)).xyz + (CB0[8].xyz + (CB0[9].xyz * f5.x)), vec3(CB0[16].w))) * f8) + ((CB0[10].xyz * mix(vec3(0.100000001490116119384765625), f8, vec3(VARYING6.w))) * (VARYING5.w * f7));
