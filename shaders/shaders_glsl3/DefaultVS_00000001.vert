...
void main()
{
    ...
    vec3 v19 = vec3(0.0);
    v19.z = TEXCOORD2.w - 1.0;
    vec3 v20 = -CB0[16].xyz;
    float v21 = dot(v12, v20);
    ...
    vec3 v25 = v24;
    v25.y = v17.y;
    vec3 v26 = ((v11 + (v12 * 6.0)).yxz * CB0[21].xyz) + CB0[22].xyz;
    vec4 v27 = vec4(0.0);
    v27.x = v26.x;
    vec4 v28 = v27;
    v28.y = v26.y;
    ...
    v36.z = v33.z;
    vec4 v37 = v36;
    v37.w = (v32 * CB0[28].w) * (CB1[gl_InstanceID * 7 + 6].z * exp2((v31 * dot(v12, normalize(v20 + normalize(v18)))) - v31));
    vec4 v38 = vec4(dot(CB0[25], v22), dot(CB0[26], v22), dot(CB0[27], v22), 0.0);
    v38.w = CB1[gl_InstanceID * 7 + 6].w;
    gl_Position = v23;
