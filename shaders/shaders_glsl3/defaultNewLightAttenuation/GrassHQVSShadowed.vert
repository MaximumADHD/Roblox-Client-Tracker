...
void main()
{
    ...
    vec3 v20 = v18;
    v20.y = v19;
    vec3 v21 = CB0[11].xyz - v20;
    float v22 = length(v21);
    vec3 v23 = (NORMAL.xyz * 2.0) - vec3(1.0);
    vec3 v24 = -CB0[16].xyz;
    float v25 = abs(dot(v23, v24));
    float v26 = exp2((((-clamp(NORMAL.w, 0.0, 1.0)) * CB2[3].x) + CB2[3].y) * CB2[1].x);
    vec3 v27 = v21 / vec3(v22);
    vec3 v28 = normalize(v24 + v27);
    float v29 = 1.0 - clamp(((v22 - CB2[1].y) + 40.0) * 0.02500000037252902984619140625, 0.0, 1.0);
    vec4 v30 = vec4(0.0);
    v30.x = (v25 * 0.5) + 0.5;
    vec4 v31 = v30;
    v31.y = abs(dot(v28, v23));
    vec4 v32 = v31;
    ...
    VARYING0 = vec4(((v20 + vec3(0.0, 6.0, 0.0)).yxz * CB0[21].xyz) + CB0[22].xyz, clamp(exp2((CB0[18].z * v22) + CB0[18].x) - CB0[18].w, 0.0, 1.0));
    VARYING1 = v20;
