...
void main()
{
    ...
    vec4 v25 = vec4(v8, v9, v10, 1.0) * mat4(CB0[0], CB0[1], CB0[2], CB0[3]);
    vec3 v26 = v22;
    v26.x = v20.x;
    vec3 v27 = v26;
    v27.y = v20.y;
    vec3 v28 = ((v11 + (v15 * 6.0)).yxz * CB0[21].xyz) + CB0[22].xyz;
    vec4 v29 = vec4(0.0);
    v29.x = v28.x;
    vec4 v30 = v29;
    v30.y = v28.y;
    ...
    v39.z = v36.z;
    vec4 v40 = v39;
    v40.w = (v35 * CB0[28].w) * (CB1[gl_InstanceID * 7 + 6].z * exp2((v34 * dot(v15, normalize(v23 + normalize(v21)))) - v34));
    gl_Position = v25;
