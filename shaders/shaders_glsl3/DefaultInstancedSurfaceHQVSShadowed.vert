...
void main()
{
    ...
    vec4 v21 = vec4(v10 - (CB0[11].xyz * abs(CB1[gl_InstanceID * 7 + 3].w)), 0.0);
    v21.w = CB1[gl_InstanceID * 7 + 5].w;
    vec4 v22 = vec4(v11, v12, v13, 0.0);
    v22.w = 0.0;
    gl_Position = v20;
    ...
    VARYING4 = vec4(CB0[7].xyz - v10, v20.w);
    VARYING5 = v22;
