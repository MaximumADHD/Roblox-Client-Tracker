...
void main()
{
    ...
    vec4 v22 = vec4(v7, v8, v9, 1.0) * mat4(CB0[0], CB0[1], CB0[2], CB0[3]);
    float v23 = v22.w;
    ...
    vec4 v26 = vec4(v11, v12, v13, 0.0);
    v26.w = 0.0;
    gl_Position = v22;
    VARYING0 = vec4(v17.x, v17.y, v24.x, v24.y);
    VARYING1 = vec4(v20.x, v20.y, v24.z, v24.w);
    ...
    VARYING5 = v26;
    VARYING6 = vec4(v14.x, v14.y, v14.z, v21.w);
    VARYING7 = v25;
