...
void main()
{
    ...
    float f114 = f108.y;
    float f115 = f108.z;
    vec3 f116 = ((((((f80.xyz * (f80.w * 120.0)) + ((((vec3(1.0) - (f95 * f72)) * CB0[15].xyz) * f88) + (CB0[17].xyz * clamp(-f86, 0.0, 1.0)))) + (((vec3(1.0) - (f105 * f72)) * (((((((CB0[40].xyz * f110) + (CB0[42].xyz * f111)) + (CB0[44].xyz * f112)) + (CB0[41].xyz * f113)) + (CB0[43].xyz * f114)) + (CB0[45].xyz * f115)) + (((((((CB0[34].xyz * f110) + (CB0[36].xyz * f111)) + (CB0[38].xyz * f112)) + (CB0[35].xyz * f113)) + (CB0[37].xyz * f114)) + (CB0[39].xyz * f115)) * f82))) * 1.0)) + ((CB0[32].xyz + (CB0[33].xyz * f82)) * 1.0)) + vec3((f26.z * 2.0) * f69)) * (f68 * f68)) + (((((f95 * (((f96 + (f96 * f96)) / max(((f97 * f97) * ((f91 * 3.0) + 0.5)) * ((f90 * 0.75) + 0.25), 7.0000001869630068540573120117188e-05)) * f88)) * CB0[15].xyz) * 1.0) * (f69 * VARYING0.w)) + ((mix(f101, textureLod(PrefilteredEnvTexture, f99, f98).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f73.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f82)) * f105) * f72));
    vec4 f117 = vec4(0.0);
    f117.x = f116.x;
    vec4 f118 = f117;
    f118.y = f116.y;
