...
void main()
{
    ...
    vec4 f21 = f19;
    f21.w = f20;
    float f22 = clamp(exp2((CB0[18].z * f6) + CB0[18].x) - CB0[18].w, 0.0, 1.0);
    vec3 f23 = textureLod(PrefilteredEnvTexture, vec4(-(VARYING4.xyz / vec3(f6)), 0.0).xyz, max(CB0[18].y, f22) * 5.0).xyz;
