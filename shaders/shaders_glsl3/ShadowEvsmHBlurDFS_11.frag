...
void main()
{
    ...
    float f3 = -CB1[2].w;
    float f4 = -exp(f3 * f1);
    float f5 = (2.0 * texture(EvsmTexture0Texture, (CB1[2].xy * vec2(-5.0, 0.0)) + VARYING0).x) - 1.0;
    float f6 = (2.0 * (((CB1[3].y / (f5 - CB1[3].x)) * CB1[3].z) + (f5 * CB1[3].w))) - 1.0;
    float f7 = exp(CB1[2].z * f6);
    float f8 = -exp(f3 * f6);
    float f9 = (2.0 * texture(EvsmTexture0Texture, (CB1[2].xy * vec2(-4.0, 0.0)) + VARYING0).x) - 1.0;
    float f10 = (2.0 * (((CB1[3].y / (f9 - CB1[3].x)) * CB1[3].z) + (f9 * CB1[3].w))) - 1.0;
    float f11 = exp(CB1[2].z * f10);
    float f12 = -exp(f3 * f10);
    float f13 = (2.0 * texture(EvsmTexture0Texture, (CB1[2].xy * vec2(-3.0, 0.0)) + VARYING0).x) - 1.0;
    ...
    float f21 = (2.0 * texture(EvsmTexture0Texture, (CB1[2].xy * vec2(-1.0, 0.0)) + VARYING0).x) - 1.0;
    ...
    float f33 = (2.0 * texture(EvsmTexture0Texture, (CB1[2].xy * vec2(3.0, 0.0)) + VARYING0).x) - 1.0;
    float f34 = (2.0 * (((CB1[3].y / (f33 - CB1[3].x)) * CB1[3].z) + (f33 * CB1[3].w))) - 1.0;
    float f35 = exp(CB1[2].z * f34);
    float f36 = -exp(f3 * f34);
    float f37 = (2.0 * texture(EvsmTexture0Texture, (CB1[2].xy * vec2(4.0, 0.0)) + VARYING0).x) - 1.0;
    float f38 = (2.0 * (((CB1[3].y / (f37 - CB1[3].x)) * CB1[3].z) + (f37 * CB1[3].w))) - 1.0;
    float f39 = exp(CB1[2].z * f38);
    float f40 = -exp(f3 * f38);
    float f41 = (2.0 * texture(EvsmTexture0Texture, (CB1[2].xy * vec2(5.0, 0.0)) + VARYING0).x) - 1.0;
    float f42 = (2.0 * (((CB1[3].y / (f41 - CB1[3].x)) * CB1[3].z) + (f41 * CB1[3].w))) - 1.0;
    float f43 = exp(CB1[2].z * f42);
    float f44 = -exp(f3 * f42);
    _entryPointOutput = ((((((((((vec4(f2, f2 * f2, f4, f4 * f4) * CB1[4].x) + (vec4(f7, f7 * f7, f8, f8 * f8) * CB1[5].y)) + (vec4(f11, f11 * f11, f12, f12 * f12) * CB1[5].x)) + (vec4(f15, f15 * f15, f16, f16 * f16) * CB1[4].w)) + (vec4(f19, f19 * f19, f20, f20 * f20) * CB1[4].z)) + (vec4(f23, f23 * f23, f24, f24 * f24) * CB1[4].y)) + (vec4(f27, f27 * f27, f28, f28 * f28) * CB1[4].y)) + (vec4(f31, f31 * f31, f32, f32 * f32) * CB1[4].z)) + (vec4(f35, f35 * f35, f36, f36 * f36) * CB1[4].w)) + (vec4(f39, f39 * f39, f40, f40 * f40) * CB1[5].x)) + (vec4(f43, f43 * f43, f44, f44 * f44) * CB1[5].y);
}
