...
void main()
{
    ...
    float f8 = f7.y;
    vec3 f9 = VARYING7.xyz - CB0[41].xyz;
    vec3 f10 = VARYING7.xyz - CB0[42].xyz;
    vec3 f11 = VARYING7.xyz - CB0[43].xyz;
    vec4 f12 = vec4(VARYING7.xyz, 1.0) * mat4(CB8[((dot(f9, f9) < CB0[41].w) ? 0 : ((dot(f10, f10) < CB0[42].w) ? 1 : ((dot(f11, f11) < CB0[43].w) ? 2 : 3))) * 4 + 0], CB8[((dot(f9, f9) < CB0[41].w) ? 0 : ((dot(f10, f10) < CB0[42].w) ? 1 : ((dot(f11, f11) < CB0[43].w) ? 2 : 3))) * 4 + 1], CB8[((dot(f9, f9) < CB0[41].w) ? 0 : ((dot(f10, f10) < CB0[42].w) ? 1 : ((dot(f11, f11) < CB0[43].w) ? 2 : 3))) * 4 + 2], CB8[((dot(f9, f9) < CB0[41].w) ? 0 : ((dot(f10, f10) < CB0[42].w) ? 1 : ((dot(f11, f11) < CB0[43].w) ? 2 : 3))) * 4 + 3]);
    ...
    float f17 = exp(CB0[45].z * f16);
    float f18 = -exp((-CB0[45].w) * f16);
    vec2 f19 = (f15 * CB0[46].y) * vec2(f17, f18);
    vec2 f20 = f19 * f19;
    float f21 = f13.x;
    ...
    float f26 = f18 - f24;
    float f27 = (dot(f0, f1) > 0.0) ? mix(f8, mix(min((f17 <= f21) ? 1.0 : clamp(((f22 / (f22 + (f23 * f23))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0), (f18 <= f24) ? 1.0 : clamp(((f25 / (f25 + (f26 * f26))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0)), f8, clamp((length(VARYING7.xyz - CB0[7].xyz) * CB0[45].y) - (CB0[45].x * CB0[45].y), 0.0, 1.0)), CB0[46].x) : 0.0;
