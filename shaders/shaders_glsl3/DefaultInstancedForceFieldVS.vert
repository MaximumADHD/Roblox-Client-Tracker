...
void main()
{
    ...
    VARYING6 = vec4((CB0[10].xyz * max(v22, 0.0)) + (CB0[12].xyz * max(-v22, 0.0)), ((float(v22 > 0.0) * pow(clamp(dot(v15, normalize(v21 + normalize(v23))), 0.0, 1.0), CB1[gl_InstanceID * 7 + 6].w)) * (CB1[gl_InstanceID * 7 + 6].z * 0.0039215688593685626983642578125)) * CB0[23].w);
