...
void main()
{
    ...
    vec4 _286 = mix(texture(LightMapTexture, _275), vec4(0.0), _285);
    vec4 _291 = mix(texture(LightGridSkylightTexture, _275), vec4(1.0), _285);
    ...
    _entryPointOutput = vec4(_357.x, _357.y, _357.z, _396.w);
}
