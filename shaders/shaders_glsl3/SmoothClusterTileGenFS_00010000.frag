...
void main()
{
    ...
    f50.z = f49;
    vec4 f51 = f40;
    f51.x = CB4[f33 * 1 + 0].x * f30.y;
    vec4 f52 = f51;
    f52.y = (CB4[f33 * 1 + 0].y * f37) - (CB4[f33 * 1 + 0].z * f39);
    vec4 f53 = f52;
    f53.z = (CB4[f33 * 1 + 0].z * f37) + (CB4[f33 * 1 + 0].y * f39);
    vec4 f54 = f45;
    f54.x = CB4[f34 * 1 + 0].x * f31.y;
    vec4 f55 = f54;
    f55.y = (CB4[f34 * 1 + 0].y * f42) - (CB4[f34 * 1 + 0].z * f44);
    vec4 f56 = f55;
    f56.z = (CB4[f34 * 1 + 0].z * f42) + (CB4[f34 * 1 + 0].y * f44);
    vec4 f57 = f50;
    f57.x = CB4[f35 * 1 + 0].x * f32.y;
    vec4 f58 = f57;
    f58.y = (CB4[f35 * 1 + 0].y * f47) - (CB4[f35 * 1 + 0].z * f49);
    vec4 f59 = f58;
    f59.z = (CB4[f35 * 1 + 0].z * f47) + (CB4[f35 * 1 + 0].y * f49);
