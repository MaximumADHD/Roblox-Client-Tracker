...
void main()
{
    ...
    vec3 f19 = (min((f16.xyz * (f16.w * 120.0)) + (CB0[27].xyz + ((CB0[28].xyz * (2.0 - CB0[9].w)) * f17.x)), vec3(CB0[16].w)) + (VARYING6 * ((1.0 - ((step(f18.x, VARYING5.z) * clamp(CB0[24].z + (CB0[24].w * abs(VARYING5.z - 0.5)), 0.0, 1.0)) * f18.y)) * f17.y))) * (f12.xyz * f12.xyz);
    vec4 f20 = vec4(0.0);
    f20.x = f19.x;
    vec4 f21 = f20;
    f21.y = f19.y;
