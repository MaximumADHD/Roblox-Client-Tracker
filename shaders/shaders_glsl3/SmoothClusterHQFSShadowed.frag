...
void main()
{
    ...
    float f17 = f16.y;
    vec3 f18 = VARYING5.xyz - CB0[25].xyz;
    vec3 f19 = VARYING5.xyz - CB0[26].xyz;
    vec3 f20 = VARYING5.xyz - CB0[27].xyz;
    vec4 f21 = vec4(VARYING5.xyz, 1.0) * mat4(CB8[((dot(f18, f18) < CB0[25].w) ? 0 : ((dot(f19, f19) < CB0[26].w) ? 1 : ((dot(f20, f20) < CB0[27].w) ? 2 : 3))) * 4 + 0], CB8[((dot(f18, f18) < CB0[25].w) ? 0 : ((dot(f19, f19) < CB0[26].w) ? 1 : ((dot(f20, f20) < CB0[27].w) ? 2 : 3))) * 4 + 1], CB8[((dot(f18, f18) < CB0[25].w) ? 0 : ((dot(f19, f19) < CB0[26].w) ? 1 : ((dot(f20, f20) < CB0[27].w) ? 2 : 3))) * 4 + 2], CB8[((dot(f18, f18) < CB0[25].w) ? 0 : ((dot(f19, f19) < CB0[26].w) ? 1 : ((dot(f20, f20) < CB0[27].w) ? 2 : 3))) * 4 + 3]);
    ...
    float f26 = exp(CB0[29].z * f25);
    float f27 = -exp((-CB0[29].w) * f25);
    vec2 f28 = (f24 * CB0[30].y) * vec2(f26, f27);
    vec2 f29 = f28 * f28;
    float f30 = f22.x;
    ...
    float f35 = f27 - f33;
    float f36 = (f11 > 0.0) ? mix(f17, mix(min((f26 <= f30) ? 1.0 : clamp(((f31 / (f31 + (f32 * f32))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0), (f27 <= f33) ? 1.0 : clamp(((f34 / (f34 + (f35 * f35))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0)), f17, clamp((length(VARYING5.xyz - CB0[7].xyz) * CB0[29].y) - (CB0[29].x * CB0[29].y), 0.0, 1.0)), CB0[30].x) : 0.0;
    vec3 f37 = (((min(((f15.xyz * (f15.w * 120.0)).xyz + CB0[8].xyz) + (CB0[9].xyz * f16.x), vec3(CB0[16].w)) + (((CB0[10].xyz * clamp(f11, 0.0, 1.0)) + (CB0[12].xyz * max(-f11, 0.0))) * f36)) + vec3((f9.z * 2.0) * f7)) * (f6 * f6).xyz) + (CB0[10].xyz * (((((step(0.0, f11) * f9.x) * f7) * CB3[0].z) * f36) * pow(clamp(dot(f8, normalize(f10 + normalize(VARYING7.xyz))), 0.0, 1.0), (clamp(f9.y, 0.0, 1.0) * 128.0) + 0.00999999977648258209228515625)));
