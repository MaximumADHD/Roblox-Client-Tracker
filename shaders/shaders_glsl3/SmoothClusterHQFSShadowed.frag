...
void main()
{
    ...
    vec3 f73 = ((((((((((vec3(1.0) - (f52 * f42)) * 1.0) * CB0[10].xyz) * f45) * f38) + (f61 * (((((((CB0[35].xyz * f66) + (CB0[37].xyz * f67)) + (CB0[39].xyz * f68)) + (CB0[36].xyz * f69)) + (CB0[38].xyz * f70)) + (CB0[40].xyz * f71)) + (((((((CB0[29].xyz * f66) + (CB0[31].xyz * f67)) + (CB0[33].xyz * f68)) + (CB0[30].xyz * f69)) + (CB0[32].xyz * f70)) + (CB0[34].xyz * f71)) * f18)))) + (CB0[27].xyz + (CB0[28].xyz * f18))) + vec3((f9.z * 2.0) * f7)) * f40) + (((((((f52 * ((f53 + (f53 * f53)) / (((f54 * f54) * ((f48 * 3.0) + 0.5)) * ((f47 * 0.75) + 0.25)))) * CB0[10].xyz) * f45) * f38) * f7) * VARYING0.w) + f72)) + (f17 * mix(f40, f72 * (1.0 / (max(max(f72.x, f72.y), f72.z) + 0.00999999977648258209228515625)), ((vec3(1.0) - f61) * f42) * (1.0 - f18)));
