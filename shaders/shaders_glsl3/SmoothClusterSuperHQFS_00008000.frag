...
void main()
{
    ...
    float f88 = f82.y;
    float f89 = f82.z;
    vec3 f90 = ((((((f54.xyz * (f54.w * 120.0)) + ((((vec3(1.0) - (f69 * f46)) * CB0[15].xyz) * f62) + (CB0[17].xyz * clamp(-f60, 0.0, 1.0)))) + (((vec3(1.0) - (f79 * f46)) * (((((((CB0[40].xyz * f84) + (CB0[42].xyz * f85)) + (CB0[44].xyz * f86)) + (CB0[41].xyz * f87)) + (CB0[43].xyz * f88)) + (CB0[45].xyz * f89)) + (((((((CB0[34].xyz * f84) + (CB0[36].xyz * f85)) + (CB0[38].xyz * f86)) + (CB0[35].xyz * f87)) + (CB0[37].xyz * f88)) + (CB0[39].xyz * f89)) * f56))) * 1.0)) + ((CB0[32].xyz + (CB0[33].xyz * f56)) * 1.0)) + vec3((f26.z * 2.0) * f43)) * (f42 * f42)) + (((((f69 * (((f70 + (f70 * f70)) / max(((f71 * f71) * ((f65 * 3.0) + 0.5)) * ((f64 * 0.75) + 0.25), 7.0000001869630068540573120117188e-05)) * f62)) * CB0[15].xyz) * 1.0) * (f43 * VARYING0.w)) + ((mix(f75, textureLod(PrefilteredEnvTexture, f73, f72).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f47.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f56)) * f79) * f46));
    vec4 f91 = vec4(0.0);
    f91.x = f90.x;
    vec4 f92 = f91;
    f92.y = f90.y;
