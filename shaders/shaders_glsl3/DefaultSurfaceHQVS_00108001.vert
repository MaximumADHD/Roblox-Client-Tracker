...
void main()
{
    ...
    vec3 v1 = normalize(((vec3(TEXCOORD1.xy, COLOR0.w) * 0.0078740157186985015869140625) - vec3(1.0)) / (CB1[gl_InstanceID * 7 + 3].xyz + vec3(0.001000000047497451305389404296875)));
    ...
    vec3 v21 = v20;
    v21.y = v16.y;
    vec3 v22 = ((v9 + (vec3(v10, v11, v12) * 6.0)).yxz * CB0[21].xyz) + CB0[22].xyz;
    vec4 v23 = vec4(0.0);
    v23.x = v22.x;
    vec4 v24 = v23;
    v24.y = v22.y;
    ...
    v27.w = 0.0;
    vec4 v28 = v13;
    v28.x = dot(CB1[gl_InstanceID * 7 + 0].xyz, v0);
    vec4 v29 = v28;
    v29.y = dot(CB1[gl_InstanceID * 7 + 1].xyz, v0);
    vec4 v30 = v29;
    v30.z = dot(CB1[gl_InstanceID * 7 + 2].xyz, v0);
    vec4 v31 = vec4(v10, v11, v12, 0.0);
    v31.w = 0.0;
    gl_Position = v19;
    VARYING0 = TEXCOORD0;
    VARYING1 = v21;
    ...
    VARYING3 = v26;
    VARYING4 = vec4(CB0[11].xyz - v9, v19.w);
    VARYING5 = v31;
    VARYING6 = v30;
    VARYING7 = v27;
