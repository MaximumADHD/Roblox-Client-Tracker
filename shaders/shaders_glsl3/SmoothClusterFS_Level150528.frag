...
void main()
{
    ...
    vec3 f48 = (min((f45.xyz * (f45.w * 120.0)) + (CB0[27].xyz + ((CB0[28].xyz * (2.0 - CB0[9].w)) * f46.x)), vec3(CB0[16].w)) + (VARYING6 * ((1.0 - ((step(f47.x, VARYING5.z) * clamp(CB0[24].z + (CB0[24].w * abs(VARYING5.z - 0.5)), 0.0, 1.0)) * f47.y)) * f46.y))) * (f30 * f30);
    vec4 f49 = vec4(0.0);
    f49.x = f48.x;
    vec4 f50 = f49;
    f50.y = f48.y;
