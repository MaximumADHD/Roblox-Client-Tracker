...
void main()
{
    ...
    vec3 f7 = CB0[11].xyz - VARYING2.xyz;
    float f8 = clamp(1.0 - (VARYING2.w * CB0[28].y), 0.0, 1.0);
    vec3 f9 = -CB0[16].xyz;
    float f10 = dot(f3, f9);
    ...
    vec4 f83 = f82;
    f83.w = 1.0;
    float f84 = clamp(exp2((CB0[18].z * VARYING2.w) + CB0[18].x) - CB0[18].w, 0.0, 1.0);
