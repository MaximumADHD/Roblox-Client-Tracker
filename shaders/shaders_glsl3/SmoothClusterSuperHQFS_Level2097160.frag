...
void main()
{
    ...
    float f108 = f102.y;
    float f109 = f102.z;
    vec3 f110 = (((((((f59.xyz * (f59.w * 120.0)) * 1.0) + (((vec3(1.0) - (f89 * f51)) * CB0[15].xyz) * f82)) + ((vec3(1.0) - (f99 * f51)) * (((((((CB0[40].xyz * f104) + (CB0[42].xyz * f105)) + (CB0[44].xyz * f106)) + (CB0[41].xyz * f107)) + (CB0[43].xyz * f108)) + (CB0[45].xyz * f109)) + (((((((CB0[34].xyz * f104) + (CB0[36].xyz * f105)) + (CB0[38].xyz * f106)) + (CB0[35].xyz * f107)) + (CB0[37].xyz * f108)) + (CB0[39].xyz * f109)) * f61)))) + (CB0[32].xyz + ((CB0[33].xyz * (2.0 - CB0[14].w)) * f61))) + vec3((f28.z * 2.0) * f38)) * (f36 * f36)) + (((((f89 * (((f90 + (f90 * f90)) / (((f91 * f91) * ((f85 * 3.0) + 0.5)) * ((f84 * 0.75) + 0.25))) * f82)) * CB0[15].xyz) * (CB0[14].w * CB0[14].w)) * (f38 * VARYING0.w)) + ((mix(f95, textureLod(PrefilteredEnvTexture, f93, f92).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f52.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f61)) * f99) * f51));
    vec4 f111 = vec4(0.0);
    f111.x = f110.x;
    vec4 f112 = f111;
    f112.y = f110.y;
