...
void main()
{
    ...
    vec3 v32 = (CB0[15].xyz * v31) + (CB0[17].xyz * clamp(-v21, 0.0, 1.0));
    vec4 v33 = vec4(0.0);
    v33.x = v32.x;
    vec4 v34 = v33;
    v34.y = v32.y;
    ...
    v35.z = v32.z;
    vec4 v36 = v35;
    v36.w = (v31 * CB0[28].w) * (COLOR1.y * exp2((v30 * dot(v19, normalize(v20 + v18))) - v30));
    vec4 v37 = vec4(dot(CB0[25], v22), dot(CB0[26], v22), dot(CB0[27], v22), 0.0);
