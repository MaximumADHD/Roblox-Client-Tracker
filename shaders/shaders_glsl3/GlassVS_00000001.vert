...
void main()
{
    ...
    vec4 v19 = CB1[gl_InstanceID * 7 + 4] * mix(COLOR0 * 0.0039215688593685626983642578125, vec4(1.0), vec4(max(sign(CB1[gl_InstanceID * 7 + 3].w), 0.0)));
    ...
    v47.z = v44.z;
    vec4 v48 = v47;
    v48.w = v43 * ((CB1[gl_InstanceID * 7 + 6].z * 0.055555999279022216796875) * exp2((v42 * dot(v15, normalize(v25 + normalize(v20)))) - v42));
    gl_Position = v28;
    VARYING0 = v18;
    VARYING1 = v30;
    VARYING2 = v40;
