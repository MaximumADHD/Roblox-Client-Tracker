...
void main()
{
    vec4 f0 = texture(Texture0Texture, VARYING0 + (CB1[1].xy * (-3.0)));
    vec4 f1 = texture(Texture0Texture, VARYING0 + (CB1[1].xy * (-2.0)));
    vec4 f2 = texture(Texture0Texture, VARYING0 + (CB1[1].xy * (-1.0)));
    vec4 f3 = texture(Texture0Texture, VARYING0);
    vec4 f4 = texture(Texture0Texture, VARYING0 + (CB1[1].xy * 1.0));
    vec4 f5 = texture(Texture0Texture, VARYING0 + (CB1[1].xy * 2.0));
    vec4 f6 = texture(Texture0Texture, VARYING0 + (CB1[1].xy * 3.0));
