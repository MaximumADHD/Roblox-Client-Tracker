...
void main()
{
    ...
    vec3 f71 = (((((((f54 - (f49 * f53)) * CB0[10].xyz) * f42) + ((f58 * f69) * CB0[25].w)) + ((CB0[27].xyz + (CB0[28].xyz * f12)) * 1.0)) * f32) + (((f49 * (((f50 + (f50 * f50)) / (((f51 * f51) * ((f45 * 3.0) + 0.5)) * ((f44 * 0.75) + 0.25))) * f42)) * CB0[10].xyz) + (f70 * f12))) + (((f10.xyz * (f10.w * 120.0)).xyz * mix(f32, f70 * (1.0 / (max(max(f69.x, f69.y), f69.z) + 0.00999999977648258209228515625)), (vec3(1.0) - f58) * (f33 * (1.0 - f12)))) * 1.0);
