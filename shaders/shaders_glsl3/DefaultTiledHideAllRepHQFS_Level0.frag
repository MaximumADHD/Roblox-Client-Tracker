...
void main()
{
    ...
    float f44 = f34.z;
    vec3 f45 = -CB0[16].xyz;
    float f46 = (dot(f23, f45) * CB0[14].w) * ((1.0 - ((step(f43.x, f44) * clamp(CB0[29].z + (CB0[29].w * abs(f44 - 0.5)), 0.0, 1.0)) * f43.y)) * f41.y);
