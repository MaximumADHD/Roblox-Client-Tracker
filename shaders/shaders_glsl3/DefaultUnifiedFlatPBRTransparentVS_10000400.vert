...
void main()
{
    ...
    vec4 v16 = v15;
    v16.w = 0.0;
    float v17 = COLOR1.y * 0.50359976291656494140625;
    float v18 = clamp(v7, 0.0, 1.0);
    vec3 v19 = (CB0[15].xyz * v18) + (CB0[17].xyz * clamp(-v7, 0.0, 1.0));
    vec4 v20 = vec4(0.0);
    v20.x = v19.x;
    vec4 v21 = v20;
    v21.y = v19.y;
    ...
    v22.z = v19.z;
    vec4 v23 = v22;
    v23.w = v18 * ((COLOR1.y * 0.055555999279022216796875) * exp2((v17 * dot(v3, normalize(v6 + v2))) - v17));
    vec4 v24 = vec4(dot(CB0[25], v8), dot(CB0[26], v8), dot(CB0[27], v8), 0.0);
