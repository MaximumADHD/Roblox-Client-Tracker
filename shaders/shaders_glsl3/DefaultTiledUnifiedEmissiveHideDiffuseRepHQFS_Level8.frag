...
void main()
{
    ...
    vec4 f16 = vec4((mix(vec3(1.0), VARYING2.xyz, vec3(mix(1.0, f4.w, CB2[3].w))) * f4.xyz) * (1.0 + (f14 * CB2[0].z)), VARYING2.w);
    ...
    vec3 f66 = normalize(f1 - CB0[11].xyz);
