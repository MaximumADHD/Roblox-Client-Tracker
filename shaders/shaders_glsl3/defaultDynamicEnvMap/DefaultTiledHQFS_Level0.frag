...
void main()
{
    ...
    vec3 f19 = vec4(((mix(vec3(1.0), VARYING2.xyz, vec3(clamp(f5.w + CB2[2].w, 0.0, 1.0))) * f5.xyz) * (1.0 + (f12 * CB2[0].z))) * (f13.x * 2.0), VARYING2.w).xyz;
