...
void main()
{
    ...
    float v23 = clamp(v17, 0.0, 1.0);
    vec3 v24 = (CB0[10].xyz * v23) + (CB0[12].xyz * clamp(-v17, 0.0, 1.0));
    vec4 v25 = vec4(v24.x, v24.y, v24.z, vec4(0.0).w);
    v25.w = (v23 * CB0[23].w) * (CB1[gl_InstanceID * 7 + 6].z * exp2((v22 * dot(v10, normalize(v16 + normalize(v15)))) - v22));
