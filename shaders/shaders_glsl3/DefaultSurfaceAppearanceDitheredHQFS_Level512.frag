...
void main()
{
    ...
    float f28 = max(f14.y, 0.04500000178813934326171875);
    ...
    vec3 f67 = ((((((((f50 - (f45 * f49)) * CB0[10].xyz) * f38) + (CB0[12].xyz * (f48 * clamp(-f36, 0.0, 1.0)))) + ((f54 * f65) * CB0[25].w)) + ((CB0[27].xyz + (CB0[28].xyz * f23)) * 1.0)) * f26) + (((f45 * (((f46 + (f46 * f46)) / (((f47 * f47) * ((f41 * 3.0) + 0.5)) * ((f40 * 0.75) + 0.25))) * f38)) * CB0[10].xyz) + (f66 * f23))) + (((f21.xyz * (f21.w * 120.0)).xyz * mix(f26, f66 * (1.0 / (max(max(f65.x, f65.y), f65.z) + 0.00999999977648258209228515625)), (vec3(1.0) - f54) * (f27 * (1.0 - f23)))) * 1.0);
    float f68 = f9.w;
