...
void main()
{
    ...
    vec4 v35 = v34;
    v35.w = 0.0;
    vec4 v36 = vec4(v22, v28.w);
    float v37 = COLOR0.w * 2.0;
    float v38 = clamp(v37 - 1.0, 0.0, 1.0);
    float v39 = (clamp(2.0 - (dot(v21, normalize(v36.xyz)) * 3.0), 0.0, 1.0) * 0.300000011920928955078125) * clamp(v37, 0.0, 1.0);
    vec4 v40 = COLOR0;
    ...
    float v42 = COLOR1.y * 0.50359570980072021484375;
    ...
    v47.z = v44.z;
    vec4 v48 = v47;
    v48.w = (v43 * CB0[28].w) * (COLOR1.y * exp2((v42 * dot(v21, normalize(v25 + normalize(v22)))) - v42));
    gl_Position = v28;
    VARYING0 = TEXCOORD0;
    VARYING1 = v30;
    VARYING2 = v40;
