...
void main()
{
    ...
    float f78 = f72.y;
    float f79 = f72.z;
    vec3 f80 = ((((((((vec3(1.0) - (f59 * f49)) * CB0[10].xyz) * f52) + ((f25.xyz * (f25.w * 120.0)) * 1.0)) + ((vec3(1.0) - (f69 * f49)) * (((((((CB0[35].xyz * f74) + (CB0[37].xyz * f75)) + (CB0[39].xyz * f76)) + (CB0[36].xyz * f77)) + (CB0[38].xyz * f78)) + (CB0[40].xyz * f79)) + (((((((CB0[29].xyz * f74) + (CB0[31].xyz * f75)) + (CB0[33].xyz * f76)) + (CB0[30].xyz * f77)) + (CB0[32].xyz * f78)) + (CB0[34].xyz * f79)) * f27)))) + (CB0[27].xyz + ((CB0[28].xyz * (2.0 - CB0[9].w)) * f27))) + vec3((f5.z * 2.0) * f15)) * (f13 * f13)) + ((((((f59 * (((f60 + (f60 * f60)) / (((f61 * f61) * ((f55 * 3.0) + 0.5)) * ((f54 * 0.75) + 0.25))) * f52)) * CB0[10].xyz) * (CB0[9].w * CB0[9].w)) * f15) * VARYING0.w) + ((mix(f65, textureLod(PrefilteredEnvTexture, f63, f62).xyz * mix(CB0[26].xyz, CB0[25].xyz, vec3(clamp(f50.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f27)) * f69) * f49));
    vec4 f81 = vec4(0.0);
    f81.x = f80.x;
    vec4 f82 = f81;
    f82.y = f80.y;
    ...
    vec3 f86 = textureLod(PrefilteredEnvTexture, vec4(-f14, 0.0).xyz, max(CB0[13].y, f85) * 5.0).xyz;
