...
void main()
{
    ...
    vec4 v26 = v24;
    v26.z = v25;
    bvec3 v27 = greaterThan(TEXCOORD1.xyz, vec3(7.5));
    gl_Position = v4;
    VARYING0 = v26;
    ...
    VARYING6 = v1;
    VARYING7 = vec3(v27.x ? vec3(1.0).x : vec3(0.0).x, v27.y ? vec3(1.0).y : vec3(0.0).y, v27.z ? vec3(1.0).z : vec3(0.0).z);
    VARYING8 = v5;
    VARYING9 = ((CB4[int(TEXCOORD0.x + 0.5) * 1 + 0] * v21) + (CB4[int(TEXCOORD0.y + 0.5) * 1 + 0] * v23)) + (CB4[int(TEXCOORD0.z + 0.5) * 1 + 0] * v25);
}
