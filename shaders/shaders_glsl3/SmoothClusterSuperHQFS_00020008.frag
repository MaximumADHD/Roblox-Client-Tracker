...
void main()
{
    ...
    if (f104 > 0.0)
    {
        vec3 f107 = normalize(f69 - CB0[16].xyz);
        ...
        f105 = ((f115 * (((f116 + (f116 * f116)) / max(((f117 * f117) * ((f111 * 3.0) + 0.5)) * ((f110 * 0.75) + 0.25), 3.0999999580672010779380798339844e-05)) * f108)) * CB0[15].xyz) * (CB0[14].w * CB0[14].w);
    }
    else
    {
        f106 = f83;
