...
void main()
{
    ...
    vec3 f9 = normalize(((f7 * f3.x) + ((cross(f8, f7) * VARYING6.w) * f3.y)) + (f8 * f3.z));
    vec3 f10 = f5.xyz;
    vec3 f11 = f10 * f10;
    vec4 f12 = f5;
    f12.x = f11.x;
