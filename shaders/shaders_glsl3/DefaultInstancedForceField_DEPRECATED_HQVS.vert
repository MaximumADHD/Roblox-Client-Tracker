...
void main()
{
    ...
    vec4 v19 = vec4(v6, v7, v8, 1.0);
    vec4 v20 = v19 * mat4(CB0[0], CB0[1], CB0[2], CB0[3]);
    vec4 v21 = vec4((TEXCOORD0.xy * v15) + CB1[gl_InstanceID * 7 + 6].xy, 0.0, 0.0);
    vec4 v22 = vec4(0.0, (TEXCOORD0.zw * v17).y, 0.0, 0.0);
    ...
    float v23 = v20.w;
    vec4 v24 = (vec4(10.0) * CB0[23].z) + vec4((0.5 * v23) * CB0[23].y);
    vec4 v25 = vec4(dot(CB0[20], v19), dot(CB0[21], v19), dot(CB0[22], v19), 0.0);
    ...
    VARYING4 = vec4(CB0[7].xyz - v9, v23);
