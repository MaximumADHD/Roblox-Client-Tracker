...
void main()
{
    ...
    float f85 = f75.z;
    vec3 f86 = -CB0[16].xyz;
    float f87 = dot(f68, f86) * ((1.0 - ((step(f84.x, f85) * clamp(CB0[29].z + (CB0[29].w * abs(f85 - 0.5)), 0.0, 1.0)) * f84.y)) * f82.y);
