...
void main()
{
    ...
    if (f72 > 0.0)
    {
        vec3 f75 = normalize(f28 - CB0[16].xyz);
        ...
        f73 = ((f83 * (((f84 + (f84 * f84)) / max(((f85 * f85) * ((f79 * 3.0) + 0.5)) * ((f78 * 0.75) + 0.25), 7.0000001869630068540573120117188e-05)) * f76)) * CB0[15].xyz) * (CB0[14].w * CB0[14].w);
    }
    else
    {
        f74 = f69;
