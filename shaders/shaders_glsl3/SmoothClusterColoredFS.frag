...
void main()
{
    ...
    vec3 f20 = sqrt(clamp(mix(vec3(f19.x ? CB0[14].xyz.x : f18.x, f19.y ? CB0[14].xyz.y : f18.y, f19.z ? CB0[14].xyz.z : f18.z), f16.xyz, vec3(f17)).xyz * CB0[15].y, vec3(0.0), vec3(1.0)));
