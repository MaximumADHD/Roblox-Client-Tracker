...
void main()
{
    ...
    VARYING5 = vec4(dot(CB0[21], v2), dot(CB0[22], v2), dot(CB0[23], v2), (CB0[13].x * length(CB0[7].xyz - v0)) + CB0[13].y);
    VARYING6 = (CB0[10].xyz * max(v19, 0.0)) + (CB0[12].xyz * max(-v19, 0.0));
    VARYING7 = ((CB4[int(TEXCOORD0.x + 0.5) * 1 + 0] * v18.x) + (CB4[int(TEXCOORD0.y + 0.5) * 1 + 0] * v18.y)) + (CB4[int(TEXCOORD0.z + 0.5) * 1 + 0] * v18.z);
}
