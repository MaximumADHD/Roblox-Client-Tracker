...
void main()
{
    ...
    vec3 f60 = normalize(f43 - CB0[16].xyz);
    ...
    float f87 = f81.y;
    float f88 = f81.z;
    vec3 f89 = (((((((f53.xyz * (f53.w * 120.0)) * 1.0) + ((((vec3(1.0) - (f68 * f45)) * CB0[15].xyz) * f61) + (CB0[17].xyz * clamp(-f59, 0.0, 1.0)))) + ((vec3(1.0) - (f78 * f45)) * (((((((CB0[40].xyz * f83) + (CB0[42].xyz * f84)) + (CB0[44].xyz * f85)) + (CB0[41].xyz * f86)) + (CB0[43].xyz * f87)) + (CB0[45].xyz * f88)) + (((((((CB0[34].xyz * f83) + (CB0[36].xyz * f84)) + (CB0[38].xyz * f85)) + (CB0[35].xyz * f86)) + (CB0[37].xyz * f87)) + (CB0[39].xyz * f88)) * f55)))) + ((CB0[32].xyz + (CB0[33].xyz * f55)) * 1.0)) + vec3((f25.z * 2.0) * f34)) * (f33 * f33)) + (((((f68 * (min((f69 + (f69 * f69)) / (((f70 * f70) * ((f64 * 3.0) + 0.5)) * ((f63 * 0.75) + 0.25)), 65504.0) * f61)) * CB0[15].xyz) * 1.0) * (f34 * VARYING0.w)) + ((mix(f74, textureLod(PrefilteredEnvTexture, f72, f71).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f46.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f55)) * f78) * f45));
    vec4 f90 = vec4(0.0);
    f90.x = f89.x;
    vec4 f91 = f90;
    f91.y = f89.y;
