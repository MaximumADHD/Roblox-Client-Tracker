...
void main()
{
    ...
    vec3 f55 = (((((((((vec3(1.0) - (f37 * f19)) * CB0[10].xyz) * f30) + (CB0[12].xyz * clamp(-f29, 0.0, 1.0))) * f17) + ((vec3(1.0) - f43) * (((((((CB0[35].xyz * f48) + (CB0[37].xyz * f49)) + (CB0[39].xyz * f50)) + (CB0[36].xyz * f51)) + (CB0[38].xyz * f52)) + (CB0[40].xyz * f53)) + (((((((CB0[29].xyz * f48) + (CB0[31].xyz * f49)) + (CB0[33].xyz * f50)) + (CB0[30].xyz * f51)) + (CB0[32].xyz * f52)) + (CB0[34].xyz * f53)) * f15)))) + (CB0[27].xyz + (CB0[28].xyz * f15))) * f26) + ((((f37 * (((f38 + (f38 * f38)) / (((f39 * f39) * ((f33 * 3.0) + 0.5)) * ((f32 * 0.75) + 0.25))) * f30)) * CB0[10].xyz) * f17) + f54)) + (f14 * mix(f26, f54 * (1.0 / (max(max(f54.x, f54.y), f54.z) + 0.00999999977648258209228515625)), f43 * (f19 * (1.0 - f15))));
    ...
    vec4 f60 = vec4(f59.x, f59.y, f59.z, f56.w);
    f60.w = VARYING2.w;
