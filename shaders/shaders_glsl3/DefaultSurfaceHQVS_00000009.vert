...
void main()
{
    ...
    vec4 v23 = vec4(v9, v10, v11, 1.0) * mat4(CB0[0], CB0[1], CB0[2], CB0[3]);
    vec3 v24 = v22;
    v24.x = v20.x;
    vec3 v25 = v24;
    v25.y = v20.y;
    vec3 v26 = ((v12 + (vec3(v13, v14, v15) * 6.0)).yxz * CB0[21].xyz) + CB0[22].xyz;
    vec4 v27 = vec4(0.0);
    v27.x = v26.x;
    vec4 v28 = v27;
    v28.y = v26.y;
    ...
    vec4 v31 = vec4(v9, v10, v11, 0.0);
    v31.w = CB1[gl_InstanceID * 7 + 5].w;
    vec4 v32 = v21;
    v32.x = dot(CB1[gl_InstanceID * 7 + 0].xyz, v2);
    vec4 v33 = v32;
    v33.y = dot(CB1[gl_InstanceID * 7 + 1].xyz, v2);
    vec4 v34 = v33;
    v34.z = dot(CB1[gl_InstanceID * 7 + 2].xyz, v2);
    vec4 v35 = vec4(v13, v14, v15, 0.0);
    v35.w = 0.0;
    gl_Position = v23;
    ...
    VARYING3 = v30;
    VARYING4 = vec4(CB0[11].xyz - v12, v23.w);
    VARYING5 = v35;
    VARYING6 = v34;
    VARYING7 = v31;
}
