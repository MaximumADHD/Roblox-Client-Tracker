...
void main()
{
    ...
    vec4 f43 = f42;
    f43.w = 1.0;
    vec3 f44 = textureLod(PrefilteredEnvTexture, vec4(f27, 0.0).xyz, max(CB0[13].y, VARYING6.w) * 5.0).xyz;
    bvec3 f45 = bvec3(!(CB0[13].w == 0.0));
    vec3 f46 = mix(vec3(f45.x ? CB0[14].xyz.x : f44.x, f45.y ? CB0[14].xyz.y : f44.y, f45.z ? CB0[14].xyz.z : f44.z), f43.xyz, vec3(VARYING6.w));
    vec4 f47 = f43;
    f47.x = f46.x;
    vec4 f48 = f47;
    f48.y = f46.y;
