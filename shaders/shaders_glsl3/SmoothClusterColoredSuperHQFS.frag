...
void main()
{
    ...
    vec3 f58 = ((((((((vec3(1.0) - (f55 * (CB0[26].w * f30))) * CB0[10].xyz) * f48) + (CB0[12].xyz * clamp(-f47, 0.0, 1.0))) * f43) + min((f40.xyz * (f40.w * 120.0)).xyz + (CB0[8].xyz + (CB0[9].xyz * f41.x)), vec3(CB0[16].w))) + vec3((f36.z * 2.0) * f30)) * (f29 * f29).xyz) + (((((f55 * (((f56 + (f56 * f56)) / (((f57 * f57) * ((f51 * 3.0) + 0.5)) * ((f50 * 0.75) + 0.25))) * f48)) * CB0[10].xyz) * f43) * f30) * VARYING0.w);
