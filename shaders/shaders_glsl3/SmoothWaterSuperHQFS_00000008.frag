...
void main()
{
    ...
    if (f110 > 0.0)
    {
        ...
        f111 = (((vec3(f118) + (vec3(0.0199999995529651641845703125) * (1.0 - f118))) * (((f119 + (f119 * f119)) / max(((f120 * f120) * ((f115 * 3.0) + 0.5)) * ((f114 * 0.75) + 0.25), 7.0000001869630068540573120117188e-05)) * clamp(f110, 0.0, 1.0))) * CB0[15].xyz) * (CB0[14].w * CB0[14].w);
    }
    else
    {
        f111 = vec3(0.0);
