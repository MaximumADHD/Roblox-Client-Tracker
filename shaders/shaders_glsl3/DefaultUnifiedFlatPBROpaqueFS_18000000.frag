...
void main()
{
    ...
    float f11 = f10.y;
    vec3 f12 = (((VARYING5.xyz * f11) + min((f9.xyz * (f9.w * 120.0)) + (CB0[13].xyz + (CB0[14].xyz * f10.x)), vec3(CB0[21].w))) * f4.xyz) + ((CB0[15].xyz * mix(vec3(0.100000001490116119384765625), f4.xyz, vec3(VARYING6.w * CB0[31].w))) * (VARYING5.w * f11));
    vec4 f13 = vec4(0.0);
    f13.x = f12.x;
    vec4 f14 = f13;
    f14.y = f12.y;
