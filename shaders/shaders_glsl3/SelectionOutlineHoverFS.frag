...
void main()
{
    ...
    vec4 f23 = mix(vec4(0.0), vec4(CB6[5].xyz, (textureLod(Texture1Texture, min(f22, CB1[12].zw), 0.0).x < textureLod(Texture2Texture, min(f22, CB1[13].xy), 0.0).x) ? CB1[2].y : 1.0), vec4(clamp(255.0 * max(abs(f10 - f8), abs(f14 - f12)), 0.0, 1.0)));
