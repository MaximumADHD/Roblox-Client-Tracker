...
void main()
{
    ...
    vec4 f3 = f2;
    f3.z = f0.z;
    float f4 = clamp(exp2((CB0[13].z * length(VARYING1)) + CB0[13].x) - CB0[13].w, 0.0, 1.0);
    vec3 f5 = textureLod(PrefilteredEnvTexture, vec4(-VARYING1, 0.0).xyz, max(CB0[13].y, f4) * 5.0).xyz;
