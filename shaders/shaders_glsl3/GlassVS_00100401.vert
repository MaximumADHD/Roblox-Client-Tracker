...
void main()
{
    ...
    vec4 v17 = CB1[gl_InstanceID * 7 + 4] * mix(vec4(COLOR0.xyz, TEXCOORD1.w) * 0.0039215688593685626983642578125, vec4(1.0), vec4(max(sign(CB1[gl_InstanceID * 7 + 3].w), 0.0)));
    ...
    vec3 v25 = ((v11 + (v20 * 6.0)).yxz * CB0[21].xyz) + CB0[22].xyz;
    vec4 v26 = vec4(0.0);
    v26.x = v25.x;
    vec4 v27 = v26;
    v27.y = v25.y;
    ...
    vec4 v35 = vec4(dot(CB0[25], v23), dot(CB0[26], v23), dot(CB0[27], v23), 0.0);
    ...
    vec3 v38 = (CB0[15].xyz * v37) + (CB0[17].xyz * clamp(-v22, 0.0, 1.0));
    vec4 v39 = vec4(0.0);
    v39.x = v38.x;
    vec4 v40 = v39;
    v40.y = v38.y;
    ...
    v41.z = v38.z;
    vec4 v42 = v41;
    v42.w = (v37 * CB0[28].w) * (CB1[gl_InstanceID * 7 + 6].z * exp2((v36 * dot(v20, normalize(v21 + v19))) - v36));
    gl_Position = v24;
