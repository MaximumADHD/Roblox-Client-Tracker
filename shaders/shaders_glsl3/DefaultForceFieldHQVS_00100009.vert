...
void main()
{
    ...
    vec4 v24 = vec4(v10, v11, v12, 1.0) * mat4(CB0[0], CB0[1], CB0[2], CB0[3]);
    vec3 v25 = ((v13 + (vec3(v14, v15, v16) * 6.0)).yxz * CB0[21].xyz) + CB0[22].xyz;
    vec4 v26 = vec4(0.0);
    v26.x = v25.x;
    vec4 v27 = v26;
    v27.y = v25.y;
    ...
    v30.w = CB1[gl_InstanceID * 7 + 6].w;
    vec4 v31 = vec4(v14, v15, v16, 0.0);
    v31.w = inversesqrt(0.1745329201221466064453125 * CB1[gl_InstanceID * 7 + 6].z);
    gl_Position = v24;
    VARYING0 = (TEXCOORD0 * v18) + CB1[gl_InstanceID * 7 + 6].xy;
    VARYING1 = max(0.0500000007450580596923828125, mix(1.0 - v3.w, 0.0, v4));
    VARYING2 = v23;
    VARYING3 = v29;
    VARYING4 = vec4(CB0[11].xyz - v13, v24.w);
    VARYING5 = v31;
    VARYING6 = v30;
}
