...
void main()
{
    ...
    vec3 f54 = ((((((((f37 - (f32 * f36)) * CB0[10].xyz) * f25) + (CB0[12].xyz * (f35 * clamp(-f23, 0.0, 1.0)))) + ((f41 * f52) * CB0[25].w)) + ((CB0[27].xyz + (CB0[28].xyz * f10)) * 1.0)) * f13) + (((f32 * (((f33 + (f33 * f33)) / (((f34 * f34) * ((f28 * 3.0) + 0.5)) * ((f27 * 0.75) + 0.25))) * f25)) * CB0[10].xyz) + (f53 * f10))) + (((f8.xyz * (f8.w * 120.0)).xyz * mix(f13, f53 * (1.0 / (max(max(f52.x, f52.y), f52.z) + 0.00999999977648258209228515625)), (vec3(1.0) - f41) * (f14 * (1.0 - f10)))) * 1.0);
