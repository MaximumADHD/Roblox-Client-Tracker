...
void main()
{
    ...
    vec3 f73 = ((((((((f56 - (f51 * f55)) * CB0[10].xyz) * f44) + (CB0[12].xyz * (f54 * clamp(-f42, 0.0, 1.0)))) + ((f60 * f71) * CB0[25].w)) + ((CB0[27].xyz + (CB0[28].xyz * f29)) * 1.0)) * f32) + (((f51 * (((f52 + (f52 * f52)) / (((f53 * f53) * ((f47 * 3.0) + 0.5)) * ((f46 * 0.75) + 0.25))) * f44)) * CB0[10].xyz) + (f72 * f29))) + (((f27.xyz * (f27.w * 120.0)).xyz * mix(f32, f72 * (1.0 / (max(max(f71.x, f71.y), f71.z) + 0.00999999977648258209228515625)), (vec3(1.0) - f60) * (f33 * (1.0 - f29)))) * 1.0);
