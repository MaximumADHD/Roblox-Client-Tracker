...
void main()
{
    ...
    vec3 f84 = (((((((f67 - (f62 * f66)) * CB0[10].xyz) * f55) + ((f71 * f82) * CB0[25].w)) + ((CB0[27].xyz + (CB0[28].xyz * f25)) * 1.0)) * f45) + (((f62 * (((f63 + (f63 * f63)) / (((f64 * f64) * ((f58 * 3.0) + 0.5)) * ((f57 * 0.75) + 0.25))) * f55)) * CB0[10].xyz) + (f83 * f25))) + (((f23.xyz * (f23.w * 120.0)).xyz * mix(f45, f83 * (1.0 / (max(max(f82.x, f82.y), f82.z) + 0.00999999977648258209228515625)), (vec3(1.0) - f71) * (f46 * (1.0 - f25)))) * 1.0);
