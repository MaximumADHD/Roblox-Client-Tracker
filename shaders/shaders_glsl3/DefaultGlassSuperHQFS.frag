...
void main()
{
    ...
    vec4 f55 = texture(GBufferColorTexture, f49 + (f53 * clamp(min(texture(GBufferDepthTexture, f51 + f54).x * 500.0, texture(GBufferDepthTexture, f51 - f54).x * 500.0) - f48, 0.0, 1.0)));
    vec3 f56 = f55.xyz;
