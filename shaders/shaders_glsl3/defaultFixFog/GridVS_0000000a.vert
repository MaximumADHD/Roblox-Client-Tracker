...
void main()
{
    ...
    vec4 v17 = vec4(v4, v5, v6, 1.0) * mat4(CB0[0], CB0[1], CB0[2], CB0[3]);
    vec3 v18 = v14;
    v18.x = v13.x;
    vec3 v19 = v18;
    v19.y = v13.y;
    ...
    v31.z = v28.z;
    vec4 v32 = v31;
    v32.w = v27 * ((COLOR1.y * 0.055555999279022216796875) * exp2((v26 * dot(v11, normalize(v15 + normalize(v12)))) - v26));
    gl_Position = v17;
    VARYING0 = TEXCOORD0;
    VARYING1 = v19;
    VARYING2 = COLOR0;
    VARYING3 = v24;
    VARYING4 = vec4(v12, v17.w);
