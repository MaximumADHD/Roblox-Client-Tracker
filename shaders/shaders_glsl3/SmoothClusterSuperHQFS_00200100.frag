...
void main()
{
    ...
    float f113 = f107.y;
    float f114 = f107.z;
    vec3 f115 = (((((((f79.xyz * (f79.w * 120.0)) * 1.0) + ((((vec3(1.0) - (f94 * f71)) * CB0[15].xyz) * f87) + (CB0[17].xyz * clamp(-f85, 0.0, 1.0)))) + ((vec3(1.0) - (f104 * f71)) * (((((((CB0[40].xyz * f109) + (CB0[42].xyz * f110)) + (CB0[44].xyz * f111)) + (CB0[41].xyz * f112)) + (CB0[43].xyz * f113)) + (CB0[45].xyz * f114)) + (((((((CB0[34].xyz * f109) + (CB0[36].xyz * f110)) + (CB0[38].xyz * f111)) + (CB0[35].xyz * f112)) + (CB0[37].xyz * f113)) + (CB0[39].xyz * f114)) * f81)))) + ((CB0[32].xyz + (CB0[33].xyz * f81)) * 1.0)) + vec3((f25.z * 2.0) * f60)) * (f59 * f59)) + (((((f94 * (min((f95 + (f95 * f95)) / (((f96 * f96) * ((f90 * 3.0) + 0.5)) * ((f89 * 0.75) + 0.25)), 65504.0) * f87)) * CB0[15].xyz) * 1.0) * (f60 * VARYING0.w)) + ((mix(f100, textureLod(PrefilteredEnvTexture, f98, f97).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f72.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f81)) * f104) * f71));
    vec4 f116 = vec4(0.0);
    f116.x = f115.x;
    vec4 f117 = f116;
    f117.y = f115.y;
