...
void main()
{
    ...
    vec3 f23 = (((VARYING6.xyz * f22) + min((f18.xyz * (f18.w * 120.0)) + (CB0[13].xyz + (CB0[14].xyz * f19.x)), vec3(CB0[21].w))) * f13.xyz) + (CB0[15].xyz * ((VARYING6.w * f22) * 0.100000001490116119384765625));
    vec4 f24 = vec4(0.0);
    f24.x = f23.x;
    vec4 f25 = f24;
    f25.y = f23.y;
