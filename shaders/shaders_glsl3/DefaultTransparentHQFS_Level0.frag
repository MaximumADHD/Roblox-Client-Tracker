...
void main()
{
    ...
    float f25 = f15.z;
    vec3 f26 = -CB0[16].xyz;
    float f27 = (dot(f4, f26) * CB0[14].w) * ((1.0 - ((step(f24.x, f25) * clamp(CB0[29].z + (CB0[29].w * abs(f25 - 0.5)), 0.0, 1.0)) * f24.y)) * f22.y);
