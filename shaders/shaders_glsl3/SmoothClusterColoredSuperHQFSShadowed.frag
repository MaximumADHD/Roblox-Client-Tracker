...
void main()
{
    ...
    vec3 f100 = ((((((((((vec3(1.0) - (f79 * f69)) * 1.0) * CB0[10].xyz) * f72) * f65) + (f88 * (((((((CB0[35].xyz * f93) + (CB0[37].xyz * f94)) + (CB0[39].xyz * f95)) + (CB0[36].xyz * f96)) + (CB0[38].xyz * f97)) + (CB0[40].xyz * f98)) + (((((((CB0[29].xyz * f93) + (CB0[31].xyz * f94)) + (CB0[33].xyz * f95)) + (CB0[30].xyz * f96)) + (CB0[32].xyz * f97)) + (CB0[34].xyz * f98)) * f45)))) + (CB0[27].xyz + (CB0[28].xyz * f45))) + vec3((f36.z * 2.0) * f30)) * f67) + (((((((f79 * ((f80 + (f80 * f80)) / (((f81 * f81) * ((f75 * 3.0) + 0.5)) * ((f74 * 0.75) + 0.25)))) * CB0[10].xyz) * f72) * f65) * f30) * VARYING0.w) + f99)) + (f44 * mix(f67, f99 * (1.0 / (max(max(f99.x, f99.y), f99.z) + 0.00999999977648258209228515625)), ((vec3(1.0) - f88) * f69) * (1.0 - f45)));
