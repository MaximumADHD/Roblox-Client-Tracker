...
void main()
{
    ...
    float f60 = f50.z;
    float f61 = f50.x;
    _entryPointOutput = vec4(mix(mix(mix(mix(CB7[f57 * 1 + 0].xyz * f58, CB7[(f57 + 256) * 1 + 0].xyz, vec3(f51)), CB6[6].xyz, vec3(f59)), CB6[7].xyz, vec3(f60)), CB6[5].xyz, vec3(f61)), max(max(max(max(CB7[f57 * 1 + 0].w * f58, f51), f59), f60), f61));
}
