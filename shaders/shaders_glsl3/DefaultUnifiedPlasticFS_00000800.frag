...
void main()
{
    ...
    float f13 = f12.y;
    vec3 f14 = (((VARYING5.xyz * f13) + min((f11.xyz * (f11.w * 120.0)) + (CB0[32].xyz + (CB0[33].xyz * f12.x)), vec3(CB0[21].w))) * f6.xyz) + ((CB0[15].xyz * mix(vec3(0.100000001490116119384765625), f6.xyz, vec3(VARYING6.w * CB0[31].w))) * (VARYING5.w * f13));
    vec4 f15 = vec4(0.0);
    f15.x = f14.x;
    vec4 f16 = f15;
    f16.y = f14.y;
