...
void main()
{
    ...
    vec4 v15 = v14;
    v15.w = 0.0;
    vec4 v16 = vec4(dot(CB0[25], v7), dot(CB0[26], v7), dot(CB0[27], v7), 0.0);
    v16.w = COLOR1.w * 0.0039215688593685626983642578125;
    float v17 = COLOR1.y * 0.50359570980072021484375;
    float v18 = clamp(v6, 0.0, 1.0);
    vec3 v19 = (CB0[15].xyz * v18) + (CB0[17].xyz * clamp(-v6, 0.0, 1.0));
    vec4 v20 = vec4(0.0);
    v20.x = v19.x;
    vec4 v21 = v20;
    v21.y = v19.y;
    ...
    v22.z = v19.z;
    vec4 v23 = v22;
    v23.w = (v18 * CB0[28].w) * (COLOR1.y * exp2((v17 * dot(v3, normalize(v5 + v2))) - v17));
    gl_Position = v8;
    VARYING0 = TEXCOORD0;
    VARYING1 = v10;
    VARYING2 = COLOR0;
