...
void main()
{
    ...
    vec3 f3 = sqrt(clamp(mix(vec3(f2.x ? CB0[14].xyz.x : f1.x, f2.y ? CB0[14].xyz.y : f1.y, f2.z ? CB0[14].xyz.z : f1.z), (pow(VARYING2.xyz * 1.35000002384185791015625, vec3(4.0)) * 4.0).xyz, vec3(f0)).xyz * CB0[15].y, vec3(0.0), vec3(1.0)));
