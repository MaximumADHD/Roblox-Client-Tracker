...
void main()
{
    ...
    float f59 = f49.z;
    vec3 f60 = -CB0[16].xyz;
    float f61 = dot(f42, f60) * ((1.0 - ((step(f58.x, f59) * clamp(CB0[29].z + (CB0[29].w * abs(f59 - 0.5)), 0.0, 1.0)) * f58.y)) * f56.y);
