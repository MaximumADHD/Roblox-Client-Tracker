...
void main()
{
    ...
    float v20 = clamp(v18, 0.0, 1.0);
    float v21 = (clamp(2.0 - (dot(v11, normalize(v17.xyz)) * 3.0), 0.0, 1.0) * 0.300000011920928955078125) * v20;
    vec4 v22 = COLOR0;
    v22.w = mix(v19, 1.0, v21);
    vec4 v23 = vec4(dot(CB0[20], v15), dot(CB0[21], v15), dot(CB0[22], v15), 0.0);
    v23.w = mix((COLOR1.w * 0.0039215688593685626983642578125) * v19, 1.0, v21);
    gl_Position = v16;
    VARYING0 = TEXCOORD0;
    VARYING1 = TEXCOORD1;
    VARYING2 = v22;
    ...
    VARYING6 = vec4((CB0[10].xyz * max(v13, 0.0)) + (CB0[12].xyz * max(-v13, 0.0)), (((float(v13 > 0.0) * pow(clamp(dot(v11, normalize(v12 + normalize(v14))), 0.0, 1.0), COLOR1.z)) * v20) * (COLOR1.y * 0.0039215688593685626983642578125)) * CB0[23].w);
    VARYING7 = v23;
    VARYING8 = NORMAL.w;
}
