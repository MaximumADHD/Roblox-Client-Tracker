...
void main()
{
    ...
    VARYING6 = vec4((CB0[10].xyz * max(v18, 0.0)) + (CB0[12].xyz * max(-v18, 0.0)), ((float(v18 > 0.0) * pow(clamp(dot(v13, normalize(v17 + normalize(v19))), 0.0, 1.0), CB1[gl_InstanceID * 7 + 6].w)) * (CB1[gl_InstanceID * 7 + 6].z * 0.0039215688593685626983642578125)) * CB0[23].w);
    VARYING7 = vec4(dot(CB0[20], v20), dot(CB0[21], v20), dot(CB0[22], v20), 0.0);
