...
void main()
{
    ...
    vec4 v23 = vec4(0.0, (TEXCOORD0.zw * v17).y, 0.0, 0.0);
    v23.x = max(0.0500000007450580596923828125, mix((COLOR0 * 0.0039215688593685626983642578125).x, 0.0, float(CB1[gl_InstanceID * 7 + 3].w > 0.0)));
    gl_Position = v22;
    VARYING0 = vec4((TEXCOORD0.xy * v15) + CB1[gl_InstanceID * 7 + 6].xy, 0.0, 0.0);
    VARYING1 = v23;
    ...
    VARYING6 = vec4((CB0[10].xyz * max(v19, 0.0)) + (CB0[12].xyz * max(-v19, 0.0)), ((float(v19 > 0.0) * pow(clamp(dot(v13, normalize(v18 + normalize(v20))), 0.0, 1.0), CB1[gl_InstanceID * 7 + 6].w)) * (CB1[gl_InstanceID * 7 + 6].z * 0.0039215688593685626983642578125)) * CB0[24].w);
    VARYING7 = vec4(dot(CB0[21], v21), dot(CB0[22], v21), dot(CB0[23], v21), 0.0);
