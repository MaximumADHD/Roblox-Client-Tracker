...
void main()
{
    ...
    float f74 = f67.z;
    float f75 = 1.0 - f28;
    vec4 f76 = mix(vec4(mix(((((f43 * f18) + ((((vec3(1.0) - (f59 * f27)) * CB0[15].xyz) * f52) + (CB0[17].xyz * clamp(-f50, 0.0, 1.0)))) + (((vec3(1.0) - (f64 * f27)) * (((((((CB0[40].xyz * f69) + (CB0[42].xyz * f70)) + (CB0[44].xyz * f71)) + (CB0[41].xyz * f72)) + (CB0[43].xyz * f73)) + (CB0[45].xyz * f74)) + (((((((CB0[34].xyz * f69) + (CB0[36].xyz * f70)) + (CB0[38].xyz * f71)) + (CB0[35].xyz * f72)) + (CB0[37].xyz * f73)) + (CB0[39].xyz * f74)) * f44))) * f18)) + (CB0[32].xyz + (CB0[33].xyz * f44))) * (f23 * f18), f48, vec3(VARYING7.w)) * f18, f18), vec4(f48, 1.0), vec4(((f75 * f75) * 0.800000011920928955078125) * clamp(f17, 0.0, 1.0))) + vec4((((f59 * (((f60 + (f60 * f60)) / max(((f61 * f61) * ((f55 * 3.0) + 0.5)) * ((f54 * 0.75) + 0.25), 7.0000001869630068540573120117188e-05)) * f52)) * CB0[15].xyz) * 1.0) + (((mix(f35, f33, f47) * f64) * f27) * f18), 0.0);
