...
void main()
{
    ...
    float f54 = clamp(f16 * ((f16 > 0.0) ? mix(f25, mix(min((f34 <= f38) ? 1.0 : clamp(((f39 / (f39 + (f40 * f40))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0), (f35 <= f41) ? 1.0 : clamp(((f42 / (f42 + (f43 * f43))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0)), f25, clamp((length(f18 - CB0[7].xyz) * CB0[46].y) - (CB0[46].x * CB0[46].y), 0.0, 1.0)), CB0[47].x) : 0.0), 0.0, 1.0);
    float f55 = f46 * f46;
    ...
    vec3 f83 = (((((((f66 - (f61 * f65)) * CB0[10].xyz) * f54) + ((f70 * f81) * CB0[25].w)) + ((CB0[27].xyz + (CB0[28].xyz * f24)) * 1.0)) * f44) + (((f61 * (((f62 + (f62 * f62)) / (((f63 * f63) * ((f57 * 3.0) + 0.5)) * ((f56 * 0.75) + 0.25))) * f54)) * CB0[10].xyz) + (f82 * f24))) + (((f22.xyz * (f22.w * 120.0)).xyz * mix(f44, f82 * (1.0 / (max(max(f81.x, f81.y), f81.z) + 0.00999999977648258209228515625)), (vec3(1.0) - f70) * (f45 * (1.0 - f24)))) * 1.0);
    float f84 = f8.w;
