...
void main()
{
    ...
    float f55 = f45.z;
    vec3 f56 = -CB0[16].xyz;
    float f57 = (dot(f38, f56) * CB0[14].w) * ((1.0 - ((step(f54.x, f55) * clamp(CB0[29].z + (CB0[29].w * abs(f55 - 0.5)), 0.0, 1.0)) * f54.y)) * f52.y);
    vec3 f58 = normalize(f39 - CB0[16].xyz);
