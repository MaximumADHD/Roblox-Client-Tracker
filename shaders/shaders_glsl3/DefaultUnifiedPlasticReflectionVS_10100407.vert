...
void main()
{
    ...
    vec4 v49 = vec4(dot(CB0[25], v40), dot(CB0[26], v40), dot(CB0[27], v40), 0.0);
    v49.w = CB1[gl_InstanceID * 7 + 5].w;
    float v50 = CB1[gl_InstanceID * 7 + 6].z * 0.50359976291656494140625;
    float v51 = clamp(v39, 0.0, 1.0);
    vec3 v52 = (CB0[15].xyz * v51) + (CB0[17].xyz * clamp(-v39, 0.0, 1.0));
    vec4 v53 = vec4(0.0);
    v53.x = v52.x;
    vec4 v54 = v53;
    v54.y = v52.y;
    ...
    v55.z = v52.z;
    vec4 v56 = v55;
    v56.w = v51 * ((CB1[gl_InstanceID * 7 + 6].z * 0.055555999279022216796875) * exp2((v50 * dot(v33, normalize(v38 + v32))) - v50));
    gl_Position = v41;
    VARYING0 = v30;
    VARYING1 = v43;
    ...
    VARYING5 = vec4(v33, CB1[gl_InstanceID * 7 + 6].w);
    VARYING6 = v56;
    VARYING7 = v49;
}
