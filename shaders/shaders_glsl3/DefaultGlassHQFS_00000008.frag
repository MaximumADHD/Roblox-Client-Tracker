...
void main()
{
    ...
    if (f71 > 0.0)
    {
        vec3 f74 = normalize(f27 - CB0[16].xyz);
        ...
        f72 = ((f82 * (((f83 + (f83 * f83)) / max(((f84 * f84) * ((f78 * 3.0) + 0.5)) * ((f77 * 0.75) + 0.25), 3.0999999580672010779380798339844e-05)) * f75)) * CB0[15].xyz) * (CB0[14].w * CB0[14].w);
    }
    else
    {
        f73 = f68;
