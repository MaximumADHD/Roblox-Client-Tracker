...
void main()
{
    ...
    vec3 v11 = ((vec3(TEXCOORD1.xy, COLOR0.w) * 0.0078740157186985015869140625) - vec3(1.0)) / (CB1[gl_InstanceID * 7 + 3].xyz + vec3(0.001000000047497451305389404296875));
    ...
    vec3 v22 = CB0[11].xyz - v10;
    vec3 v23 = -CB0[16].xyz;
    float v24 = dot(v14, v23);
    vec4 v25 = vec4(v10, 1.0);
    vec4 v26 = v25 * mat4(CB0[0], CB0[1], CB0[2], CB0[3]);
    vec3 v27 = ((v10 + (v14 * 6.0)).yxz * CB0[21].xyz) + CB0[22].xyz;
    vec4 v28 = vec4(0.0);
    v28.x = v27.x;
    vec4 v29 = v28;
    v29.y = v27.y;
    ...
    v37.z = v34.z;
    vec4 v38 = v37;
    v38.w = v33 * ((CB1[gl_InstanceID * 7 + 6].z * 0.055555999279022216796875) * exp2((v32 * dot(v14, normalize(v23 + normalize(v22)))) - v32));
    ...
    VARYING5 = vec4(v14, CB1[gl_InstanceID * 7 + 6].w);
    VARYING6 = v38;
    VARYING7 = v39;
}
