...
void main()
{
    ...
    vec3 v5 = ((v3.xyz + v4) + v4) + CB1[gl_InstanceID * 7 + 1].xyz;
    vec3 v6 = ((vec3(TEXCOORD1.xy, COLOR0.w) * 0.0078740157186985015869140625) - vec3(1.0)) / (CB1[gl_InstanceID * 7 + 3].xyz + vec3(0.001000000047497451305389404296875));
    vec3 v7 = cross(CB1[gl_InstanceID * 7 + 0].xyz, cross(CB1[gl_InstanceID * 7 + 0].xyz, v6) + (v6 * CB1[gl_InstanceID * 7 + 0].w));
    vec3 v8 = (v6 + v7) + v7;
    vec3 v9 = v8 * inversesqrt(max(dot(v8, v8), 9.9999997473787516355514526367188e-05));
    vec3 v10 = CB0[11].xyz - v5;
    ...
    vec4 v19 = vec4(v5, 1.0);
    vec4 v20 = v19 * mat4(CB0[0], CB0[1], CB0[2], CB0[3]);
    vec3 v21 = v16;
    v21.x = v15.x;
    vec3 v22 = v21;
    v22.y = v15.y;
    vec3 v23 = ((v5 + (v12 * 6.0)).yxz * CB0[21].xyz) + CB0[22].xyz;
    vec4 v24 = vec4(0.0);
    v24.x = v23.x;
    vec4 v25 = v24;
    v25.y = v23.y;
