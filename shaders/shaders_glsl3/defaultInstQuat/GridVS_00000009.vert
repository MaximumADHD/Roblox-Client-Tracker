...
void main()
{
    ...
    float v23 = v8.x;
    vec4 v24 = vec4(v23, v8.yz, 1.0) * mat4(CB0[0], CB0[1], CB0[2], CB0[3]);
    vec3 v25 = v20;
    v25.x = v19.x;
    vec3 v26 = v25;
    v26.y = v19.y;
    ...
    vec4 v32 = vec4(v23, v8.yz, 0.0);
    v32.w = CB1[gl_InstanceID * 7 + 5].w;
    float v33 = CB1[gl_InstanceID * 7 + 6].z * 0.50359976291656494140625;
    float v34 = clamp(v22, 0.0, 1.0);
    vec3 v35 = (CB0[15].xyz * v34) + (CB0[17].xyz * clamp(-v22, 0.0, 1.0));
    vec4 v36 = vec4(0.0);
    v36.x = v35.x;
    vec4 v37 = v36;
    v37.y = v35.y;
    ...
    v38.z = v35.z;
    vec4 v39 = v38;
    v39.w = v34 * ((CB1[gl_InstanceID * 7 + 6].z * 0.055555999279022216796875) * exp2((v33 * dot(v12, normalize(v21 + normalize(v16)))) - v33));
    gl_Position = v24;
    VARYING0 = v15;
    VARYING1 = v26;
