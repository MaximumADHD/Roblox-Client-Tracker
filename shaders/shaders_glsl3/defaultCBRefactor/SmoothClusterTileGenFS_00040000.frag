...
void main()
{
    ...
    vec3 f33 = (((mix(vec3(1.0), CB5[int(VARYING6.x + 0.5) * 3 + 2].xyz, vec3(f30.w)) * f30.xyz) * f6.x) + ((mix(vec3(1.0), CB5[int(VARYING6.y + 0.5) * 3 + 2].xyz, vec3(f31.w)) * f31.xyz) * f6.y)) + ((mix(vec3(1.0), CB5[int(VARYING6.z + 0.5) * 3 + 2].xyz, vec3(f32.w)) * f32.xyz) * f6.z);
