...
void main()
{
    ...
    float f109 = f103.y;
    float f110 = f103.z;
    vec3 f111 = ((((f79 + (((vec3(f100) - (f99 * (f46 * f100))) * (((((((CB0[40].xyz * f105) + (CB0[42].xyz * f106)) + (CB0[44].xyz * f107)) + (CB0[41].xyz * f108)) + (CB0[43].xyz * f109)) + (CB0[45].xyz * f110)) + (((((((CB0[34].xyz * f105) + (CB0[36].xyz * f106)) + (CB0[38].xyz * f107)) + (CB0[35].xyz * f108)) + (CB0[37].xyz * f109)) + (CB0[39].xyz * f110)) * f57))) * 1.0)) + ((CB0[32].xyz + (CB0[33].xyz * (f57 * (2.0 - CB0[14].w)))) * 1.0)) + vec3((f5.z * 2.0) * f38)) * f36) + ((f78 * (f38 * VARYING0.w)) + ((mix(f95, textureLod(PrefilteredEnvTexture, f93, f92).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f47.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f57)) * f99) * f46));
    vec4 f112 = vec4(0.0);
    f112.x = f111.x;
    vec4 f113 = f112;
    f113.y = f111.y;
