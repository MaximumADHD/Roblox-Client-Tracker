...
void main()
{
    ...
    VARYING6 = (CB0[15].xyz * max(v27, 0.0)) + (CB0[17].xyz * max(-v27, 0.0));
    VARYING7 = v5;
    VARYING8 = ((CB5[int(TEXCOORD0.x + 0.5) * 3 + 2] * v21) + (CB5[int(TEXCOORD0.y + 0.5) * 3 + 2] * v23)) + (CB5[int(TEXCOORD0.z + 0.5) * 3 + 2] * v25);
}
