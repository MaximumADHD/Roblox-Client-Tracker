...
void main()
{
    ...
    vec4 f30 = vec4(f16, 1.0) * mat4(CB4[((dot(f27, f27) < CB0[46].w) ? 0 : ((dot(f28, f28) < CB0[47].w) ? 1 : ((dot(f29, f29) < CB0[48].w) ? 2 : 3))) * 4 + 0], CB4[((dot(f27, f27) < CB0[46].w) ? 0 : ((dot(f28, f28) < CB0[47].w) ? 1 : ((dot(f29, f29) < CB0[48].w) ? 2 : 3))) * 4 + 1], CB4[((dot(f27, f27) < CB0[46].w) ? 0 : ((dot(f28, f28) < CB0[47].w) ? 1 : ((dot(f29, f29) < CB0[48].w) ? 2 : 3))) * 4 + 2], CB4[((dot(f27, f27) < CB0[46].w) ? 0 : ((dot(f28, f28) < CB0[47].w) ? 1 : ((dot(f29, f29) < CB0[48].w) ? 2 : 3))) * 4 + 3]);
