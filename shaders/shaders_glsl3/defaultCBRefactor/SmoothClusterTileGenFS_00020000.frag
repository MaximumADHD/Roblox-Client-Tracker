...
void main()
{
    ...
    vec3 f39;
    if (!(CB5[f36 * 3 + 2].w == 0.0))
    {
        f39 = (mix(vec3(1.0), CB5[f36 * 3 + 2].xyz, vec3(f33.w)) * f33.xyz) * f6.x;
    }
    else
    {
        ...
        float f41 = f40.x;
        float f42 = f40.y;
        float f43 = CB5[f36 * 3 + 2].x * f33.y;
        float f44 = (CB5[f36 * 3 + 2].y * f41) - (CB5[f36 * 3 + 2].z * f42);
        float f45 = (CB5[f36 * 3 + 2].z * f41) + (CB5[f36 * 3 + 2].y * f42);
        float f46 = f43 - f45;
        f39 = (vec3(f46, f43, f46) + (vec3(f44, f45, f44) * vec3(1.0, 1.0, -1.0))) * f6.x;
    }
    vec3 f47;
    if (!(CB5[f37 * 3 + 2].w == 0.0))
    {
        f47 = f39 + ((mix(vec3(1.0), CB5[f37 * 3 + 2].xyz, vec3(f34.w)) * f34.xyz) * f6.y);
    }
    else
    {
        ...
        float f49 = f48.x;
        float f50 = f48.y;
        float f51 = CB5[f37 * 3 + 2].x * f34.y;
        float f52 = (CB5[f37 * 3 + 2].y * f49) - (CB5[f37 * 3 + 2].z * f50);
        float f53 = (CB5[f37 * 3 + 2].z * f49) + (CB5[f37 * 3 + 2].y * f50);
        float f54 = f51 - f53;
    ...
    {
        f55 = f47 + ((mix(vec3(1.0), CB5[f38 * 3 + 2].xyz, vec3(f35.w)) * f35.xyz) * f6.z);
    }
    else
    {
        ...
        float f57 = f56.x;
        float f58 = f56.y;
        float f59 = CB5[f38 * 3 + 2].x * f35.y;
        float f60 = (CB5[f38 * 3 + 2].y * f57) - (CB5[f38 * 3 + 2].z * f58);
        float f61 = (CB5[f38 * 3 + 2].z * f57) + (CB5[f38 * 3 + 2].y * f58);
        float f62 = f59 - f61;
