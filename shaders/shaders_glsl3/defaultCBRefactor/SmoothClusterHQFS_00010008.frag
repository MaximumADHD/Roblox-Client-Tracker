...
void main()
{
    ...
    vec4 f44 = vec4(f30, 1.0) * mat4(CB4[((dot(f41, f41) < CB0[46].w) ? 0 : ((dot(f42, f42) < CB0[47].w) ? 1 : ((dot(f43, f43) < CB0[48].w) ? 2 : 3))) * 4 + 0], CB4[((dot(f41, f41) < CB0[46].w) ? 0 : ((dot(f42, f42) < CB0[47].w) ? 1 : ((dot(f43, f43) < CB0[48].w) ? 2 : 3))) * 4 + 1], CB4[((dot(f41, f41) < CB0[46].w) ? 0 : ((dot(f42, f42) < CB0[47].w) ? 1 : ((dot(f43, f43) < CB0[48].w) ? 2 : 3))) * 4 + 2], CB4[((dot(f41, f41) < CB0[46].w) ? 0 : ((dot(f42, f42) < CB0[47].w) ? 1 : ((dot(f43, f43) < CB0[48].w) ? 2 : 3))) * 4 + 3]);
