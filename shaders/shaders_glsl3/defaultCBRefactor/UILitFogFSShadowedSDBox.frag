...
void main()
{
    ...
    vec4 f33 = vec4(VARYING4.xyz, 1.0) * mat4(CB4[((dot(f30, f30) < CB0[46].w) ? 0 : ((dot(f31, f31) < CB0[47].w) ? 1 : ((dot(f32, f32) < CB0[48].w) ? 2 : 3))) * 4 + 0], CB4[((dot(f30, f30) < CB0[46].w) ? 0 : ((dot(f31, f31) < CB0[47].w) ? 1 : ((dot(f32, f32) < CB0[48].w) ? 2 : 3))) * 4 + 1], CB4[((dot(f30, f30) < CB0[46].w) ? 0 : ((dot(f31, f31) < CB0[47].w) ? 1 : ((dot(f32, f32) < CB0[48].w) ? 2 : 3))) * 4 + 2], CB4[((dot(f30, f30) < CB0[46].w) ? 0 : ((dot(f31, f31) < CB0[47].w) ? 1 : ((dot(f32, f32) < CB0[48].w) ? 2 : 3))) * 4 + 3]);
