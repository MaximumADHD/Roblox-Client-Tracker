...
void main()
{
    ...
    int v2 = int(TEXCOORD0.x);
    vec2 v3 = vec2(dot(v0, CB2[v1 * 2 + 0].xyz), dot(v0, CB2[v1 * 2 + 1].xyz)) * CB5[v2 * 3 + 0].x;
    float v4 = ((NORMAL.w * 0.0078125) - 1.0) * CB5[v2 * 3 + 0].z;
    int v5 = int(TEXCOORD1.y);
    int v6 = int(TEXCOORD0.y);
    vec2 v7 = vec2(dot(v0, CB2[v5 * 2 + 0].xyz), dot(v0, CB2[v5 * 2 + 1].xyz)) * CB5[v6 * 3 + 0].x;
    float v8 = ((TEXCOORD0.w * 0.0078125) - 1.0) * CB5[v6 * 3 + 0].z;
    int v9 = int(TEXCOORD1.z);
    int v10 = int(TEXCOORD0.z);
    vec2 v11 = vec2(dot(v0, CB2[v9 * 2 + 0].xyz), dot(v0, CB2[v9 * 2 + 1].xyz)) * CB5[v10 * 3 + 0].x;
    float v12 = ((TEXCOORD1.w * 0.0078125) - 1.0) * CB5[v10 * 3 + 0].z;
    ...
    VARYING1 = vec4(((v3 * sqrt(1.0 - (v4 * v4))) + (v3.yx * vec2(v4, -v4))) + (vec2(NORMAL.w, floor(NORMAL.w * 2.6651442050933837890625)) * CB5[v2 * 3 + 0].y), ((v7 * sqrt(1.0 - (v8 * v8))) + (v7.yx * vec2(v8, -v8))) + (vec2(TEXCOORD0.w, floor(TEXCOORD0.w * 2.6651442050933837890625)) * CB5[v6 * 3 + 0].y));
    VARYING2 = vec4(CB5[v2 * 3 + 0].w, 0.0, CB5[v6 * 3 + 0].w, 0.0);
    VARYING3 = vec4(((v11 * sqrt(1.0 - (v12 * v12))) + (v11.yx * vec2(v12, -v12))) + (vec2(TEXCOORD1.w, floor(TEXCOORD1.w * 2.6651442050933837890625)) * CB5[v10 * 3 + 0].y), CB5[v10 * 3 + 0].w, 0.0);
