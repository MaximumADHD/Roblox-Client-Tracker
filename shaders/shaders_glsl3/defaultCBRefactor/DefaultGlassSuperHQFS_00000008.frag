...
void main()
{
    ...
    vec4 f54 = vec4(f40, 1.0) * mat4(CB4[((dot(f51, f51) < CB0[46].w) ? 0 : ((dot(f52, f52) < CB0[47].w) ? 1 : ((dot(f53, f53) < CB0[48].w) ? 2 : 3))) * 4 + 0], CB4[((dot(f51, f51) < CB0[46].w) ? 0 : ((dot(f52, f52) < CB0[47].w) ? 1 : ((dot(f53, f53) < CB0[48].w) ? 2 : 3))) * 4 + 1], CB4[((dot(f51, f51) < CB0[46].w) ? 0 : ((dot(f52, f52) < CB0[47].w) ? 1 : ((dot(f53, f53) < CB0[48].w) ? 2 : 3))) * 4 + 2], CB4[((dot(f51, f51) < CB0[46].w) ? 0 : ((dot(f52, f52) < CB0[47].w) ? 1 : ((dot(f53, f53) < CB0[48].w) ? 2 : 3))) * 4 + 3]);
    ...
    float f72 = (f25 * CB0[14].w) * (((f25 * CB0[52].x) > 0.0) ? mix(min((f59 <= f63) ? 1.0 : clamp(((f64 / (f64 + (f65 * f65))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0), (f60 <= f66) ? 1.0 : clamp(((f67 / (f67 + (f68 * f68))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0)), f50, clamp((length(f40 - CB0[11].xyz) * CB0[51].y) - (CB0[51].x * CB0[51].y), 0.0, 1.0)) : f50);
    vec3 f73;
    vec3 f74;
    if (f72 > 0.0)
    {
