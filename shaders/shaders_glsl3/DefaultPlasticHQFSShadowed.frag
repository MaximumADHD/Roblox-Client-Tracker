...
void main()
{
    ...
    float f39 = max(CB0[26].w, CB2[0].w) * f2;
    float f40 = max(CB2[0].z, 0.04500000178813934326171875);
    ...
    vec3 f73 = (((((((((vec3(1.0) - (f55 * f39)) * 1.0) * CB0[10].xyz) * f48) * f37) + (f61 * (((((((CB0[35].xyz * f66) + (CB0[37].xyz * f67)) + (CB0[39].xyz * f68)) + (CB0[36].xyz * f69)) + (CB0[38].xyz * f70)) + (CB0[40].xyz * f71)) + (((((((CB0[29].xyz * f66) + (CB0[31].xyz * f67)) + (CB0[33].xyz * f68)) + (CB0[30].xyz * f69)) + (CB0[32].xyz * f70)) + (CB0[34].xyz * f71)) * f17)))) + (CB0[27].xyz + (CB0[28].xyz * f17))) * f46) + (((((f55 * ((f56 + (f56 * f56)) / (((f57 * f57) * ((f51 * 3.0) + 0.5)) * ((f50 * 0.75) + 0.25)))) * CB0[10].xyz) * f48) * f37) + f72)) + (f16 * mix(f46, f72 * (1.0 / (max(max(f72.x, f72.y), f72.z) + 0.00999999977648258209228515625)), ((vec3(1.0) - f61) * f39) * (1.0 - f17)));
