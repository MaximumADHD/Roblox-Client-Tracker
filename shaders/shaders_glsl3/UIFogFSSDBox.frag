...
void main()
{
    ...
    vec4 f18 = f17;
    f18.z = f15.z;
    float f19 = clamp(exp2((CB0[18].z * length(VARYING2)) + CB0[18].x) - CB0[18].w, 0.0, 1.0);
    vec3 f20 = textureLod(PrefilteredEnvTexture, vec4(-VARYING2, 0.0).xyz, max(CB0[18].y, f19) * 5.0).xyz;
