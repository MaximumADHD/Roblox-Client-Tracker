...
void main()
{
    ...
    float v37 = (clamp(2.0 - (dot(v21, v20) * 3.0), 0.0, 1.0) * 0.300000011920928955078125) * clamp(v35, 0.0, 1.0);
    vec4 v38 = COLOR0;
    ...
    float v40 = COLOR1.y * 0.50359976291656494140625;
    ...
    v45.z = v42.z;
    vec4 v46 = v45;
    v46.w = v41 * ((COLOR1.y * 0.055555999279022216796875) * exp2((v40 * dot(v21, normalize(v24 + v20))) - v40));
    gl_Position = v27;
    VARYING0 = TEXCOORD0;
    VARYING1 = v29;
    VARYING2 = v38;
