...
void main()
{
    ...
    do
    {
        ...
        vec3 f77 = f27 * f21;
        bvec3 f78 = bvec3(f26 && (!(CB0[58].w == 0.0)));
        f76 = textureLod(PrefilteredEnvTexture, vec4(-vec3(f78.x ? f77.x : f21.x, f78.y ? f77.y : f21.y, f78.z ? f77.z : f21.z), 0.0).xyz, max(CB0[18].y, f75) * 5.0).xyz;
        break;
    } while(false);
    vec3 f79 = mix(f76, f74.xyz, vec3(f75));
    vec4 f80 = f74;
    f80.x = f79.x;
    vec4 f81 = f80;
    f81.y = f79.y;
