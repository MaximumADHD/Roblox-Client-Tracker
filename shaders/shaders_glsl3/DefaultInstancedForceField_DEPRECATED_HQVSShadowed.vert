...
void main()
{
    ...
    vec2 v18 = TEXCOORD0.zw * v17;
    float v19 = dot(v13, -CB0[11].xyz);
    vec4 v20 = vec4(v6, v7, v8, 1.0) * mat4(CB0[0], CB0[1], CB0[2], CB0[3]);
    vec4 v21 = vec4(v18.x, v18.y, vec4(0.0).z, vec4(0.0).w);
    ...
    VARYING6 = vec4((CB0[10].xyz * max(v19, 0.0)) + (CB0[12].xyz * max(-v19, 0.0)), (float(v19 > 0.0) * (CB1[gl_InstanceID * 7 + 6].z * 0.0039215688593685626983642578125)) * CB0[23].w);
    VARYING7 = v24;
