...
void main()
{
    ...
    vec4 f10 = texture(EditableImageEmissiveMaskTexture, VARYING0);
    float f11 = gl_FrontFacing ? 1.0 : (-1.0);
    vec3 f12 = VARYING6.xyz * f11;
    vec3 f13 = VARYING5.xyz * f11;
    vec3 f14 = normalize(((f12 * f7.x) + ((cross(f13, f12) * VARYING6.w) * f7.y)) + (f13 * f7.z));
    vec3 f15 = f5.xyz;
    vec3 f16 = f15 * f15;
    vec4 f17 = f5;
    f17.x = f16.x;
    ...
    float f23 = 0.08900000154972076416015625 + (f9.x * 0.9110000133514404296875);
    vec3 f24 = -f21;
