...
void main()
{
    ...
    vec3 v11 = v10;
    v11.y = v4.y;
    vec3 v12 = ((POSITION.xyz + (v0 * 6.0)).yxz * CB0[21].xyz) + CB0[22].xyz;
    vec4 v13 = vec4(0.0);
    v13.x = v12.x;
    vec4 v14 = v13;
    v14.y = v12.y;
    ...
    float v19 = (clamp(2.0 - (dot(v0, v3) * 3.0), 0.0, 1.0) * 0.300000011920928955078125) * clamp(v17, 0.0, 1.0);
    vec4 v20 = v1;
    ...
    v27.z = v24.z;
    vec4 v28 = v27;
    v28.w = v23 * ((COLOR1.y * 0.055555999279022216796875) * exp2((v22 * dot(v0, normalize(v6 + v3))) - v22));
    gl_Position = v9;
    VARYING0 = TEXCOORD0;
    VARYING1 = v11;
    VARYING2 = v20;
    VARYING3 = v16;
    VARYING4 = vec4(v2, v9.w);
