...
void main()
{
    ...
    vec2 f95 = CB0[50].xy * 0.5;
    vec2 f96 = f95 / CB0[50].zw;
    vec2 f97 = (f91 + f94) + f96;
    vec2 f98 = (f91 - f94) + f96;
    vec4 f99 = texture(GBufferColorTexture, (f86 + (f93 * clamp(min(texture(GBufferDepthTexture, (vec2(clamp(f97.x, 0.0, 1.0), clamp(f97.y, 0.0, 1.0)) * CB0[50].zw) - f95).x * 500.0, texture(GBufferDepthTexture, (vec2(clamp(f98.x, 0.0, 1.0), clamp(f98.y, 0.0, 1.0)) * CB0[50].zw) - f95).x * 500.0) - f82, 0.0, 1.0))) * CB0[50].zw);
    vec3 f100 = f99.xyz;
    ...
    vec4 f110 = mix(mix(f109, vec4(mix(((((f44 * f18) + ((((vec3(1.0) - (f60 * f28)) * CB0[15].xyz) * f53) + (CB0[17].xyz * clamp(-f51, 0.0, 1.0)))) + (((vec3(1.0) - (f65 * f28)) * (((((((CB0[40].xyz * f70) + (CB0[42].xyz * f71)) + (CB0[44].xyz * f72)) + (CB0[41].xyz * f73)) + (CB0[43].xyz * f74)) + (CB0[45].xyz * f75)) + (((((((CB0[34].xyz * f70) + (CB0[36].xyz * f71)) + (CB0[38].xyz * f72)) + (CB0[35].xyz * f73)) + (CB0[37].xyz * f74)) + (CB0[39].xyz * f75)) * f45))) * f18)) + (CB0[32].xyz + (CB0[33].xyz * f45))) * (f24 * f18), f49, vec3(VARYING7.w)), 1.0), vec4(f18)), vec4(f49, 1.0), vec4(((f76 * f76) * 0.800000011920928955078125) * f19)) + vec4((((f60 * (((f61 + (f61 * f61)) / (((f62 * f62) * ((f56 * 3.0) + 0.5)) * ((f55 * 0.75) + 0.25))) * f53)) * CB0[15].xyz) * 1.0) + (((mix(f36, f34, f48) * f65) * f28) * f18), 0.0);
    float f111 = clamp(exp2((CB0[18].z * f25) + CB0[18].x) - CB0[18].w, 0.0, 1.0);
    vec3 f112 = textureLod(PrefilteredEnvTexture, vec4(f30, 0.0).xyz, max(CB0[18].y, f111) * 5.0).xyz;
