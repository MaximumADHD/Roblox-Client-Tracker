...
void main()
{
    ...
    vec4 f64 = f63;
    f64.w = 1.0;
    vec3 f65 = textureLod(PrefilteredEnvTexture, vec4(f49, 0.0).xyz, max(CB0[13].y, VARYING6.w) * 5.0).xyz;
