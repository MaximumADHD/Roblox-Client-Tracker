...
void main()
{
    ...
    vec4 v24 = vec4((TEXCOORD0.xy * v17) + CB1[gl_InstanceID * 7 + 6].xy, 0.0, 0.0);
    vec4 v25 = vec4(0.0, (TEXCOORD0.zw * v19).y, 0.0, 0.0);
    ...
    gl_Position = v23;
    VARYING0 = vec4(v24.x, v24.y, v27.x, v27.y);
    ...
    VARYING6 = vec4((CB0[10].xyz * max(v22, 0.0)) + (CB0[12].xyz * max(-v22, 0.0)), (float(v22 > 0.0) * (CB1[gl_InstanceID * 7 + 6].z * 0.0039215688593685626983642578125)) * CB0[23].w);
    VARYING7 = v28;
