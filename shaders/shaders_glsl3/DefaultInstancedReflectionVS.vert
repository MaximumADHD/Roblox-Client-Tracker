...
void main()
{
    ...
    float v27 = clamp(v19, 0.0, 1.0);
    vec3 v28 = (CB0[10].xyz * v27) + (CB0[12].xyz * clamp(-v19, 0.0, 1.0));
    vec4 v29 = vec4(v28.x, v28.y, v28.z, vec4(0.0).w);
    v29.w = (v27 * CB0[23].w) * (CB1[gl_InstanceID * 7 + 6].z * exp2((v26 * dot(v13, normalize(v18 + normalize(v20)))) - v26));
    gl_Position = v22;
