...
void main()
{
    ...
    vec3 v27 = (CB0[10].xyz * v26) + (CB0[12].xyz * clamp(-v14, 0.0, 1.0));
    vec4 v28 = vec4(v27.x, v27.y, v27.z, vec4(0.0).w);
    v28.w = (v26 * CB0[23].w) * (COLOR1.y * exp2((v25 * dot(v11, normalize(v13 + normalize(v12)))) - v25));
    gl_Position = v16;
    VARYING0 = TEXCOORD0;
    VARYING1 = TEXCOORD1;
    VARYING2 = v23;
