...
void main()
{
    ...
    if (f59 > 0.0)
    {
        ...
        f60 = (((vec3(f67) + (vec3(0.0199999995529651641845703125) * (1.0 - f67))) * (((f68 + (f68 * f68)) / max(((f69 * f69) * ((f64 * 3.0) + 0.5)) * ((f63 * 0.75) + 0.25), 7.0000001869630068540573120117188e-05)) * clamp(f59, 0.0, 1.0))) * CB0[15].xyz) * (CB0[14].w * CB0[14].w);
    }
    else
    {
        f60 = vec3(0.0);
