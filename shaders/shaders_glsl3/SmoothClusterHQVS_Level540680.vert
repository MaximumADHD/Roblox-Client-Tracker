...
void main()
{
    ...
    vec4 v22 = v21;
    v22.z = v19.z;
    bvec3 v23 = greaterThan(TEXCOORD1.xyz, vec3(7.5));
    gl_Position = v4;
    VARYING0 = v22;
    ...
    VARYING6 = v1;
    VARYING7 = vec3(v23.x ? vec3(1.0).x : vec3(0.0).x, v23.y ? vec3(1.0).y : vec3(0.0).y, v23.z ? vec3(1.0).z : vec3(0.0).z);
    VARYING8 = vec4(TEXCOORD0.xyz, 0.0);
}
