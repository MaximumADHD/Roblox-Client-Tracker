...
void main()
{
    ...
    int _403 = _371 + 1;
    float _412 = float((2 * _403) + 1);
    float _421 = exp((((-1.0) - _412) * (_412 + 1.0)) * _222);
    float _422 = exp(((-_412) * _412) * _222) + _421;
    vec2 _425 = CB1[1].xy * (_412 + (_421 / _422));
    int _435 = _403 + 1;
    float _444 = float((2 * _435) + 1);
    float _453 = exp((((-1.0) - _444) * (_444 + 1.0)) * _222);
    float _454 = exp(((-_444) * _444) * _222) + _453;
    vec2 _457 = CB1[1].xy * (_444 + (_453 / _454));
    float _476 = float((2 * (_435 + 1)) + 1);
    float _485 = exp((((-1.0) - _476) * (_476 + 1.0)) * _222);
    float _486 = exp(((-_476) * _476) * _222) + _485;
    vec2 _489 = CB1[1].xy * (_476 + (_485 / _486));
    _entryPointOutput = (((((((texture(Texture0Texture, VARYING0) + ((texture(Texture0Texture, VARYING0 + _266) + texture(Texture0Texture, VARYING0 - _266)) * _256)) + ((texture(Texture0Texture, VARYING0 + _329) + texture(Texture0Texture, VARYING0 - _329)) * _326)) + ((texture(Texture0Texture, VARYING0 + _361) + texture(Texture0Texture, VARYING0 - _361)) * _358)) + ((texture(Texture0Texture, VARYING0 + _393) + texture(Texture0Texture, VARYING0 - _393)) * _390)) + ((texture(Texture0Texture, VARYING0 + _425) + texture(Texture0Texture, VARYING0 - _425)) * _422)) + ((texture(Texture0Texture, VARYING0 + _457) + texture(Texture0Texture, VARYING0 - _457)) * _454)) + ((texture(Texture0Texture, VARYING0 + _489) + texture(Texture0Texture, VARYING0 - _489)) * _486)) / vec4(((((((1.0 + (2.0 * _256)) + (2.0 * _326)) + (2.0 * _358)) + (2.0 * _390)) + (2.0 * _422)) + (2.0 * _454)) + (2.0 * _486));
}
