...
void main()
{
    ...
    vec3 f73 = (((((((vec3(1.0) - (f54 * f38)) * CB0[10].xyz) * f47) + (((vec3(1.0) - f60) * f71) * CB0[25].w)) + ((CB0[27].xyz + (CB0[28].xyz * f18)) * 1.0)) * f45) + (((f54 * (((f55 + (f55 * f55)) / (((f56 * f56) * ((f50 * 3.0) + 0.5)) * ((f49 * 0.75) + 0.25))) * f47)) * CB0[10].xyz) + (f72 * f18))) + (((f16.xyz * (f16.w * 120.0)).xyz * mix(f45, f72 * (1.0 / (max(max(f71.x, f71.y), f71.z) + 0.00999999977648258209228515625)), f60 * (f38 * (1.0 - f18)))) * 1.0);
