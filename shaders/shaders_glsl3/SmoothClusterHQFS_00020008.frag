...
void main()
{
    ...
    if (f77 > 0.0)
    {
        vec3 f80 = normalize(f42 - CB0[16].xyz);
        ...
        f78 = ((f88 * (((f89 + (f89 * f89)) / max(((f90 * f90) * ((f84 * 3.0) + 0.5)) * ((f83 * 0.75) + 0.25), 7.0000001869630068540573120117188e-05)) * f81)) * CB0[15].xyz) * (CB0[14].w * CB0[14].w);
    }
    else
    {
        f79 = f56;
