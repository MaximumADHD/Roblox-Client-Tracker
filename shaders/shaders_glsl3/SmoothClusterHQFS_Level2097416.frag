...
void main()
{
    ...
    float f84 = f78.y;
    float f85 = f78.z;
    vec3 f86 = (((((((f35.xyz * (f35.w * 120.0)) * 1.0) + (((vec3(1.0) - (f65 * f27)) * CB0[15].xyz) * f58)) + ((vec3(1.0) - (f75 * f27)) * (((((((CB0[40].xyz * f80) + (CB0[42].xyz * f81)) + (CB0[44].xyz * f82)) + (CB0[41].xyz * f83)) + (CB0[43].xyz * f84)) + (CB0[45].xyz * f85)) + (((((((CB0[34].xyz * f80) + (CB0[36].xyz * f81)) + (CB0[38].xyz * f82)) + (CB0[35].xyz * f83)) + (CB0[37].xyz * f84)) + (CB0[39].xyz * f85)) * f37)))) + (CB0[32].xyz + ((CB0[33].xyz * (2.0 - CB0[14].w)) * f37))) + vec3((f5.z * 2.0) * f21)) * (f19.xyz * f19.xyz)) + (((((f65 * (((f66 + (f66 * f66)) / (((f67 * f67) * ((f61 * 3.0) + 0.5)) * ((f60 * 0.75) + 0.25))) * f58)) * CB0[15].xyz) * (CB0[14].w * CB0[14].w)) * (f21 * VARYING0.w)) + ((mix(f71, textureLod(PrefilteredEnvTexture, f69, f68).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f28.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f37)) * f75) * f27));
    vec4 f87 = vec4(0.0);
    f87.x = f86.x;
    vec4 f88 = f87;
    f88.y = f86.y;
