...
void main()
{
    ...
    vec4 v19 = vec4(dot(CB0[20], v17), dot(CB0[21], v17), dot(CB0[22], v17), 0.0);
    v19.w = CB1[gl_InstanceID * 7 + 6].w;
    vec4 v20 = vec4(v10, v11, v12, 0.0);
    v20.w = inversesqrt(0.1745329201221466064453125 * CB1[gl_InstanceID * 7 + 6].z);
    gl_Position = v18;
