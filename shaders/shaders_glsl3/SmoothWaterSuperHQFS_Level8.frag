...
void main()
{
    ...
    vec4 f107 = f106;
    f107.w = 1.0;
    vec3 f108 = textureLod(PrefilteredEnvTexture, vec4(f60, 0.0).xyz, max(CB0[13].y, VARYING6.w) * 5.0).xyz;
    bvec3 f109 = bvec3(!(CB0[13].w == 0.0));
    vec3 f110 = mix(vec3(f109.x ? CB0[14].xyz.x : f108.x, f109.y ? CB0[14].xyz.y : f108.y, f109.z ? CB0[14].xyz.z : f108.z), f107.xyz, vec3(VARYING6.w));
    vec4 f111 = f107;
    f111.x = f110.x;
    vec4 f112 = f111;
    f112.y = f110.y;
