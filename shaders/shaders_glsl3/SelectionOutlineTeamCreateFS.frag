...
void main()
{
    ...
    int f35 = int(floor(textureLod(Texture0Texture, VARYING0, 0.0).x * 255.5));
    float f36 = (textureLod(Texture1Texture, min(f34, CB1[12].zw), 0.0).x < textureLod(Texture2Texture, min(f34, CB1[13].xy), 0.0).x) ? CB1[2].y : 1.0;
