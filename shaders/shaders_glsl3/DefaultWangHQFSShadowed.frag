...
void main()
{
    ...
    float f47 = max(CB0[26].w, CB2[0].w) * f2;
    ...
    vec3 f61 = (((((((vec3(1.0) - (f58 * f47)) * (1.0 - f49)) * CB0[10].xyz) * f51) * f45) + min((f24.xyz * (f24.w * 120.0)).xyz + (CB0[8].xyz + (CB0[9].xyz * f25.x)), vec3(CB0[16].w))) * f46) + ((((f58 * ((f59 + (f59 * f59)) / (((f60 * f60) * ((f54 * 3.0) + 0.5)) * ((f53 * 0.75) + 0.25)))) * CB0[10].xyz) * f51) * f45);
