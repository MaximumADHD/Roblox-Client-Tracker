...
void main()
{
    ...
    v18.w = 0.0;
    vec4 v19 = vec4(dot(CB0[20], v15), dot(CB0[21], v15), dot(CB0[22], v15), 0.0);
    v19.w = COLOR1.w * 0.0039215688593685626983642578125;
    float v20 = COLOR1.y * 0.50359570980072021484375;
    float v21 = clamp(v14, 0.0, 1.0);
    vec3 v22 = (CB0[10].xyz * v21) + (CB0[12].xyz * clamp(-v14, 0.0, 1.0));
    vec4 v23 = vec4(v22.x, v22.y, v22.z, vec4(0.0).w);
    v23.w = (v21 * CB0[23].w) * (COLOR1.y * exp2((v20 * dot(v11, normalize(v13 + normalize(v12)))) - v20));
    gl_Position = v16;
    VARYING0 = TEXCOORD0;
    VARYING1 = TEXCOORD1;
    VARYING2 = COLOR0;
