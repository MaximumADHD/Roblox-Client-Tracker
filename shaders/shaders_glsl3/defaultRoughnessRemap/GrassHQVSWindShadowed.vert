...
void main()
{
    ...
    vec3 v44 = v42;
    v44.y = v43;
    vec3 v45 = CB0[7].xyz - v44;
    float v46 = length(v45);
    vec3 v47 = -CB0[11].xyz;
    float v48 = abs(dot(v1, v47));
    ...
    v53.x = (v48 * 0.5) + 0.5;
    vec4 v54 = v53;
    v54.y = abs(dot(v51, v1));
    vec4 v55 = v54;
    v55.z = (dot(v50, CB0[11].xyz) * v52) * v49;
    vec4 v56 = v55;
    v56.w = (pow(clamp(v51.y, 0.0, 1.0), 8.0) * v52) * v49;
    gl_Position = vec4(v23.x, v43, v23.z, 1.0) * mat4(CB0[0], CB0[1], CB0[2], CB0[3]);
    VARYING0 = vec4(((v44 + vec3(0.0, 6.0, 0.0)).yxz * CB0[16].xyz) + CB0[17].xyz, clamp(exp2((CB0[13].z * v46) + CB0[13].x) - CB0[13].w, 0.0, 1.0));
    VARYING1 = v44;
