...
void main()
{
    ...
    vec3 f51 = textureLod(PrefilteredEnvTexture, vec4(f2, 0.0).xyz, max(CB0[13].y, f50) * 5.0).xyz;
    bvec3 f52 = bvec3(!(CB0[13].w == 0.0));
    vec3 f53 = mix(vec3(f52.x ? CB0[14].xyz.x : f51.x, f52.y ? CB0[14].xyz.y : f51.y, f52.z ? CB0[14].xyz.z : f51.z), f23.xyz, vec3(f50));
    vec4 f54 = f23;
    f54.x = f53.x;
    vec4 f55 = f54;
    f55.y = f53.y;
    ...
    f58.w = f57;
    vec4 f59 = f58;
    f59.w = f57 * max(f50, CB0[13].y);
    _entryPointOutput_color = f59;
}
