...
void main()
{
    ...
    float f57 = 0.08900000154972076416015625 + (mix(f15, f16, vec4(clamp((f0 * CB2[3].z) - (CB2[2].z * CB2[3].z), 0.0, 1.0))).y * 0.9110000133514404296875);
    ...
    float f93 = f86.z;
    float f94 = 1.0 - f59;
    vec4 f95 = mix(vec4(mix(((((((vec3(1.0) - (f76 * f58)) * CB0[10].xyz) * f69) + (f33 * f18)) + (((vec3(1.0) - (f83 * f58)) * (((((((CB0[35].xyz * f88) + (CB0[37].xyz * f89)) + (CB0[39].xyz * f90)) + (CB0[36].xyz * f91)) + (CB0[38].xyz * f92)) + (CB0[40].xyz * f93)) + (((((((CB0[29].xyz * f88) + (CB0[31].xyz * f89)) + (CB0[33].xyz * f90)) + (CB0[30].xyz * f91)) + (CB0[32].xyz * f92)) + (CB0[34].xyz * f93)) * f34))) * f18)) + (CB0[27].xyz + ((CB0[28].xyz * (2.0 - CB0[9].w)) * f34))) * (f54 * f18), f80, vec3(VARYING7.w)) * f18, f18), vec4(f80, 1.0), vec4(((f94 * f94) * 0.800000011920928955078125) * clamp(f17, 0.0, 1.0))) + vec4((((f76 * (((f77 + (f77 * f77)) / (((f78 * f78) * ((f72 * 3.0) + 0.5)) * ((f71 * 0.75) + 0.25))) * f69)) * CB0[10].xyz) * f67) + ((((mix(f65, f63, f79) * f83) * f58) * f67) * f18), 0.0);
    float f96 = clamp(exp2((CB0[13].z * f55) + CB0[13].x) - CB0[13].w, 0.0, 1.0);
