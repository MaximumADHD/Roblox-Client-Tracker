...
void main()
{
    ...
    v23.z = v20.z;
    vec3 v24 = vec3(0.0);
    v24.x = float((TEXCOORD0.x == TEXCOORD0.y) || (TEXCOORD0.x == TEXCOORD0.z));
    vec3 v25 = v24;
    v25.y = float((TEXCOORD0.y == TEXCOORD0.x) || (TEXCOORD0.y == TEXCOORD0.z));
    vec3 v26 = v25;
    v26.z = float((TEXCOORD0.z == TEXCOORD0.x) || (TEXCOORD0.z == TEXCOORD0.y));
    vec4 v27 = vec4(0.0);
    v27.w = (dot(v26, v23.xyz) * 20.0) - 19.0;
    vec4 v28 = v27;
    v28.x = TEXCOORD0.x;
    vec4 v29 = v28;
    v29.y = TEXCOORD0.y;
    vec4 v30 = v29;
    v30.z = TEXCOORD0.z;
    bvec3 v31 = greaterThan(TEXCOORD1.xyz, vec3(7.5));
    gl_Position = v4;
    VARYING0 = v23;
    ...
    VARYING6 = v1;
    VARYING7 = vec3(v31.x ? vec3(1.0).x : vec3(0.0).x, v31.y ? vec3(1.0).y : vec3(0.0).y, v31.z ? vec3(1.0).z : vec3(0.0).z);
    VARYING8 = v30;
    VARYING9 = v5;
}
