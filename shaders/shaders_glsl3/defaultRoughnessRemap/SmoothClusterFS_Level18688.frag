...
void main()
{
    ...
    vec3 f29 = (min((f26.xyz * (f26.w * 120.0)) + (CB0[27].xyz + ((CB0[28].xyz * (2.0 - CB0[9].w)) * f27.x)), vec3(CB0[16].w)) + (VARYING6 * ((1.0 - ((step(f28.x, VARYING5.z) * clamp(CB0[24].z + (CB0[24].w * abs(VARYING5.z - 0.5)), 0.0, 1.0)) * f28.y)) * f27.y))) * (f22.xyz * f22.xyz);
    vec4 f30 = vec4(0.0);
    f30.x = f29.x;
    vec4 f31 = f30;
    f31.y = f29.y;
