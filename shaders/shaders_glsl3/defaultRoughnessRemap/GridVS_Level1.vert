...
void main()
{
    ...
    vec3 v25 = ((v11 + (v15 * 6.0)).yxz * CB0[16].xyz) + CB0[17].xyz;
    vec4 v26 = vec4(0.0);
    v26.x = v25.x;
    vec4 v27 = v26;
    v27.y = v25.y;
    ...
    v36.z = v33.z;
    vec4 v37 = v36;
    v37.w = (v32 * CB0[23].w) * (CB1[gl_InstanceID * 7 + 6].z * exp2((v31 * dot(v15, normalize(v21 + normalize(v20)))) - v31));
    gl_Position = v24;
