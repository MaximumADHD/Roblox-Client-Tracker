...
void main()
{
    ...
    vec3 f4 = max(vec3(0.0), mix(vec3(f3.x ? CB0[14].xyz.x : f2.x, f3.y ? CB0[14].xyz.y : f2.y, f3.z ? CB0[14].xyz.z : f2.z), (pow(VARYING2.xyz * 1.35000002384185791015625, vec3(4.0)) * 4.0).xyz, vec3(f1)).xyz);
