...
void main()
{
    vec4 f0 = mix(texture(DiffuseMapTexture, VARYING0.xy * CB2[2].y), texture(DiffuseMapTexture, VARYING0.xy), vec4(clamp((clamp(1.0 - (VARYING4.w * 0.0033333334140479564666748046875), 0.0, 1.0) * CB2[4].x) - (0.60000002384185791015625 * CB2[4].x), 0.0, 1.0)));
    ...
    float f8 = (1.0 - ((step(f7.x, VARYING6.z) * clamp(CB0[25].z + (CB0[25].w * abs(VARYING6.z - 0.5)), 0.0, 1.0)) * f7.y)) * f6.y;
    vec3 f9 = ((min(((f5.xyz * (f5.w * 120.0)).xyz + CB0[8].xyz) + (CB0[9].xyz * f6.x), vec3(CB0[17].w)) + (VARYING5.xyz * f8)) * (f1 * f1).xyz) + (CB0[10].xyz * (VARYING5.w * f8));
