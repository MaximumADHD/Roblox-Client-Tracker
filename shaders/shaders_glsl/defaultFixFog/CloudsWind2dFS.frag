...
void main()
{
    ...
    vec3 f55 = f52 - f54;
    vec3 f56 = (((((CB0[34].xyz * f55.x) + (CB0[36].xyz * f55.y)) + (CB0[38].xyz * f55.z)) + (CB0[35].xyz * f54.x)) + (CB0[37].xyz * f54.y)) + (CB0[39].xyz * f54.z);
    bvec3 f57 = bvec3(!(CB0[18].w == 0.0));
    vec3 f58 = mix(vec3(f57.x ? CB0[19].xyz.x : f56.x, f57.y ? CB0[19].xyz.y : f56.y, f57.z ? CB0[19].xyz.z : f56.z), f24.xyz, vec3(f51));
    vec4 f59 = f24;
    f59.x = f58.x;
    vec4 f60 = f59;
    f60.y = f58.y;
