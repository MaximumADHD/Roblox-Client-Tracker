...
void main()
{
    ...
    else
    {
        ...
        do
        {
            ...
            vec3 f54 = f4 * f4;
            bvec3 f55 = lessThan(f4, vec3(0.0));
            vec3 f56 = vec3(f55.x ? f54.x : vec3(0.0).x, f55.y ? f54.y : vec3(0.0).y, f55.z ? f54.z : vec3(0.0).z);
            vec3 f57 = f54 - f56;
            vec3 f58 = (((((CB0[34].xyz * f57.x) + (CB0[36].xyz * f57.y)) + (CB0[38].xyz * f57.z)) + (CB0[35].xyz * f56.x)) + (CB0[37].xyz * f56.y)) + (CB0[39].xyz * f56.z);
            bvec3 f59 = bvec3(!(CB0[18].w == 0.0));
            vec3 f60 = mix(vec3(f59.x ? CB0[19].xyz.x : f58.x, f59.y ? CB0[19].xyz.y : f58.y, f59.z ? CB0[19].xyz.z : f58.z), f26.xyz, vec3(f53));
            vec4 f61 = f26;
            f61.x = f60.x;
            vec4 f62 = f61;
            f62.y = f60.y;
            ...
            f65.w = f64;
            vec4 f66 = f65;
            f66.w = f64 * max(f53, CB0[18].y);
            f5 = f66;
            break;
        } while(false);
        vec3 f67 = f5.xyz * f5.w;
        vec4 f68 = f5;
        f68.x = f67.x;
        vec4 f69 = f68;
        f69.y = f67.y;
