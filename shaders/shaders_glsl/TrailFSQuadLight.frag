...
void main()
{
    ...
    vec3 f10 = sqrt(clamp(mix(f8, (min((f5.xyz * (f5.w * 120.0)).xyz + (CB0[8].xyz + (CB0[9].xyz * f6.x)), vec3(CB0[16].w)) + (CB0[10].xyz * ((1.0 - ((step(f7.x, VARYING3.z) * clamp(CB0[24].z + (CB0[24].w * abs(VARYING3.z - 0.5)), 0.0, 1.0)) * f7.y)) * f6.y))) * f8, vec3(CB1[0].z)).xyz * CB0[15].y, vec3(0.0), vec3(1.0))).xyz * f9;
