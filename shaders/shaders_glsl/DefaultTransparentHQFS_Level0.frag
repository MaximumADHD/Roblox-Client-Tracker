...
void main()
{
    ...
    vec3 f16 = -CB0[11].xyz;
    float f17 = dot(f13, f16) * ((1.0 - ((step(f9.x, f10) * clamp(CB0[24].z + (CB0[24].w * abs(f10 - 0.5)), 0.0, 1.0)) * f9.y)) * f8.y);
    ...
    float f29 = 1.0 - f15;
    vec3 f30 = ((((((vec3(f29) - (f26 * (f12 * f29))) * CB0[10].xyz) * f19) + (CB0[12].xyz * (f29 * clamp(-f17, 0.0, 1.0)))) + min((f7.xyz * (f7.w * 120.0)).xyz + (CB0[8].xyz + (CB0[9].xyz * f8.x)), vec3(CB0[16].w))) * f11) + ((f26 * (((f27 + (f27 * f27)) / (((f28 * f28) * ((f22 * 3.0) + 0.5)) * ((f21 * 0.75) + 0.25))) * f19)) * CB0[10].xyz);
    float f31 = f1.w;
