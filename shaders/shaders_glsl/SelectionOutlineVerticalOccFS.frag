...
void main()
{
    ...
    for (; f26 <= f0; f15 = f18, f14 = f17, f13 = f25, f12 = f24, f27 = f16, f11 = f23, f10 = f22, f9 = f21, f8 = f20, f7 = f19, f26++)
    {
        ...
        f18 = f15;
        f18.y = f15.y + CB1[0].w;
        vec4 f29 = vec4(255.0) - (texture2DLod(Texture0Texture, f17, 0.0) * 255.0);
        vec4 f30 = vec4(255.0) - (texture2DLod(Texture0Texture, f18, 0.0) * 255.0);
        vec4 f31 = f29 * f29;
        vec4 f32 = f30 * f30;
        vec2 f33;
        vec3 f34;
    ...
    if (f74 > 0.0)
    {
        ...
        vec4 f77 = texture2DLod(Texture1Texture, f8 + f76, 0.0);
        float f78 = f77.w;
        float f79;
        if (f78 == 0.0)
        {
            f79 = texture2DLod(Texture1Texture, f8 - f76, 0.0).w;
        }
        else
        {
            f79 = f78;
    ...
    {
        f75 = texture2DLod(Texture1Texture, VARYING0, 0.0).w;
    }
    ...
    if (f85 > 0.0)
    {
        ...
        vec4 f89 = texture2DLod(Texture2Texture, f9 + f88, 0.0);
        float f90 = f89.x;
        float f91;
        if (f90 == 0.0)
        {
            f91 = texture2DLod(Texture2Texture, f9 - f88, 0.0).x;
        }
        else
        {
            f91 = f90;
    ...
    if (f83 > 0.0)
    {
        ...
        vec4 f94 = texture2DLod(Texture2Texture, f10 + f93, 0.0);
        float f95 = f94.y;
        float f96;
        if (f95 == 0.0)
        {
            f96 = texture2DLod(Texture2Texture, f10 - f93, 0.0).y;
        }
        else
        {
            f96 = f95;
    ...
    if (f84 > 0.0)
    {
        ...
        vec4 f99 = texture2DLod(Texture2Texture, f11 + f98, 0.0);
        float f100 = f99.z;
        float f101;
        if (f100 == 0.0)
        {
            f101 = texture2DLod(Texture2Texture, f11 - f98, 0.0).z;
        }
        else
        {
            f101 = f100;
    ...
    gl_FragData[0] = vec4(mix(mix(mix(mix(CB7[f80 * 1 + 0].xyz * f82, CB7[(f80 + 256) * 1 + 0].xyz, vec3(f81)), CB6[6].xyz, vec3(f83)), CB6[7].xyz, vec3(f84)), CB6[5].xyz, vec3(f85)), f97);
}
