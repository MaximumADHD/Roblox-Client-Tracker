...
void main()
{
    ...
    float f41 = 1.0 - f19;
    vec3 f42 = ((((((vec3(f41) - (f38 * (f17 * f41))) * CB0[15].xyz) * f31) + (CB0[17].xyz * (f41 * clamp(-f29, 0.0, 1.0)))) + (min((f24.xyz * (f24.w * 120.0)) + (CB0[13].xyz + (CB0[14].xyz * f25.x)), vec3(CB0[21].w)) * 1.0)) * f15.xyz) + (((f38 * (((f39 + (f39 * f39)) / (((f40 * f40) * ((f34 * 3.0) + 0.5)) * ((f33 * 0.75) + 0.25))) * f31)) * CB0[15].xyz) * 1.0);
    vec4 f43 = vec4(0.0);
    f43.x = f42.x;
    vec4 f44 = f43;
    f44.y = f42.y;
