...
void main()
{
    ...
    vec3 f41 = (((((((((vec3(1.0) - (f38 * (CB0[26].w * f13))) * 1.0) * CB0[10].xyz) * f31) + ((CB0[12].xyz * 1.0) * clamp(-f30, 0.0, 1.0))) * f26) + min((f23.xyz * (f23.w * 120.0)).xyz + (CB0[8].xyz + (CB0[9].xyz * f24.x)), vec3(CB0[16].w))) + vec3((f19.z * 2.0) * f13)) * (f12 * f12).xyz) + ((((((f38 * ((f39 + (f39 * f39)) / (((f40 * f40) * ((f34 * 3.0) + 0.5)) * ((f33 * 0.75) + 0.25)))) * CB0[10].xyz) * f31) * f26) * f13) * VARYING0.w);
