...
void main()
{
    ...
    float f48 = 1.0 - f34;
    vec3 f49 = (((((((vec3(f48) - (f45 * (f32 * f48))) * CB0[10].xyz) * f38) + (CB0[12].xyz * (f48 * clamp(-f36, 0.0, 1.0)))) + min((f28.xyz * (f28.w * 120.0)) + (CB0[8].xyz + (CB0[9].xyz * f29.x)), vec3(CB0[16].w))) + vec3((f13.z * 2.0) * f1)) * f23.xyz) + (((f45 * (((f46 + (f46 * f46)) / (((f47 * f47) * ((f41 * 3.0) + 0.5)) * ((f40 * 0.75) + 0.25))) * f38)) * CB0[10].xyz) * (CB0[9].w * CB0[9].w));
    vec4 f50 = vec4(0.0);
    f50.x = f49.x;
    vec4 f51 = f50;
    f51.y = f49.y;
