...
void main()
{
    ...
    vec3 f98 = (((((((vec3(1.0) - (f95 * (CB0[26].w * f69))) * CB0[10].xyz) * f88) + (CB0[12].xyz * clamp(-f86, 0.0, 1.0))) + (min((f80.xyz * (f80.w * 120.0)).xyz + (CB0[8].xyz + (CB0[9].xyz * f81.x)), vec3(CB0[16].w)) * texture2D(AOMapTexture, gl_FragCoord.xy * CB0[45].xy).x)) + vec3((f40.z * 2.0) * f69)) * (f68 * f68).xyz) + ((((f95 * (((f96 + (f96 * f96)) / (((f97 * f97) * ((f91 * 3.0) + 0.5)) * ((f90 * 0.75) + 0.25))) * f88)) * CB0[10].xyz) * f69) * VARYING0.w);
