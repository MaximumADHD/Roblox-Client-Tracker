...
void main()
{
    ...
    vec4 v12 = v11;
    v12.w = 0.0;
    float v13 = COLOR1.y * 0.50359570980072021484375;
    float v14 = clamp(v5, 0.0, 1.0);
    vec3 v15 = (CB0[10].xyz * v14) + (CB0[12].xyz * clamp(-v5, 0.0, 1.0));
    vec4 v16 = vec4(0.0);
    v16.x = v15.x;
    vec4 v17 = v16;
    v17.y = v15.y;
    ...
    v18.z = v15.z;
    vec4 v19 = v18;
    v19.w = (v14 * CB0[23].w) * (COLOR1.y * exp2((v13 * dot(v3, normalize(v4 + v2))) - v13));
    vec4 v20 = vec4(dot(CB0[20], v6), dot(CB0[21], v6), dot(CB0[22], v6), 0.0);
