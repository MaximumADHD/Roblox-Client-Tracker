...
void main()
{
    ...
    VARYING6 = (CB0[10].xyz * max(v15, 0.0)) + (CB0[12].xyz * max(-v15, 0.0));
    VARYING7 = v5;
    VARYING8 = ((CB4[int(TEXCOORD0.x + 0.5) * 1 + 0] * v14.x) + (CB4[int(TEXCOORD0.y + 0.5) * 1 + 0] * v14.y)) + (CB4[int(TEXCOORD0.z + 0.5) * 1 + 0] * v14.z);
}
