...
void main()
{
    ...
    vec3 f4 = (min(((f3.xyz * (f3.w * 120.0)).xyz + CB0[8].xyz) + (CB0[9].xyz * mix(texture3D(LightGridSkylightTexture, f1), vec4(1.0), f2).x), vec3(CB0[17].w)) + VARYING2) * (VARYING1.xyz * VARYING1.xyz);
