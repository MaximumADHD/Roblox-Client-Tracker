...
void main()
{
    ...
    vec3 f4 = f3.xyz;
    vec3 f5 = mix(CB0[14].xyz, sqrt(clamp((f4 * f4) * CB0[15].y, vec3(0.0), vec3(1.0))).xyz, vec3(clamp((CB0[13].x * length(VARYING2)) + CB0[13].y, 0.0, 1.0)));
    gl_FragData[0] = vec4(f5.x, f5.y, f5.z, f3.w);
}
