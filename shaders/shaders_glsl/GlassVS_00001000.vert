...
void main()
{
    ...
    vec4 v16 = vec4(dot(CB0[25], v4), dot(CB0[26], v4), dot(CB0[27], v4), 0.0);
    ...
    vec3 v19 = (CB0[15].xyz * v18) + (CB0[17].xyz * clamp(-v3, 0.0, 1.0));
    vec4 v20 = vec4(0.0);
    v20.x = v19.x;
    vec4 v21 = v20;
    v21.y = v19.y;
    ...
    v22.z = v19.z;
    vec4 v23 = v22;
    v23.w = (v18 * CB0[28].w) * (COLOR1.y * exp2((v17 * dot(v0, normalize(v2 + normalize(v1)))) - v17));
    gl_Position = v5;
    VARYING0 = TEXCOORD0;
    VARYING1 = TEXCOORD1;
    VARYING2 = v15;
