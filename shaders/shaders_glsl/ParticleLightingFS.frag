...
void main()
{
    float f0 = clamp(dot(step(CB0[20].xyz, abs(VARYING0 - CB0[19].xyz)), vec3(1.0)), 0.0, 1.0);
    ...
    vec3 f5 = (min(((f3.xyz * (f3.w * 120.0)).xyz + CB0[8].xyz) + (CB0[9].xyz * f4.x), vec3(CB0[17].w)) + (CB0[10].xyz * f4.y)) * 0.008333333767950534820556640625;
