...
void main()
{
    ...
    vec3 f35;
    if (!(CB5[f32 * 3 + 2].w == 0.0))
    {
        f35 = (mix(vec3(1.0), CB5[f32 * 3 + 2].xyz, vec3(f25.w)) * f25.xyz) * VARYING0.x;
    }
    else
    {
        ...
        float f37 = f36.x;
        float f38 = f36.y;
        float f39 = CB5[f32 * 3 + 2].x * f25.y;
        float f40 = (CB5[f32 * 3 + 2].y * f37) - (CB5[f32 * 3 + 2].z * f38);
        float f41 = (CB5[f32 * 3 + 2].z * f37) + (CB5[f32 * 3 + 2].y * f38);
        float f42 = f39 - f41;
        f35 = (vec3(f42, f39, f42) + (vec3(f40, f41, f40) * vec3(1.0, 1.0, -1.0))) * VARYING0.x;
    }
    vec3 f43;
    if (!(CB5[f33 * 3 + 2].w == 0.0))
    {
        f43 = f35 + ((mix(vec3(1.0), CB5[f33 * 3 + 2].xyz, vec3(f28.w)) * f28.xyz) * VARYING0.y);
    }
    else
    {
        ...
        float f45 = f44.x;
        float f46 = f44.y;
        float f47 = CB5[f33 * 3 + 2].x * f28.y;
        float f48 = (CB5[f33 * 3 + 2].y * f45) - (CB5[f33 * 3 + 2].z * f46);
        float f49 = (CB5[f33 * 3 + 2].z * f45) + (CB5[f33 * 3 + 2].y * f46);
        float f50 = f47 - f49;
        f43 = f35 + ((vec3(f50, f47, f50) + (vec3(f48, f49, f48) * vec3(1.0, 1.0, -1.0))) * VARYING0.y);
    }
    vec3 f51;
    if (!(CB5[f34 * 3 + 2].w == 0.0))
    {
        f51 = f43 + ((mix(vec3(1.0), CB5[f34 * 3 + 2].xyz, vec3(f31.w)) * f31.xyz) * VARYING0.z);
    }
    else
    {
        ...
        float f53 = f52.x;
        float f54 = f52.y;
        float f55 = CB5[f34 * 3 + 2].x * f31.y;
        float f56 = (CB5[f34 * 3 + 2].y * f53) - (CB5[f34 * 3 + 2].z * f54);
        float f57 = (CB5[f34 * 3 + 2].z * f53) + (CB5[f34 * 3 + 2].y * f54);
        float f58 = f55 - f57;
    ...
    float f84 = 1.0 - f62;
    vec3 f85 = (((((((vec3(f84) - (f81 * ((CB0[31].w * f60) * f84))) * CB0[15].xyz) * f74) + (CB0[17].xyz * (f84 * clamp(-f72, 0.0, 1.0)))) + (min((f67.xyz * (f67.w * 120.0)) + (CB0[13].xyz + (CB0[14].xyz * f68.x)), vec3(CB0[21].w)) * 1.0)) + vec3((f12.z * 2.0) * f60)) * f59) + ((((f81 * (((f82 + (f82 * f82)) / (((f83 * f83) * ((f77 * 3.0) + 0.5)) * ((f76 * 0.75) + 0.25))) * f74)) * CB0[15].xyz) * 1.0) * (f60 * VARYING0.w));
    vec4 f86 = vec4(0.0);
    f86.x = f85.x;
    vec4 f87 = f86;
    f87.y = f85.y;
    ...
    vec4 f89 = f88;
    f89.w = 1.0;
    vec3 f90 = normalize(-VARYING8);
    vec3 f91 = f90 * f90;
    bvec3 f92 = lessThan(f90, vec3(0.0));
    vec3 f93 = vec3(f92.x ? f91.x : vec3(0.0).x, f92.y ? f91.y : vec3(0.0).y, f92.z ? f91.z : vec3(0.0).z);
    vec3 f94 = f91 - f93;
    vec3 f95 = (((((CB0[34].xyz * f94.x) + (CB0[36].xyz * f94.y)) + (CB0[38].xyz * f94.z)) + (CB0[35].xyz * f93.x)) + (CB0[37].xyz * f93.y)) + (CB0[39].xyz * f93.z);
    bvec3 f96 = bvec3(!(CB0[18].w == 0.0));
    vec3 f97 = mix(vec3(f96.x ? CB0[19].xyz.x : f95.x, f96.y ? CB0[19].xyz.y : f95.y, f96.z ? CB0[19].xyz.z : f95.z), f89.xyz, vec3(clamp(exp2((CB0[18].z * VARYING5.w) + CB0[18].x) - CB0[18].w, 0.0, 1.0)));
    vec4 f98 = f89;
    f98.x = f97.x;
    vec4 f99 = f98;
    f99.y = f97.y;
