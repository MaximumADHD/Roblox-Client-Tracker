...
void main()
{
    ...
    vec3 f26;
    if (!(CB5[f23 * 3 + 2].w == 0.0))
    {
        f26 = (mix(vec3(1.0), CB5[f23 * 3 + 2].xyz, vec3(f16.w)) * f16.xyz) * VARYING0.x;
    }
    else
    {
        ...
        float f28 = f27.x;
        float f29 = f27.y;
        float f30 = CB5[f23 * 3 + 2].x * f16.y;
        float f31 = (CB5[f23 * 3 + 2].y * f28) - (CB5[f23 * 3 + 2].z * f29);
        float f32 = (CB5[f23 * 3 + 2].z * f28) + (CB5[f23 * 3 + 2].y * f29);
        float f33 = f30 - f32;
    ...
    {
        f34 = f26 + ((mix(vec3(1.0), CB5[f24 * 3 + 2].xyz, vec3(f19.w)) * f19.xyz) * VARYING0.y);
    }
    else
    {
        ...
        float f36 = f35.x;
        float f37 = f35.y;
        float f38 = CB5[f24 * 3 + 2].x * f19.y;
        float f39 = (CB5[f24 * 3 + 2].y * f36) - (CB5[f24 * 3 + 2].z * f37);
        float f40 = (CB5[f24 * 3 + 2].z * f36) + (CB5[f24 * 3 + 2].y * f37);
        float f41 = f38 - f40;
    ...
    {
        f42 = f34 + ((mix(vec3(1.0), CB5[f25 * 3 + 2].xyz, vec3(f22.w)) * f22.xyz) * VARYING0.z);
    }
    else
    {
        ...
        float f44 = f43.x;
        float f45 = f43.y;
        float f46 = CB5[f25 * 3 + 2].x * f22.y;
        float f47 = (CB5[f25 * 3 + 2].y * f44) - (CB5[f25 * 3 + 2].z * f45);
        float f48 = (CB5[f25 * 3 + 2].z * f44) + (CB5[f25 * 3 + 2].y * f45);
        float f49 = f46 - f48;
    ...
    float f75 = 1.0 - f53;
    vec3 f76 = (((((((vec3(f75) - (f72 * ((CB0[31].w * f51) * f75))) * CB0[15].xyz) * f65) + (CB0[17].xyz * (f75 * clamp(-f63, 0.0, 1.0)))) + (min((f58.xyz * (f58.w * 120.0)) + (CB0[13].xyz + (CB0[14].xyz * f59.x)), vec3(CB0[21].w)) * 1.0)) + vec3((f12.z * 2.0) * f51)) * f50) + ((((f72 * (((f73 + (f73 * f73)) / (((f74 * f74) * ((f68 * 3.0) + 0.5)) * ((f67 * 0.75) + 0.25))) * f65)) * CB0[15].xyz) * 1.0) * (f51 * VARYING0.w));
    vec4 f77 = vec4(0.0);
    f77.x = f76.x;
    vec4 f78 = f77;
    f78.y = f76.y;
    ...
    vec4 f80 = f79;
    f80.w = 1.0;
    vec3 f81 = normalize(-VARYING8);
    vec3 f82 = f81 * f81;
    bvec3 f83 = lessThan(f81, vec3(0.0));
    vec3 f84 = vec3(f83.x ? f82.x : vec3(0.0).x, f83.y ? f82.y : vec3(0.0).y, f83.z ? f82.z : vec3(0.0).z);
    vec3 f85 = f82 - f84;
    vec3 f86 = (((((CB0[34].xyz * f85.x) + (CB0[36].xyz * f85.y)) + (CB0[38].xyz * f85.z)) + (CB0[35].xyz * f84.x)) + (CB0[37].xyz * f84.y)) + (CB0[39].xyz * f84.z);
    bvec3 f87 = bvec3(!(CB0[18].w == 0.0));
    vec3 f88 = mix(vec3(f87.x ? CB0[19].xyz.x : f86.x, f87.y ? CB0[19].xyz.y : f86.y, f87.z ? CB0[19].xyz.z : f86.z), f80.xyz, vec3(clamp(exp2((CB0[18].z * VARYING5.w) + CB0[18].x) - CB0[18].w, 0.0, 1.0)));
    vec4 f89 = f80;
    f89.x = f88.x;
    vec4 f90 = f89;
    f90.y = f88.y;
