...
void main()
{
    ...
    f29.z = f28;
    vec4 f30 = f19;
    f30.x = CB5[f12 * 3 + 2].x * f9.y;
    vec4 f31 = f30;
    f31.y = (CB5[f12 * 3 + 2].y * f16) - (CB5[f12 * 3 + 2].z * f18);
    vec4 f32 = f31;
    f32.z = (CB5[f12 * 3 + 2].z * f16) + (CB5[f12 * 3 + 2].y * f18);
    vec4 f33 = f24;
    f33.x = CB5[f13 * 3 + 2].x * f10.y;
    vec4 f34 = f33;
    f34.y = (CB5[f13 * 3 + 2].y * f21) - (CB5[f13 * 3 + 2].z * f23);
    vec4 f35 = f34;
    f35.z = (CB5[f13 * 3 + 2].z * f21) + (CB5[f13 * 3 + 2].y * f23);
    vec4 f36 = f29;
    f36.x = CB5[f14 * 3 + 2].x * f11.y;
    vec4 f37 = f36;
    f37.y = (CB5[f14 * 3 + 2].y * f26) - (CB5[f14 * 3 + 2].z * f28);
    vec4 f38 = f37;
    f38.z = (CB5[f14 * 3 + 2].z * f26) + (CB5[f14 * 3 + 2].y * f28);
    ...
    float f56 = f49.z;
    vec3 f57 = -CB0[16].xyz;
    float f58 = dot(f47, f57) * ((1.0 - ((step(f55.x, f56) * clamp(CB0[29].z + (CB0[29].w * abs(f56 - 0.5)), 0.0, 1.0)) * f55.y)) * f54.y);
    vec3 f59 = normalize(normalize(VARYING8) + f57);
    ...
    vec3 f70 = (((((((vec3(1.0) - (f67 * (CB0[31].w * f43))) * CB0[15].xyz) * f60) + (CB0[17].xyz * clamp(-f58, 0.0, 1.0))) + (min((f53.xyz * (f53.w * 120.0)) + (CB0[13].xyz + (CB0[14].xyz * f54.x)), vec3(CB0[21].w)) * 1.0)) + vec3((f8.z * 2.0) * f43)) * (f42 * f42)) + ((((f67 * (((f68 + (f68 * f68)) / (((f69 * f69) * ((f63 * 3.0) + 0.5)) * ((f62 * 0.75) + 0.25))) * f60)) * CB0[15].xyz) * 1.0) * (f43 * VARYING0.w));
    vec4 f71 = vec4(0.0);
    f71.x = f70.x;
    vec4 f72 = f71;
    f72.y = f70.y;
    ...
    vec4 f74 = f73;
    f74.w = 1.0;
    vec3 f75 = normalize(-VARYING8);
    vec3 f76 = f75 * f75;
    bvec3 f77 = lessThan(f75, vec3(0.0));
    ...
    vec3 f82 = mix(vec3(f81.x ? CB0[19].xyz.x : f80.x, f81.y ? CB0[19].xyz.y : f80.y, f81.z ? CB0[19].xyz.z : f80.z), f74.xyz, vec3(clamp(exp2((CB0[18].z * VARYING5.w) + CB0[18].x) - CB0[18].w, 0.0, 1.0)));
    vec4 f83 = f74;
    f83.x = f82.x;
    vec4 f84 = f83;
    f84.y = f82.y;
