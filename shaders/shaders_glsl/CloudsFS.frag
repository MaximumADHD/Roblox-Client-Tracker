...
void main()
{
    ...
    vec3 f64 = mix(CB0[14].xyz, f29.xyz, vec3(exp2((CB0[13].z * 3.5714285373687744140625) * (f19 * f19))));
    vec4 f65 = vec4(f64.x, f64.y, f64.z, f29.w);
    f65.w = 1.0 - f27;
    gl_FragData[0] = f65;
}
