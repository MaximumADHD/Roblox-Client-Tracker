...
void main()
{
    ...
    vec3 f65 = mix(CB0[14].xyz, f30.xyz, vec3(exp2((CB0[13].z * 3.5714285373687744140625) * (f20 * f20))));
    vec4 f66 = vec4(f65.x, f65.y, f65.z, f30.w);
    f66.w = 1.0 - f28;
    gl_FragData[0] = f66;
}
