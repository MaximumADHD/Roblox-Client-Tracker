...
void main()
{
    ...
    float v17 = clamp(v11, 0.0, 1.0);
    vec3 v18 = (CB0[10].xyz * v17) + (CB0[12].xyz * clamp(-v11, 0.0, 1.0));
    vec4 v19 = vec4(v18.x, v18.y, v18.z, vec4(0.0).w);
    v19.w = (v17 * CB0[23].w) * (COLOR1.y * exp2((v16 * dot(v8, normalize(v10 + normalize(v9)))) - v16));
