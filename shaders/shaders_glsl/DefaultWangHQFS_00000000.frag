...
void main()
{
    ...
    float f54 = 1.0 - f32;
    vec3 f55 = ((((((vec3(f54) - (f51 * (f30 * f54))) * CB0[15].xyz) * f44) + (CB0[17].xyz * (f54 * clamp(-f42, 0.0, 1.0)))) + min((f37.xyz * (f37.w * 120.0)) + (CB0[13].xyz + (CB0[14].xyz * f38.x)), vec3(CB0[21].w))) * f29.xyz) + (((f51 * (min((f52 + (f52 * f52)) / (((f53 * f53) * ((f47 * 3.0) + 0.5)) * ((f46 * 0.75) + 0.25)), 65504.0) * f44)) * CB0[15].xyz) * 1.0);
    vec4 f56 = vec4(0.0);
    f56.x = f55.x;
    vec4 f57 = f56;
    f57.y = f55.y;
