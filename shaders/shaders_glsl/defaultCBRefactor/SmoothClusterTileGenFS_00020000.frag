...
void main()
{
    ...
    {
        f33 = (mix(vec3(1.0), CB5[f30 * 3 + 2].xyz, vec3(f23.w)) * f23.xyz) * VARYING0.x;
    }
    else
    {
        ...
        float f35 = f34.x;
        float f36 = f34.y;
        float f37 = CB5[f30 * 3 + 2].x * f23.y;
        float f38 = (CB5[f30 * 3 + 2].y * f35) - (CB5[f30 * 3 + 2].z * f36);
        float f39 = (CB5[f30 * 3 + 2].z * f35) + (CB5[f30 * 3 + 2].y * f36);
        float f40 = f37 - f39;
    ...
    {
        f41 = f33 + ((mix(vec3(1.0), CB5[f31 * 3 + 2].xyz, vec3(f26.w)) * f26.xyz) * VARYING0.y);
    }
    else
    {
        ...
        float f43 = f42.x;
        float f44 = f42.y;
        float f45 = CB5[f31 * 3 + 2].x * f26.y;
        float f46 = (CB5[f31 * 3 + 2].y * f43) - (CB5[f31 * 3 + 2].z * f44);
        float f47 = (CB5[f31 * 3 + 2].z * f43) + (CB5[f31 * 3 + 2].y * f44);
        float f48 = f45 - f47;
    ...
    {
        f49 = f41 + ((mix(vec3(1.0), CB5[f32 * 3 + 2].xyz, vec3(f29.w)) * f29.xyz) * VARYING0.z);
    }
    else
    {
        ...
        float f51 = f50.x;
        float f52 = f50.y;
        float f53 = CB5[f32 * 3 + 2].x * f29.y;
        float f54 = (CB5[f32 * 3 + 2].y * f51) - (CB5[f32 * 3 + 2].z * f52);
        float f55 = (CB5[f32 * 3 + 2].z * f51) + (CB5[f32 * 3 + 2].y * f52);
        float f56 = f53 - f55;
