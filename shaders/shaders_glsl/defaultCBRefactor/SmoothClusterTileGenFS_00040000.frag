...
void main()
{
    ...
    vec3 f12 = (((mix(vec3(1.0), CB5[int(VARYING6.x + 0.5) * 3 + 2].xyz, vec3(f9.w)) * f9.xyz) * VARYING0.x) + ((mix(vec3(1.0), CB5[int(VARYING6.y + 0.5) * 3 + 2].xyz, vec3(f10.w)) * f10.xyz) * VARYING0.y)) + ((mix(vec3(1.0), CB5[int(VARYING6.z + 0.5) * 3 + 2].xyz, vec3(f11.w)) * f11.xyz) * VARYING0.z);
