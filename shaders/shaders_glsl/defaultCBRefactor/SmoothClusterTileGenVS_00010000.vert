...
void main()
{
    ...
    int v4 = int(TEXCOORD0.y);
    int v5 = int(TEXCOORD1.z);
    int v6 = int(TEXCOORD0.z);
    ...
    VARYING1 = vec4((vec2(dot(v0, CB2[v1 * 2 + 0].xyz), dot(v0, CB2[v1 * 2 + 1].xyz)) * CB5[v2 * 3 + 0].x) + (vec2(NORMAL.w, floor(NORMAL.w * 2.6651442050933837890625)) * CB5[v2 * 3 + 0].y), (vec2(dot(v0, CB2[v3 * 2 + 0].xyz), dot(v0, CB2[v3 * 2 + 1].xyz)) * CB5[v4 * 3 + 0].x) + (vec2(TEXCOORD0.w, floor(TEXCOORD0.w * 2.6651442050933837890625)) * CB5[v4 * 3 + 0].y));
    VARYING2 = vec4(CB5[v2 * 3 + 0].zw, CB5[v4 * 3 + 0].zw);
    VARYING3 = vec4((vec2(dot(v0, CB2[v5 * 2 + 0].xyz), dot(v0, CB2[v5 * 2 + 1].xyz)) * CB5[v6 * 3 + 0].x) + (vec2(TEXCOORD1.w, floor(TEXCOORD1.w * 2.6651442050933837890625)) * CB5[v6 * 3 + 0].y), CB5[v6 * 3 + 0].zw);
