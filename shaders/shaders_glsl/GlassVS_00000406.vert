...
void main()
{
    ...
    vec4 v34 = v33;
    v34.w = 0.0;
    vec4 v35 = vec4(v19, v27.w);
    float v36 = COLOR0.w * 2.0;
    float v37 = clamp(v36 - 1.0, 0.0, 1.0);
    float v38 = (clamp(2.0 - (dot(v21, normalize(v35.xyz)) * 3.0), 0.0, 1.0) * 0.300000011920928955078125) * clamp(v36, 0.0, 1.0);
    vec4 v39 = COLOR0;
    ...
    float v41 = COLOR1.y * 0.50359570980072021484375;
    ...
    v46.z = v43.z;
    vec4 v47 = v46;
    v47.w = (v42 * CB0[28].w) * (COLOR1.y * exp2((v41 * dot(v21, normalize(v24 + v20))) - v41));
    gl_Position = v27;
    VARYING0 = TEXCOORD0;
    VARYING1 = v29;
    VARYING2 = v39;
