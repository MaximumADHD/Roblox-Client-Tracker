...
void main()
{
    ...
    vec4 v18 = vec4(dot(CB0[25], v6), dot(CB0[26], v6), dot(CB0[27], v6), 0.0);
    ...
    vec3 v21 = (CB0[15].xyz * v20) + (CB0[17].xyz * clamp(-v5, 0.0, 1.0));
    vec4 v22 = vec4(0.0);
    v22.x = v21.x;
    vec4 v23 = v22;
    v23.y = v21.y;
    ...
    v24.z = v21.z;
    vec4 v25 = v24;
    v25.w = (v20 * CB0[28].w) * (COLOR1.y * exp2((v19 * dot(v3, normalize(v4 + v2))) - v19));
    gl_Position = v7;
    VARYING0 = TEXCOORD0;
    VARYING1 = TEXCOORD1;
    VARYING2 = v17;
