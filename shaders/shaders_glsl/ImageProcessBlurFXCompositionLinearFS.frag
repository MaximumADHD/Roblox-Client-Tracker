...
void main()
{
    ...
    vec3 f2 = mix((((f0 * f0) * 4.0) + texture2D(Texture3Texture, min(VARYING0, CB1[12].zw)).xyz) + (texture2D(Texture2Texture, min(VARYING0, CB1[12].xy)).xyz * CB1[5].w), (f1 * f1) * 4.0, vec3(CB1[5].x));
    vec3 f3 = f2 * CB1[6].x;
