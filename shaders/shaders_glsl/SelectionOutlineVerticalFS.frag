...
void main()
{
    ...
    float f61 = f51.z;
    float f62 = f51.x;
    gl_FragData[0] = vec4(mix(mix(mix(mix(CB7[f58 * 1 + 0].xyz * f59, CB7[(f58 + 256) * 1 + 0].xyz, vec3(f52)), CB6[6].xyz * f4, vec3(f60)), CB6[7].xyz * f4, vec3(f61)), CB6[5].xyz, vec3(f62)), max(max(max(max(CB7[f58 * 1 + 0].w * f59, f52), f60), f61), f62));
}
