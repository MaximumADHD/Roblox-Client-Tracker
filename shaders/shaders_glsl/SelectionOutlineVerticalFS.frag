...
void main()
{
    ...
    for (; f17 <= f0; f10 = f13, f9 = f12, f8 = f16, f18 = f11, f7 = f15, f6 = f14, f17++)
    {
        ...
        f13 = f10;
        f13.y = f10.y + CB1[0].w;
        vec4 f20 = vec4(255.0) - (texture2DLod(Texture0Texture, f12, 0.0) * 255.0);
    ...
    if (f51 > 0.0)
    {
        ...
        vec4 f54 = texture2DLod(Texture1Texture, f7 + f53, 0.0);
        float f55 = f54.w;
        float f56;
        if (f55 == 0.0)
        {
            f56 = texture2DLod(Texture1Texture, f7 - f53, 0.0).w;
        }
        else
        {
            f56 = f55;
    ...
    float f60 = f50.y;
    float f61 = f50.x;
    gl_FragData[0] = vec4(mix(mix(mix(mix(CB7[f57 * 1 + 0].xyz * f58, CB7[(f57 + 256) * 1 + 0].xyz, vec3(f51)), CB6[7].xyz, vec3(f59)), CB6[6].xyz, vec3(f60)), CB6[5].xyz, vec3(f61)), max(max(max(max(CB7[f57 * 1 + 0].w * f58, f51), f59), f60), f61));
}
