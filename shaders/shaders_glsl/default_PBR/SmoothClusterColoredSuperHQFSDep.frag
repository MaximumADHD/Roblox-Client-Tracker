...
void main()
{
    ...
    vec3 f64 = (((((((((vec3(1.0) - (f61 * (CB0[26].w * f36))) * 1.0) * CB0[10].xyz) * f54) + ((CB0[12].xyz * 1.0) * clamp(-f53, 0.0, 1.0))) * f49) + min((f46.xyz * (f46.w * 120.0)).xyz + (CB0[8].xyz + (CB0[9].xyz * f47.x)), vec3(CB0[16].w))) + vec3((f42.z * 2.0) * f36)) * (f35 * f35).xyz) + (((((f61 * ((f62 + (f62 * f62)) / (((f63 * f63) * ((f57 * 3.0) + 0.5)) * ((f56 * 0.75) + 0.25)))) * CB0[10].xyz) * f54) * f49) * f36);
