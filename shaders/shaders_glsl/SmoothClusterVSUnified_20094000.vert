...
void main()
{
    ...
    gl_Position = v4;
    VARYING0 = vec4(vec3(v12.x ? vec3(1.0).x : vec3(0.0).x, v12.y ? vec3(1.0).y : vec3(0.0).y, v12.z ? vec3(1.0).z : vec3(0.0).z), (abs(POSITION.w) > 3.0) ? 0.0 : 1.0);
    ...
    VARYING6 = v1;
    VARYING7 = vec3(v13.x ? vec3(1.0).x : vec3(0.0).x, v13.y ? vec3(1.0).y : vec3(0.0).y, v13.z ? vec3(1.0).z : vec3(0.0).z);
    VARYING8 = v5;
