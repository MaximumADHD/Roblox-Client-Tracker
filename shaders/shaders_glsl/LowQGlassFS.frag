...
void main()
{
    ...
    vec3 f11 = textureCube(EnvironmentMapTexture, reflect(-normalize(VARYING4.xyz), normalize(VARYING5.xyz))).xyz;
    ...
    float f16 = mix(1.0, VARYING2.w, f14);
    vec4 f17 = vec4(f15.x, f15.y, f15.z, f13.w);
    f17.w = f16;
    vec4 f18 = f17;
    f18.w = f16;
    gl_FragData[0] = f18;
