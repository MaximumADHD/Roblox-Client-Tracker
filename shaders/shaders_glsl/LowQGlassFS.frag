...
void main()
{
    ...
    vec4 f9 = f8;
    f9.z = f6.z;
    vec3 f10 = textureCube(EnvironmentMapTexture, reflect(-(VARYING4.xyz / vec3(f0)), normalize(VARYING5.xyz))).xyz;
    ...
    vec3 f21 = (((VARYING6.xyz * f20) + min((f15.xyz * (f15.w * 120.0)) + (CB0[13].xyz + (CB0[14].xyz * f17)), vec3(CB0[21].w))) * ((mix(vec3(1.0), (f10 * f10) * CB0[20].x, vec3(f17)) * VARYING7.w) + (f9.xyz * (VARYING2.w - VARYING7.w)))) + (CB0[15].xyz * ((VARYING6.w * f20) * 0.100000001490116119384765625));
    vec4 f22 = vec4(0.0);
    f22.x = f21.x;
    vec4 f23 = f22;
    f23.y = f21.y;
