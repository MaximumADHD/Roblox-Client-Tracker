...
void main()
{
    ...
    float f50 = f42.y;
    vec3 f51 = -CB0[11].xyz;
    vec3 f52 = normalize(f51 + normalize(VARYING8));
    ...
    f65.w = 1.0;
    vec3 f66 = sqrt(clamp(mix(CB0[14].xyz, f65.xyz, vec3(clamp(exp2((CB0[13].z * VARYING5.w) + CB0[13].x) - CB0[13].w, 0.0, 1.0))).xyz * CB0[15].y, vec3(0.0), vec3(1.0)));
