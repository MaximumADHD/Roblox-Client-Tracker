...
void main()
{
    ...
    gl_FragData[0] = (((((((texture2D(Texture0Texture, VARYING0) + ((texture2D(Texture0Texture, VARYING0 + f4) + texture2D(Texture0Texture, VARYING0 - f4)) * f3)) + ((texture2D(Texture0Texture, VARYING0 + f9) + texture2D(Texture0Texture, VARYING0 - f9)) * f8)) + ((texture2D(Texture0Texture, VARYING0 + f14) + texture2D(Texture0Texture, VARYING0 - f14)) * f13)) + ((texture2D(Texture0Texture, VARYING0 + f19) + texture2D(Texture0Texture, VARYING0 - f19)) * f18)) + ((texture2D(Texture0Texture, VARYING0 + f24) + texture2D(Texture0Texture, VARYING0 - f24)) * f23)) + ((texture2D(Texture0Texture, VARYING0 + f29) + texture2D(Texture0Texture, VARYING0 - f29)) * f28)) + ((texture2D(Texture0Texture, VARYING0 + f33) + texture2D(Texture0Texture, VARYING0 - f33)) * f32)) / vec4(((((((1.0 + (2.0 * f3)) + (2.0 * f8)) + (2.0 * f13)) + (2.0 * f18)) + (2.0 * f23)) + (2.0 * f28)) + (2.0 * f32));
}
