...
void main()
{
    ...
    vec3 v35 = (CB0[10].xyz * v34) + (CB0[12].xyz * clamp(-v22, 0.0, 1.0));
    vec4 v36 = vec4(v35.x, v35.y, v35.z, vec4(0.0).w);
    v36.w = (v34 * CB0[23].w) * (COLOR1.y * exp2((v33 * dot(v19, normalize(v21 + normalize(v20)))) - v33));
    gl_Position = v24;
    VARYING0 = TEXCOORD0;
    VARYING1 = TEXCOORD1;
    VARYING2 = v31;
