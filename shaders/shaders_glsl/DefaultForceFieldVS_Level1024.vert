...
void main()
{
    ...
    vec3 v16 = (CB0[10].xyz * v15) + (CB0[12].xyz * clamp(-v5, 0.0, 1.0));
    vec4 v17 = vec4(0.0);
    v17.x = v16.x;
    vec4 v18 = v17;
    v18.y = v16.y;
    ...
    v19.z = v16.z;
    vec4 v20 = v19;
    v20.w = (v15 * CB0[23].w) * (COLOR1.y * exp2((v14 * dot(v3, normalize(v4 + v2))) - v14));
    vec4 v21 = vec4(dot(CB0[20], v6), dot(CB0[21], v6), dot(CB0[22], v6), 0.0);
