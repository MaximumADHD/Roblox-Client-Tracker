...
local isUserModelDisplayNamesEnabled = require(CorePackages.AppTempCommon.LuaApp.Flags.isUserModelDisplayNamesEnabled)
...
function User.mock()
	...
	if isUserModelDisplayNamesEnabled() then
		self.displayName = self.name.."~DN~"
	end
