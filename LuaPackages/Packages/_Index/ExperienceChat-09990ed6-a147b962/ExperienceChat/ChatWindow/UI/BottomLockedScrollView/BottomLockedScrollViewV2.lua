...
local SCROLL_LOCK_THRESHOLD_PERCENT = 0.9
...
return function(props)
	...
	local scrollViewRef = React.useRef(nil :: any)
	...
	end, { props.children, isLockedAtBottom, isDragging, scrollingFrameRef } :: { any })

	return React.createElement("Frame", {
		BackgroundTransparency = if isLockedAtBottom and isDragging == false then 1 else 0,
		Size = props.Size,
		ref = parentRef,
