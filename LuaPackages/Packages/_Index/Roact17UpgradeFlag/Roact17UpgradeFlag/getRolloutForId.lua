...
game:DefineFastInt("Roact17Rollout12", 0)
game:DefineFastFlag("Roact17RolloutEnabledForAll12", false)

-- Helper function to throttle based on a unique id:
return function()
	local rolloutEnabledForAll = game:GetFastFlag("Roact17RolloutEnabledForAll12")
	if rolloutEnabledForAll then
		return true
	end

	local rolloutPercent = game:GetFastInt("Roact17Rollout12")
