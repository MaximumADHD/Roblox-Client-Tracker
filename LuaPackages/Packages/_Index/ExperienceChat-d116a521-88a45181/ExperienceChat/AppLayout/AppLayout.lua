...
function AppLayout:didUpdate(previousProps, _)
	...
	-- When the chat top bar button is pressed, we want to reset both the background and text transparencies.
	if self.props.chatTopBarVisibility and not previousProps.chatTopBarVisibility then
