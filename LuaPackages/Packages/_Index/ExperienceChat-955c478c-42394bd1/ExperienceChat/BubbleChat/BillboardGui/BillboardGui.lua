...
local getFixDisappearingBubbleChat = require(ExperienceChat.Flags.getFFlagFixDisappearingBubbleChat)
...
function BubbleChatBillboard:render()
	...
	if GlobalFlags.AvatarChatEnabled then
		...
		if getFixDisappearingBubbleChat() then
			if showVoiceIndicator then
