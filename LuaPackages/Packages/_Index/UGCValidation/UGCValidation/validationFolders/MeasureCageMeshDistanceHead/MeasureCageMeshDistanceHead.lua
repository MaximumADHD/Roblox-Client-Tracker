...
MeasureCageMeshDistanceHead.categories = { ValidationEnums.UploadCategory.DYNAMIC_HEAD }
MeasureCageMeshDistanceHead.fflag = require(root.flags.getFFlagUGCValidateCageMeshDistanceHead)
MeasureCageMeshDistanceHead.expectedAqsData = {
	Measure_Cage_Distance_Head = {},
}

MeasureCageMeshDistanceHead.run = function(reporter: Types.ValidationReporter, data: Types.SharedData)
...
return MeasureCageMeshDistanceHead :: Types.ValidationModule
