...
local AppRoot = SliderRoot.Parent
...
local GenericSlider = require(UIBloxRoot.Core.Slider.GenericSlider)
...
local divideTransparency = require(UIBloxRoot.Utility.divideTransparency)
