	...
	return Roact.createElement("Frame", {
		...
		RoundedFrame = Roact.createElement(
			...
			Dictionary.join(backgroundImageSettings, {
				...
				BackgroundTransparency = backgroundImageSettings.Image == ""
						and (getEnableChatInputBarConfigurationStyleCustomizations() and self.backgroundTransparency or self.transparency)
					or 1,
				BorderSizePixel = 0,
				AnchorPoint = Vector2.new(0.5, 0),
