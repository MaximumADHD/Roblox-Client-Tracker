...
return function()
	beforeAll(function(rootContext)
		local storyDefinition = require(script.Parent:FindFirstChild("TranslatedTextMessage.story"))
	...
	describe("WHEN parented to a statically sized frame", function()
		...
		describe("GIVEN message with translation off", function()
			beforeAll(function(c)
				c.message = {
					text = 'This is <font size="50">big</font> and this is <font size="10">small</font>!',
					translation = 'This is <font size="50">big</font> and this is <font size="10">small</font>!',
		...
		describe("GIVEN message with translation off", function()
			...
			it("SHOULD display translation", function(c)
				local findFirstInstance = c.findFirstInstance
				local instance = findFirstInstance(c:mount().instance, { ClassName = "TextLabel" })
				expect(instance).never.toBeNil()

				local messageText = c.message.prefixText .. ": " .. c.message.translation
				if EngineFeatureTextChatServiceIncludesColon then
					messageText = c.message.prefixText .. " " .. c.message.translation
				end
		...
		describe("GIVEN translated message with no prefix text", function()
			beforeAll(function(c)
				c.message = {
					text = 'This is <font size="50">big</font> and this is <font size="10">small</font>!',
					translation = 'This is <font size="50">big</font> and this is <font size="10">small</font>!',
		...
		describe("GIVEN message with no translation", function()
			beforeAll(function(c)
				c.message = {
					text = 'This is <font size="50">big</font> and this is <font size="10">small</font>!',
					useTranslation = true,
			...
			it("SHOULD fallback to text", function(c)
				local findFirstInstance = c.findFirstInstance
				local instance = findFirstInstance(c:mount().instance, { ClassName = "TextLabel" })
				expect(instance).never.toBeNil()
