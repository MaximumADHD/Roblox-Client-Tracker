...
local function getBackgroundStyleWithStateLayer(
	...
	if Flags.FoundationUseAlphaCompositingForStateLayer then
		...
		local resultR = (
			stateLayerStyle.Color3.R * sourceAlpha + (backgroundStyle.Color3.R * (destAlpha * reverseSourceA))
		) * aInverse
		local resultG = (
			stateLayerStyle.Color3.G * sourceAlpha + (backgroundStyle.Color3.G * (destAlpha * reverseSourceA))
		) * aInverse
		local resultB = (
			stateLayerStyle.Color3.B * sourceAlpha + (backgroundStyle.Color3.B * (destAlpha * reverseSourceA))
		) * aInverse
