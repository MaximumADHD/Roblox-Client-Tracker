				...
				return React.createElement(
					...
					React.createElement(
						Tooltip,
						{
							...
							text = if props.controls.text ~= "" then props.controls.text else nil,
						},
						React.createElement(
							View,
