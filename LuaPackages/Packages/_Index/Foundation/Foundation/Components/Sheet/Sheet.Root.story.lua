			...
			Content = React.createElement(Sheet.Content, { isContentFullBleed = props.controls.isContentFullBleed }, {
				Body = React.createElement(View, {
					...
					EventDetails = React.createElement(View, {
						...
						Text = React.createElement(View, {
							LayoutOrder = 2,
							tag = "col align-y-center fill auto-xy",
						}, {
							Title = React.createElement(Text, {
								LayoutOrder = 1,
								Text = "Sheet Title",
					...
					Rating = React.createElement(View, {
						LayoutOrder = 4,
						tag = "row align-y-center gap-medium size-full-0 auto-y padding-medium stroke-default radius-medium",
					}, {
						...
						Description = React.createElement(Text, {
							...
							tag = "fill auto-xy text-body-small text-wrap text-align-x-left",
						}),
					}),
				}),
