...
game:DefineFastInt("ExperienceChatUserProfileApiRollout", 0)
game:DefineFastFlag("ExperienceChatUserProfileApiEnabledForAll", false)
...
local experienceChatUserProfileApiRollout = function()
	return game:GetFastInt("ExperienceChatUserProfileApiRollout")
end

local experienceChatUserProfileApiEnabledForAll = function()
	return game:GetFastFlag("ExperienceChatUserProfileApiEnabledForAll")
end
