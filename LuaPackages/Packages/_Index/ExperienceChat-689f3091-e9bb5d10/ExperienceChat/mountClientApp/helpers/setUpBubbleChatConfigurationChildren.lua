...
local function isValidBubbleChatChild(child: Instance)
	return (child.ClassName == "ImageLabel" or child.ClassName == "UIGradient" or child.ClassName == "UICorner")
end
...
return function(store)
	...
	for _, bubbleChatChild: any in pairs({ bubbleChatImageLabel, bubbleChatUIGradient, bubbleChatUICorner }) do
