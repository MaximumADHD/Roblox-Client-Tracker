...
return{
	...
	["CoreScripts.PremiumModal.Body.Description"] = [[Roblox Premium vous confère également :]],
	...
	["CoreScripts.PremiumModal.Error.AlreadyPremium"] = [[Vous êtes déjà membre Premium !]],
