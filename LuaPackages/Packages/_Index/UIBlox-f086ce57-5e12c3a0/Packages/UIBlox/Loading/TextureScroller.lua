...
local ImageSetLabel = require(UIBloxRoot.ImageSet.Components.ImageSetLabel)
...
local arePropsValid = t.strictInterface({
	...
	BackgroundTransparency = t.optional(t.integer),
...
function TextureScroller:render()
	...
	return Roact.createElement("Frame", {
		...
		TextureScrollerImage = Roact.createElement(ImageSetLabel, {
