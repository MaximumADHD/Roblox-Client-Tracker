return function()
	...
	describe("StateTable.new validation throw tests", function()
		...
		it("should throw if non-string used for state name", function()
			expect(function()
				StateTable.new(TEST_NAME, TEST_INITIAL_STATE, {}, { [1] = {} })
			end).to.throw()
		end)
		...
		it("should throw if non-string is used for event name", function()
			expect(function()
				StateTable.new(TEST_NAME, TEST_INITIAL_STATE, {}, { Initial = { [1] = {} } })
			end).to.throw()
		end)
		...
		it("should throw if non-string used for nextState", function()
			expect(function()
