...
local function ProgressIconAnimated(props: Types.AnimationProps)
	...
	end, { setProgress, props.progress } :: { any })

	local onKeyHolding = React.useCallback(function()
		setKeyHolding(true)
		setAnimationRunning(true)
	end, { setKeyHolding, setAnimationRunning })
	...
	end, { props.onHoldComplete, setKeyPressed, setKeyHolding, setAnimationRunning, setComplete } :: { any })

	local onReset = React.useCallback(function()
		setAnimationRunning(false)
		setProgress(nil)
	end, { setAnimationRunning, setProgress } :: { any })
	...
	end, { props.keyCode, isAnimationRunning, setKeyPressed, setKeyHolding, setComplete, setProgress } :: { any })
