return function()
	...
	describe("lifecycle", function()
		...
		it("should have the proper default values", function()
			...
			expect(image1.InputButtonImage.InputFillImage.ImageRectOffset).to.equal(Images["/checkmark"].ImageRectOffset)
			expect(image3.InputButtonImage.InputFillImage.ImageRectOffset).to.equal(Images["/checkmark"].ImageRectOffset)
