...
local enumValidator = require(UIBlox.Utility.enumValidator)
...
local validateProps = t.strictInterface({
	...
	restrictionTypes = t.map(enumValidator(ItemTileEnums.Restriction), t.boolean),
