...
export type UiComponentType =
	...
	| "UI_COMPONENT_TYPE_OPTION_SELECTOR_COLLECTION"
...
messages.UiComponentType = {
	fromNumber = function(value: number): UiComponentType?
		...
		elseif value == 15 then
			return "UI_COMPONENT_TYPE_OPTION_SELECTOR_COLLECTION"
	...
	toNumber = function(self: UiComponentType): number
		...
		elseif self == "UI_COMPONENT_TYPE_VARIABLE_ITEM_WIDTH_CAROUSEL" then
			return 14
		elseif self == "UI_COMPONENT_TYPE_OPTION_SELECTOR_COLLECTION" then
			return 15
	...
	fromName = function(name: string): UiComponentType?
		...
		elseif name == "UI_COMPONENT_TYPE_VARIABLE_ITEM_WIDTH_CAROUSEL" then
			return "UI_COMPONENT_TYPE_VARIABLE_ITEM_WIDTH_CAROUSEL"
		elseif name == "UI_COMPONENT_TYPE_OPTION_SELECTOR_COLLECTION" then
			return "UI_COMPONENT_TYPE_OPTION_SELECTOR_COLLECTION"
