...
export type HydrationContentType =
	...
	| "HYDRATION_CONTENT_TYPE_UNIVERSE_USER_CONNECTIONS_PLAYED"
	| number -- Unknown
...
messages.HydrationContentType = {
	fromNumber = function(value: number): HydrationContentType?
		...
		elseif value == 24 then
			return "HYDRATION_CONTENT_TYPE_UNIVERSE_USER_CONNECTIONS_PLAYED"
		else
			return nil
		end
	end,
	...
	toNumber = function(self: HydrationContentType): number
		...
		elseif self == "HYDRATION_CONTENT_TYPE_UNIVERSE_USER_VOTE_FEEDBACK_METADATA" then
			return 23
		elseif self == "HYDRATION_CONTENT_TYPE_UNIVERSE_USER_CONNECTIONS_PLAYED" then
			return 24
		else
			return self
		end
	...
	fromName = function(name: string): HydrationContentType?
		...
		elseif name == "HYDRATION_CONTENT_TYPE_UNIVERSE_USER_VOTE_FEEDBACK_METADATA" then
			return "HYDRATION_CONTENT_TYPE_UNIVERSE_USER_VOTE_FEEDBACK_METADATA"
		elseif name == "HYDRATION_CONTENT_TYPE_UNIVERSE_USER_CONNECTIONS_PLAYED" then
			return "HYDRATION_CONTENT_TYPE_UNIVERSE_USER_CONNECTIONS_PLAYED"
		else
			return nil
		end
