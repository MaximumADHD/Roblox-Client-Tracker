...
messages.HydrationContentType = {
	fromNumber = function(value: number): HydrationContentType?
		...
		elseif value == 27 then
			return "HYDRATION_CONTENT_TYPE_FRIEND_RECOMMENDATION"
	...
	toNumber = function(self: HydrationContentType): number
		...
		elseif self == "HYDRATION_CONTENT_TYPE_MOMENT" then
			return 24
		elseif self == "HYDRATION_CONTENT_TYPE_COMMUNITY" then
			return 25
		elseif self == "HYDRATION_CONTENT_TYPE_COMMUNITY_USER_MEMBERSHIP" then
			return 26
		elseif self == "HYDRATION_CONTENT_TYPE_FRIEND_RECOMMENDATION" then
			return 27
		elseif self == "HYDRATION_CONTENT_TYPE_UNIVERSE_PRIVATE_SERVER" then
			return 28
	...
	fromName = function(name: string): HydrationContentType?
		...
		elseif name == "HYDRATION_CONTENT_TYPE_MOMENT" then
			return "HYDRATION_CONTENT_TYPE_MOMENT"
		elseif name == "HYDRATION_CONTENT_TYPE_COMMUNITY" then
			return "HYDRATION_CONTENT_TYPE_COMMUNITY"
		elseif name == "HYDRATION_CONTENT_TYPE_COMMUNITY_USER_MEMBERSHIP" then
			return "HYDRATION_CONTENT_TYPE_COMMUNITY_USER_MEMBERSHIP"
		elseif name == "HYDRATION_CONTENT_TYPE_FRIEND_RECOMMENDATION" then
			return "HYDRATION_CONTENT_TYPE_FRIEND_RECOMMENDATION"
		elseif name == "HYDRATION_CONTENT_TYPE_UNIVERSE_PRIVATE_SERVER" then
			return "HYDRATION_CONTENT_TYPE_UNIVERSE_PRIVATE_SERVER"
