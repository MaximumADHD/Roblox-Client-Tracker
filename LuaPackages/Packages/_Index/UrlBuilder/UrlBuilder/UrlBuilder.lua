...
local function buildElementsFromString(elements, inQuery)
	...
	elements = splitAndTrim(elements, separator)
...
UrlBuilder.PlatformAuth = PlatformAuthPatterns(UrlBuilder)
