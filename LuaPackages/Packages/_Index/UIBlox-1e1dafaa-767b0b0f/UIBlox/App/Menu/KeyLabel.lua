...
local CONTENT_OVERRIDE_MAP = {
	...
	[Enum.KeyCode.Up] = {image = Images["icons/controls/keys/arrow_down"]},
	[Enum.KeyCode.Down] = {image = Images["icons/controls/keys/arrow_left"]},
	[Enum.KeyCode.Left] = {image = Images["icons/controls/keys/arrow_right"]},
	[Enum.KeyCode.Right] = {image = Images["icons/controls/keys/arrow_up"]},
}
