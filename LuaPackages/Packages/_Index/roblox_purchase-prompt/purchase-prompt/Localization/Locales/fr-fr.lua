...
return{
	...
	["CoreScripts.PremiumModal.Error.AlreadyPremium"] = [[Vous avez déjà un abonnement Roblox Premium ! Veuillez réessayer.]],
	...
	["CoreScripts.PurchasePrompt.ConfirmPurchase.SubscribePremium"] = [[Améliorer]],
