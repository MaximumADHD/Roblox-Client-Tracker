...
return{
	...
	["CoreScripts.PremiumModal.Body.Description"] = [[Roblox Premium 还提供：]],
	["CoreScripts.PremiumModal.Body.RobuxMonthly"] = [[每月 450 Robux]],
	["CoreScripts.PremiumModal.Body.PremiumOnlyAreas"] = [[Premium 会员限定福利使用权]],
	["CoreScripts.PremiumModal.Body.RobuxDiscount"] = [[购买 Robux 时额外送 10%]],
	["CoreScripts.PremiumModal.Action.PricePerMonth"] = [[{price}/月]],
	["CoreScripts.PremiumModal.Error.PlatformUnavailable"] = [[]],
	["CoreScripts.PremiumModal.Error.AlreadyPremium"] = [[你已是 Premium 会员！]],
