...
exports.default = {
	...
	scrollToEnd = function(viewRef: React_ElementRef<ScrollViewNativeComponentType>, animated: boolean)
		-- ROBLOX TODO: support animated
		viewRef._nativeRef.current.CanvasPosition = Vector2.new(
			if viewRef._nativeRef.current.ScrollingDirection == Enum.ScrollingDirection.Y
				then 0
