...
現在、再試行が無効になっています。後でもう一度お試しください。]],
	...
	["Authentication.OneTimePasscode.Response.Under13NotAllowed"] = [[13歳未満のユーザーの方は、ワンタイムコード（1回のみ使用可）でログインすることはできません。]],
...
今すぐブラウザをアップデートしますか？]],
	...
	["Feature.Catalog.Message.HoldingPolicy"] = [[購入後、コレクタブルアイテムは最長で30日間保留状態になります。アイテムは保留期間が終了するまで再販売できません。]],
