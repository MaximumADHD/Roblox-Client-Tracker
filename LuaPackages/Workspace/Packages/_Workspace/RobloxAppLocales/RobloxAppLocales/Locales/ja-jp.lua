...
今すぐブラウザをアップデートしますか？]],
	...
	["Feature.Friends.Action.InviteFriends"] = [[友達を招待するか、すでに知っている人とつながりましょう]],
 ...
 楽しみましょう！]],
	...
	["Feature.NotApproved.Label.AbuseType.ContestsandSweepstakes"] = [[Robloxは、宝くじスタイルのゲームまたは無料でRobuxをもらうためにプレイする形でのコンテストや懸賞を許可しません。]],
