...
現在、再試行が無効になっています。後でもう一度お試しください。]],
	...
	["Authentication.SignUp.Description.VerifiedParentalConsentModal.LegalCheckboxLabel"] = [[コードを入力して、このボックスにチェックマークを入れるとお子様がRobloxにアクセスすることに同意したことになります。]],
...
今すぐブラウザをアップデートしますか？]],
	...
	["Feature.AccountSecurityPrompt.Header.AccountRestoresPolicyUpdateV3"] = [[認証システムを使った2段階認証を有効化]],
	...
	["Feature.AccountSecurityPrompt.Description.AccountRestoresPolicyUpdateV3Short"] = [[アカウントが危険にさらされた場合、Robloxはアカウントを復元したり、失くしたアイテムやバーチャル通貨を含むものの額を払い戻しすることはできかねます。]],
	["Feature.AccountSecurityPrompt.Description.AccountRestoresPolicyUpdateV3MessageBody"] = [[アカウントを保護するには認証システムを使って2段階認証を有効化してください。これは{linkStartSettings}アカウント設定{linkEndSettings}でできます。{lineBreak}{lineBreak}アカウントが危険にさらされた場合、Robloxはアカウントを復元したり、失くしたアイテムやバーチャル通貨を含むものの額を払い戻しすることはできかねます。詳しくは当社の {linkStartHelp}ヘルプページ{linkEndHelp}をごらんください。]],
...
両親か保護者の方が設定の中にある保護者コントロールで追加規制時間を変更することができます。]],
	...
	["IAPExperience.BuyRobux.Banner.Title"] = [[Robuxをゲット]],
