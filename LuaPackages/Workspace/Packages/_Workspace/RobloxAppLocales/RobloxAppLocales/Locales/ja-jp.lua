...
現在、再試行が無効になっています。後でもう一度お試しください。]],
	...
	["Authentication.SignUp.Description.VerifiedParentalConsentModal.LegalCheckboxLabel"] = [[コードを入力すると、お子様がRobloxにアクセスすることに同意することになります。]],
...
違う書類でもう一度お試しください。]],
	...
	["Verification.Identity.Label.ExplicitConsentVoiceCollectionWithML"] = [[内容規制と安全上の理由、当社の安全対策ツールの向上を目的としたRobloxによる音声録音の収集、使用、保管に同意します。]],
	["Verification.Identity.Label.ImplicitConsentVoiceCollectionWithML"] = [[有効化をクリックすることで、内容規制と安全上の理由、当社の安全対策ツールの向上の目的でのみ、Robloxによる音声録音の収集、使用、保管に同意します。]],
}
