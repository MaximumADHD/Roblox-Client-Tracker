...
今すぐブラウザをアップデートしますか？]],
 ...
 楽しみましょう！]],
	...
	["Feature.NotApproved.Label.AbuseType.ContestsandSweepstakes.Note"] = [[Robloxは、宝くじスタイルのゲームまたは無料でRobuxをもらうためにプレイする形でのコンテストや懸賞を許可しません。]],
...
両親か保護者の方が設定の中にある保護者コントロールで追加規制時間を変更することができます。]],
	...
	["InGame.ConnectionError.Queued"] = [[リクエストされた仮想空間が満員です。キュー内の位置はN...]],
