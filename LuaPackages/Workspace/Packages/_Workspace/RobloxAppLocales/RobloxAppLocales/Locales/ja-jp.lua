...
今すぐブラウザをアップデートしますか？]],
 ...
 楽しみましょう！]],
	...
	["Feature.NotApproved.Label.AbuseType.RealLifeThreats.Note"] = [[Robloxは、Robloxコミュニティのメンバーに対する実際的な暴力のともなう脅しを許可しません。]],
	["Feature.NotApproved.Label.AbuseType.TerrorismExtremism.Note"] = [[Robloxはテロや暴力的な過激思想に関わることを許可しません。]],
	["Feature.NotApproved.Label.AbuseType.IrlDangerousActivities.Note"] = [[Robloxは、コミュニティメンバー間で実際に危険な活動を奨励したり、参加することを許可しません。]],
	["Feature.NotApproved.Label.AbuseType.PrivacyAskingforPII.Note"] = [[Robloxは、コミュニティメンバー同士の個人識別情報（PII）の交換を許可しません。]],
	["Feature.NotApproved.Label.AbuseType.Harassment.Note"] = [[Robloxは、コミュニティメンバーへのいじめやハラスメントを許可しません。]],
	["Feature.NotApproved.Label.AbuseType.Discriminatory.Note"] = [[Robloxは、差別的な言動、またはいかなる種類の差別的なコンテンツを許可しません。]],
	["Feature.NotApproved.Label.AbuseType.SexualContent.Note"] = [[Robloxは、プラットフォーム上のいかなる形態の性的コンテンツも許可しません。]],
	["Feature.NotApproved.Label.AbuseType.ViolentContentAndGore.Note"] = [[Robloxは、画像やビデオでの過度な流血の描写を含む、暴力的なコンテンツやグロテスクな内容は許可しません。]],
	["Feature.NotApproved.Label.AbuseType.IllegalandRegulatedContent.Note"] = [[Robloxは、いかなる形態でも違法または法律で規制されたコンテンツは許可しません。これには、アルコール類、薬物、タバコ製品、または爆弾や武器の製造が含まれます。]],
	["Feature.NotApproved.Label.AbuseType.DatingandRomanticContent.Note"] = [[Robloxは、アバター同士のデートやロマンチックな交流を許可しません。]],
	["Feature.NotApproved.Label.AbuseType.Profanity.Note"] = [[Robloxは、暴言または誹謗中傷を許可しません。]],
	["Feature.NotApproved.Label.AbuseType.PoliticalContent.Note"] = [[Robloxは、現在あるの政治的な役職への候補者、政党、関連した旗やシンボルへの支持表明を許可しません。]],
	["Feature.NotApproved.Label.AbuseType.Scamming.Note"] = [[Robloxは、フィッシングや詐欺、パスワードを聞き出すこと、アカウントの売買、不正なアカウントのアップロード、Robloxのアセットのプラットフォーム外での売買、または仮想空間（体験）に関連した数値の人為的な改ざんを許可しません。]],
	["Feature.NotApproved.Label.AbuseType.Spam.Note"] = [[Robloxは、クリックベイト、または繰り返しのメッセージ、大量送信の形でのスパムを許可しません。]],
	["Feature.NotApproved.Label.AbuseType.Impersonation.Note"] = [[Robloxは、ユーザーが他人の実際または仮想世界のアイデンティティまたは所属になりすますことによって他人を欺くことを許可しません。]],
	["Feature.NotApproved.Label.AbuseType.DirectingUsersOffPlatform.Note"] = [[Robloxはいかなる種類のサイト外リンクの使用も許可しません。 Guilded（ギルデッド）、YouTube、Facebook、Discord、Twitter、Twitchへのリンクは、該当するポリシーAPIでラッピングするか、プロフィールまたは仮想空間（体験）の概要ページのSNSとSNSリンクの設定に記載済みである必要があります。 テキストチャットなど、APIを使用できない場所に表示されるリンクは禁止されています。]],
	["Feature.NotApproved.Label.AbuseType.ExtortionandBlackmail.Note"] = [[Robloxは、ユーザーがしたくないことを強制する目的でユーザーを脅そうとすることを許可していません。 ]],
	["Feature.NotApproved.Label.AbuseType.DisruptiveAudio.Note"] = [[Robloxは、理解不能だったり、過度に大音量だったり、悲鳴や高音のノイズなどの音声のアップロードを許可しません。]],
	["Feature.NotApproved.Label.AbuseType.CheatandExploits.Note"] = [[Robloxは、ユーザーがプラットフォーム上でいかなる不正行為を行う方法も導入したり議論したりすることを許可しません。]],
	["Feature.NotApproved.Label.AbuseType.MisusingRobloxSystems.Note"] = [[Robloxは、当社のプラットフォームとコミュニティを安全でセキュリティが保たれた状態にするためのシステムのバイパス（迂回）を許可しません。]],
	["Feature.NotApproved.Label.AbuseType.RobloxEconomy.Note"] = [[Robloxは、第三者によるRobuxの購入、販売、取引、Roblox Corporationからだと偽ったプロモーションコード、またはグループ・ペイアウト制度の不適切な使用を許可しません。 ]],
	["Feature.NotApproved.Label.AbuseType.RealLifeTragedy.Note"] = [[Robloxは、現実の社会で起きた特定の悲劇的な出来事を再現したり、嘲笑したり、商業利用したりするコンテンツを許可しません。]],
	["Feature.NotApproved.Label.AbuseType.IPViolation.Note"] = [[Robloxは、ユーザーが知的財産権を侵害することを許可しません。]],
	["Feature.NotApproved.Label.AbuseType.ContestsandSweepstakes"] = [[コンテストと懸賞]],
	["Feature.NotApproved.Label.AbuseType.Advertising.Note"] = [[Robloxは、コミュニティ基準または利用規約に違反する広告を許可しません。]],
	["Feature.NotApproved.Label.AbuseType.PrivacyGivingPII.Note"] = [[Robloxは、氏名（フルネーム）、Eメールアドレス、パスワード、実際の住所、電話番号、本人の画像、未成年者の不正な音声録音の形態で個人情報を共有することを許可していません。]],
	...
	["Feature.NotApproved.Label.AbuseType.ThreatsorAbuseofRobloxEmployeesorAffiliates.Note"] = [[Robloxは、Robloxの社員、請負業者、または関連業者に対しての実生活での脅しや虐待を許容しません。]],
...
詳しくは、Roblox受信トレイをチェックしてください。]],
	...
	["Feature.Profile.Description.SetAlias"] = [[友達にあなたがつけたニックネームを設定できます。あなたがつけたニックネームはあなたしか見ることができません。]],
