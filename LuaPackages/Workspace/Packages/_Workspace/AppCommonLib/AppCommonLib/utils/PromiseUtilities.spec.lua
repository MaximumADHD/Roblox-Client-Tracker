return function()
	local PromiseUtilities = require(script.Parent.PromiseUtilities)
	...
	describe("PromiseUtilities.Batch", function()
		...
		it("should invoke the given resolve callback when all promises are finished", function()
			...
			local batchedPromise = PromiseUtilities.Batch(promises):andThen(function()
		...
		it("should return the correct results of each individual promise", function()
			...
			local batchedPromise = PromiseUtilities.Batch(promises):andThen(function(results)
		...
		it("should resolve if given an empty list of promises", function()
			...
			local batchedPromise = PromiseUtilities.Batch(emptyPromises):andThen(function(results)
				callCount = callCount + 1
			end)
