...
AddFriendsTileSquare.validateProps = t.strictInterface({
	...
	tileSize = t.number,
	labelText = t.string,
	isUpdatedUI = t.optional(t.boolean),
})
...
function AddFriendsTileSquare:render()
	...
	return Style.withStyle(function(style: dependencies.UIBloxAppStyle)
		...
		local backgroundStyle = if props.isUpdatedUI then theme.UIEmphasis else theme.BackgroundUIDefault
				...
				AddFriendButton = Roact.createElement(Interactable, {
					...
					Background = Roact.createElement("Frame", {
						...
						Icon = Roact.createElement(ImageSetLabel, {
							...
							Image = if props.isUpdatedUI then FIND_FRIENDS_ICON else ADD_FRIEND_ICON,
