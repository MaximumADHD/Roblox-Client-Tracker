...
describe("FriendsCarouselIXP", function()
	...
	describe("enabledForAll", function()
		if getFFlagFriendsCarouselRemoveVariant() then
			it(
				"SHOULD return true if FriendsCarouselEnabledForAll is true and FriendsCarouselRemoveVariant is true",
				function()
			...
			it(
				"SHOULD return false if FriendsCarouselEnabledForAll is false and FriendsCarouselRemoveVariant is true",
				function()
	...
	describe("experimentOrRolloutEnabled", function()
		if getFFlagFriendsCarouselRemoveVariant() then
			describe("WHEN FFlagFriendsCarouselRemoveVariant is true", function()
