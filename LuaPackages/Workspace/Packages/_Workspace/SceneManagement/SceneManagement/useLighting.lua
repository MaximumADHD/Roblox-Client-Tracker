...
local function useLighting(configs: Configs?)
	...
	end, dependencyArray(bloomEnabled, bloomConfig))
	...
	end, dependencyArray(colorCorrectionEnabled, colorCorrectionConfig))
end
