...
local TOP_BAR_CANVAS_HEIGHT = 144
local TOPBAR_HEIGHT_RATIO = TOP_BAR_CANVAS_HEIGHT / CANVAS_HEIGHT
local CONTROLLER_BAR_CANVAS_HEIGHT = 98
...
local PAGE_CONTENT_HEIGHT_RATIO = 1 - TOPBAR_HEIGHT_RATIO
...
local function getPageContentDims()
	return calculateAdorneeProps.calculatePageContentAdorneeProps(1, DEFAULT_SCREEN_DISTANCE_TO_CAMERA)
end
...
return {
	...
	CANVAS_SIZE = Vector2.new(CANVAS_WIDTH, CANVAS_HEIGHT),
	TOP_BAR_HEIGHT_RATIO = TOPBAR_HEIGHT_RATIO,
	TOP_BAR_CANVAS_SIZE = Vector2.new(CANVAS_WIDTH, TOP_BAR_CANVAS_HEIGHT),
	DEFAULT_CANVAS_SIZE = Vector2.new(CANVAS_WIDTH, CANVAS_HEIGHT),
	FULLSCREEN_CANVAS_SIZE = Vector2.new(CANVAS_WIDTH, CANVAS_HEIGHT),
	...
	PAGE_CONTENT_CANVAS_HEIGHT = PAGE_CONTENT_CANVAS_HEIGHT,
	PAGE_CONTENT_HEIGHT_RATIO = PAGE_CONTENT_HEIGHT_RATIO,
