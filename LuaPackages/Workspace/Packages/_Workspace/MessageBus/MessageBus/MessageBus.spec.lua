...
return function()
	...
	local Packages = script:FindFirstAncestor("MessageBus").Parent
	...
	describe("MessageBus", function()
		...
		it("should construct valid protocol method request message ids", function()
			expect(MessageBus.getProtocolMethodRequestMessageId("protocol", "method")).to.equal(
				"protocol.method.Request"
			)
		end)

		it("should construct valid protocol method response message ids", function()
			expect(MessageBus.getProtocolMethodResponseMessageId("protocol", "method")).to.equal(
