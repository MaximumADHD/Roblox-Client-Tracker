...
return{
	...
	["CoreScripts.PurchasePrompt.PurchaseFailed.NotEnoughRobux"] = [[你的 Robux 不足，无法购买此物品。请访问 www.roblox.com 购买更多 Robux。]],
	...
	["CoreScripts.PurchasePrompt.PurchaseFailed.Limited"] = [[此限量物品已售完。请前往 www.roblox.com 尝试向其它用户购买。系统并未向你的帐户收取费用。]],
