...
Item {
    ...
    // To make a font thin on Windows, use font.family: fontSourceSansProLight
    // On MacOS it's enough to just set font.weight: light
    // But this doesn't work on Windows so changing the font itself is needed instead
    readonly property string fontSourceSansProLight: fontSourceSansLightProfile.name
    readonly property string fontSourceSansPro: fontSourceSansProfile.name

    FontLoader {
        source: getResource("fonts/SourceSansPro/TTF/SourceSansPro-ExtraLight.ttf")
    }
    FontLoader {
        id: fontSourceSansLightProfile
        source: getResource("fonts/SourceSansPro/TTF/SourceSansPro-Light.ttf")
    }
    FontLoader {
        id: fontSourceSansProfile
    ...
    FontLoader {
        source: getResource("fonts/SourceSansPro/TTF/SourceSansPro-Black.ttf")
    }
    ...
    // i.e. In this file, we can use just "fonts/SourceSansPro/etc"
