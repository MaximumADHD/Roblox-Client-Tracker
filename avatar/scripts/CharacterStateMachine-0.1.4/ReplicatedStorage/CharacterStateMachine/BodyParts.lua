...
function BodyParts.ArmParts()
	local parts = { "LeftUpperArm", "RightUpperArm", "LeftLowerArm", "RightLowerArm", "LeftHand", "RightHand" }
	return parts
end

function BodyParts.LegParts()
	local parts = { "LeftUpperLeg", "RightUpperLeg", "LeftLowerLeg", "RightLowerLeg", "LeftFoot", "RightFoot" }
	return parts
end
