	...
	if humanoid ~= nil then
		...
		if stateMachine.localEvent ~= nil then
			local collisionSettingRecord : ChangeCollisionSettingsRecord = {
				...
				parts =  bodyParts.GetCollidableParts(self.armsShouldCollide, self.legsShouldCollide, self.torsoShouldCollide, self.headShouldCollide)
			}
			stateMachine.localEvent:Fire(stateMachine.context.character, humanoid, "ChangeCollisionSettings", collisionSettingRecord)
		end
